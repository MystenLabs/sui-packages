module 0xd368c1e69a618b76541a72342965f87477965e15772365ede9de0b6d1f875e21::cnsnft2099 {
    struct CNSNFT2099 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2099, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2099>(arg0, arg1);
