module 0xd35e11d5bb6740bc37c2e86eb90d6437e6283a8c45fd867e8739d84212219b7b::relics {
    ...
    fun init(arg0: RELICS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Relic>(&mut v5, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{\"Rarity\":\"{rarity}\",\"Item Type\":\"{item_type}\"}"));
