module 0xd3c087e78c1e5b92d90b6efa9ab3dc92b22df2845c39428e97f26cc4947587ae::volcano {
    ...
    public entry fun decrease_eruption(arg0: &mut Volcano, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 1);
        assert!(arg0.eruption_level >= arg2, 0);
        let v0 = arg2 * 500000000;
        assert!(0x2::coin::value<0x2::sui::SUI>(arg1) >= v0, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg1, v0, arg3), 0x2::tx_context::sender(arg3));
        ...
        let v3 = EruptionDecreased{
            ...
            total_decreases : 0x2::vec_map::get<address, UserStats>(&arg0.user_stats, &v1).total_decreases,
        };
    ...
    public entry fun increase_eruption(arg0: &mut Volcano, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = EruptionIncreased{
            ...
            amount          : arg2,
            new_level       : arg0.eruption_level,
            total_increases : 0x2::vec_map::get<address, UserStats>(&arg0.user_stats, &v1).total_increases,
        };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Volcano{
            ...
            target_eruption_level : 1000000000000,
            admin                 : 0x2::tx_context::sender(arg0),
        };
        0x2::transfer::share_object<Volcano>(v0);
    }

    public entry fun set_target_eruption_level(arg0: &mut Volcano, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 3);
        assert!(arg1 > 0, 2);
        arg0.target_eruption_level = arg1;
    }
