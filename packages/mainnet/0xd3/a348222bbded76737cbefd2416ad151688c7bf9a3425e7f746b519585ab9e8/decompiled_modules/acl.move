module 0xd3a348222bbded76737cbefd2416ad151688c7bf9a3425e7f746b519585ab9e8::acl {
    ...
    public fun set_default_upgrade_cap_id(arg0: &mut ACL, arg1: address) {
        assert!(0x1::option::is_none<address>(&arg0.default_upgrade_cap_id), 7);
    ...
    public(friend) fun set_upgrade_cap(arg0: &mut ACL, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(is_admin(arg0, v0), 1);
        assert!(get_upgrade_cap_id(&arg1) == *0x1::option::borrow<address>(&arg0.default_upgrade_cap_id), 16);
