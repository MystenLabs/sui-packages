module 0xd329225d66bfb912c3012fca278cdb1f9de726983fd5bd53166b276473b9558b::sui_energy_drink {
    struct SUI_ENERGY_DRINK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_ENERGY_DRINK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_ENERGY_DRINK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Energy Drink"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://B1tObZNyOf9uu1GyT54567iMPU0nUXjF6-R5i9Q1FQQ"));
