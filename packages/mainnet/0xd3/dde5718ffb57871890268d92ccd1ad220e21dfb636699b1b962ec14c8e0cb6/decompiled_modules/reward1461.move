module 0xd3dde5718ffb57871890268d92ccd1ad220e21dfb636699b1b962ec14c8e0cb6::reward1461 {
    struct REWARD1461 has drop {
        dummy_field: bool,
    }

    struct TICKET_1461 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1461(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1461>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1461>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1461, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1461>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1461>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1461>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1461>>(v5, 0x2::tx_context::sender(arg1));
    }
