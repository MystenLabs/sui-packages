module 0xd361599612397b3d17e769fa814f2e8e31989f0bc4498c7f15623397aafc0e93::reward9597 {
    struct REWARD9597 has drop {
        dummy_field: bool,
    }

    struct TICKET_9597 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9597(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9597>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9597>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9597, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9597>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9597>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9597>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9597>>(v5, 0x2::tx_context::sender(arg1));
    }
