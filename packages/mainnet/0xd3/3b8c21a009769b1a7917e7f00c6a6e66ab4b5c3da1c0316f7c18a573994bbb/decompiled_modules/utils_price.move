module 0xd33b8c21a009769b1a7917e7f00c6a6e66ab4b5c3da1c0316f7c18a573994bbb::utils_price {
    ...
    public fun max_liquidity_for_range(arg0: u64, arg1: u64, arg2: u128, arg3: u32, arg4: u32) : (u128, bool) {
        ...
        if (arg2 <= v0) {
            ...
            return (0xd33b8c21a009769b1a7917e7f00c6a6e66ab4b5c3da1c0316f7c18a573994bbb::utils_math::mul_div_u128(v2, 0xd33b8c21a009769b1a7917e7f00c6a6e66ab4b5c3da1c0316f7c18a573994bbb::utils_math::mul_div_u128(v1, v0, 18446744073709551616), v4), true)
        };
        if (arg2 >= v1) {
            let v5 = v1 - v0;
            if (v3 == 0 || v5 == 0) {
            ...
            return (0xd33b8c21a009769b1a7917e7f00c6a6e66ab4b5c3da1c0316f7c18a573994bbb::utils_math::mul_div_u128(v3, 18446744073709551616, v5), false)
        };
        let v6 = if (v2 == 0) {
            0
        } else {
            0xd33b8c21a009769b1a7917e7f00c6a6e66ab4b5c3da1c0316f7c18a573994bbb::utils_math::mul_div_u128(v2, 0xd33b8c21a009769b1a7917e7f00c6a6e66ab4b5c3da1c0316f7c18a573994bbb::utils_math::mul_div_u128(v1, arg2, 18446744073709551616), v1 - arg2)
        };
        let v7 = if (v3 == 0) {
            0
        } else {
            0xd33b8c21a009769b1a7917e7f00c6a6e66ab4b5c3da1c0316f7c18a573994bbb::utils_math::mul_div_u128(v3, 18446744073709551616, arg2 - v0)
        };
        if (v6 <= v7) {
            (v6, true)
        } else {
