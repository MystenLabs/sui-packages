module 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::market {
    ...
    struct MarketInner has store {
        version: u64,
        transfer_cap: 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::TransferCap,
        lifecycle_cap: 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::LifecycleCap,
        treasury: 0x2::balance::Balance<0x2::sui::SUI>,
        price_states: 0x2::table::Table<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState>,
        levels: vector<Level>,
    }
    ...
    public fun new(arg0: 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::TransferCap, arg1: 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::LifecycleCap, arg2: &mut 0x2::tx_context::TxContext) : Market {
        let v0 = MarketInner{
            version       : 1,
            transfer_cap  : arg0,
            lifecycle_cap : arg1,
            treasury      : 0x2::balance::zero<0x2::sui::SUI>(),
            price_states  : 0x2::table::new<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState>(arg2),
    ...
    public fun add_level(arg0: &MarketAdminCap, arg1: &mut Market, arg2: &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::Index, arg3: u64, arg4: u64, arg5: u64) {
        assert!(arg3 > 0, 3100);
        assert!(arg4 > 0, 3101);
        assert!(arg4 <= arg5, 3101);
        assert!((arg5 as u128) * (arg3 as u128) <= 3764641647695826860204, 3119);
        let v0 = 0x2::object::id<0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::Index>(arg2);
    ...
    public fun collect_tax(arg0: &mut Market, arg1: &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::Index, arg2: 0x2::object::ID, arg3: &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::Index, arg4: vector<0x2::object::ID>, arg5: vector<u64>, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 3115);
        assert!(0x1::vector::length<0x2::object::ID>(&arg4) > 0, 3202);
        let v0 = arg0.paused;
        let v1 = level_rank_for_index_id(arg0, 0x2::object::id<0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::Index>(arg1));
        let v2 = market_uid_mut(arg0);
        0x2::balance::join<0x2::sui::SUI>(treasury_mut(arg0), 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::collect_tax(v2, v0, v1, arg1, arg2, arg3, arg4, arg5, arg6));
    }
    ...
    public fun init_tax(arg0: &MarketAdminCap, arg1: &mut Market, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::init_tax(market_uid_mut(arg1), arg2, arg3);
    }
    ...
    public(friend) fun lifecycle_cap(arg0: &Market) : &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::LifecycleCap {
    ...
    public fun premium_ppm(arg0: &Market, arg1: 0x2::object::ID) : u64 {
        if (0x2::table::contains<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState>(&load_inner(arg0).price_states, arg1)) {
            0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::premium_ppm(0x2::table::borrow<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState>(&load_inner(arg0).price_states, arg1))
        } else {
            0
        }
    }

    public(friend) fun price_states(arg0: &Market) : &0x2::table::Table<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState> {
        &load_inner(arg0).price_states
    }

    public(friend) fun price_states_mut(arg0: &mut Market) : &mut 0x2::table::Table<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState> {
        &mut load_inner_mut(arg0).price_states
    }

    public fun sale_count(arg0: &Market, arg1: 0x2::object::ID) : u64 {
        if (0x2::table::contains<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState>(&load_inner(arg0).price_states, arg1)) {
            0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::sale_count(0x2::table::borrow<0x2::object::ID, 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::pricing::PriceState>(&load_inner(arg0).price_states, arg1))
        } else {
            0
        }
    }

    public fun set_tax_level_cfg(arg0: &MarketAdminCap, arg1: &mut Market, arg2: u64, arg3: 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::TaxLevelCfg) {
        let v0 = 0x1::vector::length<Level>(market_levels(arg1));
        0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::set_tax_level_cfg(market_uid_mut(arg1), v0, arg2, arg3);
    }
    ...
    public fun swap_caps(arg0: &MarketAdminCap, arg1: &mut Market, arg2: 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::TransferCap, arg3: 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::LifecycleCap, arg4: &mut 0x2::tx_context::TxContext) : (0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::TransferCap, 0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::LifecycleCap) {
    ...
    public fun sweep_expired(arg0: &mut Market, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<0x2::sui::SUI>(treasury_mut(arg0), 0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::sweep_expired(v1, v0, arg1, arg2, arg3, arg4));
    }

    public fun tax_fund_balance(arg0: &Market) : u64 {
        0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::tax_fund_balance(market_uid(arg0))
    }

    public fun tax_is_initialized(arg0: &Market) : bool {
        0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::tax_is_initialized(market_uid(arg0))
    }

    public fun tax_self_claimable(arg0: &Market, arg1: 0x2::object::ID) : u64 {
        0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::tax_self_claimable(market_uid(arg0), arg1)
    }

    public fun tax_version_counter(arg0: &Market, arg1: 0x2::object::ID) : u64 {
        0xd3f040e18d5fb587c1801c1a61c782a7e443d3cacd7c652f220cec612a866d63::tax::tax_version_counter(market_uid(arg0), arg1)
    }

    public(friend) fun transfer_cap(arg0: &Market) : &0x4826a4d88d8ec8d40417a20ec7f07007f486404e06a09834a7e1e0c1756e9a6f::index::TransferCap {
