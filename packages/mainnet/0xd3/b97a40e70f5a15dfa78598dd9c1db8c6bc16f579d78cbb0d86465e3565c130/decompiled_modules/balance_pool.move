module 0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::balance_pool {
    ...
    public fun new(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) : BalancePool {
        BalancePool{
            ...
            authority     : 0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::new(arg0, arg1),
        }
    }

    public fun authority(arg0: &BalancePool) : &0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::Authority {
        &arg0.authority
    }

    public fun add_authorized_user(arg0: &mut BalancePool, arg1: address) {
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::add_authorized_user(&mut arg0.authority, arg1);
    }

    public fun remove_authorized_user(arg0: &mut BalancePool, arg1: address) {
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::remove_authorized_user(&mut arg0.authority, arg1);
    }

    public fun add_shared_authorized_user(arg0: &mut BalancePool, arg1: vector<u8>, arg2: address) {
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::add_authorized_user(&mut 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1).authority, arg2);
    }
    ...
    public fun new_shared_balance_pool(arg0: &mut BalancePool, arg1: vector<u8>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::verify(&arg0.authority, arg3);
        let v0 = SharedBalancePool{
            id            : 0x2::object::new(arg3),
            balance_infos : 0x1::vector::empty<BalanceInfo>(),
            authority     : 0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::new(arg2, arg3),
        };
    ...
    public fun remove_shared_authorized_user(arg0: &mut BalancePool, arg1: vector<u8>, arg2: address) {
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::remove_authorized_user(&mut 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1).authority, arg2);
    }
    ...
    public fun send_shared<T0>(arg0: &mut BalancePool, arg1: vector<u8>, arg2: 0x1::option::Option<u64>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1);
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::verify(&v0.authority, arg4);
        let v1 = 0;
        while (v1 < 0x1::vector::length<BalanceInfo>(&v0.balance_infos)) {
            let v2 = 0x1::vector::borrow_mut<BalanceInfo>(&mut v0.balance_infos, v1);
            if (v2.token == 0x1::type_name::get<T0>()) {
    ...
    public fun shared_authority(arg0: &BalancePool, arg1: vector<u8>) : &0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::Authority {
    ...
    public fun take<T0>(arg0: &mut BalancePool, arg1: 0x1::option::Option<u64>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::verify(&arg0.authority, arg2);
        let v0 = 0;
        while (v0 < 0x1::vector::length<BalanceInfo>(&arg0.balance_infos)) {
            let v1 = 0x1::vector::borrow_mut<BalanceInfo>(&mut arg0.balance_infos, v0);
            if (v1.token == 0x1::type_name::get<T0>()) {
    ...
    public fun take_shared<T0>(arg0: &mut BalancePool, arg1: vector<u8>, arg2: 0x1::option::Option<u64>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, SharedBalancePool>(&mut arg0.id, arg1);
        0xd3b97a40e70f5a15dfa78598dd9c1db8c6bc16f579d78cbb0d86465e3565c130::authority::verify(&v0.authority, arg3);
        let v1 = 0;
        while (v1 < 0x1::vector::length<BalanceInfo>(&v0.balance_infos)) {
            let v2 = 0x1::vector::borrow_mut<BalanceInfo>(&mut v0.balance_infos, v1);
            if (v2.token == 0x1::type_name::get<T0>()) {
