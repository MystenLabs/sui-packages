module 0xd3fc3ab5f195dc72597a469f7ba2ab2aa754d28c6a70b785a6bd65a6b005151d::stake_data_provider {
    ...
    public fun random_active_validator(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x2::random::Random, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) : address {
        ...
        if (0x1::vector::length<address>(&arg2) == 0) {
            ...
            *0x1::vector::borrow<address>(&v2, 0x2::random::generate_u64(&mut v0) % 0x1::vector::length<address>(&v2))
        } else {
            *0x1::vector::borrow<address>(&arg2, 0x2::random::generate_u64(&mut v0) % 0x1::vector::length<address>(&arg2))
        }
    }
