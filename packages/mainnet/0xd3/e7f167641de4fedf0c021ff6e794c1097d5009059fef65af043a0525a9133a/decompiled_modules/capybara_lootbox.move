module 0xd3e7f167641de4fedf0c021ff6e794c1097d5009059fef65af043a0525a9133a::capybara_lootbox {
    ...
    fun init(arg0: CAPYBARA_LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://api.capybara.vip/api/nft/bag.mp4"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://api.capybara.vip/api/nft/bag.mp4"));
    ...
    public fun update_storage(arg0: &0xd3e7f167641de4fedf0c021ff6e794c1097d5009059fef65af043a0525a9133a::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
