module 0xd36941bc68a6b25063797f9130c4eb2793ac55f6b6eda11dc212689a8a0b2c17::drops_test_eddrops_test_ed {
    struct DROPS_TEST_EDDROPS_TEST_ED has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DROPS_TEST_EDDROPS_TEST_ED, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DROPS_TEST_EDDROPS_TEST_ED>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"drops test eddrops test ed"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"drops test ed"));
