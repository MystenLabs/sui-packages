module 0xd35d85f2347cb6b3a913839d067f48852b824a1f18e8910aea7bf1ff1f944933::presale {
    ...
    public entry fun finalize<T0>(arg0: &mut Presale<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg0.end_time_ms || v1 >= arg0.max_raise_mist, 4);
        assert!(arg0.status == 0 || arg0.status == 1, 7);
    ...
    public entry fun withdraw_for_migration<T0>(arg0: &mut Presale<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = (((v0 as u128) * 200 / (10000 as u128)) as u64);
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_raised, v2), arg2), @0x92a32ac7fd525f8bd37ed359423b8d7d858cad26224854dfbff1914b75ee658b);
        };
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.liquidity_tokens, v1, arg2), @0x2957f0f19ee92eb5283bf1aa6ce7a3742ea7bc79bc9d1dc907fbbf7a11567409);
        let v3 = 0x2::coin::value<T0>(&arg0.creator_tokens);
        if (v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.creator_tokens, v3, arg2), arg0.creator);
        };
        ...
        0x2::event::emit<PresaleMigratingEvent>(v4);
    }
