module 0xd3453d9be7e35efe222f78a810bb3af1859fd1600926afced8b4936d825c9a05::vaults {
    ...
    public fun deposit_v2<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::mint<T2>(&mut arg1.lp_token_treasury, (v12 as u64), arg13), 0x2::coin::from_balance<T0>(v6, arg13), 0x2::coin::from_balance<T1>(v7, arg13))
    }
    ...
    public fun checked_package_version(arg0: &VaultsManager) {
        assert!(15 >= arg0.package_version, 3);
    }
    ...
    public fun migrate_liquidity<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: u64, arg8: u64, arg9: u32, arg10: u32, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v5;
        let v7 = v4;
        let v8 = take_harvest_asset<T0, T2>(arg1);
        let v9 = take_harvest_asset<T1, T2>(arg1);
        0x2::balance::join<T0>(&mut v7, v8);
        0x2::balance::join<T1>(&mut v6, v9);
        let v10 = 0x2::balance::value<T0>(&v7);
        let v11 = 0x2::balance::value<T1>(&v6);
        let v12 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T0, T1>(arg5, arg6, arg9, arg10, arg12);
        let v13 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v12);
        let (v14, v15) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::tick_range(&v12);
        let v16 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg6);
        let (v17, v18, v19) = check_is_fix_coin_a(v14, v15, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg6), v16, v10, v11);
        let (v20, v21) = if (v17) {
            (v10, v19 + v19 * (0x2::table::borrow<0x2::object::ID, OracleInfo>(&arg0.price_oracles, new_pool_key<T0, T1>()).slippage as u64) / 2000)
        } else {
            (v18 + v18 * (0x2::table::borrow<0x2::object::ID, OracleInfo>(&arg0.price_oracles, new_pool_key<T0, T1>()).slippage as u64) / 2000, v11)
        };
        let v22 = if (v17) {
            v10
        } else {
        ...
        let v23 = if (v22 > 0) {
            let v24 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg5, arg6, &mut v12, v22, v17, arg11);
            let (v25, v26) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_pay_amount<T0, T1>(&v24);
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg5, arg6, 0x2::balance::split<T0>(&mut v7, v25), 0x2::balance::split<T1>(&mut v6, v26), v24);
            if (v17) {
        ...
        let v27 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::info_liquidity(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::borrow_position_info<T0, T1>(arg6, v13));
        assert!(v27 > 0, 30);
        arg1.liquidity = v27;
        let v28 = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::deposit_v2<T0, T1>(arg3, arg2, arg4, arg6, v12, arg11, arg12);
        let v29 = MigrateLiquidityEvent{
            vault_id             : 0x2::object::id<Vault<T2>>(arg1),
            ...
            new_wrapped_position : 0x2::object::id<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&v28),
            remaining_amount     : v23,
            old_tick_lower       : v2,
            old_tick_upper       : v3,
        ...
        0x2::event::emit<MigrateLiquidityEvent>(v29);
        merge_harvest_asset<T0, T2>(arg1, v7);
        merge_harvest_asset<T1, T2>(arg1, v6);
        0x1::vector::push_back<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&mut arg1.positions, v28);
    }
