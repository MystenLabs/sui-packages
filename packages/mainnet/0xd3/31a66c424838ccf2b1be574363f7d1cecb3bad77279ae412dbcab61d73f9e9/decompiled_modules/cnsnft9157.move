module 0xd331a66c424838ccf2b1be574363f7d1cecb3bad77279ae412dbcab61d73f9e9::cnsnft9157 {
    struct CNSNFT9157 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9157, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9157>(arg0, arg1);
