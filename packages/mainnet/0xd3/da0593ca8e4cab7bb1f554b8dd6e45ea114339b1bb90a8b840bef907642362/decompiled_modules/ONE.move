module 0xd3da0593ca8e4cab7bb1f554b8dd6e45ea114339b1bb90a8b840bef907642362::ONE {
    struct ONE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ONE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<ONE>>(0x2::coin::mint<ONE>(&mut v3, 1, arg1), 0x2::tx_context::sender(arg1));
