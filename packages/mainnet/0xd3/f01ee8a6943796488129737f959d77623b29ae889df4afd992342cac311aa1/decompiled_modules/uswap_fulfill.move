module 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::uswap_fulfill {
    ...
    fun begin_fulfill_inner<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>) : (0x2::coin::Coin<T0>, FulfillReceipt) {
        let v0 = 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::parse(arg1);
        assert!(0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::dst_chain_id(&v0) == 101, 1);
        let v1 = 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::intent_id(&v0);
        let v2 = receive_all<T0>(arg0, v1, arg2);
        let v3 = 0x2::coin::value<T0>(&v2);
        assert!(v3 > 0, 3);
        let v4 = FulfillReceipt{
            intent_id      : v1,
            dst_token_hash : 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::dst_token_hash(&v0),
            dst_recipient  : 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::dst_recipient(&v0),
            min_final_out  : 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::min_final_out(&v0),
            usdc_in        : v3,
        };
        (v2, v4)
    }
    ...
    fun deliver_usdc_inner<T0>(arg0: &mut FulfillRegistry, arg1: vector<u8>, arg2: vector<0x2::transfer::Receiving<0x2::coin::Coin<T0>>>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        let v0 = 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::parse(arg1);
        assert!(0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::dst_chain_id(&v0) == 101, 1);
        let v1 = 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::dst_recipient(&v0);
        let v2 = 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::intent_id(&v0);
        if (0x2::tx_context::sender(arg4) != v1) {
            assert!(0x2::clock::timestamp_ms(arg3) > 0xd3f01ee8a6943796488129737f959d77623b29ae889df4afd992342cac311aa1::blob::deadline(&v0) * 1000 + 600000, 6);
        };
