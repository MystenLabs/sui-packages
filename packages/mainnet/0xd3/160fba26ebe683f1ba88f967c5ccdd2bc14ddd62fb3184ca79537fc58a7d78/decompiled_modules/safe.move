module 0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::safe {
    ...
    public fun extract_tokens<T0>(arg0: &mut BridgeSafe, arg1: &mut 0x8db9d9dc5cd5723ee55725869620073e28f88ddf3c360a512ebd73cb46f1903d::treasury::Treasury<0x8db9d9dc5cd5723ee55725869620073e28f88ddf3c360a512ebd73cb46f1903d::bridge_token::BRIDGE_TOKEN>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        0xe0917b74a5912e4ad186ac634e29c922ab83903f71af7500969f9411706f9b9a::two_step_role::assert_sender_is_active_role<0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::bridge_roles::OwnerRole<0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::bridge_roles::BridgeSafeTag>>(0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::bridge_roles::owner_role<0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::bridge_roles::BridgeSafeTag>(&arg0.roles), arg4);
        assert!(arg2 > 0, 10);
        let v0 = 0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::utils::type_name_bytes<T0>();
        assert!(0x2::bag::contains<vector<u8>>(&arg0.coin_storage, v0), 8);
        if (!0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::shared_structs::get_token_config_is_locked(0x2::table::borrow<vector<u8>, 0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::shared_structs::TokenConfig>(&arg0.token_cfg, v0))) {
            let v1 = 0x2::bag::borrow_mut<vector<u8>, 0x2::coin::Coin<T0>>(&mut arg0.coin_storage, v0);
            assert!(0x2::coin::value<T0>(v1) >= arg2, 8);
            0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::shared_structs::subtract_from_token_config_total_balance(borrow_token_cfg_mut(arg0, v0), arg2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(v1, arg2, arg4), arg3);
        } else {
            let v2 = 0x2::bag::borrow_mut<vector<u8>, 0x2::coin::Coin<0x8db9d9dc5cd5723ee55725869620073e28f88ddf3c360a512ebd73cb46f1903d::bridge_token::BRIDGE_TOKEN>>(&mut arg0.coin_storage, v0);
            assert!(0x2::coin::value<0x8db9d9dc5cd5723ee55725869620073e28f88ddf3c360a512ebd73cb46f1903d::bridge_token::BRIDGE_TOKEN>(v2) >= arg2, 8);
            let v3 = 0x2::coin::split<0x8db9d9dc5cd5723ee55725869620073e28f88ddf3c360a512ebd73cb46f1903d::bridge_token::BRIDGE_TOKEN>(v2, arg2, arg4);
            let v4 = borrow_token_cfg_mut(arg0, v0);
            0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::shared_structs::subtract_from_token_config_total_balance(v4, arg2);
            0x8db9d9dc5cd5723ee55725869620073e28f88ddf3c360a512ebd73cb46f1903d::treasury::transfer_from_coin<0x8db9d9dc5cd5723ee55725869620073e28f88ddf3c360a512ebd73cb46f1903d::bridge_token::BRIDGE_TOKEN>(arg1, arg3, &arg0.from_coin_cap, v3, arg4);
        };
    }
    ...
    public fun sync_supply<T0>(arg0: &mut BridgeSafe, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::borrow<vector<u8>, 0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::shared_structs::TokenConfig>(&arg0.token_cfg, v0);
        assert!(0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::shared_structs::token_config_whitelisted(v1), 5);
        assert!(0xc6fe01f6d663198656ed9bcf77ee9f2a13306ae17a397fea7c00a5f69928e29d::shared_structs::token_config_is_native(v1), 19);
