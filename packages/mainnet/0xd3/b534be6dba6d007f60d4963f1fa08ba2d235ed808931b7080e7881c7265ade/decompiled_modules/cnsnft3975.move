module 0xd3b534be6dba6d007f60d4963f1fa08ba2d235ed808931b7080e7881c7265ade::cnsnft3975 {
    struct CNSNFT3975 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3975, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3975>(arg0, arg1);
