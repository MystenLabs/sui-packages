module 0xd37ca38e54a3218bbdf7417b9817d0075ebd56ed65584a382af87854e2605066::mandate {
    ...
    public(friend) fun assert_active(arg0: &Mandate, arg1: &0x2::clock::Clock) {
        assert!(!arg0.revoked, 0xd37ca38e54a3218bbdf7417b9817d0075ebd56ed65584a382af87854e2605066::errors::revoked());
        assert!(0x2::clock::timestamp_ms(arg1) <= arg0.expiry_ms, 0xd37ca38e54a3218bbdf7417b9817d0075ebd56ed65584a382af87854e2605066::errors::expired());
    }
    ...
    public fun revoke(arg0: &mut Mandate, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 0xd37ca38e54a3218bbdf7417b9817d0075ebd56ed65584a382af87854e2605066::errors::not_owner());
        arg0.revoked = true;
    }
    ...
    public fun set_caps(arg0: &mut Mandate, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 0xd37ca38e54a3218bbdf7417b9817d0075ebd56ed65584a382af87854e2605066::errors::not_owner());
        arg0.daily_cap = arg1;
    }
