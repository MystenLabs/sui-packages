module 0xd3413b1b8d27d353daa66f55b9e663366a6defc7dbb868fe5df8ef3d93139563::retrosui {
    struct RETROSUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RETROSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RETROSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"RetroSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"RetroSui is a 2,000-piece collection for art and crypto enthusiasts, created with good vibes and love for crypto."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidzwrnlvhbndyhfz2sa3z3zfj63bn62vsqp43ithqmizyifjbdoxy"));
