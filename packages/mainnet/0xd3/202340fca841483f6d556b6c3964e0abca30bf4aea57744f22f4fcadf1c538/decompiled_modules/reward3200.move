module 0xd3202340fca841483f6d556b6c3964e0abca30bf4aea57744f22f4fcadf1c538::reward3200 {
    struct REWARD3200 has drop {
        dummy_field: bool,
    }

    struct TICKET_3200 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3200(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3200>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3200>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3200, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3200>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3200>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3200>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3200>>(v5, 0x2::tx_context::sender(arg1));
    }
