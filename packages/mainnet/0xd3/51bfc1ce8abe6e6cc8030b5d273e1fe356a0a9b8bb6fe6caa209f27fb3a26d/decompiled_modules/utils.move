module 0xd351bfc1ce8abe6e6cc8030b5d273e1fe356a0a9b8bb6fe6caa209f27fb3a26d::utils {
    ...
    public fun to_bytes(arg0: &U256) : vector<u8> {
        ...
        let v4 = get(arg0, 3);
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&v4));
        v0
    }
    ...
    public fun div(arg0: U256, arg1: U256) : U256 {
        ...
        let v3 = v1 - v2;
        let v4 = shl(arg1, (v3 as u8));
        loop {
            let v5 = compare(&arg0, &v4);
            if (v5 == 2 || v5 == 0) {
                let v6 = v3 / 64;
                let v7 = &mut v0;
    ...
    public fun shr(arg0: U256, arg1: u8) : U256 {
        ...
        if (v2 > 0) {
            ...
            while (v4 < 4) {
                let v5 = v4 - v1 - 1;
                let v6 = &mut v0;
                put(v6, v5, get(&v0, v5) + (get(&arg0, v4) << ((64 - v2) as u8)));
                v4 = v4 + 1;
            };
        };
        v0
