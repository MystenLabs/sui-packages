module 0xd31093fea103dfbec7ea5db3647b27effe75842c5182ebc326cb49c070723da2::system {
    ...
    public fun checkInRockee(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut RockeeStore, arg3: &mut RockeeArchieve, arg4: &0x2::clock::Clock, arg5: &VaultConfig, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg5.version == 1, 8012);
    ...
    public fun claimReward<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut RewardPool<T0>, arg3: &mut RockeeStore, arg4: &mut RockeeArchieve, arg5: &VaultConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg5.version == 1, 8012);
    ...
    public fun configRewardPool<T0>(arg0: &AdminCap, arg1: &mut RewardPool<T0>, arg2: bool, arg3: u64, arg4: &VaultConfig) {
        assert!(arg4.version == 1, 8012);
        arg1.active = arg2;
        arg1.reward_limit = arg3;
    }

    public fun createRewardPool<T0>(arg0: &AdminCap, arg1: &VaultConfig, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 8012);
    ...
    public fun deposit<T0>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &VaultConfig, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 1, 8012);
    ...
    public fun depositReward<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut RewardPool<T0>, arg2: &VaultConfig, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 8012);
    ...
    public fun emergencyRewardWithdraw<T0>(arg0: &TreasureCap, arg1: &mut RewardPool<T0>, arg2: &VaultConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 8012);
    ...
    public fun migrate(arg0: &AdminCap, arg1: &mut VaultConfig) {
        assert!(arg1.version < 1, 8011);
        arg1.version = 1;
    }

    public fun register(arg0: &mut RockeeReg, arg1: &0x2::clock::Clock, arg2: &VaultConfig, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 8012);
    ...
    public fun setValidator(arg0: &AdminCap, arg1: vector<u8>, arg2: &mut RockeeStore, arg3: &VaultConfig) {
        assert!(arg3.version == 1, 8012);
