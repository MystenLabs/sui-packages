module 0x533fab9a116080e2cb1c87f1832c1bf4231ab4c32318ced041e75cc28604bba9::config {
    ...
    public fun checked_emergency_pause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x533fab9a116080e2cb1c87f1832c1bf4231ab4c32318ced041e75cc28604bba9::acl::has_role(&arg0.acl, arg1, 2), 4);
    }

    public fun checked_emergency_unpause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x533fab9a116080e2cb1c87f1832c1bf4231ab4c32318ced041e75cc28604bba9::acl::has_role(&arg0.acl, arg1, 3), 5);
    }
    ...
    public fun emergency_pause(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, b"emergency_pause_before"), 7);
    ...
    public fun emergency_unpause(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, b"emergency_pause_before"), 6);
        assert!(arg1 >= 0x2::dynamic_field::remove<vector<u8>, u64>(&mut arg0.id, b"emergency_pause_before") && arg1 <= package_version(), 8);
    ...
    public fun update_package_version(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        ...
        assert!(arg2 > v0 && arg2 < 9223372036854775808, 8);
