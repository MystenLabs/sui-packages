module 0xd32599869035d9cdfee871ced0ba76776839e3e920c7345f75ef1b993826a0d0::reward5226 {
    struct REWARD5226 has drop {
        dummy_field: bool,
    }

    struct TICKET_5226 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5226(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5226>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5226>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5226, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5226>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5226>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5226>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5226>>(v5, 0x2::tx_context::sender(arg1));
    }
