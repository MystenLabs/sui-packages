module 0xd3f52c2b5282f812543120589c1976245931cb46643d4f38ff0ae755afeff52c::reward7170 {
    struct REWARD7170 has drop {
        dummy_field: bool,
    }

    struct TICKET_7170 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7170(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7170>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7170>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7170, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7170>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7170>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7170>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7170>>(v5, 0x2::tx_context::sender(arg1));
    }
