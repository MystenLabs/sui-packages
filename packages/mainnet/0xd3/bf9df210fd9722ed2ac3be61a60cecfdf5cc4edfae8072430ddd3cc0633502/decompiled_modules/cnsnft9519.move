module 0xd3bf9df210fd9722ed2ac3be61a60cecfdf5cc4edfae8072430ddd3cc0633502::cnsnft9519 {
    struct CNSNFT9519 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9519, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9519>(arg0, arg1);
