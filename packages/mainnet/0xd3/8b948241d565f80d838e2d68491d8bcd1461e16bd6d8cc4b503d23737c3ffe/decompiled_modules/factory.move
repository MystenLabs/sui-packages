module 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::factory {
    ...
    public fun add_allowed_list<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: &0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
    ...
    public fun add_allowed_pair_config<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: &0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg3));
        assert!(0x2::vec_map::contains<u32, 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::FeeTier>(0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::fee_tiers(arg0), &arg2), 17);
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun add_denied_list<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: &0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
    ...
    public(friend) fun create_pool<T0, T1>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: u128, arg4: 0x1::string::String, arg5: u32, arg6: u32, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: &0x2::coin::CoinMetadata<T0>, arg10: &0x2::coin::CoinMetadata<T1>, arg11: u64, arg12: u64, arg13: bool, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) : (0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::position::Position, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        ...
        let v1 = 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::open_position<T0, T1>(arg0, &mut v0, arg5, arg6, arg15);
        let v2 = if (arg13) {
            arg11
        } else {
            arg12
        };
        let v3 = 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::add_liquidity_fix_coin<T0, T1>(arg0, &mut v0, &mut v1, v2, arg13, arg14);
        let (v4, v5) = 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::add_liquidity_pay_amount<T0, T1>(&v3);
        assert!(v4 > 0, 16);
        assert!(v5 > 0, 16);
        assert!(0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::liquidity<T0, T1>(&v0) > 0, 16);
        if (arg13) {
            assert!(v5 <= arg12, 4);
        } else {
            assert!(v4 <= arg11, 5);
        };
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::repay_add_liquidity<T0, T1>(arg0, &mut v0, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg7, v4, arg15)), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg8, v5, arg15)), v3);
        0x2::transfer::public_share_object<0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::Pool<T0, T1>>(v0);
        (v1, arg7, arg8)
    }

    fun create_pool_internal<T0, T1>(arg0: &mut Pools, arg1: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg2: u32, arg3: u128, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::Pool<T0, T1> {
        assert!(arg3 > 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::tick_math::min_sqrt_price() && arg3 < 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::tick_math::max_sqrt_price(), 2);
        let v0 = 0x1::type_name::get<T0>();
        ...
        let v4 = 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::new<T0, T1>(arg2, arg3, 0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::get_fee_rate(arg2, arg1), v3, arg0.index, arg5, arg6);
        arg0.index = arg0.index + 1;
        let v5 = 0x2::object::id<0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::pool::Pool<T0, T1>>(&v4);
    ...
    public entry fun init_manager_and_whitelist(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: &mut 0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
    ...
    public fun mint_pool_creation_cap<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: &mut 0x2::coin::TreasuryCap<T0>, arg3: &mut 0x2::tx_context::TxContext) : PoolCreationCap {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, PermissionPairManager>(&mut arg1.id, 0x1::string::utf8(b"permission_pair_manager"));
    ...
    public fun mint_pool_creation_cap_by_admin<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: &mut 0x2::tx_context::TxContext) : PoolCreationCap {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, PermissionPairManager>(&mut arg1.id, 0x1::string::utf8(b"permission_pair_manager"));
    ...
    public fun register_permission_pair<T0, T1>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: &PoolCreationCap, arg4: &mut 0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
    ...
    public fun remove_allowed_list<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: &0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, DenyCoinList>(&mut arg1.id, 0x1::string::utf8(b"deny_coin_list"));
    ...
    public fun remove_allowed_pair_config<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: &0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg3));
    ...
    public fun remove_denied_list<T0>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: &0x2::tx_context::TxContext) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, DenyCoinList>(&mut arg1.id, 0x1::string::utf8(b"deny_coin_list"));
    ...
    public fun unregister_permission_pair<T0, T1>(arg0: &0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: &PoolCreationCap) {
        0xd38b948241d565f80d838e2d68491d8bcd1461e16bd6d8cc4b503d23737c3ffe::config::checked_package_version(arg0);
