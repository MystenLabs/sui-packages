module 0xd352031ea54579a9e6759f0d47cb3fb41a781a2147f40bd06fc18f73fece2d9a::dogeai {
    ...
    fun init(arg0: DOGEAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DOGEAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGEAI  ")))), trim_right(b"Doge AI Agent                   "), trim_right(b"The Doge AI Agent project is an emerging initiative that combines Dogecoin with artificial intelligence to expand its applications.                                                                                                                                                                                             "), v2, arg1);
        let v5 = v3;
