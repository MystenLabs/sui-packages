module 0xd3d5780d3acca17d7055ac5e7cfbfddd2b45cf701856939861456ae8c6221e14::bonding_curve {
    ...
    public(friend) fun buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0xd3d5780d3acca17d7055ac5e7cfbfddd2b45cf701856939861456ae8c6221e14::locked_coin::LockedCoin<T0>, 0x2::balance::Balance<0x2::sui::SUI>) {
        assert!(!arg0.ended, 3);
        ...
        let v14 = if (v13 >= arg0.lock_amount) {
            0xd3d5780d3acca17d7055ac5e7cfbfddd2b45cf701856939861456ae8c6221e14::locked_coin::zero<T0>(arg6)
        } else {
            ...
            v12 = v15;
            0xd3d5780d3acca17d7055ac5e7cfbfddd2b45cf701856939861456ae8c6221e14::locked_coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, v15), arg6)
        };
