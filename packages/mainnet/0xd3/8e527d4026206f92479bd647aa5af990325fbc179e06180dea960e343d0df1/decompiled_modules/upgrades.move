module 0xd38e527d4026206f92479bd647aa5af990325fbc179e06180dea960e343d0df1::upgrades {
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeCap, arg1: &mut 0xd38e527d4026206f92479bd647aa5af990325fbc179e06180dea960e343d0df1::state::State<T0>, arg2: 0x2::package::UpgradeReceipt) {
        0xd38e527d4026206f92479bd647aa5af990325fbc179e06180dea960e343d0df1::state::set_version<T0>(arg1, 0);
        0x2::package::commit_upgrade(&mut arg0.cap, arg2);
    }

    public fun check_version<T0>(arg0: VersionGated, arg1: &0xd38e527d4026206f92479bd647aa5af990325fbc179e06180dea960e343d0df1::state::State<T0>) {
        let VersionGated {  } = arg0;
        if (0xd38e527d4026206f92479bd647aa5af990325fbc179e06180dea960e343d0df1::state::get_version<T0>(arg1) != 0) {
