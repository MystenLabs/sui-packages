module 0xd3758bf2d240bb2315e4c04b009f6d9ee63e338213ad2f412ef5f45bfc5e9b89::bumper_prize {
    ...
    public(friend) fun claim_bumper_prize<T0: store + key>(arg0: &mut BumperPrizeList, arg1: u64, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (v0 == 1) {
            ...
            0xd3758bf2d240bb2315e4c04b009f6d9ee63e338213ad2f412ef5f45bfc5e9b89::rand::rng(0, v0, arg3) % v0
        };
        arg0.item_count = arg0.item_count - 1;
    ...
    public(friend) fun get_random_in_bumper(arg0: &mut BumperPrizeList, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.item_count != 0, 1);
        ...
        let v1 = if (v0 == 1) {
            ...
            0xd3758bf2d240bb2315e4c04b009f6d9ee63e338213ad2f412ef5f45bfc5e9b89::rand::rng(0, v0, arg1) % v0
        };
        let v2 = RandomIndex{
