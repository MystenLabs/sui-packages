module 0xd31a536004ed6aca3373000c0db35d3672ae803a0825e0ff3d35207c643de1bf::cnsnft2104 {
    struct CNSNFT2104 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2104, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2104>(arg0, arg1);
