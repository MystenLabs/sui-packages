module 0xd379b0813feca8215cbc2552b6aa5986d86cfe918532955cadb8ea11fe50293a::reward6323 {
    struct REWARD6323 has drop {
        dummy_field: bool,
    }

    struct TICKET_6323 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6323(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6323>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6323>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6323, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6323>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6323>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6323>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6323>>(v5, 0x2::tx_context::sender(arg1));
    }
