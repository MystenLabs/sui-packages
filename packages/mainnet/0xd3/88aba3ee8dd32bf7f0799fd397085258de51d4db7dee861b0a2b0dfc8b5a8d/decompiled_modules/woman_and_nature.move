module 0xd388aba3ee8dd32bf7f0799fd397085258de51d4db7dee861b0a2b0dfc8b5a8d::woman_and_nature {
    struct WOMAN_AND_NATURE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WOMAN_AND_NATURE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WOMAN_AND_NATURE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"WOMAN AND NATURE"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A collection about  women and nature"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Xo1mnvhy5mImxa5sY9Kv1k1r3zTUBLD4zDphUsWe2BE"));
