module 0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::farm {
    ...
    struct Farm<phantom T0> has store, key {
        ...
        td: 0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::TimeDistributor<T0, 0x2::object::ID>,
    }
    ...
    public fun size<T0>(arg0: &Farm<T0>) : u64 {
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::size<T0, 0x2::object::ID>(&arg0.td)
    }
    ...
    public fun add_member<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: &mut FarmMemberKey, arg3: u32, arg4: &0x2::clock::Clock) {
        ...
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::add_member<T0, 0x2::object::ID>(&mut arg1.td, 0x2::object::id<FarmMemberKey>(arg2), arg3, arg4);
    ...
    public fun add_members<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: &mut vector<FarmMemberKey>, arg3: vector<u32>, arg4: &0x2::clock::Clock) {
        ...
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::add_members<T0, 0x2::object::ID>(&mut arg1.td, v0, arg3, arg4);
    }
    ...
    public fun change_member_weight<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: 0x2::object::ID, arg3: u32, arg4: &0x2::clock::Clock) {
        assert_admin_cap<T0>(arg1, arg0);
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::change_weight<T0, 0x2::object::ID>(&mut arg1.td, &arg2, arg3, arg4);
    }
    ...
    public fun change_member_weights_by_idxs<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: vector<u64>, arg3: vector<u32>, arg4: &0x2::clock::Clock) {
        assert_admin_cap<T0>(arg1, arg0);
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::change_weights_by_idxs<T0, 0x2::object::ID>(&mut arg1.td, arg2, arg3, arg4);
    }

    public fun change_unlock_per_second<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        assert_admin_cap<T0>(arg1, arg0);
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::change_unlock_per_second<T0, 0x2::object::ID>(&mut arg1.td, arg2, arg3);
    }

    public fun change_unlock_start_ts_sec<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        assert_admin_cap<T0>(arg1, arg0);
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::change_unlock_start_ts_sec<T0, 0x2::object::ID>(&mut arg1.td, arg2, arg3);
    }
    ...
    public fun create<T0>(arg0: 0x2::balance::Balance<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (Farm<T0>, AdminCap) {
        ...
        let v1 = Farm<T0>{
            ...
            td       : 0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::create<T0, 0x2::object::ID>(arg0, arg1),
        };
        (v1, v0)
    }
    ...
    public fun forcefully_remove_member<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin_cap<T0>(arg1, arg0);
        let (_, v1) = 0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::remove_member<T0, 0x2::object::ID>(&mut arg1.td, &arg2, arg3);
    ...
    public fun get_unlock_per_second<T0>(arg0: &Farm<T0>) : u64 {
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::final_unlock_ts_sec<T0, 0x2::object::ID>(&arg0.td)
    }
    ...
    public fun member_withdraw_all<T0>(arg0: &mut Farm<T0>, arg1: &FarmMemberKey, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::member_withdraw_all<T0, 0x2::object::ID>(&mut arg0.td, 0x2::object::borrow_id<FarmMemberKey>(arg1), arg2)
    }
    ...
    public fun member_withdraw_all_with_ticket<T0>(arg0: &mut Farm<T0>, arg1: &mut MemberWithdrawAllTicket, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::member_withdraw_all<T0, 0x2::object::ID>(&mut arg0.td, &arg1.key_id, arg2)
    }
    ...
    public fun remove_member<T0>(arg0: &mut Farm<T0>, arg1: &mut FarmMemberKey, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        assert!(arg1.locked == false, 1);
        let (_, v1) = 0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::remove_member<T0, 0x2::object::ID>(&mut arg0.td, 0x2::object::borrow_id<FarmMemberKey>(arg1), arg2);
        arg1.unique_memberships = arg1.unique_memberships - 1;
        v1
    }
    ...
    public fun top_up_balance<T0>(arg0: &AdminCap, arg1: &mut Farm<T0>, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        assert_admin_cap<T0>(arg1, arg0);
        0xd3721cbf3fc8cb049b60f802559f7a8857b2d87db6f06c4aa03533d7a9639064::time_distributor::top_up<T0, 0x2::object::ID>(&mut arg1.td, arg2, arg3);
    }
