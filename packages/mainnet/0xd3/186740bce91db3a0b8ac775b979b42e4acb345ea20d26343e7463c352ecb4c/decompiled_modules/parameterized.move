module 0xd3186740bce91db3a0b8ac775b979b42e4acb345ea20d26343e7463c352ecb4c::parameterized {
    ...
    fun execute_single_transfer(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<0x2::object::UID>, arg2: u64, arg3: address, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::object::UID>(&arg1);
        assert!(v0 >= arg2, 2);
        if (arg2 == 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::object::UID>>(arg1, arg4);
        } else if (v0 == arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::object::UID>>(arg1, arg3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::object::UID>>(0x2::coin::split<0x2::object::UID>(&mut arg1, arg2, arg5), arg3);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::object::UID>>(arg1, arg4);
        };
        let v1 = DebugEvent{
