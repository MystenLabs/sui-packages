module 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost {
    ...
    public(friend) fun boost_pool(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: u16, arg2: u64, arg3: u8, arg4: &0x2::clock::Clock) {
        ...
        let v2 = RewardPoolId_V2{dola_pool_id: arg1};
        if (0x2::dynamic_field::exists_<RewardPoolId_V2>(v1, v2)) {
            let v3 = 0x2::dynamic_field::borrow_mut<RewardPoolId_V2, RewardPoolInfos>(v1, v2);
            let v4 = 0;
            while (v4 < 0x1::vector::length<RewardPoolInfo>(&v3.info)) {
                ...
                let (v6, v7) = if (v5.start_time <= 1717286400) {
                    (get_total_scaled_balance(arg0, arg1, v0), get_user_scaled_balance(arg0, arg1, arg2, v0))
                } else {
                    (get_total_balance(arg0, arg1), get_user_balance(arg0, arg1, arg2))
                };
                if (v0 == v5.reward_action) {
                    update_pool_reward(v5, v6, arg4);
                    update_user_reward(v5, v7, arg2);
                };
                v4 = v4 + 1;
            };
        };
    ...
    public(friend) fun claim<T0>(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: u16, arg2: u64, arg3: u8, arg4: &mut RewardPool<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = RewardPoolId_V2{dola_pool_id: arg1};
        if (0x2::dynamic_field::exists_<RewardPoolId_V2>(v0, v2)) {
            let v3 = 0x2::dynamic_field::borrow_mut<RewardPoolId_V2, RewardPoolInfos>(v0, v2);
            if (0x2::table::contains<0x2::object::ID, u64>(&v3.catalog, arg4.associate_pool)) {
                ...
                assert!(v4.reward_action == arg3, 2);
                let (v5, v6) = if (v4.start_time <= 1717286400) {
                    (get_total_scaled_balance(arg0, arg1, arg3), get_user_scaled_balance(arg0, arg1, arg2, arg3))
                } else {
                    (get_total_balance(arg0, arg1), get_user_balance(arg0, arg1, arg2))
                };
                update_pool_reward(v4, v5, arg5);
                update_user_reward(v4, v6, arg2);
                let v7 = claim_reward<T0>(v4, arg4, arg2, arg6);
                0x2::coin::join<T0>(&mut v1, v7);
            };
        };
        let v8 = ClaimRewardEvent{
        ...
        0x2::event::emit<ClaimRewardEvent>(v8);
        v1
    }
    ...
    fun update_user_reward(arg0: &mut RewardPoolInfo, arg1: u256, arg2: u64) {
        if (!0x2::table::contains<u64, UserRewardInfo>(&arg0.user_reward, arg2)) {
            let v0 = UserRewardInfo{
                last_update_reward_index : arg0.reward_index,
                unclaimed_balance        : 0,
                claimed_balance          : 0,
            };
