module 0xbfa5ac43931ed9679dd7510648240f2c3b460e2fc904cc5fda43cb1175884462::test_wallet_holding_migration {
    ...
    fun init(arg0: TEST_WALLET_HOLDING_MIGRATION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<TestLocker>(v5);
    ...
    public entry fun migrate_users_data(arg0: &MaintainerRole, arg1: &mut TestLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: &UpgradeVersion, arg5: 0x1::option::Option<u64>, arg6: &PauseUnpauseContract, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun process_accounts_and_amounts(arg0: vector<0x1::string::String>, arg1: vector<u64>, arg2: &mut TestLocker, arg3: u64) : u64 {
    ...
    public entry fun rescue_with_accounts(arg0: &Owner, arg1: &mut TestLocker, arg2: &mut StartVesting, arg3: &0x2::clock::Clock, arg4: &mut VestedTokens, arg5: vector<0x1::string::String>, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
    ...
    public entry fun update_hydro_locker_with_new_gth_holders_accounts(arg0: &MaintainerRole, arg1: &mut TestLocker, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<address>, arg5: &PauseUnpauseContract, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg6.version == 1, 2);
    ...
    public entry fun withdraw(arg0: &mut TestLocker, arg1: &mut StartVesting, arg2: &0x2::clock::Clock, arg3: 0x1::string::String, arg4: &mut VestedTokens, arg5: &PauseUnpauseContract, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg6.version == 1, 2);
        assert!(!arg5.is_paused, 22);
