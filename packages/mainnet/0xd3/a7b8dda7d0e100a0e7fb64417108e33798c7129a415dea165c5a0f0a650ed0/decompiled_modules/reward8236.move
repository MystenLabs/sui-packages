module 0xd3a7b8dda7d0e100a0e7fb64417108e33798c7129a415dea165c5a0f0a650ed0::reward8236 {
    struct REWARD8236 has drop {
        dummy_field: bool,
    }

    struct TICKET_8236 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8236(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8236>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8236>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8236, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8236>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8236>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8236>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8236>>(v5, 0x2::tx_context::sender(arg1));
    }
