module 0xd3054748f30864b6301d0bd338d0eee5758dffc9dcc149d6ba56aa8e364e589e::liquidate {
    ...
    public fun get_liquidable_debtors<T0>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : vector<address> {
        let (_, _, v2) = get_liquidable_debtors_with_info<T0>(arg0, arg1, arg2);
        v2
    }

    public fun get_liquidable_debtors_by_coin_type<T0>(arg0: &mut 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : vector<address> {
        let (_, _, v2) = get_liquidable_debtors_with_info<T0>(0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::borrow_bucket<T0>(arg0), arg1, arg2);
        v2
    }
