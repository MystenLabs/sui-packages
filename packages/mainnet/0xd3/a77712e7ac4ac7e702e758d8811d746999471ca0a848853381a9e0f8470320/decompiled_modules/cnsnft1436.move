module 0xd3a77712e7ac4ac7e702e758d8811d746999471ca0a848853381a9e0f8470320::cnsnft1436 {
    struct CNSNFT1436 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1436, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1436>(arg0, arg1);
