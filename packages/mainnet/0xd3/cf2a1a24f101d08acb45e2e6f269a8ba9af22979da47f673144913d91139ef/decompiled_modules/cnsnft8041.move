module 0xd3cf2a1a24f101d08acb45e2e6f269a8ba9af22979da47f673144913d91139ef::cnsnft8041 {
    struct CNSNFT8041 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8041, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8041>(arg0, arg1);
