module 0xd39961b4c80590e36f5a5163604623f53685931f16fc9f82ba4122e0c2e64115::cnsnft2734 {
    struct CNSNFT2734 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2734, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2734>(arg0, arg1);
