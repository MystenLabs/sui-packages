module 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_closeout {
    ...
    fun crystallize_authenticated_reallocation_return<T0>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_reallocation::ReallocationReturnProceeds<T0>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FeeAssessment) {
        ...
        if (v13 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v4, (v13 as u64), arg2), v9);
        };
        if (v12 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v4, (v12 as u64), arg2), v10);
        };
        0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::apply_fee_crystallization(arg0, v11);
        let v14 = FeeAssessment{
            gross_assets_micros            : v5,
            profit_above_high_water_micros : v6,
            lead_fee_pool_micros           : v11,
            lead_fee_micros                : v13,
            day_fee_micros                 : v12,
            net_assets_micros              : v5 - v11,
    ...
    public(friend) fun prepare_frozen_exit_pot<T0>(arg0: &0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : FrozenExitPot<T0> {
        new_frozen_exit_pot<T0>(0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_id(arg0), 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::accounting_asset(arg0), arg1, 0x2::clock::timestamp_ms(arg2), arg3)
    }
    ...
    fun reconcile_measured_return<T0>(arg0: &mut 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::OpportunityAccounting, arg1: 0x1::option::Option<0x2::coin::Coin<T0>>, arg2: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x2::coin::Coin<T0>>, FeeAssessment) {
        ...
        let v9 = mul_bps_floor(v8, v5);
        let v10 = v8 - v9;
        assert!(v1 >= v8, 11);
        assert!(v10 <= 18446744073709551615 && v9 <= 18446744073709551615, 10);
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1), (v10 as u64), arg2), v6);
        };
        if (v9 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1), (v9 as u64), arg2), v7);
        };
        let v11 = v1 - v8;
        let v12 = price_per_share_ceil(0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::liquid_assets_micros(arg0) + v11, 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::total_shares(arg0));
        let v13 = if (v12 > v2) {
            v12
        } else {
            v2
        };
        0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::managed_position::apply_full_reconciliation(arg0, v11, v13);
        let v14 = FeeAssessment{
            gross_assets_micros            : v1,
            profit_above_high_water_micros : v3,
            lead_fee_pool_micros           : v8,
            lead_fee_micros                : v10,
            day_fee_micros                 : v9,
            net_assets_micros              : v11,
            previous_high_water_pps        : v2,
            new_high_water_pps             : v13,
        };
        let v15 = AdapterReconciled{
        ...
        0x2::event::emit<AdapterReconciled>(v15);
        (arg1, v14)
    }
