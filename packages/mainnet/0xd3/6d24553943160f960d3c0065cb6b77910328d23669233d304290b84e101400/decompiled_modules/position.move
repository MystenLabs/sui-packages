module 0xd36d24553943160f960d3c0065cb6b77910328d23669233d304290b84e101400::position {
    ...
    public(friend) fun check_position_cap_matches<T0>(arg0: &Position<T0>, arg1: &PositionCap) {
        assert!(0x2::object::id<Position<T0>>(arg0) == arg1.position_id, 0xd36d24553943160f960d3c0065cb6b77910328d23669233d304290b84e101400::errors::err_position_cap_not_match());
    }
    ...
    public(friend) fun destroy_position<T0>(arg0: Position<T0>, arg1: &0xd36d24553943160f960d3c0065cb6b77910328d23669233d304290b84e101400::config::GlobalConfig) {
        let Position {
            id                   : v0,
            is_long              : _,
        ...
        0x2::transfer::public_transfer<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(v2, 0xd36d24553943160f960d3c0065cb6b77910328d23669233d304290b84e101400::config::collect_obligation_owner_cap_address(arg1));
    }
