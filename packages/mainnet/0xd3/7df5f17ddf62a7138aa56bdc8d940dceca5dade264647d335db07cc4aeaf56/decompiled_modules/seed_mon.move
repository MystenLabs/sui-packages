module 0xd37df5f17ddf62a7138aa56bdc8d940dceca5dade264647d335db07cc4aeaf56::seed_mon {
    ...
    fun init(arg0: SEED_MON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SEED Mons are virtual companions at the core of the SEED Go - collectible, tradable, and game-enhancing! Each SEED Mon comes with unique abilities, rarity levels, and earning potential. By owning a SEED Mon NFT, you unlock the ability to earn $SLOVE, $SEED, and other valuable gems."));
