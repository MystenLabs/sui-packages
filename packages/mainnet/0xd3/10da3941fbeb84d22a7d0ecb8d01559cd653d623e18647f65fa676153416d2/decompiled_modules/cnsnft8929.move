module 0xd310da3941fbeb84d22a7d0ecb8d01559cd653d623e18647f65fa676153416d2::cnsnft8929 {
    struct CNSNFT8929 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8929, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8929>(arg0, arg1);
