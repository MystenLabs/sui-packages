module 0x710c1ef4b4a05568eda3f476f25a8152464db50ef96b42882c3066161d6e4d2f::silver {
    struct SILVER has drop {
        dummy_field: bool,
    }

    fun init(arg0: SILVER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/12756-W5kexoy7ZIf8wyWs7qncXkV6RbpY8L.jpg";
        let v1 = if (0x1::vector::length<u8>(&v0) < 2) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/12756-W5kexoy7ZIf8wyWs7qncXkV6RbpY8L.jpg"))
        };
