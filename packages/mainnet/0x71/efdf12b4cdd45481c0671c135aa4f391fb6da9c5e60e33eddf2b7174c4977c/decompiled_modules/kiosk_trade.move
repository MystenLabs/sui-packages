module 0x6978f040cc983b85316a51b4aa70f168d7f7badfb98958a1b0d5f0b979710aec::kiosk_trade {
    ...
    public entry fun kiosk_buy<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: u64, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg5 - v0 - 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg1, arg5);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg6, @0xea2e824305cb5c50277f625efdc947ed99d4ed78d8ca9f6438af2e406938102d);
        let (v2, v3) = 0x2::kiosk::purchase<T0>(arg0, arg4, 0x2::coin::split<0x2::sui::SUI>(&mut arg6, v1, arg7));
        let v4 = v3;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg1, &mut v4, 0x2::coin::split<0x2::sui::SUI>(&mut arg6, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg1, v1), arg7));
        0x2::kiosk::lock<T0>(arg2, arg3, arg1, v2);
        ...
        0x2::event::emit<KiosKBuyEvent>(v8);
    }
    ...
    public entry fun kiosk_list<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0x2::kiosk::list<T0>(arg0, arg1, arg3, arg4 - arg4 * 250 / 10000 - 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg2, arg4));
