module 0x71bc17cb63b006fccf2d85d51e8a1f6bc5e9e5e365b77d225f29531c22ab1c69::zen_nft {
    ...
    fun assert_is_zen_coin<T0>() {
        ...
        let v1 = b"2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec";
        let v2 = b"zen";
        let v3 = b"ZEN";
        let v4 = if (contains_bytes(&v0, &v1)) {
            if (contains_bytes(&v0, &v2)) {
                contains_bytes(&v0, &v3)
            } else {
                false
            }
        } else {
    ...
    fun contains_bytes(arg0: &vector<u8>, arg1: &vector<u8>) : bool {
        ...
        while (v2 <= v0 - v1) {
            ...
            let v4 = 0;
            while (v4 < v1) {
                if (*0x1::vector::borrow<u8>(arg0, v2 + v4) != *0x1::vector::borrow<u8>(arg1, v4)) {
                    v3 = false;
                    break
                };
                v4 = v4 + 1;
    ...
    public fun mint_test<T0: drop>(arg0: &mut OptionsStorage, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        arg0.stage_name = 0x1::string::utf8(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>())));
