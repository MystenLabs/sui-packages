module 0x7196843a11f32dc90dfc7a03944b378aa9b4bf3f8a2d1d5a66244eda1a3dcf02::miracle {
    ...
    public fun create(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Miracle {
        assert!(arg0 > 0, 0x7196843a11f32dc90dfc7a03944b378aa9b4bf3f8a2d1d5a66244eda1a3dcf02::errors::E_BAD_SPLIT());
        Miracle{
    ...
    public fun maybe_trigger(arg0: &mut Miracle, arg1: u64) : (bool, u64) {
        ...
        assert!(v0 > 0, 0x7196843a11f32dc90dfc7a03944b378aa9b4bf3f8a2d1d5a66244eda1a3dcf02::errors::E_BAD_SPLIT());
        if (arg1 % v0 == 0) {
    ...
    public fun set_params(arg0: &mut Miracle, arg1: u64, arg2: u64) {
        assert!(arg1 > 0, 0x7196843a11f32dc90dfc7a03944b378aa9b4bf3f8a2d1d5a66244eda1a3dcf02::errors::E_BAD_SPLIT());
        arg0.base_odds = arg1;
