module 0x714b8cdbf548ac883b611c9dded5abe6adf181c6cd43cead02c0b9d9817f068b::testlabs {
    struct TESTLABS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TESTLABS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TESTLABS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"TestLabs"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Just a test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiappux6w6nwdeaf4qah445maele5tcitynwwdzrp4q6r276afldoe"));
