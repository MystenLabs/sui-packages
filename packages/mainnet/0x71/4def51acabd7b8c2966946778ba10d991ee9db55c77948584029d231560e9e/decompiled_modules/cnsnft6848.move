module 0x714def51acabd7b8c2966946778ba10d991ee9db55c77948584029d231560e9e::cnsnft6848 {
    struct CNSNFT6848 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6848, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6848>(arg0, arg1);
