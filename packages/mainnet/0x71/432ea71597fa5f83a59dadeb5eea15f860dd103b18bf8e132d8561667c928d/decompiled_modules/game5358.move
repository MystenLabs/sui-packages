module 0x71432ea71597fa5f83a59dadeb5eea15f860dd103b18bf8e132d8561667c928d::game5358 {
    struct GAME5358 has drop {
        dummy_field: bool,
    }

    struct TICKET_5358 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5358(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5358>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5358>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME5358, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME5358>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5358>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5358>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5358>>(v5, 0x2::tx_context::sender(arg1));
    }
