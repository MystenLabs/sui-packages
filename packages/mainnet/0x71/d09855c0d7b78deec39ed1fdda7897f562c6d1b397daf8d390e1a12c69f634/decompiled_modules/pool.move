module 0x71d09855c0d7b78deec39ed1fdda7897f562c6d1b397daf8d390e1a12c69f634::pool {
    ...
    public fun swap_a2b2c<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: vector<0x2::coin::Coin<T0>>, arg4: bool, arg5: bool, arg6: bool, arg7: u64, arg8: u64, arg9: u128, arg10: u128, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        let (v0, v1) = return_swap<T0, T1>(arg0, arg1, arg3, 0x1::vector::empty<0x2::coin::Coin<T1>>(), arg4, arg6, arg7, arg8, arg9, arg11, arg12);
        let v2 = v1;
        let v3 = 0x1::vector::empty<0x2::coin::Coin<T1>>();
        0x1::vector::push_back<0x2::coin::Coin<T1>>(&mut v3, v2);
        let (v4, v5) = return_swap<T1, T2>(arg0, arg2, v3, 0x1::vector::empty<0x2::coin::Coin<T2>>(), arg5, arg6, 0x2::coin::value<T1>(&v2), arg8, arg10, arg11, arg12);
        (v0, v4, v5)
    }
