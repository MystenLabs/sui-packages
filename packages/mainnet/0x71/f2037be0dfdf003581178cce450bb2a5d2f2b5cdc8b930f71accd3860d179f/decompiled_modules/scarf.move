module 0x71f2037be0dfdf003581178cce450bb2a5d2f2b5cdc8b930f71accd3860d179f::scarf {
    ...
    fun init(arg0: SCARF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<SCARF>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<SCARF>>(v4);
    }
