module 0xb2f2a777c55d13590b1ea380b7762ca8af723a92a7d241bd57924e7929ccafb4::big_queue {
    ...
    fun take_tail<T0: store>(arg0: &mut BigQueue<T0>) : vector<T0> {
        ...
        assert!(!0x1::vector::is_empty<T0>(&v0), 204);
        v0
    }
