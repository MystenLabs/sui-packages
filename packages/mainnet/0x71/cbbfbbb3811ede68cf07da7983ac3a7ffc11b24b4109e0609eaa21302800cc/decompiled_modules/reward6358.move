module 0x71cbbfbbb3811ede68cf07da7983ac3a7ffc11b24b4109e0609eaa21302800cc::reward6358 {
    struct REWARD6358 has drop {
        dummy_field: bool,
    }

    struct TICKET_6358 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6358(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_6358>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6358, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6358>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6358>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6358>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6358>>(v5, 0x2::tx_context::sender(arg1));
    }
