module 0x717a1ff41e746bba8bbdeab4691c7c79a28a32ffc718f8409160052d602c6f23::cnsnft4731 {
    struct CNSNFT4731 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4731, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9147"));
        let v4 = 0x2::package::claim<CNSNFT4731>(arg0, arg1);
