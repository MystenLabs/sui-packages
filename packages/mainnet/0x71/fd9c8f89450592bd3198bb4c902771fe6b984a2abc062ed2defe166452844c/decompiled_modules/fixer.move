module 0x71fd9c8f89450592bd3198bb4c902771fe6b984a2abc062ed2defe166452844c::fixer {
    ...
    fun generate_merkle_root(arg0: u64, arg1: vector<0x1::ascii::String>, arg2: vector<0x1::ascii::String>, arg3: vector<address>) : address {
        ...
        0x2::address::from_bytes(0x258655b04bfabf6a91fa4fdc81ffeec3fce04f55e927b8058631b4ec4297adab::merkle_proof::process_proof(&v1, 0x1::hash::sha2_256(0x2::bcs::to_bytes<Ticket>(&v0))))
    }
