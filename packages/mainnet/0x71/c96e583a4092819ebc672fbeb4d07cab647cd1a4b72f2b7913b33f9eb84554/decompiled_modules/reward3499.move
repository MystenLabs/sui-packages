module 0x71c96e583a4092819ebc672fbeb4d07cab647cd1a4b72f2b7913b33f9eb84554::reward3499 {
    struct REWARD3499 has drop {
        dummy_field: bool,
    }

    struct TICKET_3499 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3499(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3499>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3499>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3499>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3499>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3499>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3499>>(v5, 0x2::tx_context::sender(arg1));
    }
