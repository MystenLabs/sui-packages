module 0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::market {
    ...
    public(friend) fun add_reward<T0>(arg0: &mut Market, arg1: &0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::config::Config, arg2: 0x2::balance::Balance<T0>) {
        ...
        if ((0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::config::current_season(arg1) as u64) < (0x1::vector::length<Reward<T0>>(&v0.rewards) as u64)) {
        ...
        if (0x1::vector::length<0x2::vec_map::VecMap<0x2::object::ID, Deposit>>(&v0.deposits) != (0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::config::current_season(arg1) as u64) + 1) {
            err_deposits_length_and_season_mismatch();
        };
    }

    public fun claim<T0>(arg0: &mut Market, arg1: &0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::NewAction, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        if (arg2 >= 0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::new_action_season(arg1)) {
        ...
        let v3 = 0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::new_action_ticket_id(arg1);
        if (0x2::vec_map::contains<0x2::object::ID, Deposit>(v1, &v3)) {
            let v5 = 0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::new_action_ticket_id(arg1);
    ...
    public fun deposit<T0>(arg0: &mut Market, arg1: &0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::NewAction, arg2: 0x2::coin::Coin<T0>) {
        let v0 = 0x2::coin::value<T0>(&arg2);
        let v1 = 0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::new_action_ticket_id(arg1);
        ...
        let v3 = 0x1::vector::borrow_mut<0x2::vec_map::VecMap<0x2::object::ID, Deposit>>(&mut v2.deposits, (0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::new_action_season(arg1) as u64));
    ...
    public fun flash_loan<T0>(arg0: &mut Market, arg1: &0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::NewAction, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt<T0>) {
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, Reserve<T0>>(&mut arg0.id, 0x1::type_name::with_defining_ids<T0>());
    ...
    public fun repay_flash_loan<T0>(arg0: &mut Market, arg1: FlashLoanReceipt<T0>, arg2: &0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::NewAction, arg3: 0x2::coin::Coin<T0>) {
    ...
    public fun withdraw<T0>(arg0: &mut Market, arg1: &0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::NewAction, arg2: u64, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::game_ticket::new_action_season(arg1);
        if (v0 < arg3) {
