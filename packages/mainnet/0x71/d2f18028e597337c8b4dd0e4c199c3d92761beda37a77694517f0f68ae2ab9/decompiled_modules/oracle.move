module 0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::oracle {
    ...
    public fun get_price<T0>(arg0: &Oracle) : u64 {
        if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::aui::AUI>()) {
            return arg0.aui_price
        };
        if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::bui::BUI>()) {
            return arg0.bui_price
        };
        if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::cui::CUI>()) {
            return arg0.cui_price
        };
        if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x71d2f18028e597337c8b4dd0e4c199c3d92761beda37a77694517f0f68ae2ab9::usdg::USDG>()) {
