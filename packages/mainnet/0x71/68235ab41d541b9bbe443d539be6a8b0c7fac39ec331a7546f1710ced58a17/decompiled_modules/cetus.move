module 0xfeb0800bff7e13c6ba469cc49f2b5206a65c9b405fbc842a67796041cf918839::cetus {
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault, arg1: &0xfeb0800bff7e13c6ba469cc49f2b5206a65c9b405fbc842a67796041cf918839::vaults_manager::VaultsManager, arg2: &mut 0xfeb0800bff7e13c6ba469cc49f2b5206a65c9b405fbc842a67796041cf918839::rewarder::RewarderManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg5: &mut VaultPosition, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T1>, arg8: u64, arg9: u64, arg10: bool, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v10 = (0xfeb0800bff7e13c6ba469cc49f2b5206a65c9b405fbc842a67796041cf918839::utils::get_lp_amount_by_liquidity(v2, v7, v4) as u64);
        assert!(v10 > 0, 2005);
        assert!(v10 < ((18446744073709551616 - 1) as u64) - v2, 2005);
        arg5.position_share = arg5.position_share + v10;
        arg0.total_share = arg5.position_share;
        ...
        while (v3 < 0x2::vec_map::size<0x1::type_name::TypeName, u128>(&v1)) {
            ...
            if (!0x2::vec_map::contains<0x1::type_name::TypeName, PositionRewardInfo>(&v2, v4)) {
                let v6 = PositionRewardInfo{
                    pending_reward   : 0,
                    reward_debt      : 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor(*v5, (arg2.position_share as u128), 1000000000),
                    reward_harvested : 0,
                };
                ...
                v7.pending_reward = v7.pending_reward + 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor(*v5, arg3, 1000000000) - v7.reward_debt;
                v7.reward_debt = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor(*v5, (arg2.position_share as u128), 1000000000);
            };
            v3 = v3 + 1;
        };
        0xfeb0800bff7e13c6ba469cc49f2b5206a65c9b405fbc842a67796041cf918839::rewarder::set_vault_share(arg1, v0, (arg0.total_share as u128));
    }
