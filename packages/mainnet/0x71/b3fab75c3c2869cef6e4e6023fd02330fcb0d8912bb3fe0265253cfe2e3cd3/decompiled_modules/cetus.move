module 0x71b3fab75c3c2869cef6e4e6023fd02330fcb0d8912bb3fe0265253cfe2e3cd3::cetus {
    ...
    public fun get_token_price<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &0x2::coin::CoinMetadata<T0>, arg2: &0x2::coin::CoinMetadata<T1>) : u64 {
        let v0 = ((0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg0) as u256) as u256) >> 64;
        let v1 = 0x2::coin::get_decimals<T0>(arg1);
        let v2 = 0x2::coin::get_decimals<T1>(arg2);
        let v3 = if (v1 >= v2) {
            v0 * v0 * power_of_10_u256(v1 - v2)
        } else {
            v0 * v0 / power_of_10_u256(v2 - v1)
        };
        (v3 as u64)
    }

    fun power_of_10_u256(arg0: u8) : u256 {
        let v0 = 1;
        let v1 = 0;
        while (v1 < arg0) {
            v0 = v0 * 10;
