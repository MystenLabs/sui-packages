module 0x5160e4780b58f30a02ed14d3a3a9b78251acdc5cc09f893d71b336ab46701533::typus_dov_single {
    ...
    public(friend) fun deposit_from_lending_<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: 0x2::balance::Balance<T0>) : vector<u64> {
        ...
        let v4 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deposit_from_lending<T0, T0>(&mut arg0.fee_pool, get_mut_deposit_vault(v3, arg1), v0, arg3, 0x2::balance::zero<T0>(), 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v2.config.u64_padding, 5) != 1);
    ...
    public(friend) fun return_lending_account_cap_<T0: store + key>(arg0: &mut Registry, arg1: T0, arg2: LendingCapHotPotato) {
        ...
        assert!(v2 == 0x2::object::id_address<T0>(&arg1), 13906840015498903551);
