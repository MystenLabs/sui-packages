module 0x714272a90f629da591654d7d118b8e19cb66bac418d690ba7db6c43373fc46f9::curve {
    ...
    public fun buy<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut Configurator, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v4 = get_output_amount(v3, v1 + arg0.virtual_sui_amt, v2);
        assert!(v4 >= arg3, 1);
        ...
        if (v6 <= arg0.target_supply_threshold) {
            arg0.is_active = false;
            emit_migration_pending_event(0x2::object::id<BondingCurve<T0>>(arg0), v7, v5, v6);
        };
        emit_swap_event(0x2::object::id<BondingCurve<T0>>(arg0), v7, true, v3, v4, v5, v6, 0x2::tx_context::sender(arg4));
        0x2::coin::take<T0>(&mut arg0.token_balance, v4, arg4)
    }
    ...
    public fun list<T0>(arg0: &mut Configurator, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x1::option::Option<0x1::ascii::String>, arg5: 0x1::option::Option<0x1::ascii::String>, arg6: 0x1::option::Option<0x1::ascii::String>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        ...
        0x714272a90f629da591654d7d118b8e19cb66bac418d690ba7db6c43373fc46f9::freezer::freeze_object<0x2::coin::TreasuryCap<T0>>(arg1, arg8);
