module 0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::project_registry {
    ...
    fun assert_global_admin(arg0: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::Registry, arg1: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::AdminCap, arg2: address) {
        assert!(0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::is_admin(arg0, arg2, 0x2::object::id<0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::AdminCap>(arg1)), 1);
    }

    fun assert_global_owner(arg0: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::Registry, arg1: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::OwnerCap, arg2: address) {
        assert!(0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::is_owner(arg0, arg2, 0x2::object::id<0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::OwnerCap>(arg1)), 1);
    }
    ...
    public fun create_project(arg0: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::AdminCap, arg1: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::Registry, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : ProjectOwnerCap {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun create_project_by_owner(arg0: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::OwnerCap, arg1: &0x71e9d43eb9b82e9a9043d734f22397f3512350d91deec7542869b7d0a741cf72::access_control::Registry, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : ProjectOwnerCap {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun delete_project(arg0: Project, arg1: ProjectOwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert_project_owner(&arg0, &arg1, v0);
        let v1 = if (arg0.forms_count == 0) {
            if (arg0.signals_count == 0) {
                if (0x1::vector::length<Form>(&arg0.forms) == 0) {
                    0x1::vector::length<SignalReceipt>(&arg0.signals) == 0
                } else {
                    false
                }
            } else {
