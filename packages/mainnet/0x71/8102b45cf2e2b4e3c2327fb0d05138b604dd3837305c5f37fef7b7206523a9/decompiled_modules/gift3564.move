module 0x718102b45cf2e2b4e3c2327fb0d05138b604dd3837305c5f37fef7b7206523a9::gift3564 {
    struct GIFT3564 has drop {
        dummy_field: bool,
    }

    struct TICKET_3564 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3564(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3564>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3564>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3564, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3564>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3564>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3564>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3564>>(v5, 0x2::tx_context::sender(arg1));
    }
