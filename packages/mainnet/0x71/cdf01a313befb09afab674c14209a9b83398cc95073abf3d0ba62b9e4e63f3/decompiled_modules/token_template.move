module 0x71cdf01a313befb09afab674c14209a9b83398cc95073abf3d0ba62b9e4e63f3::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"E2ET", b"E2E Test Token", b"A token deployed via E2E test", 0x1::option::none<0x2::url::Url>(), arg1);
