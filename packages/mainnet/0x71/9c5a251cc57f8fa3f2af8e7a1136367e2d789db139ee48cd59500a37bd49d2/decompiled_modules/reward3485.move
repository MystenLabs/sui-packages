module 0x719c5a251cc57f8fa3f2af8e7a1136367e2d789db139ee48cd59500a37bd49d2::reward3485 {
    struct REWARD3485 has drop {
        dummy_field: bool,
    }

    struct TICKET_3485 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3485(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3485>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3485>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3485, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3485>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3485>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3485>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3485>>(v5, 0x2::tx_context::sender(arg1));
    }
