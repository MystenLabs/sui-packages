module 0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mint {
    ...
    public entry fun claim_and_create_kiosk(arg0: 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab, arg1: &0x2::transfer_policy::TransferPolicy<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>, arg2: &mut MintState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::bag::contains<address>(&arg2.kiosks, 0x2::tx_context::sender(arg3))) {
            0x2::bag::add<address, 0x2::object::ID>(&mut arg2.kiosks, 0x2::tx_context::sender(arg3), 0x2::object::id<0x2::kiosk::Kiosk>(&v2));
        };
        let v4 = 0x1::vector::empty<0x2::object::ID>();
        let v5 = 0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::mint_nft(0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::get_slot_no(&arg0), arg3);
        0x1::vector::push_back<0x2::object::ID>(&mut v4, 0x2::object::id<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>(&v5));
        0x2::kiosk::lock<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>(&mut v2, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(&v3), arg1, v5);
    ...
    public entry fun claim_nfts_and_create_kiosk(arg0: vector<0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab>, arg1: &0x2::transfer_policy::TransferPolicy<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>, arg2: &mut MintState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab>(&arg0) > 0) {
            ...
            let v7 = 0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::mint_nft(0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::get_slot_no(&v6), arg3);
            0x1::vector::push_back<0x2::object::ID>(&mut v5, 0x2::object::id<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>(&v7));
            0x2::kiosk::lock<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>(&mut v2, v4, arg1, v7);
    ...
    public entry fun claim_to_kiosk(arg0: 0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::AtlansuiLab, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg3: &0x2::transfer_policy::TransferPolicy<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::mint_nft(0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::get_slot_no(&arg0), arg4);
        0x1::vector::push_back<0x2::object::ID>(&mut v1, 0x2::object::id<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>(&v2));
        0x2::kiosk::lock<0x71889363daef4a48ed78b7dbda45ef1aad124eeaa63aa882a6ee2541162086d6::mermaid::Mermaid>(arg1, v0, arg3, v2);
        0x68cfca9b88cf98ea8ff2d69f7125d56ea4ef654c180d4fc8d7a2fe5076c478ec::atlansui_lab::burn(arg0);
        let v3 = ClaimEvent{
