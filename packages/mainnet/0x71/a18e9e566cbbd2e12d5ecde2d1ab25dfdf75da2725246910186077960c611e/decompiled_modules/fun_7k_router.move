module 0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::fun_7k_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg7: 0x1::string::String, arg8: &0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::config::Config, arg9: &mut 0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::vault::Vault, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<T0>(v5, 0x2::tx_context::sender(arg10));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg10));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg10));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg10), arg0.admin);
        let v7 = BuyEvent<T0>{
    ...
    public entry fun buy_exact_in_by_usdc<T0>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: &mut 0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg9: 0x1::string::String, arg10: &0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::config::Config, arg11: &mut 0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::vault::Vault, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        let v4 = v1;
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v0, 0x2::tx_context::sender(arg12), arg12);
        ...
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg4, 0x2::tx_context::sender(arg12));
        let v5 = 0x2::coin::from_balance<0x2::sui::SUI>(v4, arg12);
        let v6 = 0x2::balance::value<0x2::sui::SUI>(&v4) * arg0.buy_fee / 10000;
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v5, v6, arg12), arg0.admin);
        let (v7, v8) = 0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::buy_<T0>(arg3, &mut v5, true, arg6, arg7, arg8, arg12);
        let v9 = v8;
        let v10 = v7;
        let v11 = 0x2::coin::value<T0>(&v10);
        assert!(v11 >= arg6, 1);
        if (0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::locked_coin::value<T0>(&v9) == 0) {
            0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::locked_coin::destroy_zero<T0>(v9);
        } else {
            0x2::transfer::public_transfer<0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::locked_coin::LockedCoin<T0>>(v9, 0x2::tx_context::sender(arg12));
        };
        0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::settle::settle<0x2::sui::SUI, T0>(arg10, arg11, arg5 - v6, &mut v10, arg6, v11, 0x1::option::none<address>(), 0, arg12);
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<T0>(v10, 0x2::tx_context::sender(arg12));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg12));
        let v12 = BuyByUSDCEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg12),
            amount_in  : arg5,
            amount_out : v11,
        };
        0x2::event::emit<BuyByUSDCEvent<T0>>(v12);
        let v13 = FeeCollectedEvent{
            recipient : arg0.admin,
            amount    : v6,
        };
        0x2::event::emit<FeeCollectedEvent>(v13);
        let v14 = OrderCompletedEvent{order_id: arg9};
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: &0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::config::Config, arg7: &mut 0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::vault::Vault, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg8));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<T0>(v0, 0x2::tx_context::sender(arg8));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg8));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v1, v3, arg8), arg0.admin);
        let v4 = SellEvent<T0>{
    ...
    public entry fun sell_exact_in_for_usdc<T0>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: &mut 0xc42fd2cde04281a5d2659e5c96c89ba625ddeef9b622713c3d6aa1efd5ea21ab::fun_7k::Configuration, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: u64, arg7: 0x1::string::String, arg8: &0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::config::Config, arg9: &mut 0x7ea6e27ad7af6f3b8671d59df1aaebd7c03dddab893e52a714227b2f4fe91519::vault::Vault, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<T0>(v0, 0x2::tx_context::sender(arg11));
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<T0>(arg4, 0x2::tx_context::sender(arg11));
        let v2 = 0x2::coin::value<0x2::sui::SUI>(&v1);
        let v3 = v2 * arg0.sell_fee / 10000;
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v1, v3, arg11), arg0.admin);
        ...
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v8, 0x2::tx_context::sender(arg11), arg11);
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_balance<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg11), arg11);
        0x71a18e9e566cbbd2e12d5ecde2d1ab25dfdf75da2725246910186077960c611e::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg11));
