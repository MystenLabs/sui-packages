module 0x71bedbe555918845a3679182519d91912c0256037d7ab205116bc9f63f2a4edc::reward9222 {
    struct REWARD9222 has drop {
        dummy_field: bool,
    }

    struct TICKET_9222 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9222(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9222>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9222>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9222, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9222>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9222>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9222>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9222>>(v5, 0x2::tx_context::sender(arg1));
    }
