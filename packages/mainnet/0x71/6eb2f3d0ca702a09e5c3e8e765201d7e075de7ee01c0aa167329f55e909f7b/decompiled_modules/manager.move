module 0x716eb2f3d0ca702a09e5c3e8e765201d7e075de7ee01c0aa167329f55e909f7b::manager {
    ...
    public fun transfer(arg0: &mut GalxeTable, arg1: u64, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.transferable, 13906835295330107397);
        let v1 = 0x2::table::borrow_mut<address, Point>(&mut v0.balances, 0x2::tx_context::sender(arg4));
        assert!(v1.owner == 0x2::tx_context::sender(arg4), 13906835308214747137);
        assert!(v1.amount >= arg3, 13906835312510369803);
    ...
    fun check_permission(arg0: &SpacePoint, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.admin == v0 || v0 == @0x8e5af77d009beba83288e6c9164f0f1b4dc05c2895941842eeec1677935bac20, 13906835222315401217);
    }

    fun consume_signature(arg0: &GalxeTable, arg1: &vector<u8>, arg2: &vector<u8>) {
        let v0 = 0x2::hash::keccak256(arg1);
        let v1 = arg0.public_key;
        assert!(0x2::ed25519::ed25519_verify(arg2, &v1, &v0), 13906835248085729289);
    }

    public fun decreasePoint(arg0: &mut GalxeTable, arg1: u64, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<u64, SpacePoint>(&mut arg0.spaces, arg1);
        check_permission(v0, arg5);
        let v1 = 0x2::table::borrow_mut<address, Point>(&mut v0.balances, arg2);
        assert!(v1.amount >= arg3, 13906835166481481739);
        v1.amount = v1.amount - arg3;
    ...
    public fun get_space(arg0: &GalxeTable, arg1: u64) : UpdateSpacePointEvent {
        let v0 = 0x2::table::borrow<u64, SpacePoint>(&arg0.spaces, arg1);
        UpdateSpacePointEvent{
            sender       : v0.admin,
            sid          : v0.sid,
            admin        : v0.admin,
            paused       : v0.paused,
    ...
    public fun increasePoint(arg0: &mut GalxeTable, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!v3.paused, 13906834977502527493);
        assert!(!0x2::table::contains<u64, bool>(&v3.has_claimed, arg3), 13906834981797363715);
        assert!(arg5 != 0x1::vector::empty<u8>(), 13906834986092593159);
