module 0x712579292f80c11a0c9de4ff553d6e5c4757105e83a8a3129823d2b39e65d062::geometric_mean_calculations {
    ...
    public fun calc_deposit_fixed_amounts(arg0: &vector<u128>, arg1: &vector<u64>, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u128>, arg5: u128) : u64 {
        ...
        while (v8 < v0) {
            ...
            while (v10 < v0) {
                ...
                let v14 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v12, v13 + (*0x1::vector::borrow<u128>(arg4, v10) as u256));
                ...
                v9 = v9 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v15, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::ln(v18));
                v10 = v10 + 1;
            };
            let v20 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::exp(v9);
            if (v20 >= v1) {
                if (v12 < v5) {
                    v6 = v12;
                    v7 = v20;
        ...
        while (v10 < v0) {
            ...
            let v25 = if (0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v21, v24 + (*0x1::vector::borrow<u128>(arg4, v10) as u256)) >= v24) {
        ...
        while (v8 < 255) {
            ...
            while (v10 < v0) {
                ...
                v9 = v9 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v29, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::ln(v33));
            ...
            let v35 = v22 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(v1, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v27, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::exp(v9)));
    ...
    public fun calc_invariant_full(arg0: &vector<u128>, arg1: &vector<u64>) : u256 {
        ...
        while (v2 < 0x1::vector::length<u64>(arg1)) {
            ...
            assert!(v3 > 0, 11);
            v1 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v1, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::pow_down((*0x1::vector::borrow<u128>(arg0, v2) as u256), v3));
            v0 = v0 + v3;
            v2 = v2 + 1;
        };
    ...
    public fun calc_withdraw_flp_amounts_out(arg0: &vector<u128>, arg1: &vector<u64>, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u128>, arg5: u128) : u64 {
        ...
        let v2 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(calc_invariant_full(arg0, arg1), v0);
        let v3 = 0;
        let v4 = 0;
        let v5 = v4;
        ...
        while (v9 < v1) {
            ...
            let v14 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v12, v0);
            let v15 = if (v14 >= v12 || v13 == 0) {
                0
            } else {
                0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(v12 - v14, v13)
            };
            v11 = 0;
            v10 = 0;
            while (v11 < v1) {
                let v16 = (*0x1::vector::borrow<u128>(arg0, v11) as u256);
                let v17 = (*0x1::vector::borrow<u64>(arg1, v11) as u256);
                let v18 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v16, v0);
                let v19 = v16 - 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v15, (*0x1::vector::borrow<u128>(arg4, v11) as u256));
                ...
                let v22 = if (v19 >= v18) {
                    0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v19 - v18, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement(v20)) + v18
                } else {
                    let v23 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v18 - v19, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(1000000000000000000, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement(v21)));
                    if (v18 < v23) {
                        v11 = v11 + 1;
                        continue
                    };
                ...
                v10 = v10 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v17, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::ln(v22));
                v11 = v11 + 1;
            };
            let v24 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::exp(v10);
            if (v24 >= v2) {
                if (v24 < v7) {
                    v6 = v15;
                    v8 = v24;
        ...
        v11 = 0;
        while (v11 < v1) {
            let v28 = (*0x1::vector::borrow<u128>(arg0, v11) as u256);
            let v29 = if (v28 - 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v25, (*0x1::vector::borrow<u128>(arg4, v11) as u256)) >= 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v28, v0)) {
                0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg2, v11) as u256))
            } else {
                0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(1000000000000000000, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement((*0x1::vector::borrow<u64>(arg3, v11) as u256)))
            };
        ...
        while (v9 < 255) {
            ...
            let v31 = 0;
            while (v11 < v1) {
                let v32 = (*0x1::vector::borrow<u128>(arg0, v11) as u256);
                let v33 = (*0x1::vector::borrow<u64>(arg1, v11) as u256);
                let v34 = *0x1::vector::borrow<u256>(&v27, v11);
                let v35 = (*0x1::vector::borrow<u128>(arg4, v11) as u256);
                let v36 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v32, v0);
                let v37 = v32 - 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v26, v35);
                let v38 = if (v37 >= v36) {
                    0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v37 - v36, v34) + v36
                } else {
                    let v39 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v36 - v37, v34);
                    assert!(v36 >= v39, 12);
                    v36 - v39
                };
                v10 = v10 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v33, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::ln(v38));
                v31 = v31 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v33, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v34, v35)), v38);
                v11 = v11 + 1;
            };
            let v40 = v26 + 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(1000000000000000000, v31);
            let v41 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_down(v2, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_down(v31, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::exp(v10)));
            let v42 = if (v41 > v40) {
                54210108624275221
            } else {
                v40 - v41
