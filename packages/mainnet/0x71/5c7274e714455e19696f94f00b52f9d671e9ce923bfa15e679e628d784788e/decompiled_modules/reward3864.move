module 0x715c7274e714455e19696f94f00b52f9d671e9ce923bfa15e679e628d784788e::reward3864 {
    struct REWARD3864 has drop {
        dummy_field: bool,
    }

    struct TICKET_3864 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3864(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3864>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3864>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3864, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3864>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3864>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3864>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3864>>(v5, 0x2::tx_context::sender(arg1));
    }
