module 0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake {
    ...
    public fun stake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_reward_coins<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!is_emergency_inner<T0, T1>(arg0, arg2), 109);
        validate_treasury_admin(arg2, arg4);
    ...
    public fun emergency_unstake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun enable_emergency<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg2: &mut 0x2::tx_context::TxContext) {
        validate_emergency_admin(arg1, arg2);
        assert!(!is_emergency_inner<T0, T1>(arg0, arg1), 109);
        arg0.emergency_locked = true;
    }

    fun get_end_timestamp<T0, T1>(arg0: &StakePool<T0, T1>) : u64 {
        arg0.end_timestamp
    }

    public fun get_pending_user_rewards<T0, T1>(arg0: &StakePool<T0, T1>, arg1: address, arg2: &0x2::clock::Clock) : u64 {
        ...
        v0.earned_reward + (user_earned_since_last_update(arg0.accum_reward + accum_rewards_since_last_updated<T0, T1>(arg0, get_time_for_last_update<T0, T1>(arg0, 0x2::clock::timestamp_ms(arg2))), arg0.scale, v0) as u64)
    }

    fun get_pool_total_stake<T0, T1>(arg0: &StakePool<T0, T1>) : u64 {
        0x2::coin::value<T0>(&arg0.stake_coins)
    }

    fun get_start_timestamp<T0, T1>(arg0: &StakePool<T0, T1>) : u64 {
    ...
    fun get_unlock_time<T0, T1>(arg0: &StakePool<T0, T1>, arg1: address) : u64 {
        assert!(0x2::table::contains<address, UserStake>(&arg0.stakes, arg1), 103);
        0x2::math::min(arg0.end_timestamp, 0x2::table::borrow<address, UserStake>(&arg0.stakes, arg1).unlock_time)
    }

    fun get_user_stake<T0, T1>(arg0: &StakePool<T0, T1>, arg1: address) : u64 {
        assert!(0x2::table::contains<address, UserStake>(&arg0.stakes, arg1), 103);
        0x2::table::borrow<address, UserStake>(&arg0.stakes, arg1).amount
    }

    public fun harvest<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(!is_emergency_inner<T0, T1>(arg0, arg1), 109);
    ...
    fun is_emergency<T0, T1>(arg0: &StakePool<T0, T1>, arg1: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig) : bool {
        is_emergency_inner<T0, T1>(arg0, arg1)
    }

    fun is_emergency_inner<T0, T1>(arg0: &StakePool<T0, T1>, arg1: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig) : bool {
        arg0.emergency_locked || 0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::is_global_emergency(arg1)
    }

    fun is_finished<T0, T1>(arg0: &StakePool<T0, T1>, arg1: u64) : bool {
    ...
    fun is_local_emergency<T0, T1>(arg0: &StakePool<T0, T1>) : bool {
        arg0.emergency_locked
    }

    fun is_unlocked<T0, T1>(arg0: &StakePool<T0, T1>, arg1: address, arg2: &0x2::clock::Clock) : bool {
        assert!(0x2::table::contains<address, UserStake>(&arg0.stakes, arg1), 103);
        0x2::clock::timestamp_ms(arg2) / 1000 >= 0x2::math::min(arg0.end_timestamp, 0x2::table::borrow<address, UserStake>(&arg0.stakes, arg1).unlock_time)
    }
    ...
    public fun register_pool<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg3: u8, arg4: u8, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        validate_treasury_admin(arg2, arg8);
        assert!(!0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::is_global_emergency(arg2), 109);
        assert!(arg1 > 0, 112);
    ...
    fun stake_exists<T0, T1>(arg0: &StakePool<T0, T1>, arg1: address) : bool {
        0x2::table::contains<address, UserStake>(&arg0.stakes, arg1)
    }

    public fun unstake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: u64, arg2: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(arg1 > 0, 105);
        assert!(!is_emergency_inner<T0, T1>(arg0, arg2), 109);
    ...
    fun validate_emergency_admin(arg0: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == 0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::get_emergency_admin_address(arg0), 111);
    }

    fun validate_treasury_admin(arg0: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == 0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::get_treasury_admin_address(arg0), 115);
    }

    public fun withdraw_to_treasury<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: u64, arg2: &0x71132189cb802b0265ad21634fe841f7f36d2cf4aa6f3d2d839706af39e572c6::stake_config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        validate_treasury_admin(arg2, arg4);
        if (!is_emergency_inner<T0, T1>(arg0, arg2)) {
            assert!(0x2::clock::timestamp_ms(arg3) / 1000 >= arg0.end_timestamp + 172800, 114);
        };
