module 0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::cross_chain_limit_orders {
    ...
    public fun cancel_order<T0, T1, T2>(arg0: Order<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::send_coins_and_destroy_balance<T1>(v2, v4, arg2);
        0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::send_coins_and_destroy_balance<T2>(v3, v4, arg2);
        0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::send_coins_and_destroy_balance<T0>(v1, v4, arg2);
    }
    ...
    public fun claim_tokens<T0, T1, T2>(arg0: &0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::Guard<T0, T2>, arg1: Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::send_coins_and_destroy_balance<T1>(v4, v1, arg4);
        0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::send_coins_and_destroy_balance<T2>(v5, v1, arg4);
        0x2::coin::from_balance<T0>(v3, arg4)
    }

    public fun create_order<T0, T1, T2>(arg0: &0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::Guard<T0, T2>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun pre_start_order_execution<T0, T1, T2>(arg0: &0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, SwapReceipt) {
    ...
    public fun start_order_execution<T0, T1, T2>(arg0: &mut 0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = decode_start_permission_and_check_signature<T0, T2>(arg0, arg2, arg3);
        start_order_execution_internal<T0, T1, T2>(arg0, arg1, v0, arg4, arg5, arg6, arg7);
    }

    public fun start_order_execution_after_swap<T0, T1, T2>(arg0: &mut 0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: 0x2::coin::Coin<T2>, arg8: SwapReceipt, arg9: &mut 0x2::tx_context::TxContext) {
        if (0x2::balance::value<T1>(&arg1.locked_coins_in) != 0) {
            abort 5
        };
        let SwapReceipt {
    ...
    fun start_order_execution_internal<T0, T1, T2>(arg0: &mut 0x7116eb34e1dbc4c1b10a1b79df22698ba91e1cfe221ef0551a70b38fb929eab8::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: SignedPermissionData, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
