module 0x714c00789f722f417c5513cebc60363f16940c330509cceaafd513b8022152c0::cnsnft2038 {
    struct CNSNFT2038 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2038, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7739"));
        let v4 = 0x2::package::claim<CNSNFT2038>(arg0, arg1);
