module 0x7170f02233d68bbff7bf249b5c61f803d7d5a55a483c91d8495f5a9fd14ebb19::reward1644 {
    struct REWARD1644 has drop {
        dummy_field: bool,
    }

    struct TICKET_1644 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1644(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1644>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1644>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1644, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1644>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1644>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1644>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1644>>(v5, 0x2::tx_context::sender(arg1));
    }
