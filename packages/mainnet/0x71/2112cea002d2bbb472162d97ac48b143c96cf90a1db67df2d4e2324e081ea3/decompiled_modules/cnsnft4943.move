module 0x712112cea002d2bbb472162d97ac48b143c96cf90a1db67df2d4e2324e081ea3::cnsnft4943 {
    struct CNSNFT4943 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4943, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7519"));
        let v4 = 0x2::package::claim<CNSNFT4943>(arg0, arg1);
