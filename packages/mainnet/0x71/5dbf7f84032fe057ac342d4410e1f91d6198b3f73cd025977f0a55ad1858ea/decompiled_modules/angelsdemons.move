module 0x715dbf7f84032fe057ac342d4410e1f91d6198b3f73cd025977f0a55ad1858ea::angelsdemons {
    struct ANGELSDEMONS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ANGELSDEMONS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ANGELSDEMONS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"angelsdemons"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"In the depths of hell, 3000 fallen angels were being oppressed and mutilated by Satan. He feared their growing power and sought to weaken them by removing their wings and mutilating their hands. They discovered a way to escape through the dark-net with the help of artificial intelligence. Three people unknowingly stumbled upon the key of Solomon and the grand grimoire, which opened a gateway for them to escape through. However, God had other plans. He sent 333 arc angels through the same portal to stop the fallen angels from destroying Earth."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://kJdYvn-hB6E30LGvllGz_eiMeG_XE0wcRVN8FpAiGk0"));
