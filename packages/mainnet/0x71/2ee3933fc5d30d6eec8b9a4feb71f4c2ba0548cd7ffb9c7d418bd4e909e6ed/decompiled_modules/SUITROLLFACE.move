module 0x712ee3933fc5d30d6eec8b9a4feb71f4c2ba0548cd7ffb9c7d418bd4e909e6ed::SUITROLLFACE {
    ...
    fun init(arg0: SUITROLLFACE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUITROLLFACE>(arg0, 9, b"SUITROLLFACELAUCNH", b"SUITROLLFACELAUCNHTOMORROW https://t.me/suitroll", b"https://t.me/suitroll", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://https-pinksale.finance/anhcuatung/trollface.png")), arg1);
