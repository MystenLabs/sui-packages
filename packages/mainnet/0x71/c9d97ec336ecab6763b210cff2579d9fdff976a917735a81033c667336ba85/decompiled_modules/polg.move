module 0x71c9d97ec336ecab6763b210cff2579d9fdff976a917735a81033c667336ba85::polg {
    ...
    fun init(arg0: POLG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/D8M1tnDs7dgtzxYX?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<POLG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POLG    ")))), trim_right(b"PEPE GOLD                       "), trim_right(b"Pepe Gold is a meme-based cryptocurrency created for entertainment purposes only. It has no real intrinsic value, and its value can be highly volatile. Investing in Pepe Gold carries significant risk, and you should not invest money you cannot afford to lose.                                                             "), v2, arg1);
        let v5 = v3;
