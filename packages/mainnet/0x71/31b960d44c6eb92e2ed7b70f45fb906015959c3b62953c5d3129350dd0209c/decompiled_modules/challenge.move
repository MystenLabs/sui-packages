module 0x7131b960d44c6eb92e2ed7b70f45fb906015959c3b62953c5d3129350dd0209c::challenge {
    ...
    entry fun solve(arg0: &mut Challenge, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = (*0x1::vector::borrow<u8>(&v1, 0) as u64) << 24 | (*0x1::vector::borrow<u8>(&v1, 1) as u64) << 16 | (*0x1::vector::borrow<u8>(&v1, 2) as u64) << 8 | (*0x1::vector::borrow<u8>(&v1, 3) as u64);
        let v3 = 0x1::bcs::to_bytes<0x1::string::String>(&arg0.secret);
        0x1::vector::append<u8>(&mut v3, *0x1::string::as_bytes(&v0));
        let v4 = *0x1::string::as_bytes(&arg0.secret);
        let v5 = 0x1::vector::length<u8>(&v4) * 2;
        get_flag(v2, b"", 0x1::hash::sha3_256(v3), v0, v2 % 1000 + v5, v5, arg0, arg1, arg2);
    }
