module 0x71d95cfbe6a126e0198a972912d6b8ba5789069882472f8f1809b27c689fd989::leaderboard {
    struct GameWitness has drop {
        dummy_field: bool,
    }

    struct LeaderboardAdminCap has store, key {
        id: 0x2::object::UID,
    }
    ...
    struct MonthlyBoard has drop, store {
        year_month: u64,
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = LeaderboardAdminCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<LeaderboardAdminCap>(v0, 0x2::tx_context::sender(arg0));
    }
    ...
    public entry fun reset(arg0: &LeaderboardAdminCap, arg1: &mut Leaderboard) {
        arg1.monthly = 0x1::vector::empty<MonthlyBoard>();
        arg1.all_time = 0x1::vector::empty<ScoreEntry>();
    }
