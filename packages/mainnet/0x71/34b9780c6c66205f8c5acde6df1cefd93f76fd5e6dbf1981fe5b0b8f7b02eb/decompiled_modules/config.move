module 0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::config {
    ...
    struct GemsTreasury has store, key {
        id: 0x2::object::UID,
        available_gems: 0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hive_gems::HiveGems,
    }
    ...
    public fun deposit_gems_to_treasury(arg0: &mut GemsTreasury, arg1: 0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hive_gems::HiveGems, arg2: u64) : 0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hive_gems::HiveGems {
        let v0 = GemsAddedToTreasury{deposit_amt: arg2};
        0x2::event::emit<GemsAddedToTreasury>(v0);
        0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hive_gems::join(&mut arg0.available_gems, 0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hive_gems::split(&mut arg1, arg2));
        arg1
    }
    ...
    public entry fun get_fee_info<T0>(arg0: &Config) : (u64, u64) {
        if (0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::curves::is_stable<T0>()) {
            return (arg0.stable_pool_fee.total_fee_bps, arg0.stable_pool_fee.hive_fee_percent)
        };
        if (0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::curves::is_weighted<T0>()) {
            return (arg0.weighted_pool_fee.total_fee_bps, arg0.weighted_pool_fee.hive_fee_percent)
        };
        if (0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TwoAmmFeeCollectionCapability{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<TwoAmmFeeCollectionCapability>(v2, 0x2::tx_context::sender(arg0));
        let v3 = ThreeAmmFeeCollectionCapability{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<ThreeAmmFeeCollectionCapability>(v3, 0x2::tx_context::sender(arg0));
        let v4 = FeeInfo{
            total_fee_bps    : 35,
            hive_fee_percent : 34,
        };
        ...
        let v7 = Config{
            ...
            weighted_pool_fee  : v4,
            stable_pool_fee    : v5,
            curved_pool_fee    : v6,
            treasury_percent   : 10,
        };
        0x2::transfer::share_object<Config>(v7);
        let v8 = Treasury<0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hsui::HSUI>{
            id      : 0x2::object::new(arg0),
            balance : 0x2::balance::zero<0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hsui::HSUI>(),
        };
        0x2::transfer::share_object<Treasury<0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hsui::HSUI>>(v8);
        let v9 = GemsTreasury{
            id             : 0x2::object::new(arg0),
            available_gems : 0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::hive_gems::zero(),
        };
        0x2::transfer::share_object<GemsTreasury>(v9);
    }
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: u64, arg3: u64) {
        0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::curves::assert_valid_curve<T0>();
        if (0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::curves::is_stable<T0>()) {
            let v0 = &mut arg0.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0x7134b9780c6c66205f8c5acde6df1cefd93f76fd5e6dbf1981fe5b0b8f7b02eb::curves::is_curved<T0>()) {
