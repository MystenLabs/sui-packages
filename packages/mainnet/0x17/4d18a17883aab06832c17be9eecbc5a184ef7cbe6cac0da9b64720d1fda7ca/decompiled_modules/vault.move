module 0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::vault {
    ...
    public(friend) fun create_vault_and_share<T0: drop>(arg0: &T0, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::types::is_one_time_witness<T0>(arg0), 13835902965543993351);
        let v0 = RebateVault{
    ...
    public fun end_deposit_tx<T0>(arg0: &mut RebateVault, arg1: DepositCap<T0>, arg2: &0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::Config, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::ascii::String, arg5: u64, arg6: u64) {
        0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::assert_correct_version(arg2);
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 13835622396805251077);
        let DepositCap {
            vault_id         : v0,
            added_rebates    : v1,
            num_of_addresses : v2,
        ...
        assert!(v3 == v1, 13835340969073049603);
        join<T0>(arg0, arg3);
    ...
    public fun migrate<T0, T1, T2>(arg0: &mut RebateVault, arg1: &0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::Config, arg2: &0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::authority::AuthorityCap<0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::authority::PACKAGE, T0>, arg3: &mut 0xb1b653022a91d57b82bd151965ca6c8ef4f26b2b2740158e19685a57924d8166::vault::Vault, arg4: &0xb1b653022a91d57b82bd151965ca6c8ef4f26b2b2740158e19685a57924d8166::config::Config, arg5: &0x4e2df80a5e2fd0392878298c51ce15164222111ccea05504b9291b158f552677::authority::AuthorityCap<0xb1b653022a91d57b82bd151965ca6c8ef4f26b2b2740158e19685a57924d8166::authority::PACKAGE, T1>, arg6: vector<address>, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::assert_authority_cap_is_valid<T0>(arg1, arg2);
        let v0 = vector[];
        let v1 = vector[];
        let v2 = 0x2::coin::zero<T2>(arg9);
        0x1::vector::reverse<address>(&mut arg6);
        let v3 = 0;
        while (v3 < 0x1::vector::length<address>(&arg6)) {
            let v4 = 0x1::vector::pop_back<address>(&mut arg6);
            let v5 = split<T2>(arg0, v4, 0x1::type_name::with_defining_ids<T2>(), arg9);
            ...
            if (v6 == 0) {
                ...
                0x2::coin::join<T2>(&mut v2, v5);
            };
            v3 = v3 + 1;
        };
        0x1::vector::destroy_empty<address>(arg6);
        let v7 = 0x2::coin::value<T2>(&v2);
        assert!(v7 > 0, 13836186227227230217);
        let v8 = 0xb1b653022a91d57b82bd151965ca6c8ef4f26b2b2740158e19685a57924d8166::vault::begin_deposit_tx<T1, T2>(arg3, arg5, arg4);
        0xb1b653022a91d57b82bd151965ca6c8ef4f26b2b2740158e19685a57924d8166::vault::update_allocations<T2>(arg3, &mut v8, arg4, v0, v1, arg9);
        0xb1b653022a91d57b82bd151965ca6c8ef4f26b2b2740158e19685a57924d8166::vault::end_deposit_tx<T2>(arg3, v8, arg4, v2, 0x1::ascii::string(b"perpetuals migration"), arg7, arg8);
        0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::events::emit_migrate_event<T2>(0x2::object::uid_to_inner(&arg0.id), 0x2::object::id<0xb1b653022a91d57b82bd151965ca6c8ef4f26b2b2740158e19685a57924d8166::vault::Vault>(arg3), v7, 0x1::vector::length<address>(&v0));
    }
    ...
    public fun update_allocations<T0>(arg0: &mut RebateVault, arg1: &mut DepositCap<T0>, arg2: &0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::Config, arg3: vector<address>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::assert_correct_version(arg2);
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 13835622121927344133);
        let v0 = 0x1::vector::length<address>(&arg3);
        assert!(v0 == 0x1::vector::length<u64>(&arg4), 13835059189153529857);
    ...
    public fun withdraw_rebate<T0>(arg0: &mut RebateVault, arg1: &mut WithdrawCap, arg2: &0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::Config, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::config::assert_correct_version(arg2);
        assert!(arg1.vault_id == 0x2::object::uid_to_inner(&arg0.id), 13835622736107667461);
