module 0x9b8da79d54be88924cf0b3157c6e041d9ec44134dcde779bc861ab1b8c1ca254::events {
    ...
    struct MigrateEventV1 has copy, drop {
        vault_id: 0x2::object::ID,
        v2_vault_id: 0x2::object::ID,
        coin_type: 0x1::ascii::String,
        amount: u64,
        num_of_addresses: u64,
    }
    ...
    public(friend) fun emit_migrate_event<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: u64) {
        let v0 = MigrateEventV1{
            vault_id         : arg0,
            v2_vault_id      : arg1,
            coin_type        : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
            amount           : arg2,
