module 0x1776fdc1833ecb232f287c44d494b9e61ed954c8764a707be044b882e3dc4df2::silver_nft {
    struct SILVER_NFT has drop {
        dummy_field: bool,
    }

    struct SilverNft has store, key {
        id: 0x2::object::UID,
        nft_id: u64,
    ...
    public entry fun burn(arg0: &mut MintRecord, arg1: SilverNft) {
    ...
    fun init(arg0: SILVER_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SILVER_NFT>(arg0, arg1);
        ...
        let v6 = 0x2::display::new_with_fields<SilverNft>(&v0, v1, v3, arg1);
        0x2::display::update_version<SilverNft>(&mut v6);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<SilverNft>>(v6, 0x2::tx_context::sender(arg1));
    ...
    public entry fun mint(arg0: &mut MintRecord, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = NFTMinted{
            object_id : 0x2::object::id<SilverNft>(&v1),
            creator   : 0x2::tx_context::sender(arg4),
            name      : v1.name,
        };
        0x2::event::emit<NFTMinted>(v2);
        0x2::transfer::public_transfer<SilverNft>(v1, arg3);
    }
