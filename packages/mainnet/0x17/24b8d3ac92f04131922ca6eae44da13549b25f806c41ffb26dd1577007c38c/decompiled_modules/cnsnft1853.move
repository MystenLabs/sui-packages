module 0x1724b8d3ac92f04131922ca6eae44da13549b25f806c41ffb26dd1577007c38c::cnsnft1853 {
    struct CNSNFT1853 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1853, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1853>(arg0, arg1);
