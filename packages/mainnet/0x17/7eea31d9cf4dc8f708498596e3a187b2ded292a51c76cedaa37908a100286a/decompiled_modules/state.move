module 0x177eea31d9cf4dc8f708498596e3a187b2ded292a51c76cedaa37908a100286a::state {
    ...
    public(friend) fun refund_source_order<T0>(arg0: &mut State, arg1: LockedFunds<T0>, arg2: address, arg3: address, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        ...
        let v3 = v2;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0x177eea31d9cf4dc8f708498596e3a187b2ded292a51c76cedaa37908a100286a::amount::denormalize_amount(v0.fee_cancel, arg4)), arg5), arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v3, arg5), v0.trader);
        0x2::object::delete(v1);
        (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, 0x177eea31d9cf4dc8f708498596e3a187b2ded292a51c76cedaa37908a100286a::amount::denormalize_amount(v0.fee_refund, arg4)), arg5), 0x2::balance::value<T0>(&v3))
    }
