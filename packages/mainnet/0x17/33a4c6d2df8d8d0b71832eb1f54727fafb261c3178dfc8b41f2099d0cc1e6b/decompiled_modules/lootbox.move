module 0x8c6df493fb3caf76a69a40e33dc48fb732f10ef000926588bd667e60b451836::lootbox {
    ...
    struct House has key {
        ...
        nft_groups: 0x2::table::Table<0x1::string::String, vector<NFTWrapper>>,
    }
    ...
    struct NFTWrapper has store, key {
        id: 0x2::object::UID,
    }
    ...
    public entry fun assign_nft_to_group<T0: store + key>(arg0: &AdminCap, arg1: &mut House, arg2: T0, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x2::object::ID, T0>(&mut arg1.id, v1, arg2);
        let v2 = &mut arg1.nft_groups;
        let v3 = NFTWrapper{id: v0};
        if (!0x2::table::contains<0x1::string::String, vector<NFTWrapper>>(v2, arg3)) {
            0x2::table::add<0x1::string::String, vector<NFTWrapper>>(v2, arg3, 0x1::vector::singleton<NFTWrapper>(v3));
        } else {
            0x1::vector::push_back<NFTWrapper>(0x2::table::borrow_mut<0x1::string::String, vector<NFTWrapper>>(v2, arg3), v3);
        };
        let v4 = NftToGroupAssigned{
            house_id   : 0x2::object::uid_to_inner(&arg1.id),
            nft_group  : arg3,
            wrapper_id : v1,
        };
        0x2::event::emit<NftToGroupAssigned>(v4);
    }
    ...
    public entry fun copy_admin_cap_to(arg0: &AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_house(arg0: &AdminCap, arg1: vector<u8>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = House{
            ...
            nft_groups         : 0x2::table::new<0x1::string::String, vector<NFTWrapper>>(arg3),
        };
    ...
    public entry fun create_lootbox_category(arg0: &AdminCap, arg1: &mut House, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::new(arg4);
    ...
    public entry fun delete_lootbox_category(arg0: &AdminCap, arg1: &mut House, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = LootboxCategoryDeleted{category_id: 0x2::object::uid_to_inner(&v4)};
        0x2::event::emit<LootboxCategoryDeleted>(v5);
    }
    ...
    public entry fun get_back_nft<T0: store + key>(arg0: &AdminCap, arg1: &mut House, arg2: 0x1::string::String, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg1.id, nft_wrapper_id_for_group_at_index(arg1, arg2, arg3)), 0x2::tx_context::sender(arg4));
        let NFTWrapper { id: v0 } = 0x1::vector::remove<NFTWrapper>(0x2::table::borrow_mut<0x1::string::String, vector<NFTWrapper>>(&mut arg1.nft_groups, arg2), arg3);
        ...
        0x2::event::emit<NftGivenBack>(v1);
    }
    ...
    public entry fun new_open_lootbox_test(arg0: &mut House, arg1: &mut Lootbox, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.opened, 5);
        arg1.opened = true;
        arg1.opened_at = 0x2::clock::timestamp_ms(arg3);
        let (v0, v1) = get_category_index_by_id(arg0, arg1.lootbox_category_id);
        assert!(v0, 1);
        let v2 = get_category_by_index(arg0, v1);
        assert!(0x2::object::uid_to_inner(&v2.id) == arg1.lootbox_category_id, 2);
        let v3 = &v2.lootbox_settings;
        let (v4, v5) = get_lootbox_setting_index_from_remainder(v3, arg2);
        if (v4) {
            let v6 = 0x1::vector::borrow<LootboxSetting>(v3, v5);
            if (v6.type == 1) {
                let v7 = v6.nft_group;
                assert!(!0x1::option::is_none<0x1::string::String>(&v7), 9);
                nft_wrapper_id_for_group_at_index(arg0, *0x1::option::borrow<0x1::string::String>(&v7), 0);
            } else if (v6.type == 0) {
                let v8 = v6.sui_amount;
                assert!(!0x1::option::is_none<u64>(&v8), 8);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.pool, *0x1::option::borrow<u64>(&v8)), arg4), arg1.player);
            };
        };
    }
    ...
    public fun nft_group(arg0: &House, arg1: 0x1::string::String) : &vector<NFTWrapper> {
        0x2::table::borrow<0x1::string::String, vector<NFTWrapper>>(&arg0.nft_groups, arg1)
    }

    public fun nft_wrapper_id_for_group_at_index(arg0: &House, arg1: 0x1::string::String, arg2: u64) : 0x2::object::ID {
        0x2::object::uid_to_inner(&0x1::vector::borrow<NFTWrapper>(nft_group(arg0, arg1), arg2).id)
    }
    ...
    public entry fun open_lootbox<T0: store + key>(arg0: &mut House, arg1: &mut Lootbox, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg2, &v1, &v0), 6);
        ...
        if (v7) {
            ...
            if (v9.type == 1) {
                ...
                let v12 = nft_wrapper_id_for_group_at_index(arg0, *v11, 0);
                0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, v12), arg1.player);
                let NFTWrapper { id: v13 } = 0x1::vector::remove<NFTWrapper>(0x2::table::borrow_mut<0x1::string::String, vector<NFTWrapper>>(&mut arg0.nft_groups, *v11), 0);
                0x2::object::delete(v13);
                let v14 = LootboxOpenedWithNftReward{
                    lootbox_id : 0x2::object::uid_to_inner(&arg1.id),
                    opened_at  : 0x2::clock::timestamp_ms(arg3),
                    wrapper_id : v12,
                };
                0x2::event::emit<LootboxOpenedWithNftReward>(v14);
            } else if (v9.type == 0) {
                let v15 = v9.sui_amount;
                assert!(!0x1::option::is_none<u64>(&v15), 8);
                let v16 = 0x1::option::borrow<u64>(&v15);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.pool, *v16), arg4), arg1.player);
                let v17 = LootboxOpenedWithSuiReward{
                    lootbox_id : 0x2::object::uid_to_inner(&arg1.id),
                    opened_at  : 0x2::clock::timestamp_ms(arg3),
                    sui_amount : *v16,
                };
                0x2::event::emit<LootboxOpenedWithSuiReward>(v17);
            };
        } else {
            let v18 = LootboxOpenedWithNoReward{
                lootbox_id : 0x2::object::uid_to_inner(&arg1.id),
                opened_at  : 0x2::clock::timestamp_ms(arg3),
            };
            0x2::event::emit<LootboxOpenedWithNoReward>(v18);
        };
    }

    public entry fun open_lootbox_test<T0: store + key>(arg0: &mut House, arg1: &mut Lootbox, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.opened, 5);
        arg1.opened = true;
        arg1.opened_at = 0x2::clock::timestamp_ms(arg3);
        let (v0, v1) = get_category_index_by_id(arg0, arg1.lootbox_category_id);
        ...
        if (v4) {
            ...
            if (v6.type == 1) {
                let v7 = v6.nft_group;
                assert!(!0x1::option::is_none<0x1::string::String>(&v7), 9);
                let v8 = 0x1::option::borrow<0x1::string::String>(&v7);
                0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, nft_wrapper_id_for_group_at_index(arg0, *v8, 0)), arg1.player);
                let NFTWrapper { id: v9 } = 0x1::vector::remove<NFTWrapper>(0x2::table::borrow_mut<0x1::string::String, vector<NFTWrapper>>(&mut arg0.nft_groups, *v8), 0);
                0x2::object::delete(v9);
            } else if (v6.type == 0) {
                let v10 = v6.sui_amount;
                assert!(!0x1::option::is_none<u64>(&v10), 8);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.pool, *0x1::option::borrow<u64>(&v10)), arg4), arg1.player);
            };
        };
    }
