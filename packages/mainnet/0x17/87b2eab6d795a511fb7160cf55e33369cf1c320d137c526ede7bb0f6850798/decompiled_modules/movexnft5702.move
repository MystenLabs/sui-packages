module 0x1787b2eab6d795a511fb7160cf55e33369cf1c320d137c526ede7bb0f6850798::movexnft5702 {
    struct MOVEXNFT5702 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT5702, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT5702>(arg0, arg1);
