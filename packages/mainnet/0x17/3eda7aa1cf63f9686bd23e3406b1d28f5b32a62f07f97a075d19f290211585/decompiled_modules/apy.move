module 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::apy {
    ...
    public fun push_apy_and_tvl_from_enclave(arg0: &mut ApyRegistry, arg1: &0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::enclave_verifier::EnclaveRegistry, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock) {
        let v0 = 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::enclave_verifier::verify_and_decode(arg1, arg2, arg3);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        let v2 = 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::enclave_verifier::get_timestamp_ms(&v0);
        assert!(v1 >= v2 && v1 - v2 <= 300000, 601);
        let v3 = 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::enclave_verifier::get_strategy_id(&v0);
        update_base_apy_internal(arg0, v3, 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::enclave_verifier::get_apy(&v0), arg4);
        push_tvl(arg0, v3, 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::enclave_verifier::get_tvl(&v0), arg4);
    }
    ...
    public fun select_best_strategy(arg0: &ApyRegistry, arg1: &0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::strategy::StrategyRegistry) : u8 {
        let v0 = 0x173eda7aa1cf63f9686bd23e3406b1d28f5b32a62f07f97a075d19f290211585::strategy::list_available(arg1);
