module 0x17897800b853f51ea87757b2858f51e79a6ffa392c9dedb70d28690d86cca5d9::heist {
    ...
    public fun mint_device(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Session, arg2: u64, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) : Device {
        ...
        let v4 = DeviceMinted{
            ...
            treasury_fee : v0,
            vault_added  : v1,
            grid         : flatten_grid(&v3),
        };
        0x2::event::emit<DeviceMinted>(v4);
        Device{
