module 0x17df2b0984cd55c93d949eb875a50ceba5b2ff9dc59f7fcdf974efdf48b73d60::dogeai {
    ...
    fun init(arg0: DOGEAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/vDgOevMn3_mbBMfc?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOGEAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGEAI  ")))), trim_right(b"Doge Terminal AI                "), trim_right(b"AI Agent revolutionizing community interaction and reporting on the latest news about AI and Crypto.                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
