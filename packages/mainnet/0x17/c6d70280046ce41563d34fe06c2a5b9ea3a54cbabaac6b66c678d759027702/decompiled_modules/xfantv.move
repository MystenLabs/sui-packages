module 0x17c6d70280046ce41563d34fe06c2a5b9ea3a54cbabaac6b66c678d759027702::xfantv {
    ...
    fun init(arg0: XFANTV, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<XFANTV>(arg0, 9, b"$FAN", b"xFanTV", b"xFanTV represents the platform token linked to FanTV, offering ownership in the platform", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://fantv.world/images/fantv-new/logo.png")), arg1);
        let v2 = v0;
