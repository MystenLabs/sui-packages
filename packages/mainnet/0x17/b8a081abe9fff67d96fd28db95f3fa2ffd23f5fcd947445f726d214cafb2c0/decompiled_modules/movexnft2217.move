module 0x17b8a081abe9fff67d96fd28db95f3fa2ffd23f5fcd947445f726d214cafb2c0::movexnft2217 {
    struct MOVEXNFT2217 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2217, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2217>(arg0, arg1);
