module 0x1767927b54023b7b915a5f5d28918c68e24a74f9e397e8f68be7f9b9574c2b7c::cnsnft9232 {
    struct CNSNFT9232 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9232, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3271"));
        let v4 = 0x2::package::claim<CNSNFT9232>(arg0, arg1);
