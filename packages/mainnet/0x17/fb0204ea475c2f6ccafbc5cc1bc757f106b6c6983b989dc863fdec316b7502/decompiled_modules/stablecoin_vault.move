module 0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::stablecoin_vault {
    ...
    fun calculate_base_fee<T0>(arg0: &Vault<T0>, arg1: u64) : u64 {
        ...
        assert!(v0 >= arg1, 8);
        let v1 = v0 - arg1;
        let v2 = 0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u64(arg0.total_user_staked, 20) / 100;
        if (v1 > v2) {
            return 10
        };
        if (v2 == 0) {
        ...
        let v3 = 0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u64(v1, 10000) / v2;
        let v4 = v3;
        if (v3 > 10000) {
            v4 = 10000;
        };
        let v5 = 100 - 0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u64(100 - 10, v4) / 10000;
        if (v5 < 10) {
            10
        } else {
            v5
    ...
    public fun calculate_redemption_fee<T0>(arg0: &Vault<T0>, arg1: address, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : u64 {
        assert!(arg2 > 0, 5);
        ((0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u128(0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u128((arg2 as u128), (calculate_base_fee<T0>(arg0, arg3) as u128)), calculate_average_discount_rate<T0>(arg0, arg1, arg4)) / 0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u128((10000 as u128), 100000000)) as u64) + 1000000
    }
    ...
    public fun convert_ausd_to_stablecoin<T0>(arg0: &Vault<T0>, arg1: u64) : u64 {
        ...
        if (v0 == v1) {
            ...
            0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u64(arg1, (0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_pow(10, ((v0 - v1) as u128)) as u64))
        } else {
            arg1 / (0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_pow(10, ((v1 - v0) as u128)) as u64)
        }
    }
    ...
    public fun convert_stablecoin_to_ausd<T0>(arg0: &Vault<T0>, arg1: u64) : u64 {
        ...
        if (v0 == v1) {
            ...
            arg1 / (0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_pow(10, ((v0 - v1) as u128)) as u64)
        } else {
            0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_mul_u64(arg1, (0x64aea91a5dcde6d2f50f35bd1d2df82d85756b8e71043b8ad580b60f856e3f77::math_utils::safe_pow(10, ((v1 - v0) as u128)) as u64))
        }
    }

    public fun create_vault<T0>(arg0: &VaultRegistry, arg1: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        verify_registry_governance_association(arg0, arg1);
        assert!(0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_admin(arg1, 0x2::tx_context::sender(arg3)), 1);
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: &VaultRegistry, arg2: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        verify_vault_registry_association<T0>(arg0, arg1);
        verify_registry_governance_association(arg1, arg2);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_admin(arg2, v0), 1);
    ...
    public fun deposit_ausd(arg0: &mut VaultRegistry, arg1: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg2: 0x2::coin::Coin<0xd5dcd0e791949074b70af25dd6b0c2e121adcfa8a062a779846bf1dd5e0f4b9a::ausd::AUSD>, arg3: &0x2::tx_context::TxContext) {
        verify_registry_governance_association(arg0, arg1);
        assert!(0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_admin(arg1, 0x2::tx_context::sender(arg3)), 1);
    ...
    public fun init_vault_registry(arg0: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_admin(arg0, 0x2::tx_context::sender(arg1)), 1);
        let v0 = VaultRegistry{
            id                     : 0x2::object::new(arg1),
            governance_registry_id : 0x2::object::id<0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry>(arg0),
    ...
    entry fun redeem<T0>(arg0: &mut Vault<T0>, arg1: &mut VaultRegistry, arg2: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg3: 0x2::coin::Coin<0xd5dcd0e791949074b70af25dd6b0c2e121adcfa8a062a779846bf1dd5e0f4b9a::ausd::AUSD>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        verify_vault_registry_association<T0>(arg0, arg1);
        verify_registry_governance_association(arg1, arg2);
        assert!(!0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_governance_paused(arg2) && !arg0.is_paused, 2);
    ...
    public fun set_vault_pause<T0>(arg0: &mut Vault<T0>, arg1: &VaultRegistry, arg2: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        verify_vault_registry_association<T0>(arg0, arg1);
        verify_registry_governance_association(arg1, arg2);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_admin(arg2, v0), 1);
    ...
    entry fun stake<T0>(arg0: &mut Vault<T0>, arg1: &mut VaultRegistry, arg2: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        verify_vault_registry_association<T0>(arg0, arg1);
        verify_registry_governance_association(arg1, arg2);
        assert!(!0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_governance_paused(arg2) && !arg0.is_paused, 2);
    ...
    fun verify_registry_governance_association(arg0: &VaultRegistry, arg1: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry) {
        assert!(arg0.governance_registry_id == 0x2::object::id<0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry>(arg1), 7);
    }
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: &VaultRegistry, arg2: &0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::GovernanceRegistry, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        verify_vault_registry_association<T0>(arg0, arg1);
        verify_registry_governance_association(arg1, arg2);
        assert!(0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_admin(arg2, 0x2::tx_context::sender(arg5)), 1);
        assert!(0x17fb0204ea475c2f6ccafbc5cc1bc757f106b6c6983b989dc863fdec316b7502::vault_governance::is_whitelisted(arg2, arg3), 4);
        assert!(arg4 > 0, 5);
