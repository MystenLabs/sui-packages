module 0x1708f186f5b75e945d14f6860227cefb0e9b332d0b82a29fc48438ebefae3eb9::street_m_ch_n {
    struct STREET_M_CH_N has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STREET_M_CH_N, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STREET_M_CH_N>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Street M@ch!n"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Robots with street cred "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://XSi9DXkQmp-kMHzQdNz8moRCcTThyuAkHRUooVgwH50"));
