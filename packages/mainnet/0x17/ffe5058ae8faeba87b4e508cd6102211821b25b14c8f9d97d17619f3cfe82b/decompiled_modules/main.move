module 0x17ffe5058ae8faeba87b4e508cd6102211821b25b14c8f9d97d17619f3cfe82b::main {
    ...
    public fun finalize_market<T0, T1>(arg0: &MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x17ffe5058ae8faeba87b4e508cd6102211821b25b14c8f9d97d17619f3cfe82b::vault::LpVault<T0, T1> {
        ...
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v12) {
                ...
                let v22 = 0x17ffe5058ae8faeba87b4e508cd6102211821b25b14c8f9d97d17619f3cfe82b::vault::id<T0, T1>(&v4);
                let v23 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0x17ffe5058ae8faeba87b4e508cd6102211821b25b14c8f9d97d17619f3cfe82b::vault::id_to_address(&v22),
                    curator          : arg1.curator,
                    pool_address     : v21,
                    initialize_price : v15,
                    amount_y         : v5,
                    amount_x         : v6,
                    position_id      : 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v19),
                };
                ...
                0x17ffe5058ae8faeba87b4e508cd6102211821b25b14c8f9d97d17619f3cfe82b::vault::add_position<T0, T1>(&mut v4, v28);
                let v31 = 0x17ffe5058ae8faeba87b4e508cd6102211821b25b14c8f9d97d17619f3cfe82b::vault::id<T0, T1>(&v4);
                let v32 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0x17ffe5058ae8faeba87b4e508cd6102211821b25b14c8f9d97d17619f3cfe82b::vault::id_to_address(&v31),
                    curator          : arg1.curator,
                    pool_address     : v30,
                    initialize_price : v24,
                    amount_y         : v5,
                    amount_x         : v6,
                    position_id      : 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v28),
                };
