module 0x1741eccf990227a8f1178fc09958ab4435e4de245ee4b49726024c9064a1068e::reward3080 {
    struct REWARD3080 has drop {
        dummy_field: bool,
    }

    struct TICKET_3080 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3080(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3080>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3080>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3080, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3080>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3080>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3080>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3080>>(v5, 0x2::tx_context::sender(arg1));
    }
