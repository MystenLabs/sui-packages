module 0x177c0aba961efa509c72b90b190c728362ef2d4bc44486366dbebf07a0c9d2bc::gift7288 {
    struct GIFT7288 has drop {
        dummy_field: bool,
    }

    struct TICKET_7288 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7288(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7288>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7288>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7288, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7288>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7288>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7288>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7288>>(v5, 0x2::tx_context::sender(arg1));
    }
