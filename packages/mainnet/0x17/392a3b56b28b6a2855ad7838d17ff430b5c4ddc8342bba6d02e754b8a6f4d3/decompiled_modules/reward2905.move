module 0x17392a3b56b28b6a2855ad7838d17ff430b5c4ddc8342bba6d02e754b8a6f4d3::reward2905 {
    struct REWARD2905 has drop {
        dummy_field: bool,
    }

    struct TICKET_2905 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2905(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2905>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2905>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2905, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2905>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2905>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2905>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2905>>(v5, 0x2::tx_context::sender(arg1));
    }
