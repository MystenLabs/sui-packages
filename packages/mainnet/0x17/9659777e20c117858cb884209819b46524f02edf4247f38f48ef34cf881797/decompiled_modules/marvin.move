module 0x179659777e20c117858cb884209819b46524f02edf4247f38f48ef34cf881797::marvin {
    struct MARVIN has drop {
        dummy_field: bool,
    }

    struct Marvin has store, key {
        id: 0x2::object::UID,
    ...
    struct AttributeUpdatedEvent has copy, drop {
        marvin_id: 0x2::object::ID,
        attribute_type: 0x1::string::String,
        new_value: 0x1::string::String,
        updater: address,
    }

    struct MarvinMintedEvent has copy, drop {
        marvin_id: 0x2::object::ID,
        name: 0x1::string::String,
        description: 0x1::string::String,
        image_url: 0x1::string::String,
    ...
    struct MarvinBurnedEvent has copy, drop {
        marvin_id: 0x2::object::ID,
        name: 0x1::string::String,
        burned_by: address,
        burn_timestamp: u64,
    ...
    public fun attributes(arg0: &Marvin) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }

    public fun batch_burn(arg0: &AdminCap, arg1: vector<Marvin>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<Marvin>(&arg1)) {
            let v1 = 0x1::vector::pop_back<Marvin>(&mut arg1);
            let v2 = MarvinBurnedEvent{
                marvin_id      : 0x2::object::id<Marvin>(&v1),
                name           : v1.name,
                burned_by      : 0x2::tx_context::sender(arg2),
                burn_timestamp : 0x2::tx_context::epoch_timestamp_ms(arg2),
            };
            0x2::event::emit<MarvinBurnedEvent>(v2);
            let Marvin {
                id           : v3,
                name         : _,
                description  : _,
        ...
        0x1::vector::destroy_empty<Marvin>(arg1);
    }

    public fun burn(arg0: &AdminCap, arg1: Marvin, arg2: &0x2::tx_context::TxContext) {
        let v0 = MarvinBurnedEvent{
            marvin_id      : 0x2::object::id<Marvin>(&arg1),
            name           : arg1.name,
            burned_by      : 0x2::tx_context::sender(arg2),
            burn_timestamp : 0x2::tx_context::epoch_timestamp_ms(arg2),
        };
        0x2::event::emit<MarvinBurnedEvent>(v0);
        let Marvin {
            id           : v1,
            name         : _,
            description  : _,
    ...
    public fun burn_by_owner(arg0: Marvin, arg1: &0x2::tx_context::TxContext) {
        let v0 = MarvinBurnedEvent{
            marvin_id      : 0x2::object::id<Marvin>(&arg0),
            name           : arg0.name,
    ...
    public fun description(arg0: &Marvin) : &0x1::string::String {
        &arg0.description
    }

    public fun external_url(arg0: &Marvin) : &0x1::option::Option<0x1::string::String> {
        &arg0.external_url
    }

    public fun get_attribute_value(arg0: &Marvin, arg1: 0x1::string::String) : 0x1::option::Option<0x1::string::String> {
    ...
    public fun image_url(arg0: &Marvin) : &0x1::string::String {
        &arg0.image_url
    }
    ...
    fun init(arg0: MARVIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::package::claim<MARVIN>(arg0, arg1);
        let v6 = 0x2::display::new_with_fields<Marvin>(&v5, v1, v3, arg1);
        0x2::display::update_version<Marvin>(&mut v6);
        0x2::transfer::public_transfer<0x2::display::Display<Marvin>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::package::Publisher>(v5);
    ...
    public fun mint(arg0: &AdminCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::option::Option<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: vector<0x1::string::String>, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MarvinMintedEvent{
            marvin_id    : 0x2::object::id<Marvin>(&v2),
            name         : arg1,
            description  : arg2,
            image_url    : arg3,
            website_url  : arg4,
        ...
        0x2::event::emit<MarvinMintedEvent>(v3);
        0x2::transfer::public_transfer<Marvin>(v2, arg8);
    }
    ...
    public fun mint_with_auth(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::option::Option<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: address, arg8: u64, arg9: u64, arg10: vector<u8>, arg11: &mut NonceRegistry, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<MarvinMintedEvent>(v3);
        0x2::transfer::public_transfer<Marvin>(v2, arg7);
    }

    public fun name(arg0: &Marvin) : &0x1::string::String {
        &arg0.name
    }

    public fun swap_attribute_values_with_auth(arg0: &mut Marvin, arg1: &mut Marvin, arg2: vector<0x1::string::String>, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: &mut NonceRegistry, arg9: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::epoch_timestamp_ms(arg9) <= arg5, 1);
        assert!(!0x2::vec_map::contains<u64, bool>(&arg8.used_nonces, &arg6), 2);
        ...
        assert!(0x2::ed25519::ed25519_verify(&arg7, &arg8.admin_public_key, &v1), 6);
        0x2::vec_map::insert<u64, bool>(&mut arg8.used_nonces, arg6, true);
        ...
        while (v3 < 0x1::vector::length<0x1::string::String>(&arg2)) {
            ...
            let v5 = if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg0.attributes, v4)) {
                let (_, v7) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut arg0.attributes, v4);
                0x1::option::some<0x1::string::String>(v7)
            } else {
                0x1::option::none<0x1::string::String>()
            };
            let v8 = v5;
            let v9 = if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg1.attributes, v4)) {
                let (_, v11) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut arg1.attributes, v4);
                0x1::option::some<0x1::string::String>(v11)
            } else {
                0x1::option::none<0x1::string::String>()
            };
            let v12 = v9;
            if (0x1::option::is_some<0x1::string::String>(&v12)) {
                let v13 = 0x1::option::destroy_some<0x1::string::String>(v12);
                0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut arg0.attributes, *v4, v13);
                let v14 = AttributeUpdatedEvent{
                    marvin_id      : 0x2::object::id<Marvin>(arg0),
                    attribute_type : *v4,
                    new_value      : v13,
                    updater        : v2,
                };
                0x2::event::emit<AttributeUpdatedEvent>(v14);
            };
            if (0x1::option::is_some<0x1::string::String>(&v8)) {
                let v15 = 0x1::option::destroy_some<0x1::string::String>(v8);
                0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut arg1.attributes, *v4, v15);
                let v16 = AttributeUpdatedEvent{
                    marvin_id      : 0x2::object::id<Marvin>(arg1),
                    attribute_type : *v4,
                    new_value      : v15,
                    updater        : v2,
                };
                0x2::event::emit<AttributeUpdatedEvent>(v16);
            };
            v3 = v3 + 1;
        };
        arg0.image_url = arg3;
        let v17 = ImageUrlUpdatedEvent{
            marvin_id     : 0x2::object::id<Marvin>(arg0),
            new_image_url : arg0.image_url,
            updater       : v2,
        };
        0x2::event::emit<ImageUrlUpdatedEvent>(v17);
        arg1.image_url = arg4;
        let v18 = ImageUrlUpdatedEvent{
            marvin_id     : 0x2::object::id<Marvin>(arg1),
            new_image_url : arg1.image_url,
            updater       : v2,
        };
        0x2::event::emit<ImageUrlUpdatedEvent>(v18);
    }
    ...
    public fun update_description(arg0: &AdminCap, arg1: &mut Marvin, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun update_external_url(arg0: &AdminCap, arg1: &mut Marvin, arg2: 0x1::option::Option<0x1::string::String>, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun update_image_url(arg0: &AdminCap, arg1: &mut Marvin, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun update_marvin_metadata_with_auth(arg0: &mut Marvin, arg1: 0x1::option::Option<0x1::string::String>, arg2: 0x1::option::Option<0x1::string::String>, arg3: 0x1::option::Option<0x1::string::String>, arg4: 0x1::option::Option<0x1::string::String>, arg5: 0x1::option::Option<0x1::option::Option<0x1::string::String>>, arg6: 0x1::option::Option<vector<0x1::string::String>>, arg7: 0x1::option::Option<vector<0x1::string::String>>, arg8: u64, arg9: u64, arg10: vector<u8>, arg11: &mut NonceRegistry, arg12: &0x2::tx_context::TxContext) {
        verify_auth_and_consume_nonce(arg11, arg9, arg8, &arg10, 0x2::bcs::to_bytes<0x1::option::Option<0x1::string::String>>(&arg3), arg12);
        let v0 = 0x2::object::id<Marvin>(arg0);
    ...
    public fun update_website_url(arg0: &AdminCap, arg1: &mut Marvin, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun website_url(arg0: &Marvin) : &0x1::string::String {
        &arg0.website_url
    }
