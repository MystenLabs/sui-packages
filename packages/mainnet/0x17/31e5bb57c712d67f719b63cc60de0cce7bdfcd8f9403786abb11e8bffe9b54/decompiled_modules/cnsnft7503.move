module 0x1731e5bb57c712d67f719b63cc60de0cce7bdfcd8f9403786abb11e8bffe9b54::cnsnft7503 {
    struct CNSNFT7503 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7503, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7503>(arg0, arg1);
