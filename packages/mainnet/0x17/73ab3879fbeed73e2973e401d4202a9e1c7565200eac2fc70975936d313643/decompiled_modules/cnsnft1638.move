module 0x1773ab3879fbeed73e2973e401d4202a9e1c7565200eac2fc70975936d313643::cnsnft1638 {
    struct CNSNFT1638 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1638, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1638>(arg0, arg1);
