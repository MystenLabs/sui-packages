module 0x17c583e17b98ea4e6a1eb24eaf6e68f38412ae4660e22777e8b267b0f7b5176c::reward2177 {
    struct REWARD2177 has drop {
        dummy_field: bool,
    }

    struct TICKET_2177 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2177(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2177>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2177>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2177, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2177>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2177>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2177>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2177>>(v5, 0x2::tx_context::sender(arg1));
    }
