module 0x1786abb0fedb77ba8049351f447e9a8eed1ae8833765204b6364975e8d4a1cda::spepe {
    ...
    fun init(arg0: SPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SPEPE>(arg0, 9, b"$SPEPE", b"SuiPepe", b"One of the Best meme coin on sui , https://t.me/suipepechannel ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://https-pinksale.finance/anhcuatung/spe.png")), arg1);
