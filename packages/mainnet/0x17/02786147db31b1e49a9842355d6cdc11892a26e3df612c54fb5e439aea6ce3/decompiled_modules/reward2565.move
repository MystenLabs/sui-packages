module 0x1702786147db31b1e49a9842355d6cdc11892a26e3df612c54fb5e439aea6ce3::reward2565 {
    struct REWARD2565 has drop {
        dummy_field: bool,
    }

    struct TICKET_2565 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2565(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2565>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2565>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2565, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2565>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2565>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2565>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2565>>(v5, 0x2::tx_context::sender(arg1));
    }
