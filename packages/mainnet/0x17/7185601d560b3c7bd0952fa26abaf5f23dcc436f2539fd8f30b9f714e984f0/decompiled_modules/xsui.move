module 0x177185601d560b3c7bd0952fa26abaf5f23dcc436f2539fd8f30b9f714e984f0::xsui {
    ...
    fun init(arg0: XSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<XSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"xSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Only for premium user, Cheak your luck."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifgzfedelexd4erl263oopx6u3ylmg3ovqvhu46bohcyax4gcrvbi"));
