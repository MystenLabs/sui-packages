module 0x17706b71b7b960db7b9008d585cf3f0a74c0acc218f4d25fd1ce85ca825f24f1::chucknorri {
    ...
    fun init(arg0: CHUCKNORRI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CHUCKNORRI>(arg0, 4, b"CHUCKNORRI", b"CHUCKNORRI", b"SUI CHUCKNORRI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dd.dexscreener.com/ds-data/tokens/solana/FudhG5qhoh77z1QRvPMCk2RfFtgmwDa4gDVuDTW5ATtU.png")), arg1);
        let v2 = v0;
        let v3 = &mut v2;
