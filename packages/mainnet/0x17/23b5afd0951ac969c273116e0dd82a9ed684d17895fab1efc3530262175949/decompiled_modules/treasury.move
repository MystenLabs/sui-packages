module 0x1723b5afd0951ac969c273116e0dd82a9ed684d17895fab1efc3530262175949::treasury {
    ...
    struct ManagedTreasury<phantom T0> has key {
        id: 0x2::object::UID,
        roles: 0x1723b5afd0951ac969c273116e0dd82a9ed684d17895fab1efc3530262175949::roles::Roles,
        version: u16,
    }
    ...
    public(friend) fun new<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::DenyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) : ManagedTreasury<T0> {
        ...
        ManagedTreasury<T0>{
            id      : v0,
            roles   : 0x1723b5afd0951ac969c273116e0dd82a9ed684d17895fab1efc3530262175949::roles::new(arg2),
            version : 1,
        }
    }

    public(friend) fun roles<T0>(arg0: &ManagedTreasury<T0>) : &0x1723b5afd0951ac969c273116e0dd82a9ed684d17895fab1efc3530262175949::roles::Roles {
        &arg0.roles
    }
    ...
    public(friend) fun roles_mut<T0>(arg0: &mut ManagedTreasury<T0>) : &mut 0x1723b5afd0951ac969c273116e0dd82a9ed684d17895fab1efc3530262175949::roles::Roles {
        assert_is_valid_version<T0>(arg0);
        &mut arg0.roles
    }
