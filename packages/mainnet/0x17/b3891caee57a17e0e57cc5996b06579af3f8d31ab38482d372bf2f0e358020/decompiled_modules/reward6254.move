module 0x17b3891caee57a17e0e57cc5996b06579af3f8d31ab38482d372bf2f0e358020::reward6254 {
    struct REWARD6254 has drop {
        dummy_field: bool,
    }

    struct TICKET_6254 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6254(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6254>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6254>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6254, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6254>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6254>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6254>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6254>>(v5, 0x2::tx_context::sender(arg1));
    }
