module 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::staking {
    ...
    public entry fun claim(arg0: &0x2::clock::Clock, arg1: &mut StakingVault, arg2: &mut 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::ProtocolTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        claim_tokens(v0, arg0, arg1, arg2, arg3);
    }
    ...
    public fun calculate_stake_with_remainder(arg0: &0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::Stork, arg1: u64, arg2: &0x2::clock::Clock) : (u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg2) - arg1;
        (v0 / 86400000 * get_stake_per_day(arg0), v0 % 86400000)
    }

    public entry fun claim_all(arg0: &0x2::package::Publisher, arg1: vector<address>, arg2: &0x2::clock::Clock, arg3: &mut StakingVault, arg4: &mut 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::ProtocolTreasury, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 0, 7);
        assert!(0x2::package::from_package<STAKING>(arg0), 8);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            claim_tokens(*0x1::vector::borrow<address>(&arg1, v0), arg2, arg3, arg4, arg5);
            v0 = v0 + 1;
        };
    }

    public entry fun claim_all_public(arg0: vector<address>, arg1: &0x2::clock::Clock, arg2: &mut StakingVault, arg3: &mut 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 0, 7);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg0)) {
            claim_tokens(*0x1::vector::borrow<address>(&arg0, v0), arg1, arg2, arg3, arg4);
            v0 = v0 + 1;
        };
    }

    public entry fun claim_all_public_v2(arg0: vector<0x2::object::ID>, arg1: &0x2::clock::Clock, arg2: &mut StakingVault, arg3: &mut 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 0, 7);
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg0)) {
            claim_tokens_v2(*0x1::vector::borrow<0x2::object::ID>(&mut arg0, v0), arg1, arg2, arg3, arg4);
            v0 = v0 + 1;
        };
    }

    fun claim_tokens(arg0: address, arg1: &0x2::clock::Clock, arg2: &mut StakingVault, arg3: &mut 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, vector<0x2::object::ID>>(&mut arg2.reverse_owners, arg0), 0);
        let v0 = *0x2::table::borrow<address, vector<0x2::object::ID>>(&mut arg2.reverse_owners, arg0);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            claim_tokens_v2(*0x1::vector::borrow<0x2::object::ID>(&v0, v1), arg1, arg2, arg3, arg4);
            v1 = v1 + 1;
        };
    }

    fun claim_tokens_v2(arg0: 0x2::object::ID, arg1: &0x2::clock::Clock, arg2: &mut StakingVault, arg3: &mut 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x2::object::ID, u64>(&mut arg2.token_timestamps, arg0), 3);
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&mut arg2.id, arg0), 3);
        let v0 = 0x2::dynamic_object_field::borrow<0x2::object::ID, 0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::Stork>(&mut arg2.id, arg0);
        let (v1, v2) = calculate_stake_with_remainder(v0, *0x2::table::borrow<0x2::object::ID, u64>(&mut arg2.token_timestamps, arg0), arg1);
        if (v1 > 0) {
            assert!(0x2::table::contains<0x2::object::ID, address>(&arg2.owners, 0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::id(v0)), 3);
            0x2::table::remove<0x2::object::ID, u64>(&mut arg2.token_timestamps, arg0);
            0x2::table::add<0x2::object::ID, u64>(&mut arg2.token_timestamps, arg0, 0x2::clock::timestamp_ms(arg1) - v2);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::STORKTOKEN>>(0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::withdraw_staking(arg3, v1, arg4), *0x2::table::borrow<0x2::object::ID, address>(&arg2.owners, 0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::id(v0)));
        };
    }
