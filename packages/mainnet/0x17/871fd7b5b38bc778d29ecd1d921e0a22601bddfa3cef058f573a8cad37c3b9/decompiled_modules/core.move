module 0x80febc8885804d47c9dfdb08a78d21811fb54d1972418211d709da4937a0d8b2::core {
    ...
    struct BurnedForStats has copy, drop {
        core_id: 0x2::object::ID,
        owner: address,
        serial: u64,
        bot_id: 0x2::object::ID,
    ...
    public fun burn_for_stats(arg0: PrimeCore, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) : UpgradeReceipt {
        let PrimeCore {
            id          : v0,
            name        : _,
            description : _,
        ...
        let v9 = BurnedForStats{
            core_id : v7,
            owner   : v8,
            serial  : v4,
            bot_id  : arg1,
        };
        0x2::event::emit<BurnedForStats>(v9);
        0x2::object::delete(v6);
        UpgradeReceipt{
            core_id : v7,
            serial  : v4,
    ...
    public fun consume_upgrade_receipt(arg0: UpgradeReceipt) : (0x2::object::ID, u64, 0x2::object::ID, address) {
        let UpgradeReceipt {
            core_id : v0,
            serial  : v1,
            bot_id  : v2,
