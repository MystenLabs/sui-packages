module 0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::bidirectional_kiosk_transfer {
    ...
    public entry fun batch_transfer_same_collection<T0: store + key>(arg0: &mut 0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: vector<0x2::object::ID>, arg5: address, arg6: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::register_kiosk_internal(arg0, arg5, v6);
    ...
    public entry fun create_and_register_personal_kiosk(arg0: &mut 0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let (v1, v2) = 0x2::kiosk::new(arg2);
        let v3 = v1;
        let v4 = 0x2::object::id<0x2::kiosk::Kiosk>(&v3);
        0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::register_kiosk_internal(arg0, v0, v4);
    ...
    public fun get_user_registered_kiosk(arg0: &0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: address) : 0x1::option::Option<0x2::object::ID> {
        0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::get_user_kiosk(arg0, arg1)
    }

    public entry fun gift_nft<T0: store + key>(arg0: &mut 0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: 0x2::object::ID, arg5: address, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun smart_transfer<T0: store + key>(arg0: &mut 0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: 0x2::object::ID, arg5: address, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun transfer_nft_to_address<T0: store + key>(arg0: &mut 0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: 0x2::object::ID, arg5: address, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg7);
        assert!(0x2::kiosk::owner(arg1) == v0, 1);
        assert!(0x2::kiosk::has_access(arg1, arg2), 4);
        ...
        0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::register_kiosk_internal(arg0, arg5, v9);
    ...
    public entry fun transfer_nft_to_existing_kiosk<T0: store + key>(arg0: &0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg6: 0x2::object::ID, arg7: address, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::get_user_kiosk(arg0, arg7);
    ...
    public fun user_has_registered_kiosk(arg0: &0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::KioskRegistry, arg1: address) : bool {
        0x17ce87611c3edd46bbe97dc14ba93e7d5f10d6428c4bcbc5059c1323938a3e57::kiosk_registry::has_registered_kiosk(arg0, arg1)
    }
