module 0x17a134461731dd6fe505f883bf16eef2a737e565ac8f32e473207da90769822a::asdasd {
    ...
    fun init(arg0: ASDASD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ASDASD>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"asdasd"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"glassatrail "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigz32guebd2wjm6njigsiiyyjpwva5whm4eatdqmlz7cvbs7rpxly"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 3000, 0);
