module 0x179dfcc9a0ebdbe9237097f646d358722f44fc04cfcb42d4c945fb3f72ef1105::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 9, b"testFCoin", b"testFCoin", b"testFCoin", 0x1::option::none<0x2::url::Url>(), arg1);
