module 0x17a415b6491e318df79dcac400710c1ef582406df48043dabccfdb19e77c5feb::mm_demo {
    ...
    public fun swap<T0, T1>(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: u64, arg4: 0x1::string::String, arg5: 0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::confirmer::SwapCert<T0, T1>, arg6: &mut 0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::fee_tier::FeeTier, arg7: &0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::versioned::Versioned, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v1 = 0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::confirmer::get_quote_id<T0, T1>(&arg5);
        ...
        let v4 = 0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::confirmer::take_input_coin<T0, T1>(&mut arg5, arg7);
        ...
        0xda99bccc952ed900ddf73f89a4558ea21b8d254a0253be0152902f472ac6f802::confirmer::destroy_swap_cert<T0, T1>(arg5, arg6, 0x2::balance::split<T1>(0x2::coin::balance_mut<T1>(v7), arg2), arg7, arg9);
    }
