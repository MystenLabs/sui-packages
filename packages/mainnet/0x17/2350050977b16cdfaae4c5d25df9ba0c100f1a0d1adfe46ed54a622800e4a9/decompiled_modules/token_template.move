module 0x172350050977b16cdfaae4c5d25df9ba0c100f1a0d1adfe46ed54a622800e4a9::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"FIN115876", b"FixedInit 115876", b"Fixed with initial supply verification", 0x1::option::none<0x2::url::Url>(), arg1);
