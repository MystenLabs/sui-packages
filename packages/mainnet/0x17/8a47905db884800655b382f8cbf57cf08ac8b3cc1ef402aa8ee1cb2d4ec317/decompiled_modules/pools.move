module 0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::pools {
    ...
    public fun create_fee_pool<T0>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = FeePool<T0>{
    ...
    public fun create_reward_pool<T0>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_reward_pool_game<T0, T1>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_reward<T0>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::TreasureCap, arg1: 0x2::coin::Coin<T0>, arg2: &mut RewardPool<T0>, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun deposit_reward_pool_game<T0, T1>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::TreasureCap, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut RewardPoolGame<T0, T1>, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun emergency_reward_withdraw<T0>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::TreasureCap, arg1: &mut RewardPool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun emergency_reward_withdraw_pool_game<T0, T1>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::TreasureCap, arg1: &mut RewardPoolGame<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
    ...
    public(friend) fun transfer_checkin_reward<T0>(arg0: &mut 0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::archive::UserArchive, arg1: u64, arg2: &mut RewardPool<T0>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::archive::inc_checkin_reward(arg0, arg1)
    }

    public(friend) fun transfer_mission_reward<T0>(arg0: &mut 0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::archive::UserArchive, arg1: &mut RewardPool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::archive::inc_mission_reward(arg0, arg2);
    ...
    public fun withdraw_fee_pool<T0>(arg0: &0x178a47905db884800655b382f8cbf57cf08ac8b3cc1ef402aa8ee1cb2d4ec317::manager::TreasureCap, arg1: &mut FeePool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::balance::value<T0>(&arg1.balance) > 0, 3000);
        let v1 = 0x2::balance::value<T0>(&arg1.balance);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.balance, v1), arg2), v0);
