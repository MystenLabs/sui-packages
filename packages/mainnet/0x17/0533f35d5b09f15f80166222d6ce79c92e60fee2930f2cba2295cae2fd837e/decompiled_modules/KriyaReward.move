module 0x170533f35d5b09f15f80166222d6ce79c92e60fee2930f2cba2295cae2fd837e::KriyaReward {
    ...
    fun init(arg0: KRIYAREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<KRIYAREWARD>(arg0, 9, b"$ rkriya.cc - Kriya Reward Token", b"rkriya.cc", b"$10,000 Reward Token for empowering Kriya Finance.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/rkryia_0712/kriya_token_0712_1.jpg")), arg1);
