module 0x178c317da6bf011564d118ae05fca326513cecca6418ab59111071f0f5002ac4::reward9912 {
    struct REWARD9912 has drop {
        dummy_field: bool,
    }

    struct TICKET_9912 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9912(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9912>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9912>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9912, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9912>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9912>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9912>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9912>>(v5, 0x2::tx_context::sender(arg1));
    }
