module 0x17ed255a26d5799b05b5e6f68d7910a18c359ee540b0f025e4bdd9fae0d5fc43::god {
    struct GOD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GOD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<GOD>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GOD     ")))), trim_right(b"I don't know where to begin     "), trim_right(b"ELYSIUM is a backronym:                                                                                                                                                                                                                                                                                                         "), v2, arg1);
