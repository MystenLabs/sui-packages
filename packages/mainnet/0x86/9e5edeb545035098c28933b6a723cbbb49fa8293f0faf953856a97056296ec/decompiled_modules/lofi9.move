module 0x869e5edeb545035098c28933b6a723cbbb49fa8293f0faf953856a97056296ec::lofi9 {
    struct LOFI9 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI9, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI9>(arg0, 9, b"LOFI9", b"LOFI9", b"LOFI9", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI9>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI9>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI9>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI9>(0x2::coin::balance_mut<LOFI9>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI9>>(0x2::coin::from_balance<LOFI9>(0x2::balance::split<LOFI9>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI9>>(0x2::coin::from_balance<LOFI9>(0x2::balance::split<LOFI9>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI9>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI9>>(0x2::coin::from_balance<LOFI9>(v3, arg5), arg4);
        };
    }
