module 0x867d1d86a2a11203368d10ee17d2dec627c83d011c19d3b5228860da3eb793c5::cnsnft9972 {
    struct CNSNFT9972 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9972, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9972>(arg0, arg1);
