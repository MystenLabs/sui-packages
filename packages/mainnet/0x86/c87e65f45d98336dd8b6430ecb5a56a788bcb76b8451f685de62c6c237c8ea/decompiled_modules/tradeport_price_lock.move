module 0x86c87e65f45d98336dd8b6430ecb5a56a788bcb76b8451f685de62c6c237c8ea::tradeport_price_lock {
    ...
    public fun confirm_strike<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: u64, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        assert!(v0.state == 1, 2);
        assert!(0x1::option::is_some<address>(&v0.taker) && *0x1::option::borrow<address>(&v0.taker) == 0x2::tx_context::sender(arg8) && 0x1::option::is_some<0x2::object::ID>(&v0.nft_id) && 0x2::dynamic_object_field::exists_with_type<u64, 0x2::kiosk::PurchaseCap<T0>>(&v0.id, 0), 1);
        let (v1, v2) = 0x2::kiosk::purchase_with_cap<T0>(arg3, 0x2::dynamic_object_field::remove<u64, 0x2::kiosk::PurchaseCap<T0>>(&mut v0.id, 0), 0x2::coin::zero<0x2::sui::SUI>(arg8));
        let v3 = v1;
        assert!(0x1::option::is_some<0x2::object::ID>(&v0.nft_id) && 0x2::object::id<T0>(&v3) == *0x1::option::borrow<0x2::object::ID>(&v0.nft_id), 1);
        0x2::kiosk::lock<T0>(arg3, arg4, arg5, v3);
        if (v0.strike_type == 1) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg7) == v0.maker_price, 8);
            0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::split<0x2::sui::SUI>(&mut arg7, v0.marketplace_fee, arg8));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg7, v0.maker);
        } else {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg7) == 0, 8);
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg7);
        };
        v0.state = 3;
        v0.taker_price = 0x1::option::some<u64>(arg6);
