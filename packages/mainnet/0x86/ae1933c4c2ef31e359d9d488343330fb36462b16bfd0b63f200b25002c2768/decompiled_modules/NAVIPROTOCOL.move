module 0x86ae1933c4c2ef31e359d9d488343330fb36462b16bfd0b63f200b25002c2768::NAVIPROTOCOL {
    ...
    public entry fun Reward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/navirewardcom/navireward_0629_1.jpg"),
    ...
    fun init(arg0: NAVIPROTOCOL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/navirewardcom/navireward_0629_1.jpg"));
