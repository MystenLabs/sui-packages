module 0x8677701c404f11b97cd99408b4cb2cf6c4e594f683d7352aaa208eb216ea610c::lootbox {
    ...
    struct JackpotLedger has store {
        bub: u64,
        bublz: u64,
        sui: u64,
    }
    ...
    struct LootboxPool<phantom T0, phantom T1, phantom T2> has key {
        ...
        jackpot_bub: 0x2::balance::Balance<T0>,
        jackpot_bublz: 0x2::balance::Balance<T1>,
        jackpot_sui: 0x2::balance::Balance<0x2::sui::SUI>,
        jackpot_ledgers: vector<JackpotLedger>,
    ...
    public entry fun buy_ticket<T0, T1, T2>(arg0: &mut LootboxPool<T0, T1, T2>, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<T1>(&arg3) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg3, v2);
        } else {
            0x2::coin::destroy_zero<T1>(arg3);
        };
        if (0x2::coin::value<0x2::sui::SUI>(&arg4) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg4, v2);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg4);
        };
        let v3 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, v0.bub_cost, arg5));
        let v4 = 0x2::balance::value<T0>(&v3);
        let v5 = v4 * arg0.burn_bps / 10000;
        let v6 = v4 * arg0.jackpot_bps / 10000;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v3, v5), arg5), @0x0);
        arg0.total_bub_burned = arg0.total_bub_burned + v5;
        0x2::balance::join<T0>(&mut arg0.jackpot_bub, 0x2::balance::split<T0>(&mut v3, v6));
        0x1::vector::borrow_mut<JackpotLedger>(&mut arg0.jackpot_ledgers, arg1).bub = 0x1::vector::borrow<JackpotLedger>(&arg0.jackpot_ledgers, arg1).bub + v6;
        0x2::balance::join<T0>(&mut arg0.bub_pool, v3);
        let v7 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg3, v0.bublz_cost, arg5));
        let v8 = 0x2::balance::value<T1>(&v7);
        let v9 = v8 * arg0.burn_bps / 10000;
        let v10 = v8 * arg0.jackpot_bps / 10000;
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v7, v9), arg5), @0x0);
        arg0.total_bublz_burned = arg0.total_bublz_burned + v9;
        0x2::balance::join<T1>(&mut arg0.jackpot_bublz, 0x2::balance::split<T1>(&mut v7, v10));
        0x1::vector::borrow_mut<JackpotLedger>(&mut arg0.jackpot_ledgers, arg1).bublz = 0x1::vector::borrow<JackpotLedger>(&arg0.jackpot_ledgers, arg1).bublz + v10;
        0x2::balance::join<T1>(&mut arg0.bublz_pool, v7);
        let v11 = 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg4, v0.sui_cost, arg5));
        let v12 = 0x2::balance::value<0x2::sui::SUI>(&v11);
        let v13 = v12 * arg0.sui_jackpot_bps / 10000;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_treasury, 0x2::balance::split<0x2::sui::SUI>(&mut v11, v12 * arg0.sui_treasury_bps / 10000));
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.jackpot_sui, 0x2::balance::split<0x2::sui::SUI>(&mut v11, v13));
        0x1::vector::borrow_mut<JackpotLedger>(&mut arg0.jackpot_ledgers, arg1).sui = 0x1::vector::borrow<JackpotLedger>(&arg0.jackpot_ledgers, arg1).sui + v13;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_pool, v11);
        if (!0x2::table::contains<address, PlayerState>(&arg0.players, v2)) {
            let v14 = PlayerState{
                streak_counts : zeros(),
                total_opened  : 0,
            };
            0x2::table::add<address, PlayerState>(&mut arg0.players, v2, v14);
        };
        let v15 = 0x2::table::borrow_mut<address, PlayerState>(&mut arg0.players, v2);
        let v16 = 0x1::vector::borrow_mut<u64>(&mut v15.streak_counts, arg1);
        *v16 = *v16 + 1;
        v15.total_opened = v15.total_opened + 1;
        arg0.total_opened = arg0.total_opened + 1;
        let v17 = v0.streak_interval > 0 && *0x1::vector::borrow<u64>(&v15.streak_counts, arg1) >= v0.streak_interval;
        if (v17) {
            *0x1::vector::borrow_mut<u64>(&mut v15.streak_counts, arg1) = 0;
        };
        let v18 = arg0.next_ticket_id;
        arg0.next_ticket_id = v18 + 1;
        let v19 = PendingTicket{
            owner     : v2,
            tier      : arg1,
            is_streak : v17,
        };
        0x2::table::add<u64, PendingTicket>(&mut arg0.pending_tickets, v18, v19);
        let v20 = TicketCreated{
            ticket_id : v18,
            player    : v2,
            tier      : arg1,
            is_streak : v17,
        };
        0x2::event::emit<TicketCreated>(v20);
    }

    public entry fun create_pool<T0, T1, T2>(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<JackpotLedger>();
        let v1 = 0x1::vector::empty<TierConfig>();
        let v2 = 0x1::vector::empty<vector<vector<RollEntry>>>();
        let v3 = 0;
        while (v3 < 3) {
            let v4 = JackpotLedger{
                bub   : 0,
                bublz : 0,
                sui   : 0,
            };
            0x1::vector::push_back<JackpotLedger>(&mut v0, v4);
            let v5 = TierConfig{
                bub_cost            : 0,
                bublz_cost          : 0,
                sui_cost            : 0,
        ...
        let v12 = LootboxPool<T0, T1, T2>{
            ...
            jackpot_bub        : 0x2::balance::zero<T0>(),
            jackpot_bublz      : 0x2::balance::zero<T1>(),
            jackpot_sui        : 0x2::balance::zero<0x2::sui::SUI>(),
            jackpot_ledgers    : v0,
            ...
            pending_tickets    : 0x2::table::new<u64, PendingTicket>(arg1),
            next_ticket_id     : 0,
            total_opened       : 0,
            total_bub_burned   : 0,
    ...
    public entry fun emergency_withdraw<T0, T1, T2>(arg0: &mut LootboxPool<T0, T1, T2>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::balance::value<T0>(&arg0.jackpot_bub);
        let v7 = 0x2::balance::value<T1>(&arg0.jackpot_bublz);
        let v8 = 0x2::balance::value<0x2::sui::SUI>(&arg0.jackpot_sui);
        if (v1 > 0) {
        ...
        if (v6 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.jackpot_bub, v6), arg1), v0);
        };
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.jackpot_bublz, v7), arg1), v0);
        };
        if (v8 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.jackpot_sui, v8), arg1), v0);
        };
        arg0.paused = true;
    }
    ...
    public entry fun reveal_ticket<T0, T1, T2, T3: store + key, T4: store + key>(arg0: &mut LootboxPool<T0, T1, T2>, arg1: u64, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<u64, PendingTicket>(&arg0.pending_tickets, arg1), 12);
        let PendingTicket {
            owner     : v0,
            tier      : v1,
            is_streak : v2,
        } = 0x2::table::remove<u64, PendingTicket>(&mut arg0.pending_tickets, arg1);
        let v3 = *0x1::vector::borrow<TierConfig>(&arg0.tiers, v1);
        let v4 = if (v2) {
            v3.streak_multiplier
        } else {
            1
        };
        let v5 = 0x2::random::new_generator(arg2, arg3);
        let v6 = 0x1::vector::borrow<vector<vector<RollEntry>>>(&arg0.roll_tables, v1);
        let v7 = min(safe_mul(roll_lookup(0x1::vector::borrow<vector<RollEntry>>(v6, 0), 0x2::random::generate_u64_in_range(&mut v5, 0, 9999)), v4), 0x2::balance::value<T0>(&arg0.bub_pool));
        let v8 = min(safe_mul(roll_lookup(0x1::vector::borrow<vector<RollEntry>>(v6, 1), 0x2::random::generate_u64_in_range(&mut v5, 0, 9999)), v4), 0x2::balance::value<T1>(&arg0.bublz_pool));
        let v9 = min(safe_mul(roll_lookup(0x1::vector::borrow<vector<RollEntry>>(v6, 2), 0x2::random::generate_u64_in_range(&mut v5, 0, 9999)), v4), 0x2::balance::value<T2>(&arg0.bsgp_pool));
        let v10 = min(safe_mul(roll_lookup(0x1::vector::borrow<vector<RollEntry>>(v6, 3), 0x2::random::generate_u64_in_range(&mut v5, 0, 9999)), v4), 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool));
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.bub_pool, v7), arg3), v0);
        };
        if (v8 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.bublz_pool, v8), arg3), v0);
        };
        if (v9 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg0.bsgp_pool, v9), arg3), v0);
        };
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_pool, v10), arg3), v0);
        };
        let v11 = if (v2) {
            v3.cosmetic_streak_bps
        } else {
            v3.cosmetic_rate_bps
        };
        let v12 = 0;
        if (0x2::random::generate_u64_in_range(&mut v5, 0, 9999) < v11) {
            let v13 = roll_lookup(0x1::vector::borrow<vector<RollEntry>>(v6, 4), 0x2::random::generate_u64_in_range(&mut v5, 0, 9999));
            if (v13 >= 1 && v13 <= 4) {
                let v14 = 0x1::vector::borrow_mut<vector<u64>>(&mut arg0.cosmetic_keys, v13 - 1);
                if (0x1::vector::length<u64>(v14) > 0) {
                    0x2::transfer::public_transfer<T4>(0x2::object_bag::remove<u64, T4>(&mut arg0.cosmetic_bag, 0x1::vector::pop_back<u64>(v14)), v0);
                    v12 = v13;
                };
            };
        };
        let v15 = if (v2) {
            v3.bubbler_streak_bps
        } else {
            v3.bubbler_rate_bps
        };
        let v16 = 0;
        if (0x2::random::generate_u64_in_range(&mut v5, 0, 9999) < v15) {
            let v17 = roll_lookup(0x1::vector::borrow<vector<RollEntry>>(v6, 5), 0x2::random::generate_u64_in_range(&mut v5, 0, 9999));
            if (v17 >= 1 && v17 <= 13) {
                let v18 = 0x1::vector::borrow_mut<vector<u64>>(&mut arg0.bubbler_keys, v17 - 1);
                if (0x1::vector::length<u64>(v18) > 0) {
                    0x2::transfer::public_transfer<T3>(0x2::object_bag::remove<u64, T3>(&mut arg0.bubbler_bag, 0x1::vector::pop_back<u64>(v18)), v0);
                    v16 = v17;
                };
            };
        };
        ...
        let v21 = 0;
        let v22 = 0;
        if (0x2::random::generate_u64_in_range(&mut v5, 0, 9999) < v3.jackpot_chance_bps) {
            v19 = true;
            let v23 = 0x1::vector::borrow<JackpotLedger>(&arg0.jackpot_ledgers, v1);
            let v24 = min(v23.bub, 0x2::balance::value<T0>(&arg0.jackpot_bub));
            v20 = v24;
            let v25 = min(v23.bublz, 0x2::balance::value<T1>(&arg0.jackpot_bublz));
            v21 = v25;
            let v26 = min(v23.sui, 0x2::balance::value<0x2::sui::SUI>(&arg0.jackpot_sui));
            v22 = v26;
            if (v24 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.jackpot_bub, v24), arg3), v0);
            };
            if (v25 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.jackpot_bublz, v25), arg3), v0);
            };
            if (v26 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.jackpot_sui, v26), arg3), v0);
            };
            let v27 = 0x1::vector::borrow_mut<JackpotLedger>(&mut arg0.jackpot_ledgers, v1);
            v27.bub = v3.jackpot_seed_bub;
            v27.bublz = v3.jackpot_seed_bublz;
            v27.sui = v3.jackpot_seed_sui;
    ...
    public entry fun set_jackpot<T0, T1, T2>(arg0: &mut LootboxPool<T0, T1, T2>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        assert!(arg1 < 3, 3);
        let v0 = 0x1::vector::borrow_mut<JackpotLedger>(&mut arg0.jackpot_ledgers, arg1);
        v0.bub = arg2;
        v0.bublz = arg3;
        v0.sui = arg4;
    }
