module 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        ...
        assert!(points_of(arg0, arg1) >= arg2, 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::insufficient_points());
        let v0 = if (0x2::table::contains<address, u64>(&arg0.spent, arg1)) {
            let v1 = *0x2::table::borrow<address, u64>(&arg0.spent, arg1) + arg2;
            *0x2::table::borrow_mut<address, u64>(&mut arg0.spent, arg1) = v1;
            v1
        } else {
            0x2::table::add<address, u64>(&mut arg0.spent, arg1, arg2);
            arg2
        };
        let v2 = Spent{
            user        : arg1,
    ...
    fun ensure_record_cap_working(arg0: &Recorder, arg1: &RecordCap) {
        assert!(0x2::object::id<RecordCap>(arg1) == arg0.record_cap, 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::invalid_record_cap());
    }

    public(friend) fun ensure_version_matches(arg0: &Recorder) {
    ...
    public fun record(arg0: &mut Recorder, arg1: &RecordCap, arg2: address, arg3: u64) {
        ensure_version_matches(arg0);
        ensure_record_cap_working(arg0, arg1);
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 > earned_of(arg0, arg1), 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
