module 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::liquidity_mining_reward_manager {
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg2 >= 0x2::clock::timestamp_ms(arg4), 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_invalid_start_time());
        assert!(arg3 - arg2 >= 3600000, 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_invalid_time());
        ...
        assert!(v3 < 50, 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_max_concurrent_pool_rewards_violated());
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v0.coin_type == 0x1::type_name::with_defining_ids<T0>(), 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_invalid_type());
        ...
        assert!(0x1::option::is_some<PositionReward>(v1), 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_no_reward_to_claim());
    ...
    public(friend) fun close_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) >= v4, 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_pool_reward_period_not_over());
        assert!(v8 == 0, 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_not_all_rewards_claimed());
    ...
    public(friend) fun remove_position_reward_manager(arg0: &mut PoolRewardManager, arg1: 0x2::object::ID) {
        ...
        let v3 = v1;
        assert!(v0 == 0, 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_share_not_zero());
        while (!0x1::vector::is_empty<0x1::option::Option<PositionReward>>(&v3)) {
            ...
            assert!(0x1::option::is_none<PositionReward>(&v4), 0x86c4b9b171fad8bd0c86624162247e687ade555f89bcaec255a2924969be95ab::errors::liquidity_mining_not_all_rewards_claimed());
