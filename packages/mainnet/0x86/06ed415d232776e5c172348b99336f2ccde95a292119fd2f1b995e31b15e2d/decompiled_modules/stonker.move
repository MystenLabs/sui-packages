module 0x8606ed415d232776e5c172348b99336f2ccde95a292119fd2f1b995e31b15e2d::stonker {
    ...
    fun input_signal_internal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: bool, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 && v7 + v8 < arg4) {
            let v10 = arg4 - v8;
            let v11 = arg0.parameters.order_size_base;
            let v12 = convert_to_quote_at_price(arg0, v11, v10);
            let v13 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1);
            if (v13 < v12) {
                let v14 = OutOfBalanceEvent{
                    is_buy           : true,
                    balance_required : v12,
                    balance          : v13,
                };
                0x2::event::emit<OutOfBalanceEvent>(v14);
                return
            };
            if (convert_to_quote_at_price(arg0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1) + v11, v10) > 8000000000) {
                let v15 = PositionLimitEvent{
                    order_quantity_quote : v12,
                    balance_quote        : v13,
                };
                0x2::event::emit<PositionLimitEvent>(v15);
                return
            };
            if (v10 > 3800000) {
                let v16 = PriceLimitEvent{
                    is_buy : true,
                    price  : v10,
                };
                0x2::event::emit<PriceLimitEvent>(v16);
                return
            };
            if (0x2::clock::timestamp_ms(arg3) < arg0.last_trade_time_ms + 1000) {
                let v17 = WithinCooldownEvent{
                    is_buy : true,
                    price  : v10,
                };
                0x2::event::emit<WithinCooldownEvent>(v17);
                return
            };
            let v18 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v18, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v10, arg0.parameters.order_size_base, true, false, 0x2::clock::timestamp_ms(arg3) + 1000, arg3, arg7);
            arg0.last_trade_time_ms = 0x2::clock::timestamp_ms(arg3);
            return
        };
        if (!arg5 && arg4 + v8 < v6) {
            let v19 = arg4 + v8;
            let v20 = arg0.parameters.order_size_base;
            let v21 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1);
            if (v21 < v20) {
                let v22 = OutOfBalanceEvent{
                    is_buy           : false,
                    balance_required : v20,
                    balance          : v21,
                };
                0x2::event::emit<OutOfBalanceEvent>(v22);
                return
            };
            if (v19 < 2800000) {
