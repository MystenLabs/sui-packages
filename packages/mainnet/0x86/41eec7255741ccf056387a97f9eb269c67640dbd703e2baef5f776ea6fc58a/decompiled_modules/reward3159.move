module 0x8641eec7255741ccf056387a97f9eb269c67640dbd703e2baef5f776ea6fc58a::reward3159 {
    struct REWARD3159 has drop {
        dummy_field: bool,
    }

    struct TICKET_3159 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3159(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3159>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3159>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3159, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3159>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3159>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3159>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3159>>(v5, 0x2::tx_context::sender(arg1));
    }
