module 0x864f15e94aa9d0ce82c22a309e57e034e818d72e94e49fc8a67b94b404abb8aa::sustatetoken {
    ...
    fun calculate_vesting_amount(arg0: &mut Distribution, arg1: u64) : u64 {
        ...
        if (v0 > 0 && arg0.vesting.tge_status) {
            let v2 = 0x864f15e94aa9d0ce82c22a309e57e034e818d72e94e49fc8a67b94b404abb8aa::math::mul_div(arg0.vesting.total_amount, v0, 100);
    ...
    fun init(arg0: SUSTATETOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = VestingMap{
            ...
            released_amount       : 0,
            vesting_start         : 2629800000 * 6 + 1683547200000,
            last_completed_period : 2629800000 * 6 + 1683547200000,
            tge_status            : true,
            tge_percent           : 0,
            cycle_amount          : 0x864f15e94aa9d0ce82c22a309e57e034e818d72e94e49fc8a67b94b404abb8aa::math::mul_div(8000000000000000, 20, 1000),
        };
        let v7 = Distribution{
            id      : 0x2::object::new(arg1),
            name    : name_generator(b"Team"),
            account : @0x96fa421b3331299e4856b5f50f62ec0af2784a34a7278fcad55c0286a351fee9,
            vesting : v6,
        };
        let v8 = VestingMap{
            ...
            tge_status            : true,
            tge_percent           : 7,
            cycle_amount          : 0x864f15e94aa9d0ce82c22a309e57e034e818d72e94e49fc8a67b94b404abb8aa::math::mul_div(62000000000000000, 30, 1000),
        };
        let v9 = Distribution{
            id      : 0x2::object::new(arg1),
        ...
        let v10 = VestingMap{
            ...
            tge_status            : true,
            tge_percent           : 2,
            cycle_amount          : 0x864f15e94aa9d0ce82c22a309e57e034e818d72e94e49fc8a67b94b404abb8aa::math::mul_div(20000000000000000, 35, 1000),
        };
