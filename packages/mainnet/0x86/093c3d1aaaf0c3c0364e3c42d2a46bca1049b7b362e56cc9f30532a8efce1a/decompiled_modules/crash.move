module 0x797e41e2832fec6106cdb590357e0146bd212dc00166c1341822b6cdc005c554::crash {
    ...
    fun generate_crash_multiplier(arg0: &mut 0x2::random::RandomGenerator) : u64 {
        let v0 = 0x2::random::generate_u64_in_range(arg0, 1, 10000);
        if (v0 <= 5000) {
            101 + v0 * 99 / 5000
        } else if (v0 <= 8000) {
    ...
    public entry fun play(arg0: &0x2::random::Random, arg1: &mut 0x797e41e2832fec6106cdb590357e0146bd212dc00166c1341822b6cdc005c554::casino::House, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg3);
        assert!(v0 >= 100000000, 1);
        assert!(arg2 >= 101, 2);
        assert!(arg2 <= 3000, 4);
        let v1 = calculate_payout(v0, arg2);
        assert!(0x797e41e2832fec6106cdb590357e0146bd212dc00166c1341822b6cdc005c554::casino::get_house_balance(arg1) >= v1, 3);
        ...
        let v6 = CrashEvent{
            ...
            crash_x100  : v4,
            win         : v5,
            payout      : 0x797e41e2832fec6106cdb590357e0146bd212dc00166c1341822b6cdc005c554::casino::process_game_bet(arg1, arg3, v5, v1, arg4),
        };
