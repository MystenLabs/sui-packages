module 0x861482099a4faef6c63ba9f7b49fa847b3178fd00ec03019df3b2ad1bf72b037::checkdot_bridge_v1 {
    ...
    public entry fun add_transfers_from(arg0: &mut Bridge, arg1: 0x1::string::String, arg2: address, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x711d2704034eeb509104481a99a556f17b6b444c7fed7cfb223fd5567af843ad::cdt::CDT>>(0x2::coin::take<0x711d2704034eeb509104481a99a556f17b6b444c7fed7cfb223fd5567af843ad::cdt::CDT>(&mut arg0.cdt_coin, arg3, arg5), arg2);
    ...
    fun get_hash(arg0: address, arg1: u64, arg2: &0x2::tx_context::TxContext) : vector<u8> {
    ...
    public entry fun init_transfer<T0>(arg0: &mut Bridge, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::coin::Coin<0x711d2704034eeb509104481a99a556f17b6b444c7fed7cfb223fd5567af843ad::cdt::CDT>, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x1::vector::length<Transfer>(&arg0.transfers);
        let v5 = get_hash(v0, v4, arg6);
        let v6 = Transfer{
            hash            : v5,
            from            : v0,
            quantity        : v2 - v3,
        ...
        0x1::vector::push_back<Transfer>(&mut arg0.transfers, v6);
        0x2::table::add<vector<u8>, vector<u8>>(&mut arg0.transfers_hashs, v5, v5);
        0x2::table::add<vector<u8>, u64>(&mut arg0.transfers_indexs, v5, v4);
    }
