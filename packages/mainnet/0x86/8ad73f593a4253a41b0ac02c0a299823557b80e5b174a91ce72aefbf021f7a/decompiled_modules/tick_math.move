module 0x868ad73f593a4253a41b0ac02c0a299823557b80e5b174a91ce72aefbf021f7a::tick_math {
    ...
    public(friend) fun next_initialized_tick(arg0: &0x2::table::Table<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, u256>, arg1: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, arg2: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, arg3: bool, arg4: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, arg5: u256) : (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::I32, u256) {
        ...
        let (v1, v2, v3) = if (arg3) {
            ...
            let v7 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::eq(v4, arg4)) {
                ...
                *0x2::table::borrow<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, u256>(arg0, 0x868ad73f593a4253a41b0ac02c0a299823557b80e5b174a91ce72aefbf021f7a::i32_utils::lib_to_mate(v4))
            };
            let v8 = v7;
            let v9 = v7 & (2 << v5) - 1;
            while (v9 == 0) {
                ...
                v6 = v10;
                let v11 = *0x2::table::borrow<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, u256>(arg0, 0x868ad73f593a4253a41b0ac02c0a299823557b80e5b174a91ce72aefbf021f7a::i32_utils::lib_to_mate(v10));
                v8 = v11;
                v9 = v11;
            };
            ...
            let v15 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::eq(v12, arg4)) {
                ...
                *0x2::table::borrow<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, u256>(arg0, 0x868ad73f593a4253a41b0ac02c0a299823557b80e5b174a91ce72aefbf021f7a::i32_utils::lib_to_mate(v12))
            };
            let v16 = v15;
            ...
            while (v17 == 0) {
                ...
                v14 = v18;
                let v19 = *0x2::table::borrow<0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, u256>(arg0, 0x868ad73f593a4253a41b0ac02c0a299823557b80e5b174a91ce72aefbf021f7a::i32_utils::lib_to_mate(v18));
                v16 = v19;
                v17 = v19;
            };
