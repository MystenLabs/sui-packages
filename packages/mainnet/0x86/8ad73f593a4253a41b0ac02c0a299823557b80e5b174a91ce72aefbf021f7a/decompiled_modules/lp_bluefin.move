module 0x868ad73f593a4253a41b0ac02c0a299823557b80e5b174a91ce72aefbf021f7a::lp_bluefin {
    ...
    fun swap_to_optimal<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg1: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: u64, arg6: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let (v0, v1, v2, v3) = 0x868ad73f593a4253a41b0ac02c0a299823557b80e5b174a91ce72aefbf021f7a::swap_math::optimal_swap<T0, T1>(arg1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::lower_tick(arg2)), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::upper_tick(arg2)), 0x2::balance::value<T0>(&arg3), 0x2::balance::value<T1>(&arg4));
        if (v0 == 0 && v1 == 0) {
            return (arg3, arg4)
        };
        let (v4, v5) = if (v2) {
        ...
        let v6 = if (v2) {
            v3 - 0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::safe_math::mul_div_u128(v3, 0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::constants::max_fee_pips_u128() - (arg5 as u128), 0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::constants::max_fee_pips_u128())
        } else {
            v3 + 0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::safe_math::mul_div_u128(v3, 0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::constants::max_fee_pips_u128() - (arg5 as u128), 0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::constants::max_fee_pips_u128())
        };
        let (v7, v8) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg6, arg0, arg1, v4, v5, v2, true, v0, 0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::constants::amount_after_fee(v1, arg5), v6);
    ...
    public fun zap_in<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg1: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (u64, u64, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0xbdd206795d752c347646a8be991edf30f8dc253b21c2b99a2bf485a2e27355db::events::emit_zapped_in(0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg1), 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(arg2), v0, v1);
