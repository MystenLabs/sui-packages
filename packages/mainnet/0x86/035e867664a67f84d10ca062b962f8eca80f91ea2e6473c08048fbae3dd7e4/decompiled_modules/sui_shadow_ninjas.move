module 0x86035e867664a67f84d10ca062b962f8eca80f91ea2e6473c08048fbae3dd7e4::sui_shadow_ninjas {
    struct SUI_SHADOW_NINJAS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_SHADOW_NINJAS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_SHADOW_NINJAS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI Shadow Ninjas"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dive into the SUI Shadow Realm"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreie5ygkzouhb6h5wmcqmvcu7mzn2lhat4oyugc4a7it75brl35pnjm"));
