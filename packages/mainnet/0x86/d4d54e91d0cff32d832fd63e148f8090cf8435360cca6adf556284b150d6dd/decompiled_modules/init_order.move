module 0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::init_order {
    ...
    public fun initialize_order<T0>(arg0: &mut 0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::state::State, arg1: &0xe3040102b5b4d6241b22e2c3c6d2abb41595849d939326e3d67bfd537ea34ee::state::FeeManagerState, arg2: &0x2::coin::CoinMetadata<T0>, arg3: address, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: address, arg7: u16, arg8: address, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: address, arg15: u8, arg16: u8, arg17: address, arg18: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::amount::normalize_amount(0x2::coin::value<T0>(&arg4), 0x2::coin::get_decimals<T0>(arg2));
        ...
        let v4 = 0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::order::new(arg3, 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::state::chain_id(), v2, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, v3, arg16, arg17);
        let v5 = 0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::order::to_hash(&v4);
        assert!(!0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::state::has_source_order(arg0, v5), 1);
        assert!(!0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::state::has_dest_order(arg0, v5), 1);
        let (v6, v7) = 0x86d4d54e91d0cff32d832fd63e148f8090cf8435360cca6adf556284b150d6dd::state::add_source_order<T0>(arg0, 0x2::coin::into_balance<T0>(arg4), v5, arg3, v2, arg7, arg11, arg12, arg18);
        let v8 = OrderCreated{
            hash                 : v5,
            trader               : arg3,
            token_in             : v2,
