module 0x86f2bae5c5f03bbb5d26c513943df7db03372ec7960da0eaa4b89991bf369bf2::reward7141 {
    struct REWARD7141 has drop {
        dummy_field: bool,
    }

    struct TICKET_7141 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7141(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7141>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7141>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7141, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7141>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7141>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7141>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7141>>(v5, 0x2::tx_context::sender(arg1));
    }
