module 0x8676de81e12b431d367a70800ce5cf6717becc9c8a54306cc48caac743ed5189::raging_bulls {
    ...
    fun init(arg0: RAGING_BULLS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RAGING_BULLS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Raging Bulls"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"10,000 Raging Bulls spearheading the NFT Bullrun on the Sui Blockchain! "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigrt4tmtgfp55xste3lwwpuhrbv3eaw5kfbvkhsaq2fdooa63zppm"));
