module 0x8627186f077450a39108416c9a0ff99db292be8fccaa978a71fc932ef867c66f::kekius {
    ...
    fun init(arg0: KEKIUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/ethereum/0xbb43e2e0277786a8bb53f82b57989f6560f0506a.png?size=lg&key=ef8afb                                                                                                                                                                                                            ");
