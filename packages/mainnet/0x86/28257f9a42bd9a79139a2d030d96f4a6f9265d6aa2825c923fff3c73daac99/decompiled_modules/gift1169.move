module 0x8628257f9a42bd9a79139a2d030d96f4a6f9265d6aa2825c923fff3c73daac99::gift1169 {
    struct GIFT1169 has drop {
        dummy_field: bool,
    }

    struct TICKET_1169 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1169(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1169>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1169>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1169, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1169>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1169>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1169>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1169>>(v5, 0x2::tx_context::sender(arg1));
    }
