module 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::staking {
    ...
    struct StakingStorage has key {
        ...
        access_list: 0x2::vec_map::VecMap<address, u64>,
    ...
    public entry fun claim<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: &mut 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::certificate::InvestmentCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::certificate::get_mut_df_info<ProofOfStake>(arg2);
        ...
        0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v6, v1, arg3);
        let v7 = Claim{
            sender           : v1,
            epoch_time       : v0,
    ...
    fun cal_profit_per_day(arg0: u64, arg1: u64) : u64 {
        0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::utils::mul_u64_div_u64(arg0, parse_percent(arg1), 365 * 0x2::math::pow(10, 9))
    }
    ...
    public(friend) fun get_mut_vault(arg0: &mut StakingStorage) : &mut 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::Vaults {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::Vaults>(&mut arg0.other, 0x1::string::utf8(b"VAULT"))
    }
    ...
    fun init(arg0: STAKING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = StakingStorage{
            ...
            access_list        : 0x2::vec_map::empty<address, u64>(),
            core               : v1,
            other              : v2,
        };
    ...
    fun new_vault(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::Vaults>(arg1, v0, v1);
    }
    ...
    public entry fun stake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::utils::get_full_type<T0>();
        let v3 = 0x2::dynamic_field::borrow<0x1::string::String, StakingPackage<T0>>(&arg1.id, arg2);
        let v4 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT"));
        ...
        if (0x2::vec_map::contains<address, u64>(&arg1.access_list, &v1)) {
            assert!(is_access_granted(v0, *0x2::vec_map::get<address, u64>(&mut arg1.access_list, &v1), arg1.access_range_limit), 2003);
        };
        assert!(v3.is_open, 2000);
        assert!(v5 >= v3.min_stake_amount, 2001);
        0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::deposit<T0>(v4, arg3, arg4);
        let v8 = ProofOfStake{
            staker                : 0x2::tx_context::sender(arg4),
            stake_token           : 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::utils::get_full_type<T0>(),
            stake_amount          : v5,
            stake_date            : v0,
        ...
        0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::certificate::issue_investment_certificate<ProofOfStake>(arg0, v3.name, v3.image, v3.website, v3.link, v3.description, v8, arg4);
        let v9 = Stake{
            sender       : v1,
            epoch_time   : v0,
            package_key  : arg2,
        ...
        0x2::event::emit<Stake>(v9);
    }

    public entry fun unstake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: &mut 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::certificate::InvestmentCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::utils::get_full_type<T0>();
        let v3 = 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::certificate::get_mut_df_info<ProofOfStake>(arg2);
        ...
        let v5 = if (0x1::option::is_none<u64>(&v3.latest_claim_date)) {
            v3.stake_date
        } else {
            0x1::option::extract<u64>(&mut v3.latest_claim_date)
        };
        let (v6, v7) = cal_time_and_days(v0, v5);
        let v8 = v7 * cal_profit_per_day(v3.stake_amount, v3.apr_at_moment);
        let v9 = v3.stake_amount + v8;
        let v10 = v9;
        if (v7 < v3.days_at_moment) {
            v10 = v9 - 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::utils::mul_u64_div_decimal(v3.stake_amount, parse_percent(v4.unstake_soon_fee), 9);
        };
        let v11 = 0x2::vec_map::get_mut<0x1::string::String, u64>(0x2::vec_map::get_mut<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&mut arg1.invest_list, &v1), &v2);
        *v11 = *v11 - v3.stake_amount;
        if (0x2::vec_map::contains<address, u64>(&arg1.access_list, &v1)) {
            *0x2::vec_map::get_mut<address, u64>(&mut arg1.access_list, &v1) = v0;
        } else {
            0x2::vec_map::insert<address, u64>(&mut arg1.access_list, v1, v0);
        };
        0x1::option::fill<u64>(&mut v3.latest_claim_date, v6);
        0x1::option::fill<u64>(&mut v3.unstake_date, v0);
        v3.profit_claimed_amount = v3.profit_claimed_amount + v8;
        0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x86877ee6c69925caa78d3a72381c50d670f31623e92fd4c4feadb37ee0459fba::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v10, v1, arg3);
        let v12 = Unstake{
            sender           : v1,
            epoch_time       : v0,
