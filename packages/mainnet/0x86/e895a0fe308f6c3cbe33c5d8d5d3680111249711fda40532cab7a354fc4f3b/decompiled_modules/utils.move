module 0xfe1e08693803f16c94e4edc096386f0580f646b002b9bdbfa159ce25ca4e4668::utils {
    public fun get_description_nft() : vector<u8> {
        b"SUI STRIKER IS A GLOBAL BLOCKCHAIN TOURNAMENT GAME WITH NFTS REWARDS"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeidjtlygrd3kd3elub4lm6kvfk6l5nsmnbvy6t3usezqgbajcv4wry/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeifndkhr5agf6czyddjg2k755a73jpvx5nyefrzcgkwiblcxbp5byi/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/suistriker"
    }
