module 0x86d954a09e06d88ee38d3f2315d66940af69bf74471e86d789889af261c202ce::reward3404 {
    struct REWARD3404 has drop {
        dummy_field: bool,
    }

    struct TICKET_3404 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3404(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3404>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3404>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3404, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3404>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3404>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3404>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3404>>(v5, 0x2::tx_context::sender(arg1));
    }
