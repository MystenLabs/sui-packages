module 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::market {
    ...
    public fun swap_v2_ptb<T0, T1, T2>(arg0: &mut Market<T0>, arg1: &0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::model::RebaseFeeModel, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: VaultsValuation, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        if (0x1::option::is_some<SwapPriceTimestampConfig>(&v15)) {
            ...
            assert!(v19 <= v16.max_interval, 10041);
        };
        let v20 = &arg0.id;
        ...
        let (v33, v34) = 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::pool::swap_out<T2>(0x2::bag::borrow_mut<VaultName<T2>, 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::pool::Vault<T2>>(&mut arg0.vaults, v32), arg1, &v28, arg3, v30, v14, v3, v2, get_vault_amount_config<T0, T2>(arg0));
        let v35 = v33;
        let v36 = Swapped<T1, T2>{
            ...
            fee_value     : 0xf7fade57462e56e2eff1d7adef32e4fd285b21fd81f983f407bb7110ca766cda::decimal::add(v31, v34),
        };
