module 0x866181b497b2bbd7c9e1a6c68b26d11086a1ed05669be15f2562aef0837e900b::fullsail_clmm {
    public fun fullsail_clmm_add_liquidity<T0, T1>(arg0: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg1: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::rewarder::RewarderGlobalVault, arg2: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::position::Position, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: u128, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::current_sqrt_price<T0, T1>(arg0);
        let (v1, v2) = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::position::tick_range(arg4);
        let v3 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::tick_math::get_sqrt_price_at_tick(v1);
        let v4 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::tick_math::get_sqrt_price_at_tick(v2);
        if (arg7 != 0) {
            if (arg7 >= v4) {
                assert!(v0 >= v4, 0);
            } else if (arg7 <= v3) {
        ...
        if (v0 < v4) {
            let v7 = if (v0 <= v3) {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_a(v3, v4, 0x2::coin::value<T0>(&arg5), false)
            } else {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_a(v0, v4, 0x2::coin::value<T0>(&arg5), false)
            };
            v5 = v7;
        };
        if (v0 > v3) {
            let v8 = if (v0 >= v4) {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_b(v3, v4, 0x2::coin::value<T1>(&arg6), false)
            } else {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_b(v3, v0, 0x2::coin::value<T1>(&arg6), false)
            };
            v6 = v8;
        };
        let v9 = if (v0 <= v3) {
        ...
        let v10 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::add_liquidity<T0, T1>(arg2, arg1, arg0, arg4, v9, arg3);
        let v11 = 0x2::coin::into_balance<T0>(arg5);
        let v12 = 0x2::coin::into_balance<T1>(arg6);
        let (v13, v14) = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::add_liquidity_pay_amount<T0, T1>(&v10);
        0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::repay_add_liquidity<T0, T1>(arg2, arg0, 0x2::balance::split<T0>(&mut v11, v13), 0x2::balance::split<T1>(&mut v12, v14), v10);
        (0x2::coin::from_balance<T0>(v11, arg8), 0x2::coin::from_balance<T1>(v12, arg8))
    }
    ...
    public fun fullsail_clmm_remove_liquidity<T0, T1>(arg0: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg1: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::rewarder::RewarderGlobalVault, arg2: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::position::Position, arg5: u128, arg6: u128, arg7: bool, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        if (arg6 != 0) {
            ...
            let v3 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::tick_math::get_sqrt_price_at_tick(v1);
            if (arg6 >= v3) {
                assert!(0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::current_sqrt_price<T0, T1>(arg0) >= v3, 0);
            } else if (arg6 <= v2) {
                assert!(0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::current_sqrt_price<T0, T1>(arg0) <= v2, 0);
            } else {
                assert!(0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::current_sqrt_price<T0, T1>(arg0) == arg6, 0);
            };
        };
        if (arg5 == 0) {
        ...
        let v6 = v5;
        let v7 = v4;
        let (v8, v9) = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::collect_fee<T0, T1>(arg2, arg0, arg4, false);
        0x2::balance::join<T0>(&mut v7, v8);
        0x2::balance::join<T1>(&mut v6, v9);
        if (arg7) {
            0x2::balance::join<T0>(&mut v7, 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::collect_reward<T0, T1, T0>(arg2, arg0, arg4, arg1, false, arg3));
        };
        if (arg8) {
            0x2::balance::join<T1>(&mut v6, 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::collect_reward<T0, T1, T1>(arg2, arg0, arg4, arg1, false, arg3));
        };
