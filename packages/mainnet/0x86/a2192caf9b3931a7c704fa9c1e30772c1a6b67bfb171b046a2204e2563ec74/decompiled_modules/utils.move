module 0x86a2192caf9b3931a7c704fa9c1e30772c1a6b67bfb171b046a2204e2563ec74::utils {
    public fun add_delta(arg0: u128, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::I128) : u128 {
        ...
        if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::is_neg(arg1)) {
            assert!(arg0 >= v0, 0x86a2192caf9b3931a7c704fa9c1e30772c1a6b67bfb171b046a2204e2563ec74::errors::insufficient_liquidity());
            arg0 - v0
        } else {
            assert!(v0 < 0x86a2192caf9b3931a7c704fa9c1e30772c1a6b67bfb171b046a2204e2563ec74::constants::max_u128() - arg0, 0x86a2192caf9b3931a7c704fa9c1e30772c1a6b67bfb171b046a2204e2563ec74::errors::insufficient_liquidity());
            arg0 + v0
        }
    }
    ...
    public fun deposit_balance<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: 0x2::balance::Balance<T0>, arg2: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::balance::value<T0>(&arg1) >= arg2, 0x86a2192caf9b3931a7c704fa9c1e30772c1a6b67bfb171b046a2204e2563ec74::errors::insufficient_coin_balance());
    ...
    public fun withdraw_balance<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::balance::value<T0>(arg0) >= arg1, 0x86a2192caf9b3931a7c704fa9c1e30772c1a6b67bfb171b046a2204e2563ec74::errors::insufficient_coin_balance());
