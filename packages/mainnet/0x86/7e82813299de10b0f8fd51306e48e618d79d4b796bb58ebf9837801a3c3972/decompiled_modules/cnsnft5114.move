module 0x867e82813299de10b0f8fd51306e48e618d79d4b796bb58ebf9837801a3c3972::cnsnft5114 {
    struct CNSNFT5114 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5114, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5114>(arg0, arg1);
