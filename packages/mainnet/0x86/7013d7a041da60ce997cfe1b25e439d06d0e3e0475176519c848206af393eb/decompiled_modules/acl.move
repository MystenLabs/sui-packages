module 0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::acl {
    ...
    public fun destroy<T0>(arg0: SuperAdmin<T0>) {
        ...
        let v3 = v0;
        0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::sam_events::destroy_super_admin(0x2::object::uid_to_address(&v3));
    ...
    public fun destroy_admin<T0>(arg0: &mut ACL<T0>, arg1: Admin<T0>) {
        ...
        0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::sam_events::destroy_admin(0x2::object::uid_to_address(&v0));
        0x2::object::delete(v0);
    }

    public fun finish_transfer<T0>(arg0: SuperAdmin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.start != 18446744073709551615 && 0x2::tx_context::epoch(arg1) > arg0.start + 3, 0);
        let v0 = arg0.new_admin;
        arg0.new_admin = @0x0;
        arg0.start = 18446744073709551615;
        0x2::transfer::transfer<SuperAdmin<T0>>(arg0, v0);
        0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::sam_events::finish_super_admin_transfer(v0);
    }
    ...
    public fun new_admin<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: &mut 0x2::tx_context::TxContext) : Admin<T0> {
        ...
        0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::sam_events::new_admin(0x2::object::uid_to_address(&v0.id));
        v0
    }
    ...
    public fun revoke<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: address) {
        ...
        0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::sam_events::revoke_admin(arg2);
    }

    public fun revoke_with_cap<T0>(arg0: &mut ACL<T0>, arg1: &SuperAdmin<T0>, arg2: &Admin<T0>) {
        let v0 = 0x2::object::uid_to_address(&arg2.id);
        0x2::vec_set::remove<address>(&mut arg0.admins, &v0);
        0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::sam_events::revoke_admin(0x2::object::uid_to_address(&arg2.id));
    }
    ...
    public fun start_transfer<T0>(arg0: &mut SuperAdmin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.new_admin = arg1;
        0x867013d7a041da60ce997cfe1b25e439d06d0e3e0475176519c848206af393eb::sam_events::start_super_admin_transfer(arg1, arg0.start);
    }
