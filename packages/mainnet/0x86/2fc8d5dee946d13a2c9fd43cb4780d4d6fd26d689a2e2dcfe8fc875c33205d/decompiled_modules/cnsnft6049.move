module 0x862fc8d5dee946d13a2c9fd43cb4780d4d6fd26d689a2e2dcfe8fc875c33205d::cnsnft6049 {
    struct CNSNFT6049 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6049, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6049>(arg0, arg1);
