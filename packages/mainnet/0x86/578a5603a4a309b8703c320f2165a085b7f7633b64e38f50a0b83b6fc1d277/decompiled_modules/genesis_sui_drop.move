module 0x86578a5603a4a309b8703c320f2165a085b7f7633b64e38f50a0b83b6fc1d277::genesis_sui_drop {
    struct GENESIS_SUI_DROP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GENESIS_SUI_DROP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GENESIS_SUI_DROP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"GENESIS SUI DROP"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"GENESIS SUI DROP "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://zyy_YX-dAlGKVXgQ1BIUV_zleuvxfeDTBXsk_mgn-Bc"));
