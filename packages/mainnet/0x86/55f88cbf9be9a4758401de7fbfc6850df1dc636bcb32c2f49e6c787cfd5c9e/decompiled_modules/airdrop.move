module 0x8655f88cbf9be9a4758401de7fbfc6850df1dc636bcb32c2f49e6c787cfd5c9e::airdrop {
    ...
    public entry fun create_pool<T0>(arg0: &0x2::clock::Clock, arg1: vector<u8>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 != @0x96fa421b3331299e4856b5f50f62ec0af2784a34a7278fcad55c0286a351fee9 || v0 != @0x96fa421b3331299e4856b5f50f62ec0af2784a34a7278fcad55c0286a351fee9) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= 100000000, 7);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, 100000000, arg4), @0x96fa421b3331299e4856b5f50f62ec0af2784a34a7278fcad55c0286a351fee9);
