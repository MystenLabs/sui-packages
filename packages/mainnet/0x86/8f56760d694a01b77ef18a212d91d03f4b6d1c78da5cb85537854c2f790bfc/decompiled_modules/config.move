module 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::ACL,
        package_version: u64,
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::Member> {
        0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun add_in_coin_type<T0>(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        assert!(0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 1), 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::error::e_unauthorized_operator());
    ...
    public fun checked_oracle(arg0: &GlobalConfig, arg1: address) {
        assert!(0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::has_role(&arg0.acl, arg1, 2), 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::error::e_unauthorized_oracle());
    }

    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(2 >= arg0.package_version, 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::error::e_package_version_check_failed());
    }

    public fun claim_fee<T0>(arg0: &GlobalConfig, arg1: &mut ProtocolFeeVault, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 1), 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::error::e_unauthorized_operator());
    ...
    fun claim_fee_internal<T0>(arg0: &mut ProtocolFeeVault) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v0), 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::error::e_coin_type_not_found_in_vault());
    ...
    public fun claim_fee_with_cap<T0>(arg0: &GlobalConfig, arg1: &mut ProtocolFeeVault, arg2: &OperatorCap) : 0x2::balance::Balance<T0> {
        checked_package_version(arg0);
        assert!(0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::has_role(&arg0.acl, 0x2::object::id_address<OperatorCap>(arg2), 3), 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::error::e_unauthorized_operator_with_cap());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::new(arg0),
            package_version       : 1,
        ...
        0x868f56760d694a01b77ef18a212d91d03f4b6d1c78da5cb85537854c2f790bfc::acl::set_roles(&mut v0.acl, v3, 2);
