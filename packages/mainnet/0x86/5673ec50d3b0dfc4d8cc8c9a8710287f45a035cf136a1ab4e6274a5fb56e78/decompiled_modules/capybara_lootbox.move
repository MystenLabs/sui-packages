module 0x99a1800ce832f92814fac7f0b5ed1e98317a33d5325b2498d6c62356b08a39f4::capybara_lootbox {
    ...
    public fun mint_lootbox(arg0: &mut DataStorage, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = MintLootbox{
            ...
            lootbox_idxs : v3,
            random_id    : arg2,
            kiosk        : 0x2::object::id<0x2::kiosk::Kiosk>(arg6),
            kiok_cap     : 0x2::object::id<0x2::kiosk::KioskOwnerCap>(arg7),
        };
    ...
    public fun update_storage(arg0: &0x99a1800ce832f92814fac7f0b5ed1e98317a33d5325b2498d6c62356b08a39f4::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
