module 0x863d8a71811ca8e7690b097474419f86fd1aa47e0ebc19c26611f5d997058117::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"RIPY", b"Rippley", b"undefined", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/media/G4z31A2bQAAbr4v.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Rippley"),
            symbol     : 0x1::string::utf8(b"RIPY"),
            decimals   : 9,
