    ...
    fun adjust_user_share_limited<T0>(arg0: &mut UserShareRegistry, arg1: &mut SubVault<T0>, arg2: u64, arg3: u64, arg4: 0x1::option::Option<UserShareKey>, arg5: u64) : (0x1::option::Option<UserShareKey>, u64, u64) {
        ...
        if (arg2 > 0 && arg3 > 0) {
            while (0x1::option::is_some<UserShareKey>(&v1) && arg5 > 0) {
                ...
                let v3 = *0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::borrow<UserShareKey, u64>(&mut arg0.id, &arg1.user_shares, v2);
                let v4 = (((arg3 as u128) * (v3 as u128) / (arg2 as u128)) as u64);
                arg3 = arg3 - v4;
                arg2 = arg2 - v3;
                ...
                if (v3 >= v4) {
                    remove_share<T0>(arg0, arg1, v2.user, 0x1::option::some<u64>(v3 - v4));
                } else {
                    add_share<T0>(arg0, arg1, v2.user, v4 - v3);
                };
                arg5 = arg5 - 1;
            };
        } else {
