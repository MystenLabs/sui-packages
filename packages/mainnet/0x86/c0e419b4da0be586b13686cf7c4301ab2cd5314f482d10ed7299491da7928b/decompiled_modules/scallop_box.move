module 0x86c0e419b4da0be586b13686cf7c4301ab2cd5314f482d10ed7299491da7928b::scallop_box {
    ...
    public(friend) fun mint(arg0: &mut ScallopBoxStats, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : ScallopBox {
    ...
    public(friend) fun total_minted(arg0: &ScallopBoxStats) : u64 {
        arg0.total_minted
    }
