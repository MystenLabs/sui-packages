module 0x86c97141a29f0b1e95e57b660bd65abd99faf2c816208774a69d6d5907fe3ae1::cnsnft1461 {
    struct CNSNFT1461 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1461, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1461>(arg0, arg1);
