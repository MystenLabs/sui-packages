module 0x86a49ea50f3f7fb32c083bcf4e0de706d769657e25b687f7bb1867ad75e37417::signature_verifier {
    ...
    public fun admin_cleanup_expired_nonces(arg0: &mut SignatureConfig, arg1: vector<u64>, arg2: u64, arg3: &0x86a49ea50f3f7fb32c083bcf4e0de706d769657e25b687f7bb1867ad75e37417::admin::DropkitAdminCap) : u64 {
        let v0 = 0;
        let v1 = 0;
    ...
    public fun admin_remove_expired_nonce(arg0: &mut SignatureConfig, arg1: u64, arg2: u64, arg3: &0x86a49ea50f3f7fb32c083bcf4e0de706d769657e25b687f7bb1867ad75e37417::admin::DropkitAdminCap) : bool {
    ...
    public fun set_signature_requirement(arg0: &mut SignatureConfig, arg1: bool, arg2: vector<u8>, arg3: &0x86a49ea50f3f7fb32c083bcf4e0de706d769657e25b687f7bb1867ad75e37417::admin::DropkitAdminCap) {
        if (arg1) {
    ...
    public fun update_backend_public_key(arg0: &mut SignatureConfig, arg1: vector<u8>, arg2: &0x86a49ea50f3f7fb32c083bcf4e0de706d769657e25b687f7bb1867ad75e37417::admin::DropkitAdminCap) {
        assert!(!0x1::vector::is_empty<u8>(&arg1), 12);
        assert!(0x1::vector::length<u8>(&arg1) == 32, 5);
