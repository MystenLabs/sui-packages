module 0x8699ff15ffdc088bfac589f72d72523ba027bca6b1fc0f9acf546666abb40c2f::token_factory {
    ...
    public fun create_agent_with_aida<T0, T1>(arg0: &mut AgentRegistry, arg1: 0x2::coin::Coin<T1>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<vector<u8>>, arg9: 0x2::coin::TreasuryCap<T0>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (AgentMetadata, 0x8699ff15ffdc088bfac589f72d72523ba027bca6b1fc0f9acf546666abb40c2f::bonding_curve::BondingCurve<T0>) {
        ...
        let v4 = 0x8699ff15ffdc088bfac589f72d72523ba027bca6b1fc0f9acf546666abb40c2f::bonding_curve::create_bonding_curve<T0>(arg9, v1, arg11);
        ...
        let v7 = AgentMetadata{
            ...
            creator          : v1,
            bonding_curve_id : 0x2::object::id_address<0x8699ff15ffdc088bfac589f72d72523ba027bca6b1fc0f9acf546666abb40c2f::bonding_curve::BondingCurve<T0>>(&v4),
            created_at       : v2,
    ...
    public fun create_agent_with_sui<T0>(arg0: &mut AgentRegistry, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<vector<u8>>, arg9: 0x2::coin::TreasuryCap<T0>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (AgentMetadata, 0x8699ff15ffdc088bfac589f72d72523ba027bca6b1fc0f9acf546666abb40c2f::bonding_curve::BondingCurve<T0>) {
        ...
        let v2 = 0x8699ff15ffdc088bfac589f72d72523ba027bca6b1fc0f9acf546666abb40c2f::bonding_curve::create_bonding_curve<T0>(arg9, v0, arg11);
        ...
        let v5 = AgentMetadata{
            ...
            image_url        : 0x1::string::utf8(arg5),
            creator          : v0,
            bonding_curve_id : 0x2::object::id_address<0x8699ff15ffdc088bfac589f72d72523ba027bca6b1fc0f9acf546666abb40c2f::bonding_curve::BondingCurve<T0>>(&v2),
            created_at       : v1,
            personality      : 0x1::string::utf8(arg6),
            goals            : 0x1::string::utf8(arg7),
            capabilities     : v3,
