module 0x86a34ac485a11a58c531e4f1a6ef147c0b24e05eb82e83eb9f0ddac7b3c14419::cnsnft2041 {
    struct CNSNFT2041 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2041, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2041>(arg0, arg1);
