module 0x866040bf37b4b3c5d9485b19ed6b05b96485a51474c2f244e1700517778a4fc1::suiwin {
    ...
    struct Outcome_Baccarat has copy, drop {
        bet: u64,
        winvol: u64,
        b: vector<u8>,
        p: vector<u8>,
    ...
    fun baccarat_compare_cards(arg0: &vector<u8>, arg1: &vector<u8>) : u8 {
        let v0 = *0x1::vector::borrow<u8>(arg0, 0);
        let v1 = *0x1::vector::borrow<u8>(arg0, 1);
        let v2 = *0x1::vector::borrow<u8>(arg1, 0);
        let v3 = *0x1::vector::borrow<u8>(arg1, 1);
        let v4 = *0x1::vector::borrow<u8>(arg1, 2);
        let v5 = (v0 + v1) % 10;
        let v6 = (v2 + v3) % 10;
        let v7 = (v0 + v1 + *0x1::vector::borrow<u8>(arg0, 2)) % 10;
        let v8 = (v2 + v3 + v4) % 10;
        let v9 = if (v5 == 8) {
            true
        } else if (v5 == 9) {
    ...
    fun baccarat_dealing_cards(arg0: &0x2::random::Random, arg1: &mut 0x2::tx_context::TxContext) : vector<u8> {
        let v0 = 0x2::random::new_generator(arg0, arg1);
        let v1 = 0;
        let v2 = 0x1::vector::empty<u8>();
        while (v1 < 3) {
            let v3 = 0x2::random::generate_u8_in_range(&mut v0, 1, 13);
            let v4 = v3;
            if (v3 > 9) {
                v4 = 0;
            };
    ...
    entry fun game_stake_Baccarat(arg0: &0x2::random::Random, arg1: &mut GameData, arg2: u8, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg3);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.balance) > v0, 0);
        assert!(v0 >= arg1.min_bet && v0 <= arg1.max_bet, 1);
        assert!(arg2 < 3, 3);
        0x2::coin::put<0x2::sui::SUI>(&mut arg1.balance, arg3);
        let v1 = baccarat_dealing_cards(arg0, arg4);
        let v2 = baccarat_dealing_cards(arg0, arg4);
        let v3 = baccarat_compare_cards(&v1, &v2);
        let v4 = if (arg2 == v3) {
            if (v3 == 2) {
                let v5 = v0 * 2;
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.balance, v5, arg4), 0x2::tx_context::sender(arg4));
                v5
            } else if (v3 == 1) {
                let v6 = v0 / 100 * 195;
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.balance, v6, arg4), 0x2::tx_context::sender(arg4));
                v6
            } else {
                let v7 = v0 * 9;
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.balance, v7, arg4), 0x2::tx_context::sender(arg4));
                v7
            }
        } else if (v3 == 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.balance, v0, arg4), 0x2::tx_context::sender(arg4));
            v0
        } else {
            0
        };
        let v8 = Outcome_Baccarat{
            bet    : v0,
            winvol : v4,
            b      : v1,
            p      : v2,
        ...
        0x2::event::emit<Outcome_Baccarat>(v8);
    }
