module 0x869bfe3bf67db3938af7dc772a5888ec2565be5d1add4e765dc80191e73b8e54::dlmm_adapters {
    ...
    fun cetus_fee_for_id(arg0: &CetusFeeState, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) : u64 {
        ...
        let v3 = if (arg0.variable_fee_control == 0) {
            0
        } else {
            let v4 = (v2 as u256) * (arg0.bin_step as u256);
            let v5 = ((arg0.variable_fee_control as u256) * v4 * v4 + 99999999999) / 100000000000;
            assert!(v5 <= 18446744073709551615, 802);
            (v5 as u64)
        };
        if (v3 > 100000000 || arg0.base_fee_rate > 100000000 - v3) {
            100000000
        } else {
            arg0.base_fee_rate + v3
        }
    }
