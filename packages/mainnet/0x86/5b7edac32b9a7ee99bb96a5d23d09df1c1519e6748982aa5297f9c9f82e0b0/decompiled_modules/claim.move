module 0x865b7edac32b9a7ee99bb96a5d23d09df1c1519e6748982aa5297f9c9f82e0b0::claim {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        token_balance: 0x2::balance::Balance<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>,
    }
    ...
    entry fun claim(arg0: &PauseState, arg1: &mut LimitManager, arg2: &mut Treasury, arg3: &mut MappingsStorage, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2.amount;
        assert!(0x2::balance::value<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&arg2.token_balance) >= v3, 1302);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>>(0x2::coin::from_balance<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(0x2::balance::split<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&mut arg2.token_balance, v3), arg6), v0);
    ...
    fun deposit_tokens(arg0: &mut Treasury, arg1: 0x2::coin::Coin<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        emit_function_call(b"deposit_tokens", v0, arg3, arg4);
        validate_amount(arg2);
        let v1 = 0x2::coin::value<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&arg1);
        assert!(v1 >= arg2, 1302);
        if (v1 == arg2) {
            0x2::balance::join<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&mut arg0.token_balance, 0x2::coin::into_balance<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(arg1));
        } else {
            0x2::balance::join<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&mut arg0.token_balance, 0x2::coin::into_balance<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(0x2::coin::split<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&mut arg1, arg2, arg4)));
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>>(arg1, v0);
        };
    ...
    entry fun deposit_tokens_from_admin(arg0: &AdminCap, arg1: &AdminRegistry, arg2: &PauseState, arg3: &mut Treasury, arg4: 0x2::coin::Coin<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(is_admin(arg1, 0x2::tx_context::sender(arg7)), 1000);
        assert!(!arg2.is_paused, 1200);
        deposit_tokens(arg3, arg4, arg5, arg6, arg7);
    }

    entry fun deposit_tokens_from_owner(arg0: &OwnerCap, arg1: &AdminRegistry, arg2: &PauseState, arg3: &mut Treasury, arg4: 0x2::coin::Coin<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_treasury_balance(arg0: &Treasury) : u64 {
        0x2::balance::value<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&arg0.token_balance)
    }
    ...
    fun init(arg0: CLAIM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = Treasury{
            id            : 0x2::object::new(arg1),
            token_balance : 0x2::balance::zero<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(),
        };
    ...
    fun withdraw_tokens(arg0: &mut Treasury, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        validate_amount(arg1);
        validate_sui_address(arg2);
        assert!(0x2::balance::value<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&arg0.token_balance) >= arg1, 1302);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>>(0x2::coin::from_balance<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(0x2::balance::split<0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno::BRUNO>(&mut arg0.token_balance, arg1), arg4), arg2);
