module 0x86817358c869a7cba048a945a1df3ec2c2531c65f4c04b4e624cd462fcb1d44a::dege {
    ...
    fun init(arg0: DEGE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DEGE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DEGE    ")))), trim_right(b"Pepe's Dog                      "), trim_right(b"Welcome a new trusted friend: Pepe's Dog - $DEGE                                                                                                                                                                                                                                                                                "), v2, arg1);
