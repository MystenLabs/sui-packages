module 0x8696f36d16def4e1d73abe151737398778d881081f7eda8ddd18fa787d2def63::cnsnft9193 {
    struct CNSNFT9193 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9193, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9193>(arg0, arg1);
