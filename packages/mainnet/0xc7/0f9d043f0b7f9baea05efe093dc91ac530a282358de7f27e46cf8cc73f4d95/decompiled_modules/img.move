module 0xc70f9d043f0b7f9baea05efe093dc91ac530a282358de7f27e46cf8cc73f4d95::img {
    struct IMG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IMG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v2;
        0x2::coin::mint_and_transfer<IMG>(&mut v4, 10000000000, 0x2::tx_context::sender(arg1), arg1);
