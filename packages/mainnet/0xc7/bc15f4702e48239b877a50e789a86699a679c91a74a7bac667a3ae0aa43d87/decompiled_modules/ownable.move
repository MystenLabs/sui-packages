module 0xc7bc15f4702e48239b877a50e789a86699a679c91a74a7bac667a3ae0aa43d87::ownable {
    ...
    public fun assert_version(arg0: &AdminCap) {
        assert!(arg0.version == 0xc7bc15f4702e48239b877a50e789a86699a679c91a74a7bac667a3ae0aa43d87::version::get_program_version(), 2);
    }
    ...
    public(friend) fun grant_admin_cap(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = AdminCap{
            ...
            version : 0xc7bc15f4702e48239b877a50e789a86699a679c91a74a7bac667a3ae0aa43d87::version::get_program_version(),
        };
    ...
    public(friend) fun migrate(arg0: &mut AdminCap, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0xc7bc15f4702e48239b877a50e789a86699a679c91a74a7bac667a3ae0aa43d87::version::get_program_version();
