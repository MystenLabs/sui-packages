module 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::dutch_auction {
    ...
    public fun borrow_market<T0>(arg0: &0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::venue::Venue) : &DutchAuctionMarket<T0> {
        let v0 = MarketKey{dummy_field: false};
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::venue::borrow_market<DutchAuctionMarket<T0>, MarketKey>(v0, arg0)
    }
    ...
    public entry fun cancel_bid<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &mut 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::Listing, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = MarketKey{dummy_field: false};
        let v1 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::market_internal_mut<DutchAuctionMarket<T0>, MarketKey>(arg1, v0, arg2);
    ...
    public entry fun create_bid<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &mut 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::Listing, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = MarketKey{dummy_field: false};
        let v1 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::venue_internal_mut<DutchAuctionMarket<T0>, MarketKey>(arg1, v0, arg2);
        ...
        let v3 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::venue::borrow_market_mut<DutchAuctionMarket<T0>, MarketKey>(v2, v1);
    ...
    public entry fun create_bid_whitelisted<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &mut 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::Listing, arg2: 0x2::object::ID, arg3: 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::market_whitelist::Certificate, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = MarketKey{dummy_field: false};
        let v1 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::venue_internal_mut<DutchAuctionMarket<T0>, MarketKey>(arg1, v0, arg2);
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::venue::assert_is_live(v1);
    ...
    public fun create_venue<T0, T1>(arg0: &mut 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::Listing, arg1: 0x2::object::ID, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::assert_inventory<T0>(arg0, arg1);
        let v0 = new<T1>(arg1, arg3, arg4);
        let v1 = MarketKey{dummy_field: false};
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::create_venue<DutchAuctionMarket<T1>, MarketKey>(arg0, v1, v0, arg2, arg4)
    }
    ...
    public entry fun init_venue<T0, T1>(arg0: &mut 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::Listing, arg1: 0x2::object::ID, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun sale_cancel<T0>(arg0: &mut 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::Listing, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::assert_listing_admin(arg0, arg2);
        let v0 = MarketKey{dummy_field: false};
        let v1 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::venue_internal_mut<DutchAuctionMarket<T0>, MarketKey>(arg0, v0, arg1);
        let v2 = MarketKey{dummy_field: false};
        let v3 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::venue::borrow_market_mut<DutchAuctionMarket<T0>, MarketKey>(v2, v1);
        cancel_auction<T0>(v3, arg2);
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::venue::set_live(v1, false);
    }

    public entry fun sale_conclude<T0: store + key, T1>(arg0: &mut 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::Listing, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::assert_listing_admin(arg0, arg2);
        let v0 = borrow_market<T1>(0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::borrow_venue(arg0, arg1)).inventory_id;
        let v1 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::supply<T0>(arg0, v0);
        ...
        let v4 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::market_internal_mut<DutchAuctionMarket<T1>, MarketKey>(arg0, v3, arg1);
        let (v5, v6) = conclude_auction<T1>(v4, v2);
        let v7 = v6;
        let v8 = MarketKey{dummy_field: false};
        let v9 = 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::inventory_internal_mut<T0, DutchAuctionMarket<T1>, MarketKey>(arg0, v8, arg1, v0);
        ...
        while (!0x1::vector::is_empty<Bid<T1>>(&v7)) {
            ...
            let v16 = v14;
            0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::deposit<T0>(&mut v16, 0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::inventory::redeem_pseudorandom_nft<T0>(v9, arg2), arg2);
        ...
        0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::pay<T1>(arg0, v10, v2);
        0x1::vector::destroy_empty<Bid<T1>>(v7);
        if (0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::inventory::is_empty<T0>(0xc7b27d0aef013813bf271788523bb57c9347a833de7add9b157b5cde5f03ec44::listing::borrow_inventory<T0>(arg0, v0))) {
