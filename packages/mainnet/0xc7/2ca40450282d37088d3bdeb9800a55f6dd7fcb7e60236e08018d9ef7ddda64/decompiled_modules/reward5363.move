module 0xc72ca40450282d37088d3bdeb9800a55f6dd7fcb7e60236e08018d9ef7ddda64::reward5363 {
    struct REWARD5363 has drop {
        dummy_field: bool,
    }

    struct TICKET_5363 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5363(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5363>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5363>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5363, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5363>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5363>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5363>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5363>>(v5, 0x2::tx_context::sender(arg1));
    }
