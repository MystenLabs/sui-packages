module 0xc7081928acd759a24a46b95f47f62142bbac1783fbf88db4b188ad8b59a5034e::gift8717 {
    struct GIFT8717 has drop {
        dummy_field: bool,
    }

    struct TICKET_8717 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8717(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8717>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8717>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8717, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8717>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8717>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8717>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8717>>(v5, 0x2::tx_context::sender(arg1));
    }
