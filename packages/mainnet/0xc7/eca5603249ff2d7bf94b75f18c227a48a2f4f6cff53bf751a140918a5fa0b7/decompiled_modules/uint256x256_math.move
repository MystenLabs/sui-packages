module 0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::uint256x256_math {
    ...
    public fun sqrt(arg0: u256) : u256 {
        ...
        let v0 = 1 << (0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::bit_math::most_significant_bit(arg0) >> 1) + 1;
        loop {
            let v1 = v0 + arg0 / v0 >> 1;
            if (v1 >= v0) {
                break
