module 0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::oracle_helper {
    ...
    public fun get_sample_at(arg0: &Oracle, arg1: u16, arg2: u64) : (u64, u64, u64, u64) {
        ...
        let v8 = v7;
        let v9 = v6;
        let (v10, v11, v12) = get_weighted_average(&v9, &v8, get_sample_last_update(&v8) - arg2, arg2 - get_sample_last_update(&v9));
        (arg2, v10, v11, v12)
    }
    ...
    public fun get_sample_last_update(arg0: &Sample) : u64 {
        let v0 = arg0.created_at;
        let v1 = (arg0.sample_lifetime as u64);
        assert!(v0 <= (18446744073709551615 as u64) - v1, 1);
        v0 + v1
    }
    ...
    public fun get_weighted_average(arg0: &Sample, arg1: &Sample, arg2: u64, arg3: u64) : (u64, u64, u64) {
        ...
        let v1 = (arg3 as u256);
        let v2 = v0 + v1;
        let v3 = ((arg0.cumulative_id as u256) * v0 + (arg1.cumulative_id as u256) * v1) / v2;
        let v4 = ((arg0.cumulative_volatility as u256) * v0 + (arg1.cumulative_volatility as u256) * v1) / v2;
        let v5 = ((arg0.cumulative_bin_crossed as u256) * v0 + (arg1.cumulative_bin_crossed as u256) * v1) / v2;
        assert!(v3 <= 18446744073709551615, 2);
        assert!(v4 <= 18446744073709551615, 2);
        assert!(v5 <= 18446744073709551615, 2);
        ((v3 as u64), (v4 as u64), (v5 as u64))
    }
    ...
    public fun update(arg0: &mut Oracle, arg1: &mut 0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::pair_parameter_helper::PairParameters, arg2: u32, arg3: &0x2::clock::Clock) : bool {
        let v0 = 0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::pair_parameter_helper::get_oracle_id(arg1);
        let v1 = v0;
        if (v0 == 0) {
            return false
        };
        ...
        let v4 = v3;
        let v5 = v3 + (v2.sample_lifetime as u64);
        let v6 = 0x2::clock::timestamp_ms(arg3) / 1000;
        if (v6 > v5) {
            let (v7, v8, v9) = update_sample(&v2, v6 - v5, 0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::pair_parameter_helper::get_active_id(arg1), 0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::pair_parameter_helper::get_volatility_accumulator(arg1), 0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::pair_parameter_helper::get_delta_id(arg1, arg2));
            ...
            if (v11 > 120) {
                ...
                v12 = 0;
                v4 = v6;
                0xc7eca5603249ff2d7bf94b75f18c227a48a2f4f6cff53bf751a140918a5fa0b7::pair_parameter_helper::set_oracle_id(arg1, v13);
            };
            set_sample(arg0, v1, create_sample(v10, v7, v8, v9, (v12 as u8), v4));
            return true
        };
        false
    }
    ...
    public fun update_sample(arg0: &Sample, arg1: u64, arg2: u32, arg3: u32, arg4: u32) : (u64, u64, u64) {
        let v0 = (arg1 as u256);
        let v1 = (arg0.cumulative_id as u256) + (arg2 as u256) * v0;
        let v2 = (arg0.cumulative_volatility as u256) + (arg3 as u256) * v0;
        let v3 = (arg0.cumulative_bin_crossed as u256) + (arg4 as u256) * v0;
        assert!(v1 <= 18446744073709551615, 3);
        assert!(v2 <= 18446744073709551615, 3);
        assert!(v3 <= 18446744073709551615, 3);
        ((v1 as u64), (v2 as u64), (v3 as u64))
    }
