module 0xc7604a7fb133dc256034051f97d4f97dfa3a41dbbc49f4a79c488948a7d0dd1e::tariff {
    ...
    fun init(arg0: TARIFF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/6p7SbZGpAKeqNUX67TJ714Cez42Y93kQpJY98gmLpump.png?size=lg&key=5311f8                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TARIFF>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TARIFF    ")))), trim_right(b"Tariff Nation                   "), trim_right(b"Remember when everyone said trade wars were bad for business? Well, they never met $TARIFF. We're the first community to turn international trade tensions into pure entertainment                                                                                                                                              "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
