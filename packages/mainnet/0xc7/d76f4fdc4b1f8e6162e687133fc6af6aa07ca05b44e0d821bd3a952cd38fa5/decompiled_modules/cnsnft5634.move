module 0xc7d76f4fdc4b1f8e6162e687133fc6af6aa07ca05b44e0d821bd3a952cd38fa5::cnsnft5634 {
    struct CNSNFT5634 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5634, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1808"));
        let v4 = 0x2::package::claim<CNSNFT5634>(arg0, arg1);
