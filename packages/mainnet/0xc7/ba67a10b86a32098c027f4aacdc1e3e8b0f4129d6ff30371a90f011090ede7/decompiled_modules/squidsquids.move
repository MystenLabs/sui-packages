module 0xc7ba67a10b86a32098c027f4aacdc1e3e8b0f4129d6ff30371a90f011090ede7::squidsquids {
    ...
    public entry fun transfer_with_tax(arg0: &mut 0x2::coin::Coin<SQUIDSQUIDS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg1 * 3 / 100;
        let v1 = arg1 - v0;
        0xc7ba67a10b86a32098c027f4aacdc1e3e8b0f4129d6ff30371a90f011090ede7::events::emit_transfer_event(0x2::tx_context::sender(arg3), arg2, v1, v0, 0x2::tx_context::epoch(arg3));
