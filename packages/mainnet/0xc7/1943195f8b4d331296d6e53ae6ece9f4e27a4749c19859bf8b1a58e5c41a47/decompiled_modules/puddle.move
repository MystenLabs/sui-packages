module 0xc71943195f8b4d331296d6e53ae6ece9f4e27a4749c19859bf8b1a58e5c41a47::puddle {
    ...
    public entry fun arbitrage<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: vector<0x2::coin::Coin<T0>>, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = *0x2::object::borrow_id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg3);
        assert!(arg5 <= 0x2::balance::value<T0>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balanec_bag, v0)), 14);
        let v1 = 0xc71943195f8b4d331296d6e53ae6ece9f4e27a4749c19859bf8b1a58e5c41a47::cetus_invest::arbitrage<T0, T1>(arg2, arg3, coins_to_balances<T0>(arg4), arg5, arg6, arg7, arg1.metadata.trader, arg8);
        let v2 = *0x2::table::borrow<0x2::object::ID, u64>(&arg1.investments.cost_table, v0);
        let v3 = 0x2::balance::value<T1>(&v1) - v2;
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v1, v3 * (arg1.commission_percentage as u64) / 100), arg8), arg1.metadata.trader);
        if (0x2::balance::value<T1>(&v1) > v2) {
            let v4 = 0x2::balance::split<T1>(&mut v1, v3 * (100 - (arg1.commission_percentage as u64)) / 100);
            let v5 = &mut v4;
            give_out_bonus<T1>(arg1, v5, arg8);
            if (0x2::balance::value<T1>(&v4) == 0) {
                0x2::balance::destroy_zero<T1>(v4);
            } else {
                0x2::balance::join<T1>(&mut arg1.balance, v4);
            };
        };
        0x2::balance::join<T1>(&mut arg1.balance, v1);
    }

    public entry fun invest<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: vector<0x2::coin::Coin<T1>>, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T1>(&arg1.balance) >= arg5, 14);
        let v0 = *0x2::object::borrow_id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg3);
        if (0x1::vector::contains<0x2::object::ID>(&arg1.investments.invests, &v0)) {
            0x2::table::add<0x2::object::ID, u64>(&mut arg1.investments.cost_table, v0, 0x2::table::remove<0x2::object::ID, u64>(&mut arg1.investments.cost_table, v0) + arg5);
            0x2::balance::join<T0>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balanec_bag, v0), 0xc71943195f8b4d331296d6e53ae6ece9f4e27a4749c19859bf8b1a58e5c41a47::cetus_invest::invest<T0, T1>(arg2, arg3, coins_to_balances<T1>(arg4), arg5, arg6, arg7, arg1.metadata.trader, arg8));
        } else {
            0x1::vector::push_back<0x2::object::ID>(&mut arg1.investments.invests, v0);
            0x2::table::add<0x2::object::ID, u64>(&mut arg1.investments.cost_table, v0, arg5);
            0x2::bag::add<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balanec_bag, v0, 0xc71943195f8b4d331296d6e53ae6ece9f4e27a4749c19859bf8b1a58e5c41a47::cetus_invest::invest<T0, T1>(arg2, arg3, coins_to_balances<T1>(arg4), arg5, arg6, arg7, arg1.metadata.trader, arg8));
        };
    }
