module 0xc737b7abed7542f77673be382cb1511e883ba861ac4b37b9764a2fb8ee8f2ecb::cnsnft6312 {
    struct CNSNFT6312 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6312, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6312>(arg0, arg1);
