module 0xc778962476bbf5cbb02c1e98f5c523b6f4542e4120eeb02d64546d674e5d7457::cetusquotes {
    ...
    public fun compute_swap_step(arg0: u128, arg1: u128, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: bool) : (u256, u256, u128, u256) {
        ...
        let (v0, v1, v2, v3) = if (arg6) {
            ...
            (v6, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_delta_down_from_output(arg0, v8, arg2, arg5), v7, v8)
        } else {
            let v9 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_delta_down_from_output(arg0, arg1, arg2, arg5);
            ...
            let v12 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_delta_up_from_input(arg0, v11, arg2, arg5);
            (v12, v10, (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_ceil((v12 as u128), (arg4 as u128), ((0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::fee_rate_denominator() - arg4) as u128)) as u256), v11)
        };
        (v0, v1, v3, v2)
    }
