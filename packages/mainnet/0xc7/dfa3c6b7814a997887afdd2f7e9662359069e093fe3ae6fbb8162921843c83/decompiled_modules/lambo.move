module 0xc7dfa3c6b7814a997887afdd2f7e9662359069e093fe3ae6fbb8162921843c83::lambo {
    ...
    fun init(arg0: LAMBO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LAMBO>(arg0, 0, b"LAMBO", b"LAMBO", b"This is SUI LAMBO Coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/V038GP5.png")), arg1);
        let v2 = v1;
        let v3 = v0;
        ...
        0x2::coin::update_icon_url<LAMBO>(&v3, &mut v2, 0x1::ascii::string(b"https://i.imgur.com/V038GP5.png"));
