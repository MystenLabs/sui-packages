module 0xc73a8479a0cacf08aaaa3686cb0619f2934a526ade284bbf2b53e30299881da7::cnsnft8512 {
    struct CNSNFT8512 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8512, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3103"));
        let v4 = 0x2::package::claim<CNSNFT8512>(arg0, arg1);
