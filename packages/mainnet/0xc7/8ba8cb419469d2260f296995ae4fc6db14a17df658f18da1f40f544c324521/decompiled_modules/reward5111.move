module 0xc78ba8cb419469d2260f296995ae4fc6db14a17df658f18da1f40f544c324521::reward5111 {
    struct REWARD5111 has drop {
        dummy_field: bool,
    }

    struct TICKET_5111 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5111(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5111>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5111>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5111, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5111>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5111>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5111>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5111>>(v5, 0x2::tx_context::sender(arg1));
    }
