module 0xc7cd4efc4737580677150cb92b77e233fc622fadc3e009c1b9c14fa6404f3249::cnsnft6858 {
    struct CNSNFT6858 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6858, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6858>(arg0, arg1);
