module 0x65424ceb2c6eab8d68b6c26340faee7b081569471a3d20736d7e57bf1e253ac::sui_silver_card_contract {
    ...
    public fun buy_card_direct<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: 0x1::ascii::String, arg2: u64, arg3: 0x1::ascii::String, arg4: &CardConfigs, arg5: &mut PurchaseRecord, arg6: &mut FeeTierList, arg7: &mut SwapFeeList, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg4.version == 2, 3);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::address::to_ascii_string(arg4.usdc_address) == 0x1::type_name::get_address(&v0), 6);
        let v1 = 0x2::coin::value<T0>(arg0);
        assert!(v1 >= arg2, 0);
        let v2 = arg2 * get_swap_fee_from_list(arg7, arg1) / 10000;
        if (v2 != 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, v2, arg9), arg4.revenue_vault);
        };
        let v3 = arg2 - v2;
        assert!(v3 >= arg4.min_card_amount && v3 <= arg4.max_card_amount, 1);
        let v4 = v3 * get_fee_from_tiers(arg6, v3) / 10000;
        let v5 = v3 - v4;
        let v6 = 0x2::clock::timestamp_ms(arg8);
        let Date {
            year  : v7,
            month : v8,
            day   : v9,
        } = calculate_date(v6 / 1000);
        let Date {
            year  : v10,
            month : v11,
            day   : v12,
        ...
        if (v13) {
            arg5.total_card_bought_per_day = arg5.total_card_bought_per_day + v3;
        } else {
            arg5.timestamp_in_record = v6;
            arg5.total_card_bought_per_day = v3;
        };
        assert!(arg5.total_card_bought_per_day <= arg4.daily_card_buy_limit, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, v4, arg9), arg4.revenue_vault);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, v5, arg9), arg4.card_vault);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, v1 - v2 - v4 - v5, arg9), 0x2::tx_context::sender(arg9));
        let v14 = CardPurchased{
            from           : 0x2::tx_context::sender(arg9),
            amount         : v3,
            src_token_type : arg1,
            user_email     : arg3,
        };
        0x2::event::emit<CardPurchased>(v14);
    }
