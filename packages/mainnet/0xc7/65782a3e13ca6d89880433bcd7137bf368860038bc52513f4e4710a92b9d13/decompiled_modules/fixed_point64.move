module 0xc765782a3e13ca6d89880433bcd7137bf368860038bc52513f4e4710a92b9d13::fixed_point64 {
    ...
    public fun checked_div(arg0: FixedPoint64, arg1: FixedPoint64) : 0x1::option::Option<FixedPoint64> {
        ...
        let v0 = 0xc765782a3e13ca6d89880433bcd7137bf368860038bc52513f4e4710a92b9d13::math256::div_down((arg0.value as u256) << 64, (arg1.value as u256));
    ...
    public fun div(arg0: FixedPoint64, arg1: FixedPoint64) : FixedPoint64 {
        ...
        FixedPoint64{value: (0xc765782a3e13ca6d89880433bcd7137bf368860038bc52513f4e4710a92b9d13::math256::div_down((arg0.value as u256) << 64, (arg1.value as u256)) as u128)}
    }

    public fun div_down_u128(arg0: u128, arg1: FixedPoint64) : u128 {
        assert!(arg1.value != 0, 3);
        let v0 = 0xc765782a3e13ca6d89880433bcd7137bf368860038bc52513f4e4710a92b9d13::math256::div_down((arg0 as u256) << 64, (arg1.value as u256));
    ...
    public fun div_up_u128(arg0: u128, arg1: FixedPoint64) : u128 {
        assert!(arg1.value != 0, 3);
        let v0 = 0xc765782a3e13ca6d89880433bcd7137bf368860038bc52513f4e4710a92b9d13::math256::div_up((arg0 as u256) << 64, (arg1.value as u256));
        assert!(v0 <= 340282366920938463463374607431768211455, 4);
        (v0 as u128)
    }
    ...
    public fun mul_div(arg0: FixedPoint64, arg1: FixedPoint64, arg2: FixedPoint64) : FixedPoint64 {
        ...
        FixedPoint64{value: 0xc765782a3e13ca6d89880433bcd7137bf368860038bc52513f4e4710a92b9d13::math128::mul_div_down(arg0.value, arg1.value, arg2.value)}
    }
    ...
    public fun sqrt(arg0: FixedPoint64) : FixedPoint64 {
        let v0 = arg0.value;
        let v1 = ((0xc765782a3e13ca6d89880433bcd7137bf368860038bc52513f4e4710a92b9d13::math128::sqrt_down(v0) << 32) as u256);
