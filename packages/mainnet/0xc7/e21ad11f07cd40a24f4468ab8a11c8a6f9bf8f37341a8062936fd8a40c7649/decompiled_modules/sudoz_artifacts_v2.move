module 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::sudoz_artifacts_v2 {
    ...
    struct GlobalStats has key {
        ...
        evolution_auth: 0x1::option::Option<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth>,
    }
    ...
    public fun enable_burn_mechanisms(arg0: &AdminCap, arg1: &mut GlobalStats, arg2: &0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedStats) {
        assert!(0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::get_evolved_minted(arg2) >= 5555, 7);
        arg1.burn_mechanisms_enabled = true;
    }

    public entry fun entry_evolve_artifact(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedStats, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        evolve_artifact(arg0, arg1, arg2, arg3, arg4);
    }

    public entry fun entry_evolve_artifact_with_attributes(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedStats, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun evolve_artifact(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedStats, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_some<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), 7);
        ...
        0x1::vector::push_back<0x1::string::String>(v12, 0x1::string::utf8(b"Unknown"));
        0x1::vector::push_back<0x1::string::String>(v12, 0x1::string::utf8(b"Unknown"));
        let v13 = 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::mint_evolved_for_evolution(0x1::option::borrow<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), v0, *0x1::option::borrow<u8>(&arg0.path), v9, v11, arg2, arg3, arg4);
        let v14 = ArtifactBurnedForEvolved{
            artifact_id     : 0x2::object::uid_to_inner(&arg0.id),
            evolved_id      : 0x2::object::id<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedSudoz>(&v13),
            artifact_number : v0,
            evolved_number  : 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::get_evolved_number(&v13),
        };
        0x2::event::emit<ArtifactBurnedForEvolved>(v14);
        0x2::transfer::public_transfer<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedSudoz>(v13, 0x2::tx_context::sender(arg4));
    }

    public fun evolve_artifact_with_attributes(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedStats, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.level == 10, 8);
        let v0 = arg0.number;
        let SudozArtifact {
            id          : v1,
        ...
        arg1.level_10_burns = arg1.level_10_burns + 1;
        assert!(0x1::option::is_some<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), 7);
        let v9 = 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::mint_evolved_for_evolution(0x1::option::borrow<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), v0, *0x1::option::borrow<u8>(&arg0.path), arg3, arg4, arg2, arg5, arg6);
        let v10 = ArtifactBurnedForEvolved{
            artifact_id     : 0x2::object::uid_to_inner(&arg0.id),
            evolved_id      : 0x2::object::id<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedSudoz>(&v9),
            artifact_number : v0,
            evolved_number  : 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::get_evolved_number(&v9),
        };
        0x2::event::emit<ArtifactBurnedForEvolved>(v10);
        0x2::transfer::public_transfer<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolvedSudoz>(v9, 0x2::tx_context::sender(arg6));
    }
    ...
    fun init(arg0: SUDOZ_ARTIFACTS_V2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = GlobalStats{
            ...
            evolution_auth          : 0x1::option::none<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth>(),
        };
    ...
    public entry fun store_evolution_auth(arg0: &AdminCap, arg1: &mut GlobalStats, arg2: 0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth, arg3: &mut 0x2::tx_context::TxContext) {
        0x1::option::fill<0xc7e21ad11f07cd40a24f4468ab8a11c8a6f9bf8f37341a8062936fd8a40c7649::evolved_sudoz::EvolutionAuth>(&mut arg1.evolution_auth, arg2);
    }
