module 0xc7c83aebbd6950fbf78b69e65742e05125477c42318befe16fd48a65d183726e::ninja_store {
    ...
    struct PersonalKioskCapWrapper has store, key {
        id: 0x2::object::UID,
        kiosk_id: 0x2::object::ID,
        owner: address,
    }
    ...
    public entry fun create_personal_kiosk_swap_offer<T0: store + key, T1: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &T1, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(arg3);
        assert!(0x1::string::length(&v0) > 0, 4);
        let v1 = PersonalKioskCapWrapper{
            id       : 0x2::object::new(arg5),
            kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg0),
            owner    : 0x2::tx_context::sender(arg5),
        };
        let v2 = NFTTypeInfo{type_name: 0x1::string::utf8(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>())))};
        let v3 = NFTTypeInfo{type_name: 0x1::string::utf8(arg3)};
        let v4 = SwapOffer{
            id                 : 0x2::object::new(arg5),
            creator            : 0x2::tx_context::sender(arg5),
            offered_nft_id     : arg2,
        ...
        0x2::dynamic_field::add<vector<u8>, PersonalKioskCapWrapper>(&mut v4.id, b"personal_kiosk_wrapper", v1);
