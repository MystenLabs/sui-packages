module 0xc7e060ec58a62ac5c6bcdc55a8b7ca90bc7c8b11e2d7ba99f5f435720d3f8e96::gut {
    ...
    fun init(arg0: GUT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<GUT>(arg0, 6, b"GUT", b"Gyrowin Utility Token", b"GUT is a utility token for the Gyrowin platform", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gyro.win/gut.png")), arg1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<GUT>>(0x2::coin::from_balance<GUT>(0x2::balance::increase_supply<GUT>(&mut v2.total_supply, 2500000000000000), arg1), 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<Metadata<GUT>>(v2);
    }

    entry fun migrate(arg0: &mut Metadata<GUT>, arg1: &0xc7e060ec58a62ac5c6bcdc55a8b7ca90bc7c8b11e2d7ba99f5f435720d3f8e96::ownership::OwnerCap) {
        assert!(arg0.version < 1, 1);
    ...
    public(friend) fun mint(arg0: &mut Metadata<GUT>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<GUT> {
        assert_version(arg0);
        assert!(get_total_supply_value(arg0) <= 5000000000000000, 2);
