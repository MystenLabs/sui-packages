module 0xc792cf13363369fe87b4a8f8e505b3fc70289bea45208ce9a3298b7a00b907bc::ghiblielon {
    ...
    fun init(arg0: GHIBLIELON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://ipfs.io/ipfs/Qmem84WAmpD6NHVA9oQdgLFmaq5oyarBL3tpcb7JWWfcUG                                                                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GHIBLIELON>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GHIBLIELON")))), trim_right(b"GHIBLI ELON WIF DOGE            "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
