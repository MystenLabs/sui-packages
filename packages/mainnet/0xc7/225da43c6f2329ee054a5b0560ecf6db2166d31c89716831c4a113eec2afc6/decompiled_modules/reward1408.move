module 0xc7225da43c6f2329ee054a5b0560ecf6db2166d31c89716831c4a113eec2afc6::reward1408 {
    struct REWARD1408 has drop {
        dummy_field: bool,
    }

    struct TICKET_1408 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1408(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1408>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1408>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1408, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1408>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1408>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1408>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1408>>(v5, 0x2::tx_context::sender(arg1));
    }
