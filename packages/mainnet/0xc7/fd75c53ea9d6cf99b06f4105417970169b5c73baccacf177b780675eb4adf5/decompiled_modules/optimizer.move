module 0xc7fd75c53ea9d6cf99b06f4105417970169b5c73baccacf177b780675eb4adf5::optimizer {
    ...
    fun advance_route(arg0: &mut vector<Hop>, arg1: u128) : (u128, u64, u64) {
        ...
        while (v3 < 0x1::vector::length<Hop>(arg0)) {
            ...
            if (v4.kind == 0) {
                let v7 = mul_div_down(v6, v4.reserve_out, v4.reserve_in + v6);
                v4.reserve_in = v4.reserve_in + v6;
                v4.reserve_out = v4.reserve_out - v7;
                v0 = effective_output(v7, v4.output_fee_rate, v4.output_fee_denominator);
            } else if (v4.kind == 1) {
                let v8 = *current_boundary(v4);
                let (v9, v10) = if (v6 == 0) {
                    (v4.sqrt_price_x64, 0)
                } else {
                    let v11 = next_sqrt_price(v4, v6, v8.sqrt_price_x64);
                    let v12 = if (v4.zero_for_one) {
                        mul_div_down(v4.liquidity, v4.sqrt_price_x64 - v11, 18446744073709551616)
                    } else {
                        amount0_delta_down(v4.sqrt_price_x64, v11, v4.liquidity)
                    };
                    (v11, v12)
                };
                v4.sqrt_price_x64 = v9;
                if (v9 == v8.sqrt_price_x64) {
                    apply_liquidity_net(v4, v8);
                    v4.boundary_cursor = v4.boundary_cursor + 1;
                    let v13 = v1 + 1;
                    let v14 = skip_empty_v3_boundaries(v4);
                    v1 = v13 + v14;
                };
                v0 = v10;
            } else if (v4.kind == 2) {
                assert!(!orderbook_terminal(v4), 3);
                let (v15, v16) = quote_orderbook_segment_and_consumed_base(v4, v6);
                let v17 = 0x1::vector::borrow_mut<OrderbookSegment>(&mut v4.orderbook_segments, v4.orderbook_cursor);
                v17.remaining_base = v17.remaining_base - v16;
                v4.orderbook_consumed_base = v4.orderbook_consumed_base + v16;
                ...
                let v18 = quote_linear_segment(v4, v6);
                let v19 = 0x1::vector::borrow_mut<LinearSegment>(&mut v4.linear_segments, v4.linear_cursor);
                assert!(v6 <= v19.remaining_input, 3);
                v19.remaining_input = v19.remaining_input - v6;
                v19.remaining_output = v19.remaining_output - v18;
                if (v19.remaining_input == 0) {
                    assert!(v19.remaining_output == 0, 3);
            ...
            let v20 = if (v5 >= v4.policy.input_minimum) {
                0
            } else {
                v4.policy.input_minimum - v5
            };
            v4.policy.input_minimum = v20;
            v3 = v3 + 1;
        };
        (v0, v1, v2)
    }
    ...
    public fun bounded_affine_upper(arg0: &vector<Hop>) : (bool, u256, u256) {
        ...
        while (v2 < 0x1::vector::length<Hop>(arg0)) {
            ...
            let (v5, v6) = if (v4) {
                ...
                if (v7) {
                    let v8 = if (v3.kind == 10 || v3.kind == 11) {
                        1
                    } else {
                        0
                    };
                    (mul_fraction_ceil(mul_fraction_ceil(mul_ratio_up_saturating(q64(), (v3.reserve_out as u256), (v3.reserve_in as u256)), ((v3.fee_denominator - v3.fee_rate) as u256), (v3.fee_denominator as u256)), ((v3.output_fee_denominator - v3.output_fee_rate) as u256), (v3.output_fee_denominator as u256)), v8)
                } else if (v3.kind == 14) {
                    let (v9, v10) = steamm_btoken_supplies(v3);
                    (mul_ratio_up_saturating(mul_fraction_ceil(mul_ratio_up_saturating(mul_ratio_up_saturating(q64(), (v9 as u256) * 1000000000000000000, (v3.stable_scale_in as u256)), (v3.reserve_out as u256), (v3.reserve_in as u256)), ((v3.output_fee_denominator - v3.output_fee_rate) as u256), (v3.output_fee_denominator as u256)), (v3.stable_scale_out as u256), (v10 as u256) * 1000000000000000000), 0)
                } else if (v3.kind == 15) {
                    let (_, v12) = steamm_btoken_supplies(v3);
                    let v13 = (v3.stable_scale_out as u256) / (v12 as u256);
                    if (v13 == 0) {
                        return (false, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935)
                    };
                    let v14 = mul_ratio_up_saturating(q64(), (v3.reserve_in as u256), (v3.liquidity as u256));
                    let v15 = v3.stable_admin_fee;
                    let v16 = v3.stable_lp_fee;
                    let v17 = 0;
                    loop {
                        let v18 = if (v15 > v16) {
                            v15 - v16
                    ...
                    (mul_ratio_up_saturating(mul_fraction_ceil(v14, ((v3.output_fee_denominator - v3.output_fee_rate) as u256), (v3.output_fee_denominator as u256)), (v3.stable_scale_out as u256), (v12 as u256) * v13), 0)
                } else {
                    let v20 = if (v3.kind == 5) {
                        true
                    } else if (v3.kind == 6) {
                        true
                    } else {
                    ...
                    if (v20) {
                        (0, (v3.reserve_out as u256))
                    } else if (v3.kind == 16) {
                        (0, (v3.sqrt_price_x64 as u256))
                    } else if (v3.kind == 7) {
                        let v21 = if (v3.zero_for_one) {
                            v3.reserve_in
                        } else {
                            v3.reserve_out
                        };
                        let v22 = (v3.sqrt_price_x64 as u256) * (v3.stable_amp as u256);
                        let v23 = v22 * v22 * (v3.stable_scale_in as u256) / (v3.stable_scale_out as u256);
                        let v24 = v22 + (v21 as u256) - (v3.sqrt_price_x64 as u256);
                        if (v24 == 0 || v23 == 0) {
                            return (false, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935)
                        };
                        let v25 = if (v3.zero_for_one) {
                            if (v24 > 115792089237316195423570985008687907853269984665640564039457584007913129639935 / v24) {
                                return (false, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935)
                            };
                            mul_ratio_up_saturating(q64(), v23, v24 * v24)
                        } else {
                            let v26 = v23 / v24;
                            if (v26 == 0) {
                                return (false, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935)
                            };
                            mul_ratio_up_saturating(q64(), v24, v26)
                        };
                        (mul_fraction_ceil(v25, ((v3.fee_denominator - v3.fee_rate) as u256), (v3.fee_denominator as u256)), 2)
                    } else {
                        let v27 = if (v3.kind == 3) {
                        ...
                        if (v27) {
                            let v28 = 0x1::vector::borrow<LinearSegment>(&v3.linear_segments, 0);
                            if (v28.exact_dlmm || v28.remaining_input != 18446744073709551616) {
                                return (false, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935)
                            };
                            (saturating_add((v28.remaining_output as u256), 2), 0)
                        } else {
                            return (false, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935)
                        }
                    }
            ...
            let v29 = mul_q64_ceil(v0, v5);
            v0 = v29;
            let v30 = saturating_add(mul_q64_ceil(v1, v5), v6);
            v1 = v30;
            if (v29 == 115792089237316195423570985008687907853269984665640564039457584007913129639935 || v30 == 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                return (false, 115792089237316195423570985008687907853269984665640564039457584007913129639935, 115792089237316195423570985008687907853269984665640564039457584007913129639935)
            };
            v2 = v2 + 1;
        };
            ...
            *arg3 = *arg3 - 1;
            ...
            let v5 = if (v4.kind == 0) {
                ...
                let v16 = if (v0 == v12) {
                    ...
                    next_sqrt_price_partial(v13, v14, v4.zero_for_one, effective_input(v0 - v12, v4.fee_rate, v4.fee_denominator), v4.policy.stop_at_zero_liquidity)
                };
    ...
    fun extend_v3_prefix_cache(arg0: &Hop, arg1: &mut V3PrefixCache, arg2: u128, arg3: u64) : u64 {
        ...
        let v8 = v2;
        let v9 = v1;
        if (v0 > 0 && (v1 > arg2 || arg0.policy.stop_at_zero_liquidity && v4 == 0)) {
            return 0
        };
        ...
        while (v11 < arg0.boundary_cursor + arg3) {
            ...
            v11 = v11 + 1;
            if (v16 > arg2 || arg0.policy.stop_at_zero_liquidity && v18 == 0) {
                break
            };
        };
        v11 - v10
    ...
    fun hop_endpoint_marginal_x64(arg0: &Hop, arg1: u128) : u256 {
        ...
        let v1 = if (arg0.kind == 0) {
            ...
            let (v3, v4) = linear_marginal_fraction(current_linear_segment(arg0));
            v3 / v4
        };
    ...
    fun hop_marginal_upper_x64(arg0: &Hop) : u256 {
        let v0 = if (arg0.kind == 0) {
            ...
            let (v2, v3) = linear_marginal_fraction(current_linear_segment(arg0));
            div_ceil(v2, v3)
        } else if (arg0.kind == 12) {
            let (v4, v5) = aftermath_weights(arg0);
            mul_ratio_up_saturating(mul_ratio_up_saturating(mul_ratio_up_saturating(div_ceil((arg0.reserve_out as u256) * q64(), (arg0.reserve_in as u256)), (v4 as u256), (v5 as u256)), (arg0.stable_scale_in as u256), (arg0.stable_scale_out as u256)), 1000000000000000000 - (arg0.stable_admin_fee as u256), 1000000000000000000)
        } else {
    ...
    fun hop_marginal_x64(arg0: &Hop) : u256 {
        let v0 = if (arg0.kind == 0) {
            ...
            let (v4, v5) = aftermath_weights(arg0);
            mul_ratio_down_saturating(mul_ratio_down_saturating(mul_ratio_down_saturating((arg0.reserve_out as u256) * q64() / (arg0.reserve_in as u256), (v4 as u256), (v5 as u256)), (arg0.stable_scale_in as u256), (arg0.stable_scale_out as u256)), 1000000000000000000 - (arg0.stable_admin_fee as u256), 1000000000000000000)
        } else {
            assert!(arg0.kind == 13, 1);
            if (arg0.zero_for_one) {
    ...
    fun join_staged_route(arg0: vector<Hop>, arg1: vector<StagedHop>) : vector<Hop> {
        ...
        while (0x1::vector::length<Hop>(&arg0) > 0) {
            ...
            if (v3 == 1) {
                ...
                let v12 = &mut v2;
                normalize_v3_initial_boundary(v12);
                0x1::vector::push_back<Hop>(&mut v1, v2);
                continue
            };
            if (v3 == 3) {
                assert!(v2.kind == 11 && !v2.zero_for_one, 1);
                let v13 = if (v2.stable_scale_out == 0) {
                    if (0x1::vector::is_empty<TickBoundary>(&v8)) {
                        0x1::vector::is_empty<Hop>(&v7)
                    } else {
                        false
                    }
                } else {
            ...
            assert!(v14, 3);
            let v15 = 0x1::vector::pop_back<Hop>(&mut v7);
            assert!(v2.kind == 2 && v15.kind == 2 || v2.kind == 3 && v15.kind == 3, 1);
            0x1::vector::push_back<Hop>(&mut v1, v15);
        };
    ...
    fun linear_marginal_fraction(arg0: &LinearSegment) : (u256, u256) {
        if (!arg0.exact_dlmm) {
    ...
    fun next_sqrt_price(arg0: &Hop, arg1: u128, arg2: u128) : u128 {
        ...
        if (arg0.policy.stop_at_zero_liquidity) {
            return next_sqrt_price_partial(arg0.sqrt_price_x64, arg0.liquidity, arg0.zero_for_one, arg1, true)
        };
        if (arg0.zero_for_one) {
    ...
    fun next_sqrt_price_partial(arg0: u128, arg1: u128, arg2: bool, arg3: u128, arg4: bool) : u128 {
        if (arg4 && arg2) {
            let v0 = (arg1 as u256) << 64;
            let v1 = (arg0 as u256);
            let v2 = (arg3 as u256) * v1;
            if (v0 > 115792089237316195423570985008687907853269984665640564039457584007913129639935 / v1 || v2 > 115792089237316195423570985008687907853269984665640564039457584007913129639935 - v0) {
                return arg0
            };
            return to_u128(div_up_u256(v0 * v1, v0 + v2))
        };
        if (arg2) {
            let v4 = (arg1 as u256) << 64;
            to_u128(div_up_u256(v4, v4 / (arg0 as u256) + (arg3 as u256)))
        } else {
    ...
    fun normalize_v3_initial_boundary(arg0: &mut Hop) {
        if (0x1::vector::is_empty<TickBoundary>(&arg0.boundaries) || 0x1::vector::borrow<TickBoundary>(&arg0.boundaries, 0).sqrt_price_x64 != arg0.sqrt_price_x64) {
            return
        };
        let v0 = *0x1::vector::borrow<TickBoundary>(&arg0.boundaries, 0);
        apply_liquidity_net(arg0, v0);
    ...
    fun optimize_impl(arg0: vector<Hop>, arg1: u128, arg2: u64, arg3: u8) : OptimizeResult {
        assert!(0x1::vector::length<Hop>(&arg0) > 0, 5);
        assert!(arg1 > 0 && arg2 > 0, 6);
        if (auxiliary_cost_x64(&arg0) > q64() || has_execution_bounds(&arg0)) {
        ...
        while (v1 < arg1 && v0.segments < arg2) {
            ...
            let (v16, v17) = if (arg3 != 0 && v15 > q64()) {
                ...
                let (v18, v19) = closed_form_root(v9, v14, v6);
                (v19, v18)
            };
            if (v16) {
                let v20 = &mut v0;
                record_nearby_candidates(&arg0, v1, v2, v17, v9, v20);
            ...
            if (v9 == v8) {
                let v21 = &mut v0;
                record_candidate_if_valid(&arg0, v9, v1 + v9, v2 + v14, v21);
                if (v1 == 0) {
                    let v22 = &mut v0;
                    record_v2_plateau_candidate(&arg0, v9, v14, v22);
                };
                return v0
            };
            let v23 = &mut arg0;
            let (v24, v25, v26) = advance_route(v23, v9);
            let v27 = v1 + v9;
            v1 = v27;
            let v28 = v2 + v24;
            v2 = v28;
            v0.crossed_ticks = v0.crossed_ticks + v25;
            v0.crossed_orders = v0.crossed_orders + v26;
            let v29 = &mut v0;
            record_candidate_if_valid(&arg0, 0, v27, v28, v29);
        };
    ...
    public fun passes_bounded_profit_gate(arg0: &vector<Hop>, arg1: u128) : bool {
        ...
        while (v4 < 0x1::vector::length<Hop>(arg0)) {
            if (0x1::vector::borrow<Hop>(arg0, v4).policy.auxiliary_fee_rate > 0) {
                v3 = saturating_add(v3, 1);
            };
            v4 = v4 + 1;
        };
        let v5 = v3 == 0 || v3 < (arg1 as u256);
        !v5
    }
    ...
    public fun progress_append_boundaries(arg0: &mut OptimizeState, arg1: u64, arg2: vector<TickBoundary>) {
        ...
        if (!0x1::vector::is_empty<Hop>(&arg0.validation_route)) {
            0x1::vector::append<TickBoundary>(&mut 0x1::vector::borrow_mut<Hop>(&mut arg0.validation_route, arg1).boundaries, arg2);
        };
    ...
    public fun progress_append_linear_segments(arg0: &mut OptimizeState, arg1: u64, arg2: vector<LinearSegment>, arg3: bool) {
        ...
        if (!0x1::vector::is_empty<Hop>(&arg0.validation_route)) {
            0x1::vector::append<LinearSegment>(&mut 0x1::vector::borrow_mut<Hop>(&mut arg0.validation_route, arg1).linear_segments, arg2);
            0x1::vector::borrow_mut<Hop>(&mut arg0.validation_route, arg1).linear_has_more = arg3;
        };
        let v0 = 0x1::vector::borrow_mut<Hop>(&mut arg0.route, arg1);
        assert!(v0.kind == 3, 1);
    ...
    fun progressive_probe(arg0: &vector<Hop>, arg1: &mut vector<V3PrefixCache>, arg2: &mut vector<OrderbookShortfall>, arg3: u128, arg4: &mut vector<u128>, arg5: &mut u64, arg6: &mut OptimizeResult) : ProgressiveSample {
        ...
        if (v1 != 0 || v0 == 0) {
            ...
            let v5 = empty_progressive_sample();
            v5.status = v1;
            return v5
        };
        let v6 = route_auxiliary_fee(arg0, arg3);
        record_candidate_with_fee(arg3, v0, v6, arg6);
        let v7 = saturating_add((arg3 as u256), v6);
        let v8 = v7 > (v0 as u256);
        let v9 = if (v8) {
            v7 - (v0 as u256)
        } else {
            (v0 as u256) - v7
    ...
    fun progressive_search_impl(arg0: vector<Hop>, arg1: vector<StagedHop>, arg2: vector<u128>, arg3: u128, arg4: u128, arg5: u128, arg6: u64, arg7: u64, arg8: u64) : (OptimizeResult, vector<u128>) {
        ...
        let v16 = if (v15) {
            0x1::u128::max(0x1::u128::max(v14, v11.policy.input_minimum), v11.orderbook_min_size)
        } else {
            0x1::u128::max(v14, v11.policy.input_minimum)
        };
    ...
    fun quote_v3_cached(arg0: &Hop, arg1: &mut V3PrefixCache, arg2: u128, arg3: &mut u64) : (u128, u8, u64) {
        ...
        let v9 = if (arg0.policy.stop_at_zero_liquidity) {
            if (v2 > 0) {
                v7 == 0
            } else {
                false
        ...
        if (v5 > arg0.policy.output_capacity) {
            return (0, 7, v2)
        };
        if (v2 == v1 || v7 == 0) {
            return (0, 3, v2)
        ...
        *arg3 = *arg3 - 1;
        let v10 = effective_input(arg2 - v4, arg0.fee_rate, arg0.fee_denominator);
        let v11 = if (v10 == 0) {
            v6
        } else {
            next_sqrt_price_partial(v6, v7, arg0.zero_for_one, v10, arg0.policy.stop_at_zero_liquidity)
        };
    ...
    public fun quote_window(arg0: vector<Hop>, arg1: u128) : (u128, bool, u64, u64) {
        if (has_execution_bounds(&arg0)) {
            let (v0, v1, _) = build_v3_prefix_caches(&arg0, 65536);
            let v3 = v0;
            if (v1 != 0) {
                return (0, false, 0, 18446744073709551615)
            };
            let v4 = 65536;
            let v5 = &mut v3;
            let v6 = &mut v4;
            let (v7, v8, v9, _) = quote_bounded_route(&arg0, v5, arg1, v6);
            let v11 = if (v8 == 0) {
                true
            } else if (v8 == 1) {
                true
            ...
            let v12 = if (v8 == 3) {
                first_missing_boundary(&arg0)
            } else {
                18446744073709551615
            };
            return (v7, v11, v9, v12)
        };
        let v13 = 0;
        let v14 = 0;
        while (arg1 > 0) {
            let v15 = first_missing_boundary(&arg0);
            if (v15 != 18446744073709551615) {
                return (v13, false, v14, v15)
            };
            if (has_terminal_finite_hop(&arg0)) {
                break
            };
            let (v16, _) = next_route_boundary(&arg0, arg1);
            let v18 = &mut arg0;
            let (v19, v20, _) = advance_route(v18, v16);
            arg1 = arg1 - v16;
            v13 = v13 + v19;
            v14 = v14 + v20;
        };
        if (!orderbook_minimums_satisfied(&arg0)) {
            return (0, true, v14, 18446744073709551615)
        };
        (v13, true, v14, 18446744073709551615)
    }
    ...
    public fun search_evaluation_limit_status() : u8 {
        9
    }
    ...
    public fun search_initial_quote_zero_status() : u8 {
        8
    }
    ...
    public fun v3_hop(arg0: u128, arg1: u128, arg2: u64, arg3: u64, arg4: bool, arg5: vector<TickBoundary>) : Hop {
        ...
        let v2 = &mut v1;
        normalize_v3_initial_boundary(v2);
        v1
    }
    ...
    fun validate_boundaries(arg0: u128, arg1: bool, arg2: &vector<TickBoundary>) {
        ...
        while (v0 < 0x1::vector::length<TickBoundary>(arg2)) {
            ...
            if (v0 == 0 && v1.sqrt_price_x64 == arg0) {
            } else if (arg1) {
    ...
    fun validate_linear_segments(arg0: &vector<LinearSegment>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<LinearSegment>(arg0)) {
            let v1 = 0x1::vector::borrow<LinearSegment>(arg0, v0);
            assert!(v1.remaining_input > 0 && v1.remaining_output > 0, 3);
            if (v1.exact_dlmm) {
                assert!(v1.price_x64 > 0 && v1.fee_denominator > v1.fee_rate, 3);
            } else {
                let v2 = if (v1.price_x64 == 0) {
                    if (v1.fee_rate == 0) {
                        v1.fee_denominator == 1
                    } else {
                        false
                    }
                } else {
            ...
            if (v0 > 0) {
                let v3 = 0x1::vector::borrow<LinearSegment>(arg0, v0 - 1);
                assert!(v1.exact_dlmm == v3.exact_dlmm, 3);
                let v4 = if (v1.exact_dlmm) {
                    assert!(v1.forward == v3.forward && v1.fee_denominator == v3.fee_denominator, 3);
                    v1.forward && (v1.price_x64 as u256) * ((v1.fee_denominator - v1.fee_rate) as u256) <= (v3.price_x64 as u256) * ((v3.fee_denominator - v3.fee_rate) as u256) || ((v1.fee_denominator - v1.fee_rate) as u256) * (v3.price_x64 as u256) <= ((v3.fee_denominator - v3.fee_rate) as u256) * (v1.price_x64 as u256)
                } else {
                    (v1.remaining_output as u256) * (v3.remaining_input as u256) <= (v3.remaining_output as u256) * (v1.remaining_input as u256)
                };
                assert!(v4, 3);
            };
            v0 = v0 + 1;
    ...
    public fun with_output_capacity_u64(arg0: Hop, arg1: u64) : Hop {
        arg0.policy.output_capacity = 0x1::u128::min(arg0.policy.output_capacity, (arg1 as u128));
        arg0
    }
    ...
    public fun with_suidex_execution_bounds(arg0: Hop) : Hop {
        assert!(arg0.kind == 0 && arg0.output_fee_rate == 0, 1);
