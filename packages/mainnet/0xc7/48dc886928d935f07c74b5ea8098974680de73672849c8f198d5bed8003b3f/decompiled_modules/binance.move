module 0xc748dc886928d935f07c74b5ea8098974680de73672849c8f198d5bed8003b3f::binance {
    ...
    fun init(arg0: BINANCE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<BINANCE>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<BINANCE>>(v4);
    }
