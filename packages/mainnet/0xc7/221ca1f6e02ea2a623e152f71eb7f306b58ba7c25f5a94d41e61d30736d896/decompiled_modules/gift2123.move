module 0xc7221ca1f6e02ea2a623e152f71eb7f306b58ba7c25f5a94d41e61d30736d896::gift2123 {
    struct GIFT2123 has drop {
        dummy_field: bool,
    }

    struct TICKET_2123 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2123(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2123>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2123>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2123, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2123>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2123>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2123>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2123>>(v5, 0x2::tx_context::sender(arg1));
    }
