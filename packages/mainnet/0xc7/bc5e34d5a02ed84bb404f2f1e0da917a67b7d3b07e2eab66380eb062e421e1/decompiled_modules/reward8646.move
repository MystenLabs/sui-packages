module 0xc7bc5e34d5a02ed84bb404f2f1e0da917a67b7d3b07e2eab66380eb062e421e1::reward8646 {
    struct REWARD8646 has drop {
        dummy_field: bool,
    }

    struct TICKET_8646 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8646(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8646>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8646>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8646, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8646>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8646>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8646>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8646>>(v5, 0x2::tx_context::sender(arg1));
    }
