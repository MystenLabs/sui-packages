module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    fun calculate_max_storage_caps_with_land_types_readonly(arg0: &StakingPool, arg1: &vector<LandInfo>, arg2: u128) : ResourceAmounts {
        ...
        while (v1 < 0x1::vector::length<LandInfo>(arg1)) {
            ...
            if (0x1::option::is_none<u64>(&v2.cooldown_ts)) {
                ...
                let v6 = land_type_enum_to_storage_multiplier(string_to_land_type_enum_u8(&v5));
    ...
    fun calculate_user_storage_caps_with_land_types(arg0: &mut StakingPool, arg1: address) : ResourceAmounts {
        ...
        while (v6 < 0x1::vector::length<0x2::object::ID>(&v3)) {
            ...
            let v8 = get_cached_land_type_storage_multiplier(&v7);
    ...
    fun compute_single_land_production(arg0: &StakingPool, arg1: &LandInfo, arg2: u64, arg3: &0x1::option::Option<vector<u8>>) : ResourceAmounts {
        ...
        let (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) = if (0x1::option::is_some<vector<u8>>(arg3)) {
            ...
            (get_cached_size_multiplier(v10, 0), get_cached_size_multiplier(v10, 1), get_cached_size_multiplier(v10, 2), get_cached_size_multiplier(v10, 3), get_cached_size_multiplier(v10, 4), get_cached_size_multiplier(v10, 5), get_cached_size_multiplier(v10, 6), get_cached_sky_bonus(v10), get_cached_soil_bonus(v10), get_cached_land_type_production_multiplier(v10))
        } else {
            let v11 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato::get_attributes(0x2::kiosk::borrow<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato::LAND>(&arg0.kiosk, &arg0.kiosk_owner_cap, arg1.nft_id));
    ...
    fun compute_user_production_with_storage_boost_by_address(arg0: &mut StakingPool, arg1: address, arg2: u64, arg3: u64) : ResourceAmounts {
        ...
        while (v5 < v2) {
            ...
            if (0x1::option::is_none<u64>(&v6.cooldown_ts)) {
                let v8 = get_or_cache_land_traits(arg0, v7.nft_id);
    ...
    fun get_cached_land_type_production_multiplier(arg0: &vector<u8>) : u128 {
        land_type_enum_to_production_multiplier(get_cached_land_type(arg0))
    }

    fun get_cached_land_type_storage_multiplier(arg0: &vector<u8>) : u128 {
        land_type_enum_to_storage_multiplier(get_cached_land_type(arg0))
    }
    ...
    fun land_type_enum_to_production_multiplier(arg0: u8) : u128 {
        if (arg0 == 0) {
            10000
        } else if (arg0 == 1) {
            20000
    ...
    fun land_type_enum_to_storage_multiplier(arg0: u8) : u128 {
        if (arg0 == 0) {
            10000
        } else if (arg0 == 1) {
            40000
