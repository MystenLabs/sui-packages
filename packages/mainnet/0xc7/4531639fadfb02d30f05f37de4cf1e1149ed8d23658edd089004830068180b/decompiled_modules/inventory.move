module 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::inventory {
    ...
    public(friend) fun redeem_random_nft<T0: store + key>(arg0: &mut Inventory<T0>, arg1: 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::RedeemCommitment, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : T0 {
        assert!(is_warehouse<T0>(arg0), 0);
    ...
    public(friend) fun redeem_random_nft_and_transfer<T0: store + key>(arg0: &mut Inventory<T0>, arg1: 0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::RedeemCommitment, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
