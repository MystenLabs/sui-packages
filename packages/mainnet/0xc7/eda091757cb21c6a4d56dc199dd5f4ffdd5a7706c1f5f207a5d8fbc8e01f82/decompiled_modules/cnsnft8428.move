module 0xc7eda091757cb21c6a4d56dc199dd5f4ffdd5a7706c1f5f207a5d8fbc8e01f82::cnsnft8428 {
    struct CNSNFT8428 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8428, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8428>(arg0, arg1);
