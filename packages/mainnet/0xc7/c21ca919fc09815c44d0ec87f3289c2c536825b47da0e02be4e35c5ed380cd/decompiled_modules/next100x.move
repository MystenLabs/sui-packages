module 0xc7c21ca919fc09815c44d0ec87f3289c2c536825b47da0e02be4e35c5ed380cd::next100x {
    struct NEXT100X has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NEXT100X, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NEXT100X>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"next100x"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Testing WALRUS tech integration on Tradeport"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibnapqyzvanhnj62pwmewlo7ojrh5jibi5rwhv2zl2zkoizrkthra"));
