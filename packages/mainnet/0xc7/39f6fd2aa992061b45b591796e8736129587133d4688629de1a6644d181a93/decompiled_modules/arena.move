module 0xc739f6fd2aa992061b45b591796e8736129587133d4688629de1a6644d181a93::arena {
    ...
    public(friend) fun remove_treasury_id(arg0: &mut ArenaStore, arg1: 0x1::string::String) {
        let (v0, v1) = 0x1::vector::index_of<0x1::string::String>(&arg0.created_treasury, &arg1);
        if (v0) {
            0x1::vector::remove<0x1::string::String>(&mut arg0.created_treasury, v1);
        };
    }
