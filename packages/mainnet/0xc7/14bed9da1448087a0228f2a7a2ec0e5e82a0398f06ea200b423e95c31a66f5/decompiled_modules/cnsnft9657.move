module 0xc714bed9da1448087a0228f2a7a2ec0e5e82a0398f06ea200b423e95c31a66f5::cnsnft9657 {
    struct CNSNFT9657 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9657, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3600"));
        let v4 = 0x2::package::claim<CNSNFT9657>(arg0, arg1);
