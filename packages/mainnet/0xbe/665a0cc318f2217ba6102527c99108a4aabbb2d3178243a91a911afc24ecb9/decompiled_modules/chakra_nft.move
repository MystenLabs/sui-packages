module 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::chakra_nft {
    ...
    struct GlobalConfig has key {
        ...
        referral_codes: 0x2::table::Table<0x1::string::String, u64>,
        ...
        version: 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::version::Version,
    }
    ...
    public(friend) fun add_referral_code(arg0: &mut GlobalConfig, arg1: &mut ChakraNFT, arg2: 0x1::string::String) {
        ...
        assert!(!0x2::table::contains<0x1::string::String, u64>(&arg0.referral_codes, v1), 4);
        let v2 = if (is_whale_whitelisted(arg0, arg1.minted_by)) {
            arg0.max_codes_per_whale
        } else {
            arg0.max_codes_per_acc
        };
        0x2::table::add<0x1::string::String, u64>(&mut arg0.referral_codes, v1, v2);
        arg1.referral_codes = v1;
    }

    public fun admin_add_whale_refferal_wl(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0x2::table::add<address, bool>(&mut arg1.whale_refferal_wl, arg2, true);
    }

    public fun admin_overwrite_referral(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: 0x1::string::String, arg2: u64, arg3: &mut GlobalConfig, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::string::String, u64>(&arg3.referral_codes, arg1), 0);
        *0x2::table::borrow_mut<0x1::string::String, u64>(&mut arg3.referral_codes, arg1) = arg2;
    }

    public fun admin_remove_whale_refferal_wl(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0x2::table::remove<address, bool>(&mut arg1.whale_refferal_wl, arg2);
    }

    public fun admin_set_base_price(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.base_price = arg1;
    }

    public fun admin_set_bonus_percentage_per_claim(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig) {
        arg2.bonus_percentage_per_claim = arg1;
    }

    public fun admin_set_boost_a(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_a = arg1;
    }

    public fun admin_set_boost_b(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_b = arg1;
    }

    public fun admin_set_boost_c(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_c = arg1;
    }

    public fun admin_set_boost_d(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_d = arg1;
    }

    public fun admin_set_boost_e(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_e = arg1;
    }

    public fun admin_set_boost_f(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_f = arg1;
    }

    public fun admin_set_display_url(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut 0x2::display::Display<ChakraNFT>, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
        0x2::display::edit<ChakraNFT>(arg1, 0x1::string::utf8(b"image_url"), arg2);
        0x2::display::update_version<ChakraNFT>(arg1);
    }

    public fun admin_set_max_bonus_per_claim(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig) {
        arg2.max_bonus_per_claim = arg1;
    }

    public fun admin_set_referral_price(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.referral_price = arg1;
    }

    public fun admin_set_refferal_limit_per_acc(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.max_codes_per_acc = arg1;
    }

    public fun admin_set_refferal_limit_per_whale(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.max_codes_per_whale = arg1;
    }

    public fun admin_set_status(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: bool, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.status = arg1;
    }
    ...
    public fun batch_update_a(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun batch_update_b(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 1,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_c(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 2,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_d(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 3,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_e(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 4,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_f(arg0: &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 5,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    fun init(arg0: CHAKRA_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = GlobalConfig{
            ...
            referral_codes             : 0x2::table::new<0x1::string::String, u64>(arg1),
            ...
            total_maya_burnt           : 0,
            version                    : 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::version::new(arg1),
        };
    ...
    public fun is_code_available(arg0: &GlobalConfig, arg1: 0x1::string::String) : bool {
        !0x2::table::contains<0x1::string::String, u64>(&arg0.referral_codes, arg1)
    }
    ...
    public fun remaining_referrals(arg0: &GlobalConfig, arg1: 0x1::string::String) : (u64, bool) {
        if (0x2::table::contains<0x1::string::String, u64>(&arg0.referral_codes, arg1)) {
            (*0x2::table::borrow<0x1::string::String, u64>(&arg0.referral_codes, arg1), true)
        } else {
            (0, false)
        }
    }
    ...
    public fun total_referral_entries_count(arg0: &GlobalConfig) : u64 {
        0x2::table::length<0x1::string::String, u64>(&arg0.referral_codes)
    }

    public(friend) fun use_referral_code(arg0: &mut GlobalConfig, arg1: 0x1::string::String) {
        assert!(0x2::table::contains<0x1::string::String, u64>(&arg0.referral_codes, arg1), 0);
        let v0 = 0x2::table::borrow_mut<0x1::string::String, u64>(&mut arg0.referral_codes, arg1);
        assert!(*v0 > 0, 1);
        *v0 = *v0 - 1;
    }
    ...
    public fun version(arg0: &GlobalConfig) : &0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::version::Version {
        &arg0.version
    }
