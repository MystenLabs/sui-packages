module 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::version {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : Version {
        Version{
            ...
            major_version : 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::current_version::current_major_version(),
            minor_version : 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::current_version::current_minor_version(),
        }
    }
    ...
    public fun is_supported_major_version(arg0: &Version) : bool {
        arg0.major_version == 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::current_version::current_major_version()
    }

    public fun is_supported_minor_version(arg0: &Version) : bool {
        0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::current_version::current_minor_version() >= arg0.minor_version
    }
    ...
    public fun upgrade_major(arg0: &mut Version, arg1: &VersionCap) {
        arg0.major_version = 0xbe665a0cc318f2217ba6102527c99108a4aabbb2d3178243a91a911afc24ecb9::current_version::current_major_version() + 1;
    }
