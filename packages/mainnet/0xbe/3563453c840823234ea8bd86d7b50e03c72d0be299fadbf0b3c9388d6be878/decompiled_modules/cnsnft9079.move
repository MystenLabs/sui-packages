module 0xbe3563453c840823234ea8bd86d7b50e03c72d0be299fadbf0b3c9388d6be878::cnsnft9079 {
    struct CNSNFT9079 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9079, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9079>(arg0, arg1);
