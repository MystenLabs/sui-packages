module 0xbec677896a7a40ad9f5801824c510182f485111ddde5112d3a49246aa8d901b7::cnsnft3809 {
    struct CNSNFT3809 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3809, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1811"));
        let v4 = 0x2::package::claim<CNSNFT3809>(arg0, arg1);
