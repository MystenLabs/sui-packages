module 0xbeee423f6a2571832cef7c11da65e8a2da2c770a90a877c2d18a146492643c07::cnsnft3007 {
    struct CNSNFT3007 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3007, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3007>(arg0, arg1);
