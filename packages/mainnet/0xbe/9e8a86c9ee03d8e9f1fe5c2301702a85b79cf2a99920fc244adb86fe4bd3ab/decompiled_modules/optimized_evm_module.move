module 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module {
    ...
    public fun prepare_signing_eip1559(arg0: &mut 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::module_interface::VaultContainer, arg1: &EVMModule, arg2: 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::module_interface::ModuleActionRequest<EVMAction>, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::module_interface::ModuleActionResult<EVMPreparedSigning> {
        ...
        assert!(arg4 <= v0.max_allowed_nonce, 3);
        if (arg4 == v0.max_allowed_nonce) {
            v0.max_allowed_nonce = v0.max_allowed_nonce + 1;
        };
        let v10 = EVMTxData{
            nonce   : arg4,
            dropped : false,
    ...
    public fun to_signable_blob_eip1559(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: u64) : vector<u8> {
        ...
        let v1 = 0x1::vector::length<u8>(&arg3) == 1 && *0x1::vector::borrow<u8>(&arg3, 0) < 128;
        if (!v1) {
            0x1::vector::append<u8>(&mut v0, encode_length(0x1::vector::length<u8>(&arg3), 128));
        };
        let v2 = encode_array_of_bytes(0x1::vector::empty<vector<u8>>());
        let v3 = 0x1::vector::singleton<u8>(2);
        0x1::vector::append<u8>(&mut v3, encode_length(0x1::vector::length<u8>(&v0) + 0x1::vector::length<u8>(&arg3) + 0x1::vector::length<u8>(&v2), 192));
    ...
    public fun to_signable_blob_legacy(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64) : vector<u8> {
        ...
        let v2 = encode_bytes(arg0);
        let v3 = encode_bytes(0x1::vector::empty<u8>());
        let v4 = encode_bytes(0x1::vector::empty<u8>());
        let v5 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v5, encode_length(0x1::vector::length<u8>(&v0) + 0x1::vector::length<u8>(&arg3) + 0x1::vector::length<u8>(&v2) + 0x1::vector::length<u8>(&v3) + 0x1::vector::length<u8>(&v4), 192));
