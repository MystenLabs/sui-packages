module 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::erc20_native_transfer_for_optimized {
    ...
    fun assemble_ethereum_erc20_action(arg0: vector<u8>, arg1: vector<u8>, arg2: 0x1::string::String, arg3: u256) : 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::EVMAction {
        let v0 = 0x1::vector::empty<u8>();
        let v1 = b"transfer(address,uint256)";
        0x1::vector::append<u8>(&mut v0, 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::bytes4(0x2::hash::keccak256(&v1)));
        0x1::vector::append<u8>(&mut v0, 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::left_pad_address_to_32_bytes(arg1));
        0x1::vector::append<u8>(&mut v0, 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::u256_to_32_byte_vector(arg3));
        let v2 = 0x1::string::utf8(b":");
        let v3 = 0x1::string::substring(&arg2, 0x1::string::index_of(&arg2, &v2) + 1, 0x1::string::length(&arg2));
        let v4 = 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::string_to_number(*0x1::string::as_bytes(&v3));
        0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::create_evm_action(v0, 0x1::vector::empty<u8>(), arg0, 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::to_minimal_be_bytes<u32>(&v4))
    }

    fun assemble_ethereum_native_transfer_action(arg0: vector<u8>, arg1: 0x1::string::String, arg2: u256) : 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::EVMAction {
        let v0 = 0x1::string::utf8(b":");
        let v1 = 0x1::string::substring(&arg1, 0x1::string::index_of(&arg1, &v0) + 1, 0x1::string::length(&arg1));
        let v2 = 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::string_to_number(*0x1::string::as_bytes(&v1));
        0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::create_evm_action(0x1::vector::empty<u8>(), 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::to_minimal_be_bytes<u256>(&arg2), arg0, 0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::to_minimal_be_bytes<u32>(&v2))
    }

    public fun get_effects_ERC20_transfer(arg0: &EVMTransferModule, arg1: vector<u8>, arg2: 0x1::string::String, arg3: vector<u8>, arg4: vector<u8>, arg5: u256, arg6: 0x1::option::Option<0xbc813cf16f98aa811aebb4da2e997d38f5347042c9e46ebfabd44d0e83f31b72::signature_utils::SignedPrice>, arg7: &0x2::clock::Clock) : 0x8149631b2b88686a6ae1337c93939c0ed52f9b32dd0817612557dee54c8f1894::module_interface::TxEffectsResult<0xbe9e8a86c9ee03d8e9f1fe5c2301702a85b79cf2a99920fc244adb86fe4bd3ab::optimized_evm_module::EVMAction> {
