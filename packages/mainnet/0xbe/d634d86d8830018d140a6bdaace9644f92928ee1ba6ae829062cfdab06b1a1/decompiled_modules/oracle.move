module 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::oracle {
    ...
    public fun base_amount_to_usd_notional(arg0: u64, arg1: u64, arg2: u8) : u64 {
        0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::safe_math::safe_mul_div_u64(arg0, arg1, pow10(arg2))
    }

    public(friend) fun current_market_prices<T0, T1>(arg0: &0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::PoolState<T0, T1>, arg1: &0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::update::Update, arg2: &0x2::clock::Clock) : (u64, u64, u64) {
        let (v0, _) = usd_price_from_update(0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::base_feed_id_pro<T0, T1>(arg0), arg1, arg2, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::base_max_age_ms<T0, T1>(arg0));
        let (v2, _) = usd_price_from_update(0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::quote_feed_id_pro<T0, T1>(arg0), arg1, arg2, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::quote_max_age_ms<T0, T1>(arg0));
        (v0, v2, reference_price_from_usd(v0, v2, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::base_coin_decimals<T0, T1>(arg0), 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::quote_coin_decimals<T0, T1>(arg0)))
    }

    public(friend) fun current_market_prices_pyth_core<T0, T1>(arg0: &0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::PoolState<T0, T1>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : (u64, u64, u64) {
        let (v0, _) = usd_price_from_pyth_core(0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::base_feed_id_core<T0, T1>(arg0), arg1, arg3, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::base_core_max_age_sec<T0, T1>(arg0));
        let (v2, _) = usd_price_from_pyth_core(0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::quote_feed_id_core<T0, T1>(arg0), arg2, arg3, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::quote_core_max_age_sec<T0, T1>(arg0));
        (v0, v2, reference_price_from_usd(v0, v2, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::base_coin_decimals<T0, T1>(arg0), 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::pool::quote_coin_decimals<T0, T1>(arg0)))
    }
    ...
    fun normalize_price_to_one_by_parts(arg0: u64, arg1: u8, arg2: bool) : u64 {
        let v0 = 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::safe_math::get_one_decimals();
        if (arg2) {
            if (arg1 < v0) {
                arg0 * pow10(v0 - arg1)
            } else if (arg1 == v0) {
    ...
    public fun reference_price_from_usd(arg0: u64, arg1: u64, arg2: u8, arg3: u8) : u64 {
        if (arg3 >= arg2) {
            0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::safe_math::safe_mul_div_u64(arg0, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::safe_math::get_one() * pow10(arg3 - arg2), arg1)
        } else {
            0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::safe_math::safe_mul_div_u64(arg0, 0xbed634d86d8830018d140a6bdaace9644f92928ee1ba6ae829062cfdab06b1a1::safe_math::get_one(), arg1) / pow10(arg2 - arg3)
        }
    }
