module 0xbe7bcdc94f54b462c39cb19ba47a3cf267c7d7bc017fcb0c7252280112826463::cnsnft2862 {
    struct CNSNFT2862 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2862, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8478"));
        let v4 = 0x2::package::claim<CNSNFT2862>(arg0, arg1);
