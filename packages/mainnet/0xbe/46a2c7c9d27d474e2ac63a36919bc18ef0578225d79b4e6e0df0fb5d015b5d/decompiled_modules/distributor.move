module 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor {
    ...
    struct Distributor has store, key {
        ...
        target: u64,
        pool_allocator: 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::Allocator,
        fee_wallet: address,
    ...
    entry fun add_new_pool(arg0: &AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Distributor, arg3: 0x2::object::ID) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::add_new_pool(&mut arg2.pool_allocator, arg3);
    }
    ...
    public(friend) fun get_rewards<T0>(arg0: &mut Distributor, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::get_rewards<T0>(&mut arg0.pool_allocator, arg1, v1, v2)
    }

    entry fun add_admin(arg0: &AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        let v0 = AdminCap{
    ...
    entry fun add_reward<T0>(arg0: &mut Distributor, arg1: &AdminCap, arg2: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg2);
        let v0 = 0x1::type_name::get<T0>();
        assert!(v0 != 0x1::type_name::get<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>(), 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::external_reward_alpha());
        let v1 = false;
        let v2 = if (0x2::vec_map::contains<0x1::type_name::TypeName, UnlockData>(&arg0.reward_unlock, &v0) == true) {
            ...
            0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::top_up_pools<T0>(&mut arg0.pool_allocator, v3.unlock_per_ms, 0x2::math::min(0x2::clock::timestamp_ms(arg5), v3.last_unlock_time), v3.last_unlock_time);
            v3.last_unlock_time
        } else {
            0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::get_rewards_from_distributor<T0>(&mut arg0.pool_allocator, 0x2::balance::zero<T0>());
            v1 = true;
            0
        };
        if (0x2::clock::timestamp_ms(arg5) > v2) {
            0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::top_up_pools<T0>(&mut arg0.pool_allocator, 0, 0x2::clock::timestamp_ms(arg5), 0x2::clock::timestamp_ms(arg5));
        };
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::get_rewards_from_distributor<T0>(&mut arg0.pool_allocator, 0x2::coin::into_balance<T0>(arg3));
        if (v1) {
            let v4 = UnlockData{
                unlock_per_ms    : arg4,
                last_unlock_time : 0x2::clock::timestamp_ms(arg5) + 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::get_reward_value<T0>(&arg0.pool_allocator) / arg4,
            };
            ...
            v5.last_unlock_time = 0x2::clock::timestamp_ms(arg5) + 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::get_reward_value<T0>(&arg0.pool_allocator) / arg4;
        };
    }

    entry fun change_airdrop_wallet_address(arg0: &AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Distributor, arg3: address) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        arg2.airdrop_wallet = arg3;
    }

    entry fun change_dust_wallet_address(arg0: &AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Distributor, arg3: address) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        arg2.dust_wallet_address = arg3;
    }

    entry fun change_fee_wallet_address(arg0: &AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Distributor, arg3: address) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        arg2.fee_wallet = arg3;
    }

    entry fun change_onhold_receipts_wallet_address(arg0: &AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Distributor, arg3: address) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        arg2.onhold_receipts_wallet_address = arg3;
    }

    entry fun change_team_wallet_address(arg0: &AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Distributor, arg3: address) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        arg2.team_wallet_address = arg3;
    }

    public fun create(arg0: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg1: 0x2::coin::TreasuryCap<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>, arg2: address, arg3: address, arg4: address, arg5: address, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Distributor{
            ...
            target                         : 0,
            pool_allocator                 : 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::create_allocator(arg7),
            fee_wallet                     : arg2,
            airdrop_wallet                 : arg3,
    ...
    entry fun delete_pool_from_allocator(arg0: &AdminCap, arg1: &mut Distributor, arg2: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg3: 0x2::object::ID) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg2);
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::delete_pool(&mut arg1.pool_allocator, arg3);
    }
    ...
    fun mint_and_distribute_alpha(arg0: &mut Distributor, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg0.next_halving_timestamp <= 0x2::clock::timestamp_ms(arg1)) {
            ...
            0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::top_up_pools<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>(&mut arg0.pool_allocator, v1, arg0.next_halving_timestamp, arg0.next_halving_timestamp);
    ...
    entry fun remove_unlock_per_second<T0>(arg0: &mut Distributor, arg1: &AdminCap, arg2: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg3: &0x2::clock::Clock) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg2);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, UnlockData>(&arg0.reward_unlock, &v0) == true, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::reward_not_set_error());
        let v1 = 0x2::vec_map::get<0x1::type_name::TypeName, UnlockData>(&arg0.reward_unlock, &v0);
        let v2 = v1.unlock_per_ms;
        if (v2 > 0) {
            0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::top_up_pools<T0>(&mut arg0.pool_allocator, v2, 0x2::math::min(0x2::clock::timestamp_ms(arg3), v1.last_unlock_time), v1.last_unlock_time);
        };
    ...
    fun send_rewards_to_pool_allocator<T0>(arg0: &mut Distributor, arg1: 0x2::coin::Coin<T0>) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::get_rewards_from_distributor<T0>(&mut arg0.pool_allocator, 0x2::coin::into_balance<T0>(arg1));
    }

    public fun set_start_timestamp_and_destroy_cap(arg0: &AdminCap, arg1: BurnStartCap, arg2: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg3: &mut Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg2);
    ...
    entry fun set_weights<T0>(arg0: &AdminCap, arg1: &mut Distributor, arg2: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg3: vector<0x2::object::ID>, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg2);
        assert!(0x1::vector::length<0x2::object::ID>(&arg3) == 0x1::vector::length<u64>(&arg4), 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::input_error());
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, UnlockData>(&arg1.reward_unlock, &v0) == true) {
            ...
            0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::top_up_pools<T0>(&mut arg1.pool_allocator, v1.unlock_per_ms, 0x2::math::min(0x2::clock::timestamp_ms(arg5), v1.last_unlock_time), v1.last_unlock_time);
        };
        if (v0 == 0x1::type_name::get<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>()) {
            ...
            if (arg1.next_halving_timestamp > 0) {
                0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::top_up_pools<T0>(&mut arg1.pool_allocator, upms_for_alpha(arg1), 0x2::clock::timestamp_ms(arg5), arg1.next_halving_timestamp);
            };
        };
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator::set_weight<T0>(&mut arg1.pool_allocator, 0x1::vector::pop_back<0x2::object::ID>(&mut arg3), 0x1::vector::pop_back<u64>(&mut arg4), arg5);
            v2 = v2 + 1;
        };
    }
    ...
    entry fun withdraw_airdrop_balance(arg0: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg1: &mut Distributor, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg0);
        assert!(0x2::balance::value<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>(&arg1.airdrop_wallet_balance) >= arg2, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::insufficient_balance_error());
    ...
    entry fun withdraw_team_balance(arg0: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg1: &mut Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg0);
        assert!(0x2::clock::timestamp_ms(arg2) > arg1.start_timestamp + 300 * 6000, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::withdraw_before_cliff_error());
        assert!(0x2::balance::value<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>(&arg1.team_wallet_balance) > 0, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::insufficient_balance_error());
