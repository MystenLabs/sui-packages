module 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::allocator {
    ...
    public fun remove<T0>(arg0: &mut Allocator, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.rewards, 0x1::type_name::get<T0>())), arg1), 0x2::tx_context::sender(arg1));
    }

    public(friend) fun add_new_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == false, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::pool_already_present_error());
    ...
    public(friend) fun delete_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == true, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::pool_not_present_error());
        ...
        assert!(v3 == true, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::pool_has_weight_error());
        assert!(v4 == false, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::pending_rewards_error());
    ...
    public(friend) fun get_rewards_from_distributor<T0>(arg0: &mut Allocator, arg1: 0x2::balance::Balance<T0>) {
        ...
        let v0 = AllocatorEvent{
            value    : 0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.rewards, 0x1::type_name::get<T0>())),
            location : 10,
        };
        0x2::event::emit<AllocatorEvent>(v0);
    }
    ...
    public(friend) fun top_up_pools<T0>(arg0: &mut Allocator, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg2 <= arg3, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::unlock_time_exceeded_error());
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.rewards, 0x1::type_name::get<T0>()) == false) {
            return
        };
        if (0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.rewards, 0x1::type_name::get<T0>())) == 0) {
            arg1 = 0;
        };
