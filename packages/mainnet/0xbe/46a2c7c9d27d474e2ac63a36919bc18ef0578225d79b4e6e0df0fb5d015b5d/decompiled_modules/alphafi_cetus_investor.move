module 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::alphafi_cetus_investor {
    ...
    fun autocompound_internal<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, 0x2::sui::SUI>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: 0x2::balance::Balance<T0>, arg8: 0x2::balance::Balance<T1>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (v7 >= arg0.minimum_swap_amount) {
            let (v8, v9) = 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::converter::swap_b2a<T1, 0x2::sui::SUI>(arg2, arg4, v1, true, v7, arg9, arg10);
            let v10 = v8;
            0x2::coin::destroy_zero<0x2::sui::SUI>(v9);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v10, (((0x2::coin::value<T1>(&v10) as u128) * (arg0.performance_fee as u128) / 10000) as u64), arg10), 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::get_fee_wallet_address(arg1));
        ...
        let v13 = v12;
        let v14 = v11;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v14, (((0x2::balance::value<T0>(&v14) as u128) * (arg0.performance_fee as u128) / 10000) as u64)), arg10), 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v13, (((0x2::balance::value<T1>(&v13) as u128) * (arg0.performance_fee as u128) / 10000) as u64)), arg10), 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::get_fee_wallet_address(arg1));
    ...
    public fun collect_and_convert_reward_to_sui<T0, T1, T2>(arg0: &mut Investor<T0, T2>, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T2>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<u64>(&v1) == true) {
            ...
            if (v3 >= arg0.minimum_swap_amount) {
                let (v5, v6) = 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::converter::swap_a2b<T1, 0x2::sui::SUI>(arg4, arg3, v4, true, v3, arg6, arg7);
    ...
    public(friend) fun get_balances_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool) : (u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (0x2::balance::value<T0>(&arg1) == 0 || 0x2::balance::value<T1>(&arg2) == 0) {
            ...
            if (v7 <= v9) {
                if (arg4 == false) {
                    assert!(((v9 - v7) as u128) * 1000000000 / (v9 as u128) <= 2000000, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::difference_too_high());
                };
                ...
                assert!(v11 <= v14, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::insufficient_balance_to_add_liquidity());
                if (arg4 == false) {
                    assert!(((v14 - v11) as u128) * 1000000000 / (v14 as u128) <= 2000000, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::error::difference_too_high());
                };
                if (v11 > 1) {
                    v13 = v11 - 1;
                };
    ...
    fun get_total_balance_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (v9 > 0) {
            ...
            if (v14 >= (arg0.minimum_swap_amount as u256)) {
                let (v16, v17) = 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::converter::swap_a2b<T0, T1>(arg2, arg5, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.free_balance_a, (v14 as u64)), arg7), true, (v14 as u64), arg6, arg7);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v16, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::get_dust_wallet_address(arg1));
            ...
            if (v21 >= (arg0.minimum_swap_amount as u256)) {
                let (v23, v24) = 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::converter::swap_b2a<T0, T1>(arg2, arg5, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.free_balance_b, (v21 as u64)), arg7), true, (v21 as u64), arg6, arg7);
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v24, 0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::get_dust_wallet_address(arg1));
    ...
    entry fun set_minimum_swap_amount<T0, T1>(arg0: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Investor<T0, T1>, arg3: u64) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
        arg2.minimum_swap_amount = arg3;
    }

    entry fun set_performance_fee<T0, T1>(arg0: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::distributor::AdminCap, arg1: &0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::Version, arg2: &mut Investor<T0, T1>, arg3: u64) {
        0xbe46a2c7c9d27d474e2ac63a36919bc18ef0578225d79b4e6e0df0fb5d015b5d::version::assert_current_version(arg1);
