module 0xe25582daef54ee41052390c4db5e70a82ec1baed97942db0eb6094267624b5d::jewel_cetus_farm {
    ...
    fun do_add_liquidity<T0, T1>(arg0: &mut FarmPool<T0, T1>, arg1: &mut 0xe25582daef54ee41052390c4db5e70a82ec1baed97942db0eb6094267624b5d::jewel_cetus_position::Position, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: 0x2::balance::Balance<T0>, arg5: 0x2::balance::Balance<T1>, arg6: u128, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x1::option::borrow<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.cetus_position));
        let v0 = 0x2::balance::value<T0>(&arg4);
        let v1 = 0x2::balance::value<T1>(&arg5);
        let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity<T0, T1>(arg2, arg3, 0x1::option::borrow_mut<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.cetus_position), arg6, arg7);
        let (v3, v4) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_pay_amount<T0, T1>(&v2);
        assert!(v0 >= v3, 106);
        assert!(v1 >= v4, 107);
        if (v0 > v3) {
            0x2::balance::join<T0>(&mut arg0.surplus_balance_a, 0x2::balance::split<T0>(&mut arg4, v0 - v3));
        };
        if (v1 > v4) {
            0x2::balance::join<T1>(&mut arg0.surplus_balance_b, 0x2::balance::split<T1>(&mut arg5, v1 - v4));
        };
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg2, arg3, arg4, arg5, v2);
    }
