module 0xbecf8389b6fe56086434bd690ea5a98f48faa3f1b40722468872da502f90ca5e::arts_of_generation {
    struct ARTS_OF_GENERATION has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ARTS_OF_GENERATION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ARTS_OF_GENERATION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Arts of Generation"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Arts of Generation is a collection of 555 unique Ai Arts NFTs-- unique digital collectibles living on the SUI Blockchain."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigktg2q25iqwei2r2s3hnc7da4s7cxi3upgw73i5zybwse6i7v6mu"));
