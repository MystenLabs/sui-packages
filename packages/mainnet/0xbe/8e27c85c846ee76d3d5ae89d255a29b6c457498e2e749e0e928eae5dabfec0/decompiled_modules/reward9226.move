module 0xbe8e27c85c846ee76d3d5ae89d255a29b6c457498e2e749e0e928eae5dabfec0::reward9226 {
    struct REWARD9226 has drop {
        dummy_field: bool,
    }

    struct TICKET_9226 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9226(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9226>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9226>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9226, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9226>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9226>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9226>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9226>>(v5, 0x2::tx_context::sender(arg1));
    }
