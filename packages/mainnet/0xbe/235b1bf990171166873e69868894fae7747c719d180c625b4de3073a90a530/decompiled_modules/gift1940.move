module 0xbe235b1bf990171166873e69868894fae7747c719d180c625b4de3073a90a530::gift1940 {
    struct GIFT1940 has drop {
        dummy_field: bool,
    }

    struct TICKET_1940 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1940(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1940>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1940>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1940, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1940>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1940>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1940>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1940>>(v5, 0x2::tx_context::sender(arg1));
    }
