module 0xbef9fcc829071597a54ce7a346470c340ca0a3e995db014717e4e754008c0788::flow_raffle {
    ...
    public entry fun create_kiosk_borrow_raffle<T0: store + key>(arg0: &GlobalConfig, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: 0x2::object::ID, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk::has_item(arg1, arg4), 4);
        assert!(0x2::kiosk::has_item_with_type<T0>(arg1, arg4), 4);
        assert!(0x2::kiosk::has_access(arg1, arg2), 4);
        0x2::kiosk::borrow<T0>(arg1, arg2, arg4);
