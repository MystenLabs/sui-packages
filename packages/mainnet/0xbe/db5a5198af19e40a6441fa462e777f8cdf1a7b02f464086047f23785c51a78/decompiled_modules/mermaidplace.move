module 0xbedb5a5198af19e40a6441fa462e777f8cdf1a7b02f464086047f23785c51a78::mermaidplace {
    ...
    public entry fun buy<T0: store + key>(arg0: &mut MermaidplaceConfig, arg1: &mut 0xbedb5a5198af19e40a6441fa462e777f8cdf1a7b02f464086047f23785c51a78::royalty_fee::RoyaltyBag, arg2: 0x2::object::ID, arg3: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0xbedb5a5198af19e40a6441fa462e777f8cdf1a7b02f464086047f23785c51a78::royalty_fee::charge_royalty<T0>(arg1, v3, &mut v1, arg4);
        assert!(v8 + v9 < v3, 5);
        let v10 = v3 - v8 - v9;
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xbedb5a5198af19e40a6441fa462e777f8cdf1a7b02f464086047f23785c51a78::royalty_fee::init_royalty_bag(arg0);
    }
