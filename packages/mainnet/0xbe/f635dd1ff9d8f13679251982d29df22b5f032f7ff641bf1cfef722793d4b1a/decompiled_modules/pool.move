module 0xb073375aba97556eff7a6263fe686a421e3365877dedb6f68ea938e234d0bf85::pool {
    ...
    struct AdminSweepEvent has copy, drop {
        pool_id: 0x2::object::ID,
        sender: address,
        amount_a: u64,
        amount_b: u64,
    ...
    public fun admin_sweep<T0, T1>(arg0: &AdminCap, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        arg1.liquidity_global = 0;
        let v0 = AdminSweepEvent{
            pool_id  : 0x2::object::uid_to_inner(&arg1.id),
            sender   : 0x2::tx_context::sender(arg2),
            amount_a : 0x2::balance::value<T0>(&arg1.reserve_a),
            amount_b : 0x2::balance::value<T1>(&arg1.reserve_b),
        };
        0x2::event::emit<AdminSweepEvent>(v0);
        (0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg1.reserve_a), arg2), 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg1.reserve_b), arg2))
    }
    ...
    fun swap_a_to_b_impl<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u256, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
    ...
    public fun swap_a_to_b_with_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x5ef97658a3eee57643f2a7adf724c1558e9e43f778cd3b6c6afbc8d0af52aa71::fee::FeeConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u256, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let v0 = swap_a_to_b_impl<T0, T1>(arg0, arg2, arg3, arg4, arg6);
    ...
    fun swap_b_to_a_impl<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u256, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::event::emit<SwapEvent>(v6);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.reserve_a, v4), arg4)
    }
    ...
    public fun swap_b_to_a_with_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x5ef97658a3eee57643f2a7adf724c1558e9e43f778cd3b6c6afbc8d0af52aa71::fee::FeeConfig, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u256, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = swap_b_to_a_impl<T0, T1>(arg0, arg2, arg3, arg4, arg6);
