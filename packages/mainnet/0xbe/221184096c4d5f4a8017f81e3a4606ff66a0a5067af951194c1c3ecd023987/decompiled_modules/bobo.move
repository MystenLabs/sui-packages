module 0xbe221184096c4d5f4a8017f81e3a4606ff66a0a5067af951194c1c3ecd023987::bobo {
    ...
    fun init(arg0: BOBO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<BOBO>(&mut v2, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
