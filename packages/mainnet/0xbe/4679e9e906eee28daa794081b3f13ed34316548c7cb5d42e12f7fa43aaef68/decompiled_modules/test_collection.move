module 0xad64ed6747c162b35cc6ee9bde9e3e2ce1b80a6981c08604b2b5c549d0d4a7a7::test_collection {
    ...
    fun init(arg0: TEST_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"test collection "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreihmadmvy64lvqt7w5ibvji4pmfc7xjfdqt66xmrr54bwgfcljpjxi"));
