module 0xbea29ddb577779fda6d4b6a6608a2f1003938132d76667fc931a370071a8b4fd::cnsnft6692 {
    struct CNSNFT6692 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6692, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6692>(arg0, arg1);
