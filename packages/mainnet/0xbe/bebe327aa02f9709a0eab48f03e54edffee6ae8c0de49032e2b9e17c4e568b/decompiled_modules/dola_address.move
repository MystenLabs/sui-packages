module 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::dola_address {
    ...
    public fun decode_dola_address(arg0: vector<u8>) : DolaAddress {
        ...
        DolaAddress{
            dola_chain_id : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::deserialize_u16(&v2),
            dola_address  : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::vector_slice<u8>(&arg0, v0 + v1, 0x1::vector::length<u8>(&arg0)),
        }
    }

    public fun encode_dola_address(arg0: DolaAddress) : vector<u8> {
        let v0 = 0x1::vector::empty<u8>();
        0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::serialize_u16(&mut v0, arg0.dola_chain_id);
        0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::serialize_vector(&mut v0, arg0.dola_address);
        v0
    }
