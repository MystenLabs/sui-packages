module 0xbef2831bf20b29825c1b9073216c1d1e77d4703ecf903695a09bf18fb1140eb4::jack {
    ...
    fun init(arg0: JACK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JACK>(arg0, 9, b"jack", b"JACK", b"test token", 0x1::option::none<0x2::url::Url>(), arg1);
