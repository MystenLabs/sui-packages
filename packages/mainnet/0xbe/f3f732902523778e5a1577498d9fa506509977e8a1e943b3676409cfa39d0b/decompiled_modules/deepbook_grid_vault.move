module 0xbef3f732902523778e5a1577498d9fa506509977e8a1e943b3676409cfa39d0b::deepbook_grid_vault {
    ...
    public fun create_grid_vault<T0, T1>(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : GridVault<T0, T1> {
        ...
        let v1 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::new(arg6);
        let v2 = 0x2::table::new<0x1::string::String, u64>(arg6);
        ...
        let v3 = GridVault<T0, T1>{
            ...
            balance_manager            : v1,
            trade_cap                  : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::mint_trade_cap(&mut v1, arg6),
            deposit_cap                : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::mint_deposit_cap(&mut v1, arg6),
            withdraw_cap               : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::mint_withdraw_cap(&mut v1, arg6),
            allowed_pool_id            : arg0,
            total_shares               : 0,
            user_shares                : 0x2::table::new<address, u64>(arg6),
            user_cost_basis            : 0x2::table::new<address, u64>(arg6),
            strategy_params            : v2,
