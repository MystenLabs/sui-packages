module 0xbe6b04a00af176418a8119117f70030516a159fd7aff82d3dce26a4800c432bb::hapika {
    struct HAPIKA has drop {
        dummy_field: bool,
    }

    fun init(arg0: HAPIKA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HAPIKA>(arg0, 6, b"HAPIKA", b"30mins left", b"No mint function. Join: https://t.me/HalfPikachu.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/EJ3mLKs.png"))), arg1);
        let v2 = v0;
