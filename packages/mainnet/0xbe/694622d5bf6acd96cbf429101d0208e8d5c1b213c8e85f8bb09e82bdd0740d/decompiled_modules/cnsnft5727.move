module 0xbe694622d5bf6acd96cbf429101d0208e8d5c1b213c8e85f8bb09e82bdd0740d::cnsnft5727 {
    struct CNSNFT5727 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5727, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5727>(arg0, arg1);
