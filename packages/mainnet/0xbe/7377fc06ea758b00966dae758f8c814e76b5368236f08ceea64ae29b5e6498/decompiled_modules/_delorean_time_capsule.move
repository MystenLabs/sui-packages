module 0xbe7377fc06ea758b00966dae758f8c814e76b5368236f08ceea64ae29b5e6498::_delorean_time_capsule {
    struct _DELOREAN_TIME_CAPSULE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _DELOREAN_TIME_CAPSULE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_DELOREAN_TIME_CAPSULE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" DeLorean Time Capsule"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The DeLorean Time Capsule is a collection of 8,800 Time Capsule NFTs travelling to the future on the Sui blockchain, driving innovation in the automotive industry. These NFTs will open in the near future to reveal exciting prizes, including the chance to win a new DeLorean vehicle model, early build slot reservations, F1 experience packages, DMC Nike Dunk SE 6.0 sneakers and many more iconic prizes to be announced! Visit www.DeLoreanLabs.com for more details"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://EpT2BGzWPgS-qTdvHyNnTcxalcKhcDMeaOQ_7_LhcUM"));
