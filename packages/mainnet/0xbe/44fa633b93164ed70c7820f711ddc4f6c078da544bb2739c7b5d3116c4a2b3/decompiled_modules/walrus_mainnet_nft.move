module 0xbe44fa633b93164ed70c7820f711ddc4f6c078da544bb2739c7b5d3116c4a2b3::walrus_mainnet_nft {
    struct WALRUS_MAINNET_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WALRUS_MAINNET_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WALRUS_MAINNET_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Walrus Mainnet NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Walrus is a decentralized storage and availability protocol designed specifically for large binary files."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicdu3ohfemv37nqakaaomp567ppavm4ucmarc2x3qeqcn46ki6hdy"));
