module 0xbebc870f4f72e4dfde04dfc7a5e169a7697b9503c1a9a8f27c4205158e9bfcd5::cnsnft4565 {
    struct CNSNFT4565 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4565, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4565>(arg0, arg1);
