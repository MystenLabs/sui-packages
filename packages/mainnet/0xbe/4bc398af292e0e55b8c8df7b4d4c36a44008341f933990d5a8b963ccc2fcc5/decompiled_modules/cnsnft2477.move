module 0xbe4bc398af292e0e55b8c8df7b4d4c36a44008341f933990d5a8b963ccc2fcc5::cnsnft2477 {
    struct CNSNFT2477 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2477, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2477>(arg0, arg1);
