module 0xbe7451adebbcebe152119debd8723a089914ed7b355659827e621a3b0da91934::claim {
    ...
    public fun getOwner<T0>(arg0: &mut ClaimPool<T0>) : address {
        arg0.owner
    }

    public fun getTokenLeft<T0>(arg0: &mut ClaimPool<T0>) : u64 {
