module 0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::directory {
    ...
    public fun delist<T0>(arg0: &mut AgentDirectory<T0>, arg1: &T0, arg2: &0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::AgentIdentity) {
        let v0 = 0x2::object::id<0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::AgentIdentity>(arg2);
    ...
    public fun list<T0>(arg0: &mut AgentDirectory<T0>, arg1: &T0, arg2: &0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::AgentIdentity, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::AgentIdentity>(arg2);
        assert!(!0x2::table::contains<0x2::object::ID, DirectoryEntry>(&arg0.listings, v0), 0);
        let v1 = DirectoryEntry{
            agent_id    : v0,
            owner       : 0x2::tx_context::sender(arg3),
            name        : *0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::name(arg2),
            description : *0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::description(arg2),
            tags        : *0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::tags(arg2),
    ...
    public fun update_listing<T0>(arg0: &mut AgentDirectory<T0>, arg1: &T0, arg2: &0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::AgentIdentity, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::AgentIdentity>(arg2);
        assert!(0x2::table::contains<0x2::object::ID, DirectoryEntry>(&arg0.listings, v0), 1);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, DirectoryEntry>(&mut arg0.listings, v0);
        v1.owner = 0x2::tx_context::sender(arg3);
        v1.name = *0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::name(arg2);
        v1.description = *0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::description(arg2);
        v1.tags = *0x43d916113ce11bc53662eea0b54aaa340270f837d8148d06c494af4077491076::identity::tags(arg2);
    }
