module 0xbed221ac7d10f58c3d52bd4326e69848fd3e8b4d3d5fa5dbb9aedabe630c1ac7::bm {
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext, arg1: address) : address {
        let v0 = CBM{
            id : 0x2::object::new(arg0),
            o  : arg1,
            b  : 0x2::bag::new(arg0),
            aw : 0x2::vec_set::empty<address>(),
            tc : 0x2::table::new<address, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeCap>(arg0),
        };
        ...
        0x2::transfer::public_transfer<AC>(v2, arg1);
        v1
    }
