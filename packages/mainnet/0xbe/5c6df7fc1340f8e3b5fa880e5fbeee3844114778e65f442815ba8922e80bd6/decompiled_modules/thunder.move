module 0xbe5c6df7fc1340f8e3b5fa880e5fbeee3844114778e65f442815ba8922e80bd6::thunder {
    ...
    entry fun strike_relay(arg0: &mut Storm, arg1: vector<u8>, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::ed25519::ed25519_verify(&arg4, &arg5, &arg3), 5);
        ...
        v0.last_activity_ms = 0x2::clock::timestamp_ms(arg6);
