module 0xbe36938a4f4291fa2a0606693d695c2b9f3093e0cb9349372f57002e2f11c9b7::reward2129 {
    struct REWARD2129 has drop {
        dummy_field: bool,
    }

    struct TICKET_2129 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2129(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2129>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2129>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2129, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2129>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2129>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2129>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2129>>(v5, 0x2::tx_context::sender(arg1));
    }
