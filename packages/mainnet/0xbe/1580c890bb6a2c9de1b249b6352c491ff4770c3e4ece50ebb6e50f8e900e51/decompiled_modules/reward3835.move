module 0xbe1580c890bb6a2c9de1b249b6352c491ff4770c3e4ece50ebb6e50f8e900e51::reward3835 {
    struct REWARD3835 has drop {
        dummy_field: bool,
    }

    struct TICKET_3835 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3835(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3835>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3835>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3835, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3835>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3835>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3835>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3835>>(v5, 0x2::tx_context::sender(arg1));
    }
