module 0xbe4a10ba2d17d6070a2a2a2f4c04e2b5b8dd93c2fccd47c07be95bfcc3a75894::rebalancer_ab {
    ...
    fun clamp_lower_to_bounds(arg0: u32, arg1: u32, arg2: u32) : u32 {
        let v0 = 443636 / arg2 * arg2;
        let v1 = 0 - v0;
        let v2 = v0 - arg1;
        if (signed_lt_u32(arg0, v1)) {
            return v1
        };
        if (signed_gt_u32(arg0, v2)) {
            return v2
        };
        arg0
    }

    public entry fun create<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg1);
        ...
        0x2::transfer::public_transfer<Vault<T0, T1>>(v1, 0x2::tx_context::sender(arg1));
    }
    ...
    fun is_current_pos_one_of_three(arg0: u32, arg1: u32, arg2: u32, arg3: u32, arg4: u32) : bool {
        ...
        let v1 = clamp_lower_to_bounds(v0, arg4, arg3);
        let v2 = clamp_lower_to_bounds(v0 + arg4, arg4, arg3);
        let v3 = clamp_lower_to_bounds(v0 - arg4, arg4, arg3);
        if (arg0 == v1 && arg1 == v1 + arg4) {
            true
        } else if (arg0 == v2 && arg1 == v2 + arg4) {
            true
        } else {
            arg0 == v3 && arg1 == v3 + arg4
        }
    }
    ...
    fun ll_swap_a_to_b_amount<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: u64) {
        ...
        let (v0, v1, v2) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg2, true, true, arg4, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price() + 1, arg3);
        let v3 = v2;
    ...
    fun ll_swap_b_to_a_amount<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: u64) {
        ...
        let (v0, v1, v2) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg2, false, true, arg4, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price() - 1, arg3);
        let v3 = v2;
        let v4 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v3);
    ...
    fun pick_best_range_and_limit_side(arg0: u64, arg1: u64, arg2: u128, arg3: u32, arg4: u32) : (u32, u32, bool) {
        let v0 = 1 * arg4;
        let v1 = tick_floor_to_spacing_u32(arg3, arg4);
        let v2 = clamp_lower_to_bounds(v1, v0, arg4);
        let v3 = clamp_lower_to_bounds(v1 + v0, v0, arg4);
        let v4 = clamp_lower_to_bounds(v1 - v0, v0, arg4);
        if (arg0 > 0 && arg1 == 0) {
            return (v3, v3 + v0, true)
        };
        if (arg1 > 0 && arg0 == 0) {
            return (v4, v4 + v0, false)
        };
        let (v5, v6) = max_liquidity_for_range(arg0, arg1, arg2, v2, v2 + v0);
        let (v7, v8) = max_liquidity_for_range(arg0, arg1, arg2, v3, v3 + v0);
        let (v9, v10) = max_liquidity_for_range(arg0, arg1, arg2, v4, v4 + v0);
        if (v5 >= v7 && v5 >= v9) {
            (v2, v2 + v0, v6)
        } else if (v7 >= v9) {
            (v3, v3 + v0, v8)
    ...
    public entry fun rebalance<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: bool, arg5: bool, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1) {
            ...
            if (is_current_pos_one_of_three(arg0.pos_tick_lower, arg0.pos_tick_upper, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg2)), v2, 1 * v2)) {
                return
            };
        };
    ...
    public entry fun set_pool<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg2);
        assert!(!arg0.has_position, 4);
        let v0 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg1);
    ...
    fun signed_gt_u32(arg0: u32, arg1: u32) : bool {
        signed_lt_u32(arg1, arg0)
    }

    fun signed_lt_u32(arg0: u32, arg1: u32) : bool {
        let v0 = tick_is_negative(arg0);
        let v1 = tick_is_negative(arg1);
        v0 != v1 && v0 && !v1 || arg0 < arg1
    }
    ...
    fun tick_is_negative(arg0: u32) : bool {
        arg0 & 2147483648 != 0
    }
    ...
    public fun vault_ticks_i32<T0, T1>(arg0: &Vault<T0, T1>) : (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) {
        (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.pos_tick_lower), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.pos_tick_upper))
    }
