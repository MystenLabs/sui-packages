module 0xbe4f8248a06eede0a18a57a23236a72680c2e2316edc807d3cc02a8d436bf86e::birds_nft {
    ...
    public fun update_mating_left(arg0: &BirdConfig, arg1: &mut BirdNFT) : (u64, u64) {
        assert!(arg0.version == 1, 1002);
        assert!(arg1.mating_left > 0, 1017);
        arg1.mating_left = arg1.mating_left - 1;
        let v0 = arg1.max_mating - arg1.mating_left;
        let v1 = UpdateNFTMatingCount{
            id           : 0x2::object::id<BirdNFT>(arg1),
            mating_left  : arg1.mating_left,
            mating_count : v0,
        };
        0x2::event::emit<UpdateNFTMatingCount>(v1);
        (v0, arg1.mating_left)
    }
