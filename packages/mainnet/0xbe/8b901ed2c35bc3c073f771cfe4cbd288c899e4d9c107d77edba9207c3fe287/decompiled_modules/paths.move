module 0xbe8b901ed2c35bc3c073f771cfe4cbd288c899e4d9c107d77edba9207c3fe287::paths {
        ...
        while (v1 < 0x1::vector::length<PriceNode>(arg1)) {
            ...
            if (v4 > 0) {
                ...
                while (v5 < v4) {
                    ...
                    let v8 = 0xbe8b901ed2c35bc3c073f771cfe4cbd288c899e4d9c107d77edba9207c3fe287::arithmetic::mul_128(0x1::vector::borrow<Route>(&v3, v5).sqrtPrice, v2.sqrtPrice);
                    if (v8 > v7 || v6 < arg2) {
