module 0xbe63cc5a29f9cd4e6184eac15a38841ed27063f798796c0fe56433d3e2cec8b7::thunder {
    ...
    entry fun deposit(arg0: &mut Thunder, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun peek(arg0: &Thunder, arg1: vector<u8>) : (vector<u8>, vector<u8>, u64) {
    ...
    entry fun pop(arg0: &mut Thunder, arg1: vector<u8>, arg2: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg3: &0x2::tx_context::TxContext) {
