module 0xbecef125fd1a25dc19486e4f3603a57652531b37ace9465549798128e55a3772::cnsnft5013 {
    struct CNSNFT5013 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5013, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8922"));
        let v4 = 0x2::package::claim<CNSNFT5013>(arg0, arg1);
