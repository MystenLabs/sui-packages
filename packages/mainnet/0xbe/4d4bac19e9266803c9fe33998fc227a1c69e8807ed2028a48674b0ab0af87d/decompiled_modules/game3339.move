module 0xbe4d4bac19e9266803c9fe33998fc227a1c69e8807ed2028a48674b0ab0af87d::game3339 {
    struct GAME3339 has drop {
        dummy_field: bool,
    }

    struct TICKET_3339 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3339(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3339>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3339>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME3339, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3339>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3339>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3339>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3339>>(v5, 0x2::tx_context::sender(arg1));
    }
