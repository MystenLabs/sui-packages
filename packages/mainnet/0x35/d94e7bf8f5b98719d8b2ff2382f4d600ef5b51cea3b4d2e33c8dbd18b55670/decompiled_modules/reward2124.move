module 0x35d94e7bf8f5b98719d8b2ff2382f4d600ef5b51cea3b4d2e33c8dbd18b55670::reward2124 {
    struct REWARD2124 has drop {
        dummy_field: bool,
    }

    struct TICKET_2124 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2124(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2124>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2124>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2124, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2124>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2124>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2124>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2124>>(v5, 0x2::tx_context::sender(arg1));
    }
