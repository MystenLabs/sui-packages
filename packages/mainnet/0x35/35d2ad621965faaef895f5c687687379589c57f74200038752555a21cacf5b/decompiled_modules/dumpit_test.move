module 0x3535d2ad621965faaef895f5c687687379589c57f74200038752555a21cacf5b::dumpit_test {
    struct DUMPIT_TEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DUMPIT_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DUMPIT_TEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"DumpIT test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dump.it"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://orRZw02X4bnxfE5hasFA-68eZigEW-RXGhWHYTj-hzs"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 3300, 0);
