module 0x352e4e50bdc9efe3719bb85cae72a41fddeed0ff64658f88e0899d89dd8b1c20::privatecoin {
    ...
    fun init(arg0: PRIVATECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        mint(v3, 2222220000000000, @0x32efe2b154c930565177f3eef79dc7181545646aa106aea2daee829b3c47cd18, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<PRIVATECOIN>>(v2, @0x32efe2b154c930565177f3eef79dc7181545646aa106aea2daee829b3c47cd18);
    }
