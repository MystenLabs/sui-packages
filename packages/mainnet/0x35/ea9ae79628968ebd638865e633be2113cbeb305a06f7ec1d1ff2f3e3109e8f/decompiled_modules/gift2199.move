module 0x35ea9ae79628968ebd638865e633be2113cbeb305a06f7ec1d1ff2f3e3109e8f::gift2199 {
    struct GIFT2199 has drop {
        dummy_field: bool,
    }

    struct TICKET_2199 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2199(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2199>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2199>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2199, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2199>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2199>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2199>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2199>>(v5, 0x2::tx_context::sender(arg1));
    }
