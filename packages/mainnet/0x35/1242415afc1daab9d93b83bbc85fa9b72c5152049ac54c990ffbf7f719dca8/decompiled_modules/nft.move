module 0x351242415afc1daab9d93b83bbc85fa9b72c5152049ac54c990ffbf7f719dca8::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v9;
        let v11 = v8;
        0x351242415afc1daab9d93b83bbc85fa9b72c5152049ac54c990ffbf7f719dca8::royalty_policy::set<Item>(&mut v11, &v10, 200);
    ...
    public entry fun mint(arg0: u8, arg1: u8, arg2: vector<u8>, arg3: &mut Storage, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(verifyMintSignature(arg3.package, 0x2::tx_context::sender(arg4), arg0, arg1, arg3.signer, arg2), 9223372509301506054);
    ...
    fun verifyMintSignature(arg0: address, arg1: address, arg2: u8, arg3: u8, arg4: vector<u8>, arg5: vector<u8>) : bool {
        ...
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0x351242415afc1daab9d93b83bbc85fa9b72c5152049ac54c990ffbf7f719dca8::string::u8_to_string(arg2));
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0x351242415afc1daab9d93b83bbc85fa9b72c5152049ac54c990ffbf7f719dca8::string::u8_to_string(arg3));
