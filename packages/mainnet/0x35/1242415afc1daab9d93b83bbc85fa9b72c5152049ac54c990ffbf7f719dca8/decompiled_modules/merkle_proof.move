module 0x351242415afc1daab9d93b83bbc85fa9b72c5152049ac54c990ffbf7f719dca8::merkle_proof {
    ...
    fun hash_pair(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
        if (0x351242415afc1daab9d93b83bbc85fa9b72c5152049ac54c990ffbf7f719dca8::vectors::lt(arg0, arg1)) {
    ...
    public fun verify_with_index(arg0: &vector<vector<u8>>, arg1: vector<u8>, arg2: vector<u8>) : (bool, u256) {
        ...
        while (v1 < 0x1::vector::length<vector<u8>>(arg0)) {
            ...
            let v5 = if (0x351242415afc1daab9d93b83bbc85fa9b72c5152049ac54c990ffbf7f719dca8::vectors::lt(v0, v4)) {
