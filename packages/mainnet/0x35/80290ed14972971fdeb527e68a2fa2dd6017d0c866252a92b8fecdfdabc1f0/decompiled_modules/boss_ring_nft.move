module 0x3580290ed14972971fdeb527e68a2fa2dd6017d0c866252a92b8fecdfdabc1f0::boss_ring_nft {
    struct BOSS_RING_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BOSS_RING_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BOSS_RING_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Boss Ring NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Build your empire, outsmart the streets. In MOBFI, loyalty is power and betrayal has a price."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiecaooe3iy7jogp2yzjonvuz2rhyrsaqidvw4qu4k3yblxmg7r3p4"));
