module 0x351a52abb0bdef8fc03a854e67d1cf98da03afde959a5539d78fc8833579e7a1::cnsnft3213 {
    struct CNSNFT3213 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3213, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8417"));
        let v4 = 0x2::package::claim<CNSNFT3213>(arg0, arg1);
