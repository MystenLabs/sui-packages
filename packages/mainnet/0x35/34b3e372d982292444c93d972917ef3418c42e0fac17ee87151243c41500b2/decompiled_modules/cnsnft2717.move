module 0x3534b3e372d982292444c93d972917ef3418c42e0fac17ee87151243c41500b2::cnsnft2717 {
    struct CNSNFT2717 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2717, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2717>(arg0, arg1);
