module 0x35274ed60c35938654dad4efbddb576b86b44399233ff46ed51b6ca27fff6be7::private_coin {
    ...
    fun init(arg0: PRIVATE_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PRIVATE_COIN>(arg0, 9, trim_right(b"USDC"), trim_right(b"private coin"), trim_right(b"yulezhuanyong"), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreicrbhwfehj2o2t6a6tho5rdypqpdw2dn4aa3lmc27t36iicn2oxq4"))), arg1);
        let v2 = v0;
        if (75901320000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<PRIVATE_COIN>>(0x2::coin::mint<PRIVATE_COIN>(&mut v2, 75901320000000000, arg1), 0x2::tx_context::sender(arg1));
        };
