module 0x357f20a7d46a3021402e47c41eab83a7eb69ba5b5883d37afa1c5b31aa33ed3f::cnsnft5857 {
    struct CNSNFT5857 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5857, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5857>(arg0, arg1);
