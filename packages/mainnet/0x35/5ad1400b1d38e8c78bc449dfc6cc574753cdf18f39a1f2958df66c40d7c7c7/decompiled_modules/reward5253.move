module 0x355ad1400b1d38e8c78bc449dfc6cc574753cdf18f39a1f2958df66c40d7c7c7::reward5253 {
    struct REWARD5253 has drop {
        dummy_field: bool,
    }

    struct TICKET_5253 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5253(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5253>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5253>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5253, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5253>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5253>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5253>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5253>>(v5, 0x2::tx_context::sender(arg1));
    }
