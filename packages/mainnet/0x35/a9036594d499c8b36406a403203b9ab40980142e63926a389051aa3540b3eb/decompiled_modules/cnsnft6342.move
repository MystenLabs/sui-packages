module 0x35a9036594d499c8b36406a403203b9ab40980142e63926a389051aa3540b3eb::cnsnft6342 {
    struct CNSNFT6342 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6342, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6342>(arg0, arg1);
