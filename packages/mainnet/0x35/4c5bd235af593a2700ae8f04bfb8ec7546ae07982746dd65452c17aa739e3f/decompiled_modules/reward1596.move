module 0x354c5bd235af593a2700ae8f04bfb8ec7546ae07982746dd65452c17aa739e3f::reward1596 {
    struct REWARD1596 has drop {
        dummy_field: bool,
    }

    struct TICKET_1596 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1596(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1596>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1596>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1596>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1596>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1596>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1596>>(v5, 0x2::tx_context::sender(arg1));
    }
