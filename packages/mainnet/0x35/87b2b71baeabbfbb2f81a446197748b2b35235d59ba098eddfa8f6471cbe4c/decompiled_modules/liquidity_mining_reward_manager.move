module 0x3587b2b71baeabbfbb2f81a446197748b2b35235d59ba098eddfa8f6471cbe4c::liquidity_mining_reward_manager {
    ...
    struct PoolReward has store, key {
        ...
        end_time_ms: u64,
        total_rewards: u64,
        allocated_rewards: 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::Decimal,
        cumulative_rewards_per_share: 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::Decimal,
    ...
    struct ObligationReward has store {
        ...
        earned_rewards: 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::Decimal,
        cumulative_rewards_per_share: 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::Decimal,
    }
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 - v0 >= 3600000, 0x3587b2b71baeabbfbb2f81a446197748b2b35235d59ba098eddfa8f6471cbe4c::error::liquidity_mining_invalid_time());
        ...
        let v3 = PoolReward{
            ...
            allocated_rewards              : 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(0),
            cumulative_rewards_per_share   : 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(0),
            num_obligation_reward_managers : 0,
            additional_fields              : v1,
        };
        let v4 = find_available_index(arg0);
        assert!(v4 < 50, 0x3587b2b71baeabbfbb2f81a446197748b2b35235d59ba098eddfa8f6471cbe4c::error::liquidity_mining_max_concurrent_pool_rewards_violated());
    ...
    public(friend) fun cancel_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::split<T0>(0x2::bag::borrow_mut<RewardBalance<T0>, 0x2::balance::Balance<T0>>(&mut v0.additional_fields, v1), 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::floor(0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::sub(0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(v0.total_rewards), v0.allocated_rewards)))
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v0.coin_type == 0x1::type_name::get<T0>(), 0x3587b2b71baeabbfbb2f81a446197748b2b35235d59ba098eddfa8f6471cbe4c::error::liquidity_mining_invalid_type());
        ...
        let v2 = 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::floor(v1.earned_rewards);
        v1.earned_rewards = 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::sub(v1.earned_rewards, 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(v2));
    ...
    public(friend) fun close_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) >= v4, 0x3587b2b71baeabbfbb2f81a446197748b2b35235d59ba098eddfa8f6471cbe4c::error::liquidity_mining_pool_reward_period_not_over());
        assert!(v8 == 0, 0x3587b2b71baeabbfbb2f81a446197748b2b35235d59ba098eddfa8f6471cbe4c::error::liquidity_mining_not_all_rewards_claimed());
            ...
            if (0x1::option::is_none<ObligationReward>(v5)) {
                if (v0.last_update_time_ms <= v4.end_time_ms) {
                    let v6 = if (v0.last_update_time_ms <= v4.start_time_ms) {
                        0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::mul(v4.cumulative_rewards_per_share, 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(v0.share))
                    } else {
                        0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(0)
                    };
                ...
                v8.earned_rewards = 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::add(v8.earned_rewards, 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::mul(0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::sub(v4.cumulative_rewards_per_share, v8.cumulative_rewards_per_share), 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(v0.share)));
    ...
    fun update_pool_reward_manager(arg0: &mut PoolRewardManager, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<PoolReward>>(&arg0.pool_rewards)) {
            ...
            let v4 = 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::div(0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::mul(0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(v3.total_rewards), 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(0x1::u64::min(v0, v3.end_time_ms) - 0x1::u64::max(v3.start_time_ms, arg0.last_update_time_ms))), 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(v3.end_time_ms - v3.start_time_ms));
            v3.allocated_rewards = 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::add(v3.allocated_rewards, v4);
            v3.cumulative_rewards_per_share = 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::add(v3.cumulative_rewards_per_share, 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::div(v4, 0x3a2341506a50725e93850c5584ab6441bda2c70e82626e15691701e8681bdf5d::float::from(arg0.total_shares)));
            v1 = v1 + 1;
        };
        arg0.last_update_time_ms = v0;
    }
