module 0x35ac7f1e861beadcb3d1b36592ac9f94ccb533913b0d9cdb6c00a4098fa7d6ad::football_arena_sui_ {
    struct FOOTBALL_ARENA_SUI_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"766198de-a474-4340-9b0d-632a68dc2d62"),
        };
    ...
    fun init(arg0: FOOTBALL_ARENA_SUI_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<FOOTBALL_ARENA_SUI_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Football Arena Sui "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Nft Cards "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmfNZMG76CsotX9BcYm98pMEHCN1ABBSkSmkrgxfA1CSc3"));
