module 0x35d36e7e094778989d5b0e23b6c957f78d57d15d993d552d359d59561d5fc7eb::llv_admin {
    ...
    public(friend) fun migrate(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.version = 1;
        0x35d36e7e094778989d5b0e23b6c957f78d57d15d993d552d359d59561d5fc7eb::llv_events::emit_global_migrated(arg0.version);
    }
    ...
    public(friend) fun set_global_paused(arg0: &mut LLVGlobal, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.paused = arg1;
        0x35d36e7e094778989d5b0e23b6c957f78d57d15d993d552d359d59561d5fc7eb::llv_events::emit_global_paused(arg1);
    }
    ...
    public(friend) fun set_owner(arg0: &mut LLVGlobal, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 3);
        arg0.owner = arg1;
        0x35d36e7e094778989d5b0e23b6c957f78d57d15d993d552d359d59561d5fc7eb::llv_events::emit_owner_changed(arg0.owner, arg1);
    }
