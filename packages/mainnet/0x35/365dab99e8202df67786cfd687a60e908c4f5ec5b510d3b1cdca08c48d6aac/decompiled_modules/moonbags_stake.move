module 0x35365dab99e8202df67786cfd687a60e908c4f5ec5b510d3b1cdca08c48d6aac::moonbags_stake {
    ...
    public entry fun claim_creator_pool<T0>(arg0: &mut Configuration, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v1.creator == 0x2::tx_context::sender(arg2), 6);
    ...
    public entry fun transfer_admin(arg0: AdminCap, arg1: &mut Configuration, arg2: address) {
        arg1.admin = arg2;
    ...
    public entry fun unstake<T0>(arg0: &mut Configuration, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v5 >= v4.unstake_deadline, 9);
        update_rewards(v1.reward_index, v4);
    ...
    public entry fun update_config(arg0: &AdminCap, arg1: &mut Configuration, arg2: u64) {
        arg1.deny_unstake_duration_ms = arg2;
    }
