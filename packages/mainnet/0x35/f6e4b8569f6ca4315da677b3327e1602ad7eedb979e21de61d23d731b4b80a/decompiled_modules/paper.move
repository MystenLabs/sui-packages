module 0x35f6e4b8569f6ca4315da677b3327e1602ad7eedb979e21de61d23d731b4b80a::paper {
    ...
    fun init(arg0: PAPER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BZAzTm4J9RXPr2Xm7WmNwHk7e2FhegUuMTBx5fcpump.png?size=lg&key=823dd5                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PAPER>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PAPER     ")))), trim_right(b"Paper Ai                        "), trim_right(b"aper AI offers risk-free paper trading, advanced strategies, and analytics to sharpen your skills and navigate the crypto market confidently.                                                                                                                                                                                   "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
