module 0x35e0e4ff6daeb22b4743d98eb7b9bccbeb6694768f7943b8fca759c56d8a8038::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"MINT", b"TEDT D", b"dsfsdf", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-23T12-16-35.594Z-Cheems.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"TEDT D"),
            symbol     : 0x1::string::utf8(b"MINT"),
            decimals   : 9,
