module 0x35049affa494f8f3b33df888b54bfba0d142ef4e0263d1ea8a602ce53649ee0c::gift6172 {
    struct GIFT6172 has drop {
        dummy_field: bool,
    }

    struct TICKET_6172 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6172(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6172>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6172>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6172, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6172>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6172>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6172>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6172>>(v5, 0x2::tx_context::sender(arg1));
    }
