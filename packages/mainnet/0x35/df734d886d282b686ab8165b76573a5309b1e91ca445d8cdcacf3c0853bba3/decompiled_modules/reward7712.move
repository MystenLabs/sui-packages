module 0x35df734d886d282b686ab8165b76573a5309b1e91ca445d8cdcacf3c0853bba3::reward7712 {
    struct REWARD7712 has drop {
        dummy_field: bool,
    }

    struct TICKET_7712 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7712(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7712>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7712>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7712, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7712>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7712>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7712>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7712>>(v5, 0x2::tx_context::sender(arg1));
    }
