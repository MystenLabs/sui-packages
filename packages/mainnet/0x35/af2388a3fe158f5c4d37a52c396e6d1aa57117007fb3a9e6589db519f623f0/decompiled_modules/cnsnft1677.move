module 0x35af2388a3fe158f5c4d37a52c396e6d1aa57117007fb3a9e6589db519f623f0::cnsnft1677 {
    struct CNSNFT1677 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1677, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1677>(arg0, arg1);
