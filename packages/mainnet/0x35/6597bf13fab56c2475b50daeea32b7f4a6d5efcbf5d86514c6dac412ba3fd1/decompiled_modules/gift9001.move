module 0x356597bf13fab56c2475b50daeea32b7f4a6d5efcbf5d86514c6dac412ba3fd1::gift9001 {
    struct GIFT9001 has drop {
        dummy_field: bool,
    }

    struct TICKET_9001 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9001(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9001>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9001>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9001, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9001>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9001>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9001>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9001>>(v5, 0x2::tx_context::sender(arg1));
    }
