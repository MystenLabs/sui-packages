module 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::draw_manager {
    ...
    entry fun trigger_pulse(arg0: &mut DrawState, arg1: &mut 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::RewardPool, arg2: &0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::PoolAdminCap, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &AdminCap, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        while (v3 < 4) {
            0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::award_pulse(arg1, 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::pulse_balance(arg1) / 4, *0x1::vector::borrow<address>(&arg0.pulse_tickets, 0x2::random::generate_u64_in_range(&mut v2, 0, v1 - 1)), arg2, arg6);
            v3 = v3 + 1;
        };
    ...
    entry fun trigger_spark(arg0: &mut DrawState, arg1: &mut 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::RewardPool, arg2: &0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::PoolAdminCap, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &AdminCap, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg4);
        ...
        let v3 = 0;
        while (v3 < 3) {
            0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::award_spark(arg1, 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::spark_balance(arg1) / 3, *0x1::vector::borrow<address>(&arg0.spark_tickets, 0x2::random::generate_u64_in_range(&mut v2, 0, v1 - 1)), arg2, arg6);
            v3 = v3 + 1;
        };
    ...
    entry fun trigger_surge(arg0: &mut DrawState, arg1: &mut 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::RewardPool, arg2: &0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::PoolAdminCap, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &AdminCap, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg4);
        assert!(v0 >= arg0.next_surge_ms, 1);
        let v1 = 0x1::vector::length<address>(&arg0.surge_tickets);
        assert!(v1 > 0, 2);
        let v2 = 0x2::random::new_generator(arg3, arg6);
        0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::award_surge(arg1, 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::reward_pool::surge_balance(arg1), *0x1::vector::borrow<address>(&arg0.surge_tickets, 0x2::random::generate_u64_in_range(&mut v2, 0, v1 - 1)), arg2, arg6);
