module 0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::treasury {
    struct Treasury has key {
        id: 0x2::object::UID,
        vaults: 0x2::bag::Bag,
    }

    public fun deposit<T0>(arg0: &0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::admin_cap::AdminCap, arg1: &mut Treasury, arg2: 0x2::balance::Balance<T0>) {
    ...
    public fun withdraw<T0>(arg0: &0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg1.vaults, v0)) {
            abort 20
        };
