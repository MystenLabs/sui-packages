module 0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::pool {
    ...
    public fun close_round<T0, T1>(arg0: &0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::admin_cap::AdminCap, arg1: &mut Pool<T0, T1>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
    ...
    fun create<T0, T1>(arg0: &mut 0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::round_seq::RoundSeq, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        let v0 = 0x1::type_name::get<T0>();
        Pool<T0, T1>{
            id                      : 0x2::object::new(arg6),
            market                  : v0,
            betting_currency        : 0x1::type_name::get<T1>(),
            round                   : 0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::round_seq::get_next_round(arg0, v0),
            size                    : arg1,
            closing_price           : 0,
    ...
    public fun create_pool<T0, T1>(arg0: &0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::admin_cap::AdminCap, arg1: &mut 0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::round_seq::RoundSeq, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun refund<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = arg0.size;
        claim<T0, T1>(arg0, v0, arg1);
    }

    public fun settle_round<T0, T1>(arg0: &0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::admin_cap::AdminCap, arg1: &mut Pool<T0, T1>, arg2: &mut 0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::treasury::Treasury, arg3: vector<address>) {
        if (!arg1.is_round_closed) {
            abort 8
        };
        ...
        if (arg1.total_winners == 0) {
            ...
            add_claimed(v1, &arg3);
            0x3531d47f32e80a28683536c4595e3ce0a168c342b7f7b68e0c46fbd3ead96a66::treasury::deposit<T1>(arg0, arg2, 0x2::balance::split<T1>(&mut arg1.prize_balance, arg1.revenue_amount));
        };
        arg1.is_settle_round = true;
    }

    public fun winner_claim<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
