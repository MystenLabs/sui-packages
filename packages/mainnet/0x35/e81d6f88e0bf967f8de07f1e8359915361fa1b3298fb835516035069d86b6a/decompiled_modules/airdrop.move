module 0xfee5b23269aa272aebc81d79a19ebda3b730804bec95733571203557d19873a7::airdrop {
    ...
    public(friend) fun destroy<T0>(arg0: Airdrop<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let Airdrop {
            id      : v0,
            balance : v1,
            root    : _,
