module 0x3586aed9f82dac85d95ddab4df93e5bfb179931c10b2f3348c9e952d08624504::gated_vault {
    struct GatedVaultRegistryItem has store, key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<0x3586aed9f82dac85d95ddab4df93e5bfb179931c10b2f3348c9e952d08624504::generis::GENERIS>,
        unlock_date: u64,
    }
    ...
    public(friend) fun add_to_registry(arg0: &mut GatedVaultRegistry, arg1: &0x2::clock::Clock, arg2: u64, arg3: 0x2::coin::Coin<0x3586aed9f82dac85d95ddab4df93e5bfb179931c10b2f3348c9e952d08624504::generis::GENERIS>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = GatedVaultRegistryItem{
            ...
            balance     : 0x2::coin::into_balance<0x3586aed9f82dac85d95ddab4df93e5bfb179931c10b2f3348c9e952d08624504::generis::GENERIS>(arg3),
            unlock_date : 0x3586aed9f82dac85d95ddab4df93e5bfb179931c10b2f3348c9e952d08624504::vault_constants::get_lock_duration_for_level(arg1, arg2),
        };
    ...
    public entry fun claim_unlocked_vault(arg0: &mut GatedVaultRegistry, arg1: &0x2::clock::Clock, arg2: address, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x3586aed9f82dac85d95ddab4df93e5bfb179931c10b2f3348c9e952d08624504::generis::GENERIS>>(0x2::coin::from_balance<0x3586aed9f82dac85d95ddab4df93e5bfb179931c10b2f3348c9e952d08624504::generis::GENERIS>(v2, arg4), arg2);
    }
