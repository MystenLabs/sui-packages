module 0x35bcfd6f82b3002eb650a2182a588cb3b751bed302fc02bfbfac922ef379a5b7::cnsnft9352 {
    struct CNSNFT9352 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9352, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9352>(arg0, arg1);
