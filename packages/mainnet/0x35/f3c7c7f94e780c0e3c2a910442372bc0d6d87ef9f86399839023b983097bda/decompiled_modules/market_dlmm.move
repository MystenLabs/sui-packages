module 0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::market_dlmm {
    ...
    public fun borrow_position(arg0: &DLMMMarket, arg1: 0x2::object::ID) : &DLMMPosition {
        assert!(contain_position(arg0, arg1), 13835343125146632195);
    ...
    public fun check_pool_price_deviation<T0, T1>(arg0: &DLMMMarket, arg1: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg2: &0xa518c1a6e27d8ce5798d8a5a1128cdac585cb2145e234b5a04ca9de2c60a378b::pyth_oracle::PythOracle, arg3: &0x2::clock::Clock) {
        ...
        let v4 = get_current_pool_price<T0, T1>(arg1);
        let v5 = 0x1::u64::diff(v2, v4);
        let v6 = 0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>>(arg1);
        let v7 = *0x2::vec_map::get<0x2::object::ID, u64>(&arg0.certified_pools, &v6);
        let v8 = PoolPriceDeviation{
            pool                : 0x2::object::id<0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>>(arg1),
            allow_bin_deviation : v7,
            base_price          : v0,
            quote_price         : v1,
            pool_oracle_price   : v2,
            pool_current_price  : v4,
            diff                : v5,
            derivation          : v7,
        };
        0x2::event::emit<PoolPriceDeviation>(v8);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_floor(10000, v5, v2) <= v7, 13837031777438924811);
    }
    ...
    public fun get_current_pool_price<T0, T1>(arg0: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>) : u64 {
        ...
        let v1 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::bin_step<T0, T1>(arg0);
        0x1::debug::print<u16>(&v1);
        let v2 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::price_math::get_price_from_id(v0, 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::bin_step<T0, T1>(arg0));
        0x1::debug::print<u128>(&v2);
        let v3 = 18446744073709551616;
        0x1::debug::print<u256>(&v3);
        (((v2 as u256) * (0x1::u64::pow(10, 10) as u256) / 18446744073709551616) as u64)
    }
