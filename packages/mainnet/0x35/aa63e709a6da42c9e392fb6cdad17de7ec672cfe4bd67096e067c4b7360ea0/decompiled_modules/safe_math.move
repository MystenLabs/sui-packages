module 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
