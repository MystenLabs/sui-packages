module 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::lb_position {
    ...
    public(friend) fun add_reward_debt(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u64, arg3: u64) {
        ...
        if (0x2::table::contains<u64, u64>(&v0.reward_debt, arg2)) {
            ...
            *v1 = 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::add_u64(*v1, arg3);
        } else {
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (((0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::mul_u128(v2, 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::sub_u128(arg3, v1.fee_growth_inside_last_x)) >> 64) as u64), ((0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::mul_u128(v2, 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::sub_u128(arg4, v1.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 6) {
            ...
            v3 = 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::add_u64(v0, v3);
            v1 = 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }

    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: u128, arg6: u128) {
        let v0 = borrow_mut_position_info(arg0, arg2);
        if (contains_bin(v0, arg3)) {
            let v1 = borrow_bin_mut(v0, arg3);
            v1.amount = 0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::safe_math::add_u128(v1.amount, arg4);
        ...
        0x35aa63e709a6da42c9e392fb6cdad17de7ec672cfe4bd67096e067c4b7360ea0::bin_manager::increment_total_supply(arg1, arg3, arg4);
    }
