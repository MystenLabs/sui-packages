module 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy {
    ...
    public fun accept_limits<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.proxy_id == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        ...
        assert!(0x1::option::is_some<ProxyPendingLimits>(&arg0.pending_limits), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_no_pending_limits_change());
        let v0 = 0x1::option::extract<ProxyPendingLimits>(&mut arg0.pending_limits);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 >= v0.proposed_at + arg0.limits_cooldown, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_limits_change_timelock_active());
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_limits_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun accept_manager_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x1::option::is_some<address>(&arg0.pending_manager), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_no_pending_manager_change());
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 >= arg0.pending_manager_ts + arg0.manager_change_cooldown, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_cooldown_not_elapsed());
        arg0.manager = 0x1::option::extract<address>(&mut arg0.pending_manager);
        arg0.pending_manager_ts = 0;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_manager_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg0.manager, 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun accept_processor_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x1::option::is_some<address>(&arg0.pending_processor), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_no_pending_processor_change());
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 >= arg0.pending_processor_ts + arg0.processor_change_cooldown, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_cooldown_not_elapsed());
        arg0.processor = 0x1::option::extract<address>(&mut arg0.pending_processor);
        arg0.pending_processor_ts = 0;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_processor_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg0.processor, 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun activate_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, TargetConfig>(&arg0.targets, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_not_found());
        let v0 = 0x2::table::borrow_mut<address, TargetConfig>(&mut arg0.targets, arg2);
        assert!(!v0.active, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        v0.active = true;
        v0.updated_at = 0x2::clock::timestamp_ms(arg3) / 1000;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, true, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public fun add_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: address, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert!(arg1.proxy_id == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg5) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(!0x2::table::contains<address, TargetConfig>(&arg0.targets, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_already_exists());
        0x2::table::add<address, TargetConfig>(&mut arg0.targets, arg2, new_target_config(arg3, 0x2::clock::timestamp_ms(arg4) / 1000));
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, true, 0x2::clock::timestamp_ms(arg4));
    }
    ...
    public fun create_proxy<T0>(arg0: 0x2::object::ID, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : (ProxyAdminCap, ProxyManagerCap, ProxyProcessorCap) {
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_initialized(v1, arg0, 0x2::clock::timestamp_ms(arg1));
    ...
    public fun deactivate_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, TargetConfig>(&arg0.targets, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_not_found());
        let v0 = 0x2::table::borrow_mut<address, TargetConfig>(&mut arg0.targets, arg2);
        assert!(v0.active, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_inactive());
        v0.active = false;
        v0.updated_at = 0x2::clock::timestamp_ms(arg3) / 1000;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, false, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public fun emergency_sweep<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg4) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_not_paused());
        assert!(0x2::clock::timestamp_ms(arg3) / 1000 >= arg0.paused_at + arg0.emergency_cooldown, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_cooldown_not_elapsed());
        ...
        assert!(v0 >= v1, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_balance());
    ...
    public fun force_pause<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyAdminCap, arg2: &0x2::clock::Clock) {
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_paused(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun force_unpause<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyAdminCap, arg2: &0x2::clock::Clock) {
        ...
        arg0.paused = false;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_unpaused(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun forward_funds_manager<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg5) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(!arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_paused());
        assert!(arg3 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        assert!(arg3 <= arg0.manager_max_per_tx, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_amount_exceeds_max());
        maybe_reset_daily<T0>(arg0, 0x2::clock::timestamp_ms(arg4) / 1000);
        assert!(arg0.manager_daily_used + arg3 <= arg0.manager_daily_limit, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_daily_limit_exceeded());
        assert!(0x2::table::contains<address, TargetConfig>(&arg0.targets, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_not_found());
        assert!(0x2::table::borrow<address, TargetConfig>(&arg0.targets, arg2).active, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_inactive());
        arg0.manager_daily_used = arg0.manager_daily_used + arg3;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_funds_forwarded(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, arg3, 0x2::clock::timestamp_ms(arg4));
    ...
    public fun forward_funds_processor<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyProcessorCap, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1.proxy_id == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg5) == arg0.processor, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(!arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_paused());
        assert!(arg3 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        assert!(arg3 <= arg0.processor_max_per_tx, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_amount_exceeds_max());
        let v0 = 0x2::clock::timestamp_ms(arg4) / 1000;
        maybe_reset_daily<T0>(arg0, v0);
        if (arg0.last_operation_time > 0 && arg0.processor_cooldown > 0) {
            assert!(v0 >= arg0.last_operation_time + arg0.processor_cooldown, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_cooldown_not_elapsed());
        };
        assert!(arg0.processor_daily_used + arg3 <= arg0.processor_daily_limit, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_daily_limit_exceeded());
        assert!(0x2::table::contains<address, TargetConfig>(&arg0.targets, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_not_found());
        assert!(0x2::table::borrow<address, TargetConfig>(&arg0.targets, arg2).active, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_target_inactive());
    ...
    public fun forward_to_ccam<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyProcessorCap, arg2: &mut 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg3: &0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_cross_chain_asset_manager::CcamProcessorCap, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_cross_chain_asset_manager::get_proxy_id<T0>(arg2) == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        let v0 = 0x2::object::id<0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>>(arg2);
        let v1 = forward_funds<T0>(arg0, arg1, 0x2::object::id_to_address(&v0), arg4, arg5, arg6);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_cross_chain_asset_manager::deposit<T0>(arg2, arg3, v1, arg6);
    }
    ...
    public fun pause<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(!arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_already_paused());
        arg0.paused = true;
        arg0.paused_at = 0x2::clock::timestamp_ms(arg2) / 1000;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_paused(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun propose_limits<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: &0x2::clock::Clock, arg9: &0x2::tx_context::TxContext) {
        assert!(arg1.proxy_id == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg9) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        ...
        assert!(v0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_no_limits_changes());
        ...
        assert!(v1 >= v2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_limit());
        assert!(v3 >= v4, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_limit());
        if (0x1::option::is_some<u64>(&arg6)) {
            let v5 = *0x1::option::borrow<u64>(&arg6);
            assert!(v5 >= 60 && v5 <= 604800, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_limit());
        };
        if (0x1::option::is_some<u64>(&arg7)) {
            let v6 = *0x1::option::borrow<u64>(&arg7);
            assert!(v6 >= 60 && v6 <= 604800, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_limit());
        };
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_limits_change_pending(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg8) / 1000 + arg0.limits_cooldown, 0x2::clock::timestamp_ms(arg8));
    }
    ...
    public fun propose_manager_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg4) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(arg2 != arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        arg0.pending_manager = 0x1::option::some<address>(arg2);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        arg0.pending_manager_ts = v0 / 1000;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_manager_change_pending(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, v0 / 1000 + arg0.manager_change_cooldown, v0);
    }
    ...
    public fun propose_processor_change<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_processor_change_pending(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, v0 / 1000 + arg0.processor_change_cooldown, v0);
    }
    ...
    public fun receive_funds<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyProcessorCap, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg1.proxy_id == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg4) == arg0.processor, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        0x2::balance::join<T0>(&mut arg0.underlying, 0x2::coin::into_balance<T0>(arg2));
    }
    ...
    public fun receive_funds_processor<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyProcessorCap, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.proxy_id == 0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.processor, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        0x2::balance::join<T0>(&mut arg0.underlying, 0x2::coin::into_balance<T0>(arg2));
    }
    ...
    public fun remove_target<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_target_updated(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, false, 0);
    }
    ...
    public fun return_funds_manager<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_funds_returned(0x2::object::id<ProxyAssetManager<T0>>(arg0), arg2, 0x2::clock::timestamp_ms(arg3));
    ...
    public fun unpause<T0>(arg0: &mut ProxyAssetManager<T0>, arg1: &ProxyManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_not_paused());
        assert!(!arg0.force_paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::proxy_force_paused());
        arg0.paused = false;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_proxy_unpaused(0x2::object::id<ProxyAssetManager<T0>>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
