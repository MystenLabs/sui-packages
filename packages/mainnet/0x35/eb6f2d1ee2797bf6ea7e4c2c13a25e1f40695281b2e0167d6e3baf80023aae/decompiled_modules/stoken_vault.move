module 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_vault {
    ...
    public fun accept_cooldowns<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(0x1::option::is_some<PendingCooldowns>(&arg0.pending.cooldowns), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::no_pending_cooldown_change());
        let v0 = 0x1::option::extract<PendingCooldowns>(&mut arg0.pending.cooldowns);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.cooldowns.config_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::cooldown_change_timelock_active());
    ...
    public fun accept_fees<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(0x1::option::is_some<PendingFees>(&arg0.pending.fees), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::no_pending_fees_change());
        let v0 = 0x1::option::extract<PendingFees>(&mut arg0.pending.fees);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.cooldowns.fee_change_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::fee_change_timelock_active());
    ...
    public fun accept_limits<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(0x1::option::is_some<PendingLimits>(&arg0.pending.limits), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::no_config_changes_pending());
        let v0 = 0x1::option::extract<PendingLimits>(&mut arg0.pending.limits);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.cooldowns.config_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::config_cooldown_not_expired());
    ...
    public fun accept_price<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version<T0, T1>(arg0);
        ...
        assert!(v1, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x1::option::is_some<PendingPrice>(&arg0.pending.price), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::no_pending_price());
        let v2 = 0x1::option::borrow<PendingPrice>(&arg0.pending.price);
        let v3 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::calculate_price_deviation(arg0.pricing.price, v2.price);
        let v4 = v0 == arg0.roles.manager;
        if (v3 > 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::max_manager_bypass_deviation_bps() && !v4) {
            abort 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized()
        };
        let v5 = v4 && v3 <= 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::max_manager_bypass_deviation_bps();
        let v6 = now_secs(arg2);
        assert!(v5 || v6 >= v2.proposed_at + arg0.cooldowns.price_acceptance_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::price_cooldown_not_expired());
    ...
    public fun accept_roles<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(0x1::option::is_some<PendingRoles>(&arg0.pending.roles), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::no_pending_roles_change());
        let v0 = 0x1::option::extract<PendingRoles>(&mut arg0.pending.roles);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.cooldowns.role_change_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::role_change_timelock_active());
    ...
    public fun accept_whitelist<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(0x1::option::is_some<PendingWhitelist>(&arg0.pending.whitelist), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::no_pending_whitelist_change());
        let v0 = 0x1::option::extract<PendingWhitelist>(&mut arg0.pending.whitelist);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.cooldowns.config_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::whitelist_change_timelock_active());
    ...
    public fun accept_withdrawal_params<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(0x1::option::is_some<PendingWithdrawalParams>(&arg0.pending.withdrawal_params), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::no_config_changes_pending());
    ...
    public fun accrue_management_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::clock::Clock) {
        ...
        let v2 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::calculate_management_fee(arg0.total_shares, arg0.fees.management_fee_bps_per_year, v1);
    ...
    public fun add_to_deposit_whitelist<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(arg0.deposit_whitelist_enabled, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::whitelist_mode_not_enabled());
        ...
        assert!(!v0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::governance_no_op());
    ...
    public fun add_to_withdrawal_whitelist<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert_manager<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(arg0.withdrawal_whitelist_enabled, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::whitelist_mode_not_enabled());
    ...
    public fun allowlist_mint<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: address, arg2: address, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg0);
        assert!(0x2::tx_context::sender(arg4) == arg1, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(is_mint_allowlisted<T0, T1>(arg0, arg1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(!arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::vault_paused());
        assert!(arg3 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_total_shares(arg0.total_shares, arg3, arg0.limits.max_total_shares);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_shares_per_user(get_user_shares<T0, T1>(arg0, arg2), arg3, arg0.limits.max_shares_per_user);
    ...
    fun assert_accountant<T0, T1>(arg0: &Vault<T0, T1>, arg1: &AccountantCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg2) == arg0.roles.accountant, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    }

    fun assert_admin<T0, T1>(arg0: &Vault<T0, T1>, arg1: &AdminCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg2) == arg0.roles.admin, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    }

    fun assert_asset_manager<T0, T1>(arg0: &Vault<T0, T1>, arg1: &AssetManagerCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg2) == arg0.roles.asset_manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    }

    fun assert_guardian<T0, T1>(arg0: &Vault<T0, T1>, arg1: &GuardianCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg2) == arg0.roles.guardian, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    }

    fun assert_manager<T0, T1>(arg0: &Vault<T0, T1>, arg1: &ManagerCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg2) == arg0.roles.manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    }
    ...
    fun assert_oracle<T0, T1>(arg0: &Vault<T0, T1>, arg1: &OracleCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg2) == arg0.roles.oracle, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    }
    ...
    fun assert_price_fresh<T0, T1>(arg0: &Vault<T0, T1>, arg1: u64) {
        ...
        assert!(arg1 <= arg0.pricing.last_price_update_ts + arg0.pricing.max_price_staleness_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::price_too_old());
    }

    fun assert_processor<T0, T1>(arg0: &Vault<T0, T1>, arg1: &ProcessorCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg2) == arg0.roles.processor, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    }

    fun assert_version<T0, T1>(arg0: &Vault<T0, T1>) {
        assert!(arg0.version == 3, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::wrong_version());
    }

    public fun attach_proxy_asset_manager<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &AdminCap, arg2: &0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyAssetManager<T0>, arg3: &0x2::tx_context::TxContext) {
        assert_admin<T0, T1>(arg0, arg1, arg3);
        assert_version<T0, T1>(arg0);
        assert!(0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::get_vault_id<T0>(arg2) == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        let v0 = 0x2::object::id<0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyAssetManager<T0>>(arg2);
    ...
    public fun attach_treasury<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &AdminCap, arg2: 0x2::coin::TreasuryCap<T1>, arg3: &0x2::tx_context::TxContext) {
        abort 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::treasury_already_attached()
    }
    ...
    public fun cancel_withdrawal_after_ttl<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ProcessorCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<u64, WithdrawalRequest>(&arg0.withdrawal_requests, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::withdrawal_request_not_found());
        let v0 = now_secs(arg3);
        let v1 = 0x2::table::borrow<u64, WithdrawalRequest>(&arg0.withdrawal_requests, arg2);
        assert!(is_withdrawal_pending(v1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        let v2 = v1.shares;
        let v3 = v1.fee_shares;
        let v4 = v1.amount_due;
        let v5 = v1.user;
        assert!(v0 >= v1.created_at + arg0.wparams.withdrawal_ttl_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_timestamp());
        let v6 = v2 + v3;
        let v7 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::apply_basis_points(v2, arg0.wparams.system_penalty_bps);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_total_shares(arg0.total_shares, v7, arg0.limits.max_total_shares);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_shares_per_user(get_user_shares<T0, T1>(arg0, v5), v6 + v7, arg0.limits.max_shares_per_user);
        ...
        assert!(arg0.total_withdrawals_pending >= v4, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::math_overflow());
    ...
    public fun cancel_withdrawal_user<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg0);
        assert_not_paused<T0, T1>(arg0);
        assert!(0x2::table::contains<u64, WithdrawalRequest>(&arg0.withdrawal_requests, arg1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::withdrawal_request_not_found());
        ...
        let v4 = v1.amount_due;
        let v5 = v1.user;
        assert!(0x2::tx_context::sender(arg3) == v5, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        let v6 = 0;
        let v7 = 0;
        let v8 = if (!(v0 >= v1.created_at + arg0.wparams.withdrawal_ttl_secs)) {
            ...
            let v9 = v2 + v3;
            let v10 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::apply_basis_points(v2, arg0.wparams.system_penalty_bps);
            v7 = v10;
            0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_total_shares(arg0.total_shares, v10, arg0.limits.max_total_shares);
            0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_shares_per_user(get_user_shares<T0, T1>(arg0, v5), v9 + v10, arg0.limits.max_shares_per_user);
            v9
        };
    ...
    public fun create_vault<T0, T1>(arg0: &mut 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_factory::FactoryRegistry, arg1: &0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_factory::FactoryAdminCap, arg2: 0x2::coin::TreasuryCap<T1>, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: address, arg11: address, arg12: address, arg13: address, arg14: address, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_factory::assert_registry_matches_cap(arg0, arg1);
        create_vault_impl<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16);
    }

    fun create_vault_impl<T0, T1>(arg0: &mut 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_factory::FactoryRegistry, arg1: &0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_factory::FactoryAdminCap, arg2: 0x2::coin::TreasuryCap<T1>, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: address, arg10: address, arg11: address, arg12: address, arg13: address, arg14: address, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::validate_fees(arg5, arg6, arg7);
        assert!(arg8 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_price());
        assert!(arg4 != 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(arg4 >= arg3, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        let v0 = now_secs(arg15);
        let v1 = VaultPricing{
            price                    : arg8,
            last_price_update_ts     : 0,
            max_price_staleness_secs : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::default_max_price_staleness_secs(),
            max_deviation_bps        : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::default_max_deviation_bps(),
        };
        let v2 = VaultFees{
            deposit_fee_bps             : arg5,
            withdraw_fee_bps            : arg6,
            management_fee_bps_per_year : arg7,
            swap_fee_bps                : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::default_swap_fee_bps(),
            last_mgmt_fee_ts            : v0,
        };
        let v3 = VaultLimits{
            max_total_shares    : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::no_limit(),
            max_shares_per_user : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::no_limit(),
            max_total_idle      : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::no_limit(),
            min_shares_to_mint  : 0,
        };
        let v4 = VaultWithdrawalParams{
            downside_cap_bps    : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::default_downside_cap_bps(),
            withdrawal_ttl_secs : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::min_withdrawal_ttl_secs(),
            system_penalty_bps  : 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::default_system_penalty_bps(),
        };
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_factory::register_vault(arg0, arg1, v10, arg15);
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.deposit_whitelist_enabled) {
            assert!(is_whitelisted(&arg0.deposit_whitelist, v0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::user_not_whitelisted());
        };
    ...
    public fun deposit_for<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.deposit_whitelist_enabled) {
            assert!(is_whitelisted(&arg0.deposit_whitelist, 0x2::tx_context::sender(arg5)), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::user_not_whitelisted());
        };
    ...
    fun deposit_inner<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        let v1 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::amount_to_shares(v0, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        let v2 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::apply_basis_points(v1, arg0.fees.deposit_fee_bps);
        let v3 = v1 - v2;
        assert!(v3 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::zero_shares_calculated());
        if (arg3 > 0) {
            assert!(v3 >= arg3, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::slippage_not_met());
        };
        let v4 = get_user_shares<T0, T1>(arg0, arg2);
        if (arg0.limits.min_shares_to_mint > 0) {
            let v5 = v4 + v3;
            if (v5 > 0 && v5 < arg0.limits.min_shares_to_mint) {
                abort 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::minimum_shares_not_met()
            };
        };
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_shares_per_user(v4, v3, arg0.limits.max_shares_per_user);
        let v6 = v3 + v2;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_total_shares(arg0.total_shares, v6, arg0.limits.max_total_shares);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_total_idle(arg0.total_idle, v0, arg0.limits.max_total_idle);
    ...
    public fun execute_emergency_withdrawal<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::vault_not_paused());
        assert!(arg0.emergency.emergency_withdrawal_amount > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        assert!(now_secs(arg3) >= arg0.emergency.emergency_timelock_end, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::emergency_withdrawal_timelock_active());
        let v0 = arg0.emergency.emergency_withdrawal_amount;
        assert!(0x2::balance::value<T0>(&arg0.underlying) >= v0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_vault_funds());
    ...
    public fun fulfill_withdrawal<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ProcessorCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_withdrawal_pending(v0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        let v1 = v0.shares;
        ...
        let v6 = v0.user;
        let v7 = v0.receiver;
        let v8 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::shares_to_amount(v1, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        let v9 = if (v8 < v4) {
            v4
        ...
        assert!(0x2::balance::value<T0>(&arg0.underlying) >= v9, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_vault_funds());
        assert!(v9 <= arg0.total_idle, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_vault_funds());
        ...
        assert!(arg0.total_withdrawals_pending >= v3, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::math_overflow());
    ...
    public fun initiate_emergency_withdrawal<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::vault_not_paused());
        assert!(arg2 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        assert!(0x2::balance::value<T0>(&arg0.underlying) >= arg2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_vault_funds());
    ...
    public fun migrate<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &AdminCap, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.version < 3, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::not_upgrade());
        arg0.version = 3;
    }
    ...
    public fun pause_vault<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: &GuardianCap, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(arg2.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version<T0, T1>(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == arg0.roles.manager || v0 == arg0.roles.guardian, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(!arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::vault_paused());
        arg0.paused = true;
    ...
    public fun process_deposits<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ProcessorCap, arg2: &mut 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyAssetManager<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_processor<T0, T1>(arg0, arg1, arg5);
        assert_version<T0, T1>(arg0);
        assert_not_paused<T0, T1>(arg0);
        assert!(0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::get_vault_id<T0>(arg2) == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        let v0 = 0x2::object::id<0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyAssetManager<T0>>(arg2);
        assert!(0x2::object::id_to_address(&v0) == arg0.roles.asset_manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(arg3 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        assert!(arg3 <= arg0.total_idle, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_vault_funds());
        arg0.total_idle = arg0.total_idle - arg3;
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::accept_underlying<T0>(arg2, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.underlying, arg3), arg5));
    ...
    public fun propose_cooldowns<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &0x2::tx_context::TxContext) {
        ...
        assert!(v0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::cooldown_change_timelock_active());
        let v1 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::min_cooldown_secs();
        let v2 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::max_cooldown_secs();
        assert!(arg2 >= v1 && arg2 <= v2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(arg3 >= v1 && arg3 <= v2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(arg4 >= v1 && arg4 <= v2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(arg5 >= v1 && arg5 <= v2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(arg6 >= v1 && arg6 <= v2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(arg7 >= v1 && arg7 <= v2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        ...
        assert!(v3, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::governance_no_op());
    ...
    public fun propose_fees<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::validate_fees(arg2, arg3, arg4);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::validate_swap_fee(arg5);
    ...
    public fun propose_limits<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::validate_new_limits(arg2, arg3, arg4, arg6);
        assert!(arg5 <= 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::max_allowed_deviation_bps(), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
    ...
    public fun propose_whitelist<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: bool, arg3: bool, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg2 != arg0.deposit_whitelist_enabled || arg3 != arg0.withdrawal_whitelist_enabled, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::governance_no_op());
    ...
    public fun propose_withdrawal_params<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg3 >= 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::min_withdrawal_ttl_secs() && arg3 <= 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::max_withdrawal_ttl_secs(), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        ...
        assert!(arg4 <= 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::bps_precision(), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
    ...
    public fun remove_from_deposit_whitelist<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg0.deposit_whitelist_enabled, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::whitelist_mode_not_enabled());
        assert!(0x2::table::contains<address, bool>(&arg0.deposit_whitelist, arg2) && *0x2::table::borrow<address, bool>(&arg0.deposit_whitelist, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::user_not_whitelisted());
    ...
    public fun remove_from_withdrawal_whitelist<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg0.withdrawal_whitelist_enabled, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::whitelist_mode_not_enabled());
        assert!(0x2::table::contains<address, bool>(&arg0.withdrawal_whitelist, arg2) && *0x2::table::borrow<address, bool>(&arg0.withdrawal_whitelist, arg2), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::user_not_whitelisted());
    ...
    public fun return_funds<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &AssetManagerCap, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        arg0.total_idle = arg0.total_idle + v0;
        assert!(0x2::balance::value<T0>(&arg0.underlying) >= arg0.total_idle, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_vault_funds());
    ...
    public fun return_funds_from_proxy<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyAssetManager<T0>, arg2: &0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyProcessorCap, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg0);
        assert!(0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::get_processor_cap_proxy_id(arg2) == 0x2::object::id<0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyAssetManager<T0>>(arg1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::get_vault_id<T0>(arg1) == 0x2::object::id<Vault<T0, T1>>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        let v0 = 0x2::object::id<0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::ProxyAssetManager<T0>>(arg1);
        assert!(0x2::object::id_to_address(&v0) == arg0.roles.asset_manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg5) == 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_proxy::get_processor<T0>(arg1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
    ...
    fun sub_user_shares<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: address, arg2: u64) {
        assert!(0x2::table::contains<address, u64>(&arg0.share_balances, arg1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_shares());
        let v0 = 0x2::table::borrow_mut<address, u64>(&mut arg0.share_balances, arg1);
        assert!(*v0 >= arg2, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_shares());
        *v0 = *v0 - arg2;
    }
    ...
    public fun swap_tokens<T0, T1, T2>(arg0: &mut Vault<T0, T1>, arg1: &mut Vault<T0, T2>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<Vault<T0, T1>>(arg0) != 0x2::object::id<Vault<T0, T2>>(arg1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_swap_same_vault());
        assert!(arg0.roles.asset_manager == arg1.roles.asset_manager, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::asset_manager_mismatch());
        assert_version<T0, T1>(arg0);
        assert_version<T0, T2>(arg1);
        assert!(arg0.share_decimals == arg1.share_decimals, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert_not_paused<T0, T1>(arg0);
        ...
        assert!(is_mint_allowlisted<T0, T1>(arg0, 0x2::object::id_to_address(&v2)), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::destination_not_allowlisted());
        if (arg0.withdrawal_whitelist_enabled) {
            assert!(is_whitelisted(&arg0.withdrawal_whitelist, v0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::user_not_whitelisted());
        };
        if (arg1.deposit_whitelist_enabled) {
            assert!(is_whitelisted(&arg1.deposit_whitelist, v0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::user_not_whitelisted());
        };
        ...
        if (arg0.limits.min_shares_to_mint > 0 && v3 > 0) {
            assert!(v3 >= arg0.limits.min_shares_to_mint, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::minimum_shares_not_met());
        };
        let v4 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::shares_to_amount(arg2, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        let v5 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::apply_basis_points(v4, arg0.fees.swap_fee_bps);
        let v6 = v5 / 2;
        let v7 = v5 - v6;
        let v8 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::amount_to_shares(v4 - v5, arg1.pricing.price, arg1.underlying_decimals, arg1.share_decimals);
        assert!(v8 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::zero_shares_calculated());
        assert!(v8 >= arg3, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::slippage_not_met());
        let v9 = if (v7 > 0) {
            0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::amount_to_shares(v7, arg1.pricing.price, arg1.underlying_decimals, arg1.share_decimals)
        } else {
            0
        };
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_total_shares(arg1.total_shares, v8 + v9, arg1.limits.max_total_shares);
        let v10 = get_user_shares<T0, T2>(arg1, v0);
        let v11 = v10 + v8;
        if (arg1.limits.min_shares_to_mint > 0 && v11 > 0) {
            assert!(v11 >= arg1.limits.min_shares_to_mint, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::minimum_shares_not_met());
        };
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::check_max_shares_per_user(v10, v8, arg1.limits.max_shares_per_user);
        add_user_shares<T0, T2>(arg1, v0, v8);
        arg1.total_shares = arg1.total_shares + v8;
        if (v6 > 0) {
            let v12 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::amount_to_shares(v6, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
            if (v12 > 0) {
    ...
    public fun transfer_admin<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &AdminCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0, T1>(arg0);
        assert!(arg2 != @0x0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(arg2 != arg0.roles.admin, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::governance_no_op());
    ...
    public fun update_price<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &OracleCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        let v0 = now_secs(arg3);
        assert!(v0 >= arg0.pricing.last_price_update_ts + arg0.cooldowns.price_update_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::price_update_too_frequent());
        ...
        if (0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::calculate_price_deviation(arg0.pricing.price, arg2) <= arg0.pricing.max_deviation_bps) {
            arg0.pricing.price = arg2;
            arg0.pricing.last_price_update_ts = v0;
            arg0.pending.price = 0x1::option::none<PendingPrice>();
    ...
    public fun update_withdrawal_minimum<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_withdrawal_pending(v0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(v0.user == 0x2::tx_context::sender(arg4), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(arg2 <= v0.min_amount_out, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
    ...
    public fun withdraw_request<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        abort 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::treasury_attached_use_coin_withdraw()
    }
    ...
    fun withdraw_request_inner<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.withdrawal_whitelist_enabled) {
            assert!(is_whitelisted(&arg0.withdrawal_whitelist, v1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::user_not_whitelisted());
        };
        assert!(arg1 > 0, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_amount());
        let v2 = get_user_shares<T0, T1>(arg0, v1) - arg1;
        if (arg0.limits.min_shares_to_mint > 0 && v2 > 0) {
            assert!(arg1 >= arg0.limits.min_shares_to_mint, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::withdrawal_amount_too_low());
            assert!(v2 >= arg0.limits.min_shares_to_mint, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::minimum_shares_not_met());
        };
        let (v3, v4) = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::apply_fee(arg1, arg0.fees.withdraw_fee_bps);
        let v5 = 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::shares_to_amount(v3, arg0.pricing.price, arg0.underlying_decimals, arg0.share_decimals);
        assert!(arg2 <= v5, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        if (arg2 > 0) {
            assert!(arg2 <= 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::mul_div(v5, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::bps_precision() - arg0.wparams.downside_cap_bps, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_math::bps_precision()), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        };
    ...
    public fun withdraw_unexpected_deposits<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &ManagerCap, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 <= v1, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::insufficient_vault_funds());
    ...
    public fun write_vault_total_shares<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: address, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg1, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert!(is_mint_allowlisted<T0, T1>(arg0, arg1), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::invalid_argument());
        assert!(!arg0.paused, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::vault_paused());
