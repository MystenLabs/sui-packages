module 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_factory {
    ...
    public fun accept_version(arg0: &mut FactoryRegistry, arg1: &FactoryAdminCap, arg2: &0x2::clock::Clock) {
        assert!(arg1.factory_id == 0x2::object::id<FactoryRegistry>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version(arg0);
        assert!(0x1::option::is_some<PendingVersion>(&arg0.pending_version), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::factory_no_pending_version_change());
        let v0 = 0x1::option::extract<PendingVersion>(&mut arg0.pending_version);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 >= v0.timestamp + arg0.version_change_cooldown_secs, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::factory_version_change_timelock_active());
    ...
    public fun propose_version(arg0: &mut FactoryRegistry, arg1: &FactoryAdminCap, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg1.factory_id == 0x2::object::id<FactoryRegistry>(arg0), 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::unauthorized());
        assert_version(arg0);
        assert!(arg2 != arg0.current_version, 0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_errors::factory_version_unchanged());
    ...
    public fun register_vault(arg0: &mut FactoryRegistry, arg1: &FactoryAdminCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) {
        ...
        0x9ac684bb54bf68ce2d52f80a35c18f6b19030a47fbe448c3be632b958db63c4d::stoken_events::emit_factory_vault_created(0x2::object::id<FactoryRegistry>(arg0), arg2, arg0.vault_count, 0x2::clock::timestamp_ms(arg3));
    }
