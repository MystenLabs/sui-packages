module 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::finance {
    ...
    public entry fun new_topup_sui(arg0: &FinanceCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = SUIPool{
            id       : 0x2::object::new(arg2),
            sequence : 0,
            receipt  : arg1,
        ...
        0x2::transfer::public_share_object<SUIPool>(v0);
    }
