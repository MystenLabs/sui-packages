module 0x35d0bf8d2af4a199bf5119e69b58b05dbc804af4474828fe3eb913a251e62a2f::reward4630 {
    struct REWARD4630 has drop {
        dummy_field: bool,
    }

    struct TICKET_4630 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4630(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4630>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4630>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4630, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4630>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4630>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4630>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4630>>(v5, 0x2::tx_context::sender(arg1));
    }
