module 0x352a721cca9018789f01f64767b6e6fb36ec9bad8d0a7e011d4ea4cf4590878b::cnsnft9650 {
    struct CNSNFT9650 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9650, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9650>(arg0, arg1);
