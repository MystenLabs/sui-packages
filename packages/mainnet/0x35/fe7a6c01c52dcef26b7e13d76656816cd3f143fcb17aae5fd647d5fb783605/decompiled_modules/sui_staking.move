module 0x35fe7a6c01c52dcef26b7e13d76656816cd3f143fcb17aae5fd647d5fb783605::sui_staking {
    ...
    fun assert_owner(arg0: &Admin, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg0.owner || v0 == arg0.pool, 101);
    }
    ...
    public entry fun claim_reward(arg0: &Admin, arg1: &mut FarmingPool, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        send_reward(arg0.pool, v2, v5, arg3);
    ...
    fun update_reward(arg0: &mut FarmingPool, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (u128, u128) {
        ...
        (v1, 0x35fe7a6c01c52dcef26b7e13d76656816cd3f143fcb17aae5fd647d5fb783605::math::mul_div_u128(v1, (arg0.multiplier as u128), 10000))
    }

    public entry fun withdraw_reward(arg0: &Admin, arg1: &mut FarmingPool, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg0, arg3);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = &mut arg1.reward_amount;
        send_reward(v0, arg2, v1, arg3);
    }

    public entry fun withdraw_stake(arg0: &Admin, arg1: &mut FarmingPool, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) {
        assert_owner(arg0, arg3);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = &mut arg1.stake_amount;
        send_reward(v0, arg2, v1, arg3);
    }
