module 0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::duck_nft {
    ...
    fun get_rarity_image_url(arg0: u8) : 0x1::string::String {
        if (arg0 == 3) {
            0x1::string::utf8(b"https://img.duckdynasty.io/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/Golden.png")
        } else if (arg0 == 2) {
            0x1::string::utf8(b"https://img.duckdynasty.io/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/King.png")
        } else if (arg0 == 1) {
            0x1::string::utf8(b"https://img.duckdynasty.io/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/Queen.png")
        } else {
            0x1::string::utf8(b"https://img.duckdynasty.io/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/Common.png")
        }
    }
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::burn(arg8, 0x2::coin::split<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>>(0x2::coin::split<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>>(0x2::coin::split<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0x357837afaa2c4eb84122c2ed88b1d51581bfaa3e9707989e91f3134b14746cef::shttoken::SHTTOKEN>(arg12);
        };
