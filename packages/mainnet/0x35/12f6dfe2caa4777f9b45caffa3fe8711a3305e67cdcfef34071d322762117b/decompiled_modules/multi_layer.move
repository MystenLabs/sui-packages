        ...
        while (v10 < v1) {
            ...
            if (!v2) {
                if (v15) {
                    ...
                    let v28 = if (v10 == 0) {
                        let v29 = v27.price != v21;
                        let v30 = !v29 && should_refresh_order(v27.expire_timestamp, v0);
                        let v31 = v24 && v22 <= v27.price;
                        if (v29) {
                            true
                        } else if (v30) {
                            true
                        ...
                        should_requote_price(v27.price, v21, v14) || should_refresh_order(v27.expire_timestamp, v0)
                    };
                    if (v28) {
                ...
                if (v15) {
                    ...
                    let v32 = 0x1::option::borrow<LayerOrderInfo>(&v26);
                    let v33 = if (v10 == 0) {
                        let v34 = v32.price != v22;
                        let v35 = !v34 && should_refresh_order(v32.expire_timestamp, v0);
                        let v36 = v23 && v21 >= v32.price;
                        if (v34) {
                            true
                        } else if (v35) {
                            true
                        ...
                        should_requote_price(v32.price, v22, v14) || should_refresh_order(v32.expire_timestamp, v0)
                    };
                    if (v33) {
                        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::cancel_order<T0, T1>(arg3, arg2, arg19, v32.order_id, arg5, arg25);
                        if (v24) {
