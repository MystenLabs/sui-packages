module 0x3568c607fde4aea5186828bce9dbe3a461dc34a6f96bcbb121217d0807cfb849::drop400 {
    struct DROP400 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DROP400, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DROP400>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"drop400"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"dklsjkal kjasdkladjl"));
