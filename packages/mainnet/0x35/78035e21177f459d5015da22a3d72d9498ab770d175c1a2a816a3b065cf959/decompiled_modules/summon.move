module 0x3578035e21177f459d5015da22a3d72d9498ab770d175c1a2a816a3b065cf959::summon {
    ...
    struct TokenRegistry has key {
        ...
        admin: address,
        treasury: 0x2::coin::TreasuryCap<SUMMON>,
    }
    ...
    public entry fun buy_tokens(arg0: &mut TokenRegistry, arg1: &mut BondingCurve, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u256, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg6: &0x2::clock::Clock, arg7: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg8: &0x2::coin::CoinMetadata<SUMMON>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SUMMON>>(0x2::coin::mint<SUMMON>(&mut arg0.treasury, v0, arg9), 0x2::tx_context::sender(arg9));
    ...
    fun init(arg0: SUMMON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUMMON>(arg0, 9, b"SUMMON", b"Summon Token", b"Universal token for all meme launches on Summon", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://scarlet-visual-gopher-984.mypinata.cloud/ipfs/QmT5PjXAzqLSgfdoRTnXjFTqW3YSr9wAu6jtt45MTDzPYS/1.jpeg")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<SUMMON>>(v1);
    ...
    public fun init_cetus_pool(arg0: address, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<SUMMON>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::coin::CoinMetadata<SUMMON>, arg7: address, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : bool {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= 1000000000, 11);
        assert!(0x2::coin::value<SUMMON>(&arg2) >= 40000000000000, 11);
        let (v0, v1, v2) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<SUMMON, 0x2::sui::SUI>(arg4, arg3, 200, 92233720368547760, 0x1::string::utf8(b""), 4294523696, 443600, 0x2::coin::split<SUMMON>(&mut arg2, 40000000000000, arg9), 0x2::coin::split<0x2::sui::SUI>(&mut arg1, 1000000000, arg9), arg6, arg5, true, arg8, arg9);
        let v3 = v2;
        let v4 = v1;
        ...
        if (0x2::coin::value<SUMMON>(&v4) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<SUMMON>>(v4, arg0);
        } else {
            0x2::coin::destroy_zero<SUMMON>(v4);
        };
        ...
        if (0x2::coin::value<SUMMON>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<SUMMON>>(arg2, arg0);
        } else {
            0x2::coin::destroy_zero<SUMMON>(arg2);
        };
    ...
    public entry fun sell_tokens(arg0: &mut TokenRegistry, arg1: &mut BondingCurve, arg2: &mut 0x2::coin::Coin<SUMMON>, arg3: u256, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg6: &0x2::clock::Clock, arg7: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg8: &0x2::coin::CoinMetadata<SUMMON>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = (arg3 as u64);
        assert!(0x2::coin::value<SUMMON>(arg2) >= v0, 7);
        let v1 = calculate_sell_price(arg1.total_minted, arg3);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1.sui_treasury) >= v1, 3);
        0x2::coin::burn<SUMMON>(&mut arg0.treasury, 0x2::coin::split<SUMMON>(arg2, v0, arg9));
        arg1.total_minted = arg1.total_minted - arg3;
    ...
    fun try_create_pool(arg0: &mut TokenRegistry, arg1: &mut BondingCurve, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::clock::Clock, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::coin::CoinMetadata<SUMMON>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::coin::mint<SUMMON>(&mut arg0.treasury, 40000000000000, arg7);
