module 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::composable_nft {
    ...
    public fun compose<T0, T1: store + key>(arg0: &Composition<T0>, arg1: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::NftBag, arg2: T1) {
        assert_insertable<T0, T1>(arg0, compose_<T1>(arg1, arg2));
    }

    fun compose_<T0: store + key>(arg0: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::NftBag, arg1: T0) : u64 {
        let v0 = Key<T0>{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<T0, Key<T0>>(v0, arg0, arg1);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::count<Key<T0>>(arg0)
    }

    public fun compose_into_nft<T0, T1: store + key>(arg0: &Composition<T0>, arg1: &mut 0x2::object::UID, arg2: T1) {
        let v0 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::borrow_domain_mut(arg1);
        compose<T0, T1>(arg0, v0, arg2);
    }

    public fun compose_with_collection_schema<T0, T1, T2: store + key>(arg0: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<T0>, arg1: &mut 0x2::object::UID, arg2: T2) {
        let v0 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::borrow_domain_mut(arg1);
        compose<T1, T2>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::borrow_domain<T0, Composition<T1>>(arg0), v0, arg2);
    }

    public fun compose_with_nft_schema<T0, T1: store + key>(arg0: &mut 0x2::object::UID, arg1: T1) {
        let v0 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::borrow_domain_mut(arg0);
        assert_insertable<T0, T1>(borrow_domain<T0>(arg0), compose_<T1>(v0, arg1));
    }

    public fun decompose<T0, T1: store + key>(arg0: &Composition<T0>, arg1: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::NftBag, arg2: 0x2::object::ID) : T1 {
        let v0 = 0x1::type_name::get<T1>();
        assert_composable<T0>(arg0, &v0);
        decompose_<T1>(arg1, arg2)
    }

    fun decompose_<T0: store + key>(arg0: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::NftBag, arg1: 0x2::object::ID) : T0 {
        let v0 = Key<T0>{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::decompose<T0, Key<T0>>(v0, arg0, arg1)
    }
    ...
    public fun decompose_with_collection_schema<T0, T1, T2: store + key>(arg0: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<T0>, arg1: &mut 0x2::object::UID, arg2: 0x2::object::ID) : T2 {
        let v0 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::borrow_domain_mut(arg1);
        decompose<T1, T2>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::borrow_domain<T0, Composition<T1>>(arg0), v0, arg2)
    }
    ...
    public fun decompose_with_nft_schema<T0, T1: store + key>(arg0: &mut 0x2::object::UID, arg1: 0x2::object::ID) : T1 {
        ...
        let v1 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::borrow_domain_mut(arg0);
