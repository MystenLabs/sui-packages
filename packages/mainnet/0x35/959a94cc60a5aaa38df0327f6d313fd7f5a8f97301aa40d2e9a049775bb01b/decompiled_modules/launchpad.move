module 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::launchpad {
    ...
    public fun buy_with_return<T0, T1>(arg0: &Protocol, arg1: &mut Pool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>) {
        ...
        let (v4, v5, v6) = if (arg5) {
            assert!(v1 >= arg3, 8);
            let v7 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(arg3, v2, 1000000);
            let v8 = arg3 - v7;
            let v9 = 0x1::u64::min(v8, 0x1::u64::min(arg1.fair_launch_quote_amount - 0x2::balance::value<T1>(&arg1.real_quote_reserves), 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_liquidity_cost(v3, arg1.virtual_quote_reserves, arg1.virtual_token_reserves)));
            let v10 = 0x1::u64::min(0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_token_return(v9, arg1.virtual_quote_reserves, arg1.virtual_token_reserves), v3);
            let v11 = if (v9 == v8) {
                v7
            } else {
                0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v9, 1000000, 1000000 - v2) - v9
            };
            assert!(v10 >= arg4, 6);
            (v11, v9, v10)
        } else {
            assert!(arg3 <= v3, 9);
            let v12 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_liquidity_cost(arg3, arg1.virtual_quote_reserves, arg1.virtual_token_reserves);
            assert!(v12 <= arg1.fair_launch_quote_amount - 0x2::balance::value<T1>(&arg1.real_quote_reserves), 7);
            let v13 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v12, 1000000, 1000000 - v2) - v12;
    ...
    public fun complete_pool_by_admin<T0, T1>(arg0: &AdminCap, arg1: &Protocol, arg2: &mut Pool<T0, T1>) {
        assert!(arg1.version == 2, 0);
        assert_pool<T0, T1>(arg1, arg2);
        assert!(!arg2.is_completed, 11);
        complete_pool<T0, T1>(arg2);
    }

    public fun constants() : (u8, u64, u64, u64, u64, u64, u8, u8, u8, u8, u64, u64, u64, u64, u64) {
        (6, 1000000000000000, 800000000000000, 200000000000000, 1066666666666667, 0, 0, 1, 2, 3, 250000, 500000, 1000000, 400, 2)
    }
    ...
    public fun create<T0, T1>(arg0: &mut Protocol, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut 0x2::coin_registry::Currency<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: u8, arg6: u8, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: u8, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = usd_raise_target_cents_for_mode(arg6);
        let v9 = &mut arg3;
        let v10 = charge_exact_or_refund<0x2::sui::SUI>(v9, arg0.launch_fee_sui, arg16);
    ...
    fun derive_quote_parameters(arg0: u64, arg1: u8) : (u64, u64) {
        assert!(arg0 > 0, 14);
        let v0 = (((arg0 as u128) * (usd_raise_target_cents_for_mode(arg1) as u128) + 99) / 100 + 2) / 3 * 3;
    ...
    public fun pool_launch_config<T0, T1>(arg0: &Pool<T0, T1>) : (u8, u64, u64) {
        (arg0.bond_mode, arg0.usd_raise_target_cents, arg0.config_version)
    }
    ...
    public fun quote_buy_exact_in<T0, T1>(arg0: &Protocol, arg1: &Pool<T0, T1>, arg2: u64) : (u64, u64, u64) {
        ...
        assert!(!arg1.is_completed, 11);
        assert!(arg2 > 0, 2);
        let v0 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(arg2, 10000, 1000000);
        let v1 = arg2 - v0;
        let v2 = 0x2::balance::value<T0>(&arg1.real_token_reserves);
        let v3 = 0x1::u64::min(v1, 0x1::u64::min(arg1.fair_launch_quote_amount - 0x2::balance::value<T1>(&arg1.real_quote_reserves), 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_liquidity_cost(v2, arg1.virtual_quote_reserves, arg1.virtual_token_reserves)));
        assert!(v3 > 0, 2);
        let v4 = 0x1::u64::min(0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_token_return(v3, arg1.virtual_quote_reserves, arg1.virtual_token_reserves), v2);
        assert!(v4 > 0, 2);
        let v5 = if (v3 == v1) {
            v0
        } else {
            0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v3, 1000000, 1000000 - 10000) - v3
        };
        (v4, v3, v5)
    }
    ...
    public fun quote_buy_exact_out<T0, T1>(arg0: &Protocol, arg1: &Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        let v0 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_liquidity_cost(arg2, arg1.virtual_quote_reserves, arg1.virtual_token_reserves);
        assert!(v0 > 0, 2);
        assert!(v0 <= arg1.fair_launch_quote_amount - 0x2::balance::value<T1>(&arg1.real_quote_reserves), 7);
        let v1 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v0, 1000000, 1000000 - 10000);
        (v1, v1 - v0)
    }
    ...
    public fun quote_sell_exact_in<T0, T1>(arg0: &Protocol, arg1: &Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        assert!(!arg1.is_completed, 11);
        assert!(arg2 > 0, 2);
        let v0 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_quote_return(arg2, arg1.virtual_quote_reserves, arg1.virtual_token_reserves);
        let v1 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v0, 10000, 1000000);
        assert!(v0 > v1, 2);
    ...
    public fun quote_sell_exact_out<T0, T1>(arg0: &Protocol, arg1: &Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        assert!(!arg1.is_completed, 11);
        assert!(arg2 > 0, 2);
        let v0 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(arg2, 1000000, 1000000 - 10000);
        assert!(v0 < arg1.virtual_quote_reserves, 10);
        assert!(v0 <= 0x2::balance::value<T1>(&arg1.real_quote_reserves), 10);
        (0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v0, arg1.virtual_token_reserves, arg1.virtual_quote_reserves - v0), v0 - arg2)
    }
    ...
    public fun sell_with_return<T0, T1>(arg0: &Protocol, arg1: &mut Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>) {
        ...
        let (v1, v2, v3) = if (arg5) {
            let v4 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::curves::calculate_quote_return(arg3, arg1.virtual_quote_reserves, arg1.virtual_token_reserves);
            let v5 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v4, 10000, 1000000);
            assert!(v4 - v5 >= arg4, 6);
            (v5, v4, arg3)
        } else {
            let v6 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(arg3, 1000000, 1000000 - 10000);
            assert!(v6 < arg1.virtual_quote_reserves, 10);
            let v7 = 0x35959a94cc60a5aaa38df0327f6d313fd7f5a8f97301aa40d2e9a049775bb01b::full_math_u64::mul_div_ceil(v6, arg1.virtual_token_reserves, arg1.virtual_quote_reserves - v6);
            assert!(v7 <= arg4, 7);
            (v6 - arg3, v6, v7)
        };
        assert!(v3 > 0 && v2 > v1, 2);
    ...
    fun usd_raise_target_cents_for_mode(arg0: u8) : u64 {
        if (arg0 == 0) {
            250000
        } else if (arg0 == 1) {
            500000
