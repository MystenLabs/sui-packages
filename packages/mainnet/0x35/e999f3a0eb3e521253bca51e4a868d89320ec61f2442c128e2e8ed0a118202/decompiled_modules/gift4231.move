module 0x35e999f3a0eb3e521253bca51e4a868d89320ec61f2442c128e2e8ed0a118202::gift4231 {
    struct GIFT4231 has drop {
        dummy_field: bool,
    }

    struct TICKET_4231 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4231(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4231>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4231>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4231, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4231>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4231>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4231>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4231>>(v5, 0x2::tx_context::sender(arg1));
    }
