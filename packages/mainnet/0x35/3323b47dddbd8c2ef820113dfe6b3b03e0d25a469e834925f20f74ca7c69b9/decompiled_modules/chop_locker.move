module 0x353323b47dddbd8c2ef820113dfe6b3b03e0d25a469e834925f20f74ca7c69b9::chop_locker {
    ...
    public fun calculate_apy2<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::balance::Balance<T0>, arg3: u64, arg4: u64, arg5: u64) : u64 {
        assert!(arg3 > 0, 3);
        assert!(arg5 > 0, 4);
        assert!(0x2::balance::value<T0>(arg2) > 0, 2);
        if (arg1 == 0) {
            let v1 = 0x2::balance::value<T0>(arg2) / arg3 / arg3 * (100 * arg4 / 90 + 50) * 1000 / 1000000000 * 365 * 100 / arg5;
            if (v1 > 50000000) {
                50000000
            } else {
                v1
            ...
            let v2 = (0x2::balance::value<T0>(arg0) as u128) * (1000000 as u128) / (arg1 as u128) * ((0x2::balance::value<T0>(arg2) / arg3) as u128) * (1000000 as u128) / (arg3 as u128) * (((100 * arg4 / 90 + 50) * 1000) as u128) * (365 as u128) * (1000000 as u128) * 100 / (arg5 as u128);
            if (v2 > (50000000 as u128)) {
                50000000
            } else {
                (v2 as u64)
            }
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = calculate_apy<T0>(arg0, 0x2::balance::value<T0>(0x2::coin::balance<T0>(&arg1)), arg3 / 86400000 + 1);
