module 0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::port {
    ...
    public entry fun mint(arg0: &0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::utils::Version, arg1: &mut Plan, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < arg2) {
            ...
            let v4 = 0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::collection::mint_nft_with_cap(arg0, arg1.cur_index, v3, *0x1::vector::borrow<0x1::string::String>(&arg1.image_urls, arg1.cur_index % 0x1::vector::length<0x1::string::String>(&arg1.image_urls)), &arg1.mint_cap, 0x1::vector::empty<0x1::string::String>(), 0x1::vector::empty<0x1::string::String>(), arg4);
            ...
            0x2::transfer::public_transfer<0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::collection::Mobius>(v4, 0x2::tx_context::sender(arg4));
        ...
        if (0x2::tx_context::sender(arg4) != arg1.admin) {
    ...
    public fun redeem(arg0: &0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::utils::Version, arg1: &mut Plan, arg2: &mut Stake, arg3: 0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::collection::Mobius, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.profit, *0x2::table::borrow<0x2::object::ID, u64>(&arg1.price_record, v0) * 0x2::table::borrow<0x2::object::ID, Record>(&arg2.nft_record, v0).total_stake_time / 28800 / 270), arg4), 0x2::tx_context::sender(arg4));
    }
