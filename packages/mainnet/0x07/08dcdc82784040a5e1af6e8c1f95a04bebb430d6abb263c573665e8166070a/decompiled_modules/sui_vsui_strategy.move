        ...
        loop {
            ...
            if ((v4 as u64) <= 0x2::balance::value<0x2::sui::SUI>(&arg11)) {
                ...
                if (0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::from_shares(arg1, arg2, v5) < 1000000000) {
                    ...
                    let v6 = 0x2::balance::split<0x2::sui::SUI>(&mut arg11, (v4 as u64));
                    let v7 = get_withdraw_amt(arg0, arg1, arg2, arg5, 0x2::balance::value<0x2::sui::SUI>(&v6));
                    let (v8, v9) = navi_repay_and_withdraw_collateral(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, v6, v7, arg13);
            ...
            let v12 = 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg11);
