module 0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::bluemove_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg5));
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg5));
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg5), arg0.admin);
        let v3 = BuyEvent<T0>{
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg5));
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg5));
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg5), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg5),
            amount_in  : arg1,
            amount_out : v1 - v2,
    ...
    public entry fun sell_exact_out<T0>(arg0: &FeeObject, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg5));
        0x73e357606f89c8ccaeea197dd0e4c22d23b8b65de00b36079e85a7f7b58710a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v1, v2, arg5), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg5),
            amount_in  : v0,
