module 0x7ea73d09ca3e730c26870ecb332542528ec913526b7eeeace6a920faaee054f::nft_hero {
    struct NFT_HERO has drop {
        dummy_field: bool,
    }

    struct MyHero has store, key {
        id: 0x2::object::UID,
        tokenId: u64,
        hp: u64,
        mp: u64,
    ...
    public entry fun transfer(arg0: MyHero, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<MyHero>(arg0, arg1);
    }
