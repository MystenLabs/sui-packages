module 0x7259ff7c9dfc761384a794662fbf1872d3cd5c48c1ba06f927edd17eddc8ba2::subscription {
    ...
    public fun create_market<T0, T1>(arg0: &MainConfig, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u128, arg9: u64, arg10: u64, arg11: bool, arg12: 0x2::coin::Coin<T0>, arg13: 0x2::coin::Coin<T1>, arg14: vector<address>, arg15: vector<u64>, arg16: vector<u8>, arg17: &mut 0x2::tx_context::TxContext) {
    ...
    public fun finalize_market<T0, T1>(arg0: &MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<T1>(&arg1.balance_y) > arg1.hard_cap && v0 > arg1.market_close, 9);
        if (v0 < arg1.market_close + arg0.curator_finalizing_cooldown) {
        ...
        if (arg1.is_auto_add_liquidity) {
            let v3 = arg1.add_liquidity_bps * arg1.hard_cap / 10000;
        ...
        let v26 = arg1.hard_cap - arg1.hard_cap * arg0.finalize_market_fee_bps / 10000;
        let v27 = v26;
        if (arg1.is_auto_add_liquidity) {
            v27 = v26 - arg1.hard_cap * arg1.add_liquidity_bps / 10000;
        };
    ...
    public fun refund<T0, T1>(arg0: &mut Market<T0, T1>, arg1: Proof<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(arg0.contributed < arg0.hard_cap, 7);
        assert!(0x2::object::uid_to_bytes(&arg0.id) == 0x2::object::id_to_bytes(&arg1.market_id), 8);
        let Proof {
            id            : v0,
            market_id     : _,
    ...
    fun validate_params(arg0: &MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + arg0.finalize_market_fee_bps <= 10000, 1);
        let v0 = 0;
        if (arg5) {
