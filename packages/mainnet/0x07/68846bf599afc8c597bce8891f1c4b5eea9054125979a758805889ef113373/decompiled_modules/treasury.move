module 0x768846bf599afc8c597bce8891f1c4b5eea9054125979a758805889ef113373::treasury {
    struct Treasury has store, key {
        id: 0x2::object::UID,
        vaults: 0x2::bag::Bag,
    }

    public fun deposit<T0>(arg0: &0x768846bf599afc8c597bce8891f1c4b5eea9054125979a758805889ef113373::admin_cap::AdminCap, arg1: &mut Treasury, arg2: 0x2::balance::Balance<T0>) {
    ...
    public entry fun withdraw<T0>(arg0: &0x768846bf599afc8c597bce8891f1c4b5eea9054125979a758805889ef113373::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg1.vaults, v0)) {
            abort 20
        };
