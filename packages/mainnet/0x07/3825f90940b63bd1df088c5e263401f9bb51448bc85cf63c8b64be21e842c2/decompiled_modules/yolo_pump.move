module 0xc5c0523f71c490d45b40d24ba30edf44ffde80db76ae4e9426c0fbb8f923f2a6::yolo_pump {
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 > 0, 2);
        let v4 = 0x1::u64::min(0xc5c0523f71c490d45b40d24ba30edf44ffde80db76ae4e9426c0fbb8f923f2a6::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3), 0x2::coin::value<0x2::sui::SUI>(&v2.real_sui_reserves));
