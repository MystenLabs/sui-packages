module 0x76d4c6bdf73cb196d9ca65d9732264de6bbb36d4d7a1b28beafac77a158ddf3::sfloki {
    ...
    fun init(arg0: SFLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SFLOKI>(arg0, 6, b"SFLOKI", b"SuiFloki-Inu", b"The first meme token on Sui Blockchain", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://lh6.googleusercontent.com/db0fyRaCV7KhGEhAnzyGPFMhWeCpBRMAsmmZY9tClehLHtyj3IpGWG4eW9KCpjtuUZZ5T7cMI_kV44gF7LEz=w1280")), arg1);
