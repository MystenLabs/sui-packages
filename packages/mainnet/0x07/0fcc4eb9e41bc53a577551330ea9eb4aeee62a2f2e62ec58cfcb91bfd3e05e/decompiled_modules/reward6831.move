module 0x70fcc4eb9e41bc53a577551330ea9eb4aeee62a2f2e62ec58cfcb91bfd3e05e::reward6831 {
    struct REWARD6831 has drop {
        dummy_field: bool,
    }

    struct TICKET_6831 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6831(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6831>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6831>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6831, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6831>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6831>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6831>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6831>>(v5, 0x2::tx_context::sender(arg1));
    }
