module 0x752a3b6b262d72e18ab80a68236b3a2b2b97fc5f5f950e7bea279c29100b57d::cnsnft6586 {
    struct CNSNFT6586 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6586, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6586>(arg0, arg1);
