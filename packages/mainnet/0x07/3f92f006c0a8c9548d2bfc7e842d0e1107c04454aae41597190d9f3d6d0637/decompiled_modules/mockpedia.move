module 0x73f92f006c0a8c9548d2bfc7e842d0e1107c04454aae41597190d9f3d6d0637::mockpedia {
    ...
    fun init(arg0: MOCKPEDIA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = MockPediaMetadata{
            ...
            name            : v7,
            base_url        : 0x1::string::utf8(b"ipfs://QmWiQE65tmpYzcokCheQmng2DCM33DEhjXcPB6PanwpAZo"),
    ...
    public entry fun mint_nft_to_address(arg0: u64, arg1: address, arg2: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<MockPedia>, arg3: &mut MockPediaMetadata, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun mint_nft_to_kiosk(arg0: u64, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<MockPedia>, arg3: &mut MockPediaMetadata, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 >= 1 && arg0 <= 5, 1);
        let v0 = 0x1::vector::borrow_mut<u64>(&mut arg3.mint_count, arg0 - 1);
        let v1 = 0x1::string::utf8(b"");
        0x1::string::append(&mut v1, *0x1::vector::borrow<0x1::string::String>(&arg3.name, arg0 - 1));
