module 0x7fb916cd1e2ba73e3b2e8b75919a28b4e93826faf6a4b997a38e76018a84082::usdd {
    struct USDD has drop {
        dummy_field: bool,
    }

    fun init(arg0: USDD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/ujlqK02D1MgynOEQuNCp3cIkE1f1fHLTdKWlqo5CKJI";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/ujlqK02D1MgynOEQuNCp3cIkE1f1fHLTdKWlqo5CKJI"))
        };
