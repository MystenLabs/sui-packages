module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    public(friend) entry fun hotfix(arg0: &ManagerCap, arg1: &mut Registry, arg2: &mut AdditionalConfigRegistry) {
        ...
        update_additional_config<u64>(arg2, v0, 16);
        let v1 = AdditionalConfigKey{
            index : 8,
            tag   : b"portfolio_step",
        };
        update_additional_config<u64>(arg2, v1, 16);
        let v2 = AdditionalConfigKey{
            index : 12,
            tag   : b"portfolio_step",
        };
        update_additional_config<u64>(arg2, v2, 16);
        let v3 = AdditionalConfigKey{
            index : 13,
            tag   : b"portfolio_step",
        };
        update_additional_config<u64>(arg2, v3, 16);
    }
