module 0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>,
        miner: u64,
        miner_rate: u64,
        map: u64,
        map_base: u64,
    ...
    entry fun add_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: 0x2::coin::TreasuryCap<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury"), arg2);
    }
    ...
    entry fun claim(arg0: &mut GameInfo, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::borrow_mut<address, PlayerInfo>(&mut arg0.id, v0).last_claim = 1234;
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version     : 1,
            balance     : 0x2::balance::zero<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>(),
            miner       : 1,
            miner_rate  : 1,
            map         : 1,
            map_base    : 2,
    ...
    entry fun remove_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg2));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>>(0x2::coin::from_balance<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>(0x2::balance::split<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>>(0x2::coin::from_balance<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>(0x2::balance::withdraw_all<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>>(0x2::coin::mint<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0x7612c23680b53b9bd4e742b1c82911f998f54ff3dbd2182ae602a4bcb145bc8::tonminer::TONMINER>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
