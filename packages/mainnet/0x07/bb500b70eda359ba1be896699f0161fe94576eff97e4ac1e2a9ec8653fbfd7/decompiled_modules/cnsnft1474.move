module 0x7bb500b70eda359ba1be896699f0161fe94576eff97e4ac1e2a9ec8653fbfd7::cnsnft1474 {
    struct CNSNFT1474 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1474, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1474>(arg0, arg1);
