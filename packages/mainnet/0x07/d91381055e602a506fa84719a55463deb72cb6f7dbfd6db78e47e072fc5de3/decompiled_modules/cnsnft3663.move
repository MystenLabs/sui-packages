module 0x7d91381055e602a506fa84719a55463deb72cb6f7dbfd6db78e47e072fc5de3::cnsnft3663 {
    struct CNSNFT3663 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3663, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2993"));
        let v4 = 0x2::package::claim<CNSNFT3663>(arg0, arg1);
