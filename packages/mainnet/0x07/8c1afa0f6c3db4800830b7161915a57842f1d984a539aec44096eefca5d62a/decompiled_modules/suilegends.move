module 0x78c1afa0f6c3db4800830b7161915a57842f1d984a539aec44096eefca5d62a::suilegends {
    struct SUILEGENDS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUILEGENDS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUILEGENDS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiLegends"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Legendary characters and stories immortalized as NFTs on Sui."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidptsh7viwy4eakgbywrapiac463gtt5dvctkcmmagvnfdzgkffs4"));
