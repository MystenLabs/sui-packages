module 0x79b972419794bbb7e0136a8e0833cbf08553a9702ea7bfa8e02d381996330ab::cnsnft9958 {
    struct CNSNFT9958 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9958, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9958>(arg0, arg1);
