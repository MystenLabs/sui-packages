module 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::campaign {
    ...
    public entry fun add_whitelist<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun change_amount<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        arg1.min_amount = arg2;
        arg1.max_amount = arg3;
    }

    entry fun change_hardcap<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.hard_cap = arg2;
    }

    public entry fun claim<T0, T1>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::vault::Vault<T1>, arg2: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::vesuip::Supply, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::vesuip::mint_and_transfer(arg2, 10 * 1000000000, arg4);
        if (v3 > (arg0.hard_cap as u256)) {
            ...
            0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::lock::new<T1>(v1, arg0.scheduled_times, arg0.scheduled_rewards, 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::vault::claim<T1>(arg1, v1, v4, arg4), 0x2::clock::timestamp_ms(arg3), arg3, arg4);
        } else {
            ...
            0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::lock::new<T1>(v1, arg0.scheduled_times, arg0.scheduled_rewards, 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::vault::claim<T1>(arg1, v1, v7, arg4), 0x2::clock::timestamp_ms(arg3), arg3, arg4);
        };
    }

    public entry fun claim_insurance<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::Fund<T0>, arg2: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::CampaignRefundAllowance, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::object::id<Campaign<T0>>(arg0) == 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::campaign_id(arg2), 1010);
        ...
        0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::claim_refund<T0>(arg1, arg2, v1.valid_amount, v1.claimed, arg4);
    ...
    public entry fun create<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: vector<u64>, arg9: vector<u64>, arg10: bool, arg11: u64, arg12: address, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::lock::check(arg8, arg9), 1016);
        let v0 = Campaign<T0>{
    ...
    fun fund<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::Fund<T0>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun fund_pub<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::Fund<T0>, arg2: 0x2::coin::Coin<T0>, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        fund<T0>(arg0, arg1, 0, arg2, arg3, arg4, arg5);
    }

    public entry fun fund_with_vesuip<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::Fund<T0>, arg2: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::vesuip::VeSuip, arg3: 0x2::coin::Coin<T0>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.only_whitelist, 1009);
        fund<T0>(arg0, arg1, 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::vesuip::amount(arg2), arg3, arg4, arg5, arg6);
    }
    ...
    fun pub_fund<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::Fund<T0>, arg2: 0x2::coin::Coin<T0>, arg3: bool, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3) {
            ...
            0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::insure_campaign<T0>(arg1, 0x2::object::id<Campaign<T0>>(arg0), v3, arg5);
        };
    ...
    fun staker_fund<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::Fund<T0>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
    ...
    public entry fun take_fund<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun take_fund_with_amount<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun update<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: vector<u64>, arg10: vector<u64>, arg11: bool, arg12: address, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::lock::check(arg9, arg10), 1016);
        arg1.hard_cap = arg2;
        arg1.price = arg3;
    ...
    fun wilte_list_fund<T0>(arg0: &mut Campaign<T0>, arg1: &mut 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::Fund<T0>, arg2: 0x2::coin::Coin<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::coin::value<T0>(&arg2);
        let v2 = v1;
        ...
        if (arg3) {
            ...
            0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance::insure_campaign<T0>(arg1, 0x2::object::id<Campaign<T0>>(arg0), v4, arg4);
        };
        arg0.total_deposit = arg0.total_deposit + (v2 as u256);
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(arg2));
        if (0x2::bag::contains<address>(&mut arg0.members, v0)) {
