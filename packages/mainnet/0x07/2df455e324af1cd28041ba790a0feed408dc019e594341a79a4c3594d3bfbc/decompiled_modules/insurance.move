module 0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::insurance {
    ...
    entry fun new<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Fund<T0>{
    ...
    entry fun issue_refund_allowance(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun set_operator<T0>(arg0: &0x72df455e324af1cd28041ba790a0feed408dc019e594341a79a4c3594d3bfbc::admin::AdminCap, arg1: &mut Fund<T0>, arg2: address) {
        arg1.operator = arg2;
    }
