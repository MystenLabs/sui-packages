module 0x757cfd5bae68c732367c4bd75c833181c79c3d81f97b1b4f842ac8a2792afa6::cnsnft2624 {
    struct CNSNFT2624 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2624, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2624>(arg0, arg1);
