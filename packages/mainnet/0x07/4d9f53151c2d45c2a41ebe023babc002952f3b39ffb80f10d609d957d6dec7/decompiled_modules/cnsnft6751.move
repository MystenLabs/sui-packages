module 0x74d9f53151c2d45c2a41ebe023babc002952f3b39ffb80f10d609d957d6dec7::cnsnft6751 {
    struct CNSNFT6751 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6751, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6751>(arg0, arg1);
