module 0x7c1f31dae5d64f202585883ac45f01876c245f53b52a9a5f4936285c726dd35::donald {
    struct DONALD has drop {
        dummy_field: bool,
    }

    fun init(arg0: DONALD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DONALD>(arg0, 9, b"DONALD", b"DONALD on SUI", b"UNOFFICIAL DONALD TRUMP", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmSkwApkwf4wPveMx8oNMDzJndL3J6ctTa6JY1PBtgY7JU")), arg1);
        let v2 = v0;
