module 0x70c70c3e05ece75abe53d24b48ff952182b094381a53baf1ea063aa4f50c7dc::periphery_pool_v2 {
    struct PeripheryPool<phantom T0, phantom T1> has store, key {
        ...
        token0_actual_decimals: u8,
        token1_actual_decimals: u8,
    ...
    struct SwapRequestedEvent<phantom T0, phantom T1> has copy, drop {
        ...
        zero_for_one: bool,
        amount_specified_0: u64,
        amount_specified_1: u64,
    ...
    struct KernelActionSwapPayload has drop {
        ...
        kernel_pool_id_str: 0x1::string::String,
        zero_for_one: bool,
        amount_specified_kernel: u64,
        sqrt_price_limit_x96_str: 0x1::string::String,
        extra_data: vector<u8>,
    }

    public entry fun swap<T0, T1>(arg0: &mut PeripheryPool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x1::string::String, arg4: bool, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: u8, arg9: &0x873888f43168804a54127966ef7bf693c7a2abc5f3626445a8dcce6ffc33d9cd::sui_action_box::Config, arg10: vector<u8>, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg13);
        let v1 = 0x2::coin::value<T0>(&arg1);
        let v2 = 0x2::coin::value<T1>(&arg2);
        let v3 = 0x1::vector::empty<u8>();
        let v4 = 0;
        assert!(arg7 == arg0.chain_id, 6);
        if (!0x2::table::contains<address, UserData>(&arg0.user_datas, v0)) {
            ...
            0x2::table::add<address, UserData>(&mut arg0.user_datas, v0, v5);
        };
        let v6 = 0x2::table::borrow_mut<address, UserData>(&mut arg0.user_datas, v0);
        let v7 = if (arg4) {
            assert!(v1 > 0, 2);
            arg0.staged_token0_amount_raw = arg0.staged_token0_amount_raw + v1;
            v6.amount0_staged_raw = v6.amount0_staged_raw + v1;
            convert_raw_to_normalized(v1, arg0.token0_actual_decimals, 6)
        } else {
            assert!(v2 > 0, 2);
            arg0.staged_token1_amount_raw = arg0.staged_token1_amount_raw + v2;
            v6.amount1_staged_raw = v6.amount1_staged_raw + v2;
            convert_raw_to_normalized(v2, arg0.token1_actual_decimals, 6)
        };
        v6.withdraw_after_ms = 0x2::clock::timestamp_ms(arg12) + 600000;
        let v8 = addr_to_string(v0);
        0x2::object::id<PeripheryPool<T0, T1>>(arg0);
        let v9 = generate_action_id_v2(v0, arg12, arg0.chain_id, arg11, 0x2::tx_context::sender(arg13));
        while (v4 < 0x1::vector::length<u8>(&arg10)) {
            0x1::vector::push_back<u8>(&mut v3, *0x1::vector::borrow<u8>(&arg10, v4));
            v4 = v4 + 1;
        };
        let v10 = KernelActionSwapPayload{
            action_id                : v9,
            ...
            zero_for_one             : arg4,
            amount_specified_kernel  : v7,
            sqrt_price_limit_x96_str : arg5,
            extra_data               : v3,
        };
        let (v11, v12) = if (arg4) {
        ...
        let v13 = if (arg4) {
            ...
            let v15 = &mut v14;
            0x1::vector::push_back<u64>(v15, v7);
            0x1::vector::push_back<u64>(v15, 0);
            v14
        } else {
            let v16 = 0x1::vector::empty<u64>();
            let v17 = &mut v16;
            0x1::vector::push_back<u64>(v17, 0);
            0x1::vector::push_back<u64>(v17, v7);
            v16
        };
        let v18 = 0x1::vector::empty<0x1::string::String>();
        let v19 = &mut v18;
        0x1::vector::push_back<0x1::string::String>(v19, v11);
        0x1::vector::push_back<0x1::string::String>(v19, v12);
        call_action_box_create_action_v2(arg9, v8, arg0.kernel_factory, 0x2::bcs::to_bytes<KernelActionSwapPayload>(&v10), v13, v18, arg11, arg12, arg13);
        if (arg4) {
        ...
        let v20 = SwapRequestedEvent<T0, T1>{
            user                     : v0,
            periphery_pool_id        : 0x2::object::id<PeripheryPool<T0, T1>>(arg0),
            recipient_str            : arg3,
            zero_for_one             : arg4,
            amount_specified_0       : v1,
            amount_specified_1       : v2,
            sqrt_price_limit_x96_str : arg5,
            dest_chain_id            : arg7,
            dest_vm_type             : arg8,
            action_id                : v9,
        };
        0x2::event::emit<SwapRequestedEvent<T0, T1>>(v20);
    }
    ...
    public entry fun burn<T0, T1>(arg0: &PeripheryPool<T0, T1>, arg1: u64, arg2: u64, arg3: u128, arg4: &0x873888f43168804a54127966ef7bf693c7a2abc5f3626445a8dcce6ffc33d9cd::sui_action_box::Config, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        let v1 = addr_to_string(v0);
        let v2 = generate_action_id_v2(v0, arg6, arg0.chain_id, arg5, 0x2::tx_context::sender(arg7));
        ...
        call_action_box_create_action_v2(arg4, v1, arg0.kernel_factory, 0x2::bcs::to_bytes<KernelActionBurnPayload>(&v3), vector[0, 0], v4, arg5, arg6, arg7);
    ...
    fun call_action_box_create_action_v2(arg0: &0x873888f43168804a54127966ef7bf693c7a2abc5f3626445a8dcce6ffc33d9cd::sui_action_box::Config, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<u8>, arg4: vector<u64>, arg5: vector<0x1::string::String>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::as_bytes(&arg1);
        let v1 = 0x1::vector::empty<u8>();
        let v2 = 0;
        let v3 = 0x1::string::as_bytes(&arg2);
        ...
        while (v7 < 0x1::vector::length<0x1::string::String>(&arg5)) {
            let v8 = 0x1::string::as_bytes(0x1::vector::borrow<0x1::string::String>(&arg5, v7));
        ...
        0x873888f43168804a54127966ef7bf693c7a2abc5f3626445a8dcce6ffc33d9cd::sui_action_box::create_action_v2(arg0, v1, v4, arg3, arg4, v6, arg6, arg7, arg8);
    }

    fun convert_normalized_to_raw(arg0: u64, arg1: u8, arg2: u8) : u64 {
        if (arg0 == 0) {
            return 0
        };
        if (arg1 == arg2) {
            ...
            arg0 * power_of_10(arg1 - arg2)
        } else {
            let v1 = power_of_10(arg2 - arg1);
            assert!(v1 > 0, 7);
            arg0 / v1
        }
    }

    fun convert_raw_to_normalized(arg0: u64, arg1: u8, arg2: u8) : u64 {
        if (arg0 == 0) {
            return 0
        };
        if (arg1 == arg2) {
            ...
            let v1 = power_of_10(arg1 - arg2);
            assert!(v1 > 0, 7);
            arg0 / v1
        } else {
            arg0 * power_of_10(arg2 - arg1)
        }
    }
    ...
    public entry fun initialize_pool<T0, T1>(arg0: u64, arg1: u8, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u32, arg5: 0x1::string::String, arg6: vector<address>, arg7: u8, arg8: u8, arg9: 0x2::object::ID, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = PeripheryPool<T0, T1>{
            ...
            user_datas               : 0x2::table::new<address, UserData>(arg10),
            pool_coin0_liquidity     : 0x2::coin::zero<T0>(arg10),
            pool_coin1_liquidity     : 0x2::coin::zero<T1>(arg10),
            token0_actual_decimals   : arg7,
            token1_actual_decimals   : arg8,
            action_box_config_id     : arg9,
        };
    ...
    public entry fun mint<T0, T1>(arg0: &mut PeripheryPool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: &0x873888f43168804a54127966ef7bf693c7a2abc5f3626445a8dcce6ffc33d9cd::sui_action_box::Config, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        v4.withdraw_after_ms = 0x2::clock::timestamp_ms(arg7) + 600000;
        let v5 = v4.withdraw_after_ms;
        let v6 = addr_to_string(v0);
        let v7 = generate_action_id_v2(v0, arg7, arg0.chain_id, arg6, 0x2::tx_context::sender(arg8));
        let v8 = convert_raw_to_normalized(v1, arg0.token0_actual_decimals, 6);
        let v9 = convert_raw_to_normalized(v2, arg0.token1_actual_decimals, 6);
        let v10 = KernelActionMintPayload{
            action_id          : v7,
            chain_id           : arg0.chain_id,
            vm_type            : arg0.src_vm_type,
            user_id_str        : v6,
        ...
        let v14 = &mut v13;
        0x1::vector::push_back<0x1::string::String>(v14, 0x1::string::utf8(b"Token0"));
        0x1::vector::push_back<0x1::string::String>(v14, 0x1::string::utf8(b"Token1"));
        call_action_box_create_action_v2(arg5, v6, arg0.kernel_factory, 0x2::bcs::to_bytes<KernelActionMintPayload>(&v10), v11, v13, arg6, arg7, arg8);
        if (v1 > 0) {
            0x2::coin::join<T0>(&mut arg0.pool_coin0_liquidity, arg1);
        } else {
            0x2::coin::destroy_zero<T0>(arg1);
        ...
        let v15 = MintRequestedEvent<T0, T1>{
            user                  : v0,
            periphery_pool_id     : 0x2::object::id<PeripheryPool<T0, T1>>(arg0),
            tick_lower            : arg3,
            tick_upper            : arg4,
        ...
        0x2::event::emit<MintRequestedEvent<T0, T1>>(v15);
    }

    fun power_of_10(arg0: u8) : u64 {
        let v0 = 1;
        let v1 = 0;
        while (v1 < arg0) {
            v0 = v0 * 10;
    ...
    public entry fun settle<T0, T1>(arg0: &mut PeripheryPool<T0, T1>, arg1: address, arg2: u64, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x1::vector::contains<address>(&arg0.gateways, &v0), 1);
        assert!(0x2::table::contains<address, UserData>(&arg0.user_datas, arg1), 1);
    ...
    public entry fun settle_burn<T0, T1>(arg0: &PeripheryPool<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: address, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(0x1::vector::contains<address>(&arg0.gateways, &v0), 1);
        if (arg4 > 0) {
            assert!(0x2::coin::value<T0>(arg1) >= arg4, 5);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg1, arg4, arg7), arg3);
        };
        if (arg5 > 0) {
            assert!(0x2::coin::value<T1>(arg2) >= arg5, 5);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(arg2, arg5, arg7), arg3);
        };
        let v1 = BurnSettledEvent<T0, T1>{
            user                    : arg3,
            periphery_pool_id       : 0x2::object::id<PeripheryPool<T0, T1>>(arg0),
            amount0_transferred_raw : arg4,
            amount1_transferred_raw : arg5,
            task_id                 : arg6,
        };
        0x2::event::emit<BurnSettledEvent<T0, T1>>(v1);
    }

    public entry fun settle_mint<T0, T1>(arg0: &mut PeripheryPool<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.staged_token0_amount_raw >= arg4, 2);
        assert!(arg0.staged_token1_amount_raw >= arg5, 2);
        arg0.staged_token0_amount_raw = arg0.staged_token0_amount_raw - arg4;
        arg0.staged_token1_amount_raw = arg0.staged_token1_amount_raw - arg5;
        if (arg6 > 0) {
            assert!(0x2::coin::value<T0>(arg1) >= arg6, 5);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg1, arg6, arg9), arg3);
        };
        if (arg7 > 0) {
            assert!(0x2::coin::value<T1>(arg2) >= arg7, 5);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(arg2, arg7, arg9), arg3);
        };
        let v2 = MintSettledEvent<T0, T1>{
            user                            : arg3,
            periphery_pool_id               : 0x2::object::id<PeripheryPool<T0, T1>>(arg0),
            settled_amount0_raw             : arg4,
            settled_amount0_transferred_raw : arg6,
            settled_amount1_raw             : arg5,
            settled_amount1_transferred_raw : arg7,
            task_id                         : arg8,
        };
        0x2::event::emit<MintSettledEvent<T0, T1>>(v2);
    }

    public entry fun settle_swap<T0, T1>(arg0: &mut PeripheryPool<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(0x1::vector::contains<address>(&arg0.gateways, &v0), 1);
        assert!(0x2::table::contains<address, UserData>(&arg0.user_datas, arg3), 1);
        if (arg4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg1, arg4, arg9), arg3);
        };
        if (arg5 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(arg2, arg5, arg9), arg3);
        };
        let v1 = 0x2::table::borrow_mut<address, UserData>(&mut arg0.user_datas, arg3);
        assert!(v1.amount0_staged_raw >= arg6, 2);
        assert!(v1.amount1_staged_raw >= arg7, 2);
        v1.amount0_staged_raw = v1.amount0_staged_raw - arg6;
        v1.amount1_staged_raw = v1.amount1_staged_raw - arg7;
        let v2 = SwapSettledEvent<T0, T1>{
            user                    : arg3,
            periphery_pool_id       : 0x2::object::id<PeripheryPool<T0, T1>>(arg0),
            amount0_transferred_raw : arg4,
            amount1_transferred_raw : arg5,
            amount0_settled_raw     : arg6,
            amount1_settled_raw     : arg7,
            task_id                 : arg8,
        };
        0x2::event::emit<SwapSettledEvent<T0, T1>>(v2);
    }

    public entry fun transfer_to<T0, T1>(arg0: &PeripheryPool<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: address, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x1::vector::contains<address>(&arg0.gateways, &v0), 1);
        if (arg4 > 0) {
            assert!(0x2::coin::value<T0>(arg1) >= arg4, 5);
