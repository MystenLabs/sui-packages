module 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::finance {
    ...
    fun claim_internal<T0>(arg0: address, arg1: &0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::investment::ProfitCS, arg2: &mut 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::investment::Investment, arg3: &0x2::clock::Clock, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg5: bool) : u64 {
        let v0 = 0;
        let (v1, v2, v3, v4, _) = 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::investment::calculate_rewards(arg2, arg1, 0x2::clock::timestamp_ms(arg3));
        if (arg5) {
            assert!(v1 > 0, 4);
        };
        if (v1 > 0) {
            0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::investment::claim_reward(arg2, v4);
            let v6 = 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::suiprice::get_amount_out<T0>(arg4, v1 - v2, false);
            v0 = v6;
            let v7 = Claim{
    ...
    public entry fun stake<T0>(arg0: &mut Finance, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::suiprice::get_amount_out<T0>(arg4, arg1, true);
    ...
    fun unstake_internal<T0>(arg0: &mut Finance, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext, arg5: 0x1::option::Option<address>) {
        check_version(arg0);
        ...
        let (v4, v5, _, _, _) = 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::investment::investment_value(v2);
        0x2::linked_table::remove<u64, 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::investment::Investment>(v1, v4);
        let v9 = 0x71c8bd7e35cf235c00dc3bd358abd96fb53d8c009e13e3717631c377ef6c8ca::suiprice::get_amount_out<T0>(arg3, v5, false);
