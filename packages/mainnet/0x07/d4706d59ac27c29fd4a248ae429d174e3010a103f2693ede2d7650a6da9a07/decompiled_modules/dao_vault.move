module 0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::dao_vault {
    ...
    public fun add_deposit_coin<T0>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::is_token_allowed(arg2, &v0), 22);
        process_add_deposit_coin<T0>(arg0);
    }

    public fun add_swap_coin<T0>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::is_token_allowed(arg2, &v0), 22);
    ...
    fun calculate_protocol_fee(arg0: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig, arg1: u64) : u64 {
        arg1 * 0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::get_protocol_fee(arg0) / 10000
    }

    public fun calculate_total_value_locked_in_usd<T0>(arg0: &Vault, arg1: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig, arg2: &mut TotalValueLockedCalculation, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock) {
        let v0 = 0x1::vector::pop_back<0x1::ascii::String>(&mut arg2.remaining_coins);
        arg2.value = arg2.value + 0x2::balance::value<T0>(0x2::bag::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.balance_storage, v0)) * 0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::price::usd_price(0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::get_price_feed_id(arg1, &v0), arg4, arg5) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg3));
    }
    ...
    public fun deposit_coin<T0>(arg0: &mut Vault, arg1: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig, arg2: TotalValueLocked, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: 0x2::coin::Coin<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 1);
        let v0 = 0x2::coin::value<T0>(&arg6);
        assert!(v0 > 0, 2);
        let v1 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::is_token_allowed(arg1, &v1), 22);
        let v2 = calculate_lp_token_price(arg0, &arg2);
        let v3 = usd_to_shares(arg0, arg2, v0 * 0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::price::usd_price(0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::get_price_feed_id(arg1, &v1), arg4, arg5) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg3)));
        assert!(v3 > 0, 2);
    ...
    public fun flashloan_for_swap<T0>(arg0: &mut Vault, arg1: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig, arg2: &ManagerCap, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanForSwap) {
        assert!(arg5 > 0, 2);
        assert!(arg2.vault_id == 0x2::object::id<Vault>(arg0), 5);
        assert!(!arg0.paused, 1);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        let v1 = arg5 * 0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::price::usd_price(0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::get_price_feed_id(arg1, &v0), arg4, arg6) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg3));
    ...
    public fun return_flashloan_from_swap<T0>(arg0: &mut Vault, arg1: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: FlashLoanForSwap, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::coin::value<T0>(&arg5) * 0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::price::usd_price(0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::get_price_feed_id(arg1, &v3), arg3, arg6) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg2));
    ...
    public fun withdraw_protocol_fees<T0>(arg0: &mut Vault, arg1: &0x7d4706d59ac27c29fd4a248ae429d174e3010a103f2693ede2d7650a6da9a07::protocol_config::ProtocolConfig, arg2: &Guardian, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
