        ...
        while (v2 < 0x1::vector::length<u32>(&arg1)) {
            ...
            if (!v9) {
                if (0x1::vector::contains<0x1::string::String>(v7, &v1) && 0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg0.id, v8)) {
                    ...
                    let v14 = v13;
                    if (v13 > 0) {
                        if (v13 >= 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::vault_amount<T0>(&v11.vault)) {
                            v14 = 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::vault_amount<T0>(&v11.vault);
                        };
                        v11.distributed_rewards = v11.distributed_rewards + v14;
                        0x2::balance::join<T0>(&mut v3, 0xb670828da7ad7c177dac6c15f601ace1b078966a13dc3fea7f342bf1683036d3::vault::withdraw<T0>(&mut v11.vault, v14));
