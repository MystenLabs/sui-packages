module 0x76a803dbb8c74e4d706ae07885f068022158ac9f046cd6dfb4aaacb7150aa3a::cnsnft6624 {
    struct CNSNFT6624 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6624, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6624>(arg0, arg1);
