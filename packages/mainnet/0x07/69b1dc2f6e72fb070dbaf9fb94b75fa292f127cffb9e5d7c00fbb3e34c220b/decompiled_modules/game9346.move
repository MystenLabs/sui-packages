module 0x769b1dc2f6e72fb070dbaf9fb94b75fa292f127cffb9e5d7c00fbb3e34c220b::game9346 {
    struct GAME9346 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeTicket9346(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GAME9346, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME9346>(arg0, arg1);
