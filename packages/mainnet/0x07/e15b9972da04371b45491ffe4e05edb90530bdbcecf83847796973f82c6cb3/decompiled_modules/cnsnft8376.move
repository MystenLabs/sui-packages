module 0x7e15b9972da04371b45491ffe4e05edb90530bdbcecf83847796973f82c6cb3::cnsnft8376 {
    struct CNSNFT8376 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8376, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8376>(arg0, arg1);
