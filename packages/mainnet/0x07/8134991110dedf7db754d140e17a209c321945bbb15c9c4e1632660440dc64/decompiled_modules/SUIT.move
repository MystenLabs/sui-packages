module 0x78134991110dedf7db754d140e17a209c321945bbb15c9c4e1632660440dc64::SUIT {
    struct SUIT has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIT>(arg0, 6, b"MSTR2100", b"MSTR", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1843475199766999042/t-y-HhfY_400x400.jpg")), arg1);
