module 0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::bird {
    ...
    public fun claimPreyReward(arg0: &mut BirdArchieve, arg1: &0x2::clock::Clock, arg2: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg2, 1);
    ...
    public fun claimReferallReward(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg5, 1);
    ...
    public fun claimReward<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut RewardPool<T0>, arg3: &mut BirdStore, arg4: &mut BirdArchieve, arg5: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg5, 1);
    ...
    public fun configRewardPool<T0>(arg0: &AdminCap, arg1: &mut RewardPool<T0>, arg2: bool, arg3: u64, arg4: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg4, 1);
        arg1.active = arg2;
        arg1.reward_limit = arg3;
    }

    public fun createRewardPool<T0>(arg0: &AdminCap, arg1: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg1, 1);
    ...
    public fun deposit<T0>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg3, 1);
    ...
    public fun depositReward<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut RewardPool<T0>, arg2: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg2, 1);
    ...
    public fun emergencyRewardWithdraw<T0>(arg0: &TreasureCap, arg1: &mut RewardPool<T0>, arg2: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg2, 1);
    ...
    public fun feedWorm(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg5, 1);
    ...
    fun init(arg0: BIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::cap_vault::createVault<AdminCap>(arg1);
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::cap_vault::createVault<TreasureCap>(arg1);
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::cap_vault::createVault<0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::VAdminCap>(arg1);
    }

    public fun mineBird(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg5, 1);
        verifySignature(arg0, arg1, arg2);
        let v0 = 0x2::bcs::new(arg1);
    ...
    public fun mineNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg5, 1);
        verifySignature(arg0, arg1, arg2);
    ...
    public fun preyBird(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg5, 1);
        let v0 = 0x2::clock::timestamp_ms(arg4);
        verifySignature(arg0, arg1, arg2);
        let v1 = 0x2::bcs::new(arg1);
    ...
    public fun register(arg0: &mut BirdReg, arg1: &0x2::clock::Clock, arg2: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg2, 1);
    ...
    public fun updateValidator(arg0: &AdminCap, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::Version) {
        0x76666055856bb9f738dc816f36a209805047be841e6b929f179193beca1a2ca::version::checkVersion(arg3, 1);
