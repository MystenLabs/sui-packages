module 0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::incentive_pool {
    ...
    struct IncentivePools<phantom T0> has store, key {
        ...
        reward_pool: 0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool::RewardPool<T0>,
    }
    ...
    public(friend) fun add_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: 0x2::balance::Balance<T0>) {
        0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool::add_reward<T0>(&mut arg0.reward_pool, arg1);
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : (u64, 0x2::balance::Balance<T0>) {
        0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool::claim_reward<T0>(&mut arg0.reward_pool, arg1)
    }
    ...
    public(friend) fun create_incentive_pools<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : IncentivePools<T0> {
        IncentivePools<T0>{
            ...
            reward_pool : 0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool::new<T0>(arg0, arg1),
        }
    }
    ...
    public fun reward_pool<T0>(arg0: &IncentivePools<T0>) : &0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool::RewardPool<T0> {
        &arg0.reward_pool
    }
    ...
    public(friend) fun take_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool::remove_reward<T0>(&mut arg0.reward_pool, arg1)
    }
    ...
    public(friend) fun update_reward_pool<T0>(arg0: &mut IncentivePools<T0>, arg1: u64, arg2: u64) {
        0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool::update_reward_pool<T0>(&mut arg0.reward_pool, arg1, arg2);
    }
