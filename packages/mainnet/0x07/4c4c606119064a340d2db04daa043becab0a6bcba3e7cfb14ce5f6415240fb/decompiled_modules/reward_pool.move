module 0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::reward_pool {
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64) : RewardPool<T0> {
        assert!(arg1 > 0, 0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::app_error::reward_exchange_rate_numerator_zero());
        RewardPool<T0>{
    ...
    public(friend) fun update_reward_pool<T0>(arg0: &mut RewardPool<T0>, arg1: u64, arg2: u64) {
        assert!(arg2 > 0, 0x74c4c606119064a340d2db04daa043becab0a6bcba3e7cfb14ce5f6415240fb::app_error::reward_exchange_rate_numerator_zero());
