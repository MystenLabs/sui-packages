module 0x76542bcda1650a976c76030478cd95cfa1da3f6c7df1fc986a00a862efdaf9c::claynosaurz_phantom_patch {
    struct CLAYNOSAURZ_PHANTOM_PATCH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CLAYNOSAURZ_PHANTOM_PATCH, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CLAYNOSAURZ_PHANTOM_PATCH>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://vpunRZjnV9lpmqikblTOkgDHuYxrwuus_ROkni8s1aE"));
