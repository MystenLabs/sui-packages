module 0x7876b8f3c9554336b774a2a1a20e3240e30c15ad49730b18337685a204f8334::walrus_nft {
    ...
    fun init(arg0: WALRUS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://aggregator.walrus.site/v1/{walrus_blob_id}"));
