module 0x9b149fa785d17c7f7d94c6132c21649cc13e73f55e0e8d6bf957f4dc208d22b6::vault_events {
    ...
    struct AdminBalanceFixed has copy, drop {
        user: address,
        old_balance: u64,
        new_balance: u64,
        new_total_shares: u64,
        new_share_price: u128,
    }

    struct AdminPendingDepositFixed has copy, drop {
        user: address,
        old_amount: u64,
        new_amount: u64,
    }

    struct AdminRcusdpInjected has copy, drop {
        amount: u64,
        new_custody_balance: u64,
        new_share_price: u128,
    }

    public fun emit_admin_balance_fixed(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u128) {
        let v0 = AdminBalanceFixed{
            user             : arg0,
            old_balance      : arg1,
            new_balance      : arg2,
            new_total_shares : arg3,
            new_share_price  : arg4,
        };
        0x2::event::emit<AdminBalanceFixed>(v0);
    }
    ...
    public fun emit_admin_pending_deposit_fixed(arg0: address, arg1: u64, arg2: u64) {
        let v0 = AdminPendingDepositFixed{
            user       : arg0,
            old_amount : arg1,
            new_amount : arg2,
        };
        0x2::event::emit<AdminPendingDepositFixed>(v0);
    }

    public fun emit_admin_rcusdp_injected(arg0: u64, arg1: u64, arg2: u128) {
        let v0 = AdminRcusdpInjected{
            amount              : arg0,
            new_custody_balance : arg1,
            new_share_price     : arg2,
        };
        0x2::event::emit<AdminRcusdpInjected>(v0);
    }
