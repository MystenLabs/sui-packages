module 0x708bdc2bb328a4d07e978181768215649a2bcfa02f9da6682c47859cd229220::reward7914 {
    struct REWARD7914 has drop {
        dummy_field: bool,
    }

    struct TICKET_7914 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7914(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7914>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7914>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7914, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7914>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7914>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7914>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7914>>(v5, 0x2::tx_context::sender(arg1));
    }
