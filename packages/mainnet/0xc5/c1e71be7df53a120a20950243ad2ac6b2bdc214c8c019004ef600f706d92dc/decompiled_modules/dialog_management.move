module 0xc5c1e71be7df53a120a20950243ad2ac6b2bdc214c8c019004ef600f706d92dc::dialog_management {
    ...
    public entry fun update_chat_count(arg0: &mut ChatCounts, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, u64>(&arg0.counts, arg2)) {
            let v1 = 0x2::table::borrow_mut<address, u64>(&mut arg0.counts, arg2);
            *v1 = *v1 + 1;
        } else {
            0x2::table::add<address, u64>(&mut arg0.counts, arg2, 1);
        };
    }
