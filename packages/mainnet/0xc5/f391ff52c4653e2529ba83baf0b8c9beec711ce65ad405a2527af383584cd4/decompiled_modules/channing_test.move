module 0xc5f391ff52c4653e2529ba83baf0b8c9beec711ce65ad405a2527af383584cd4::channing_test {
    struct CHANNING_TEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CHANNING_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CHANNING_TEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Channing Test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Channing Test "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidin44g2nnsvmdcfthvvsoooivrf33n33a6huhlylw7mm5f4elnae"));
