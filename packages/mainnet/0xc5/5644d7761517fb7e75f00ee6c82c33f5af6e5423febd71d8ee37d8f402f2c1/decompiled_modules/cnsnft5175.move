module 0xc55644d7761517fb7e75f00ee6c82c33f5af6e5423febd71d8ee37d8f402f2c1::cnsnft5175 {
    struct CNSNFT5175 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5175, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6529"));
        let v4 = 0x2::package::claim<CNSNFT5175>(arg0, arg1);
