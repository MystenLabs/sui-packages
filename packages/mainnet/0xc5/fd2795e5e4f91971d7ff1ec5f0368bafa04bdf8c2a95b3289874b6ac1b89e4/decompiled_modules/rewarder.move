module 0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::rewarder {
    ...
    public(friend) fun accumulate_vault_reward(arg0: &mut Rewarder, arg1: 0x2::object::ID, arg2: u128, arg3: u64) : u128 {
        ...
        if (arg3 > v0.last_reward_time && arg0.emission_per_second > 0) {
            if (arg2 > 0) {
                v0.acc_per_share = v0.acc_per_share + 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor(((arg0.emission_per_second * (arg3 - v0.last_reward_time) * v0.allocate_point / arg0.total_allocate_point) as u128), 1000000000, arg2);
            } else {
                v0.acc_per_share = 0;
            };
        };
    ...
    public(friend) fun add_vault<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(is_vault_registered(arg0, arg1), 2);
        let v0 = 0x1::type_name::get<T0>();
        assert!(!is_vault_in_rewarder(arg0, v0, arg1), 2);
    ...
    public fun create_rewarder<T0>(arg0: &0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::VaultsManager, arg1: &mut RewarderManager, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::checked_package_version(arg0);
        0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::check_rewarder_manager_role(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0x1::type_name::get<T0>();
        ...
        let v1 = Rewarder{
            ...
            last_reward_time       : 0x2::clock::timestamp_ms(arg3) / 1000,
    ...
    public fun deposit_reward<T0>(arg0: &0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::VaultsManager, arg1: &mut RewarderManager, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::checked_package_version(arg0);
    ...
    public(friend) fun register_vault(arg0: &mut RewarderManager, arg1: 0x2::object::ID) {
        assert!(!is_vault_registered(arg0, arg1), 3);
    ...
    public fun update_rewarder_emission<T0>(arg0: &0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::VaultsManager, arg1: &mut RewarderManager, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::checked_package_version(arg0);
        0x39fdb3c3e25a4f38fbc0b8067fbd8117e0c0613dd69a3f7de46b40d156e8e8c6::vaults_manager::check_rewarder_manager_role(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0x1::type_name::get<T0>();
        assert!(!0x2::linked_table::contains<0x1::type_name::TypeName, Rewarder>(&arg1.rewarders, v0), 1);
    ...
    public(friend) fun vault_rewards_settle(arg0: &mut RewarderManager, arg1: vector<0x1::type_name::TypeName>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u128> {
        assert!(is_vault_registered(arg0, arg2), 2);
        let v0 = 0x2::linked_table::borrow<0x2::object::ID, u128>(&arg0.vault_shares, arg2);
        let v1 = 0x2::clock::timestamp_ms(arg3) / 1000;
        ...
        while (0x1::vector::length<0x1::type_name::TypeName>(&arg1) > 0) {
            ...
            let v5 = accumulate_vault_reward(v4, arg2, *v0, v1);
    ...
    public(friend) fun withdraw_reward<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(is_vault_registered(arg0, arg1), 2);
        assert!(is_vault_in_rewarder(arg0, v0, arg1), 4);
