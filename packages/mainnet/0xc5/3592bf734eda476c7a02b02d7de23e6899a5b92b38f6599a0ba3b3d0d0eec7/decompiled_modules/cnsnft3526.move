module 0xc53592bf734eda476c7a02b02d7de23e6899a5b92b38f6599a0ba3b3d0d0eec7::cnsnft3526 {
    struct CNSNFT3526 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3526, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3526>(arg0, arg1);
