module 0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::liquidity_pool {
    ...
    public fun complete_fulfill_swap_request<T0, T1, T2>(arg0: &BankOwnerCap<T0>, arg1: address, arg2: SwapHotPotato, arg3: &mut Bank<T0>, arg4: &0x2::clock::Clock, arg5: 0x2::coin::Coin<T2>, arg6: vector<u8>, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 1, 1);
        assert!(arg3.transaction_digest != *0x2::tx_context::digest(arg8), 5);
        arg3.transaction_digest = *0x2::tx_context::digest(arg8);
        ...
        assert!(0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::alt_bn128_bls::verify(arg6, 0x2::address::to_bytes(arg7), 0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::verification::create_swap_message_hash(0x1::type_name::get<T1>(), v0.expected_input_amount, v0.minimum_output_amount, v0.valid_till, arg1)), 8);
        let v3 = SwapEvent{
            user                : v0.user,
    ...
    public fun update_merkle_root_state<T0>(arg0: &BankOwnerCap<T0>, arg1: &mut Bank<T0>, arg2: u64, arg3: vector<u8>, arg4: u64, arg5: vector<vector<u8>>, arg6: address, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::verification::verify_merkle_aggregation(arg4, arg6, arg5, 0x1::vector::borrow<MerkleRootState>(v0, 0).root), 7);
        assert!(0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::alt_bn128_bls::verify(arg7, 0x2::address::to_bytes(arg6), 0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::verification::create_merkle_root_message_hash(arg3, arg2)), 8);
    ...
    public fun withdraw_tokens<T0, T1>(arg0: &BankOwnerCap<T0>, arg1: address, arg2: &mut Bank<T0>, arg3: address, arg4: u64, arg5: u64, arg6: u32, arg7: vector<u8>, arg8: u64, arg9: address, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 1);
        ...
        assert!(0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::alt_bn128_bls::verify(arg10, 0x2::address::to_bytes(arg9), 0xc5d92a0df718e9e39e45b76ad50ebf13362c1824fa045bfec3327c0094ce73ee::verification::create_withdrawal_message_hash(0x1::type_name::get<T1>(), arg4, arg5, arg3, arg9)), 8);
