module 0xc542cba93977a03256c2d64ed940fe1810fe44bafb7c20f0c32aac3df48c8883::sacabam {
    ...
    struct Inventory has store, key {
        ...
        warehouse: 0xc542cba93977a03256c2d64ed940fe1810fe44bafb7c20f0c32aac3df48c8883::warehouse::Warehouse<Sacabam>,
    }
    ...
    fun init(arg0: SACABAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v17 = Inventory{
            ...
            warehouse  : 0xc542cba93977a03256c2d64ed940fe1810fe44bafb7c20f0c32aac3df48c8883::warehouse::new<Sacabam>(arg1),
        };
    ...
    public entry fun mint_nft(arg0: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Sacabam>, arg1: &mut Inventory, arg2: 0x1::ascii::String, arg3: 0x1::ascii::String, arg4: vector<u8>, arg5: vector<0x1::ascii::String>, arg6: vector<0x1::ascii::String>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xc542cba93977a03256c2d64ed940fe1810fe44bafb7c20f0c32aac3df48c8883::warehouse::deposit_nft<Sacabam>(&mut arg1.warehouse, v1);
    }

    public entry fun redeem_nft(arg0: &mut Inventory, arg1: &0x6c073f9bcb63af5a4d1120e36a1f01e1110fa20c3768776e818739f09b45fdb5::fossil::BurnCap, arg2: &mut 0x6c073f9bcb63af5a4d1120e36a1f01e1110fa20c3768776e818739f09b45fdb5::supply::Supply, arg3: 0x6c073f9bcb63af5a4d1120e36a1f01e1110fa20c3768776e818739f09b45fdb5::fossil::Fossil, arg4: &mut 0x2::kiosk::Kiosk, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x6c073f9bcb63af5a4d1120e36a1f01e1110fa20c3768776e818739f09b45fdb5::fossil::Fossil>(&arg3);
        assert!(0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.revelation, v0), 2);
        0x6c073f9bcb63af5a4d1120e36a1f01e1110fa20c3768776e818739f09b45fdb5::fossil::burn(arg1, arg2, arg3, arg5);
        let v1 = *0x2::table::borrow<0x2::object::ID, 0x2::object::ID>(&arg0.revelation, v0);
        0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::deposit<Sacabam>(arg4, 0xc542cba93977a03256c2d64ed940fe1810fe44bafb7c20f0c32aac3df48c8883::warehouse::redeem_nft<Sacabam>(&mut arg0.warehouse, v1), arg5);
        let v2 = Redeem{
            fossil_id  : v0,
            sacabam_id : v1,
    ...
    public entry fun reveal(arg0: &0x2::package::Publisher, arg1: &mut Inventory, arg2: vector<0x2::object::ID>, arg3: vector<0x2::object::ID>) {
        ...
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg2)) {
            ...
            0xc542cba93977a03256c2d64ed940fe1810fe44bafb7c20f0c32aac3df48c8883::warehouse::assert_exists<Sacabam>(&arg1.warehouse, v2);
