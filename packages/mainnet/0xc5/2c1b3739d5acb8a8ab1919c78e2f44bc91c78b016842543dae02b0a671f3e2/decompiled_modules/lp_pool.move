module 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::lp_pool {
    ...
    entry fun hotfix_remove_liquidity_pool<T0>(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let LiquidityPool {
            ...
            token_pools                   : v4,
            pool_info                     : _,
            liquidated_unsettled_receipts : v6,
            u64_padding                   : _,
            bcs_padding                   : _,
        } = 0x2::dynamic_object_field::remove<u64, LiquidityPool>(&mut arg1.liquidity_pool_registry, arg2);
        let v9 = v4;
        let v10 = v0;
        0x2::table::destroy_empty<address, vector<DeactivatingShares<T0>>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::table::Table<address, vector<DeactivatingShares<T0>>>>(&mut v10, 0x1::string::utf8(b"deactivating_shares")));
        while (0x1::vector::length<TokenPool>(&v9) > 0) {
            let TokenPool {
                token_type : _,
                config     : _,
                state      : _,
            } = 0x1::vector::pop_back<TokenPool>(&mut v9);
        };
        0x1::vector::destroy_empty<TokenPool>(v9);
        0x1::vector::destroy_empty<0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::escrow::UnsettledBidReceipt>(v6);
