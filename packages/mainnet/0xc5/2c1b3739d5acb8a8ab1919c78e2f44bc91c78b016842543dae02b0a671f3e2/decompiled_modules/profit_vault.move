module 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::profit_vault {
    ...
    entry fun add_whitelist(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut ProfitVault, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::verify(arg0, arg3);
        assert!(!0x2::vec_set::contains<address>(&arg1.whitelist, &arg2), 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::error::whitelist_already_existed());
    ...
    entry fun create_lock_vault(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut 0x2::tx_context::TxContext) {
        0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::verify(arg0, arg1);
        let v0 = LockVault{
    ...
    entry fun create_profit_vault(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::verify(arg0, arg2);
        let v0 = ProfitVault{
    ...
    public(friend) fun get_locked_user_profits(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &LockVault, arg2: address) : vector<vector<u8>> {
    ...
    public(friend) fun get_user_profits(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &ProfitVault, arg2: address) : vector<vector<u8>> {
        0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::version_check(arg0);
        let v0 = 0x1::vector::empty<vector<u8>>();
    ...
    entry fun lock_user_profit<T0>(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut ProfitVault, arg2: &mut LockVault, arg3: address, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, vector<UserProfit>>(&arg1.user_profits, arg3)) {
            ...
            assert!(arg4 < 0x1::vector::length<UserProfit>(v1), 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::error::invalid_idx());
            let v2 = LockedUserProfit{
                user_profit  : 0x1::vector::remove<UserProfit>(v1, arg4),
                create_ts_ms : 0x2::clock::timestamp_ms(arg5),
            };
            assert!(v0 == v2.user_profit.collateral_token, 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::error::collateral_token_type_mismatched());
    ...
    entry fun remove_whitelist(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut ProfitVault, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::verify(arg0, arg3);
        assert!(0x2::vec_set::contains<address>(&arg1.whitelist, &arg2), 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::error::whitelist_not_existed());
    ...
    entry fun unlock_user_profit<T0>(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut ProfitVault, arg2: &mut LockVault, arg3: address, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::verify(arg0, arg5);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        if (0x2::table::contains<address, vector<LockedUserProfit>>(&arg2.user_profits, arg3)) {
            let v1 = 0x2::table::borrow_mut<address, vector<LockedUserProfit>>(&mut arg2.user_profits, arg3);
            assert!(arg4 < 0x1::vector::length<LockedUserProfit>(v1), 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::error::invalid_idx());
    ...
    entry fun update_unlock_countdown_ts_ms(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut ProfitVault, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::verify(arg0, arg3);
