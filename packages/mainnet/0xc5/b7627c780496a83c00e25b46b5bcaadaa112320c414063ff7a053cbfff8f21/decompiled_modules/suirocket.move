module 0xc5b7627c780496a83c00e25b46b5bcaadaa112320c414063ff7a053cbfff8f21::suirocket {
    ...
    fun init(arg0: SUIROCKET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<SUIROCKET>(arg0, 7, b"ROCKET", b"SuiRocket", b"", v1, arg1);
        let v4 = v2;
        0x2::coin::mint_and_transfer<SUIROCKET>(&mut v4, 250000000000000000, v0, arg1);
