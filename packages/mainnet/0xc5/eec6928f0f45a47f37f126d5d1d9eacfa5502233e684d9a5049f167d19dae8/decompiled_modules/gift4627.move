module 0xc5eec6928f0f45a47f37f126d5d1d9eacfa5502233e684d9a5049f167d19dae8::gift4627 {
    struct GIFT4627 has drop {
        dummy_field: bool,
    }

    struct TICKET_4627 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4627(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4627>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4627>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4627, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4627>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4627>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4627>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4627>>(v5, 0x2::tx_context::sender(arg1));
    }
