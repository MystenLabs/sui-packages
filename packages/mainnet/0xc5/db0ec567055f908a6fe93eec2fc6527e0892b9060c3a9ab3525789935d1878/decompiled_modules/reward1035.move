module 0xc5db0ec567055f908a6fe93eec2fc6527e0892b9060c3a9ab3525789935d1878::reward1035 {
    struct REWARD1035 has drop {
        dummy_field: bool,
    }

    struct TICKET_1035 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1035(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1035>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1035>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1035, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1035>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1035>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1035>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1035>>(v5, 0x2::tx_context::sender(arg1));
    }
