module 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::alphapool {
    ...
    public fun claim_airdrop<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::option::is_some<u64>(v4)) {
            let v8 = *0x1::option::borrow<u64>(v4);
            let v9 = if (v8 >= v1) {
                if (v8 < v1 + 98 * 86400000) {
                    if (v2 >= v1) {
                        v2 < v1 + 98 * 86400000
                    } else {
                        false
            ...
            if (v9) {
                ...
                let v10 = *0x2::linked_table::borrow<u64, u64>(&arg1.locked_balance, v8);
                if (v8 + 21 * 86400000 >= v2) {
                    v5 = v5 + v10;
                };
                v6 = v6 + v10;
            };
            v4 = 0x2::linked_table::next<u64, u64>(&arg1.locked_balance, v8);
        };
        while (0x1::vector::length<u64>(&v7) > 0) {
            0x2::linked_table::remove<u64, u64>(&mut arg1.locked_balance, 0x1::vector::pop_back<u64>(&mut v7));
        };
        if (v6 > 0) {
            let v11 = v6 - v5;
            arg1.unlocked_xtokens = arg1.unlocked_xtokens + (v11 as u256);
            let v12 = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::airdrop_rate(arg3) * (v11 as u256) / 1000000000;
            let v13 = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::withdraw_airdrop_balance_for_airdrop<T0>(arg3, (v12 as u64));
            if (0x2::balance::value<T0>(&v13) > 0) {
                let v14 = AirdropLossEvent{airdrop_amount: (v12 as u64)};
                0x2::event::emit<AirdropLossEvent>(v14);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v13, arg5), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_unclaimed_airdrop_wallet_address(arg3));
            } else {
                0x2::balance::destroy_zero<T0>(v13);
            };
            if (v5 > 0) {
                let v15 = 0x2::balance::split<T0>(&mut arg2.alpha_bal, (((v5 as u256) * exchange_rate<T0>(arg2) / (1000000000000000000000000000000000000 as u256)) as u64));
                arg1.xTokenBalance = arg1.xTokenBalance - v5;
                arg2.xTokenSupply = arg2.xTokenSupply - v5;
                let v16 = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::airdrop_rate(arg3) * (v5 as u256) / 1000000000;
                0x2::balance::join<T0>(&mut v15, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::withdraw_airdrop_balance_for_airdrop<T0>(arg3, (v16 as u64)));
                let v17 = AirdropClaimEvent{
                    airdrop_amount : (v16 as u64),
                    relock_amount  : 0x2::balance::value<T0>(&v15),
                };
                0x2::event::emit<AirdropClaimEvent>(v17);
                let v18 = 0x2::coin::from_balance<T0>(v15, arg5);
                user_deposit<T0>(arg0, 0x1::option::some<Receipt>(arg1), arg2, arg3, v18, arg4, arg5);
            } else {
                0x2::transfer::public_transfer<Receipt>(arg1, 0x2::tx_context::sender(arg5));
            };
        } else {
    ...
    fun unlock_locked_balance_for_user<T0>(arg0: &mut Receipt, arg1: &mut 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::airdrop_rate(arg1) * (v2 as u256) / 1000000000;
        let v7 = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::withdraw_airdrop_balance_for_airdrop<T0>(arg1, (v6 as u64));
        if (0x2::balance::value<T0>(&v7) > 0) {
            let v8 = AirdropLossEvent{airdrop_amount: (v6 as u64)};
            0x2::event::emit<AirdropLossEvent>(v8);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v7, arg3), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_unclaimed_airdrop_wallet_address(arg1));
        } else {
