module 0xc5f02fef9d9dcccd5e0c333bd0c7bda8ba9d21f94ebd0acf5519eaa8d5954f85::reward8344 {
    struct REWARD8344 has drop {
        dummy_field: bool,
    }

    struct TICKET_8344 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8344(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8344>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8344>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8344, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8344>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8344>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8344>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8344>>(v5, 0x2::tx_context::sender(arg1));
    }
