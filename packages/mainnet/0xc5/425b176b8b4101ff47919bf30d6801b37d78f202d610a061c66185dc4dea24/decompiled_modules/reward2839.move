module 0xc5425b176b8b4101ff47919bf30d6801b37d78f202d610a061c66185dc4dea24::reward2839 {
    struct REWARD2839 has drop {
        dummy_field: bool,
    }

    struct TICKET_2839 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2839(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2839>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2839>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2839, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2839>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2839>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2839>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2839>>(v5, 0x2::tx_context::sender(arg1));
    }
