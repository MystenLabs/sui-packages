module 0xc57d73337cdd515f17c79fa35f62918ba3915f75c49e7119507c43c2dd083aa0::events {
    struct OrderCreated has copy, drop {
        order_hash: vector<u8>,
        order: 0xc57d73337cdd515f17c79fa35f62918ba3915f75c49e7119507c43c2dd083aa0::order::Order,
    }
    ...
    public(friend) fun order_created(arg0: vector<u8>, arg1: 0xc57d73337cdd515f17c79fa35f62918ba3915f75c49e7119507c43c2dd083aa0::order::Order) {
        let v0 = OrderCreated{
            order_hash : arg0,
            order      : arg1,
        };
    ...
    public(friend) fun order_filled(arg0: vector<u8>, arg1: 0xc57d73337cdd515f17c79fa35f62918ba3915f75c49e7119507c43c2dd083aa0::order::Order) {
        let v0 = OrderFilled{
            order_hash : arg0,
            order      : arg1,
        };
