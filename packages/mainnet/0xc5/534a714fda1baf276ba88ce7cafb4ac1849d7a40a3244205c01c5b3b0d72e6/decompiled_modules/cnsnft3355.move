module 0xc5534a714fda1baf276ba88ce7cafb4ac1849d7a40a3244205c01c5b3b0d72e6::cnsnft3355 {
    struct CNSNFT3355 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3355, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3355>(arg0, arg1);
