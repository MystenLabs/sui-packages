module 0xc50dbe7060d7cc671ff7d7aa7b6abc0882448c19600eeddcc9fec9b7b2148d22::flowx_vampire_attack {
    ...
    struct FlowxLockdropForPool<phantom T0, phantom T1> has key {
        ...
        user_profile_access_cap: 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::ProfileDofOwnershipCapability,
        total_hive_incentives: u64,
        available_hive_tokens: 0x2::balance::Balance<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>,
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut FlowxLockdropForPool<T0, T1>, arg2: &FlowxAttackConfig, arg3: 0x2::coin::Coin<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
        assert!(arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window > 0x2::clock::timestamp_ms(arg0), 9803);
        let v0 = 0x2::coin::into_balance<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(arg3);
        0x2::balance::join<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(&mut arg1.available_hive_tokens, 0x2::balance::split<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(&mut v0, arg4));
        ...
        0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::coin_helper::destroy_or_transfer_balance<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(v0, 0x2::tx_context::sender(arg5), arg5);
    ...
    fun allowed_withdrawal_amount(arg0: &FlowxAttackConfig, arg1: u64, arg2: u64) : u64 {
        ...
        if (arg1 < v2) {
            (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_div_u256((arg2 as u256), ((v2 - arg1) as u256), ((v2 - v1) as u256)) as u64)
        } else {
            0
        }
    }
    ...
    fun calculate_hive_rewards(arg0: u128, arg1: u128, arg2: u64) : u64 {
        if (arg1 == 0) {
            ...
            (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_div_u256((arg2 as u256), (arg0 as u256), (arg1 as u256)) as u64)
        }
    }

    fun calculate_weighted_units(arg0: u64, arg1: u64, arg2: &FlowxAttackConfig) : u128 {
        (((arg0 as u256) * ((1000000000 as u256) + 0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_div_u256(((arg1 - 1) as u256) * (arg2.weekly_multiplier as u256), (1000000000 as u256), (arg2.weekly_divider as u256)))) as u128)
    }

    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &FlowxLockdropForPool<T0, T1>, arg4: &mut 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::HiveProfile, arg5: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, u128, u128) {
        ...
        if (!0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::exists_for_profile(arg4, 0x1::string::to_ascii(v0))) {
        ...
        } = 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::entry_remove_from_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, arg5);
        0x2::object::delete(v1);
        0x2::table::drop<u64, bool>(v6);
        (v2, v3, v4, v5, (v7 as u128), v8)
    }

    public fun does_user_have_position<T0, T1>(arg0: &0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::HiveProfile, arg1: &FlowxLockdropForPool<T0, T1>) : bool {
        let v0 = 0x1::string::utf8(b"flowx_vampire_attack");
        0x1::string::append(&mut v0, arg1.identifer);
        0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::exists_for_profile(arg0, 0x1::string::to_ascii(v0))
    }

    public fun extract_liquidity_from_flowx<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &mut FlowxLockdropForPool<T0, T1>, arg4: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg5: &mut 0x2::tx_context::TxContext) : (u128, u128, u64, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>) {
        assert!(0x2::clock::timestamp_ms(arg0) > arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9813);
        ...
        (arg3.total_lp_locked, arg3.total_weighted_units, arg3.total_hive_incentives, v5, v6, 0x2::balance::withdraw_all<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(&mut arg3.available_hive_tokens))
    }

    public fun get_user_position<T0, T1>(arg0: &0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::HiveProfile, arg1: &FlowxLockdropForPool<T0, T1>) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        let v0 = 0x1::string::utf8(b"flowx_vampire_attack");
        0x1::string::append(&mut v0, arg1.identifer);
        let v1 = 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::borrow_from_profile<UserFlowxHivePosition>(arg0, 0x1::string::to_ascii(v0));
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::config::HiveEntryCap, arg2: 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::ProfileDofOwnershipCapability, arg3: &mut FlowxAttackConfig, arg4: 0x1::string::String, arg5: 0x2::coin::Coin<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : address {
        assert!(arg3.init_timestamp > 0x2::clock::timestamp_ms(arg0), 9800);
        let v0 = 0x2::coin::into_balance<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(arg5);
        ...
        let v3 = FlowxLockdropForPool<T0, T1>{
            ...
            available_hive_tokens   : 0x2::balance::split<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(&mut v0, arg6),
        ...
        0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::coin_helper::destroy_or_transfer_balance<0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive::HIVE>(v0, 0x2::tx_context::sender(arg7), arg7);
    ...
    public entry fun initialize_flowx_attack_config(arg0: &0x2::clock::Clock, arg1: &0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
    ...
    public entry fun lock_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &mut FlowxLockdropForPool<T0, T1>, arg4: &mut 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::HiveProfile, arg5: 0x2::coin::Coin<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::get_profile_meta_info(arg4);
        ...
        let v6 = if (0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::exists_for_profile(arg4, 0x1::string::to_ascii(v5))) {
            0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::entry_remove_from_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, arg8)
        } else {
        ...
        0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::entry_add_to_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, v6, arg8);
    ...
    public entry fun withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &mut FlowxLockdropForPool<T0, T1>, arg4: &mut 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::HiveProfile, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::get_profile_meta_info(arg4);
        assert!(v0 >= arg2.init_timestamp, 9804);
        ...
        let v5 = 0x1::string::utf8(b"flowx_vampire_attack");
        0x1::string::append(&mut v5, arg3.identifer);
        assert!(0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::exists_for_profile(arg4, 0x1::string::to_ascii(v5)), 9808);
        let v6 = 0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::entry_remove_from_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, arg7);
        ...
        0x9d7a91a658d6a16e77dfbfcff61aaa9a8f85824d6bc4e53528d4a74210776f04::hive_profile::entry_add_to_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, v6, arg7);
