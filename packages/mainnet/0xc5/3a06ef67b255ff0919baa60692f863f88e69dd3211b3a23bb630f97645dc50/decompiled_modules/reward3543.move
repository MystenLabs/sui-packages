module 0xc53a06ef67b255ff0919baa60692f863f88e69dd3211b3a23bb630f97645dc50::reward3543 {
    struct REWARD3543 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward3543(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD3543, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3543>(arg0, arg1);
