module 0xc588aa8837047a7f25483bf9d8243687c5116be5878f730ea8270315e7d20163::lock_unlock {
    ...
    struct Reserves<phantom T0> has key {
        ...
        nest_reserve: 0x2::balance::Balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>,
    ...
    fun check_circuit_breaker<T0>(arg0: &mut Reserves<T0>, arg1: &0x2::clock::Clock) {
        let v0 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.nest_reserve) as u128);
    ...
    public entry fun create_reserves<T0>(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Reserves<T0>{
            ...
            nest_reserve                         : 0x2::balance::zero<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(),
    ...
    public entry fun emergency_withdraw_nest<T0>(arg0: &AdminCap, arg1: &mut Reserves<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 > 0, 9);
        let v1 = 0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg1.nest_reserve);
        assert!(v1 >= arg2, 2);
        assert!(arg2 <= v1 / 10, 7);
        arg1.last_emergency_nest_withdrawal = v0;
        let v2 = 0x2::tx_context::sender(arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>>(0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg1.nest_reserve, arg2), arg4), v2);
        let v3 = EmergencyWithdrawal{
            admin      : v2,
            token_type : b"NEST",
            amount     : arg2,
    ...
    public fun get_health_dashboard<T0>(arg0: &Reserves<T0>) : (u128, u128, u128, u128, bool, bool, u128, u128, u64, u64) {
        ...
        (get_backing_ratio<T0>(arg0), (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.nest_reserve) as u128), (0x2::balance::value<T0>(&arg0.collateral_balance) as u128), arg0.total_nest_in_circulation, v0, arg0.critical_state, v1, v2, arg0.total_locks, arg0.total_unlocks)
    }

    public fun get_nest_reserve<T0>(arg0: &Reserves<T0>) : u64 {
        0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.nest_reserve)
    }

    public fun get_nest_reserve_u128<T0>(arg0: &Reserves<T0>) : u128 {
        (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.nest_reserve) as u128)
    }

    public fun get_reserves_stats<T0>(arg0: &Reserves<T0>) : (u64, u64, u128, u128, u128, u64, u64, bool, bool) {
        (0x2::balance::value<T0>(&arg0.collateral_balance), 0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg0.nest_reserve), arg0.total_collateral_locked, arg0.total_nest_in_circulation, arg0.total_nest_fees_collected, arg0.total_locks, arg0.total_unlocks, arg0.is_initialized, arg0.is_paused)
    }
    ...
    public entry fun init_reserves<T0>(arg0: &mut Reserves<T0>, arg1: 0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>, arg2: &AdminCap, arg3: &0x2::clock::Clock) {
        ...
        0x2::balance::join<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.nest_reserve, 0x2::coin::into_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(arg1));
    ...
    public entry fun lock<T0>(arg0: &mut Reserves<T0>, arg1: &mut 0xae9a18f87d91f9a71a925c9e6afd535f33d8141d152806046a9f2da5e5474031::staking_pool::StakingPool, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.nest_reserve, (v4 as u64));
        let v8 = 0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.nest_reserve, (v6 as u64));
        let (v9, v10, _) = verify_reserves_integrity<T0>(arg0);
        assert!(v9 && v10 == 0, 14);
        check_circuit_breaker<T0>(arg0, arg4);
        let v12 = 0x2::tx_context::sender(arg5);
        0xae9a18f87d91f9a71a925c9e6afd535f33d8141d152806046a9f2da5e5474031::staking_pool::deposit_rewards(arg1, 0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(v7, arg5), arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>>(0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(v8, arg5), v12);
        let v13 = Locked{
            user                      : v12,
    ...
    public entry fun refill_nest_reserves<T0>(arg0: &AdminCap, arg1: &mut Reserves<T0>, arg2: 0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = (0x2::coin::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg2) as u128);
        assert!(v0 > 0, 9);
        0x2::balance::join<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg1.nest_reserve, 0x2::coin::into_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(arg2));
        let v1 = (0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg1.nest_reserve) as u128);
    ...
    public entry fun unlock<T0>(arg0: &mut Reserves<T0>, arg1: &mut 0xae9a18f87d91f9a71a925c9e6afd535f33d8141d152806046a9f2da5e5474031::staking_pool::StakingPool, arg2: 0x2::coin::Coin<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 5);
        assert!(arg0.is_initialized, 4);
        assert!(!arg0.critical_state, 22);
        let v0 = (0x2::coin::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg2) as u128);
        ...
        0x2::balance::join<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.nest_reserve, 0x2::coin::into_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(arg2));
        ...
        let v8 = 0x2::balance::split<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&mut arg0.nest_reserve, (v5 as u64));
        ...
        0xae9a18f87d91f9a71a925c9e6afd535f33d8141d152806046a9f2da5e5474031::staking_pool::deposit_rewards(arg1, 0x2::coin::from_balance<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(v8, arg5), arg4);
    ...
    public entry fun unpause<T0>(arg0: &AdminCap, arg1: &mut Reserves<T0>, arg2: &0x2::clock::Clock) {
        ...
        assert!((0x2::balance::value<0x35d42a4a511889fe959907140cd316acf0a1a8f1fef39e5fe24a4b8b5ffe1b08::nest::NEST>(&arg1.nest_reserve) as u128) >= 333000000000000 * 100 / 10000, 22);
