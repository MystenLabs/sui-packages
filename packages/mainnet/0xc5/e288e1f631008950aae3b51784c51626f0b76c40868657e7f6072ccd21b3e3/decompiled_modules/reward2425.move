module 0xc5e288e1f631008950aae3b51784c51626f0b76c40868657e7f6072ccd21b3e3::reward2425 {
    struct REWARD2425 has drop {
        dummy_field: bool,
    }

    struct TICKET_2425 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2425(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2425>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2425>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2425, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2425>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2425>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2425>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2425>>(v5, 0x2::tx_context::sender(arg1));
    }
