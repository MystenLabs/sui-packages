module 0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::cB {
    struct AC {
        lv: 0x2::bag::Bag,
    ...
    public fun fA<T0>(arg0: &0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::dB::AP, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : AC {
        0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::dB::gJ(arg0);
    ...
    public fun in<T0, T1>(arg0: &mut 0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::dB::AP, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::vault::FlashLoan, arg3: bool, arg4: u64, arg5: AC, arg6: &mut 0x2::tx_context::TxContext) {
        let AC {
            lv : v0,
            lb : v1,
        } = arg5;
        ...
        if (arg3) {
            ...
            assert!(0x2::bag::is_empty(&v2), 314);
            0x2::bag::destroy_empty(v2);
            0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::dB::eA<T0>(arg0, v3, v1);
        } else {
            ...
            assert!(0x2::bag::is_empty(&v2), 314);
            0x2::bag::destroy_empty(v2);
            0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::dB::eA<T1>(arg0, v4, v1);
        };
    }
    ...
    public fun on<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: 0x1::string::String, arg2: bool, arg3: u64, arg4: &0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::dB::AP, arg5: &mut 0x2::tx_context::TxContext) : (AC, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::vault::FlashLoan) {
        0xc52fc1399ff1761440c6869345501e599811df290ecb605cfe85587972654c08::dB::gJ(arg4);
        let v0 = if (arg2) {
