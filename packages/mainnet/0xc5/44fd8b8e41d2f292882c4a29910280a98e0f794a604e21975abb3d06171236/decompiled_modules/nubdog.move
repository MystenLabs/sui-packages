module 0xc544fd8b8e41d2f292882c4a29910280a98e0f794a604e21975abb3d06171236::nubdog {
    struct NUBDOG has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<NUBDOG>, arg1: 0x2::coin::Coin<NUBDOG>) {
        0x2::coin::burn<NUBDOG>(arg0, arg1);
    }

    fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<NUBDOG>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<NUBDOG>(arg0, arg1, arg2, arg3);
    }
