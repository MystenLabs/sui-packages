module 0xc5bddbcfca99e5aafe5e60eb377f9fa76089aec541a8391ff9ac709feeea1b72::cnsnft5018 {
    struct CNSNFT5018 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5018, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8534"));
        let v4 = 0x2::package::claim<CNSNFT5018>(arg0, arg1);
