module 0xc582c360142055af4ceb82fccdeedaa797a6f1f090c6b8a62f325959b9e9a9ea::cnsnft2229 {
    struct CNSNFT2229 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2229, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2229>(arg0, arg1);
