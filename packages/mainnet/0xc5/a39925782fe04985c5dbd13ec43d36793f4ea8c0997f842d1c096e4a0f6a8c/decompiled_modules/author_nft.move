module 0xc5a39925782fe04985c5dbd13ec43d36793f4ea8c0997f842d1c096e4a0f6a8c::author_nft {
    ...
    fun init(arg0: AUTHOR_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = LiteraryCollection{
            ...
            name             : 0x1::string::utf8(b"Walrus Lit Blob Issue 1 Collection"),
            description      : 0x1::string::utf8(b"A curated collection of literary works decentrally published by Walrus Proetry, featuring the best stories, poems, and DLT literary experiments on web3."),
            website          : 0x1::string::utf8(b"https://walrusproetry.wal.app"),
            creator          : v1,
            total_minted     : 0,
            authors          : 0x2::vec_map::empty<0x1::string::String, u64>(),
            collection_image : 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/-NdJt97baTZBrs4hQFDReMzBcJEiH0a9Xi45P7eMYU0"),
