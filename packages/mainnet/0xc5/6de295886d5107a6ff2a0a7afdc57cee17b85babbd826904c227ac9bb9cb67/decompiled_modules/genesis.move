module 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis {
    ...
    struct Version_1_0_9 has copy, drop, store {
        dummy_field: bool,
    }

    struct Version_1_1_0 has copy, drop, store {
        dummy_field: bool,
    }

    struct Version_1_1_1 has copy, drop, store {
        dummy_field: bool,
    }

    struct Version_1_1_2 has copy, drop, store {
        dummy_field: bool,
    }

    struct Version_1_1_3 has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun check_latest_version(arg0: &GovernanceGenesis) {
        ...
        let v1 = if (0x2::dynamic_field::exists_with_type<Version, Version_1_1_2>(&arg0.id, v0)) {
            true
        } else {
            let v2 = Version{dummy_field: false};
            0x2::dynamic_field::exists_with_type<Version, Version_1_1_3>(&arg0.id, v2)
        };
        assert!(v1, 4);
    }
    ...
    public fun get_version_1_0_9() : Version_1_0_9 {
        Version_1_0_9{dummy_field: false}
    }

    public fun get_version_1_1_0() : Version_1_1_0 {
        Version_1_1_0{dummy_field: false}
    }

    public fun get_version_1_1_1() : Version_1_1_1 {
        Version_1_1_1{dummy_field: false}
    }

    public fun get_version_1_1_2() : Version_1_1_2 {
        Version_1_1_2{dummy_field: false}
    }

    public fun get_version_1_1_3() : Version_1_1_3 {
        Version_1_1_3{dummy_field: false}
    }
