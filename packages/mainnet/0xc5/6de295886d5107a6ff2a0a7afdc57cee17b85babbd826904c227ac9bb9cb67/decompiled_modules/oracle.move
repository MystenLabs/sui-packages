module 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle {
    ...
    fun extract_vaa_bytes_from_accumulator_message(arg0: vector<u8>) : vector<u8> {
        ...
        let v3 = v0 + v1 + (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::deserialize_u8(&v2) as u64) + 1;
        let v4 = 2;
        let v5 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::vector_slice<u8>(&arg0, v3, v3 + v4);
        let v6 = v3 + v4;
        0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::vector_slice<u8>(&arg0, v6, v6 + (0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::serde::deserialize_u16(&v5) as u64))
    }
    ...
    public fun register_token_price(arg0: &0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceCap, arg1: &mut PriceOracle, arg2: vector<u8>, arg3: u16, arg4: u256, arg5: u8, arg6: &0x2::clock::Clock) {
        ...
        0x2::dynamic_field::remove_if_exists<u16, 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::PriceIdentifier>(&mut arg1.id, arg3);
    ...
    fun update_price(arg0: &mut Price, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::Price, arg2: u64) {
        ...
        assert!(v1 > 0, 10);
        let v2 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_expo(arg1);
