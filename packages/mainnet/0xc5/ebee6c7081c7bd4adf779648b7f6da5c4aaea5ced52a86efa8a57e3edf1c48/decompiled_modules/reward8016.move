module 0xc5ebee6c7081c7bd4adf779648b7f6da5c4aaea5ced52a86efa8a57e3edf1c48::reward8016 {
    struct REWARD8016 has drop {
        dummy_field: bool,
    }

    struct TICKET_8016 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8016(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8016>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8016>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8016, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8016>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8016>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8016>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8016>>(v5, 0x2::tx_context::sender(arg1));
    }
