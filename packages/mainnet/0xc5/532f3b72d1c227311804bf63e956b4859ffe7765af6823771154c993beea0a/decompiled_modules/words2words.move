module 0xc5532f3b72d1c227311804bf63e956b4859ffe7765af6823771154c993beea0a::words2words {
    ...
    fun random_index(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0xc5532f3b72d1c227311804bf63e956b4859ffe7765af6823771154c993beea0a::pseudorandom::rand_with_ctx(arg1);
        0xc5532f3b72d1c227311804bf63e956b4859ffe7765af6823771154c993beea0a::pseudorandom::select_u64(arg0, &v0)
    }
    ...
    public entry fun sentence_to_words(arg0: Sentence, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x1::vector::is_empty<0x1::string::String>(&v14)) {
            ...
            0x2::kiosk::place<Word>(arg1, arg2, v15);
        };
