module 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::vault {
    ...
    public fun calculate_lp_token_share<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::coin::TreasuryCap<VAULT>, arg3: u64) : (u64, u64) {
        ...
        assert!(v4 > 0, 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::invalidLPToken());
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::constants::lp_token_metadata();
    ...
    fun mint_lp_token(arg0: &mut 0x2::coin::TreasuryCap<VAULT>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<VAULT> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::constants::minimal_liquidity(), 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::liquidityInsufficientMinted());
        0x2::coin::mint<VAULT>(arg0, v1, arg5)
    }

    public fun new_vault<T0, T1>(arg0: &0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
        let v0 = Vault<T0, T1>{
    ...
    public fun process_deposits<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1>(arg1), 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::invalid_vault_cap());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg5)), 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::address_not_whitelisted());
        let v0 = &arg1.deepbook_account_cap;
        let (v1, v2, v3, v4) = get_deepbook_account_assets<T0, T1>(arg1, arg2);
        assert!(v2 == 0, 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::locked_base_asset_found());
        assert!(v4 == 0, 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::locked_quote_asset_found());
        ...
        while (0x1::vector::length<DepositRequest<T1>>(&arg1.deposit_requests) > 0) {
            ...
            let v12 = v10;
            let v13 = if (v3 == 0) {
                0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&v12), 1, 2)
            } else {
                0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&v12), v1, 1000 * v3 + v1)
            };
            let v14 = 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::safe_math::safe_mul_div_u64(v13, v7, 1000000) * 1000;
    ...
    public fun process_withdrawals<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1>(arg1), 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::invalid_vault_cap());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg4)), 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::address_not_whitelisted());
        let v0 = &arg1.deepbook_account_cap;
    ...
    public fun revoke_trading_permission<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: address) {
        ...
        assert!(v0, 0xc5006d1758c16a3e2b00e230c3f1efb3e55df8d42d55ec5518c52841fb62ddbc::error::address_not_whitelisted());
