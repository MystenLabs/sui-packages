module 0xc5733dbc0b8381e42545b938fdf2801be898aae90ea92296678b2636401e19ca::dal {
    struct DAL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DAL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (1000000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<DAL>>(0x2::coin::mint<DAL>(&mut v5, 1000000000000000000, arg1), v6);
        };
