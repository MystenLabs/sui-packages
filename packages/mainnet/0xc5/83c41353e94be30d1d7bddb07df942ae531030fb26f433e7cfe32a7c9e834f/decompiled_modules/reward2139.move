module 0xc583c41353e94be30d1d7bddb07df942ae531030fb26f433e7cfe32a7c9e834f::reward2139 {
    struct REWARD2139 has drop {
        dummy_field: bool,
    }

    struct TICKET_2139 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2139(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2139>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2139>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2139, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2139>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2139>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2139>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2139>>(v5, 0x2::tx_context::sender(arg1));
    }
