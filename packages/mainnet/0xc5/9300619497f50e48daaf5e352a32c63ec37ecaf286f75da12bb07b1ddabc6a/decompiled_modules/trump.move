module 0xc59300619497f50e48daaf5e352a32c63ec37ecaf286f75da12bb07b1ddabc6a::trump {
    ...
    fun init(arg0: TRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TRUMP>(arg0, 6, b"TRUMP STAR", b"TRUMP", b"$TRUMP on $SUI MAKE SUI GREAT AGAIN! https://www.trumpstars.org/  https://x.com/trumpstar_sui https://t.me/trumpstarportal", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://harlequin-payable-basilisk-127.mypinata.cloud/ipfs/QmW6HgCSNYqMnHR1m6nd1YNFt1kDFsqCdxqQyZ9dAdmyXw")), arg1);
