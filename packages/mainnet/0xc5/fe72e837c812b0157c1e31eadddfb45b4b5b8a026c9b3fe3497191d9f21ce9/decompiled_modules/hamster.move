module 0xc5fe72e837c812b0157c1e31eadddfb45b4b5b8a026c9b3fe3497191d9f21ce9::hamster {
    ...
    fun init(arg0: HAMSTER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HAMSTER>(arg0, 6, b"Hamster", b"Hamster", b"Lya-lya-lya capybara on Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://gateway.pinata.cloud/ipfs/QmQgeb5N6DyXtuFve1nD7vbsU3pmvdadnUMsQDtFiptjBd"))), arg1);
        let v2 = v0;
