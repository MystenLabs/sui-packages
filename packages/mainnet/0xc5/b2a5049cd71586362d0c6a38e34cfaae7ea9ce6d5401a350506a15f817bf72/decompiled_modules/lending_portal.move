module 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_portal {
    ...
    entry fun cancel_as_collateral_remote(arg0: &0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceGenesis, arg1: &0x2::clock::Clock, arg2: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::wormhole_adapter_pool::PoolState, arg3: &mut LendingPortal, arg4: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::state::State, arg5: vector<u16>, arg6: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::check_latest_version(arg0);
        let v0 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::merge_coins::merge_coin<0x2::sui::SUI>(arg6, arg7, arg8);
        let v1 = 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::state::message_fee(arg4);
        assert!(arg7 >= v1, 3);
        let v2 = get_nonce(arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v0, arg3.relayer);
        let v3 = RelayEvent{
            sequence   : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::wormhole_adapter_pool::send_message(arg2, arg4, 0x2::coin::split<0x2::sui::SUI>(&mut v0, v1, arg8), 1, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_codec::encode_manage_collateral_payload(arg5, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_codec::get_cancel_as_colleteral_type()), arg1, arg8),
            nonce      : v2,
            dst_pool   : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::dola_address::convert_address_to_dola(@0x0),
            fee_amount : 0x2::coin::value<0x2::sui::SUI>(&v0),
            call_type  : 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_codec::get_cancel_as_colleteral_type(),
        };
        0x2::event::emit<RelayEvent>(v3);
    }
