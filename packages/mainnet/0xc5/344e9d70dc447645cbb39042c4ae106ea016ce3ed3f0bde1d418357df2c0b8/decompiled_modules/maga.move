module 0xc5344e9d70dc447645cbb39042c4ae106ea016ce3ed3f0bde1d418357df2c0b8::maga {
    ...
    fun init(arg0: MAGA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MAGA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MAGA    ")))), trim_right(b"MAGA                            "), trim_right(b"MAGA MEME COIN MAKE CRYPTO GREAT AGAIN CTO - SAFU                                                                                                                                                                                                                                                                               "), v2, arg1);
