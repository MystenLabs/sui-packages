module 0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::ACL,
    ...
    public fun add_role(arg0: &mut AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::Member> {
        0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::remove_member(&mut arg1.acl, arg2);
        let v0 = RemoveMemberEvent{member: arg2};
        0x2::event::emit<RemoveMemberEvent>(v0);
    }

    public fun remove_role(arg0: &mut AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun checked_keeper(arg0: &GlobalConfig, arg1: address) {
        assert!(0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::has_role(&arg0.acl, arg1, 1), 2);
    }
    ...
    public fun checked_pool_token_types<T0, T1>(arg0: &GlobalConfig) {
        if (arg0.require_check_token_white_list) {
            assert!(0x2::table::contains<0x1::type_name::TypeName, u64>(&arg0.token_white_list, 0x1::type_name::with_defining_ids<T0>()) && 0x2::table::contains<0x1::type_name::TypeName, u64>(&arg0.token_white_list, 0x1::type_name::with_defining_ids<T1>()), 3);
        };
    }

    public fun checked_token_white_list_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::has_role(&arg0.acl, arg1, 0), 1);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                            : 0xc54683db9ee2ec07d896df5950bc69b95e28b3f734d0bb1230191100ea24da81::acl::new(arg0),
    ...
    public fun set_config_require_check_token_white_list(arg0: &mut AdminCap, arg1: &mut GlobalConfig, arg2: bool) {
        checked_package_version(arg1);
    ...
    public fun set_config_require_flash_loan_auth(arg0: &mut AdminCap, arg1: &mut GlobalConfig, arg2: bool) {
        checked_package_version(arg1);
    ...
    public fun update_min_trade_amount<T0>(arg0: &mut AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        checked_package_version(arg1);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun update_package_version(arg0: &mut AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
