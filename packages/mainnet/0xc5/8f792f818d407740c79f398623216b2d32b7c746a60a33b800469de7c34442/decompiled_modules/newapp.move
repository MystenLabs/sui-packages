module 0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::newapp {
    ...
    fun clac_level_diff(arg0: &mut Global_NetworkStatistics, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            let v4 = 0x2::table::borrow_mut<address, User>(arg1, 0x1::option::extract<address>(&mut v0));
            ...
            if (v5 > v2) {
                ...
                if (v4.underway_power > 0) {
                    let v7 = v4.total_static_power - v4.total_revenue;
                    let v8 = if (v7 > v6) {
                        v6
                    } else {
                        v7
                    ...
                    v4.total_revenue = v4.total_revenue + v8;
                    v4.daily_static_revenue = v4.daily_static_revenue + v8;
                    handler_out(arg0, v4);
                };
                v2 = v4.level;
                v3 = v4.inviter;
        ...
        if (0x1::option::is_some<address>(&v0) && 0x1::option::is_some<address>(&v3)) {
            let v9 = 0x2::table::borrow_mut<address, User>(arg1, 0x1::option::extract<address>(&mut v3));
            let v10 = arg3 * 2 / 100;
            if (v9.underway_power > 0) {
                let v11 = v9.total_static_power - v9.total_revenue;
                let v12 = if (v11 > v10) {
                    v10
                } else {
                    v11
                };
                v9.balance = v9.balance + v12;
                v9.total_revenue = v9.total_revenue + v12;
                v9.daily_static_revenue = v9.daily_static_revenue + v12;
                handler_out(arg0, v9);
            };
        };
    }
    ...
    public entry fun distribution<T0>(arg0: &mut Contract<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<address>(v1)) {
            let v4 = 0x2::table::borrow_mut<address, User>(v0, *0x1::vector::borrow<address>(v1, v2));
            if (v4.underway_power <= 0) {
                continue
            };
            let v5 = v4.underway_power / 500;
            let v6 = v4.dynamic_power / 500;
            if (v6 > 0) {
                v4.dynamic_power = v4.dynamic_power - v6;
            };
            let v7 = v5 + v6;
            let v8 = v4.total_static_power - v4.total_revenue;
            let v9 = if (v8 > v7) {
                v7
            } else {
                v8
            };
            v3.total_static_power_released = v3.total_static_power_released + v5;
            v3.total_dynamic_power_released = v3.total_dynamic_power_released + v6;
            v4.release_static_power = v4.release_static_power + v5;
            v4.release_dynamic_power = v4.release_dynamic_power + v6;
            v4.balance = v4.balance + v9;
            v4.total_revenue = v4.total_revenue + v9;
            v4.daily_static_revenue = v4.daily_static_revenue + v9;
            handler_out(v3, v4);
            v2 = v2 + 1;
        };
    }
    ...
    public entry fun extract_yy<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun init_contract<T0>(arg0: &Owner, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Global_NetworkStatistics{
        ...
        0x1::vector::push_back<address>(&mut v2.user_list, @0x5f5fdde75def86cf3449cd9f8e5b33d87d34bbd3080f892c1af185aec0bf3797);
        0x2::table::add<address, User>(&mut v2.users, @0x5f5fdde75def86cf3449cd9f8e5b33d87d34bbd3080f892c1af185aec0bf3797, v3);
    ...
    public entry fun purchase<T0, T1>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u8, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        v4.total_invested_amount = v4.total_invested_amount + arg3;
        v4.total_static_power_invested = v4.total_static_power_invested + v3;
        v4.total_asset_invested = v4.total_asset_invested + arg3;
        ...
        0x1::vector::push_back<Order>(&mut v2.orders, v7);
        update_dynamic_power(v4, v1, v0, arg3);
        update_performance(v1, v0, arg3);
        clac_level_diff(v4, v1, v0, arg3);
        0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::event::purchase_event(v0, arg3, v3, v5, v6);
    }
    ...
    public entry fun withdraw<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut arg0.global_network_statistics;
        v2.total_withdrawn_amount = v2.total_withdrawn_amount + arg1;
        let v3 = (v1 - v1 * (arg0.withdraw_ratio as u64) / 100) / 2;
        let v4 = &mut arg0.prize_pool;
        v4.level5_gross = v4.level5_gross + v3 * 50 / 100;
        v4.level6_gross = v4.level5_gross + v3 * 30 / 100;
        v4.level7_gross = v4.level5_gross + v3 * 20 / 100;
    }
