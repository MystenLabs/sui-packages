module 0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::typus_dov_single {
    ...
    public(friend) fun activate_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (v16 == 0 || 0x2::clock::timestamp_ms(arg3) >= v1.info.expiration_ts_ms) {
            v1.info.status = 4;
            let v19 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3);
            if (v19 > 0) {
                let (_, _) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::recoup<T0>(v3, v19, arg4);
            };
        } else {
            v1.info.status = 1;
        };
        let v22 = v1.info.settlement_base_name;
        let (v23, v24, v25) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000);
        0x1::string::append_utf8(&mut v22, b"-");
        0x1::string::append_utf8(&mut v22, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v25));
        0x1::string::append_utf8(&mut v22, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_month_short_string(v24));
        0x1::string::append_utf8(&mut v22, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v23));
        if (v1.info.period == 3) {
            0x1::string::append_utf8(&mut v22, b"-");
            0x1::string::append_utf8(&mut v22, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v22, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 3600000 / 60000));
        } else {
            0x1::vector::reverse<u64>(&mut v11);
            while (!0x1::vector::is_empty<u64>(&v11)) {
                0x1::string::append_utf8(&mut v22, b"-");
                0x1::string::append_utf8(&mut v22, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v11), v5));
            };
        };
        ...
        0x2::dynamic_object_field::add<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(&mut arg0.bid_vault_registry, arg1, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::new_bid_vault<T0, T1>(v1.info.index, v22, arg4));
        (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::activate<T0>(v3, v1.config.has_next, arg4), v16)
    }
    ...
    public(friend) fun fixed_incentivise_<T0>(arg0: &mut Registry, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64) : u64 {
        ...
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::update_deposit_vault_incentive_token<T0>(get_mut_deposit_vault(v2, arg1));
        ...
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 2, v4);
    ...
    public(friend) fun get_mut_bid_vault_by_id_or_index(arg0: &mut 0x2::object::UID, arg1: &0x2::object::ID, arg2: u64) : &mut 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault {
        if (0x2::dynamic_object_field::exists_with_type<address, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))) {
            0x2::dynamic_object_field::borrow_mut<address, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(arg0, 0x2::object::id_to_address(arg1))
        } else {
    ...
    public(friend) fun update_strike_(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock) : (u64, u64, VaultConfig) {
        ...
        if (v7.info.period == 3) {
            ...
            let (v30, v31, v32) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_date_from_ts(v7.info.expiration_ts_ms / 1000);
            0x1::string::append_utf8(&mut v29, b"-");
            0x1::string::append_utf8(&mut v29, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v32));
            0x1::string::append_utf8(&mut v29, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_month_short_string(v31));
            0x1::string::append_utf8(&mut v29, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v30));
            0x1::string::append_utf8(&mut v29, b"-");
            0x1::string::append_utf8(&mut v29, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v7.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v29, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v7.info.expiration_ts_ms % 3600000 / 60000));
            0x1::vector::reverse<u64>(&mut v8);
            while (!0x1::vector::is_empty<u64>(&v8)) {
                0x1::string::append_utf8(&mut v29, b"-");
                0x1::string::append_utf8(&mut v29, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v8), v1));
            };
            ...
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::update_bid_receipt_display(get_mut_bid_vault(v28, arg1), v29);
        };
        let v33 = v7.config.active_vault_config;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v33.u64_padding, 0, v7.info.round);
        (v0, v1, v33)
    }
