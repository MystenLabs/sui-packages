module 0xa709c8d2ac734a2441f968989a7cb347050bab01149ea628c74ee275fdab18d8::cnsnft4271 {
    struct CNSNFT4271 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4271, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4271>(arg0, arg1);
