module 0xa787193d3c84a1349a9b68bdf43cecb194780cc05c58dd33431096f1f9ddb95c::plhh {
    ...
    fun calculate_apy_rate_for_elapsed(arg0: &StakeInfo, arg1: u64) : u64 {
        ((((arg1 - arg0.start_epoch) as u128) * 1100 / (365 as u128)) as u64)
    }

    fun calculate_rewards(arg0: &StakeInfo, arg1: u64) : u64 {
        if (arg1 - arg0.last_claim_epoch == 0) {
            return 0
        };
        (((arg0.amount as u128) * ((calculate_apy_rate_for_elapsed(arg0, arg1) - calculate_apy_rate_for_elapsed(arg0, arg0.last_claim_epoch)) as u128) / 10000) as u64)
    }
