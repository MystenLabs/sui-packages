module 0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::alphafi_bluefin_sui_second_investor {
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: bool, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        let (v0, v1) = get_sqrt_price_limits<T0, T1>(arg4, arg6, arg7);
        let v2 = 0x2::coin::zero<T3>(arg9);
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T3>(arg4)) {
            0x2::coin::join<T3>(&mut v2, 0x2::coin::from_balance<T3>(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T3>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")), arg9));
        };
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, 0xdd5c4badc89f08fb2ff3c1827411c9bafbed54c64c17d8ab969f637364ca8b4f::blue::BLUE>(arg4)) {
            let v3 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, 0xdd5c4badc89f08fb2ff3c1827411c9bafbed54c64c17d8ab969f637364ca8b4f::blue::BLUE>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
            update_free_rewards<T0, T1, 0xdd5c4badc89f08fb2ff3c1827411c9bafbed54c64c17d8ab969f637364ca8b4f::blue::BLUE>(arg0, v3);
        };
        let v4 = 0x2::balance::zero<0x9753a815080c9a1a1727b4be9abb509014197e78ae09e33c146c786fac3731e0::bpoint::BPOINT>();
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, 0x9753a815080c9a1a1727b4be9abb509014197e78ae09e33c146c786fac3731e0::bpoint::BPOINT>(arg4)) {
            0x2::balance::join<0x9753a815080c9a1a1727b4be9abb509014197e78ae09e33c146c786fac3731e0::bpoint::BPOINT>(&mut v4, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, 0x9753a815080c9a1a1727b4be9abb509014197e78ae09e33c146c786fac3731e0::bpoint::BPOINT>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")));
        };
        update_free_rewards<T0, T1, 0x9753a815080c9a1a1727b4be9abb509014197e78ae09e33c146c786fac3731e0::bpoint::BPOINT>(arg0, v4);
        let v5 = 0x2::balance::zero<T2>();
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T2>()) == true) {
            0x2::balance::join<T2>(&mut v5, 0x2::balance::withdraw_all<T2>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut arg0.free_rewards, 0x1::type_name::get<T2>())));
        };
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T2>(arg4)) {
            0x2::balance::join<T2>(&mut v5, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T2>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")));
        };
        let v6 = 0x2::balance::value<T2>(&v5);
        if (v6 >= arg0.minimum_swap_amount) {
            let (v7, _) = get_sqrt_price_limits<T0, T1>(arg4, arg6, true);
            let (v9, v10) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T3>(arg8, arg2, arg5, v5, 0x2::balance::zero<T3>(), true, true, v6, 0, v7);
            0x2::balance::destroy_zero<T2>(v9);
            0x2::coin::join<T3>(&mut v2, 0x2::coin::from_balance<T3>(v10, arg9));
        } else {
            update_free_rewards<T0, T1, T2>(arg0, v5);
        };
        update_free_rewards<T0, T1, T3>(arg0, 0x2::coin::into_balance<T3>(v2));
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T0>(arg4)) {
            let v11 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
            update_free_rewards<T0, T1, T0>(arg0, v11);
        };
        let v12 = 0;
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T1>()) == true) {
            let v15 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.free_rewards, 0x1::type_name::get<T1>());
            v14 = (0x2::balance::value<T1>(v15) as u128) * (arg0.performance_fee as u128) / 10000;
            0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::balance::withdraw_all<T1>(v15));
        };
        let (_, _, v18, v19) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v20 = v19;
        let v21 = v18;
        let v22 = v12 + (0x2::balance::value<T0>(&v21) as u128) * (arg0.performance_fee as u128) / 10000;
        let v23 = v14 + (0x2::balance::value<T1>(&v20) as u128) * (arg0.performance_fee as u128) / 10000;
        0x2::balance::join<T0>(&mut v21, 0x2::balance::withdraw_all<T0>(&mut arg0.free_balance_a));
        0x2::balance::join<T1>(&mut v20, 0x2::balance::withdraw_all<T1>(&mut arg0.free_balance_b));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v21, (v22 as u64)), arg9), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v20, (v23 as u64)), arg9), 0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::get_fee_wallet_address(arg1));
        let (v24, v25) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v21, v20, arg4, arg6, v0, v1, arg7, arg8, arg9);
        let (_, v27, v28, v29) = get_balances_in_ratio<T0, T1>(arg0, v24, v25, arg4, true, arg9);
        let v30 = v28;
        let v31 = v27;
        if (0x2::balance::value<T0>(&v31) <= 100 && 0x2::balance::value<T1>(&v30) <= 100) {
            0x2::balance::join<T0>(&mut arg0.free_balance_a, 0x2::balance::withdraw_all<T0>(&mut v31));
            0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::balance::withdraw_all<T1>(&mut v30));
        };
        ...
        let v34 = AutoCompoundingEvent{
            ...
            compound_amount_a : 0x2::balance::value<T0>(&v31),
            compound_amount_b : 0x2::balance::value<T1>(&v30),
            total_amount_a    : v32,
            total_amount_b    : v33,
            ...
            fee_collected_a   : (v22 as u64),
            fee_collected_b   : (v23 as u64),
    ...
    fun get_sqrt_price_limits<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: bool) : (u128, u128) {
        if (arg2 == false) {
            let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T0, T1>(arg1);
            let v3 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg1);
            let v4 = if (v2 == 100) {
                v3 * 999749968 / 1000000000
            } else if (v2 == 10000) {
                v3 * 992471662 / 1000000000
            } else {
                v3 * 994987437 / 1000000000
            };
            let v5 = if (v2 == 100) {
                v3 * 1000249968 / 1000000000
            } else if (v2 == 10000) {
                v3 * 1007472083 / 1000000000
            } else {
                v3 * 1004987562 / 1000000000
            };
            (v4, v5)
        } else {
            let v6 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_fee_rate<T0, T1>(arg0);
            let v7 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg0);
            let v8 = if (v6 >= 100 && v6 <= 500) {
                v7 * 999499874 / 1000000000
            } else if (v6 > 500 && v6 <= 2500) {
                v7 * 997496867 / 1000000000
            } else {
                v7 * 992471662 / 1000000000
            };
            let v9 = if (v6 >= 100 && v6 <= 500) {
    ...
    public fun rebalance_v2<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::RebalanceCap, arg2: &0xeea4b39278f417d8320a581b34af2f312c505f89d94a9e74a16c0964cc5ba0d1::version::Version, arg3: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: u32, arg7: u32, arg8: u32, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg10: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg11: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg12: bool, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        let (v8, v9) = get_sqrt_price_limits<T0, T1>(arg9, arg10, arg12);
        ...
        while (v12 < arg8 + 1) {
            ...
            let (_, _, v15, v16) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg4, arg9, &mut v0, v10, arg13);
            let v17 = v16;
            let v18 = v15;
            ...
            let (v19, v20) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg4, arg5, v18, v17, arg9, arg10, v8, v9, arg12, arg13, arg14);
            let (_, v22, v23, v24) = get_balances_in_ratio<T0, T1>(arg0, v19, v20, arg9, true, arg14);
            let v25 = v23;
            let v26 = v22;
            if (0x2::balance::value<T0>(&v26) > 100 || 0x2::balance::value<T1>(&v25) > 100) {
                let (v27, v28) = if (0x2::balance::value<T0>(&v26) == 0 || v24 == false) {
                    let (v29, v30, v31, v32) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg13, arg4, arg9, &mut v1, v26, v25, 0x2::balance::value<T1>(&v25), false);
                    let _ = v30;
                    let _ = v29;
                    (v31, v32)
                } else {
                    let (v35, v36, v37, v38) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg13, arg4, arg9, &mut v1, v26, v25, 0x2::balance::value<T0>(&v26), true);
                    let _ = v36;
                    let _ = v35;
                    (v37, v38)
                };
        ...
        let (v39, v40, v41) = autocompound_internal<T0, T1, T2, T3>(arg0, arg3, arg4, arg5, arg9, arg11, arg10, arg12, arg13, arg14);
        let v42 = v40;
        let v43 = v39;
        ...
        if (0x2::balance::value<T0>(&v43) > 100 || 0x2::balance::value<T1>(&v42) > 100) {
            deposit<T0, T1>(arg0, arg4, arg9, v43, v42, v41, arg13);
        } else {
