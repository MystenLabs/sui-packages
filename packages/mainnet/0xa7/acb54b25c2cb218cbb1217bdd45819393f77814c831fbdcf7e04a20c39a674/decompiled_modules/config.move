module 0xa7acb54b25c2cb218cbb1217bdd45819393f77814c831fbdcf7e04a20c39a674::config {
    ...
    public(friend) fun emit_start_swap_event(arg0: address, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: vector<u8>) {
        let v0 = StartSwapEvent{
            sender           : arg0,
            from             : arg1,
            target           : arg2,
            amount_in        : arg3,
            amount_out_limit : arg4,
            provider         : 0x1::string::utf8(arg5),
        };
