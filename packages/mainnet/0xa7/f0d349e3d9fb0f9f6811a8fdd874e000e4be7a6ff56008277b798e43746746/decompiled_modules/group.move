module 0xa7f0d349e3d9fb0f9f6811a8fdd874e000e4be7a6ff56008277b798e43746746::group {
    ...
    entry fun create_private_group(arg0: vector<u8>, arg1: vector<address>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xa7f0d349e3d9fb0f9f6811a8fdd874e000e4be7a6ff56008277b798e43746746::events::emit_group_created(0x2::object::uid_to_inner(&v3.id), v0, v2, v1);
    ...
    entry fun send_group_message(arg0: &mut PrivateGroup, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0xa7f0d349e3d9fb0f9f6811a8fdd874e000e4be7a6ff56008277b798e43746746::events::emit_group_message_sent(0x2::object::uid_to_inner(&arg0.id), v0, 0x2::clock::timestamp_ms(arg2) / 1000);
    }
