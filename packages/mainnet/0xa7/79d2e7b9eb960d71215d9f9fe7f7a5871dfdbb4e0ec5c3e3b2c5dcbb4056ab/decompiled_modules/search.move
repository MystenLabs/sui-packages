module 0xc5baa691ecbed8575d4bff750b80791d638ce1d1a5cb1942d85d4f6e9b7e808c::search {
    ...
    public fun find_optimal_momentum<T0, T1>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u64, arg4: u64, arg5: u8, arg6: u8) : u64 {
        ...
        while (v4 < arg5) {
            ...
            let v5 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::compute_swap_result<T0, T1>(arg0, arg1, true, v0, v3);
            let v6 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_calculated(&v5);
            let v7 = v3 - 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_specified(&v5);
            if (v6 == 0 || v7 == 0) {
                break
            };
            if (!price_ok(effective_price(v7, v6, arg1), arg2, arg1)) {
        ...
        while (v4 < arg6) {
            ...
            let v8 = (v2 + v3) / 2;
            let v9 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::compute_swap_result<T0, T1>(arg0, arg1, true, v0, v8);
            let v10 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_calculated(&v9);
            let v11 = v8 - 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::get_state_amount_specified(&v9);
            if (v10 > 0 && v11 > 0) {
                if (price_ok(effective_price(v11, v10, arg1), arg2, arg1)) {
                    v1 = v11;
                    v2 = v8;
