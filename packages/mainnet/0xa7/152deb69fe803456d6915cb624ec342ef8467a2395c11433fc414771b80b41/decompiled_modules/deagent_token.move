module 0xa7152deb69fe803456d6915cb624ec342ef8467a2395c11433fc414771b80b41::deagent_token {
    ...
    fun init(arg0: DEAGENT_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<DEAGENT_TOKEN>>(0x2::coin::mint<DEAGENT_TOKEN>(&mut v2, 99500000000000000, arg1), 0x2::tx_context::sender(arg1));
