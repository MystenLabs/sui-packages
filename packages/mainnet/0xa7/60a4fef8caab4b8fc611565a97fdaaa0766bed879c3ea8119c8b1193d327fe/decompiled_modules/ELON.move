module 0xa760a4fef8caab4b8fc611565a97fdaaa0766bed879c3ea8119c8b1193d327fe::ELON {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ELON>(arg0, 9, b"DOG", b"Dog MILLIONS on SUI", b"Dog MILLIONS on SUI", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
