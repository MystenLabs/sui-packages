module 0xa71dcd60a02fa418655eea4cfe09d867742a8a171926727f7ab8ed2dcbe863f6::squidsquids {
    ...
    fun init(arg0: SQUIDSQUIDS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SQUIDSQUIDS>(arg0, 6, b"SQSQ", b"SQUIDSQUIDS", b"A Rogue Squid accidently Inked the prestine SUI code", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cdn.discordapp.com/attachments/1187159981830901760/1187160012088479744/Untitled_design_8.png")), arg1);
        let v2 = v0;
    ...
    public entry fun transfer_with_tax(arg0: &mut 0x2::coin::Coin<SQUIDSQUIDS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg1 * 3 / 100;
        let v1 = arg1 - v0;
        0xa71dcd60a02fa418655eea4cfe09d867742a8a171926727f7ab8ed2dcbe863f6::events::emit_transfer_event(0x2::tx_context::sender(arg3), arg2, v1, v0, 0x2::tx_context::epoch(arg3));
