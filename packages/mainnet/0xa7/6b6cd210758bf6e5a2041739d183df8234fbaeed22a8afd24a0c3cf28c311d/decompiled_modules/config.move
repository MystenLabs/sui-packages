module 0xbc33614900f37a4560cee4330963558bf7731b236a37a6a3c4c3064f9e89c4d::config {
    ...
    public(friend) fun create_config(arg0: &CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Config{
            ...
            version      : 1,
            aftermath_pk : x"00a2dd303755bfc8cea9dc446a642941f74d9880bc6337ede21c115c701ab2fb2f",
        };
    ...
    fun init(arg0: CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0xbc33614900f37a4560cee4330963558bf7731b236a37a6a3c4c3064f9e89c4d::admin::AdminCap>(0xbc33614900f37a4560cee4330963558bf7731b236a37a6a3c4c3064f9e89c4d::admin::create_admin_cap<CONFIG>(&arg0, arg1), v0);
        0x2::transfer::public_transfer<0x2::package::Publisher>(0x2::package::claim<CONFIG>(arg0, arg1), v0);
    }

    public fun update_aftermath_pk(arg0: &0xbc33614900f37a4560cee4330963558bf7731b236a37a6a3c4c3064f9e89c4d::admin::AdminCap, arg1: &mut Config, arg2: vector<u8>) {
        assert_interacting_with_most_up_to_date_package(arg1);
        0xbc33614900f37a4560cee4330963558bf7731b236a37a6a3c4c3064f9e89c4d::events::emit_updated_aftermath_pk_event(arg1.aftermath_pk, arg2);
