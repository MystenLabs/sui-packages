module 0xa7e66baca4aeeca4cf7f096e4b075c6cefcc87639501348eec255d31a87a015a::sensui_nft {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = NFTMintData{
            ...
            nft_minted       : 0,
            max_supply       : 60,
            owner_event      : @0xdaa9cbcd5d31e7d6c7ec555ef52e873bbb788585f2ee2584da649cb758a0996d,
            has_paused       : false,
            is_resume        : false,
            time_start_event : 0,
    ...
    public entry fun mint_to_sender(arg0: &mut NFTMintData, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        let v4 = 0;
        if (arg0.nft_minted <= 20 && v1 / 3600 - arg0.time_start_event / 3600 <= 2 && !arg0.is_resume) {
            if (arg5 >= 1 && arg5 <= 6) {
                v2 = 1200000;
            } else if (arg5 >= 7) {
                v2 = 1000000;
    ...
    public entry fun set_max_supply(arg0: &mut NFTMintData, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.owner_event || v0 == @0x6f48615e72481747d4bd88f6dea9e9643199804b3eba4a432f801750c170b6d4, 104);
        arg0.max_supply = arg0.max_supply + arg1;
    }
