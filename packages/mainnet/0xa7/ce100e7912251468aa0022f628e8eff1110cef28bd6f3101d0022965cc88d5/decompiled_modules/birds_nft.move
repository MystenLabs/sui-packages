module 0xa7ce100e7912251468aa0022f628e8eff1110cef28bd6f3101d0022965cc88d5::birds_nft {
    ...
    public fun buy(arg0: &mut BirdConfig, arg1: &mut SaleConfig, arg2: u16, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : BirdNFT {
        assert!(arg0.version == 1, 1002);
        ...
        let v6 = ((v0 % (arg0.total_sub_type as u64)) as u8);
        let v7 = ((v0 % (arg0.total_gen_id as u64)) as u16);
        let v8 = BirdNFT{
    ...
    public fun info(arg0: &BirdNFT) : (u64, u16, u8) {
