module 0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::pool_rewards {
    ...
    struct StakedNFT has store, key {
        id: 0x2::object::UID,
        nft: 0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT,
        owner: address,
        pool_id: 0x2::object::ID,
        stake_time: u64,
        weight: u64,
    ...
    fun calculate_total_current_weight(arg0: &Pool, arg1: u64) : u64 {
        ...
        while (v2 < 0x1::vector::length<0x2::object::ID>(&arg0.staked_nft_ids)) {
            ...
            if (0x2::object_table::contains<0x2::object::ID, StakedNFT>(&arg0.staked_nfts, v3)) {
                let v4 = (v0 - 0x2::object_table::borrow<0x2::object::ID, StakedNFT>(&arg0.staked_nfts, v3).stake_time) / 3600000;
                let v5 = if (v4 == 0) {
                    1
                } else {
                    v4
    ...
    fun check_nft_has_all_required_elements(arg0: &0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT, arg1: &vector<u64>) : bool {
    ...
    public fun delete_pool(arg0: &PoolAdminCap, arg1: &mut PoolSystem, arg2: 0x2::object::ID, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<0x2::object::ID>(&v0.staked_nft_ids)) {
            ...
            if (0x2::object_table::contains<0x2::object::ID, StakedNFT>(&v0.staked_nfts, v3)) {
                ...
                0x2::transfer::public_transfer<0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT>(v6, v4.owner);
            };
            v2 = v2 + 1;
        };
        let Pool {
    ...
    fun extract_nft_element_ids(arg0: &0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT) : vector<u64> {
        0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::get_all_item_ids(arg0)
    }
    ...
    public fun get_reward_update_interval(arg0: &PoolSystem) : u64 {
        arg0.global_config.reward_update_interval
    }
    ...
    public fun get_user_reward_details(arg0: &PoolSystem, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64, bool, u64, u64) {
        ...
        (v2.nft_count, v5, v2.pending_sui_rewards, v6, v7 >= arg0.global_config.claim_time_interval, v3, v7)
    }
    ...
    fun init(arg0: POOL_REWARDS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            reward_update_interval : 21600000,
            claim_time_interval    : 86400000,
        };
        let v2 = PoolSystem{
    ...
    public fun stake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        assert!(v0.is_active, 2);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        ...
        let v3 = 0x2::object::id<0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT>(&arg2);
        let v4 = 1;
        let v5 = StakedNFT{
    ...
    public fun time_until_next_reward_update(arg0: &PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v1 = arg0.global_config.reward_update_interval;
        if (v0 >= v1) {
            0
        } else {
            v1 - v0
    ...
    public fun unstake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3 - v0.last_reward_update < arg0.global_config.reward_update_interval;
        v0.total_staked_count = v0.total_staked_count - 1;
        ...
        0x2::transfer::public_transfer<0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT>(v7, v1);
        let v14 = NFTUnstaked{
            pool_id           : arg1,
            nft_id            : arg2,
            owner             : v1,
    ...
    public fun update_pool_rewards(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        let v1 = 0x2::clock::timestamp_ms(arg2);
        assert!(v1 - v0.last_reward_update >= arg0.global_config.reward_update_interval, 9);
    ...
    public fun update_reward_update_interval(arg0: &PoolAdminCap, arg1: &mut PoolSystem, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.global_config.reward_update_interval = arg2;
    }

    fun validate_nft_requirements(arg0: &Pool, arg1: &0xa7bfdc878c9186eec818a4a785cdc705cd46e24be7e7c6325540d5fb3b9193d6::creature_nft::CreatureNFT) {
