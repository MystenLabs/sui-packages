module 0xa7843ac3e1b397208aa0908e1bc434e739b6ccb205ba14a382144bd358c0540a::reward2968 {
    struct REWARD2968 has drop {
        dummy_field: bool,
    }

    struct TICKET_2968 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2968(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2968>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2968>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2968, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2968>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2968>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2968>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2968>>(v5, 0x2::tx_context::sender(arg1));
    }
