module 0xa7be0d1c259c75546753a3ae416237ab93e5f51faf13fe87ddf7187b8502deb4::cnsnft3272 {
    struct CNSNFT3272 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3272, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3272>(arg0, arg1);
