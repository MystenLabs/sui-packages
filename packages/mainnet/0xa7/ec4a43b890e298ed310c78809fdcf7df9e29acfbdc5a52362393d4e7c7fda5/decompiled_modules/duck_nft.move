module 0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::duck_nft {
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::burn(arg8, 0x2::coin::split<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>>(0x2::coin::split<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>>(0x2::coin::split<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0xa7ec4a43b890e298ed310c78809fdcf7df9e29acfbdc5a52362393d4e7c7fda5::shttoken::SHTTOKEN>(arg12);
        };
