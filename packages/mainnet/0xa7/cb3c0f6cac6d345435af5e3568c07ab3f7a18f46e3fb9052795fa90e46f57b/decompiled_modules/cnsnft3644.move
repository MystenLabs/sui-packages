module 0xa7cb3c0f6cac6d345435af5e3568c07ab3f7a18f46e3fb9052795fa90e46f57b::cnsnft3644 {
    struct CNSNFT3644 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3644, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3644>(arg0, arg1);
