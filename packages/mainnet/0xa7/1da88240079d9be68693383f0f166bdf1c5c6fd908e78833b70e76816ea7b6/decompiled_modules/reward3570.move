module 0xa71da88240079d9be68693383f0f166bdf1c5c6fd908e78833b70e76816ea7b6::reward3570 {
    struct REWARD3570 has drop {
        dummy_field: bool,
    }

    struct TICKET_3570 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3570(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3570>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3570>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3570, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3570>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3570>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3570>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3570>>(v5, 0x2::tx_context::sender(arg1));
    }
