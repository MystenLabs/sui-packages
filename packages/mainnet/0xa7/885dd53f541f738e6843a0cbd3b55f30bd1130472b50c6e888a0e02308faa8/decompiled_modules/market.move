module 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::market {
    ...
    public fun list(arg0: &mut Global, arg1: 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(arg1, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun list_v2(arg0: &mut Global, arg1: &mut 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Global, arg2: 0x1::string::String, arg3: vector<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(&arg3)) {
            0x2::transfer::public_transfer<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(0x1::vector::pop_back<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(&mut arg3), 0x2::tx_context::sender(arg5));
        };
        0x1::vector::destroy_empty<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(arg3);
    }
    ...
    public fun list_v3(arg0: &mut Global, arg1: &mut 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Global, arg2: 0x1::string::String, arg3: vector<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(&arg3)) {
            0x2::transfer::public_transfer<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(0x1::vector::pop_back<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(&mut arg3), 0x2::tx_context::sender(arg6));
        };
        0x1::vector::destroy_empty<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(arg3);
    }

    public fun list_v4(arg0: &mut Global, arg1: &mut 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Global, arg2: 0x1::string::String, arg3: vector<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        only_allowed_version(arg0);
        only_not_paused(arg0);
        assert!(arg6 >= 100, 1006);
        assert!(arg4 > 0, 1005);
        let v0 = 0x2::tx_context::sender(arg7);
        let (v1, v2, v3, v4) = 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::merge_v2(arg1, arg2, arg3, arg6, arg7);
        assert!(arg6 > 0, 1006);
        assert!(v3 >= arg6, 1010);
        if (v4 > 0) {
            0x2::transfer::public_transfer<0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::Sui20>(v2, v0);
        } else {
            0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20::destroy_zero(v2);
        };
    ...
    public fun withdraw_fee_amount(arg0: &mut Global, arg1: &mut AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.fee, arg2), arg3), 0x2::tx_context::sender(arg3));
    }
