module 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault {
    ...
    public fun deposit_dual_token<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: address, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock, arg16: &AccessCap, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::utils::verify_signature(get_signers(arg0), 1, v2, arg8, arg9);
        if (!arg5) {
    ...
    public entry fun move_token_to_withdraw_assets<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x1::type_name::into_string(0x1::type_name::get<T0>())) {
            ...
            let v2 = arg2.available_liquidity - (arg3 as u128);
            arg2.available_liquidity = arg2.available_liquidity - (arg3 as u128);
            let v3 = 0x2::coin::split<T0>(v1, arg3, arg4);
            let v4 = get_dynamic_field_or_default<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", 0x1::vector::empty<0x1::ascii::String>());
            if (!0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"withdraw_assets")) {
                0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", 0x2::bag::new(arg4));
            };
            let v5 = 0x2::dynamic_field::remove<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets");
            if (0x2::bag::contains<0x1::ascii::String>(&v5, v0)) {
                increase_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T0>(&v3) as u128), arg4);
                0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut v5, v0), v3);
            } else {
                add_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T0>(&v3) as u128), arg4);
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut v5, v0, v3);
                0x1::vector::push_back<0x1::ascii::String>(&mut v4, v0);
            };
            0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", v5);
            set_dynamic_field<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", v4);
            add_table_vault_asset<T0, T1>(arg2, v0, v2, arg4);
            let v6 = MoveTokenToWithdrawAssetEvent{
                amount   : arg3,
                vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
                token    : v0,
            };
            0x2::event::emit<MoveTokenToWithdrawAssetEvent>(v6);
        } else {
            assert!(0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0), 22);
            let v7 = 0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0);
            assert!(0x2::coin::value<T2>(v7) >= arg3, 2);
            let v8 = 0x2::coin::split<T2>(v7, arg3, arg4);
            if (0x2::coin::value<T2>(v7) == 0) {
                add_table_vault_asset<T0, T1>(arg2, v0, 0, arg4);
                0x2::coin::destroy_zero<T2>(0x2::bag::remove<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0));
                let (v9, v10) = 0x1::vector::index_of<0x1::ascii::String>(&arg2.harvest_asset_keys, &v0);
                if (v9) {
                    0x1::vector::swap_remove<0x1::ascii::String>(&mut arg2.harvest_asset_keys, v10);
                };
            } else {
                add_table_vault_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(v7) as u128), arg4);
            };
            let v11 = get_dynamic_field_or_default<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", 0x1::vector::empty<0x1::ascii::String>());
            if (!0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"withdraw_assets")) {
                0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", 0x2::bag::new(arg4));
            };
            let v12 = 0x2::dynamic_field::remove<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets");
            if (0x2::bag::contains<0x1::ascii::String>(&v12, v0)) {
                increase_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v8) as u128), arg4);
                0x2::coin::join<T2>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut v12, v0), v8);
            } else {
                add_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v8) as u128), arg4);
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut v12, v0, v8);
                0x1::vector::push_back<0x1::ascii::String>(&mut v11, v0);
            };
            0x2::dynamic_field::add<vector<u8>, 0x2::bag::Bag>(&mut arg2.id, b"withdraw_assets", v12);
            set_dynamic_field<T0, T1, vector<0x1::ascii::String>>(arg2, b"withdraw_asset_keys", v11);
            let v13 = MoveTokenToWithdrawAssetEvent{
                amount   : arg3,
                vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
                token    : v0,
            };
            0x2::event::emit<MoveTokenToWithdrawAssetEvent>(v13);
        };
    }
    ...
    fun redeem_dual_token_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<vector<0x1::ascii::String>>, arg4: vector<u64>, arg5: vector<vector<u64>>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        ...
        0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::utils::verify_signature(get_signers(arg0), 1, v1, arg8, arg9);
    ...
    public(friend) fun redeem_internal<T0, T1>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: u64, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::utils::verify_signature(get_signers(arg0), 1, v1, arg6, arg7);
        assert!(0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, arg2), 7);
        let v3 = 0x2::table::remove<address, vector<PendingRedeem>>(&mut arg1.pending_redeems, arg2);
        let v4 = 0x1::vector::empty<PendingRedeem>();
        let v5 = 0x1::vector::empty<PendingRedeem>();
    ...
    public(friend) fun redeem_token_internal<T0, T1, T2>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: address, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        while (v14 < v10) {
            ...
            assert!(v15.amount >= *v19, 21);
            v11 = v11 + *v18;
            v12 = v12 + v15.amount;
            v13 = v13 + *v19;
            v14 = v14 + 1;
        };
        let v20 = get_dynamic_field_or_default<T0, T1, u64>(arg1, b"hwm", (arg1.liquidity as u64));
        let v21 = if (v20 >= v13) {
            v20 - v13
        } else {
            0
        };
        set_dynamic_field<T0, T1, u64>(arg1, b"hwm", v21);
        arg1.pending_redemptions = arg1.pending_redemptions - (v12 as u128);
        ...
        if (v12 > v13) {
            arg1.liquidity = arg1.liquidity + (v12 as u128) - (v13 as u128);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v22, v23, arg11), arg1.fee_receiver);
        let v24 = get_dynamic_field_or_default<T0, T1, u128>(arg1, b"total_withdraw", 0) + (v13 as u128);
        set_dynamic_field<T0, T1, u128>(arg1, b"total_withdraw", v24);
    ...
    public entry fun withdraw_dual_token<T0, T1, T2, T3>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::utils::verify_signature(get_signers(arg0), 1, v3, arg8, arg9);
        if (!arg5) {
            add_profit_internal<T0, T1>(arg1, arg4, arg3, arg7, arg10);
        } else {
            credit_loss_internal<T0, T1>(arg1, arg4, arg7, arg10);
