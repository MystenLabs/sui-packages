module 0xa70556ec7238aa85758bb718feb4251e46306a82315f2947d419ea94139ecefb::stonker {
    ...
    fun adjust_maker_orders(arg0: &Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::tx_context::TxContext) {
        ...
        while (v16 < 0x1::vector::length<u128>(&v7)) {
            ...
            v16 = v16 + 1;
            assert!(v17 != 0, 13906837739166236671);
            if (order_is_bid(v17)) {
                if (v13 == 0) {
                    v14 = v17;
                    continue
    ...
    fun check_sender(arg0: &Stonker, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834629609914367);
    }
    ...
    public fun test_transaction(arg0: &mut Stonker, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2::tx_context::TxContext) {
        check_sender(arg0, arg3);
        let v0 = TopUpEvent{gas_coin_value_before: 0x2::coin::value<0x2::sui::SUI>(arg1)};
        0x2::event::emit<TopUpEvent>(v0);
        if (0x2::coin::value<0x2::sui::SUI>(arg1) < 1 * 1000000000) {
            0x2::coin::join<0x2::sui::SUI>(arg1, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::withdraw<0x2::sui::SUI>(arg2, 2 * 1000000000 - 0x2::coin::value<0x2::sui::SUI>(arg1), arg3));
        };
    }
