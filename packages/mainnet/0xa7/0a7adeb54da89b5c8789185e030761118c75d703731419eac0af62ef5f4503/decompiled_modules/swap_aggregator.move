module 0xa70a7adeb54da89b5c8789185e030761118c75d703731419eac0af62ef5f4503::swap_aggregator {
    struct TimeEvent has copy, drop {
        timestamp_ms: u64,
    }

    public entry fun swap(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: bool, arg2: bool, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = TimeEvent{timestamp_ms: 0x2::clock::timestamp_ms(arg5)};
