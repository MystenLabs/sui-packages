module 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::alpha_router {
    ...
    struct MemeboxManager has key {
        ...
        usdc_vault_admin_cap: 0x1::option::Option<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>,
        meme_vault_admin_cap: 0x1::option::Option<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>,
    }
    ...
    fun after_execute<T0>(arg0: &MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: u8, arg6: 0x2::coin::Coin<T0>, arg7: &0x2::tx_context::TxContext) {
        ...
        let v2 = borrow_mut_trade_receipt(arg1, arg3, arg4);
        let v3 = TradeStep{
            dex    : arg5,
            coin   : v1,
            amount : v0,
        };
        0x1::vector::push_back<TradeStep>(&mut v2.steps, v3);
        v2.to = v1;
        v2.to_amount = v0;
        store_intermediate_coin<T0>(arg1, arg6);
    }

    public entry fun approve(arg0: &mut MemeboxManager, arg1: &SuperAdminCap, arg2: &0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::USDCVault, arg3: &0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::SuperAdminCap, arg4: &0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::VaultManager, arg5: &0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::SuperAdminCap, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::option::is_none<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap) && 0x1::option::is_none<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap), 11);
        verify_super_admin_cap(arg0, arg1);
        0x1::option::fill<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>(&mut arg0.usdc_vault_admin_cap, 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::create_admin_cap(arg2, arg3, arg6));
        0x1::option::fill<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>(&mut arg0.meme_vault_admin_cap, 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::create_admin_cap(arg4, arg5, arg6));
    }
    ...
    fun create_manager(arg0: &mut 0x2::tx_context::TxContext) : (MemeboxManager, SuperAdminCap) {
        ...
        let v1 = MemeboxManager{
            ...
            usdc_vault_admin_cap    : 0x1::option::none<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>(),
            meme_vault_admin_cap    : 0x1::option::none<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>(),
        };
    ...
    fun create_trade_receipt(arg0: &mut IntermediateStorage, arg1: 0x1::string::String, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &0x2::tx_context::TxContext) : u64 {
        ...
        0x1::vector::push_back<TradeReceipt>(&mut 0x2::table::borrow_mut<0x1::string::String, TradeData>(&mut arg0.trade_data, arg1).receipts, v1);
        v0
    }
    ...
    public entry fun end_trade<T0, T1>(arg0: &MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: &mut 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::USDCVault, arg4: &mut 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::VaultManager, arg5: 0x1::string::String, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<IntermediateStorage>(arg1) == arg0.intermediate_storage_id, 1);
        verify_admin_permission(arg0, arg2, 0x2::tx_context::sender(arg7));
        assert!(0x1::option::is_some<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap) && 0x1::option::is_some<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap), 12);
        ...
        0x2::event::emit<Traded>(v1);
        let v2 = 0x1::option::borrow<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap);
        let v3 = 0x1::option::borrow<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap);
        if (is_usdc<T1>()) {
            let v4 = extract_intermediate_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1, v0.to_amount, arg7);
            0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::deposit_with_admin(arg3, v2, v4, arg7);
        } else {
            let v5 = extract_intermediate_coin<T1>(arg1, v0.to_amount, arg7);
            0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::deposit_with_admin<T1>(arg4, v3, v5, arg7);
        };
    ...
    public entry fun execute_bluefin_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg10: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::bluefin_wrapper::swap_a2b<T0, T1>(arg7, arg8, arg9, v1, arg10);
            ...
            let v4 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::bluefin_wrapper::swap_b2a<T0, T1>(arg7, arg8, arg9, v3, arg10);
    ...
    public entry fun execute_cetus_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg9: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::cetus_wrapper::swap_a2b<T0, T1>(arg7, arg8, arg9, v1, arg10, arg11);
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, 1, v2, arg11);
            0x2::coin::value<T1>(&v2)
        } else {
            let v3 = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, 1, arg6, arg11);
            let v4 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::cetus_wrapper::swap_b2a<T0, T1>(arg7, arg8, arg9, v3, arg10, arg11);
    ...
    public entry fun execute_flowx_v3_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool_manager::PoolRegistry, arg8: u64, arg9: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::versioned::Versioned, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::flowx_v3_wrapper::swap_a2b<T0, T1>(arg7, arg8, v1, arg9, arg10, arg11);
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, 3, v2, arg11);
            0x2::coin::value<T1>(&v2)
        } else {
            let v3 = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, 3, arg6, arg11);
            let v4 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::flowx_v3_wrapper::swap_b2a<T0, T1>(arg7, arg8, v3, arg9, arg10, arg11);
    ...
    public entry fun execute_turbos_swap<T0, T1, T2>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: 0x1::string::String, arg4: u64, arg5: bool, arg6: u64, arg7: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: &mut 0x2::tx_context::TxContext) : u64 {
        if (arg5) {
            ...
            let v2 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::turbos_wrapper::swap_a2b<T0, T1, T2>(arg7, v1, arg8, arg9, arg10);
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, 2, v2, arg10);
            0x2::coin::value<T1>(&v2)
        } else {
            let v3 = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, 2, arg6, arg10);
            let v4 = 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::turbos_wrapper::swap_b2a<T0, T1, T2>(arg7, v3, arg8, arg9, arg10);
    ...
    public entry fun start_trade<T0, T1>(arg0: &MemeboxManager, arg1: &mut IntermediateStorage, arg2: &AdminCap, arg3: &mut 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::USDCVault, arg4: &mut 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::VaultManager, arg5: 0x1::string::String, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<IntermediateStorage>(arg1) == arg0.intermediate_storage_id, 1);
        verify_admin_permission(arg0, arg2, 0x2::tx_context::sender(arg7));
        assert!(0x1::option::is_some<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap) && 0x1::option::is_some<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap), 12);
        ...
        let v1 = 0x1::option::borrow<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::AdminCap>(&arg0.usdc_vault_admin_cap);
        let v2 = 0x1::option::borrow<0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::AdminCap>(&arg0.meme_vault_admin_cap);
        if (is_usdc<T0>()) {
            store_intermediate_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1, 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::usdc_vault::withdraw_with_admin(arg3, v1, arg6, arg7));
        } else {
            store_intermediate_coin<T0>(arg1, 0xa7e967372cc2efa856cef51b6e5c6eba4e85c7cc9bb093e2418a58f401d2f80f::meme_vault::withdraw_with_admin<T0>(arg4, v2, arg6, arg7));
        };
    }
