module 0xa7438330570923dd49343cc31fb46d8e50814cc105cfc2a1c3860f2775b17580::cnsnft4926 {
    struct CNSNFT4926 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4926, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4926>(arg0, arg1);
