module 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::dextrader_bluefin {
    ...
    struct State has key {
        ...
        oracles: 0x2::table::Table<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>,
        oracle_staleness_threshold: u64,
        oracle_tolerance_bps: u64,
    }
    ...
    public(friend) fun check_pool_prices(arg0: &State, arg1: 0x2::object::ID, arg2: bool, arg3: u128, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock) {
        ...
        if (arg2) {
            assert!(0x1::u256::pow((arg3 as u256), 2) >= 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::get_oracle_price_x128(0x2::table::borrow<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>(&arg0.oracles, arg1), arg4, arg0.oracle_staleness_threshold, arg5) * ((10000 - arg0.oracle_tolerance_bps) as u256) / 10000, 121);
        } else {
            assert!(0x1::u256::pow((arg3 as u256), 2) <= 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::get_oracle_price_x128(0x2::table::borrow<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>(&arg0.oracles, arg1), arg4, arg0.oracle_staleness_threshold, arg5) * ((10000 + arg0.oracle_tolerance_bps) as u256) / 10000, 121);
        };
    }
    ...
    public(friend) fun check_pool_ticks<T0, T1>(arg0: &State, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock) {
        ...
        let v2 = 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::get_oracle_price_x128(0x2::table::borrow<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>(&arg0.oracles, v0), arg4, arg0.oracle_staleness_threshold, arg5);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = State{
            ...
            oracles                    : 0x2::table::new<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>(arg0),
    ...
    entry fun set_price_oracle<T0, T1>(arg0: &mut State, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: vector<u8>, arg3: u8, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: bool, arg7: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg1);
        if (0x2::table::contains<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>(&arg0.oracles, v0)) {
            0x2::table::remove<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>(&mut arg0.oracles, v0);
        };
        0x2::table::add<0x2::object::ID, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::OracleConfig>(&mut arg0.oracles, v0, 0xa71fd53c1b2b172efe0e1c51276d451c3c1440d7c781afe1ed265131de940384::pyth_oracle::create_oracle_config(arg2, arg3, 0x2::coin::get_decimals<T0>(arg4), 0x2::coin::get_decimals<T1>(arg5), arg6));
