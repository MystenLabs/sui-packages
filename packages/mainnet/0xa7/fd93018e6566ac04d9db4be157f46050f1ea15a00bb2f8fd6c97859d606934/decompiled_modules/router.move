module 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::router {
    struct SwapContext {
    ...
    public fun confirm_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v12 >= v5, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::amount_out_slippage_check_failed());
        assert!(v12 > 0, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::zero_amount_out());
        assert!(0x2::bag::is_empty(&v10), 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::remains_balance());
    ...
    public fun new_swap_context<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::fee::FeeConfig, arg5: &mut 0x2::tx_context::TxContext) : SwapContext {
        0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::fee::assert_valid_version(arg4);
        let v0 = 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::fee::fee_rate(arg4);
        let v1 = 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::fee::fee_recipient(arg4);
        let v2 = 0x2::coin::value<T0>(&arg3);
        assert!(v2 > 0, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::amount_in_is_zero());
        if (v0 > 0) {
            assert!(v1 != @0x0, 0x27f0a2dd036967aed0ffc395ce040b3f2a84b6e56b466500af3670aaf99c3ec4::errors::invalid_fee_recipient());
        };
