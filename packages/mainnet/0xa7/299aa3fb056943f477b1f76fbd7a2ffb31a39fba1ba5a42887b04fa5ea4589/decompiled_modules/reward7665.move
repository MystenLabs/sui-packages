module 0xa7299aa3fb056943f477b1f76fbd7a2ffb31a39fba1ba5a42887b04fa5ea4589::reward7665 {
    struct REWARD7665 has drop {
        dummy_field: bool,
    }

    struct TICKET_7665 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7665(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7665>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7665>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7665, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7665>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7665>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7665>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7665>>(v5, 0x2::tx_context::sender(arg1));
    }
