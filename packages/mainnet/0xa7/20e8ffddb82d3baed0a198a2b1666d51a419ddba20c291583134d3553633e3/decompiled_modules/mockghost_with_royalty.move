module 0xa720e8ffddb82d3baed0a198a2b1666d51a419ddba20c291583134d3553633e3::mockghost_with_royalty {
    ...
    fun init(arg0: MOCKGHOST_WITH_ROYALTY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = &mut v9;
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R]1"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R]2"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R]3"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R]4"));
        0x1::vector::push_back<0x1::string::String>(v10, 0x1::string::utf8(b"Ghost[R]5"));
