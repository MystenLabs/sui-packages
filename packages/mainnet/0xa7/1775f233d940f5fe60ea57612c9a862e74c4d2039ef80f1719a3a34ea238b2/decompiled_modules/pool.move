module 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::pool {
    ...
    struct PrivacyPool<phantom T0> has store, key {
        ...
        merkle_tree: 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::MerkleTree,
        nullifiers: 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::NullifierRegistry,
        vk_bytes: vector<u8>,
    ...
    public fun swap<T0, T1>(arg0: &mut PrivacyPool<T0>, arg1: &mut PrivacyPool<T1>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::is_spent(&arg0.nullifiers, v3), 1);
        assert!(!0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::is_spent(&arg0.nullifiers, v4), 1);
        ...
        assert!(arg5 >= arg6, 7);
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::mark_spent(&mut arg0.nullifiers, v3);
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::mark_spent(&mut arg0.nullifiers, v4);
        save_historical_root<T0>(arg0);
        save_historical_root<T1>(arg1);
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::insert(&mut arg1.merkle_tree, v6);
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::insert(&mut arg0.merkle_tree, v7);
        ...
        let v16 = SwapEvent{
            ...
            output_position       : 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_next_index(&arg1.merkle_tree),
            change_position       : 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_next_index(&arg0.merkle_tree),
            amount_in             : arg5,
            amount_out            : arg5,
    ...
    public fun transfer<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<vector<u8>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::is_spent(&arg0.nullifiers, v0), 1);
        assert!(!0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::is_spent(&arg0.nullifiers, v8), 1);
        let v9 = 0x2::groth16::bn254();
        ...
        assert!(0x2::groth16::verify_groth16_proof(&v13, &v10, &v11, &v12), 2);
        let v14 = 0x1::vector::empty<vector<u8>>();
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::mark_spent(&mut arg0.nullifiers, v0);
        0x1::vector::push_back<vector<u8>>(&mut v14, v0);
        if (!is_zero_commitment(&v8)) {
            0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::mark_spent(&mut arg0.nullifiers, v8);
        ...
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::insert(&mut arg0.merkle_tree, v2);
        0x1::vector::push_back<vector<u8>>(&mut v15, *0x1::vector::borrow<vector<u8>>(&arg3, 0));
        0x1::vector::push_back<vector<u8>>(&mut v16, v2);
        0x1::vector::push_back<u64>(&mut v17, 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_next_index(&arg0.merkle_tree));
    ...
    fun create_pool<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : PrivacyPool<T0> {
        PrivacyPool<T0>{
            ...
            merkle_tree       : 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::new(arg3),
            nullifiers        : 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::new(arg3),
            vk_bytes          : arg0,
    ...
    public fun get_merkle_root<T0>(arg0: &PrivacyPool<T0>) : vector<u8> {
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_root(&arg0.merkle_tree)
    }

    public fun get_note_count<T0>(arg0: &PrivacyPool<T0>) : u64 {
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_next_index(&arg0.merkle_tree)
    }

    public fun is_nullifier_spent<T0>(arg0: &PrivacyPool<T0>, arg1: vector<u8>) : bool {
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::is_spent(&arg0.nullifiers, arg1)
    }

    fun is_valid_root<T0>(arg0: &PrivacyPool<T0>, arg1: &vector<u8>) : bool {
        if (*arg1 == 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_root(&arg0.merkle_tree)) {
            return true
        };
        let v0 = 0;
    ...
    fun save_historical_root<T0>(arg0: &mut PrivacyPool<T0>) {
        0x1::vector::push_back<vector<u8>>(&mut arg0.historical_roots, 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_root(&arg0.merkle_tree));
    ...
    public fun shield<T0>(arg0: &mut PrivacyPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::insert(&mut arg0.merkle_tree, arg2);
        let v0 = ShieldEvent{
            pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
            position       : 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_next_index(&arg0.merkle_tree),
            commitment     : arg2,
            encrypted_note : arg3,
        };
    ...
    public fun unshield<T0>(arg0: &mut PrivacyPool<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: address, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_valid_root<T0>(arg0, &v6), 3);
        assert!(!0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::is_spent(&arg0.nullifiers, v1), 1);
        ...
        0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::nullifier::mark_spent(&mut arg0.nullifiers, v1);
        ...
        if (!is_zero_commitment(&v4)) {
            save_historical_root<T0>(arg0);
            let v14 = 0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::get_next_index(&arg0.merkle_tree);
            v13 = v14;
            0xa71775f233d940f5fe60ea57612c9a862e74c4d2039ef80f1719a3a34ea238b2::merkle_tree::insert(&mut arg0.merkle_tree, v4);
            let v15 = ShieldEvent{
                pool_id        : 0x2::object::id<PrivacyPool<T0>>(arg0),
                position       : v14,
                commitment     : v4,
