module 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::off_hours {
    ...
    public fun clear_enhanced_funding(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut OffHoursRegistry, arg2: vector<u8>) {
    ...
    public fun close_session(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut OffHoursRegistry, arg2: vector<u8>) {
        assert!(0x2::table::contains<vector<u8>, OffHoursConfig>(&arg1.configs, arg2), 0);
    ...
    public entry fun init_policy(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun open_session(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut OffHoursRegistry, arg2: vector<u8>, arg3: &0x2::clock::Clock) {
        assert!(0x2::table::contains<vector<u8>, OffHoursConfig>(&arg1.configs, arg2), 0);
        let v0 = 0x2::table::borrow_mut<vector<u8>, OffHoursConfig>(&mut arg1.configs, arg2);
    ...
    public fun register_config(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut OffHoursRegistry, arg2: vector<u8>) {
    ...
    public fun restore_mm_liquidity(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut OffHoursRegistry, arg2: vector<u8>) {
        assert!(0x2::table::contains<vector<u8>, OffHoursConfig>(&arg1.configs, arg2), 0);
    ...
    public fun set_mm_liquidity_gone(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut OffHoursRegistry, arg2: vector<u8>) {
        assert!(0x2::table::contains<vector<u8>, OffHoursConfig>(&arg1.configs, arg2), 0);
    ...
    public entry fun update_tier_caps(arg0: &mut OffHoursPolicy, arg1: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg2: u8, arg3: TierCaps, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
    ...
    public fun update_transition_params(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut OffHoursRegistry, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64) {
        assert!(0x2::table::contains<vector<u8>, OffHoursConfig>(&arg1.configs, arg2), 0);
        assert!(arg3 > 0, 8);
