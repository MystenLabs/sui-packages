module 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::depeg_state {
    ...
    public fun init_depeg_state(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun tick(arg0: &mut DepegStateMachine, arg1: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::depeg_oracle::DepegOracle, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg2);
        if (arg0.last_tick_at_ms != 0) {
            assert!(v0 >= arg0.last_tick_at_ms + 1000, 3);
        };
        let v1 = 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::depeg_oracle::try_read_usdc_px(arg1, arg2);
    ...
    public fun update_config(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::AdminCap, arg1: &mut DepegStateMachine, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        assert!(arg4 > 0, 1);
        assert!(arg4 < arg3, 1);
        assert!(arg3 < arg2, 1);
        assert!(arg2 < arg5, 1);
        assert!(arg5 <= 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::depeg_oracle::price_scale(), 1);
        assert!(arg6 > 0, 2);
