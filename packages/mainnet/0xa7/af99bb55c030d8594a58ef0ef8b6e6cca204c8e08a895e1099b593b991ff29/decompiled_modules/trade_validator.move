module 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::trade_validator {
    ...
    public fun validate_trade(arg0: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::admin_config::GlobalParams, arg1: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::market_factory::MarketRegistry, arg2: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::circuit_breaker::BreakerRegistry, arg3: &BlocklistRegistry, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: u64, arg9: u64, arg10: bool) {
        ...
        if (0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::circuit_breaker::breaker_exists(arg2, arg5) && 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::circuit_breaker::is_emergency(arg2, arg5) && !arg10) {
            abort 4
        };
        if (arg10) {
            return
        ...
        assert!(arg8 > 0, 10);
        let v1 = 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_calculator::compute_notional_value(arg7, arg9);
        assert!(arg8 >= 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_calculator::compute_initial_margin(v1, 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::market_factory::market_initial_margin_ratio_bps(v0)), 5);
        assert!((v1 as u128) <= (arg8 as u128) * (0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::market_factory::market_max_leverage(v0) as u128), 6);
        let v2 = 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::market_factory::market_long_oi(v0);
        let v3 = 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::market_factory::market_short_oi(v0);
        assert!((v2 as u128) + (v3 as u128) + (v1 as u128) <= (0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::market_factory::market_total_oi_cap(v0) as u128), 7);
        let v4 = if (0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::circuit_breaker::breaker_exists(arg2, arg5)) {
