module 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::position_store {
    ...
    fun compute_round_delta_v4<T0>(arg0: &PositionStore, arg1: &0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_bank::MarginBank<T0>, arg2: address, arg3: 0x2::object::ID, arg4: u64, arg5: u128, arg6: bool, arg7: u128) : FundingRoundDelta {
        let v0 = make_key(arg2, arg3);
        assert!(0x2::table::contains<vector<u8>, StoredPosition>(&arg0.positions, v0), 0);
        ...
        let v6 = if (v5) {
            min_u64(v4, min_u64(v1.collateral, 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_bank::get_locked_balance<T0>(arg1, arg2)))
        } else {
            0
        };
        let v7 = if (v5 && v4 > v6) {
    ...
    public(friend) fun settle_market_funding_round_v4<T0>(arg0: &mut PositionStore, arg1: &mut 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_bank::MarginBank<T0>, arg2: 0x2::object::ID, arg3: u64, arg4: u128, arg5: bool, arg6: u128, arg7: &0x2::clock::Clock) : u64 {
        if (!0x2::linked_table::contains<0x2::object::ID, vector<address>>(&arg0.market_positions, arg2)) {
            return 0
        };
        ...
        while (v6 < v8) {
            ...
            while (v14 > 0) {
                ...
                0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_bank::transfer_locked<T0>(arg1, v15.owner, v13.owner, v16);
        ...
        while (v6 < v8) {
            ...
            if (v19 > 0) {
                0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_bank::slash_locked<T0>(arg1, v18.owner, v19);
            };
            v6 = v6 + 1;
        };
        let v20 = 0;
        ...
        while (v6 < v8) {
            ...
            v21.borrow_debit = min_u64(v21.borrow_amount, min_u64(v22, 0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_bank::get_locked_balance<T0>(arg1, v21.owner)));
            v21.borrow_shortfall = v21.borrow_amount - v21.borrow_debit;
            v21.new_collateral = v22 - v21.borrow_debit;
            if (v21.borrow_debit > 0) {
                0x60df2030f7245e1caf1b23d507406032ddcbeb4aeadd793c273cd1a04ffd47bb::margin_bank::slash_locked<T0>(arg1, v21.owner, v21.borrow_debit);
            };
            v6 = v6 + 1;
        };
        v6 = 0;
