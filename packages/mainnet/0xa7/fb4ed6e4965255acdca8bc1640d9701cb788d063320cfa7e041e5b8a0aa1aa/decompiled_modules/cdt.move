module 0xa7fb4ed6e4965255acdca8bc1640d9701cb788d063320cfa7e041e5b8a0aa1aa::cdt {
    struct CDT has drop {
        dummy_field: bool,
    }
    ...
    fun create_coin(arg0: CDT, arg1: &mut 0x2::tx_context::TxContext) : (0x2::coin::TreasuryCap<CDT>, 0x2::coin::CoinMetadata<CDT>) {
        0x2::coin::create_currency<CDT>(arg0, 6, b"CDT", b"CheckDot Coin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://checkdot.io/token-256x256.png"))), arg1)
    }

    fun init(arg0: CDT, arg1: &mut 0x2::tx_context::TxContext) {
        assert_admin_signer(arg1);
        let (v0, v1) = create_and_mint(arg0, 100000000, arg1);
