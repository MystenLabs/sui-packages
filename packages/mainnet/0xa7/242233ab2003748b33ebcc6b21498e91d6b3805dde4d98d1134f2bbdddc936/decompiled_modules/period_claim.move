module 0xa7242233ab2003748b33ebcc6b21498e91d6b3805dde4d98d1134f2bbdddc936::period_claim {
    ...
    fun assert_admin<T0>(arg0: &Vault<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 10);
    }
    ...
    public fun emergency_withdraw<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun set_admin<T0>(arg0: &mut Vault<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun withdraw_excess<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_admin<T0>(arg0, arg1);
        let v0 = arg0.budget - arg0.spent;
        let v1 = 0x2::balance::value<T0>(&arg0.balance);
        assert!(v1 >= v0, 6);
        let v2 = v1 - v0;
        let v3 = if (v2 > 0) {
            0x2::coin::take<T0>(&mut arg0.balance, v2, arg1)
        } else {
            0x2::coin::zero<T0>(arg1)
        };
        let v4 = Withdrawn{
