module 0xa74d502f9d8f20183b5fb9191db889ab2b24ddd70928a9da37af81610bab936d::flipcoin {
    ...
    public entry fun play(arg0: &mut FlipCoin, arg1: 0x1::string::String, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg1 == v0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v2, 2 * (100 - arg0.fee) * 0x2::coin::value<0x2::sui::SUI>(&arg2) / 100, arg4), 0x2::tx_context::sender(arg4));
    ...
    public entry fun play_guess_number(arg0: &mut FlipCoin, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xa74d502f9d8f20183b5fb9191db889ab2b24ddd70928a9da37af81610bab936d::random::get_last_number(0x2::clock::timestamp_ms(arg3));
        0x1::string::utf8(b"");
        let v1 = if (v0 == arg1) {
            let v2 = 0x2::dynamic_object_field::remove<bool, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg0.id, true);
