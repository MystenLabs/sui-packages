module 0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_events {
    ...
    struct Withdrawn has copy, drop {
        ...
        shares_burned: u128,
        amount_received: u64,
        recall: vector<0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_allocation_plan::ProtocolAmount>,
        timestamp_ms: u64,
    }

    struct BalancesSynced has copy, drop {
        pool_id: 0x2::object::ID,
        balances: vector<0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_allocation_plan::ProtocolAmount>,
        total_assets: u128,
    ...
    public(friend) fun emit_balances_synced(arg0: 0x2::object::ID, arg1: vector<0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_allocation_plan::ProtocolAmount>, arg2: u128, arg3: u128, arg4: u64) {
    ...
    public(friend) fun emit_deposited(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: u128, arg5: vector<0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_allocation_plan::ProtocolAmount>, arg6: u64) {
        let v0 = Deposited{
            pool_id       : arg0,
            position_id   : arg1,
            user          : arg2,
    ...
    public(friend) fun emit_withdrawn(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: u128, arg4: u64, arg5: vector<0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_allocation_plan::ProtocolAmount>, arg6: u64) {
        let v0 = Withdrawn{
            pool_id         : arg0,
            position_id     : arg1,
            user            : arg2,
