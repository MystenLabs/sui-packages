module 0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_admin {
    ...
    public(friend) fun migrate(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.version = 1;
        0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_events::emit_global_migrated(arg0.version);
    }
    ...
    public(friend) fun set_global_paused(arg0: &mut LLVGlobal, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.paused = arg1;
        0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_events::emit_global_paused(arg1);
    }
    ...
    public(friend) fun set_owner(arg0: &mut LLVGlobal, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 3);
        arg0.owner = arg1;
        0xa7fad098fbea98d8817425fc96c32ce87bc2eb19648c0d136ac08872b6b9ef91::llv_events::emit_owner_changed(arg0.owner, arg1);
    }
