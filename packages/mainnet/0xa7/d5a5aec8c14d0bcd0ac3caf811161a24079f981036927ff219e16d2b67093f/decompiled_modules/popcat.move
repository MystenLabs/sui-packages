module 0xa7d5a5aec8c14d0bcd0ac3caf811161a24079f981036927ff219e16d2b67093f::popcat {
    struct POPCAT has drop {
        dummy_field: bool,
    }

    fun init(arg0: POPCAT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<POPCAT>(arg0, 9, b"POPCAT", b"POPCAT", b"", 0x1::option::none<0x2::url::Url>(), arg1);
