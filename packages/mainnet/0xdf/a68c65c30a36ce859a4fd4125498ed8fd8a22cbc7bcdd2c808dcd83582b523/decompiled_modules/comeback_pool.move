module 0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::comeback_pool {
    ...
    public entry fun verify_milestone(arg0: &mut Pool, arg1: u64, arg2: 0x2::coin::Coin<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>, arg3: &mut 0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::verification_fees::Treasury, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.navigator, 2);
        assert!(arg1 < 0x1::vector::length<Milestone>(&arg0.milestones), 3);
        0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::verification_fees::collect_fee(arg3, arg2, arg5);
        let v0 = 0x1::vector::borrow_mut<Milestone>(&mut arg0.milestones, arg1);
        v0.completed = true;
        v0.verified_at = 0x2::clock::timestamp_ms(arg4);
    }
