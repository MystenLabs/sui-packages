module 0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::navigator_staking {
    ...
    struct NavigatorStake has key {
        id: 0x2::object::UID,
        navigator: address,
        stake: 0x2::balance::Balance<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>,
        staked_at: u64,
    ...
    public entry fun complete_unstake(arg0: &mut NavigatorRegistry, arg1: NavigatorStake, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>>(0x2::coin::from_balance<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>(v2, arg3), v1);
    ...
    public entry fun stake_navigator(arg0: &mut NavigatorRegistry, arg1: &mut 0x2::coin::Coin<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>(arg1) >= 1000000000000, 0);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = NavigatorStake{
            id                   : 0x2::object::new(arg3),
            navigator            : v0,
            stake                : 0x2::coin::into_balance<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>(0x2::coin::split<0xdfa68c65c30a36ce859a4fd4125498ed8fd8a22cbc7bcdd2c808dcd83582b523::shock::SHOCK>(arg1, 1000000000000, arg3)),
