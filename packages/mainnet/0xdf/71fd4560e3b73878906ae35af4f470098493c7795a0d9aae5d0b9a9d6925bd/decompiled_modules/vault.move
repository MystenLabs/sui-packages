module 0x45355b07146d699e6a8c405bcc2f60ef5d062a15183c6012ac55d5734d8add21::vault {
    ...
    public(friend) fun redeem_token_internal<T0, T1, T2>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: address, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        while (v14 < v10) {
            ...
            v11 = v11 + *0x1::vector::borrow<u64>(&arg5, v17);
            v12 = v12 + v15.amount;
            v13 = v13 + *0x1::vector::borrow<u64>(&arg6, v17);
            v14 = v14 + 1;
        };
        let v18 = arg1.hwm;
        let v19 = if (v18 >= (v13 as u128)) {
            v18 - (v13 as u128)
        } else {
            0
        };
        arg1.hwm = v19;
        arg1.pending_redemptions = arg1.pending_redemptions - (v12 as u128);
        let v20 = spend_withdraw_asset<T0, T1, T2>(arg1, v11, arg11);
        let v21 = calculate_fee(v11, arg1.withdraw.fee_bps);
        arg1.withdraw.total_fee = arg1.withdraw.total_fee + calculate_fee(v13, arg1.withdraw.fee_bps);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v20, v21, arg11), arg1.fee_receiver);
        arg1.total_withdraw = arg1.total_withdraw + (v13 as u128);
        let v22 = RedeemWithSigTokenEvent{
            receiver                            : arg2,
            item_amount                         : v12,
            amount                              : v11,
        ...
        0x2::event::emit<RedeemWithSigTokenEvent>(v22);
        v20
    }
