module 0xdf06765eed33e9945390f8bb3ccfa5beeb236199743c85ae0ed0ffe0fb2a505d::xxt {
    struct XXT has drop {
        dummy_field: bool,
    }

    fun init(arg0: XXT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/ca1VtRljllADX5hdnKJB4_KP6Cfgtrj_qjOTgNlOiZU";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/ca1VtRljllADX5hdnKJB4_KP6Cfgtrj_qjOTgNlOiZU"))
        };
