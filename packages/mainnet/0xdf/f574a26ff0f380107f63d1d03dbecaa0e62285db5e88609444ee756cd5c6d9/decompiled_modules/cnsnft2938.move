module 0xdff574a26ff0f380107f63d1d03dbecaa0e62285db5e88609444ee756cd5c6d9::cnsnft2938 {
    struct CNSNFT2938 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2938, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2938>(arg0, arg1);
