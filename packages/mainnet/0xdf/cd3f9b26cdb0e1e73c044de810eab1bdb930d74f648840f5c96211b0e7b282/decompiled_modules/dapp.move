module 0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::dapp {
    ...
    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &mut 0xf64c53c15b63226cff5e81f5dfcaa7d7f2743e93dfeded0a83b5f5db4f19ccff::implements::Global, arg2: &0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::price_oracle::PriceOracle, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 13906838039813947391);
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 100) {
            ...
            if (v3 > 0) {
                ...
                if (v2.invest_amount > 0) {
                    ...
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_user_balance(arg0, v6);
                };
            };
            v0 = v2.inviter;
            v1 = v1 + 1;
    ...
    fun update_dynamic_power(arg0: &mut 0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: bool) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            ...
            if (v8.invest_amount > 0 && v7 > 0) {
                ...
                if (v1 == 1 && arg4) {
                    let v10 = v9 / 10;
                    let v11 = v8.static_power - v8.total_earning;
                    let v12 = if (v10 < v11) {
                        v10
                    } else {
                        v11
                    };
                    v8.balance = v8.balance + v12;
                    v8.today_earning = v8.today_earning + v12;
                    v8.total_earning = v8.total_earning + v12;
                    handler_out(arg0, v8);
                    v8.dynamic_power = v8.dynamic_power + v9 - v12;
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_dynamic_power_distributed(arg0, v9 - v12);
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_share_reward(arg0, v12);
                    0xc2a651b4ef30a1985904e7d01de09c370bbd82e3e9dcc4eb514c91d4fbd1bf6e::admin::add_total_user_balance(arg0, v12);
                } else {
