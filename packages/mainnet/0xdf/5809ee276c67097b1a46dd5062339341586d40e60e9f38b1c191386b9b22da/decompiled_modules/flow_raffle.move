module 0xdf5809ee276c67097b1a46dd5062339341586d40e60e9f38b1c191386b9b22da::flow_raffle {
    ...
    public entry fun buy_ticket(arg0: &mut HybridRaffle, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1 * arg2.primary_fee_percentage / 10000;
        let v3 = v1 * arg2.secondary_fee_percentage / 10000;
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v2, arg4), arg2.primary_fee_address);
        };
        if (v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v3, arg4), arg2.secondary_fee_address);
        };
    ...
    public entry fun create_wallet_raffle<T0: store + key>(arg0: &GlobalConfig, arg1: T0, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = NFTEscrow<T0>{
            ...
            nft               : arg1,
            raffle_id         : v3,
            original_kiosk_id : v0,
        };
        let v5 = 0x2::clock::timestamp_ms(arg7) + arg6;
        let v6 = HybridRaffle{
            id             : v2,
            name           : arg2,
            description    : arg3,
        ...
        0x2::event::emit<HybridRaffleCreated>(v7);
        0x2::transfer::share_object<NFTEscrow<T0>>(v4);
        0x2::transfer::share_object<HybridRaffle>(v6);
    }
