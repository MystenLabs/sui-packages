module 0xdf1e5d70f1af8767b6949dcf47574090eeb4ca7ab2b6b915a3ea6d644ac8a041::reward7330 {
    struct REWARD7330 has drop {
        dummy_field: bool,
    }

    struct TICKET_7330 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7330(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_7330>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7330, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7330>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7330>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7330>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7330>>(v5, 0x2::tx_context::sender(arg1));
    }
