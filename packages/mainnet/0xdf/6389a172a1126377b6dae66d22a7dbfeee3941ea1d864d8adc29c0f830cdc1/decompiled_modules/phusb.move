module 0xdf6389a172a1126377b6dae66d22a7dbfeee3941ea1d864d8adc29c0f830cdc1::phusb {
    ...
    fun init(arg0: PHUSB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<PHUSB>(arg0, 9, b"PHUSB", b"Peanut Husbulla on SUI", b"$PHUSB - Legendary characters team up to conquer SUI.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://ipfs.io/ipfs/QmNSNoLPL8f4oWPEpj4fWkmA2iMCzcjKGjYiHHAqHr2ufj"))), false, arg1);
        let v3 = v0;
        0x2::coin::mint_and_transfer<PHUSB>(&mut v3, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
