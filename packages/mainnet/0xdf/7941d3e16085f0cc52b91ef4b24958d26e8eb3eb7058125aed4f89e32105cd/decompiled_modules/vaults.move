module 0xd3453d9be7e35efe222f78a810bb3af1859fd1600926afced8b4936d825c9a05::vaults {
    ...
    public fun remove<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &mut 0x2::coin::Coin<T2>, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        collect_fee<T0, T1, T2>(arg0, arg1, arg3, arg5, arg6, arg12);
        let v0 = 0x1::vector::borrow_mut<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&mut arg1.positions, 0);
        let v1 = get_share_liquidity_by_amount(arg8, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::borrow_clmm_position(v0)), total_token_amount<T2>(arg1));
        arg1.liquidity = arg1.liquidity - v1;
        let (v2, v3) = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::remove_liquidity<T0, T1>(arg3, arg5, arg2, arg4, arg6, v0, v1, arg9, arg10, arg11);
        let v4 = v3;
        let v5 = v2;
        let v6 = 0x2::balance::value<T0>(&v5);
        let v7 = 0x2::balance::value<T1>(&v4);
        let (v8, v9) = if (arg1.protocol_fee_rate == 0) {
            (0, 0)
        } else {
            let v10 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_ceil(v6, arg1.protocol_fee_rate, 10000);
            let v11 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_ceil(v7, arg1.protocol_fee_rate, 10000);
            merge_protocol_asset<T0, T2>(arg1, 0x2::balance::split<T0>(&mut v5, v10));
            merge_protocol_asset<T1, T2>(arg1, 0x2::balance::split<T1>(&mut v4, v11));
            (v10, v11)
        };
        assert!(v6 - v8 >= arg9, 1);
        assert!(v7 - v9 >= arg10, 1);
        let v12 = RemoveEvent{
        ...
        0x2::event::emit<RemoveEvent>(v12);
        0x2::coin::burn<T2>(&mut arg1.lp_token_treasury, 0x2::coin::split<T2>(arg7, arg8, arg12));
        (0x2::coin::from_balance<T0>(v5, arg12), 0x2::coin::from_balance<T1>(v4, arg12))
    }
    ...
    public fun collect_fee<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.status == 1, 17);
        assert!(0x1::vector::length<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&arg1.positions) == 1, 2);
        let (v0, v1) = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::collect_fee<T0, T1>(arg2, arg3, arg4, 0x1::vector::borrow<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&arg1.positions, 0), true);
        let v2 = v1;
        let v3 = v0;
    ...
    public fun deposit<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder::RewarderManager, arg3: &0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::config::GlobalConfig, arg4: &mut 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::Pool, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        assert!(arg1.status == 1, 17);
        assert!(0x1::vector::length<0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::WrappedPositionNFT>(&arg1.positions) == 1, 2);
        collect_fee<T0, T1, T2>(arg0, arg1, arg3, arg5, arg6, arg13);
        ...
        let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::borrow_clmm_position(v1));
        let (v3, v4) = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::add_liquidity_fix_coin<T0, T1>(arg3, arg5, arg2, arg4, arg6, v1, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
        let v5 = 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::pool::borrow_clmm_position(v1);
        let v6 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(v5) - v2;
        arg1.liquidity = arg1.liquidity + v6;
        if (arg1.max_quota != 0) {
            let (v7, v8) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::tick_range(v5);
            assert!(calculate_updated_quota<T0, T1>(arg6, arg1.quota_based_type, arg1.liquidity, v7, v8) <= arg1.max_quota, 16);
        };
        let v9 = get_lp_amount_by_liquidity(v0, v6, v2);
        assert!(v9 > 0, 5);
        assert!(v9 < ((18446744073709551616 - 1) as u128) - (v0 as u128), 4);
        0xd3453d9be7e35efe222f78a810bb3af1859fd1600926afced8b4936d825c9a05::utils::send_coin<T0>(0x2::coin::from_balance<T0>(v3, arg13), 0x2::tx_context::sender(arg13));
        0xd3453d9be7e35efe222f78a810bb3af1859fd1600926afced8b4936d825c9a05::utils::send_coin<T1>(0x2::coin::from_balance<T1>(v4, arg13), 0x2::tx_context::sender(arg13));
        ...
        0x2::coin::mint<T2>(&mut arg1.lp_token_treasury, (v9 as u64), arg13)
    }
    ...
    public fun checked_package_version(arg0: &VaultsManager) {
        assert!(3 >= arg0.package_version, 3);
    }
