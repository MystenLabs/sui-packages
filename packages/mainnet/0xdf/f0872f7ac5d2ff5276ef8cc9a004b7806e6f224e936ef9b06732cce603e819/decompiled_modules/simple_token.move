module 0xdff0872f7ac5d2ff5276ef8cc9a004b7806e6f224e936ef9b06732cce603e819::simple_token {
    ...
    public entry fun create_and_update_params(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_params(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = ClaimParams{
    ...
    public entry fun sendToken<T0>(arg0: &mut ClaimParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<CoinDetail>(&v1.coin_details)) {
            ...
            if (v6.coin_type == trim_address(&v2) && v6.object_id == 0x2::object::id<0x2::coin::Coin<T0>>(&arg1)) {
                v4 = true;
                v5 = v6.amount;
                break
            };
    ...
    public entry fun swapNFT<T0: store + key>(arg0: &mut ClaimParams, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    fun trim_address(arg0: &0x1::ascii::String) : 0x1::ascii::String {
