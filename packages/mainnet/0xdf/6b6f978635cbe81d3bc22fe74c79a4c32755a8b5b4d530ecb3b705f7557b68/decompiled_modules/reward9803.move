module 0xdf6b6f978635cbe81d3bc22fe74c79a4c32755a8b5b4d530ecb3b705f7557b68::reward9803 {
    struct REWARD9803 has drop {
        dummy_field: bool,
    }

    struct TICKET_9803 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9803(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9803>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9803>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9803, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9803>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9803>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9803>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9803>>(v5, 0x2::tx_context::sender(arg1));
    }
