module 0xdfac97bedc2af2f2e1e9b0c4cc78df2e6a584bf6c068521d6fcdf0ec2a55e536::fetcher {
    ...
    public entry fun test<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
        let (v0, v1) = 0xdee9::clob_v2::get_level2_book_status_bid_side<T0, T1>(arg0, 0, 10000000000, arg3);
        let v2 = v1;
        let v3 = v0;
        let v4 = TestEvent{
