module 0xdf86448283e31081c19d12262133e9167f556f96b1e6f8558339fdd6796b52d9::cnsnft7128 {
    struct CNSNFT7128 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7128, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4142"));
        let v4 = 0x2::package::claim<CNSNFT7128>(arg0, arg1);
