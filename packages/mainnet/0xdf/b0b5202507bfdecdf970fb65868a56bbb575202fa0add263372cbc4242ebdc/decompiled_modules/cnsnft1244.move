module 0xdfb0b5202507bfdecdf970fb65868a56bbb575202fa0add263372cbc4242ebdc::cnsnft1244 {
    struct CNSNFT1244 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1244, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1244>(arg0, arg1);
