module 0xdf27946cc0ea40cd69878b99eb7fa350b37faf0215ed8874fdcb0219bf9df24f::nft {
    ...
    fun isWhitelist<T0>(arg0: &mut Phaser<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0xdf27946cc0ea40cd69878b99eb7fa350b37faf0215ed8874fdcb0219bf9df24f::merkle_proof::verify(&arg2, arg0.whitelist_merkle_root, 0x1::hash::sha2_256(0x2::bcs::to_bytes<Ticket>(&v0)))
    }
    ...
    public entry fun open<T0, T1: store + key, T2: store + key, T3: store + key, T4: store + key, T5: store + key>(arg0: &mut Registry, arg1: &mut CubicNft, arg2: &mut 0x2::tx_context::TxContext) {
