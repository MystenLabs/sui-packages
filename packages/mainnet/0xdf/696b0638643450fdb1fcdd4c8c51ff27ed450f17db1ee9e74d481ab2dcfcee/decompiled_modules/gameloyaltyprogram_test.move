module 0xdf696b0638643450fdb1fcdd4c8c51ff27ed450f17db1ee9e74d481ab2dcfcee::gameloyaltyprogram_test {
    ...
    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        ...
        let (v1, v2) = 0x2::coin::create_currency<T0>(arg0, 18, b"TEST", b"test", b"The following contract regulates the functioning of Game Loyalty program Loyalty Tokens", v0, arg1);
