    ...
    public fun settle_fund<T0, T1, T2, T3>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut UserShareRegistry, arg3: &mut DepositVault<T0, T1>, arg4: &mut BidVault<T0, T2>, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v1 != 0) {
            ...
            if (arg7 > v2) {
                ...
                v0 = v4;
                if (v4 != 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg4.performance_fee_sub_vault.balance, v4), arg11), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                };
            } else if (arg7 < v2) {
                let v5 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T1, T2>()) {
                    ...
                    ((((((0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (arg9 as u128) / (arg10 as u128)) as u64)
                } else {
                    ((((((0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) / (1000 as u128)) as u64) as u128) * (arg10 as u128) / (arg9 as u128)) as u64)
                };
                let v6 = active_share_supply<T0, T1>(arg3) + deactivating_share_supply<T0, T1>(arg3);
                let v7 = (v1 as u256) * ((v2 - arg7) as u256) / (v2 as u256) + (v5 as u256);
                let v8 = 0x2::balance::split<T1>(&mut arg3.active_sub_vault.balance, ((v7 * (arg3.active_sub_vault.share_supply as u256) / (v6 as u256)) as u64));
                let v9 = &mut arg3.active_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v9);
                let v10 = &mut arg3.deactivating_sub_vault;
                adjust_user_share_ratio<T1>(arg1, v10);
                0x2::balance::join<T1>(&mut v8, 0x2::balance::split<T1>(&mut arg3.deactivating_sub_vault.balance, ((v7 * (arg3.deactivating_sub_vault.share_supply as u256) / (v6 as u256)) as u64)));
                while (!0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::is_empty<UserShareKey, u64>(&arg4.bidder_sub_vault.user_shares)) {
                    let (v11, v12) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::pop_front<UserShareKey, u64>(&mut arg2.id, &mut arg4.bidder_sub_vault.user_shares);
                    let v13 = v11;
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v8, (((0x2::balance::value<T1>(&v8) as u128) * (v12 as u128) / (arg4.bidder_sub_vault.share_supply as u128)) as u64)), arg11), v13.user);
                    arg4.bidder_sub_vault.share_supply = arg4.bidder_sub_vault.share_supply - v12;
                };
                0x2::balance::destroy_zero<T1>(v8);
            };
            if (0x2::balance::value<T2>(&arg4.performance_fee_sub_vault.balance) > 0) {
                let v14 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::first<UserShareKey, u64>(&arg4.performance_fee_sub_vault.user_shares);
                while (0x1::option::is_some<UserShareKey>(&v14)) {
                    let v15 = *0x1::option::borrow<UserShareKey>(&v14);
                    v14 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::next<UserShareKey, u64>(&arg2.id, &arg4.performance_fee_sub_vault.user_shares, v15);
                    let v16 = &mut arg4.performance_fee_sub_vault;
                    let (_, v18) = withdraw_<T2>(arg2, v16, 0x1::option::none<u64>(), v15.user);
                    let v19 = &mut arg4.premium_sub_vault;
                    deposit_<T2>(arg2, v19, v18, v15.user);
                };
            };
            let v20 = &mut arg3.deactivating_sub_vault;
            let v21 = &mut arg3.inactive_sub_vault;
            rock_n_roll<T1>(arg1, v20, v21);
        ...
        0x2::event::emit<Settle<T0, T2>>(v24);
        v0
    }
