module 0xdf976d10348eefc82408a6329540dcc908170f1b3595cf7a2d6ebce2f06172e3::cnsnft8989 {
    struct CNSNFT8989 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8989, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8989>(arg0, arg1);
