module 0xdfdf1c9c5c95f2311326ec417dd2ceb45c2ba5c11f5477dd89e6b33fdbdf0356::reward8315 {
    struct REWARD8315 has drop {
        dummy_field: bool,
    }

    struct TICKET_8315 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8315(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8315>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8315>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8315, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8315>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8315>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8315>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8315>>(v5, 0x2::tx_context::sender(arg1));
    }
