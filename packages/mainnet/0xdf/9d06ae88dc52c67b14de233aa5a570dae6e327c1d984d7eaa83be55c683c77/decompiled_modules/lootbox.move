module 0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::lootbox {
    ...
    public fun create_lootbox<T0>(arg0: &0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::house::AdminCap, arg1: &mut LootboxGame<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: vector<u64>, arg6: vector<u64>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun purchase_lootbox<T0>(arg0: &mut LootboxGame<T0>, arg1: &mut 0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::house::House<T0>, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::house::deposit<T0>(arg1, v2);
        let v3 = PurchasedLootBox<T0>{
            id         : 0x2::object::new(arg4),
            lootbox_id : 0x2::object::uid_to_inner(&v1.id),
            buyer      : 0x2::tx_context::sender(arg4),
            fund       : 0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::house::take_fund_balance<T0>(arg1, *0x1::vector::borrow<u64>(&v1.reward_amounts, 0x1::vector::length<u64>(&v1.reward_amounts) - 1)),
        };
        0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::house::distribute_referral_rewards<T0>(arg1, 0x2::coin::value<T0>(&v2), 0x2::tx_context::sender(arg4));
        0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::events::emit_purchased_lootbox_event(0x2::object::uid_to_inner(&v1.id), 0x2::object::uid_to_inner(&v3.id), 0x2::tx_context::sender(arg4));
        0x2::vec_map::insert<0x2::object::ID, PurchasedLootBox<T0>>(&mut arg0.purchased_lootbox, 0x2::object::uid_to_inner(&v3.id), v3);
    }

    public fun reveal_lootbox_onchain_randomness<T0>(arg0: &mut LootboxGame<T0>, arg1: &mut 0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::house::House<T0>, arg2: 0x2::object::ID, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::house::join_balance<T0>(arg1, v6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v6, v11, arg4), v4);
        0xdf9d06ae88dc52c67b14de233aa5a570dae6e327c1d984d7eaa83be55c683c77::events::emit_revealed_lootbox_event(0x2::object::uid_to_inner(&v8), v7, v4, v11);
