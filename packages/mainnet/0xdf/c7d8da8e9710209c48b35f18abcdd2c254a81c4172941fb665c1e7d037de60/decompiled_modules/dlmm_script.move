module 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_script {
    ...
    public entry fun shrink_position<T0, T1>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0 && arg2 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223376774203703295);
    ...
    public entry fun mint_by_strategy<T0, T1>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_factory::Factory, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: u64, arg6: bool, arg7: u64, arg8: u8, arg9: u32, arg10: u32, arg11: u32, arg12: u32, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 > 0 || arg7 > 0, 9223373565863133183);
        assert!(arg4 || arg6, 9223373570158100479);
        if (arg4 && arg6) {
        ...
        let (v8, v9) = if (arg4 && arg6) {
            ...
            if (v15 < arg5) {
                let (v17, v18) = get_distribution_by_strategy(arg8, v0, arg10, v0);
                let v19 = v17;
                let (v20, _) = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v0, v1, arg5 - v15, 0, v2, v3, v19, v18);
                let v22 = v20;
                let v23 = 0;
                let v24 = 0x1::vector::empty<u64>();
                while (v23 < 0x1::vector::length<u32>(&v7)) {
                    if (*0x1::vector::borrow<u32>(&v7, v23) < v0) {
                        0x1::vector::push_back<u64>(&mut v24, *0x1::vector::borrow<u64>(&v14, v23));
                    } else {
                        0x1::vector::push_back<u64>(&mut v24, *0x1::vector::borrow<u64>(&v14, v23) + *0x1::vector::borrow<u64>(&v22, v23 - 0x1::vector::length<u32>(&v7) - 0x1::vector::length<u32>(&v19)));
                    };
                    v23 = v23 + 1;
                };
                v14 = v24;
            ...
            if (v16 < arg7) {
                let (v25, v26) = get_distribution_by_strategy(arg8, arg9, v0, v0);
                let (_, v28) = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v0, v1, 0, arg7 - v16, v2, v3, v25, v26);
                let v29 = v28;
                let v30 = 0;
                let v31 = 0x1::vector::empty<u64>();
                while (v30 < 0x1::vector::length<u32>(&v7)) {
                    if (*0x1::vector::borrow<u32>(&v7, v30) > v0) {
                        0x1::vector::push_back<u64>(&mut v31, *0x1::vector::borrow<u64>(&v13, v30));
                    } else {
                        0x1::vector::push_back<u64>(&mut v31, *0x1::vector::borrow<u64>(&v13, v30) + *0x1::vector::borrow<u64>(&v29, v30));
                    };
                    v30 = v30 + 1;
                };
                v13 = v31;
            ...
            if (v0 < arg9) {
                let v32 = vector[];
                let v33 = 0;
                while (v33 < 0x1::vector::length<u32>(&v7)) {
                    0x1::vector::push_back<u64>(&mut v32, 0);
                    v33 = v33 + 1;
                };
                (0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_ask_side(v0, v1, arg5, v7, v6), v32)
            } else {
                assert!(v0 >= arg9 && v0 <= arg10, 3);
                let v34 = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::auto_fill_y_by_weight(v0, v1, arg5, v2, v3, v7, v6);
                assert!(v34 >= arg13 && v34 <= arg14, 2);
                0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v0, v1, arg5, v34, v2, v3, v7, v6)
            }
        } else if (v0 > arg10) {
            let v35 = vector[];
            let v36 = 0;
            while (v36 < 0x1::vector::length<u32>(&v7)) {
                0x1::vector::push_back<u64>(&mut v35, 0);
                v36 = v36 + 1;
            };
            (v35, 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_bid_side(v0, arg7, v7, v6))
        } else {
            assert!(v0 >= arg9 && v0 <= arg10, 3);
            let v37 = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::auto_fill_x_by_weight(v0, v1, arg7, v2, v3, v7, v6);
            assert!(v37 >= arg13 && v37 <= arg14, 2);
            0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v0, v1, v37, arg7, v2, v3, v7, v6)
        };
        let (v38, v39, v40) = filter_empty_bins(v7, v8, v9);
        let v41 = 0x2::tx_context::sender(arg16);
        mint_amounts<T0, T1>(arg0, arg1, arg2, arg3, v38, v39, v40, v41, arg15, arg16);
    }
    ...
    public entry fun raise_by_strategy<T0, T1>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_factory::Factory, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: bool, arg6: u64, arg7: bool, arg8: u64, arg9: u8, arg10: u32, arg11: u32, arg12: u64, arg13: u64, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg6 > 0 || arg8 > 0, 9223375395519201279);
        assert!(arg5 || arg7, 9223375399814168575);
        if (arg5 && arg7) {
        ...
        let (v10, v11) = if (arg5 && arg7) {
            ...
            if (v17 < arg6) {
                let (v19, v20) = get_distribution_by_strategy(arg9, v2, v1, v2);
                let v21 = v19;
                let (v22, _) = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v2, v3, arg6 - v17, 0, v4, v5, v21, v20);
                let v24 = v22;
                let v25 = 0;
                let v26 = 0x1::vector::empty<u64>();
                while (v25 < 0x1::vector::length<u32>(&v9)) {
                    if (*0x1::vector::borrow<u32>(&v9, v25) < v2) {
                        0x1::vector::push_back<u64>(&mut v26, *0x1::vector::borrow<u64>(&v16, v25));
                    } else {
                        0x1::vector::push_back<u64>(&mut v26, *0x1::vector::borrow<u64>(&v16, v25) + *0x1::vector::borrow<u64>(&v24, v25 - 0x1::vector::length<u32>(&v9) - 0x1::vector::length<u32>(&v21)));
                    };
                    v25 = v25 + 1;
                };
                v16 = v26;
            ...
            if (v18 < arg8) {
                let (v27, v28) = get_distribution_by_strategy(arg9, v0, v2, v2);
                let (_, v30) = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v2, v3, 0, arg8 - v18, v4, v5, v27, v28);
                let v31 = v30;
                let v32 = 0;
                let v33 = 0x1::vector::empty<u64>();
                while (v32 < 0x1::vector::length<u32>(&v9)) {
                    if (*0x1::vector::borrow<u32>(&v9, v32) > v2) {
                        0x1::vector::push_back<u64>(&mut v33, *0x1::vector::borrow<u64>(&v15, v32));
                    } else {
                        0x1::vector::push_back<u64>(&mut v33, *0x1::vector::borrow<u64>(&v15, v32) + *0x1::vector::borrow<u64>(&v31, v32));
                    };
                    v32 = v32 + 1;
                };
                v15 = v33;
            ...
            if (v2 < v0) {
                let v34 = vector[];
                let v35 = 0;
                while (v35 < 0x1::vector::length<u32>(&v9)) {
                    0x1::vector::push_back<u64>(&mut v34, 0);
                    v35 = v35 + 1;
                };
                (0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_ask_side(v2, v3, arg6, v9, v8), v34)
            } else {
                assert!(v2 >= v0 && v2 <= v1, 3);
                let v36 = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::auto_fill_y_by_weight(v2, v3, arg6, v4, v5, v9, v8);
                assert!(v36 >= arg12 && v36 <= arg13, 2);
                0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v2, v3, arg6, v36, v4, v5, v9, v8)
            }
        } else if (v2 > v1) {
            let v37 = vector[];
            let v38 = 0;
            while (v38 < 0x1::vector::length<u32>(&v9)) {
                0x1::vector::push_back<u64>(&mut v37, 0);
                v38 = v38 + 1;
            };
            (v37, 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_bid_side(v2, arg8, v9, v8))
        } else {
            assert!(v2 >= v0 && v2 <= v1, 3);
            let v39 = 0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::auto_fill_x_by_weight(v2, v3, arg8, v4, v5, v9, v8);
            assert!(v39 >= arg12 && v39 <= arg13, 2);
            0xf878ed14b96c9ac261820ebadcfb6b15488563a386c34c967ff884355c2be5ba::dlmm_pair_utils::to_amount_both_side(v2, v3, v39, arg8, v4, v5, v9, v8)
        };
        let (v40, _, _) = filter_empty_bins(v9, v10, v11);
        let v43 = v40;
        if (0x1::vector::length<u32>(&v9) != 0x1::vector::length<u32>(&v43)) {
            abort 6
        };
        let v44 = 0x2::tx_context::sender(arg15);
        raise_position_by_amounts<T0, T1>(arg0, arg1, arg2, arg3, arg4, v10, v11, v44, arg14, arg15);
    }
    ...
    public entry fun shrink_position_reward1<T0, T1, T2>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::RewarderGlobalVault, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0 && arg3 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223376855808081919);
    ...
    public entry fun shrink_position_reward2<T0, T1, T2, T3>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::RewarderGlobalVault, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0 && arg3 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223376963182264319);
        let v0 = 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::collect_reward<T0, T1, T2>(arg0, arg1, arg2, arg4, arg5);
        if (0x2::balance::value<T2>(&v0) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(v0, arg5), 0x2::tx_context::sender(arg5));
        } else {
    ...
    public entry fun shrink_position_reward3<T0, T1, T2, T3, T4>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::RewarderGlobalVault, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0 && arg3 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223377096326250495);
        let v0 = 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::collect_reward<T0, T1, T2>(arg0, arg1, arg2, arg4, arg5);
        if (0x2::balance::value<T2>(&v0) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(v0, arg5), 0x2::tx_context::sender(arg5));
        } else {
