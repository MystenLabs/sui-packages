module 0xdf15d5af1d68699367e613badfde64f3403a067bcafddad5b3b3b8288295ef20::gut {
    ...
    fun init(arg0: GUT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<GUT>(arg0, 9, b"GUT", b"Gyrowin Utility Token", b"GUT is a utility token for the Gyrowin platform", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gyro.win/gut.png")), arg1);
    ...
    entry fun migrate(arg0: &mut Metadata<GUT>, arg1: &0xdf15d5af1d68699367e613badfde64f3403a067bcafddad5b3b3b8288295ef20::ownership::OwnerCap) {
        assert!(arg0.version < 1, 1);
