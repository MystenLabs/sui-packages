module 0xdfbd961cc4ce5315f3c63c32720e11759b01288776132a256c9b9655c4338262::my_module {
    ...
    public entry fun my_test(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Child>(v1, 0x2::tx_context::sender(arg0));
    }
