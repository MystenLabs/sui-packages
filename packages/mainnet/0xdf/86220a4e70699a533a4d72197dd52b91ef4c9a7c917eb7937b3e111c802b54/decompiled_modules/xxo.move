module 0xdf86220a4e70699a533a4d72197dd52b91ef4c9a7c917eb7937b3e111c802b54::xxo {
    struct XXO has drop {
        dummy_field: bool,
    }

    fun init(arg0: XXO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/b7xSRftrYJBTgmXOU_uW1R6dhd8KoWRP_Mk1JnWuGY4";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/b7xSRftrYJBTgmXOU_uW1R6dhd8KoWRP_Mk1JnWuGY4"))
        };
