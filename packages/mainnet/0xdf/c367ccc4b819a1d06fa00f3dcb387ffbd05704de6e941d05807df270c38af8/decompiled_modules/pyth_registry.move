module 0xdfc367ccc4b819a1d06fa00f3dcb387ffbd05704de6e941d05807df270c38af8::pyth_registry {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PythRegistryCap{
            id           : 0x2::object::new(arg0),
            for_registry : 0x2::object::id<PythRegistry>(&v0),
        };
    ...
    public fun register_pyth_feed<T0>(arg0: &mut PythRegistry, arg1: &PythRegistryCap, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: u64) {
        ...
        assert!(0x2::object::id<PythRegistry>(arg0) == arg1.for_registry, 70150);
