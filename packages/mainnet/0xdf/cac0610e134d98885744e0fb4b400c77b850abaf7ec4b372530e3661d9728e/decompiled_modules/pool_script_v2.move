module 0xdfcac0610e134d98885744e0fb4b400c77b850abaf7ec4b372530e3661d9728e::pool_script_v2 {
    ...
    public fun cpmm_swap<T0, T1, T2, T3, T4, T5: drop>(arg0: &mut 0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::pool::Pool<T3, T4, 0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::cpmm::CpQuoter, T5>, arg1: &mut 0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::bank::Bank<T0, T1, T3>, arg2: &mut 0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::bank::Bank<T0, T2, T4>, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::coin::Coin<T1>, arg5: &mut 0x2::coin::Coin<T2>, arg6: bool, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = if (arg6) {
            (0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::bank::mint_btoken<T0, T1, T3>(arg1, arg3, arg4, arg7, arg9, arg10), 0x2::coin::zero<T4>(arg10))
        } else {
            (0x2::coin::zero<T3>(arg10), 0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::bank::mint_btoken<T0, T2, T4>(arg2, arg3, arg5, arg7, arg9, arg10))
        };
        let v2 = v1;
        let v3 = v0;
        let v4 = if (arg6) {
        ...
        if (v5 > 0) {
            let v7 = 0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::bank::burn_btoken<T0, T1, T3>(arg1, arg3, &mut v3, v5, arg9, arg10);
            assert!(0x2::coin::value<T1>(&v7) >= arg8, 0);
            0x2::coin::join<T1>(arg4, v7);
        };
        if (v6 > 0) {
            let v8 = 0xddaa7c8c1e74d4b0448c5a11fdbee779eaca26c40183d8791e315c8f62530d51::bank::burn_btoken<T0, T2, T4>(arg2, arg3, &mut v2, v6, arg9, arg10);
            assert!(0x2::coin::value<T2>(&v8) >= arg8, 0);
            0x2::coin::join<T2>(arg5, v8);
        };
        0xdfcac0610e134d98885744e0fb4b400c77b850abaf7ec4b372530e3661d9728e::pool_script::destroy_or_transfer<T3>(v3, arg10);
        0xdfcac0610e134d98885744e0fb4b400c77b850abaf7ec4b372530e3661d9728e::pool_script::destroy_or_transfer<T4>(v2, arg10);
    }
