module 0xdffc6ff6abdc7a134ff0fc47a4de27cb5a57e8c6184fa471c2e8ca06d0afd324::cetus_adapter {
    ...
    public fun collect_fees<T0>(arg0: &mut GraduatedPool<T0>, arg1: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::FeeVault, arg2: &0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x2::sui::SUI, T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x2::sui::SUI, T0>>(arg4) == arg0.pool_id, 1);
        let (v0, v1) = 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::collect_fee<0x2::sui::SUI, T0>(arg2, arg3, arg4, &mut arg0.proof, arg6);
        let v2 = v1;
        let v3 = v0;
        arg0.sui_collected = arg0.sui_collected + 0x2::coin::value<0x2::sui::SUI>(&v3);
        arg0.token_collected = arg0.token_collected + 0x2::coin::value<T0>(&v2);
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::router::deposit_pool_fees<T0>(arg1, arg0.curve_id, arg0.coin_type, arg0.creator, 0x2::coin::into_balance<0x2::sui::SUI>(v3), v2, arg5);
    }
    ...
    public fun migrate<T0>(arg0: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::migration::MigrationVault<T0>, arg1: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::MigrationCap, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::coin::CoinMetadata<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v9, v10, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<0x2::sui::SUI, T0>(arg2, arg3, 200, 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::migration::sqrt_price_x64(v5, v6), 0x1::string::utf8(b""), v7, v8, 0x2::coin::from_balance<0x2::sui::SUI>(v4, arg8), 0x2::coin::from_balance<T0>(v3, arg8), arg5, arg6, true, arg7, arg8);
        let v12 = v9;
        ...
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::migration::return_dust<T0>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v10), 0x2::coin::into_balance<T0>(v11));
    ...
    public fun migrate_burn_position<T0>(arg0: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::migration::MigrationVault<T0>, arg1: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::MigrationCap, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg5: &0x2::coin::CoinMetadata<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v8, v9, v10) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<0x2::sui::SUI, T0>(arg2, arg3, 200, 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::migration::sqrt_price_x64(v4, v5), 0x1::string::utf8(b""), v6, v7, 0x2::coin::from_balance<0x2::sui::SUI>(v3, arg7), 0x2::coin::from_balance<T0>(v2, arg7), arg4, arg5, true, arg6, arg7);
        let v11 = v8;
        let v12 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v11);
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::migration::return_dust<T0>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v9), 0x2::coin::into_balance<T0>(v10));
