module 0xa28da7bcfd491f72f9e802909f6520899de246950fa2f637ee37f677cc9a68c9::check {
    ...
    fun check_reserves(arg0: u64, arg1: u64, arg2: u128, arg3: bool) {
        if (arg3) {
            assert!(((arg1 as u256) << 128) / (arg0 as u256) <= (arg2 as u256) * (arg2 as u256), 101);
        } else {
            assert!(((arg1 as u256) << 128) / (arg0 as u256) >= (arg2 as u256) * (arg2 as u256), 101);
        };
    }
    ...
    public fun flowxamm<T0, T1>(arg0: &0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: u128, arg2: bool) {
        ...
        check_reserves(v0, v1, arg1, arg2);
    }
    ...
    public fun kriyaamm<T0, T1>(arg0: &0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg1: u128, arg2: bool) {
        let (v0, v1, _) = 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::get_reserves<T0, T1>(arg0);
        check_reserves(v1, v0, arg1, arg2);
    }
    ...
    public fun magma<T0, T1>(arg0: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg1: u128, arg2: bool) {
        check(0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::current_sqrt_price<T0, T1>(arg0), arg1, arg2);
    }
    ...
    public fun suiswap<T0, T1>(arg0: &0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::Pool<T0, T1>, arg1: u128, arg2: bool) {
        check_reserves(0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::pool_get_balance_x_value<T0, T1>(arg0), 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::pool_get_balance_y_value<T0, T1>(arg0), arg1, arg2);
    }
