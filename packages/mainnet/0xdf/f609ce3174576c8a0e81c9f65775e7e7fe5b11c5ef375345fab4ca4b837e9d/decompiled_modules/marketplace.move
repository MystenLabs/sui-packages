module 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::marketplace {
    ...
    struct KioskDesk has store {
        sonar_reserve: 0x2::balance::Balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>,
    ...
    struct QualityMarketplace has key {
        id: 0x2::object::UID,
        treasury_cap: 0x2::coin::TreasuryCap<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>,
        reward_pool: 0x2::balance::Balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>,
        reward_pool_initial: u64,
        reward_pool_allocated: u64,
        liquidity_vault: 0x2::balance::Balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>,
        kiosk: KioskDesk,
        ...
        economic_config: 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::EconomicConfig,
    ...
    public entry fun claim_vested_tokens(arg0: &mut QualityMarketplace, arg1: &mut AudioSubmission, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.reward_pool, v0, arg2), arg1.uploader);
    }
    ...
    public entry fun finalize_submission(arg0: &ValidatorCap, arg1: &mut QualityMarketplace, arg2: &mut AudioSubmission, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::calculate_reward(get_circulating_supply(arg1), arg3);
        let v1 = if (arg3 >= 30) {
            1
        } else {
            2
        ...
        if (v1 == 1) {
            assert!(0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg1.reward_pool) - arg1.reward_pool_allocated >= v0, 2005);
    ...
    public entry fun fund_kiosk_sonar(arg0: &AdminCap, arg1: &mut QualityMarketplace, arg2: 0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>) {
        0x2::balance::join<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg1.kiosk.sonar_reserve, 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(arg2));
        let v0 = KioskFunded{amount: 0x2::coin::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg2)};
        0x2::event::emit<KioskFunded>(v0);
    }

    public fun get_circulating_supply(arg0: &QualityMarketplace) : u64 {
        let v0 = 0x2::coin::total_supply<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.treasury_cap);
        let v1 = 0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.reward_pool) + 0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.liquidity_vault);
        if (v0 > v1) {
            v0 - v1
        } else {
            0
    ...
    public fun get_current_burn_rate(arg0: &QualityMarketplace) : u64 {
        0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::burn_bps(get_circulating_supply(arg0), &arg0.economic_config)
    }

    public fun get_current_tier(arg0: &QualityMarketplace) : u8 {
        0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::get_tier(get_circulating_supply(arg0), &arg0.economic_config)
    }
    ...
    public fun get_marketplace_stats(arg0: &QualityMarketplace) : (u64, u64, u64, u64, u64) {
        (arg0.total_submissions, arg0.total_purchases, arg0.total_burned, 0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.reward_pool), 0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.liquidity_vault))
    }
    ...
    public fun initialize_marketplace(arg0: 0x2::coin::TreasuryCap<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 100000000000000000;
        let v1 = 0x2::coin::mint<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0, v0, arg3);
        let v2 = 70000000000000000;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(v1, arg1);
        let v3 = AdminCap{id: 0x2::object::new(arg3)};
        let v4 = ValidatorCap{id: 0x2::object::new(arg3)};
        let v5 = KioskDesk{
            sonar_reserve            : 0x2::balance::zero<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(),
        ...
        let v8 = QualityMarketplace{
            ...
            treasury_cap          : arg0,
            reward_pool           : 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut v1, v2, arg3)),
            reward_pool_initial   : v2,
            reward_pool_allocated : 0,
            liquidity_vault       : 0x2::balance::zero<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(),
            kiosk                 : v5,
            total_submissions     : 0,
            total_purchases       : 0,
            total_burned          : 0,
            ...
            economic_config       : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::default_config(),
            circuit_breaker       : v6,
    ...
    public entry fun purchase_dataset(arg0: &mut QualityMarketplace, arg1: &mut AudioSubmission, arg2: 0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg2) >= v0, 3003);
        let v1 = get_circulating_supply(arg0);
        let v2 = 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::get_tier(v1, &arg0.economic_config);
        update_kiosk_tier_and_price(arg0);
        let (v3, v4, v5, v6) = 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::calculate_purchase_splits(v0, v1, &arg0.economic_config);
        if (v3 > 0) {
            0x2::balance::decrease_supply<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::supply_mut<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.treasury_cap), 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg2, v3, arg3)));
            arg0.total_burned = arg0.total_burned + v3;
        };
        if (v4 > 0) {
            let v7 = 0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg2, v4, arg3);
            let v8 = v4 * arg0.kiosk.sui_cut_percentage / 100;
            if (v8 > 0) {
                0x2::balance::join<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.kiosk.sonar_reserve, 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut v7, v8, arg3)));
            };
            if (v4 - v8 > 0) {
                0x2::balance::join<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.liquidity_vault, 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(v7));
            } else {
                0x2::coin::destroy_zero<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(v7);
            };
        };
        if (v6 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg2, v6, arg3), arg0.treasury_address);
        };
        if (v5 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg2, v5, arg3), arg1.uploader);
        };
        if (0x2::coin::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(arg2, 0x2::tx_context::sender(arg3));
        } else {
            0x2::coin::destroy_zero<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(arg2);
        };
        ...
        if (v9 > 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.reward_pool, v9, arg3), arg1.uploader);
        };
        arg1.purchase_count = arg1.purchase_count + 1;
        arg0.total_purchases = arg0.total_purchases + 1;
        let v10 = 0x2::tx_context::sender(arg3);
        0x2::transfer::public_transfer<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::purchase_policy::PurchaseReceipt>(0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::purchase_policy::mint_receipt(arg1.seal_policy_id, 0x2::object::uid_to_inner(&arg1.id), v10, arg3), v10);
        let v11 = DatasetPurchased{
            submission_id       : 0x2::object::uid_to_inner(&arg1.id),
            buyer               : v10,
            price               : v0,
            burned              : v3,
            burn_rate_bps       : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::burn_bps(v1, &arg0.economic_config),
            liquidity_allocated : v4,
            liquidity_rate_bps  : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::liquidity_bps(v1, &arg0.economic_config),
            uploader_paid       : v5,
            uploader_rate_bps   : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::uploader_bps(v1, &arg0.economic_config),
            treasury_paid       : v6,
    ...
    public entry fun purchase_dataset_kiosk(arg0: &mut QualityMarketplace, arg1: &mut AudioSubmission, arg2: 0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!is_circuit_breaker_active(&arg0.circuit_breaker, arg3), 5002);
        assert!(arg1.status == 1, 3002);
        assert!(arg1.listed_for_sale, 3001);
        let v0 = arg1.dataset_price;
    ...
    public entry fun purchase_dataset_kiosk_with_sui(arg0: &mut QualityMarketplace, arg1: &mut AudioSubmission, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.kiosk.sonar_reserve) >= v1, 4001);
        ...
        let v3 = 0x2::coin::take<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.kiosk.sonar_reserve, v1, arg3);
        let v4 = get_circulating_supply(arg0);
        let (v5, v6, v7, v8) = 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::calculate_purchase_splits(v1, v4, &arg0.economic_config);
        if (v5 > 0) {
            0x2::balance::decrease_supply<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::supply_mut<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.treasury_cap), 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut v3, v5, arg3)));
            arg0.total_burned = arg0.total_burned + v5;
        };
        if (v6 > 0) {
            let v9 = 0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut v3, v6, arg3);
            let v10 = v6 * arg0.kiosk.sui_cut_percentage / 100;
            if (v10 > 0) {
                0x2::balance::join<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.kiosk.sonar_reserve, 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut v9, v10, arg3)));
            };
            if (v6 - v10 > 0) {
                0x2::balance::join<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.liquidity_vault, 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(v9));
            } else {
                0x2::coin::destroy_zero<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(v9);
            };
        };
        if (v8 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut v3, v8, arg3), arg0.treasury_address);
        };
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::split<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut v3, v7, arg3), arg1.uploader);
        };
        if (0x2::coin::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&v3) > 0) {
            0x2::balance::join<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.kiosk.sonar_reserve, 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(v3));
        } else {
            0x2::coin::destroy_zero<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(v3);
        };
        ...
        if (v11 > 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.reward_pool, v11, arg3), arg1.uploader);
        };
        arg1.purchase_count = arg1.purchase_count + 1;
        arg0.total_purchases = arg0.total_purchases + 1;
        arg0.kiosk.total_datasets_purchased = arg0.kiosk.total_datasets_purchased + 1;
        ...
        let v13 = DatasetPurchased{
            ...
            price               : v1,
            burned              : v5,
            burn_rate_bps       : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::burn_bps(v4, &arg0.economic_config),
            liquidity_allocated : v6,
            liquidity_rate_bps  : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::liquidity_bps(v4, &arg0.economic_config),
            uploader_paid       : v7,
            uploader_rate_bps   : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::uploader_bps(v4, &arg0.economic_config),
            treasury_paid       : v8,
            circulating_supply  : v4,
            economic_tier       : 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::get_tier(v4, &arg0.economic_config),
            seal_policy_id      : arg1.seal_policy_id,
            purchase_timestamp  : 0x2::tx_context::epoch(arg3),
        };
    ...
    public entry fun sell_sonar(arg0: &mut QualityMarketplace, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 3003);
        assert!(0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.kiosk.sonar_reserve) >= v2, 4001);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.kiosk.sonar_reserve, v2, arg2), 0x2::tx_context::sender(arg2));
    ...
    public entry fun submit_audio(arg0: &mut QualityMarketplace, arg1: 0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::option::Option<vector<u8>>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!is_circuit_breaker_active(&arg0.circuit_breaker, arg6), 5002);
        let v0 = get_circulating_supply(arg0);
        let v1 = 0x2::coin::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg1);
        assert!(v1 >= 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::calculate_burn_fee(v0), 2001);
        0x2::balance::decrease_supply<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::supply_mut<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.treasury_cap), 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(arg1));
        arg0.total_burned = arg0.total_burned + v1;
        assert!(0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.reward_pool) >= 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::calculate_reward(v0, 30), 2002);
    ...
    public entry fun submit_audio_dataset(arg0: &mut QualityMarketplace, arg1: 0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: vector<u64>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = get_circulating_supply(arg0);
        let v2 = 0x2::coin::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg1);
        assert!(v2 >= 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::calculate_burn_fee(v1), 2001);
        0x2::balance::decrease_supply<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(0x2::coin::supply_mut<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg0.treasury_cap), 0x2::coin::into_balance<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(arg1));
        arg0.total_burned = arg0.total_burned + v2;
        assert!(0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg0.reward_pool) >= 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::calculate_reward(v1, 30), 2002);
    ...
    public fun update_economic_config(arg0: &AdminCap, arg1: &mut QualityMarketplace, arg2: 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::EconomicConfig) {
        assert!(0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::validate_config(&arg2), 5001);
    ...
    public entry fun update_economic_config_entry(arg0: &AdminCap, arg1: &mut QualityMarketplace, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64) {
        update_economic_config(arg0, arg1, 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::create_config(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13));
    }
    ...
    fun update_kiosk_tier_and_price(arg0: &mut QualityMarketplace) {
        let v0 = 0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::economics::get_tier(get_circulating_supply(arg0), &arg0.economic_config);
    ...
    public entry fun withdraw_liquidity_vault(arg0: &AdminCap, arg1: &mut QualityMarketplace, arg2: u64, arg3: address, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1.total_withdrawn_this_epoch + arg2 <= 0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg1.liquidity_vault) * v1.max_per_epoch_bps / 10000, 5005);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&mut arg1.liquidity_vault, arg2, arg5), arg3);
        ...
        let v2 = LiquidityVaultWithdrawal{
            ...
            recipient         : arg3,
            reason            : arg4,
            remaining_balance : 0x2::balance::value<0xdff609ce3174576c8a0e81c9f65775e7e7fe5b11c5ef375345fab4ca4b837e9d::sonar_token::SONAR_TOKEN>(&arg1.liquidity_vault),
