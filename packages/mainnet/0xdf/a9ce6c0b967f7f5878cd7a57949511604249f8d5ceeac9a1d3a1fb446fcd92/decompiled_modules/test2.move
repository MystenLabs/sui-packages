module 0xdfa9ce6c0b967f7f5878cd7a57949511604249f8d5ceeac9a1d3a1fb446fcd92::test2 {
    ...
    fun init(arg0: TEST2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::option::fill<0x2::url::Url>(&mut v0, 0x2::url::new_unsafe_from_bytes(b"https://yolo-hola-dev.s3.amazonaws.com/uploads/1741771546644.png"));
