module 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::scoreboard {
    ...
    public(friend) fun add_score(arg0: &mut Scoreboard, arg1: u64, arg2: u64, arg3: address) {
        ...
        if (!0x2::table::contains<address, ScoreInfo>(v1, arg3)) {
            ...
            0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_score_added(v0, arg3, arg1, 0, arg1);
        } else {
            let v2 = 0x2::table::borrow_mut<address, ScoreInfo>(v1, arg3);
            let v3 = v2.score;
            let v4 = 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::checked_add(v3, arg1);
            v2.score = v4;
            0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_score_added(v0, arg3, arg1, v3, v4);
        };
    }
    ...
    public(friend) fun calculate_convert(arg0: &mut Scoreboard, arg1: &0x2::clock::Clock, arg2: address) : u64 {
        ...
        let v3 = 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::checked_add(v2, v0);
        v1.score_debt = v3;
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_score_debt_updated(0x2::object::id<Scoreboard>(arg0), arg2, v0, v2, v3, 2);
        v0
    }
    ...
    public(friend) fun calculate_convert_amount(arg0: &mut Scoreboard, arg1: &0x2::clock::Clock, arg2: address, arg3: u64) : u64 {
        ...
        let v2 = 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::checked_add(v1, arg3);
        v0.score_debt = v2;
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_score_debt_updated(0x2::object::id<Scoreboard>(arg0), arg2, arg3, v1, v2, 2);
        arg3
    }
    ...
    fun calculate_current_score_at(arg0: &ScoreInfo, arg1: u64) : u64 {
        ...
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::checked_add(arg0.score, 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::linear_accrued(arg0.score_per_duration, arg1 - arg0.updated_at, arg0.duration))
    }
    ...
    fun calculate_current_score_at_with_pause(arg0: &ScoreInfo, arg1: u64, arg2: u64) : u64 {
        ...
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::checked_add(arg0.score, 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::linear_accrued(arg0.score_per_duration, v0 - v1, arg0.duration))
    }

    public fun create_shared_scoreboard(arg0: &0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::global_config::GlobalConfig, arg1: &0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::project_cap::ProjectCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::global_config::assert_domain_enabled(arg0, 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::global_config::scoreboard_domain());
        let v0 = Scoreboard{
            id                      : 0x2::object::new(arg2),
            project_id              : 0x2::object::id<0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::project_cap::ProjectCap>(arg1),
    ...
    public fun get_project_cap_ID(arg0: &0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::project_cap::ProjectCap) : 0x2::object::ID {
        0x2::object::id<0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::project_cap::ProjectCap>(arg0)
    }
    ...
    public(friend) fun new_scoreboard(arg0: &0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::project_cap::ProjectCap, arg1: &mut 0x2::tx_context::TxContext) : Scoreboard {
        Scoreboard{
    ...
    public(friend) fun restore_tokenized_score(arg0: &mut Scoreboard, arg1: &0x2::clock::Clock, arg2: address, arg3: u64) {
        ...
        if (v5 >= arg3) {
            ...
            v4.score_debt = 0;
            v4.score = 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::checked_add(v4.score, arg3 - v5);
        };
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_score_debt_updated(v0, arg2, arg3, v5, v4.score_debt, 3);
    }
    ...
    public(friend) fun set_linear_time_score(arg0: &mut Scoreboard, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: address) {
        ...
        if (!0x2::table::contains<address, ScoreInfo>(v3, arg4)) {
            ...
            0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_linear_time_score_set(v0, arg4, 0, 0, 0, arg1, 0, arg2, 0, v1);
        } else {
            ...
            0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_linear_time_score_set(v0, arg4, v5.score, v6, v5.score_per_duration, arg1, v5.duration, arg2, v5.updated_at, v1);
        };
    }
    ...
    public(friend) fun sub_score(arg0: &mut Scoreboard, arg1: u64, arg2: address) {
        ...
        let v4 = 0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::point_math::checked_add(v3, arg1);
        v2.score_debt = v4;
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_score_debt_updated(v0, arg2, arg1, v3, v4, 1);
    }
    ...
    public(friend) fun update_linear_time_score(arg0: &mut Scoreboard, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: address) {
        ...
        v4.updated_at = v1;
        v4.linear_paused_ms_at_update = v2;
        0x810c9b47bd1f6eb88c4f6e29221a5408882dcb100ddf13074a9efe6917116039::event::emit_linear_time_score_updated(v0, arg4, v4.score, v5, v4.score_per_duration, arg1, v4.duration, arg2, v4.updated_at, v1);
    }
