module 0xdf365b1fe139949836c2714cd24fae56e73d1688ff1fcfb2aeb95a5014ae4a38::blastisass {
    struct BLASTISASS has drop {
        dummy_field: bool,
    }

    fun init(arg0: BLASTISASS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BLASTISASS>(arg0, 9, b"BLASTISASS", b"_B_", b"BLAST IS ASS smells like it too", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
