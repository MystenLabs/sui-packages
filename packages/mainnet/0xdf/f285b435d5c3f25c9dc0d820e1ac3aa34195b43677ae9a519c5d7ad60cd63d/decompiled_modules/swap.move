module 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap {
    struct SwapContext {
    ...
    public fun end_swap(arg0: SwapContext, arg1: EmptyTokenTicket) {
        ...
        assert!(0x2::bag::is_empty(&v0), 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::error::balances_not_empty());
    ...
    public fun take_balance<T0: drop, T1>(arg0: &mut SwapContext, arg1: &0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::router::Router, arg2: T0, arg3: u64) : 0x2::balance::Balance<T1> {
        assert!(0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::router::is_package_whitelisted<T0>(arg1), 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::error::package_not_whitelisted());
        take_balance_internal<T1>(arg0, arg3)
    }

    fun take_balance_internal<T0>(arg0: &mut SwapContext, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::error::invalid_coin_type());
        ...
        assert!(v1 >= v2, 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::error::insufficient_balance());
        if (v2 == v1) {
