module 0xdfb20db527693af0fdd2266cf5ce8dd5b5f92d549be1b48797eeaaded4f669dd::usdt {
    struct USDT has drop {
        dummy_field: bool,
    }

    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/52EjzRxH8JdZmuK8UP53cUe5o-z4ri0sSmTEgaKPl6k";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/52EjzRxH8JdZmuK8UP53cUe5o-z4ri0sSmTEgaKPl6k"))
        };
