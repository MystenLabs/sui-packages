module 0xdfb6d8e041804d629b7412646573284cf7011cb421f255ca29d415a979169345::cnsnft2516 {
    struct CNSNFT2516 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2516, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2516>(arg0, arg1);
