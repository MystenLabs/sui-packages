module 0xdfea298b9b4e1d948dec51baa108d595efdea6b8ab46524aa4209d5eb7ef5bd4::cnsnft2817 {
    struct CNSNFT2817 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2817, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2817>(arg0, arg1);
