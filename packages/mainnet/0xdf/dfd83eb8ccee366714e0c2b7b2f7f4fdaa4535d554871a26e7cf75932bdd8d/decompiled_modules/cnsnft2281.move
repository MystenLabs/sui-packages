module 0xdfdfd83eb8ccee366714e0c2b7b2f7f4fdaa4535d554871a26e7cf75932bdd8d::cnsnft2281 {
    struct CNSNFT2281 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2281, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2281>(arg0, arg1);
