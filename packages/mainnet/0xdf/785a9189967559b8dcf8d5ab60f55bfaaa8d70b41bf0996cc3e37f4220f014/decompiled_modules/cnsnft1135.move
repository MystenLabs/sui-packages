module 0xdf785a9189967559b8dcf8d5ab60f55bfaaa8d70b41bf0996cc3e37f4220f014::cnsnft1135 {
    struct CNSNFT1135 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1135, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1135>(arg0, arg1);
