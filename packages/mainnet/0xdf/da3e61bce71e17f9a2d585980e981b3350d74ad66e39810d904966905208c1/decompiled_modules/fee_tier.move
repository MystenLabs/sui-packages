module 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::fee_tier {
    ...
    public(friend) fun collect_fee<T0>(arg0: &mut FeeTier, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_invalid_coin_type());
    ...
    public(friend) fun set_default_fee_rate(arg0: &mut FeeTier, arg1: u32) {
        assert!(arg1 <= 200000, 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_max_fee_rate_limit());
