module 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::mm_vault {
    ...
    public(friend) fun swap<T0, T1>(arg0: &mut MMVault, arg1: 0x1::string::String, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: &0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::Versioned, arg8: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::check_version(arg7);
        ...
        assert!(v3, 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_invalid_signature());
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v6), 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_insufficient_balance());
        let v7 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.balances, v6);
        assert!(0x2::balance::value<T1>(v7) >= arg3, 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_insufficient_balance());
    ...
    fun check_cap(arg0: &MMVault, arg1: &MMVaultCap) {
        assert!(arg0.cap_id == 0x2::object::id<MMVaultCap>(arg1), 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_invalid_cap());
    }

    fun check_signer(arg0: &MMVault, arg1: address) {
        assert!(arg0.signer == arg1, 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_invalid_signer());
    }

    public fun create_vault(arg0: &mut MMRegistry, arg1: 0x1::string::String, arg2: address, arg3: &0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::admin_cap::AdminCap, arg4: &0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::Versioned, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::check_version(arg4);
    ...
    public fun deposit<T0>(arg0: &mut MMVault, arg1: 0x2::coin::Coin<T0>, arg2: &0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::Versioned) {
    ...
    fun parse_signature(arg0: vector<u8>) : (address, vector<u8>, vector<u8>) {
        assert!(*0x1::vector::borrow<u8>(&arg0, 0) == 0, 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_scheme_not_support());
        let v0 = x"00";
        let v1 = b"";
    ...
    public fun update_signer(arg0: &mut MMVault, arg1: address, arg2: &MMVaultCap, arg3: &0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::Versioned) {
    ...
    public fun withdraw<T0>(arg0: &mut MMVault, arg1: u64, arg2: &MMVaultCap, arg3: &0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::Versioned, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::check_version(arg3);
        check_cap(arg0, arg2);
        assert!(arg1 > 0, 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_invalid_amount());
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::errors::err_coin_not_in_vault());
    ...
    public fun withdraw_and_transfer<T0>(arg0: &mut MMVault, arg1: u64, arg2: &MMVaultCap, arg3: &0xdfda3e61bce71e17f9a2d585980e981b3350d74ad66e39810d904966905208c1::versioned::Versioned, arg4: &mut 0x2::tx_context::TxContext) {
