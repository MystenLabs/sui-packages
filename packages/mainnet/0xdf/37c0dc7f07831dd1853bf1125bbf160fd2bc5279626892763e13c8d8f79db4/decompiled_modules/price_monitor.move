module 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor {
    ...
    fun calculate_deviation_bps(arg0: u128, arg1: u128) : u64 {
        ...
        let v1 = 0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_div_floor(v0, (0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_basis_points_denominator() as u128), arg1);
    ...
    fun calculate_z_score(arg0: u128, arg1: u128, arg2: u128) : u128 {
        ...
        0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_div_floor(v0, (0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_basis_points_denominator() as u128), arg2)
    }
    ...
    public fun emergency_pause(arg0: &mut PriceMonitor, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.last_anomaly_level = 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_emergency();
        let v0 = EventCircuitBreakerActivated{
            monitor_id   : 0x2::object::id<PriceMonitor>(arg0),
            level        : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_emergency(),
    ...
    public fun emergency_resume(arg0: &mut PriceMonitor, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.last_anomaly_level = 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal();
        arg0.consecutive_anomalies = 0;
        let v0 = EventCircuitBreakerDeactivated{
            monitor_id   : 0x2::object::id<PriceMonitor>(arg0),
            level        : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal(),
            timestamp_ms : 0x2::clock::timestamp_ms(arg1),
        };
    ...
    fun emit_validation_events(arg0: &PriceMonitor, arg1: &DeviationValidationResult, arg2: &StatisticalValidationResult, arg3: &DeviationValidationResult, arg4: &CircuitBreakerResult, arg5: u128, arg6: u128, arg7: u64) {
        if (arg1.anomaly_level > 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal()) {
        ...
        if (arg3.anomaly_level > 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal()) {
        ...
        if (arg2.anomaly_level > 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal()) {
    ...
    fun evaluate_circuit_breaker(arg0: &PriceMonitor, arg1: &DeviationValidationResult, arg2: &DeviationValidationResult, arg3: &StatisticalValidationResult, arg4: u64) : CircuitBreakerResult {
        ...
        CircuitBreakerResult{
            level           : v0,
            should_activate : v0 != 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal(),
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PriceMonitorConfig{
            warning_deviation_bps            : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_warning_deviation_bps(),
            critical_deviation_bps           : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_critical_deviation_bps(),
            emergency_deviation_bps          : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_emergency_deviation_bps(),
            warning_zscore_threshold         : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_warning_zscore_threshold(),
            critical_zscore_threshold        : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_critical_zscore_threshold(),
            emergency_zscore_threshold       : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_emergency_zscore_threshold(),
            critical_anomaly_threshold       : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_critical_anomaly_threshold(),
            emergency_anomaly_threshold      : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_emergency_anomaly_threshold(),
            anomaly_cooldown_period_ms       : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_cooldown_period_ms(),
            max_price_age_ms                 : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_max_price_age_ms(),
            max_price_history_age_ms         : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_max_price_history_age_ms(),
            min_price_interval_ms            : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_min_price_interval_ms(),
            max_price_history_size           : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_max_price_history_size(),
            min_prices_for_analysis          : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_min_prices_for_analysis(),
            enable_oracle_pool_validation    : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_enable_oracle_pool_validation(),
            enable_oracle_history_validation : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_enable_oracle_history_validation(),
            enable_statistical_validation    : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_enable_statistical_validation(),
            enable_critical_escalation       : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_enable_critical_escalation(),
            enable_emergency_escalation      : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_enable_emergency_escalation(),
        };
        let v1 = PriceMonitor{
            ...
            max_history_size               : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_max_price_history_size(),
            anomaly_count                  : 0,
            consecutive_anomalies          : 0,
            is_emergency_paused            : false,
            pause_timestamp_ms             : 0,
            last_anomaly_level             : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal(),
    ...
    fun should_escalate_circuit_breaker(arg0: &PriceMonitor, arg1: u8, arg2: u64) : bool {
        if (arg1 == 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal() || arg1 == 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_warning()) {
            return false
        };
        if (arg2 - arg0.last_anomaly_timestamp_ms < arg0.config.anomaly_cooldown_period_ms) {
            return false
        };
        let v0 = if (arg1 == 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_critical()) {
        ...
        let v1 = if (arg1 == 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_emergency()) {
    ...
    fun validate_oracle_history_deviation(arg0: &PriceMonitor, arg1: u128) : DeviationValidationResult {
        if (0x2::linked_table::length<u64, PricePoint>(&arg0.price_history) == 0) {
            return DeviationValidationResult{
                deviation_bps : 0,
                anomaly_level : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal(),
                anomaly_flags : 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_none(),
            }
        };
        let v0 = 0x2::linked_table::front<u64, PricePoint>(&arg0.price_history);
        ...
        let v2 = if (v1 >= 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_emergency_history_deviation_bps()) {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_emergency()
        } else if (v1 >= 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_critical_history_deviation_bps()) {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_critical()
        } else if (v1 >= 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_warning_history_deviation_bps()) {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_warning()
        } else {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal()
        };
        let v3 = if (v2 > 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal()) {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_deviation()
        } else {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_none()
        };
    ...
    fun validate_oracle_pool_deviation(arg0: &PriceMonitor, arg1: u128, arg2: u128) : DeviationValidationResult {
        ...
        let v2 = if (v1 > 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal()) {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_deviation()
        } else {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_none()
        };
    ...
    public fun validate_price<T0, T1, T2>(arg0: &mut PriceMonitor, arg1: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg2: &0x8c9b843944257991e5f813039d9fb70e0358ae2ff28b2bfdf2624dd6d8251bb3::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : PriceValidationResult {
        ...
        let v5 = if (arg0.config.enable_oracle_pool_validation) {
            ...
            DeviationValidationResult{deviation_bps: 0, anomaly_level: 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal(), anomaly_flags: 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_none()}
        };
        let v6 = v5;
        ...
        let v9 = if (arg0.config.enable_statistical_validation) {
            ...
            StatisticalValidationResult{z_score: 0, anomaly_level: 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal(), anomaly_flags: 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_none()}
        };
        let v10 = v9;
        ...
        PriceValidationResult{
            ...
            is_valid              : v11.level == 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal(),
            price_q64             : v2,
        }
    }
    ...
    fun validate_statistical_anomaly(arg0: &PriceMonitor, arg1: u128) : StatisticalValidationResult {
        ...
        let v4 = if (v3 > 0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_level_normal()) {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_statistical()
        } else {
            0xdf37c0dc7f07831dd1853bf1125bbf160fd2bc5279626892763e13c8d8f79db4::price_monitor_consts::get_anomaly_flag_none()
        };
