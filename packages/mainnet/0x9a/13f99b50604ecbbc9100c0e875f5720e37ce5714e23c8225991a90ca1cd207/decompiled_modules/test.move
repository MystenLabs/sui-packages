module 0x9a13f99b50604ecbbc9100c0e875f5720e37ce5714e23c8225991a90ca1cd207::test {
    ...
    fun init(arg0: TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST>(arg0, 9, b"TEST", b"TEST", b"gello", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"hello world")), arg1);
