module 0x9a84425f4ed0262191e256e65363232b857263592b7dd2aad12d60a486b16c77::mm_vault {
    ...
    fun calculate_price_with_expo(arg0: u64, arg1: u64, arg2: bool) : u256 {
        if (arg2) {
            if (arg1 > 18) {
                let v1 = (arg1 as u64) - 18;
                assert!(v1 <= 77, 4);
                (arg0 as u256) / (0x2::math::pow(10, (v1 as u8)) as u256)
            } else {
                (arg0 as u256) * (0x2::math::pow(10, ((18 - (arg1 as u64)) as u8)) as u256)
            }
        } else {
            let v2 = 18 + (arg1 as u64);
            assert!(v2 <= 77, 4);
            (arg0 as u256) * (0x2::math::pow(10, (v2 as u8)) as u256)
        }
    }
    ...
    fun get_deep_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x2::clock::Clock) : u256 {
        ...
        calculate_price_with_expo(v5, v6, 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v4))
    }
