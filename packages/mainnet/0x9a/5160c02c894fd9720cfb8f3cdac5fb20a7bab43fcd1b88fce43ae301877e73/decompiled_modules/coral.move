module 0x9a5160c02c894fd9720cfb8f3cdac5fb20a7bab43fcd1b88fce43ae301877e73::coral {
    ...
    public fun force_resolve_market<T0>(arg0: &CoralManagerCap, arg1: &mut 0xb3aed6cae5afa34d74da7e3e8de627bfdf54009563f38cc244d9c1cefc22068f::market::Market<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = CoralWitness{dummy_field: false};
        0xb3aed6cae5afa34d74da7e3e8de627bfdf54009563f38cc244d9c1cefc22068f::market::resolve_market<T0, CoralWitness>(arg1, arg2, v0, arg3);
    }
    ...
    public fun resolve_market<T0, T1>(arg0: &mut 0xb3aed6cae5afa34d74da7e3e8de627bfdf54009563f38cc244d9c1cefc22068f::market::Market<T0>, arg1: &mut 0xd382c7d5cb16fe6b42ea3d9a1354819028b41c6c87b62a81a0846c5e65bed411::query::Query<T1>, arg2: &0x2::clock::Clock) {
        assert!(0xb3aed6cae5afa34d74da7e3e8de627bfdf54009563f38cc244d9c1cefc22068f::market::oracle_id<T0>(arg0) == 0x1::option::some<0x2::object::ID>(0xd382c7d5cb16fe6b42ea3d9a1354819028b41c6c87b62a81a0846c5e65bed411::query::id<T1>(arg1)), 1);
        ...
        resolve_market_<T0>(arg0, *0x1::option::borrow<vector<u8>>(&v0), arg2);
    }

    public(friend) fun resolve_market_<T0>(arg0: &mut 0xb3aed6cae5afa34d74da7e3e8de627bfdf54009563f38cc244d9c1cefc22068f::market::Market<T0>, arg1: vector<u8>, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::vec_set::keys<vector<u8>>(0xb3aed6cae5afa34d74da7e3e8de627bfdf54009563f38cc244d9c1cefc22068f::market::outcome_values<T0>(arg0));
        let v1 = 0;
        let v2;
        while (v1 < 0x1::vector::length<vector<u8>>(v0)) {
            if (0x1::vector::borrow<vector<u8>>(v0, v1) == &arg1) {
                ...
                0xb3aed6cae5afa34d74da7e3e8de627bfdf54009563f38cc244d9c1cefc22068f::market::resolve_market<T0, CoralWitness>(arg0, 0x1::option::destroy_some<u64>(v2), v3, arg2);
                return
            };
            v1 = v1 + 1;
        };
