module 0x9ab292ef1acbdf5e05164b3dd9f0b7828d908418e12ba2ff1ceee3d6ea694a90::reward1443 {
    struct REWARD1443 has drop {
        dummy_field: bool,
    }

    struct TICKET_1443 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1443(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1443>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1443>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1443, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1443>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1443>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1443>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1443>>(v5, 0x2::tx_context::sender(arg1));
    }
