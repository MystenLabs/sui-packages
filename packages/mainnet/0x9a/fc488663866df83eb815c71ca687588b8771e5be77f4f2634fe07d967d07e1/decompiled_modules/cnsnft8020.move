module 0x9afc488663866df83eb815c71ca687588b8771e5be77f4f2634fe07d967d07e1::cnsnft8020 {
    struct CNSNFT8020 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8020, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8020>(arg0, arg1);
