module 0x5e2f4359b5c0311954f502c4e1e12a845e85152b67e033ca6f8590b5781606ff::blackjack {
    ...
    fun dealer_move<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut BlackjackTable<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v16 == 200) {
            ...
            while (0x1::vector::length<u64>(&v33) != 0) {
                v38 = v38 + 0x1::vector::pop_back<u64>(&mut v33);
            };
            0x1::vector::destroy_empty<u64>(v33);
            let v39 = 0;
            0x1::vector::reverse<u64>(&mut v36);
            while (0x1::vector::length<u64>(&v36) != 0) {
                v39 = v39 + 0x1::vector::pop_back<u64>(&mut v36);
            };
            0x1::vector::destroy_empty<u64>(v36);
            payout<T0>(arg0, arg1, v38, v39, arg2);
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_blackjack_game_result<T0, Blackjack>(arg0, v4, v5, v38, v39, v30, v23, v6, v27);
        };
    }
    ...
    fun is_soft_17(arg0: &vector<u8>, arg1: u8) : bool {
        if (contains_aces(arg0) && arg1 == 17) {
            ...
            while (0x1::vector::length<u8>(&v1) != 0) {
                ...
                let v3 = x"000d1a27";
                if (!0x1::vector::contains<u8>(&v3, &v2)) {
    ...
    fun surrender<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut BlackjackTable<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_blackjack_game_result<T0, Blackjack>(arg0, 0x2::object::uid_to_inner(&arg1.id), arg1.round_number, v0, v12, v10, v3, arg1.creator, v7);
    }
