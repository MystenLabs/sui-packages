module 0x9a95659b5b4532cb713b4a93ca07ad1f3732f77bc08060dbe4af04e006994660::cnsnft9828 {
    struct CNSNFT9828 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9828, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9828>(arg0, arg1);
