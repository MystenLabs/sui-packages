module 0x9a47c73e87bd6f5c6955b7fbb3dabe4919cf8a7f2e5fc8677ca684de531fa14b::reward9664 {
    struct REWARD9664 has drop {
        dummy_field: bool,
    }

    struct TICKET_9664 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9664(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9664>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9664>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9664, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9664>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9664>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9664>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9664>>(v5, 0x2::tx_context::sender(arg1));
    }
