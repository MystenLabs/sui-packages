module 0x9a923e63a65818226f58795b20b4ea9fdc2cb49dda32d1fcfe15a172be562b78::movexnft4343 {
    struct MOVEXNFT4343 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT4343, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT4343>(arg0, arg1);
