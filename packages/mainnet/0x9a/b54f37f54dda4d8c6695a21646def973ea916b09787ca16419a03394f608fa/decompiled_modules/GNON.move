module 0x9ab54f37f54dda4d8c6695a21646def973ea916b09787ca16419a03394f608fa::GNON {
    struct GNON has drop {
        dummy_field: bool,
    }

    fun init(arg0: GNON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<GNON>(arg0, 2, b"GNON", b"numogram", b"numogram", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/Q1kSeCPo29VsmxKeHCMCTIqln7NbNJwrGmGmjQxXykA?ext=png")), arg1);
