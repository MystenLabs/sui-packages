module 0x9a470e2a272f1aa1f81f5cd2a3066f878fffd9ce9c8d22309ad62f81e5b77dd2::fee {
    struct FEE has drop {
        dummy_field: bool,
    }
    ...
    struct ProposalFeePendingApplied has copy, drop {
    ...
    public fun apply_pending_proposal_fee(arg0: &mut FeeManager, arg1: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        if (0x1::option::is_none<u64>(&arg0.pending_proposal_fee_effective_ts)) {
            return
        };
        ...
        if (0x1::option::is_some<u64>(&arg0.pending_proposal_fee)) {
            let v1 = *0x1::option::borrow<u64>(&arg0.pending_proposal_fee);
            arg0.proposal_creation_fee_per_outcome = v1;
            arg0.pending_proposal_fee = 0x1::option::none<u64>();
            arg0.pending_proposal_fee_effective_ts = 0x1::option::none<u64>();
            let v2 = ProposalFeePendingApplied{
                new_proposal_fee : v1,
                timestamp        : v0,
            };
            0x2::event::emit<ProposalFeePendingApplied>(v2);
        } else {
            arg0.pending_proposal_fee_effective_ts = 0x1::option::none<u64>();
        };
    }
    ...
    public fun deposit_fees<T0>(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        assert_admin_cap(arg0, arg1);
        deposit_fees_internal<T0>(arg0, arg2);
    }

    fun deposit_fees_internal<T0>(arg0: &mut FeeManager, arg1: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun deposit_fees_with_proposal<T0>(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock) {
        assert_admin_cap(arg0, arg1);
        let v0 = deposit_fees_internal<T0>(arg0, arg2);
        if (v0 == 0) {
            return
        };
    ...
    fun deposit_payment(arg0: &mut FeeManager, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock) : u64 {
        ...
        assert!(v0 == arg1, 0);
        deposit_fees_internal<0x2::sui::SUI>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(arg2));
        v0
    }
    ...
    public fun deposit_proposal_creation_payment(arg0: &mut FeeManager, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        apply_pending_proposal_fee(arg0, arg3);
    ...
    fun init(arg0: FEE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = FeeManager{
            ...
            dao_creation_fee                  : 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::default_dao_creation_fee(),
            proposal_creation_fee_per_outcome : 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::default_proposal_fee_per_outcome(),
            launchpad_creation_fee            : 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::default_launchpad_creation_fee(),
            pending_proposal_fee              : 0x1::option::none<u64>(),
            pending_proposal_fee_effective_ts : 0x1::option::none<u64>(),
            proposal_fee_baseline             : 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::default_proposal_fee_per_outcome(),
    ...
    fun max_allowed_from_baseline(arg0: u64) : u64 {
        if (arg0 > 18446744073709551615 / 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::max_fee_multiplier()) {
            18446744073709551615
        } else {
            arg0 * 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::max_fee_multiplier()
        }
    }
    ...
    public fun update_coin_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 >= v0.creation_baseline_reset_timestamp + 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::six_months_ms()) {
        ...
        if (arg3 <= v0.dao_creation_fee) {
            ...
            v0.pending_creation_fee_effective_timestamp = 0x1::option::some<u64>(v1 + 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::six_months_ms());
        };
    }
    ...
    public fun update_coin_proposal_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, CoinFeeConfig>(&mut arg0.id, arg2);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        if (v1 >= v0.proposal_baseline_reset_timestamp + 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::six_months_ms()) {
        ...
        if (arg3 <= v0.proposal_creation_fee_per_outcome) {
            ...
            v0.pending_proposal_fee_effective_timestamp = 0x1::option::some<u64>(v1 + 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::six_months_ms());
        };
    }
    ...
    public entry fun update_launchpad_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = LaunchpadCreationFeeUpdated{
            old_fee   : arg0.launchpad_creation_fee,
            new_fee   : arg2,
            admin     : 0x2::tx_context::sender(arg4),
            timestamp : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<LaunchpadCreationFeeUpdated>(v0);
    }
    ...
    public entry fun update_proposal_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 >= arg0.proposal_baseline_reset_ts + 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::six_months_ms()) {
        ...
        if (arg2 <= v1) {
            ...
            let v3 = v0 + 0x8085d42c3f597247c761e0a15e56d201a6e9727f2dff5a1d794491416b5ce82f::constants::six_months_ms();
