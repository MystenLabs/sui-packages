module 0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::nest {
    ...
    public entry fun clear_stale_stake(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::kiosk::has_item_with_type<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::duck_nft::DuckNFT>(arg1, v1), 1);
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::NestMintCap, arg4: &mut 0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg0.owner == v0, 6);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.staked_duck_id), 13);
        let v1 = *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id);
        assert!(0x2::kiosk::has_item_with_type<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::duck_nft::DuckNFT>(arg1, v1), 2);
        ...
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SHTTOKEN>>(0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::mint_for_nest(arg3, arg4, v10, arg7), v0);
        };
    ...
    public fun is_staked_duck_in_kiosk(arg0: &Nest, arg1: &0x2::kiosk::Kiosk) : (bool, bool) {
        if (0x1::option::is_none<0x2::object::ID>(&arg0.staked_duck_id)) {
            ...
            (true, 0x2::kiosk::has_item_with_type<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::duck_nft::DuckNFT>(arg1, *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id)))
        }
    }
    ...
    public entry fun stake_duck(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut HarvestStats, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x2::object::ID>(&arg3.staked_duck_id)) {
            if (0x2::kiosk::has_item_with_type<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::duck_nft::DuckNFT>(arg0, *0x1::option::borrow<0x2::object::ID>(&arg3.staked_duck_id))) {
                abort 12
            };
        ...
        let v1 = 0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::duck_nft::get_rarity_level(0x2::kiosk::borrow<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::duck_nft::DuckNFT>(arg0, arg1, arg2));
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::NestMintCap, arg4: &mut 0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::kiosk::has_item_with_type<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::duck_nft::DuckNFT>(arg1, v1)) {
            ...
            if (v3 > 0) {
                ...
                if (v9 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SHTTOKEN>>(0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::mint_for_nest(arg3, arg4, v9, arg7), v0);
                };
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SHTTOKEN>, arg2: &mut 0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::burn(arg2, 0x2::coin::split<0x9ae3519d509258f3b86ad06c60eb194552f1463270ae2b8b203bdff7e5197579::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
