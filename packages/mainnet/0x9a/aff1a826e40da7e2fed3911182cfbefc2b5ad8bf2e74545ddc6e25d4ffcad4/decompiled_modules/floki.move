module 0x9aaff1a826e40da7e2fed3911182cfbefc2b5ad8bf2e74545ddc6e25d4ffcad4::floki {
    ...
    fun init(arg0: FLOKI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2iEjkph18vY7pYxEo2pVicyQYtCtELDdBMoPncbypump.png?size=lg&key=1cfc1c                                                                                                                                                                                                            ");
