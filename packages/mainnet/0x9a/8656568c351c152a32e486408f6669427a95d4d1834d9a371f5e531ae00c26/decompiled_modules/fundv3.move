module 0x5b7772033302df3ea06eec0b65a4140468f6ad57db01cfc88ca7dbb85b4e42db::fundv3 {
    ...
    public entry fun withdraw_by_owner<T0>(arg0: &mut Config, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        only_owner(arg0, arg3);
        let v0 = vault_key<T0>();
        assert!(0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, Vault<T0>>(&mut arg0.id, v0).balance, arg1, arg3), arg2);
    }
