module 0x9a65a7d5da4307057f3c17079625df5ad5845dd7c8ccc2dd7e106d1d12e967d7::bluemove_launchpad {
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = LaunchpadData{
            ...
            fund_address   : @0x42fc24ddd7ac1f5433e947ba800cb4031f5ab7f5b47072d769fe366e8de16f07,
            total_nft      : 5555,
            pre_mint       : 0,
            start_order    : 0,
        };
    ...
    public entry fun mint_with_quantity(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut LaunchpadData, arg3: &mut Order, arg4: &mut Storage, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < arg5) {
            ...
            let v13 = arg2.base_image_url;
            0x1::string::append(&mut v13, num_str(v9));
            0x1::string::append(&mut v13, 0x1::string::utf8(b".webp"));
            0x2::dynamic_object_field::add<u64, BlueMoveDragon>(&mut arg4.id, arg2.current_place + 1, mint_inscriptions_nft(v11, arg2.description, v13, v12, 0x1::string::utf8(b"https://sui.bluemove.net/"), arg7));
        ...
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, @0x42fc24ddd7ac1f5433e947ba800cb4031f5ab7f5b47072d769fe366e8de16f07);
        } else {
