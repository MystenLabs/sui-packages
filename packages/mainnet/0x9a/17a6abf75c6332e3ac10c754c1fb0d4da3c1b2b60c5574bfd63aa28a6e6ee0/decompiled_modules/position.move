module 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::position {
    ...
    public fun calculate_bankruptcy_price(arg0: &Position, arg1: u256, arg2: u64) : u64 {
        ...
        let v6 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::to_balance(v5, 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::b9_scaling());
        let v7 = v6;
        if (v1 && 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::from_balance(v6, 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::b9_scaling()) != v5) {
            v7 = v6 + 1;
        };
        let v8 = v7 % arg2;
        if (v8 != 0) {
    ...
    public fun compute_free_collateral(arg0: &Position, arg1: u256, arg2: u256, arg3: u256, arg4: u256) : u256 {
        ...
        let v3 = v2;
        if (arg4 != 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::one_fixed()) {
    ...
    public fun compute_free_collateral_with_fundings(arg0: &Position, arg1: u256, arg2: u256, arg3: u256, arg4: u256, arg5: u256, arg6: u256) : u256 {
        ...
        let v2 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(arg0.collateral, arg1);
        let v3 = v2;
        if (arg6 != 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::one_fixed()) {
    ...
    public(friend) fun create_position(arg0: u256, arg1: u256) : Position {
        Position{
            ...
            bids_quantity               : 0,
            pending_orders              : 0,
            maker_fee                   : 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::null_fee(),
            taker_fee                   : 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::null_fee(),
            initial_margin_ratio        : 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::one_fixed(),
        }
    }
    ...
    public fun ensure_margin_requirements(arg0: u256, arg1: u256, arg2: u256, arg3: u256) {
        ...
        assert!(arg1 != 0, 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::errors::initial_margin_requirements_violated());
        assert!(!0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::is_neg(arg2) && !0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::is_neg(arg0), 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::errors::position_bad_debt());
        let v0 = if (arg3 != 0) {
            0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::div(arg2, arg3)
        } else {
            0
        };
        assert!(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::greater_than_eq(v0, 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::div(arg0, arg1)), 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::errors::initial_margin_requirements_violated());
    }
    ...
    public(friend) fun set_initial_margin_ratio(arg0: &mut Position, arg1: u256, arg2: u256, arg3: 0x2::object::ID, arg4: u64) {
        assert!(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::greater_than_eq(arg1, arg2) && 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::less_than_eq(arg1, 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::constants::one_fixed()), 0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::errors::invalid_position_imr());
        arg0.initial_margin_ratio = arg1;
        0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::events::set_position_initial_margin_ratio(arg3, arg4, arg1);
    }
    ...
    public(friend) fun settle_position_funding(arg0: &mut Position, arg1: u256, arg2: u256, arg3: u256, arg4: &0x2::object::ID, arg5: u64) {
        ...
        if (v2) {
            0x9a17a6abf75c6332e3ac10c754c1fb0d4da3c1b2b60c5574bfd63aa28a6e6ee0::events::emit_settled_funding(*arg4, arg5, v0, v1, arg2, arg3);
        };
