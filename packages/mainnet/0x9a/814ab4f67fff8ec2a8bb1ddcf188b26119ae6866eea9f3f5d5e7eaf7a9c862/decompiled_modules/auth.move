module 0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::auth {
    ...
    public(friend) fun config(arg0: &Auth) : &0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::Config {
        0x2::versioned::load_value<0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::Config>(&arg0.config)
    }
    ...
    public(friend) fun grant_permission<T0: drop>(arg0: &mut Auth, arg1: 0x2::object::ID, arg2: 0x2::object::ID) {
        ...
        if (0x2::vec_map::contains<0x2::object::ID, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&arg0.member_permissions, &arg2)) {
            ...
            assert!(!(0x2::vec_map::size<0x2::object::ID, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&arg0.member_permissions) == 0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::config_max_channel_members(0x2::versioned::load_value<0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::Config>(&arg0.config))), 420);
    ...
    public(friend) fun new(arg0: 0x2::object::ID, arg1: 0x1::option::Option<0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::Config>, arg2: &mut 0x2::tx_context::TxContext) : Auth {
        ...
        let v1 = if (0x1::option::is_none<0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::Config>(&arg1)) {
            0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::default()
        } else {
            0x1::option::extract<0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::Config>(&mut arg1)
        };
        Auth{
            member_permissions : v0,
            config             : 0x2::versioned::create<0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::config::Config>(0x9a814ab4f67fff8ec2a8bb1ddcf188b26119ae6866eea9f3f5d5e7eaf7a9c862::admin::version(), v1, arg2),
        }
    }
