module 0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::hop_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::BondingCurve<T0>, arg2: &0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::MemeConfig, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<T0>(v3, 0x2::tx_context::sender(arg7));
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg7));
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v0, arg7), arg0.admin);
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(arg3, 0x2::tx_context::sender(arg7));
        let v4 = BuyEvent<T0>{
    ...
    public entry fun buy_exact_in_by_usdc<T0>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: &mut 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::BondingCurve<T0>, arg4: &0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::MemeConfig, arg5: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg6: u64, arg7: u64, arg8: 0x1::string::String, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        let v4 = v1;
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v0, 0x2::tx_context::sender(arg10), arg10);
        ...
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg5, 0x2::tx_context::sender(arg10));
        let v6 = 0x2::coin::from_balance<0x2::sui::SUI>(v4, arg10);
        let v7 = v5 * arg0.buy_fee / 10000;
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v6, v7, arg10), arg0.admin);
        ...
        let v10 = v9;
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<T0>(v10, 0x2::tx_context::sender(arg10));
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(v8, 0x2::tx_context::sender(arg10));
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(v6, 0x2::tx_context::sender(arg10));
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::BondingCurve<T0>, arg2: &0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::MemeConfig, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 - v2 >= arg5, 1);
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg7));
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg7));
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg7), arg0.admin);
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg7),
            amount_in  : arg4,
            amount_out : v1 - v2,
    ...
    public entry fun sell_exact_in_for_usdc<T0>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: &mut 0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::BondingCurve<T0>, arg4: &0x5c8657a6009556804585cd667be3b43487062195422ff586333721de0f8baeae::meme::MemeConfig, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: u64, arg8: 0x1::string::String, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&v0);
        let v2 = v1 * arg0.sell_fee / 10000;
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg10), arg0.admin);
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<T0>(arg5, 0x2::tx_context::sender(arg10));
        let v3 = v1 - v2;
        assert!(v3 >= arg7, 1);
        ...
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v8, 0x2::tx_context::sender(arg10), arg10);
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_balance<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg10), arg10);
        0x9ac7f754cdf8c6e78fcbc8ae11fad9490342802eb0462d9e8c2a8d30f6941c6a::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg10));
