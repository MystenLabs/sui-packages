module 0x9ac1f4b184c2507b50c47852fe38ae5488d126d27570438ffa400886fc766ffd::upgrade {
    struct UpgradeManager has key {
        id: 0x2::object::UID,
        upgrade_cap: 0x2::package::UpgradeCap,
    }

    public fun admin_upgrade(arg0: &mut UpgradeManager, arg1: &0x9ac1f4b184c2507b50c47852fe38ae5488d126d27570438ffa400886fc766ffd::admin::AdminCap, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::package::UpgradeTicket {
