module 0x9a9bb78045be5b008798591076c52cca99f4c9c9b7643c9209be42aad688f181::reward7346 {
    struct REWARD7346 has drop {
        dummy_field: bool,
    }

    struct TICKET_7346 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7346(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7346>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7346>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7346, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7346>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7346>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7346>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7346>>(v5, 0x2::tx_context::sender(arg1));
    }
