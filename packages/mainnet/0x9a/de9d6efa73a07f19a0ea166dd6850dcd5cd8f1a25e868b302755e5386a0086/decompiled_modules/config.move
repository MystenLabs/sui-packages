module 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::config {
    ...
    struct Configs has store, key {
        id: 0x2::object::UID,
        acl: 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::acl::ACL,
    ...
    public fun set_roles(arg0: &mut Configs, arg1: &PumpAdminCap, arg2: address, arg3: u128) {
        ...
        0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun assert_claim_role(arg0: &Configs, arg1: address) {
        assert!(0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::acl::has_role(&arg0.acl, arg1, 2), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::no_claim_permission());
    }

    public fun assert_manager_role(arg0: &Configs, arg1: address) {
        assert!(0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::acl::has_role(&arg0.acl, arg1, 0), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::no_manager_permission());
    }

    public fun assert_upload_role(arg0: &Configs, arg1: address) {
        assert!(0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::acl::has_role(&arg0.acl, arg1, 1), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::no_upload_permission());
    }

    public fun assert_url_update_flag(arg0: &Configs, arg1: u8) {
        assert!(arg0.url_update_flags & 1 << arg1 != 0, 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::not_allow_update_in_this_status());
    }

    public fun assert_valid_package(arg0: &Configs) {
        let v0 = 1;
        assert!(0x2::vec_set::contains<u64>(&arg0.allowed_versions, &v0), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::package_version_not_allowed());
    }
    ...
    public(friend) fun claim_fee<T0>(arg0: &mut Configs, arg1: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.fee_vault, v0), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::insufficient_balance());
    ...
    public entry fun disable_version(arg0: &mut Configs, arg1: u64, arg2: &PumpAdminCap) {
        assert!(arg1 != 1, 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::cannot_disable_current_version());
        assert!(0x2::vec_set::contains<u64>(&arg0.allowed_versions, &arg1), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::version_not_enabled());
    ...
    public entry fun enable_version(arg0: &mut Configs, arg1: u64, arg2: &PumpAdminCap) {
        assert!(!0x2::vec_set::contains<u64>(&arg0.allowed_versions, &arg1), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::version_already_enabled());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = Configs{
            ...
            acl                  : 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::acl::new(arg0),
        ...
        0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::acl::set_roles(&mut v3.acl, v5, 0 | 1 << 0);
    ...
    public fun init_fee<T0>(arg0: &Configs) : u64 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, u64>(&arg0.init_fees, v0), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::init_fee_type_not_exist());
    ...
    public fun remove_update_fee<T0>(arg0: &mut Configs, arg1: &0x2::tx_context::TxContext) {
        ...
        assert_manager_role(arg0, 0x2::tx_context::sender(arg1));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, u64>(&arg0.update_fees, v0), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::update_fee_type_not_exist());
