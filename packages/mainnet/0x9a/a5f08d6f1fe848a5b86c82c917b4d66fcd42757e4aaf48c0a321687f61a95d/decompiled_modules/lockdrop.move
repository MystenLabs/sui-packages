module 0x14832a290b19640822bbe3ef70095f8c5d1ef753801f8b7093a06ad78d04abd2::lockdrop {
    ...
    fun calculate_withdrawable_lp_shares(arg0: u64, arg1: &UserLockdropHivePosition, arg2: bool) : (u64, vector<u64>, vector<u64>, vector<u64>, vector<u64>) {
        ...
        while (v5 < 0x1::vector::length<u64>(&arg1.sui_lockdrop.lockup_weeks)) {
            ...
            if (!*0x2::table::borrow<u64, bool>(&arg1.sui_lockdrop.dlp_claim_flag, v6) && (true || arg2 || arg0 >= *0x2::table::borrow<u64, u64>(&arg1.sui_lockdrop.unlock_timestamps, v6))) {
                ...
                v0 = v0 + *0x2::table::borrow<u64, u64>(&arg1.sui_lockdrop.locked_per_position, v6);
            };
            v5 = v5 + 1;
        };
        let v7 = 0;
    ...
    public fun rev_unlock_degenhive_sui<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &mut LockdropVault, arg2: &mut 0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::HiveProfile, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let (_, _, _, v3) = 0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::get_profile_meta_info(arg2);
        let v4 = 0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::remove_app_from_profile<UserLockdropHivePosition>(&arg1.user_profile_access_cap, arg2, arg4);
        let v5 = &mut v4;
        let (v6, _, _, _, _) = unbond_degenhive_lp_tokens(0x2::clock::timestamp_ms(arg0), v5, false);
        let v11 = 0x2::coin::into_balance<0x2::sui::SUI>(arg3);
        0x616fa729bb4fbddf2cfc165b1ce19c1d7d738252283a250dc0183b3e015d148b::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v11, v6), v3, arg4);
        0x616fa729bb4fbddf2cfc165b1ce19c1d7d738252283a250dc0183b3e015d148b::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v11, 0x2::tx_context::sender(arg4), arg4);
        0xcfc06c5e96b2a09666851de57669afcf97bc9bb7dd5ac50ea3dbe801c9f24772::hive_profile::add_app_to_profile<UserLockdropHivePosition>(&arg1.user_profile_access_cap, arg2, v4, arg4);
    }
