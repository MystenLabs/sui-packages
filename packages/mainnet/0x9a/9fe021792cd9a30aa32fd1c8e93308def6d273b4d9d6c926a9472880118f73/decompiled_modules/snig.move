module 0x9a9fe021792cd9a30aa32fd1c8e93308def6d273b4d9d6c926a9472880118f73::snig {
    struct SNIG has drop {
        dummy_field: bool,
    }

    fun init(arg0: SNIG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = vector[9, 1000000000000000000, 0];
        let v1 = vector[b"SNIG", b"Suppa Nigga", b"Thank you MISS ANN", b"https://i.imgur.com/1EVh5MS.png"];
        let v2 = vector[b"SNIG", b"Suppa Nigga", b"Thank you MISS ANN", b"https://i.imgur.com/1EVh5MS.png"];
        let v3 = vector[b"SNIG", b"Suppa Nigga", b"Thank you MISS ANN", b"https://i.imgur.com/1EVh5MS.png"];
        let v4 = vector[b"SNIG", b"Suppa Nigga", b"Thank you MISS ANN", b"https://i.imgur.com/1EVh5MS.png"];
        let (v5, v6) = 0x2::coin::create_currency<SNIG>(arg0, (*0x1::vector::borrow<u64>(&v0, 0) as u8), *0x1::vector::borrow<vector<u8>>(&v1, 0), *0x1::vector::borrow<vector<u8>>(&v2, 1), *0x1::vector::borrow<vector<u8>>(&v3, 2), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(*0x1::vector::borrow<vector<u8>>(&v4, 3))), arg1);
        let v7 = v5;
        let v8 = 0x2::tx_context::sender(arg1);
        let v9 = vector[9, 1000000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v9, 1) > 0) {
            let v10 = vector[9, 1000000000000000000, 0];
            0x2::coin::mint_and_transfer<SNIG>(&mut v7, *0x1::vector::borrow<u64>(&v10, 1), v8, arg1);
        };
        let (v11, v12) = 0xa204bd0d48d49fc7b8b05c8ef3f3ae63d1b22d157526a88b91391b41e6053157::ipx_coin_standard::new<SNIG>(v7, arg1);
        let v13 = v12;
        let v14 = v11;
        ...
        0xa204bd0d48d49fc7b8b05c8ef3f3ae63d1b22d157526a88b91391b41e6053157::ipx_coin_standard::destroy_witness<SNIG>(&mut v14, v13);
        ...
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<SNIG>>(v6);
    }
