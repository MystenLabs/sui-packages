module 0x9a3ea48e7983964173439a654527b541c739cc3ad585b16fe0f464c99104851b::SUIPEPENFT {
    struct SUIPEPENFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUIPEPENFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<SUIPEPENFT>(arg0, arg1);
