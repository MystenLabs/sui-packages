module 0x9a2a5d6cc974df8db8970f6a20e30d8e0a2c2e2d48f80ad85c454f4ebf6e4cd5::cnsnft3979 {
    struct CNSNFT3979 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3979, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3979>(arg0, arg1);
