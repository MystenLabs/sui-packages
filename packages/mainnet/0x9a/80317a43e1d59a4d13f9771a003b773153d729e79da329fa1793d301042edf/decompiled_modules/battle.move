module 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::battle {
    ...
    public fun create_pvp_battle_v3(arg0: address, arg1: address, arg2: u64, arg3: &0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::config::Config, arg4: 0x2::balance::Balance<0x2::sui::SUI>, arg5: u64, arg6: 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::fifth_move::FifthMoveEligibility, arg7: 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::fifth_move::FifthMoveEligibility, arg8: &0x2::random::Random, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = gen_moves_for_entitlement(v0, arg8, arg9);
        let v4 = gen_moves_for_entitlement(v1, arg8, arg9);
        let v5 = Status{
            block_turns       : 0,
            next_turn_penalty : 0,
            poison_ticks      : 0,
        ...
        emit_update_v3(&v7);
        0x2::transfer::share_object<PvpBattleV3>(v7);
    }
    ...
    fun gen_moves_for_entitlement(arg0: bool, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : vector<u8> {
        ...
        let v1 = all_hand_candidate_moves();
        let v2 = 0x1::vector::empty<u8>();
        let v3 = 0;
        while (v3 < 0x1::vector::length<u8>(&v1)) {
            let v4 = *0x1::vector::borrow<u8>(&v1, v3);
            if (!0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::contains_u8(&v0, v4)) {
                0x1::vector::push_back<u8>(&mut v2, v4);
            };
            v3 = v3 + 1;
        };
        let v5 = 0x1::vector::length<u8>(&v2);
        assert!(v5 > 0, 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::errors::e_invalid_move());
        let v6 = 0x2::random::new_generator(arg1, arg2);
        0x1::vector::push_back<u8>(&mut v0, *0x1::vector::borrow<u8>(&v2, 0x2::random::generate_u64(&mut v6) % v5));
        v0
    }
    ...
    public fun use_ability_id_pvp_v3(arg0: &mut PvpBattleV3, arg1: u8, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.turn == 0) {
            ...
            if (arg0.p1_growth >= arg0.target_growth) {
                let v1 = arg0.player1;
                finish_and_payout_v3(arg0, v1, arg3);
            } else {
                arg0.turn = 1;
                emit_update_v3(arg0);
            };
