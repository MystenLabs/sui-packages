module 0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_staking {
    ...
    struct StakingPool<phantom T0, phantom T1> has key {
        id: 0x2::object::UID,
        total_staked: 0x2::balance::Balance<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>,
    ...
    public fun create_staking_pool<T0, T1>(arg0: &AdminCap, arg1: &mut StakingRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : StakingPool<T0, T1> {
        ...
        let v1 = StakingPool<T0, T1>{
            ...
            total_staked              : 0x2::balance::zero<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(),
    ...
    public fun estimate_apr<T0, T1>(arg0: &StakingPool<T0, T1>) : u64 {
        let v0 = 0x2::balance::value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.total_staked);
        if (v0 == 0) {
            return 0
        };
    ...
    public fun get_total_staked<T0, T1>(arg0: &StakingPool<T0, T1>) : u64 {
        0x2::balance::value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.total_staked)
    }
    ...
    public fun stake<T0, T1>(arg0: &mut StakingPool<T0, T1>, arg1: 0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : StakePosition<T0, T1> {
        ...
        assert!(v0 > 0, 1);
        0x2::balance::join<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&mut arg0.total_staked, 0x2::coin::into_balance<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(arg1));
        ...
        let v2 = Staked{
            ...
            user         : 0x2::tx_context::sender(arg3),
            amount       : v0,
            total_staked : 0x2::balance::value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.total_staked),
        };
    ...
    public fun unstake<T0, T1>(arg0: &mut StakingPool<T0, T1>, arg1: StakePosition<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>, 0x2::coin::Coin<0x2::sui::SUI>) {
        let StakePosition {
            id          : v0,
            owner       : v1,
            amount      : v2,
        ...
        (0x2::coin::from_balance<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(0x2::balance::split<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&mut arg0.total_staked, v2), arg3), v7)
    }
    ...
    fun update_pool<T0, T1>(arg0: &mut StakingPool<T0, T1>, arg1: &0x2::clock::Clock) {
        ...
        let v1 = 0x2::balance::value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.total_staked);
        if (v1 == 0) {
