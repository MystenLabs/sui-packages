module 0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::factory {
    ...
    public fun create_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>> {
        ...
        let (v2, v3) = 0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::pool::create_pool<T0, T1>(arg2, arg3, arg0.fee_collector, arg4, arg5);
        let v4 = v2;
        let v5 = 0x2::object::id_address<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::pool::Pool<T0, T1>>(&v4);
        0x2::table::add<PairKey, address>(&mut arg0.pools, v0, v5);
        arg0.pool_count = arg0.pool_count + 1;
        0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::pool::share_pool<T0, T1>(v4);
        let v6 = PoolCreated{
            pool_id     : v5,
            coin_a      : v0.coin_a,
            coin_b      : v0.coin_b,
    ...
    public fun create_pool_from_contract<T0, T1>(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (address, 0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= arg0.creation_fee, 0);
        let v0 = get_pair_key<T0, T1>();
        assert!(!0x2::table::contains<PairKey, address>(&arg0.pools, v0), 1);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
