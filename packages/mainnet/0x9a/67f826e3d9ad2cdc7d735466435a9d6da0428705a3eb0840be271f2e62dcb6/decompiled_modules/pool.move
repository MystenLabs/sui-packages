module 0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::pool {
    ...
    struct Pool<phantom T0, phantom T1> has key {
        ...
        lp_supply: 0x2::balance::Supply<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>,
        locked_lp: 0x2::balance::Balance<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>,
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>) {
        ...
        let v4 = 0x2::balance::supply_value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.lp_supply);
        assert!(v2 > 0 && v3 > 0, 0);
        ...
        let v10 = 0x2::balance::supply_value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.lp_supply);
        ...
        (arg1, arg2, 0x2::coin::from_balance<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(0x2::balance::increase_supply<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&mut arg0.lp_supply, v9), arg4))
    }

    public fun burn_liquidity_lock<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::coin::value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg1);
        assert!(v0 > 0, 7);
        let (v1, v2, v3) = get_amounts<T0, T1>(arg0);
        0x2::balance::decrease_supply<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&mut arg0.lp_supply, 0x2::coin::into_balance<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(arg1));
        let v4 = LiquidityBurnedLocked{
            ...
            remaining_supply : 0x2::balance::supply_value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.lp_supply),
            timestamp        : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<LiquidityBurnedLocked>(v4);
    }

    public fun create_pool<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (Pool<T0, T1>, 0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>) {
        let v0 = 0x2::coin::value<T0>(&arg0);
        let v1 = 0x2::coin::value<T1>(&arg1);
        assert!(v0 > 0 && v1 > 0, 1);
        let v2 = sqrt_u128((v0 as u128) * (v1 as u128));
        assert!(v2 >= 1000 * 10, 0);
        let v3 = 0x2::balance::create_supply<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::create_witness<T0, T1>());
        let v4 = 0x2::balance::increase_supply<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&mut v3, v2);
        ...
        let v6 = Pool<T0, T1>{
            ...
            lp_supply            : v3,
            locked_lp            : 0x2::balance::split<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&mut v4, 1000),
            fee_collector        : arg2,
            lp_fee               : 100,
            project_fee          : 50,
            add_liquidity_fee    : 0,
        ...
        (v6, 0x2::coin::from_balance<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(v4, arg4))
    }
    ...
    fun emit_sync<T0, T1>(arg0: &Pool<T0, T1>) {
        let v0 = Sync{
            ...
            lp_supply : 0x2::balance::supply_value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.lp_supply),
        };
    ...
    public fun get_amounts<T0, T1>(arg0: &Pool<T0, T1>) : (u64, u64, u64) {
        (0x2::balance::value<T0>(&arg0.reserve_a), 0x2::balance::value<T1>(&arg0.reserve_b), 0x2::balance::supply_value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.lp_supply))
    }
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = 0x2::coin::value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg1);
        assert!(v0 > 0, 7);
        let v1 = 0x2::balance::supply_value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.lp_supply);
        assert!(v1 > 0, 0);
        assert!(v0 <= v1, 1);
        ...
        let v4 = LiquidityRemoved{
            ...
            amount_a     : v2,
            amount_b     : v3,
            total_supply : 0x2::balance::supply_value<0x9a67f826e3d9ad2cdc7d735466435a9d6da0428705a3eb0840be271f2e62dcb6::lp_coin::LP<T0, T1>>(&arg0.lp_supply),
        };
