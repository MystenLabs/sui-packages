module 0x9aae30a311491f3bb560c7d286b1cac90fc42b65d8c48e377ab200c3c96aa175::cnsnft7923 {
    struct CNSNFT7923 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7923, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7923>(arg0, arg1);
