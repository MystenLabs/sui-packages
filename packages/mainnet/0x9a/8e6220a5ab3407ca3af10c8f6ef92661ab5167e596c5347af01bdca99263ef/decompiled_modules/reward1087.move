module 0x9a8e6220a5ab3407ca3af10c8f6ef92661ab5167e596c5347af01bdca99263ef::reward1087 {
    struct REWARD1087 has drop {
        dummy_field: bool,
    }

    struct TICKET_1087 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1087(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1087>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1087>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1087, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1087>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1087>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1087>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1087>>(v5, 0x2::tx_context::sender(arg1));
    }
