module 0x9acc4d8dd44334fec3ac4bb5111976a03f2364c923f47310247b757384710a6c::reward2756 {
    struct REWARD2756 has drop {
        dummy_field: bool,
    }

    struct TICKET_2756 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2756(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2756>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2756>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2756, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2756>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2756>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2756>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2756>>(v5, 0x2::tx_context::sender(arg1));
    }
