module 0x9a77a566a5d0a2579c27ca9dd02e39a4ef2d2afae1a5d83670ae9886a7d7b7a3::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"CHAD", b"CHAD", b"Officia token", 0x1::option::none<0x2::url::Url>(), arg1);
