module 0x9a4758a87b99399fa9a5d0cd546518140091e87da446dd8b48da905269a413bb::cnsnft2387 {
    struct CNSNFT2387 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2387, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9293"));
        let v4 = 0x2::package::claim<CNSNFT2387>(arg0, arg1);
