module 0x9aa6dc7eda9864ba9bf15120c2bd98209aeb6976c01a8c2de409006230b48dbb::xx {
    struct XX has drop {
        dummy_field: bool,
    }

    fun init(arg0: XX, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/c5N7xaeXdO-v8UEX4KqGmBLDqAq1aKlyHWBWtnoAA9w";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/c5N7xaeXdO-v8UEX4KqGmBLDqAq1aKlyHWBWtnoAA9w"))
        };
