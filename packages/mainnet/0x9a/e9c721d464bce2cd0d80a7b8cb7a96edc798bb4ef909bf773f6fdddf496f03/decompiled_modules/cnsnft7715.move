module 0x9ae9c721d464bce2cd0d80a7b8cb7a96edc798bb4ef909bf773f6fdddf496f03::cnsnft7715 {
    struct CNSNFT7715 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7715, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7715>(arg0, arg1);
