module 0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::qanda {
    ...
    public entry fun question(arg0: &mut 0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
            id              : 0x2::object::new(arg3),
            title           : arg1,
            comment         : arg2,
            community_id    : 0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::get_id(arg0),
            total_child     : 0,
            votes           : 0,
            downvotes       : 0,
            child_comments  : 0x2::vec_map::empty<u64, CommentChild>(),
            create_date     : 0x2::tx_context::epoch_timestamp_ms(arg3),
            owner           : 0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::get_address_admin(),
        ...
        0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::update_qandas(arg0, arg3);
        0x2::transfer::public_transfer<Qanda>(v0, 0x2::tx_context::sender(arg3));
    }

    public entry fun question_by_admin(arg0: &mut 0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
        ...
        0x2::transfer::public_transfer<Qanda>(v0, 0x2::tx_context::sender(arg4));
    }

    public entry fun reply_qanda(arg0: &mut 0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::Community, arg1: &mut Qanda, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::validate_owner_community(arg0, arg3);
        let v0 = CommentChild{
            id           : 0x2::object::new(arg3),
            community_id : 0x9a1e25c04b374c0e0b7e067a9d233b50352739fecb2165609487e777798c4fe9::community::get_id(arg0),
            comment      : arg2,
