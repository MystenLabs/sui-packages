module 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::akasui {
    ...
    public entry fun add_liquidity_to_flowx<T0, T1>(arg0: &mut Configuration, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0, T1>>(&mut arg0.id, generate_pool_name<T0, T1>());
        assert!(v0.is_completed, 110);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(0x1::vector::contains<address>(&arg0.operators, &v1), 111);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v0.real_raise_coin_reserves, v3 * arg0.creator_fee / 10000, arg3), v0.creator_address);
        let v4 = 0x2::coin::value<T1>(&v0.real_raise_coin_reserves);
        0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::router::add_liquidity<T0, T1>(arg2, arg1, v2, 0x2::coin::split<T1>(&mut v0.real_raise_coin_reserves, v4, arg3), 0x2::coin::value<T0>(&v2), v4, v1, 0x2::clock::timestamp_ms(arg2) + 60000, arg3);
        let v5 = AddedLiquidityToDexEvent{
            pool_id            : 0x2::object::id<Pool<T0, T1>>(v0),
            ts                 : 0x2::clock::timestamp_ms(arg2),
            token_address      : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
    ...
    public entry fun buy<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v10, 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::as_u64(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::div(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::mul(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(0x2::coin::value<T0>(&v10)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(arg0.platform_fee)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(10000))), arg3), arg0.fee_recepient);
    ...
    fun buy_direct<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = v6;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v8, 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::as_u64(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::div(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::mul(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(0x2::coin::value<T0>(&v8)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(arg3)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(10000))), arg5), arg0.fee_recepient);
    ...
    public fun buy_returns<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert_version(arg0.version);
        let (_, v1) = estimate_amount_out_without_fee<T0, T1>(arg0, 0x2::coin::value<T1>(&arg1), 0);
        assert!(v1 > 0, 102);
        0x1::type_name::get<T0>();
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0, T1>>(&mut arg0.id, generate_pool_name<T0, T1>());
        assert!(!v2.is_completed, 103);
        let v3 = 0x2::math::min(v1, v2.virtual_token_reserves - 0x2::coin::value<T0>(&v2.remain_token_reserves));
        let v4 = 0x2::coin::zero<T0>(arg3);
        let (v5, v6) = swap<T0, T1>(v2, v4, arg1, v3, 0, arg3);
        let v7 = v5;
        v2.virtual_token_reserves = v2.virtual_token_reserves - 0x2::coin::value<T0>(&v7);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v7, 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::as_u64(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::div(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::mul(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(0x2::coin::value<T0>(&v7)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(arg0.platform_fee)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(10000))), arg3), arg0.fee_recepient);
        (v7, v6)
    }
    ...
    public fun estimate_amount_out<T0, T1>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        if (arg1 > 0 && arg2 == 0) {
            let v3 = 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::curves::calculate_token_amount_received(v0.virtual_raise_coin_reserves, v0.virtual_token_reserves, arg1);
            (0, v3 - 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::as_u64(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::div(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::mul(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(v3), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(arg0.platform_fee)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(10000))))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::curves::calculate_remove_liquidity_return(v0.virtual_token_reserves, v0.virtual_raise_coin_reserves, arg2);
            (v4 - 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::as_u64(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::div(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::mul(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(v4), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(arg0.platform_fee)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(10000))), 0)
        } else {
            (0, 0)
        }
    }
    ...
    public fun estimate_amount_out_for_buy_direct(arg0: &mut Configuration, arg1: u64, arg2: u64, arg3: u64) : (u64, u64) {
        (0, 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::curves::calculate_token_amount_received(arg2, arg3, arg1))
    }
    ...
    public fun estimate_amount_out_without_fee<T0, T1>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v0 = 0x2::dynamic_object_field::borrow<0x1::ascii::String, Pool<T0, T1>>(&arg0.id, generate_pool_name<T0, T1>());
        if (arg1 > 0 && arg2 == 0) {
            (0, 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::curves::calculate_token_amount_received(v0.virtual_raise_coin_reserves, v0.virtual_token_reserves, arg1))
        } else if (arg1 == 0 && arg2 > 0) {
            (0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::curves::calculate_remove_liquidity_return(v0.virtual_token_reserves, v0.virtual_raise_coin_reserves, arg2), 0)
        } else {
            (0, 0)
        }
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Configuration{
            ...
            admin                                   : @0x5b0e0e6fcbe8c00ce763c629a07f063201778e341fd1529a7636f3c4013663a9,
            fee_recepient                           : @0xc409454600a13f70760000ad8f64c1c0be6d4be61c91a67bcebf27b6556dc6ec,
            platform_fee                            : 100,
            graduated_fee                           : 100,
            creator_fee                             : 100,
    ...
    public entry fun sell<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 102);
        let v3 = 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_raise_coin_reserves, v2);
        let v4 = 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::as_u64(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::div(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::mul(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(v3), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(arg0.platform_fee)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(10000)));
        assert!(v3 - v4 >= arg2, 2);
    ...
    public fun sell_returns<T0, T1>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x1::type_name::get<T0>();
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0, T1>>(&mut arg0.id, generate_pool_name<T0, T1>());
        assert_version(arg0.version);
        assert!(!v0.is_completed, 103);
        let v1 = 0x2::coin::value<T0>(&arg1);
        assert!(v1 > 0, 102);
        let v2 = 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::curves::calculate_remove_liquidity_return(v0.virtual_token_reserves, v0.virtual_raise_coin_reserves, v1);
        let v3 = 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::as_u64(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::div(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::mul(0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(v2), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(arg0.platform_fee)), 0x4bc82bd1b43d7d864223bad0d55230395cc07c6dbcc3371b354101f9e1f79424::utils::from_u64(10000)));
        assert!(v2 - v3 >= arg2, 2);
        let v4 = 0x2::coin::zero<T1>(arg4);
        let (v5, v6) = swap<T0, T1>(v0, arg1, v4, 0, v2, arg4);
        let v7 = v6;
        v0.virtual_raise_coin_reserves = v0.virtual_raise_coin_reserves - 0x2::coin::value<T1>(&v7);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v7, v3, arg4), arg0.fee_recepient);
        (v5, v7)
    }
    ...
    public entry fun swap_on_bluemove<T0, T1>(arg0: &Configuration, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = if (0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::sort_token_type<T0, T1>()) {
            0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::token_reserves<T0, T1>(0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::get_pool<T0, T1>(arg4))
        } else {
            let (v4, v5) = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::token_reserves<T1, T0>(0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::get_pool<T1, T0>(arg4));
            (v5, v4)
        };
        let v6 = BluemoveSwap{
        ...
        0x2::event::emit<BluemoveSwap>(v6);
    }

    public entry fun swap_on_flowx<T0, T1>(arg0: &Configuration, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::router::swap_exact_input_direct<T0, T1>(arg1, arg2, arg4);
        let v1 = 0x2::coin::value<T1>(&v0);
        if (arg3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v0, v1 * arg3 / 10000, arg4), arg0.fee_recepient);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v0, 0x2::tx_context::sender(arg4));
        let (v2, v3) = if (0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::swap_utils::is_ordered<T0, T1>()) {
            0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::get_reserves<T0, T1>(0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::borrow_pair<T0, T1>(arg1))
        } else {
            let (v4, v5) = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::get_reserves<T1, T0>(0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::borrow_pair<T1, T0>(arg1));
            (v5, v4)
        };
        let v6 = BluemoveSwap{
            token_in          : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            token_out         : 0x1::type_name::into_string(0x1::type_name::get<T1>()),
            in_amount         : 0x2::coin::value<T0>(&arg2),
            out_amount        : v1,
            token_in_reserve  : v2,
            token_out_reserve : v3,
        };
