module 0x9a9c0021641ff92e1aa6b57d1b803087aee927a74fa06cdf63a6c59bc7c622c1::reward5613 {
    struct REWARD5613 has drop {
        dummy_field: bool,
    }

    struct TICKET_5613 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5613(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5613>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5613>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5613, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5613>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5613>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5613>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5613>>(v5, 0x2::tx_context::sender(arg1));
    }
