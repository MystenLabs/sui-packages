module 0x9a109df6474bb78962b8b69c66d33fac3e9b69747dc641f23098b89f7106b567::reward1961 {
    struct REWARD1961 has drop {
        dummy_field: bool,
    }

    struct TICKET_1961 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1961(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_1961>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1961, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1961>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1961>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1961>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1961>>(v5, 0x2::tx_context::sender(arg1));
    }
