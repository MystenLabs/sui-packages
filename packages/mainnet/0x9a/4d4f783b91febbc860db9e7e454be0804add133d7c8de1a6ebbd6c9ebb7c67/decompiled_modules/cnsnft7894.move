module 0x9a4d4f783b91febbc860db9e7e454be0804add133d7c8de1a6ebbd6c9ebb7c67::cnsnft7894 {
    struct CNSNFT7894 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7894, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7894>(arg0, arg1);
