module 0x9a43cecc4bd010a1e5cc1186a1fd6d20c22cb34ffacde2ee45447e1a9262db56::_mogul_by_moviepass {
    struct _MOGUL_BY_MOVIEPASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _MOGUL_BY_MOVIEPASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_MOGUL_BY_MOVIEPASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" Mogul By MoviePass"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Holders of the Mogul NFT get access to special benefits, such as early access to MoviePass features, VIP experiences, or access to curated screenings. These could include events, movie premieres, or other exclusive movie-related opportunities."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibd3disx6kopkbm4f3oisk64m5rrlctk4xcticw2cuynaw6jjcm5u"));
