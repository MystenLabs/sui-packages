module 0x9a56512d68bf8169759262dd1e47bdc69c0fc1be6f0ab30eca62d1b468bfa4f4::bbb {
    ...
    public fun balance<T0>(arg0: &mut MyPool, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        check_address(0x2::tx_context::sender(arg1));
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.bag, v0)) {
            0
        } else {
            0x2::balance::value<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.bag, v0))
        }
    }
    ...
    public fun push<T0>(arg0: &mut MyPool, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v1 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.bag, v0);
        0x2::balance::join<T0>(v1, 0x2::coin::into_balance<T0>(arg1));
