module 0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::duck_nft {
    ...
    public entry fun admin_update_staking_policy_nest_registry(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<DuckNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<DuckNFT>, arg3: address) {
        0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::staking_rule::update_nest_registry<DuckNFT>(arg1, arg2, arg3);
    }
    ...
    fun apply_genesis_purchase(arg0: &mut PackSupply, arg1: &Whitelist, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (arg0.whitelist_phase_active) {
            ...
            if (arg0.whitelist_packs_sold >= 3) {
                arg0.whitelist_phase_active = false;
    ...
    public fun can_set_referrer(arg0: &ReferralRegistry, arg1: &PackSupply, arg2: address) : bool {
        if (!0x2::table::contains<address, address>(&arg0.referrers, arg2)) {
            if (!0x2::table::contains<address, u64>(&arg1.user_last_purchase_time, arg2)) {
                !0x2::table::contains<address, u64>(&arg1.user_whitelist_purchases, arg2)
            } else {
                false
            }
        } else {
    ...
    fun check_genesis_batch_completion(arg0: &mut PackSupply, arg1: &0x2::clock::Clock) {
        ...
        if (arg0.total_packs_remaining == 0) {
            ...
            arg0.cooldown_end_time = v0 + 300000;
            arg0.current_batch_number = 1;
            arg0.display_batch_number = 0;
            arg0.previous_batch_completed = true;
            let v1 = GenesisBatchCompleted{
                end_time         : v0,
                total_packs_sold : 5,
            };
            0x2::event::emit<GenesisBatchCompleted>(v1);
            let v2 = LastMintOfBatch{
                completed_batch_number : 0,
                next_batch_number      : 1,
                cooldown_end_time      : arg0.cooldown_end_time,
                final_nfts_minted      : arg0.total_nfts_minted_globally,
            };
            0x2::event::emit<LastMintOfBatch>(v2);
            let v3 = CooldownStarted{
                batch_number      : 0,
                sellout_time      : v0,
                cooldown_end_time : arg0.cooldown_end_time,
            };
            0x2::event::emit<CooldownStarted>(v3);
        };
    }
    ...
    fun create_duck_nft(arg0: u8, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : DuckNFT {
        ...
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Luck"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Multiplier"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Batch"));
        let v7 = 0x1::vector::empty<0x1::string::String>();
        let v8 = &mut v7;
        0x1::vector::push_back<0x1::string::String>(v8, get_rarity_name(arg0));
        0x1::vector::push_back<0x1::string::String>(v8, v3);
        0x1::vector::push_back<0x1::string::String>(v8, v4);
        0x1::vector::push_back<0x1::string::String>(v8, get_batch_name(arg1));
        DuckNFT{
    ...
    fun get_rarity_image_url(arg0: u8) : 0x1::string::String {
        if (arg0 == 3) {
            0x1::string::utf8(b"https://magenta-protestant-falcon-171.mypinata.cloud/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/Golden.png")
        } else if (arg0 == 2) {
            0x1::string::utf8(b"https://magenta-protestant-falcon-171.mypinata.cloud/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/King.png")
        } else if (arg0 == 1) {
            0x1::string::utf8(b"https://magenta-protestant-falcon-171.mypinata.cloud/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/Queen.png")
        } else {
            0x1::string::utf8(b"https://magenta-protestant-falcon-171.mypinata.cloud/ipfs/bafybeignzuwwl5bn2q7jv6lwkoy5cfeusjtq4mepwtbbiob3lcajnx4t3q/Common.png")
        }
    }
    ...
    public fun get_supply_constants(arg0: &PackSupply) : (u64, u64, u64, u64, u64, u64) {
        (100, 5, 3, 5 - 3, 4, arg0.total_nfts_minted_globally)
    }
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.total_nfts_minted_globally + arg14 <= 100, 14);
        let v3 = arg1.basic_egg_sht_cost;
        let v4 = arg1.basic_egg_sui_cost;
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::burn(arg8, 0x2::coin::split<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>>(0x2::coin::split<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>>(0x2::coin::split<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::shttoken::SHTTOKEN>(arg12);
        };
    ...
    public entry fun hatch_genesis_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &mut GlobalStats, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: u64, arg11: &0x2::random::Random, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.total_nfts_minted_globally + arg10 <= 100, 14);
    ...
    fun init(arg0: DUCK_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"attribute_keys"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"attribute_values"));
        ...
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"{attribute_keys}"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"{attribute_values}"));
        ...
        let v9 = v8;
        let v10 = v7;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<DuckNFT>(&mut v10, &v9, 1000, 0);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<DuckNFT>>(v10);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<DuckNFT>>(v9, v0);
        let (v11, v12) = 0x2::transfer_policy::new<DuckNFT>(&v1, arg1);
        let v13 = v12;
        let v14 = v11;
        0x9ad3ac098fddaabba3af7cf6710bf9400794562d06f1c4784b7ea0f015a06139::staking_rule::add<DuckNFT>(&mut v14, &v13, @0x0);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<DuckNFT>>(v14);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<DuckNFT>>(v13, v0);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v1, v0);
        let v15 = HatchCap{id: 0x2::object::new(arg1)};
        0x2::transfer::share_object<HatchCap>(v15);
        let v16 = AdminCap{
            id                    : 0x2::object::new(arg1),
            team_mint_initialized : false,
        };
        0x2::transfer::transfer<AdminCap>(v16, v0);
        let v17 = PackSupply{
            id                                : 0x2::object::new(arg1),
        ...
        0x2::transfer::share_object<PackSupply>(v17);
        let v18 = PerTypeSupply{
            id                     : 0x2::object::new(arg1),
        ...
        0x2::transfer::share_object<PerTypeSupply>(v18);
        let v19 = TreasuryConfig{
            id              : 0x2::object::new(arg1),
            treasury_wallet : v0,
        };
        0x2::transfer::share_object<TreasuryConfig>(v19);
        let v20 = Whitelist{
            id        : 0x2::object::new(arg1),
            addresses : 0x2::vec_set::empty<address>(),
        };
        0x2::transfer::share_object<Whitelist>(v20);
        let v21 = ReferralRegistry{
            id        : 0x2::object::new(arg1),
            referrers : 0x2::table::new<address, address>(arg1),
        };
        0x2::transfer::share_object<ReferralRegistry>(v21);
        let v22 = GlobalStats{
            id                  : 0x2::object::new(arg1),
            common_minted       : 0,
            queen_minted        : 0,
        ...
        0x2::transfer::share_object<GlobalStats>(v22);
        let v23 = UserStatsRegistry{id: 0x2::object::new(arg1)};
        0x2::transfer::share_object<UserStatsRegistry>(v23);
    }
    ...
    public entry fun set_referrer(arg0: &mut ReferralRegistry, arg1: &PackSupply, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<address, u64>(&arg1.user_last_purchase_time, v0), 10);
        assert!(!0x2::table::contains<address, u64>(&arg1.user_whitelist_purchases, v0), 10);
    ...
    fun start_cooldown_if_sold_out(arg0: &mut PackSupply, arg1: &mut PerTypeSupply, arg2: &0x2::clock::Clock) {
        if (arg0.total_packs_remaining == 0 && !arg0.in_cooldown) {
            ...
            arg0.last_sellout_time = v0;
            arg0.cooldown_end_time = v0 + 300000;
            let v5 = LastMintOfBatch{
                completed_batch_number : v4,
                next_batch_number      : arg0.current_batch_number,
                cooldown_end_time      : arg0.cooldown_end_time,
                final_nfts_minted      : arg0.total_nfts_minted_globally,
            };
            0x2::event::emit<LastMintOfBatch>(v5);
            let v6 = CooldownStarted{
                batch_number      : v4,
                sellout_time      : v0,
                cooldown_end_time : arg0.cooldown_end_time,
            };
            0x2::event::emit<CooldownStarted>(v6);
        };
    }
    ...
    public entry fun team_mint(arg0: &mut TeamMintCap, arg1: &mut PackSupply, arg2: &mut GlobalStats, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 20;
        assert!(arg1.total_nfts_minted_globally + v1 <= 100, 14);
        let v2 = 0;
        while (v2 < 10) {
        ...
        while (v4 < 10) {
            ...
            0x2::kiosk::lock<DuckNFT>(arg3, arg4, arg5, create_duck_nft(2, 0, arg1.total_nfts_minted_globally + 10 + v4 + 1, arg6, arg7));
            v4 = v4 + 1;
        };
        arg0.minted = true;
