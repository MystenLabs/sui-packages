module 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::uint256x256_math {
    ...
    public fun sqrt(arg0: u256) : u256 {
        ...
        let v0 = 1 << (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::most_significant_bit(arg0) >> 1) + 1;
        loop {
            let v1 = v0 + arg0 / v0 >> 1;
            if (v1 >= v0) {
                break
