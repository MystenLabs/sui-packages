module 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::uint128x128_math {
    ...
    public fun log2(arg0: u256) : u256 {
        assert!(arg0 > 0, 300);
        if (arg0 == 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::constants::scale()) {
            return 0
        };
        let v0 = shr(arg0, 1);
        ...
        let v3 = (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::most_significant_bit(shr(v1, 127)) as u256);
    ...
    public fun pow(arg0: u256, arg1: u256) : u256 {
        if (arg1 == 0) {
            return 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::constants::scale()
        };
        if (arg0 == 0) {
            return 0
        };
