module 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::tree_math {
    ...
    public fun find_first_left(arg0: &TreeUint24, arg1: u32) : u32 {
        ...
        if (v1 < 255) {
            let v2 = 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::closest_bit_left(safe_borrow_table(&arg0.level2, v0), v1 + 1);
        ...
        if (v4 < 255) {
            let v5 = 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::closest_bit_left(safe_borrow_table(&arg0.level1, v3), v4 + 1);
            if (v5 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v6 = (v3 as u256) << 8 | v5;
                return ((v6 << 8 | (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::least_significant_bit(safe_borrow_table(&arg0.level2, (v6 as u64))) as u256)) as u32)
            };
        };
        let v7 = ((v3 & (255 as u64)) as u8);
        if (v7 < 255) {
            let v8 = 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::closest_bit_left(arg0.level0, v7 + 1);
            if (v8 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v9 = v8 << 8 | (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::least_significant_bit(safe_borrow_table(&arg0.level1, (v8 as u64))) as u256);
                return ((v9 << 8 | (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::least_significant_bit(safe_borrow_table(&arg0.level2, (v9 as u64))) as u256)) as u32)
            };
        };
        0
    }
    ...
    public fun find_first_right(arg0: &TreeUint24, arg1: u32) : u32 {
        ...
        let v1 = ((arg1 & (255 as u32)) as u8);
        if (v1 > 0) {
            let v2 = 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::closest_bit_right(safe_borrow_table(&arg0.level2, v0), v1 - 1);
            if (v2 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                return (((v0 as u256) << 8 | v2) as u32)
            };
        };
        ...
        let v4 = ((v0 & (255 as u64)) as u8);
        if (v4 > 0) {
            let v5 = 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::closest_bit_right(safe_borrow_table(&arg0.level1, v3), v4 - 1);
            if (v5 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v6 = (v3 as u256) << 8 | v5;
                return ((v6 << 8 | (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::most_significant_bit(safe_borrow_table(&arg0.level2, (v6 as u64))) as u256)) as u32)
            };
        };
        let v7 = ((v3 & (255 as u64)) as u8);
        if (v7 > 0) {
            let v8 = 0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::closest_bit_right(arg0.level0, v7 - 1);
            if (v8 != 115792089237316195423570985008687907853269984665640564039457584007913129639935) {
                let v9 = v8 << 8 | (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::most_significant_bit(safe_borrow_table(&arg0.level1, (v8 as u64))) as u256);
                return ((v9 << 8 | (0x9adc2caf7a827f1e05a76bf6cafb2bf7c8ebc30a27ff407b27b0cf03e9ddd183::bit_math::most_significant_bit(safe_borrow_table(&arg0.level2, (v9 as u64))) as u256)) as u32)
            };
        };
        16777215
    }
