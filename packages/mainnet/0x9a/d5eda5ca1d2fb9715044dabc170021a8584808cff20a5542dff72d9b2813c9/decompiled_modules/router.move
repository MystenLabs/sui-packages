module 0x422e3239f174320760dd675ba3835cf4b1c511be4a36e819cb61fab7d5d404a::router {
    ...
    struct ConfirmSwapEventV4 has copy, drop {
        quote_id: 0x1::string::String,
        from: 0x1::type_name::TypeName,
        target: 0x1::type_name::TypeName,
    ...
    public fun confirm_swap_v4<T0>(arg0: SwapContext, arg1: &mut 0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::ProtocolFeeVault, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = QuoteGuardKey{dummy_field: false};
        assert!(0x2::bag::contains_with_type<QuoteGuardKey, QuoteGuardV3>(&arg0.balances, v0), 0x422e3239f174320760dd675ba3835cf4b1c511be4a36e819cb61fab7d5d404a::errors::err_missing_quote_guard());
        let SwapContext {
            quote_id          : v1,
        ...
        let v15 = mul_div(v4, v13, v12);
        let v16 = mul_div(v15, 1000000 - v14, 1000000);
        assert!(v16 > 0, 0x422e3239f174320760dd675ba3835cf4b1c511be4a36e819cb61fab7d5d404a::errors::err_amount_out_limit_is_zero());
        let v17 = 0x2::bag::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v10, v3);
        let v18 = 0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::rate_denominator();
        let v19 = 0;
        let v20 = 0;
        if (v7 > 0 && v8 != @0x0) {
            let v21 = mul_div(0x2::balance::value<T0>(&v17), (v7 as u64), (1000000 as u64));
            let v22 = mul_div(v21, 0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::protocol_cut_rate(arg1), v18);
            v19 = v22;
            let v23 = v21 - v22;
            v20 = v23;
            0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::deposit_overlay_fee<T0>(arg1, 0x2::balance::split<T0>(&mut v17, v22));
            transfer_balance<T0>(0x2::balance::split<T0>(&mut v17, v23), v8, arg2);
        };
        assert!(0x2::balance::value<T0>(&v17) >= v16, 0x422e3239f174320760dd675ba3835cf4b1c511be4a36e819cb61fab7d5d404a::errors::err_amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v10), 0x422e3239f174320760dd675ba3835cf4b1c511be4a36e819cb61fab7d5d404a::errors::err_remains_balance());
        0x2::bag::destroy_empty(v10);
        let v24 = 0;
        let v25 = 0;
        if (0x2::balance::value<T0>(&v17) > v15) {
            let v26 = 0x2::balance::value<T0>(&v17) - v15;
            v24 = v26;
            let v27 = mul_div(v26, 0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::capture_rate(arg1), v18);
            v25 = v27;
            let v28 = mul_div(0x2::balance::value<T0>(&v17), 0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::volume_cap_rate(arg1), v18);
            if (v27 > v28) {
                v25 = v28;
            };
            0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::deposit_surplus_revenue<T0>(arg1, 0x2::balance::split<T0>(&mut v17, v25));
        };
        let v29 = ConfirmSwapEventV4{
            quote_id              : v1,
            from                  : v2,
            target                : v3,
            vault_id              : 0x2::object::id<0x4c9bc3a3ac829f684075b40a0287600cc557e0b846870e37da42adb017f73337::protocol_fee::ProtocolFeeVault>(arg1),
            quote_amount_in       : v12,
            quote_amount_out      : v13,
            slippage              : v14,
            amount_in             : v4,
            amount_out            : 0x2::balance::value<T0>(&v17),
            amount_out_limit      : v16,
            protocol_fee_amount   : v19,
            integrator_fee_amount : v20,
            surplus_amount        : v24,
            surplus_share         : v25,
            fee_rate              : v7,
            fee_recipient         : v8,
        };
        0x2::event::emit<ConfirmSwapEventV4>(v29);
        0x2::coin::from_balance<T0>(v17, arg2)
    }
