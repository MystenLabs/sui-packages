module 0x9a5e441ab67702541e490e3f208faacb13c20e2a855f7304906f7faac2012761::hash_share_market {
    ...
    public fun fill_buy_order<T0, T1>(arg0: &mut BuyOrder<T0, T1>, arg1: &MarketFeePool<T1>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::option::destroy_some<u64>(0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::u64::mul_div(v0, arg0.price_per_unit_mist, 1, 0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::rounding::down()));
        assert!(0x2::balance::value<T1>(&arg0.payment) >= v1, 13906835256675532807);
        let v2 = 0x2::tx_context::sender(arg3);
        let v3 = 0x1::option::destroy_some<u64>(0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::u64::mul_div(v1, 200, 10000, 0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::rounding::down()));
    ...
    public fun fill_sell_order<T0, T1>(arg0: &mut SellOrder<T0, T1>, arg1: &MarketFeePool<T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::option::destroy_some<u64>(0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::u64::mul_div(arg3, arg0.price_per_unit_mist, 1, 0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::rounding::down()));
        assert!(0x2::coin::value<T1>(&arg2) >= v0, 13906835888035725319);
        let v1 = 0x2::tx_context::sender(arg4);
        let v2 = 0x1::option::destroy_some<u64>(0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::u64::mul_div(v0, 200, 10000, 0x98ff8cc8145f3b37531148c12860865f040fb8d814f96834be173a15b8cb4f4c::rounding::down()));
