module 0x9a5e67653455c4f33c062ee16f0452f36d07be13b69d0763142a36b33b1cd453::reward4182 {
    struct REWARD4182 has drop {
        dummy_field: bool,
    }

    struct TICKET_4182 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4182(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4182>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4182>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4182, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4182>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4182>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4182>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4182>>(v5, 0x2::tx_context::sender(arg1));
    }
