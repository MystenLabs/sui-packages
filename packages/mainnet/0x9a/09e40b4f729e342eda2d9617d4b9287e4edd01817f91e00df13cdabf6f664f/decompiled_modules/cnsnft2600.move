module 0x9a09e40b4f729e342eda2d9617d4b9287e4edd01817f91e00df13cdabf6f664f::cnsnft2600 {
    struct CNSNFT2600 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2600>(arg0, arg1);
