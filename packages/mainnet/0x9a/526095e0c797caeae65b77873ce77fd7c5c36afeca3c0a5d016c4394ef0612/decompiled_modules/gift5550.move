module 0x9a526095e0c797caeae65b77873ce77fd7c5c36afeca3c0a5d016c4394ef0612::gift5550 {
    struct GIFT5550 has drop {
        dummy_field: bool,
    }

    struct TICKET_5550 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5550(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5550>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5550>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5550, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5550>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5550>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5550>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5550>>(v5, 0x2::tx_context::sender(arg1));
    }
