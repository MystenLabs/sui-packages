module 0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::launchpad_sale {
    ...
    public(friend) fun withdraw<T0: store + key, T1: store>(arg0: &mut Sale<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : T0 {
        let v0 = &mut arg0.reg;
        v0.born = v0.born + 1;
        0x2::object_table::remove<0x2::object::ID, T0>(&mut arg0.nfts, 0x1::vector::swap_remove<0x2::object::ID>(&mut v0.nft_index, 0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::random::rand_u64_range(0, 0x1::vector::length<0x2::object::ID>(&arg0.reg.nft_index), arg1)))
    }
