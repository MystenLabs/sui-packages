module 0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::bid {
    ...
    public entry fun accept_bid<T0: store + key, T1>(arg0: T0, arg1: &mut Bid<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::bid_event::bid_complete_event(0x2::object::id<T0>(&arg0), 0x2::object::id<Bid<T1>>(arg1), 0x2::tx_context::sender(arg2), v0);
    ...
    public entry fun accept_bid_from_market<T0: store + key, T1>(arg0: &mut 0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::market::Marketplace<T1>, arg1: 0x2::object::ID, arg2: &mut Bid<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::market::delist<T0, T1>(arg0, arg1, arg3);
    ...
    public entry fun add_bid_price<T0>(arg0: &mut Bid<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::bid_event::change_bid_price_event(0x2::object::id<Bid<T0>>(arg0), arg0.item_id, 0x2::tx_context::sender(arg2), 0x2::coin::value<T0>(&arg0.funds));
    }
    ...
    public entry fun cancel_bid<T0>(arg0: &mut Bid<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::bid_event::bid_cancel_event(arg0.item_id, 0x2::object::id<Bid<T0>>(arg0), 0x2::tx_context::sender(arg1));
    ...
    public entry fun new_bid<T0>(arg0: 0x2::object::ID, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::bid_event::new_bid_event(0x2::object::id<Bid<T0>>(&v0), arg0, 0x2::tx_context::sender(arg2), 0x2::coin::value<T0>(&arg1));
    }
    ...
    public entry fun reduce_bid_price<T0>(arg0: &mut Bid<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x9aa6d749c6ee26481c088bf61871b84c1d3320504023019cbea0d773a6047ac7::bid_event::change_bid_price_event(0x2::object::id<Bid<T0>>(arg0), arg0.item_id, v0, 0x2::coin::value<T0>(&arg0.funds));
    }
