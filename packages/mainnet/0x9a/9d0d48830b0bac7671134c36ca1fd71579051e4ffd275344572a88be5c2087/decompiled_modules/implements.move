module 0x9a9d0d48830b0bac7671134c36ca1fd71579051e4ffd275344572a88be5c2087::implements {
    ...
    public(friend) fun removeYY<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        assert!(arg2, 12);
        assert!(arg1 > 0, 12);
        assert!(!is_sui<T1>(), 17);
        assert!(0x2::clock::timestamp_ms(arg3) - arg0.last_burn_time / 24 * 60 * 1000 > 0, 18);
        let (_, v1, _) = get_reserves_size<T0, T1>(arg0);
        assert!(v1 > arg1, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg0.coin_y, arg1, arg4), arg0.burn_address);
