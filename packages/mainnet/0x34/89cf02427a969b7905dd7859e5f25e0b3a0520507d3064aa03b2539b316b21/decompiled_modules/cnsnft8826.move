module 0x3489cf02427a969b7905dd7859e5f25e0b3a0520507d3064aa03b2539b316b21::cnsnft8826 {
    struct CNSNFT8826 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8826, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8826>(arg0, arg1);
