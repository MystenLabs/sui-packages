module 0x3471cec1e100c064538c20dfac7c49e5709978ab72d4137576ca1e5e4496c7bb::cnsnft2042 {
    struct CNSNFT2042 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2042, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2042>(arg0, arg1);
