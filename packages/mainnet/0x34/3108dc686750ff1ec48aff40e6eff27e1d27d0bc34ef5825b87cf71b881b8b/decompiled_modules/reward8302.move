module 0x343108dc686750ff1ec48aff40e6eff27e1d27d0bc34ef5825b87cf71b881b8b::reward8302 {
    struct REWARD8302 has drop {
        dummy_field: bool,
    }

    struct TICKET_8302 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8302(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8302>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8302>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8302, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8302>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8302>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8302>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8302>>(v5, 0x2::tx_context::sender(arg1));
    }
