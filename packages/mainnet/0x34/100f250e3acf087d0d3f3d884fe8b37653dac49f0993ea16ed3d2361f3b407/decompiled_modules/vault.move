module 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::vault {
    ...
    struct DepositQueue<phantom T0> has store {
        requests: 0x2::linked_table::LinkedTable<address, DepositRequest<T0>>,
    ...
    public(friend) fun add_deposit_request<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::balance::Balance<T1>, arg2: address, arg3: u8) {
        let v0 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_active();
        assert!(&arg0.state == &v0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::strategy_not_active());
        let v1 = 0x2::balance::value<T1>(&arg1);
        assert!(v1 >= 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::min_deposit_amount(), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::deposit_amount_too_low());
        let v2 = &mut arg0.deposit_queue;
        v2.unprocessed_amount = v2.unprocessed_amount + v1;
        v2.pending_requests = v2.pending_requests + 1;
        if (0x2::linked_table::contains<address, DepositRequest<T1>>(&v2.requests, arg2)) {
            0x2::balance::join<T1>(&mut 0x2::linked_table::borrow_mut<address, DepositRequest<T1>>(&mut v2.requests, arg2).amount, arg1);
        } else {
            ...
            0x2::linked_table::push_back<address, DepositRequest<T1>>(&mut v2.requests, arg2, v3);
        };
    }
    ...
    public(friend) fun add_swap_route<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: vector<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>) {
        ...
        assert!(!0x2::bag::contains<0x1::ascii::String>(&arg0.swap_routes, v0), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::invalid_route());
    ...
    public fun calculate_lp_token_share<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        assert!(v4 > 0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::invalidLPToken());
        (v0 * arg2 / v4, v2 * arg2 / v4)
    }

    public(friend) fun check_vault_cap_compatibility<T0, T1, T2>(arg0: &VaultCap, arg1: &Vault<T0, T1, T2>) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1, T2>(arg1), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::invalid_vault_cap());
    }
    ...
    public(friend) fun claim_withdrawal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::table::contains<address, ClaimableWithdrawals<T0, T1>>(&arg0.claimable_withdrawals, arg1), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::claim_does_not_exist());
    ...
    public fun get_user_unprocessed_deposits<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: address) : u64 {
        ...
        if (0x2::linked_table::contains<address, DepositRequest<T1>>(&v0.requests, arg1)) {
            0x2::balance::value<T1>(&0x2::linked_table::borrow<address, DepositRequest<T1>>(&v0.requests, arg1).amount)
        } else {
            0
        }
    }
    ...
    public(friend) fun mark_state_as_ready_for_withdrawal_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::tx_context::TxContext) {
        assert!(is_address_whitelisted_for_trading<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg1)), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::address_not_whitelisted());
        let v0 = &arg0.deposit_queue;
        let v1 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::strategy_not_ready_for_withdrawal_processing());
        arg0.state = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_paused_and_ready_for_withdrawal_processing();
    }
    ...
    fun mint_lp_token<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::minimal_liquidity(), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::liquidityInsufficientMinted());
        0x2::coin::mint<T0>(arg0, v1, arg5)
    }

    public(friend) fun new_vault<T0, T1, T2>(arg0: &0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::app::AdminCap, arg1: 0x2::coin::TreasuryCap<T2>, arg2: &0xdee9::clob_v2::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, VaultCap) {
        let v0 = DepositQueue<T1>{
            requests           : 0x2::linked_table::new<address, DepositRequest<T1>>(arg4),
        ...
        let v2 = Vault<T0, T1, T2>{
            ...
            epoch_counter         : 0,
            state                 : 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_active(),
    ...
    public(friend) fun pause_strategy_and_mark_ready_for_deposit_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::tx_context::TxContext) {
        assert!(is_address_whitelisted_for_trading<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg2)), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::address_not_whitelisted());
        let v0 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_active();
        assert!(&arg0.state == &v0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::strategy_not_active());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::invalid_pool());
        ...
        arg0.state = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_paused_and_ready_for_deposit_processing();
    }

    public(friend) fun process_deposits<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &0x2::clock::Clock, arg5: &0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::vault_acl::VaultAcl, arg6: &0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::acl::RouterAcl, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::strategy_not_ready_for_deposit_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::invalid_pool());
        let v1 = &arg0.deepbook_account_cap;
        let (v2, v3, v4, v5) = get_deepbook_account_assets<T0, T1, T2>(arg0, arg1);
        let v6 = get_swap_route<T0, T1, T2>(arg0);
        assert!(v3 == 0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::locked_base_asset_found());
        assert!(v5 == 0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::locked_quote_asset_found());
        let (_, _, v9) = get_deepbook_price<T0, T1>(arg1);
        let v10 = v2;
        let v11 = v4;
        let v12 = &mut arg0.treasury_cap;
        let v13 = 0;
        let v14 = &mut arg0.deposit_queue;
        while (v13 < arg7 && 0x2::linked_table::length<address, DepositRequest<T1>>(&v14.requests) > 0) {
            let (_, v16) = 0x2::linked_table::pop_front<address, DepositRequest<T1>>(&mut v14.requests);
            let DepositRequest {
                amount       : v17,
                owner        : v18,
                request_type : _,
            ...
            let v22 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::process_deposit_helper::issue_swap_receipt<T1>(arg5, arg6, v6, 0x2::balance::split<T1>(&mut v20, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::process_deposit_helper::get_amount_to_swap(v21, v10, v11, v9)), arg8);
            0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::cetus_adapter::swap_router<T0, T1>(&mut v22, arg2, arg3, arg6, arg4, arg8);
            let v23 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::process_deposit_helper::consume_swap_receipt<T0>(v22, arg5);
            let v24 = 0x2::coin::from_balance<T1>(v20, arg8);
            let v25 = v10 + 0x2::coin::value<T0>(&v23);
            v10 = v25;
            let v26 = v11 + 0x2::coin::value<T1>(&v24);
            v11 = v26;
            let v27 = mint_lp_token<T2>(v12, v25, v26, 0x2::coin::value<T0>(&v23), 0x2::coin::value<T1>(&v24), arg8);
            0xdee9::clob_v2::deposit_base<T0, T1>(arg1, v23, v1);
            0xdee9::clob_v2::deposit_quote<T0, T1>(arg1, v24, v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v27, v18);
            v14.unprocessed_amount = v14.unprocessed_amount - v21;
            v14.pending_requests = v14.pending_requests - 1;
            v13 = v13 + 1;
        };
        0x1::vector::destroy_empty<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>(v6);
        if (v14.pending_requests == 0) {
            mark_state_as_ready_for_withdrawal_processing<T0, T1, T2>(arg0, arg8);
        };
    }
    ...
    public(friend) fun process_withdrawals<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::strategy_not_ready_for_withdrawal_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::invalid_pool());
        let v1 = &arg0.deepbook_account_cap;
        let v2 = 0;
    ...
    public(friend) fun revoke_trading_permission<T0, T1, T2>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>, arg2: address) {
        ...
        assert!(v0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::address_not_whitelisted());
    ...
    public(friend) fun start_strategy<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        assert!(is_address_whitelisted_for_trading<T0, T1, T2>(arg0, 0x2::tx_context::sender(arg2)), 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::address_not_whitelisted());
        let v0 = &arg0.withdraw_queue;
        let v1 = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::error::strategy_not_ready_to_make_active());
        arg0.state = 0x34100f250e3acf087d0d3f3d884fe8b37653dac49f0993ea16ed3d2361f3b407::constants::strategy_active();
