module 0x5ad1f0ff5e19834315d4bbcd6425fcf946929c153d5a1680f838f2b343c30d1e::launchpad {
    ...
    public entry fun claim<T0, T1>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x5ad1f0ff5e19834315d4bbcd6425fcf946929c153d5a1680f838f2b343c30d1e::math_extend::mul_div(arg0.claim_amount_per_coin_uint, v1.paid_amount, arg0.pay_coin_unit);
        assert!(v2 > 0, 1005);
    ...
    public entry fun purchase<T0>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, *0x1::vector::borrow<address>(&arg0.inviters, (0x2::clock::timestamp_ms(arg1) + v1 + arg0.remain_pay_supply) % 0x1::vector::length<address>(&arg0.inviters)));
        v4.paid_amount = v4.paid_amount + v1;
    }

    public entry fun set_airdrop<T0>(arg0: &mut LaunchInfo<T0>, arg1: &mut LaunchCap, arg2: vector<address>, arg3: vector<u64>) {
        assert!(0x2::object::uid_to_inner(&arg1.id) == arg0.launch_cap_id, 1010);
        assert!(0x1::vector::length<address>(&arg2) == 0x1::vector::length<u64>(&arg3), 1111);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            let v1 = Info{
                paid_amount    : *0x1::vector::borrow<u64>(&mut arg3, v0),
                claimed_amount : 0,
                is_freeze      : false,
            };
            0x2::table::add<address, Info>(&mut arg0.all_info, *0x1::vector::borrow<address>(&mut arg2, v0), v1);
            v0 = v0 + 1;
        };
    }

    public entry fun set_airdrop_v2<T0>(arg0: &mut LaunchInfo<T0>, arg1: &mut LaunchCap, arg2: vector<address>, arg3: vector<u64>) {
        assert!(0x2::object::uid_to_inner(&arg1.id) == arg0.launch_cap_id, 1010);
        assert!(0x1::vector::length<address>(&arg2) == 0x1::vector::length<u64>(&arg3), 1111);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            let v1 = 0x2::table::borrow_mut<address, Info>(&mut arg0.all_info, *0x1::vector::borrow<address>(&mut arg2, v0));
            v1.paid_amount = *0x1::vector::borrow<u64>(&mut arg3, v0);
            v1.claimed_amount = 0;
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun set_remain_supply<T0, T1>(arg0: &mut LaunchInfo<T0>, arg1: &LaunchCap, arg2: u64) {
        ...
        if (arg2 == 0) {
            arg0.inviters = 0x1::vector::empty<address>();
        };
    }
