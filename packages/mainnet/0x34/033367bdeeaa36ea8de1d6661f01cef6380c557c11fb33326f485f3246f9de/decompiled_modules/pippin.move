module 0x34033367bdeeaa36ea8de1d6661f01cef6380c557c11fb33326f485f3246f9de::pippin {
    ...
    fun init(arg0: PIPPIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<PIPPIN>(&mut v3, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
