module 0x3464d3508e6eeb201c24bda40b52883e0a02e9393eb5891e777082284eb91785::oft_ptb_builder {
    struct OFTPtbBuilder {
        dummy_field: bool,
    }

    fun add_lz_receive_call<T0>(arg0: &mut 0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_calls_builder::MoveCallsBuilder, arg1: &0x3464d3508e6eeb201c24bda40b52883e0a02e9393eb5891e777082284eb91785::oft::OFT<T0>, arg2: &0x2::clock::Clock) {
        let v0 = 0x1::vector::empty<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>();
        let v1 = &mut v0;
        0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>(v1, 0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::create_object(0x2::object::id_address<0x3464d3508e6eeb201c24bda40b52883e0a02e9393eb5891e777082284eb91785::oft::OFT<T0>>(arg1)));
        0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>(v1, 0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::create_object(0x3464d3508e6eeb201c24bda40b52883e0a02e9393eb5891e777082284eb91785::oft::oapp_object<T0>(arg1)));
    ...
    fun add_lz_receive_compose_call<T0>(arg0: &mut 0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_calls_builder::MoveCallsBuilder, arg1: &0x3464d3508e6eeb201c24bda40b52883e0a02e9393eb5891e777082284eb91785::oft::OFT<T0>, arg2: &0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::endpoint_v2::EndpointV2, arg3: address, arg4: address, arg5: &0x2::clock::Clock) {
        let v0 = 0x1::vector::empty<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>();
        let v1 = &mut v0;
        0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>(v1, 0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::create_object(0x2::object::id_address<0x3464d3508e6eeb201c24bda40b52883e0a02e9393eb5891e777082284eb91785::oft::OFT<T0>>(arg1)));
        0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>(v1, 0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::create_object(0x3464d3508e6eeb201c24bda40b52883e0a02e9393eb5891e777082284eb91785::oft::oapp_object<T0>(arg1)));
