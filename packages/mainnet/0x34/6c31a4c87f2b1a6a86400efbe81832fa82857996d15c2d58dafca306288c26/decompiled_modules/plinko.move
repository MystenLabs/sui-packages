module 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::plinko {
    ...
    public entry fun play_plinko(arg0: &mut 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::house_pool::HousePool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: u8, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 <= 2, 0);
        let v0 = if (arg4 == 8) {
            true
        } else if (arg4 == 12) {
        ...
        let v5 = v1 * v4 / 100;
        let v6 = v5 > v1;
        let v7 = 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::house_pool::process_bet(arg0, arg1, v6, v5, b"plinko", arg5);
