module 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::wheel {
    ...
    public entry fun play_wheel(arg0: &mut 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::house_pool::HousePool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: u8, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::house_pool::process_bet(arg0, arg1, v5, v7, b"wheel", arg5);
        let v9 = WheelResult{
            player        : v0,
            bet_amount    : v1,
            won           : v5,
