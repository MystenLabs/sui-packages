module 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::crash {
    ...
    public entry fun play_crash(arg0: &mut 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::house_pool::HousePool, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x346c31a4c87f2b1a6a86400efbe81832fa82857996d15c2d58dafca306288c26::house_pool::process_bet(arg0, arg1, v5, v8, b"crash", arg4);
        let v10 = CrashResult{
            player        : v0,
            bet_amount    : v1,
            won           : v5,
