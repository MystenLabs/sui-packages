module 0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_margin {
    ...
    public fun atomic_close_to_vault<T0>(arg0: &mut 0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        ...
        0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::deposit_usdc_from_trading<T0>(arg0, v1);
    }

    public fun atomic_deposit_to_bm<T0>(arg0: &mut 0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
        ...
        assert!((v1 as u128) <= (0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::available_usdc_for_trading<T0>(arg0) as u128) * (arg2.max_allocation_bps as u128) / (10000 as u128), 102);
    ...
    public fun atomic_swap_and_close<T0, T1>(arg0: &mut 0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T1>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg5: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::deposit_usdc_from_trading<T1>(arg0, v9);
    }

    public fun atomic_swap_base_to_quote<T0, T1>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T1>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &MarginAccount, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg5: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T1>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
    ...
    public fun atomic_swap_quote_to_base<T0, T1>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T1>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &MarginAccount, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg5: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T1>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
    ...
    public fun authorize_margin_deposit<T0>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : MarginDepositAuth {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
        assert!(arg2.enabled, 100);
        assert!(arg3 > 0, 101);
        assert!(((arg2.total_allocated + arg3) as u128) <= (0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::available_usdc_for_trading<T0>(arg0) as u128) * (arg2.max_allocation_bps as u128) / (10000 as u128), 102);
    ...
    public fun authorize_margin_return<T0>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : MarginReturnAuth {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        MarginReturnAuth{
    ...
    public fun complete_margin_close<T0>(arg0: CloseObligation, arg1: &mut 0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg2: &mut MarginAccount, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock) {
        let CloseObligation {
            vault_id   : v0,
            min_return : v1,
        } = arg0;
        assert!(v0 == 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg1), 100);
        ...
        0x2::event::emit<MarginFundsReturned>(v5);
        0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::deposit_usdc_from_trading<T0>(arg1, arg3);
    }

    public fun consume_margin_deposit<T0>(arg0: MarginDepositAuth, arg1: &mut 0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg2: &mut MarginAccount, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v1 == 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg1), 100);
        ...
        0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::extract_usdc_for_trading<T0>(arg1, v2, arg4)
    }

    public fun create_margin_account<T0>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0), 100);
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
    ...
    public fun initiate_margin_close<T0>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &MarginAccount, arg3: u64) : CloseObligation {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
        CloseObligation{
    ...
    public fun reset_allocation<T0>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount) {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
        arg2.total_allocated = 0;
    ...
    public fun return_margin_funds<T0>(arg0: MarginReturnAuth, arg1: &mut 0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg2: &mut MarginAccount, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &0x2::clock::Clock) {
    ...
    public fun update_margin_settings<T0>(arg0: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>, arg1: &0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiLeaderCap, arg2: &mut MarginAccount, arg3: u64, arg4: u64, arg5: bool) {
        let v0 = 0x2::object::id<0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::SuiVault<T0>>(arg0);
        assert!(0x349dfa203d142a8595566da2ad1d2fcf31d0684e3961d92a235ae47b10baaea8::sui_vault::leader_cap_vault_id(arg1) == v0, 100);
        assert!(arg2.vault_id == v0, 100);
