module 0x3437881139cd9b73cf421b14670c6711727a180b85361878f287014164a2eda6::options_builder {
    ...
    public fun encode_legacy_options_type1(arg0: u256) : vector<u8> {
        assert!(arg0 < 340282366920938463463374607431768211455, 2);
    ...
    public fun encode_legacy_options_type2(arg0: u256, arg1: u256, arg2: vector<u8>) : vector<u8> {
        assert!(arg0 < 340282366920938463463374607431768211455, 2);
        assert!(arg1 < 340282366920938463463374607431768211455, 2);
    ...
    public fun new_from_options(arg0: vector<u8>) : OptionsBuilder {
        let v0 = 0x245ba36f7a1cc643a2b037450dff1e4399e18069c6545fb5fcaaf37d39d7dc::buffer_reader::create(arg0);
        assert!(0x245ba36f7a1cc643a2b037450dff1e4399e18069c6545fb5fcaaf37d39d7dc::buffer_reader::read_u16(&mut v0) == 3, 1);
        OptionsBuilder{options: arg0}
    }
