module 0x34388e8331a382b664f6d828d1347b8a0a7318b9f87fdb674987637aad87850a::liquidator {
    ...
    public(friend) fun ensure_caller_whitelisted(arg0: &Liquidator, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg1), 0x34388e8331a382b664f6d828d1347b8a0a7318b9f87fdb674987637aad87850a::error::not_whitelisted());
    }
    ...
    public fun update_slippage_tolerance(arg0: &LiquidatorAdminCap, arg1: &mut Liquidator, arg2: u32) {
        assert!(arg2 <= 10000, 0x34388e8331a382b664f6d828d1347b8a0a7318b9f87fdb674987637aad87850a::error::invalid_slippage());
