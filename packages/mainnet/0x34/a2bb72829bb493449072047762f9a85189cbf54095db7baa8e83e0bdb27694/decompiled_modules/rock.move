module 0x34a2bb72829bb493449072047762f9a85189cbf54095db7baa8e83e0bdb27694::rock {
    ...
    fun init(arg0: ROCK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ROCK>(arg0, 6, b"ROCK", b"RockSui", b"$Rock  is a Powerfull #meme token   https://www.rockk.xyz/  https://x.com/rocksonsui   https://t.me/rockonsuiportal", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://belaunchio.infura-ipfs.io/ipfs/QmXBcFGukKdM2gFx64tk9sj4PkvUmFJ1jshWYVFGbq1Lhm")), arg1);
