module 0x343d8569f8fbad4c77c134033cdb539db951b727df002d9664b8e7840eda5182::reward5850 {
    struct REWARD5850 has drop {
        dummy_field: bool,
    }

    struct TICKET_5850 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5850(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5850>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5850>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5850, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5850>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5850>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5850>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5850>>(v5, 0x2::tx_context::sender(arg1));
    }
