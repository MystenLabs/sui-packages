module 0x34e846e4a6cf56d6cb1e0a5e1b7d3130c1d5b88de15bdb6a3190d60044b59854::reward4059 {
    struct REWARD4059 has drop {
        dummy_field: bool,
    }

    struct TICKET_4059 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4059(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4059>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4059>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4059, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4059>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4059>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4059>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4059>>(v5, 0x2::tx_context::sender(arg1));
    }
