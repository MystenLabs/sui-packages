module 0x34e9b82b35aff3238703597b55a7f471e155e103416a01b77e81bb84e43f464b::cnsnft8910 {
    struct CNSNFT8910 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8910, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8910>(arg0, arg1);
