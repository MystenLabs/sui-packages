module 0x348ee392e8c34b98b3d0d0c6b976f76eeb2ee205b68e153b3e6373c989a94c61::admin {
    ...
    public(friend) fun add_direct_push_reward(arg0: &mut GlobalNetworkData, arg1: u64) {
        arg0.reward_stats.direct_push_reward = arg0.reward_stats.direct_push_reward + arg1;
    }
    ...
    public(friend) fun add_pre_burn_pre_amount(arg0: &mut GlobalNetworkData, arg1: u64) {
        arg0.other_stats.pre_burn_amount = arg0.other_stats.pre_burn_amount + arg1;
    }
    ...
    public(friend) fun add_total_claimed_sui(arg0: &mut GlobalNetworkData, arg1: u64) {
        arg0.other_stats.total_claimed_sui = arg0.other_stats.total_claimed_sui + arg1;
    }
    ...
    public(friend) fun clean_rank_reward(arg0: &mut GlobalNetworkData) {
        arg0.reward_stats.current_share_rank_dividend_amount = 0;
    }

    public(friend) fun get_current_rank_reward(arg0: &GlobalNetworkData) : u64 {
        arg0.reward_stats.current_share_rank_dividend_amount
    }
    ...
    public(friend) fun set_total_share_rank_dividend_amount(arg0: &mut GlobalNetworkData, arg1: u64, arg2: u64) {
        arg0.reward_stats.total_share_rank_dividend_amount = arg1;
        arg0.reward_stats.current_share_rank_dividend_amount = arg2;
    }

    public(friend) fun sub_total_admin_sui_amount(arg0: &mut GlobalNetworkData, arg1: u64) {
        if (arg0.other_stats.total_admin_sui_amount >= arg1) {
            arg0.other_stats.total_admin_sui_amount = arg0.other_stats.total_admin_sui_amount - arg1;
        };
    }
