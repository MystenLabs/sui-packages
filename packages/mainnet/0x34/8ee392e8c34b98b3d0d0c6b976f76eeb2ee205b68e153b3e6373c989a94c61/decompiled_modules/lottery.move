module 0x348ee392e8c34b98b3d0d0c6b976f76eeb2ee205b68e153b3e6373c989a94c61::lottery {
    ...
    public(friend) fun add_chances_by_amount<T0>(arg0: &mut Lottery<T0>, arg1: u64, arg2: &0x2::tx_context::TxContext) {
    ...
    public(friend) fun admin_set_prize_weights_bps<T0>(arg0: &mut Lottery<T0>, arg1: vector<u64>) {
        assert_version(arg0.version);
        assert!(0x1::vector::length<u64>(&arg0.prize_amounts) == 0x1::vector::length<u64>(&arg1), 7);
        assert!(sum_u64(&arg1) == 10000, 7);
        arg0.prize_weights_bps = arg1;
    }
    ...
    public(friend) fun create_default<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = vector[5000, 4000, 500, 300, 200, 0, 0, 0, 0];
    ...
    public fun draw_once<T0>(arg0: &mut Lottery<T0>, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.reward_vault, v6, arg2), v0);
        *v2 = *v2 - 1;
