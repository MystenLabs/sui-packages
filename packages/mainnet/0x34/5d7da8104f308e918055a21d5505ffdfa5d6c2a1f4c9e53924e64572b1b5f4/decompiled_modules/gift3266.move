module 0x345d7da8104f308e918055a21d5505ffdfa5d6c2a1f4c9e53924e64572b1b5f4::gift3266 {
    struct GIFT3266 has drop {
        dummy_field: bool,
    }

    struct TICKET_3266 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3266(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3266>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3266>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3266, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3266>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3266>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3266>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3266>>(v5, 0x2::tx_context::sender(arg1));
    }
