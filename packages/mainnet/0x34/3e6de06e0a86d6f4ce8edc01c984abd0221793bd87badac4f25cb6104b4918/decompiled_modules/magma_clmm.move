module 0x343e6de06e0a86d6f4ce8edc01c984abd0221793bd87badac4f25cb6104b4918::magma_clmm {
    public fun magma_clmm_add_liquidity<T0, T1>(arg0: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg1: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::Position, arg4: u128, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::add_liquidity<T0, T1>(arg1, arg0, arg3, arg4, arg2, arg7);
        let v1 = 0x2::coin::into_balance<T0>(arg5);
        let v2 = 0x2::coin::into_balance<T1>(arg6);
        let (v3, v4) = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::add_liquidity_pay_amount<T0, T1>(&v0);
        0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::repay_add_liquidity<T0, T1>(arg1, arg0, 0x2::balance::split<T0>(&mut v1, v3), 0x2::balance::split<T1>(&mut v2, v4), v0);
        transfer_or_destroy_balance<T0>(v1, arg7);
        transfer_or_destroy_balance<T1>(v2, arg7);
    }
