module 0x66648edaf473d6cc14b7ab46f56b673be4e44f9c940f70b6bacd7848808859b::alphafi_bluefin_type_1_investor {
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<0x2::sui::SUI>()) == true) {
            ...
            if (v9 >= arg0.minimum_swap_amount) {
                let (v10, v11) = 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::converter::swap_b2a<T1, 0x2::sui::SUI>(arg3, arg7, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(v8), arg9), true, v9, arg8, arg9);
                let v12 = v10;
        ...
        let (_, _, v15, v16) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg8, arg2, arg4, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v17 = v16;
        let v18 = v15;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v18, (v19 as u64)), arg9), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v17, (v20 as u64)), arg9), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
        let v21 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::fee_rate<T1, T0>(arg6);
        let v22 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T1, T0>(arg6);
        let v23 = if (v21 == 100) {
            v22 * 999749968 / 1000000000
        } else if (v21 == 10000) {
            v22 * 992471662 / 1000000000
        } else {
            v22 * 994987437 / 1000000000
        };
        let v24 = if (v21 == 100) {
            v22 * 1000249968 / 1000000000
        } else if (v21 == 10000) {
            v22 * 1007472083 / 1000000000
        } else {
            v22 * 1004987562 / 1000000000
        };
        let (v25, v26) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v18, v17, arg4, arg6, v23, v24, arg8, arg9);
        let (_, v28, v29, v30) = get_balances_in_ratio<T0, T1>(arg0, v25, v26, arg4, true, arg9);
        let v31 = v29;
        let v32 = v28;
    ...
    public fun rebalance<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::RebalanceCap, arg2: &0x66648edaf473d6cc14b7ab46f56b673be4e44f9c940f70b6bacd7848808859b::version::Version, arg3: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: u32, arg7: u32, arg8: u32, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg10: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg11: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg12: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        while (v13 < arg8 + 1) {
            ...
            let (_, _, v16, v17) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg4, arg9, &mut v0, v11, arg13);
            let v18 = v17;
            let v19 = v16;
            ...
            let (v20, v21) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg4, arg5, v19, v18, arg9, arg10, v9, v10, arg13, arg14);
            let (_, v23, v24, v25) = get_balances_in_ratio<T0, T1>(arg0, v20, v21, arg9, true, arg14);
            let v26 = v24;
            let v27 = v23;
            if (0x2::balance::value<T0>(&v27) > 100 || 0x2::balance::value<T1>(&v26) > 100) {
                let (v28, v29) = if (0x2::balance::value<T0>(&v27) == 0 || v25 == false) {
                    let (v30, v31, v32, v33) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg13, arg4, arg9, &mut v1, v27, v26, 0x2::balance::value<T1>(&v26), false);
                    let _ = v31;
                    let _ = v30;
                    (v33, v32)
                } else {
                    let (v36, v37, v38, v39) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg13, arg4, arg9, &mut v1, v27, v26, 0x2::balance::value<T0>(&v27), true);
                    let _ = v37;
                    let _ = v36;
                    (v39, v38)
                };
        ...
        let (v40, v41, v42) = autocompound_internal<T0, T1, T2, T3>(arg0, arg3, arg4, arg5, arg9, arg11, arg10, arg12, arg13, arg14);
        let v43 = v41;
        let v44 = v40;
        ...
        if (0x2::balance::value<T0>(&v44) > 100 || 0x2::balance::value<T1>(&v43) > 100) {
            deposit<T0, T1>(arg0, arg4, arg9, v44, v43, v42, arg13);
        } else {
