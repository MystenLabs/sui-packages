module 0x34d6b9571ae1abede3fb4a80a9c0b1c65c947d604db39e655fc335724eb95d87::evai {
    ...
    fun init(arg0: EVAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/MLGBmJJTWdmmoS2W2VxNmGEHj2iz15h1nZmzLx5pump.png?size=lg&key=1b8d94                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<EVAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"EVAI    ")))), trim_right(b"Eva AI                          "), trim_right(b"Build and explore relationships with Eva, your personal AI companion (18+)                                                                                                                                                                                                                                                      "), v2, arg1);
        let v5 = v3;
