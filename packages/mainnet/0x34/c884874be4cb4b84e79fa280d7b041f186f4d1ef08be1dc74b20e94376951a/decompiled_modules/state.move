module 0x34c884874be4cb4b84e79fa280d7b041f186f4d1ef08be1dc74b20e94376951a::state {
    struct State has key {
        ...
        paused: bool,
        roles: 0x34c884874be4cb4b84e79fa280d7b041f186f4d1ef08be1dc74b20e94376951a::roles::Roles,
    ...
    public(friend) fun new(arg0: u32, arg1: u32, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : State {
        State{
            ...
            paused                : false,
            roles                 : 0x34c884874be4cb4b84e79fa280d7b041f186f4d1ef08be1dc74b20e94376951a::roles::new(arg3, arg3, arg3, arg4),
            compatible_versions   : 0x2::vec_set::singleton<u64>(0x34c884874be4cb4b84e79fa280d7b041f186f4d1ef08be1dc74b20e94376951a::version_control::current_version()),
        }
    }

    public fun roles(arg0: &State) : &0x34c884874be4cb4b84e79fa280d7b041f186f4d1ef08be1dc74b20e94376951a::roles::Roles {
        &arg0.roles
    }
    ...
    public(friend) fun roles_mut(arg0: &mut State) : &mut 0x34c884874be4cb4b84e79fa280d7b041f186f4d1ef08be1dc74b20e94376951a::roles::Roles {
        &mut arg0.roles
    }
