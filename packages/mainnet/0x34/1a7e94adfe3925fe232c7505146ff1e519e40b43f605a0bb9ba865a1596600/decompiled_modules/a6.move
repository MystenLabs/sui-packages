module 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::a6 {
    ...
    public fun ap<T0, T1>(arg0: &mut A<T0, T1>, arg1: &0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::vault::Vault<T1>, arg2: &0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::aftermath_perp_adapter::PerpAccount<T0, T1>, arg3: &0x9591a869747770ffd0ae181baf2aea8a8092ed00f3cc7d309c86cc309096d1e4::config::LotusConfig, arg4: u64, arg5: 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::clearing_house::ClearingHouse<T1>, arg6: &mut 0x3ec740df8428aa9c93aaef7f8cc1542ac3194fd014826b51bfe245346d64efc7::account::Account<T1>, arg7: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg8: &0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed_storage::PriceFeedStorage, arg9: u64, arg10: u64, arg11: u64, arg12: u8, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        arg0.b.f = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m0::lx(arg0.b.f, v22, arg0.tox_in, arg0.tox_out);
        arg0.x.f = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m0::lx(arg0.x.f, v23, arg0.tox_in, arg0.tox_out);
        if (arg0.b.f) {
            v11 = v11 | 256;
        };
        if (arg0.x.f) {
        ...
        let v24 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::tg(arg11, arg12, arg13, false);
        let v25 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::tg(arg11, arg12, arg13, true);
        let v26 = if (v24 > 0) {
            v24
        } else {
            v25
        ...
        let v29 = if (v28) {
            let (v30, _) = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::mkp(true, v24, arg0.cost, v3, v2, arg0.off, v17);
            v30
        } else {
            0
        };
        ...
        let v33 = if (v32) {
            let (v34, _) = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::mkp(false, v25, arg0.cost, v3, v2, arg0.off, v17);
            v34
        } else {
            0
        };
        let (v36, v37) = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m0::cx(v29, v33, v3, v2, v17, arg12);
        let v38 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::rqd(arg0.b.o != 0, arg0.b.p, v36, true, econ_bound(v24, arg0.cost, true), arg0.improve, v17, arg0.b.e, v1, arg0.refresh);
        let v39 = 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::rqd(arg0.x.o != 0, arg0.x.p, v37, false, econ_bound(v25, arg0.cost, false), arg0.improve, v17, arg0.x.e, v1, arg0.refresh);
        let v40 = false;
        let v41 = false;
        if (v38 != 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.b.o != 0) {
            let v42 = &mut arg5;
            ...
            v40 = v44;
        } else if (v38 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.b.o != 0) {
            v11 = v11 | 1;
        };
        if (v39 != 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.x.o != 0) {
            let v45 = &mut arg5;
            ...
            v41 = v47;
        } else if (v39 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_keep() && arg0.x.o != 0) {
            v11 = v11 | 8;
        };
        let v48 = if (v38 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_replace()) {
            if (v36 > 0) {
                v19 > 0
            } else {
                false
        ...
        let v49 = if (v39 == 0x341a7e94adfe3925fe232c7505146ff1e519e40b43f605a0bb9ba865a1596600::m1::act_replace()) {
            if (v37 > 0) {
                v20 > 0
            } else {
                false
