module 0x34520e03b9b75f75ad6f77d0036f027d24f8beec09dba1a431fb030b81a4c0c6::reward9899 {
    struct REWARD9899 has drop {
        dummy_field: bool,
    }

    struct TICKET_9899 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9899(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9899>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9899>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9899, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9899>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9899>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9899>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9899>>(v5, 0x2::tx_context::sender(arg1));
    }
