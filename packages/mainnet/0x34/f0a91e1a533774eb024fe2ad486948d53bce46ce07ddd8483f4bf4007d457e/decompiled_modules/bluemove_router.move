module 0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::bluemove_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &mut FeeObject, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= arg1, 1);
        let v0 = arg1 * arg0.buy_fee / 10000;
        let v1 = arg1 - v0;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg6)));
        ...
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_coin<T0>(v2, 0x2::tx_context::sender(arg6));
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg6));
        let v3 = BuyEvent<T0>{
    ...
    public entry fun buy_exact_in_by_usdc<T0>(arg0: &mut FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: u64, arg5: u64, arg6: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg7: 0x1::string::String, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_coin<T0>(v8, 0x2::tx_context::sender(arg9));
    ...
    public entry fun collect_fee(arg0: &mut FeeObject, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, arg1), arg0.admin, arg2);
    }
    ...
    public entry fun sell_exact_in<T0>(arg0: &mut FeeObject, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg6)));
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg6));
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg6));
        let v3 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg6),
            amount_in  : arg1,
            amount_out : v1 - v2,
    ...
    public entry fun sell_exact_in_for_usdc<T0>(arg0: &mut FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: u64, arg6: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg7: 0x1::string::String, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<T0>(&arg3) >= arg4, 1);
        let v0 = 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::router::swap_exact_input_<T0, 0x2::sui::SUI>(arg4, 0x2::coin::split<T0>(&mut arg3, arg4, arg9), 0, arg6, arg9);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&v0);
        let v2 = v1 * arg0.sell_fee / 10000;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v0, v2, arg9)));
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg9));
        ...
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v7, 0x2::tx_context::sender(arg9), arg9);
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_balance<0x2::sui::SUI>(v4, 0x2::tx_context::sender(arg9), arg9);
        0x34f0a91e1a533774eb024fe2ad486948d53bce46ce07ddd8483f4bf4007d457e::utils::send_coin<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg9));
