module 0x34405b31c325bf653b1f852336fd18de2964a53b0a3fcc36742c257e53f456eb::pool {
    ...
    public fun create_pool<T0: copy + drop + store, T1: store + key, T2: store + key>(arg0: &0x2::clock::Clock, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Pool<T0, T1, T2> {
        assert!(arg3 + arg4 + arg5 == 10000, 1);
        let v0 = TimeInfo{
            start_time          : 0x2::clock::timestamp_ms(arg0) + arg1,
            lock_stake_duration : arg2 - 86400000,
        ...
        Pool<T0, T1, T2>{
            ...
            claimable       : 0x2::table::new<u64, T2>(arg6),
    ...
    public entry fun new_pool<T0: copy + drop + store, T1: store + key, T2: store + key>(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 0);
        check_duplicated<T0, T1>(arg0);
        let v0 = create_pool<T0, T1, T2>(arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        if (0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, 0x1::type_name::get<T0>())) {
