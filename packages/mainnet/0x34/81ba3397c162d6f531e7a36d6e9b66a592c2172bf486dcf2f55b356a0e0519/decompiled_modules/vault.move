module 0x3481ba3397c162d6f531e7a36d6e9b66a592c2172bf486dcf2f55b356a0e0519::vault {
    ...
    entry fun change_limit<T0>(arg0: &mut Vault<T0>, arg1: &0x3481ba3397c162d6f531e7a36d6e9b66a592c2172bf486dcf2f55b356a0e0519::owner_cap::OwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x3481ba3397c162d6f531e7a36d6e9b66a592c2172bf486dcf2f55b356a0e0519::owner_cap::is_owned(&arg0.id, arg1);
        arg0.limit = arg2;
    ...
    entry fun create_vault<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x3481ba3397c162d6f531e7a36d6e9b66a592c2172bf486dcf2f55b356a0e0519::owner_cap::create_owner_cap(&v0.id, 0x2::tx_context::sender(arg2), arg2);
    ...
    entry fun liquidate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0x3481ba3397c162d6f531e7a36d6e9b66a592c2172bf486dcf2f55b356a0e0519::owner_cap::OwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x3481ba3397c162d6f531e7a36d6e9b66a592c2172bf486dcf2f55b356a0e0519::owner_cap::is_owned(&arg0.id, arg1);
