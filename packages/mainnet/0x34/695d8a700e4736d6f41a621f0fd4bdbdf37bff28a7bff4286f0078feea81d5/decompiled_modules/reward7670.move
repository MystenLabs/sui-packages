module 0x34695d8a700e4736d6f41a621f0fd4bdbdf37bff28a7bff4286f0078feea81d5::reward7670 {
    struct REWARD7670 has drop {
        dummy_field: bool,
    }

    struct TICKET_7670 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7670(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7670>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7670>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7670, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7670>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7670>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7670>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7670>>(v5, 0x2::tx_context::sender(arg1));
    }
