module 0x242f0fe98b2dcf15b4dd48cf7188899c127014c5f0d9b54d3f203f3c144ac4a::apr {
    ...
    public fun last_ratio(arg0: &0x2::object::UID) : u256 {
        ...
        if (0x2::dynamic_field::exists<RatioKey>(arg0, v0)) {
    ...
    public fun last_sync_ms(arg0: &0x2::object::UID) : u64 {
        ...
        if (0x2::dynamic_field::exists<SyncKey>(arg0, v0)) {
