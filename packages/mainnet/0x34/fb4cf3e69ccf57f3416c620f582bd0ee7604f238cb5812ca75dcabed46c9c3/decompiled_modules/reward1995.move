module 0x34fb4cf3e69ccf57f3416c620f582bd0ee7604f238cb5812ca75dcabed46c9c3::reward1995 {
    struct REWARD1995 has drop {
        dummy_field: bool,
    }

    struct TICKET_1995 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1995(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_1995>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1995, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1995>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1995>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1995>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1995>>(v5, 0x2::tx_context::sender(arg1));
    }
