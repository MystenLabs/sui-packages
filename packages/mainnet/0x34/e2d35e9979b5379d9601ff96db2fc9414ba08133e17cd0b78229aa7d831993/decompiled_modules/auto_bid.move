module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::auto_bid {
    ...
    entry fun new_bid<T0, T1>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v17 = 0;
        let v18 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::size(v15);
        let (v19, v20) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_auction_ts(v13);
        let v21 = 0x2::vec_map::get_mut<u64, 0x2::table_vec::TableVec<StrategyV2>>(0x2::vec_map::get_mut<u64, 0x2::vec_map::VecMap<u64, 0x2::table_vec::TableVec<StrategyV2>>>(&mut arg1.strategies, &arg2), &arg3);
        let v22 = 0;
        while (v22 < 0x2::table_vec::length<StrategyV2>(v21)) {
            let v23 = 0x2::table_vec::borrow_mut<StrategyV2>(v21, v22);
            if ((0x1::vector::contains<u64>(&v23.target_rounds, &v16) || 0x1::vector::length<u64>(&v23.target_rounds) == 0) && v23.bid_times < v23.max_times && v23.bid_round < v16 && 100 - (0x2::clock::timestamp_ms(arg4) - v19) * 100 / v20 <= v23.price_percentage && v23.active) {
                let v24 = v23.user;
                let v25 = v23.size;
                let v26 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T1>>(&mut v23.id, 0x1::string::utf8(b"balance"));
                0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::validate_bid(v13, v15, v25);
                let v27 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::total_bid_size(v15);
                let v28 = if (v27 + v25 > v18) {
                    v18 - v27
                } else {
                    v25
                };
                let (v29, v30) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_new_bid_incentive_balance_value<T1>(v1, v13, v15, v28, v17, arg4);
                if (0x2::balance::value<T1>(v26) >= v30) {
                    if (v28 > 0) {
                        let v31 = 0x1::vector::empty<0x2::coin::Coin<T1>>();
                        0x1::vector::push_back<0x2::coin::Coin<T1>>(&mut v31, 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(v26), arg5));
                        let (v32, v33, v34, v35, v36, v37, _, v39) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch::public_new_bid<T1>(v24, v15, v28, v31, 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::get_new_bid_incentive_balance<T1>(v1, v13, v29), v17, arg4, arg5);
                        0x2::balance::join<T1>(v26, 0x2::coin::into_balance<T1>(v39));
                        if (0x2::balance::value<T1>(v26) < v30) {
                            v23.active = false;
                        };
                        0x1::vector::push_back<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt>(&mut v23.receipts, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::public_new_bid(v14, v34, arg5));
                        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::emit_new_bid_event(v13, v32, v33, v34, v35, v36, v37, v24);
                        let (v40, v41) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking::mut_nft_table(v1);
                        if (0x2::object_table::contains<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v40, v23.user)) {
                            let v42 = 0x2::object_table::borrow_mut<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v40, v23.user);
                            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::first_bid(v41, v42);
                            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::nft_exp_up(v41, v42, 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::calculate_in_usd<T1>(v13, v35, false) * 200);
                        };
                        v23.bid_times = v23.bid_times + 1;
                        v23.bid_round = v16;
                        v23.bid_ts_ms = v37;
                        0x1::vector::push_back<u64>(&mut v23.bid_rounds, v16);
                        update_u64_padding<T0, T1>(v23);
                    } else {
                        break
                    };
                } else {
