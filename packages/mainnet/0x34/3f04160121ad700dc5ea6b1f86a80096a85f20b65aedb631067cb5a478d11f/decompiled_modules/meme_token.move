module 0x343f04160121ad700dc5ea6b1f86a80096a85f20b65aedb631067cb5a478d11f::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"$SHLONG", b"SHLONG", b"rvqv12v", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-16T15-07-08.244Z-6483bb973b8f65001ea4755f.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"SHLONG"),
            symbol     : 0x1::string::utf8(b"$SHLONG"),
            decimals   : 9,
