module 0x343542a2e5ddc53e2cca0d092318d124430dd56aeb42f7b02a9b44a94629c039::factor {
    struct AirdropPoolInfo has key {
        id: 0x2::object::UID,
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun add_claim_tokendrop<T0>(arg0: &mut AirdropPoolInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun add_pair_claim_tokendrop<T0: store + key>(arg0: &mut AirdropPoolInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    public entry fun create_airdrop_pool(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<AirdropPoolInfo>(v4);
    }

    public entry fun init_airdrop(arg0: &mut AirdropPoolInfo, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 0);
        arg0.initialized = arg1;
    }

    public entry fun init_airdrop_stake_token(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut AirdropPoolInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun init_pool_airdrop(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = AirdropPoolInfo{
        ...
        0x2::transfer::share_object<AirdropPoolInfo>(v0);
    }

    public entry fun init_pool_update(arg0: &mut AirdropPoolInfo, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
