module 0x3460620dbdaf175d617770d4a0d75f132f0ec494780317508b58319e595d890d::reward8930 {
    struct REWARD8930 has drop {
        dummy_field: bool,
    }

    struct TICKET_8930 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8930(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_8930>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8930, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8930>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8930>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8930>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8930>>(v5, 0x2::tx_context::sender(arg1));
    }
