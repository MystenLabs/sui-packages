module 0x34cf4b11913979d2f0b90fe5617bff84531d796b6ed82cc9983bbf136c3a8961::cnsnft1634 {
    struct CNSNFT1634 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1634, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1634>(arg0, arg1);
