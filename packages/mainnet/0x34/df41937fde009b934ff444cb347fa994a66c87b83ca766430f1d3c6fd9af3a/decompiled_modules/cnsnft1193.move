module 0x34df41937fde009b934ff444cb347fa994a66c87b83ca766430f1d3c6fd9af3a::cnsnft1193 {
    struct CNSNFT1193 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1193, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9727"));
        let v4 = 0x2::package::claim<CNSNFT1193>(arg0, arg1);
