module 0x34faed7a2b1c50b90ff18ca38e64ea281327e26aeb5e77c82a3bca2777aac5d5::inbox_bridge {
    ...
    fun create_inbox_message_hash(arg0: u64, arg1: u32, arg2: address, arg3: &vector<u8>) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x34faed7a2b1c50b90ff18ca38e64ea281327e26aeb5e77c82a3bca2777aac5d5::utils::u64_to_be_bytes(arg0));
        0x1::vector::append<u8>(&mut v0, 0x34faed7a2b1c50b90ff18ca38e64ea281327e26aeb5e77c82a3bca2777aac5d5::utils::u32_to_be_bytes(arg1));
        0x1::vector::append<u8>(&mut v0, 0x2::address::to_bytes(arg2));
        0x1::vector::append<u8>(&mut v0, *arg3);
        0x1::hash::sha2_256(v0)
    }

    public fun finality_threshold_confirmed() : u32 {
        1000
    }

    public fun finality_threshold_finalized() : u32 {
        2000
    }
    ...
    public fun submit_inbox_message<T0: drop>(arg0: &mut InboxBridge, arg1: T0, arg2: vector<u8>, arg3: &0x2::clock::Clock) : (u8, u64, vector<u8>) {
        submit_inbox_message_inner<T0>(arg0, arg1, arg2, 2000, arg3)
    }
    ...
    entry fun submit_inbox_message_as_eoa(arg0: &mut InboxBridge, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        submit_inbox_message_as_eoa_inner(arg0, arg1, 2000, arg2, arg3);
    }

    fun submit_inbox_message_as_eoa_inner(arg0: &mut InboxBridge, arg1: vector<u8>, arg2: u32, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_bridge_version(arg0);
        ...
        let v2 = InboxMessageEvent{
            version                : 1,
            msg_id                 : v0,
            min_finality_threshold : arg2,
            sender                 : v1,
            msg_hash               : create_inbox_message_hash(v0, arg2, v1, &arg1),
    ...
    fun submit_inbox_message_inner<T0: drop>(arg0: &mut InboxBridge, arg1: T0, arg2: vector<u8>, arg3: u32, arg4: &0x2::clock::Clock) : (u8, u64, vector<u8>) {
        assert_bridge_version(arg0);
        ...
        let v4 = create_inbox_message_hash(v2, arg3, v3, &arg2);
        let v5 = InboxMessageEvent{
            version                : 1,
            msg_id                 : v2,
            min_finality_threshold : arg3,
            sender                 : v3,
            msg_hash               : v4,
    ...
    public fun submit_inbox_message_with_finality<T0: drop>(arg0: &mut InboxBridge, arg1: T0, arg2: vector<u8>, arg3: u32, arg4: &0x2::clock::Clock) : (u8, u64, vector<u8>) {
        submit_inbox_message_inner<T0>(arg0, arg1, arg2, arg3, arg4)
    }

    entry fun submit_inbox_message_with_finality_as_eoa(arg0: &mut InboxBridge, arg1: vector<u8>, arg2: u32, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        submit_inbox_message_as_eoa_inner(arg0, arg1, arg2, arg3, arg4);
    }
