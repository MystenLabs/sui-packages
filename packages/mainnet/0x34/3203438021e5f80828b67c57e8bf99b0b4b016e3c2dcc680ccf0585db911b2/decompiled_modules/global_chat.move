module 0x7668dfda754919d31b3b1bb240034bbe9c20b4b75587d0e6c334ad04f1f40a5c::global_chat {
    ...
    struct GlobalChatMemberRemoved has copy, drop {
        global_chat_id: 0x2::object::ID,
        admin: address,
        member: address,
        member_count: u64,
    ...
    entry fun kick_member(arg0: &mut GlobalChatGroup, arg1: &GlobalChatAdminCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg4);
        assert!(arg2 != arg0.admin, 12);
        assert!(0x2::table::contains<address, Member>(&arg0.members, arg2), 11);
        0x2::table::remove<address, Member>(&mut arg0.members, arg2);
        arg0.member_count = arg0.member_count - 1;
        let v0 = GlobalChatMemberRemoved{
            global_chat_id : 0x2::object::id<GlobalChatGroup>(arg0),
            admin          : 0x2::tx_context::sender(arg4),
            member         : arg2,
            member_count   : arg0.member_count,
            removed_at_ms  : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<GlobalChatMemberRemoved>(v0);
    }
    ...
    entry fun seal_approve_global_chat(arg0: vector<u8>, arg1: &GlobalChatGroup, arg2: &0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u8>(&arg0) == 40, 13);
        let v0 = 0x2::bcs::new(arg0);
        let v1 = 0x2::object::id<GlobalChatGroup>(arg1);
        assert!(0x2::bcs::peel_address(&mut v0) == 0x2::object::id_to_address(&v1) && 0x2::bcs::peel_u64(&mut v0) == 0, 13);
        assert!(0x2::table::contains<address, Member>(&arg1.members, 0x2::tx_context::sender(arg2)), 11);
    }

    public fun seal_identity(arg0: &GlobalChatGroup) : vector<u8> {
        let v0 = 0x2::object::id<GlobalChatGroup>(arg0);
        let v1 = 0x2::object::id_to_address(&v0);
        let v2 = 0x2::bcs::to_bytes<address>(&v1);
        let v3 = 0;
        0x1::vector::append<u8>(&mut v2, 0x2::bcs::to_bytes<u64>(&v3));
        v2
    }

    public fun seal_key_version() : u64 {
        0
    }
