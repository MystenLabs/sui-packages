module 0x345795f032a2dae933005d444700527a7272bcd4d301ce19a58cf6deee5967e4::Moonday {
    struct MOONDAY has drop {
        dummy_field: bool,
    }

    fun init(arg0: MOONDAY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = if (b"https://storage.googleapis.com/moonday/tokens/c9af753a-09bd-4fe2-8dc0-4097753bf261/thunder.webp" == b"") {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://storage.googleapis.com/moonday/tokens/c9af753a-09bd-4fe2-8dc0-4097753bf261/thunder.webp"))
        };
        let v1 = b"aTHUNDER";
