module 0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::bluefin {
    public fun confirm_swap<T0, T1>(arg0: &mut 0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::Config, arg1: 0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::SwapRequest, arg2: &0xe8f996ea6ff38c557c253d3b93cfe2ebf393816487266786371aa4532a9229f2::config::Config, arg3: &mut 0xe8f996ea6ff38c557c253d3b93cfe2ebf393816487266786371aa4532a9229f2::vault::Vault, arg4: 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let (v7, v8) = 0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::deduct_fee<T1>(arg0, v6, arg5);
        let v9 = v7;
    ...
    public fun start_swap<T0, T1>(arg0: &0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::Config, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::SwapRequest, 0x2::coin::Coin<T0>) {
        0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::checked_package_version(arg0);
        0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::checked_pause(arg0);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 > 0, 1);
        let v1 = 0x342acc0fb6b2930a493fc2e82b471f5a40587c0686e63f90ebee702306e75ac6::config::new_swap_request(0x1::type_name::get<T0>(), 0x1::type_name::get<T1>(), v0, arg2, b"BLUEFIN", arg3);
