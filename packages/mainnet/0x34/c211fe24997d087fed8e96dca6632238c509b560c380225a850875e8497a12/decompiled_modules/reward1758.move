module 0x34c211fe24997d087fed8e96dca6632238c509b560c380225a850875e8497a12::reward1758 {
    struct REWARD1758 has drop {
        dummy_field: bool,
    }

    struct TICKET_1758 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1758(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1758>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1758>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1758>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1758>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1758>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1758>>(v5, 0x2::tx_context::sender(arg1));
    }
