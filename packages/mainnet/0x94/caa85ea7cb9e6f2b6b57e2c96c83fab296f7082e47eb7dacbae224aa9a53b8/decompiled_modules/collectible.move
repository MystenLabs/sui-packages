module 0x94caa85ea7cb9e6f2b6b57e2c96c83fab296f7082e47eb7dacbae224aa9a53b8::collectible {
    ...
    fun init(arg0: COLLECTIBLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"FlowX Testnet Pass III"));
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://bafybeicq4gg6ofoe5zk2vbob7ca7puhvk2nkovzl2rxr2tkotcixjjch4i"));
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Certification for early participants in the Testnet phase of FlowX Finance. This pass has 3 parts and cannot be transferred."));
        ...
        let v3 = State{
            ...
            started_at_ms : 1697079600000,
            ended_at_ms   : 1699758000000,
    ...
    public entry fun mint(arg0: &mut State, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.total_supply < 1000, 0);
