module 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::curve {
    ...
    public(friend) fun buy_for<T0>(arg0: &mut Curve<T0>, arg1: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::Config, arg2: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::FeeVault, arg3: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::referral::ReferralRegistry, arg4: address, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: 0x1::option::Option<address>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        assert!(v0 > 0, 2);
        let v1 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::referral::resolve_and_bind(arg3, arg4, arg7, arg8);
        let v2 = sui_total<T0>(arg0);
        let v3 = token_total<T0>(arg0);
        let v4 = arg0.curve_supply - arg0.tokens_sold;
        let v5 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::math::mul_bps(v0, arg0.fee_bps);
        let v6 = v5;
        let v7 = v0 - v5;
        let v8 = v7;
        let v9 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::math::tokens_out(v2, v3, v7);
        let v10 = v9;
        if (v9 > v4) {
            v10 = v4;
            let v11 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::math::sui_in_for_tokens(v2, v3, v4);
            v8 = v11;
            v6 = gross_from_net(v11, arg0.fee_bps, v0) - v11;
        };
        assert!(v10 >= arg6, 1);
        assert!(v10 > 0, 2);
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::accrue_with_config(arg2, arg1, 0x2::object::uid_to_inner(&arg0.id), 0x2::balance::split<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut arg5), v6), v1);
        ...
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::events::trade(0x2::object::uid_to_inner(&arg0.id), arg0.coin_type, arg4, true, v8, v10, v6, sui_total<T0>(arg0), token_total<T0>(arg0), arg0.curve_supply - arg0.tokens_sold, price_scaled<T0>(arg0), progress_bps<T0>(arg0), v1, 0x2::clock::timestamp_ms(arg8));
    ...
    public fun collect_migration_fee<T0>(arg0: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::AdminCap, arg1: &mut Curve<T0>, arg2: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::FeeVault, arg3: &0x2::clock::Clock) : u64 {
        sweep_migration_fee<T0>(arg1, arg2, arg3)
    }

    public fun collect_migration_fee_by_fee_claimer<T0>(arg0: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::FeeClaimerCap, arg1: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::Config, arg2: &mut Curve<T0>, arg3: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::FeeVault, arg4: &0x2::clock::Clock) : u64 {
    ...
    public(friend) fun sell_for<T0>(arg0: &mut Curve<T0>, arg1: &0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::config::Config, arg2: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::FeeVault, arg3: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::referral::ReferralRegistry, arg4: address, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: 0x1::option::Option<address>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::referral::resolve_and_bind(arg3, arg4, arg7, arg8);
        let v2 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::math::sui_out(sui_total<T0>(arg0), token_total<T0>(arg0), v0);
        assert!(v2 <= 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reserve), 3);
        let v3 = 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::math::mul_bps(v2, arg0.fee_bps);
        let v4 = v2 - v3;
        assert!(v4 >= arg6, 1);
        ...
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::accrue_with_config(arg2, arg1, 0x2::object::uid_to_inner(&arg0.id), 0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_reserve, v3), v1);
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::events::trade(0x2::object::uid_to_inner(&arg0.id), arg0.coin_type, arg4, false, v4, v0, v3, sui_total<T0>(arg0), token_total<T0>(arg0), arg0.curve_supply - arg0.tokens_sold, price_scaled<T0>(arg0), progress_bps<T0>(arg0), v1, 0x2::clock::timestamp_ms(arg8));
    ...
    fun sweep_migration_fee<T0>(arg0: &mut Curve<T0>, arg1: &mut 0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::FeeVault, arg2: &0x2::clock::Clock) : u64 {
        let v0 = take_migration_fee<T0>(arg0);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&v0);
        0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::fees::credit_protocol(arg1, v0);
        if (v1 > 0) {
            0x2b79fe248bbd7d32de2a967bddad9ddfc6857016e4b768038c04e65b3e7eae0::events::migration_fee_collected(0x2::object::uid_to_inner(&arg0.id), arg0.coin_type, v1, 0x2::clock::timestamp_ms(arg2));
        };
        v1
    }
