module 0x94f606983443bf8d6a74c8d7e7420f503f1c0d34d646c19f51c66da149f205e8::cnsnft5438 {
    struct CNSNFT5438 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5438, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTRU2LVfvwnEAZceKHWq2ZqZaJWjcNtV2Bqi2hkhVDpvB?ref=7379"));
        let v4 = 0x2::package::claim<CNSNFT5438>(arg0, arg1);
