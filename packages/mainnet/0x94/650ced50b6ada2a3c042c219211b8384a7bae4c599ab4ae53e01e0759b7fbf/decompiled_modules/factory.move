module 0x94650ced50b6ada2a3c042c219211b8384a7bae4c599ab4ae53e01e0759b7fbf::factory {
    ...
    public fun sellCoins<T0>(arg0: &mut CoinReserve<T0>, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: &0xd2a5dabef718a5908aa92dd10bf1fb2fe0a5305f18c7dc53c1753501ea96f6e2::collector::Collector, arg4: u64, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = v0 / 100;
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance) >= v0, 15);
        assert!(v0 >= arg4, 9);
        0x2::coin::put<T0>(&mut arg0.coin_balance, 0x2::coin::split<T0>(arg1, arg2, arg6));
        0xd2a5dabef718a5908aa92dd10bf1fb2fe0a5305f18c7dc53c1753501ea96f6e2::collector::sendFee(arg3, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.sui_balance, v1, arg6), arg6);
        let v2 = 0x2::tx_context::sender(arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.sui_balance, v0 - v1, arg6), v2);
        let v3 = getBuyPriceForTokens<T0>(arg0, 1, arg6);
        let v4 = TradeOperation<T0>{
            operation          : 0x1::string::utf8(b"BUY"),
            wallet             : v2,
            quantity           : arg2,
            total_amount       : v0 - v1,
        ...
        0x2::event::emit<TradeOperation<T0>>(v4);
    }
