module 0xb6b6920e6d9714490c097ee2afc202d33ac9a91dd480f30e2097f141b227f747::hive_chronicles {
    ...
    public fun get_more_new_hive_chronicle_for_profile(arg0: &0x2::clock::Clock, arg1: &0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveManager, arg2: &mut HiveChroniclesVault, arg3: &0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg4: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, bool, u64, u64) {
        ...
        if (v0.active_epoch < v1 && 0x2::linked_table::contains<u64, BeesFarmingSnapshot>(&arg2.bees_farming_snampshots, v0.active_epoch)) {
            ...
            if (v7 > 0) {
                v3 = (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u256(((v0.engagement_metrics.likes_made + v0.engagement_metrics.likes_earned) as u256), v7, (1000000000 as u256)) as u64);
            };
            if (v8 > 0) {
                v4 = (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u256(((v0.engagement_metrics.dialogues_made + v0.engagement_metrics.dialogues_earned) as u256), v8, (1000000000 as u256)) as u64);
            };
        };
