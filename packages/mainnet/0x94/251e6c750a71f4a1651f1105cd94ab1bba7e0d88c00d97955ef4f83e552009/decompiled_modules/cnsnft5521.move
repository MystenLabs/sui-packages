module 0x94251e6c750a71f4a1651f1105cd94ab1bba7e0d88c00d97955ef4f83e552009::cnsnft5521 {
    struct CNSNFT5521 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5521, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5521>(arg0, arg1);
