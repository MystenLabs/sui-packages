module 0x94763762e082db00bf9368905611d7d99cb9184e2896c7742eb4afee4fd95df0::marketplace {
    ...
    public entry fun buy<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: &mut 0x94763762e082db00bf9368905611d7d99cb9184e2896c7742eb4afee4fd95df0::royalty_fee::RoyaltyBag, arg2: 0x2::object::ID, arg3: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x94763762e082db00bf9368905611d7d99cb9184e2896c7742eb4afee4fd95df0::royalty_fee::charge_royalty<T0>(arg1, v3, &mut v1, arg4);
        assert!(v8 + v9 < v3, 5);
        let v10 = v3 - v8 - v9;
    ...
    public entry fun change_price<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x94763762e082db00bf9368905611d7d99cb9184e2896c7742eb4afee4fd95df0::royalty_fee::init_royalty_bag(arg0);
    }
