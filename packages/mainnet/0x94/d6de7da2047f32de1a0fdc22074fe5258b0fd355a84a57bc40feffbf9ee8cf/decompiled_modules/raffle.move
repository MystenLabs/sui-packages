module 0x94d6de7da2047f32de1a0fdc22074fe5258b0fd355a84a57bc40feffbf9ee8cf::raffle {
    ...
    public entry fun buy_ticket(arg0: &mut Raffle, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (0x2::vec_map::contains<address, u64>(&arg0.participants, &v1)) {
            *0x2::vec_map::get<address, u64>(&arg0.participants, &v1)
        } else {
            0x2::vec_map::insert<address, u64>(&mut arg0.participants, v1, 0);
            0
        };
        ...
        while (v5 < arg2) {
            ...
            0x1::vector::push_back<0x2::object::ID>(&mut v3, 0x2::object::id<Ticket>(&v7));
            0x1::vector::push_back<u64>(&mut v4, v6);
            0x2::transfer::transfer<Ticket>(v7, v1);
            v5 = v5 + 1;
        };
    ...
    public entry fun create_raffle(arg0: &mut RaffleManager, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = Raffle{
