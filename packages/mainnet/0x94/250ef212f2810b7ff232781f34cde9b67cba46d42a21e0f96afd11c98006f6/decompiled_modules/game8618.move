module 0x94250ef212f2810b7ff232781f34cde9b67cba46d42a21e0f96afd11c98006f6::game8618 {
    struct GAME8618 has drop {
        dummy_field: bool,
    }

    struct TICKET_8618 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8618(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8618>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8618>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME8618, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8618>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8618>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8618>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8618>>(v5, 0x2::tx_context::sender(arg1));
    }
