module 0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::xcsmh {
    struct XCSMH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: XCSMH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<XCSMH>(arg0, 0, b"XCSMH", b"Xociety company stock - Medi Health Future", b"Stock for the Xociety in-game company named Medi Health Future", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://app.xociety.io/assets/xcs/xcsmh.png"))), arg1);
        let v2 = v0;
        let (v3, v4) = 0x2::token::new_policy<XCSMH>(&v2, arg1);
        let v5 = v4;
        let v6 = v3;
        let v7 = 0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::new<XCSMH>(v2, 0x2::tx_context::sender(arg1), arg1);
        0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::add_capability<XCSMH, 0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::MintCap>(&mut v7, @0x3142efe76da5935d46bcbde9351398e6b70fa8423a86c98e39ad71c24bdb95c7, 0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::new_mint_cap(5000000, arg1), arg1);
        0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::add_capability<XCSMH, 0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::WhitelistCap>(&mut v7, @0x3142efe76da5935d46bcbde9351398e6b70fa8423a86c98e39ad71c24bdb95c7, 0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::new_whitelist_cap(), arg1);
        let v8 = &mut v6;
        set_rules<XCSMH>(v8, &v5, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<XCSMH>>(v1);
        0x2::transfer::public_transfer<0x2::token::TokenPolicyCap<XCSMH>>(v5, 0x2::tx_context::sender(arg1));
        0x2::token::share_policy<XCSMH>(v6);
        0x948b0ee11f52e78b42a08380bed1162e9185095e147d0f93ab7e0ffe9666a408::treasury::share<XCSMH>(v7);
    }
