module 0x94ed38b366d175090349dc0820c470e9459917abffaf1d84d4f15b2fa1c60c98::nexa_reward_points {
    ...
    public fun initialize_treasury<T0>(arg0: &0x94ed38b366d175090349dc0820c470e9459917abffaf1d84d4f15b2fa1c60c98::app::AdminCap, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun mint_and_claim_reward_points<T0>(arg0: &mut NexaRewardCoinTreasury<T0>, arg1: u64, arg2: &0x94ed38b366d175090349dc0820c470e9459917abffaf1d84d4f15b2fa1c60c98::nexa_referrals::ReferralsMap, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x94ed38b366d175090349dc0820c470e9459917abffaf1d84d4f15b2fa1c60c98::nexa_referrals::get_referrer(arg2, v1);
        if (v3 != @0x0) {
            let v4 = arg1 * 30 / 100;
            ...
            let v6 = 0x94ed38b366d175090349dc0820c470e9459917abffaf1d84d4f15b2fa1c60c98::nexa_referrals::get_referrer(arg2, v3);
            if (v6 != @0x0) {
                let v7 = v4 * 10 / 100;
