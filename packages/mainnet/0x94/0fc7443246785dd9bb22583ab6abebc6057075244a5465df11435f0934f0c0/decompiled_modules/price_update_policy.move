module 0x940fc7443246785dd9bb22583ab6abebc6057075244a5465df11435f0934f0c0::price_update_policy {
    struct PriceUpdateRequest<phantom T0> {
        for_policy: 0x2::object::ID,
        receipts: 0x2::vec_set::VecSet<0x1::type_name::TypeName>,
        price_feeds: vector<0x940fc7443246785dd9bb22583ab6abebc6057075244a5465df11435f0934f0c0::price_feed::PriceFeed>,
    }
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : (PriceUpdatePolicy, PriceUpdatePolicyCap) {
        ...
        let v1 = PriceUpdatePolicyCap{
            id         : 0x2::object::new(arg0),
            for_policy : 0x2::object::id<PriceUpdatePolicy>(&v0),
        };
        (v0, v1)
    }

    public fun add_price_feed<T0, T1: drop>(arg0: T1, arg1: &mut PriceUpdateRequest<T0>, arg2: 0x940fc7443246785dd9bb22583ab6abebc6057075244a5465df11435f0934f0c0::price_feed::PriceFeed) {
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.receipts, 0x1::type_name::with_defining_ids<T1>());
        0x1::vector::push_back<0x940fc7443246785dd9bb22583ab6abebc6057075244a5465df11435f0934f0c0::price_feed::PriceFeed>(&mut arg1.price_feeds, arg2);
    }

    public fun add_rule<T0>(arg0: &mut PriceUpdatePolicy, arg1: &PriceUpdatePolicyCap) {
        add_rule_by_id<T0>(arg0, for_policy(arg1));
    }

    public fun add_rule_by_id<T0>(arg0: &mut PriceUpdatePolicy, arg1: 0x2::object::ID) {
        assert!(0x2::object::id<PriceUpdatePolicy>(arg0) == arg1, 723);
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg0.rules, 0x1::type_name::with_defining_ids<T0>());
    }

    public(friend) fun add_rule_v2<T0, T1>(arg0: &mut PriceUpdatePolicy, arg1: &PriceUpdatePolicyCap) {
        add_rule_v2_by_id<T0, T1>(arg0, for_policy(arg1));
    }

    public(friend) fun add_rule_v2_by_id<T0, T1>(arg0: &mut PriceUpdatePolicy, arg1: 0x2::object::ID) {
        assert!(0x2::object::id<PriceUpdatePolicy>(arg0) == arg1, 723);
        ...
        0x2::vec_set::insert<0x1::type_name::TypeName>(0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(v1, v2), 0x1::type_name::with_defining_ids<T1>());
    }

    public fun confirm_request<T0>(arg0: PriceUpdateRequest<T0>, arg1: &PriceUpdatePolicy) : vector<0x940fc7443246785dd9bb22583ab6abebc6057075244a5465df11435f0934f0c0::price_feed::PriceFeed> {
        ...
        assert!(v4 == 0x2::vec_set::length<0x1::type_name::TypeName>(&v5), 721);
        let v6 = 0;
        while (v6 < v4) {
    ...
    public fun for_policy(arg0: &PriceUpdatePolicyCap) : 0x2::object::ID {
        arg0.for_policy
    }
    ...
    public(friend) fun init_rules_df_if_not_exist(arg0: &PriceUpdatePolicyCap, arg1: &mut PriceUpdatePolicy, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<PriceUpdatePolicy>(arg1);
        init_rules_df_if_not_exist_by_id(v0, arg1, arg2);
    }

    public(friend) fun init_rules_df_if_not_exist_by_id(arg0: 0x2::object::ID, arg1: &mut PriceUpdatePolicy, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = PriceUpdatePolicyRulesKey{dummy_field: false};
    ...
    public fun new_request<T0>(arg0: &PriceUpdatePolicy) : PriceUpdateRequest<T0> {
        PriceUpdateRequest<T0>{
            for_policy  : 0x2::object::id<PriceUpdatePolicy>(arg0),
            receipts    : 0x2::vec_set::empty<0x1::type_name::TypeName>(),
            price_feeds : 0x1::vector::empty<0x940fc7443246785dd9bb22583ab6abebc6057075244a5465df11435f0934f0c0::price_feed::PriceFeed>(),
        }
    }

    public fun remove_rule<T0>(arg0: &mut PriceUpdatePolicy, arg1: &PriceUpdatePolicyCap) {
        remove_rule_by_id<T0>(arg0, for_policy(arg1));
    }

    public fun remove_rule_by_id<T0>(arg0: &mut PriceUpdatePolicy, arg1: 0x2::object::ID) {
        assert!(0x2::object::id<PriceUpdatePolicy>(arg0) == arg1, 723);
    ...
    public(friend) fun remove_rule_v2<T0, T1>(arg0: &mut PriceUpdatePolicy, arg1: &PriceUpdatePolicyCap) {
        remove_rule_v2_by_id<T0, T1>(arg0, for_policy(arg1));
    }

    public(friend) fun remove_rule_v2_by_id<T0, T1>(arg0: &mut PriceUpdatePolicy, arg1: 0x2::object::ID) {
        assert!(0x2::object::id<PriceUpdatePolicy>(arg0) == arg1, 723);
        let v0 = PriceUpdatePolicyRulesKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<PriceUpdatePolicyRulesKey, 0x2::table::Table<0x1::type_name::TypeName, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>>(&mut arg0.id, v0);
        let v2 = 0x1::type_name::with_defining_ids<T0>();
