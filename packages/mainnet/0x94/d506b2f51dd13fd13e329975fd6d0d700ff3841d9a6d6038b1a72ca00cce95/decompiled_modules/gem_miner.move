module 0x94d506b2f51dd13fd13e329975fd6d0d700ff3841d9a6d6038b1a72ca00cce95::gem_miner {
    ...
    public entry fun buy_gems(arg0: &mut GameState, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        v10.hatchery_miners = v10.hatchery_miners + v9 / 1080000;
        v10.claimed_eggs = 0;
        ...
        if (0x2::dynamic_field::exists_<address>(&arg0.id, v2)) {
            ...
            let v12 = v9 * 15 / 100;
            if (v12 > 0 && v12 < v9) {
                v11.claimed_eggs = v11.claimed_eggs + v12;
            };
        };
    ...
    fun get_eggs_since_last_hatch(arg0: &MinerInfo, arg1: &0x2::clock::Clock) : u64 {
        min(1080000, (0x2::clock::timestamp_ms(arg1) - arg0.last_hatch) / 1000) * arg0.hatchery_miners * calculate_reduction_multiplier(arg0.current_withdrawn, arg0.current_deposit) / 100
    }
    ...
    public entry fun hire_miners(arg0: &mut GameState, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (v1 == 0) {
            ...
            v1 / 1080000 * calculate_reduction_multiplier(v2.current_withdrawn, v2.current_deposit) / 100
        };
