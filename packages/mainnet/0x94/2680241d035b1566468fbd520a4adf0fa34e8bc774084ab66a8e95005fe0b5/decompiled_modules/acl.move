module 0x942680241d035b1566468fbd520a4adf0fa34e8bc774084ab66a8e95005fe0b5::acl {
    struct Igzodhvymzlnpbd has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Zdlanpxgyfjzzqg>,
    }

    struct Zdlanpxgyfjzzqg has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun baqsdvwaqmitocu<T0: store + key>(arg0: &mut Igzodhvymzlnpbd, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Zdlanpxgyfjzzqg>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Zdlanpxgyfjzzqg>(&mut arg0.pools, arg1);
    ...
    public entry fun dnkpejxbkoyaxai(arg0: &mut Igzodhvymzlnpbd, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, Zdlanpxgyfjzzqg>(&mut arg0.pools, arg1, v4);
    }

    public entry fun hvnriehaypgpbrv(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Igzodhvymzlnpbd, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Zdlanpxgyfjzzqg>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Zdlanpxgyfjzzqg>(&mut arg2.pools, arg3);
        if (v0.initialized) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Igzodhvymzlnpbd{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Zdlanpxgyfjzzqg>(arg0),
        };
        0x2::transfer::share_object<Igzodhvymzlnpbd>(v0);
    }

    public entry fun kbujvrhyiovcbnk<T0>(arg0: &mut Igzodhvymzlnpbd, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Zdlanpxgyfjzzqg>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Zdlanpxgyfjzzqg>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
    ...
    public entry fun wnqypwmsjnpchxa(arg0: &mut Igzodhvymzlnpbd, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Zdlanpxgyfjzzqg{
        ...
        0x2::table::add<0x1::ascii::String, Zdlanpxgyfjzzqg>(&mut arg0.pools, arg1, v0);
    }

    public entry fun zhhylteummtagkg(arg0: &mut Igzodhvymzlnpbd, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Zdlanpxgyfjzzqg>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Zdlanpxgyfjzzqg>(&mut arg0.pools, arg1);
    ...
    public entry fun zrglezgtbvraxyi(arg0: &mut Igzodhvymzlnpbd, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Zdlanpxgyfjzzqg>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Zdlanpxgyfjzzqg>(&mut arg0.pools, arg1);
