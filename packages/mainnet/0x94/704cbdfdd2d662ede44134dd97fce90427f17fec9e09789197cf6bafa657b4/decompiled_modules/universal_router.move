module 0x94704cbdfdd2d662ede44134dd97fce90427f17fec9e09789197cf6bafa657b4::universal_router {
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0x94704cbdfdd2d662ede44134dd97fce90427f17fec9e09789197cf6bafa657b4::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
