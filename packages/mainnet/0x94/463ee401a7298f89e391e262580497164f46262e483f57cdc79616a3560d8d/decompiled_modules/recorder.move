module 0x94463ee401a7298f89e391e262580497164f46262e483f57cdc79616a3560d8d::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        ...
        assert!(points_of(arg0, arg1) >= arg2, 0x94463ee401a7298f89e391e262580497164f46262e483f57cdc79616a3560d8d::errors::insufficient_points());
    ...
    public fun record(arg0: &mut Recorder, arg1: &RecordCap, arg2: address, arg3: u64) {
        assert!(arg0.version == 1, 0x94463ee401a7298f89e391e262580497164f46262e483f57cdc79616a3560d8d::errors::wrong_version());
        assert!(0x2::object::id<RecordCap>(arg1) == arg0.record_cap, 0x94463ee401a7298f89e391e262580497164f46262e483f57cdc79616a3560d8d::errors::invalid_record_cap());
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0x94463ee401a7298f89e391e262580497164f46262e483f57cdc79616a3560d8d::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 >= earned_of(arg0, arg1), 0x94463ee401a7298f89e391e262580497164f46262e483f57cdc79616a3560d8d::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
