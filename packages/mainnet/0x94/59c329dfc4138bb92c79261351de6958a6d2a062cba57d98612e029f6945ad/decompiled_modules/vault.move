module 0x45355b07146d699e6a8c405bcc2f60ef5d062a15183c6012ac55d5734d8add21::vault {
    ...
    entry fun move_token<T0, T1, T2>(arg0: &AdminCap, arg1: &VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::type_name::into_string(0x1::type_name::with_defining_ids<T2>()) == 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())) {
            ...
            assert!(0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0), 45);
            if (0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0)) {
    ...
    entry fun move_token_token<T0, T1, T2>(arg0: &AdminCap, arg1: &VaultConfig, arg2: &mut Vault<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 9, 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T2>());
        assert!(0x2::bag::contains<0x1::ascii::String>(&arg2.withdraw_assets, v0), 14);
        let v1 = 0x2::bag::remove<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0);
        let v2 = 0x2::coin::value<T2>(&v1);
        assert!(v2 > 0, 2);
        let v3 = 0x2::coin::split<T2>(&mut v1, v2, arg3);
        if (0x2::coin::value<T2>(&v1) > 0) {
            0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0, v1);
        } else {
        ...
        if (0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0)) {
            let v6 = 0x2::bag::remove<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0);
            0x2::coin::join<T2>(&mut v6, v3);
            0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0, v6);
        } else {
            0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0, v3);
            0x1::vector::push_back<0x1::ascii::String>(&mut arg2.harvest_asset_keys, v0);
        };
        let v7 = AddFundEvent{
            amount   : v2,
