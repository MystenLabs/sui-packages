module 0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::usdb {
    ...
    public fun burn<T0: drop>(arg0: &mut Treasury, arg1: T0, arg2: u16, arg3: 0x2::coin::Coin<USDB>) {
        ...
        if (v0 > 0) {
            ...
            let v2 = 0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::decrease(v1, v0);
    ...
    public fun mint<T0: drop>(arg0: &mut Treasury, arg1: T0, arg2: u16, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<USDB> {
        ...
        if (arg3 > 0) {
            let v1 = borrow_supply_mut<T0>(arg0);
            let v2 = 0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::increase(v1, arg3);
            let v3 = borrow_cap_mut(arg0);
            let v4 = Mint<T0>{
                amount        : arg3,
                module_supply : v2,
    ...
    public fun limited_supply(arg0: &ModuleConfig) : &0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::LimitedSupply {
        &arg0.limited_supply
    }

    public fun add_version<T0: drop>(arg0: &mut Treasury, arg1: &0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::admin::AdminCap, arg2: u16) {
        ...
        if (0x2::vec_map::contains<0x1::type_name::TypeName, ModuleConfig>(module_config_map(arg0), &v0)) {
            ...
            let v1 = ModuleConfig{
                ...
                limited_supply : 0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::new(0),
            };
    ...
    fun borrow_supply_mut<T0>(arg0: &mut Treasury) : &mut 0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::LimitedSupply {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun claim<T0, T1: drop>(arg0: &mut Treasury, arg1: &0x89495ef31f30a6edbd08f8a28f4e5419401d2c133c34a617a7983928d5697797::account::AccountRequest, arg2: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::coin::Coin<T0>> {
        if (beneficiary_address(arg0) != 0x89495ef31f30a6edbd08f8a28f4e5419401d2c133c34a617a7983928d5697797::account::request_address(arg1)) {
            err_not_beneficiary();
        };
        let v0 = &mut arg0.id;
        ...
        if (0x2::coin::value<T0>(&v6) > 0) {
            0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::treasury::emit_claim_fee<T0, T1>(0x2::coin::value<T0>(&v6));
        };
    ...
    public fun collect<T0, T1: drop>(arg0: &mut Treasury, arg1: T1, arg2: 0x1::string::String, arg3: 0x2::balance::Balance<T0>) {
        ...
        if (v0 > 0) {
            ...
            0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::treasury::emit_collect_fee<T0, T1>(arg2, v0);
    ...
    fun init(arg0: USDB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDB>(arg0, decimal(), b"USDB", b"Bucket USD", b"USDB is a decentralized, overcollateralized stablecoin of bucketprotocol.io, pegged to 1 USD and backed by crypto assets via CDP and PSM mechanisms.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://aqua-natural-grasshopper-705.mypinata.cloud/ipfs/bafkreihybg6uwyyzx2oqsjoepjgzleo4igmajkut2zrpqazkzahjwm742e")), arg1);
    ...
    public fun remove_module<T0: drop>(arg0: &mut Treasury, arg1: &0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::admin::AdminCap) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, ModuleConfig>(module_config_map(arg0), &v0)) {
            ...
            0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::destroy(v4);
        };
    }

    public fun remove_version<T0: drop>(arg0: &mut Treasury, arg1: &0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::admin::AdminCap, arg2: u16) {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = module_config_map(arg0);
    ...
    public fun set_beneficiary_address(arg0: &mut Treasury, arg1: &0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::admin::AdminCap, arg2: address) {
        arg0.beneficiary_address = arg2;
    }

    public fun set_supply_limit<T0: drop>(arg0: &mut Treasury, arg1: &0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::admin::AdminCap, arg2: u64) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, ModuleConfig>(module_config_map(arg0), &v0)) {
            0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::set_limit(&mut 0x2::vec_map::get_mut<0x1::type_name::TypeName, ModuleConfig>(&mut arg0.module_config_map, &v0).limited_supply, arg2);
        } else {
            let v1 = ModuleConfig{
                valid_versions : 0x2::vec_set::empty<u16>(),
                limited_supply : 0x94c1beb34be4677052e1989cc16c4cddf8b97c706532d2136c33df6c2f5656fa::limited_supply::new(arg2),
            };
            0x2::vec_map::insert<0x1::type_name::TypeName, ModuleConfig>(&mut arg0.module_config_map, v0, v1);
        };
    }
