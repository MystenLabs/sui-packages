module 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager {
    ...
    public fun check_duplicate_match_option(arg0: vector<BetOption>, arg1: BetOption) : bool {
        let v0 = 0;
        while (v0 < 0x1::vector::length<BetOption>(&arg0)) {
            if (0x1::vector::borrow<BetOption>(&arg0, v0).target == arg1.target && *0x1::vector::borrow<u64>(&0x1::vector::borrow<BetOption>(&arg0, v0).range, 0) == *0x1::vector::borrow<u64>(&arg1.range, 0)) {
                return true
            };
            v0 = v0 + 1;
        };
    ...
    public fun create_unihouse_bet_option(arg0: BetOption) : 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::MarbleRacingBetOption {
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::create_marble_racing_bet_option(arg0.target, arg0.range)
    }
