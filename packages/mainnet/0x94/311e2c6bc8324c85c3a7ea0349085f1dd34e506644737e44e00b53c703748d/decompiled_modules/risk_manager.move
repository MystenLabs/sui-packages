module 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::risk_manager {
    ...
    public(friend) fun add_total_risk(arg0: &mut RiskManager, arg1: 0x1::type_name::TypeName, arg2: u64) {
        assert!(0x1::option::is_some<0x2::linked_table::LinkedTable<0x1::type_name::TypeName, u64>>(&arg0.total_risks), 1);
