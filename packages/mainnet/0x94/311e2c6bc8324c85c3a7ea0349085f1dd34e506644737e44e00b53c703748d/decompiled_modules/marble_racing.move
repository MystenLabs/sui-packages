module 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::marble_racing {
    ...
    struct AddBetEvent has copy, drop {
        ...
        bet_type: u8,
        payout: u64,
        option: vector<0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetOption>,
    ...
    struct RaceConfig has store, key {
        ...
        page_size: u64,
        bet_manager: 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetManager,
        max_combo: u8,
    ...
    struct Race has store, key {
        ...
        bet_end_time: u64,
        status: u64,
        risk_manager: 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::risk_manager::RiskManager,
        bet_setting: 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetSetting,
    ...
    fun remove(arg0: &mut RaceConfig, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::risk_manager::destroy_manager(v6);
    ...
    public fun set_single_house_edge(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64, arg3: u8) {
        ...
        0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::set_single_house_edge(&mut arg0.bet_manager, arg2, arg3);
    }
    ...
    public fun add_bet<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut RaceConfig, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: vector<u64>, arg6: vector<vector<u64>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v5 = 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::get_bet_payout(&arg1.bet_manager, &v0.bet_setting, v3, arg4, arg1.max_combo, v4, 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::risk_manager::marble_ids(&v0.risk_manager));
        0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::risk_manager::add_total_risk(&mut v0.risk_manager, 0x1::type_name::with_defining_ids<T0>(), v5);
        let v6 = MarbleRacing{dummy_field: false};
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::assert_within_risk<T0, MarbleRacing>(arg0, v6, 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::risk_manager::total_risk(&v0.risk_manager, 0x1::type_name::with_defining_ids<T0>()), arg8);
        ...
        if (0x2::linked_table::contains<address, vector<BetSlip>>(v12, v1)) {
            0x1::vector::push_back<BetSlip>(0x2::linked_table::borrow_mut<address, vector<BetSlip>>(v12, v1), v10);
        } else {
            let v13 = 0x1::vector::empty<BetSlip>();
            0x1::vector::push_back<BetSlip>(&mut v13, v10);
            0x2::linked_table::push_back<address, vector<BetSlip>>(v12, v1, v13);
        };
        0x2::dynamic_field::add<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut v0.id, v11, v2);
        let v14 = AddBetEvent{
            player_address : v1,
    ...
    public fun add_risk_limit<T0>(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64) {
        0x2::linked_table::push_back<0x1::type_name::TypeName, u64>(&mut arg0.risk_limits, 0x1::type_name::with_defining_ids<T0>(), arg2);
    }
    ...
    public fun cancel_race_bets<T0>(arg0: 0x2::object::ID, arg1: &mut RaceConfig, arg2: 0x1::option::Option<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v6 < v5 && 0x2::linked_table::length<address, vector<BetSlip>>(v2) > 0) {
            ...
            while (v6 < v5 && 0x1::vector::length<BetSlip>(&v9) != 0) {
                ...
                let v11 = 0x2::object::id<BetSlip>(&v10);
                if (v10.coin_type == 0x1::type_name::with_defining_ids<T0>()) {
                    let BetSlip {
                        id             : v12,
                        player_address : _,
                        bet_size       : _,
    ...
    public fun create(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: &mut RaceConfig, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = Race{
            ...
            bet_end_time   : arg2,
            status         : 0,
            risk_manager   : 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::risk_manager::new_manager(arg4, arg6),
            bet_setting    : 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::new_bet_setting(arg4),
    ...
    fun create_option(arg0: vector<u64>, arg1: vector<vector<u64>>, arg2: u8) : vector<0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetOption> {
        let v0 = 0x1::vector::empty<0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetOption>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            let v2 = if (arg2 == 0) {
                true
            ...
            let v3 = 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::new_bet_option(*0x1::vector::borrow<u64>(&arg0, v1), *0x1::vector::borrow<vector<u64>>(&arg1, v1));
            if (arg2 == 2) {
                assert!(!0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::check_duplicate_match_option(v0, v3), 18);
            };
            0x1::vector::push_back<0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetOption>(&mut v0, v3);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public fun get_risk_limit<T0>(arg0: &RaceConfig) : u64 {
        if (!0x2::linked_table::contains<0x1::type_name::TypeName, u64>(&arg0.risk_limits, 0x1::type_name::with_defining_ids<T0>())) {
            0
        } else {
            *0x2::linked_table::borrow<0x1::type_name::TypeName, u64>(&arg0.risk_limits, 0x1::type_name::with_defining_ids<T0>())
        }
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RaceConfig{
            ...
            page_size    : 200,
            bet_manager  : 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::new_bet_manager(),
            max_combo    : 3,
    ...
    public fun remove_risk_limit<T0>(arg0: &mut RaceConfig, arg1: &AdminCap) {
        0x2::linked_table::remove<0x1::type_name::TypeName, u64>(&mut arg0.risk_limits, 0x1::type_name::with_defining_ids<T0>());
    }
    ...
    public fun resolve<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: 0x2::object::ID, arg2: vector<u64>, arg3: &mut RaceConfig, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::linked_table::length<address, vector<BetSlip>>(v1) == 0) {
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_marble_racing_bet_results<T0, MarbleRacing>(arg0, 0x1::option::some<0x2::object::ID>(arg1), 0x1::option::none<0x1::string::String>(), 0x1::vector::empty<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::MarbleRacingBetResult<T0, MarbleRacing>>());
        ...
        let v5 = 0x1::vector::empty<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::MarbleRacingBetResult<T0, MarbleRacing>>();
        ...
        while (v7 < v6 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            ...
            while (v7 < v6 && 0x1::vector::length<BetSlip>(&v10) != 0) {
                ...
                let v12 = 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::won_bet(v11.option, v11.bet_type, arg2);
                if (v11.coin_type == 0x1::type_name::with_defining_ids<T0>()) {
                    let BetSlip {
                        id             : v13,
                        player_address : _,
                        bet_size       : v15,
                    ...
                    if (v12) {
                        ...
                        0x1::vector::push_back<PlayerWin<T0>>(&mut v2, v21);
                    } else {
                    ...
                    let v22 = 0;
                    let v23 = 0x1::vector::empty<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::MarbleRacingBetOption>();
                    while (v22 < 0x1::vector::length<0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetOption>(&v20)) {
                        0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::MarbleRacingBetOption>(&mut v23, 0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::create_unihouse_bet_option(*0x1::vector::borrow<0x94311e2c6bc8324c85c3a7ea0349085f1dd34e506644737e44e00b53c703748d::bet_manager::BetOption>(&v20, v22)));
                        v22 = v22 + 1;
                    };
                    let v24 = MarbleRacing{dummy_field: false};
                    0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::MarbleRacingBetResult<T0, MarbleRacing>>(&mut v5, 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::create_unihouse_marble_racing_bet_result<T0, MarbleRacing>(arg0, v24, 0x1::option::some<0x2::object::ID>(0x2::object::id<BetSlip>(&v11)), v8, v23, v16, v15, v17, arg2, v12));
        ...
        if (!0x1::vector::is_empty<PlayerWin<T0>>(&v2)) {
            let v25 = MarbleRacing{dummy_field: false};
            let v26 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::split_with_reimbursement<T0, MarbleRacing>(arg0, v25, v3);
            while (!0x1::vector::is_empty<PlayerWin<T0>>(&v2)) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v26, v29), arg5), v27);
                let v30 = MarbleRacing{dummy_field: false};
                0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::put_with_fee<T0, MarbleRacing>(arg0, v30, 0x2::coin::from_balance<T0>(v28, arg5));
            };
            0x2::balance::destroy_zero<T0>(v26);
        };
        0x1::vector::destroy_empty<PlayerWin<T0>>(v2);
        if (0x2::balance::value<T0>(&v4) != 0) {
            let v31 = MarbleRacing{dummy_field: false};
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::put_with_fee<T0, MarbleRacing>(arg0, v31, 0x2::coin::from_balance<T0>(v4, arg5));
        } else {
            0x2::balance::destroy_zero<T0>(v4);
        };
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_marble_racing_bet_results<T0, MarbleRacing>(arg0, 0x1::option::some<0x2::object::ID>(arg1), 0x1::option::none<0x1::string::String>(), v5);
        if (0x2::linked_table::length<address, vector<BetSlip>>(v1) == 0) {
            remove(arg3, arg1, arg5);
        };
    }
    ...
    public fun update_risk_limit<T0>(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64) {
        ...
        *0x2::linked_table::borrow_mut<0x1::type_name::TypeName, u64>(&mut arg0.risk_limits, 0x1::type_name::with_defining_ids<T0>()) = arg2;
    }
