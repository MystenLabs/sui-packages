module 0x94a87b57c09c53e430b257e78e6ccc2cf4539350d6446cf2b6e91bc0e4662708::staked_share {
    ...
    public entry fun new_and_share_number_pool_and_share_supply<T0: store, T1: store + key, T2: store + key>(arg0: &0x94a87b57c09c53e430b257e78e6ccc2cf4539350d6446cf2b6e91bc0e4662708::pool::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::length<StakedPoolShare<T0, T1, T2>>(&arg1.available_shares) == 0) {
            ...
            while (0x1::vector::length<StakedPoolShare<T0, T1, T2>>(&arg1.available_shares) != 0) {
                ...
                if (v7 > v0) {
                    ...
                    0x2::dynamic_field::add<0x2::object::ID, u64>(&mut v9.id, 0x2::object::uid_to_inner(&v9.id), v1);
                ...
                if (v7 == v0) {
                    0x2::dynamic_field::add<0x2::object::ID, u64>(&mut v6.id, 0x2::object::uid_to_inner(&v6.id), v1);
                    0x1::vector::push_back<StakedPoolShare<T0, T1, T2>>(&mut v5, v6);
                    v0 = 0;
                    arg0.active_supply = arg0.active_supply + v7;
                    break
                };
                let v10 = v7 * 100000 / v0 * v1 / 100000;
                v1 = v1 - v10;
                0x2::dynamic_field::add<0x2::object::ID, u64>(&mut v6.id, 0x2::object::uid_to_inner(&v6.id), v10);
                0x1::vector::push_back<StakedPoolShare<T0, T1, T2>>(&mut v5, v6);
                v0 = v0 - v7;
                arg0.active_supply = arg0.active_supply + v7;
            };
            if (v0 != 0) {
                ...
                0x2::dynamic_field::add<0x2::object::ID, u64>(&mut v11.id, 0x2::object::uid_to_inner(&v11.id), v1);
                0x1::vector::push_back<StakedPoolShare<T0, T1, T2>>(&mut v5, v11);
