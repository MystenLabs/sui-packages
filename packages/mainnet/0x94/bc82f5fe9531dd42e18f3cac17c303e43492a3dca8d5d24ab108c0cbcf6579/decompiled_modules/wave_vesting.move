module 0x94bc82f5fe9531dd42e18f3cac17c303e43492a3dca8d5d24ab108c0cbcf6579::wave_vesting {
    struct App has key {
        id: 0x2::object::UID,
    ...
    struct WaveVestingClaimed has copy, drop, store {
        receiver: address,
        id: u64,
        amount: u64,
        unlock_time: u64,
    ...
    entry fun claim(arg0: &mut App, arg1: u64, arg2: u64, arg3: address, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = WaveVestingClaimed{
            receiver    : arg3,
            id          : arg1,
            amount      : arg2,
            unlock_time : arg4,
        };
        0x2::event::emit<WaveVestingClaimed>(v0);
    }
    ...
    entry fun operator_pause(arg0: &mut App, arg1: u64, arg2: vector<u8>, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::string::utf8(b"WAVE_VESTING_PAUSE:");
    ...
    fun validate_signature(arg0: vector<u8>, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock) {
        let v0 = 0x1::string::utf8(b"WAVE_VESTING_CLAIM:");
        let v1 = 0x2::bcs::to_bytes<0x1::string::String>(&v0);
