module 0x94f657fc19160d304cd058a842b2a323d1082c25877045875e0013fbe63b36a2::cnsnft1926 {
    struct CNSNFT1926 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1926, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1926>(arg0, arg1);
