module 0x94f368e7610cdf29677f549ef8680e9097ac899e838eaabe1aab8fbe30f266a3::blockbolt {
    ...
    public entry fun collect_profits<T0>(arg0: &MerchantOwnerCap, arg1: &mut MerchnatFee<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun send<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut MerchnatFee<T0>, arg2: 0x1::string::String, arg3: address, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
