module 0x9421ccfcf4d538cbafbc84a9e96d738752217dc1abe14e987fa378712b89f031::tocen_coin_flip {
    ...
    struct GameCheck has key {
        id: 0x2::object::UID,
        messageVector: vector<u8>,
        stringrandomness: 0x1::string::String,
    }
    ...
    public entry fun playtest(arg0: &mut Game, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id_bytes<Game>(arg0);
        let v1 = v0;
        0x1::vector::append<u8>(&mut v1, arg0.user_randomness);
        let v2 = GameCheck{
            ...
            messageVector    : v1,
            stringrandomness : 0x1::string::utf8(v1),
        };
        0x2::transfer::share_object<GameCheck>(v2);
    }
