module 0x94411dbb6ea04a35d637ed6e031b3ce8482a4991e8ae00c4eabc72c29f73aade::reward1490 {
    struct REWARD1490 has drop {
        dummy_field: bool,
    }

    struct TICKET_1490 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1490(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1490>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1490>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1490, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1490>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1490>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1490>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1490>>(v5, 0x2::tx_context::sender(arg1));
    }
