module 0x944adc45c349711fee3db643561f45cb4e577f7e49f5802f2ec71ec4e164caa6::reward7641 {
    struct REWARD7641 has drop {
        dummy_field: bool,
    }

    struct TICKET_7641 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7641(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7641>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7641>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7641, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7641>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7641>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7641>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7641>>(v5, 0x2::tx_context::sender(arg1));
    }
