module 0x94ad2a55ae405c94a386df6b5c2c39f9659ac2f469ac422b168c0c5be9a61036::reward1768 {
    struct REWARD1768 has drop {
        dummy_field: bool,
    }

    struct TICKET_1768 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1768(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1768>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1768>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1768, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1768>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1768>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1768>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1768>>(v5, 0x2::tx_context::sender(arg1));
    }
