module 0x9472afda3d6adfc9ec2fcf499d23f01f7ab8df20418edae9c0f00b44d35c93ae::launchpad {
    ...
    public entry fun claim<T0, T1>(arg0: &mut LaunchInfo<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x9472afda3d6adfc9ec2fcf499d23f01f7ab8df20418edae9c0f00b44d35c93ae::math_extend::mul_div(arg0.claim_amount_per_coin_uint, v1.paid_amount, arg0.pay_coin_unit);
        assert!(v2 > 0, 1005);
