module 0x941807666dc323cee8b3e6e8358edb2ff9a052dc3392c5df443d84073794cdce::onepiece {
    ...
    fun init(arg0: ONEPIECE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<ONEPIECE>(&mut v2, 10000000000000000000, 0x2::tx_context::sender(arg1), arg1);
