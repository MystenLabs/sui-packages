module 0x94aabddcd74cf8eb813840b861320765cfd766efff27597da28ed7005da70772::public_sale {
    ...
    public entry fun calculate_elligible_rewards(arg0: &mut PresaleData, arg1: &mut UserData, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (get_is_whitelisted(arg0, 0x2::tx_context::sender(arg2))) {
            arg1.calculatedBonusReward = calculate_bonus_reward(arg1.investedSui, arg0.bonusRewardPool, arg0.testTotalSuiDeposited);
        };
    ...
    fun calculate_refundable_reward(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = calculate_reward(arg0, arg2, arg3) / 1000000 * arg1 / 1000000000 * 1000000;
        if (v0 > arg0) {
            0
        } else {
            arg0 - v0
    ...
    public entry fun end_presale(arg0: &ICOOperatorCapability, arg1: &mut PresaleData) {
        assert!(arg1.isPresaleActive == true, 2);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PresaleData{
            ...
            icoStartTimestamp      : 1684420821000,
    ...
    public entry fun purchase_tokens(arg0: &mut PresaleData, arg1: &mut UserData, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(arg2) > arg0.minimumContributionSui, 4);
        assert!(v0 >= arg0.icoStartTimestamp, 0);
        assert!(v0 <= arg0.icoEndTimestamp, 1);
        assert!(arg0.isPresaleActive == true, 1);
    ...
    public entry fun withdraw_funds(arg0: &mut PresaleData, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.totalSuiDeposited, v0, arg1), @0x648f3b1dde9ffe6d79c61670f2bf6a710a4a3285d0dfea6b7c07fadbd8b30c38);
        let v1 = FundsWithdrawn{
            wallet : @0x648f3b1dde9ffe6d79c61670f2bf6a710a4a3285d0dfea6b7c07fadbd8b30c38,
            amount : v0,
        };
