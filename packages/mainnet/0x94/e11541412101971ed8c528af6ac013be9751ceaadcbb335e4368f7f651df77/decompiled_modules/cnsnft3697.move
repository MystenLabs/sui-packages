module 0x94e11541412101971ed8c528af6ac013be9751ceaadcbb335e4368f7f651df77::cnsnft3697 {
    struct CNSNFT3697 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3697, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3697>(arg0, arg1);
