module 0x94f12f01512009cd88bb3f4e7513e7a5bbb5a8fd7ce473c28bb746d6e6ca1eea::evosgenesisegg {
    ...
    fun create_nft(arg0: &mut 0x2::tx_context::TxContext) : EvosGenesisEgg {
        EvosGenesisEgg{
            ...
            url  : 0x2::url::new_unsafe_from_bytes(b"https://knw-gp.s3.eu-north-1.amazonaws.com/test.jpghttps://knw-gp.s3.eu-north-1.amazonaws.com/test.jpg"),
        }
    }
