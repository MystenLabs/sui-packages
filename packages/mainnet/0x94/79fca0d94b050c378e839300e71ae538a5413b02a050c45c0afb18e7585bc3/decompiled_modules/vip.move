module 0x12936bef50c5ce93fd6e0ec805ac760660d7c5c58a860e920a6fd8ff47c26af8::vip {
    ...
    fun assert_valid_exp_multiplier(arg0: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float) {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gte(arg0, &v0), 13836466001396760583);
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::lte(arg0, &v1), 13836466005691727879);
    }

    fun assert_valid_version(arg0: &VipRegistry) {
        let v0 = package_version();
        assert!(0x2::vec_set::contains<u64>(&arg0.version_set, &v0), 13838718690269331473);
    }
    ...
    entry fun claim_vip_level_up_usd_reward<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = take_claimable_level_up_reward_preconditions<T0>(arg0);
        let v1 = take_claimable_level_up_reward(arg0, arg1, arg4);
        let (v2, v3, _) = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::get_checked_usd_price(arg0, v0, arg2, arg3);
        pay_claimed_level_up_reward<T0>(arg0, arg1, v1, v2, v3, arg3, arg4);
    }

    entry fun claim_vip_level_up_usd_reward_v2<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = take_claimable_level_up_reward_preconditions<T0>(arg0);
        let v1 = take_claimable_level_up_reward(arg0, arg1, arg4);
        let (v2, v3, _) = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::get_checked_usd_price_v2(arg0, v0, arg2, arg3);
        pay_claimed_level_up_reward<T0>(arg0, arg1, v1, v2, v3, arg3, arg4);
    }
    ...
    fun edit_vip_registry_internal(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: bool, arg2: u64, arg3: vector<u64>, arg4: 0x2::vec_map::VecMap<u64, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>, arg5: u64) {
        let v0 = borrow_vip_registry_mut(arg0);
        v0.is_enabled = arg1;
        assert!(arg2 <= 1000000 / 100, 13837031343647227915);
        v0.stake_contribution_to_rakeback_pool = arg2;
        if (0x1::vector::length<u64>(&arg3) > 1) {
            let v1 = 0;
            while (v1 < 0x1::vector::length<u64>(&arg3) - 1) {
                assert!(*0x1::vector::borrow<u64>(&arg3, v1) < *0x1::vector::borrow<u64>(&arg3, v1 + 1), 13837312852983808013);
                v1 = v1 + 1;
            };
        };
        ...
        while (v5 < 0x1::vector::length<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(&v4)) {
            assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(0x1::vector::borrow<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(&v4, v5)), 13837594370910322703);
            v5 = v5 + 1;
        };
    ...
    fun external_give_exp_to_player_internal(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = borrow_vip_registry_mut(arg0);
        assert!(v0.is_enabled, 13836188881516756997);
        ...
        assert!(v1 <= (v0.daily_external_exp_limit as u128), 13835625961627844609);
    ...
    fun get_exp_multiplier_internal(arg0: &VipRegistry, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName) : 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float {
        assert!(exp_multiplier_exists_internal(arg0, arg1, arg2), 13836749495008231433);
    ...
    fun pay_claimed_level_up_reward<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg3: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg4: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::floor_to_u64(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::mul(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::div(arg2, v1), 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::from_u64(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::math::pow_u64(10, (v0 as u64)))));
        let v3 = PlayerClaimVipLevelUpUsdRewardEvent{
            player                    : 0x2::tx_context::sender(arg6),
            claimed_at_timestamp_ms   : 0x2::clock::timestamp_ms(arg5),
            level                     : arg1,
            dollar_coin_type_name     : 0x1::type_name::with_defining_ids<T0>(),
            usd_reward_amount         : arg2,
            dollar_coin_reward_amount : v2,
            dollar_coin_decimals      : v0,
            stablecoin_price          : arg3,
            stablecoin_confidence     : arg4,
            payout_price              : v1,
        };
        0x2::event::emit<PlayerClaimVipLevelUpUsdRewardEvent>(v3);
        let v4 = Vip{dummy_field: false};
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::operator_take_from_rakeback_pool<T0, Vip>(arg0, v4, v2), arg6), 0x2::tx_context::sender(arg6));
    }
    ...
    fun remove_player_exp_boost_entry<T0, T1: drop>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: address, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let v0 = borrow_vip_registry_mut(arg0);
        let v1 = PlayerVipProfileKey{pos0: arg1};
        assert!(0x2::dynamic_object_field::exists_<PlayerVipProfileKey>(&v0.id, v1), 13839563772329852951);
        ...
        assert!(0x2::dynamic_object_field::exists_<ExpMultiplierKey>(&v2.id, v5), 13839563823869460503);
        let PlayerExpBoost {
            id                      : v6,
            multiplier              : v7,
            expiry_timestamp_ms     : v8,
    ...
    fun remove_version_internal(arg0: &mut VipRegistry, arg1: u64) {
        assert!(0x2::vec_set::contains<u64>(&arg0.version_set, &arg1), 13839000422944210963);
    ...
    fun set_player_exp_boost_entry<T0, T1: drop>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: address, arg2: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 > v0, 13839845062623100953);
        ...
        let v4 = 0x1::type_name::with_defining_ids<T1>();
        let v5 = make_exp_multiplier_key(v3, v4);
        assert!(!0x2::dynamic_object_field::exists_<ExpMultiplierKey>(&v2.id, v5), 13839282159914057749);
    ...
    fun take_claimable_level_up_reward(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: &0x2::tx_context::TxContext) : 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float {
        let v0 = borrow_vip_registry_mut(arg0);
        let v1 = borrow_player_vip_profile_mut(v0, 0x2::tx_context::sender(arg2));
        let v2 = VipLevelUpUsdRewardKey{level: arg1};
        assert!(0x2::dynamic_object_field::exists_<VipLevelUpUsdRewardKey>(&v1.id, v2), 13840128839702413339);
        let VipLevelUpUsdReward {
            id                      : v3,
            usd_reward_amount       : v4,
            created_at_timestamp_ms : _,
        } = 0x2::dynamic_object_field::remove<VipLevelUpUsdRewardKey, VipLevelUpUsdReward>(&mut v1.id, v2);
        0x2::object::delete(v3);
        v4
    }

    fun take_claimable_level_up_reward_preconditions<T0>(arg0: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : 0x1::type_name::TypeName {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::get_dollar_coin_type(arg0) == v0, 13835906646330703875);
        v0
    }
