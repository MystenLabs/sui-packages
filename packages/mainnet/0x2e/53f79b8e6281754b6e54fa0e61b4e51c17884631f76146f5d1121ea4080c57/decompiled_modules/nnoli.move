module 0x2e53f79b8e6281754b6e54fa0e61b4e51c17884631f76146f5d1121ea4080c57::nnoli {
    struct NNOLI has drop {
        dummy_field: bool,
    }

    fun init(arg0: NNOLI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<NNOLI>(arg0, 9, 0x1::string::utf8(b"NNOLI"), 0x1::string::utf8(b"Nnolitmere"), 0x1::string::utf8(b"meme coin cat"), 0x1::string::utf8(b"https://gateway.irys.xyz/IGjqm_IByLFRQ6wL8TsKe9x5ccw9W7bl4jw-j0xIuVg"), arg1);
        let v2 = v1;
        let v3 = v0;
