module 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::decimal {
    ...
    public fun mul_u256(arg0: Decimal, arg1: u256) : Decimal {
        Decimal{value: arg0.value * arg1}
    }
    ...
    public fun to_u128(arg0: Decimal) : u128 {
        let v0 = arg0.value / 1000000000000000000;
        assert!(v0 <= 340282366920938463463374607431768211455, 4202);
        (v0 as u128)
    }
