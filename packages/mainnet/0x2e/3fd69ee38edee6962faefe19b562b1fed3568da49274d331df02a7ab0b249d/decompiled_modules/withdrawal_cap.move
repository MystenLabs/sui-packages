module 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::withdrawal_cap {
    struct WithdrawalCap has store {
        config_capacity: 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::I64,
        current_total: 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::I64,
    ...
    public(friend) fun check_capacity_allows_withdrawals(arg0: &WithdrawalCap, arg1: u64) {
        assert!(!0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::is_negative(&arg0.config_capacity), 4101);
        let v0 = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::from_u64(arg1);
        let v1 = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::add(&arg0.current_total, &v0);
        assert!(0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::lt(&v1, &arg0.config_capacity) || 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::eq(&v1, &arg0.config_capacity), 4101);
    }
    ...
    public(friend) fun new(arg0: u64, arg1: u64, arg2: u64) : WithdrawalCap {
        WithdrawalCap{
            config_capacity                : 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::from_u64(arg0),
            current_total                  : 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::from_u64(0),
    ...
    public(friend) fun reset_current_interval_and_counter(arg0: &mut WithdrawalCap, arg1: u64) {
        arg0.current_total = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::from_u64(0);
    ...
    public(friend) fun update_config_capcity(arg0: &mut WithdrawalCap, arg1: u64) {
        arg0.config_capacity = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::from_u64(arg1);
    }
    ...
    public fun update_counter(arg0: &mut WithdrawalCap, arg1: u64, arg2: u8, arg3: u8) {
        ...
        if (arg2 == 1) {
            if (arg3 == 3) {
                arg0.current_total = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::saturating_add(&arg0.current_total, &v0);
            } else {
                arg0.current_total = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::checked_add(&arg0.current_total, &v0);
            };
        } else if (arg2 == 2) {
            if (arg3 == 3) {
                arg0.current_total = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::saturating_sub(&arg0.current_total, &v0);
            } else {
                arg0.current_total = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::i64::checked_sub(&arg0.current_total, &v0);
            };
        };
    }
