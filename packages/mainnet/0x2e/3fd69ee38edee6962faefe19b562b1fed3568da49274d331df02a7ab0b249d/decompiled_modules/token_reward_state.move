module 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::token_reward_state {
    ...
    public(friend) fun add_reward_token_treasury<T0>(arg0: &mut TokenRewardState, arg1: 0x2::coin::TreasuryCap<T0>) {
        add<0x1::string::String, 0x2::coin::TreasuryCap<T0>>(arg0, 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::utils::get_type<T0>(), arg1);
    }
    ...
    public(friend) fun receive_treasury_cap<T0>(arg0: &mut TokenRewardState, arg1: 0x2::coin::TreasuryCap<T0>) {
        let v0 = 0x2e3fd69ee38edee6962faefe19b562b1fed3568da49274d331df02a7ab0b249d::utils::get_type<T0>();
