module 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop {
    ...
    public fun new_item(arg0: &mut GenesisShop, arg1: &mut Builder) {
        ...
        *v4 = *v4 - 1;
        ...
        let (v8, v9, v10) = if (arg1.equipment == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::primary_bytes() || arg1.equipment == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::secondary_bytes() || arg1.equipment == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::tertiary_bytes()) {
            ...
            let (v11, v12, v13) = if (arg1.equipment == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::left_bracer_bytes()) {
                let (v14, v15, v16) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_left_bracer(v2, v6);
                (v16, v14, v15)
            } else {
                let (v17, v18, v19) = if (arg1.equipment == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::right_bracer_bytes()) {
        ...
        let v20 = b"";
        0x1::vector::append<u8>(&mut v20, v2);
        0x1::vector::append<u8>(&mut v20, arg1.equipment);
        0x1::vector::append<u8>(&mut v20, v6);
        let v21 = Item{
            hash         : 0x2::hash::blake2b256(&v20),
            ...
            image_url    : 0x1::string::utf8(v8),
            model_url    : 0x1::string::utf8(v9),
            texture_url  : 0x1::string::utf8(v10),
        };
        0x2::table_vec::push_back<Item>(0x2::table::borrow_mut<0x1::string::String, 0x2::table_vec::TableVec<Item>>(&mut arg0.items, 0x1::string::utf8(arg1.equipment)), v21);
        if (*v4 == 0) {
            0x1::vector::pop_back<u64>(v1);
            if (0x1::vector::length<u64>(v1) == 0) {
                0x1::vector::pop_back<vector<u64>>(&mut arg1.quantities);
