module 0x2e868e44010e06c0fc925d29f35029b6ef75a50e03d997585980fb2acea45ec6::fees {
    ...
    public(friend) fun withdraw<T0, T1>(arg0: &mut Fees<T0, T1>) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        (0x2::balance::split<T0>(&mut arg0.fee_a, 0x2::balance::value<T0>(&arg0.fee_a)), 0x2::balance::split<T1>(&mut arg0.fee_b, 0x2::balance::value<T1>(&arg0.fee_b)))
    }
