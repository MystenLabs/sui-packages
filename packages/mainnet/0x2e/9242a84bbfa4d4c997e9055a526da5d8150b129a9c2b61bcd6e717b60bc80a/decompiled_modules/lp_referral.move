module 0x2e9242a84bbfa4d4c997e9055a526da5d8150b129a9c2b61bcd6e717b60bc80a::lp_referral {
    ...
    public fun claim(arg0: &mut LpReferral, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        claim_internal(arg0, v0.user, v0.amount, v0.from_ts, v0.to_ts, v0.cashback_amount, v0.commission_amount, arg3, arg4)
    }

    fun claim_internal(arg0: &mut LpReferral, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(arg2 > 0, 3);
        assert!(0x2::tx_context::sender(arg8) == arg1, 6);
        assert!(arg3 < arg4, 4);
        ...
        assert!(arg4 <= 0x2::clock::timestamp_ms(arg7), 4);
        ...
        let v1 = Claimed{
            ...
            from_ts           : arg3,
            to_ts             : arg4,
            cashback_amount   : arg5,
            commission_amount : arg6,
        };
        0x2::event::emit<Claimed>(v1);
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_vault, arg2), arg8)
    }
    ...
    fun verify_signature(arg0: &vector<u8>, arg1: vector<u8>, arg2: vector<u8>) : ClaimPayload {
        ...
        let v1 = ClaimPayload{
            ...
            cashback_amount   : 0x2::bcs::peel_u64(&mut v0),
            commission_amount : 0x2::bcs::peel_u64(&mut v0),
        };
