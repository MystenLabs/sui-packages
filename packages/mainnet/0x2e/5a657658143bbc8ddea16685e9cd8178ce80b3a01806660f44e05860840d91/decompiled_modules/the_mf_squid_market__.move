module 0x2e5a657658143bbc8ddea16685e9cd8178ce80b3a01806660f44e05860840d91::the_mf_squid_market__ {
    struct THE_MF_SQUID_MARKET__ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: THE_MF_SQUID_MARKET__, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<THE_MF_SQUID_MARKET__>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"544845204d46205351554944204d41524b455420e29c85"));
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreie75odhmga52dmw4txuf35snbv5qyqs3tcyqux3tb643abycmn43q"));
