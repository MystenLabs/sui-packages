module 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::fixed_point64 {
    ...
    public fun div(arg0: FixedPoint64, arg1: FixedPoint64) : FixedPoint64 {
        ...
        FixedPoint64{value: (0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_down((arg0.value as u256) << 64, (arg1.value as u256)) as u128)}
    }

    public fun div_down_u128(arg0: u128, arg1: FixedPoint64) : u128 {
        assert!(arg1.value != 0, 3);
        let v0 = 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_down((arg0 as u256) << 64, (arg1.value as u256));
    ...
    public fun div_up_u128(arg0: u128, arg1: FixedPoint64) : u128 {
        assert!(arg1.value != 0, 3);
        let v0 = 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_up((arg0 as u256) << 64, (arg1.value as u256));
        assert!(v0 <= 340282366920938463463374607431768211455, 4);
        (v0 as u128)
    }
    ...
    public fun mul_div(arg0: FixedPoint64, arg1: FixedPoint64, arg2: FixedPoint64) : FixedPoint64 {
        ...
        FixedPoint64{value: 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math128::mul_div_down(arg0.value, arg1.value, arg2.value)}
    }
    ...
    public fun sqrt(arg0: FixedPoint64) : FixedPoint64 {
        let v0 = arg0.value;
        let v1 = ((0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math128::sqrt_down(v0) << 32) as u256);
