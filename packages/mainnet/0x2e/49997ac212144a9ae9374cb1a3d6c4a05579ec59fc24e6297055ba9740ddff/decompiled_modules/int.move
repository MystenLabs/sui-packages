module 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::int {
    ...
    public fun div_down(arg0: Int, arg1: Int) : Int {
        if (is_positive(arg0)) {
            if (is_positive(arg1)) {
                return from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_down(arg0.value, arg1.value))
            };
            let v0 = abs(arg1);
            return neg_from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_down(arg0.value, v0.value))
        };
        if (is_positive(arg1)) {
            let v1 = abs(arg0);
            return neg_from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_down(v1.value, arg1.value))
        };
        let v2 = abs(arg0);
        let v3 = abs(arg1);
        from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_down(v2.value, v3.value))
    }

    public fun div_up(arg0: Int, arg1: Int) : Int {
        if (is_positive(arg0)) {
            if (is_positive(arg1)) {
                return from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_up(arg0.value, arg1.value))
            };
            let v0 = abs(arg1);
            return neg_from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_up(arg0.value, v0.value))
        };
        if (is_positive(arg1)) {
            let v1 = abs(arg0);
            return neg_from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_up(v1.value, arg1.value))
        };
        let v2 = abs(arg0);
        let v3 = abs(arg1);
        from_u256(0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::div_up(v2.value, v3.value))
    }
    ...
    public fun pow(arg0: Int, arg1: u256) : Int {
        let v0 = abs(arg0);
        let v1 = 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::math256::pow(v0.value, arg1);
