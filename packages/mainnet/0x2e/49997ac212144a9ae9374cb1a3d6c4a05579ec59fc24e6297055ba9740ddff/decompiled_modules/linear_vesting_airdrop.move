module 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::linear_vesting_airdrop {
    ...
    public fun destroy_zero<T0>(arg0: Airdrop<T0>) {
        ...
        0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::bitmap::destroy(v5);
    }
    ...
    public fun new<T0>(arg0: 0x2::coin::Coin<T0>, arg1: vector<u8>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Airdrop<T0> {
        ...
        Airdrop<T0>{
            ...
            start    : arg2,
            duration : arg3,
            map      : 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::bitmap::new(arg5),
        }
    }
    ...
    public fun get_airdrop<T0>(arg0: &mut Airdrop<T0>, arg1: vector<vector<u8>>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::linear_vesting_wallet::Wallet<T0> {
        ...
        0x2e49997ac212144a9ae9374cb1a3d6c4a05579ec59fc24e6297055ba9740ddff::linear_vesting_wallet::new<T0>(0x2::coin::take<T0>(&mut arg0.balance, arg3, arg4), arg2, arg0.start, arg0.duration, arg4)
    }
