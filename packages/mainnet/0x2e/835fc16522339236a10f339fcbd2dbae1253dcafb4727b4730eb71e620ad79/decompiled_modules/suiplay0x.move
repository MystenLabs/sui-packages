module 0x2e835fc16522339236a10f339fcbd2dbae1253dcafb4727b4730eb71e620ad79::suiplay0x {
    struct SUIPLAY0X has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUIPLAY0X, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIPLAY0X>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SuiPlay0x"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The SuiPlay0X1 is a first-of-its-kind handheld gaming console. It supports a wide range of PC games, as well as new AAA titles developed using Sui technology."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigzsixmjq3c6r5553neuokjhouwchihyjcw2cdax26ckw2j6ra3uy"));
