module 0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::cross_chain_airdrop {
    ...
    struct PerContractAirdropInfo has store {
        ...
        claimed_source_token_ids: vector<0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::TokenID>,
    }

    struct ERC721 has store, key {
        id: 0x2::object::UID,
        source_contract_address: SourceContractAddress,
        metadata: 0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::ERC721Metadata,
        url: 0x2::url::Url,
    ...
    public entry fun claim(arg0: &mut CrossChainAirdropOracle, arg1: address, arg2: vector<u8>, arg3: u256, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::new_token_id(arg3);
        assert!(!is_token_claimed(v0, &v1), 0);
        let v2 = SourceContractAddress{address: arg2};
        let v3 = ERC721{
            id                      : 0x2::object::new(arg8),
            source_contract_address : v2,
            metadata                : 0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::new(v1, arg4, arg5),
            url                     : 0x2::url::new_unsafe_from_bytes(arg6),
            description             : 0x1::string::utf8(arg7),
            name                    : 0x1::string::utf8(arg4),
        };
        0x1::vector::push_back<0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::TokenID>(&mut v0.claimed_source_token_ids, v1);
    ...
    fun create_contract(arg0: &mut CrossChainAirdropOracle, arg1: &vector<u8>) : &mut PerContractAirdropInfo {
        ...
        let v1 = PerContractAirdropInfo{
            ...
            claimed_source_token_ids : 0x1::vector::empty<0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::TokenID>(),
        };
    ...
    fun is_token_claimed(arg0: &PerContractAirdropInfo, arg1: &0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::TokenID) : bool {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids)) {
            if (0x1::vector::borrow<0x2e71ed3efe6c61b1a8c25378c51a126bf4e75aaa39ed153496f6548a01e14e12::erc721_metadata::TokenID>(&arg0.claimed_source_token_ids, v0) == arg1) {
                return true
            };
            v0 = v0 + 1;
        };
