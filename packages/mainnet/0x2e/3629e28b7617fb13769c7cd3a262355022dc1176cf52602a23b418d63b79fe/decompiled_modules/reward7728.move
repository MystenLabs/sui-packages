module 0x2e3629e28b7617fb13769c7cd3a262355022dc1176cf52602a23b418d63b79fe::reward7728 {
    struct REWARD7728 has drop {
        dummy_field: bool,
    }

    struct TICKET_7728 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7728(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7728>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7728>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7728, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7728>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7728>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7728>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7728>>(v5, 0x2::tx_context::sender(arg1));
    }
