module 0x2ec7f33ebfea038f802dad8d58a20cf00e8d2700faa25e905f02d776fa9478d2::reward1167 {
    struct REWARD1167 has drop {
        dummy_field: bool,
    }

    struct TICKET_1167 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1167(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1167>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1167>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1167, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1167>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1167>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1167>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1167>>(v5, 0x2::tx_context::sender(arg1));
    }
