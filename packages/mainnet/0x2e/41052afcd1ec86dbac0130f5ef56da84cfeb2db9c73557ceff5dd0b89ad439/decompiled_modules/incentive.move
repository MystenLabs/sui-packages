module 0x2e41052afcd1ec86dbac0130f5ef56da84cfeb2db9c73557ceff5dd0b89ad439::incentive {
    ...
    fun calculate_one(arg0: &mut IncentivePool, arg1: u64, arg2: u256, arg3: address, arg4: u256) : (u256, u256) {
    ...
    fun get_active_pools(arg0: &Incentive, arg1: u8, arg2: u8, arg3: u64) : vector<address> {
    ...
    public fun get_incentive_apy(arg0: &0x2::clock::Clock, arg1: &Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: &0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::PriceOracle, arg4: u8) : vector<IncentiveAPYInfo> {
        ...
        while (v1 > 0) {
            ...
            let (_, v7, _) = 0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::get_token_price(arg0, arg3, 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_oracle_id(arg2, v2));
            let v9 = get_active_pools(arg1, v2, arg4, 0x2::clock::timestamp_ms(arg0));
            let v10 = 0x1::vector::length<address>(&v9);
            if (v10 == 0) {
                v1 = v1 - 1;
                continue
            };
            ...
            while (v10 > 0) {
                let v13 = 0x2::table::borrow<address, IncentivePool>(&arg1.pools, *0x1::vector::borrow<address>(&v9, v10 - 1));
                let (_, v15, _) = 0x859de5e155d57462d3fe0aeb980b9a3f9cdccf76522d9499f372789183440aca::oracle::get_token_price(arg0, arg3, 0x2::table::borrow<address, IncentiveFundsPoolInfo>(&arg1.funds, v13.funds).oracle_id);
                v11 = v11 + v13.total_supply / (v13.end_at - v13.start_at) * (v15 as u64) * 31536000000 / (v5 as u64) * (v7 as u64);
                if (!0x1::vector::contains<address>(&v12, &v13.funds)) {
                    0x1::vector::push_back<address>(&mut v12, v13.funds);
                };
                v10 = v10 - 1;
            };
            let v17 = IncentiveAPYInfo{
                asset_id   : v2,
                apy        : v11,
                funds_list : v12,
            };
            0x1::vector::push_back<IncentiveAPYInfo>(&mut v0, v17);
            v1 = v1 - 1;
        };
        v0
    }

    public fun get_incentive_pools(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: u8, arg4: u8, arg5: address) : vector<IncentivePoolInfo> {
        ...
        while (v5 > 0) {
            ...
            let v12 = calculate_user_effective_amount(arg4, v6, v7, v11.factor);
            let (_, v14) = calculate_one(v11, 0x2::clock::timestamp_ms(arg0), v10, arg5, v12);
            let v15 = 0;
            if (0x2::table::contains<address, u256>(&v11.total_claimed_of_users, arg5)) {
                v15 = *0x2::table::borrow<address, u256>(&v11.total_claimed_of_users, arg5);
            };
            let v16 = IncentivePoolInfo{
            ...
            0x1::vector::push_back<IncentivePoolInfo>(&mut v0, v16);
            v5 = v5 - 1;
        };
        v0
    }
    ...
    public fun get_pool_obj_from_funds_pool<T0>(arg0: &mut Incentive, arg1: &IncentiveFundsPool<T0>, arg2: u8, arg3: u8) : vector<address> {
    ...
    fun update_reward(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: u8, arg4: u8, arg5: address) {
        ...
        while (v5 > 0) {
            let v11 = 0x2::table::borrow_mut<address, IncentivePool>(&mut arg1.pools, *0x1::vector::borrow<address>(&v4, v5 - 1));
            let v12 = calculate_user_effective_amount(arg4, v6, v7, v11.factor);
            let (v13, v14) = calculate_one(v11, v0, v10, arg5, v12);
            v11.index_reward = v13;
            ...
            0x2::table::add<address, u256>(&mut v11.index_rewards_paids, arg5, v13);
            ...
            0x2::table::add<address, u256>(&mut v11.total_rewards_of_users, arg5, v14);
            v5 = v5 - 1;
        };
    }
