module 0x2e8d69a9624341b282ebbe8588affa11fe021e4c4dd41882db11133e34eaa83e::cnsnft1980 {
    struct CNSNFT1980 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1980, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1980>(arg0, arg1);
