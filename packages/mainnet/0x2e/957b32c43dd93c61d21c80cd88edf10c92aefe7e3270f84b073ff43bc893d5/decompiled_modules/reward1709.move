module 0x2e957b32c43dd93c61d21c80cd88edf10c92aefe7e3270f84b073ff43bc893d5::reward1709 {
    struct REWARD1709 has drop {
        dummy_field: bool,
    }

    struct TICKET_1709 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1709(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1709>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1709>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1709, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1709>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1709>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1709>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1709>>(v5, 0x2::tx_context::sender(arg1));
    }
