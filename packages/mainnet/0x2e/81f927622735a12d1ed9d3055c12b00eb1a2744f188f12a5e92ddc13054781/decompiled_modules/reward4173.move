module 0x2e81f927622735a12d1ed9d3055c12b00eb1a2744f188f12a5e92ddc13054781::reward4173 {
    struct REWARD4173 has drop {
        dummy_field: bool,
    }

    struct TICKET_4173 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4173(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4173>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4173>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4173, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4173>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4173>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4173>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4173>>(v5, 0x2::tx_context::sender(arg1));
    }
