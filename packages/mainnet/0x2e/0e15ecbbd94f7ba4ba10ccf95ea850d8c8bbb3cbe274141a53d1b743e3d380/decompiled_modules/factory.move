module 0x2e0e15ecbbd94f7ba4ba10ccf95ea850d8c8bbb3cbe274141a53d1b743e3d380::factory {
    ...
    public entry fun check_profit_2<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T1, T0, T2>) : u8 {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u128>();
        let v2 = 0x1::vector::empty<u128>();
        let (v3, v4, v5) = inner_turbos<T1, T0, T2>(arg1, true);
        0x1::vector::push_back<u64>(&mut v0, v5);
        0x1::vector::push_back<u128>(&mut v1, v3);
        0x1::vector::push_back<u128>(&mut v2, v4);
        let (v6, v7, v8) = inner_cetus<T0, T1>(arg0, true);
    ...
    fun inner_turbos<T0, T1, T2>(arg0: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: bool) : (u128, u128, u64) {
        let (v0, v1) = price_from_sqrt_price(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_sqrt_price<T0, T1, T2>(arg0), arg1);
        (((v0 >> 32) as u128), ((v1 >> 32) as u128), (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_fee<T0, T1, T2>(arg0) as u64))
    }
