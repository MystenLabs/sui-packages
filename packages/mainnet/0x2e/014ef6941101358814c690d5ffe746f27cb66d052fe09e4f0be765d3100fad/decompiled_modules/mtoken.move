module 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::mtoken {
    ...
    public fun collect_mtokens<T0, T1, T2>(arg0: &mut VestingManager<T0, T1, T2>, arg1: &AdminCap<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_version_and_upgrade<T0, T1, T2>(arg0);
        assert!(arg1.manager == 0x2::object::id<VestingManager<T0, T1, T2>>(arg0), 3);
        0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.vesting_balance), arg2)
    }
