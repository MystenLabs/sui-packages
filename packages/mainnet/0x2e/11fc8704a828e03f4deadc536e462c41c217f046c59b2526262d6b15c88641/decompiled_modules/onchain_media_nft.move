module 0x2e11fc8704a828e03f4deadc536e462c41c217f046c59b2526262d6b15c88641::onchain_media_nft {
    ...
    fun init(arg0: ONCHAIN_MEDIA_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://aggregator.walrus-testnet.walrus.space/v1/blobs/{walrus_blob_id}"));
