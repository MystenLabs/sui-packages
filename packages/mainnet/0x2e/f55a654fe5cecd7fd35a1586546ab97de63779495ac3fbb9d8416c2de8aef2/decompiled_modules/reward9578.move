module 0x2ef55a654fe5cecd7fd35a1586546ab97de63779495ac3fbb9d8416c2de8aef2::reward9578 {
    struct REWARD9578 has drop {
        dummy_field: bool,
    }

    struct TICKET_9578 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9578(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9578>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9578>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9578, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9578>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9578>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9578>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9578>>(v5, 0x2::tx_context::sender(arg1));
    }
