module 0x2e33a93047f829a755a2bdc19d45ebad4d25543f981282543f3cd29de5a043a8::cnsnft2361 {
    struct CNSNFT2361 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2361, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2361>(arg0, arg1);
