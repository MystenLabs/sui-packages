module 0x2ec450b2821d71c1df6ec50cbcc2a4e65d2d9bc8bdf8acf326a1634a44e02291::reward3412 {
    struct REWARD3412 has drop {
        dummy_field: bool,
    }

    struct TICKET_3412 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3412(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3412>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3412>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3412, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3412>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3412>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3412>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3412>>(v5, 0x2::tx_context::sender(arg1));
    }
