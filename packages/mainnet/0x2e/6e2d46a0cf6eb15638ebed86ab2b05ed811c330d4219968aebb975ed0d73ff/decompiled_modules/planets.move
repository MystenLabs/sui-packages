module 0x2e6e2d46a0cf6eb15638ebed86ab2b05ed811c330d4219968aebb975ed0d73ff::planets {
    ...
    fun init(arg0: PLANETS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Planets NFT Collection: A revolutionary drop of 350 unique Planets featuring Arid/Green/Ice biomes, empowering auras with special abilities, Xenomorph/Human/Yautja races, and integrated Portals & Energy Cores."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeicj2qgha5kkrotrkjay2zdpxn3gj6pwv53kkhd4uy44epx6xfd6wa"));
