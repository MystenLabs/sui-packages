module 0x2e84bd32e0c90b7b15b6d0bf4ebbe1922639ca0db3fc31b7e3a236b26c4f9bc3::reward4888 {
    struct REWARD4888 has drop {
        dummy_field: bool,
    }

    struct TICKET_4888 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4888(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4888>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4888>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4888, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4888>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4888>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4888>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4888>>(v5, 0x2::tx_context::sender(arg1));
    }
