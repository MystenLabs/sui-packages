module 0xb81a8531ebcc965130e03f9f8d17a9dcfb3f24982984dfc2fffe055254d1d88f::house {
    ...
    public(friend) fun join_with_fee<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>) {
        let v0 = 0xb81a8531ebcc965130e03f9f8d17a9dcfb3f24982984dfc2fffe055254d1d88f::math::mul_rate(0x2::balance::value<T0>(&arg1), 300000);
    ...
    public fun pool_changes(arg0: u64) : (u64, u64) {
        let v0 = 0xb81a8531ebcc965130e03f9f8d17a9dcfb3f24982984dfc2fffe055254d1d88f::math::mul_rate(arg0, 300000);
        (arg0 - v0, v0)
    }
    ...
    public(friend) fun split_with_reimbursement<T0>(arg0: &mut House<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 <= max_risk<T0>(arg0), 0);
        assert!(arg1 <= 0x2::balance::value<T0>(&arg0.pool), 1);
        let v0 = 0xb81a8531ebcc965130e03f9f8d17a9dcfb3f24982984dfc2fffe055254d1d88f::math::mul_rate(arg1, 300000);
