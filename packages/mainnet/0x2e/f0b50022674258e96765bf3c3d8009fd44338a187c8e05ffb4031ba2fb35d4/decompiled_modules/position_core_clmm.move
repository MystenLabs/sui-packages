module 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_core_clmm {
    ...
    struct CreatePositionTicket<phantom T0, phantom T1, T2> {
        ...
        debt_bag: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag,
    }
    ...
    struct Position<phantom T0, phantom T1, T2> has key {
        ...
        debt_bag: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag,
        collected_fees: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::balance_bag::BalanceBag,
        ticket_active: bool,
        version: u16,
    }
    ...
    struct PositionConfig has key {
        ...
        lend_facil_cap: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::LendFacilCap,
    ...
    struct ReductionRepaymentTicket<phantom T0, phantom T1> {
        sx: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtShare<T0>,
        sy: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtShare<T1>,
        info: ReductionInfo,
    }
    ...
    struct DeleverageInfo has copy, drop {
        position_id: 0x2::object::ID,
        model: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::PositionModel,
    ...
    public(friend) fun calc_liq_fee_from_reward(arg0: &PositionConfig, arg1: u64) : u64 {
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::util::muldiv(arg1, (arg0.liq_bonus_bps as u64) * (arg0.liq_fee_bps as u64), (10000 + (arg0.liq_bonus_bps as u64)) * 10000)
    }
    ...
    public(friend) fun collected_fees_mut<T0, T1, T2>(arg0: &mut Position<T0, T1, T2>) : &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::balance_bag::BalanceBag {
    ...
    public(friend) fun cpt_debt_bag<T0, T1, T2>(arg0: &CreatePositionTicket<T0, T1, T2>) : &0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag {
        &arg0.debt_bag
    }

    public(friend) fun cpt_debt_bag_mut<T0, T1, T2>(arg0: &mut CreatePositionTicket<T0, T1, T2>) : &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag {
        &mut arg0.debt_bag
    }
    ...
    public fun create_empty_config(arg0: 0x2::object::ID, arg1: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::access::ActionRequest) {
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::create_lend_facil_cap(arg1);
        ...
        (0x2::object::id<0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::LendFacilCap>(&v0), 0xa0501135cff2a49568b1fd32407372300f57ebc5949aaabbcc33d16028c58222::access::new_request<ACreateConfig>(v2, arg1))
    }
    ...
    public(friend) fun deleverage_info_constructor(arg0: 0x2::object::ID, arg1: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::PositionModel, arg2: u256, arg3: u128, arg4: u128, arg5: u64, arg6: u64, arg7: u64, arg8: u64) : DeleverageInfo {
        DeleverageInfo{
            position_id         : arg0,
            model               : arg1,
    ...
    public fun deleverage_ticket_repay_x<T0, T1, T2, T3: store>(arg0: &mut Position<T0, T1, T3>, arg1: &PositionConfig, arg2: &mut DeleverageTicket, arg3: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T0, T2>, arg4: &0x2::clock::Clock) {
        assert!(arg2.position_id == 0x2::object::id<Position<T0, T1, T3>>(arg0), 9);
        assert!(arg0.config_id == 0x2::object::uid_to_inner(&arg1.id), 4);
        if (!arg2.can_repay_x) {
            return
        };
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_take_all<T2>(&mut arg0.debt_bag);
        let (_, v2) = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay_max_possible<T0, T2>(arg3, &mut v0, &mut arg0.col_x, arg4);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_add<T0, T2>(&mut arg0.debt_bag, v0);
        arg2.can_repay_x = false;
        arg2.info.x_repaid = v2;
    }

    public fun deleverage_ticket_repay_y<T0, T1, T2, T3: store>(arg0: &mut Position<T0, T1, T3>, arg1: &PositionConfig, arg2: &mut DeleverageTicket, arg3: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T1, T2>, arg4: &0x2::clock::Clock) {
        assert!(arg2.position_id == 0x2::object::id<Position<T0, T1, T3>>(arg0), 9);
        assert!(arg0.config_id == 0x2::object::uid_to_inner(&arg1.id), 4);
        if (!arg2.can_repay_y) {
            return
        ...
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_take_all<T2>(&mut arg0.debt_bag);
        let (_, v2) = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay_max_possible<T1, T2>(arg3, &mut v0, &mut arg0.col_y, arg4);
        arg2.info.y_repaid = v2;
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_add<T1, T2>(&mut arg0.debt_bag, v0);
    ...
    public(friend) fun destroy_create_position_ticket<T0, T1, T2>(arg0: CreatePositionTicket<T0, T1, T2>) : (0x2::object::ID, T2, T2, u64, u64, u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag) {
    ...
    public fun destroy_reduction_ticket<T0, T1>(arg0: ReductionRepaymentTicket<T0, T1>) {
        assert!(0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_value_x64<T0>(&arg0.sx) == 0, 10);
        assert!(0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_value_x64<T1>(&arg0.sy) == 0, 10);
        let ReductionRepaymentTicket {
            sx   : v0,
            sy   : v1,
            info : v2,
        } = arg0;
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_destroy_zero<T0>(v0);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_destroy_zero<T1>(v1);
    ...
    public(friend) fun emit_liquidation_info(arg0: 0x2::object::ID, arg1: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::PositionModel, arg2: u256, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64) {
    ...
    public(friend) fun init_margin_is_valid(arg0: &PositionConfig, arg1: &0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::PositionModel, arg2: u256, arg3: u256) : bool {
        let v0 = ((arg0.min_init_margin_bps as u128) << 64) / 10000;
        if (0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::margin_x64(arg1, arg2) < v0) {
            return false
        };
        if (0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::margin_x64(arg1, arg3) < v0) {
            return false
        };
        true
    }

    public(friend) fun lend_facil_cap(arg0: &PositionConfig) : &0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::LendFacilCap {
        &arg0.lend_facil_cap
    }
    ...
    public(friend) fun liq_margin_is_valid(arg0: &PositionConfig, arg1: &0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::PositionModel, arg2: u256, arg3: u256) : bool {
        let v0 = (arg0.min_liq_start_price_delta_bps as u256);
        let v1 = ((arg0.liq_margin_bps as u128) << 64) / 10000;
        if (0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::margin_x64(arg1, arg2 - arg2 * v0 / 10000) < v1) {
            return false
        };
        if (0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::margin_x64(arg1, arg3 + arg3 * v0 / 10000) < v1) {
            return false
        };
        true
    }
    ...
    public(friend) fun new_create_position_ticket<T0, T1, T2>(arg0: 0x2::object::ID, arg1: T2, arg2: T2, arg3: u64, arg4: u64, arg5: u128, arg6: 0x2::balance::Balance<T0>, arg7: 0x2::balance::Balance<T1>, arg8: 0x2::balance::Balance<T0>, arg9: 0x2::balance::Balance<T1>, arg10: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag) : CreatePositionTicket<T0, T1, T2> {
    ...
    public(friend) fun position_constructor<T0, T1, T2>(arg0: 0x2::object::ID, arg1: T2, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag, arg5: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::balance_bag::BalanceBag, arg6: &mut 0x2::tx_context::TxContext) : Position<T0, T1, T2> {
        Position<T0, T1, T2>{
    ...
    public fun position_debt_bag<T0, T1, T2>(arg0: &Position<T0, T1, T2>) : &0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag {
        &arg0.debt_bag
    }

    public(friend) fun position_debt_bag_mut<T0, T1, T2>(arg0: &mut Position<T0, T1, T2>) : &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtBag {
        &mut arg0.debt_bag
    }
    ...
    public fun rebalance_repay_debt_x<T0, T1, T2, T3: store>(arg0: &mut Position<T0, T1, T3>, arg1: &mut 0x2::balance::Balance<T0>, arg2: &mut RebalanceReceipt, arg3: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T0, T2>, arg4: &0x2::clock::Clock) {
        assert!(arg2.position_id == 0x2::object::id<Position<T0, T1, T3>>(arg0), 9);
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_take_all<T2>(&mut arg0.debt_bag);
        let (_, v2) = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay_max_possible<T0, T2>(arg3, &mut v0, arg1, arg4);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_add<T0, T2>(&mut arg0.debt_bag, v0);
        arg2.x_repaid = arg2.x_repaid + v2;
    }

    public fun rebalance_repay_debt_y<T0, T1, T2, T3: store>(arg0: &mut Position<T0, T1, T3>, arg1: &mut 0x2::balance::Balance<T1>, arg2: &mut RebalanceReceipt, arg3: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T1, T2>, arg4: &0x2::clock::Clock) {
        assert!(arg2.position_id == 0x2::object::id<Position<T0, T1, T3>>(arg0), 9);
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_take_all<T2>(&mut arg0.debt_bag);
        let (_, v2) = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay_max_possible<T1, T2>(arg3, &mut v0, arg1, arg4);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_add<T1, T2>(&mut arg0.debt_bag, v0);
        arg2.y_repaid = arg2.y_repaid + v2;
    }

    public(friend) fun reduction_info_constructor(arg0: 0x2::object::ID, arg1: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::position_model_clmm::PositionModel, arg2: u256, arg3: u128, arg4: u128, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64) : ReductionInfo {
        ReductionInfo{
            position_id         : arg0,
            model               : arg1,
            oracle_price_x128   : arg2,
    ...
    public(friend) fun reduction_repayment_ticket_constructor<T0, T1>(arg0: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtShare<T0>, arg1: 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::FacilDebtShare<T1>, arg2: ReductionInfo) : ReductionRepaymentTicket<T0, T1> {
    ...
    public fun reduction_ticket_calc_repay_amt_x<T0, T1, T2>(arg0: &ReductionRepaymentTicket<T1, T2>, arg1: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T0, T1>, arg2: &0x2::clock::Clock) : u64 {
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::calc_repay_by_shares<T0, T1>(arg1, 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_facil_id<T1>(&arg0.sx), 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_value_x64<T1>(&arg0.sx), arg2)
    }

    public fun reduction_ticket_calc_repay_amt_y<T0, T1, T2>(arg0: &ReductionRepaymentTicket<T1, T2>, arg1: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T0, T2>, arg2: &0x2::clock::Clock) : u64 {
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::calc_repay_by_shares<T0, T2>(arg1, 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_facil_id<T2>(&arg0.sy), 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_value_x64<T2>(&arg0.sy), arg2)
    }

    public fun reduction_ticket_repay_x<T0, T1, T2>(arg0: &mut ReductionRepaymentTicket<T1, T2>, arg1: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        arg0.info.x_repaid = 0x2::balance::value<T0>(&arg2);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay<T0, T1>(arg1, 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_withdraw_all<T1>(&mut arg0.sx), arg2, arg3);
    }

    public fun reduction_ticket_repay_y<T0, T1, T2>(arg0: &mut ReductionRepaymentTicket<T1, T2>, arg1: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T0, T2>, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        arg0.info.y_repaid = 0x2::balance::value<T0>(&arg2);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay<T0, T2>(arg1, 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fds_withdraw_all<T2>(&mut arg0.sy), arg2, arg3);
    }

    public fun repay_debt_x<T0, T1, T2, T3: store>(arg0: &mut Position<T0, T1, T3>, arg1: &PositionCap, arg2: &mut 0x2::balance::Balance<T0>, arg3: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T0, T2>, arg4: &0x2::clock::Clock) {
        check_position_version<T0, T1, T3>(arg0);
        assert!(arg1.position_id == 0x2::object::id<Position<T0, T1, T3>>(arg0), 7);
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_take_all<T2>(&mut arg0.debt_bag);
        let (_, v2) = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay_max_possible<T0, T2>(arg3, &mut v0, arg2, arg4);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_add<T0, T2>(&mut arg0.debt_bag, v0);
    ...
    public fun repay_debt_y<T0, T1, T2, T3: store>(arg0: &mut Position<T0, T1, T3>, arg1: &PositionCap, arg2: &mut 0x2::balance::Balance<T1>, arg3: &mut 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::Pool<T1, T2>, arg4: &0x2::clock::Clock) {
        check_position_version<T0, T1, T3>(arg0);
        assert!(arg1.position_id == 0x2::object::id<Position<T0, T1, T3>>(arg0), 7);
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_take_all<T2>(&mut arg0.debt_bag);
        let (_, v2) = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::repay_max_possible<T1, T2>(arg3, &mut v0, arg2, arg4);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::fdb_add<T1, T2>(&mut arg0.debt_bag, v0);
        let v3 = RepayDebtInfo{
            position_id : 0x2::object::id<Position<T0, T1, T3>>(arg0),
            x_repaid    : 0,
    ...
    public(friend) fun take_rebalance_fee<T0, T1, T2, T3>(arg0: &mut Position<T0, T1, T2>, arg1: u16, arg2: &mut 0x2::balance::Balance<T3>, arg3: &mut RebalanceReceipt) {
        let v0 = 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::util::muldiv(0x2::balance::value<T3>(arg2), (arg1 as u64), 10000);
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::balance_bag::add<T3>(&mut arg0.collected_fees, 0x2::balance::split<T3>(arg2, v0));
    ...
    public(friend) fun validate_debt_info(arg0: &PositionConfig, arg1: &0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::debt_info::DebtInfo) : 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::debt_info::ValidatedDebtInfo {
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::debt_info::validate(arg1, 0x2::object::id<0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::supply_pool::LendFacilCap>(&arg0.lend_facil_cap))
    }

    public(friend) fun validate_price_info(arg0: &PositionConfig, arg1: &0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::pyth::PythPriceInfo) : 0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::pyth::ValidatedPythPriceInfo {
        let v0 = 0x2::bag::borrow<0x1::type_name::TypeName, PythConfig>(&arg0.allowed_oracles, 0x1::type_name::get<PythConfig>());
        0x2ef0b50022674258e96765bf3c3d8009fd44338a187c8e05ffb4031ba2fb35d4::pyth::validate(arg1, v0.max_age_secs, &v0.pio_allowlist)
    }
