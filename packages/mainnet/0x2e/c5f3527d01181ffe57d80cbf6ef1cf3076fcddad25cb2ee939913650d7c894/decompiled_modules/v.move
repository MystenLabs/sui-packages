module 0x8939f0b2d43a66890ee4f0676c5ba5207f5daecc8c96d8d1166bbb72c549d885::v {
    ...
    public fun wa<T0>(arg0: &mut V<T0>, arg1: u64, arg2: &0x8939f0b2d43a66890ee4f0676c5ba5207f5daecc8c96d8d1166bbb72c549d885::a::AC, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.b, arg1), arg3), 0x2::tx_context::sender(arg3));
    }
