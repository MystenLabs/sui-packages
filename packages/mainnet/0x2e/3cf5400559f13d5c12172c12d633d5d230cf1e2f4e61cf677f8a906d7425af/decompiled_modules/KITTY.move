module 0x2e3cf5400559f13d5c12172c12d633d5d230cf1e2f4e61cf677f8a906d7425af::KITTY {
    ...
    fun init(arg0: KITTY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<KITTY>(arg0, 9, b"TRUMP", b"Donald Trump", b"Donald Trump winner fund", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
