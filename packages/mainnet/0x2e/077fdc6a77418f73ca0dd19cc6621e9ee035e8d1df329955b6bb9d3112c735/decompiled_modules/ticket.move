module 0x2e077fdc6a77418f73ca0dd19cc6621e9ee035e8d1df329955b6bb9d3112c735::ticket {
    ...
    public fun create_share(arg0: vector<vector<u8>>, arg1: vector<u8>, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(@0xe666e6e477325728a57870363560362cfeb8283163f2dae47cd7f70cdb63fff != @0x0, 20);
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg7) == v3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg7, @0xe666e6e477325728a57870363560362cfeb8283163f2dae47cd7f70cdb63fff);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg7, v3, arg8), @0xe666e6e477325728a57870363560362cfeb8283163f2dae47cd7f70cdb63fff);
    ...
    public fun get_dev_wallet() : address {
        @0xe666e6e477325728a57870363560362cfeb8283163f2dae47cd7f70cdb63fff
    }
