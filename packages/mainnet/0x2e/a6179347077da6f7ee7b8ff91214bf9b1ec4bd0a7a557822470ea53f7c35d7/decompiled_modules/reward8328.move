module 0x2ea6179347077da6f7ee7b8ff91214bf9b1ec4bd0a7a557822470ea53f7c35d7::reward8328 {
    struct REWARD8328 has drop {
        dummy_field: bool,
    }

    struct TICKET_8328 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8328(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8328>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8328>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8328, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8328>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8328>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8328>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8328>>(v5, 0x2::tx_context::sender(arg1));
    }
