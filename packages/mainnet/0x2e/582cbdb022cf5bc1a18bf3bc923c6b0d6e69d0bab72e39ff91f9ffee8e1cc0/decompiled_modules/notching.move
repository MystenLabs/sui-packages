module 0x2e582cbdb022cf5bc1a18bf3bc923c6b0d6e69d0bab72e39ff91f9ffee8e1cc0::notching {
    struct NOTCHING has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NOTCHING, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NOTCHING>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Notching"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Notching $Notch"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibclvce4mzonvqrxmntnagzu76rge4eqjh25auhhoninpfustze5e"));
