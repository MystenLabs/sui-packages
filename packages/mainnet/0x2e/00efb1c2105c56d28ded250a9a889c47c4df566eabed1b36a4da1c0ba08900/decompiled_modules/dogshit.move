module 0x2e00efb1c2105c56d28ded250a9a889c47c4df566eabed1b36a4da1c0ba08900::dogshit {
    ...
    fun init(arg0: DOGSHIT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/8AKBy6SkaerTMWZAad47yQxZnvrEk59DvhcHLHUsbonk.png?size=lg&key=2ea3e5                                                                                                                                                                                                            ");
