module 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::cetus_manager {
    ...
    public entry fun transfer_positions_to_admin_v2<T0, T1>(arg0: &mut CetusManager<T0, T1>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::length<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v0.positions) > 0) {
            while (!0x1::vector::is_empty<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v0.positions)) {
                let v1 = 0x1::vector::remove<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut v0.positions, 0);
                0x2::transfer::public_transfer<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v1, @0x668fe68cc71fc5741c427bd6539617c7e3265457dae598faadff782a37bcfcf9);
                let v2 = PositionClosed{
                    position_id : 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v1),
                    is_core     : arg1,
                };
                0x2::event::emit<PositionClosed>(v2);
            };
        };
    }
