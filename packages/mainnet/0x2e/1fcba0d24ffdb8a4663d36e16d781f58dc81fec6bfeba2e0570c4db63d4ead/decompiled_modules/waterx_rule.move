module 0x1f1207ccde07c5c1c2c7395d0f5771370bf7e8a99acf28f0a341fbd1ed3f3384::waterx_rule {
    ...
    struct BboFeedConfigured has copy, drop {
    ...
    public fun is_bbo_method(arg0: &0x1::string::String) : bool {
        *arg0 == 0x1::string::utf8(b"bbo_consensus_v1")
    }

    public fun is_bbo_source(arg0: u64) : bool {
        if (arg0 == 1001) {
            true
        } else if (arg0 == 1002) {
            true
    ...
    public fun is_supported_method(arg0: &0x1::string::String) : bool {
        if (is_bbo_method(arg0)) {
            true
        } else if (*arg0 == 0x1::string::utf8(b"direct")) {
            true
        } else if (*arg0 == 0x1::string::utf8(b"median")) {
            true
        } else {
    ...
    public fun method_bbo_consensus() : 0x1::string::String {
        0x1::string::utf8(b"bbo_consensus_v1")
    }
    ...
    public fun quote_for_timestamp(arg0: &Config, arg1: &0x2::clock::Clock, arg2: &0xbce5b23dc3bca7b514adc36954cd01ac5227d17c2e7764c36e9b3808364c6693::enclave::EnclaveConfig<WATERX_RULE>, arg3: &0xbce5b23dc3bca7b514adc36954cd01ac5227d17c2e7764c36e9b3808364c6693::enclave::Enclave<WATERX_RULE>, arg4: 0x1::string::String, arg5: u64, arg6: u64, arg7: BatchPricePayload, arg8: &vector<u8>) : VerifiedPrice {
        ...
        if (!0xbce5b23dc3bca7b514adc36954cd01ac5227d17c2e7764c36e9b3808364c6693::enclave::verify_signature<WATERX_RULE, BatchPricePayload>(arg3, arg2, 1, arg5, arg7, arg8)) {
            abort 13906836824338202625
        };
        let v0 = *0x1::vector::borrow<BatchPriceItem>(&arg7.items, 0);
        if (v0.symbol != arg4) {
            abort 13906836845815922733
        };
    ...
    public fun set_bbo_feed(arg0: &mut Config, arg1: &0xd6fd5fa8be2f2cb3042fbb11f31f26c27280676f6a08681b16cbb5e4cb64f24e::oracle::ListingCap, arg2: 0x1::string::String, arg3: vector<u64>, arg4: u64, arg5: u64, arg6: u64, arg7: u8) {
        set_feed_with_limits(arg0, arg1, arg2, arg2, arg3, 0x1::string::utf8(b"bbo_consensus_v1"), arg4, arg5, arg6, arg7);
        let v0 = BboFeedConfigured{
            config_id : 0x2::object::id<Config>(arg0),
            symbol    : arg2,
            feed      : *0x2::vec_map::get<0x1::string::String, FeedConfig>(&arg0.feed_map, &arg2),
        };
        0x2::event::emit<BboFeedConfigured>(v0);
    }
    ...
    public fun set_feed(arg0: &mut Config, arg1: &0xd6fd5fa8be2f2cb3042fbb11f31f26c27280676f6a08681b16cbb5e4cb64f24e::oracle::ListingCap, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<u64>, arg5: 0x1::string::String, arg6: u64) {
        assert!(!is_bbo_method(&arg5), 13906837477174935579);
    ...
    fun set_feed_with_limits(arg0: &mut Config, arg1: &0xd6fd5fa8be2f2cb3042fbb11f31f26c27280676f6a08681b16cbb5e4cb64f24e::oracle::ListingCap, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<u64>, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: u64, arg9: u8) {
        if (0x1::string::is_empty(&arg2)) {
            abort 13906837829360943111
        };
        if (0x1::string::is_empty(&arg3)) {
            abort 13906837842245844999
        };
        if (0x1::vector::is_empty<u64>(&arg4)) {
            abort 13906837855131533331
        };
        if (!are_supported_sources(&arg4)) {
            abort 13906837868015386627
        };
        if (has_duplicate_source(&arg4)) {
            abort 13906837880900419589
        };
        if (!is_supported_method(&arg5)) {
            abort 13906837893786763291
        };
        if (is_bbo_method(&arg5)) {
            let v0 = &arg4;
            let v1 = 0;
            let v2;
            while (v1 < 0x1::vector::length<u64>(v0)) {
                if (!is_bbo_source(*0x1::vector::borrow<u64>(v0, v1))) {
                    v2 = false;
                    /* label 23 */
                    assert!(v2, 13906837906670092291);
                    assert!(arg2 == arg3, 13906837910965714957);
                    assert!(0x1::vector::length<u64>(&arg4) <= 255 && (arg9 as u64) <= 0x1::vector::length<u64>(&arg4), 13906837915261075475);
                    /* label 35 */
                    if (arg6 == 0) {
                        abort 13906837936735256585
                    };
                    if (arg7 > 10000 || arg8 > 10000) {
                        abort 13906837949620158473
                    };
                    if (arg9 == 0) {
                        abort 13906837962505715731
                    };
                    let v3 = FeedConfig{
                        ticker                   : arg3,
                        sources                  : arg4,
                    ...
                    let v4 = &mut arg0.feed_map;
                    if (0x2::vec_map::contains<0x1::string::String, FeedConfig>(v4, &arg2)) {
                        *0x2::vec_map::get_mut<0x1::string::String, FeedConfig>(v4, &arg2) = v3;
                    } else {
                        0x2::vec_map::insert<0x1::string::String, FeedConfig>(v4, arg2, v3);
                    };
                    return
                };
                v1 = v1 + 1;
            ...
            while (v6 < 0x1::vector::length<u64>(v5)) {
                if (is_bbo_source(*0x1::vector::borrow<u64>(v5, v6))) {
                    v7 = true;
                    /* label 59 */
                    assert!(!v7, 13906837923849961475);
                    /* goto 35 */
                } else {
                    v6 = v6 + 1;
                };
    ...
    public fun set_perp_feed(arg0: &mut Config, arg1: &0xd6fd5fa8be2f2cb3042fbb11f31f26c27280676f6a08681b16cbb5e4cb64f24e::oracle::ListingCap, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<u64>, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: u64, arg9: u8) {
        if (!are_perp_sources(&arg4)) {
            abort 13906837691923038231
        };
        if (!is_perp_method(&arg5)) {
            abort 13906837704808202267
        };
    ...
    fun validate_batch_shape(arg0: &BatchPricePayload) {
        ...
        if (v1 == 0) {
            abort 13906839749213421607
        };
        if (v1 > 32) {
            abort 13906839762098454569
        };
        let v2 = 0;
        while (v2 < v1) {
            let v3 = v2 + 1;
