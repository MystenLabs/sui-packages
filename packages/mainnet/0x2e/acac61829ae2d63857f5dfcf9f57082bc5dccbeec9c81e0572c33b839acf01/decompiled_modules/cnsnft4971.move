module 0x2eacac61829ae2d63857f5dfcf9f57082bc5dccbeec9c81e0572c33b839acf01::cnsnft4971 {
    struct CNSNFT4971 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4971, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4971>(arg0, arg1);
