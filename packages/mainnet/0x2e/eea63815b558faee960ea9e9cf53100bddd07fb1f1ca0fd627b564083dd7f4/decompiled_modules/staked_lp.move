module 0x2eeea63815b558faee960ea9e9cf53100bddd07fb1f1ca0fd627b564083dd7f4::staked_lp {
    ...
    public fun into_token<T0>(arg0: StakedLP<T0>, arg1: &0x2::clock::Clock, arg2: &0x2::token::TokenPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg1) >= v2, 0x2eeea63815b558faee960ea9e9cf53100bddd07fb1f1ca0fd627b564083dd7f4::errors::lp_stake_time_not_passed());
        0x2::object::delete(v0);
        0x2eeea63815b558faee960ea9e9cf53100bddd07fb1f1ca0fd627b564083dd7f4::token_ir::from_balance<T0>(arg2, v1, arg3)
    }
