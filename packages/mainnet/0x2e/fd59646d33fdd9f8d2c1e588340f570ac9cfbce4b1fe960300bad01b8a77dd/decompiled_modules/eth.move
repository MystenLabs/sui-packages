module 0x2efd59646d33fdd9f8d2c1e588340f570ac9cfbce4b1fe960300bad01b8a77dd::eth {
    struct ETH has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ETH, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v1;
        0x2::coin::mint_and_transfer<ETH>(&mut v3, 0x1::u64::pow(10, v0 + 1), 0x2::tx_context::sender(arg1), arg1);
        let v4 = Treasury{
