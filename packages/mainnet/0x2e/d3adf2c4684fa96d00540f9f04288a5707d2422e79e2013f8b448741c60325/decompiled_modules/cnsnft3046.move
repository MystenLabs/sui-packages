module 0x2ed3adf2c4684fa96d00540f9f04288a5707d2422e79e2013f8b448741c60325::cnsnft3046 {
    struct CNSNFT3046 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3046, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3046>(arg0, arg1);
