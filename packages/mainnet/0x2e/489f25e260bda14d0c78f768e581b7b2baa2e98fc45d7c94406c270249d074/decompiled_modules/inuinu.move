module 0x2e489f25e260bda14d0c78f768e581b7b2baa2e98fc45d7c94406c270249d074::inuinu {
    ...
    fun init(arg0: INUINU, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<INUINU>(arg0, 9, b"INUINU", b"InuInu", b"Woof woof", 0x1::option::none<0x2::url::Url>(), arg1);
