module 0x2e42a5d8a9fc3aa4ccba79191aa51216103b44ec34504059ae8f472a40558ccc::cnsnft7666 {
    struct CNSNFT7666 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7666, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7666>(arg0, arg1);
