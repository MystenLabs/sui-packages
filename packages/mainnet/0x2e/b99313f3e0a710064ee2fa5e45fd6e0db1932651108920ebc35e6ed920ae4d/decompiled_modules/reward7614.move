module 0x2eb99313f3e0a710064ee2fa5e45fd6e0db1932651108920ebc35e6ed920ae4d::reward7614 {
    struct REWARD7614 has drop {
        dummy_field: bool,
    }

    struct TICKET_7614 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7614(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7614>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7614>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7614, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7614>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7614>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7614>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7614>>(v5, 0x2::tx_context::sender(arg1));
    }
