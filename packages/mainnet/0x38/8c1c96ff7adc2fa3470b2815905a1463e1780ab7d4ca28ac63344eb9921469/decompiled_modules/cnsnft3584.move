module 0x388c1c96ff7adc2fa3470b2815905a1463e1780ab7d4ca28ac63344eb9921469::cnsnft3584 {
    struct CNSNFT3584 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3584, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3584>(arg0, arg1);
