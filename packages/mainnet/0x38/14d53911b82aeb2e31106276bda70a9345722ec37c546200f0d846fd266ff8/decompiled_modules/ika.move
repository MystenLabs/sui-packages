module 0x3814d53911b82aeb2e31106276bda70a9345722ec37c546200f0d846fd266ff8::ika {
    struct IKA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IKA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<IKA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ika"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"IKA NFTs represent cutting-edge digital artwork, blending futuristic design with unique, collectible features. Each piece is a one-of-a-kind, offering owners a slice of the digital future. Immerse yourself in vibrant visuals, exclusive utility, and a seamless experience that bridges art with technology."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeicola5w5g2ztkynblf7dy66gqms5mjim6iqhzohtzrj7smfcf464q"));
