module 0x382200678f4af3c7d7db2e04d08c4379851f38d5d828acfd56e79781a696fe19::cnsnft2262 {
    struct CNSNFT2262 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2262, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2262>(arg0, arg1);
