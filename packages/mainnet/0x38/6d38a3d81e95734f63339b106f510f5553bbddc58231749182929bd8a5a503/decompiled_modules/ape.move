module 0x9856a56bdb1071c3f8f8c19c5108b73ac90c9802a317254a16ff07c02777d6e::ape {
    ...
    public fun remove_from_kiosk(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : (Ape, 0x2::transfer_policy::TransferRequest<Ape>) {
        0x2::kiosk::list<Ape>(arg0, arg1, arg2, 0);
        0x2::kiosk::purchase<Ape>(arg0, arg2, 0x2::coin::zero<0x2::sui::SUI>(arg3))
    }

    public fun remove_from_personal_kiosk(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : (Ape, 0x2::transfer_policy::TransferRequest<Ape>) {
        0x2::kiosk::list<Ape>(arg0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg1), arg2, 0);
        0x2::kiosk::purchase<Ape>(arg0, arg2, 0x2::coin::zero<0x2::sui::SUI>(arg3))
    }
