module 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::avatar {
    ...
    struct AvatarSettingsV2 has key {
        id: 0x2::object::UID,
        edition: 0x1::string::String,
        image_url: 0x1::string::String,
        avatar_model: 0x1::string::String,
    ...
    fun assert_check_ac(arg0: &AvatarSettingsV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl) {
        ...
        assert!(arg0.access_control == 0x2::object::id_to_address(&v0), 6);
    }
    ...
    public fun equip_cosmetic_v2(arg0: &mut Avatar, arg1: &0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::profile_pictures::ProfilePicturesV2, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::Cosmetic>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        *0x2::vec_map::get_mut<0x1::string::String, vector<u8>>(&mut arg0.attributes_hash, &arg3) = v3;
        let v4 = if (arg3 == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::helm()) {
            true
        } else if (arg3 == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::upper_torso()) {
            true
        } else {
            arg3 == 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::chestpiece()
        };
        if (v4) {
            update_image_v2(arg0, arg1);
        };
    }
    ...
    public entry fun fix_boots_avatar(arg0: &mut Avatar) {
        let v0 = CosmeticKey{pos0: 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::boots()};
        if (0x2::dynamic_object_field::exists_<CosmeticKey>(&arg0.id, v0)) {
            let v1 = CosmeticKey{pos0: 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::boots()};
            0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::fix_boots(0x2::dynamic_object_field::borrow_mut<CosmeticKey, 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::Cosmetic>(&mut arg0.id, v1));
        };
    }
    ...
    public fun migrate(arg0: AvatarSettings, arg1: &mut 0x2::tx_context::TxContext) {
        let AvatarSettings {
            id             : v0,
            edition        : v1,
            image_url      : v2,
        ...
        0x2::transfer::share_object<AvatarSettingsV2>(v6);
    }
    ...
    public fun new_v2(arg0: &AvatarSettingsV2, arg1: &mut 0x2::tx_context::TxContext) : Avatar {
    ...
    public fun set_settings_active_v2(arg0: &mut AvatarSettingsV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: bool) {
    ...
    public fun set_settings_avatar_model_v2(arg0: &mut AvatarSettingsV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: 0x1::string::String) {
        assert_check_ac(arg0, arg1);
        0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::admin::assert_genesis_minter_role(arg1, arg2);
        arg0.avatar_model = arg3;
    }
    ...
    public fun set_settings_avatar_texture_v2(arg0: &mut AvatarSettingsV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: 0x1::string::String) {
        assert_check_ac(arg0, arg1);
        0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::admin::assert_genesis_minter_role(arg1, arg2);
        arg0.avatar_texture = arg3;
    }
    ...
    public fun set_settings_edition_v2(arg0: &mut AvatarSettingsV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: 0x1::string::String) {
        assert_check_ac(arg0, arg1);
        0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::admin::assert_genesis_minter_role(arg1, arg2);
        arg0.edition = arg3;
    }
    ...
    public fun set_settings_image_url_v2(arg0: &mut AvatarSettingsV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: 0x1::string::String) {
        assert_check_ac(arg0, arg1);
        0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::admin::assert_genesis_minter_role(arg1, arg2);
        arg0.image_url = arg3;
    }
    ...
    public fun unequip_cosmetics_v2(arg0: &mut Avatar, arg1: &0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::profile_pictures::ProfilePicturesV2, arg2: vector<0x1::string::String>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::Cosmetic>) {
    ...
    public fun update_image_v2(arg0: &mut Avatar, arg1: &0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::profile_pictures::ProfilePicturesV2) {
        ...
        arg0.image_url = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::profile_pictures::get_v2(arg1, *0x2::vec_map::get<0x1::string::String, vector<u8>>(&arg0.attributes_hash, &v0), *0x2::vec_map::get<0x1::string::String, vector<u8>>(&arg0.attributes_hash, &v1), *0x2::vec_map::get<0x1::string::String, vector<u8>>(&arg0.attributes_hash, &v2));
    }
