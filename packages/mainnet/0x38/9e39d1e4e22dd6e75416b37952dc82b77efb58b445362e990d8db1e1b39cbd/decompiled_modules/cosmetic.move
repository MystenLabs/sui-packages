module 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic {
    ...
    public(friend) fun fix_boots(arg0: &mut Cosmetic) {
        let v0 = if (arg0.name == 0x1::string::utf8(b"Fang MK IV")) {
            if (arg0.colour_way == 0x1::string::utf8(b"Digital Winter")) {
                if (arg0.image_url == 0x1::string::utf8(b"QmYRL4Ws5DjjFywLzibgqLa3NSNDZinKNxn3xQZUywVrv3")) {
                    arg0.type == 0x1::string::utf8(b"Boots")
                } else {
                    false
                }
            } else {
        ...
        if (v0) {
            ...
            let (v1, v2, v3) = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::uris::get_other(b"Fang MK IV", b"Boots", b"Hikari");
            ...
            0x1::vector::append<u8>(&mut v4, b"Boots");
            0x1::vector::append<u8>(&mut v4, b"Hikari");
            arg0.hash = 0x2::hash::blake2b256(&v4);
        };
    }

    public entry fun fix_boots_personal_kiosk(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap) {
