module 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_drop {
    ...
    public fun admin_mint_to_kiosk_v2(arg0: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg2: &mut 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop::GenesisShopV2, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::Cosmetic>, arg6: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::weapon::Weapon>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg1);
        let v1 = if (0x2::object::id_to_address(&v0) == @0xa6a06785a010803d77c10b0318999368e0e309709cdbc77ca52cfc8a6a439a66) {
            true
        } else {
            let v2 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg1);
            0x2::object::id_to_address(&v2) == @0xaf220903a8e40f818a69a4c69c8c4704af979d50148d723d25aec9f688408274
        };
        assert!(v1, 9);
    ...
    fun assert_can_mint(arg0: &SaleV2, arg1: vector<GenesisPass>, arg2: u64, arg3: u64, arg4: u64) {
    ...
    public fun migrate_sale(arg0: Sale, arg1: &mut 0x2::tx_context::TxContext) {
        let Sale {
            id          : v0,
            active      : v1,
            start_times : v2,
        ...
        0x2::transfer::share_object<SaleV2>(v6);
    }
    ...
    public fun mint_to_avatar_v2(arg0: &mut SaleV2, arg1: &mut 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop::GenesisShopV2, arg2: vector<GenesisPass>, arg3: &0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::profile_pictures::ProfilePictures, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::avatar::Avatar {
        abort 0
    }

    public fun mint_to_avatar_v3(arg0: &mut SaleV2, arg1: &mut 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop::GenesisShopV2, arg2: vector<GenesisPass>, arg3: &0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::profile_pictures::ProfilePicturesV2, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::avatar::Avatar {
        ...
        while (!0x1::vector::is_empty<0x1::string::String>(&v0)) {
            let v2 = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop::borrow_item_mut_v2(arg1, 0x1::vector::pop_back<0x1::string::String>(&mut v0));
        ...
        while (!0x1::vector::is_empty<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop::Item>(&v1)) {
            ...
            let v17 = if (v10 != 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::primary()) {
                if (v10 != 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::secondary()) {
                    v10 != 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::tertiary()
                } else {
                    false
                }
            } else {
            ...
            if (v17) {
                let v18 = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::new(v8, v9, v14, v15, v16, v10, v11, 0x1::string::utf8(b"Genesis"), v12, v13, 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::pseuso_random::rng(0, 1000000000, arg5, arg6), arg6);
                0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::fix_legs(&mut v18);
                0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::avatar::equip_minted_cosmetic(&mut v4, v18);
                continue
            };
        ...
        0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::avatar::set_image(&mut v4, 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::profile_pictures::get_v2(arg3, v7, v6, v5));
        v4
    }
    ...
    fun mint_to_kiosk_impl(arg0: &mut 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop::GenesisShopV2, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::Cosmetic>, arg4: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::weapon::Weapon>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg5 > 0) {
            ...
            while (!0x1::vector::is_empty<0x1::string::String>(&v0)) {
                ...
                let v12 = if (v5 != 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::primary()) {
                    if (v5 != 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::secondary()) {
                        v5 != 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::attributes::tertiary()
                    } else {
                        false
                    }
                } else {
                ...
                if (v12) {
                    let v13 = 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::new(v3, v4, v9, v10, v11, v5, v6, 0x1::string::utf8(b"Genesis"), v7, v8, 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::pseuso_random::rng(0, 1000000000, arg6, arg7), arg7);
                    0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::fix_legs(&mut v13);
                    0x2::kiosk::lock<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::Cosmetic>(arg1, arg2, arg3, v13);
                    continue
                };
    ...
    public fun mint_to_kiosk_v2(arg0: &mut SaleV2, arg1: &mut 0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::genesis_shop::GenesisShopV2, arg2: vector<GenesisPass>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::cosmetic::Cosmetic>, arg6: &0x2::transfer_policy::TransferPolicy<0x75cab45b9cba2d0b06a91d1f5fa51a4569da07374cf42c1bd2802846a61efe33::weapon::Weapon>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    public fun set_active_v2(arg0: &mut SaleV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: bool) {
        let v0 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg2);
        let v1 = if (0x2::object::id_to_address(&v0) == @0xa6a06785a010803d77c10b0318999368e0e309709cdbc77ca52cfc8a6a439a66) {
            true
        } else {
            let v2 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg2);
            0x2::object::id_to_address(&v2) == @0xaf220903a8e40f818a69a4c69c8c4704af979d50148d723d25aec9f688408274
        };
        assert!(v1, 9);
    ...
    public fun set_drops_left_v2(arg0: &mut SaleV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: u64) {
        let v0 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg2);
        let v1 = if (0x2::object::id_to_address(&v0) == @0xa6a06785a010803d77c10b0318999368e0e309709cdbc77ca52cfc8a6a439a66) {
            true
        } else {
    ...
    public fun set_max_mints_v2(arg0: &mut SaleV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: vector<u64>) {
        let v0 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg2);
        let v1 = if (0x2::object::id_to_address(&v0) == @0xa6a06785a010803d77c10b0318999368e0e309709cdbc77ca52cfc8a6a439a66) {
            true
        } else {
    ...
    public fun set_prices_v2(arg0: &mut SaleV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: vector<u64>) {
        let v0 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg2);
        let v1 = if (0x2::object::id_to_address(&v0) == @0xa6a06785a010803d77c10b0318999368e0e309709cdbc77ca52cfc8a6a439a66) {
            true
        } else {
    ...
    public fun set_start_times_v2(arg0: &mut SaleV2, arg1: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::AccessControl, arg2: &0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin, arg3: vector<u64>) {
        let v0 = 0x2::object::id<0xa51314ed1206259abaa92da73c5b685082755e3b7797462a879033d06eb0a60c::access_control::Admin>(arg2);
        let v1 = if (0x2::object::id_to_address(&v0) == @0xa6a06785a010803d77c10b0318999368e0e309709cdbc77ca52cfc8a6a439a66) {
            true
        } else {
