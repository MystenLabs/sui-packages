module 0x38b2b3f8722e6e54c44cba985da01be7fbddd730482d72ced4d74e47361c7115::cnsnft1111 {
    struct CNSNFT1111 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1111, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1111>(arg0, arg1);
