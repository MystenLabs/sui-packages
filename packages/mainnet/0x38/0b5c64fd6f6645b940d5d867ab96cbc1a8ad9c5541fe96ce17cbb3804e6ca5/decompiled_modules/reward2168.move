module 0x380b5c64fd6f6645b940d5d867ab96cbc1a8ad9c5541fe96ce17cbb3804e6ca5::reward2168 {
    struct REWARD2168 has drop {
        dummy_field: bool,
    }

    struct TICKET_2168 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2168(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2168>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2168>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2168, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2168>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2168>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2168>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2168>>(v5, 0x2::tx_context::sender(arg1));
    }
