module 0x38ec04c2895b4298433a5077941c08ce49b5e9f1c90852969bcec1245cc5f229::yuki {
    struct YUKI has drop {
        dummy_field: bool,
    }

    fun init(arg0: YUKI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<YUKI>(arg0, 6, b"YUKI", b"LOFI's Son $YUKI", b"$YUKI is a cute little fluffy furred Yeti and LOFI's son , he's stepping into Water chain as his Dad", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafkreidcjaidw5dkz2y34ymglrlkvnrmpcjvcai7wljnaypxdrtgjllk6m")), arg1);
