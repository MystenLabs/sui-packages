module 0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::bidding {
    ...
    fun close_bid_<T0>(arg0: &mut Bid<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::BidCommission<T0>>(&arg0.commission)) {
            let (v3, _) = 0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::destroy_bid_commission<T0>(0x1::option::extract<0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::BidCommission<T0>>(&mut arg0.commission));
    ...
    public fun create_bid<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = new_bid<T0>(arg0, arg1, arg2, 0x1::option::none<0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::BidCommission<T0>>(), arg3, arg4);
    ...
    public fun create_bid_with_commission<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: address, arg4: u64, arg5: &mut 0x2::coin::Coin<T0>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x1::option::some<0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::BidCommission<T0>>(0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::new_bid_commission<T0>(arg3, 0x2::balance::split<T0>(0x2::coin::balance_mut<T0>(arg5), arg4)));
        let v1 = new_bid<T0>(arg0, arg1, arg2, v0, arg5, arg6);
        0x2::transfer::share_object<Bid<T0>>(v1);
        0x2::object::id<Bid<T0>>(&v1)
    }

    public fun new_bid<T0>(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u64, arg3: 0x1::option::Option<0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::BidCommission<T0>>, arg4: &mut 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : Bid<T0> {
        assert!(arg2 != 0, 2);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = if (0x1::option::is_some<0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::BidCommission<T0>>(&arg3)) {
            0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::bid_commission_amount<T0>(0x1::option::borrow<0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::BidCommission<T0>>(&arg3))
        } else {
            0
        };
        let v2 = Bid<T0>{
    ...
    fun sell_nft_common<T0: store + key, T1>(arg0: &mut Bid<T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0>, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0> {
        ...
        0x381bc6b9fd89d748226db81e98e6c22c6246c37d4a13acefc862e4a70c73a788::trading::transfer_bid_commission<T1>(&mut arg0.commission, arg4);
