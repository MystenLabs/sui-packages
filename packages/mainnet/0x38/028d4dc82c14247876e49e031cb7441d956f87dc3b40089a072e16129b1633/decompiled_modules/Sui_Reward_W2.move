module 0x38028d4dc82c14247876e49e031cb7441d956f87dc3b40089a072e16129b1633::Sui_Reward_W2 {
    struct SUI_REWARD_W2 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun GiveReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUI_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmVtK1p8fU1QJWtceQ6qheJZqb9nbuyrAUTJbUwyv4Mf45"),
            };
    ...
    fun init(arg0: SUI_REWARD_W2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmVtK1p8fU1QJWtceQ6qheJZqb9nbuyrAUTJbUwyv4Mf45"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui"));
        let v4 = 0x2::package::claim<SUI_REWARD_W2>(arg0, arg1);
