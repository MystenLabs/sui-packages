module 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::master_chef {
    ...
    public entry fun add_pool<T0>(arg0: &MasterChefAdmin, arg1: &mut MasterChefStorage, arg2: &mut AccountStorage, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::utils::get_coin_info_string<T0>();
    ...
    public fun get_pending_rewards<T0>(arg0: &MasterChefStorage, arg1: &AccountStorage, arg2: &0x2::clock::Clock, arg3: address) : u256 {
        ...
        if (v3 > v0.last_reward_timestamp) {
            let v7 = if (v6) {
                0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fdiv_u256(((v3 - v0.last_reward_timestamp) as u256) * (arg0.sip_per_ms as u256) * (v0.allocation_points as u256) / (arg0.total_allocation_points as u256), (v0.balance_value as u256))
            } else {
        ...
        if (v6) {
            0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fmul_u256(v2, v5) - v1.rewards_paid
        } else {
    ...
    fun get_pool_key<T0>(arg0: &MasterChefStorage) : u64 {
        0x2::table::borrow<0x1::ascii::String, PoolKey>(&arg0.pool_keys, 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::utils::get_coin_info_string<T0>()).key
    }

    public fun get_rewards<T0>(arg0: &mut MasterChefStorage, arg1: &mut AccountStorage, arg2: &mut 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIPStorage, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIP> {
        ...
        let v3 = if (v2) {
            0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fmul_u256(((v1.balance as u256) as u256), v0.accrued_sip_per_share)
        } else {
        ...
        assert!(v4 != 0, 3);
        let v5 = if (v2) {
            0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fmul_u256((v1.balance as u256), v0.accrued_sip_per_share)
        } else {
            (v1.balance as u256) * v0.accrued_sip_per_share
        };
        v1.rewards_paid = v5;
        0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::mint(arg2, &arg0.publisher, (v4 as u64), arg4)
    }
    ...
    fun init(arg0: MASTER_CHEF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, PoolKey>(&mut v1, 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::utils::get_coin_info_string<0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIP>(), v3);
    ...
    public fun stake(arg0: &mut MasterChefStorage, arg1: &mut MasterChefBalanceStorage, arg2: &mut AccountStorage, arg3: &mut 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIPStorage, arg4: address, arg5: &0x2::clock::Clock, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIP> {
        ...
        if (v9 > 0) {
            let v10 = if (v7) {
                0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fmul_u256(v9, v5.accrued_sip_per_share)
            } else {
        ...
        let v11 = if (v7) {
            0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fmul_u256((v6.balance as u256), v5.accrued_sip_per_share)
        } else {
        ...
        0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::mint(arg3, &arg0.publisher, (v8 as u64), arg7)
    }
    ...
    public fun unstake(arg0: &mut MasterChefStorage, arg1: &mut MasterChefBalanceStorage, arg2: &mut AccountStorage, arg3: &mut 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIPStorage, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIP>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        assert!(v4 >= arg5, 2);
        let v5 = if (v3) {
            0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fmul_u256((v4 as u256), v1.accrued_sip_per_share)
        } else {
        ...
        let v7 = if (v3) {
            0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fmul_u256((v2.balance as u256), v1.accrued_sip_per_share)
        } else {
        ...
        (0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::mint(arg3, &arg0.publisher, (v6 as u64), arg6), 0x2::coin::take<0x2::sui::SUI>(&mut arg1.balance, arg5, arg6))
    }
    ...
    fun update_pool_internal(arg0: &mut Pool, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64) {
        ...
        let v1 = if (arg0.pool_key == 0) {
            0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::math::fdiv_u256((arg0.allocation_points as u256) * ((v0 - arg0.last_reward_timestamp) as u256) * (arg2 as u256) / (arg3 as u256), (arg0.balance_value as u256))
        } else {
    ...
    fun update_sip_pool(arg0: &mut MasterChefStorage) {
        ...
        let v1 = borrow_mut_pool<0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::sip::SIP>(arg0);
