module 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::utils {
    ...
    fun compare_struct<T0, T1>() : u8 {
        ...
        let v2 = 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::comparator::compare_u8_vector(v0, v1);
        if (0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::comparator::is_greater_than(&v2)) {
            2
        } else {
            let v4 = 0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::comparator::compare_u8_vector(v0, v1);
            if (0x38dbf062bfcb9ca04c468aa55c217cd3ba6cfc4a57bfaa25c740ac0beccc13ea::comparator::is_equal(&v4)) {
                0
            } else {
                1
            }
