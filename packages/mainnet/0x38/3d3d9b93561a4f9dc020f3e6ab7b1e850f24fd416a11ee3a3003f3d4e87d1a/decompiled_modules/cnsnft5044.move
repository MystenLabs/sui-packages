module 0x383d3d9b93561a4f9dc020f3e6ab7b1e850f24fd416a11ee3a3003f3d4e87d1a::cnsnft5044 {
    struct CNSNFT5044 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5044, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4135"));
        let v4 = 0x2::package::claim<CNSNFT5044>(arg0, arg1);
