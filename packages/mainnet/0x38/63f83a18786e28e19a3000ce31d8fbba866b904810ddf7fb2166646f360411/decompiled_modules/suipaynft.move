module 0x3863f83a18786e28e19a3000ce31d8fbba866b904810ddf7fb2166646f360411::suipaynft {
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        if (arg2 == 0) {
            arg2 = ((0x3863f83a18786e28e19a3000ce31d8fbba866b904810ddf7fb2166646f360411::pseudorandom::rand_u32(arg5) % 65535) as u16);
        };
