module 0x381ca6a55330af1cb01ae834ebc331fa371523b291fa4e0625bc23d6ca89f392::cnsnft5640 {
    struct CNSNFT5640 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5640, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5640>(arg0, arg1);
