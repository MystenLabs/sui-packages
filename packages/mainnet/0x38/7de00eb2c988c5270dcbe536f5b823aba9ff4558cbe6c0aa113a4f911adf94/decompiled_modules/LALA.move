module 0x387de00eb2c988c5270dcbe536f5b823aba9ff4558cbe6c0aa113a4f911adf94::LALA {
    struct LALA has drop {
        dummy_field: bool,
    }

    fun init(arg0: LALA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LALA>(arg0, 9, b"LOFI", b"Lofi Trump", b"Lofi Trump Boost", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
