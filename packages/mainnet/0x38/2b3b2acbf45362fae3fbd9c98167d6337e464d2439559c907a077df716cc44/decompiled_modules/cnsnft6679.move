module 0x382b3b2acbf45362fae3fbd9c98167d6337e464d2439559c907a077df716cc44::cnsnft6679 {
    struct CNSNFT6679 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6679, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6679>(arg0, arg1);
