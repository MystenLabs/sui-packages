module 0x387a8c4bbb214d4df23ffe89c00f7a5bf7a1f890daa9f1fa3f152ea677a08ffd::reward3797 {
    struct REWARD3797 has drop {
        dummy_field: bool,
    }

    struct TICKET_3797 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3797(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3797>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3797>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3797, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3797>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3797>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3797>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3797>>(v5, 0x2::tx_context::sender(arg1));
    }
