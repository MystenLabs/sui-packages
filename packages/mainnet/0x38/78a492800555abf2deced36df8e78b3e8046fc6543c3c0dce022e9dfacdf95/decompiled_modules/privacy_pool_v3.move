module 0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::privacy_pool_v3 {
    ...
    struct PrivacyPoolV3 has store, key {
        id: 0x2::object::UID,
        merkle_tree: 0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::merkle_tree_v3::MerkleTreeV3,
    ...
    public fun is_valid_root(arg0: &PrivacyPoolV3, arg1: vector<u8>) : bool {
        0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::merkle_tree_v3::is_valid_root(&arg0.merkle_tree, arg1)
    }
    ...
    public fun create_pool(arg0: &mut 0x2::tx_context::TxContext) : (PrivacyPoolV3, AdminCapV3) {
        ...
        let v2 = PrivacyPoolV3{
            id             : v0,
            merkle_tree    : 0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::merkle_tree_v3::initialize(26, arg0),
    ...
    public entry fun deposit(arg0: &mut PrivacyPoolV3, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, _) = 0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::merkle_tree_v3::append(&mut arg0.merkle_tree, arg2);
    ...
    public fun get_current_root(arg0: &PrivacyPoolV3) : vector<u8> {
        0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::merkle_tree_v3::get_root(&arg0.merkle_tree)
    }
    ...
    public fun get_tree_stats(arg0: &PrivacyPoolV3) : (u64, u8, u64) {
        0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::merkle_tree_v3::get_stats(&arg0.merkle_tree)
    }
    ...
    public fun verify_merkle_proof(arg0: &PrivacyPoolV3, arg1: vector<u8>, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: u64) : bool {
        0x3878a492800555abf2deced36df8e78b3e8046fc6543c3c0dce022e9dfacdf95::merkle_tree_v3::verify_proof(arg1, arg2, arg3, arg4)
    }
