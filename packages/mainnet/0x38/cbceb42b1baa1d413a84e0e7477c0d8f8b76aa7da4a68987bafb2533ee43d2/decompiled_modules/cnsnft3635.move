module 0x38cbceb42b1baa1d413a84e0e7477c0d8f8b76aa7da4a68987bafb2533ee43d2::cnsnft3635 {
    struct CNSNFT3635 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3635, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3635>(arg0, arg1);
