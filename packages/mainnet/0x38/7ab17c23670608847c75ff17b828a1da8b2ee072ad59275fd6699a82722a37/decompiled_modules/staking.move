module 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::staking {
    ...
    public entry fun claim<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: &mut 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::certificate::InvestmentCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::certificate::get_mut_df_info<ProofOfStake>(arg2);
        ...
        0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v6, v1, arg3);
        let v7 = Claim{
            sender           : v1,
            epoch_time       : v0,
    ...
    fun cal_profit_per_day(arg0: u64, arg1: u64) : u64 {
        0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::utils::mul_u64_div_u64(arg0, parse_percent(arg1), 365 * 0x2::math::pow(10, 9))
    }
    ...
    public(friend) fun get_mut_vault(arg0: &mut StakingStorage) : &mut 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::Vaults {
        0x2::object_bag::borrow_mut<0x1::string::String, 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::Vaults>(&mut arg0.other, 0x1::string::utf8(b"VAULT"))
    }

    public fun get_staking_point_by_address(arg0: &StakingStorage, arg1: address, arg2: 0x1::string::String) : u64 {
        if (0x2::vec_map::contains<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&arg0.invest_list, &arg1)) {
            *0x2::vec_map::get<0x1::string::String, u64>(0x2::vec_map::get<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&arg0.invest_list, &arg1), &arg2)
        } else {
            0
        }
    }
    ...
    fun new_vault(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::Vaults>(arg1, v0, v1);
    }
    ...
    public entry fun stake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::utils::get_full_type<T0>();
        let v3 = 0x2::dynamic_field::borrow<0x1::string::String, StakingPackage<T0>>(&arg1.id, arg2);
        let v4 = 0x2::object_bag::borrow_mut<0x1::string::String, 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT"));
        ...
        if (0x2::vec_map::contains<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&arg1.access_list, &v1)) {
            let v11 = 0x2::vec_map::get_mut<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&mut arg1.access_list, &v1);
            let v12 = 0x1::string::utf8(b"ACTION_STAKE");
            if (0x2::vec_map::contains<0x1::string::String, u64>(v11, &v12)) {
                let v13 = 0x1::string::utf8(b"ACTION_STAKE");
                *0x2::vec_map::get_mut<0x1::string::String, u64>(v11, &v13) = v0;
            } else {
                0x2::vec_map::insert<0x1::string::String, u64>(v11, 0x1::string::utf8(b"ACTION_STAKE"), v0);
            };
        } else {
            let v14 = 0x2::vec_map::empty<0x1::string::String, u64>();
            0x2::vec_map::insert<0x1::string::String, u64>(&mut v14, 0x1::string::utf8(b"ACTION_STAKE"), v0);
            0x2::vec_map::insert<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&mut arg1.access_list, v1, v14);
        };
        0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::deposit<T0>(v4, arg3, arg4);
        let v15 = ProofOfStake{
            staker                : 0x2::tx_context::sender(arg4),
            stake_token           : 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::utils::get_full_type<T0>(),
            stake_amount          : v5,
            stake_date            : v0,
        ...
        0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::certificate::issue_investment_certificate<ProofOfStake>(arg0, v3.name, v3.image, v3.website, v3.link, v3.description, v15, arg4);
        let v16 = Stake{
            sender       : v1,
            epoch_time   : v0,
            package_key  : arg2,
        ...
        0x2::event::emit<Stake>(v16);
    }

    public entry fun unstake<T0>(arg0: &0x2::clock::Clock, arg1: &mut StakingStorage, arg2: &mut 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::certificate::InvestmentCertificate, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::utils::get_full_type<T0>();
        let v3 = 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::certificate::get_mut_df_info<ProofOfStake>(arg2);
        ...
        if (0x2::vec_map::contains<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&arg1.access_list, &v1)) {
            ...
            let v6 = 0x1::string::utf8(b"ACTION_STAKE");
            if (0x2::vec_map::contains<0x1::string::String, u64>(v5, &v6)) {
                let v7 = 0x1::string::utf8(b"ACTION_STAKE");
        ...
        if (v10 < v3.days_at_moment) {
            v13 = v12 - 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::utils::mul_u64_div_decimal(v3.stake_amount, parse_percent(v4.unstake_soon_fee), 9);
        };
        ...
        *v14 = *v14 - v3.stake_amount;
        let v15 = 0x2::vec_map::get_mut<address, 0x2::vec_map::VecMap<0x1::string::String, u64>>(&mut arg1.access_list, &v1);
        let v16 = 0x1::string::utf8(b"ACTION_UNSTAKE");
        if (0x2::vec_map::contains<0x1::string::String, u64>(v15, &v16)) {
            let v17 = 0x1::string::utf8(b"ACTION_UNSTAKE");
            *0x2::vec_map::get_mut<0x1::string::String, u64>(v15, &v17) = v0;
        } else {
            0x2::vec_map::insert<0x1::string::String, u64>(v15, 0x1::string::utf8(b"ACTION_UNSTAKE"), v0);
        };
        ...
        0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0xf0cdf14bcac51ef9f468600807f4224c97bc21e4480b34a9cfd51eeae63b297::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v13, v1, arg3);
        let v18 = Unstake{
            sender           : v1,
            epoch_time       : v0,
