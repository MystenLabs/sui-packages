module 0x3800ae885e1b2455feb61c1ae445129df7bfa3a2bf7b4dc124c9cc1bbbc1f2ef::req_helpers {
    ...
    public(friend) fun msgFromReqSigningMessage(arg0: vector<u8>) : vector<u8> {
        ...
        if (*v1 == 1) {
            ...
            0x1::vector::push_back<vector<u8>>(v5, 0x3800ae885e1b2455feb61c1ae445129df7bfa3a2bf7b4dc124c9cc1bbbc1f2ef::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v3) + 29 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v8, 0x3800ae885e1b2455feb61c1ae445129df7bfa3a2bf7b4dc124c9cc1bbbc1f2ef::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v6) + 31 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v11, 0x3800ae885e1b2455feb61c1ae445129df7bfa3a2bf7b4dc124c9cc1bbbc1f2ef::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v9) + 29 + 66));
