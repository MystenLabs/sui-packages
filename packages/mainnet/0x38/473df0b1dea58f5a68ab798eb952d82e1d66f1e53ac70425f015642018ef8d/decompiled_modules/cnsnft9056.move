module 0x38473df0b1dea58f5a68ab798eb952d82e1d66f1e53ac70425f015642018ef8d::cnsnft9056 {
    struct CNSNFT9056 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9056, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9056>(arg0, arg1);
