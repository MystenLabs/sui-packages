module 0x38b21ea81bd5b17e7f19aaa95a92fec6a5b217399fdab541ccb73684de6a6d97::movie {
    ...
    fun init(arg0: MOVIE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<MOVIE>(&mut v2, 12000000000000000000, @0xfaffafb9a2c9d2893e9beae187f30b2c2d75bdbabba4afcf43539d989fce97e1, arg1);
        let v4 = MintCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<MintCap>(v4, @0xfaffafb9a2c9d2893e9beae187f30b2c2d75bdbabba4afcf43539d989fce97e1);
    ...
    public entry fun mint(arg0: &MintCap, arg1: &mut ProtectedTreasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::mint_and_transfer<MOVIE>(v0, arg2 * 100000000, @0xfaffafb9a2c9d2893e9beae187f30b2c2d75bdbabba4afcf43539d989fce97e1, arg3);
    }
