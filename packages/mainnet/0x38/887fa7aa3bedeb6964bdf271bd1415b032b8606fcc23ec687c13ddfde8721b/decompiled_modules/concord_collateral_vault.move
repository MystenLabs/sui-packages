module 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_collateral_vault {
    ...
    public(friend) fun cancel_unlocked<T0>(arg0: &mut CollateralVault<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!arg0.locked, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::invalid_state());
        assert!(!arg0.seized, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::already_finalized());
        arg0.released = true;
    ...
    public(friend) fun lock_collateral<T0>(arg0: &mut CollateralVault<T0>) {
        assert!(!arg0.locked, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::invalid_state());
        assert!(0x2::balance::value<T0>(&arg0.escrow) >= arg0.required, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::insufficient_collateral());
        arg0.locked = true;
    }
    ...
    public fun post_collateral<T0>(arg0: &mut CollateralVault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.borrower, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::unauthorized());
        assert!(!arg0.locked, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::invalid_state());
    ...
    public(friend) fun seize_collateral<T0>(arg0: &mut CollateralVault<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.locked, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::invalid_state());
        assert!(!arg0.released, 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_errors::already_finalized());
        arg0.seized = true;
        arg0.locked = false;
        take_all_escrow<T0>(arg0, arg1)
    }
