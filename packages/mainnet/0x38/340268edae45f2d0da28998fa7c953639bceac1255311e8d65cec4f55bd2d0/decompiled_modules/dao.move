module 0x38340268edae45f2d0da28998fa7c953639bceac1255311e8d65cec4f55bd2d0::dao {
    ...
    struct DAOFund<phantom T0> has key {
        id: 0x2::object::UID,
        creator: address,
    ...
    public entry fun change_fund_status<T0>(arg0: &mut DAOFund<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.fundraise_status == 0x1::string::utf8(b"fundraising"), 1010);
    ...
    fun check_fund_withdrawable<T0>(arg0: &DAOFund<T0>, arg1: &0x2::clock::Clock) {
        ...
        if (v0 < arg0.dao_end_at) {
            assert!(v0 >= arg0.fundraise_end_at && 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) < ((arg0.fundraise_goal * 110 / 100) as u64), 1007);
        };
    }
    ...
    public entry fun commit<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= arg1, 1004);
        validate_phase<T0>(arg0, 0x2::tx_context::sender(arg4));
        validate_fundraise_time<T0>(arg0, arg3);
        assert!(arg0.fundraise_status == 0x1::string::utf8(b"fundraising"), 1010);
        validate_commit_amount<T0>(arg0, arg1);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        let v1 = Record{
            sender           : 0x2::tx_context::sender(arg4),
            token_type       : arg0.token_type,
            committed_amount : arg1,
            withdrawn_amount : 0,
            created_at       : v0,
        };
        if (!is_existed_user_dao<T0>(arg0, 0x2::tx_context::sender(arg4))) {
            let v2 = 0x2::table::new<address, Record>(arg4);
            0x2::table::add<address, Record>(&mut v2, 0x2::tx_context::sender(arg4), v1);
            let v3 = UserDAO{
                dao_type               : arg0.phase,
                max_committable_amount : 0,
                total_committed_amount : arg1,
                total_withdrawn_amount : 0,
                records                : v2,
            };
            ...
            assert!(v4.total_committed_amount + arg1 <= v4.max_committable_amount, 1005);
            v4.total_committed_amount = v4.total_committed_amount + arg1;
        };
        let v5 = arg0.price * arg1;
        let v6 = mint_dao_token<T0>(arg0, v5, arg3, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v6, 0x2::tx_context::sender(arg4));
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, arg1, arg4)));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, 0x2::tx_context::sender(arg4));
        let v7 = CommittedEvent{
            dao_fund_id  : 0x2::object::id<DAOFund<T0>>(arg0),
            sender       : 0x2::tx_context::sender(arg4),
            amount       : arg1,
            committed_at : v0,
        };
        0x2::event::emit<CommittedEvent>(v7);
    }

    public entry fun create_dao_fund<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: &mut SharedObj, arg7: 0x2::transfer::Receiving<0x2::coin::TreasuryCap<T0>>, arg8: &0x38340268edae45f2d0da28998fa7c953639bceac1255311e8d65cec4f55bd2d0::dao_config::GlobalDaoFee, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg10);
        let v1 = ((arg3 / arg5 * 110 / 100) as u64);
        let (v2, v3, _, _, _, _) = 0x38340268edae45f2d0da28998fa7c953639bceac1255311e8d65cec4f55bd2d0::dao_config::get_dao_fee_config(arg8);
        let v8 = ((arg5 * v2 / v3) as u64);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg9) >= v8, 1004);
        let v9 = DAOFund<T0>{
            ...
            treasury_cap         : 0x2::transfer::public_receive<0x2::coin::TreasuryCap<T0>>(&mut arg6.id, arg7),
            is_seeded            : false,
            platform_fee         : 0x2::balance::zero<0x2::sui::SUI>(),
            carried_distribution : 0x2::balance::zero<0x2::sui::SUI>(),
        };
        0x2::balance::join<0x2::sui::SUI>(&mut v9.platform_fee, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg9, v8, arg11)));
        let v10 = DAOFundCreatedEvent{
            id                           : 0x2::object::id<DAOFund<T0>>(&v9),
            name                         : arg0,
            symbol                       : arg1,
            description                  : arg2,
            total_supply                 : arg3,
            icon_url                     : arg4,
            token_type                   : v9.token_type,
            created_at                   : v9.created_at,
            dao_end_at                   : v9.dao_end_at,
            fundraise_end_at             : v9.fundraise_end_at,
            price                        : v1,
            fundraise_goal               : arg5,
            phase                        : v9.phase,
            fundraise_status             : v9.fundraise_status,
            current_platform_fee         : 0x2::balance::value<0x2::sui::SUI>(&v9.platform_fee),
            current_carried_distribution : 0x2::balance::value<0x2::sui::SUI>(&v9.carried_distribution),
        };
        0x2::event::emit<DAOFundCreatedEvent>(v10);
        let v11 = PhaseChangedEvent{
            dao_fund_id : 0x2::object::id<DAOFund<T0>>(&v9),
            sender      : 0x2::tx_context::sender(arg11),
            phase       : 0x1::string::utf8(b"accepting"),
            created_at  : v0,
        };
        0x2::event::emit<PhaseChangedEvent>(v11);
        let v12 = AdminCap{
            id          : 0x2::object::new(arg11),
            dao_fund_id : 0x2::object::id<DAOFund<T0>>(&v9),
        };
        0x2::transfer::transfer<AdminCap>(v12, 0x2::tx_context::sender(arg11));
        0x2::transfer::share_object<DAOFund<T0>>(v9);
    ...
    public(friend) fun get_seed_balance<T0>(arg0: &mut DAOFund<T0>, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg0.fundraise_status == 0x1::string::utf8(b"succeed"), 1011);
        assert!(0x2::clock::timestamp_ms(arg1) < arg0.dao_end_at, 1012);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x38340268edae45f2d0da28998fa7c953639bceac1255311e8d65cec4f55bd2d0::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public(friend) fun mint_dao_token<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::coin::mint<T0>(&mut arg0.treasury_cap, arg1, arg3)
    }

    public entry fun set_dao_fee_config(arg0: &OperatorCap, arg1: &mut 0x38340268edae45f2d0da28998fa7c953639bceac1255311e8d65cec4f55bd2d0::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::tx_context::TxContext) {
        0x38340268edae45f2d0da28998fa7c953639bceac1255311e8d65cec4f55bd2d0::dao_config::set_dao_fee_config(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }
    ...
    fun validate_coin_type<T0>(arg0: &DAOFund<T0>) {
        assert!(0x1::type_name::into_string(0x1::type_name::get<T0>()) == arg0.token_type, 1003);
    }

    fun validate_commit_amount<T0>(arg0: &DAOFund<T0>, arg1: u64) {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) + arg1 <= ((arg0.fundraise_goal * 110 / 100) as u64), 1005);
    }

    fun validate_fundraise_time<T0>(arg0: &DAOFund<T0>, arg1: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg1) <= arg0.fundraise_end_at, 1002);
    }
    ...
    fun validate_withdraw_amount<T0>(arg0: &DAOFund<T0>, arg1: u64) {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= arg1, 1006);
    }
    ...
    public entry fun withdraw<T0>(arg0: &mut DAOFund<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_existed_user_dao<T0>(arg0, 0x2::tx_context::sender(arg4)), 1008);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        let v1 = arg0.price * arg2;
        assert!(0x2::coin::value<T0>(&arg1) >= v1, 1004);
        0x2::coin::burn<T0>(&mut arg0.treasury_cap, 0x2::coin::split<T0>(&mut arg1, v1, arg4));
