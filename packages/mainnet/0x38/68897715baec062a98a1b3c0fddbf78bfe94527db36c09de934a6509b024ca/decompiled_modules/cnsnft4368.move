module 0x3868897715baec062a98a1b3c0fddbf78bfe94527db36c09de934a6509b024ca::cnsnft4368 {
    struct CNSNFT4368 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4368, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4368>(arg0, arg1);
