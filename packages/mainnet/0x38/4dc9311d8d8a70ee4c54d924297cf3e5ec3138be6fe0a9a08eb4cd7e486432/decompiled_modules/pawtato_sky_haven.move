module 0x384dc9311d8d8a70ee4c54d924297cf3e5ec3138be6fe0a9a08eb4cd7e486432::pawtato_sky_haven {
    struct PAWTATO_SKY_HAVEN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PAWTATO_SKY_HAVEN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PAWTATO_SKY_HAVEN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pawtato Sky Haven"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Welcome to Pawtato Sky Haven, a breathtaking low-poly floating oasis where nature defies gravity! This unique NFT showcases a vibrant green island suspended in a dreamy sky, adorned with whimsical trees, a serene pond, and scattered stones. Enhanced with a subtle oceanic base and ethereal clouds, this artwork blends tranquility with fantasy. Own a piece of this digital paradise, perfect for collectors seeking a one-of-a-kind escape into the skies. Minted on the blockchain, Pawtato Sky Haven invites you to plant your paw in a world of endless imagination!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://m2UWUk8fIXiXbs_8Pm8N7pFbVvX29BOX0PaiMR1qW0k"));
