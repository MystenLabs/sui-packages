module 0x382c42b48f0e3747f11c3d83d23142bb1c96040ccc1dec6a2e7a5c6fd1155969::reward1793 {
    struct REWARD1793 has drop {
        dummy_field: bool,
    }

    struct TICKET_1793 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1793(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1793>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1793>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1793, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1793>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1793>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1793>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1793>>(v5, 0x2::tx_context::sender(arg1));
    }
