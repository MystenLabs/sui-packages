module 0x38592216e19f5621772f18c0aabd1aad2bb529c5f26d1f1a1097706491695521::stz {
    struct STZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STZ, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<STZ>(arg0, 2, b"STZ", b"Suitizen", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"ipfs://https://i.imgur.com/rJnMzhr.png")), arg1);
