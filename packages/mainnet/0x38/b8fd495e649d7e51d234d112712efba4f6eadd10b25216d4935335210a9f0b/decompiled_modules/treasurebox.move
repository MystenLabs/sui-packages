module 0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::treasurebox {
    ...
    struct TreasureBoxChef has key {
        id: 0x2::object::UID,
        version: u64,
        dream_flow_treasure: 0x2::linked_table::LinkedTable<address, address>,
        ongoing_season: u64,
    ...
    struct TreasureBoxMinted has copy, drop {
        dream_flow_treasure_id: 0x2::object::ID,
        owner: address,
        referrer: 0x1::option::Option<address>,
        timestamp: u64,
        cur_season: u64,
    ...
    public fun award_chest_points(arg0: &PointsAdminCap, arg1: &0x2::clock::Clock, arg2: &mut TreasureBoxChef, arg3: &mut TreasureBox, arg4: u64) {
        ...
        if (!v4 && !(v2.start_time > v0)) {
            ...
            let v6 = TreasureBoxPointsAwarded{
                dream_flow_treasure_id : 0x2::object::id<TreasureBox>(arg3),
                owner                  : arg3.owner,
                points_earned          : arg4,
    ...
    public fun get_dream_flow_treasure_info(arg0: &TreasureBox) : (u64, 0x1::option::Option<address>, address, u64, u64, u64, u64, u64) {
    ...
    public fun get_user_dream_flow_treasure_id(arg0: &TreasureBoxChef, arg1: address) : 0x1::option::Option<address> {
        if (0x2::linked_table::contains<address, address>(&arg0.dream_flow_treasure, arg1)) {
            0x1::option::some<address>(*0x2::linked_table::borrow<address, address>(&arg0.dream_flow_treasure, arg1))
        } else {
    ...
    public fun has_dream_flow_treasure(arg0: &TreasureBoxChef, arg1: address) : bool {
        0x2::linked_table::contains<address, address>(&arg0.dream_flow_treasure, arg1)
    }
    ...
    fun increment_global_claim_index(arg0: &0x2::clock::Clock, arg1: &mut SeasonRewards) {
        ...
        if (arg1.total_points > 0) {
            arg1.global_claim_index = arg1.global_claim_index + 0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256(((v0 - arg1.last_time) as u256), (arg1.rewards_distribution_rate as u256) * (1000000000 as u256), (arg1.total_points as u256));
        };
        arg1.last_time = v0;
    }

    fun increment_user_claim_index(arg0: &SeasonRewards, arg1: &mut UserSeasonInfo) : u64 {
        let v0 = (0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256(arg0.global_claim_index - arg1.claim_index, (arg1.points_earned as u256), (1000000000 as u256)) as u64);
    ...
    public fun init_chest_chef(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = TreasureBoxChef{
            ...
            version             : 0,
            dream_flow_treasure : 0x2::linked_table::new<address, address>(arg3),
            ongoing_season      : 0,
    ...
    public fun mint_dream_flow_treasure(arg0: &0x2::clock::Clock, arg1: &mut TreasureBoxChef, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) {
        validation_check(arg1);
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = arg1.ongoing_season;
        assert!(!0x2::linked_table::contains<address, address>(&arg1.dream_flow_treasure, v0), 13906836381957816340);
        ...
        0x2::linked_table::push_back<address, address>(&mut arg1.dream_flow_treasure, v0, 0x2::object::uid_to_address(&v3.id));
        ...
        let v5 = TreasureBoxMinted{
            dream_flow_treasure_id : 0x2::object::id<TreasureBox>(&v3),
            owner                  : v0,
        ...
        if (v0 > 0 && v0 > v1) {
            ...
            let v4 = if (!v2.is_time_based_distribution) {
                if (v2.total_points > 0) {
                    (0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256((v3.points_earned as u256), (v2.rewards_allocated as u256), (v2.total_points as u256)) as u64)
                } else {
                    0
                }
            } else {
                v3.claim_index = v2.global_claim_index;
                (0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256(v2.global_claim_index - v3.claim_index, (v3.points_earned as u256), (1000000000 as u256)) as u64)
            };
            ...
            if (0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v2)) {
                ...
                if (!v5.is_time_based_distribution) {
                    if (v5.total_points > 0) {
                        v4 = v3 + (0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256((v6.points_earned as u256), (v5.rewards_allocated as u256), (v5.total_points as u256)) as u64) - v6.claimed_amount;
                    };
                } else {
                    v4 = v3 + (0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256(v5.global_claim_index - v6.claim_index, (v6.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        if (0x2::linked_table::contains<u64, SeasonRewards>(&arg1.season_alloc, v1) && 0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v1)) {
            ...
            if (!v9 && !(v7.start_time > v0)) {
                if (v7.is_time_based_distribution && v7.total_points > 0) {
                    v4 = v4 + (0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256(v7.global_claim_index + 0x38b8fd495e649d7e51d234d112712efba4f6eadd10b25216d4935335210a9f0b::math::mul_div_u256(((v0 - v7.last_time) as u256), (((v7.rewards_distribution_rate as u256) * 1000000000) as u256), (v7.total_points as u256)) - v8.claim_index, (v8.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        v4
