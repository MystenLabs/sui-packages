module 0x386c8cd21b7ba319b8e18eedcb32b119ec966940236bab0e2e037806089568a9::role {
    ...
    public fun create_random_role_for_cards(arg0: &Global, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::get_random_num(0, 1000, arg1, arg2);
    ...
    public fun get_random_role_by_power(arg0: &Global, arg1: u8, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::get_random_num(0, 1000, arg1, arg4);
        if (v0 < arg3) {
    ...
    public fun permenant_increase_role_hp(arg0: &mut vector<Role>, arg1: &0x2::vec_map::VecMap<0x1::string::String, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::Int_wrapper>) {
        let v0 = 0x2::vec_map::keys<0x1::string::String, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::Int_wrapper>(arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&v0)) {
            ...
            while (v3 < 0x1::vector::length<Role>(arg0)) {
                if (&0x1::vector::borrow_mut<Role>(arg0, v3).class == v2) {
                    ...
                    increase_hp(v4, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::get_int(0x2::vec_map::get<0x1::string::String, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::Int_wrapper>(arg1, v2)));
                    break
                };
                v3 = v3 + 1;
            };
    ...
    public fun print_role(arg0: &Role) {
        ...
        0x1::string::append(&mut v0, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::u8_to_string(arg0.level));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", attack: "));
        0x1::string::append(&mut v0, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::u64_to_string(arg0.attack));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", hp: "));
        0x1::string::append(&mut v0, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::u64_to_string(arg0.hp));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", speed: "));
        0x1::string::append(&mut v0, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::u64_to_string(arg0.speed));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", sp: "));
        0x1::string::append(&mut v0, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::u8_to_string(arg0.sp));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", sp_cap: "));
        0x1::string::append(&mut v0, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::u8_to_string(arg0.sp_cap));
        ...
        0x1::string::append(&mut v0, 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::u8_to_string(arg0.gold_cost));
    ...
    public fun upgrade(arg0: &Global, arg1: &Role, arg2: &mut Role) : bool {
        ...
        if (v0 < 9 && v1 < 9) {
            ...
            let v9 = 0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::get_class_by_level(0x43511aee799bf4de32a617733993c346b4117e26fa17c16bfd5f90611f38194f::utils::removeSuffix(arg2.class), v3);
