module 0x38984f28ef653e245c23d6a9bb411bd667663a088473e727e916f06f20428888::privatecoin {
    ...
    fun init(arg0: PRIVATECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        mint(v3, 8505627000000000, @0x682d1d6a9a6ae077a7ec4aff3bc00f3512be42e52c6bd45f3b283e4a61b69b9d, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<PRIVATECOIN>>(v2, @0x682d1d6a9a6ae077a7ec4aff3bc00f3512be42e52c6bd45f3b283e4a61b69b9d);
    }
