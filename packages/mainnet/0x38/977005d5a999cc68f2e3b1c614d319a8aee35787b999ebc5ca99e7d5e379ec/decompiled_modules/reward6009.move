module 0x38977005d5a999cc68f2e3b1c614d319a8aee35787b999ebc5ca99e7d5e379ec::reward6009 {
    struct REWARD6009 has drop {
        dummy_field: bool,
    }

    struct TICKET_6009 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6009(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6009>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6009>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6009, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6009>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6009>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6009>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6009>>(v5, 0x2::tx_context::sender(arg1));
    }
