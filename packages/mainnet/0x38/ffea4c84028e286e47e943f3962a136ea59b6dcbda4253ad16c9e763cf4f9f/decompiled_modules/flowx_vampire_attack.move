module 0xb13d6c45d10b6c31bb37513aa09b876448b46a9f864c4c179c277da138aa6799::flowx_vampire_attack {
    ...
    struct FlowxLockdropForPool<phantom T0, phantom T1> has key {
        ...
        available_hive_tokens: 0x2::balance::Balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>,
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut FlowxLockdropForPool<T0, T1>, arg2: &FlowxAttackConfig, arg3: 0x2::coin::Coin<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
        assert!(arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window > 0x2::clock::timestamp_ms(arg0), 9803);
        let v0 = 0x2::coin::into_balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(arg3);
        0x2::balance::join<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(&mut arg1.available_hive_tokens, 0x2::balance::split<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(&mut v0, arg4));
        ...
        0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::coin_helper::destroy_or_transfer_balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(v0, 0x2::tx_context::sender(arg5), arg5);
    ...
    fun calculate_weighted_units(arg0: u64, arg1: u64, arg2: &FlowxAttackConfig) : u128 {
        (((arg0 as u256) * ((1000000000 as u256) + 0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::math::mul_div_u256(((arg1 - 1) as u256) * (arg2.weekly_multiplier as u256), (1000000000 as u256), (arg2.weekly_divider as u256)))) as u128)
    }

    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &FlowxLockdropForPool<T0, T1>, arg4: &mut 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg5: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, u128, u128) {
        ...
        if (!0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::exists_for_profile(arg4, 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap))) {
        ...
        } = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::remove_app_from_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, arg5);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun does_user_have_position<T0, T1>(arg0: &0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg1: &FlowxLockdropForPool<T0, T1>) : bool {
        0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::exists_for_profile(arg0, 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap))
    }

    public fun extract_liquidity_from_flowx<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &mut FlowxLockdropForPool<T0, T1>, arg4: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg5: &mut 0x2::tx_context::TxContext) : (u128, u8, u128, u64, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>) {
        assert!(0x2::clock::timestamp_ms(arg0) > arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9813);
        ...
        (arg3.total_lp_locked, arg3.precision, arg3.total_weighted_units, arg3.total_hive_incentives, v1, v2, 0x2::balance::withdraw_all<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(&mut arg3.available_hive_tokens))
    }

    public fun get_user_position<T0, T1>(arg0: &0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg1: &FlowxLockdropForPool<T0, T1>) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        ...
        let v1 = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::borrow_from_profile<UserFlowxHivePosition>(arg0, v0);
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveAppAccessCapability, arg3: &mut FlowxAttackConfig, arg4: 0x1::string::String, arg5: u8, arg6: 0x2::coin::Coin<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : address {
        0x2::clock::timestamp_ms(arg0);
        let v0 = 0x2::coin::into_balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(arg6);
        ...
        let v3 = FlowxLockdropForPool<T0, T1>{
            ...
            available_hive_tokens   : 0x2::balance::split<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(&mut v0, arg7),
        ...
        0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::coin_helper::destroy_or_transfer_balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(v0, 0x2::tx_context::sender(arg8), arg8);
    ...
    public entry fun initialize_flowx_attack_config(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
    ...
    public entry fun lock_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &mut FlowxLockdropForPool<T0, T1>, arg4: &mut 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg5: 0x2::coin::Coin<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair::LP<T0, T1>>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_profile_meta_info(arg4);
        ...
        let v5 = if (0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::exists_for_profile(arg4, 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap))) {
            0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::remove_app_from_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, arg8)
        } else {
        ...
        let v7 = arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window + arg7 * 0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::constants::week_multiplier();
        ...
        0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::add_app_to_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg8);
    ...
    public fun simulate_withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &FlowxAttackConfig, arg2: &FlowxLockdropForPool<T0, T1>, arg3: &0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg4: u64, arg5: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap);
        if (!0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::exists_for_profile(arg3, v1)) {
            return (0, 0, false)
        };
        let v2 = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::borrow_from_profile<UserFlowxHivePosition>(arg3, v1);
    ...
    public entry fun withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: &FlowxAttackConfig, arg3: &mut FlowxLockdropForPool<T0, T1>, arg4: &mut 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_profile_meta_info(arg4);
        assert!(v0 >= arg2.init_timestamp, 9804);
        assert!(v0 < arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9811);
        assert!(0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::exists_for_profile(arg4, 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap)), 9808);
        let v5 = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::remove_app_from_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, arg7);
        ...
        0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::add_app_to_profile<UserFlowxHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg7);
