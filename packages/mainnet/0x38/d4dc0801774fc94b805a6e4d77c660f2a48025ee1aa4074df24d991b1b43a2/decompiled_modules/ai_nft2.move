module 0x38d4dc0801774fc94b805a6e4d77c660f2a48025ee1aa4074df24d991b1b43a2::ai_nft2 {
    ...
    public fun setValidator(arg0: &AdminCap, arg1: &mut VaultConfig, arg2: vector<u8>) {
        assert!(arg1.version == 1, 1002);
    ...
    fun verifySignature(arg0: vector<u8>, arg1: vector<u8>, arg2: &0x1::option::Option<vector<u8>>) {
        ...
        assert!(0x2::ed25519::ed25519_verify(&arg1, 0x1::option::borrow<vector<u8>>(arg2), &arg0), 1005);
    }
