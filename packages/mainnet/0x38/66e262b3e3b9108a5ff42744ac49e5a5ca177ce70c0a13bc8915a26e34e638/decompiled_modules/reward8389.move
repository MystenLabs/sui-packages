module 0x3866e262b3e3b9108a5ff42744ac49e5a5ca177ce70c0a13bc8915a26e34e638::reward8389 {
    struct REWARD8389 has drop {
        dummy_field: bool,
    }

    struct TICKET_8389 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8389(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8389>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8389>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8389, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8389>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8389>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8389>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8389>>(v5, 0x2::tx_context::sender(arg1));
    }
