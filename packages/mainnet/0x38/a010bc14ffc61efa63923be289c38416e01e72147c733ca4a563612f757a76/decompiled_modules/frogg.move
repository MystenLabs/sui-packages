module 0x38a010bc14ffc61efa63923be289c38416e01e72147c733ca4a563612f757a76::frogg {
    ...
    fun init(arg0: FROGG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<FROGG>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<FROGG>>(v4);
    }
