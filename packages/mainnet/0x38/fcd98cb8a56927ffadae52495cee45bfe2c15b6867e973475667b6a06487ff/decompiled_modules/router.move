module 0x38fcd98cb8a56927ffadae52495cee45bfe2c15b6867e973475667b6a06487ff::router {
    public fun bluefin_spot_swap_a2b<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xac39307870d61ca17d1330febe39d391a12298787feb4bf580c17f06c8e2ba90::liquid_mesh_events::emit_hop_log(0x1::string::utf8(b"bluefin_spot"), 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x1::type_name::into_string(0x1::type_name::get<T1>()), v0, 0x2::coin::value<T1>(&v3));
        v3
    }
    ...
    public fun bluefin_spot_swap_b2a<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0xac39307870d61ca17d1330febe39d391a12298787feb4bf580c17f06c8e2ba90::liquid_mesh_events::emit_hop_log(0x1::string::utf8(b"bluefin_spot"), 0x1::type_name::into_string(0x1::type_name::get<T1>()), 0x1::type_name::into_string(0x1::type_name::get<T0>()), v0, 0x2::coin::value<T0>(&v3));
        v3
    }
    ...
    public fun finalize_swap<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u16, arg6: address, arg7: u16, arg8: u16, arg9: address, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (v0 > arg2 && arg7 > 0) {
            let v2 = v0 - arg2;
            let v3 = (((v2 as u128) * (arg7 as u128) / 10000) as u64);
            let v4 = v3;
            ...
            if (v4 > 0) {
                ...
                0xac39307870d61ca17d1330febe39d391a12298787feb4bf580c17f06c8e2ba90::liquid_mesh_events::emit_positive_slippage(arg10, 0x2::tx_context::sender(arg11), arg9, arg2, v0, v2, v4, arg7, arg8, 0x1::type_name::into_string(0x1::type_name::get<T1>()));
        ...
        if (arg5 > 0) {
            if (arg4) {
                ...
                if (v6 > 0) {
                    0xac39307870d61ca17d1330febe39d391a12298787feb4bf580c17f06c8e2ba90::liquid_mesh_events::emit_commission(arg5, arg4, v6, arg6, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
                };
            } else {
                ...
                if (v7 > 0) {
                    ...
                    0xac39307870d61ca17d1330febe39d391a12298787feb4bf580c17f06c8e2ba90::liquid_mesh_events::emit_commission(arg5, arg4, v7, arg6, 0x1::type_name::into_string(0x1::type_name::get<T1>()));
                };
            };
        };
        let v8 = 0x2::coin::value<T1>(&arg0);
        0xac39307870d61ca17d1330febe39d391a12298787feb4bf580c17f06c8e2ba90::liquid_mesh_events::emit_swap_log(arg10, 0x2::tx_context::sender(arg11), arg1, arg2, arg3, v8, 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0x1::type_name::into_string(0x1::type_name::get<T1>()));
        assert!(v8 >= arg3, 0);
        arg0
    }
