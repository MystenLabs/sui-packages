module 0x38f9132756f4dfd5ad61819b1fbea8571034cb9643059c4a3cda79a58160986a::reward5433 {
    struct REWARD5433 has drop {
        dummy_field: bool,
    }

    struct TICKET_5433 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5433(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5433>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5433>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5433, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5433>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5433>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5433>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5433>>(v5, 0x2::tx_context::sender(arg1));
    }
