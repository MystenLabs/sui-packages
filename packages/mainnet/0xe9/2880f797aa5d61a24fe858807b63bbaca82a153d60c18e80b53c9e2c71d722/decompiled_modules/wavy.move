module 0xe92880f797aa5d61a24fe858807b63bbaca82a153d60c18e80b53c9e2c71d722::wavy {
    ...
    fun init(arg0: WAVY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://i.postimg.cc/MHVNtB5c/photo-6100657953846709559-y.jpg                                                                                                                                                                                                                                                                   ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<WAVY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WAVY    ")))), trim_right(b"WAVY AI                         "), trim_right(b"WAVY isnt just another meme coin  its a symbol of the new wave in crypto. Inspired by a slick blue droplet with a cyberpunk twist, WAVY represents flow, impact, and rebellion. WAVY  Drip, Not Dip.                                                                                                                            "), v2, arg1);
        let v5 = v3;
