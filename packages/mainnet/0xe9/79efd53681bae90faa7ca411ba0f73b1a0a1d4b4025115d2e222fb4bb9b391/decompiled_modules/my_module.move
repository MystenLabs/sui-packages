module 0xe979efd53681bae90faa7ca411ba0f73b1a0a1d4b4025115d2e222fb4bb9b391::my_module {
    ...
    public entry fun cetus_swap<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: bool, arg3: u64, arg4: &0x2::clock::Clock, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: &mut 0x2::tx_context::TxContext) {
        if (arg2) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg5, 0x2::tx_context::sender(arg7));
            ...
            let v3 = SwapEvent{amount_y_out: cetus_get_amount_out<T0, T1>(arg1, arg2, arg3)};
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg6, 0x2::tx_context::sender(arg7));
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg6, arg3, arg7)), v6);
        };
    }
