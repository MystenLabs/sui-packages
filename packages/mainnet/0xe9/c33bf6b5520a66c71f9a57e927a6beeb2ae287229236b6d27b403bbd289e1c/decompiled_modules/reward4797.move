module 0xe9c33bf6b5520a66c71f9a57e927a6beeb2ae287229236b6d27b403bbd289e1c::reward4797 {
    struct REWARD4797 has drop {
        dummy_field: bool,
    }

    struct TICKET_4797 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4797(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4797>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4797>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4797, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4797>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4797>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4797>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4797>>(v5, 0x2::tx_context::sender(arg1));
    }
