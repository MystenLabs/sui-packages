module 0xe91b0f359ec0d15dfa637e4fb567ba3e34901433a6db30d22ef53cd4bbdd1555::cnsnft7995 {
    struct CNSNFT7995 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7995, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7995>(arg0, arg1);
