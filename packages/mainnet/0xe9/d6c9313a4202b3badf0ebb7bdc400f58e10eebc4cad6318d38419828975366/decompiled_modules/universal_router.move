module 0xe9d6c9313a4202b3badf0ebb7bdc400f58e10eebc4cad6318d38419828975366::universal_router {
    ...
    fun deepbook_prune_input<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        refund_if_necessary<T0>(0x2::coin::split<T0>(arg0, 0x2::coin::value<T0>(arg0) % 1000, arg1), 0x2::tx_context::sender(arg1));
    }
    ...
    public fun deepbook_swap_exact_base_for_quote<T0, T1>(arg0: &mut Treasury, arg1: &mut Route, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::option::extract<0x2::coin::Coin<T0>>(&mut v0.coin_in);
        let v2 = &mut v1;
        deepbook_prune_input<T0>(v2, arg4);
        ...
        let v6 = v3;
        if (0x2::coin::value<T0>(&v6) > 1000) {
            abort 6
        };
        refund_if_necessary<T0>(v6, 0x2::tx_context::sender(arg4));
    ...
    public fun deepbook_swap_exact_quote_for_base<T0, T1>(arg0: &mut Treasury, arg1: &mut Route, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::option::extract<0x2::coin::Coin<T1>>(&mut v0.coin_in);
        let v2 = &mut v1;
        deepbook_prune_input<T1>(v2, arg4);
        ...
        let v6 = v4;
        if (0x2::coin::value<T1>(&v6) > 1000) {
            abort 6
        };
        refund_if_necessary<T1>(v6, 0x2::tx_context::sender(arg4));
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0xe9d6c9313a4202b3badf0ebb7bdc400f58e10eebc4cad6318d38419828975366::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
