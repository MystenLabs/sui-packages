module 0xe9aa2d60ff8bcb889fffc63db7c40280231bdcff78d0868f966e66b630ef83ad::strump {
    ...
    fun init(arg0: STRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2WAz28MbNRzEs874k8HdmAkPrh8bcrSKBCwGEgiYPCqz.png?size=lg&key=27d06f                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<STRUMP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"STRUMP  ")))), trim_right(b"Santa Trump                     "), trim_right(b"Santa returns every year.Trump also returned to the White House.That's why he's Santa.                                                                                                                                                                                                                                          "), v2, arg1);
        let v5 = v3;
