module 0x5658d4bf5ddcba27e4337b4262108b3ad1716643cac8c2054ac341538adc72ec::referral_bindings {
    ...
    public fun unbind_ve_sca_referrer(arg0: &mut ReferralBindings, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(has_ve_sca_binding(arg0, v0), 406);
        0x2::table::remove<address, 0x2::object::ID>(&mut arg0.ve_sca_binding, v0);
    }
