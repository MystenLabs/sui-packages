module 0xe942d2cd5d636c32851bd542340a9ca0ef08ae48306683aa7ed88e3169f46919::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 2, b"FAUCET", b"FAUCETCOIN", b"This is FAUCET COIN", 0x1::option::none<0x2::url::Url>(), arg1);
