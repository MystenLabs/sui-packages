module 0xe9124bbbac738155877ea019816e80b9dbd0f38f220e8bfb429a502551b4e6d2::reward6210 {
    struct REWARD6210 has drop {
        dummy_field: bool,
    }

    struct TICKET_6210 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6210(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6210>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6210>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6210, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6210>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6210>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6210>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6210>>(v5, 0x2::tx_context::sender(arg1));
    }
