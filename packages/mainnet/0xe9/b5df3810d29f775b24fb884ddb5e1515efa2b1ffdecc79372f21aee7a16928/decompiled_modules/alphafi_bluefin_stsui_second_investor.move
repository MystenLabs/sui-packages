module 0xff869e243a172cfef9a4551f4eef88ac4861be0f81b0e7a4b7840b6276f5ceeb::alphafi_bluefin_stsui_second_investor {
    ...
    fun autocompound_internal<T0, T1: drop, T2>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, 0x2::sui::SUI>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<0x2::sui::SUI, T0>, arg8: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<T1>, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: bool, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        let (v19, v20) = if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"swap_using_mint_burn") == true && *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"swap_using_mint_burn") == true) {
            let (v21, v22) = get_sqrt_price_limits<0x2::sui::SUI, T0, T0, 0x2::sui::SUI>(arg7, arg6, arg10);
            get_total_balance_in_ratio_with_limit<T0, T1>(arg0, v16, v15, arg2, arg3, arg4, arg6, arg7, arg8, arg9, arg10, v21, v22, arg11, arg12)
        } else {
            let (v23, v24) = get_bluefin_sqrt_price_limits<T0, T1>(arg4);
            get_total_balance_in_ratio_with_limit_base_pool<T0, T1>(arg0, v16, v15, arg2, arg4, v23, v24, arg11, arg12)
        };
        let (_, v26, v27, v28) = get_balances_in_ratio<T0, T1>(arg0, v19, v20, arg4, true, arg12);
        let v29 = v27;
        let v30 = v26;
    ...
    entry fun swap_using_mint_burn<T0, T1>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::AdminCap, arg1: &0xff869e243a172cfef9a4551f4eef88ac4861be0f81b0e7a4b7840b6276f5ceeb::version::Version, arg2: &mut Investor<T0, T1>, arg3: bool) {
        0xff869e243a172cfef9a4551f4eef88ac4861be0f81b0e7a4b7840b6276f5ceeb::version::assert_current_version(arg1);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"swap_using_mint_burn")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(&mut arg2.id, b"swap_using_mint_burn") = arg3;
        } else {
            0x2::dynamic_field::add<vector<u8>, bool>(&mut arg2.id, b"swap_using_mint_burn", arg3);
        };
    }
