module 0x6343bfb55a15b5ccc847223a7d96f51b68d39a66f6d9025be393421142dab037::mint {
    ...
    public fun mint_chest(arg0: &mut Mint, arg1: 0x1::option::Option<0x1::string::String>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x6343bfb55a15b5ccc847223a7d96f51b68d39a66f6d9025be393421142dab037::chest::SamChest {
        ...
        let v0 = if (0x1::option::is_some<0x1::string::String>(&arg1)) {
            ...
            0x6343bfb55a15b5ccc847223a7d96f51b68d39a66f6d9025be393421142dab037::referral::join(v1, 0x2::coin::split<0x2::sui::SUI>(&mut arg2, v4, arg3));
        ...
        *v6 = *v6 + 1;
        ...
        let v7 = 0x6343bfb55a15b5ccc847223a7d96f51b68d39a66f6d9025be393421142dab037::chest::mint(arg3);
        let v8 = MintChestEvent{
            chest_id : 0x2::object::id<0x6343bfb55a15b5ccc847223a7d96f51b68d39a66f6d9025be393421142dab037::chest::SamChest>(&v7),
            sender   : v5,
            code     : arg1,
        };
