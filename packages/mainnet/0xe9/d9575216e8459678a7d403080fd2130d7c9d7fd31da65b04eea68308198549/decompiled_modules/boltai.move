module 0xe9d9575216e8459678a7d403080fd2130d7c9d7fd31da65b04eea68308198549::boltai {
    struct BOLTAI has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<BOLTAI>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<BOLTAI>>(0x2::coin::mint<BOLTAI>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: BOLTAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<BOLTAI>>(0x2::coin::mint<BOLTAI>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
