module 0xe930824b457ca41bb7ba169c52035f650401fb7a3dd86ccbf44cae71887b33ee::cnsnft3105 {
    struct CNSNFT3105 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3105, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3105>(arg0, arg1);
