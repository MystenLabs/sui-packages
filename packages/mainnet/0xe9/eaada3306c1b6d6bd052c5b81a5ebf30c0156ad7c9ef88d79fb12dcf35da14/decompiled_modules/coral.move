module 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::coral {
    ...
    fun add_created_order<T0>(arg0: &mut Coral, arg1: vector<u8>, arg2: 0x2::coin::Coin<T0>) {
        0x2::bag::add<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::OrderStatus<T0>>(&mut arg0.order_hash_to_status, arg1, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::created<T0>(arg2));
    }

    fun add_filled_settlement<T0>(arg0: &mut Coral, arg1: vector<u8>) {
        0x2::bag::add<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::SettlementStatus<T0>>(&mut arg0.settlement_to_status, arg1, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::filled<T0>());
    }

    fun add_forwarded_settlement<T0>(arg0: &mut Coral, arg1: vector<u8>) {
        0x2::bag::add<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::SettlementStatus<T0>>(&mut arg0.settlement_to_status, arg1, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::forwarded<T0>());
    }

    fun add_refunded_order<T0>(arg0: &mut Coral, arg1: vector<u8>) {
        0x2::bag::add<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::OrderStatus<T0>>(&mut arg0.order_hash_to_status, arg1, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::refunded<T0>());
    }

    fun add_settled_order<T0>(arg0: &mut Coral, arg1: vector<u8>) {
        0x2::bag::add<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::OrderStatus<T0>>(&mut arg0.order_hash_to_status, arg1, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::settled<T0>());
    }

    fun assert_new_order<T0>(arg0: &Coral, arg1: vector<u8>) {
        assert!(!0x2::bag::contains_with_type<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::OrderStatus<T0>>(&arg0.order_hash_to_status, arg1), 9223372543660982274);
    }

    fun assert_new_settlement<T0>(arg0: &Coral, arg1: vector<u8>) {
        assert!(!0x2::bag::contains_with_type<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::SettlementStatus<T0>>(&arg0.settlement_to_status, arg1), 9223372681100066820);
    }
    ...
    entry fun collect_fees<T0>(arg0: &FeeCollectorCap, arg1: &mut Coral, arg2: 0x1::ascii::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::events::fee_collected(0x2::tx_context::sender(arg3), arg2, 0x2::balance::value<T0>(&v0));
    }
    ...
    entry fun create_order<T0>(arg0: &mut Coral, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: vector<u8>, arg16: &0x2::tx_context::TxContext) {
        let v0 = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::new(arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15);
        let v1 = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::order_hash(&v0);
        assert_new_order<T0>(arg0, v1);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_signer(&v0, 0x2::tx_context::sender(arg16));
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_expiry(&v0, 0x2::clock::timestamp_ms(arg1));
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_from_chain_is_sui(&v0, 1000001);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_order_from_amount(&v0, 0x2::coin::value<T0>(&arg2));
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_from_token<T0>(&v0);
        add_created_order<T0>(arg0, v1, arg2);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::events::order_created(v1, v0);
    }

    fun decode_hub_payload(arg0: vector<u8>) : (u8, vector<vector<u8>>, address, vector<u256>, vector<u256>, vector<vector<u8>>) {
        let v0 = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::new_reader(arg0);
        let v1 = vector[];
        let v2 = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::read_vector_u256(&mut v0);
        ...
        ((0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::read_u256(&mut v0) as u8), v1, 0x2::address::from_bytes(0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::read_bytes(&mut v0)), 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::read_vector_u256(&mut v0), 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::read_vector_u256(&mut v0), 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::read_vector_bytes(&mut v0))
    }
    ...
    fun encode_forward_settlements_payload(arg0: vector<vector<u8>>) : vector<u8> {
        ...
        let v1 = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::new_writer(1);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::write_vector_u256(&mut v1, v0);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::abi::into_bytes(v1)
    }
    ...
    public fun execute(arg0: 0xeb055ffc3237c24e305a2bb760fe6551f6ff7c5fdb68735169c0f528fccab373::channel::ApprovedMessage, arg1: &mut Coral) {
        ...
        store_release_batch(arg1, v1, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::release_batch::new(v4, v5, v6, v7, v8, v9));
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::events::received_release_batch(v1, v5);
    }
    ...
    fun fill_order_internal<T0>(arg0: &mut Coral, arg1: &0x2::tx_context::TxContext, arg2: 0x2::coin::Coin<T0>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: vector<u8>) {
        ...
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_filler(&v0, 0x2::tx_context::sender(arg1));
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_to_chain_is_sui(&v0, 1000001);
        add_filled_settlement<T0>(arg0, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0x2::address::from_bytes(arg4));
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::events::order_filled(v1, v0);
    }
    ...
    entry fun forward_settlements<T0>(arg0: &mut Coral, arg1: &0xeb055ffc3237c24e305a2bb760fe6551f6ff7c5fdb68735169c0f528fccab373::gateway::Gateway, arg2: &mut 0xc10dd54f42a2f3ebdb8f113bd0a0627934c90e608d1e32e5fd0c7ae4d03d93b3::gas_service::GasService, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: vector<vector<u8>>, arg5: &0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<vector<u8>>(&arg4)) {
            ...
            assert!(0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::is_filled<T0>(v1), 9223375004678029326);
            add_forwarded_settlement<T0>(arg0, *0x1::vector::borrow<vector<u8>>(&arg4, v0));
            0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::events::settlement_forwarded(*0x1::vector::borrow<vector<u8>>(&arg4, v0));
            v0 = v0 + 1;
        };
    ...
    fun get_order_by_hash<T0>(arg0: &mut Coral, arg1: vector<u8>) : 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::OrderStatus<T0> {
        0x2::bag::remove<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::OrderStatus<T0>>(&mut arg0.order_hash_to_status, arg1)
    }

    fun get_release_batch(arg0: &mut Coral, arg1: 0x1::ascii::String) : 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::release_batch::ReleaseBatch {
        0x2::bag::remove<0x1::ascii::String, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::release_batch::ReleaseBatch>(&mut arg0.message_id_to_release_batch, arg1)
    }

    fun get_settlement_by_hash<T0>(arg0: &mut Coral, arg1: vector<u8>) : 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::SettlementStatus<T0> {
        0x2::bag::remove<vector<u8>, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::settlement_status::SettlementStatus<T0>>(&mut arg0.settlement_to_status, arg1)
    }
    ...
    entry fun refund_order<T0>(arg0: &mut Coral, arg1: &0x2::clock::Clock, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: vector<u8>, arg15: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::new(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_from_chain_is_sui(&v0, 1000001);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::verify_order_expired(&v0, 0x2::tx_context::sender(arg15), 0x2::clock::timestamp_ms(arg1));
        let v1 = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order::order_hash(&v0);
        let v2 = get_order_by_hash<T0>(arg0, v1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::extract_balance_from_created<T0>(v2), arg15), 0x2::address::from_bytes(arg2));
        add_refunded_order<T0>(arg0, v1);
        0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::events::order_refunded(v1);
    }
    ...
    entry fun release_batched<T0>(arg0: &mut Coral, arg1: 0x1::ascii::String, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2, v3, v4, v5, v6) = 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::release_batch::consume_release_batch(v0);
        let v7 = v6;
        let v8 = v5;
        let v9 = v4;
        let v10 = v2;
        ...
        while (v13 < 0x1::vector::length<vector<u8>>(&v10)) {
            ...
            0x2::balance::join<T0>(&mut v12, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::order_status::extract_balance_from_created<T0>(v14));
            add_settled_order<T0>(arg0, *0x1::vector::borrow<vector<u8>>(&v10, v13));
            0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::events::order_released(*0x1::vector::borrow<vector<u8>>(&v10, v13));
            v13 = v13 + 1;
        };
    ...
    entry fun setup(arg0: CreatorCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2b839b25c7133e5e0f8f585cb2e89bf430a6585a88c4a0343ae3b246372d431c::discovery::RelayerDiscovery, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<vector<u8>>(v3, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<Coral>(&v1))));
    ...
    fun store_release_batch(arg0: &mut Coral, arg1: 0x1::ascii::String, arg2: 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::release_batch::ReleaseBatch) {
        0x2::bag::add<0x1::ascii::String, 0xe9eaada3306c1b6d6bd052c5b81a5ebf30c0156ad7c9ef88d79fb12dcf35da14::release_batch::ReleaseBatch>(&mut arg0.message_id_to_release_batch, arg1, arg2);
    }
