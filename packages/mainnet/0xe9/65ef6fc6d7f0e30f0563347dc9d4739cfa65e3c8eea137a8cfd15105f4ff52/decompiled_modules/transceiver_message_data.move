module 0xe965ef6fc6d7f0e30f0563347dc9d4739cfa65e3c8eea137a8cfd15105f4ff52::transceiver_message_data {
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0xe965ef6fc6d7f0e30f0563347dc9d4739cfa65e3c8eea137a8cfd15105f4ff52::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0xe965ef6fc6d7f0e30f0563347dc9d4739cfa65e3c8eea137a8cfd15105f4ff52::ntt_manager_message::to_bytes(v2);
