module 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::meta {
    ...
    fun init(arg0: META, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<META>(arg0, 9, b"META", b"META", b"META", 0x1::option::some<0x2::url::Url>(0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::icon::get_icon_url()), arg1);
        let v2 = v1;
        let v3 = v0;
