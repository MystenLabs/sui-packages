module 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::mining {
    ...
    entry fun mint(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut BlockStore, arg3: &mut 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::meta::Treasury, arg4: vector<u8>, arg5: vector<u8>, arg6: u64, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    fun adjust_difficulty(arg0: &mut BlockStore) {
        if (arg0.current_height % 256 == 0) {
            ...
            arg0.current_target = 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::utils::median_to_max(arg0.current_target, 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::utils::adjust_difficulty_by_diff(arg0.current_target, (256 as u256) * (600000 as u256), (v0 as u256)));
            let (_, v2) = 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::utils::u256_try_divide_and_round_up((v0 as u256), (256 as u256));
    ...
    fun distribute_reward(arg0: &BlockStore, arg1: &mut 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::meta::Treasury, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::meta::mint(arg1, arg2, (0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::utils::u256_try_mul_div_down(50, 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::utils::u256_pow(10, 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::meta::decimals()), 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::utils::u256_pow(2, ((arg0.current_height / 210000) as u8))) as u64), arg3);
    }
    ...
    public fun is_valid_hash(arg0: vector<u8>, arg1: u256) : bool {
        0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::utils::vector_to_u256(arg0) <= arg1
    }

    fun mint_internal(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut BlockStore, arg3: &mut 0xe91921946d6add684c8dd8d1822d9666a9fcf3bc99fa877c58d7a5ae6e98b668::meta::Treasury, arg4: vector<u8>, arg5: vector<u8>, arg6: u64, arg7: address, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) {
