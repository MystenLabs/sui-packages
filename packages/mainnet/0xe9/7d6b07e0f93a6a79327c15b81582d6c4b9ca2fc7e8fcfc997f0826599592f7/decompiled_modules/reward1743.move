module 0xe97d6b07e0f93a6a79327c15b81582d6c4b9ca2fc7e8fcfc997f0826599592f7::reward1743 {
    struct REWARD1743 has drop {
        dummy_field: bool,
    }

    struct TICKET_1743 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1743(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1743>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1743>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1743, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1743>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1743>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1743>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1743>>(v5, 0x2::tx_context::sender(arg1));
    }
