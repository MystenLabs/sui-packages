module 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault {
    ...
    public fun update_coin_type_asset_value<T0, T1>(arg0: &mut Vault<T0>, arg1: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::OracleConfig, arg2: &0x2::clock::Clock) {
        ...
        assert!(0x1::type_name::get<T1>() != 0x1::type_name::get<T0>(), 5026);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T1>());
        let v1 = 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_utils::mul_with_oracle_price((0x2::balance::value<T1>(0x2::bag::borrow<0x1::ascii::String, 0x2::balance::Balance<T1>>(&arg0.assets, v0)) as u256), 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::get_normalized_asset_price(arg1, arg2, v0));
