module 0xe9b1b8e7eb6a472a99f3017f87f3938932d9f221d07adf0eb6766d7242d45d0b::cnsnft6425 {
    struct CNSNFT6425 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6425, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4916"));
        let v4 = 0x2::package::claim<CNSNFT6425>(arg0, arg1);
