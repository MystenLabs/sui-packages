module 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::control {
    ...
    entry fun withdraw<T0, T1>(arg0: &mut StoreOwner, arg1: &mut Store, arg2: &mut 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::pool::Pool<T0, T1>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
        let (v0, v1) = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::pool::withdraw_transaction_fee<T0, T1>(arg2, arg4);
        let v2 = v1;
        let v3 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v3, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v2, arg3);
        0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::events::emit_transaction_fee_withdraw(0x2::object::id<0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::pool::Pool<T0, T1>>(arg2), 0x2::coin::value<T0>(&v3), 0x2::coin::value<T1>(&v2), arg3);
    }
