module 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::pool {
    struct Pool<phantom T0, phantom T1> has key {
        id: 0x2::object::UID,
        x_symbol: 0x1::ascii::String,
        x_reserve: 0x2::balance::Balance<T0>,
        x_coin_scale: u64,
        x_pool_rate: u32,
        x_pool_fee: 0x2::balance::Balance<T0>,
        x_transaction_fee: 0x2::balance::Balance<T0>,
        y_symbol: 0x1::ascii::String,
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, u64, u64, u64) {
        ...
        let (v7, v8) = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::tools::calc_optimal_values(v4, v6, arg2, arg4, v0, v1);
        let v9 = if (v2 == 0) {
            let v10 = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::maths::sqrt(0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::maths::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 505);
    ...
    public fun create_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: 0x1::ascii::String, arg2: u64, arg3: u32, arg4: 0x1::ascii::String, arg5: u64, arg6: u32, arg7: u64, arg8: bool, arg9: bool, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v1 = Pool<T0, T1>{
            ...
            can_blacklist     : arg10,
            blacklist         : 0x2::table::new<address, bool>(arg11),
        };
        ...
        0x2::transfer::public_transfer<PoolOwner<T0, T1>>(v3, 0x2::tx_context::sender(arg11));
        v2
    }
    ...
    public fun remove_liqudity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        ...
        let v4 = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::maths::mul_div(v1, v0, v3);
        let v5 = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::maths::mul_div(v2, v0, v3);
    ...
    public fun swap_x_to_y<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        ...
        let v4 = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::tools::get_fee(v3, 20, 10000);
        let v5 = if (arg0.x_pool_rate > 0) {
            0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::tools::get_fee(v3, arg0.x_pool_rate, 10000)
        } else {
            0
        };
        let v6 = v5;
        ...
        let v7 = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::tools::calculate_amount_out(v0, v1, v3 - v4 - v6);
        assert!(v7 >= arg3, 510);
        ...
        0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::tools::check_reserve_is_increased(v0, v1, v10, v11);
        if (arg0.trading_time == 0) {
    ...
    public fun swap_y_to_x<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, u64) {
        ...
        let v7 = 0xe9856ebaa74c55300a4111f809d8c5d9aeb331c64ba7aa61ffb0e9f24ead7373::tools::calculate_amount_out(v1, v0, v3 - v4 - v6);
        assert!(v7 >= arg3, 510);
