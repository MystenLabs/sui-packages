module 0xe95ab1fc0a03132808e7d75bdaa5ba2743c4c51055057d04bafc430d68ed4217::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<Degen<0xe95ab1fc0a03132808e7d75bdaa5ba2743c4c51055057d04bafc430d68ed4217::collectible::Collectible>>(&v4, v0, v2, arg1);
        0x2::display::update_version<Degen<0xe95ab1fc0a03132808e7d75bdaa5ba2743c4c51055057d04bafc430d68ed4217::collectible::Collectible>>(&mut v5);
        let v6 = AdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::public_transfer<AdminCap>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Degen<0xe95ab1fc0a03132808e7d75bdaa5ba2743c4c51055057d04bafc430d68ed4217::collectible::Collectible>>>(v5, 0x2::tx_context::sender(arg1));
    }
