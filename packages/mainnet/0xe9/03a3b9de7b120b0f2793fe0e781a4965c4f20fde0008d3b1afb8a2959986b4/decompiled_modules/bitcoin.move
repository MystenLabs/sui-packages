module 0xe903a3b9de7b120b0f2793fe0e781a4965c4f20fde0008d3b1afb8a2959986b4::bitcoin {
    ...
    fun init(arg0: BITCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BITCOIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BITCOIN ")))), trim_right(b"BITCOINERS                      "), trim_right(b"BITCOINERS (BITCOINERS)                                                                                                                                                                                                                                                                                                         "), v2, arg1);
