module 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool {
    ...
    fun calc_dynamic_fee<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u128, arg3: bool) : (u64, u128) {
        ...
        let v7 = (v6 as u128);
        let v8 = if (v7 <= v4) {
            (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(((v3.fee_base * 1000) as u128), v7, v4) as u64)
        } else {
            v3.fee_base * 1000 + (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(((v3.fee_max * 1000) as u128), v7, 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v2, (v3.max_reserve_pct as u128), 10000)) as u64)
        };
        (v8, v4)
    }
    ...
    public fun simulate_buy_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        assert!(v2 != 0, 4016);
        let (v3, v4) = calc_dynamic_fee<T0, T1>(arg0, arg3, v0, false);
        let (v5, v6, v7) = calculate_swap_fees<T0>(arg0, (v2 as u64), v3);
        SwapSimulationResult{
            base_out        : (v5 as u64),
            quote_out       : (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v5 as u128), 1000000000000000000, v0) as u64),
    ...
    public fun simulate_sell_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, v3) = calc_dynamic_fee<T0, T1>(arg0, (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0) as u64), v0, true);
        let (v4, v5, v6) = calculate_swap_fees<T0>(arg0, arg3, v2);
        SwapSimulationResult{
            base_out        : (v4 as u64),
            quote_out       : (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v4 as u128), 1000000000000000000, v0) as u64),
            swap_fee_pct    : arg0.swap_fee_pct * 1000,
            dynamic_fee_pct : v2,
            ideal_quote_amt : v3,
            swap_fee        : ((v6 + v5) as u64),
            lp_fee          : (v6 as u64),
            protocol_fee    : (v5 as u64),
            price_used      : v0,
        }
    }
    ...
    public fun simulate_sell_swap_reverse<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, _) = calc_dynamic_fee<T0, T1>(arg0, arg3, v0, true);
        let v4 = (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), v0, 1000000000000000000) as u64);
        let (v5, v6) = calculate_fees<T0>(arg0, v4, v2);
        let v7 = ((10000 * 1000) as u128);
        let v8 = (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((get_quote_balance<T0, T1>(arg0) as u128), v0, 1000000000000000000) as u64);
        let v9 = 0x1::u64::max(0x1::u64::min((0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v4 as u128), v7, v7 - ((v2 + ((arg0.swap_fee_pct * 1000) as u64)) as u128)) as u64), v8), v5 + v6 + arg0.min_base_out);
        let v10 = simulate_sell_swap<T0, T1>(arg0, arg1, arg2, v9);
        if (v10.quote_out < arg3 && v9 < v8) {
            return simulate_sell_swap<T0, T1>(arg0, arg1, arg2, v9 + 1)
        };
        v10
    }
