module 0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::admin {
    ...
    struct AuthKeyV2 has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun assert_app_is_authorized(arg0: &0x2::object::UID) {
        assert!(has_authorized(arg0), 13906834934552723459);
    }

    fun assert_app_is_deauthorized(arg0: &0x2::object::UID) {
        assert!(!has_authorized(arg0), 13906834956027691013);
    }
    ...
    public fun authorize_v2(arg0: &AdminCap, arg1: &mut 0x2::object::UID) {
        assert!(!has_authorized_v2(arg1), 13906834797113901061);
        let v0 = AuthKeyV2{dummy_field: false};
        let v1 = AuthCap{dummy_field: false};
        0x2::dynamic_field::add<AuthKeyV2, AuthCap>(arg1, v0, v1);
        0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::events::emit_authorized_app_event(arg1);
    }
    ...
    public fun deauthorize(arg0: &AdminCap, arg1: &mut 0x2::object::UID) {
        assert!(has_authorized_v1(arg1), 13906834719804358659);
        let v0 = AuthKey{dummy_field: false};
    ...
    public fun deauthorize_v2(arg0: &AdminCap, arg1: &mut 0x2::object::UID) {
        assert!(has_authorized_v2(arg1), 13906834865833246723);
        let v0 = AuthKeyV2{dummy_field: false};
        let AuthCap {  } = 0x2::dynamic_field::remove<AuthKeyV2, AuthCap>(arg1, v0);
        0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::events::emit_deauthorized_app_event(arg1);
    }

    public fun has_authorized(arg0: &0x2::object::UID) : bool {
        has_authorized_v1(arg0) || has_authorized_v2(arg0)
    }

    public fun has_authorized_v1(arg0: &0x2::object::UID) : bool {
        let v0 = AuthKey{dummy_field: false};
        0x2::dynamic_field::exists_<AuthKey>(arg0, v0)
    }

    public fun has_authorized_v2(arg0: &0x2::object::UID) : bool {
        let v0 = AuthKeyV2{dummy_field: false};
        0x2::dynamic_field::exists_<AuthKeyV2>(arg0, v0)
    }
