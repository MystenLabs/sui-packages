module 0xe9359997673326a6eefbc509b1d3fe8992ee401965f7f5d7790e36a2fc0be03d::llv_admin {
    ...
    public(friend) fun migrate(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.version = 1;
        0xe9359997673326a6eefbc509b1d3fe8992ee401965f7f5d7790e36a2fc0be03d::llv_events::emit_global_migrated(arg0.version);
    }
    ...
    public(friend) fun set_global_paused(arg0: &mut LLVGlobal, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.paused = arg1;
        0xe9359997673326a6eefbc509b1d3fe8992ee401965f7f5d7790e36a2fc0be03d::llv_events::emit_global_paused(arg1);
    }
    ...
    public(friend) fun set_owner(arg0: &mut LLVGlobal, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 3);
        arg0.owner = arg1;
        0xe9359997673326a6eefbc509b1d3fe8992ee401965f7f5d7790e36a2fc0be03d::llv_events::emit_owner_changed(arg0.owner, arg1);
    }
