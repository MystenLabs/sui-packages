module 0xe9a08c0eda32a010a8061c773c6e9fa334b9caa30efce4ce3d0f7726543f8f46::vault {
    ...
    struct Vault has key {
        id: 0x2::object::UID,
        ggsui_kraft_cap: 0x2::coin::TreasuryCap<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>,
    ...
    public fun claim_collected_lsd_fee(arg0: &mut Vault, arg1: &mut 0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::honey_yield::FeeCollector<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 9002);
        let v0 = LsdFeeCollected{amt: 0x2::balance::value<0x2::sui::SUI>(&arg0.protocol_fee_vault)};
        0x2::event::emit<LsdFeeCollected>(v0);
        0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::honey_yield::collect_fee_for_coin<0x2::sui::SUI>(arg1, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.protocol_fee_vault));
    }
    ...
    public fun init_vault(arg0: 0x2::coin::TreasuryCap<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ConfigParams{
            pause_stake           : false,
    ...
    fun internal_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        let v0 = get_sui_by_ggsui(arg1, 0x2::balance::value<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&arg2));
        ...
        0x2::coin::burn<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(arg2, arg4));
        arg1.ggsui_supply = 0x2::coin::total_supply<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
        let v5 = get_sui_claimable_per_ggsui(arg1);
        arg1.sui_claimable_per_ggsui = v5;
        let v6 = UserUnstakedInstantly{
            owner                   : 0x2::tx_context::sender(arg4),
            sui_withdrawn           : v0,
            ggsui_burnt             : 0x2::balance::value<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&arg2),
            redemption_fees         : v4,
    ...
    public fun request_delayed_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : UnstakeRequest {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        let v0 = 0x2::tx_context::epoch(arg3);
        update_accrued_rewards(arg1, arg0, arg3);
        let v1 = get_sui_by_ggsui(arg1, 0x2::balance::value<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&arg2));
        ...
        let v4 = UnstakeRequest{
            ...
            ggsui_amount       : 0x2::balance::value<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&arg2),
            sui_amount         : v1,
            requested_at_epoch : v0,
        };
        0x2::coin::burn<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(arg2, arg3));
        arg1.ggsui_supply = 0x2::coin::total_supply<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
    ...
    public fun request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = arg1.config_params.redeem_fee_bps;
        internal_instant_unstake(arg0, arg1, arg2, v0, arg3)
    }

    public fun request_instant_unstake_disc(arg0: &RedeemFeeDiscCap, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut Vault, arg3: 0x2::balance::Balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
    ...
    public fun stake_sui_request(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI> {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        ...
        0x2::coin::mint_balance<0xd5f9fa35639f08e6ba3b82672439fa66d7f8c9272fc451944dee090aee7284f6::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, v1)
    }
