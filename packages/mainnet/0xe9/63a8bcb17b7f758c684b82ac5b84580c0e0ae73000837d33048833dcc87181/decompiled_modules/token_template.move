module 0xe963a8bcb17b7f758c684b82ac5b84580c0e0ae73000837d33048833dcc87181::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"CON2810753", b"Concurrent2 810753", b"Concurrent 2", 0x1::option::none<0x2::url::Url>(), arg1);
