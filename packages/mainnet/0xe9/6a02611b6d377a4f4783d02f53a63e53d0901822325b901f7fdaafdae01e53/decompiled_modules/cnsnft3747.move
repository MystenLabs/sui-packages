module 0xe96a02611b6d377a4f4783d02f53a63e53d0901822325b901f7fdaafdae01e53::cnsnft3747 {
    struct CNSNFT3747 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3747, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5439"));
        let v4 = 0x2::package::claim<CNSNFT3747>(arg0, arg1);
