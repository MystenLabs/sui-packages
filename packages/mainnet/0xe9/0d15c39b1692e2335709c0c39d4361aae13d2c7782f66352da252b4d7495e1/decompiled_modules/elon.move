module 0xe90d15c39b1692e2335709c0c39d4361aae13d2c7782f66352da252b4d7495e1::elon {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ELON>(arg0, 4, b"ELON", b"Elon Gold Token", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = 0x2::coin::treasury_into_supply<ELON>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<ELON>>(0x2::coin::from_balance<ELON>(0x2::balance::increase_supply<ELON>(&mut v2, 100000000000000), arg1), 0x2::tx_context::sender(arg1));
