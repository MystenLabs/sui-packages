module 0xe956831cf81d3eea67e190226d615c606e9d52652ee04734ff76e8c3a2944dc7::cnsnft2538 {
    struct CNSNFT2538 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2538, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2538>(arg0, arg1);
