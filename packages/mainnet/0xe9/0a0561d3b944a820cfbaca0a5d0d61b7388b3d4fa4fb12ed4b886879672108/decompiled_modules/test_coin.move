module 0xe90a0561d3b944a820cfbaca0a5d0d61b7388b3d4fa4fb12ed4b886879672108::test_coin {
    ...
    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 6, b"forge2", b"forge", b"Template Coin Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"dddd"))), arg1);
