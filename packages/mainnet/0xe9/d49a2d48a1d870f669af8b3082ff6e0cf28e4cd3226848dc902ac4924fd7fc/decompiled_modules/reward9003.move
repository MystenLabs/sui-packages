module 0xe9d49a2d48a1d870f669af8b3082ff6e0cf28e4cd3226848dc902ac4924fd7fc::reward9003 {
    struct REWARD9003 has drop {
        dummy_field: bool,
    }

    struct TICKET_9003 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9003(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9003>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9003>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9003, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9003>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9003>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9003>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9003>>(v5, 0x2::tx_context::sender(arg1));
    }
