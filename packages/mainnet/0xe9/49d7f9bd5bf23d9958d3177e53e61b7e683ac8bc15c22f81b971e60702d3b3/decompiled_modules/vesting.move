module 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::vesting {
    ...
    public entry fun claim<T0>(arg0: &mut Pool<T0>, arg1: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun deposit<T0>(arg0: &mut Pool<T0>, arg1: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg2: vector<0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::NonTransferCoin<T0>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
    ...
    fun inner_claim(arg0: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg1: &mut UserVest, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun withdraw<T0>(arg0: &mut Pool<T0>, arg1: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::bag::contains<address>(&arg0.vesters, v0), 1003);
        let v1 = 0x2::bag::remove<address, UserVest>(&mut arg0.vesters, v0);
