module 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::staking {
    ...
    public entry fun claim_vest<T0, T1, T2, T3, T4>(arg0: &mut Pool<T0, T1, T2, T3, T4>, arg1: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
    ...
    public entry fun create_stake_pool<T0, T1, T2, T3, T4>(arg0: &mut 0xaff8c4874f0145d8d586aff69fdd8de07276200c985ce4878d05bddc6854a0ba::admin::Manage, arg1: 0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::NonTransferCoin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg7 - v0;
        if (arg3 == 0) {
            arg3 = 0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::value<T0>(&arg1) / v1;
        };
        if (arg4 == 0) {
            arg4 = 0x2::coin::value<T1>(&arg2) / v1;
        };
        let v2 = Pool<T0, T1, T2, T3, T4>{
        ...
        0x2::transfer::public_share_object<Pool<T0, T1, T2, T3, T4>>(v2);
    }

    public entry fun deposit<T0, T1, T2, T3, T4>(arg0: &mut Pool<T0, T1, T2, T3, T4>, arg1: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg2: vector<0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::NonTransferCoin<T4>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
    ...
    fun inner_vest_claim(arg0: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg1: &mut UserVest, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x202591744d54ee4f4af736ef3b8508f3d46d982c36747d9587032bd549122179::luck::LUCK>>(0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::get_luck(arg0, arg1.earned_reward, arg2), 0x2::tx_context::sender(arg2));
        arg1.earned_reward = 0;
    }
    ...
    public entry fun withdraw<T0, T1, T2, T3, T4>(arg0: &mut Pool<T0, T1, T2, T3, T4>, arg1: &mut 0xe949d7f9bd5bf23d9958d3177e53e61b7e683ac8bc15c22f81b971e60702d3b3::luck_vault::Vault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::bag::contains<address>(&arg0.vester, v0), 1003);
        let v1 = 0x2::bag::remove<address, UserVest>(&mut arg0.vester, v0);
