module 0x84ac518a4592aa40db5a7243ddda6211c60dc01c1165fa02ecbad862191f71d5::fuddies_gang_nfts {
    ...
    public fun whitelist_mint_v2<T0>(arg0: &mut Configuration, arg1: &mut WhitelistMintFee<T0>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        update_whitelist_mint(arg0, arg5);
        whitelist_pay<T0>(arg0, arg1, arg3, arg5);
        let v0 = 0x1::vector::swap_remove<Metadata>(&mut arg0.nft_metadata, arg2);
        assert!(arg4 == arg0.total_supply, 0);
        let v1 = 0x2::tx_context::sender(arg5);
        mint_internal(arg0, v1, v0, arg5);
    }

    public fun whitelist_mint_v3<T0>(arg0: &mut Configuration, arg1: &mut WhitelistMintFee<T0>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        update_whitelist_mint(arg0, arg5);
        whitelist_pay<T0>(arg0, arg1, arg3, arg5);
        let v0 = 0x1::vector::swap_remove<Metadata>(&mut arg0.nft_metadata, arg2);
        let Metadata {
