module 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::project {
    ...
    public fun create_project<T0>(arg0: &mut 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::platform::DonationPlatform, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::platform::increment_project_count(arg0);
    ...
    public fun decrease_support<T0>(arg0: &mut Project<T0>, arg1: &mut 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::SupportRecord, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Project<T0>>(arg0);
        0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::decrease_support(arg1, v0, arg2, arg3);
        ...
        let v1 = SupportDecreasedEvent{
            ...
            new_total        : 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::get_support_amount(arg1, v0),
    ...
    public fun end_support<T0>(arg0: &mut Project<T0>, arg1: &mut 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::SupportRecord, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Project<T0>>(arg0);
        0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::end_support(arg1, v0);
        arg0.financial.total_support_amount = arg0.financial.total_support_amount - 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::get_support_amount(arg1, v0);
    ...
    public fun increase_support<T0>(arg0: &mut Project<T0>, arg1: &mut 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::SupportRecord, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Project<T0>>(arg0);
        0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::increase_support(arg1, v0, arg2, arg3);
        arg0.financial.total_support_amount = arg0.financial.total_support_amount + arg2;
    ...
    public fun support_project<T0>(arg0: &mut Project<T0>, arg1: &mut 0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::SupportRecord, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Project<T0>>(arg0);
        0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::start_support(arg1, v0, arg2, arg3);
        arg0.financial.total_support_amount = arg0.financial.total_support_amount + arg2;
        if (!0xdd703e7f17da8aa2a4dc1674a185160470d15da59f8870ed75660c8e3a359e67::support_record::is_supporting(arg1, v0)) {
            arg0.stats.supporter_count = arg0.stats.supporter_count + 1;
        };
