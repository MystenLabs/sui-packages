module 0xddc2f6b9344405c0c043f39ef62db3e1f55322316d5a1694d537511ebdceb2e7::helper {
    public(friend) fun apply_slippage(arg0: u64, arg1: u64) : u64 {
        if (arg0 == 0) {
            return 0
        };
        arg0 + 0xddc2f6b9344405c0c043f39ef62db3e1f55322316d5a1694d537511ebdceb2e7::math::mul(arg0, arg1)
    }
    ...
    public(friend) fun get_sui_per_deep<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        assert!(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::whitelisted<T0, T1>(arg0) && 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::registered_pool<T0, T1>(arg0), 13906834689739456513);
        ...
        assert!(v0 == v2 && v1 == v3 || v0 == v3 && v1 == v2, 13906834741279064065);
        if (v0 == v2) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::mid_price<T0, T1>(arg0, arg1)
        } else {
            0xddc2f6b9344405c0c043f39ef62db3e1f55322316d5a1694d537511ebdceb2e7::math::div(1000000000, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::mid_price<T0, T1>(arg0, arg1))
        }
    }
    ...
    public(friend) fun validate_slippage(arg0: u64) {
        assert!(arg0 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 13906835046221873155);
    }
