module 0xddbcc00845005739bcbfbe147745216ac594f6c7655e853dc9e42b114b6cdc52::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"TESD", b"TEST20", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-17T09-26-23.713Z-toji-fushiguro-anime-character-mqjc41j5m0opdlf8.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"TEST20"),
            symbol     : 0x1::string::utf8(b"TESD"),
            decimals   : 9,
