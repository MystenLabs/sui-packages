module 0xdda8ddf07b9ac66dfe1869f581657efedf1f17200936a10df21088bf06ae36c0::splo {
    struct SPLO has drop {
        dummy_field: bool,
    }

    fun init(arg0: SPLO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SPLO>(arg0, 9, b"SPLO", x"f09f92a753706c6f", b"Oficial token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
