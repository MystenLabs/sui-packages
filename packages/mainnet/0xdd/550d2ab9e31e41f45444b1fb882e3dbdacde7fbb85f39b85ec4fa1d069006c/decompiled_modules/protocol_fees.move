module 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::protocol_fees {
    ...
    public(friend) fun protocol_fees(arg0: &ProtocolFees) : u64 {
        arg0.protocol_fees
    }
    ...
    public(friend) fun claim_default_referral_fees(arg0: &mut ProtocolFees) : u64 {
        let v0 = 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::default_referral();
    ...
    public(friend) fun decrease_shares(arg0: &mut ProtocolFees, arg1: 0x1::option::Option<0x2::object::ID>, arg2: u64) {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, ReferralTracker>(&mut arg0.referrals, 0x1::option::destroy_with_default<0x2::object::ID>(arg1, 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::default_referral()));
        update_unclaimed_fees(v0, arg0.fees_per_share);
    ...
    public(friend) fun default_protocol_fees(arg0: &mut 0x2::tx_context::TxContext) : ProtocolFees {
        ...
        0x2::table::add<0x2::object::ID, ReferralTracker>(&mut v0.referrals, 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::default_referral(), v1);
        v0
    }

    public(friend) fun fees_per_share(arg0: &ProtocolFees) : u64 {
        arg0.fees_per_share
    }
    ...
    public(friend) fun increase_fees_accrued(arg0: &mut ProtocolFees, arg1: 0x2::object::ID, arg2: u64) {
        ...
        if (arg0.total_shares > 0) {
            arg0.fees_per_share = arg0.fees_per_share + 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::div(v2, arg0.total_shares);
    ...
    public(friend) fun maintainer_fees(arg0: &ProtocolFees) : u64 {
        arg0.maintainer_fees
    }
    ...
    public(friend) fun referral_tracker(arg0: &ProtocolFees, arg1: 0x2::object::ID) : (u64, u64) {
        let v0 = 0x2::table::borrow<0x2::object::ID, ReferralTracker>(&arg0.referrals, arg1);
        (v0.current_shares, v0.unclaimed_fees + 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::mul(v0.current_shares, arg0.fees_per_share - v0.last_fees_per_share))
    }

    public(friend) fun total_shares(arg0: &ProtocolFees) : u64 {
        arg0.total_shares
    }

    fun update_unclaimed_fees(arg0: &mut ReferralTracker, arg1: u64) {
        arg0.unclaimed_fees = arg0.unclaimed_fees + 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::mul(arg0.current_shares, arg1 - arg0.last_fees_per_share);
