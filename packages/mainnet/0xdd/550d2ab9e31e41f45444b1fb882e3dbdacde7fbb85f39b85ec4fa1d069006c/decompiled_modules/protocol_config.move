module 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::protocol_config {
    ...
    public(friend) fun calculate_interest_with_borrow(arg0: &ProtocolConfig, arg1: u64, arg2: u64, arg3: u64) : u64 {
        0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::mul(0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::mul(arg3, interest_rate(arg0, arg1)), 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::div(arg2, 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::year_ms()))
    }
    ...
    public(friend) fun interest_rate(arg0: &ProtocolConfig, arg1: u64) : u64 {
        ...
        if (arg1 < v0) {
            0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::mul(arg1, arg0.interest_config.base_slope) + arg0.interest_config.base_rate
        } else {
            arg0.interest_config.base_rate + 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::mul(v0, arg0.interest_config.base_slope) + 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::mul(arg1 - v0, arg0.interest_config.excess_slope)
        }
    }
    ...
    public fun new_interest_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : InterestConfig {
        assert!(arg2 <= 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), 1);
        InterestConfig{
            base_rate           : arg0,
            base_slope          : arg1,
    ...
    public fun new_margin_pool_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : MarginPoolConfig {
        assert!(arg1 <= 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), 1);
        assert!(arg3 >= 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::min_min_borrow(), 1);
        assert!(arg2 <= 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::max_protocol_spread(), 1);
        let v0 = arg0 / 10;
        MarginPoolConfig{
            supply_cap                    : arg0,
            ...
            rate_limit_refill_rate_per_ms : v0 / 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::day_ms(),
