module 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_registry {
    ...
    public(friend) fun add_margin_manager(arg0: &mut MarginRegistry, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::length<0x2::object::ID>(v2) <= 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::max_margin_managers(), 13);
    }
    ...
    fun calculate_risk_ratios(arg0: u64) : RiskRatios {
        RiskRatios{
            min_withdraw_risk_ratio       : 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling() + 4 * arg0,
            min_borrow_risk_ratio         : 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling() + arg0,
            liquidation_risk_ratio        : 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling() + arg0 / 2,
            target_liquidation_risk_ratio : 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling() + arg0,
        }
    }
    ...
    public fun disable_deepbook_pool<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &mut 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::id<T0, T1>(arg2);
    ...
    public fun enable_deepbook_pool<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &mut 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::id<T0, T1>(arg2);
        assert!(0x2::table::contains<0x2::object::ID, PoolConfig>(&v0.pool_registry, v1), 3);
        let v2 = 0x2::table::borrow_mut<0x2::object::ID, PoolConfig>(&mut v0.pool_registry, v1);
    ...
    fun init(arg0: MARGIN_REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = MarginRegistryInner{
            ...
            allowed_versions    : 0x2::vec_set::singleton<u64>(0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::margin_version()),
        ...
        let v2 = MarginRegistry{
            id    : v0,
            inner : 0x2::versioned::create<MarginRegistryInner>(0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::margin_version(), v1, arg1),
        };
    ...
    public(friend) fun load_inner(arg0: &MarginRegistry) : &MarginRegistryInner {
        ...
        let v1 = 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::margin_version();
    ...
    public fun new_pool_config<T0, T1>(arg0: &MarginRegistry, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : PoolConfig {
        ...
        assert!(arg3 < arg2, 1);
        assert!(arg3 < arg4, 1);
        assert!(arg3 >= 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), 1);
        assert!(arg5 <= 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), 1);
        assert!(arg6 <= 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), 1);
        assert!(arg5 + arg6 <= 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), 1);
        assert!(arg4 > 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling() + arg5 + arg6, 1);
        let v0 = RiskRatios{
    ...
    public fun new_pool_config_with_leverage<T0, T1>(arg0: &MarginRegistry, arg1: u64) : PoolConfig {
        load_inner(arg0);
        assert!(arg1 > 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::min_leverage(), 1);
        assert!(arg1 <= 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::max_leverage(), 1);
        let v0 = calculate_risk_ratios(0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::math::div(0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), arg1 - 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling()));
        new_pool_config<T0, T1>(arg0, v0.min_withdraw_risk_ratio, v0.min_borrow_risk_ratio, v0.liquidation_risk_ratio, v0.target_liquidation_risk_ratio, 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::default_user_liquidation_reward(), 0xdd550d2ab9e31e41f45444b1fb882e3dbdacde7fbb85f39b85ec4fa1d069006c::margin_constants::default_pool_liquidation_reward())
    }
    ...
    public fun pool_enabled<T0, T1>(arg0: &MarginRegistry, arg1: &0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::Pool<T0, T1>) : bool {
        let v0 = load_inner(arg0);
        let v1 = 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::id<T0, T1>(arg1);
    ...
    public fun register_deepbook_pool<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::Pool<T0, T1>, arg3: PoolConfig, arg4: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::id<T0, T1>(arg2);
    ...
    public fun update_risk_params<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::Pool<T0, T1>, arg3: PoolConfig, arg4: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::pool::id<T0, T1>(arg2);
        assert!(0x2::table::contains<0x2::object::ID, PoolConfig>(&v0.pool_registry, v1), 3);
        ...
        assert!(arg3.risk_ratios.liquidation_risk_ratio >= 0xe37c5fc3882eaa43d3e670c2e9ca6884461dc398b0fe4d185d5343754bb23820::constants::float_scaling(), 1);
        0x2::table::add<0x2::object::ID, PoolConfig>(&mut v0.pool_registry, v1, arg3);
