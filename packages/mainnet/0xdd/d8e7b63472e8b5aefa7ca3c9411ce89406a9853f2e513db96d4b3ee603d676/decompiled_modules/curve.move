module 0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::curve {
    ...
    public fun burn_share(arg0: u64, arg1: u64, arg2: u64) : u64 {
        0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::math::mul_div(arg0, arg1, arg1 + arg2)
    }

    public(friend) fun buy(arg0: &mut 0x2::object::UID, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = CurveKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<CurveKey>(arg0, v0)) {
            return 0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::math::output(arg3, arg2, arg1)
        };
        ...
        let v3 = if (v2.basis == 0) {
            ...
            0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::math::mul_div(arg3, v2.basis, arg2)
        };
        assert!(v3 > 0, 1);
        v2.basis = v2.basis + v3;
        0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::math::output(v3, v2.virtual_quote + v2.basis, arg1)
    }
    ...
    public(friend) fun sell(arg0: &mut 0x2::object::UID, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = CurveKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<CurveKey>(arg0, v0)) {
            return 0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::math::output(arg3, arg1, arg2)
        };
        let v1 = CurveKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<CurveKey, Curve>(arg0, v1);
        let v3 = 0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::math::output(arg3, arg1, v2.virtual_quote + v2.basis);
        assert!(v3 <= v2.basis, 2);
        v2.basis = v2.basis - v3;
        0xddd8e7b63472e8b5aefa7ca3c9411ce89406a9853f2e513db96d4b3ee603d676::math::mul_div(v3, arg2, v2.basis)
    }
