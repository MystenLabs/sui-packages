module 0xdd3ba042c03854131831a0d301960be2d7aba1d9528344610b9fa9bd960cdb2f::ad_campaigns {
    ...
    public fun create_campaign(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<vector<u8>>, arg5: u64, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: 0x1::option::Option<u8>, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = AdCampaign{
            ...
            content_zones    : arg9,
            planet           : arg10,
            escrow_id        : 0x1::option::some<0x2::object::ID>(0xdd3ba042c03854131831a0d301960be2d7aba1d9528344610b9fa9bd960cdb2f::ad_payments::create_escrow(v4, arg0, arg11, arg12, arg13)),
        };
    ...
    public entry fun record_impression_with_escrow(arg0: &mut AdCampaign, arg1: &mut 0xdd3ba042c03854131831a0d301960be2d7aba1d9528344610b9fa9bd960cdb2f::ad_payments::CampaignEscrow, arg2: &mut 0xdd3ba042c03854131831a0d301960be2d7aba1d9528344610b9fa9bd960cdb2f::ad_payments::RevenuePool, arg3: &0xdd3ba042c03854131831a0d301960be2d7aba1d9528344610b9fa9bd960cdb2f::ad_payments::AdminCap, arg4: &0x2::clock::Clock) : bool {
        let v0 = deduct_impression_cost(arg0, arg4);
        if (!v0) {
            return false
        };
        0xdd3ba042c03854131831a0d301960be2d7aba1d9528344610b9fa9bd960cdb2f::ad_payments::withdraw_for_impression(arg1, arg0.bid, arg2, arg3)
    }
