module 0xdd4abec62b40cb8e81eda4c1c45d648639bebeca7060ee419b7c4f582e27c919::svg {
    fun build_awakened_overlay() : vector<u8> {
        b"<rect x=\"4\" y=\"4\" width=\"392\" height=\"392\" rx=\"8\" fill=\"none\" stroke=\"#00e5ff\" stroke-width=\"3\"/>"
    }

    fun build_evolution_overlay(arg0: u8, arg1: u64, arg2: u64) : vector<u8> {
        if (arg0 == 0) {
            build_genesis_overlay(arg1)
        } else if (arg0 == 1) {
            build_awakened_overlay()
        } else if (arg0 == 2) {
            build_vesting_overlay(arg2)
        } else if (arg0 == 3) {
    ...
    fun build_vesting_overlay(arg0: u64) : vector<u8> {
        let v0 = b"<rect x=\"4\" y=\"4\" width=\"392\" height=\"392\" rx=\"8\" fill=\"none\" stroke=\"#a855f7\" stroke-width=\"4\" stroke-dasharray=\"8 4\"/>";
        0x1::vector::append<u8>(&mut v0, b"<text x=\"320\" y=\"30\" font-family=\"monospace\" font-size=\"11\" fill=\"#a855f7\">");
        0x1::vector::append<u8>(&mut v0, u64_to_bytes(arg0));
        0x1::vector::append<u8>(&mut v0, b"% vested</text>");
        v0
    }
    ...
    public fun compose_nft_svg(arg0: vector<0x1::string::String>, arg1: u8, arg2: &0x1::string::String, arg3: u64, arg4: u64, arg5: u64) : 0x1::string::String {
        ...
        0x1::vector::append<u8>(&mut v0, build_evolution_overlay(arg1, arg4, arg5));
