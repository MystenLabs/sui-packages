module 0xdda090eedcfefc442c0e0df2b1d3f911f81e028d1578f4210724f7778b1b6b89::validator_set {
    ...
    public(friend) fun remove_stakes(arg0: &mut ValidatorSet, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x2::sui::SUI>, u64, u64) {
        ...
        if (!0x2::table::contains<address, Vault>(&mut arg0.vaults, arg2)) {
            if (*0x2::vec_map::get<address, u64>(&arg0.validators, &arg2) == 0) {
                ...
                let (v4, v5) = 0x1::vector::index_of<address>(&arg0.sorted_validators, &arg2);
                assert!(v4, 303);
                0x1::vector::swap_remove<address>(&mut arg0.sorted_validators, v5);
            };
            return (v0, 0, 0)
        };
        let v6 = 0x2::table::borrow_mut<address, Vault>(&mut arg0.vaults, arg2);
        while (v6.gap < v6.length && 0x2::balance::value<0x2::sui::SUI>(&v0) < arg3) {
            let v7 = 0x2::object_table::borrow_mut<u64, 0x3::staking_pool::StakedSui>(&mut v6.stakes, v6.gap);
            if (0x3::staking_pool::stake_activation_epoch(v7) > 0x2::tx_context::epoch(arg4)) {
                break
            };
            let v8 = 0x3::staking_pool::staked_sui_amount(v7);
            let v9 = v8;
            let v10 = arg3 - 0x2::balance::value<0x2::sui::SUI>(&v0);
            let v11 = v10;
            if (v10 < 1000000000) {
                v11 = 1000000000;
            };
            let v12 = if (v8 > v11 && v8 - v11 >= 1000000000) {
                v9 = v11;
                0x3::staking_pool::split(v7, v11, arg4)
            } else {
                v6.gap = v6.gap + 1;
                0x2::object_table::remove<u64, 0x3::staking_pool::StakedSui>(&mut v6.stakes, v6.gap)
            };
            v1 = v1 + v9;
            0x2::balance::join<0x2::sui::SUI>(&mut v0, 0x3::sui_system::request_withdraw_stake_non_entry(arg1, v12, arg4));
        };
        v6.total_staked = v6.total_staked - v1;
        if (v6.gap == v6.length) {
            assert!(v6.total_staked == 0, 302);
            if (*0x2::vec_map::get<address, u64>(&arg0.validators, &arg2) == 0) {
                destroy_vault(0x2::table::remove<address, Vault>(&mut arg0.vaults, arg2));
                let (_, _) = 0x2::vec_map::remove<address, u64>(&mut arg0.validators, &arg2);
                let (v15, v16) = 0x1::vector::index_of<address>(&arg0.sorted_validators, &arg2);
                assert!(v15, 303);
                0x1::vector::swap_remove<address>(&mut arg0.sorted_validators, v16);
            } else {
                v6.gap = 0;
                v6.length = 0;
            };
