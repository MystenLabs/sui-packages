module 0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::jackpot {
    ...
    fun get_positive_price(arg0: 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price::Price, arg1: u64) : u64 {
        ...
        if (0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_is_negative(&v0)) {
            ...
            if (0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_is_negative(&v2)) {
                0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::math::mul_div(arg1, 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_positive(&v0), 0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::math::pow(10, ((0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_negative(&v2) - 9) as u8)))
            } else {
                arg1 * 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_positive(&v0) * 0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::math::pow(10, ((0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_positive(&v2) - 9) as u8))
            }
        }
    }
    ...
    public(friend) fun lottery<T0>(arg0: &0x2::clock::Clock, arg1: &mut JackpotStore<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < v1) {
            ...
            if (get_random(arg0, arg1.total_probability, 0x2::tx_context::epoch_timestamp_ms(arg2)) < v5) {
                ...
                0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::event::winner_event<T0>(v4.id, arg1.round, v4.user, v6);
                v3 = v1;
            };
            v3 = v3 + 1;
        };
    ...
    public(friend) fun trade_event<T0>(arg0: u64, arg1: u64, arg2: &mut JackpotStore<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 > 0) {
            ...
            0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::event::new_tick_event<T0>(arg2.round, v0, v3, arg0, v1);
        };
    }
    ...
    public(friend) fun update_price<T0>(arg0: &mut JackpotStore<T0>, arg1: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::state::State, arg2: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        let v0 = 0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::comparator::compare_u8_vector(arg0.price_id_bytes, get_price_id_bytes_from_info_object(arg2));
        assert!(0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::comparator::is_equal(&v0), 5);
        let v1 = 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::pyth::get_price_unsafe(arg2);
        if (0xdd250dfa7be43f91126c8bf3ed6ee4c6d2a1a3a026593975256e3f5613d05d15::math::abs_diff(0x2::clock::timestamp_ms(arg3) / 1000, 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price::get_timestamp(&v1)) > 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::state::get_stale_price_threshold_secs(arg1)) {
