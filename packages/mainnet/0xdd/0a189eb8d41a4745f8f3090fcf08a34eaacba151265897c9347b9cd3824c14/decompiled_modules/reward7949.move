module 0xdd0a189eb8d41a4745f8f3090fcf08a34eaacba151265897c9347b9cd3824c14::reward7949 {
    struct REWARD7949 has drop {
        dummy_field: bool,
    }

    struct TICKET_7949 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7949(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7949>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7949>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7949, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7949>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7949>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7949>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7949>>(v5, 0x2::tx_context::sender(arg1));
    }
