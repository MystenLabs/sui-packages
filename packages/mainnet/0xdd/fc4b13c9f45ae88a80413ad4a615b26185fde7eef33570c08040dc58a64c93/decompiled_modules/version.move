module 0x7bf0bd74001fdfaaa2796af8dbc6f9bf129a8098fe298a1cd497ca726d7c52d0::version {
    ...
    public fun check_version_eq<T0: drop>(arg0: &VersionTable, arg1: u16) {
        assert!(arg1 == *0x2::table::borrow<0x1::type_name::TypeName, u16>(&arg0.versions, 0x1::type_name::get<T0>()), 13906834423451484161);
    }

    public fun check_version_gte<T0: drop>(arg0: &VersionTable, arg1: u16) {
        assert!(arg1 >= *0x2::table::borrow<0x1::type_name::TypeName, u16>(&arg0.versions, 0x1::type_name::get<T0>()), 13906834389091745793);
    }
