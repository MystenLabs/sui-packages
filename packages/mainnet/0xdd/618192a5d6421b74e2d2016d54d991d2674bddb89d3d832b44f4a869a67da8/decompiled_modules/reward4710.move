module 0xdd618192a5d6421b74e2d2016d54d991d2674bddb89d3d832b44f4a869a67da8::reward4710 {
    struct REWARD4710 has drop {
        dummy_field: bool,
    }

    struct TICKET_4710 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4710(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4710>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4710>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4710, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4710>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4710>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4710>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4710>>(v5, 0x2::tx_context::sender(arg1));
    }
