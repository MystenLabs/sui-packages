module 0xdd010b3376422ac3554065bd15ddbedbb0f53b569e7d4e96641e7283b76a13a7::mist_bucket {
    ...
    public fun wipe_mist<T0>(arg0: &mut MistBucket, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<T0>(&arg1) > arg0.threshold) {
        ...
        if (!0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0)) {
            0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.id, v0, 0x2::coin::zero<T0>(arg2));
        };
        0x2::coin::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.id, v0), arg1);
    }
    ...
    public fun wipe_mist_custom_threshold<T0>(arg0: &mut MistBucket, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0)) {
            0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.id, v0, 0x2::coin::zero<T0>(arg3));
        };
        0x2::coin::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg0.id, v0), arg1);
    }
