module 0xdd8a4d57f600b31984c79196d326727de7ef4fd7031d56df9b6c1215715907c4::cnsnft7445 {
    struct CNSNFT7445 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7445, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3125"));
        let v4 = 0x2::package::claim<CNSNFT7445>(arg0, arg1);
