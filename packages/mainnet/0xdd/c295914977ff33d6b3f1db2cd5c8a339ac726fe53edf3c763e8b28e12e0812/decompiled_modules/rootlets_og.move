module 0xddc295914977ff33d6b3f1db2cd5c8a339ac726fe53edf3c763e8b28e12e0812::rootlets_og {
    ...
    fun init(arg0: ROOTLETS_OG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Rootlets OG Holder"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"This NFT is a token of appreciation awarded to OG Rootlets holders since mint."));
