module 0xddc323092e50c74cd75e35202ad04935ad38a685c6387f211f57e48e975da9d8::runner {
    ...
    fun init(arg0: RUNNER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[b"RUNNER", b"Sui Runner", b"Wake up! Sui's runner is here", b""];
        let v2 = vector[b"RUNNER", b"Sui Runner", b"Wake up! Sui's runner is here", b""];
        let v3 = vector[b"RUNNER", b"Sui Runner", b"Wake up! Sui's runner is here", b""];
        let v4 = vector[b"RUNNER", b"Sui Runner", b"Wake up! Sui's runner is here", b""];
        let (v5, v6) = 0x2::coin::create_currency<RUNNER>(arg0, (*0x1::vector::borrow<u64>(&v0, 0) as u8), *0x1::vector::borrow<vector<u8>>(&v1, 0), *0x1::vector::borrow<vector<u8>>(&v2, 1), *0x1::vector::borrow<vector<u8>>(&v3, 2), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(*0x1::vector::borrow<vector<u8>>(&v4, 3))), arg1);
        let v7 = v5;
        let v8 = 0x2::tx_context::sender(arg1);
        let v9 = vector[9, 1000000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v9, 1) > 0) {
            let v10 = vector[9, 1000000000000000000, 0];
            0x2::coin::mint_and_transfer<RUNNER>(&mut v7, *0x1::vector::borrow<u64>(&v10, 1), v8, arg1);
        };
        let (v11, v12) = 0xa204bd0d48d49fc7b8b05c8ef3f3ae63d1b22d157526a88b91391b41e6053157::ipx_coin_standard::new<RUNNER>(v7, arg1);
        let v13 = v12;
        let v14 = v11;
        ...
        0xa204bd0d48d49fc7b8b05c8ef3f3ae63d1b22d157526a88b91391b41e6053157::ipx_coin_standard::destroy_witness<RUNNER>(&mut v14, v13);
        ...
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<RUNNER>>(v6);
    }
