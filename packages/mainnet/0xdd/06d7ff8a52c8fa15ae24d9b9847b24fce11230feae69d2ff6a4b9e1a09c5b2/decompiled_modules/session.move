module 0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::session {
    ...
    public fun authorize(arg0: &mut SessionKey, arg1: &0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::PolicyRegistry, arg2: &0x2::clock::Clock, arg3: vector<PriceFeedInput>, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) : RebalanceProof {
        0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::version::assert_is_current(0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::version_of(arg1));
        0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::assert_not_revoked(arg1, 0x2::object::id<SessionKey>(arg0));
    ...
    public fun consume_proof(arg0: RebalanceProof) {
        ...
        assert!(v2 >= 0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::math::bps_of_ceil(v1, 10000 - v3), 8);
    ...
    public fun read_price<T0>(arg0: &0x2::coin::CoinMetadata<T0>, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::PolicyRegistry) : PriceFeedInput {
        ...
        assert!(0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::expected_feed_id(arg3, v0) == 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::get_bytes(&v2), 1);
        let v3 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::pyth::get_price_no_older_than(arg1, arg2, 60);
        let v4 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_price(&v3);
        assert!(!0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_is_negative(&v4), 2);
        ...
        let v8 = 0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::math::price_from_pyth(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v4), v6, v7);
        let v9 = 0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::math::price_from_pyth(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_conf(&v3), v6, v7);
        let v10 = if (v8 > v9) {
            v8 - v9
        } else {
            0
    ...
    public fun revoke_session_key(arg0: &mut 0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::PolicyRegistry, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == 0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::owner_of(arg0, arg1) || 0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::is_admin(arg0, v0), 10);
        0x7499f97221cc2e65d12e8c76b938341b1ca41780a1c9d321b246662951fcf6bc::policy::mark_revoked(arg0, arg1);
