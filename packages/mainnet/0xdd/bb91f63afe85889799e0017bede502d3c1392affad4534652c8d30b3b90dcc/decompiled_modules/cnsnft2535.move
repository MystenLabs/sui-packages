module 0xddbb91f63afe85889799e0017bede502d3c1392affad4534652c8d30b3b90dcc::cnsnft2535 {
    struct CNSNFT2535 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2535, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2535>(arg0, arg1);
