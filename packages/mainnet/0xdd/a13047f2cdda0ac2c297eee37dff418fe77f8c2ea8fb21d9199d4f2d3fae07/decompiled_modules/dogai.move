module 0xdda13047f2cdda0ac2c297eee37dff418fe77f8c2ea8fb21d9199d4f2d3fae07::dogai {
    ...
    fun init(arg0: DOGAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DOGAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGAI     ")))), trim_right(b"DOGE AI MEME                    "), trim_right(b"Conceptualized as an AI-embodied, loyal companion, DOGAI isn't just another cryptocurrency or digital asset; it represents the fusion of advanced AI                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
