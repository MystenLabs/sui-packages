module 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::support_config {
    ...
    public(friend) fun validate_signature_algorithm_allowed_global_presign(arg0: &SupportConfig, arg1: u32) {
        assert!(0x1::vector::contains<u32>(&arg0.signature_algorithms_allowed_global_presign, &arg1), 3);
    }

    public(friend) fun validate_signature_algorithm_not_allowed_global_presign(arg0: &SupportConfig, arg1: u32) {
        assert!(!0x1::vector::contains<u32>(&arg0.signature_algorithms_allowed_global_presign, &arg1), 3);
    }
