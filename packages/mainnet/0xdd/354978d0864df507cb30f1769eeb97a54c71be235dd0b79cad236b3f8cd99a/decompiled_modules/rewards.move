module 0xdd354978d0864df507cb30f1769eeb97a54c71be235dd0b79cad236b3f8cd99a::rewards {
    ...
    public fun claim(arg0: &mut RewardsPool, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, v1), arg2)
    }
