module 0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::campaign {
    ...
    entry fun change_amount<T0>(arg0: &0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        arg1.min_amount = arg2;
        arg1.max_amount = arg3;
    }

    entry fun change_hardcap<T0>(arg0: &0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.hard_cap = arg2;
    }
    ...
    public entry fun claim<T0, T1>(arg0: &mut Campaign<T0>, arg1: &mut 0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::vault::Vault<T1>, arg2: &mut 0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::vesuip::Supply, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::vesuip::mint_and_transfer(arg2, 10 * 1000000000, arg4);
    ...
    public entry fun refund<T0>(arg0: &mut Campaign<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = (arg0.hard_cap as u256);
        assert!(v2 > v3, 1012);
        let v4 = 1000000000000;
        let v5 = (((v2 - v3) * (v1.amount as u256) * v4 / v2 / v4) as u64);
        assert!(v5 > 0, 1012);
        assert!(v5 <= v1.amount, 1006);
        v1.return_amount = v5;
        v1.valid_amount = v1.amount - v5;
        v1.is_refunded = true;
        let v6 = CampaignRefundClaimEvent{
            campaign_id  : 0x2::object::id<Campaign<T0>>(arg0),
            wallet       : v0,
        ...
        0x2::event::emit<CampaignRefundClaimEvent>(v6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, v5), arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    entry fun take_fund_with_amount<T0>(arg0: &0x10786d3c5b9aa5ab3efb05dd7b349ad03e20c175d2995a8f895ad2145bf29a6e::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
