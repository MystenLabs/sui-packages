module 0xdd46e08593faaae15675135e8f385fd477d19a80000e3e1dcd6f743cd1dc7204::swap {
    ...
    public fun take_swap_fee<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > 0, 105);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, 0xdd46e08593faaae15675135e8f385fd477d19a80000e3e1dcd6f743cd1dc7204::util::mul_div(0x2::coin::value<T0>(arg0), arg1, 1000000000), arg2), @0x1226a80ef40bd2e70c6a285b045b9b5d29915a2c5a2d57a2d3032cbdd89a8d5c);
    }
