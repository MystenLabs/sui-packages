module 0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::drachma {
    ...
    public fun from_coin(arg0: &0x2::token::TokenPolicy<DRACHMA>, arg1: 0x2::coin::Coin<DRACHMA>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<DRACHMA> {
        ...
        let v2 = v1;
        0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::verify<DRACHMA>(arg0, &mut v2, arg2);
    ...
    public entry fun spend(arg0: &mut 0x2::token::TokenPolicy<DRACHMA>, arg1: &mut 0x2::token::Token<DRACHMA>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::verify<DRACHMA>(arg0, &mut v0, arg3);
    ...
    public fun transfer(arg0: &0x2::token::TokenPolicy<DRACHMA>, arg1: 0x2::token::Token<DRACHMA>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::verify<DRACHMA>(arg0, &mut v0, arg3);
        0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::allow_list::verify<DRACHMA>(arg0, &mut v0, arg3);
    ...
    fun init(arg0: DRACHMA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v4;
        let v6 = v3;
        0x2::token::add_rule_for_action<DRACHMA, 0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::allow_list::Allowlist>(&mut v6, &v5, 0x2::token::transfer_action(), arg1);
        0x2::token::add_rule_for_action<DRACHMA, 0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::Denylist>(&mut v6, &v5, 0x2::token::transfer_action(), arg1);
        0x2::token::add_rule_for_action<DRACHMA, 0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::Denylist>(&mut v6, &v5, 0x2::token::spend_action(), arg1);
        0x2::token::add_rule_for_action<DRACHMA, 0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::Denylist>(&mut v6, &v5, 0x2::token::to_coin_action(), arg1);
        0x2::token::add_rule_for_action<DRACHMA, 0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::Denylist>(&mut v6, &v5, 0x2::token::from_coin_action(), arg1);
        ...
        0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::allow_list::add_records<DRACHMA>(&mut v6, &v5, v7, arg1);
    ...
    public entry fun split_and_transfer(arg0: &0x2::token::TokenPolicy<DRACHMA>, arg1: &mut 0x2::token::Token<DRACHMA>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::deny_list::verify<DRACHMA>(arg0, &mut v0, arg4);
        0xdd7ad5ae459190e8a8ea83051fe881dce450d22bbc310b32b9c18dccc4d5a2e4::allow_list::verify<DRACHMA>(arg0, &mut v0, arg4);
