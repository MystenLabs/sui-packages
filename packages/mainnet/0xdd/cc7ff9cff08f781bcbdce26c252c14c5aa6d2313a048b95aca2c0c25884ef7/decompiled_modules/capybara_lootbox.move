module 0xddcc7ff9cff08f781bcbdce26c252c14c5aa6d2313a048b95aca2c0c25884ef7::capybara_lootbox {
    ...
    fun init(arg0: CAPYBARA_LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v8, v9) = 0x2::transfer_policy::new<NFTLootbox>(&v0, arg1);
        let v10 = v9;
        let v11 = v8;
        let v12 = Rule{dummy_field: false};
        let v13 = Config{
            amount_bp  : 1000,
            min_amount : 100000,
        };
        0x2::transfer_policy::add_rule<NFTLootbox, Rule, Config>(v12, &mut v11, &v10, v13);
        ...
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicy<NFTLootbox>>(v11, v6);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<NFTLootbox>>(v10, v6);
    }
    ...
    public fun update_storage(arg0: &0xddcc7ff9cff08f781bcbdce26c252c14c5aa6d2313a048b95aca2c0c25884ef7::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
