module 0xdd926bf9262202bb9187a95e38a5f27c8d383e27bbe41b79d31ee250335b37e4::cnsnft5696 {
    struct CNSNFT5696 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5696, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5696>(arg0, arg1);
