module 0xdd94120032ef901491f2126e041ea80ef7571203500c5eccfdb4d4aa5a292bb1::mmt_clmm {
    public fun fetch_ticks_around<T0, T1>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: u32, arg2: u64) : (vector<u32>, vector<u128>, vector<u128>) {
        ...
        v10 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::add(v3, 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::from(1));
        let v19 = 0;
        let v20 = 0;
        loop {
            let v21 = if (v19 < arg2) {
            ...
            if (v21) {
                ...
                v10 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::add(v22, 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::from(1));
            } else {
                break
            };
        };
