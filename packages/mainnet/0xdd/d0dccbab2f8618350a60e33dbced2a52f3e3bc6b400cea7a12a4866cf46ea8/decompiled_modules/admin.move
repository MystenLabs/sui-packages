module 0xddd0dccbab2f8618350a60e33dbced2a52f3e3bc6b400cea7a12a4866cf46ea8::admin {
    ...
    public entry fun accept_reward(arg0: &ContractPublisher, arg1: &mut RewardPool, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>>(&mut arg1.id, 0x1::string::utf8(b"dummy"), 0x2::transfer::public_receive<0x2::coin::Coin<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>>(&mut arg1.id, arg2));
    }
    ...
    public(friend) fun get_mutable_reference_to_reward_balance(arg0: &mut RewardPool) : &mut 0x2::balance::Balance<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY> {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"dummy")), 1002);
        0x2::coin::balance_mut<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>>(&mut arg0.id, 0x1::string::utf8(b"dummy")))
    }
    ...
    public entry fun receive_dummy2(arg0: &ContractPublisher, arg1: &mut Dummy2Pool, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>>(&mut arg1.id, 0x1::string::utf8(b"dummy2"), 0x2::transfer::public_receive<0x2::coin::Coin<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>>(&mut arg1.id, arg2));
    }
    ...
    public entry fun send_reward(arg0: &mut RewardPool, arg1: &mut 0x2::coin::Coin<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>(arg1) >= arg2, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>>(0x2::coin::from_balance<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>(0x2::balance::split<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>(0x2::coin::balance_mut<0xc02af64372bf36dd8c1eae7361281bb4fb32af104c18e4af8b8d2e55f1cd0d1e::dummy::DUMMY>(arg1), arg2), arg3), 0x2::object::uid_to_address(&arg0.id));
    }

    public entry fun top_up_dummy2(arg0: &mut Dummy2Pool, arg1: &mut 0x2::coin::Coin<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>(arg1) >= arg2, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>>(0x2::coin::from_balance<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>(0x2::balance::split<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>(0x2::coin::balance_mut<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>(arg1), arg2), arg3), 0x2::object::uid_to_address(&arg0.id));
    }
    ...
    public(friend) fun withdraw_dummy2(arg0: &mut Dummy2Pool, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2> {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"dummy2")), 1002);
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>>(&mut arg0.id, 0x1::string::utf8(b"dummy2"));
        assert!(0x2::coin::value<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>(v0) > arg1, 5);
        0x2::coin::split<0xd3f33f40648efbb658fdf85edf16419c096fc467e6fa6f91b5e80fb1c082ea8a::dummy2::DUMMY2>(v0, arg1, arg2)
    }
