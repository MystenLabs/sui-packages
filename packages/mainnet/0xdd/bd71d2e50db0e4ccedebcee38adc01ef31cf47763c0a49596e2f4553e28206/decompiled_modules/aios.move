module 0xddbd71d2e50db0e4ccedebcee38adc01ef31cf47763c0a49596e2f4553e28206::aios {
    ...
    fun init(arg0: AIOS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/5QS7RcHfGUa2ZtrovPvEJMB9coqroiT7H48dPSwFpump.png?size=lg&key=274d16                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<AIOS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"AIOS    ")))), trim_right(b"Real AIOS Foundation            "), trim_right(b"Real AIOS Foundation (AIOS) AIOS Foundation is the host of AIOS -- the world's first AI Agent Operating System (AIOS). AIOS Foundation is dedicated to the research, development and deployment of AIOS, nurturing the open-source AIOS-Agent ecosystem for the greater good of humanit.                                        "), v2, arg1);
        let v5 = v3;
