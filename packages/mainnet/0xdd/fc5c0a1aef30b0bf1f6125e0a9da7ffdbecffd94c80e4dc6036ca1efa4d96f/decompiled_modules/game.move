module 0xddfc5c0a1aef30b0bf1f6125e0a9da7ffdbecffd94c80e4dc6036ca1efa4d96f::game {
    ...
    public entry fun place_bet(arg0: &mut GameState, arg1: &mut 0xddfc5c0a1aef30b0bf1f6125e0a9da7ffdbecffd94c80e4dc6036ca1efa4d96f::player_registry::Registry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (0xddfc5c0a1aef30b0bf1f6125e0a9da7ffdbecffd94c80e4dc6036ca1efa4d96f::player_registry::is_valid_referrer(arg1, arg3)) {
            let v4 = 0xddfc5c0a1aef30b0bf1f6125e0a9da7ffdbecffd94c80e4dc6036ca1efa4d96f::player_registry::get_player_address(arg1, arg3);
            if (v4 == v0) {
                arg0.admin
            } else {
                v4
        ...
        if (v3 != arg0.admin) {
            let v7 = v1 * 1 / 100;
            if (v7 > 0) {
                0xddfc5c0a1aef30b0bf1f6125e0a9da7ffdbecffd94c80e4dc6036ca1efa4d96f::player_registry::add_referral_reward(arg1, v3, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v6, v7), arg5), arg4);
            };
        };
