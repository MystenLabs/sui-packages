module 0xb0afb87c57d53ee79aee3252da9379b1025be9f517ca4f4e338ba2f1a7d6b85::kitty {
    ...
    struct KittyEventCreatedV2 has copy, drop {
        event_id: 0x2::object::ID,
        organizer: address,
        goal_usd_cents: u64,
    ...
    struct KittyContribution has copy, drop {
        event_id: 0x2::object::ID,
        payment_type: u8,
        amount_mist: u64,
    }

    struct KittyClosed has copy, drop {
        event_id: 0x2::object::ID,
        all_paid: bool,
    }
    ...
    public entry fun close_event<T0>(arg0: &mut KittyEvent<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.active = false;
        let v0 = KittyClosed{
            event_id : 0x2::object::id<KittyEvent<T0>>(arg0),
            all_paid : count_all_paid<T0>(arg0),
        };
        0x2::event::emit<KittyClosed>(v0);
    }
    ...
    public entry fun contribute_coin<T0>(arg0: &mut KittyEvent<T0>, arg1: 0x1::string::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        *0x2::vec_map::get_mut<0x1::string::String, u8>(&mut arg0.statuses, &arg1) = 3;
        ...
        let v0 = KittyContribution{
            event_id     : 0x2::object::id<KittyEvent<T0>>(arg0),
            payment_type : 3,
            amount_mist  : 0x2::coin::value<T0>(&arg2),
        };
        0x2::event::emit<KittyContribution>(v0);
    }
    ...
    fun count_all_paid<T0>(arg0: &KittyEvent<T0>) : bool {
        let v0 = 0;
        while (v0 < 0x2::vec_map::size<0x1::string::String, u8>(&arg0.statuses)) {
            let (_, v2) = 0x2::vec_map::get_entry_by_idx<0x1::string::String, u8>(&arg0.statuses, v0);
            if (*v2 == 0) {
                return false
            };
            v0 = v0 + 1;
    ...
    public entry fun create_event<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<0x1::string::String>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = KittyEventCreatedV2{
            event_id          : 0x2::object::id<KittyEvent<T0>>(&v2),
            organizer         : 0x2::tx_context::sender(arg6),
            goal_usd_cents    : arg4,
            participant_count : (0x1::vector::length<0x1::string::String>(&arg3) as u64),
            has_deadline      : arg5 > 0,
        };
        0x2::event::emit<KittyEventCreatedV2>(v4);
        ...
        while (v0 < 0x1::vector::length<0x1::string::String>(&arg1)) {
            ...
            if (0x2::vec_map::contains<0x1::string::String, u8>(&arg0.statuses, &v1) && *0x2::vec_map::get<0x1::string::String, u8>(&arg0.statuses, &v1) == 0) {
                *0x2::vec_map::get_mut<0x1::string::String, u8>(&mut arg0.statuses, &v1) = 2;
                let v2 = KittyContribution{
                    event_id     : 0x2::object::id<KittyEvent<T0>>(arg0),
                    payment_type : 2,
                    amount_mist  : 0,
                };
                0x2::event::emit<KittyContribution>(v2);
            };
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun organizer_withdraw<T0>(arg0: &mut KittyEvent<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (count_all_paid<T0>(arg0)) {
            arg0.active = false;
            let v3 = KittyClosed{
                event_id : 0x2::object::id<KittyEvent<T0>>(arg0),
                all_paid : true,
            };
            0x2::event::emit<KittyClosed>(v3);
        };
    }
