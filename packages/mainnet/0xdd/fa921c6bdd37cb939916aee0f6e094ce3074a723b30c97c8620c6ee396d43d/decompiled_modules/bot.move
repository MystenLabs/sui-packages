module 0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::bot {
    ...
    struct ArbitrageBot has key {
        ...
        min_trade_size: u64,
        max_trade_size: u64,
        total_profit_usdc: 0x2::balance::Balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>,
        total_profit_usdt: 0x2::balance::Balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>,
        trading_balance_usdc: 0x2::balance::Balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>,
        trading_balance_usdt: 0x2::balance::Balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>,
        active: bool,
    ...
    public entry fun deposit_usdc(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(&mut arg0.trading_balance_usdc, 0x2::coin::into_balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(arg1));
    ...
    public entry fun deposit_usdt(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(&mut arg0.trading_balance_usdt, 0x2::coin::into_balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(arg1));
        let v1 = FundsDeposited{
            amount    : v0,
            is_usdc   : false,
            timestamp : 0x2::tx_context::epoch(arg2),
    ...
    public fun get_total_profit_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(&arg0.total_profit_usdc)
    }

    public fun get_total_profit_usdt(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(&arg0.total_profit_usdt)
    }

    public fun get_trading_balance_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(&arg0.trading_balance_usdc)
    }

    public fun get_trading_balance_usdt(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(&arg0.trading_balance_usdt)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = ArbitrageBot{
            ...
            total_profit_usdc    : 0x2::balance::zero<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(),
            total_profit_usdt    : 0x2::balance::zero<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(),
            trading_balance_usdc : 0x2::balance::zero<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(),
            trading_balance_usdt : 0x2::balance::zero<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(),
            active               : true,
    ...
    public entry fun withdraw_profits(arg0: &mut ArbitrageBot, arg1: u64, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>>(0x2::coin::from_balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(0x2::balance::split<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDC>(&mut arg0.total_profit_usdc, arg1), arg3), arg0.owner);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>>(0x2::coin::from_balance<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(0x2::balance::split<0xddfa921c6bdd37cb939916aee0f6e094ce3074a723b30c97c8620c6ee396d43d::coins::USDT>(&mut arg0.total_profit_usdt, arg1), arg3), arg0.owner);
        };
    }
