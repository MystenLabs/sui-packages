module 0xddd3b5f3ea398a23c9184cc6c19bdcb2c67f4e353e2e01704340f06cb01ec11f::pppp {
    ...
    public fun mint_max_supply(arg0: &mut 0x2::coin::TreasuryCap<PPPP>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<PPPP> {
        assert!(0x2::coin::total_supply<PPPP>(arg0) + 100000000000 <= 100000000000, 0);
        0x2::coin::mint<PPPP>(arg0, 100000000000, arg1)
    }
