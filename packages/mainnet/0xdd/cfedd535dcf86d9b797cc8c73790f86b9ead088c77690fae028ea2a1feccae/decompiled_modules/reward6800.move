module 0xddcfedd535dcf86d9b797cc8c73790f86b9ead088c77690fae028ea2a1feccae::reward6800 {
    struct REWARD6800 has drop {
        dummy_field: bool,
    }

    struct TICKET_6800 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6800(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6800>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6800>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6800, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6800>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6800>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6800>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6800>>(v5, 0x2::tx_context::sender(arg1));
    }
