module 0xdd81708d8adcc967532ce0abdcaa6497b271a54308fe4061317c7455dc98536a::sgd {
    struct SGD has drop {
        dummy_field: bool,
    }

    fun init(arg0: SGD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/V0p50xLkpIAS5l4NX9hQ2Rj-ssUGFJyBs0i3eDIaXuU";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/V0p50xLkpIAS5l4NX9hQ2Rj-ssUGFJyBs0i3eDIaXuU"))
        };
