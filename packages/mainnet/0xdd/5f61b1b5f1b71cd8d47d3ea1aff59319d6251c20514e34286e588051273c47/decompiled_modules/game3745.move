module 0xdd5f61b1b5f1b71cd8d47d3ea1aff59319d6251c20514e34286e588051273c47::game3745 {
    struct GAME3745 has drop {
        dummy_field: bool,
    }

    struct TICKET_3745 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3745(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3745>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3745>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME3745, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3745>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3745>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3745>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3745>>(v5, 0x2::tx_context::sender(arg1));
    }
