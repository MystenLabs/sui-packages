module 0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::storage {
    ...
    public entry fun init_reserve<T0>(arg0: &StorageAdminCap, arg1: &0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::pool::PoolAdminCap, arg2: &0x2::clock::Clock, arg3: &mut Storage, arg4: u8, arg5: bool, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: u256, arg16: u256, arg17: u256, arg18: &0x2::coin::CoinMetadata<T0>, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = ReserveData{
            ...
            current_supply_index  : 0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::ray_math::ray(),
            current_borrow_index  : 0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
        ...
        0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::pool::create_pool<T0>(arg1, 0x2::coin::get_decimals<T0>(arg18), arg19);
    }
    ...
    public fun set_base_rate(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).borrow_rate_factors.base_rate = arg3;
    }

    public fun set_borrow_cap(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).borrow_cap_ceiling = arg3;
    }

    public fun set_jump_rate_multiplier(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).borrow_rate_factors.jump_rate_multiplier = arg3;
    }

    public fun set_liquidation_bonus(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).liquidation_factors.bonus = arg3;
    }

    public fun set_liquidation_ratio(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).liquidation_factors.ratio = arg3;
    }

    public fun set_liquidation_threshold(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).liquidation_factors.threshold = arg3;
    }

    public fun set_ltv(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).ltv = arg3;
    }

    public fun set_multiplier(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).borrow_rate_factors.multiplier = arg3;
    }

    public fun set_optimal_utilization(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
    ...
    public fun set_reserve_factor(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).borrow_rate_factors.reserve_factor = arg3;
    }

    public fun set_supply_cap(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
        0x2::table::borrow_mut<u8, ReserveData>(&mut arg1.reserves, arg2).supply_cap_ceiling = arg3;
    }

    public fun set_treasury_factor(arg0: &StorageAdminCap, arg1: &mut Storage, arg2: u8, arg3: u256) {
        version_verification(arg1);
    ...
    public entry fun version_migrate(arg0: &StorageAdminCap, arg1: &mut Storage) {
        assert!(arg1.version < 1, 43001);
        arg1.version = 1;
    }

    fun version_verification(arg0: &Storage) {
        assert!(arg0.version == 1, 43000);
    }

    public fun withdraw_treasury<T0>(arg0: &StorageAdminCap, arg1: &0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::pool::PoolAdminCap, arg2: &mut Storage, arg3: u8, arg4: &mut 0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::pool::Pool<T0>, arg5: u64, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(get_coin_type(arg2, arg3) == 0x1::type_name::into_string(0x1::type_name::get<T0>()), 43007);
        let v0 = 0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::pool::unnormal_amount<T0>(arg4, (get_treasury_balance(arg2, arg3) as u64));
        let v1 = arg5;
        if (arg5 < v0) {
            v1 = v0;
        };
        0x6cef539ba34b9071f774f866d83dc839e0a87c6de82291d20aa5899b7290f9b2::pool::withdraw_reserve_balance<T0>(arg1, arg4, v1, arg6, arg7);
    }
