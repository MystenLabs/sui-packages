module 0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::dubhe_math {
    ...
    public fun safe_div(arg0: u256, arg1: u256) : u256 {
        0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::error::division_by_zero(arg1 != 0);
        arg0 / arg1
    }
    ...
    public fun safe_mul(arg0: u256, arg1: u256) : u256 {
        ...
        let v0 = arg0 * arg1;
        0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::error::math_overflow(v0 / arg0 == arg1);
        v0
    }
    ...
    public(friend) fun windows(arg0: &vector<u256>, arg1: u64) : vector<vector<u256>> {
        0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::error::invalid_window_size(arg1 > 0);
