module 0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::address_system {
    fun base58_decode(arg0: 0x1::ascii::String) : vector<u8> {
        ...
        while (v4 < 0x1::vector::length<u8>(v1)) {
            ...
            0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::error::invalid_solana_address(v6);
            let v8 = v5;
            let v9 = 32 - 1;
            while (v9 < 32) {
    ...
    public fun evm_to_sui(arg0: 0x1::ascii::String) : address {
        ...
        0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::error::invalid_evm_address(0x1::vector::length<u8>(&v0) == 20);
        let v1 = b"";
        let v2 = 0;
        while (v2 < 12) {
    ...
    public fun solana_to_sui(arg0: 0x1::ascii::String) : address {
        ...
        0xdd59a0e210585ec38da6d966d2936c7476b9e08b3cc2f785ca998d084bf24c81::error::invalid_solana_address(0x1::vector::length<u8>(&v0) == 32);
