module 0xf803f8265a15313a737ab1aef7f167404bcd9084e755c15b0ace6577069fa938::cnsnft7210 {
    struct CNSNFT7210 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7210, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7210>(arg0, arg1);
