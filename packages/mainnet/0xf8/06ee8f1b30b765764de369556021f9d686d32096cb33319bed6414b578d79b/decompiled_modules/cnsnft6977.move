module 0xf806ee8f1b30b765764de369556021f9d686d32096cb33319bed6414b578d79b::cnsnft6977 {
    struct CNSNFT6977 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6977, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6977>(arg0, arg1);
