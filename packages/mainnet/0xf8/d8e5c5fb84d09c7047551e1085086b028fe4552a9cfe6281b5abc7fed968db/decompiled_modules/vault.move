module 0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::vault {
    ...
    public entry fun burn_sgc<T0>(arg0: &mut AdminAddr_fee, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::SGC>>(0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::mini_swap::swap<0x2::sui::SUI, 0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::SGC>(arg1, 0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::mini_swap::swap<T0, 0x2::sui::SUI>(arg1, v0, arg2), arg2), @0x0);
    }
    ...
    fun claim_reward_all<T0, T1, T2>(arg0: &Reward_coin_type<T0, T1>, arg1: &mut AdminAddr_fee, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T0>, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T1>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg6: &mut SavingsData<T2>, arg7: &0x2::clock::Clock, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        if (0x1::vector::length<address>(&arg0.adderlis_t) > 0) {
            ...
            if (0x2::coin::value<T0>(&v0) > 0) {
                ...
                let v2 = Outcome<T0>{
                    win       : 0x2::coin::value<T0>(&v0),
                    game_type : arg6.time_per_round,
                    adder     : arg8,
                };
                0x2::event::emit<Outcome<T0>>(v2);
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v0, arg8);
            };
            if (&arg0.adderlis_t != &arg0.adderlis_d) {
                let v3 = claim_reward<T1, T2>(arg6, arg0.strlis_d, arg0.adderlis_d, arg4, arg5, arg3, arg7, arg9);
                if (0x2::coin::value<T1>(&v3) > 0) {
                    let v4 = 0x2::coin::split<T1>(&mut v3, 0x2::coin::value<T1>(&v3) / (arg1.fee as u64), arg9);
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v3, arg8);
                    deposit_fee<T1>(arg1, v4, arg9);
                    let v5 = Outcome<T1>{
                        win       : 0x2::coin::value<T1>(&v3),
                        game_type : arg6.time_per_round,
                        adder     : arg8,
                    };
                    0x2::event::emit<Outcome<T1>>(v5);
                } else {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v3, arg8);
                };
            };
    ...
    public entry fun entry_get_sgc_coin<T0>(arg0: &mut 0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::Minter, arg1: &mut 0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg4) / 1000;
        0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg5)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg5))) / arg3.sgc_weight, arg5);
    ...
    fun get_sgc_coin<T0>(arg0: &mut 0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::Minter, arg1: &mut 0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg5) / 1000;
        if (arg4) {
            0xf8d8e5c5fb84d09c7047551e1085086b028fe4552a9cfe6281b5abc7fed968db::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg6)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg6))) / arg3.sgc_weight, arg6);
