module 0xc45cd4efcd2963bdee861ddef337f2eba4e3815ec425ae216f8bf0bd21e81ee9::move_pump {
    ...
    public entry fun buy<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, Pool<T0>>(&mut arg0.id, 0x1::string::from_ascii(v2));
        ...
        assert!(v8 >= v6 + v7, 6);
        let v9 = 0x2::coin::split<0x2::sui::SUI>(&mut arg1, v7, arg5);
        let v10 = 0x2::coin::zero<T0>(arg5);
        let (v11, v12) = swap<T0>(v3, v10, arg1, v5, v8 - v6 - v7, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v12, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v11, v0);
        let v13 = arg0.admin;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v9, v13);
        if (v4 == v5) {
            transfer_pool<T0>(v3, arg2, v13, arg0.graduated_fee, arg4, arg5);
        };
        let v14 = TradedEvent{
            is_buy                 : true,
            user                   : v0,
    ...
    public entry fun create<T0>(arg0: &mut Configuration, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::clock::Clock, arg3: 0x1::ascii::String, arg4: 0x1::ascii::String, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::type_name::get<T0>();
        let v2 = 0x1::type_name::get_module(&v1);
        0x2::dynamic_object_field::add<0x1::string::String, Pool<T0>>(&mut arg0.id, 0x1::string::from_ascii(v2), v0);
    ...
    public fun skim<T0>(arg0: &mut Configuration, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::type_name::get<T0>();
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, Pool<T0>>(&mut arg0.id, 0x1::string::from_ascii(0x1::type_name::get_module(&v1)));
