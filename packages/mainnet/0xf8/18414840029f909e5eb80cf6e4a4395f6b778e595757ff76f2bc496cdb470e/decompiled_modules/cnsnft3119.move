module 0xf818414840029f909e5eb80cf6e4a4395f6b778e595757ff76f2bc496cdb470e::cnsnft3119 {
    struct CNSNFT3119 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3119, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5031"));
        let v4 = 0x2::package::claim<CNSNFT3119>(arg0, arg1);
