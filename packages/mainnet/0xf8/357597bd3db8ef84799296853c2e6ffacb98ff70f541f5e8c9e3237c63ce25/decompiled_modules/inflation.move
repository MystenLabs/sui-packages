module 0xf8357597bd3db8ef84799296853c2e6ffacb98ff70f541f5e8c9e3237c63ce25::inflation {
    ...
    fun init(arg0: INFLATION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<INFLATION>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Inflation ")))), trim_right(b"This will keep increasing       "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
