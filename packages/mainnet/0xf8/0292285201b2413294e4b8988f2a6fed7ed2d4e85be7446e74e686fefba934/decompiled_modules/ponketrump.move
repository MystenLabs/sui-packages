module 0xf80292285201b2413294e4b8988f2a6fed7ed2d4e85be7446e74e686fefba934::ponketrump {
    ...
    fun init(arg0: PONKETRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<PONKETRUMP>(arg0, 9, b"PonkeTrump", b"PonkeTrump", b"PonkeTrump Meme Coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), false, arg1);
        let v3 = v0;
