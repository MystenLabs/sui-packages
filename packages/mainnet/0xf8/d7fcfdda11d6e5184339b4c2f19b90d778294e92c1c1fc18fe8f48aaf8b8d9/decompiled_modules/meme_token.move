module 0xf8d7fcfdda11d6e5184339b4c2f19b90d778294e92c1c1fc18fe8f48aaf8b8d9::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"TC", b"Test Coin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-12T17-11-48.207Z-toji-fushiguro-anime-character-mqjc41j5m0opdlf8.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Test Coin"),
            symbol     : 0x1::string::utf8(b"TC"),
            decimals   : 9,
