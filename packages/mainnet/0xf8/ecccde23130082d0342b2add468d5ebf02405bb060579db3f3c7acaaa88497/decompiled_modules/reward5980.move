module 0xf8ecccde23130082d0342b2add468d5ebf02405bb060579db3f3c7acaaa88497::reward5980 {
    struct REWARD5980 has drop {
        dummy_field: bool,
    }

    struct TICKET_5980 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5980(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5980>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5980>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5980, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5980>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5980>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5980>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5980>>(v5, 0x2::tx_context::sender(arg1));
    }
