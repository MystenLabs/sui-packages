module 0xf88075b8ad158f71e3b0df8532a28e619e7859c2147a146cf07faa6cf6e9e4f4::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        ...
        assert!(points_of(arg0, arg1) >= arg2, 0xf88075b8ad158f71e3b0df8532a28e619e7859c2147a146cf07faa6cf6e9e4f4::errors::insufficient_points());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<Recorder>(v0);
        let v1 = 0x2::tx_context::sender(arg0);
        let v2 = AdminCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<AdminCap>(v2, v1);
        let v3 = RecordCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<RecordCap>(v3, v1);
    }
    ...
    public fun new_record_cap(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) : RecordCap {
        RecordCap{id: 0x2::object::new(arg1)}
    }
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0xf88075b8ad158f71e3b0df8532a28e619e7859c2147a146cf07faa6cf6e9e4f4::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
            record(arg0, arg1, *0x1::vector::borrow<address>(&arg2, v1), *0x1::vector::borrow<u64>(&arg3, v1));
            v1 = v1 + 1;
        };
    }
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 >= earned_of(arg0, arg1), 0xf88075b8ad158f71e3b0df8532a28e619e7859c2147a146cf07faa6cf6e9e4f4::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
