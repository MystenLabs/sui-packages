module 0xf80e71b9fe884d3170e04f85ea91151f569e2077a909d05ac90d4cd497bc3037::SUIREWARD_W {
    ...
    public entry fun RewardFrom(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUIREWARD_PASS{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/rewardsuicom/rewardsuicom_0625_2.jpg"),
    ...
    fun init(arg0: SUIREWARD_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/rewardsuicom/rewardsuicom_0625_2.jpg"));
