module 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::treasury {
    ...
    public fun disable_version(arg0: &mut Treasury, arg1: &0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::multisig_config::MultisigConfig, arg2: &0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::admin::AdminCap, arg3: u16, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 <= 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::helper::current_version(), 3);
    ...
    public fun enable_version(arg0: &mut Treasury, arg1: &0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::multisig_config::MultisigConfig, arg2: &0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::admin::AdminCap, arg3: u16, arg4: &mut 0x2::tx_context::TxContext) {
        0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::multisig_config::validate_sender_is_admin_multisig(arg1, arg4);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Treasury{
            ...
            allowed_versions            : 0x2::vec_set::singleton<u16>(0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::helper::current_version()),
    ...
    public(friend) fun verify_version(arg0: &Treasury) {
        let v0 = 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::helper::current_version();
        assert!(0x2::vec_set::contains<u16>(&arg0.allowed_versions, &v0), 5);
    }

    public fun withdraw_coverage_fee<T0>(arg0: &mut Treasury, arg1: 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::AdminTicket, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version(arg0);
        0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::validate_ticket(&arg1, 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::withdraw_coverage_fee_ticket_type(), arg2, arg3);
        0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::destroy_ticket(arg1, arg2);
        let v0 = ChargedFeeKey<T0>{dummy_field: false};
        if (0x2::bag::contains<ChargedFeeKey<T0>>(&arg0.deep_reserves_coverage_fees, v0)) {
    ...
    public fun withdraw_deep_reserves(arg0: &mut Treasury, arg1: 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::AdminTicket, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
        verify_version(arg0);
        0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::validate_ticket(&arg1, 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::withdraw_deep_reserves_ticket_type(), arg3, arg4);
    ...
    public fun withdraw_protocol_fee<T0>(arg0: &mut Treasury, arg1: 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::AdminTicket, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version(arg0);
        0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::validate_ticket(&arg1, 0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::withdraw_protocol_fee_ticket_type(), arg2, arg3);
        0xf87e715624ddec186d8b5360907db94f7d0928111b655244739a98d6004b2fce::ticket::destroy_ticket(arg1, arg2);
        let v0 = ChargedFeeKey<T0>{dummy_field: false};
        if (0x2::bag::contains<ChargedFeeKey<T0>>(&arg0.protocol_fees, v0)) {
