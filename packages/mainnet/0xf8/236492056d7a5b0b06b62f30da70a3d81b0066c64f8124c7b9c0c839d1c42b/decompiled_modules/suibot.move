module 0xf8236492056d7a5b0b06b62f30da70a3d81b0066c64f8124c7b9c0c839d1c42b::suibot {
    ...
    fun init(arg0: SUIBOT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIBOT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUIBOT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Advance robot on sui "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicp2ynffszd5kvopxvgay6pwi2isphimf6pvt2fxmmgc5p6l2vrnq"));
