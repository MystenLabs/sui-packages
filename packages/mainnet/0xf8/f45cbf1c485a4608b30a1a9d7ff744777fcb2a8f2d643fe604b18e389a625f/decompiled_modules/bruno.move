module 0xf8f45cbf1c485a4608b30a1a9d7ff744777fcb2a8f2d643fe604b18e389a625f::bruno {
    ...
    entry fun burn(arg0: &mut ProtectedTreasury, arg1: &AdminRegistry, arg2: 0x2::coin::Coin<BRUNO>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::coin::value<BRUNO>(&arg2);
        let (v2, v3) = if (v1 > arg3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<BRUNO>>(arg2, v0);
            (0x2::coin::split<BRUNO>(&mut arg2, arg3, arg5), v1 - arg3)
        } else {
            assert!(v1 == arg3, 1302);
            (arg2, 0)
        };
        ...
        0x2::coin::burn<BRUNO>(v6, v2);
        assert!(arg0.current_supply == 0x2::coin::total_supply<BRUNO>(borrow_cap(arg0)), 1404);
    }

    entry fun total_supply(arg0: &ProtectedTreasury) : u64 {
        0x2::coin::total_supply<BRUNO>(borrow_cap(arg0))
    }
    ...
    fun borrow_cap(arg0: &ProtectedTreasury) : &0x2::coin::TreasuryCap<BRUNO> {
        let v0 = TreasuryCapKey{dummy_field: false};
        0x2::dynamic_object_field::borrow<TreasuryCapKey, 0x2::coin::TreasuryCap<BRUNO>>(&arg0.id, v0)
    }

    fun borrow_cap_mut(arg0: &mut ProtectedTreasury) : &mut 0x2::coin::TreasuryCap<BRUNO> {
        let v0 = TreasuryCapKey{dummy_field: false};
        0x2::dynamic_object_field::borrow_mut<TreasuryCapKey, 0x2::coin::TreasuryCap<BRUNO>>(&mut arg0.id, v0)
    }
    ...
    fun init(arg0: BRUNO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BRUNO>(arg0, 9, b"BRUNO", b"Bruno", b"bruno token description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://apricot-big-lungfish-670.mypinata.cloud/ipfs/bafkreif27fbndiey3qbl74ctiuro32hedyprhzbmkbfsfibl5zaa74zevi"))), arg1);
        ...
        0x2::dynamic_object_field::add<TreasuryCapKey, 0x2::coin::TreasuryCap<BRUNO>>(&mut v4.id, v5, v0);
        let v6 = &mut v4;
        v4.current_supply = 1000000000000000000;
        let v7 = MintEvent{
            amount             : 1000000000000000000,
            recipient          : @0x56215153ec9523995bb4c284898264a6955a19a410874ea7adffd6a19132baf5,
            minter             : v2,
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<BRUNO>>(0x2::coin::mint<BRUNO>(borrow_cap_mut(v6), 1000000000000000000, arg1), @0x56215153ec9523995bb4c284898264a6955a19a410874ea7adffd6a19132baf5);
        0x2::transfer::share_object<ProtectedTreasury>(v4);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<BRUNO>>(v1);
