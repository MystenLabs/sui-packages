module 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::dapp {
    ...
    struct Contract<phantom T0> has key {
        ...
        withdraw_charges: u8,
        withdraw_ratio: u8,
        global_network_data: 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::GlobalNetworkData,
        vault: Vault,
        admin: address,
        rebot: address,
    }
    ...
    public fun adminWithdrawAmount<T0, T1>(arg0: &mut Contract<T1>, arg1: u64, arg2: address, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_admin_sui_amount(&mut arg0.global_network_data, arg1);
    }
    ...
    public entry fun adminWithdraw_pre<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_admin_pre_amount(&mut arg0.global_network_data, arg2);
    }

    fun apply_reward(arg0: &mut User, arg1: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::GlobalNetworkData, arg2: u64, arg3: bool) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_user_balance(arg1, v1);
        arg0.total_earning = arg0.total_earning + v1;
        arg0.today_earning = arg0.today_earning + v1;
        handler_out(arg1, arg0);
        if (arg3) {
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_static_power_distributed(arg1, v1);
        } else {
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_dynamic_power_distributed_amount(arg1, v1);
        };
    }
    ...
    public entry fun bindInviter<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_user(&mut arg0.global_network_data, 1);
    }

    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &mut 0xf64c53c15b63226cff5e81f5dfcaa7d7f2743e93dfeded0a83b5f5db4f19ccff::implements::Global, arg2: &0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::PriceOracle, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg3);
        assert!(v0 > 0, 13906837872310222847);
        let v1 = 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::get_sui_amount(arg2, v0);
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_use_pre_buy_quota(&mut arg0.global_network_data, v1, 0x2::coin::value<T1>(&v3));
    }
    ...
    fun calc_level_diff(arg0: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 100) {
            ...
            if (v3 > 0) {
                ...
                if (v2.invest_amount > 0) {
                    ...
                    handler_out(arg0, v2);
                    0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::addTeamReward(arg0, v3, v6);
                };
            };
            v0 = v2.inviter;
            v1 = v1 + 1;
    ...
    public entry fun claimBalance<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::sub_total_user_balance(v0, arg2);
        let v2 = arg2 / 10;
        let v3 = v2 / 2;
        let v4 = 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::get_sui_amount(arg1, arg2);
        let v5 = withdrawSui<T0>(&arg0.vault, v4, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_claimed_amount(v0, arg2, v4, v2);
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_pre_burn_usdt_amount(v0, v3);
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_share_rank_dividend_amount(v0, v3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v5, 0x2::tx_context::sender(arg10));
    }

    public entry fun claimInterest<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::PriceOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::get_usdt_from_pre(arg2, v6);
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_caimed_stake_interest(v3, v6, v7);
    ...
    public fun freezeUser<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2 == 1) {
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_freeze_user(&mut arg0.global_network_data, 1);
        } else {
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::sub_total_freeze_user(&mut arg0.global_network_data, 1);
        };
    }
    ...
    fun handler_out(arg0: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::GlobalNetworkData, arg1: &mut User) {
        let v0 = 0;
        let v1 = 0;
        while (0x1::vector::length<Order>(&arg1.orders) > v0) {
            ...
            if (v2.status == 0 && arg1.total_earning >= v3) {
                ...
                0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::sub_total_asset_invested(arg0, v2.amount);
            };
            v0 = v0 + 1;
        };
    }
    ...
    public fun init_contract<T0>(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = Contract<T0>{
            ...
            withdraw_charges    : 10,
            withdraw_ratio      : 100,
            global_network_data : 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::new(),
            vault               : v4,
    ...
    public entry fun investment<T0, T1, T2>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::PriceOracle, arg4: u64, arg5: u8, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg10: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::rank_list::TodayRank, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 > 0) {
            ...
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_sui_invested(v3, v6, arg4 * (arg5 as u64) / 100);
        } else {
        ...
        let v8 = 0;
        if (v7 > 0) {
            let v9 = 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::get_pre_amount(arg3, arg4 * (v7 as u64) / 100);
            let v10 = 0x2::coin::value<T1>(&arg2);
            v8 = v10;
            assert!(v10 >= v9, 2);
            0x2::balance::join<T1>(&mut arg0.pre_balance, 0x2::coin::into_balance<T1>(arg2));
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_pre_invested(v3, v10, v9);
        } else {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_asset_invested(v3, arg4);
        if (v11) {
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_effective_user(v3, 1);
        };
        let v13 = Order{
    ...
    fun release_dynamic_power(arg0: &mut User, arg1: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::GlobalNetworkData) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::sub_total_dynamic_power(arg1, v0);
        apply_reward(arg0, arg1, v0, false);
    }

    fun release_static_power(arg0: &mut User, arg1: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::GlobalNetworkData) {
    ...
    public entry fun stake<T0>(arg0: &mut Contract<T0>, arg1: &0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_cumulative_stake(&mut arg0.global_network_data, v0);
        let v3 = StakeOrder{
            ...
            cycle              : arg3,
            pre_amount         : v0,
            amount             : 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::price_oracle::get_pre_amount(arg1, v0),
            interest           : 0,
    ...
    public entry fun unStake<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_redemption_pre(&mut arg0.global_network_data, v4);
        0x1::vector::borrow_mut<StakeOrder>(&mut 0x2::table::borrow_mut<address, User>(&mut arg0.users, v0).stake_orders, arg1 - 1).status = 1;
    }

    fun update_dynamic_power(arg0: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: bool) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        let v1 = 1;
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            ...
            if (v3 > 0) {
                ...
                if (v1 == 1 && arg4) {
                    let v5 = v4 / 10;
                    0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_user_balance(arg0, v5);
                    ...
                    0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_dynamic_power_distributed(arg0, v4 - v5);
                    0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_share_reward(arg0, v5);
                } else {
                    v2.dynamic_power = v2.dynamic_power + v4;
                    0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_dynamic_power_distributed(arg0, v4);
                };
                if (v1 == 1) {
                    v2.quota = v2.quota + v4;
                    0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::admin::add_total_pre_buy_quota(arg0, v4);
                };
            };
            v0 = v2.inviter;
            v1 = v1 + 1;
    ...
    fun update_share_performance(arg0: &mut 0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::rank_list::TodayRank, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        if (0x1::option::is_some<address>(&v0)) {
            ...
            0xf8912f2d995116956fefb8e293251cf13c4cf0fd91cdce6272963ac6646ec006::rank_list::add_performance(arg0, arg2, arg3, arg4);
        };
    }
