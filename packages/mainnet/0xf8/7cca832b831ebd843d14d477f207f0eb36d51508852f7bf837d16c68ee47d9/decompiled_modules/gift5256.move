module 0xf87cca832b831ebd843d14d477f207f0eb36d51508852f7bf837d16c68ee47d9::gift5256 {
    struct GIFT5256 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift5256(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT5256, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5256>(arg0, arg1);
