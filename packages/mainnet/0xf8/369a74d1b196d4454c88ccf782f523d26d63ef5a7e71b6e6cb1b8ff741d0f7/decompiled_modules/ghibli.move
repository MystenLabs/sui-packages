module 0xf8369a74d1b196d4454c88ccf782f523d26d63ef5a7e71b6e6cb1b8ff741d0f7::ghibli {
    ...
    fun init(arg0: GHIBLI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BUdeKJG1dz6DWaPKkqzeNQSBBoBUt48ztYphEb3apump.png?size=lg&key=7ebbf6                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GHIBLI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GHIBLI  ")))), trim_right(b"Ghibli AI                       "), trim_right(b"Ghibli AI is a revolutionary platform that uses artificial intelligence to generate stunning artwork in the style of Studio Ghibli animations.                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
