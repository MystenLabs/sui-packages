module 0x88e900326dda4d837dd13144034bc3c339917cb22b3cdc87ff1bddde3e4389e1::gnv_presale {
    ...
    struct ReservedStake has store {
        amount: u64,
        lock_days: u64,
        apy_bp: u64,
        start_ms: u64,
    ...
    struct RCommitKey has copy, drop, store {
        dummy_field: bool,
    }

    struct EventReservedStaked has copy, drop {
        staker: address,
        amount: u64,
        lock_days: u64,
        apy_bp: u64,
    ...
    struct EventReservedUnstaked has copy, drop {
        staker: address,
        amount: u64,
        forfeited_early: bool,
    }
    ...
    public fun get_reserved_stake<T0>(arg0: &PresaleState<T0>, arg1: address) : (u64, u64, u64, u64) {
        if (0x2::dynamic_field::exists_<address>(&arg0.id, arg1)) {
            let v4 = 0x2::dynamic_field::borrow<address, ReservedStake>(&arg0.id, arg1);
            (v4.amount, v4.lock_days, v4.apy_bp, v4.start_ms)
        } else {
            (0, 0, 0, 0)
        }
    }
    ...
    fun r_committed<T0>(arg0: &PresaleState<T0>) : u64 {
        let v0 = RCommitKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<RCommitKey>(&arg0.id, v0)) {
            let v2 = RCommitKey{dummy_field: false};
            *0x2::dynamic_field::borrow<RCommitKey, u64>(&arg0.id, v2)
        } else {
            0
        }
    }

    fun r_lerp(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        if (arg4 <= arg0) {
            return arg1
        };
        if (arg4 >= arg2) {
    ...
    fun r_set_committed<T0>(arg0: &mut PresaleState<T0>, arg1: u64) {
        let v0 = RCommitKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<RCommitKey>(&arg0.id, v0)) {
            let v1 = RCommitKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<RCommitKey, u64>(&mut arg0.id, v1) = arg1;
        } else {
            let v2 = RCommitKey{dummy_field: false};
            0x2::dynamic_field::add<RCommitKey, u64>(&mut arg0.id, v2, arg1);
        };
    }
    ...
    public fun reserved_accrued<T0>(arg0: &PresaleState<T0>, arg1: address, arg2: u64) : u64 {
        if (!0x2::dynamic_field::exists_<address>(&arg0.id, arg1)) {
            return 0
        };
        let v0 = 0x2::dynamic_field::borrow<address, ReservedStake>(&arg0.id, arg1);
        let v1 = if (arg2 > v0.start_ms) {
            arg2 - v0.start_ms
        } else {
            0
        };
        let v2 = (((v0.amount as u128) * (v0.apy_bp as u128) * (v1 as u128) / (10000 as u128) * (31536000000 as u128)) as u64);
        let v3 = reserved_max_reward(v0.amount, v0.apy_bp, v0.lock_days);
        if (v2 > v3) {
            v3
        } else {
            v2
    ...
    public fun reserved_apy_bp(arg0: u64) : u64 {
        if (arg0 < 30) {
            return 200
        };
        if (arg0 <= 30) {
        ...
        if (arg0 <= 90) {
            return r_lerp(30, 500, 90, 1200, arg0)
        };
        if (arg0 <= 180) {
            return r_lerp(90, 1200, 180, 2500, arg0)
        };
        if (arg0 <= 365) {
            return r_lerp(180, 2500, 365, 5000, arg0)
        };
        if (arg0 <= 730) {
            return r_lerp(365, 5000, 730, 8000, arg0)
        };
        if (arg0 <= 1825) {
            return r_lerp(730, 8000, 1825, 12000, arg0)
        };
        12000
    }

    public fun reserved_available<T0>(arg0: &PresaleState<T0>, arg1: address) : u64 {
        if (!0x2::table::contains<address, Reservation>(&arg0.reservations, arg1)) {
            return 0
        };
        let v0 = 0x2::table::borrow<address, Reservation>(&arg0.reservations, arg1);
        let v1 = v0.total_gnv - v0.claimed_gnv;
        if (0x2::dynamic_field::exists_<address>(&arg0.id, arg1)) {
            let v3 = 0x2::dynamic_field::borrow<address, ReservedStake>(&arg0.id, arg1);
            if (v1 > v3.amount) {
                v1 - v3.amount
            } else {
                0
    ...
    public fun reserved_committed_total<T0>(arg0: &PresaleState<T0>) : u64 {
        r_committed<T0>(arg0)
    }

    public fun reserved_max_reward(arg0: u64, arg1: u64, arg2: u64) : u64 {
        (((arg0 as u128) * (arg1 as u128) * (arg2 as u128) / (365 as u128) * (10000 as u128)) as u64)
    }
    ...
    public fun stake_reserved<T0>(arg0: &mut PresaleState<T0>, arg1: &0x1e055ea18d894fe815280a65d3fe51581186c5a7b8293e153dc31324d4ca1adc::gnv_staking::StakingPool, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x2::table::contains<address, Reservation>(&arg0.reservations, v0), 5);
        assert!(arg2 > 0, 12);
        assert!(arg3 >= 1 && arg3 <= 1825, 32);
        assert!(!0x2::dynamic_field::exists_<address>(&arg0.id, v0), 30);
        let v1 = 0x2::table::borrow<address, Reservation>(&arg0.reservations, v0);
        assert!(arg2 <= v1.total_gnv - v1.claimed_gnv, 12);
        let v2 = reserved_apy_bp(arg3);
        let v3 = reserved_max_reward(arg2, v2, arg3);
        let v4 = r_committed<T0>(arg0);
        assert!(v4 + v3 <= 0x1e055ea18d894fe815280a65d3fe51581186c5a7b8293e153dc31324d4ca1adc::gnv_staking::pool_unused_rewards(arg1), 33);
        let v5 = ReservedStake{
            amount    : arg2,
            lock_days : arg3,
            apy_bp    : v2,
            start_ms  : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::dynamic_field::add<address, ReservedStake>(&mut arg0.id, v0, v5);
        r_set_committed<T0>(arg0, v4 + v3);
        let v6 = EventReservedStaked{
            staker     : v0,
            amount     : arg2,
            lock_days  : arg3,
            apy_bp     : v2,
        ...
        0x2::event::emit<EventReservedStaked>(v6);
    }
    ...
    public fun unstake_reserved<T0>(arg0: &mut PresaleState<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::dynamic_field::exists_<address>(&arg0.id, v0), 31);
        let ReservedStake {
            amount    : v1,
            lock_days : v2,
            apy_bp    : v3,
            start_ms  : v4,
        } = 0x2::dynamic_field::remove<address, ReservedStake>(&mut arg0.id, v0);
        let v5 = reserved_max_reward(v1, v3, v2);
        let v6 = r_committed<T0>(arg0);
        let v7 = if (v6 > v5) {
            v6 - v5
        } else {
            0
        };
        r_set_committed<T0>(arg0, v7);
        let v8 = EventReservedUnstaked{
            staker          : v0,
            amount          : v1,
            forfeited_early : 0x2::clock::timestamp_ms(arg1) < v4 + v2 * 86400000,
        };
        0x2::event::emit<EventReservedUnstaked>(v8);
    }
