module 0xf8993e3e4cb78e36b686f7ac18c76228e28ba09c7323712bce6e432f38c01008::reward2861 {
    struct REWARD2861 has drop {
        dummy_field: bool,
    }

    struct TICKET_2861 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2861(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2861>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2861>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2861, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2861>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2861>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2861>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2861>>(v5, 0x2::tx_context::sender(arg1));
    }
