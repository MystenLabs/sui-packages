module 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::calculator {
    ...
    public fun get_max_voting_power(arg0: u64, arg1: u64) : u64 {
        if (arg1 < 126144000000) {
            (((arg0 as u128) * ((arg1 * 1000000 / 126144000000) as u128) / (1000000 as u128)) as u64)
        } else {
            arg0
        }
    }
