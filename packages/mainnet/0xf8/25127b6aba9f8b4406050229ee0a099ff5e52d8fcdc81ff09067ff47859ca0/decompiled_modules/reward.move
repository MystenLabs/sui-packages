module 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::reward {
    ...
    public fun claim_reward<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::VeTokenVault<T0>, arg2: &mut 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::VoteEscrowedToken<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        update_reward_distributions<T0>(arg0, arg1, arg3);
        update_nft_reward(arg0, 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::nft_id<T0>(arg2), 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::nft_locked_amount<T0>(arg2), arg4);
        let v0 = 0x1::type_name::get<T1>();
        let v1 = 0x2::table::borrow_mut<address, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&mut arg0.nft_unclaimed_rewards, 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::nft_id<T0>(arg2));
        let v2 = *0x2::table::borrow<0x1::type_name::TypeName, u64>(v1, v0);
        *0x2::table::borrow_mut<0x1::type_name::TypeName, u64>(v1, v0) = 0;
        assert!(0x2::balance::value<T1>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.reward_balances, v0)) >= v2, 2);
    ...
    public(friend) fun create_reward_manager<T0>(arg0: &mut 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::VeTokenVault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::vault_id<T0>(arg0);
        ...
        0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::set_reward_manager<T0>(arg0, 0x2::object::uid_to_address(&v1.id));
    ...
    public(friend) fun distribute_reward<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::VeTokenVault<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::get<T1>();
        update_reward_distribution<T0>(arg0, arg1, arg3, v0);
        assert!(*0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.available_reward_amounts, v0) >= arg2, 1);
    ...
    public(friend) fun set_reward_rate<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::VeTokenVault<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::get<T1>();
        update_reward_distribution<T0>(arg0, arg1, arg3, v0);
    ...
    public fun update_nft_reward(arg0: &mut RewardManager, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<0x1::type_name::TypeName>(v1)) {
            ...
            if (v5) {
                0x2::table::add<0x1::type_name::TypeName, u256>(0x2::table::borrow_mut<address, 0x2::table::Table<0x1::type_name::TypeName, u256>>(&mut arg0.nft_reward_indices, arg1), *v3, v4);
    ...
    public fun update_reward_distribution<T0>(arg0: &mut RewardManager, arg1: &mut 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::VeTokenVault<T0>, arg2: &0x2::clock::Clock, arg3: 0x1::type_name::TypeName) {
        ...
        let v5 = (0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::vault_total_locked_balance<T0>(arg1) as u256);
        if (v3 > 0 && v5 > 0) {
    ...
    public fun update_reward_distributions<T0>(arg0: &mut RewardManager, arg1: &mut 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault::VeTokenVault<T0>, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::vec_map::keys<0x1::type_name::TypeName, Distribution>(&arg0.distributions);
        let v1 = &v0;
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x1::type_name::TypeName>(v1)) {
