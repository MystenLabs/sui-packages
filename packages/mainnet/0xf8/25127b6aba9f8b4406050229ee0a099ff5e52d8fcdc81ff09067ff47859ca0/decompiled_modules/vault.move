module 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::vault {
    ...
    public(friend) fun extend_lock<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        ...
        arg1.max_voting_power = 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::calculator::get_max_voting_power(arg1.locked_amount, arg3);
    ...
    public fun get_nft_info<T0>(arg0: &VoteEscrowedToken<T0>) : (address, 0x1::type_name::TypeName, u64, u64, u64, u64, u64, bool, bool, &PreUnlockVesting) {
        (0x2::object::uid_to_address(&arg0.id), arg0.base_token, arg0.locked_amount, arg0.max_voting_power, arg0.lock_start_time, arg0.lock_period, arg0.lock_end_time, arg0.is_active, arg0.is_always_max_power, &arg0.pre_unlock_vesting)
    }
    ...
    public(friend) fun lock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v3 = 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::calculator::get_max_voting_power(v2, arg3);
        0x2::balance::join<T0>(&mut arg0.total_locked_balance, arg2);
        let v4 = PreUnlockVesting{
            amount         : 0,
            start_time     : 0,
            vesting_period : 0,
            claimed_amount : 0,
        };
        let v5 = VoteEscrowedToken<T0>{
            ...
            pre_unlock_vesting  : v4,
        };
        let v6 = NAVXLocked{
            nft_id              : 0x2::object::uid_to_address(&v5.id),
            amount              : v2,
            lock_start_time     : v0,
            lock_end_time       : v1,
            max_voting_power    : v3,
    ...
    public(friend) fun lock_for_max_power<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v4 = 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::calculator::get_max_voting_power(v3, v0);
        0x2::balance::join<T0>(&mut arg0.total_locked_balance, arg2);
        let v5 = PreUnlockVesting{
            amount         : 0,
            start_time     : 0,
            vesting_period : 0,
            claimed_amount : 0,
        };
        let v6 = VoteEscrowedToken<T0>{
            ...
            pre_unlock_vesting  : v5,
        };
        let v7 = NAVXLocked{
            nft_id              : 0x2::object::uid_to_address(&v6.id),
            amount              : v3,
            lock_start_time     : v1,
            lock_end_time       : v2,
            max_voting_power    : v4,
        ...
        0x2::event::emit<NAVXLocked>(v7);
        v6
    }

    public(friend) fun merge_veToken<T0>(arg0: &VeTokenVault<T0>, arg1: &mut vector<VoteEscrowedToken<T0>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        check_version(arg0.version);
        check_enabled(arg0.enabled);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        let v1 = 0;
        ...
        while (v4 > 0) {
            let v5 = 0x1::vector::borrow_mut<VoteEscrowedToken<T0>>(arg1, v4 - 1);
        ...
        let v8 = VoteEscrowedToken<T0>{
            ...
            base_token          : 0x1::type_name::get<T0>(),
            locked_amount       : v1,
            max_voting_power    : 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::calculator::get_max_voting_power(v1, v2),
            lock_start_time     : v0,
            lock_period         : v2,
            lock_end_time       : v0 + v2,
            is_active           : true,
        ...
        let v9 = VeTokenMerged{
            nft_ids           : v3,
            new_nft_id        : 0x2::object::uid_to_address(&v8.id),
            new_locked_amount : v1,
            new_lock_period   : v2,
        };
        0x2::event::emit<VeTokenMerged>(v9);
        v8
    }
    ...
    public(friend) fun pre_unlock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        ...
        let v2 = (((v1 as u128) * (0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::calculator::get_penalty_ratio(v0 - arg1.lock_start_time, arg1.lock_period, arg3) as u128) / (1000000 as u128)) as u64);
        let v3 = (v1 as u64) - v2;
        ...
        arg1.max_voting_power = (((arg1.max_voting_power as u128) * (v3 as u128) * (1000000 as u128) / (v1 as u128) / (1000000 as u128)) as u64);
    ...
    public(friend) fun switch_to_always_max_power<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock) {
        ...
        if (arg1.lock_period < 126144000000) {
            ...
            arg1.max_voting_power = 0xf825127b6aba9f8b4406050229ee0a099ff5e52d8fcdc81ff09067ff47859ca0::calculator::get_max_voting_power(arg1.locked_amount, 126144000000);
        };
        update_nft_lock_start_end_time<T0>(arg1, arg2);
