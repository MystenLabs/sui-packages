module 0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::access_mgmt {
    ...
    fun assert_bound(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: 0x2::object::ID) {
        assert!(0x2::object::id<0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter>(arg0) == arg1, 250);
    }
    ...
    fun assert_owner_or_scope(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: &ManagerWhitelist, arg2: address, arg3: u8) {
        if (0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::owner(arg0) == arg2) {
            return
        };
        assert!(arg1.character_id == 0x2::object::id<0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter>(arg0), 250);
    ...
    entry fun create_access_management(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: u8, arg2: u8, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::assert_owner(arg0, 0x2::tx_context::sender(arg4));
    ...
    entry fun grant_manager(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: &mut ManagerWhitelist, arg2: address, arg3: ManagerScope, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_bound(arg0, arg1.character_id);
        0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::assert_owner(arg0, 0x2::tx_context::sender(arg5));
    ...
    entry fun grant_manager_scope(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: &mut ManagerWhitelist, arg2: address, arg3: bool, arg4: bool, arg5: bool, arg6: bool, arg7: bool, arg8: &0x2::clock::Clock, arg9: &0x2::tx_context::TxContext) {
        let v0 = ManagerScope{
            edit_persona     : arg3,
    ...
    entry fun issue_pass(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: &ManagerWhitelist, arg2: &mut PassBook, arg3: vector<u8>, arg4: u8, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
    ...
    entry fun revoke_manager(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: &mut ManagerWhitelist, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_bound(arg0, arg1.character_id);
        0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::assert_owner(arg0, 0x2::tx_context::sender(arg4));
        let (v0, v1) = find_manager(arg1, arg2);
        if (v0) {
    ...
    entry fun revoke_pass(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: &ManagerWhitelist, arg2: &mut PassBook, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_bound(arg0, arg2.character_id);
        assert!(arg1.character_id == 0x2::object::id<0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter>(arg0), 250);
    ...
    entry fun set_interaction_policy(arg0: &0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter, arg1: &ManagerWhitelist, arg2: &mut PassBook, arg3: u8, arg4: u8, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        assert_bound(arg0, arg2.character_id);
        assert!(arg1.character_id == 0x2::object::id<0xf86c05b3f322396d32323319e24b90d17541833059e5ad879aba70431eff7738::identity::LivingCharacter>(arg0), 250);
