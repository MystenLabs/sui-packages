module 0xf8d548ab5500472fd6070084627301f15da2367777e1e8b93992f708e3538b9f::cnsnft3519 {
    struct CNSNFT3519 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3519, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2439"));
        let v4 = 0x2::package::claim<CNSNFT3519>(arg0, arg1);
