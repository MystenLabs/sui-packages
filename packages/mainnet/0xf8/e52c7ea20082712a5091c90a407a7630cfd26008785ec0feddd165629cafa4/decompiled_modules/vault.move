module 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault {
    ...
    fun redeem_dual_token_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<vector<0x1::ascii::String>>, arg4: vector<u64>, arg5: vector<vector<u64>>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        ...
        assert!(v6 == 0x1::vector::length<vector<0x1::ascii::String>>(&arg3), 31);
        assert!(v6 == 0x1::vector::length<vector<u64>>(&arg5), 30);
        assert!(v6 == 0x1::vector::length<u64>(&arg6), 32);
        let v7 = 0;
        ...
        let v29 = get_dynamic_field_or_default<T0, T1, u64>(arg1, b"hwm", (arg1.liquidity as u64));
        if (v29 >= v15) {
            set_dynamic_field<T0, T1, u64>(arg1, b"hwm", v29 - v15);
        } else {
            set_dynamic_field<T0, T1, u64>(arg1, b"hwm", 0);
        };
        let v30 = if (arg1.pending_redemptions >= (v14 as u128)) {
            arg1.pending_redemptions - (v14 as u128)
        } else {
            0
        };
        arg1.pending_redemptions = v30;
        assert!(v12 > 0, 25);
        assert!(v13 > 0, 26);
        ...
        let v35 = get_dynamic_field_or_default<T0, T1, u128>(arg1, b"total_withdraw", 0) + (v15 as u128);
        set_dynamic_field<T0, T1, u128>(arg1, b"total_withdraw", v35);
        let v36 = DualTokensRedeemEvent{
            receiver                            : arg2,
            item_amount                         : v14,
        ...
        0x2::event::emit<DualTokensRedeemEvent>(v36);
        (v31, v32)
    }
    ...
    entry fun update_rate<T0, T1>(arg0: &AdminCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64) {
        assert!(arg1.version == 1, 5);
        arg2.rate = arg3;
    }
