module 0xf8db53cd8a5d70d12b8a01bf082f864331234cfe4fdaf4292c991dea7b3fc4ad::cnsnft4712 {
    struct CNSNFT4712 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4712, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4712>(arg0, arg1);
