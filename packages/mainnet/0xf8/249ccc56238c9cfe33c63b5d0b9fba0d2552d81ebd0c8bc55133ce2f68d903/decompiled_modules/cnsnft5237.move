module 0xf8249ccc56238c9cfe33c63b5d0b9fba0d2552d81ebd0c8bc55133ce2f68d903::cnsnft5237 {
    struct CNSNFT5237 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5237, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5237>(arg0, arg1);
