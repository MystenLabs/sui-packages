module 0xf8b927d407923326561c333c628c7a1afd814cd58f006ece3593d85a71692d99::reward3784 {
    struct REWARD3784 has drop {
        dummy_field: bool,
    }

    struct TICKET_3784 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3784(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3784>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3784>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3784, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3784>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3784>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3784>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3784>>(v5, 0x2::tx_context::sender(arg1));
    }
