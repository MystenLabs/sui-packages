module 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::marketing_ledger {
    ...
    struct WithdrawDailyCapUpdated has copy, drop {
        old_cap: u64,
        new_cap: u64,
    }
    ...
    public fun set_withdraw_daily_cap(arg0: &mut MarketingLedger, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
        arg0.withdraw_daily_cap = arg1;
        let v0 = WithdrawDailyCapUpdated{
            old_cap : arg0.withdraw_daily_cap,
            new_cap : arg1,
        };
        0x2::event::emit<WithdrawDailyCapUpdated>(v0);
    }
    ...
    public fun withdraw_daily_cap(arg0: &MarketingLedger) : u64 {
        assert_version(arg0);
        arg0.withdraw_daily_cap
    }
