module 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_exchange {
    ...
    struct CurveFill has copy, drop, store {
        fill_id: vector<u8>,
        maker_order: Order,
        taker_order: Order,
        maker_signature: Signature,
        taker_signature: Signature,
        fill_amount: u64,
        maker_multiplier_bps: u64,
        taker_multiplier_bps: u64,
    }

    struct CurveFeeConfig has copy, drop, store {
        base_k_ppm: u64,
        min_multiplier_bps: u64,
        max_multiplier_bps: u64,
    }

    struct TradingKeysKey has copy, drop, store {
        trader: address,
    }

    struct TradingKey has copy, drop, store {
        key_address: address,
        expires_at_ms: u64,
    }
    ...
    struct OrderFilledCurve has copy, drop {
        fill_id: vector<u8>,
        maker_order_hash: vector<u8>,
        taker_order_hash: vector<u8>,
        maker: address,
        ...
        maker_multiplier_bps: u64,
        taker_multiplier_bps: u64,
        maker_final_k_ppm: u64,
        taker_final_k_ppm: u64,
    }

    struct CurveFeeConfigUpdated has copy, drop {
        exchange_id: 0x2::object::ID,
        base_k_ppm: u64,
        min_multiplier_bps: u64,
        max_multiplier_bps: u64,
    ...
    struct TradingKeyRegistered has copy, drop {
        trader: address,
        key_address: address,
        expires_at_ms: u64,
    ...
    struct TradingKeyRevoked has copy, drop {
        trader: address,
        key_address: address,
        active_key_count: u64,
    }
    ...
    fun apply_fill(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: Order, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        apply_fill_curve(arg0, arg1, arg2, arg3, arg4, arg5, 0, arg6, arg7);
    }

    fun apply_fill_curve(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: Order, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        if (arg3.side == 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::side_sell()) {
            0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::debit_outcome(arg1, arg3.market_id, arg3.market_object_id, arg3.outcome, arg4);
            0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::credit_outcome(arg2, arg3.market_id, arg3.market_object_id, arg3.outcome, arg4);
            let v0 = 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::debit_yoso(arg2, arg5 + arg7, arg8);
            let v1 = if (arg7 == 0) {
            ...
            let v2 = if (arg6 == 0) {
                ...
                0x2::coin::split<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(&mut v0, arg6, arg8)
            };
            credit_fee(arg0, v1);
            credit_fee(arg0, v2);
            credit_yoso_or_destroy_zero(arg1, v0);
        } else {
            let v3 = 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::debit_yoso(arg1, arg5 + arg6, arg8);
            let v4 = if (arg6 == 0) {
                0x2::coin::zero<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(arg8)
            } else {
                0x2::coin::split<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(&mut v3, arg6, arg8)
            };
            let v5 = if (arg7 == 0) {
                0x2::coin::zero<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(arg8)
            } else {
                0x2::coin::split<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(&mut v3, arg7, arg8)
            };
            0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::credit_outcome(arg1, arg3.market_id, arg3.market_object_id, arg3.outcome, arg4);
            0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::debit_outcome(arg2, arg3.market_id, arg3.market_object_id, arg3.outcome, arg4);
            credit_fee(arg0, v4);
            credit_fee(arg0, v5);
            credit_yoso_or_destroy_zero(arg2, v3);
        };
    }
    ...
    fun assert_batch_size(arg0: u64) {
        assert!(arg0 > 0, 106);
        assert!(arg0 <= 10, 107);
    }
    ...
    fun assert_fill_pair_valid(arg0: &CLOBExchange, arg1: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::CLOBMarket, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: Order, arg8: Order, arg9: u64, arg10: u64, arg11: &0x2::tx_context::TxContext) {
    ...
    fun credit_yoso_or_destroy_zero(arg0: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg1: 0x2::coin::Coin<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>) {
        if (0x2::coin::value<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(&arg1) == 0) {
            0x2::coin::destroy_zero<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(arg1);
        } else {
            0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::credit_yoso(arg0, arg1);
        };
    }

    public fun curve_fee_config(arg0: &CLOBExchange) : (u64, u64, u64) {
        assert!(has_curve_fee_config(arg0), 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_state());
        let v0 = 0x2::dynamic_field::borrow<vector<u8>, CurveFeeConfig>(&arg0.id, b"curve_fee_config");
        (v0.base_k_ppm, v0.min_multiplier_bps, v0.max_multiplier_bps)
    }
    ...
    public fun has_curve_fee_config(arg0: &CLOBExchange) : bool {
        0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"curve_fee_config")
    }
    ...
    public fun is_authorized_trading_key(arg0: &CLOBExchange, arg1: address, arg2: address, arg3: u64) : bool {
        assert_version(arg0);
        let v0 = TradingKeysKey{trader: arg1};
        if (!0x2::dynamic_field::exists<TradingKeysKey>(&arg0.id, v0)) {
            return false
        };
        let v1 = 0x2::dynamic_field::borrow<TradingKeysKey, vector<TradingKey>>(&arg0.id, v0);
        let v2 = 0;
        while (v2 < 0x1::vector::length<TradingKey>(v1)) {
            let v3 = 0x1::vector::borrow<TradingKey>(v1, v2);
            if (v3.key_address == arg2 && arg3 <= v3.expires_at_ms) {
                return true
            };
            v2 = v2 + 1;
        };
    ...
    public fun max_trading_key_ttl_ms() : u64 {
        2592000000
    }

    public fun max_trading_keys_per_trader() : u64 {
        3
    }
    ...
    public fun new_curve_fill(arg0: vector<u8>, arg1: Order, arg2: Order, arg3: Signature, arg4: Signature, arg5: u64, arg6: u64, arg7: u64) : CurveFill {
        CurveFill{
            fill_id              : arg0,
            maker_order          : arg1,
            taker_order          : arg2,
            ...
            fill_amount          : arg5,
            maker_multiplier_bps : arg6,
            taker_multiplier_bps : arg7,
        }
    }
    ...
    fun new_exchange(arg0: address, arg1: address, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : CLOBExchange {
        ...
        assert!(arg3 <= 2000, 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_fee());
        CLOBExchange{
    ...
    fun put_trading_keys(arg0: &mut CLOBExchange, arg1: address, arg2: vector<TradingKey>) {
        if (0x1::vector::is_empty<TradingKey>(&arg2)) {
            0x1::vector::destroy_empty<TradingKey>(arg2);
        } else {
            let v0 = TradingKeysKey{trader: arg1};
            0x2::dynamic_field::add<TradingKeysKey, vector<TradingKey>>(&mut arg0.id, v0, arg2);
        };
    }

    public fun register_trading_key(arg0: &mut CLOBExchange, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        assert!(arg1 != @0x0, 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_not_authorized());
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(arg2 > v1, 109);
        assert!(arg2 - v1 <= 2592000000, 110);
        let v2 = take_trading_keys(arg0, v0);
        let v3 = retain_unexpired(v2, v1);
        let v4 = false;
        let v5 = 0;
        while (v5 < 0x1::vector::length<TradingKey>(&v3)) {
            if (0x1::vector::borrow<TradingKey>(&v3, v5).key_address == arg1) {
                0x1::vector::borrow_mut<TradingKey>(&mut v3, v5).expires_at_ms = arg2;
                v4 = true;
                break
            };
            v5 = v5 + 1;
        ...
        if (!v4) {
            assert!(0x1::vector::length<TradingKey>(&v3) < 3, 111);
            let v6 = TradingKey{
                key_address   : arg1,
                expires_at_ms : arg2,
            };
            0x1::vector::push_back<TradingKey>(&mut v3, v6);
        };
        put_trading_keys(arg0, v0, v3);
        let v7 = TradingKeyRegistered{
            trader           : v0,
            key_address      : arg1,
            expires_at_ms    : arg2,
            active_key_count : 0x1::vector::length<TradingKey>(&v3),
        };
        0x2::event::emit<TradingKeyRegistered>(v7);
    }
    ...
    fun retain_unexpired(arg0: vector<TradingKey>, arg1: u64) : vector<TradingKey> {
        let v0 = 0x1::vector::empty<TradingKey>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<TradingKey>(&arg0)) {
            let v2 = *0x1::vector::borrow<TradingKey>(&arg0, v1);
            if (v2.expires_at_ms > arg1) {
                0x1::vector::push_back<TradingKey>(&mut v0, v2);
            };
            v1 = v1 + 1;
        };
        v0
    ...
    public fun revoke_all_trading_keys(arg0: &mut CLOBExchange, arg1: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = take_trading_keys(arg0, v0);
        let v2 = 0;
        while (v2 < 0x1::vector::length<TradingKey>(&v1)) {
            let v3 = *0x1::vector::borrow<TradingKey>(&v1, v2);
            let v4 = TradingKeyRevoked{
                trader           : v0,
                key_address      : v3.key_address,
                active_key_count : 0,
            };
            0x2::event::emit<TradingKeyRevoked>(v4);
            v2 = v2 + 1;
        };
    }

    public fun revoke_trading_key(arg0: &mut CLOBExchange, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = take_trading_keys(arg0, v0);
        let v2 = 0x1::vector::empty<TradingKey>();
        let v3 = false;
        let v4 = 0;
        while (v4 < 0x1::vector::length<TradingKey>(&v1)) {
            let v5 = *0x1::vector::borrow<TradingKey>(&v1, v4);
            if (v5.key_address == arg1) {
                v3 = true;
            } else {
                0x1::vector::push_back<TradingKey>(&mut v2, v5);
            };
            v4 = v4 + 1;
        };
        assert!(v3, 112);
        put_trading_keys(arg0, v0, v2);
        let v6 = TradingKeyRevoked{
            trader           : v0,
            key_address      : arg1,
            active_key_count : 0x1::vector::length<TradingKey>(&v2),
        };
        0x2::event::emit<TradingKeyRevoked>(v6);
    }
    ...
    public fun set_curve_fee_config(arg0: &mut CLOBExchange, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg4);
        assert!(arg1 > 0, 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_fee());
        assert!(arg2 <= arg3, 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_fee());
        assert!(0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::final_k_ppm(arg1, arg3) <= 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::max_final_k_ppm(), 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_fee());
        let v0 = CurveFeeConfig{
            base_k_ppm         : arg1,
            min_multiplier_bps : arg2,
            max_multiplier_bps : arg3,
        };
        if (0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"curve_fee_config")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, CurveFeeConfig>(&mut arg0.id, b"curve_fee_config") = v0;
        } else {
            0x2::dynamic_field::add<vector<u8>, CurveFeeConfig>(&mut arg0.id, b"curve_fee_config", v0);
        };
        let v1 = CurveFeeConfigUpdated{
            exchange_id        : 0x2::object::id<CLOBExchange>(arg0),
            base_k_ppm         : arg1,
            min_multiplier_bps : arg2,
            max_multiplier_bps : arg3,
        };
        0x2::event::emit<CurveFeeConfigUpdated>(v1);
    }

    public fun set_fee_bps(arg0: &mut CLOBExchange, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
        assert!(arg1 <= 2000, 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_fee());
        arg0.fee_bps = arg1;
        let v0 = FeeUpdated{
    ...
    public(friend) fun settle_curve_fill_without_signatures(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::CLOBMarket, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: Order, arg8: Order, arg9: u64, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        settle_curve_fill_without_signatures_at(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, 0x2::clock::timestamp_ms(arg12), arg13)
    }

    fun settle_curve_fill_without_signatures_at(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::CLOBMarket, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: Order, arg8: Order, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        assert_fill_pair_valid(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg12, arg13);
        let (v0, v1, v2) = curve_fee_config(arg0);
        assert!(arg10 >= v1 && arg10 <= v2, 108);
        assert!(arg11 >= v1 && arg11 <= v2, 108);
        let v3 = 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::final_k_ppm(v0, arg10);
        let v4 = 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::final_k_ppm(v0, arg11);
        let v5 = 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::collateral_for_fill(arg9, arg7.price);
        let v6 = 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::curve_fee(v5, arg7.price, v3);
        let v7 = 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::curve_fee(v5, arg7.price, v4);
        assert!(v6 <= 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::fee_cap_for(v5, arg7.max_fee_bps), 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_fee_exceeds_cap());
        assert!(v7 <= 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_fee::fee_cap_for(v5, arg8.max_fee_bps), 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_fee_exceeds_cap());
        apply_fill_curve(arg0, arg1, arg2, arg7, arg9, v5, v6, v7, arg13);
        add_filled(arg0, arg5, arg9);
        add_filled(arg0, arg6, arg9);
        set_fill_settled(arg0, arg4, true);
        let v8 = OrderFilledCurve{
            fill_id              : arg4,
            ...
            maker_fee            : v6,
            taker_fee            : v7,
            maker_multiplier_bps : arg10,
            taker_multiplier_bps : arg11,
            maker_final_k_ppm    : v3,
            taker_final_k_ppm    : v4,
        };
        0x2::event::emit<OrderFilledCurve>(v8);
        (v5, v6, v7)
    }
    ...
    fun settle_fill_without_signatures_at(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::CLOBMarket, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: Order, arg8: Order, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        assert_fill_pair_valid(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
        ...
        apply_fill(arg0, arg1, arg2, arg7, arg9, v0, v1, arg11);
    ...
    public fun settle_signed_fill_curve(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::CLOBMarket, arg4: vector<u8>, arg5: Order, arg6: Order, arg7: Signature, arg8: Signature, arg9: u64, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        let v0 = CurveFill{
            fill_id              : arg4,
            maker_order          : arg5,
            taker_order          : arg6,
        ...
        settle_signed_fill_curve_internal(arg0, arg1, arg2, arg3, v0, 0x2::clock::timestamp_ms(arg12), arg13)
    }

    fun settle_signed_fill_curve_internal(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::CLOBMarket, arg4: CurveFill, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        let CurveFill {
            fill_id              : v0,
            maker_order          : v1,
            taker_order          : v2,
            ...
            taker_signature      : v4,
            fill_amount          : v5,
            maker_multiplier_bps : v6,
            taker_multiplier_bps : v7,
        } = arg4;
        let v8 = order_hash(arg0, v1);
        let v9 = order_hash(arg0, v2);
        verify_order_signature(arg0, v1, v3);
        verify_order_signature(arg0, v2, v4);
        settle_curve_fill_without_signatures_at(arg0, arg1, arg2, arg3, v0, v8, v9, v1, v2, v5, v6, v7, arg5, arg6)
    }
    ...
    public fun settle_signed_fills_curve(arg0: &mut CLOBExchange, arg1: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg2: &mut 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account::TradingAccount, arg3: &0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::CLOBMarket, arg4: vector<CurveFill>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<CurveFill>(&arg4);
        assert_batch_size(v0);
        let v1 = 0;
        while (v1 < v0) {
            let (_, _, _) = settle_signed_fill_curve_internal(arg0, arg1, arg2, arg3, *0x1::vector::borrow<CurveFill>(&arg4, v1), 0x2::clock::timestamp_ms(arg5), arg6);
            v1 = v1 + 1;
        };
        let v5 = SettlementBatchExecuted{
            batch_size : v0,
            market_id  : 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_market::market_id(arg3),
        };
        0x2::event::emit<SettlementBatchExecuted>(v5);
    }
    ...
    public fun signer_address(arg0: &Signature) : address {
        ...
        0x1::vector::append<u8>(&mut v2, arg0.public_key);
    ...
    fun take_trading_keys(arg0: &mut CLOBExchange, arg1: address) : vector<TradingKey> {
        let v0 = TradingKeysKey{trader: arg1};
        if (0x2::dynamic_field::exists<TradingKeysKey>(&arg0.id, v0)) {
            0x2::dynamic_field::remove<TradingKeysKey, vector<TradingKey>>(&mut arg0.id, v0)
        } else {
            0x1::vector::empty<TradingKey>()
        }
    }

    public fun trading_key_address(arg0: &TradingKey) : address {
        arg0.key_address
    }

    public fun trading_key_expires_at_ms(arg0: &TradingKey) : u64 {
        arg0.expires_at_ms
    }

    public fun trading_keys(arg0: &CLOBExchange, arg1: address) : vector<TradingKey> {
        assert_version(arg0);
        let v0 = TradingKeysKey{trader: arg1};
        if (0x2::dynamic_field::exists<TradingKeysKey>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow<TradingKeysKey, vector<TradingKey>>(&arg0.id, v0)
        } else {
            0x1::vector::empty<TradingKey>()
        }
    }
    ...
    fun verify_order_signature(arg0: &CLOBExchange, arg1: Order, arg2: Signature) {
        let v0 = signer_address(&arg2);
        if (v0 != arg1.trader) {
            assert!(is_authorized_trading_key(arg0, arg1.trader, v0, arg1.expiration_ms), 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_signature());
        };
        let Signature {
            scheme     : v1,
            public_key : v2,
        ...
        let v5 = v2;
        let v6 = if (v1 == 0) {
            let v7 = order_personal_signing_digest(arg0, arg1);
            0x2::ed25519::ed25519_verify(&v4, &v5, &v7)
        } else if (v1 == 1) {
            let v8 = order_message(arg0, arg1);
            0x2::ecdsa_k1::secp256k1_verify(&v4, &v5, &v8, 1)
        } else {
            assert!(v1 == 2, 104);
            let v9 = order_personal_signing_digest(arg0, arg1);
            0x2::ecdsa_r1::secp256r1_verify(&v4, &v5, &v9, 1)
        };
        assert!(v6, 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::clob_types::e_invalid_signature());
    }
