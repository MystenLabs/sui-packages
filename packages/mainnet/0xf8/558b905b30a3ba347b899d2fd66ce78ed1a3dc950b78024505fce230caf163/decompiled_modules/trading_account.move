module 0x2ba57e9bd6f4a86ef3861f8317cae4c54c40a45027b5f161dda79f4e5c1e023a::trading_account {
    struct BonusLockKey has copy, drop, store {
        dummy_field: bool,
    }

    struct BonusLock has store {
        locked: u64,
    }

    struct TradingAccountRegistry has key {
        id: 0x2::object::UID,
        version: u64,
        admin: address,
        operator: address,
    ...
    struct TradingAccountRegistryCreated has copy, drop {
    ...
    public fun account_id(arg0: &TradingAccountRegistry, arg1: address) : 0x2::object::ID {
        assert_registry_version(arg0);
        assert!(0x2::table::contains<address, 0x2::object::ID>(&arg0.accounts, arg1), 103);
        *0x2::table::borrow<address, 0x2::object::ID>(&arg0.accounts, arg1)
    }

    public(friend) fun apply_bonus_lock(arg0: &mut TradingAccount, arg1: u64) {
        assert_version(arg0);
        let v0 = BonusLockKey{dummy_field: false};
        if (0x2::dynamic_field::exists<BonusLockKey>(&arg0.id, v0)) {
            let v1 = BonusLockKey{dummy_field: false};
            let v2 = 0x2::dynamic_field::borrow_mut<BonusLockKey, BonusLock>(&mut arg0.id, v1);
            v2.locked = v2.locked + arg1;
        } else {
            let v3 = BonusLockKey{dummy_field: false};
            let v4 = BonusLock{locked: arg1};
            0x2::dynamic_field::add<BonusLockKey, BonusLock>(&mut arg0.id, v3, v4);
        };
    }
    ...
    fun assert_registry_version(arg0: &TradingAccountRegistry) {
    ...
    public(friend) fun clear_bonus_lock(arg0: &mut TradingAccount) {
        assert_version(arg0);
        let v0 = BonusLockKey{dummy_field: false};
        if (0x2::dynamic_field::exists<BonusLockKey>(&arg0.id, v0)) {
            let v1 = BonusLockKey{dummy_field: false};
            let BonusLock {  } = 0x2::dynamic_field::remove<BonusLockKey, BonusLock>(&mut arg0.id, v1);
        };
    }

    public(friend) fun create_registered_account(arg0: &mut TradingAccountRegistry, arg1: &mut 0x2::tx_context::TxContext) : TradingAccount {
        assert_registry_version(arg0);
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(!0x2::table::contains<address, 0x2::object::ID>(&arg0.accounts, v0), 102);
        let v1 = new_account(v0, arg1);
        let v2 = 0x2::object::id<TradingAccount>(&v1);
        0x2::table::add<address, 0x2::object::ID>(&mut arg0.accounts, v0, v2);
        let v3 = TradingAccountCreated{
            account_id : v2,
            owner      : v0,
        };
        0x2::event::emit<TradingAccountCreated>(v3);
        v1
    }
    ...
    public(friend) fun credit_yoso_as_deposit(arg0: &mut TradingAccount, arg1: 0x2::coin::Coin<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>) {
        assert_version(arg0);
    ...
    public fun has_account(arg0: &TradingAccountRegistry, arg1: address) : bool {
        assert_registry_version(arg0);
    ...
    public fun init_account_with_registry(arg0: &mut TradingAccountRegistry, arg1: &mut 0x2::tx_context::TxContext) {
        share_account(create_registered_account(arg0, arg1));
    }

    public fun init_trading_account_registry(arg0: &0x2::package::UpgradeCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = TradingAccountRegistry{
            id       : 0x2::object::new(arg2),
            version  : 1,
            admin    : v0,
            operator : arg1,
            accounts : 0x2::table::new<address, 0x2::object::ID>(arg2),
        };
        let v2 = TradingAccountRegistryCreated{
            registry_id : 0x2::object::id<TradingAccountRegistry>(&v1),
            admin       : v0,
            operator    : arg1,
        };
        0x2::event::emit<TradingAccountRegistryCreated>(v2);
        0x2::transfer::share_object<TradingAccountRegistry>(v1);
    }

    public fun locked_yoso(arg0: &TradingAccount) : u64 {
        assert_version(arg0);
        let v0 = BonusLockKey{dummy_field: false};
        if (0x2::dynamic_field::exists<BonusLockKey>(&arg0.id, v0)) {
            let v2 = BonusLockKey{dummy_field: false};
            0x2::dynamic_field::borrow<BonusLockKey, BonusLock>(&arg0.id, v2).locked
        } else {
            0
        }
    }
    ...
    public fun registry_admin(arg0: &TradingAccountRegistry) : address {
        assert_registry_version(arg0);
        arg0.admin
    }

    public fun registry_operator(arg0: &TradingAccountRegistry) : address {
        assert_registry_version(arg0);
        arg0.operator
    }
    ...
    public(friend) fun share_account(arg0: TradingAccount) {
        0x2::transfer::share_object<TradingAccount>(arg0);
    }
    ...
    public fun withdraw_yoso(arg0: &mut TradingAccount, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD> {
        assert_owner(arg0, arg2);
        assert!(arg1 <= withdrawable_yoso(arg0), 106);
    ...
    public fun withdrawable_yoso(arg0: &TradingAccount) : u64 {
        let v0 = 0x2::balance::value<0x501f9137023532a285b9ddc971467f26b8d1f72faf2a6016999a88b78a6905f7::yosousd::YOSOUSD>(&arg0.yoso_vault);
        let v1 = locked_yoso(arg0);
        if (v0 > v1) {
            v0 - v1
        } else {
            0
