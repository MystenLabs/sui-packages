module 0xf838d973da3c591c4ba0cabee769531daa57e0a287f094dd686f86c92d1295f0::cnsnft7922 {
    struct CNSNFT7922 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7922, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7753"));
        let v4 = 0x2::package::claim<CNSNFT7922>(arg0, arg1);
