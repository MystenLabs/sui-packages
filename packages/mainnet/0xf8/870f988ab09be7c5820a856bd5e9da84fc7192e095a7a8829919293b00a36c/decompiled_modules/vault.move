module 0xf8870f988ab09be7c5820a856bd5e9da84fc7192e095a7a8829919293b00a36c::vault {
    ...
    fun internal_swap<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Vault, arg2: Quote, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        assert!(v0 == arg2.vault, 0xf8870f988ab09be7c5820a856bd5e9da84fc7192e095a7a8829919293b00a36c::errors::invalid_vault());
        ...
        assert!(v1 == 0x1::string::to_ascii(arg2.token_in_type), 0xf8870f988ab09be7c5820a856bd5e9da84fc7192e095a7a8829919293b00a36c::errors::invalid_token_input_type());
        assert!(v2 == 0x1::string::to_ascii(arg2.token_out_type), 0xf8870f988ab09be7c5820a856bd5e9da84fc7192e095a7a8829919293b00a36c::errors::invalid_token_output_type());
        assert!(is_coin_supported(arg1, v1) && is_coin_supported(arg1, v2), 0xf8870f988ab09be7c5820a856bd5e9da84fc7192e095a7a8829919293b00a36c::errors::token_not_supported());
        ...
        0xf8870f988ab09be7c5820a856bd5e9da84fc7192e095a7a8829919293b00a36c::events::emit_swap_executed_event(v0, arg2.id, arg2.taker, arg2.token_in_type, arg2.token_out_type, arg2.token_in_amount, arg2.token_out_amount, v10, v3, v5, v4, v6, arg1.sequence_number);
        v8
    }
