module 0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::profile_and_rank {
    ...
    public(friend) fun update_both_trophies_after_win(arg0: &mut ProfileTable, arg1: u64, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1 == 1) {
            let v2 = 5;
            if (v0 < v1) {
                v2 = 0x1::u64::max(0x1::u64::divide_and_round_up(v1 - v0, 2), 25);
            };
            ...
            let v3 = 5;
            if (v1 < v0) {
                v3 = 0x1::u64::max(0x1::u64::divide_and_round_up(v0 - v1, 2), 25);
            };
    ...
    public entry fun update_version(arg0: &0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::FFIO::FindFourAdminCap, arg1: &mut ProfileTable) {
        arg1.version = 1;
    }
