module 0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::maker {
    ...
    fun align(arg0: u64, arg1: u64, arg2: u8) : u64 {
    ...
    public(friend) fun align_price(arg0: u64, arg1: u64, arg2: u8) : u64 {
        align(arg0, arg1, arg2)
    }
    ...
    fun clamp_inside(arg0: u64, arg1: u64, arg2: u64, arg3: u8) : u64 {
        ...
        if (arg3 == 1) {
            ...
            let v2 = align(0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::math::add(arg1, arg2), arg2, 2);
            if (arg0 > v2) {
                arg0
            } else {
                v2
    ...
    public(friend) fun commitment_headroom<T0, T1>(arg0: &MakerKernel<T0, T1>) : u64 {
        let v0 = committed_quote<T0, T1>(arg0);
        let v1 = param<T0, T1>(arg0, 6);
        if (v0 >= v1) {
            0
        } else {
            v1 - v0
    ...
    public(friend) fun consume_sequence<T0, T1>(arg0: &mut MakerKernel<T0, T1>, arg1: u64) {
    ...
    public fun decode_status(arg0: u64, arg1: u64, arg2: u64) : u32 {
        (((arg2 ^ mix(arg0, arg1)) & 4294967295) as u32)
    }

    public(friend) fun emit_cycle<T0, T1>(arg0: &MakerKernel<T0, T1>, arg1: u32) {
        0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::events::emit_mk(0x2::object::uid_to_inner(&arg0.id), arg0.n, (arg1 as u64) ^ mix(arg0.n, arg0.cy));
    }
    ...
    fun latch(arg0: bool, arg1: u64, arg2: u64, arg3: u64) : bool {
    ...
    public(friend) fun leg_satisfies_target<T0, T1>(arg0: &MakerKernel<T0, T1>, arg1: u8, arg2: u64, arg3: u64, arg4: u8, arg5: u64) : bool {
        let v0 = leg<T0, T1>(arg0, arg1);
        satisfies(&v0, arg2, arg3, arg4, arg5, param<T0, T1>(arg0, 4))
    }

    public(friend) fun max_age<T0, T1>(arg0: &MakerKernel<T0, T1>) : u64 {
        param<T0, T1>(arg0, 4)
    }
    ...
    fun mode_for(arg0: bool, arg1: bool) : u8 {
        if (arg0) {
            3
        } else if (arg1) {
            2
    ...
    public fun pack_inputs(arg0: u64, arg1: u64, arg2: u64, arg3: bool, arg4: bool) : u64 {
        ...
        (arg1 | arg2 << 16 | (v0 | v1) << 32) ^ mix(arg0, arg0)
    }
    ...
    public fun pack_inputs2(arg0: u64, arg1: u64, arg2: u64, arg3: bool, arg4: bool, arg5: bool, arg6: bool, arg7: u64, arg8: u64) : u64 {
        ...
        (arg1 | arg2 << 16 | (v0 | v1 | v2 | v3) << 32 | arg7 << 36 | arg8 << 44) ^ mix(arg0, arg0)
    }
    ...
    public(friend) fun plan<T0, T1>(arg0: &MakerKernel<T0, T1>, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: bool) : (u64, u8, bool) {
        let v0 = latch(arg6, arg4, param<T0, T1>(arg0, 2), param<T0, T1>(arg0, 3));
        let v1 = mode_for(v0, arg5);
        let v2 = param<T0, T1>(arg0, 7);
        let v3 = if (v1 == 2) {
            px_b(arg3, v2, arg1)
        } else if (v1 == 3) {
            px_c(arg2, v2, arg4, param<T0, T1>(arg0, 1), arg1)
        } else {
            px_a(arg2, v2, (param<T0, T1>(arg0, 0) as u8), arg1)
        };
        (clamp_inside(v3, arg3, v2, arg1), v1, v0)
    }
    ...
    fun px_b(arg0: u64, arg1: u64, arg2: u8) : u64 {
        ...
        if (arg2 == 1) {
            ...
            align(arg0 - arg1, arg1, 1)
        } else {
            align(0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::math::add(arg0, arg1), arg1, 2)
        }
    }
    ...
    public(friend) fun record_cleared<T0, T1>(arg0: &mut MakerKernel<T0, T1>, arg1: u8) : u64 {
    ...
    public(friend) fun record_placed<T0, T1>(arg0: &mut MakerKernel<T0, T1>, arg1: u8, arg2: u128, arg3: u64, arg4: u64, arg5: u64, arg6: u8, arg7: u64, arg8: u64) {
        let v0 = arg1 == 1 && arg0.b.f || arg0.a.f;
        let v1 = L{
            o : arg2,
            c : arg3,
    ...
    fun satisfies(arg0: &L, arg1: u64, arg2: u64, arg3: u8, arg4: u64, arg5: u64) : bool {
        if (arg0.o != 0) {
            if (arg0.x == arg1) {
                if (arg0.q == arg2) {
                    if (arg0.m == arg3) {
    ...
    public(friend) fun set_latched<T0, T1>(arg0: &mut MakerKernel<T0, T1>, arg1: u8, arg2: bool) {
        if (arg1 == 1) {
            arg0.b.f = arg2;
        } else {
            arg0.a.f = arg2;
