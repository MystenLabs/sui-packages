module 0xf8499dfb7910e6f3619d54ade66074a8430c5ff22146352ed2c455affe5699f3::cnsnft8669 {
    struct CNSNFT8669 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8669, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6605"));
        let v4 = 0x2::package::claim<CNSNFT8669>(arg0, arg1);
