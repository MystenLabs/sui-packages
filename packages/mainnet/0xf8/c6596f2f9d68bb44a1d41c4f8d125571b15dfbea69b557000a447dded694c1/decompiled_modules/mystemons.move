module 0xf8c6596f2f9d68bb44a1d41c4f8d125571b15dfbea69b557000a447dded694c1::mystemons {
    ...
    fun init(arg0: MYSTEMONS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Mystemon>(&mut v3, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Mystendex Test 1"));
        0x2::display::add<Mystemon>(&mut v3, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"4120636f6c6c656374696f6e206f6620756e69717565204d797374c3a96d6f6e732067656e6572617465642066726f6d20757365722070726f66696c65732e"));
        0x2::display::add<Mystemon>(&mut v3, 0x1::string::utf8(b"icon_url"), 0x1::string::utf8(b"https://i.imgur.com/8z1Zz0s.png"));
