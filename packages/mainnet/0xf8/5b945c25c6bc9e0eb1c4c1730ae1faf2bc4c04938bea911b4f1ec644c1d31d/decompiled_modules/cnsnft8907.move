module 0xf85b945c25c6bc9e0eb1c4c1730ae1faf2bc4c04938bea911b4f1ec644c1d31d::cnsnft8907 {
    struct CNSNFT8907 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8907, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8907>(arg0, arg1);
