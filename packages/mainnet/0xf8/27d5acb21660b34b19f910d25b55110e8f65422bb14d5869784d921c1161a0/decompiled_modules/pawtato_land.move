module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    public fun check_version(arg0: &StakingPool) {
        assert!(arg0.version == 5, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_version_mismatch());
    }
    ...
    fun compute_user_production_with_storage_boost_by_address(arg0: &mut StakingPool, arg1: address, arg2: u64) : ResourceAmounts {
        ...
        let v16 = calculate_max_storage_caps_with_boost((v3 as u128), v12);
        if (v13 > 10000) {
    ...
    fun compute_user_production_with_storage_boost_readonly(arg0: &StakingPool, arg1: &vector<LandInfo>, arg2: &vector<ItemInfo>, arg3: u64) : ResourceAmounts {
        ...
        let v7 = calculate_max_storage_caps_with_boost((v2 as u128), get_storage_boost_from_staked_items(arg0, arg2));
        let v8 = 0;
        let v9 = 0;
        while (v9 < v1) {
            let v10 = 0x1::vector::borrow<LandInfo>(arg1, v9);
            if (0x1::option::is_none<u64>(&v10.cooldown_ts)) {
                v8 = v8 + 1;
                let v11 = 0x1::option::none<vector<u8>>();
                let v12 = compute_single_land_production(arg0, v10, arg3, &v11);
                if (v12.wood > 0) {
                    v0.wood = v0.wood + v12.wood;
                };
                if (v12.stone > 0) {
                    v0.stone = v0.stone + v12.stone;
                };
                if (v12.water > 0) {
                    v0.water = v0.water + v12.water;
                };
                if (v12.coal > 0) {
                    v0.coal = v0.coal + v12.coal;
                };
                if (v12.iron > 0) {
                    v0.iron = v0.iron + v12.iron;
                };
                if (v12.gold > 0) {
                    v0.gold = v0.gold + v12.gold;
                };
                if (v12.crystal > 0) {
                    v0.crystal = v0.crystal + v12.crystal;
                };
            };
            v9 = v9 + 1;
        };
        ...
        if (v0.stone > v7.stone) {
            v0.stone = v7.stone;
        };
        if (v0.water > v7.water) {
            v0.water = v7.water;
        };
        if (v0.coal > v7.coal) {
            v0.coal = v7.coal;
        ...
        if (v0.crystal > v7.crystal) {
            v0.crystal = v7.crystal;
        };
        v0
    }
    ...
    public entry fun stake_tool(arg0: &mut StakingPool, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::transfer_policy::TransferPolicy<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>, arg5: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_category_string(v2);
        let v6 = if (0x1::option::is_some<0x1::string::String>(&v5)) {
            let v7 = 0x1::option::extract<0x1::string::String>(&mut v5);
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::get_item_category_by_name(&v7)
        } else {
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::get_item_category_by_type(v3)
        };
        let v8 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_quality_string(v2);
        let v9 = if (0x1::option::is_none<0x1::string::String>(&v4)) {
            true
        } else if (0x1::option::is_none<0x1::string::String>(&v5)) {
            true
        } else {
            0x1::option::is_none<0x1::string::String>(&v8)
        };
        if (v9) {
            let v10 = 0x2::kiosk::borrow_mut<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(arg1, arg2, arg3);
            if (0x1::option::is_none<0x1::string::String>(&v4)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_durability_if_missing(v10);
            };
            if (0x1::option::is_none<0x1::string::String>(&v5)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_category_if_missing(v10);
            };
            if (0x1::option::is_none<0x1::string::String>(&v8)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_quality_if_missing(v10);
            };
        };
        ...
        let v11 = get_or_create_user(arg0, v0, arg7);
        if (v6 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_production()) {
            assert!(count_items_by_category(&v11.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_production()) < 3, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_production_slots_full());
        } else if (v6 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous()) {
            assert!(count_items_by_category(&v11.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous()) < 3, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_miscellaneous_slots_full());
        } else {
            let v12 = if (v6 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_woodworking()) {
                true
            } else if (v6 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_masonry()) {
                true
            } else {
                v6 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_blacksmithing()
            };
            if (v12) {
                assert!(count_items_by_category(&v11.items, v6) < 1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_crafting_category_slot_full());
            };
        };
        let v13 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::get_item_stake_limit(v3);
        if (v13 > 0) {
            assert!(count_items_by_type(&v11.items, v3) < v13, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_staked_item_limit_reached());
        };
        let v14 = ItemInfo{
            nft_id      : arg3,
            item_type   : v3,
        ...
        0x1::vector::push_back<ItemInfo>(&mut v11.items, v14);
        let v15 = ItemStaked{
            user      : v1,
            nft_id    : arg3,
            item_type : v3,
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 5, 13906836407726374911);
        arg1.version = 5;
    ...
    public entry fun withdraw_item<T0: store + key>(arg0: &mut StakingPool, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::tx_context::sender(arg7);
        auto_claim_resources(arg0, arg5, v0, arg7);
        let v2 = get_user(arg0, arg7);
        let v3 = 0x1::option::none<u64>();
        let v4 = 0;
        while (v4 < 0x1::vector::length<ItemInfo>(&v2.items)) {
            let v5 = 0x1::vector::borrow<ItemInfo>(&v2.items, v4);
            if (v5.nft_id == arg3) {
                if (0x1::option::is_some<u64>(&v5.cooldown_ts)) {
                    assert!(v0 >= *0x1::option::borrow<u64>(&v5.cooldown_ts), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_cooldown_not_over());
        ...
        let v6 = 0x1::vector::remove<ItemInfo>(&mut v2.items, *0x1::option::borrow<u64>(&v3));
        if (!user_has_staked_nfts(v2)) {
        ...
        0x2::event::emit<ItemWithdrawn>(v7);
    }
