module 0xf8d4631588fa59992669f52616cc1be0d338654882ae54d7c19530ea37d02101::mm_state {
    ...
    public fun create(arg0: &0xf8d4631588fa59992669f52616cc1be0d338654882ae54d7c19530ea37d02101::mm_registry::MMRegistry, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : MMState {
        let v0 = MMState{
            id                 : 0x2::object::new(arg2),
            owner              : 0x2::tx_context::sender(arg2),
            registry_id        : 0xf8d4631588fa59992669f52616cc1be0d338654882ae54d7c19530ea37d02101::mm_registry::registry_id(arg0),
            current_price      : 0,
            current_spread     : 0,
            price_sequence     : 0,
            execution_count    : 0,
        ...
        0xf8d4631588fa59992669f52616cc1be0d338654882ae54d7c19530ea37d02101::events::emit_state_created(0x2::object::id<MMState>(&v0), 0x2::tx_context::sender(arg2), 0x2::clock::timestamp_ms(arg1));
        v0
    }
    ...
    public(friend) fun pause(arg0: &mut MMState, arg1: u64, arg2: u64) {
        ...
        0xf8d4631588fa59992669f52616cc1be0d338654882ae54d7c19530ea37d02101::events::emit_trading_paused(0x2::object::id<MMState>(arg0), arg1, arg2);
    }
    ...
    public(friend) fun update_price(arg0: &mut MMState, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : bool {
        ...
        0xf8d4631588fa59992669f52616cc1be0d338654882ae54d7c19530ea37d02101::events::emit_price_updated(0x2::object::id<MMState>(arg0), arg0.current_price, arg1, arg3, arg4);
        true
    }
