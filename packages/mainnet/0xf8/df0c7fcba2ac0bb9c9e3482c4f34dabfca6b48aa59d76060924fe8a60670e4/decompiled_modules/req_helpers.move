module 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::req_helpers {
    ...
    public(friend) fun msgFromReqSigningMessage(arg0: vector<u8>) : vector<u8> {
        ...
        if (*v1 == 1) {
            ...
            0x1::vector::push_back<vector<u8>>(v5, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v3) + 29 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v8, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v6) + 31 + 66));
            ...
            0x1::vector::push_back<vector<u8>>(v11, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v9) + 29 + 66));
