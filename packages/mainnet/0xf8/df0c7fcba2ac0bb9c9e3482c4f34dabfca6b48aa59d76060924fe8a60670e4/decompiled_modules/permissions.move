module 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::permissions {
    ...
    struct ExecutorsUpdated has copy, drop {
    ...
    fun checkExecutorsForIndex(arg0: vector<vector<u8>>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &PermissionsStorage) {
        0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::assertEthAddressList(arg0);
    ...
    fun checkExecutorsNotDuplicated(arg0: vector<vector<u8>>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<vector<u8>>(&arg0)) {
            let v1 = 0;
            while (v1 < v0) {
                assert!(*0x1::vector::borrow<vector<u8>>(&arg0, v1) != *0x1::vector::borrow<vector<u8>>(&arg0, v0), 30);
                v1 = v1 + 1;
            };
            v0 = v0 + 1;
        };
    ...
    fun checkSignature(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>) {
        ...
        assert!(0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::recoverEthAddress(arg0, arg1, arg2) == arg3, 34);
    }
    ...
    public(friend) fun initExecutorsInternal(arg0: vector<vector<u8>>, arg1: u64, arg2: &mut PermissionsStorage) {
        0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::assertEthAddressList(arg0);
        assert!(arg1 <= 0x1::vector::length<vector<u8>>(&arg0), 27);
        assert!(0x1::vector::length<u64>(&arg2._exeThresholdForIndex) == 0, 24);
        assert!(arg1 > 0, 25);
        checkExecutorsNotDuplicated(arg0);
    ...
    public entry fun removeProposer(arg0: address, arg1: &mut PermissionsStorage, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 < v1) {
            ...
            *0x1::vector::borrow_mut<address>(&mut arg1._proposerList, v0 - 1) = v2;
    ...
    public entry fun updateExecutors(arg0: vector<vector<u8>>, arg1: u64, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<vector<u8>>, arg5: vector<vector<u8>>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut PermissionsStorage) {
        ...
        checkExecutorsNotDuplicated(arg0);
        let v0 = 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::req_helpers::BRIDGE_CHANNEL();
        let v1 = 0x1::vector::empty<vector<u8>>();
        let v2 = &mut v1;
        0x1::vector::push_back<vector<u8>>(v2, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::req_helpers::ETH_SIGN_HEADER());
        0x1::vector::push_back<vector<u8>>(v2, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64ToString(3 + 0x1::vector::length<u8>(&v0) + 29 + 43 * 0x1::vector::length<vector<u8>>(&arg0) + 12 + 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64Log10(arg1) + 1 + 25 + 25 + 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64Log10(arg6) + 1));
        0x1::vector::push_back<vector<u8>>(v2, b"[");
        0x1::vector::push_back<vector<u8>>(v2, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::req_helpers::BRIDGE_CHANNEL());
        ...
        0x1::vector::push_back<vector<u8>>(v2, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64ToString(arg1));
        0x1::vector::push_back<vector<u8>>(v2, x"0a");
        0x1::vector::push_back<vector<u8>>(v2, b"Active since: ");
        0x1::vector::push_back<vector<u8>>(v2, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64ToString(arg2));
        0x1::vector::push_back<vector<u8>>(v2, x"0a");
        0x1::vector::push_back<vector<u8>>(v2, b"Current executors index: ");
        0x1::vector::push_back<vector<u8>>(v2, 0xf8df0c7fcba2ac0bb9c9e3482c4f34dabfca6b48aa59d76060924fe8a60670e4::utils::smallU64ToString(arg6));
        ...
        let v4 = ExecutorsUpdated{
            executors   : arg0,
            threshold   : arg1,
            activeSince : arg2,
            exeIndex    : v3,
        };
        0x2::event::emit<ExecutorsUpdated>(v4);
    }
