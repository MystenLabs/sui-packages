module 0xf8f4d3ae8d84b843c979d172369470610a1af363a0c05ec5e3ee8ac612c3ec8a::swapFaucetB {
    ...
    fun init(arg0: SWAPFAUCETB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SWAPFAUCETB>(arg0, 4, b"unlizhao_faucetB", b"UNLIZHAO_FAUCET_COINB", b"UNLIZHAO_FAUCET_COINAB", 0x1::option::none<0x2::url::Url>(), arg1);
