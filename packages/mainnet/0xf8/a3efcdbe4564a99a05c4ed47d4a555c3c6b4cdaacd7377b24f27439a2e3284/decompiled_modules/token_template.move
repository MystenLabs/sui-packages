module 0xf8a3efcdbe4564a99a05c4ed47d4a555c3c6b4cdaacd7377b24f27439a2e3284::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"MC4776910", b"MixedConcurrent4 776910", b"Fourth concurrent deployment", 0x1::option::none<0x2::url::Url>(), arg1);
