module 0x1f246b075220ec5f49435224ca862fa60c254b9c544c8961764b1bfe77bf8728::creature_nft {
    ...
    public fun mint_nft_v2(arg0: &mut BrainrotCollection, arg1: 0x1::string::String, arg2: vector<u64>, arg3: vector<u64>, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: address, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(arg6) >= arg0.config.duplicate_recipe_fee, 1);
        assert!(is_name_available(arg0, &arg1), 11);
        validate_name(&arg1);
        reserve_name(arg0, arg1, 0x2::tx_context::sender(arg9));
        let v0 = build_simple_items(arg2, arg3);
        let v1 = 0x1::hash::sha2_256(*0x1::string::as_bytes(&arg4));
        let v2 = false;
        if (0x2::table::contains<vector<u8>, PublicRecipe>(&arg0.public_recipes, v1)) {
            v2 = true;
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg6, arg0.config.duplicate_recipe_fee, arg9), 0x2::table::borrow<vector<u8>, PublicRecipe>(&arg0.public_recipes, v1).creator);
            increment_recipe_usage(arg0, &v1);
        } else {
            let v3 = NFTMetadata{
                name              : arg1,
            ...
            0x2::table::add<vector<u8>, PublicRecipe>(&mut arg0.public_recipes, v1, v4);
            0x1::vector::push_back<vector<u8>>(&mut arg0.recipe_list, v1);
            let v5 = arg0.config.duplicate_recipe_fee;
            if (0x2::coin::value<0x2::sui::SUI>(arg6) >= v5) {
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.treasury, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(arg6, v5, arg9)));
            };
        };
        let v6 = NFTMetadataV2{
            name           : arg1,
            material_items : v0,
            image_uri      : arg5,
            created_at     : 0x2::clock::timestamp_ms(arg8),
        ...
        arg0.minted_count = arg0.minted_count + 1;
        let v8 = NFTMinted{
            nft_id              : 0x2::object::uid_to_inner(&v7),
            name                : v6.name,
            creator             : 0x2::tx_context::sender(arg9),
            is_duplicate_recipe : v2,
        };
        0x2::event::emit<NFTMinted>(v8);
        let v9 = CreatureNFTv2{
            id         : v7,
            metadata   : v6,
            creator    : 0x2::tx_context::sender(arg9),
            created_at : 0x2::clock::timestamp_ms(arg8),
        };
        0x2::transfer::public_transfer<CreatureNFTv2>(v9, arg7);
    }
