module 0x60e8987340bf13458b2b006d5fb3f8f5ecffed21d475cf91a87e0ffa67059404::gift9856 {
    struct GIFT9856 has drop {
        dummy_field: bool,
    }

    struct TICKET_9856 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9856(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9856>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9856>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9856, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9856>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9856>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9856>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9856>>(v5, 0x2::tx_context::sender(arg1));
    }
