module 0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_deepbook {
    ...
    public fun authorize_swap<T0>(arg0: &0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>, arg1: &0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiLeaderCap, arg2: u64, arg3: u64, arg4: bool, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : SwapAuthorization {
        assert!(0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::leader_cap_vault_id(arg1) == 0x2::object::id<0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>>(arg0), 1);
        assert!(arg2 > 0, 3);
    ...
    public fun consume_swap_for_buy<T0>(arg0: SwapAuthorization, arg1: &mut 0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v1 == 0x2::object::id<0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>>(arg1), 1);
        assert!(v4, 3);
        0x2::object::delete(v0);
        0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::extract_usdc_for_trading<T0>(arg1, v2, arg3)
    }

    public fun consume_swap_for_sell<T0>(arg0: SwapAuthorization, arg1: &mut AssetVault<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let SwapAuthorization {
            id           : v0,
            vault_id     : v1,
            input_amount : v2,
    ...
    public fun create_asset_vault<T0, T1>(arg0: &0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>, arg1: &0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiLeaderCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::leader_cap_vault_id(arg1) == 0x2::object::id<0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>>(arg0), 1);
        let v0 = 0x2::object::id<0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>>(arg0);
    ...
    public fun deposit_usdc_from_sell<T0>(arg0: &mut 0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64) {
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 >= arg2, 5);
        0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::deposit_usdc_from_trading<T0>(arg0, arg1);
        let v1 = SwapExecuted{
            vault_id      : 0x2::object::id<0x60636ee15efcdd7ec07fe009d0391ff96ae87b56cf77c08b24f6d6f00f463fdb::sui_vault::SuiVault<T0>>(arg0),
            input_amount  : 0,
            output_amount : v0,
            is_buy        : false,
        };
