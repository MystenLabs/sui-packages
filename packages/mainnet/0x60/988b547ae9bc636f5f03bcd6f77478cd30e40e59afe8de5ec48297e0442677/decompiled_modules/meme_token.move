module 0x60988b547ae9bc636f5f03bcd6f77478cd30e40e59afe8de5ec48297e0442677::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"DM", b"DEMOOOO COIN", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-03T13-10-32.121Z-images.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"DEMOOOO COIN"),
            symbol     : 0x1::string::utf8(b"DM"),
            decimals   : 9,
