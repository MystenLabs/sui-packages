module 0x604cdfc00224276b5797b53af8c3aa6c8a9895481b1019784fa98ea786a0ad32::events {
    ...
    public(friend) fun emit_paused(arg0: u8, arg1: 0x2::object::ID, arg2: u8, arg3: u64, arg4: vector<u8>) {
        assert!(0x1::vector::length<u8>(&arg4) <= 256, 0x604cdfc00224276b5797b53af8c3aa6c8a9895481b1019784fa98ea786a0ad32::errors::e_pause_reason_too_long());
        let v0 = Paused{
            scope     : arg0,
            object_id : arg1,
            lock_kind : arg2,
