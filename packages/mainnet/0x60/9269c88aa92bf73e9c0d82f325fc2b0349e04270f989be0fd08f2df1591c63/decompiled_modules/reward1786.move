module 0x609269c88aa92bf73e9c0d82f325fc2b0349e04270f989be0fd08f2df1591c63::reward1786 {
    struct REWARD1786 has drop {
        dummy_field: bool,
    }

    struct TICKET_1786 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1786(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1786>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1786>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1786, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1786>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1786>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1786>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1786>>(v5, 0x2::tx_context::sender(arg1));
    }
