module 0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::nest {
    ...
    public entry fun create_staking_transfer_policy(arg0: &NestAdminCap, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::transfer_policy::new<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg1, arg2);
        let v2 = v1;
        let v3 = v0;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(&mut v3, &v2);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(&mut v3, &v2, 0, 0);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>>(v3);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>>(v2, 0x2::tx_context::sender(arg2));
    }
    ...
    public entry fun harvest_duck(arg0: &mut StakedDuck, arg1: &Nest, arg2: &mut HarvestStats, arg3: &0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::NestMintCap, arg4: &mut 0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v9 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SHTTOKEN>>(0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::mint_for_nest(arg3, arg4, v9, arg7), v0);
        };
    ...
    public entry fun stake_duck(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut StakingKiosk, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>, arg6: &mut HarvestStats, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg3.owner == v0, 6);
        assert!(0x1::option::is_none<0x2::object::ID>(&arg3.staked_duck_id), 12);
        0x2::kiosk::list<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg0, arg1, arg2, 0);
        let (v1, v2) = 0x2::kiosk::purchase<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg0, arg2, 0x2::coin::zero<0x2::sui::SUI>(arg8));
        let v3 = v2;
        let v4 = v1;
        let v5 = 0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::get_rarity_level(&v4);
        let v6 = 0x2::clock::timestamp_ms(arg7);
        0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::mark_as_staked(&mut v4, v6, arg3.level);
        0x2::kiosk::lock<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(&mut arg4.kiosk, &arg4.cap, arg5, v4);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(&mut v3, &arg4.kiosk);
        if (0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg5, 0) > 0) {
            abort 100
        };
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg5, &mut v3, 0x2::coin::zero<0x2::sui::SUI>(arg8));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg5, v3);
    ...
    public entry fun unstake_duck(arg0: StakedDuck, arg1: &mut Nest, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &mut StakingKiosk, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>, arg6: &mut HarvestStats, arg7: &0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::NestMintCap, arg8: &mut 0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SharedTreasury, arg9: &0x2::random::Random, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4 > 0) {
            ...
            if (v10 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SHTTOKEN>>(0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::mint_for_nest(arg7, arg8, v10, arg11), v0);
            };
        ...
        0x2::kiosk::list<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(&mut arg4.kiosk, &arg4.cap, v3, 0);
        let (v18, v19) = 0x2::kiosk::purchase<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(&mut arg4.kiosk, v3, 0x2::coin::zero<0x2::sui::SUI>(arg11));
        let v20 = v19;
        let v21 = v18;
        0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::mark_as_unstaked(&mut v21);
        0x2::kiosk::lock<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg2, arg3, arg5, v21);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(&mut v20, arg2);
        if (0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg5, 0) > 0) {
            abort 100
        };
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg5, &mut v20, 0x2::coin::zero<0x2::sui::SUI>(arg11));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::duck_nft::DuckNFT>(arg5, v20);
        let StakedDuck {
            id                : v25,
            duck_id           : _,
            owner             : _,
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SHTTOKEN>, arg2: &mut 0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::burn(arg2, 0x2::coin::split<0x605db68682b260c46731ed8edcc931ee73730ca63df97375a2d455992fd4096f::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
