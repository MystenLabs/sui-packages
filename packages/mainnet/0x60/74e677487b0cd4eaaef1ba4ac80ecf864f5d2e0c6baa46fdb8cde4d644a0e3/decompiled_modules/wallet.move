module 0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::wallet {
    ...
    public fun split_vault_balance_by_sub<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::asserts::must_sender(arg2, 0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::admin::sub());
        0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::asserts::must_amount(arg1);
        0x2::balance::split<T0>(&mut arg0.balance, arg1)
    }

    public fun split_vault_balance_by_whitelist<T0>(arg0: &mut Vault<T0>, arg1: &0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::whitelist::Config, arg2: u64, arg3: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::asserts::must_whitelisted(0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::whitelist::is_whitelisted(arg1, 0x2::tx_context::sender(arg3)));
        0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::asserts::must_amount(arg2);
        0x2::balance::split<T0>(&mut arg0.balance, arg2)
    }

    public fun sw<T0>(arg0: &mut Vault<T0>, arg1: &0xc77b320a443abbefd01833f2159a00f34b6ec6c141369a92fbd12a3fdb3183f8::whitelist::Config, arg2: u64, arg3: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        split_vault_balance_by_whitelist<T0>(arg0, arg1, arg2, arg3)
    }
