module 0x9db741d5dfea02b1aadedaff43e73bde3972adf82beadf7cc6da26f107bfbc54::playground {
    ...
    struct AppBounty has key {
        id: 0x2::object::UID,
        poster: address,
        description: 0x1::string::String,
        reward: 0x2::balance::Balance<0x2::sui::SUI>,
        fulfilled_app: 0x1::option::Option<0x2::object::ID>,
        winner: 0x1::option::Option<address>,
        open: bool,
        created_at_ms: u64,
    }

    struct ForkRegistry has key {
        id: 0x2::object::UID,
        prices: 0x2::table::Table<0x2::object::ID, u64>,
    }

    struct PrivacyRegistry has key {
        id: 0x2::object::UID,
        private: 0x2::table::Table<0x2::object::ID, bool>,
    }
    ...
    struct AppBountyPosted has copy, drop {
    ...
    struct AppBountyAwarded has copy, drop {
        bounty_id: 0x2::object::ID,
        app_id: 0x2::object::ID,
        winner: address,
        amount: u64,
    ...
    struct AppBountyCancelled has copy, drop {
        bounty_id: 0x2::object::ID,
        poster: address,
        refund: u64,
    }

    struct ForkPriceSet has copy, drop {
        app_id: 0x2::object::ID,
        builder: address,
        price: u64,
    }

    struct AppForkPaid has copy, drop {
        app_id: 0x2::object::ID,
        payer: address,
        builder: address,
        price: u64,
    ...
    struct AppPrivacySet has copy, drop {
        app_id: 0x2::object::ID,
        builder: address,
        private: bool,
    }
    ...
    public fun award_app_bounty(arg0: &mut AppBounty, arg1: &PublishedApp, arg2: &mut Treasury, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.poster, 8);
        assert!(arg0.open, 9);
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg0.reward);
        let v1 = v0 * 250 / 10000;
        let v2 = 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.reward);
        0x2::balance::join<0x2::sui::SUI>(&mut arg2.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v2, v1));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v2, arg3), arg1.builder);
        arg0.fulfilled_app = 0x1::option::some<0x2::object::ID>(0x2::object::id<PublishedApp>(arg1));
        arg0.winner = 0x1::option::some<address>(arg1.builder);
        arg0.open = false;
        let v3 = AppBountyAwarded{
            bounty_id : 0x2::object::id<AppBounty>(arg0),
            app_id    : 0x2::object::id<PublishedApp>(arg1),
            winner    : arg1.builder,
            amount    : v0 - v1,
            fee       : v1,
        };
        0x2::event::emit<AppBountyAwarded>(v3);
    }

    public fun bounty_open(arg0: &AppBounty) : bool {
        arg0.open
    }

    public fun bounty_poster(arg0: &AppBounty) : address {
        arg0.poster
    }

    public fun bounty_reward(arg0: &AppBounty) : u64 {
        0x2::balance::value<0x2::sui::SUI>(&arg0.reward)
    }

    public fun bounty_winner(arg0: &AppBounty) : &0x1::option::Option<address> {
        &arg0.winner
    }
    ...
    public fun cancel_app_bounty(arg0: &mut AppBounty, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.poster, 8);
        assert!(arg0.open, 9);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.reward), arg1), arg0.poster);
        arg0.open = false;
        let v0 = AppBountyCancelled{
            bounty_id : 0x2::object::id<AppBounty>(arg0),
            poster    : arg0.poster,
            refund    : 0x2::balance::value<0x2::sui::SUI>(&arg0.reward),
        };
        0x2::event::emit<AppBountyCancelled>(v0);
    }
    ...
    public fun create_fork_registry(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = ForkRegistry{
            id     : 0x2::object::new(arg0),
            prices : 0x2::table::new<0x2::object::ID, u64>(arg0),
        };
        0x2::transfer::share_object<ForkRegistry>(v0);
    }
    ...
    public fun create_privacy_registry(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PrivacyRegistry{
            id      : 0x2::object::new(arg0),
            private : 0x2::table::new<0x2::object::ID, bool>(arg0),
        };
        0x2::transfer::share_object<PrivacyRegistry>(v0);
    }
    ...
    public fun fork_price(arg0: &ForkRegistry, arg1: 0x2::object::ID) : u64 {
        if (0x2::table::contains<0x2::object::ID, u64>(&arg0.prices, arg1)) {
            *0x2::table::borrow<0x2::object::ID, u64>(&arg0.prices, arg1)
        } else {
            0
        }
    }

    fun id_in_app(arg0: &PublishedApp, arg1: &vector<u8>) : bool {
        let v0 = 0x2::object::id_bytes<PublishedApp>(arg0);
    ...
    public fun is_private(arg0: &PrivacyRegistry, arg1: 0x2::object::ID) : bool {
        0x2::table::contains<0x2::object::ID, bool>(&arg0.private, arg1) && *0x2::table::borrow<0x2::object::ID, bool>(&arg0.private, arg1)
    }
    ...
    public fun pay_to_fork(arg0: &ForkRegistry, arg1: &PublishedApp, arg2: &mut Treasury, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<PublishedApp>(arg1);
        assert!(0x2::table::contains<0x2::object::ID, u64>(&arg0.prices, v0), 11);
        let v1 = *0x2::table::borrow<0x2::object::ID, u64>(&arg0.prices, v0);
        assert!(v1 > 0, 11);
        let v2 = 0x2::coin::value<0x2::sui::SUI>(&arg3);
        assert!(v2 >= v1, 12);
        let v3 = 0x2::coin::into_balance<0x2::sui::SUI>(arg3);
        if (v2 > v1) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v3, v2 - v1), arg4), 0x2::tx_context::sender(arg4));
        };
        let v4 = v1 * 250 / 10000;
        0x2::balance::join<0x2::sui::SUI>(&mut arg2.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v3, v4));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v3, arg4), arg1.builder);
        let v5 = AppForkPaid{
            app_id  : v0,
            payer   : 0x2::tx_context::sender(arg4),
            builder : arg1.builder,
            price   : v1,
            fee     : v4,
        };
        0x2::event::emit<AppForkPaid>(v5);
    }

    public fun post_app_bounty(arg0: 0x1::string::String, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = AppBounty{
            ...
            description   : arg0,
            reward        : 0x2::coin::into_balance<0x2::sui::SUI>(arg1),
            fulfilled_app : 0x1::option::none<0x2::object::ID>(),
            winner        : 0x1::option::none<address>(),
            open          : true,
            created_at_ms : v1,
        };
        let v3 = AppBountyPosted{
            bounty_id     : 0x2::object::id<AppBounty>(&v2),
            poster        : v2.poster,
            reward        : v0,
            created_at_ms : v1,
        };
        0x2::event::emit<AppBountyPosted>(v3);
        0x2::transfer::share_object<AppBounty>(v2);
    }
    ...
    entry fun seal_approve_app_owner(arg0: vector<u8>, arg1: &PublishedApp, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg1.builder, 13);
        assert!(id_in_app(arg1, &arg0), 14);
    }

    public fun set_fork_price(arg0: &mut ForkRegistry, arg1: &PublishedApp, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.builder, 4);
        let v0 = 0x2::object::id<PublishedApp>(arg1);
        if (arg2 == 0) {
            if (0x2::table::contains<0x2::object::ID, u64>(&arg0.prices, v0)) {
                0x2::table::remove<0x2::object::ID, u64>(&mut arg0.prices, v0);
            };
        } else if (0x2::table::contains<0x2::object::ID, u64>(&arg0.prices, v0)) {
            *0x2::table::borrow_mut<0x2::object::ID, u64>(&mut arg0.prices, v0) = arg2;
        } else {
            0x2::table::add<0x2::object::ID, u64>(&mut arg0.prices, v0, arg2);
        };
        let v1 = ForkPriceSet{
            app_id  : v0,
            builder : arg1.builder,
        ...
        0x2::event::emit<ForkPriceSet>(v1);
    }
    ...
    public fun set_private(arg0: &mut PrivacyRegistry, arg1: &PublishedApp, arg2: bool, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.builder, 4);
        let v0 = 0x2::object::id<PublishedApp>(arg1);
        if (0x2::table::contains<0x2::object::ID, bool>(&arg0.private, v0)) {
            *0x2::table::borrow_mut<0x2::object::ID, bool>(&mut arg0.private, v0) = arg2;
        } else {
            0x2::table::add<0x2::object::ID, bool>(&mut arg0.private, v0, arg2);
        };
        let v1 = AppPrivacySet{
            app_id  : v0,
            builder : arg1.builder,
            private : arg2,
        };
        0x2::event::emit<AppPrivacySet>(v1);
    }
