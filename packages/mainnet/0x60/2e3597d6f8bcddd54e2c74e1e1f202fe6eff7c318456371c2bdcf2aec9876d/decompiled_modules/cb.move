module 0x602e3597d6f8bcddd54e2c74e1e1f202fe6eff7c318456371c2bdcf2aec9876d::cb {
    struct CB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<CB>(&mut v2, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
