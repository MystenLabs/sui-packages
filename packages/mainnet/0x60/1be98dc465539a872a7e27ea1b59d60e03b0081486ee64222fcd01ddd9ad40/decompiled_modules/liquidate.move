module 0x601be98dc465539a872a7e27ea1b59d60e03b0081486ee64222fcd01ddd9ad40::liquidate {
    ...
    public fun get_liquidable_debtors<T0>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : vector<address> {
        let (_, _, v2) = get_liquidable_debtors_with_info<T0>(arg0, arg1, arg2, arg3, arg4);
        v2
    }

    public fun get_liquidable_debtors_by_coin_type<T0>(arg0: &mut 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : vector<address> {
        let (_, _, v2) = get_liquidable_debtors_with_info<T0>(0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::borrow_bucket<T0>(arg0), arg1, arg2, arg3, arg4);
        v2
    }

    public fun get_liquidable_debtors_with_info<T0>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : (u64, u64, vector<address>) {
        if (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::is_in_recovery_mode<T0>(arg0, arg1, arg4)) {
            return get_liquidable_debtors_with_info_under_recovery_mode<T0>(arg0, arg1, arg2, arg3, arg4)
        };
        get_liquidable_debtors_with_info_under_normal_mode<T0>(arg0, arg1, arg4)
    }
    ...
    fun get_liquidable_debtors_with_info_under_recovery_mode<T0>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : (u64, u64, vector<address>) {
        let v0 = 0;
        let v1 = 0;
        let v2 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_lowest_cr_debtor<T0>(arg0);
        let v3 = 0x1::vector::empty<address>();
        let (v4, v5) = 0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::get_price<T0>(arg1, arg4);
        let v6 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_bucket_debt<T0>(arg0, arg4);
        ...
        while (0x1::option::is_some<address>(&v2)) {
            ...
            if (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::is_healthy_bottle_by_debtor<T0>(arg0, arg1, arg4, v10)) {
                break
            };
            if (v9) {
                let (v11, v12) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_bottle_info_with_interest_by_debtor<T0>(arg0, v10, arg4);
                if (v8 < v11) {
                    if (v8 > 0) {
                ...
                v6 = v6 - v12;
                v7 = v7 - v11;
                v9 = is_in_recovery_mode_by_value(arg3, v6, v7, v4, v5);
            } else {
                let (v13, v14) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_bottle_info_with_interest_by_debtor<T0>(arg0, v10, arg4);
                if (v8 < v13) {
                    if (v8 > 0) {
                        0x1::vector::push_back<address>(&mut v3, v10);
                        break
                ...
                if (is_under_collateralized_by_value(arg2, v14, v13, v4, v5)) {
                    v0 = v0 + v14;
                    v1 = v1 + v13;
                    v8 = v8 - v13;
                } else {
    ...
    public fun liquidate_debtors_through<T0>(arg0: &mut 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: vector<address>, arg3: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        let v0 = 0x2::balance::zero<T0>();
        while (!0x1::vector::is_empty<address>(&arg2)) {
            0x2::balance::join<T0>(&mut v0, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::liquidate_under_normal_mode<T0>(arg0, arg1, arg3, 0x1::vector::pop_back<address>(&mut arg2)));
        };
        v0
    }

    public fun liquidate_debtors_through_skip<T0>(arg0: &mut 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: vector<address>, arg3: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        let v0 = 0x2::balance::zero<T0>();
        if (!0x1::vector::is_empty<address>(&arg2)) {
            0x1::vector::pop_back<address>(&mut arg2);
        };
        while (!0x1::vector::is_empty<address>(&arg2)) {
            0x2::balance::join<T0>(&mut v0, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::liquidate_under_normal_mode<T0>(arg0, arg1, arg3, 0x1::vector::pop_back<address>(&mut arg2)));
        };
