module 0x60790db44accf46a726f281050dcf6d69081fd9ceecdade06033be4e24f28b19::acl {
    struct Bvymipwijvkpqss has key {
        id: 0x2::object::UID,
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun cwklzjgvhrvaucr<T0>(arg0: &mut Bvymipwijvkpqss, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun ehbhaphumczpoby(arg0: &mut Bvymipwijvkpqss, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun ijuozjgkqvpyvsg<T0: store + key>(arg0: &mut Bvymipwijvkpqss, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    public entry fun rgpzebgyjxciuld(arg0: &mut Bvymipwijvkpqss, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 0);
        arg0.initialized = arg1;
    }

    public entry fun tlhcclhgidhycuw(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Bvymipwijvkpqss, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun vesxgzcwhkwblxe(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool{coin_details: 0x1::vector::empty<PoolDetail>()};
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&arg4)) {
            let v2 = *0x1::vector::borrow<0x1::ascii::String>(&arg4, v1);
        ...
        0x2::transfer::share_object<Bvymipwijvkpqss>(v4);
    }

    public entry fun ytxjmfqbdxninmw(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Bvymipwijvkpqss{
        ...
        0x2::transfer::share_object<Bvymipwijvkpqss>(v0);
    }
