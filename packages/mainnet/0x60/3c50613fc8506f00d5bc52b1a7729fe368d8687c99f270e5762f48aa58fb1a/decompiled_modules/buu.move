module 0x603c50613fc8506f00d5bc52b1a7729fe368d8687c99f270e5762f48aa58fb1a::buu {
    struct BUU has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BUU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4, v5) = 0x2::coin::create_regulated_currency_v2<BUU>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BUU     ")))), trim_right(b"BUU                             "), trim_right(b"In the shadows, a community arose, a new vibe, a mischievous vibe. It's all about the community and art. Together, we're building a playful realm where creativity and fun collide.                                                                                                                                             "), v2, false, arg1);
        let v6 = v3;
