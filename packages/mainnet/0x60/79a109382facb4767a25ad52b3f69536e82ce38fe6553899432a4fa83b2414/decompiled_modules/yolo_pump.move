module 0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::yolo_pump {
    ...
    public entry fun buy_v2<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &mut Configuration, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v3 - v5;
        assert!(v6 > 0, 2);
        let v7 = 0x1::u64::min(0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::curves::calculate_token_amount_received(v2.virtual_sui_reserves, v2.virtual_token_reserves, v6), v4);
        ...
        if (v4 == v7 || 0x2::coin::value<0x2::sui::SUI>(&v2.real_sui_reserves) >= arg5.threshold) {
            transfer_pool<T0>(arg0, arg1, arg2, arg3, arg4, v2, arg7, arg8);
        };
        let v12 = TradedEvent{
            is_buy                 : true,
            user                   : v0,
    ...
    fun calculate_platform_fee(arg0: u64, arg1: u64) : u64 {
        0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::curves::mul_div(arg0, arg1, 10000)
    }
    ...
    public entry fun create_and_first_buy<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &mut Configuration, arg6: 0x2::coin::TreasuryCap<T0>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &0x2::clock::Clock, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: 0x1::ascii::String, arg14: 0x1::ascii::String, arg15: 0x1::ascii::String, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&arg7) > 0) {
            ...
            let v2 = calculate_platform_fee(v1, arg5.platform_fee);
            let v3 = v1 - v2;
            assert!(v3 > 0, 2);
            let v4 = 0x1::u64::min(0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::curves::calculate_token_amount_received(v0.virtual_sui_reserves, v0.virtual_token_reserves, v3), arg5.initial_virtual_token_reserves - arg5.remain_token_reserves);
            assert!(v0.virtual_token_reserves >= v4, 8);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg7, v2, arg16), arg5.admin);
            let v5 = &mut v0;
            let v6 = 0x2::coin::zero<T0>(arg16);
            let (v7, v8) = swap<T0>(v5, v6, arg7, v4, 0, arg16);
            let v9 = v7;
            v0.virtual_token_reserves = v0.virtual_token_reserves - 0x2::coin::value<T0>(&v9);
            let v10 = 0x2::tx_context::sender(arg16);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v8, v10);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v9, v10);
            if (v4 == arg5.initial_virtual_token_reserves - arg5.remain_token_reserves || 0x2::coin::value<0x2::sui::SUI>(&v0.real_sui_reserves) >= arg5.threshold) {
                let v11 = &mut v0;
                transfer_pool<T0>(arg0, arg1, arg2, arg3, arg4, v11, arg8, arg16);
            };
        } else {
        ...
        let v13 = 0x1::type_name::get<Pool<T0>>();
        0x2::dynamic_object_field::add<0x1::ascii::String, Pool<T0>>(&mut arg5.id, 0x1::type_name::get_address(&v12), v0);
        let v14 = CreatedEvent{
            ...
            telegram               : arg14,
            website                : arg15,
            token_address          : 0x1::type_name::into_string(v12),
            bonding_curve          : 0x1::type_name::get_module(&v13),
            pool_id                : 0x2::object::id<Pool<T0>>(&v0),
    ...
    public fun early_complete_pool<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &mut Configuration, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        transfer_pool<T0>(arg0, arg1, arg2, arg3, arg4, v1, arg6, arg7);
    }
    ...
    public fun estimate_amount_out<T0>(arg0: &mut Configuration, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        if (arg1 > 0 && arg2 == 0) {
            (0, 0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::curves::calculate_token_amount_received(v1.virtual_sui_reserves, v1.virtual_token_reserves, arg1 - calculate_platform_fee(arg1, arg0.platform_fee)))
        } else if (arg1 == 0 && arg2 > 0) {
            let v4 = 0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::curves::calculate_remove_liquidity_return(v1.virtual_token_reserves, v1.virtual_sui_reserves, arg2);
    ...
    public entry fun sell<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 > 0, 2);
        let v4 = 0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
    ...
    fun transfer_pool<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &mut Pool<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        arg5.is_completed = true;
        let v0 = 0x2::coin::split<T0>(&mut arg5.real_token_reserves, 0x2::coin::value<T0>(&arg5.real_token_reserves), arg7);
        let v1 = 0x2::coin::split<0x2::sui::SUI>(&mut arg5.real_sui_reserves, 0x2::coin::value<0x2::sui::SUI>(&arg5.real_sui_reserves), arg7);
        0x2::coin::join<T0>(&mut v0, 0x2::coin::split<T0>(&mut arg5.remain_token_reserves, 0x2::coin::value<T0>(&arg5.remain_token_reserves), arg7));
        let v2 = 0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::math::sqrt((0x2::coin::value<0x2::sui::SUI>(&v1) as u128) / (0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::math::power_decimals(3) as u128) / (0x2::coin::value<T0>(&v0) as u128)) * 0x6079a109382facb4767a25ad52b3f69536e82ce38fe6553899432a4fa83b2414::math::pow(2, 64);
        let v3 = 60;
        let v4 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::abs_u32(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_tick_at_sqrt_price(v2));
        let (v5, v6, v7) = init_cetus_pool<0x2::sui::SUI, T0>(arg0, arg1, v3, v2, 0x1::string::from_ascii(arg5.uri), v4 - v4 % v3 - v3, v4 - v4 % v3 + v3, v1, v0, arg3, arg4, true, arg6, arg7);
        0x2::transfer::public_transfer<0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::CetusLPBurnProof>(0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::burn_lp_v2(arg2, v5, arg7), @0xf3cf5493e58e308861e4c8649cdcb44a24c4f6ecce3db46ee9d99ba96daaca1f);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v6, @0xf3cf5493e58e308861e4c8649cdcb44a24c4f6ecce3db46ee9d99ba96daaca1f);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v7, @0xf3cf5493e58e308861e4c8649cdcb44a24c4f6ecce3db46ee9d99ba96daaca1f);
        let v8 = PoolCompletedEvent{
            token_address : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            lp            : 0x1::ascii::string(b"0x0"),
            ts            : 0x2::clock::timestamp_ms(arg6),
        };
        0x2::event::emit<PoolCompletedEvent>(v8);
    }
