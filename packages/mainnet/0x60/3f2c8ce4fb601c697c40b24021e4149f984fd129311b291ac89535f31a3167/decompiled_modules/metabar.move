module 0x603f2c8ce4fb601c697c40b24021e4149f984fd129311b291ac89535f31a3167::metabar {
    ...
    fun init(arg0: METABAR, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<METABAR>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"MetaBar"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"MetaBar Cocktails x MananaBar "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibiuvgoq3jp4lxakpg734c2bxuas2whhwrpqcpnx6cydgtmxoiszu"));
