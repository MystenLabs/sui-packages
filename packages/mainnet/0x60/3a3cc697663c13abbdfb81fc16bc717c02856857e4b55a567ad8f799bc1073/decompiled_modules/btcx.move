module 0x603a3cc697663c13abbdfb81fc16bc717c02856857e4b55a567ad8f799bc1073::btcx {
    ...
    public fun buy(arg0: &mut BTCXTreasuryCoinfig, arg1: &mut 0xd57d6993ef810bd227469f694d08fbb33fa56ef9730e1d475ad2a68d21d80532::config::Config, arg2: &mut 0xd57d6993ef810bd227469f694d08fbb33fa56ef9730e1d475ad2a68d21d80532::treasury::Treasury, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (u64, u64, 0x2::coin::Coin<BTCX>, 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>) {
        let (v0, v1, v2) = 0xd57d6993ef810bd227469f694d08fbb33fa56ef9730e1d475ad2a68d21d80532::trade::buy_stock<BTCX>(arg1, arg2, arg3, arg4, arg5, arg6);
        (v0, v1, 0x2::coin::mint<BTCX>(&mut arg0.treasuryCap, v1, arg6), v2)
    }

    fun init(arg0: BTCX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BTCX>(arg0, 8, b"BTCx", b"Bitcoin Token", b"Tokenized Bitcoin representing fractional ownership of BTC (backed by Bitcoin reserves)", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://cro-ag.pages.dev/btcx.png"))), arg1);
