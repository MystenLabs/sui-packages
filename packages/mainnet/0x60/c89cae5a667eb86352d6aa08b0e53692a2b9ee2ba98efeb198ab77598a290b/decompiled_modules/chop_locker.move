module 0x60c89cae5a667eb86352d6aa08b0e53692a2b9ee2ba98efeb198ab77598a290b::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &mut PoolConfig<T0>, arg1: u64, arg2: u64) : u64 {
        let v0 = 365;
        100 * arg1 / arg0.total_staked * 100 * 0x2::balance::value<T0>(&arg0.reward_balance) / v0 / v0 * (100 * arg2 / 90 + 50) * v0 / 100
    }
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = withdraw_from_balance<T0>(v5, 0x2::balance::value<T0>(0x2::coin::balance<T0>(&arg1)) * 1000 * v1 / 365 * v2 / 10000 / 1000, arg5);
        let v7 = Lock<T0>{
            id             : v4,
