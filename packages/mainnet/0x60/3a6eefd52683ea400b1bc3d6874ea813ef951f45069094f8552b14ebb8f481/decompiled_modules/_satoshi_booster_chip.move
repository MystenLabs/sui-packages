module 0x603a6eefd52683ea400b1bc3d6874ea813ef951f45069094f8552b14ebb8f481::_satoshi_booster_chip {
    struct _SATOSHI_BOOSTER_CHIP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _SATOSHI_BOOSTER_CHIP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_SATOSHI_BOOSTER_CHIP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" Satoshi Booster Chip"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Satoshi Booster Chip is an exclusive upgrade that gives holders a 5x multiplier when mining $SATM massively boosting your rewards and mining efficiency."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://kBymA6Rcu30chqi7vNjpF3V2LK7IfWFzhQ9GIVRdolM"));
