module 0x60f883f926a6b3372285d8e0fccb236f6e126b964210ccfcd82af5836f7a8ed7::paramx {
    ...
    fun add_position(arg0: &mut 0x2::table::Table<address, Position>, arg1: address, arg2: bool, arg3: u64) : u64 {
        if (!0x2::table::contains<address, Position>(arg0, arg1)) {
            let v0 = Position{
                amount   : arg3,
                is_short : arg2,
            };
            0x2::table::add<address, Position>(arg0, arg1, v0);
            return 0
        };
        let v1 = 0x2::table::borrow_mut<address, Position>(arg0, arg1);
        if (v1.is_short == arg2) {
            v1.amount = v1.amount + arg3;
            return 0
        };
        if (arg3 > v1.amount) {
            v1.amount = arg3 - v1.amount;
            v1.is_short = arg2;
        } else {
            v1.amount = v1.amount - arg3;
        };
        if (v1.amount == 0) {
            0x2::table::remove<address, Position>(arg0, arg1);
        };
        0x1::u64::min(v1.amount, arg3)
    }
    ...
    public fun execute_trade<T0>(arg0: &mut Exchange<T0>, arg1: address, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: u256, arg5: 0x2::object::ID, arg6: u64, arg7: u64, arg8: &vector<u8>, arg9: address, arg10: u256, arg11: 0x1::option::Option<u64>, arg12: u64, arg13: 0x2::object::ID, arg14: u64, arg15: u64, arg16: &vector<u8>, arg17: bool, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) {
        let v0 = BuyerOrderIntent{
            user               : arg1,
            total_price        : arg2,
            total_amount       : arg3,
            contract_id        : arg4,
            exchange_object_id : arg5,
            expiry             : arg6,
            nonce              : arg7,
        };
        let v1 = SellerOrderIntent{
            ...
            total_amount       : arg12,
            total_price        : arg11,
            exchange_object_id : arg13,
            expiry             : arg14,
            nonce              : arg15,
        };
        let v2 = 0x2::bcs::to_bytes<BuyerOrderIntent>(&v0);
        assert!(0x2::ed25519::ed25519_verify(arg8, &0x2::table::borrow<address, Account<T0>>(&arg0.accounts, v0.user).trading_pubkey, &v2), 1);
        let v3 = 0x2::bcs::to_bytes<SellerOrderIntent>(&v1);
        assert!(0x2::ed25519::ed25519_verify(arg16, &0x2::table::borrow<address, Account<T0>>(&arg0.accounts, v1.user).trading_pubkey, &v3), 12);
        ...
        assert!(0x2::clock::timestamp_ms(arg18) < v0.expiry, 15);
        assert!(0x2::clock::timestamp_ms(arg18) < v1.expiry, 15);
        assert!(0x1::option::is_some<u64>(&v0.total_amount) && 0x1::option::is_some<u64>(&v1.total_price) || 0x1::option::is_none<u64>(&v0.total_amount) != 0x1::option::is_none<u64>(&v1.total_price) && (arg17 && 0x1::option::is_some<u64>(&v0.total_amount) || !arg17 && 0x1::option::is_some<u64>(&v1.total_price)), 9);
        ...
        let v15 = (v14 as u64);
        if (!0x2::table::contains<u256, GridContract<T0>>(&arg0.contracts, v1.contract_id)) {
            assert!(((v1.contract_id >> 192 & 4294967295) as u32) < ((v1.contract_id >> 160 & 4294967295) as u32), 31);
            assert!(((v1.contract_id >> 32 & 18446744073709551615) as u64) < ((v1.contract_id >> 96 & 18446744073709551615) as u64), 32);
            let v16 = GridContract<T0>{
                reward    : 0x2::balance::zero<T0>(),
                positions : 0x2::table::new<address, Position>(arg19),
            };
            0x2::table::add<u256, GridContract<T0>>(&mut arg0.contracts, v1.contract_id, v16);
        };
        let v17 = 0x2::table::borrow_mut<u256, GridContract<T0>>(&mut arg0.contracts, v1.contract_id);
        let v18 = &mut v17.positions;
        let v19 = add_position(v18, v0.user, false, v13);
        let v20 = &mut v17.positions;
        let v21 = v13 - add_position(v20, v1.user, true, v13);
        0x2::balance::join<T0>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v0.user).balance, 0x2::balance::split<T0>(&mut v17.reward, v19));
        assert!(0x2::balance::value<T0>(&0x2::table::borrow<address, Account<T0>>(&arg0.accounts, v0.user).balance) >= v15, 18);
        let v22 = 0x2::balance::split<T0>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v0.user).balance, v15);
        0x2::balance::join<T0>(&mut arg0.fees, 0x2::balance::split<T0>(&mut v22, v15 * arg0.taker_fee_bps / 10000));
        0x2::balance::join<T0>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v1.user).balance, v22);
        assert!(0x2::balance::value<T0>(&0x2::table::borrow<address, Account<T0>>(&arg0.accounts, v1.user).balance) >= v21, 33);
        0x2::balance::join<T0>(&mut v17.reward, 0x2::balance::split<T0>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v1.user).balance, v21));
        let v23 = if (0x1::option::is_some<u64>(&v0.total_amount)) {
            v13
        } else {
            v15
        };
        if (0x2::table::contains<u64, NonceData>(&0x2::table::borrow<address, Account<T0>>(&arg0.accounts, v0.user).nonce_data, v0.nonce)) {
            let v24 = 0x2::table::borrow_mut<u64, NonceData>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v0.user).nonce_data, v0.nonce);
            let v25 = 0x1::option::get_with_default<u64>(&v24.filled_amount, 0) + v23;
            let v26 = if (0x1::option::is_some<u64>(&v0.total_amount)) {
                0x1::option::get_with_default<u64>(&v0.total_amount, 0)
            } else {
                v0.total_price
            };
            assert!(v25 <= v26, 25);
            v24.filled_amount = 0x1::option::some<u64>(v25);
        } else {
            let v27 = NonceData{
                expiry        : v0.expiry,
                filled_amount : 0x1::option::some<u64>(v23),
            };
            0x2::table::add<u64, NonceData>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v0.user).nonce_data, v0.nonce, v27);
        };
        if (0x2::table::contains<u64, NonceData>(&0x2::table::borrow<address, Account<T0>>(&arg0.accounts, v1.user).nonce_data, v1.nonce)) {
            let v28 = 0x2::table::borrow_mut<u64, NonceData>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v1.user).nonce_data, v1.nonce);
            let v29 = 0x1::option::get_with_default<u64>(&v28.filled_amount, 0) + v13;
            assert!(v29 <= v1.total_amount, 25);
            v28.filled_amount = 0x1::option::some<u64>(v29);
        } else {
            let v30 = NonceData{
                expiry        : v1.expiry,
                filled_amount : 0x1::option::some<u64>(v13),
            };
            0x2::table::add<u64, NonceData>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, v1.user).nonce_data, v1.nonce, v30);
        };
    }
    ...
    public fun settle_no_side<T0>(arg0: &mut Exchange<T0>, arg1: u256, arg2: u32, arg3: address, arg4: u64, arg5: u64, arg6: u32, arg7: u32, arg8: 0x2::object::ID, arg9: &vector<u8>, arg10: &0x2::clock::Clock) {
        ...
        if (0x2::table::contains<address, Position>(&v6.positions, arg3) && 0x2::table::borrow<address, Position>(&v6.positions, arg3).is_short) {
            let Position {
                amount   : v7,
                is_short : _,
            } = 0x2::table::remove<address, Position>(&mut v6.positions, arg3);
            if (0x2::table::contains<address, Account<T0>>(&arg0.accounts, arg3)) {
                0x2::balance::join<T0>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, arg3).balance, 0x2::balance::split<T0>(&mut v6.reward, v7));
            } else {
                0x2::balance::send_funds<T0>(0x2::balance::split<T0>(&mut v6.reward, v7), arg3);
            };
        };
        if (0x2::balance::value<T0>(&v6.reward) == 0) {
            ...
            0x2::table::drop<address, Position>(v10);
        };
    }
    ...
    public fun settle_yes_side<T0>(arg0: &mut Exchange<T0>, arg1: u256, arg2: address, arg3: u32, arg4: u64, arg5: u32, arg6: 0x2::object::ID, arg7: &vector<u8>, arg8: &0x2::clock::Clock) {
        ...
        let v6 = 0x2::table::borrow_mut<u256, GridContract<T0>>(&mut arg0.contracts, arg1);
        if (0x2::table::contains<address, Position>(&v6.positions, arg2) && !0x2::table::borrow<address, Position>(&v6.positions, arg2).is_short) {
            let Position {
                amount   : v7,
                is_short : _,
            } = 0x2::table::remove<address, Position>(&mut v6.positions, arg2);
            if (0x2::table::contains<address, Account<T0>>(&arg0.accounts, arg2)) {
                0x2::balance::join<T0>(&mut 0x2::table::borrow_mut<address, Account<T0>>(&mut arg0.accounts, arg2).balance, 0x2::balance::split<T0>(&mut v6.reward, v7));
            } else {
                0x2::balance::send_funds<T0>(0x2::balance::split<T0>(&mut v6.reward, v7), arg2);
            };
        };
        if (0x2::balance::value<T0>(&v6.reward) == 0) {
            let GridContract {
