module 0x605234098591dd983843c4832d89465d643ba1b612aeeeb0081ecd87640a52a7::reward4047 {
    struct REWARD4047 has drop {
        dummy_field: bool,
    }

    struct TICKET_4047 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4047(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4047>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4047>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4047, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4047>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4047>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4047>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4047>>(v5, 0x2::tx_context::sender(arg1));
    }
