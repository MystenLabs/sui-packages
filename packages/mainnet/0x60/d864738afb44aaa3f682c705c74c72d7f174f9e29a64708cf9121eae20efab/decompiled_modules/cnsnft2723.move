module 0x60d864738afb44aaa3f682c705c74c72d7f174f9e29a64708cf9121eae20efab::cnsnft2723 {
    struct CNSNFT2723 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2723, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2723>(arg0, arg1);
