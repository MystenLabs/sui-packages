module 0x60e1fbb84b0ae8e7e543b97f60fe1795910f692bc3843648ba12f72d570102fe::amm_v2 {
    ...
    fun calculate_lp_mint_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u128) : u64 {
        if (arg0 == 0) {
            (((0x1::u64::sqrt(arg1 + arg5) as u128) * (0x1::u64::sqrt(arg2 + arg6) as u128) * 1000000000 / arg7) as u64)
        } else {
            let v1 = (arg1 as u128) * 1000000000 / ((arg3 + arg5) as u128);
            let v2 = (arg2 as u128) * 1000000000 / ((arg4 + arg6) as u128);
            let v3 = if (v1 < v2) {
                v1
            } else {
                v2
            };
            (((arg0 as u128) * v3 / 1000000000) as u64)
        }
    }
