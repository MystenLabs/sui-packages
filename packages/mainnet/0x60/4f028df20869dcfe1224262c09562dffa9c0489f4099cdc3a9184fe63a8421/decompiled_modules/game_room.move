module 0x604f028df20869dcfe1224262c09562dffa9c0489f4099cdc3a9184fe63a8421::game_room {
    ...
    struct GameRoomStore<phantom T0> has store, key {
        id: 0x2::object::UID,
    ...
    public fun cancel_room<T0>(arg0: &mut GameRoomStore<T0>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v4 = if (v0.is_sponsored) {
            0x2::coin::take<T0>(v3, v2, arg3)
        } else {
            let v5 = 0;
            while (v5 < 0x1::vector::length<address>(&v0.participant_vector)) {
                let v6 = *0x1::vector::borrow<address>(&v0.participant_vector, v5);
                if (v6 != v0.creator) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(v3, v0.entry_fee, arg3), v6);
                };
                v5 = v5 + 1;
            };
            0x2::coin::take<T0>(v3, v0.entry_fee, arg3)
        };
    ...
    public fun collect_completion_signature<T0>(arg0: &mut GameRoomStore<T0>, arg1: address, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<address, GameRoom>(&mut arg0.rooms, arg1);
    ...
    public fun complete_game<T0>(arg0: &mut GameRoomStore<T0>, arg1: address, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<address, GameRoom>(&mut arg0.rooms, arg1);
        if (v0.is_special) {
        ...
        if (v7 == 0) {
            ...
            if (v0.is_sponsored) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.treasury, v0.total_prize_pool, arg5), v0.creator);
                ...
                while (v10 < 0x1::vector::length<address>(v8)) {
                    ...
                    if (0x2::table::contains<address, GameRoomParticipant>(&v0.participants, v11)) {
                        ...
                        if (v12.entry_fee_paid > 0) {
                            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.treasury, v12.entry_fee_paid, arg5), v11);
                        };
                    };
                    v10 = v10 + 1;
                };
            ...
            if (v15 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.treasury, v15, arg5), @0x32572830354edf43effe74bb5f67e3fa6aa99bbc0133b9152fce5e30f45ca841);
            };
            if (v16 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.treasury, v16, arg5), v0.creator);
            };
            ...
            while (v25 < v7) {
                ...
                if (v35 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.treasury, v35, arg5), v36);
                };
                v25 = v25 + 1;
            };
    ...
    public fun create_room<T0>(arg0: &mut GameRoomStore<T0>, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: bool, arg7: 0x1::string::String, arg8: bool, arg9: bool, arg10: u64, arg11: 0x1::string::String, arg12: u64, arg13: u64, arg14: &0x2::clock::Clock, arg15: 0x2::coin::Coin<T0>, arg16: &mut 0x2::tx_context::TxContext) : (address, 0x2::coin::Coin<T0>) {
        let v0 = 0x2::clock::timestamp_ms(arg14);
        let v1 = 0x2::tx_context::sender(arg16);
        if (arg8) {
            assert!(0x2::coin::value<T0>(&arg15) >= arg10, 13);
        } else {
            assert!(0x2::coin::value<T0>(&arg15) >= arg3, 3);
        };
        let v2 = if (arg8) {
            arg10
        } else {
        ...
        let v10 = if (!arg8) {
            if (0x2::coin::value<T0>(&arg15) > arg3) {
                0x2::coin::put<T0>(&mut arg0.treasury, 0x2::coin::split<T0>(&mut arg15, arg3, arg16));
                arg15
            } else {
                0x2::coin::put<T0>(&mut arg0.treasury, arg15);
                0x2::coin::zero<T0>(arg16)
            }
        } else if (0x2::coin::value<T0>(&arg15) > arg10) {
            0x2::coin::put<T0>(&mut arg0.treasury, 0x2::coin::split<T0>(&mut arg15, arg10, arg16));
            arg15
        } else {
            0x2::coin::put<T0>(&mut arg0.treasury, arg15);
            0x2::coin::zero<T0>(arg16)
    ...
    public fun fetch_room<T0>(arg0: &GameRoomStore<T0>, arg1: address) : &GameRoom {
        assert!(0x2::table::contains<address, GameRoom>(&arg0.rooms, arg1), 2);
        0x2::table::borrow<address, GameRoom>(&arg0.rooms, arg1)
    }

    public fun get_game_room_rules<T0>(arg0: &GameRoomStore<T0>, arg1: address) : (&0x1::string::String, &0x1::string::String, u64, u64, &0x1::string::String) {
    ...
    public fun get_participant_details<T0>(arg0: &GameRoomStore<T0>, arg1: address, arg2: address) : &GameRoomParticipant {
        let v0 = 0x2::table::borrow<address, GameRoom>(&arg0.rooms, arg1);
    ...
    public fun get_room_details<T0>(arg0: &GameRoomStore<T0>, arg1: address) : &GameRoom {
        0x2::table::borrow<address, GameRoom>(&arg0.rooms, arg1)
    }

    public fun get_room_participants<T0>(arg0: &GameRoomStore<T0>, arg1: address) : &0x2::table::Table<address, GameRoomParticipant> {
        &0x2::table::borrow<address, GameRoom>(&arg0.rooms, arg1).participants
    }

    public fun get_signature_status<T0>(arg0: &GameRoomStore<T0>, arg1: address) : (u64, u64, bool) {
        let v0 = 0x2::table::borrow<address, GameRoom>(&arg0.rooms, arg1);
        if (!v0.is_special) {
            return (0, 0, true)
        };
    ...
    public fun get_total_rooms<T0>(arg0: &GameRoomStore<T0>) : u64 {
        arg0.room_counter
    }

    public fun has_signed<T0>(arg0: &GameRoomStore<T0>, arg1: address, arg2: address) : bool {
        let v0 = 0x2::table::borrow<address, GameRoom>(&arg0.rooms, arg1);
        if (!v0.is_special) {
            return false
        };
    ...
    public fun init_for_coin<T0>(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = RoomManagerCap{id: 0x2::object::new(arg0)};
        let v1 = GameRoomStore<T0>{
        ...
        0x2::transfer::share_object<GameRoomStore<T0>>(v1);
    }

    public fun is_player_in_room<T0>(arg0: &GameRoomStore<T0>, arg1: address, arg2: address) : bool {
        let v0 = 0x2::table::borrow<address, GameRoom>(&arg0.rooms, arg1);
    ...
    public fun join_room<T0>(arg0: &mut GameRoomStore<T0>, arg1: address, arg2: 0x1::string::String, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (address, 0x2::coin::Coin<T0>) {
        let v0 = 0x2::table::borrow_mut<address, GameRoom>(&mut arg0.rooms, arg1);
        if (v0.is_private) {
        ...
        if (!v0.is_sponsored) {
            assert!(0x2::coin::value<T0>(&arg3) >= v0.entry_fee, 3);
        };
        ...
        let v7 = if (!v0.is_sponsored) {
            let v7 = if (0x2::coin::value<T0>(&arg3) > v0.entry_fee) {
                0x2::coin::put<T0>(&mut arg0.treasury, 0x2::coin::split<T0>(&mut arg3, v0.entry_fee, arg5));
                arg3
            } else {
                0x2::coin::put<T0>(&mut arg0.treasury, arg3);
    ...
    public fun leave_room<T0>(arg0: &mut GameRoomStore<T0>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::table::borrow_mut<address, GameRoom>(&mut arg0.rooms, arg1);
        let v2 = b"waiting";
        assert!(0x1::string::as_bytes(&v1.status) == &v2, 5);
        let v3 = 0;
        let v4 = false;
        let v5 = 0x1::vector::length<address>(&v1.participant_vector);
        if (0x1::vector::borrow<address>(&v1.participant_vector, v5 - 1) == &v0) {
            0x1::vector::pop_back<address>(&mut v1.participant_vector);
        } else {
            while (v3 < v5 && !v4) {
                if (0x1::vector::borrow<address>(&v1.participant_vector, v3) == &v0) {
                    0x1::vector::remove<address>(&mut v1.participant_vector, v3);
                    v4 = true;
                    continue
                };
                v3 = v3 + 1;
        ...
        v1.current_players = v1.current_players - 1;
        v1.updated_at = 0x2::clock::timestamp_ms(arg2);
        let v6 = 0x2::table::borrow_mut<address, GameRoomParticipant>(&mut v1.participants, v0);
        assert!(v6.is_active, 9);
        v6.is_active = false;
        v6.left_at = 0x2::clock::timestamp_ms(arg2);
        let v7 = if (v1.is_sponsored) {
            0
        } else {
            v1.entry_fee
        };
        if (v7 > 0) {
            v1.total_prize_pool = v1.total_prize_pool - v7;
        };
        let v8 = PlayerLeft{
            room_id       : arg1,
            player        : v0,
        ...
        0x2::coin::take<T0>(&mut arg0.treasury, v7, arg3)
    }

    public fun room_exists<T0>(arg0: &GameRoomStore<T0>, arg1: address) : bool {
        0x2::table::contains<address, GameRoom>(&arg0.rooms, arg1)
    }

    public fun start_game<T0>(arg0: &mut GameRoomStore<T0>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<address, GameRoom>(&mut arg0.rooms, arg1);
        assert!(v0.creator == 0x2::tx_context::sender(arg3), 4);
        let v1 = b"waiting";
        assert!(0x1::string::as_bytes(&v0.status) == &v1, 5);
