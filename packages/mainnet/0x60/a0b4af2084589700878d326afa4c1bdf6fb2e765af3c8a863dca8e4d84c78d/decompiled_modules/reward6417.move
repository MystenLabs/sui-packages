module 0x60a0b4af2084589700878d326afa4c1bdf6fb2e765af3c8a863dca8e4d84c78d::reward6417 {
    struct REWARD6417 has drop {
        dummy_field: bool,
    }

    struct TICKET_6417 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6417(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_6417>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6417, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6417>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6417>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6417>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6417>>(v5, 0x2::tx_context::sender(arg1));
    }
