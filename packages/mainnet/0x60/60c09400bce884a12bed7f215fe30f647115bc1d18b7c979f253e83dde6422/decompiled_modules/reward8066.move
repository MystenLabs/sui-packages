module 0x6060c09400bce884a12bed7f215fe30f647115bc1d18b7c979f253e83dde6422::reward8066 {
    struct REWARD8066 has drop {
        dummy_field: bool,
    }

    struct TICKET_8066 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8066(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8066>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8066>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8066, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8066>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8066>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8066>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8066>>(v5, 0x2::tx_context::sender(arg1));
    }
