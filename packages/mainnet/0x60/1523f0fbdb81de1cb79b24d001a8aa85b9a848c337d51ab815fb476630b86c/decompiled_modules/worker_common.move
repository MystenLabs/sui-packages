module 0x601523f0fbdb81de1cb79b24d001a8aa85b9a848c337d51ab815fb476630b86c::worker_common {
    ...
    struct Worker has store {
        ...
        message_libs: 0x2::vec_set::VecSet<address>,
        ...
        worker_cap: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call_cap::CallCap,
    ...
    struct SetSupportedMessageLibEvent has copy, drop {
        worker: address,
        message_lib: address,
        supported: bool,
    }
    ...
    public fun assert_acl(arg0: &Worker, arg1: address) {
        assert!(has_acl(arg0, arg1), 11);
    }

    public fun assert_admin(arg0: &Worker, arg1: &AdminCap) {
        assert!(is_admin(arg0, arg1), 15);
    }

    public fun assert_owner(arg0: &Worker, arg1: &OwnerCap) {
        assert!(arg0.owner_cap_id == 0x2::object::id_address<OwnerCap>(arg1), 15);
    }

    public fun assert_supported_message_lib(arg0: &Worker, arg1: address) {
        assert!(is_supported_message_lib(arg0, arg1), 16);
    }
    ...
    public fun create_worker(arg0: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call_cap::CallCap, arg1: address, arg2: vector<address>, arg3: address, arg4: address, arg5: u16, arg6: vector<address>, arg7: &mut 0x2::tx_context::TxContext) : (Worker, OwnerCap) {
        assert!(!0x1::vector::is_empty<address>(&arg6), 10);
        assert!(arg1 != @0x0, 6);
        let v0 = OwnerCap{id: 0x2::object::new(arg7)};
        let v1 = AdminRegistry{
            active_admins         : 0x2::vec_set::empty<address>(),
            admin_to_admin_cap_id : 0x2::table::new<address, address>(arg7),
            admin_cap_status      : 0x2::table::new<address, bool>(arg7),
        };
        let v2 = Worker{
            deposit_address        : arg1,
            message_libs           : 0x2::vec_set::empty<address>(),
            worker_fee_lib         : arg4,
            price_feed             : arg3,
            ...
            supported_option_types : 0x2::table::new<u32, vector<u8>>(arg7),
            worker_cap             : arg0,
            admin_registry         : v1,
        ...
        while (v3 < 0x1::vector::length<address>(&arg6)) {
            let v4 = &mut v2;
            set_admin(v4, &v0, 0x1::vector::pop_back<address>(&mut arg6), true, arg7);
            v3 = v3 + 1;
        };
        ...
        while (v5 < 0x1::vector::length<address>(&arg2)) {
            let v6 = &mut v2;
            set_supported_message_lib(v6, &v0, 0x1::vector::pop_back<address>(&mut arg2), true);
            v5 = v5 + 1;
        };
    ...
    public fun is_supported_message_lib(arg0: &Worker, arg1: address) : bool {
        0x2::vec_set::contains<address>(&arg0.message_libs, &arg1)
    }
    ...
    public fun set_allowlist(arg0: &mut Worker, arg1: &OwnerCap, arg2: address, arg3: bool) {
        ...
        if (arg3) {
            ...
            assert!(is_on_allowlist(arg0, arg2), 12);
    ...
    public fun set_denylist(arg0: &mut Worker, arg1: &OwnerCap, arg2: address, arg3: bool) {
        ...
        if (arg3) {
            ...
            assert!(is_on_denylist(arg0, arg2), 13);
    ...
    public fun set_supported_message_lib(arg0: &mut Worker, arg1: &OwnerCap, arg2: address, arg3: bool) {
        assert_owner(arg0, arg1);
        if (arg3) {
            assert!(!is_supported_message_lib(arg0, arg2), 8);
            0x2::vec_set::insert<address>(&mut arg0.message_libs, arg2);
        } else {
            assert!(is_supported_message_lib(arg0, arg2), 9);
            0x2::vec_set::remove<address>(&mut arg0.message_libs, &arg2);
        };
        let v0 = SetSupportedMessageLibEvent{
            worker      : worker_cap_address(arg0),
            message_lib : arg2,
            supported   : arg3,
        };
        0x2::event::emit<SetSupportedMessageLibEvent>(v0);
    }
    ...
    public fun worker_cap(arg0: &Worker) : &0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call_cap::CallCap {
        &arg0.worker_cap
    }

    public fun worker_cap_address(arg0: &Worker) : address {
        0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call_cap::id(&arg0.worker_cap)
    }
