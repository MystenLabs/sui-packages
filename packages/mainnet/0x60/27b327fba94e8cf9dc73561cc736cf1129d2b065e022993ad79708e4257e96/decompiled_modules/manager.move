module 0x6027b327fba94e8cf9dc73561cc736cf1129d2b065e022993ad79708e4257e96::manager {
    ...
    public entry fun balance_of(arg0: &GalxeTable, arg1: u64, arg2: address) : u64 {
    ...
    public entry fun get_space(arg0: &GalxeTable, arg1: u64) : SpaceInfo {
    ...
    public entry fun has_claimed(arg0: &GalxeTable, arg1: u64, arg2: u64) : bool {
        0x2::table::contains<u64, bool>(&0x2::table::borrow<u64, SpacePoint>(&arg0.spaces, arg1).has_claimed, arg2)
    }

    public entry fun increasePoint(arg0: &mut GalxeTable, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg6);
        let v1 = MintChallenge{
            claim_to : arg4,
            amount   : arg2,
    ...
    public fun space(arg0: &GalxeTable, arg1: u64) : &SpacePoint {
        0x2::table::borrow<u64, SpacePoint>(&arg0.spaces, arg1)
    }
