module 0x60522d0e4aa1c630319e72276c3af5a7b6a837e278d9c5eabfae984dc6b5a61e::display_nft {
    ...
    fun init(arg0: DISPLAY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"somebody"));
        ...
        let v6 = My_NFT{
            ...
            name      : 0x1::string::utf8(b"display nft"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/116293226?s=400&u=b9628112f43a958fd75d47efbc3bc6893397d546&v=4"),
        };
