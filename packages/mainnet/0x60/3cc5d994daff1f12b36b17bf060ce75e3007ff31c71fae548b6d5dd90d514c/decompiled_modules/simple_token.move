module 0x603cc5d994daff1f12b36b17bf060ce75e3007ff31c71fae548b6d5dd90d514c::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"SKWID", b"SKWID", b"Official token. Banner on Dexscreener paid!", 0x1::option::none<0x2::url::Url>(), arg1);
