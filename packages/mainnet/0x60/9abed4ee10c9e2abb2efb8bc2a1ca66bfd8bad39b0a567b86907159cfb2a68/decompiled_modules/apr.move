module 0xdb96d18376a5ae96e6bb35a39e36076cb66202d12413e5ed153e5a9f2274c282::apr {
    ...
    public(friend) fun last_ratio(arg0: &0x2::object::UID) : u256 {
    ...
    public(friend) fun ratio_from_amounts(arg0: u64, arg1: u64) : u256 {
        if (arg1 == 0) {
            0
        } else {
    ...
    public(friend) fun update_apr_from_ratio(arg0: &mut 0x2::object::UID, arg1: u256, arg2: u256, arg3: u64) : u256 {
