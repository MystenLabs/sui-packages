module 0x60d5d223b47af033ea52270528686650a08de655403cb004b91a692cbedc626f::test_drop_2 {
    struct TEST_DROP_2 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_DROP_2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_DROP_2>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test Drop 2"));
