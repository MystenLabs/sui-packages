module 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::big_vector {
    ...
    public fun find_key_at_rank<T0: store>(arg0: &BigVector<T0>, arg1: u64) : u128 {
        if (arg0.root_id == 0) {
            abort 5
        };
        let v0 = 0;
        ...
        while (v9 < 0x1::vector::length<u128>(&v8.keys)) {
            if (v0 == arg1) {
                return *0x1::vector::borrow<u128>(&v8.keys, v9)
            };
            v0 = v0 + 1;
            v9 = v9 + 1;
        };
        if (0x1::vector::length<u128>(&v8.keys) > 0) {
            *0x1::vector::borrow<u128>(&v8.keys, 0x1::vector::length<u128>(&v8.keys) - 1)
        } else {
            0
        }
    }
    ...
    public fun find_rank<T0: store>(arg0: &BigVector<T0>, arg1: u128) : u64 {
        if (arg0.root_id == 0) {
            abort 5
        };
        let v0 = arg0.depth;
        ...
        v2 + slice_bisect_left<T0>(0x2::dynamic_field::borrow<u64, Slice<T0>>(&arg0.id, v1), arg1)
    }
    ...
    fun leaf_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: T0) : (u128, u64) {
        ...
        let v3 = Slice<T0>{
            prev : arg1,
            next : v0.next,
            keys : 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_until<u128>(&mut v0.keys, v2),
            vals : 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_until<T0>(&mut v0.vals, v2),
            size : 0,
        };
    ...
    fun node_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u8, arg3: u128, arg4: T0) : (u128, u64) {
        ...
        let v7 = Slice<u64>{
            prev : arg1,
            next : v5.next,
            keys : 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_until<u128>(&mut v5.keys, v6),
            vals : 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_until<u64>(&mut v5.vals, v6),
            size : 0,
        };
    ...
    fun slice_redistribute<T0: store, T1: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: u64) : u128 {
        ...
        let (v8, v22) = if (v21) {
            let v23 = 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_until<T1>(&mut v8, v19);
            0x1::vector::append<T1>(&mut v23, v15);
            (v8, v23)
        } else {
            0x1::vector::append<T1>(&mut v8, v15);
            (v8, 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_n<T1>(&mut v15, v20))
        };
        let v24 = v22;
        let (v9, v25, v26) = if (v2 && v21) {
            let v27 = 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_until<u128>(&mut v9, v19);
            0x1::vector::append<u128>(&mut v27, v12);
            (v9, *0x1::vector::borrow<u128>(&v27, 0), v27)
        } else {
            let (v28, v29, v9) = if (v2 && !v21) {
                let v30 = v12;
                let v31 = 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_n<u128>(&mut v30, v20);
                0x1::vector::append<u128>(&mut v9, v30);
                (*0x1::vector::borrow<u128>(&v31, 0), v31, v9)
            } else {
                let (v9, v32, v33) = if (!v2 && v21) {
                    let v34 = 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_until<u128>(&mut v9, v19);
                    0x1::vector::push_back<u128>(&mut v34, arg2);
                    0x1::vector::append<u128>(&mut v34, v12);
                    (v9, 0x1::vector::pop_back<u128>(&mut v9), v34)
                } else {
                    0x1::vector::push_back<u128>(&mut v9, arg2);
                    let v35 = v12;
                    0x1::vector::append<u128>(&mut v9, v35);
                    (v9, 0x1::vector::pop_back<u128>(&mut v35), 0x60c6ff4c6f5b4e201d2af46e40b549575dfe12fabb0b77da54860ca1c8a5ec8f::utils::pop_n<u128>(&mut v35, v20 - 1))
                };
                (v32, v33, v9)
            };
            (v9, v28, v29)
        ...
        0x2::dynamic_field::add<u64, Slice<T1>>(&mut arg0.id, arg1, v36);
        let v37 = Slice<T1>{
            prev : v10,
            next : v11,
            keys : v26,
        ...
        0x2::dynamic_field::add<u64, Slice<T1>>(&mut arg0.id, arg3, v37);
        if (v2) {
            let v38 = 0x2::dynamic_field::borrow_mut<u64, Slice<T0>>(&mut arg0.id, arg1);
            v38.size = 0x1::vector::length<T0>(&v38.vals);
            let v39 = 0x2::dynamic_field::borrow_mut<u64, Slice<T0>>(&mut arg0.id, arg3);
            v39.size = 0x1::vector::length<T0>(&v39.vals);
        } else {
            let v40 = &arg0.id;
            let v41 = 0;
            let v42 = 0;
            let v43 = 0;
            let v44 = 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, arg1);
            while (v41 < 0x1::vector::length<T1>(&v8)) {
                v42 = v42 + 0x2::dynamic_field::borrow<u64, Slice<T0>>(v40, *0x1::vector::borrow<u64>(&v44.vals, v41)).size;
            };
            let v45 = 0;
            let v46 = 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, arg3);
            while (v45 < 0x1::vector::length<T1>(&v24)) {
                v43 = v43 + 0x2::dynamic_field::borrow<u64, Slice<T0>>(v40, *0x1::vector::borrow<u64>(&v46.vals, v45)).size;
            };
            0x2::dynamic_field::borrow_mut<u64, Slice<u64>>(&mut arg0.id, arg3).size = v43;
            assert!(v43 > 0, 111);
            0x2::dynamic_field::borrow_mut<u64, Slice<u64>>(&mut arg0.id, arg1).size = v42;
            assert!(v42 > 0, 111);
        };
        v25
    }
