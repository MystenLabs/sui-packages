module 0xba0b81fdf50cba87ac4a95686dfed7baf21323adea809b41875b040fff6c072a::admin {
    ...
    public fun execute_unregister_harvest_protocol(arg0: &mut 0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::timelock::TimelockRegistry, arg1: &mut 0xba0b81fdf50cba87ac4a95686dfed7baf21323adea809b41875b040fff6c072a::harvest::HarvestConfig, arg2: &0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::vault::AdminCap, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        assert!(v0 == 13, 901);
        let v2 = 0x2::bcs::new(v1);
        0xba0b81fdf50cba87ac4a95686dfed7baf21323adea809b41875b040fff6c072a::harvest::unregister_harvest_protocol(arg1, arg2, 0x2::bcs::peel_u8(&mut v2));
    }
    ...
    public fun execute_update_has_rewards(arg0: &mut 0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::timelock::TimelockRegistry, arg1: &mut 0xba0b81fdf50cba87ac4a95686dfed7baf21323adea809b41875b040fff6c072a::strategy::StrategyRegistry, arg2: &0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::vault::AdminCap, arg3: u64, arg4: &0x2::clock::Clock) {
        let (v0, v1) = 0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::timelock::execute(arg0, arg3, arg4);
        assert!(v0 == 12, 901);
        let v2 = 0x2::bcs::new(v1);
        0xba0b81fdf50cba87ac4a95686dfed7baf21323adea809b41875b040fff6c072a::strategy::update_has_rewards(arg1, arg2, 0x2::bcs::peel_u8(&mut v2), 0x2::bcs::peel_bool(&mut v2));
    }
    ...
    public fun propose_unregister_harvest_protocol(arg0: &0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::vault::AdminCap, arg1: &mut 0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::timelock::TimelockRegistry, arg2: u8, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) : u64 {
        0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::timelock::propose(arg1, arg0, 13, 0x2::bcs::to_bytes<u8>(&arg2), arg3, arg4)
    }
    ...
    public fun propose_update_has_rewards(arg0: &0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::vault::AdminCap, arg1: &mut 0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::timelock::TimelockRegistry, arg2: u8, arg3: bool, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : u64 {
        let v0 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u8>(&arg2));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<bool>(&arg3));
        0xc8b07577c7390e9f8749d031f980676d060e22d819c3577b02573018959e68dd::timelock::propose(arg1, arg0, 12, v0, arg4, arg5)
    }
