module 0x2536af824bffa011b336e140841652e95a3f925207a5c642ad8c7e462f781d45::versioned {
    ...
    public entry fun pause(arg0: &0x2536af824bffa011b336e140841652e95a3f925207a5c642ad8c7e462f781d45::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public entry fun unpause(arg0: &0x2536af824bffa011b336e140841652e95a3f925207a5c642ad8c7e462f781d45::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public fun upgrade(arg0: &0x2536af824bffa011b336e140841652e95a3f925207a5c642ad8c7e462f781d45::admin_cap::AdminCap, arg1: &mut Versioned) {
