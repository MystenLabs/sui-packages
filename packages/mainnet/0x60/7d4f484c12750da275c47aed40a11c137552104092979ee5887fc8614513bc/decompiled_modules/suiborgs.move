module 0x607d4f484c12750da275c47aed40a11c137552104092979ee5887fc8614513bc::suiborgs {
    ...
    public fun mint_to_sender(arg0: &Whitelist, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = amout_to_pay(arg0, arg6);
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg5, v1, arg6), @0x63cb64db89b5bdbad83a94c38b562cbd4b0481c778f10dd2c7315ba9f984e6f9);
        ...
        let v2 = new(arg1, arg2, arg3, arg4, arg6);
        let v3 = NFTMinted{
            object_id : 0x2::object::id<GeneratedNFT>(&v2),
            creator   : v0,
            name      : v2.name,
        };
        0x2::event::emit<NFTMinted>(v3);
        0x2::transfer::transfer<GeneratedNFT>(v2, v0);
    }
