module 0x60cfb813b802d4fd946017432a4ddbeb8311b9d572ee917f1743af4e45b3370b::rockee_ai_nft {
    struct ROCKEE_AI_NFT has drop {
        dummy_field: bool,
    }
    ...
    struct RockeeAINFT has store, key {
        id: 0x2::object::UID,
        gen_id: u128,
    }
    ...
    public fun burn(arg0: &Config, arg1: RockeeAINFT, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1002);
        let RockeeAINFT {
            id     : v0,
            gen_id : v1,
        ...
        let v2 = BurnedEvent{
            ...
            campaign_id : 0x2::object::id<Config>(arg0),
            nft_id      : 0x2::object::id<RockeeAINFT>(&arg1),
            gen_id      : v1,
        };
    ...
    fun init(arg0: ROCKEE_AI_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = 0x2::package::claim<ROCKEE_AI_NFT>(arg0, arg1);
        let v2 = setup_nft_display(&v1, arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v1, v0);
        0x2::transfer::public_transfer<0x2::display::Display<RockeeAINFT>>(v2, v0);
    ...
    public fun mint(arg0: &mut Config, arg1: &mut 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1002);
        assert!(!arg0.paused, 1003);
        let v0 = 0x2::tx_context::sender(arg3);
        if (v0 != arg0.admin) {
            let v1 = 0x2::clock::timestamp_ms(arg2);
            assert!(v1 >= arg0.start_time, 1006);
            assert!(v1 <= arg0.end_time, 1010);
            let v2 = 0x2::tx_context::sender(arg3);
            assert!(0x2::table::contains<address, bool>(&arg0.whitelisted, v2), 1009);
            assert!(arg0.remaining > 0, 1005);
            assert!(!0x2::table::contains<address, bool>(&arg0.participants, v2), 1007);
            assert!(0x1::option::is_some<0x2::coin::Coin<0x2::sui::SUI>>(arg1), 1011);
            let v3 = 0x1::option::extract<0x2::coin::Coin<0x2::sui::SUI>>(arg1);
            assert!(0x2::coin::value<0x2::sui::SUI>(&v3) == arg0.mint_fee, 1000);
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.fee_balance, 0x2::coin::into_balance<0x2::sui::SUI>(v3));
            arg0.total_sold = arg0.total_sold + 1;
            arg0.remaining = arg0.remaining - 1;
            0x2::table::add<address, bool>(&mut arg0.participants, v2, true);
        };
        let v4 = RockeeAINFT{
        ...
        let v5 = MintedEvent{
            user        : v0,
            campaign_id : 0x2::object::id<Config>(arg0),
            nft_id      : 0x2::object::id<RockeeAINFT>(&v4),
            gen_id      : arg0.total_sold,
        };
        0x2::event::emit<MintedEvent>(v5);
        0x2::transfer::public_transfer<RockeeAINFT>(v4, v0);
    }
    ...
    fun setup_nft_display(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : 0x2::display::Display<RockeeAINFT> {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ROCKEE AI - Rockee AI Asset"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://assets.thebirds.ai/nfts/quest-hub/rockee-ai/{gen_id}.json"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://assets.thebirds.ai/nfts/quest-hub/rockee-ai/{gen_id}.png"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://assets.thebirds.ai/nfts/quest-hub/rockee-ai/{gen_id}-thumbnail.jpg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"The AI Layer powering DeFi on Sui. Ultimate all-in-one platform for DeFAI."));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://x.com/RockeeAI"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Rockee AI"));
        let v4 = 0x2::display::new_with_fields<RockeeAINFT>(arg0, v0, v2, arg1);
        0x2::display::update_version<RockeeAINFT>(&mut v4);
        v4
    }
