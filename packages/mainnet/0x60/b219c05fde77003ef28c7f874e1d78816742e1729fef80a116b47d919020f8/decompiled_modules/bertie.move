module 0x60b219c05fde77003ef28c7f874e1d78816742e1729fef80a116b47d919020f8::bertie {
    ...
    fun init(arg0: BERTIE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BERTIE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Bertie  ")))), trim_right(b"Bertie                          "), trim_right(b"Bertie - the official Guinness record holder of being the FASTEST turtle in the world - yes, Bertie is fast as fk boi with a record speed of 0.28 m/s                                                                                                                                                                           "), v2, arg1);
