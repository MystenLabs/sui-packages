module 0x600c2adf0ddd09607b40711aeeef0186bd1c0626b9e2ef914f61e485e853d3df::rich_watermelon {
    ...
    public fun offload<T0: store, T1: store>(arg0: &mut Store, arg1: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
    ...
    public fun upload<T0: store, T1: store>(arg0: &mut Store, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<u64>, arg4: vector<u64>, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: &mut 0x2::tx_context::TxContext) {
