module 0xa43cc9a94caa904a97316d97c08804369ee8fbe3335d2ddae154022d7d6e5d5d::soul {
    ...
    public fun animacraft_appearance_v6_id(arg0: &SoulState) : 0x2::object::ID {
        assert!(0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 3), 22);
        *0x2::dynamic_field::borrow<u8, 0x2::object::ID>(&arg0.id, 3)
    }

    public fun animacraft_output_provenance_v5_id(arg0: &SoulState) : 0x2::object::ID {
        assert!(0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 2), 20);
        *0x2::dynamic_field::borrow<u8, 0x2::object::ID>(&arg0.id, 2)
    }

    public fun animacraft_provenance_id(arg0: &SoulState) : 0x2::object::ID {
        assert!(0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 1), 20);
        *0x2::dynamic_field::borrow<u8, 0x2::object::ID>(&arg0.id, 1)
    }
    ...
    public(friend) fun bind_animacraft_appearance_v6(arg0: &mut SoulState, arg1: 0x2::object::ID) {
        assert!(!0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 3), 21);
        0x2::dynamic_field::add<u8, 0x2::object::ID>(&mut arg0.id, 3, arg1);
    }

    public(friend) fun bind_animacraft_output_provenance_v5(arg0: &mut SoulState, arg1: 0x2::object::ID) {
        assert!(!0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 2), 19);
        0x2::dynamic_field::add<u8, 0x2::object::ID>(&mut arg0.id, 2, arg1);
    }

    public(friend) fun bind_animacraft_provenance(arg0: &mut SoulState, arg1: 0x2::object::ID) {
        assert!(!0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 1), 19);
        0x2::dynamic_field::add<u8, 0x2::object::ID>(&mut arg0.id, 1, arg1);
    }
    ...
    public fun has_animacraft_appearance_v6(arg0: &SoulState) : bool {
        0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 3)
    }

    public fun has_animacraft_output_provenance_v5(arg0: &SoulState) : bool {
        0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 2)
    }

    public fun has_animacraft_provenance(arg0: &SoulState) : bool {
        0x2::dynamic_field::exists_with_type<u8, 0x2::object::ID>(&arg0.id, 1)
    }
    ...
    public(friend) fun provenance_animacraft() : u8 {
        3
    }
