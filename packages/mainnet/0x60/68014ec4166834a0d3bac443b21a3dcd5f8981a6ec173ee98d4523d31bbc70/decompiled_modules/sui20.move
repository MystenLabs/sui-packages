module 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20 {
    ...
    public fun update_global_v4(arg0: &mut Global, arg1: &mut AdminCap, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::bag::borrow_mut<0x1::string::String, Sui20Data>(&mut arg0.sui20tokens, arg2);
        assert!(v0.total_minted + arg3 <= v0.meta.max, 1004);
        v0.total_minted = v0.total_minted + arg3;
    }
