module 0x60531573115c0c12bbff060fb59650a3e627e0f3b7a5768ff81f003da6843c8f::drop_example {
    struct DROP_EXAMPLE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DROP_EXAMPLE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DROP_EXAMPLE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Drop example"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"drop description"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreihwgxk2tucuobnjpgo4r4ptldqoelm4vl7qr2nst5xgfioxq3fdhi"));
