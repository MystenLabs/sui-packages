module 0x230e21e983a67ad8015e2bad46983149a676fa1d2ca7c7cf15fef0d16a55369a::reward4828 {
    struct REWARD4828 has drop {
        dummy_field: bool,
    }

    struct TICKET_4828 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4828(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4828>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4828>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4828, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4828>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4828>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4828>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4828>>(v5, 0x2::tx_context::sender(arg1));
    }
