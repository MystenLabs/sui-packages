module 0x237cab96d6092c12a5898898c5efa04a9636d0a5a58ea168c834beb62c2e949d::suigift {
    ...
    public entry fun GiftBoxAirdrop(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUI_GIFTBOX{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuinet_0813/giftsuinet_0813_1.jpg"),
    ...
    fun init(arg0: SUIGIFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuinet_0813/giftsuinet_0813_1.jpg"));
