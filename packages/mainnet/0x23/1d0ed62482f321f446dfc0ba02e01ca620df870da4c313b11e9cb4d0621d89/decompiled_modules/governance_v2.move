module 0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::governance_v2 {
    ...
    public fun activate_governance(arg0: &0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: 0x1::type_name::TypeName, arg3: 0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::genesis::GovernanceManagerCap) {
        ...
        0x1::option::fill<0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::genesis::GovernanceManagerCap>(&mut arg1.governance_manager_cap, arg3);
        arg1.active = true;
    }

    public fun add_guardians(arg0: &0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: address) {
    ...
    public fun create_proposal<T0: drop + store, T1>(arg0: &GovernanceInfo, arg1: T0, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = Proposal<T0, T1>{
            ...
            certificate   : arg1,
            staked_coin   : 0x2::coin::into_balance<T1>(0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::merge_coins::merge_coin<T1>(arg2, arg3, arg4)),
            favor_num     : arg3,
            favor_votes   : v3,
            against_num   : 0,
    ...
    public fun create_proposal_with_history<T0: drop + store, T1>(arg0: &mut GovernanceInfo, arg1: T0, arg2: vector<0x2::coin::Coin<T1>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.active, 1);
        assert!(arg3 >= arg0.proposal_minimum_staking, 10);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::tx_context::epoch(arg4);
        ...
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.his_proposal, v5);
        let v6 = 0x1::type_name::get<T0>();
        let v7 = Proposal<T0, T1>{
            id            : v4,
            creator       : v0,
            start_vote    : v2,
            end_vote      : v2 + arg0.voting_delay,
            expired       : v1 + arg0.max_delay,
            package_id    : 0x1::type_name::get_address(&v6),
            certificate   : arg1,
            staked_coin   : 0x2::coin::into_balance<T1>(0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::merge_coins::merge_coin<T1>(arg2, arg3, arg4)),
            favor_num     : arg3,
            favor_votes   : v3,
        ...
        0x2::transfer::share_object<Proposal<T0, T1>>(v7);
        let v8 = CreateProposal{proposal_id: v5};
        0x2::event::emit<CreateProposal>(v8);
    }
    ...
    public fun remove_guardians(arg0: &0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: address) {
    ...
    public fun update_minumum_staking(arg0: &0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: u64, arg3: u64) {
    ...
    public fun vote_proposal<T0: drop + store, T1>(arg0: &GovernanceInfo, arg1: T0, arg2: &mut Proposal<T0, T1>, arg3: vector<0x2::coin::Coin<T1>>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::genesis::GovernanceCap> {
        ...
        if (v0 < arg2.end_vote) {
            0x2::balance::join<T1>(&mut arg2.staked_coin, 0x2::coin::into_balance<T1>(0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::merge_coins::merge_coin<T1>(arg3, arg4, arg6)));
            if (arg5) {
            ...
            0x2::coin::destroy_zero<T1>(0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::merge_coins::merge_coin<T1>(arg3, arg4, arg6));
