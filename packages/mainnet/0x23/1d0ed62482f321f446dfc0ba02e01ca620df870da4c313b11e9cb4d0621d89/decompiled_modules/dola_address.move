module 0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::dola_address {
    ...
    public fun decode_dola_address(arg0: vector<u8>) : DolaAddress {
        ...
        DolaAddress{
            dola_chain_id : 0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::serde::deserialize_u16(&v2),
            dola_address  : 0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::serde::vector_slice<u8>(&arg0, v0 + v1, 0x1::vector::length<u8>(&arg0)),
        }
    }

    public fun encode_dola_address(arg0: DolaAddress) : vector<u8> {
        let v0 = 0x1::vector::empty<u8>();
        0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::serde::serialize_u16(&mut v0, arg0.dola_chain_id);
        0x231d0ed62482f321f446dfc0ba02e01ca620df870da4c313b11e9cb4d0621d89::serde::serialize_vector(&mut v0, arg0.dola_address);
        v0
    }
