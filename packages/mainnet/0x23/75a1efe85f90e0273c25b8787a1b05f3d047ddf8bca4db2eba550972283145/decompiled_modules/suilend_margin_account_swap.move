module 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account_swap {
    public fun swap<T0, T1>(arg0: &mut 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::ProtectedMarginAccount, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg2: &mut 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::rfq_account::Account, arg3: u128, arg4: u128, arg5: u64, arg6: vector<u8>, arg7: u64, arg8: u64, arg9: u64, arg10: 0x2::coin::Coin<T0>, arg11: &0x2::clock::Clock, arg12: &mut 0x3::sui_system::SuiSystemState, arg13: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::rfq_account::verify_signature<T0, T1>(arg2, arg3, 0x2::object::id<0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::ProtectedMarginAccount>(arg0), arg4, arg7, arg8, arg9, arg5, arg6, arg11);
        let v0 = 0x2::coin::value<T0>(&arg10);
        let v1 = 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::rfq_account::calc_output_by_quote(arg7, arg8, arg9, v0);
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::assert_for_account(arg0, arg2);
        let (v2, v3) = 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::unsafe_borrow_obligation_cap(arg0);
        let v4 = v2;
        ...
        if (0x2::coin::value<T0>(&arg10) != 0) {
            0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::deposit_liquidity<T0>(arg1, &v4, v6, arg10, arg11, arg12, arg13);
        } else {
        ...
        if (v8 != 0) {
            0x2::coin::join<T1>(&mut v10, 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::withdraw_collateral<T1>(arg1, &v4, v7, 0x1::u64::min(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::ceil(v9), v8), arg11, arg12, arg13));
        };
        if (v1 > 0x2::coin::value<T1>(&v10)) {
            0x2::coin::join<T1>(&mut v10, 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::borrow_liquidity<T1>(arg1, &v4, v7, v1 - 0x2::coin::value<T1>(&v10), arg11, arg12, arg13));
        };
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::swap::emit_swap_event<T0, T1>(arg3, 0x2::object::id<0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::rfq_account::Account>(arg2), 0x2::object::id<0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::ProtectedMarginAccount>(arg0), arg4, v0, 0x2::coin::value<T1>(&v10));
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::suilend_margin_account::return_obligation_cap(arg0, v4, v3);
        v10
    }
