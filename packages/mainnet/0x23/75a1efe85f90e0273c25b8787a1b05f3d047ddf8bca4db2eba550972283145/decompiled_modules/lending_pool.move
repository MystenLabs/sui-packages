module 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::lending_pool {
    ...
    struct LendingPool<phantom T0> has key {
        ...
        pending_withdrawals: 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::Queue<Withdrawal<T0>>,
        borrowing_fee: 0x1::uq32_32::UQ32_32,
        protocol_fee: 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::protocol_fee::ProtocolFeeInfo,
        outstanding_debt: 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::OutstandingDebt<T0>,
    }
    ...
    public fun new<T0>(arg0: u64, arg1: u64, arg2: address, arg3: &mut LendingPoolRegistry, arg4: &0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::admin::AdminCap, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun borrow_and_check_later<T0>(arg0: &mut LendingPool<T0>, arg1: &mut 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::MarginAccount, arg2: u64, arg3: &0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::risk_params::RiskParams, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, u64, 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::MustCheckBorrowLimit) {
        let v0 = 0x1::uq32_32::int_mul(arg2, arg0.borrowing_fee);
        deposit_virtual_fees<T0>(arg0, v0);
        let v1 = 0x1::uq32_32::int_mul(arg2, 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::protocol_fee::fees(&arg0.protocol_fee));
        assert!(0x2::balance::value<T0>(&arg0.borrowable_base) >= arg2 + v1, 4);
        let (v2, v3) = 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::inscrease_debt<T0>(arg1, arg2 + v0 + v1, arg3, arg4, arg5);
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::join_outstanding_debt<T0>(&mut arg0.outstanding_debt, v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.borrowable_base, v1), arg5), 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::protocol_fee::recipient(&arg0.protocol_fee));
        let v4 = EventBorrow<T0>{
            margin_account_id : 0x2::object::id<0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::MarginAccount>(arg1),
            amount            : arg2,
        };
    ...
    public fun destroy<T0>(arg0: LendingPool<T0>, arg1: &0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::admin::AdminCap) : 0x2::balance::Balance<T0> {
        ...
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::destroy_empty<Withdrawal<T0>>(v5);
        0x2::object::delete(v0);
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::destroy_zero_outstanding_debt<T0>(v8);
        v3
    }
    ...
    fun internal_new<T0>(arg0: u64, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : LendingPool<T0> {
        LendingPool<T0>{
            ...
            pending_withdrawals   : 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::new<Withdrawal<T0>>(arg3),
            borrowing_fee         : 0x1::uq32_32::from_quotient(arg0, 10000),
            protocol_fee          : 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::protocol_fee::new(arg1, arg2),
            outstanding_debt      : 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::empty_outstanding_debt<T0>(),
        }
    }
    ...
    public(friend) fun internal_swap_repay_for_margin_account<T0>(arg0: &mut LendingPool<T0>, arg1: &mut 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::MarginAccount, arg2: 0x2::balance::Balance<T0>, arg3: &0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::risk_params::RiskParams, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun repay<T0>(arg0: &mut LendingPool<T0>, arg1: 0x2::balance::Balance<T0>) : 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::OutstandingDebt<T0> {
        assert!(0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::outstanding_debt_value<T0>(&arg0.outstanding_debt) >= 0x2::balance::value<T0>(&arg1), 1);
        while (!0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::is_empty<Withdrawal<T0>>(&arg0.pending_withdrawals) && 0x2::balance::value<T0>(&arg1) > 0) {
            let v0 = 0x1::u64::min(0x2::balance::value<T0>(&arg1), 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::borrow_front<Withdrawal<T0>>(&arg0.pending_withdrawals).owed);
            let v1 = 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::borrow_mut_front<Withdrawal<T0>>(&mut arg0.pending_withdrawals);
            0x2::balance::join<T0>(&mut v1.paid, 0x2::balance::split<T0>(&mut arg1, v0));
            v1.owed = v1.owed - v0;
            if (v1.owed == 0) {
                let (v2, v3) = into_completed_withdrawal_parts<T0>(0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::pop_front<Withdrawal<T0>>(&mut arg0.pending_withdrawals));
                0x2::table::add<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg0.completed_withdrawals, v2, v3);
            };
        };
        0x2::balance::join<T0>(&mut arg0.borrowable_base, arg1);
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::split_outstanding_debt<T0>(&mut arg0.outstanding_debt, 0x2::balance::value<T0>(&arg1))
    }

    public fun repay_for_margin_account<T0>(arg0: &mut LendingPool<T0>, arg1: &mut 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::MarginAccount, arg2: 0x2::balance::Balance<T0>, arg3: &0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::risk_params::RiskParams, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::margin_account::decrease_debt<T0>(arg1, repay<T0>(arg0, arg2), arg3, arg4, arg5);
    }
    ...
    public fun start_withdrawal<T0>(arg0: &mut LendingPool<T0>, arg1: DebtPoolShare<T0>, arg2: &mut 0x2::tx_context::TxContext) : WithdrawalTicket<T0> {
        ...
        let v4 = WithdrawalTicket<T0>{
            id          : v3,
            queue_index : 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::next_index<Withdrawal<T0>>(&arg0.pending_withdrawals),
        };
        ...
        if (v5 == v2) {
            ...
            0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::push<Withdrawal<T0>>(&mut arg0.pending_withdrawals, v6);
        };
    ...
    public fun update_borrowing_fees<T0>(arg0: &mut LendingPool<T0>, arg1: 0x1::uq32_32::UQ32_32, arg2: &0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::admin::AdminCap) {
        arg0.borrowing_fee = arg1;
    }

    public fun update_protocol_fees<T0>(arg0: &mut LendingPool<T0>, arg1: 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::protocol_fee::ProtocolFeeInfo, arg2: &0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::admin::AdminCap) {
    ...
    public fun withdrawable_base<T0>(arg0: &LendingPool<T0>, arg1: &WithdrawalTicket<T0>) : u64 {
        ...
        0x2::balance::value<T0>(&0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::queue::borrow_at<Withdrawal<T0>>(&arg0.pending_withdrawals, arg1.queue_index).paid)
    }
