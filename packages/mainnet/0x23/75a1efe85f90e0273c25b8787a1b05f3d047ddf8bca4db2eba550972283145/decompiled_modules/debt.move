module 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::debt {
    ...
    public fun calc_debt(arg0: &Debt, arg1: &mut 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::trusted_prices::TrustedPriceData) : u64 {
        ...
        while (!0x1::vector::is_empty<0x1::type_name::TypeName>(&v0)) {
            ...
            let v3 = 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::trusted_prices::pull_raw_price(arg1, v2);
            v1 = v1 + 0x2375a1efe85f90e0273c25b8787a1b05f3d047ddf8bca4db2eba550972283145::price::calc_value(&v3, *0x2::table::borrow<0x1::type_name::TypeName, u64>(&arg0.open_debt, v2));
        };
        v1
    }
