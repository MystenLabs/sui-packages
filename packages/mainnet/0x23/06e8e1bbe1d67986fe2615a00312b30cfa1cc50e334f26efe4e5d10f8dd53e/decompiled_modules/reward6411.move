module 0x2306e8e1bbe1d67986fe2615a00312b30cfa1cc50e334f26efe4e5d10f8dd53e::reward6411 {
    struct REWARD6411 has drop {
        dummy_field: bool,
    }

    struct TICKET_6411 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6411(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6411>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6411>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6411, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6411>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6411>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6411>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6411>>(v5, 0x2::tx_context::sender(arg1));
    }
