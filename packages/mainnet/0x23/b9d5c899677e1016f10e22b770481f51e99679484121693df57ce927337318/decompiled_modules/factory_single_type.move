module 0x23b9d5c899677e1016f10e22b770481f51e99679484121693df57ce927337318::factory_single_type {
    ...
    public entry fun create_treasury_cap_one_time(arg0: u8, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = TokenMarker{dummy_field: false};
        let (v1, v2) = 0x2::coin::create_currency<TokenMarker>(v0, arg0, arg1, arg2, b"TokenMarker for Meme Hedge Factory", 0x1::option::none<0x2::url::Url>(), arg3);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<TokenMarker>>(v1, 0x2::tx_context::sender(arg3));
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<TokenMarker>>(v2);
    }
