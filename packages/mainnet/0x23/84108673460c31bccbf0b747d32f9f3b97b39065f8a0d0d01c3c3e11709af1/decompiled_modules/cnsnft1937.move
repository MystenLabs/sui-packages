module 0x2384108673460c31bccbf0b747d32f9f3b97b39065f8a0d0d01c3c3e11709af1::cnsnft1937 {
    struct CNSNFT1937 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1937, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1937>(arg0, arg1);
