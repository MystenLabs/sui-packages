module 0x23b4b9584e6c443c7d20dc37800d6fe21c29595d44cc23c73ae4367354137f95::chippy {
    ...
    fun init(arg0: CHIPPY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CHIPPY>(arg0, 6, b"$CHIP", b"Chippy", b"DRAMATIC CHIPPY $CHIP IS A VIRAL INTERNET 5-SECOND CLIP OF A PRAIRIE DOG      https://chipppy.xyz/    https://x.com/ChippySuii   https://t.me/chippysui        ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://belaunchio.infura-ipfs.io/ipfs/QmRUiG2uWFGGgNNwJZLemhCEH6hz9rPQRdR8RSiP2zLD3b")), arg1);
