module 0x23d18a39f444ff429d5189fa0c5ea635a3afc1a9e2112f103a7349d96e975794::flp {
    ...
    public fun claim<T0>(arg0: &mut Flp1<T0>, arg1: &mut 0x23d18a39f444ff429d5189fa0c5ea635a3afc1a9e2112f103a7349d96e975794::pool::Pool<T0>, arg2: u16, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!0x2::vec_map::contains<u16, u64>(&arg0.claimed_rounds, &arg2), 0x23d18a39f444ff429d5189fa0c5ea635a3afc1a9e2112f103a7349d96e975794::errors::already_claimed());
        let v0 = 0x23d18a39f444ff429d5189fa0c5ea635a3afc1a9e2112f103a7349d96e975794::pool::claim_rewards<T0>(arg1, (arg2 as u64), arg0.lots);
    ...
    public(friend) fun mint<T0>(arg0: &MintCap, arg1: &mut 0x23d18a39f444ff429d5189fa0c5ea635a3afc1a9e2112f103a7349d96e975794::pool::Pool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : Flp1<T0> {
        assert!(arg2 != 0, 0x23d18a39f444ff429d5189fa0c5ea635a3afc1a9e2112f103a7349d96e975794::errors::invalid_params());
        let v0 = 0x2::object::new(arg3);
        let v1 = 0x23d18a39f444ff429d5189fa0c5ea635a3afc1a9e2112f103a7349d96e975794::pool::record_mint<T0>(arg1, arg2, 0x2::object::uid_to_inner(&v0));
