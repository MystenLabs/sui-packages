module 0x23db6dfd2be4da4f1d44ef79f9fb2b372d4bf1b18d31ccfd1a91c991b00d8331::cnsnft2603 {
    struct CNSNFT2603 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2603, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2603>(arg0, arg1);
