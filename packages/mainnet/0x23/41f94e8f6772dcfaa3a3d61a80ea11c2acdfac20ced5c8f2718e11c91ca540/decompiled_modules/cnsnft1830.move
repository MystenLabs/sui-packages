module 0x2341f94e8f6772dcfaa3a3d61a80ea11c2acdfac20ced5c8f2718e11c91ca540::cnsnft1830 {
    struct CNSNFT1830 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1830, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1830>(arg0, arg1);
