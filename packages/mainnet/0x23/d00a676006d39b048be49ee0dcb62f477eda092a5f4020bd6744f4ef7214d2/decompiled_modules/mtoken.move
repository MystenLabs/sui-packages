module 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::mtoken {
    ...
    public fun redeem_mtokens<T0, T1, T2>(arg0: &mut VestingManager<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::coin::Coin<T2>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v2 = if (v1 < arg0.end_time_s) {
            let v3 = 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::div(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::sub(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.end_time_s), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(v1)), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::sub(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.end_time_s), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.start_time_s)));
            0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::ceil(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::add(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::mul(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::div(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::mul(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.start_penalty_numerator), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(v0)), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.penalty_denominator)), v3), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::mul(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::div(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::mul(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.end_penalty_numerator), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(v0)), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.penalty_denominator)), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::sub(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(1), v3))))
        } else {
            0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::ceil(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::div(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::mul(0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.end_penalty_numerator), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(v0)), 0x23d00a676006d39b048be49ee0dcb62f477eda092a5f4020bd6744f4ef7214d2::decimal::from(arg0.penalty_denominator)))
        };
    ...
    entry fun set_end_time_s<T0: drop, T1, T2>(arg0: &mut VestingManager<T0, T1, T2>, arg1: &AdminCap<T0, T1, T2>, arg2: u64) {
        assert!(arg1.manager == 0x2::object::id<VestingManager<T0, T1, T2>>(arg0), 3);
        assert_version_and_upgrade<T0, T1, T2>(arg0);
        arg0.end_time_s = arg2;
    }

    entry fun set_params<T0: drop, T1, T2>(arg0: &mut VestingManager<T0, T1, T2>, arg1: &AdminCap<T0, T1, T2>, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::coin::CoinMetadata<T0>, arg6: 0x1::string::String) {
        assert!(arg1.manager == 0x2::object::id<VestingManager<T0, T1, T2>>(arg0), 3);
        assert_version_and_upgrade<T0, T1, T2>(arg0);
        arg0.start_penalty_numerator = arg2;
        arg0.end_penalty_numerator = arg3;
        arg0.penalty_denominator = arg4;
        0x2::coin::update_description<T0>(&arg0.mtoken_treasury_cap, arg5, arg6);
    }

    entry fun set_start_time_s<T0: drop, T1, T2>(arg0: &mut VestingManager<T0, T1, T2>, arg1: &AdminCap<T0, T1, T2>, arg2: u64) {
        assert!(arg1.manager == 0x2::object::id<VestingManager<T0, T1, T2>>(arg0), 3);
        assert_version_and_upgrade<T0, T1, T2>(arg0);
        arg0.start_time_s = arg2;
    }
