module 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::pool {
    ...
    public(friend) fun new<T0>(arg0: CreatePoolCap<T0>, arg1: &mut 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::pool_registry::PoolRegistry, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<0x1::ascii::String>, arg8: vector<u64>, arg9: u64, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: 0x1::option::Option<vector<u8>>, arg15: bool, arg16: 0x1::option::Option<u8>, arg17: &mut 0x2::tx_context::TxContext) : Pool<T0> {
        ...
        0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::pool_registry::register_pool<T0>(arg1, &v9, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
        let v10 = 9;
        let (v11, v12, v13) = if (arg15) {
            let (v14, v15) = 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::decimals::decimal_scalars_from_decimals(0x1::option::borrow<vector<u8>>(&arg14));
            let v11 = v15;
            let v13 = v14;
            ...
            let (v12, v13) = if (0x1::option::is_some<vector<u8>>(&arg14)) {
                ...
                ((0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::pow_down(0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::fixed::convert_int_to_fixed(10), v17) as u128) / 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::numerical::int_exp_128(10, (v13 as u64)), v13)
            } else {
                let v19 = 0;
                while (v19 < v0) {
                    0x1::vector::push_back<u128>(&mut v11, (1000000000000000000 as u128));
        ...
        let v21 = if (v20 >= v13) {
            v12 / 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::numerical::int_exp_128(10, ((v20 - v13) as u64))
        } else {
            v12 * 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::numerical::int_exp_128(10, ((v13 - v20) as u64))
        };
        v13 = v20;
        Pool<T0>{
            id                  : v9,
            ...
            type_names          : arg7,
            normalized_balances : 0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::vector::empty_vector_128(v0),
            weights             : arg8,
            flatness            : arg9,
            fees_swap_in        : arg10,
            fees_swap_out       : arg11,
    ...
    fun assert_pool_creation_parameters_are_valid<T0>(arg0: u64, arg1: u64, arg2: &vector<u64>, arg3: &vector<u64>, arg4: &vector<u64>, arg5: &vector<u64>, arg6: &vector<u64>, arg7: &0x1::option::Option<vector<u8>>, arg8: bool, arg9: &0x1::option::Option<u8>, arg10: &CreatePoolCap<T0>) {
        ...
        let v13 = if (arg8) {
            ...
            0x78548ffea3a06853d89dded8c6cdbed1fafc69d89469c4693c2373d6d600f666::decimals::mean(&v9)
        } else {
            9
        };
        let v14 = v13;
    ...
    fun borrow_balance<T0, T1>(arg0: &Pool<T0>) : &0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow<0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&arg0.id, 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::type_to_balance_key<T1>())
    }

    fun borrow_mut_balance<T0, T1>(arg0: &mut Pool<T0>) : &mut 0x2::balance::Balance<T1> {
        0x2::dynamic_field::borrow_mut<0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg0.id, 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::type_to_balance_key<T1>())
    }
    ...
    public fun contains_type<T0, T1>(arg0: &Pool<T0>) : bool {
        let v0 = 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::type_to_string<T1>();
    ...
    public(friend) fun initialize_liquidity<T0, T1>(arg0: &mut 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::pool_registry::PoolRegistry, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<T1>) {
        *0x1::vector::borrow_mut<u128>(&mut arg1.normalized_balances, type_to_index<T0, T1>(arg1)) = normalize_amount<T0, T1>(arg1, 0x2::coin::value<T1>(&arg2));
        0x2::dynamic_field::add<0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::BalanceKey<T1>, 0x2::balance::Balance<T1>>(&mut arg1.id, 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::type_to_balance_key<T1>(), 0x2::coin::into_balance<T1>(arg2));
        0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::pool_registry::add_coin<T1>(arg0);
    }
    ...
    public fun lp_type<T0>(arg0: &Pool<T0>) : 0x1::ascii::String {
        0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::type_to_string<T0>()
    }
    ...
    public(friend) fun type_to_index<T0, T1>(arg0: &Pool<T0>) : u64 {
        type_name_to_index<T0>(arg0, 0x2328394b747206cf1111a020ae0eb6cf68fc33cb9ca435183d9c950c6c08a8ab::keys::type_to_string<T1>())
    }
