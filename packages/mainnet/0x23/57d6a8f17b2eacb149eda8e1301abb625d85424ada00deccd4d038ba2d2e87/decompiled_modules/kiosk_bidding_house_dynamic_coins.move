module 0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::kiosk_bidding_house_dynamic_coins {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v21, 0x2::balance::value<T1>(&v21) * (v11 as u64) / 10000), arg5), 0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::get_owner(arg1));
    ...
    public fun buy_nft_with_request<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, 0x2::coin::value<T1>(&arg5) * (v5 as u64) / 10000, arg6), 0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::get_owner(arg1));
        (v29, v30)
    }
    ...
    public entry fun create_and_share_kiosk_bidding_house_store(arg0: &0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_kiosk_bidding_house(arg0: &0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Bidding_Store {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::is_admin(arg0, v0), 33);
        let v1 = 0x2::object::new(arg1);
        let v2 = Kiosk_Bidding_Store{
            id            : v1,
            auction_house : 0x2::object::id<0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::AuctionHouse>(arg0),
    ...
    public entry fun emergency_reset_accepted_bid<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 33);
    ...
    public entry fun emergency_reset_listing<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 33);
