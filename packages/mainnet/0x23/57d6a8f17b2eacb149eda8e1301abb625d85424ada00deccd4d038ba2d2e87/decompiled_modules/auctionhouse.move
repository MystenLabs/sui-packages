module 0x2357d6a8f17b2eacb149eda8e1301abb625d85424ada00deccd4d038ba2d2e87::auctionhouse {
    ...
    fun init(arg0: AUCTIONHOUSE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v11, v5.app_link);
    ...
    public entry fun update_display(arg0: &mut AuctionHouse, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 1);
        create_and_update_display(arg0, 0x1::string::utf8(b"https://suiverse.space/assets/bg/portal.png"), 0x1::string::utf8(b"https://suiverse.space"), arg1, arg2);
    }
