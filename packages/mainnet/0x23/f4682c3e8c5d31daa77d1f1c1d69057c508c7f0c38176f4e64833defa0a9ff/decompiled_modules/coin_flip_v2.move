module 0x23f4682c3e8c5d31daa77d1f1c1d69057c508c7f0c38176f4e64833defa0a9ff::coin_flip_v2 {
    ...
    public entry fun create_house<T0>(arg0: vector<u8>, arg1: u128, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 <= 10000, 5);
        let v0 = House<T0>{
            ...
            pool             : 0x2::coin::into_balance<T0>(arg4),
            treasury         : 0x2::balance::zero<T0>(),
        };
        0x2::transfer::share_object<House<T0>>(v0);
    }

    public entry fun create_house_no_type(arg0: vector<u8>, arg1: u128, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 <= 10000, 5);
        let v0 = House<0x2::sui::SUI>{
            id               : 0x2::object::new(arg5),
            pub_key          : arg0,
            fee_rate         : arg1,
            min_stake_amount : arg2,
        ...
        0x2::transfer::share_object<House<0x2::sui::SUI>>(v0);
    }
    ...
    public entry fun update_fee_rate<T0>(arg0: &mut House<T0>, arg1: u128) {
        assert!(arg1 <= 10000, 5);
        arg0.fee_rate = arg1;
    }
