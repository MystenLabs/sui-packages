module 0x2308af7295c74fe781d545b4c73079b02a954ea5f4deb2465c1f00926460c814::gift4969 {
    struct GIFT4969 has drop {
        dummy_field: bool,
    }

    struct TICKET_4969 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4969(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4969>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4969>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4969, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4969>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4969>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4969>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4969>>(v5, 0x2::tx_context::sender(arg1));
    }
