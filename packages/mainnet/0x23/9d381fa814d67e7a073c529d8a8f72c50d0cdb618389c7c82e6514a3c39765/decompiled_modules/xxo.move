module 0x239d381fa814d67e7a073c529d8a8f72c50d0cdb618389c7c82e6514a3c39765::xxo {
    struct XXO has drop {
        dummy_field: bool,
    }

    fun init(arg0: XXO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/LAIUfqwL61WV_Mui-T3M8Wa8He2N17RtjJym2YeVe00";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/LAIUfqwL61WV_Mui-T3M8Wa8He2N17RtjJym2YeVe00"))
        };
