module 0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::surf {
    ...
    public fun mint(arg0: &mut MintConfig, arg1: &mut 0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::recorder::Recorder, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : SurfNFT {
        assert!(arg0.version == 1, 0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::errors::wrong_version());
        let v0 = if (arg0.live) {
            if (arg0.season >= 2) {
                arg0.mint_cost > 0
        ...
        assert!(v0, 0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::errors::not_configured());
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = current_week(arg0, arg2);
        assert!(0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::recorder::points_of(arg1, v1) >= arg0.threshold, 0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::errors::below_threshold());
        if (v2 >= 2 && arg0.weekly_cap > 0) {
            assert!(weekly_minted(arg0, v1, v2) < arg0.weekly_cap, 0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::errors::weekly_cap_reached());
        };
        0x2351c77ad7dae69f6f43a6abace91894f7e71a2147f646c4766b06e453df27f6::recorder::add_spent(arg1, v1, arg0.mint_cost);
