module 0x23a5457077b9ad42facff1b0169c9ec1757fb42f9758347ab2a1527d9a05c5ed::atasa {
    ...
    fun init(arg0: ATASA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<ATASA>(arg0, 6, 0x1::string::utf8(b"ATS"), 0x1::string::utf8(b"ATASA"), 0x1::string::utf8(b"energy coin by sui hub"), 0x1::string::utf8(b"https://i.ibb.co/M5GPgNRH/Screenshot-2025-10-21-130949.png"), arg1);
        let v2 = v1;
        let v3 = v0;
