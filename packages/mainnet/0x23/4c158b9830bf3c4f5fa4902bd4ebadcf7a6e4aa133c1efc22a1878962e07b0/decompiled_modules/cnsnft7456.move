module 0x234c158b9830bf3c4f5fa4902bd4ebadcf7a6e4aa133c1efc22a1878962e07b0::cnsnft7456 {
    struct CNSNFT7456 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7456, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7456>(arg0, arg1);
