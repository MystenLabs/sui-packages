module 0x2353e5ab72428c006cb3d55bd597b25ce7cf8a059c1b5d721d54c0e15fff67ed::app_cap_display {
    struct AppCapDisplay has copy, drop, store {
        link_opacity: u8,
        uri_encoded_text: 0x1::string::String,
    }

    public(friend) fun new(arg0: 0x2353e5ab72428c006cb3d55bd597b25ce7cf8a059c1b5d721d54c0e15fff67ed::name::Name, arg1: bool) : AppCapDisplay {
        let v0 = if (arg1) {
            100
        } else {
            0
    ...
    public(friend) fun uri_encode_text(arg0: 0x2353e5ab72428c006cb3d55bd597b25ce7cf8a059c1b5d721d54c0e15fff67ed::name::Name) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let (v1, v2) = render_batch(0x2353e5ab72428c006cb3d55bd597b25ce7cf8a059c1b5d721d54c0e15fff67ed::name::app_to_string(&arg0), 16, 30, 23, 23, 0x1::string::utf8(b"BDBFEC"));
        0x1::string::append(&mut v0, v1);
        let (v3, _) = render_batch(0x2353e5ab72428c006cb3d55bd597b25ce7cf8a059c1b5d721d54c0e15fff67ed::name::org_to_string(&arg0), 32, v2, 10, 12, 0x1::string::utf8(b"E0E1EC"));
