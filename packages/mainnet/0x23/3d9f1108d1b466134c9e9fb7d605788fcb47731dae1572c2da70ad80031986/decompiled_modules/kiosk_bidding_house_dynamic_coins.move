module 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::kiosk_bidding_house_dynamic_coins {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v25, v26), arg6), 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::get_owner(arg1));
    ...
    public fun buyout_nft<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v35, arg8), 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::get_owner(arg1));
    ...
    public entry fun create_and_share_kiosk_bidding_store(arg0: &0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Kiosk_Bidding_Store>(create_kiosk_bidding_store(arg0, arg1));
    }

    public fun create_kiosk_bidding_store(arg0: &0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Bidding_Store {
