module 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::kiosk_classic_bidding_auctionhouse {
    ...
    public fun complete_auction<T0: store + key, T1>(arg0: &mut SimpleAuctionStore, arg1: &mut 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v29, v30), arg4), 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::get_owner(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v29, arg4), v2);
    }

    public entry fun complete_auction_entry<T0: store + key, T1>(arg0: &mut SimpleAuctionStore, arg1: &mut 0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        complete_auction<T0, T1>(arg0, arg1, arg2, arg3, arg4);
    }

    public entry fun create_and_share_simple_auction_store(arg0: &0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_simple_auction_store(arg0: &0x233d9f1108d1b466134c9e9fb7d605788fcb47731dae1572c2da70ad80031986::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : SimpleAuctionStore {
