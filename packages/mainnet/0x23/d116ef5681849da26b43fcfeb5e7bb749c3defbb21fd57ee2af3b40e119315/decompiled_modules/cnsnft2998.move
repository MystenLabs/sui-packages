module 0x23d116ef5681849da26b43fcfeb5e7bb749c3defbb21fd57ee2af3b40e119315::cnsnft2998 {
    struct CNSNFT2998 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2998, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2998>(arg0, arg1);
