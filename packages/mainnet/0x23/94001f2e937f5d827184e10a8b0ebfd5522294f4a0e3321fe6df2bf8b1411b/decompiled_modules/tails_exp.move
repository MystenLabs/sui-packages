module 0xc4808fe7296f41f30c3d226966d6303a84ad4c39ffa9301ca08fe5ab09a70a8d::tails_exp {
    ...
    public(friend) entry fun draw(arg0: &mut Registry, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(&v3) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(v3, v2);
        } else {
            0x2::coin::destroy_zero<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(v3);
        };
    }

    fun draw_with_bls_sig(arg0: &mut Registry, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP> {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        let (_, v3) = 0x2::vec_map::remove<address, Game>(&mut v1.opened_games, &arg2);
        ...
        let v23 = 0xc4808fe7296f41f30c3d226966d6303a84ad4c39ffa9301ca08fe5ab09a70a8d::utils::multiplier(9);
        ...
        let v32 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x2::coin::TreasuryCap<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&mut arg0.id, b"exp_treasury_cap");
        mint_exp_token(v32, v30, arg5)
    }

    fun draw_with_random(arg0: &mut Registry, arg1: u64, arg2: address, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP> {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        let (_, v3) = 0x2::vec_map::remove<address, Game>(&mut v1.opened_games, &arg2);
        ...
        let v24 = 0xc4808fe7296f41f30c3d226966d6303a84ad4c39ffa9301ca08fe5ab09a70a8d::utils::multiplier(9);
        let v25 = generate_answer(10000, &v5);
        ...
        let v33 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x2::coin::TreasuryCap<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&mut arg0.id, b"exp_treasury_cap");
        mint_exp_token(v33, v31, arg4)
    }

    public(friend) fun friend_mint_exp_token(arg0: &mut Registry, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP> {
        version_check(arg0);
    ...
    entry fun hotfix_treasury_cap(arg0: &mut Registry, arg1: &0x2::tx_context::TxContext) {
        version_check(arg0);
        registry_whitelist_check(arg0, arg1);
        0x2::dynamic_object_field::add<vector<u8>, 0x2::coin::TreasuryCap<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&mut arg0.id, b"exp_treasury_cap", 0x2::dynamic_object_field::remove<vector<u8>, 0x2::coin::TreasuryCap<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&mut arg0.id, b"typus_manager_cap"));
    }
    ...
    public(friend) entry fun merge_exp_tokens(arg0: vector<0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&arg0)) {
            v0 = v0 + 0x2::coin::value<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(0x1::vector::borrow<0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&arg0, v1));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(0x2::coin::from_balance<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(0xc4808fe7296f41f30c3d226966d6303a84ad4c39ffa9301ca08fe5ab09a70a8d::utils::extract_balance<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(arg0, v0, arg1), arg1), 0x2::tx_context::sender(arg1));
    }

    fun mint_exp_token(arg0: &mut 0x2::coin::TreasuryCap<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP> {
        assert!(arg1 <= 100000000 - 0x2::coin::total_supply<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(arg0), 16);
        0x2::coin::mint<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(arg0, arg1, arg2)
    }
    ...
    public(friend) entry fun new_game<T0>(arg0: &mut Registry, arg1: u64, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&v1.id, 0x1::type_name::get<T0>())) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::type_name::get<T0>()), 0xc4808fe7296f41f30c3d226966d6303a84ad4c39ffa9301ca08fe5ab09a70a8d::utils::extract_balance<T0>(arg2, arg3, arg4));
        } else {
            0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::type_name::get<T0>(), 0xc4808fe7296f41f30c3d226966d6303a84ad4c39ffa9301ca08fe5ab09a70a8d::utils::extract_balance<T0>(arg2, arg3, arg4));
        };
    ...
    entry fun new_registry(arg0: 0x2::coin::TreasuryCap<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
        ...
        0x2::dynamic_object_field::add<vector<u8>, 0x2::coin::TreasuryCap<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&mut v0.id, b"exp_treasury_cap", arg0);
    ...
    entry fun play_guess_with_random(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: bool, arg4: u64, arg5: bool, arg6: &0x2::random::Random, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(&v9) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(v9, v6);
        } else {
            0x2::coin::destroy_zero<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>(v9);
        };
    }
