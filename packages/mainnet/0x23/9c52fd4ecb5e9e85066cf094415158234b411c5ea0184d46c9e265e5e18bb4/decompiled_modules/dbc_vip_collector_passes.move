module 0x239c52fd4ecb5e9e85066cf094415158234b411c5ea0184d46c9e265e5e18bb4::dbc_vip_collector_passes {
    struct DBC_VIP_COLLECTOR_PASSES has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"f10c2fde-b1b9-4c60-acee-b347c71a1d92"),
        };
        0x2::event::emit<AddNftMetadataEvent>(v0);
    }

    fun init(arg0: DBC_VIP_COLLECTOR_PASSES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DBC_VIP_COLLECTOR_PASSES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"DBC VIP Collector Passes"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The VIP pass enables you to secure a physical art piece on commission direct from the artist. "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://Qmd3t4gDcn1DRwn3H3CXD62XyDnW7cpDw6L616y1gQTKcf"));
