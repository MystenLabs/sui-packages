module 0x237245c073c794d2353af0a5654e3dba56f90bea934238951597d9f470114d05::gift4719 {
    struct GIFT4719 has drop {
        dummy_field: bool,
    }

    struct TICKET_4719 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4719(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4719>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4719>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4719, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4719>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4719>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4719>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4719>>(v5, 0x2::tx_context::sender(arg1));
    }
