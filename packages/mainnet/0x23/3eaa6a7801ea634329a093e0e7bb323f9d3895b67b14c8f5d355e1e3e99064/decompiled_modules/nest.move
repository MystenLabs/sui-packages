module 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::nest {
    ...
    struct StakedDuck has store {
        duck: 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::DuckNFT,
        stake_time: u64,
    ...
    public fun get_duck_harvest_stats(arg0: &Nest) : (u8, u8, u8) {
        ...
        let v0 = 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::get_rarity_level(&0x1::option::borrow<StakedDuck>(&arg0.staked_duck).duck);
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::NestMintCap, arg3: &mut 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::get_rarity_level(&v2.duck);
        let v6 = 0x2::object::id<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::DuckNFT>(&v2.duck);
        ...
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>>(0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::mint_for_nest(arg2, arg3, v11, arg6), v0);
        };
    ...
    public entry fun stake_duck(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut HarvestStats, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::kiosk::take<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::DuckNFT>(arg0, arg1, arg2);
        ...
        let v4 = DuckStaked{
            ...
            duck_id    : 0x2::object::id<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::DuckNFT>(&v1),
            owner      : v0,
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::NestMintCap, arg3: &mut 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v3 > 0) {
            ...
            if (v11 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>>(0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::mint_for_nest(arg2, arg3, v11, arg8), v0);
            };
        ...
        let v20 = DuckUnstaked{
            nest_id    : v1,
            duck_id    : 0x2::object::id<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::DuckNFT>(&v19.duck),
            owner      : v0,
        ...
        0x2::kiosk::place<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft::DuckNFT>(arg5, arg6, v21);
    }
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>, arg2: &mut 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::burn(arg2, 0x2::coin::split<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
