module 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::duck_nft {
    ...
    public entry fun admin_update_royalty(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<DuckNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<DuckNFT>, arg3: address, arg4: u16, arg5: u64) {
        0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::transfer_rule::update_royalty<DuckNFT>(arg1, arg2, arg4, arg5, arg3);
    }
    ...
    fun create_duck_nft(arg0: u8, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : DuckNFT {
        let (v0, v1) = get_duck_stats(arg0);
        let v2 = 0x1::string::utf8(b"#");
        0x1::string::append(&mut v2, u64_to_string(arg2));
        DuckNFT{
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::burn(arg8, 0x2::coin::split<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>>(0x2::coin::split<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>>(0x2::coin::split<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::shttoken::SHTTOKEN>(arg12);
        };
        ...
        while (v12 < arg14) {
            ...
            0x2::kiosk::place<DuckNFT>(arg9, arg10, v14);
            v12 = v12 + 1;
        };
    ...
    public entry fun hatch_genesis_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &mut GlobalStats, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: u64, arg11: &0x2::random::Random, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        while (v5 < arg10) {
            ...
            0x2::kiosk::place<DuckNFT>(arg6, arg7, v7);
            v5 = v5 + 1;
        };
    ...
    public entry fun place_duck_in_kiosk(arg0: DuckNFT, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap) {
        0x2::kiosk::place<DuckNFT>(arg1, arg2, arg0);
    }
    ...
    public entry fun setup_royalty_policy(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<DuckNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<DuckNFT>, arg3: address, arg4: u16, arg5: u64) {
        0x233eaa6a7801ea634329a093e0e7bb323f9d3895b67b14c8f5d355e1e3e99064::transfer_rule::add<DuckNFT>(arg1, arg2, arg4, arg5, arg3);
    }
    ...
    public entry fun team_mint(arg0: &mut TeamMintCap, arg1: &mut PackSupply, arg2: &mut GlobalStats, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 100) {
            ...
            0x2::kiosk::place<DuckNFT>(arg3, arg4, v3);
            v2 = v2 + 1;
        };
        let v4 = 0;
        while (v4 < 100) {
            update_rarity_stats(arg2, 2);
            0x2::kiosk::place<DuckNFT>(arg3, arg4, create_duck_nft(2, 0, arg1.total_nfts_minted_globally + 100 + v4 + 1, arg6, arg7));
            v4 = v4 + 1;
        };
        arg0.minted = true;
