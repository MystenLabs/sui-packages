module 0xe1c78d168958c11c51ca09af19d091d8c4c787e6bd653fcb10ea27eeff2d6a21::supply_bag {
    ...
    public fun add_supply<T0>(arg0: 0x2::balance::Supply<T0>, arg1: &mut SupplyBag) {
    ...
    public(friend) fun transfer_bag(arg0: SupplyBag, arg1: address) {
        let SupplyBag {
            id  : v0,
            bag : v1,
        } = arg0;
        0x2::object::delete(v0);
        0x2::transfer::public_transfer<0x2::bag::Bag>(v1, arg1);
    }
