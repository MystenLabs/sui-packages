module 0x23f9b3ec66466e8949b2b53287f96d87be338c06cce73074ff1ff6ae77f39f94::gift6300 {
    struct GIFT6300 has drop {
        dummy_field: bool,
    }

    struct TICKET_6300 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6300(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6300>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6300>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6300, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6300>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6300>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6300>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6300>>(v5, 0x2::tx_context::sender(arg1));
    }
