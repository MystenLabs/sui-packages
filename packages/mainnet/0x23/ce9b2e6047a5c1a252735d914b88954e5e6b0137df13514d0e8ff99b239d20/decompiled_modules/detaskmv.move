module 0xad2d116d9aa4db57484007f5e20242ff206530b8d763693a276ae36b397c4786::detaskmv {
    ...
    struct Detask2 has store, key {
        ...
        creator: address,
        taker_addresses: vector<address>,
        taker_list: 0x2::table::Table<address, ListingLog2>,
        ttype: u64,
        baglist: 0x2::bag::Bag,
        mslist: vector<0x2::object::ID>,
        st_timestamp_ms: u64,
    ...
    struct ListingLog2 has drop, store {
        taskid: 0x2::object::ID,
        user: address,
        tst: u64,
        logs: 0x1::string::String,
    ...
    public entry fun registerFromItem<T0: store + key>(arg0: T0, arg1: &DetaskAdminCap, arg2: &mut BagCountCap, arg3: &mut Detask, arg4: &mut 0x2::tx_context::TxContext) {
        abort 1234
    }
