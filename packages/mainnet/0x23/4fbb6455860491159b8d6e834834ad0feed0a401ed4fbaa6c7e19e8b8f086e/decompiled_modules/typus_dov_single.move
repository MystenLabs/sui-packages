module 0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::typus_dov_single {
    ...
    public(friend) fun delivery_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, u64) {
        let v0 = &mut arg0.portfolio_vault_registry;
        let v1 = get_mut_portfolio_vault(v0, arg1);
        let v2 = &mut arg0.deposit_vault_registry;
        let v3 = get_mut_deposit_vault(v2, arg1);
        ...
        let v20 = if (v1.config.deposit_incentive_bp > 0 && 0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.id, 0x1::type_name::get<T1>())) {
            let v21 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg0.id, 0x1::type_name::get<T1>());
            let v22 = 0x2::balance::value<T1>(v21);
            let v23 = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_u64_padding_value(&v1.config.u64_padding, 0);
            let v24 = v1.info.option_type % 2 == 0 && v1.info.option_type != 6;
            let v25 = if (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::match_types<T0, T1>()) {
                ((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3)) as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64)
            } else if (v24) {
                (((((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3)) as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64) as u128) * (v1.info.oracle_info.price as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.oracle_info.decimal) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            } else {
                (((((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_share_supply(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_share_supply(v3)) as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.oracle_info.decimal) as u128) / (v1.info.oracle_info.price as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            };
            let v26 = if (v25 > v22) {
                if (v22 > v23) {
                    0x2::balance::split<T1>(v21, v23)
                } else {
                    0x2::balance::withdraw_all<T1>(v21)
                }
            } else if (v25 > v23) {
                0x2::balance::split<T1>(v21, v23)
            } else {
                0x2::balance::split<T1>(v21, v25)
            };
            let v27 = v26;
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, v23 - 0x2::balance::value<T1>(&v27));
            v27
        } else {
            0x2::balance::zero<T1>()
        };
        let v28 = v20;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::delivery_b<T0, T1>(v3, v5, v10, v28, arg4);
        ...
        (v12, v13, v14, v15, v16, v17, 0x2::balance::value<T1>(&v28))
    }
    ...
    public(friend) fun emit_delivery_event(arg0: &Registry, arg1: u64, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &0x2::tx_context::TxContext) {
        let v0 = get_portfolio_vault(&arg0.portfolio_vault_registry, arg1);
        let v1 = DeliveryEvent{
            ...
            bidder_fee                : arg6,
            incentive_bid_value       : arg7,
            incentive_fee             : arg8,
            b_token_decimal           : v0.info.b_token_decimal,
            b_token                   : v0.info.bid_token,
            depositor_incentive_value : arg9,
            u64_padding               : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<DeliveryEvent>(v1);
    }
    ...
    public(friend) fun emit_redeem_event(arg0: &PortfolioVault, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let v0 = RedeemEvent{
    ...
    public(friend) fun update_strike_(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock) : (u64, u64, VaultConfig) {
        ...
        let v4 = v3.config.active_vault_config.strike_increment;
        let v5 = 0x1::vector::length<PayoffConfig>(&v3.config.active_vault_config.payoff_configs);
        while (v5 > 0) {
            let v6 = 0x1::vector::borrow_mut<PayoffConfig>(&mut v3.config.active_vault_config.payoff_configs, v5 - 1);
            let v7 = calculate_strike(v0, v6.strike_bp, v4);
            let v8 = if (v3.info.option_type % 2 == 1 && v7 > v4) {
                v7 - v4
            } else {
                v7
            };
            0x1::option::swap<u64>(&mut v6.strike, v8);
            v5 = v5 - 1;
        };
        (v0, v1, v3.config.active_vault_config)
    }
