module 0x2387e38a806a43d6ff665c7c4c2ae3e1ed041f239ae0baef4c008e2f5d5a1083::reward9414 {
    struct REWARD9414 has drop {
        dummy_field: bool,
    }

    struct TICKET_9414 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9414(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9414>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9414>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9414, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9414>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9414>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9414>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9414>>(v5, 0x2::tx_context::sender(arg1));
    }
