module 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_token {
    ...
    public(friend) fun split(arg0: &mut VeToken, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : VeToken {
        assert!(arg1 > 0 && arg1 < 0x2::balance::value<0x35169bc93e1fddfcf3a82a9eae726d349689ed59e4b065369af8789fe59f8608::mmt::MMT>(&arg0.balance), 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_invalid_split_amount());
        VeToken{
    ...
    public fun calculate_ve_vote_power(arg0: &VeToken, arg1: &0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::VeMMT, arg2: u64, arg3: u64) : u64 {
        if (unbond_at(arg0) == max_bond_unbond_at()) {
            0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::vote_power::vote_power_for_max_bond(arg2)
        } else {
            0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::vote_power::vote_power_for_range(0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::vp_config(arg1), 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::ep_config(arg1), arg2, arg3, unbond_at(arg0))
        }
    }
    ...
    public(friend) fun create(arg0: &0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::VeMMT, arg1: 0x2::balance::Balance<0x35169bc93e1fddfcf3a82a9eae726d349689ed59e4b065369af8789fe59f8608::mmt::MMT>, arg2: u64, arg3: u8, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : VeToken {
        assert!(arg3 == 1 || arg3 == 2, 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_invalid_bond_mode());
        if (arg3 == 2) {
            assert!(arg2 == 18446744073709551615, 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_invalid_unbond_at());
        };
        if (arg3 == 1) {
            let v0 = if (arg2 > 0x2::clock::timestamp_ms(arg4)) {
                if (arg2 <= get_normal_max_unbond_at(arg0, arg4)) {
                    0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::epoch::is_epoch_start(0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::ep_config(arg0), arg2)
                } else {
                    false
                }
            } else {
            ...
            assert!(v0, 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_invalid_unbond_at());
        };
        VeToken{
    ...
    public(friend) fun extend(arg0: &mut VeToken, arg1: &0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::VeMMT, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    fun get_normal_max_unbond_at(arg0: &0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::VeMMT, arg1: &0x2::clock::Clock) : u64 {
        let (v0, v1) = 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::config_fields(arg0);
        0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::epoch::epoch_start(v1, 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::epoch::epoch_id(v1, 0x2::clock::timestamp_ms(arg1)) + 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::vote_power::max_bond_epochs(v0))
    }
    ...
    public(friend) fun merge(arg0: &mut VeToken, arg1: VeToken) {
        assert!(check_merge_allowed(arg0, &arg1), 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_invalid_merge());
        let VeToken {
            id        : v0,
            bond_mode : _,
            unbond_at : _,
    ...
    public(friend) fun set_max_bond(arg0: &mut VeToken) {
        assert!(bond_mode(arg0) == 1, 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_invalid_bond_mode());
        arg0.bond_mode = 2;
        arg0.unbond_at = 18446744073709551615;
    }

    public(friend) fun set_normal(arg0: &mut VeToken, arg1: &0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::ve_mmt::VeMMT, arg2: &0x2::clock::Clock) {
        assert!(bond_mode(arg0) == 2, 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_invalid_bond_mode());
        arg0.bond_mode = 1;
    ...
    public(friend) fun unbond(arg0: VeToken, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<0x35169bc93e1fddfcf3a82a9eae726d349689ed59e4b065369af8789fe59f8608::mmt::MMT> {
        assert!(0x2::clock::timestamp_ms(arg1) >= unbond_at(&arg0), 0x23ecc2b1c55a7e1c1c1e5091afee8ffdbbfc7b044d059d536804ad050c0c39f5::error::e_not_unbond_yet());
        let VeToken {
            id        : v0,
            bond_mode : _,
            unbond_at : _,
