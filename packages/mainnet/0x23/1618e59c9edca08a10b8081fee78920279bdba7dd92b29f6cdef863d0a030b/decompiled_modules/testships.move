module 0x8ab8ce7e53354948f48354fc488e9a965be68034c8e817c253250d97d85dfffb::testships {
    ...
    public fun upgrade(arg0: &UpgradeManager, arg1: vector<ShipNFT>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &Payout, arg4: &0x2::transfer_policy::TransferPolicy<ShipNFT>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut Counter, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Type"), clone_string(&v28.ship_type));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Rarity"), clone_string(&v28.rarity));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Rank"), u64_to_string((v28.ship_rank as u64)));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Speed"), u64_to_string(v28.speed));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Attack"), u64_to_string(v28.attack));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Defence"), u64_to_string(v28.defence));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Health"), u64_to_string(v28.health));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Upgrades"), clone_string(&v28.upgrades));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v28.attributes, 0x1::string::utf8(b"Specialisation"), clone_string(&v28.specialisation));
