module 0x23b5409bd1d814a7213594af55fc8ac7f0a43cd8f0b0c4811d4995bff9bb7d4d::dbkq {
    ...
    public fun gps<T0, T1, T2, T3, T4>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T4>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T1, T4>, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T4>, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T3, T4>, arg4: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager) {
        let (v0, v1, v2) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T0, T4>(arg0, arg4);
        let (v3, v4, v5) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T1, T4>(arg1, arg4);
        let (v6, v7, v8) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T2, T4>(arg2, arg4);
        let (v9, v10, v11) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::locked_balance<T3, T4>(arg3, arg4);
        let v12 = ACP{
            a : 0x1::string::utf8(b"SUI"),
            l : v0,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T0>(arg4),
        };
        0x2::event::emit<ACP>(v12);
        let v13 = ACP{
            a : 0x1::string::utf8(b"USDC"),
            l : v1 + v4 + v7 + v10,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T4>(arg4),
        };
        0x2::event::emit<ACP>(v13);
        let v14 = ACP{
            a : 0x1::string::utf8(b"DEEP"),
            l : v2 + v3 + v5 + v8 + v11,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T1>(arg4),
        };
        0x2::event::emit<ACP>(v14);
        let v15 = ACP{
            a : 0x1::string::utf8(b"WAL"),
            l : v6,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T2>(arg4),
        };
        0x2::event::emit<ACP>(v15);
        let v16 = ACP{
            a : 0x1::string::utf8(b"ETH"),
            l : v9,
            f : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T3>(arg4),
        };
        0x2::event::emit<ACP>(v16);
    }
