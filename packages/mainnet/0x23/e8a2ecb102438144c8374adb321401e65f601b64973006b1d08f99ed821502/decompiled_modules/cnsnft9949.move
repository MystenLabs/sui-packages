module 0x23e8a2ecb102438144c8374adb321401e65f601b64973006b1d08f99ed821502::cnsnft9949 {
    struct CNSNFT9949 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9949, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9949>(arg0, arg1);
