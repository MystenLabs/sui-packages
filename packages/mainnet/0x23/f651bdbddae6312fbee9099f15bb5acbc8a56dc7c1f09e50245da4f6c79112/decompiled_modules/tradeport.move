module 0xf78977221c9420f9a8ecf39b6bc28f7a576f92179bc29ecc34edca80ac7d9c55::tradeport {
    ...
    public fun mint_into_kiosk_<T0: drop + store>(arg0: &mut NftCap<T0>, arg1: &0x2::transfer_policy::TransferPolicy<Nft<T0>>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        mint_into_kiosk<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0x1::option::none<T0>(), 0x1::option::none<address>(), 0x1::vector::empty<vector<u8>>(), arg7, arg8)
    }
    ...
    public entry fun set_nft_properties<T0: drop + store>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: address, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>) {
        0x2::kiosk::borrow_mut<Nft<T0>>(arg0, arg1, 0x2::object::id_from_address(arg2)).properties = format_properties(arg3, arg4);
    }

    public entry fun set_token_properties<T0: drop + store>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &Nft<T0>, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>) {
        0x2::kiosk::borrow_mut<Nft<T0>>(arg0, arg1, 0x2::object::id<Nft<T0>>(arg2)).properties = format_properties(arg3, arg4);
    }
