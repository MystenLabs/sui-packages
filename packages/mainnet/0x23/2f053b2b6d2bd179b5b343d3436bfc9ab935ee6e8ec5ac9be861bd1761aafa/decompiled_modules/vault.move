module 0x23726b949bc1927a15ace88933989086ea581c888ccc4b74413f70e8ae091a4::vault {
    ...
    public entry fun deposit_with_sigs_credit_time<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x23726b949bc1927a15ace88933989086ea581c888ccc4b74413f70e8ae091a4::utils::verify_signature(&arg0.signers, arg0.threshold, v2, arg8, arg9);
        if (!arg5) {
    ...
    public entry fun move_token_to_withdraw_assets<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(check_operator(arg1, 0x2::tx_context::sender(arg4), 0x2::object::id<OperatorCap>(arg0)), 1);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T2>());
        let v1 = if (v0 == 0x1::type_name::into_string(0x1::type_name::get<T0>())) {
            assert!(0x1::option::is_some<0x2::coin::Coin<T0>>(&arg2.coin_store.coin), 2);
            let v2 = 0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg2.coin_store.coin);
            assert!(0x2::coin::value<T0>(v2) >= arg3, 2);
            arg2.available_liquidity = arg2.available_liquidity - (arg3 as u128);
            0x2::coin::split<T0>(v2, arg3, arg4)
        } else {
            assert!(0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0), 14);
            let v3 = 0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.harvest_assets, v0);
            ...
            if (0x2::coin::value<T0>(v3) == 0) {
                ...
                let (v4, v5) = 0x1::vector::index_of<0x1::ascii::String>(&arg2.harvest_asset_keys, &v0);
                if (v4) {
                    0x1::vector::swap_remove<0x1::ascii::String>(&mut arg2.harvest_asset_keys, v5);
                };
            };
            0x2::coin::split<T0>(v3, arg3, arg4)
        };
        if (0x2::bag::contains<0x1::ascii::String>(&arg2.withdraw_assets, v0)) {
            0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.withdraw_assets, v0), v1);
        } else {
            0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.withdraw_assets, v0, v1);
            0x1::vector::push_back<0x1::ascii::String>(&mut arg2.withdraw_asset_keys, v0);
        };
    ...
    public(friend) fun redeem_internal<T0, T1>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: u64, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x23726b949bc1927a15ace88933989086ea581c888ccc4b74413f70e8ae091a4::utils::verify_signature(&arg0.signers, arg0.threshold, v1, arg6, arg7);
    ...
    public(friend) fun redeem_token_internal<T0, T1, T2>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        assert!(arg0.version == 1, 5);
        assert!(arg1.enable, 4);
        ...
        0x23726b949bc1927a15ace88933989086ea581c888ccc4b74413f70e8ae091a4::utils::verify_signature(&arg0.signers, arg0.threshold, v1, arg7, arg8);
        assert!(0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, arg2), 7);
        ...
        while (v7 < 0x1::vector::length<PendingRedeem>(&v4)) {
            ...
            let (v9, _) = 0x1::vector::index_of<u64>(&arg3, &v8.withdraw_time);
            if (v8.withdraw_time <= v0 - arg1.lock_duration_ms && v9) {
        ...
        while (v15 < v11) {
            ...
            let (_, v18) = 0x1::vector::index_of<u64>(&arg3, &v16.withdraw_time);
            let v19 = 0x1::vector::borrow<u64>(&arg4, v18);
            let v20 = 0x1::vector::borrow<u64>(&arg5, v18);
            assert!(v16.amount >= *v19, 18);
            v12 = v12 + *v19;
            v13 = v13 + v16.amount;
            v14 = v14 + *v20;
            v15 = v15 + 1;
        ...
        let v23 = spend_withdraw_asset<T0, T1, T2>(arg1, v12, arg10);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v23, v24, arg10), arg1.fee_receiver);
    ...
    public entry fun redeem_with_sigs_token<T0, T1, T2>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(redeem_token_internal<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10), arg2);
    }
    ...
    public entry fun withdraw_with_sigs_credit_time<T0, T1, T2>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x23726b949bc1927a15ace88933989086ea581c888ccc4b74413f70e8ae091a4::utils::verify_signature(&arg0.signers, arg0.threshold, v3, arg8, arg9);
        if (!arg5) {
            add_profit_internal<T0, T1>(arg1, arg4, arg3, arg7, arg10);
        } else {
            credit_loss_internal<T0, T1>(arg1, arg4, arg7, arg10);
