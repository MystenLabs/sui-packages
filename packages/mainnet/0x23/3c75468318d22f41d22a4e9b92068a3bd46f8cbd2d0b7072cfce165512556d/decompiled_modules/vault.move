module 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::vault {
    ...
    public fun add_deposit_request<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_active();
        assert!(&arg0.strategy_state == &v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::strategy_not_active());
    ...
    public fun calculate_lp_token_share<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::coin::TreasuryCap<VAULT>, arg3: u64) : (u64, u64) {
        ...
        assert!(v4 > 0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::invalidLPToken());
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::lp_token_metadata();
    ...
    public fun mark_state_as_ready_for_withdrawal_processing<T0, T1>(arg0: &mut Vault<T0, T1>) {
        let v0 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.strategy_state == &v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::strategy_not_ready_for_withdrawal_processing());
        arg0.strategy_state = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_paused_and_ready_for_withdrawal_processing();
    }

    public fun mark_strategy_as_ready_to_start<T0, T1>(arg0: &mut Vault<T0, T1>) {
        let v0 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.strategy_state == &v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::strategy_not_ready_to_start());
        arg0.strategy_state = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_paused_and_ready_to_start();
    }
    ...
    fun mint_lp_token(arg0: &mut 0x2::coin::TreasuryCap<VAULT>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<VAULT> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::minimal_liquidity(), 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::liquidityInsufficientMinted());
        0x2::coin::mint<VAULT>(arg0, v1, arg5)
    }

    public fun new_vault<T0, T1>(arg0: &0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::app::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
        let v0 = Vault<T0, T1>{
            ...
            epoch_counter                          : 0,
            strategy_state                         : 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_paused_and_ready_for_deposit_processing(),
    ...
    public fun pause_strategy_and_mark_ready_for_deposit_processing<T0, T1>(arg0: &mut Vault<T0, T1>) {
        let v0 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_active();
        assert!(&arg0.strategy_state == &v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::strategy_not_active());
        arg0.strategy_state = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_paused_and_ready_for_deposit_processing();
    }
    ...
    public fun process_deposits<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1>(arg1), 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::invalid_vault_cap());
        let v0 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_active();
        assert!(&arg1.strategy_state == &v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::strategy_not_active());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg5)), 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::address_not_whitelisted());
        let v1 = &arg1.deepbook_account_cap;
        let (v2, v3, v4, v5) = get_deepbook_account_assets<T0, T1>(arg1, arg2);
        assert!(v3 == 0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::locked_base_asset_found());
        assert!(v5 == 0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::locked_quote_asset_found());
        ...
        while (v11 < 80 || 0x1::vector::length<address>(&arg1.deposit_requests_keys) > 0) {
            ...
            let v16 = if (v4 == 0) {
                0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::safe_math::safe_mul_div_u64(v15, 1, 2)
            } else {
                0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::safe_math::safe_mul_div_u64(v15, v2, 1000 * v4 + v2)
            };
            let v17 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::safe_math::safe_mul_div_u64(v16, v8, 1000000) * 1000;
    ...
    public fun process_withdrawals<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_active();
        assert!(&arg1.strategy_state == &v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::strategy_not_active());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg4)), 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::address_not_whitelisted());
        let v1 = &arg1.deepbook_account_cap;
        let v2 = 0;
    ...
    public fun revoke_trading_permission<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: address) {
        ...
        assert!(v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::address_not_whitelisted());
    ...
    public fun start_strategy<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::clock::Clock) {
        let v0 = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_paused_and_ready_to_start();
        assert!(&arg0.strategy_state == &v0, 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::error::strategy_not_ready_to_make_active());
        arg0.strategy_state = 0x233c75468318d22f41d22a4e9b92068a3bd46f8cbd2d0b7072cfce165512556d::constants::strategy_active();
