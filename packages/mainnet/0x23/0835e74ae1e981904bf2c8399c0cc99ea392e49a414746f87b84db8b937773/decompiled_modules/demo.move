module 0x230835e74ae1e981904bf2c8399c0cc99ea392e49a414746f87b84db8b937773::demo {
    ...
    fun get_token_type_string_any<T0>() : 0x1::string::String {
        ...
        if (0x1::vector::length<u8>(v1) > 0 && *0x1::vector::borrow<u8>(v1, 0) == 76) {
            let v3 = 0x1::vector::empty<u8>();
            0x1::vector::push_back<u8>(&mut v3, 48);
            0x1::vector::push_back<u8>(&mut v3, 120);
            let v4 = 1;
