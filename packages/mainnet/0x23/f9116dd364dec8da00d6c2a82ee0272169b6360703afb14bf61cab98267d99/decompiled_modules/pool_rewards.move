module 0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::pool_rewards {
    ...
    fun calculate_total_current_weight(arg0: &Pool, arg1: u64) : u64 {
        ...
        while (v2 < 0x1::vector::length<0x2::object::ID>(&arg0.staked_nft_ids)) {
            ...
            if (0x2::object_table::contains<0x2::object::ID, StakedNFT>(&arg0.staked_nfts, v3)) {
                v1 = v1 + v0 - 0x2::object_table::borrow<0x2::object::ID, StakedNFT>(&arg0.staked_nfts, v3).stake_time;
            };
            v2 = v2 + 1;
        };
        if (v1 == 0) {
    ...
    public fun claim_rewards_dynamic(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = if (v5 == 0 || v4 == 0) {
            ...
            v4 * v6 * 0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) / v5 * (v0.end_time - v0.start_time)
        };
        if (v7 > 0 && 0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) >= v7) {
            0x2::table::borrow_mut<address, UserStakeInfo>(&mut v0.user_stakes, v1).last_reward_claim = v2;
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v0.sui_reward_pool, v7), arg3), v1);
            let v8 = RewardsClaimed{
                pool_id    : arg1,
                user       : v1,
                sui_amount : v7,
            };
            0x2::event::emit<RewardsClaimed>(v8);
        };
    }
    ...
    public fun get_user_reward_details_dynamic(arg0: &PoolSystem, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64, u64, u64) {
        ...
        let v5 = if (v1 > v0.end_time) {
            v0.end_time - v0.start_time
        } else {
            v1 - v0.start_time
        };
        let v6 = if (v4 > 0 && v3 > 0) {
            v3 * v5 * 0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) / v4 * (v0.end_time - v0.start_time)
        } else {
            0
        };
        (v2.nft_count, v3, v4, v6, v1 - v2.stake_start_time, v2.last_reward_claim)
    }
