module 0x23f43e4ae6a50f04c15fc1035a72b5ec5b9cc60cf9c1a471da63cecf302a61d1::math {
    public(friend) fun bfgdvsd(arg0: u64, arg1: u64) : u64 {
        let v0 = (arg0 as u128) * (arg1 as u128);
        btm36c(v0);
        (v0 as u64)
    }

    public(friend) fun btm36c(arg0: u128) {
        assert!(arg0 <= 18446744073709551615, 1);
    }

    public(friend) fun dcdc46(arg0: u64, arg1: u64) : u64 {
        dcdsm46(arg0, 1000000000, arg1)
    }

    public(friend) fun dcdsm46(arg0: u64, arg1: u64, arg2: u64) : u64 {
        let v0 = (arg0 as u128) * (arg1 as u128);
    ...
    public(friend) fun dfdffdc(arg0: u64, arg1: u64) : u64 {
        smd64(arg0, 1000000000, arg1)
    }

    public(friend) fun dvcdcc(arg0: u64, arg1: u64, arg2: u64, arg3: bool, arg4: u64) : u64 {
        assert!(arg0 > 0, 2);
    ...
    public(friend) fun dvvdcv(arg0: u64, arg1: u64, arg2: u64) : u64 {
        if (arg0 == 0) {
            return 0
        };
    ...
    public(friend) fun jiijnn(arg0: u64, arg1: u64) : u64 {
        smd64(arg0, arg1, 1000000000)
    }

    public(friend) fun o7cs(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        assert!(arg0 > 0, 2);
        jiijnn(arg3, 1000000000 - arg4 + jiijnn(arg4, dcdc46(smd64(arg0, arg0, arg1), arg2)))
    }

    public(friend) fun smd64(arg0: u64, arg1: u64, arg2: u64) : u64 {
