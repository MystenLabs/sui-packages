module 0xf2f6684ed0a01dc9aa9c681d564e14052421bf7e3c9fddce36ed21e6c483a84a::cnsnft3751 {
    struct CNSNFT3751 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3751, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3751>(arg0, arg1);
