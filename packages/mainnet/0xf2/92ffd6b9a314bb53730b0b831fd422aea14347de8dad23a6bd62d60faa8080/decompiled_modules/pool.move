module 0xf292ffd6b9a314bb53730b0b831fd422aea14347de8dad23a6bd62d60faa8080::pool {
    ...
    public(friend) fun borrow_mut_claimed<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>) : &mut 0x2::table::Table<u64, address> {
        &mut arg0.claimed
    }
    ...
    public fun check_arrived_lock_time<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        assert!(arg0.time_info.start_time + arg0.time_info.lock_stake_duration <= 0x2::clock::timestamp_ms(arg1), 7);
    }

    public fun check_arrived_reward_time<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: &0x2::clock::Clock) {
    ...
    public fun check_round_could_claim_reward<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: u64) {
