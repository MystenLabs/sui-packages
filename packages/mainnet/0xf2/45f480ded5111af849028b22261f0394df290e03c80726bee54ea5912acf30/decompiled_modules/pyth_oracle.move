module 0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::pyth_oracle {
    ...
    public fun get_verified_price_1e18(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: u64) : u256 {
        let (v0, _) = get_verified_price_1e18_with_publish_time(arg0, arg1, arg2, arg3);
        v0
    }

    public fun get_verified_price_1e18_with_publish_time(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: u64) : (u256, u64) {
        let (v0, v1, v2) = get_verified_price_components(arg0, arg1, arg2, arg3);
        (scale_price_components_to_1e18(v0, v1), v2)
    }
