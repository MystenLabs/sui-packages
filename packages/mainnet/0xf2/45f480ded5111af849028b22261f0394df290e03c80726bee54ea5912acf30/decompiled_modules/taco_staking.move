module 0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco_staking {
    struct StakePool has key {
        id: 0x2::object::UID,
        total_staked: 0x2::balance::Balance<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>,
        staking_cap: u64,
        min_coeff: u256,
        max_coeff: u256,
        max_lock_ms: u64,
    ...
    fun create_pool_internal(arg0: u64, arg1: u256, arg2: u256, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (StakePool, StakeAdminCap) {
        ...
        let v0 = StakePool{
            ...
            total_staked         : 0x2::balance::zero<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(),
            staking_cap          : arg0,
            min_coeff            : arg1,
            max_coeff            : arg2,
            max_lock_ms          : arg3,
    ...
    public fun set_staking_config(arg0: &mut StakePool, arg1: &StakeAdminCap, arg2: u64, arg3: u256, arg4: u256, arg5: u64) {
        ...
        assert!(0x2::balance::value<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(&arg0.total_staked) <= arg2, 11008);
    ...
    public fun stake(arg0: &mut StakePool, arg1: 0x2::coin::Coin<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        transfer_position(stake_ptb(arg0, arg1, arg2, arg3, arg4), v0);
    }

    public fun stake_ptb(arg0: &mut StakePool, arg1: 0x2::coin::Coin<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : StakePosition {
        assert!(arg2 <= arg0.max_lock_ms, 11002);
        let v0 = 0x2::coin::value<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(&arg1);
        assert!(v0 > 0, 11006);
        assert!(0x2::balance::value<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(&arg0.total_staked) + v0 <= arg0.staking_cap, 11003);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = lock_coeff(arg0, arg2);
        let v3 = (v0 as u256) * v2 / 1000000000000000000;
        let v4 = safe_add_u64(v1, arg2);
        0x2::balance::join<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(&mut arg0.total_staked, 0x2::coin::into_balance<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(arg1));
    ...
    public fun unstake(arg0: &mut StakePool, arg1: StakePosition, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>>(unstake_ptb(arg0, arg1, arg2, arg3), v0);
    }

    public fun unstake_ptb(arg0: &mut StakePool, arg1: StakePosition, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO> {
        ...
        0x2::coin::from_balance<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(0x2::balance::split<0xf245f480ded5111af849028b22261f0394df290e03c80726bee54ea5912acf30::taco::TACO>(&mut arg0.total_staked, v1), arg3)
    }
