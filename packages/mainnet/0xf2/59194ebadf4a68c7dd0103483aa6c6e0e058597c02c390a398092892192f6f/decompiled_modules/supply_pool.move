module 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::supply_pool {
    ...
    public fun create_pool<T0, T1: drop>(arg0: 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::equity::EquityTreasury<T1>, arg1: &mut 0x2::tx_context::TxContext) : 0xd9dd55ac7eb676dc78f7d0ae3bc5529d7fd6b52ac0d0edb2d7820c52d080026::access::ActionRequest {
        ...
        let v1 = if (0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::equity::supply_x64<T1>(v0) == 0) {
            if (0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::equity::underlying_value_x64<T1>(v0) == 0) {
                0x2::coin::total_supply<T1>(0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::equity::borrow_treasury_cap<T1>(&arg0)) == 0
            } else {
                false
            }
        } else {
    ...
    public(friend) fun fdb_destroy_empty(arg0: FacilDebtBag) {
        ...
        0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::debt_bag::destroy_empty(v2);
    }
    ...
    public(friend) fun fdb_is_empty(arg0: &FacilDebtBag) : bool {
        0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::debt_bag::is_empty(&arg0.inner)
    }

    public(friend) fun fdb_length(arg0: &FacilDebtBag) : u64 {
        0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::debt_bag::length(&arg0.inner)
    }

    public(friend) fun fdb_share_type_matches_asset_if_any_exists<T0, T1>(arg0: &FacilDebtBag) : bool {
        0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::debt_bag::share_type_matches_asset_if_any_exists<T0, T1>(&arg0.inner)
    }
    ...
    public(friend) fun repay<T0, T1>(arg0: &mut SupplyPool<T0, T1>, arg1: FacilDebtShare<T1>, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        arg0.total_liabilities_x64 = arg0.total_liabilities_x64 - 0x1::u128::min(arg0.total_liabilities_x64, (v3 as u128) << 64);
    ...
    public fun total_liabilities_x64<T0, T1>(arg0: &SupplyPool<T0, T1>) : u128 {
        arg0.total_liabilities_x64
    }
    ...
    public fun update_interest<T0, T1>(arg0: &mut SupplyPool<T0, T1>, arg1: &0x2::clock::Clock) {
        ...
        let v1 = 0;
        let v2 = 0;
        while (v2 < 0x2::vec_map::length<0x2::object::ID, LendFacilInfo<T1>>(&arg0.debt_info)) {
