module 0xf2456e930818f50355b2a5e8b801a32ac1b2a559d273539d22a5e1bcbf56d2f4::cnsnft5793 {
    struct CNSNFT5793 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5793, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5793>(arg0, arg1);
