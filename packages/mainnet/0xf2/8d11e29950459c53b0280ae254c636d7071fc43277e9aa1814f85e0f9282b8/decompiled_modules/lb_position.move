module 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::lb_position {
    ...
    public(friend) fun collect_fees(arg0: &mut LBBinPosition, arg1: u128, arg2: u128) : (u64, u64) {
        ...
        (((0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::mul_u128(arg0.amount, 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::sub_u128(arg1, arg0.fee_growth_inside_last_x)) >> 64) as u64), ((0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::mul_u128(arg0.amount, 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public(friend) fun collect_reward(arg0: &mut LBBinPosition, arg1: u64, arg2: u128) : u64 {
        ...
        *0x1::vector::borrow_mut<u128>(&mut arg0.reward_growth_inside_last, arg1) = arg2;
        0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::u128_to_u64(arg0.amount * 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::sub_u128(arg2, v0) >> 64)
    }
    ...
    public(friend) fun get_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(arg1.saved_fee_x, ((v1 * (arg3 - v0.fee_growth_inside_last_x) >> 64) as u64)), 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(arg1.saved_fee_y, ((v1 * (arg4 - v0.fee_growth_inside_last_y) >> 64) as u64)))
    }
    ...
    public(friend) fun get_pending_rewards(arg0: &LBBinPosition, arg1: u64, arg2: u128) : u64 {
        ...
        0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::u128_to_u64(v0 * (arg2 - v1) >> 64)
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(v0, v3);
            v1 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }

    public(friend) fun increase_liquidity(arg0: &mut 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bin_manager::BinManager, arg1: &mut LBPositionManager, arg2: &mut LBPosition, arg3: vector<u32>, arg4: vector<u128>, arg5: vector<u128>, arg6: vector<u128>, arg7: vector<vector<u128>>) {
        let v0 = 0x1::vector::length<u32>(&arg3);
        if (v0 == 0) {
            return
        };
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, LBPositionInfo>(&mut arg1.positions, arg2.my_id);
        let v2 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bin_manager::borrow_bins_table_mut(arg0);
        let v3 = 0;
        let v4 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::constants::max_u32();
        let v5 = PackedBins{
            active_bins_bitmap : 0,
            bin_data           : 0x1::vector::empty<LBBinPosition>(),
        };
        let v6 = &mut v5;
        let v7 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bin_manager::create_empty_pack();
        let v8 = &mut v7;
        while (v3 < v0) {
            ...
            if (v13 != v4) {
                ...
                v8 = 0x2::table::borrow_mut<u32, 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bin_manager::PackedBins>(v2, v13);
                v4 = v13;
            };
            if (is_bin_active_in_bitmap(v6.active_bins_bitmap, v14)) {
                ...
                if (v16.amount > 0) {
                    let v17 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::u128_to_u64(v16.amount * 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::sub_u128(v10, v16.fee_growth_inside_last_x) >> 64);
                    let v18 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::u128_to_u64(v16.amount * 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::sub_u128(v11, v16.fee_growth_inside_last_y) >> 64);
                    arg2.saved_fee_x = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(arg2.saved_fee_x, v17);
                    arg2.saved_fee_y = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(arg2.saved_fee_y, v18);
                    0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bin_manager::sub_fees(0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bin_manager::get_bin_mut_from_pack(v8, 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bin_manager::get_bin_index_in_pack(v8, v14)), v17, v18);
                    let v19 = 0;
                    ...
                    while (v19 < v22) {
                        ...
                        if (v23 > v24) {
                            let v25 = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::u128_to_u64(v16.amount * (v23 - v24) >> 64);
                            if (v25 > 0) {
                                while (0x1::vector::length<u64>(&arg2.saved_rewards) <= v19) {
                                    0x1::vector::push_back<u64>(&mut arg2.saved_rewards, 0);
                                };
                                *0x1::vector::borrow_mut<u64>(&mut arg2.saved_rewards, v19) = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg2.saved_rewards, v19), v25);
                            };
                        };
                        v19 = v19 + 1;
                    };
                };
                v16.amount = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u128(v16.amount, *0x1::vector::borrow<u128>(&arg4, v3));
    ...
    public(friend) fun remove_bins(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: vector<u32>) {
        ...
        while (v3 < v0) {
            ...
            if (v7 != v4) {
                let v9 = if (v4 != 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::constants::max_u32()) {
        ...
        let v10 = if (v4 != 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::constants::max_u32()) {
            if (v6.active_bins_bitmap == 0) {
                !0x1::vector::contains<u32>(&v2, &v4)
            } else {
                false
    ...
    public(friend) fun save_reward(arg0: &mut LBPosition, arg1: u64, arg2: u64) {
        if (arg2 > 0) {
            ...
            *0x1::vector::borrow_mut<u64>(&mut arg0.saved_rewards, arg1) = 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg0.saved_rewards, arg1), arg2);
        };
    }
