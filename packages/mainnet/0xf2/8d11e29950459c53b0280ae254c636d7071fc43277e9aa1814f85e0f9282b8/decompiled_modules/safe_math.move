module 0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0xf28d11e29950459c53b0280ae254c636d7071fc43277e9aa1814f85e0f9282b8::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
