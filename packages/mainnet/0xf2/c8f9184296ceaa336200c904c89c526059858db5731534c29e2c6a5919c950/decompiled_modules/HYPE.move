module 0xf2c8f9184296ceaa336200c904c89c526059858db5731534c29e2c6a5919c950::HYPE {
    ...
    fun init(arg0: HYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<HYPE>(arg0, 9, b"TRUMP", b"Trump win election", b"Trump win election powered by Musk", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
