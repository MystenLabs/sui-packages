module 0xf2592cbe62d9b8ecd2e95db11536e28ec2a4a985522b3c94c41a0ffc861279c0::suipaynft {
    ...
    fun init(arg0: SUIPAYNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v25 = v22;
        let v26 = 30000000000;
        0xf2592cbe62d9b8ecd2e95db11536e28ec2a4a985522b3c94c41a0ffc861279c0::floor_price_rule::add<NFT>(&mut v25, &v24, v26);
    ...
    fun mint0(arg0: &mut ContractInfo, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u8, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        mintInternal(arg0, arg2, 0, 0x1::string::utf8(b"Early Adopter"), v5, arg3, arg4, arg5)
    }
    ...
    fun mintDiscount0(arg0: &mut ContractInfo, arg1: &Whitelist, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u8, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        mintInternal(arg0, arg3, 0, arg1.type, v6, arg4, arg5, arg6)
    }

    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg2 == 0) {
            arg2 = ((0xf2592cbe62d9b8ecd2e95db11536e28ec2a4a985522b3c94c41a0ffc861279c0::pseudorandom::rand_u32(arg7) % 65535) as u16);
        };
