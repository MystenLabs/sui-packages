module 0xf2ae038dd6731994d0c77dd402743d144dc613eb9c61bce0cd22386eb0a1d068::suishib {
    ...
    fun init(arg0: SUISHIB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUISHIB>(arg0, 2, b"SUISHIB INU", b"SUISHIB", b"", 0x1::option::none<0x2::url::Url>(), arg1);
