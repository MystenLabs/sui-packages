module 0xf2e71641075fdedff04129d8af51db8663e2dea37c690b4da5192b40f03ecb6f::scallop_box {
    ...
    fun get_image_url(arg0: u64) : 0x1::string::String {
        if (arg0 == 1) {
            0x1::string::utf8(b"ipfs://bafkreiginzkqsi5itegjcjbxzbhdxvcrhqyburlsy6bjuaa2fdll74ok7e")
        } else if (arg0 == 2) {
            0x1::string::utf8(b"ipfs://bafkreid3urhcmt6hi6vje27grcvyhnutp5q6ducpcmcuolvlegsqv52fou")
        } else if (arg0 == 3) {
            0x1::string::utf8(b"ipfs://bafkreifasnucqwcj5zx5vuaqn62ajlb27nomcsprwp5omaf4mxkyglv2fu")
        } else if (arg0 == 4) {
            0x1::string::utf8(b"ipfs://bafkreido24kmli2wazwekz7ozlekhalajikqonual4ylkkshhmcv52t2oy")
        } else if (arg0 == 5) {
            0x1::string::utf8(b"ipfs://bafkreihto5xzwsnnuiglwtlrq7pgc3vq6t2qp3e3fydpsfvbm4oyuo6pde")
        } else {
            assert!(arg0 == 6, 0);
            0x1::string::utf8(b"ipfs://bafkreid7eik27fejxwzgrpymtkumkiiv5kefsshbbxqmxt2y2dxz73scu4")
        }
    }
    ...
    fun init(arg0: SCALLOP_BOX, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::package::claim_and_keep<SCALLOP_BOX>(arg0, arg1);
    ...
    public(friend) fun mint(arg0: &mut ScallopBoxStats, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : ScallopBox {
        ...
        if (arg1 == 1) {
            ...
            v1 = 0x1::string::utf8(b"Bronze Scallop Box #");
            ...
            v1 = 0x1::string::utf8(b"Platinum Scallop Box #");
            ...
            v1 = 0x1::string::utf8(b"Diamond Scallop Box #");
            ...
            v1 = 0x1::string::utf8(b"Legendary Scallop Box #");
        ...
        let v4 = ScallopBox{
            ...
            name            : v1,
            description     : 0x1::string::utf8(b"No one knows what's inside this box."),
