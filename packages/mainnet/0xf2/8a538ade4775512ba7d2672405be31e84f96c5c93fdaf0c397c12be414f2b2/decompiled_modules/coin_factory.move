module 0xf28a538ade4775512ba7d2672405be31e84f96c5c93fdaf0c397c12be414f2b2::coin_factory {
    ...
    public entry fun burn(arg0: &mut CoinFactory, arg1: vector<u8>, arg2: 0x2::coin::Coin<CoinFactoryCoin>) {
    ...
    public fun mint(arg0: &mut CoinFactory, arg1: vector<u8>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(arg1);
        assert!(0x2::table::contains<0x1::string::String, 0x2::coin::TreasuryCap<CoinFactoryCoin>>(&arg0.coins, v0), 1);
    ...
    public entry fun create_coin(arg0: &mut CoinFactory, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u8, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<CoinFactoryCoin>>(v4);
