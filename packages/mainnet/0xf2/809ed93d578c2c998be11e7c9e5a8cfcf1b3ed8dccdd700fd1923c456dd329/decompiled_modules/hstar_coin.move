module 0xf2809ed93d578c2c998be11e7c9e5a8cfcf1b3ed8dccdd700fd1923c456dd329::hstar_coin {
    struct HSTAR_COIN has drop {
        dummy_field: bool,
    }

    public fun burn(arg0: &mut 0x2::coin::TreasuryCap<HSTAR_COIN>, arg1: 0x2::coin::Coin<HSTAR_COIN>) {
        0x2::coin::burn<HSTAR_COIN>(arg0, arg1);
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<HSTAR_COIN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
