module 0xf2ea9755cc43fdf81c75b5b4f6d02f4a86076c1be43568b9cc42c511cc39b8cd::reward_distributor {
    ...
    public fun claim(arg0: &mut RewardPool, arg1: &0xf2ea9755cc43fdf81c75b5b4f6d02f4a86076c1be43568b9cc42c511cc39b8cd::player_card::PlayerCard, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.finalized, 2);
        assert!(!0xf2ea9755cc43fdf81c75b5b4f6d02f4a86076c1be43568b9cc42c511cc39b8cd::player_card::is_alive(arg1), 4);
    ...
    public(friend) fun deposit(arg0: &mut RewardPool, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>) {
        ...
        let v0 = PoolDeposited{
            ...
            new_total : 0x2::balance::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg0.balance),
        };
        0x2::event::emit<PoolDeposited>(v0);
    }

    public fun deposit_direct(arg0: &mut RewardPool, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>) {
        0x2::balance::join<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.balance, 0x2::coin::into_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg1));
        let v0 = PoolDeposited{
            amount    : 0x2::coin::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg1),
            new_total : 0x2::balance::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg0.balance),
        ...
        while (v1 < v0) {
            ...
            if (!0x2::table::contains<0x2::object::ID, bool>(&arg0.claimed, v2) && 0x2::table::contains<0x2::object::ID, u64>(&arg0.payouts, v2)) {
                ...
                if (v4 > 0) {
                    ...
                    0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(0x2::coin::from_balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x2::balance::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.balance, v4), arg3), v3);
