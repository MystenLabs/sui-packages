module 0xf24cafda9a9982c3936223b14418c2c6daf4388b81766de03c13cca620ad5f62::launchpad {
    ...
    public fun constants() : (u8, u64, u64, u64, u64, u64, u64) {
        (6, 1000000000000000, 800000000000000, 200000000000000, 1066666666666667, 0, 2)
    }
    ...
    public fun create<T0, T1>(arg0: &mut Protocol, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut 0x2::coin_registry::Currency<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: u64, arg6: u64, arg7: u8, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: 0x1::string::String, arg15: u8, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let (v6, v7) = derive_quote_parameters(arg4, arg5, arg6);
        let v8 = &mut arg3;
        let v9 = charge_exact_or_refund<0x2::sui::SUI>(v8, arg0.launch_fee_sui, arg17);
        ...
        let v10 = Pool<T0, T1>{
            ...
            real_token_reserves         : 0x2::coin::into_balance<T0>(0x2::coin::mint<T0>(&mut arg1, 800000000000000, arg17)),
            virtual_token_reserves      : 1066666666666667,
            virtual_quote_reserves      : v7,
            lp_token_reserves           : 0x2::coin::into_balance<T0>(0x2::coin::mint<T0>(&mut arg1, 200000000000000, arg17)),
    ...
    fun derive_quote_parameters(arg0: u64, arg1: u64, arg2: u64) : (u64, u64) {
        assert!(arg0 > 0 && arg1 > 0, 14);
        assert!(arg2 > 0, 14);
        let v0 = ((100 * 10000) as u128);
        let v1 = (((arg0 as u128) * (arg1 as u128) * (arg2 as u128) + v0 - 1) / v0 + 2) / 3 * 3;
        assert!(v1 + v1 / 3 <= 18446744073709551615, 15);
        let v2 = (v1 as u64);
        (v2, v2 / 3)
    }
