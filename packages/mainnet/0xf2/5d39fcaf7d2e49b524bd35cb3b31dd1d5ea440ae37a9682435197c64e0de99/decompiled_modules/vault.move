module 0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::vault {
    ...
    public entry fun move_token_to_withdraw_assets<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x1::type_name::into_string(0x1::type_name::get<T0>())) {
            ...
            let v2 = 0x2::coin::split<T0>(v1, arg3, arg4);
            if (0x2::bag::contains<0x1::ascii::String>(&arg2.withdraw_assets, v0)) {
                increase_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T0>(&v2) as u128), arg4);
                0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.withdraw_assets, v0), v2);
            } else {
                add_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T0>(&v2) as u128), arg4);
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg2.withdraw_assets, v0, v2);
                0x1::vector::push_back<0x1::ascii::String>(&mut arg2.withdraw_asset_keys, v0);
            };
        } else {
            assert!(0x2::bag::contains<0x1::ascii::String>(&arg2.harvest_assets, v0), 14);
            let v3 = 0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0);
            assert!(0x2::coin::value<T2>(v3) >= arg3, 2);
            let v4 = 0x2::coin::split<T2>(v3, arg3, arg4);
            if (0x2::coin::value<T2>(v3) == 0) {
                ...
                let (v5, v6) = 0x1::vector::index_of<0x1::ascii::String>(&arg2.harvest_asset_keys, &v0);
                if (v5) {
                    0x1::vector::swap_remove<0x1::ascii::String>(&mut arg2.harvest_asset_keys, v6);
                };
            } else {
                add_table_vault_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(v3) as u128), arg4);
            };
            if (0x2::bag::contains<0x1::ascii::String>(&arg2.withdraw_assets, v0)) {
                increase_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v4) as u128), arg4);
                0x2::coin::join<T2>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0), v4);
            } else {
                add_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v4) as u128), arg4);
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0, v4);
                0x1::vector::push_back<0x1::ascii::String>(&mut arg2.withdraw_asset_keys, v0);
            };
        };
        let v7 = MoveTokenToWithdrawAssetEvent{
            amount   : arg3,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
            token    : v0,
        };
        0x2::event::emit<MoveTokenToWithdrawAssetEvent>(v7);
    }
