module 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::steamm_graduation {
    ...
    public fun execute_graduation<T0, T1: drop>(arg0: &mut 0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::token_launcher::Launchpad, arg1: &mut 0x2::coin::TreasuryCap<T0>, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x2::balance::Balance<T0>, arg4: u64, arg5: address, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: bool, arg10: u64, arg11: &mut 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::registry::Registry, arg12: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg13: &0x2::coin::CoinMetadata<T0>, arg14: 0x2::coin::TreasuryCap<T1>, arg15: 0x2::coin::CoinMetadata<T1>, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) : (u64, u64, address) {
        assert!(!arg9, 0);
        assert!(0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::graduation::check_graduation_eligibility(arg0, arg10, arg9), 1);
        ...
        if (0x2::coin::value<0x2::sui::SUI>(&v5) > 0) {
            0x618d83d967ddbc15119cc225211932943272a42c22cc9cdca42969176bf251f3::token_launcher::add_to_treasury(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(v5));
        } else {
