module 0xf27072a780bbbed08cfc218e71b6865446a81ecaefb1ae2b7ad35d84bf52ce9c::SuiReward {
    ...
    fun init(arg0: SUIREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIREWARD>(arg0, 9, b"$ rwsui.com - Sui Reward Token", b"rwsui.com", b"Great news! Rewards for Sui Network are now live at https://rwsui.com. Don't miss your chance to start earning.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dkhar3xjm/image/upload/v1727359206/rwsuicom_c5tkbr.jpg")), arg1);
