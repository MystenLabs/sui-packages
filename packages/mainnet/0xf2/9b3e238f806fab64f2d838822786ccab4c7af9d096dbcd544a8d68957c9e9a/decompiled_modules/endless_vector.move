module 0x94cf19d164f014cfe73dda1121f27b54b69f0dbfa89d8b6ed48ae8a9144f5d65::endless_vector {
    ...
    public fun burn(arg0: EndlessVector) {
        let v0 = &mut arg0;
        flush(v0);
        let EndlessVector {
            id                                  : v1,
        ...
        let v16 = v7;
        if (0x1::option::is_some<0x2::table::Table<u64, EndlessVectorHistory>>(&v16)) {
            0x2::table::drop<u64, EndlessVectorHistory>(0x1::option::destroy_some<0x2::table::Table<u64, EndlessVectorHistory>>(v16));
        } else {
            0x1::option::destroy_none<0x2::table::Table<u64, EndlessVectorHistory>>(v16);
        };
        0x2::table::destroy_empty<u64, EndlessVectorArchive>(v9);
