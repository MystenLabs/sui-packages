module 0xf28bb823a44cfafd872ec9addbbef4aa598128342e97d3c81ef5388cfdd04f66::cnsnft1931 {
    struct CNSNFT1931 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1931, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1931>(arg0, arg1);
