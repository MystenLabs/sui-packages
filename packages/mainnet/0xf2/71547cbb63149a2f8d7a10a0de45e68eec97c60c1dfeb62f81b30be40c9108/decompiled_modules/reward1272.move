module 0xf271547cbb63149a2f8d7a10a0de45e68eec97c60c1dfeb62f81b30be40c9108::reward1272 {
    struct REWARD1272 has drop {
        dummy_field: bool,
    }

    struct TICKET_1272 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1272(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1272>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1272>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1272, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1272>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1272>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1272>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1272>>(v5, 0x2::tx_context::sender(arg1));
    }
