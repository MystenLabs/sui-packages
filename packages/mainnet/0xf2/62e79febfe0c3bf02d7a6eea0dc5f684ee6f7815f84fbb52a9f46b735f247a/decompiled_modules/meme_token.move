module 0xf262e79febfe0c3bf02d7a6eea0dc5f684ee6f7815f84fbb52a9f46b735f247a::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"SUKU", b"SUKUNA", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-12T13-09-19.035Z-sukuna.jpeg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"SUKUNA"),
            symbol     : 0x1::string::utf8(b"SUKU"),
            decimals   : 9,
