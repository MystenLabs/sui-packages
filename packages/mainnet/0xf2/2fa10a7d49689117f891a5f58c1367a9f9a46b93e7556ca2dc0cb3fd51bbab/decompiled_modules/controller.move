module 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::controller {
    struct SubnamePrunedEvent has copy, drop {
        subdomain: 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::Domain,
        parent_domain: 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::Domain,
    }

    struct ControllerV2 has drop {
        dummy_field: bool,
    }
    ...
    public fun prune_expired_subname(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg1: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: 0x1::string::String, arg3: &0x2::clock::Clock) {
        ...
        let v2 = 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::new(arg2);
        assert!(0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::is_subdomain(&v2), 2);
        assert!(0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::is_parent_of(&v1, &v2), 1);
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::prune_expired_subdomain_record(v0, v2, arg3);
        let v3 = SubnamePrunedEvent{
            subdomain     : v2,
            parent_domain : v1,
        };
        0x2::event::emit<SubnamePrunedEvent>(v3);
    }

    public fun prune_expired_subnames(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg1: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: vector<0x1::string::String>, arg3: &0x2::clock::Clock) : u64 {
        let v0 = registry_mut(arg0);
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::assert_nft_is_authorized(v0, arg1, arg3);
        let v1 = 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::domain(arg1);
        let v2 = 0;
        ...
        while (v3 < 0x1::vector::length<0x1::string::String>(&arg2)) {
            let v4 = 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::new(0x1::vector::pop_back<0x1::string::String>(&mut arg2));
            if (!0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::is_subdomain(&v4) || !0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::is_parent_of(&v1, &v4)) {
            } else if (0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::try_prune_expired_subdomain_record(v0, v4, arg3)) {
                v2 = v2 + 1;
                let v5 = SubnamePrunedEvent{
                    subdomain     : v4,
                    parent_domain : v1,
                };
                0x2::event::emit<SubnamePrunedEvent>(v5);
            };
            v3 = v3 + 1;
        };
    ...
    fun registry_mut(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS) : &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::Registry {
        let v0 = ControllerV2{dummy_field: false};
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::app_registry_mut<ControllerV2, 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::Registry>(v0, arg0)
    }

    public fun set_object_reverse_lookup(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg1: &mut 0x2::object::UID, arg2: 0x1::string::String) {
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::set_reverse_lookup(registry_mut(arg0), 0x2::object::uid_to_address(arg1), 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::domain::new(arg2));
    }
    ...
    public fun set_user_data(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg1: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0x2::clock::Clock) {
        ...
        let v3 = if (v2 == b"avatar") {
            true
        } else if (v2 == b"content_hash") {
            true
        } else {
            v2 == b"walrus_site_id"
        };
    ...
    public fun unset_object_reverse_lookup(arg0: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins::SuiNS, arg1: &mut 0x2::object::UID) {
        0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::registry::unset_reverse_lookup(registry_mut(arg0), 0x2::object::uid_to_address(arg1));
    }
