module 0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::tradeport {
    ...
    public fun confirm_transfer(arg0: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg1: 0x2::transfer_policy::TransferRequest<Nft>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::kiosk::Kiosk, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::royalty_rule::fee_amount<Nft>(arg0, 0x2::coin::value<0x2::sui::SUI>(&arg2));
        assert!(v0 > 0, 4);
        0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::royalty_rule::pay<Nft>(arg0, &mut arg1, 0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg4));
        0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::kiosk_lock_rule::prove<Nft>(&mut arg1, arg3);
        0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::witness_rule::prove<Nft, TRADEPORT>(arg0, &mut arg1);
    ...
    fun init(arg0: TRADEPORT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::kiosk_lock_rule::add<Nft>(&mut v5, &v4);
        0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::royalty_rule::add<Nft>(&mut v5, &v4, (500 as u16), 0);
        0xf262b3331555718f96df52847ea2a8f68ca6673947b5208b9f41addce07bed9c::witness_rule::add<Nft, TRADEPORT>(&mut v5, &v4);
