module 0xf23fa7929008f7eb33d118aa9f30bc5c87460bdb28dd436051364410e3c96c0f::zo_mm {
    ...
    struct ArbProfitCalculated has copy, drop {
        direction: u8,
        db_price: u64,
        zo_price: u64,
        net_profit_e6: u64,
    ...
    public fun a2b4c6(arg0: u64, arg1: u64, arg2: u8, arg3: u64, arg4: u64) : (u64, bool) {
        ...
        0x2::event::emit<ArbProfitCalculated>(v2);
        (v0, v1)
    }
