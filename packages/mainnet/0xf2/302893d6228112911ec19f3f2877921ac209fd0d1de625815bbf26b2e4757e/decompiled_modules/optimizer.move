module 0xf2302893d6228112911ec19f3f2877921ac209fd0d1de625815bbf26b2e4757e::optimizer {
    ...
    fun advance_route(arg0: &mut vector<Hop>, arg1: u128) : (u128, u64, u64) {
        ...
        while (v3 < 0x1::vector::length<Hop>(arg0)) {
            ...
            if (v4.kind == 0) {
                ...
                let v12 = orderbook_segment_base_consumed(v4, v5);
                let v13 = 0x1::vector::borrow_mut<OrderbookSegment>(&mut v4.orderbook_segments, v4.orderbook_cursor);
                v13.remaining_base = v13.remaining_base - v12;
                v4.orderbook_consumed_base = v4.orderbook_consumed_base + v12;
                if (v13.remaining_base == 0) {
                    v4.orderbook_cursor = v4.orderbook_cursor + 1;
                    v2 = v2 + 1;
                };
                v0 = quote_orderbook_segment(v4, v5);
            } else {
                assert!(v4.kind == 3, 1);
                assert!(!linear_terminal(v4), 3);
                let v14 = quote_linear_segment(v4, v5);
                let v15 = 0x1::vector::borrow_mut<LinearSegment>(&mut v4.linear_segments, v4.linear_cursor);
                assert!(v5 <= v15.remaining_input, 3);
                v15.remaining_input = v15.remaining_input - v5;
                v15.remaining_output = v15.remaining_output - v14;
                if (v15.remaining_input == 0) {
                    assert!(v15.remaining_output == 0, 3);
    ...
    fun input_to_current_boundary(arg0: &Hop) : u128 {
        if (arg0.kind == 2) {
            ...
            return if (arg0.orderbook_base_to_quote) {
                v0.remaining_base
            } else {
    ...
    fun inverse_hop(arg0: &Hop, arg1: u128) : (u128, bool) {
        ...
        let v0 = if (arg0.kind == 0) {
            ...
            if (arg0.zero_for_one) {
                let v2 = mul_div_up(arg1, 18446744073709551616, arg0.liquidity);
                if (v2 >= arg0.sqrt_price_x64) {
                    return (0, false)
                };
                amount0_delta_up(arg0.sqrt_price_x64, arg0.sqrt_price_x64 - v2, arg0.liquidity)
            } else {
                let v3 = mul_div_down(arg0.liquidity, 18446744073709551616, arg0.sqrt_price_x64);
                if (arg1 >= v3) {
                    return (0, false)
                };
                mul_div_up(mul_div_up(arg0.liquidity, arg0.sqrt_price_x64, 18446744073709551616), arg1, v3 - arg1)
            }
        } else if (arg0.kind == 2) {
            let v4 = current_orderbook_segment(arg0);
            if (arg1 > orderbook_segment_output_capacity(arg0, v4)) {
                return (0, false)
            };
            if (arg0.orderbook_base_to_quote) {
                round_up_to_quantum(mul_div_up(arg1, 1000000000, v4.price), arg0.orderbook_lot_size)
            } else {
                mul_div_up(round_up_to_quantum(arg1, arg0.orderbook_lot_size), v4.price, 1000000000)
            }
        } else {
            assert!(arg0.kind == 3, 1);
            let v5 = current_linear_segment(arg0);
            if (arg1 > v5.remaining_output) {
                return (0, false)
            };
            mul_div_up(arg1, v5.remaining_input, v5.remaining_output)
        };
    ...
    fun quote_orderbook_segment(arg0: &Hop, arg1: u128) : u128 {
        ...
        if (arg0.orderbook_base_to_quote) {
            let v2 = round_down_to_quantum(arg1, arg0.orderbook_lot_size);
            let v3 = if (v2 < v0.remaining_base) {
                v2
            } else {
                v0.remaining_base
            };
            mul_div_down(v3, v0.price, 1000000000)
        } else {
            let v4 = round_down_to_quantum(mul_div_down(arg1, 1000000000, v0.price), arg0.orderbook_lot_size);
            if (v4 < v0.remaining_base) {
                v4
            } else {
                v0.remaining_base
            }
