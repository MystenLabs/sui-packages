module 0xf2ffdd6bebeea414f938d398fcac1af8aaac36356a060fcb240b0136e4d7c152::version {
    ...
    fun init(arg0: VERSION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Version{
            ...
            value : 0xf2ffdd6bebeea414f938d398fcac1af8aaac36356a060fcb240b0136e4d7c152::current_version::value(),
        };
    ...
    public fun is_active_version(arg0: &Version) : bool {
        arg0.value == 0xf2ffdd6bebeea414f938d398fcac1af8aaac36356a060fcb240b0136e4d7c152::current_version::value()
    }
