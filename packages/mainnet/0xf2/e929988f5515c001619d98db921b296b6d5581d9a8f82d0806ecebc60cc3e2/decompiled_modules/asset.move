module 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::asset {
    ...
    public(friend) fun new<T0>(arg0: 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::interest::InterestModel, arg1: AssetConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
    ...
    fun assert_not_equal_and_set<T0: copy + drop + store>(arg0: &mut 0x2::object::UID, arg1: T0, arg2: bool) {
        ...
        assert!(*v0 != arg2, 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::error::updating_with_same_value());
        *v0 = arg2;
    }
    ...
    public(friend) fun change_operation_status<T0>(arg0: &mut Asset<T0>, arg1: u8, arg2: bool) {
        ...
        if (*v0 == 0) {
            ...
            assert!(*v0 == 4, 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::error::invalid_operation_status());
            let v9 = &mut arg0.id;
    ...
    public(friend) fun interest_model<T0>(arg0: &Asset<T0>) : &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::interest::InterestModel {
        &arg0.interest_model
    }
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::interest::InterestModel) {
