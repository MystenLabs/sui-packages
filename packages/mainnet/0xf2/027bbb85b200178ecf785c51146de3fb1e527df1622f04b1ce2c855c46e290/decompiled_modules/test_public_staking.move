module 0xf2027bbb85b200178ecf785c51146de3fb1e527df1622f04b1ce2c855c46e290::test_public_staking {
    ...
    struct PublicStakingVault has store, key {
        id: 0x2::object::UID,
        total_staked: 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>,
    ...
    struct RewardKitty has store, key {
        id: 0x2::object::UID,
        total_kitty: 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>,
        reward_per_token: u64,
    }

    struct TreasuryVault has store, key {
        id: 0x2::object::UID,
        treasury: 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>,
        timestamp: u64,
        last_staked_at: u64,
    }
    ...
    struct TEST_PUBLIC_STAKING has drop {
        dummy_field: bool,
    }

    public entry fun add_funds_to_treasury_vault(arg0: &Owner, arg1: 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>, arg2: u64, arg3: &mut TreasuryVault, arg4: &0x2::clock::Clock, arg5: &UpgradeVersion, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 != 0, 6);
        assert!(0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg1) >= arg2, 7);
        ...
        0x2::coin::join<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg3.treasury, arg1);
        let v0 = TreasuryVaultFunded{
            total_funds : 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg3.treasury),
            funds_added : 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg1),
        };
    ...
    public entry fun change_owner(arg0: 0x2::package::UpgradeCap, arg1: &mut MaintainerRole, arg2: Owner, arg3: address, arg4: &UpgradeVersion, arg5: &0x2::tx_context::TxContext) {
        ...
        assert!(@0x0 != arg3, 3);
        assert!(0x2::tx_context::sender(arg5) == v0, 2);
        assert!(arg3 != v0, 4);
        0x2::vec_set::remove<address>(&mut arg1.has_maintainer_access, &arg2.owner_address);
    ...
    public entry fun claim_rewards(arg0: &mut PublicStakingVault, arg1: &mut TreasuryVault, arg2: &mut RewardKitty, arg3: &0x2::clock::Clock, arg4: &RewardDetails, arg5: &UpgradeVersion, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1.earned_reward <= 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg2.total_kitty), 9);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg2.total_kitty, v1.earned_reward, arg6), v0);
        v1.earned_reward = 0;
    ...
    entry fun collect_reward(arg0: 0x2::transfer::Receiving<0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>, arg1: &mut TreasuryVault, arg2: &MaintainerRole, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::vec_set::contains<address>(&arg2.has_maintainer_access, &v0), 11);
        assert!(arg3.version == 0, 1);
        let v1 = 0x2::transfer::public_receive<0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(&mut arg1.id, arg0);
        let v2 = TreasuryVaultBalance<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>{dummy_field: false};
        let v3 = &mut arg1.id;
        if (0x2::dynamic_field::exists_<TreasuryVaultBalance<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(v3, v2)) {
            0x2::coin::join<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(0x2::dynamic_field::borrow_mut<TreasuryVaultBalance<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>, 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(v3, v2), v1);
        } else {
            0x2::dynamic_field::add<TreasuryVaultBalance<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>, 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(v3, v2, v1);
        };
        let v4 = 0x2::dynamic_field::borrow_mut<TreasuryVaultBalance<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>, 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(v3, v2);
        0x2::coin::join<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg1.treasury, 0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(v4, 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(v4), arg4));
        let v5 = RewardCollected{reward_collected: 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&v1)};
    ...
    fun init(arg0: TEST_PUBLIC_STAKING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = TreasuryVault{
            id             : 0x2::object::new(arg1),
            treasury       : 0x2::coin::zero<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(arg1),
            timestamp      : 0,
            last_staked_at : 0,
        };
        let v4 = RewardKitty{
            id               : 0x2::object::new(arg1),
            total_kitty      : 0x2::coin::zero<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(arg1),
            reward_per_token : 0,
        };
        let v5 = PublicStakingVault{
            id              : 0x2::object::new(arg1),
            total_staked    : 0x2::coin::zero<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(arg1),
    ...
    public entry fun reinvest_rewards(arg0: &mut PublicStakingVault, arg1: &mut TreasuryVault, arg2: &mut RewardKitty, arg3: &0x2::clock::Clock, arg4: &RewardDetails, arg5: &UpgradeVersion, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg2.total_kitty, v2.earned_reward, arg6);
        let v4 = 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&v3);
        v2.earned_reward = 0;
        let v5 = &mut v3;
        stake(v5, v4, arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        0x2::coin::destroy_zero<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(v3);
        let v6 = Reinvested{
            staker            : v0,
    ...
    public entry fun stake(arg0: &mut 0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>, arg1: u64, arg2: &mut PublicStakingVault, arg3: &mut TreasuryVault, arg4: &mut RewardKitty, arg5: &0x2::clock::Clock, arg6: &RewardDetails, arg7: &UpgradeVersion, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg7.version == 0, 1);
        assert!(arg1 != 0, 6);
        assert!(arg1 <= 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(arg0), 7);
        let v1 = 0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(arg0, arg1, arg8);
        if (0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg2.total_staked) == 0 && 0x2::vec_map::size<address, StakerInfo>(&arg2.user_stake_info) == 0) {
            0x2::coin::join<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg2.total_staked, v1);
            let v2 = StakerInfo{
                staked                    : arg1,
            ...
            0x2::vec_map::get_mut<address, StakerInfo>(&mut arg2.user_stake_info, &v0).earned_reward = 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg4.total_kitty);
            let v3 = Staked{
    ...
    public entry fun unstake(arg0: &mut PublicStakingVault, arg1: 0x1::option::Option<u64>, arg2: &mut TreasuryVault, arg3: &mut RewardKitty, arg4: &0x2::clock::Clock, arg5: &UpgradeVersion, arg6: &RewardDetails, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg5.version == 0, 1);
        assert!(0x2::vec_map::contains<address, StakerInfo>(&arg0.user_stake_info, &v0), 5);
        let v1 = 0x2::coin::zero<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(arg7);
        let v2 = 0x2::vec_map::get_mut<address, StakerInfo>(&mut arg0.user_stake_info, &v0);
        if (0x1::option::is_none<u64>(&arg1)) {
            ...
            0x2::coin::join<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut v1, 0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg0.total_staked, v2.staked, arg7));
        } else {
            ...
            v2.staked_at = time_in_secs(arg4);
            update_reward(0x1::option::some<u64>(v2.staked), arg0, arg2, arg3, arg4, arg6, arg7);
            0x2::coin::join<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut v1, 0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg0.total_staked, v3, arg7));
        };
        let v4 = Unstaked{
            unstaked_amount : 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&v1),
            staker_info     : *0x2::vec_map::get<address, StakerInfo>(&arg0.user_stake_info, &v0),
        };
        0x2::event::emit<Unstaked>(v4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(v1, v0);
    }
    ...
    fun update_reward(arg0: 0x1::option::Option<u64>, arg1: &mut PublicStakingVault, arg2: &mut TreasuryVault, arg3: &mut RewardKitty, arg4: &0x2::clock::Clock, arg5: &RewardDetails, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg1.total_staked);
        let v4 = if (v3 == 0) {
            0
        } else {
    ...
    public fun update_reward_contract(arg0: &PublicStakingVault, arg1: &mut TreasuryVault, arg2: &mut RewardKitty, arg3: &0x2::clock::Clock, arg4: &RewardDetails, arg5: &UpgradeVersion, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg0.total_staked);
        let v2 = if (v1 == 0) {
            0
        } else {
    ...
    fun update_reward_kitty(arg0: &mut TreasuryVault, arg1: &mut RewardKitty, arg2: &0x2::clock::Clock, arg3: &RewardDetails, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg0.treasury) >= v1, 9);
        0x2::coin::join<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg1.total_kitty, 0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg0.treasury, v1, arg4));
    ...
    public entry fun view_total_stake(arg0: &mut PublicStakingVault, arg1: &UpgradeVersion, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.version == 0, 1);
        let v0 = TotalStake{amount: 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg0.total_staked)};
    ...
    public entry fun withdraw_reward_kitty(arg0: &Owner, arg1: &mut RewardKitty, arg2: address, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 0, 1);
        assert!(0x2::tx_context::sender(arg4) == arg0.owner_address, 2);
        let v0 = 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg1.total_kitty);
        assert!(v0 != 0, 6);
        assert!(arg2 != @0x0, 3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg1.total_kitty, v0, arg4), arg2);
    ...
    public entry fun withdraw_treasury_vault(arg0: &Owner, arg1: &mut TreasuryVault, arg2: address, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 0, 1);
        assert!(0x2::tx_context::sender(arg4) == arg0.owner_address, 2);
        let v0 = 0x2::coin::value<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&arg1.treasury);
        assert!(v0 != 0, 6);
        assert!(arg2 != @0x0, 3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>>(0x2::coin::split<0x8e955df8b202f71ab6354163979d8e68742dbe420e0d83d2365013878cb44995::test_token::TEST_TOKEN>(&mut arg1.treasury, v0, arg4), arg2);
        let v1 = EmergencyWithdrawl{
            amount    : v0,
            recipient : arg2,
        };
