module 0xf278c471096bb260c1fed13d4102c7629c39e857ed64c3f78ff1453c242ec8c7::pawtato_land {
    ...
    fun init(arg0: PAWTATO_LAND, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PAWTATO_LAND>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pawtato land"));
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://qk3Fblyu-H-McfnU6_AdCtpeBHKuwxuv1Jxnwf8vaF4"));
