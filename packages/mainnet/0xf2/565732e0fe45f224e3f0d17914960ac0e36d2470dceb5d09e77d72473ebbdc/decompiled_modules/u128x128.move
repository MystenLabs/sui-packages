module 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::u128x128 {
    public fun pow(arg0: u256, arg1: 0xec2104ea911f9583a68ed634183831609ffb7274e7e46ba1d491e10dd5423495::i32::I32) : u256 {
        let v0 = false;
        let v1 = v0;
        if (arg0 == 0) {
            return 0
        };
        if (0xec2104ea911f9583a68ed634183831609ffb7274e7e46ba1d491e10dd5423495::i32::eq(arg1, 0xec2104ea911f9583a68ed634183831609ffb7274e7e46ba1d491e10dd5423495::i32::zero())) {
            return 1 << 128
        };
        let v2 = (0xec2104ea911f9583a68ed634183831609ffb7274e7e46ba1d491e10dd5423495::i32::abs_u32(arg1) as u128);
        assert!(v2 < 1048576, 3);
        if (0xec2104ea911f9583a68ed634183831609ffb7274e7e46ba1d491e10dd5423495::i32::is_neg(arg1)) {
            v1 = !v0;
        };
        let v3 = 0;
        if (v2 < 1048576) {
    ...
    public fun log2(arg0: u256) : (u256, bool) {
        ...
        let (v2, _) = 0xf2565732e0fe45f224e3f0d17914960ac0e36d2470dceb5d09e77d72473ebbdc::bit_math::most_significant_bit(((arg0 >> 127) as u256));
