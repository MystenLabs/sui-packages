module 0xf280432b03a80030761efbb39a622bd1b54198a30ddc331f3767c72e99fa7e70::gift5529 {
    struct GIFT5529 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift5529(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT5529, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5529>(arg0, arg1);
