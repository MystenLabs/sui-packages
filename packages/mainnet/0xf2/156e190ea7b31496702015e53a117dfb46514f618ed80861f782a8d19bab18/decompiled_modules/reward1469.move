module 0xf2156e190ea7b31496702015e53a117dfb46514f618ed80861f782a8d19bab18::reward1469 {
    struct REWARD1469 has drop {
        dummy_field: bool,
    }

    struct TICKET_1469 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1469(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1469>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1469>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1469, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1469>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1469>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1469>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1469>>(v5, 0x2::tx_context::sender(arg1));
    }
