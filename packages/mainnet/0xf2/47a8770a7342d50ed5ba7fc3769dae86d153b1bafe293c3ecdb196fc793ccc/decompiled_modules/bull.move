module 0xf247a8770a7342d50ed5ba7fc3769dae86d153b1bafe293c3ecdb196fc793ccc::bull {
    struct BULL has drop {
        dummy_field: bool,
    }

    fun init(arg0: BULL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BULL>(arg0, 6, b"BULL", b"BULL", b"Launched on Odyssey", 0x1::option::none<0x2::url::Url>(), arg1);
