module 0xf2596a299d0bcffd111e2fdb745da15784f0f5aa92ed4da2d4c730e78cb3b6a3::reward5925 {
    struct REWARD5925 has drop {
        dummy_field: bool,
    }

    struct TICKET_5925 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5925(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5925>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5925>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5925, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5925>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5925>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5925>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5925>>(v5, 0x2::tx_context::sender(arg1));
    }
