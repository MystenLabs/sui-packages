module 0xa96cd71ea7b5a9969bf5379114c41023ed1d468ce4aea1693c3fb886a6ed3894::auto_invest {
    ...
    public fun check_valid_source_asset<T0>(arg0: &Investment) {
        let v0 = if (0x2::vec_set::is_empty<0x1::type_name::TypeName>(&arg0.whitelist_source_assets)) {
            true
        } else {
            let v1 = 0x1::type_name::get<T0>();
            0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelist_source_assets, &v1)
        };
        assert!(v0, 3);
    }
    ...
    public fun remove_plan_and_withdraw<T0>(arg0: &mut Investment, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_version(arg0);
        check_plan_exists(arg0, arg1);
        let v0 = remove_plan_(arg0, arg1, 0x2::tx_context::sender(arg2));
        let v1 = 0x1::type_name::get<T0>();
        assert!(&v1 == 0xa96cd71ea7b5a9969bf5379114c41023ed1d468ce4aea1693c3fb886a6ed3894::plan::source_asset(&v0), 3);
        let v2 = if (0xa96cd71ea7b5a9969bf5379114c41023ed1d468ce4aea1693c3fb886a6ed3894::plan::execution_limit(&v0) > 0) {
            0xa96cd71ea7b5a9969bf5379114c41023ed1d468ce4aea1693c3fb886a6ed3894::plan::execution_limit(&v0) - 0xa96cd71ea7b5a9969bf5379114c41023ed1d468ce4aea1693c3fb886a6ed3894::plan::execution_count(&v0)
        } else {
            0
        };
        let v3 = if (v2 > 0) {
            0xa96cd71ea7b5a9969bf5379114c41023ed1d468ce4aea1693c3fb886a6ed3894::plan::subscription_amount(&v0) * v2
        } else {
            0
        };
        0xa96cd71ea7b5a9969bf5379114c41023ed1d468ce4aea1693c3fb886a6ed3894::plan::destroy(v0);
        ...
        0x2::event::emit<PlanRemoved>(v4);
        if (v3 > 0) {
            withdraw<T0>(arg0, v3, arg2)
        } else {
