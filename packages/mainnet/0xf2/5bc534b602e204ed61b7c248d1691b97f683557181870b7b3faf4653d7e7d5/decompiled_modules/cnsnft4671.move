module 0xf25bc534b602e204ed61b7c248d1691b97f683557181870b7b3faf4653d7e7d5::cnsnft4671 {
    struct CNSNFT4671 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4671, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4671>(arg0, arg1);
