module 0xf22fcb8cbfaf9274fe66811186be7671c906fccc5cbe9647e6df61e0b1a63a11::reader {
    public fun current<T0>(arg0: &0xc2ae6693383e4a81285136effc8190c7baaf0e75aafa36d1c69cd2170cfc3803::pool::Pool<T0>, arg1: &0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb::Treasury, arg2: &0xf2ab9aa60c5e879675351a1a89f47131de9dea7cc927327dd0e7282e295c7f5e::result::PriceResult<T0>, arg3: bool) : (u8, u8, u64, u64, bool, bool) {
        ...
        let v10 = 0xc2ae6693383e4a81285136effc8190c7baaf0e75aafa36d1c69cd2170cfc3803::pool::usdb_supply<T0>(arg0);
        let v11 = if (arg3) {
        ...
        let v12 = 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::to_scaled_val(v11);
        let v13 = if (arg3) {
        ...
        let v18 = if (v12 <= 1000000000) {
            (v12 as u64)
        } else {
            0
        };
        (v16, v17, v18, v13, v12 <= 1000000000, v2)
    }
