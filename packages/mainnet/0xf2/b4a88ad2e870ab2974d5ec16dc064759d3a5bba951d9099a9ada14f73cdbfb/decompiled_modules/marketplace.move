module 0xf2b4a88ad2e870ab2974d5ec16dc064759d3a5bba951d9099a9ada14f73cdbfb::marketplace {
    ...
    public entry fun end_auction<T0: store + key>(arg0: &mut Auction, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.highest_bidder != @0x0) {
            let (v0, v1) = 0x2::kiosk::purchase<T0>(arg1, arg0.nft_id, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, arg0.current_bid, arg5));
            let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg3, v1);
            0x2::transfer::public_transfer<T0>(v0, arg0.highest_bidder);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, arg0.current_bid, arg5), arg0.seller);
            let v5 = AuctionEnded{
                auction_id : 0x2::object::uid_to_inner(&arg0.id),
                winner     : arg0.highest_bidder,
                final_bid  : arg0.current_bid,
            };
            0x2::event::emit<AuctionEnded>(v5);
        } else {
