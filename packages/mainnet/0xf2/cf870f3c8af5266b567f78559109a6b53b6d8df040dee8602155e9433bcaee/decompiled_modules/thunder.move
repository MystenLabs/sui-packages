module 0xf2cf870f3c8af5266b567f78559109a6b53b6d8df040dee8602155e9433bcaee::thunder {
    ...
    public fun count(arg0: &Thunderbun, arg1: vector<u8>) : u64 {
    ...
    entry fun deposit(arg0: &mut Thunderbun, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Thunderbun{id: 0x2::object::new(arg0)};
        0x2::transfer::share_object<Thunderbun>(v0);
    }
    ...
    public fun peek(arg0: &Thunderbun, arg1: vector<u8>) : (vector<u8>, vector<u8>, u64) {
    ...
    entry fun pop(arg0: &mut Thunderbun, arg1: vector<u8>, arg2: &0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg3: &0x2::tx_context::TxContext) {
