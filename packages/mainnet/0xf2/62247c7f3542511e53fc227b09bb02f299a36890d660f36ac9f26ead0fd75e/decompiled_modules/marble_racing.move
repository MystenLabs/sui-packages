module 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing {
    ...
    struct AddBetEvent has copy, drop {
        ...
        bet_type: u8,
        payout: u64,
        option: vector<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>,
    ...
    struct MarbleRacingBetResult<phantom T0> has copy, drop {
        ...
        player: address,
        bet_options: vector<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>,
        bet_type: u8,
        bet_size: u64,
        bet_returned: u64,
    ...
    struct RaceConfig has store, key {
        ...
        page_size: u64,
        bet_manager: 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetManager,
        max_combo: u8,
    ...
    struct Race has store, key {
        ...
        bet_end_time: u64,
        status: u64,
        risk_manager: 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::risk_manager::RiskManager,
        bet_setting: 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetSetting,
    ...
    fun remove(arg0: &mut RaceConfig, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::risk_manager::destroy_manager(v6);
    ...
    public fun set_single_house_edge(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64, arg3: u8) {
        ...
        0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::set_single_house_edge(&mut arg0.bet_manager, arg2, arg3);
    }
    ...
    public fun add_bet<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut RaceConfig, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: vector<u64>, arg6: vector<vector<u64>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v5 = 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::get_bet_payout(&arg1.bet_manager, &v0.bet_setting, v3, arg4, arg1.max_combo, v4, 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::risk_manager::marble_ids(&v0.risk_manager));
        MarbleRacing{dummy_field: false};
        0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::risk_manager::add_total_risk(&mut v0.risk_manager, 0x1::type_name::get<T0>(), v5);
        0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::risk_manager::total_risk(&v0.risk_manager, 0x1::type_name::get<T0>());
    ...
    public fun create(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: &mut RaceConfig, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = Race{
            ...
            bet_end_time   : arg2,
            status         : 0,
            risk_manager   : 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::risk_manager::new_manager(arg4, arg6),
            bet_setting    : 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::new_bet_setting(arg4),
    ...
    public fun create_bank<T0>(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::new_bank<T0>(arg1);
    }

    fun create_option(arg0: vector<u64>, arg1: vector<vector<u64>>, arg2: u8) : vector<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption> {
        let v0 = 0x1::vector::empty<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            let v2 = if (arg2 == 0) {
                true
            ...
            let v3 = 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::new_bet_option(*0x1::vector::borrow<u64>(&arg0, v1), *0x1::vector::borrow<vector<u64>>(&arg1, v1));
            if (arg2 == 2) {
                assert!(!0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::check_duplicate_match_option(v0, v3), 18);
            };
            0x1::vector::push_back<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>(&mut v0, v3);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RaceConfig{
            ...
            page_size    : 200,
            bet_manager  : 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::new_bet_manager(),
            max_combo    : 3,
    ...
    public fun put_to_bank<T0>(arg0: &AdminCap, arg1: &mut 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::MarbleRacingBank<T0>, arg2: 0x2::coin::Coin<T0>) {
        0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::put_to_bank<T0>(arg1, arg2);
    }
    ...
    public fun resolve<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: 0x2::object::ID, arg2: vector<u64>, arg3: &mut RaceConfig, arg4: 0x1::option::Option<u64>, arg5: &mut 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::MarbleRacingBank<T0>, arg6: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version(arg3);
        assert_sender_is_manager(arg3, arg6);
        ...
        while (v8 < v7 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            ...
            while (v8 < v7 && 0x1::vector::length<BetSlip>(&v11) != 0) {
                ...
                let v13 = 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::won_bet(v12.option, v12.bet_type, arg2);
                if (v12.coin_type == 0x1::type_name::get<T0>()) {
                    ...
                    let v23 = 0;
                    let v24 = 0x1::vector::empty<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>();
                    while (v23 < 0x1::vector::length<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>(&v21)) {
                        0x1::vector::push_back<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>(&mut v24, *0x1::vector::borrow<0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::bet_manager::BetOption>(&v21, v23));
                        v23 = v23 + 1;
                    };
        ...
        if (!0x1::vector::is_empty<PlayerWin<T0>>(&v3)) {
            while (!0x1::vector::is_empty<PlayerWin<T0>>(&v3)) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::get_from_bank<T0>(arg5, v28), arg6), v26);
                0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::put_to_bank<T0>(arg5, 0x2::coin::from_balance<T0>(v27, arg6));
            };
        };
        0x1::vector::destroy_empty<PlayerWin<T0>>(v3);
        if (0x2::balance::value<T0>(&v5) != 0) {
            0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::put_to_bank<T0>(arg5, 0x2::coin::from_balance<T0>(v5, arg6));
        } else {
    ...
    public fun withdraw_from_bank<T0>(arg0: &AdminCap, arg1: address, arg2: &mut 0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::MarbleRacingBank<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xf262247c7f3542511e53fc227b09bb02f299a36890d660f36ac9f26ead0fd75e::marble_racing_bank::withdraw_from_bank<T0>(arg1, arg2, arg3);
    }
