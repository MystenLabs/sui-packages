module 0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token {
    ...
    fun init(arg0: TEST_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<TEST_TOKEN>(arg0, 9, b"TT", b"Test_Token", b"Utility Coin for Testing", 0x1::option::none<0x2::url::Url>(), arg1);
