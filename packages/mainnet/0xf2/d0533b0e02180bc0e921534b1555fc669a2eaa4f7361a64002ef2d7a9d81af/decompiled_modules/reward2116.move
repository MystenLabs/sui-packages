module 0xf2d0533b0e02180bc0e921534b1555fc669a2eaa4f7361a64002ef2d7a9d81af::reward2116 {
    struct REWARD2116 has drop {
        dummy_field: bool,
    }

    struct TICKET_2116 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2116(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2116>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2116>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2116, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2116>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2116>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2116>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2116>>(v5, 0x2::tx_context::sender(arg1));
    }
