module 0xf2b5295d8c2b404e0bb39f307dd829898b2cb395793392b7d3b37c8ccc613b5f::popkins_nft {
    ...
    fun init(arg0: POPKINS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = v7;
        let v9 = v6;
        0xf2b5295d8c2b404e0bb39f307dd829898b2cb395793392b7d3b37c8ccc613b5f::royalty_rule::add_to_policy<PopkinsNFT>(&mut v9, &v8, 0xf2b5295d8c2b404e0bb39f307dd829898b2cb395793392b7d3b37c8ccc613b5f::royalty_rule::new_config<PopkinsNFT>(@0x3993606b5fd91994ce0575ffc7579177054a26092b87ead515b41e7952647fdb, 700));
    ...
    public entry fun transfer_nft_to_new_kiosk(arg0: &PopkinsRegistryPolicy, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        validate_policy_version(arg0);
        let (v0, v1) = 0x2::kiosk::new(arg5);
        let v2 = v1;
        let v3 = v0;
        0x2::kiosk::lock<PopkinsNFT>(&mut v3, &v2, &arg0.transfer_policy, 0x2::kiosk::take<PopkinsNFT>(arg1, arg2, arg3));
