module 0xf2c120760accabf17a36399de68c728c1b97c31cfd5d7425c5281171720b732b::reward8699 {
    struct REWARD8699 has drop {
        dummy_field: bool,
    }

    struct TICKET_8699 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8699(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8699>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8699>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8699, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8699>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8699>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8699>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8699>>(v5, 0x2::tx_context::sender(arg1));
    }
