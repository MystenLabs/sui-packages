module 0xf2a579ab00e9b326a77a18cfec0e7b90e93cafd39f5d73bd7601fd2aa5c4a919::reward4515 {
    struct REWARD4515 has drop {
        dummy_field: bool,
    }

    struct TICKET_4515 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4515(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4515>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4515>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4515, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4515>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4515>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4515>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4515>>(v5, 0x2::tx_context::sender(arg1));
    }
