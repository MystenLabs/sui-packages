module 0xf25920b602e355ce9cad8053611b0cfc455910329e85680303459e5482ac15da::strk {
    ...
    fun init(arg0: STRK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://gateway.irys.xyz/ESmq8Ue6gRMT4CQQjNkJ9F1gD5UQKxfX3LgCysJ6H7Ev                                                                                                                                                                                                                                                           ");
        ...
        let v6 = v3;
        0x2::coin::mint_and_transfer<STRK>(&mut v6, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
