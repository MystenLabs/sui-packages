module 0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::vault {
    ...
    public(friend) fun extend_lock<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        ...
        arg1.max_voting_power = 0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::calculator::get_max_voting_power(arg1.locked_amount, arg3);
    ...
    public(friend) fun lock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v3 = 0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::calculator::get_max_voting_power(v2, arg3);
    ...
    public(friend) fun lock_for_max_power<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v4 = 0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::calculator::get_max_voting_power(v3, v0);
        0x2::balance::join<T0>(&mut arg0.total_locked_balance, arg2);
    ...
    public(friend) fun merge_veToken<T0>(arg0: &mut VeTokenVault<T0>, arg1: vector<VoteEscrowedToken<T0>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (VoteEscrowedToken<T0>, vector<VoteEscrowedToken<T0>>) {
        ...
        let v7 = 0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::calculator::get_max_voting_power(v1, v2);
    ...
    public(friend) fun pre_unlock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        ...
        let v2 = (((v1 as u128) * (0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::calculator::get_penalty_ratio(v0 - arg1.lock_start_time, arg1.lock_period, arg3) as u128) / (1000000 as u128)) as u64);
        let v3 = (v1 as u64) - v2;
        ...
        arg1.max_voting_power = 0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::calculator::get_max_voting_power(v3, arg3);
        arg0.total_max_voting_power = arg0.total_max_voting_power - arg1.max_voting_power - arg1.max_voting_power;
    ...
    public(friend) fun switch_to_always_max_power<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock) {
        ...
        if (arg1.lock_period < 63072000000) {
            ...
            arg1.max_voting_power = 0xf21c5d05c7886648e7a6e2519b7df1df21c9004568f895583c8ba1de1b402f54::calculator::get_max_voting_power(arg1.locked_amount, 63072000000);
        };
        update_nft_lock_start_end_time<T0>(arg1, arg2);
