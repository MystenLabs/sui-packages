module 0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>,
        init_reward: u64,
    ...
    struct PlayerInfo has store, key {
        ...
        fisherman_level: u64,
        fisherman_speed: u64,
        fisherman_item: 0x2::table_vec::TableVec<ItemBoost>,
        sea_level: u64,
        sea_reward: u64,
        board_level: u64,
        board_peroid: u64,
        board_item: 0x1::string::String,
        referral: address,
        last_claim: u64,
    }
    ...
    entry fun add_treasury_cap(arg0: &mut GameInfo, arg1: 0x2::coin::TreasuryCap<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 4);
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury"), arg1);
    }
    ...
    entry fun create_user(arg0: &mut GameInfo, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x1::string::String, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version <= 1, 2);
        assert!(arg0.owner == 0x2::tx_context::sender(arg10), 4);
        ...
        let v2 = 0x2::table_vec::empty<ItemBoost>(arg10);
        let v3 = ItemBoost{
            type       : 2,
            rate       : 1,
            start_time : 0,
        ...
        0x2::table_vec::push_back<ItemBoost>(&mut v2, v3);
        let v4 = ItemBoost{
            type       : 2,
            rate       : 3,
            start_time : 0,
        ...
        0x2::table_vec::push_back<ItemBoost>(&mut v2, v4);
        let v5 = PlayerInfo{
        ...
        0x2::dynamic_object_field::add<address, PlayerInfo>(&mut arg0.id, arg1, v5);
        let v6 = arg0.init_reward;
        let v7 = CreateUser{
            user_address : arg1,
            ref_address  : arg2,
        };
        0x2::event::emit<CreateUser>(v7);
        if (v6 > 0) {
            send_tokens(arg0, arg1, v6, arg10);
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version      : 1,
            balance      : 0x2::balance::zero<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>(),
    ...
    entry fun remove_treasury_cap(arg0: &mut GameInfo, arg1: &0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg1));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>>(0x2::coin::from_balance<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>(0x2::balance::split<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>>(0x2::coin::from_balance<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>(0x2::balance::withdraw_all<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>>(0x2::coin::mint<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0x69f1e1c329a8347ceff0eb19a6dee43e7be63bdfbec96081b4e6c384bd52d9b6::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
