module 0x69f56ddcf0afd984804b0a17f11539a575854cb6fac16b887328abcf8f966bc2::vesting_lock {
    ...
    public fun compute_vested_amount<T0>(arg0: &VestingLock<T0>, arg1: u64) : u64 {
        if (arg1 < arg0.start_time) {
            ...
            0x69f56ddcf0afd984804b0a17f11539a575854cb6fac16b887328abcf8f966bc2::math::mul_factor(0x2::balance::value<T0>(&arg0.vault) + arg0.released_amount, arg1 - arg0.start_time, arg0.duration)
        }
    }
