module 0x69e7d357a1ec089e948c4cf699460335387c4c022e44cb74d637f6d2974900bc::pope {
    ...
    fun init(arg0: POPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<POPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POPE        ")))), trim_right(b"POPE FRANCIS                    "), trim_right(b"Pope To Heaven, Pope To The Moon                                                                                                                                                                                                                                                                                                "), v2, arg1);
