module 0x69e4f9c0a91068b5fee29de92bbebdb9ff4a7a2a06ee07386d7024fc57a7c32d::cnsnft2633 {
    struct CNSNFT2633 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2633, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2633>(arg0, arg1);
