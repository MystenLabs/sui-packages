module 0x69726fa42ba5583a700fbbaae4191fef299753a032b9f8a3339085d605fcffb6::sui_eggs {
    ...
    fun init(arg0: SUI_EGGS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Mint some SUI eggs before the collection drops"));
