module 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::decimal {
    ...
    public fun div_by_rate(arg0: Decimal, arg1: 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::rate::Rate) : Decimal {
    ...
    public fun from_rate(arg0: 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::rate::Rate) : Decimal {
        Decimal{value: (0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::rate::to_raw(arg0) as u256)}
    }
    ...
    public fun mul_with_rate(arg0: Decimal, arg1: 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::rate::Rate) : Decimal {
    ...
    public fun pow_frac(arg0: Decimal, arg1: Decimal) : Decimal {
        if (is_zero(&arg1)) {
            return one()
        };
        if (is_zero(&arg0)) {
        ...
        let v0 = to_raw(arg1);
        let v1 = ((v0 / 1000000000000000000) as u64);
        let v2 = v0 % 1000000000000000000;
        let v3 = pow_u64(arg0, v1);
        if (v2 > 0) {
            let v5 = pow_u64(arg0, v1 + 1);
            let (v6, v7) = if (ge(&v3, &v5)) {
                (sub(v3, v5), true)
            } else {
                (sub(v5, v3), false)
            };
            if (v7) {
                sub(v3, mul(v6, from_raw(v2)))
            } else {
                add(v3, mul(v6, from_raw(v2)))
            }
        } else {
            v3
        }
    ...
    public fun to_rate(arg0: Decimal) : 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::rate::Rate {
        assert!(arg0.value <= (340282366920938463463374607431768211455 as u256), 1);
        0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::rate::from_raw((arg0.value as u128))
    }
