module 0x69ff80e24a30ed8da6948741e1f042414368207d090b36e289ee3e2ea9050d70::my_hero {
    ...
    fun init(arg0: MY_HERO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Claim your free Sui Ticket to Get free NFTs or SUI tokens. Claim it here : https://tinyurl.com/ticket-sui"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"The Sui Ticket"));
