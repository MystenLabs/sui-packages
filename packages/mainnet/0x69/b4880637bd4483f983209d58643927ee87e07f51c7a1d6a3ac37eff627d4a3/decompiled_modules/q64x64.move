module 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::q64x64 {
    ...
    public fun liquidity_from_amounts(arg0: u64, arg1: u64, arg2: u128) : u128 {
        0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::add_u128(0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::mul_div_u128((arg0 as u128), arg2, 18446744073709551616), (arg1 as u128))
    }
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::bit_math::most_significant_bit(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::bit_math::most_significant_bit(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
