module 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
