module 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::lb_position {
    ...
    public(friend) fun add_total_fees_generated(arg0: &mut LBPositionInfo, arg1: u128) {
        arg0.fee_reward_info.total_fees_generated = 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::add_u128(arg0.fee_reward_info.total_fees_generated, arg1);
    }
    ...
    fun calculate_and_update_fees_internal(arg0: &mut LBBinPosition, arg1: u128, arg2: u128) : (u64, u64) {
        ...
        (((0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::mul_u128(v0, 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::sub_u128(arg1, arg0.fee_growth_inside_last_x)) >> 64) as u64), ((0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::mul_u128(v0, 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public(friend) fun decrease_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: &0x2::clock::Clock) : u128 {
        ...
        0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::bin_manager::decrement_total_supply(arg1, arg3, arg4)
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (arg2 <= arg3) {
            ...
            arg2 = 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::add_u32(arg2, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::add_u64(v0, v3);
            v1 = 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128) : u128 {
        let v0 = borrow_mut_position_info(arg0, 0x2::object::id<LBPosition>(arg2));
        if (0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg3)) {
            let v1 = 0x2::table::borrow_mut<u32, LBBinPosition>(&mut v0.bins, arg3);
            v1.amount = 0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::safe_math::add_u128(v1.amount, arg4);
        } else {
        ...
        0x69b4880637bd4483f983209d58643927ee87e07f51c7a1d6a3ac37eff627d4a3::bin_manager::increment_total_supply(arg1, arg3, arg4)
    }
