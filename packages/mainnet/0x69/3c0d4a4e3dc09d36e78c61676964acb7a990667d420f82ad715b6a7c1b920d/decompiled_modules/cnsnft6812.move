module 0x693c0d4a4e3dc09d36e78c61676964acb7a990667d420f82ad715b6a7c1b920d::cnsnft6812 {
    struct CNSNFT6812 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6812, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6812>(arg0, arg1);
