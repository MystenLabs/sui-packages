module 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill {
    ...
    public fun deprecate(arg0: &mut Skill, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.agent_id, 1);
    ...
    public fun publish(arg0: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: vector<u64>, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg0) == 0x2::tx_context::sender(arg11), 0);
        assert!(arg5 <= 2, 21);
        assert!(arg8 >= 300 && arg8 <= 604800, 22);
        let v0 = 0x2::tx_context::epoch_timestamp_ms(arg11);
        let v1 = 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg0);
    ...
    public fun reactivate(arg0: &mut Skill, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.agent_id, 1);
    ...
    public fun update_metadata(arg0: &mut Skill, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_pricing(arg0: &mut Skill, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_timeout(arg0: &mut Skill, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg3), 0);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.agent_id, 1);
