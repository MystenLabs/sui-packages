module 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::task {
    ...
    public fun accept(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg4), 0);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 < arg0.expires_at, 3);
        let v1 = 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1);
        if (arg0.status == 1) {
    ...
    public fun cancel(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg3), 0);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.requester_agent, 12);
    ...
    public fun claim_bond(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 9, 2);
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        let v0 = 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.worker_bond), arg2), 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1));
    }

    public fun claim_refund(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 9, 2);
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.requester_agent, 12);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.escrow) > 0, 7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.escrow), arg2), 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1));
    }

    public fun confirm(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg3), 0);
    ...
    public fun create(arg0: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::Skill, arg2: 0x1::string::String, arg3: 0x1::option::Option<0x1::string::String>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u8, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg0) == 0x2::tx_context::sender(arg8), 0);
        assert!(!0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::deprecated(arg1), 18);
        assert!(arg5 <= 2, 20);
        let v0 = 0x2::clock::timestamp_ms(arg7);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg4);
        assert!(v1 >= 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::base_price_mist(arg1) * 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::priority_multiplier(arg1, arg5) / 10000, 7);
        let v2 = if (arg6 == 0) {
            0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::timeout_seconds(arg1)
        } else {
            arg6
        };
        let v3 = Task{
            id                   : 0x2::object::new(arg8),
            requester_agent      : 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg0),
            worker_agent         : 0x1::option::none<0x2::object::ID>(),
            skill_id             : 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::Skill>(arg1),
            skill_version        : 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::version(arg1),
            ...
            payment_amount       : v1,
            worker_bond_required : 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::worker_bond_mist(arg1),
            priority_tier        : arg5,
            verification_type    : 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::skill::verification_type(arg1),
            status               : 0,
            created_at           : v0,
    ...
    public fun expire(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &mut 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::treasury::Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg4), 0);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.requester_agent, 12);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        ...
        let v3 = 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1);
        ...
        let v5 = if (0x1::option::is_some<0x2::object::ID>(&arg0.worker_agent) && v2 > 0) {
            ...
            0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::treasury::deposit(arg2, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.worker_bond), arg4));
            v2
        } else {
            0
        };
    ...
    public fun extend_deadline(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg4), 0);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.requester_agent, 12);
    ...
    public fun reject(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg5), 0);
        assert!(arg0.status == 4, 2);
        assert!(arg0.verification_type == 1, 21);
        assert!(0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1) == arg0.requester_agent, 12);
        let v0 = 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg2);
        assert!(0x1::option::contains<0x2::object::ID>(&arg0.worker_agent, &v0), 11);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&arg0.worker_bond);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.escrow), arg5), 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1));
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.worker_bond), arg5), 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg2));
        };
        arg0.status = 9;
        let v2 = TaskFailed{
            task_id         : 0x2::object::id<Task>(arg0),
    ...
    public fun reserve(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg3), 0);
        assert!(arg0.status == 0, 2);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        assert!(v0 < arg0.expires_at, 3);
    ...
    public fun settle(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &mut 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::treasury::Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 5, 2);
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg4), 0);
        let v0 = 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg1);
        assert!(0x1::option::contains<0x2::object::ID>(&arg0.worker_agent, &v0), 11);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1);
        let v3 = arg0.payment_amount * 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::treasury::fee_bps(arg2) / 10000;
        0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::treasury::deposit(arg2, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.escrow, v3), arg4));
    ...
    public fun submit(arg0: &mut Task, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg1) == 0x2::tx_context::sender(arg5), 0);
