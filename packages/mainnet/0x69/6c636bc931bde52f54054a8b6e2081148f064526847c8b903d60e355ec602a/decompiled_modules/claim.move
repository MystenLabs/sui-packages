module 0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::claim {
    ...
    public fun generate(arg0: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : Claim {
        assert!(0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::owner(arg0) == 0x2::tx_context::sender(arg2), 0);
        let v0 = 0x2::tx_context::epoch_timestamp_ms(arg2);
        let v1 = Claim{
            id                : 0x2::object::new(arg2),
            agent_id          : 0x2::object::id<0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent>(arg0),
    ...
    public fun generate_and_share(arg0: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Claim>(generate(arg0, arg1, arg2));
    }

    public fun generate_and_transfer(arg0: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun revoke(arg0: &mut Claim, arg1: &0x696c636bc931bde52f54054a8b6e2081148f064526847c8b903d60e355ec602a::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
