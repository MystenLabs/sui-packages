module 0x69cbacf622b5074c460da71a246a923cf16a45793f0da31cf26fa739fea0505b::endpoints_v2 {
    ...
    public fun swap<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: &0xdee9::custodian_v2::AccountCap, arg2: u64, arg3: u64, arg4: bool, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = 0x2::coin::zero<T0>(arg8);
        let v1 = 0x2::coin::zero<T1>(arg8);
        if (arg4) {
            let (v2, v3) = swap_base_for_quote<T0, T1>(arg0, arg1, arg2, arg3, arg5, arg6, arg7, arg8);
            0x2::coin::join<T0>(&mut v0, v2);
            0x2::coin::join<T1>(&mut v1, v3);
        } else {
            let (v4, v5) = swap_quote_for_base<T0, T1>(arg0, arg1, arg2, arg3, arg6, arg7, arg8);
