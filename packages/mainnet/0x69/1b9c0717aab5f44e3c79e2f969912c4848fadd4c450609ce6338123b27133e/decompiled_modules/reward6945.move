module 0x691b9c0717aab5f44e3c79e2f969912c4848fadd4c450609ce6338123b27133e::reward6945 {
    struct REWARD6945 has drop {
        dummy_field: bool,
    }

    struct TICKET_6945 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6945(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6945>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6945>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6945, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6945>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6945>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6945>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6945>>(v5, 0x2::tx_context::sender(arg1));
    }
