module 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_nft {
    ...
    public fun payment_chain(arg0: &SuiPlay0x1PreorderNFT) : &0x1::string::String {
        &arg0.payment_chain
    }

    public fun payment_tx_digest(arg0: &SuiPlay0x1PreorderNFT) : &0x1::string::String {
        &arg0.payment_tx_digest
    }
    ...
    public fun update_and_transfer_returned_nft(arg0: SuiPlay0x1PreorderNFT, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut TransferWhitelist, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(is_authorized_whitelist_manager(arg3, 0x2::tx_context::sender(arg5)), 8);
        let v0 = 0xd7b0a6b6832c2693ebafab2e71fb79ed12653c4073d39acbc9f712d0682fdd57::suiplay_constants::supported_chains();
        assert!(0x1::vector::contains<vector<u8>>(&v0, 0x1::string::as_bytes(&arg1)), 2);
        arg0.payment_chain = arg1;
        arg0.payment_tx_digest = arg2;
        0x2::transfer::transfer<SuiPlay0x1PreorderNFT>(arg0, arg4);
    }
