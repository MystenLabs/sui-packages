module 0x69ed5000acf83bcf9fa5fe44d041ada877d34879e88a71ab7b65b3dbceaea2a9::helper {
    public(friend) fun apply_slippage(arg0: u64, arg1: u64) : u64 {
        if (arg0 == 0) {
            return 0
        };
        arg0 + 0x69ed5000acf83bcf9fa5fe44d041ada877d34879e88a71ab7b65b3dbceaea2a9::math::mul(arg0, arg1)
    }
    ...
    public(friend) fun get_sui_per_deep_from_oracle(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : u64 {
        let (v0, v1) = 0x69ed5000acf83bcf9fa5fe44d041ada877d34879e88a71ab7b65b3dbceaea2a9::oracle::get_pyth_price(arg0, arg2);
        let v2 = v1;
        let v3 = v0;
        let (v4, v5) = 0x69ed5000acf83bcf9fa5fe44d041ada877d34879e88a71ab7b65b3dbceaea2a9::oracle::get_pyth_price(arg1, arg2);
        let v6 = v5;
        let v7 = v4;
        assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2) == 0x69ed5000acf83bcf9fa5fe44d041ada877d34879e88a71ab7b65b3dbceaea2a9::oracle::deep_price_feed_id() && 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v6) == 0x69ed5000acf83bcf9fa5fe44d041ada877d34879e88a71ab7b65b3dbceaea2a9::oracle::sui_price_feed_id(), 3);
    ...
    public(friend) fun get_sui_per_deep_from_reference_pool<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        ...
        if (v0 == v2) {
            ...
            0x69ed5000acf83bcf9fa5fe44d041ada877d34879e88a71ab7b65b3dbceaea2a9::math::div(1000000000, get_pool_first_ask_price<T0, T1>(arg0, arg1))
        }
    }
