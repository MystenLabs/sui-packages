module 0x697f3ceec3ff45affeb2196b8e10d84bc47bb83f671ab1ea4c697fd4db4c95c2::sui_presents_walrus_ {
    ...
    struct SUI_PRESENTS_WALRUS_ has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUI_PRESENTS_WALRUS_, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui Presents Walrus"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b""));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://lu.ma/suipresentswalrus"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://images.lumacdn.com/cdn-cgi/image/format=auto,fit=cover,dpr=2,background=white,quality=75,width=400,height=400/event-covers/ed/8bc33333-481a-46b6-9dc1-6cb013f8c525.png"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://giftdrop.io/nft"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"1740197386708"));
        ...
        let v4 = 0x2::package::claim<SUI_PRESENTS_WALRUS_>(arg0, arg1);
