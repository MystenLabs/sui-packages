module 0x6925b2b0708350bbb682760c48ff69000a747b5832181515aa6a23b2d36c9213::cnsnft3496 {
    struct CNSNFT3496 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3496, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3496>(arg0, arg1);
