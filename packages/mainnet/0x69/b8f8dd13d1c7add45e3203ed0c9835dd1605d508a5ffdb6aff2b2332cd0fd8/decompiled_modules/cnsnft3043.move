module 0x69b8f8dd13d1c7add45e3203ed0c9835dd1605d508a5ffdb6aff2b2332cd0fd8::cnsnft3043 {
    struct CNSNFT3043 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3043, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2868"));
        let v4 = 0x2::package::claim<CNSNFT3043>(arg0, arg1);
