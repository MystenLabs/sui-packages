module 0x694711a7df5dc3077b7921234829645f86432c01532297afe2235b989a13e286::crusher {
    ...
    public entry fun execute_crush<T0: store + key>(arg0: &mut CrusherNFT, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = CrushEvent{
            ...
            crusher     : 0x2::tx_context::sender(arg2),
            crush_count : arg0.crush_count,
            rarity      : get_rarity(arg0.crush_count),
        };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = CollectionConfig{
            id         : 0x2::object::new(arg0),
            admin      : 0x2::tx_context::sender(arg0),
            minted     : 0,
            max_supply : 100,
            mint_price : 500000000,
        };
        0x2::transfer::share_object<CollectionConfig>(v1);
    }
    ...
    public entry fun mint(arg0: &mut CollectionConfig, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg1, arg0.mint_price, arg2), arg0.admin);
