module 0x69c8b845264649f088338f81d13752b5add9d2ca977be2a5fa46c86348be20f8::reward8459 {
    struct REWARD8459 has drop {
        dummy_field: bool,
    }

    struct TICKET_8459 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8459(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8459>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8459>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8459, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8459>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8459>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8459>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8459>>(v5, 0x2::tx_context::sender(arg1));
    }
