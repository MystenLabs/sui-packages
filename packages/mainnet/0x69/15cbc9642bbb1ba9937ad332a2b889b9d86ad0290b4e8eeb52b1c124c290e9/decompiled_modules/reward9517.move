module 0x6915cbc9642bbb1ba9937ad332a2b889b9d86ad0290b4e8eeb52b1c124c290e9::reward9517 {
    struct REWARD9517 has drop {
        dummy_field: bool,
    }

    struct TICKET_9517 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9517(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9517>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9517>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9517, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9517>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9517>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9517>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9517>>(v5, 0x2::tx_context::sender(arg1));
    }
