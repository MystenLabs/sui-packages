module 0x6963cd45857bf632a9fe3de728d2369242f6d9e70ff3a59f8a91fe722a4380d2::tato {
    ...
    fun init(arg0: TATO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TATO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Tato"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Pawtato "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibjxnocoyymj4a2m5p5yhb47s6bw472bkrywnvrmv4l4kk52nvjy4"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 9000, 0);
