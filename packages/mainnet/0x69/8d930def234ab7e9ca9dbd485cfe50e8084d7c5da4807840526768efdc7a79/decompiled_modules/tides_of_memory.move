module 0x698d930def234ab7e9ca9dbd485cfe50e8084d7c5da4807840526768efdc7a79::tides_of_memory {
    struct TIDES_OF_MEMORY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TIDES_OF_MEMORY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TIDES_OF_MEMORY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Tides of Memory"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Drifting through the currents of time, some moments are never meant to fade"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihuwws7cbgfhseckaphkzdxpfc5cz7x5g53jk3vgbgymggmqct4oe"));
