module 0x69ab9c4de4f3c93cfbdb5b0dd2b9ec0e98ed5ed051a6c7d37325de9f3103676c::cai {
    struct CAI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/vTT8CvaaCwvDBtPUjQVAm1bhUaMtbcUdErtRXkApump.png?size=lg&key=6653b2                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<CAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CAI     ")))), trim_right(b"Cadoc AI                        "), trim_right(b"Your ultimate AI trading companion to level up your crypto game!                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
