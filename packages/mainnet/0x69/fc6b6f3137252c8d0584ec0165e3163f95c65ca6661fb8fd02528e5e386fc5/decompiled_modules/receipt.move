module 0xc74a7df07b4089d92f196d1db73ce0574db7f58ae0ba2b19b2a59d402958d394::receipt {
    ...
    struct ReceiptTypeAttested has copy, drop {
    ...
    public(friend) fun mint_v2<T0>(arg0: address, arg1: address, arg2: u64, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : PaymentReceipt {
        let v0 = mint(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        let v1 = ReceiptTypeAttested{
            receipt_id : 0x2::object::id<PaymentReceipt>(&v0),
            coin_type  : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())),
        };
        0x2::event::emit<ReceiptTypeAttested>(v1);
        v0
    }
