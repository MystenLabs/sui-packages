module 0xc74a7df07b4089d92f196d1db73ce0574db7f58ae0ba2b19b2a59d402958d394::auto_swap {
    ...
    struct AutoSwapCapV3<phantom T0> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
        vault_id: 0x2::object::ID,
        owner: address,
    ...
    struct AutoSwapV3Validated has copy, drop {
        registry_id: 0x2::object::ID,
        vault_id: 0x2::object::ID,
        cap_id: 0x2::object::ID,
        amount: u64,
    ...
    struct AutoSwapBoundsUpdated has copy, drop {
        owner: address,
        cap_id: 0x2::object::ID,
        old_max_per_swap: u64,
        new_max_per_swap: u64,
        old_max_per_day: u64,
        new_max_per_day: u64,
    ...
    struct AutoSwapCapV4<phantom T0> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
        vault_id: 0x2::object::ID,
        owner: address,
    ...
    struct AutoSwapV4Enabled has copy, drop {
        owner: address,
        registry_id: 0x2::object::ID,
        vault_id: 0x2::object::ID,
        cap_id: 0x2::object::ID,
    ...
    struct AutoSwapRateFloorUpdated has copy, drop {
        owner: address,
        cap_id: 0x2::object::ID,
        old_min_rate_num: u64,
        old_min_rate_den: u64,
        new_min_rate_num: u64,
        new_min_rate_den: u64,
    }

    public fun accept_admin_transfer(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun accept_delay_change(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun add_allowed_dest<T0>(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun add_allowed_provider(arg0: &mut AutoSwapRegistryV2, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
    ...
    fun assert_rate_floor(arg0: u64, arg1: u64) {
        assert!(arg0 > 0, 224);
        assert!(arg1 > 0, 224);
    }

    public fun begin_admin_transfer(arg0: &mut AutoSwapRegistryV2, arg1: address, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun begin_delay_change(arg0: &mut AutoSwapRegistryV2, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg3);
    ...
    public fun bootstrap_v7(arg0: &mut 0x2::tx_context::TxContext) {
        abort 223
    }

    public fun bootstrap_v8(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::tx_context::sender(arg1);
    ...
    public fun cancel_admin_transfer(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun cancel_delay_change(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        assert!(0x1::option::is_some<PendingDelayChange>(&arg0.pending_delay_change), 209);
        let PendingDelayChange {
            new_delay_ms         : v0,
    ...
    public fun cap_v3_day_reset_at_ms<T0>(arg0: &AutoSwapCapV3<T0>) : u64 {
        arg0.day_reset_at_ms
    }

    public fun cap_v3_expires_at_ms<T0>(arg0: &AutoSwapCapV3<T0>) : u64 {
        arg0.expires_at_ms
    }

    public fun cap_v3_max_per_day<T0>(arg0: &AutoSwapCapV3<T0>) : u64 {
        arg0.max_per_day
    }

    public fun cap_v3_max_per_swap<T0>(arg0: &AutoSwapCapV3<T0>) : u64 {
        arg0.max_per_swap
    }

    public fun cap_v3_owner<T0>(arg0: &AutoSwapCapV3<T0>) : address {
        arg0.owner
    }

    public fun cap_v3_paused<T0>(arg0: &AutoSwapCapV3<T0>) : bool {
        arg0.paused
    }

    public fun cap_v3_registry<T0>(arg0: &AutoSwapCapV3<T0>) : 0x2::object::ID {
        arg0.registry_id
    }

    public fun cap_v3_used_today<T0>(arg0: &AutoSwapCapV3<T0>) : u64 {
        arg0.used_today
    }

    public fun cap_v3_vault<T0>(arg0: &AutoSwapCapV3<T0>) : 0x2::object::ID {
        arg0.vault_id
    }

    public fun cap_v4_day_reset_at_ms<T0>(arg0: &AutoSwapCapV4<T0>) : u64 {
        arg0.day_reset_at_ms
    }

    public fun cap_v4_expires_at_ms<T0>(arg0: &AutoSwapCapV4<T0>) : u64 {
        arg0.expires_at_ms
    }

    public fun cap_v4_max_per_day<T0>(arg0: &AutoSwapCapV4<T0>) : u64 {
        arg0.max_per_day
    }

    public fun cap_v4_max_per_swap<T0>(arg0: &AutoSwapCapV4<T0>) : u64 {
        arg0.max_per_swap
    }

    public fun cap_v4_min_rate_den<T0>(arg0: &AutoSwapCapV4<T0>) : u64 {
        arg0.min_rate_den
    }

    public fun cap_v4_min_rate_num<T0>(arg0: &AutoSwapCapV4<T0>) : u64 {
        arg0.min_rate_num
    }

    public fun cap_v4_owner<T0>(arg0: &AutoSwapCapV4<T0>) : address {
        arg0.owner
    }

    public fun cap_v4_paused<T0>(arg0: &AutoSwapCapV4<T0>) : bool {
        arg0.paused
    }

    public fun cap_v4_registry<T0>(arg0: &AutoSwapCapV4<T0>) : 0x2::object::ID {
        arg0.registry_id
    }

    public fun cap_v4_used_today<T0>(arg0: &AutoSwapCapV4<T0>) : u64 {
        arg0.used_today
    }

    public fun cap_v4_vault<T0>(arg0: &AutoSwapCapV4<T0>) : 0x2::object::ID {
        arg0.vault_id
    }
    ...
    public fun disable<T0>(arg0: AutoSwapCap<T0>, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun grant_oncall(arg0: &mut AutoSwapRegistryV2, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
    ...
    public fun grant_treasury(arg0: &mut AutoSwapRegistryV2, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
    ...
    public fun grant_worker(arg0: &mut AutoSwapRegistryV2, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
    ...
    public(friend) fun new_cap_v3<T0>(arg0: &AutoSwapRegistryV2, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : AutoSwapCapV3<T0> {
        assert!(arg3 > 0, 104);
        assert!(arg4 > 0, 214);
        assert!(arg4 >= arg3, 214);
        let v0 = AutoSwapCapV3<T0>{
            id              : 0x2::object::new(arg7),
            registry_id     : 0x2::object::id<AutoSwapRegistryV2>(arg0),
            vault_id        : arg1,
            owner           : arg2,
            max_per_swap    : arg3,
            expires_at_ms   : arg5,
            ...
            max_per_day     : arg4,
            used_today      : 0,
            day_reset_at_ms : 0x2::clock::timestamp_ms(arg6) + 86400000,
        };
        let v1 = AutoSwapEnabled{
            owner         : arg2,
            vault_id      : arg1,
            cap_id        : 0x2::object::id<AutoSwapCapV3<T0>>(&v0),
            coin_type     : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())),
            max_per_swap  : arg3,
            expires_at_ms : arg5,
        };
    ...
    public(friend) fun new_cap_v4<T0>(arg0: &AutoSwapRegistryV2, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : AutoSwapCapV4<T0> {
        assert!(arg3 > 0, 104);
        assert!(arg4 > 0, 214);
        assert!(arg4 >= arg3, 214);
        assert_rate_floor(arg6, arg7);
        let v0 = AutoSwapCapV4<T0>{
            ...
            max_per_day     : arg4,
            used_today      : 0,
            day_reset_at_ms : 0x2::clock::timestamp_ms(arg8) + 86400000,
            min_rate_num    : arg6,
            min_rate_den    : arg7,
        };
        let v1 = AutoSwapV4Enabled{
            owner         : arg2,
            registry_id   : v0.registry_id,
            vault_id      : arg1,
            cap_id        : 0x2::object::id<AutoSwapCapV4<T0>>(&v0),
            coin_type     : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())),
            max_per_swap  : arg3,
            max_per_day   : arg4,
            expires_at_ms : arg5,
        ...
        0x2::event::emit<AutoSwapV4Enabled>(v1);
        v0
    }

    public fun pause<T0>(arg0: &mut AutoSwapCap<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        arg0.paused = true;
    ...
    public fun pause_registry(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun pause_v2<T0>(arg0: &mut AutoSwapCapV2<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        assert!(!arg0.paused, 222);
        arg0.paused = true;
        let v0 = AutoSwapPaused{
            owner  : arg0.owner,
            cap_id : 0x2::object::id<AutoSwapCapV2<T0>>(arg0),
            paused : true,
        };
        0x2::event::emit<AutoSwapPaused>(v0);
    }

    public fun pause_v3<T0>(arg0: &mut AutoSwapCapV3<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        assert!(!arg0.paused, 222);
        arg0.paused = true;
        let v0 = AutoSwapPaused{
            owner  : arg0.owner,
            cap_id : 0x2::object::id<AutoSwapCapV3<T0>>(arg0),
            paused : true,
        };
        0x2::event::emit<AutoSwapPaused>(v0);
    }

    public fun pause_v4<T0>(arg0: &mut AutoSwapCapV4<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        assert!(!arg0.paused, 222);
        arg0.paused = true;
        let v0 = AutoSwapPaused{
            owner  : arg0.owner,
            cap_id : 0x2::object::id<AutoSwapCapV4<T0>>(arg0),
            paused : true,
        };
        0x2::event::emit<AutoSwapPaused>(v0);
    }

    public fun remove_allowed_dest<T0>(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::tx_context::TxContext) {
        assert_admin_or_treasury(arg0, arg1);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun remove_allowed_provider(arg0: &mut AutoSwapRegistryV2, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        assert_admin_or_treasury(arg0, arg2);
    ...
    public fun resume<T0>(arg0: &mut AutoSwapCap<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        arg0.paused = false;
        let v0 = AutoSwapPaused{
            owner  : arg0.owner,
    ...
    public fun resume_v2<T0>(arg0: &mut AutoSwapCapV2<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        assert!(arg0.paused, 222);
        arg0.paused = false;
        let v0 = AutoSwapPaused{
    ...
    public fun resume_v3<T0>(arg0: &mut AutoSwapCapV3<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        assert!(arg0.paused, 222);
        arg0.paused = false;
        let v0 = AutoSwapPaused{
    ...
    public fun resume_v4<T0>(arg0: &mut AutoSwapCapV4<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 106);
        assert!(arg0.paused, 222);
        arg0.paused = false;
        let v0 = AutoSwapPaused{
    ...
    public fun revoke_oncall(arg0: &mut AutoSwapRegistryV2, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
    ...
    public fun revoke_treasury(arg0: &mut AutoSwapRegistryV2, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
    ...
    public fun revoke_worker(arg0: &mut AutoSwapRegistryV2, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg2);
    ...
    public fun unpause_registry(arg0: &mut AutoSwapRegistryV2, arg1: &0x2::tx_context::TxContext) {
        assert_admin_or_oncall(arg0, arg1);
        arg0.paused = false;
    ...
    public fun update_bounds<T0>(arg0: &mut AutoSwapCap<T0>, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun update_bounds_v2<T0>(arg0: &mut AutoSwapCapV2<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 106);
        assert!(arg1 > 0, 104);
        assert!(arg2 > 0, 214);
        assert!(arg2 >= arg1, 214);
        let v0 = if (arg1 != arg0.max_per_swap) {
            true
        } else if (arg2 != arg0.max_per_day) {
            true
        } else {
            arg3 != arg0.expires_at_ms
        };
        assert!(v0, 222);
        arg0.max_per_swap = arg1;
        arg0.max_per_day = arg2;
        arg0.expires_at_ms = arg3;
        let v1 = AutoSwapBoundsUpdated{
            owner             : arg0.owner,
            cap_id            : 0x2::object::id<AutoSwapCapV2<T0>>(arg0),
            old_max_per_swap  : arg0.max_per_swap,
            new_max_per_swap  : arg1,
            old_max_per_day   : arg0.max_per_day,
            new_max_per_day   : arg2,
            old_expires_at_ms : arg0.expires_at_ms,
            new_expires_at_ms : arg3,
        };
        0x2::event::emit<AutoSwapBoundsUpdated>(v1);
    }

    public fun update_bounds_v3<T0>(arg0: &mut AutoSwapCapV3<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 106);
        assert!(arg1 > 0, 104);
        assert!(arg2 > 0, 214);
        assert!(arg2 >= arg1, 214);
    ...
    public fun update_bounds_v4<T0>(arg0: &mut AutoSwapCapV4<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 106);
        assert!(arg1 > 0, 104);
        assert!(arg2 > 0, 214);
        assert!(arg2 >= arg1, 214);
    ...
    public fun update_rate_floor_v4<T0>(arg0: &mut AutoSwapCapV4<T0>, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.owner, 106);
        assert_rate_floor(arg1, arg2);
        assert!(arg1 != arg0.min_rate_num || arg2 != arg0.min_rate_den, 222);
        arg0.min_rate_num = arg1;
        arg0.min_rate_den = arg2;
        let v0 = AutoSwapRateFloorUpdated{
            owner            : arg0.owner,
            cap_id           : 0x2::object::id<AutoSwapCapV4<T0>>(arg0),
            old_min_rate_num : arg0.min_rate_num,
            old_min_rate_den : arg0.min_rate_den,
            new_min_rate_num : arg1,
            new_min_rate_den : arg2,
        };
        0x2::event::emit<AutoSwapRateFloorUpdated>(v0);
    }

    public fun upgrade_cap_to_v2<T0>(arg0: AutoSwapCap<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.owner, 106);
        assert!(arg1 > 0, 214);
    ...
    public(friend) fun validate_for_swap_v3<T0>(arg0: &mut AutoSwapRegistryV2, arg1: &mut AutoSwapCapV3<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::object::id<AutoSwapRegistryV2>(arg0) == arg1.registry_id, 221);
        assert!(!arg0.paused, 204);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x1::vector::contains<address>(&arg0.worker_addresses, &v0), 203);
        assert!(!arg1.paused, 100);
        ...
        arg1.used_today = v2;
        arg0.total_validations = arg0.total_validations + 1;
        let v3 = AutoSwapV3Validated{
            registry_id      : arg1.registry_id,
            vault_id         : arg1.vault_id,
            cap_id           : 0x2::object::id<AutoSwapCapV3<T0>>(arg1),
            amount           : arg2,
            used_today_after : arg1.used_today,
            day_reset_at_ms  : arg1.day_reset_at_ms,
            coin_type        : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())),
        };
        0x2::event::emit<AutoSwapV3Validated>(v3);
    }

    public(friend) fun validate_for_swap_v4<T0>(arg0: &mut AutoSwapRegistryV2, arg1: &mut AutoSwapCapV4<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(0x2::object::id<AutoSwapRegistryV2>(arg0) == arg1.registry_id, 221);
        assert!(!arg0.paused, 204);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x1::vector::contains<address>(&arg0.worker_addresses, &v0), 203);
        ...
        let v3 = AutoSwapV3Validated{
            registry_id      : arg1.registry_id,
            vault_id         : arg1.vault_id,
            cap_id           : 0x2::object::id<AutoSwapCapV4<T0>>(arg1),
            amount           : arg2,
            used_today_after : arg1.used_today,
            day_reset_at_ms  : arg1.day_reset_at_ms,
            coin_type        : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())),
