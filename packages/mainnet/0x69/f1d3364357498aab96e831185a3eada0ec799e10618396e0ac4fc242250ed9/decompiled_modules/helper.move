module 0x69f1d3364357498aab96e831185a3eada0ec799e10618396e0ac4fc242250ed9::helper {
    public fun calculate_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        let v4 = if (v2 == 0) {
            (0xe877cd72b0e6c9113789e1fe113eb7dfce8355fcb606ac351112556c0b361a7b::math::mul_div_u256((arg2 as u256), (0xe877cd72b0e6c9113789e1fe113eb7dfce8355fcb606ac351112556c0b361a7b::math::mul_to_u128(get_sui_amount(&v3), 1) as u256), (0xe877cd72b0e6c9113789e1fe113eb7dfce8355fcb606ac351112556c0b361a7b::math::mul_to_u128(1, get_token_amount(&v3)) as u256)) as u64)
        } else {
            (0xe877cd72b0e6c9113789e1fe113eb7dfce8355fcb606ac351112556c0b361a7b::math::mul_div_u256((arg2 as u256), (0xe877cd72b0e6c9113789e1fe113eb7dfce8355fcb606ac351112556c0b361a7b::math::mul_to_u128(get_sui_amount(&v3), get_token_amount(&v1)) as u256), (0xe877cd72b0e6c9113789e1fe113eb7dfce8355fcb606ac351112556c0b361a7b::math::mul_to_u128(v2, get_token_amount(&v3)) as u256)) as u64)
        };
        v4 - arg2
    }
