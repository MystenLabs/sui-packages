module 0x697582cae5be0393b0d19926fcb064241028ad7df1baf9e1ffea04678a7dd1b4::reward1158 {
    struct REWARD1158 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward1158(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD1158, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1158>(arg0, arg1);
