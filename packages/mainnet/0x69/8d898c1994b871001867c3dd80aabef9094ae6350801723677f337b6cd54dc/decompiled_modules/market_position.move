module 0x698d898c1994b871001867c3dd80aabef9094ae6350801723677f337b6cd54dc::market_position {
    ...
    public(friend) fun update_lp_display<T0: drop>(arg0: &mut MarketPosition, arg1: &0x698d898c1994b871001867c3dd80aabef9094ae6350801723677f337b6cd54dc::py::PyState<T0>) {
        let v0 = 9;
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(0x698d898c1994b871001867c3dd80aabef9094ae6350801723677f337b6cd54dc::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>())) {
            v0 = *0x2::dynamic_field::borrow<0x1::type_name::TypeName, u8>(0x698d898c1994b871001867c3dd80aabef9094ae6350801723677f337b6cd54dc::py::get_state_id<T0>(arg1), 0x1::type_name::get<T0>());
        };
