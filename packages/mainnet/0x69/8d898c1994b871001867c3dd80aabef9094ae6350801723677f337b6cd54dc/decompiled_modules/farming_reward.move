module 0x698d898c1994b871001867c3dd80aabef9094ae6350801723677f337b6cd54dc::farming_reward {
    ...
    public(friend) fun update_rewarder<T0: drop>(arg0: &mut RewardPool, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::type_name::get<T0>() == v0.reward_token, 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::reward_token_type_mismatch());
