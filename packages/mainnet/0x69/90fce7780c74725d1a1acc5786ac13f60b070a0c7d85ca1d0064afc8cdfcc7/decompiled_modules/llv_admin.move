module 0x6990fce7780c74725d1a1acc5786ac13f60b070a0c7d85ca1d0064afc8cdfcc7::llv_admin {
    ...
    public(friend) fun migrate(arg0: &mut LLVGlobal, arg1: &0x2::tx_context::TxContext) {
        ...
        arg0.version = 1;
        0x6990fce7780c74725d1a1acc5786ac13f60b070a0c7d85ca1d0064afc8cdfcc7::llv_events::emit_global_migrated(arg0.version);
    }
    ...
    public(friend) fun set_global_paused(arg0: &mut LLVGlobal, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        arg0.paused = arg1;
        0x6990fce7780c74725d1a1acc5786ac13f60b070a0c7d85ca1d0064afc8cdfcc7::llv_events::emit_global_paused(arg1);
    }
    ...
    public(friend) fun set_owner(arg0: &mut LLVGlobal, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 3);
        arg0.owner = arg1;
        0x6990fce7780c74725d1a1acc5786ac13f60b070a0c7d85ca1d0064afc8cdfcc7::llv_events::emit_owner_changed(arg0.owner, arg1);
    }
