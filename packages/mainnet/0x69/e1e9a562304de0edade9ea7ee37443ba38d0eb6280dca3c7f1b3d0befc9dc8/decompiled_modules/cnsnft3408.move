module 0x69e1e9a562304de0edade9ea7ee37443ba38d0eb6280dca3c7f1b3d0befc9dc8::cnsnft3408 {
    struct CNSNFT3408 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3408, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTRU2LVfvwnEAZceKHWq2ZqZaJWjcNtV2Bqi2hkhVDpvB?ref=1676"));
        let v4 = 0x2::package::claim<CNSNFT3408>(arg0, arg1);
