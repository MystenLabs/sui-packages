module 0x69708b3a14cf2a1b541ec69708d46bbcafe6cd246ac9acc2d0a05bb2201f6d03::cnsnft4498 {
    struct CNSNFT4498 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4498, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4498>(arg0, arg1);
