module 0x69fb0270d7f988c90ca8926edb05189a0c2be60423e280b6a01591db282479f7::IDO {
    ...
    public entry fun claim_subscription<T0>(arg0: &mut IDO<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.whitelist_funded_amount + arg0.subscription_funded_amount <= arg0.hard_cap) {
            ...
            let v3 = *v0 * 20000 * (800000000000000 as u128) * 1000000000 / (arg0.subscription_funded_amount as u128) * 1000 * 1000000000;
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_balance, ((*v0 - *v0 * (800000000000000 as u128) / (arg0.subscription_funded_amount as u128)) as u64)), arg2), 0x2::tx_context::sender(arg2));
