module 0x698786c6439d4eb3f1fe7f97f17aceaf33b6333900eeeb4b8b908e118b28c5b9::reward3124 {
    struct REWARD3124 has drop {
        dummy_field: bool,
    }

    struct TICKET_3124 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3124(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3124>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3124>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3124, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3124>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3124>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3124>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3124>>(v5, 0x2::tx_context::sender(arg1));
    }
