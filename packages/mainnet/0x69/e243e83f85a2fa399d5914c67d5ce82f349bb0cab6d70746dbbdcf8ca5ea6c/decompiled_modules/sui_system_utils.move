module 0xda6c40dac49910d172705418d578d7d14af0fa6ef488538ef0dbdeaebad5d551::sui_system_utils {
    ...
    public fun pool_token_exchange_rate_at_epoch(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64) : 0x3::staking_pool::PoolTokenExchangeRate {
        ...
        let v5 = v3 - 1;
        if (0x2::table::contains<u64, 0x3::staking_pool::PoolTokenExchangeRate>(v2, v5)) {
            return *0x2::table::borrow<u64, 0x3::staking_pool::PoolTokenExchangeRate>(v2, v5)
        } else {
            while (v5 >= 0) {
                let v6 = v5 - 1;
                v5 = v6;
                if (0x2::table::contains<u64, 0x3::staking_pool::PoolTokenExchangeRate>(v2, v6)) {
                    return *0x2::table::borrow<u64, 0x3::staking_pool::PoolTokenExchangeRate>(v2, v6)
                };
            };
            abort 9223372865783529474
        };
    }
