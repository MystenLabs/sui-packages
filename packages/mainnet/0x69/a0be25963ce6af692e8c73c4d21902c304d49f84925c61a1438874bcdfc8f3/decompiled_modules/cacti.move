module 0x69a0be25963ce6af692e8c73c4d21902c304d49f84925c61a1438874bcdfc8f3::cacti {
    ...
    fun init(arg0: CACTI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CACTI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"cacti"));
