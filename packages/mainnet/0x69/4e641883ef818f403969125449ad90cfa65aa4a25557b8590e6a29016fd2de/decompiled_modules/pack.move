module 0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::pack {
    ...
    public fun burn(arg0: Pack, arg1: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = PackBurned{
    ...
    public fun increment_version(arg0: &mut PackTokenPool, arg1: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::PackerCap) {
    ...
    public fun mint(arg0: 0x2::object::ID, arg1: vector<vector<u8>>, arg2: vector<u16>, arg3: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::PackMinterCap, arg4: &mut 0x2::tx_context::TxContext) : Pack {
    ...
    public fun new_pack_token_pool(arg0: u8, arg1: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::PackerCap, arg2: &mut 0x2::tx_context::TxContext) : 0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::uniqueidset::UniqueIdSet {
        assert!(arg0 < 16, 771);
        assert!(arg0 > 0, 781);
        ...
        0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::uniqueidset::new_set(arg2)
    }
    ...
    entry fun open_pack(arg0: &mut PackTokenPool, arg1: Pack, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg0.group_count) {
            ...
            0x1::vector::push_back<0x2::object::ID>(&mut v2, 0x2::object::id<0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token>(&v4));
            0x2::transfer::public_transfer<0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token>(v4, 0x2::tx_context::sender(arg3));
            v0 = v0 + 1;
        };
        let v5 = PackOpened{
    ...
    public fun receive_object_for_pool(arg0: &mut PackTokenPool, arg1: 0x2::transfer::Receiving<0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token>, arg2: u8, arg3: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::PackerCap) {
        assert!(arg0.version == 0, 780);
        ...
        *v0 = *v0 + 1;
        0x2::dynamic_object_field::add<0x1::string::String, 0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token>(&mut arg0.id, build_token_dynamic_field_name(arg2, *v0), 0x2::transfer::public_receive<0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token>(&mut arg0.id, arg1));
    ...
    public fun set_pool_open(arg0: &mut PackTokenPool, arg1: bool, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::PackerCap) {
        assert!(arg0.version == 0, 780);
    ...
    public fun update_description(arg0: &mut Pack, arg1: vector<u8>, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
        arg0.description = 0x1::string::utf8(arg1);
    }

    public fun update_edition_number(arg0: &mut Pack, arg1: u16, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
        arg0.edition_number = arg1;
    }

    public fun update_name(arg0: &mut Pack, arg1: vector<u8>, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
        arg0.name = 0x1::string::utf8(arg1);
    }

    public fun update_preview_image(arg0: &mut Pack, arg1: vector<u8>, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
        arg0.preview_image = 0x2::url::new_unsafe_from_bytes(arg1);
    }

    public fun update_rarity(arg0: &mut Pack, arg1: vector<u8>, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
        arg0.rarity = 0x1::string::utf8(arg1);
    }

    public fun update_set(arg0: &mut Pack, arg1: vector<u8>, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
        arg0.set = 0x1::string::utf8(arg1);
    }

    public fun update_total_editions(arg0: &mut Pack, arg1: u16, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
        arg0.total_editions = arg1;
    }

    public fun update_uri(arg0: &mut Pack, arg1: vector<u8>, arg2: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::AdminCap) {
    ...
    fun withdraw_random_token_from_group(arg0: &mut PackTokenPool, arg1: u8, arg2: &mut 0x2::random::RandomGenerator) : 0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token {
        ...
        0x2::dynamic_object_field::remove<0x1::string::String, 0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token>(&mut arg0.id, build_token_dynamic_field_name(arg1, v3))
    }

    entry fun withdraw_token(arg0: &mut PackTokenPool, arg1: u8, arg2: &0x2::random::Random, arg3: &0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::caps::PackerCap, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 780);
        assert!(arg0.opening_enabled == false, 779);
        assert!(arg1 < arg0.group_count, 775);
        let v0 = 0x2::random::new_generator(arg2, arg4);
        let v1 = &mut v0;
        0x2::transfer::public_transfer<0x694e641883ef818f403969125449ad90cfa65aa4a25557b8590e6a29016fd2de::token::Token>(withdraw_random_token_from_group(arg0, arg1, v1), 0x2::tx_context::sender(arg4));
    }
