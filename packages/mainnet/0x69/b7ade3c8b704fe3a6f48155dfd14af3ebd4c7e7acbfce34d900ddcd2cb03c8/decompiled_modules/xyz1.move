module 0x69b7ade3c8b704fe3a6f48155dfd14af3ebd4c7e7acbfce34d900ddcd2cb03c8::xyz1 {
    struct XYZ1 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: XYZ1, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<XYZ1>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"xyz1"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"xyz1 "));
