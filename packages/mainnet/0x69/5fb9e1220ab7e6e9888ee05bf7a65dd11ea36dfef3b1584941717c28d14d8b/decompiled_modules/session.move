module 0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::session {
    ...
    public fun authorize(arg0: &mut SessionKey, arg1: &0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::PolicyRegistry, arg2: &0x2::clock::Clock, arg3: vector<PriceFeedInput>, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) : RebalanceProof {
        0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::version::assert_is_current(0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::version_of(arg1));
        0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::assert_not_revoked(arg1, 0x2::object::id<SessionKey>(arg0));
    ...
    public fun consume_proof(arg0: RebalanceProof) {
        ...
        assert!(v2 >= 0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::math::bps_of_ceil(v1, 10000 - v3), 8);
    ...
    public fun read_price<T0>(arg0: &0x2::coin_registry::Currency<T0>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::PolicyRegistry) : PriceFeedInput {
        ...
        assert!(0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::expected_feed_id(arg3, v0) == 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2), 1);
        ...
        let v8 = 0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::math::price_from_pyth(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v4), v6, v7);
        let v9 = 0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::math::price_from_pyth(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v3), v6, v7);
        let v10 = if (v8 > v9) {
            v8 - v9
        } else {
            0
    ...
    public fun revoke_session_key(arg0: &mut 0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::PolicyRegistry, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == 0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::owner_of(arg0, arg1) || 0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::is_admin(arg0, v0), 10);
        0x695fb9e1220ab7e6e9888ee05bf7a65dd11ea36dfef3b1584941717c28d14d8b::policy::mark_revoked(arg0, arg1);
