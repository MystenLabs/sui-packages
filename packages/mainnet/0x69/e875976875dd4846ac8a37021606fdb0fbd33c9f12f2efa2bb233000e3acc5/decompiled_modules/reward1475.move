module 0x69e875976875dd4846ac8a37021606fdb0fbd33c9f12f2efa2bb233000e3acc5::reward1475 {
    struct REWARD1475 has drop {
        dummy_field: bool,
    }

    struct TICKET_1475 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1475(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1475>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1475>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1475, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1475>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1475>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1475>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1475>>(v5, 0x2::tx_context::sender(arg1));
    }
