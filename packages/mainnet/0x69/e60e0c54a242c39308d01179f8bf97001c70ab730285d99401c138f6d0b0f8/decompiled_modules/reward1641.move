module 0x69e60e0c54a242c39308d01179f8bf97001c70ab730285d99401c138f6d0b0f8::reward1641 {
    struct REWARD1641 has drop {
        dummy_field: bool,
    }

    struct TICKET_1641 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1641(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1641>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1641>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1641, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1641>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1641>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1641>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1641>>(v5, 0x2::tx_context::sender(arg1));
    }
