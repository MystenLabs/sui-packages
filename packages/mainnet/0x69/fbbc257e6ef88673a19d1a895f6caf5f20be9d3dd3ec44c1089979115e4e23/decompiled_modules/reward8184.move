module 0x69fbbc257e6ef88673a19d1a895f6caf5f20be9d3dd3ec44c1089979115e4e23::reward8184 {
    struct REWARD8184 has drop {
        dummy_field: bool,
    }

    struct TICKET_8184 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8184(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8184>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8184>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8184>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8184>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8184>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8184>>(v5, 0x2::tx_context::sender(arg1));
    }
