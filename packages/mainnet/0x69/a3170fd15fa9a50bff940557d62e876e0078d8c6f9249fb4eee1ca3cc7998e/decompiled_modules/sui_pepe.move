module 0x69a3170fd15fa9a50bff940557d62e876e0078d8c6f9249fb4eee1ca3cc7998e::sui_pepe {
    ...
    fun init(arg0: SUI_PEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_PEPE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI PEPE"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SUI PEPE "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiekdxr72fws6bwhnismvlrdp44ngmgvpjerl5f45hiygeadbf36hi"));
