module 0x69408eaff749969240481491b2477b25fa783006a30df1856c6125b5ac2c508c::icy_vibe {
    ...
    fun init(arg0: ICY_VIBE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ICY_VIBE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Icy Vibe"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://rM83VBmTKxR4JXZSXmpCF--F3roLHErEC-VrYG7SnH4"));
