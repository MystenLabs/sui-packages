module 0x690d19e0f0587be042426904ec2b2189e3f27380a3479bf862f9875a08bf13dd::zo_mm {
    ...
    public fun l4m8n0(arg0: Config) {
        let Config {
            id                   : v0,
            owner                : _,
            order_size           : _,
            profit_threshold_bps : _,
            enabled              : _,
        } = arg0;
    ...
    public fun p4q8r3(arg0: &mut 0x2::tx_context::TxContext) {
