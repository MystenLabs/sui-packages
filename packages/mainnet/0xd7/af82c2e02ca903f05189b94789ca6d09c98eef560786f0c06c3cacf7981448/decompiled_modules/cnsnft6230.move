module 0xd7af82c2e02ca903f05189b94789ca6d09c98eef560786f0c06c3cacf7981448::cnsnft6230 {
    struct CNSNFT6230 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6230, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6230>(arg0, arg1);
