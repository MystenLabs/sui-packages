module 0xd7e9b65124cc321261d2de48a29ac941151025969240f7902ed3ef8d8123eb4d::reward3355 {
    struct REWARD3355 has drop {
        dummy_field: bool,
    }

    struct TICKET_3355 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3355(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3355>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3355>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3355, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3355>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3355>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3355>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3355>>(v5, 0x2::tx_context::sender(arg1));
    }
