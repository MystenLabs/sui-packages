module 0xd7c82cde4ad36490b5a96a1a3f4691d5b19a186bca4ae73194fc281e3cd14328::KITTY {
    ...
    fun init(arg0: KITTY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<KITTY>(arg0, 9, b"TRUMP", b"Kitty Trump", b"Kitty honey millions $$$", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
