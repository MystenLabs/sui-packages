module 0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::treasury {
    ...
    public fun accept_admin_transfer<T0>(arg0: &mut Treasury<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::events::emit_admin_transfer_accepted(arg0.admin, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun collect_fee<T0>(arg0: &mut Treasury<T0>, arg1: &0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::core::Config, arg2: &mut 0x2::coin::Coin<T0>, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert_version<T0>(arg0);
        ...
        assert!(v0 > 0, 2);
        let v1 = (((v0 as u128) * (0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::core::fee_rate(arg1, arg3) as u128) / 10000) as u64);
        if (v1 > 0) {
            ...
            0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::events::emit_fee_collected(0x2::tx_context::sender(arg4), arg3, v1, v0);
        };
        v1
    }
    ...
    public fun propose_admin_transfer<T0>(arg0: &mut Treasury<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::events::emit_admin_transfer_proposed(0x2::tx_context::sender(arg2), arg1);
    }

    public fun receive_coins<T0>(arg0: &mut Treasury<T0>, arg1: &0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::core::AdminCap, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>) {
        assert_version<T0>(arg0);
        ...
        arg0.total_collected = arg0.total_collected + 0x2::coin::value<T0>(&v0);
    }
    ...
    public fun withdraw_fees<T0>(arg0: &mut Treasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xd775fcc66eae26797654d435d751dea56b82eeb999de51fd285348e573b968ad::events::emit_fees_withdrawn(arg1, 0x2::tx_context::sender(arg2), arg0.total_withdrawn);
