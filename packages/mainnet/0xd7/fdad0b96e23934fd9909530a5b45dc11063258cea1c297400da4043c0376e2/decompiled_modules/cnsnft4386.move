module 0xd7fdad0b96e23934fd9909530a5b45dc11063258cea1c297400da4043c0376e2::cnsnft4386 {
    struct CNSNFT4386 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4386, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4386>(arg0, arg1);
