module 0xd79cde6c85b8df9116a8704dfae0904c76e9600c4c9e711aae7c6a004349f02a::jwlsui {
    ...
    fun init(arg0: JWLSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<JWLSUI>(arg0, 9, b"JWLSUI", b"JWLSUI", b"JWLSUI is a stablecoin pegged to SUI and minted with SUI 1:1. Brought to you by JewelSwap.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/20947.png")), arg1);
