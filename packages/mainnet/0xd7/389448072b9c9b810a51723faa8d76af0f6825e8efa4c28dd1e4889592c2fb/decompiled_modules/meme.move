module 0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::meme {
    ...
    public fun change_configurator_admin(arg0: &0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::admin::AdminCap, arg1: &mut Configurator, arg2: address) {
        arg1.admin = arg2;
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Configurator{
            ...
            creator_reward    : 21,
            total_fees        : 0,
            config_id         : 0x2::object::id_from_address(@0x9774e359588ead122af1c7e7f64e14ade261cfeecdb5d0eb4a5b3b4c8ab8bd3e),
            pools_id          : 0x2::object::id_from_address(@0x50eb61dd5928cec5ea04711a2e9b72e5237e79e9fbcd2ce3d5469dc8708e0ee2),
            burn_manager_id   : 0x2::object::id_from_address(@0xd04529ef15b7dad6699ee905daca0698858cab49724b2b2a1fc6b1ebc5e474ef),
    ...
    public fun list<T0>(arg0: &mut Configurator, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::freeze::freeze_object<0x2::coin::TreasuryCap<T0>>(arg1, arg6);
    ...
    public fun sell<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut Configurator, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(v11 > 0 && v12 > 0, 5);
        0x2::coin::from_balance<0x2::sui::SUI>(v6, arg4)
    }

    public fun update_creator_reward(arg0: &0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.creator_reward = arg2;
    }

    public fun update_dex_ids(arg0: &0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::admin::AdminCap, arg1: &mut Configurator, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x2::object::ID) {
        arg1.config_id = arg2;
        arg1.pools_id = arg3;
        arg1.burn_manager_id = arg4;
    }

    public fun update_graduation_fee(arg0: &0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.graduation_fee = arg2;
    }

    public fun update_listing_fee(arg0: &0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.listing_fee = arg2;
    }

    public fun update_swap_fee(arg0: &0xd7389448072b9c9b810a51723faa8d76af0f6825e8efa4c28dd1e4889592c2fb::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.swap_fee = arg2;
    }
