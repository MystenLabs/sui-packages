module 0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::cetus {
    ...
    public fun rebalance_claim_batch_swap_to_x<T0, T1, T2>(arg0: &mut RebalanceReceipt<T0, T1>, arg1: &mut 0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwap<T2, T0>) {
        let v0 = 0x1::vector::length<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&arg0.batch_swap_to_x) - 1;
        while (v0 >= 0) {
            let (v1, v2) = 0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::claim_if_matches<T2, T0>(arg1, 0x1::vector::swap_remove<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&mut arg0.batch_swap_to_x, v0));
            0x2::balance::join<T0>(&mut arg0.collected_x, v1);
            let v3 = v2;
            if (0x1::option::is_some<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&v3)) {
                0x1::vector::push_back<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&mut arg0.batch_swap_to_x, 0x1::option::destroy_some<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(v3));
                continue
            };
            0x1::option::destroy_none<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(v3);
        };
    }
    ...
    public fun rebalance_claim_batch_swap_to_y<T0, T1, T2>(arg0: &mut RebalanceReceipt<T0, T1>, arg1: &mut 0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwap<T2, T1>) {
        let v0 = 0x1::vector::length<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&arg0.batch_swap_to_y) - 1;
        while (v0 >= 0) {
            let (v1, v2) = 0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::claim_if_matches<T2, T1>(arg1, 0x1::vector::swap_remove<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&mut arg0.batch_swap_to_y, v0));
            0x2::balance::join<T1>(&mut arg0.collected_y, v1);
            let v3 = v2;
            if (0x1::option::is_some<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&v3)) {
                0x1::vector::push_back<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(&mut arg0.batch_swap_to_y, 0x1::option::destroy_some<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(v3));
                continue
            };
            0x1::option::destroy_none<0x1e8e36d73a53f7eaeba0d9913714c4727b6b667eede79ea2d5c7af14fa94d2a4::batch_swap::BatchSwapClaim>(v3);
        };
