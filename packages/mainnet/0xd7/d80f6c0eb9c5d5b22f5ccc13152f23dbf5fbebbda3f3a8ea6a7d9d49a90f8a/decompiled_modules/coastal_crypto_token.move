module 0xd7d80f6c0eb9c5d5b22f5ccc13152f23dbf5fbebbda3f3a8ea6a7d9d49a90f8a::coastal_crypto_token {
    ...
    public entry fun mint(arg0: &AdminCap, arg1: &mut 0x2::coin::TreasuryCap<COASTAL_CRYPTO_TOKEN>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 1);
        assert!(0x2::coin::total_supply<COASTAL_CRYPTO_TOKEN>(arg1) + arg2 <= 100000000000000000, 0);
    ...
    fun init(arg0: COASTAL_CRYPTO_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COASTAL_CRYPTO_TOKEN>(arg0, 9, b"COASTAL CRYPTO TOKEN", b"CCT", b"coastal crypto description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://scarlet-visual-gopher-984.mypinata.cloud/ipfs/bafybeie5whghfxteehmbfxee3gaixjiare6gprjwwrgstzf4i3lodiqhie")), arg1);
