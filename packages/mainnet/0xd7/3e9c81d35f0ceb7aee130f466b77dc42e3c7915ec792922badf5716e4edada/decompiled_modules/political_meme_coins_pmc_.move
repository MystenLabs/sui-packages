module 0xd73e9c81d35f0ceb7aee130f466b77dc42e3c7915ec792922badf5716e4edada::political_meme_coins_pmc_ {
    struct POLITICAL_MEME_COINS_PMC_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"ada07d23-f87e-4d5d-aff1-89db939b487b"),
        };
    ...
    fun init(arg0: POLITICAL_MEME_COINS_PMC_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<POLITICAL_MEME_COINS_PMC_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Political_Meme_Coins(PMC)"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Collection of political meme coins."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmaNTBCekDqvtdB9htk18vGrzcui359JZ5j1DJYg1xhe3a"));
