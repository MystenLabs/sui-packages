module 0xd74b5b515af3a1be97f832adf1f021bb2b7223168b8b7f77114f15da44eb21f5::cnsnft9606 {
    struct CNSNFT9606 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9606, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9606>(arg0, arg1);
