module 0xd7315641d566b4883ba5f44930df31a1d98f189c5adc1cbe81e96dff92ec938b::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xd7315641d566b4883ba5f44930df31a1d98f189c5adc1cbe81e96dff92ec938b::royalty_policy::new_royalty_policy<Item>(&v6, 200, arg1);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Item>>(v8);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Item>>(v9, 0x2::tx_context::sender(arg1));
        let (v10, v11) = 0x2::kiosk::new(arg1);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v10);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v11, 0x2::tx_context::sender(arg1));
    ...
    public entry fun mint(arg0: u8, arg1: u8, arg2: vector<u8>, arg3: &mut Storage, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(verifyMintSignature(arg3.package, 0x2::tx_context::sender(arg4), arg0, arg1, arg3.signer, arg2), 9223372492121636870);
        let v0 = Item{
    ...
    fun verifyMintSignature(arg0: address, arg1: address, arg2: u8, arg3: u8, arg4: vector<u8>, arg5: vector<u8>) : bool {
        ...
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0xd7315641d566b4883ba5f44930df31a1d98f189c5adc1cbe81e96dff92ec938b::string::u8_to_string(arg2));
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0xd7315641d566b4883ba5f44930df31a1d98f189c5adc1cbe81e96dff92ec938b::string::u8_to_string(arg3));
