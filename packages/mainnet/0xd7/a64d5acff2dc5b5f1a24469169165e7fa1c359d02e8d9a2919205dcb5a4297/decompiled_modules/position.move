module 0xd7a64d5acff2dc5b5f1a24469169165e7fa1c359d02e8d9a2919205dcb5a4297::position {
    ...
    public(friend) fun check_position_cap_matches<T0>(arg0: &Position<T0>, arg1: &PositionCap) {
        assert!(0x2::object::id<Position<T0>>(arg0) == arg1.position_id, 0xd7a64d5acff2dc5b5f1a24469169165e7fa1c359d02e8d9a2919205dcb5a4297::errors::err_position_cap_not_match());
    }
    ...
    public(friend) fun destroy_position<T0>(arg0: Position<T0>, arg1: &0xd7a64d5acff2dc5b5f1a24469169165e7fa1c359d02e8d9a2919205dcb5a4297::config::GlobalConfig) {
        let Position {
            id                   : v0,
            is_long              : _,
        ...
        0x2::transfer::public_transfer<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(v2, 0xd7a64d5acff2dc5b5f1a24469169165e7fa1c359d02e8d9a2919205dcb5a4297::config::collect_obligation_owner_cap_address(arg1));
    }
    ...
    public fun position_id(arg0: &PositionCap) : 0x2::object::ID {
        arg0.position_id
    }
