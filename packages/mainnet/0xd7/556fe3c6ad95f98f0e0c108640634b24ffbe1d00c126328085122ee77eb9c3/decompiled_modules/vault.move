module 0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::vault {
    ...
    public fun claim<T0, T1>(arg0: &mut LpVault<T0, T1>, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::events::emit_fee_claimed<T0, T1>(0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::events::get_id(&v1.id), v0, 0, arg2, arg2, *v3);
    ...
    public fun collect_lp_fee<T0, T1>(arg0: &mut LpVault<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::events::emit_fee_collected<T0, T1>(0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::events::get_id(&arg0.id), v6, v7, arg4, v0, arg3);
    }
    ...
    public fun id<T0, T1>(arg0: &LpVault<T0, T1>) : 0x2::object::ID {
        0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::events::get_id(&arg0.id)
    }

    public fun new_lp_vault<T0, T1>(arg0: 0x2::bag::Bag, arg1: address, arg2: vector<u8>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : LpVault<T0, T1> {
        let v0 = Vault<T0, T1>{
            ...
            admin_key_id     : arg3,
            claims           : 0x2::table::new<address, 0x2::table::Table<u64, u64>>(arg4),
            epoch_totals     : 0x2::table::new<u64, u64>(arg4),
            signatures       : 0x2::table::new<vector<u8>, bool>(arg4),
        };
        0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::events::emit_vault_created<T0, T1>(0xd7556fe3c6ad95f98f0e0c108640634b24ffbe1d00c126328085122ee77eb9c3::events::get_id(&v0.id), arg1, arg2, v0.epoch);
        LpVault<T0, T1>{
            id           : 0x2::object::new(arg4),
            position_bag : arg0,
            curator      : arg1,
    ...
    public fun share_lp_vault<T0, T1>(arg0: LpVault<T0, T1>) {
        0x2::transfer::share_object<LpVault<T0, T1>>(arg0);
    }
