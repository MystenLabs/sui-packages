module 0xd7c12e2579c12c5ce6840bc655eb8591fd36bbae0521978314275e45a31fd400::healthy_gang {
    struct HEALTHY_GANG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: HEALTHY_GANG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<HEALTHY_GANG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Healthy Gang"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A squad of cheerful fruits on a mission to spread positivity, wellness, and good vibes!"));
