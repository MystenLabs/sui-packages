module 0xd785fc3f90a3960373b8bffc3bdee8ca4cbeb403378d76fd2f89994842ac1e8d::cnsnft4956 {
    struct CNSNFT4956 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4956, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4956>(arg0, arg1);
