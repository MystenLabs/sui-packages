module 0xd74c24cb02ce4f9d5d447f78e902c3b88b458ec4b8c2ee7313c02f47266e0ac7::amm {
    struct AMM has drop {
        dummy_field: bool,
    }
    ...
    struct Pool<phantom T0, phantom T1, phantom T2> has store, key {
        id: 0x2::object::UID,
        pool_id: u64,
        lp_treasury: 0x2::coin::TreasuryCap<T2>,
    ...
    public entry fun add_liquidity<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::mint<T2>(&mut arg0.lp_treasury, v2, arg3), 0x2::tx_context::sender(arg3));
    ...
    public fun calculate_swap_output<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: u64, arg2: bool) : u64 {
        if (arg2) {
    ...
    public entry fun claim_creator_fees<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun claim_protocol_fees<T0, T1, T2>(arg0: &Global, arg1: &mut Pool<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_pool_with_lp_type<T0, T1, T2: drop>(arg0: &mut Global, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: T2, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let (v3, v4) = 0x2::coin::create_currency<T2>(arg5, 9, arg7, arg6, arg8, v2, arg12);
        let v5 = v4;
        let v6 = 0x2::object::id<0x2::coin::CoinMetadata<T2>>(&v5);
        ...
        let v9 = if (0x1::vector::is_empty<u8>(&arg9)) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(arg9))
        };
        ...
        0x2::table::add<0x2::object::ID, LPTokenInfo>(&mut arg0.lp_info, v8, v10);
        let v11 = 0x2::coin::value<T0>(&arg2);
        if (v11 > 0) {
            0x2::balance::join<T0>(&mut v7.reserve_x, 0x2::coin::into_balance<T0>(arg2));
            let v12 = calculate_initial_lp_amount(v11, arg10, arg11);
            if (v12 > 0) {
                v7.lp_supply = v12;
                0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::mint<T2>(&mut v7.lp_treasury, v12, arg12), 0x2::tx_context::sender(arg12));
            };
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0x2::tx_context::sender(arg12));
        };
        0x2::table::add<0x2::object::ID, bool>(&mut arg0.pools, v8, true);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<T2>>(v5);
        let v13 = PoolCreated{
            pool_id        : v8,
            pool_number    : v1,
            coin_x_type    : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())),
        ...
        let v14 = LaunchEvent{
            ...
            initial_supply   : v11,
            virtual_reserves : arg10,
            creator          : 0x2::tx_context::sender(arg12),
        };
        0x2::event::emit<LaunchEvent>(v14);
    ...
    public fun get_pool_info<T0, T1, T2>(arg0: &Pool<T0, T1, T2>) : (u64, u64, u64, u64, u64, u8, address) {
    ...
    public fun get_total_value_locked<T0, T1, T2>(arg0: &Pool<T0, T1, T2>) : (u64, u64) {
        (0x2::balance::value<T0>(&arg0.reserve_x), 0x2::balance::value<T1>(&arg0.reserve_y))
    }
    ...
    public entry fun remove_liquidity<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::burn<T2>(&mut arg0.lp_treasury, arg1);
        arg0.lp_supply = arg0.lp_supply - v0;
        let v3 = 0x2::tx_context::sender(arg2);
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.reserve_x, v1), arg2), v3);
        };
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reserve_y, v2), arg2), v3);
        };
    ...
    public entry fun swap_x_for_y<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg1);
    ...
    public entry fun swap_y_for_x<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
