module 0xd77b822ea2e49dd7447f66c672476cacf0fbb9ea413e446fa6212e9ac0291480::cnsnft3243 {
    struct CNSNFT3243 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3243, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3243>(arg0, arg1);
