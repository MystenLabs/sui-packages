module 0xd7c653c43d347f82217cfa7b52a20467c6ffedd3d71a17daaeaca111377285bf::reward9756 {
    struct REWARD9756 has drop {
        dummy_field: bool,
    }

    struct TICKET_9756 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9756(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9756>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9756>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9756, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9756>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9756>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9756>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9756>>(v5, 0x2::tx_context::sender(arg1));
    }
