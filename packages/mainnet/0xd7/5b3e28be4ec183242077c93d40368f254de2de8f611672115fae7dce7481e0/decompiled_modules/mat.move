module 0xd75b3e28be4ec183242077c93d40368f254de2de8f611672115fae7dce7481e0::mat {
    struct MAT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun burn(arg0: &mut UMyTokenCap, arg1: 0x2::coin::Coin<MAT>) {
    ...
    public entry fun buy_tokens(arg0: &mut TokenConfig, arg1: &mut UMyTokenCap, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = v0 / 10000;
        assert!(v1 > 0, 5);
        let v2 = 0x2::coin::total_supply<MAT>(&arg1.treasury) * v1 / 100;
        assert!(v2 > 0, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg3, arg0.token_account_address);
        0x2::coin::mint_and_transfer<MAT>(&mut arg1.treasury, v2, 0x2::tx_context::sender(arg4), arg4);
    ...
    fun init(arg0: MAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TokenConfig{
            ...
            token_account_address          : @0x123456789abcdef123456789abcdef123456789abcdef123456789abcdef1234,
        ...
        let v5 = TreasuryCapCreatedEvent{
            ...
            transfer_address : @0x123456789abcdef123456789abcdef123456789abcdef123456789abcdef1234,
        };
        ...
        0x2::coin::mint_and_transfer<MAT>(&mut v3.treasury, 1000000000000, @0x123456789abcdef123456789abcdef123456789abcdef123456789abcdef1234, arg1);
        0x2::transfer::public_transfer<UMyTokenCap>(v3, @0x123456789abcdef123456789abcdef123456789abcdef123456789abcdef1234);
    }
