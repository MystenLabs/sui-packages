module 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder {
    ...
    public(friend) fun accumulate_strategy_reward(arg0: &mut Rewarder, arg1: 0x2::object::ID, arg2: u128, arg3: u64) : u128 {
        ...
        if (arg3 > v0.last_reward_time && arg0.emission_per_second > 0) {
            let v1 = arg0.emission_per_second * (arg3 - v0.last_reward_time);
            v0.acc_per_share = v0.acc_per_share + 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::mul_div_floor(((v1 * v0.allocate_point / arg0.total_allocate_point) as u128), 1000000000, arg2);
            v0.last_reward_time = arg3;
            arg0.total_reward_released = arg0.total_reward_released + (v1 as u128);
        };
        v0.acc_per_share
    }
    ...
    public fun add_reward_black_list(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut RewarderManager, arg3: vector<address>, arg4: &mut 0x2::tx_context::TxContext) {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_reward_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        0x1::vector::append<address>(&mut arg2.black_list, arg3);
    }
    ...
    public fun create_rewarder<T0>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut RewarderManager, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_reward_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        let v0 = 0x1::type_name::get<T0>();
        let v1 = Rewarder{
    ...
    public fun deposit_rewarder<T0>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut RewarderManager, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_reward_black_list(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut RewarderManager, arg3: vector<address>, arg4: &mut 0x2::tx_context::TxContext) {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_reward_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public(friend) fun strategy_rewards_settle(arg0: &mut RewarderManager, arg1: vector<0x1::type_name::TypeName>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u128> {
        assert!(0x2::linked_table::contains<0x2::object::ID, u128>(&arg0.strategy_shares, arg2), 2);
    ...
    public fun update_rewarder<T0>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut RewarderManager, arg3: u64, arg4: &0x2::clock::Clock) {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_reward_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::linked_table::contains<0x1::type_name::TypeName, Rewarder>(&arg2.rewarders, v0), 1);
