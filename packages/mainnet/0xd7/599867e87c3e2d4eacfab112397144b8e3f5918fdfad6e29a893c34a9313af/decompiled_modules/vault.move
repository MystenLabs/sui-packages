module 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::vault {
    ...
    public fun add_rewarder<T0>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg3: &mut Strategy, arg4: u64, arg5: &0x2::clock::Clock) {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        let v0 = 0x1::type_name::get<T0>();
        assert!(!0x1::vector::contains<0x1::type_name::TypeName>(&arg3.rewarders, &v0), 3);
        let v1 = 0x2::object::id<Strategy>(arg3);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::add_strategy<T0>(arg2, v1, arg4, arg5);
    ...
    public fun check_rebalance<T0, T1, T2>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut Strategy, arg2: 0x2::object::ID, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg4: &mut 0x2::tx_context::TxContext) : CheckRebalance {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg0);
    ...
    public fun check_rebalance_loop<T0, T1, T2>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut Strategy, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg5: &mut 0x2::tx_context::TxContext) : (vector<CheckRebalance>, 0x1::option::Option<0x2::object::ID>) {
        ...
        let v3 = &v2;
        while (!0x1::option::is_none<0x2::object::ID>(v3) && v1 < arg3) {
            let v4 = *0x1::option::borrow<0x2::object::ID>(v3);
            let v5 = check_rebalance<T0, T1, T2>(arg0, arg1, v4, arg4, arg5);
            if (v5.rebalance) {
                0x1::vector::push_back<CheckRebalance>(&mut v0, v5);
            };
            v3 = 0x2::linked_table::next<0x2::object::ID, VaultInfo>(&arg1.vaults, v4);
            v1 = v1 + 1;
        };
        (v0, *v3)
    }
    ...
    public fun close_vault<T0, T1>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut Strategy, arg2: Vault, arg3: &mut 0x2::tx_context::TxContext) {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg0);
        assert!(arg1.status == 0, 15);
    ...
    fun collect_clmm_base_fees<T0, T1, T2>(arg0: &mut Strategy, arg1: 0x2::object::ID, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: &0x2::clock::Clock, arg5: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Strategy>(arg0);
        let v1 = borrow_mut_clmm_base_nft(arg0, arg1);
        let (v2, v3) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::collect_with_return_<T0, T1, T2>(arg2, arg3, v1, 18446744073709551615, 18446744073709551615, 0x2::object::id_to_address(&arg1), 0x2::clock::timestamp_ms(arg4) + 60000, arg4, arg5, arg6);
        let v4 = v3;
        let v5 = v2;
        merge_vault_balance<T0>(arg0, arg1, 0x2::coin::into_balance<T0>(v5));
        merge_vault_balance<T1>(arg0, arg1, 0x2::coin::into_balance<T1>(v4));
        let v6 = ClmmFeeClaimedEvent{
            vault_id         : arg1,
            strategy_id      : v0,
            clmm_pool_id     : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg2),
            clmm_nft_id      : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v1),
            amount_a         : 0x2::coin::value<T0>(&v5),
            amount_b         : 0x2::coin::value<T1>(&v4),
            coin_a_type_name : 0x1::type_name::get<T0>(),
            coin_b_type_name : 0x1::type_name::get<T1>(),
        };
        0x2::event::emit<ClmmFeeClaimedEvent>(v6);
    }

    fun collect_clmm_base_reward<T0, T1, T2, T3>(arg0: &mut Strategy, arg1: 0x2::object::ID, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::PoolRewardVault<T3>, arg5: u64, arg6: address, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T3> {
        let v0 = 0x2::object::id<Strategy>(arg0);
        let v1 = borrow_mut_clmm_base_nft(arg0, arg1);
        let v2 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::collect_reward_with_return_<T0, T1, T2, T3>(arg2, arg3, v1, arg4, arg5, 18446744073709551615, arg6, 0x2::clock::timestamp_ms(arg7) + 60000, arg7, arg8, arg9);
        let v3 = ClmmRewardClaimedEvent{
            vault_id         : arg1,
            strategy_id      : v0,
            clmm_pool_id     : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg2),
            clmm_nft_id      : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v1),
            amount           : 0x2::coin::value<T3>(&v2),
            reward_type_name : 0x1::type_name::get<T3>(),
        };
        0x2::event::emit<ClmmRewardClaimedEvent>(v3);
        v2
    }

    fun collect_clmm_fees<T0, T1, T2>(arg0: &mut Strategy, arg1: 0x2::object::ID, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: &0x2::clock::Clock, arg5: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg6: &mut 0x2::tx_context::TxContext) {
        if (is_clmm_base_nft_exists(arg0, arg1)) {
            collect_clmm_base_fees<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        };
        if (is_clmm_limit_nft_exists(arg0, arg1)) {
            collect_clmm_limit_fees<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        };
    }

    fun collect_clmm_limit_fees<T0, T1, T2>(arg0: &mut Strategy, arg1: 0x2::object::ID, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: &0x2::clock::Clock, arg5: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Strategy>(arg0);
        let v1 = borrow_mut_clmm_limit_nft(arg0, arg1);
        let (v2, v3) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::collect_with_return_<T0, T1, T2>(arg2, arg3, v1, 18446744073709551615, 18446744073709551615, 0x2::object::id_to_address(&arg1), 0x2::clock::timestamp_ms(arg4) + 60000, arg4, arg5, arg6);
        let v4 = v3;
        let v5 = v2;
        merge_vault_balance<T0>(arg0, arg1, 0x2::coin::into_balance<T0>(v5));
    ...
    fun collect_clmm_limit_reward<T0, T1, T2, T3>(arg0: &mut Strategy, arg1: 0x2::object::ID, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::PoolRewardVault<T3>, arg5: u64, arg6: address, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T3> {
        let v0 = 0x2::object::id<Strategy>(arg0);
        let v1 = borrow_mut_clmm_limit_nft(arg0, arg1);
        let v2 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::collect_reward_with_return_<T0, T1, T2, T3>(arg2, arg3, v1, arg4, arg5, 18446744073709551615, arg6, 0x2::clock::timestamp_ms(arg7) + 60000, arg7, arg8, arg9);
        let v3 = ClmmRewardClaimedEvent{
    ...
    fun collect_clmm_reward<T0, T1, T2, T3>(arg0: &mut Strategy, arg1: 0x2::object::ID, arg2: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::PoolRewardVault<T3>, arg5: u64, arg6: address, arg7: &0x2::clock::Clock, arg8: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg9: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T3> {
        let v0 = 0x2::balance::zero<T3>();
        if (is_clmm_base_nft_exists(arg0, arg1)) {
            let v1 = collect_clmm_base_reward<T0, T1, T2, T3>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
            0x2::balance::join<T3>(&mut v0, 0x2::coin::into_balance<T3>(v1));
        };
        if (is_clmm_limit_nft_exists(arg0, arg1)) {
            0x2::balance::join<T3>(&mut v0, 0x2::coin::into_balance<T3>(collect_clmm_limit_reward<T0, T1, T2, T3>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9)));
        };
        v0
    }
    ...
    public fun collect_clmm_reward_direct_return<T0, T1, T2, T3>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut Strategy, arg2: &Vault, arg3: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg5: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::PoolRewardVault<T3>, arg6: u64, arg7: address, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T3> {
        ...
        let v1 = collect_clmm_reward<T0, T1, T2, T3>(arg1, 0x2::object::id<Vault>(arg2), arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
    ...
    public fun collect_clmm_reward_to_vault<T0, T1, T2, T3>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: 0x2::object::ID, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg5: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg6: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::PoolRewardVault<T3>, arg7: u64, arg8: address, arg9: &0x2::clock::Clock, arg10: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg11: &mut 0x2::tx_context::TxContext) {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        assert!(arg2.status == 0, 15);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_rebalance_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        let v0 = collect_clmm_reward<T0, T1, T2, T3>(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
        merge_vault_balance<T3>(arg2, arg3, v0);
    }

    public(friend) fun collect_protocol_fee<T0>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        assert!(arg2.status == 0, 15);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public fun collect_reward<T0>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg2: &mut Strategy, arg3: &Vault, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::strategy_rewards_settle(arg1, arg2.rewarders, v1, arg4);
    ...
    public fun create_strategy<T0, T1, T2>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg3: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg4: u32, arg5: bool, arg6: u32, arg7: bool, arg8: 0x1::string::String, arg9: u32, arg10: u32, arg11: u32, arg12: u32, arg13: &mut 0x2::tx_context::TxContext) : Strategy {
        ...
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::register_strategy(arg2, v7);
    ...
    public fun get_vault_total_amount<T0, T1, T2>(arg0: &Strategy, arg1: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg2: 0x2::object::ID) : (u64, u64) {
        let v0 = get_vault_balance<T0>(arg0, arg2);
        let v1 = v0;
        let v2 = get_vault_balance<T1>(arg0, arg2);
        let v3 = v2;
        let v4 = 0x2::linked_table::borrow<0x2::object::ID, VaultInfo>(&arg0.vaults, arg2);
        let v5 = v4.base_liquidity;
        let v6 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_sqrt_price<T0, T1, T2>(arg1);
        if (v5 > 0) {
            let (v7, v8) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_liquidity::get_amount_for_liquidity(v6, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::sqrt_price_from_tick_index(v4.base_lower_index), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::sqrt_price_from_tick_index(v4.base_upper_index), v5);
            v1 = v0 + (v7 as u64);
            v3 = v2 + (v8 as u64);
        };
        if (v4.limit_liquidity > 0) {
            let (v9, v10) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_liquidity::get_amount_for_liquidity(v6, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::sqrt_price_from_tick_index(v4.base_lower_index), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_tick::sqrt_price_from_tick_index(v4.base_upper_index), v5);
            v1 = v1 + (v9 as u64);
            v3 = v3 + (v10 as u64);
        };
        (v1, v3)
    ...
    public fun rebalance<T0, T1, T2>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg3: &mut Strategy, arg4: 0x2::object::ID, arg5: bool, arg6: bool, arg7: u32, arg8: bool, arg9: u32, arg10: bool, arg11: u32, arg12: bool, arg13: u32, arg14: bool, arg15: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg16: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg17: &0x2::clock::Clock, arg18: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from_u32_neg(arg9, arg10);
        let v2 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from_u32_neg(arg11, arg12);
        let v3 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from_u32_neg(arg13, arg14);
        let v4 = CheckRebalance{
            vault_id           : arg4,
            rebalance          : arg5,
            base_lower_index   : v0,
            base_upper_index   : v1,
        ...
        let v5 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_sqrt_price<T0, T1, T2>(arg15);
        let v6 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_current_index<T0, T1, T2>(arg15);
        if (!v4.base_just_increase) {
            check_tick_range(arg3.base_tick_step_minimum, v6, v0, v1, arg3.tick_spacing);
        };
        check_tick_range(arg3.limit_tick_step_minimum, v6, v2, v3, arg3.tick_spacing);
        if (!v4.rebalance) {
            return
        };
        collect_clmm_fees<T0, T1, T2>(arg3, arg4, arg15, arg16, arg17, arg18, arg19);
        let v7 = get_vault_base_clmm_position_id(arg3, arg4);
        let v8 = get_vault_base_liquidity(arg3, arg4);
        let v9 = get_vault_limit_clmm_position_id(arg3, arg4);
        let v10 = get_vault_limit_liquidity(arg3, arg4);
        let v11 = get_vault_base_last_tick_index(arg3, arg4);
        get_vault_limit_last_tick_index(arg3, arg4);
        if (is_clmm_limit_nft_exists(arg3, arg4)) {
            let v12 = borrow_mut_clmm_limit_nft(arg3, arg4);
            let (_, _, v15) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v12));
            if (v15 > 0) {
                let (v16, v17) = decrease_clmm_liquidity<T0, T1, T2>(v12, arg15, arg16, v15, arg17, arg18, arg19);
                v10 = 0;
                merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v16));
                merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v17));
            };
            burn_clmm_limit_nft<T0, T1, T2>(arg3, arg4, arg16, arg18, arg19);
        };
        let v18 = v4.limit_upper_index;
        let v19 = v4.limit_lower_index;
        let v20 = 0x2::coin::zero<T0>(arg19);
        let v21 = 0x2::coin::zero<T1>(arg19);
        if (is_clmm_base_nft_exists(arg3, arg4)) {
            if (v4.base_just_increase) {
                if (calculate_liquidity(v5, v0, v1, get_vault_balance<T0>(arg3, arg4), get_vault_balance<T1>(arg3, arg4)) > 0) {
                    let v22 = take_vault_balance<T0>(arg3, arg4);
                    let v23 = 0x2::coin::from_balance<T0>(v22, arg19);
                    let v24 = take_vault_balance<T1>(arg3, arg4);
                    let v25 = 0x2::coin::from_balance<T1>(v24, arg19);
                    let (v26, v27, _, _, v30) = increase_clmm_liquidity<T0, T1, T2>(arg3, arg4, true, arg15, arg16, v23, v25, arg17, arg18, arg19);
                    v8 = v30;
                    0x2::coin::join<T0>(&mut v20, v26);
                    0x2::coin::join<T1>(&mut v21, v27);
                };
            } else {
                let v31 = borrow_mut_clmm_base_nft(arg3, arg4);
                let (_, _, v34) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v31));
                let (v35, v36) = decrease_clmm_liquidity<T0, T1, T2>(v31, arg15, arg16, v34, arg17, arg18, arg19);
                merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v35));
                merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v36));
                burn_clmm_base_nft<T0, T1, T2>(arg3, arg4, arg16, arg18, arg19);
                v8 = 0;
                if (calculate_liquidity(v5, v4.base_lower_index, v4.base_upper_index, get_vault_balance<T0>(arg3, arg4), get_vault_balance<T1>(arg3, arg4)) > 0) {
                    let v37 = take_vault_balance<T0>(arg3, arg4);
                    let v38 = 0x2::coin::from_balance<T0>(v37, arg19);
                    let v39 = take_vault_balance<T1>(arg3, arg4);
                    let v40 = 0x2::coin::from_balance<T1>(v39, arg19);
                    let (v41, v42, v43) = mint_clmm_liquidity<T0, T1, T2>(arg15, arg16, v38, v40, v4.base_lower_index, v4.base_upper_index, arg17, arg18, arg19);
                    let v44 = v41;
                    0x2::coin::join<T0>(&mut v20, v42);
                    0x2::coin::join<T1>(&mut v21, v43);
                    let (_, _, v47) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&v44));
                    v8 = v47;
                    v7 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::position_id(&v44);
            ...
            if (calculate_liquidity(v5, v4.base_lower_index, v4.base_upper_index, get_vault_balance<T0>(arg3, arg4), get_vault_balance<T1>(arg3, arg4)) > 0) {
                let v48 = take_vault_balance<T0>(arg3, arg4);
                let v49 = 0x2::coin::from_balance<T0>(v48, arg19);
                let v50 = take_vault_balance<T1>(arg3, arg4);
                let v51 = 0x2::coin::from_balance<T1>(v50, arg19);
                let (v52, v53, v54) = mint_clmm_liquidity<T0, T1, T2>(arg15, arg16, v49, v51, v4.base_lower_index, v4.base_upper_index, arg17, arg18, arg19);
                let v55 = v52;
                0x2::coin::join<T0>(&mut v20, v53);
                0x2::coin::join<T1>(&mut v21, v54);
                let (_, _, v58) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&v55));
                v8 = v58;
                v7 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::position_id(&v55);
                fill_clmm_base_nft(arg3, arg4, v55);
            };
            v11 = v6;
        };
        merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v20));
        merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v21));
        let v59 = get_vault_balance<T0>(arg3, arg4);
        let v60 = get_vault_balance<T1>(arg3, arg4);
        let v61 = v4.limit_lower_index;
        let v62 = floor_tick_index(v6, arg3.tick_spacing, true);
        let v63 = floor_tick_index(v6, arg3.tick_spacing, false);
        let v64 = v4.limit_upper_index;
        let v65 = calculate_liquidity(v5, v61, v62, v59, v60);
        let v66 = calculate_liquidity(v5, v63, v64, v59, v60);
        if (v65 > 0 || v66 > 0) {
            let (v67, v68) = if (v65 > v66) {
                (v61, v62)
            } else {
                (v63, v64)
            };
            v18 = v68;
            v19 = v67;
            let v69 = take_vault_balance<T0>(arg3, arg4);
            let v70 = 0x2::coin::from_balance<T0>(v69, arg19);
            let v71 = take_vault_balance<T1>(arg3, arg4);
            let v72 = 0x2::coin::from_balance<T1>(v71, arg19);
            let (v73, v74, v75) = mint_clmm_liquidity<T0, T1, T2>(arg15, arg16, v70, v72, v67, v68, arg17, arg18, arg19);
            let v76 = v73;
            let (_, _, v79) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&v76));
            v10 = v79;
            v9 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::position_id(&v76);
            fill_clmm_limit_nft(arg3, arg4, v76);
            merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v74));
            merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v75));
        };
        update_vault_info_with_tick_range(arg3, arg4, v7, v4.base_lower_index, v4.base_upper_index, v8, v9, v19, v18, v10, v5, v11, v6);
        update_strategy_reward_info(arg2, arg3, arg4, arg17);
        let v80 = RebalanceEvent{
            vault_id       : arg4,
        ...
        0x2::event::emit<RebalanceEvent>(v80);
    }
    ...
    fun take_vault_balance_by_amount<T0>(arg0: &mut Strategy, arg1: 0x2::object::ID, arg2: u64) : 0x2::balance::Balance<T0> {
        ...
        let v1 = borrow_mut_vault_account(arg0, arg1);
        if (0x2::bag::contains<0x1::string::String>(&v1.balances, v0)) {
            0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v1.balances, v0), arg2)
        } else {
            0x2::balance::zero<T0>()
        }
    }

    public(friend) fun update_strategy_base_minimum_threshold(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: u32) : u32 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public(friend) fun update_strategy_default_base_rebalance_threshold(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: u32) : u32 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public(friend) fun update_strategy_default_limit_rebalance_threshold(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: u32) : u32 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public(friend) fun update_strategy_image_url(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: 0x1::string::String) : 0x1::string::String {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        arg2.image_url = arg3;
        arg3
    ...
    public(friend) fun update_strategy_limit_minimum_threshold(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: u32) : u32 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public(friend) fun update_strategy_protocol_fee_rate(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: u64) : u64 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        assert!(arg3 <= 1000000, 5);
        arg2.protocol_fee_rate = arg3;
        let v0 = UpdateFeeRateEvent{
            strategy_id : 0x2::object::id<Strategy>(arg2),
            old_rate    : arg2.protocol_fee_rate,
            new_rate    : arg3,
        };
    ...
    fun update_strategy_reward_info(arg0: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg1: &mut Strategy, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : u128 {
        let v0 = 0;
        let v1 = v0;
        let v2 = 0x2::object::id<Strategy>(arg1);
        let (v3, v4, v5, v6, v7, v8, v9, v10, _) = get_vault_info(arg1, arg2);
        if (!0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::is_in_black_list(arg0, 0x2::object::id_to_address(&arg2))) {
            if (is_clmm_base_nft_exists(arg1, arg2)) {
        ...
        let v13 = 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::strategy_rewards_settle(arg0, arg1.rewarders, v2, arg3);
        update_vault_reward_info(arg1, arg2, v13, v1);
        arg1.total_share = v12;
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::set_strategy_share(arg0, v2, v12);
        v1
    }

    public(friend) fun update_strategy_status(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: u8) : u8 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
        arg2.status = arg3;
        arg3
    ...
    public(friend) fun update_vault_base_rebalance_threshold(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: 0x2::object::ID, arg4: u32) : u32 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public(friend) fun update_vault_limit_rebalance_threshold(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut Strategy, arg3: 0x2::object::ID, arg4: u32) : u32 {
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::checked_package_version(arg1);
        0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::check_vault_manager_role(arg1, 0x2::object::id_address<0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap>(arg0));
    ...
    public fun withdraw<T0, T1, T2>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg2: &mut Strategy, arg3: &mut Vault, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg5: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg6: u64, arg7: bool, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v1 = 0x2::object::id<Vault>(arg3);
        collect_clmm_fees<T0, T1, T2>(arg2, v1, arg4, arg5, arg8, arg9, arg10);
        let v2 = borrow_mut_clmm_base_nft(arg2, v1);
        let (_, _, v5) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v2));
        let v6 = 0;
        let v7 = 0x2::coin::zero<T0>(arg10);
        let v8 = 0x2::coin::zero<T1>(arg10);
        if (v5 > 0) {
            let (v9, v10) = decrease_clmm_liquidity<T0, T1, T2>(v2, arg4, arg5, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::mul_div_floor(v5, (arg6 as u128), 100), arg8, arg9, arg10);
            let (_, _, v13) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v2));
            v6 = v13;
            0x2::coin::join<T0>(&mut v7, v9);
            0x2::coin::join<T1>(&mut v8, v10);
        };
        let v14 = 0;
        let v15 = is_clmm_limit_nft_exists(arg2, v1);
        if (v15) {
            let v16 = borrow_mut_clmm_limit_nft(arg2, v1);
            let (_, _, v19) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v16));
            if (v19 > 0) {
                let (v20, v21) = decrease_clmm_liquidity<T0, T1, T2>(v16, arg4, arg5, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::mul_div_floor(v19, (arg6 as u128), 100), arg8, arg9, arg10);
                let (_, _, v24) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v16));
                v14 = v24;
                0x2::coin::join<T0>(&mut v7, v20);
                0x2::coin::join<T1>(&mut v8, v21);
            };
        };
        let v25 = vault_balance_amount<T1>(arg2, v1);
        let v26 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u64::mul_div_floor(vault_balance_amount<T0>(arg2, v1), arg6, 100);
        let v27 = take_vault_balance_by_amount<T0>(arg2, v1, v26);
        let v28 = take_vault_balance_by_amount<T1>(arg2, v1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u64::mul_div_floor(v25, arg6, 100));
        0x2::coin::join<T0>(&mut v7, 0x2::coin::from_balance<T0>(v27, arg10));
        0x2::coin::join<T1>(&mut v8, 0x2::coin::from_balance<T1>(v28, arg10));
        let v29 = arg2.protocol_fee_rate;
        let (v30, v31) = if (v29 == 0) {
            (0, 0)
        } else {
            let v32 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u64::mul_div_ceil(0x2::coin::value<T0>(&v7), v29, 1000000);
            let v33 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u64::mul_div_ceil(0x2::coin::value<T1>(&v8), v29, 1000000);
            merge_protocol_asset<T0>(arg2, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v7, v32, arg10)));
            merge_protocol_asset<T1>(arg2, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v8, v33, arg10)));
            (v32, v33)
        };
        if (arg7 && arg6 == 100) {
            burn_clmm_base_nft<T0, T1, T2>(arg2, v1, arg5, arg9, arg10);
            if (v15) {
                burn_clmm_limit_nft<T0, T1, T2>(arg2, v1, arg5, arg9, arg10);
            };
        };
        update_vault_info(arg2, v1, v6, v14, v0);
        update_strategy_reward_info(arg1, arg2, v1, arg8);
        borrow_vault_info(arg2, v1);
        let v34 = WithdrawEvent{
            vault_id              : v1,
            strategy_id           : 0x2::object::id<Strategy>(arg2),
            clmm_pool_id          : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>>(arg4),
            percentage            : arg6,
            burn_clmm_nft         : arg7,
            amount_a              : 0x2::coin::value<T0>(&v7),
            amount_b              : 0x2::coin::value<T1>(&v8),
            protocol_fee_a_amount : v30,
            protocol_fee_b_amount : v31,
        };
        0x2::event::emit<WithdrawEvent>(v34);
        (v7, v8)
    }
