module 0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::treasury {
    ...
    public fun drain(arg0: &mut Treasury, arg1: &0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::acl::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x7262fb2f7a3a14c888c438a3cd9b912469a58cf60f367352c46584262e8299aa::ika::IKA>, 0x2::coin::Coin<0x2::sui::SUI>) {
    ...
    public fun pay_dkg_zero_trust(arg0: &mut Treasury, arg1: &0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::acl::OperatorCap, arg2: &mut 0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::account::Account, arg3: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg4: 0x2::object::ID, arg5: u32, arg6: vector<u8>, arg7: vector<u8>, arg8: address, arg9: vector<u8>, arg10: vector<u8>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = take(arg0, arg12);
        let v2 = v1;
        let v3 = v0;
        0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::dkg::request_dkg_zero_trust(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, &mut v3, &mut v2, arg12);
        give_back(arg0, v3, v2);
    }

    public fun pay_presign(arg0: &mut Treasury, arg1: &0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::acl::OperatorCap, arg2: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg3: 0x2::object::ID, arg4: u32, arg5: u32, arg6: vector<u8>, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public fun pay_register_and_dkg_zero_trust(arg0: &mut Treasury, arg1: &0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::acl::OperatorCap, arg2: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg3: 0x2::object::ID, arg4: u32, arg5: vector<u8>, arg6: vector<u8>, arg7: address, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = take(arg0, arg11);
        let v2 = v1;
        let v3 = v0;
        let v4 = 0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::account::register_account(arg1, arg11);
        0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::dkg::request_dkg_zero_trust(arg1, &mut v4, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, &mut v3, &mut v2, arg11);
        0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::account::share_account(v4);
        give_back(arg0, v3, v2);
    }

    public fun pay_sign_zero_trust(arg0: &mut Treasury, arg1: &0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::acl::OperatorCap, arg2: &mut 0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::account::Account, arg3: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg4: 0x2::object::ID, arg5: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap, arg6: u32, arg7: u32, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let (v0, v1) = take(arg0, arg11);
        let v2 = v1;
        let v3 = v0;
        give_back(arg0, v3, v2);
        0xd7a25592d4c99570a767195cd666cf9c54686d64a512907830bc9b1d91783d65::sign::request_sign_zero_trust(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, &mut v3, &mut v2, arg11)
    }
