module 0xd7bc0e3471bf6804fbb98c30f70de193785857651c80a375e23c5a926d462f3d::SUICAT {
    ...
    fun init(arg0: SUICAT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUICAT>(arg0, 2, b"SUICAT", b"SUICAT", b"test token", 0x1::option::none<0x2::url::Url>(), arg1);
