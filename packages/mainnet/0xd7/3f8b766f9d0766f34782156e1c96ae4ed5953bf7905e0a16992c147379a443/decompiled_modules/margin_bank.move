module 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::margin_bank {
    ...
    public entry fun create_bank<T0>(arg0: &0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::roles::ExchangeAdminCap, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Bank<T0>{
    ...
    entry fun deposit_to_bank<T0>(arg0: &mut Bank<T0>, arg1: address, arg2: u64, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg2 <= 0x2::coin::value<T0>(arg3), 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::coin_does_not_have_enough_amount());
        ...
        let v3 = 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::library::convert_usdc_to_base_decimals((arg2 as u128));
        *v2 = v3 + *v2;
    ...
    public entry fun set_withdrawal_status<T0>(arg0: &0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::roles::CapabilitiesSafe, arg1: &0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::roles::ExchangeGuardianCap, arg2: &mut Bank<T0>, arg3: bool) {
    ...
    fun transfer_based_on_fundsflow<T0>(arg0: &mut Bank<T0>, arg1: address, arg2: address, arg3: 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number::Number, arg4: u64) {
        if (0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number::value(arg3) == 0) {
            return
        };
        let (v0, v1, v2) = if (0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number::gt_uint(arg3, 0)) {
            (arg1, arg4, arg2)
        } else {
            (arg2, 2, arg1)
        };
        transfer_margin_to_account<T0>(arg0, v2, v0, 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number::value(arg3), v1);
    }
    ...
    public(friend) fun transfer_margin_to_account<T0>(arg0: &mut Bank<T0>, arg1: address, arg2: address, arg3: u128, arg4: u64) {
        ...
        assert!(*v1 >= arg3, 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::not_enough_balance_in_margin_bank(arg4));
        *v1 = *v1 - arg3;
    ...
    public(friend) fun transfer_trade_margin<T0>(arg0: &mut Bank<T0>, arg1: address, arg2: address, arg3: address, arg4: 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number::Number, arg5: 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number::Number) {
        assert!(0x2::table::contains<address, BankAccount>(&arg0.accounts, arg2), 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::not_enough_balance_in_margin_bank(0));
        assert!(0x2::table::contains<address, BankAccount>(&arg0.accounts, arg3), 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::not_enough_balance_in_margin_bank(1));
        if (0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number::gte_uint(arg4, 0)) {
    ...
    entry fun withdraw_all_margin_from_bank<T0>(arg0: &mut Bank<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.isWithdrawalAllowed, 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::withdrawal_is_not_allowed());
        let v1 = &mut arg0.accounts;
        assert!(0x2::table::contains<address, BankAccount>(v1, v0), 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::user_has_no_bank_account());
    ...
    entry fun withdraw_from_bank<T0>(arg0: &mut Bank<T0>, arg1: address, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut arg0.accounts;
        assert!(0x2::table::contains<address, BankAccount>(v1, v0), 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::user_has_no_bank_account());
        let v2 = 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::library::convert_usdc_to_base_decimals(arg2);
        let v3 = &mut 0x2::table::borrow_mut<address, BankAccount>(v1, v0).balance;
        assert!(*v3 >= v2, 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::error::not_enough_balance_in_margin_bank(3));
        *v3 = *v3 - v2;
