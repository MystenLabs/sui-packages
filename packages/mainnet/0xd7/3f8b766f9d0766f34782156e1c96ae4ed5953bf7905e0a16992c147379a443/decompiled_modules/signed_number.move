module 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::library::base_div(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun mul_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::library::base_mul(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun one() : Number {
        Number{
            value : 0xd73f8b766f9d0766f34782156e1c96ae4ed5953bf7905e0a16992c147379a443::library::base_uint(),
            sign  : true,
        }
    }
