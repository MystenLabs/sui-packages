module 0xd79dcbab2d0637aced8364c829a0c116d2d18b9eff074d1993985bd5a3c7fa0c::sale {
    ...
    public entry fun purchase(arg0: &mut TokenSale, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.current_phase == 0) {
            ...
            let v19 = if (0x2::table::contains<address, u8>(&arg0.purchases_public_count, v0)) {
            ...
            if (0x2::table::contains<address, u64>(&arg0.purchases_public, v0)) {
                let v21 = 0x2::table::borrow_mut<address, u64>(&mut arg0.purchases_public, v0);
                *v21 = *v21 + v1;
                *0x2::table::borrow_mut<address, u8>(&mut arg0.purchases_public_count, v0) = v20;
            } else {
                0x2::table::add<address, u64>(&mut arg0.purchases_public, v0, v1);
                0x2::table::add<address, u8>(&mut arg0.purchases_public_count, v0, v20);
            };
            if (0x2::table::contains<address, u64>(&arg0.token_allocations_public, v0)) {
                let v22 = 0x2::table::borrow_mut<address, u64>(&mut arg0.token_allocations_public, v0);
                *v22 = *v22 + arg0.tokens_per_purchase;
            } else {
                0x2::table::add<address, u64>(&mut arg0.token_allocations_public, v0, arg0.tokens_per_purchase);
            };
            arg0.total_tokens_allocated = arg0.total_tokens_allocated + arg0.tokens_per_purchase;
            let v23 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl1, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl1, v0)
            } else {
                0
            };
            let v24 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_wl2, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_wl2, v0)
            } else {
                0
            };
            let v25 = if (0x2::table::contains<address, u64>(&arg0.token_allocations_public, v0)) {
                *0x2::table::borrow<address, u64>(&arg0.token_allocations_public, v0)
            } else {
                0
            };
            let v26 = PurchaseEvent{
                buyer           : v0,
                amount          : v1,
                phase           : 2,
                purchase_number : v20,
            ...
            0x2::event::emit<PurchaseEvent>(v26);
            let v27 = TokenAllocationEvent{
                buyer                  : v0,
                tokens_allocated       : arg0.tokens_per_purchase,
                phase                  : 2,
                total_tokens_user      : v23 + v24 + v25,
                total_tokens_allocated : arg0.total_tokens_allocated,
            };
            0x2::event::emit<TokenAllocationEvent>(v27);
        };
        let v28 = arg0.total_raised + v1;
        if (arg0.total_tokens_allocated >= arg0.max_token_supply) {
            arg0.is_sold_out = true;
            arg0.current_phase = 3;
            let v29 = SoldOutEvent{
                total_raised           : v28,
                total_tokens_allocated : arg0.total_tokens_allocated,
                max_token_supply       : arg0.max_token_supply,
                timestamp              : v2,
            };
            0x2::event::emit<SoldOutEvent>(v29);
        };
        arg0.total_raised = v28;
