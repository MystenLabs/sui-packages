module 0xd7846fc200b809c6b4e64032263a2aa085712cf43478f0b227e4103cdfedabab::vault {
    ...
    public fun claim_referee_rewards<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xd7846fc200b809c6b4e64032263a2aa085712cf43478f0b227e4103cdfedabab::events::emit_referee_rewards_claimed_event(0x2::balance::value<T0>(&v2));
    ...
    public fun claim_referrer_rewards<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xd7846fc200b809c6b4e64032263a2aa085712cf43478f0b227e4103cdfedabab::events::emit_referrer_rewards_claimed_event(0x2::balance::value<T0>(&v2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v2, arg1), v0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<AdminCap>(v1, @0x773aa5b84cf4e58d7c6d12a7f1e3de2eeef7ab72ce6c15bb4a7699cdaf48f5f0);
        let v2 = Vault<0x2::sui::SUI>{
        ...
        0x2::transfer::share_object<Vault<0x2::sui::SUI>>(v2);
    }
