module 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::asset {
    struct AssetConfig has copy, drop, store {
        min_borrow_amount: u64,
        max_borrow_amount: u64,
        max_deposit_amount: u64,
        repay_fee_rate: 0xf01bf3d01c8f50247fdf597e3f565b865e00b4a20a01b353d44d71c993f36e9a::float::Decimal,
        liquidation_fee_rate: 0xf01bf3d01c8f50247fdf597e3f565b865e00b4a20a01b353d44d71c993f36e9a::float::Decimal,
    }

    struct Asset<phantom T0> has store, key {
        id: 0x2::object::UID,
        flash_loan_lock: bool,
        interest_model: 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::interest::InterestModel,
    }
    ...
    public(friend) fun new<T0>(arg0: 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::interest::InterestModel, arg1: AssetConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
    ...
    fun assert_not_equal_and_set<T0: copy + drop + store>(arg0: &mut 0x2::object::UID, arg1: T0, arg2: bool) {
        ...
        assert!(*v0 != arg2, 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::error::updating_with_same_value());
        *v0 = arg2;
    }
    ...
    public(friend) fun change_operation_status<T0>(arg0: &mut Asset<T0>, arg1: u8, arg2: bool) {
        ...
        if (*v0 == 0) {
            ...
            assert!(*v0 == 4, 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::error::invalid_operation_status());
            let v9 = &mut arg0.id;
    ...
    public(friend) fun interest_model<T0>(arg0: &Asset<T0>) : &0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::interest::InterestModel {
        &arg0.interest_model
    }

    public fun liquidation_fee_rate(arg0: &AssetConfig) : 0xf01bf3d01c8f50247fdf597e3f565b865e00b4a20a01b353d44d71c993f36e9a::float::Decimal {
    ...
    public(friend) fun new_asset_config(arg0: u64, arg1: u64, arg2: 0xf01bf3d01c8f50247fdf597e3f565b865e00b4a20a01b353d44d71c993f36e9a::float::Decimal, arg3: u64, arg4: 0xf01bf3d01c8f50247fdf597e3f565b865e00b4a20a01b353d44d71c993f36e9a::float::Decimal) : AssetConfig {
        AssetConfig{
    ...
    public fun repay_fee_rate(arg0: &AssetConfig) : 0xf01bf3d01c8f50247fdf597e3f565b865e00b4a20a01b353d44d71c993f36e9a::float::Decimal {
        arg0.repay_fee_rate
    }
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0xd71f23897be8e6a7543c612bba6d90fb7fb7b480101666b64ba3345f34859878::interest::InterestModel) {
