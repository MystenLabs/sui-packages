module 0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::market {
    ...
    public entry fun add_new_vault<T0, T1>(arg0: &0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::admin::AdminCap, arg1: &mut Market<T0, T1>) {
        let v0 = VaultName<T1>{dummy_field: false};
        0x2::bag::add<VaultName<T1>, 0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::pool::Vault<T1>>(&mut arg1.vaults, v0, 0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::pool::new_vault<T1>());
        let v1 = VaultCreated<T1>{dummy_field: false};
        0x2::event::emit<VaultCreated<T1>>(v1);
    }

    public fun create_market<T0, T1>(arg0: &0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::admin::AdminCap, arg1: 0x2::balance::Supply<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Market<T0, T1>{
    ...
    public fun unwrap_token<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::pool::unwrap<T1>(0x2::bag::borrow_mut<VaultName<T1>, 0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::pool::Vault<T1>>(&mut arg0.vaults, v1), v2, arg2, 0x2::balance::supply_value<T0>(&arg0.lp_supply));
    ...
    public entry fun update_market_fun_mask<T0, T1>(arg0: &0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::admin::AdminCap, arg1: &mut Market<T0, T1>, arg2: u256, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.fun_mask = arg2;
    ...
    public fun wrap_token<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = VaultName<T1>{dummy_field: false};
        let v2 = 0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::pool::wrap<T1>(0x2::bag::borrow_mut<VaultName<T1>, 0xd71b62d7c58929fd6cd3e27e2a517339050bed357d429b334c7e51cb12ac7913::pool::Vault<T1>>(&mut arg0.vaults, v1), 0x2::coin::into_balance<T1>(arg1), arg2, 0x2::balance::supply_value<T0>(&arg0.lp_supply));
