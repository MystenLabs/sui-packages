module 0xd7e5168d0fc05e89e552a13cedb88f410fbb7eeb70de1187578d05c83ccac8d2::launchpad_manager_config {
    ...
    public fun update_launch_admin(arg0: LaunchAdmin, arg1: address) {
        0x2::transfer::transfer<LaunchAdmin>(arg0, arg1);
        let v0 = LaunchAdminUpdatedEvent{new_admin: arg1};
        0x2::event::emit<LaunchAdminUpdatedEvent>(v0);
    }
