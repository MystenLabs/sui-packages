module 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_accountant {
    ...
    public fun accept_cooldown<T0>(arg0: &mut Accountant<T0>, arg1: &AccountantManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.accountant_id == 0x2::object::id<Accountant<T0>>(arg0), 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::unauthorized());
    ...
    public fun accept_manager<T0>(arg0: &mut Accountant<T0>, arg1: &AccountantManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::unauthorized());
        assert!(0x1::option::is_some<PendingManager>(&arg0.pending_manager), 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::no_pending_roles_change());
        let v0 = 0x1::option::extract<PendingManager>(&mut arg0.pending_manager);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.role_change_cooldown_secs, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::role_change_timelock_active());
    ...
    public fun create_accountant<T0>(arg0: address, arg1: address, arg2: address, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (AccountantAdminCap, AccountantManagerCap, AccountantProcessorCap) {
        assert!(arg0 != @0x0 && arg1 != @0x0, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::invalid_argument());
        assert!(arg2 != @0x0 && arg3 != @0x0, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::invalid_argument());
        assert!(arg2 != arg3, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::invalid_argument());
        assert!(arg4 > 0 && arg5 > 0, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::invalid_argument());
    ...
    public fun distribute_native<T0>(arg0: &mut Accountant<T0>, arg1: &AccountantProcessorCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.native_balance) >= arg2, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::insufficient_balance());
        let v0 = 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_math::mul_div(arg2, arg0.recipient_a_weight_bps, arg0.recipient_a_weight_bps + arg0.recipient_b_weight_bps);
        let v1 = arg2 - v0;
    ...
    public fun distribute_tokens<T0>(arg0: &mut Accountant<T0>, arg1: &AccountantProcessorCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::tx_context::sender(arg3) == arg0.processor, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::unauthorized());
        assert!(arg2 > 0, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::invalid_amount());
        assert!(0x2::balance::value<T0>(&arg0.token_balance) >= arg2, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::insufficient_balance());
        let v0 = 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_math::mul_div(arg2, arg0.recipient_a_weight_bps, arg0.recipient_a_weight_bps + arg0.recipient_b_weight_bps);
        let v1 = arg2 - v0;
    ...
    public fun update_split_ratio<T0>(arg0: &mut Accountant<T0>, arg1: &AccountantManagerCap, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg4) == arg0.manager, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::unauthorized());
        assert!(arg2 > 0 && arg3 > 0, 0xd7a7c8633d426bfa7484dd5a11150eef9f79b58c6da379fbba906077d108c271::stoken_errors::invalid_argument());
