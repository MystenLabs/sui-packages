module 0xd7a566b02316965124d0b61988c093b432f38fbe22463a33a2b40c8c904ee074::bluefin {
        ...
        if (arg4) {
            ...
            if (v2 >= arg5) {
                if (v2 == arg5) {
                    ...
                    let v3 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::calculate_swap_results<T0, T1>(arg1, true, true, v2 - arg5, 4295048026);
                    if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_swap_result_amount_calculated(&v3) == 0) {
                        (0x1::option::none<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::FlashSwapReceipt<T0, T1>>(), false)
                    } else {
                        let (v4, v5, v6) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::flash_swap<T0, T1>(arg6, arg0, arg1, true, true, v2 - arg5, 4295048026);
                ...
                let (v7, v8, v9) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::flash_swap<T0, T1>(arg6, arg0, arg1, false, false, arg5 - v2, 79226673515401279992447579045);
            ...
            if (v10 >= arg5) {
                let (v11, v12) = if (v10 == arg5) {
                    ...
                    let v13 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::calculate_swap_results<T0, T1>(arg1, false, true, v10 - arg5, 79226673515401279992447579045);
                    let (v14, v15) = if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_swap_result_amount_calculated(&v13) == 0) {
                        ...
                        let (v16, v17, v18) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::flash_swap<T0, T1>(arg6, arg0, arg1, false, true, v10 - arg5, 79226673515401279992447579045);
                ...
                let (v19, v20, v21) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::flash_swap<T0, T1>(arg6, arg0, arg1, true, false, arg5 - v10, 4295048026);
