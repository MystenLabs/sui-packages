module 0xd7b7a8feaad8852d07b3aa198e812ec03fe01f8588c5f91a6d512321e8850bdb::sui_safe {
    ...
    struct YieldLock has store, key {
        id: 0x2::object::UID,
        owner: address,
        start_time: u64,
        duration_ms: u64,
    ...
    public entry fun create_yield_lock<T0>(arg0: &Platform, arg1: &mut UserRegistry, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused_deposits, 6);
        assert!(arg3 > 0, 0);
        ...
        if (0x2::vec_map::contains<address, vector<0x2::object::ID>>(&arg1.yield_locks, &v3)) {
            0x1::vector::push_back<0x2::object::ID>(0x2::vec_map::get_mut<address, vector<0x2::object::ID>>(&mut arg1.yield_locks, &v3), 0x2::object::id<YieldLock>(&v4));
        } else {
            let v5 = 0x1::vector::empty<0x2::object::ID>();
            0x1::vector::push_back<0x2::object::ID>(&mut v5, 0x2::object::id<YieldLock>(&v4));
            0x2::vec_map::insert<address, vector<0x2::object::ID>>(&mut arg1.yield_locks, v3, v5);
        };
        0x2::transfer::public_transfer<YieldLock>(v4, v3);
        let v6 = YieldLockCreated{
            owner            : v3,
            principal_amount : v1,
            coin_type        : v0,
            start_time       : v2,
        ...
        0x2::event::emit<YieldLockCreated>(v6);
    }
    ...
    public entry fun withdraw_yield_lock<T0>(arg0: YieldLock, arg1: &mut Platform, arg2: &mut UserRegistry, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.paused_withdrawals, 6);
        ...
        let v12 = 0x2::coin::value<T0>(&arg3);
        let v13 = if (v12 >= v6) {
            v6
        } else {
            v12
        ...
        if (v23 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v23, arg5), v0);
        };
        if (v24 > 0) {
            let v25 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg3, v24, arg5));
            if (v16 > 0) {
        ...
        if (0x2::vec_map::contains<address, vector<0x2::object::ID>>(&arg2.yield_locks, &v0)) {
            ...
            remove_lock_id(v26, 0x2::object::uid_to_inner(&v10));
