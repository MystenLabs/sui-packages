module 0xd7ea9c4ad86fe706a8f75593405d6c729be8ee40985c530ca23610b3eca1fbae::ptb_types {
    ...
    public fun create_package_lookup(arg0: address, arg1: 0x1::string::String, arg2: u64) : OffchainLookup {
        OffchainLookup{
            lookup_type          : 4,
            parent_object        : arg0,
            lookup_key           : b"package",
            placeholder_name     : arg1,
            required_for_command : arg2,
        }
    }
    ...
    public fun discovered_data_to_bytes(arg0: &DiscoveredData) : vector<u8> {
        0x2::bcs::to_bytes<DiscoveredData>(arg0)
    }
