module 0xd7f588d9bbdcc4f14a1cc8a39a41e1d92af0db582b055d272f322ef13579213d::cnsnft4163 {
    struct CNSNFT4163 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4163, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4163>(arg0, arg1);
