module 0xd7171aa685f04230839ac3f1adcea2d83f8dca6b8fd8694002374fdef21b239b::bonding_curve {
    ...
    public(friend) fun buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0xd7171aa685f04230839ac3f1adcea2d83f8dca6b8fd8694002374fdef21b239b::locked_coin::LockedCoin<T0>, 0x2::balance::Balance<0x2::sui::SUI>) {
        assert!(!arg0.ended, 3);
        ...
        let v14 = if (v13 >= arg0.lock_amount || 0x2::clock::timestamp_ms(arg6) > arg0.unlock_timestamp) {
            0xd7171aa685f04230839ac3f1adcea2d83f8dca6b8fd8694002374fdef21b239b::locked_coin::zero<T0>(arg7)
        } else {
            ...
            v12 = v15;
            0xd7171aa685f04230839ac3f1adcea2d83f8dca6b8fd8694002374fdef21b239b::locked_coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, v15), arg7)
        };
        let v16 = 0x2::coin::from_balance<T0>(v11, arg7);
        ...
        if (0x2::balance::value<T0>(&arg0.coin_vault) == 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut v18, seed_to_dex<T0>(arg5, arg0, arg7));
        };
        (v16, v14, v18)
    }
    ...
    fun seed_to_dex<T0>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: &mut BondingCurve<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        let v4 = 0x2::balance::split<T0>(&mut arg1.to_dex_vault, v3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v4, (((v3 as u128) * ((10000 - arg1.to_dex_liquidity_pbs) as u128) / (10000 as u128)) as u64)), arg2), @0x0);
        ...
        let v5 = if (0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::swap_utils::is_ordered<0x2::sui::SUI, T0>()) {
            add_liquidity<0x2::sui::SUI, T0>(arg0, v1, v4, arg2)
        } else {
            add_liquidity<T0, 0x2::sui::SUI>(arg0, v4, v1, arg2)
        };
