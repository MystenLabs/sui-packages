module 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::misfits {
    ...
    fun mint_nft_(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: 0x1::ascii::String, arg4: 0x1::ascii::String, arg5: 0x1::ascii::String, arg6: 0x1::ascii::String, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: 0x1::ascii::String, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Misfit>, arg14: &mut 0x2::tx_context::TxContext) : Misfit {
        ...
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::background::Background, Witness>(v7, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::background::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg3)), arg14));
        let v8 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::clothing::Clothing, Witness>(v8, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::clothing::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg7)), arg14));
        let v9 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::eyes::Eyes, Witness>(v9, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::eyes::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg4)), arg14));
        let v10 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::mouth::Mouth, Witness>(v10, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::mouth::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg5)), arg14));
        let v11 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::facial_hair::FacialHair, Witness>(v11, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::facial_hair::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg6)), arg14));
        let v12 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::facewear::Facewear, Witness>(v12, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::facewear::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg9)), arg14));
        let v13 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::accessories::Accessory, Witness>(v13, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::accessories::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg10)), arg14));
        let v14 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::headwear::Headwear, Witness>(v14, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::headwear::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg8)), arg14));
        let v15 = Witness{dummy_field: false};
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::nft_bag::compose<0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::companion::Companion, Witness>(v15, &mut v6, 0xd7e5b73d1ca11e33b107541011585636145b94b898f3e8f50946e35ecae1789a::companion::mint_(0x1::string::utf8(0x1::ascii::into_bytes(arg11)), arg14));
