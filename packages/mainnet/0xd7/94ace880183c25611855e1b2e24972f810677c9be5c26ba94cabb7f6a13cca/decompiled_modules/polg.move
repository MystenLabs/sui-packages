module 0xd794ace880183c25611855e1b2e24972f810677c9be5c26ba94cabb7f6a13cca::polg {
    ...
    fun init(arg0: POLG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/aV8_fmEyWDHgCuMK?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<POLG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POLG    ")))), trim_right(b"PEPE GOLD                       "), trim_right(b"Pepe Gold  isn't just another flash in the pan; it's the meme coin that turns laughter into lasting value. Coins come and go, but Pepe Gold is here to stay. Join the fun, embrace the gold, be the gold, and be part of the gold revolution!                                                                                   "), v2, arg1);
        let v5 = v3;
