module 0x1a116140c5b1b13f33fef17ba2729034ddee66e4342a583c1d596cc1bfa2edd2::cnsnft9035 {
    struct CNSNFT9035 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9035, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9035>(arg0, arg1);
