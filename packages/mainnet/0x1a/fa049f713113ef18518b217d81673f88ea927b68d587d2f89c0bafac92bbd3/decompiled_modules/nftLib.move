module 0x1afa049f713113ef18518b217d81673f88ea927b68d587d2f89c0bafac92bbd3::nftLib {
        ...
        while (v0 <= 0x2::vec_map::size<u64, Achievement>(&arg0.achievements)) {
            ...
            while (v2 < 0x1::vector::length<u8>(&arg4)) {
                ...
                if (v3 == v1.achievementType) {
                    if (v1.communityId != arg2 && v1.communityId != 0x1afa049f713113ef18518b217d81673f88ea927b68d587d2f89c0bafac92bbd3::commonLib::getZeroId()) {
                        continue
                    };
