module 0x1a4129f51c68869dba988dc6a3eddcba7770f41ee0c46206437b5942b3bf175a::reward8062 {
    struct REWARD8062 has drop {
        dummy_field: bool,
    }

    struct TICKET_8062 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8062(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8062>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8062>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8062, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8062>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8062>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8062>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8062>>(v5, 0x2::tx_context::sender(arg1));
    }
