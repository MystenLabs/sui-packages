module 0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp {
    ...
    struct DestEngineInvoked has copy, drop {
        fn_is_withdraw: bool,
        src_eid: u32,
        layerzero_nonce: u64,
        guid: vector<u8>,
    ...
    struct AuthenticatedVaultRequest {
        src_eid: u32,
        layerzero_nonce: u64,
        guid: vector<u8>,
        account: address,
    ...
    public fun consume_vault_request_proof(arg0: AuthenticatedVaultRequest) : (u32, u64, vector<u8>, address, u64, vector<u8>) {
        let AuthenticatedVaultRequest {
            src_eid         : v0,
            layerzero_nonce : v1,
            guid            : v2,
            account         : v3,
    ...
    public fun receive_vault_request(arg0: &mut HubOApp, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::LzReceiveParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void>, arg3: &0x2::clock::Clock) {
        let (_, _, _, _, _, _) = consume_vault_request_proof(receive_vault_request_engine(arg0, arg1, arg2, arg3));
    }

    public fun receive_vault_request_engine(arg0: &mut HubOApp, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::LzReceiveParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void>, arg3: &0x2::clock::Clock) : AuthenticatedVaultRequest {
        assert!(is_registered(arg0), 2);
        assert_oapp(arg0, arg1);
        let v0 = 0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::lz_receive(arg1, &arg0.call_cap, arg2);
        assert!(0x1::option::is_none<0x2::coin::Coin<0x2::sui::SUI>>(0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::value(&v0)), 18);
        let v1 = 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::src_eid(&v0);
        assert!(is_supported_remote(v1), 11);
        let v2 = 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::nonce(&v0);
        let v3 = 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::guid(&v0);
        let v4 = 0x245ba36f7a1cc643a2b037450dff1e4399e18069c6545fb5fcaaf37d39d7dc::bytes32::to_bytes(&v3);
        assert!(0x1::vector::length<u8>(&v4) == 32, 13);
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.consumed_hub_guids, v4), 33);
        0x2::table::add<vector<u8>, bool>(&mut arg0.consumed_hub_guids, v4, true);
        let (v5, v6, v7) = decode_vault_request(*0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::message(&v0));
        let (_, _, _, _, _, _, _, v15) = 0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::destroy(v0);
        0x1::option::destroy_none<0x2::coin::Coin<0x2::sui::SUI>>(v15);
        let v16 = VaultRequestReceived{
            src_eid         : v1,
            layerzero_nonce : v2,
            guid            : v4,
            account         : v5,
        ...
        0x2::event::emit<VaultRequestReceived>(v16);
        let v17 = DestEngineInvoked{
            fn_is_withdraw  : false,
            src_eid         : v1,
            layerzero_nonce : v2,
            guid            : v4,
            account         : v5,
        ...
        0x2::event::emit<DestEngineInvoked>(v17);
        AuthenticatedVaultRequest{
            src_eid         : v1,
            layerzero_nonce : v2,
            guid            : v4,
            account         : v5,
