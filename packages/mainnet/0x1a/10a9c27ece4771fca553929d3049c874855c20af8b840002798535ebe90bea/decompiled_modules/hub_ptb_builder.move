module 0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_ptb_builder {
    ...
    public fun build_lz_receive_ptb(arg0: &0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp::HubOApp, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: &0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Call<0x31beaef889b08b9c3b37d19280fc1f8b75bae5b2de2410fc3120f403e9a36dac::lz_receive::LzReceiveParam, 0x28de9e8e087a6347001907fb698fdf8ab0467b342229b74b19264067aebc4ae9::call::Void>, arg3: &0x2::clock::Clock) : vector<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall> {
        ...
        if (v0 == 1) {
            ...
            0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall>(&mut v2, direct_receive_call(0x1::ascii::string(b"lz_receive_execution_outcome"), 0x2::object::id_address<0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp::HubOApp>(arg0), 0x2::object::id_address<0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp>(arg1), 0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::ptb_builder_helper::lz_receive_call_id(), 0x2::object::id_address<0x2::clock::Clock>(arg3)));
            v2
        } else if (v0 == 2) {
            let v3 = 0x1::vector::empty<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall>();
            let v4 = &mut v3;
            0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall>(v4, direct_receive_call(0x1::ascii::string(b"receive_hub_deposit"), 0x2::object::id_address<0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp::HubOApp>(arg0), 0x2::object::id_address<0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp>(arg1), 0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::ptb_builder_helper::lz_receive_call_id(), 0x2::object::id_address<0x2::clock::Clock>(arg3)));
            ...
            0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall>(&mut v5, direct_receive_call(0x1::ascii::string(b"receive_vault_request"), 0x2::object::id_address<0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp::HubOApp>(arg0), 0x2::object::id_address<0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp>(arg1), 0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::ptb_builder_helper::lz_receive_call_id(), 0x2::object::id_address<0x2::clock::Clock>(arg3)));
            v5
        } else {
            let v6 = 0x1::vector::empty<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall>();
            let v7 = &mut v6;
            0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall>(v7, direct_receive_call(0x1::ascii::string(b"receive_hub_withdraw_request"), 0x2::object::id_address<0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp::HubOApp>(arg0), 0x2::object::id_address<0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp>(arg1), 0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::ptb_builder_helper::lz_receive_call_id(), 0x2::object::id_address<0x2::clock::Clock>(arg3)));
            0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::move_call::MoveCall>(v7, consume_proof_call(0x1::ascii::string(b"consume_withdraw_proof")));
            v6
        }
    }
    ...
    fun is_evm_vault_request(arg0: &vector<u8>) : bool {
        if (0x1::vector::length<u8>(arg0) < 160) {
            return false
        };
        let v0 = 0;
        while (v0 < 31) {
        ...
        *0x1::vector::borrow<u8>(arg0, 31) == 1
    }

    public fun lz_receive_info(arg0: &0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp::HubOApp, arg1: &0xfdc28afc0110cb2edb94e3e57f2b1ce69b5a99c503b06d15e51cfa212de56e24::oapp::OApp, arg2: &0x2::clock::Clock) : vector<u8> {
        let v0 = 0x1::vector::empty<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>();
        let v1 = &mut v0;
        0x1::vector::push_back<0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::Argument>(v1, 0xc44d4a8623333b1a1d1397d23da4f12298b5763390f245dc7acba2ad98fbc2be::argument::create_object(0x2::object::id_address<0x653582ac275ffdd981bd78463fe4bd1c219f3a31d75c6b39eb324d5e00e9138a::hub_oapp::HubOApp>(arg0)));
