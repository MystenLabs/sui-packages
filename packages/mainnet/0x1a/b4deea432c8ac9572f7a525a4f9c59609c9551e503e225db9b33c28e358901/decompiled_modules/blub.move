module 0x1ab4deea432c8ac9572f7a525a4f9c59609c9551e503e225db9b33c28e358901::blub {
    ...
    fun init(arg0: BLUB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<BLUB>(&mut v2, 1000000000000000 * 0x1::u64::pow(10, 2), 0x2::tx_context::sender(arg1), arg1);
