module 0x1a084f9b3297504d404ed9e7466e2fbb52bcd68640493ed5c008a18078e5bf7a::secret_game_pass {
    struct SECRET_GAME_PASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SECRET_GAME_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SECRET_GAME_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Secret Game Pass"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"4974e2809973207365637265742e204e6f7720796f75206b6e6f772e"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiaotwq634ypl4cq2zq7lfqkcx6gxrj4el6jzbkxrvwdkc7ezdcxdq"));
