module 0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft {
    ...
    struct CommerceV5InitializedKey has copy, drop, store {
        dummy_field: bool,
    }

    struct CompositionV6InitializedKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct ProtocolFeeConfig has key {
        id: 0x2::object::UID,
        version: u64,
        treasury_id: 0x2::object::ID,
    ...
    struct ProtocolTreasury<phantom T0> has key {
        id: 0x2::object::UID,
        version: u64,
    ...
    struct ProtocolFeeAdminCap has store, key {
        id: 0x2::object::UID,
        version: u64,
        config_id: 0x2::object::ID,
        treasury_id: 0x2::object::ID,
    ...
    struct CanonicalSoulMintAuthorization {
    ...
    struct ProtocolFeesInitialized has copy, drop {
        config_id: 0x2::object::ID,
        treasury_id: 0x2::object::ID,
        admin_cap_id: 0x2::object::ID,
        payment_coin_type: 0x1::string::String,
    ...
    struct PrimaryMintRevenueSplit has copy, drop {
        maker_id: 0x2::object::ID,
        maker_treasury_id: 0x2::object::ID,
        protocol_treasury_id: 0x2::object::ID,
        payer: address,
    ...
    struct PrimaryProtocolFeeUpdated has copy, drop {
        config_id: 0x2::object::ID,
        fee_bps: u16,
    }

    struct ProtocolFeeEnabledUpdated has copy, drop {
        config_id: 0x2::object::ID,
        enabled: bool,
    }

    struct ProtocolRevenueWithdrawn has copy, drop {
        config_id: 0x2::object::ID,
        treasury_id: 0x2::object::ID,
        operator: address,
        recipient: address,
    ...
    public(friend) fun assert_item_exists_for_v5(arg0: &OCMaker, arg1: &0x1::string::String, arg2: &0x1::string::String) {
        assert_part_exists(arg0, arg1);
        assert!(item_exists(arg0, arg1, arg2), 14);
    }
    ...
    fun assert_protocol_fee_admin(arg0: &ProtocolFeeConfig, arg1: &ProtocolFeeAdminCap) {
        assert!(arg1.config_id == 0x2::object::id<ProtocolFeeConfig>(arg0), 43);
        assert!(arg1.treasury_id == arg0.treasury_id, 43);
    }

    fun assert_protocol_treasury_matches<T0>(arg0: &ProtocolFeeConfig, arg1: &ProtocolTreasury<T0>) {
        assert!(arg0.treasury_id == 0x2::object::id<ProtocolTreasury<T0>>(arg1), 44);
        assert!(arg1.config_id == 0x2::object::id<ProtocolFeeConfig>(arg0), 44);
        assert!(arg0.primary_mint_fee_bps <= 5000, 42);
    }
    ...
    public(friend) fun assert_valid_recipe_for_v5(arg0: &OCMaker, arg1: &vector<RecipeSlot>) {
        assert_valid_recipe(arg0, arg1);
    }

    fun assert_valid_royalty(arg0: u16) {
        assert!(arg0 <= 500 && arg0 % 50 == 0, 37);
    }
    ...
    public fun authorize_soul_mint_paid_with_protocol_fee<T0>(arg0: &OCMaker, arg1: &mut MakerTreasury<T0>, arg2: &ProtocolFeeConfig, arg3: &mut ProtocolTreasury<T0>, arg4: 0x2::coin::Coin<T0>, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<u8>, arg10: vector<RecipeSlot>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : CanonicalSoulMintAuthorization {
        assert!(arg0.minting_enabled, 35);
        assert!(arg0.mint_fee_enabled && arg0.mint_price_atomic > 0, 36);
        assert!(arg2.enabled, 45);
        let v0 = collect_mint_payment_with_protocol_fee<T0>(arg0, arg1, arg2, arg3, arg4, arg12);
        CanonicalSoulMintAuthorization{
            authorization          : new_soul_mint_authorization(arg0, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12),
            protocol_fee_config_id : 0x2::object::id<ProtocolFeeConfig>(arg2),
            protocol_treasury_id   : 0x2::object::id<ProtocolTreasury<T0>>(arg3),
            protocol_fee_bps       : arg2.primary_mint_fee_bps,
            protocol_fee_amount    : v0,
        }
    }

    public fun authorize_soul_mint_with_protocol_gate(arg0: &OCMaker, arg1: &ProtocolFeeConfig, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: vector<u8>, arg7: vector<RecipeSlot>, arg8: &0x2::clock::Clock, arg9: &0x2::tx_context::TxContext) : CanonicalSoulMintAuthorization {
        assert!(arg0.minting_enabled, 35);
        assert!(!arg0.mint_fee_enabled && arg0.mint_price_atomic == 0, 36);
        assert!(arg1.enabled, 45);
        assert!(arg1.primary_mint_fee_bps <= 5000, 42);
        CanonicalSoulMintAuthorization{
            authorization          : new_soul_mint_authorization(arg0, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9),
            protocol_fee_config_id : 0x2::object::id<ProtocolFeeConfig>(arg1),
            protocol_treasury_id   : arg1.treasury_id,
            protocol_fee_bps       : arg1.primary_mint_fee_bps,
            protocol_fee_amount    : 0,
        }
    }

    public fun canonical_soul_mint_authorization_payer(arg0: &CanonicalSoulMintAuthorization) : address {
        arg0.authorization.payer
    }

    public fun canonical_soul_mint_authorization_recipe_hash(arg0: &CanonicalSoulMintAuthorization) : &vector<u8> {
        &arg0.authorization.recipe_hash
    }

    public(friend) fun claim_commerce_v5_initializer(arg0: &ProtocolFeeConfig, arg1: &mut ProtocolFeeAdminCap) {
        assert_protocol_fee_admin(arg0, arg1);
        let v0 = CommerceV5InitializedKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists<CommerceV5InitializedKey>(&arg1.id, v0), 49);
        0x2::dynamic_field::add<CommerceV5InitializedKey, bool>(&mut arg1.id, v0, true);
    }

    public(friend) fun claim_composition_v6_initializer(arg0: &mut ProtocolFeeAdminCap) {
        let v0 = CompositionV6InitializedKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists<CompositionV6InitializedKey>(&arg0.id, v0), 50);
        0x2::dynamic_field::add<CompositionV6InitializedKey, u64>(&mut arg0.id, v0, 6);
    }

    fun collect_mint_payment_with_protocol_fee<T0>(arg0: &OCMaker, arg1: &mut MakerTreasury<T0>, arg2: &ProtocolFeeConfig, arg3: &mut ProtocolTreasury<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert_treasury_matches<T0>(arg0, arg1);
        assert_protocol_treasury_matches<T0>(arg2, arg3);
        let v0 = 0x2::coin::value<T0>(&arg4);
        assert!(v0 == arg0.mint_price_atomic, 36);
        let v1 = (((v0 as u128) * (arg2.primary_mint_fee_bps as u128) / 10000) as u64);
        let v2 = v0 - v1;
        if (v1 > 0) {
            0x2::coin::put<T0>(&mut arg3.revenue, 0x2::coin::split<T0>(&mut arg4, v1, arg5));
            arg3.total_collected = arg3.total_collected + v1;
        };
        0x2::coin::put<T0>(&mut arg1.revenue, arg4);
        arg1.total_collected = arg1.total_collected + v2;
        let v3 = MakerRevenueCollected{
            maker_id    : 0x2::object::id<OCMaker>(arg0),
            treasury_id : 0x2::object::id<MakerTreasury<T0>>(arg1),
            payer       : 0x2::tx_context::sender(arg5),
            amount      : v2,
        };
        0x2::event::emit<MakerRevenueCollected>(v3);
        let v4 = PrimaryMintRevenueSplit{
            maker_id             : 0x2::object::id<OCMaker>(arg0),
            maker_treasury_id    : 0x2::object::id<MakerTreasury<T0>>(arg1),
            protocol_treasury_id : 0x2::object::id<ProtocolTreasury<T0>>(arg3),
            payer                : 0x2::tx_context::sender(arg5),
            gross_amount         : v0,
            maker_amount         : v2,
        ...
        0x2::event::emit<PrimaryMintRevenueSplit>(v4);
        v1
    }

    public fun composition_v6_initialized_version(arg0: &ProtocolFeeAdminCap) : u64 {
        let v0 = CompositionV6InitializedKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<CompositionV6InitializedKey>(&arg0.id, v0)) {
            return 0
        };
        *0x2::dynamic_field::borrow<CompositionV6InitializedKey, u64>(&arg0.id, v0)
    }
    ...
    public fun consume_canonical_soul_mint_authorization(arg0: CanonicalSoulMintAuthorization) : (SoulMintAuthorization, 0x2::object::ID, 0x2::object::ID, u16, u64) {
        let CanonicalSoulMintAuthorization {
            authorization          : v0,
            protocol_fee_config_id : v1,
            protocol_treasury_id   : v2,
            protocol_fee_bps       : v3,
            protocol_fee_amount    : v4,
        } = arg0;
        (v0, v1, v2, v3, v4)
    }
    ...
    public(friend) fun disable_legacy_minting_for_v5<T0>(arg0: MakerAdminCap, arg1: &mut OCMaker, arg2: &MakerTreasury<T0>, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) : MakerAdminCap {
        assert_maker_admin(arg1, &arg0);
        assert_treasury_matches<T0>(arg1, arg2);
        assert!(arg1.published, 3);
        assert!(0x2::balance::value<T0>(&arg2.revenue) == 0, 38);
        arg1.minting_enabled = false;
        arg1.mint_fee_enabled = false;
        arg1.mint_price_atomic = 0;
        arg1.archived = true;
        ...
        let v0 = MakerEconomicsUpdated{
            ...
            mint_price_atomic : 0,
            royalty_bps       : arg1.policy.royalty_bps,
        };
        0x2::event::emit<MakerEconomicsUpdated>(v0);
        let v1 = OCMakerArchiveChanged{
            maker_id : 0x2::object::id<OCMaker>(arg1),
            creator  : 0x2::tx_context::sender(arg4),
            archived : true,
        };
        0x2::event::emit<OCMakerArchiveChanged>(v1);
        arg0
    }

    public fun hash_recipe_slots(arg0: &vector<RecipeSlot>) : vector<u8> {
        0x1::hash::sha2_256(0x1::bcs::to_bytes<vector<RecipeSlot>>(arg0))
    }
    ...
    public fun initialize_protocol_fees<T0>(arg0: 0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : ProtocolFeeAdminCap {
        assert!(0x2::package::from_package<ANIMACRAFT>(&arg0), 41);
        let (v0, v1, v2) = new_protocol_fee_objects<T0>(0x1::option::some<0x2::package::Publisher>(arg0), false, arg1);
        let v3 = v2;
        let v4 = v1;
        let v5 = v0;
        let v6 = ProtocolFeesInitialized{
            config_id            : 0x2::object::id<ProtocolFeeConfig>(&v5),
            treasury_id          : 0x2::object::id<ProtocolTreasury<T0>>(&v4),
            admin_cap_id         : 0x2::object::id<ProtocolFeeAdminCap>(&v3),
            payment_coin_type    : payment_coin_type_name<T0>(),
            primary_mint_fee_bps : 5000,
            enabled              : false,
        };
        0x2::event::emit<ProtocolFeesInitialized>(v6);
        0x2::transfer::share_object<ProtocolFeeConfig>(v5);
        0x2::transfer::share_object<ProtocolTreasury<T0>>(v4);
        v3
    }

    public(friend) fun item_blob_id_for_v5(arg0: &OCMaker, arg1: &0x1::string::String, arg2: &0x1::string::String) : 0x1::string::String {
        assert_part_exists(arg0, arg1);
        let v0 = PartKey{name: *arg1};
        ...
        while (v2 < 0x1::vector::length<ItemRecord>(v1)) {
            if (&0x1::vector::borrow<ItemRecord>(v1, v2).item_key == arg2) {
                return 0x1::vector::borrow<ItemRecord>(v1, v2).walrus_blob_id
            };
            v2 = v2 + 1;
        };
        abort 14
    ...
    public fun maker_manifest_blob_id(arg0: &OCMaker) : &0x1::string::String {
    ...
    public(friend) fun new_canonical_commerce_v5_authorization(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address, arg3: address, arg4: &OCMaker, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<u8>, arg10: 0x1::string::String, arg11: u64, arg12: vector<RecipeSlot>, arg13: 0x2::object::ID, arg14: 0x2::object::ID, arg15: u16, arg16: u64, arg17: &0x2::clock::Clock) : CanonicalSoulMintAuthorization {
        assert!(arg4.published, 3);
        assert_non_empty(&arg5);
        assert_max_bytes(&arg5, 128);
        assert_blob_id(&arg6);
        assert_blob_id(&arg7);
        assert_non_empty(&arg8);
        assert_max_bytes(&arg8, 512);
        assert!(0x1::vector::length<RecipeSlot>(&arg12) > 0 && 0x1::vector::length<RecipeSlot>(&arg12) <= 750, 7);
        assert!(0x1::vector::length<u8>(&arg9) == 32, 28);
        assert_valid_recipe(arg4, &arg12);
        let v0 = SoulMintAuthorization{
            version                : 5,
            maker_id               : arg0,
            maker_treasury_id      : arg1,
            maker_creator          : arg2,
            payer                  : arg3,
            name                   : arg5,
            ...
            image_url              : arg8,
            recipe_hash            : arg9,
            license_snapshot       : arg4.policy,
            mint_payment_coin_type : arg10,
            mint_price_atomic      : arg11,
            recipe                 : arg12,
            authorized_at_ms       : 0x2::clock::timestamp_ms(arg17),
        };
        CanonicalSoulMintAuthorization{
            authorization          : v0,
            protocol_fee_config_id : arg13,
            protocol_treasury_id   : arg14,
            protocol_fee_bps       : arg15,
            protocol_fee_amount    : arg16,
        }
    }
    ...
    fun new_protocol_fee_objects<T0>(arg0: 0x1::option::Option<0x2::package::Publisher>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) : (ProtocolFeeConfig, ProtocolTreasury<T0>, ProtocolFeeAdminCap) {
        let v0 = 0x2::object::new(arg2);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = ProtocolTreasury<T0>{
        ...
        let v3 = 0x2::object::id<ProtocolTreasury<T0>>(&v2);
        let v4 = ProtocolFeeConfig{
            id                   : v0,
            version              : 4,
            treasury_id          : v3,
            primary_mint_fee_bps : 5000,
    ...
    public fun new_recipe_slot(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64) : RecipeSlot {
        RecipeSlot{
            part_key     : arg0,
            item_key     : arg1,
            color_hex    : arg2,
    ...
    public fun primary_protocol_fee_bps(arg0: &ProtocolFeeConfig) : u16 {
        arg0.primary_mint_fee_bps
    }
    ...
    public fun protocol_fee_admin_config_id(arg0: &ProtocolFeeAdminCap) : 0x2::object::ID {
        arg0.config_id
    }

    public fun protocol_fee_admin_holds_publisher(arg0: &ProtocolFeeAdminCap) : bool {
        0x1::option::is_some<0x2::package::Publisher>(&arg0.publisher)
    }

    public fun protocol_fee_admin_treasury_id(arg0: &ProtocolFeeAdminCap) : 0x2::object::ID {
        arg0.treasury_id
    }

    public fun protocol_fee_config_id(arg0: &ProtocolFeeConfig) : 0x2::object::ID {
        0x2::object::id<ProtocolFeeConfig>(arg0)
    }

    public fun protocol_fee_config_version(arg0: &ProtocolFeeConfig) : u64 {
        arg0.version
    }

    public fun protocol_fee_enabled(arg0: &ProtocolFeeConfig) : bool {
        arg0.enabled
    }

    public fun protocol_fee_treasury_id(arg0: &ProtocolFeeConfig) : 0x2::object::ID {
        arg0.treasury_id
    }

    public fun protocol_treasury_balance<T0>(arg0: &ProtocolTreasury<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.revenue)
    }

    public fun protocol_treasury_config_id<T0>(arg0: &ProtocolTreasury<T0>) : 0x2::object::ID {
        arg0.config_id
    }

    public fun protocol_treasury_id<T0>(arg0: &ProtocolTreasury<T0>) : 0x2::object::ID {
        0x2::object::id<ProtocolTreasury<T0>>(arg0)
    }

    public fun protocol_treasury_total_collected<T0>(arg0: &ProtocolTreasury<T0>) : u64 {
        arg0.total_collected
    }

    public fun protocol_treasury_total_withdrawn<T0>(arg0: &ProtocolTreasury<T0>) : u64 {
        arg0.total_withdrawn
    }

    public fun protocol_treasury_version<T0>(arg0: &ProtocolTreasury<T0>) : u64 {
        arg0.version
    }
    ...
    public fun update_primary_protocol_fee_bps(arg0: &mut ProtocolFeeConfig, arg1: &ProtocolFeeAdminCap, arg2: u16) {
        assert_protocol_fee_admin(arg0, arg1);
        assert!(arg2 <= 5000, 42);
        arg0.primary_mint_fee_bps = arg2;
        let v0 = PrimaryProtocolFeeUpdated{
            config_id : 0x2::object::id<ProtocolFeeConfig>(arg0),
            fee_bps   : arg2,
        };
        0x2::event::emit<PrimaryProtocolFeeUpdated>(v0);
    }

    public fun update_protocol_fee_enabled(arg0: &mut ProtocolFeeConfig, arg1: &ProtocolFeeAdminCap, arg2: bool) {
        assert_protocol_fee_admin(arg0, arg1);
        arg0.enabled = arg2;
        let v0 = ProtocolFeeEnabledUpdated{
            config_id : 0x2::object::id<ProtocolFeeConfig>(arg0),
            enabled   : arg2,
        };
        0x2::event::emit<ProtocolFeeEnabledUpdated>(v0);
    }
    ...
    public fun withdraw_protocol_revenue<T0>(arg0: &ProtocolFeeConfig, arg1: &mut ProtocolTreasury<T0>, arg2: &ProtocolFeeAdminCap, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        assert_protocol_fee_admin(arg0, arg2);
        assert_protocol_treasury_matches<T0>(arg0, arg1);
        assert!(arg4 != @0x0, 42);
        assert!(arg3 > 0 && arg3 <= 0x2::balance::value<T0>(&arg1.revenue), 47);
        ...
        let v0 = ProtocolRevenueWithdrawn{
            config_id   : 0x2::object::id<ProtocolFeeConfig>(arg0),
            treasury_id : 0x2::object::id<ProtocolTreasury<T0>>(arg1),
            operator    : 0x2::tx_context::sender(arg5),
            recipient   : arg4,
            amount      : arg3,
        };
        0x2::event::emit<ProtocolRevenueWithdrawn>(v0);
    }
