module 0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::commerce_v5 {
    ...
    struct LegacyLogicalCompatibilityStateV5 has copy, drop, store {
        legacy_maker_id: 0x2::object::ID,
        protocol_config_id: 0x2::object::ID,
        protocol_admin_cap_id: 0x2::object::ID,
        registered_count: u64,
    }

    struct LegacyLogicalStyleApprovalKeyV5 has copy, drop, store {
        part_key: 0x1::string::String,
        item_key: 0x1::string::String,
        style_key: 0x1::string::String,
    }

    struct LegacyLogicalStyleApprovalV5 has copy, drop, store {
        legacy_maker_id: 0x2::object::ID,
        protocol_config_id: 0x2::object::ID,
        protocol_admin_cap_id: 0x2::object::ID,
        asset_blob_id: 0x1::string::String,
    ...
    struct IndependentExtensionLockStateV5 has copy, drop, store {
        authority_id: 0x2::object::ID,
        legacy_maker_id: 0x2::object::ID,
        protocol_config_id: 0x2::object::ID,
        protocol_admin_cap_id: 0x2::object::ID,
        owner: address,
        retired_control_cap_id: 0x2::object::ID,
    ...
    struct IndependentExtensionAuthorityV5 has key {
        id: 0x2::object::UID,
        version: u64,
        root_id: 0x2::object::ID,
        legacy_maker_id: 0x2::object::ID,
    ...
    struct LegacyLogicalStyleRegisteredV5 has copy, drop {
        root_id: 0x2::object::ID,
        legacy_maker_id: 0x2::object::ID,
        protocol_config_id: 0x2::object::ID,
        protocol_admin_cap_id: 0x2::object::ID,
    ...
    struct IndependentExtensionRootFinalizedV5 has copy, drop {
        root_id: 0x2::object::ID,
        authority_id: 0x2::object::ID,
        legacy_maker_id: 0x2::object::ID,
        protocol_config_id: 0x2::object::ID,
    ...
    public fun activate_maker_v5(arg0: &mut MakerRootV5, arg1: &MakerControlCapV5, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(!root_legacy_logical_compatibility_enabled_v5(arg0), 1);
    ...
    public(friend) fun assert_independent_extension_authority_v5(arg0: &MakerRootV5, arg1: &0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker, arg2: &IndependentExtensionAuthorityV5, arg3: &0x2::tx_context::TxContext) {
        assert_independent_extension_parent_paused_v5(arg0);
        assert_legacy_maker(arg0, arg1);
        assert!(0x1::option::is_none<0x2::object::ID>(&arg0.active_listing_id), 1);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.current_control_cap_id), 9);
        assert!(*0x1::option::borrow<0x2::object::ID>(&arg0.current_control_cap_id) == arg2.retired_control_cap_id, 9);
        assert!(arg0.ownership_epoch == arg2.locked_ownership_epoch, 9);
        assert!(arg0.current_owner == 0x2::tx_context::sender(arg3) && arg2.owner == 0x2::tx_context::sender(arg3), 10);
        assert!(arg2.root_id == 0x2::object::id<MakerRootV5>(arg0), 9);
        assert!(arg2.legacy_maker_id == 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker>(arg1), 7);
        assert!(arg2.protocol_config_id == arg0.protocol_config_id, 7);
        assert!(arg2.retired_control_cap_epoch < 18446744073709551615, 9);
        assert!(arg2.retired_control_cap_epoch + 1 == arg2.locked_ownership_epoch, 9);
        assert!(0x1::vector::length<u8>(&arg2.audit_hash) == 32, 53);
        assert!(arg0.release.style_registry_sealed, 34);
        assert_legacy_logical_compatibility_complete(arg0);
        let v0 = root_independent_extension_lock_v5(arg0);
        let v1 = if (v0.finalized) {
            if (v0.authority_id == 0x2::object::id<IndependentExtensionAuthorityV5>(arg2)) {
                if (v0.legacy_maker_id == arg2.legacy_maker_id) {
                    if (v0.protocol_config_id == arg2.protocol_config_id) {
                        if (v0.protocol_admin_cap_id == arg2.protocol_admin_cap_id) {
                            if (v0.owner == arg2.owner) {
                                if (v0.retired_control_cap_id == arg2.retired_control_cap_id) {
                                    if (v0.retired_control_cap_epoch == arg2.retired_control_cap_epoch) {
                                        if (v0.locked_ownership_epoch == arg2.locked_ownership_epoch) {
                                            v0.audit_hash == arg2.audit_hash
                                        } else {
                                            false
                                        }
                                    } else {
    ...
    fun assert_independent_extension_locked_state_v5(arg0: &MakerRootV5) {
        assert!(0x1::option::is_none<0x2::object::ID>(&arg0.active_listing_id), 1);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.current_control_cap_id), 9);
        assert!(arg0.release.style_registry_sealed, 34);
        let v0 = root_independent_extension_lock_v5(arg0);
        assert!(v0.finalized, 9);
        assert!(v0.legacy_maker_id == arg0.legacy_maker_id, 7);
        assert!(v0.protocol_config_id == arg0.protocol_config_id, 7);
        assert!(v0.retired_control_cap_id == *0x1::option::borrow<0x2::object::ID>(&arg0.current_control_cap_id), 9);
        assert!(v0.locked_ownership_epoch == arg0.ownership_epoch, 9);
        assert!(v0.retired_control_cap_epoch < 18446744073709551615, 9);
        assert!(v0.retired_control_cap_epoch + 1 == v0.locked_ownership_epoch, 9);
        assert!(0x1::vector::length<u8>(&v0.audit_hash) == 32, 53);
        assert_legacy_logical_compatibility_complete(arg0);
    }

    fun assert_independent_extension_operational(arg0: &MakerRootV5, arg1: &CommerceProtocolConfigV5) {
        assert_independent_extension_parent_paused_v5(arg0);
    ...
    public(friend) fun assert_independent_extension_operational_v5(arg0: &MakerRootV5, arg1: &CommerceProtocolConfigV5) {
        assert_independent_extension_operational(arg0, arg1);
        assert_independent_extension_locked_state_v5(arg0);
    }

    public(friend) fun assert_independent_extension_parent_paused_v5(arg0: &MakerRootV5) {
        assert!(arg0.lifecycle == 1, 1);
        assert_independent_extension_locked_state_v5(arg0);
    }

    fun assert_legacy_logical_compatibility_complete(arg0: &MakerRootV5) {
        let v0 = legacy_logical_compatibility_state_key_v5();
        if (!0x2::dynamic_field::exists<0x1::string::String>(&arg0.id, v0)) {
            return
        };
        let v1 = 0x2::dynamic_field::borrow<0x1::string::String, LegacyLogicalCompatibilityStateV5>(&arg0.id, v0);
        let v2 = if (v1.legacy_maker_id == arg0.legacy_maker_id) {
            if (v1.protocol_config_id == arg0.protocol_config_id) {
                if (v1.registered_count == 7) {
                    if (arg0.release.style_count == 26) {
                        0x1::vector::length<StyleBindingKeyV5>(&arg0.style_keys) == 26
                    } else {
                        false
                    }
                } else {
        ...
        let v6 = 0;
        let v7 = 0;
        while (v7 < 0x1::vector::length<StyleBindingKeyV5>(&arg0.style_keys)) {
            let v8 = *0x1::vector::borrow<StyleBindingKeyV5>(&arg0.style_keys, v7);
            let v9 = 0x2::table::borrow<StyleBindingKeyV5, StyleProductRecordV5>(&arg0.style_registry, v8);
            let v10 = legacy_logical_style_approval_key_v5(&v8);
            if (v9.row_kind == 0) {
                assert!(!0x2::dynamic_field::exists<LegacyLogicalStyleApprovalKeyV5>(&arg0.id, v10), 47);
                v3 = v3 + 1;
            } else {
                assert!(0x2::dynamic_field::exists<LegacyLogicalStyleApprovalKeyV5>(&arg0.id, v10), 47);
                let v11 = 0x2::dynamic_field::borrow<LegacyLogicalStyleApprovalKeyV5, LegacyLogicalStyleApprovalV5>(&arg0.id, v10);
                let v12 = if (v11.legacy_maker_id == v1.legacy_maker_id) {
                    if (v11.protocol_config_id == v1.protocol_config_id) {
                        if (v11.protocol_admin_cap_id == v1.protocol_admin_cap_id) {
                            if (v11.row_kind == v9.row_kind) {
                                v11.asset_blob_id != arg0.logical_auxiliary_blob_id
                            } else {
                                false
                            }
                        } else {
    ...
    fun assert_legacy_logical_compatibility_pristine(arg0: &MakerRootV5) {
        assert!(arg0.release.style_count == 19 && 0x1::vector::length<StyleBindingKeyV5>(&arg0.style_keys) == 19, 47);
        let v0 = 0;
        while (v0 < 0x1::vector::length<StyleBindingKeyV5>(&arg0.style_keys)) {
            let v1 = *0x1::vector::borrow<StyleBindingKeyV5>(&arg0.style_keys, v0);
            assert!(0x2::table::borrow<StyleBindingKeyV5, StyleProductRecordV5>(&arg0.style_registry, v1).row_kind == 0 && !0x2::dynamic_field::exists<LegacyLogicalStyleApprovalKeyV5>(&arg0.id, legacy_logical_style_approval_key_v5(&v1)), 47);
            v0 = v0 + 1;
        };
    }

    fun assert_legacy_logical_identity(arg0: &0x1::string::String, arg1: &0x1::string::String, arg2: &0x1::string::String, arg3: u8) {
        let v0 = 0x1::string::utf8(b"__ac_none");
        let v1 = 0x1::string::utf8(b"__animacraft_none__");
        let v2 = 0x1::string::utf8(b"__ac_color_");
        let v3 = 0x1::string::utf8(b"__animacraft_color__:");
        0x1::string::append(&mut v3, *arg1);
        if (arg3 == 1) {
            let v4 = if (arg1 == &v0) {
                if (arg2 == &v1) {
                    !has_non_empty_string_prefix(arg0, &v2)
                } else {
                    false
                }
            } else {
            ...
            assert!(arg3 == 2, 46);
            assert!(has_non_empty_string_prefix(arg0, &v2) && arg2 == &v3, 47);
        };
    }
    ...
    public(friend) fun collect_independent_extension_primary_payment_v5<T0>(arg0: &MakerRootV5, arg1: &CommerceProtocolConfigV5, arg2: &mut CommerceProtocolTreasuryV5<T0>, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_independent_extension_operational(arg0, arg1);
        assert_protocol_treasury<T0>(arg1, arg2);
        assert!(arg0.protocol_config_id == 0x2::object::id<CommerceProtocolConfigV5>(arg1), 7);
        assert!(&arg0.payment_coin_type == &arg1.payment_coin_type, 8);
    ...
    fun finalize_independent_extension_root_impl_v5<T0>(arg0: &mut MakerRootV5, arg1: &MakerTreasuryV5<T0>, arg2: MakerControlCapV5, arg3: &0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker, arg4: &CommerceProtocolConfigV5, arg5: &0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap, arg6: vector<0x1::string::String>, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: vector<u8>, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) : IndependentExtensionAuthorityV5 {
        assert_control(arg0, &arg2, arg11);
        assert_maker_treasury<T0>(arg0, arg1);
        assert!(0x2::balance::value<T0>(&arg1.revenue) == 0, 12);
        assert!(arg0.lifecycle == 1, 1);
        assert!(0x1::option::is_none<0x2::object::ID>(&arg0.active_listing_id), 1);
        assert!(!arg0.release.style_registry_sealed, 30);
        assert!(arg0.release.pack_count == 0 && 0x1::vector::length<0x1::string::String>(&arg0.pack_keys) == 0, 13);
        assert!(arg0.base_access_kind == 0, 3);
        assert!(arg0.base_purchase_price_atomic == 0, 18);
        assert!(arg0.release.protected_style_count == 0, 39);
        assert!(arg0.release.complete_output_count == 0, 41);
        assert!(arg0.release.total_completes == 0, 19);
        assert!(0x2::table::is_empty<address, EntitlementRecordV5>(&arg0.base_entitlement_registry), 16);
        assert!(0x2::table::is_empty<EntitlementKeyV5, EntitlementRecordV5>(&arg0.entitlement_registry), 16);
        assert!(0x2::table::is_empty<CompletionCountKeyV5, u64>(&arg0.completion_counts), 19);
        assert!(0x2::table::is_empty<vector<u8>, CompleteOutputRecordV5>(&arg0.complete_outputs), 41);
        assert!(!root_independent_extension_locked_v5(arg0), 9);
        assert_legacy_maker(arg0, arg3);
        assert!(arg0.protocol_config_id == 0x2::object::id<CommerceProtocolConfigV5>(arg4), 7);
        assert_protocol_admin(arg4, arg5);
        assert!(arg4.enabled, 6);
        assert_protocol_dependencies_bound(arg4);
        assert!(root_maker_release_evidence_bound_v5(arg0), 52);
        assert!(0x1::vector::length<u8>(&arg10) == 32, 53);
        let v0 = if (0x1::vector::length<0x1::string::String>(&arg6) == 26) {
            if (0x1::vector::length<0x1::string::String>(&arg7) == 26) {
                if (0x1::vector::length<0x1::string::String>(&arg8) == 26) {
                    0x1::vector::length<u8>(&arg9) == 26
                } else {
                    false
                }
            } else {
        ...
        assert!(v0, 47);
        assert!(arg0.release.style_count == 0 && 0x1::vector::length<StyleBindingKeyV5>(&arg0.style_keys) == 0, 47);
        let v1 = 0;
        while (v1 < 19) {
            assert!(*0x1::vector::borrow<u8>(&arg9, v1) == 0, 47);
            register_base_style_v5(arg0, &arg2, arg3, *0x1::vector::borrow<0x1::string::String>(&arg6, v1), *0x1::vector::borrow<0x1::string::String>(&arg7, v1), *0x1::vector::borrow<0x1::string::String>(&arg8, v1), arg11);
            v1 = v1 + 1;
        };
        assert_legacy_logical_compatibility_pristine(arg0);
        while (v1 < 26) {
            assert!(*0x1::vector::borrow<u8>(&arg9, v1) == 1 || *0x1::vector::borrow<u8>(&arg9, v1) == 2, 47);
            register_base_legacy_logical_style_v5(arg0, &arg2, arg3, arg4, arg5, *0x1::vector::borrow<0x1::string::String>(&arg6, v1), *0x1::vector::borrow<0x1::string::String>(&arg7, v1), *0x1::vector::borrow<0x1::string::String>(&arg8, v1), *0x1::vector::borrow<u8>(&arg9, v1), arg11);
            v1 = v1 + 1;
        };
        seal_style_registry_v5(arg0, &arg2, arg11);
        assert_legacy_logical_compatibility_complete(arg0);
        let v2 = 0x2::object::id<MakerControlCapV5>(&arg2);
        let v3 = arg2.ownership_epoch;
        assert!(v3 < 18446744073709551615, 9);
        let v4 = v3 + 1;
        arg0.ownership_epoch = v4;
        arg0.current_control_cap_id = 0x1::option::some<0x2::object::ID>(v2);
        ...
        let v10 = new_independent_extension_authority_v5(0x2::object::id<MakerRootV5>(arg0), 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker>(arg3), 0x2::object::id<CommerceProtocolConfigV5>(arg4), 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap>(arg5), v9, v2, v3, v4, arg10, arg11);
        let v11 = 0x2::object::id<IndependentExtensionAuthorityV5>(&v10);
        let v12 = IndependentExtensionLockStateV5{
            authority_id              : v11,
            legacy_maker_id           : 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker>(arg3),
            protocol_config_id        : 0x2::object::id<CommerceProtocolConfigV5>(arg4),
            protocol_admin_cap_id     : 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap>(arg5),
            owner                     : 0x2::tx_context::sender(arg11),
            retired_control_cap_id    : v2,
            retired_control_cap_epoch : v3,
            locked_ownership_epoch    : v4,
            audit_hash                : arg10,
            finalized                 : true,
        };
        0x2::dynamic_field::add<0x1::string::String, IndependentExtensionLockStateV5>(&mut arg0.id, independent_extension_lock_state_key_v5(), v12);
        let v13 = IndependentExtensionRootFinalizedV5{
            root_id                   : 0x2::object::id<MakerRootV5>(arg0),
            authority_id              : v11,
            legacy_maker_id           : 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker>(arg3),
            protocol_config_id        : 0x2::object::id<CommerceProtocolConfigV5>(arg4),
        ...
        0x2::event::emit<IndependentExtensionRootFinalizedV5>(v13);
        v10
    }

    public fun finalize_independent_extension_root_v5<T0>(arg0: &mut MakerRootV5, arg1: &MakerTreasuryV5<T0>, arg2: MakerControlCapV5, arg3: &0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker, arg4: &CommerceProtocolConfigV5, arg5: &0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap, arg6: vector<0x1::string::String>, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: vector<u8>, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<IndependentExtensionAuthorityV5>(finalize_independent_extension_root_impl_v5<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11));
    }
    ...
    public fun independent_extension_authority_audit_hash_v5(arg0: &IndependentExtensionAuthorityV5) : &vector<u8> {
        &arg0.audit_hash
    }

    public fun independent_extension_authority_id_v5(arg0: &IndependentExtensionAuthorityV5) : 0x2::object::ID {
        0x2::object::id<IndependentExtensionAuthorityV5>(arg0)
    }

    public fun independent_extension_authority_legacy_maker_id_v5(arg0: &IndependentExtensionAuthorityV5) : 0x2::object::ID {
        arg0.legacy_maker_id
    }

    public fun independent_extension_authority_locked_epoch_v5(arg0: &IndependentExtensionAuthorityV5) : u64 {
        arg0.locked_ownership_epoch
    }

    public fun independent_extension_authority_owner_v5(arg0: &IndependentExtensionAuthorityV5) : address {
        arg0.owner
    }

    public fun independent_extension_authority_root_id_v5(arg0: &IndependentExtensionAuthorityV5) : 0x2::object::ID {
        arg0.root_id
    }

    fun independent_extension_lock_state_key_v5() : 0x1::string::String {
        0x1::string::utf8(b"animacraft.independent-extension-lock.v5")
    }
    ...
    fun legacy_logical_compatibility_state_key_v5() : 0x1::string::String {
        0x1::string::utf8(b"animacraft.legacy-logical-compatibility.v5")
    }

    fun legacy_logical_style_approval_key_v5(arg0: &StyleBindingKeyV5) : LegacyLogicalStyleApprovalKeyV5 {
        LegacyLogicalStyleApprovalKeyV5{
            part_key  : arg0.part_key,
            item_key  : arg0.item_key,
            style_key : arg0.style_key,
        }
    }
    ...
    fun new_independent_extension_authority_v5(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: address, arg5: 0x2::object::ID, arg6: u64, arg7: u64, arg8: vector<u8>, arg9: &mut 0x2::tx_context::TxContext) : IndependentExtensionAuthorityV5 {
        IndependentExtensionAuthorityV5{
            id                        : 0x2::object::new(arg9),
            version                   : 5,
            root_id                   : arg0,
            legacy_maker_id           : arg1,
            protocol_config_id        : arg2,
            protocol_admin_cap_id     : arg3,
            owner                     : arg4,
            retired_control_cap_id    : arg5,
            retired_control_cap_epoch : arg6,
            locked_ownership_epoch    : arg7,
            audit_hash                : arg8,
        }
    }
    ...
    fun register_base_legacy_logical_style_v5(arg0: &mut MakerRootV5, arg1: &MakerControlCapV5, arg2: &0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::OCMaker, arg3: &CommerceProtocolConfigV5, arg4: &0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: u8, arg9: &0x2::tx_context::TxContext) {
        assert_control(arg0, arg1, arg9);
        assert!(arg0.protocol_config_id == 0x2::object::id<CommerceProtocolConfigV5>(arg3), 7);
        assert_protocol_admin(arg3, arg4);
        assert!(arg3.enabled, 6);
        assert_protocol_dependencies_bound(arg3);
        assert!(arg0.lifecycle == 1, 1);
        assert_configurable(arg0);
        ...
        assert!(arg8 == 1 || arg8 == 2, 46);
        assert_legacy_logical_identity(&arg5, &arg6, &arg7, arg8);
        0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::assert_item_exists_for_v5(arg2, &arg5, &arg6);
        let v0 = 0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::item_blob_id_for_v5(arg2, &arg5, &arg6);
        assert!(v0 != arg0.logical_auxiliary_blob_id, 47);
        assert!(0x1::option::is_some<0x1::string::String>(&arg3.logical_auxiliary_blob_id) && arg0.logical_auxiliary_blob_id == *0x1::option::borrow<0x1::string::String>(&arg3.logical_auxiliary_blob_id), 7);
        let v1 = legacy_logical_compatibility_state_key_v5();
        if (!0x2::dynamic_field::exists<0x1::string::String>(&arg0.id, v1)) {
            assert_legacy_logical_compatibility_pristine(arg0);
            let v2 = LegacyLogicalCompatibilityStateV5{
                legacy_maker_id       : 0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::maker_id(arg2),
                protocol_config_id    : 0x2::object::id<CommerceProtocolConfigV5>(arg3),
                protocol_admin_cap_id : 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap>(arg4),
                registered_count      : 0,
            };
            0x2::dynamic_field::add<0x1::string::String, LegacyLogicalCompatibilityStateV5>(&mut arg0.id, v1, v2);
        };
        let v3 = 0x2::dynamic_field::borrow<0x1::string::String, LegacyLogicalCompatibilityStateV5>(&arg0.id, v1);
        let v4 = if (v3.legacy_maker_id == 0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::maker_id(arg2)) {
            if (v3.protocol_config_id == 0x2::object::id<CommerceProtocolConfigV5>(arg3)) {
                if (v3.protocol_admin_cap_id == 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap>(arg4)) {
                    v3.registered_count < 7
                } else {
                    false
                }
            } else {
        ...
        assert!(v4, 47);
        let v5 = v3.registered_count + 1;
        let v6 = StyleBindingKeyV5{
            part_key  : arg5,
            item_key  : arg6,
            style_key : arg7,
        };
        assert!(!0x2::table::contains<StyleBindingKeyV5, StyleProductRecordV5>(&arg0.style_registry, v6), 31);
        let v7 = legacy_logical_style_approval_key_v5(&v6);
        assert!(!0x2::dynamic_field::exists<LegacyLogicalStyleApprovalKeyV5>(&arg0.id, v7), 31);
        let v8 = LegacyLogicalStyleApprovalV5{
            legacy_maker_id       : 0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::maker_id(arg2),
            protocol_config_id    : 0x2::object::id<CommerceProtocolConfigV5>(arg3),
            protocol_admin_cap_id : 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap>(arg4),
            asset_blob_id         : v0,
        ...
        0x2::dynamic_field::add<LegacyLogicalStyleApprovalKeyV5, LegacyLogicalStyleApprovalV5>(&mut arg0.id, v7, v8);
        0x1::vector::push_back<StyleBindingKeyV5>(&mut arg0.style_keys, v6);
        let v9 = StyleProductRecordV5{
            pack_key       : 0x1::option::none<0x1::string::String>(),
            asset_blob_id  : arg0.logical_auxiliary_blob_id,
            row_kind       : arg8,
            seal_protected : false,
        };
        0x2::table::add<StyleBindingKeyV5, StyleProductRecordV5>(&mut arg0.style_registry, v6, v9);
        arg0.release.style_count = arg0.release.style_count + 1;
        0x2::dynamic_field::borrow_mut<0x1::string::String, LegacyLogicalCompatibilityStateV5>(&mut arg0.id, v1).registered_count = v5;
        let v10 = LegacyLogicalStyleRegisteredV5{
            root_id               : 0x2::object::id<MakerRootV5>(arg0),
            legacy_maker_id       : 0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::maker_id(arg2),
            protocol_config_id    : 0x2::object::id<CommerceProtocolConfigV5>(arg3),
            protocol_admin_cap_id : 0x2::object::id<0x9678afa6b008ddd0637b7723e30beac1c2a1d096b39c76b103f1a1841dc1ffea::animacraft::ProtocolFeeAdminCap>(arg4),
            ...
            asset_blob_id         : v0,
            compat_index          : v5,
            style_count_after     : arg0.release.style_count,
        };
        0x2::event::emit<LegacyLogicalStyleRegisteredV5>(v10);
    }
    ...
    public fun root_independent_extension_lock_v5(arg0: &MakerRootV5) : &IndependentExtensionLockStateV5 {
        let v0 = independent_extension_lock_state_key_v5();
        assert!(0x2::dynamic_field::exists<0x1::string::String>(&arg0.id, v0), 9);
        0x2::dynamic_field::borrow<0x1::string::String, IndependentExtensionLockStateV5>(&arg0.id, v0)
    }

    public fun root_independent_extension_locked_v5(arg0: &MakerRootV5) : bool {
        0x2::dynamic_field::exists<0x1::string::String>(&arg0.id, independent_extension_lock_state_key_v5())
    }

    public fun root_legacy_logical_compatibility_count_v5(arg0: &MakerRootV5) : u64 {
        let v0 = legacy_logical_compatibility_state_key_v5();
        if (!0x2::dynamic_field::exists<0x1::string::String>(&arg0.id, v0)) {
            return 0
        };
        0x2::dynamic_field::borrow<0x1::string::String, LegacyLogicalCompatibilityStateV5>(&arg0.id, v0).registered_count
    }

    public fun root_legacy_logical_compatibility_enabled_v5(arg0: &MakerRootV5) : bool {
        0x2::dynamic_field::exists<0x1::string::String>(&arg0.id, legacy_logical_compatibility_state_key_v5())
    }
