module 0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::distributor {
    ...
    fun init(arg0: DISTRIBUTOR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::test_nft::TestNft>(&v4, v0, v2, arg1);
        0x2::display::update_version<0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::test_nft::TestNft>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::test_nft::TestNft>>(v5, 0x2::tx_context::sender(arg1));
        let v6 = Distributor{
    ...
    public entry fun mint_single(arg0: &DistributorCap, arg1: &mut Distributor, arg2: u64, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::test_nft::new(arg2, arg1.name, arg1.description, 0x1::option::some<0x1::string::String>(arg3), 0x1::option::some<0x1::string::String>(arg4), arg6);
        0x2::table::add<u64, 0x2::object::ID>(&mut arg1.registry, arg2, 0x2::object::id<0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::test_nft::TestNft>(&v0));
        let v1 = NFTMinted{
            nft_id : 0x2::object::id<0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::test_nft::TestNft>(&v0),
            minter : arg5,
        };
        0x2::event::emit<NFTMinted>(v1);
        0x2::transfer::public_transfer<0x1af21b950dad9e1af84b3238505f5c5309ab7821c8514e7edb5240d6c0217fbb::test_nft::TestNft>(v0, arg5);
