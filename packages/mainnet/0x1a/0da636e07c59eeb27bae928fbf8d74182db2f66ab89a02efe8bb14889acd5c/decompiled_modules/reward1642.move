module 0x1a0da636e07c59eeb27bae928fbf8d74182db2f66ab89a02efe8bb14889acd5c::reward1642 {
    struct REWARD1642 has drop {
        dummy_field: bool,
    }

    struct TICKET_1642 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1642(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1642>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1642>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1642, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1642>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1642>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1642>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1642>>(v5, 0x2::tx_context::sender(arg1));
    }
