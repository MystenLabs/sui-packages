module 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::umi_signer {
    ...
    public fun approve_with_tx(arg0: &mut UmiSigner, arg1: ChainId, arg2: &0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicy, arg3: 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningRequest, arg4: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg5: u32, arg6: u32, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) : (0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::MessageApproval, BorrowReceipt) {
        assert!(has_wallet(arg0, arg1), 3);
        assert!(0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::signer_id(&arg3) == 0x2::object::id<UmiSigner>(arg0), 7);
        assert!(0x2::object::id<0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicy>(arg2) == arg0.policy_id, 8);
        assert!(0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::has_rule<0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::message_validation_rule::Rule>(arg2), 9);
        let v0 = 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::intent_hash(&arg3);
        let v1 = 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::chain_id(&arg3);
        let v2 = 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::new_request(v1, v0, 0x2::object::id<UmiSigner>(arg0), arg8);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::copy_receipts(&arg3, &mut v2);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::destroy_request(arg3);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::message_validation_rule::prove_with_message(&mut v2, arg2, v1, arg7);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::enforce_request(arg2, &v2);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::destroy_request(v2);
        let v3 = WalletKey{pos0: arg1};
        let v4 = 0x2::dynamic_field::remove<WalletKey, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&mut arg0.id, v3);
        let v5 = 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v4);
        let v6 = LockKey{pos0: arg1};
        let v7 = WalletKey{pos0: arg1};
        let v8 = BorrowedWallet{
            wallet_id : v5,
            locked    : 0x2::dynamic_field::exists_<LockKey>(&arg0.id, v6),
        };
        0x2::dynamic_field::add<WalletKey, BorrowedWallet>(&mut arg0.id, v7, v8);
        arg0.last_owner_activity_ts = 0x2::tx_context::epoch_timestamp_ms(arg8);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::signing_occurred(0x2::object::id<UmiSigner>(arg0), arg1.name, v5, v0);
        let v9 = BorrowReceipt{
            signer_id : 0x2::object::id<UmiSigner>(arg0),
            chain_id  : arg1,
            wallet_id : v5,
        };
        (v4, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::approve_message(arg4, &v4, arg5, arg6, arg7), v9)
    }

    public fun borrow_for_signing(arg0: &mut UmiSigner, arg1: ChainId, arg2: &0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicy, arg3: 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningRequest, arg4: &mut 0x2::tx_context::TxContext) : (0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, BorrowReceipt) {
        assert!(has_wallet(arg0, arg1), 3);
        assert!(0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::signer_id(&arg3) == 0x2::object::id<UmiSigner>(arg0), 7);
        assert!(0x2::object::id<0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicy>(arg2) == arg0.policy_id, 8);
        assert!(!0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::has_rule<0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::message_validation_rule::Rule>(arg2), 9);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::enforce_request(arg2, &arg3);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::destroy_request(arg3);
        ...
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::signing_occurred(0x2::object::id<UmiSigner>(arg0), arg1.name, v2, 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::intent_hash(&arg3));
    ...
    entry fun default(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::share(v3);
        0x2::transfer::transfer<UmiSignerOwnerCap>(v2, v0);
        0x2::transfer::public_transfer<0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicyCap>(v4, v0);
    }
    ...
    public fun lock(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: 0x2::object::ID, arg4: &0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicy, arg5: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, arg6: 0x1::option::Option<0x2::object::ID>, arg7: &0x2::tx_context::TxContext) {
        ...
        if (v0) {
            ...
            0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::user_share_registered(0x2::object::id<UmiSigner>(arg0), arg2.name, v1, v2);
        } else {
            0x1::option::destroy_none<0x2::object::ID>(arg6);
        };
        arg0.last_owner_activity_ts = 0x2::tx_context::epoch_timestamp_ms(arg7);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::wallet_placed(0x2::object::id<UmiSigner>(arg0), arg2.name, 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&arg5), true);
    }
    ...
    public fun new_with_policy(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : (UmiSigner, UmiSignerOwnerCap, 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicy, 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicyCap) {
        let (v0, v1) = 0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::new(arg1);
        let v2 = v1;
        let v3 = v0;
        let v4 = UmiSigner{
            id                     : 0x2::object::new(arg1),
            owner                  : arg0,
            policy_id              : 0x2::object::id<0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::signing_policy::SigningPolicy>(&v3),
            wallet_count           : 0,
        ...
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::authorization_rule::add(&mut v3, &v2, v6);
        (v4, v5, v3, v2)
    }
    ...
    public fun place(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: 0x2::object::ID, arg4: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, arg5: 0x1::option::Option<0x2::object::ID>, arg6: &0x2::tx_context::TxContext) {
        ...
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::wallet_placed(0x2::object::id<UmiSigner>(arg0), arg2.name, 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&arg4), false);
    }
    ...
    public fun register_user_share(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: address, arg4: 0x2::object::ID, arg5: &0x2::tx_context::TxContext) {
        ...
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::user_share_registered(0x2::object::id<UmiSigner>(arg0), arg2.name, arg3, arg4);
    }
    ...
    public fun unregister_user_share(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: address, arg4: &0x2::tx_context::TxContext) {
        ...
        arg0.last_owner_activity_ts = 0x2::tx_context::epoch_timestamp_ms(arg4);
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::user_share_unregistered(0x2::object::id<UmiSigner>(arg0), arg2.name, arg3, 0x2::dynamic_field::remove<UserShareKey, 0x2::object::ID>(&mut arg0.id, v0));
    }
    ...
    public fun withdraw(arg0: &mut UmiSigner, arg1: &UmiSignerOwnerCap, arg2: ChainId, arg3: &0x2::tx_context::TxContext) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap {
        ...
        0x1a6309586a92f2df092b85205eb29e720f422d23d0d922b5228d42a0d882b52b::events::wallet_withdrawn(0x2::object::id<UmiSigner>(arg0), arg2.name, 0x2::object::id<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v1));
        v1
    }
