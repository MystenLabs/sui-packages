module 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::reward {
    ...
    public fun claim_reward<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::VeTokenVault<T0>, arg2: &mut 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::VoteEscrowedToken<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        update_reward_distributions<T0>(arg0, arg1, arg3);
        update_nft_reward(arg0, 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::nft_id<T0>(arg2), 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::nft_locked_amount<T0>(arg2), arg4);
        let v0 = 0x1::type_name::get<T1>();
        let v1 = 0x2::table::borrow_mut<address, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&mut arg0.nft_unclaimed_rewards, 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::nft_id<T0>(arg2));
    ...
    public(friend) fun create_reward_manager<T0>(arg0: &mut 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::VeTokenVault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::vault_id<T0>(arg0);
        ...
        0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::set_reward_manager<T0>(arg0, 0x2::object::uid_to_address(&v1.id));
    ...
    public(friend) fun distribute_reward<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::VeTokenVault<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::get<T1>();
    ...
    public(friend) fun set_reward_rate<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::VeTokenVault<T0>, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::get<T1>();
        update_reward_distribution<T0>(arg0, arg1, arg3, v0);
    ...
    public fun update_reward_distribution<T0>(arg0: &mut RewardManager, arg1: &mut 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::VeTokenVault<T0>, arg2: &0x2::clock::Clock, arg3: 0x1::type_name::TypeName) {
        ...
        let v5 = (0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::vault_total_locked_balance<T0>(arg1) as u256);
        if (v3 > 0 && v5 > 0) {
    ...
    public fun update_reward_distributions<T0>(arg0: &mut RewardManager, arg1: &mut 0x1a9040ee1221693597d41604a7d3a6ac0e6673f53c942f2e7bd79168ddf05d45::vault::VeTokenVault<T0>, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::vec_map::keys<0x1::type_name::TypeName, Distribution>(&arg0.distributions);
        let v1 = &v0;
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x1::type_name::TypeName>(v1)) {
