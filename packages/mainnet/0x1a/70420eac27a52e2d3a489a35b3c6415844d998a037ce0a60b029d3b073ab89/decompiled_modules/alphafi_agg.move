module 0x1a70420eac27a52e2d3a489a35b3c6415844d998a037ce0a60b029d3b073ab89::alphafi_agg {
    struct AlphafiAgg has drop {
        dummy_field: bool,
    }

    public fun swap<T0: drop>(arg0: &0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::router::Router, arg1: &mut 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap::SwapContext, arg2: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<T0>, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: bool, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        if (arg4) {
            let v0 = AlphafiAgg{dummy_field: false};
            let v1 = swap_a2b<T0>(arg2, arg3, 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap::take_balance<AlphafiAgg, 0x2::sui::SUI>(arg1, arg0, v0, arg5), arg6);
            ...
            let v3 = swap_b2a<T0>(arg2, arg3, 0xdff285b435d5c3f25c9dc0d820e1ac3aa34195b43677ae9a519c5d7ad60cd63d::swap::take_balance<AlphafiAgg, T0>(arg1, arg0, v2, arg5), arg6);
