module 0x1ae006077198a118422daac60cf8f45be747e21eb1325e6d053f4ead54140439::points {
    ...
    public fun burn_points<T0: drop>(arg0: &mut PointsManager<T0>, arg1: 0x2::coin::Coin<0x2a094736a1d4e08e71069a65eb5ef9fb6da2f5f0d76679947f8f4499b13af8d0::suilend_point::SUILEND_POINT>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = arg0.ratio;
        let v1 = 0x2::coin::value<0x2a094736a1d4e08e71069a65eb5ef9fb6da2f5f0d76679947f8f4499b13af8d0::suilend_point::SUILEND_POINT>(&arg1) * v0.numerator / v0.denominator;
        assert!(v1 <= 0x2::balance::value<T0>(&arg0.balance), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2a094736a1d4e08e71069a65eb5ef9fb6da2f5f0d76679947f8f4499b13af8d0::suilend_point::SUILEND_POINT>>(arg1, @0x0);
