module 0x1a8030383676140111bf453c60cfda101ba84a7d2b19004edef37a5df3af5370::oracle_utils {
    ...
    public fun calculate_amplitude(arg0: u256, arg1: u256) : u64 {
        ...
        if (v0 > 0x2::address::max() / (0x1a8030383676140111bf453c60cfda101ba84a7d2b19004edef37a5df3af5370::oracle_constants::multiple() as u256)) {
            return 18446744073709551615
        };
        let v1 = v0 * (0x1a8030383676140111bf453c60cfda101ba84a7d2b19004edef37a5df3af5370::oracle_constants::multiple() as u256) / arg0;
