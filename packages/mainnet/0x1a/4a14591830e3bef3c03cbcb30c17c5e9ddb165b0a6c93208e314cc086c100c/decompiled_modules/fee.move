module 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::fee {
    ...
    struct FeeStore<phantom T0> has store {
        ...
        jackpot_store: 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::JackpotStore<T0>,
    ...
    public(friend) fun distribute_fee<T0>(arg0: &mut FeeStore<T0>, arg1: Fee, arg2: u64, arg3: u64, arg4: u64, arg5: 0x2::balance::Balance<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(v2, arg1.gov1, v1);
        let v4 = 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(v2, arg1.gov2, v1);
        let v5 = 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(v2, arg1.jackpot, v1);
        let v6 = v2 - v3 - v4 - v5;
        let v7 = &mut arg5;
        ...
        0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::add_price_balance<T0>(&mut arg0.jackpot_store, arg5);
        0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::event::swap_back_event<T0>(arg2, arg3, arg4, v3, v4, v5, v6);
    }
    ...
    public(friend) fun get_fee_amount<T0>(arg0: &mut FeeStore<T0>, arg1: u64, arg2: Fee) : (u64, u64, u64, 0x2::balance::Balance<T0>) {
        let v0 = 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(arg1, arg2.burn, arg2.total);
        let v1 = 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(arg1, arg2.liquidity, arg2.total);
        let v2 = 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(arg1, arg2.bonus, arg2.total);
        (v0, v1, v2, 0x2::balance::split<T0>(&mut arg0.fee_pool, arg1 - v0 - v1 - v2))
    }

    public fun get_jackpot_store<T0>(arg0: &FeeStore<T0>) : &0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::JackpotStore<T0> {
        &arg0.jackpot_store
    }
    ...
    public(friend) fun initialize<T0>(arg0: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price_info::PriceInfoObject, arg1: &mut 0x2::tx_context::TxContext) : FeeStore<T0> {
        ...
        FeeStore<T0>{
            ...
            jackpot_store   : 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::create_jackpot<T0>(arg0),
    ...
    public(friend) fun lottery_jackpot<T0>(arg0: &0x2::clock::Clock, arg1: &mut FeeStore<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::lottery<T0>(arg0, &mut arg1.jackpot_store, arg2);
    }
    ...
    public(friend) fun should_take_fee<T0, T1>(arg0: address, arg1: &FeeStore<T0>) : bool {
        let v0 = 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::utils::get_type_name_str<T1>();
    ...
    public(friend) fun take_fee<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: bool, arg3: &mut FeeStore<T0>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, Fee) {
        let v0 = if (arg2) {
            0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::trade_event<T0>(0x2::coin::value<T0>(&arg0), arg1, &mut arg3.jackpot_store, arg4);
            arg3.buy_fee
        } else {
            arg3.sell_fee
        };
        let v1 = v0;
        0x2::balance::join<T0>(&mut arg3.fee_pool, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg0, 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(0x2::coin::value<T0>(&arg0), v1.total, 10000), arg4)));
        0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::event::take_fee_event<T0>(0x2::tx_context::sender(arg4), 0x2::coin::value<T0>(&arg0), arg2);
        (arg0, v1)
    }
    ...
    public(friend) fun update_jackpot_bonus<T0>(arg0: &mut FeeStore<T0>, arg1: u64, arg2: u64) {
        0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::update_bonus<T0>(&mut arg0.jackpot_store, arg1, arg2);
    }
    ...
    public(friend) fun update_price<T0>(arg0: &mut FeeStore<T0>, arg1: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::state::State, arg2: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot::update_price<T0>(&mut arg0.jackpot_store, arg1, arg2, arg3);
    }
