module 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::jackpot {
    ...
    fun get_positive_price(arg0: 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price::Price, arg1: u64) : u64 {
        ...
        if (0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_is_negative(&v0)) {
            ...
            if (0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_is_negative(&v2)) {
                0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::mul_div(arg1, 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_positive(&v0), 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::pow(10, (0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_negative(&v2) as u8)))
            } else {
                arg1 * 0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_positive(&v0) * 0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::math::pow(10, (0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::i64::get_magnitude_if_positive(&v2) as u8))
            }
        }
    }
    ...
    public(friend) fun lottery<T0>(arg0: &0x2::clock::Clock, arg1: &mut JackpotStore<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < v1) {
            ...
            if (get_random(arg0, arg1.total_probability, 0x2::tx_context::epoch_timestamp_ms(arg2)) < v5) {
                ...
                0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::event::winner_event<T0>(v4.id, arg1.round, v4.user, v6);
                v3 = v1;
            };
            v3 = v3 + 1;
        };
    ...
    public(friend) fun trade_event<T0>(arg0: u64, arg1: u64, arg2: &mut JackpotStore<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 > 0) {
            ...
            0x1a4a14591830e3bef3c03cbcb30c17c5e9ddb165b0a6c93208e314cc086c100c::event::new_tick_event<T0>(arg2.round, v0, v3, arg0, v1);
        };
    }
