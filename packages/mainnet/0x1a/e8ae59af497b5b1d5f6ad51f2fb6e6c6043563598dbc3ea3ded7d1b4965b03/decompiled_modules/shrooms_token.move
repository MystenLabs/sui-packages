module 0x1ae8ae59af497b5b1d5f6ad51f2fb6e6c6043563598dbc3ea3ded7d1b4965b03::shrooms_token {
    ...
    public entry fun create_farm(arg0: &mut GameState, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Farm{
            ...
            mushrooms          : 10,
            level              : 1,
            last_harvest_epoch : 0x2::tx_context::epoch(arg2),
    ...
    public fun get_farm_info(arg0: &GameState, arg1: u64) : (address, u64, u64, u64, u64) {
        ...
        (v0.owner, v0.mushrooms, v0.level, v0.last_harvest_epoch, v0.created_at_epoch)
    }
    ...
    public entry fun harvest(arg0: &mut GameState, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 0x2::tx_context::epoch(arg2);
        let v2 = 0x1::vector::borrow_mut<Farm>(&mut arg0.farms, arg1);
        assert!(v2.owner == v0, 1);
        let v3 = v1 - v2.last_harvest_epoch;
        assert!(v3 > 0, 3);
        let v4 = calculate_yield(v2.mushrooms, v3, v2.level);
        0x2::transfer::public_transfer<0x2::coin::Coin<SHROOMS_TOKEN>>(0x2::coin::mint<SHROOMS_TOKEN>(&mut arg0.treasury_cap, v4, arg2), v0);
        v2.last_harvest_epoch = v1;
