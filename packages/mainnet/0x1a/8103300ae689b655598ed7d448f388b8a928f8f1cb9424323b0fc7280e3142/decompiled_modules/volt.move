module 0x1a8103300ae689b655598ed7d448f388b8a928f8f1cb9424323b0fc7280e3142::volt {
    ...
    fun init(arg0: VOLT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<VOLT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"VOLT    ")))), trim_right(b"VOLT WIN                        "), trim_right(b"Make VOLT.WIN Great Again                                                                                                                                                                                                                                                                                                       "), v2, arg1);
