module 0x1a3c6c3f263abf91c5a34e83c5c56fb8399e0851f60aa99b0808005b7e96bec3::dialog_management {
    ...
    public entry fun send_message(arg0: &mut UserDialogs, arg1: &mut UserDialogHashes, arg2: &mut ChatCounts, arg3: vector<u8>, arg4: address, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        if (!0x2::table::contains<vector<u8>, 0x2::table::Table<u64, Message>>(&arg0.dialogs, arg3)) {
            0x2::table::add<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg3, 0x2::table::new<u64, Message>(arg6));
