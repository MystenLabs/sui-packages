module 0x1a79c1611ab49723b388510813553ad912d96a4f1a9ed5fdbdb57e446c6fe946::error {
    ...
    public fun insufficient_credit_to_unsuspend(arg0: bool) {
        assert!(arg0, 13906834436338090011);
    }

    public fun insufficient_payment(arg0: bool) {
        assert!(arg0, 13906834951738097751);
    }

    public fun invalid_consent_signature(arg0: bool) {
    ...
    public fun invalid_window_size(arg0: bool) {
        assert!(arg0, 13906834934558097493);
    }
    ...
    public fun item_already_owned(arg0: bool) {
        assert!(arg0, 13906834968918098009);
    }
    ...
    public fun nonce_already_used(arg0: bool) {
