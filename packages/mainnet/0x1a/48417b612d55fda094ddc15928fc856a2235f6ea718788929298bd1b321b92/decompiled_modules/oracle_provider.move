module 0x1a48417b612d55fda094ddc15928fc856a2235f6ea718788929298bd1b321b92::oracle_provider {
    ...
    fun abs_diff_u64(arg0: u64, arg1: u64) : u64 {
        if (arg0 > arg1) {
            arg0 - arg1
        } else {
            arg1 - arg0
    ...
    fun ceil_div_ms_to_secs(arg0: u64) : u64 {
        if (arg0 % 1000 == 0) {
            arg0 / 1000
        } else {
            arg0 / 1000 + 1
    ...
    public fun cleanup_price_update_request(arg0: &mut OracleProvider, arg1: 0x1::string::String, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(0x2::table::contains<u64, PriceUpdateRequest>(&arg0.price_update_requests, arg2), 11);
        let v0 = 0x2::table::borrow<u64, PriceUpdateRequest>(&arg0.price_update_requests, arg2);
        assert!(v0.asset_id == arg1, 11);
        assert!(v0.executed || 0x2::clock::timestamp_ms(arg3) > v0.expires_at, 19);
        0x2::table::remove<u64, PriceUpdateRequest>(&mut arg0.price_update_requests, arg2);
    }
    ...
    fun get_current_price_from_pyth(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &vector<u8>, arg3: &0x2::clock::Clock, arg4: u64) : u64 {
        ...
        assert!(abs_diff_u64(0x2::clock::timestamp_ms(arg3) / 1000, 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_timestamp(&v2)) <= ceil_div_ms_to_secs(arg4), 1);
        ...
        let v5 = if (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v4)) {
            ...
            if (v6 > (8 as u64)) {
                (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v3) as u128) / 0x1a48417b612d55fda094ddc15928fc856a2235f6ea718788929298bd1b321b92::math_utils::safe_pow(10, ((v6 - (8 as u64)) as u128))
            } else {
                0x1a48417b612d55fda094ddc15928fc856a2235f6ea718788929298bd1b321b92::math_utils::safe_mul_u128((0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v3) as u128), 0x1a48417b612d55fda094ddc15928fc856a2235f6ea718788929298bd1b321b92::math_utils::safe_pow(10, (((8 as u64) - v6) as u128)))
            }
        } else {
    ...
    fun get_price_data_from_pyth(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &vector<u8>, arg3: &0x2::clock::Clock, arg4: u64) : PriceData {
        let v0 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::get_price_info_from_price_info_object(arg1);
        let v1 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::get_price_identifier(&v0);
        assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v1) == *arg2, 4);
        let v2 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::pyth::get_price(arg0, arg1, arg3);
        let v3 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_timestamp(&v2);
        let v4 = abs_diff_u64(0x2::clock::timestamp_ms(arg3) / 1000, v3) <= ceil_div_ms_to_secs(arg4);
        assert!(v4, 1);
        ...
        let v7 = if (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v6)) {
            ...
            if (v8 > (8 as u64)) {
                (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v5) as u128) / 0x1a48417b612d55fda094ddc15928fc856a2235f6ea718788929298bd1b321b92::math_utils::safe_pow(10, ((v8 - (8 as u64)) as u128))
            } else {
                0x1a48417b612d55fda094ddc15928fc856a2235f6ea718788929298bd1b321b92::math_utils::safe_mul_u128((0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v5) as u128), 0x1a48417b612d55fda094ddc15928fc856a2235f6ea718788929298bd1b321b92::math_utils::safe_pow(10, (((8 as u64) - v8) as u128)))
            }
        } else {
    ...
    fun get_pyth_price(arg0: &OracleProvider, arg1: 0x1::string::String, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock) : u64 {
        ...
        get_current_price_from_pyth(arg2, arg3, &0x2::table::borrow<0x1::string::String, PriceFeedConfig>(&arg0.price_feeds, arg1).pyth_feed_id, arg4, arg0.staleness_threshold)
    }
    ...
    fun get_pyth_price_data(arg0: &OracleProvider, arg1: 0x1::string::String, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock) : PriceData {
        assert!(0x2::table::contains<0x1::string::String, PriceFeedConfig>(&arg0.price_feeds, arg1), 6);
        get_price_data_from_pyth(arg2, arg3, &0x2::table::borrow<0x1::string::String, PriceFeedConfig>(&arg0.price_feeds, arg1).pyth_feed_id, arg4, arg0.staleness_threshold)
    }
    ...
    fun is_pyth_price_fresh(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : bool {
        ...
        abs_diff_u64(0x2::clock::timestamp_ms(arg2) / 1000, 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_timestamp(&v0)) <= ceil_div_ms_to_secs(864000000)
    }
    ...
    public fun set_staleness_threshold(arg0: &mut OracleProvider, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 16);
        assert!(arg1 > 0, 15);
        arg0.staleness_threshold = arg1;
    }
