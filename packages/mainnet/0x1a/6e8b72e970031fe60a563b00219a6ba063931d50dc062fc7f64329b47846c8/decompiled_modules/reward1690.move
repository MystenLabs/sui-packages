module 0x1a6e8b72e970031fe60a563b00219a6ba063931d50dc062fc7f64329b47846c8::reward1690 {
    struct REWARD1690 has drop {
        dummy_field: bool,
    }

    struct TICKET_1690 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1690(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1690>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1690>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1690, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1690>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1690>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1690>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1690>>(v5, 0x2::tx_context::sender(arg1));
    }
