module 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::big_vector {
    ...
    fun slice_redistribute<T0: store, T1: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: u64) : u128 {
        ...
        let (v8, v22, v23) = if (v2 && v19) {
            ...
            let v25 = v11;
            let v26 = 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::obutils::pop_n<u128>(&mut v25, v18);
            0x1::vector::append<u128>(&mut v8, v25);
            (v8, *0x1::vector::borrow<u128>(&v26, 0), v26)
        } else {
            let (v27, v8, v28) = if (!v2 && v19) {
                let v29 = 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::obutils::pop_until<u128>(&mut v8, v17);
                ...
                (0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::obutils::pop_n<u128>(&mut v30, v18 - 1), v8, 0x1::vector::pop_back<u128>(&mut v30))
            };
            (v8, v28, v27)
        };
        let v31 = Slice<T1>{
