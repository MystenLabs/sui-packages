module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools {
    ...
    public fun get_processing_resource_mul(arg0: &TOOL) : u64 {
    ...
    public fun get_processing_resource_mul_v2(arg0: &TOOL) : u64 {
        assert!(arg0.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_sledgehammer() || arg0.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_mould_deckle(), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_invalid_tool());
        let v0 = get_attributes(arg0);
        let v1 = 0x1::string::utf8(b"Tier");
        let v2 = 0x1::string::utf8(b"Quality");
        let v3 = 0x1::vector::empty<u64>();
    ...
    public fun get_processing_time_mul(arg0: &TOOL) : u64 {
        let v0 = get_attributes(arg0);
        let v1 = 0x1::string::utf8(b"Tier");
        let v2 = 0x1::string::utf8(b"Quality");
        let v3 = 0x1::vector::empty<u64>();
