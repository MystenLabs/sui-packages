module 0x1a184ecf7d0652f8f1285a3b0b2e644bf86ae1742317fcdaa9b11a7f3a30bd70::memez_vesting {
    ...
    fun linear_vesting_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        if (arg3 < arg0) {
            return 0
        };
        if (arg3 > arg0 + arg1) {
    ...
    public fun vesting_status<T0>(arg0: &MemezVesting<T0>, arg1: &0x2::clock::Clock) : u64 {
        linear_vesting_amount(arg0.start, arg0.duration, 0x2::balance::value<T0>(&arg0.balance) + arg0.released, 0x2::clock::timestamp_ms(arg1)) - arg0.released
    }
