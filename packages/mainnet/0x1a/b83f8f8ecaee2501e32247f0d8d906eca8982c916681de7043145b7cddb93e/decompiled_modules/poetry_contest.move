module 0x1ab83f8f8ecaee2501e32247f0d8d906eca8982c916681de7043145b7cddb93e::poetry_contest {
    ...
    public entry fun create_contest(arg0: vector<u8>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<Contest>(v1);
    }

    public entry fun mutate_manager(arg0: address, arg1: &mut Contest, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.manager == 0x2::tx_context::sender(arg2), 5);
        arg1.manager = arg0;
    }

    public entry fun submit_poem<T0: store + key>(arg0: &T0, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Contest, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::string::from_ascii(0x1::type_name::get_address(&v1)) == 0x1::string::utf8(b"0x9c97500fd49fd0f13b753bed6fd0352eb199c1bb026d3340d25c7ace8bb8b5fc"), 3);
        let v2 = 0x2::object::id_address<T0>(arg0);
        let v3 = Vote{
            poemId        : v2,
            owner_address : 0x2::tx_context::sender(arg4),
            votes         : 0,
        };
        0x2::table::add<address, Vote>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::table::Table<address, Vote>>(&mut arg2.id, 0x1::string::utf8(b"votes")), v2, v3);
        0x2::coin::put<0x2::sui::SUI>(&mut arg2.funds, arg1);
    }

    public entry fun vote<T0: store + key>(arg0: address, arg1: &T0, arg2: &mut Contest, arg3: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg3);
        ...
        v2.votes = v2.votes + 1;
        0x2::table::add<address, address>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::table::Table<address, address>>(&mut arg2.id, 0x1::string::utf8(b"voted")), 0x2::object::id_address<T0>(arg1), arg0);
    }

    public entry fun withdraw_proceeds(arg0: &mut Contest, arg1: &mut 0x2::tx_context::TxContext) {
