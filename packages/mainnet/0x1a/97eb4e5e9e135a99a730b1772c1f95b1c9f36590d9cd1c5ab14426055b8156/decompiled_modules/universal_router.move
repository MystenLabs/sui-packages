module 0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::universal_router {
    ...
    public(friend) fun new<T0, T1>(arg0: &mut 0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::partner_manager::PartnerRegistry, arg1: 0x1::option::Option<0x1::string::String>, arg2: 0x2::coin::Coin<T0>, arg3: u256, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) : Trade<T0, T1> {
        if (arg5 > 1000000) {
            abort 2
        };
        let v0 = 0x1::vector::empty<Route>();
        let v1 = 0;
        while (0x1::vector::is_empty<u64>(&arg7)) {
            let v2 = 0x1::vector::pop_back<u64>(&mut arg7);
            v1 = v1 + v2;
            let v3 = Route{
                trade_id  : arg3,
                amount_in : 0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::math::mul_div(0x2::coin::value<T0>(&arg2), v2, 100),
                current   : 0,
                paths     : 0x2::bag::new(arg8),
            };
            0x1::vector::push_back<Route>(&mut v0, v3);
        };
        if (v1 != 100) {
            abort 6
        };
        let v4 = Trade<T0, T1>{
            ...
            deadline            : arg6,
            coin_in             : arg2,
            coin_out            : 0x2::coin::zero<T1>(arg8),
            routes              : v0,
            partner             : arg1,
        };
        if (0x1::option::is_some<0x1::string::String>(&arg1)) {
            0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::partner_manager::collect_commission_if_necessary<T0>(arg0, *0x1::option::borrow<0x1::string::String>(&arg1), &mut v4.coin_in, true, arg8);
        };
        v4
    }
    ...
    public entry fun set_fee_on(arg0: &0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::admin_cap::AdminCap, arg1: &mut Treasury, arg2: bool) {
        arg1.fee_on = arg2;
    }

    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: &mut 0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::partner_manager::PartnerRegistry, arg2: Trade<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let Trade {
            trade_id            : v0,
            amount_in           : v1,
        ...
        if (0x2::coin::value<T1>(&v11) < 0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::math::mul_div(1000000 - v3, v2, 1000000)) {
            abort 1
        };
        0x1::vector::destroy_empty<Route>(v10);
        refund_if_necessary<T0>(v5, 0x2::tx_context::sender(arg4));
        let v12 = &mut v11;
        pay_router_fee_if_necessary<T1>(arg0, v12, v2, arg4);
        if (0x1::option::is_some<0x1::string::String>(&v9)) {
            0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::partner_manager::collect_commission_if_necessary<T1>(arg1, 0x1::option::destroy_some<0x1::string::String>(v9), &mut v11, false, arg4);
        } else {
            0x1::option::destroy_none<0x1::string::String>(v9);
        };
        let v13 = Swap{
    ...
    public entry fun withdraw<T0>(arg0: &0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
