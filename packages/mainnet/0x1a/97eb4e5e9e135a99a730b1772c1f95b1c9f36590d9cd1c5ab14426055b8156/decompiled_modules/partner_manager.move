module 0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::partner_manager {
    ...
    public(friend) fun collect_commission_if_necessary<T0>(arg0: &mut PartnerRegistry, arg1: 0x1::string::String, arg2: &mut 0x2::coin::Coin<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&v0.commissions, 0x1::type_name::get<T0>())) {
            ...
            let v2 = if (v1.type == 1) {
                if (v1.value > 0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::math::mul_div(0x2::coin::value<T0>(arg2), arg0.max_comission_percentage, 1000000)) {
                    abort 2
                };
                v1.value
            } else {
                0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::math::mul_div(0x2::coin::value<T0>(arg2), v1.value, 1000000)
            };
            if (arg3 && v1.level == 0) {
    ...
    public entry fun register_partner(arg0: &0x1a97eb4e5e9e135a99a730b1772c1f95b1c9f36590d9cd1c5ab14426055b8156::admin_cap::AdminCap, arg1: &mut PartnerRegistry, arg2: vector<u8>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(arg2);
