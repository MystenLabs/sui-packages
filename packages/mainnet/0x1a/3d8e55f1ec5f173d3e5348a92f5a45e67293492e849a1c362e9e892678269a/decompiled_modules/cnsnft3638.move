module 0x1a3d8e55f1ec5f173d3e5348a92f5a45e67293492e849a1c362e9e892678269a::cnsnft3638 {
    struct CNSNFT3638 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3638, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8652"));
        let v4 = 0x2::package::claim<CNSNFT3638>(arg0, arg1);
