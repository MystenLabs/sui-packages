module 0x1a58d346861021bd38bb18e46eaac0f8695e51421e89fee9317e500e335fb7f4::reward5084 {
    struct REWARD5084 has drop {
        dummy_field: bool,
    }

    struct TICKET_5084 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5084(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5084>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5084>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5084, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5084>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5084>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5084>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5084>>(v5, 0x2::tx_context::sender(arg1));
    }
