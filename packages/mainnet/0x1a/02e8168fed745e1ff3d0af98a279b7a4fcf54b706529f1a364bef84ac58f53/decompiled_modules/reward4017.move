module 0x1a02e8168fed745e1ff3d0af98a279b7a4fcf54b706529f1a364bef84ac58f53::reward4017 {
    struct REWARD4017 has drop {
        dummy_field: bool,
    }

    struct TICKET_4017 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4017(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4017>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4017>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4017, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4017>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4017>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4017>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4017>>(v5, 0x2::tx_context::sender(arg1));
    }
