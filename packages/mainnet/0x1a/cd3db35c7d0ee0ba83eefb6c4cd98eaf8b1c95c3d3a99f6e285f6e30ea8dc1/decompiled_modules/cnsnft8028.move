module 0x1acd3db35c7d0ee0ba83eefb6c4cd98eaf8b1c95c3d3a99f6e285f6e30ea8dc1::cnsnft8028 {
    struct CNSNFT8028 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8028, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8028>(arg0, arg1);
