module 0x1a03084e7f5205824220122f1eef75fd3798f1f26f253e1e5bdf68bddb0bc4a5::gift8572 {
    struct GIFT8572 has drop {
        dummy_field: bool,
    }

    struct TICKET_8572 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8572(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8572>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8572>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8572, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8572>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8572>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8572>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8572>>(v5, 0x2::tx_context::sender(arg1));
    }
