module 0x1a4e2f10ab05189d36fdef18ebefa0916fae6bfbe082acbc8ac09229d27dcff6::state {
    ...
    public(friend) fun deposit_into_extension<T0, T1>(arg0: &mut ExtensionStateV1<T0>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(v2)) {
            if (0x1::vector::borrow<0x1::type_name::TypeName>(v2, v3) == &v1) {
                v4 = 0x1::option::some<u64>(v3);
                /* label 8 */
                let v5 = if (0x1::option::is_none<u64>(&v4)) {
                    let v6 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserves<T0>(v0);
                    let v7 = 0;
                    let v5;
                    while (v7 < 0x1::vector::length<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::Reserve<T0>>(v6)) {
                        let v8 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::coin_type<T0>(0x1::vector::borrow<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::Reserve<T0>>(v6, v7));
                        if (&v8 == &v1) {
                            /* label 17 */
                            let v9 = 0x1::option::some<u64>(v7);
                            if (0x1::option::is_none<u64>(&v9)) {
                                abort 3
                            };
                            0x1::vector::push_back<0x1::type_name::TypeName>(&mut arg0.coin_types, v1);
                            0x1::vector::push_back<u64>(&mut arg0.reserve_indexes, 0x1::option::extract<u64>(&mut v9));
                            v5 = 0x1::vector::length<0x1::type_name::TypeName>(&arg0.coin_types) - 1;
                            /* goto 21 */
                        } else {
                            /* goto 22 */
                        };
                ...
                /* label 21 */
                let v10 = *0x1::vector::borrow<u64>(&arg0.reserve_indexes, v5);
                0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::deposit_ctokens_into_obligation<T0, T1>(arg1, v10, &arg0.obligation_owner_cap, arg3, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::deposit_liquidity_and_mint_ctokens<T0, T1>(arg1, v10, arg3, arg2, arg4), arg4);
                return
                /* label 22 */
                /* goto 12 */
                continue;
    ...
    public(friend) fun withdraw_from_extension<T0, T1>(arg0: &ExtensionStateV1<T0>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::redeem_ctokens_and_withdraw_liquidity<T0, T1>(arg1, v1, arg3, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::withdraw_ctokens<T0, T1>(arg1, v1, &arg0.obligation_owner_cap, arg3, 0x1::u64::min(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::ceil(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::div(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(arg2), 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::ctoken_ratio<T0>(v0))), 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::obligation::deposited_ctoken_amount<T0, T1>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::obligation<T0>(arg1, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::obligation_id<T0>(&arg0.obligation_owner_cap)))), arg4), 0x1::option::none<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::RateLimiterExemption<T0, T1>>(), arg4)
    }
