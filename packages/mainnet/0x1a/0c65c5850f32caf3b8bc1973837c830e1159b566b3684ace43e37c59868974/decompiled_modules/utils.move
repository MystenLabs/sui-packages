module 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::utils {
    public fun are_coins_suitable<T0, T1>() : bool {
        assert!(0x1::type_name::get<T0>() != 0x1::type_name::get<T1>(), 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::errors::select_different_coins());
        true
    }
    ...
    public fun assert_coin_integrity<T0, T1, T2>(arg0: &0x2::coin::TreasuryCap<T0>, arg1: &0x2::coin::CoinMetadata<T0>, arg2: &0x2::coin::TreasuryCap<T2>, arg3: &0x2::coin::CoinMetadata<T2>) {
        ...
        assert!(0x1::type_name::get<T1>() == 0x1::type_name::get<0x2::sui::SUI>(), 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::errors::invalid_quote_token());
    ...
    public fun assert_coin_integrity_tm<T0>(arg0: &0x2::coin::TreasuryCap<T0>, arg1: &0x2::coin::CoinMetadata<T0>) {
        assert!(0x2::coin::get_decimals<T0>(arg1) == 6, 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::errors::meme_and_ticket_coins_must_have_6_decimals());
        assert!(0x2::coin::total_supply<T0>(arg0) == 0, 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::errors::should_have_0_total_supply());
    }

    public fun assert_ticket_coin_integrity<T0, T1, T2>(arg0: &0x2::coin::CoinMetadata<T0>) {
        assert!(0x2::coin::get_decimals<T0>(arg0) == 6, 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::errors::meme_and_ticket_coins_must_have_6_decimals());
    ...
    fun assert_ticket_coin_otw<T0, T1, T2>() {
        ...
        assert!(0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::comparator::eq(&v5), 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::errors::wrong_module_name());
    }
