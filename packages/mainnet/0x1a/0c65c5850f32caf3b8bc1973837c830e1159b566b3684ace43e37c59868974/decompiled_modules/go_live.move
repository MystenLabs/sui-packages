module 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::go_live {
    struct AddLiquidityHook has drop {
        dummy_field: bool,
    }

    public fun go_live<T0, T1, T2>(arg0: &0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::admin::Admin, arg1: 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::seed_pool::SeedPool, arg2: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: 0x2::coin::TreasuryCap<T2>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg7);
        go_live_<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::vesting::new_config(v0, v0 + arg5, v0 + arg6), arg7, arg8);
    }

    public fun go_live_<T0, T1, T2>(arg0: &0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::admin::Admin, arg1: 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::seed_pool::SeedPool, arg2: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: 0x2::coin::TreasuryCap<T2>, arg5: 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::vesting::VestingConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, _, _, v7, v8) = 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::seed_pool::destroy_pool<T0, 0x2::sui::SUI, T1>(arg1);
        let v9 = v4;
        let v10 = v1;
        let v11 = v0;
        assert!(v7, 0);
        ...
        assert!(v12 == 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::utils::mist(30000), 0);
        ...
        let v13 = 0x2::balance::split<T1>(&mut v9, 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::math::div_mul(0x2::balance::value<T1>(&v9), 10000, 8000));
        ...
        0x2::transfer::public_share_object<0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::staking_pool::StakingPool<T0, T1, T2>>(0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::staking_pool::new<T0, T1, T2>(0x2::object::id<0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::interest_pool::InterestPool<0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::curves::Volatile>>(&v27), v9, 0x2::coin::into_balance<T2>(v26), arg5, v25, v8, arg7));
    ...
    public fun go_live_default<T0, T1, T2>(arg0: &0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::admin::Admin, arg1: 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::seed_pool::SeedPool, arg2: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: 0x2::coin::TreasuryCap<T2>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        go_live_<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, 0x1a0c65c5850f32caf3b8bc1973837c830e1159b566b3684ace43e37c59868974::vesting::default_config(arg5), arg5, arg6);
    }
