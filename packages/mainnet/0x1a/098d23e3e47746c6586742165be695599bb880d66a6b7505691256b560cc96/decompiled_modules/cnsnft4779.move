module 0x1a098d23e3e47746c6586742165be695599bb880d66a6b7505691256b560cc96::cnsnft4779 {
    struct CNSNFT4779 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4779, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6988"));
        let v4 = 0x2::package::claim<CNSNFT4779>(arg0, arg1);
