module 0x1abccc994a96fd03c789304c1a31313f55269b9216f2941660ab00643a2119a2::reward3234 {
    struct REWARD3234 has drop {
        dummy_field: bool,
    }

    struct TICKET_3234 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3234(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3234>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3234>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3234, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3234>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3234>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3234>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3234>>(v5, 0x2::tx_context::sender(arg1));
    }
