module 0x1aff0a5b46f071ec3c8f7cba35c554b9292698171d1ef99a229718d4564ae7f3::suiaifun {
    ...
    public entry fun bot_start_new_coin<T0>(arg0: &mut SuiAiFun, arg1: 0x2::coin::CoinMetadata<T0>, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: address, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v1;
        buy<T0>(arg0, v3, 0, arg3, @0x66f25ca6d8edc0bb161b53e67eac7bf7e680251dc095cb4f973f10051f9d63cb, arg11);
    ...
    public entry fun buy<T0>(arg0: &mut SuiAiFun, arg1: &mut Pool<T0>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 4);
        ...
        if (v1 > 0) {
            ...
            let (v3, v4) = if (v1 * (10000 - arg0.fee_bps) / 10000 < v2) {
                let v4 = 0x2::coin::split<0x2::sui::SUI>(&mut arg3, v1 * arg0.fee_bps / 10000, arg5);
                (0x2::coin::value<0x2::sui::SUI>(&arg3), v4)
            } else {
                let v5 = v2 * arg0.fee_bps / (10000 - arg0.fee_bps);
                let v4 = 0x2::coin::split<0x2::sui::SUI>(&mut arg3, v5, arg5);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, v1 - v2 - v5, arg5), v0);
                arg1.complete = true;
                (v2, v4)
            };
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.pool_coin, (v6 as u64), arg5), v0);
            let v7 = 0x2::coin::value<0x2::sui::SUI>(&v4);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v4, v7 / 20 * 7, arg5), arg1.creator);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v4, v7 / 8, arg5), arg4);
            ...
            if (arg1.complete == true) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.pool_coin, 0x2::balance::value<T0>(&arg1.pool_coin), arg5), @0x66f25ca6d8edc0bb161b53e67eac7bf7e680251dc095cb4f973f10051f9d63cb);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.pool_sui, 0x2::balance::value<0x2::sui::SUI>(&arg1.pool_sui), arg5), @0x66f25ca6d8edc0bb161b53e67eac7bf7e680251dc095cb4f973f10051f9d63cb);
    ...
    public entry fun start_new_coin<T0>(arg0: &mut SuiAiFun, arg1: 0x2::coin::CoinMetadata<T0>, arg2: 0x2::coin::TreasuryCap<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Pool<T0>{
            ...
            pool_sui              : 0x2::balance::zero<0x2::sui::SUI>(),
            pool_coin             : 0x2::coin::into_balance<T0>(0x2::coin::mint<T0>(&mut arg2, 1000000000000000, arg9)),
            total_supply          : 1000000000000000,
            virtual_coin_reserves : (1000000000000000 as u128) * 11 / 10,
            virtual_sui_reserves  : (arg0.max_pool_sui as u128) * 3 / 8,
            max_pool_sui          : arg0.max_pool_sui,
        ...
        0x2::event::emit<PoolCreatedEvent>(v2);
        let v3 = &mut v1;
        buy<T0>(arg0, v3, 0, arg3, @0x66f25ca6d8edc0bb161b53e67eac7bf7e680251dc095cb4f973f10051f9d63cb, arg9);
        0x2::transfer::public_share_object<Pool<T0>>(v1);
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<T0>>(arg2);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<T0>>(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg4, @0x66f25ca6d8edc0bb161b53e67eac7bf7e680251dc095cb4f973f10051f9d63cb);
