module 0x1a0c2c0385891c55f3a3a2445fefe5c84d2b923393d7505618f9140eca69ac01::cnsnft4667 {
    struct CNSNFT4667 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4667, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4667>(arg0, arg1);
