module 0x5d86a8bcd9527aed2b0fe84e0cd77cf861d5a95b5d051f452e80747f64a83ce3::cnsnft9601 {
    struct CNSNFT9601 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9601, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9601>(arg0, arg1);
