module 0x5d75ffb7ec8dcc0948645710e60363f0e775bf3b4793c5ad666adb8dcff19caf::cnsnft8424 {
    struct CNSNFT8424 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8424, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8424>(arg0, arg1);
