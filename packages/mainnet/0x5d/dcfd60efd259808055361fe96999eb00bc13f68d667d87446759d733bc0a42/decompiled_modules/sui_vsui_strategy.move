module 0x5b5a87571c64ac8876a55aea8b0eb35693340e2271f2a3995502303b64fdb02e::sui_vsui_strategy {
        ...
        if (v1 > 0) {
            ...
            if (0x2::balance::value<0x2::sui::SUI>(&v3) >= v1) {
                ...
                if (v4 >= v5) {
                    ...
                    let v8 = revolving_repay_and_withdraw(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v3), v1 + v4, arg15);
                    ...
                    let v9 = calculate_required_sui_for_repay(arg0, arg4, arg5, arg8, v1);
                    let v10 = v9;
                    if (v9 < v5) {
                        v10 = v5;
                    };
                    let (v11, v12) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_loan_with_account_cap<0x2::sui::SUI>(arg14, arg9, v10, &arg0.navi_cap);
                    let v13 = v11;
                    let v14 = 0x2::balance::value<0x2::sui::SUI>(&v13);
                    let v15 = (0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::utils::u256_mul_div((v14 as u256), (6 as u256), (10000 as u256)) as u64);
                    0x2::balance::join<0x2::sui::SUI>(&mut v3, v13);
                    let v16 = revolving_repay_and_withdraw(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v3), v1 + v14 + v15, arg15);
                    0x2::balance::join<0x2::sui::SUI>(&mut v3, v16);
                    0x2::balance::join<0x2::sui::SUI>(&mut v3, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_repay_with_account_cap<0x2::sui::SUI>(arg7, arg8, arg9, v12, 0x2::balance::split<0x2::sui::SUI>(&mut v3, v14 + v15), &arg0.navi_cap));
                    0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::strategy_repay<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2, &arg0.vault_access, 0x2::balance::split<0x2::sui::SUI>(&mut v3, v1));
                };
            ...
            let v18 = 0x1::u64::min(v0, 0x2::balance::value<0x2::sui::SUI>(0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::free_balance<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2)));
            let v19 = 0x2::coin::from_balance<0x2::sui::SUI>(0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::strategy_borrow<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2, &arg0.vault_access, v18), arg15);
            let v20 = BorrowEvent{
                vault_id    : 0x2::object::id<0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::Vault<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>>(arg2),
                strategy_id : *0x2::object::uid_as_inner(&arg0.id),
                borrow_amt  : v18,
    ...
    fun revolving_repay_and_withdraw(arg0: &mut Strategy, arg1: &mut 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::NativePool, arg2: &mut 0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::Metadata<0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::CERT>, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &0x2::clock::Clock, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<0x2::sui::SUI>, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::cert::CERT>, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg10: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg11: 0x2::balance::Balance<0x2::sui::SUI>, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        loop {
            let v4 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_balance(arg5, 0, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::account_owner(&arg0.navi_cap));
            if ((v4 as u64) <= 0x2::balance::value<0x2::sui::SUI>(&arg11)) {
                let v5 = get_withdraw_amt(arg0, arg1, arg2, arg5, (v4 as u64));
                if (0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::from_shares(arg1, arg2, v5) < 1000000000) {
                    break
                } else {
                    let (v6, v7) = navi_repay_and_withdraw_collateral(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, 0x2::balance::split<0x2::sui::SUI>(&mut arg11, (v4 as u64)), v1, arg13);
            ...
            let v9 = get_withdraw_amt(arg0, arg1, arg2, arg5, 0x2::balance::value<0x2::sui::SUI>(&arg11));
            if (0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::from_shares(arg1, arg2, v9) < 1000000000) {
                break
            };
            let (v10, v11) = navi_repay_and_withdraw_collateral(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg11), v1, arg13);
