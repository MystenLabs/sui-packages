module 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::state_inner {
    ...
    public(friend) fun withdraw<T0, T1>(arg0: &mut SamStateV1<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: vector<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::ptr::ProtocolLiquidity>, arg3: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, vector<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::WithdrawRequest<T0>>) {
        ...
        v22 = 0;
        while (v22 < v20 && v12 > 0) {
            let v24 = 0x1::u64::min(0x99a1d666d9e4792bee2f34a2693aeab95a57b3c662da2e68574a03e929e60b0e::fixed18::to_u64_up(0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::ptr::available_liquidity(0x1::vector::borrow<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::ptr::ProtocolLiquidity>(&arg2, v22)), v4) - *0x1::vector::borrow<u64>(&v21, v22), v12);
        ...
        while (v22 < v20) {
            ...
            if (v25 > 0) {
                0x1::vector::push_back<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::WithdrawRequest<T0>>(&mut v6, 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::new<T0>(v25, 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::ptr::witness_type_name(0x1::vector::borrow<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::ptr::ProtocolLiquidity>(&arg2, v22))));
            };
            v22 = v22 + 1;
        };
        let v26 = &v6;
        ...
        while (v28 < 0x1::vector::length<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::WithdrawRequest<T0>>(v26)) {
            0x1::vector::push_back<0x1::type_name::TypeName>(&mut v27, 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::get_witness<T0>(0x1::vector::borrow<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::WithdrawRequest<T0>>(v26, v28)));
            v28 = v28 + 1;
        };
        let v29 = &v6;
        let v30 = vector[];
        let v31 = 0;
        while (v31 < 0x1::vector::length<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::WithdrawRequest<T0>>(v29)) {
            0x1::vector::push_back<u64>(&mut v30, 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::get_coin_amount<T0>(0x1::vector::borrow<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::wdr::WithdrawRequest<T0>>(v29, v31)));
            v31 = v31 + 1;
        };
        0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam_events::withdraw<T0, T1>(v5, v0, v1, 0x2::tx_context::sender(arg3), v27, v30, 0x2::balance::value<T0>(&v3));
        (v3, v6)
    }
    ...
    fun allocation_config<T0, T1>(arg0: &SamStateV1<T0, T1>) : AllocationConfig {
        let v0 = ConfigKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<ConfigKey>(&arg0.id, v0)) {
            let v2 = ConfigKey{dummy_field: false};
            *0x2::dynamic_field::borrow<ConfigKey, AllocationConfig>(&arg0.id, v2)
        } else {
            AllocationConfig{idle_buffer_bps: 500, max_exposure_bps: 7000}
        }
    }
    ...
    public(friend) fun get_allocation_config<T0, T1>(arg0: &SamStateV1<T0, T1>) : (u64, u64) {
        let v0 = allocation_config<T0, T1>(arg0);
        (v0.idle_buffer_bps, v0.max_exposure_bps)
    }
    ...
    public(friend) fun rebalance_optimal<T0, T1>(arg0: &mut SamStateV1<T0, T1>, arg1: &0x2::tx_context::TxContext) : vector<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::rbr::RebalanceRequest<T0>> {
        ...
        while (v17 < v13) {
            ...
            if (v22 >= 1000) {
                ...
                let v24 = 0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::rbr::new<T0>(v22, 0x1::option::none<0x1::type_name::TypeName>(), 0x1::option::some<0x1::type_name::TypeName>(v18));
        ...
        0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam_events::rebalance(0x1::vector::empty<0x1::option::Option<0x1::type_name::TypeName>>(), v15, v16, 0x2::tx_context::sender(arg1));
        v2
    }
    ...
    public(friend) fun set_allocation_config<T0, T1>(arg0: &mut SamStateV1<T0, T1>, arg1: u64, arg2: u64) {
        ...
        if (0x2::dynamic_field::exists_<ConfigKey>(&arg0.id, v1)) {
            let v2 = ConfigKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<ConfigKey, AllocationConfig>(&mut arg0.id, v2) = v0;
        } else {
            let v3 = ConfigKey{dummy_field: false};
            0x2::dynamic_field::add<ConfigKey, AllocationConfig>(&mut arg0.id, v3, v0);
        };
    }
    ...
    public(friend) fun update_coin_icon<T0, T1>(arg0: &SamStateV1<T0, T1>, arg1: &mut 0x2::coin::CoinMetadata<T1>, arg2: 0x1::ascii::String) {
        0x2::coin::update_icon_url<T1>(0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam_coin_treasury::inner<T1>(0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::extended_field::borrow<0xd2550407673e08d06c4b1f16f31bb7313e5de02c5212f6e0627250e3bc72f282::sam_coin_treasury::SamTreasury<T1>>(&arg0.treasury)), arg1, arg2);
    }
