module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    public entry fun add_durability_to_all_staked_tools_batched(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0;
        while (arg2 < v4) {
            let v6 = *0x1::vector::borrow<address>(&arg1.stakers, arg2);
            if (0x2::table::contains<address, UserInfo>(&arg1.users, v6)) {
                let v7 = 0x2::table::borrow_mut<address, UserInfo>(&mut arg1.users, v6);
                let v8 = 0;
                while (v8 < 0x1::vector::length<ItemInfo>(&v7.items)) {
                    let v9 = 0x1::vector::borrow<ItemInfo>(&v7.items, v8);
                    if (v9.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_storage()) {
                        let v10 = 0x2::kiosk::borrow_mut<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&mut arg1.kiosk, &arg1.kiosk_owner_cap, v9.nft_id);
                        let v11 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_durability_string(v10);
                        let v12 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_category_string(v10);
                        let v13 = false;
                        if (0x1::option::is_none<0x1::string::String>(&v11)) {
    ...
    public entry fun stake_tool(arg0: &mut StakingPool, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::transfer_policy::TransferPolicy<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>, arg5: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_none<0x1::string::String>(&v4) || 0x1::option::is_none<0x1::string::String>(&v5)) {
            let v6 = 0x2::kiosk::borrow_mut<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(arg1, arg2, arg3);
            if (0x1::option::is_none<0x1::string::String>(&v4)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_durability_if_missing(v6);
            };
            if (0x1::option::is_none<0x1::string::String>(&v5)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_category_if_missing(v6);
            };
        };
        ...
        let v7 = get_or_create_user(arg0, v0, arg7);
        let v8 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::get_item_limit(v3);
        if (v8 > 0) {
            assert!(count_items_by_type(&v7.items, v3) < v8, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_staked_item_limit_reached());
        };
        let v9 = ItemInfo{
            nft_id      : arg3,
            item_type   : v3,
        ...
        0x1::vector::push_back<ItemInfo>(&mut v7.items, v9);
        let v10 = ItemStaked{
            user      : v1,
            nft_id    : arg3,
            item_type : v3,
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 3, 13906836356186767359);
        arg1.version = 3;
