module 0x5d05141e343af4fe4f58ec3e022d7408f5914ec4323dbe13dc42db8898ba61f3::launchpadINO {
    ...
    public entry fun add_pool(arg0: &mut LaunchpadINO, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun deposit_nfts<T0: store + key>(arg0: &mut Pool, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x2::object::ID, Listing<T0>>(&mut arg0.id, 0x2::object::id<Listing<T0>>(&v0), v0);
    }
