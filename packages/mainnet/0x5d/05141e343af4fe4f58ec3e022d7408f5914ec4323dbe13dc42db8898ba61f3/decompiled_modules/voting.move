module 0x5d05141e343af4fe4f58ec3e022d7408f5914ec4323dbe13dc42db8898ba61f3::voting {
    ...
    public entry fun create_vote(arg0: &mut 0x5d05141e343af4fe4f58ec3e022d7408f5914ec4323dbe13dc42db8898ba61f3::launchpadINO::LaunchpadINO, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(v0 == 0x5d05141e343af4fe4f58ec3e022d7408f5914ec4323dbe13dc42db8898ba61f3::launchpadINO::get_admin(), 0);
        let v1 = 0x2::object::new(arg5);
        0x2::object::uid_to_inner(&v1);
        let v2 = Vote{
            id               : v1,
            launchpad_ino_id : 0x5d05141e343af4fe4f58ec3e022d7408f5914ec4323dbe13dc42db8898ba61f3::launchpadINO::get_id(arg0),
        ...
        0x5d05141e343af4fe4f58ec3e022d7408f5914ec4323dbe13dc42db8898ba61f3::launchpadINO::update_vote_id(arg0, v3);
