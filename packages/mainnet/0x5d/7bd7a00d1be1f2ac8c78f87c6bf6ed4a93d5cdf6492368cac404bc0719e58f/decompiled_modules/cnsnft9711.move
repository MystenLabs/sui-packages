module 0x5d7bd7a00d1be1f2ac8c78f87c6bf6ed4a93d5cdf6492368cac404bc0719e58f::cnsnft9711 {
    struct CNSNFT9711 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9711, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9711>(arg0, arg1);
