module 0x5dd51f49dc38f0c9af2a3d821864127b8c06b54bb1dfcee274e9cf9ee8c68887::vault {
    ...
    public fun withdraw<T0>(arg0: &mut DepositContract<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun withdraw_all<T0>(arg0: &mut DepositContract<T0>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
