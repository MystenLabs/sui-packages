module 0x5dd4286ec234c117bb9577d4eaed1885b70d73ab1d3dab2794d0ab9a2c06c4a1::config {
    ...
    public fun add_plan(arg0: &mut Config, arg1: &0x5dd4286ec234c117bb9577d4eaed1885b70d73ab1d3dab2794d0ab9a2c06c4a1::admin::AdminCap, arg2: u64, arg3: u8, arg4: u8, arg5: u64) {
    ...
    public(friend) fun create_config(arg0: &CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Config{
            ...
            paused                : false,
            accepted_payment_type : 0x1::ascii::string(b"dba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC"),
        };
    ...
    public fun remove_plan(arg0: &mut Config, arg1: &0x5dd4286ec234c117bb9577d4eaed1885b70d73ab1d3dab2794d0ab9a2c06c4a1::admin::AdminCap, arg2: u64) {
    ...
    public fun set_accepted_payment_type<T0>(arg0: &mut Config, arg1: &0x5dd4286ec234c117bb9577d4eaed1885b70d73ab1d3dab2794d0ab9a2c06c4a1::admin::AdminCap) {
        arg0.accepted_payment_type = 0x1::type_name::into_string(0x1::type_name::with_original_ids<T0>());
    }

    public fun set_paused(arg0: &mut Config, arg1: &0x5dd4286ec234c117bb9577d4eaed1885b70d73ab1d3dab2794d0ab9a2c06c4a1::admin::AdminCap, arg2: bool) {
        arg0.paused = arg2;
    }

    public fun update_fee_receiver(arg0: &mut Config, arg1: &0x5dd4286ec234c117bb9577d4eaed1885b70d73ab1d3dab2794d0ab9a2c06c4a1::admin::AdminCap, arg2: address) {
        arg0.fee_receiver = arg2;
    }

    public fun update_plan(arg0: &mut Config, arg1: &0x5dd4286ec234c117bb9577d4eaed1885b70d73ab1d3dab2794d0ab9a2c06c4a1::admin::AdminCap, arg2: u64, arg3: u8, arg4: u8, arg5: u64) {
        assert!(0x2::vec_map::contains<u64, SubscriptionPlan>(&arg0.plans, &arg2), 102);
        let (_, _) = 0x2::vec_map::remove<u64, SubscriptionPlan>(&mut arg0.plans, &arg2);
