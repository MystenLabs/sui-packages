module 0x5de25f57951156b10e7bd75e8350c92fc736ecf987d1b19ccdc01350b75deba9::pool {
    ...
    struct Vault<phantom T0> has store, key {
        ...
        coin_type_a: 0x1::type_name::TypeName,
        coin_type_b: 0x1::type_name::TypeName,
        buffer_assets: 0x5de25f57951156b10e7bd75e8350c92fc736ecf987d1b19ccdc01350b75deba9::balance_bag::BalanceBag,
        markets: 0x2::object_bag::ObjectBag,
    }

    public fun add_coin<T0: drop, T1>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T1>) {
        0x5de25f57951156b10e7bd75e8350c92fc736ecf987d1b19ccdc01350b75deba9::balance_bag::join<T1>(&mut arg0.buffer_assets, 0x2::coin::into_balance<T1>(arg1));
    }
    ...
    public fun new_vault<T0, T1>(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
            ...
            coin_type_a   : 0x1::type_name::with_defining_ids<T0>(),
            coin_type_b   : 0x1::type_name::with_defining_ids<T1>(),
            buffer_assets : 0x5de25f57951156b10e7bd75e8350c92fc736ecf987d1b19ccdc01350b75deba9::balance_bag::new_balance_bag(arg0),
