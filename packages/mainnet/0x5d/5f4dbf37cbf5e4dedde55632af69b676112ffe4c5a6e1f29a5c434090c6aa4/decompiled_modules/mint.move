module 0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::mint {
    ...
    struct Mint has store, key {
        id: 0x2::object::UID,
        nfts: 0x2::table_vec::TableVec<0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data>,
        phases: vector<Phase>,
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v32 = Mint{
            ...
            nfts             : 0x2::table_vec::empty<0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data>(arg0),
            phases           : v0,
            burn_phase       : v18,
            public_phase     : v31,
    ...
    public(friend) fun add_data(arg0: &mut Mint, arg1: 0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data) {
        0x2::table_vec::push_back<0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data>(&mut arg0.nfts, arg1);
    }
    ...
    public(friend) fun add_minter_list(arg0: &mut Mint, arg1: u64, arg2: vector<address>) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            let v1 = &arg1;
            if (*v1 == 0) {
                0x2::table::add<address, bool>(&mut 0x1::vector::borrow_mut<Phase>(&mut arg0.phases, 0).list, 0x1::vector::pop_back<address>(&mut arg2), true);
            } else if (*v1 == 1) {
                0x2::table::add<address, bool>(&mut 0x1::vector::borrow_mut<Phase>(&mut arg0.phases, 1).list, 0x1::vector::pop_back<address>(&mut arg2), true);
            } else if (*v1 == 2) {
            } else if (*v1 == 31) {
            } else {
                assert!(*v1 == 32, 71);
    ...
    public(friend) fun data_length(arg0: &Mint) : u64 {
        0x2::table_vec::length<0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data>(&arg0.nfts)
    }

    public(friend) fun data_pop_back(arg0: &mut Mint) : 0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data {
        0x2::table_vec::pop_back<0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data>(&mut arg0.nfts)
    }

    public(friend) fun data_swap_remove(arg0: &mut Mint, arg1: u64) : 0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data {
        0x2::table_vec::swap_remove<0x5d5f4dbf37cbf5e4dedde55632af69b676112ffe4c5a6e1f29a5c434090c6aa4::barc::Data>(&mut arg0.nfts, arg1)
    }
