module 0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::raffle {
    ...
    public fun add_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun add_ticket_options<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg2: vector<u64>, arg3: vector<u64>) {
        assert!(0x1::vector::length<u64>(&arg2) == 0x1::vector::length<u64>(&arg3), 8);
        let v0 = get_valid_coin_type<T0>(arg0);
        TicketOptionsAdded{treasury: 0x2::object::id<RaffleTreasury>(arg0), ticket_amounts: arg2, extra_tickets: arg3, coin_type: 0x1::type_name::into_string(v0)};
        while (!0x1::vector::is_empty<u64>(&arg2)) {
            let v1 = 0x1::vector::pop_back<u64>(&mut arg2);
            let v2 = 0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<u64, u64>>(&mut arg0.ticket_options, v0);
            assert!(!0x2::table::contains<u64, u64>(v2, v1), 18);
            0x2::table::add<u64, u64>(v2, v1, 0x1::vector::pop_back<u64>(&mut arg3));
        };
        let v3 = TicketOptionsAdded{
            treasury       : 0x2::object::id<RaffleTreasury>(arg0),
            ticket_amounts : arg2,
            extra_tickets  : arg3,
            coin_type      : 0x1::type_name::into_string(v0),
        };
        0x2::event::emit<TicketOptionsAdded>(v3);
    }
    ...
    public fun create(arg0: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg1: Prize, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = derive_next_drand_round(arg2);
        let v1 = 0x2::object::new(arg3);
        let v2 = 0x2::object::uid_to_inner(&v1);
        arg1.raffle_id = v2;
        let v3 = Raffle{
            id                 : v1,
            prize              : 0x1::option::some<Prize>(arg1),
            total_tickets      : 0,
            participants       : 0x2::table::new<address, vector<Ticket>>(arg3),
            end_date           : arg2,
            winning_ticket     : 0,
            winner             : @0x0,
            count              : 0,
            collected          : 0x2::table::new<0x1::type_name::TypeName, u64>(arg3),
            drand_round        : v0,
            total_participants : 0,
        };
        let v4 = RaffleCreated{
            raffle_id   : v2,
            prize_value : arg1.value,
            drand_round : v0,
            end_date    : arg2,
        };
    ...
    public fun create_treasury(arg0: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun disable_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap) {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun enable_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.accepted_coins, v0)) {
    ...
    public fun extend_raffle(arg0: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg1: &mut Raffle, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = RaffleTreasury{
            ...
            total_balances    : 0,
            non_zero_balances : 0,
            accepted_coins    : 0x2::table::new<0x1::type_name::TypeName, bool>(arg0),
            price_per_ticket  : 0x2::table::new<0x1::type_name::TypeName, u64>(arg0),
            ticket_options    : 0x2::table::new<0x1::type_name::TypeName, 0x2::table::Table<u64, u64>>(arg0),
        };
        0x2::transfer::share_object<RaffleTreasury>(v0);
    }
    ...
    public fun lucky_number(arg0: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg1: &mut Raffle, arg2: &0x2::clock::Clock, arg3: vector<u8>, arg4: vector<u8>) {
        assert!(0x2::clock::timestamp_ms(arg2) > arg1.end_date, 4);
        assert!(arg1.winning_ticket == 0, 5);
        let v0 = 0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::drand_utils::safe_selection(arg1.total_tickets, arg1.drand_round, arg3, arg4);
    ...
    public fun new_prize(arg0: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg1: 0x1::string::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : Prize {
        Prize{
    ...
    public fun remove_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.accepted_coins, v0)) {
            assert!(0x2::balance::value<T0>(0x2::dynamic_field::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, v0)) == 0, 13);
    ...
    public fun remove_ticket_option<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg2: u64) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.accepted_coins, v0), 16);
    ...
    public fun update_ticket_options<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg2: vector<u64>, arg3: vector<u64>) {
        assert!(0x1::vector::length<u64>(&arg2) == 0x1::vector::length<u64>(&arg3), 8);
        let v0 = get_valid_coin_type<T0>(arg0);
        while (!0x1::vector::is_empty<u64>(&arg2)) {
            let v1 = 0x1::vector::pop_back<u64>(&mut arg2);
            let v2 = 0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<u64, u64>>(&mut arg0.ticket_options, v0);
            assert!(0x2::table::contains<u64, u64>(v2, v1), 9);
            *0x2::table::borrow_mut<u64, u64>(v2, v1) = 0x1::vector::pop_back<u64>(&mut arg3);
        };
        let v3 = TicketOptionsUpdated{
            treasury       : 0x2::object::id<RaffleTreasury>(arg0),
            ticket_amounts : arg2,
            extra_tickets  : arg3,
            coin_type      : 0x1::type_name::into_string(v0),
        };
        0x2::event::emit<TicketOptionsUpdated>(v3);
    }
    ...
    public fun withdraw_proceeds<T0>(arg0: &mut RaffleTreasury, arg1: &0x5dd54913f8d636fdc4df65a634522c9b717fadd9c10737b8bddfcb9bdf261d64::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x1::type_name::get<T0>();
