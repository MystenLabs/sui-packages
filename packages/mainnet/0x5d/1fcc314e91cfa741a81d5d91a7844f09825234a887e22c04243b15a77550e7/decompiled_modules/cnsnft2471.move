module 0x5d1fcc314e91cfa741a81d5d91a7844f09825234a887e22c04243b15a77550e7::cnsnft2471 {
    struct CNSNFT2471 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2471, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2471>(arg0, arg1);
