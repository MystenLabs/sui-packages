module 0x5d88349076cc360cc1ba6691c9eb2ece0278b9c9d5c833c6813359ffbb7891fe::today_not_tomorrow {
    struct TODAY_NOT_TOMORROW has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TODAY_NOT_TOMORROW, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TODAY_NOT_TOMORROW>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Today Not Tomorrow"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigby4tjflyq46a2gitfye676v6oqozge5gd2dnyr3evpbzk6lvrn4"));
