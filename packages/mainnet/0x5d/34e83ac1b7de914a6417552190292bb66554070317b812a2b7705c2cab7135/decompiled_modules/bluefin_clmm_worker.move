module 0x93c062d2672a7090758406070a7df48e17a9a6c633014049d8f578bbcff943f0::bluefin_clmm_worker {
    ...
    public fun collect_reward_mid_one_other_swap_reverse<T0, T1, T2, T3, T4>(arg0: &0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::global_storage::GlobalStorage, arg1: address, arg2: &mut WorkerInfo<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T4, T0>, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T4, T1>, arg8: bool, arg9: bool, arg10: bool, arg11: bool, arg12: u8, arg13: u8, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        if (arg10) {
            ...
            let v13 = 0x2::balance::value<T3>(&v12);
            if (v13 > 0) {
                let (v14, v15) = 0x87a5e0ad2f534245971542090137a368879938c10beabb175d8eb602c5582477::bluefin_clmm_utils::swap_exact_safe_reverse<T4, T3>(arg0, arg1, arg13, arg12, arg3, arg5, 0x2::coin::zero<T4>(arg16), 0x2::coin::from_balance<T3>(v12, arg16), false, true, v13, arg14, arg15, arg16);
                let v16 = v14;
                0x2::coin::destroy_zero<T3>(v15);
                let v17 = 0x2::coin::value<T4>(&v16);
                if (v17 > 0) {
                    if (arg11) {
                        let (v18, v19) = 0x87a5e0ad2f534245971542090137a368879938c10beabb175d8eb602c5582477::bluefin_clmm_utils::swap_exact_safe_reverse<T0, T4>(arg0, arg1, arg2.coin_base_decimals, arg13, arg3, arg6, 0x2::coin::zero<T0>(arg16), v16, false, true, v17, arg14, arg15, arg16);
                        ...
                        let (v22, v23) = 0x87a5e0ad2f534245971542090137a368879938c10beabb175d8eb602c5582477::bluefin_clmm_utils::swap_exact_safe_reverse<T1, T4>(arg0, arg1, arg2.coin_farming_decimals, arg13, arg3, arg7, 0x2::coin::zero<T1>(arg16), v16, false, true, v17, arg14, arg15, arg16);
                        0x2::coin::destroy_zero<T4>(v23);
                        let v24 = 0x2::coin::into_balance<T1>(v22);
                        let v25 = 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T1>(&v24), arg2.reinvest_bounty_bps, 10000);
                        if (0x2::balance::value<T1>(&v24) >= v25) {
                            0x2::balance::join<T1>(&mut arg2.tiny_coin_farming_bounty, 0x2::balance::split<T1>(&mut v24, v25));
                        };
                        0x2::balance::join<T1>(&mut arg2.tiny_coin_farming, v24);
                    };
                } else {
    ...
    public fun health<T0, T1, T2>(arg0: &WorkerInfo<T0, T1, T2>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: u64) : u64 {
        ...
        let _ = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::calculate_swap_results<T0, T1>(arg1, v7, true, v6, v8);
        abort 1111
    }
