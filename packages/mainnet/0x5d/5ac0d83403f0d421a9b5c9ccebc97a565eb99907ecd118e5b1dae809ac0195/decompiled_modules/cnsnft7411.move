module 0x5d5ac0d83403f0d421a9b5c9ccebc97a565eb99907ecd118e5b1dae809ac0195::cnsnft7411 {
    struct CNSNFT7411 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7411, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1627"));
        let v4 = 0x2::package::claim<CNSNFT7411>(arg0, arg1);
