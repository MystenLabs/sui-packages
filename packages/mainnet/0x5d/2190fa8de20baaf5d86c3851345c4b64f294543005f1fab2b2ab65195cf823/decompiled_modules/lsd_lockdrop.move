module 0x5d2190fa8de20baaf5d86c3851345c4b64f294543005f1fab2b2ab65195cf823::lsd_lockdrop {
    struct LsdLockdropVault has key {
        ...
        hive_incentives_balance: 0x2::balance::Balance<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>,
    }
    ...
    public fun add_hive_incentives(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(0x2::clock::timestamp_ms(arg0) <= arg1.init_timestamp + arg1.deposit_window, 5100);
        let v0 = 0x2::coin::into_balance<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>(arg2);
        0x2::balance::join<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>(&mut arg1.hive_incentives_balance, 0x2::balance::split<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>(&mut v0, arg3));
        arg1.total_hive_incentives = arg1.total_hive_incentives + arg3;
        0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::coin_helper::destroy_or_transfer_balance<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    ...
    public fun add_to_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::HiveProfile, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = if (0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::exists_for_profile(arg3, 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap))) {
            0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::remove_app_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg7)
        } else {
        ...
        let v8 = arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window + arg6 * 0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::constants::week_multiplier();
        ...
        0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::add_app_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg7);
        0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v6, 0x2::tx_context::sender(arg7), arg7);
    }
    ...
    public fun destroy_user_position(arg0: &0x2::clock::Clock, arg1: &0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::config::HiveEntryCap, arg2: &LsdLockdropVault, arg3: &mut 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, u128, u128) {
        ...
        if (!0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::exists_for_profile(arg3, 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap))) {
        ...
        } = 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::remove_app_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg4);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun does_user_have_position(arg0: &0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : bool {
    ...
    public fun get_user_position(arg0: &0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        ...
        let v1 = 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg0, v0);
    ...
    public fun infuse_sui_dsui_pool(arg0: &0x2::clock::Clock, arg1: &0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x4ae4217ce30ab816efdda3d13ba947b6afce321beb20f53ef9ef6405e735b247::dsui_vault::DSuiVault, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::dsui::DSUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>, u64, u128) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        ...
        let v2 = 0x4ae4217ce30ab816efdda3d13ba947b6afce321beb20f53ef9ef6405e735b247::dsui_vault::stake_sui_request(arg3, arg4, 0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, v1), 0x1::option::none<address>(), arg5);
        let v3 = SuiStakedForDegenSUI{
            cur_timestamp      : v0,
            total_sui_locked   : arg2.total_sui_locked,
            sui_to_stake       : v1,
            total_dsui_krafted : 0x2::balance::value<0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::dsui::DSUI>(&v2),
        };
        0x2::event::emit<SuiStakedForDegenSUI>(v3);
        (v2, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.sui_locked_balance), 0x2::balance::withdraw_all<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>(&mut arg2.hive_incentives_balance), arg2.total_sui_locked, arg2.total_sui_weighted_units)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun initialize_global_lsd_lockdrop(arg0: &0x2::clock::Clock, arg1: &0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::config::HiveEntryCap, arg2: 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::HiveAppAccessCapability, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : address {
        ...
        let v0 = LsdLockdropVault{
            ...
            hive_incentives_balance  : 0x2::balance::zero<0xdd9632ef1c108b77fe228d9626caada6d620fbbcdf23f8fff09dd066ab1c984e::hive::HIVE>(),
        };
    ...
    public fun simulate_withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &LsdLockdropVault, arg2: &0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::HiveProfile, arg3: u64, arg4: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap);
        if (!0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::exists_for_profile(arg2, v1)) {
            return (0, 0, false)
        };
        let v2 = 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg2, v1);
    ...
    public fun withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::HiveProfile, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::get_profile_meta_info(arg3);
        assert!(v0 >= arg2.init_timestamp, 5101);
        assert!(v0 < arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 5103);
        assert!(0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::exists_for_profile(arg3, 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap)), 5104);
        let v5 = 0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::remove_app_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg6);
        ...
        0x6687af8a0372520704813c0760e8230f8e4ba8e02944a62b6e7891290b421d3c::hive_profile::add_app_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg6);
        0xb2daad3cfd62e10e0434af18ff824f89c03ab523f0502dddfdbc72953f2da9b4::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, arg4), v4, arg6);
    }
