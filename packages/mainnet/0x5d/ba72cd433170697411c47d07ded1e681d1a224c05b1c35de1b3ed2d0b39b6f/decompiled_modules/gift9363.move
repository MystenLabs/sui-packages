module 0x5dba72cd433170697411c47d07ded1e681d1a224c05b1c35de1b3ed2d0b39b6f::gift9363 {
    struct GIFT9363 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift9363(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT9363, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9363>(arg0, arg1);
