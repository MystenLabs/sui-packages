module 0x5d466ee46705685687da1c58d9bb339aa73624dff84b2d89b12a8da375fa19dc::protective_bid_registry {
    ...
    public fun bid_count(arg0: &0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::Account, arg1: &0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::package_registry::PackageRegistry) : u64 {
        if (!has_registry(arg0)) {
            return 0
        };
        let v0 = ProtectiveBidKey{dummy_field: false};
        0x1::vector::length<ProtectiveBidRecord>(&0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::borrow_managed_data_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v0, 0x5d466ee46705685687da1c58d9bb339aa73624dff84b2d89b12a8da375fa19dc::markets_core_version::current()).records)
    }

    public fun bid_ids(arg0: &0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::Account, arg1: &0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::package_registry::PackageRegistry) : vector<0x2::object::ID> {
        if (!has_registry(arg0)) {
            return 0x1::vector::empty<0x2::object::ID>()
        };
        let v0 = ProtectiveBidKey{dummy_field: false};
        let v1 = 0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::borrow_managed_data_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v0, 0x5d466ee46705685687da1c58d9bb339aa73624dff84b2d89b12a8da375fa19dc::markets_core_version::current());
    ...
    fun clear_internal(arg0: &mut 0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::Account, arg1: &0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::package_registry::PackageRegistry, arg2: 0x2::object::ID) {
        ...
        let v0 = ProtectiveBidKey{dummy_field: false};
        let v1 = 0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::borrow_managed_data_mut_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v0, 0x5d466ee46705685687da1c58d9bb339aa73624dff84b2d89b12a8da375fa19dc::markets_core_version::current());
        let v2 = 0;
    ...
    public fun has_registry(arg0: &0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::Account) : bool {
        let v0 = ProtectiveBidKey{dummy_field: false};
        0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::has_managed_data<ProtectiveBidKey>(arg0, v0)
    }
    ...
    fun set_internal(arg0: &mut 0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::Account, arg1: &0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::package_registry::PackageRegistry, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        if (!has_registry(arg0)) {
            ...
            0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::add_managed_data_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v3, v2, 0x5d466ee46705685687da1c58d9bb339aa73624dff84b2d89b12a8da375fa19dc::markets_core_version::current());
        } else {
            let v4 = ProtectiveBidKey{dummy_field: false};
            let v5 = 0x120fdca1774a9543ace0f4a38fb06efadae8966c58de1783d6e30d8d6a50b024::account::borrow_managed_data_mut_with_package_witness<ProtectiveBidKey, ProtectiveBidRegistry>(arg0, arg1, v4, 0x5d466ee46705685687da1c58d9bb339aa73624dff84b2d89b12a8da375fa19dc::markets_core_version::current());
            assert!(0x1::vector::length<ProtectiveBidRecord>(&v5.records) < 0xcc850ba260a5e370a0e98b96db02037f6b84893754b6c6c198f3e4f24feea81e::constants::max_protective_bids_per_dao(), 1);
