module 0x5dff2b138213b79e0b96c7584912691122d816134841d26df21c74f09f46eae0::reward7705 {
    struct REWARD7705 has drop {
        dummy_field: bool,
    }

    struct TICKET_7705 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7705(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7705>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7705>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7705, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7705>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7705>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7705>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7705>>(v5, 0x2::tx_context::sender(arg1));
    }
