module 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user_pool {
    ...
    public(friend) fun borrow(arg0: &UserPool, arg1: 0x1::string::String) : &0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::User {
    ...
    entry fun delete(arg0: &mut UserPool, arg1: 0x1::string::String, arg2: &0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::package_state::State, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::remove<0x1::string::String, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::User>(&mut arg0.users, arg1);
        assert!(0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::package_state::is_admin(arg2, arg3), 2);
        let v2 = borrow_mut(arg0, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::proposer(&v1));
        0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::remove_propose(v2, &v1);
        let v3 = 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::proposed_mut(&mut v1);
        while (0x2::table_vec::length<0x1::string::String>(v3) > 0) {
            let v4 = 0x2::table::remove<0x1::string::String, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::User>(&mut arg0.users, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::consts::SYSTEM_UID());
            let v5 = borrow_mut(arg0, 0x2::table_vec::pop_back<0x1::string::String>(v3));
            0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::set_proposer(v5, &mut v4, arg2, arg3);
            0x2::table::add<0x1::string::String, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::User>(&mut arg0.users, 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::consts::SYSTEM_UID(), v4);
        };
        0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::user::destroy_empty(v1, arg3);
    }
