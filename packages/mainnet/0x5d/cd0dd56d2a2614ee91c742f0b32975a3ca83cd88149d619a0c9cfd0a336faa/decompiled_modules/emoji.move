module 0x5dcd0dd56d2a2614ee91c742f0b32975a3ca83cd88149d619a0c9cfd0a336faa::emoji {
    ...
    fun init(arg0: EMOJI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<EMOJI>(arg0, 2, b"SUIER", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
