module 0x5d3a873550a3fa890ac486a07c44d269bde21299a5f1cbea847cea6a0d3e7bae::perf_fee_helper {
    ...
    fun next_reference_ratio(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u256, arg5: u256, arg6: u64) : u256 {
        ...
        let v1 = 0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_utils::div_d(v0, arg5);
        let v2 = if (arg4 >= arg3) {
            v1
        } else {
    ...
    public fun pre_calculate_perf_fee<T0>(arg0: &VaultHelper<T0>, arg1: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault::Vault<T0>, arg2: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_oracle::OracleConfig, arg3: &0x2::clock::Clock, arg4: bool, arg5: u64) : u64 {
        ...
        let v7 = if (v4 == 0) {
            ...
            0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_utils::div_d(v6, v4)
        };
