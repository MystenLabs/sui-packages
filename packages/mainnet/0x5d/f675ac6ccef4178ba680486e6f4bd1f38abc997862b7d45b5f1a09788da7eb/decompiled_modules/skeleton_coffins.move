module 0x5df675ac6ccef4178ba680486e6f4bd1f38abc997862b7d45b5f1a09788da7eb::skeleton_coffins {
    struct SKELETON_COFFINS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SKELETON_COFFINS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SKELETON_COFFINS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Skeleton Coffins"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Skeleton Coffins is a limited collection of 1230 access NFTs. Each Coffin acts as a key. By holding one, you secure your right to mint a 1:1 SKELSUI NFT when the final collection rises exactly 88 days after the Coffins are minted."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeicocuxwslhhyyh6skxvn6ccc5dyjzhwlw4ecpl3g24j6itw4xce2e"));
