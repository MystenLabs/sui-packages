module 0x5dee331fee8893d71428798bfe5050ca6b48a51400d6d0e5039e97725c39aa5f::reward3911 {
    struct REWARD3911 has drop {
        dummy_field: bool,
    }

    struct TICKET_3911 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3911(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3911>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3911>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3911, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3911>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3911>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3911>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3911>>(v5, 0x2::tx_context::sender(arg1));
    }
