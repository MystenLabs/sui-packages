module 0x5d54aeee2b81120584e2738f49c59a2effc93c27cde6c9651d8aacc5465ca908::vault {
    ...
    public(friend) fun assert_vault_cap<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2>>(arg0), 0x5d54aeee2b81120584e2738f49c59a2effc93c27cde6c9651d8aacc5465ca908::error::invalid_vault_cap());
    }
