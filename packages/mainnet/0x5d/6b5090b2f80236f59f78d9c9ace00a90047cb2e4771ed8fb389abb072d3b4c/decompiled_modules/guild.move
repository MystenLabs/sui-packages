module 0x147acc1b8cb6cfd088472825069a3bcb9cf13ec15e43a0924a59d56df4f764de::guild {
    ...
    public(friend) fun add_fund_to_pool<T0>(arg0: &mut FeePool<T0>, arg1: 0x2::coin::Coin<T0>) {
    ...
    public(friend) fun withdraw_from_pool<T0>(arg0: &mut FeePool<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 6016);
