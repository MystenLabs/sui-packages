module 0x5df19611ee2a0b8e41cb53f1dcb90eaa5d86b966bb8ded50fe48962c6967cb7c::mind {
    ...
    fun init(arg0: MIND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/DQ76RZW7QRt8XzmhusYr3xY5xdQoHZHwE89zjH6tPzNw.png?size=lg&key=b71b18                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<MIND>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MIND    ")))), trim_right(b"Mind of Pepe                    "), trim_right(b"MIND of Pepe is a self-evolving AI agent that interacts with X and other platforms, generating its own presence and opinions. As MIND of Pepe engages with influencers, shares thoughts on meme coins, and sparks discussions, it naturally gains popularity.                                                                   "), v2, arg1);
        let v5 = v3;
