module 0x49099704c85d20c73f73234c5349b257ad9664ef21ca562b0ca1574f31be427b::vault {
    ...
    public entry fun deposit_with_sigs_credit_time<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg2, v5, arg11), arg1.fee_receiver);
    ...
    fun redeem_dual_token_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<0x1::ascii::String>, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        assert!(arg0.version == 2, 5);
        assert!(arg1.enable, 4);
        ...
        while (v15 < v10) {
            ...
            let v21 = 0x1::vector::borrow<u64>(&arg5, v20);
            let v22 = 0x1::vector::borrow<u64>(&arg6, v20);
            assert!(v18.amount >= *v22, 18);
            let v23 = 0x1::vector::borrow<0x1::ascii::String>(&arg3, v20);
            if (v23 == &v16) {
                v11 = v11 + *v21;
            } else if (v23 == &v17) {
                v12 = v12 + *v21;
        ...
        let v26 = spend_withdraw_asset<T0, T1, T2>(arg1, v11, arg11);
        let v27 = spend_withdraw_asset<T0, T1, T3>(arg1, v12, arg11);
        let v28 = calculate_fee(v11, arg1.withdraw.fee_bps);
        let v29 = calculate_fee(v12, arg1.withdraw.fee_bps);
        arg1.withdraw.total_fee = arg1.withdraw.total_fee + calculate_fee(v14, arg1.withdraw.fee_bps);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v26, v28, arg11), arg1.fee_receiver);
        0x2::transfer::public_transfer<0x2::coin::Coin<T3>>(0x2::coin::split<T3>(&mut v27, v29, arg11), arg1.fee_receiver);
        arg1.total_withdraw = arg1.total_withdraw + (v14 as u128);
        let v30 = DualTokenRedeemEvent{
            receiver                            : arg2,
            item_amount                         : v13,
        ...
        0x2::event::emit<DualTokenRedeemEvent>(v30);
        (v26, v27)
    }
    ...
    public entry fun withdraw_dual_token<T0, T1, T2, T3>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, v1)) {
            let v8 = 0x2::table::borrow_mut<address, vector<PendingRedeem>>(&mut arg1.pending_redeems, v1);
            0x1::vector::push_back<PendingRedeem>(v8, v6);
            0x1::vector::push_back<PendingRedeem>(v8, v7);
        } else {
            let v9 = 0x1::vector::empty<PendingRedeem>();
            0x1::vector::push_back<PendingRedeem>(&mut v9, v6);
            0x1::vector::push_back<PendingRedeem>(&mut v9, v7);
