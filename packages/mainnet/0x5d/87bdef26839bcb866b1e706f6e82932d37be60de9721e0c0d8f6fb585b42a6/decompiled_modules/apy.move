module 0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::apy {
    ...
    public fun push_apy_and_tvl_from_enclave(arg0: &mut ApyRegistry, arg1: &0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::enclave_verifier::EnclaveRegistry, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock) {
        let v0 = 0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::enclave_verifier::verify_and_decode(arg1, arg2, arg3);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        let v2 = 0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::enclave_verifier::get_timestamp_ms(&v0);
        assert!(v1 >= v2 && v1 - v2 <= 300000, 601);
        let v3 = 0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::enclave_verifier::get_strategy_id(&v0);
        update_base_apy_internal(arg0, v3, 0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::enclave_verifier::get_apy(&v0), arg4);
        push_tvl(arg0, v3, 0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::enclave_verifier::get_tvl(&v0), arg4);
    }
    ...
    public fun push_base_apy(arg0: &mut ApyRegistry, arg1: u8, arg2: u64, arg3: bool, arg4: &0x2::clock::Clock) {
        ...
        update_base_apy_internal(arg0, arg1, v0, arg4);
    }
    ...
    public fun push_base_apy_verified(arg0: &mut ApyRegistry, arg1: u8, arg2: u64, arg3: bool, arg4: u64, arg5: &0x2::clock::Clock) {
        ...
        update_base_apy_internal(arg0, arg1, v0, arg5);
    }
    ...
    public fun select_best_strategy(arg0: &ApyRegistry, arg1: &0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::strategy::StrategyRegistry) : u8 {
        let v0 = 0x5d87bdef26839bcb866b1e706f6e82932d37be60de9721e0c0d8f6fb585b42a6::strategy::list_available(arg1);
    ...
    fun update_base_apy_internal(arg0: &mut ApyRegistry, arg1: u8, arg2: u64, arg3: &0x2::clock::Clock) {
        if (0x2::vec_map::contains<u8, RateEntry>(&arg0.entries, &arg1)) {
            let v0 = 0x2::vec_map::get_mut<u8, RateEntry>(&mut arg0.entries, &arg1);
