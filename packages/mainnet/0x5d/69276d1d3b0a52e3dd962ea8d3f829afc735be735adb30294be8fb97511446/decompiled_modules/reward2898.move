module 0x5d69276d1d3b0a52e3dd962ea8d3f829afc735be735adb30294be8fb97511446::reward2898 {
    struct REWARD2898 has drop {
        dummy_field: bool,
    }

    struct TICKET_2898 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2898(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2898>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2898>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2898, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2898>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2898>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2898>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2898>>(v5, 0x2::tx_context::sender(arg1));
    }
