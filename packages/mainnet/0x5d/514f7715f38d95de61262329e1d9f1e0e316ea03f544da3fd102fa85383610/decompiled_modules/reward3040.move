module 0x5d514f7715f38d95de61262329e1d9f1e0e316ea03f544da3fd102fa85383610::reward3040 {
    struct REWARD3040 has drop {
        dummy_field: bool,
    }

    struct TICKET_3040 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3040(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3040>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3040>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3040, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3040>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3040>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3040>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3040>>(v5, 0x2::tx_context::sender(arg1));
    }
