module 0xe22293b97873f57ee94e79d24563b11f63565559be9604a57d976b2be0dd475e::evos {
    ...
    fun create_evos(arg0: 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::Witness<Evos>, arg1: &mut Incubator, arg2: &mut 0x2::tx_context::TxContext) : Evos {
        ...
        let v2 = select(0x1::vector::length<Specie>(&arg1.specs), &v1);
        assert!(v2 < 0x1::vector::length<Specie>(&arg1.specs), 11);
        let v3 = 0x1::vector::borrow<Specie>(&arg1.specs, v2);
        while (select(255, &v1) < (v3.weight as u64)) {
            v3 = 0x1::vector::borrow<Specie>(&arg1.specs, select(0x1::vector::length<Specie>(&arg1.specs), &v1));
        };
        let v4 = 0x1::vector::empty<0x1::ascii::String>();
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::ascii::String>(v5, 0x1::ascii::string(b"gems"));
        0x1::vector::push_back<0x1::ascii::String>(v5, 0x1::ascii::string(b"xp"));
        0x1::vector::push_back<0x1::ascii::String>(v5, 0x1::ascii::string(b"species"));
        0x1::vector::push_back<0x1::ascii::String>(v5, 0x1::ascii::string(b"stage"));
        let v6 = 0x1::vector::empty<0x1::ascii::String>();
        let v7 = &mut v6;
        0x1::vector::push_back<0x1::ascii::String>(v7, 0x1::ascii::string(b"0"));
        0x1::vector::push_back<0x1::ascii::String>(v7, 0x1::ascii::string(b"0"));
        0x1::vector::push_back<0x1::ascii::String>(v7, 0x1::string::to_ascii(v3.name));
        0x1::vector::push_back<0x1::ascii::String>(v7, 0x1::ascii::string(b"Egg"));
        let v8 = Evos{
            ...
            xp         : 0,
            gems       : 0,
            url        : 0x2::url::new_unsafe_from_bytes(v3.url),
            attributes : 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::from_vec(v4, v6),
        };
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_event::emit_mint<Evos>(arg0, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::collection_id<Evos>(&arg1.mint_cap), &v8);
        v8
    }
    ...
    public entry fun get_slot_deposit_at(arg0: 0x2::object::ID, arg1: &Incubator, arg2: &mut 0x2::tx_context::TxContext) : u64 {
    ...
    fun sort_array(arg0: &mut vector<Specie>) {
        let v0 = 0x1::vector::length<Specie>(arg0);
        let v1 = 0;
        let v2 = 0;
        while (v1 < v0) {
            let v3 = false;
            while (v2 < v0 - v1 - 1) {
                if (0x1::vector::borrow<Specie>(arg0, v2).weight > 0x1::vector::borrow<Specie>(arg0, v2 + 1).weight) {
                    0x1::vector::swap<Specie>(arg0, v2, v2 + 1);
                    v3 = true;
                };
                v2 = v2 + 1;
            };
