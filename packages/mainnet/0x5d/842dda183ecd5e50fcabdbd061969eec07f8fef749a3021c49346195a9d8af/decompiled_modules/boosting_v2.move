module 0x304cfcfddc0ffef090de03bb4733b64ffa01bc4ccd201fd0a589c2b16c3eba10::boosting_v2 {
    ...
    public fun deposit_pre_subscribe<T0>(arg0: &0x304cfcfddc0ffef090de03bb4733b64ffa01bc4ccd201fd0a589c2b16c3eba10::guild::Config, arg1: &mut PreSubscribe, arg2: &mut BoostingVault, arg3: u8, arg4: 0x2::balance::Balance<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_set::contains<address>(&arg1.subscribers, &v3)) {
            ...
            let v5 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.subscribers_type, 1);
            assert!(!0x2::vec_set::contains<address>(v5, &v3), 7009);
            0x2::vec_set::insert<address>(v5, v3);
        } else {
            assert!(v2 == v1, 7002);
        ...
        let v6 = DepositPreSubscribeEvent{
            pre_subscribe : 0x2::object::id<PreSubscribe>(arg1),
            subscriber    : v3,
            type          : arg3,
            amount        : v1,
        };
        0x2::event::emit<DepositPreSubscribeEvent>(v6);
    }
    ...
    public fun pre_subscribe<T0>(arg0: &0x304cfcfddc0ffef090de03bb4733b64ffa01bc4ccd201fd0a589c2b16c3eba10::guild::Config, arg1: &mut PreSubscribe, arg2: &mut BoostingVault, arg3: u8, arg4: 0x2::balance::Balance<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_set::contains<address>(&arg1.subscribers, &v1)) {
            ...
            let v5 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.subscribers_type, 1);
            assert!(!0x2::vec_set::contains<address>(v5, &v1), 7009);
            0x2::vec_set::insert<address>(v5, v1);
        } else {
        ...
        *v2 = *v2 - 1;
        assert!(arg1.fee_type == 0x1::type_name::get<T0>(), 7005);
        deposit_to_vault<T0>(arg2, arg4, arg5);
        let v6 = PreSubscribeEvent{
            subscriber : 0x2::tx_context::sender(arg6),
            type       : arg3,
            amount     : v3,
        };
        0x2::event::emit<PreSubscribeEvent>(v6);
    }
