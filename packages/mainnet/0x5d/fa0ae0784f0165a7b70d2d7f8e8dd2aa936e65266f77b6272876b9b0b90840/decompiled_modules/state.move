module 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::state {
    ...
    fun cal_sqrt_price(arg0: u256, arg1: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::I128, arg2: u256) : u256 {
        ...
        let v1 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::is_neg(arg1)) {
            0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::sqrt(v0 * v0 + 4 * arg0 * arg2) - v0
        } else {
            0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::sqrt(v0 * v0 + 4 * arg0 * arg2) + v0
        };
        (v1 << 64) / (arg0 << 1)
    ...
    public fun solve_one_for_zero(arg0: &SwapState) : u128 {
        let v0 = 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::constants::max_fee_pips_u256() - arg0.fee_pips;
        let v1 = arg0.liquidity << 64;
        let v2 = arg0.amount_x_desired + v1 / arg0.sqrt_price;
        let v3 = 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_price * 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::constants::max_fee_pips_u256() / v0);
        let v4 = arg0.amount_y_desired + v3 - 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_ratio_lower);
        assert!(v4 > arg0.amount_y_desired, 0);
        (0x1::u256::max(cal_sqrt_price(v2 - v1 * 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::constants::max_fee_pips_u256() / v0 * arg0.sqrt_ratio_upper, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::mul_div_Q64(v2, arg0.sqrt_ratio_lower) as u128)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from(((arg0.fee_pips * arg0.liquidity / v0) as u128))), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((((arg0.amount_y_desired + v3 << 64) / arg0.sqrt_ratio_upper) as u128))), v4), arg0.sqrt_price) as u128)
    }

    public fun solve_zero_for_one(arg0: &SwapState) : u128 {
        let v0 = 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::constants::max_fee_pips_u256() - arg0.fee_pips;
        let v1 = arg0.liquidity << 64;
        let v2 = v1 * 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::constants::max_fee_pips_u256() / v0 * arg0.sqrt_price;
        let v3 = arg0.amount_x_desired + v2 - v1 / arg0.sqrt_ratio_upper;
        assert!(v3 > arg0.amount_x_desired, 0);
        let v4 = arg0.amount_y_desired + 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_price);
        (0x1::u256::min(cal_sqrt_price(v3, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::add(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::mul_div_Q64(arg0.amount_x_desired + v2, arg0.sqrt_ratio_lower) as u128)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from(((arg0.fee_pips * arg0.liquidity / v0) as u128))), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((((v4 << 64) / arg0.sqrt_ratio_upper) as u128))), v4 - 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::safe_math::mul_div_Q64(arg0.liquidity, 0x5dfa0ae0784f0165a7b70d2d7f8e8dd2aa936e65266f77b6272876b9b0b90840::constants::max_fee_pips_u256() * arg0.sqrt_ratio_lower / v0)), arg0.sqrt_price) as u128)
    }
