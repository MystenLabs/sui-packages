module 0x5d53929dac7347a679e5e26dd28374b6e3d759ccb5b57c4d3e5b9745acb737ac::cnsnft1429 {
    struct CNSNFT1429 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1429, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1429>(arg0, arg1);
