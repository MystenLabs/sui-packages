module 0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>,
        gas_fee: u16,
        owner: address,
        ref1: u16,
        ref2: u16,
    ...
    entry fun add_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: 0x2::coin::TreasuryCap<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury"), arg2);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version : 1,
            balance : 0x2::balance::zero<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>(),
            gas_fee : 3000,
            owner   : v0,
            ref1    : 2000,
            ref2    : 500,
    ...
    entry fun remove_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg2));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>>(0x2::coin::from_balance<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>(0x2::balance::split<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>>(0x2::coin::from_balance<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>(0x2::balance::withdraw_all<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>>(0x2::coin::mint<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0x5d91602187541cba7bf8d0b9d972393f41853797bae174f431d03e71886f41de::tonminer::TONMINER>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
