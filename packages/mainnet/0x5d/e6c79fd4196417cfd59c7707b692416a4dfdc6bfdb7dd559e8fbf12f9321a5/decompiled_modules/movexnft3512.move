module 0x5de6c79fd4196417cfd59c7707b692416a4dfdc6bfdb7dd559e8fbf12f9321a5::movexnft3512 {
    struct MOVEXNFT3512 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT3512, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT3512>(arg0, arg1);
