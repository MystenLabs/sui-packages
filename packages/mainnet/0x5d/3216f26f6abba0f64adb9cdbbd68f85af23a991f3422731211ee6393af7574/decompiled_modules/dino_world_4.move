module 0x5d3216f26f6abba0f64adb9cdbbd68f85af23a991f3422731211ee6393af7574::dino_world_4 {
    struct DINO_WORLD_4 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DINO_WORLD_4, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DINO_WORLD_4>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dino World 4"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Dino World"));
