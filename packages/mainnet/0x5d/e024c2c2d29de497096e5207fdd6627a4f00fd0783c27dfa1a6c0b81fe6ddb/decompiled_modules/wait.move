module 0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::wait {
    ...
    public fun borrow_contribution(arg0: &WaitCard) : &0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::WarlotData {
        0x2::dynamic_field::borrow<vector<u8>, 0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::WarlotData>(&arg0.id, b"WARLOT CONTRIBUTIONS")
    }

    public fun borrow_contribution_mut(arg0: &mut AdminCap, arg1: &mut WaitCard) : &mut 0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::WarlotData {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::WarlotData>(&mut arg1.id, b"WARLOT CONTRIBUTIONS")
    }
    ...
    fun destroy_dfield(arg0: &mut 0x2::object::UID) {
        ...
        if (v0 == true) {
            0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::destroy(0x2::dynamic_field::remove<vector<u8>, 0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::WarlotData>(arg0, b"WARLOT CONTRIBUTIONS"));
        };
    }
    ...
    fun init(arg0: WAIT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://waitlist.warlot.xyz/image/thumbnail"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://waitlist.warlot.xyz/image/thumbnail2"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://waitlist.warlot.xyz/image/thumbnail"));
        ...
        let v7 = WaitCard{
            ...
            image_url   : 0x1::string::utf8(b"https://waitlist.warlot.xyz/image/thumbnail"),
    ...
    fun mint(arg0: &CloneWaitCard<WAIT>, arg1: &mut 0x2::tx_context::TxContext) : WaitCard {
        ...
        0x2::dynamic_field::add<vector<u8>, 0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::WarlotData>(&mut v1.id, b"WARLOT CONTRIBUTIONS", 0x5de024c2c2d29de497096e5207fdd6627a4f00fd0783c27dfa1a6c0b81fe6ddb::contribution::create());
        v1
    }
