module 0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::stake_plan {
    ...
    public fun addMemberInVault(arg0: &AdminCap, arg1: address, arg2: &mut Vault, arg3: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun changeMemberInVault(arg0: &AdminCap, arg1: address, arg2: &mut Vault, arg3: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg3, 1);
    ...
    public fun changeOperationWallet(arg0: &mut Operation, arg1: &Vault, arg2: address, arg3: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg3, 1);
    ...
    public fun createPool<T0, T1>(arg0: &ManagerCap, arg1: &mut ProjectRegistry, arg2: u64, arg3: u128, arg4: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun depositRewardCoins<T0, T1>(arg0: &TreasureCap, arg1: &mut StakePool<T0, T1>, arg2: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg3: 0x2::coin::Coin<T1>) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg2, 1);
    ...
    public fun getUserClaimableTokens<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: address, arg2: u64) : (u128, u128) {
        ...
        while (v1 < 0x1::vector::length<StakeItem>(v0)) {
            ...
            if (arg2 >= v4.unlock_time && !v4.claimed) {
                v3 = v3 + v4.stake;
            };
    ...
    fun init(arg0: STAKE_PLAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::cap_vault::createVault<AdminCap>(arg1);
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::cap_vault::createVault<ManagerCap>(arg1);
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::cap_vault::createVault<TreasureCap>(arg1);
    ...
    public fun pause<T0, T1>(arg0: &ManagerCap, arg1: &mut StakePool<T0, T1>, arg2: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg2, 1);
        arg1.paused = true;
    ...
    public fun start<T0, T1>(arg0: &ManagerCap, arg1: &mut StakePool<T0, T1>, arg2: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg2, 1);
        arg1.paused = false;
    ...
    public fun stopEmergency<T0, T1>(arg0: &ManagerCap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: bool, arg4: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg4, 1);
        let v0 = 0;
    ...
    public fun updateApy<T0, T1>(arg0: &ManagerCap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u128, arg4: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg5: &0x2::clock::Clock) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg4, 1);
        assert!(arg3 > 0, 8001);
    ...
    public fun updateUnlockTime<T0, T1>(arg0: &ManagerCap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version) {
    ...
    public fun withdrawRewardCoins<T0, T1>(arg0: &TreasureCap, arg1: &mut StakePool<T0, T1>, arg2: &Operation, arg3: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg3, 1);
    ...
    public fun withdrawRockee<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg2, 1);
        assert!(!arg0.paused, 8008);
        ...
        while (v3 < 0x1::vector::length<StakeItem>(v2)) {
            ...
            if (v1 >= v5.unlock_time && !v5.claimed) {
                v5.claimable = true;
                v5.withdraw_stake = v5.stake;
                v4 = v4 + v5.stake;
                v5.unstaked = true;
    ...
    public fun withdrawStakeCoins<T0, T1>(arg0: &TreasureCap, arg1: &mut StakePool<T0, T1>, arg2: &Operation, arg3: &0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x5d6ebf942572a1a505e2cd219e6ff401fa8a0e5d239ebef33a1d6dfdd4caf1b7::version::checkVersion(arg3, 1);
