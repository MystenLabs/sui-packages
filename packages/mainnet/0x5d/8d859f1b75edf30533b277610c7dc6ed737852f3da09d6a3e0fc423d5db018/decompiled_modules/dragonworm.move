module 0x5d8d859f1b75edf30533b277610c7dc6ed737852f3da09d6a3e0fc423d5db018::dragonworm {
    struct DRAGONWORM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DRAGONWORM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://i.postimg.cc/cJdXfZ3z/Q3Stc493-Sf-W8i-X.jpg";
        let v1 = if (0x1::vector::is_empty<u8>(&v0)) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v0))
        };
        let (v2, v3) = 0x2::coin::create_currency<DRAGONWORM>(arg0, 9, b"DragonWorm", b"Dragon Worm", b"Dragon Worm", v1, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<DRAGONWORM>>(v3);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<DRAGONWORM>>(v2);
        let v4 = CoinSocialLinks{
            id       : 0x2::object::new(arg1),
            website  : 0x1::string::utf8(b"https://dragonworm.lol/"),
            twitter  : 0x1::string::utf8(b""),
            telegram : 0x1::string::utf8(b""),
        };
        0x2::transfer::share_object<CoinSocialLinks>(v4);
        let v5 = AdminCap{
            id            : 0x2::object::new(arg1),
        ...
        0x2::transfer::public_transfer<AdminCap>(v5, 0x2::tx_context::sender(arg1));
        let v6 = TaxStorage{
            id        : 0x2::object::new(arg1),
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<DRAGONWORM>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<DRAGONWORM>(0x2::coin::balance_mut<DRAGONWORM>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<DRAGONWORM>>(0x2::coin::from_balance<DRAGONWORM>(0x2::balance::split<DRAGONWORM>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<DRAGONWORM>>(0x2::coin::from_balance<DRAGONWORM>(0x2::balance::split<DRAGONWORM>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<DRAGONWORM>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<DRAGONWORM>>(0x2::coin::from_balance<DRAGONWORM>(v3, arg5), arg4);
        };
    }
