module 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::marketplace {
    ...
    public fun accept_unlisted_bid<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: address, arg7: 0x2::object::ID, arg8: bool, arg9: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg10: &mut 0xb52b5bf61cf58c7d785c1fddee3eb1baae54ebb0a3b15f2007b314670d0dddc7::ions::AnimaIONs, arg11: &mut 0xb52b5bf61cf58c7d785c1fddee3eb1baae54ebb0a3b15f2007b314670d0dddc7::ions::AnimaChef, arg12: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        let v18 = v17 - v10 - v11;
        0x2::kiosk::list<T0>(arg3, arg4, arg5, v18);
        let (v19, v20) = 0x2::kiosk::purchase<T0>(arg3, arg5, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v9, v18), arg12));
        let v21 = v20;
        0x2::kiosk::lock<T0>(arg2, &arg1.escrow_kiosk_cap, arg9, v19);
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(arg9)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v21, arg2);
        };
        if (v11 > 0 && 0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(arg9)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg9, &mut v21, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v9, v11), arg12));
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.available_sui, 0x2::balance::split<0x2::sui::SUI>(&mut v9, v10));
        0x2::balance::join<0x2::sui::SUI>(&mut v9, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::kiosk::withdraw(arg3, arg4, 0x1::option::some<u64>(v18), arg12)));
        ...
        v8.lifetime_volume = v8.lifetime_volume + (v17 as u128);
        update_collection_avg_price<T0>(v8, v17);
        let (v22, v23) = if (v8.ion_points_enabled) {
            let v24 = if (v8.ion_collection_multiplier == 0) {
                1000
            } else {
                v8.ion_collection_multiplier
            };
            let v25 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_bid_proximity_multiplier(v17, v8.avg_sale_price);
            let v26 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_time_multiplier(0x2::clock::timestamp_ms(arg0) - v3, true);
            let v27 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_ion_points(v17, v24, v25, v26);
            award_ion_points_with_referral(v0, arg1, arg10, v27, arg0, arg11);
            let v28 = 0x8a98290668a674241f7d42e95cfd47ddabb4de9e2e76e52b79a0af9d542a4e90::helpers::calculate_ion_points(v17, v24, v25, v26);
            let v29 = 0x2::linked_table::borrow_mut<address, UserInfo>(&mut arg1.user_activity, arg6);
            v29.claimable_points = v29.claimable_points + v28;
            (v28, v27)
        } else {
            (0, 0)
        };
        let v30 = BidAcceptedEvent{
            nft_type          : v1,
            nft_id            : arg5,
            seller            : v0,
            buyer             : arg6,
            ...
            commission        : v10,
            escrow_kiosk      : 0x2::object::id<0x2::kiosk::Kiosk>(arg2),
            buyer_ion_points  : v22,
            seller_ion_points : v23,
        };
        0x2::event::emit<BidAcceptedEvent>(v30);
        v21
    }
    ...
    public fun process_pending_claim_test<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut MarketPlaceStore, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0x1::debug::print<address>(&v0);
        0x1::debug::print<0x2::object::ID>(&arg6);
        let v2 = 0x1::string::utf8(b"Pending claim verified for buyer");
        ...
        let (v3, v4) = 0x2::kiosk::purchase<T0>(arg2, arg6, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::zero<0x2::sui::SUI>(), arg7));
        let v5 = v4;
        0x2::kiosk::lock<T0>(arg4, arg5, arg3, v3);
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(arg3)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v5, arg4);
        };
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(arg3)) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg3, &mut v5, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::zero<0x2::sui::SUI>(), arg7));
        };
        v5
    }
