module 0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::fair_launch {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun finalize_fair_launch<T0, T1>(arg0: &0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::main::MainConfig, arg1: &mut FairLaunch<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::LpVault<T0, T1>> {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        let v1 = 0x2::balance::value<T1>(&arg1.balance_y);
        assert!(v1 >= arg1.soft_cap && v0 > arg1.end_time, 8);
        if (v0 < arg1.timestamp_last_ms + 0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::main::curator_finalizing_cooldown(arg0) || v0 < arg1.end_time + 0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::main::curator_finalizing_cooldown(arg0)) {
        ...
        let v2 = @0x0;
        let v3 = 0;
        let v4 = 0x1::option::none<0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::LpVault<T0, T1>>();
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v12) {
                ...
                let v22 = 0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::new_lp_vault<T0, T1>(v19, arg1.curator, arg7);
                0x1::option::fill<0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::LpVault<T0, T1>>(&mut v4, v22);
                0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::events::emit_lp_vault_created<T0, T1>(0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::events::get_id(&arg1.id), 0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::id<T0, T1>(&v22), arg1.curator, v21, v15, v5, v6);
            } else {
                let v23 = sqrt(340282366920938463463374607431768211456 * (v6 as u256) / (v5 as u256));
                v3 = v23;
                ...
                let v30 = 0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::new_lp_vault<T0, T1>(v27, arg1.curator, arg7);
                0x1::option::fill<0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::LpVault<T0, T1>>(&mut v4, v30);
                0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::events::emit_lp_vault_created<T0, T1>(0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::events::get_id(&arg1.id), 0x5d5eaf503ce0045258e9b5c43897252e05ba1ed9bc96a348adf9f75f507edd8b::vault::id<T0, T1>(&v30), arg1.curator, v29, v23, v5, v6);
            };
        };
        ...
        let v31 = FairLaunchFinalized<T0, T1>{
        ...
        0x2::event::emit<FairLaunchFinalized<T0, T1>>(v31);
        v4
    }
