module 0x5da66a74413baaaeaba6cba44c74b1ef0bee3a9da9233c8bfbc34c8479599c52::cnsnft4584 {
    struct CNSNFT4584 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4584, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4584>(arg0, arg1);
