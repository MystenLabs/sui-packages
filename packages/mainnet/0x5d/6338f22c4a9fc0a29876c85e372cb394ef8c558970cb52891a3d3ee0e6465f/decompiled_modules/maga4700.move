module 0x5d6338f22c4a9fc0a29876c85e372cb394ef8c558970cb52891a3d3ee0e6465f::maga4700 {
    ...
    fun init(arg0: MAGA4700, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<MAGA4700>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"MAGA4700")))), trim_right(b"MAGA4700                        "), trim_right(b"MAGA4700 | MAKE AMERICAN GREAT AGAIN | TRUMP4700                                                                                                                                                                                                                                                                                "), v2, arg1);
