module 0x5d663fe35c25c54fe701cc9490e516722590e28722c34325dc6f1e20b2e8576c::suilens_core {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalRegistry{
            id                 : 0x2::object::new(arg0),
            events             : 0x2::table::new<0x2::object::ID, Event>(arg0),
            user_profiles      : 0x2::table::new<address, UserProfile>(arg0),
            event_counter      : 0,
            total_users        : 0,
            platform_fee_rate  : 250,
            platform_balance   : 0x2::balance::zero<0x2::sui::SUI>(),
            attendance_records : 0x2::table::new<0x2::object::ID, 0x2::vec_set::VecSet<address>>(arg0),
            event_waitlists    : 0x2::table::new<0x2::object::ID, 0x2::vec_set::VecSet<address>>(arg0),
            registrations      : 0x2::table::new<0x2::object::ID, EventRegistration>(arg0),
            user_registrations : 0x2::table::new<address, 0x2::vec_set::VecSet<0x2::object::ID>>(arg0),
        };
        0x2::transfer::transfer<AdminCap>(v0, 0x2::tx_context::sender(arg0));
        0x2::transfer::share_object<GlobalRegistry>(v1);
    }
