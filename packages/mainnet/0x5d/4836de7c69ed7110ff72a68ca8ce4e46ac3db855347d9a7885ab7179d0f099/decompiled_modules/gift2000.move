module 0x5d4836de7c69ed7110ff72a68ca8ce4e46ac3db855347d9a7885ab7179d0f099::gift2000 {
    struct GIFT2000 has drop {
        dummy_field: bool,
    }

    struct TICKET_2000 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2000(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2000>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2000>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2000, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2000>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2000>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2000>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2000>>(v5, 0x2::tx_context::sender(arg1));
    }
