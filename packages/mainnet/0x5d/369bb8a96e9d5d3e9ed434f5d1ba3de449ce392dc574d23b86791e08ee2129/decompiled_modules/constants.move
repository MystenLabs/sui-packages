module 0x5d369bb8a96e9d5d3e9ed434f5d1ba3de449ce392dc574d23b86791e08ee2129::constants {
    ...
    public fun default_dao_creation_fee() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::default_dao_creation_fee()
    }

    public fun default_launchpad_creation_fee() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::default_launchpad_creation_fee()
    }
    ...
    public fun default_proposal_creation_fee() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::default_proposal_creation_fee()
    }

    public fun default_proposal_fee_per_outcome() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::default_proposal_fee_per_outcome()
    }
    ...
    public fun execution_window_ms() : u64 {
        let v0 = 1800000;
        let v1 = 0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::min_execution_window_ms();
        if (v0 > v1) {
            v0
        } else {
            v1
    ...
    public fun launchpad_bid_fee_per_contribution() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::launchpad_bid_fee_per_contribution()
    }
    ...
    public fun launchpad_min_duration_ms() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::launchpad_min_duration_ms()
    }
    ...
    public fun min_execution_window_ms() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::min_execution_window_ms()
    }
    ...
    public fun min_proposal_intent_expiry_ms() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::min_proposal_intent_expiry_ms()
    }

    public fun min_review_period_ms() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::min_review_period_ms()
    }

    public fun min_trading_period_ms() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::min_trading_period_ms()
    }
    ...
    public fun protocol_min_liquidity_amount() : u64 {
        0xdd5fa72b9e1b14b4184938c6c818edc6049cd8046bc0dc6d7e060a7c9346a1de::constants::protocol_min_liquidity_amount()
    }
