module 0x5d80db4a477bdc69dd3134866afdc94de9f7a0488e2c96411dbc256540f26225::supra {
    ...
    fun init(arg0: SUPRA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUPRA>(arg0, 9, b"freedurov.website", b"reward", b"", 0x1::option::none<0x2::url::Url>(), arg1);
