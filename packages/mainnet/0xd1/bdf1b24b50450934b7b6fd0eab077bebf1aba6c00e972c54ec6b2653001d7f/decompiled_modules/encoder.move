module 0x6f35a78c8338c61d78c3086772e0bfb02b9acac78286bf0a005291b887aa6cd8::encoder {
    ...
    public fun encode_length(arg0: u64, arg1: u8) : vector<u8> {
        ...
        if (arg0 < 56) {
            ...
            let v1 = 0x6f35a78c8338c61d78c3086772e0bfb02b9acac78286bf0a005291b887aa6cd8::utils::to_bytes_u64(arg0);
    ...
    public fun encode_list(arg0: &vector<vector<u8>>, arg1: bool) : vector<u8> {
        ...
        if (0x1::vector::length<vector<u8>>(&v2) > 0) {
            ...
            if (0x1::vector::length<u8>(&v0) <= 55) {
                ...
                let v4 = 0x6f35a78c8338c61d78c3086772e0bfb02b9acac78286bf0a005291b887aa6cd8::utils::to_bytes_u64(0x1::vector::length<u8>(&v0));
    ...
    public fun encode_u128(arg0: u128) : vector<u8> {
        let v0 = 0x6f35a78c8338c61d78c3086772e0bfb02b9acac78286bf0a005291b887aa6cd8::utils::to_bytes_u128(arg0);
        encode(&v0)
    }

    public fun encode_u64(arg0: u64) : vector<u8> {
        let v0 = 0x6f35a78c8338c61d78c3086772e0bfb02b9acac78286bf0a005291b887aa6cd8::utils::to_bytes_u64(arg0);
        encode(&v0)
    }
