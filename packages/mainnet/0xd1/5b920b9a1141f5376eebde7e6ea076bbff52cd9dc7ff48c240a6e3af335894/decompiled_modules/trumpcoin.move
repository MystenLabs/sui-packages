module 0xd15b920b9a1141f5376eebde7e6ea076bbff52cd9dc7ff48c240a6e3af335894::trumpcoin {
    ...
    fun init(arg0: TRUMPCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/Bj9Jksrp9vxughKiJnk1ka2Vxr2YBimdEtFtpgjQpump.png                                                                                                                                                                                                                               ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRUMPCOIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TRUMPCOIN ")))), trim_right(b"TRUMPCOIN                       "), trim_right(b"TrumpCoin isnt just                                                                                                                                                                                                                                                                                                             "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
