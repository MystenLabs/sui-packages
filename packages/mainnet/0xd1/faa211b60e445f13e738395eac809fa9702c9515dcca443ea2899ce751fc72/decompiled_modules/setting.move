module 0xd1faa211b60e445f13e738395eac809fa9702c9515dcca443ea2899ce751fc72::setting {
    struct SETTING has drop {
        dummy_field: bool,
    }
    ...
    public fun claim_fee<T0>(arg0: &AdminCap, arg1: &mut Config, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg1.balances, v0), 1001);
    ...
    fun init(arg0: SETTING, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Config{
