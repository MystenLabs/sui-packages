module 0xd18a21b17745bba5427f553eb73eba46feaccf4d678da386d8cd110a9f0d07bc::reward5410 {
    struct REWARD5410 has drop {
        dummy_field: bool,
    }

    struct TICKET_5410 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5410(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5410>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5410>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5410, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5410>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5410>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5410>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5410>>(v5, 0x2::tx_context::sender(arg1));
    }
