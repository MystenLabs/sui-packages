module 0xd13ceb34a086ac7f28acd2563aae177a6c716ff6b944b4c1b9243d9cb6f4d37c::aipp {
    ...
    fun init(arg0: AIPP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AIPP>(arg0, 100, b"AIPP", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
