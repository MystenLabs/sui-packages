module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_calculator {
    ...
    public fun compute_notional_value(arg0: u64, arg1: u64) : u64 {
        (((arg0 as u128) * (arg1 as u128) / 100000000) as u64)
    }
    ...
    public fun compute_unrealized_pnl(arg0: u64, arg1: u64, arg2: u64, arg3: bool) : SignedValue {
        ...
        SignedValue{
            value       : (((arg0 as u128) * (v0 as u128) / 100000000) as u64),
            is_negative : v1,
        }
    }
