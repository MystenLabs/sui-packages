module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::insurance_fund {
    ...
    public fun balance_canonical_usd8(arg0: &InsuranceFundState) : u64 {
        arg0.balance / 10
    }
    ...
    public(friend) fun cover_deficit(arg0: &mut InsuranceFundState, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        assert!(arg0.initialized, 1);
        assert!(arg1 > 0, 3);
        let v0 = (arg1 as u128) * (10 as u128);
        ...
        let v3 = ((v2 / (10 as u128)) as u64);
        let v4 = (v3 as u128) * (10 as u128);
        arg0.balance = ((v1 - v4) as u64);
        arg0.total_outflows = arg0.total_outflows + v4;
        arg0.total_deficit_covered = arg0.total_deficit_covered + v4;
        let v5 = DeficitCovered{
            deficit_amount : arg1,
            amount_covered : v3,
            new_balance    : arg0.balance,
        };
        0x2::event::emit<DeficitCovered>(v5);
        update_n_max_scale(arg0, arg2);
        v3
    }
    ...
    public fun initialize_fund(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut InsuranceFundState, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    public fun treasury_deposit(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut InsuranceFundState, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    public fun treasury_withdraw(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut InsuranceFundState, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg1.initialized, 1);
        assert!(arg2 > 0, 3);
