module 0xd1eefc1ec6611c541e5e7dea90fe02ab28f4e52f3c67c1b7afc4b75956d3ac2b::tokifi_gold_v1_ {
    struct TOKIFI_GOLD_V1_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"d239d23d-3123-4d33-bd8a-f6e6d72d457f"),
        };
    ...
    fun init(arg0: TOKIFI_GOLD_V1_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TOKIFI_GOLD_V1_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ToKiFi Gold V1."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Golden Tokifi NFT Collection V1."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmUuwp2mrh4Pvn3yfWi5P2VeT2hwy2wCbqc8bwESyo9k5U"));
