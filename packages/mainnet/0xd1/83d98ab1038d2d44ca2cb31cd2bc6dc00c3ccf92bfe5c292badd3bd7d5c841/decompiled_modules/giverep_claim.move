module 0xd183d98ab1038d2d44ca2cb31cd2bc6dc00c3ccf92bfe5c292badd3bd7d5c841::giverep_claim {
    ...
    public fun add_whitelist(arg0: &mut Whitelist, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x1::vector::contains<address>(&arg0.whitelist, &v0), 1);
    ...
    public fun init_pool<T0>(arg0: &Whitelist, arg1: vector<address>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_whitelist(arg0: &mut Whitelist, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x1::vector::contains<address>(&arg0.whitelist, &v0) && 0x1::vector::length<address>(&arg0.whitelist) > 1, 1);
        let (_, v2) = 0x1::vector::index_of<address>(&arg0.whitelist, &arg1);
