module 0xd1c533feb74dbbe1c7e4264adcad3c584ff3f0fe67afd2873b8c50359e8cf7d2::peace {
    ...
    fun init(arg0: PEACE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PEACE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PEACE     ")))), trim_right(b"Peace Coin                      "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
