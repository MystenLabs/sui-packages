module 0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::lottery_gold_diamond {
    struct GoldToDiamondLottery has key {
        id: 0x2::object::UID,
        round: u64,
    ...
    public entry fun draw(arg0: &mut GoldToDiamondLottery, arg1: &mut 0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::Hall, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v6 > 0) {
            0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::deposit_lottery_rewards(0x2::coin::take<0x2::sui::SUI>(&mut arg0.prize_pool, v6, arg3), 0x1::string::utf8(b"GoldToDiamond Lottery"), arg1);
        };
        let v16 = 0;
        while (v16 < v0) {
    ...
    public entry fun emergency_return_all_nfts(arg0: &mut GoldToDiamondLottery, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun enter(arg0: &mut GoldToDiamondLottery, arg1: 0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::RoastNFT, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<LotteryEntry>(&arg0.entries);
        assert!(v0 < 100, 0);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= 10000000000, 1);
        assert!(!arg0.is_drawing, 5);
        assert!(0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::is_gold(&arg1), 2);
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.prize_pool, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, 10000000000, arg4)));
    ...
    public fun get_entry_count(arg0: &GoldToDiamondLottery) : u64 {
    ...
    public fun get_prize_pool(arg0: &GoldToDiamondLottery) : u64 {
        0x2::balance::value<0x2::sui::SUI>(&arg0.prize_pool)
    }

    public fun get_round(arg0: &GoldToDiamondLottery) : u64 {
        arg0.round
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GoldToDiamondLottery{
        ...
        0x2::transfer::share_object<GoldToDiamondLottery>(v0);
    }

    public fun is_full(arg0: &GoldToDiamondLottery) : bool {
        0x1::vector::length<LotteryEntry>(&arg0.entries) >= 100
    }

    public fun is_nft_entered(arg0: &GoldToDiamondLottery, arg1: 0x2::object::ID) : bool {
        0x1::vector::contains<0x2::object::ID>(&arg0.entered_nft_ids, &arg1)
    }

    public fun is_ready_for_draw(arg0: &GoldToDiamondLottery) : bool {
        0x1::vector::length<LotteryEntry>(&arg0.entries) >= 100 && !arg0.is_drawing
    }
