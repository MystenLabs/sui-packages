module 0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame {
    ...
    public fun get_nft_id(arg0: &RoastNFT) : 0x2::object::ID {
        0x2::object::id<RoastNFT>(arg0)
    }
    ...
    public fun is_common(arg0: &RoastNFT) : bool {
        arg0.rarity == 0
    }
    ...
    public fun is_gold(arg0: &RoastNFT) : bool {
        arg0.rarity == 2
    }

    public fun is_silver(arg0: &RoastNFT) : bool {
        arg0.rarity == 1
    }
    ...
    public fun rarity_diamond() : u8 {
        3
    }

    public fun rarity_gold() : u8 {
        2
    }

    public fun rarity_silver() : u8 {
        1
    }
