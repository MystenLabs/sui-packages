module 0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::lottery_silver_gold {
    ...
    public entry fun draw(arg0: &mut SilverToGoldLottery, arg1: &mut 0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::Hall, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v6 > 0) {
            0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::deposit_lottery_rewards(0x2::coin::take<0x2::sui::SUI>(&mut arg0.prize_pool, v6, arg3), 0x1::string::utf8(b"SilverToGold Lottery"), arg1);
        };
        let v16 = 0;
        while (v16 < v0) {
    ...
    public entry fun emergency_return_all_nfts(arg0: &mut SilverToGoldLottery, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun enter(arg0: &mut SilverToGoldLottery, arg1: 0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::RoastNFT, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<LotteryEntry>(&arg0.entries);
        assert!(v0 < 50, 0);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= 5000000000, 1);
        assert!(!arg0.is_drawing, 5);
        assert!(0xd1eab0c7d9fc9878533f108d0397019066bc235415331f18cf10703822a552fd::hall_of_shame::is_silver(&arg1), 2);
    ...
    public fun is_nft_entered(arg0: &SilverToGoldLottery, arg1: 0x2::object::ID) : bool {
        0x1::vector::contains<0x2::object::ID>(&arg0.entered_nft_ids, &arg1)
    }

    public fun is_ready_for_draw(arg0: &SilverToGoldLottery) : bool {
        0x1::vector::length<LotteryEntry>(&arg0.entries) >= 50 && !arg0.is_drawing
    }
