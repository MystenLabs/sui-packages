module 0xd148a71e37823158ca7eca79d0abd7b9715408f88849f446aec7b4f3a33fe59c::arbitrage {
    ...
    public fun execute_real_arbitrage_with_pools(arg0: &mut Arbitrage, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u64, arg5: u8, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(v0 == arg2, 2);
        let arg1 = if (arg4 > 0) {
            let v1 = if (0x2::balance::value<0x2::sui::SUI>(&arg0.treasury) >= arg4) {
                arg4
            } else {
                0
            };
            if (v1 > 0) {
                0x2::coin::join<0x2::sui::SUI>(&mut arg1, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.treasury, v1), arg7));
