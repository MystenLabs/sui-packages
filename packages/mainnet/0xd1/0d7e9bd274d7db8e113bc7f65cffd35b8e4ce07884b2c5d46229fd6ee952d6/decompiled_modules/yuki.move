module 0xd10d7e9bd274d7db8e113bc7f65cffd35b8e4ce07884b2c5d46229fd6ee952d6::yuki {
    ...
    fun init(arg0: YUKI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/HnaZaySA7GVPndpq9sZkWEjt4BpVfmeKgnanZpiipump.png?size=lg&key=df8e13                                                                                                                                                                                                            ");
