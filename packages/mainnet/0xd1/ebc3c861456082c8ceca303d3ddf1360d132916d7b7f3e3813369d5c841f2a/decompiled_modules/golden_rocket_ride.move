module 0xd1ebc3c861456082c8ceca303d3ddf1360d132916d7b7f3e3813369d5c841f2a::golden_rocket_ride {
    ...
    fun init(arg0: GOLDEN_ROCKET_RIDE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GOLDEN_ROCKET_RIDE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Golden rocket ride"));
