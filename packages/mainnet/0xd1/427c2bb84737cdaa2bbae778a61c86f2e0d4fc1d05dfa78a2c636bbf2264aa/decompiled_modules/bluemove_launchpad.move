module 0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad {
    ...
    public fun asser_suis_inscriptions<T0>() {
        assert!(get_token_name<T0>() == get_token_name<SUIS>(), 9);
    }
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = LaunchpadData{
            ...
            current_nft    : 0,
            current_place  : 0,
            base_name      : 0x1::string::utf8(b"suis #"),
