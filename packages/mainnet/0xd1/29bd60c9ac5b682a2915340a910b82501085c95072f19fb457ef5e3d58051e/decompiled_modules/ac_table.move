module 0xd129bd60c9ac5b682a2915340a910b82501085c95072f19fb457ef5e3d58051e::ac_table {
    ...
    struct AcTableCap<phantom T0> has store, key {
        id: 0x2::object::UID,
        ownership: 0xd129bd60c9ac5b682a2915340a910b82501085c95072f19fb457ef5e3d58051e::ownership::Ownership<AcTableOwnership>,
    }
    ...
    public fun borrow_mut<T0: drop, T1: copy + drop + store, T2: store>(arg0: &mut AcTable<T0, T1, T2>, arg1: &AcTableCap<T0>, arg2: T1) : &mut T2 {
        0xd129bd60c9ac5b682a2915340a910b82501085c95072f19fb457ef5e3d58051e::ownership::assert_owner<AcTableOwnership, AcTable<T0, T1, T2>>(&arg1.ownership, arg0);
    ...
    public fun new<T0: drop, T1: copy + drop + store, T2: store>(arg0: T0, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) : (AcTable<T0, T1, T2>, AcTableCap<T0>) {
        ...
        let v3 = AcTableCap<T0>{
            id        : 0x2::object::new(arg2),
            ownership : 0xd129bd60c9ac5b682a2915340a910b82501085c95072f19fb457ef5e3d58051e::ownership::create_ownership<AcTableOwnership>(v2, 0x2::object::id<AcTable<T0, T1, T2>>(&v1), arg2),
        };
        (v1, v3)
    }
