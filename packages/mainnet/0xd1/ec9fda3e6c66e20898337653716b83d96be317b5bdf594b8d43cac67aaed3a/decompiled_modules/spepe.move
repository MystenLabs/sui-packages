module 0xd1ec9fda3e6c66e20898337653716b83d96be317b5bdf594b8d43cac67aaed3a::spepe {
    ...
    public entry fun add_minter(arg0: &SPEPEAdminCap, arg1: &mut SPEPEStorage, arg2: 0x2::object::ID) {
        0x2::vec_set::insert<0x2::object::ID>(&mut arg1.minters, arg2);
        let v0 = MinterAdded{id: arg2};
        0x2::event::emit<MinterAdded>(v0);
    }

    public fun burn(arg0: &mut SPEPEStorage, arg1: 0x2::coin::Coin<SPEPE>) : u64 {
        0x2::balance::decrease_supply<SPEPE>(&mut arg0.supply, 0x2::coin::into_balance<SPEPE>(arg1))
    }

    fun init(arg0: SPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SPEPE>(arg0, 9, b"SPEPE", b"Sui PEPE ", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = 0x2::coin::treasury_into_supply<SPEPE>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<SPEPE>>(0x2::coin::from_balance<SPEPE>(0x2::balance::increase_supply<SPEPE>(&mut v2, 800000000000000000), arg1), 0x2::tx_context::sender(arg1));
    ...
    public fun is_minter(arg0: &SPEPEStorage, arg1: 0x2::object::ID) : bool {
        0x2::vec_set::contains<0x2::object::ID>(&arg0.minters, &arg1)
    }

    public fun mint(arg0: &mut SPEPEStorage, arg1: &0x2::package::Publisher, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<SPEPE> {
        assert!(is_minter(arg0, 0x2::object::id<0x2::package::Publisher>(arg1)), 1);
        0x2::coin::from_balance<SPEPE>(0x2::balance::increase_supply<SPEPE>(&mut arg0.supply, arg2), arg3)
    }

    public entry fun remove_minter(arg0: &SPEPEAdminCap, arg1: &mut SPEPEStorage, arg2: 0x2::object::ID) {
    ...
    public entry fun transfer_admin(arg0: SPEPEAdminCap, arg1: address) {
        assert!(arg1 != @0x0, 2);
        0x2::transfer::transfer<SPEPEAdminCap>(arg0, arg1);
