module 0x2b5cd7f4d6d6bedae194565d228d96c36ab98209a8ada90378a4cb2e955e9fa3::yapcoder {
    ...
    public fun read_yapcoder_details_owned(arg0: &YapCoder) : (0x2::object::ID, u64, u64, 0x1::string::String, 0x1::string::String, bool) {
        (0x2::object::id<YapCoder>(arg0), arg0.github_user_id, arg0.repo_id, 0x1::string::substring(&arg0.username, 0, 0x1::string::length(&arg0.username)), 0x1::string::substring(&arg0.repo_name, 0, 0x1::string::length(&arg0.repo_name)), arg0.is_validated)
    }
