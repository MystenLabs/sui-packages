module 0xd16844ca3fbbf9da702aeadae05139d9a1988e87281b59e5dab4167d039fb338::ducke {
    ...
    fun init(arg0: DUCKE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<DUCKE>(&mut v2, 69000000000000000, 0x2::tx_context::sender(arg1), arg1);
