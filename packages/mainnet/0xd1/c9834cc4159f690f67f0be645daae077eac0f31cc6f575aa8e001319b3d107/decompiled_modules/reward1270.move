module 0xd1c9834cc4159f690f67f0be645daae077eac0f31cc6f575aa8e001319b3d107::reward1270 {
    struct REWARD1270 has drop {
        dummy_field: bool,
    }

    struct TICKET_1270 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1270(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1270>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1270>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1270, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1270>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1270>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1270>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1270>>(v5, 0x2::tx_context::sender(arg1));
    }
