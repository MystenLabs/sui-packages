module 0xd16f05c1ffaad513f4578caf6582e1ca2566803a60d09bba796b6326a564fabf::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"SUIAGENT", b"suiagent", b"suiagentsuiagentsuiagentsuiagentsuiagent", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dapp.suiagents.ai/assets/images/nft-images/agent.jpg")), arg1);
