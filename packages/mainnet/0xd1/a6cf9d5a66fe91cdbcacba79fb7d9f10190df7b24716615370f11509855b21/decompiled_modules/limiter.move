module 0xd1a6cf9d5a66fe91cdbcacba79fb7d9f10190df7b24716615370f11509855b21::limiter {
    ...
    public(friend) fun add_outflow(arg0: &mut Limiter, arg1: u64, arg2: u64) {
        assert!(count_current_outflow(arg0, arg1) + arg2 <= arg0.outflow_limit, 0xd1a6cf9d5a66fe91cdbcacba79fb7d9f10190df7b24716615370f11509855b21::error::outflow_reach_limit_error());
    ...
    fun count_current_outflow(arg0: &Limiter, arg1: u64) : u64 {
        let v0 = 0;
    ...
    public(friend) fun create_new_limiter_change(arg0: u64, arg1: u32, arg2: u32) : NewLimiter {
        validate_limiter_params(arg1, arg2);
        NewLimiter{
            outflow_limit            : arg0,
    ...
    public(friend) fun current_usage(arg0: &Limiter, arg1: u64) : RateLimitUsage {
        RateLimitUsage{
    ...
    fun validate_limiter_params(arg0: u32, arg1: u32) {
        assert!(arg1 != 0, 0xd1a6cf9d5a66fe91cdbcacba79fb7d9f10190df7b24716615370f11509855b21::error::invalid_params_error());
        assert!(arg0 >= arg1, 0xd1a6cf9d5a66fe91cdbcacba79fb7d9f10190df7b24716615370f11509855b21::error::invalid_params_error());
        assert!(arg0 % arg1 == 0, 0xd1a6cf9d5a66fe91cdbcacba79fb7d9f10190df7b24716615370f11509855b21::error::invalid_params_error());
        assert!(arg0 / arg1 <= 48, 0xd1a6cf9d5a66fe91cdbcacba79fb7d9f10190df7b24716615370f11509855b21::error::invalid_params_error());
    }
