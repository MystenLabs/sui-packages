module 0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::oracle {
    ...
    struct MmtOracle has key {
        id: 0x2::object::UID,
        version: 0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::Version,
    ...
    public fun get_price(arg0: &MmtOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : u64 {
        0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::assert_current_version(&arg0.version);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MmtOracle{
            ...
            version             : 0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::initialize(),
    ...
    public fun remove_primary_source<T0>(arg0: &AdminCap, arg1: &mut MmtOracle) {
        0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::assert_current_version(&arg1.version);
    ...
    public fun set_primary_price<T0, T1: drop>(arg0: T1, arg1: &mut PriceReceipt<T0>, arg2: &MmtOracle, arg3: u64, arg4: u64, arg5: &0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::registry::SetPriceCap, arg6: &0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::registry::SetPriceCapRegistry) {
        0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::assert_current_version(&arg2.version);
        assert!(!0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::registry::is_revoked(arg6, arg5), 0);
    ...
    public fun set_secondary_price<T0, T1: drop>(arg0: T1, arg1: &mut PriceReceipt<T0>, arg2: &MmtOracle, arg3: u64, arg4: u64, arg5: &0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::registry::SetPriceCap, arg6: &0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::registry::SetPriceCapRegistry) {
        0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::assert_current_version(&arg2.version);
        assert!(!0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::registry::is_revoked(arg6, arg5), 0);
    ...
    public fun update_staleness_threshold(arg0: &AdminCap, arg1: &mut MmtOracle, arg2: u64) {
        arg1.staleness_threshold = arg2;
    }

    public fun upgrade_major(arg0: &AdminCap, arg1: &mut MmtOracle) {
        0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::upgrade_major(&mut arg1.version);
    }

    public fun upgrade_minor(arg0: &AdminCap, arg1: &mut MmtOracle) {
        0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::upgrade_minor(&mut arg1.version);
    }

    public fun version(arg0: &MmtOracle) : &0xd129487010865d68654b443b84b42f3a55bff9cbe86b4fc9e78b274fedc82345::version::Version {
        &arg0.version
    }
