module 0xd1cb6f8c61a8bb724394694bc67218fbb5dff058f4fb8eb46b14d53a7febe7ec::reward1022 {
    struct REWARD1022 has drop {
        dummy_field: bool,
    }

    struct TICKET_1022 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1022(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1022>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1022>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1022, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1022>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1022>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1022>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1022>>(v5, 0x2::tx_context::sender(arg1));
    }
