module 0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::template {
    ...
    public fun create(arg0: &0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::Agent, arg1: &0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::skill::Skill, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::option::Option<0x1::string::String>, arg5: 0x1::option::Option<0x1::string::String>, arg6: u8, arg7: u64, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::owner(arg0) == 0x2::tx_context::sender(arg9), 0);
        let v0 = 0x2::tx_context::epoch_timestamp_ms(arg9);
        let v1 = 0x2::object::id<0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::Agent>(arg0);
        let v2 = 0x2::object::id<0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::skill::Skill>(arg1);
        let v3 = Template{
    ...
    public fun deprecate(arg0: &mut Template, arg1: &0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        assert!(0x2::object::id<0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::Agent>(arg1) == arg0.creator_agent, 1);
    ...
    public fun set_public(arg0: &mut Template, arg1: &0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::Agent, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update(arg0: &mut Template, arg1: &0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::Agent, arg2: 0x1::option::Option<0x1::string::String>, arg3: 0x1::option::Option<0x1::string::String>, arg4: u8, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::owner(arg1) == 0x2::tx_context::sender(arg6), 0);
        assert!(0x2::object::id<0xd17ca794f5f95f4915a6afe8e45bb60596ea411014751a1ab97565bd5bd578cb::agent::Agent>(arg1) == arg0.creator_agent, 1);
        assert!(!arg0.deprecated, 18);
