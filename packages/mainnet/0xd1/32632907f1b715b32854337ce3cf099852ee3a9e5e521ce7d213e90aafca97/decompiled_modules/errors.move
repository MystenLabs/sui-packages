module 0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::errors {
    ...
    public fun EGuardSavingsGdoriMintZero() : u64 {
        41
    }

    public fun EGuardSavingsInvalidAllocation() : u64 {
        33
    }

    public fun EGuardSavingsNoStakedBalance() : u64 {
        42
    }

    public fun EGuardSavingsNonceMismatch() : u64 {
        40
    }

    public fun EGuardSavingsPendingCollateral() : u64 {
        39
    }

    public fun EGuardSavingsPoolAlreadyClaimed() : u64 {
        35
    }

    public fun EGuardSavingsPoolNotInTicket() : u64 {
        37
    }

    public fun EGuardSavingsPoolNotRegistered() : u64 {
        34
    }

    public fun EGuardSavingsPoolsRemaining() : u64 {
        36
    }

    public fun EGuardSavingsStakerNotFound() : u64 {
        38
    }

    public fun EGuardSavingsZeroAmount() : u64 {
        32
    }
