module 0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::psm_v2 {
    ...
    struct PSMV2SwapToDoriEnrichedEvent has copy, drop {
        psm_id: 0x2::object::ID,
        sender: address,
        collateral_amount: u64,
        dori_amount: u64,
    ...
    struct PSMV2SwapToCollateralEnrichedEvent has copy, drop {
        psm_id: 0x2::object::ID,
        sender: address,
        dori_amount: u64,
        collateral_amount: u64,
    ...
    struct PSMV2CreatedEnrichedEvent has copy, drop {
        psm_id: 0x2::object::ID,
        collateral_decimals: u64,
        fee_in_bps: u64,
        fee_out_bps: u64,
    ...
    public entry fun migrate_v32<T0>(arg0: &0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::governance_admin::AdminCap, arg1: &mut PSMV2<T0>) {
    ...
    public fun swap_to_collateral<T0>(arg0: &mut PSMV2<T0>, arg1: 0x2::coin::Coin<0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::dori::DORI>, arg2: &mut 0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::global::Global, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        arg0.total_volume_out = saturating_add(arg0.total_volume_out, (v1 as u64));
        arg0.total_fees_collected = saturating_add(arg0.total_fees_collected, (v2 as u64));
        ...
        let v5 = PSMV2SwapToCollateralEnrichedEvent{
            psm_id               : 0x2::object::id<PSMV2<T0>>(arg0),
            sender               : 0x2::tx_context::sender(arg3),
            dori_amount          : v0,
            collateral_amount    : (v3 as u64),
            fee_amount           : (v2 as u64),
            collateral_balance   : 0x2::balance::value<T0>(&arg0.collateral_balance),
            fee_balance          : 0x2::balance::value<T0>(&arg0.fee_balance),
            total_volume_in      : arg0.total_volume_in,
            total_volume_out     : arg0.total_volume_out,
            total_fees_collected : arg0.total_fees_collected,
        };
        0x2::event::emit<PSMV2SwapToCollateralEnrichedEvent>(v5);
    ...
    public fun swap_to_dori<T0>(arg0: &mut PSMV2<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::global::Global, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::dori::DORI> {
        ...
        arg0.total_volume_in = saturating_add(arg0.total_volume_in, v0);
        arg0.total_fees_collected = saturating_add(arg0.total_fees_collected, (v1 as u64));
        ...
        let v6 = PSMV2SwapToDoriEnrichedEvent{
            psm_id               : 0x2::object::id<PSMV2<T0>>(arg0),
            sender               : 0x2::tx_context::sender(arg3),
            collateral_amount    : v0,
            dori_amount          : (v3 as u64),
        ...
        0x2::event::emit<PSMV2SwapToDoriEnrichedEvent>(v6);
