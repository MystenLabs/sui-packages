module 0xd184e6a28f7cf06694360d117e8cb84bc88829154f7d1c0f115441b93b0fdc9b::reward9258 {
    struct REWARD9258 has drop {
        dummy_field: bool,
    }

    struct TICKET_9258 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9258(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9258>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9258>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9258, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9258>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9258>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9258>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9258>>(v5, 0x2::tx_context::sender(arg1));
    }
