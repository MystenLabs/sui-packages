module 0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::oracle_adapter {
    struct PriceReadEvent has copy, drop, store {
        bps: u64,
    }

    public entry fun emit_sui_usd_bps(arg0: &0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::config_registry::Config, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        let v0 = PriceReadEvent{bps: read_sui_usd_bps(arg0, arg1, arg2, arg3)};
        0x2::event::emit<PriceReadEvent>(v0);
    }

    public fun read_sui_usd_bps(arg0: &0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::config_registry::Config, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : u64 {
        if (0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::config_registry::emergency_fixed_mode(arg0)) {
            return 0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::config_registry::fixed_sui_usd_price_bps(arg0)
        };
