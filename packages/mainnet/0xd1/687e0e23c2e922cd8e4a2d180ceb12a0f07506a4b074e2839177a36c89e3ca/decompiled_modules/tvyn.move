module 0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::tvyn {
    ...
    public entry fun create_and_share_mint_vault(arg0: 0x2::coin::TreasuryCap<TVYN>, arg1: &mut 0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::config_registry::Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MintVault{
            id  : 0x2::object::new(arg2),
            cap : arg0,
        };
        0xd1687e0e23c2e922cd8e4a2d180ceb12a0f07506a4b074e2839177a36c89e3ca::config_registry::set_mint_vault_id(arg1, 0x2::object::id<MintVault>(&v0));
