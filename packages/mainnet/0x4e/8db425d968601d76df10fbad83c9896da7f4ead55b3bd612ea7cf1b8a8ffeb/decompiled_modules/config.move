module 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config {
    ...
    public entry fun add_quote_coin<T0>(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        assert!(arg2 <= 5000, 5);
    ...
    public entry fun update_protocol_fee_rate<T0>(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        assert!(arg2 <= 5000, 5);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg1.allow_quotes, &v0), 6);
        *0x2::vec_map::get_mut<0x1::type_name::TypeName, u64>(&mut arg1.allow_quotes, &v0) = arg2;
