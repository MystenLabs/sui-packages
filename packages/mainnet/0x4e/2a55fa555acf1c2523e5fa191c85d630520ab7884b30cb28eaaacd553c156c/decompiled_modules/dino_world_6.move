module 0x4e2a55fa555acf1c2523e5fa191c85d630520ab7884b30cb28eaaacd553c156c::dino_world_6 {
    struct DINO_WORLD_6 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DINO_WORLD_6, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DINO_WORLD_6>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dino World 6"));
