module 0x4efe0db9e99841c1852bb40e1ce519c878e7d70eb2a234c08468b03e51ed958c::cnsnft7404 {
    struct CNSNFT7404 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7404, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7404>(arg0, arg1);
