module 0x4ed9672b7f5780598f6109d5917487c6092678898f2aedf4e9e441135fd792ab::m {
    ...
    fun opt<T0, T1>(arg0: &0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64, arg9: bool) : u64 {
        assert!(arg4 > 0, 13906835406999191556);
        assert!(arg4 <= arg5, 13906835411294289926);
        assert!(arg8 < arg4, 13906835415589388296);
        let v0 = 0;
        let v1 = 0;
        let v2 = arg4;
        let v3 = 0;
    ...
    fun tt<T0, T1>(arg0: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::Pool<T0, T1>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::versioned::Versioned, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: u64, arg12: bool, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let (v6, v7, v8) = 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::swap<T0, T1>(arg0, v4, true, v3, v5, arg3, arg4, arg13);
        let v9 = v8;
        let v10 = v7;
        let v11 = v6;
        let (v12, v13) = 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::swap_receipt_debts(&v9);
        let v14 = if (v4) {
            v12
        } else {
            v13
        ...
        assert!(v15 >= v16, 13906836197273042946);
        let (v17, v18) = if (v4) {
            (v14, 0)
        } else {
            (0, v14)
        ...
        let (v19, v20) = if (v4) {
            (0x2::coin::zero<T1>(arg13), 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::wd<T0>(arg1, arg2, v17, arg13))
        } else {
            (0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::wd<T1>(arg1, arg2, v18, arg13), 0x2::coin::zero<T0>(arg13))
        };
        let v21 = v19;
        let v22 = v20;
        let (v23, v24) = if (v4) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v22, v17, arg13)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v21, v18, arg13)))
        };
        0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool::pay<T0, T1>(arg0, v9, v23, v24, arg3, arg13);
        0x2::coin::join<T0>(&mut v22, 0x2::coin::from_balance<T0>(v11, arg13));
        0x2::coin::join<T1>(&mut v21, 0x2::coin::from_balance<T1>(v10, arg13));
        0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::dp<T0>(arg1, arg2, v22, arg13);
        0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::dp<T1>(arg1, arg2, v21, arg13);
        (v14, v15)
    }
    ...
    public fun ttb<T0, T1>(arg0: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool_manager::PoolRegistry, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::versioned::Versioned, arg4: &0x2::clock::Clock, arg5: u64, arg6: vector<u128>, arg7: vector<u64>, arg8: vector<u64>, arg9: u64, arg10: vector<u128>, arg11: vector<u64>, arg12: vector<u64>, arg13: u64, arg14: u8, arg15: u8, arg16: bool, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        while (v5 < 0x1::vector::length<u128>(&arg6)) {
            ...
            let (v8, v9) = tt<T0, T1>(v0, arg1, arg2, arg3, arg4, *0x1::vector::borrow<u128>(&arg6, v5), true, arg9, v7, arg14, arg15, *0x1::vector::borrow<u64>(&arg8, v5), arg16, arg17);
            if (v8 == 0 || v9 == 0) {
                break
            };
            v2 = v2 - v8;
        ...
        while (v5 < 0x1::vector::length<u128>(&arg10)) {
            let v10 = *0x1::vector::borrow<u64>(&arg11, v5);
            let v11 = if (v10 > v4) {
                v4
            } else {
                v10
            ...
            let (v12, v13) = tt<T0, T1>(v0, arg1, arg2, arg3, arg4, *0x1::vector::borrow<u128>(&arg10, v5), false, arg13, v11, arg14, arg15, *0x1::vector::borrow<u64>(&arg12, v5), arg16, arg17);
            if (v12 == 0 || v13 == 0) {
                break
            };
            v4 = v4 - v12;
