module 0x4eb0246aeb115b197dfa1722d446662fe72b28fb6c78e830312520660944df89::sony9997_swap {
    ...
    public entry fun swap_b_a<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: &mut Bank<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 11);
        assert!(0x2::balance::value<T0>(&arg1.coin_a) > v0, 11);
        0x2::balance::join<T1>(&mut arg1.coin_b, 0x2::coin::into_balance<T1>(arg0));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.coin_a, v0, arg2), 0x2::tx_context::sender(arg2));
    }
