module 0x4ebe0a09300cb1c78ab4b383e4c2fdb9e6a10e9ffe9ddfdc13e6eb52b410767a::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0x4ebe0a09300cb1c78ab4b383e4c2fdb9e6a10e9ffe9ddfdc13e6eb52b410767a::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x4ebe0a09300cb1c78ab4b383e4c2fdb9e6a10e9ffe9ddfdc13e6eb52b410767a::config::AdminCap, arg1: &0x4ebe0a09300cb1c78ab4b383e4c2fdb9e6a10e9ffe9ddfdc13e6eb52b410767a::config::GlobalConfig, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
    ...
    public(friend) fun update_emission<T0>(arg0: &mut RewarderGlobalVault, arg1: &mut RewarderManager, arg2: u128, arg3: u128, arg4: u64) {
        ...
        if (arg3 > 0) {
            let v0 = 0x1::type_name::get<T0>();
            assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 5);
            assert!((0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg0.balances, v0)) as u128) >= 86400 * (arg3 >> 64), 4);
        };
