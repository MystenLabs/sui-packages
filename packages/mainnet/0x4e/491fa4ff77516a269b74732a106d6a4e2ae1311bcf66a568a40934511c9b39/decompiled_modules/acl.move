module 0x4e491fa4ff77516a269b74732a106d6a4e2ae1311bcf66a568a40934511c9b39::acl {
    struct Nqzgsvclobnmfdd has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Obtrljkapswslnj>,
    }

    struct Obtrljkapswslnj has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun abbnkvgmurlvlvm<T0>(arg0: &mut Nqzgsvclobnmfdd, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Obtrljkapswslnj>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Obtrljkapswslnj>(&mut arg0.pools, arg1);
    ...
    public entry fun ashidjzkjljxgha(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Nqzgsvclobnmfdd, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Obtrljkapswslnj>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Obtrljkapswslnj>(&mut arg2.pools, arg3);
        if (v0.initialized) {
            assert!(0x1::option::is_some<Pool>(&v0.details), 1);
    ...
    public entry fun gqyxliekvqitzxn(arg0: &mut Nqzgsvclobnmfdd, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Obtrljkapswslnj>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Obtrljkapswslnj>(&mut arg0.pools, arg1);
    ...
    public entry fun gwjcmrngbvdrasx(arg0: &mut Nqzgsvclobnmfdd, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Obtrljkapswslnj>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Obtrljkapswslnj>(&mut arg0.pools, arg1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Nqzgsvclobnmfdd{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Obtrljkapswslnj>(arg0),
        };
        0x2::transfer::share_object<Nqzgsvclobnmfdd>(v0);
    }

    public entry fun thgnxjffjfomfzr(arg0: &mut Nqzgsvclobnmfdd, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, Obtrljkapswslnj>(&mut arg0.pools, arg1, v4);
    }
    ...
    public entry fun virxlfxjxtliukj(arg0: &mut Nqzgsvclobnmfdd, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Obtrljkapswslnj{
        ...
        0x2::table::add<0x1::ascii::String, Obtrljkapswslnj>(&mut arg0.pools, arg1, v0);
    }

    public entry fun ybstkigsgetqkwo<T0: store + key>(arg0: &mut Nqzgsvclobnmfdd, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Obtrljkapswslnj>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Obtrljkapswslnj>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
