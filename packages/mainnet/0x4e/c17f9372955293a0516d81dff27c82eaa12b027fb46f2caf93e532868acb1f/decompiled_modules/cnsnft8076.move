module 0x4ec17f9372955293a0516d81dff27c82eaa12b027fb46f2caf93e532868acb1f::cnsnft8076 {
    struct CNSNFT8076 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8076, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8076>(arg0, arg1);
