module 0x4edd937076befd22bbccf74cb4cfe6a5818f6ccfbbfe93275070f98ee4b12d24::cnsnft9387 {
    struct CNSNFT9387 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9387, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3784"));
        let v4 = 0x2::package::claim<CNSNFT9387>(arg0, arg1);
