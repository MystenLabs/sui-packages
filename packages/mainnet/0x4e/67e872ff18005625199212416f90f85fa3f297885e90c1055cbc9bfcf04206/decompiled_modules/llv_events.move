module 0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_events {
    ...
    struct Deposited has copy, drop {
        ...
        amount: u64,
        shares_minted: u128,
        allocation: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>,
        timestamp_ms: u64,
    }
    ...
    struct Withdrawn has copy, drop {
        ...
        shares_burned: u128,
        amount_received: u64,
        recall: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>,
        timestamp_ms: u64,
    }

    struct BalancesSynced has copy, drop {
        pool_id: 0x2::object::ID,
        balances: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>,
        total_assets: u128,
        timestamp_ms: u64,
    }
    ...
    public(friend) fun emit_balances_synced(arg0: 0x2::object::ID, arg1: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>, arg2: u128, arg3: u64) {
    ...
    public(friend) fun emit_deposited(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u128, arg4: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>, arg5: u64) {
        let v0 = Deposited{
            pool_id       : arg0,
            user          : arg1,
            amount        : arg2,
    ...
    public(friend) fun emit_vault_deposit(arg0: 0x2::object::ID, arg1: address, arg2: u128, arg3: u128, arg4: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>, arg5: u64) {
    ...
    public(friend) fun emit_vault_withdraw(arg0: 0x2::object::ID, arg1: address, arg2: u128, arg3: u128, arg4: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>, arg5: u64) {
    ...
    public(friend) fun emit_withdrawn(arg0: 0x2::object::ID, arg1: address, arg2: u128, arg3: u64, arg4: vector<0x4e67e872ff18005625199212416f90f85fa3f297885e90c1055cbc9bfcf04206::llv_allocation_plan::ProtocolAmount>, arg5: u64) {
        let v0 = Withdrawn{
            pool_id         : arg0,
            user            : arg1,
            shares_burned   : arg2,
