module 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::aggregator {
    struct Paused has copy, drop {
        timestamp: u64,
    }

    struct Resumed has copy, drop {
        timestamp: u64,
    }
    ...
    public entry fun execute_bluefin_swap<T0, T1>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: u64, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock, arg6: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg8: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg1) {
            ...
            let v3 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::bluefin_wrapper::swap_a2b<T0, T1>(arg5, arg6, arg7, v2, arg8);
            after_execute<T1>(arg0, v0, v3, arg3, arg4, arg8);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg4, arg8);
            let v5 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::bluefin_wrapper::swap_b2a<T0, T1>(arg5, arg6, arg7, v4, arg8);
    ...
    public entry fun execute_cetus_swap<T0, T1>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: u64, arg4: 0x2::object::ID, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg1) {
            ...
            let v3 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::cetus_wrapper::swap_a2b<T0, T1>(arg5, arg6, arg7, v2, arg8, arg9);
            after_execute<T1>(arg0, v0, v3, arg3, arg4, arg9);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg4, arg9);
            let v5 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::cetus_wrapper::swap_b2a<T0, T1>(arg5, arg6, arg7, v4, arg8, arg9);
            after_execute<T0>(arg0, v0, v5, arg3, arg4, arg9);
            0x2::coin::value<T0>(&v5)
        }
    }

    public entry fun execute_flowx_v3_swap<T0, T1>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: u64, arg4: 0x2::object::ID, arg5: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::pool_manager::PoolRegistry, arg6: u64, arg7: &mut 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::versioned::Versioned, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 3;
        if (arg1) {
            let v2 = before_execute<T0>(arg0, v0, arg2, arg4, arg9);
            let v3 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::flowx_v3_wrapper::swap_a2b<T0, T1>(arg5, arg6, v2, arg7, arg8, arg9);
            after_execute<T1>(arg0, v0, v3, arg3, arg4, arg9);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg4, arg9);
            let v5 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::flowx_v3_wrapper::swap_b2a<T0, T1>(arg5, arg6, v4, arg7, arg8, arg9);
            after_execute<T0>(arg0, v0, v5, arg3, arg4, arg9);
            0x2::coin::value<T0>(&v5)
        }
    }
    ...
    public entry fun execute_turbos_swap<T0, T1, T2>(arg0: &mut Aggregator, arg1: bool, arg2: u64, arg3: u64, arg4: 0x2::object::ID, arg5: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg6: &0x2::clock::Clock, arg7: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg8: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg1) {
            let v2 = before_execute<T0>(arg0, v0, arg2, arg4, arg8);
            let v3 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::turbos_wrapper::swap_a2b<T0, T1, T2>(arg5, v2, arg6, arg7, arg8);
            after_execute<T1>(arg0, v0, v3, arg3, arg4, arg8);
            0x2::coin::value<T1>(&v3)
        } else {
            let v4 = before_execute<T1>(arg0, v0, arg2, arg4, arg8);
            let v5 = 0x4e3964b7cae38893c950a2f8bef23999bc1670c0112efb9b2cf2168833e5759b::turbos_wrapper::swap_b2a<T0, T1, T2>(arg5, v4, arg6, arg7, arg8);
            after_execute<T0>(arg0, v0, v5, arg3, arg4, arg8);
            0x2::coin::value<T0>(&v5)
        }
    }
    ...
    public entry fun pause(arg0: &mut Aggregator, arg1: &SuperAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        verify_paused(arg0);
        arg0.paused = true;
        let v0 = Paused{timestamp: 0x2::tx_context::epoch_timestamp_ms(arg2)};
        0x2::event::emit<Paused>(v0);
    }

    public entry fun resume(arg0: &mut Aggregator, arg1: &SuperAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        if (!arg0.paused) {
            return
        };
        arg0.paused = false;
        let v0 = Resumed{timestamp: 0x2::tx_context::epoch_timestamp_ms(arg2)};
        0x2::event::emit<Resumed>(v0);
    }
    ...
    public fun verify_paused(arg0: &Aggregator) {
    ...
    public entry fun withdraw<T0>(arg0: &mut Aggregator, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.recipient == 0x2::tx_context::sender(arg2), 1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, v0.recipient);
    }
