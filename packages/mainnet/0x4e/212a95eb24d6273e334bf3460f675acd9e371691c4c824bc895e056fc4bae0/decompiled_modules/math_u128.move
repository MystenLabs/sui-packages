module 0x4e212a95eb24d6273e334bf3460f675acd9e371691c4c824bc895e056fc4bae0::math_u128 {
    ...
    public fun greater_or_equal_overflowing(arg0: u128, arg1: u128) : bool {
        let v0 = arg0 > 340282366920938463463374607431768211455 / 2;
        let v1 = arg1 > 340282366920938463463374607431768211455 / 2;
        v0 && v1 && arg0 >= arg1 || !v0 && !v1 && arg0 >= arg1 || !v0
    }
    ...
    public fun is_neg(arg0: u128) : bool {
        arg0 > 340282366920938463463374607431768211455 / 2
    }
