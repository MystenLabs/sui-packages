module 0x4ec224fa16eaabf5e54bbd93179c63474ebb78c0e79c02770c1befd603286694::cnsnft6594 {
    struct CNSNFT6594 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6594, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7845"));
        let v4 = 0x2::package::claim<CNSNFT6594>(arg0, arg1);
