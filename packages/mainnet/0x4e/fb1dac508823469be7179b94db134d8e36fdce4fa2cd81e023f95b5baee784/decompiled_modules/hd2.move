module 0x4efb1dac508823469be7179b94db134d8e36fdce4fa2cd81e023f95b5baee784::hd2 {
    ...
    public fun bt<T0, T1>(arg0: &mut 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::oracle_driven_pool::Pool<T0, T1>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg3: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg4: &0x2::clock::Clock, arg5: vector<u128>, arg6: vector<u64>, arg7: vector<u64>, arg8: u64, arg9: vector<u128>, arg10: vector<u64>, arg11: vector<u64>, arg12: u64, arg13: u8, arg14: u8, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T1>(arg3);
        let v1 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::balance_of<T0>(arg2);
        let v2 = 0;
        let v3 = 0;
        let v4 = 0;
        let v5 = 0;
    ...
    fun op<T0, T1>(arg0: &0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::oracle_driven_pool::Pool<T0, T1>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: bool, arg4: u128, arg5: u128, arg6: u64, arg7: u64, arg8: u8, arg9: u8, arg10: u64) : u64 {
        ...
        while (v3 < arg8) {
            ...
            let (v4, v5, v6) = sm<T0, T1>(arg0, arg1, arg2, v2, arg3, arg4);
            if (v6) {
                break
            };
            if (!pk(v5, arg5, arg3)) {
        ...
        while (v3 < arg9) {
            ...
            let v7 = (v1 + v2) / 2;
            let (v8, v9, v10) = sm<T0, T1>(arg0, arg1, arg2, v7, arg3, arg4);
    ...
    fun sm<T0, T1>(arg0: &0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::oracle_driven_pool::Pool<T0, T1>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: u64, arg4: bool, arg5: u128) : (u64, u128, bool) {
        if (arg3 == 0) {
            return (0, 0, true)
        };
        let v0 = if (arg4) {
            0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::trader::query_sell_quote_coin<T0, T1>(arg0, arg2, arg1, arg3)
        } else {
            0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::trader::query_sell_base_coin<T0, T1>(arg0, arg2, arg1, arg3)
        };
        if (v0 == 0) {
            return (0, 0, true)
        };
    ...
    fun sw<T0, T1>(arg0: &mut 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::oracle_driven_pool::Pool<T0, T1>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg3: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        if (arg5 == 0) {
            return (0, 0, 0)
        };
        let (_, v1, v2) = sm<T0, T1>(arg0, arg1, arg4, arg7, arg6, 0);
        if (v2) {
            return (0, 0, 0)
        };
        if (!pk(v1, arg5, arg6)) {
        ...
        let v3 = op<T0, T1>(arg0, arg1, arg4, arg6, 0, arg5, arg7, arg8, arg9, arg10, arg11);
        if (v3 < arg7) {
            return (0, 0, 0)
        };
        if (arg6) {
            let v7 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T1>(arg3, v3, arg12);
            let v8 = 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::trader::sell_quote_coin<T0, T1>(arg0, arg4, arg1, &mut v7, v3, imo(v3, arg5, arg6), arg12);
            ...
            let v13 = 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T0>(arg2, v3, arg12);
            let v14 = 0x9525dec11fb79eaef17138ee0352dedf4ee817bc44893a9465e7bb217b45761::trader::sell_base_coin<T0, T1>(arg0, arg4, arg1, &mut v13, v3, imo(v3, arg5, arg6), arg12);
