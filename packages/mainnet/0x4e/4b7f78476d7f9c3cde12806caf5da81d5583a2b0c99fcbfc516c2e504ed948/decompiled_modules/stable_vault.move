module 0x839ebd53d7fd8cf4209b83a3937c3875968e2705156717c76760b3b64eef7e3a::stable_vault {
    ...
    public fun request_burn_v2<T0, T1, T2, T3>(arg0: &mut StableVault<T0, T1, T2>, arg1: &0x203eebc39442014a1b8180f3b8ed70143dac2c5d28ba5703fe34c21052728705::yield_usdb::YieldVault<T2, T3>, arg2: &0x872d08a70db3db498aa7853276acea8091fdd9871b2d86bc8dcb8524526df622::saving::SavingPool<T3>, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<T0>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version<T0, T1, T2>(arg0);
        if (0x2::coin::value<T0>(&arg4) < 1000) {
            err_burn_not_enough();
        };
        ...
        let v5 = RequestToBurn{
            ...
            lp_type            : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
            lp_amount          : v2,
            u_amount           : 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::ceil(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::mul_u64(0x203eebc39442014a1b8180f3b8ed70143dac2c5d28ba5703fe34c21052728705::yield_usdb::burn_ratio<T2, T3>(arg1, arg2, arg3), v2)),
            expected_burn_time : v3,
        };
