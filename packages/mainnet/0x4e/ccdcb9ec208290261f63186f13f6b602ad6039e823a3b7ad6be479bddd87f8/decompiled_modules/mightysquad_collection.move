module 0xaa0a256987a2ab5cdc3d09499d88ce7b0f15650ba57993b65cc5f8554120f1a1::mightysquad_collection {
    ...
    fun mint(arg0: &mut InfoCollection, arg1: &mut 0x2::tx_context::TxContext) : MightySquad {
        ...
        MightySquad{
            ...
            name    : v0,
            img_url : img_url(*0x1::string::bytes(&arg0.ourl), arg0.sum_nft, 0xaa0a256987a2ab5cdc3d09499d88ce7b0f15650ba57993b65cc5f8554120f1a1::utils::get_type_image()),
            link    : img_url(*0x1::string::bytes(&arg0.metadata), arg0.sum_nft, 0xaa0a256987a2ab5cdc3d09499d88ce7b0f15650ba57993b65cc5f8554120f1a1::utils::get_type_metadata()),
        }
    }
