module 0x5d5119a05902bf979a8909c24b1ba98b9d7039a67171d291bc234d7ae6d0e48d::balance_manager {
    ...
    struct IncomeRetained has copy, drop {
        typename: 0x1::type_name::TypeName,
        amount: u64,
    }

    struct FeeBpsSet has copy, drop {
        vault_id: 0x2::object::ID,
        fee_bps: u64,
    }
    ...
    struct EmergencyPositionTaken has copy, drop {
        vault_id: 0x2::object::ID,
        pool_id: 0x2::object::ID,
    ...
    public fun admin_cap_id(arg0: &CapitalVault) : 0x2::object::ID {
        arg0.admin_cap_id
    }
    ...
    public fun all_approved_pools(arg0: &CapitalVault) : vector<0x2::object::ID> {
        *0x2::vec_set::keys<0x2::object::ID>(&arg0.approved_pools)
    }
    ...
    public(friend) fun assert_admin_pkg(arg0: &CapitalVault, arg1: &AdminCap) {
        assert_admin(arg0, arg1);
    }
    ...
    public(friend) fun borrow_extra(arg0: &CapitalVault) : &0x2::bag::Bag {
        &arg0.extra
    }

    public(friend) fun borrow_extra_mut(arg0: &mut CapitalVault) : &mut 0x2::bag::Bag {
        &mut arg0.extra
    }

    public(friend) fun borrow_position_mut<T0: store + key>(arg0: &mut CapitalVault, arg1: &KeeperCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID) : &mut T0 {
        assert_keeper(arg0, arg1);
        assert_version(arg0);
        assert!(0x2::object_bag::contains<0x2::object::ID>(&arg0.positions, arg3), 3);
        ...
        0x2::object_bag::borrow_mut<0x2::object::ID, T0>(&mut arg0.positions, arg3)
    }

    public fun contains_position(arg0: &CapitalVault, arg1: 0x2::object::ID) : bool {
        0x2::object_bag::contains<0x2::object::ID>(&arg0.positions, arg1)
    }
    ...
    public fun create(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = CapitalVault{
            ...
            positions        : 0x2::object_bag::new(arg1),
    ...
    public fun emergency_take_position<T0: store + key>(arg0: &mut CapitalVault, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = remove_from_index<T0>(arg0, arg2, arg3);
        let v1 = arg0.profit_recipient;
        let v2 = EmergencyPositionTaken{
            vault_id    : 0x2::object::id<CapitalVault>(arg0),
            pool_id     : arg2,
            position_id : arg3,
            recipient   : v1,
        };
        0x2::event::emit<EmergencyPositionTaken>(v2);
        0x2::transfer::public_transfer<T0>(v0, v1);
    }

    public fun fee_bps(arg0: &CapitalVault) : u64 {
        arg0.fee_bps
    }
    ...
    public fun keeper_cap_id(arg0: &CapitalVault) : 0x2::object::ID {
        arg0.keeper_cap_id
    }
    ...
    public(friend) fun realize_income<T0>(arg0: &mut CapitalVault, arg1: 0x2::balance::Balance<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<T0>(&arg1);
        if (v0 == 0) {
            0x2::balance::destroy_zero<T0>(arg1);
            return
        ...
        if (v1 > 0) {
            pay_profit_balance<T0>(arg0, 0x2::balance::split<T0>(&mut arg1, v1), arg2);
        };
        let v2 = 0x2::balance::value<T0>(&arg1);
        if (v2 > 0) {
            let v3 = IncomeRetained{
                typename : 0x1::type_name::with_defining_ids<T0>(),
                amount   : v2,
            };
            0x2::event::emit<IncomeRetained>(v3);
            deposit_balance<T0>(arg0, arg1);
        } else {
            0x2::balance::destroy_zero<T0>(arg1);
        };
    }

    fun remove_from_index<T0: store + key>(arg0: &mut CapitalVault, arg1: 0x2::object::ID, arg2: 0x2::object::ID) : T0 {
        assert!(0x2::object_bag::contains<0x2::object::ID>(&arg0.positions, arg2), 3);
        assert!(0x2::table::contains<0x2::object::ID, 0x2::vec_set::VecSet<0x2::object::ID>>(&arg0.pool_positions, arg1), 5);
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.pool_positions, arg1);
        assert!(0x2::vec_set::contains<0x2::object::ID>(v0, &arg2), 5);
        0x2::vec_set::remove<0x2::object::ID>(v0, &arg2);
        if (0x2::vec_set::is_empty<0x2::object::ID>(v0)) {
            0x2::table::remove<0x2::object::ID, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.pool_positions, arg1);
            0x2::vec_set::remove<0x2::object::ID>(&mut arg0.active_pools, &arg1);
        };
        0x2::object_bag::remove<0x2::object::ID, T0>(&mut arg0.positions, arg2)
    }
    ...
    public fun set_fee_bps(arg0: &mut CapitalVault, arg1: &AdminCap, arg2: u64) {
        assert_admin(arg0, arg1);
    ...
    public(friend) fun store_position<T0: store + key>(arg0: &mut CapitalVault, arg1: &KeeperCap, arg2: 0x2::object::ID, arg3: T0) : 0x2::object::ID {
        assert_keeper(arg0, arg1);
        assert_operational(arg0);
        let v0 = 0x2::object::id<T0>(&arg3);
        assert!(!0x2::object_bag::contains<0x2::object::ID>(&arg0.positions, v0), 4);
        0x2::object_bag::add<0x2::object::ID, T0>(&mut arg0.positions, v0, arg3);
        if (0x2::table::contains<0x2::object::ID, 0x2::vec_set::VecSet<0x2::object::ID>>(&arg0.pool_positions, arg2)) {
            let v1 = 0x2::table::borrow_mut<0x2::object::ID, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.pool_positions, arg2);
            assert!(0x2::vec_set::length<0x2::object::ID>(v1) < 64, 10);
            0x2::vec_set::insert<0x2::object::ID>(v1, v0);
        } else {
            assert!(0x2::vec_set::length<0x2::object::ID>(&arg0.active_pools) < 32, 11);
    ...
    public(friend) fun take_position<T0: store + key>(arg0: &mut CapitalVault, arg1: &KeeperCap, arg2: 0x2::object::ID, arg3: 0x2::object::ID) : T0 {
        assert_keeper(arg0, arg1);
        assert_version(arg0);
        remove_from_index<T0>(arg0, arg2, arg3)
    }
