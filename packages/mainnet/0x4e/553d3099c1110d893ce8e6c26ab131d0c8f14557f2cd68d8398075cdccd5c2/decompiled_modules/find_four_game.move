module 0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::find_four_game {
    ...
    public(friend) fun ai_move(arg0: &mut GameBoard, arg1: u64) {
        ...
        assert!(arg0.current_player == 2, 9223372745524379647);
        drop_disc(arg0, arg1);
    }
    ...
    public(friend) fun incrementGameNonce(arg0: &mut GameBoard) {
        check_version_GameBoard(arg0);
    ...
    public entry fun migrate(arg0: &0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::FFIO::FindFourAdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = GamesTracker{
    ...
    public fun timerWentOff(arg0: &0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::FFIO::FindFourAdminCap, arg1: &mut GameBoard) {
    ...
    public entry fun update_version(arg0: &0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::FFIO::FindFourAdminCap, arg1: &mut GameBoard) {
        arg1.version = 1;
    }
