module 0x4ef629a3070fb1fa0655a59c0864576aa13c48f730df58da3b7c963a12134d24::suifren_subdao {
    struct SUIFREN_SUBDAO has drop {
        dummy_field: bool,
    }

    struct SubDao<phantom T0> has key {
        id: 0x2::object::UID,
    ...
    entry fun cancel_proposal<T0>(arg0: &mut SubDao<T0>, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_subdao<T0>(arg0: &mut 0x4ef629a3070fb1fa0655a59c0864576aa13c48f730df58da3b7c963a12134d24::suifren_dao::Dao<T0>, arg1: &0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = SubDao<T0>{
            ...
            proposals      : 0x2::object_table::new<0x2::object::ID, Proposal>(arg9),
        };
        0x4ef629a3070fb1fa0655a59c0864576aa13c48f730df58da3b7c963a12134d24::suifren_dao::update_subdaos<T0>(arg0, 0x2::object::id<SubDao<T0>>(&v0));
        0x2::transfer::share_object<SubDao<T0>>(v0);
    }

    entry fun deposit_to_treasury<T0>(arg0: &mut SubDao<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.treasury, arg1);
    }

    entry fun execute_proposal<T0>(arg0: &mut SubDao<T0>, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Proposal>(&mut arg0.proposals, arg1);
        assert!(v0.status == 0, 7);
    ...
    entry fun vote<T0>(arg0: &mut SubDao<T0>, arg1: &0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::SuiFren<T0>, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.birth_location == 0xee496a0cc04d06a345982ba6697c90c619020de9e274408c7819f787ff66e1a1::suifrens::birth_location<T0>(arg1), 8);
