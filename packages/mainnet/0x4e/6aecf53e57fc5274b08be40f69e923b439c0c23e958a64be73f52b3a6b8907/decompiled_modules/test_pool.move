module 0x4e6aecf53e57fc5274b08be40f69e923b439c0c23e958a64be73f52b3a6b8907::test_pool {
    ...
    public fun withdraw_all<T0, T1>(arg0: &mut TestPool<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x1::vector::contains<address>(&arg0.whitelist, &v0), 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.t1), arg1), 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.t2), arg1), 0x2::tx_context::sender(arg1));
    }
