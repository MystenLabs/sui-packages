module 0x4e305166cd685a1d5b7debb0b9e14530e5993978f0f254f90c044dd0f7ff8c30::reward3230 {
    struct REWARD3230 has drop {
        dummy_field: bool,
    }

    struct TICKET_3230 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3230(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3230>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3230>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3230, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3230>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3230>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3230>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3230>>(v5, 0x2::tx_context::sender(arg1));
    }
