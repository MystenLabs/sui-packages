module 0x4ebff147600fa7625fd1266bf32b56ddf0835ccd6ba3117db77bae2a682868e9::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"yuhuangdadi666"),
            description : 0x1::string::utf8(b"yuhuangdadi666 NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/77825640?v=4"),
        };
