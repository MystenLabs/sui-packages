module 0x4e64d6dec37f2bb0abf5b0bc86a9a8879812e35010f5023cc41be7334d7499c9::reward4004 {
    struct REWARD4004 has drop {
        dummy_field: bool,
    }

    struct TICKET_4004 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4004(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4004>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4004>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4004, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4004>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4004>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4004>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4004>>(v5, 0x2::tx_context::sender(arg1));
    }
