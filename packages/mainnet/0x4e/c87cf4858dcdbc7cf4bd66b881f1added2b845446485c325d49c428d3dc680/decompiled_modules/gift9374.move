module 0x4ec87cf4858dcdbc7cf4bd66b881f1added2b845446485c325d49c428d3dc680::gift9374 {
    struct GIFT9374 has drop {
        dummy_field: bool,
    }

    struct TICKET_9374 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9374(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9374>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9374>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9374, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9374>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9374>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9374>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9374>>(v5, 0x2::tx_context::sender(arg1));
    }
