module 0x4e4ff35de2a31dd8cbc532f1978545ac33e05454aad8e97a336e989a3ccb709f::ninja_store {
    ...
    public entry fun AcceptSwap<T0: store + key, T1: store + key>(arg0: &mut SwapListing, arg1: T1, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        get_type_name<T1>();
        let v0 = arg0.requested_nft_type.type_name;
        let v1 = get_type_name<T1>();
        assert!(0x1::string::bytes(&v1) == 0x1::string::bytes(&v0), 9);
