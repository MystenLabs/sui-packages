module 0x4e0185983496d011d1ff6f37ffdeae06e3d3759138d441b5998d5de311c31ea8::momentum_adapter {
    ...
    public fun swap<T0: drop, T1, T2>(arg0: &mut MomentumVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, Momentum, T1>, arg2: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, Momentum, T2>, arg3: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg4: bool, arg5: bool, arg6: u128, arg7: &0x2::clock::Clock, arg8: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg9: &mut 0x2::tx_context::TxContext) : (0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Momentum, T0, T1>, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Momentum, T0, T2>) {
        ...
        let (v3, v4, v5) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::flash_swap<T1, T2>(arg3, arg4, arg5, v2, arg6, arg7, arg8, arg9);
        let v6 = v5;
        let v7 = v4;
        let v8 = v3;
        ...
        0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::repay_flash_swap<T1, T2>(arg3, v6, v12, v13, arg8, arg9);
        0x2::balance::join<T1>(&mut v0, v8);
        0x2::balance::join<T2>(&mut v1, v7);
        0x4e0185983496d011d1ff6f37ffdeae06e3d3759138d441b5998d5de311c31ea8::momentum_adapter_event::swap_event<T1, T2>(*0x1::option::borrow<0x2::object::ID>(&arg0.main_vault_id), 0x2::balance::value<T1>(&v0), 0x2::balance::value<T2>(&v1), 0x2::balance::value<T1>(&v0), 0x2::balance::value<T2>(&v1));
        let v14 = new_single_asset<T0, T1>(arg0, v0, arg9);
        (v14, new_single_asset<T0, T2>(arg0, v1, arg9))
    }

    public fun new<T0: drop>(arg0: &mut MomentumAdapterRegistry, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Momentum>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x4e0185983496d011d1ff6f37ffdeae06e3d3759138d441b5998d5de311c31ea8::momentum_adapter_event::new_momentum_vault_event(*0x2::object::uid_as_inner(&v5.id), v3);
    ...
    public fun add_liquidity<T0: drop, T1, T2>(arg0: &mut MomentumVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, Momentum, T1>, arg2: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, Momentum, T2>, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg7: &0x2::clock::Clock, arg8: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg9: &mut 0x2::tx_context::TxContext) : (0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Momentum, T0, T1>, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Momentum, T0, T2>) {
        ...
        let (v3, v4) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::add_liquidity<T1, T2>(arg6, v2, 0x2::coin::from_balance<T1>(v0, arg9), 0x2::coin::from_balance<T2>(v1, arg9), arg3, arg4, arg7, arg8, arg9);
        let v5 = v4;
        let v6 = v3;
    ...
    public fun claim<T0: drop, T1, T2, T3>(arg0: &mut MomentumVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Momentum>, arg2: u64, arg3: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg4: &0x2::clock::Clock, arg5: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg6: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Momentum, T0, T3> {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        if (arg0.is_fetching) {
        ...
        let v1 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::collect::reward<T1, T2, T3>(arg3, 0x1::vector::borrow_mut<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&mut arg0.positions, arg2), arg4, arg5, arg6);
        ...
        0x4e0185983496d011d1ff6f37ffdeae06e3d3759138d441b5998d5de311c31ea8::momentum_adapter_event::claim_event<T1, T2, T3>(*0x1::option::borrow<0x2::object::ID>(&arg0.main_vault_id), 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>>(arg3), 0x2::coin::value<T3>(&v1));
        new_single_asset<T0, T3>(arg0, 0x2::coin::into_balance<T3>(v1), arg6)
    }
    ...
    public fun collect_total_value<T0: drop, T1, T2>(arg0: &mut MomentumVault, arg1: &MomentumAdapterRegistry, arg2: &mut ConsumePositionRecord, arg3: u64, arg4: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>) {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun create_consume_position_record(arg0: &mut MomentumVault) : ConsumePositionRecord {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
    ...
    public fun fetch_total_value<T0: drop>(arg0: &mut MomentumVault, arg1: &MomentumAdapterRegistry, arg2: ConsumePositionRecord, arg3: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Momentum, T0> {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun new_momentum_state<T0: drop>(arg0: &mut MomentumVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Momentum>, arg2: &mut 0x2::tx_context::TxContext) : (MomentumState, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Momentum, T0>) {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
    ...
    public fun open_position<T0: drop, T1, T2>(arg0: &mut MomentumVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Momentum>, arg2: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg3: u32, arg4: u32, arg5: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        if (arg0.is_fetching) {
        ...
        message_pre_check<T0>(arg0, arg1);
        let v0 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::open_position<T1, T2>(arg2, 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::from_u32(arg3), 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::from_u32(arg4), arg5, arg6);
        ...
        0x4e0185983496d011d1ff6f37ffdeae06e3d3759138d441b5998d5de311c31ea8::momentum_adapter_event::new_momentum_position_event<T1, T2>(*0x2::object::uid_as_inner(&arg0.id), 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>>(arg2), arg3, arg4);
    ...
    public fun remove_liquidity<T0: drop, T1, T2>(arg0: &mut MomentumVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Momentum>, arg2: u64, arg3: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg4: u128, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg9: &mut 0x2::tx_context::TxContext) : (0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Momentum, T0, T1>, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Momentum, T0, T2>) {
        ...
        let (v1, v2) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::remove_liquidity<T1, T2>(arg3, v0, arg4, arg5, arg6, arg7, arg8, arg9);
        let v3 = v2;
        let v4 = v1;
        ...
        let v6 = new_single_asset<T0, T1>(arg0, 0x2::coin::into_balance<T1>(v4), arg9);
        (v6, new_single_asset<T0, T2>(arg0, 0x2::coin::into_balance<T2>(v3), arg9))
    }

    entry fun remove_whitelist<T0>(arg0: &mut MomentumAdapterRegistry, arg1: &MomentumAdapterAdminCap) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun unlock<T0: drop>(arg0: &mut MomentumVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Momentum>) {
        if (!arg0.is_redeeming) {
            err_not_redeeming();
        };
    ...
    fun update_reward_record_value(arg0: &mut MomentumVault, arg1: vector<0x1::ascii::String>, arg2: vector<u64>) {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        let v0 = 0;
    ...
    public fun verify_momentum_state<T0: drop>(arg0: &mut MomentumVault, arg1: MomentumState, arg2: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Momentum, T0> {
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        update_liquidity_record_value(arg0);
