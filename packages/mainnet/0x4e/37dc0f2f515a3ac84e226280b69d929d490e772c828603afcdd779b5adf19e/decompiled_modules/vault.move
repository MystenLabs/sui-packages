module 0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::vault {
    ...
    public fun withdraw_token_v2<T0, T1, T2>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u128, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<u64>, arg7: &0x2::clock::Clock, arg8: &AccessCap, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (v8) {
            ...
            let v13 = (0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_token_out_amount(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), v7, arg4, arg5, arg6, v3) as u64);
            v6 = v13;
