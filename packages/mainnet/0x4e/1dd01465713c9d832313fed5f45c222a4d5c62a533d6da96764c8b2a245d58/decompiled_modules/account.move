module 0x4e1dd01465713c9d832313fed5f45c222a4d5c62a533d6da96764c8b2a245d58::account {
    ...
    public fun deposit<T0>(arg0: &mut Account, arg1: 0x2::coin::Coin<T0>) {
        ...
        0x4e1dd01465713c9d832313fed5f45c222a4d5c62a533d6da96764c8b2a245d58::account_events::emit_deposited(account_id(arg0), 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), 0x2::coin::value<T0>(&arg1), stored_balance<T0>(arg0));
    }
    ...
    public fun settle<T0>(arg0: &mut AccountWrapper, arg1: &0x2::accumulator::AccumulatorRoot, arg2: &0x2::clock::Clock) {
        ...
        0x4e1dd01465713c9d832313fed5f45c222a4d5c62a533d6da96764c8b2a245d58::account_events::emit_funds_settled(account_id(&arg0.account), 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), v1, stored_balance<T0>(&arg0.account));
    }
    ...
    public fun withdraw<T0>(arg0: &mut Account, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x4e1dd01465713c9d832313fed5f45c222a4d5c62a533d6da96764c8b2a245d58::account_events::emit_withdrawn(account_id(arg0), 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), arg1, stored_balance<T0>(arg0));
