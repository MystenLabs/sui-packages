module 0x4ec4fb8749dd981ce607a889809595521b3ed6fe1a599c3adf7885967c6a714e::cnsnft5039 {
    struct CNSNFT5039 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5039, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5039>(arg0, arg1);
