module 0x4e06ddfb2570e2cd46da4d12b2df47db87562b08e38b71db7cd76a9eebfe58a9::BOOK {
    ...
    fun init(arg0: BOOK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BOOK>(arg0, 9, b"BOOK", b"TBook Token", b"BOOK: The TBook Token.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://walrus-main-aggregator.4everland.org/v1/blobs/2SqOzKBNbZ_DS5-IvlpJHwTHgDnVhNhxAJg2Jl3hhBA")), arg1);
