module 0x4ef7d22f731621fcde258cc376f716127caf61d8dfa4c3fb96074643300097e9::role {
    ...
    public fun change_manager(arg0: &mut Global, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.manager, 6);
        arg0.manager = arg1;
    }
    ...
    public fun check_roles_equality(arg0: &vector<Role>, arg1: &vector<Role>) : bool {
        ...
        let v0 = 0;
        while (v0 < 6) {
            assert!(0x1::vector::length<Role>(arg0) > v0, 5);
            assert!(0x1::vector::length<Role>(arg1) > v0, 5);
    ...
    public fun create_random_role_for_cards(arg0: &Global, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0xd676f5b01f25ceace77b17fbbc91cbb2a5b43eea7695b99b32d15866f6a706d8::utils::get_random_num(0, 1000, arg1, arg2);
    ...
    public fun get_random_role_by_power(arg0: &Global, arg1: u8, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0xd676f5b01f25ceace77b17fbbc91cbb2a5b43eea7695b99b32d15866f6a706d8::utils::get_random_num(0, 1000, arg1, arg4);
        if (v0 < arg3) {
    ...
    public fun upgrade(arg0: &Global, arg1: &Role, arg2: &mut Role) : bool {
        ...
        if (v1 < 9 && v3 < 9) {
            ...
            arg2.level = v13;
            let v14 = 0xd676f5b01f25ceace77b17fbbc91cbb2a5b43eea7695b99b32d15866f6a706d8::utils::removeSuffix(arg2.class);
            let v15 = get_role_by_class(arg0, 0xd676f5b01f25ceace77b17fbbc91cbb2a5b43eea7695b99b32d15866f6a706d8::utils::get_class_by_level(v14, v1));
            let v16 = get_role_by_class(arg0, 0xd676f5b01f25ceace77b17fbbc91cbb2a5b43eea7695b99b32d15866f6a706d8::utils::get_class_by_level(v14, v3));
            let v17 = v5 - v15.hp;
            let v18 = v7 - v16.hp;
            let v19 = if (v17 > v18) {
                v17
            ...
            let v23 = 0xd676f5b01f25ceace77b17fbbc91cbb2a5b43eea7695b99b32d15866f6a706d8::utils::get_class_by_level(v14, v13);
