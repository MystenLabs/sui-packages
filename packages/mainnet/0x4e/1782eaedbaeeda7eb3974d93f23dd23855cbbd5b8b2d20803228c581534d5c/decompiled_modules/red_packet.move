module 0x4e1782eaedbaeeda7eb3974d93f23dd23855cbbd5b8b2d20803228c581534d5c::red_packet {
    ...
    public entry fun send_new_red_packet<T0>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        ...
        let v6 = 0x1::option::none<vector<address>>();
        if (0x1::vector::length<address>(&arg2) > 0) {
            v6 = 0x1::option::some<vector<address>>(arg2);
        };
        let v7 = RedPacket<T0>{
            id                  : v1,
            sender              : v0,
