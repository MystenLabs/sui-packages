module 0x4e3965bb8b70dd7ff5c61e162741941914f4f09e086fc6f8f589357268721ec6::reward4760 {
    struct REWARD4760 has drop {
        dummy_field: bool,
    }

    struct TICKET_4760 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4760(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4760>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4760>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4760, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4760>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4760>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4760>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4760>>(v5, 0x2::tx_context::sender(arg1));
    }
