module 0x4efe2d4ea4457a898d050a311da458f11e049e2b8c4c40427b021e0406e38898::asset {
    struct Collateral has copy, drop, store {
        collateral_factor: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal,
        liquidation_incentive: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal,
        liquidation_revenue_factor: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal,
    }
    ...
    struct BorrowConfig has copy, drop, store {
        ...
        flash_loan_fee_rate: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal,
        repay_fee_rate: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal,
    }
    ...
    public(friend) fun new<T0>(arg0: 0x4efe2d4ea4457a898d050a311da458f11e049e2b8c4c40427b021e0406e38898::interest::InterestModel, arg1: BorrowConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
    ...
    public fun collateral_factor(arg0: &Collateral) : 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal {
    ...
    public fun collateral_setting<T0>(arg0: &Asset<T0>) : &Collateral {
        ...
        assert!(0x1::option::is_some<Collateral>(v1), 0x4efe2d4ea4457a898d050a311da458f11e049e2b8c4c40427b021e0406e38898::error::asset_not_collateral());
    ...
    public(friend) fun enable_as_collateral<T0>(arg0: &mut Asset<T0>, arg1: Collateral) {
        let v0 = DFKey<Collateral>{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<DFKey<Collateral>, 0x1::option::Option<Collateral>>(&mut arg0.id, v0);
        assert!(0x1::option::is_none<Collateral>(v1), 0x4efe2d4ea4457a898d050a311da458f11e049e2b8c4c40427b021e0406e38898::error::asset_already_collateral());
        *v1 = 0x1::option::some<Collateral>(arg1);
    }

    public fun flash_loan_fee_rate(arg0: &BorrowConfig) : 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal {
    ...
    public fun interest_model<T0>(arg0: &Asset<T0>) : &0x4efe2d4ea4457a898d050a311da458f11e049e2b8c4c40427b021e0406e38898::interest::InterestModel {
        &arg0.interest_model
    }

    public fun liq_revenue_factor(arg0: &Collateral) : 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal {
        arg0.liquidation_revenue_factor
    }

    public fun liquidation_incentive(arg0: &Collateral) : 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal {
    ...
    public(friend) fun new_borrow_config(arg0: u64, arg1: u64, arg2: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal, arg3: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal, arg4: u64) : BorrowConfig {
        BorrowConfig{
    ...
    public(friend) fun new_collateral(arg0: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal, arg1: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal, arg2: 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal) : Collateral {
        Collateral{
    ...
    public fun repay_fee_rate(arg0: &BorrowConfig) : 0x684131467d610004df3734295dc4604132f8d2af79479874a3bc69a06b676aca::float::Decimal {
        arg0.repay_fee_rate
    }
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0x4efe2d4ea4457a898d050a311da458f11e049e2b8c4c40427b021e0406e38898::interest::InterestModel) {
