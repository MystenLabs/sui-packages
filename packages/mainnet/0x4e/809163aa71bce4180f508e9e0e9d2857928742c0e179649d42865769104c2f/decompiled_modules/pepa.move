module 0x4e809163aa71bce4180f508e9e0e9d2857928742c0e179649d42865769104c2f::pepa {
    ...
    fun init(arg0: PEPA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/efXf2bjQ7RVSHgSRiz9EQsqGwP9WbNXqkCfVM7zpump.png?size=lg&key=7bba9b                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PEPA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PEPA    ")))), trim_right(b"Chill Pepa                      "), trim_right(b"Is the latest meme token, featuring a chubby, loveable frog mascot that hops its way into the crypto world.                                                                                                                                                                                                                     "), v2, arg1);
        let v5 = v3;
