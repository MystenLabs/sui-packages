module 0x4e2113296128b5d154345ffbcd1d29d7ebe825066ee5cdf98d742db0014cb951::cnsnft3641 {
    struct CNSNFT3641 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3641, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3641>(arg0, arg1);
