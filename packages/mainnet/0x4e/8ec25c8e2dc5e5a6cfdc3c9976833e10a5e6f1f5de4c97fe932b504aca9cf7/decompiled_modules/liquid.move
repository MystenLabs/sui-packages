module 0x4e8ec25c8e2dc5e5a6cfdc3c9976833e10a5e6f1f5de4c97fe932b504aca9cf7::liquid {
    ...
    fun init(arg0: LIQUID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Scallop X-Event"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"http://scallop.fi"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://scallop.fi/nft.gif"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Scallop X-Event"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"http://scallop.fi"));
