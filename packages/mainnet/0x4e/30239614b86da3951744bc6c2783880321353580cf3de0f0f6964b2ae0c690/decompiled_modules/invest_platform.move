module 0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::invest_platform {
    struct InvestmentPlatform has store, key {
        id: 0x2::object::UID,
        owner: address,
        total_invested: u64,
        sui_reserve: 0x2::balance::Balance<0x2::sui::SUI>,
        token_reserve: 0x2::balance::Balance<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>,
        is_closed: bool,
        is_buy_enabled: bool,
    ...
    public entry fun buy_tokens_from_amm<T0: store + key>(arg0: &mut InvestmentPlatform, arg1: &mut AMMPool<T0>, arg2: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun initialize_amm_pool<T0: store + key>(arg0: &mut InvestmentPlatform, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun initialize_platform(arg0: address, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = InvestmentPlatform{
            ...
            total_invested       : 0,
            sui_reserve          : 0x2::balance::zero<0x2::sui::SUI>(),
            token_reserve        : 0x2::balance::zero<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(),
            is_closed            : false,
    ...
    public entry fun sell_tokens_to_amm<T0: store + key>(arg0: &mut InvestmentPlatform, arg1: &mut AMMPool<T0>, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_closed, 2);
        assert!(arg0.amm_initialized, 6);
        let v0 = 0x2::tx_context::sender(arg5);
    ...
    public entry fun spl_payment<T0: store + key>(arg0: &mut InvestmentPlatform, arg1: &mut AMMPool<T0>, arg2: vector<0x2::coin::Coin<T0>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.amm_initialized, 6);
    ...
    public entry fun update_spl_amount(arg0: &mut InvestmentPlatform, arg1: address, arg2: vector<0x2::coin::Coin<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_closed, 1);
        assert!(arg3 > 0, 5);
        let v0 = 0x1::vector::pop_back<0x2::coin::Coin<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>>(&mut arg2);
        while (!0x1::vector::is_empty<0x2::coin::Coin<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>>(&arg2)) {
            0x2::coin::join<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(&mut v0, 0x1::vector::pop_back<0x2::coin::Coin<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>>(&mut arg2));
        };
        0x1::vector::destroy_empty<0x2::coin::Coin<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>>(arg2);
        let v1 = 0x2::coin::value<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(&v0);
        assert!(v1 >= arg3, 11);
        if (v1 > arg3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>>(0x2::coin::split<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(&mut v0, v1 - arg3, arg4), 0x2::tx_context::sender(arg4));
        };
        0x2::balance::join<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(&mut arg0.token_reserve, 0x2::coin::into_balance<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(v0));
    ...
    public entry fun withdraw_all_funds(arg0: &mut InvestmentPlatform, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::balance::value<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(&arg0.token_reserve);
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>>(0x2::coin::from_balance<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(0x2::balance::split<0x4e30239614b86da3951744bc6c2783880321353580cf3de0f0f6964b2ae0c690::spl::SPL>(&mut arg0.token_reserve, v2), arg1), v0);
        };
        arg0.reserved_suis = 0;
        arg0.reserved_tokens = 0;
    }

    public entry fun withdraw_amm_funds<T0: store + key>(arg0: &mut InvestmentPlatform, arg1: &mut AMMPool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
