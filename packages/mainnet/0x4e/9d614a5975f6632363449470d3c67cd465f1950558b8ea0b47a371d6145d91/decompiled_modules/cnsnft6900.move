module 0x4e9d614a5975f6632363449470d3c67cd465f1950558b8ea0b47a371d6145d91::cnsnft6900 {
    struct CNSNFT6900 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6900, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6900>(arg0, arg1);
