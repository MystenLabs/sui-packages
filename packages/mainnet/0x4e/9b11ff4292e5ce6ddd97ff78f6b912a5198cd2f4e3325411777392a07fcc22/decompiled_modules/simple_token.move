module 0x4e9b11ff4292e5ce6ddd97ff78f6b912a5198cd2f4e3325411777392a07fcc22::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"Sphere", b"Sphere", b"Official token on Sui blockchain. Banner, ads and boost on dexscreener already paid.", 0x1::option::none<0x2::url::Url>(), arg1);
