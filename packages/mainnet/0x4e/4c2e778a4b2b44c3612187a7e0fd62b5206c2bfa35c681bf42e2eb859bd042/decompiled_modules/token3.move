module 0x4e4c2e778a4b2b44c3612187a7e0fd62b5206c2bfa35c681bf42e2eb859bd042::token3 {
    ...
    fun init(arg0: TOKEN3, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN3>(arg0, 9, b"tt", b"TT", b"", 0x1::option::none<0x2::url::Url>(), arg1);
