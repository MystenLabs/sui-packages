module 0x4ebc3390a701e2d489645cb14d42cf8c8bfa21585c88450906df8d8f8618e97d::reward3537 {
    struct REWARD3537 has drop {
        dummy_field: bool,
    }

    struct TICKET_3537 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3537(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3537>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3537>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3537, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3537>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3537>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3537>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3537>>(v5, 0x2::tx_context::sender(arg1));
    }
