module 0x4efc22ce106d8560bd165cdcfdb38447a9518a3477184acdf51b9cc8285bf920::h5a57f {
    ...
    public(friend) fun hae3b3<T0>(arg0: &0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::clearing_house::ClearingHouse<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: bool) : vector<u64> {
        let (v0, v1) = if (arg4) {
            0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::orderbook::inspect_orders(0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::clearing_house::orderbook<T0>(arg0), false, 18446744073709551615, 0, arg2)
        } else {
            0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::orderbook::inspect_orders(0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::clearing_house::orderbook<T0>(arg0), true, 0, 18446744073709551615, arg2)
        };
        let v2 = v1;
        let v3 = v0;
        let v4 = vector[];
        let v5 = 0;
        while (v5 < 0x1::vector::length<0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::orderbook::Order>(&v2)) {
            let (v6, _, _, v9, _, _) = 0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::orderbook::as_parts(0x1::vector::borrow<0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::orderbook::Order>(&v2, v5));
            let v12 = v9;
