module 0x4e0c44ad5d12cdc4e199c836209c49ecf497f9ec65a4ce221a081e1a01e699ac::gift6870 {
    struct GIFT6870 has drop {
        dummy_field: bool,
    }

    struct TICKET_6870 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6870(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6870>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6870>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6870, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6870>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6870>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6870>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6870>>(v5, 0x2::tx_context::sender(arg1));
    }
