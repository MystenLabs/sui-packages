module 0x4533a4cec3e0483139a692416e83e694bbc20e861e5e833d9ee5dcab8c57e1ec::reward8307 {
    struct REWARD8307 has drop {
        dummy_field: bool,
    }

    struct TICKET_8307 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8307(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8307>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8307>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8307, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8307>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8307>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8307>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8307>>(v5, 0x2::tx_context::sender(arg1));
    }
