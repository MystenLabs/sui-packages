module 0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_hero_staking {
    ...
    struct RewardReceived has copy, drop {
        user: address,
        resource_type: 0x1::string::String,
        amount: u64,
    }
    ...
    struct PausedV2Key has copy, drop, store {
        dummy_field: bool,
    }
    ...
    fun auto_claim_influence(arg0: &mut HeroStakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::StakingPool, arg2: &0x2::clock::Clock, arg3: address) {
        store_influence_on_carry(arg0, arg2, arg3);
    }
    ...
    public fun check_not_paused_v2(arg0: &HeroStakingPool) : bool {
        let v0 = PausedV2Key{dummy_field: false};
        let v1 = 0x2::dynamic_field::exists_<PausedV2Key>(&arg0.id, v0) && *0x2::dynamic_field::borrow<PausedV2Key, bool>(&arg0.id, v0);
        assert!(!v1, 2);
        !v1
    }
    ...
    fun mint_and_transfer_coin<T0>(arg0: &HeroStakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        if (0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::get_coin_type_string<T0>() == 0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::get_coin_type_string<0xd72ab42db7dfe82f07858fd4af0d821c939b037b51200554256ed0446b488db::pawtato_coin_divine_favor_token::PAWTATO_COIN_DIVINE_FAVOR_TOKEN>()) {
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_dft_with_cap(&arg0.pawtato_package_cap, arg1, 0x2::object::id<HeroStakingPool>(arg0), arg2, arg3, arg4);
        } else {
    ...
    public entry fun mint_reward<T0>(arg0: &0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_package_cap::PawtatoPackageCap, arg1: &HeroStakingPool, arg2: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        abort 0
    }
    ...
    public entry fun set_paused_v2(arg0: &0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_heroes::HeroAdminCap, arg1: &mut HeroStakingPool, arg2: bool) {
        let v0 = PausedV2Key{dummy_field: false};
        if (0x2::dynamic_field::exists_<PausedV2Key>(&arg1.id, v0)) {
            *0x2::dynamic_field::borrow_mut<PausedV2Key, bool>(&mut arg1.id, v0) = arg2;
        } else {
            0x2::dynamic_field::add<PausedV2Key, bool>(&mut arg1.id, v0, arg2);
        };
    }
    ...
    fun store_influence_on_carry(arg0: &mut HeroStakingPool, arg1: &0x2::clock::Clock, arg2: address) {
        if (!is_user_registered(arg0, arg2)) {
            return
        };
        let v0 = 0x2::table::borrow_mut<address, HeroUserInfo>(&mut arg0.users, arg2);
        if (0x1::vector::length<HeroInfo>(&v0.heroes) == 0) {
            return
        };
        let v1 = 0x2::clock::timestamp_ms(arg1);
        v0.last_patrol_claim_ts = v1;
        v0.influence_carry = calculate_total_influence_with_decimals(&v0.heroes, v0.last_patrol_claim_ts, v1, v0.influence_carry);
    }
    ...
    public entry fun upgrade_version(arg0: &0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_heroes::HeroAdminCap, arg1: &mut HeroStakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version < 2, 13906842137212747775);
        arg1.version = 2;
    }
