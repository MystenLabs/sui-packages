module 0x45a7f9bfb046a4c7eb5c9b73e5d2cb52be0e06e1320a5923c0587ac944730647::events {
    ...
    struct UpgradedSourceVersion has copy, drop {
        source_id: u16,
        version: u64,
    }
    ...
    public(friend) fun emit_upgraded_source_version(arg0: u16, arg1: u64) {
        let v0 = UpgradedSourceVersion{
            source_id : arg0,
            version   : arg1,
        };
        0x2::event::emit<UpgradedSourceVersion>(v0);
    }
