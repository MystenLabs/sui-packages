module 0x454a1c627a82af320bb474b09cdeb920b38f11facb23b51a38cae35fd8a4c62e::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"WEED", b"Legalized Weed", b"Official token", 0x1::option::none<0x2::url::Url>(), arg1);
    ...
    public entry fun transfer_ownership(arg0: 0x2::coin::TreasuryCap<SIMPLE_TOKEN>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<SIMPLE_TOKEN>>(arg0, arg1);
    }
