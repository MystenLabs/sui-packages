module 0x45d57f18eb53cbdcbad089bf6656204d949817fd7df7d12721cf8801112792fb::bob {
    struct BOB has drop {
        dummy_field: bool,
    }

    fun init(arg0: BOB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = vector[6, 10000000000000000, 0];
        let v1 = vector[b"BOB", b"BOB", b"Bob once a fossil, now a king on SUI!", b"https://api.interestlabs.io/files/874517134babf70669842285e932d9f859c712fd1dd5b368.PNG"];
        let v2 = vector[b"BOB", b"BOB", b"Bob once a fossil, now a king on SUI!", b"https://api.interestlabs.io/files/874517134babf70669842285e932d9f859c712fd1dd5b368.PNG"];
        let v3 = vector[b"BOB", b"BOB", b"Bob once a fossil, now a king on SUI!", b"https://api.interestlabs.io/files/874517134babf70669842285e932d9f859c712fd1dd5b368.PNG"];
        let v4 = vector[b"BOB", b"BOB", b"Bob once a fossil, now a king on SUI!", b"https://api.interestlabs.io/files/874517134babf70669842285e932d9f859c712fd1dd5b368.PNG"];
        let (v5, v6) = 0x2::coin::create_currency<BOB>(arg0, (*0x1::vector::borrow<u64>(&v0, 0) as u8), *0x1::vector::borrow<vector<u8>>(&v1, 0), *0x1::vector::borrow<vector<u8>>(&v2, 1), *0x1::vector::borrow<vector<u8>>(&v3, 2), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(*0x1::vector::borrow<vector<u8>>(&v4, 3))), arg1);
        let v7 = v5;
        let v8 = 0x2::tx_context::sender(arg1);
        let v9 = vector[6, 10000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v9, 1) > 0) {
            let v10 = vector[6, 10000000000000000, 0];
            0x2::coin::mint_and_transfer<BOB>(&mut v7, *0x1::vector::borrow<u64>(&v10, 1), v8, arg1);
        };
        let (v11, v12) = 0x7ead93e49fe002193faec3d2e4a7b750e9e568b5d875cafe17fcb0dc672b075e::ipx_coin_standard::new<BOB>(v7, arg1);
        let v13 = v12;
        let v14 = v11;
        let v15 = vector[6, 10000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v15, 2) > 0) {
            let v16 = vector[6, 10000000000000000, 0];
        ...
        0x7ead93e49fe002193faec3d2e4a7b750e9e568b5d875cafe17fcb0dc672b075e::ipx_coin_standard::destroy_witness<BOB>(&mut v14, v13);
        ...
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<BOB>>(v6);
    }
