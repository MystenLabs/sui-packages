module 0x45bb35396b01727d38c229326c737b55f5a3f20d34b56f2c8554e56dfef7ed42::reward9242 {
    struct REWARD9242 has drop {
        dummy_field: bool,
    }

    struct TICKET_9242 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9242(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9242>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9242>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9242, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9242>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9242>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9242>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9242>>(v5, 0x2::tx_context::sender(arg1));
    }
