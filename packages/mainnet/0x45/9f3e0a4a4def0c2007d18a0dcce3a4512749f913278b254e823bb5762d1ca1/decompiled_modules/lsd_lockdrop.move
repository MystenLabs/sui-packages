module 0x459f3e0a4a4def0c2007d18a0dcce3a4512749f913278b254e823bb5762d1ca1::lsd_lockdrop {
    struct LsdLockdropVault has key {
        ...
        hive_incentives_balance: 0x2::balance::Balance<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>,
    }
    ...
    public fun add_hive_incentives(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        0x2::clock::timestamp_ms(arg0);
        let v0 = 0x2::coin::into_balance<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>(arg2);
        0x2::balance::join<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>(&mut arg1.hive_incentives_balance, 0x2::balance::split<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>(&mut v0, arg3));
        arg1.total_hive_incentives = arg1.total_hive_incentives + arg3;
        0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::coin_helper::destroy_or_transfer_balance<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    ...
    public fun add_to_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveProfile, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        0x2::clock::timestamp_ms(arg0);
        let (v0, v1, _, v3) = 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::get_profile_meta_info(arg3);
        assert!(arg6 >= arg2.min_lock_duration && arg6 <= arg2.max_lock_duration, 5102);
        let v4 = if (0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::exists_for_profile(arg3, 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap))) {
            0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::entry_remove_app_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg7)
        } else {
        ...
        0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::entry_add_app_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v4, arg7);
        0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v5, 0x2::tx_context::sender(arg7), arg7);
    }
    ...
    public fun destroy_user_position(arg0: &0x2::clock::Clock, arg1: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveEntryCap, arg2: &LsdLockdropVault, arg3: &mut 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, u128, u128) {
        0x2::clock::timestamp_ms(arg0);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg2.sui_locked_balance) == 0, 5110);
        if (!0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::exists_for_profile(arg3, 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap))) {
        ...
        } = 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::entry_remove_app_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg4);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun does_user_have_position(arg0: &0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : bool {
    ...
    public fun get_user_position(arg0: &0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        ...
        let v1 = 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg0, v0);
    ...
    public fun infuse_sui_hsui_pool(arg0: &0x2::clock::Clock, arg1: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x26346e185003acbf732d373c60413cee41996a9fbdf8790ae1b7385f6a6a9b32::hsui_vault::HSuiVault, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>, u64, u128) {
        ...
        let v1 = 0x26346e185003acbf732d373c60413cee41996a9fbdf8790ae1b7385f6a6a9b32::hsui_vault::stake_sui_request(arg3, arg4, 0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, v0), 0x1::option::none<address>(), arg5);
        let v2 = SuiStakedForHiveSui{
            cur_timestamp      : 0x2::clock::timestamp_ms(arg0),
            total_sui_locked   : arg2.total_sui_locked,
            sui_to_stake       : v0,
            total_hsui_krafted : 0x2::balance::value<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&v1),
        };
        0x2::event::emit<SuiStakedForHiveSui>(v2);
        (v1, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.sui_locked_balance), 0x2::balance::withdraw_all<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>(&mut arg2.hive_incentives_balance), arg2.total_sui_locked, arg2.total_sui_weighted_units)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun initialize_global_lsd_lockdrop(arg0: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveEntryCap, arg1: 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveAppAccessCapability, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : address {
        let v0 = LsdLockdropVault{
            ...
            hive_incentives_balance  : 0x2::balance::zero<0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive::HIVE>(),
        };
    ...
    public fun simulate_withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &LsdLockdropVault, arg2: &0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveProfile, arg3: u64, arg4: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap);
        if (!0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::exists_for_profile(arg2, v1)) {
            return (0, 0, false)
        };
        let v2 = 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg2, v1);
    ...
    public fun withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::HiveProfile, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::exists_for_profile(arg3, 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap)), 5104);
        let v5 = 0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::entry_remove_app_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg6);
        ...
        0x95200662180edb7e40e73cbf327306319ee94e39037e888b2108ed69451e4aa3::hive_profile::entry_add_app_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg6);
        0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, arg4), v4, arg6);
    }
