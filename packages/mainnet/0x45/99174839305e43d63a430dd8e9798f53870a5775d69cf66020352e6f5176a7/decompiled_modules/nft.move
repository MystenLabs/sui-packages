module 0x4599174839305e43d63a430dd8e9798f53870a5775d69cf66020352e6f5176a7::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun launchpad_mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &0x2::transfer_policy::TransferPolicy<Nft>, arg9: &mut 0x1198edab988f56ced66d5f8a511be599ebcb4d7e86bbff60966fd00383bc4cda::launch_manager::Launch, arg10: &mut 0x1198edab988f56ced66d5f8a511be599ebcb4d7e86bbff60966fd00383bc4cda::launchpad::Launchpad, arg11: u64, arg12: &mut Config, arg13: &mut 0x2::tx_context::TxContext) {
        assert_mintable(arg12);
        let v0 = impl_mint(arg0, arg2, arg1, arg11, arg4, arg5, arg13);
        let v1 = MintNftEvent{nft_id: 0x2::object::uid_to_inner(&v0.id)};
        0x2::event::emit<MintNftEvent>(v1);
        arg12.mint_count = arg12.mint_count + 1;
        0x1198edab988f56ced66d5f8a511be599ebcb4d7e86bbff60966fd00383bc4cda::launch_manager::mint_with_kiosk<Nft>(arg9, v0, arg6, arg8, arg7, arg3, arg10, arg13);
    }
    ...
    fun setup_display(arg0: 0x2::display::Display<Nft>, arg1: address) {
        ...
        0x2::display::add<Nft>(&mut arg0, 0x1::string::utf8(b"collectionDescription"), 0x1::string::utf8(b"This is the most awesome collection that you will ever see!"));
