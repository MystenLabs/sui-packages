module 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error {
    public fun apm_price_history_empty_error() : u64 {
        4099
    }
    ...
    public fun e_mode_asset_already_present() : u64 {
        94215
    }

    public fun e_mode_asset_list_full() : u64 {
        94216
    }

    public fun e_mode_borrow_not_allowed() : u64 {
        94212
    }

    public fun e_mode_category_not_found() : u64 {
        94209
    }

    public fun e_mode_category_still_active() : u64 {
        94214
    }

    public fun e_mode_debt_not_in_category() : u64 {
        94210
    }

    public fun e_mode_invalid_params() : u64 {
        94213
    }

    public fun e_mode_switch_unhealthy() : u64 {
        94211
    }
    ...
    public fun interest_is_not_accrued_error() : u64 {
        4100
    }
    ...
    public fun invalid_flash_loan_fee_discount_error() : u64 {
        69634
    }
    ...
    public fun invalid_util_rate_error() : u64 {
        77827
    }
    ...
    public fun mint_with_zero_amount_error() : u64 {
        2051
    }
    ...
    public fun protocol_already_frozen_error() : u64 {
        4101
    }
    ...
    public fun zero_deposit_amount_error() : u64 {
        1797
    }
    ...
    public fun zero_withdrawal_amount_error() : u64 {
        1798
    }
