module 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::reserve {
    ...
    fun borrow_flash_loan_internal<T0>(arg0: &mut Reserve, arg1: u64, arg2: u64, arg3: u64) : (0x2::balance::Balance<T0>, FlashLoan<T0>) {
        assert!(arg3 > 0, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::invalid_flash_loan_fee_discount_error());
        assert!(arg2 <= arg3, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::invalid_flash_loan_fee_discount_error());
    ...
    public(friend) fun handle_borrow<T0>(arg0: &mut Reserve, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v1.cash >= arg1, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::reserve_not_enough_error());
        v1.cash = v1.cash - arg1;
        v1.debt = v1.debt + arg1;
        assert!(v1.cash >= v1.revenue, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun mint_market_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<MarketCoin<T0>> {
        ...
        assert!(v2 > 0, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::mint_market_coin_too_small_error());
    ...
    public(friend) fun redeem_underlying_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<MarketCoin<T0>>) : 0x2::balance::Balance<T0> {
        ...
        assert!(v2 > 0, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::redeem_market_coin_too_small_error());
        let v3 = BalanceSheets{dummy_field: false};
        let v4 = 0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::wit_table::borrow_mut<BalanceSheets, 0x1::type_name::TypeName, BalanceSheet>(v3, &mut arg0.balance_sheets, 0x1::type_name::get<T0>());
        assert!(v4.cash >= v2, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::reserve_not_enough_error());
        v4.cash = v4.cash - v2;
        v4.market_coin_supply = v4.market_coin_supply - v0;
        assert!(v4.cash >= v4.revenue, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun repay_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoan<T0>) {
        ...
        assert!(v2 >= v0 + v1, 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::flash_loan_repay_not_enough_error());
        let v3 = v2 - v0;
    ...
    fun update_and_get_market_coin_price(arg0: &mut Reserve, arg1: 0x1::type_name::TypeName) : 0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::Decimal {
        ...
        let v5 = if (v4.market_coin_supply > 0) {
            ...
            assert!(0x7caedbf4c4d64288771089889a8b3e8721e5522bb55d041b14a234bf5e4d242::decimal::ge(v6, *v2), 0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::error::market_coin_price_cannot_decrease_error());
            v6
        } else {
