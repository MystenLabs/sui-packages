module 0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::registry {
    ...
    struct Registry has key {
        id: 0x2::object::UID,
        version: 0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::Version,
        oracle_set_price_cap: 0x1::option::Option<0x69fea1d4f9275f58bec2465ac54ccf6477a44fb89c6ab893421ad849fb947ae::registry::SetPriceCap>,
    ...
    public fun get_oracle_set_price_cap(arg0: &Registry) : &0x69fea1d4f9275f58bec2465ac54ccf6477a44fb89c6ab893421ad849fb947ae::registry::SetPriceCap {
        0x1::option::borrow<0x69fea1d4f9275f58bec2465ac54ccf6477a44fb89c6ab893421ad849fb947ae::registry::SetPriceCap>(&arg0.oracle_set_price_cap)
    }

    public fun get_pair_id<T0>(arg0: &Registry) : 0x2::object::ID {
        0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::assert_current_version(&arg0.version);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            version              : 0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::initialize(),
            oracle_set_price_cap : 0x1::option::none<0x69fea1d4f9275f58bec2465ac54ccf6477a44fb89c6ab893421ad849fb947ae::registry::SetPriceCap>(),
    ...
    public fun set_oracle_set_price_cap(arg0: &mut Registry, arg1: 0x69fea1d4f9275f58bec2465ac54ccf6477a44fb89c6ab893421ad849fb947ae::registry::SetPriceCap) {
        0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::assert_current_version(&arg0.version);
        0x1::option::fill<0x69fea1d4f9275f58bec2465ac54ccf6477a44fb89c6ab893421ad849fb947ae::registry::SetPriceCap>(&mut arg0.oracle_set_price_cap, arg1);
    }
    ...
    public fun set_price_pair_id<T0>(arg0: &AdminCap, arg1: &mut Registry, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::assert_current_version(&arg1.version);
    ...
    public fun upgrade_major(arg0: &AdminCap, arg1: &mut Registry) {
        0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::upgrade_major(&mut arg1.version);
    }

    public fun upgrade_minor(arg0: &AdminCap, arg1: &mut Registry) {
        0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::upgrade_minor(&mut arg1.version);
    }

    public fun version(arg0: &Registry) : &0x454ae856685130db7e5f86851add03d8252cebddbaff59db196548f3bd93d32a::version::Version {
        &arg0.version
    }
