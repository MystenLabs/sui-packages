module 0x4519cd592757a1cea0fa25c0834db9661971cb7e9722c6f89dd461a82ceadaf1::cnsnft2864 {
    struct CNSNFT2864 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2864, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2864>(arg0, arg1);
