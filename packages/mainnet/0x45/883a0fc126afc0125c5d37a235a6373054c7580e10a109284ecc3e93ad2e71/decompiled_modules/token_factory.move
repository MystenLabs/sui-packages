module 0x45883a0fc126afc0125c5d37a235a6373054c7580e10a109284ecc3e93ad2e71::token_factory {
    ...
    fun init(arg0: TOKEN_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_FACTORY>(arg0, 6, b"ORION", b"Oreo Token", b"Test Token for Pool Creation", 0x1::option::none<0x2::url::Url>(), arg1);
