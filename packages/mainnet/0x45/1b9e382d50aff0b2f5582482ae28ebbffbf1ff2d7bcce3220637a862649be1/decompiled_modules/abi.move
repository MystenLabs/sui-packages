module 0x451b9e382d50aff0b2f5582482ae28ebbffbf1ff2d7bcce3220637a862649be1::abi {
    ...
    fun append_u256(arg0: &mut AbiWriter, arg1: u256) {
        let v0 = 0;
        while (v0 < 32) {
            0x1::vector::push_back<u8>(&mut arg0.bytes, ((arg1 >> (((31 - v0) * 8) as u8) & 255) as u8));
            v0 = v0 + 1;
        };
    }
    ...
    public fun into_remaining_bytes(arg0: AbiReader) : vector<u8> {
        let AbiReader {
            bytes : v0,
            head  : _,
            pos   : _,
    ...
    public fun read_u256(arg0: &mut AbiReader) : u256 {
        ...
        while (v1 < 32) {
            let v3 = v0 << 8;
            v0 = v3 | (*0x1::vector::borrow<u8>(&arg0.bytes, v1 + v2) as u256);
            v1 = v1 + 1;
        };
        arg0.pos = v2 + 32;
        v0
    ...
    public fun read_vector_bytes(arg0: &mut AbiReader) : vector<vector<u8>> {
        ...
        arg0.pos = v2 + (v3 as u64);
        let v4 = read_u256(arg0);
        arg0.head = arg0.pos;
        let v5 = 0;
        while (v5 < (v4 as u64)) {
            let v6 = read_bytes(arg0);
            0x1::vector::push_back<vector<u8>>(&mut v0, v6);
            v5 = v5 + 1;
        };
        arg0.pos = v1 + 32;
        arg0.head = v2;
    ...
    public fun read_vector_u256(arg0: &mut AbiReader) : vector<u256> {
        ...
        arg0.pos = arg0.head + (v2 as u64);
        let v3 = read_u256(arg0);
        let v4 = 0;
        while (v4 < (v3 as u64)) {
            let v5 = read_u256(arg0);
            0x1::vector::push_back<u256>(&mut v0, v5);
            v4 = v4 + 1;
        };
        arg0.pos = v1 + 32;
        v0
    ...
    public fun write_vector_bytes(arg0: &mut AbiWriter, arg1: vector<vector<u8>>) : &mut AbiWriter {
        ...
        while (v3 < v1) {
            let v4 = &mut v2;
            write_bytes(v4, *0x1::vector::borrow<vector<u8>>(&arg1, v3));
            v3 = v3 + 1;
        };
    ...
    public fun write_vector_u256(arg0: &mut AbiWriter, arg1: vector<u256>) : &mut AbiWriter {
        ...
        let v2 = 0;
        while (v2 < v1) {
            append_u256(arg0, *0x1::vector::borrow<u256>(&arg1, v2));
            v2 = v2 + 1;
        };
        arg0
    }
