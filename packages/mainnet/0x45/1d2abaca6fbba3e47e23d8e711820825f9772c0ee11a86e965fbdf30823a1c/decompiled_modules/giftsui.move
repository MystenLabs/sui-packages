module 0x451d2abaca6fbba3e47e23d8e711820825f9772c0ee11a86e965fbdf30823a1c::giftsui {
    ...
    public entry fun Gift10000Sui(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = GIFTSUI_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuinet_0807/giftsuinet_0807_1.jpg"),
    ...
    fun init(arg0: GIFTSUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuinet_0807/giftsuinet_0807_1.jpg"));
