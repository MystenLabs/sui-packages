module 0x45af2e083d45e6d8f5e14f9025bf973ac7853243f459a55d81d8aca391160f67::q64x64 {
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v3 = 0x45af2e083d45e6d8f5e14f9025bf973ac7853243f459a55d81d8aca391160f67::bit_math::most_significant_bit(v1);
        let v4 = 64;
        let v5 = if (v3 >= v4) {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0x45af2e083d45e6d8f5e14f9025bf973ac7853243f459a55d81d8aca391160f67::bit_math::most_significant_bit(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
