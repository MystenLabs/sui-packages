module 0x45238bd9471d1c5d21baf5663f23be6a2f87d1389c9cf36043b2bfb4fd4a930c::cnsnft9255 {
    struct CNSNFT9255 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9255, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9255>(arg0, arg1);
