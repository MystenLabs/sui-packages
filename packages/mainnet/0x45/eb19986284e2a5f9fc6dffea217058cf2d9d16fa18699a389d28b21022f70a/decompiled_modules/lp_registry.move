module 0x45eb19986284e2a5f9fc6dffea217058cf2d9d16fa18699a389d28b21022f70a::lp_registry {
    struct LPRegistry has key {
        ...
        owner_registrations: 0x2::table::Table<address, vector<0x2::object::ID>>,
    }
    ...
    struct PositionReplaced has copy, drop {
        registration_id: address,
    ...
    public fun compound_fees(arg0: &PositionRegistration) : bool {
        arg0.compound_fees
    }

    public fun get_owner_registration_count(arg0: &LPRegistry, arg1: address) : u64 {
        if (0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.owner_registrations, arg1)) {
            0x1::vector::length<0x2::object::ID>(0x2::table::borrow<address, vector<0x2::object::ID>>(&arg0.owner_registrations, arg1))
        } else {
            0
        }
    }

    public fun get_owner_registrations(arg0: &LPRegistry, arg1: address) : vector<0x2::object::ID> {
        if (0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.owner_registrations, arg1)) {
            *0x2::table::borrow<address, vector<0x2::object::ID>>(&arg0.owner_registrations, arg1)
        } else {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LPRegistry{
            ...
            total_registered    : 0,
            total_rebalances    : 0,
            owner_registrations : 0x2::table::new<address, vector<0x2::object::ID>>(arg0),
        };
    ...
    public fun is_out_of_range(arg0: &PositionRegistration) : bool {
        arg0.out_of_range_since > 0
    }

    public fun is_ready_for_out_of_range_rebalance(arg0: &PositionRegistration, arg1: &0x2::clock::Clock) : bool {
        if (!arg0.is_active) {
            return false
        };
        if (!arg0.rebalance_on_out_of_range) {
            return false
        };
        if (arg0.out_of_range_since == 0) {
            return false
        };
        0x2::clock::timestamp_ms(arg1) - arg0.out_of_range_since >= arg0.out_of_range_delay_ms
    }
    ...
    public entry fun mark_in_range(arg0: &mut PositionRegistration, arg1: &0x2::tx_context::TxContext) {
        assert!(is_authorized(arg0, 0x2::tx_context::sender(arg1)), 3);
        arg0.out_of_range_since = 0;
    }

    public entry fun mark_out_of_range(arg0: &mut PositionRegistration, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        assert!(is_authorized(arg0, 0x2::tx_context::sender(arg2)), 3);
        assert!(arg0.is_active, 7);
        if (arg0.out_of_range_since == 0) {
            arg0.out_of_range_since = 0x2::clock::timestamp_ms(arg1);
        };
    }
    ...
    public fun out_of_range_delay_ms(arg0: &PositionRegistration) : u64 {
        arg0.out_of_range_delay_ms
    }

    public fun out_of_range_since(arg0: &PositionRegistration) : u64 {
        arg0.out_of_range_since
    }
    ...
    public fun recurring(arg0: &PositionRegistration) : bool {
        arg0.recurring
    }

    public entry fun register_existing_position<T0: store + key>(arg0: &mut LPRegistry, arg1: T0, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: bool, arg7: u64, arg8: bool, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        register_position<T0>(arg0, arg1, arg2, 0x1::string::utf8(arg3), 0x1::string::utf8(arg4), arg5, arg6, arg7, arg8, arg9, arg10, arg11);
    }

    public fun register_position<T0: store + key>(arg0: &mut LPRegistry, arg1: T0, arg2: 0x2::object::ID, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: bool, arg7: u64, arg8: bool, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        if (!0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.owner_registrations, v0)) {
            0x2::table::add<address, vector<0x2::object::ID>>(&mut arg0.owner_registrations, v0, 0x1::vector::empty<0x2::object::ID>());
        };
        0x1::vector::push_back<0x2::object::ID>(0x2::table::borrow_mut<address, vector<0x2::object::ID>>(&mut arg0.owner_registrations, v0), v6);
    ...
    public entry fun register_position_entry<T0: store + key>(arg0: &mut LPRegistry, arg1: T0, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: bool, arg7: u64, arg8: bool, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        register_position<T0>(arg0, arg1, arg2, 0x1::string::utf8(arg3), 0x1::string::utf8(arg4), arg5, arg6, arg7, arg8, arg9, arg10, arg11);
    }
    ...
    public fun store_new_position<T0: store + key>(arg0: &mut LPRegistry, arg1: &mut PositionRegistration, arg2: T0, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(is_authorized(arg1, v0), 3);
        assert!(arg1.is_active, 7);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        let v2 = 0x2::object::id<T0>(&arg2);
        let v3 = arg1.position_id;
        arg1.position_id = v2;
        arg1.rebalance_count = arg1.rebalance_count + 1;
        arg1.last_rebalance_at = v1;
        ...
        let v5 = PositionReplaced{
            registration_id : 0x2::object::id_address<PositionRegistration>(arg1),
            old_position_id : 0x2::object::id_to_address(&v3),
            new_position_id : 0x2::object::id_to_address(&v2),
            owner           : arg1.owner,
        };
        0x2::event::emit<PositionReplaced>(v5);
    }
    ...
    public fun unregister_position<T0: store + key>(arg0: &mut LPRegistry, arg1: PositionRegistration, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v19 = v1;
        let v20 = v0;
        if (0x2::table::contains<address, vector<0x2::object::ID>>(&arg0.owner_registrations, v2)) {
            let v21 = 0x2::table::borrow_mut<address, vector<0x2::object::ID>>(&mut arg0.owner_registrations, v2);
            let v22 = 0x2::object::uid_to_inner(&v20);
            let (v23, v24) = 0x1::vector::index_of<0x2::object::ID>(v21, &v22);
            if (v23) {
                0x1::vector::remove<0x2::object::ID>(v21, v24);
            };
        };
        arg0.total_registered = arg0.total_registered - 1;
        let v25 = PositionUnregistered{
            registration_id : 0x2::object::uid_to_address(&v20),
            position_id     : 0x2::object::id_to_address(&v19),
            owner           : v2,
        };
        0x2::event::emit<PositionUnregistered>(v25);
        0x2::object::delete(v20);
        0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, v19)
    }

    public entry fun update_out_of_range_delay(arg0: &mut PositionRegistration, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 2);
        arg0.out_of_range_delay_ms = arg1;
    }

    public entry fun update_settings(arg0: &mut PositionRegistration, arg1: u64, arg2: bool, arg3: u64, arg4: bool, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
