module 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::ordered_map {
    ...
    public(friend) fun borrow<T0: copy + drop + store>(arg0: &Map<T0>, arg1: u128) : &T0 {
        ...
        assert!(arg1 == v1.key, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::key_not_exist());
        &v1.val
    }
    ...
    public(friend) fun borrow_mut<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u128) : &mut T0 {
        ...
        assert!(arg1 == v2.key, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::key_not_exist());
        &mut v2.val
    }

    public(friend) fun destroy_empty<T0: copy + drop + store>(arg0: Map<T0>) {
        assert!(is_empty<T0>(&arg0), 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::destroy_not_empty());
        let Map {
            id                 : v0,
            size               : _,
            counter            : _,
    ...
    public(friend) fun change_params<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        ...
        assert!(arg0.size > 3, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::map_too_small());
        assert!(arg1 <= arg0.branch_min && arg0.branch_max <= arg3, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::invalid_map_parameters());
        assert!(arg4 <= arg0.leaf_min && arg0.leaf_max <= arg6, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::invalid_map_parameters());
    ...
    fun check_map_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        assert!(2 <= arg0 && arg0 <= arg2 / 2, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::invalid_map_parameters());
        assert!(2 * arg0 <= arg1 && arg1 <= arg2, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::invalid_map_parameters());
        assert!(2 <= arg3 && arg3 <= (arg5 + 1) / 2, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::invalid_map_parameters());
        assert!(2 * arg3 - 1 <= arg4 && arg4 <= arg5, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::invalid_map_parameters());
    }
    ...
    fun insert_into_leaf<T0: copy + drop + store>(arg0: &mut Leaf<T0>, arg1: u128, arg2: T0) : u64 {
        ...
        let v1 = 0x1::vector::length<Pair<T0>>(v0);
        let v2 = binary_search_p<T0>(v0, v1, arg1);
        assert!(v2 == v1 || arg1 != 0x1::vector::borrow<Pair<T0>>(v0, v2).key, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::key_already_exists());
        let v3 = Pair<T0>{
            key : arg1,
            val : arg2,
        };
    ...
    fun remove_from_leaf<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u64, arg2: u128) : (T0, u64) {
        ...
        assert!(arg2 == v5.key, 0x45b45e93b1d4cd1f616ab9b3ebe8df84b92171558faa394707cc3b69fde9fe33::errors::key_not_exist());
        arg0.size = arg0.size - 1;
        (v5.val, v2 - 1)
    }
