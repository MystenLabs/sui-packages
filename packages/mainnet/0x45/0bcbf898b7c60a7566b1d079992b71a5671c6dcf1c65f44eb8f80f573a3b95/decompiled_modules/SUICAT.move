module 0x450bcbf898b7c60a7566b1d079992b71a5671c6dcf1c65f44eb8f80f573a3b95::SUICAT {
    struct SUICAT has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUICAT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUICAT>(arg0, 6, b"SUICAT", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
