module 0xdec456c198200260c20663a5a53b82fd1d6c75ae893473e335a873c3f5c444d8::project_manager {
    ...
    public fun batch_add_white_list_admin<T0>(arg0: &0xdec456c198200260c20663a5a53b82fd1d6c75ae893473e335a873c3f5c444d8::launchpad_manager_config::LaunchWhiteListAdmin, arg1: &mut ProjectManager<T0>, arg2: vector<address>, arg3: vector<u64>) {
    ...
    public fun batch_remove_white_list_admin<T0>(arg0: &mut ProjectManager<T0>, arg1: &0xdec456c198200260c20663a5a53b82fd1d6c75ae893473e335a873c3f5c444d8::launchpad_manager_config::LaunchWhiteListAdmin, arg2: vector<address>) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 <= 200, 13);
        let v1 = 0;
        while (v1 < v0) {
