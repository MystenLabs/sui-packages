module 0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::identity {
    ...
    public fun register(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: &mut 0x2::tx_context::TxContext) : AgentIdentity {
        ...
        let v4 = AgentRegistered{
            agent_id            : v1,
            feedback_board_id   : 0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::feedback::create_and_share<FeedbackKey>(&mut v0.id, v2, v1, arg5),
            validation_board_id : 0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::validation::create_and_share<ValBoardKey>(&mut v0.id, v3, v1, arg5),
    ...
    public fun review_as_agent(arg0: &mut 0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::feedback::FeedbackBoard, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &AgentIdentity, arg3: u8, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::feedback::pay_and_review_as_agent(arg0, arg1, 0x2::object::id<AgentIdentity>(arg2), arg3, arg4, arg5);
    }
    ...
    public fun withdraw(arg0: &mut 0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::feedback::FeedbackBoard, arg1: &AgentIdentity, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::feedback::withdraw_balance(arg0, 0x2::object::id<AgentIdentity>(arg1), arg2, arg3)
    }

    public fun withdraw_all(arg0: &mut 0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::feedback::FeedbackBoard, arg1: &AgentIdentity, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x45c82249c59ef5c50b9a8ccaba962fa5d441aa869f5f2611c02e3714dba5de27::feedback::withdraw_all_balance(arg0, 0x2::object::id<AgentIdentity>(arg1), arg2)
    }
