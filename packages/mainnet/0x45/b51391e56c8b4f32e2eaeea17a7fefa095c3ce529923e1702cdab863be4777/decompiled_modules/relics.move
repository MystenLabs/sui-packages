module 0x45b51391e56c8b4f32e2eaeea17a7fefa095c3ce529923e1702cdab863be4777::relics {
    ...
    fun init(arg0: RELICS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Relic>(&mut v5, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Relics of Mysten"));
        0x2::display::add<Relic>(&mut v5, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Ancient relics imbued with the power of Mysten."));
        0x2::display::add<Relic>(&mut v5, 0x1::string::utf8(b"icon_url"), 0x1::string::utf8(b"https://aggregator.mainnet.walrus.mirai.cloud/v1/blobs/ScREaq6fZq71Rbw0ncMYcq-dBoSNhXcAP8I9vkh6zY4"));
    ...
    public entry fun mint(arg0: &AdminCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::transfer_policy::TransferPolicy<Relic>, arg9: &mut 0x2::tx_context::TxContext) {
