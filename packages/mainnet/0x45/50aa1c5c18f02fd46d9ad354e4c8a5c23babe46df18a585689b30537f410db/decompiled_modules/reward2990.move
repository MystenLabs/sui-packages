module 0x4550aa1c5c18f02fd46d9ad354e4c8a5c23babe46df18a585689b30537f410db::reward2990 {
    struct REWARD2990 has drop {
        dummy_field: bool,
    }

    struct TICKET_2990 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2990(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2990>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2990>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2990, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2990>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2990>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2990>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2990>>(v5, 0x2::tx_context::sender(arg1));
    }
