module 0x4503caf6ac7647f44e6662bbd300ef8f5ba5784870e88ced65c827b5db212470::cnsnft2357 {
    struct CNSNFT2357 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2357, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2357>(arg0, arg1);
