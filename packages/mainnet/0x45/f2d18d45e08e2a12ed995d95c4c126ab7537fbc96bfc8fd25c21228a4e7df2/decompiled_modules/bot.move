module 0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::bot {
    ...
    struct ArbitrageBot has key {
        ...
        min_trade_size: u64,
        max_trade_size: u64,
        total_profit_usdc: 0x2::balance::Balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>,
        total_profit_wusdc: 0x2::balance::Balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>,
        trading_balance_usdc: 0x2::balance::Balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>,
        trading_balance_wusdc: 0x2::balance::Balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>,
        active: bool,
    ...
    public fun create_new_bot(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = ArbitrageBot{
            ...
            total_profit_usdc     : 0x2::balance::zero<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(),
            total_profit_wusdc    : 0x2::balance::zero<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(),
            trading_balance_usdc  : 0x2::balance::zero<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(),
            trading_balance_wusdc : 0x2::balance::zero<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(),
            active                : true,
    ...
    public entry fun deposit_usdc(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(&mut arg0.trading_balance_usdc, 0x2::coin::into_balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(arg1));
    ...
    public entry fun deposit_wusdc(arg0: &mut ArbitrageBot, arg1: 0x2::coin::Coin<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(&arg1);
        assert!(v0 >= 1000000, 5);
        0x2::balance::join<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(&mut arg0.trading_balance_wusdc, 0x2::coin::into_balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(arg1));
        let v1 = FundsDeposited{
            amount    : v0,
            is_usdc   : false,
            timestamp : 0x2::tx_context::epoch(arg2),
    ...
    public fun get_total_profit_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(&arg0.total_profit_usdc)
    }

    public fun get_total_profit_wusdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(&arg0.total_profit_wusdc)
    }

    public fun get_trading_balance_usdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(&arg0.trading_balance_usdc)
    }

    public fun get_trading_balance_wusdc(arg0: &ArbitrageBot) : u64 {
        0x2::balance::value<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(&arg0.trading_balance_wusdc)
    }
    ...
    public entry fun withdraw_profits(arg0: &mut ArbitrageBot, arg1: u64, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>>(0x2::coin::from_balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(0x2::balance::split<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::usdc::USDC>(&mut arg0.total_profit_usdc, arg1), arg3), arg0.owner);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>>(0x2::coin::from_balance<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(0x2::balance::split<0x45f2d18d45e08e2a12ed995d95c4c126ab7537fbc96bfc8fd25c21228a4e7df2::coin::COIN>(&mut arg0.total_profit_wusdc, arg1), arg3), arg0.owner);
        };
    }
