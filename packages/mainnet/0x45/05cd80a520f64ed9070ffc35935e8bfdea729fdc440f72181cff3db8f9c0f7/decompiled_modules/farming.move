module 0x4505cd80a520f64ed9070ffc35935e8bfdea729fdc440f72181cff3db8f9c0f7::farming {
    ...
    public entry fun add_reward_for_pool<T0>(arg0: &mut StakingPool<0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::LSP<0x2::sui::SUI, T0>, T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.reward_type = 0x4505cd80a520f64ed9070ffc35935e8bfdea729fdc440f72181cff3db8f9c0f7::utils::get_token_name<T0>();
        let v1 = AddRewardPoolEvent{
            ...
            lp_type           : 0x4505cd80a520f64ed9070ffc35935e8bfdea729fdc440f72181cff3db8f9c0f7::utils::get_token_name<0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::LSP<0x2::sui::SUI, T0>>(),
            reward_type       : 0x4505cd80a520f64ed9070ffc35935e8bfdea729fdc440f72181cff3db8f9c0f7::utils::get_token_name<T0>(),
    ...
    public entry fun create_staking_pool<T0>(arg0: &0x92fecee99603c0628ced2fbd37f85c05f6c0049c183eb6b1b58db24764c6c7bc::move_pump::Configuration, arg1: &mut FarmingData, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x4505cd80a520f64ed9070ffc35935e8bfdea729fdc440f72181cff3db8f9c0f7::utils::get_token_name<T0>();
        assert_version(arg1.version);
        let v1 = 0x2::clock::timestamp_ms(arg2) / 1000;
        let v2 = v1 + 2592000;
        let v3 = 0x4505cd80a520f64ed9070ffc35935e8bfdea729fdc440f72181cff3db8f9c0f7::utils::get_token_name<0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::LSP<0x2::sui::SUI, T0>>();
