module 0x45c2259c7594339139562fc58dae9a4fdb672dd029e647aa2176d20067752a88::birds_nft {
    ...
    public fun buy(arg0: &mut BirdConfig, arg1: &mut SaleConfig, arg2: u8, arg3: u8, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1002);
        ...
        0x2::transfer::public_transfer<BirdNFT>(v6, v3);
    }
    ...
    fun init(arg0: BIRDS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<UserArchive>(v4);
        let v5 = BirdConfig{
            id             : 0x2::object::new(arg1),
            version        : 1,
    ...
    public fun mint(arg0: &mut BirdConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut UserArchive, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 1002);
        ...
        let v5 = if (0x2::table::contains<address, u128>(&arg4.user_nonce, v2)) {
            0x2::table::borrow_mut<address, u128>(&mut arg4.user_nonce, v2)
        } else {
            0x2::table::add<address, u128>(&mut arg4.user_nonce, v2, 0);
            0x2::table::borrow_mut<address, u128>(&mut arg4.user_nonce, v2)
        };
        assert!(*v5 < 0x2::bcs::peel_u128(&mut v1), 1014);
        *v5 = *v5 + 1;
        ...
        0x2::event::emit<MintedEvent>(v7);
        0x2::transfer::public_transfer<BirdNFT>(v6, v0);
    }
