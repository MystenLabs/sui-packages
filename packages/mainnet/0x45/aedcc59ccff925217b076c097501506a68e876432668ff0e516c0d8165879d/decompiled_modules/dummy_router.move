module 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::dummy_router {
    ...
    public fun observe_and_route<T0, T1>(arg0: &mut Router<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg8: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg10 > arg0.last_sequence, 4);
        validate_signal_times(arg13, arg14, arg0.gate_window_ms, arg0.maximum_signal_age_ms, 0x2::clock::timestamp_ms(arg15));
        let (v0, v1) = gated_direction(arg11, arg12, arg0.gate_bps);
        arg0.last_sequence = arg10;
        let v2 = fair_quote_for_clip(arg12, arg0.clip_base_raw, true);
        let v3 = mul_div_down(v2, 10000 - arg0.margin_bps, 10000);
        let v4 = mul_div_up(v2, 10000 + arg0.margin_bps, 10000);
        let v5 = v0 != 0;
        if (!v5 || arg0.execution_count >= arg0.maximum_executions) {
            emit_signal<T0, T1>(arg0, arg10, arg11, arg12, arg13, arg14, v1, v0, v5, v2, v3, v4, 0, 0, 0, 0, 0, false);
            return
        };
        let v6 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::sqrt_price<T0, T1>(arg3);
        let v7 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg9);
        let v8 = 0x1::vector::empty<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>();
        if (v0 == 1) {
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_deepbook_buy_exact_base<T0, T1>(arg1, arg2, arg0.clip_base_raw, v3, arg15));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_momentum_buy_exact_base<T0, T1>(arg3, arg0.clip_base_raw, upper_sqrt_limit(v6, arg0.maximum_sqrt_move_bps_e4)));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_cetus_buy_exact_base<T0, T1>(arg6, arg0.clip_base_raw, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::cetus_low_route()));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_cetus_buy_exact_base<T0, T1>(arg7, arg0.clip_base_raw, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::cetus_high_route()));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_bluefin_buy_exact_base<T0, T1>(arg9, arg0.clip_base_raw, upper_sqrt_limit(v7, arg0.maximum_sqrt_move_bps_e4)));
        } else {
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_deepbook_sell_exact_base<T0, T1>(arg1, arg2, arg0.clip_base_raw, v4, arg15));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_momentum_sell_exact_base<T0, T1>(arg3, arg0.clip_base_raw, lower_sqrt_limit(v6, arg0.maximum_sqrt_move_bps_e4)));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_cetus_sell_exact_base<T0, T1>(arg6, arg0.clip_base_raw, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::cetus_low_route()));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_cetus_sell_exact_base<T0, T1>(arg7, arg0.clip_base_raw, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::cetus_high_route()));
            0x1::vector::push_back<0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::TakerQuote>(&mut v8, 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::quote_bluefin_sell_exact_base<T0, T1>(arg9, arg0.clip_base_raw, lower_sqrt_limit(v7, arg0.maximum_sqrt_move_bps_e4)));
        };
        emit_candidate_quotes<T0, T1>(&v8, arg10, arg12, arg0.margin_bps);
        ...
        let v12 = 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::select_best_taker(v8, v11, v3, v4, arg0.clip_base_raw, v9, v10, v9, arg0.inventory_target_base_raw, arg0.inventory_guard_base_raw);
        let (v13, v14, v15, v16, v17, v18, v19) = 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::taker_selection_values(&v12);
        let v20 = false;
        if (v13 != 0) {
            assert!(0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::selected_taker_is_safe(&v12, arg0.clip_base_raw, v9, v10, v9, arg0.inventory_target_base_raw, arg0.inventory_guard_base_raw), 6);
            let v21 = if (v14 == 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::buy_base_side() || v13 == 0x45aedcc59ccff925217b076c097501506a68e876432668ff0e516c0d8165879d::spot_guard::deepbook_route()) {
                v16
            } else {
                v4
            };
            execute_selected<T0, T1>(v13, v14, arg10, arg0.clip_base_raw, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, v15, v21, arg12, v18, arg15, arg16);
            assert_balance_delta<T0, T1>(arg2, v14, v15, v21, v9, v10);
            arg0.execution_count = arg0.execution_count + 1;
            v20 = true;
        };
        emit_signal<T0, T1>(arg0, arg10, arg11, arg12, arg13, arg14, v1, v0, true, v2, v3, v4, v13, v15, v16, v17, v19, v20);
    }
