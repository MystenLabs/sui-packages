module 0x45b3d0a21e3d7fb3f542d116af6aca6e47bfe593c8fe5ca977b4af9a4ff99217::mystemons {
    ...
    fun init(arg0: MYSTEMONS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Mystemon>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"MystenDex Mystemons"));
        0x2::display::add<Mystemon>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"4120636f6c6c656374696f6e206f6620756e69717565204d797374c3a96d6f6e732067656e6572617465642066726f6d20757365722070726f66696c65732e20446973636f7665722c20636f6c6c6563742c20616e6420626174746c6520696e20746865204d797374656e44657820756e69766572736521"));
        0x2::display::add<Mystemon>(&mut v1, 0x1::string::utf8(b"collection_image"), 0x1::string::utf8(b"https://aggregator.mainnet.walrus.mirai.cloud/v1/blobs/ScREaq6fZq71Rbw0ncMYcq-dBoSNhXcAP8I9vkh6zY4"));
        0x2::display::add<Mystemon>(&mut v1, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://teammysten.com"));
        0x2::display::add<Mystemon>(&mut v1, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Team Mysten"));
        0x2::display::add<Mystemon>(&mut v1, 0x1::string::utf8(b"symbol"), 0x1::string::utf8(b"MYSTM"));
