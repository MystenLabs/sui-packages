module 0x45d951fd73fb1f1c11be5f073c76658ac2f006a65cfa17d985cef852faf53187::cnsnft2970 {
    struct CNSNFT2970 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2970, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2970>(arg0, arg1);
