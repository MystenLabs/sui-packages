module 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::deposit {
    ...
    public fun deposit<T0, T1, T2>(arg0: &mut 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x1::option::Option<0x2::coin::Coin<T0>>, 0x1::option::Option<0x2::coin::Coin<T1>>) {
        ...
        let (v0, v1) = 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::get_position_tick_range<T0, T1, T2>(arg0);
        let (v2, v3, v4) = 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::utils::check_is_fix_coin_a(v0, v1, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg1), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_sqrt_price<T0, T1>(arg1), 0x2::coin::value<T0>(&arg3), 0x2::coin::value<T1>(&arg4));
        let v5 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::position_borrow<T0, T1, T2>(arg0));
        let v6 = if (v2) {
            v3
        } else {
            v4
        };
        let v7 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg2, arg1, 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::position_borrow_mut<T0, T1, T2>(arg0), v6, v2, arg5);
        let (v8, v9, v10, v11) = take_lp_coins<T0, T1>(&v7, arg3, arg4, arg6);
        let v12 = v9;
        let v13 = v8;
        ...
        let v14 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::position_borrow<T0, T1, T2>(arg0));
        let v15 = 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::mint_vault_coin<T0, T1, T2>(arg0, v14 - v5, v5, arg6);
        emit_event(0x2::object::id<0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::Vault<T0, T1, T2>>(arg0), v5, v14, 0x2::coin::value<T2>(&v15), 0x2::coin::value<T0>(&v13), 0x2::coin::value<T1>(&v12));
        (v15, v10, v11)
    }
