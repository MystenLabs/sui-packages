module 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault {
    ...
    public fun new<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<VaultCap>(v1, 0x2::tx_context::sender(arg8));
    }
    ...
    public(friend) fun burn_vault_cap(arg0: VaultCap) {
        let VaultCap {
            id       : v0,
            vault_id : _,
        } = arg0;
    ...
    public fun compare_amounts(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : bool {
        let v0 = 1000000;
        (arg0 as u128) * (v0 as u128) / (arg1 as u128) > (arg2 as u128) * (v0 as u128) / (arg3 as u128)
    }
