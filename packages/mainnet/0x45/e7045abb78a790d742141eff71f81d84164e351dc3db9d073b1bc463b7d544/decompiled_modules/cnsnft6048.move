module 0x45e7045abb78a790d742141eff71f81d84164e351dc3db9d073b1bc463b7d544::cnsnft6048 {
    struct CNSNFT6048 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6048, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6048>(arg0, arg1);
