module 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::liquidity_mining {
    ...
    struct PoolReward has store, key {
        ...
        end_time_ms: u64,
        total_rewards: u64,
        allocated_rewards: 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::Decimal,
        cumulative_rewards_per_share: 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::Decimal,
    ...
    struct UserReward has store {
        ...
        earned_rewards: 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::Decimal,
        cumulative_rewards_per_share: 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::Decimal,
    }
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = PoolReward{
            ...
            allocated_rewards            : 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(0),
            cumulative_rewards_per_share : 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(0),
    ...
    public(friend) fun cancel_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::split<T0>(0x2::bag::borrow_mut<RewardBalance<T0>, 0x2::balance::Balance<T0>>(&mut v0.additional_fields, v1), 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::floor(0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::sub(0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(v0.total_rewards), v0.allocated_rewards)))
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        let v3 = 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::floor(v2.earned_rewards);
        v2.earned_rewards = 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::sub(v2.earned_rewards, 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(v3));
    ...
    fun update_pool_reward_manager(arg0: &mut PoolRewardManager, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<PoolReward>>(&arg0.pool_rewards)) {
            ...
            let v4 = 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::div(0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::mul(0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(v3.total_rewards), 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(0x1::u64::min(v0, v3.end_time_ms) - 0x1::u64::max(v3.start_time_ms, arg0.last_update_time_ms))), 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(v3.end_time_ms - v3.start_time_ms));
            v3.allocated_rewards = 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::add(v3.allocated_rewards, v4);
            v3.cumulative_rewards_per_share = 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::add(v3.cumulative_rewards_per_share, 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::div(v4, 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(arg0.total_shares)));
            v1 = v1 + 1;
        };
        arg0.last_update_time_ms = v0;
    }
            ...
            if (0x1::option::is_none<UserReward>(v4)) {
                if (arg1.last_update_time_ms <= v3.end_time_ms) {
                    let v5 = if (arg1.last_update_time_ms <= v3.start_time_ms) {
                        0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::mul(v3.cumulative_rewards_per_share, 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(arg1.share))
                    } else {
                ...
                v7.earned_rewards = 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::add(v7.earned_rewards, 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::mul(0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::sub(v3.cumulative_rewards_per_share, v7.cumulative_rewards_per_share), 0x45b067d099dd088cf90b360dc27da0628485c8abddc177fa0f229371933bce83::decimal::from(arg1.share)));
