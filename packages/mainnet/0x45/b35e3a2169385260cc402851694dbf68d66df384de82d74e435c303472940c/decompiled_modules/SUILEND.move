module 0x45b35e3a2169385260cc402851694dbf68d66df384de82d74e435c303472940c::SUILEND {
    ...
    public entry fun RewardVoucher(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUILEND_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/suilend_0702/suilend_0702_2.jpg"),
    ...
    fun init(arg0: SUILEND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/suilend_0702/suilend_0702_2.jpg"));
