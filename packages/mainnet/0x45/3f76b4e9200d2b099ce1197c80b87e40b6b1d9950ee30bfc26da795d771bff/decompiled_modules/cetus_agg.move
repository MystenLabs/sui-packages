module 0x453f76b4e9200d2b099ce1197c80b87e40b6b1d9950ee30bfc26da795d771bff::cetus_agg {
    struct CetusAgg has drop {
        dummy_field: bool,
    }

    public fun swap<T0, T1>(arg0: &0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::router::Router, arg1: &mut 0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::SwapContext, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool, arg5: u64, arg6: &0x2::clock::Clock) {
        let (v0, v1) = if (arg4) {
            let v2 = CetusAgg{dummy_field: false};
            swap_a2b<T0, T1>(arg2, arg3, 0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::take_balance<CetusAgg, T0>(arg1, arg0, v2, arg5), arg6)
        } else {
            let v3 = CetusAgg{dummy_field: false};
            swap_b2a<T0, T1>(arg2, arg3, 0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::take_balance<CetusAgg, T1>(arg1, arg0, v3, arg5), arg6)
        };
        let v4 = v1;
        let v5 = v0;
    ...
    public fun flash_swap_fixed_output<T0, T1>(arg0: &mut 0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::SwapContext, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock) : (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T0, T1>, u64) {
        ...
        if (0x2::balance::value<T0>(&v6) > 0) {
            0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::put_balance<T0>(arg0, v6);
        } else {
            0x2::balance::destroy_zero<T0>(v6);
        };
        if (0x2::balance::value<T1>(&v5) > 0) {
            0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::put_balance<T1>(arg0, v5);
        } else {
    ...
    public fun repay_flash_swap_fixed_output<T0, T1>(arg0: &0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::router::Router, arg1: &mut 0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::SwapContext, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool, arg5: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T0, T1>) {
        let (v0, v1) = if (arg4) {
            let v2 = CetusAgg{dummy_field: false};
            (0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::take_balance<CetusAgg, T0>(arg1, arg0, v2, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&arg5)), 0x2::balance::zero<T1>())
        } else {
            let v3 = CetusAgg{dummy_field: false};
            (0x2::balance::zero<T0>(), 0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::take_balance<CetusAgg, T1>(arg1, arg0, v3, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&arg5)))
        };
        let (v4, v5) = repay_flash_swap<T0, T1>(arg2, arg3, arg4, v0, v1, arg5);
        let v6 = v5;
        let v7 = v4;
        if (0x2::balance::value<T0>(&v7) > 0) {
            0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::put_balance<T0>(arg1, v7);
        } else {
            0x2::balance::destroy_zero<T0>(v7);
        };
        if (0x2::balance::value<T1>(&v6) > 0) {
            0xf23575bda553a38973514e828c3d5f735d4628bb2c945336b319344d0092b094::swap::put_balance<T1>(arg1, v6);
        } else {
