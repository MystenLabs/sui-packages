module 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::reward_distribution {
    ...
    struct PauseClaimConfig has key {
        id: 0x2::object::UID,
        pause_claim: bool,
    }

    public entry fun add_breaker_to_acl(arg0: &AdminCap, arg1: &mut ACL, arg2: address) {
        assert!(!0x1::vector::contains<address>(&arg1.breakers, &arg2), 10);
    ...
    public entry fun add_robot_to_acl(arg0: &AdminCap, arg1: &mut ACL, arg2: address) {
        assert!(!0x1::vector::contains<address>(&arg1.robots, &arg2), 10);
    ...
    public entry fun add_user_rewards(arg0: &OperatorCap, arg1: &mut RewardDistributor, arg2: u32, arg3: vector<address>, arg4: vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        add_user_rewards_process(arg1, arg2, arg3, arg4, arg5);
    }

    public(friend) fun add_user_rewards_process(arg0: &mut RewardDistributor, arg1: u32, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<u32, 0x2::table::Table<address, u64>>(&arg0.period_rewards, arg1)) {
            0x2::table::add<u32, 0x2::table::Table<address, u64>>(&mut arg0.period_rewards, arg1, 0x2::table::new<address, u64>(arg4));
        };
        if (!0x2::table::contains<u32, vector<0x1::string::String>>(&arg0.period_vaults, arg1)) {
            0x2::table::add<u32, vector<0x1::string::String>>(&mut arg0.period_vaults, arg1, 0x1::vector::empty<0x1::string::String>());
        };
        if (!0x1::vector::contains<u32>(&arg0.period_keys, &arg1)) {
            0x1::vector::push_back<u32>(&mut arg0.period_keys, arg1);
        };
        if (!0x2::table::contains<u32, u64>(&arg0.period_total_percentages, arg1)) {
            0x2::table::add<u32, u64>(&mut arg0.period_total_percentages, arg1, 0);
        };
        let v1 = 0x2::table::borrow_mut<u32, 0x2::table::Table<address, u64>>(&mut arg0.period_rewards, arg1);
        let v2 = *0x2::table::borrow<u32, u64>(&arg0.period_total_percentages, arg1);
        let v3 = 0;
        while (v3 < v0) {
        ...
        *0x2::table::borrow_mut<u32, u64>(&mut arg0.period_total_percentages, arg1) = v2;
    }
    ...
    fun check_all_coins_claimed(arg0: &vector<0x1::string::String>, arg1: &0x2::table::Table<u32, 0x2::table::Table<address, vector<0x1::string::String>>>, arg2: address, arg3: u32) : bool {
        ...
        0x1::vector::length<0x1::string::String>(arg0) == 0x1::vector::length<0x1::string::String>(0x2::table::borrow<address, vector<0x1::string::String>>(v0, arg2))
    }
    ...
    public fun claim_rewards_coin_v2<T0>(arg0: &mut PauseClaimConfig, arg1: &mut RewardDistributor, arg2: vector<u32>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!arg0.pause_claim, 9);
        ...
        while (v2 < 0x1::vector::length<u32>(&arg2)) {
            ...
            assert!(0x2::table::contains<u32, 0x2::table::Table<address, u64>>(&arg1.period_rewards, v4), 2);
            assert!(0x2::table::contains<u32, vector<0x1::string::String>>(&arg1.period_vaults, v4), 2);
            let v5 = 0x2::table::borrow_mut<u32, 0x2::table::Table<address, u64>>(&mut arg1.period_rewards, v4);
            assert!(0x2::table::contains<address, u64>(v5, v0), 3);
            let v6 = *0x2::table::borrow<address, u64>(v5, v0);
            let v7 = 0x2::table::borrow<u32, vector<0x1::string::String>>(&arg1.period_vaults, v4);
            let v8 = CoinTypeKey<T0>{period: v4};
            let v9 = false;
            if (0x2::table::contains<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&arg1.claimed_rewards, v4)) {
                let v10 = 0x2::table::borrow<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&arg1.claimed_rewards, v4);
            ...
            let v11 = if (!v9) {
                if (0x1::vector::contains<0x1::string::String>(v7, &v1)) {
                    0x2::dynamic_field::exists_with_type<CoinTypeKey<T0>, CoinVault<T0>>(&arg1.id, v8)
                } else {
                    false
                }
            } else {
            ...
            if (v11) {
                let v12 = 0x2::dynamic_field::borrow_mut<CoinTypeKey<T0>, CoinVault<T0>>(&mut arg1.id, v8);
                let v13 = if (v4 <= 2) {
                    1000000
                } else {
                    1000000000
                };
                let v14 = (((v12.total_rewards as u128) * (v6 as u128) / (v13 as u128)) as u64);
                let v15 = v14;
                if (v14 > 0) {
                    if (v14 >= 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::vault_amount<T0>(&v12.vault)) {
                        v15 = 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::vault_amount<T0>(&v12.vault);
                    };
                    v12.distributed_rewards = v12.distributed_rewards + v15;
                    0x2::balance::join<T0>(&mut v3, 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::withdraw<T0>(&mut v12.vault, v15));
                    let v16 = RewardClaimed{
                        user      : v0,
                        period    : v4,
                        coin_type : v1,
                        amount    : v15,
                    };
                    0x2::event::emit<RewardClaimed>(v16);
                    if (!0x2::table::contains<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&arg1.claimed_rewards, v4)) {
                        0x2::table::add<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&mut arg1.claimed_rewards, v4, 0x2::table::new<address, vector<0x1::string::String>>(arg3));
                    };
                    let v17 = 0x2::table::borrow_mut<u32, 0x2::table::Table<address, vector<0x1::string::String>>>(&mut arg1.claimed_rewards, v4);
                    if (!0x2::table::contains<address, vector<0x1::string::String>>(v17, v0)) {
                        0x2::table::add<address, vector<0x1::string::String>>(v17, v0, 0x1::vector::singleton<0x1::string::String>(v1));
                    } else {
                        0x1::vector::push_back<0x1::string::String>(0x2::table::borrow_mut<address, vector<0x1::string::String>>(v17, v0), v1);
                    };
                };
            };
            if (check_all_coins_claimed(v7, &arg1.claimed_rewards, v0, v4)) {
    ...
    public entry fun claim_rewards_v2<T0>(arg0: &mut PauseClaimConfig, arg1: &mut RewardDistributor, arg2: vector<u32>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(claim_rewards_coin_v2<T0>(arg0, arg1, arg2, arg3), v0);
    }
    ...
    public entry fun deposit_reward<T0>(arg0: &OperatorCap, arg1: &mut RewardDistributor, arg2: u32, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        deposit_reward_process<T0>(arg1, arg2, arg3, arg4);
    }

    public(friend) fun deposit_reward_process<T0>(arg0: &mut RewardDistributor, arg1: u32, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = get_coin_type_name<T0>();
        let v1 = 0x2::coin::value<T0>(&arg2);
        if (!0x2::table::contains<u32, vector<0x1::string::String>>(&arg0.period_vaults, arg1)) {
            0x2::table::add<u32, vector<0x1::string::String>>(&mut arg0.period_vaults, arg1, 0x1::vector::empty<0x1::string::String>());
        };
        let v2 = 0x2::table::borrow_mut<u32, vector<0x1::string::String>>(&mut arg0.period_vaults, arg1);
        if (!0x1::vector::contains<0x1::string::String>(&arg0.supported_coin_types, &v0)) {
            0x1::vector::push_back<0x1::string::String>(&mut arg0.supported_coin_types, v0);
        };
        if (!0x1::vector::contains<u32>(&arg0.period_keys, &arg1)) {
            0x1::vector::push_back<u32>(&mut arg0.period_keys, arg1);
        };
        let v3 = CoinTypeKey<T0>{period: arg1};
        if (!0x1::vector::contains<0x1::string::String>(v2, &v0)) {
            let v4 = 0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::new<T0>(arg3);
            0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::deposit<T0>(&mut v4, 0x2::coin::into_balance<T0>(arg2));
            let v5 = CoinVault<T0>{
                coin_type           : v0,
                vault               : v4,
                total_rewards       : v1,
            ...
            0x2::dynamic_field::add<CoinTypeKey<T0>, CoinVault<T0>>(&mut arg0.id, v3, v5);
            0x1::vector::push_back<0x1::string::String>(v2, v0);
        } else {
            let v6 = 0x2::dynamic_field::borrow_mut<CoinTypeKey<T0>, CoinVault<T0>>(&mut arg0.id, v3);
            0xa566a1422c0529700a27e7d5e800d52d6b9ade2a57790f20ac0842a39cb02ce8::vault::deposit<T0>(&mut v6.vault, 0x2::coin::into_balance<T0>(arg2));
            ...
            if (0x2::table::contains<u32, 0x2::table::Table<address, u64>>(&arg0.period_rewards, v3)) {
                if (0x2::table::contains<address, u64>(0x2::table::borrow<u32, 0x2::table::Table<address, u64>>(&arg0.period_rewards, v3), arg1)) {
                    if (0x2::table::contains<u32, vector<0x1::string::String>>(&arg0.period_vaults, v3)) {
                        if (!check_all_coins_claimed(0x2::table::borrow<u32, vector<0x1::string::String>>(&arg0.period_vaults, v3), &arg0.claimed_rewards, arg1, v3)) {
    ...
    public entry fun init_pause_reward(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = PauseClaimConfig{
            id          : 0x2::object::new(arg1),
            pause_claim : false,
        };
        0x2::transfer::share_object<PauseClaimConfig>(v0);
    }
    ...
    public(friend) fun pause_claim(arg0: &mut PauseClaimConfig, arg1: bool) {
        arg0.pause_claim = arg1;
    }
