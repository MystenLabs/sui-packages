module 0x45ae75196c7f72cd0c0b713955f5a3a632e10c043624ddc96e0dfca18e673db6::pawtato_heroes {
    ...
    fun init(arg0: PAWTATO_HEROES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pawtato Heroes"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A unique NFT collection featuring the brave and cheerful heroes of Pawtato Land. Each character has their own story, bringing joy and value to your digital journey"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeicvwn6wrbfmi6d3i7eblhzdlrzo7ws5c6gibu6fwjqjamrscn3mdi"));
