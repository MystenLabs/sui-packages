module 0x458446d261dff12681934d1a0f890fc341a522794007400279cce10ec16002e3::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 6, b"JAMIE_JAN_FAUCET", b"JAMIE_JAN_FAUCET", b"JAMIE_JAN Faucet Coin", 0x1::option::none<0x2::url::Url>(), arg1);
