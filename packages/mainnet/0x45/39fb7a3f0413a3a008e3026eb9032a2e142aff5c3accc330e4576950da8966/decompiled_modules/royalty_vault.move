module 0x4539fb7a3f0413a3a008e3026eb9032a2e142aff5c3accc330e4576950da8966::royalty_vault {
    ...
    entry fun create<T0, T1>(arg0: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg1: &0x2::transfer_policy::TransferPolicyCap<T0>) {
        assert!(is_supported_collection<T0>(), 1);
    ...
    fun is_supported_collection<T0>() : bool {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
