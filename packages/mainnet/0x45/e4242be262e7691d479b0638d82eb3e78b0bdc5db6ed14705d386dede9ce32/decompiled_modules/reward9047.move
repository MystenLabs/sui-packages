module 0x45e4242be262e7691d479b0638d82eb3e78b0bdc5db6ed14705d386dede9ce32::reward9047 {
    struct REWARD9047 has drop {
        dummy_field: bool,
    }

    struct TICKET_9047 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9047(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9047>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9047>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9047, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9047>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9047>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9047>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9047>>(v5, 0x2::tx_context::sender(arg1));
    }
