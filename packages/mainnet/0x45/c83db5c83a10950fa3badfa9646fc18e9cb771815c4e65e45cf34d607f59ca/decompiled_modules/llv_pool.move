module 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_pool {
    ...
    struct LLVPool<phantom T0, phantom T1> has key {
        ...
        acl: 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::Acl,
    ...
    public(friend) fun accrue_fees<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u128, arg2: u64) : u128 {
        ...
        if (v9) {
            ...
            if (v12 > 0) {
                v3 = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_math::mul_div(v12, arg1, v0);
            };
        };
        let v13 = if (v6 > 0) {
            if (v0 > 0) {
        ...
        if (v17) {
            let v18 = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_math::mul_div(v8.performance_pending_assets, v0, arg1);
            v2 = v18;
            if (v18 > 0) {
                let v19 = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_math::mul_div_ceil(v18, arg1, v0);
                let v20 = v19;
        ...
        if (v21 > 0) {
            0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_fees_accrued(0x2::object::id<LLVPool<T0, T1>>(arg0), v1, v2, v21, arg0.fee_recipient, v7, v3, v4, arg1, v0 + v21, arg2);
        };
        v21
    }
    ...
    public(friend) fun add_keeper<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: address, arg3: &0x2::clock::Clock) {
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_keeper_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, true, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public(friend) fun add_protocol<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: u8, arg3: &0x2::clock::Clock) {
        ...
        assert!(!0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::is_idle_protocol(arg2), 2);
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_update_protocol(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, 0, false, false, 0, 0, 0, 0, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public fun assert_keeper_reward_claim_prologue<T0, T1>(arg0: &0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_admin::LLVGlobal, arg1: &LLVPool<T0, T1>, arg2: address) {
    ...
    public(friend) fun assert_protocol_fresh<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8, arg2: u64) {
        ...
        let v1 = if (!0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::is_idle_protocol(arg1)) {
    ...
    public(friend) fun claim_fee_shares<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: address, arg2: &mut 0x2::tx_context::TxContext, arg3: &0x2::clock::Clock) : (0x2::coin::Coin<T1>, u128) {
        ...
        (0x2::coin::mint<T1>(&mut arg0.share_treasury, (v2 as u64), arg2), 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_math::calculate_assets_for_shares(total_shares<T0, T1>(arg0), get_total_assets<T0, T1>(arg0), v2))
    }
    ...
    public(friend) fun create_pool<T0, T1>(arg0: &0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_admin::LLVGlobalAdminCap, arg1: 0x1::string::String, arg2: address, arg3: 0x2::coin::TreasuryCap<T1>, arg4: u8, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : LLVPool<T0, T1> {
        assert!(arg4 >= 6 && arg4 <= 12, 112);
        assert!(0x2::coin::total_supply<T1>(&arg3) == 0, 113);
        assert!(arg2 != @0x0, 122);
        let v0 = 0x1::vector::empty<u8>();
        0x1::vector::push_back<u8>(&mut v0, 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::PROTOCOL_IDLE());
        let v1 = LLVPool<T0, T1>{
            ...
            acl                         : 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::empty(),
            last_rebalance_ms           : 0,
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::set_role(&mut v1.acl, 0x2::tx_context::sender(arg6), 1);
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_pool_created(0x2::object::id<LLVPool<T0, T1>>(&v1), 0x1::type_name::with_defining_ids<T0>(), 0x2::tx_context::sender(arg6), v1.paused, v1.min_deposit, v1.deposit_cap, v1.performance_fee_bps, v1.management_fee_bps, v1.fee_recipient, v1.min_rebalance_interval_ms, v1.min_rebalance_deviation_bps, 0x2::clock::timestamp_ms(arg5));
        v1
    }
    ...
    public(friend) fun deposit_idle_balance_internal<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        ...
        record_deposit<T0, T1>(arg0, 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::PROTOCOL_IDLE(), (v0 as u128), 0);
        refresh_idle_balance<T0, T1>(arg0);
    }
    ...
    public(friend) fun extract_balance<T0, T1, T2>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u64) : 0x2::balance::Balance<T2> {
        ...
        if (!0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::exists<0x2::balance::Balance<T2>>(v0, arg1)) {
            return 0x2::balance::zero<T2>()
        };
        let v1 = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::borrow_mut<0x2::balance::Balance<T2>>(v0, arg1);
        if (0x2::balance::value<T2>(v1) <= arg2) {
            0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::remove<0x2::balance::Balance<T2>>(v0, arg1)
        } else {
    ...
    public(friend) fun extract_idle_balance<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = borrow_uid_mut<T0, T1>(arg0);
        let v1 = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::PROTOCOL_IDLE();
        if (!0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::exists<0x2::balance::Balance<T0>>(v0, v1)) {
            return 0x2::balance::zero<T0>()
        };
        let v2 = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::borrow_mut<0x2::balance::Balance<T0>>(v0, v1);
    ...
    public fun get_acl_role<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: address) : u64 {
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::role_of(&arg0.acl, arg1)
    }
    ...
    public fun get_keepers<T0, T1>(arg0: &LLVPool<T0, T1>) : vector<address> {
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::members_with_role(&arg0.acl, 2)
    }
    ...
    public fun get_protocol_deposit_cap<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8) : u128 {
        if (0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::is_idle_protocol(arg1)) {
            return 0
        };
        if (!0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg1)) {
            return 0
    ...
    public fun get_required_idle_balance<T0, T1>(arg0: &LLVPool<T0, T1>) : u128 {
        get_total_assets<T0, T1>(arg0) * (get_protocol_ratio<T0, T1>(arg0, 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::PROTOCOL_IDLE()) as u128) / (10000 as u128)
    }
    ...
    fun keeper_count<T0, T1>(arg0: &LLVPool<T0, T1>) : u64 {
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::role_count(&arg0.acl, 2)
    }
    ...
    public fun max_accounted_value_gap_for_input<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u64) : u64 {
        ...
        let v0 = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_math::mul_div_ceil((arg1 as u128), (arg0.max_accounted_value_gap_bps as u128), (10000 as u128));
    ...
    fun pool_admin_count<T0, T1>(arg0: &LLVPool<T0, T1>) : u64 {
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::role_count(&arg0.acl, 1)
    }
    ...
    public fun query_holding_balance<T0, T1, T2>(arg0: &LLVPool<T0, T1>, arg1: u8) : u64 {
        ...
        if (0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::exists<0x2::balance::Balance<T2>>(v0, arg1)) {
            0x2::balance::value<T2>(0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::borrow<0x2::balance::Balance<T2>>(v0, arg1))
        } else {
            0
        }
    }
    ...
    public fun query_idle_holding_balance<T0, T1>(arg0: &LLVPool<T0, T1>) : u64 {
        query_holding_balance<T0, T1, T0>(arg0, 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::PROTOCOL_IDLE())
    }
    ...
    public(friend) fun record_withdraw<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128, arg3: u64) {
        ...
        let v1 = if (v0.deposited_amount >= arg2) {
            ...
            0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_withdraw_saturation(0x2::object::id<LLVPool<T0, T1>>(arg0), arg1, 0, v0.deposited_amount, arg2);
            0
        };
    ...
    public(friend) fun remove_keeper<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: address, arg3: &0x2::clock::Clock) {
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::remove_role(&mut arg0.acl, arg2);
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_keeper_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, false, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    fun set_acl_role_internal<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: address, arg2: u64) {
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_acl::set_role(&mut arg0.acl, arg1, arg2);
    }
    ...
    fun set_protocol_config_internal<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: address, arg2: u8, arg3: ProtocolConfig, arg4: &0x2::clock::Clock) {
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_update_protocol_config(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, v0, arg3.ids, arg3.values, v1, 0x2::clock::timestamp_ms(arg4));
    }

    public(friend) fun set_protocol_deposit_cap<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: u8, arg3: u128) {
        assert_pool_admin<T0, T1>(arg0, 0x2::tx_context::sender(arg1));
        assert!(!0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::is_idle_protocol(arg2), 130);
        assert!(0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 3);
    ...
    public(friend) fun set_protocol_status<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0x2::tx_context::TxContext, arg2: u8, arg3: bool, arg4: bool, arg5: &0x2::clock::Clock) {
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_update_protocol(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, 1, arg3, arg4, v0.target_ratio_bps, v0.deposited_amount, v0.current_balance, v0.last_sync_ms, 0x2::clock::timestamp_ms(arg5));
    }
    ...
    public(friend) fun store_or_join_balance<T0, T1, T2>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: 0x2::balance::Balance<T2>) {
        let v0 = borrow_uid_mut<T0, T1>(arg0);
        if (0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::exists<0x2::balance::Balance<T2>>(v0, arg1)) {
            0x2::balance::join<T2>(0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::borrow_mut<0x2::balance::Balance<T2>>(v0, arg1), arg2);
        } else {
            0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::protocol_holdings::store<0x2::balance::Balance<T2>>(v0, arg1, arg2);
        };
    }

    public(friend) fun store_or_join_idle_balance<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        store_or_join_balance<T0, T1, T0>(arg0, 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::PROTOCOL_IDLE(), arg1);
    }
    ...
    public(friend) fun update_last_total_assets<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u128) {
        ...
        arg0.last_total_assets = 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_math::mul_div_ceil(arg0.last_total_assets, v0, arg1);
    }
    ...
    fun update_protocol_targets_internal<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: vector<u8>, arg2: vector<u64>, arg3: vector<u128>, arg4: vector<bool>, arg5: vector<bool>, arg6: &0x2::clock::Clock) {
        ...
        0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_events::emit_protocol_targets_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg1, arg2, arg3, arg4, arg5, 0x2::clock::timestamp_ms(arg6));
    }
    ...
    fun validate_withdraw_queue_coverage<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: &vector<u8>) {
        ...
        while (v0 < 0x2::vec_map::length<u8, ProtocolAllocation>(&arg0.allocations)) {
            ...
            let v3 = if (!0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::is_idle_protocol(*v1)) {
                if (v2.can_withdraw) {
    ...
    public(friend) fun withdraw_idle_balance_internal<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        record_withdraw<T0, T1>(arg0, 0x7b6199eb8cef4aa121bb94594b599dc311ff7910e5159745e3f34d62f11bb2ed::llv_allocation_plan::PROTOCOL_IDLE(), (arg1 as u128), 0);
        refresh_idle_balance<T0, T1>(arg0);
        v0
    }
