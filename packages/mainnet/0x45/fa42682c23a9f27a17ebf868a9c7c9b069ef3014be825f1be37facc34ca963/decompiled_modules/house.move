module 0x45fa42682c23a9f27a17ebf868a9c7c9b069ef3014be825f1be37facc34ca963::house {
    ...
    public(friend) fun join_with_fee<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>) {
        let v0 = 0x45fa42682c23a9f27a17ebf868a9c7c9b069ef3014be825f1be37facc34ca963::math::mul_rate(0x2::balance::value<T0>(&arg1), 300000);
    ...
    public fun pool_changes(arg0: u64) : (u64, u64) {
        let v0 = 0x45fa42682c23a9f27a17ebf868a9c7c9b069ef3014be825f1be37facc34ca963::math::mul_rate(arg0, 300000);
        (arg0 - v0, v0)
    }
    ...
    public(friend) fun split_with_reimbursement<T0>(arg0: &mut House<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 <= max_risk<T0>(arg0), 0);
        let v0 = 0x45fa42682c23a9f27a17ebf868a9c7c9b069ef3014be825f1be37facc34ca963::math::mul_rate(arg1, 300000);
