module 0x45b443d50597b981b01fe292c705b5e1e31c07735661721e8f85537e92015f4e::suipaynft {
    ...
    struct ContractInfo has key {
        ...
        transferPolicy: 0x2::transfer_policy::TransferPolicy<NFT>,
    }
    ...
    fun init(arg0: SUIPAYNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v25 = v22;
        let v26 = 30;
        0x45b443d50597b981b01fe292c705b5e1e31c07735661721e8f85537e92015f4e::floor_price_rule::add<NFT>(&mut v25, &v24, v26);
    ...
    public entry fun mint(arg0: &mut ContractInfo, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u8, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 != 0, 2);
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut arg1, v0, arg0.owner_address, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, 0x2::tx_context::sender(arg5));
        let v3 = 0x2::tx_context::sender(arg5);
        mintInternal(arg0, arg2, 0, 0x1::string::utf8(b"Supporter"), v3, arg3, arg4, arg5);
    }
    ...
    public entry fun mintDiscount(arg0: &mut ContractInfo, arg1: &Whitelist, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u8, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 != 0, 2);
        0x2::pay::split_and_transfer<0x2::sui::SUI>(&mut arg2, v0, arg0.owner_address, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, 0x2::tx_context::sender(arg6));
        let v5 = 0x2::tx_context::sender(arg6);
        mintInternal(arg0, arg3, 0, arg1.type, v5, arg4, arg5, arg6);
    }

    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        if (arg2 == 0) {
            arg2 = ((0x45b443d50597b981b01fe292c705b5e1e31c07735661721e8f85537e92015f4e::pseudorandom::rand_u32(arg7) % 65535) as u16);
        };
        ...
        if (arg1 == 0) {
            ...
            let v1 = &mut arg0.nfts_minted_tier_0;
            let v2 = gen_next_free(arg2 % 30, v1, 30);
            arg2 = v2;
            v0 = v2;
        } else if (arg1 == 1) {
            assert!(arg0.count_tier_1 < 50, 1);
            arg0.count_tier_1 = arg0.count_tier_1 + 1;
            let v3 = &mut arg0.nfts_minted_tier_1;
            let v4 = gen_next_free(arg2 % 50, v3, 50);
            arg2 = v4;
            v0 = v4 + 30;
        } else if (arg1 == 2) {
            assert!(arg0.count_tier_2 < 100, 1);
            arg0.count_tier_2 = arg0.count_tier_2 + 1;
            let v5 = &mut arg0.nfts_minted_tier_2;
            let v6 = gen_next_free(arg2 % 100, v5, 100);
            arg2 = v6;
            v0 = v6 + 30 + 50;
        } else if (arg1 == 3) {
            assert!(arg0.count_tier_3 < 500, 1);
            arg0.count_tier_3 = arg0.count_tier_3 + 1;
            let v7 = &mut arg0.nfts_minted_tier_3;
            let v8 = gen_next_free(arg2 % 500, v7, 500);
            arg2 = v8;
            v0 = v8 + 30 + 50 + 100;
        } else if (arg1 == 4) {
            assert!(arg0.count_tier_4 < 1500, 1);
            arg0.count_tier_4 = arg0.count_tier_4 + 1;
            let v9 = &mut arg0.nfts_minted_tier_4;
            let v10 = gen_next_free(arg2 % 1500, v9, 1500);
            arg2 = v10;
            v0 = v10 + 30 + 50 + 100 + 500;
        };
        let v11 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        let v12 = 0x1::string::utf8(b"");
        let v13 = get_traits(arg2, arg1, arg0);
        let v14 = 0;
        while (v14 < 0x1::vector::length<Feature>(&v13)) {
            let v15 = 0x1::vector::borrow<Feature>(&v13, v14);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v11, v15.name, v15.trait);
            0x1::string::append(&mut v12, convert_u8(v15.index));
            v14 = v14 + 1;
        };
        let v16 = NFT{
        ...
        let v17 = NFTMinted{
            id        : 0x2::object::id<NFT>(&v16),
            minted_by : arg4,
        };
        0x2::event::emit<NFTMinted>(v17);
        0x2::kiosk::lock<NFT>(arg5, arg6, &arg0.transferPolicy, v16);
    }

    public entry fun mint_team(arg0: &CreatorCap, arg1: &mut ContractInfo, arg2: u16, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        mintInternal(arg1, 0, arg2, 0x1::string::utf8(b"Team"), v0, arg3, arg4, arg5);
    }
