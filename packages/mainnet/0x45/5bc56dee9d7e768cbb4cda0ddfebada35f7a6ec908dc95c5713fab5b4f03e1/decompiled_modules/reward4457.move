module 0x455bc56dee9d7e768cbb4cda0ddfebada35f7a6ec908dc95c5713fab5b4f03e1::reward4457 {
    struct REWARD4457 has drop {
        dummy_field: bool,
    }

    struct TICKET_4457 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4457(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4457>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4457>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4457, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4457>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4457>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4457>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4457>>(v5, 0x2::tx_context::sender(arg1));
    }
