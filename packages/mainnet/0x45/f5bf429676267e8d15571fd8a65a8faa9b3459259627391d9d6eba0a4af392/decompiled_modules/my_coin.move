module 0x45f5bf429676267e8d15571fd8a65a8faa9b3459259627391d9d6eba0a4af392::my_coin {
    struct MY_COIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_COIN>(arg0, 6, b"silver-x", b"my coin", b"a coin by test", 0x1::option::none<0x2::url::Url>(), arg1);
