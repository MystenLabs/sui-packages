module 0x45b800407f8eecf8313212976cf2a3a51a754f047712c61f49b9ddec7d291dd8::reward3915 {
    struct REWARD3915 has drop {
        dummy_field: bool,
    }

    struct TICKET_3915 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3915(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3915>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3915>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3915, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3915>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3915>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3915>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3915>>(v5, 0x2::tx_context::sender(arg1));
    }
