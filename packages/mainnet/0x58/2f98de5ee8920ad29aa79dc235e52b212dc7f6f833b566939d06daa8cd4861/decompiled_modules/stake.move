module 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::stake {
    ...
    struct MigrateNewVersionEvent has copy, drop, store {
        pool_id: address,
        user_address: address,
        timestamp: u64,
        amount_staked: u128,
    ...
    struct MigrateNewVersionEventV2 has copy, drop, store {
        pool_id: address,
        user_address: address,
        package_target: vector<u8>,
        network: vector<u8>,
    ...
    struct StratMigrateEvent has copy, drop, store {
        id: address,
        admin_address: address,
    }

    public fun stake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg3, 1);
    ...
    public fun change_admin(arg0: Admincap, arg1: address, arg2: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg2, 1);
        0x2::transfer::public_transfer<Admincap>(arg0, arg1);
    }

    public entry fun claimRewards<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg2, 1);
        assert!(!arg0.paused, 8008);
    ...
    public entry fun createPool<T0, T1>(arg0: &Admincap, arg1: u64, arg2: u128, arg3: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg3, 1);
        assert!(arg2 > 0, 8001);
    ...
    public entry fun depositRewardCoins<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg3: 0x2::coin::Coin<T1>) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg2, 1);
    ...
    public entry fun migrateNewVersion<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut MigrateInfor, arg4: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg4, 1);
        let v0 = 0x2::clock::timestamp_ms(arg5);
        let v1 = 0x2::tx_context::sender(arg6);
        assert!(0x2::table::contains<address, UserStake>(&mut arg0.stakes, v1), 8003);
        ...
        assert!(v3 > 0 && v3 <= (0x2::coin::value<T0>(&arg0.stake_coins) as u128), 8003);
        v2.spt_staked = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.stake_coins, (v3 as u64), arg6), arg3.admin_address);
        let v4 = v2.reward_remaining;
        assert!(v4 > 0 && v4 <= (0x2::coin::value<T1>(&arg0.reward_coins) as u128), 8003);
        v2.reward_remaining = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg0.reward_coins, (v4 as u64), arg6), v1);
        let v5 = MigrateNewVersionEvent{
            pool_id                   : 0x2::object::uid_to_address(&arg0.id),
            user_address              : v1,
            timestamp                 : v0,
            amount_staked             : v3,
        ...
        0x2::event::emit<MigrateNewVersionEvent>(v5);
    }

    public entry fun migrateNewVersionV2<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut MigrateInfor, arg4: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg5: u128, arg6: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg4, 1);
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::table::contains<address, UserStake>(&mut arg0.stakes, v0), 8003);
        let v1 = 0x2::table::borrow_mut<address, UserStake>(&mut arg0.stakes, v0);
        let v2 = v1.spt_staked;
        assert!(arg5 >= 500000000000, 8009);
        assert!(arg5 <= v2, 8003);
        assert!(v2 <= (0x2::coin::value<T0>(&arg0.stake_coins) as u128), 8003);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.stake_coins, (arg5 as u64), arg6), arg3.admin_address);
        v1.spt_staked = v1.spt_staked - arg5;
        let v3 = MigrateNewVersionEventV2{
            pool_id                   : 0x2::object::uid_to_address(&arg0.id),
            user_address              : v0,
            package_target            : arg1,
            network                   : arg2,
        ...
        0x2::event::emit<MigrateNewVersionEventV2>(v3);
    }
    ...
    public fun set_treasury_admin_address<T0, T1>(arg0: &Admincap, arg1: &mut MigrateInfor, arg2: address, arg3: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg3, 1);
        arg1.admin_address = arg2;
    }

    public entry fun stakeRewards<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg2, 1);
        assert!(!arg0.paused, 8008);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<address, UserStake>(&mut arg0.stakes, v0), 8003);
    ...
    public fun start_migrate<T0, T1>(arg0: &Admincap, arg1: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg1, 1);
        let v0 = MigrateInfor{
            id            : 0x2::object::new(arg2),
            admin_address : @0x25627af75dbe256c26346a6803ea569786d096719b7be9731471f34bdca1c008,
        };
        let v1 = StratMigrateEvent{
            id            : 0x2::object::id_address<MigrateInfor>(&v0),
            admin_address : @0x25627af75dbe256c26346a6803ea569786d096719b7be9731471f34bdca1c008,
        };
        0x2::event::emit<StratMigrateEvent>(v1);
        0x2::transfer::share_object<MigrateInfor>(v0);
    }

    public entry fun stopEmergency<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg5, 1);
        let v0 = 0;
    ...
    public fun unstake<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: u128, arg2: &0x2::clock::Clock, arg3: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg3, 1);
        assert!(!arg0.paused, 8008);
    ...
    public entry fun updateApy<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u128, arg4: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg5: &0x2::clock::Clock) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg4, 1);
        assert!(arg3 > 0, 8001);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
    ...
    public entry fun updateApyV2<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: vector<address>, arg3: u128, arg4: u128, arg5: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg6: &0x2::clock::Clock) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg5, 1);
        assert!(arg3 > 0, 8001);
        arg1.apy = arg3;
        let v0 = 0;
    ...
    public entry fun updateUnlockTime<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: u64, arg3: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg3, 1);
        assert!(arg2 > 0, 8001);
    ...
    public entry fun withdrawRewardCoins<T0, T1>(arg0: &Admincap, arg1: &mut StakePool<T0, T1>, arg2: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg2, 1);
    ...
    public entry fun withdrawSpt<T0, T1>(arg0: &mut StakePool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x9c5b0ad01821f479aa8582d82d50b23a0d580f83ec0541722da8e3f626f946f6::version::checkVersion(arg2, 1);
        assert!(!arg0.paused, 8008);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<address, UserStake>(&mut arg0.stakes, v0), 8003);
