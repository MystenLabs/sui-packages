module 0x589523c4beac27a3144b3d7289cf29b9b81b84e66a336996a14be008b0215881::reward7190 {
    struct REWARD7190 has drop {
        dummy_field: bool,
    }

    struct TICKET_7190 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7190(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7190>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7190>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7190, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7190>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7190>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7190>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7190>>(v5, 0x2::tx_context::sender(arg1));
    }
