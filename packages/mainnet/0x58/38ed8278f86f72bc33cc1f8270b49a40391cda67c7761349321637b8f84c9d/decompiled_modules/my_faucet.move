module 0x5838ed8278f86f72bc33cc1f8270b49a40391cda67c7761349321637b8f84c9d::my_faucet {
    ...
    fun init(arg0: MY_FAUCET, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_FAUCET>(arg0, 6, b"MY FAUCET", b"MY FAUCET", b"MY FAUCET", 0x1::option::none<0x2::url::Url>(), arg1);
