module 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honeyjar {
    ...
    struct MarketplaceChef has key {
        ...
        claim_locked: bool,
        activity_incentives_cap: 0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey_yield::ClaimHoneyCap,
        activity_rewards: 0x2::balance::Balance<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>,
        last_claim_ts: u64,
        global_claim_index: u256,
        total_distributed: u64,
        active_points: u64,
        trading_incentives_cap: 0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey_yield::ClaimHoneyCap,
        trading_rewards: 0x2::balance::Balance<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>,
        cur_cycle: u64,
    ...
    struct HoneyJar has key {
        ...
        claimable_amm_rewards: 0x2::balance::Balance<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>,
        bag: 0x2::bag::Bag,
        version: u64,
    }
    ...
    public fun claim_honey(arg0: &0x2::clock::Clock, arg1: &mut MarketplaceChef, arg2: &mut 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::HoneyManager, arg3: &mut HoneyJar, arg4: &mut 0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey_yield::HoneyYield, arg5: &mut 0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey_yield::FeeCollector<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>, arg6: &mut 0x2::token::TokenPolicy<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = if (arg3.claimable_rewards > 0) {
            ...
            0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&arg3.claimable_amm_rewards) > 0
        };
        if (v0) {
            let v1 = 0x2::balance::split<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut arg1.activity_rewards, arg3.claimable_rewards);
            0x2::balance::join<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut v1, 0x2::balance::split<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut arg1.trading_rewards, arg3.claimable_trading_rewards));
            0x2::balance::join<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut v1, 0x2::balance::withdraw_all<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut arg3.claimable_amm_rewards));
            0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::token_rules::from_coin_and_transfer<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(0x2::coin::from_balance<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(v1, arg7), arg5, arg4, arg6, 0x2::tx_context::sender(arg7), arg7);
            ...
            let v2 = HoneyJarHoneyClaimed{
                ...
                claimed_amm_rewards      : 0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&arg3.claimable_amm_rewards),
    ...
    public fun add_to_honeyjar(arg0: &HoneyJarPointsCap, arg1: &0x2::clock::Clock, arg2: &mut MarketplaceChef, arg3: &mut 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::HoneyManager, arg4: &mut HoneyJar, arg5: u64) {
    ...
    public fun add_trade_points_to_honeyjar(arg0: &HoneyJarPointsCap, arg1: &0x2::clock::Clock, arg2: &mut MarketplaceChef, arg3: &mut 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::HoneyManager, arg4: &mut HoneyJar, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        validation_check(arg2);
        box_validation_check(arg4);
    ...
    public fun amm_add_claimable_rewards(arg0: &mut HoneyJar, arg1: 0x2::balance::Balance<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>) {
        0x2::balance::join<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut arg0.claimable_amm_rewards, arg1);
    }
    ...
    public fun claim_sui_collected(arg0: &mut MarketplaceChef, arg1: &HoneyJarFeeClaimCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.balance), arg2, arg3);
    }
    ...
    public fun get_claimable_amm_rewards(arg0: &HoneyJar) : u64 {
        0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&arg0.claimable_amm_rewards)
    }
    ...
    fun increment_global_index(arg0: &0x2::clock::Clock, arg1: &mut 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::HoneyManager, arg2: &mut MarketplaceChef) {
        if (arg2.active_points == 0) {
            return
        };
        let v0 = 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::claim_honey(&mut arg2.activity_incentives_cap, arg1, arg0);
        let v1 = 0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&v0);
        arg2.global_claim_index = arg2.global_claim_index + 0x2f7d1c63b46fbd1f36c7a633533402a0a3c40de704ad03097f47b05274fecc86::math::mul_div_u256((v1 as u256), (1000000000000 as u256), (arg2.active_points as u256));
        arg2.last_claim_ts = 0x2::clock::timestamp_ms(arg0);
        arg2.total_distributed = arg2.total_distributed + v1;
        0x2::balance::join<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut arg2.activity_rewards, v0);
    }

    fun increment_honeyjar_rewards(arg0: &0x2::clock::Clock, arg1: &mut 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::HoneyManager, arg2: &mut MarketplaceChef, arg3: &mut HoneyJar) {
        increment_global_index(arg0, arg1, arg2);
        arg3.claimable_rewards = arg3.claimable_rewards + (0x2f7d1c63b46fbd1f36c7a633533402a0a3c40de704ad03097f47b05274fecc86::math::mul_div_u256(arg2.global_claim_index - arg3.claim_index, (arg3.active_points as u256), (1000000000000 as u256)) as u64);
        arg3.claim_index = arg2.global_claim_index;
    }

    fun increment_honeyjar_trading_rewards(arg0: &0x2::clock::Clock, arg1: &mut 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::HoneyManager, arg2: &mut MarketplaceChef, arg3: &mut HoneyJar, arg4: &0x2::tx_context::TxContext) {
        ...
        let v5 = 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::claim_honey(&mut arg2.trading_incentives_cap, arg1, arg0);
        arg2.cur_cycle_rewards = arg2.cur_cycle_rewards + 0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&v5);
        0x2::balance::join<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&mut arg2.trading_rewards, v5);
        if (arg3.cur_cycle != arg2.cur_cycle) {
            if (0x2::linked_table::contains<u64, CycleInfo>(&arg2.cycle_info, arg3.cur_cycle)) {
                ...
                if (v6.total_points > 0 && arg3.cur_cycle_points > 0) {
                    let v7 = (0x2f7d1c63b46fbd1f36c7a633533402a0a3c40de704ad03097f47b05274fecc86::math::mul_div_u128((arg3.cur_cycle_points as u128), (v6.honey_rewards as u128), (v6.total_points as u128)) as u64);
    ...
    fun init(arg0: HONEYJAR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<HoneyJar>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://d13jtsearj5tgw.cloudfront.net/assets/HoneyJar.png"));
    ...
    public fun init_marketplace_chef(arg0: &mut HoneyJarAdminCap, arg1: 0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey_yield::ClaimHoneyCap, arg2: 0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey_yield::ClaimHoneyCap, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = MarketplaceChef{
            ...
            activity_rewards        : 0x2::balance::zero<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(),
            last_claim_ts           : 0x2::clock::timestamp_ms(arg3),
            global_claim_index      : 0,
            total_distributed       : 0,
            active_points           : 0,
            trading_incentives_cap  : arg2,
            trading_rewards         : 0x2::balance::zero<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(),
    ...
    public fun mint_honeyjar(arg0: &0x2::clock::Clock, arg1: &mut MarketplaceChef, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg3), arg3);
        let v2 = HoneyJar{
            ...
            claimable_amm_rewards     : 0x2::balance::zero<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(),
    ...
    public fun query_activity_rewards_state(arg0: &MarketplaceChef) : (u256, u64, u64, u64) {
        (arg0.global_claim_index, arg0.total_distributed, arg0.active_points, 0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&arg0.activity_rewards))
    }
    ...
    public fun query_nft_trading_cycle_state(arg0: &MarketplaceChef) : (u64, u64, u64, u64, u64) {
        (arg0.cur_cycle, arg0.cycle_duration, arg0.cur_cycle_points, arg0.cur_cycle_rewards, 0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&arg0.trading_rewards))
    }
    ...
    public fun query_user_all_rewards(arg0: &HoneyJar) : (u64, u64, u64, u64, u64, u64, u64) {
        (arg0.active_points, arg0.claimable_rewards, arg0.cur_cycle, arg0.cur_cycle_points, arg0.claimable_trading_rewards, 0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&arg0.claimable_amm_rewards), arg0.total_claimed_rewards)
    }
    ...
    public fun query_user_nft_trading_claimable_for_cycle(arg0: &MarketplaceChef, arg1: &HoneyJar, arg2: u64) : u64 {
        ...
        (0x2f7d1c63b46fbd1f36c7a633533402a0a3c40de704ad03097f47b05274fecc86::math::mul_div_u128((arg1.cur_cycle_points as u128), (v0.honey_rewards as u128), (v0.total_points as u128)) as u64)
    }
    ...
    public fun query_user_pending_activity_rewards(arg0: &MarketplaceChef, arg1: &HoneyJar) : u64 {
        ...
        (0x2f7d1c63b46fbd1f36c7a633533402a0a3c40de704ad03097f47b05274fecc86::math::mul_div_u256((arg1.active_points as u256), v0, 1000000000000) as u64)
    }

    public fun query_user_total_claimable(arg0: &HoneyJar) : u64 {
        arg0.claimable_rewards + arg0.claimable_trading_rewards + 0x2::balance::value<0xc5678bddaf27d430ebeab9c1e7b8544e1cee3b966143cdce81de96cd7f2ee231::honey::HONEY>(&arg0.claimable_amm_rewards)
    }

    public fun remove_from_honeyjar(arg0: &HoneyJarPointsCap, arg1: &0x2::clock::Clock, arg2: &mut MarketplaceChef, arg3: &mut 0x586408bc4f3272b0ba66a723ab00ff86fc7e5f833a3ba4176a546a3e2adb4d22::honey_manager::HoneyManager, arg4: &mut HoneyJar, arg5: u64) {
        validation_check(arg2);
        box_validation_check(arg4);
        increment_honeyjar_rewards(arg1, arg3, arg2, arg4);
        arg2.active_points = arg2.active_points - arg5;
