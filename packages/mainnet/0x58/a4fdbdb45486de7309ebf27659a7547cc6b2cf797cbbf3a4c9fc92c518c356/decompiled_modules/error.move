module 0x58a4fdbdb45486de7309ebf27659a7547cc6b2cf797cbbf3a4c9fc92c518c356::error {
    public fun apm_triggered_error() : u64 {
        4098
    }
    ...
    public fun market_coin_price_cannot_decrease_error() : u64 {
        90113
    }
    ...
    public fun min_collateral_amount_error() : u64 {
        81926
    }
    ...
    public fun unauthorize_pause_error() : u64 {
        2308
    }
