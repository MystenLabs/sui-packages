module 0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::cetus {
    ...
    public fun cetus_swap_a_b_buy<T0, T1>(arg0: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::KongBot<T0>, arg1: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::Banana<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T0>(v8, arg7);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T1>(v9, arg7);
        0x2::coin::destroy_zero<T0>(v3);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T1>(v4, arg7);
    }

    public fun cetus_swap_a_b_sell<T0, T1>(arg0: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::KongBot<T1>, arg1: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::Banana<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg5);
        let (v1, v2, v3, v4) = flash_swap<T0, T1>(arg2, arg3, true, v0, arg4, 4295048016, arg6, arg7);
        assert!(v4 == v0, 0);
        let (_, v6) = 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::transfer_bananas<T1>(arg0, arg1, v2, arg7);
        let v7 = 0x2::coin::zero<T1>(arg7);
        let (v8, v9) = repay_flash_swap<T0, T1>(arg2, arg3, true, arg5, v7, v3, arg7);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T0>(v8, arg7);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T1>(v9, arg7);
        0x2::coin::destroy_zero<T0>(v1);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T1>(v6, arg7);
    }

    public fun cetus_swap_b_a_buy<T0, T1>(arg0: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::KongBot<T1>, arg1: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::Banana<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::transfer_bananas<T1>(arg0, arg1, arg5, arg7);
        let v2 = v1;
    ...
    public fun cetus_swap_b_a_sell<T0, T1>(arg0: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::KongBot<T0>, arg1: &mut 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::Banana<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v4 == v0, 0);
        let (_, v6) = 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot::transfer_bananas<T0>(arg0, arg1, v1, arg7);
        let v7 = 0x2::coin::zero<T0>(arg7);
        let (v8, v9) = repay_flash_swap<T0, T1>(arg2, arg3, false, v7, arg5, v3, arg7);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T0>(v8, arg7);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T1>(v9, arg7);
        0x2::coin::destroy_zero<T1>(v2);
        0x5896f235f86d4a34e97bf6631e5f0ad641fbd991fb96feeff47e34b4bd800e7d::utils::transfer_or_destroy_coin<T0>(v6, arg7);
    }
