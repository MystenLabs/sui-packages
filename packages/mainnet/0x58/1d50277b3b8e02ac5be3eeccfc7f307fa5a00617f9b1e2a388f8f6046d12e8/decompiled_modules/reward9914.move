module 0x581d50277b3b8e02ac5be3eeccfc7f307fa5a00617f9b1e2a388f8f6046d12e8::reward9914 {
    struct REWARD9914 has drop {
        dummy_field: bool,
    }

    struct TICKET_9914 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9914(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9914>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9914>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9914, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9914>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9914>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9914>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9914>>(v5, 0x2::tx_context::sender(arg1));
    }
