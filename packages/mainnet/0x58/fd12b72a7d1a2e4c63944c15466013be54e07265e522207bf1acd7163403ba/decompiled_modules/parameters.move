module 0x58fd12b72a7d1a2e4c63944c15466013be54e07265e522207bf1acd7163403ba::parameters {
    ...
    public fun check_sender(arg0: &Parameters, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834758458933247);
    }
    ...
    public fun production_stonker_parameters(arg0: &mut 0x2::tx_context::TxContext) : Parameters {
        ...
        let v1 = SwapParameters{
            enabled                : false,
            threshold_bps_times_1k : 300,
            minimum_start_quantity : 300 * 1000000000,
            step_start_quantity    : 100 * 1000000000,
            minimum_portfolio      : 30000 * 1000000,
        };
        Parameters{
    ...
    public fun set_swap_minimum_portfolio(arg0: &mut Parameters, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        check_sender(arg0, arg2);
        arg0.swap_parameters.minimum_portfolio = arg1;
    }
    ...
    public fun staging_stonker_parameters(arg0: &mut 0x2::tx_context::TxContext) : Parameters {
        ...
        v0.swap_parameters.minimum_portfolio = 0;
    ...
    public fun swap_minimum_portfolio(arg0: &Parameters) : u64 {
        arg0.swap_parameters.minimum_portfolio
    }
