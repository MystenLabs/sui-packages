module 0x58a0bd7b9fcce3273c6157fb4c0e2cd0ca2446e5ee4bcdc92ffa96e90f1563fc::cnsnft9605 {
    struct CNSNFT9605 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9605, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9605>(arg0, arg1);
