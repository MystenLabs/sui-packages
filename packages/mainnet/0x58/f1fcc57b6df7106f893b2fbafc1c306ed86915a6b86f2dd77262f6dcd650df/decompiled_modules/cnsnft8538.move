module 0x58f1fcc57b6df7106f893b2fbafc1c306ed86915a6b86f2dd77262f6dcd650df::cnsnft8538 {
    struct CNSNFT8538 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8538, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8538>(arg0, arg1);
