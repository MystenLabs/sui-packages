module 0x58e64785e78fd06b7ef5a21adf822a380cf87c9af3c582c43f6ebeb46223c776::config {
    ...
    public(friend) fun assert_global_close_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_close_pause, 0x58e64785e78fd06b7ef5a21adf822a380cf87c9af3c582c43f6ebeb46223c776::errors::err_global_close_paused());
    }

    public(friend) fun assert_global_open_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_open_pause, 0x58e64785e78fd06b7ef5a21adf822a380cf87c9af3c582c43f6ebeb46223c776::errors::err_global_open_paused());
    }

    public(friend) fun assert_package_version(arg0: &GlobalConfig) {
        assert!(check_package_version(arg0), 0x58e64785e78fd06b7ef5a21adf822a380cf87c9af3c582c43f6ebeb46223c776::errors::err_wrong_version());
    }
