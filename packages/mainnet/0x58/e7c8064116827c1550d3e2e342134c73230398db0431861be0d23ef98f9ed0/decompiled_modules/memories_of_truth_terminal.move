module 0x58e7c8064116827c1550d3e2e342134c73230398db0431861be0d23ef98f9ed0::memories_of_truth_terminal {
    struct MEMORIES_OF_TRUTH_TERMINAL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MEMORIES_OF_TRUTH_TERMINAL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MEMORIES_OF_TRUTH_TERMINAL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Memories of Truth Terminal"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Images of expressions from Truth Terminal regarding Meme Magick."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://a32R9hq0G9FNJz47dw6hn6ADTtn0jxUSP5bBCz9Q3js"));
