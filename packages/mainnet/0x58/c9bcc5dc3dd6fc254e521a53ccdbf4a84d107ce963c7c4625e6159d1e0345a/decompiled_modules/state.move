module 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::state {
    ...
    public fun destroy_rebalance_receipt(arg0: RebalanceReceipt, arg1: &0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::registry::ProxyCap) : (0x2::object::ID, u64, u64, u128, u128) {
    ...
    public fun new_rebalance_receipt(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u128, arg4: u128, arg5: &0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::registry::ProxyCap) : RebalanceReceipt {
        RebalanceReceipt{
            position_id   : arg0,
            amount_x      : arg1,
            amount_y      : arg2,
    ...
    public fun solve_one_for_zero(arg0: &SwapState) : u128 {
        let v0 = 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::constants::scaling_pips_u256() - arg0.fee_pips;
        let v1 = arg0.liquidity << 64;
        let v2 = arg0.amount_x_desired + v1 / arg0.sqrt_price;
        let v3 = 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_price * 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::constants::scaling_pips_u256() / v0);
        let v4 = arg0.amount_y_desired + v3 - 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_ratio_lower);
        assert!(v4 > arg0.amount_y_desired, 0);
        0x1::u128::max(cal_sqrt_price(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(u256_to_i128(v2), u256_to_i128(v1 * 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::constants::scaling_pips_u256() / v0 * arg0.sqrt_ratio_upper)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(u256_to_i128(0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::safe_math::mul_div_Q64(v2, arg0.sqrt_ratio_lower)), u256_to_i128(arg0.fee_pips * arg0.liquidity / v0)), u256_to_i128((arg0.amount_y_desired + v3 << 64) / arg0.sqrt_ratio_upper)), u256_to_i128(v4)), sqrt_price(arg0))
    }

    public fun solve_zero_for_one(arg0: &SwapState) : u128 {
        let v0 = 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::constants::scaling_pips_u256() - arg0.fee_pips;
        let v1 = arg0.liquidity << 64;
        let v2 = v1 * 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::constants::scaling_pips_u256() / v0 * arg0.sqrt_price;
        let v3 = arg0.amount_x_desired + v2 - v1 / arg0.sqrt_ratio_upper;
        assert!(v3 > arg0.amount_x_desired, 0);
        let v4 = arg0.amount_y_desired + 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_price);
        0x1::u128::min(cal_sqrt_price(u256_to_i128(v3), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::add(u256_to_i128(0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::safe_math::mul_div_Q64(arg0.amount_x_desired + v2, arg0.sqrt_ratio_lower)), u256_to_i128(arg0.fee_pips * arg0.liquidity / v0)), u256_to_i128((v4 << 64) / arg0.sqrt_ratio_upper)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(u256_to_i128(v4), u256_to_i128(0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::safe_math::mul_div_Q64(arg0.liquidity, 0x58c9bcc5dc3dd6fc254e521a53ccdbf4a84d107ce963c7c4625e6159d1e0345a::constants::scaling_pips_u256() * arg0.sqrt_ratio_lower / v0)))), sqrt_price(arg0))
    }
