module 0x58d07ca8dd203ea788df006d5fdbe837da84fe94747ecf79346a16f0007a8a60::momentum_bans {
    struct MOMENTUM_BANS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOMENTUM_BANS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MOMENTUM_BANS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Momentum Bans"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Own a piece of history"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigoeqhaavkclmpu4lzrlmkz3rupwg6g7cw6s43y6re4nguojiuhve"));
