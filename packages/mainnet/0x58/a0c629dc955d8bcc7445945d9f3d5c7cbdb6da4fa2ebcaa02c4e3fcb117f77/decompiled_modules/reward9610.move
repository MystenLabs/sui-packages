module 0x58a0c629dc955d8bcc7445945d9f3d5c7cbdb6da4fa2ebcaa02c4e3fcb117f77::reward9610 {
    struct REWARD9610 has drop {
        dummy_field: bool,
    }

    struct TICKET_9610 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9610(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9610>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9610>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9610, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9610>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9610>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9610>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9610>>(v5, 0x2::tx_context::sender(arg1));
    }
