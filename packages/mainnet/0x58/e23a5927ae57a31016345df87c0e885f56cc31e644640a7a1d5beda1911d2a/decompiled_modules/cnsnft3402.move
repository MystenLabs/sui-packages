module 0x58e23a5927ae57a31016345df87c0e885f56cc31e644640a7a1d5beda1911d2a::cnsnft3402 {
    struct CNSNFT3402 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3402, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6358"));
        let v4 = 0x2::package::claim<CNSNFT3402>(arg0, arg1);
