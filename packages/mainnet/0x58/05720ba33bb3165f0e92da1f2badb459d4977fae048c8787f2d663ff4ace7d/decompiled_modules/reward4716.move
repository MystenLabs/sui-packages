module 0x5805720ba33bb3165f0e92da1f2badb459d4977fae048c8787f2d663ff4ace7d::reward4716 {
    struct REWARD4716 has drop {
        dummy_field: bool,
    }

    struct TICKET_4716 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4716(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4716>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4716>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4716, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4716>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4716>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4716>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4716>>(v5, 0x2::tx_context::sender(arg1));
    }
