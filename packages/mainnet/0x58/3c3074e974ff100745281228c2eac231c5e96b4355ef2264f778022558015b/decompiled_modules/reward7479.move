module 0x583c3074e974ff100745281228c2eac231c5e96b4355ef2264f778022558015b::reward7479 {
    struct REWARD7479 has drop {
        dummy_field: bool,
    }

    struct TICKET_7479 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7479(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7479>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7479>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7479, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7479>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7479>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7479>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7479>>(v5, 0x2::tx_context::sender(arg1));
    }
