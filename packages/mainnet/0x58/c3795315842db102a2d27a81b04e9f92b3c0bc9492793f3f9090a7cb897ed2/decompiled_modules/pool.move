module 0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::pool {
    ...
    public fun calc_pending_rewards(arg0: &Pool, arg1: &0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::position::Position) : u64 {
        ((calc_rewards_for(arg0, arg1) - 0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::position::reward_debt(arg1)) as u64)
    }

    public fun calc_rewards_for(arg0: &Pool, arg1: &0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::position::Position) : u256 {
        (0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::position::value(arg1) as u256) * arg0.acc_reward_per_share / 1000000000000
    }

    public(friend) fun create_pool(arg0: u64, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Pool {
        let v0 = 0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::utils::to_seconds(0x2::clock::timestamp_ms(arg3));
        let v1 = new(arg4);
    ...
    public fun pending_reward(arg0: &Pool, arg1: &0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::position::Position, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : u64 {
        let v0 = 0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::utils::to_seconds(0x2::clock::timestamp_ms(arg4));
        ...
        (((0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::position::value(arg1) as u256) * v2 / 1000000000000 - 0x58c3795315842db102a2d27a81b04e9f92b3c0bc9492793f3f9090a7cb897ed2::position::reward_debt(arg1)) as u64)
    }
