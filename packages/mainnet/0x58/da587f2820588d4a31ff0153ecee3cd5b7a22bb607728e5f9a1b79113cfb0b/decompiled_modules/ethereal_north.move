module 0x58da587f2820588d4a31ff0153ecee3cd5b7a22bb607728e5f9a1b79113cfb0b::ethereal_north {
    struct ETHEREAL_NORTH has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"ccde33ea-ea0f-440c-a9b1-6fb48585626f"),
        };
    ...
    fun init(arg0: ETHEREAL_NORTH, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ETHEREAL_NORTH>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Ethereal North"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"457468657265616c204e6f7274682072657665616c73204e6f72776179e2809973207261772062656175747920696e206d6f6e6f6368726f6d65e280946d696e696d616c2079657420706f77657266756c2c2077696c6420796574207472616e7175696c2e"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmR4a5pVwxxGLREh715zXmf3z1ywRnvCH1Vhw8Qg7ZFeM6"));
    ...
    public entry fun mint_nft(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::kiosk::Kiosk, arg14: &0x2::kiosk::KioskOwnerCap, arg15: &0x2::transfer_policy::TransferPolicy<Nft>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = MintNftEvent{
            ...
            price                     : arg9 + arg10,
            collection_id             : 0x1::string::utf8(b"ccde33ea-ea0f-440c-a9b1-6fb48585626f"),
            collection_creator_wallet : @0x5bead84be1d721549c607c226aab12edda5cb3b54dcc37c03a72c1e1432e2eb4,
