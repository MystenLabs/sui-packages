module 0x5898a7fb565641b45e8fb527f44e384ac46f47468672ab311e0d4db78c617330::allocator {
    ...
    public(friend) fun add_new_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == false, 0x5898a7fb565641b45e8fb527f44e384ac46f47468672ab311e0d4db78c617330::error::pool_already_present_error());
    ...
    public(friend) fun delete_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == true, 0x5898a7fb565641b45e8fb527f44e384ac46f47468672ab311e0d4db78c617330::error::pool_not_present_error());
        ...
        assert!(v3 == true, 0x5898a7fb565641b45e8fb527f44e384ac46f47468672ab311e0d4db78c617330::error::pool_has_weight_error());
        assert!(v4 == false, 0x5898a7fb565641b45e8fb527f44e384ac46f47468672ab311e0d4db78c617330::error::pending_rewards_error());
    ...
    public(friend) fun top_up_pools<T0>(arg0: &mut Allocator, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg2 <= arg3, 0x5898a7fb565641b45e8fb527f44e384ac46f47468672ab311e0d4db78c617330::error::unlock_time_exceeded_error());
