module 0x58b0394ff6980233ffe6239c809a5e486f973e2dd25f25d818b4318630dc787a::shares {
    ...
    public(friend) fun deduct(arg0: &mut ShareReceipt, arg1: u128) {
        assert!(arg0.shares >= arg1, 0x58b0394ff6980233ffe6239c809a5e486f973e2dd25f25d818b4318630dc787a::errors::insufficient_shares());
        arg0.shares = arg0.shares - arg1;
    }
    ...
    public fun destroy_zero(arg0: ShareReceipt) {
        ...
        assert!(v2 == 0, 0x58b0394ff6980233ffe6239c809a5e486f973e2dd25f25d818b4318630dc787a::errors::share_receipt_not_empty());
        0x2::object::delete(v0);
    }
    ...
    public fun join(arg0: &mut ShareReceipt, arg1: ShareReceipt) {
        ...
        assert!(v1 == arg0.vault_id, 0x58b0394ff6980233ffe6239c809a5e486f973e2dd25f25d818b4318630dc787a::errors::wrong_vault_id());
