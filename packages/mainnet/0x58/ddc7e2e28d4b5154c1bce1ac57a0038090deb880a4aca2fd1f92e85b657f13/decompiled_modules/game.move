module 0x58ddc7e2e28d4b5154c1bce1ac57a0038090deb880a4aca2fd1f92e85b657f13::game {
        ...
        if (0x2::bag::length(&arg1.daemons) > 0) {
            if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 75) {
                if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 30 && !0x2::vec_set::contains<address>(&arg0.owned_keys, &arg1.validator_address)) {
                    ...
                    0x2::transfer::transfer<NodeKey>(v2, 0x2::tx_context::sender(arg4));
                    0x2::vec_set::insert<address>(&mut arg0.owned_keys, arg1.validator_address);
                };
            } else {
                let v3 = 0x2::random::generate_u64_in_range(&mut v1, 1, 5);
                if (arg0.data_fragments >= v3) {
                    arg0.data_fragments = arg0.data_fragments - v3;
                } else {
            ...
            if (0x2::random::generate_u8_in_range(&mut v1, 0, 100) < 30 && !0x2::vec_set::contains<address>(&arg0.owned_keys, &arg1.validator_address)) {
                ...
                0x2::transfer::transfer<NodeKey>(v4, 0x2::tx_context::sender(arg4));
                0x2::vec_set::insert<address>(&mut arg0.owned_keys, arg1.validator_address);
            };
