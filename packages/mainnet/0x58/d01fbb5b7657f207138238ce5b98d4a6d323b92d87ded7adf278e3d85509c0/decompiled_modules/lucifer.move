module 0x58d01fbb5b7657f207138238ce5b98d4a6d323b92d87ded7adf278e3d85509c0::lucifer {
    ...
    fun init(arg0: LUCIFER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LUCIFER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"lucifer"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"f 4 u"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://6UdJSpcHiwgBA7EfkFvlHeY_WoEZIEDr-7HTayUpKkY"));
