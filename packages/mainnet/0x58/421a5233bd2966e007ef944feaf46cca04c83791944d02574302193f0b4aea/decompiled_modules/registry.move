module 0x58421a5233bd2966e007ef944feaf46cca04c83791944d02574302193f0b4aea::registry {
    ...
    public fun disable_version(arg0: &mut Registry, arg1: u64, arg2: &AdminCap) {
        assert!(arg1 != 0x58421a5233bd2966e007ef944feaf46cca04c83791944d02574302193f0b4aea::constants::current_version(), 3);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            allowed_versions : 0x2::vec_set::singleton<u64>(0x58421a5233bd2966e007ef944feaf46cca04c83791944d02574302193f0b4aea::constants::current_version()),
