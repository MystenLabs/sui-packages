module 0x58421a5233bd2966e007ef944feaf46cca04c83791944d02574302193f0b4aea::event_v1 {
    ...
    struct SwapEvent has copy, drop {
        pool_id: 0x2::object::ID,
        math: 0x58421a5233bd2966e007ef944feaf46cca04c83791944d02574302193f0b4aea::math_v1::PoolMath,
        x_to_y: bool,
        amount_in: u64,
        amount_out: u64,
        fee_amount: u64,
    ...
    public(friend) fun emit_swap_event(arg0: &0x2::object::UID, arg1: 0x58421a5233bd2966e007ef944feaf46cca04c83791944d02574302193f0b4aea::math_v1::PoolMath, arg2: bool, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = SwapEvent{
            pool_id    : *0x2::object::uid_as_inner(arg0),
            math       : arg1,
            x_to_y     : arg2,
