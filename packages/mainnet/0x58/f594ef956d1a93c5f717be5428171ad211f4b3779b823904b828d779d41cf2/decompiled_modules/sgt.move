module 0x58f594ef956d1a93c5f717be5428171ad211f4b3779b823904b828d779d41cf2::sgt {
    struct SGT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun initialize_amm_pool(arg0: &mut SgtPlatform, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<SGT>(&arg0.token_balance) >= 1000000000000, 2);
        ...
        let v1 = AMMPool{
            ...
            token_reserve : 0x2::balance::split<SGT>(&mut arg0.token_balance, 1000000000000),
        };
