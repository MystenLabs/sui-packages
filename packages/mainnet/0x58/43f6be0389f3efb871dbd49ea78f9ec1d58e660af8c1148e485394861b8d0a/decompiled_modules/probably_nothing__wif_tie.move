module 0x5843f6be0389f3efb871dbd49ea78f9ec1d58e660af8c1148e485394861b8d0a::probably_nothing__wif_tie {
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"95413cce-0198-410d-8de1-bbae9382f95c"),
        };
    ...
    fun init(arg0: PROBABLY_NOTHING__WIF_TIE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PROBABLY_NOTHING__WIF_TIE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Probably Nothing: Wif Tie"));
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmaoeXxJ8aX27sZbgTMgckNzFuxp2fMHmzWoBkEYxFZrzq"));
