module 0x58f6df360e1d410fc23a66313bd460171011c093d4b1c907c74fd329ed4ce28c::game {
    ...
    public fun finish_evaluation(arg0: 0x2::object::ID, arg1: vector<u8>, arg2: &mut ConvenienceStore, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0;
        while (v6 < v2) {
            let v8 = 0x58f6df360e1d410fc23a66313bd460171011c093d4b1c907c74fd329ed4ce28c::math::get_random_u64_in_range(&v5, tickets_left(arg2));
            let v9 = &v5;
