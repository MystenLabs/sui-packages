module 0x58d73e6beeefc0d9f0e493fd902813b750049a077d3fab1927090796ad818bce::cnsnft4132 {
    struct CNSNFT4132 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4132, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4132>(arg0, arg1);
