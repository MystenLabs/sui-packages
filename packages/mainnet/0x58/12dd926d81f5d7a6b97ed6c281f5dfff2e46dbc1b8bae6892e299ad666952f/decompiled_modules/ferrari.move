module 0x5812dd926d81f5d7a6b97ed6c281f5dfff2e46dbc1b8bae6892e299ad666952f::ferrari {
    struct FERRARI has drop {
        dummy_field: bool,
    }

    fun init(arg0: FERRARI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = vector[9, 1000000000000000, 0];
        let v1 = vector[b"Ferrari", b"Ferrari", b"Fast", b"https://i.pinimg.com/736x/1f/d0/7e/1fd07e1786e734eea0a974cf90080861.jpg"];
        let v2 = vector[b"Ferrari", b"Ferrari", b"Fast", b"https://i.pinimg.com/736x/1f/d0/7e/1fd07e1786e734eea0a974cf90080861.jpg"];
        let v3 = vector[b"Ferrari", b"Ferrari", b"Fast", b"https://i.pinimg.com/736x/1f/d0/7e/1fd07e1786e734eea0a974cf90080861.jpg"];
        let v4 = vector[b"Ferrari", b"Ferrari", b"Fast", b"https://i.pinimg.com/736x/1f/d0/7e/1fd07e1786e734eea0a974cf90080861.jpg"];
        let (v5, v6) = 0x2::coin::create_currency<FERRARI>(arg0, (*0x1::vector::borrow<u64>(&v0, 0) as u8), *0x1::vector::borrow<vector<u8>>(&v1, 0), *0x1::vector::borrow<vector<u8>>(&v2, 1), *0x1::vector::borrow<vector<u8>>(&v3, 2), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(*0x1::vector::borrow<vector<u8>>(&v4, 3))), arg1);
        let v7 = v5;
        let v8 = 0x2::tx_context::sender(arg1);
        let v9 = vector[9, 1000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v9, 1) > 0) {
            let v10 = vector[9, 1000000000000000, 0];
            0x2::coin::mint_and_transfer<FERRARI>(&mut v7, *0x1::vector::borrow<u64>(&v10, 1), v8, arg1);
        };
        let (v11, v12) = 0x8135dda2a2b575ef87654aa1115a46da63ea9a387abb5f7cdb93df062af7a937::ipx_coin_standard::new<FERRARI>(v7, arg1);
        let v13 = v12;
        let v14 = v11;
        ...
        0x8135dda2a2b575ef87654aa1115a46da63ea9a387abb5f7cdb93df062af7a937::ipx_coin_standard::destroy_witness<FERRARI>(&mut v14, v13);
        ...
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<FERRARI>>(v6);
    }
