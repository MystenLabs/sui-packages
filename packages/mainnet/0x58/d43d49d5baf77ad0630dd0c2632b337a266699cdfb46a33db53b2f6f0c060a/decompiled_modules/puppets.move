module 0x58d43d49d5baf77ad0630dd0c2632b337a266699cdfb46a33db53b2f6f0c060a::puppets {
    ...
    struct PUPPETS_NFT has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun add_to_phase2(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            0x2::table::add<address, u64>(&mut arg1.phase2_whitelist, v1, 69);
            let v2 = WhitelistAdded{
                phase      : 2,
                address    : v1,
                mint_limit : 1,
    ...
    public entry fun burn_nft(arg0: PUPPETS_NFT, arg1: &mut NFTCollection) {
        let PUPPETS_NFT {
            id          : v0,
            name        : _,
            description : _,
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : PUPPETS_NFT {
        let v0 = 0x1::string::utf8(b"Sui Puppets #");
        ...
        PUPPETS_NFT{
            ...
            name        : v0,
            description : 0x1::string::utf8(b"1420 gators swimming in the sui swamp."),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    public fun get_token_id(arg0: &PUPPETS_NFT) : u64 {
        arg0.token_id
    }
    ...
    fun init(arg0: PUPPETS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PUPPETS>(arg0, arg1);
        let v1 = NFTCollection{
            ...
            mint_start        : 1758668400000,
            phase_end         : 1758668400000 + 3600000,
            admin_address     : @0x2cea8ec233ed992c1a2d595b85fc279c47c4347e7f042d764cd4b8fbb665a8f2,
            treasury_address  : @0x2cea8ec233ed992c1a2d595b85fc279c47c4347e7f042d764cd4b8fbb665a8f2,
            phase1_price      : 3330000000,
            phase2_price      : 4200000000,
            phase3_price      : 0,
            public_price      : 5500000000,
        };
        let v2 = 1;
        while (v2 <= 1420) {
        ...
        let v4 = 0x2::display::new<PUPPETS_NFT>(&v0, arg1);
        0x2::display::add<PUPPETS_NFT>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<PUPPETS_NFT>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<PUPPETS_NFT>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://walrus.doonies.net/puppets/{image_url}.png"));
        0x2::display::add<PUPPETS_NFT>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<PUPPETS_NFT>(&mut v4);
        let (v5, v6) = 0x2::transfer_policy::new<PUPPETS_NFT>(&v0, arg1);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<PUPPETS_NFT>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PUPPETS_NFT>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PUPPETS_NFT>>(v5);
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PUPPETS_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v8, 4);
        let v9 = if (v2) {
            if (arg0.phase1_minted >= 300) {
                0
            } else {
                300 - arg0.phase1_minted
            }
        } else {
            0
        };
        let v10 = if (v4) {
            if (arg0.phase2_minted >= 1020) {
                0
            } else {
                1020 - arg0.phase2_minted
            }
        } else {
            0
        };
        ...
        if (v2 && v13 > 0) {
            while (v20 < v13) {
                ...
                0x2::kiosk::lock<PUPPETS_NFT>(arg5, arg6, arg2, v22);
                let v23 = NFTMinted{
                    nft_id   : 0x2::object::id<PUPPETS_NFT>(&v22),
                    token_id : v21,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        if (v4 && v15 > 0) {
            let v24 = 0;
            while (v24 < v15) {
                let v25 = select_random_id(arg0, arg4, arg7);
                let v26 = create_nft(arg0, v25, arg7);
                arg0.minted = arg0.minted + 1;
                arg0.phase2_minted = arg0.phase2_minted + 1;
                0x2::kiosk::lock<PUPPETS_NFT>(arg5, arg6, arg2, v26);
                let v27 = NFTMinted{
                    nft_id   : 0x2::object::id<PUPPETS_NFT>(&v26),
                    token_id : v25,
                    minter   : v0,
                    phase    : 2,
                };
        ...
        if (v6 && v17 > 0) {
            let v28 = 0;
            while (v28 < v17) {
                let v29 = select_random_id(arg0, arg4, arg7);
                let v30 = create_nft(arg0, v29, arg7);
                arg0.minted = arg0.minted + 1;
                arg0.phase3_minted = arg0.phase3_minted + 1;
                0x2::kiosk::lock<PUPPETS_NFT>(arg5, arg6, arg2, v30);
                let v31 = NFTMinted{
                    nft_id   : 0x2::object::id<PUPPETS_NFT>(&v30),
                    token_id : v29,
                    minter   : v0,
                    phase    : 3,
                };
    ...
    public entry fun mint_phase1(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PUPPETS_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.phase1_minted + arg7 <= 300, 9);
        assert!(arg0.minted + arg7 <= 1420, 1);
        ...
        while (v4 < arg7) {
            ...
            arg0.minted = arg0.minted + 1;
            arg0.phase1_minted = arg0.phase1_minted + 1;
            0x2::kiosk::lock<PUPPETS_NFT>(arg5, arg6, arg2, v6);
            let v7 = NFTMinted{
                nft_id   : 0x2::object::id<PUPPETS_NFT>(&v6),
                token_id : v5,
                minter   : v0,
                phase    : 1,
            };
    ...
    public entry fun mint_phase2(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PUPPETS_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
        ...
        assert!(v2 > 0 && arg7 <= v2, 5);
        assert!(arg0.phase2_minted + arg7 <= 1020, 9);
        assert!(arg0.minted + arg7 <= 1420, 1);
    ...
    public entry fun mint_phase3(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PUPPETS_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 <= arg0.phase_end, 3);
    ...
    public entry fun mint_public(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<PUPPETS_NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(v1 >= arg0.mint_start, 2);
        assert!(v1 > arg0.phase_end, 2);
        assert!(arg7 > 0 && arg7 <= 13, 7);
        assert!(arg0.minted + arg7 <= 1420, 1);
        ...
        while (v3 < arg7) {
            ...
            0x2::kiosk::lock<PUPPETS_NFT>(arg5, arg6, arg2, v5);
            let v6 = NFTMinted{
                nft_id   : 0x2::object::id<PUPPETS_NFT>(&v5),
                token_id : v4,
                minter   : v0,
                phase    : 100,
            };
    ...
    public entry fun team_mint_batch(arg0: &AdminCap, arg1: &mut NFTCollection, arg2: &0x2::transfer_policy::TransferPolicy<PUPPETS_NFT>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        while (arg5 <= arg6) {
            ...
            0x2::kiosk::lock<PUPPETS_NFT>(arg3, arg4, arg2, v1);
            let v2 = NFTMinted{
                nft_id   : 0x2::object::id<PUPPETS_NFT>(&v1),
                token_id : v0,
