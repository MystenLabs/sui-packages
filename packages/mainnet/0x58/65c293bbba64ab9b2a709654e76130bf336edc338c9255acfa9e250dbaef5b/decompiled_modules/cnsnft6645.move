module 0x5865c293bbba64ab9b2a709654e76130bf336edc338c9255acfa9e250dbaef5b::cnsnft6645 {
    struct CNSNFT6645 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6645, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6645>(arg0, arg1);
