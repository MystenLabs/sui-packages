module 0x58c9c2806b0b6deec30d8303bc1f505dee4209e49bf2b00cf6507d0ff7f70e53::cnsnft1712 {
    struct CNSNFT1712 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1712, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1712>(arg0, arg1);
