module 0x58c55150186b8d43a6be3d70cf3a9434f25dc3b9e1a90f9e864bc64bad6aa70f::cnsnft6605 {
    struct CNSNFT6605 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6605, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6605>(arg0, arg1);
