module 0x58b5165b01b148841102593225b0785296055c77011c2b6f54d58258fb066ca4::dog {
    struct DOG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DOG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DOG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOG     ")))), trim_right(b"IAmTheDog                       "), trim_right(b"After an attempt on President Trump's life during his last speech, he told everyone to FIGHT, encouraging us to continue fighting to Make America Great Again                                                                                                                                                                   "), v2, arg1);
