module 0x1de3e6de7e4fb3c43d14da56685f22fbc8a166090e068f525ead23852e29231b::reward8433 {
    struct REWARD8433 has drop {
        dummy_field: bool,
    }

    struct TICKET_8433 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8433(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8433>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8433>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8433, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8433>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8433>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8433>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8433>>(v5, 0x2::tx_context::sender(arg1));
    }
