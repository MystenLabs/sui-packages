module 0x1d43395360f959a930a47e8b10decb583c7d85214aedecb391e497bf9cec4668::cnsnft1700 {
    struct CNSNFT1700 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1700, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1700>(arg0, arg1);
