module 0x1dd83be247635bd69b25adde38834e9e33336185e1e435e6771f22e8cdcdbd3e::vault {
    ...
    public fun extend_lock<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > 0x2::clock::timestamp_ms(arg2), 20);
        assert!(arg1 > arg0.unlock_ms, 31);
        arg0.unlock_ms = arg1;
        let v0 = VaultExtendedEvent<T0>{
            vault_id      : 0x2::object::uid_to_inner(&arg0.id),
            owner         : arg0.owner,
            old_unlock_ms : arg0.unlock_ms,
            new_unlock_ms : arg1,
        };
        0x2::event::emit<VaultExtendedEvent<T0>>(v0);
    }
    ...
    public fun top_up<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = VaultWithdrawnEvent<T0>{
            vault_id        : 0x2::object::uid_to_inner(&arg0.id),
            owner           : arg0.owner,
            amount          : 0x2::balance::value<T0>(&arg0.balance),
            withdrawn_at_ms : v0,
        };
        0x2::event::emit<VaultWithdrawnEvent<T0>>(v1);
