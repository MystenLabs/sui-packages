module 0x1d4b5fc6639357902a5505034164af93201d256ed1806eec05e810017fe5b2cb::cnsnft4199 {
    struct CNSNFT4199 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4199, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4199>(arg0, arg1);
