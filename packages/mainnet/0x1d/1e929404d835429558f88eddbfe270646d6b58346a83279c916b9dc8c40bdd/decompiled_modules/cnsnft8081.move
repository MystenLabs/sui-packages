module 0x1d1e929404d835429558f88eddbfe270646d6b58346a83279c916b9dc8c40bdd::cnsnft8081 {
    struct CNSNFT8081 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8081, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8081>(arg0, arg1);
