module 0x1d4ba3438932a2201ad05156e3d2b5f216558e63cbc7a28a968617bb4e0ed547::liquidation_vault {
    ...
    public fun liquidate_base<T0, T1>(arg0: &mut LiquidationVault, arg1: &mut 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_manager::MarginManager<T0, T1>, arg2: &0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_registry::MarginRegistry, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &mut 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_pool::MarginPool<T0>, arg6: &mut 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_pool::MarginPool<T1>, arg7: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg8: 0x1::option::Option<u64>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = balance<T0>(arg0);
        if (!0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_registry::can_liquidate(arg2, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg7), 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_manager::risk_ratio<T0, T1>(arg1, arg2, arg3, arg4, arg7, arg5, arg6, arg9)) || v0 < 1000) {
            return
        };
        let v1 = 0x1::option::destroy_with_default<u64>(arg8, v0);
        let v2 = withdraw_int<T0>(arg0, v1);
        let (v3, v4, v5) = 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_manager::liquidate<T0, T1, T0>(arg1, arg2, arg3, arg4, arg5, arg7, 0x2::coin::from_balance<T0>(v2, arg10), arg9, arg10);
        let v6 = v5;
        let v7 = v4;
        let v8 = v3;
        let v9 = LiquidationByVault{
            vault_id                : id(arg0),
            margin_manager_id       : 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_manager::id<T0, T1>(arg1),
            margin_pool_id          : 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_pool::id<T0>(arg5),
            base_in                 : v1,
    ...
    public fun liquidate_quote<T0, T1>(arg0: &mut LiquidationVault, arg1: &mut 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_manager::MarginManager<T0, T1>, arg2: &0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_registry::MarginRegistry, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &mut 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_pool::MarginPool<T0>, arg6: &mut 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_pool::MarginPool<T1>, arg7: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg8: 0x1::option::Option<u64>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4, v5) = 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_manager::liquidate<T0, T1, T1>(arg1, arg2, arg3, arg4, arg6, arg7, 0x2::coin::from_balance<T1>(v2, arg10), arg9, arg10);
        let v6 = v5;
        let v7 = v4;
        let v8 = v3;
        let v9 = LiquidationByVault{
            vault_id                : id(arg0),
            margin_manager_id       : 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_manager::id<T0, T1>(arg1),
            margin_pool_id          : 0xdd8400e6da54a2d4216f157f9f242af9ec81d011acc75756ff6bcc81dd78d3be::margin_pool::id<T1>(arg6),
            base_in                 : 0,
            base_out                : 0x2::coin::value<T0>(&v8),
            quote_in                : v1,
            quote_out               : 0x2::coin::value<T1>(&v7),
