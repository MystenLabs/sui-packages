module 0x1d7cf431d17440206907481d07b17fb52b0df8ba89cd2a633279669f5df35f19::reward3524 {
    struct REWARD3524 has drop {
        dummy_field: bool,
    }

    struct TICKET_3524 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3524(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3524>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3524>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3524, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3524>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3524>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3524>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3524>>(v5, 0x2::tx_context::sender(arg1));
    }
