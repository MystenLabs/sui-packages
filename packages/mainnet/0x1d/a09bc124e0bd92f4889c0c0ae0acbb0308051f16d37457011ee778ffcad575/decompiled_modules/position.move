module 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::position {
    ...
    public(friend) fun decrease_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::Bin, arg3: u128) {
        if (arg3 == 0) {
            return
        };
        let v0 = bin_idx(arg1, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg2));
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, v0);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v1.bin_id, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg2)), 13906836132849713172);
        let v2 = &mut arg0.fee_owned_a;
        let v3 = &mut arg0.fee_owned_b;
        update_fee_per_bin(v1, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_a_growth_global(arg2), 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_b_growth_global(arg2), v2, v3);
        let v4 = &mut arg0.rewards_owned;
        update_reward_per_bin(v1, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::rewards_growth_global(arg2), v4);
        *0x1::vector::borrow_mut<u128>(&mut arg1.liquidity_shares, v0) = decrease_liquidity_per_bin(v1, arg3);
    }

    public(friend) fun add_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::Bin, arg3: u128) {
        0x1::vector::push_back<BinStat>(&mut arg0.stats, new_bin_stat(arg2, 0));
        let v0 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, bin_idx(arg1, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg2)));
        v0.fee_a_growth = 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_a_growth_global(arg2);
        v0.fee_b_growth = 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_b_growth_global(arg2);
        v0.rewards_growth = 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::rewards_growth_global(arg2);
        0x1::vector::push_back<u128>(&mut arg1.liquidity_shares, increase_liquidity_per_bin(v0, arg3));
    }
    ...
    public(friend) fun assert_no_pending_add(arg0: &Position) {
        assert!(arg0.flash_count == 0, 13906837584549445664);
    }
    ...
    public(friend) fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906835252382072862);
    ...
    public fun borrow_position_info(arg0: &PositionManager, arg1: 0x2::object::ID) : &PositionInfo {
        assert!(0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906837683333562398);
    ...
    public(friend) fun clear_pending_add(arg0: &mut Position) {
        assert!(arg0.flash_count > 0, 13906837533009969186);
    ...
    public(friend) fun close_position_bin(arg0: &mut ClosePositionCert, arg1: &mut 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::Bin, arg2: BinStat) : (u64, u64) {
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(arg2.bin_id, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg1)), 13906836643950821396);
        let v0 = &mut arg2;
        let v1 = &mut arg0.position_info.fee_owned_a;
        let v2 = &mut arg0.position_info.fee_owned_b;
        update_fee_per_bin(v0, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_a_growth_global(arg1), 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_b_growth_global(arg1), v1, v2);
        let v3 = &mut arg2;
        let v4 = &mut arg0.position_info.rewards_owned;
        update_reward_per_bin(v3, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::rewards_growth_global(arg1), v4);
        let BinStat {
            bin_id          : _,
            liquidity_share : v6,
            fee_a_growth    : _,
        ...
        let (v10, v11) = 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::decrease_liquidity(arg1, v6);
    ...
    fun decrease_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(arg0.liquidity_share >= arg1, 13906839130736623632);
    ...
    public(friend) fun destroy_cert(arg0: ClosePositionCert) {
        ...
        let v9 = v8;
        assert!(0x1::vector::length<BinStat>(&v9) == 0, 13906837215181996060);
        0x1::vector::destroy_empty<BinStat>(v9);
        assert!(v2 + v5 == 0, 13906837223771537430);
        assert!(v3 + v6 == 0, 13906837228066635800);
        let v10 = v7;
        let v11 = 0;
        while (v11 < 0x1::vector::length<u64>(&v10)) {
            assert!(0x1::vector::pop_back<u64>(&mut v10) == 0, 13906837236656701466);
            v11 = v11 + 1;
        };
    ...
    public(friend) fun extract_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : PositionInfo {
        assert!(0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906835321101549598);
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::Bin, arg3: u128) {
        let v0 = bin_idx(arg1, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg2));
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, v0);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v1.bin_id, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg2)), 13906835956756054036);
        let v2 = &mut arg0.fee_owned_a;
        let v3 = &mut arg0.fee_owned_b;
        update_fee_per_bin(v1, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_a_growth_global(arg2), 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_b_growth_global(arg2), v2, v3);
        let v4 = &mut arg0.rewards_owned;
    ...
    fun increase_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(340282366920938463463374607431768211455 - arg0.liquidity_share >= arg1, 13906839066311983118);
        arg0.liquidity_share = arg0.liquidity_share + arg1;
        arg0.liquidity_share
    }
    ...
    public(friend) fun new_bin_stat(arg0: &0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::Bin, arg1: u128) : BinStat {
        BinStat{
            bin_id          : 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg0),
            liquidity_share : arg1,
            fee_a_growth    : 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_a_growth_global(arg0),
            fee_b_growth    : 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::fee_b_growth_global(arg0),
            rewards_growth  : 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::rewards_growth_global(arg0),
        }
    }
    ...
    public(friend) fun open_position<T0, T1>(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: u64, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg4: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) : Position {
        let v0 = Position{
            ...
            coin_type_a      : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_original_ids<T0>())),
            coin_type_b      : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_original_ids<T1>())),
    ...
    public(friend) fun restore_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: PositionInfo) {
        assert!(!0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906835398411354148);
    ...
    public(friend) fun take_reward_from_close_cert(arg0: &mut ClosePositionCert, arg1: u64) : u64 {
        assert!(0x1::vector::length<u64>(&arg0.position_info.rewards_owned) > arg1, 13906836923123564562);
    ...
    public(friend) fun update_fee(arg0: &mut PositionInfo, arg1: &0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::Bin) {
        let v0 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, bin_idx_on_position_info(arg0, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg1)));
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v0.bin_id, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg1)), 13906836253108797460);
    ...
    fun update_fee_per_bin(arg0: &mut BinStat, arg1: u128, arg2: u128, arg3: &mut u64, arg4: &mut u64) {
        ...
        *arg3 = *arg3 + 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg1, arg0.fee_a_growth), arg0.liquidity_share);
        *arg4 = *arg4 + 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg2, arg0.fee_b_growth), arg0.liquidity_share);
    }
    ...
    fun update_reward_per_bin(arg0: &mut BinStat, arg1: vector<u128>, arg2: &mut vector<u64>) {
        ...
        assert!(v1 <= v0, 13906839242405904402);
        let v2 = 0;
        while (v2 < v0) {
            ...
            let v4 = if (v1 > v2) {
                ...
                *v5 = v3;
                0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(v3, *v5), arg0.liquidity_share)
            } else {
                0x1::vector::push_back<u128>(&mut arg0.rewards_growth, v3);
                0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::dlmm_math::calculate_amount_by_growth(v3, arg0.liquidity_share)
            };
    ...
    public(friend) fun update_rewards(arg0: &mut PositionInfo, arg1: &0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::Bin) {
        let v0 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, bin_idx_on_position_info(arg0, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg1)));
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v0.bin_id, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::id(arg1)), 13906836351893045268);
        if (liquidity_share(v0) == 0) {
            return
        };
        let v1 = &mut arg0.rewards_owned;
        update_reward_per_bin(v0, 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::bin::rewards_growth_global(arg1), v1);
    }
