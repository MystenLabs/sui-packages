module 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::reward {
    ...
    public(friend) fun add_reward<T0>(arg0: &mut RewardManager, arg1: 0x1::option::Option<u64>, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock) {
        ...
        assert!(arg2 > v0, 13906835089172332559);
        let v1 = if (0x1::option::is_none<u64>(&arg1)) {
            v0
        } else {
            let v2 = 0x1::option::extract<u64>(&mut arg1);
            assert!(v2 >= v0, 13906835110647037965);
            assert!(v2 < arg2, 13906835114942005261);
            v2
        };
        let v3 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_floor((0x2::balance::value<T0>(&arg3) as u128), 1 << 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::constants::scale_offset(), ((arg2 - v1) as u128));
        ...
        if (v1 == v0) {
            assert!(340282366920938463463374607431768211455 - v5.current_emission_rate >= v3, 13906835265265729547);
    ...
    fun current_period_end_time(arg0: u64) : u64 {
        assert!(arg0 >= 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::constants::reward_period_start_at(), 13906837318260621331);
        arg0 + 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::constants::reward_period() - (arg0 - 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::constants::reward_period_start_at()) % 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::constants::reward_period()
    }
    ...
    public(friend) fun emergency_withdraw_refund_reward<T0>(arg0: &mut RewardManager) : 0x2::balance::Balance<T0> {
        ...
        withdraw<T0>(arg0, ((v0.reward_refunded / (1 << 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::constants::scale_offset())) as u64))
    }

    public fun get_index<T0>(arg0: &RewardManager) : u64 {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_some<u64>(&v0), 13906836686899511301);
    ...
    public(friend) fun initialize_reward<T0>(arg0: &mut RewardManager, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = reward_index<T0>(arg0);
        assert!(0x1::option::is_none<u64>(&v0), 13906834908782788609);
        assert!(0x1::vector::length<Reward>(&arg0.rewards) < 0x1da09bc124e0bd92f4889c0c0ae0acbb0308051f16d37457011ee778ffcad575::constants::max_reward_num(), 13906834913077886979);
        assert!(!arg0.emergency_reward_pause, 13906834917374033941);
        let v1 = Reward{
            reward_coin           : 0x1::type_name::with_original_ids<T0>(),
    ...
    public(friend) fun refund_rewards(arg0: &mut RewardManager, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            assert!(340282366920938463463374607431768211455 - v1.reward_refunded >= *0x1::vector::borrow<u128>(&arg1, v0), 13906835810727362583);
    ...
    public fun reward_index<T0>(arg0: &RewardManager) : 0x1::option::Option<u64> {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            if (0x1::vector::borrow<Reward>(&arg0.rewards, v0).reward_coin == 0x1::type_name::with_original_ids<T0>()) {
    ...
    public(friend) fun rollover_refunds_into_remaining_time(arg0: &mut RewardManager, arg1: vector<u128>, arg2: &0x2::clock::Clock) {
        ...
        while (v0 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            assert!(340282366920938463463374607431768211455 - v2.current_emission_rate >= v4, 13906835724827230219);
    ...
    public(friend) fun settle_rewards(arg0: &mut RewardManager, arg1: &0x2::clock::Clock) : vector<u128> {
        ...
        assert!(v0 < v1, 13906835394114486279);
        let v2 = 0;
        ...
        while (v2 < 0x1::vector::length<Reward>(&arg0.rewards)) {
            ...
            while (0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::option_u64::is_some(&v5) && v1 > v0) {
                ...
                assert!(!0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::is_neg(v8), 13906835514374225937);
    ...
    public(friend) fun withdraw<T0>(arg0: &mut RewardManager, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v1), 13906836291762782217);
        let v2 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.vault, v1);
        assert!(0x2::balance::value<T0>(v2) >= arg1, 13906836300352716809);
