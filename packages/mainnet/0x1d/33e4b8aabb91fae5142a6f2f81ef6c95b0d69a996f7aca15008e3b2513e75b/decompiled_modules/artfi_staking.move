module 0xe634701ab4c4daf2f031772048840a7484ca18ae5fbcf22e63bbbd7b4833f8ee::artfi_staking {
    ...
    public entry fun get_registry<T0>(arg0: &mut ArtfiStaking<T0>, arg1: &DeployerRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun get_rewards<T0>(arg0: &mut ArtfiStaking<T0>, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.obj_id == 0x2::object::uid_to_inner(&arg0.id), 8);
        let v0 = if (arg2 == 0) {
            0x2::balance::value<T0>(&arg0.amount)
        } else {
            assert!(arg2 <= 0x2::balance::value<T0>(&arg0.amount), 0);
