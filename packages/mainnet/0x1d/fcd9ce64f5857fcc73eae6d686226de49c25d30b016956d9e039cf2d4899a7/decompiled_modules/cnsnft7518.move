module 0x1dfcd9ce64f5857fcc73eae6d686226de49c25d30b016956d9e039cf2d4899a7::cnsnft7518 {
    struct CNSNFT7518 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7518, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3354"));
        let v4 = 0x2::package::claim<CNSNFT7518>(arg0, arg1);
