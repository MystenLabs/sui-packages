module 0x1d2d0d101933584f7939db74b887bbf47b62db5a5de20a8b68bf08408ccb5055::cnsnft9099 {
    struct CNSNFT9099 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9099, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9099>(arg0, arg1);
