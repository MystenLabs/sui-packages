module 0x1dc09f4eafdba5ba80d1f0fa8df6480ecbdd277c51b1845c07bbf4f8e1410c95::lp_staking {
    ...
    fun payout_dual<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: &mut 0x2::balance::Balance<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (v1 > 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(arg0, v2), arg4), arg3);
            v0 = arg2 - v2;
        };
        if (v0 > 0) {
            ...
            if (v4 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(arg1, v4), arg4), arg3);
                v0 = v0 - v4;
            };
        };
        arg2 - v0
