module 0x1dd13c66a68cbd1f5a8d1197e7a5b38e6744dc12290a171fea47d47cb8b83d43::reward1915 {
    struct REWARD1915 has drop {
        dummy_field: bool,
    }

    struct TICKET_1915 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1915(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1915>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1915>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1915, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1915>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1915>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1915>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1915>>(v5, 0x2::tx_context::sender(arg1));
    }
