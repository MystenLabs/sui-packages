module 0xabe311fe4b4d343d1317d3f8db1bd53fb7b96b2aa64771ae5ab54d4f9b2988f7::blackjack {
    ...
    struct StakersKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct HouseEdgeAccrued has copy, drop {
        burn: u64,
        buyback: u64,
        stakers: u64,
    }

    struct HouseEdgeDistributed has copy, drop {
        burned: u64,
        stakers: u64,
    }
    ...
    fun accrue_house_edge(arg0: &mut GameState, arg1: u64) {
        let v0 = arg1 * 500 / 10000;
        let v1 = arg1 * 200 / 10000;
        let v2 = arg1 * 300 / 10000;
        let v3 = v0 + v1 + v2;
        if (v3 == 0 || 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&arg0.prize_pool) < 10000000000000 + v3) {
            return
        };
        ...
        let v9 = StakersKey{dummy_field: false};
        df_accumulate<StakersKey>(arg0, v9, v6);
        let v10 = HouseEdgeAccrued{
            burn    : v0,
            buyback : v1,
            stakers : v2,
        };
        0x2::event::emit<HouseEdgeAccrued>(v10);
    }

    public entry fun admin_withdraw_all(arg0: &AdminCap, arg1: &mut GameState, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&arg1.prize_pool);
        if (v0 == 0) {
            return
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(0x2::coin::take<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&mut arg1.prize_pool, v0, arg2), 0x2::tx_context::sender(arg2));
    }

    public entry fun admin_withdraw_amount(arg0: &AdminCap, arg1: &mut GameState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(0x2::coin::take<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&mut arg1.prize_pool, arg2, arg3), 0x2::tx_context::sender(arg3));
    }

    public fun admin_withdraw_amount_ptb(arg0: &AdminCap, arg1: &mut GameState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI> {
        0x2::coin::take<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&mut arg1.prize_pool, arg2, arg3)
    }
    ...
    fun df_accumulate<T0: copy + drop + store>(arg0: &mut GameState, arg1: T0, arg2: 0x2::balance::Balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>) {
    ...
    public entry fun drain_house_edge(arg0: &AdminCap, arg1: &mut GameState, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = BurnKey{dummy_field: false};
        let v1 = if (0x2::dynamic_field::exists_<BurnKey>(&arg1.id, v0)) {
            let v2 = BurnKey{dummy_field: false};
            let v3 = 0x2::dynamic_field::borrow_mut<BurnKey, 0x2::balance::Balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(&mut arg1.id, v2);
            let v4 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(v3);
            if (v4 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(0x2::coin::from_balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(0x2::balance::split<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(v3, v4), arg2), @0x0);
            };
            v4
        } else {
            0
        };
        let v5 = BuybackKey{dummy_field: false};
        let v6 = if (0x2::dynamic_field::exists_<BuybackKey>(&arg1.id, v5)) {
            let v7 = BuybackKey{dummy_field: false};
            let v8 = 0x2::dynamic_field::borrow_mut<BuybackKey, 0x2::balance::Balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(&mut arg1.id, v7);
            let v9 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(v8);
            if (v9 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(0x2::coin::from_balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(0x2::balance::split<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(v8, v9), arg2), @0x0);
            };
            v9
        } else {
            0
        };
        let v10 = StakersKey{dummy_field: false};
        let v11 = if (0x2::dynamic_field::exists_<StakersKey>(&arg1.id, v10)) {
            let v12 = StakersKey{dummy_field: false};
            let v13 = 0x2::dynamic_field::borrow_mut<StakersKey, 0x2::balance::Balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(&mut arg1.id, v12);
            let v14 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(v13);
            if (v14 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(0x2::coin::from_balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(0x2::balance::split<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(v13, v14), arg2), @0xb1bd12894b2ef9d8a1934a28acd0926bd6b6bedd2647bf4508cf1daa46041e2e);
            };
            v14
        } else {
            0
        ...
        if (v1 + v6 > 0 || v11 > 0) {
            let v15 = HouseEdgeDistributed{
                burned  : v1 + v6,
                stakers : v11,
            };
            0x2::event::emit<HouseEdgeDistributed>(v15);
        };
    }
    ...
    public entry fun execute_emergency_withdraw(arg0: &AdminCap, arg1: &mut GameState, arg2: PendingWithdrawal, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (arg1.pending_withdrawals >= v1) {
            arg1.pending_withdrawals - v1
        } else {
            0
        };
        arg1.pending_withdrawals = v3;
        let v4 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&arg1.prize_pool);
        let v5 = if (v1 > v4) {
            v4
        } else {
            v1
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>>(0x2::coin::from_balance<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(0x2::balance::split<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&mut arg1.prize_pool, v5), arg4), 0x2::tx_context::sender(arg4));
        let v6 = WithdrawExecuted{
            amount     : v5,
        ...
        0x2::event::emit<WithdrawExecuted>(v6);
    }
    ...
    public entry fun initiate_emergency_withdraw(arg0: &AdminCap, arg1: &mut GameState, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&arg1.prize_pool);
        let v1 = if (v0 > arg1.pending_withdrawals) {
            v0 - arg1.pending_withdrawals
        } else {
            0
        };
        assert!(arg2 <= v1 * 1000 / 10000, 4);
        arg1.pending_withdrawals = arg1.pending_withdrawals + arg2;
        let v2 = 0x2::clock::timestamp_ms(arg3) + 172800000;
        let v3 = WithdrawInitiated{
            amount     : arg2,
            not_before : v2,
        };
        0x2::event::emit<WithdrawInitiated>(v3);
        let v4 = PendingWithdrawal{
            id         : 0x2::object::new(arg4),
            amount     : arg2,
            not_before : v2,
        };
        0x2::transfer::transfer<PendingWithdrawal>(v4, 0x2::tx_context::sender(arg4));
    }
    ...
    public entry fun receive_accumulator_donation(arg0: &AdminCap, arg1: &mut GameState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&mut arg1.prize_pool, 0x2::balance::redeem_funds<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(0x2::balance::withdraw_funds_from_object<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&mut arg1.id, arg2)));
        let v0 = PoolDeposited{
