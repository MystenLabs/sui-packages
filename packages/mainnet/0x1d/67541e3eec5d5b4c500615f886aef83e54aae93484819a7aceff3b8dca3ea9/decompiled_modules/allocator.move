module 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::allocator {
    ...
    public(friend) fun add_new_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == false, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::pool_already_present_error());
    ...
    public(friend) fun delete_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == true, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::pool_not_present_error());
        ...
        assert!(v3 == true, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::pool_has_weight_error());
        assert!(v4 == false, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::pending_rewards_error());
    ...
    public(friend) fun get_rewards<T0>(arg0: &mut Allocator, arg1: 0x2::object::ID, arg2: u64, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        if (0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == true && 0x2::bag::contains<0x1::type_name::TypeName>(&arg0.rewards, v0) == true) {
            ...
            if (0x2::vec_map::contains<0x1::type_name::TypeName, PoolData>(&v2.pool_data, &v0) == true) {
                ...
                let v5 = v4;
                if (v3.weight > 0) {
                    v5 = v4 + ((((arg3 - v3.last_update_time) as u128) * (arg2 as u128) * (v3.weight as u128) / (*0x2::vec_map::get<0x1::type_name::TypeName, u64>(&arg0.total_weights, &v0) as u128)) as u64);
                };
    ...
    public(friend) fun top_up_pools<T0>(arg0: &mut Allocator, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg2 <= arg3, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::unlock_time_exceeded_error());
        let v0 = 0x1::type_name::get<T0>();
