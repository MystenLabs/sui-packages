module 0x1db7beed4c660b961c00589249e33a6c88a2972bf32377633d7dd082f0c5e348::reward6594 {
    struct REWARD6594 has drop {
        dummy_field: bool,
    }

    struct TICKET_6594 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6594(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6594>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6594>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6594, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6594>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6594>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6594>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6594>>(v5, 0x2::tx_context::sender(arg1));
    }
