module 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::curve {
    ...
    fun buy_fee_now<T0>(arg0: &Curve<T0>, arg1: u64) : u64 {
        if (in_whitelist_phase<T0>(arg0, arg1)) {
            return 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::trade_fee_bps(&arg0.params)
        };
        let v0 = snipe_start_ms<T0>(arg0);
        if (arg1 < v0) {
            return 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::snipe_start_fee_bps(&arg0.params)
        };
        buy_fee_bps_at(&arg0.params, v0, arg0.snipe_window_ms, arg1)
    }
    ...
    public fun buy_with_proof<T0>(arg0: &mut Curve<T0>, arg1: &0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::Config, arg2: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::Treasury, arg3: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::referral::Registry, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: 0x1::option::Option<address>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = LaunchKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<LaunchKey, Launch>(&arg0.id, v1);
        assert!(!0x1::vector::is_empty<u8>(&v2.whitelist_root), 440);
        let (v3, v4) = launch_times(v2, arg0.created_ms);
        assert!(v0 >= v3, 432);
        assert!(v0 < v4, 433);
        let v5 = v2.whitelist_root;
        let v6 = 0x2::tx_context::sender(arg10);
        assert!(wl_spent<T0>(arg0, v6) < v2.whitelist_cap_sui, 434);
        assert!(0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::merkle::verify(&v5, 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::merkle::address_leaf(v6), &arg8), 436);
    ...
    public(friend) fun configure_launch<T0>(arg0: &mut Curve<T0>, arg1: u64, arg2: u64, arg3: 0x1::option::Option<0x2::object::ID>, arg4: u64, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: u64, arg9: u64) {
        assert!(arg9 <= 1000, 442);
        let v0 = !0x1::vector::is_empty<u8>(&arg5);
        let v1 = arg4 > 0;
        if (v1) {
            assert!(arg4 >= arg0.created_ms + 600000, 438);
            assert!(arg4 <= arg0.created_ms + 86400000, 438);
        };
        if (v0) {
            assert!(0x1::vector::length<u8>(&arg5) == 32, 438);
            assert!(arg6 >= 3600000 && arg6 <= 86400000, 438);
            assert!(arg7 > 0, 438);
            assert!(arg8 > 0 && arg8 < 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::graduation_sui(&arg0.params), 438);
        } else {
            let v2 = if (arg6 == 0) {
                if (arg7 == 0) {
                    arg8 == 0
        ...
        if (arg9 > 0) {
            ...
            0x2::dynamic_field::add<CreatorTaxKey, u64>(&mut arg0.id, v4, arg9);
        };
        if (v1 || v0) {
            ...
            let v6 = Launch{
                ...
                whitelist_root      : arg5,
                whitelist_ms        : arg6,
                whitelist_cap_sui   : arg7,
                whitelist_max_raise : arg8,
                whitelist_raised    : 0,
                filled_ms           : 0,
                opened_ms           : 0,
            };
            0x2::dynamic_field::add<LaunchKey, Launch>(&mut arg0.id, v5, v6);
        };
    ...
    public fun creator_tax_bps<T0>(arg0: &Curve<T0>) : u64 {
        ...
        if (!0x2::dynamic_field::exists_with_type<CreatorTaxKey, u64>(&arg0.id, v0)) {
            return 0
        };
        let v1 = CreatorTaxKey{dummy_field: false};
        *0x2::dynamic_field::borrow<CreatorTaxKey, u64>(&arg0.id, v1)
    }
    ...
    fun distribute_fee<T0>(arg0: &mut Curve<T0>, arg1: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::Treasury, arg2: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::referral::Registry, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: u64, arg5: 0x1::option::Option<address>, arg6: u64) {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.creator_fees, 0x2::balance::split<0x2::sui::SUI>(&mut v2, 0x1::u64::min(0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::math::mul_div(arg4, arg6, 10000), 0x2::balance::value<0x2::sui::SUI>(&v2))));
    ...
    fun has_launch<T0>(arg0: &Curve<T0>) : bool {
        ...
        0x2::dynamic_field::exists_with_type<LaunchKey, Launch>(&arg0.id, v0)
    }

    fun in_whitelist_phase<T0>(arg0: &Curve<T0>, arg1: u64) : bool {
        if (!has_launch<T0>(arg0)) {
            return false
        };
        let v0 = LaunchKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow<LaunchKey, Launch>(&arg0.id, v0);
        if (0x1::vector::is_empty<u8>(&v1.whitelist_root)) {
            return false
        };
        let (v2, v3) = launch_times(v1, arg0.created_ms);
        arg1 >= v2 && arg1 < v3
    }
    ...
    fun is_open<T0>(arg0: &Curve<T0>) : bool {
        ...
        let v0 = LaunchKey{dummy_field: false};
        0x2::dynamic_field::borrow<LaunchKey, Launch>(&arg0.id, v0).opened_ms > 0
    }
    ...
    public fun launch_phase<T0>(arg0: &Curve<T0>, arg1: &0x2::clock::Clock) : u8 {
        ...
        if (v0 < v3) {
            1
        } else if (v0 < v4 && !0x1::vector::is_empty<u8>(&v2.whitelist_root)) {
            2
        } else {
            3
        }
    ...
    public fun launch_schedule<T0>(arg0: &Curve<T0>) : (u64, u64, u64) {
        if (!has_launch<T0>(arg0)) {
            return (arg0.created_ms, arg0.created_ms, arg0.created_ms)
        };
        let v0 = LaunchKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow<LaunchKey, Launch>(&arg0.id, v0);
        let (v2, v3) = launch_times(v1, arg0.created_ms);
    ...
    public fun lower_creator_tax<T0>(arg0: &mut Curve<T0>, arg1: &0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::Config, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        let v0 = creator_tax_bps<T0>(arg0);
        assert!(arg2 < v0, 443);
        let v1 = CreatorTaxKey{dummy_field: false};
        *0x2::dynamic_field::borrow_mut<CreatorTaxKey, u64>(&mut arg0.id, v1) = arg2;
    ...
    fun open_or_abort<T0>(arg0: &mut Curve<T0>, arg1: u64) {
        ...
        let v0 = LaunchKey{dummy_field: false};
        let (_, v2) = launch_times(0x2::dynamic_field::borrow<LaunchKey, Launch>(&arg0.id, v0), arg0.created_ms);
        assert!(arg1 >= v2 + 600000, 432);
        let v3 = 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::snipe_max_ms(&arg0.params);
        let v4 = LaunchKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<LaunchKey, Launch>(&mut arg0.id, v4).opened_ms = arg1;
        arg0.snipe_window_ms = v3;
        let v5 = Opened{
            curve_id        : 0x2::object::id<Curve<T0>>(arg0),
            opened_ms       : arg1,
            snipe_window_ms : v3,
    ...
    public(friend) fun open_with_window<T0>(arg0: &mut Curve<T0>, arg1: u64, arg2: &0x2::clock::Clock) {
        assert!(arg0.status == 0, 401);
        assert!(has_launch<T0>(arg0), 437);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        let v1 = LaunchKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<LaunchKey, Launch>(&mut arg0.id, v1);
        assert!(v2.opened_ms == 0, 437);
        let (_, v4) = launch_times(v2, arg0.created_ms);
        assert!(v0 >= v4, 432);
        v2.opened_ms = v0;
    ...
    fun snipe_start_ms<T0>(arg0: &Curve<T0>) : u64 {
        ...
        let (_, v3) = launch_times(v1, arg0.created_ms);
        v3
    }
    ...
    public(friend) fun whitelist_buy<T0>(arg0: &mut Curve<T0>, arg1: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::Treasury, arg2: &mut 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::referral::Registry, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: u64, arg6: 0x1::option::Option<address>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = wl_spent<T0>(arg0, v0);
        let v2 = LaunchKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow<LaunchKey, Launch>(&arg0.id, v2);
        let v4 = v3.whitelist_cap_sui;
        let v5 = v3.whitelist_max_raise;
        let v6 = v3.whitelist_raised;
        let v7 = with_tax<T0>(arg0, 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::trade_fee_bps(&arg0.params));
        let v8 = price_buy(k_of(arg0.virtual_sui, arg0.virtual_tokens), arg0.x, arg0.y, 0x2::balance::value<T0>(&arg0.token_reserve), arg4, v7);
        assert!(v8.tokens_out > 0 && v8.tokens_out >= arg5, 402);
        assert!(v1 + v8.gross_in <= v4, 434);
        assert!(v6 + v8.net_in <= v5 && !v8.sells_out, 435);
        let v9 = WlSpentKey{buyer: v0};
        if (0x2::dynamic_field::exists_<WlSpentKey>(&arg0.id, v9)) {
            let v10 = WlSpentKey{buyer: v0};
            *0x2::dynamic_field::borrow_mut<WlSpentKey, u64>(&mut arg0.id, v10) = v1 + v8.gross_in;
        } else {
            let v11 = WlSpentKey{buyer: v0};
            0x2::dynamic_field::add<WlSpentKey, u64>(&mut arg0.id, v11, v8.gross_in);
        };
        let v12 = LaunchKey{dummy_field: false};
        let v13 = 0x2::dynamic_field::borrow_mut<LaunchKey, Launch>(&mut arg0.id, v12);
        v13.whitelist_raised = v6 + v8.net_in;
        let v14 = v13.whitelist_raised >= 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::math::mul_div(v5, 9900, 10000);
        if (v14) {
            v13.filled_ms = arg7;
        };
        if (v14) {
            let v15 = WhitelistFilled{
                curve_id  : 0x2::object::id<Curve<T0>>(arg0),
                raised    : v13.whitelist_raised,
                filled_ms : arg7,
            };
            0x2::event::emit<WhitelistFilled>(v15);
        };
        execute_buy<T0>(arg0, arg1, arg2, arg3, v8, v7, arg6, arg7, arg8)
    }

    fun with_tax<T0>(arg0: &Curve<T0>, arg1: u64) : u64 {
        let v0 = arg1 + creator_tax_bps<T0>(arg0);
        let v1 = 0x918d32f8a0b349584e96113ec425708374161d4798f8c28d63362602831b33ef::config::snipe_start_fee_bps(&arg0.params);
        if (v0 > v1) {
            0x1::u64::max(v1, arg1)
        } else {
            v0
    ...
    public fun wl_spent<T0>(arg0: &Curve<T0>, arg1: address) : u64 {
        ...
        if (!0x2::dynamic_field::exists_with_type<WlSpentKey, u64>(&arg0.id, v0)) {
            return 0
        };
        let v1 = WlSpentKey{buyer: arg1};
        *0x2::dynamic_field::borrow<WlSpentKey, u64>(&arg0.id, v1)
    }
