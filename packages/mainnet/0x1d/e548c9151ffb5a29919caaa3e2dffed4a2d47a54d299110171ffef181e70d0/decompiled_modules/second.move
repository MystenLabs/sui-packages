module 0x1de548c9151ffb5a29919caaa3e2dffed4a2d47a54d299110171ffef181e70d0::second {
    ...
    fun init(arg0: SECOND, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SECOND>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"second"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"2"));
