module 0xfb8906dbc39e821f2cd42faeac156a289fa5b3a714a36ee5c25383e84a4ad637::flash_liquidator {
    ...
    fun assert_package_upgrade_cap(arg0: &0x2::package::UpgradeCap) {
        let v0 = 0x1::type_name::with_defining_ids<OperatorCap>();
        let v1 = 0x2::package::upgrade_package(arg0);
        assert!(0x2::object::id_to_address(&v1) == 0x2::address::from_bytes(0x2::hex::decode(0x1::ascii::into_bytes(0x1::type_name::get_address(&v0)))), 3);
    }
