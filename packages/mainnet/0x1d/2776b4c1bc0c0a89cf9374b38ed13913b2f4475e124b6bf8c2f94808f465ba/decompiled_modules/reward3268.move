module 0x1d2776b4c1bc0c0a89cf9374b38ed13913b2f4475e124b6bf8c2f94808f465ba::reward3268 {
    struct REWARD3268 has drop {
        dummy_field: bool,
    }

    struct TICKET_3268 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3268(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3268>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3268>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3268, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3268>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3268>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3268>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3268>>(v5, 0x2::tx_context::sender(arg1));
    }
