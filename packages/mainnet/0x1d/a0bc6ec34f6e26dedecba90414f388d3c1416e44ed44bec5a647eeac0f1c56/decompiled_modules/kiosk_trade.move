module 0x6978f040cc983b85316a51b4aa70f168d7f7badfb98958a1b0d5f0b979710aec::kiosk_trade {
    ...
    public entry fun kiosk_buy<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: u64, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg6, arg5 * 250 / 10000, arg7), @0x8084455a96bdde21edd8fe48ec3f15dbe1c82b2ee2e0e963d800f3d7d8fbbcd5);
        let (v0, v1) = 0x2::kiosk::purchase<T0>(arg0, arg4, arg6);
        let v2 = v1;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg1, &mut v2, 0x2::coin::split<0x2::sui::SUI>(&mut arg6, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg1, arg5), arg7));
        0x2::kiosk::lock<T0>(arg2, arg3, arg1, v0);
        ...
        0x2::event::emit<KiosKBuyEvent>(v6);
    }
