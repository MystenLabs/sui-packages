module 0x1da7b824063a9bb3cc8e05d7c6690d28e4fc7a6efa3e15364e73689494260ade::squidsquids {
    ...
    public entry fun transfer_with_tax(arg0: &mut 0x2::coin::Coin<SQUIDSQUIDS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg1 * 3 / 100;
        let v1 = arg1 - v0;
        0x1da7b824063a9bb3cc8e05d7c6690d28e4fc7a6efa3e15364e73689494260ade::events::emit_transfer_event(0x2::tx_context::sender(arg3), arg2, v1, v0, 0x2::tx_context::epoch(arg3));
