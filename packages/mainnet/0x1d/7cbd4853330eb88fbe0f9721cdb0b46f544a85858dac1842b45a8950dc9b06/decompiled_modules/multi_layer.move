module 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::multi_layer {
    ...
    fun get_orders_by_layer<T0, T1>(arg0: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2::clock::Clock) : vector<LayerOrderInfo> {
        ...
        while (v2 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(&v0)) {
            ...
            let (v6, v7, _) = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::parse_order_id(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v3));
    ...
    public(friend) fun process_layers<T0, T1, T2, T3>(arg0: &mut 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::mm_state::MMState, arg1: &0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::mm_registry::MMRegistry, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T2, T3>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &vector<u64>, arg12: &vector<u64>, arg13: &vector<u64>, arg14: &vector<u64>, arg15: &vector<u64>, arg16: u64, arg17: u64, arg18: u64, arg19: &0x1::option::Option<0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::OrderbookSnapshot>, arg20: u64, arg21: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg22: &0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::MMConfig, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: u64, arg28: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::is_dry_run(arg22);
        let v3 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::enable_deep_payment(arg22);
        let v4 = get_orders_by_layer<T0, T1>(arg3, arg2, arg5);
        if (!v2 && 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::enable_deep_refill(arg22)) {
            let v5 = 0;
            let v6 = 0;
            while (v6 < v1) {
            ...
            let (_, _) = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::deep_manager::ensure_deep_balance<T0, T1, T2, T3>(arg3, arg4, arg2, arg21, v5, arg6, arg22, arg5, arg28);
        };
        let v10 = 0;
        while (v10 < v1) {
            let v11 = (v10 as u8);
            let v12 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::inv_sizing::apply_multiplier(*0x1::vector::borrow<u64>(arg13, v10), arg17, arg24, arg25);
            let v13 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::inv_sizing::apply_multiplier(*0x1::vector::borrow<u64>(arg14, v10), arg18, arg24, arg25);
            ...
            let v21 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orders::round_bid_price(v19, arg23);
            v19 = v21;
            let v22 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orders::round_ask_price(v20, arg23);
            v20 = v22;
            let v23 = if (v10 == 0) {
                if (0x1::option::is_some<0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::OrderbookSnapshot>(arg19)) {
                    arg20 > 0
                } else {
                    false
                }
            ...
            if (v23) {
                let v24 = 0x1::option::borrow<0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::OrderbookSnapshot>(arg19);
                let (v25, v26) = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::find_queue_snipe_price(v24, v21, true, arg23, arg20);
                let v27 = if (v26) {
                    v25
                } else {
                    0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orders::round_bid_price(v25, arg23)
                };
                v19 = v27;
                let (v28, v29) = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::find_queue_snipe_price(v24, v22, false, arg23, arg20);
                let v30 = if (v29) {
                    v28
                } else {
                    0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orders::round_ask_price(v28, arg23)
                };
                v20 = v30;
                let v31 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::best_bid(v24);
                let v32 = 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::orderbook_analyzer::best_ask(v24);
                if (v32 > 0 && v27 >= v32) {
            ...
            let v34 = if (v12 >= arg25) {
                if (v12 >= 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::min_order_size(arg22)) {
                    v19 >= 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::min_price(arg22)
                } else {
                    false
                }
            } else {
            ...
            let v35 = if (v13 >= arg25) {
                if (v13 >= 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::min_order_size(arg22)) {
                    v20 <= 0x1d7cbd4853330eb88fbe0f9721cdb0b46f544a85858dac1842b45a8950dc9b06::config::max_price(arg22)
                } else {
                    false
                }
            } else {
