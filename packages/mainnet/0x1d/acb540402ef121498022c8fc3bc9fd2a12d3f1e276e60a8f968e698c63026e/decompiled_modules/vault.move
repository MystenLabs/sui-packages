module 0x1dacb540402ef121498022c8fc3bc9fd2a12d3f1e276e60a8f968e698c63026e::vault {
    ...
    entry fun deposit<T0>(arg0: &AdminCap, arg1: &mut Vault, arg2: 0x2::coin::Coin<T0>) {
        ...
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg1.id, v0)) {
            ...
            0x2::balance::join<T0>(&mut v1, 0x2::coin::into_balance<T0>(arg2));
            0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.id, v0, v1);
        };
    }
