module 0x1d85ef10959022b1236e1a6195222f7c9a1cdf0de4a4982a3112dcc268fae41c::reward1251 {
    struct REWARD1251 has drop {
        dummy_field: bool,
    }

    struct TICKET_1251 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1251(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1251>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1251>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1251, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1251>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1251>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1251>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1251>>(v5, 0x2::tx_context::sender(arg1));
    }
