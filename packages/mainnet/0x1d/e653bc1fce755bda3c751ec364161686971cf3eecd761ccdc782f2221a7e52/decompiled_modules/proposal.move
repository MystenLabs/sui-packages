module 0x1de653bc1fce755bda3c751ec364161686971cf3eecd761ccdc782f2221a7e52::proposal {
    ...
    public entry fun vote_porposal<T0, T1>(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::governance_v1::GovernanceInfo, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg2: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::RewardPool<T0>, arg3: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::RewardPool<T1>, arg4: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::governance_v1::Proposal<Certificate>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = Certificate{dummy_field: false};
        ...
        if (0x1::option::is_some<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceCap>(&v1)) {
            ...
            let v3 = 0x2::object::id<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::RewardPool<T0>>(arg2);
            assert!(0x2::object::id_to_address(&v3) == 0x2::address::from_bytes(x"da84329b39e4ebb2a18c09e8cef524e1f0e0421501d916a7a93e9938f7f20454"), 1);
            let v4 = 0x2::object::id<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::RewardPool<T1>>(arg3);
            assert!(0x2::object::id_to_address(&v4) == 0x2::address::from_bytes(x"807aadc45ec152b6a2dbffe5ffe14e23ed469c554b19806448df47983a2a5018"), 1);
            let v5 = 0x2::address::from_bytes(x"65859958bd62e30aa0571f9712962f59098d1eb29f73b091d9d71317d8e67497");
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::remove_reward_pool<T0>(&v2, arg1, arg2, 3, arg5), v5);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::boost::remove_reward_pool<T1>(&v2, arg1, arg3, 8, arg5), v5);
