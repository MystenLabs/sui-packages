module 0x1d7b0208dc2989e9eb862129db359ac1986254699d280c65f4b80b07deda9296::rewards {
    ...
    public fun add_rewards<T0: store + key>(arg0: &mut RewardWheel, arg1: &0x1d7b0208dc2989e9eb862129db359ac1986254699d280c65f4b80b07deda9296::canvas_admin::CanvasAdminCap, arg2: vector<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_reward_wheel(arg0: &0x1d7b0208dc2989e9eb862129db359ac1986254699d280c65f4b80b07deda9296::canvas_admin::CanvasAdminCap, arg1: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = RewardWheel{
        ...
        0x1d7b0208dc2989e9eb862129db359ac1986254699d280c65f4b80b07deda9296::events::emit_wheel_created_event(0x2::object::uid_to_inner(&v0.id), 0x2::tx_context::sender(arg2));
    ...
    public fun set_reward_wheel_metadata(arg0: &0x1d7b0208dc2989e9eb862129db359ac1986254699d280c65f4b80b07deda9296::canvas_admin::CanvasAdminCap, arg1: &mut RewardWheel, arg2: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>) {
        arg1.metadata = arg2;
    }
    ...
    entry fun toggle_reward_wheel(arg0: &0x1d7b0208dc2989e9eb862129db359ac1986254699d280c65f4b80b07deda9296::canvas_admin::CanvasAdminCap, arg1: &mut RewardWheel) {
        arg1.paused = !arg1.paused;
    }

    public fun withdraw_from_reward_wheel<T0: store + key>(arg0: &0x1d7b0208dc2989e9eb862129db359ac1986254699d280c65f4b80b07deda9296::canvas_admin::CanvasAdminCap, arg1: &mut RewardWheel, arg2: u32) : T0 {
