module 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::suipump {
    ...
    public fun buy_with_return<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let (v3, v4, v5) = if (arg4) {
            let v6 = 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::full_math_u64::mul_div_ceil(arg2, arg0.platform_fee, 1000000);
            let v7 = arg2 - v6;
            let v8 = 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::curves::calculate_token_return(v7, v1.virtual_sui_reserves, v1.virtual_token_reserves);
            assert!(v8 >= arg3, 6);
            assert!(v2 >= v8, 9);
            (v6, v7, v8)
        } else {
            let v9 = 0x1::u64::min(arg2, v2);
            let v10 = 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::curves::calculate_liquidity_cost(v1.virtual_sui_reserves, v1.virtual_token_reserves, v9);
            assert!(v10 <= arg3, 7);
            (0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::full_math_u64::mul_div_ceil(v10, arg0.platform_fee, 1000000), v10, v9)
        };
    ...
    public fun sell_with_return<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        assert!(v2 > 0, 2);
        let (v3, v4, v5) = if (arg4) {
            let v6 = 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::curves::calculate_sui_return(arg2, v1.virtual_sui_reserves, v1.virtual_token_reserves);
            let v7 = 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::full_math_u64::mul_div_ceil(v6, arg0.platform_fee, 1000000);
            assert!(v6 - v7 >= arg3, 6);
            (v7, v6, arg2)
        } else {
            let v8 = 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::full_math_u64::mul_div_ceil(arg2, arg0.platform_fee, 1000000);
            let v9 = arg2 + v8;
            let v10 = 0x1d489da3a71fd450e934c890d62d39a14f453ae3f74d2880c563793ce4297756::curves::calculate_token_return(v9, v1.virtual_sui_reserves, v1.virtual_token_reserves);
            assert!(v10 < arg3, 7);
            (v8, v9, v10)
        };
        assert!(v2 >= v5, 11);
