module 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::capsule {
    ...
    public fun bytes_to_ibe_encryption(arg0: &vector<u8>) : IbeEncryption {
        let v0 = b"u";
        let v1 = 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::get_vec_u8(arg0, 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::key(&v0));
        let v2 = b"v";
        let v3 = b"w";
        IbeEncryption{
            u : 0x2::bls12381::g2_from_bytes(&v1),
            v : 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::get_vec_u8(arg0, 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::key(&v2)),
            w : 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::get_vec_u8(arg0, 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::key(&v3)),
        }
    }
    ...
    public fun decrypt_with_round_signature(arg0: &vector<u8>, arg1: vector<u8>) : vector<u8> {
        ...
        let v2 = 0;
        let v3 = 0;
        while (v2 < 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::get_chunks_count(arg0)) {
            let v4 = 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::get_vec_u8(arg0, (v2 as u32));
    ...
    public fun encrypt(arg0: &mut DrandChain, arg1: u64, arg2: &vector<u8>) : vector<u8> {
        let v0 = use_randomness(arg0);
        encrypt_for_round(&arg0.public_key, arg1, arg2, v0)
    }

    public fun encrypt_for_round(arg0: &vector<u8>, arg1: u64, arg2: &vector<u8>, arg3: &vector<u8>) : vector<u8> {
        let v0 = 0x2::bls12381::g2_from_bytes(arg0);
        let v1 = round_key(arg1);
        let v2 = 0x1::vector::empty<u8>();
        let v3 = 0;
        let v4 = 0;
        let v5 = 0x1::vector::length<u8>(arg2);
        while (v3 < v5) {
            ...
            if (v4 == 0) {
                ...
                let v10 = &mut v9;
                0x1::vector::push_back<u8>(v10, (((v5 >> 24) % 256) as u8));
                0x1::vector::push_back<u8>(v10, (((v5 >> 16) % 256) as u8));
                0x1::vector::push_back<u8>(v10, (((v5 >> 8) % 256) as u8));
                0x1::vector::push_back<u8>(v10, ((v5 % 256) as u8));
                0x1::vector::append<u8>(&mut v6, v9);
                v8 = 28;
            };
            while (v7 < v8) {
                if (v3 + v7 < v5) {
                    0x1::vector::push_back<u8>(&mut v6, *0x1::vector::borrow<u8>(arg2, v3 + v7));
                } else {
                    0x1::vector::push_back<u8>(&mut v6, *0x1::vector::borrow<u8>(arg3, v7));
                };
                v7 = v7 + 1;
            };
            let v11 = ibe_encryption_to_bytes(insecure_ibe_encrypt(&v0, &v1, &v6, arg3));
            0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::set<vector<u8>>(&mut v2, v4, &v11);
            v3 = v3 + v8;
            v4 = v4 + 1;
        };
        v2
    ...
    public fun encrypt_for_time(arg0: &mut DrandChain, arg1: u64, arg2: &vector<u8>) : vector<u8> {
        let v0 = round_at(arg0, arg1);
        let v1 = use_randomness(arg0);
        encrypt_for_round(&arg0.public_key, v0, arg2, v1)
    }
    ...
    public fun ibe_encryption_to_bytes(arg0: IbeEncryption) : vector<u8> {
        ...
        let v1 = b"v";
        0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::set<vector<u8>>(&mut v0, 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::key(&v1), &arg0.v);
        let v2 = b"w";
        0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::set<vector<u8>>(&mut v0, 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::key(&v2), &arg0.w);
        let v3 = b"u";
        0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::set<vector<u8>>(&mut v0, 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::metadata::key(&v3), 0x2::group_ops::bytes<0x2::bls12381::G2>(&arg0.u));
        v0
    }

    fun insecure_ibe_encrypt(arg0: &0x2::group_ops::Element<0x2::bls12381::G2>, arg1: &vector<u8>, arg2: &vector<u8>, arg3: &vector<u8>) : IbeEncryption {
        assert!(0x1::vector::length<u8>(arg3) == 32, 0);
        let v0 = 0x2::bls12381::hash_to_g1(arg1);
        let v1 = 0x2::bls12381::pairing(&v0, arg0);
        assert!(0x1::vector::length<u8>(arg2) == 0x1::vector::length<u8>(arg3), 0);
        let v2 = b"HASH3 - ";
        0x1::vector::append<u8>(&mut v2, *arg3);
        0x1::vector::append<u8>(&mut v2, *arg2);
        let v3 = 0x2::hash::blake2b256(&v2);
        let v4 = modulo_order(&v3);
        let v5 = 0x2::bls12381::scalar_from_bytes(&v4);
        let v6 = 0x2::bls12381::g2_generator();
        let v7 = 0x2::bls12381::gt_mul(&v5, &v1);
        let v8 = b"HASH2 - ";
        0x1::vector::append<u8>(&mut v8, *0x2::group_ops::bytes<0x2::bls12381::GT>(&v7));
        let v9 = 0x2::hash::blake2b256(&v8);
        let v10 = 0x1::vector::empty<u8>();
        let v11 = 0;
        while (v11 < 0x1::vector::length<u8>(arg3)) {
            0x1::vector::push_back<u8>(&mut v10, *0x1::vector::borrow<u8>(arg3, v11) ^ *0x1::vector::borrow<u8>(&v9, v11));
            v11 = v11 + 1;
        };
        let v12 = b"HASH4 - ";
        0x1::vector::append<u8>(&mut v12, *arg3);
        let v13 = 0x2::hash::blake2b256(&v12);
        let v14 = 0x1::vector::empty<u8>();
        let v15 = 0;
        while (v15 < 0x1::vector::length<u8>(arg2)) {
            0x1::vector::push_back<u8>(&mut v14, *0x1::vector::borrow<u8>(arg2, v15) ^ *0x1::vector::borrow<u8>(&v13, v15));
            v15 = v15 + 1;
        };
        IbeEncryption{
            u : 0x2::bls12381::g2_mul(&v5, &v6),
            v : v10,
            w : v14,
        }
    }
