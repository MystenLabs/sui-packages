module 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::timecapsule {
    ...
    public entry fun decrypt(arg0: &TimecapsuleStore, arg1: &mut Timecapsule, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::capsule::drand_quicknet();
        if (0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::capsule::verify_signature(&mut v0, arg1.for_round, &arg2) == false) {
            abort 2
        };
        arg1.prophecy = 0x1::string::utf8(0x1d420d002adade6fd88463a7496d064d31a6cc565f503c0629013229e956fc32::capsule::decrypt(&v0, &arg1.encrypted_prophecy, arg2));
        arg1.decrypted = true;
