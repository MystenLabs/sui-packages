module 0x1d476940f4bcbdaadcefd97bc3592b209bbaedf9538d85faf4026676cdb8bf90::capo_mafia_collection {
    ...
    fun init(arg0: CAPO_MAFIA_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut v1;
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"CAPO: King of The Streets"));
