module 0x1d676df72d1fa1b917516f8b1ee53992d9be343e34801131354b2b99d9081221::lofinfts_events {
    ...
    public(friend) fun airdrop_position_created(arg0: u64, arg1: address) {
        ...
        0x1d676df72d1fa1b917516f8b1ee53992d9be343e34801131354b2b99d9081221::event_wrapper::emit_event<AirdropPositionCreated>(v0);
    }

    public(friend) fun finish_super_admin_transfer(arg0: address) {
        let v0 = FinishSuperAdminTransfer{pos0: arg0};
        0x1d676df72d1fa1b917516f8b1ee53992d9be343e34801131354b2b99d9081221::event_wrapper::emit_event<FinishSuperAdminTransfer>(v0);
    }
    ...
    public(friend) fun new_admin(arg0: address) {
        ...
        0x1d676df72d1fa1b917516f8b1ee53992d9be343e34801131354b2b99d9081221::event_wrapper::emit_event<NewAdmin>(v0);
    }
    ...
    public(friend) fun revoke_admin(arg0: address) {
        ...
        0x1d676df72d1fa1b917516f8b1ee53992d9be343e34801131354b2b99d9081221::event_wrapper::emit_event<RevokeAdmin>(v0);
    }
    ...
    public(friend) fun start_super_admin_transfer(arg0: address, arg1: u64) {
        ...
        0x1d676df72d1fa1b917516f8b1ee53992d9be343e34801131354b2b99d9081221::event_wrapper::emit_event<StartSuperAdminTransfer>(v0);
    }
