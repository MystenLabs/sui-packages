module 0x1d0ed54d8decbe97772d2be411e46d02035587d82c1f643a6169e6abd0b5a0e7::cnsnft4745 {
    struct CNSNFT4745 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4745, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4745>(arg0, arg1);
