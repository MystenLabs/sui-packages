module 0x1d3d6cfca764ece3c1cef12033df9cdfbc034465a8046e7d3137e4a0be632acc::nft {
    ...
    public entry fun add_object(arg0: &mut VisitorList, arg1: &mut CoCoNFT, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x1::string::String, 0x1d3d6cfca764ece3c1cef12033df9cdfbc034465a8046e7d3137e4a0be632acc::item::CoCoItem>(&mut arg1.id, item_key(), 0x1d3d6cfca764ece3c1cef12033df9cdfbc034465a8046e7d3137e4a0be632acc::item::new_item(arg3, arg4, arg5, arg2, arg6));
    }
