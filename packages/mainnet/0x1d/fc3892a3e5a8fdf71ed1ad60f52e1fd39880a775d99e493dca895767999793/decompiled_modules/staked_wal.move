module 0x1dfc3892a3e5a8fdf71ed1ad60f52e1fd39880a775d99e493dca895767999793::staked_wal {
    struct STAKED_WAL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STAKED_WAL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STAKED_WAL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Staked Wal"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Staked Wal "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreib6arixp5glowugta4madammf65c64hzjai3oql3htkdo4jbgs4sa"));
