module 0x98427405860694d5a0be19830e3a6c3a60805fc453556113b02638cda9633442::reward6319 {
    struct REWARD6319 has drop {
        dummy_field: bool,
    }

    struct TICKET_6319 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6319(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6319>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6319>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6319, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6319>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6319>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6319>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6319>>(v5, 0x2::tx_context::sender(arg1));
    }
