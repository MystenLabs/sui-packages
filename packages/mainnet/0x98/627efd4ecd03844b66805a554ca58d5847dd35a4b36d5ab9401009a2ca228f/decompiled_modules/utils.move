module 0x98627efd4ecd03844b66805a554ca58d5847dd35a4b36d5ab9401009a2ca228f::utils {
    public fun get_description_nft() : vector<u8> {
        b"1000 Gods yet to be revived !!!"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeiawh5ovgm2l7ziijmtobo3hxmoz3ugbe5kgf4phz45efrsoffvvqu//"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeibcos2njkqe5v3pho4kyc3xfv5mvcdzriwfihldghu2bsqo7qkf5e/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/SuiGodsNFT_"
    }
