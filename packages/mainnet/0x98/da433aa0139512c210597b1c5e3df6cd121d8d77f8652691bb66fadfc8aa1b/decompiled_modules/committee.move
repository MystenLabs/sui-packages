module 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::committee {
    ...
    public(friend) fun initialize(arg0: 0x2::vec_map::VecMap<0x2::object::ID, u16>) : Committee {
        let v0 = 0;
        let v1 = if (0x2::vec_map::length<0x2::object::ID, u16>(&arg0) <= 1) {
            arg0
        } else {
    ...
    public fun size(arg0: &Committee) : u64 {
        0x2::vec_map::length<0x2::object::ID, vector<u16>>(&arg0.pos0)
    }
    ...
    public(friend) fun transition(arg0: &Committee, arg1: 0x2::vec_map::VecMap<0x2::object::ID, u16>) : Committee {
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x2::vec_map::length<0x2::object::ID, u16>(&arg1)) {
        ...
        let v6 = 0;
        let v7 = 0;
        while (v7 < 0x2::vec_map::length<0x2::object::ID, vector<u16>>(&arg0.pos0)) {
        ...
        let v33 = if (0x2::vec_map::length<0x2::object::ID, vector<u16>>(&v4) <= 1) {
            v4
        } else {
