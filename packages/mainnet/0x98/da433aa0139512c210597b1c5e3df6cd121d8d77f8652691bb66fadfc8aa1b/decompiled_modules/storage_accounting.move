module 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::storage_accounting {
    ...
    public(friend) fun extract_burn_balance(arg0: &mut FutureAccountingRingBuffer) : 0x2::balance::Balance<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL> {
        let v0 = 0x1::vector::borrow_mut<FutureAccounting>(&mut arg0.ring_buffer, (arg0.current_index as u64));
        let v1 = rewards_balance(v0);
        0x2::balance::split<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(v1, 0x2::balance::value<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(v1) * 3 / 100)
    }
