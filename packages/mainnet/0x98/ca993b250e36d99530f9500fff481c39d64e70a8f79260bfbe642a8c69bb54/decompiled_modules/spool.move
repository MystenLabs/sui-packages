module 0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::spool {
    struct Spool has store, key {
        ...
        ve_sca_bind: 0x2::table::Table<0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x2::object::ID>,
        stakes: u64,
        min_stakes: u64,
        max_stakes: u64,
        rewards: 0x2::bag::Bag,
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Spool {
        Spool{
            ...
            ve_sca_bind            : 0x2::table::new<0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x2::object::ID>(arg2),
            stakes                 : 0,
            min_stakes             : arg0,
            max_stakes             : arg1,
    ...
    public(friend) fun accrue_points(arg0: &mut Spool, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.points_list)) {
            ...
            v2.index = v2.index + 0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::utils::mul_div(1000000000, v5, v2.weighted_amount);
            v1 = v1 + 1;
        };
    }
    ...
    public(friend) fun bind_ve_sca_to_spool_account(arg0: &mut Spool, arg1: 0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, arg2: 0x2::object::ID) {
        0x2::table::add<0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x2::object::ID>(&mut arg0.ve_sca_bind, arg1, arg2);
    }
    ...
    public fun is_ve_sca_binded(arg0: &Spool, arg1: 0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>) : bool {
        0x2::table::contains<0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x2::object::ID>(&arg0.ve_sca_bind, arg1)
    }
    ...
    public(friend) fun unbind_ve_sca_from_spool_account(arg0: &mut Spool, arg1: 0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, arg2: 0x2::object::ID) {
        assert!(0x2::table::remove<0x98ca993b250e36d99530f9500fff481c39d64e70a8f79260bfbe642a8c69bb54::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0x2::object::ID>(&mut arg0.ve_sca_bind, arg1) == arg2, 1);
    }
