module 0x98a7e983015bab950f8f8b8067321ab72c49ae40fcbf5c0db73ab273c7dbe6b9::supergrok {
    ...
    fun init(arg0: SUPERGROK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<SUPERGROK>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"SuperGrok ")))), trim_right(b"SuperGrok                       "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
