module 0x98d999266fa56ff6fc79e64e5b909cf3e54d97c3e453ea28b5ab645efbd7a301::cnsnft9168 {
    struct CNSNFT9168 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9168, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3812"));
        let v4 = 0x2::package::claim<CNSNFT9168>(arg0, arg1);
