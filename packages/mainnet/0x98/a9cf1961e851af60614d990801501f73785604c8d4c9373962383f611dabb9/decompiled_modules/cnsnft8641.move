module 0x98a9cf1961e851af60614d990801501f73785604c8d4c9373962383f611dabb9::cnsnft8641 {
    struct CNSNFT8641 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8641, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3790"));
        let v4 = 0x2::package::claim<CNSNFT8641>(arg0, arg1);
