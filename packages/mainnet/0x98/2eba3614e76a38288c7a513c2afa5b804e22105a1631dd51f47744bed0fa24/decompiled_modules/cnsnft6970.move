module 0x982eba3614e76a38288c7a513c2afa5b804e22105a1631dd51f47744bed0fa24::cnsnft6970 {
    struct CNSNFT6970 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6970, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6970>(arg0, arg1);
