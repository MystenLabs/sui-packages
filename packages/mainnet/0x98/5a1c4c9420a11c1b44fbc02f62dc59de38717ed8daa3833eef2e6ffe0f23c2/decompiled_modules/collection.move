module 0x985a1c4c9420a11c1b44fbc02f62dc59de38717ed8daa3833eef2e6ffe0f23c2::collection {
    struct HouseCollectionNFT has store, key {
        id: 0x2::object::UID,
        url: 0x2::url::Url,
        level: u64,
        attributes: 0x985a1c4c9420a11c1b44fbc02f62dc59de38717ed8daa3833eef2e6ffe0f23c2::attributes::Attributes,
    }
    ...
    fun init(arg0: COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        let v5 = v2;
        0x985a1c4c9420a11c1b44fbc02f62dc59de38717ed8daa3833eef2e6ffe0f23c2::royalty_rule::add<HouseCollectionNFT>(&mut v5, &v4, 600, 0);
        0x985a1c4c9420a11c1b44fbc02f62dc59de38717ed8daa3833eef2e6ffe0f23c2::kiosk_lock_rule::add<HouseCollectionNFT>(&mut v5, &v4);
    ...
    public(friend) fun mint_(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : HouseCollectionNFT {
        ...
        HouseCollectionNFT{
            id         : 0x2::object::new(arg1),
            url        : 0x2::url::new_unsafe_from_bytes(0x985a1c4c9420a11c1b44fbc02f62dc59de38717ed8daa3833eef2e6ffe0f23c2::constants::get_nft_image((arg0 as u64))),
            level      : (arg0 as u64),
            attributes : 0x985a1c4c9420a11c1b44fbc02f62dc59de38717ed8daa3833eef2e6ffe0f23c2::attributes::from_vec(&mut v0, &mut v2),
        }
    }
