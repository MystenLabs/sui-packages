module 0x988780713f081519ec62860bf5f88d66b94581a0f520d454633410d0825588d3::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<SNFT>(v6, @0x2153fd135a789448f40cfde8464b8216ceca4081222b2e376c1ffe060c308b4a);
    }
