module 0x988834d2d6ba54ae450033b89f0efa15c4507dcc0df2b074af9518e4e8797faf::cnsnft9427 {
    struct CNSNFT9427 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9427, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9427>(arg0, arg1);
