module 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::tocen_marketplace {
    ...
    public entry fun accept_collection_offer_list<T0: store + key>(arg0: &mut Marketplace, arg1: &mut CollectionOffer, arg2: 0x2::object::ID, arg3: u64, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_version(), 123);
        ...
        let (_, v7, v8) = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::royalties::fee_service_collection(arg3, arg0.fee_service, *v2);
        *v3 = *v3 + v8;
    ...
    public entry fun accept_collection_offer_list_v2<T0: store + key>(arg0: &mut Marketplace, arg1: &mut CollectionOffer, arg2: 0x2::object::ID, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, v8, v9) = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::royalties::fee_service_collection(arg3, arg0.fee_service, *v2);
        *v3 = *v3 + v9;
    ...
    public entry fun accept_offer_list<T0: store + key>(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v12 == true, 7);
        let v14 = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_list();
        ...
        v3.owner = @0x0;
        v3.price = 0;
        *v6 = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_not_list();
        0x1::vector::remove<Offer>(v4, v13);
        let (v15, v16, v17) = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::royalties::fee_service_collection(arg3, arg0.fee_service, *v10);
        *v11 = *v11 + v17;
    ...
    public entry fun accept_offer_not_list<T0: store + key>(arg0: &mut Marketplace, arg1: T0, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v12, v13, v14) = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::royalties::fee_service_collection(arg3, arg0.fee_service, *v8);
        *v9 = *v9 + v14;
    ...
    public fun buy<T0: store + key>(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v8 = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_list();
        assert!(v3 == &v8, 3);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= v2.price, 2);
        let (v9, v10, v11) = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::royalties::fee_service_collection(v2.price, arg0.fee_service, *v6);
        let v12 = v2.owner;
        *v7 = *v7 + v11;
        ...
        *v3 = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_not_list();
        v2.price = 0;
        v2.owner = @0x0;
    ...
    public entry fun buy_cart<T0: store + key>(arg0: &mut Marketplace, arg1: vector<0x2::object::ID>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<0x2::object::ID>(&arg1) > 0) {
            ...
            let (v11, v12, v13) = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::royalties::fee_service_collection(v9.price, arg0.fee_service, *v4);
            *v5 = *v5 + v13;
            ...
            *v10 = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_not_list();
            v9.price = 0;
            v9.owner = @0x0;
        };
    ...
    fun check_list_nft(arg0: &mut Marketplace, arg1: vector<0x2::object::ID>) : (bool, u64) {
        ...
        while (0x1::vector::length<0x2::object::ID>(&arg1) > 0) {
            ...
            let v3 = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_not_list();
            if (&mut v1.status == &v3) {
                return (false, 0)
            };
            v0 = v0 + v2.price;
    ...
    public fun delist<T0: store + key>(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v2 = &mut v0.list_on_sale;
        let v3 = &mut v0.status;
        let v4 = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_list();
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Marketplace{
            ...
            fee_service                 : 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_fee_service(),
            feeBalance                  : 0x2::balance::zero<0x2::sui::SUI>(),
            fee_collection_unregistered : 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_fee_collection_unregistered(),
            collection_market           : 0x2::table::new<0x1::type_name::TypeName, Collection>(arg0),
            version                     : 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_version(),
        };
    ...
    public entry fun list<T0: store + key>(arg0: &mut Marketplace, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, v1)) {
            let v2 = init_nft_list(v0, arg2, 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_list(), arg3);
            ...
            v4.owner = v0;
            v4.price = arg2;
            v3.status = 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_list();
    ...
    public entry fun order_offer<T0: store + key>(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, arg1)) {
            let v1 = init_nft_list(@0x0, 0, 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_status_not_list(), arg4);
    ...
    public entry fun register_collection_market<T0: store + key>(arg0: &mut Marketplace, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::config::get_version(), 123);
        assert!(0x98059411a57b5f660448b603868111bf87879c7782c0ec39417f45d7b74e1ffc::owner::check_owner(arg2), 1);
