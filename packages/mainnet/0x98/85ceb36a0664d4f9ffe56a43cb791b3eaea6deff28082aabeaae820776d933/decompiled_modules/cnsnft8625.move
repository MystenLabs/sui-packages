module 0x9885ceb36a0664d4f9ffe56a43cb791b3eaea6deff28082aabeaae820776d933::cnsnft8625 {
    struct CNSNFT8625 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8625, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8625>(arg0, arg1);
