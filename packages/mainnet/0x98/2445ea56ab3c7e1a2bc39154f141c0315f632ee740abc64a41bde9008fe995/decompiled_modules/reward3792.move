module 0x982445ea56ab3c7e1a2bc39154f141c0315f632ee740abc64a41bde9008fe995::reward3792 {
    struct REWARD3792 has drop {
        dummy_field: bool,
    }

    struct TICKET_3792 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3792(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3792>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3792>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3792>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3792>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3792>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3792>>(v5, 0x2::tx_context::sender(arg1));
    }
