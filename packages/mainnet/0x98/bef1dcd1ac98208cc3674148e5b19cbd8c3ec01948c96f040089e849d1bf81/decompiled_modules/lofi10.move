module 0x98bef1dcd1ac98208cc3674148e5b19cbd8c3ec01948c96f040089e849d1bf81::lofi10 {
    struct LOFI10 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI10, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LOFI10>(arg0, 9, b"LOFI10", b"LOFI10", b"LOFI10", v2, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LOFI10>>(v4);
        0x2::transfer::public_share_object<0x2::coin::TreasuryCap<LOFI10>>(v3);
    ...
    public entry fun transfer_with_tax(arg0: &TaxStorage, arg1: &AdminCap, arg2: &mut 0x2::coin::Coin<LOFI10>, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        ...
        let v3 = 0x2::balance::split<LOFI10>(0x2::coin::balance_mut<LOFI10>(arg2), arg3);
        if (v0 > 0) {
            let v4 = arg3 * v0 / 10000;
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI10>>(0x2::coin::from_balance<LOFI10>(0x2::balance::split<LOFI10>(&mut v3, v4), arg5), arg1.admin_address);
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI10>>(0x2::coin::from_balance<LOFI10>(0x2::balance::split<LOFI10>(&mut v3, arg3 - v4), arg5), arg4);
            0x2::balance::destroy_zero<LOFI10>(v3);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<LOFI10>>(0x2::coin::from_balance<LOFI10>(v3, arg5), arg4);
        };
    }
