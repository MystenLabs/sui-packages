module 0x9833f7817e404c7384956d53d35b4af157401ccfbe84292769c0f14be1698cb7::elementals {
    ...
    public entry fun mint_element(arg0: &AdminRegistry, arg1: address, arg2: address, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(0x2::vec_set::contains<address>(&arg0.admins, &v0), 3);
        assert!(arg1 == arg2, 4);
        let v1 = vector[b"Aether", b"Air", b"Fire", b"Earth", b"Water"];
        assert!(0x1::vector::contains<vector<u8>>(&v1, 0x1::string::as_bytes(&arg8)), 2);
        let v2 = ElementNFT{
        ...
        0x2::transfer::public_transfer<ElementNFT>(v2, arg2);
    }
