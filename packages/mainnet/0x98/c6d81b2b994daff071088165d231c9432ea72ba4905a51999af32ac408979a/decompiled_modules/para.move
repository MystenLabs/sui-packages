module 0x98c6d81b2b994daff071088165d231c9432ea72ba4905a51999af32ac408979a::para {
    ...
    public fun flash_loan_cetus_wrapper<T0, T1>(arg0: &mut 0x2::object::UID, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>) {
    ...
    public fun repay_loan_cetus_wrapper<T0, T1>(arg0: &mut 0x2::object::UID, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) {
