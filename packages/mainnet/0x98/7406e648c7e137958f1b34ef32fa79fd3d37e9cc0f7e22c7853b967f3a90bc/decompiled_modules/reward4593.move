module 0x987406e648c7e137958f1b34ef32fa79fd3d37e9cc0f7e22c7853b967f3a90bc::reward4593 {
    struct REWARD4593 has drop {
        dummy_field: bool,
    }

    struct TICKET_4593 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4593(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4593>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4593>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4593, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4593>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4593>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4593>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4593>>(v5, 0x2::tx_context::sender(arg1));
    }
