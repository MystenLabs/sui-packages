module 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::bonding_curve {
    ...
    public(friend) fun buy_<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: address, arg4: address, arg5: &mut BondingCurve<T0>, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: bool, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        if (0x2::balance::value<T0>(&arg5.coin_vault) == 0) {
            arg5.ended = true;
            migrate_to_dex<T0>(arg5, arg0, arg1, arg2, arg10, arg3, arg4, arg11);
        };
        ...
        (0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(arg6), v3), arg11), 0x2::coin::from_balance<T0>(v14, arg11))
    }
    ...
    public(friend) fun create_<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: 0x2::coin::TreasuryCap<T0>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        let v0 = arg4 - arg5;
        let v1 = 0x2::coin::mint_balance<T0>(&mut arg2, arg4);
        let v2 = arg6 + arg5;
    ...
    public(friend) fun first_buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        assert!(!arg0.ended, 0);
    ...
    fun max_tick() : 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::I32 {
        0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::from(443636)
    }
    ...
    public(friend) fun migrate_to_dex<T0>(arg0: &mut BondingCurve<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg4: &0x2::clock::Clock, arg5: address, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v0 - v4 - v5;
        let (v7, v8, v9) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v3_with_creation_cap<T0, 0x2::sui::SUI>(arg1, arg2, &mut arg0.pool_creation_cap, 200, calculate_sqrt_price(v6, v1 - 40000000000000000), 0x1::string::utf8(b"SUI-Token Full Range Pool - from Eric"), 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::as_u32(0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::mul(0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::div(min_tick(), 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::from(200)), 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::from(200))), 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::as_u32(0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::mul(0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::div(max_tick(), 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::from(200)), 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::from(200))), 0x2::coin::from_balance<T0>(v2, arg7), 0x2::coin::from_balance<0x2::sui::SUI>(v3, arg7), true, arg4, arg7);
        let v10 = v7;
    ...
    fun min_tick() : 0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::I32 {
        0x9580191d2a2a77a868fa516b59bc92427bd07cb93971c46c65f9175c5906bcb9::i32::neg_from(443636)
    }
    ...
    public(friend) fun sell_<T0>(arg0: &mut BondingCurve<T0>, arg1: 0x2::coin::Coin<T0>, arg2: bool, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<0x2::sui::SUI>) {
        assert!(!arg0.ended, 0);
        assert!(arg0.first_buy, 1);
