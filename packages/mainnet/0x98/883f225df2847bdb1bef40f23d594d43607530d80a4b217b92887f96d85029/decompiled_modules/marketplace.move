module 0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::marketplace {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Marketplace>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223374175748620291);
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg1), 9223374180043587587);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v0), 9223374184338685957);
        let v1 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg1), v1), 9223374188634046475);
        ...
        let Listing {
            ...
            purchase_cap : v5,
            timestamp    : v6,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v2);
        ...
        let Bidding {
            ...
            funds     : v11,
            timestamp : v12,
        } = 0x2::bag::remove<BidItem, Bidding<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg1), v7);
        ...
        0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::witness_rule_marketplace::confirm<T0, Purchase>(v19, arg3, &mut v18);
        0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::lock<T0>(arg1, v16, arg3);
        ...
        (v18, 0x2::transfer_policy::new_request<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Marketplace>(arg2, v10, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v20, 0x2::coin::split<T1>(&mut v13, arg6, arg7))
    }

    public fun accept_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut Collection, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Marketplace>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223374381907050499);
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg1), 9223374386202017795);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v0), 9223374390497116165);
        let v1 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg3.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg1), v1), 9223374394792476683);
        let v2 = ListItem{id: arg2};
        let Listing {
            seller       : v3,
            price        : _,
        ...
        let CollectionBid {
            ...
            funds     : v9,
            timestamp : v10,
        } = 0x2::bag::remove<CollectionBidItem, CollectionBid<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg1), v7);
        let v11 = v9;
        ...
        let v18 = v17;
        let v19 = Purchase{dummy_field: false};
        0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::witness_rule_marketplace::confirm<T0, Purchase>(v19, arg4, &mut v18);
        0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::lock<T0>(arg1, v16, arg4);
        let v20 = TradeInfo<T0>{
            item_id   : arg2,
            coin_type : v14,
            price     : v12,
        ...
        (v18, 0x2::transfer_policy::new_request<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Marketplace>(arg2, v12, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v20, 0x2::coin::split<T1>(&mut v13, arg7, arg8))
    }
    ...
    public fun cancel_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223373896575746051);
        let v0 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v0), 9223373900871237643);
        ...
        let Bidding {
            ...
            funds     : v9,
            timestamp : _,
        } = 0x2::bag::remove<BidItem, Bidding<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v5);
    ...
    public fun cancel_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223374034014699523);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v0), 9223374038310191115);
        let v1 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v2 = 0x1::bcs::to_bytes<0x2::object::ID>(&v1);
        let v3 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v2, 0x1::bcs::to_bytes<address>(&v3));
        ...
        let CollectionBid {
            ...
            funds     : v8,
            timestamp : _,
        } = 0x2::bag::remove<CollectionBidItem, CollectionBid<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v6);
    ...
    public fun delist<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: &mut MarketplaceConfig, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223373179316207619);
        ...
        let Listing {
            ...
            purchase_cap : v7,
            timestamp    : _,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v4);
    ...
    public fun list<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut MarketplaceConfig, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223373003222548483);
        let v0 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v1 = 0x1::bcs::to_bytes<0x2::object::ID>(&v0);
        let v2 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v1, 0x1::bcs::to_bytes<address>(&v2));
        ...
        0x2::bag::add<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v4, v5);
        let v6 = ListingEvent{
            item_id   : arg2,
    ...
    public fun place_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &0x2::clock::Clock, arg8: vector<u8>, arg9: &mut MarketplaceConfig, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223373535798493187);
        let v0 = ListItem{id: arg3};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg2), v0), 9223373540093591557);
        let v1 = BidItem{id: arg3};
        assert!(!0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v1), 9223373544388821001);
        ...
        let v8 = 0x2::bag::borrow<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg2), v7);
        let v9 = &v8.seller;
        ...
        0x2::bag::add<BidItem, Bidding<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v10, v11);
    ...
    public fun place_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: vector<u8>, arg6: &mut MarketplaceConfig, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223373741956923395);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(!0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v0), 9223373746252283913);
        let v1 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v2 = 0x1::bcs::to_bytes<0x2::object::ID>(&v1);
        let v3 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v2, 0x1::bcs::to_bytes<address>(&v3));
        ...
        0x2::bag::add<CollectionBidItem, CollectionBid<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v7, v8);
    ...
    public fun purchase<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Marketplace>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Extension>(arg0), 9223373338229997571);
        let v0 = ListItem{id: arg1};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v0), 9223373342525095941);
        ...
        let Listing {
            ...
            purchase_cap : v4,
            timestamp    : v5,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::bag_mut(arg0), v1);
        ...
        0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::witness_rule_marketplace::confirm<T0, Purchase>(v12, arg3, &mut v11);
        ...
        (v9, v11, 0x2::transfer_policy::new_request<0x98883f225df2847bdb1bef40f23d594d43607530d80a4b217b92887f96d85029::extension::Marketplace>(arg1, v3, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v13, 0x2::coin::split<T1>(&mut arg2, arg6, arg7))
    }
