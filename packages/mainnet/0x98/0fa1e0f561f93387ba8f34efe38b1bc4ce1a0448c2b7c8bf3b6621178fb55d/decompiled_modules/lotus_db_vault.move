module 0x980fa1e0f561f93387ba8f34efe38b1bc4ce1a0448c2b7c8bf3b6621178fb55d::lotus_db_vault {
    struct LotusDBVault<phantom T0> has store, key {
        id: 0x2::object::UID,
        td_pool: 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Pool<T0>,
        td_pool_admin_cap: 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::AdminCap,
        stake: 0x1::option::Option<0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Stake<T0>>,
    ...
    public fun new<T0>(arg0: 0x2::object::ID, arg1: &mut 0x2::tx_context::TxContext) : (LotusDBVault<T0>, LotusDBVaultCap) {
        let (v0, v1) = 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::create<T0>(arg1);
        ...
        let v3 = LotusDBVault<T0>{
            ...
            stake              : 0x1::option::none<0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Stake<T0>>(),
            allowed_pool       : arg0,
            balance_manager    : v2,
    ...
    public fun add_to_td_farm<T0, T1>(arg0: &mut LotusDBVault<T0>, arg1: &mut 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::farm::Farm<T1>, arg2: &0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::farm::AdminCap, arg3: u32, arg4: &0x2::clock::Clock) {
        0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::add_to_farm<T1, T0>(arg2, arg1, &arg0.td_pool_admin_cap, &mut arg0.td_pool, arg3, arg4);
    }
    ...
    public fun collect_incentive_rewards_to_vault<T0, T1>(arg0: &mut LotusDBVault<T0>, arg1: &mut 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::farm::Farm<T1>, arg2: 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::TopUpTicket, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T1>());
        if (0x2::bag::contains<0x1::ascii::String>(&arg0.incentive_balances, v0)) {
            0x2::balance::join<T1>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T1>>(&mut arg0.incentive_balances, v0), 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::collect_all_rewards<T1, T0>(&mut arg0.td_pool, 0x1::option::borrow_mut<0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Stake<T0>>(&mut arg0.stake), arg2));
        } else {
            0x2::bag::add<0x1::ascii::String, 0x2::balance::Balance<T1>>(&mut arg0.incentive_balances, v0, 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::collect_all_rewards<T1, T0>(&mut arg0.td_pool, 0x1::option::borrow_mut<0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Stake<T0>>(&mut arg0.stake), arg2));
        };
    }

    public fun deposit_shares<T0>(arg0: &mut LotusDBVault<T0>, arg1: &mut 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Stake<T0>, arg2: 0x2::coin::Coin<T0>, arg3: 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::TopUpTicket, arg4: &mut 0x2::tx_context::TxContext) {
        0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::deposit_shares<T0>(&mut arg0.td_pool, arg1, 0x2::coin::into_balance<T0>(arg2), arg3);
    }

    public fun deposit_shares_new<T0>(arg0: &mut LotusDBVault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::TopUpTicket, arg3: &mut 0x2::tx_context::TxContext) {
        0x1::option::fill<0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Stake<T0>>(&mut arg0.stake, 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::deposit_shares_new<T0>(&mut arg0.td_pool, 0x2::coin::into_balance<T0>(arg1), arg2, arg3));
    }
    ...
    public fun get_stake_value<T0>(arg0: &LotusDBVault<T0>) : u64 {
        0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::stake_balance<T0>(0x1::option::borrow<0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::Stake<T0>>(&arg0.stake))
    }

    public fun get_td_farm_member_key_id<T0>(arg0: &LotusDBVault<T0>) : 0x2::object::ID {
        0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::farm_key_id<T0>(&arg0.td_pool)
    }
    ...
    public fun new_top_up_ticket<T0>(arg0: &mut LotusDBVault<T0>) : 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::TopUpTicket {
        0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::new_top_up_ticket<T0>(&mut arg0.td_pool)
    }
    ...
    public fun td_pool_top_up<T0, T1>(arg0: &mut 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::farm::Farm<T1>, arg1: &mut LotusDBVault<T0>, arg2: &mut 0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::TopUpTicket, arg3: &0x2::clock::Clock) {
        0xec93d2eed75c60c9774c0b9f1841f1d547796c9b7fa010aa663f9633a7cef46e::pool::top_up<T1, T0>(arg0, &mut arg1.td_pool, arg2, arg3);
    }
