module 0x986b00f028f46c32237100a416033f6d1bce5f63a725aeb18ca3c604a266c13e::reward2928 {
    struct REWARD2928 has drop {
        dummy_field: bool,
    }

    struct TICKET_2928 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2928(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_2928>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2928, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2928>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2928>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2928>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2928>>(v5, 0x2::tx_context::sender(arg1));
    }
