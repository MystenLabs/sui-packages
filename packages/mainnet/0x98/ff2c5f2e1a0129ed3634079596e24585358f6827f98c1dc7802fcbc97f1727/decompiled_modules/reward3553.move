module 0x98ff2c5f2e1a0129ed3634079596e24585358f6827f98c1dc7802fcbc97f1727::reward3553 {
    struct REWARD3553 has drop {
        dummy_field: bool,
    }

    struct TICKET_3553 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3553(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3553>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3553>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3553, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3553>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3553>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3553>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3553>>(v5, 0x2::tx_context::sender(arg1));
    }
