module 0x9832588705671cb850798db05061db85da1f375c261752c58845d95166d046a9::survived_cetus_ {
    struct SURVIVED_CETUS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SURVIVED_CETUS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SURVIVED_CETUS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Survived Cetus!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"If you own this, you own a piece of history from 05/22."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://iEdLyNdi6-Ck9Hf3ddVuaUkhUOrSZvpHUc904xIFOps"));
