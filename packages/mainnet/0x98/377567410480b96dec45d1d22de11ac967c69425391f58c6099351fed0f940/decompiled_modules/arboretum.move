module 0x6f13fefeb11114a97c3177b7d4a8cfdacd5b40174ab3f80b07420b456d469a2b::arboretum {
    ...
    entry fun reset_season(arg0: &AdminCap, arg1: &mut Registry, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&arg1.reward_pool);
        let v2 = if (v1 > 0) {
            0x2::balance::split<0x2::sui::SUI>(&mut arg1.reward_pool, v1)
        } else {
            0x2::balance::zero<0x2::sui::SUI>()
        };
        let v3 = arg1.current_season_id;
        let v4 = arg1.season_start_ms;
        let v5 = v0 + 604800000;
        let v6 = SeasonArchive{
            id                  : 0x2::object::new(arg3),
            admin               : arg1.admin,
            season_id           : v3,
            season_start_ms     : v4,
            season_end_ms       : v4 + 2592000000,
            finalized_at_ms     : v0,
            claim_deadline_ms   : v5,
            total_growth_points : arg1.total_growth_points,
            total_seeds         : arg1.total_seeds,
            reward_pool         : v2,
            swept               : false,
        };
        let v7 = SeasonArchived{
            archive_id          : 0x2::object::id<SeasonArchive>(&v6),
            season_id           : v3,
            finalized_at_ms     : v0,
            claim_deadline_ms   : v5,
            reward_pool_mist    : v1,
        ...
        0x2::event::emit<SeasonArchived>(v7);
        arg1.total_growth_points = 0;
        arg1.season_start_ms = 0;
        arg1.total_seeds = 0;
        let v8 = SeasonReset{season_id: v3};
        0x2::event::emit<SeasonReset>(v8);
        0x2::transfer::share_object<SeasonArchive>(v6);
    }
