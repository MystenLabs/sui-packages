module 0x9839f8ce979df7e33679dcd0b9656add7d97c667fec955f1d93ac1ec8df2355e::cnsnft6778 {
    struct CNSNFT6778 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6778, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6778>(arg0, arg1);
