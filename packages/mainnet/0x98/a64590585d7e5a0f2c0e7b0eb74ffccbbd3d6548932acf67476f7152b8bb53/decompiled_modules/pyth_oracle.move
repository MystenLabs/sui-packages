module 0xa59fb76bc3c9f9d62277a21d20d3176ed4e20a3dd408ed7b583de23967cc6ada::pyth_oracle {
    ...
    public fun get_oracle_price_x128(arg0: &OracleConfig, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: bool, arg4: &0x2::clock::Clock) : u256 {
        to_bluefin_price(arg0, arg0.oracle_price_a2b, get_oracle_price(arg0, arg1, arg2, arg4))
    }
    ...
    public fun to_bluefin_price(arg0: &OracleConfig, arg1: bool, arg2: u64) : u256 {
        if (arg1 == arg0.oracle_price_a2b) {
            (arg2 as u256) * 0x1::u256::pow(10, arg0.token_b_decimals) * 340282366920938463463374607431768211456 / 0x1::u256::pow(10, arg0.oracle_price_decimals) * 0x1::u256::pow(10, arg0.token_a_decimals)
        } else {
            0x1::u256::pow(10, arg0.oracle_price_decimals) * 0x1::u256::pow(10, arg0.token_a_decimals) * 340282366920938463463374607431768211456 / (arg2 as u256) * 0x1::u256::pow(10, arg0.token_b_decimals)
        }
    }
