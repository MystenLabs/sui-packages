module 0x98a325024ddd50b46bd58c3925429ecacd95d5c79ac99c4a10841ceca439cdd7::dao {
    ...
    public fun claim_dao<T0, T1>(arg0: &mut DAO<T0, T1>, arg1: DAOVoucher<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg0.payment_balance, arg1.owned_amount * arg0.payment_amount / arg0.funded_amount, arg2), 0x2::tx_context::sender(arg2));
        let DAOVoucher {
            id           : v0,
            owned_amount : _,
        } = arg1;
