module 0x98fc4c13fbf3e1d1ab5812a31552c806269db4c3a6ff6bdb1e54f5be1b4572a9::reward5284 {
    struct REWARD5284 has drop {
        dummy_field: bool,
    }

    struct TICKET_5284 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5284(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5284>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5284>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5284, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5284>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5284>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5284>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5284>>(v5, 0x2::tx_context::sender(arg1));
    }
