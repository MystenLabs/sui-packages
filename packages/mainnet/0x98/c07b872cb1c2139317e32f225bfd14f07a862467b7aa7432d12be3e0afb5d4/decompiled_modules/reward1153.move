module 0x98c07b872cb1c2139317e32f225bfd14f07a862467b7aa7432d12be3e0afb5d4::reward1153 {
    struct REWARD1153 has drop {
        dummy_field: bool,
    }

    struct TICKET_1153 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1153(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_1153>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1153, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1153>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1153>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1153>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1153>>(v5, 0x2::tx_context::sender(arg1));
    }
