module 0x98a768305cb09ec55b9185f682e79faa5e09445eb1f3221d76c6f8b998a49d50::cnsnft8675 {
    struct CNSNFT8675 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8675, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8675>(arg0, arg1);
