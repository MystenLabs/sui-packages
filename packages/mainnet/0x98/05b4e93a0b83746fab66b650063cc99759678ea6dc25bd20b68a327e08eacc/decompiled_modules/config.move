module 0x9805b4e93a0b83746fab66b650063cc99759678ea6dc25bd20b68a327e08eacc::config {
    ...
    public fun derive_multisig_address(arg0: &Config, arg1: vector<u8>) : address {
        ...
        0x1::vector::append<u8>(&mut v0, x"0100000000000000");
    ...
    public fun update_mist_required_per_trade(arg0: &0x9805b4e93a0b83746fab66b650063cc99759678ea6dc25bd20b68a327e08eacc::admin::AdminCap, arg1: &mut Config, arg2: u64) {
