module 0x8f6664467287d847209a45fb99ca6efe89643554f66024c4a1a06adffb2b77f4::snowbara {
    ...
    fun assert_score_fits_level(arg0: u64, arg1: u64) {
        assert!(arg1 >= 1, 13906836072719843343);
        ...
        while (v2 < arg1 + 1) {
            ...
            if (v1 > (arg0 as u128) * 1000000) {
                assert!(v2 + 1 >= arg1, 13906836124259713043);
                return
            };
            let v3 = v0 * 10405;
            v0 = v3 / 10000;
        };
        abort 13906836154324353041
    }
    ...
    public fun migrate(arg0: &mut Leaderboard, arg1: &AdminCap) {
        assert!(1 > arg0.version, 13906835784958083103);
        arg0.version = 1;
    ...
    public fun prune_row(arg0: &mut Leaderboard, arg1: &AdminCap, arg2: u64) : Entry {
        assert!(arg0.version == 1, 13906835857972396061);
    ...
    public fun rotate_submit_key(arg0: &mut Leaderboard, arg1: &AdminCap, arg2: vector<u8>) {
        assert!(arg0.version == 1, 13906835733418344477);
        assert!(0x1::vector::length<u8>(&arg2) == 32, 13906835737713180699);
    ...
    public fun submit_score(arg0: &mut Leaderboard, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u256, arg7: vector<u8>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 13906835346871287837);
        assert!(arg2 > 0, 13906835351165075467);
        assert!(0x1::string::length(&arg1) <= 40, 13906835355460173837);
        assert_score_fits_level(arg2, arg3);
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(0x1::vector::length<u8>(&arg0.submit_key) == 32, 13906835376935796761);
        let v1 = SubmitMsg{
        ...
        assert!(0x2::ed25519::ed25519_verify(&arg7, &arg0.submit_key, &v2), 13906835432770109461);
        assert!(!0x2::table::contains<u256, bool>(&arg0.spent, arg6), 13906835454245077015);
