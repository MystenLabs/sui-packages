module 0x9883457b287b710296dc11fc5344d66b8c9a54d94750107860b192f52b40d703::reward4007 {
    struct REWARD4007 has drop {
        dummy_field: bool,
    }

    struct TICKET_4007 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4007(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4007>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4007>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4007, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4007>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4007>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4007>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4007>>(v5, 0x2::tx_context::sender(arg1));
    }
