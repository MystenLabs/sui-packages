module 0xaee4312ae0d1a32c60b22ec6ec7ed11c81bf7ca5807c3244a6368e1f261fb0df::cetus_vampire_attack {
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut LockdropForPool<T0, T1>, arg2: &CetusAttackConfig, arg3: 0x2::coin::Coin<0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
    ...
    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &LockdropForPool<T0, T1>, arg4: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, u128) {
        ...
        let UserCetusHivePosition {
            ...
            lockup_weeks         : v1,
            lockup_receipts      : v2,
            total_weighted_units : v3,
        } = 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_remove_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg6);
        let v4 = v2;
        let v5 = v1;
        ...
        while (v16 < 0x1::vector::length<u64>(&v5)) {
            ...
            0x2::table::add<u64, u64>(&mut v7, v17, 0x2::table::borrow<u64, Receipt>(&v4, v17).unlock_timestamp);
        ...
        (v5, v7, v8, v9, v10, v11, v12, v13, v14, v15, v3)
    }
    ...
    public entry fun initialize_cetus_attack(arg0: &0x2::clock::Clock, arg1: &0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
        0x2::clock::timestamp_ms(arg0);
    ...
    public fun stake_cetus_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xcdbc35b84e578e2bcd78e031b812a1264f1e2eadc0a0f585db06f703d1928ecb::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &mut LockdropForPool<T0, T1>, arg4: &mut 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::HiveProfile, arg5: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        0x2::clock::timestamp_ms(arg0);
        ...
        let v4 = if (0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::exists_for_profile(arg4, 0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::get_profile_dof_capability_identifier(&arg3.user_profile_access_cap))) {
            0xd4955abce56b3625304c547b5027611fc4f7e7488fdea8c1f2d5e02430ddca74::hive_profile::entry_remove_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg7)
        } else {
            UserCetusHivePosition{id: 0x2::object::new(arg7), lockup_weeks: 0x1::vector::empty<u64>(), lockup_receipts: 0x2::table::new<u64, Receipt>(arg7), total_weighted_units: 0}
        };
        if (!0x1::vector::contains<u64>(&v4.lockup_weeks, &arg6)) {
            let v5 = &mut v4;
            kraft_cetus_receipt(v5, arg6, arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window + arg6 * 604800000000);
        };
        ...
        let v7 = 0x2::table::borrow_mut<u64, Receipt>(&mut v4.lockup_receipts, arg6);
        assert!(v7.position_liquidity == 0, 9816);
        let v8 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(&arg5);
        let v9 = calculate_weighted_units(v8, arg6, arg2);
        v7.weighted_units = v9;
        v7.position_liquidity = v8;
        ...
        v11.position_liquidity = v8;
        v11.weighted_units = v9;
        ...
        v4.total_weighted_units = v4.total_weighted_units + v9;
        ...
        let v13 = CetusPositionLocked<T0, T1>{
            ...
            lockup_weeks                   : arg6,
            liquidity_locked               : v8,
            unlock_timestamp               : v7.unlock_timestamp,
