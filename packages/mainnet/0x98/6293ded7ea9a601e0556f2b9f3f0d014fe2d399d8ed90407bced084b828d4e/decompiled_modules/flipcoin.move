module 0x986293ded7ea9a601e0556f2b9f3f0d014fe2d399d8ed90407bced084b828d4e::flipcoin {
    ...
    public entry fun add_first_liquidity(arg0: &mut FlipCoin, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x4df25da4b5a9fbdfe3c052947aca64cc42d23a19841b1844933b3a53d3ec470c, 0);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = FlipCoin{
            ...
            admin_address : @0x4df25da4b5a9fbdfe3c052947aca64cc42d23a19841b1844933b3a53d3ec470c,
            fee           : 5,
        };
    ...
    public entry fun play(arg0: &mut FlipCoin, arg1: 0x1::string::String, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (arg1 == v0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v2, (50 - arg0.fee) * 0x2::coin::value<0x2::sui::SUI>(&arg2) / 50, arg4), 0x2::tx_context::sender(arg4));
        ...
        0x2::transfer::share_object<Ticket>(v3);
    }
