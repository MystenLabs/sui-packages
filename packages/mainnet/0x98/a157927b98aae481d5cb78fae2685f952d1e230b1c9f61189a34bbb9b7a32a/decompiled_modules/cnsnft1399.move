module 0x98a157927b98aae481d5cb78fae2685f952d1e230b1c9f61189a34bbb9b7a32a::cnsnft1399 {
    struct CNSNFT1399 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1399, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1399>(arg0, arg1);
