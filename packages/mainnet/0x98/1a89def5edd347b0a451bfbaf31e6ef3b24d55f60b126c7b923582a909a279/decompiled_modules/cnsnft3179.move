module 0x981a89def5edd347b0a451bfbaf31e6ef3b24d55f60b126c7b923582a909a279::cnsnft3179 {
    struct CNSNFT3179 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3179, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3179>(arg0, arg1);
