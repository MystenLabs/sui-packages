module 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::intents {
    ...
    public fun add_action_spec<T0, T1: drop, T2: drop>(arg0: &mut Intent<T0>, arg1: T1, arg2: vector<u8>, arg3: T2) {
        ...
        assert!(0x1::vector::length<u8>(&arg2) <= 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::max_action_data_size(), 12);
        let v0 = ActionSpec{
            version     : 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::current_action_version(),
    ...
    public fun add_existing_action_spec<T0, T1: drop>(arg0: &mut Intent<T0>, arg1: ActionSpec, arg2: T1) {
        ...
        assert!(arg1.version == 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::current_action_version(), 11);
        assert!(0x1::vector::length<u8>(&arg1.action_data) <= 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::max_action_data_size(), 12);
    ...
    public(friend) fun destroy_intent<T0: drop + store>(arg0: &mut Intents, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : Expired {
        let Intent {
            type_           : _,
            key             : v1,
            description     : _,
        ...
        let v12 = 0;
        while (v12 < 0x1::vector::length<ActionSpec>(&v10)) {
        ...
        0x1::vector::reverse<bool>(&mut v11);
        Expired{
            account          : v3,
            key              : v1,
            action_specs     : v10,
            executed_actions : v11,
            intent_id        : 0x2::object::uid_to_inner(&v13),
        }
    }
    ...
    public fun new_action_spec<T0>(arg0: vector<u8>, arg1: u8) : ActionSpec {
        assert!(arg1 == 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::current_action_version(), 11);
        assert!(0x1::vector::length<u8>(&arg0) <= 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::max_action_data_size(), 12);
        ActionSpec{
            version     : arg1,
    ...
    public fun new_action_spec_with_typename(arg0: 0x1::type_name::TypeName, arg1: vector<u8>, arg2: u8) : ActionSpec {
        assert!(arg2 == 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::current_action_version(), 11);
        assert!(0x1::vector::length<u8>(&arg1) <= 0x7a6ec95f874af0292f624c7d8ad8a5fb95935f5e756a1d1c31530f779358eaa7::constants::max_action_data_size(), 12);
        ActionSpec{
            version     : arg2,
            action_type : arg0,
            action_data : arg1,
