module 0x7a8d92a2f7574934013b7f9782fdcbc2d429d333889a3308314d01a5baee15fd::app_cap_display {
    ...
    public(friend) fun new(arg0: 0x7a8d92a2f7574934013b7f9782fdcbc2d429d333889a3308314d01a5baee15fd::name::Name, arg1: bool) : AppCapDisplay {
        let v0 = if (arg1) {
            100
        } else {
            0
        ...
        AppCapDisplay{
            title            : 0x7a8d92a2f7574934013b7f9782fdcbc2d429d333889a3308314d01a5baee15fd::name::to_string(&arg0),
            link_opacity     : v0,
    ...
    public(friend) fun uri_encode_text(arg0: 0x7a8d92a2f7574934013b7f9782fdcbc2d429d333889a3308314d01a5baee15fd::name::Name) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let v1 = 0x7a8d92a2f7574934013b7f9782fdcbc2d429d333889a3308314d01a5baee15fd::name::org_to_string(&arg0);
        0x1::string::append(&mut v1, 0x1::string::utf8(b"/"));
        let (v2, v3) = render_batch(v1, 22, 40, 15, 15, 0x1::string::utf8(b"91A3B1"));
        0x1::string::append(&mut v0, v2);
        let (v4, _) = render_batch(0x7a8d92a2f7574934013b7f9782fdcbc2d429d333889a3308314d01a5baee15fd::name::app_to_string(&arg0), 13, v3, 26, 26, 0x1::string::utf8(b"FFFFFF"));
