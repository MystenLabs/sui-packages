module 0xca96885371150f55653f7fab9e9b146f5a19698b1002bdff42159ea9d2ba7d7e::coinflip {
    ...
    public fun borrow_coinflip_settings(arg0: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &CoinFlipSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<CoinFlip, CoinFlipSettingsKey, CoinFlipSettings>(arg0, v1, v0), 13836465975627415566);
    ...
    fun borrow_coinflip_settings_mut(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &mut CoinFlipSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<CoinFlip, CoinFlipSettingsKey, CoinFlipSettings>(arg0, v0, v1), 13836466035756957710);
    ...
    fun borrow_mut_parameters<T0>(arg0: &mut CoinFlipSettings) : &mut Parameters<T0> {
        assert!(parameters_exist<T0>(arg0), 13835621692430811144);
    ...
    fun play_internal<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: bool, arg5: vector<0x1::string::String>, arg6: vector<vector<u8>>, arg7: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::PriceQuote, arg8: &0x2::clock::Clock, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v4 = v2.min_stake;
        let v5 = v2.max_stake;
        assert!(v3 >= 1000000, 13837311165062119444);
        assert!(v3 <= 10000000, 13835340844519194630);
        assert!(v4 <= v5, 13837029698675212306);
        assert!(arg3 > 0 && arg3 <= 100, 13837029702970179602);
        ...
        assert!(0x2::balance::value<T0>(&v7) == arg1, 13836748301007781904);
        ...
        0x13a877d974d59f54d8affa4d345bf794cf8e9e936d9d22100c801c95b415930f::loyalty::process_stake_ticket_with_quote<T0, CoinFlip>(&mut v10, arg0, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::utils::build_metadata<0x1::string::String, vector<u8>>(arg5, arg6), arg7, arg8, arg9, arg10);
        ...
        while (v13 < arg3) {
            ...
            assert!(v14 >= v4, 13835904065055817738);
            assert!(v14 <= v5, 13836185544327626764);
            assert!(v14 <= 9223372036854775807, 13837029973553119250);
    ...
    fun set_parameters<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 >= 1000000, 13837310778515062804);
        assert!(arg1 <= 10000000, 13835340457972137990);
        assert!(arg2 <= arg3, 13837029312128155666);
