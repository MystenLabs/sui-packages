module 0x7a63e3ddbfd738d061c2800a869a1044d0a4a04dc75bde476b7a149537c6ac5e::reward7369 {
    struct REWARD7369 has drop {
        dummy_field: bool,
    }

    struct TICKET_7369 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7369(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7369>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7369>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7369, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7369>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7369>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7369>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7369>>(v5, 0x2::tx_context::sender(arg1));
    }
