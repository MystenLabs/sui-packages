module 0x79b4d9b6b564e324ff1c6f928d586196aef423da1c2b6e37aea39c7407c281dc::magma_clmm {
    ...
    struct ClosePositionEvent2 has copy, drop, store {
        pool_id: 0x2::object::ID,
        position_id: 0x2::object::ID,
        liquidity: u128,
        after_liquidity: u128,
    ...
    public(friend) fun close_position_internal<T0, T1>(arg0: 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::Position, arg1: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg2: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v7 = v6;
        let v8 = v5;
        let (v9, v10) = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::tick_range(&arg0);
        ...
        let v11 = ClosePositionEvent2{
            pool_id            : 0x2::object::id<0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>>(arg2),
            ...
            tick_lower         : 0x659c0e9c4c8a416f040fa758d4fc4073a5fdd1fed97edadcd5cba5180fb36246::i32::as_u32(v9),
            tick_upper         : 0x659c0e9c4c8a416f040fa758d4fc4073a5fdd1fed97edadcd5cba5180fb36246::i32::as_u32(v10),
            current_sqrt_price : 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::current_sqrt_price<T0, T1>(arg2),
        };
        0x2::event::emit<ClosePositionEvent2>(v11);
        (v3, v2)
    }
    ...
    public entry fun reposition<T0, T1>(arg0: &mut 0x79b4d9b6b564e324ff1c6f928d586196aef423da1c2b6e37aea39c7407c281dc::bot::Bot<0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::Position>, arg1: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg2: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg3: u64, arg4: u64, arg5: u32, arg6: u32, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = RepositionEvent2{
            ...
            amount_b           : v11,
            liquidity          : 0,
            after_liquidity    : 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::liquidity(&v1),
            current_sqrt_price : 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::current_sqrt_price<T0, T1>(arg2),
        };
        0x2::event::emit<RepositionEvent2>(v14);
    }
