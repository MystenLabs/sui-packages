module 0x7a36b7e158934dc4120c0caea98f71fba6408b77a4d8c56b2f2a35bea1e72fd4::x {
    struct X has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: X, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<X>(arg0, 9, b"x", b"x", b"", v1, arg1);
        let v4 = v2;
        0x2::coin::mint_and_transfer<X>(&mut v4, 1000000000000, v0, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<X>>(v4, v0);
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<X>>(v3);
    }
