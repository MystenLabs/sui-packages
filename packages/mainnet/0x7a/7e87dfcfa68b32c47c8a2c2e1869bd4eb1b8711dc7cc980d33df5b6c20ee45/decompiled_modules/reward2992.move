module 0x7a7e87dfcfa68b32c47c8a2c2e1869bd4eb1b8711dc7cc980d33df5b6c20ee45::reward2992 {
    struct REWARD2992 has drop {
        dummy_field: bool,
    }

    struct TICKET_2992 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2992(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2992>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2992>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2992, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2992>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2992>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2992>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2992>>(v5, 0x2::tx_context::sender(arg1));
    }
