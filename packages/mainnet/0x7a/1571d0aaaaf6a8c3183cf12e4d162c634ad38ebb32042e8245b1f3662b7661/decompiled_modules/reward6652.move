module 0x7a1571d0aaaaf6a8c3183cf12e4d162c634ad38ebb32042e8245b1f3662b7661::reward6652 {
    struct REWARD6652 has drop {
        dummy_field: bool,
    }

    struct TICKET_6652 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6652(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6652>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6652>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6652, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6652>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6652>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6652>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6652>>(v5, 0x2::tx_context::sender(arg1));
    }
