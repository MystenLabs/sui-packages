module 0x7abb46623062f1abdd8e11092e4105144c7a2d1c6ef3ed20fe0cd439385a78e4::suinobi_x {
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"a4af2172-d76c-44c6-a226-bd796b99ddd4"),
        };
    ...
    fun init(arg0: SUINOBI_X, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUINOBI_X>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Suinobi X"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Suinobi X is a cutting-edge fusion of futuristic cybernetics and ancient ninja mystique."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmVc9cZdtMUtjjScM8jDAoP3LFS7EGsjFRD7Xn7psaMZ9o"));
