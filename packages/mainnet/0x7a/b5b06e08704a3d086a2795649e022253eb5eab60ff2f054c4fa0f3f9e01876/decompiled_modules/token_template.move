module 0x7ab5b06e08704a3d086a2795649e022253eb5eab60ff2f054c4fa0f3f9e01876::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"MC2776910", b"MixedConcurrent2 776910", b"Token for mixed concurrent test 2", 0x1::option::none<0x2::url::Url>(), arg1);
