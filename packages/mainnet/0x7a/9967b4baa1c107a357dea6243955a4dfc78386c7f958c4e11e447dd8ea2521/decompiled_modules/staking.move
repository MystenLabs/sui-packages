module 0x7a9967b4baa1c107a357dea6243955a4dfc78386c7f958c4e11e447dd8ea2521::staking {
    ...
    struct StakingPool has store, key {
        id: 0x2::object::UID,
        vault: 0x2::balance::Balance<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>,
        locks: vector<u64>,
    ...
    entry fun extend_stake(arg0: &mut StakingPool, arg1: &mut StakingLock, arg2: u64, arg3: u64, arg4: vector<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun get_coin_from_vec(arg0: vector<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP> {
        let v0 = 0x1::vector::pop_back<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>(&mut arg0);
        0x2::pay::join_vec<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&mut v0, arg0);
        assert!(0x2::coin::value<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&v0) >= arg1, 3);
        if (0x2::coin::value<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&v0) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>(v0, 0x2::tx_context::sender(arg2));
        } else {
            0x2::coin::destroy_zero<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(v0);
        };
        0x2::coin::split<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&mut v0, arg1, arg2)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = StakingPool{
            ...
            vault                   : 0x2::balance::zero<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(),
    ...
    entry fun new_stake(arg0: &mut StakingPool, arg1: u64, arg2: u64, arg3: vector<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun set_penalty_receiver(arg0: &0x7a9967b4baa1c107a357dea6243955a4dfc78386c7f958c4e11e447dd8ea2521::launchpad::Launchpad, arg1: &mut StakingPool, arg2: address) {
        arg1.penalty_receiver = arg2;
    }

    fun stake_coins(arg0: &mut StakingPool, arg1: &mut StakingLock, arg2: 0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        arg1.amount = arg1.amount + 0x2::coin::value<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&arg2);
        0x2::balance::join<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&mut arg0.vault, 0x2::coin::into_balance<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(arg2));
    }
    ...
    entry fun withdraw(arg0: &mut StakingPool, arg1: StakingLock, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::coin::take<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&mut arg0.vault, arg1.amount, arg3);
        if (arg1.last_distribution_timestamp + arg0.investment_lock_time > 0x2::clock::timestamp_ms(arg2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>(0x2::coin::split<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&mut v0, v1, arg3), arg0.penalty_receiver);
        };
        let StakingLock {
            id                          : v2,
            amount                      : _,
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>(v0, 0x2::tx_context::sender(arg3));
    }
