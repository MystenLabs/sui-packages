module 0x7ad9617a477793f10bc161ba899ea383972d63a3726fe2038fe094d52c22b6d2::deep {
    ...
    fun init(arg0: DEEP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<DEEP>(&mut v2, 1000000000000 * 0x1::u64::pow(10, 6), 0x2::tx_context::sender(arg1), arg1);
