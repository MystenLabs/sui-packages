module 0x8b55577d79ac27ba840b33c20357603ccc0c1d63d75fa49b2b772d72eff67d99::alphafi_bluefin_type_1_investor {
    ...
    public(friend) fun collect_and_swap_trade_fee<T0, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg4: &0x2::clock::Clock) {
        ...
        if (v6 >= arg0.minimum_swap_amount) {
            ...
            let (v9, v10) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg4, arg1, arg2, v5, 0x2::balance::zero<T1>(), true, true, v6, 0, v7);
            0x2::balance::destroy_zero<T0>(v9);
            0x2::balance::join<T1>(&mut v4, v10);
        } else {
            update_free_rewards<T0, T1, T0>(arg0, v5);
        };
        let v11 = 0x2::balance::value<T1>(&v4);
        if (v11 >= arg0.minimum_swap_amount) {
            let (_, v13) = get_bluefin_sqrt_price_limits<T2, T1>(arg3);
            let (v14, v15) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T1>(arg4, arg1, arg3, 0x2::balance::zero<T2>(), v4, false, true, v11, 0, v13);
            0x2::balance::destroy_zero<T1>(v15);
            update_free_rewards<T0, T1, T2>(arg0, v14);
        } else {
    ...
    entry fun is_autocompounding<T0, T1>(arg0: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::AdminCap, arg1: &0x8b55577d79ac27ba840b33c20357603ccc0c1d63d75fa49b2b772d72eff67d99::version::Version, arg2: &mut Investor<T0, T1>, arg3: bool) {
        0x8b55577d79ac27ba840b33c20357603ccc0c1d63d75fa49b2b772d72eff67d99::version::assert_current_version(arg1);
