module 0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::red_oracle {
    ...
    public fun finalize_update_request<T0>(arg0: &mut RedOracle, arg1: UpdatePriceRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v5;
        let v7 = v4;
        let v8 = 0x1::vector::borrow<0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::PriceFeed>(&v7, 0);
        let v9 = 0;
        while (v9 < 0x1::vector::length<0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::PriceFeed>(&v6)) {
            0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::assert_acceptable_diff(v8, 0x1::vector::borrow<0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::PriceFeed>(&v6, v9));
            v9 = v9 + 1;
        };
        let v10 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, 0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::PriceFeed>(&arg0.prices, &v10)) {
            0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::assert_max_deviation(v8, 0x2::vec_map::get<0x1::type_name::TypeName, 0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::PriceFeed>(&arg0.prices, &v10));
        };
        add_or_replace_coin_price_feed<T0>(arg0, v8);
        let v11 = PriceFeedUpdatedEvent{
            primary_price_feeds   : v7,
            secondary_price_feeds : v6,
        };
        0x2::event::emit<PriceFeedUpdatedEvent>(v11);
    }
    ...
    public fun set_coin_decimals<T0>(arg0: &RedOracleCap, arg1: &mut RedOracle, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u8>(&arg1.decimals, &v0)) {
            let v1 = 0x1::type_name::get<T0>();
            let (_, _) = 0x2::vec_map::remove<0x1::type_name::TypeName, u8>(&mut arg1.decimals, &v1);
        };
    ...
    public fun update_price_feed_as_primary_v2<T0, T1: drop>(arg0: &mut RedOracle, arg1: &mut UpdatePriceRequest<T0>, arg2: 0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::PriceFeed, arg3: &0x2::clock::Clock, arg4: T1) {
    ...
    public fun update_price_feed_as_secondary_v2<T0, T1: drop>(arg0: &mut RedOracle, arg1: &mut UpdatePriceRequest<T0>, arg2: 0x1b56015b0e1a49d29c7dd95f9f017c198a59e60d09a97031e394fd0292811375::price_feed::PriceFeed, arg3: &0x2::clock::Clock, arg4: T1) {
        assert_ensure_coin_policy_exists<T0>(arg0);
        let v0 = 0x1::type_name::get<T0>();
