module 0x7a6f82a3d0940342e0dcea39f5e12758853a74870d1698f80622a27b301586eb::verify_ir {
    public(friend) fun verify_and_extract_payload(arg0: vector<u8>, arg1: vector<u8>, arg2: u8) : vector<u8> {
        ...
        let v6 = x"000000000000000000000000017fa2955e60d6e094f8fd97cae0bb1768876c22";
        let v7 = 12;
        while (v7 < 32) {
