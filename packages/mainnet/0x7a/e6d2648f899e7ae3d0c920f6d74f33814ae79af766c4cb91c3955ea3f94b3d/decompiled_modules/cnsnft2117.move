module 0x7ae6d2648f899e7ae3d0c920f6d74f33814ae79af766c4cb91c3955ea3f94b3d::cnsnft2117 {
    struct CNSNFT2117 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2117, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3113"));
        let v4 = 0x2::package::claim<CNSNFT2117>(arg0, arg1);
