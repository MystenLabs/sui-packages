module 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::staking {
    ...
    public entry fun claim_vest_reward_luck<T0, T1, T2, T3, T4>(arg0: &mut Pool<T0, T1, T2, T3, T4>, arg1: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::bag::contains<address>(&arg0.vester, v0), 1003);
        let v1 = 0x2::bag::remove<address, UserVest>(&mut arg0.vester, v0);
        ...
        update_user_vest_earnings(arg0.vest_duration, v2, arg2);
        let v3 = &mut v1;
        reward_inner_vest_claim(arg1, v3, arg3);
        0x1::debug::print<UserVest>(&v1);
        if (v1.amount - v1.unobtainable_reward > 0) {
            0x2::bag::add<address, UserVest>(&mut arg0.vester, v0, v1);
        } else {
    ...
    public entry fun deposit_to_stake<T0, T1, T2, T3, T4>(arg0: &mut Pool<T0, T1, T2, T3, T4>, arg1: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg2: vector<0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::NonTransferCoin<T4>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x2::bag::contains<address>(&arg0.stakes, v0), 1009);
        let v1 = 0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::zero<T4>(v0, arg5);
        ...
        if (0x2::bag::contains<address>(&arg0.vester, v0)) {
            let v3 = 0x2::bag::borrow_mut<address, UserVest>(&mut arg0.vester, v0);
            update_user_vest_earnings(arg0.vest_duration, v3, arg4);
            reward_inner_vest_claim(arg1, v3, arg5);
            v3.amount = v3.amount + arg3;
            v3.unobtainable_reward = 0;
            v3.lastet_updated = 0x2::clock::timestamp_ms(arg4);
            v3.passed_time = 0;
    ...
    fun reward_inner_vest_claim(arg0: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg1: &mut UserVest, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun withdraw_from_stake<T0, T1, T2, T3, T4>(arg0: &mut Pool<T0, T1, T2, T3, T4>, arg1: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::bag::contains<address>(&arg0.vester, v0), 1003);
        let v1 = 0x2::bag::remove<address, UserVest>(&mut arg0.vester, v0);
