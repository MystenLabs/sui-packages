module 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault {
    ...
    struct RewardLuckVault has store, key {
        id: 0x2::object::UID,
        luck: 0x2::coin::Coin<0x202591744d54ee4f4af736ef3b8508f3d46d982c36747d9587032bd549122179::luck::LUCK>,
    }
    ...
    public fun deposit_reward_luck(arg0: &mut 0xaff8c4874f0145d8d586aff69fdd8de07276200c985ce4878d05bddc6854a0ba::admin::Manage, arg1: &mut RewardLuckVault, arg2: 0x2::coin::Coin<0x202591744d54ee4f4af736ef3b8508f3d46d982c36747d9587032bd549122179::luck::LUCK>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xaff8c4874f0145d8d586aff69fdd8de07276200c985ce4878d05bddc6854a0ba::admin::is_admin(arg0, arg3), 10000);
        0x2::coin::join<0x202591744d54ee4f4af736ef3b8508f3d46d982c36747d9587032bd549122179::luck::LUCK>(&mut arg1.luck, arg2);
    }
    ...
    public(friend) fun get_luck_reward(arg0: &mut RewardLuckVault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x202591744d54ee4f4af736ef3b8508f3d46d982c36747d9587032bd549122179::luck::LUCK> {
        let v0 = GetLuck{
            user   : 0x2::tx_context::sender(arg2),
            amount : arg1,
        };
    ...
    public fun init_reward_luck_vault(arg0: &mut 0xaff8c4874f0145d8d586aff69fdd8de07276200c985ce4878d05bddc6854a0ba::admin::Manage, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0xaff8c4874f0145d8d586aff69fdd8de07276200c985ce4878d05bddc6854a0ba::admin::is_admin(arg0, arg1), 10000);
        let v0 = RewardLuckVault{
            id   : 0x2::object::new(arg1),
            luck : 0x2::coin::zero<0x202591744d54ee4f4af736ef3b8508f3d46d982c36747d9587032bd549122179::luck::LUCK>(arg1),
        };
        0x2::transfer::public_share_object<RewardLuckVault>(v0);
    }
    ...
    public fun withdraw_reward_vault(arg0: &mut 0xaff8c4874f0145d8d586aff69fdd8de07276200c985ce4878d05bddc6854a0ba::admin::Manage, arg1: &mut RewardLuckVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xaff8c4874f0145d8d586aff69fdd8de07276200c985ce4878d05bddc6854a0ba::admin::is_admin(arg0, arg3), 10000);
