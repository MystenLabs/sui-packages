module 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::vesting {
    ...
    public entry fun claim_luck_reward<T0>(arg0: &mut Pool<T0>, arg1: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::bag::contains<address>(&arg0.vesters, v0), 1003);
        let v1 = 0x2::bag::remove<address, UserVest>(&mut arg0.vesters, v0);
        ...
        update_user_earnings(arg0.vesting_duration, v2, arg2);
        let v3 = &mut v1;
        reward_inner_claim(arg1, v3, arg3);
        if (v1.amount != v1.unobtainable_reward) {
            0x2::bag::add<address, UserVest>(&mut arg0.vesters, v0, v1);
        } else {
            arg0.total_vesters = arg0.total_vesters - 1;
    ...
    public entry fun deposit_to_vesting<T0>(arg0: &mut Pool<T0>, arg1: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg2: vector<0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::NonTransferCoin<T0>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::zero<T0>(v0, arg5);
        0x1c7e4548a40742d9545125a815941067bfe9720ef3ded3f1a10999e589cc5fd5::nonTransferCoin::join_vec<T0>(&mut v1, arg2);
        ...
        if (0x2::bag::contains<address>(&arg0.vesters, v0)) {
            let v2 = 0x2::bag::borrow_mut<address, UserVest>(&mut arg0.vesters, v0);
            update_user_earnings(arg0.vesting_duration, v2, arg4);
            reward_inner_claim(arg1, v2, arg5);
            v2.amount = v2.amount + arg3;
            v2.unobtainable_reward = 0;
            v2.lastet_updated = 0x2::clock::timestamp_ms(arg4);
            v2.passed_time = 0;
    ...
    fun reward_inner_claim(arg0: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg1: &mut UserVest, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x202591744d54ee4f4af736ef3b8508f3d46d982c36747d9587032bd549122179::luck::LUCK>>(0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::get_luck_reward(arg0, arg1.earned_reward, arg2), 0x2::tx_context::sender(arg2));
        arg1.earned_reward = 0;
    }
    ...
    public entry fun withdraw_from_vesting<T0>(arg0: &mut Pool<T0>, arg1: &mut 0x2d62336f06432989088ceeac7abe2a35b21ac179871ac5252fcbdf5261e7cb78::luck_vault::RewardLuckVault, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.emergency_locked, 1004);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::bag::contains<address>(&arg0.vesters, v0), 1003);
        let v1 = 0x2::bag::remove<address, UserVest>(&mut arg0.vesters, v0);
