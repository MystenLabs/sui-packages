module 0x7a3bfc692d0e103f6feb36b9055efdb12762376d1e4992b1bc18d2a83a2e3376::cnsnft5915 {
    struct CNSNFT5915 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5915, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5915>(arg0, arg1);
