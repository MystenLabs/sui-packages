module 0x7a026ed76f4380264c065452e179b47f2e5d2f641765f4ab5e5651c5aa05e32d::solo {
    ...
    struct SwapOfferCreatedDemo has copy, drop {
        offer_id: 0x2::object::ID,
        offerer_kiosk_id: 0x2::object::ID,
        offerer_nft_id: 0x2::object::ID,
        receiver_nft_id: 0x2::object::ID,
    ...
    public entry fun create_swap_offer_demo<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk::has_item(arg1, arg3), 2);
        assert!(!0x2::kiosk::is_listed(arg1, arg3), 6);
        0x2::kiosk::list<T0>(arg1, arg2, arg3, 0);
        let (v0, v1) = 0x2::kiosk::purchase<T0>(arg1, arg3, 0x2::coin::zero<0x2::sui::SUI>(arg6));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg5, v1);
        let v5 = SwapOfferDemo{
            id               : 0x2::object::new(arg6),
            offerer          : 0x2::tx_context::sender(arg6),
            offerer_kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
            offerer_nft_id   : arg3,
            receiver_nft_id  : arg4,
            status           : 0,
        };
        let v6 = 0x2::object::id<SwapOfferDemo>(&v5);
        0x2::dynamic_object_field::add<0x2::object::ID, SwapOfferDemo>(&mut arg0.id, v6, v5);
        0x2::dynamic_object_field::add<0x2::object::ID, T0>(&mut arg0.id, arg3, v0);
        let v7 = SwapOfferCreatedDemo{
            offer_id         : v6,
            offerer_kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
            offerer_nft_id   : arg3,
            receiver_nft_id  : arg4,
        ...
        0x2::event::emit<SwapOfferCreatedDemo>(v7);
    }
