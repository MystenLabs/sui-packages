module 0x7a359f0f94680e51572591b435b3626a78b448e5427b34e3ea048477e1f7043e::deepbook {
    ...
    public fun swap_exact_quantity<T0, T1, T2, T3>(arg0: &mut 0x7a359f0f94680e51572591b435b3626a78b448e5427b34e3ea048477e1f7043e::checkpoint::Payload<T2, T3>, arg1: &mut DeepPool, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(arg4 <= 0x7a359f0f94680e51572591b435b3626a78b448e5427b34e3ea048477e1f7043e::constant::deepbook_max_taker_fee(), 0);
        ...
        let (_, _, v5) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_quote_quantity_out<T0, T1>(arg2, v2, arg5);
        ...
        if (arg3 && v7) {
            0x2::balance::join<T0>(&mut v8, 0x2::balance::split<T0>(&mut v0, v2 * arg4 * 0x7a359f0f94680e51572591b435b3626a78b448e5427b34e3ea048477e1f7043e::constant::deepbook_fee_penalty() / 1000000));
        } else {
            0x2::balance::join<T1>(&mut v9, 0x2::balance::split<T1>(&mut v1, v2 * arg4 * 0x7a359f0f94680e51572591b435b3626a78b448e5427b34e3ea048477e1f7043e::constant::deepbook_fee_penalty() / 1000000));
        };
        ...
        (0x2::coin::into_balance<T0>(v10), 0x2::coin::into_balance<T1>(v11), v8, v9)
    }
