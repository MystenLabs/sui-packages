module 0x7a84d2cb1d3cb785b6209f0e411d290856ca2193381af1bcdca721c10e38d5b0::vault {
    ...
    struct Vault<phantom T0> has key {
        ...
        treasury_cap: 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::ReceiptTreasuryCap,
    }
    ...
    public fun borrow_treasury_ref<T0>(arg0: &Vault<T0>) : &0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::ReceiptTreasuryCap {
        &arg0.treasury_cap
    }
    ...
    fun calculate_shares_and_validate<T0>(arg0: &Vault<T0>, arg1: u64, arg2: &0x2::clock::Clock) : (u64, u64) {
        if (arg0.current_strategy != 0 && arg0.last_heartbeat_ms > 0) {
            0x7a84d2cb1d3cb785b6209f0e411d290856ca2193381af1bcdca721c10e38d5b0::floors::assert_heartbeat_age(0x2::clock::timestamp_ms(arg2) - arg0.last_heartbeat_ms);
        };
        assert!(arg1 > 0, 200);
    ...
    public fun commit_strategy<T0, T1>(arg0: &mut Vault<T0>, arg1: &ProtocolAccessCap, arg2: BorrowReceipt<T0>, arg3: 0x2::balance::Balance<T1>, arg4: u8, arg5: u64) {
        ...
        if (v0 > 0) {
            assert!(arg5 >= v0 - v0 * 0x7a84d2cb1d3cb785b6209f0e411d290856ca2193381af1bcdca721c10e38d5b0::floors::max_slippage_ceil() / 10000, 207);
        };
    ...
    public fun commit_unwind<T0>(arg0: &mut Vault<T0>, arg1: &ProtocolAccessCap, arg2: YieldPromise<T0>, arg3: 0x2::coin::Coin<T0>, arg4: u64) {
        ...
        let v3 = if (is_depeg_active<T0>(arg0)) {
            0x7a84d2cb1d3cb785b6209f0e411d290856ca2193381af1bcdca721c10e38d5b0::floors::max_emergency_slippage_ceil()
        } else {
            0x7a84d2cb1d3cb785b6209f0e411d290856ca2193381af1bcdca721c10e38d5b0::floors::max_slippage_ceil()
        };
        if (arg4 > 0) {
    ...
    public fun create_vault<T0>(arg0: 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::ReceiptTreasuryCap, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit_existing<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::AqReceipt, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::locked_until_epoch(arg1);
        ...
        0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::augment_receipt(&arg0.treasury_cap, arg1, v2, arg4);
    }

    public fun deposit_new<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::AqReceipt {
        ...
        0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::mint_receipt(&arg0.treasury_cap, v1, arg3)
    }
    ...
    public fun is_heartbeat_stale<T0>(arg0: &Vault<T0>, arg1: &0x2::clock::Clock) : bool {
        ...
        0x2::clock::timestamp_ms(arg1) - arg0.last_heartbeat_ms > 0x7a84d2cb1d3cb785b6209f0e411d290856ca2193381af1bcdca721c10e38d5b0::floors::max_heartbeat_age_ms()
    }
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::AqReceipt, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::tx_context::epoch(arg4) > 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::deposit_epoch(&arg1), 17);
        assert!(0x2::tx_context::epoch(arg4) > 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::locked_until_epoch(&arg1), 214);
        let v0 = 0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::receipt_amount(&arg1);
        assert!(v0 > 0, 200);
        let v1 = if (arg0.total_receipts == 0) {
            0
        } else {
        ...
        assert!(v1 > 0, 200);
        assert!(v1 >= arg2, 203);
        0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::deplete_receipt(&arg0.treasury_cap, &mut arg1, v0);
        0x62d431fededc4fdd6b5d55bdf3fdf9f27eff871958de312f4e6446e20864241f::receipt::destroy_empty_receipt(arg1);
