module 0x7a42d920bfcad88772f775858deb4e23762ea31c3f6d491de52018d1398be56b::xbird {
    ...
    public fun depositToken(arg0: vector<u8>, arg1: vector<u8>, arg2: &ValidatorVault, arg3: &mut PegVault<XBIRD>, arg4: &mut 0x7a42d920bfcad88772f775858deb4e23762ea31c3f6d491de52018d1398be56b::archieve::UserArchieve, arg5: &0x7a42d920bfcad88772f775858deb4e23762ea31c3f6d491de52018d1398be56b::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<XBIRD>, DepositProof) {
        ...
        assert!(v2 > 0, 1002);
        assert!(v2 > 0, 1002);
        assert!(0x2::bcs::peel_u64(&mut v1) > 0x2::clock::timestamp_ms(arg6), 1002);
        0x7a42d920bfcad88772f775858deb4e23762ea31c3f6d491de52018d1398be56b::archieve::verUpdateTokenPegNonce(v3, arg4);
        let v4 = DepositProof{
            owner   : v0,
            balance : v2,
        };
        let v5 = XBirdDeposited{
            ...
            nonce         : v3,
            balance       : v2,
            total_deposit : 0x7a42d920bfcad88772f775858deb4e23762ea31c3f6d491de52018d1398be56b::archieve::increaseTotalDeposit(v2, arg4),
        };
    ...
    fun init(arg0: XBIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x7a42d920bfcad88772f775858deb4e23762ea31c3f6d491de52018d1398be56b::cap_vault::createVault<XBirdAdminCap>(arg1);
    }

    public fun setValidator(arg0: &XBirdAdminCap, arg1: vector<u8>, arg2: &mut ValidatorVault, arg3: &0x7a42d920bfcad88772f775858deb4e23762ea31c3f6d491de52018d1398be56b::version::Version) {
