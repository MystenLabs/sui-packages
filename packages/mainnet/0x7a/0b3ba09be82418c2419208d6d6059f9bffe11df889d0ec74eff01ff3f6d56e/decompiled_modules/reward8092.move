module 0x7a0b3ba09be82418c2419208d6d6059f9bffe11df889d0ec74eff01ff3f6d56e::reward8092 {
    struct REWARD8092 has drop {
        dummy_field: bool,
    }

    struct TICKET_8092 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8092(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8092>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8092>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8092, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8092>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8092>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8092>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8092>>(v5, 0x2::tx_context::sender(arg1));
    }
