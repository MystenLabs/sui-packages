module 0x7a075d9c285d7660b7e98244980f784d208abe26e673dc76627a818d76d5d6e1::cnsnft4490 {
    struct CNSNFT4490 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4490, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4490>(arg0, arg1);
