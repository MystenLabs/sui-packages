module 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::bluefin_helper {
    ...
    public fun close_position_and_try_reopen<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: u8, arg7: u8, arg8: u128, arg9: bool, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = calc_open_parameters<T0, T1>(arg2, v13, v14, arg6, arg7, arg8, arg9);
        0x2::event::emit<OpenParameters>(v15);
        if (v15.swap_amount == 0 && (v15.a2b && v13 > v15.a_position_amount + v15.swap_amount || !v15.a2b && v14 > v15.b_position_amount + v15.swap_amount)) {
            let (v16, v17, v18) = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::get_liquidity_by_amount(v15.lower_tick, v15.upper_tick, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg2), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg2), (arg8 as u64), arg9);
            let v19 = if (v16 == 0) {
                true
            } else if (v13 <= (with_position_ratio_u64(v17) as u128)) {
                true
            } else {
                v14 <= (with_position_ratio_u64(v18) as u128)
            };
            if (v19) {
            ...
            let v20 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg1, arg2, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v15.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v15.upper_tick), arg10);
            let (_, _, v23, v24) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity<T0, T1>(arg0, arg1, arg2, &mut v20, v11, v12, with_position_ratio_u128(v16));
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T0>(v23, 0x2::tx_context::sender(arg10), arg10);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T1>(v24, 0x2::tx_context::sender(arg10), arg10);
            0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v20, 0x2::tx_context::sender(arg10));
        } else {
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T0>(v11, 0x2::tx_context::sender(arg10), arg10);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T1>(v12, 0x2::tx_context::sender(arg10), arg10);
        };
