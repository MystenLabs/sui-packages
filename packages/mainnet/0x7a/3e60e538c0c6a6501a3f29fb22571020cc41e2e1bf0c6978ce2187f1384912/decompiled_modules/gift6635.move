module 0x7a3e60e538c0c6a6501a3f29fb22571020cc41e2e1bf0c6978ce2187f1384912::gift6635 {
    struct GIFT6635 has drop {
        dummy_field: bool,
    }

    struct TICKET_6635 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6635(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6635>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6635>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6635, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6635>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6635>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6635>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6635>>(v5, 0x2::tx_context::sender(arg1));
    }
