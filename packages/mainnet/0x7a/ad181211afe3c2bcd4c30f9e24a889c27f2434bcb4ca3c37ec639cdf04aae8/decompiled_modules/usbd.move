module 0x7aad181211afe3c2bcd4c30f9e24a889c27f2434bcb4ca3c37ec639cdf04aae8::usbd {
    ...
    fun init(arg0: USBD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x2::coin::create_regulated_currency_v2<USBD>(arg0, 9, trim_right(b"USBD"), trim_right(b"USBD  "), trim_right(b"Qqqq"), v1, true, arg1);
        let v5 = v2;
