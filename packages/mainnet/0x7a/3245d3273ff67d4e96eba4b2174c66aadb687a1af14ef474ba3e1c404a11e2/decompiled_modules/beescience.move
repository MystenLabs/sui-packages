module 0x15f53b90602b3d8e2450cc7df0a593b904fa023ba348d1c8df4c8148a51c29ce::beescience {
    ...
    public fun evolve_bee(arg0: u256, arg1: vector<u256>) : u256 {
        let v0 = (0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::math::min_u64((((slice_number(arg0, 3, 4) as u8) + 1) as u64), ((8 - 1) as u64)) as u8);
    ...
    public fun pow_approx(arg0: u128, arg1: u128, arg2: u128) : u128 {
        let v0 = 0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::constants::precision_constant();
        if (arg0 <= 2) {
