module 0x7aa0ade988ced8fc5ce6f8db66b2598b5d37b216a26b384d346d16325a6a91b9::gift5282 {
    struct GIFT5282 has drop {
        dummy_field: bool,
    }

    struct TICKET_5282 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5282(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5282>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5282>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5282, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5282>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5282>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5282>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5282>>(v5, 0x2::tx_context::sender(arg1));
    }
