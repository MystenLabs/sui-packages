module 0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::contest {
    ...
    struct Contest has key {
        ...
        voting_keys_tab: 0x2::table::Table<0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::voting_key::VotingKey, u8>,
    ...
    public(friend) fun check_double_voting_for_nft_internal(arg0: &mut Contest, arg1: 0x2::object::ID, arg2: address) {
        let v0 = 0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::voting_key::create_voting_key(arg1, arg2);
        assert!(!0x2::table::contains<0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::voting_key::VotingKey, u8>(&arg0.voting_keys_tab, v0), 4);
        0x2::table::add<0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::voting_key::VotingKey, u8>(&mut arg0.voting_keys_tab, v0, 1);
    }
    ...
    public(friend) fun create_contest(arg0: vector<u8>, arg1: address, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Contest {
        ...
        Contest{
            ...
            voting_keys_tab        : 0x2::table::new<0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::voting_key::VotingKey, u8>(arg5),
    ...
    public fun do_delete(arg0: &mut Contest, arg1: vector<u8>, arg2: 0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::meme::MemeNFT, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = create_msg(0x2::tx_context::sender(arg3), 0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::meme::id(&arg2));
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg1, &arg0.admin_pub_key, &v0), 11);
        update_contest_on_nft_removal_internal(arg0, 0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::meme::id(&arg2));
        0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::meme::burn_meme(arg2);
    }
    ...
    public fun do_mint(arg0: &mut Contest, arg1: 0x1::string::String, arg2: address, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = 0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::meme::mint_meme(0x2::object::uid_to_inner(&arg0.id), arg1, arg2, arg3, arg0.nft_mint_order, arg4, arg5);
        let v1 = 0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::meme::id(&v0);
        0x2::table::add<0x2::object::ID, u64>(&mut arg0.num_votes_tab, v1, 0);
        0x2::transfer::public_transfer<0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::meme::MemeNFT>(v0, arg2);
        v1
    }
    ...
    public fun do_vote(arg0: &mut Contest, arg1: vector<u8>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x7a4cb5bfcec16a36aa4e03a11296d2cc63dd9a17d47c86b04d0f13dca0880ef6::vote_proof::create_vote_proof_and_transfer(arg2, arg4);
    }
