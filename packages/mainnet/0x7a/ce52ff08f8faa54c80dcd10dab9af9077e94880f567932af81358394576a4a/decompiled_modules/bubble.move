module 0x7ace52ff08f8faa54c80dcd10dab9af9077e94880f567932af81358394576a4a::bubble {
    ...
    fun init(arg0: BUBBLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BUBBLE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BUBBLE  ")))), trim_right(b"Bubble                          "), trim_right(b"BUBBLE is the utility token driving the Imaginary World, used for gaming, merchandise, and content. It is designed with the goal of empowering holders with governance rights, thereby allowing them to shape the future of the Imaginary World and rewarding their contributions.                                              "), v2, arg1);
        let v5 = v3;
