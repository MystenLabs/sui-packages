module 0x7a998c4ff009866ed450951d71ac12f6be63878da0d29dbff51603fcda25b0af::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 9, b"RBCOIN", b"RBC", b"", 0x1::option::none<0x2::url::Url>(), arg1);
