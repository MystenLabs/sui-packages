module 0x7a82d15a897c0220199026087a60d7740684bc469f7b2f3903018facd11a7bdc::cnsnft5289 {
    struct CNSNFT5289 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5289, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2904"));
        let v4 = 0x2::package::claim<CNSNFT5289>(arg0, arg1);
