module 0x7a552f2fb68e9e564abd22b9a25b2906f55338fced57521bacacd6b6bbdc6db4::reward2498 {
    struct REWARD2498 has drop {
        dummy_field: bool,
    }

    struct TICKET_2498 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2498(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2498>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2498>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2498, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2498>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2498>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2498>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2498>>(v5, 0x2::tx_context::sender(arg1));
    }
