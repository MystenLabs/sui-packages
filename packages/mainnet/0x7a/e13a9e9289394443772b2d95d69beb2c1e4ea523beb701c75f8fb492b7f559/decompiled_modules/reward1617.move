module 0x7ae13a9e9289394443772b2d95d69beb2c1e4ea523beb701c75f8fb492b7f559::reward1617 {
    struct REWARD1617 has drop {
        dummy_field: bool,
    }

    struct TICKET_1617 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1617(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1617>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1617>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1617, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1617>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1617>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1617>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1617>>(v5, 0x2::tx_context::sender(arg1));
    }
