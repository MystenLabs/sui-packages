module 0x7ad737d1a2ff08472d2f576bda810f68cc59533801a46e50dba3781f97930f78::kooni_holder_prezent_nft {
    struct KOONI_HOLDER_PREZENT_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: KOONI_HOLDER_PREZENT_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<KOONI_HOLDER_PREZENT_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"KOONI Holder Prezent NFT"));
