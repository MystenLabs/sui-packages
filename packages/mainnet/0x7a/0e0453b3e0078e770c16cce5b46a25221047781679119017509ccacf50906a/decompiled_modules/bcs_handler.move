module 0x7a0e0453b3e0078e770c16cce5b46a25221047781679119017509ccacf50906a::bcs_handler {
    ...
    public fun dec_order(arg0: vector<u8>) : (vector<u8>, address, address, 0x1::string::String, u64, u64, u64, bool, bool, u64, u64, u64) {
        let v0 = 0x2::bcs::new(arg0);
        (0x2::hash::blake2b256(&arg0), 0x2::bcs::peel_address(&mut v0), 0x2::bcs::peel_address(&mut v0), 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0)), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0)) == 0x7a0e0453b3e0078e770c16cce5b46a25221047781679119017509ccacf50906a::constants::position_long(), 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0)) == 0x7a0e0453b3e0078e770c16cce5b46a25221047781679119017509ccacf50906a::constants::position_isolated(), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0), 0x2::bcs::peel_u64(&mut v0))
    }
