module 0x7a0e0453b3e0078e770c16cce5b46a25221047781679119017509ccacf50906a::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0x7a0e0453b3e0078e770c16cce5b46a25221047781679119017509ccacf50906a::utils::base_div(arg0.value, arg1);
    ...
    public fun mul_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0x7a0e0453b3e0078e770c16cce5b46a25221047781679119017509ccacf50906a::utils::base_mul(arg0.value, arg1);
        let v1 = v0 == 0 || arg0.sign;
        Number{
            value : v0,
            sign  : v1,
    ...
    public fun one() : Number {
        Number{
            value : 0x7a0e0453b3e0078e770c16cce5b46a25221047781679119017509ccacf50906a::constants::base_uint(),
            sign  : true,
        }
    }
