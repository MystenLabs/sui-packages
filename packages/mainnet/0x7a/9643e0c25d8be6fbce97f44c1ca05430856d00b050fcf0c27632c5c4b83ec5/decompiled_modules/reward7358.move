module 0x7a9643e0c25d8be6fbce97f44c1ca05430856d00b050fcf0c27632c5c4b83ec5::reward7358 {
    struct REWARD7358 has drop {
        dummy_field: bool,
    }

    struct TICKET_7358 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7358(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7358>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7358>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7358, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7358>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7358>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7358>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7358>>(v5, 0x2::tx_context::sender(arg1));
    }
