module 0x7aee5a0d3a713a3116186ece2f179a41d5bb4e586e87c4d8d737e3826dc3bbc8::consolidated {
    ...
    public entry fun buy_tokens(arg0: &mut BondingCurve, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u256, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg5: &0x2::clock::Clock, arg6: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg7: &0x2::coin::CoinMetadata<LaunchpadToken>, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = (arg2 as u64);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<LaunchpadToken>>(0x2::coin::mint<LaunchpadToken>(&mut arg0.treasury, v0, arg8), 0x2::tx_context::sender(arg8));
        arg0.total_minted = arg0.total_minted + arg2;
        if (v2 > v5) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v2 - v5, arg8), 0x2::tx_context::sender(arg8));
        };
    ...
    public entry fun create_token_and_bonding_curve(arg0: &mut TokenRegistry, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u8, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = LaunchpadToken{dummy_field: false};
        let (v1, v2) = 0x2::coin::create_currency<LaunchpadToken>(v0, arg5, arg2, arg1, arg3, 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(arg4)), arg8);
        0x2::transfer::public_transfer<0x2::coin::CoinMetadata<LaunchpadToken>>(v2, 0x2::tx_context::sender(arg8));
        let v3 = 0x2::object::new(arg8);
        let v4 = 0x2::object::uid_to_address(&v3);
        let v5 = 0x2::object::uid_to_address(&v3);
        let v6 = TokenInfo{
        ...
        0x2::table::add<address, TokenInfo>(&mut arg0.tokens, v4, v6);
        let v7 = BondingCurve{
            id           : v3,
            token_id     : v4,
            total_minted : 0,
    ...
    public fun init_cetus_pool(arg0: address, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<LaunchpadToken>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::coin::CoinMetadata<LaunchpadToken>, arg7: address, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : bool {
    ...
    public entry fun sell_tokens(arg0: &mut BondingCurve, arg1: &mut 0x2::coin::Coin<LaunchpadToken>, arg2: u256, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg5: &0x2::clock::Clock, arg6: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg7: &0x2::coin::CoinMetadata<LaunchpadToken>, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = (arg2 as u64);
        assert!(0x2::coin::value<LaunchpadToken>(arg1) >= v0, 7);
        let v1 = calculate_sell_price(arg0.total_minted, arg2);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0.sui_treasury) >= v1, 3);
        0x2::coin::burn<LaunchpadToken>(&mut arg0.treasury, 0x2::coin::split<LaunchpadToken>(arg1, v0, arg8));
        arg0.total_minted = arg0.total_minted - arg2;
