module 0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_receipt_info {
    ...
    public(friend) fun update_after_request_withdraw(arg0: &mut VaultReceiptInfo, arg1: u256, arg2: address) {
        let v0 = arg0.status;
        if (v0 == 0) {
            let v1 = if (arg2 != 0x2::address::from_u256(0)) {
                3
            } else {
                2
            };
            ...
            let v2 = if (arg2 != 0x2::address::from_u256(0)) {
                5
            } else {
                4
            };
    ...
    public(friend) fun update_reward(arg0: &mut VaultReceiptInfo, arg1: 0x1::type_name::TypeName, arg2: u256) : u256 {
        ...
        if (arg2 > *v1) {
            let v3 = 0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_utils::mul_with_oracle_price(arg2 - *v1, arg0.shares);
            *v1 = arg2;
            *v2 = *v2 + v3;
