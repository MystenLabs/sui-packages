module 0x2fe46bbc4d317660a6aa57d8686178791c7524feaf7dbab2decf666e81df8717::cnsnft7329 {
    struct CNSNFT7329 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7329, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1902"));
        let v4 = 0x2::package::claim<CNSNFT7329>(arg0, arg1);
