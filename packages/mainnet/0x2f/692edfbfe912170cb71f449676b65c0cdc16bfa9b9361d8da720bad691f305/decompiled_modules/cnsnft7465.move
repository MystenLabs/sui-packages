module 0x2f692edfbfe912170cb71f449676b65c0cdc16bfa9b9361d8da720bad691f305::cnsnft7465 {
    struct CNSNFT7465 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7465, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7465>(arg0, arg1);
