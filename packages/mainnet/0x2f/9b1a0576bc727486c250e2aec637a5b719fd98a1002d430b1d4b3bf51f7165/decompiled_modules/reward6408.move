module 0x2f9b1a0576bc727486c250e2aec637a5b719fd98a1002d430b1d4b3bf51f7165::reward6408 {
    struct REWARD6408 has drop {
        dummy_field: bool,
    }

    struct TICKET_6408 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6408(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6408>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6408>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6408, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6408>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6408>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6408>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6408>>(v5, 0x2::tx_context::sender(arg1));
    }
