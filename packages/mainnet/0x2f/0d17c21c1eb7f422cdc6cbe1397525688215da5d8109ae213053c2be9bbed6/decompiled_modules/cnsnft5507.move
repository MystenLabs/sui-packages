module 0x2f0d17c21c1eb7f422cdc6cbe1397525688215da5d8109ae213053c2be9bbed6::cnsnft5507 {
    struct CNSNFT5507 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5507, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7037"));
        let v4 = 0x2::package::claim<CNSNFT5507>(arg0, arg1);
