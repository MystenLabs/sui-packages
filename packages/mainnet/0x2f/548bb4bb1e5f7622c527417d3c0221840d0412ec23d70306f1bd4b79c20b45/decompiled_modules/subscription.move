module 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::subscription {
    ...
    public fun admin_activate_enterprise(arg0: &0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::AdminCap, arg1: &mut 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::GlobalConfig, arg2: address, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::register_user(arg1, arg2, v1, arg5);
        let v2 = Subscription{
    ...
    public fun admin_extend_enterprise(arg0: &0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::AdminCap, arg1: &mut Subscription, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
    ...
    fun pay_and_return_change<T0>(arg0: &mut 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::treasury::Treasury, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::coin::value<T0>(&arg1) >= arg2, 102);
        if (arg2 > 0) {
            0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::treasury::deposit<T0>(arg0, 0x2::coin::split<T0>(&mut arg1, arg2, arg4), 0x2::tx_context::sender(arg4), arg3, 0x2::tx_context::epoch(arg4));
        };
        arg1
    }
    ...
    public fun remove_plan_coin_price<T0>(arg0: &0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::AdminCap, arg1: &mut PlanRegistry, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 3, 100);
        let v0 = (arg2 as u64);
    ...
    public fun renew<T0>(arg0: &0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::GlobalConfig, arg1: &PlanRegistry, arg2: &mut 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::treasury::Treasury, arg3: &mut Subscription, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::billing_period_epochs(arg0);
    ...
    public fun set_plan_coin_price<T0>(arg0: &0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::AdminCap, arg1: &mut PlanRegistry, arg2: u8, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 3, 100);
        let v0 = (arg2 as u64);
        assert!(v0 < 0x1::vector::length<PlanDef>(&arg1.plans), 115);
        let v1 = 0x1::type_name::with_original_ids<T0>();
    ...
    public fun subscribe<T0>(arg0: &mut 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::GlobalConfig, arg1: &PlanRegistry, arg2: &mut 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::treasury::Treasury, arg3: u8, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : (UserAccount, Subscription, 0x2::coin::Coin<T0>) {
        0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::assert_not_paused(arg0);
        0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::assert_version(arg0);
        assert!(arg3 <= 3, 100);
        assert!(arg3 != 3, 123);
        let v0 = 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::billing_period_epochs(arg0);
        ...
        0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::register_user(arg0, 0x2::tx_context::sender(arg5), v7, arg5);
        let v8 = Subscription{
            id                     : 0x2::object::new(arg5),
    ...
    public fun update_plan_limits(arg0: &0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin::AdminCap, arg1: &mut PlanRegistry, arg2: u8, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: bool, arg10: bool, arg11: u64, arg12: u64, arg13: u64, arg14: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 3, 100);
        let v0 = (arg2 as u64);
        assert!(v0 < 0x1::vector::length<PlanDef>(&arg1.plans), 115);
