module 0x2f548bb4bb1e5f7622c527417d3c0221840d0412ec23d70306f1bd4b79c20b45::admin {
    ...
    struct MaxFoldersPerStoreUpdated has copy, drop {
        old_max: u64,
        new_max: u64,
        updated_by: address,
        epoch: u64,
    ...
    public fun max_folders_hard_cap() : u64 {
        1024
    }

    public fun max_folders_per_store(arg0: &GlobalConfig) : u64 {
        arg0.max_folders_per_store
    }
    ...
    public fun update_max_folders_per_store(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert_version(arg1);
        assert!(arg2 > 0 && arg2 <= 1024, 18);
        arg1.max_folders_per_store = arg2;
        let v0 = MaxFoldersPerStoreUpdated{
            old_max    : arg1.max_folders_per_store,
            new_max    : arg2,
            updated_by : 0x2::tx_context::sender(arg3),
            epoch      : 0x2::tx_context::epoch(arg3),
        };
        0x2::event::emit<MaxFoldersPerStoreUpdated>(v0);
    }
