module 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::vault {
    ...
    public(friend) fun withdraw<T0>(arg0: &mut Vaults, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::pay::split_and_transfer<T0>(0x2::dynamic_object_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<T0>>(&mut arg0.id, 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_full_type<T0>()), arg1, arg2, arg3);
        let v0 = OutVault{
            vault_id : 0x2::object::uid_to_inner(&arg0.id),
            amount   : arg1,
