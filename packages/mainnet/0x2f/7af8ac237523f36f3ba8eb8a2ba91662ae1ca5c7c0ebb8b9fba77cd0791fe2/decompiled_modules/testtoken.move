module 0x2f7af8ac237523f36f3ba8eb8a2ba91662ae1ca5c7c0ebb8b9fba77cd0791fe2::testtoken {
    ...
    fun init(arg0: TESTTOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<TESTTOKEN>(arg0, 9, b"TT", b"TESTTOKEN", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v3 = v1;
        0x2::coin::mint_and_transfer<TESTTOKEN>(&mut v3, 1000000000000000, v0, arg1);
