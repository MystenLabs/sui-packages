module 0x2f994018d1b9b9b5686b8a842a04ca0c3a91ddabb3b1c340d55ab7f1109d3d4b::suilend_adapter {
    ...
    public fun withdraw_with_delevering<T0, T1: drop>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: u64, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        while (0x2::coin::value<0x2::sui::SUI>(&v2) < arg5 && v1 < 10) {
            ...
            if (v3 == 0) {
                let v4 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::ceil(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::mul(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::div(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(arg5 - 0x2::coin::value<0x2::sui::SUI>(&v2)), 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::price<T0>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserve<T0, T1>(arg0))), 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::price<T0>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserve<T0, 0x2::sui::SUI>(arg0))));
                let v5 = withdraw_liquidity_from_suilend<T0, T1>(arg0, arg2, arg4, arg3, v4, arg7, arg9);
                0x2::coin::join<0x2::sui::SUI>(&mut v2, 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::redeem<T1>(arg6, v5, arg7, arg9));
                break
            };
            let v6 = calculate_safe_withdraw_amount<T0, T1>(arg0, arg3, arg2, arg4);
            if (v6 < 10000) {
                break
            };
            if (!check_health_factor_safe<T0>(arg0, arg3, arg4)) {
            ...
            if (v3 > 0) {
                let v9 = &mut v8;
                repay_borrow<T0, 0x2::sui::SUI>(arg0, arg1, arg3, arg4, v9, arg9);
            };
            0x2::coin::join<0x2::sui::SUI>(&mut v2, v8);
            v1 = v1 + 1;
        };
        let v10 = 0x2::coin::value<0x2::sui::SUI>(&v2);
        if (v10 > arg5) {
            let v11 = 0x2::coin::split<0x2::sui::SUI>(&mut v2, v10 - arg5, arg9);
            deposit_to_suilend<T0, 0x2::sui::SUI>(arg0, arg1, arg4, v11, arg3, arg9);
        };
        v2
    }
