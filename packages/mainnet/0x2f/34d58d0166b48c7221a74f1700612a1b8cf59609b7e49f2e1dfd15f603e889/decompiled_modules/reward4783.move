module 0x2f34d58d0166b48c7221a74f1700612a1b8cf59609b7e49f2e1dfd15f603e889::reward4783 {
    struct REWARD4783 has drop {
        dummy_field: bool,
    }

    struct TICKET_4783 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4783(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4783>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4783>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4783, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4783>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4783>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4783>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4783>>(v5, 0x2::tx_context::sender(arg1));
    }
