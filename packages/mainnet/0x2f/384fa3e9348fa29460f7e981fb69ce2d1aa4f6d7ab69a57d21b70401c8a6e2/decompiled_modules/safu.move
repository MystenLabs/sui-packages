module 0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::safu {
    ...
    public(friend) fun post_deposit_dov_(arg0: &0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt, arg4: &mut 0x2::tx_context::TxContext) {
        0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::verify(arg0, arg4);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2);
        let v1 = 0x1::vector::empty<u64>();
        let v2 = &mut v1;
        0x1::vector::push_back<u64>(v2, arg2);
        0x1::vector::push_back<u64>(v2, *0x1::vector::borrow<u64>(&v0.info, 1));
        let v3 = 0x2::object::id_address<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt>(&arg3);
        ...
        0x2::dynamic_object_field::add<0x1::ascii::String, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt>(&mut v0.id, 0x1::ascii::string(b"typus_deposit_receipt"), arg3);
    }
    ...
    public(friend) fun post_withdraw_dov_<T0>(arg0: &0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::verify(arg0, arg4);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2);
        assert!(*0x1::vector::borrow<u64>(&v0.info, 4) == 5, invalid_status(arg2));
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 4) = 0;
        ...
        if (v1 < v2) {
            0x2::balance::join<T0>(&mut arg3, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"mist_balance")), 1));
        };
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"deposit_balance")), 0x2::balance::split<T0>(&mut arg3, v2));
        if (0x2::balance::value<T0>(&arg3) > 0 && 0x2::balance::value<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"mist_balance"))) == 0) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"mist_balance")), 0x2::balance::split<T0>(&mut arg3, 1));
        };
    ...
    public fun pre_bid_v2(arg0: &mut 0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : u64 {
        0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::verify(arg0, arg9);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2);
        assert!(*0x1::vector::borrow<u64>(&v0.info, 4) == 0, invalid_status(arg2));
        let v1 = (((arg3 as u128) * (*0x1::vector::borrow<u64>(&v0.config, 4) as u128) / (10000 as u128)) as u64);
        let v2 = calculate_bid_size(arg4, arg6, arg8, v1, arg7);
        let v3 = calculate_bid_value(arg4, arg5, arg6, arg8, v2);
        let v4 = 0x1::vector::empty<u64>();
        let v5 = &mut v4;
        0x1::vector::push_back<u64>(v5, arg2);
        0x1::vector::push_back<u64>(v5, *0x1::vector::borrow<u64>(&v0.info, 1));
        0x1::vector::push_back<u64>(v5, arg3);
        0x1::vector::push_back<u64>(v5, v1);
        0x1::vector::push_back<u64>(v5, v2);
        0x1::vector::push_back<u64>(v5, v3);
        let v6 = ManagerEvent{
            action      : 0x1::ascii::string(b"pre_bid_v2"),
            log         : v4,
            bcs_padding : vector[],
        };
        0x2::event::emit<ManagerEvent>(v6);
    ...
    public(friend) fun pre_deposit_dov_<T0>(arg0: &0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, u64) {
        0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::verify(arg0, arg4);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2);
        assert!(*0x1::vector::borrow<u64>(&v0.info, 5) == 1, lending_disabled(arg2));
        assert!(0x2::clock::timestamp_ms(arg3) < *0x1::vector::borrow<u64>(&v0.info, 3), not_time_yet(arg2));
        assert!(*0x1::vector::borrow<u64>(&v0.info, 4) == 0, invalid_status(arg2));
    ...
    public(friend) fun pre_withdraw_dov_(arg0: &0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt, u64) {
        0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::verify(arg0, arg3);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2);
        assert!(*0x1::vector::borrow<u64>(&v0.info, 4) == 5, invalid_status(arg2));
        let v1 = 0x2::dynamic_object_field::remove<0x1::ascii::String, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt>(&mut v0.id, 0x1::ascii::string(b"typus_deposit_receipt"));
        let v2 = 0x1::vector::empty<u64>();
        let v3 = &mut v2;
        0x1::vector::push_back<u64>(v3, arg2);
        0x1::vector::push_back<u64>(v3, *0x1::vector::borrow<u64>(&v0.info, 1));
        let v4 = 0x2::object::id_address<0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusDepositReceipt>(&v1);
        let v5 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v5, 0x1::bcs::to_bytes<address>(&v4));
        let v6 = ManagerEvent{
    ...
    public fun restart<T0>(arg0: &0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        0xa7bedeaa28ff3defa50d012812618178727f530bc5a70af5d03fc6424a984cc7::version::verify(arg0, arg6);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, arg2);
        assert!(*0x1::vector::borrow<u64>(&v0.info, 4) == 999, invalid_status(arg2));
        assert!(*0x1::vector::borrow<u64>(&v0.share_supply, 0) + *0x1::vector::borrow<u64>(&v0.share_supply, 1) + *0x1::vector::borrow<u64>(&v0.share_supply, 2) + *0x1::vector::borrow<u64>(&v0.share_supply, 3) == 0x2::balance::value<T0>(0x2::dynamic_field::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&v0.id, 0x1::ascii::string(b"deposit_balance"))), contaminated_share(arg2));
        let v1 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::length(&v0.share);
        if (v1 > 0) {
            let v2 = (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::slice_size(&v0.share) as u64);
            ...
            while (v4 < v1) {
                ...
                *0x1::vector::borrow_mut<u64>(&mut v5.share, 4) = *0x1::vector::borrow<u64>(&v5.share, 2);
                *0x1::vector::borrow_mut<u64>(&mut v5.share, 0) = *0x1::vector::borrow<u64>(&v5.share, 3) + *0x1::vector::borrow<u64>(&v5.share, 2);
                *0x1::vector::borrow_mut<u64>(&mut v5.share, 3) = 0;
                *0x1::vector::borrow_mut<u64>(&mut v5.share, 2) = 0;
                if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 4) = 0;
        ...
        let v9 = ManagerEvent{
            action      : 0x1::ascii::string(b"restart"),
            log         : v7,
            bcs_padding : vector[],
        };
        0x2::event::emit<ManagerEvent>(v9);
        *0x1::vector::borrow_mut<u64>(&mut v0.share_supply, 4) = *0x1::vector::borrow<u64>(&v0.share_supply, 2);
        *0x1::vector::borrow_mut<u64>(&mut v0.share_supply, 0) = *0x1::vector::borrow<u64>(&v0.share_supply, 3) + *0x1::vector::borrow<u64>(&v0.share_supply, 2);
        *0x1::vector::borrow_mut<u64>(&mut v0.share_supply, 3) = 0;
        *0x1::vector::borrow_mut<u64>(&mut v0.share_supply, 2) = 0;
