module 0x2f4206770841c3398361060947c88cf184f4cbbb3502ef6c235be59a9b025d35::tood {
    ...
    fun init(arg0: TOOD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOOD>(arg0, 9, b"TOOD", b"VvvvV", x"e9a392e9a392", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://wwww.meme.com")), arg1);
        let v2 = v1;
