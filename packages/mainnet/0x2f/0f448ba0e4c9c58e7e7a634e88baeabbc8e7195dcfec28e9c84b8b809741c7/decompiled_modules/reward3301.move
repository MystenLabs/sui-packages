module 0x2f0f448ba0e4c9c58e7e7a634e88baeabbc8e7195dcfec28e9c84b8b809741c7::reward3301 {
    struct REWARD3301 has drop {
        dummy_field: bool,
    }

    struct TICKET_3301 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3301(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3301>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3301>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3301, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3301>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3301>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3301>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3301>>(v5, 0x2::tx_context::sender(arg1));
    }
