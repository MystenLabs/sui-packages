module 0x5e42466c68fcbcf5d1f79291d745a73c0ed0450e554c8c9d5c2fae924b240f5b::swap_pool {
    ...
    struct VerifyValueEvent has copy, drop {
        value: u64,
    }
    ...
    public fun verify(arg0: &SwapPool, arg1: u64) {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) > arg1, 2);
    }

    public fun verify_with_event(arg0: &SwapPool, arg1: u64) {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) > arg1, 2);
        let v0 = VerifyValueEvent{value: 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) - arg1};
        0x2::event::emit<VerifyValueEvent>(v0);
    }
