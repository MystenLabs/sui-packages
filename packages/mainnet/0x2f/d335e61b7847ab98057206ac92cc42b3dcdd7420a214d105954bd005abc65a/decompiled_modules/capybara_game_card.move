module 0x2fd335e61b7847ab98057206ac92cc42b3dcdd7420a214d105954bd005abc65a::capybara_game_card {
    ...
    fun init(arg0: CAPYBARA_GAME_CARD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Coins Earned: {points}"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"League: {league}"));
