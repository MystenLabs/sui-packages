module 0x2f4b327d7e56d9e699ee1063e74875026572b378f669c7b9b944a245ea0bd819::cnsnft8262 {
    struct CNSNFT8262 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8262, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2618"));
        let v4 = 0x2::package::claim<CNSNFT8262>(arg0, arg1);
