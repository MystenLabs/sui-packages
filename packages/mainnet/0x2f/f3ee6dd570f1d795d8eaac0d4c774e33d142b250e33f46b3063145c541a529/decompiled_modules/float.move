module 0x2ff3ee6dd570f1d795d8eaac0d4c774e33d142b250e33f46b3063145c541a529::float {
    ...
    public fun div(arg0: Float, arg1: Float) : Float {
        ...
        Float{value: (((arg0.value as u256) * (1000000000 as u256) / (arg1.value as u256)) as u128)}
    }
    ...
    public fun mul(arg0: Float, arg1: Float) : Float {
        Float{value: (((arg0.value as u256) * (arg1.value as u256) / (1000000000 as u256)) as u128)}
    }
