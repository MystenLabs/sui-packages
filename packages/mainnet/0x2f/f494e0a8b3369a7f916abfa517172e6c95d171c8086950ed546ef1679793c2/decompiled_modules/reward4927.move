module 0x2ff494e0a8b3369a7f916abfa517172e6c95d171c8086950ed546ef1679793c2::reward4927 {
    struct REWARD4927 has drop {
        dummy_field: bool,
    }

    struct TICKET_4927 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4927(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4927>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4927>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4927, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4927>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4927>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4927>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4927>>(v5, 0x2::tx_context::sender(arg1));
    }
