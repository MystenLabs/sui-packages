module 0x2f144cd05ab1124ce5701e48730186bdfb210f366c66507a36e27bfaf0257051::cnsnft2273 {
    struct CNSNFT2273 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2273, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2273>(arg0, arg1);
