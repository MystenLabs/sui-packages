module 0x2f5aeeb7b5d9ef6e35e49da4001d055729af17e7b070e9a79db8ac9422aa253d::reward5687 {
    struct REWARD5687 has drop {
        dummy_field: bool,
    }

    struct TICKET_5687 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5687(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5687>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5687>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5687, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5687>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5687>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5687>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5687>>(v5, 0x2::tx_context::sender(arg1));
    }
