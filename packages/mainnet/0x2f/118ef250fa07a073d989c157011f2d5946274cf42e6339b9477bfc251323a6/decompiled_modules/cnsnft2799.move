module 0x2f118ef250fa07a073d989c157011f2d5946274cf42e6339b9477bfc251323a6::cnsnft2799 {
    struct CNSNFT2799 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2799, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2799>(arg0, arg1);
