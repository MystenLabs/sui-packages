module 0x2fa9d477bd8d43ae6371f9432702bd6441e693667fadd864e7e7fb932dfcd4b1::random_panda_club {
    ...
    fun init(arg0: RANDOM_PANDA_CLUB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RANDOM_PANDA_CLUB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Random Panda Club"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Random Panda Club is issued by the Panda Sui community. It is a special NFT collection that allows users to convert their held NFTs with Coins interchangeably, solving the problem of liquidity depletion in the NFT market."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreib3dad7n67n2mbkpipez222io7yldije4mhrkhw6gnv74ubas2wdi"));
