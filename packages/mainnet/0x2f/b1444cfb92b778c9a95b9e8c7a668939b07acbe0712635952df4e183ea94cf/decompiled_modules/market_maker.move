module 0x2fb1444cfb92b778c9a95b9e8c7a668939b07acbe0712635952df4e183ea94cf::market_maker {
    ...
    public fun rebalance_swap_sell<T0, T1>(arg0: &mut 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool::LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: 0x1::option::Option<DepositAddress>, arg6: 0x1::option::Option<DepositAddress>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v16, v17) = if (0x2::balance::value<T0>(&v0) == 0) {
            let v18 = if (v4 == 0) {
                6004
            } else {
                6005
            ...
            let (v20, v21) = if (v7 >= arg4) {
                let v22 = RebalanceSwapSellEvent{
                    pool_id            : v6,
                    sender             : 0x2::tx_context::sender(arg8),
                    status             : 6001,
                    base_out           : 0x2::balance::value<T0>(&v0),
                ...
                0x2::event::emit<RebalanceSwapSellEvent>(v22);
                (0x2::balance::zero<T1>(), v0)
            } else {
                let (v23, v24) = if (v15 == 0) {
                    let v25 = RebalanceSwapSellEvent{
                        pool_id            : v6,
                        sender             : 0x2::tx_context::sender(arg8),
                        status             : 6002,
                        base_out           : 0x2::balance::value<T0>(&v0),
                    ...
                    0x2::event::emit<RebalanceSwapSellEvent>(v25);
                    (v0, 0x2::balance::zero<T1>())
                } else {
        ...
        let v26 = v17;
        let v27 = v16;
        let v28 = if (0x1::option::is_some<DepositAddress>(&arg5)) {
            0x1::option::borrow<DepositAddress>(&arg5).address
        } else {
            0x2::tx_context::sender(arg8)
        };
        let v29 = if (0x1::option::is_some<DepositAddress>(&arg6)) {
            0x1::option::borrow<DepositAddress>(&arg6).address
        } else {
            0x2::tx_context::sender(arg8)
        };
        if (0x2::balance::value<T0>(&v27) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v27, arg8), v28);
        } else {
            0x2::balance::destroy_zero<T0>(v27);
        };
        if (0x2::balance::value<T1>(&v26) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v26, arg8), v29);
        } else {
