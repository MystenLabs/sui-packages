module 0x2fc90a80499db1843fb1e5f60f48708550d4aff0992bf972812dddbc9b3a6eac::xaum_indicator_core {
    ...
    public fun assert_current_version(arg0: &PriceStorage) {
        assert!(is_current_version(arg0), 3);
    }
    ...
    public fun is_current_version(arg0: &PriceStorage) : bool {
        arg0.version == 1
    }
    ...
    public fun push_gr_indicators_to_x_oracle(arg0: &PriceStorage, arg1: &AdminCap, arg2: &mut 0xcde8e9f40019620c316c66627733237292e11f33ff2d0bffb1d4c2b3fed1646e::x_oracle::XOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        let v0 = ((arg0.latest_price / 1000000000) as u64);
        assert!(v0 > 0, 2);
        let v1 = AdminCapKey{dummy_field: false};
        0xcde8e9f40019620c316c66627733237292e11f33ff2d0bffb1d4c2b3fed1646e::x_oracle::set_gr_indicators(arg2, 0x2::dynamic_object_field::borrow<AdminCapKey, 0xcde8e9f40019620c316c66627733237292e11f33ff2d0bffb1d4c2b3fed1646e::x_oracle::XOracleAdminCap>(&arg0.id, v1), ((arg0.ema120_current / 1000000000) as u64), ((arg0.ema90_current / 1000000000) as u64), v0, 0x2::clock::timestamp_ms(arg3) / 1000, arg4);
    }
    ...
    public fun storage_version(arg0: &PriceStorage) : u64 {
        arg0.version
    }
    ...
    public fun update_price_storage_admin(arg0: &mut PriceStorage, arg1: &AdminCap, arg2: u256) {
        assert_admin(arg0, arg1);
        update_price_storage(arg0, arg2);
    }
