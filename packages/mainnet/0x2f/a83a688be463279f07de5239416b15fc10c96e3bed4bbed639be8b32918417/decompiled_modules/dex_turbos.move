module 0x2fa83a688be463279f07de5239416b15fc10c96e3bed4bbed639be8b32918417::dex_turbos {
    ...
    public fun get_pool_config() : address {
        0x2fa83a688be463279f07de5239416b15fc10c96e3bed4bbed639be8b32918417::constants::turbos_sui_usdc_pool()
    }
    ...
    public fun get_turbos_packages() : (address, address) {
        (@0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1, 0x2fa83a688be463279f07de5239416b15fc10c96e3bed4bbed639be8b32918417::constants::turbos_sui_usdc_pool())
    }
    ...
    public fun swap_sui_to_usdc<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u128, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = TurbosSwapExecuted{
            ...
            min_amount_out : arg2,
            pool_id        : 0x2fa83a688be463279f07de5239416b15fc10c96e3bed4bbed639be8b32918417::constants::turbos_sui_usdc_pool(),
