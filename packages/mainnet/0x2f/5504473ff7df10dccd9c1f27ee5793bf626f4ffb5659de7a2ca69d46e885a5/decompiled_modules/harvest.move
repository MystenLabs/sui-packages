module 0x2f5504473ff7df10dccd9c1f27ee5793bf626f4ffb5659de7a2ca69d46e885a5::harvest {
    ...
    public fun complete_harvest<T0>(arg0: &mut 0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::Vault<T0>, arg1: &mut HarvestConfig, arg2: &0x2f5504473ff7df10dccd9c1f27ee5793bf626f4ffb5659de7a2ca69d46e885a5::strategy::StrategyRegistry, arg3: HarvestPromise<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &0xcd90be8978b6ba0a88cc48270cf6de0bd4b0fae1ac8877c641243844dbabd215::price_info::PriceInfoObject, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let HarvestPromise {
            vault_id        : v0,
            strategy_id     : v1,
            expected_amount : v2,
        ...
        assert!(0x2::object::id<0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::Vault<T0>>(arg0) == v0, 702);
        ...
        0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::floors::assert_slippage(arg1.harvest_slippage_bps, false);
        assert!(v4 >= (((v2 as u128) * (v16 as u128) * 1000000 / v17) as u64) * (10000 - (arg1.harvest_slippage_bps as u64)) / 10000, 704);
        let v19 = 0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::performance_fee_bps<T0>(arg0);
        let v20 = 0;
        if (v19 > 0) {
            let v21 = v4 * v19 / 10000;
            v20 = v21;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg4, v21, arg7), 0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::fee_recipient<T0>(arg0));
        };
        0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::deposit_balance_to_idle<T0>(arg0, 0x2f5504473ff7df10dccd9c1f27ee5793bf626f4ffb5659de7a2ca69d46e885a5::strategy::borrow_protocol_access_cap(arg2), 0x2::coin::into_balance<T0>(arg4));
    ...
    public fun issue_harvest_promise<T0, T1>(arg0: &0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::Vault<T0>, arg1: &HarvestConfig, arg2: &0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::ProtocolAccessCap, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock) : HarvestPromise<T0> {
        let (v0, _) = should_harvest(arg1, arg3, arg5);
        assert!(v0, 700);
        HarvestPromise<T0>{
            vault_id        : 0x2::object::id<0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::Vault<T0>>(arg0),
            strategy_id     : arg3,
    ...
    public fun issue_harvest_promise_for_spoke<T0, T1>(arg0: &0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::vault::Vault<T0>, arg1: &HarvestConfig, arg2: &0x2f5504473ff7df10dccd9c1f27ee5793bf626f4ffb5659de7a2ca69d46e885a5::strategy::StrategyRegistry, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock) : HarvestPromise<T0> {
        issue_harvest_promise<T0, T1>(arg0, arg1, 0x2f5504473ff7df10dccd9c1f27ee5793bf626f4ffb5659de7a2ca69d46e885a5::strategy::borrow_protocol_access_cap(arg2), arg3, arg4, arg5)
    }
    ...
    public(friend) fun set_harvest_slippage_bps(arg0: &mut HarvestConfig, arg1: u64) {
        0xdeb7b8ffa0ca0480ca78bf6c07a9b460f1627a529288696a3b1b1a67012eed5d::floors::assert_slippage(arg1, false);
