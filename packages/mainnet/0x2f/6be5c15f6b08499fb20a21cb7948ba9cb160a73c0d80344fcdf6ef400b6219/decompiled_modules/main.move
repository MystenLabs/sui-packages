module 0x7623378eed7bc765d60c6257250c3b79997ef9000a7721ee77912533b4783d8c::main {
    ...
    public fun claim_released<T0>(arg0: &mut SuiReleasePool, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &0x2::clock::Clock, arg6: &mut 0x3::sui_system::SuiSystemState, arg7: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1.released_amount - v1.claimed_amount;
        assert!(v2 > 0, 6);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(withdrawSui<T0>(&arg0.vault, v2, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8), v0);
    ...
    public fun robot_daily_release(arg0: &mut SuiReleasePool, arg1: vector<address>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.robot, 1);
        check_version(arg0);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        let v1 = 0;
        while (v1 < 0x1::vector::length<address>(&arg1)) {
            let v2 = *0x1::vector::borrow<address>(&arg1, v1);
            assert!(0x2::table::contains<address, UserSuiReleaseData>(&arg0.users, v2), 3);
            let v3 = 0x2::table::borrow_mut<address, UserSuiReleaseData>(&mut arg0.users, v2);
            assert!(v0 >= v3.last_release_time && v0 - v3.last_release_time >= 43200000, 4);
            let v4 = calc_daily_release_amount(v3.staked_amount, v3.released_amount, arg0.daily_release_bps);
            if (v4 > 0) {
                assert!(v3.released_amount + v4 <= v3.staked_amount, 5);
                v3.released_amount = v3.released_amount + v4;
                arg0.total_released_amount = arg0.total_released_amount + v4;
                arg0.total_running_staked_amount = arg0.total_running_staked_amount - v4;
            };
