module 0x2faec3e9459e5b389a5a8b5c1586a13532d2f02d3909126aea143a1e89ab712c::eval {
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        ...
        while (v3 < 5) {
            ...
            assert!(v4 < 52, 1);
            let v5 = 0x2faec3e9459e5b389a5a8b5c1586a13532d2f02d3909126aea143a1e89ab712c::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0x2faec3e9459e5b389a5a8b5c1586a13532d2f02d3909126aea143a1e89ab712c::types::card_suit(v4));
