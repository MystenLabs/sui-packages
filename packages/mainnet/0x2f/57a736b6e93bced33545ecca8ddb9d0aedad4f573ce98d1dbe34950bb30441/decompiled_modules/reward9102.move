module 0x2f57a736b6e93bced33545ecca8ddb9d0aedad4f573ce98d1dbe34950bb30441::reward9102 {
    struct REWARD9102 has drop {
        dummy_field: bool,
    }

    struct TICKET_9102 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9102(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9102>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9102>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9102, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9102>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9102>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9102>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9102>>(v5, 0x2::tx_context::sender(arg1));
    }
