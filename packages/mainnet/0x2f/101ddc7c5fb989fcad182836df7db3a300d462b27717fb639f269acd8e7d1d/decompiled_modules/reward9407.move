module 0x2f101ddc7c5fb989fcad182836df7db3a300d462b27717fb639f269acd8e7d1d::reward9407 {
    struct REWARD9407 has drop {
        dummy_field: bool,
    }

    struct TICKET_9407 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9407(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9407>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9407>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9407, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9407>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9407>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9407>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9407>>(v5, 0x2::tx_context::sender(arg1));
    }
