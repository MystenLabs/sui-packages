module 0x2f21c18e9e5b254c2ec224f47a8b5910a5696355fa06b17710eeea3f53639860::nft_collection {
    ...
    public entry fun mint_multiple_nfts(arg0: &mut Collection, arg1: &mut 0x2f21c18e9e5b254c2ec224f47a8b5910a5696355fa06b17710eeea3f53639860::attributes::CollectionData, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0, 7);
        assert!(arg3 <= 10, 6);
        mint_nfts_internal(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    public entry fun mint_nft(arg0: &mut Collection, arg1: &mut 0x2f21c18e9e5b254c2ec224f47a8b5910a5696355fa06b17710eeea3f53639860::attributes::CollectionData, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        mint_nfts_internal(arg0, arg1, arg2, 1, arg3, arg4);
    }

    fun mint_nfts_internal(arg0: &mut Collection, arg1: &mut 0x2f21c18e9e5b254c2ec224f47a8b5910a5696355fa06b17710eeea3f53639860::attributes::CollectionData, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(arg0.total_minted + arg3 <= 500, 1);
        assert!(0x2f21c18e9e5b254c2ec224f47a8b5910a5696355fa06b17710eeea3f53639860::attributes::nfts_left(arg1) >= arg3, 4);
        ...
        let v5 = 0;
        while (v5 < arg3) {
            let v6 = 0x2f21c18e9e5b254c2ec224f47a8b5910a5696355fa06b17710eeea3f53639860::attributes::nfts_left(arg1);
            let v7 = if (v6 == 1) {
                0
            } else {
                0x2::random::generate_u64_in_range(&mut v3, 0, v6 - 1)
            };
            let (v8, v9, v10, v11, v12, v13) = 0x2f21c18e9e5b254c2ec224f47a8b5910a5696355fa06b17710eeea3f53639860::attributes::get_nft(arg1, v7);
            let v14 = v13;
            let v15 = v12;
