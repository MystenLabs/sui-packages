module 0x2f8f086af67922d7e4147b3e899ae33671606ecc4a936296046c5f8bd4cbe37a::franky_ko {
    ...
    fun init(arg0: FRANKY_KO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Y-Nmn9OL3bWgWR69CNA9d7JSf7MPBWscDnSwxJQk1gw"));
