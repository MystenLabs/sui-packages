module 0x2f87202caf14b9db46be327f60c77f0d343ab2393c35bd8ceaa5de71cbcffbba::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &mut PoolConfig<T0>, arg1: u64, arg2: u64) : u64 {
        ...
        if (v0 > 0) {
            let v2 = 365;
            100 * arg1 / v0 * 100 * 0x2::balance::value<T0>(&arg0.reward_balance) / v2 / v2 * (100 * arg2 / 90 + 50) * v2 / 100
        } else {
            250000
        }
    }
