module 0x2f513b8a07eefe286d78abb499ccc82b4154ed5b5a08449e05f6c45c7f45927d::listings {
    ...
    public fun buy_with_transfer_request<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        let (v0, v1, v2) = buy<T0>(arg0, arg1, arg2, arg3);
        0x2::transfer_policy::new_request<T0>(v0, v1, v2)
    }
