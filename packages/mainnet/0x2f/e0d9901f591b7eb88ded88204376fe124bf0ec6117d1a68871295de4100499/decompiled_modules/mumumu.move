module 0x2fe0d9901f591b7eb88ded88204376fe124bf0ec6117d1a68871295de4100499::mumumu {
    ...
    struct NFT has store, key {
        ...
        token_id: u64,
        image_base: 0x1::string::String,
        metadata: 0x2::vec_map::VecMap<0x1::string::String, 0x2::vec_map::VecMap<0x1::string::String, vector<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>>>,
    }
    ...
    fun generate_metadata(arg0: u64, arg1: &Mumumu) : 0x2::vec_map::VecMap<0x1::string::String, 0x2::vec_map::VecMap<0x1::string::String, vector<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>>> {
        let v0 = 0x2::vec_map::empty<0x1::string::String, 0x2::vec_map::VecMap<0x1::string::String, vector<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>>>();
        let v1 = 0x2::vec_map::empty<0x1::string::String, vector<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>>();
        let v2 = 0x1::vector::empty<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>();
        let v3 = if (0x2::table::contains<u64, 0x1::string::String>(&arg1.character_types, arg0)) {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v4, 0x1::string::utf8(b"key"), 0x1::string::utf8(b"Character"));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v4, 0x1::string::utf8(b"value"), v3);
        0x1::vector::push_back<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&mut v2, v4);
        0x2::vec_map::insert<0x1::string::String, vector<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>>(&mut v1, 0x1::string::utf8(b"contents"), v2);
        0x2::vec_map::insert<0x1::string::String, 0x2::vec_map::VecMap<0x1::string::String, vector<0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>>>(&mut v0, 0x1::string::utf8(b"attributes"), v1);
        v0
    }
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Mumumu v2 #{token_id}"));
        ...
        let v10 = v9;
        let v11 = v8;
        0x2fe0d9901f591b7eb88ded88204376fe124bf0ec6117d1a68871295de4100499::royalty_rule::add<NFT>(&mut v11, &v10, 1000, 0);
        0x2fe0d9901f591b7eb88ded88204376fe124bf0ec6117d1a68871295de4100499::kiosk_lock_rule::add<NFT>(&mut v11, &v10);
    ...
    fun mint_nft(arg0: &mut Mumumu, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg2) {
            ...
            let v2 = NFT{
                ...
                metadata   : generate_metadata(v1, arg0),
            };
    ...
    public entry fun purchase_token(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::transfer_policy::TransferPolicy<NFT>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2fe0d9901f591b7eb88ded88204376fe124bf0ec6117d1a68871295de4100499::kiosk_lock_rule::prove<NFT>(&mut v2, &v6);
