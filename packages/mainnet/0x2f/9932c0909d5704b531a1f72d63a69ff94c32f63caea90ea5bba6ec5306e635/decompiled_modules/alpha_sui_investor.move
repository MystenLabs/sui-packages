module 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::alpha_sui_investor {
    ...
    fun autocompound_internal<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, T1>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: 0x2::balance::Balance<T0>, arg7: 0x2::balance::Balance<T1>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_reward<T0, T1, 0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(arg2, arg5, v0, arg3, true, arg8);
        ...
        let v2 = 0x2::coin::from_balance<T1>(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_reward<T0, T1, T1>(arg2, arg5, v0, arg3, true, arg8), arg9);
        if (0x2::balance::value<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&v1) >= 100000) {
            let (v3, v4) = 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::converter::swap_a2b<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, T1>(arg2, arg4, 0x2::coin::from_balance<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(v1, arg9), true, 0x2::balance::value<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&v1), arg8, arg9);
            0x2::coin::destroy_zero<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(v3);
            0x2::coin::join<T1>(&mut v2, v4);
        } else {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v2, (((0x2::coin::value<T1>(&v2) as u128) * (arg0.performance_fee as u128) / 10000) as u64), arg9), 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::distributor::get_fee_wallet_address(arg1));
        0x2::balance::join<T1>(&mut arg0.free_balance_b, 0x2::coin::into_balance<T1>(v2));
        let (v5, v6) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_fee<T0, T1>(arg2, arg5, v0, true);
        let v7 = v6;
        let v8 = v5;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v8, (((0x2::balance::value<T0>(&v8) as u128) * (arg0.performance_fee as u128) / 10000) as u64)), arg9), 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v7, (((0x2::balance::value<T1>(&v7) as u128) * (arg0.performance_fee as u128) / 10000) as u64)), arg9), 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::distributor::get_fee_wallet_address(arg1));
        ...
        let (v9, v10) = get_total_balance_in_ratio<T0, T1>(arg0, arg1, arg2, v8, v7, arg5, arg8, arg9);
        let v11 = v10;
        let v12 = v9;
        let v13 = FreeBalanceEventNew{
            free_balance_a : 0x2::balance::value<T0>(&arg0.free_balance_a),
            free_balance_b : 0x2::balance::value<T1>(&arg0.free_balance_b),
            balance_a      : 0x2::balance::value<T0>(&v12),
            balance_b      : 0x2::balance::value<T1>(&v11),
            location       : 10,
        };
        0x2::event::emit<FreeBalanceEventNew>(v13);
        0x2::balance::join<T0>(&mut v12, arg6);
        0x2::balance::join<T1>(&mut v11, arg7);
        let (_, v15, v16) = get_balances_in_ratio<T0, T1>(arg0, v12, v11, arg5, true);
        let v17 = v16;
        let v18 = v15;
