module 0x2f38f21ddc6d6b7ab349d79cb68dc24928ee87250bb758461b9b60abc26da8cf::cnsnft3460 {
    struct CNSNFT3460 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3460, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3460>(arg0, arg1);
