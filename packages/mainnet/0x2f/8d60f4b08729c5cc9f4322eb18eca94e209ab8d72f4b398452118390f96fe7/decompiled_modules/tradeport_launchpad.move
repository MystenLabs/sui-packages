module 0x2f8d60f4b08729c5cc9f4322eb18eca94e209ab8d72f4b398452118390f96fe7::tradeport_launchpad {
    ...
    fun get_nft_metadata_0(arg0: &0x2::clock::Clock, arg1: &mut Group, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::bag::Bag, 0x1::option::Option<0x2::bag::Bag>) {
        ...
        if (arg2 && !0xc74531639fadfb02d30f05f37de4cf1e1149ed8d23658edd089004830068180b::warehouse::is_empty<0x2::bag::Bag>(v0)) {
            return (0x2f8d60f4b08729c5cc9f4322eb18eca94e209ab8d72f4b398452118390f96fe7::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::some<0x2::bag::Bag>(0x2f8d60f4b08729c5cc9f4322eb18eca94e209ab8d72f4b398452118390f96fe7::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3)))
        };
        (0x2f8d60f4b08729c5cc9f4322eb18eca94e209ab8d72f4b398452118390f96fe7::warehouse_utils::redeem_random_nft<0x2::bag::Bag>(arg0, v0, arg3), 0x1::option::none<0x2::bag::Bag>())
    }
