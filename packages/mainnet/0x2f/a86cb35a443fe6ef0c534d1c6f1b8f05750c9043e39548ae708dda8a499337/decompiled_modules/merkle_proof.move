module 0x2fa86cb35a443fe6ef0c534d1c6f1b8f05750c9043e39548ae708dda8a499337::merkle_proof {
    ...
    fun hash_pair(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
        if (0x2fa86cb35a443fe6ef0c534d1c6f1b8f05750c9043e39548ae708dda8a499337::vectors::lt(&arg0, &arg1)) {
    ...
    fun process_multi_proof(arg0: &vector<vector<u8>>, arg1: &vector<bool>, arg2: &vector<vector<u8>>) : vector<u8> {
        ...
        while (v6 < v1) {
            let v7 = if (v3 < v0) {
                let v8 = *0x1::vector::borrow<vector<u8>>(arg2, v3);
                v3 = v3 + 1;
                v8
            } else {
                let v9 = *0x1::vector::borrow<vector<u8>>(&v2, v4);
                v4 = v4 + 1;
                v9
            };
            let v10 = if (*0x1::vector::borrow<bool>(arg1, v6)) {
                if (v3 < v0) {
                    let v11 = *0x1::vector::borrow<vector<u8>>(arg2, v3);
                    v3 = v3 + 1;
                    v11
                } else {
                    let v12 = *0x1::vector::borrow<vector<u8>>(&v2, v4);
                    v4 = v4 + 1;
                    v12
                }
            } else {
                let v13 = *0x1::vector::borrow<vector<u8>>(arg0, v5);
                v5 = v5 + 1;
                v13
            };
