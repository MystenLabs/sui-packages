module 0x2fda0f938965a557fe291c931ce4540aec361526d4c3804316868fefbf445800::parameterized {
    ...
    public entry fun mint_custom_token(arg0: &mut TransferParams, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<CUSTOM_COIN>(v1, 9, arg2, arg1, arg3, 0x1::option::none<0x2::url::Url>(), arg5);
        let v4 = v2;
