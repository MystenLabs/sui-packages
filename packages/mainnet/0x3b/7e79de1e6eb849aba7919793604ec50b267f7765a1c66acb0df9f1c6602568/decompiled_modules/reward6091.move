module 0x3b7e79de1e6eb849aba7919793604ec50b267f7765a1c66acb0df9f1c6602568::reward6091 {
    struct REWARD6091 has drop {
        dummy_field: bool,
    }

    struct TICKET_6091 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6091(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6091>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6091>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6091, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6091>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6091>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6091>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6091>>(v5, 0x2::tx_context::sender(arg1));
    }
