module 0x3b3f5e3319d4c88c929e9a3e5af5f9610e3f3a3285fec82cd8f22167e6364590::reward1509 {
    struct REWARD1509 has drop {
        dummy_field: bool,
    }

    struct TICKET_1509 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1509(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1509>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1509>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1509, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1509>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1509>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1509>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1509>>(v5, 0x2::tx_context::sender(arg1));
    }
