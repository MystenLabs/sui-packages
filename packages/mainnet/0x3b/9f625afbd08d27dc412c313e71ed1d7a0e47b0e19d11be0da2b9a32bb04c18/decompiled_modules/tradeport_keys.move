module 0x3b9f625afbd08d27dc412c313e71ed1d7a0e47b0e19d11be0da2b9a32bb04c18::tradeport_keys {
    struct TRADEPORT_KEYS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TRADEPORT_KEYS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TRADEPORT_KEYS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"TradePort Keys"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiglpzq6or6bnk2rcesq6wuufkekodrbo4efujykza4bys5nwk4d3e"));
