module 0x3be188dcf366ecb875ebeecbb1b55aa5c3969d4f2e37898b1d9021eb7cfb13de::haedal_adapter {
    ...
    public fun new<T0: drop>(arg0: &mut HaedalAdapterRegistry, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Haedal>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x3be188dcf366ecb875ebeecbb1b55aa5c3969d4f2e37898b1d9021eb7cfb13de::haedal_adapter_event::new_haedal_pass_event(*0x2::object::uid_as_inner(&v4.id), v3);
        0x2::transfer::share_object<HaedalPass>(v4);
    }

    entry fun add_whitelist<T0>(arg0: &mut HaedalAdapterRegistry, arg1: &HaedalAdapterAdminCap) {
    ...
    public fun fetch_total_value<T0: drop>(arg0: &mut HaedalPass, arg1: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Haedal, T0> {
    ...
    entry fun remove_whitelist<T0>(arg0: &mut HaedalAdapterRegistry, arg1: &HaedalAdapterAdminCap) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun stake_sui<T0: drop>(arg0: &mut HaedalPass, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<T0, Haedal, 0x2::sui::SUI>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg4: address, arg5: &mut 0x2::tx_context::TxContext) : 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::asset::Asset<Haedal, T0, 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI> {
        ...
        0x3be188dcf366ecb875ebeecbb1b55aa5c3969d4f2e37898b1d9021eb7cfb13de::haedal_adapter_event::stake_sui_event(0x2::object::id<HaedalPass>(arg0), v1, v1 / 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::get_exchange_rate(arg3) / 1000000);
