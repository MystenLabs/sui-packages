module 0x3bfc30f7f08b15f87ee3e2873aec0174143721cf544641857bfee9328fc8e8a0::LESTER {
    struct LESTER has drop {
        dummy_field: bool,
    }

    fun init(arg0: LESTER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<LESTER>(arg0, 2, b"LESTER", b"Litecoin Mascot", b"Litecoin Mascot", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/gbK3-sD63bs9Hh7XsOALqTpvMUpgTAb_ZUbmO3LkgMI?ext=png")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LESTER>>(v2);
        0x2::transfer::public_transfer<0x2::coin::DenyCap<LESTER>>(v1, @0x7c3c58155b85c3ecf4864777fce255a7e405ffa3b6e443e736976588910f0e8d);
        let v3 = v0;
