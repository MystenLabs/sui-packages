module 0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::ido {
    ...
    public entry fun claim<T0, T1>(arg0: &mut Campaign<T0>, arg1: &mut 0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::vault::Vault<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v3 > (arg0.hard_cap as u256)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::vault::claim<T1>(arg1, v1, v4, arg3), arg3), v0);
        } else {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::vault::claim<T1>(arg1, v1, v7, arg3), arg3), v0);
        };
    }
    ...
    public fun create<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: bool, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = Campaign<T0>{
    ...
    public fun migrate<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        arg1.version = 0;
    }
    ...
    fun pri_fund<T0>(arg0: &mut Campaign<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!arg0.change_to_public) {
            ...
            assert!(0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::merkle_proof::verify(&arg2, arg0.merkle_root, 0x1::hash::sha2_256(0x2::bcs::to_bytes<address>(&v0))), 1018);
        };
    ...
    public fun set_merkle_root<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.merkle_root = arg2;
    }

    public fun switch_end<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        arg1.is_end = !arg1.is_end;
    }

    public fun switch_enmergency<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        arg1.enmergency = !arg1.enmergency;
    }

    public fun switch_open<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        arg1.is_open = !arg1.is_open;
    }

    public fun take_fund<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun take_fund_with_amount<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update<T0>(arg0: &0x3b6d94b83614fd8fe35c7e07ac3a5fb52f2d7b9e3d25a4bb6a3ed3745db58179::admin::AdminCap, arg1: &mut Campaign<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: bool, arg9: address, arg10: &mut 0x2::tx_context::TxContext) {
        arg1.hard_cap = arg2;
        arg1.price = arg3;
