module 0x3b24f68b7042bf8ba5214395886ff24ca51b1b5636eac45e52631512bee16653::genescience {
    ...
    public fun evolve_genes(arg0: u256, arg1: vector<u256>) : u256 {
        let v0 = (0x3b24f68b7042bf8ba5214395886ff24ca51b1b5636eac45e52631512bee16653::math::min_u64((((slice_number(arg0, 3, 4) as u8) + 1) as u64), ((8 - 1) as u64)) as u8);
    ...
    public fun generate_genesis_genes_with_tier(arg0: vector<u8>, arg1: u64) : u256 {
        ...
        let v3 = 0;
        while (v3 < 28) {
            v1 = v1 | (0x3b24f68b7042bf8ba5214395886ff24ca51b1b5636eac45e52631512bee16653::math::min_u64(v2 + (*0x1::vector::borrow<u8>(&v0, v3 * 3 % 32) as u64) % (3 + arg1 - v2 + 1), 31) as u256) << 4 + 3 + (v3 as u8) * 5;
            v3 = v3 + 1;
        };
        let v4 = if (arg1 >= 1) {
            arg1 - 1
        ...
        v3 = 0;
        while (v3 < 21) {
            v1 = v1 | (0x3b24f68b7042bf8ba5214395886ff24ca51b1b5636eac45e52631512bee16653::math::min_u64(v4 + (*0x1::vector::borrow<u8>(&v0, (28 + v3) * 3 % 32) as u64) % (2 + arg1 - v4 + 1), 15) as u256) << 147 + (v3 as u8) * 4;
            v3 = v3 + 1;
        };
        v1
    }
