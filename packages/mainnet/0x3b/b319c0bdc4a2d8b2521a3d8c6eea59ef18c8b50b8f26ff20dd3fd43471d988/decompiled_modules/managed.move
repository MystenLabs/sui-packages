module 0x3bb319c0bdc4a2d8b2521a3d8c6eea59ef18c8b50b8f26ff20dd3fd43471d988::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"RTV", b"RedVolt", b"RedVolt is ready!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/33udkRS.webp")), arg1);
