module 0x3bb40aa94aab5f84a151526eac3cf199338bf9e98cc5955306c9ce13f62a3868::cnsnft7741 {
    struct CNSNFT7741 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7741, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8838"));
        let v4 = 0x2::package::claim<CNSNFT7741>(arg0, arg1);
