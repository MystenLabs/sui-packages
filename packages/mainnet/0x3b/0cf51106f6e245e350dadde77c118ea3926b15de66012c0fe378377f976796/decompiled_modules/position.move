module 0xaa3ae572fb09f157d7368ce22c6b7f33fde0fe74cba75ae9679af52088b57bb0::position {
    ...
    public fun info_fullsail_distribution_growth_inside(arg0: &PositionInfo) : u128 {
        arg0.fullsail_distribution_growth_inside
    }
    ...
    public(friend) fun mark_position_staked(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: u128, arg3: u128, arg4: u128, arg5: bool) {
        let v0 = borrow_mut_position_info(arg0, arg1);
        update_fee_internal(v0, arg2, arg3);
        update_fullsail_distribution_internal(v0, arg4);
        assert!(v0.fullsail_distribution_staked != arg5, 92372398045693466);
        v0.fullsail_distribution_staked = arg5;
    ...
    fun update_fee_internal(arg0: &mut PositionInfo, arg1: u128, arg2: u128) {
        let v0 = 0;
        let v1 = 0;
        if (!arg0.fullsail_distribution_staked) {
            v0 = (0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_shr(arg0.liquidity, 0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::math_u128::wrapping_sub(arg1, arg0.fee_growth_inside_a), 64) as u64);
            v1 = (0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_shr(arg0.liquidity, 0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::math_u128::wrapping_sub(arg2, arg0.fee_growth_inside_b), 64) as u64);
        };
    ...
    fun update_fullsail_distribution_internal(arg0: &mut PositionInfo, arg1: u128) {
        let v0 = 0;
        if (arg0.fullsail_distribution_staked) {
            v0 = (0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_shr(arg0.liquidity, 0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::math_u128::wrapping_sub(arg1, arg0.fullsail_distribution_growth_inside), 64) as u64);
        };
