module 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::rewards {
    ...
    struct RewardUpdateEvent has copy, drop {
        ...
        start_time: u64,
        end_time: u64,
        distributed_rewards: 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number,
        cummulative_rewards_per_share: 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number,
    }
    ...
    struct UserRewardUpdateEvent has copy, drop {
        ...
        reward_id: 0x2::object::ID,
        coin_type: 0x1::type_name::TypeName,
        earned_rewards: 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number,
        cummulative_rewards_per_share: 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::Number,
        is_auto_compounded: bool,
        auto_compound_market_id: u64,
    }
    ...
    public(friend) fun add_reward<T0>(arg0: &mut RewardDistributor, arg1: 0x2::balance::Balance<T0>, arg2: 0x1::type_name::TypeName, arg3: bool, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 < 0x1::vector::length<0x1::option::Option<Reward>>(&arg0.rewards)) {
            ...
            let v1 = Reward{
                ...
                start_time                    : arg5,
                end_time                      : arg6,
                distributed_rewards           : 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0),
                cummulative_rewards_per_share : 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0),
            };
            assert!(arg6 > arg5, 4);
            ...
            if (0x1::option::is_some<UserReward>(v6)) {
                ...
                if (v7.coin_type == v1) {
                    if (v7.is_auto_compounded) {
                        v5 = 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::to_u64(v7.earned_rewards);
                        v3 = find_reward(arg1, v1, true);
                    } else {
                        v4 = 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::to_u64(v7.earned_rewards);
                        v2 = find_reward(arg1, v1, false);
                    };
                    v7.earned_rewards = 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0);
                };
            };
            v0 = v0 + 1;
        };
    ...
    public(friend) fun emit_reward_distributor_refresh_event(arg0: u64, arg1: &RewardDistributor) {
        ...
        0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::events::emit_event<RewardDistributorRefreshEvent>(v0);
    }
    ...
    public(friend) fun emit_reward_update_event(arg0: &Reward, arg1: u64) {
        ...
        0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::events::emit_event<RewardUpdateEvent>(v0);
    }
    ...
    public(friend) fun emit_user_reward_distributor_refresh_event(arg0: &UserRewardDistributor, arg1: u64, arg2: 0x2::object::ID) {
        ...
        0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::events::emit_event<UserRewardDistributorRefreshEvent>(v0);
    }
    ...
    public(friend) fun emit_user_reward_update_event(arg0: u64, arg1: 0x2::object::ID, arg2: &UserReward) {
        ...
        0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::events::emit_event<UserRewardUpdateEvent>(v0);
    }
    ...
    public(friend) fun get_claimable_rewards(arg0: &UserRewardDistributor, arg1: &RewardDistributor, arg2: &0x2::clock::Clock) : vector<ClaimableReward> {
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<UserReward>>(&arg0.rewards)) {
            ...
            if (0x1::option::is_some<UserReward>(v2)) {
                ...
                if (0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::to_u64(v3.earned_rewards) > 0) {
    ...
    public(friend) fun get_earned_rewards(arg0: &UserReward) : u64 {
        0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::to_u64(arg0.earned_rewards)
    }
        ...
        while (v0 < 0x1::vector::length<0x1::option::Option<Reward>>(&arg0.rewards)) {
            ...
            if (0x1::option::is_some<Reward>(v1)) {
                ...
                if (v2.end_time < arg0.last_updated) {
                    ...
                    let v4 = if (0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::gt(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(v2.total_rewards), v2.distributed_rewards)) {
                        0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::div(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::mul(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::sub(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(v2.total_rewards), v2.distributed_rewards), 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0x1::u64::min(0x2::clock::timestamp_ms(arg1), v2.end_time) - v3)), 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(v2.end_time - v3))
                    } else {
                        0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0)
                    };
                    v2.distributed_rewards = 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::add(v2.distributed_rewards, v4);
                    v2.cummulative_rewards_per_share = 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::add(v2.cummulative_rewards_per_share, 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::div(v4, 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(arg0.total_xtokens)));
        ...
        while (v0 < 0x1::vector::length<0x1::option::Option<Reward>>(&arg1.rewards)) {
            ...
            if (0x1::vector::length<0x1::option::Option<UserReward>>(&arg0.rewards) <= v0) {
                ...
                let v4 = if (arg0.last_updated <= v2.start_time) {
                    0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::mul(v2.cummulative_rewards_per_share, 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(arg0.share))
                } else {
                    0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(0)
                };
                let v5 = UserReward{
                ...
                v6.earned_rewards = 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::add(v6.earned_rewards, 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::mul(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::sub(v2.cummulative_rewards_per_share, v6.cummulative_rewards_per_share), 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(arg0.share)));
