module 0x3b6f0ff0b203f6d6d78f9505ef64f03d4684ef52802ec92841a07a80c4ebc0ae::cnsnft6834 {
    struct CNSNFT6834 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6834, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6834>(arg0, arg1);
