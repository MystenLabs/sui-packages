module 0x3b7fa18c1a2a1a0f6487ef762a0edef3bbcfbc02f97de06eff08f8160e4ec154::cnsnft3771 {
    struct CNSNFT3771 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3771, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3771>(arg0, arg1);
