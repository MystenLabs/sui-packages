module 0x3b516a263f39932cf40f6a8fd5eb51eebf90e7df90821a2ce70995f869943de7::V35 {
    ...
    public fun blue_fin_swap_a_to_b<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: u128, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_wl(arg5);
        let v0 = 0x2::coin::value<T0>(&arg3);
        let (v1, v2) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg0, arg1, arg4, 0x2::coin::into_balance<T0>(arg3), 0x2::balance::zero<T1>(), true, true, v0, 0, arg2);
        let v3 = 0x2::coin::from_balance<T1>(v2, arg5);
        0x2::pay::keep<T0>(0x2::coin::from_balance<T0>(v1, arg5), arg5);
        let v4 = MEVStepEvent{
            coin_in      : v0,
            coin_out     : 0x2::coin::value<T1>(&v3),
            coin_in_left : 0,
        };
        0x2::event::emit<MEVStepEvent>(v4);
        v3
    }

    public fun blue_fin_swap_b_to_a<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: u128, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_wl(arg5);
        let v0 = 0x2::coin::value<T1>(&arg3);
        let (v1, v2) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg0, arg1, arg4, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(arg3), false, true, v0, 0, arg2);
        let v3 = 0x2::coin::from_balance<T0>(v1, arg5);
        0x2::pay::keep<T1>(0x2::coin::from_balance<T1>(v2, arg5), arg5);
        let v4 = MEVStepEvent{
            coin_in      : v0,
            coin_out     : 0x2::coin::value<T0>(&v3),
            coin_in_left : 0,
        };
        0x2::event::emit<MEVStepEvent>(v4);
        v3
