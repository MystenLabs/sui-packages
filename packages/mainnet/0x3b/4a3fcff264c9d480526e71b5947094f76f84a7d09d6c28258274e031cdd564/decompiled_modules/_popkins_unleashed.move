module 0x3b4a3fcff264c9d480526e71b5947094f76f84a7d09d6c28258274e031cdd564::_popkins_unleashed {
    struct _POPKINS_UNLEASHED has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _POPKINS_UNLEASHED, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_POPKINS_UNLEASHED>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" Popkins Unleashed"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Claynosaurz Expands From Solana to Sui With New NFTs, Upcoming Game"));
