module 0xe39b9ba59dd4c523df7a3a8d0eacf0e18576a88b38138b58ccbf1f0daa8aa64d::game {
    ...
    entry fun admin_init_rep_system<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = RepConfigKey{dummy_field: false};
        ...
        let v2 = RepConfig{
            ...
            base_fee_bps                 : arg6,
            streak_reduction_per_day_bps : arg7,
            max_streak_reduction_bps     : arg8,
            streak_lock_days             : arg9,
        };
        0x2::dynamic_field::add<RepConfigKey, RepConfig>(&mut arg0.id, v1, v2);
        let v3 = RepTableKey{dummy_field: false};
        0x2::dynamic_field::add<RepTableKey, 0x2::table::Table<address, RepProfile>>(&mut arg0.id, v3, 0x2::table::new<address, RepProfile>(arg10));
        ...
        if (!0x2::dynamic_field::exists_<FeeTableKey>(&arg0.id, v4)) {
            ...
            0x2::dynamic_field::add<FeeTableKey, 0x2::table::Table<address, u64>>(&mut arg0.id, v5, 0x2::table::new<address, u64>(arg10));
            let v6 = DefaultFeeKey{dummy_field: false};
            0x2::dynamic_field::add<DefaultFeeKey, u64>(&mut arg0.id, v6, arg6);
        };
    }
