module 0x3bbc7ffbd248dcbea1bfa55c5c67e793578411546f7c4ef8850670c9fae2a307::queen_maker {
    ...
    struct QueenCustody has store {
        family_type: u64,
        mystical_bee: 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::MysticalBee,
        sui_bidded: u64,
        auction_epoch: u64,
    }
    ...
    public fun add_to_bid(arg0: &0x2::clock::Clock, arg1: &mut QueenMaker, arg2: &mut 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::DragonTrainer, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 0, 9893);
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = arg1.current_auction.auction_start_epoch;
        let (v2, v3, _) = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::get_trainer_meta_info(arg2);
    ...
    public fun compete_to_be_a_queen(arg0: &0x2::clock::Clock, arg1: &mut QueenMaker, arg2: &mut 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::BeesManager, arg3: &mut 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::DragonTrainer, arg4: u64, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 0, 9893);
        let v0 = arg1.current_auction.auction_start_epoch;
        let (v1, v2, _) = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::get_trainer_meta_info(arg3);
        ...
        let v5 = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::get_bee_for_queen_competition(&arg1.hive_kraft_cap, arg2, 0x2::object::uid_to_address(&arg1.id), arg3, arg4);
        let v6 = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::get_bee_family(&v5);
    ...
    fun create_user_position(arg0: u64, arg1: address, arg2: 0x1::string::String, arg3: 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::MysticalBee, arg4: u64, arg5: u64, arg6: u64, arg7: u64) : ParticipationPosition {
    ...
    fun destroy_user_position(arg0: ParticipationPosition) : (0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::MysticalBee, u64, u64, 0x1::string::String, address, u64, u64) {
    ...
    public fun increment_queen_maker(arg0: &0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::yield_flow::TwoAmmFlowAccess, arg1: &mut 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::BeesManager, arg2: &mut QueenMaker, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, 0x2::balance::Balance<0x2::sui::SUI>) {
        ...
        while (0x1::option::is_some<u64>(&v3)) {
            ...
            let v18 = v11;
            0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::make_bee_queen(&arg2.hive_kraft_cap, arg1, &mut v18, arg2.config.max_eggs_per_queen, v12, arg3);
            let v19 = v2 + v16;
            v2 = v19 - v17;
    ...
    public fun withdraw_bee_after_competition(arg0: &mut QueenMaker, arg1: &mut 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::BeesManager, arg2: &mut 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::DragonTrainer, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 9893);
        let (v0, _, _) = 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::get_trainer_meta_info(arg2);
        if (0x2::linked_table::contains<address, QueenCustody>(&arg0.queen_custody, v0)) {
            ...
            let v8 = QueenClaimedByItsOwner{
                trainer_addr  : v0,
                version       : 0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::get_bee_version(&v7),
                sui_bidded    : v5,
                auction_epoch : v6,
            };
            ...
            0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::return_bee_from_competition(&arg0.hive_kraft_cap, arg1, arg2, v7, v10, v11);
            return
        };
        ...
        0x283004ccb8d55ec1a7203686a5cfcc8d8db5d0b0759f11fca9f6c7afb425f4c6::dragon_trainer::return_bee_from_competition(&arg0.hive_kraft_cap, arg1, arg2, v12, v20, v21);
