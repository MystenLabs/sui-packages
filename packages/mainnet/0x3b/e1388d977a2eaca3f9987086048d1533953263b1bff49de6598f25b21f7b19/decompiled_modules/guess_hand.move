module 0x3be1388d977a2eaca3f9987086048d1533953263b1bff49de6598f25b21f7b19::guess_hand {
    ...
    fun init(arg0: GUESS_HAND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<GUESS_HAND>(arg0, 9, b"windynanzi", b"Windy", b"game coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://cdn.icon-icons.com/icons2/1865/PNG/96/dogbaby_119594.png"))), arg1);
        let v3 = v1;
