module 0x3b650e712e06ca4dbebeaf5f272152e60c50615d396113946a8d09863f28e93d::yes_market {
    ...
    public fun mint(arg0: &mut Market, arg1: 0x2::coin::Coin<0xca5d6a58c939e929e49525e973eab52c4de99e8f24b3a47d0df7fe14ea111b71::pinata_usdc::PINATA_USDC>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<YES_MARKET> {
        ...
        0x2::coin::mint<YES_MARKET>(&mut arg0.treasury_cap, v0, arg2)
    }
    ...
    entry fun mint_and_keep(arg0: &mut Market, arg1: 0x2::coin::Coin<0xca5d6a58c939e929e49525e973eab52c4de99e8f24b3a47d0df7fe14ea111b71::pinata_usdc::PINATA_USDC>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = mint(arg0, arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<YES_MARKET>>(v0, 0x2::tx_context::sender(arg2));
    }
