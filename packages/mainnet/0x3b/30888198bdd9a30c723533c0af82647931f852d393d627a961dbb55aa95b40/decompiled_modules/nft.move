module 0x3b30888198bdd9a30c723533c0af82647931f852d393d627a961dbb55aa95b40::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public fun burn(arg0: BirdNFT) {
        let (_, _, _, _, _, _) = burnInt(arg0);
    }

    fun burnInt(arg0: BirdNFT) : (0x2::object::ID, u128, u16, u16, u16, u64) {
        let BirdNFT {
            id       : v0,
            xid      : v1,
            type     : v2,
    ...
    public fun depositNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &mut 0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::archieve::UserArchieve, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::archieve::verUpdateNftPegNonce(v2, arg3);
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::cap_vault::createVault<NftAdminCap>(arg1);
    }
    ...
    public fun setValidator(arg0: &NftAdminCap, arg1: vector<u8>, arg2: &mut NftPegVault, arg3: &0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::version::Version) {
    ...
    public fun withdrawFee(arg0: &NftAdminCap, arg1: &mut NftPegVault, arg2: &0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::version::Version, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    public fun withdrawNft(arg0: &mut 0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::archieve::UserArchieve, arg1: BirdNFT, arg2: &0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::version::checkVersion(arg2, 1);
        let (v0, v1, v2, v3, v4, v5) = burnInt(arg1);
        let v6 = NFTWithdrawn{
            id       : v0,
            ...
            rare     : v4,
            value    : v5,
            nonce    : 0xaebc18d31d451b6d2c35a335dabfe0fc81814fa2dd741a1254d30b3f693eea6d::archieve::increaseGetNftDepegNonce(arg0),
        };
