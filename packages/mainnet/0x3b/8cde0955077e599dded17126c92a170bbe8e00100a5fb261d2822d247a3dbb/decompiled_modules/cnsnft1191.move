module 0x3b8cde0955077e599dded17126c92a170bbe8e00100a5fb261d2822d247a3dbb::cnsnft1191 {
    struct CNSNFT1191 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1191, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1191>(arg0, arg1);
