module 0x3b3a97607c265f59f56a8af5b61c7b9438a77c11cc9b6bfc8973e6f70362ab82::reward9604 {
    struct REWARD9604 has drop {
        dummy_field: bool,
    }

    struct TICKET_9604 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9604(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9604>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9604>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9604, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9604>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9604>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9604>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9604>>(v5, 0x2::tx_context::sender(arg1));
    }
