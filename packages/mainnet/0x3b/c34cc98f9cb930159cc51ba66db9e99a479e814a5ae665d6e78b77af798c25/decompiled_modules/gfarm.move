module 0x3bc34cc98f9cb930159cc51ba66db9e99a479e814a5ae665d6e78b77af798c25::gfarm {
    ...
    public fun new<T0>(arg0: &AdminCap, arg1: 0x2::coin::TreasuryCap<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : Farm<T0> {
        let v0 = Fee{
            deposit_fee_bps  : 0,
            withdraw_fee_bps : 0,
        };
