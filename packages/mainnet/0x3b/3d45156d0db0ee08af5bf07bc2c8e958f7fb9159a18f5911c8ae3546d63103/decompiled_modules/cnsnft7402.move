module 0x3b3d45156d0db0ee08af5bf07bc2c8e958f7fb9159a18f5911c8ae3546d63103::cnsnft7402 {
    struct CNSNFT7402 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7402, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7402>(arg0, arg1);
