module 0x3bc860f1e0946b6d3003b0963650b2bbef2ec63d034a550bf4c91691b4d3a5ee::cnsnft9013 {
    struct CNSNFT9013 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9013, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9013>(arg0, arg1);
