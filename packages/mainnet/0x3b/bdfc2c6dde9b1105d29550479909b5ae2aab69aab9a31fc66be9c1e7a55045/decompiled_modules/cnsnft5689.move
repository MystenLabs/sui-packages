module 0x3bbdfc2c6dde9b1105d29550479909b5ae2aab69aab9a31fc66be9c1e7a55045::cnsnft5689 {
    struct CNSNFT5689 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5689, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5689>(arg0, arg1);
