module 0x3b9be2d7cd9d15b995faae2b2b0e9525fe5d28543c19cd7b88f27662b83982af::ducky {
    ...
    fun init(arg0: DUCKY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DUCKY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DUCKY   ")))), trim_right(b"Ducky                           "), trim_right(b"Ducky Sui                                                                                                                                                                                                                                                                                                                       "), v2, arg1);
