module 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::trading {
    ...
    public fun extract_ask_commission<T0>(arg0: AskCommission, arg1: &mut 0x2::balance::Balance<T0>) : (0x2::balance::Balance<T0>, address) {
        let AskCommission {
            cut         : v0,
            beneficiary : v1,
        } = arg0;
        (0x2::balance::split<T0>(arg1, v0), v1)
    }
