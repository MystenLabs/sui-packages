module 0x3b242e350aae8e071ed27a56798f7ae41973bff751b83fa69368e55407f9035d::Sui_Reward_W0 {
    struct SUI_REWARD_W0 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun GiveReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUI_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmcVYDUFPMpP23ZdiUxAjMvh84hT4EdfZDxeZ4anv8jk4N"),
            };
    ...
    fun init(arg0: SUI_REWARD_W0, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmcVYDUFPMpP23ZdiUxAjMvh84hT4EdfZDxeZ4anv8jk4N"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui"));
        let v4 = 0x2::package::claim<SUI_REWARD_W0>(arg0, arg1);
