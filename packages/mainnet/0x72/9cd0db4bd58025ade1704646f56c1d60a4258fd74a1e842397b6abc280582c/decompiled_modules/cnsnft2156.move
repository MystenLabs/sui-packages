module 0x729cd0db4bd58025ade1704646f56c1d60a4258fd74a1e842397b6abc280582c::cnsnft2156 {
    struct CNSNFT2156 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2156, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4654"));
        let v4 = 0x2::package::claim<CNSNFT2156>(arg0, arg1);
