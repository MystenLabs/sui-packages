module 0x7df55a5cb5d91bc52b20b8b12daadc7bdc64091767bc2325b5da9afadea13069::alphafi_bluefin_sui_first_investor {
    ...
    struct AutoCompoundingEventV2 has copy, drop {
        investor_id: 0x2::object::ID,
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg7: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: u128, arg10: bool, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T0>()) == true) {
            let v11 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.free_rewards, 0x1::type_name::get<T0>());
            v10 = (0x2::balance::value<T0>(v11) as u128) * (arg0.performance_fee as u128) / 10000;
            0x2::balance::join<T0>(&mut arg0.free_balance_a, 0x2::balance::withdraw_all<T0>(v11));
        };
        ...
        let v16 = v15;
        let v17 = v14;
        let v18 = v10 + (0x2::balance::value<T0>(&v17) as u128) * (arg0.performance_fee as u128) / 10000;
        let v19 = (0x2::balance::value<T1>(&v16) as u128) * (arg0.performance_fee as u128) / 10000;
        ...
        let (v20, v21) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v17, v16, arg4, arg6, v0, v1, arg10, arg11, arg12);
        ...
        let v30 = AutoCompoundingEventV2{
        ...
        0x2::event::emit<AutoCompoundingEventV2>(v30);
        (v27, v26, v25)
    }
    ...
    public(friend) fun rebalance_v3<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: u32, arg5: u32, arg6: u32, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg9: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg10: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg11: &mut 0x3::sui_system::SuiSystemState, arg12: u128, arg13: bool, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg2, arg7, arg4, arg5, arg15);
        ...
        let (v8, v9) = get_sqrt_price_limits<T0, T1>(arg7, arg8, arg13);
        let v10 = v2 / (arg6 as u128);
        let v11 = v2 % (arg6 as u128);
        let v12 = 0;
        while (v12 < arg6 + 1) {
            if (v12 == arg6) {
                if (v11 == 0) {
            ...
            let (_, _, v15, v16) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg2, arg7, &mut v0, v10, arg14);
            let v17 = v16;
            let v18 = v15;
            ...
            let (v19, v20) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg2, arg3, v18, v17, arg7, arg8, v8, v9, arg13, arg14, arg15);
            let (_, v22, v23, v24) = get_balances_in_ratio<T0, T1>(arg0, v19, v20, arg7, true, arg15);
            let v25 = v23;
            let v26 = v22;
            if (0x2::balance::value<T0>(&v26) > 100 || 0x2::balance::value<T1>(&v25) > 100) {
                let (v27, v28) = if (0x2::balance::value<T0>(&v26) == 0 || v24 == false) {
                    let (v29, v30, v31, v32) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg14, arg2, arg7, &mut v1, v26, v25, 0x2::balance::value<T1>(&v25), false);
                    let _ = v30;
                    let _ = v29;
                    (v31, v32)
                } else {
                    let (v35, v36, v37, v38) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg14, arg2, arg7, &mut v1, v26, v25, 0x2::balance::value<T0>(&v26), true);
                    let _ = v36;
                    let _ = v35;
                    (v37, v38)
                };
        ...
        let (v39, v40, v41) = autocompound_internal<T0, T1, T2, T3>(arg0, arg1, arg2, arg3, arg7, arg9, arg8, arg10, arg11, arg12, arg13, arg14, arg15);
        let v42 = v40;
        let v43 = v39;
        close_position<T0, T1>(arg7, 0x2::dynamic_field::remove<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"), arg2, arg14);
        ...
        if (0x2::balance::value<T0>(&v43) > 100 || 0x2::balance::value<T1>(&v42) > 100) {
            deposit<T0, T1>(arg0, arg2, arg7, v43, v42, v41, arg14);
        } else {
