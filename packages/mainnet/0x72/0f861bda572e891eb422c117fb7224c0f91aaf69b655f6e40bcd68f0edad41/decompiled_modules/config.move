module 0xc4ebf35be1478318d78c324342854dd2735a036139373a9d41a1aa3a46a01d05::config {
    ...
    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(11 >= arg0.package_version, 0xc4ebf35be1478318d78c324342854dd2735a036139373a9d41a1aa3a46a01d05::error::package_version_deprecate());
    }
    ...
    public fun emergency_unpause(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: u64) {
    ...
    public fun set_swap_slippage<T0>(arg0: &mut GlobalConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 <= 500, 0xc4ebf35be1478318d78c324342854dd2735a036139373a9d41a1aa3a46a01d05::error::invalid_swap_slippage());
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = 0;
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.swap_slippages, &v0)) {
    ...
    public entry fun update_package_version(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: u64) {
        ...
        assert!(arg2 > v0, 0xc4ebf35be1478318d78c324342854dd2735a036139373a9d41a1aa3a46a01d05::error::wrong_package_version());
        arg0.package_version = arg2;
