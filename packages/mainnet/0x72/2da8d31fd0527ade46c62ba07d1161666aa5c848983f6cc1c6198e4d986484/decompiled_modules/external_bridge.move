module 0x722da8d31fd0527ade46c62ba07d1161666aa5c848983f6cc1c6198e4d986484::external_bridge {
    ...
    public entry fun i_deposit_usdc<T0: drop>(arg0: &mut ExternalBridge, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: u8, arg4: u128, arg5: vector<u8>, arg6: address, arg7: vector<u8>, arg8: &0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::state::State, arg9: &mut 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::state::State, arg10: &0x2::deny_list::DenyList, arg11: &mut 0xecf47609d7da919ea98e7fd04f6e0648a0a79b337aaad373fa37aac8febf19c8::treasury::Treasury<T0>, arg12: &mut 0x2::tx_context::TxContext) : (0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::burn_message::BurnMessage, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::Message) {
        ...
        let v3 = Auth{dummy_field: false};
        let (v4, v5) = 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::deposit_for_burn::deposit_for_burn_with_package_auth<T0, Auth>(0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::deposit_for_burn::create_deposit_for_burn_ticket<T0, Auth>(v3, arg2, v0.domain_id, arg6), arg8, arg9, arg10, arg11, arg12);
        let v6 = v5;
        let v7 = IUSDCDeposited{
            tx_type             : arg3,
            partner_id          : arg4,
            amount              : 0x2::coin::value<T0>(&arg2),
            dest_chain_id_bytes : arg5,
            usdc_nonce          : 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::nonce(&v6),
            token               : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())),
            recipient           : arg6,
            depositor           : 0x2::tx_context::sender(arg12),
            data                : arg7,
        };
        0x2::event::emit<IUSDCDeposited>(v7);
        (v4, v6)
    }
