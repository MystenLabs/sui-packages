module 0x72cd0e26d47a9a98c3a3196bdd7370ca4cb32f30ce76d913ebd42a46b4cd5dfd::cnsnft6785 {
    struct CNSNFT6785 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6785, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6785>(arg0, arg1);
