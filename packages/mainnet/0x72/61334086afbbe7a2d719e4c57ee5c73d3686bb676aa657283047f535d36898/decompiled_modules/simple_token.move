module 0x7261334086afbbe7a2d719e4c57ee5c73d3686bb676aa657283047f535d36898::simple_token {
    ...
    fun init(arg0: SIMPLE_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SIMPLE_TOKEN>(&mut v2, 1000000000000, @0x46c2993db5cdf34e0defdde2440b226f9a9173394919fede8a43d4bab040a228, arg1);
