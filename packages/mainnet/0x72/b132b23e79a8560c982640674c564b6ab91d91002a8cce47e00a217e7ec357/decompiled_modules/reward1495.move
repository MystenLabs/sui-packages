module 0x72b132b23e79a8560c982640674c564b6ab91d91002a8cce47e00a217e7ec357::reward1495 {
    struct REWARD1495 has drop {
        dummy_field: bool,
    }

    struct TICKET_1495 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1495(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1495>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1495>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1495, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1495>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1495>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1495>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1495>>(v5, 0x2::tx_context::sender(arg1));
    }
