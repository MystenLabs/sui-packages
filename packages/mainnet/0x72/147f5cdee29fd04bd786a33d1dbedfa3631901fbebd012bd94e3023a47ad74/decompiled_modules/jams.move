module 0x72147f5cdee29fd04bd786a33d1dbedfa3631901fbebd012bd94e3023a47ad74::jams {
    ...
    fun init(arg0: JAMS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<JAMS>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<JAMS>>(v4);
    }
