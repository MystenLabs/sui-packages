module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools {
    ...
    public fun get_processing_resource_mul_v2(arg0: &TOOL) : u64 {
        let v0 = if (arg0.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_sledgehammer()) {
            true
        } else if (arg0.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_mould_deckle()) {
            true
        } else {
            arg0.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_lapidary_kit()
        };
        assert!(v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_item_invalid_tool());
        let v1 = get_attributes(arg0);
        let v2 = 0x1::string::utf8(b"Tier");
