module 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::rewarder {
    ...
    public(friend) fun add_vault<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(is_vault_registered(arg0, arg1), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::vault_not_registered());
        let v0 = 0x1::type_name::get<T0>();
        assert!(!is_vault_in_rewarder(arg0, v0, arg1), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::vault_already_registered());
        assert!(arg2 > 0, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::invalid_amount());
    ...
    public fun create_rewarder<T0>(arg0: &0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::VaultsManager, arg1: &mut RewarderManager, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::checked_package_version(arg0);
        0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::check_rewarder_manager_role(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0x1::type_name::get<T0>();
        assert!(!0x2::linked_table::contains<0x1::type_name::TypeName, Rewarder>(&arg1.rewarders, v0), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::invalid_reward_type());
        assert!(arg2 > 0, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::invalid_amount());
        let v1 = Rewarder{
            reward_coin            : v0,
    ...
    public fun deposit_reward<T0>(arg0: &0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::VaultsManager, arg1: &mut RewarderManager, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::checked_package_version(arg0);
        assert!(0x2::coin::value<T0>(&arg2) > 0, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::invalid_amount());
        let v0 = 0x1::type_name::get<T0>();
    ...
    public(friend) fun register_vault(arg0: &mut RewarderManager, arg1: 0x2::object::ID) {
        assert!(!is_vault_registered(arg0, arg1), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::vault_already_registered());
    ...
    public fun update_rewarder_emission<T0>(arg0: &0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::VaultsManager, arg1: &mut RewarderManager, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::checked_package_version(arg0);
        0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::vaults_manager::check_rewarder_manager_role(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::linked_table::contains<0x1::type_name::TypeName, Rewarder>(&arg1.rewarders, v0), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::invalid_reward_type());
    ...
    public(friend) fun vault_rewards_settle(arg0: &mut RewarderManager, arg1: vector<0x1::type_name::TypeName>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u128> {
        assert!(is_vault_registered(arg0, arg2), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::vault_not_registered());
    ...
    public(friend) fun withdraw_reward<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::get<T0>();
        assert!(is_vault_registered(arg0, arg1), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::vault_not_registered());
        assert!(is_vault_in_rewarder(arg0, v0, arg1), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::vault_not_in_rewarder());
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.vault, v0), 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::invalid_reward_type());
        assert!(arg2 > 0, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::invalid_amount());
        let v1 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.vault, v0);
        assert!(0x2::balance::value<T0>(v1) >= arg2, 0xaf0babdb56090a40343ce4eb0f007c756969226887ad2536068889ad8ffcee96::error::reward_not_enough());
        let v2 = 0x2::linked_table::borrow_mut<0x1::type_name::TypeName, Rewarder>(&mut arg0.rewarders, v0);
