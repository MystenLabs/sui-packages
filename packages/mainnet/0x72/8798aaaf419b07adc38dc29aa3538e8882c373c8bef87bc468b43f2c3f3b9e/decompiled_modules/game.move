module 0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>,
        gas_fee: u16,
        owner: address,
        ref1: u16,
        ref2: u16,
    ...
    entry fun add_treasury_cap(arg0: &mut GameInfo, arg1: 0x2::coin::TreasuryCap<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 4);
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>>(&mut arg0.id, 0x1::string::utf8(b"treasury"), arg1);
    }
    ...
    fun calc_claim(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3) {
            let v5 = v4 * (100 - (arg0.gas_fee as u64));
            v4 = v5 / 100;
        };
        send_tokens(arg0, arg1, v4, arg4);
        let v6 = arg0.owner;
        send_tokens(arg0, v6, arg2 * 1 / 100, arg4);
        if (v0 != @0x0 && v0 != arg1 && 0x2::dynamic_object_field::exists_<address>(&arg0.id, v0)) {
            let v7 = v4 * (arg0.ref1 as u64) / 100;
            v1 = v7;
            ...
            if (v8 != @0x0 && v8 != arg1 && 0x2::dynamic_object_field::exists_<address>(&arg0.id, v8)) {
                let v9 = v4 * (arg0.ref2 as u64) / 100;
                v3 = v9;
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version      : 1,
            balance      : 0x2::balance::zero<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>(),
            gas_fee      : 1,
            owner        : v0,
            ref1         : 5,
            ref2         : 1,
    ...
    entry fun remove_treasury_cap(arg0: &mut GameInfo, arg1: &0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg1));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>>(0x2::coin::from_balance<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>(0x2::balance::split<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>>(0x2::coin::from_balance<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>(0x2::balance::withdraw_all<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>>(0x2::coin::mint<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0x728798aaaf419b07adc38dc29aa3538e8882c373c8bef87bc468b43f2c3f3b9e::tonminer::TONMINER>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
