module 0x728820090378ff29976a8df857c9187713416f01f74cf66ff626db25f727a4c2::version {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : Version {
        Version{
            ...
            major_version : 0x728820090378ff29976a8df857c9187713416f01f74cf66ff626db25f727a4c2::current_version::current_major_version(),
            minor_version : 0x728820090378ff29976a8df857c9187713416f01f74cf66ff626db25f727a4c2::current_version::current_minor_version(),
        }
    }
    ...
    public fun is_supported_major_version(arg0: &Version) : bool {
        arg0.major_version == 0x728820090378ff29976a8df857c9187713416f01f74cf66ff626db25f727a4c2::current_version::current_major_version()
    }

    public fun is_supported_minor_version(arg0: &Version) : bool {
        0x728820090378ff29976a8df857c9187713416f01f74cf66ff626db25f727a4c2::current_version::current_minor_version() >= arg0.minor_version
    }
    ...
    public fun upgrade_major(arg0: &mut Version, arg1: &VersionCap) {
        arg0.major_version = 0x728820090378ff29976a8df857c9187713416f01f74cf66ff626db25f727a4c2::current_version::current_major_version() + 1;
    }
