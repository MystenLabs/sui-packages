module 0x88df7a1ddfa9524721fc850ad33dd47ab7921b7931a30b32ee2482545e394eed::cetus_adapter {
    ...
    public fun fetch_total_value<T0: drop>(arg0: &mut CetusVault, arg1: &CetusAdapterRegistry, arg2: ConsumePositionRecord, arg3: &mut 0x2::tx_context::TxContext) : 0xd0a66f97193dde2b87a4c3e817bba626114067f27e1323086fb1f41b1117451d::message::Message<Cetus, T0> {
        let v0 = 0x2::vec_map::keys<u64, 0x2::object::ID>(&arg2.records);
        assert!(0x1::vector::length<u64>(&v0) == 0, 11111);
        if (arg0.is_redeeming) {
            err_redeeming();
        };
        let v1 = 0x1::type_name::get<T0>();
        if (!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg1.whitelist, &v1)) {
            err_not_whitelisted_source();
        };
        let (v2, v3, v4) = burn_position_record(arg2);
        update_liquidity_record_value(arg0);
        arg0.is_fetching = false;
        new_total_value_message<T0>(arg0, v2, v3, v4, arg3)
    }
