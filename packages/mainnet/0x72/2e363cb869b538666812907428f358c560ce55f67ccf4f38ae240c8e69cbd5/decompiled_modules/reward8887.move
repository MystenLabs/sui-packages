module 0x722e363cb869b538666812907428f358c560ce55f67ccf4f38ae240c8e69cbd5::reward8887 {
    struct REWARD8887 has drop {
        dummy_field: bool,
    }

    struct TICKET_8887 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8887(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8887>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8887>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8887, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8887>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8887>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8887>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8887>>(v5, 0x2::tx_context::sender(arg1));
    }
