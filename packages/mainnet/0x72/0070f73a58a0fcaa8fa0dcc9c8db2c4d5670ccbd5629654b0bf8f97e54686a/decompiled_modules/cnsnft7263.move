module 0x720070f73a58a0fcaa8fa0dcc9c8db2c4d5670ccbd5629654b0bf8f97e54686a::cnsnft7263 {
    struct CNSNFT7263 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7263, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7263>(arg0, arg1);
