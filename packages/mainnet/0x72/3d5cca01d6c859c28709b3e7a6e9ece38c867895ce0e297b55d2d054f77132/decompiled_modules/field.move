module 0x723d5cca01d6c859c28709b3e7a6e9ece38c867895ce0e297b55d2d054f77132::field {
    ...
    fun check_harvestable<T0>(arg0: &mut Field, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) - v1.planted >= 0x723d5cca01d6c859c28709b3e7a6e9ece38c867895ce0e297b55d2d054f77132::fruit::get_harvest_time<T0>(0x2::dynamic_field::borrow_mut<0x2::object::ID, 0x723d5cca01d6c859c28709b3e7a6e9ece38c867895ce0e297b55d2d054f77132::fruit::Fruit<T0>>(&mut arg0.id, v1.name)), 3);
    }
    ...
    public fun harvest_fruit<T0>(arg0: &mut Field, arg1: u64, arg2: &0x2::clock::Clock) : 0x723d5cca01d6c859c28709b3e7a6e9ece38c867895ce0e297b55d2d054f77132::fruit::Fruit<T0> {
        assert!(arg1 < 9, 0);
        ...
        *v0 = 0x1::option::none<Slot>();
        0x2::dynamic_field::remove<0x2::object::ID, 0x723d5cca01d6c859c28709b3e7a6e9ece38c867895ce0e297b55d2d054f77132::fruit::Fruit<T0>>(&mut arg0.id, v1.name)
    }

    public fun plant_fruit<T0>(arg0: &mut Field, arg1: u64, arg2: 0x723d5cca01d6c859c28709b3e7a6e9ece38c867895ce0e297b55d2d054f77132::fruit::Fruit<T0>, arg3: &mut 0x2::tx_context::TxContext, arg4: &0x2::clock::Clock) {
        assert!(arg1 < 9, 0);
        let v0 = 0x1::vector::borrow_mut<0x1::option::Option<Slot>>(&mut arg0.plots, arg1);
        ...
        0x2::dynamic_field::add<0x2::object::ID, 0x723d5cca01d6c859c28709b3e7a6e9ece38c867895ce0e297b55d2d054f77132::fruit::Fruit<T0>>(&mut arg0.id, v2.name, arg2);
