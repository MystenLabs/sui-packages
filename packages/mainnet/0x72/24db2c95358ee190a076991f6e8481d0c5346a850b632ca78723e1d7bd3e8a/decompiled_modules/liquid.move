module 0x7224db2c95358ee190a076991f6e8481d0c5346a850b632ca78723e1d7bd3e8a::liquid {
    ...
    fun init(arg0: LIQUID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"http://GENIUS.GG"));
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"http://geniuses.com"));
