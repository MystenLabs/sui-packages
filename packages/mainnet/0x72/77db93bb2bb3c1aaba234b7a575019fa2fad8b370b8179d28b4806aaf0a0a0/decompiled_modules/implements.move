module 0x6b84da4f5dc051759382e60352377fea9d59bc6ec92dc60e0b6387e05274415f::implements {
    ...
    public fun upgrade_v4<T0, T1>(arg0: &mut Global, arg1: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v4 = 0x2::coin::take<T0>(&mut v1.coin_x, v2, arg1);
        0x2::coin::join<T0>(&mut v4, 0x2::coin::take<T0>(&mut v1.fee_coin_x, 0x2::balance::value<T0>(&v1.fee_coin_x), arg1));
        let v5 = 0x2::coin::take<T1>(&mut v1.coin_y, v3, arg1);
        0x2::coin::join<T1>(&mut v5, 0x2::coin::take<T1>(&mut v1.fee_coin_y, 0x2::balance::value<T1>(&v1.fee_coin_y), arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v5, 0x2::tx_context::sender(arg1));
        (v2, v3)
    }
