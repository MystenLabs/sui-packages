module 0x724302b75b7a3cc34d8a1c58288ed59e72f1f7b73ada5220a45314848e5372ef::jpds {
    ...
    fun init(arg0: JPDS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x2::coin::create_regulated_currency_v2<JPDS>(arg0, 9, trim_right(b"JPDS"), trim_right(b"JPDSndn"), trim_right(b"JPDSndnddsf"), v1, true, arg1);
        let v5 = v2;
        let v6 = 0x2::tx_context::sender(arg1);
        if (99999999000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<JPDS>>(0x2::coin::mint<JPDS>(&mut v5, 99999999000000000, arg1), v6);
        };
