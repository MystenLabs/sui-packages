module 0x721f784368fef7f6ce7ec4e312065861051ebae0afcb7ebae81b9c1556459745::treasury_cap {
    ...
    public fun burn<T0>(arg0: &mut TreasuryCapV2, arg1: &BurnCap, arg2: 0x2::coin::Coin<T0>) {
        ...
        0x2::coin::burn<T0>(0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, 0x2::coin::TreasuryCap<T0>>(&mut arg0.id, 0x1::type_name::get<T0>()), arg2);
    }

    public fun mint<T0>(arg0: &mut TreasuryCapV2, arg1: &MintCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1.treasury == 0x2::object::uid_to_address(&arg0.id), 9223372625265295361);
        let v0 = Mint<T0>{pos0: arg2};
        0x2::event::emit<Mint<T0>>(v0);
        0x2::coin::mint<T0>(0x2::dynamic_object_field::borrow_mut<0x1::type_name::TypeName, 0x2::coin::TreasuryCap<T0>>(&mut arg0.id, 0x1::type_name::get<T0>()), arg2, arg3)
    }

    public fun total_supply<T0>(arg0: &TreasuryCapV2) : u64 {
        0x2::coin::total_supply<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x2::coin::TreasuryCap<T0>>(&arg0.id, 0x1::type_name::get<T0>()))
    }
    ...
    public fun update_description<T0>(arg0: &TreasuryCapV2, arg1: &mut 0x2::coin::CoinMetadata<T0>, arg2: &MetadataCap, arg3: 0x1::string::String) {
        assert!(arg2.treasury == 0x2::object::uid_to_address(&arg0.id), 9223372513596145665);
        0x2::coin::update_description<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x2::coin::TreasuryCap<T0>>(&arg0.id, 0x1::type_name::get<T0>()), arg1, arg3);
    }
    ...
    public fun update_icon_url<T0>(arg0: &TreasuryCapV2, arg1: &mut 0x2::coin::CoinMetadata<T0>, arg2: &MetadataCap, arg3: 0x1::ascii::String) {
        assert!(arg2.treasury == 0x2::object::uid_to_address(&arg0.id), 9223372569430720513);
        0x2::coin::update_icon_url<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x2::coin::TreasuryCap<T0>>(&arg0.id, 0x1::type_name::get<T0>()), arg1, arg3);
    }
    ...
    public fun update_name<T0>(arg0: &TreasuryCapV2, arg1: &mut 0x2::coin::CoinMetadata<T0>, arg2: &MetadataCap, arg3: 0x1::string::String) {
        ...
        0x2::coin::update_name<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x2::coin::TreasuryCap<T0>>(&arg0.id, 0x1::type_name::get<T0>()), arg1, arg3);
    }

    public fun update_symbol<T0>(arg0: &TreasuryCapV2, arg1: &mut 0x2::coin::CoinMetadata<T0>, arg2: &MetadataCap, arg3: 0x1::ascii::String) {
        assert!(arg2.treasury == 0x2::object::uid_to_address(&arg0.id), 9223372457761570817);
        0x2::coin::update_symbol<T0>(0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, 0x2::coin::TreasuryCap<T0>>(&arg0.id, 0x1::type_name::get<T0>()), arg1, arg3);
    }
