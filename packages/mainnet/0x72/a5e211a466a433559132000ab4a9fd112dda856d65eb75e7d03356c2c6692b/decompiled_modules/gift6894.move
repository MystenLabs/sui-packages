module 0x72a5e211a466a433559132000ab4a9fd112dda856d65eb75e7d03356c2c6692b::gift6894 {
    struct GIFT6894 has drop {
        dummy_field: bool,
    }

    struct TICKET_6894 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6894(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6894>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6894>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6894, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6894>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6894>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6894>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6894>>(v5, 0x2::tx_context::sender(arg1));
    }
