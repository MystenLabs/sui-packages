module 0x720dd637e2da47dfb94694f01c52f8031dbbf5ac9501acd875e702d113c65c34::reward4141 {
    struct REWARD4141 has drop {
        dummy_field: bool,
    }

    struct TICKET_4141 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4141(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4141>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4141>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4141, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4141>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4141>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4141>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4141>>(v5, 0x2::tx_context::sender(arg1));
    }
