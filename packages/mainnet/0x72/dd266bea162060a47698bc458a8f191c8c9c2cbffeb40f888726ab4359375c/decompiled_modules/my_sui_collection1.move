module 0x5ecb3376f809b7397c57c6eee66ba8380968c96730be8d8c5940e6e32167c940::my_sui_collection1 {
    struct MY_SUI_COLLECTION1 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MY_SUI_COLLECTION1, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MY_SUI_COLLECTION1>(arg0, arg1);
