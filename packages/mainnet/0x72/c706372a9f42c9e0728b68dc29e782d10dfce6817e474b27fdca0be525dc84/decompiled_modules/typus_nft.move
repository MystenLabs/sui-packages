module 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft {
    ...
    entry fun close_pool(arg0: &ManagerCap, arg1: Pool) {
        ...
        0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::table_vec::destroy_empty<Tails>(v1);
    ...
    entry fun update_policy_rules(arg0: &ManagerCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<Tails>, arg2: &Royalty) {
        0x2::transfer_policy::remove_rule<Tails, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::royalty_rule::Rule, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::royalty_rule::Config>(arg1, &arg2.policy_cap);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Tails>(arg1, &arg2.policy_cap, 1000, 1000000000);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<Tails>(arg1, &arg2.policy_cap);
    }

    entry fun update_pool_nft(arg0: &ManagerCap, arg1: &mut Pool, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: vector<u8>) {
        let v0 = 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::table_vec::borrow_mut<Tails>(&mut arg1.tails, arg2);
    ...
    public(friend) fun withdraw_nfts(arg0: &ManagerCap, arg1: &mut Pool, arg2: u64) : vector<Tails> {
        ...
        while (arg2 > 0) {
            0x1::vector::push_back<Tails>(&mut v0, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::table_vec::pop_back<Tails>(&mut arg1.tails));
            arg2 = arg2 - 1;
        };
        v0
    }
