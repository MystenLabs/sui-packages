module 0x725faa590170e8102e85324a41a53dbe2b8a66b71a52f9cebd54e6cdb8d6dc34::epic_wing {
    ...
    public entry fun claimWithSignature(arg0: &mut WingRegistry, arg1: &PublicKey, arg2: vector<u8>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::string::append_utf8(&mut v0, b"Epic");
    ...
    fun init(arg0: EPIC_WING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Epic Explorer's Wing #{token_id}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://www.cubicgames.xyz/games"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://cubic-static.s3.amazonaws.com/common/bbp/n8.png"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"A big reward awaits the top Steam players who explore Web3. "));
        ...
        let v4 = 0x2::package::claim<EPIC_WING>(arg0, arg1);
    ...
    fun mint_nft(arg0: u64, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : Wing {
        ...
        let v2 = 60 + gen_random(v1, 0, 30);
        let v3 = 60 + gen_random(v1, v2, 30);
        let v4 = 60 + gen_random(v1, v3, 30);
        let v5 = Wing{
            id         : v0,
            token_id   : arg0,
            durability : v2,
