module 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::deepbook_v3 {
    ...
    public fun place_market_order_v2<T0, T1>(arg0: &mut 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::GlobalConfig, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg6: u8, arg7: u64, arg8: bool, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>) {
        ...
        let v3 = if (arg9) {
            if (v0 >= 0) {
                v0 < 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::alternative_payment_amount(arg0)
            } else {
                false
            }
        } else {
        ...
        if (v3) {
            let v4 = 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::alternative_payment_amount(arg0) - v0;
            v1 = v4;
            let v5 = 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::alternative_payment_deep(arg0, arg5, v4, arg11);
        ...
        let v6 = arg9 && v2 > 0;
        let v7 = 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::place_market_order_by_user_bm<T0, T1>(arg1, arg2, 1107, arg6, arg7, arg8, v6, arg10, arg11);
        if (v1 > 0) {
            0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::deposit_deep_fee(arg0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::withdraw<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg1, v1 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v7), arg11));
        };
        0x2::coin::join<T0>(&mut arg3, 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::withdraw_all<T0>(arg0, arg11));
        0x2::coin::join<T1>(&mut arg4, 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::withdraw_all<T1>(arg0, arg11));
        ...
        (arg3, arg4, 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::withdraw_all<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg0, arg11))
    }

    public fun place_market_order_v3<T0, T1>(arg0: &mut 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::GlobalConfig, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg6: u8, arg7: u64, arg8: bool, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::checked_package_version(arg0);
        let v0 = 0x2::coin::value<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&arg5);
        ...
        let v6 = arg9 && v2 > 0;
        let v7 = 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::place_market_order_by_user_bm<T0, T1>(arg1, arg2, 1107, arg6, arg7, arg8, v6, arg10, arg11);
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v7);
        let v8 = PlaceMarktetOrderEvent{
            balance_manager_id        : 0x2::object::id<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager>(arg1),
            pool_id                   : 0x2::object::id<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>>(arg2),
            order_id                  : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::order_id(&v7),
    ...
    public fun place_market_order_v4<T0, T1>(arg0: &mut 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::GlobalConfig, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg6: u8, arg7: u64, arg8: bool, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::checked_package_version(arg0);
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::deposit<T1>(arg1, arg4, arg11);
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::deposit<T0>(arg1, arg3, arg11);
        abort 0
    ...
    public fun swap_a2b_<T0, T1>(arg0: &mut 0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::GlobalConfig, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>) {
        ...
        let v6 = if (v3 > v5) {
            let v7 = v3 - v5;
            v4 = v7;
            0x722b8000d0ffb2c0e6fa0261bea9eb524d0904c53e0e08465ac336089a3f963d::global_config::alternative_payment_deep(arg0, arg3, v7, arg5)
        } else {
            arg3
        };
        let v8 = v6;
