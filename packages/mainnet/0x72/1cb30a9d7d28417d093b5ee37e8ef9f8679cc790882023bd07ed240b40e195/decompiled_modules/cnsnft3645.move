module 0x721cb30a9d7d28417d093b5ee37e8ef9f8679cc790882023bd07ed240b40e195::cnsnft3645 {
    struct CNSNFT3645 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3645, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3645>(arg0, arg1);
