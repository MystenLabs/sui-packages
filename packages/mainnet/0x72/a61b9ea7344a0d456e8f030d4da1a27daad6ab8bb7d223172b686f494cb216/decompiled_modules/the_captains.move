module 0x72a61b9ea7344a0d456e8f030d4da1a27daad6ab8bb7d223172b686f494cb216::the_captains {
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<PfpNFT>>(v12);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PfpNFT>>(v13, @0x552c4e45ef071c3c14e75a5247a9c5dd4e7430e3783e217b663aab1d926d8fa5);
    ...
    fun mint_core(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut Counter, arg12: &MintConfig, arg13: &mut MintStats, arg14: &Payout, arg15: 0x2::coin::Coin<0x2::sui::SUI>, arg16: &0x2::transfer_policy::TransferPolicy<PfpNFT>, arg17: &mut 0x2::kiosk::Kiosk, arg18: &0x2::kiosk::KioskOwnerCap, arg19: &0x2::clock::Clock, arg20: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(minted_count_in_stage(arg13, arg7, v1) + arg3 <= get_stage_limit(arg12, arg7), 11);
        if (0x2::table::contains<address, u64>(&arg13.per_address, v1)) {
            let v2 = 0x2::table::borrow_mut<address, u64>(&mut arg13.per_address, v1);
            *v2 = *v2 + arg3;
        } else {
            0x2::table::add<address, u64>(&mut arg13.per_address, v1, arg3);
        };
        ensure_stage_bucket(arg13, arg7, arg20);
        if (0x2::table::contains<address, u64>(0x2::table::borrow<u64, 0x2::table::Table<address, u64>>(&arg13.per_stage, arg7), v1)) {
            let v3 = 0x2::table::borrow_mut<address, u64>(0x2::table::borrow_mut<u64, 0x2::table::Table<address, u64>>(&mut arg13.per_stage, arg7), v1);
            *v3 = *v3 + arg3;
        } else {
            0x2::table::add<address, u64>(0x2::table::borrow_mut<u64, 0x2::table::Table<address, u64>>(&mut arg13.per_stage, arg7), v1, arg3);
        };
        ...
        while (v4 < arg3) {
            ...
            0x2::kiosk::lock<PfpNFT>(arg17, arg18, arg16, v6);
            v4 = v4 + 1;
        };
    }
    ...
    fun mint_free_core(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut Counter, arg12: &MintConfig, arg13: &mut MintStats, arg14: &0x2::transfer_policy::TransferPolicy<PfpNFT>, arg15: &mut 0x2::kiosk::Kiosk, arg16: &0x2::kiosk::KioskOwnerCap, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg3) {
            ...
            0x2::event::emit<MintEvent>(v7);
            0x2::kiosk::lock<PfpNFT>(arg15, arg16, arg14, v6);
            v4 = v4 + 1;
        };
    }
