module 0x720bd34fe57ed60f76a71c2005274e0a42bce885e352bc24921363008c5770a4::inbox_bridge {
    ...
    fun create_inbox_message_hash(arg0: u64, arg1: u32, arg2: address, arg3: &vector<u8>) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x720bd34fe57ed60f76a71c2005274e0a42bce885e352bc24921363008c5770a4::utils::u64_to_be_bytes(arg0));
        0x1::vector::append<u8>(&mut v0, 0x720bd34fe57ed60f76a71c2005274e0a42bce885e352bc24921363008c5770a4::utils::u32_to_be_bytes(arg1));
