module 0x7282a300e3a274e63f04626bec470be50546943373b5612f0a58c0aeb4f4fd62::reward5914 {
    struct REWARD5914 has drop {
        dummy_field: bool,
    }

    struct TICKET_5914 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5914(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5914>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5914>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5914, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5914>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5914>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5914>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5914>>(v5, 0x2::tx_context::sender(arg1));
    }
