module 0x72d4735b2387fb48520bba873f8132a658343c9f4612bb4684c3f99ddda3f824::registry {
    ...
    public(friend) fun add(arg0: u16, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &mut Registry, arg4: &0x72d4735b2387fb48520bba873f8132a658343c9f4612bb4684c3f99ddda3f824::collection::Collection) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg3.num_to_nft) as u16) == (0x72d4735b2387fb48520bba873f8132a658343c9f4612bb4684c3f99ddda3f824::collection::supply(arg4) as u16)) {
            arg3.is_ready = true;
        };
    }

    public(friend) fun add_new(arg0: u16, arg1: 0x2::object::ID, arg2: &mut Registry, arg3: &0x72d4735b2387fb48520bba873f8132a658343c9f4612bb4684c3f99ddda3f824::collection::Collection) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg2.num_to_nft) as u16) == (0x72d4735b2387fb48520bba873f8132a658343c9f4612bb4684c3f99ddda3f824::collection::supply(arg3) as u16)) {
            arg2.is_ready = true;
        };
    }
    ...
    public fun nft_id_from_number(arg0: &Registry, arg1: &0x72d4735b2387fb48520bba873f8132a658343c9f4612bb4684c3f99ddda3f824::collection::Collection, arg2: u16) : 0x2::object::ID {
        assert!(arg2 >= 1 && arg2 <= 0x72d4735b2387fb48520bba873f8132a658343c9f4612bb4684c3f99ddda3f824::collection::supply(arg1), 1);
