module 0x72dbbf498547a24435690db140de501d815baf3be830c1a1bd8a85c287f18df5::cnsnft1423 {
    struct CNSNFT1423 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1423, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1423>(arg0, arg1);
