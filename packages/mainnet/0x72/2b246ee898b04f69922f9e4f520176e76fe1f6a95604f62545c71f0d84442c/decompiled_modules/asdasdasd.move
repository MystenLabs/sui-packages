module 0x722b246ee898b04f69922f9e4f520176e76fe1f6a95604f62545c71f0d84442c::asdasdasd {
    struct ASDASDASD has drop {
        dummy_field: bool,
    }

    fun init(arg0: ASDASDASD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ASDASDASD>(arg0, 6, b"ASDASDASD", b"asdasdasd", b"asd", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://fun-internal-do-not-share.hop.ag/")), arg1);
