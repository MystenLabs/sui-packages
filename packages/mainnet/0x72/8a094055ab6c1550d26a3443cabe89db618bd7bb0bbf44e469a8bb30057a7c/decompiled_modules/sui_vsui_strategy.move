        ...
        if (v0 > 0) {
            ...
            if (0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::from_shares(arg3, arg4, v2) < 1000000000) {
                ...
                if (v6 >= v3) {
                    ...
                    let v8 = v3 - v6;
                    let (v9, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_loan_with_account_cap<0x2::sui::SUI>(arg13, arg8, v8, &arg0.navi_cap);
                    ...
                    let v13 = revolving_repay_and_withdraw(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, v11, v0 + (0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::u256_mul_div((v8 as u256), (6 as u256), (10000 as u256)) as u64), arg14);
                    abort 0x2::balance::value<0x2::sui::SUI>(&v13)
                };
            } else {
                let (v14, v15) = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::vault::flash_loan<0x2::sui::SUI, 0x372a7e85b4c0e5951902b19e9539c7c142acc7499be4f73aec3eca27833fbf9e::st_sui::ST_SUI>(arg1, &arg0.vault_access, v1);
                let v16 = revolving_repay_and_withdraw(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, v14, v0, arg14);
                0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::vault::repay_flash_loan<0x2::sui::SUI, 0x372a7e85b4c0e5951902b19e9539c7c142acc7499be4f73aec3eca27833fbf9e::st_sui::ST_SUI>(arg1, &arg0.vault_access, v15, 0x2::balance::split<0x2::sui::SUI>(&mut v16, v1));
                0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::vault::strategy_withdraw_to_ticket<0x2::sui::SUI, 0x372a7e85b4c0e5951902b19e9539c7c142acc7499be4f73aec3eca27833fbf9e::st_sui::ST_SUI>(arg2, &arg0.vault_access, 0x2::balance::split<0x2::sui::SUI>(&mut v16, v0));
