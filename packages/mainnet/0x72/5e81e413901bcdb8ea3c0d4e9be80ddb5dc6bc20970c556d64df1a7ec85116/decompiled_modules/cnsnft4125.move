module 0x725e81e413901bcdb8ea3c0d4e9be80ddb5dc6bc20970c556d64df1a7ec85116::cnsnft4125 {
    struct CNSNFT4125 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4125, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4125>(arg0, arg1);
