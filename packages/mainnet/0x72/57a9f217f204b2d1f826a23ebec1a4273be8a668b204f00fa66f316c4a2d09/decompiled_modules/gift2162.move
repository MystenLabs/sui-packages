module 0x7257a9f217f204b2d1f826a23ebec1a4273be8a668b204f00fa66f316c4a2d09::gift2162 {
    struct GIFT2162 has drop {
        dummy_field: bool,
    }

    struct TICKET_2162 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2162(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2162>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2162>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2162, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2162>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2162>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2162>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2162>>(v5, 0x2::tx_context::sender(arg1));
    }
