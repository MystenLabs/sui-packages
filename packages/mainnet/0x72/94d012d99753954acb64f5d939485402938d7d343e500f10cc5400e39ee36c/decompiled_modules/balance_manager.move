module 0x7294d012d99753954acb64f5d939485402938d7d343e500f10cc5400e39ee36c::balance_manager {
    ...
    public fun new_with_custom_owner_caps<T0: drop>(arg0: &0x7294d012d99753954acb64f5d939485402938d7d343e500f10cc5400e39ee36c::registry::Registry, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (BalanceManager, DepositCap, WithdrawCap, TradeCap) {
        0x7294d012d99753954acb64f5d939485402938d7d343e500f10cc5400e39ee36c::registry::assert_app_is_authorized<T0>(arg0);
    ...
    public fun register_balance_manager(arg0: &BalanceManager, arg1: &mut 0x7294d012d99753954acb64f5d939485402938d7d343e500f10cc5400e39ee36c::registry::Registry, arg2: &mut 0x2::tx_context::TxContext) {
        validate_owner(arg0, arg2);
        0x7294d012d99753954acb64f5d939485402938d7d343e500f10cc5400e39ee36c::registry::add_balance_manager(arg1, owner(arg0), id(arg0));
    }

    public fun register_manager(arg0: &BalanceManager, arg1: &mut 0x7294d012d99753954acb64f5d939485402938d7d343e500f10cc5400e39ee36c::registry::Registry) {
        abort 1337
    }
