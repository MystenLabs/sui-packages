module 0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::reward_distributor {
    struct RewardPool has key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>,
        admin: address,
        finalized: bool,
    ...
    public fun claim(arg0: &mut RewardPool, arg1: &0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::player_card::PlayerCard, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.finalized, 2);
        assert!(!0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::player_card::is_alive(arg1), 4);
        let v0 = 0x2::object::id<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::player_card::PlayerCard>(arg1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>>(0x2::coin::from_balance<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(0x2::balance::split<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&mut arg0.balance, v1), arg3), arg2);
    ...
    public(friend) fun deposit(arg0: &mut RewardPool, arg1: 0x2::coin::Coin<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>) {
        0x2::balance::join<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&mut arg0.balance, 0x2::coin::into_balance<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(arg1));
        let v0 = PoolDeposited{
            amount    : 0x2::coin::value<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&arg1),
            new_total : 0x2::balance::value<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&arg0.balance),
        };
        0x2::event::emit<PoolDeposited>(v0);
    }

    public fun deposit_direct(arg0: &mut RewardPool, arg1: 0x2::coin::Coin<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>) {
        0x2::balance::join<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&mut arg0.balance, 0x2::coin::into_balance<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(arg1));
        let v0 = PoolDeposited{
            amount    : 0x2::coin::value<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&arg1),
            new_total : 0x2::balance::value<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&arg0.balance),
        ...
        while (v1 < v0) {
            ...
            if (!0x2::table::contains<0x2::object::ID, bool>(&arg0.claimed, v2) && 0x2::table::contains<0x2::object::ID, u64>(&arg0.payouts, v2)) {
                ...
                if (v4 > 0) {
                    ...
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>>(0x2::coin::from_balance<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(0x2::balance::split<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&mut arg0.balance, v4), arg3), v3);
    ...
    public fun finalize(arg0: &mut RewardPool, arg1: vector<0x2::object::ID>, arg2: vector<u8>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!arg0.finalized, 2);
        let v0 = 0x2::balance::value<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&arg0.balance);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = RewardPool{
            ...
            balance   : 0x2::balance::zero<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(),
    ...
    public fun pool_balance(arg0: &RewardPool) : u64 {
        0x2::balance::value<0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::fusdc::FUSDC>(&arg0.balance)
    }
