module 0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::ACL,
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        ...
        0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::Member> {
        0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun checked_kepper(arg0: &GlobalConfig, arg1: address) {
        assert!(0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::has_role(&arg0.acl, arg1, 1), 2);
    }
    ...
    public fun checked_token_white_list_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::has_role(&arg0.acl, arg1, 0), 1);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                            : 0x72a8521f978988834733b91c51ab34c14ac396922ba52bc419080c12ea0d2933::acl::new(arg0),
    ...
    public fun set_config_deletion_grace_period(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        checked_kepper(arg0, 0x2::tx_context::sender(arg2));
