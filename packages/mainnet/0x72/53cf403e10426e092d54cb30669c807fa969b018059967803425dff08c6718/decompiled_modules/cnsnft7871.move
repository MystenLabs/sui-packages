module 0x7253cf403e10426e092d54cb30669c807fa969b018059967803425dff08c6718::cnsnft7871 {
    struct CNSNFT7871 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7871, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7871>(arg0, arg1);
