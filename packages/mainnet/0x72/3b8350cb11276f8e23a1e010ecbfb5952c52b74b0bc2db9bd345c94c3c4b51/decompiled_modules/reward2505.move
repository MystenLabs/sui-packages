module 0x723b8350cb11276f8e23a1e010ecbfb5952c52b74b0bc2db9bd345c94c3c4b51::reward2505 {
    struct REWARD2505 has drop {
        dummy_field: bool,
    }

    struct TICKET_2505 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2505(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2505>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2505>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2505, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2505>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2505>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2505>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2505>>(v5, 0x2::tx_context::sender(arg1));
    }
