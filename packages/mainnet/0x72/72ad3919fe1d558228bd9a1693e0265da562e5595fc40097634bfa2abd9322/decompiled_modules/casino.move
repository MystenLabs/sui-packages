module 0xb2a6c0ebfe6fdac6d8261fd0df496cc90522d745aada4a0bf699c5f32406d583::casino {
    ...
    fun init(arg0: CASINO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::package::Publisher>(0x2::package::claim<CASINO>(arg0, arg1), v0);
        let v1 = House{
    ...
    public fun process_game_bet(arg0: &mut House, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
        let v0 = if (arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, arg3), arg4), 0x2::tx_context::sender(arg4));
            arg0.total_wins = arg0.total_wins + 1;
            arg3
        } else {
            0
        ...
        arg0.total_bets = arg0.total_bets + 1;
        arg0.total_volume = arg0.total_volume + 0x2::coin::value<0x2::sui::SUI>(&arg1);
        v0
    }
