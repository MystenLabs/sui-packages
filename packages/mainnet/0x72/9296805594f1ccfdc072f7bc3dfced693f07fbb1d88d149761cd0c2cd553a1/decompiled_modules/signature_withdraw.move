module 0x729296805594f1ccfdc072f7bc3dfced693f07fbb1d88d149761cd0c2cd553a1::signature_withdraw {
    ...
    public fun withdraw<T0>(arg0: &mut WithdrawState<T0>, arg1: u64, arg2: address, arg3: vector<u8>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg4 <= v0, 2);
        assert!(v0 - arg4 <= 300, 3);
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 4);
        assert!(arg1 > 0, 8);
        let v1 = if (0x2::table::contains<address, UserWithdrawRecord>(&arg0.user_records, arg2)) {
            *0x2::table::borrow<address, UserWithdrawRecord>(&arg0.user_records, arg2)
        } else {
            UserWithdrawRecord{nonce: 0, total_withdrawn: 0}
        };
        let v2 = v1;
        let v3 = create_withdraw_message<T0>(arg1, arg2, v2.nonce, arg4);
        assert!(0x2::ed25519::ed25519_verify(&arg3, &arg0.public_key, &v3), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.balance, arg1, arg6), arg2);
        v2.nonce = v2.nonce + 1;
        v2.total_withdrawn = v2.total_withdrawn + arg1;
        if (0x2::table::contains<address, UserWithdrawRecord>(&arg0.user_records, arg2)) {
            *0x2::table::borrow_mut<address, UserWithdrawRecord>(&mut arg0.user_records, arg2) = v2;
        } else {
            0x2::table::add<address, UserWithdrawRecord>(&mut arg0.user_records, arg2, v2);
        };
        ...
        let v4 = WithdrawEvent{
            ...
            timestamp                  : arg4,
            nonce                      : v2.nonce - 1,
            user_total_withdrawn       : v2.total_withdrawn,
