module 0x268affe33e2b6ed70467d58ecd6798b237927f0ee0b23fbc510243680dacecd3::game_store {
    ...
    entry fun publish_game(arg0: &mut Registry, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg6), 0);
