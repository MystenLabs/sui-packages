module 0x2639ac6e4d5f13f5ee5da8b8662ec3d4625ca47eb4ee4253b993e0e7eae42325::jim {
    struct JIM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: JIM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<JIM>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"JIM     ")))), trim_right(b"Naked Jim                       "), trim_right(b"An original memecoin bearing it all on Solana (and beyond).                                                                                                                                                                                                                                                                     "), v2, arg1);
