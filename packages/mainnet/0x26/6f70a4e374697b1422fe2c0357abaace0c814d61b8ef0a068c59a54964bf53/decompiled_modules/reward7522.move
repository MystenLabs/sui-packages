module 0x266f70a4e374697b1422fe2c0357abaace0c814d61b8ef0a068c59a54964bf53::reward7522 {
    struct REWARD7522 has drop {
        dummy_field: bool,
    }

    struct TICKET_7522 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7522(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7522>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7522>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7522, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7522>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7522>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7522>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7522>>(v5, 0x2::tx_context::sender(arg1));
    }
