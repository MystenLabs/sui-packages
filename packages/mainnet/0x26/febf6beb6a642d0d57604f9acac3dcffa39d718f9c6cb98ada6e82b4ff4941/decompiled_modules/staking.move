module 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::staking {
    ...
    struct StakingTails has store {
        nft: 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails,
        snapshot_ms: u64,
        updating_url: bool,
    }
    ...
    public fun add_exp(arg0: &mut Registry, arg1: &ManagerCap, arg2: address, arg3: u64) {
        ...
        0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::nft_exp_up(&v0.nft_manager_cap, &mut 0x2::table::borrow_mut<address, StakingTails>(v1, arg2).nft, arg3);
    }

    public fun add_nft_extension(arg0: &mut Registry, arg1: 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::ManagerCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"nft_extension"), 0);
        let v0 = NftExtension{
    ...
    public fun first_bid(arg0: &mut Registry, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, StakingTails>(v1, 0x2::tx_context::sender(arg1))) {
            0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::first_bid(&v0.nft_manager_cap, &mut 0x2::table::borrow_mut<address, StakingTails>(v1, 0x2::tx_context::sender(arg1)).nft);
        };
    }
    ...
    public fun first_deposit(arg0: &mut Registry, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0.nft_table;
        if (0x2::table::contains<address, StakingTails>(v1, 0x2::tx_context::sender(arg1))) {
            0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::first_deposit(&v0.nft_manager_cap, &mut 0x2::table::borrow_mut<address, StakingTails>(v1, 0x2::tx_context::sender(arg1)).nft);
        };
    }
    ...
    public fun level_up(arg0: &mut Registry, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::level_up(&v0.nft_manager_cap, &mut v3.nft);
        if (0x1::option::is_some<u64>(&v4)) {
            let v5 = LevelUpEvent{
                nft_id : 0x2::object::id<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&v3.nft),
                sender : v2,
                number : 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::tails_number(&v3.nft),
    ...
    public fun snapshot(arg0: &mut Registry, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v2.snapshot_ms = v3;
        0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::nft_exp_up(&v0.nft_manager_cap, &mut v2.nft, 10);
    }
    ...
    public fun stake_nft(arg0: &mut Registry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = StakingTails{
            nft          : 0x2::kiosk::take<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(arg1, arg2, arg3),
    ...
    public fun unstake_nft(arg0: &mut Registry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!v3, 4);
        0x2::kiosk::place<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(arg1, arg2, v1);
    }
    ...
    public fun update_image_url(arg0: &mut Registry, arg1: &ManagerCap, arg2: address, arg3: vector<u8>) {
        ...
        0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::update_image_url(&v0.nft_manager_cap, &mut v2.nft, arg3);
