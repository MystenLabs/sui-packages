module 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::discount_mint {
    struct Pool has key {
        id: 0x2::object::UID,
        num: u64,
        price: u64,
        ...
        tails: 0x2::table_vec::TableVec<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>,
    ...
    struct DiscountEvent has copy, drop {
        price: u64,
        discount_pct: u64,
        discount_price: u64,
    }

    struct DiscountEventV2 has copy, drop {
        pool: 0x2::object::ID,
        price: u64,
        discount_pct: u64,
        discount_price: u64,
    ...
    entry fun deposit_nft(arg0: &mut Pool, arg1: 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails) {
        0x2::table_vec::push_back<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut arg0.tails, arg1);
    }

    entry fun execute_mint(arg0: &mut Pool, arg1: &0x2::transfer_policy::TransferPolicy<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::table_vec::length<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&arg0.tails);
        let v7 = if (v6 == 1) {
            0x2::table_vec::pop_back<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut arg0.tails)
        } else {
            0x2::table_vec::swap<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut arg0.tails, (generate_answer(v6, &v5) as u64), v6 - 1);
            0x2::table_vec::pop_back<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut arg0.tails)
        };
        let v8 = v7;
        0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::emit_mint_event(&v8, v0);
        let (v9, v10) = 0x2::kiosk::new(arg3);
        let v11 = v10;
        let v12 = v9;
        0x2::kiosk::lock<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut v12, &v11, arg1, v8);
        ...
        let v16 = DiscountEventV3{
            ...
            user           : v0,
            vrf_input      : v3,
            level          : 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::tails_level(&v8),
        };
    ...
    entry fun migrate_nfts(arg0: &0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::ManagerCap, arg1: &mut 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Pool, arg2: u64, arg3: &mut Pool) {
        let v0 = 0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::withdraw_nfts(arg0, arg1, arg2);
        while (!0x1::vector::is_empty<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&v0)) {
            deposit_nft(arg3, 0x1::vector::pop_back<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut v0));
        };
        0x1::vector::destroy_empty<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(v0);
    }

    entry fun migrate_pool(arg0: &mut Pool, arg1: &mut Pool, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(arg0.authority == 0x2::tx_context::sender(arg4), 0);
        assert!(arg1.authority == 0x2::tx_context::sender(arg4), 0);
        let v0 = 0;
        let v1 = 0x2::table_vec::length<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&arg0.tails);
        while (v0 < v1 && arg3 > 0) {
            if (0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::tails_level(0x2::table_vec::borrow<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&arg0.tails, v0)) > arg2) {
                0x2::table_vec::swap<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut arg0.tails, v0, v1 - 1);
                deposit_nft(arg1, 0x2::table_vec::pop_back<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut arg0.tails));
                v1 = v1 - 1;
                arg3 = arg3 - 1;
                continue
            };
    ...
    entry fun new_pool(arg0: &0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::ManagerCap, arg1: u64, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: vector<u64>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool{
            ...
            tails         : 0x2::table_vec::empty<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(arg6),
    ...
    entry fun update_pool_nft(arg0: &0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::ManagerCap, arg1: &mut Pool, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: vector<u8>, arg6: &0x2::tx_context::TxContext) {
        assert!(arg1.authority == 0x2::tx_context::sender(arg6), 0);
        0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::update_nft(arg0, 0x2::table_vec::borrow_mut<0x26febf6beb6a642d0d57604f9acac3dcffa39d718f9c6cb98ada6e82b4ff4941::typus_nft::Tails>(&mut arg1.tails, arg2), arg3, arg4, arg5);
    }
