module 0x2670d33a25d5303d42483b479a2853fac3a98c4bf633078f9db09c9cd3914e36::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"boo", b"boo boy", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-04T13-19-45.135Z-600x600 (2).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"boo boy"),
            symbol     : 0x1::string::utf8(b"boo"),
            decimals   : 9,
