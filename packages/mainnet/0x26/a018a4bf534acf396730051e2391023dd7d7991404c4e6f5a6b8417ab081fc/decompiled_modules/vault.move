module 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::vault {
    ...
    public(friend) fun add_deposit_request<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x2::balance::Balance<T1>, arg2: address, arg3: u8) {
        let v0 = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_active();
        assert!(&arg0.state == &v0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::strategy_not_active());
        let v1 = 0x2::balance::value<T1>(&arg1);
        assert!(v1 >= 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::min_deposit_amount(), 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::deposit_amount_too_low());
    ...
    public fun calculate_lp_token_share<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: u64) : (u64, u64) {
        ...
        assert!(v4 > 0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::invalidLPToken());
    ...
    public(friend) fun claim_withdrawal<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::table::contains<address, ClaimableWithdrawals<T0, T1>>(&arg0.claimable_withdrawals, arg1), 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::claim_does_not_exist());
    ...
    public(friend) fun mark_state_as_ready_for_withdrawal_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) {
        let v0 = &arg0.deposit_queue;
        let v1 = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::strategy_not_ready_for_withdrawal_processing());
        arg0.state = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_paused_and_ready_for_withdrawal_processing();
    }
    ...
    fun mint_lp_token<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::minimal_liquidity(), 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::liquidityInsufficientMinted());
        0x2::coin::mint<T0>(arg0, v1, arg5)
    }

    public(friend) fun new_vault<T0, T1, T2>(arg0: &0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::app::AdminCap, arg1: 0x2::coin::TreasuryCap<T2>, arg2: &0xdee9::clob_v2::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, VaultCap) {
        ...
        let v2 = Vault<T0, T1, T2>{
            ...
            epoch_counter         : 0,
            state                 : 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_active(),
    ...
    public(friend) fun pause_strategy_and_mark_ready_for_deposit_processing<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>) {
        let v0 = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_active();
        assert!(&arg0.state == &v0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::strategy_not_active());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::invalid_pool());
        ...
        arg0.state = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_paused_and_ready_for_deposit_processing();
    }

    public(friend) fun process_deposits<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_paused_and_ready_for_deposit_processing();
        assert!(&arg0.state == &v0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::strategy_not_ready_for_deposit_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::invalid_pool());
        let v1 = &arg0.deepbook_account_cap;
        let (v2, v3, v4, v5) = get_deepbook_account_assets<T0, T1, T2>(arg0, arg1);
        assert!(v3 == 0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::locked_base_asset_found());
        assert!(v5 == 0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::locked_quote_asset_found());
        let (_, _, v8) = get_deepbook_price<T0, T1>(arg1);
        let v9 = v2;
        let v10 = v4;
        let v11 = &mut arg0.treasury_cap;
        let v12 = 0;
        let v13 = &mut arg0.deposit_queue;
        while (v12 < arg3 && 0x2::linked_table::length<address, DepositRequest<T1>>(&v13.requests) > 0) {
            let (_, v15) = 0x2::linked_table::pop_front<address, DepositRequest<T1>>(&mut v13.requests);
            let DepositRequest {
                amount       : v16,
                owner        : v17,
                request_type : _,
            ...
            let v21 = if (v4 == 0) {
                0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::safe_math::safe_mul_div_u64(v20, 1, 2)
            } else {
                0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::safe_math::safe_mul_div_u64(v20, v2, 1000 * v4 + v2)
            };
            let v22 = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::safe_math::safe_mul_div_u64(v21, v8, 1000000) * 1000;
            let (v23, v24) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg1, v1, 1, v22 - v22 % 100000000, true, 0x2::coin::zero<T0>(arg4), 0x2::coin::from_balance<T1>(v19, arg4), arg2, arg4);
            let v25 = v24;
            let v26 = v23;
            let v27 = v9 + 0x2::coin::value<T0>(&v26);
            v9 = v27;
            let v28 = v10 + 0x2::coin::value<T1>(&v25);
            v10 = v28;
            0xdee9::clob_v2::deposit_base<T0, T1>(arg1, v26, v1);
            0xdee9::clob_v2::deposit_quote<T0, T1>(arg1, v25, v1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(mint_lp_token<T2>(v11, v27, v28, 0x2::coin::value<T0>(&v26), 0x2::coin::value<T1>(&v25), arg4), v17);
            v13.unprocessed_amount = v13.unprocessed_amount - v20;
            v13.pending_requests = v13.pending_requests - 1;
            v12 = v12 + 1;
        };
        if (v13.pending_requests == 0) {
    ...
    public(friend) fun process_withdrawals<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::strategy_not_ready_for_withdrawal_processing());
        assert!(0x2::object::id<0xdee9::clob_v2::Pool<T0, T1>>(arg1) == arg0.pool_id, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::invalid_pool());
        let v1 = &arg0.deepbook_account_cap;
        let v2 = 0;
    ...
    public(friend) fun revoke_trading_permission<T0, T1, T2>(arg0: &VaultCap, arg1: &mut Vault<T0, T1, T2>, arg2: address) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1, T2>(arg1), 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::invalid_vault_cap());
        let (v0, v1) = 0x1::vector::index_of<address>(&arg1.whitelisted_addresses, &arg2);
        assert!(v0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::address_not_whitelisted());
        0x1::vector::remove<address>(&mut arg1.whitelisted_addresses, v1);
    }

    public(friend) fun start_strategy<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        let v0 = &arg0.withdraw_queue;
        let v1 = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_paused_and_ready_for_withdrawal_processing();
        assert!(&arg0.state == &v1 && v0.pending_requests == 0, 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::error::strategy_not_ready_to_make_active());
        arg0.state = 0x26a018a4bf534acf396730051e2391023dd7d7991404c4e6f5a6b8417ab081fc::constants::strategy_active();
