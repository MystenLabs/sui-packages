module 0x26c230ccc2bde3fefffcc104c2d147eb7c8f9d646d9f61d41f0aefe879862c90::ido {
    struct IDO has drop {
        dummy_field: bool,
    }
    ...
    public entry fun claim<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.raised_amount < arg0.soft_cap) {
            ...
            let v5 = 0x26c230ccc2bde3fefffcc104c2d147eb7c8f9d646d9f61d41f0aefe879862c90::math::mul_div(v1.purchased_amount, arg0.sale_rate, 1000);
            ...
            let v6 = if (arg0.vesting.using_vesting) {
                ...
                if (v7 > 0 && v1.vesting_map.tge_status) {
                    let v9 = 0x26c230ccc2bde3fefffcc104c2d147eb7c8f9d646d9f61d41f0aefe879862c90::math::mul_div(v1.vesting_map.total_amount, v7, 100);
                    ...
                    assert!(v2 > v11, 37);
                    let v12 = 0x26c230ccc2bde3fefffcc104c2d147eb7c8f9d646d9f61d41f0aefe879862c90::math::mul_div(v1.vesting_map.total_amount, arg0.vesting.cycle_percent, 10000) * v10;
    ...
    public entry fun settle<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.raised_amount < arg1.soft_cap) {
            ...
            let v5 = arg1.sale_amount - 0x26c230ccc2bde3fefffcc104c2d147eb7c8f9d646d9f61d41f0aefe879862c90::math::mul_div(arg1.raised_amount, arg1.sale_rate, 1000);
