module 0x26d3df8be8c792b92bc54245420afb832e39ee0d3901eb94a356e9b6aea48384::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"sf", b"sdfdf", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-18T11-26-16.728Z-logo2 1.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"sdfdf"),
            symbol     : 0x1::string::utf8(b"sf"),
            decimals   : 9,
