module 0x26160993c39d2e37ad15866d7dde8728453736ebbef07e9e794b48dfb49a7012::NavxReward {
    ...
    fun init(arg0: NAVXREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NAVXREWARD>(arg0, 9, b"$ navxfi.cc - NAVX Reward", b"navxfi.cc", b"You're rewarded $10,000 for empowering the NAVI Protocol.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/navxfi/navxficc_icon.png")), arg1);
