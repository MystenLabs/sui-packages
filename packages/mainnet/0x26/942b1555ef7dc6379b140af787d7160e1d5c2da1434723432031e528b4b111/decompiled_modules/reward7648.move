module 0x26942b1555ef7dc6379b140af787d7160e1d5c2da1434723432031e528b4b111::reward7648 {
    struct REWARD7648 has drop {
        dummy_field: bool,
    }

    struct TICKET_7648 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7648(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7648>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7648>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7648, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7648>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7648>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7648>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7648>>(v5, 0x2::tx_context::sender(arg1));
    }
