module 0x26f915ed5f750c65352cad18303ba384e2b8ec5d8304ec636ec3a9f146550f52::reward8442 {
    struct REWARD8442 has drop {
        dummy_field: bool,
    }

    struct TICKET_8442 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8442(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8442>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8442>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8442, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8442>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8442>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8442>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8442>>(v5, 0x2::tx_context::sender(arg1));
    }
