module 0x2619a8f0dcb23cb213f79c35a85b729b4ee4323bebd6767aebb94bba0c77ad5b::cnsnft2993 {
    struct CNSNFT2993 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2993, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2993>(arg0, arg1);
