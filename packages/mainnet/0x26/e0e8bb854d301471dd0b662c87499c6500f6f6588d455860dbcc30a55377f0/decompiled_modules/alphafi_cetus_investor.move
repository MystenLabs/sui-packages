    ...
    public(friend) fun get_balances_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool) : (u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (v2, v3, v4) = if (0x2::balance::value<T0>(&arg1) == 0 || 0x2::balance::value<T1>(&arg2) == 0) {
            ...
            let (v5, v6, v7) = if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lte(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T0, T1>(arg3), v1)) {
                ...
                0x2::event::emit<FreeBalanceEventNew>(v11);
                let v12 = 0x2::balance::value<T1>(&arg2);
                let v13 = v10 + 1;
                if (v13 <= v12) {
                    if (arg4 == false) {
                        assert!(((v12 - v13) as u128) * 1000000000 / (v12 as u128) <= 10000000, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::difference_too_high());
                    };
                    0x2::balance::join<T1>(&mut arg0.free_balance_b, arg2);
                    (v8, arg1, 0x2::balance::split<T1>(&mut arg2, v13))
                } else {
                    ...
                    assert!(v15 <= v18, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::insufficient_balance_to_add_liquidity());
                    if (arg4 == false) {
                        assert!(((v18 - v15) as u128) * 1000000000 / (v18 as u128) <= 10000000, 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::error::difference_too_high());
                    };
                    if (v15 > 1) {
                        v17 = v15 - 1;
                    };
