module 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::policy {
    struct Request {
    ...
    public(friend) fun add_receipt<T0>(arg0: &mut Request) {
        0x2::vec_set::insert<0x1::string::String>(&mut arg0.receipts, 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_key_by_struct<T0>());
    }

    public(friend) fun add_rule<T0, T1: drop + store>(arg0: &mut Policy, arg1: T1) {
        let v0 = 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_key_by_struct<T0>();
    ...
    public(friend) fun get_rule<T0, T1: drop + store>(arg0: &Policy) : &T1 {
        0x2::dynamic_field::borrow<0x1::string::String, T1>(&arg0.id, 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_key_by_struct<T0>())
    }

    public(friend) fun get_rule_mut<T0, T1: drop + store>(arg0: &mut Policy) : &mut T1 {
        0x2::dynamic_field::borrow_mut<0x1::string::String, T1>(&mut arg0.id, 0x7ec05d4d0c863d8e6e8a4cdda12a126f3d2bda1dede3ef8f149cefe301ef3c2e::utils::get_key_by_struct<T0>())
    }
