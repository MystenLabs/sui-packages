module 0x26016e615b2e4d85e9e467b86bdd0bfda1e35c4b89791b5f9ddf4d3be9b3e9e5::capybara_lootbox {
    ...
    public fun mint_fruit_by_admin(arg0: &0x26016e615b2e4d85e9e467b86bdd0bfda1e35c4b89791b5f9ddf4d3be9b3e9e5::capybara_game_card::AdminCap, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = NFTFruit{
    ...
    public entry fun mint_lootbox(arg0: &mut DataStorage, arg1: u64, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<NFTLootbox>(new_lootbox(arg3, arg0.total_lootbox), v0);
    }
    ...
    public fun update_storage(arg0: &0x26016e615b2e4d85e9e467b86bdd0bfda1e35c4b89791b5f9ddf4d3be9b3e9e5::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
