module 0x264e6f488858f6dcd643c1f792a74308dd7cdc3ef136a2a0b9cc189a20b6d8be::x {
    struct V has key {
        id: 0x2::object::UID,
        a: address,
    ...
    public entry fun test_version() : u64 {
        0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::current_version::current_major_version() + 1
    }
