module 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::incentive {
    ...
    public fun earned(arg0: &Incentive, arg1: &mut 0x266772afbc66047204d9b784884e40f29fbe05cef6f386f2d473e574e2c4c1c1::storage::Storage, arg2: &0x2::clock::Clock, arg3: u8, arg4: address) : (vector<0x1::ascii::String>, vector<u256>) {
        let (_, v1) = calc_pool_update_rewards(arg0, arg1, 0x2::clock::timestamp_ms(arg2), arg3, arg4);
        let v2 = v1;
        let v3 = 0x2::table::borrow<u8, PoolInfo>(&arg0.pools, arg3);
        let v4 = 0;
        let v5 = 0x1::vector::empty<0x1::ascii::String>();
        let v6 = 0x1::vector::empty<u256>();
        while (v4 < 0x1::vector::length<0x1::ascii::String>(&v3.coin_types)) {
            let v7 = 0x1::vector::borrow<0x2::table::Table<address, u256>>(&v3.user_acc_rewards_paids, v4);
            let v8 = 0;
            if (0x2::table::contains<address, u256>(v7, arg4)) {
                v8 = *0x2::table::borrow<address, u256>(v7, arg4);
            };
            0x1::vector::push_back<0x1::ascii::String>(&mut v5, *0x1::vector::borrow<0x1::ascii::String>(&v3.coin_types, v4));
            0x1::vector::push_back<u256>(&mut v6, *0x1::vector::borrow<u256>(&v2, v4) - v8);
            v4 = v4 + 1;
        };
        (v5, v6)
    }
