module 0x26d3b922340e0f38ae35a6f38342ad7700de6c851b90a8fcd7fbaaa08b06a2c3::global_config {
    ...
    public fun add_sponsor_record(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun add_sponsor_whitelist_address(arg0: &mut GlobalConfig, arg1: address) {
        ...
        if (!0x2::table::contains<address, bool>(&v0.whitelist, arg1)) {
            0x2::table::add<address, bool>(&mut v0.whitelist, arg1, true);
        };
    }

    public fun add_whitelist(arg0: &mut GlobalConfig, arg1: 0x2::object::ID, arg2: bool) {
        0x2::table::add<0x2::object::ID, bool>(&mut arg0.whitelist, arg1, arg2);
    }
    ...
    public fun generate_proof_as_trader(arg0: &mut GlobalConfig, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeCap, arg2: &0x2::tx_context::TxContext) : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof {
    ...
    entry fun init_sponsor_fee_record(arg0: &mut GlobalConfig, arg1: &mut 0x2::tx_context::TxContext) {
