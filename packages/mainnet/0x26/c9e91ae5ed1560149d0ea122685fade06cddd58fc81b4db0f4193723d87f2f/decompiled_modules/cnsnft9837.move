module 0x26c9e91ae5ed1560149d0ea122685fade06cddd58fc81b4db0f4193723d87f2f::cnsnft9837 {
    struct CNSNFT9837 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9837, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9406"));
        let v4 = 0x2::package::claim<CNSNFT9837>(arg0, arg1);
