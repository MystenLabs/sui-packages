module 0x2603077d65eec652e3b3847c4b2e8f948fa299fe0a1fc411238e749f4b8b970b::interfaces {
    ...
    public fun get_reward_pool_apy(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg2: u16, arg3: address, arg4: u16, arg5: &0x2::clock::Clock) : (u256, u256) {
        let v0 = if (arg2 == 3) {
            9
        } else if (arg4 == 8) {
            6
    ...
    public entry fun get_reward_pool_apys(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle, arg2: vector<u16>, arg3: vector<address>, arg4: vector<u16>, arg5: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<address>(&arg3)) {
            ...
            let (v3, v4) = get_reward_pool_apy(arg0, arg1, *0x1::vector::borrow<u16>(&arg2, v1), v2, *0x1::vector::borrow<u16>(&arg4, v1), arg5);
            let v5 = RewardPoolApy{
                reward_pool_info : v2,
                apy              : v3,
                total_value      : v4,
            };
            0x1::vector::push_back<RewardPoolApy>(&mut v0, v5);
            v1 = v1 + 1;
        };
        let v6 = RewardPoolApys{apys: v0};
        0x2::event::emit<RewardPoolApys>(v6);
    }
