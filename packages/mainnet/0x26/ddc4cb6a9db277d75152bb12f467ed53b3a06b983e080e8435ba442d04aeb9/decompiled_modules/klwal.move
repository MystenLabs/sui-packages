module 0x26ddc4cb6a9db277d75152bb12f467ed53b3a06b983e080e8435ba442d04aeb9::klwal {
    struct KLWAL has drop {
        dummy_field: bool,
    }

    fun init(arg0: KLWAL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x51e0ccce48f0763f98f1cb4856847c2e1531adacada99cdd7626ab999db57523::equity::create_treasury<KLWAL>(arg0, 6, b"klWAL", b"klWAL", b"Kai Leverage WAL Supply Pool LP Token", 0x1::option::none<0x2::url::Url>(), arg1);
