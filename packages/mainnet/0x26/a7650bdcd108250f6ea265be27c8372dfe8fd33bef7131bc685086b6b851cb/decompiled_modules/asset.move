module 0x26a7650bdcd108250f6ea265be27c8372dfe8fd33bef7131bc685086b6b851cb::asset {
    ...
    public(friend) fun new<T0>(arg0: 0x26a7650bdcd108250f6ea265be27c8372dfe8fd33bef7131bc685086b6b851cb::interest::InterestModel, arg1: BorrowConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
    ...
    public fun collateral_setting<T0>(arg0: &Asset<T0>) : &Collateral {
        ...
        assert!(0x1::option::is_some<Collateral>(v1), 0x26a7650bdcd108250f6ea265be27c8372dfe8fd33bef7131bc685086b6b851cb::error::asset_not_collateral());
    ...
    public(friend) fun enable_as_collateral<T0>(arg0: &mut Asset<T0>, arg1: Collateral) {
        let v0 = DFKey<Collateral>{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<DFKey<Collateral>, 0x1::option::Option<Collateral>>(&mut arg0.id, v0);
        assert!(0x1::option::is_none<Collateral>(v1), 0x26a7650bdcd108250f6ea265be27c8372dfe8fd33bef7131bc685086b6b851cb::error::asset_already_collateral());
    ...
    public fun interest_model<T0>(arg0: &Asset<T0>) : &0x26a7650bdcd108250f6ea265be27c8372dfe8fd33bef7131bc685086b6b851cb::interest::InterestModel {
        &arg0.interest_model
    }
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0x26a7650bdcd108250f6ea265be27c8372dfe8fd33bef7131bc685086b6b851cb::interest::InterestModel) {
