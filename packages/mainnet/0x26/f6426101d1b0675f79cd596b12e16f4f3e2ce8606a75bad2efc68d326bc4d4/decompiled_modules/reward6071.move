module 0x26f6426101d1b0675f79cd596b12e16f4f3e2ce8606a75bad2efc68d326bc4d4::reward6071 {
    struct REWARD6071 has drop {
        dummy_field: bool,
    }

    struct TICKET_6071 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6071(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6071>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6071>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6071, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6071>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6071>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6071>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6071>>(v5, 0x2::tx_context::sender(arg1));
    }
