module 0x2695b9a2c73c56f989da46af0845aee0f458aea0f79b4f8b77670e5fcdf78e2e::aqua {
    ...
    struct Vault<phantom T0> has key {
        ...
        total_shares: u64,
        current_strategy: u8,
        treasury_cap: 0x2::coin::TreasuryCap<AQUA>,
    }
    ...
    public fun admin_cancel_withdrawal(arg0: &KeeperCap, arg1: WithdrawalRequest) {
    ...
    public fun create_vault<T0>(arg0: 0x2::coin::TreasuryCap<AQUA>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
        ...
        let v1 = KeeperCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<KeeperCap>(v1, 0x2::tx_context::sender(arg1));
    }

    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<AQUA> {
        ...
        0x2::coin::mint<AQUA>(&mut arg0.treasury_cap, v5, arg2)
    }
    ...
    public fun fulfill_withdrawal<T0>(arg0: &KeeperCap, arg1: &mut Vault<T0>, arg2: WithdrawalRequest, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = arg1.total_shares + v2;
        let v6 = if (v5 == 0) {
            0x2::balance::value<T0>(&arg1.idle_balance)
        } else {
            (((v2 as u128) * (0x2::balance::value<T0>(&arg1.idle_balance) as u128) / (v5 as u128)) as u64)
        };
        assert!(v6 >= v3, 5);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.idle_balance, v6, arg3), v1);
    }
    ...
    fun init(arg0: AQUA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AQUA>(arg0, 6, b"aqUSDC", b"AquaYield USDC", b"Yield-bearing USDC receipt token. Deposit USDC, receive aqUSDC.", 0x1::option::none<0x2::url::Url>(), arg1);
    ...
    public fun request_withdrawal<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<AQUA>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::coin::burn<AQUA>(&mut arg0.treasury_cap, arg1);
        assert!(v1 > 0, 1);
        ...
        let v4 = WithdrawalRequestedEvent{
            request_id : 0x2::object::id<WithdrawalRequest>(&v3),
            user       : v0,
            shares     : v1,
            min_usdc   : arg2,
        };
        0x2::event::emit<WithdrawalRequestedEvent>(v4);
        0x2::transfer::share_object<WithdrawalRequest>(v3);
    }
