module 0x26eee2fd1b69b3e34330131765ed9c0c05203a29c761125d95224af95ef0128c::cnsnft7193 {
    struct CNSNFT7193 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7193, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5870"));
        let v4 = 0x2::package::claim<CNSNFT7193>(arg0, arg1);
