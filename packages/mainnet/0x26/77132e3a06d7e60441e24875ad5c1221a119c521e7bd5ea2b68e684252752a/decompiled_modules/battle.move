module 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::battle {
    ...
    fun choose_bot_move(arg0: &Battle, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : u8 {
        ...
        let v3 = 0;
        while (v3 < v0) {
            let v4 = bot_move_score(*0x1::vector::borrow<u8>(&arg0.p2_moves, v3), arg0.p2_growth, arg0.p1_growth, &arg0.p2_status, &arg0.p1_status);
            if (v4 > v1) {
                v2 = v4;
            };
            v3 = v3 + 1;
        ...
        v3 = 0;
        while (v3 < v0) {
            if (bot_move_score(*0x1::vector::borrow<u8>(&arg0.p2_moves, v3), arg0.p2_growth, arg0.p1_growth, &arg0.p2_status, &arg0.p1_status) == v2) {
                v5 = v5 + 1;
            };
            v3 = v3 + 1;
        };
        ...
        v3 = 0;
        while (v3 < v0) {
            let v8 = *0x1::vector::borrow<u8>(&arg0.p2_moves, v3);
            if (bot_move_score(v8, arg0.p2_growth, arg0.p1_growth, &arg0.p2_status, &arg0.p1_status) == v2) {
                if (v7 == 0x2::random::generate_u64(&mut v6) % v5) {
                    return v8
                };
                v7 = v7 + 1;
            };
