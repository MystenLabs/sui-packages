module 0x734b19fa1696dec30f8cae38f1cdbf0ab5a12720735f7c7b0d4935cab31732cc::vessel {
    ...
    struct VesselLighthouseEarned has copy, drop {
        vessel_id: address,
        lighthouse_count: u64,
        earned_at: u64,
    }
    ...
    public fun cap_vessel_id(arg0: &VesselCap) : 0x2::object::ID {
        arg0.vessel_id
    }
    ...
    public fun created_at(arg0: &Vessel) : u64 {
        arg0.created_at
    }
    ...
    public fun lighthouse_count(arg0: &Vessel) : u64 {
        arg0.lighthouse_count
    }
    ...
    public fun record_lighthouse(arg0: &mut Vessel, arg1: &VesselCap, arg2: &0x2::clock::Clock) {
        assert!(arg1.vessel_id == 0x2::object::id<Vessel>(arg0), 2);
        arg0.lighthouse_count = arg0.lighthouse_count + 1;
        let v0 = 0x2::object::id<Vessel>(arg0);
        let v1 = VesselLighthouseEarned{
            vessel_id        : 0x2::object::id_to_address(&v0),
            lighthouse_count : arg0.lighthouse_count,
            earned_at        : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<VesselLighthouseEarned>(v1);
    }
