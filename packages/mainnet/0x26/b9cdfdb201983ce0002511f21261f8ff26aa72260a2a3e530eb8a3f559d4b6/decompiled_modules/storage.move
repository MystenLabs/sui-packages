module 0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::storage {
    ...
    public entry fun init_reserve<T0>(arg0: &StorageAdminCap, arg1: &0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::pool::PoolAdminCap, arg2: &0x2::clock::Clock, arg3: &mut Storage, arg4: u8, arg5: bool, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: u256, arg16: u256, arg17: u256, arg18: &0x2::coin::CoinMetadata<T0>, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = ReserveData{
            ...
            current_supply_index  : 0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::ray_math::ray(),
            current_borrow_index  : 0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
        ...
        0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::pool::create_pool<T0>(arg1, 0x2::coin::get_decimals<T0>(arg18), arg19);
    }
    ...
    public entry fun version_migrate(arg0: &StorageAdminCap, arg1: &mut Storage) {
        assert!(arg1.version < 2, 43001);
        arg1.version = 2;
    }

    fun version_verification(arg0: &Storage) {
        assert!(arg0.version == 2, 43000);
    }

    public fun withdraw_treasury<T0>(arg0: &StorageAdminCap, arg1: &0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::pool::PoolAdminCap, arg2: &mut Storage, arg3: u8, arg4: &mut 0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::pool::Pool<T0>, arg5: u64, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::pool::unnormal_amount<T0>(arg4, (*v0 as u64));
        let v2 = arg5;
        if (arg5 < v1) {
            v2 = v1;
        };
        *v0 = *v0 - (v2 as u256);
        0x26b9cdfdb201983ce0002511f21261f8ff26aa72260a2a3e530eb8a3f559d4b6::pool::withdraw_reserve_balance<T0>(arg1, arg4, v2, arg6, arg7);
    }
