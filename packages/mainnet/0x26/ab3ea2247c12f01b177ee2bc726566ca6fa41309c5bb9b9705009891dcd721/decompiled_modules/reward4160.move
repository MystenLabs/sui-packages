module 0x26ab3ea2247c12f01b177ee2bc726566ca6fa41309c5bb9b9705009891dcd721::reward4160 {
    struct REWARD4160 has drop {
        dummy_field: bool,
    }

    struct TICKET_4160 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4160(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_4160>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4160, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4160>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4160>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4160>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4160>>(v5, 0x2::tx_context::sender(arg1));
    }
