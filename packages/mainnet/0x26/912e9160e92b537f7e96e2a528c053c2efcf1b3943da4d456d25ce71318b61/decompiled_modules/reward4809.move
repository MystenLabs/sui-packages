module 0x26912e9160e92b537f7e96e2a528c053c2efcf1b3943da4d456d25ce71318b61::reward4809 {
    struct REWARD4809 has drop {
        dummy_field: bool,
    }

    struct TICKET_4809 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4809(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4809>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4809>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4809, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4809>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4809>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4809>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4809>>(v5, 0x2::tx_context::sender(arg1));
    }
