module 0x2654bf37ada90547a1aea42b2a7a481fdca8951ed758fee6338cb2a827ab5d48::mystery_pack_by_ciaynosaurs {
    struct MYSTERY_PACK_BY_CIAYNOSAURS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MYSTERY_PACK_BY_CIAYNOSAURS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MYSTERY_PACK_BY_CIAYNOSAURS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Mystery Pack by CIaynosaurs"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Minting a mystery pack you can pull either an Escape Pack or a Legendary Pack."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://mZZxIcYVEovfgr-o5bxqoyBoD3CuoS7l22zfmJnIPHs"));
