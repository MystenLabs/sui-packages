module 0x26346e185003acbf732d373c60413cee41996a9fbdf8790ae1b7385f6a6a9b32::hsui_vault {
    struct HSuiVault has key {
        id: 0x2::object::UID,
        config_params: ConfigParams,
        hsui_kraft_cap: 0x2::coin::TreasuryCap<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>,
    ...
    fun calculate_staked_sui_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64) : u64 {
        0x26346e185003acbf732d373c60413cee41996a9fbdf8790ae1b7385f6a6a9b32::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(arg1), 0x3::staking_pool::staked_sui_amount(arg1), 0x3::staking_pool::stake_activation_epoch(arg1), arg2)
    }
    ...
    public fun claim_collected_fees(arg0: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveDaoCapability, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut HSuiVault, arg3: &mut 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::Treasury<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u128((0x2::balance::value<0x2::sui::SUI>(&arg2.hive_fee_vault) as u128), (arg2.config_params.treasury_percent as u128), (100000 as u128));
        if (v0 > 0) {
            ...
            0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::deposit_to_treasury<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(arg3, v2);
        };
    ...
    fun do_before_unstake(arg0: &mut HSuiVault, arg1: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        let v0 = 0;
    ...
    public fun emergency_pause_update(arg0: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveDaoCapability, arg1: &mut HSuiVault, arg2: bool) {
    ...
    public fun get_hsui_by_sui(arg0: &HSuiVault, arg1: u64) : u64 {
        ...
        (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((arg1 as u256), (arg0.hsui_supply as u256), (v0 as u256)) as u64)
    }
    ...
    fun get_split_amount(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &0x3::staking_pool::StakedSui, arg2: u64, arg3: u64) : (u64, u64, u64, u64) {
        ...
        let v3 = ((0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((1000000000 as u256) * (arg2 as u256), (v0 as u256), (v2 as u256)) / (1000000000 as u256)) as u64) + 1;
        let v4 = v0 - v3;
        if (v3 < 1000000000) {
    ...
    public fun get_sui_by_hsui(arg0: &HSuiVault, arg1: u64) : u64 {
        ...
        (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((v0 as u256), (arg1 as u256), (arg0.hsui_supply as u256)) as u64)
    }
    ...
    public fun get_sui_claimable_per_hsui(arg0: &HSuiVault) : u128 {
        ...
        (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((v0 as u256), (1000000000 as u256), (v1 as u256)) as u128)
    }

    public fun get_total_sui(arg0: &HSuiVault) : u64 {
        let v0 = 0x1::string::utf8(b"get_total_sui");
        0x1::debug::print<0x1::string::String>(&v0);
        let v1 = *0x2::linked_table::front<address, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.selected_validator_mapping);
        let v2 = 0;
        while (0x1::option::is_some<address>(&v1)) {
            let v3 = *0x1::option::borrow<address>(&v1);
            v2 = v2 + 0x2::balance::value<0x2::sui::SUI>(0x2::linked_table::borrow<address, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.selected_validator_mapping, v3));
            v1 = *0x2::linked_table::next<address, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.selected_validator_mapping, v3);
        };
        arg0.total_principal_staked + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_to_stake) + v2 + arg0.total_accrued_rewards - arg0.uncollected_protocol_fees - arg0.sui_to_unstake
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public fun init_hsui_vault(arg0: 0x2::coin::TreasuryCap<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ConfigParams{
            pause_stake           : false,
    ...
    public fun query_all_staked_sui_objs_for_pool(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &HSuiVault, arg2: address, arg3: 0x1::option::Option<u64>, arg4: u64, arg5: &0x2::tx_context::TxContext) : (vector<u64>, vector<u64>, vector<u64>, vector<u64>, u64) {
        ...
        while (0x1::option::is_some<u64>(&v6) && 0 < arg4) {
            ...
            0x1::vector::push_back<u64>(&mut v4, 0x26346e185003acbf732d373c60413cee41996a9fbdf8790ae1b7385f6a6a9b32::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(v8), v10, v9, 0x2::tx_context::epoch(arg5)));
    ...
    public fun query_request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        let v1 = 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u128((v0 as u128), (arg1.config_params.service_fee_percent as u128), (100000 as u128));
        (v0 - v1, v1, 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div(v1, arg1.config_params.protocol_fee_percent, 100000))
    }
    ...
    public fun query_staked_sui_obj_for_pool(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &HSuiVault, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        (v1, v2, 0x26346e185003acbf732d373c60413cee41996a9fbdf8790ae1b7385f6a6a9b32::helper::calculate_rewards(arg0, 0x3::staking_pool::pool_id(v0), v2, v1, 0x2::tx_context::epoch(arg4)))
    }
    ...
    public fun request_delayed_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: 0x2::balance::Balance<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>, arg3: &mut 0x2::tx_context::TxContext) : UnstakeRequest {
        assert!(arg1.version == 0, 9002);
        let v0 = 0x2::tx_context::epoch(arg3);
        update_calculated_accrued_rewards(arg0, arg1, arg3);
        let v1 = get_sui_by_hsui(arg1, 0x2::balance::value<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&arg2));
        ...
        let v4 = UnstakeRequest{
            ...
            hsui_amount        : 0x2::balance::value<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&arg2),
            sui_amount         : v1,
            requested_at_epoch : v0,
        };
        0x2::coin::burn<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&mut arg1.hsui_kraft_cap, 0x2::coin::from_balance<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(arg2, arg3));
        arg1.hsui_supply = 0x2::coin::total_supply<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&arg1.hsui_kraft_cap);
    ...
    public fun request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: 0x2::balance::Balance<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg1.version == 0, 9002);
        update_calculated_accrued_rewards(arg0, arg1, arg3);
        let v0 = get_sui_by_hsui(arg1, 0x2::balance::value<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&arg2));
        ...
        let v2 = 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u128((v0 as u128), (arg1.config_params.service_fee_percent as u128), (100000 as u128));
        let v3 = 0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div(v2, arg1.config_params.protocol_fee_percent, 100000);
        ...
        let v6 = UserUnstakedInstantly{
            ...
            hsui_burnt             : 0x2::balance::value<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&arg2),
    ...
    fun sort_vals_in_decreasing_order(arg0: &HSuiVault) : vector<address> {
        let v0 = 0x1::vector::empty<address>();
        let v1 = 0x1::vector::empty<u64>();
    ...
    public fun stake_sui_request(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI> {
        assert!(arg1.version == 0, 9002);
        ...
        0x2::coin::mint_balance<0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::hsui::HSUI>(&mut arg1.hsui_kraft_cap, v1)
    }
    ...
    public fun update_calculated_accrued_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut HSuiVault, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = (0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::math::mul_div_u256((v2 as u256), (arg1.config_params.protocol_fee_percent as u256), (100000 as u256)) as u64);
    ...
    public fun update_global_fee_config(arg0: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveDaoCapability, arg1: &mut HSuiVault, arg2: u64, arg3: u64, arg4: u64) {
        assert!(arg1.version == 0, 9002);
    ...
    public fun update_validator_list(arg0: &0x893914132732096938d72cbc7188a44d4c9bd8c8bcd1d45bd782891a51420301::config::HiveDaoCapability, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut HSuiVault, arg3: vector<address>, arg4: bool) {
