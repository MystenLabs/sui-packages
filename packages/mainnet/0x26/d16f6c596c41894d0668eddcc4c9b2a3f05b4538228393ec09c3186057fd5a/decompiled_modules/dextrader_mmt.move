module 0x17b6ad0fff80ff591bbf1083faf70193aa867c4004a6768be39dc66ae51a19f2::dextrader_mmt {
    ...
    struct WithdrawPosition has copy, drop {
        pool: 0x2::object::ID,
        position_id: 0x2::object::ID,
        recipient: address,
    }
    ...
    entry fun create_position_and_add_liquidity<T0, T1>(arg0: &mut State, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg2: u32, arg3: u32, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::from_u32(arg3);
        check_pool_ticks(arg0, v0, v1, v2);
        let v3 = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::open_position<T0, T1>(arg1, v1, v2, arg8, arg10);
        let v4 = CreatePosition{
            pool           : v0,
            position_id    : 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&v3),
            tick_lower_idx : arg2,
        ...
        let v6 = 0x2::coin::take<T0>(get_balance_mut<T0>(v5), arg4, arg10);
        let v7 = &mut arg0.balances;
        let (v8, v9) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::liquidity::add_liquidity<T0, T1>(arg1, &mut v3, v6, 0x2::coin::take<T1>(get_balance_mut<T1>(v7), arg5, arg10), arg6, arg7, arg9, arg8, arg10);
        merge_coins_into_balances<T0, T1>(arg0, v8, v9);
        0x2::transfer::public_transfer<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(v3, 0x2::object::uid_to_address(&arg0.id));
    }
    ...
    entry fun withdraw_position<T0, T1>(arg0: &mut State, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg2: 0x2::transfer::Receiving<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: &0x2::tx_context::TxContext) {
        check_version(arg0);
        check_operator(arg0, arg4);
        let v0 = 0x2::transfer::public_receive<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&mut arg0.id, arg2);
        let v1 = WithdrawPosition{
            pool        : check_pool_id<T0, T1>(arg0, arg1),
            position_id : 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(&v0),
            recipient   : arg0.token_holder,
        };
        0x2::event::emit<WithdrawPosition>(v1);
        0x2::transfer::public_transfer<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::position::Position>(v0, arg0.token_holder);
    }
