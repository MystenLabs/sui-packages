module 0x26cc4074aa2353938c4b2566e9ecb5d2e0959a17fad331607521a2545ab1156e::gem_miner {
    ...
    public entry fun hire_miners(arg0: &mut GameState, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (v1 == 0) {
            ...
            v1 / 864000 * calculate_reduction_multiplier(v2.current_withdrawn, v2.current_deposit) / 100
        };
