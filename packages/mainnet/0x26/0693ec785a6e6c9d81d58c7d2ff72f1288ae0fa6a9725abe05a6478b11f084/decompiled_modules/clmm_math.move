module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math {
    public fun compute_swap_step(arg0: u128, arg1: u128, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: bool) : (u64, u64, u128, u64) {
        ...
        let (v0, v1, v2, v3) = if (arg6) {
            ...
            let v10 = (v9 as u64);
            (v10, v1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_ceil(v10, arg4, 1000000 - arg4), v3)
        };
        (v0, v1, v3, v2)
    }
    ...
    public fun get_amount_by_liquidity(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: u128, arg4: u128, arg5: bool) : (u64, u64) {
        ...
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(arg0, arg1), 8);
    ...
    public fun get_delta_a(arg0: u128, arg1: u128, arg2: u128, arg3: bool) : u64 {
        ...
        let v3 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u256::div_round(v1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::full_mul(arg0, arg1), arg3);
    ...
    public fun get_delta_b(arg0: u128, arg1: u128, arg2: u128, arg3: bool) : u64 {
        ...
        if (arg3 && v1 & 18446744073709551615 > 0) {
            assert!((v1 >> 64) + 1 <= 18446744073709551615, 6);
            return (((v1 >> 64) + 1) as u64)
        };
        assert!(v1 >> 64 <= 18446744073709551615, 6);
        ((v1 >> 64) as u64)
    }
    ...
    public fun get_liquidity_by_amount(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: u128, arg4: u64, arg5: bool) : (u128, u64, u64) {
        let v0 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_sqrt_price_at_tick(arg0);
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_sqrt_price_at_tick(arg1);
        let v2 = 0;
        let v3 = 0;
        let v4 = if (arg5) {
            assert!(arg3 < v1, 3018);
            let v4 = if (arg3 <= v0) {
                get_liquidity_from_a(v0, v1, arg4, false)
            } else {
                let v5 = get_liquidity_from_a(arg3, v1, arg4, false);
                v3 = get_delta_b(arg3, v0, v5, true);
                v5
            };
            v2 = arg4;
            v4
            ...
            assert!(arg3 > v0, 3018);
            let v4 = if (arg3 >= v1) {
                get_liquidity_from_b(v0, v1, arg4, false)
            } else {
                let v6 = get_liquidity_from_b(v0, arg3, arg4, false);
                v2 = get_delta_a(arg3, v1, v6, true);
                v6
            };
            v3 = arg4;
            v4
    ...
    public fun get_liquidity_from_a(arg0: u128, arg1: u128, arg2: u64, arg3: bool) : u128 {
        ...
        assert!(arg0 <= 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price(), 4);
        assert!(arg1 <= 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price(), 4);
        let v1 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u256::div_round(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::full_mul(arg0, arg1) * (arg2 as u256), (v0 as u256) << 64, arg3);
        assert!(v1 <= 340282366920938463463374607431768211455, 7);
        (v1 as u128)
    }
    ...
    public fun get_liquidity_from_b(arg0: u128, arg1: u128, arg2: u64, arg3: bool) : u128 {
        ...
        let v1 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u256::div_round((arg2 as u256) << 64, (v0 as u256), arg3);
        assert!(v1 <= 340282366920938463463374607431768211455, 7);
        (v1 as u128)
    }
    ...
    public fun get_next_sqrt_price_a_up(arg0: u128, arg1: u128, arg2: u64, arg3: bool) : u128 {
        ...
        let v4 = if (arg3) {
            0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u256::div_round(v0, v2 + v3, true)
        } else {
            if (v2 <= v3) {
                abort 5
            };
        ...
        assert!(v4 >= (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price() as u256), 1);
        assert!(v4 <= (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price() as u256), 0);
        (v4 as u128)
    }
