module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::ACL,
        package_version: u64,
    }
    ...
    public fun acl(arg0: &GlobalConfig) : &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::Member> {
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun check_emergency_pause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::has_role(&arg0.acl, arg1, 6), 13);
    }

    public fun check_emergency_restore_version(arg0: &GlobalConfig) {
        assert!(arg0.package_version == 18446744073709551000, 12);
    }

    public fun check_emergency_unpause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::has_role(&arg0.acl, arg1, 5), 17);
    }

    public fun check_fee_tier_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::has_role(&arg0.acl, arg1, 1), 6);
    }

    public fun check_partner_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::has_role(&arg0.acl, arg1, 3), 7);
    }
    ...
    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::has_role(&arg0.acl, arg1, 2), 9);
    }

    public fun check_rewarder_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::has_role(&arg0.acl, arg1, 4), 8);
    }

    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(15 >= arg0.package_version, 10);
    }
    ...
    public fun emergency_pause(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, b"emergency_pause_before"), 15);
    ...
    public fun emergency_unpause(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        check_emergency_unpause_role(arg0, 0x2::tx_context::sender(arg2));
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, b"emergency_pause_before"), 14);
        assert!(arg1 >= 0x2::dynamic_field::remove<vector<u8>, u64>(&mut arg0.id, b"emergency_pause_before") && arg1 <= package_version(), 16);
    ...
    public fun update_package_version(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        ...
        assert!(arg2 > v0 && arg2 < 9223372036854775808, 16);
