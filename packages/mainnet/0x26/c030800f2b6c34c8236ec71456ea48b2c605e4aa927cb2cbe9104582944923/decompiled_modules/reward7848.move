module 0x26c030800f2b6c34c8236ec71456ea48b2c605e4aa927cb2cbe9104582944923::reward7848 {
    struct REWARD7848 has drop {
        dummy_field: bool,
    }

    struct TICKET_7848 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7848(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7848>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7848>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7848, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7848>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7848>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7848>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7848>>(v5, 0x2::tx_context::sender(arg1));
    }
