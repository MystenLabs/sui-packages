module 0x81a07c94eadc21f980b9ce3b9bf736fe76c862caa87034b0c224d7be72b544d2::scallop_adapter {
    ...
    public fun new_scallop_state<T0: drop>(arg0: &mut ScallopVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Scallop>, arg2: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation::Obligation, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (ScallopState, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Scallop, T0>) {
        ...
        if (0x1::vector::length<0x1::ascii::String>(&v3) > 0) {
            let v4 = 0x1::vector::pop_back<0x1::ascii::String>(&mut v3);
            abort *0x2::vec_map::get<0x1::ascii::String, u64>(&arg0.record.borrow, &v4)
        };
        let v5 = 0x2::vec_map::keys<0x1::ascii::String, u64>(&arg0.record.supply);
        while (0x1::vector::length<0x1::ascii::String>(&v5) > 0) {
            let v6 = 0x1::vector::pop_back<0x1::ascii::String>(&mut v5);
            let v7 = &mut v2.supply;
        ...
        while (0x1::vector::length<0x1::ascii::String>(&v8) > 0) {
            ...
            let v10 = &mut v2.collateral;
            add_amount(v10, v9, 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::floor(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul_u64(v1, *0x2::vec_map::get<0x1::ascii::String, u64>(&arg0.record.collateral, &v9))));
        };
