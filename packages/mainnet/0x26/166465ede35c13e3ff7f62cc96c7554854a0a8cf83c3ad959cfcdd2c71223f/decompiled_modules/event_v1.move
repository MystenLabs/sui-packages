module 0x26166465ede35c13e3ff7f62cc96c7554854a0a8cf83c3ad959cfcdd2c71223f::event_v1 {
    ...
    struct SwapEvent has copy, drop {
        pool_id: 0x2::object::ID,
        math: 0x26166465ede35c13e3ff7f62cc96c7554854a0a8cf83c3ad959cfcdd2c71223f::math_v1::PoolMath,
        x_to_y: bool,
        amount_in: u64,
        amount_out: u64,
        fee_amount: u64,
    ...
    public(friend) fun emit_swap_event(arg0: &0x2::object::UID, arg1: 0x26166465ede35c13e3ff7f62cc96c7554854a0a8cf83c3ad959cfcdd2c71223f::math_v1::PoolMath, arg2: bool, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = SwapEvent{
            pool_id    : *0x2::object::uid_as_inner(arg0),
            math       : arg1,
            x_to_y     : arg2,
