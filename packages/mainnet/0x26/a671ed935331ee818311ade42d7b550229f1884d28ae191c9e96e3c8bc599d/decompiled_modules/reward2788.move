module 0x26a671ed935331ee818311ade42d7b550229f1884d28ae191c9e96e3c8bc599d::reward2788 {
    struct REWARD2788 has drop {
        dummy_field: bool,
    }

    struct TICKET_2788 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2788(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2788>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2788>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2788, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2788>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2788>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2788>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2788>>(v5, 0x2::tx_context::sender(arg1));
    }
