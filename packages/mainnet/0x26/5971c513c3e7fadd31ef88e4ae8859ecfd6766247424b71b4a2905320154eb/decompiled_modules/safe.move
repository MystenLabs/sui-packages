module 0x265971c513c3e7fadd31ef88e4ae8859ecfd6766247424b71b4a2905320154eb::safe {
    ...
    public fun debit<T0>(arg0: &mut Safe<T0>, arg1: &mut TransferCapability<T0>, arg2: u64) : 0x2::balance::Balance<T0> {
