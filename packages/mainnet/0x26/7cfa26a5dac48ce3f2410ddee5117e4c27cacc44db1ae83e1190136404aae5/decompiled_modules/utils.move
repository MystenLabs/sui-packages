module 0x267cfa26a5dac48ce3f2410ddee5117e4c27cacc44db1ae83e1190136404aae5::utils {
    public fun get_description_nft() : vector<u8> {
        b"Akashi is the first unique collection of NFT with a story on the SUI blockchain."
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeie72sche4ug7pyuh6ydhqgcusnirk5gsnfzddsggftyaskkybhmei/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeig37xyt7n2doci5fytm64fnnp3cmcamxmz7ppd27itplka7ep373m/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/Sui_Akashi"
    }
