module 0x265d8e3f20bb7970c4b794ad884d3b8322d537707e1b2423e994a62f1df73fb6::reward3550 {
    struct REWARD3550 has drop {
        dummy_field: bool,
    }

    struct TICKET_3550 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3550(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3550>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3550>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3550, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3550>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3550>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3550>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3550>>(v5, 0x2::tx_context::sender(arg1));
    }
