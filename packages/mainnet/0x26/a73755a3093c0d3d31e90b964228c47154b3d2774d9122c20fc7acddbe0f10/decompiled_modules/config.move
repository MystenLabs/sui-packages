module 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config {
    ...
    struct GlobalConfig has key {
        ...
        package_version: u64,
        acl: 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::ACL,
    }
    ...
    public fun add_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        ...
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::add_role(&mut arg0.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun remove_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::remove_role(&mut arg0.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun check_operation_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::has_role(&arg0.acl, arg1, 1) || 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::has_role(&arg0.acl, arg1, 2), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::no_operation_manager_permission());
    }

    public fun check_oracle_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::has_role(&arg0.acl, arg1, 4), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::no_oracle_manager_permission());
    }

    public fun check_pool_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::has_role(&arg0.acl, arg1, 3), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::no_pool_manager_permission());
    }

    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::has_role(&arg0.acl, arg1, 0), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::no_protocol_fee_claim_permission());
    }

    public fun check_rebalance_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::has_role(&arg0.acl, arg1, 2), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::no_operation_manager_permission());
    }

    public fun check_reinvest_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::has_role(&arg0.acl, arg1, 1), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::no_operation_manager_permission());
    }

    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(1 >= arg0.package_version, 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::package_version_deprecate());
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            ...
            package_version         : 1,
            acl                     : 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::acl::new(arg0),
        };
    ...
    public entry fun update_package_version(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: u64) {
        ...
        assert!(arg2 > v0, 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::wrong_package_version());
    ...
    public fun update_protocol_fee_rate(arg0: &mut GlobalConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
        assert!(arg1 <= 2000, 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::invalid_protocol_fee_rate());
