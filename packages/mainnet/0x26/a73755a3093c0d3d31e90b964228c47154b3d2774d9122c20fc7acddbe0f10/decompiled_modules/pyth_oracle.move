module 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::pyth_oracle {
    ...
    public fun add_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::checked_package_version(arg1);
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg6));
        let v0 = 0x1::type_name::get<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::oracle_info_exists());
    ...
    public fun calculate_oracle_prices<T0, T1>(arg0: &PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::oracle_info_not_exists());
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v1), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::oracle_info_not_exists());
        ...
        assert!(v2.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::price_object_not_match_with_coin_type());
        assert!(v3.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::price_object_not_match_with_coin_type());
    ...
    public fun get_price<T0>(arg0: &PythOracle, arg1: &0x2::clock::Clock) : Price {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, v0), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::price_not_exists());
        let v1 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v0);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 == v1.last_update_time, 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::price_not_updated());
        v1
    }

    public fun get_price_by_type(arg0: &PythOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : Price {
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, arg1), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::price_not_exists());
        let v0 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, arg1);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 == v0.last_update_time, 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::price_not_updated());
        v0
    }
    ...
    public fun get_sqrt_price_from_oracle<T0, T1>(arg0: &PythOracle, arg1: &0x2::clock::Clock) : u128 {
        ...
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::utils::price_to_sqrt_price(v2, 10)
    }
    ...
    public fun pyth_price_from_oracle_info(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(arg1.price_feed_id == 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::invalid_price_feed_id());
        ...
        assert!(v5 != 0, 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::invalid_oracle_price());
    ...
    public fun remove_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::GlobalConfig, arg2: &0x2::tx_context::TxContext) {
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::checked_package_version(arg1);
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::oracle_info_not_exists());
    ...
    public(friend) fun split_fee(arg0: &mut PythOracle, arg1: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.update_price_fee) >= arg1, 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::update_price_fee_not_enough());
    ...
    public fun update_price_age<T0>(arg0: &mut PythOracle, arg1: &0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::GlobalConfig, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::checked_package_version(arg1);
        0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg3));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::oracle_info_not_exists());
    ...
    fun update_price_from_type<T0>(arg0: &mut PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : Price {
        ...
        assert!(v1.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 0x26a73755a3093c0d3d31e90b964228c47154b3d2774d9122c20fc7acddbe0f10::error::price_object_not_match_with_coin_type());
        let v2 = Price{
