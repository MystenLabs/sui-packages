module 0x26d014c86303164c313b91cf6833de2e855811df6204b513ee4b3fc858025e15::kriya_vampire_attack {
    ...
    struct KriyaLockdropForPool<phantom T0, phantom T1> has key {
        ...
        available_hive_tokens: 0x2::balance::Balance<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>,
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut KriyaLockdropForPool<T0, T1>, arg2: &KriyaAttackConfig, arg3: 0x2::coin::Coin<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
        assert!(arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window > 0x2::clock::timestamp_ms(arg0), 9803);
        let v0 = 0x2::coin::into_balance<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(arg3);
        0x2::balance::join<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(&mut arg1.available_hive_tokens, 0x2::balance::split<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(&mut v0, arg4));
        ...
        0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::coin_helper::destroy_or_transfer_balance<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(v0, 0x2::tx_context::sender(arg5), arg5);
    ...
    fun allowed_withdrawal_amount(arg0: &KriyaAttackConfig, arg1: u64, arg2: u64) : u64 {
        ...
        if (arg1 < v2) {
            (0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::math::mul_div_u256(((arg2 / 2) as u256), ((v2 - arg1) as u256), ((v2 - v1) as u256)) as u64)
        } else {
            0
        }
    }
    ...
    fun calculate_hive_rewards(arg0: u128, arg1: u128, arg2: u64) : u64 {
        if (arg1 == 0) {
            ...
            (0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::math::mul_div_u256((arg2 as u256), (arg0 as u256), (arg1 as u256)) as u64)
        }
    }

    fun calculate_weighted_units(arg0: u128, arg1: u64, arg2: &KriyaAttackConfig) : u128 {
        (((arg0 as u256) * ((1000000000 as u256) + 0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::math::mul_div_u256(((arg1 - 1) as u256) * (arg2.weekly_multiplier as u256), (1000000000 as u256), (arg2.weekly_divider as u256)))) as u128)
    }

    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &KriyaLockdropForPool<T0, T1>, arg4: &mut 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::HiveProfile, arg5: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, u128, u128) {
        ...
        if (!0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::exists_for_profile(arg4, 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap))) {
        ...
        } = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::remove_app_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg5);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, v6, v7)
    }

    public fun does_user_have_position<T0, T1>(arg0: &0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : bool {
        0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::exists_for_profile(arg0, 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap))
    }

    public fun extract_liquidity_from_kriya<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u128, u8, u128, u64, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>) {
        assert!(0x2::clock::timestamp_ms(arg0) > arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9813);
        ...
        (arg3.total_lp_locked, arg3.precision, arg3.total_weighted_units, arg3.total_hive_incentives, v1, v2, 0x2::balance::withdraw_all<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(&mut arg3.available_hive_tokens))
    }

    public fun get_user_position<T0, T1>(arg0: &0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u128, u64) {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u64>();
        let v2 = 0x1::vector::empty<u128>();
        let v3 = 0x1::vector::empty<bool>();
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap);
        if (!0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::exists_for_profile(arg0, v5)) {
            return (0x1::vector::empty<u64>(), v0, v1, v2, v3, v4, 0, 0)
        };
        let v6 = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::borrow_from_profile<UserKriyaHivePosition>(arg0, v5);
        let v7 = 0;
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::config::HiveEntryCap, arg2: 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::HiveAppAccessCapability, arg3: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg4: &mut KriyaAttackConfig, arg5: 0x1::string::String, arg6: u8, arg7: 0x2::coin::Coin<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : address {
        let v0 = 0x2::coin::into_balance<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(arg7);
        ...
        let v4 = KriyaLockdropForPool<T0, T1>{
            ...
            available_hive_tokens   : 0x2::balance::split<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(&mut v0, arg8),
        ...
        0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::coin_helper::destroy_or_transfer_balance<0xe31ae103194e7a1a8218b3ac9d1accb88993f706533a323fe7c79e36defc252::hive::HIVE>(v0, 0x2::tx_context::sender(arg9), arg9);
    ...
    public entry fun initialize_kriya_attack_config(arg0: &0x2::clock::Clock, arg1: &0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
    ...
    public entry fun lock_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::HiveProfile, arg5: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_profile_meta_info(arg4);
        ...
        let v5 = if (0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::exists_for_profile(arg4, 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap))) {
            0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::remove_app_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg8)
        } else {
        ...
        let v7 = arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window + arg7 * 0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::constants::week_multiplier();
        ...
        0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::add_app_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg8);
    ...
    public fun simulate_withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &KriyaAttackConfig, arg2: &KriyaLockdropForPool<T0, T1>, arg3: &0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::HiveProfile, arg4: u128, arg5: u64) : (u64, u64, bool) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        if (v0 < arg1.init_timestamp || v0 > arg1.init_timestamp + arg1.deposit_window + arg1.withdrawal_window) {
            return (0, 0, false)
        };
        let v1 = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_hive_app_name(&arg2.user_profile_access_cap);
        if (!0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::exists_for_profile(arg3, v1)) {
            return (0, 0, false)
        };
        let v2 = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::borrow_from_profile<UserKriyaHivePosition>(arg3, v1);
    ...
    public entry fun withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x526fcd8e26368a0f1eb1b30e2830150a9fd5026edf6a3df117a9af1a7eac7752::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::HiveProfile, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x1::string::String, u8) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_profile_meta_info(arg4);
        assert!(v0 >= arg2.init_timestamp, 9804);
        assert!(v0 < arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9811);
        assert!(0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::exists_for_profile(arg4, 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap)), 9808);
        let v5 = 0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::remove_app_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg7);
        ...
        0xdaa92b45136039414845606e44e029fb5df2714797919d18a834bd5cd771839c::hive_profile::add_app_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg7);
