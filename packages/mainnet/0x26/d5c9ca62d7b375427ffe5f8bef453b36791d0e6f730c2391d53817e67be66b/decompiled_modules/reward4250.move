module 0x26d5c9ca62d7b375427ffe5f8bef453b36791d0e6f730c2391d53817e67be66b::reward4250 {
    struct REWARD4250 has drop {
        dummy_field: bool,
    }

    struct TICKET_4250 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4250(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4250>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4250>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4250, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4250>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4250>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4250>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4250>>(v5, 0x2::tx_context::sender(arg1));
    }
