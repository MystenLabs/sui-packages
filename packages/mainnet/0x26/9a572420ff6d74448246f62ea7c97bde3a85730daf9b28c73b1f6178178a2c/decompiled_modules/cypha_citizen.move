module 0x3c89d9cfbde3ef6898014a718dee6fe676b390016d796eba194b7a9d74dd83b9::cypha_citizen {
    ...
    public fun mint_pass_v2<T0>(arg0: &mut Registry, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::string::String, arg3: 0x1::option::Option<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&arg1) >= 0x2::dynamic_field::borrow<AcceptedPaymentCoinKey<T0>, AcceptedPaymentCoinValue>(&arg0.id, v1).amount, 6);
        ...
        let v2 = 0x1::string::length(&arg2);
        assert!(v2 >= 3 && v2 <= 64, 1);
        let v3 = 0x1::option::none<address>();
        if (0x1::option::is_some<0x1::string::String>(&arg3)) {
            let v4 = *0x1::option::borrow<0x1::string::String>(&arg3);
            assert!(0x2::table::contains<0x1::string::String, address>(&arg0.referral_book.code_to_owner, v4), 8);
            let v5 = *0x2::table::borrow<0x1::string::String, address>(&arg0.referral_book.code_to_owner, v4);
            if (!0x2::table::contains<address, u64>(&arg0.referral_book.invite_counts, v5)) {
                0x2::table::add<address, u64>(&mut arg0.referral_book.invite_counts, v5, 0);
            };
            *0x2::table::borrow_mut<address, u64>(&mut arg0.referral_book.invite_counts, v5) = *0x2::table::borrow<address, u64>(&arg0.referral_book.invite_counts, v5) + 1;
        ...
        let v6 = 0x1::string::utf8(b"Citizen Pass #");
        0x1::string::append(&mut v6, 0x1::u128::to_string(arg0.sequence_number));
        ...
        0x2::transfer::transfer<CitizenPass>(v8, v0);
        let v9 = CitizenPassMintedEvent{
            pass_id       : 0x2::object::id<CitizenPass>(&v8),
            owner         : v0,
            invited_by    : arg3,
            referral_code : arg2,
            minted_by     : v0,
        ...
        0x2::event::emit<CitizenPassMintedEvent>(v9);
    }
