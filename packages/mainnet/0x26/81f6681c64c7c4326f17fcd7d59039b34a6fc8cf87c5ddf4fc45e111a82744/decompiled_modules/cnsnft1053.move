module 0x2681f6681c64c7c4326f17fcd7d59039b34a6fc8cf87c5ddf4fc45e111a82744::cnsnft1053 {
    struct CNSNFT1053 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1053, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1053>(arg0, arg1);
