module 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft {
    ...
    public entry fun mint_rwa_nft(arg0: &RWAAdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x1::option::Option<vector<u8>>, arg5: 0x1::option::Option<vector<u8>>, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: 0x1::option::Option<0x2::object::ID>, arg9: u64, arg10: vector<u8>, arg11: vector<u8>, arg12: vector<u8>, arg13: address, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = 0x2::url::inner_url(&v12.image_url);
        let v14 = RWANFTMinted{
            nft_id        : 0x2::object::uid_to_inner(&v0),
            creator       : 0x2::tx_context::sender(arg14),
            name          : 0x1::string::substring(&v7, 0, 0x1::string::length(&v7)),
            description   : v8,
            image_url     : 0x1::string::utf8(*0x1::ascii::as_bytes(&v13)),
            asset_id      : 0x1::string::substring(&v9, 0, 0x1::string::length(&v9)),
            category      : 0x1::string::substring(&v10, 0, 0x1::string::length(&v10)),
            collection_id : v3,
        };
        0x2::event::emit<RWANFTMinted>(v14);
        0x2::transfer::public_transfer<RWAToken>(v12, arg13);
    }

    public entry fun mint_rwa_nft_for_collection(arg0: &RWAAdminCap, arg1: &mut Collection, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: 0x1::option::Option<vector<u8>>, arg6: 0x1::option::Option<vector<u8>>, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: vector<u8>, arg10: vector<u8>, arg11: vector<u8>, arg12: address, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg13) == arg0.authorized_minter, 0);
        assert!(0x1::vector::length<vector<u8>>(&arg7) == 0x1::vector::length<vector<u8>>(&arg8), 1);
        if (0x1::option::is_some<u64>(&arg1.max_supply)) {
            assert!(arg1.current_supply < *0x1::option::borrow<u64>(&arg1.max_supply), 2);
        };
        let v0 = 0x2::object::new(arg13);
        let v1 = 0x2::object::uid_to_inner(&arg1.id);
        let v2 = arg1.royalty_percentage;
        assert!(v2 <= 2500, 5);
        let v3 = 0x1::vector::empty<Attribute>();
        0x1::vector::reverse<vector<u8>>(&mut arg7);
        0x1::vector::reverse<vector<u8>>(&mut arg8);
        while (!0x1::vector::is_empty<vector<u8>>(&arg7)) {
            let v4 = Attribute{
                name  : 0x1::string::utf8(0x1::vector::pop_back<vector<u8>>(&mut arg7)),
                value : 0x1::string::utf8(0x1::vector::pop_back<vector<u8>>(&mut arg8)),
            };
            0x1::vector::push_back<Attribute>(&mut v3, v4);
        };
        ...
        let v6 = if (0x1::option::is_some<vector<u8>>(&arg6)) {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(0x1::option::extract<vector<u8>>(&mut arg6)))
        } else {
            0x1::option::none<0x2::url::Url>()
        };
        let v7 = 0x1::string::utf8(arg2);
        let v8 = 0x1::string::utf8(arg3);
        let v9 = 0x1::string::utf8(arg9);
        let v10 = 0x1::string::utf8(arg10);
        let v11 = RWAVerification{
            asset_id     : v9,
            category     : v10,
        ...
        let v12 = RWAToken{
            ...
            external_url       : v6,
            attributes         : v3,
            collection_id      : 0x1::option::some<0x2::object::ID>(v1),
            creator            : arg1.creator,
            royalty_percentage : v2,
            edition_number     : 0x1::option::some<u64>(arg1.current_supply + 1),
        ...
        let v14 = RWANFTMinted{
            ...
            creator       : arg1.creator,
            name          : 0x1::string::substring(&v7, 0, 0x1::string::length(&v7)),
            description   : 0x1::string::substring(&v8, 0, 0x1::string::length(&v8)),
            image_url     : 0x1::string::utf8(*0x1::ascii::as_bytes(&v13)),
            asset_id      : 0x1::string::substring(&v9, 0, 0x1::string::length(&v9)),
            category      : 0x1::string::substring(&v10, 0, 0x1::string::length(&v10)),
            collection_id : 0x1::option::some<0x2::object::ID>(v1),
        ...
        0x2::event::emit<RWANFTMinted>(v14);
        0x2::transfer::public_transfer<RWAToken>(v12, arg12);
    }
    ...
    public entry fun mint_rwa_nft_simple(arg0: &RWAAdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x1::option::Option<vector<u8>>, arg5: 0x1::option::Option<vector<u8>>, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: u64, arg9: vector<u8>, arg10: vector<u8>, arg11: vector<u8>, arg12: address, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        let v12 = 0x2::url::inner_url(&v11.image_url);
        let v13 = RWANFTMinted{
            nft_id        : 0x2::object::uid_to_inner(&v0),
            creator       : 0x2::tx_context::sender(arg13),
            name          : 0x1::string::substring(&v6, 0, 0x1::string::length(&v6)),
            description   : v7,
            image_url     : 0x1::string::utf8(*0x1::ascii::as_bytes(&v12)),
