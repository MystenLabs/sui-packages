module 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::marketplace {
    ...
    public entry fun buy_nft(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v1;
        let v7 = 0x2::dynamic_field::remove<vector<u8>, 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::RWAToken>(&mut v6, b"nft");
        assert!(!0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::is_nft_frozen(&v7), 8);
        let (v8, v9) = 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::get_creator_info(&v7);
        ...
        0x2::transfer::public_transfer<0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::RWAToken>(v7, v0);
    ...
    public entry fun delist_nft(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::tx_context::sender(arg2) == v0, 9);
        let Listing {
            id        : v1,
            nft_id    : _,
            seller    : _,
        ...
        let v6 = v1;
        0x2::transfer::public_transfer<0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::RWAToken>(0x2::dynamic_field::remove<vector<u8>, 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::RWAToken>(&mut v6, b"nft"), v0);
        let v7 = NFTDelisted{
            marketplace_id : 0x2::object::uid_to_inner(&arg0.id),
            listing_id     : 0x2::object::uid_to_inner(&v6),
            nft_id         : arg1,
    ...
    public entry fun list_nft(arg0: &mut Marketplace, arg1: 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::RWAToken, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_frozen, 4);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(!0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::is_nft_frozen(&arg1), 8);
        let v1 = 0x2::object::id<0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::RWAToken>(&arg1);
        assert!(!0x2::table::contains<0x2::object::ID, Listing>(&arg0.listings, v1), 6);
        let v2 = 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::get_rwa_verification(&arg1);
        ...
        0x2::dynamic_field::add<vector<u8>, 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::RWAToken>(&mut v4.id, b"nft", arg1);
        ...
        let v5 = NFTListed{
            ...
            seller         : v0,
            price          : arg2,
            name           : 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::get_name(&arg1),
            description    : 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::get_description(&arg1),
            image_url      : 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::get_image_url(&arg1),
            asset_id       : 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::get_asset_id(v2),
            category       : 0xc104f0c01aeddc90cb5e01f4dd2f862ce790c34a5026cb80f94af93efca91589::nft::get_category(v2),
        };
