module 0xc1903c5e337aba61efccb39a7abdb156c775a39c1cbdb26f1e0f0e9f60a0b9d9::mermaid {
    ...
    struct Mermaid has store, key {
        ...
        number: u64,
        attributes: 0xc1903c5e337aba61efccb39a7abdb156c775a39c1cbdb26f1e0f0e9f60a0b9d9::attributes::Attributes,
    }
    ...
    fun init(arg0: MERMAID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xc1903c5e337aba61efccb39a7abdb156c775a39c1cbdb26f1e0f0e9f60a0b9d9::collection::display(&v4, arg1);
        ...
        0x2::transfer::public_share_object<0xc1903c5e337aba61efccb39a7abdb156c775a39c1cbdb26f1e0f0e9f60a0b9d9::collection::Collection>(0xc1903c5e337aba61efccb39a7abdb156c775a39c1cbdb26f1e0f0e9f60a0b9d9::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: u64, arg1: vector<0x1::ascii::String>, arg2: vector<0x1::ascii::String>, arg3: &mut 0x2::tx_context::TxContext) : Mermaid {
        let v0 = Mermaid{
            ...
            image_url   : 0x2::url::new_unsafe_from_bytes(b"https://bafybeie3uvtc4uciiczvpzez4rgfzg7jrmqwsatghlgphejzouaflogacm.ipfs.nftstorage.link"),
            project_url : 0x2::url::new_unsafe_from_bytes(b"https://atlansui.xyz"),
            number      : arg0,
            attributes  : 0xc1903c5e337aba61efccb39a7abdb156c775a39c1cbdb26f1e0f0e9f60a0b9d9::attributes::new_from_vec(arg1, arg2),
        };
    ...
    public(friend) fun mint_special_nft(arg0: u64, arg1: vector<u8>, arg2: vector<0x1::ascii::String>, arg3: vector<0x1::ascii::String>, arg4: &mut 0x2::tx_context::TxContext) : Mermaid {
        let v0 = Mermaid{
            ...
            project_url : 0x2::url::new_unsafe_from_bytes(b"https://atlansui.xyz/"),
            number      : arg0,
            attributes  : 0xc1903c5e337aba61efccb39a7abdb156c775a39c1cbdb26f1e0f0e9f60a0b9d9::attributes::new_from_vec(arg2, arg3),
        };
        let v1 = MermaidMintedEvent{
            id     : 0x2::object::id<Mermaid>(&v0),
            number : arg0,
