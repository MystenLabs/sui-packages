module 0xc1c141cd608b7d8a329893caf25d943824fa42b565894895f8c9102c47078008::cnsnft7654 {
    struct CNSNFT7654 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7654, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7654>(arg0, arg1);
