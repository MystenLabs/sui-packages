module 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::bonding_curve {
    ...
    fun swap<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: u64, arg5: bool, arg6: bool, arg7: u128, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        assert!(arg1.status == 1, 3);
        let (v0, v1, v2, v3) = if (arg5) {
            let (v4, v5, v6, v7) = if (arg6) {
                0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::math::buy(arg1.current_sqrt_price, arg1.end_sqrt_price, arg1.liquidity, arg4, 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::swap_fee_rate(arg0), true)
            } else {
                0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::math::buy(arg1.current_sqrt_price, arg1.end_sqrt_price, arg1.liquidity, arg4, 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::swap_fee_rate(arg0), false)
            };
            (v5, v6, v7, v4)
        } else {
            let (v8, v9, v10, v11) = if (arg6) {
                0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::math::sell(arg1.current_sqrt_price, arg1.start_sqrt_price, arg1.liquidity, arg4, 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::swap_fee_rate(arg0), true)
            } else {
                0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::math::sell(arg1.current_sqrt_price, arg1.start_sqrt_price, arg1.liquidity, arg4, 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::swap_fee_rate(arg0), false)
            };
            (v9, v10, v11, v8)
        };
    ...
    public fun burn_lp<T0, T1, T2>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T2>, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &mut 0x2::tx_context::TxContext) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        ...
        let v2 = if (0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::is_protocol_owned_lp(arg0)) {
    ...
    public fun claim_clmm_fee<T0, T1, T2>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg2: &mut BondingCurve<T0>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::check_acl_manager_role(arg0, 0x2::tx_context::sender(arg5));
    ...
    public fun claim_swap_fee<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::check_acl_manager_role(arg0, 0x2::tx_context::sender(arg2));
    ...
    public fun migrate_liquidity_to_clmm<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurves, arg2: &mut BondingCurve<T0>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg5: &0x2::coin::CoinMetadata<T0>, arg6: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        if (arg2.status != 2) {
            return
        };
    ...
    public fun start_bonding_curve<T0, T1>(arg0: &mut 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurves, arg2: BondingCurveStartCap<T0>, arg3: &mut BondingCurve<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::init_fee<T1>(arg0);
        assert!(0x2::coin::value<T1>(&arg4) == v7, 0);
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::receive_fee<T1>(arg0, 0x2::coin::into_balance<T1>(arg4));
        let (v8, v9, v10, v11) = 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::bonding_curve_config(arg0);
        ...
        let (v13, v14) = 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::math::get_init_liquidity_from_sui(v8, v9, v10);
        assert!(v11 >= v14, 5);
    ...
    public fun swap_exact_input_meme<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        let v0 = 0x2::coin::zero<0x2::sui::SUI>(arg6);
        swap<T0>(arg0, arg1, arg2, v0, arg3, false, true, arg4, arg5, arg6)
    }

    public fun swap_exact_input_sui<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        let v0 = 0x2::coin::zero<T0>(arg6);
        swap<T0>(arg0, arg1, v0, arg2, arg3, true, true, arg4, arg5, arg6)
    }

    public fun swap_exact_output_meme<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        let v0 = 0x2::coin::zero<T0>(arg6);
        swap<T0>(arg0, arg1, v0, arg2, arg3, true, false, arg4, arg5, arg6)
    }

    public fun swap_exact_output_sui<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        let v0 = 0x2::coin::zero<0x2::sui::SUI>(arg6);
    ...
    public fun update_url_by_creator<T0, T1>(arg0: &mut 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x1::ascii::String, arg3: &mut 0x2::coin::Coin<T1>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        assert!(0x2::tx_context::sender(arg5) == arg1.creator, 8);
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::check_url_update_flag(arg0, arg1.status);
        let (v0, _) = verify_internal(arg0, 0x1::ascii::into_bytes(arg2), &arg4);
        assert!(v0, 7);
        if (arg1.status == 1) {
            0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::receive_fee<T1>(arg0, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(arg3, 0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::update_fee<T1>(arg0), arg5)));
        };
        update_url<T0>(arg1, arg2);
    }

    public fun update_url_by_manager<T0>(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x1::ascii::String, arg3: &0x2::tx_context::TxContext) {
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::checked_package_version(arg0);
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::check_acl_manager_role(arg0, 0x2::tx_context::sender(arg3));
        update_url<T0>(arg1, arg2);
    }

    fun verify_internal(arg0: &0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::GlobalConfig, arg1: vector<u8>, arg2: &0x1::string::String) : (bool, address) {
        let (v0, v1, v2, v3) = parse_signature(0x2::hex::decode(*0x1::string::as_bytes(arg2)));
        let v4 = v2;
        let v5 = v1;
        0xc1ce68a7f77ebac04addf7cab80da8d8d3cb821122ef9f916cd5865674db7d4c::config::check_acl_upload_role(arg0, v0);
        let v6 = if (v3 == 0) {
