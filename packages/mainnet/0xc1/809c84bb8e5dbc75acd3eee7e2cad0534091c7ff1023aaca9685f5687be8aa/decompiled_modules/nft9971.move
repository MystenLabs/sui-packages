module 0xc1809c84bb8e5dbc75acd3eee7e2cad0534091c7ff1023aaca9685f5687be8aa::nft9971 {
    struct NFT9971 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT9971, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<NFT9971>(arg0, arg1);
