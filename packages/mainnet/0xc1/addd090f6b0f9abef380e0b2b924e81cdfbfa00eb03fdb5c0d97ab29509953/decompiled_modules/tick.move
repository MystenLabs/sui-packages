module 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::tick {
    ...
    fun compute_reward_growths(arg0: vector<u128>, arg1: vector<u128>) : vector<u128> {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg0)) {
            ...
            0x1::vector::push_back<u128>(&mut v1, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(*0x1::vector::borrow<u128>(&arg0, v0), v2));
            v0 = v0 + 1;
        };
        v1
    }
    ...
    public fun create_tick(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32) : TickInfo {
        TickInfo{
            index                          : arg0,
            sqrt_price                     : 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::tick_math::get_sqrt_price_at_tick(arg0),
            liquidity_gross                : 0,
    ...
    public(friend) fun cross(arg0: &mut TickManager, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: u128, arg3: u128, arg4: vector<u128>, arg5: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i64::I64, arg6: u256, arg7: u64) : 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::I128 {
        ...
        v0.fee_growth_outside_a = 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg2, v0.fee_growth_outside_a);
        v0.fee_growth_outside_b = 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg3, v0.fee_growth_outside_b);
        ...
        v0.tick_cumulative_out_side = 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i64H::sub(arg5, v0.tick_cumulative_out_side);
    ...
    public fun fetch_provided_ticks(arg0: &TickManager, arg1: vector<u32>) : vector<TickInfo> {
        ...
        while (v0 < 0x1::vector::length<u32>(&arg1)) {
            ...
            if (is_tick_initialized(arg0, v2)) {
                0x1::vector::push_back<TickInfo>(&mut v1, *get_tick_from_manager(arg0, v2));
            };
            v0 = v0 + 1;
        };
        v1
    ...
    public fun get_fee_and_reward_growths_inside(arg0: &TickManager, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg4: u128, arg5: u128, arg6: vector<u128>) : (u128, u128, vector<u128>) {
        ...
        let v6 = 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg3);
        let (v7, v8, v9) = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::gte(v6, 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg1))) {
            (v0, v1, v2)
        } else {
            (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg4, v0), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg5, v1), compute_reward_growths(arg6, v2))
        };
        let (v10, v11, v12) = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lt(v6, 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg2))) {
            (v3, v4, v5)
        } else {
            (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg4, v3), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg5, v4), compute_reward_growths(arg6, v5))
        };
        (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg4, v7), v10), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::math_u128::wrapping_sub(arg5, v8), v11), compute_reward_growths(compute_reward_growths(arg6, v9), v12))
    }
    ...
    public(friend) fun update(arg0: &mut TickManager, arg1: 0x2::object::ID, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg4: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i128::I128, arg5: u128, arg6: u128, arg7: vector<u128>, arg8: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i64::I64, arg9: u256, arg10: u64, arg11: bool) : bool {
        let v0 = &mut arg0.ticks;
        let v1 = get_mutable_tick_from_table(v0, arg2);
        let v2 = v1.liquidity_gross;
        let v3 = 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::utils::add_delta(v2, arg4);
        if (v2 == 0) {
            if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lte(0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg2), 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg3))) {
                v1.fee_growth_outside_a = arg5;
                v1.fee_growth_outside_b = arg6;
                v1.seconds_per_liquidity_out_side = arg9;
                v1.tick_cumulative_out_side = arg8;
                v1.seconds_out_side = arg10;
                v1.reward_growths_outside = arg7;
            } else {
                let v4 = 0;
        ...
        let v5 = if (arg11) {
            0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i128H::sub(v1.liquidity_net, arg4)
        } else {
            0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i128H::add(v1.liquidity_net, arg4)
        };
        v1.liquidity_net = v5;
        v3 == 0 != v2 == 0
    }
