module 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::oracle {
    ...
    public fun binary_search(arg0: &ObservationManager, arg1: u64) : (Observation, Observation) {
        ...
        loop {
            let v4 = (v0 + v1) / 2;
            v3 = get_observation(arg0, v4 % arg0.observation_cardinality);
            if (!v3.initialized) {
                v0 = v4 + 1;
                continue
            };
            v2 = get_observation(arg0, (v4 + 1) % arg0.observation_cardinality);
            if (v3.timestamp <= arg1 && arg1 <= v2.timestamp) {
                break
            };
            if (v3.timestamp < arg1) {
                v0 = v4 + 1;
                continue
            };
            v1 = v4 - 1;
    ...
    fun get_observation(arg0: &ObservationManager, arg1: u64) : Observation {
        if (arg1 < 0x1::vector::length<Observation>(&arg0.observations)) {
    ...
    public fun get_surrounding_observations(arg0: &ObservationManager, arg1: u64, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: u128) : (Observation, Observation) {
        ...
        assert!(v0.timestamp <= arg1, 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::errors::invalid_observation_timestamp());
    ...
    public(friend) fun grow(arg0: &mut ObservationManager, arg1: u64) : (u64, u64) {
        ...
        arg0.observation_cardinality_next = 0x1::u64::max(v0, arg1);
    ...
    public fun initialized(arg0: &Observation) : bool {
        arg0.initialized
    }

    public fun observation_cardinality(arg0: &ObservationManager) : u64 {
        arg0.observation_cardinality
    }

    public fun observation_cardinality_next(arg0: &ObservationManager) : u64 {
        arg0.observation_cardinality_next
    }

    public fun observation_index(arg0: &ObservationManager) : u64 {
        arg0.observation_index
    }

    public fun observations_length(arg0: &ObservationManager) : u64 {
    ...
    public fun observe_single(arg0: &ObservationManager, arg1: u64, arg2: u64, arg3: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg4: u128) : (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i64::I64, u256) {
        ...
        if (v2 == v6.timestamp) {
            ...
            (0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i64H::lib_to_mate(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::add(0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i64H::mate_to_lib(v6.tick_cumulative), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::mul(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::div(0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i64H::mate_to_lib(0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i64H::sub(v5.tick_cumulative, v6.tick_cumulative)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::from(v9)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::from(v10)))), v6.seconds_per_liquidity_cumulative + (v5.seconds_per_liquidity_cumulative - v6.seconds_per_liquidity_cumulative) * (v10 as u256) / (v9 as u256))
        }
    }
    ...
    public fun tick_cumulative(arg0: &Observation) : 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i64::I64 {
        arg0.tick_cumulative
    }

    public fun timestamp(arg0: &Observation) : u64 {
        arg0.timestamp
    }
    ...
    public fun transform(arg0: &Observation, arg1: u64, arg2: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg3: u128) : Observation {
        let v0 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::is_neg(0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg2))) {
            0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::neg_from((0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::abs_u32(0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg2)) as u64))
        } else {
            0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::from((0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::abs_u32(0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i32H::mate_to_lib(arg2)) as u64))
        };
        ...
        Observation{
            timestamp                        : arg1,
            tick_cumulative                  : 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i64H::add(arg0.tick_cumulative, 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::i64H::lib_to_mate(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::mul(v0, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i64::from(v1)))),
            seconds_per_liquidity_cumulative : 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::utils::overflow_add(arg0.seconds_per_liquidity_cumulative, ((v1 as u256) << 128) / (v2 as u256)),
            initialized                      : true,
        }
    }
