module 0xc1addd090f6b0f9abef380e0b2b924e81cdfbfa00eb03fdb5c0d97ab29509953::errors {
    ...
    public fun guardian_already_initialized() : u64 {
        1047
    }

    public fun guardian_not_initialized() : u64 {
        1046
    }
    ...
    public fun invalid_emission_window() : u64 {
        1042
    }
    ...
    public fun rotation_to_same_guardian() : u64 {
        1045
    }
    ...
    public fun zero_guardian_address() : u64 {
        1048
    }
