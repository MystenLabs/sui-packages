module 0xc1968f08b2a5696e66d2eb73c70a9e381e15203c233edea4b894310b7b031ac5::zen_nft {
    ...
    fun assert_is_zen_coin<T0>() {
        ...
        let v1 = 0x1::ascii::into_bytes(v0);
        0x1::debug::print<0x1::ascii::String>(&v0);
        let v2 = b"2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec";
        let v3 = b"zen";
        let v4 = b"ZEN";
        let v5 = if (contains_bytes(&v1, &v2)) {
            if (contains_bytes(&v1, &v3)) {
                contains_bytes(&v1, &v4)
            } else {
                false
            }
        } else {
