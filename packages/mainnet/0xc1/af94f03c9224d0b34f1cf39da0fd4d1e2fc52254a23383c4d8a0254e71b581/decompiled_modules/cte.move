module 0xc1af94f03c9224d0b34f1cf39da0fd4d1e2fc52254a23383c4d8a0254e71b581::cte {
    ...
    fun opt<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u64, arg4: u64, arg5: u8, arg6: u8, arg7: u64) : u64 {
        assert!(arg3 > 0, 13906834762754228230);
        assert!(arg3 <= arg4, 13906834767049326600);
        assert!(arg7 < arg3, 13906834771344424970);
        ...
        while (v8 < arg5) {
            ...
            v6 = arg3;
            v7 = v10;
            let (v11, v12) = scs<T0, T1>(arg0, v10, arg1);
        ...
        while (v8 < arg6) {
            ...
            let v16 = v6 + (v7 - v6 >> 1);
            let (v17, v18) = scs<T0, T1>(arg0, v16, arg1);
    ...
    fun tt<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xa3e3162fb175b3068eee9c18a91c72aba52d1a2b69b68fcda1d34c629da6376a::bm::CBM, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: u128, arg5: bool, arg6: u64, arg7: u64, arg8: u8, arg9: u8, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v17 >= v18, 13906835608862654468);
        let (v19, v20) = if (arg5) {
            (v16, 0)
        } else {
            (0, v16)
    ...
    public fun ttb<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xa3e3162fb175b3068eee9c18a91c72aba52d1a2b69b68fcda1d34c629da6376a::bm::CBM, arg2: &mut 0x7e5c9a5a5e505816e99df9ab6a076e8a3f23ddf0c3dab7c3666bbdc66a60e2d8::sq::SQR, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &0x2::clock::Clock, arg5: vector<u128>, arg6: vector<u64>, arg7: vector<u64>, arg8: u64, arg9: vector<u128>, arg10: vector<u64>, arg11: vector<u64>, arg12: u64, arg13: u8, arg14: u8, arg15: u64, arg16: u64, arg17: &mut 0x2::tx_context::TxContext) {
