module 0xc1555e6240456b8a18f7725f238a3240e731f4929f7d784bc3b5d47d0ed8b90e::escrow {
    ...
    public entry fun deposit_payment(arg0: vector<u8>, arg1: address, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0xc1555e6240456b8a18f7725f238a3240e731f4929f7d784bc3b5d47d0ed8b90e::main::WhitelistStorage, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg2);
        assert!(v0 > 0, 0);
        assert!(0xc1555e6240456b8a18f7725f238a3240e731f4929f7d784bc3b5d47d0ed8b90e::main::is_whitelisted(arg3, arg1), 2);
        let v1 = Escrow{
    ...
    public entry fun refund_to_client(arg0: &AdminCap, arg1: &mut Escrow, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1.coin, arg1.amount, arg2), arg1.client);
    ...
    public entry fun release_to_lawyer(arg0: &AdminCap, arg1: &mut Escrow, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.is_completed, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1.coin, arg1.amount, arg2), arg1.lawyer);
        arg1.is_completed = true;
