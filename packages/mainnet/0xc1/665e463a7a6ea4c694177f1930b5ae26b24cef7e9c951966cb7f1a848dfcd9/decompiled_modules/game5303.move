module 0xc1665e463a7a6ea4c694177f1930b5ae26b24cef7e9c951966cb7f1a848dfcd9::game5303 {
    struct GAME5303 has drop {
        dummy_field: bool,
    }

    struct TICKET_5303 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5303(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5303>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5303>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME5303, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME5303>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5303>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5303>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5303>>(v5, 0x2::tx_context::sender(arg1));
    }
