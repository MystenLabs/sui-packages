module 0xc1329d48629df1fb4052cd9f2d1cfc233cf7abebf23f1697df5239b24cc3af64::cnsnft4491 {
    struct CNSNFT4491 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4491, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4491>(arg0, arg1);
