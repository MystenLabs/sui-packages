module 0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_payload {
    ...
    public fun extract_values_by_feed_id(arg0: &Payload, arg1: &vector<u8>) : vector<vector<u8>> {
        ...
        0x1::vector::reverse<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage>(&mut v1);
        let v2 = 0;
        while (v2 < 0x1::vector::length<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage>(&v1)) {
            let v3 = 0x1::vector::pop_back<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage>(&mut v1);
            0x1::vector::push_back<vector<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>>(&mut v0, *0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::data_points(&v3));
            v2 = v2 + 1;
        };
        0x1::vector::destroy_empty<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage>(v1);
        let v4 = 0x1::vector::empty<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>();
        let v5 = 0x1::vector::flatten<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(v0);
        0x1::vector::reverse<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(&mut v5);
        let v6 = 0;
        while (v6 < 0x1::vector::length<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(&v5)) {
            let v7 = 0x1::vector::pop_back<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(&mut v5);
            if (0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::feed_id(&v7) == arg1) {
                0x1::vector::push_back<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(&mut v4, v7);
            };
            v6 = v6 + 1;
        };
        0x1::vector::destroy_empty<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(v5);
        let v8 = vector[];
        ...
        let v9 = 0;
        while (v9 < 0x1::vector::length<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(&v4)) {
            let v10 = 0x1::vector::pop_back<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPoint>(&mut v4);
            0x1::vector::push_back<vector<u8>>(&mut v8, *0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::value(&v10));
            v9 = v9 + 1;
        };
    ...
    fun parse_raw_payload(arg0: vector<u8>) : Payload {
        0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_validate::verify_redstone_marker(&arg0);
        let v0 = &mut arg0;
    ...
    public fun process_payload(arg0: &0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_config::Config, arg1: u64, arg2: vector<u8>, arg3: vector<u8>) : (u256, u64) {
        ...
        0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_validate::verify_data_packages(&v2, arg0, arg1);
        let v3 = vector[];
        ...
        while (v5 < 0x1::vector::length<vector<u8>>(&v4)) {
            ...
            0x1::vector::push_back<u256>(&mut v3, 0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_conv::from_bytes_to_u256(&v6));
            v5 = v5 + 1;
        };
        0x1::vector::destroy_empty<vector<u8>>(v4);
        (0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_median::calculate_median(&mut v3), 0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::timestamp(0x1::vector::borrow<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage>(&v2, 0)))
    }

    fun trim_data_package(arg0: &mut vector<u8>) : 0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage {
        ...
        0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::new_data_package(0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_crypto::recover_address(&v6, &v0), v4, trim_data_points(arg0, v2, v3))
    }

    fun trim_data_packages(arg0: &mut vector<u8>, arg1: u64) : vector<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage> {
        let v0 = 0x1::vector::empty<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage>();
        let v1 = 0;
        while (v1 < arg1) {
            0x1::vector::push_back<0xfa84e5620fda505bbeb9178316a555e1db36f8932dee44210dd88a6464a76ef6::redstone_sdk_data_package::DataPackage>(&mut v0, trim_data_package(arg0));
            v1 = v1 + 1;
        };
        v0
    }
