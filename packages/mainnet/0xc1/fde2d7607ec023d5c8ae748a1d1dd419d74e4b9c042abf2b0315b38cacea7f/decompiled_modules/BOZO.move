module 0xc1fde2d7607ec023d5c8ae748a1d1dd419d74e4b9c042abf2b0315b38cacea7f::BOZO {
    struct BOZO has drop {
        dummy_field: bool,
    }

    fun init(arg0: BOZO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BOZO>(arg0, 9, b"BOZO", b"BOZO", b"Ladies with gentle hands this is my alter ego. $BOZO", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1704143547769798656/W_J4MHEz_400x400.jpg")), arg1);
