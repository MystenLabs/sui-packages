module 0xc1c368f74e4393139be6237d320a7e61e90566bf110e12c53e92f462e472c3f4::xbtc {
    ...
    public entry fun batch_add_to_deny_list(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<XBTC>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 4);
        let v1 = BatchAddDenyListEvent{
            denylister : 0x2::tx_context::sender(arg3),
            accounts   : arg2,
        };
        0x2::event::emit<BatchAddDenyListEvent>(v1);
        let v2 = 0;
        while (v2 < v0) {
    ...
    public entry fun batch_remove_from_deny_list(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<XBTC>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 > 0, 4);
        let v1 = BatchRemoveDenyListEvent{
            denylister : 0x2::tx_context::sender(arg3),
            accounts   : arg2,
        };
        0x2::event::emit<BatchRemoveDenyListEvent>(v1);
        let v2 = 0;
        while (v2 < v0) {
    ...
    fun init(arg0: XBTC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<XBTCReceiver>(v3, @0x4ac95fc4186c2c33ada72045c1221efa1cbe26c33830800989d01a613de0fe16);
    ...
    public entry fun set_receiver(arg0: &0x2::coin::TreasuryCap<XBTC>, arg1: &mut XBTCReceiver, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 != @0x0, 3);
        arg1.receiver = arg2;
    ...
    public entry fun transfer_minter_role(arg0: 0x2::coin::TreasuryCap<XBTC>, arg1: XBTCReceiver, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 != @0x0, 3);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<XBTC>>(arg0, arg2);
        0x2::transfer::public_transfer<XBTCReceiver>(arg1, arg2);
        let v0 = TransferMinterRoleEvent{
            old_minter : 0x2::tx_context::sender(arg3),
            new_minter : arg2,
        };
