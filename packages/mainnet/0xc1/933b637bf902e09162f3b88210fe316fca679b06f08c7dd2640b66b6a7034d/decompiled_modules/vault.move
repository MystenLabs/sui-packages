module 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::vault {
    ...
    struct Vault<phantom T0, phantom T1, phantom T2, T3: copy + drop + store> has key {
        ...
        decimals_a: u8,
        decimals_b: u8,
        config: 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Config<T3>,
    }
    ...
    struct VaultCreatedEvent<T0: copy + drop + store> has copy, drop {
        ...
        fee_val: u64,
        withdraw_fee: u64,
        config: 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Config<T0>,
    }
    ...
    public fun set_target_adapter<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Drift>, arg1: &VaultCap, arg2: 0x1::ascii::String) {
        check_vault_cap_compatibility<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Drift>(arg0, arg1);
        0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::set_target_adapter(borrow_mut_config<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Drift>(arg0), arg2);
    }
    ...
    public(friend) fun add_swap_route<T0, T1, T2, T3: copy + drop + store, T4>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: vector<0x360802cb106b004205cd67a706e314eaeadd8590d5f4d1cee46137566232a627::bag_value::Value>, arg2: bool) {
        ...
        assert!(v0 != 0x1::type_name::into_string(0x1::type_name::get<T0>()), 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_route_key());
        assert!(v0 != 0x1::type_name::into_string(0x1::type_name::get<T1>()), 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_route_key());
        assert!(!0x2::bag::contains<0x1::ascii::String>(&arg0.swap_routes, v0), 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_route_key());
        let v1 = SwapRoute{
            route     : arg1,
            returns_x : arg2,
        };
    ...
    public fun assert_rebalance_cap<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: &RebalanceCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<Vault<T0, T1, T2, T3>>(arg0) == arg1.vault_id, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_rebalance_cap());
        assert!(arg1.whitelisted_address == 0x2::tx_context::sender(arg2), 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_rebalance_owner());
    }

    public fun borrow_config<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>) : &0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Config<T3> {
        &arg0.config
    }

    public(friend) fun borrow_mut_config<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>) : &mut 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Config<T3> {
        &mut arg0.config
    }
    ...
    public fun check_pool_compatibility<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>) {
        assert!(arg0.clmm_pool_id == 0x2::object::id<0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>>(arg1), 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_pool());
    }

    public fun check_vault_cap_compatibility<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2, T3>>(arg0), 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_vault_cap());
    }

    public fun check_vault_cap_uninitialised(arg0: &VaultCap) {
        assert!(arg0.is_initialised == false, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_vault_cap());
    }
    ...
    fun emit_event<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>, arg1: 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Config<T3>) {
    ...
    public fun is_deposit_enabled<T0, T1, T2, T3: copy + drop + store>(arg0: &Vault<T0, T1, T2, T3>) : bool {
        *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::constants::deposit_enabled_df_key())
    }

    public fun issue_rebalance_cap(arg0: &VaultCap, arg1: address, arg2: &0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun mint_vault_coin<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: u128, arg2: u128, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        assert!(v0 > 0, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::seed_mint_zero());
    ...
    public fun new_drift_vault<T0, T1, T2>(arg0: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u8, arg12: u8, arg13: u64, arg14: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::treasury_cap_supply_non_zero());
        assert!(arg2 > arg3, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_price_scalling());
        let v0 = 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::new_drift_config(0x1::ascii::string(b""), arg4);
        let v1 = Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Drift>{
        ...
        0x2::dynamic_field::add<vector<u8>, bool>(&mut v1.id, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::constants::deposit_enabled_df_key(), true);
        let v2 = VaultCap{
            id             : 0x2::object::new(arg14),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Drift>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Drift>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Drift>>(v1);
    ...
    public fun new_stable_vault<T0, T1, T2>(arg0: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u8, arg11: u8, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::treasury_cap_supply_non_zero());
        assert!(arg2 > arg3, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_price_scalling());
        let v0 = 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::new_stable_config();
        let v1 = Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Stable>{
        ...
        let v2 = VaultCap{
            id             : 0x2::object::new(arg13),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Stable>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Stable>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Stable>>(v1);
    ...
    public fun new_uncorrelated_vault<T0, T1, T2>(arg0: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u128, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u8, arg13: u8, arg14: u64, arg15: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<T2>(&arg1) == 0, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::treasury_cap_supply_non_zero());
        assert!(arg4 > arg5, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::upper_lower_trigger_price_incompatible());
        assert!(arg2 > arg3, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_price_scalling());
        let v0 = 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::new_uncorrelated_config(0, 0, arg4, arg5);
        let v1 = Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Uncorrelated>{
        ...
        let v2 = VaultCap{
            id             : 0x2::object::new(arg15),
            vault_id       : 0x2::object::id<Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Uncorrelated>>(&v1),
            is_initialised : false,
        };
        emit_event<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Uncorrelated>(&v1, v0);
        0x2::transfer::share_object<Vault<T0, T1, T2, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::config::Uncorrelated>>(v1);
    ...
    public(friend) fun seed<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: 0x2::balance::Balance<T2>) {
        assert!(0x2::balance::value<T2>(&arg0.seed_balance) == 0, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::seed_balance_zero());
    ...
    public fun set_deposit_enable<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: &AdminCap, arg2: bool) {
        *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(&mut arg0.id, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::constants::deposit_enabled_df_key()) = arg2;
    }
    ...
    public fun set_fee<T0, T1, T2, T3: copy + drop + store>(arg0: &mut Vault<T0, T1, T2, T3>, arg1: &VaultCap, arg2: u64) {
        check_vault_cap_compatibility<T0, T1, T2, T3>(arg0, arg1);
        assert!(arg2 <= 1000000, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_fee_val());
        arg0.fee_val = arg2;
    }
    ...
    public fun update_rebalance_cap_ownership(arg0: &VaultCap, arg1: &mut RebalanceCap, arg2: address, arg3: &0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::version::Version) {
        0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::version::assert_supported_version(arg3);
        assert!(arg0.vault_id == arg1.vault_id, 0xc1933b637bf902e09162f3b88210fe316fca679b06f08c7dd2640b66b6a7034d::error::invalid_rebalance_cap());
