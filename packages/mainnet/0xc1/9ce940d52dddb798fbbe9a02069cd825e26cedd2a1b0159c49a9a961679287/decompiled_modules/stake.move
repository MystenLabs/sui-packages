module 0xc19ce940d52dddb798fbbe9a02069cd825e26cedd2a1b0159c49a9a961679287::stake {
    ...
    public entry fun create_stake<T0>(arg0: &mut StakingPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3 != @0x0) {
            ...
            assert!(0x2::balance::value<T0>(&arg0.rewards_pool) >= calculate_referral_rewards(&v6), 9);
    ...
    fun process_roi_affiliate_rewards<T0>(arg0: &Stake, arg1: &mut StakingPool<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        loop {
            ...
            if ((v1 as u64) < 0x1::vector::length<u64>(&v2) && v0 != @0x0) {
                let v3 = vector[20, 10, 8, 5, 5, 5, 4, 4, 4, 3, 3, 3, 2, 2, 2];
                let v4 = calculate_roi_affiliate_reward(arg2, *0x1::vector::borrow<u64>(&v3, (v1 as u64)));
                if (v4 > 0) {
                    assert!(0x2::balance::value<T0>(&arg1.rewards_pool) >= v4, 9);
                    let v5 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::table::Table<address, UserRewards>>(&mut arg1.id, b"user_rewards");
                    if (!0x2::table::contains<address, UserRewards>(v5, v0)) {
                        let v6 = UserRewards{
                        ...
                        0x2::table::add<address, UserRewards>(v5, v0, v6);
                    };
                    let v7 = 0x2::table::borrow_mut<address, UserRewards>(v5, v0);
                    add_affiliate_reward(v7, v4, 0x2::object::uid_to_inner(&arg0.id), arg2, v1, arg3);
                    let v8 = AffiliateRoiRewardPaid{
                        from_stake         : 0x2::object::uid_to_inner(&arg0.id),
                    ...
                    0x2::event::emit<AffiliateRoiRewardPaid>(v8);
