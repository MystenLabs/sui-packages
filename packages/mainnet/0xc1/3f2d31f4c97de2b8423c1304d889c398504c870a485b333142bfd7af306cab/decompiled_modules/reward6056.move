module 0xc13f2d31f4c97de2b8423c1304d889c398504c870a485b333142bfd7af306cab::reward6056 {
    struct REWARD6056 has drop {
        dummy_field: bool,
    }

    struct TICKET_6056 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6056(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6056>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6056>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6056, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6056>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6056>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6056>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6056>>(v5, 0x2::tx_context::sender(arg1));
    }
