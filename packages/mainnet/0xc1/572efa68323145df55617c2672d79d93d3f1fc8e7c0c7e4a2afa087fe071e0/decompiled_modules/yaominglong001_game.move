module 0xc1572efa68323145df55617c2672d79d93d3f1fc8e7c0c7e4a2afa087fe071e0::yaominglong001_game {
    ...
    public entry fun play<T0>(arg0: u8, arg1: &mut Game<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v5) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.pool, arg1.reward), arg3), 0x2::tx_context::sender(arg3));
        };
        let v6 = GameResult{
            result    : v4,
            is_winner : v5,
