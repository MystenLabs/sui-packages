module 0xc12bc4daee4bea0553c161fdb00bdc6928627c632917d8f104c02fd029b48855::cnsnft3258 {
    struct CNSNFT3258 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3258, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3258>(arg0, arg1);
