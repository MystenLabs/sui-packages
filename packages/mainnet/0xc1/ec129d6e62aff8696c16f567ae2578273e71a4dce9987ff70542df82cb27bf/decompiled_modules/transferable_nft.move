module 0xc1ec129d6e62aff8696c16f567ae2578273e71a4dce9987ff70542df82cb27bf::transferable_nft {
    struct TRANSFERABLE_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TRANSFERABLE_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x2::package::claim<TRANSFERABLE_NFT>(arg0, arg1);
