module 0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::candy_machine {
    ...
    fun create_nft(arg0: &mut CandyMachine, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : (0x2::kiosk::Kiosk, 0x2::kiosk::KioskOwnerCap) {
        let (v0, v1) = 0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::kiosk::new_kiosk(arg2);
        let v2 = v1;
        let v3 = v0;
        ...
        let v7 = 0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::create_nft_with_ipfs(v4, v5, arg0.collection_description, v6, v4, 0x2::tx_context::epoch(arg2), 0x2::object::id<0x2::kiosk::Kiosk>(&v3), 0x2::object::id<0x2::kiosk::KioskOwnerCap>(&v2), arg2);
        let v8 = 0x2::object::id<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Nft>(&v7);
        0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::kiosk::place(&mut v3, &v2, v7);
        let v9 = NFTMinted{
            nft_id     : v8,
    ...
    fun init(arg0: CANDY_MACHINE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Nft>(&v4, v0, v2, arg1);
        0x2::display::update_version<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Nft>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Nft>>(v5, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun reveal_and_return_nft(arg0: &mut CandyMachine, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::kiosk::take<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Nft>(arg1, &arg2, arg3);
        let v1 = 0x1::string::utf8(b"");
        0x1::string::append(&mut v1, arg6);
        let v2 = 0x1::vector::empty<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Attribute>();
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x1::string::String>(&arg4)) {
            0x1::vector::push_back<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Attribute>(&mut v2, 0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::create_attribute(*0x1::vector::borrow<0x1::string::String>(&arg4, v3), *0x1::vector::borrow<0x1::string::String>(&arg5, v3)));
            v3 = v3 + 1;
        };
        0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::update_metadata(&mut v0, v1, v2);
        0x2::kiosk::place<0xc197f8b1bc5cbc60d50a9042702b4d299804031d555b7ddef6baeed93a13e89a::nft::Nft>(arg1, &arg2, v0);
