module 0xc1cf30e2b9812cfabc718dd81473a9a92c443a8a8ffe9d0d998f5087fe51c0d4::test_coin {
    ...
    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 6, b"test", b"forge", b"Template Coin Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"dddd"))), arg1);
