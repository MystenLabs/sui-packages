module 0xc13e921174e87618aa5e6debb280ce3e1d1f0c4dd0ac20c12ad2b7f038083f61::reward6506 {
    struct REWARD6506 has drop {
        dummy_field: bool,
    }

    struct TICKET_6506 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6506(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6506>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6506>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6506, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6506>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6506>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6506>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6506>>(v5, 0x2::tx_context::sender(arg1));
    }
