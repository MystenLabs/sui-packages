module 0xc10dd25319829d55119585f832a06d86867eba2f9542083fac471ffdb9c38a35::math_u256 {
    public fun overflowing_add(arg0: u256, arg1: u256) : (u256, bool) {
        let (v0, v1) = 0xc10dd25319829d55119585f832a06d86867eba2f9542083fac471ffdb9c38a35::math_u128::overflowing_add(((arg0 & 340282366920938463463374607431768211455) as u128), ((arg1 & 340282366920938463463374607431768211455) as u128));
        let (v2, v3) = 0xc10dd25319829d55119585f832a06d86867eba2f9542083fac471ffdb9c38a35::math_u128::overflowing_add(((arg0 >> 128 & 340282366920938463463374607431768211455) as u128), ((arg1 >> 128 & 340282366920938463463374607431768211455) as u128));
        let v4 = if (v1) {
            1
        } else {
            0
        };
        let (v5, v6) = 0xc10dd25319829d55119585f832a06d86867eba2f9542083fac471ffdb9c38a35::math_u128::overflowing_add(v2, v4);
        let v7 = v3 || v6;
