module 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::farm {
    ...
    public(friend) fun add_reward<T0, T1>(arg0: &mut Farm<T0>, arg1: 0x2::balance::Balance<T1>, arg2: u64, arg3: bool, arg4: &0x2::clock::Clock) {
        ...
        assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.reward_types, &v0), 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::error::invalid_reward_type());
    ...
    fun assert_farm_id<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) {
        assert!(arg1.farm_id == 0x2::object::id<Farm<T0>>(arg0), 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::error::invalid_stake_receipt_for_farm());
    }
    ...
    public(friend) fun claim_reward<T0, T1>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        assert!(v1.is_claimable, 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::error::reward_not_claimable());
    ...
    public(friend) fun harvest<T0>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) {
        ...
        while (v4 < 0x1::vector::length<0x1::type_name::TypeName>(v3)) {
            ...
            v5.cumulative_index = v5.cumulative_index + 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128((v6 as u128), 18446744073709551616, (arg0.total_weight as u128));
            v4 = v4 + 1;
        };
        *v1 = v0;
    }
    ...
    public(friend) fun harvest_for_user<T0>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(v0)) {
            ...
            if (0x2::table::contains<0x1::type_name::TypeName, UserRewardInfo>(&arg1.reward_infos, v2)) {
                ...
                v4.harvested_rewards = v4.harvested_rewards + (0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128((arg1.shares as u128), v3.cumulative_index - v4.cumulative_index, 18446744073709551616) as u64);
                v4.cumulative_index = v3.cumulative_index;
            } else {
                let v5 = UserRewardInfo{
                    cumulative_index  : v3.cumulative_index,
                    harvested_rewards : (0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128((arg1.shares as u128), v3.cumulative_index, 18446744073709551616) as u64),
                };
    ...
    fun harvest_points_for_user<T0>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: &0x2::clock::Clock) {
        ...
        let v0 = (0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128((arg1.shares as u128), arg0.points_info.index - arg1.user_points_info.index, 18446744073709551616) as u64);
    ...
    public(friend) fun initialize<T0>(arg0: 0x2::balance::Balance<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : Farm<T0> {
        let v0 = PointsInfo{
            ...
            index                    : 0,
            updated_at               : 0x2::clock::timestamp_ms(arg1) / 1000,
            start_time               : 0x2::clock::timestamp_ms(arg1) / 1000,
        };
        Farm<T0>{
            ...
            last_update_time : 0x2::clock::timestamp_ms(arg1) / 1000,
    ...
    public fun reward_info<T0, T1>(arg0: &Farm<T0>) : (u64, u64, u64) {
        let v0 = 0x2::table::borrow<0x1::type_name::TypeName, RewardInfo>(&arg0.reward_infos, 0x1::type_name::get<T1>());
        (v0.rewards_per_sec, v0.harvested_rewards, 0x2::balance::value<T1>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.reward_balances, 0x1::type_name::get<T1>())))
    }
    ...
    public fun simulate_current_points<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) : u64 {
        ...
        arg0.points_info.total_claimed_points + (0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128((arg1.shares as u128), arg0.points_info.index - arg1.user_points_info.index, 18446744073709551616) as u64)
    }
    ...
    public fun simulate_current_rewards<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) : (vector<0x1::ascii::String>, vector<u64>) {
        ...
        while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(v0)) {
            ...
            if (0x2::table::contains<0x1::type_name::TypeName, UserRewardInfo>(&arg1.reward_infos, v4)) {
                ...
                0x1::vector::push_back<u64>(&mut v2, v6.harvested_rewards + (0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128((arg1.shares as u128), v5.cumulative_index - v6.cumulative_index, 18446744073709551616) as u64));
            } else {
                0x1::vector::push_back<u64>(&mut v2, (0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128((arg1.shares as u128), v5.cumulative_index, 18446744073709551616) as u64));
            };
            v3 = v3 + 1;
        };
        (v1, v2)
    ...
    public(friend) fun unstake<T0>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: u64, arg3: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        harvest<T0>(arg0, arg3);
        harvest_for_user<T0>(arg0, arg1, arg3);
        assert!(arg2 <= arg1.shares, 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::error::unstake_amount_too_much());
    ...
    public(friend) fun update_points<T0>(arg0: &mut Farm<T0>, arg1: u64, arg2: &0x2::clock::Clock) {
        arg0.points_info.index = arg0.points_info.index + 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::utils::mul_factor_u128(((arg1 - arg0.points_info.total_accumulated_points) as u128), 18446744073709551616, (arg0.total_weight as u128));
    ...
    public(friend) fun withdraw_unharvested<T0, T1>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        assert!(v1.harvested_rewards < v3, 0xc14866d64854a1dd6ecb417f32849f24daa662b3eb855226c40a144f767fe7f5::error::no_unharvested_rewards());
