module 0xc1eee72de8affc5ba2a498d335ef9d254d613e80b44f52f24a182080d01aab05::reward5545 {
    struct REWARD5545 has drop {
        dummy_field: bool,
    }

    struct TICKET_5545 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5545(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5545>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5545>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5545, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5545>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5545>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5545>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5545>>(v5, 0x2::tx_context::sender(arg1));
    }
