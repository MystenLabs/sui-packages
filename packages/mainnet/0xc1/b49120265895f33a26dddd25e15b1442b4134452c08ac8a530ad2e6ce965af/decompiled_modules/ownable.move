module 0xc1b49120265895f33a26dddd25e15b1442b4134452c08ac8a530ad2e6ce965af::ownable {
    ...
    public(friend) fun execute_ownership_transfer(arg0: OwnerCap, arg1: &mut OwnableState, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v2 != 0xe1f64e7b6a475e6d834ec83f44927910d54d524a868c40afa8e1407a6f3b551::mcms_registry::get_multisig_address(), 9);
        arg1.owner = arg2;
    ...
    public fun execute_ownership_transfer_to_mcms<T0: drop>(arg0: OwnerCap, arg1: &mut OwnableState, arg2: &mut 0xe1f64e7b6a475e6d834ec83f44927910d54d524a868c40afa8e1407a6f3b551::mcms_registry::Registry, arg3: address, arg4: 0xe1f64e7b6a475e6d834ec83f44927910d54d524a868c40afa8e1407a6f3b551::mcms_registry::PublisherWrapper<T0>, arg5: T0, arg6: vector<vector<u8>>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<OwnerCap>(&arg0) == arg1.owner_cap_id, 1);
        assert!(0x1::option::is_some<PendingTransfer>(&arg1.pending_transfer), 4);
        let v0 = 0x1::option::extract<PendingTransfer>(&mut arg1.pending_transfer);
        let v1 = arg1.owner;
        ...
        assert!(v2 == arg3, 7);
        assert!(v0.accepted, 8);
        assert!(arg3 == 0xe1f64e7b6a475e6d834ec83f44927910d54d524a868c40afa8e1407a6f3b551::mcms_registry::get_multisig_address(), 10);
        arg1.owner = arg3;
        0xe1f64e7b6a475e6d834ec83f44927910d54d524a868c40afa8e1407a6f3b551::mcms_registry::register_entrypoint<T0, OwnerCap>(arg2, arg4, arg5, arg0, arg6, arg7);
        let v3 = OwnershipTransferred{
            from : v1,
            to   : v2,
        };
