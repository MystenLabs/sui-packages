module 0xc1747b54828d57d32ffa0cd57a78838f977dafbbd43e9bfa5bfd6ac6c086c5ff::bluefin_clmm {
    public fun bluefin_clmm_add_liquidity<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: u128, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg0);
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_sqrt_price_at_tick(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::lower_tick(arg3));
        let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::get_sqrt_price_at_tick(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::upper_tick(arg3));
        if (arg6 != 0) {
            if (arg6 >= v2) {
                assert!(v0 >= v2, 0);
            } else if (arg6 <= v1) {
        ...
        if (v0 < v2) {
            let v5 = if (v0 <= v1) {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_liquidity_from_a(v1, v2, 0x2::coin::value<T0>(&arg4), false)
            } else {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_liquidity_from_a(v0, v2, 0x2::coin::value<T0>(&arg4), false)
            };
            v3 = v5;
        };
        if (v0 > v1) {
            let v6 = if (v0 >= v2) {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_liquidity_from_b(v1, v2, 0x2::coin::value<T1>(&arg5), false)
            } else {
                0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::get_liquidity_from_b(v1, v0, 0x2::coin::value<T1>(&arg5), false)
            };
            v4 = v6;
        };
        let v7 = if (v0 <= v1) {
    ...
    public fun bluefin_clmm_remove_liquidity<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &0x2::clock::Clock, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u128, arg5: u128, arg6: bool, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        if (arg5 != 0) {
            ...
            if (arg5 >= v1) {
                assert!(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg0) >= v1, 0);
            } else if (arg5 <= v0) {
                assert!(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg0) <= v0, 0);
            } else {
                assert!(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg0) == arg5, 0);
            };
        };
        if (arg4 == 0) {
        ...
        let (v2, v3) = if (arg4 > 0) {
            let (v4, v5, v6, v7) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg1, arg0, arg3, arg4, arg2);
            let _ = v5;
            let _ = v4;
            (v6, v7)
        } else {
        ...
        let v10 = v3;
        let v11 = v2;
        let (_, _, v14, v15) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg2, arg1, arg0, arg3);
        0x2::balance::join<T0>(&mut v11, v14);
        0x2::balance::join<T1>(&mut v10, v15);
        if (arg6) {
            0x2::balance::join<T0>(&mut v11, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg2, arg1, arg0, arg3));
        };
        if (arg7) {
            0x2::balance::join<T1>(&mut v10, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T1>(arg2, arg1, arg0, arg3));
        };
        (0x2::coin::from_balance<T0>(v11, arg8), 0x2::coin::from_balance<T1>(v10, arg8))
    }
