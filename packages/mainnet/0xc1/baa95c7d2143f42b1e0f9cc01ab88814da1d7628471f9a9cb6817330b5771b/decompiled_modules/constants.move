module 0xc1baa95c7d2143f42b1e0f9cc01ab88814da1d7628471f9a9cb6817330b5771b::constants {
    public fun cetus_sui_usdt_pool() : address {
        @0x6d8af9e6afd27262db436f0d37b304a041f710c3ea1fa4c3a9bab36b3569ad3
    }

    public fun deepbook_sui_usdt_pool() : address {
    ...
    public fun kriya_sui_usdt_pool() : address {
    ...
    public fun turbos_sui_usdt_pool() : address {
    ...
    public fun usdt_package() : address {
