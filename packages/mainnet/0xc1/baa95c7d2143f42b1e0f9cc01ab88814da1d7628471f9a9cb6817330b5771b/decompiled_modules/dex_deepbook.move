module 0xc1baa95c7d2143f42b1e0f9cc01ab88814da1d7628471f9a9cb6817330b5771b::dex_deepbook {
    ...
    public fun swap<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(0x2::coin::value<T0>(&arg1) > 0, 802);
        abort 801
    }
    ...
    public fun place_ioc_order<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: bool, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        ...
        assert!(v0 > 0, 802);
        let v1 = v0 * 10 / 10000;
        let (v2, _) = calculate_ioc_fill(v0 - v1, arg3, arg0);
