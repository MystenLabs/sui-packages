module 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::account {
    ...
    public(friend) fun add_integrator_config<T0>(arg0: &mut Account<T0>, arg1: address, arg2: u256) {
        ...
        0x2::dynamic_field::add<0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::keys::IntegratorConfig, IntegratorConfig>(&mut arg0.id, 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::keys::integrator_config(arg1), v0);
        0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::events::emit_added_integrator_config<T0>(arg0.account_id, arg1, arg2);
    }

    public fun check_valid_account_cap<T0, T1>(arg0: &Account<T0>, arg1: &AccountCap<T1>) {
        assert!(has_authority<T0, T1>(arg1, arg0), 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::errors::invalid_account_cap());
    }
    ...
    public(friend) fun consume_policy_and_share_account<T0>(arg0: Account<T0>, arg1: AccountSharePolicy) {
        ...
        assert!(0x2::object::uid_to_inner(&arg0.id) == v0, 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::errors::invalid_share_policy());
    ...
    public(friend) fun create_account<T0>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : (Account<T0>, AccountSharePolicy, AccountCap<ADMIN>) {
        ...
        0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::events::emit_created_account<T0>(v1, 0x2::tx_context::sender(arg1), arg0);
        (v0, v2, v3)
    }
    ...
    public(friend) fun deposit_collateral<T0>(arg0: &mut Account<T0>, arg1: 0x2::coin::Coin<T0>) {
        ...
        0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::events::emit_deposited_collateral<T0>(arg0.account_id, v0);
    }
    ...
    public fun get_integrator_config<T0>(arg0: &Account<T0>, arg1: address) : &IntegratorConfig {
        0x2::dynamic_field::borrow<0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::keys::IntegratorConfig, IntegratorConfig>(&arg0.id, 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::keys::integrator_config(arg1))
    }
    ...
    public(friend) fun new_assistant_account_cap<T0>(arg0: &mut Account<T0>, arg1: &mut 0x2::tx_context::TxContext) : AccountCap<ASSISTANT> {
        assert!(0x1::vector::length<0x2::object::ID>(&arg0.active_assistants) < 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::constants::max_assistats_per_account(), 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::errors::too_many_assistants_per_account());
        ...
        0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::events::emit_created_assistant_account_cap(arg0.account_id, 0x2::object::uid_to_inner(&v0.id));
        v0
    }
    ...
    public(friend) fun remove_integrator_config<T0>(arg0: &mut Account<T0>, arg1: address) {
        let IntegratorConfig {  } = 0x2::dynamic_field::remove<0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::keys::IntegratorConfig, IntegratorConfig>(&mut arg0.id, 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::keys::integrator_config(arg1));
        0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::events::emit_removed_integrator_config<T0>(arg0.account_id, arg1);
    }
        ...
        while (v1 < 0x1::vector::length<0x2::object::ID>(v0)) {
            if (*0x1::vector::borrow<0x2::object::ID>(v0, v1) == arg1) {
                ...
                if (0x1::option::is_some<u64>(&v2)) {
                    ...
                    0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::events::emit_revoked_assistant_account_cap(arg0.account_id, arg1);
                } else {
    ...
    public(friend) fun withdraw_collateral<T0>(arg0: &mut Account<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1 != 0, 0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::errors::deposit_or_withdraw_amount_zero());
        0xc0bdfac112f06963c33a2e436acc6ab22dfbe9701187d991720f231b9b2cff9a::events::emit_withdrew_collateral<T0>(arg0.account_id, arg1);
