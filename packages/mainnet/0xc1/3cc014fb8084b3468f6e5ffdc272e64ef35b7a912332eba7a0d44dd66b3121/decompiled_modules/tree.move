module 0xc13cc014fb8084b3468f6e5ffdc272e64ef35b7a912332eba7a0d44dd66b3121::tree {
    ...
    public fun advance_branch(arg0: &mut MemoryTree, arg1: &0x1::string::String, arg2: vector<u8>) {
        ...
        arg0.merge_count = arg0.merge_count + 1;
    }
    ...
    public fun branch(arg0: &mut MemoryTree, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc13cc014fb8084b3468f6e5ffdc272e64ef35b7a912332eba7a0d44dd66b3121::acl::create(v2, v1, v3, arg3);
    ...
    public fun init_tree(arg0: address, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        v6.merge_count = 0;
        0xc13cc014fb8084b3468f6e5ffdc272e64ef35b7a912332eba7a0d44dd66b3121::acl::create(v7, v1, v8, arg3);
        let v10 = TreeCreated{
            tree_id        : v7,
            owner          : v0,
            memwal_account : v2,
    ...
    public fun merge_count(arg0: &MemoryTree) : u64 {
        arg0.merge_count
    }
