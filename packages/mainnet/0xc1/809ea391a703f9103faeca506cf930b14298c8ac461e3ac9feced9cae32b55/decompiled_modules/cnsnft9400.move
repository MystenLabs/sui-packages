module 0xc1809ea391a703f9103faeca506cf930b14298c8ac461e3ac9feced9cae32b55::cnsnft9400 {
    struct CNSNFT9400 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9400, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9400>(arg0, arg1);
