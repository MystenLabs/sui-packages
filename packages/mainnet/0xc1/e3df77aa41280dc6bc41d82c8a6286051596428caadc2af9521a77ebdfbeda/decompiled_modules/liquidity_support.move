module 0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::liquidity_support {
    ...
    struct LiquiditySupportTestClosed has copy, drop {
        lumi_returned: u64,
        sui_returned: u64,
    }
    ...
    public entry fun create_and_close_lumi_sui_support_for_test(arg0: &0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::router::Router, arg1: &0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::AdminCap, arg2: &mut 0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::Vault, arg3: &mut 0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::revenue::RevenueVault<0x2::sui::SUI>, arg4: &0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::price_oracle::PriceOracle, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI, 0x2::sui::SUI>, arg6: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg7: u64, arg8: u32, arg9: u32, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        assert!(!0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::router::is_paused(arg0), 1);
        assert!(arg7 > 0, 4);
        let v0 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI, 0x2::sui::SUI>(arg6, arg5, arg8, arg9, arg15);
        let v1 = &mut v0;
        let (_, _, _, _) = deploy(arg1, arg2, arg3, arg4, arg5, arg6, v1, arg7, arg10, arg11, arg14, arg15);
        let (v6, v7) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::remove_liquidity_with_slippage<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI, 0x2::sui::SUI>(arg6, arg5, &mut v0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(&v0), arg12, arg13, arg14);
        let v8 = v7;
        let v9 = v6;
        let (v10, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_fee<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI, 0x2::sui::SUI>(arg6, arg5, &v0, false);
        0x2::balance::join<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI>(&mut v9, v10);
        0x2::balance::join<0x2::sui::SUI>(&mut v8, v11);
        let v12 = 0x2::balance::value<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI>(&v9);
        let v13 = 0x2::balance::value<0x2::sui::SUI>(&v8);
        assert!(v12 >= arg12 && v13 >= arg13, 3);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::close_position<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI, 0x2::sui::SUI>(arg6, arg5, v0);
        0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::return_lumi_from_liquidity(arg2, 0x2::coin::from_balance<0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi::LUMI>(v9, arg15));
        0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::revenue::deposit<0x2::sui::SUI>(arg3, v8);
        let v14 = LiquiditySupportTestClosed{
            lumi_returned : v12,
            sui_returned  : v13,
        };
        0x2::event::emit<LiquiditySupportTestClosed>(v14);
    }
