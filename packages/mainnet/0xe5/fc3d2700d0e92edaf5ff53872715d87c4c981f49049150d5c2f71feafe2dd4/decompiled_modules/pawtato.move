module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato {
    ...
    fun check_version(arg0: &NFTCollection) {
        let v0 = VersionKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<VersionKey>(&arg0.id, v0), 19);
        assert!(*0x2::dynamic_field::borrow<VersionKey, u64>(&arg0.id, v0) == 1, 19);
    }
    ...
    public fun is_collection_paused(arg0: &NFTCollection) : bool {
    ...
    public fun set_attributes(arg0: &0xc3dc70c7ca20eaf2e1c52826cf5b9fb2712e34a1d6f3de5f4dfb727c32d62c36::pawtato_admin::NFTUpgradeCap, arg1: &NFTCollection, arg2: &mut LAND, arg3: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>) {
        assert!(!is_collection_paused(arg1), 18);
        check_version(arg1);
    ...
    public entry fun set_collection_paused(arg0: &0xc3dc70c7ca20eaf2e1c52826cf5b9fb2712e34a1d6f3de5f4dfb727c32d62c36::pawtato_admin::AdminCap, arg1: &mut NFTCollection, arg2: bool) {
        let v0 = PausedKey{dummy_field: false};
    ...
    public entry fun upgrade_version(arg0: &0xc3dc70c7ca20eaf2e1c52826cf5b9fb2712e34a1d6f3de5f4dfb727c32d62c36::pawtato_admin::AdminCap, arg1: &mut NFTCollection) {
        let v0 = VersionKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<VersionKey>(&arg1.id, v0)) {
            assert!(1 > *0x2::dynamic_field::borrow<VersionKey, u64>(&arg1.id, v0), 20);
