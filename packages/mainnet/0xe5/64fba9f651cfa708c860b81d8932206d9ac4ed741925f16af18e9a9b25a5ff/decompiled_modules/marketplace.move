module 0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::marketplace {
    ...
    public entry fun buy_nft(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v1;
        let v7 = 0x2::dynamic_field::remove<vector<u8>, 0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::RWAToken>(&mut v6, b"nft");
        assert!(!0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::is_nft_frozen(&v7), 8);
        let (v8, v9) = 0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::get_creator_info(&v7);
        ...
        0x2::transfer::public_transfer<0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::RWAToken>(v7, v0);
    ...
    public entry fun delist_nft(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_frozen, 4);
        assert!(0x2::table::contains<0x2::object::ID, Listing>(&arg0.listings, arg1), 3);
        assert!(0x2::tx_context::sender(arg2) == @0x4ab9b816fd602d5f2237ce4c26038c64862e4a24c3f7295c71ec64639393a257, 9);
        ...
        let v6 = v1;
        0x2::transfer::public_transfer<0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::RWAToken>(0x2::dynamic_field::remove<vector<u8>, 0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::RWAToken>(&mut v6, b"nft"), v0);
        let v7 = NFTDelisted{
            marketplace_id : 0x2::object::uid_to_inner(&arg0.id),
            listing_id     : 0x2::object::uid_to_inner(&v6),
            nft_id         : arg1,
    ...
    public fun is_authorized_lister(arg0: address) : bool {
        arg0 == @0x4ab9b816fd602d5f2237ce4c26038c64862e4a24c3f7295c71ec64639393a257
    }
    ...
    public entry fun list_nft(arg0: &mut Marketplace, arg1: 0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::RWAToken, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_frozen, 4);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == @0x4ab9b816fd602d5f2237ce4c26038c64862e4a24c3f7295c71ec64639393a257, 9);
        assert!(!0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::is_nft_frozen(&arg1), 8);
        let v1 = 0x2::object::id<0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::RWAToken>(&arg1);
        ...
        0x2::dynamic_field::add<vector<u8>, 0xe564fba9f651cfa708c860b81d8932206d9ac4ed741925f16af18e9a9b25a5ff::nft::RWAToken>(&mut v3.id, b"nft", arg1);
