module 0xe516be71671a1489e9884dd4bb2b0384cd05a4fd54ae674b56bd3ce67a753fc3::suibtc {
    ...
    fun init(arg0: SUIBTC, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIBTC>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUIBTC"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A collection to support BTC on Sui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibsrgi5zs4zunkbiu5ntszrnge4aebrin5jqifwangrdpxiazmfvy"));
