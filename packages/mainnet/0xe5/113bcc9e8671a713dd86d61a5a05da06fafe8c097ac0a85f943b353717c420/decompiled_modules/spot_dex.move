module 0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::spot_dex {
    ...
    fun assert_lp_value_is_increased(arg0: bool, arg1: u64, arg2: u64, arg3: u128, arg4: u128, arg5: u128, arg6: u128) {
        if (arg0) {
            assert!(0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::utils::lp_value(arg5, arg1, arg6, arg2) > 0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::utils::lp_value(arg3, arg1, arg4, arg2), 16);
        } else {
    ...
    fun get_token_amount_to_maintain_ratio(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        (0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::safe_math::safe_mul_div_u64(arg0, arg2, arg1) as u64)
    }
    ...
    fun mint_lsp_token<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        let v4 = if (v3 == 0) {
            ...
            0x2::math::min(0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::safe_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg1), v3, v1), 0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg2), v3, v0))
        };
        assert!(v4 > 0, 7);
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: KriyaLPToken<T0, T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>) {
        ...
        let v3 = 0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::safe_math::safe_mul_div_u64(v0, arg2, v2);
        let v4 = 0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::safe_math::safe_mul_div_u64(v1, arg2, v2);
        assert!(v3 > 0 && v4 > 0, 0);
    ...
    public fun swap_token_x<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v6 = if (arg0.is_stable) {
            0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::utils::get_input_price_stable(arg2 - v5, v3, v2, arg0.lp_fee_percent, arg0.scaleX, arg0.scaleY)
        } else {
            0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::utils::get_input_price_uncorrelated(arg2 - v5, v3, v2, arg0.lp_fee_percent)
        };
        assert!(v6 >= arg3, 8);
    ...
    public fun swap_token_y<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v6 = if (arg0.is_stable) {
            0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::utils::get_input_price_stable(arg2 - v5, v2, v3, arg0.lp_fee_percent, arg0.scaleY, arg0.scaleX)
        } else {
            0xe5113bcc9e8671a713dd86d61a5a05da06fafe8c097ac0a85f943b353717c420::utils::get_input_price_uncorrelated(arg2 - v5, v2, v3, arg0.lp_fee_percent)
        };
        assert!(v6 >= arg3, 8);
