module 0xe50b27c60244d75f77cd8ed5c6263756d76832b63bf77d9bb2ce2920a2db51ff::staking_pool {
    ...
    public entry fun approve_user_stake_config(arg0: &mut StakingPool, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(is_admin(arg0, v0), 4);
        assert!(v0 != arg0.main_admin, 4);
        assert!(0x2::table::contains<address, PendingUserStakeApproval>(&arg0.pending_approvals, arg1), 13);
        let v1 = 0x2::table::borrow_mut<address, PendingUserStakeApproval>(&mut arg0.pending_approvals, arg1);
        let v2 = 0;
    ...
    public entry fun create_staking_pool(arg0: address, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == @0x170c624eff64c35cf9200527ddb953cad11b4fe8679a6902db2ee36d04ac4dc1, 4);
        assert!(arg1 <= 1000, 11);
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public entry fun emergency_restore_admin(arg0: &mut StakingPool, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x170c624eff64c35cf9200527ddb953cad11b4fe8679a6902db2ee36d04ac4dc1, 4);
