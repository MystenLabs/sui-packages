module 0xe5c875c334b04cccc60e3a07046995e2530f23a5944cac9479f7270d23778979::token_factory {
    ...
    fun init(arg0: TOKEN_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_FACTORY>(arg0, 6, b"DESK", b"DESK Token", b"Test Token for Pool Creation", 0x1::option::none<0x2::url::Url>(), arg1);
