module 0xe5c7bfdce3afff86c2279c37be69339a4a3c439245bdc081771d522f2b064484::reward5169 {
    struct REWARD5169 has drop {
        dummy_field: bool,
    }

    struct TICKET_5169 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5169(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5169>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5169>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5169, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5169>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5169>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5169>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5169>>(v5, 0x2::tx_context::sender(arg1));
    }
