module 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::allocator {
    ...
    public(friend) fun add_new_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == false, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::pool_already_present_error());
    ...
    public(friend) fun delete_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, PoolInfo>(&arg0.members, &arg1) == true, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::pool_not_present_error());
        ...
        assert!(v3 == true, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::pool_has_weight_error());
        assert!(v4 == false, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::pending_rewards_error());
    ...
    public(friend) fun top_up_pools<T0>(arg0: &mut Allocator, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg2 <= arg3, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::unlock_time_exceeded_error());
