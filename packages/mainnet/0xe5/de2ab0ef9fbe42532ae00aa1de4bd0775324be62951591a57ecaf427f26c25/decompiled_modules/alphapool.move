module 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::alphapool {
    ...
    fun assert_receipt<T0>(arg0: &Receipt, arg1: &Pool<T0>) {
        assert!(arg0.pool_id == 0x2::object::uid_to_inner(&arg1.id), 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::invalid_receipt_error());
    }

    public fun create<T0>(arg0: &0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::alpha::AdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: &0x2::clock::Clock, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool<T0>{
    ...
    public fun deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Receipt {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, 0x2::balance::value<T0>(&v1) * arg1.deposit_fee / 10000), arg5), 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::get_fee_wallet_address(arg2));
    ...
    public fun destroy_receipt_and_transfer_rewards<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.xTokenBalance == 0, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::receipt_not_empty());
        let v0 = &mut arg0;
    ...
    public fun get_pool_rewards_all<T0>(arg0: &mut Pool<T0>, arg1: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        get_rewards<T0, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::alpha::ALPHA>(arg0, arg1, arg2, arg3);
        get_rewards<T0, 0x2::sui::SUI>(arg0, arg1, arg2, arg3);
    }

    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x1::type_name::get<0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::alpha::ALPHA>()) {
            0x2::balance::join<T0>(&mut arg0.alpha_bal, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::get_rewards<T0>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3));
        } else {
            let v1 = 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    public fun get_user_rewards<T0, T1>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
    ...
    public fun get_user_rewards_all<T0>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun set_deposit_fee<T0>(arg0: &0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::alpha::AdminCap, arg1: &mut Pool<T0>, arg2: u64) {
        assert!(arg2 <= arg1.deposit_fee_max_cap, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::fee_too_high_error());
        arg1.deposit_fee = arg2;
    }

    public entry fun set_lock_period<T0>(arg0: &0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::alpha::AdminCap, arg1: &mut Pool<T0>, arg2: u64) {
        arg1.locked_period_in_days = arg2;
    }

    public fun set_withdrawal_fee<T0>(arg0: &0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::alpha::AdminCap, arg1: &mut Pool<T0>, arg2: u64) {
        assert!(arg2 <= arg1.withdraw_fee_max_cap, 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::fee_too_high_error());
    ...
    public fun user_deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = deposit<T0>(arg0, arg1, arg2, arg3, arg4, arg5);
        0x2::transfer::public_transfer<Receipt>(v0, 0x2::tx_context::sender(arg5));
    }

    public fun user_withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        if (arg5 == true) {
            assert!(arg3 <= (((arg0.xTokenBalance as u256) * v1 / (1000000000 as u256)) as u64), 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::insufficient_balance_error());
        } else {
            assert!(arg3 <= (arg0.balance as u64), 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::error::insufficient_balance_error());
        };
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.alpha_bal, v9), arg6), 0x825a81d9292a72d1772a43ad5e5bbf33d6b48426ce5ce6a220b93d4368a0d850::distributor::get_fee_wallet_address(arg2));
