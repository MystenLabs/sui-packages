module 0xe5191923cb37f96b6277b1e4c7200b9b07e963872b53c1d2f03f99fe004b0180::reward7340 {
    struct REWARD7340 has drop {
        dummy_field: bool,
    }

    struct TICKET_7340 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7340(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7340>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7340>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7340, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7340>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7340>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7340>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7340>>(v5, 0x2::tx_context::sender(arg1));
    }
