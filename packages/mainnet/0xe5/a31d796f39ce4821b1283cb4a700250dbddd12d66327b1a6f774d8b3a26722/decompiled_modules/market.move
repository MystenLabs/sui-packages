module 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::market {
    struct AdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct Store has store {
        obj: 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20,
        price: u64,
        owner: address,
    }
    ...
    public fun buy(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let (_, v7) = 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::get_sui20_data(&v5);
        ...
        0x2::transfer::public_transfer<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(v5, v0);
    ...
    public fun buy_v2(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let (_, v12) = 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::get_sui20_data(&v10);
        let v13 = 0x2::object::id<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(&v10);
        ...
        0x2::transfer::public_transfer<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(v10, v0);
    ...
    public fun delist(arg0: &mut Global, arg1: 0x1::string::String, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v4 == v0, 1003);
        0x2::transfer::public_transfer<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(v2, v0);
    ...
    public fun delist_v2(arg0: &mut Global, arg1: 0x1::string::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v2;
        assert!(v6 == v0, 1003);
        let v11 = 0x2::object::id<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(&v10);
        ...
        if (0x2::table::contains<address, UserInfo>(&v1.user_infos, v0)) {
            ...
            while (v10 < 0x1::vector::length<0x2::object::ID>(&v9)) {
                ...
                if (0x2::bag::contains<0x2::object::ID>(&v1.stores, v11)) {
                    ...
                    let (_, v14) = 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::get_sui20_data(&v12.obj);
                    let v15 = ListedItem{
                        id     : v11,
                        amount : v14,
                        price  : v12.price,
    ...
    public fun get_market_data_v2(arg0: &Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, UserInfo>(&v1.user_infos, v0)) {
            ...
            while (v11 < 0x1::vector::length<0x2::object::ID>(&v10)) {
                ...
                if (0x2::bag::contains<0x2::object::ID>(&v1.stores, v12)) {
                    ...
                    let (_, v15) = 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::get_sui20_data(&v13.obj);
                    let v16 = ListedItem{
                        id     : v12,
                        amount : v15,
                        price  : v13.price,
        ...
        while (0x2::bag::contains<u64>(&v1.stores, v18) && v19 < arg4) {
            ...
            let (_, v22) = 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::get_sui20_data(&v20.obj);
            let v23 = ListedItemV2{
                store_index   : v18,
                id            : 0x2::object::id<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(&v20.obj),
                amount        : v22,
                price         : v20.price,
    ...
    public fun list(arg0: &mut Global, arg1: 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        only_allowed_version(arg0);
        only_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        let (v1, v2) = 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::get_sui20_data(&arg1);
        assert!(v2 > 0, 1006);
        assert!(arg2 > 0, 1005);
        let v3 = 0x2::object::id<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(&arg1);
        let v4 = Store{
            obj   : arg1,
            price : arg2,
    ...
    public fun list_v2(arg0: &mut Global, arg1: &mut 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Global, arg2: 0x1::string::String, arg3: vector<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        only_allowed_version(arg0);
        only_not_paused(arg0);
        assert!(arg4 > 0, 1005);
        let v0 = 0x2::tx_context::sender(arg5);
        let (v1, v2) = 0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::merge(arg1, arg2, arg3, arg5);
        let v3 = v1;
        assert!(v2 > 0, 1006);
        ...
        0x1::vector::push_back<0x2::object::ID>(&mut 0x2::table::borrow_mut<address, UserInfo>(&mut v4.user_infos, v0).listed_ids, 0x2::object::id<0xe5a31d796f39ce4821b1283cb4a700250dbddd12d66327b1a6f774d8b3a26722::sui20::Sui20>(&v3));
        v10.size = v10.size + 1;
