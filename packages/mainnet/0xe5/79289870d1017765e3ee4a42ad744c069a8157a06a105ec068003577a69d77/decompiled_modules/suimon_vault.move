module 0xe579289870d1017765e3ee4a42ad744c069a8157a06a105ec068003577a69d77::suimon_vault {
    struct SUIMON_VAULT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUIMON_VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIMON_VAULT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Suimon Vault"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Your one stop shop for humor, family & positivity. Welcome to Suimon, a CTO bred memecoin operating on Sui."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifnylwdruaznbpni57jw54j4zo2aondiwxdtedzq2nboveevxcl4y"));
