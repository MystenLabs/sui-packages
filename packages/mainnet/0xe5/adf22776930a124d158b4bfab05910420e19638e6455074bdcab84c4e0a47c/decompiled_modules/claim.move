module 0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::claim {
    ...
    public fun generate(arg0: &0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::Agent, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : Claim {
        assert!(0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::owner(arg0) == 0x2::tx_context::sender(arg2), 0);
        let v0 = 0x2::tx_context::epoch_timestamp_ms(arg2);
        let v1 = Claim{
            id                : 0x2::object::new(arg2),
            agent_id          : 0x2::object::id<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::Agent>(arg0),
    ...
    public fun generate_and_share(arg0: &0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::Agent, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Claim>(generate(arg0, arg1, arg2));
    }

    public fun generate_and_transfer(arg0: &0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::Agent, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun revoke(arg0: &mut Claim, arg1: &0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::Agent, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::owner(arg1) == 0x2::tx_context::sender(arg2), 0);
        assert!(0x2::object::id<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::agent::Agent>(arg1) == arg0.agent_id, 1);
        arg0.status = 2;
        let v0 = ClaimRevoked{
