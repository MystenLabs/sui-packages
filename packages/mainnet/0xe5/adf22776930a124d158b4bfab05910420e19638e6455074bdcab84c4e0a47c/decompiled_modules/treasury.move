module 0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::treasury {
    ...
    struct Treasury has key {
        ...
        balance: 0x2::balance::Balance<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>,
        total_collected: u64,
        total_withdrawn: u64,
        fee_bps: u64,
    ...
    public fun balance(arg0: &Treasury) : u64 {
        0x2::balance::value<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(&arg0.balance)
    }
    ...
    public(friend) fun create(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v2 = Treasury{
            ...
            balance              : 0x2::balance::zero<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(),
            total_collected      : 0,
            total_withdrawn      : 0,
            fee_bps              : v1,
    ...
    public(friend) fun deposit(arg0: &mut Treasury, arg1: 0x2::coin::Coin<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>) {
        let v0 = 0x2::coin::value<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(&arg1);
        0x2::balance::join<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(&mut arg0.balance, 0x2::coin::into_balance<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(arg1));
    ...
    public fun emergency_withdraw(arg0: &mut Treasury, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::balance::value<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(&arg0.balance);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>>(0x2::coin::from_balance<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(0x2::balance::withdraw_all<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(&mut arg0.balance), arg2), arg1);
    ...
    public fun withdraw(arg0: &mut Treasury, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(&arg0.balance) >= arg1, 7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>>(0x2::coin::from_balance<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(0x2::balance::split<0xe5adf22776930a124d158b4bfab05910420e19638e6455074bdcab84c4e0a47c::types::USDC>(&mut arg0.balance, arg1), arg3), arg2);
