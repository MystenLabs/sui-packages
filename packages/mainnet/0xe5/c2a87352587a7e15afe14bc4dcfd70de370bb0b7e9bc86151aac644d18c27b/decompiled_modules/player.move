module 0xe5c2a87352587a7e15afe14bc4dcfd70de370bb0b7e9bc86151aac644d18c27b::player {
    ...
    public(friend) fun assert_can_play(arg0: &Player, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 13906834736985014287);
        let v0 = 0x2::tx_context::sender(arg2);
        if (v0 == arg0.owner) {
            return
        };
        assert!(v0 == arg0.session_addr && 0x2::clock::timestamp_ms(arg1) < arg0.session_expires_ms, 13906834762753900545);
    }

    public(friend) fun assert_idle(arg0: &Player) {
        assert!(0x1::option::is_none<ActiveAction>(&arg0.action), 13906835308215402507);
    }
    ...
    public fun create_player(arg0: &0xe5c2a87352587a7e15afe14bc4dcfd70de370bb0b7e9bc86151aac644d18c27b::registry::Registry, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Player{
            ...
            name               : arg1,
            coins              : 0xe5c2a87352587a7e15afe14bc4dcfd70de370bb0b7e9bc86151aac644d18c27b::registry::start_coins(arg0),
            inventory          : 0x2::vec_map::empty<u16, u64>(),
            xp                 : v0,
            location           : 0xe5c2a87352587a7e15afe14bc4dcfd70de370bb0b7e9bc86151aac644d18c27b::registry::start_location(arg0),
    ...
    public(friend) fun debit_coins(arg0: &mut Player, arg1: u64) {
        assert!(arg0.coins >= arg1, 13906835110646644743);
        arg0.coins = arg0.coins - arg1;
    }
    ...
    public(friend) fun debit_enemies(arg0: &mut Player, arg1: u16, arg2: u64) {
        ...
        assert!(enemy_count(arg0, arg1) >= arg2, 13906835200841089033);
        let v0 = 0x2::vec_map::get_mut<u16, u64>(&mut arg0.enemy_pool, &arg1);
        *v0 = *v0 - arg2;
        if (*v0 == 0) {
    ...
    public(friend) fun debit_item(arg0: &mut Player, arg1: u16, arg2: u64) {
        ...
        assert!(item_qty(arg0, arg1) >= arg2, 13906835054811938821);
        let v0 = 0x2::vec_map::get_mut<u16, u64>(&mut arg0.inventory, &arg1);
        *v0 = *v0 - arg2;
        if (*v0 == 0) {
    ...
    public fun end_session(arg0: &mut Player, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg0.owner || v0 == arg0.session_addr, 13906834956027428865);
        let v1 = SessionEnded{
    ...
    public fun skill_level(arg0: &Player, arg1: u8) : u8 {
        0xe5c2a87352587a7e15afe14bc4dcfd70de370bb0b7e9bc86151aac644d18c27b::xp::level_for_xp(skill_xp(arg0, arg1))
    }
    ...
    public(friend) fun start_action(arg0: &mut Player, arg1: u8, arg2: vector<u64>, arg3: &0x2::clock::Clock) {
        assert!(0x1::option::is_none<ActiveAction>(&arg0.action), 13906835269560696843);
        let v0 = ActiveAction{
            kind          : arg1,
            params        : arg2,
    ...
    public fun start_session(arg0: &mut Player, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 13906834870129000463);
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 13906834874423181315);
    ...
    public(friend) fun take_action(arg0: &mut Player) : ActiveAction {
        assert!(0x1::option::is_some<ActiveAction>(&arg0.action), 13906835325395402765);
