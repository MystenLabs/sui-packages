module 0x3607d74b9141ed61882e77cf367038f782cd29ad4c5687e25652809fd97e7ade::suimon_nft {
    ...
    public entry fun fix_image_url(arg0: &mut SuimonNFT) {
        let v0 = arg0.name;
        if (v0 == 0x1::string::utf8(b"Plankmon")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/plankmon.png");
        } else if (v0 == 0x1::string::utf8(b"Anti-Jeet")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/anti-jeet.png");
        } else if (v0 == 0x1::string::utf8(b"Anti-Jeet Army")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/anti-jeet.png");
        } else if (v0 == 0x1::string::utf8(b"Burnard")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/burnard.png");
        } else if (v0 == 0x1::string::utf8(b"Suider")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/suideer.png");
        } else if (v0 == 0x1::string::utf8(b"Suideer")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/suideer.png");
        } else if (v0 == 0x1::string::utf8(b"SuiTwo")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/suitwo.png");
        } else if (v0 == 0x1::string::utf8(b"Wagmichu")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/wagmichu.png");
        } else if (v0 == 0x1::string::utf8(b"WagmiChu")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/wagmichu.png");
        } else if (v0 == 0x1::string::utf8(b"Suimaid")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/suimaid.png");
        } else if (v0 == 0x1::string::utf8(b"Hubbabubba")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/hubbabubba.png");
        } else if (v0 == 0x1::string::utf8(b"Hubba Bubba")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/hubbabubba.png");
        } else if (v0 == 0x1::string::utf8(b"Flyquidity")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/flyquidity.png");
        } else if (v0 == 0x1::string::utf8(b"Jengacide")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/jengacide.png");
        } else if (v0 == 0x1::string::utf8(b"Licktide")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/licktide.png");
        } else if (v0 == 0x1::string::utf8(b"Gasper")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/gasper.png");
        } else if (v0 == 0x1::string::utf8(b"Ded Zeppelin")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/dedzeppelin.png");
        } else if (v0 == 0x1::string::utf8(b"Skitachu")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/skitachu.png");
        } else if (v0 == 0x1::string::utf8(b"Barizard")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/barizard.png");
        } else if (v0 == 0x1::string::utf8(b"Piktatofinance")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/piktatofinance.png");
        } else if (v0 == 0x1::string::utf8(b"Tripsi")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/tripsi.png");
        } else if (v0 == 0x1::string::utf8(b"Hopiumdrenched")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/hopiumdrenched.png");
        } else if (v0 == 0x1::string::utf8(b"Hopium Drenched")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/hopiumdrenched.png");
        } else if (v0 == 0x1::string::utf8(b"Toilet Duck")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/toiletduck.png");
        } else if (v0 == 0x1::string::utf8(b"Toiletduck")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/toiletduck.png");
        } else if (v0 == 0x1::string::utf8(b"Poolmon")) {
            arg0.image_url = 0x1::string::utf8(b"https://cutforsuimon.com/nft-images/poolmon.png");
        };
    }
    ...
    public entry fun update_image_url(arg0: &AdminCap, arg1: &mut SuimonNFT, arg2: vector<u8>) {
