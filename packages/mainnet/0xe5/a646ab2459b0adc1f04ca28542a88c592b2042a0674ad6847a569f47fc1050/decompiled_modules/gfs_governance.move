module 0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance {
    ...
    public fun mint_tokens_for_presale(arg0: &mut GovernanceRegistry, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<GFS_GOVERNANCE> {
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 1);
        0x2::coin::mint<GFS_GOVERNANCE>(&mut arg0.treasury_cap, arg1, arg2)
    }
