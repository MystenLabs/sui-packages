module 0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::presale {
    struct PresaleConfig has key {
        ...
        gfs_treasury: 0x2::balance::Balance<0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::GFS_GOVERNANCE>,
        start_time: u64,
        end_time: u64,
    }
    ...
    public entry fun buy_tokens(arg0: &mut PresaleConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::GFS_GOVERNANCE>(&arg0.gfs_treasury) >= v3, 3);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::GFS_GOVERNANCE>>(0x2::coin::take<0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::GFS_GOVERNANCE>(&mut arg0.gfs_treasury, v3, arg3), v1);
    ...
    fun calculate_gfs_amount(arg0: u64) : u64 {
        arg0 * 550 * 1000000000 / 1000000000
    }
    ...
    public fun get_presale_info(arg0: &PresaleConfig) : (bool, u64, u64, u64, u64) {
        (arg0.is_active, arg0.total_tokens_for_sale, arg0.tokens_sold, 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_collected), 0x2::balance::value<0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::GFS_GOVERNANCE>(&arg0.gfs_treasury))
    }

    public entry fun initialize_presale(arg0: &mut 0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::GovernanceRegistry, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PresaleConfig{
            ...
            gfs_treasury          : 0x2::coin::into_balance<0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::GFS_GOVERNANCE>(0xe5a646ab2459b0adc1f04ca28542a88c592b2042a0674ad6847a569f47fc1050::gfs_governance::mint_tokens_for_presale(arg0, arg1, arg5)),
            start_time            : arg2,
            end_time              : arg3,
        };
