module 0xe599a2d0f5ca45225a48b290c2586647d28bb0f97179460ba112ac22b9162655::reward7209 {
    struct REWARD7209 has drop {
        dummy_field: bool,
    }

    struct TICKET_7209 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7209(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7209>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7209>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7209, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7209>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7209>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7209>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7209>>(v5, 0x2::tx_context::sender(arg1));
    }
