module 0xe50f20afd5a6834c8b04daa194e30bc742eea22cc1cf449dc9f518a7d1c355dd::glitchy_collector {
    struct GLITCHY_COLLECTOR has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GLITCHY_COLLECTOR, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GLITCHY_COLLECTOR>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Glitchy Collector"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Glitchy Collector NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifw7mc7rlga7bdzybai5b3bkz77qc6fjwzzn2jrlepw75rxapotxm"));
