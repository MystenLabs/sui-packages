module 0x90332a76b3fdcd84edeb229315b3d623be7d5888aa733d3030b8cee9c53bb4ed::vault {
    ...
    public(friend) fun assert_deposits_enabled<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: u64) {
        assert!(arg0.deposits_enabled && 0x2::balance::value<T2>(&arg0.seed_vt) > 0 && arg1 < arg0.deposit_limit, 0x90332a76b3fdcd84edeb229315b3d623be7d5888aa733d3030b8cee9c53bb4ed::error::deposits_disabled());
    }

    public(friend) fun assert_harvest_cap<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &HarvestCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2>>(arg0), 0x90332a76b3fdcd84edeb229315b3d623be7d5888aa733d3030b8cee9c53bb4ed::error::invalid_harvest_cap());
        assert!(arg1.whitelisted_address == 0x2::tx_context::sender(arg2), 0x90332a76b3fdcd84edeb229315b3d623be7d5888aa733d3030b8cee9c53bb4ed::error::sender_not_whitelisted());
    }

    public(friend) fun assert_vault_cap<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2>>(arg0), 0x90332a76b3fdcd84edeb229315b3d623be7d5888aa733d3030b8cee9c53bb4ed::error::invalid_vault_cap());
    }
