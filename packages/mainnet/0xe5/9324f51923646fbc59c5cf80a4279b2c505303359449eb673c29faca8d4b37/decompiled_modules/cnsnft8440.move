module 0xe59324f51923646fbc59c5cf80a4279b2c505303359449eb673c29faca8d4b37::cnsnft8440 {
    struct CNSNFT8440 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8440, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8440>(arg0, arg1);
