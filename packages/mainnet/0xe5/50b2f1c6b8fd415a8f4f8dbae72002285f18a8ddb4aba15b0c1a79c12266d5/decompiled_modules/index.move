module 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::index {
    ...
    struct RulesKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public(friend) fun assert_admin<T0>(arg0: &Index<T0>, arg1: &AdminCap) {
    ...
    public fun genesis_put<T0, T1>(arg0: &mut Index<T0>, arg1: &mut GenesisTicket, arg2: 0x2::coin::Coin<T1>, arg3: u64) {
        ...
        assert!(arg3 >= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::min_bps()) && arg3 <= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::max_bps()), 13);
        assert!(0x2::vec_map::length<0x1::type_name::TypeName, u64>(&arg0.targets) < rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::max_coins()), 14);
    ...
    public(friend) fun high_for<T0>(arg0: &Index<T0>, arg1: &0x1::type_name::TypeName, arg2: u64) : u64 {
        ...
        if (v0 > 0 && arg2 < v0 + rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::young_ms())) {
            rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::young_max_bps())
        } else {
            rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::max_bps())
        }
    }
    ...
    public fun keeper_swap_begin<T0, T1, T2>(arg0: &mut Index<T0>, arg1: &KeeperCap, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, SwapTicket) {
        ...
        if (!0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.retiring, &v0)) {
            ...
            assert!(v5.out + arg2 <= mul_div(v5.start_holding, rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::keeper_daily_out_bps()), 10000), 17);
            v5.out = v5.out + arg2;
        };
        arg0.busy = true;
        let v7 = SwapTicket{
    ...
    public fun rule<T0>(arg0: &Index<T0>, arg1: u8) : u64 {
        if (arg1 == 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::pol_share_bps()) {
            return pol_share_bps<T0>(arg0)
        };
        let v0 = RulesKey{dummy_field: false};
        if (0x2::dynamic_field::exists<RulesKey>(&arg0.id, v0)) {
            let v2 = RulesKey{dummy_field: false};
            0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::get(0x2::dynamic_field::borrow<RulesKey, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::Rules>(&arg0.id, v2), arg1)
        } else {
            0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::default_of(arg1)
        }
    }

    public fun rule_fits<T0>(arg0: &Index<T0>, arg1: u8, arg2: u64) : bool {
        if (!0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::in_range(arg1, arg2)) {
            return false
        };
        let (_, v1) = 0x2::vec_map::into_keys_values<0x1::type_name::TypeName, u64>(arg0.targets);
        let v2 = v1;
        let v3 = 10000;
        let v4 = 0;
        let v5 = 0;
        while (v5 < 0x1::vector::length<u64>(&v2)) {
            if (*0x1::vector::borrow<u64>(&v2, v5) < v3) {
                v3 = *0x1::vector::borrow<u64>(&v2, v5);
            };
            if (*0x1::vector::borrow<u64>(&v2, v5) > v4) {
                v4 = *0x1::vector::borrow<u64>(&v2, v5);
            };
            v5 = v5 + 1;
        };
        if (arg1 == 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::min_bps()) {
            if (arg2 <= v3) {
                if (arg2 * rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::max_coins()) <= 10000) {
                    arg2 <= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::add_max_bps())
                } else {
                    false
                }
            } else {
            ...
            arg1 == 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::max_bps() && arg2 >= v4 && arg2 >= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::young_max_bps()) || arg1 == 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::max_coins() && arg2 >= 0x1::vector::length<u64>(&v2) && arg2 * rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::min_bps()) <= 10000 || arg1 == 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::add_max_bps() && arg2 >= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::min_bps()) && arg2 <= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::young_max_bps()) || arg1 == 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::young_max_bps() && arg2 >= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::add_max_bps()) && arg2 <= rule<T0>(arg0, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::max_bps()) || true
        }
    }
    ...
    public(friend) fun set_rule<T0>(arg0: &mut Index<T0>, arg1: u8, arg2: u64) {
        if (arg1 == 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::pol_share_bps()) {
            set_pol_share_bps<T0>(arg0, arg2);
            return
        };
        let v0 = RulesKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<RulesKey>(&arg0.id, v0)) {
            let v1 = RulesKey{dummy_field: false};
            0x2::dynamic_field::add<RulesKey, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::Rules>(&mut arg0.id, v1, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::empty());
        };
        let v2 = RulesKey{dummy_field: false};
        0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::set(0x2::dynamic_field::borrow_mut<RulesKey, 0x54e8315e419c9768faf889e36a0a12c90287e14669903f20f92f0ce9a8013c2::rules::Rules>(&mut arg0.id, v2), arg1, arg2);
    }
