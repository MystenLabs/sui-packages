module 0xe598db7a1eea31cca5611d734d7c4a8a69d1fd21a68201ae1a215cda42bca0ae::reward1243 {
    struct REWARD1243 has drop {
        dummy_field: bool,
    }

    struct TICKET_1243 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1243(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1243>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1243>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1243, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1243>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1243>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1243>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1243>>(v5, 0x2::tx_context::sender(arg1));
    }
