module 0xe57ee3613b7dece546f8a2d8a53145cbab41d32b86037b94f9ebfcbcfa66885a::config {
    ...
    public fun update_mist_required_per_order(arg0: &0xe57ee3613b7dece546f8a2d8a53145cbab41d32b86037b94f9ebfcbcfa66885a::admin::AdminCap, arg1: &mut Config, arg2: u64) {
        assert_interacting_with_most_up_to_date_package(arg1);
        arg1.mist_required_per_order = arg2;
    }

    public fun update_total_protocol_fee_bps(arg0: &0xe57ee3613b7dece546f8a2d8a53145cbab41d32b86037b94f9ebfcbcfa66885a::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
        assert!(arg2 <= 1000, 9223372779884511239);
        arg1.total_protocol_fee_bps = arg2;
    }

    public fun update_treasury_fee_bps(arg0: &0xe57ee3613b7dece546f8a2d8a53145cbab41d32b86037b94f9ebfcbcfa66885a::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
        assert!(arg2 <= 10000, 9223372848604119049);
        arg1.treasury_fee_bps = arg2;
    }

    public fun upgrade_version(arg0: &0xe57ee3613b7dece546f8a2d8a53145cbab41d32b86037b94f9ebfcbcfa66885a::admin::AdminCap, arg1: &mut Config) {
