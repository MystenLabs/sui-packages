module 0xe5fe52bae057e3713776e1a01cea37ba8aebdbc2c699edc677290c699fa074f2::Navi_Reward_W9 {
    struct NAVI_REWARD_W9 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun GiveReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmXiJgX1qsx8tbuLvWQpxDzg16YXgiMzPAys5jirWENt2n"),
            };
    ...
    fun init(arg0: NAVI_REWARD_W9, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmXiJgX1qsx8tbuLvWQpxDzg16YXgiMzPAys5jirWENt2n"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<NAVI_REWARD_W9>(arg0, arg1);
