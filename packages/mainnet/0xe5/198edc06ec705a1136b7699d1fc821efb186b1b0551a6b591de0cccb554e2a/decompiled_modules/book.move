module 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::book {
    ...
    fun inject_taker_order(arg0: &Order, arg1: &TradeProof) : bool {
        let v0 = if (arg0.ord_type <= 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::ord_cross()) {
            true
        } else if (arg0.status >= 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::filled()) {
            true
        } else {
    ...
    public(friend) fun place_cross(arg0: &mut Book, arg1: &OrderInfo, arg2: u64) : (0x1::option::Option<Bill>, 0x1::option::Option<ExpiredBill>, address, u64) {
        ...
        let v4 = if (arg1.ord_type == 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::ord_cross()) {
        ...
        assert!(v4, 18);
        let v5 = to_order(0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::obutils::encode_order_id(arg1.is_bid, arg1.price, v0), arg1);
        let v6 = &mut v5;
        setStatus(v6, 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::live());
        if (order_expired0(v3, arg2)) {
            ...
            let v13 = &mut v5;
            setStatus(v13, 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::completed());
            let v14 = Bill{
                taker_is_bid : true,
            ...
            0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::big_vector::remove<Order>(v15, v1);
    ...
    fun validate_inputs(arg0: &OrderInfo, arg1: u64, arg2: u64, arg3: u64) {
        ...
        let v0 = if (arg0.ord_type < 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::ord_limit() && arg0.price == 0) {
            true
        } else if (arg0.ord_type == 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::ord_limit()) {
            if (arg0.price >= 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::min_price()) {
                arg0.price <= 0x31d43b2cdf40b24b265085005b3d93081eb1edefa574a300a4de08594fe37a4e::constants::max_price()
            } else {
                false
            }
        } else {
