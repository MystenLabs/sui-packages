module 0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::insurance {
    ...
    entry fun new<T0>(arg0: &0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::launchpad::Launchpad, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Fund<T0>{
    ...
    public(friend) fun claim_refund<T0, T1, T2>(arg0: &mut Fund<T0>, arg1: &CampaignRefundAllowance, arg2: &0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::vault::InvestCertificate, arg3: &0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::vault::Vault<T1, T2>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.campaign_id == 0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::vault::get_certificate_campaign_id(arg2), 1);
        let v0 = 0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::vault::get_user_deposit(arg2);
        let v1 = 0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::vault::get_user_total_reward<T1, T2>(arg3, arg2) * arg1.real_avg_price / (10000000 as u64);
        assert!(v0 > v1, 4);
        let v2 = v0 - v1;
    ...
    entry fun issue_refund_allowance(arg0: &0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::launchpad::Launchpad, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun set_operator<T0>(arg0: &0xe5f567e6f1a232ecbbc392cbb22ac518ed195c5ca8b4854e731a19e7242d60d2::launchpad::Launchpad, arg1: &mut Fund<T0>, arg2: address) {
        arg1.operator = arg2;
    }
