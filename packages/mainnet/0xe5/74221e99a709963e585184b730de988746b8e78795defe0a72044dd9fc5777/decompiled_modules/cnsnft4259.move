module 0xe574221e99a709963e585184b730de988746b8e78795defe0a72044dd9fc5777::cnsnft4259 {
    struct CNSNFT4259 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4259, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4259>(arg0, arg1);
