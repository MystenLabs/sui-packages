module 0xe54038d1f4fdc7ed48904c21047c345ef0d3b14bc129f62358f261666784dc39::reward5916 {
    struct REWARD5916 has drop {
        dummy_field: bool,
    }

    struct TICKET_5916 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5916(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5916>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5916>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5916, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5916>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5916>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5916>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5916>>(v5, 0x2::tx_context::sender(arg1));
    }
