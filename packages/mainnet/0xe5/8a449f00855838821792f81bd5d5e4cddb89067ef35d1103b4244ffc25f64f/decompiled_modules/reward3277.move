module 0xe58a449f00855838821792f81bd5d5e4cddb89067ef35d1103b4244ffc25f64f::reward3277 {
    struct REWARD3277 has drop {
        dummy_field: bool,
    }

    struct TICKET_3277 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3277(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3277>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3277>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3277, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3277>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3277>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3277>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3277>>(v5, 0x2::tx_context::sender(arg1));
    }
