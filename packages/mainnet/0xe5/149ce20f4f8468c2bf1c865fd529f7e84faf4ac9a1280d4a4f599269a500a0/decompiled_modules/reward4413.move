module 0xe5149ce20f4f8468c2bf1c865fd529f7e84faf4ac9a1280d4a4f599269a500a0::reward4413 {
    struct REWARD4413 has drop {
        dummy_field: bool,
    }

    struct TICKET_4413 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4413(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4413>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4413>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4413, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4413>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4413>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4413>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4413>>(v5, 0x2::tx_context::sender(arg1));
    }
