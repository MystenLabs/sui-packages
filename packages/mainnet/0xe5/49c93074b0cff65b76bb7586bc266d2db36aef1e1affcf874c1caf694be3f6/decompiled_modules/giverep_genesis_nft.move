module 0xe549c93074b0cff65b76bb7586bc266d2db36aef1e1affcf874c1caf694be3f6::giverep_genesis_nft {
    ...
    fun init(arg0: GIVEREP_GENESIS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"GiveRep Genesis NFT "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreia532q2ztj2vspfqfuherm655ol2y3xc47hor3k3i3i66thdgrxsm"));
