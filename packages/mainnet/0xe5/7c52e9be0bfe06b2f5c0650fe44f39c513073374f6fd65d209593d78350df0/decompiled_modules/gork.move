module 0xe57c52e9be0bfe06b2f5c0650fe44f39c513073374f6fd65d209593d78350df0::gork {
    ...
    fun init(arg0: GORK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/8jVuUsRGrUEjPK6XUnGQh6CXD9DRpwoxedwPWgUrpump.png                                                                                                                                                                                                                               ");
