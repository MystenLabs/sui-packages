module 0xe5e8530dd00b3b52c9a9af16a3d556796a1723720e1c0aed960d411ce42783bc::mumumu {
    ...
    struct Mumumu has key {
        ...
        kiosk_table: 0x2::table::Table<address, 0x2::object::ID>,
    }
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v12 = Mumumu{
            ...
            kiosk_table         : 0x2::table::new<address, 0x2::object::ID>(arg1),
        };
    ...
    fun mint_nft(arg0: &mut Mumumu, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg2) {
            ...
            if (!0x2::table::contains<address, 0x2::object::ID>(&arg0.kiosk_table, arg1)) {
                let (v4, v5) = 0x2::kiosk::new(arg3);
                let v6 = v4;
                0x2::table::add<address, 0x2::object::ID>(&mut arg0.kiosk_table, arg1, 0x2::object::id<0x2::kiosk::Kiosk>(&v6));
                0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v5, arg1);
                0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v6);
            };
            0x2::transfer::public_transfer<NFT>(v2, arg1);
            v0 = v0 + 1;
        };
    }
