module 0xe51d888b0f3b4be123dea5cb976f644d5fd3fe829dbd84089eb1c22b9f598673::metasui {
    ...
    fun init(arg0: METASUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<METASUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"MetaSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Metaverse avatars and worlds, designed and collectible on Sui."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidm7aick2vlnonpevgt3pdhxwbkrzldd2u62dhaparvbafyjrxwnq"));
