module 0xe5613666c33a1ded840c10ec23ad890f8c46a49940a4b728b03bd16386381d02::cnsnft7572 {
    struct CNSNFT7572 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7572, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7572>(arg0, arg1);
