module 0xe557afe4a862d0aa100ecae8547946b2a3acc3c8d718145b9616da3beafd4627::cnsnft2230 {
    struct CNSNFT2230 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2230, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2230>(arg0, arg1);
