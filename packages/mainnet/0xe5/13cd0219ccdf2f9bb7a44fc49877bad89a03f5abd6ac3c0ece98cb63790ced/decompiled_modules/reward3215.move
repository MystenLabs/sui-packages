module 0xe513cd0219ccdf2f9bb7a44fc49877bad89a03f5abd6ac3c0ece98cb63790ced::reward3215 {
    struct REWARD3215 has drop {
        dummy_field: bool,
    }

    struct TICKET_3215 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3215(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_3215>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3215, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3215>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3215>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3215>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3215>>(v5, 0x2::tx_context::sender(arg1));
    }
