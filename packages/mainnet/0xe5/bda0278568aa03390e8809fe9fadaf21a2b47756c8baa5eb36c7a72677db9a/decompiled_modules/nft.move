module 0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::nft {
    ...
    fun create_meme_nft(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::blob::Blob, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::capability::new_creator_cap(v2, arg6);
        0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::meme_events::emit_meme_nft_created(v2, v0, v3.title, 0x1::option::none<0x2::object::ID>(), 0x2::tx_context::epoch(arg6));
        0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::meme_events::emit_creator_cap_created(0x2::object::id<0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::capability::CreatorCap>(&v4), v2);
        0x2::transfer::share_object<MemeNFT>(v3);
        0x2::transfer::public_transfer<0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::capability::CreatorCap>(v4, v0);
    }
    ...
    fun create_remix_nft(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::blob::Blob, arg5: vector<u8>, arg6: &mut MemeNFT, arg7: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = 0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::capability::new_creator_cap(v2, arg8);
        0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::meme_events::emit_meme_nft_created(v2, v0, v9.title, 0x1::option::some<0x2::object::ID>(v3), 0x2::tx_context::epoch(arg8));
        0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::meme_events::emit_creator_cap_created(0x2::object::id<0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::capability::CreatorCap>(&v10), v2);
        0x2::transfer::share_object<MemeNFT>(v9);
        0x2::transfer::public_transfer<0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::capability::CreatorCap>(v10, v0);
    }
    ...
    public fun extend_blob_public(arg0: &mut MemeNFT, arg1: &0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::admin::ExtendConfig, arg2: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg3: u32, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xe5bda0278568aa03390e8809fe9fadaf21a2b47756c8baa5eb36c7a72677db9a::admin::get_extend_reward(arg1);
