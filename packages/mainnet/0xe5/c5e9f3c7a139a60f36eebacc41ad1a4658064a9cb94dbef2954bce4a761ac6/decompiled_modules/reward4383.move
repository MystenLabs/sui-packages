module 0xe5c5e9f3c7a139a60f36eebacc41ad1a4658064a9cb94dbef2954bce4a761ac6::reward4383 {
    struct REWARD4383 has drop {
        dummy_field: bool,
    }

    struct TICKET_4383 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4383(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4383>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4383>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4383, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4383>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4383>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4383>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4383>>(v5, 0x2::tx_context::sender(arg1));
    }
