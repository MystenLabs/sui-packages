module 0xe51beabe62f36e96a5129d0ecf869a4da2b66a5d418044b66a2e50ead8988a49::game9077 {
    struct GAME9077 has drop {
        dummy_field: bool,
    }

    struct TICKET_9077 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9077(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9077>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9077>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME9077, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME9077>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9077>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9077>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9077>>(v5, 0x2::tx_context::sender(arg1));
    }
