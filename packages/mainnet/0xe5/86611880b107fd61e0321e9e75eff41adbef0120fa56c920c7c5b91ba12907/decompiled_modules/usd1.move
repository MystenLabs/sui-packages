module 0xe586611880b107fd61e0321e9e75eff41adbef0120fa56c920c7c5b91ba12907::usd1 {
    ...
    fun init(arg0: USD1, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USD1>(arg0, 9, b"USD1", b"USD1", b"This is USD1. ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://node1.irys.xyz/PlSssRTBGYNrA-JOA2YzbNcaz4XLEMPm4ALyfAKKqpE")), arg1);
