module 0xe5e6e7c1a7dbbbbf9ce1552d12389b7bbb620ed95824bfa1f70000fef47a0907::cnsnft4713 {
    struct CNSNFT4713 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4713, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4713>(arg0, arg1);
