module 0xe5b5e7df77e1a79fe8d8140b0d04c16c4144215cf5560dcbad282927c2af87de::vram {
    ...
    fun new(arg0: u64, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) : VramNFT {
        ...
        VramNFT{
            ...
            image_url   : 0x1::string::utf8(b"https://vram.mypinata.cloud/ipfs/bafybeiem5nqu6agk2q455pzpwbyew5pt6bi37qpcul26xmcvltcla3k3lq"),
            description : arg1,
    ...
    public entry fun add_attrkeys_list(arg0: address, arg1: vector<0x1::string::String>, arg2: &mut Treasury, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(@0x843a4c7ad62d90c8b6ad23a807baa5ade4ee2efac64e4a31d8b31e4caed282f5 == 0x2::tx_context::sender(arg3), 0);
    ...
    public entry fun add_whitelist(arg0: address, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(@0x843a4c7ad62d90c8b6ad23a807baa5ade4ee2efac64e4a31d8b31e4caed282f5 == 0x2::tx_context::sender(arg2), 0);
    ...
    public entry fun admin_withdraw(arg0: &mut Treasury, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(@0x843a4c7ad62d90c8b6ad23a807baa5ade4ee2efac64e4a31d8b31e4caed282f5 == 0x2::tx_context::sender(arg1), 0);
    ...
    fun init(arg0: VRAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"https://vram.mypinata.cloud/ipfs/bafybeiem5nqu6agk2q455pzpwbyew5pt6bi37qpcul26xmcvltcla3k3lq"));
        ...
        let v4 = v3;
        let v5 = v2;
        0xe5b5e7df77e1a79fe8d8140b0d04c16c4144215cf5560dcbad282927c2af87de::kiosk_lock_rule::add<VramNFT>(&mut v5, &v4);
        0xe5b5e7df77e1a79fe8d8140b0d04c16c4144215cf5560dcbad282927c2af87de::royalty_rule::add<VramNFT>(&mut v5, &v4, 500, 0);
    ...
    entry fun mint(arg0: u64, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(@0x843a4c7ad62d90c8b6ad23a807baa5ade4ee2efac64e4a31d8b31e4caed282f5 == 0x2::tx_context::sender(arg4), 0);
