module 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::deepbook {
    ...
    public fun swap_exact_quantity<T0, T1, T2, T3>(arg0: &mut 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::checkpoint::Payload<T2, T3>, arg1: &mut DeepPool, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (_, _, v5) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::get_quantity_out<T0, T1>(arg2, 0x2::balance::value<T0>(&v0), 0x2::balance::value<T1>(&v1), arg4);
        let (v6, v7) = if (0x2::balance::value<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&arg1.balance) >= v5) {
            (0x2::coin::from_balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(0x2::balance::split<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&mut arg1.balance, v5), arg5), true)
        } else {
        ...
        if (v7) {
            ...
            if (arg3) {
                0x2::balance::join<T0>(&mut v8, 0x2::balance::split<T0>(&mut v0, v2 * v10 / 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::constant::scalar() * 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::constant::deepbook_fee_penalty_rate() / 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::constant::deepbook_fee_penalty_rate_multiplier()));
            } else {
                0x2::balance::join<T1>(&mut v9, 0x2::balance::split<T1>(&mut v1, v2 * v10 / 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::constant::scalar() * 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::constant::deepbook_fee_penalty_rate() / 0x9425470f697c81f30c1b30e83202172ffffc1fcaacb75a0abcbb5a35c1a036e9::constant::deepbook_fee_penalty_rate_multiplier()));
            };
        };
        let (v13, v14, v15) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::swap_exact_quantity<T0, T1>(arg2, 0x2::coin::from_balance<T0>(v0, arg5), 0x2::coin::from_balance<T1>(v1, arg5), v6, 0, arg4, arg5);
        let v16 = v15;
        let v17 = v14;
        let v18 = v13;
        assert!(0x2::coin::value<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&v16) == 0, 0);
        ...
        if (arg3) {
            ...
            if (0x2::coin::value<T0>(&v18) == 0) {
                ...
                0x2::balance::join<T0>(&mut v8, 0x2::coin::into_balance<T0>(v18));
            };
        } else {
            ...
            if (0x2::coin::value<T1>(&v17) == 0) {
                ...
                0x2::balance::join<T1>(&mut v9, 0x2::coin::into_balance<T1>(v17));
            };
        };
        (v8, v9)
    }
