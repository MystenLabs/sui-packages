module 0xc813dd750cff7592251334cd65e5d34a368cd6fbe3207103978415fbff877057::collection {
    ...
    entry fun reveal_many_and_lock(arg0: &mut Collection, arg1: vector<Pumplienz>, arg2: &0x2::transfer_policy::TransferPolicy<Pumplienz>, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<Pumplienz>(&arg1);
        assert!(v0 > 0, 4);
        assert!(v0 <= 10, 6);
        ...
        let v5 = v2;
        while (!0x1::vector::is_empty<Pumplienz>(&arg1)) {
            let v6 = 0x1::vector::pop_back<Pumplienz>(&mut arg1);
            let v7 = &mut v6;
            let v8 = &mut v1;
            reveal_inner(arg0, v7, v8, arg4);
            0x2::kiosk::lock<Pumplienz>(&mut v5, &v4, arg2, v6);
        };
        0x1::vector::destroy_empty<Pumplienz>(arg1);
    ...
    entry fun reveal_many_in_personal_kiosk(arg0: &mut Collection, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg3: vector<0x2::object::ID>, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        while (v3 < v0) {
            let v4 = 0x2::kiosk::borrow_mut<Pumplienz>(arg1, v1, *0x1::vector::borrow<0x2::object::ID>(&arg3, v3));
            let v5 = &mut v2;
