module 0xe58d59d31dd49c3a96e46f5a1141336a5aea28e2cfaedd068b8ababb81776e86::reward6277 {
    struct REWARD6277 has drop {
        dummy_field: bool,
    }

    struct TICKET_6277 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6277(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6277>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6277>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6277, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6277>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6277>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6277>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6277>>(v5, 0x2::tx_context::sender(arg1));
    }
