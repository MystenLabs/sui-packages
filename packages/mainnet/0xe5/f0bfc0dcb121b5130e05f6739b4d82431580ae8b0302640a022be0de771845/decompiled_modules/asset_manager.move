module 0xa17a409164d1676db71b411ab50813ba2c7dd547d2df538c699049566f1ff922::asset_manager {
    struct ExecutorKey has copy, drop, store {
        executor: address,
    }
    ...
    public fun is_executor(arg0: &Config, arg1: address) : bool {
        let v0 = ExecutorKey{executor: arg1};
        0x2::dynamic_field::exists_<ExecutorKey>(&arg0.id, v0)
    }
    ...
    entry fun recv_message<T0>(arg0: &mut Config, arg1: &mut 0xf3b1e696a66d02cb776dc15aae73c68bc8f03adcb6ba0ec7f6332d9d90a6a3d2::connectionv3::State, arg2: &mut 0x4a25336d949648eddf4b5cf78e46d67bc529efffe4a5cca5169164116a56ea48::rate_limits::Config, arg3: u256, arg4: vector<u8>, arg5: u256, arg6: vector<u8>, arg7: vector<vector<u8>>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        enforce_version(arg0, 7);
        assert!(is_executor(arg0, 0x2::tx_context::sender(arg9)), 4);
    ...
    entry fun set_executor(arg0: &mut Config, arg1: address, arg2: bool, arg3: &AdminCap) {
        enforce_version(arg0, 7);
        let v0 = ExecutorKey{executor: arg1};
        if (arg2) {
            if (!0x2::dynamic_field::exists_<ExecutorKey>(&arg0.id, v0)) {
                0x2::dynamic_field::add<ExecutorKey, bool>(&mut arg0.id, v0, true);
            };
        } else if (0x2::dynamic_field::exists_<ExecutorKey>(&arg0.id, v0)) {
            0x2::dynamic_field::remove<ExecutorKey, bool>(&mut arg0.id, v0);
        };
    }
