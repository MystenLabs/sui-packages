module 0xe50669ea0e135918ad85fcd6ba3779aaefc36e16b8d51dbedb6ddf01378d567c::cnsnft8691 {
    struct CNSNFT8691 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8691, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8691>(arg0, arg1);
