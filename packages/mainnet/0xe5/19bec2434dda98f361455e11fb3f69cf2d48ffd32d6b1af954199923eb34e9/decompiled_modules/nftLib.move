module 0xe519bec2434dda98f361455e11fb3f69cf2d48ffd32d6b1af954199923eb34e9::nftLib {
        ...
        while (v0 <= 0x2::vec_map::size<u64, Achievement>(&arg0.achievements)) {
            ...
            while (v2 < 0x1::vector::length<u8>(&arg4)) {
                ...
                if (v3 == v1.achievementType) {
                    if (v1.communityId != arg2 && v1.communityId != 0xe519bec2434dda98f361455e11fb3f69cf2d48ffd32d6b1af954199923eb34e9::commonLib::getZeroId()) {
                        continue
                    };
