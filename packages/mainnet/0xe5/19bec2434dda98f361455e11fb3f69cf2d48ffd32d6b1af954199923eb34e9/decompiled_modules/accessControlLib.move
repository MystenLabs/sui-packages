module 0xe519bec2434dda98f361455e11fb3f69cf2d48ffd32d6b1af954199923eb34e9::accessControlLib {
    ...
    public(friend) fun grantCommunityAdminRole(arg0: &mut UserRolesCollection, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        checkHasRole(arg0, arg2, 5, arg1);
        grantRole_(arg0, getCommunityRole(x"03", arg1), arg3);
    }

    public(friend) fun grantCommunityModeratorRole(arg0: &mut UserRolesCollection, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        checkHasRole(arg0, arg2, 5, arg1);
        grantRole_(arg0, getCommunityRole(x"04", arg1), arg3);
    }
    ...
    fun grantRole_(arg0: &mut UserRolesCollection, arg1: vector<u8>, arg2: 0x2::object::ID) {
        assert!(arg1 != 0x1::vector::empty<u8>(), 310);
    ...
    public(friend) fun revokeCommunityAdminRole(arg0: &mut UserRolesCollection, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        checkHasRole(arg0, arg2, 5, arg1);
        assert!(arg2 != arg3, 309);
        revokeRole_(arg0, getCommunityRole(x"03", arg1), arg3);
    }

    public(friend) fun revokeCommunityModeratorRole(arg0: &mut UserRolesCollection, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        checkHasRole(arg0, arg2, 5, arg1);
        revokeRole_(arg0, getCommunityRole(x"04", arg1), arg3);
    }
