module 0xe5728b174f7b66715775e963e3f4a3a4ca2ea8ba7af9336c113f217574d9333a::reward8352 {
    struct REWARD8352 has drop {
        dummy_field: bool,
    }

    struct TICKET_8352 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8352(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8352>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8352>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8352, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8352>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8352>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8352>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8352>>(v5, 0x2::tx_context::sender(arg1));
    }
