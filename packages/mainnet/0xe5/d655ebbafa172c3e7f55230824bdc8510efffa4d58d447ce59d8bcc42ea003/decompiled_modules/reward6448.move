module 0xe5d655ebbafa172c3e7f55230824bdc8510efffa4d58d447ce59d8bcc42ea003::reward6448 {
    struct REWARD6448 has drop {
        dummy_field: bool,
    }

    struct TICKET_6448 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6448(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6448>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6448>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6448, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6448>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6448>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6448>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6448>>(v5, 0x2::tx_context::sender(arg1));
    }
