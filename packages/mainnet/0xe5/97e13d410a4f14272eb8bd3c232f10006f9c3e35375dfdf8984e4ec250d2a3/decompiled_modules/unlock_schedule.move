module 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::unlock_schedule {
    ...
    public(friend) fun add_future_unlock_amount(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg0.refreshed_at == 0x2::clock::timestamp_ms(arg3) / 1000, 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::error_code::should_refresh_first());
        0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::ve_sca_rules::assert_unlock_at(arg2, arg3);
    ...
    fun calculate_lock_history_snapshots(arg0: &VeScaUnlockSchedule, arg1: &0x2::clock::Clock) : vector<LockHistorySnapshot> {
        ...
        while (v2 != v1) {
            v2 = 0x2::math::min(v2 + 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::constants::unlock_round_duration() - v2 % 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::constants::unlock_round_duration(), v1);
    ...
    public(friend) fun extend_lock_period(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        assert!(arg0.refreshed_at == v0, 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::error_code::should_refresh_first());
        0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::ve_sca_rules::assert_unlock_at(arg3, arg4);
        if (arg2 > v0) {
            let v1 = nearest_unlock_amount_mut(arg0, arg2);
            *v1 = *v1 - arg1;
        };
        let v2 = nearest_unlock_amount_mut(arg0, arg3);
        *v2 = *v2 + arg1;
    }
    ...
    public(friend) fun new() : VeScaUnlockSchedule {
        ...
        let v1 = 0;
        while (v1 < 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::constants::max_lock_rounds()) {
    ...
    fun rounds_passed_since_last_refresh(arg0: &VeScaUnlockSchedule, arg1: u64) : u64 {
        arg1 / 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::constants::unlock_round_duration() - arg0.refreshed_at / 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::constants::unlock_round_duration()
    }
