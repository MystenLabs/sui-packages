module 0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::ve_sca_display {
    ...
    fun init(arg0: VE_SCA_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::ve_sca::VeScaKey>(&v0, v1, v3, arg1);
        0x2::display::update_version<0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::ve_sca::VeScaKey>(&mut v5);
        let v6 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, v6);
        0x2::transfer::public_transfer<0x2::display::Display<0xe597e13d410a4f14272eb8bd3c232f10006f9c3e35375dfdf8984e4ec250d2a3::ve_sca::VeScaKey>>(v5, v6);
    }
