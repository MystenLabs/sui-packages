module 0xe59e8488882f9fe59805410c5625431f4c373c36faca2da8873020cc001663fb::cnsnft1625 {
    struct CNSNFT1625 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1625, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1625>(arg0, arg1);
