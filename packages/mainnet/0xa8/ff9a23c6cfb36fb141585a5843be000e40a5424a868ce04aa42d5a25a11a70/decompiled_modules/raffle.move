module 0xa8ff9a23c6cfb36fb141585a5843be000e40a5424a868ce04aa42d5a25a11a70::raffle {
    ...
    public entry fun settle_coin_raffle<T0>(arg0: &mut Raffle<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xa8ff9a23c6cfb36fb141585a5843be000e40a5424a868ce04aa42d5a25a11a70::drand_lib::verify_drand_signature(arg1, arg2, arg0.round);
        arg0.status = 1;
        arg0.settler = 0x2::tx_context::sender(arg3);
        let v0 = 0xa8ff9a23c6cfb36fb141585a5843be000e40a5424a868ce04aa42d5a25a11a70::drand_lib::derive_randomness(arg1);
        let v1 = 0;
        v1 = v1 + 1;
        let v2 = 0x1::vector::length<address>(&arg0.participants);
        0x1::vector::swap<address>(&mut arg0.participants, 0xa8ff9a23c6cfb36fb141585a5843be000e40a5424a868ce04aa42d5a25a11a70::drand_lib::safe_selection(v2, &v0, 0), v2 - 1);
