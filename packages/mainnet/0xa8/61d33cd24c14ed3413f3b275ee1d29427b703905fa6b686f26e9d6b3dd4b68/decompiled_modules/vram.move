module 0xa861d33cd24c14ed3413f3b275ee1d29427b703905fa6b686f26e9d6b3dd4b68::vram {
    ...
    fun init(arg0: VRAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<VramNFT>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Genesis VRAM NFT Collection represents the first implementation of the Axolotl Standard on the Sui blockchain, enabling true on-chain evolution of digital assets."));
        ...
        let v4 = v3;
        let v5 = v2;
        0xa861d33cd24c14ed3413f3b275ee1d29427b703905fa6b686f26e9d6b3dd4b68::kiosk_lock_rule::add<VramNFT>(&mut v5, &v4);
        0xa861d33cd24c14ed3413f3b275ee1d29427b703905fa6b686f26e9d6b3dd4b68::royalty_rule::add<VramNFT>(&mut v5, &v4, 500, 0);
