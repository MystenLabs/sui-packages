module 0xa83810b89217e4e1ac30edc0423cf6054cb9657a83f4e60b5f531a7dabbf4411::step_into_sui__a_suing_event {
    ...
    fun init(arg0: STEP_INTO_SUI__A_SUING_EVENT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STEP_INTO_SUI__A_SUING_EVENT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Step into Sui: A SuiNG Event"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiadmklhpsalp23awlf5ahgy2fqo2jjqfdxk66rkujqp5iow7jbmy4"));
