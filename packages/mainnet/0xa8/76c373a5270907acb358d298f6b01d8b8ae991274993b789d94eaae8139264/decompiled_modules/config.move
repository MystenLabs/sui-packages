module 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::config {
    ...
    struct OracleFor<phantom T0, phantom T1> has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun assert_active(arg0: &LotusConfig, arg1: u64) {
        assert!(arg1 == arg0.version, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::wrong_version());
        assert!(1 == arg0.version, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::wrong_version());
        assert!(arg0.status == 0, status_error_code(arg0.status));
    }

    public fun assert_admin(arg0: &LotusConfig, arg1: &ProtocolAdminCap) {
        assert!(arg1.config_id == 0x2::object::uid_to_inner(&arg0.id), 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::cap_vault_mismatch());
        let v0 = 0x2::object::id<ProtocolAdminCap>(arg1);
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_caps, &v0), 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::cap_revoked());
    }

    public fun assert_designated_oracle<T0, T1>(arg0: &LotusConfig, arg1: 0x2::object::ID) {
        let v0 = OracleFor<T0, T1>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<OracleFor<T0, T1>>(&arg0.id, v0), 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::oracle_not_designated());
        assert!(*0x2::dynamic_field::borrow<OracleFor<T0, T1>, 0x2::object::ID>(&arg0.id, v0) == arg1, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::oracle_not_designated());
    }
    ...
    public fun assert_not_paused(arg0: &LotusConfig, arg1: u64) {
        assert!(arg1 == arg0.version, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::wrong_version());
        assert!(1 == arg0.version, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::wrong_version());
        assert!(arg0.status != 2, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::protocol_paused());
    }
    ...
    public fun bump_version(arg0: &mut LotusConfig, arg1: &ProtocolUpgradeCap, arg2: u64) {
        ...
        assert!(arg2 > arg0.version, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::wrong_version());
        arg0.version = arg2;
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::events::emit_version_updated(0x2::object::uid_to_inner(&arg0.id), arg0.version, arg2);
    }

    public fun clear_oracle_for_pair<T0, T1>(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u64) {
        assert_governance_active(arg0, arg2);
        assert_admin(arg0, arg1);
        let v0 = OracleFor<T0, T1>{dummy_field: false};
        if (0x2::dynamic_field::exists_<OracleFor<T0, T1>>(&arg0.id, v0)) {
            0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::events::emit_oracle_designated(0x2::object::uid_to_inner(&arg0.id), 0x1::option::some<0x2::object::ID>(0x2::dynamic_field::remove<OracleFor<T0, T1>, 0x2::object::ID>(&mut arg0.id, v0)), 0x2::object::id_from_address(@0x0));
        };
    }
    ...
    fun do_revoke(arg0: &mut LotusConfig, arg1: 0x2::object::ID, arg2: u8) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_caps, &arg1), 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::cap_not_in_allowlist());
        0x2::vec_set::remove<0x2::object::ID>(&mut arg0.allowed_caps, &arg1);
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::events::emit_protocol_cap_revoked(0x2::object::uid_to_inner(&arg0.id), arg1, arg2);
    }
    ...
    public fun enable_dex(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u8) {
        ...
        assert!(v0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::unknown_dex());
        if (!0x2::vec_set::contains<u8>(&arg0.allowed_dex, &arg2)) {
    ...
    public fun fee_early_window_ms(arg0: &FeeConfig) : u64 {
        arg0.early_withdraw_window_ms
    }

    public fun fee_early_withdraw_bps(arg0: &FeeConfig) : u64 {
        arg0.early_withdraw_fee_bps
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = FeeConfig{
            ...
            early_withdraw_window_ms   : 86400000,
            early_withdraw_fee_bps     : 100,
        ...
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::events::emit_initialized(v1, 0x2::tx_context::sender(arg0), v12.version);
    ...
    public fun oracle_for_pair<T0, T1>(arg0: &LotusConfig) : 0x1::option::Option<0x2::object::ID> {
        let v0 = OracleFor<T0, T1>{dummy_field: false};
        if (0x2::dynamic_field::exists_<OracleFor<T0, T1>>(&arg0.id, v0)) {
            0x1::option::some<0x2::object::ID>(*0x2::dynamic_field::borrow<OracleFor<T0, T1>, 0x2::object::ID>(&arg0.id, v0))
        } else {
            0x1::option::none<0x2::object::ID>()
        }
    }

    public fun oracle_force_mark_max_bps(arg0: &OracleConfig) : u64 {
        arg0.force_mark_max_bps
    }
    ...
    public fun oracle_max_conf_bps(arg0: &OracleConfig) : u64 {
        arg0.max_conf_bps
    }

    public fun oracle_max_move_bps(arg0: &OracleConfig) : u64 {
        arg0.max_move_bps
    }
    ...
    public fun oracle_move_window_ms(arg0: &OracleConfig) : u64 {
        arg0.move_window_ms
    }
    ...
    public fun risk_max_drip_lag_ms(arg0: &RiskConfig) : u64 {
        arg0.max_drip_lag_ms
    }
    ...
    public fun risk_min_bootstrap_quote(arg0: &RiskConfig) : u64 {
        arg0.min_bootstrap_quote
    }
    ...
    public fun set_buy_fee_caps(arg0: &mut LotusConfig, arg1: &ProtocolFeeCap, arg2: u64, arg3: u64, arg4: u64) {
        ...
        assert!(arg3 <= 10000, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_fee_bps());
        assert!(arg4 > 0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_period_ms());
    ...
    public fun set_early_withdraw_policy(arg0: &mut LotusConfig, arg1: &ProtocolFeeCap, arg2: u64, arg3: u64) {
        assert_fee_cap(arg0, arg1);
        assert!(arg3 <= 1000, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_fee_param());
        assert!(arg2 <= 2592000000, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_fee_param());
        arg0.fee_config.early_withdraw_window_ms = arg2;
        arg0.fee_config.early_withdraw_fee_bps = arg3;
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::events::emit_early_withdraw_policy(0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    }
    ...
    public fun set_oracle_config(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64) {
        assert_admin(arg0, arg1);
        assert!(arg2 > 0 && arg3 > 0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_oracle_param());
        assert!(arg4 > 0 && arg7 > 0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_oracle_param());
        assert!(arg5 > 0 && arg5 <= 10000, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_oracle_param());
        assert!(arg6 > 0 && arg6 <= 10000, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_oracle_param());
        assert!(arg8 <= 10000, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_oracle_param());
        let v0 = OracleConfig{
            max_source_age_ms  : arg2,
            max_price_age_ms   : arg3,
            mark_max_age_ms    : arg4,
            max_conf_bps       : arg5,
            max_move_bps       : arg6,
            move_window_ms     : arg7,
            force_mark_max_bps : arg8,
        };
        arg0.oracle_config = v0;
    }

    public fun set_oracle_for_pair<T0, T1>(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u64, arg3: 0x2::object::ID) {
        assert_governance_active(arg0, arg2);
        assert_admin(arg0, arg1);
        let v0 = OracleFor<T0, T1>{dummy_field: false};
        let v1 = if (0x2::dynamic_field::exists_<OracleFor<T0, T1>>(&arg0.id, v0)) {
            0x1::option::some<0x2::object::ID>(0x2::dynamic_field::remove<OracleFor<T0, T1>, 0x2::object::ID>(&mut arg0.id, v0))
        } else {
            0x1::option::none<0x2::object::ID>()
        };
        0x2::dynamic_field::add<OracleFor<T0, T1>, 0x2::object::ID>(&mut arg0.id, v0, arg3);
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::events::emit_oracle_designated(0x2::object::uid_to_inner(&arg0.id), v1, arg3);
    }
    ...
    public fun set_risk_config(arg0: &mut LotusConfig, arg1: &ProtocolRiskCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64) {
        assert_risk_cap(arg0, arg1);
        assert!(arg4 > 0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_risk_param());
        assert!(arg6 > 0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_risk_param());
        assert!(arg7 > 0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_risk_param());
        let v0 = RiskConfig{
            ...
            max_order_size      : arg5,
            max_ptb_ops         : arg6,
            min_bootstrap_quote : arg7,
            max_drip_lag_ms     : arg8,
        };
        arg0.risk_config = v0;
    }
    ...
    public fun set_status(arg0: &mut LotusConfig, arg1: &ProtocolPauseCap, arg2: u8) {
        ...
        assert!(v0, 0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::bad_risk_param());
        arg0.status = arg2;
        0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::events::emit_status_changed(0x2::object::uid_to_inner(&arg0.id), arg0.status, arg2);
    }
    ...
    fun status_error_code(arg0: u8) : u64 {
        if (arg0 == 2) {
            0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::protocol_paused()
        } else if (arg0 == 1) {
            0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::protocol_frozen()
        } else {
            0xa876c373a5270907acb358d298f6b01d8b8ae991274993b789d94eaae8139264::errors::protocol_paused()
        }
    }
