module 0xa80cf1aff14636b03f06e6b4c629212d03ebb51849f6e9ab07d0f31bfb066c4b::reward5470 {
    struct REWARD5470 has drop {
        dummy_field: bool,
    }

    struct TICKET_5470 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5470(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5470>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5470>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5470, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5470>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5470>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5470>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5470>>(v5, 0x2::tx_context::sender(arg1));
    }
