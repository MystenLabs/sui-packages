module 0xa8758011f36c854daca6e01e14d85bb6d1d3cc7e86de387259a9d7ad28117a2b::cnsnft3088 {
    struct CNSNFT3088 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3088, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3088>(arg0, arg1);
