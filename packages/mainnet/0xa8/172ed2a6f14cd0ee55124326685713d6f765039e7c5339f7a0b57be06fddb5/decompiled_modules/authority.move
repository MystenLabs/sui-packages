module 0xa8172ed2a6f14cd0ee55124326685713d6f765039e7c5339f7a0b57be06fddb5::authority {
    struct PACKAGE {
        dummy_field: bool,
    }
    ...
    public fun add_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0xa8172ed2a6f14cd0ee55124326685713d6f765039e7c5339f7a0b57be06fddb5::events::emit_added_authorization(0x2::object::uid_to_inner(arg0));
    }
    ...
    public fun is_authorized(arg0: &0x2::object::UID) : bool {
        let v0 = AuthKey{dummy_field: false};
        0x2::dynamic_field::exists_with_type<AuthKey, AuthCap>(arg0, v0)
    }
    ...
    public fun remove_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0xa8172ed2a6f14cd0ee55124326685713d6f765039e7c5339f7a0b57be06fddb5::events::emit_removed_authorization(0x2::object::uid_to_inner(arg0));
    }
