module 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::config {
    ...
    public fun add_new_ls_rule(arg0: &AdminCap, arg1: &mut Config, arg2: LockedStakingRule, arg3: &mut 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::pool::RewardPool) {
        0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::pool::add_new_stats(arg3, 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::locked_str(), 0x1::option::some<u64>(arg2.staking_window));
    ...
    public fun add_oes_new_apy_bp(arg0: &AdminCap, arg1: &mut Config, arg2: u16, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::max_bps() >= arg2, 1);
    ...
    public fun borrow_ls(arg0: &Config) : &LockedStaking {
        borrow<StakingKey, LockedStaking>(arg0, config_staking_key(0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::locked_str()))
    }

    fun borrow_mut_ls(arg0: &mut Config) : &mut LockedStaking {
        borrow_mut<StakingKey, LockedStaking>(arg0, config_staking_key(0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::locked_str()))
    }

    fun borrow_mut_oes(arg0: &mut Config) : &mut OpenEndedStaking {
        borrow_mut<StakingKey, OpenEndedStaking>(arg0, config_staking_key(0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::open_ended_str()))
    }

    public fun borrow_oes(arg0: &Config) : &OpenEndedStaking {
        borrow<StakingKey, OpenEndedStaking>(arg0, config_staking_key(0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::open_ended_str()))
    }
    ...
    fun init(arg0: CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = OpenEndedStaking{
            ...
            min_stakable_amount     : 1 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
            max_lockable_amount     : 8000000 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
        };
        0x2::vec_map::insert<u64, u16>(&mut v1.apy_bps, 0x2::tx_context::epoch(arg1), 700);
        let v2 = LockedStaking{rules: 0x2::vec_map::empty<u64, LockedStakingRule>()};
        let v3 = LockedStakingRule{
            staking_window      : 90,
            apy_bp              : 1000,
            min_stakable_amount : 1 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
            max_lockable_amount : 7000000 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
            restakable_window   : 5,
        };
        ...
        let v4 = LockedStakingRule{
            ...
            apy_bp              : 1400,
            min_stakable_amount : 1 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
            max_lockable_amount : 6000000 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
            restakable_window   : 5,
        };
        ...
        let v5 = LockedStakingRule{
            ...
            apy_bp              : 2000,
            min_stakable_amount : 1 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
            max_lockable_amount : 5000000 * 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::times_token_decimals(),
            restakable_window   : 5,
        };
        0x2::vec_map::insert<u64, LockedStakingRule>(&mut v2.rules, 365, v5);
        let v6 = StakingKey{name: 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::open_ended_str()};
        0x2::dynamic_field::add<StakingKey, OpenEndedStaking>(&mut v0.id, v6, v1);
        let v7 = StakingKey{name: 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::locked_str()};
    ...
    public fun remove_ls_rule(arg0: &AdminCap, arg1: &mut Config, arg2: u64, arg3: &mut 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::pool::RewardPool) {
        0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::pool::remove_stats(arg3, 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::constants::locked_str(), 0x1::option::some<u64>(arg2));
        let (_, _) = 0x2::vec_map::remove<u64, LockedStakingRule>(&mut borrow_mut_ls(arg1).rules, &arg2);
    }

    public fun take_from_pool(arg0: &AdminCap, arg1: &mut 0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::pool::RewardPool, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x46fbe54691b27d7abd2c9e5a01088913531f241b98f3c2351f8215e45cc17a4c::times::TIMES> {
        0xa884a68c09a4e1f198e4e9214b7cfb6fb56fc6cc6bce23db685bfc52ab4658e3::pool::take_from_pool(arg1, arg2, arg3)
    }
