module 0xa8053bc617506580ebd889ae21e393044e1674c899bf60d8b660309187e1a215::evolved_sudoz {
    ...
    fun build_evolved_name(arg0: u64) : 0x1::string::String {
        if (is_one_of_one(arg0)) {
            ...
            0x1::vector::append<u8>(&mut v1, u64_to_string_bytes(arg0));
            0x1::string::utf8(v1)
        } else {
            let v2 = 0x1::vector::empty<u8>();
            0x1::vector::append<u8>(&mut v2, b"THE SUDOZ #");
            0x1::vector::append<u8>(&mut v2, u64_to_string_bytes(arg0));
            0x1::string::utf8(v2)
        }
    }
