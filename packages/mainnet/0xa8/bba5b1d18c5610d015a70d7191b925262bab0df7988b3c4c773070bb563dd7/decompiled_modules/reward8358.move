module 0xa8bba5b1d18c5610d015a70d7191b925262bab0df7988b3c4c773070bb563dd7::reward8358 {
    struct REWARD8358 has drop {
        dummy_field: bool,
    }

    struct TICKET_8358 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8358(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8358>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8358>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8358, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8358>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8358>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8358>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8358>>(v5, 0x2::tx_context::sender(arg1));
    }
