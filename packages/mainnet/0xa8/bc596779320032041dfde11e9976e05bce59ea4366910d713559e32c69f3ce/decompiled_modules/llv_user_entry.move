module 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_user_entry {
    ...
    public fun add_withdraw_leg_accounted<T0, T1, T2>(arg0: &mut WithdrawReceipt<T0, T1>, arg1: &0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::LLVPool<T0, T1>, arg2: u8, arg3: 0x2::balance::Balance<T0>, arg4: u64, arg5: &0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_admin::ExtAuthGuard<T2>) {
        assert!(arg0.pool_id == 0x2::object::id<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::LLVPool<T0, T1>>(arg1), 8);
        ...
        let v1 = (arg4 as u128);
        assert!(v1 <= 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::get_protocol_balance<T0, T1>(arg1, arg2), 13);
        assert!(v1 > 0 || v0 == 0, 26);
        let v2 = &mut arg0.used_protocols;
        let v3 = if (arg4 > 0 || v0 > 0) {
            1
        } else {
            0
        };
        claim_withdraw_protocol(v2, arg2, v3);
        0x2::balance::join<T0>(&mut arg0.total_withdrawed, arg3);
        if (v1 > 0) {
    ...
    fun assert_withdraw_loss_bps(arg0: u64) {
        assert!(arg0 <= 10, 25);
    }
    ...
    fun assert_withdraw_source_debits_cover_plan(arg0: &vector<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>, arg1: &vector<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>) {
        ...
        while (v0 < 0x1::vector::length<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>(arg1)) {
            let v1 = 0x1::vector::borrow<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>(arg1, v0);
            assert!(0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::get_amount(arg0, 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::protocol_id(v1)) > 0 || 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::amount(v1) == 0, 13);
            v0 = v0 + 1;
        };
    }
    ...
    public fun complete_withdraw_return<T0, T1>(arg0: &mut 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::LLVPool<T0, T1>, arg1: WithdrawReceipt<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v20 = validate_withdraw_settlement<T0, T1>(arg0, &v15, &v12, &v13, v11, 0x2::clock::timestamp_ms(arg3));
        assert!(v20 <= v10, 4);
        let v21 = (0x2::balance::value<T0>(&v14) as u128);
        let v22 = v10 - v20;
        let v23 = min_u128(v21, v22);
        assert!(v21 >= v22, 4);
        assert!(v23 >= (arg2 as u128), 4);
        assert!(v1 <= 18446744073709551615, 10);
        let v24 = v2;
        let v25 = if ((v1 as u64) >= 0x2::coin::value<T1>(&v24)) {
            0x2::coin::burn<T1>(0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::share_treasury_mut<T0, T1>(arg0), v24);
            0x2::coin::zero<T1>(arg4)
        } else {
            0x2::coin::burn<T1>(0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::share_treasury_mut<T0, T1>(arg0), 0x2::coin::split<T1>(&mut v24, (v1 as u64), arg4));
            v24
        };
        ...
        let v14 = if (v26 == 0) {
            ...
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::store_or_join_idle_balance<T0, T1>(arg0, 0x2::balance::split<T0>(&mut v14, (v26 as u64)));
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::record_deposit<T0, T1>(arg0, v16, v26, 0);
            v14
        };
        0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::update_last_total_assets<T0, T1>(arg0, v9);
        0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::end_operation<T0, T1>(arg0);
        0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_events::emit_withdrawn(v0, 0x2::tx_context::sender(arg4), v1, (v23 as u64), v13, 0x2::clock::timestamp_ms(arg3));
        (0x2::coin::from_balance<T0>(v14, arg4), v25)
    }
    ...
    fun validate_withdraw_settlement<T0, T1>(arg0: &0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::LLVPool<T0, T1>, arg1: &vector<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>, arg2: &vector<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>, arg3: &vector<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>, arg4: u64, arg5: u64) : u128 {
        assert_withdraw_source_debits_cover_plan(arg1, arg2);
        assert_withdraw_source_debits_cover_plan(arg1, arg3);
        let v0 = 0;
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>(arg1)) {
            let v2 = 0x1::vector::borrow<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::ProtocolAmount>(arg1, v1);
            let v3 = 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::protocol_id(v2);
            let v4 = 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::amount(v2);
            let v5 = 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::get_amount(arg2, v3);
            let v6 = 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::get_amount(arg3, v3);
            let v7 = if (0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_allocation_plan::is_idle_protocol(v3)) {
                0
            } else {
                0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::effective_settlement_loss_bps<T0, T1>(arg0, v3, arg4)
            };
            let v8 = if (v4 > v5) {
                v4
            } else {
            ...
            assert!(v6 >= 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_math::mul_div(v8, 10000 - (v7 as u128), 10000), 4);
            let v9 = if (v8 > v6) {
                v8 - v6
            } else {
                0
            ...
            v0 = v0 + v9;
            0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_events::emit_settlement_leg(0x2::object::id<0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_pool::LLVPool<T0, T1>>(arg0), 1, v3, v4, v5, v6, v7, v9, arg5);
            v1 = v1 + 1;
        };
        v0
    }
