module 0x1a9ebe18506edf61885c5ad3cd7d1c64160c8e2d9a324a8c66238f9ac68ab52d::llv_math {
    ...
    public fun accounted_value_delta_capped(arg0: u128, arg1: u128, arg2: u64) : u64 {
        let v0 = accounted_value_delta(arg0, arg1);
        if (v0 > arg2) {
            arg2
        } else {
            v0
    ...
    public fun select_receipt_token_withdraw_amount_floor(arg0: u128, arg1: u64, arg2: u128, arg3: u128, arg4: u64) : u64 {
        let v0 = if (arg0 == 0) {
            true
        } else if (arg1 == 0) {
            true
        ...
        let v1 = (((arg0 as u256) * (arg3 as u256) / (arg2 as u256)) as u128);
        let v2 = mul_div((arg4 as u128), arg3, arg2);
        let v3 = if (v1 < v2) {
            v1
        } else {
