module 0xa83ed171d919700e7e3394eddafa0d5d4fe1552a229ac79738aacc9f2ecf6c1f::deepbook {
    ...
    public fun swap_exact_quantity<T0, T1, T2, T3>(arg0: &mut 0xa83ed171d919700e7e3394eddafa0d5d4fe1552a229ac79738aacc9f2ecf6c1f::checkpoint::Payload<T2, T3>, arg1: &mut DeepPool, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (arg3 && v7) {
            0x2::balance::join<T0>(&mut v8, 0x2::balance::split<T0>(&mut v0, v2 * arg4 * 0xa83ed171d919700e7e3394eddafa0d5d4fe1552a229ac79738aacc9f2ecf6c1f::constant::deepbook_fee_penalty() / 1000000));
        } else {
            0x2::balance::join<T1>(&mut v9, 0x2::balance::split<T1>(&mut v1, v2 * arg4 * 0xa83ed171d919700e7e3394eddafa0d5d4fe1552a229ac79738aacc9f2ecf6c1f::constant::deepbook_fee_penalty() / 1000000));
        };
        ...
        if (arg3) {
            0xa83ed171d919700e7e3394eddafa0d5d4fe1552a229ac79738aacc9f2ecf6c1f::checkpoint::place_next<T2, T3, T1>(arg0, 0x2::coin::into_balance<T1>(v14));
            ...
            0xa83ed171d919700e7e3394eddafa0d5d4fe1552a229ac79738aacc9f2ecf6c1f::checkpoint::place_next<T2, T3, T0>(arg0, 0x2::coin::into_balance<T0>(v15));
