module 0xa892458d7f0c335e98ed2f10d81131c6d594d9d348ea3cd7e1d27a3c563beead::staked_share {
    ...
    public entry fun new_and_share_number_pool_and_share_supply<T0, T1, T2>(arg0: &0xa892458d7f0c335e98ed2f10d81131c6d594d9d348ea3cd7e1d27a3c563beead::pool::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun new_share<T0, T1, T2>(arg0: &mut ShareSupply<T0, T1, T2>, arg1: &mut NumberPool<T0, T1, T2>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : vector<StakedPoolShare<T0, T1, T2>> {
        let v0 = arg2;
        let v1 = arg3;
        if (0x1::vector::length<StakedPoolShare<T0, T1, T2>>(&arg1.available_shares) == 0) {
            let v3 = StakedPoolShare<T0, T1, T2>{
                ...
                end_num   : arg0.total_supply + arg2,
            };
            ...
            while (0x1::vector::length<StakedPoolShare<T0, T1, T2>>(&arg1.available_shares) != 0) {
                ...
                if (v7 == v0) {
                    ...
                    let v12 = 0;
                    v0 = v12;
                    arg0.active_supply = arg0.active_supply + v12;
                    break
                };
    ...
    public fun uid<T0, T1, T2>(arg0: &mut StakedPoolShare<T0, T1, T2>) : &mut 0x2::object::UID {
        &mut arg0.id
    }
