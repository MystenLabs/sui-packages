module 0xa87af9cb6ee1558a4c3f318cf2e1a7bc02662de1ba6c1663f4a7b345509c9487::token_factory {
    ...
    public entry fun create_token(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: bool, arg5: bool, arg6: bool, arg7: vector<address>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg8) >= 1000000000, 0);
        assert!(0x1::vector::length<address>(&arg7) <= 500, 6);
        ...
        let (v2, v3) = 0x2::coin::create_currency<Token>(v1, 9, arg1, arg0, b"Custom token created via token factory", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(arg2)), arg9);
        let v4 = v2;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<Token>>(v3);
        let v5 = LPToken<Token, 0x2::sui::SUI>{dummy_field: false};
        let (v6, v7) = 0x2::coin::create_currency<LPToken<Token, 0x2::sui::SUI>>(v5, 9, b"LP", b"Liquidity Pool Token", b"", 0x1::option::none<0x2::url::Url>(), arg9);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LPToken<Token, 0x2::sui::SUI>>>(v7);
        if (arg6) {
            assert!(0x1::vector::length<address>(&arg7) < 500, 6);
            0x1::vector::push_back<address>(&mut arg7, v0);
        };
        let v8 = TokenConfig{
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg8, @0x152fa772d358c3bd6fb299e4ef66d32c849a040ceeee64554caccd0b464094c1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<Token>>(0x2::coin::mint<Token>(&mut v4, arg3 / 10, arg9), v0);
    }
