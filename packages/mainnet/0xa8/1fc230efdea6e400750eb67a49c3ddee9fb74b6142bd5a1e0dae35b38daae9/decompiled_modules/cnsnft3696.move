module 0xa81fc230efdea6e400750eb67a49c3ddee9fb74b6142bd5a1e0dae35b38daae9::cnsnft3696 {
    struct CNSNFT3696 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3696, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3696>(arg0, arg1);
