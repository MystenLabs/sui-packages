module 0x3fcdcee11f485731170944af3acd26b17d1b96121ce6b756fe8517a95192b3a::distribution_config {
    ...
    public fun checked_package_version(arg0: &DistributionConfig) {
        assert!(arg0.version == 7, 458466182903521300);
    }
    ...
    public(friend) fun remove_price_aggregators(arg0: &mut DistributionConfig) : (0x1::option::Option<0x2::object::ID>, 0x1::option::Option<0x2::object::ID>) {
        arg0.o_sail_price_aggregator_id = 0x1::option::none<0x2::object::ID>();
        arg0.sail_price_aggregator_id = 0x1::option::none<0x2::object::ID>();
        (arg0.o_sail_price_aggregator_id, arg0.sail_price_aggregator_id)
    }
    ...
    public fun set_package_version(arg0: &mut DistributionConfig, arg1: &0x2::package::Publisher, arg2: u64) {
        assert!(0x2::package::from_module<DISTRIBUTION_CONFIG>(arg1), 24442067766657028);
        assert!(arg2 <= 7, 326963916733903800);
        arg0.version = arg2;
    }
