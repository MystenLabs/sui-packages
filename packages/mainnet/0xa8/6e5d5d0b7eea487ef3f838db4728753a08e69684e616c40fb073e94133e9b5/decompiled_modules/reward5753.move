module 0xa86e5d5d0b7eea487ef3f838db4728753a08e69684e616c40fb073e94133e9b5::reward5753 {
    struct REWARD5753 has drop {
        dummy_field: bool,
    }

    struct TICKET_5753 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5753(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5753>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5753>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5753, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5753>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5753>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5753>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5753>>(v5, 0x2::tx_context::sender(arg1));
    }
