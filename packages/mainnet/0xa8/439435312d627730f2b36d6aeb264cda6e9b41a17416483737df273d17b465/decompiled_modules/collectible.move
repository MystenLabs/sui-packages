module 0xa8439435312d627730f2b36d6aeb264cda6e9b41a17416483737df273d17b465::collectible {
    ...
    fun init(arg0: COLLECTIBLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"FlowX Testnet Pass IV"));
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://bafybeiebezg5ygqppanyfkwet433bc4vxanqvpksysqkxmni72vgfkqiqa"));
        ...
        let v3 = State{
            ...
            started_at_ms : 1697101200000,
            ended_at_ms   : 1699779600000,
