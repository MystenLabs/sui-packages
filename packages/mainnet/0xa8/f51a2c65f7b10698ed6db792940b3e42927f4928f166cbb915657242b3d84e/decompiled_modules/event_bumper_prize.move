module 0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::event_bumper_prize {
    ...
    public(friend) fun claim_bumper_prize<T0: store + key>(arg0: &mut Event_BumperPrizeList, arg1: u64, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (v0 == 1) {
            ...
            0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::rand::rng(0, v0, arg3) % v0
        };
    ...
    public(friend) fun get_random_in_event_bumper(arg0: &mut Event_BumperPrizeList, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (v0 == 1) {
            ...
            0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::rand::rng(0, v0, arg1) % v0
        };
        let v2 = RandomIndex{
