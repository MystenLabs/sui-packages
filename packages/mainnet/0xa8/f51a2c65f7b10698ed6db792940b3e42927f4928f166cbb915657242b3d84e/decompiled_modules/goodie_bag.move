module 0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::goodie_bag {
    ...
    public fun get_random_goodie(arg0: &mut GoodieBagList, arg1: &0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::version::checkVersion(arg1, 2);
        ...
        let v1 = if (v0 == 1) {
            ...
            0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::rand::rng(0, v0, arg2) % v0
        };
        let v2 = RandomIndex{
    ...
    public fun mint_participation_token(arg0: address, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut PopList, arg5: &GoodieBagList, arg6: &0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::version::Version, arg7: &mut 0x2::tx_context::TxContext) {
        0x89c23be637500077ae43cacaf11a7ce6def85e39a4391c3525c3ef770caf188f::version::checkVersion(arg6, 2);
