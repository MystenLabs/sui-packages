module 0x517fb485d39a4845bed030ebba5257ef33498b2af97d97ecd59d67d83138974b::farms {
    ...
    public fun withdraw_rewards<T0>(arg0: &AdminCap, arg1: &mut RewardBalance<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = RewardsWithdrawn{
            balance_id : 0x2::object::uid_to_inner(&arg1.id),
            amount     : v1,
        };
        0x2::event::emit<RewardsWithdrawn>(v2);
