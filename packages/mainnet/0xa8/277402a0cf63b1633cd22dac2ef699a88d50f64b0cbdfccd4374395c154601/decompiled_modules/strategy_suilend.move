module 0x4d60167ca198b1264e4d3b95f5227eaf877876058c7cfb970d2e9abde90a6638::strategy_suilend {
    struct SuilendStrategy has key {
        id: 0x2::object::UID,
    ...
    public fun initialize(arg0: 0x4d60167ca198b1264e4d3b95f5227eaf877876058c7cfb970d2e9abde90a6638::aqua::StrategyCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = SuilendStrategy{
            id  : 0x2::object::new(arg1),
            cap : arg0,
        };
        0x2::transfer::share_object<SuilendStrategy>(v0);
    }
    ...
    public fun withdraw_ctoken<T0, T1>(arg0: &mut 0x4d60167ca198b1264e4d3b95f5227eaf877876058c7cfb970d2e9abde90a6638::aqua::Vault<T0>, arg1: &0x4d60167ca198b1264e4d3b95f5227eaf877876058c7cfb970d2e9abde90a6638::aqua::StrategyCap) : 0x2::balance::Balance<T1> {
