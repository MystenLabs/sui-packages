module 0xa8e1696bd4c6fbda3d22ad9ae83168609a0f9edc40b773cf93fb4d2ec5aad9e3::reward3879 {
    struct REWARD3879 has drop {
        dummy_field: bool,
    }

    struct TICKET_3879 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3879(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3879>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3879>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3879>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3879>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3879>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3879>>(v5, 0x2::tx_context::sender(arg1));
    }
