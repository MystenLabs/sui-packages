module 0xa8626b1c27a03db6955303de1e9379bea8c03b11b1b47e4fdded0cb0fa4233e2::reward2967 {
    struct REWARD2967 has drop {
        dummy_field: bool,
    }

    struct TICKET_2967 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2967(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2967>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2967>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2967, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2967>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2967>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2967>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2967>>(v5, 0x2::tx_context::sender(arg1));
    }
