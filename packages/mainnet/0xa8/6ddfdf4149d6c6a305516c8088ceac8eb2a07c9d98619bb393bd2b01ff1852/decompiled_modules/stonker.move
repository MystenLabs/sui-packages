module 0xa86ddfdf4149d6c6a305516c8088ceac8eb2a07c9d98619bb393bd2b01ff1852::stonker {
    ...
    fun input_signal_internal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: bool, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 && v7 + v8 < arg4) {
            ...
            if (v20 < 10 * arg0.parameters.single_base) {
                let v21 = AtLimitEvent{is_buy: true};
                0x2::event::emit<AtLimitEvent>(v21);
                return
            };
            if (v13 > 3800000) {
                let v22 = PriceLimitEvent{
                    is_buy : true,
                    price  : v13,
                };
                0x2::event::emit<PriceLimitEvent>(v22);
                return
            };
            if (0x2::clock::timestamp_ms(arg3) < arg0.last_trade_time_ms + 100) {
                let v23 = WithinCooldownEvent{
                    is_buy : true,
                    price  : v13,
                };
                0x2::event::emit<WithinCooldownEvent>(v23);
                return
            };
            let v24 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v24, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v13, v20, true, false, 0x2::clock::timestamp_ms(arg3) + 1000, arg3, arg7);
            arg0.last_trade_time_ms = 0x2::clock::timestamp_ms(arg3);
            return
        };
        if (!arg5 && arg4 + v8 < v6) {
            let (v25, _, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2);
            let v28 = (arg4 + v8 + v25 - 1) / v25 * v25;
            let v29 = (380 + 1000000 * (v6 - v8 - arg4) / v7 * 285 / 100) * arg0.parameters.single_base;
            let v30 = v29;
            let v31 = 99 * 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1) / 100;
            if (v29 > v31) {
                v30 = v31;
            };
            if (v30 < 10 * arg0.parameters.single_base) {
                let v32 = AtLimitEvent{is_buy: true};
                0x2::event::emit<AtLimitEvent>(v32);
                return
            };
            if (v28 < 2800000) {
                let v33 = PriceLimitEvent{
                    is_buy : false,
                    price  : v28,
                };
                0x2::event::emit<PriceLimitEvent>(v33);
                return
            };
            if (0x2::clock::timestamp_ms(arg3) < arg0.last_trade_time_ms + 100) {
                let v34 = WithinCooldownEvent{
                    is_buy : true,
                    price  : v7,
                };
                0x2::event::emit<WithinCooldownEvent>(v34);
                return
            };
            let v35 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v35, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v28, v30, false, false, 0x2::clock::timestamp_ms(arg3) + 1000, arg3, arg7);
            arg0.last_trade_time_ms = 0x2::clock::timestamp_ms(arg3);
            return
        };
    }
