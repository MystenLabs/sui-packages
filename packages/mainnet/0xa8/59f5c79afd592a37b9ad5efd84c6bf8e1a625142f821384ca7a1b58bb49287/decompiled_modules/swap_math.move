module 0xa859f5c79afd592a37b9ad5efd84c6bf8e1a625142f821384ca7a1b58bb49287::swap_math {
    fun cross_ticks<T0, T1>(arg0: &mut 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::SwapState, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg2: bool) {
        loop {
            let (v0, _) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_bitmap::next_initialized_tick_within_one_word(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick::bitmap(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_manager<T0, T1>(arg1)), 0xa859f5c79afd592a37b9ad5efd84c6bf8e1a625142f821384ca7a1b58bb49287::i32_utils::lib_to_mate(0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::tick(arg0)), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_tick_spacing<T0, T1>(arg1), arg2);
            ...
            let (v4, v5, v6, v7) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::compute_swap_step(0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::sqrt_price(arg0), v2, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::liquidity(arg0), v3, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::fee_pips(arg0), arg2, true);
            let (v8, v9) = if (arg2) {
                (0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::amount_x_desired(arg0) - v4 - v7, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::amount_y_desired(arg0) + v5)
            } else {
                (0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::amount_x_desired(arg0) + v5, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::amount_y_desired(arg0) - v4 - v7)
            };
            if (v6 != v2) {
                break
            };
            if (0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::math::is_zero_for_one(v8, v9, v6, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::sqrt_ratio_lower(arg0), 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::sqrt_ratio_upper(arg0)) != arg2) {
                break
            };
    ...
    public(friend) fun optimal_swap<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u32, arg2: u32, arg3: u64, arg4: u64) : (u64, u64, bool, u128) {
        ...
        let v2 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lt(v0, v1)) {
            if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::gte(v0, 0xa859f5c79afd592a37b9ad5efd84c6bf8e1a625142f821384ca7a1b58bb49287::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::min_tick()))) {
                0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i32::lte(v1, 0xa859f5c79afd592a37b9ad5efd84c6bf8e1a625142f821384ca7a1b58bb49287::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::max_tick()))
            } else {
                false
            }
        } else {
        ...
        let v4 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::get_sqrt_price_at_tick(0xa859f5c79afd592a37b9ad5efd84c6bf8e1a625142f821384ca7a1b58bb49287::i32_utils::lib_to_mate(v0));
        let v5 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::get_sqrt_price_at_tick(0xa859f5c79afd592a37b9ad5efd84c6bf8e1a625142f821384ca7a1b58bb49287::i32_utils::lib_to_mate(v1));
        let v6 = 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::init_swap_state(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::liquidity<T0, T1>(arg0), v3, 0xa859f5c79afd592a37b9ad5efd84c6bf8e1a625142f821384ca7a1b58bb49287::i32_utils::mate_to_lib(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg0)), arg3, arg4, v4, v5, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_fee_rate<T0, T1>(arg0));
        ...
        if (v7) {
            ...
            (v13, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::amount_y_desired(&v6) + 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::get_delta_b(v12, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::sqrt_price(&v6), 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::liquidity(&v6), false) - arg4, true, v12)
        } else {
            let (v15, v12) = if (0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::sqrt_price(&v6) >= v4) {
                ...
                (arg4 + 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::constants::amount_before_fee(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::clmm_math::get_delta_b(v16, 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::sqrt_price(&v6), 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::liquidity(&v6), true), 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::fee_pips(&v6)) - 0xbf967495248de88d8f64f927c16206598516deccc81ab52f5c8d31a3d5466f81::state::amount_y_desired(&v6), v16)
            } else {
