module 0xa8c53112bcbdba3a970f22faa49a72e63ea4872e66e452997dab78474b3a2df1::cetus {
    ...
    public fun swap<T0, T1, T2, T3, T4>(arg0: &mut 0xa8c53112bcbdba3a970f22faa49a72e63ea4872e66e452997dab78474b3a2df1::fund::Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>, arg1: &mut 0x2::balance::Balance<T3>, arg2: &mut 0x2::balance::Balance<T4>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T3, T4>, arg5: bool, arg6: bool, arg7: &0x2::clock::Clock) {
        ...
        let (v12, v13) = if (0x2::balance::value<T3>(arg1) == 0) {
            (0x2::balance::value<T4>(arg2), 0x1::type_name::get<T4>())
        } else {
            (0x2::balance::value<T3>(arg1), 0x1::type_name::get<T3>())
        };
        0xa8c53112bcbdba3a970f22faa49a72e63ea4872e66e452997dab78474b3a2df1::fund::supported_defi_confirm_1l_for_2l<T0, T1, T2>(arg0, v0, v12);
        let v14 = Swap{
