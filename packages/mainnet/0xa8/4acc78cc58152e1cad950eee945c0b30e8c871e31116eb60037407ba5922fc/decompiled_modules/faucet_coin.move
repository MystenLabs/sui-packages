module 0xa84acc78cc58152e1cad950eee945c0b30e8c871e31116eb60037407ba5922fc::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 9, b"my_Cheshire", b"Royal retour", b"The king of memes", 0x1::option::none<0x2::url::Url>(), arg1);
