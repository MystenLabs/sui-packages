module 0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::vault {
    ...
    public fun add_profit_with_credit_time_sigs<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::utils::verify_signature(&arg1.signers, arg1.threshold, v0, arg7, arg8);
    ...
    public fun check_pauser_cap(arg0: &mut VaultConfig, arg1: 0x2::object::ID) : bool {
        ...
        let v0 = 0x2::dynamic_field::borrow<vector<u8>, vector<0x2::object::ID>>(&mut arg0.id, b"pausers");
        let v1 = 0;
        let v2 = false;
        while (v1 < 0x1::vector::length<0x2::object::ID>(v0)) {
            if (*0x1::vector::borrow<0x2::object::ID>(v0, v1) == arg1) {
    ...
    public fun credit_loss_with_credit_time_sigs<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: u64, arg5: u64, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg5 >= 0x2::clock::timestamp_ms(arg8), 17);
        let v0 = 0x1::vector::empty<u8>();
        let v1 = 0x2::object::id<Vault<T0, T1>>(arg2);
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<0x2::object::ID>(&v1));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg3));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg5));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg4));
        0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::utils::verify_signature(&arg1.signers, arg1.threshold, v0, arg6, arg7);
    ...
    public fun deposit_dual_token<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: address, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock, arg16: &AccessCap, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > 0) {
            assert!(arg1.liquidity + (arg2 as u128) <= v0, 20);
        };
        ...
        0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::utils::verify_signature(&arg0.signers, arg0.threshold, v2, arg8, arg9);
        if (!arg5) {
        ...
        let v4 = 0x96a0426b95bdeecca5d30a3164d1302d8de9a0aafc194543eb45cb0c2c6fab4::fast_price_feed::safe_mul_div_u64(arg2, 1000000, arg1.rate);
        ...
        if (0x2::coin::total_supply<T1>(&arg1.treasury_cap) == 0) {
            arg1.liquidity = (arg2 as u128);
        } else {
            arg1.liquidity = arg1.liquidity + (arg2 as u128);
        };
        0x2::coin::mint_and_transfer<T1>(&mut arg1.treasury_cap, v4, arg10, arg17);
        let v5 = DualTokenDepositEvent{
            sender              : arg10,
            amount              : arg2,
            lp                  : v4,
            vault_id            : 0x2::object::id<Vault<T0, T1>>(arg1),
        ...
        0x2::event::emit<DualTokenDepositEvent>(v5);
    }
    ...
    public(friend) fun deposit_with_no_fee<T0, T1>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            assert!(arg1.liquidity + (v0 as u128) <= v1, 20);
        };
        ...
        0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::utils::verify_signature(&arg0.signers, arg0.threshold, v3, arg8, arg9);
        if (!arg5) {
        ...
        let v5 = 0x96a0426b95bdeecca5d30a3164d1302d8de9a0aafc194543eb45cb0c2c6fab4::fast_price_feed::safe_mul_div_u64(v0, 1000000, arg1.rate);
        arg1.total_deposit = arg1.total_deposit + (v0 as u128);
        let v6 = 0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1.coin_store.coin);
        arg1.available_liquidity = (0x2::coin::value<T0>(v6) as u128);
        arg1.available_liquidity = (0x2::coin::value<T0>(v6) as u128);
        add_table_vault_asset<T0, T1>(arg1, 0x1::type_name::into_string(0x1::type_name::get<T0>()), (0x2::coin::value<T0>(v6) as u128), arg11);
        if (0x2::coin::total_supply<T1>(&arg1.treasury_cap) == 0) {
            arg1.liquidity = (v0 as u128);
        } else {
            arg1.liquidity = arg1.liquidity + (v0 as u128);
        };
        0x2::coin::mint_and_transfer<T1>(&mut arg1.treasury_cap, v5, 0x2::tx_context::sender(arg11), arg11);
    ...
    public entry fun deposit_with_sigs_credit_time<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = calculate_fee(v0, arg1.deposit.fee_bps);
        let v6 = v0 - v5;
        let v7 = 0x2::coin::split<T0>(&mut arg2, v5, arg11);
        if (0x1::option::is_some<0x2::coin::Coin<T0>>(&arg1.coin_store.coin)) {
            0x2::coin::join<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1.coin_store.coin), arg2);
        } else {
            0x1::option::fill<0x2::coin::Coin<T0>>(&mut arg1.coin_store.coin, arg2);
        };
        arg1.hwm = arg1.hwm + (v6 as u128);
        let v8 = 0x96a0426b95bdeecca5d30a3164d1302d8de9a0aafc194543eb45cb0c2c6fab4::fast_price_feed::safe_mul_div_u64(v6, 1000000, arg1.rate);
        arg1.total_deposit = arg1.total_deposit + (v6 as u128);
        ...
        if (0x2::coin::total_supply<T1>(&arg1.treasury_cap) == 0) {
            arg1.liquidity = (v6 as u128);
        } else {
            arg1.liquidity = arg1.liquidity + (v6 as u128);
        };
        arg1.deposit.total_fee = arg1.deposit.total_fee + v5;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v7, arg1.fee_receiver);
    ...
    public fun deposit_zap_mode_token<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: address, arg11: 0x1::ascii::String, arg12: 0x1::ascii::String, arg13: u64, arg14: u64, arg15: 0x1::ascii::String, arg16: u64, arg17: &0x2::clock::Clock, arg18: &AccessCap, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x96a0426b95bdeecca5d30a3164d1302d8de9a0aafc194543eb45cb0c2c6fab4::fast_price_feed::safe_mul_div_u64(v5, 1000000, arg1.rate);
        ...
        0x2::coin::mint_and_transfer<T1>(&mut arg1.treasury_cap, v6, arg10, arg19);
        let v7 = ZapModeDepositEvent{
            sender               : arg10,
            amount               : arg2,
            lp                   : v6,
            vault_id             : 0x2::object::id<Vault<T0, T1>>(arg1),
        ...
        0x2::event::emit<ZapModeDepositEvent>(v7);
    }
    ...
    public fun get_est_deposit_amount_credit_time<T0, T1>(arg0: &Vault<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64) : (u64, u64) {
        ...
        (v0, 0x96a0426b95bdeecca5d30a3164d1302d8de9a0aafc194543eb45cb0c2c6fab4::fast_price_feed::safe_mul_div_u64(v0, v0, v1))
    }
    ...
    public fun get_est_withdraw_amount_credit_time<T0, T1>(arg0: &Vault<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64) : (u64, u64) {
        ...
        let v6 = 0x96a0426b95bdeecca5d30a3164d1302d8de9a0aafc194543eb45cb0c2c6fab4::fast_price_feed::safe_mul_div_u64(arg1, v0, 1000000);
    ...
    public fun move_token_to_withdraw_assets_sigs<T0, T1, T2>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: u64, arg4: u64, arg5: vector<vector<u8>>, arg6: vector<vector<u8>>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::utils::verify_signature(&arg1.signers, arg1.threshold, v1, arg5, arg6);
        if (v0 == 0x1::type_name::into_string(0x1::type_name::get<T0>())) {
            ...
            let v5 = 0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.harvest_assets, v0);
            assert!(0x2::coin::value<T2>(v5) >= arg3, 2);
            let v6 = 0x2::coin::split<T2>(v5, arg3, arg8);
            if (0x2::coin::value<T2>(v5) == 0) {
                ...
                let (v7, v8) = 0x1::vector::index_of<0x1::ascii::String>(&arg2.harvest_asset_keys, &v0);
                if (v7) {
                    0x1::vector::swap_remove<0x1::ascii::String>(&mut arg2.harvest_asset_keys, v8);
                };
            } else {
                add_table_vault_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(v5) as u128), arg8);
            };
            if (0x2::bag::contains<0x1::ascii::String>(&arg2.withdraw_assets, v0)) {
                increase_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v6) as u128), arg8);
                0x2::coin::join<T2>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0), v6);
            } else {
                add_table_withdraw_asset<T0, T1>(arg2, v0, (0x2::coin::value<T2>(&v6) as u128), arg8);
                0x2::bag::add<0x1::ascii::String, 0x2::coin::Coin<T2>>(&mut arg2.withdraw_assets, v0, v6);
                0x1::vector::push_back<0x1::ascii::String>(&mut arg2.withdraw_asset_keys, v0);
            };
        };
        let v9 = MoveTokenToWithdrawAssetEvent{
            amount   : arg3,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg2),
            token    : v0,
        };
        0x2::event::emit<MoveTokenToWithdrawAssetEvent>(v9);
    }
    ...
    public entry fun redeem<T0, T1>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x2::coin::split<T0>(0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1.coin_store.coin), v7, arg3);
        let v12 = calculate_fee(v7, arg1.withdraw.fee_bps);
        arg1.withdraw.total_fee = arg1.withdraw.total_fee + v12;
        arg1.total_fee = arg1.total_fee + v12;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v11, v12, arg3), arg1.fee_receiver);
    ...
    fun redeem_dual_token_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<vector<0x1::ascii::String>>, arg4: vector<u64>, arg5: vector<vector<u64>>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        ...
        let v6 = 0x1::vector::length<u64>(&arg4);
        assert!(v6 == 0x1::vector::length<vector<0x1::ascii::String>>(&arg3), 29);
        assert!(v6 == 0x1::vector::length<vector<u64>>(&arg5), 28);
        assert!(v6 == 0x1::vector::length<u64>(&arg6), 30);
        let v7 = 0;
        while (v7 < 0x1::vector::length<PendingRedeem>(&v3)) {
            let v8 = 0x1::vector::borrow<PendingRedeem>(&v3, v7);
            let (v9, _) = 0x1::vector::index_of<u64>(&arg4, &v8.withdraw_time);
            if (v9) {
                0x1::vector::push_back<PendingRedeem>(&mut v4, *v8);
            } else {
        ...
        let v11 = 0x1::vector::length<PendingRedeem>(&v4);
        assert!(v11 > 0, 19);
        let v12 = 0;
        let v13 = 0;
        let v14 = 0;
        let v15 = 0;
        let v16 = 0;
        let v17 = 0x1::type_name::into_string(0x1::type_name::get<T2>());
        let v18 = 0x1::type_name::into_string(0x1::type_name::get<T3>());
        while (v16 < v11) {
            let v19 = 0x1::vector::borrow<PendingRedeem>(&v4, v16);
            let (_, v21) = 0x1::vector::index_of<u64>(&arg4, &v19.withdraw_time);
            let v22 = 0x1::vector::borrow<vector<u64>>(&arg5, v21);
            let v23 = 0x1::vector::borrow<u64>(&arg6, v21);
            assert!(v19.amount >= *v23, 18);
            let v24 = 0x1::vector::borrow<vector<0x1::ascii::String>>(&arg3, v21);
            assert!(0x1::vector::length<0x1::ascii::String>(v24) == 2, 31);
            let (v25, v26) = 0x1::vector::index_of<0x1::ascii::String>(v24, &v17);
            let (v27, v28) = 0x1::vector::index_of<0x1::ascii::String>(v24, &v18);
            if (v25 && v27) {
                v12 = v12 + *0x1::vector::borrow<u64>(v22, v26);
                v13 = v13 + *0x1::vector::borrow<u64>(v22, v28);
            } else if (v25) {
                v12 = v12 + *0x1::vector::borrow<u64>(v22, v26);
            } else if (v27) {
                v13 = v13 + *0x1::vector::borrow<u64>(v22, v28);
        ...
        let v29 = arg1.hwm;
        let v30 = if (v29 >= (v15 as u128)) {
            v29 - (v15 as u128)
        } else {
            0
        };
        arg1.hwm = v30;
        arg1.pending_redemptions = arg1.pending_redemptions - (v14 as u128);
        assert!(v12 > 0, 21);
        assert!(v13 > 0, 22);
        let v31 = spend_withdraw_asset<T0, T1, T2>(arg1, v12, arg11);
        let v32 = spend_withdraw_asset<T0, T1, T3>(arg1, v13, arg11);
        let v33 = calculate_fee(v12, arg1.withdraw.fee_bps);
        let v34 = calculate_fee(v13, arg1.withdraw.fee_bps);
        arg1.withdraw.total_fee = arg1.withdraw.total_fee + calculate_fee(v15, arg1.withdraw.fee_bps);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v31, v33, arg11), arg1.fee_receiver);
        0x2::transfer::public_transfer<0x2::coin::Coin<T3>>(0x2::coin::split<T3>(&mut v32, v34, arg11), arg1.fee_receiver);
        arg1.total_withdraw = arg1.total_withdraw + (v15 as u128);
        let v35 = DualTokensRedeemEvent{
            receiver                            : arg2,
            item_amount                         : v14,
            collateral_amount                   : v15,
            vault_id                            : 0x2::object::id<Vault<T0, T1>>(arg1),
            fee_a                               : v33,
            fee_b                               : v34,
            tokens                              : arg3,
        ...
        0x2::event::emit<DualTokensRedeemEvent>(v35);
        (v31, v32)
    }
    ...
    entry fun redeem_fee_v2<T0, T1>(arg0: &OperatorCap, arg1: &mut VaultConfig, arg2: &mut Vault<T0, T1>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < 0x1::vector::length<PendingRedeem>(&v1)) {
            let v5 = 0x1::vector::borrow<PendingRedeem>(&v1, v4);
            let (v6, _) = 0x1::vector::index_of<u64>(&arg3, &v5.withdraw_time);
            if (v6) {
                0x1::vector::push_back<PendingRedeem>(&mut v2, *v5);
            } else {
                0x1::vector::push_back<PendingRedeem>(&mut v3, *v5);
        ...
        let v8 = 0x1::vector::length<PendingRedeem>(&v2);
        assert!(v8 > 0, 19);
        let v9 = 0;
        let v10 = 0;
        while (v10 < v8) {
            v9 = v9 + 0x1::vector::borrow<PendingRedeem>(&v2, v10).amount;
            v10 = v10 + 1;
        };
        arg2.pending_redemptions = arg2.pending_redemptions - (v9 as u128);
        let v11 = spend_withdraw_asset<T0, T1, T0>(arg2, v9, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v11, arg2.fee_receiver);
        let v12 = RedeemFeeEventV2{
            receiver          : arg2.fee_receiver,
            amount            : v9,
            vault_id          : 0x2::object::id<Vault<T0, T1>>(arg2),
            withdraw_requests : arg3,
        };
        0x2::event::emit<RedeemFeeEventV2>(v12);
    }
    ...
    public(friend) fun redeem_internal<T0, T1>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: u64, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0xa6ce917b3fea8d6b32e7811b555f7d00b4364d0d18ea3dcb2cc340420a220a76::utils::verify_signature(&arg0.signers, arg0.threshold, v1, arg6, arg7);
        assert!(0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, arg2), 7);
        let v3 = 0x2::table::remove<address, vector<PendingRedeem>>(&mut arg1.pending_redeems, arg2);
        let v4 = 0x1::vector::empty<PendingRedeem>();
        let v5 = 0x1::vector::empty<PendingRedeem>();
    ...
    public(friend) fun redeem_token_internal<T0, T1, T2>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: address, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        arg1.total_withdraw = arg1.total_withdraw + (v14 as u128);
        let v25 = RedeemWithSigTokenEvent{
            receiver                            : arg2,
            item_amount                         : v13,
            amount                              : v12,
        ...
        0x2::event::emit<RedeemWithSigTokenEvent>(v25);
        v23
    }
    ...
    public entry fun withdraw_dual_token<T0, T1, T2, T3>(arg0: &mut VaultConfig, arg1: &mut Vault<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x96a0426b95bdeecca5d30a3164d1302d8de9a0aafc194543eb45cb0c2c6fab4::fast_price_feed::safe_mul_div_u64(v2, arg1.rate, 1000000);
        ...
        if (0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, v1)) {
            ...
            while (v8 < 0x1::vector::length<PendingRedeem>(v7)) {
                assert!(0x1::vector::borrow<PendingRedeem>(v7, v8).withdraw_time != v6.withdraw_time, 26);
                v8 = v8 + 1;
            };
    ...
    fun withdraw_fee_internal<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        if (0x2::table::contains<address, vector<PendingRedeem>>(&arg0.pending_redeems, v3)) {
            let v5 = 0x2::table::borrow_mut<address, vector<PendingRedeem>>(&mut arg0.pending_redeems, v3);
            let v6 = 0;
            while (v6 < 0x1::vector::length<PendingRedeem>(v5)) {
                assert!(0x1::vector::borrow<PendingRedeem>(v5, v6).withdraw_time != v4.withdraw_time, 26);
                v6 = v6 + 1;
            };
            0x1::vector::push_back<PendingRedeem>(v5, v4);
        } else {
            let v7 = 0x1::vector::empty<PendingRedeem>();
            0x1::vector::push_back<PendingRedeem>(&mut v7, v4);
            0x2::table::add<address, vector<PendingRedeem>>(&mut arg0.pending_redeems, v3, v7);
        };
        arg0.pending_redemptions = arg0.pending_redemptions + (v1 as u128);
        arg0.pending_fee = arg0.pending_fee - v1;
        let v8 = WithdrawFeeEvent{
            amount   : arg1,
            vault_id : 0x2::object::id<Vault<T0, T1>>(arg0),
            time     : v0,
        };
        0x2::event::emit<WithdrawFeeEvent>(v8);
    }
        ...
        if (v8) {
            ...
            if (0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, v1)) {
                ...
                while (v14 < 0x1::vector::length<PendingRedeem>(v13)) {
                    assert!(0x1::vector::borrow<PendingRedeem>(v13, v14).withdraw_time != v12.withdraw_time, 26);
                    v14 = v14 + 1;
                };
