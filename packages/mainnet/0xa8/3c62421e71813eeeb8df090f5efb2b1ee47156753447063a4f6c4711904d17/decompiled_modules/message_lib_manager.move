module 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_manager {
    ...
    struct MessageLibRegistry has store {
        ...
        lib_to_type: 0x2::table::Table<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>,
    }

    struct MessageLibConfig has copy, drop, store {
        send_lib: address,
        receive_lib: address,
        receive_lib_timeout: 0x1::option::Option<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>,
    }
    ...
    struct LibraryRegisteredEvent has copy, drop {
        new_lib: address,
        lib_type: 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType,
    }
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : MessageLibManager {
        let v0 = MessageLibRegistry{
            ...
            lib_to_type : 0x2::table::new<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>(arg0),
        };
        MessageLibManager{
            registry        : v0,
    ...
    fun assert_default_receive_library_configured(arg0: &MessageLibManager, arg1: u32) {
        ...
        let v1 = if (0x2::table::contains<u32, MessageLibConfig>(v0, arg1)) {
            ...
            let v2 = MessageLibConfig{
                send_lib            : @0x0,
                receive_lib         : @0x0,
                receive_lib_timeout : 0x1::option::none<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>(),
            };
            &v2
        };
    ...
    fun assert_receive_library_type(arg0: &MessageLibManager, arg1: address) {
        ...
        assert!(v0 == 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::receive() || v0 == 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::send_and_receive(), 9);
    }

    fun assert_registered_library(arg0: &MessageLibManager, arg1: address) {
        assert!(0x2::table::contains<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>(&arg0.registry.lib_to_type, arg1), 10);
    }

    fun assert_send_library_type(arg0: &MessageLibManager, arg1: address) {
        let v0 = get_library_type(arg0, arg1);
        assert!(v0 == 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::send() || v0 == 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::send_and_receive(), 11);
    }
    ...
    public(friend) fun get_default_receive_library_timeout(arg0: &MessageLibManager, arg1: u32) : 0x1::option::Option<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout> {
        assert_default_receive_library_configured(arg0, arg1);
    ...
    public(friend) fun get_library_type(arg0: &MessageLibManager, arg1: address) : 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType {
        let v0 = &arg0.registry.lib_to_type;
        assert!(0x2::table::contains<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>(v0, arg1), 10);
        *0x2::table::borrow<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>(v0, arg1)
    }
    ...
    public(friend) fun get_receive_library_timeout(arg0: &MessageLibManager, arg1: address, arg2: u32) : 0x1::option::Option<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout> {
        let v0 = &arg0.oapp_configs;
        let v1 = OAppConfigKey{
            oapp : arg1,
            eid  : arg2,
    ...
    public(friend) fun is_registered_library(arg0: &MessageLibManager, arg1: address) : bool {
        0x2::table::contains<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>(&arg0.registry.lib_to_type, arg1)
    }
    ...
    public(friend) fun is_valid_receive_library(arg0: &MessageLibManager, arg1: address, arg2: u32, arg3: address, arg4: &0x2::clock::Clock) : bool {
        ...
        let v4 = v2;
        if (0x1::option::is_none<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>(&v4)) {
            false
        } else {
            let v6 = 0x1::option::destroy_some<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>(v4);
            !0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::is_expired(&v6, arg4) && 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::fallback_lib(&v6) == arg3
        }
    }

    public(friend) fun register_library(arg0: &mut MessageLibManager, arg1: address, arg2: 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType) {
        assert!(!0x2::table::contains<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>(&arg0.registry.lib_to_type, arg1), 1);
        assert!(arg1 != @0x0, 4);
        0x2::table_vec::push_back<address>(&mut arg0.registry.libs, arg1);
        0x2::table::add<address, 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_type::MessageLibType>(&mut arg0.registry.lib_to_type, arg1, arg2);
    ...
    public(friend) fun set_config(arg0: &MessageLibManager, arg1: address, arg2: address, arg3: u32, arg4: u32, arg5: vector<u8>) : 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_set_config::SetConfigParam {
        assert_registered_library(arg0, arg2);
        0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::message_lib_set_config::create_param(arg1, arg3, arg4, arg5)
    }
    ...
    public(friend) fun set_default_receive_library(arg0: &mut MessageLibManager, arg1: u32, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        let v5 = if (arg3 > 0) {
            let v6 = 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::create_with_grace_period(arg3, v3, arg4);
            v2.receive_lib_timeout = 0x1::option::some<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>(v6);
            0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::expiry(&v6)
        } else {
            v2.receive_lib_timeout = 0x1::option::none<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>();
            0
        };
    ...
    public(friend) fun set_default_receive_library_timeout(arg0: &mut MessageLibManager, arg1: u32, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (arg3 > 0) {
            let v1 = 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::create(arg3, arg2);
            assert!(!0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::is_expired(&v1, arg4), 6);
            v0.receive_lib_timeout = 0x1::option::some<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>(v1);
        } else {
            v0.receive_lib_timeout = 0x1::option::none<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>();
        };
    ...
    public(friend) fun set_receive_library(arg0: &mut MessageLibManager, arg1: address, arg2: u32, arg3: address, arg4: u64, arg5: &0x2::clock::Clock) {
        ...
        let v8 = if (arg4 > 0) {
            ...
            let v9 = 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::create_with_grace_period(arg4, v6, arg5);
            v5.receive_lib_timeout = 0x1::option::some<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>(v9);
            0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::expiry(&v9)
        } else {
            v5.receive_lib_timeout = 0x1::option::none<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>();
            0
        };
    ...
    public(friend) fun set_receive_library_timeout(arg0: &mut MessageLibManager, arg1: address, arg2: u32, arg3: address, arg4: u64, arg5: &0x2::clock::Clock) {
        ...
        if (arg4 > 0) {
            let v4 = 0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::create(arg4, arg3);
            assert!(!0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::is_expired(&v4, arg5), 6);
            v3.receive_lib_timeout = 0x1::option::some<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>(v4);
        } else {
            v3.receive_lib_timeout = 0x1::option::none<0xa83c62421e71813eeeb8df090f5efb2b1ee47156753447063a4f6c4711904d17::timeout::Timeout>();
        };
