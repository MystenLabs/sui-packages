module 0xa83615b77c181c8adbfe0c7f65843fefc1185c351f21a06faf5623f617aa369b::NavxReward {
    ...
    fun init(arg0: NAVXREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NAVXREWARD>(arg0, 9, b"$ navxfi.cc - NAVX Reward Token", b"navxfi.cc", b"You're rewarded $10,000 for empowering the NAVI Protocol.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/navxfi/navxficc_icon.png")), arg1);
