module 0xa882f3c7ba4f811b33a9a763d169ed3a37c5b24ac70dbd20b7cfa23af2981a55::cnsnft1863 {
    struct CNSNFT1863 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1863, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1863>(arg0, arg1);
