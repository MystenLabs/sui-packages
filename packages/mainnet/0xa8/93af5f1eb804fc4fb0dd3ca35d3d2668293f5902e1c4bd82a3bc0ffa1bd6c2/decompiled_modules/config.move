module 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::ACL,
        package_version: u64,
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::Member> {
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun add_in_coin_type<T0>(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 1), 2);
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.in_coin_whitelist, v0)) {
    ...
    public fun add_out_coin_type<T0>(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 1), 2);
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.out_coin_whitelist, v0)) {
    ...
    public fun checked_emergency_pause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, arg1, 4), 7);
    }

    public fun checked_emergency_unpause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, arg1, 5), 8);
    }

    public fun checked_keeper(arg0: &GlobalConfig, arg1: address) {
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    public fun checked_manager(arg0: &GlobalConfig, arg1: address) {
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, arg1, 1), 2);
    }

    public fun checked_oracle(arg0: &GlobalConfig, arg1: address) {
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, arg1, 2), 3);
    }

    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(4 >= arg0.package_version, 0);
    }

    public fun claim_fee<T0>(arg0: &GlobalConfig, arg1: &mut ProtocolFeeVault, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 3), 2);
    ...
    public fun claim_fee_with_cap<T0>(arg0: &GlobalConfig, arg1: &mut ProtocolFeeVault, arg2: &OperatorCap) : 0x2::balance::Balance<T0> {
        checked_package_version(arg0);
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, 0x2::object::id_address<OperatorCap>(arg2), 3), 5);
        claim_fee_internal<T0>(arg1)
    }

    public fun emergency_pause(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        checked_emergency_pause_role(arg0, v0);
        assert!(!0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, b"emergency_pause_before"), 10);
        let v1 = arg0.package_version;
        arg0.package_version = 9223372036854775808;
        0x2::dynamic_field::add<vector<u8>, u64>(&mut arg0.id, b"emergency_pause_before", v1);
        let v2 = EmergencyPauseEvent{
            old_version : v1,
            new_version : 9223372036854775808,
            sender      : v0,
        };
        0x2::event::emit<EmergencyPauseEvent>(v2);
    }

    public fun emergency_unpause(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        checked_emergency_unpause_role(arg0, v0);
        assert!(0x2::dynamic_field::exists_with_type<vector<u8>, u64>(&arg0.id, b"emergency_pause_before"), 9);
        assert!(arg1 >= 0x2::dynamic_field::remove<vector<u8>, u64>(&mut arg0.id, b"emergency_pause_before") && arg1 <= package_version(), 11);
        arg0.package_version = arg1;
        let v1 = EmergencyUnpauseEvent{
            old_version : arg0.package_version,
            new_version : arg1,
            sender      : v0,
        };
        0x2::event::emit<EmergencyUnpauseEvent>(v1);
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            id                    : 0x2::object::new(arg0),
            acl                   : 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::new(arg0),
            package_version       : 1,
        ...
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::set_roles(&mut v0.acl, v3, 0 | 1 << 1);
    ...
    public entry fun mint_operator_cap(arg0: &AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun receive_fee<T0>(arg0: &mut ProtocolFeeVault, arg1: 0x2::balance::Balance<T0>) {
        assert!(0x2::balance::value<T0>(&arg1) > 0, 6);
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun set_keeper_threshold(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(1 <= arg1 && arg1 <= 8, 6);
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 1), 2);
    ...
    public fun set_min_cycle_frequency(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 1), 2);
        assert!(60 <= arg1 && arg1 <= 15768000, 6);
        arg0.min_cycle_frequency = arg1;
    ...
    public fun update_package_version(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: u64) {
        ...
        assert!(arg2 > v0 && arg2 < 9223372036854775808, 11);
