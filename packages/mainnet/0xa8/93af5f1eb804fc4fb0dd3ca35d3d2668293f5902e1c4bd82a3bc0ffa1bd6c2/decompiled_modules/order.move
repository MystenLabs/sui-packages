module 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::order {
    ...
    public fun cancel_order<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_package_version(arg0);
    ...
    public fun cancle_order<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        abort 17
    }

    public fun flash_loan_for_make_deal<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &mut 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::ProtocolFeeVault, arg2: &mut Order<T0, T1>, arg3: u64, arg4: vector<0x1::string::String>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, MakeDealReceipt) {
        abort 17
    }

    public fun flash_loan_for_make_deal_v2<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &mut 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::ProtocolFeeVault, arg2: &mut Order<T0, T1>, arg3: u64, arg4: u64, arg5: vector<0x1::string::String>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, MakeDealReceipt) {
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_package_version(arg0);
        assert!(arg2.status == 0, 13);
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_keeper(arg0, 0x2::tx_context::sender(arg7));
        let v0 = 0x2::clock::timestamp_ms(arg6) / 1000;
        assert!(arg2.amount_left_next_cycle > 0, 2);
        assert!(v0 >= arg2.next_cycle_at, 3);
        assert!(arg2.min_out_amount_per_cycle <= arg3 && arg3 <= arg2.max_out_amount_per_cycle, 16);
        assert!(validate_keepers_v2<T0, T1>(arg0, arg2, arg3, arg5, arg4, arg6), 14);
        ...
        let v2 = if (arg2.fee_rate > 0) {
            ...
            0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::receive_fee<T0>(arg1, 0x2::balance::split<T0>(&mut v1, v3));
            v3
        } else {
            0
        };
    ...
    public fun open_order<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x1::string::String, arg10: &0x2::clock::Clock, arg11: &mut OrderIndexer, arg12: &mut 0x2::tx_context::TxContext) {
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_package_version(arg0);
        assert!(0x1::type_name::get<T0>() != 0x1::type_name::get<T1>(), 20);
        assert!(arg4 < arg5, 16);
        assert!(arg7 <= (1000000 as u64), 18);
        assert!(arg2 <= 31536000, 19);
        let v0 = 0x2::coin::value<T0>(&arg1) / arg3;
        assert!(0 < v0, 21);
        assert!(((0x2::coin::value<T0>(&arg1) / v0) as u128) * (arg5 as u128) <= 18446744073709551615, 24);
        ...
        0x2::table::add<0x2::object::ID, bool>(&mut arg11.open_orders, v6, true);
    ...
    fun parse_signature(arg0: vector<u8>) : (address, vector<u8>, vector<u8>) {
        assert!(0x1::vector::length<u8>(&arg0) == 97, 22);
    ...
    public fun repay_for_make_deal<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: 0x2::coin::Coin<T1>, arg4: MakeDealReceipt, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_package_version(arg0);
    ...
    fun validate_keepers<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &Order<T0, T1>, arg2: u64, arg3: vector<0x1::string::String>) : bool {
        abort 17
    }

    fun validate_keepers_v2<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &Order<T0, T1>, arg2: u64, arg3: vector<0x1::string::String>, arg4: u64, arg5: &0x2::clock::Clock) : bool {
        let v0 = 0x2::clock::timestamp_ms(arg5) / 1000;
        assert!(v0 >= arg4 && v0 - arg4 <= 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::oracle_valid_duration(arg0), 14);
        if (0x1::vector::length<0x1::string::String>(&arg3) < 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::keeper_threshold(arg0)) {
            return false
        };
        let v1 = 0x2::vec_set::empty<address>();
        let v2 = 0;
        let v3 = 0x2::object::id_bytes<Order<T0, T1>>(arg1);
        let v4 = 0x1::type_name::get<T0>();
        0x1::vector::append<u8>(&mut v3, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v4));
        let v5 = 0x1::type_name::get<T1>();
        0x1::vector::append<u8>(&mut v3, 0x1::bcs::to_bytes<0x1::type_name::TypeName>(&v5));
        0x1::vector::append<u8>(&mut v3, 0x1::bcs::to_bytes<u64>(&arg1.next_cycle_at));
        0x1::vector::append<u8>(&mut v3, 0x1::bcs::to_bytes<u64>(&arg1.amount_left_next_cycle));
        0x1::vector::append<u8>(&mut v3, 0x1::bcs::to_bytes<u64>(&arg2));
        0x1::vector::append<u8>(&mut v3, 0x1::bcs::to_bytes<u64>(&arg4));
        while (v2 < 0x1::vector::length<0x1::string::String>(&arg3)) {
            let (v6, v7) = verify_internal(arg0, v3, 0x1::vector::borrow<0x1::string::String>(&arg3, v2), 1);
            if (v6) {
                0x2::vec_set::insert<address>(&mut v1, v7);
            };
            v2 = v2 + 1;
        };
        if (0x2::vec_set::size<address>(&v1) < 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::keeper_threshold(arg0)) {
            return false
        };
        true
    }

    fun validate_order<T0, T1>(arg0: address, arg1: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: 0x1::string::String, arg9: &0x2::clock::Clock) {
        assert!(0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::is_coin_allow<T0, T1>(arg1), 15);
        assert!(arg5 >= 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::min_cycle_count(arg1), 0);
        assert!(arg3 > 0, 7);
        assert!(arg2 >= arg3, 7);
        assert!(arg4 >= 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::min_cycle_frequency(arg1), 1);
        ...
        assert!(v1 <= 0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::oracle_valid_duration(arg1), 11);
    ...
    fun verify_internal(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: vector<u8>, arg2: &0x1::string::String, arg3: u8) : (bool, address) {
        let (v0, v1, v2) = parse_signature(0x2::hex::decode(*0x1::string::as_bytes(arg2)));
        let v3 = v2;
        let v4 = v1;
        if (arg3 == 0) {
            0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_oracle(arg0, v0);
        } else {
            0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_keeper(arg0, v0);
        };
        (0x2::ed25519::ed25519_verify(&v3, &v4, &arg1), v0)
    }

    public fun withdraw<T0, T1>(arg0: &0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::GlobalConfig, arg1: &mut Order<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0x587614620d0d30aed66d86ffd3ba385a661a86aa573a4d579017068f561c6d8f::config::checked_package_version(arg0);
