module 0xa85da58409caf7be5b93669a4cd6b1c71131a2e845fc96b10a2e598a8a843483::cnsnft1949 {
    struct CNSNFT1949 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1949, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1949>(arg0, arg1);
