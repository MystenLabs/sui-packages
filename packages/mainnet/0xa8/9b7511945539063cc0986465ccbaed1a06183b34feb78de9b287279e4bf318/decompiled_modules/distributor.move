module 0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::distributor {
    ...
    fun init(arg0: DISTRIBUTOR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::jackson_sharkz::JacksonSharkz>(&v4, v0, v2, arg1);
        0x2::display::update_version<0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::jackson_sharkz::JacksonSharkz>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::jackson_sharkz::JacksonSharkz>>(v5, 0x2::tx_context::sender(arg1));
        let v6 = Distributor{
    ...
    public entry fun mint_single(arg0: &DistributorCap, arg1: &mut Distributor, arg2: u64, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::jackson_sharkz::new(arg2, arg1.name, arg1.description, 0x1::option::some<0x1::string::String>(arg3), 0x1::option::some<0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::attributes::Attributes>(0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::attributes::admin_new(arg4, arg5, arg7)), arg7);
        0x2::table::add<u64, 0x2::object::ID>(&mut arg1.registry, arg2, 0x2::object::id<0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::jackson_sharkz::JacksonSharkz>(&v0));
        let v1 = NFTMinted{
            nft_id : 0x2::object::id<0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::jackson_sharkz::JacksonSharkz>(&v0),
            minter : arg6,
        };
        0x2::event::emit<NFTMinted>(v1);
        0x2::transfer::public_transfer<0xa89b7511945539063cc0986465ccbaed1a06183b34feb78de9b287279e4bf318::jackson_sharkz::JacksonSharkz>(v0, arg6);
