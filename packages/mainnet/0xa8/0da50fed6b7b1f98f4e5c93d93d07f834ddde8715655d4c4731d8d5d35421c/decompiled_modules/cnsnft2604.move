module 0xa80da50fed6b7b1f98f4e5c93d93d07f834ddde8715655d4c4731d8d5d35421c::cnsnft2604 {
    struct CNSNFT2604 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2604, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4249"));
        let v4 = 0x2::package::claim<CNSNFT2604>(arg0, arg1);
