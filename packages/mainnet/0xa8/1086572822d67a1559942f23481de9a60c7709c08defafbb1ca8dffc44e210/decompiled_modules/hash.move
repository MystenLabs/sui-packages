module 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::hash {
    ...
    public fun generate_attestation_msg(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64) : vector<u8> {
        let v0 = new();
        assert!(0x1::vector::length<u8>(&arg0) == 32, 13906834951732592643);
        assert!(0x1::vector::length<u8>(&arg1) == 32, 13906834956027822087);
        assert!(0x1::vector::length<u8>(&arg2) == 32, 13906834960322920457);
        assert!(0x1::vector::length<u8>(&arg3) == 32, 13906834964617625605);
        assert!(0x1::vector::length<u8>(&arg4) == 64, 13906834968912986123);
        let v1 = &mut v0;
        push_bytes(v1, arg0);
        let v2 = &mut v0;
        push_bytes(v2, arg1);
    ...
    public fun generate_consensus_msg(arg0: u64, arg1: u64, arg2: &vector<vector<u8>>, arg3: &vector<0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal>, arg4: vector<u8>) : vector<u8> {
        let v0 = new();
        let v1 = &mut v0;
        push_u64_le(v1, arg0);
        let v2 = &mut v0;
        ...
        while (v3 < 0x1::vector::length<vector<u8>>(arg2)) {
            ...
            let v5 = 0x1::vector::borrow<0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal>(arg3, v3);
            assert!(0x1::vector::length<u8>(v4) == 32, 13906834835768344577);
            let v6 = &mut v0;
            push_bytes(v6, *v4);
            let v7 = &mut v0;
            push_decimal_le(v7, v5);
            let v8 = &mut v0;
            push_u8(v8, *0x1::vector::borrow<u8>(&arg4, v3));
            v3 = v3 + 1;
        };
        let Hasher { buffer: v9 } = v0;
        v9
    }

    public fun generate_update_msg(arg0: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u32, arg6: u64) : vector<u8> {
        let v0 = new();
        assert!(0x1::vector::length<u8>(&arg1) == 32, 13906834681149915143);
        assert!(0x1::vector::length<u8>(&arg2) == 32, 13906834685444489217);
        assert!(0x1::vector::length<u8>(&arg3) == 32, 13906834689739718661);
        let v1 = &mut v0;
        push_bytes(v1, arg1);
        let v2 = &mut v0;
        push_bytes(v2, arg2);
    ...
    public fun push_decimal(arg0: &mut Hasher, arg1: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal) {
        let (v0, v1) = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::unpack(*arg1);
        push_i128(arg0, v0, v1);
    }

    public fun push_decimal_le(arg0: &mut Hasher, arg1: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::Decimal) {
        let (v0, v1) = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::unpack(*arg1);
