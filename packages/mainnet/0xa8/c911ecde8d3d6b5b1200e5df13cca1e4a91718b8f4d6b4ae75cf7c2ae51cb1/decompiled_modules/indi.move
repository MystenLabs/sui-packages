module 0xa8c911ecde8d3d6b5b1200e5df13cca1e4a91718b8f4d6b4ae75cf7c2ae51cb1::indi {
    ...
    entry fun burn(arg0: &mut ProtectedTreasury, arg1: &AdminRegistry, arg2: 0x2::coin::Coin<INDI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::coin::value<INDI>(&arg2);
        let (v2, v3) = if (v1 > arg3) {
            0x2::transfer::public_transfer<0x2::coin::Coin<INDI>>(arg2, v0);
            (0x2::coin::split<INDI>(&mut arg2, arg3, arg5), v1 - arg3)
        } else {
            assert!(v1 == arg3, 1302);
            (arg2, 0)
        };
        ...
        0x2::coin::burn<INDI>(v6, v2);
        assert!(arg0.current_supply == 0x2::coin::total_supply<INDI>(borrow_cap(arg0)), 1404);
    }

    entry fun total_supply(arg0: &ProtectedTreasury) : u64 {
        0x2::coin::total_supply<INDI>(borrow_cap(arg0))
    }
    ...
    fun borrow_cap(arg0: &ProtectedTreasury) : &0x2::coin::TreasuryCap<INDI> {
        let v0 = TreasuryCapKey{dummy_field: false};
        0x2::dynamic_object_field::borrow<TreasuryCapKey, 0x2::coin::TreasuryCap<INDI>>(&arg0.id, v0)
    }

    fun borrow_cap_mut(arg0: &mut ProtectedTreasury) : &mut 0x2::coin::TreasuryCap<INDI> {
        let v0 = TreasuryCapKey{dummy_field: false};
        0x2::dynamic_object_field::borrow_mut<TreasuryCapKey, 0x2::coin::TreasuryCap<INDI>>(&mut arg0.id, v0)
    }
    ...
    fun init(arg0: INDI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<INDI>(arg0, 9, b"INDI", b"Indi", b"indi token description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://vram.mypinata.cloud/ipfs/bafkreic2p5m4mvguperqmpvfkfh4jzmdnj6rrigmi5hxofw6kh2kewmlb4"))), arg1);
        ...
        0x2::dynamic_object_field::add<TreasuryCapKey, 0x2::coin::TreasuryCap<INDI>>(&mut v4.id, v5, v0);
        let v6 = &mut v4;
        v4.current_supply = 1000000000000000000;
        let v7 = MintEvent{
            amount             : 1000000000000000000,
            recipient          : @0x6d511af1de165db1ce84dfc48076a04b0c031242d95da3668553ece3840abc37,
            minter             : v2,
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<INDI>>(0x2::coin::mint<INDI>(borrow_cap_mut(v6), 1000000000000000000, arg1), @0x6d511af1de165db1ce84dfc48076a04b0c031242d95da3668553ece3840abc37);
        0x2::transfer::share_object<ProtectedTreasury>(v4);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<INDI>>(v1);
