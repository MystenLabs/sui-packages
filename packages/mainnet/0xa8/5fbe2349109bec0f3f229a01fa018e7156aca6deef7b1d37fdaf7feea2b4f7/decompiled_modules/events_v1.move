module 0x9ec78ad67035029b202a08d25f72ade9c6ed6ca3abb0939fade3e895117d69a0::events_v1 {
    ...
    struct UnstakePositionEventV1a has copy, drop {
        holder_position_id: 0x2::object::ID,
        farm_id: 0x2::object::ID,
        balance: u256,
        liquidity: u128,
    ...
    public fun emit_unstake_position_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u256) {
    ...
    public fun emit_unstake_position_event_v1a(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: u256, arg3: u128, arg4: 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i32::I32, arg5: 0x25929e7f29e0a30eb4e692952ba1b5b65a3a4d65ab5f2a32e1ba3edcb587f26d::i32::I32) {
        let v0 = UnstakePositionEventV1a{
            holder_position_id : arg0,
            farm_id            : arg1,
            balance            : arg2,
            liquidity          : arg3,
        ...
        0x2::event::emit<UnstakePositionEventV1a>(v0);
    }
