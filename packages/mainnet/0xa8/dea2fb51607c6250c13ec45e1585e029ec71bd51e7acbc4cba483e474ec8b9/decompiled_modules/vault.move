module 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::vault {
    ...
    public fun calculate_lp_token_share<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::coin::TreasuryCap<VAULT>, arg3: u64) : (u64, u64) {
        let (v0, v1, v2, v3) = get_deepbook_account_assets<T0, T1>(arg0, arg1);
        assert!(v1 > 0, 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::locked_base_asset_found());
        assert!(v3 > 0, 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::locked_quote_asset_found());
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::constants::lp_token_metadata();
        let (v4, v5) = 0x2::coin::create_currency<VAULT>(arg0, v0, v1, v2, v3, 0x1::option::none<0x2::url::Url>(), arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<VAULT>>(v4, 0x2::tx_context::sender(arg1));
    ...
    fun mint_lp_token(arg0: &mut 0x2::coin::TreasuryCap<VAULT>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<VAULT> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::constants::minimal_liquidity(), 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::liquidityInsufficientMinted());
        0x2::coin::mint<VAULT>(arg0, v1, arg5)
    }

    public fun new_vault<T0, T1>(arg0: &0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
        let v0 = Vault<T0, T1>{
    ...
    public fun process_deposits<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1>(arg1), 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::invalid_vault_cap());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg5)), 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::address_not_whitelisted());
        let v0 = &arg1.deepbook_account_cap;
        let (v1, v2, v3, v4) = get_deepbook_account_assets<T0, T1>(arg1, arg2);
        assert!(v2 > 0, 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::locked_base_asset_found());
        assert!(v4 > 0, 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::locked_quote_asset_found());
        let v5 = v1 / v3;
        ...
        while (0x1::vector::length<DepositRequest<T1>>(&arg1.deposit_requests) > 0) {
            ...
            let v13 = v11;
            let (v14, v15) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg2, v0, 1, 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&v13), v5, v5 + 1) * v8, true, 0x2::coin::zero<T0>(arg5), 0x2::coin::from_balance<T1>(v13, arg5), arg4, arg5);
            let v16 = v15;
            let v17 = v14;
    ...
    public fun process_withdrawals<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1>(arg1), 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::invalid_vault_cap());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg4)), 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::address_not_whitelisted());
        let v0 = &arg1.deepbook_account_cap;
    ...
    public fun revoke_trading_permission<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: address) {
        ...
        assert!(v0, 0xa8dea2fb51607c6250c13ec45e1585e029ec71bd51e7acbc4cba483e474ec8b9::error::address_not_whitelisted());
