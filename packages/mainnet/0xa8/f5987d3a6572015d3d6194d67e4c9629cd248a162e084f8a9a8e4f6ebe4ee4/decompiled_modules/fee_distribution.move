module 0xc48ce784327427802e1f38145c65b4e5e0a74c53187fca4b9ca0d4ca47da68b1::fee_distribution {
    ...
    public fun fees_meme<T0, T1>(arg0: &FeeState<T0, T1>) : &0x2::balance::Balance<T1> {
        &arg0.fees_meme
    }

    public fun fees_meme_total<T0, T1>(arg0: &FeeState<T0, T1>) : u64 {
        arg0.fees_meme_total
    }

    public fun fees_s<T0, T1>(arg0: &FeeState<T0, T1>) : &0x2::balance::Balance<T0> {
        &arg0.fees_s
    }

    public fun fees_s_total<T0, T1>(arg0: &FeeState<T0, T1>) : u64 {
        arg0.fees_s_total
    }
    ...
    public fun stakes_total<T0, T1>(arg0: &FeeState<T0, T1>) : u64 {
        arg0.stakes_total
    }

    public fun user_withdrawals_x<T0, T1>(arg0: &FeeState<T0, T1>) : &0x2::table::Table<address, u64> {
        &arg0.user_withdrawals_x
    }

    public fun user_withdrawals_y<T0, T1>(arg0: &FeeState<T0, T1>) : &0x2::table::Table<address, u64> {
        &arg0.user_withdrawals_y
    }
