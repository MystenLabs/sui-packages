module 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::publishing {
    ...
    struct ArtifactSeriesDescriptionUpdatedEvent has copy, drop {
        series_id: 0x2::object::ID,
        artifact_type: u8,
        updated_by: address,
        updated_at_ms: u64,
    ...
    struct ArtifactVersionChangeNoteRecordedEvent has copy, drop {
        series_id: 0x2::object::ID,
        version_id: 0x2::object::ID,
        artifact_type: u8,
        version: u64,
    ...
    struct ArtifactControllerPromotionEvent has copy, drop {
        series_id: 0x2::object::ID,
        comments_tree_id: 0x2::object::ID,
        artifact_type: u8,
        promoted_by: address,
    ...
    public fun add_blog_post_version_with_controller(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg4: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg5: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg6: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: 0x1::string::String, arg15: vector<MetadataAttribute>, arg16: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        validate_title(&arg7);
        validate_medium_text(&arg8);
        validate_tags(&arg9);
        validate_short_text(&arg10);
        assert_version_change_note_present(&arg15);
        let v0 = 0x2::object::new(arg18);
        let v1 = *0x2::object::uid_as_inner(&v0);
        let v2 = add_version_common_with_controller(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::blog_post(), v1, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18);
        emit_version_change_note_event(arg2, &v2, v1, arg18);
        let v3 = BlogPostVersionRecord{
            id       : v0,
            header   : v2,
            title    : arg7,
            summary  : arg8,
        ...
        0x2::transfer::share_object<BlogPostVersionRecord>(v3);
    }
    ...
    public fun add_dataset_version_with_controller(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg4: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg5: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg6: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: u64, arg11: u64, arg12: 0x1::string::String, arg13: vector<0x1::string::String>, arg14: 0x1::string::String, arg15: 0x1::string::String, arg16: 0x1::string::String, arg17: 0x1::string::String, arg18: vector<MetadataAttribute>, arg19: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) {
        validate_title(&arg7);
        validate_long_text(&arg8);
        validate_keywords(&arg13);
        validate_short_text(&arg9);
        validate_short_text(&arg12);
        assert_version_change_note_present(&arg18);
        let v0 = 0x2::object::new(arg21);
        let v1 = *0x2::object::uid_as_inner(&v0);
        let v2 = add_version_common_with_controller(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::dataset(), v1, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21);
        emit_version_change_note_event(arg2, &v2, v1, arg21);
        let v3 = DatasetVersionRecord{
            id          : v0,
            header      : v2,
            title       : arg7,
            description : arg8,
        ...
        0x2::transfer::share_object<DatasetVersionRecord>(v3);
    }
    ...
    public fun add_generic_file_version_with_controller(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg4: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg5: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg6: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: u64, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: 0x1::string::String, arg15: 0x1::string::String, arg16: vector<MetadataAttribute>, arg17: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) {
        validate_title(&arg7);
        validate_long_text(&arg8);
        validate_short_text(&arg9);
        validate_short_text(&arg11);
        assert_version_change_note_present(&arg16);
        let v0 = 0x2::object::new(arg19);
        let v1 = *0x2::object::uid_as_inner(&v0);
        let v2 = add_version_common_with_controller(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::generic_file(), v1, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19);
        emit_version_change_note_event(arg2, &v2, v1, arg19);
        let v3 = GenericFileVersionRecord{
            id          : v0,
            header      : v2,
            title       : arg7,
            description : arg8,
        ...
        0x2::transfer::share_object<GenericFileVersionRecord>(v3);
    }
    ...
    public fun add_preprint_version_with_controller(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg4: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg5: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg6: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: u64, arg14: 0x1::string::String, arg15: 0x1::string::String, arg16: 0x1::string::String, arg17: 0x1::string::String, arg18: vector<MetadataAttribute>, arg19: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) {
        validate_title(&arg7);
        validate_long_text(&arg8);
        validate_authors(&arg9);
        ...
        let v0 = 0x2::object::new(arg21);
        let v1 = *0x2::object::uid_as_inner(&v0);
        let v2 = add_version_common_with_controller(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::preprint(), v1, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21);
        emit_version_change_note_event(arg2, &v2, v1, arg21);
        let v3 = PreprintVersionRecord{
            id            : v0,
            header        : v2,
            title         : arg7,
            abstract_text : arg8,
        ...
        0x2::transfer::share_object<PreprintVersionRecord>(v3);
    }
    ...
    public fun add_software_release_version_with_controller(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg4: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg5: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg6: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: 0x1::string::String, arg15: 0x1::string::String, arg16: 0x1::string::String, arg17: 0x1::string::String, arg18: vector<MetadataAttribute>, arg19: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) {
        validate_title(&arg7);
        validate_short_text(&arg8);
        validate_short_text(&arg9);
        validate_short_text(&arg10);
        validate_medium_text(&arg11);
        validate_short_text(&arg12);
        validate_medium_text(&arg13);
        assert_version_change_note_present(&arg18);
        let v0 = 0x2::object::new(arg21);
        let v1 = *0x2::object::uid_as_inner(&v0);
        let v2 = add_version_common_with_controller(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::software_release(), v1, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21);
        emit_version_change_note_event(arg2, &v2, v1, arg21);
        let v3 = SoftwareReleaseVersionRecord{
            id             : v0,
            header         : v2,
            project_name   : arg7,
            version_name   : arg8,
            ...
            changelog      : arg11,
            license        : arg12,
            repository_url : arg13,
        };
        0x2::transfer::share_object<SoftwareReleaseVersionRecord>(v3);
    }
    ...
    public fun add_technical_report_version_with_controller(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg4: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg5: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg6: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: vector<0x1::string::String>, arg13: 0x1::string::String, arg14: 0x1::string::String, arg15: 0x1::string::String, arg16: 0x1::string::String, arg17: 0x1::string::String, arg18: vector<MetadataAttribute>, arg19: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg20: &0x2::clock::Clock, arg21: &mut 0x2::tx_context::TxContext) {
        validate_title(&arg7);
        validate_long_text(&arg8);
        validate_authors(&arg9);
        validate_keywords(&arg12);
        validate_short_text(&arg10);
        validate_short_text(&arg11);
        validate_short_text(&arg13);
        assert_version_change_note_present(&arg18);
        let v0 = 0x2::object::new(arg21);
        let v1 = *0x2::object::uid_as_inner(&v0);
        let v2 = add_version_common_with_controller(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::technical_report(), v1, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21);
        emit_version_change_note_event(arg2, &v2, v1, arg21);
        let v3 = TechnicalReportVersionRecord{
            id            : v0,
            header        : v2,
            title         : arg7,
            abstract_text : arg8,
        ...
        0x2::transfer::share_object<TechnicalReportVersionRecord>(v3);
    }
    ...
    fun add_version_common(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg4: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg5: u8, arg6: 0x2::object::ID, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: vector<MetadataAttribute>, arg12: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : CommonArtifactHeader {
        ...
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_series_legacy_write_allowed(&arg2.id);
    ...
    fun add_version_common_with_controller(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &mut ArtifactSeries, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg4: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg5: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg6: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg7: u8, arg8: 0x2::object::ID, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: vector<MetadataAttribute>, arg14: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) : CommonArtifactHeader {
        assert_current_root(arg0);
        assert_current_registry(arg1);
        assert_current_series(arg2);
        assert!(!arg0.paused, 1);
        assert!(0x2::object::id<TypeRegistry>(arg1) == arg0.type_registry_id, 7);
        assert!(arg1.registry_id == 0x2::object::id<PaperProofRoot>(arg0), 7);
        assert!(0x2::table::borrow<u8, TypeInfo>(&arg1.types, arg7).enabled, 6);
        assert!(arg2.artifact_type == arg7, 5);
        assert!(arg2.status == 0, 22);
        assert!(0x1::vector::length<0x2::object::ID>(&arg2.version_ids) < 168, 25);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg2.id, 0x2::object::id<ArtifactSeries>(arg2), arg2.artifact_type, arg3, arg4, arg16);
        assert!(0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::registry_id(arg5) == 0x2::object::id<PaperProofRoot>(arg0), 8);
        assert!(0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::fee_manager_registry_id(arg6) == 0x2::object::id<PaperProofRoot>(arg0), 9);
        assert!(0x2::object::id<0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault>(arg5) == arg0.governance_vault_id, 8);
        assert!(0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::fee_manager_id(arg6) == arg0.fee_manager_id, 9);
        validate_content_fields(&arg9, &arg10, &arg11, &arg12);
        validate_metadata_extensions(&arg13);
        assert_version_change_note_present(&arg13);
        0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::collect_artifact_fee(arg5, arg6, arg7, arg14, arg16);
        let v0 = 0x2::clock::timestamp_ms(arg15);
        let v1 = 0x2::tx_context::sender(arg16);
        let v2 = arg2.current_version_id;
        let v3 = arg2.current_version + 1;
        arg2.current_version = v3;
        arg2.current_version_id = arg8;
        0x1::vector::push_back<0x2::object::ID>(&mut arg2.version_ids, arg8);
        arg2.updated_at_ms = v0;
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::sync_legacy_series_owner_mirror(arg3, arg4, arg2.owner, arg15, arg16);
        let v4 = CommonArtifactHeader{
            series_id             : 0x2::object::id<ArtifactSeries>(arg2),
            artifact_type         : arg7,
            version               : v3,
            ...
            author                : v1,
            content_hash          : arg9,
            walrus_blob_id        : arg10,
            walrus_blob_object_id : arg11,
            content_type          : arg12,
            metadata_extensions   : arg13,
            status                : 0,
            created_at_ms         : v0,
        };
        let v5 = ArtifactVersionAddedEvent{
    ...
    fun assert_series_description_key_integrity(arg0: &vector<MetadataAttribute>) {
        let v0 = find_metadata_value(arg0, 0x1::string::utf8(b"series_description"));
        if (0x1::option::is_some<0x1::string::String>(&v0)) {
            validate_long_text(0x1::option::borrow<0x1::string::String>(&v0));
        };
    }
    ...
    fun assert_version_change_note_present(arg0: &vector<MetadataAttribute>) {
        let v0 = find_metadata_value(arg0, 0x1::string::utf8(b"version_change_note"));
        assert!(0x1::option::is_some<0x1::string::String>(&v0), 27);
        validate_long_text(0x1::option::borrow<0x1::string::String>(&v0));
    }
    ...
    fun emit_version_change_note_event(arg0: &ArtifactSeries, arg1: &CommonArtifactHeader, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        let v0 = ArtifactVersionChangeNoteRecordedEvent{
            ...
            created_at_ms : arg1.created_at_ms,
        };
        0x2::event::emit<ArtifactVersionChangeNoteRecordedEvent>(v0);
    }
    ...
    fun find_metadata_value(arg0: &vector<MetadataAttribute>, arg1: 0x1::string::String) : 0x1::option::Option<0x1::string::String> {
        let v0 = 0;
        while (v0 < 0x1::vector::length<MetadataAttribute>(arg0)) {
            let v1 = 0x1::vector::borrow<MetadataAttribute>(arg0, v0);
            if (v1.key == arg1) {
                return 0x1::option::some<0x1::string::String>(v1.value)
            };
            v0 = v0 + 1;
        };
    ...
    public fun header_version_change_note(arg0: &CommonArtifactHeader) : 0x1::option::Option<0x1::string::String> {
        find_metadata_value(&arg0.metadata_extensions, 0x1::string::utf8(b"version_change_note"))
    }
    ...
    public fun promote_existing_series_to_controller_only(arg0: &mut ArtifactSeries, arg1: &mut 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, arg2: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg0.id, 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg5);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::set_authority_mode(&mut arg0.id, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid_mut(arg1), arg2, arg3, 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_controller_only(), arg4, arg5);
        let v0 = ArtifactControllerPromotionEvent{
            series_id        : 0x2::object::id<ArtifactSeries>(arg0),
            comments_tree_id : 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1),
            artifact_type    : arg0.artifact_type,
            promoted_by      : 0x2::tx_context::sender(arg5),
            authority_mode   : 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_controller_only(),
            promoted_at_ms   : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<ArtifactControllerPromotionEvent>(v0);
    }

    public fun promote_existing_series_to_controller_primary(arg0: &mut ArtifactSeries, arg1: &mut 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, arg2: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1) == arg0.comments_tree_id, 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_series_id(arg1) == 0x2::object::id<ArtifactSeries>(arg0), 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_artifact_type(arg1) == arg0.artifact_type, 23);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg0.id, 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg5);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::set_authority_mode(&mut arg0.id, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid_mut(arg1), arg2, arg3, 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_controller_primary(), arg4, arg5);
        let v0 = ArtifactControllerPromotionEvent{
            series_id        : 0x2::object::id<ArtifactSeries>(arg0),
            comments_tree_id : 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1),
            artifact_type    : arg0.artifact_type,
            promoted_by      : 0x2::tx_context::sender(arg5),
            authority_mode   : 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_controller_primary(),
            promoted_at_ms   : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<ArtifactControllerPromotionEvent>(v0);
    }

    public fun promote_existing_series_to_dual_mode(arg0: &mut ArtifactSeries, arg1: &mut 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        let v0 = 0x2::object::id<ArtifactSeries>(arg0);
        let v1 = 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1);
        let v2 = arg0.artifact_type;
        assert!(v1 == arg0.comments_tree_id, 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_series_id(arg1) == v0, 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_artifact_type(arg1) == v2, 23);
        assert!(0x2::tx_context::sender(arg3) == arg0.owner, 21);
        let v3 = 0x2::tx_context::sender(arg3);
        let (v4, v5) = 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::enable_control(&mut arg0.id, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid_mut(arg1), v0, v1, arg0.artifact_code, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::name(v2), v2, arg0.owner, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::owner(arg1), 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_dual(), arg2, arg3);
        let v6 = ArtifactControllerPromotionEvent{
            series_id        : v0,
            comments_tree_id : v1,
            artifact_type    : v2,
            promoted_by      : v3,
            authority_mode   : 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_dual(),
            promoted_at_ms   : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<ArtifactControllerPromotionEvent>(v6);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::share_record_and_transfer_nft(v4, v5, v3);
    }
    ...
    fun publish_common(arg0: &PaperProofRoot, arg1: &TypeRegistry, arg2: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg3: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg4: u8, arg5: 0x2::object::ID, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: vector<MetadataAttribute>, arg11: vector<MetadataAttribute>, arg12: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : (ArtifactSeries, CommonArtifactHeader, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::LikesBook) {
        ...
        let v13 = v12.artifact_code;
        let (v14, v15) = 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::enable_control(&mut v12.id, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid_mut(&mut v8), v3, v9, v13, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::name(arg4), arg4, v1, v1, 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_controller_only(), arg13, arg14);
        let v16 = CommonArtifactHeader{
            series_id             : v3,
            artifact_type         : arg4,
            version               : 1,
        ...
        let v17 = ArtifactPublishedEvent{
            series_id        : v3,
            version_id       : arg5,
            artifact_type    : arg4,
            artifact_code    : v13,
            author           : v1,
            content_hash     : v16.content_hash,
            walrus_blob_id   : v16.walrus_blob_id,
            content_type     : v16.content_type,
            version          : 1,
            comments_tree_id : v9,
            likes_book_id    : v10,
            created_at_ms    : v0,
        };
        0x2::event::emit<ArtifactPublishedEvent>(v17);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::share_record_and_transfer_nft(v14, v15, v1);
        (v12, v16, v8, v7)
    }
    ...
    fun publish_reserved_preprint_common(arg0: PreprintReservation, arg1: &PaperProofRoot, arg2: &TypeRegistry, arg3: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::GovernanceVault, arg4: &0x75923624e354789e995537e88afaab698bd405a61f91926e3f8837fb7cc6b5cf::governance::FeeManager, arg5: 0x2::object::ID, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: vector<MetadataAttribute>, arg11: vector<MetadataAttribute>, arg12: 0x1::option::Option<0x2::coin::Coin<0x2::sui::SUI>>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : (ArtifactSeries, CommonArtifactHeader, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::LikesBook) {
        ...
        let v19 = v18.artifact_code;
        let (v20, v21) = 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::enable_control(&mut v18.id, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid_mut(&mut v14), v10, v15, v19, 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::name(0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::preprint()), 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::preprint(), v6, v6, 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::authority_mode_controller_only(), arg13, arg14);
        let v22 = CommonArtifactHeader{
            series_id             : v10,
            artifact_type         : 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::preprint(),
            version               : 1,
            previous_version_id   : 0x1::option::none<0x2::object::ID>(),
        ...
        let v23 = ArtifactPublishedEvent{
            series_id        : v10,
            version_id       : arg5,
            artifact_type    : 0xe67a6956f37c3182354189d9b77ca14058694aad82522da0c6cb91cfddee4782::artifact_types::preprint(),
            artifact_code    : v19,
            ...
            walrus_blob_id   : v22.walrus_blob_id,
            content_type     : v22.content_type,
            version          : 1,
            comments_tree_id : v15,
            likes_book_id    : v16,
            created_at_ms    : v7,
        };
        0x2::event::emit<ArtifactPublishedEvent>(v23);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::share_record_and_transfer_nft(v20, v21, v6);
        (v18, v22, v14, v13)
    }
    ...
    public fun repair_existing_series_control_mirrors(arg0: &mut ArtifactSeries, arg1: &mut 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, arg2: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg3: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1) == arg0.comments_tree_id, 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_series_id(arg1) == 0x2::object::id<ArtifactSeries>(arg0), 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_artifact_type(arg1) == arg0.artifact_type, 23);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg0.id, 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg5);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_tree(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid(arg1), 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1), 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg5);
        arg0.owner = 0x2::tx_context::sender(arg5);
        0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::transfer_tree_owner_with_controller(arg1, arg2, arg3, 0x2::tx_context::sender(arg5), arg4, arg5);
        arg0.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::repair_legacy_owner_mirrors(arg2, arg3, arg0.owner, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::owner(arg1), arg4, arg5);
    }
    ...
    public fun series_authority_mode(arg0: &ArtifactSeries) : u8 {
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::series_authority_mode(&arg0.id)
    }
    ...
    public fun series_control_enabled(arg0: &ArtifactSeries) : bool {
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::is_series_control_enabled(&arg0.id)
    }

    public fun series_control_record_id(arg0: &ArtifactSeries) : 0x1::option::Option<0x2::object::ID> {
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::series_control_record_id(&arg0.id)
    }

    public fun series_controller_nft_id(arg0: &ArtifactSeries) : 0x1::option::Option<0x2::object::ID> {
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::series_controller_nft_id(&arg0.id)
    }
    ...
    public fun series_description(arg0: &ArtifactSeries) : 0x1::option::Option<0x1::string::String> {
        find_metadata_value(&arg0.metadata_extensions, 0x1::string::utf8(b"series_description"))
    }

    public fun series_in_controller_only_mode(arg0: &ArtifactSeries) : bool {
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::is_series_in_controller_only_mode(&arg0.id)
    }

    public fun series_in_controller_primary_mode(arg0: &ArtifactSeries) : bool {
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::is_series_in_controller_primary_mode(&arg0.id)
    }

    public fun series_in_dual_mode(arg0: &ArtifactSeries) : bool {
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::is_series_in_dual_mode(&arg0.id)
    }
    ...
    public fun sync_existing_series_control_mirrors(arg0: &mut ArtifactSeries, arg1: &mut 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, arg2: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg3: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg0.id, 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg5);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_tree(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid(arg1), 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1), 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg5);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::sync_legacy_owner_mirrors(arg2, arg3, arg0.owner, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::owner(arg1), arg4, arg5);
    }
    ...
    public fun transfer_artifact_owner(arg0: &mut ArtifactSeries, arg1: &mut 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_series_legacy_write_allowed(&arg0.id);
    ...
    public fun transfer_artifact_owner_with_controller(arg0: &mut ArtifactSeries, arg1: &mut 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::CommentsTree, arg2: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg3: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1) == arg0.comments_tree_id, 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_series_id(arg1) == 0x2::object::id<ArtifactSeries>(arg0), 23);
        assert!(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::target_artifact_type(arg1) == arg0.artifact_type, 23);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg0.id, 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg6);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_tree(0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_uid(arg1), 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::tree_id(arg1), 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg2, arg3, arg6);
        assert!(arg4 == 0x2::tx_context::sender(arg6), 31);
        0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::transfer_tree_owner_with_controller(arg1, arg2, arg3, arg4, arg5, arg6);
        arg0.owner = arg4;
        arg0.updated_at_ms = 0x2::clock::timestamp_ms(arg5);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::sync_legacy_owner_mirrors(arg2, arg3, arg0.owner, 0xaef346fc40bf20af62f4bbbc1608ba2272e80e4ba3d716634026baa589e9aeba::comments::owner(arg1), arg5, arg6);
    }
    ...
    public fun update_series_description(arg0: &mut ArtifactSeries, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_series_legacy_write_allowed(&arg0.id);
        assert!(0x2::tx_context::sender(arg3) == arg0.owner, 21);
        assert!(arg0.status == 0, 22);
        validate_long_text(&arg1);
        arg0.metadata_extensions = upsert_metadata_attribute(&arg0.metadata_extensions, metadata_attribute(0x1::string::utf8(b"series_description"), arg1));
        arg0.updated_at_ms = 0x2::clock::timestamp_ms(arg2);
        let v0 = ArtifactSeriesDescriptionUpdatedEvent{
            series_id     : 0x2::object::id<ArtifactSeries>(arg0),
            artifact_type : arg0.artifact_type,
            updated_by    : 0x2::tx_context::sender(arg3),
            updated_at_ms : arg0.updated_at_ms,
        };
        0x2::event::emit<ArtifactSeriesDescriptionUpdatedEvent>(v0);
    }

    public fun update_series_description_with_controller(arg0: &mut ArtifactSeries, arg1: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg2: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg0.id, 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg1, arg2, arg5);
        assert!(arg0.status == 0, 22);
        validate_long_text(&arg3);
        arg0.metadata_extensions = upsert_metadata_attribute(&arg0.metadata_extensions, metadata_attribute(0x1::string::utf8(b"series_description"), arg3));
        arg0.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::sync_legacy_series_owner_mirror(arg1, arg2, arg0.owner, arg4, arg5);
        let v0 = ArtifactSeriesDescriptionUpdatedEvent{
            series_id     : 0x2::object::id<ArtifactSeries>(arg0),
            artifact_type : arg0.artifact_type,
    ...
    public fun update_series_metadata_extensions_with_controller(arg0: &mut ArtifactSeries, arg1: &mut 0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ArtifactControlRecord, arg2: &0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::ControllerNFT, arg3: vector<MetadataAttribute>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_current_series(arg0);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::assert_controller_for_series(&arg0.id, 0x2::object::id<ArtifactSeries>(arg0), arg0.artifact_type, arg1, arg2, arg5);
        assert!(arg0.status == 0, 22);
        validate_metadata_extensions(&arg3);
        assert_series_description_key_integrity(&arg3);
        arg0.metadata_extensions = arg3;
        arg0.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        0xe68fef47337eb2ee970431fae9519c4b2bb9f4505a3d14b6b91fdfc6aae3b75c::controller::sync_legacy_series_owner_mirror(arg1, arg2, arg0.owner, arg4, arg5);
        let v0 = ArtifactSeriesMetadataUpdatedEvent{
            series_id      : 0x2::object::id<ArtifactSeries>(arg0),
    ...
    fun upsert_metadata_attribute(arg0: &vector<MetadataAttribute>, arg1: MetadataAttribute) : vector<MetadataAttribute> {
        let v0 = 0x1::vector::empty<MetadataAttribute>();
        let v1 = false;
        let v2 = 0;
        while (v2 < 0x1::vector::length<MetadataAttribute>(arg0)) {
            let v3 = *0x1::vector::borrow<MetadataAttribute>(arg0, v2);
            if (v3.key == arg1.key) {
                0x1::vector::push_back<MetadataAttribute>(&mut v0, arg1);
                v1 = true;
            } else {
                0x1::vector::push_back<MetadataAttribute>(&mut v0, v3);
            };
            v2 = v2 + 1;
        };
        if (!v1) {
        ...
        validate_metadata_extensions(&v0);
        v0
    }
