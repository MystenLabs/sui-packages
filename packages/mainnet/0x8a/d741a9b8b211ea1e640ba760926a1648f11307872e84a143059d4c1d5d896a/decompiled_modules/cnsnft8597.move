module 0x8ad741a9b8b211ea1e640ba760926a1648f11307872e84a143059d4c1d5d896a::cnsnft8597 {
    struct CNSNFT8597 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8597, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8597>(arg0, arg1);
