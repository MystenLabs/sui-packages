module 0x8a071c88e380b4a430a0b04e70dd2e34e891723082c9f8044e25861c7123aae1::reward1740 {
    struct REWARD1740 has drop {
        dummy_field: bool,
    }

    struct TICKET_1740 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1740(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1740>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1740>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1740, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1740>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1740>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1740>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1740>>(v5, 0x2::tx_context::sender(arg1));
    }
