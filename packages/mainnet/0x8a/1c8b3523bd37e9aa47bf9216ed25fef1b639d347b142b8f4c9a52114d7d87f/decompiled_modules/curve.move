module 0x8a1c8b3523bd37e9aa47bf9216ed25fef1b639d347b142b8f4c9a52114d7d87f::curve {
    ...
    fun maybe_mark_ready_to_graduate<T0>(arg0: &mut Curve<T0>) {
        ...
        if (v1) {
            arg0.lifecycle = 1;
            let v2 = GraduationReady{
                curve_id         : 0x2::object::uid_to_inner(&arg0.id),
                real_sui_reserve : v0,
                threshold        : arg0.graduation_threshold_mist,
            };
            0x2::event::emit<GraduationReady>(v2);
        };
    }
    ...
    public entry fun prepare_graduation<T0>(arg0: &0x8a1c8b3523bd37e9aa47bf9216ed25fef1b639d347b142b8f4c9a52114d7d87f::launchpad::LaunchpadConfig, arg1: &0x8a1c8b3523bd37e9aa47bf9216ed25fef1b639d347b142b8f4c9a52114d7d87f::admin::AdminCap, arg2: &mut Curve<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0x8a1c8b3523bd37e9aa47bf9216ed25fef1b639d347b142b8f4c9a52114d7d87f::launchpad::assert_admin_cap(arg0, arg1);
        assert!(arg2.lifecycle == 1, 541);
        let v0 = 0x8a1c8b3523bd37e9aa47bf9216ed25fef1b639d347b142b8f4c9a52114d7d87f::launchpad::treasury(arg0);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&arg2.real_sui_reserve);
        let v2 = 0x2::balance::value<T0>(&arg2.token_reserve);
        arg2.lifecycle = 2;
        let v3 = &mut arg2.real_sui_reserve;
        transfer_claim(v3, v1, v0, arg3);
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.token_reserve, v2), arg3), v0);
        };
        let v4 = GraduationPrepared{
            curve_id         : 0x2::object::uid_to_inner(&arg2.id),
            admin            : v0,
            real_sui_reserve : v1,
            token_reserve    : v2,
        };
        0x2::event::emit<GraduationPrepared>(v4);
    }
