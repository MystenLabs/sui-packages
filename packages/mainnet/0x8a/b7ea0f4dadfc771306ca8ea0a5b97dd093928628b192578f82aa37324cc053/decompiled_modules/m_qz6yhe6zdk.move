module 0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_qz6yhe6zdk {
    struct T_v7hq6z4lf3 has copy, drop {
        tick_lower: u32,
        tick_upper: u32,
        deposited_a: u64,
        deposited_b: u64,
    ...
    struct T_57ffa4hkjq has copy, drop {
        reward_amount: u64,
        returned_a: u64,
        returned_b: u64,
    }

    struct T_jqlu4tx7wv has copy, drop {
        deposited_a: u64,
        deposited_b: u64,
        residual_a: u64,
        residual_b: u64,
    ...
    struct T_ny6bjttf3d has copy, drop {
        reward_amount: u64,
    }

    struct T_6t2mw65s7l has copy, drop {
        reward_amount: u64,
        fee_a: u64,
        fee_b: u64,
        sui_amount: u64,
    ...
    struct T_4savanm5w6 has copy, drop {
        reward_a: u64,
        reward_b: u64,
        fee_a: u64,
        fee_b: u64,
    ...
    struct T_q4mrsouxyj has copy, drop {
        reward_amount: u64,
        closed_a: u64,
        closed_b: u64,
        swap_input_a: u64,
    ...
    struct T_owirzxu5wc has copy, drop {
        initial_a: u64,
        initial_b: u64,
        final_a: u64,
        final_b: u64,
    ...
    struct T_3nyqxhi56t has copy, drop {
        tick_lower: u32,
        tick_upper: u32,
        reward_amount: u64,
        closed_a: u64,
    ...
    struct T_tumqp4q4df has copy, drop {
        reward_a: u64,
        reward_b: u64,
        fee_a: u64,
        fee_b: u64,
    ...
    struct T_4umhqzezec has copy, drop {
        input_sui: u64,
        swapped_sui: u64,
        deep_out: u64,
        deposited_deep: u64,
    ...
    struct T_oygv7w4aiv has copy, drop {
        input_deep: u64,
        input_blue: u64,
        input_usdc: u64,
        blue_as_deep: u64,
    ...
    struct T_vmhr7mdq6g has copy, drop {
        tick_lower: u32,
        tick_upper: u32,
        reward_deep: u64,
        fee_deep: u64,
    ...
    struct T_mmcplqtlph has copy, drop {
        reward_blue: u64,
        reward_stsui: u64,
        reward_sui: u64,
        fee_sui: u64,
    ...
    struct T_vhpggnwun3 has copy, drop {
        tick_lower: u32,
        tick_upper: u32,
        reward_amount: u64,
    ...
    public entry fun f_4medflw6a7<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: 0x2::coin::Coin<T0>, arg6: u32, arg7: u32, arg8: u64, arg9: bool, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext, arg13: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        f_6qitb2op2q<T0, T1>(arg2, arg6, arg7);
        ...
        let (v17, v18) = f_mupkyrxovj<T0, T1>(arg0, arg1, arg2, v2);
        let v19 = v18;
        let v20 = v17;
        ...
        0x2::event::emit<T_owirzxu5wc>(v23);
        if (v21 >= v0) {
            let v24 = 0x2::tx_context::sender(arg12);
            f_64ehfxlbuq<T0>(0x2::balance::split<T0>(&mut v20, v0), v24, arg12);
            f_mzcn3wjtr6<T0>(v20);
        } else {
            let v25 = 0x2::tx_context::sender(arg12);
            f_64ehfxlbuq<T0>(v20, v25, arg12);
        };
        if (v22 >= v1) {
            let v26 = 0x2::tx_context::sender(arg12);
            f_64ehfxlbuq<T1>(0x2::balance::split<T1>(&mut v19, v1), v26, arg12);
            f_mzcn3wjtr6<T1>(v19);
        } else {
            let v27 = 0x2::tx_context::sender(arg12);
            f_64ehfxlbuq<T1>(v19, v27, arg12);
        };
    }

    public entry fun f_4s6eobaier<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext, arg12: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        assert!(v1 >= arg6, 2);
        let (v2, v3) = f_mupkyrxovj<T0, T1>(arg0, arg1, arg2, arg3);
        let v4 = v3;
        let v5 = v2;
        ...
        0x2::event::emit<T_q4mrsouxyj>(v23);
        ...
        f_64ehfxlbuq<T0>(v20, v24, arg11);
        let v25 = 0x2::tx_context::sender(arg11);
        f_64ehfxlbuq<T1>(v19, v25, arg11);
    }

    fun f_64ehfxlbuq<T0>(arg0: 0x2::balance::Balance<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun f_6qitb2op2q<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u32, arg2: u32) {
    ...
    public entry fun f_7jge3ckpti<T0, T1, T2, T3>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T3>, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T2>, arg8: 0x2::coin::Coin<T3>, arg9: bool, arg10: u64, arg11: u64, arg12: bool, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: &mut 0x2::tx_context::TxContext, arg18: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x2::coin::value<T2>(&arg7);
        let v1 = 0x2::coin::value<T3>(&arg8);
        let v2 = 0x2::coin::into_balance<T0>(arg6);
        let v3 = if (v0 > 0) {
            f_ocrfpnm5cx<T0, T2>(arg0, arg1, arg4, 0x2::coin::into_balance<T2>(arg7))
        } else {
        ...
        let v5 = if (v1 > 0) {
            f_ocrfpnm5cx<T1, T3>(arg0, arg1, arg5, 0x2::coin::into_balance<T3>(arg8))
        } else {
        ...
        if (arg10 > 0) {
            if (arg9) {
                let v8 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T0>(&mut v2, arg10));
                v7 = 0x2::balance::value<T1>(&v8);
                0x2::balance::join<T1>(&mut v6, v8);
            } else {
                let v9 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v6, arg10));
                v7 = 0x2::balance::value<T0>(&v9);
                0x2::balance::join<T0>(&mut v2, v9);
            };
        };
        let (v10, v11) = f_az3ttjih3g<T0, T1>(arg0, arg1, arg2, arg3, v2, v6, arg11, arg12);
        let v12 = v11;
        let v13 = v10;
        ...
        0x2::event::emit<T_oygv7w4aiv>(v18);
        let v19 = 0x2::tx_context::sender(arg17);
        f_64ehfxlbuq<T0>(v13, v19, arg17);
        let v20 = 0x2::tx_context::sender(arg17);
        f_64ehfxlbuq<T1>(v12, v20, arg17);
    }

    public entry fun f_ay6r2uv3al<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        let v1 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, v0);
        ...
        0x2::event::emit<T_4savanm5w6>(v3);
        0x2::balance::send_funds<T1>(v1, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
    }

    public fun f_az3ttjih3g<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: 0x2::balance::Balance<T0>, arg5: 0x2::balance::Balance<T1>, arg6: u64, arg7: bool) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        0x2::event::emit<T_jqlu4tx7wv>(v6);
        (v5, v4)
    }

    public entry fun f_boqmqci7fv<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x2::coin::Coin<T2>, arg5: u64, arg6: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        assert!(v1 >= arg5, 2);
        let v2 = T_ny6bjttf3d{reward_amount: v1};
        0x2::event::emit<T_ny6bjttf3d>(v2);
        0x2::balance::send_funds<T2>(v0, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
    }

    public entry fun f_ccjlonzxsm<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: u64, arg6: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, arg3);
        ...
        0x2::balance::join<T0>(&mut v0, f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, v1));
        let v3 = f_lnm3rqknsb<T0, T2>(arg0, arg1, arg4, v0);
        let v4 = 0x2::balance::value<T2>(&v3);
        assert!(v4 >= arg5, 4);
        let v5 = T_ny6bjttf3d{reward_amount: v2};
        0x2::event::emit<T_ny6bjttf3d>(v5);
        let v6 = T_4savanm5w6{
            reward_a   : v2,
        ...
        0x2::event::emit<T_4savanm5w6>(v6);
        0x2::balance::send_funds<T2>(v3, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
    }

    public entry fun f_co2rz6wg6v<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, arg3);
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T1>(arg0, arg1, arg2, arg3);
        0x2::balance::join<T0>(&mut v0, f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, v1));
        let v2 = 0x2::balance::value<T0>(&v0);
    ...
    public fun f_coxphcpxyu<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: u32, arg6: u64, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(arg5 > 0, 0);
        ...
        0x2::event::emit<T_v7hq6z4lf3>(v13);
    ...
    fun f_cu7d3sdftp<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public entry fun f_cvicbdgcf4<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u32, arg6: u32, arg7: u64, arg8: bool, arg9: &mut 0x2::tx_context::TxContext, arg10: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        f_6qitb2op2q<T0, T1>(arg2, arg5, arg6);
        ...
        0x2::event::emit<T_v7hq6z4lf3>(v7);
        let v8 = 0x2::tx_context::sender(arg9);
        f_64ehfxlbuq<T0>(v6, v8, arg9);
        let v9 = 0x2::tx_context::sender(arg9);
        f_64ehfxlbuq<T1>(v5, v9, arg9);
    ...
    public entry fun f_dfdlnjppg3<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: address, arg6: &mut 0x2::tx_context::TxContext, arg7: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
    ...
    public entry fun f_eah2ewnybq<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u32, arg5: bool, arg6: u64, arg7: u64, arg8: bool, arg9: bool, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: address, arg16: &mut 0x2::tx_context::TxContext, arg17: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        0x2::event::emit<T_vhpggnwun3>(v33);
        ...
        f_64ehfxlbuq<T0>(v30, v34, arg16);
        let v35 = 0x2::tx_context::sender(arg16);
        f_64ehfxlbuq<T1>(v29, v35, arg16);
        f_64ehfxlbuq<T0>(v6, arg15, arg16);
    }

    public entry fun f_euk7ncpa4v<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u32, arg6: u32, arg7: u64, arg8: bool, arg9: u64, arg10: address, arg11: &mut 0x2::tx_context::TxContext, arg12: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        assert!(v6 >= arg9, 2);
        let (v7, v8) = f_mupkyrxovj<T0, T1>(arg0, arg1, arg2, v0);
        let v9 = v8;
        let v10 = v7;
        0x2::balance::join<T0>(&mut v10, v3);
        0x2::balance::join<T1>(&mut v9, v4);
        let v11 = T_57ffa4hkjq{
            reward_amount : v6,
            returned_a    : 0x2::balance::value<T0>(&v10),
            returned_b    : 0x2::balance::value<T1>(&v9),
        };
        0x2::event::emit<T_57ffa4hkjq>(v11);
        let v12 = 0x2::tx_context::sender(arg11);
        f_64ehfxlbuq<T0>(v10, v12, arg11);
        let v13 = 0x2::tx_context::sender(arg11);
        f_64ehfxlbuq<T1>(v9, v13, arg11);
        f_64ehfxlbuq<T2>(v5, arg10, arg11);
    }

    public entry fun f_eyad6fddws<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: u64, arg6: u64, arg7: address, arg8: &mut 0x2::tx_context::TxContext, arg9: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        0x2::event::emit<T_57ffa4hkjq>(v8);
        let v9 = 0x2::tx_context::sender(arg8);
        f_64ehfxlbuq<T0>(v5, v9, arg8);
        let v10 = 0x2::tx_context::sender(arg8);
        f_64ehfxlbuq<T1>(v4, v10, arg8);
        f_64ehfxlbuq<T2>(v0, arg7, arg8);
    }

    public entry fun f_fpjgdkd2id<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: u32, arg6: u64, arg7: u64, arg8: bool, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: &mut 0x2::tx_context::TxContext, arg15: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        assert!(arg5 > 0, 0);
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, &mut arg3);
        ...
        let (v2, v3, v4, v5) = f_cu7d3sdftp<T0, T1>(arg0, arg1, arg2, arg3);
        let v6 = v5;
        let v7 = v4;
        let v8 = v3;
        let v9 = v2;
        0x2::balance::join<T1>(&mut v1, v6);
        let v10 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, v1);
        0x2::balance::join<T0>(&mut v0, v7);
        0x2::balance::join<T0>(&mut v0, v10);
        let v11 = f_lnm3rqknsb<T0, T2>(arg0, arg1, arg4, v0);
        ...
        let v13 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, v8);
        0x2::balance::join<T0>(&mut v9, v13);
        assert!(0x2::balance::value<T0>(&v9) >= arg6, 3);
        let v14 = f_lnm3rqknsb<T0, T2>(arg0, arg1, arg4, 0x2::balance::split<T0>(&mut v9, arg6));
        ...
        0x2::event::emit<T_tumqp4q4df>(v30);
        ...
        f_64ehfxlbuq<T0>(v27, v31, arg14);
        let v32 = 0x2::tx_context::sender(arg14);
        f_64ehfxlbuq<T2>(v26, v32, arg14);
    }

    public fun f_gkkr5xm72e<T0>(arg0: 0x2::balance::Balance<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        f_64ehfxlbuq<T0>(arg0, arg1, arg2);
    }

    public entry fun f_h3osuccnjf<T0, T1, T2, T3>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T3>, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T2>, arg8: 0x2::coin::Coin<T3>, arg9: 0x2::coin::Coin<T1>, arg10: u32, arg11: bool, arg12: u64, arg13: u64, arg14: bool, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: &mut 0x2::tx_context::TxContext, arg21: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        assert!(arg10 > 0, 0);
        let v0 = 0x2::coin::value<T2>(&arg7);
        let v1 = 0x2::coin::value<T3>(&arg8);
        ...
        let (v4, v5, v6, v7) = f_cu7d3sdftp<T0, T1>(arg0, arg1, arg2, arg3);
        let v8 = v7;
        let v9 = v6;
        let v10 = v5;
        let v11 = v4;
        ...
        let v14 = if (0x2::balance::value<T0>(&v2) > 0) {
            f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, v2)
        } else {
        ...
        0x2::event::emit<T_4savanm5w6>(v16);
        if (v15 > 0) {
        ...
        if (arg12 > 0) {
            if (arg11) {
                let v22 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T0>(&mut v11, arg12));
                v21 = 0x2::balance::value<T1>(&v22);
                0x2::balance::join<T1>(&mut v10, v22);
            } else {
                let v23 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v10, arg12));
        ...
        0x2::event::emit<T_vmhr7mdq6g>(v41);
    ...
    public entry fun f_jk43yaj56z<T0, T1, T2, T3>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T3>, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T2>, arg7: 0x2::coin::Coin<T3>, arg8: u32, arg9: bool, arg10: u64, arg11: u64, arg12: bool, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: &mut 0x2::tx_context::TxContext, arg18: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        0x2::event::emit<T_vhpggnwun3>(v20);
        ...
        f_64ehfxlbuq<T0>(v17, v21, arg17);
        let v22 = 0x2::tx_context::sender(arg17);
        f_64ehfxlbuq<T1>(v16, v22, arg17);
    }

    fun f_lnm3rqknsb<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<T1> {
    ...
    public entry fun f_m2z4ka2wie<T0, T1, T2, T3>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T3>, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T2>, arg8: 0x2::coin::Coin<T3>, arg9: bool, arg10: u64, arg11: u64, arg12: bool, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: &mut 0x2::tx_context::TxContext, arg19: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, arg3);
        ...
        let v11 = if (0x2::balance::value<T0>(&v0) > 0) {
            f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, v0)
        } else {
        ...
        0x2::event::emit<T_4savanm5w6>(v13);
        if (v12 > 0) {
        ...
        f_7jge3ckpti<T0, T1, T2, T3>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg14, arg15, arg16, arg17, arg18, arg19);
    }

    public entry fun f_mf2sqzar6k<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: u64, arg6: u64, arg7: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, arg3);
        let v1 = 0x2::balance::value<T0>(&v0);
        assert!(v1 >= arg5, 2);
        let v2 = f_lnm3rqknsb<T0, T2>(arg0, arg1, arg4, v0);
        let v3 = 0x2::balance::value<T2>(&v2);
        assert!(v3 >= arg6, 4);
        let v4 = T_ny6bjttf3d{reward_amount: v1};
        0x2::event::emit<T_ny6bjttf3d>(v4);
        let v5 = T_6t2mw65s7l{
            reward_amount : v1,
            fee_a         : 0,
            fee_b         : 0,
        ...
        0x2::event::emit<T_6t2mw65s7l>(v5);
        0x2::balance::send_funds<T2>(v2, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
    }

    public entry fun f_mhe2hwhwf3<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: u32, arg7: u32, arg8: u64, arg9: bool, arg10: u64, arg11: address, arg12: &mut 0x2::tx_context::TxContext, arg13: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        0x2::event::emit<T_3nyqxhi56t>(v15);
        let v16 = 0x2::tx_context::sender(arg12);
        f_64ehfxlbuq<T0>(v14, v16, arg12);
        let v17 = 0x2::tx_context::sender(arg12);
        f_64ehfxlbuq<T1>(v13, v17, arg12);
        f_64ehfxlbuq<T2>(v0, arg11, arg12);
    ...
    fun f_mupkyrxovj<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let (v0, v1, v2, v3) = f_cu7d3sdftp<T0, T1>(arg0, arg1, arg2, arg3);
    ...
    public fun f_mzcn3wjtr6<T0>(arg0: 0x2::balance::Balance<T0>) {
        if (0x2::balance::value<T0>(&arg0) > 0) {
    ...
    fun f_ocrfpnm5cx<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T1>) : 0x2::balance::Balance<T0> {
    ...
    public entry fun f_pdtjibhfcw<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: u32, arg6: bool, arg7: u64, arg8: u64, arg9: bool, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &mut 0x2::tx_context::TxContext, arg17: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        assert!(arg5 > 0, 0);
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, &mut arg3);
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T1>(arg0, arg1, arg2, &mut arg3);
        let v2 = 0x2::balance::value<T0>(&v0);
        assert!(v2 >= arg10, 2);
        let (v3, v4, v5, v6) = f_cu7d3sdftp<T0, T1>(arg0, arg1, arg2, arg3);
        let v7 = v6;
        let v8 = v5;
        let v9 = v4;
        let v10 = v3;
        ...
        let v13 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, v1);
        0x2::balance::join<T0>(&mut v0, v13);
        let v14 = f_lnm3rqknsb<T0, T2>(arg0, arg1, arg4, v0);
        let v15 = 0x2::balance::value<T2>(&v14);
        assert!(v15 >= arg11, 4);
        let v16 = T_6t2mw65s7l{
            reward_amount : v2,
            fee_a         : v11,
            fee_b         : v12,
            sui_amount    : v15,
        };
        0x2::event::emit<T_6t2mw65s7l>(v16);
        let v17 = T_4savanm5w6{
            reward_a   : v2,
            reward_b   : 0x2::balance::value<T1>(&v1),
            fee_a      : v11,
            fee_b      : v12,
        ...
        0x2::event::emit<T_4savanm5w6>(v17);
        ...
        if (arg7 > 0) {
            if (arg6) {
                ...
                let v19 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T0>(&mut v10, arg7));
                v18 = 0x2::balance::value<T1>(&v19);
                0x2::balance::join<T1>(&mut v9, v19);
            } else {
                assert!(0x2::balance::value<T1>(&v9) >= arg7, 4);
                let v20 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v9, arg7));
        ...
        0x2::event::emit<T_vhpggnwun3>(v36);
        ...
        f_64ehfxlbuq<T0>(v33, v37, arg16);
        let v38 = 0x2::tx_context::sender(arg16);
        f_64ehfxlbuq<T1>(v32, v38, arg16);
    }

    public fun f_ps44ausbei<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: u64, arg6: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T2>(arg0, arg1, arg2, &mut arg3);
        let v1 = 0x2::balance::value<T2>(&v0);
        assert!(v1 >= arg4, 2);
        let (v2, v3) = f_mupkyrxovj<T0, T1>(arg0, arg1, arg2, arg3);
    ...
    public entry fun f_r66d564bcy<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: u64, arg6: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, arg3);
        ...
        0x2::balance::join<T0>(&mut v0, f_ocrfpnm5cx<T0, T2>(arg0, arg1, arg4, v1));
        let v2 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, v0);
        ...
        0x2::event::emit<T_4savanm5w6>(v4);
        0x2::balance::send_funds<T1>(v2, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
    }

    public entry fun f_r7zuitz65b<T0, T1, T2, T3, T4>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T4, T0>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T4, T2>, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T0>, arg8: u64, arg9: u64, arg10: bool, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &mut 0x2::tx_context::TxContext, arg17: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T2>(arg0, arg1, arg2, &mut arg3);
        ...
        let v12 = f_lnm3rqknsb<T4, T0>(arg0, arg1, arg4, f_ocrfpnm5cx<T4, T2>(arg0, arg1, arg6, v0));
        let v13 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, v7);
        0x2::balance::join<T0>(&mut v2, v8);
        0x2::balance::join<T0>(&mut v2, v12);
        0x2::balance::join<T0>(&mut v2, f_lnm3rqknsb<T3, T0>(arg0, arg1, arg7, v1));
        0x2::balance::join<T0>(&mut v2, v13);
        let v14 = 0x2::balance::value<T0>(&v2);
        assert!(v14 >= arg11, 4);
        0x2::balance::send_funds<T0>(v2, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
        let v15 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, v9);
        let v16 = 0x2::balance::value<T0>(&v15);
        0x2::balance::join<T0>(&mut v10, v15);
        if (arg8 == 18446744073709551615) {
            let v17 = T_mmcplqtlph{
            ...
            0x2::event::emit<T_mmcplqtlph>(v17);
            let v18 = 0x2::tx_context::sender(arg16);
            f_64ehfxlbuq<T0>(v10, v18, arg16);
            return
        };
        assert!(0x2::balance::value<T0>(&v10) >= arg8, 4);
        let v19 = f_ocrfpnm5cx<T4, T0>(arg0, arg1, arg4, 0x2::balance::split<T0>(&mut v10, arg8));
        let v20 = 0x2::balance::value<T4>(&v19);
        let (v21, v22) = f_az3ttjih3g<T4, T0>(arg0, arg1, arg4, arg5, v19, v10, arg9, arg10);
        let v23 = v22;
        let v24 = v21;
        ...
        0x2::event::emit<T_mmcplqtlph>(v29);
        let v30 = 0x2::tx_context::sender(arg16);
        f_64ehfxlbuq<T4>(v24, v30, arg16);
        let v31 = 0x2::tx_context::sender(arg16);
        f_64ehfxlbuq<T0>(v23, v31, arg16);
    }

    public fun f_relubzcrli<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg2);
        ...
        0x2::event::emit<T_v7hq6z4lf3>(v10);
    ...
    public entry fun f_rf7gg5jytj<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u64, arg5: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, arg3);
        let (v1, v2) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::get_accrued_fee(arg3);
        let (v3, v4) = if (v1 > 0 || v2 > 0) {
            let (_, _, v7, v8) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg0, arg1, arg2, arg3);
        ...
        let v10 = v3;
        0x2::balance::join<T0>(&mut v0, v10);
        0x2::balance::join<T1>(&mut v9, f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, v0));
        let v11 = 0x2::balance::value<T1>(&v9);
        assert!(v11 >= arg4, 4);
        let v12 = T_4savanm5w6{
            reward_a   : 0x2::balance::value<T0>(&v0),
            reward_b   : 0,
            fee_a      : 0x2::balance::value<T0>(&v10),
            fee_b      : 0x2::balance::value<T1>(&v9),
        ...
        0x2::event::emit<T_4savanm5w6>(v12);
        0x2::balance::send_funds<T1>(v9, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
    }

    public entry fun f_rhvb3srupz<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: u32, arg6: bool, arg7: u64, arg8: u64, arg9: bool, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: &mut 0x2::tx_context::TxContext, arg16: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        assert!(arg5 > 0, 0);
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, &mut arg3);
        ...
        0x2::balance::join<T0>(&mut v0, v8);
        0x2::balance::join<T0>(&mut v0, f_ocrfpnm5cx<T0, T2>(arg0, arg1, arg4, v1));
        let v11 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, v0);
        ...
        if (arg7 > 0) {
            if (arg6) {
                assert!(0x2::balance::value<T0>(&v10) >= arg7, 3);
                let v15 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T0>(&mut v10, arg7));
                v14 = 0x2::balance::value<T1>(&v15);
                0x2::balance::join<T1>(&mut v9, v15);
            } else {
                assert!(0x2::balance::value<T1>(&v9) >= arg7, 4);
                let v16 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v9, arg7));
        ...
        0x2::event::emit<T_vhpggnwun3>(v32);
        ...
        f_64ehfxlbuq<T0>(v29, v33, arg15);
        let v34 = 0x2::tx_context::sender(arg15);
        f_64ehfxlbuq<T1>(v28, v34, arg15);
    }

    public entry fun f_sfywy35ubd<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u32, arg6: u32, arg7: u64, arg8: bool, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext, arg12: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        f_6qitb2op2q<T0, T1>(arg2, arg5, arg6);
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg1, arg2, arg5, arg6, arg11);
        let (_, _, v3, v4) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg0, arg1, arg2, &mut v0, 0x2::coin::into_balance<T0>(arg3), 0x2::coin::into_balance<T1>(arg4), arg7, arg8);
        let (v5, v6) = f_mupkyrxovj<T0, T1>(arg0, arg1, arg2, v0);
        let v7 = v6;
        let v8 = v5;
        ...
        f_64ehfxlbuq<T0>(v8, v9, arg11);
        let v10 = 0x2::tx_context::sender(arg11);
        f_64ehfxlbuq<T1>(v7, v10, arg11);
    }

    public entry fun f_so4nc5faq3<T0, T1, T2, T3, T4>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg6: &mut 0x2::coin::Coin<T4>, arg7: u64, arg8: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        ...
        let v3 = T_ny6bjttf3d{reward_amount: v2};
        0x2::event::emit<T_ny6bjttf3d>(v3);
        0x2::balance::send_funds<T4>(v0, @0xa40759d45016da48ec08b52907582e69d9c0de9c1ce719331a409e6e15533292);
    }

    public entry fun f_u64lwtg2cy<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u32, arg5: bool, arg6: u64, arg7: u64, arg8: bool, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: &mut 0x2::tx_context::TxContext, arg15: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        assert!(arg4 > 0, 0);
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, &mut arg3);
        let v1 = 0x2::balance::value<T0>(&v0);
        let (v2, v3, v4, v5) = f_cu7d3sdftp<T0, T1>(arg0, arg1, arg2, arg3);
        ...
        if (arg6 > 0) {
            if (arg5) {
                assert!(0x2::balance::value<T0>(&v9) >= arg6, 3);
                let v15 = f_lnm3rqknsb<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T0>(&mut v9, arg6));
                v14 = 0x2::balance::value<T1>(&v15);
                0x2::balance::join<T1>(&mut v8, v15);
            } else {
                assert!(0x2::balance::value<T1>(&v8) >= arg6, 4);
                let v16 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v8, arg6));
                v14 = 0x2::balance::value<T0>(&v16);
        ...
        f_64ehfxlbuq<T0>(v29, v33, arg14);
        let v34 = 0x2::tx_context::sender(arg14);
        f_64ehfxlbuq<T1>(v28, v34, arg14);
    }

    public entry fun f_wwmwq73xtl<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: bool, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext, arg13: &0x8ab7ea0f4dadfc771306ca8ea0a5b97dd093928628b192578f82aa37324cc053::m_2uosyn2i4w::T_xecq4ixpmo) {
        let v0 = 0x2::coin::into_balance<T1>(arg4);
        let v1 = 0x2::balance::value<T1>(&v0);
        assert!(v1 >= arg5, 4);
        let v2 = f_ocrfpnm5cx<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v0, arg5));
        let v3 = 0x2::balance::value<T0>(&v2);
        let (v4, v5) = f_az3ttjih3g<T0, T1>(arg0, arg1, arg2, arg3, v2, v0, arg6, arg7);
        let v6 = v5;
        let v7 = v4;
        ...
        0x2::event::emit<T_4umhqzezec>(v12);
        let v13 = 0x2::tx_context::sender(arg12);
        f_64ehfxlbuq<T0>(v7, v13, arg12);
        let v14 = 0x2::tx_context::sender(arg12);
        f_64ehfxlbuq<T1>(v6, v14, arg12);
    }

    public fun f_wztebpxm5e<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: u32, arg6: u32, arg7: u64, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        f_6qitb2op2q<T0, T1>(arg2, arg5, arg6);
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg1, arg2, arg5, arg6, arg9);
