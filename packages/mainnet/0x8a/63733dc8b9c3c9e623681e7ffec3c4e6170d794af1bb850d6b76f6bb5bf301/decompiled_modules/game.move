module 0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>,
        init_reward: u64,
    ...
    entry fun add_treasury_cap(arg0: &mut GameInfo, arg1: 0x2::coin::TreasuryCap<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 4);
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury"), arg1);
    }
    ...
    entry fun claim(arg0: &mut GameInfo, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 >= v1.board_peroid, 3);
        v1.last_claim = v2;
        let v4 = v3;
        if (v1.board_peroid < v3) {
            v4 = v1.board_peroid;
        };
        calc_claim(arg0, v0, v1.sea_reward / 3600000 * v4 * (1 + (v1.fisherman_speed + v1.fisherman_item) / 100), arg2);
    }
    ...
    entry fun create_user(arg0: &mut GameInfo, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = PlayerInfo{
            ...
            board_peroid    : arg8,
            referral        : arg2,
            last_claim      : 0x2::clock::timestamp_ms(arg9),
        };
        ...
        if (v3 > 0) {
            send_tokens(arg0, arg1, v3, arg10);
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version      : 1,
            balance      : 0x2::balance::zero<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>(),
    ...
    entry fun remove_treasury_cap(arg0: &mut GameInfo, arg1: &0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg1));
    }

    entry fun restore_user(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>>(0x2::coin::from_balance<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>(0x2::balance::split<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>>(0x2::coin::from_balance<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>(0x2::balance::withdraw_all<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>>(0x2::coin::mint<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
