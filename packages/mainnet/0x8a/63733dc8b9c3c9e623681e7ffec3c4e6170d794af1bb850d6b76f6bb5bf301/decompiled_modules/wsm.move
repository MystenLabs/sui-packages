module 0x8a63733dc8b9c3c9e623681e7ffec3c4e6170d794af1bb850d6b76f6bb5bf301::wsm {
    struct WSM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WSM, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<WSM>(arg0, 9, b"WSM", b"WSM Token", b"WSM Token is a digital asset built on sui blockchain", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://walletsmart.co/coin/logo.png")), arg1);
