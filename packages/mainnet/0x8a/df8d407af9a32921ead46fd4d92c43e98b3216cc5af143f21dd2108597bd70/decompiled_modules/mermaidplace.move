module 0x8adf8d407af9a32921ead46fd4d92c43e98b3216cc5af143f21dd2108597bd70::mermaidplace {
    ...
    struct AddSponsorEvent has copy, drop {
        user_addr: address,
    ...
    public entry fun add_sponsor(arg0: &mut MermaidplaceConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddSponsorEvent{
            user_addr    : 0x2::tx_context::sender(arg2),
            sponsor_addr : arg1,
        };
        0x2::event::emit<AddSponsorEvent>(v0);
    }

    public entry fun buy<T0: store + key>(arg0: &mut MermaidplaceConfig, arg1: &mut 0x8adf8d407af9a32921ead46fd4d92c43e98b3216cc5af143f21dd2108597bd70::royalty_fee::RoyaltyBag, arg2: 0x2::object::ID, arg3: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x8adf8d407af9a32921ead46fd4d92c43e98b3216cc5af143f21dd2108597bd70::royalty_fee::charge_royalty<T0>(arg1, v3, &mut v1, arg4);
        assert!(v8 + v9 < v3, 5);
        let v10 = v3 - v8 - v9;
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x8adf8d407af9a32921ead46fd4d92c43e98b3216cc5af143f21dd2108597bd70::royalty_fee::init_royalty_bag(arg0);
    }
