module 0x8a0cc51bb1c8731cd610104aba1286b158acfad5107ca05422876be1582b8415::cnsnft2031 {
    struct CNSNFT2031 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2031>(arg0, arg1);
