module 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::bonding_curve {
    ...
    public fun start_bonding_curve_v2<T0, T1>(arg0: &mut 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::config::Configs, arg1: &mut BondingCurves, arg2: BondingCurveStartCapV2, arg3: 0x2::coin::TreasuryCap<T0>, arg4: &mut BondingCurve<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg8: &0x2::coin::CoinMetadata<T0>, arg9: &0x2::clock::Clock, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object::delete(v0);
        assert!(v3 == 0x2::object::id<0x2::coin::TreasuryCap<T0>>(&arg3), 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::incorrect_treasury_cap());
        let (v4, _, v6) = verify_internal(arg0, 0x1::ascii::into_bytes(0x2::url::inner_url(0x1::option::borrow<0x2::url::Url>(&arg4.url))), &arg10);
        assert!(v6 + 300 >= 0x2::clock::timestamp_ms(arg9) / 1000, 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::signature_expired());
        assert!(v4, 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::invalid_signature());
        0x2::table::add<0x2::object::ID, bool>(&mut arg1.list, v1, true);
        ...
        let v7 = 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::config::init_fee<T1>(arg0);
        assert!(0x2::coin::value<T1>(&arg5) == v7, 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::incorrect_fee_amount());
        0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::config::receive_fee<T1>(arg0, 0x2::coin::into_balance<T1>(arg5));
        let (v8, v9, v10, v11) = 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::config::bonding_curve_config(arg0);
        ...
        let (v13, v14) = 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::math::get_init_liquidity_from_sui(v8, v9, v10);
        assert!(v11 >= v14, 0x9ade9d6efa73a07f19a0ea166dd6850dcd5cd8f1a25e868b302755e5386a0086::errors::init_curve_config_error());
