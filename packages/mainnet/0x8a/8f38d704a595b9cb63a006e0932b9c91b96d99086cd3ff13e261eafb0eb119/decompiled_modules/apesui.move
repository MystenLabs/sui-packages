module 0x8a8f38d704a595b9cb63a006e0932b9c91b96d99086cd3ff13e261eafb0eb119::apesui {
    ...
    fun init(arg0: APESUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<APESUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ApeSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"ApeSui Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif2lmswwmav2gobleng5r3ri5lb547bdudhydht6wzi63rpdk6yyi"));
