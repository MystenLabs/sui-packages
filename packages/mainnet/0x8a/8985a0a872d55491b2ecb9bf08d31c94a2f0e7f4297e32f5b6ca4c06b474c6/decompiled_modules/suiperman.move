module 0x8a8985a0a872d55491b2ecb9bf08d31c94a2f0e7f4297e32f5b6ca4c06b474c6::suiperman {
    ...
    fun init(arg0: SUIPERMAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<SUIPERMAN>(arg0, 0, b"SUIPM", b"Suiperman", b"Introducing SUIperman, the superhero of the digital currency world, built on the revolutionary SUI blockchain!", v1, arg1);
        let v4 = v2;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<SUIPERMAN>>(v3);
        0x2::coin::mint_and_transfer<SUIPERMAN>(&mut v4, 1000000001, v0, arg1);
