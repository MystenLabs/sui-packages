module 0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::swap {
    struct OrderService has store, key {
        id: 0x2::object::UID,
        balances: 0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::BalanceBag,
    ...
    struct BalanceResult has copy, drop {
        balance: u64,
    }
    ...
    public entry fun deposit<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: 0x2::coin::Coin<T0>) {
        ...
        if (!0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::contains<T0>(&arg0.balances)) {
            0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::init_balance<T0>(&mut arg0.balances);
            0x1::vector::push_back<0x1::type_name::TypeName>(&mut arg0.coins, 0x1::type_name::get<T0>());
        };
        0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::join<T0>(&mut arg0.balances, 0x2::coin::into_balance<T0>(arg2));
    }

    public entry fun get_balance<T0>(arg0: &mut OrderService, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = BalanceResult{balance: 0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::value<T0>(&arg0.balances)};
        0x2::event::emit<BalanceResult>(v0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = OrderService{
            ...
            balances : 0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::new(arg0),
    ...
    fun withdraw<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_admin(arg0, arg1);
        assert!(0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::value<T0>(&arg0.balances) >= arg2, 4);
        0x2::coin::from_balance<T0>(0x8a5de7d8800ea341d9acfddb10047c984fe5772b21719b5f7c4130ce158d733f::balance_bag::split<T0>(&mut arg0.balances, arg2), arg3)
    }
