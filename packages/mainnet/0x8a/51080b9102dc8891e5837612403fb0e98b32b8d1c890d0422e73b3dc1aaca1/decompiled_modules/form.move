module 0x8a51080b9102dc8891e5837612403fb0e98b32b8d1c890d0422e73b3dc1aaca1::form {
    struct Form has key {
        id: 0x2::object::UID,
        owner: address,
    ...
    public fun add_admin(arg0: &mut Form, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x8a51080b9102dc8891e5837612403fb0e98b32b8d1c890d0422e73b3dc1aaca1::events::emit_admin_added(0x2::object::id<Form>(arg0), arg1);
    }
    ...
    public fun create(arg0: vector<u8>, arg1: bool, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x8a51080b9102dc8891e5837612403fb0e98b32b8d1c890d0422e73b3dc1aaca1::events::emit_form_created(0x2::object::id<Form>(&v3), v0, arg0);
    ...
    public fun remove_admin(arg0: &mut Form, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x8a51080b9102dc8891e5837612403fb0e98b32b8d1c890d0422e73b3dc1aaca1::events::emit_admin_removed(0x2::object::id<Form>(arg0), arg1);
    }
    ...
    public fun set_status(arg0: &mut Form, arg1: u8, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg1 <= 2, 7);
        arg0.status = arg1;
        0x8a51080b9102dc8891e5837612403fb0e98b32b8d1c890d0422e73b3dc1aaca1::events::emit_form_status_changed(0x2::object::id<Form>(arg0), arg1);
    }
    ...
    public fun update_schema(arg0: &mut Form, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x8a51080b9102dc8891e5837612403fb0e98b32b8d1c890d0422e73b3dc1aaca1::events::emit_form_updated(0x2::object::id<Form>(arg0), arg1, arg0.version);
    }
