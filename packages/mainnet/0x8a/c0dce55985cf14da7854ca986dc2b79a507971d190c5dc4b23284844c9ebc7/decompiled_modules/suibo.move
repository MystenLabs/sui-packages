module 0x8ac0dce55985cf14da7854ca986dc2b79a507971d190c5dc4b23284844c9ebc7::suibo {
    ...
    fun init(arg0: SUIBO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUIBO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Suibo"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The First Ever SocialFi NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://gNrot7Elvo6JS1zgrFFZlp33CS4SNyDKucL5vuSU-RE"));
