module 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::tpsl {
    ...
    struct ConditionalOrderPriceOutOfBounds has copy, drop {
        manager_id: 0x2::object::ID,
        conditional_order_id: u64,
        conditional_order: ConditionalOrder,
        timestamp: u64,
    ...
    struct ConditionalOrderBelowLiquidation has copy, drop {
        manager_id: 0x2::object::ID,
        conditional_order_id: u64,
        conditional_order: ConditionalOrder,
        timestamp: u64,
    ...
    public(friend) fun add_conditional_order<T0, T1>(arg0: &mut TakeProfitStopLoss, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg6: u64, arg7: Condition, arg8: PendingOrder, arg9: &0x2::clock::Clock) {
        if (is_limit_order(&arg8)) {
            assert!(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::check_limit_order_params<T0, T1>(arg1, *0x1::option::borrow<u64>(&arg8.price), arg8.quantity, *0x1::option::borrow<u64>(&arg8.expire_timestamp), arg9), 6);
        } else {
            assert!(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::check_market_order_params<T0, T1>(arg1, arg8.quantity), 6);
        };
        let v0 = 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::oracle::calculate_price<T0, T1>(arg5, arg3, arg4, arg9);
        let v1 = arg7.trigger_below_price;
        let v2 = arg7.trigger_price;
        assert!(v1 && v2 <= v0 || !v1 && v2 >= v0, 1);
        assert!(num_conditional_orders(arg0) < 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::max_conditional_orders(), 3);
    ...
    public(friend) fun emit_below_liquidation_event(arg0: &TakeProfitStopLoss, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = get_conditional_order(arg0, arg2);
        if (0x1::option::is_some<ConditionalOrder>(&v0)) {
            let v1 = ConditionalOrderBelowLiquidation{
                manager_id           : arg1,
                conditional_order_id : arg2,
                conditional_order    : 0x1::option::destroy_some<ConditionalOrder>(v0),
                timestamp            : 0x2::clock::timestamp_ms(arg3),
            };
            0x2::event::emit<ConditionalOrderBelowLiquidation>(v1);
        };
    }
    ...
    public(friend) fun emit_price_out_of_bounds_event(arg0: &TakeProfitStopLoss, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = get_conditional_order(arg0, arg2);
        if (0x1::option::is_some<ConditionalOrder>(&v0)) {
            let v1 = ConditionalOrderPriceOutOfBounds{
                manager_id           : arg1,
                conditional_order_id : arg2,
                conditional_order    : 0x1::option::destroy_some<ConditionalOrder>(v0),
                timestamp            : 0x2::clock::timestamp_ms(arg3),
            };
            0x2::event::emit<ConditionalOrderPriceOutOfBounds>(v1);
        };
    }
    ...
    public fun new_pending_limit_order(arg0: u64, arg1: u8, arg2: u8, arg3: u64, arg4: u64, arg5: bool, arg6: bool, arg7: u64) : PendingOrder {
        assert!(arg1 == 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::no_restriction() || arg1 == 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 4);
        PendingOrder{
            is_limit_order       : true,
