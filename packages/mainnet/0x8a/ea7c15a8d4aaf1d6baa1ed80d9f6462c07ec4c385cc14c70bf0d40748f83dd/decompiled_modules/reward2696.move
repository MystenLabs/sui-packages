module 0x8aea7c15a8d4aaf1d6baa1ed80d9f6462c07ec4c385cc14c70bf0d40748f83dd::reward2696 {
    struct REWARD2696 has drop {
        dummy_field: bool,
    }

    struct TICKET_2696 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2696(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2696>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2696>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2696, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2696>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2696>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2696>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2696>>(v5, 0x2::tx_context::sender(arg1));
    }
