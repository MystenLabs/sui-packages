module 0x8af8e2d88d5551231ed3d4780b074147026bd4d54d6dbebf3bc18c1deb066e29::reward2038 {
    struct REWARD2038 has drop {
        dummy_field: bool,
    }

    struct TICKET_2038 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2038(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2038>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2038>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2038, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2038>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2038>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2038>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2038>>(v5, 0x2::tx_context::sender(arg1));
    }
