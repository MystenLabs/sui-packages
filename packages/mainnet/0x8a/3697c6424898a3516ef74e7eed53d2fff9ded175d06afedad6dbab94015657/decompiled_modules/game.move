module 0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>,
        init_reward: u64,
    ...
    struct PlayerInfo has store, key {
        ...
        board_level: u64,
        board_peroid: u64,
        board_item: 0x2::table_vec::TableVec<ItemBoost>,
        referral: address,
        last_claim: u64,
    }
    ...
    entry fun add_treasury_cap(arg0: &mut GameInfo, arg1: 0x2::coin::TreasuryCap<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 4);
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury"), arg1);
    }
    ...
    entry fun create_user(arg0: &mut GameInfo, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::table_vec::empty<ItemBoost>(arg9);
        let v3 = ItemBoost{
            type       : 2,
            rate       : 1,
            start_time : 0,
        ...
        let v5 = PlayerInfo{
            ...
            board_level     : arg7,
            board_peroid    : arg8,
            board_item      : 0x2::table_vec::empty<ItemBoost>(arg9),
            referral        : arg2,
            last_claim      : 0,
        };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version      : 1,
            balance      : 0x2::balance::zero<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>(),
    ...
    entry fun remove_treasury_cap(arg0: &mut GameInfo, arg1: &0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg1));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>>(0x2::coin::from_balance<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>(0x2::balance::split<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>>(0x2::coin::from_balance<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>(0x2::balance::withdraw_all<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>>(0x2::coin::mint<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0x8a3697c6424898a3516ef74e7eed53d2fff9ded175d06afedad6dbab94015657::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
