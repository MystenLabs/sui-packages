module 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::intents {
    ...
    public fun add_action_spec<T0, T1: drop, T2: drop>(arg0: &mut Intent<T0>, arg1: T1, arg2: vector<u8>, arg3: T2) {
        ...
        assert!(0x1::vector::length<u8>(&arg2) <= 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::constants::max_action_data_size(), 12);
        let v0 = ActionSpec{
            version     : 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::constants::current_action_version(),
    ...
    public fun add_existing_action_spec<T0, T1: drop>(arg0: &mut Intent<T0>, arg1: ActionSpec, arg2: T1) {
        ...
        assert!(arg1.version == 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::constants::current_action_version(), 11);
        assert!(0x1::vector::length<u8>(&arg1.action_data) <= 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::constants::max_action_data_size(), 12);
    ...
    public fun new_action_spec_with_typename(arg0: 0x1::type_name::TypeName, arg1: vector<u8>, arg2: u8) : ActionSpec {
        assert!(arg2 == 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::constants::current_action_version(), 11);
        assert!(0x1::vector::length<u8>(&arg1) <= 0x8a7f8ce15365ff144cb808887e3c1d2484ddd7ce1b7037bdf5e299351845eada::constants::max_action_data_size(), 12);
        ActionSpec{
            version     : arg2,
            action_type : arg0,
            action_data : arg1,
