module 0x8a6d360dd0ba041ed8037accc87e4a8dae621a98ccb352898267860ccc0f8a2d::cnsnft1021 {
    struct CNSNFT1021 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1021, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2614"));
        let v4 = 0x2::package::claim<CNSNFT1021>(arg0, arg1);
