module 0x8a1b8c735c61d1896dfe7a912d975dbbb32b6984ba56ac253a40691d19817582::gift5460 {
    struct GIFT5460 has drop {
        dummy_field: bool,
    }

    struct TICKET_5460 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5460(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5460>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5460>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5460, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5460>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5460>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5460>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5460>>(v5, 0x2::tx_context::sender(arg1));
    }
