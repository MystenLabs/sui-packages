module 0x8a5da8cd401e35da070eebd1d1d2677b89994ac2e75e94dc08b7bd2bf6ec9c43::babygoat {
    ...
    fun init(arg0: BABYGOAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BABYGOAT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BABYGOAT")))), trim_right(b"Baby Goatseus Maximus           "), trim_right(b"First Baby meme created by @truth_terminal. Baby Goatseus Maximus will fulfill the prophecies of the ancient memeers.                                                                                                                                                                                                           "), v2, arg1);
