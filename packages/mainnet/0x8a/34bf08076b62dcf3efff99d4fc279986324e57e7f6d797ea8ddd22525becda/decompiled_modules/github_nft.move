module 0x8a34bf08076b62dcf3efff99d4fc279986324e57e7f6d797ea8ddd22525becda::github_nft {
    ...
    fun init(arg0: GITHUB_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"dsecription"));
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"image_url"));
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"creator"));
        let v2 = 0x1::vector::empty<0x1::string::String>();
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"GINAYY NFT #{nft_id}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"a nft for GINAYY Github avatar"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/111634195?s=400&u=09891269f1901b3d3b25701ccf92dca9cc2165c4&v=4"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"GINAYY"));
        let v4 = MintRecord{
