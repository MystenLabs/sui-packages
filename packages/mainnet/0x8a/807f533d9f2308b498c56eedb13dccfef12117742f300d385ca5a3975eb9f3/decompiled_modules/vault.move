module 0xc74a7df07b4089d92f196d1db73ce0574db7f58ae0ba2b19b2a59d402958d394::vault {
    ...
    public fun auto_swap_deposit_to_owner_v2<T0>(arg0: &mut TaliseVault, arg1: &0xc74a7df07b4089d92f196d1db73ce0574db7f58ae0ba2b19b2a59d402958d394::auto_swap::AutoSwapRegistryV2, arg2: 0x2::balance::Balance<T0>, arg3: SwapTicket, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()));
        if (0x2::bag::contains<vector<u8>>(&arg0.balances, v3)) {
            0x2::balance::join<T0>(&mut arg2, 0x2::bag::remove<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg0.balances, v3));
        };
        ...
        let v4 = VaultAutoSwap{
            ...
            to_type     : 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())),
            from_amount : v2,
            to_amount   : 0x2::balance::value<T0>(&arg2),
    ...
    public entry fun enable_auto_swap_v2<T0>(arg0: &TaliseVault, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun receive_from_accumulator<T0>(arg0: &mut TaliseVault, arg1: u64, arg2: &0x2::tx_context::TxContext) {
    ...
    public entry fun receive_from_accumulator_to_owner<T0>(arg0: &mut TaliseVault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::redeem_funds<T0>(0x2::balance::withdraw_funds_from_object<T0>(&mut arg0.id, arg1));
        assert!(0x2::balance::value<T0>(&v0) > 0, 202);
