module 0x8a9c5597e412a41c51b3ac76ca4e1233a4d81e0fb1327dd0f9527c0321a11611::reward4074 {
    struct REWARD4074 has drop {
        dummy_field: bool,
    }

    struct TICKET_4074 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4074(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4074>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4074>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4074, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4074>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4074>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4074>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4074>>(v5, 0x2::tx_context::sender(arg1));
    }
