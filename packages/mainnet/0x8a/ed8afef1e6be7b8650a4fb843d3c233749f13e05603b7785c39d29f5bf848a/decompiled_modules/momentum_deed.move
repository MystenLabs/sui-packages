module 0x8aed8afef1e6be7b8650a4fb843d3c233749f13e05603b7785c39d29f5bf848a::momentum_deed {
    ...
    fun init(arg0: MOMENTUM_DEED, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Come back after the mint ends to reveal your NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidrwp4ejznr7dhmw2ojj52wgvc6ywda2etbmz5szi6wvfb4hguxhm"));
