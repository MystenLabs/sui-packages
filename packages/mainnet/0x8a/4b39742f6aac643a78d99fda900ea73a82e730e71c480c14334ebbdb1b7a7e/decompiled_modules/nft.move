module 0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::nft {
    ...
    public entry fun accumulate_sity_updated(arg0: &mut City, arg1: &mut GameData, arg2: &Wallet, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = if (v0 < get_withdraw_date(arg1)) {
            0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg1.pool, v4 * (v8 + (v9 * 10 + v10 * 15) * v8 / 100) * arg1.speed / 3600000, arg4)
        } else {
            0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg1.secure_pool, v4 * (v8 + (v9 * 10 + v10 * 15) * v8 / 100) * arg1.speed / 3600000, arg4)
        };
    ...
    fun calculate_factory_bonus_with_boost(arg0: &mut City, arg1: &GameData) : u64 {
        ...
        0x2::balance::value<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&arg0.balance) * (v0 + (v1 * 20 + v2 * 40) * v0 / 100) / 100
    }
