module 0x8a17ffc914b03dfa98b822b9988008bde4cdffcc8857e7c3c752733b894c985b::sui_passport_ {
    struct SUI_PASSPORT_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_PASSPORT_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_PASSPORT_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI PASSPORT "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SUI PASSPORT  "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihcudycwifdqqm2s75mpwwc4i6ze6ptu4eedkpw3c2534szrz2gjm"));
