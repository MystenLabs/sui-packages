module 0x8ab7c2f041bc8c7b6fc3fc1eb8831098df6eb6641bb212d068a35b954c6d0a35::tester {
    ...
    fun init(arg0: TESTER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TESTER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"tester"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"testing"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibkik3zao2dgndcxqmwqvriqyklktfdxmsn2iyknrl7tsg5wpgu4m"));
