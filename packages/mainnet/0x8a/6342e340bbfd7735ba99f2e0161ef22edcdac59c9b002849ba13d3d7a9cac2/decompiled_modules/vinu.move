module 0x8a6342e340bbfd7735ba99f2e0161ef22edcdac59c9b002849ba13d3d7a9cac2::vinu {
    ...
    fun init(arg0: VINU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/bsc/0xfebe8c1ed424dbf688551d4e2267e7a53698f0aa.png?size=lg&key=ca0845                                                                                                                                                                                                                 ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<VINU>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"VINU    ")))), trim_right(b"Vita Inu                        "), trim_right(b"The only memecoin with real world utility. Zero fees, instant settlement and the highest energy efficiency out there. What more could you ask for? Join our fast growing community!                                                                                                                                             "), v2, arg1);
        let v5 = v3;
