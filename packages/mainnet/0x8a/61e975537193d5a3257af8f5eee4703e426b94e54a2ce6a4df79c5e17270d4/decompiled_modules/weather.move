module 0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather {
    ...
    public fun city_weather_oracle_dt(arg0: &WeatherOracle, arg1: u32) : u32 {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).dt
    }
    ...
    public fun city_weather_oracle_humidity(arg0: &WeatherOracle, arg1: u32) : u8 {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).humidity
    }
    ...
    public fun city_weather_oracle_positive_latitude(arg0: &WeatherOracle, arg1: u32) : bool {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).positive_latitude
    }

    public fun city_weather_oracle_positive_longitude(arg0: &WeatherOracle, arg1: u32) : bool {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).positive_longitude
    }

    public fun city_weather_oracle_pressure(arg0: &WeatherOracle, arg1: u32) : u32 {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).pressure
    }
    ...
    public fun city_weather_oracle_weather_id(arg0: &WeatherOracle, arg1: u32) : u16 {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).weather_id
    }

    public fun city_weather_oracle_wind_deg(arg0: &WeatherOracle, arg1: u32) : u16 {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).wind_deg
    }

    public fun city_weather_oracle_wind_gust(arg0: &WeatherOracle, arg1: u32) : 0x1::option::Option<u16> {
        0x2::dynamic_object_field::borrow<u32, CityWeatherOracle>(&arg0.id, arg1).wind_gust
    }
