module 0x8a4c81941cf55f115cb9886d521e622e73cd41a473b423036b0c3a62fa148474::gift2056 {
    struct GIFT2056 has drop {
        dummy_field: bool,
    }

    struct TICKET_2056 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2056(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2056>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2056>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2056, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2056>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2056>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2056>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2056>>(v5, 0x2::tx_context::sender(arg1));
    }
