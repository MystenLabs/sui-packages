module 0x8a8f456cb6a84ac7323e70f645ed1cadb932475261ec539c97d6105481782c64::cocoro {
    ...
    fun init(arg0: COCORO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/783cgtfEPBdutPvoM36eg5BCAtHqy7p6Pa6iaBzpump.png?size=lg&key=b40392                                                                                                                                                                                                             ");
