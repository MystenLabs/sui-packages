module 0x8a941d101aeed577b91957f2ca99b8e0deb282f920044a18a1b5c8df0101ecb2::cnsnft6416 {
    struct CNSNFT6416 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6416, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2380"));
        let v4 = 0x2::package::claim<CNSNFT6416>(arg0, arg1);
