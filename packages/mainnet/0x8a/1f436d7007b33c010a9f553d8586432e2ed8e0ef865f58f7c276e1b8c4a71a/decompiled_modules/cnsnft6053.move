module 0x8a1f436d7007b33c010a9f553d8586432e2ed8e0ef865f58f7c276e1b8c4a71a::cnsnft6053 {
    struct CNSNFT6053 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6053, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6053>(arg0, arg1);
