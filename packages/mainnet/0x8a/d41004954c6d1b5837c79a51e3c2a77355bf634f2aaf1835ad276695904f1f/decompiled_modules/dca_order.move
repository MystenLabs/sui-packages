module 0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_order {
    ...
    struct TestParseSignatureEvent has copy, drop {
        address: address,
        public_key: vector<u8>,
        signature: vector<u8>,
    }

    public fun cancel_order<T0, T1>(arg0: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::checked_package_version(arg0);
    ...
    public fun flash_loan_for_make_deal<T0, T1>(arg0: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg1: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::DCAConfig, arg2: &mut 0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::ProtocolFeeVault, arg3: &mut Order<T0, T1>, arg4: u64, arg5: vector<0x1::string::String>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, MakeDealReceipt) {
        0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::checked_package_version(arg0);
        ...
        let v2 = if (arg3.fee_rate > 0) {
            ...
            0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::receive_fee<T0>(arg2, 0x2::balance::split<T0>(&mut v1, v3));
            v3
        } else {
            0
        };
    ...
    public fun open_order<T0, T1>(arg0: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg1: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::DCAConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: 0x1::string::String, arg11: &0x2::clock::Clock, arg12: &mut OrderIndexer, arg13: &mut 0x2::tx_context::TxContext) {
        0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::checked_package_version(arg0);
    ...
    public fun parse_signature_test(arg0: 0x1::string::String) : (address, vector<u8>, vector<u8>) {
        let v0 = 0x2::hex::decode(*0x1::string::as_bytes(&arg0));
        assert!(*0x1::vector::borrow<u8>(&v0, 0) == 0, 10);
        let v1 = 0x1::vector::empty<u8>();
        ...
        let v5 = 0x2::address::from_bytes(0x2::hash::blake2b256(&v1));
        0x1::vector::remove<u8>(&mut v1, 0);
        let v6 = TestParseSignatureEvent{
            address    : v5,
            public_key : v1,
            signature  : v2,
        };
        0x2::event::emit<TestParseSignatureEvent>(v6);
        (v5, v1, v2)
    }

    public fun repay_for_make_deal<T0, T1>(arg0: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg1: &mut Order<T0, T1>, arg2: &mut OrderIndexer, arg3: 0x2::coin::Coin<T1>, arg4: MakeDealReceipt, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::checked_package_version(arg0);
        let MakeDealReceipt {
            order_id           : v0,
            in_amount          : v1,
    ...
    fun validate_keepers<T0, T1>(arg0: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg1: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::DCAConfig, arg2: &Order<T0, T1>, arg3: u64, arg4: vector<0x1::string::String>) : bool {
        if (0x1::vector::length<0x1::string::String>(&arg4) < 0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::keeper_threshold(arg1)) {
            return false
        };
        ...
        0x2::vec_set::size<address>(&v0) >= 0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::keeper_threshold(arg1)
    }

    fun validate_order<T0, T1>(arg0: address, arg1: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg2: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::DCAConfig, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: 0x1::string::String, arg10: &0x2::clock::Clock) {
        assert!(0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::is_coin_allow<T0, T1>(arg2), 15);
        assert!(arg3 >= 0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::min_cycle_count(arg2), 0);
        assert!(arg4 > arg6, 7);
        assert!(arg5 >= 0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::min_cycle_frequency(arg2), 1);
        ...
        assert!(v1 <= 0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::oracle_valid_duration(arg2), 11);
    ...
    fun verify_internal(arg0: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg1: vector<u8>, arg2: &0x1::string::String, arg3: u8) : (bool, address) {
        let (v0, v1, v2) = parse_signature(0x2::hex::decode(*0x1::string::as_bytes(arg2)));
        let v3 = v2;
        let v4 = v1;
        if (arg3 == 0) {
            0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::checked_oracle(arg0, v0);
        } else {
            0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::dca_config::checked_keeper(arg0, v0);
        };
        (0x2::ed25519::ed25519_verify(&v3, &v4, &arg1), v0)
    }

    public fun withdraw<T0, T1>(arg0: &0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::BaseConfig, arg1: &mut Order<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0xa34a715f3ad75c65b43d5c88c67cdc0e91262436bb5335eba514e4584e12980::base_config::checked_package_version(arg0);
