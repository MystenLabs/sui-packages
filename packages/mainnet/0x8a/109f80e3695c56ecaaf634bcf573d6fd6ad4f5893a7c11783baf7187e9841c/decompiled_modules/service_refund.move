module 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service_refund {
    ...
    public(friend) fun insert_refund_address(arg0: &mut 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::Service, arg1: address) {
        ...
        if (0x2::vec_set::contains<0x1::string::String>(0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::features(arg0), &v0)) {
            let v1 = 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::get_feature_mut<Feature, Config>(arg0);
            if (!0x2::vec_set::contains<address>(&v1.arr_claimed_address, &arg1)) {
                0x2::vec_set::insert<address>(&mut v1.arr_claimed_address, arg1);
            };
        };
    }
