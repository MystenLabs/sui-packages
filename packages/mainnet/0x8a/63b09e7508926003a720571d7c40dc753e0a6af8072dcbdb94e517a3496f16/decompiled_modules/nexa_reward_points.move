module 0x8a63b09e7508926003a720571d7c40dc753e0a6af8072dcbdb94e517a3496f16::nexa_reward_points {
    ...
    public fun initialize_treasury<T0>(arg0: &0x8a63b09e7508926003a720571d7c40dc753e0a6af8072dcbdb94e517a3496f16::app::AdminCap, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun mint_and_claim_reward_points<T0>(arg0: &mut NexaRewardCoinTreasury<T0>, arg1: u64, arg2: &0x8a63b09e7508926003a720571d7c40dc753e0a6af8072dcbdb94e517a3496f16::nexa_referrals::ReferralsMap, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x8a63b09e7508926003a720571d7c40dc753e0a6af8072dcbdb94e517a3496f16::nexa_referrals::get_referrer(arg2, v1);
        if (v3 != @0x0) {
            let v4 = arg1 * 30 / 100;
            ...
            let v6 = 0x8a63b09e7508926003a720571d7c40dc753e0a6af8072dcbdb94e517a3496f16::nexa_referrals::get_referrer(arg2, v3);
            if (v6 != @0x0) {
                let v7 = v4 * 10 / 100;
