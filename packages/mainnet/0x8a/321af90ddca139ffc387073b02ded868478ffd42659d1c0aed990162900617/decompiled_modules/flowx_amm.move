module 0x8a321af90ddca139ffc387073b02ded868478ffd42659d1c0aed990162900617::flowx_amm {
    struct FlowxAmmSwapEvent has copy, drop {
    ...
    public fun swap_a2b<T0, T1>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = FlowxAmmSwapEvent{
            pool_id      : 0x2::object::id<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container>(arg0),
            a2b          : true,
        ...
        0x2::event::emit<FlowxAmmSwapEvent>(v1);
        v0
    }
    ...
    public fun swap_b2a<T0, T1>(arg0: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::router::swap_exact_input_direct<T1, T0>(arg0, arg1, arg2);
        let v1 = FlowxAmmSwapEvent{
            pool_id      : 0x2::object::id<0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container>(arg0),
            a2b          : false,
