module 0x8ab8ce7e53354948f48354fc488e9a965be68034c8e817c253250d97d85dfffb::testships {
    ...
    public fun update_attributes(arg0: &PubKey, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: vector<u8>, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: u64) {
        let v0 = 0x2::kiosk::borrow_mut<ShipNFT>(arg1, arg2, arg3);
        let v1 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v1, b"UPDATE");
        0x1::vector::append<u8>(&mut v1, 0x1::string::into_bytes(0x1::u64::to_string(v0.ship_id)));
        0x1::vector::append<u8>(&mut v1, 0x1::string::into_bytes(0x1::u64::to_string(arg6)));
        0x1::vector::append<u8>(&mut v1, 0x1::string::into_bytes(0x1::u64::to_string(arg7)));
        0x1::vector::append<u8>(&mut v1, 0x1::string::into_bytes(0x1::u64::to_string(arg8)));
        0x1::vector::append<u8>(&mut v1, 0x1::string::into_bytes(0x1::u64::to_string(arg9)));
        0x1::vector::append<u8>(&mut v1, string_to_bytes_copy(&arg10));
        0x1::vector::append<u8>(&mut v1, string_to_bytes_copy(&arg11));
        0x1::vector::append<u8>(&mut v1, 0x1::string::into_bytes(0x1::u64::to_string(arg12)));
        assert!(is_valid_hash_alg(arg5), 11);
        assert!(0x2::ecdsa_k1::secp256k1_verify(&arg4, &arg0.pubkey_bytes, &v1, arg5), 3);
        v0.speed = arg6;
        v0.attack = arg7;
        v0.defence = arg8;
        v0.health = arg9;
        v0.upgrades = arg10;
        v0.specialisation = arg11;
        let v2 = 0x1::string::utf8(b"Speed");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v0.attributes, &v2)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v0.attributes, &v2) = u64_to_string(arg6);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, v2, u64_to_string(arg6));
        };
        let v3 = 0x1::string::utf8(b"Attack");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v0.attributes, &v3)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v0.attributes, &v3) = u64_to_string(arg7);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, v3, u64_to_string(arg7));
        };
        let v4 = 0x1::string::utf8(b"Defence");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v0.attributes, &v4)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v0.attributes, &v4) = u64_to_string(arg8);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, v4, u64_to_string(arg8));
        };
        let v5 = 0x1::string::utf8(b"Health");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v0.attributes, &v5)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v0.attributes, &v5) = u64_to_string(arg9);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, v5, u64_to_string(arg9));
        };
        let v6 = 0x1::string::utf8(b"Upgrades");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v0.attributes, &v6)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v0.attributes, &v6) = clone_string(&v0.upgrades);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, v6, clone_string(&v0.upgrades));
        };
        let v7 = 0x1::string::utf8(b"Specialisation");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v0.attributes, &v7)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v0.attributes, &v7) = clone_string(&v0.specialisation);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, v7, clone_string(&v0.specialisation));
        };
    }
