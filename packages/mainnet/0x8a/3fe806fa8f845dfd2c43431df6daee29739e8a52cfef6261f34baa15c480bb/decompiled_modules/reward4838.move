module 0x8a3fe806fa8f845dfd2c43431df6daee29739e8a52cfef6261f34baa15c480bb::reward4838 {
    struct REWARD4838 has drop {
        dummy_field: bool,
    }

    struct TICKET_4838 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4838(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4838>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4838>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4838, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4838>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4838>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4838>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4838>>(v5, 0x2::tx_context::sender(arg1));
    }
