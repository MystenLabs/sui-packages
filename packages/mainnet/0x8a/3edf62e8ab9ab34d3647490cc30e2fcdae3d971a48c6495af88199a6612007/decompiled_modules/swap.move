module 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::swap {
    ...
    public entry fun swap<T0, T1>(arg0: &mut Global, arg1: &mut Pools, arg2: &mut Fees, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::event::swapped_event(id<T0, T1>(arg0), generate_lp_name<T0, T1>(), 0x1::vector::pop_back<u64>(&mut v0), 0x1::vector::pop_back<u64>(&mut v0), 0x1::vector::pop_back<u64>(&mut v0), 0x1::vector::pop_back<u64>(&mut v0));
    }
    ...
    public entry fun add_can_add_lp<T0, T1>(arg0: &mut Fees, arg1: address, arg2: &0x2::coin::TreasuryCap<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::add_can_add_lp<T0, T1>(get_mut_fee_store<T0>(arg0), arg1);
    }
    ...
    public entry fun add_fee_exempt<T0, T1>(arg0: &mut Fees, arg1: address, arg2: &0x2::coin::TreasuryCap<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::add_fee_exempt<T0, T1>(get_mut_fee_store<T0>(arg0), arg1);
    }

    fun distribute_fee<T0>(arg0: &mut Pools, arg1: &mut 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::pool_balance<T0>(arg1);
        if (v0 > 0) {
            let v1 = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::get_fee<T0>(arg2, arg1);
            let (v2, v3, v4, v5) = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::get_fee_amount<T0>(arg1, v0, v1);
            let v6 = 0x2::coin::from_balance<T0>(v5, arg3);
            let v7 = swap_back<T0, 0x2::sui::SUI>(arg0, v6, arg3);
            0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::distribute_fee<T0>(arg1, v1, v2, v3, v4, v7, arg3);
        };
    }
    ...
    public entry fun lottery_jackpot<T0>(arg0: &mut Fees, arg1: &0x2::clock::Clock, arg2: &0x2::coin::TreasuryCap<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::lottery_jackpot<T0>(arg1, get_mut_fee_store<T0>(arg0), arg3);
    }
    ...
    public entry fun update_jackpot_bonus<T0>(arg0: &mut Fees, arg1: u64, arg2: u64, arg3: &0x2::coin::TreasuryCap<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::update_jackpot_bonus<T0>(get_mut_fee_store<T0>(arg0), arg1, arg2);
    }
    ...
    public entry fun update_price<T0>(arg0: &mut Fees, arg1: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::state::State, arg2: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::update_price<T0>(get_mut_fee_store<T0>(arg0), arg1, arg2, arg3);
    }
    ...
    public entry fun update_whitelist<T0, T1>(arg0: &mut Fees, arg1: bool, arg2: bool, arg3: &0x2::coin::TreasuryCap<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::update_whitelist<T0, T1>(get_mut_fee_store<T0>(arg0), arg1, arg2);
    }
    ...
    public entry fun add_liquidity<T0, T1>(arg0: &mut Global, arg1: &mut Pools, arg2: &mut Fees, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::event::added_event(global_id<T0, T1>(get_pool<T0, T1>(arg1, v0)), generate_lp_name<T0, T1>(), 0x1::vector::pop_back<u64>(&mut v4), 0x1::vector::pop_back<u64>(&mut v4), 0x1::vector::pop_back<u64>(&mut v4));
    }
    ...
    fun add_liquidity_internal<T0, T1>(arg0: &mut Fees, arg1: &mut Pools, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::sqrt(0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 4);
            return (arg0, v0)
        };
        let v1 = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 6);
        assert!(v1 >= arg2, 3);
        (v1, arg1)
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }

    public fun get_fee_store<T0>(arg0: &Fees) : &0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0> {
        assert!(is_fee_store_existed<T0>(arg0), 16);
        0x2::bag::borrow<0x1::ascii::String, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>>(&arg0.fee_stores, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::utils::get_type_name_str<T0>())
    }

    public fun get_fee_to_fundation(arg0: u64) : u64 {
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div(arg0, 30 / 5, 10000)
    }

    fun get_mut_fee_store<T0>(arg0: &mut Fees) : &mut 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0> {
        assert!(is_fee_store_existed<T0>(arg0), 16);
        0x2::bag::borrow_mut<0x1::ascii::String, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>>(&mut arg0.fee_stores, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::utils::get_type_name_str<T0>())
    }
    ...
    fun get_mut_pool_and_fee_store<T0, T1, T2>(arg0: &mut Pools, arg1: &mut Fees, arg2: bool) : (&mut Pool<T0, T1>, &mut 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T2>) {
    ...
    fun get_sui_amount<T0>(arg0: u64, arg1: &Pools) : u64 {
        ...
        if (v0) {
            ...
            if (v2 > 0) {
                0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div(arg0, v3, v2)
            } else {
                0
            }
        } else {
            ...
            if (v6 > 0) {
                0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div(arg0, v5, v6)
            } else {
                0
            }
        }
    ...
    fun into_balance_check_fee<T0, T1>(arg0: &mut Pools, arg1: &mut 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>, arg2: 0x2::coin::Coin<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        if (0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::should_take_fee<T0, T1>(0x2::tx_context::sender(arg4), arg1)) {
            let (v1, _) = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::take_fee<T0>(arg2, get_sui_amount<T0>(0x2::coin::value<T0>(&arg2), arg0), arg3, arg1, arg4);
    ...
    fun is_fee_store_existed<T0>(arg0: &Fees) : bool {
        0x2::bag::contains_with_type<0x1::ascii::String, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>>(&arg0.fee_stores, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::utils::get_type_name_str<T0>())
    }

    public fun is_order<T0, T1>() : bool {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get<T1>();
        let v2 = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::comparator::is_equal(&v2), 9);
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::comparator::is_smaller_than(&v2)
    }
    ...
    public entry fun register_fee_store<T0>(arg0: &mut Fees, arg1: &0xa446c4a37c0bb69d03357c1a52d60da0b434048226d5f3feffdb693586bea861::price_info::PriceInfoObject, arg2: &0x2::coin::TreasuryCap<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::utils::get_type_name_str<T0>();
        assert!(!0x2::bag::contains_with_type<0x1::ascii::String, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>>(&mut arg0.fee_stores, v0), 17);
        0x2::bag::add<0x1::ascii::String, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>>(&mut arg0.fee_stores, v0, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::initialize<T0>(arg1, arg3));
    }
    ...
    public entry fun remove_liquidity<T0, T1>(arg0: &mut Global, arg1: &mut Pools, arg2: &mut Fees, arg3: 0x2::coin::Coin<LP<T0, T1>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::event::removed_event(global_id<T0, T1>(get_pool<T0, T1>(arg1, v0)), generate_lp_name<T0, T1>(), 0x2::coin::value<T0>(&v5), 0x2::coin::value<T1>(&v4), 0x2::coin::value<LP<T0, T1>>(&arg3));
    }
    ...
    fun remove_liquidity_internal<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LP<T0, T1>>, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_x, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div(v1, v0, v3), arg3), 0x2::coin::take<T1>(&mut arg0.coin_y, 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::math::mul_div(v2, v0, v3), arg3))
    }
    ...
    fun transfer_check_fee<T0, T1>(arg0: &mut Pools, arg1: &mut 0xacf4c9044f910a421e0e3e8885e3052f0586930db366a81808974455ccf88d32::fee::FeeStore<T0>, arg2: 0x2::coin::Coin<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
