module 0x8ad9dac1c3673b4cd944ffc937d394b11f775c6e02dbc28ea8c94073054e9635::banana {
    struct BANANA has drop {
        dummy_field: bool,
    }

    fun init(arg0: BANANA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BANANA>(arg0, 9, b"BANANA", b"Comedian", b"https://pump.fun/advanced/coin/9PR7nCP9DpcUotnDPVLUBUZKu5WAYkwrCUx9wDnSpump", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
