module 0x8a2b4744fcf9df160ebc40d28d74455738b59b443932c49048e44bf46f2b83cc::cnsnft1741 {
    struct CNSNFT1741 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1741, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4794"));
        let v4 = 0x2::package::claim<CNSNFT1741>(arg0, arg1);
