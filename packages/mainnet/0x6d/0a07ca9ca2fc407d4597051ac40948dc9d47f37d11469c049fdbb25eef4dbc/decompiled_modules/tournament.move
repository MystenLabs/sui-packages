module 0x6d0a07ca9ca2fc407d4597051ac40948dc9d47f37d11469c049fdbb25eef4dbc::tournament {
    ...
    public fun create_tournament(arg0: &mut TournamentRegistry, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u8, arg4: u64, arg5: u64, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: vector<0x1::string::String>, arg9: bool, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0, 5);
        assert!(0x2::tx_context::sender(arg11) == arg0.admin, 6);
        let v1 = arg9;
        if (arg10) {
    ...
    public fun end_tournament(arg0: &mut Tournament, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (!has_participants_with_votes(arg0)) {
            ...
            0x6d0a07ca9ca2fc407d4597051ac40948dc9d47f37d11469c049fdbb25eef4dbc::storage::transfer_sui(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.prize_pool, v3), arg2), v2.owner);
            ...
            0x6d0a07ca9ca2fc407d4597051ac40948dc9d47f37d11469c049fdbb25eef4dbc::storage::transfer_sui(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.prize_pool, v6), arg2), v11.owner);
            ...
            0x6d0a07ca9ca2fc407d4597051ac40948dc9d47f37d11469c049fdbb25eef4dbc::storage::transfer_sui(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.prize_pool, v7), arg2), v14.owner);
            ...
            0x6d0a07ca9ca2fc407d4597051ac40948dc9d47f37d11469c049fdbb25eef4dbc::storage::transfer_sui(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.prize_pool, v8), arg2), v17.owner);
