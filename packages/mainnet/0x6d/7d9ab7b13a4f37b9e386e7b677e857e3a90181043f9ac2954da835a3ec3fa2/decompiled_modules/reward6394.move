module 0x6d7d9ab7b13a4f37b9e386e7b677e857e3a90181043f9ac2954da835a3ec3fa2::reward6394 {
    struct REWARD6394 has drop {
        dummy_field: bool,
    }

    struct TICKET_6394 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6394(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6394>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6394>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6394, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6394>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6394>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6394>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6394>>(v5, 0x2::tx_context::sender(arg1));
    }
