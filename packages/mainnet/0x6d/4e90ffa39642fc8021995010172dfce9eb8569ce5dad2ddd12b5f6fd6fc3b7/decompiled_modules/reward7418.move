module 0x6d4e90ffa39642fc8021995010172dfce9eb8569ce5dad2ddd12b5f6fd6fc3b7::reward7418 {
    struct REWARD7418 has drop {
        dummy_field: bool,
    }

    struct TICKET_7418 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7418(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7418>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7418>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7418, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7418>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7418>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7418>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7418>>(v5, 0x2::tx_context::sender(arg1));
    }
