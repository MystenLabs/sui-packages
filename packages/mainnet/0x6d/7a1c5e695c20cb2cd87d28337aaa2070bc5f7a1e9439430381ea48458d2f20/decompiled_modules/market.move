module 0x6d7a1c5e695c20cb2cd87d28337aaa2070bc5f7a1e9439430381ea48458d2f20::market {
    ...
    public entry fun new(arg0: &0x2::package::Publisher, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Market{
            ...
            coin_symbol                 : 0x1::string::utf8(arg3),
    ...
    public entry fun settlement<T0>(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::clock::Clock) {
        ...
        arg0.coin_symbol = 0x1::string::from_ascii(0x2::coin::get_symbol<T0>(arg2));
    ...
    public entry fun withdraw(arg0: &mut Market, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg1);
        0x6d7a1c5e695c20cb2cd87d28337aaa2070bc5f7a1e9439430381ea48458d2f20::utils::withdraw_balance<0x5d4b302506645c37ff133b98c4b50a5ae14841659738d6d733d59d0d217a93bf::coin::COIN>(&mut arg0.balance, arg2);
    }
