module 0x6d5ee4fca6cd87739f5b8db609a69fd641e8a13e8af37761ee9734f70f801992::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"TESTAISUI", b"testaisui", b"test agent on aiSUI, check if everything is OK", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafkreigmh4amjri7cfpchgyaw23tuzhbnmqrvbkmewi26hsulqrezg6mly")), arg1);
