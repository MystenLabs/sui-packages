module 0x6da2b55a20a3fe9dc1fbec0473a6f3d893c6f485c089fd5a556ded5d2406a798::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/F38KkrNY94u781sTEHssTbzPaDytZsmYzpkaQW44pump.png?size=lg&key=340db8                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DEGEN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DEGEN   ")))), trim_right(b"Lowq Degen                      "), trim_right(b"A Degen with low iq in a world of superhuman AI I like crypto, sportsbetting and memes.                                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
