module 0xc68f74e99d732949aa3edd6b9910f5a8ecfbd3a55c5058bb895ea0f791e605a4::reward_distributor {
    ...
    struct Receivable<phantom T0> {
        recipient: address,
        receivable_amount: u64,
        receiving_fund: 0x2::balance::Balance<T0>,
    }
    ...
    struct RewardDistributor<phantom T0, phantom T1> has store, key {
        ...
        receiving_coin_type: 0x1::type_name::TypeName,
        receiving_rate: 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::Double,
    }

    public fun new<T0, T1, T2>(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::Double, arg4: &mut 0x2::tx_context::TxContext) : RewardDistributor<T0, T1> {
        let v0 = RewardDistributor<T0, T1>{
            ...
            stake_table         : 0x2::table::new<address, StakeData<T0, T1>>(arg4),
            ...
            delay_ms            : arg2,
            withdraw_requests   : 0x2::linked_table::new<0x2::object::ID, WithdrawRequest>(arg4),
            receiving_coin_type : 0x1::type_name::with_defining_ids<T2>(),
            receiving_rate      : arg3,
        };
        let v1 = Create{
    ...
    public fun add_fund<T0>(arg0: &mut Receivable<T0>, arg1: 0x2::coin::Coin<T0>) {
        0x2::balance::join<T0>(&mut arg0.receiving_fund, 0x2::coin::into_balance<T0>(arg1));
    }
    ...
    public fun cancel_withdraw<T0, T1>(arg0: &mut RewardDistributor<T0, T1>, arg1: 0x2::object::ID, arg2: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest) {
        ...
        v4.pending_withdrawal_amount = v4.pending_withdrawal_amount - v1;
        let v5 = CancelWithdraw{
        ...
        0x2::event::emit<CancelWithdraw>(v5);
    }
    ...
    public fun default<T0, T1, T2>(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: u256, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<RewardDistributor<T0, T1>>(new<T0, T1, T2>(arg0, arg1, arg2, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::from_scaled_val(arg3), arg4));
    }
    ...
    fun err_cannot_execute_withdraw() {
        abort 8
    }
    ...
    fun err_invalid_receiving_coin_type() {
        abort 7
    }
    ...
    fun err_receiving_fund_not_enough() {
        abort 9
    }
    ...
    public fun execute_withdraw<T0, T1, T2>(arg0: &mut RewardDistributor<T0, T1>, arg1: &0x2::clock::Clock, arg2: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, Receivable<T2>) {
        assert_valid_package_version<T0, T1>(arg0);
        assert_sender_is_manager<T0, T1>(arg0, arg2);
        if (0x1::type_name::with_defining_ids<T2>() != arg0.receiving_coin_type) {
            err_invalid_receiving_coin_type();
        };
        ...
        v4.pending_withdrawal_amount = v4.pending_withdrawal_amount - v1;
        let v5 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.stake, v1), arg4);
        let v6 = Receivable<T2>{
            recipient         : v0,
            receivable_amount : 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::floor(0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::mul_u64(arg0.receiving_rate, 0x2::coin::value<T0>(&v5))),
            receiving_fund    : 0x2::balance::zero<T2>(),
        };
        let v7 = Withdraw{
            vault_id    : id<T0, T1>(arg0),
            asset_type  : 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()),
    ...
    public fun get_stake_data<T0, T1>(arg0: &RewardDistributor<T0, T1>, arg1: address, arg2: &0x2::clock::Clock) : StakeDataDisplay {
        if (stake_exists<T0, T1>(arg0, arg1)) {
            let v1 = stake_data<T0, T1>(arg0, arg1);
            StakeDataDisplay{stake_coin_type: 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), reward_coin_type: 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()), stake_amount: v1.stake_amount, pending_withdrawal_amount: v1.pending_withdrawal_amount, claimable_reward_amount: realtime_reward_amount<T0, T1>(arg0, arg1, arg2), cumulative_reward_amount: v1.cumulative_reward_amount}
        } else {
            StakeDataDisplay{stake_coin_type: 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), reward_coin_type: 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()), stake_amount: 0, pending_withdrawal_amount: 0, claimable_reward_amount: 0, cumulative_reward_amount: 0}
        }
    }
    ...
    public fun request_withdraw<T0, T1>(arg0: &mut RewardDistributor<T0, T1>, arg1: &0x2::clock::Clock, arg2: u64, arg3: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (withdrawable_amount<T0, T1>(arg0, v1) < arg2) {
            err_withdraw_too_much();
        };
        let v2 = 0x2::clock::timestamp_ms(arg1) + delay_ms<T0, T1>(arg0);
        let v3 = stake_data_mut<T0, T1>(arg0, v1);
        v3.pending_withdrawal_amount = v3.pending_withdrawal_amount + arg2;
    ...
    public fun resolve_receivable<T0>(arg0: Receivable<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let Receivable {
            recipient         : v0,
            receivable_amount : v1,
            receiving_fund    : v2,
        } = arg0;
        let v3 = v2;
        if (0x2::balance::value<T0>(&v3) < v1) {
            err_receiving_fund_not_enough();
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v3, arg1), v0);
    }
    ...
    public fun set_receiving_coin_type<T0, T1, T2>(arg0: &mut RewardDistributor<T0, T1>, arg1: &AdminCap, arg2: 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::double::Double) {
        arg0.receiving_coin_type = 0x1::type_name::with_defining_ids<T2>();
        arg0.receiving_rate = arg2;
    }
    ...
    public fun withdrawable_amount<T0, T1>(arg0: &RewardDistributor<T0, T1>, arg1: address) : u64 {
        if (stake_exists<T0, T1>(arg0, arg1)) {
            let v1 = stake_data<T0, T1>(arg0, arg1);
            v1.stake_amount - v1.pending_withdrawal_amount
        } else {
            0
        }
    }
