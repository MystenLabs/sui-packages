module 0x6d31102733b68f5ba705644bff7f4cd856a9c26d54ff3b6928bd4adf18decf17::reward3955 {
    struct REWARD3955 has drop {
        dummy_field: bool,
    }

    struct TICKET_3955 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3955(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3955>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3955>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3955, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3955>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3955>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3955>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3955>>(v5, 0x2::tx_context::sender(arg1));
    }
