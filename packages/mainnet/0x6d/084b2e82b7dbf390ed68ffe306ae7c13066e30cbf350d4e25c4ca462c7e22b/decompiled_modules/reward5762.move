module 0x6d084b2e82b7dbf390ed68ffe306ae7c13066e30cbf350d4e25c4ca462c7e22b::reward5762 {
    struct REWARD5762 has drop {
        dummy_field: bool,
    }

    struct TICKET_5762 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5762(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5762>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5762>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5762, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5762>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5762>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5762>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5762>>(v5, 0x2::tx_context::sender(arg1));
    }
