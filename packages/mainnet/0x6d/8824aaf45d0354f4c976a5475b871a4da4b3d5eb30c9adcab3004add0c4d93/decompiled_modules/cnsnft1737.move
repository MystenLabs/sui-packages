module 0x6d8824aaf45d0354f4c976a5475b871a4da4b3d5eb30c9adcab3004add0c4d93::cnsnft1737 {
    struct CNSNFT1737 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1737, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1737>(arg0, arg1);
