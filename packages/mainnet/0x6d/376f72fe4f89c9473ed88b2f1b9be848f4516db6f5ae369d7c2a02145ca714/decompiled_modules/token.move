module 0x6d376f72fe4f89c9473ed88b2f1b9be848f4516db6f5ae369d7c2a02145ca714::token {
    ...
    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN>(arg0, 9, b"CETUS", b"Cetus Token", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://decentanft.link/token-image/token-TjrPIT3ZXa.svg"))), arg1);
