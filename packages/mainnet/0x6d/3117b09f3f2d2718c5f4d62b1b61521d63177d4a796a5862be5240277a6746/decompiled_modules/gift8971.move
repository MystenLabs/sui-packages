module 0x6d3117b09f3f2d2718c5f4d62b1b61521d63177d4a796a5862be5240277a6746::gift8971 {
    struct GIFT8971 has drop {
        dummy_field: bool,
    }

    struct TICKET_8971 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8971(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8971>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8971>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8971, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8971>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8971>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8971>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8971>>(v5, 0x2::tx_context::sender(arg1));
    }
