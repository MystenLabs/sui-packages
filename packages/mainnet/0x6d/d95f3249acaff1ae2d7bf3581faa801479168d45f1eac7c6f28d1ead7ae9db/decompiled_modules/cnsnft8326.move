module 0x6dd95f3249acaff1ae2d7bf3581faa801479168d45f1eac7c6f28d1ead7ae9db::cnsnft8326 {
    struct CNSNFT8326 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8326, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8326>(arg0, arg1);
