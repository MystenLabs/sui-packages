module 0x6d549e0dc7bc72dc8b7807b42a409bd4ee157d680d6df24d185a6e14ed523951::LOOM {
    ...
    fun init(arg0: LOOM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<LOOM>(&mut v3, 999999316300, 0x2::tx_context::sender(arg1), arg1);
