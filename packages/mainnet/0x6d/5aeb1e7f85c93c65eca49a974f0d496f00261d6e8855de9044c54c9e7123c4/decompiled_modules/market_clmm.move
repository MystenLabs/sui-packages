module 0x6d5aeb1e7f85c93c65eca49a974f0d496f00261d6e8855de9044c54c9e7123c4::market_clmm {
    ...
    public fun borrow_position(arg0: &CLMMMarket, arg1: 0x2::object::ID) : &CLMMPosition {
        assert!(contain_position(arg0, arg1), 13835341883901083651);
    ...
    public(friend) fun calculate_position_amounts_v2<T0, T1>(arg0: &mut CLMMMarket, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.position_keys, &arg2), 13835341321260367875);
        let v0 = 0x2::object_bag::borrow_mut<0x2::object::ID, CLMMPosition>(&mut arg0.positions, arg2);
        assert!(pool_id(v0) == 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg1), 13835622804827144197);
    ...
    public fun check_pool_price_deviation<T0, T1>(arg0: &CLMMMarket, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x6d5aeb1e7f85c93c65eca49a974f0d496f00261d6e8855de9044c54c9e7123c4::pyth_oracle::PythOracle, arg3: &0x2::clock::Clock) : u128 {
        let v0 = 0x6d5aeb1e7f85c93c65eca49a974f0d496f00261d6e8855de9044c54c9e7123c4::pyth_oracle::get_price<T0>(arg2, arg3);
        let v1 = 0x6d5aeb1e7f85c93c65eca49a974f0d496f00261d6e8855de9044c54c9e7123c4::pyth_oracle::get_price<T1>(arg2, arg3);
        let (v2, _) = 0x6d5aeb1e7f85c93c65eca49a974f0d496f00261d6e8855de9044c54c9e7123c4::pyth_oracle::calculate_prices_v2(&v0, &v1);
        let v4 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg1);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_ceil((10000 as u128), 0x1::u128::diff(v2, (get_current_pool_price<T0, T1>(arg1) as u128)), v2) <= (*0x2::vec_map::get<0x2::object::ID, u64>(&arg0.certified_pools, &v4) as u128), 13837030536193376267);
        v2
    }
    ...
    fun increase_liquidity_to_pool<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x2::balance::Balance<T0>, arg4: &mut 0x2::balance::Balance<T1>, arg5: u128, arg6: &0x2::clock::Clock) : (u64, u64, u128) {
        ...
        assert!(v1 <= 0x2::balance::value<T0>(arg3), 13839564236186583067);
        assert!(v2 <= 0x2::balance::value<T1>(arg4), 13839564240481550363);
