module 0x6d5be44b9d383ba1d127e0f61e3c46ad9f22ded2620fb9bdbd47489749a8dd3e::mongs {
    ...
    fun init(arg0: MONGS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MONGS>(arg0, 6, b"MS", b"https://t.me/MongSUI", b"https://t.me/MongSUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/h0omlTj.jpg"))), arg1);
        let v2 = v0;
