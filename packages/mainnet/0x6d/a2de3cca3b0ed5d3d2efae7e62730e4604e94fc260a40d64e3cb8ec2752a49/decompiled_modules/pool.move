module 0x6da2de3cca3b0ed5d3d2efae7e62730e4604e94fc260a40d64e3cb8ec2752a49::pool {
    ...
    public(friend) fun assert_pool_version<T0, T1>(arg0: &PoolState<T0, T1>) {
        assert!(arg0.version == 0x6da2de3cca3b0ed5d3d2efae7e62730e4604e94fc260a40d64e3cb8ec2752a49::version::get_program_version(), 8);
    }
    ...
    public(friend) fun claim_assets<T0, T1>(arg0: &mut PoolState<T0, T1>, arg1: 0x2::coin::Coin<BasePoolLiquidityCoin<T0, T1>>, arg2: 0x2::coin::Coin<QuotePoolLiquidityCoin<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v4 = if (v0 > 0 && v2 > 0) {
            0x6da2de3cca3b0ed5d3d2efae7e62730e4604e94fc260a40d64e3cb8ec2752a49::safe_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg0.base_coin), v0, v2)
        } else {
            0
        };
        let v5 = if (v1 > 0 && v3 > 0) {
            0x6da2de3cca3b0ed5d3d2efae7e62730e4604e94fc260a40d64e3cb8ec2752a49::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg0.quote_coin), v1, v3)
        } else {
            0
        };
    ...
    public(friend) fun create_pool_and_regime<T0, T1>(arg0: address, arg1: u8, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) : (PoolState<T0, T1>, RegimeState) {
        ...
        let v9 = PoolState<T0, T1>{
            id                            : 0x2::object::new(arg3),
            version                       : 0x6da2de3cca3b0ed5d3d2efae7e62730e4604e94fc260a40d64e3cb8ec2752a49::version::get_program_version(),
            maintainer                    : arg0,
    ...
    public(friend) fun migrate_pool_version<T0, T1>(arg0: &mut PoolState<T0, T1>) {
        arg0.version = 0x6da2de3cca3b0ed5d3d2efae7e62730e4604e94fc260a40d64e3cb8ec2752a49::version::get_program_version();
    }
