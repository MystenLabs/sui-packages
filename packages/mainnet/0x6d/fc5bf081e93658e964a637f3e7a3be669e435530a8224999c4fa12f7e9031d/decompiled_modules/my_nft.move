module 0x6dfc5bf081e93658e964a637f3e7a3be669e435530a8224999c4fa12f7e9031d::my_nft {
    ...
    fun init(arg0: MY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = MYNFT{
            ...
            name      : 0x1::string::utf8(b"Banksy-w"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/197375449?v=4"),
        };
