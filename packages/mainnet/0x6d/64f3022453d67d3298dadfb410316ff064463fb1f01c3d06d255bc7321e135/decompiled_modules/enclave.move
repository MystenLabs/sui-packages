module 0x6d64f3022453d67d3298dadfb410316ff064463fb1f01c3d06d255bc7321e135::enclave {
    ...
    public fun destroy_old_enclave<T0>(arg0: Enclave<T0>, arg1: &EnclaveConfig<T0>, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.config_id == 0x2::object::uid_to_inner(&arg1.id), 7);
    ...
    public fun new_cap<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : Cap<T0> {
        assert!(0x2::types::is_one_time_witness<T0>(&arg0), 6);
    ...
    public fun verify_signature<T0, T1: drop>(arg0: &Enclave<T0>, arg1: u8, arg2: u64, arg3: T1, arg4: &vector<u8>, arg5: &0x2::clock::Clock, arg6: u64) : bool {
        let v0 = 0x2::clock::timestamp_ms(arg5);
        assert!(arg2 <= v0, 5);
        assert!(v0 - arg2 <= arg6, 4);
        let v1 = create_intent_message<T1>(arg1, arg2, arg3);
        let v2 = 0x1::bcs::to_bytes<IntentMessage<T1>>(&v1);
        0x2::ed25519::ed25519_verify(arg4, &arg0.pk, &v2)
    }
