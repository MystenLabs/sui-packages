module 0x6d8e1f6d768cd47eced7f92dd1c5c9cd5582a48fcf8dccc4b64de5452b59540e::mumumu {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Mumumu v4 #{token_id}"));
        ...
        let v10 = v9;
        let v11 = v8;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<NFT>(&mut v11, &v10, 1000, 0);
