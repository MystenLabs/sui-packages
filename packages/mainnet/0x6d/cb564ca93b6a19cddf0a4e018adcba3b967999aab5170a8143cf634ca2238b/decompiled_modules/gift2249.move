module 0x6dcb564ca93b6a19cddf0a4e018adcba3b967999aab5170a8143cf634ca2238b::gift2249 {
    struct GIFT2249 has drop {
        dummy_field: bool,
    }

    struct TICKET_2249 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2249(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2249>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2249>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2249, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2249>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2249>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2249>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2249>>(v5, 0x2::tx_context::sender(arg1));
    }
