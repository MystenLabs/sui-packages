module 0x6de816032e1285e88cd87e2ddfcd9d6964fd0eb3e81e6e4f374a987bc6a24c61::vesta_drop {
    ...
    public fun claim<T0>(arg0: &mut VestaDrop<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 >= arg0.start_time, 6);
        assert!(0x2::table::contains<address, AirdropInfo>(&arg0.claims, 0x2::tx_context::sender(arg2)), 2);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.drop_fund, v1), arg2), 0x2::tx_context::sender(arg2));
    }
