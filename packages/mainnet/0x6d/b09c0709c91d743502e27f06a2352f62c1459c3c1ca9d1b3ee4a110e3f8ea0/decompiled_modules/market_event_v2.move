module 0xb88f9149c55d6314b7ae436a730cfbf3a5d53522f37e2d56288531bb8adc7071::market_event_v2 {
    ...
    struct TradeInfoEvent has copy, drop {
        tick: 0x1::ascii::String,
        burn_ratio: u64,
        community_ratio: u64,
        lock_ratio: u64,
    ...
    public(friend) fun trade_detail_event(arg0: 0x1::ascii::String, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        let v0 = TradeInfoEvent{
            tick             : arg0,
            burn_ratio       : arg1,
            community_ratio  : arg2,
            lock_ratio       : arg3,
            timestamp        : arg4,
            yesterday_volume : arg5,
            today_volume     : arg6,
            total_volume     : arg7,
        };
        0x2::event::emit<TradeInfoEvent>(v0);
    }
