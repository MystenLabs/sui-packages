module 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::ACL,
        package_version: u64,
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        ...
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::Member> {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun check_validator_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::has_role(&arg0.acl, arg1, 1), 2);
    }

    public fun check_validator_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::has_role(&arg0.acl, arg1, 2), 3);
    }
    ...
    public fun collect_protocol_fee<T0>(arg0: &mut GlobalConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 3), 4);
    ...
    public fun has_validator_role(arg0: &GlobalConfig, arg1: address) : bool {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::has_role(&arg0.acl, arg1, 2)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            id                  : 0x2::object::new(arg0),
            acl                 : 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::acl::new(arg0),
            package_version     : 1,
            allow_quotes        : 0x2::vec_map::empty<0x1::type_name::TypeName, u64>(),
            protocol_fees       : 0x2::bag::new(arg0),
            inscription_account : 0xcb5bd7a29f458a1b1e0221516fbfaeb182be027033eb8dcb4f33dd540d20bb87::config::create_account(arg0),
            confirmed_limit     : 1,
    ...
    public(friend) fun transfer_from_vault(arg0: &GlobalConfig, arg1: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::Inscription, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::transfer_from(&arg0.inscription_account, arg1, arg2, arg3)
    }

    public(friend) fun transfer_to_vault(arg0: &GlobalConfig, arg1: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::Inscription, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::transfer(&arg0.inscription_account, arg1, arg2)
    }
