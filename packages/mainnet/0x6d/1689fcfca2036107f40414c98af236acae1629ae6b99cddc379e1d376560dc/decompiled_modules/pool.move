module 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::pool {
    struct Order<phantom T0> has store, key {
        id: 0x2::object::UID,
        collection_id: 0x2::object::ID,
        seller: address,
        buyer: address,
        inscription: 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::Inscription,
        price: u128,
        status: u8,
    ...
    public fun buy<T0>(arg0: &mut 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &mut UserIndexer, arg2: &mut Collection<T0>, arg3: &mut Order<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::checked_package_version(arg0);
        if (arg3.status != 1) {
            abort 2
        };
        ...
        let v0 = 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::get_amt(&arg3.inscription);
        ...
        let v2 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_ceil(v1, 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::get_protocol_fee_rate<T0>(arg0), 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::protocol_fee_denom());
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::receive_protocol_fee<T0>(arg0, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg4, v2, arg6)));
        ...
        let v3 = OrderDealEvent{
            ...
            withdraw_id   : 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::transfer_from_vault(arg0, &arg3.inscription, arg3.buyer, arg6),
            protocol_fee  : v2,
    ...
    public fun cancel_order_by_seller<T0>(arg0: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &mut Collection<T0>, arg2: &mut Order<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::checked_package_version(arg0);
        if (arg2.status != 1) {
            abort 2
        };
        ...
        let v0 = OrderCanceledBySellerEvent{
            ...
            withdraw_id   : 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::transfer_from_vault(arg0, &arg2.inscription, arg2.seller, arg4),
    ...
    public fun cancel_order_by_validator<T0>(arg0: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &mut Collection<T0>, arg2: &mut Order<T0>, arg3: vector<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::checked_package_version(arg0);
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::check_validator_role(arg0, 0x2::tx_context::sender(arg5));
        if (arg2.status != 0) {
            abort 9
        };
        if (arg2.collection_id != 0x2::object::id<Collection<T0>>(arg1)) {
        ...
        if (!0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::validator::verify(arg0, v0, arg3)) {
            abort 7
        };
        arg2.status = 3;
    ...
    public fun confirm_order<T0>(arg0: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &mut Order<T0>, arg2: &mut Collection<T0>, arg3: vector<0x1::string::String>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::checked_package_version(arg0);
        if (arg1.status != 0) {
            return
        };
        ...
        arg2.in_sales_amount = arg2.in_sales_amount + 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::get_amt(&arg1.inscription);
        ...
        if (!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, u64>(v2, v1)) {
            0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::push_back<0x2::object::ID, u64>(v2, v1, 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::get_amt(&arg1.inscription));
        };
    ...
    fun create_collection_internal<T0>(arg0: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &0xcb5bd7a29f458a1b1e0221516fbfaeb182be027033eb8dcb4f33dd540d20bb87::config::GlobalConfig, arg2: &mut Collections, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Collection<T0> {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::checked_quote_coin<T0>(arg0);
        assert!(0xcb5bd7a29f458a1b1e0221516fbfaeb182be027033eb8dcb4f33dd540d20bb87::config::contains_tick(arg1, 0xcb5bd7a29f458a1b1e0221516fbfaeb182be027033eb8dcb4f33dd540d20bb87::config::tick_key(arg3, arg4)), 8);
    ...
    fun create_order_internal<T0>(arg0: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &mut Collection<T0>, arg2: &mut UserIndexer, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg7: u128, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : (0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::Inscription, Order<T0>) {
        let v0 = 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::new(arg3, arg4, arg5, arg6);
        ...
        let v2 = Order<T0>{
            ...
            price         : arg7,
            status        : 0,
            deposit_id    : 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::transfer_to_vault(arg0, &v0, arg10),
        ...
        if (get_collection_key<T0>(0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::get_p(&v2.inscription), 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::get_tick(&v2.inscription)) != get_collection_key<T0>(arg1.p, arg1.tick)) {
            abort 1
        };
    ...
    public fun delete_order_by_validator<T0>(arg0: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &mut Collection<T0>, arg2: &mut UserIndexer, arg3: Order<T0>, arg4: vector<0x1::string::String>, arg5: &0x2::clock::Clock) {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::checked_package_version(arg0);
        ...
        if (!0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::validator::verify(arg0, v0, arg4)) {
            abort 7
        };
        let v1 = if (arg3.status == 2 || arg3.status == 3) {
            arg3.canceled_ts + 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::get_delete_grace(arg0)
        } else {
            arg3.sold_ts + 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::get_delete_grace(arg0)
        };
    ...
    public fun list_order<T0>(arg0: &0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::GlobalConfig, arg1: &mut Collection<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u64, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: u128, arg8: u64, arg9: &mut UserIndexer, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::config::checked_package_version(arg0);
    ...
    fun remove_from_collection<T0>(arg0: &mut Collection<T0>, arg1: &Order<T0>) {
        ...
        if ((arg1.status == 2 || arg1.status == 4) && arg0.in_sales_amount >= 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::get_amt(&arg1.inscription)) {
            arg0.in_sales_amount = arg0.in_sales_amount - 0x6d1689fcfca2036107f40414c98af236acae1629ae6b99cddc379e1d376560dc::inscription::get_amt(&arg1.inscription);
        };
