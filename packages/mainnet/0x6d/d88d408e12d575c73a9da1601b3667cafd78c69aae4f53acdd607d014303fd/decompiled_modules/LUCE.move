module 0x6dd88d408e12d575c73a9da1601b3667cafd78c69aae4f53acdd607d014303fd::LUCE {
    struct LUCE has drop {
        dummy_field: bool,
    }

    fun init(arg0: LUCE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<LUCE>(arg0, 2, b"LUCE", b"LUCE", b"LUCE", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/V5fzUYaXeD502PsR5gcZIGt6_f9_c14-jIzcjgxZf-0?ext=png")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<LUCE>>(v2);
        0x2::transfer::public_transfer<0x2::coin::DenyCap<LUCE>>(v1, @0x8bcc0e6cadf05f36018b1dff59d669b358a5aad6e5d05ad00bda60873cf0cb5c);
        let v3 = v0;
