module 0x6d9340fdc88ceff4fdce3acf8f0425060a2e00566098481750078248682743a0::suilend_adapter {
    ...
    public fun withdraw_with_delevering<T0, T1: drop>(arg0: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg1: u64, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        while (v3 < arg5 && v1 < 10) {
            ...
            if (v4 == 0) {
                let v5 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::ceil(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::mul(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::div(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(arg5 - v3), 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::price<T0>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserve<T0, T1>(arg0))), 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::price<T0>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserve<T0, 0x2::sui::SUI>(arg0))));
                let v6 = withdraw_liquidity_from_suilend<T0, T1>(arg0, arg2, arg4, arg3, v5, arg7, arg9);
                let v7 = 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::redeem<T1>(arg6, v6, arg7, arg9);
                0x2::coin::join<0x2::sui::SUI>(&mut v2, v7);
                break
            };
            let v8 = calculate_safe_withdraw_amount<T0, T1>(arg0, arg3, arg2, arg4);
            if (v8 < 10000) {
                break
            };
            if (!check_health_factor_safe<T0>(arg0, arg3, arg4)) {
            ...
            let v9 = withdraw_liquidity_from_suilend<T0, T1>(arg0, arg2, arg4, arg3, v8, arg7, arg9);
            let v10 = 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::redeem<T1>(arg6, v9, arg7, arg9);
            v3 = v3 + 0x2::coin::value<0x2::sui::SUI>(&v10);
            if (v4 > 0) {
                let v11 = &mut v10;
                repay_borrow<T0, 0x2::sui::SUI>(arg0, arg1, arg3, arg4, v11, arg9);
            };
            0x2::coin::join<0x2::sui::SUI>(&mut v2, v10);
            v1 = v1 + 1;
        };
        v2
    }
