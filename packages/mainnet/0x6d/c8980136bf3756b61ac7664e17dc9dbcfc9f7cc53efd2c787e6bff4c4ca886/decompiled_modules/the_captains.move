module 0x6dc8980136bf3756b61ac7664e17dc9dbcfc9f7cc53efd2c787e6bff4c4ca886::the_captains {
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<PfpNFT>>(v15, @0x495ce5fc99f68d2c8179618e0c4eda72df13efc4c04a6308ba5dc4b2b6ab6597);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v8, @0x495ce5fc99f68d2c8179618e0c4eda72df13efc4c04a6308ba5dc4b2b6ab6597);
        0x2::transfer::public_transfer<0x2::display::Display<PfpNFT>>(v13, @0x495ce5fc99f68d2c8179618e0c4eda72df13efc4c04a6308ba5dc4b2b6ab6597);
    }
    ...
    fun mint_core(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut Counter, arg12: &MintConfig, arg13: &mut MintStats, arg14: &Payout, arg15: 0x2::coin::Coin<0x2::sui::SUI>, arg16: &0x2::transfer_policy::TransferPolicy<PfpNFT>, arg17: &mut 0x2::kiosk::Kiosk, arg18: &0x2::kiosk::KioskOwnerCap, arg19: &0x2::clock::Clock, arg20: &mut 0x2::tx_context::TxContext) {
        ...
        while (v7 < arg3) {
            ...
            let v10 = 0x1::string::utf8(b"https://sui-api.talentum.id/api/the-captains/nft/image/production/");
