module 0x6dc21506e8215862dffb6e72bdd1dab61c045d5b4226dadf86579b321aaada34::SFRENS {
    ...
    fun init(arg0: SFRENS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SFRENS>(&mut v2, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
