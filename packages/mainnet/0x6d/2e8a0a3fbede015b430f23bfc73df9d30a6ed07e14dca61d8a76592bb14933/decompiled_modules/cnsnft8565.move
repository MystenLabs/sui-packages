module 0x6d2e8a0a3fbede015b430f23bfc73df9d30a6ed07e14dca61d8a76592bb14933::cnsnft8565 {
    struct CNSNFT8565 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8565, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3417"));
        let v4 = 0x2::package::claim<CNSNFT8565>(arg0, arg1);
