module 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::library::base_div(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun mul_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::library::base_mul(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun one() : Number {
        Number{
            value : 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::library::base_uint(),
            sign  : true,
        }
    }
