module 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::roles {
    ...
    struct CapabilitiesSafe has key {
        ...
        priceOracleOperator: 0x2::object::ID,
    ...
    public fun check_delevearging_operator_validity(arg0: &CapabilitiesSafe, arg1: &DeleveragingCap) {
        assert!(arg0.deleveraging == 0x2::object::uid_to_inner(&arg1.id), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::invalid_deleveraging_operator());
    }

    public fun check_funding_rate_operator_validity(arg0: &CapabilitiesSafe, arg1: &FundingRateCap) {
        assert!(arg0.fundingRateOperator == 0x2::object::uid_to_inner(&arg1.id), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::invalid_funding_rate_operator());
    }

    public fun check_guardian_validity(arg0: &CapabilitiesSafe, arg1: &ExchangeGuardianCap) {
        assert!(arg0.guardian == 0x2::object::uid_to_inner(&arg1.id), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::invalid_guardian());
    }

    public fun check_price_oracle_operator_validity(arg0: &CapabilitiesSafe, arg1: &PriceOracleOperatorCap) {
        assert!(arg0.priceOracleOperator == 0x2::object::uid_to_inner(&arg1.id), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::invalid_price_oracle_operator());
    }

    public fun check_public_settlement_cap_validity(arg0: &CapabilitiesSafe, arg1: &SettlementCap) {
        assert!(arg0.publicSettlementCap == 0x2::object::uid_to_inner(&arg1.id), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::not_a_public_settlement_cap());
    }
    ...
    public fun check_settlement_operator_validity(arg0: &CapabilitiesSafe, arg1: &SettlementCap) {
        ...
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.settlementOperators, &v0), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::invalid_settlement_operator());
    }
    ...
    fun create_price_oracle_operator(arg0: address, arg1: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x2::object::new(arg1);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = PriceOracleOperatorCap{id: v0};
        0x2::transfer::transfer<PriceOracleOperatorCap>(v2, arg0);
        let v3 = PriceOracleOperatorUpdate{
            id      : v1,
            account : arg0,
        };
        0x2::event::emit<PriceOracleOperatorUpdate>(v3);
        v1
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = create_price_oracle_operator(v2, arg0);
        let v4 = 0x2::tx_context::sender(arg0);
        let v5 = create_deleveraging_operator(v4, arg0);
        let v6 = 0x2::tx_context::sender(arg0);
        let v7 = create_funding_rate_operator(v6, arg0);
        let v8 = 0x2::object::new(arg0);
        let v9 = SettlementCap{id: v8};
        0x2::transfer::share_object<SettlementCap>(v9);
        let v10 = CapabilitiesSafe{
            id                  : 0x2::object::new(arg0),
            guardian            : v1,
            priceOracleOperator : v3,
            deleveraging        : v5,
            fundingRateOperator : v7,
            publicSettlementCap : 0x2::object::uid_to_inner(&v8),
            settlementOperators : 0x2::vec_set::empty<0x2::object::ID>(),
        };
        0x2::transfer::share_object<CapabilitiesSafe>(v10);
        let v11 = SubAccounts{
            id  : 0x2::object::new(arg0),
            map : 0x2::table::new<address, 0x2::vec_set::VecSet<address>>(arg0),
        };
        0x2::transfer::share_object<SubAccounts>(v11);
    }
    ...
    entry fun remove_settlement_operator(arg0: &ExchangeAdminCap, arg1: &mut CapabilitiesSafe, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg1.settlementOperators, &arg2), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::operator_already_removed());
    ...
    entry fun set_exchange_admin(arg0: ExchangeAdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 != 0x2::tx_context::sender(arg2), 0x6daf6e084de79fde6ff50856b0470c2003552570a92b35cffed3dbe82744ffe4::error::new_address_can_not_be_same_as_current_one());
    ...
    public entry fun set_price_oracle_operator(arg0: &ExchangeAdminCap, arg1: &mut CapabilitiesSafe, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.priceOracleOperator = create_price_oracle_operator(arg2, arg3);
    }
