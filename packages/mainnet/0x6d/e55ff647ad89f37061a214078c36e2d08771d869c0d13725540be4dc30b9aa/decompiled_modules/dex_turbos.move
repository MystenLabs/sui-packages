module 0x6de55ff647ad89f37061a214078c36e2d08771d869c0d13725540be4dc30b9aa::dex_turbos {
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0 > 0, 0x6de55ff647ad89f37061a214078c36e2d08771d869c0d13725540be4dc30b9aa::constants::get_zero_amount_error());
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0x6de55ff647ad89f37061a214078c36e2d08771d869c0d13725540be4dc30b9aa::constants::get_turbos_sui_usdc_pool(),
        };
        0x2::event::emit<SwapExecuted>(v1);
        abort 0x6de55ff647ad89f37061a214078c36e2d08771d869c0d13725540be4dc30b9aa::constants::get_zero_amount_error()
    }
