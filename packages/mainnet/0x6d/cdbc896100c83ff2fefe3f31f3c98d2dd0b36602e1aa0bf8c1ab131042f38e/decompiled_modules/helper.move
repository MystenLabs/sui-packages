module 0x6dcdbc896100c83ff2fefe3f31f3c98d2dd0b36602e1aa0bf8c1ab131042f38e::helper {
    public fun calculate_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        let v4 = if (v2 == 0) {
            (0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::math::mul_div_u256((arg2 as u256), (0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::math::mul_to_u128(get_sui_amount(&v3), 1) as u256), (0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::math::mul_to_u128(1, get_token_amount(&v3)) as u256)) as u64)
        } else {
            (0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::math::mul_div_u256((arg2 as u256), (0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::math::mul_to_u128(get_sui_amount(&v3), get_token_amount(&v1)) as u256), (0x145cc4aff56ac7f3aa994bc8aee09e3e5fbdb3b3a138c5fc51ef79861865e2cf::math::mul_to_u128(v2, get_token_amount(&v3)) as u256)) as u64)
        };
        v4 - arg2
    }
