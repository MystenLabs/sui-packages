module 0x6dc234e9a85395da22e63aaa15ea9f1e14ae039a1ce5dfca30f1189558c7419e::newapp {
    ...
    fun clac_level_diff(arg0: &mut Global_NetworkStatistics, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            ...
            if (v4.level > v2) {
                let v5 = arg3 * (get_reward_percentage(v4.level) - 0) / 100;
                if (v4.underway_power > 0) {
                    v4.balance = v4.balance + v5;
                    v4.total_revenue = v4.total_revenue + v5;
                    v4.daily_static_revenue = v4.daily_static_revenue + v5;
                    handler_out(arg0, v4);
                };
                v2 = v4.level;
                v3 = v4.inviter;
        ...
        if (0x1::option::is_some<address>(&v0) && 0x1::option::is_some<address>(&v3)) {
            let v6 = 0x2::table::borrow_mut<address, User>(arg1, 0x1::option::extract<address>(&mut v3));
            let v7 = arg3 * 2 / 100;
            if (v6.underway_power > 0) {
                v6.balance = v6.balance + v7;
                v6.total_revenue = v6.total_revenue + v7;
                v6.daily_static_revenue = v6.daily_static_revenue + v7;
                handler_out(arg0, v6);
            };
        };
    }
