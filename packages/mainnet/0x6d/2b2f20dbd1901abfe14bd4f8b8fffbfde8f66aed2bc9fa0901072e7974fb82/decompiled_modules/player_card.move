module 0x7292baf0cfa84626d31e44b71673b9ad591597b5dee108e8e7bd7577a376d2a2::player_card {
    ...
    struct CardStatsCreated has copy, drop {
        card_id: 0x2::object::ID,
    ...
    public fun admin_freeze_card(arg0: &AdminCap, arg1: &mut CardStats) {
        assert!(arg1.is_alive, 2);
        arg1.is_alive = false;
        let v0 = CardFrozen{card_id: arg1.card_id};
        0x2::event::emit<CardFrozen>(v0);
    }

    public fun admin_set_current_value(arg0: &AdminCap, arg1: &mut CardStats, arg2: u64) {
        arg1.current_value = arg2;
    }

    public fun admin_update_stats(arg0: &AdminCap, arg1: &mut CardStats, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8) {
    ...
    public entry fun burn(arg0: PlayerCard) {
        let PlayerCard {
            id            : v0,
            player_id     : _,
            name          : _,
    ...
    public fun calculate_score(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : u64 {
        let v0 = arg0 * 10 + arg1 * 5 + arg3 * 3;
        let v1 = arg2 * 2 + arg5 * 2 + arg4 * 2;
        if (v0 > v1) {
            v0 - v1
        } else {
            0
    ...
    public fun create_card_stats(arg0: &AdminCap, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        create_card_stats_internal(arg1, arg2, arg3);
    }

    public(friend) fun create_card_stats_internal(arg0: 0x2::object::ID, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = CardStats{
        ...
        let v1 = CardStatsCreated{
            card_id  : arg0,
            stats_id : 0x2::object::id<CardStats>(&v0),
        };
        0x2::event::emit<CardStatsCreated>(v1);
        0x2::transfer::share_object<CardStats>(v0);
    }
    ...
    public fun render_svg(arg0: &PlayerCard) : 0x1::string::String {
        let v0 = if (arg0.rarity == 4) {
            b"#FFD700"
        } else if (arg0.rarity == 3) {
            b"#9B59B6"
    ...
    public fun set_image_url(arg0: &AdminCap, arg1: &mut PlayerCard, arg2: 0x1::string::String) {
        arg1.image_url = arg2;
    }
    ...
    public fun stats_card_id(arg0: &CardStats) : 0x2::object::ID {
        arg0.card_id
    }

    public fun stats_is_alive(arg0: &CardStats) : bool {
        arg0.is_alive
    }

    public fun stats_rarity(arg0: &CardStats) : u8 {
        arg0.rarity
    }

    public fun stats_score(arg0: &CardStats) : u64 {
        arg0.score
    }
