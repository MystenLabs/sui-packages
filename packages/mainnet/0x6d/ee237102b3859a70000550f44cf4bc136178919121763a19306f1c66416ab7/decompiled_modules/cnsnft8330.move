module 0x6dee237102b3859a70000550f44cf4bc136178919121763a19306f1c66416ab7::cnsnft8330 {
    struct CNSNFT8330 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8330, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8330>(arg0, arg1);
