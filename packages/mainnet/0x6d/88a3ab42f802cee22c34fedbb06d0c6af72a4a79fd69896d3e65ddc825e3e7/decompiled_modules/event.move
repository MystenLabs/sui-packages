module 0x6d88a3ab42f802cee22c34fedbb06d0c6af72a4a79fd69896d3e65ddc825e3e7::event {
    ...
    public(friend) fun emit_burn_your_stable_event<T0>(arg0: 0x2::object::ID, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        let v0 = BurnYourStable<T0>{
            ...
            burned_amount              : arg2,
            discharged_buck            : arg3,
            burned_st_sbuck_amount     : arg4,
            factory_supply             : arg5,
    ...
    public(friend) fun emit_create_queue_ticket_event<T0>(arg0: 0x1::type_name::TypeName, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
