module 0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::dca {
    ...
    struct DCAReg has key {
        ...
        fee_rate: u64,
        total_escrows: 0x2::vec_set::VecSet<0x2::object::ID>,
    ...
    fun add_new_escrow_to_owner(arg0: &mut DCAReg, arg1: address, arg2: 0x2::object::ID) {
        0x2::vec_set::insert<0x2::object::ID>(&mut arg0.total_escrows, arg2);
    ...
    public(friend) fun apply_fee<T0>(arg0: &mut DCAReg, arg1: &mut 0x2::coin::Coin<T0>) {
        ...
        0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::event::charge_fee<T0>(v0);
    }
    ...
    public entry fun claim_fee<T0>(arg0: &mut DCAReg, arg1: &DCACap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::event::claim_fee<T0>(0x2::tx_context::sender(arg3), arg2);
    }
    ...
    public fun close_escrow<T0, T1>(arg0: &mut DCAReg, arg1: Escrow<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v21 = 0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut v19), arg2);
        let v22 = 0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut v18), arg2);
        0x2::balance::destroy_zero<T0>(v19);
        0x2::balance::destroy_zero<T1>(v18);
        0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::event::order_closed<T0, T1>(0x2::object::uid_to_inner(&v20), v1, 0x2::coin::value<T0>(&v21), 0x2::coin::value<T1>(&v22));
        (v21, v22)
    }
    ...
    public fun deposit_escrow<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::coin::value<T0>(&arg1) >= arg0.divided_amount, 115);
        let v0 = 0x2::coin::value<T0>(&arg1) / arg0.divided_amount;
        0x2::coin::put<T0>(&mut arg0.balance_x, 0x2::coin::split<T0>(&mut arg1, v0 * arg0.divided_amount, arg2));
        arg0.end_time = arg0.end_time + v0 * arg0.frequency;
        arg1
    }
    ...
    public fun execute_order<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, SwapReceipt<T0, T1>) {
        let v0 = get_current_epoch<T0, T1>(arg0, arg2);
        assert!(arg0.last_claimed == 0 || get_last_claimed_epoch<T0, T1>(arg0) <= v0, 104);
        assert!(arg0.filled_orders < total_orders<T0, T1>(arg0), 110);
        assert!(balance_x_value<T0, T1>(arg0) > 0, 112);
        assert!(0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::utils::get_sec(arg2) <= v0 * arg0.frequency + arg0.deposit_time + 30, 114);
        roll_epoch<T0, T1>(arg0, arg2);
        let (v1, v2) = get_escrow_required_amount<T0, T1>(arg0, arg1, arg2);
        let v3 = SwapReceipt<T0, T1>{
            escrow_id : 0x2::object::id<Escrow<T0, T1>>(arg0),
            ts        : 0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::utils::get_sec(arg2),
            spent     : v1,
            amount    : v2,
        };
        (0x2::coin::take<T0>(&mut arg0.balance_x, v1, arg3), v3)
    }
    ...
    public fun finalize_new_escrow<T0, T1>(arg0: &mut DCAReg, arg1: Escrow<T0, T1>, arg2: SwapReceipt<T0, T1>, arg3: 0x2::coin::Coin<T1>) {
        let v0 = &mut arg1;
    ...
    public fun get_current_epoch<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        get_epoch<T0, T1>(arg0, 0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::utils::get_sec(arg1))
    }
    ...
    public fun get_escrow_required_amount<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : (u64, u64) {
        let v0 = if (arg0.price_enabled) {
            ...
            0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::utils::mul_div(get_output_y<T0, T1>(arg0, arg1, arg0.divided_amount, arg2), 10000 - 50, 10000)
        };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = DCAReg{
            ...
            fee_rate      : 10,
            total_escrows : 0x2::vec_set::empty<0x2::object::ID>(),
    ...
    public fun new_escrow<T0, T1>(arg0: &mut DCAReg, arg1: Escrow<T0, T1>) {
        0x2::transfer::share_object<Escrow<T0, T1>>(arg1);
    }
    ...
    public fun place_order<T0, T1>(arg0: &mut DCAReg, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: u64, arg6: u64, arg7: bool, arg8: u128, arg9: u128, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : Escrow<T0, T1> {
        ...
        Escrow<T0, T1>{
            ...
            frequency              : arg5,
            divided_amount         : v1,
            last_claimed           : 0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::utils::get_sec(arg10),
            filled_orders          : 0,
            balance_x              : v2,
            ...
            min_price              : v4,
            max_price              : v5,
            deposit_time           : 0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::utils::get_sec(arg10),
            end_time               : 0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::utils::get_sec(arg10) + (arg6 - 1) * arg5,
            total_spent            : 0,
    ...
    fun remove_escrow_from_owner<T0, T1>(arg0: &mut DCAReg, arg1: &Escrow<T0, T1>) {
        ...
        0x2::vec_set::remove<0x2::object::ID>(&mut arg0.total_escrows, &v0);
    ...
    public fun repay_order<T0, T1>(arg0: &mut DCAReg, arg1: &mut Escrow<T0, T1>, arg2: SwapReceipt<T0, T1>, arg3: 0x2::coin::Coin<T1>) {
        ...
        0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::event::order_executed<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg1), arg1.owner, v1, v4, v3);
    }
    ...
    public fun total_escrows(arg0: &DCAReg) : vector<0x2::object::ID> {
        0x2::vec_set::into_keys<0x2::object::ID>(arg0.total_escrows)
    }

    public fun total_escrows_length(arg0: &DCAReg) : u64 {
        0x2::vec_set::size<0x2::object::ID>(&arg0.total_escrows)
    }
    ...
    public entry fun update_price<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: &0x2::tx_context::TxContext) {
        ...
        arg0.min_price = arg2;
        arg0.max_price = arg3;
        0x6dd39d83e8084c9bb07ade6df244f59b3970d786f825681958fc1a6f66237c3d::event::price_updated<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg0), arg0.owner, arg0.price_enabled, arg0.min_price, arg0.max_price);
    }
    ...
    public fun withdraw<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.balance_y), arg1)
    }
