module 0x6d0cf81a214839cb1e0c4d2f52d20b371c2e722a17846a919e743174ce6bbcf5::drand_based_scratch_card {
    struct Game has key {
        id: 0x2::object::UID,
        creator: address,
        reward_amount: u64,
    ...
    public entry fun evaluate(arg0: Ticket, arg1: &Game, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.game_id == 0x2::object::id<Game>(arg1), 2);
        0x6d0cf81a214839cb1e0c4d2f52d20b371c2e722a17846a919e743174ce6bbcf5::drand_lib::verify_drand_signature(arg2, arg3, end_of_game_round(arg1.base_drand_round));
        let v0 = 0x6d0cf81a214839cb1e0c4d2f52d20b371c2e722a17846a919e743174ce6bbcf5::drand_lib::derive_randomness(arg2);
        let v1 = 0x2::object::id<Ticket>(&arg0);
        let v2 = 0x2::object::id_to_bytes(&v1);
        let v3 = 0x2::hmac::hmac_sha3_256(&v0, &v2);
        if (0x6d0cf81a214839cb1e0c4d2f52d20b371c2e722a17846a919e743174ce6bbcf5::drand_lib::safe_selection(arg1.reward_factor, &v3) == 0) {
            let v4 = Winner{
                id      : 0x2::object::new(arg4),
                game_id : 0x2::object::id<Game>(arg1),
            };
            0x2::transfer::public_transfer<Winner>(v4, 0x2::tx_context::sender(arg4));
        };
        let Ticket {
            id      : v5,
            game_id : _,
