module 0xb417d12b1cfe2676a5b0c01cf6d5e12ad39d23c10c19889f1df39239cb62435d::cnsnft6680 {
    struct CNSNFT6680 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6680, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2299"));
        let v4 = 0x2::package::claim<CNSNFT6680>(arg0, arg1);
