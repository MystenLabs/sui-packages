module 0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::collection {
    ...
    public(friend) fun new(arg0: u64, arg1: 0x1::string::String, arg2: 0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::attributes::Attributes) : FusionOfTheGodsData {
        FusionOfTheGodsData{
            name       : arg0,
            url        : arg1,
            attributes : arg2,
    ...
    public fun add_kiosk_lock_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<FusionOfTheGods>, arg1: &CollectionInfo) {
        0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::kiosk_lock_rule::add<FusionOfTheGods>(arg0, &arg1.policy_cap);
    }

    public fun add_royalty_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<FusionOfTheGods>, arg1: &CollectionInfo) {
        0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::royalty_rule::add<FusionOfTheGods>(arg0, &arg1.policy_cap, 1200, 0);
    }
    ...
    public fun remove_kiosk_lock_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<FusionOfTheGods>, arg1: &CollectionInfo) {
        0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::kiosk_lock_rule::remove<FusionOfTheGods>(arg0, &arg1.policy_cap);
    }

    public fun remove_royalty_rule(arg0: &mut 0x2::transfer_policy::TransferPolicy<FusionOfTheGods>, arg1: &CollectionInfo) {
        0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::royalty_rule::remove<FusionOfTheGods>(arg0, &arg1.policy_cap);
    }

    public(friend) fun replace_attributes(arg0: &mut FusionOfTheGods, arg1: 0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::attributes::Attributes) {
        arg0.attributes = arg1;
    }

    public(friend) fun upgrade(arg0: &mut FusionOfTheGods, arg1: 0x1::string::String, arg2: 0xb47c22a2ef73d3ed84b83a90867292748c244749aa5ea90287ada040e0d5a516::attributes::Attributes) {
