module 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::alphapool {
    ...
    public fun create<T0>(arg0: &0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::alpha::Admin_cap, arg1: u64, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool<T0>{
    ...
    fun deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = exchange_rate<T0>(arg1);
        let v1 = 0x2::balance::value<T0>(&arg3);
        arg1.tokensInvested = arg1.tokensInvested + v1;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg3, 0x2::balance::value<T0>(&arg3) * arg1.deposit_fee / 100), arg5), 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::get_fee_wallet_address(arg2));
        ...
        if (0x1::option::is_some<Receipt>(&arg0) == true) {
            ...
            let v6 = &mut v5;
            unlock_locked_balance_for_user<T0>(arg1, v6, arg4);
            if (0x2::linked_table::contains<u64, u64>(&v5.locked_balance, v4) == true) {
                let v7 = 0x2::linked_table::borrow_mut<u64, u64>(&mut v5.locked_balance, v4);
                *v7 = *v7 + v3;
            } else {
                let v8 = &mut v5;
                insert_to_locked_balance(v8, v4, v3, arg5);
            };
            0x2::transfer::public_transfer<Receipt>(v5, 0x2::tx_context::sender(arg5));
        } else {
            ...
            while (v10 < 0x2::vec_map::size<0x1::type_name::TypeName, u256>(&arg1.acc_rewards_per_xtoken)) {
                ...
                0x2::vec_map::insert<0x1::type_name::TypeName, u256>(&mut v9, *v11, *v12);
                v10 = v10 + 1;
            };
            let v13 = 0x2::linked_table::new<u64, u64>(arg5);
            0x2::linked_table::push_back<u64, u64>(&mut v13, v4, v3);
            let v14 = Receipt{
                id                         : 0x2::object::new(arg5),
                pool_id                    : 0x2::object::uid_to_inner(&arg1.id),
                xTokenBalance              : (v2 as u64),
                last_acc_reward_per_xtoken : v9,
                locked_balance             : v13,
                balance                    : 0,
            };
            0x2::transfer::public_transfer<Receipt>(v14, 0x2::tx_context::sender(arg5));
        };
        0x1::option::destroy_none<Receipt>(arg0);
    }

    fun destroy_receipt_and_transfer_rewards<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0;
    ...
    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::string::index_of(&v0, &v1) < 0x1::string::length(&v0)) {
            0x2::balance::join<T0>(&mut arg0.alpha_bal, 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::get_rewards<T0>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3));
        } else {
            let v2 = 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    public fun get_user_rewards<T0, T1>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
    ...
    public fun get_user_rewards_all<T0>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_lock_period<T0>(arg0: &0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::alpha::Admin_cap, arg1: &mut Pool<T0>, arg2: u64) {
    ...
    fun unlock_locked_balance_for_user<T0>(arg0: &mut Pool<T0>, arg1: &mut Receipt, arg2: &0x2::clock::Clock) {
    ...
    public fun user_deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun user_withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        update_pool<T0>(arg1, arg4);
    ...
    fun withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = exchange_rate<T0>(arg1);
        let v1 = &mut arg0;
        assert_receipt<T0>(v1, arg1);
        let v2 = &mut arg0;
        ...
        let v3 = (arg3 as u256) * v0 / (1000000000 as u256);
        arg1.xTokenSupply = arg1.xTokenSupply - (v3 as u64);
        arg0.xTokenBalance = arg0.xTokenBalance - (v3 as u64);
        let v4 = 0;
        if (arg3 > (arg0.balance as u64) && arg5 == true) {
            let v5 = arg3 - (arg0.balance as u64);
            v4 = v5;
            arg3 = arg3 - v5;
        };
        let v6 = 0x2::balance::split<T0>(&mut arg1.alpha_bal, arg3);
        arg0.balance = arg0.balance - (arg3 as u256);
        if (v4 > 0) {
            let v7 = &mut arg0;
            unlock_xtokens_from_locked(v7, (((v4 as u256) * v0 / (1000000000 as u256)) as u64));
            0x2::balance::join<T0>(&mut v6, 0x2::balance::split<T0>(&mut arg1.alpha_bal, v4 - v4 * arg1.locked_balance_withdrawal_fee / 100));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v6, 0x2::balance::value<T0>(&v6) * arg1.withdrawal_fee / 100), arg6), 0xb4e13d9a163df387dfd5e3f09299ee30b695247467a89fe3b6e76c6a9d6b15d3::distributor::get_fee_wallet_address(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v6, arg6), 0x2::tx_context::sender(arg6));
        let v8 = if (arg3 + v4 > arg1.tokensInvested) {
            0
        } else {
            arg1.tokensInvested - arg3 - v4
        };
        arg1.tokensInvested = v8;
