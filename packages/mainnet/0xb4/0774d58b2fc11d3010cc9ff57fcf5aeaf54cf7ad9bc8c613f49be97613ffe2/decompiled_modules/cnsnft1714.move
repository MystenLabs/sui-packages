module 0xb40774d58b2fc11d3010cc9ff57fcf5aeaf54cf7ad9bc8c613f49be97613ffe2::cnsnft1714 {
    struct CNSNFT1714 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1714, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2506"));
        let v4 = 0x2::package::claim<CNSNFT1714>(arg0, arg1);
