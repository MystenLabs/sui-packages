module 0xb40f9a9df0ca978c5c9bd887628814c6cdf07cee8104265d23148b4f794f1f7b::cnsnft7045 {
    struct CNSNFT7045 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7045, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8647"));
        let v4 = 0x2::package::claim<CNSNFT7045>(arg0, arg1);
