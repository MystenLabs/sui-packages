module 0xb4d03f5af26f616f25693b3d974e69a7e0936498f3fc06c3631e9da6a1e7955c::reward6433 {
    struct REWARD6433 has drop {
        dummy_field: bool,
    }

    struct TICKET_6433 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6433(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6433>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6433>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6433, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6433>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6433>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6433>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6433>>(v5, 0x2::tx_context::sender(arg1));
    }
