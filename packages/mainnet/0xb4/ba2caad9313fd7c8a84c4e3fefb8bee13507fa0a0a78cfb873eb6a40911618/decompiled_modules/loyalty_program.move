module 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::loyalty_program {
    ...
    fun award_level_up(arg0: &mut CustomerProfile, arg1: address, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = calculate_level(arg0.total_xp);
        if (v0 > arg0.level) {
            arg0.level = v0;
            ...
            0x2::transfer::transfer<RewardNFT>(v2, arg1);
        };
    }
    ...
    public entry fun create_stamp_authority(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = StampAuthority{
            id     : 0x2::object::new(arg1),
            admin  : 0x2::tx_context::sender(arg1),
            pubkey : arg0,
        };
        0x2::transfer::share_object<StampAuthority>(v0);
    }
    ...
    public entry fun record_batch_purchases(arg0: &mut CustomerShopAccount, arg1: &mut CustomerProfile, arg2: &mut 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg3: &mut LoyaltyProgram, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg4) {
            ...
            award_level_up(arg1, arg0.customer, v1, v0, arg6);
            v4 = v4 + 1;
        };
        ...
        0x2::event::emit<PurchaseRecorded>(v8);
        0x2::transfer::transfer<Purchase>(v7, arg0.customer);
    }
    ...
    public entry fun record_purchase(arg0: &mut CustomerShopAccount, arg1: &mut CustomerProfile, arg2: &mut 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg3: &mut LoyaltyProgram, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        award_level_up(arg1, arg0.customer, v1, v0, arg5);
    }

    public entry fun record_purchase_attested(arg0: &mut CustomerShopAccount, arg1: &mut CustomerProfile, arg2: &mut 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg3: &mut LoyaltyProgram, arg4: &StampAuthority, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg8);
        0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::verify_shop_ready(arg2);
        let v1 = 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::get_shop_owner(arg2);
        assert!(0x2::tx_context::sender(arg9) == arg0.customer, 2);
        assert!(arg0.shop == v1, 2);
        assert!(arg1.zklogin_address == arg0.customer, 2);
        assert!(arg6 >= 1 && arg6 <= 5, 10);
        assert!(v0 < arg7, 14);
        let v2 = stamp_message(arg0.customer, v1, arg6, arg0.purchases, arg7);
        assert!(0x2::ed25519::ed25519_verify(&arg5, &arg4.pubkey, &v2), 13);
        let v3 = arg3.points_per_purchase;
        let v4 = v3 * 0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::get_shop_multiplier(arg2) / 100 * arg6;
        arg0.points = arg0.points + v4;
        arg0.purchases = arg0.purchases + arg6;
        arg0.last_purchase_timestamp = v0;
        arg1.total_xp = arg1.total_xp + v3 * arg6;
        arg1.total_purchases = arg1.total_purchases + arg6;
        arg3.total_purchases = arg3.total_purchases + arg6;
        0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::increment_shop_purchases(arg2);
        let v5 = PurchaseRecorded{
            customer             : arg0.customer,
            shop                 : v1,
        ...
        0x2::event::emit<PurchaseRecorded>(v5);
        award_level_up(arg1, arg0.customer, v1, v0, arg9);
    }
    ...
    public entry fun redeem_reward(arg0: &mut CustomerShopAccount, arg1: &0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::coffee_shop_registry::CoffeeShop, arg2: &LoyaltyProgram, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::voucher_system::mint_voucher_pkg(arg0.customer, arg0.shop, arg4, arg3, arg5, arg6);
    }
    ...
    public entry fun redeem_reward_nft(arg0: RewardNFT, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x16b10cb26c38ccc41a5ce0ed1e20c365df2ef3fa696eb6356c5e1518ed480ce2::voucher_system::mint_voucher_pkg(v1, v2, b"free_coffee", 0, arg1, arg2);
    }
    ...
    public entry fun rotate_stamp_authority_key(arg0: &mut StampAuthority, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 2);
        arg0.pubkey = arg1;
    }

    fun stamp_message(arg0: address, arg1: address, arg2: u64, arg3: u64, arg4: u64) : vector<u8> {
        let v0 = b"BITBREW_STAMP_V1";
