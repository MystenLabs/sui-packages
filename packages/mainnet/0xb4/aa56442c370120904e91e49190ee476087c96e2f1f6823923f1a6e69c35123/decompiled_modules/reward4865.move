module 0xb4aa56442c370120904e91e49190ee476087c96e2f1f6823923f1a6e69c35123::reward4865 {
    struct REWARD4865 has drop {
        dummy_field: bool,
    }

    struct TICKET_4865 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4865(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_4865>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4865, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4865>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4865>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4865>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4865>>(v5, 0x2::tx_context::sender(arg1));
    }
