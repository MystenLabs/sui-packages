module 0xb4d72e8646c05194c74fac3884976459a57583f72a20c8a33d3cbfad4dab42d2::cnsnft5684 {
    struct CNSNFT5684 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5684, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5684>(arg0, arg1);
