module 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::sunset {
    ...
    public fun exchange_reward_asset<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<T1>(&arg0.pst_balance) >= v3 + v4, 205);
        let v5 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, 0x2::tx_context::sender(arg3));
        assert!(v5.reward_asset >= arg2, 203);
        assert!(v5.state == 0, 303);
        v5.reward_asset = v5.reward_asset - arg2;
        v5.pst_balance = v5.pst_balance + v3;
        v5.repurchase_points = v5.repurchase_points + v2;
    ...
    public fun investment<T0, T1, T2>(arg0: &mut Contract<T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: &0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::PriceOracle, arg5: u64, arg6: u8, arg7: &0x2::clock::Clock, arg8: &mut 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::implements::Global, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0;
        if (arg6 == 1) {
            let v8 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_sui_amount(arg4, arg5);
            let v9 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_sui_amount(arg4, arg5 * 70 / 100);
            v5 = v8;
            assert!(0x2::coin::value<T0>(&arg1) >= v8, 2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swapCoin<T0, T1>(arg8, 0x2::coin::split<T0>(&mut arg1, v9, arg9), 0, arg9), v3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swapCoin<T0, T2>(arg8, 0x2::coin::split<T0>(&mut arg1, v8 - v9, arg9), 0, arg9), v3);
            0x2::coin::send_funds<T0>(arg1, v0);
            0x2::coin::send_funds<T1>(arg2, v0);
            0x2::coin::send_funds<T2>(arg3, v0);
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_sui_invested(v2, v8, arg5);
        } else if (arg6 == 2) {
            let v10 = arg5 * 70 / 100;
            let v11 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg4, v10);
            let v12 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pst_amount(arg4, arg5 - v10);
            let v13 = v11 + v12;
            v7 = v13;
            assert!(0x2::coin::value<T2>(&arg3) >= v13, 4);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swapCoin<T0, T1>(arg8, 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swapCoin<T2, T0>(arg8, 0x2::coin::split<T2>(&mut arg3, v11, arg9), 0, arg9), 0, arg9), v3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut arg3, v12, arg9), v3);
            0x2::coin::send_funds<T0>(arg1, v0);
            0x2::coin::send_funds<T1>(arg2, v0);
            0x2::coin::send_funds<T2>(arg3, v0);
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pst_invested(v2, v13, arg5);
        } else {
            let v14 = arg5 * 70 / 100;
            let v15 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg4, v14);
            let v16 = 0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::price_oracle::get_pre_amount(arg4, arg5 - v14);
            let v17 = v15 + v16;
            v6 = v17;
            assert!(0x2::coin::value<T1>(&arg2) >= v17, 4);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg2, v15, arg9), v3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swapCoin<T0, T2>(arg8, 0xfac379d68d055e1e0f7019f3f4e3f2cf5a155a2943a54cbfc40ec03090d46a5::interface::swapCoin<T1, T0>(arg8, 0x2::coin::split<T1>(&mut arg2, v16, arg9), 0, arg9), 0, arg9), v3);
            0x2::coin::send_funds<T0>(arg1, v0);
            0x2::coin::send_funds<T1>(arg2, v0);
            0x2::coin::send_funds<T2>(arg3, v0);
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_pre_invested(v2, v17, arg5);
        };
        let v18 = calc_static_power(arg5);
        let v19 = 0x2::table::borrow_mut<address, User>(v1, v0);
        v19.static_power = v19.static_power + v18;
        v19.underway_power = v19.underway_power + v18;
        v19.join_amount = v19.join_amount + arg5;
        v19.invest_amount = v19.invest_amount + arg5;
        let v20 = v19.static_power;
        0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_asset_invested(v2, arg5);
        if (v19.invest_amount == 0) {
            0xb4d655e7d6cfe525bba14215811b532478d4c78c94ab500543861f1437666331::admin::add_total_effective_user(v2, 1);
        };
        let v21 = 0x2::table::borrow_mut<address, User>(v1, v0);
        let v22 = Order{
            id                 : (0x1::vector::length<Order>(&v21.orders) as u64) + 1,
            ...
            pre_amount         : v6,
            static_power       : v18,
            total_static_power : v20,
            status             : 0,
        };
        0x1::vector::push_back<Order>(&mut v21.orders, v22);
