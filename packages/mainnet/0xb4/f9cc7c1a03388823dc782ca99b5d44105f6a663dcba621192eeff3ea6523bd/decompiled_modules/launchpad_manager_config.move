module 0xb4f9cc7c1a03388823dc782ca99b5d44105f6a663dcba621192eeff3ea6523bd::launchpad_manager_config {
    ...
    struct LaunchWhiteListAdmin has key {
        id: 0x2::object::UID,
    }
    ...
    struct LaunchWhiteListAdminSetEvent has copy, drop {
        new_admin: address,
    }
    ...
    public fun set_launch_white_list_admin(arg0: &LaunchManagerAdmin, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = LaunchWhiteListAdmin{id: 0x2::object::new(arg2)};
        0x2::transfer::transfer<LaunchWhiteListAdmin>(v0, arg1);
        let v1 = LaunchWhiteListAdminSetEvent{new_admin: arg1};
        0x2::event::emit<LaunchWhiteListAdminSetEvent>(v1);
    }
