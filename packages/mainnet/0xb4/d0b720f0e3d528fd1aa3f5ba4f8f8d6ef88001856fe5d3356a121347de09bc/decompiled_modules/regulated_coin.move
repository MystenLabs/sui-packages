module 0xb4d0b720f0e3d528fd1aa3f5ba4f8f8d6ef88001856fe5d3356a121347de09bc::regulated_coin {
    ...
    public entry fun destroy_treasury_cap(arg0: 0x2::coin::TreasuryCap<REGULATED_COIN>, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<REGULATED_COIN>>(arg0);
    }

    fun init(arg0: REGULATED_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<REGULATED_COIN>(arg0, 5, b"dudu", b"dudu", b"Example Regulated Coin", 0x1::option::none<0x2::url::Url>(), true, arg1);
