module 0xb46a23eaea5ece7e3774c5ee2dea4bc52825923574c3e3325dbe342fc68d4c37::cnsnft2051 {
    struct CNSNFT2051 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2051, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2051>(arg0, arg1);
