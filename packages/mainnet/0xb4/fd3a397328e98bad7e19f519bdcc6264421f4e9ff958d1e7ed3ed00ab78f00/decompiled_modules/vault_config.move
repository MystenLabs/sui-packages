module 0xb4fd3a397328e98bad7e19f519bdcc6264421f4e9ff958d1e7ed3ed00ab78f00::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &mut VaultConfig) : &mut 0x689ce2c0fa10ce818d8f31cf7b9470a30673e8d01bc22f832e2be8358a002fbc::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x689ce2c0fa10ce818d8f31cf7b9470a30673e8d01bc22f832e2be8358a002fbc::cloud_wallet_config::QuickWithdrawCap>(&mut arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public fun set_cloud_wallet_withdraw_cap(arg0: &mut VaultConfig, arg1: 0x2::transfer::Receiving<0x689ce2c0fa10ce818d8f31cf7b9470a30673e8d01bc22f832e2be8358a002fbc::cloud_wallet_config::QuickWithdrawCap>, arg2: &mut 0x2::tx_context::TxContext) {
        only_admin(arg0, arg2);
        0x2::dynamic_field::add<0x1::ascii::String, 0x689ce2c0fa10ce818d8f31cf7b9470a30673e8d01bc22f832e2be8358a002fbc::cloud_wallet_config::QuickWithdrawCap>(&mut arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0x689ce2c0fa10ce818d8f31cf7b9470a30673e8d01bc22f832e2be8358a002fbc::cloud_wallet_config::QuickWithdrawCap>(&mut arg0.id, arg1));
    }
