module 0xb40c31c9227c35f5d9010f94404a46d44233e8249402b06b0779f8cc8b1aec1b::map {
    ...
    public(friend) fun can_place_npc_on_tile(arg0: u8) : bool {
        arg0 == 0xb40c31c9227c35f5d9010f94404a46d44233e8249402b06b0779f8cc8b1aec1b::types::TILE_EMPTY()
    }
    ...
    public(friend) fun publish_map_from_bcs(arg0: u8, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, u64, u64) {
        ...
        while (v3 < v4) {
            ...
            if (v7 == 0xb40c31c9227c35f5d9010f94404a46d44233e8249402b06b0779f8cc8b1aec1b::types::TILE_HOSPITAL()) {
