module 0xb414f76aa34da97ec24f83703b9452a0e6d0ee260d2e109cd1b897c2b87e938f::usdt {
    ...
    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDT>(arg0, 6, b"USDT", b"USDT", b"Standard USDT token on Sui", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
