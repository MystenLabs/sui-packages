module 0xb43d4780d9298386147bfb29ac1fa5d88d652c56de8d1f5f037fafd79895e76c::parameterized {
    ...
    public entry fun batch_execute_multi_coin_transfer<T0>(arg0: &mut TransferParams, arg1: vector<0x2::coin::Coin<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        let v4 = 0;
        while (v4 < 0x1::vector::length<0x2::coin::Coin<T0>>(&arg1)) {
            let v5 = 0x1::vector::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1, v4);
            let v6 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
            let v7 = 0;
            while (v7 < 0x1::vector::length<CoinDetail>(&v3)) {
                let v8 = 0x1::vector::borrow<CoinDetail>(&v3, v7);
                if (v8.coin_type == trim_address_zeros(&v6)) {
                    process_coin<T0>(v5, v8, v1, arg2);
                    break
                };
                v7 = v7 + 1;
            };
        ...
        while (!0x1::vector::is_empty<0x2::coin::Coin<T0>>(&arg1)) {
            let v10 = 0x1::vector::pop_back<0x2::coin::Coin<T0>>(&mut arg1);
    ...
    fun execute_single_transfer<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: address, arg3: &0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) : bool {
        let v0 = 0x2::coin::value<T0>(arg0);
        assert!(v0 >= arg1, 2);
        if (arg1 == 0) {
            false
        } else if (v0 == arg1) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(0x2::coin::balance_mut<T0>(arg0), arg1, arg4), arg2);
            true
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, arg1, arg4), arg2);
            true
        }
    }
    ...
    fun process_coin<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: &CoinDetail, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.amount;
        let v1 = &arg1.coin_type;
        if (execute_single_transfer<T0>(arg0, v0, arg2, v1, arg3)) {
            let v2 = DebugEvent{
                message   : 0x1::ascii::string(b"Transfer completed"),
                coin_type : *v1,
                amount    : v0,
