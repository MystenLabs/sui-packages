module 0xb4b00abd030f969f438cf459f45cb5e569fa41708885b06ee987bce11fdc09df::gift2219 {
    struct GIFT2219 has drop {
        dummy_field: bool,
    }

    struct TICKET_2219 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2219(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2219>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2219>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2219, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2219>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2219>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2219>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2219>>(v5, 0x2::tx_context::sender(arg1));
    }
