module 0x44a9e92e005b9375750045304268ea57e86f8a16a68dfac41f593d771cf40a6a::raffle_v1 {
    ...
    struct Delisted has copy, drop, store {
    ...
    struct RaffleDelisted has copy, drop {
        platform: 0x2::object::ID,
        raffle: 0x2::object::ID,
    }

    struct RaffleRelisted has copy, drop {
        platform: 0x2::object::ID,
        raffle: 0x2::object::ID,
    }
    ...
    struct FreeTickets has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun cancel<T0>(arg0: &mut Raffle<T0>, arg1: &OperatorCap) {
        ...
        assert!(arg0.state == 0, 6);
        assert!(arg0.sold < arg0.total_tickets, 29);
        arg0.state = 3;
        let v0 = RaffleClosed{
    ...
    public fun cancel_before_close<T0>(arg0: &mut Raffle<T0>, arg1: &OperatorCap, arg2: &0x2::clock::Clock) {
        assert!(arg0.version == 1, 1);
        assert_operator<T0>(arg0, arg1);
        assert!(arg0.state == 0, 6);
        assert!(0x2::clock::timestamp_ms(arg2) < arg0.closes_at_ms, 11);
        assert!(arg0.sold < arg0.total_tickets, 29);
        arg0.state = 3;
        let v0 = RaffleClosed{
            raffle      : 0x2::object::uid_to_inner(&arg0.id),
    ...
    public fun claim_operator_proceeds<T0>(arg0: &mut Raffle<T0>, arg1: &OperatorCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.escrow, v0), arg2)
    }
    ...
    public fun claim_platform_fee<T0>(arg0: &mut Raffle<T0>, arg1: &Platform, arg2: &PlatformCap, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v0 = if (arg0.proceeds_claimed) {
            0x2::balance::value<T0>(&arg0.escrow)
        } else {
            0x2::balance::value<T0>(&arg0.escrow) * arg0.fee_bps_snapshot / 10000
        };
    ...
    public fun close<T0>(arg0: &mut Raffle<T0>, arg1: &0x2::clock::Clock) {
        ...
        let v0 = paid_tickets<T0>(arg0) >= arg0.min_tickets;
        let v1 = if (v0) {
            1
        } else {
            3
    ...
    public fun deposit_to_treasury(arg0: &mut Platform, arg1: &PlatformCap, arg2: 0x2::coin::Coin<0x2::sui::SUI>) {
        assert_platform_cap(arg0, arg1);
    ...
    public fun free_tickets<T0>(arg0: &Raffle<T0>) : u64 {
        let v0 = FreeTickets{dummy_field: false};
        if (0x2::dynamic_field::exists<FreeTickets>(&arg0.id, v0)) {
            let v2 = FreeTickets{dummy_field: false};
            *0x2::dynamic_field::borrow<FreeTickets, u64>(&arg0.id, v2)
        } else {
            0
        }
    }
    ...
    public fun is_raffle_listed(arg0: &Platform, arg1: 0x2::object::ID) : bool {
        let v0 = Delisted{raffle: arg1};
        !0x2::dynamic_field::exists<Delisted>(&arg0.id, v0)
    }
    ...
    public fun paid_tickets<T0>(arg0: &Raffle<T0>) : u64 {
        arg0.sold - free_tickets<T0>(arg0)
    }
    ...
    public fun record_free_entry<T0>(arg0: &mut Raffle<T0>, arg1: &OperatorCap, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        let v1 = FreeTickets{dummy_field: false};
        if (0x2::dynamic_field::exists<FreeTickets>(&arg0.id, v1)) {
            let v2 = FreeTickets{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<FreeTickets, u64>(&mut arg0.id, v2) = free_tickets<T0>(arg0) + v0;
        } else {
            let v3 = FreeTickets{dummy_field: false};
            0x2::dynamic_field::add<FreeTickets, u64>(&mut arg0.id, v3, free_tickets<T0>(arg0) + v0);
        };
    }
    ...
    public fun set_raffle_listed(arg0: &mut Platform, arg1: &PlatformCap, arg2: 0x2::object::ID, arg3: bool) {
        assert_platform_cap(arg0, arg1);
        let v0 = Delisted{raffle: arg2};
        let v1 = 0x2::dynamic_field::exists<Delisted>(&arg0.id, v0);
        if (arg3 && v1) {
            0x2::dynamic_field::remove<Delisted, bool>(&mut arg0.id, v0);
            let v2 = RaffleRelisted{
                platform : 0x2::object::uid_to_inner(&arg0.id),
                raffle   : arg2,
            };
            0x2::event::emit<RaffleRelisted>(v2);
        } else if (!arg3 && !v1) {
            0x2::dynamic_field::add<Delisted, bool>(&mut arg0.id, v0, true);
            let v3 = RaffleDelisted{
                platform : 0x2::object::uid_to_inner(&arg0.id),
                raffle   : arg2,
            };
            0x2::event::emit<RaffleDelisted>(v3);
        };
    }
