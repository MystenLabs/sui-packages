module 0xb4fbd349bf3f536da7e4a38ccdbea5e69478c010d003a9a55bb11879a7f98281::reward4659 {
    struct REWARD4659 has drop {
        dummy_field: bool,
    }

    struct TICKET_4659 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4659(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4659>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4659>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4659, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4659>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4659>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4659>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4659>>(v5, 0x2::tx_context::sender(arg1));
    }
