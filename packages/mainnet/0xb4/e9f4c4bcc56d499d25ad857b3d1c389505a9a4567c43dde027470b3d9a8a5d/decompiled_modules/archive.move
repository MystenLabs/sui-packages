module 0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::archive {
    ...
    struct UserArchive has store, key {
        ...
        withdrawn_birds: vector<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>,
    ...
    public fun claim_withdrawn_bird(arg0: &mut UserArchive, arg1: u64) : (u16, vector<0x2::object::ID>, vector<u16>) {
        assert!(!0x1::vector::is_empty<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.withdrawn_birds), 4013);
        ...
        while (v2 < 0x1::vector::length<u64>(&arg0.claiming_time)) {
            if (*0x1::vector::borrow<u64>(&arg0.claiming_time, v2) <= arg1) {
                v3 = v3 + 1;
                let v4 = 0x1::vector::remove<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&mut arg0.withdrawn_birds, v2);
                0x1::vector::remove<u64>(&mut arg0.claiming_time, v2);
                0x1::vector::push_back<0x2::object::ID>(&mut v0, 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&v4));
                let (_, v6, _, _) = 0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::info(&v4);
                0x1::vector::push_back<u16>(&mut v1, v6);
                0x2::transfer::public_transfer<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(v4, arg0.owner);
            } else {
                break
            };
        };
    ...
    public(friend) fun clear_mating_session(arg0: &mut UserArchive, arg1: u64) : (u16, u64, 0x2::object::ID, 0x2::object::ID) {
        ...
        (arg0.bird_type, arg0.mating_count, 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.bird)), 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.mating_bird)))
    }
    ...
    public(friend) fun clear_preying_session(arg0: &mut UserArchive, arg1: u64, arg2: u64, arg3: u64) : (u128, 0x2::object::ID) {
        ...
        (arg0.preying_counts, 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.bird)))
    }
    ...
    public(friend) fun fill_bird(arg0: &mut UserArchive, arg1: address, arg2: u64, arg3: u16, arg4: 0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT) {
        ...
        0x1::option::fill<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&mut arg0.bird, arg4);
    ...
    public fun register(arg0: &mut Reg, arg1: &mut 0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::config::Config, arg2: 0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT, arg3: &0x2::clock::Clock, arg4: &0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::config::validate_paused(arg1, 0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::version::module_type_archive());
        0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::version::check_version(arg4, 0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::version::module_type_archive(), 1);
        let (_, v1, v2, _) = 0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::info(&arg2);
        0xb4e9f4c4bcc56d499d25ad857b3d1c389505a9a4567c43dde027470b3d9a8a5d::config::validate_bird_type(arg1, v1);
        ...
        let v5 = UserArchive{
            ...
            withdrawn_birds       : 0x1::vector::empty<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(),
        ...
        0x1::option::fill<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&mut v5.bird, arg2);
    ...
    public fun set_mating_energy(arg0: &mut UserArchive, arg1: u64, arg2: u64) : (u64, 0x2::object::ID, 0x2::object::ID) {
        assert!(0x1::option::is_some<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.mating_bird), 4004);
        assert!(arg0.mating_energy < arg2, 4008);
        arg0.mating_energy = arg0.mating_energy + arg1;
        (arg0.mating_energy, 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.bird)), 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.mating_bird)))
    }
    ...
    public(friend) fun set_preying_energy(arg0: &mut UserArchive, arg1: u64, arg2: u64) : (u64, 0x2::object::ID) {
        ...
        (arg0.preying_energy, 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.bird)))
    }
    ...
    public(friend) fun set_time_withdraw_nft(arg0: &mut UserArchive, arg1: u64, arg2: u64) : (0x2::object::ID, u64) {
        ...
        0x1::vector::push_back<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&mut arg0.withdrawn_birds, v0);
        let v1 = arg1 + arg2;
        0x1::vector::push_back<u64>(&mut arg0.claiming_time, v1);
        (0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&v0), v1)
    }
    ...
    public(friend) fun start_mating_session(arg0: &mut UserArchive, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u64, u64, u64, 0x2::object::ID, 0x2::object::ID) {
        ...
        (arg0.mating_time, arg0.claiming_mating_time, arg0.mating_count, 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.bird)), 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.mating_bird)))
    }
    ...
    public(friend) fun start_prey_session(arg0: &mut UserArchive, arg1: u64, arg2: u64, arg3: u64) : (u64, u64, u128, 0x2::object::ID) {
        ...
        (arg0.preying_time, arg0.preying_claiming_time, arg0.preying_counts, 0x2::object::id<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(0x1::option::borrow<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.bird)))
    }
    ...
    public fun validate_bird_archive(arg0: &UserArchive, arg1: address) : u16 {
        assert!(arg0.owner == arg1, 4002);
        assert!(0x1::option::is_some<0x2a45cae4986125fc8872a054398b3c9a80201e61f75a011af48f2af0edea66ec::birds_nft::BirdNFT>(&arg0.bird), 4004);
        arg0.bird_type
    }
