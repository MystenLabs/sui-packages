module 0xb44cc2a8ebe4b5af16de3471a71b1b0749a8fd6a3b1a948e09400491d45f1ca0::cnsnft5056 {
    struct CNSNFT5056 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5056, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1831"));
        let v4 = 0x2::package::claim<CNSNFT5056>(arg0, arg1);
