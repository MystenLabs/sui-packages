module 0xb4b1e15bf58c8640e29ffef8ec783ca997cbbc8d9fc9f6430933b34636bf0cb1::prediction {
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            let (_, v2) = 0xb4b1e15bf58c8640e29ffef8ec783ca997cbbc8d9fc9f6430933b34636bf0cb1::math::unsafe_div_round(0xb4b1e15bf58c8640e29ffef8ec783ca997cbbc8d9fc9f6430933b34636bf0cb1::math::mul((*0x2::table::borrow<address, u256>(&v0.upaddress, 0x2::tx_context::sender(arg3)) as u64), (v0.downamount as u64)), (v0.upamount as u64));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, (v2 as u64), arg3), 0x2::tx_context::sender(arg3));
            ...
            let (_, v4) = 0xb4b1e15bf58c8640e29ffef8ec783ca997cbbc8d9fc9f6430933b34636bf0cb1::math::unsafe_div_round(0xb4b1e15bf58c8640e29ffef8ec783ca997cbbc8d9fc9f6430933b34636bf0cb1::math::mul((*0x2::table::borrow<address, u256>(&v0.downaddress, 0x2::tx_context::sender(arg3)) as u64), (v0.upamount as u64)), (v0.downamount as u64));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut v0.totalAmount, (v4 as u64), arg3), 0x2::tx_context::sender(arg3));
