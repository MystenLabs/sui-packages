module 0xb4293932dcfff88e0c3d74670729d4b0b7cddbe0a34bc53cee56bb2eaf912978::cnsnft6031 {
    struct CNSNFT6031 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6031>(arg0, arg1);
