module 0xb4f00642b24ae21f97403f4e2150e6e772a006cc62ab5042b9e52ac4815bb770::cult {
    ...
    fun init(arg0: CULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<CULT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CULT    ")))), trim_right(b"Milady Cult Coin                "), trim_right(b"Twitter is captured by a technocapital singularity as schizoautist revolution and whitepilled lovecore lock into commoditization take-off. Logistically accelerating techno-economic interactivity crumbles social order in auto-sophisticating cult runaway.                                                                   "), v2, arg1);
        let v5 = v3;
