module 0xb4f02fa3c22dc3772854ecca86530059a9e443612e1b0035259c1ab9bd31636c::pawtato_land_card_whitelist {
    ...
    fun init(arg0: PAWTATO_LAND_CARD_WHITELIST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PAWTATO_LAND_CARD_WHITELIST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pawtato Land Card Whitelist"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"genesis card to pawtato land"));
