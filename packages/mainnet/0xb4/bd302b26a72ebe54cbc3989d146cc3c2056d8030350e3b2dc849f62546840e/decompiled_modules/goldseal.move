module 0xb4bd302b26a72ebe54cbc3989d146cc3c2056d8030350e3b2dc849f62546840e::goldseal {
    struct GOLDSEAL has drop {
        dummy_field: bool,
    }

    fun init(arg0: GOLDSEAL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<GOLDSEAL>(arg0, 6, b"GOLDSEAL", b"Golden seal", b"Golden seal is created from the bottom of the sea from treasure heading towards the moons", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/50fdd48d_28af_47cc_bb03_a63028f933d9_bf1f80a1fe.jpeg")), arg1);
