module 0xb48e231fccfc7b050175e9ae52cb47b7b8f690e2caf8be035e4233cf99350e54::reward8605 {
    struct REWARD8605 has drop {
        dummy_field: bool,
    }

    struct TICKET_8605 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8605(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_8605>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8605, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8605>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8605>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8605>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8605>>(v5, 0x2::tx_context::sender(arg1));
    }
