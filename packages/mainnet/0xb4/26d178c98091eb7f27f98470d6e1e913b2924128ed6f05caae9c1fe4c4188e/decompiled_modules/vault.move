module 0xb426d178c98091eb7f27f98470d6e1e913b2924128ed6f05caae9c1fe4c4188e::vault {
    ...
    public entry fun withdraw_fee<T0>(arg0: &0xb426d178c98091eb7f27f98470d6e1e913b2924128ed6f05caae9c1fe4c4188e::role::Role, arg1: &mut Vault, arg2: &0x2::tx_context::TxContext) {
        0xb426d178c98091eb7f27f98470d6e1e913b2924128ed6f05caae9c1fe4c4188e::role::only_collector(arg0, arg2);
        let v0 = coin_key<T0>();
        let v1 = 0x2::dynamic_object_field::remove<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg1.id, v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, 0xb426d178c98091eb7f27f98470d6e1e913b2924128ed6f05caae9c1fe4c4188e::role::get_collector(arg0));
