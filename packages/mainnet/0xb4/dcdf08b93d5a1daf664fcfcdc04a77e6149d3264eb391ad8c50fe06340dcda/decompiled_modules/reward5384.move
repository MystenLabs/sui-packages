module 0xb4dcdf08b93d5a1daf664fcfcdc04a77e6149d3264eb391ad8c50fe06340dcda::reward5384 {
    struct REWARD5384 has drop {
        dummy_field: bool,
    }

    struct TICKET_5384 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5384(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5384>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5384>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5384, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5384>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5384>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5384>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5384>>(v5, 0x2::tx_context::sender(arg1));
    }
