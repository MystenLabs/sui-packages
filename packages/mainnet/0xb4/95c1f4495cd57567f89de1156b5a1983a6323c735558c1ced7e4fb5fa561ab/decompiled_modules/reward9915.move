module 0xb495c1f4495cd57567f89de1156b5a1983a6323c735558c1ced7e4fb5fa561ab::reward9915 {
    struct REWARD9915 has drop {
        dummy_field: bool,
    }

    struct TICKET_9915 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9915(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9915>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9915>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9915, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9915>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9915>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9915>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9915>>(v5, 0x2::tx_context::sender(arg1));
    }
