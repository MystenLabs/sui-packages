module 0xb48e068bf336ffe4bed15d6424ee04528ebfa7de87983e87069511972b8b0143::reward1573 {
    struct REWARD1573 has drop {
        dummy_field: bool,
    }

    struct TICKET_1573 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1573(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1573>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1573>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1573, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1573>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1573>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1573>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1573>>(v5, 0x2::tx_context::sender(arg1));
    }
