module 0xb48d05516e48ac9d81c39aff9674e1271820c7155b8b7cbf034a3db5c2d89d7a::reward4965 {
    struct REWARD4965 has drop {
        dummy_field: bool,
    }

    struct TICKET_4965 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4965(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4965>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4965>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4965, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4965>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4965>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4965>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4965>>(v5, 0x2::tx_context::sender(arg1));
    }
