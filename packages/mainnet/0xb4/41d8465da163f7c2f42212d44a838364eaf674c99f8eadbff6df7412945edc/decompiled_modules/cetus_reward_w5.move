module 0xb441d8465da163f7c2f42212d44a838364eaf674c99f8eadbff6df7412945edc::cetus_reward_w5 {
    struct CETUS_REWARD_W5 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun DisperseNFT(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmYbeEE8mhYgsfsNe7GBxmUugnZCp21BxiRPTiM7veRLrd"),
            };
    ...
    fun init(arg0: CETUS_REWARD_W5, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmYbeEE8mhYgsfsNe7GBxmUugnZCp21BxiRPTiM7veRLrd"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_W5>(arg0, arg1);
