module 0xb48f2b9aee6e1edfe9e45d41b45e400a1d50c855b315c91dea6c09277d02e53d::reward7039 {
    struct REWARD7039 has drop {
        dummy_field: bool,
    }

    struct TICKET_7039 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7039(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7039>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7039>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7039, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7039>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7039>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7039>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7039>>(v5, 0x2::tx_context::sender(arg1));
    }
