module 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::storage {
    ...
    fun get_or_add_validator_index_by_staking_pool_id_mut(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v4 = 0x3::sui_system::pool_exchange_rates(arg1, &arg2);
        let v5 = 0x2::tx_context::epoch(arg3);
        while (!0x2::table::contains<u64, 0x3::staking_pool::PoolTokenExchangeRate>(v4, v5)) {
            v5 = v5 - 1;
        };
        let v6 = ValidatorInfo{
            ...
            exchange_rate     : *0x2::table::borrow<u64, 0x3::staking_pool::PoolTokenExchangeRate>(v4, v5),
            total_sui_amount  : 0,
            extra_fields      : 0x2::bag::new(arg3),
        };
        0x1::vector::push_back<ValidatorInfo>(&mut arg0.validator_infos, v6);
    ...
    fun redeem_and_update_accounting(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: 0x3::staking_pool::FungibleStakedSui, arg4: &0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x3::sui_system::redeem_fungible_staked_sui(arg1, arg3, arg4);
        let v1 = 0x1::vector::borrow_mut<ValidatorInfo>(&mut arg0.validator_infos, arg2);
        let v2 = 0x1::u64::min(0x2::balance::value<0x2::sui::SUI>(&v0), v1.total_sui_amount);
        arg0.total_sui_supply = arg0.total_sui_supply - v2;
        v1.total_sui_amount = v1.total_sui_amount - v2;
        v0
    }
    ...
    fun split_from_active_stake(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        redeem_and_update_accounting(arg0, arg1, arg2, v0, arg4)
    }
    ...
    public(friend) fun split_n_sui(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        while (v2 > 0 && 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool) < arg2) {
            v2 = v2 - 1;
            let v3 = arg2 - 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool) + 100;
    ...
    fun take_active_stake(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: &0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        redeem_and_update_accounting(arg0, arg1, arg2, v0, arg3)
    }
