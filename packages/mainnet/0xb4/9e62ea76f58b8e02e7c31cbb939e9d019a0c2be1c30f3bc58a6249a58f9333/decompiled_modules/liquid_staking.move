module 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking {
    ...
    public fun net_redemption_amount<T0>(arg0: &LiquidStakingInfo<T0>) : u64 {
        let v0 = lst_amount_to_sui_amount<T0>(arg0, 1000000000);
        let v1 = 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::fees::calculate_redeem_fee(fee_config<T0>(arg0), v0);
        assert!(v0 >= v1, 2);
        v0 - v1
    }
    ...
    fun redeem_internal<T0: drop>(arg0: &mut LiquidStakingInfo<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v0 = if (arg3) {
            0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::storage::split_from_sui_pool(&mut arg0.storage, lst_amount_to_sui_amount<T0>(arg0, 0x2::coin::value<T0>(&arg1)))
        } else {
            0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::storage::split_n_sui(&mut arg0.storage, arg2, lst_amount_to_sui_amount<T0>(arg0, 0x2::coin::value<T0>(&arg1)), arg4)
        };
        let v1 = v0;
        let v2 = if (arg3) {
            0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::fees::calculate_custom_redeem_fee(0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::cell::get<0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::fees::FeeConfig>(&arg0.fee_config), 0x2::balance::value<0x2::sui::SUI>(&v1))
        } else {
            0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::fees::calculate_redeem_fee(0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::cell::get<0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::fees::FeeConfig>(&arg0.fee_config), 0x2::balance::value<0x2::sui::SUI>(&v1))
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.fees, 0x2::balance::split<0x2::sui::SUI>(&mut v1, (v2 as u64)));
        assert!(0x2::balance::value<0x2::sui::SUI>(&v1) > 0, 2);
        let v3 = RedeemEvent{
            typename       : 0x1::type_name::get<T0>(),
        ...
        0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::events::emit_event<RedeemEvent>(v3);
