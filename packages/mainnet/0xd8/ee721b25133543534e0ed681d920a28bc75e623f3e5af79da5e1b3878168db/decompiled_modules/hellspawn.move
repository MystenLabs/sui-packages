module 0xd8ee721b25133543534e0ed681d920a28bc75e623f3e5af79da5e1b3878168db::hellspawn {
    ...
    fun init(arg0: HELLSPAWN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<HELLSPAWN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"HellSpawn"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A series of HellSpawn for your Avatar"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreie26jml547oo7wmdoza3j4v5yt5c7bbqwsst67d33vdebjuuyyeg4"));
