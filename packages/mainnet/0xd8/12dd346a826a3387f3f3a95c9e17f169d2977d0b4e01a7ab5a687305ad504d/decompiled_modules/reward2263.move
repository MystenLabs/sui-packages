module 0xd812dd346a826a3387f3f3a95c9e17f169d2977d0b4e01a7ab5a687305ad504d::reward2263 {
    struct REWARD2263 has drop {
        dummy_field: bool,
    }

    struct TICKET_2263 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2263(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2263>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2263>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2263, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2263>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2263>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2263>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2263>>(v5, 0x2::tx_context::sender(arg1));
    }
