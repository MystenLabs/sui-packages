module 0xd8c19df9a8ac1ce8c7681fab0dca87a098e39d5f1cbc584cd824b9fccee3af30::divine_art {
    struct DIVINE_ART has drop {
        dummy_field: bool,
    }

    struct DivineArtNft has key {
        id: 0x2::object::UID,
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<DivineArtNft>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = DivineArtNft{
        ...
        0x2::transfer::transfer<DivineArtNft>(v0, 0x2::tx_context::sender(arg5));
    }
