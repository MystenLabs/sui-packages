module 0xd8f0c51ae3d6922928d93630c1a61af4fdd6dcd24f68a5d3529258f84ca95afb::cnsnft2252 {
    struct CNSNFT2252 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2252, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2252>(arg0, arg1);
