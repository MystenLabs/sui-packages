module 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::pair_parameter_helper {
    ...
    public fun get_base_fee(arg0: &PairParameters, arg1: u16) : u64 {
        0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::mul_u64(0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::mul_u64((arg0.base_factor as u64), (arg1 as u64)), 10)
    }
    ...
    public fun get_total_fee(arg0: &PairParameters, arg1: u16) : u64 {
        let v0 = 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::add_u64(get_base_fee(arg0, arg1), get_variable_fee(arg0, arg1));
        if (v0 > 100000000) {
            100000000
        } else {
            v0
    ...
    public fun get_variable_fee(arg0: &PairParameters, arg1: u16) : u64 {
        ...
        if (v0 != 0) {
            let v2 = 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::mul_u64((arg0.volatility_accumulator as u64), (arg1 as u64));
            (0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::mul_u64(0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::mul_u64(v2, v2), v0) + 99) / 100
        } else {
            0
        }
    }
    ...
    public fun set_static_fee_parameters(arg0: &mut PairParameters, arg1: u32, arg2: u16, arg3: u16, arg4: u16, arg5: u32, arg6: u16, arg7: u32) {
        let v0 = if (arg2 <= arg3) {
            if ((arg4 as u64) <= 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::constants::basis_point_max()) {
                if ((arg6 as u64) <= 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::constants::max_protocol_share()) {
                    arg7 <= 1048575
                } else {
                    false
                }
    ...
    public fun update_volatility_accumulator(arg0: &mut PairParameters, arg1: u32) {
        ...
        let v2 = 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::add_u64((arg0.volatility_reference as u64), 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::mul_u64((v1 as u64), 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::constants::basis_point_max()));
        ...
        arg0.volatility_accumulator = 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::u64_to_u32(v4);
    }
    ...
    public fun update_volatility_reference(arg0: &mut PairParameters) {
        arg0.volatility_reference = 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::u64_to_u32(0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::safe_math::mul_div_u64((arg0.volatility_accumulator as u64), (arg0.reduction_factor as u64), 0xd89aa86e8929db34f1049403b3d7b41390deb28089d23ec40c6a9d1707d27eba::constants::basis_point_max()));
    }
