module 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::subscription {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, arg1.contributed * 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::finalize_market_fee_bps(arg0) / 10000), arg2), 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::fee_recipient(arg0));
    }

    fun collect_open_market_fee<T0>(arg0: &0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::MainConfig, arg1: 0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(&arg1) == 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::open_market_fee(arg0), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::fee_recipient(arg0));
    }
    ...
    public fun finalize_market<T0, T1>(arg0: &0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::LpVault<T0, T1> {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(0x2::balance::value<T1>(&arg1.balance_y) >= arg1.soft_cap && v0 > arg1.market_close, 9);
        if (v0 < arg1.market_close + 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::curator_finalizing_cooldown(arg0)) {
        ...
        let v1 = @0x0;
        let v2 = 0;
        let v3 = 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::admin_key_id(arg0), arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v11) {
                ...
                0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::add_position<T0, T1>(&mut v3, v20);
                let v23 = 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::id<T0, T1>(&v3);
                let v24 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::id_to_address(&v23),
                    curator          : arg1.curator,
                    pool_address     : v22,
                    initialize_price : v14,
                    amount_y         : v4,
                    amount_x         : v5,
                    position_id      : 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v20),
                };
                0x2::event::emit<LpVaultCreated<T0, T1>>(v24);
            } else {
                let v25 = sqrt(340282366920938463463374607431768211456 * (v5 as u256) / (v4 as u256));
                v2 = v25;
                let (v26, v27) = calculate_ticks(v25, arg1.tick_spacing);
                let (v28, v29, v30) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2<T1, T0>(arg2, arg3, arg1.tick_spacing, v25, 0x1::string::utf8(b""), v26, v27, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, v4), arg7), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.balance_x, v5), arg7), arg5, arg4, false, arg6, arg7);
                let v31 = v28;
                let v32 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::pool_id(&v31);
                let v33 = 0x2::object::id_to_address(&v32);
                v1 = v33;
                0x2::balance::join<T1>(&mut arg1.balance_y, 0x2::coin::into_balance<T1>(v29));
                0x2::balance::join<T0>(&mut arg1.balance_x, 0x2::coin::into_balance<T0>(v30));
                0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::add_position<T0, T1>(&mut v3, v31);
                let v34 = 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::id<T0, T1>(&v3);
                let v35 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::vault::id_to_address(&v34),
                    curator          : arg1.curator,
                    pool_address     : v33,
                    initialize_price : v25,
                    amount_y         : v4,
                    amount_x         : v5,
                    position_id      : 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v31),
                };
                0x2::event::emit<LpVaultCreated<T0, T1>>(v35);
            };
        };
        collect_finalize_market_fee<T0, T1>(arg0, arg1, arg7);
        let v36 = arg1.soft_cap - arg1.soft_cap * 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::finalize_market_fee_bps(arg0) / 10000;
        let v37 = v36;
        if (arg1.is_auto_add_liquidity) {
            v37 = v36 - arg1.soft_cap * arg1.add_liquidity_bps / 10000;
        };
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, v37), arg7), arg1.curator);
        let v38 = MarketFinalized<T0, T1>{
            market_address     : 0x2::object::id_address<Market<T0, T1>>(arg1),
            finalize_time      : v0,
        ...
        0x2::event::emit<MarketFinalized<T0, T1>>(v38);
        v3
    }
    ...
    fun validate_params(arg0: &0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + 0xd80f208a6efaf5274b0ff8a916a4b6a4c5576091f7c14fd0ab507d7df2bdd7ac::main::finalize_market_fee_bps(arg0) <= 10000, 1);
        let v0 = 0;
        if (arg5) {
