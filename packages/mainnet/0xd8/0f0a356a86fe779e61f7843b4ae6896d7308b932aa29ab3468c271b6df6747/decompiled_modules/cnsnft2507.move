module 0xd80f0a356a86fe779e61f7843b4ae6896d7308b932aa29ab3468c271b6df6747::cnsnft2507 {
    struct CNSNFT2507 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2507, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2833"));
        let v4 = 0x2::package::claim<CNSNFT2507>(arg0, arg1);
