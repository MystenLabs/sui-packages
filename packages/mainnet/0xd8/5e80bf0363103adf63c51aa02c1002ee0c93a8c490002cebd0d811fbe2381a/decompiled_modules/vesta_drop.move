module 0x27f5a65655f8e0287e89c05370e28570b64b4305447011e6e34d8564b41c7a0c::vesta_drop {
    ...
    public entry fun remove<T0>(arg0: &0x27f5a65655f8e0287e89c05370e28570b64b4305447011e6e34d8564b41c7a0c::versioned::Versioned, arg1: &mut VestaDrop<T0>, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0x27f5a65655f8e0287e89c05370e28570b64b4305447011e6e34d8564b41c7a0c::versioned::check_version(arg0);
        assert!(arg1.manager == 0x2::tx_context::sender(arg3), 0x27f5a65655f8e0287e89c05370e28570b64b4305447011e6e34d8564b41c7a0c::errors::err_not_vesta_manager());
        if (0x2::table::contains<address, AirdropInfo>(&arg1.claims, arg2)) {
            arg1.total_amount = arg1.total_amount - 0x2::table::borrow_mut<address, AirdropInfo>(&mut arg1.claims, arg2).amount;
            0x2::table::remove<address, AirdropInfo>(&mut arg1.claims, arg2);
        };
    }
