module 0xd8a77678a80050d719ae60f8fdc52025992019513ed17ed25192fc7fc769a306::cnsnft3613 {
    struct CNSNFT3613 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3613, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3613>(arg0, arg1);
