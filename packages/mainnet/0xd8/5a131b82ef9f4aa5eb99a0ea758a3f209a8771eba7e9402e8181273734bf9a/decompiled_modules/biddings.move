module 0xb42dbb7413b79394e1a0175af6ae22b69a5c7cc5df259cd78072b6818217c027::biddings {
    ...
    public fun admin_cancel_bid<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x1565313b747dbdaf2d9d82709461018c43dafa495543d9923e710b1c6535d253, 0);
        let Bid {
            id          : v0,
            nft_type    : v1,
            nft_id      : v2,
        ...
        if (0x1::option::is_some<0x2::object::ID>(&v8)) {
            let v9 = CancelBidEvent{
                bid_id      : arg1,
                nft_type    : v1,
                nft_id      : *0x1::option::borrow<0x2::object::ID>(&v8),
                buyer       : v3,
                price       : v4,
                commission  : v6,
                beneficiary : v7,
            };
            0x2::event::emit<CancelBidEvent>(v9);
        } else {
            let v10 = CancelCollectionBidEvent{
                bid_id      : arg1,
                nft_type    : v1,
                buyer       : v3,
                price       : v4,
            ...
            0x2::event::emit<CancelCollectionBidEvent>(v10);
        };
    }
