module 0xd816bcaf9cfaafe1c659d6ec83b15f0090eb0842667a124065d586caead150ce::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0xd816bcaf9cfaafe1c659d6ec83b15f0090eb0842667a124065d586caead150ce::utils::base_div(arg0.value, arg1);
    ...
    public fun mul_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0xd816bcaf9cfaafe1c659d6ec83b15f0090eb0842667a124065d586caead150ce::utils::base_mul(arg0.value, arg1);
        let v1 = v0 == 0 || arg0.sign;
        Number{
            value : v0,
            sign  : v1,
    ...
    public fun one() : Number {
        Number{
            value : 0xd816bcaf9cfaafe1c659d6ec83b15f0090eb0842667a124065d586caead150ce::constants::base_uint(),
            sign  : true,
        }
    }
