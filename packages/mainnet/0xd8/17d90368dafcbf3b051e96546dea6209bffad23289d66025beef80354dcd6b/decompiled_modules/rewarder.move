module 0x11ea791d82b5742cc8cab0bf7946035c97d9001d7c3803a93f119753da66f526::rewarder {
    ...
    fun accumulate_pool_reward(arg0: &mut Rewarder, arg1: 0x2::object::ID, arg2: u128, arg3: u64) : u128 {
        ...
        if (arg3 <= v1 || v0.allocate_point == 0 || arg2 == 0) {
            return v0.acc_per_share
        };
        let v2 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::full_mul(arg0.emission_per_second, ((arg3 - v1) as u128)) * (v0.allocate_point as u256) / (arg0.total_allocate_point as u256);
        v0.reward_released = v0.reward_released + (v2 as u128);
        v0.acc_per_share = v0.acc_per_share + (v2 as u128) / arg2;
        v0.acc_per_share
    }
