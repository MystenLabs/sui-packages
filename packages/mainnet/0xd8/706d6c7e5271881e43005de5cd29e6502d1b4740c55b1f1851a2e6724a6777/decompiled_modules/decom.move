module 0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::decom {
    ...
    struct DecomAdminCap has store, key {
        ...
        ownership: 0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::ownership::CredenzaOwnership,
    }
    ...
    public fun buy_decom_token<T0>(arg0: &0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::sellable::CredenzaSellableConfig<DECOM>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::sellable::accept_payment_coin<DECOM, T0>(arg0, arg1, arg2);
        let v0 = DecomToken{
    ...
    fun init(arg0: DECOM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = DecomAdminCap{
            ...
            ownership            : 0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        };
        0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
        ...
        let (_, v4) = 0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::sellable::create_config<DECOM>(arg0, arg1);
        0x2::transfer::public_share_object<0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::sellable::CredenzaSellableConfig<DECOM>>(v4);
    }

    public fun mint(arg0: &DecomAdminCap, arg1: address, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        let v0 = DecomToken{
    ...
    public fun set_owner(arg0: &mut DecomAdminCap, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }

    public fun write_owner_render_data(arg0: &mut DecomAdminCap, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        0xd8706d6c7e5271881e43005de5cd29e6502d1b4740c55b1f1851a2e6724a6777::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
