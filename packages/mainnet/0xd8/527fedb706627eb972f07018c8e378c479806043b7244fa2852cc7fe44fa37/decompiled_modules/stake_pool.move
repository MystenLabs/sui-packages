module 0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::stake_pool {
    ...
    entry fun add_lp_user_shares_v2(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::verify(arg0, arg3);
        let v0 = &mut arg1.id;
        0x2::dynamic_field::add<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut get_mut_stake_pool(v0, arg2).id, 0x1::string::utf8(b"lp_user_shares_v2"), 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::new<address, LpUserShare>(1000, arg3));
    }
    ...
    entry fun auto_compound<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v1.id, 0x1::string::utf8(b"lp_user_shares_v2"));
        let v6 = 0;
        let v7 = 0;
    ...
    public(friend) fun get_user_shares(arg0: &StakePoolRegistry, arg1: u64, arg2: address) : vector<u8> {
        ...
        let v1 = 0x2::dynamic_field::borrow<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&v0.id, 0x1::string::utf8(b"lp_user_shares_v2"));
    ...
    public fun harvest_per_user_share<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v2), v6), arg5)
    }
    ...
    entry fun hotfix_pool_info_u64_padding(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: vector<u64>, arg4: &0x2::tx_context::TxContext) {
        0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::verify(arg0, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        v1.pool_info.u64_padding = arg3;
        let v2 = UpdatePoolInfoU64PaddingEvent{
            sender      : 0x2::tx_context::sender(arg4),
            index       : arg2,
            u64_padding : v1.pool_info.u64_padding,
        };
        0x2::event::emit<UpdatePoolInfoU64PaddingEvent>(v2);
    }
    ...
    fun log_harvested_amount(arg0: &mut LpUserShare, arg1: u64) {
        if (0x1::vector::length<u64>(&arg0.u64_padding) == 2) {
            ...
            0x1::vector::append<u64>(&mut arg0.u64_padding, v0);
        } else if (0x1::vector::length<u64>(&arg0.u64_padding) == 4) {
            let v2 = 0x1::vector::borrow_mut<u64>(&mut arg0.u64_padding, 3);
            *v2 = *v2 + arg1;
        };
    }

    entry fun migrate_lp_user_shares_v2(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: address, arg4: &0x2::tx_context::TxContext) {
        0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::verify(arg0, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::table::Table<address, vector<LpUserShare>>>(&mut v1.id, 0x1::string::utf8(b"lp_user_shares"));
        let v3 = 0x2::table::borrow_mut<address, vector<LpUserShare>>(v2, arg3);
        let v4 = 0x1::vector::pop_back<LpUserShare>(v3);
        while (0x1::vector::length<LpUserShare>(v3) > 0) {
            let LpUserShare {
                user                       : _,
                user_share_id              : _,
                stake_ts_ms                : _,
                total_shares               : v8,
                active_shares              : v9,
                deactivating_shares        : v10,
                last_incentive_price_index : _,
                u64_padding                : _,
            } = 0x1::vector::pop_back<LpUserShare>(v3);
            v4.total_shares = v4.total_shares + v8;
            v4.active_shares = v4.active_shares + v9;
            0x1::vector::append<DeactivatingShares>(&mut v4.deactivating_shares, v10);
        };
        if (0x1::vector::length<LpUserShare>(v3) == 0) {
            0x1::vector::destroy_empty<LpUserShare>(0x2::table::remove<address, vector<LpUserShare>>(v2, arg3));
        };
        0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::push_back<address, LpUserShare>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v1.id, 0x1::string::utf8(b"lp_user_shares_v2")), arg3, v4);
    }
    ...
    entry fun migrate_to_staked_tlp<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        assert!(0x1::type_name::with_defining_ids<T0>() == v1.pool_info.stake_token, 0);
        0x2::dynamic_field::add<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::string::utf8(b"staked_tlp"), 0x2::dynamic_field::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::type_name::with_defining_ids<T0>()));
    }
    ...
    entry fun new_stake_pool<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v0, 0x1::string::utf8(b"lp_user_shares_v2"), 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::new<address, LpUserShare>(1000, arg3));
    ...
    entry fun remove_lp_user_shares_v1(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::verify(arg0, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        0x2::table::destroy_empty<address, vector<LpUserShare>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::table::Table<address, vector<LpUserShare>>>(&mut v1.id, 0x1::string::utf8(b"lp_user_shares")));
        0x1::vector::push_back<u64>(&mut v1.pool_info.u64_padding, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::length(0x2::dynamic_field::borrow<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&v1.id, 0x1::string::utf8(b"lp_user_shares_v2"))));
    }
    ...
    public fun snapshot(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg3: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        ...
        let v4 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_by_key_mut<address, LpUserShare>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v2.id, 0x1::string::utf8(b"lp_user_shares_v2")), v0);
        if (0x1::vector::length<u64>(&v4.u64_padding) == 0) {
            let v5 = 0x1::vector::empty<u64>();
            let v6 = &mut v5;
            0x1::vector::push_back<u64>(v6, v4.stake_ts_ms);
            0x1::vector::push_back<u64>(v6, v3);
            v4.u64_padding = v5;
        };
        let v7 = v4.active_shares;
        let v8 = *0x1::vector::borrow<u64>(&v4.u64_padding, 0);
        let v9 = *0x1::vector::borrow<u64>(&v4.u64_padding, 1);
        let v10 = v4.user_share_id;
        let v11 = 0x2::clock::timestamp_ms(arg6);
        let v12 = *0x1::vector::borrow<u64>(&v2.pool_info.u64_padding, 1);
        let v13 = (((v7 as u256) * (v9 as u256) * (((v11 - v8) / 60000) as u256) / (multiplier(13) as u256) / ((60 * v12) as u256)) as u64);
        *0x1::vector::borrow_mut<u64>(&mut v4.u64_padding, 0) = v11;
        *0x1::vector::borrow_mut<u64>(&mut v4.u64_padding, 1) = v3;
        ...
        let v15 = &mut v14;
        0x1::vector::push_back<u64>(v15, v3);
        0x1::vector::push_back<u64>(v15, v12);
        let v16 = SnapshotEvent{
        ...
        0x2::event::emit<SnapshotEvent>(v16);
    }
    ...
    public fun stake<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        let v7 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v2.id, 0x1::string::utf8(b"lp_user_shares_v2"));
        if (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::contains<address>(v7, v0)) {
            ...
            v8.stake_ts_ms = v6;
            assert!(*0x1::vector::borrow<u64>(&v8.u64_padding, 0) == v6, 10);
            ...
            0x1::vector::push_back<u64>(v11, 0);
            0x1::vector::push_back<u64>(v11, 0);
            let v12 = LpUserShare{
                user                       : v0,
            ...
            let v13 = StakeEvent{
                ...
                index                      : arg2,
                lp_token_type              : v3,
                stake_amount               : v12.total_shares,
                user_share_id              : v12.user_share_id,
                stake_ts_ms                : v12.stake_ts_ms,
                last_incentive_price_index : v12.last_incentive_price_index,
                u64_padding                : v12.u64_padding,
            };
            0x2::event::emit<StakeEvent>(v13);
            0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::push_back<address, LpUserShare>(v7, v0, v12);
        };
        *0x1::vector::borrow_mut<u64>(&mut v2.pool_info.u64_padding, 2) = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::length(v7);
    ...
    public fun unstake<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(*0x1::vector::borrow<u64>(&v6.u64_padding, 0) == v3, 10);
        ...
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::string::utf8(b"staked_tlp")), v8), arg5)
    }
    ...
    public fun unsubscribe<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        let v4 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::borrow_by_key_mut<address, LpUserShare>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v1.id, 0x1::string::utf8(b"lp_user_shares_v2")), 0x2::tx_context::sender(arg6));
        let v5 = v4.user_share_id;
        ...
        assert!(*0x1::vector::borrow<u64>(&v4.u64_padding, 0) == v3, 10);
    ...
    entry fun update_pool_info_u64_padding(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        *0x1::vector::borrow_mut<u64>(&mut v1.pool_info.u64_padding, 0) = arg3;
        *0x1::vector::borrow_mut<u64>(&mut v1.pool_info.u64_padding, 1) = arg4;
        *0x1::vector::borrow_mut<u64>(&mut v1.pool_info.u64_padding, 2) = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::length(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::keyed_big_vector::KeyedBigVector>(&mut v1.id, 0x1::string::utf8(b"lp_user_shares_v2")));
        let v2 = UpdatePoolInfoU64PaddingEvent{
            sender      : 0x2::tx_context::sender(arg5),
            index       : arg2,
            u64_padding : v1.pool_info.u64_padding,
    ...
    public fun withdraw_incentive_v2<T0>(arg0: &0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0xc427209145715a00a93d7e674a95c556a7147d79fda1bbaeb1a1cac5f9923966::admin::verify(arg0, arg5);
        allocate_incentive(arg0, arg1, arg2, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
