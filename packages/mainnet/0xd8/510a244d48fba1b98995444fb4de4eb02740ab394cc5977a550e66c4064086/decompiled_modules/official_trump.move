module 0xd8510a244d48fba1b98995444fb4de4eb02740ab394cc5977a550e66c4064086::official_trump {
    struct OFFICIAL_TRUMP has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"02dddf31-5b06-436f-bc34-b5a9e3094a47"),
        };
    ...
    fun init(arg0: OFFICIAL_TRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<OFFICIAL_TRUMP>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"OFFICIAL TRUMP"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"TRUMP are now free NFT on the blockchain. FIGHT FIGHT FIGHT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmNWyBYPSJn86mQCet3dSrWFP7jvJXMG1nMYCEzVL8zyuz"));
