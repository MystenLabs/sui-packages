module 0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::goodie_bag {
    ...
    fun add_participation_info(arg0: address, arg1: Participation_NFT, arg2: &PopList, arg3: &GoodieBagList, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg2.user_received, arg0), 7);
        let v0 = Participation_Info{
            id          : 0x2::object::new(arg4),
            name        : arg3.stall_name,
            description : arg3.stall_description,
            location    : arg3.stall_location,
        };
    ...
    fun check_cool_down_period(arg0: &mut GoodieBagList, arg1: address, arg2: &0x2::clock::Clock) {
    ...
    public(friend) fun claim_goodie_bag<T0: store + key>(arg0: vector<u8>, arg1: vector<vector<u8>>, arg2: vector<vector<u8>>, arg3: &mut GoodieBagList, arg4: Participation_NFT, arg5: &PopList, arg6: u64, arg7: 0x2::object::ID, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_random_goodie(arg0: &mut GoodieBagList, arg1: &0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::version::checkVersion(arg1, 1);
        ...
        let v1 = if (v0 == 1) {
            ...
            0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::rand::rng(0, v0, arg2) % v0
        };
        let v2 = RandomIndex{
    ...
    fun increase_cool_down(arg0: &mut GoodieBagList, arg1: address, arg2: &0x2::clock::Clock) {
    ...
    public fun increase_points(arg0: Participation_NFT, arg1: &mut GoodieBagList, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        check_cool_down_period(arg1, v0, arg2);
        let v1 = 10;
        let v2 = arg0.booth_points + v1;
        arg0.booth_points = v2;
        increase_cool_down(arg1, v0, arg2);
    ...
    public fun mint_participation_token(arg0: address, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut PopList, arg5: &GoodieBagList, arg6: &0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::version::Version, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Participation_Info{
            id          : 0x2::object::new(arg7),
            name        : arg5.stall_name,
            description : arg5.stall_description,
            location    : arg5.stall_location,
        };
