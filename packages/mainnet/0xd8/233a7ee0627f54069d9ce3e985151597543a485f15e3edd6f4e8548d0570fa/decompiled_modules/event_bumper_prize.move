module 0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::event_bumper_prize {
    ...
    public(friend) fun claim_bumper_prize<T0: store + key>(arg0: &mut Event_BumperPrizeList, arg1: u64, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (v0 == 1) {
            ...
            0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::rand::rng(0, v0, arg3) % v0
        };
    ...
    public(friend) fun get_random_in_event_bumper(arg0: &Event_BumperPrizeList, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.item_count != 0, 3);
        ...
        let v1 = if (v0 == 1) {
            ...
            0xd8233a7ee0627f54069d9ce3e985151597543a485f15e3edd6f4e8548d0570fa::rand::rng(0, v0, arg1) % v0
        };
        let v2 = RandomIndex{
