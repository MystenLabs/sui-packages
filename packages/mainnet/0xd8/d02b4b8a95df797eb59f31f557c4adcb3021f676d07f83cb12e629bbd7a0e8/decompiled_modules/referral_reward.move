module 0xd8d02b4b8a95df797eb59f31f557c4adcb3021f676d07f83cb12e629bbd7a0e8::referral_reward {
    ...
    entry fun un_pause(arg0: &mut Referral, arg1: &AdminCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
    ...
    entry fun withdraw(arg0: &mut Referral, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg4) <= arg2, 1002);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) >= arg3, 1001);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, arg3), arg5), 0x2::tx_context::sender(arg5));
