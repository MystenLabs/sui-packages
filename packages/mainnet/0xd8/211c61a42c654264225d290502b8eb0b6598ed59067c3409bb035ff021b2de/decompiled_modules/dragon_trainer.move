module 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer {
    ...
    struct GameMasterKey has store, key {
        ...
        total_energy: u64,
        total_health: u64,
        hive_incentives: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        honey_incentives: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
    }
    ...
    struct MemepadCapability has store, key {
        id: 0x2::object::UID,
    }
    ...
    struct TradesCustodian has key {
        id: 0x2::object::UID,
        trainer_bids_custody: 0x2::linked_table::LinkedTable<address, TraderInfo>,
        module_version: u64,
    }

    struct TraderInfo has store {
        withdrawable_sui: 0x2::balance::Balance<0x2::sui::SUI>,
        expired_bids: vector<u64>,
        sold_dragon_bees: vector<u64>,
        available_bees: 0x2::linked_table::LinkedTable<u64, MysticalBee>,
    }

    struct ReferralStore has key {
        id: 0x2::object::UID,
        referrals_list: 0x2::linked_table::LinkedTable<0x1::ascii::String, address>,
        owner_to_referral_map: 0x2::linked_table::LinkedTable<address, ReferralInfo>,
        module_version: u64,
    }

    struct ReferralInfo has store {
        code: 0x1::ascii::String,
        sui_custody: 0x2::balance::Balance<0x2::sui::SUI>,
        times_used: u64,
        history: 0x2::linked_table::LinkedTable<u64, UseHistory>,
    }

    struct UseHistory has store {
        trainer: address,
    ...
    struct BeesManager has store, key {
        ...
        hive_treasury: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        honey_treasury: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
    ...
    struct DragonEggsBasket has store {
        ...
        honey_avail: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
        hive_avail: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
    }
    ...
    struct HiddenWorld has store, key {
        id: 0x2::object::UID,
        cap: 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::HiddenWorldCapability,
    ...
    struct NectarStore has store {
        evolution_stage: u8,
        lockup_weeks: u64,
        hive_locked: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        weighted_hive_locked: u128,
        unlock_timestamp: u64,
        honey_locked: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
    ...
    struct DragonTrainer has key {
        ...
        available_honey: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
    ...
    struct DragonSchool has store, key {
        ...
        owner: address,
        username: 0x1::ascii::String,
        available_hive: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        available_honey: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
        module_version: u64,
    }
    ...
    struct YieldFarm has store, key {
        ...
        incoming_honey_for_bees: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
        incoming_hive_for_bees: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
        honey_for_bees: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>,
        hive_for_bees: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>,
    ...
    struct ReferralCodeCreated has copy, drop {
        trainer_addr: address,
        referral_code: 0x1::ascii::String,
    }

    struct ReferralUsed has copy, drop {
        referral_code: 0x1::ascii::String,
        sui_bonus: u64,
        trainer: address,
        username: 0x1::ascii::String,
    ...
    struct SuiBonusClaimed has copy, drop {
        trainer_addr: address,
        code: 0x1::ascii::String,
        sui_to_claim: u64,
        times_used: u64,
    ...
    struct UpdatedStingerBeesEnergyHealth has copy, drop {
        stinger_version: u64,
        hive_energy: u64,
        honey_health: u64,
    }
    ...
    struct NewEggIncubated has copy, drop {
        ...
        stinger_gene: u256,
        child_gene: u256,
        hive_energy_for_egg: u64,
        honey_health_for_egg: u64,
    ...
    struct BidDeleted has copy, drop {
        version: u64,
        bidder_trainer: address,
        bid_amt: u64,
    }
    ...
    struct RandomTrainerMessage has copy, drop {
        profile_addr: address,
    ...
    struct MemeCoinLaunchedViaBee has copy, drop {
    ...
    struct CustodyAccountCleared has copy, drop {
        trainer_addr: address,
        withdrawable_sui_amt: u64,
        expired_bids_list: vector<u64>,
        sold_dragon_bees_list: vector<u64>,
        claimed_dragon_bees: vector<u64>,
    }

    public entry fun accept_bid(arg0: &0x2::clock::Clock, arg1: &mut BeesManager, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut MarketPlace, arg4: &mut DragonTrainer, arg5: address, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        abort 0
    }

    public entry fun accept_bidV2(arg0: &0x2::clock::Clock, arg1: &mut TradesCustodian, arg2: &mut BeesManager, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg4: &mut MarketPlace, arg5: &mut DragonTrainer, arg6: address, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg1.module_version == 4) {
            if (arg2.module_version == 4) {
                arg4.module_version == 4
            } else {
                false
            }
        } else {
        ...
        assert!(v2.expiration_sec > 0x2::clock::timestamp_ms(arg0), 1032);
        let (_, _, _) = destroy_listing_record(v2);
        let v6 = 0x2::balance::zero<0x2::sui::SUI>();
        let v7 = &mut v6;
        let (v8, v9) = execute_sale(arg2, arg1, arg4, arg3, arg7, true, arg6, 0, v7, arg8);
        0x2::balance::join<0x2::sui::SUI>(&mut arg5.available_sui, v9);
        update_bee_ownership(arg2, arg7, arg6);
        add_dragon_bee_to_trader_custody(arg1, arg6, v8, arg8);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v6, v1, arg8);
    }

    public fun add_app_to_hive_store(arg0: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: &mut BeesManager, arg2: &mut DegenHiveMapStore, arg3: 0x1::ascii::String, arg4: u64, arg5: u64, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = GameMasterKey{
            id               : 0x2::object::new(arg7),
            app_name         : arg3,
            total_energy     : 0,
            total_health     : 0,
            hive_incentives  : 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg1.hive_treasury, arg4),
            honey_incentives : 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg1.honey_treasury, arg5),
        };
    ...
    fun add_capabilities_based_on_gene(arg0: &BeesManager, arg1: &mut MysticalBee) {
        ...
        let v1 = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::decode_dominant_power_traits(arg1.genes);
        ...
        while (v8 < 7) {
            ...
            assert!(0x2::linked_table::contains<u64, CapabilityState>(&v0.capabilities, v9), 9223392077172178943);
    ...
    public entry fun add_dna_for_dragon_egg(arg0: &GenesisBeesUploaderCapability, arg1: &mut BeesManager, arg2: u256, arg3: vector<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 4, 1079);
    ...
    fun add_dragon_bee_to_trader_custody(arg0: &mut TradesCustodian, arg1: address, arg2: MysticalBee, arg3: &mut 0x2::tx_context::TxContext) {
        if (!0x2::linked_table::contains<address, TraderInfo>(&arg0.trainer_bids_custody, arg1)) {
            let v0 = TraderInfo{
                withdrawable_sui : 0x2::balance::zero<0x2::sui::SUI>(),
                expired_bids     : 0x1::vector::empty<u64>(),
                sold_dragon_bees : 0x1::vector::empty<u64>(),
                available_bees   : 0x2::linked_table::new<u64, MysticalBee>(arg3),
            };
            0x2::linked_table::push_back<address, TraderInfo>(&mut arg0.trainer_bids_custody, arg1, v0);
        };
        0x2::linked_table::push_back<u64, MysticalBee>(&mut 0x2::linked_table::borrow_mut<address, TraderInfo>(&mut arg0.trainer_bids_custody, arg1).available_bees, arg2.version, arg2);
    }
    ...
    fun add_sui_to_trader_custody(arg0: &mut TradesCustodian, arg1: address, arg2: u64, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::linked_table::contains<address, TraderInfo>(&arg0.trainer_bids_custody, arg1)) {
            let v0 = TraderInfo{
                ...
                expired_bids     : 0x1::vector::empty<u64>(),
                sold_dragon_bees : 0x1::vector::empty<u64>(),
                available_bees   : 0x2::linked_table::new<u64, MysticalBee>(arg5),
            };
            0x2::linked_table::push_back<address, TraderInfo>(&mut arg0.trainer_bids_custody, arg1, v0);
        };
        let v1 = 0x2::linked_table::borrow_mut<address, TraderInfo>(&mut arg0.trainer_bids_custody, arg1);
        0x2::balance::join<0x2::sui::SUI>(&mut v1.withdrawable_sui, arg3);
        if (!arg4) {
            0x1::vector::push_back<u64>(&mut v1.expired_bids, arg2);
        } else {
            0x1::vector::push_back<u64>(&mut v1.sold_dragon_bees, arg2);
        };
    }

    public fun add_to_admin_fee(arg0: &mut BeesManager, arg1: 0x2::balance::Balance<0x2::sui::SUI>) {
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.buidlers_royalty, arg1);
    }
    ...
    public fun admin_mint_queen(arg0: &0x2::clock::Clock, arg1: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DeployerCap, arg2: &0x2::random::Random, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg4: &mut BeesManager, arg5: &mut YieldFarm, arg6: &mut DragonTrainer, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) {
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::coin::into_balance<0x2::sui::SUI>(arg7), 0x2::tx_context::sender(arg8), arg8);
    }

    public fun admin_mint_queenV2(arg0: &0x2::clock::Clock, arg1: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DeployerCap, arg2: &0x2::random::Random, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg4: &mut BeesManager, arg5: &mut ReferralStore, arg6: &mut YieldFarm, arg7: &mut DragonTrainer, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = lay_genesis_dragonbee_egg(arg0, arg2, arg3, arg4, arg5, 0x1::option::none<0x1::ascii::String>(), arg6, arg7, 0x2::coin::into_balance<0x2::sui::SUI>(arg8), true, 0, false, arg9);
    ...
    entry fun breed_with_queen_bee(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::YieldFlow, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg4: &mut BeesManager, arg5: u64, arg6: &mut DragonTrainer, arg7: u64, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg4.module_version == 4 && arg6.module_version == 4, 1079);
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v3, 0x2::tx_context::sender(arg10), arg10);
    }
    ...
    public fun cancel_active_trainer_request(arg0: &mut HiddenWorld, arg1: &mut BeesManager, arg2: &mut DragonTrainer, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 4, 1079);
        ...
        if (v1.state == 3) {
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_pool, 0x2::balance::split<0x2::sui::SUI>(&mut v11, 0x2::balance::value<0x2::sui::SUI>(&v11) * arg0.config.expiry_penalty_pct / 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision()));
        };
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v11, 0x2::tx_context::sender(arg3), arg3);
        v1.state = 0;
    ...
    public entry fun cancel_bid(arg0: &mut MarketPlace, arg1: &mut DragonTrainer, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::linked_table::contains<u64, vector<Bid>>(&arg0.available_bids, arg2)) {
            let v5 = 0x2::linked_table::remove<u64, vector<Bid>>(&mut arg0.available_bids, arg2);
            let v6 = &mut v5;
            0x2::balance::join<0x2::sui::SUI>(&mut v1, destroy_bid_among_bids(v6, v0, arg2));
            0x2::linked_table::push_back<u64, vector<Bid>>(&mut arg0.available_bids, arg2, v5);
        };
        let v7 = BidCanceled{
            version        : arg2,
            bidder_trainer : v0,
            refund_sui     : 0x2::balance::value<0x2::sui::SUI>(&v1),
        };
        0x2::event::emit<BidCanceled>(v7);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg3), arg3);
    }
    ...
    public entry fun cancel_listingV2(arg0: &mut TradesCustodian, arg1: &mut MarketPlace, arg2: &mut DragonTrainer, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg0.module_version == 4) {
            if (arg1.module_version == 4) {
                arg2.module_version == 4
            } else {
                false
            }
        } else {
        ...
        assert!(v0, 1079);
        assert!(0x2::linked_table::contains<u64, ListingRecord>(&arg2.listing_records, arg3), 1037);
        let v1 = 0x2::linked_table::remove<u64, Listing>(&mut arg1.active_listings, arg3);
        let v2 = ListingCanceled{
            listed_by_trainer : v1.listed_by_trainer,
            version           : arg3,
        };
        0x2::event::emit<ListingCanceled>(v2);
        let (v3, _, _, _) = destroy_listing(v1);
        let (_, _, _) = destroy_listing_record(0x2::linked_table::remove<u64, ListingRecord>(&mut arg2.listing_records, arg3));
        deposit_bee_in_trainer(arg2, v3);
        remove_marketplace_bids(arg0, arg1, arg3, arg4);
    }
    ...
    public fun charge_mystical_bee(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability, arg1: &mut MysticalBee, arg2: u64) {
    ...
    fun claim_gov_yield(arg0: &mut YieldFarm, arg1: &mut MysticalBee) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        let v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::precision_constant();
        let v1 = 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>();
        let v2 = 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>();
        increment_global_yield_indexes(arg0);
        let v3 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg0.hive_global_index - arg1.nectar.hive_claim_index, (arg1.nectar.weighted_hive_locked as u256), (v0 as u256)) as u64);
        let v4 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg0.honey_global_index - arg1.nectar.honey_claim_index, (arg1.nectar.weighted_honey_locked as u256), (v0 as u256)) as u64);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v1, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_for_bees, v3));
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v2, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.honey_for_bees, v4));
        arg1.nectar.hive_claim_index = arg0.hive_global_index;
        arg1.nectar.honey_claim_index = arg0.honey_global_index;
        let v5 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v4 as u256), (15 as u256), (100 as u256)) as u64);
        lock_honey_with_bee(arg0, arg1, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v2, v5));
        ...
        if (v3 > 0 || v4 > 0) {
            let v6 = BeeFarmedYield{
                ...
                honeylocked          : v5,
                total_honey_locked   : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1.nectar.honey_locked),
    ...
    public entry fun claim_hidden_world_rewards(arg0: &0x2::clock::Clock, arg1: &mut HiddenWorld, arg2: &mut DragonTrainer, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(claim_rewards_from_hidden_world_bees(arg0, arg1, 0x2::object::uid_to_address(&arg2.id), arg3), 0x2::tx_context::sender(arg4), arg4);
    }

    public entry fun claim_referral_bonus(arg0: &mut ReferralStore, arg1: &mut DragonTrainer, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 4, 1079);
        let v0 = 0x2::object::uid_to_address(&arg1.id);
        if (!0x2::linked_table::contains<address, ReferralInfo>(&arg0.owner_to_referral_map, v0)) {
            return
        };
        let v1 = 0x2::linked_table::borrow_mut<address, ReferralInfo>(&mut arg0.owner_to_referral_map, v0);
        let v2 = 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v1.sui_custody);
        let v3 = SuiBonusClaimed{
            trainer_addr : v0,
            code         : v1.code,
            sui_to_claim : 0x2::balance::value<0x2::sui::SUI>(&v2),
            times_used   : v1.times_used,
        };
        0x2::event::emit<SuiBonusClaimed>(v3);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v2, arg1.owner, arg2);
    }
    ...
    public fun clear_trades_custody_account(arg0: &mut BeesManager, arg1: &mut TradesCustodian, arg2: &mut DragonTrainer, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 4 && arg1.module_version == 4, 1079);
        let v0 = 0x2::object::uid_to_address(&arg2.id);
        if (!0x2::linked_table::contains<address, TraderInfo>(&arg1.trainer_bids_custody, v0)) {
            return
        };
        let v1 = 0x2::linked_table::borrow_mut<address, TraderInfo>(&mut arg1.trainer_bids_custody, v0);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v1.withdrawable_sui), 0x2::tx_context::sender(arg3), arg3);
        v1.expired_bids = 0x1::vector::empty<u64>();
        v1.sold_dragon_bees = 0x1::vector::empty<u64>();
        let v2 = 0x1::vector::empty<u64>();
        let v3 = *0x2::linked_table::front<u64, MysticalBee>(&v1.available_bees);
        while (0x1::option::is_some<u64>(&v3)) {
            let v4 = *0x1::option::borrow<u64>(&v3);
            v3 = *0x2::linked_table::next<u64, MysticalBee>(&v1.available_bees, v4);
            let v5 = 0x2::linked_table::remove<u64, MysticalBee>(&mut v1.available_bees, v4);
            update_bee_ownership(arg0, v5.version, v0);
            deposit_bee_in_trainer(arg2, v5);
            0x1::vector::push_back<u64>(&mut v2, v4);
        };
        0x1::option::destroy_none<u64>(v3);
        let v6 = CustodyAccountCleared{
            trainer_addr          : v0,
            withdrawable_sui_amt  : 0x2::balance::value<0x2::sui::SUI>(&v1.withdrawable_sui),
            expired_bids_list     : v1.expired_bids,
            sold_dragon_bees_list : v1.sold_dragon_bees,
            claimed_dragon_bees   : v2,
        };
        0x2::event::emit<CustodyAccountCleared>(v6);
    }

    fun compute_veHive(arg0: u64, arg1: u64, arg2: u64) : u128 {
        (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg1 as u256), (arg0 as u256), (208 as u256)), (get_evolution_multiplier((arg2 as u8)) as u256), (1000000 as u256)) as u128)
    }
    ...
    fun delete_dragon_bee(arg0: &0x2::clock::Clock, arg1: MysticalBee) {
        ...
        0x2::balance::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v30);
        0x2::balance::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(v33);
    ...
    public entry fun delete_dragon_trainer(arg0: &mut DegenHiveMapStore, arg1: &mut HiveGraph, arg2: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: &YieldFarm, arg5: DragonTrainer, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v19 = DragonTrainerDeleted{
            ...
            profile_addr    : v0,
            recepient       : arg6,
            available_honey : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v16),
            available_sui   : 0x2::balance::value<0x2::sui::SUI>(&v15),
        };
        0x2::event::emit<DragonTrainerDeleted>(v19);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v15, arg6, arg7);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg2, arg3, v16, arg6, arg7);
    }
    ...
    fun deposit_bee_in_trainer(arg0: &mut DragonTrainer, arg1: MysticalBee) {
        arg1.owned_by = 0x2::object::uid_to_address(&arg0.id);
        0x2::linked_table::push_back<u64, MysticalBee>(&mut arg0.owned_bees, arg1.version, arg1);
    }

    public fun deposit_hive_for_distribution(arg0: &mut YieldFarm, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>) {
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg1) > 0) {
            let v0 = HiveAddedForHarvest{yield_added: 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg1)};
            0x2::event::emit<HiveAddedForHarvest>(v0);
        };
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.incoming_hive_for_bees, arg1);
        increment_global_yield_indexes(arg0);
    }

    public fun deposit_hive_with_dragon_eggs_basket(arg0: &mut BeesManager, arg1: 0x2::coin::Coin<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(arg1);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut 0x2::table::borrow_mut<u64, DragonEggsBasket>(&mut arg0.dragon_eggs_basket, 420).hive_avail, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v0, arg2));
    ...
    public fun deposit_hive_with_treasury(arg0: &mut BeesManager, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>) {
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_treasury, arg1);
        let v0 = HiveAddedToTreasury{
            hive_added             : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg1),
            total_hive_in_treasury : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.hive_treasury),
        };
        0x2::event::emit<HiveAddedToTreasury>(v0);
    }

    public fun deposit_honey_for_distribution(arg0: &mut YieldFarm, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1) > 0) {
            let v0 = HoneyAddedForHarvest{yield_added: 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1)};
            0x2::event::emit<HoneyAddedForHarvest>(v0);
        };
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.incoming_honey_for_bees, arg1);
        increment_global_yield_indexes(arg0);
    }

    public fun deposit_honey_in_dragon_school(arg0: &mut DragonSchool, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        let v0 = 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1);
        if (v0 > 0) {
        ...
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.available_honey, arg1);
    }

    public fun deposit_honey_in_trainer(arg0: &mut DragonTrainer, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.available_honey, arg1);
    }

    public fun deposit_honey_tokens_for_distribution(arg0: &mut YieldFarm, arg1: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg2: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &mut 0x2::token::Token<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::unwrap_honey_tokens_to_coins<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg3, arg1, arg2, arg4, arg5));
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v0) > 0) {
            let v1 = HoneyAddedForHarvest{yield_added: 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v0)};
            0x2::event::emit<HoneyAddedForHarvest>(v1);
        };
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.incoming_honey_for_bees, v0);
        increment_global_yield_indexes(arg0);
    }

    public fun deposit_honey_with_dragon_eggs_basket(arg0: &mut BeesManager, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut 0x2::table::borrow_mut<u64, DragonEggsBasket>(&mut arg0.dragon_eggs_basket, 420).honey_avail, arg1);
    }

    public fun deposit_honey_with_treasury(arg0: &mut BeesManager, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.honey_treasury, arg1);
        let v0 = HoneyAddedToTreasury{
            honey_added             : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1),
            total_honey_in_treasury : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.honey_treasury),
        };
    ...
    fun destroy_bid_among_bids(arg0: &mut vector<Bid>, arg1: address, arg2: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        while (v1 < 0x1::vector::length<Bid>(arg0)) {
            if (0x1::vector::borrow<Bid>(arg0, v1).bidder_trainer == arg1) {
                let (v2, _, _, _, _) = destroy_bid(0x1::vector::remove<Bid>(arg0, v1), arg2);
    ...
    public fun does_trainer_owns_bee(arg0: &DragonTrainer, arg1: u64) : bool {
        0x2::linked_table::contains<u64, MysticalBee>(&arg0.owned_bees, arg1)
    }

    public fun dragon_food_claim_gov_yield(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability, arg1: &mut YieldFarm, arg2: &mut MysticalBee) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        claim_gov_yield(arg1, arg2)
    }

    public fun dragon_food_deposit_bee(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability, arg1: &mut BeesManager, arg2: &mut DragonTrainer, arg3: MysticalBee) {
    ...
    public fun dragon_food_infuse_bee_with_energy(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability, arg1: &0x2::clock::Clock, arg2: &mut YieldFarm, arg3: &mut MysticalBee, arg4: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        internal_infuse_bee_with_energy(arg1, arg2, arg3, arg4, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg4), 0)
    }

    public fun dragon_food_infuse_bee_with_health(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability, arg1: &0x2::clock::Clock, arg2: &mut YieldFarm, arg3: &mut MysticalBee, arg4: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
    ...
    public fun emit_random_event(arg0: &mut DragonTrainer, arg1: 0x1::string::String) {
        let v0 = RandomTrainerMessage{
            profile_addr : 0x2::object::uid_to_address(&arg0.id),
            msg          : arg1,
        };
        0x2::event::emit<RandomTrainerMessage>(v0);
    }

    public fun enable_referral_code(arg0: &mut ReferralStore, arg1: &mut DragonTrainer, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x2::linked_table::contains<0x1::ascii::String, address>(&arg0.referrals_list, arg1.username)) {
            return
        };
        let v0 = 0x2::object::uid_to_address(&arg1.id);
        let v1 = ReferralInfo{
            ...
            times_used  : 0,
            history     : 0x2::linked_table::new<u64, UseHistory>(arg2),
        };
        0x2::linked_table::push_back<address, ReferralInfo>(&mut arg0.owner_to_referral_map, v0, v1);
        0x2::linked_table::push_back<0x1::ascii::String, address>(&mut arg0.referrals_list, arg1.username, v0);
        let v2 = ReferralCodeCreated{
            trainer_addr  : v0,
            referral_code : arg1.username,
        };
        0x2::event::emit<ReferralCodeCreated>(v2);
    }
    ...
    public fun entry_claim_sui_from_beehive(arg0: &mut BeesManager, arg1: &mut DragonTrainer, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(claim_sui_from_beehive(arg0, v0), 0x2::tx_context::sender(arg3), arg3);
    }

    public fun entry_deposit_honey_in_dragon_school(arg0: &mut DragonSchool, arg1: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg2: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: 0x2::token::Token<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        deposit_honey_in_dragon_school(arg0, 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::unwrap_honey_tokens_to_coins<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3, arg2, arg1, arg4, arg5)));
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3, arg2, arg1, 0x2::token::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg3), 0x2::tx_context::sender(arg5), arg5);
        0x2::token::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg3);
    }
    ...
    fun evolve_bee_powers(arg0: &BeesManager, arg1: &mut MysticalBee, arg2: &mut 0x2::random::RandomGenerator, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::decode_dominant_power_traits(arg1.genes);
        let v1 = 0x2::table::borrow<u64, DragonEggsBasket>(&arg0.dragon_eggs_basket, 420);
        let v2 = 0;
        while (v2 < 7) {
            let v3 = v2 * 15 + (*0x1::vector::borrow<u8>(&v0, v2) as u64);
            assert!(0x2::linked_table::contains<u64, CapabilityState>(&v1.capabilities, v3), 9223399245472595967);
    ...
    fun evolved_gene_generator(arg0: &mut 0x2::random::RandomGenerator, arg1: u256) : u256 {
        ...
        0x1::vector::push_back<u256>(&mut v0, (0x2::random::generate_u128_in_range(arg0, 340282, 340384634633755) as u256) << 128 | (0x2::random::generate_u128_in_range(arg0, 340282, 340282366920938463463) as u256));
        0x1::vector::push_back<u256>(&mut v0, (0x2::random::generate_u128_in_range(arg0, 340282, 340384634633755) as u256) << 128 | (0x2::random::generate_u128_in_range(arg0, 340282, 340282366920938463463) as u256));
        0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::evolve_bee(arg1, v0)
    }

    fun execute_sale(arg0: &mut BeesManager, arg1: &mut TradesCustodian, arg2: &mut MarketPlace, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg4: u64, arg5: bool, arg6: address, arg7: u64, arg8: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) : (MysticalBee, 0x2::balance::Balance<0x2::sui::SUI>) {
        let (v0, v1, _, _) = destroy_listing(0x2::linked_table::remove<u64, Listing>(&mut arg2.active_listings, arg4));
        let v4 = v0;
        assert!(v1 != arg6, 1062);
        if (0x2::linked_table::contains<u64, vector<Bid>>(&arg2.available_bids, arg4)) {
            let v5 = 0x2::linked_table::remove<u64, vector<Bid>>(&mut arg2.available_bids, arg4);
            while (0x1::vector::length<Bid>(&v5) > 0) {
                let (v6, v7, v8, _, _) = destroy_bid(0x1::vector::remove<Bid>(&mut v5, 0), arg4);
                let v11 = v6;
                let v12 = BidDeleted{
                    version        : arg4,
                    bidder_trainer : v7,
                    bid_amt        : 0x2::balance::value<0x2::sui::SUI>(&v11),
                };
                0x2::event::emit<BidDeleted>(v12);
                if (arg5 && v7 == arg6) {
                    if (arg7 == 0) {
                        arg7 = v8;
                    };
                    0x2::balance::join<0x2::sui::SUI>(arg8, v11);
                    continue
                };
                add_sui_to_trader_custody(arg1, v7, arg4, v11, false, arg9);
            };
            0x1::vector::destroy_empty<Bid>(v5);
        };
        assert!(arg7 > 0, 1186);
        let v13 = process_royalty(0x2::balance::split<0x2::sui::SUI>(arg8, arg7), arg0, arg3, v4.queen_version, v4.birth_certificate.generation == 0);
        if (!arg5) {
            add_sui_to_trader_custody(arg1, v1, arg4, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v13), true, arg9);
        };
        let v14 = SaleExecuted{
            version        : arg4,
            buyer_trainer  : arg6,
            seller_trainer : v1,
            purchase_price : arg7,
        };
        0x2::event::emit<SaleExecuted>(v14);
        (v4, v13)
    }
    ...
    public fun game_master_adds_honey_to_trainer_via_bee(arg0: &mut GameMasterKey, arg1: &0x2::clock::Clock, arg2: &mut YieldFarm, arg3: &mut DragonTrainer, arg4: u64, arg5: u64) {
        if (arg5 > 0) {
            ...
            let v1 = 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.honey_incentives, arg5);
            let v2 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg5 as u256), (15 as u256), (100 as u256)) as u64);
            let (v3, v4) = update_global_mystic_power(arg1, arg2, v0, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v1, v2), 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(), 0, false, false);
            let v5 = HoneyAddedToProfile{
                username        : arg3.username,
                profile_addr    : 0x2::object::uid_to_address(&arg3.id),
                deposited_honey : arg5 - v2,
            };
            0x2::event::emit<HoneyAddedToProfile>(v5);
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3.available_honey, v1);
            let v6 = internal_replenish_master_key(arg0, v3, v4, 0, arg5);
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_incentives, v6);
        };
    }
    ...
    public fun game_master_bees_attack(arg0: &mut GameMasterKey, arg1: &0x2::clock::Clock, arg2: &mut MysticalBee, arg3: &mut MysticalBee, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(internal_replenish_master_key(arg0, 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(), 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(), v0 / 2, v1 / 2), 0x2::tx_context::sender(arg7), arg7);
    }
    ...
    public fun game_master_infuses_bee_with_energy(arg0: &mut GameMasterKey, arg1: &0x2::clock::Clock, arg2: &mut YieldFarm, arg3: &mut MysticalBee, arg4: u64, arg5: u64) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        assert!(arg2.module_version == 4, 1079);
        let (v0, v1) = internal_infuse_bee_with_energy(arg1, arg2, arg3, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_incentives, arg4), arg4, arg5);
        let v2 = v1;
        let v3 = v0;
        internal_replenish_master_key(arg0, v2, v3, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v3), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v2))
    }

    public fun game_master_infuses_bee_with_health(arg0: &mut GameMasterKey, arg1: &0x2::clock::Clock, arg2: &mut YieldFarm, arg3: &mut MysticalBee, arg4: u64) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        assert!(arg2.module_version == 4, 1079);
        let (v0, v1) = internal_infuse_bee_with_honey(arg1, arg2, arg3, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.honey_incentives, arg4));
        let v2 = v1;
        let v3 = v0;
        internal_replenish_master_key(arg0, v2, v3, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v3), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v2))
    }

    public fun game_master_send_to_hidden_world(arg0: &mut GameMasterKey, arg1: &0x2::clock::Clock, arg2: &mut BeesManager, arg3: &mut HiddenWorld, arg4: &mut YieldFarm, arg5: MysticalBee, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        assert!(arg4.module_version == 4, 1079);
    ...
    public fun game_master_withdraws_hive_from_bee(arg0: &mut GameMasterKey, arg1: &0x2::clock::Clock, arg2: &mut YieldFarm, arg3: &mut MysticalBee) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
    ...
    public fun get_accrued_yield_for_bee(arg0: &YieldFarm, arg1: &MysticalBee) : (u64, u64, u64) {
        ...
        if (arg0.governance_info.total_weighted_hive > 0) {
            v1 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.incoming_hive_for_bees) as u256), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::precision_constant() as u256), (arg0.governance_info.total_weighted_hive as u256));
        };
        if (arg0.governance_info.total_weighted_honey > 0) {
            v2 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.incoming_honey_for_bees) as u256), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::precision_constant() as u256), (arg0.governance_info.total_weighted_honey as u256));
        };
        let v3 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg0.honey_global_index + v2 - arg1.nectar.honey_claim_index, (arg1.nectar.weighted_honey_locked as u256), (v0 as u256)) as u64);
        let v4 = v3 * 15 / 100;
        ((0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(arg0.hive_global_index + v1 - arg1.nectar.hive_claim_index, (arg1.nectar.weighted_hive_locked as u256), (v0 as u256)) as u64), v3 - v4, v4)
    }
    ...
    public fun get_available_hive_in_school(arg0: &DragonSchool) : u64 {
        0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.available_hive)
    }

    public fun get_available_honey(arg0: &DragonTrainer) : u64 {
        0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.available_honey)
    }
    ...
    public fun get_bee_family(arg0: &MysticalBee) : u64 {
        (0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::get_family_type(arg0.genes) as u64)
    }

    public fun get_bee_flight_info(arg0: &BeesManager, arg1: u64) : (address, address) {
        if (0x2::linked_table::contains<u64, BeeInFlight>(&arg0.bee_transfers.custodied_bees, arg1)) {
            let v2 = 0x2::linked_table::borrow<u64, BeeInFlight>(&arg0.bee_transfers.custodied_bees, arg1);
            (v2.transferred_by, v2.recepient)
        } else {
            (@0x0, @0x0)
        }
    }

    public fun get_bee_for_queen_competition(arg0: &0x2::coin::TreasuryCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg1: &mut BeesManager, arg2: address, arg3: &mut DragonTrainer, arg4: u64) : MysticalBee {
        assert!(arg1.module_version == 4 && arg3.module_version == 4, 1079);
    ...
    public fun get_bee_in_flight_info(arg0: &BeesManager, arg1: u64) : (u64, 0x1::string::String, address, u64, u256, u64, u64, address, 0x1::option::Option<address>, 0x1::option::Option<address>, bool, u64, bool, u64, u8, u64, u8, u64, u128, u64, u64, u64, u128, u64, u64, u64, u64, u64, bool) {
        get_bee_info(&0x2::linked_table::borrow<u64, BeeInFlight>(&arg0.bee_transfers.custodied_bees, arg1).mystical_bee)
    }
    ...
    public fun get_locked_assets(arg0: &DragonTrainer) : (u64, u64) {
        ...
        (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v0.hive_locked), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v0.honey_locked))
    }
    ...
    public fun get_master_key_info(arg0: &GameMasterKey) : (address, 0x1::ascii::String, u64, u64, u64, u64) {
        (0x2::object::uid_to_address(&arg0.id), arg0.app_name, arg0.total_energy, arg0.total_health, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.hive_incentives), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.honey_incentives))
    }
    ...
    public fun get_prices_for_dragonbee_eggs(arg0: &0x2::clock::Clock, arg1: &mut BeesManager, arg2: address, arg3: u64) : (u64, vector<u64>, u64) {
        ...
        let v5 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(v1.eggs_count - v1.eggs_laid, 0x1::vector::length<u64>(&v1.bees_indexes));
        if (v4 > v5) {
            v4 = v5;
        };
        let v6 = v1.eggs_laid;
        ...
        while (v9 < arg3) {
            let v10 = if (v7 > 0) {
                ...
                0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::compute_gene_price(v1.base_price, v1.curve_a, v6)
            };
            v6 = v6 + 1;
    ...
    public fun get_referral_history(arg0: &ReferralStore, arg1: address, arg2: 0x1::option::Option<u64>, arg3: u64) : (vector<address>, vector<0x1::ascii::String>, vector<u64>, vector<u64>, vector<u64>, u64) {
        if (!0x2::linked_table::contains<address, ReferralInfo>(&arg0.owner_to_referral_map, arg1)) {
            return (0x1::vector::empty<address>(), 0x1::vector::empty<0x1::ascii::String>(), 0x1::vector::empty<u64>(), 0x1::vector::empty<u64>(), 0x1::vector::empty<u64>(), 0)
        };
        let v0 = 0x2::linked_table::borrow<address, ReferralInfo>(&arg0.owner_to_referral_map, arg1);
        let v1 = 0x1::vector::empty<address>();
        ...
        let v6 = if (0x1::option::is_some<u64>(&arg2)) {
            ...
            *0x2::linked_table::front<u64, UseHistory>(&v0.history)
        };
        let v7 = 0;
        while (v7 < arg3 && 0x1::option::is_some<u64>(&v6)) {
            let v8 = *0x1::option::borrow<u64>(&v6);
            let v9 = 0x2::linked_table::borrow<u64, UseHistory>(&v0.history, v8);
            0x1::vector::push_back<address>(&mut v1, v9.trainer);
            0x1::vector::push_back<0x1::ascii::String>(&mut v2, v9.username);
            0x1::vector::push_back<u64>(&mut v3, v9.bee_version);
            0x1::vector::push_back<u64>(&mut v4, v9.sui_earned);
            0x1::vector::push_back<u64>(&mut v5, v9.timestamp);
            v6 = *0x2::linked_table::next<u64, UseHistory>(&v0.history, v8);
            v7 = v7 + 1;
        };
        (v1, v2, v3, v4, v5, 0x2::linked_table::length<u64, UseHistory>(&v0.history))
    }

    public fun get_referrals_info_list(arg0: &ReferralStore, arg1: 0x1::option::Option<address>, arg2: u64) : (vector<address>, vector<0x1::ascii::String>, vector<u64>, vector<u64>, u64) {
        let v0 = 0x1::vector::empty<address>();
        ...
        let v4 = if (0x1::option::is_some<address>(&arg1)) {
            ...
            *0x2::linked_table::front<address, ReferralInfo>(&arg0.owner_to_referral_map)
        };
        let v5 = 0;
        while (v5 < arg2 && 0x1::option::is_some<address>(&v4)) {
            let v6 = *0x1::option::borrow<address>(&v4);
            let v7 = 0x2::linked_table::borrow<address, ReferralInfo>(&arg0.owner_to_referral_map, v6);
            0x1::vector::push_back<address>(&mut v0, v6);
            0x1::vector::push_back<0x1::ascii::String>(&mut v1, v7.code);
            0x1::vector::push_back<u64>(&mut v2, v7.times_used);
            0x1::vector::push_back<u64>(&mut v3, 0x2::balance::value<0x2::sui::SUI>(&v7.sui_custody));
            v4 = *0x2::linked_table::next<address, ReferralInfo>(&arg0.owner_to_referral_map, v6);
            v5 = v5 + 1;
        };
        (v0, v1, v2, v3, 0x2::linked_table::length<address, ReferralInfo>(&arg0.owner_to_referral_map))
    }

    public fun get_referrals_list(arg0: &ReferralStore, arg1: 0x1::option::Option<0x1::ascii::String>, arg2: u64) : (vector<0x1::ascii::String>, u64) {
        let v0 = 0x1::vector::empty<0x1::ascii::String>();
        let v1 = if (0x1::option::is_some<0x1::ascii::String>(&arg1)) {
            arg1
        } else {
            *0x2::linked_table::front<0x1::ascii::String, address>(&arg0.referrals_list)
        };
        let v2 = 0;
        while (v2 < arg2 && 0x1::option::is_some<0x1::ascii::String>(&v1)) {
            let v3 = *0x1::option::borrow<0x1::ascii::String>(&v1);
            0x1::vector::push_back<0x1::ascii::String>(&mut v0, v3);
            v1 = *0x2::linked_table::next<0x1::ascii::String, address>(&arg0.referrals_list, v3);
            v2 = v2 + 1;
        };
        (v0, 0x2::linked_table::length<0x1::ascii::String, address>(&arg0.referrals_list))
    }

    public fun get_refferal_code_owner(arg0: &ReferralStore, arg1: 0x1::ascii::String) : address {
        if (!0x2::linked_table::contains<0x1::ascii::String, address>(&arg0.referrals_list, arg1)) {
            return @0x0
        };
        *0x2::linked_table::borrow<0x1::ascii::String, address>(&arg0.referrals_list, arg1)
    }
    ...
    public fun get_trader_custody_ac(arg0: &TradesCustodian, arg1: address) : (u64, vector<u64>, vector<u64>, vector<u64>) {
        if (!0x2::linked_table::contains<address, TraderInfo>(&arg0.trainer_bids_custody, arg1)) {
            return (0, 0x1::vector::empty<u64>(), 0x1::vector::empty<u64>(), 0x1::vector::empty<u64>())
        };
        let v0 = 0x2::linked_table::borrow<address, TraderInfo>(&arg0.trainer_bids_custody, arg1);
        let v1 = 0x1::vector::empty<u64>();
        let v2 = *0x2::linked_table::front<u64, MysticalBee>(&v0.available_bees);
        while (0x1::option::is_some<u64>(&v2)) {
            0x1::vector::push_back<u64>(&mut v1, *0x1::option::borrow<u64>(&v2));
            let v3 = 0x2::linked_table::next<u64, MysticalBee>(&v0.available_bees, *0x1::option::borrow<u64>(&v2));
            v2 = *v3;
        };
        (0x2::balance::value<0x2::sui::SUI>(&v0.withdrawable_sui), v0.expired_bids, v0.sold_dragon_bees, v1)
    }

    public fun get_traders_in_custody_list(arg0: &TradesCustodian, arg1: 0x1::option::Option<address>, arg2: u64) : (vector<address>, u64) {
        let v0 = if (0x1::option::is_some<address>(&arg1)) {
            0x1::option::some<address>(*0x1::option::borrow<address>(&arg1))
        } else {
            *0x2::linked_table::front<address, TraderInfo>(&arg0.trainer_bids_custody)
        };
        let v1 = v0;
        let v2 = 0;
        let v3 = 0x1::vector::empty<address>();
        while (0x1::option::is_some<address>(&v1) && v2 < arg2) {
            0x1::vector::push_back<address>(&mut v3, *0x1::option::borrow<address>(&v1));
            let v4 = 0x2::linked_table::next<address, TraderInfo>(&arg0.trainer_bids_custody, *0x1::option::borrow<address>(&v1));
            v1 = *v4;
            v2 = v2 + 1;
        };
        (v3, 0x2::linked_table::length<address, TraderInfo>(&arg0.trainer_bids_custody))
    }
    ...
    public fun get_trainer_info(arg0: &DragonTrainer) : (0x1::ascii::String, u64, address, u64, u64, vector<u64>, vector<u64>, vector<u64>, vector<u64>, u64) {
        ...
        (arg0.username, arg0.joined_at, arg0.owner, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.available_honey), 0x2::balance::value<0x2::sui::SUI>(&arg0.available_sui), v0, v1, v2, v3, 0x2::linked_table::length<0x1::ascii::String, address>(&arg0.trainer_sessions))
    }
    ...
    public fun get_trainer_referral_info(arg0: &ReferralStore, arg1: address) : (0x1::ascii::String, u64, u64) {
        if (!0x2::linked_table::contains<address, ReferralInfo>(&arg0.owner_to_referral_map, arg1)) {
            return (0x1::ascii::string(b""), 0, 0)
        };
        let v0 = 0x2::linked_table::borrow<address, ReferralInfo>(&arg0.owner_to_referral_map, arg1);
        (v0.code, v0.times_used, 0x2::balance::value<0x2::sui::SUI>(&v0.sui_custody))
    }
    ...
    public fun get_transfer_box_for_trainer(arg0: &BeesManager, arg1: address) : (vector<u64>, vector<u64>) {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u64>();
        if (0x2::linked_table::contains<address, vector<u64>>(&arg0.bee_transfers.incoming_boxes, arg1)) {
            v0 = *0x2::linked_table::borrow<address, vector<u64>>(&arg0.bee_transfers.incoming_boxes, arg1);
        };
        if (0x2::linked_table::contains<address, vector<u64>>(&arg0.bee_transfers.outgoing_boxes, arg1)) {
            v1 = *0x2::linked_table::borrow<address, vector<u64>>(&arg0.bee_transfers.outgoing_boxes, arg1);
        };
        (v0, v1)
    }

    public fun get_treasury_info(arg0: &BeesManager) : (u64, u64) {
        (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.hive_treasury), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.honey_treasury))
    }

    public fun get_yield_farm_info(arg0: &YieldFarm) : (u128, u128, u64, u64, u64, u64, u256, u256) {
        (arg0.governance_info.total_weighted_hive, arg0.governance_info.total_weighted_honey, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.incoming_hive_for_bees), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.hive_for_bees), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.incoming_honey_for_bees), 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.honey_for_bees), arg0.hive_global_index, arg0.honey_global_index)
    }
    ...
    public entry fun handle_expired_listingsV2(arg0: &0x2::clock::Clock, arg1: &mut TradesCustodian, arg2: &mut MarketPlace, arg3: &mut DragonTrainer, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg1.module_version == 4) {
            if (arg2.module_version == 4) {
                arg3.module_version == 4
            } else {
                false
            }
        } else {
        ...
        assert!(v0, 1079);
        let v1 = *0x2::linked_table::front<u64, ListingRecord>(&arg3.listing_records);
        while (0x1::option::is_some<u64>(&v1)) {
            let v2 = *0x1::option::borrow<u64>(&v1);
            v1 = *0x2::linked_table::next<u64, ListingRecord>(&arg3.listing_records, v2);
            if (0x2::linked_table::borrow<u64, ListingRecord>(&arg3.listing_records, v2).expiration_sec > 0x2::clock::timestamp_ms(arg0)) {
                continue
            };
            let v3 = 0x2::linked_table::remove<u64, Listing>(&mut arg2.active_listings, v2);
            let v4 = ListingExpired{
                listed_by_trainer : v3.listed_by_trainer,
                version           : v2,
            };
            0x2::event::emit<ListingExpired>(v4);
            let (v5, _, _, _) = destroy_listing(v3);
            let (_, _, _) = destroy_listing_record(0x2::linked_table::remove<u64, ListingRecord>(&mut arg3.listing_records, v2));
            deposit_bee_in_trainer(arg3, v5);
            remove_marketplace_bids(arg1, arg2, v2, arg4);
        };
    }
    ...
    public entry fun handle_expired_marketplace_bids(arg0: &0x2::clock::Clock, arg1: &mut MarketPlace, arg2: &mut DragonTrainer, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::object::uid_to_address(&arg2.id);
        let v1 = 0x2::balance::zero<0x2::sui::SUI>();
        let v2 = *0x2::linked_table::front<u64, BidRecord>(&arg2.bid_records);
        while (0x1::option::is_some<u64>(&v2)) {
            let v3 = *0x1::option::borrow<u64>(&v2);
            v2 = *0x2::linked_table::next<u64, BidRecord>(&arg2.bid_records, v3);
            if (0x2::linked_table::borrow<u64, BidRecord>(&arg2.bid_records, v3).expiration_sec < 0x2::clock::timestamp_ms(arg0)) {
                if (0x2::linked_table::contains<u64, vector<Bid>>(&arg1.available_bids, v3)) {
                    let v4 = 0x2::linked_table::borrow_mut<u64, vector<Bid>>(&mut arg1.available_bids, v3);
                    0x2::balance::join<0x2::sui::SUI>(&mut v1, destroy_bid_among_bids(v4, v0, v3));
                    let v5 = BidExpired{
                        version        : v3,
                        bidder_trainer : v0,
                        refund_sui     : 0x2::balance::value<0x2::sui::SUI>(&v1),
                ...
                let (_, _, _) = destroy_bid_record(0x2::linked_table::remove<u64, BidRecord>(&mut arg2.bid_records, v3));
            };
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg2.available_sui, v1);
    }
    ...
    fun handle_sui_bet(arg0: &HiddenWorld, arg1: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::YieldFlow, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x2::balance::Balance<0x2::sui::SUI>) : (0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x2::sui::SUI>) {
        if (0x2::balance::value<0x2::sui::SUI>(&arg3) == 0) {
            let v1 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(0x2::balance::value<0x2::sui::SUI>(&arg2), 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::get_treasury_balance(arg1));
            let v2 = 0x2::balance::zero<0x2::sui::SUI>();
            0x2::balance::join<0x2::sui::SUI>(&mut v2, 0x2::balance::split<0x2::sui::SUI>(&mut arg2, v1));
            0x2::balance::join<0x2::sui::SUI>(&mut v2, 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::release_sui_from_treasury_for_bet(&arg0.cap, arg1, v1));
            (arg2, arg3, v2)
        } else {
            let v3 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(0x2::balance::value<0x2::sui::SUI>(&arg2), 0x2::balance::value<0x2::sui::SUI>(&arg3));
    ...
    public entry fun harvest_royalty_yield_for_builders(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::MasterAccessKey, arg1: &mut BeesManager, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun harvest_yield_from_bees(arg0: &mut BeesManager, arg1: &mut YieldFarm, arg2: &mut DragonTrainer, arg3: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        let v0 = if (arg0.module_version == 4) {
            if (arg1.module_version == 4) {
                arg2.module_version == 4
            } else {
        ...
        while (0x1::option::is_some<u64>(&v3)) {
            ...
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v1, v6);
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v2, v7);
        ...
        let v8 = DegenHiveYieldHarvested{
            ...
            hive_harvested    : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v1),
            honey_harvested   : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v2),
        };
        0x2::event::emit<DegenHiveYieldHarvested>(v8);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg3, arg4, v2, 0x2::tx_context::sender(arg5), arg5);
        v1
    }
    ...
    public entry fun harvest_yield_from_bees_and_return(arg0: &mut BeesManager, arg1: &mut YieldFarm, arg2: &mut DragonTrainer, arg3: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v0, 0x2::tx_context::sender(arg5), arg5);
    }
    ...
    public entry fun increment_bees_manager(arg0: &mut BeesManager) {
        assert!(arg0.module_version < 4, 1080);
        arg0.module_version = 4;
    }
    ...
    public entry fun increment_global_yield_indexes(arg0: &mut YieldFarm) {
        ...
        let v1 = 0;
        if (arg0.governance_info.total_weighted_hive > 0) {
            v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.incoming_hive_for_bees) as u256), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::precision_constant() as u256), (arg0.governance_info.total_weighted_hive as u256));
        };
        if (arg0.governance_info.total_weighted_honey > 0) {
            v1 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.incoming_honey_for_bees) as u256), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::precision_constant() as u256), (arg0.governance_info.total_weighted_honey as u256));
        };
        ...
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_for_bees, 0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.incoming_hive_for_bees));
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.honey_for_bees, 0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.incoming_honey_for_bees));
    }

    public entry fun increment_hidden_world(arg0: &mut HiddenWorld) {
        assert!(arg0.module_version < 4, 1080);
        arg0.module_version = 4;
    }

    public entry fun increment_hive_graph(arg0: &mut HiveGraph) {
        assert!(arg0.module_version < 4, 1080);
        arg0.module_version = 4;
    }
    ...
    public entry fun increment_referrals_store(arg0: &mut ReferralStore) {
        assert!(arg0.module_version < 4, 1080);
        arg0.module_version = 4;
    }

    public entry fun increment_trades_custodian(arg0: &mut TradesCustodian) {
        assert!(arg0.module_version < 4, 1080);
        arg0.module_version = 4;
    }
    ...
    public fun infuse_bee_and_school_with_honey(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut DragonSchool, arg3: &mut MysticalBee, arg4: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        assert!(arg1.module_version == 4 && arg2.module_version == 4, 1079);
        let (v0, v1) = internal_infuse_bee_with_honey(arg0, arg1, arg3, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg4, (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg4) as u256), (15 as u256), (100 as u256)) as u64)));
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg2.available_hive, v0);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg4, v1);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg2.available_honey, arg4);
    }

    public fun infuse_bee_and_trainer_with_honey(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut DragonTrainer, arg3: &mut MysticalBee, arg4: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 4 && arg2.module_version == 4, 1079);
        let (v0, v1) = internal_infuse_bee_with_honey(arg0, arg1, arg3, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg4, (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg4) as u256), (15 as u256), (100 as u256)) as u64)));
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v0, 0x2::tx_context::sender(arg5), arg5);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg4, v1);
    ...
    public fun infuse_bee_with_energy(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: &mut DragonTrainer, arg5: u64, arg6: 0x2::coin::Coin<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 4 && arg4.module_version == 4, 1079);
        let v0 = 0x2::linked_table::borrow_mut<u64, MysticalBee>(&mut arg4.owned_bees, arg5);
        let (v1, v2) = internal_infuse_bee_with_energy(arg0, arg1, v0, 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(arg6), arg7, arg8);
        if (arg1.trading_enabled) {
            ...
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg2, arg3, v2, 0x2::tx_context::sender(arg9), arg9);
        } else {
            ...
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v3.hive_locked, v1);
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v3.honey_locked, v2);
        };
    }

    public fun infuse_bee_with_health(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: &mut DragonTrainer, arg5: u64, arg6: 0x2::token::Token<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 4 && arg4.module_version == 4, 1079);
        let v0 = 0x2::linked_table::borrow_mut<u64, MysticalBee>(&mut arg4.owned_bees, arg5);
        let (v1, v2) = internal_infuse_bee_with_honey(arg0, arg1, v0, 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::unwrap_honey_tokens_to_coins<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg6, arg3, arg2, arg7, arg8)));
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v1, 0x2::tx_context::sender(arg8), arg8);
        if (arg1.trading_enabled) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg2, arg3, v2, 0x2::tx_context::sender(arg8), arg8);
        } else {
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut 0x2::dynamic_object_field::borrow_mut<0x1::string::String, LockedDegenHiveAssets>(&mut arg4.id, 0x1::string::utf8(b"LOCKED_DEGEN_HIVE_ASSETS")).honey_locked, v2);
        };
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg6, arg3, arg2, 0x2::token::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg6), 0x2::tx_context::sender(arg8), arg8);
        0x2::token::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg6);
    }
    ...
    fun init(arg0: DRAGON_TRAINER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = MemepadCapability{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<MemepadCapability>(v2, 0x2::tx_context::sender(arg1));
        let v3 = TwapUpdateCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<TwapUpdateCap>(v3, 0x2::tx_context::sender(arg1));
        ...
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"creation time"));
        ...
        let v7 = &mut v6;
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"DegenHive - DragonTrainer"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"DRAGON-TRAINER -::- Collect, breed and battle with mystical-bees to evolve them into dragons! "));
        ...
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"{joined_at}"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"https://www.degenhive.ai"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"{module_version}"));
        let v8 = 0x2::package::claim<DRAGON_TRAINER>(arg0, arg1);
        let v9 = 0x2::display::new_with_fields<DragonTrainer>(&v8, v4, v6, arg1);
        0x2::display::update_version<DragonTrainer>(&mut v9);
        ...
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"owned_by"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"queen_version"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"genes"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"energy"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"health"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"dragon_dust"));
        ...
        0x1::vector::push_back<0x1::string::String>(v13, 0x1::string::utf8(b"{owned_by}"));
        0x1::vector::push_back<0x1::string::String>(v13, 0x1::string::utf8(b"{queen_version}"));
        0x1::vector::push_back<0x1::string::String>(v13, 0x1::string::utf8(b"{genes}"));
        0x1::vector::push_back<0x1::string::String>(v13, 0x1::string::utf8(b"{energy}"));
        0x1::vector::push_back<0x1::string::String>(v13, 0x1::string::utf8(b"{health}"));
        0x1::vector::push_back<0x1::string::String>(v13, 0x1::string::utf8(b"{dragon_dust}"));
        let v14 = 0x2::display::new_with_fields<MysticalBee>(&v8, v10, v12, arg1);
        0x2::display::update_version<MysticalBee>(&mut v14);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v8, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<DragonTrainer>>(v9, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<MysticalBee>>(v14, 0x2::tx_context::sender(arg1));
        let v15 = HiveTwapInfo{
        ...
        0x2::transfer::share_object<HiveGraph>(v16);
        let v17 = GenesisBeesUploaderCapability{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<GenesisBeesUploaderCapability>(v17, 0x2::tx_context::sender(arg1));
    }

    fun internal_breed_with_queen_bee(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::YieldFlow, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg4: &mut BeesManager, arg5: &mut MysticalBee, arg6: u64, arg7: 0x2::balance::Balance<0x2::sui::SUI>, arg8: address, arg9: address, arg10: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision();
        ...
        let v8 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v5 as u256), (arg4.configuration.breeding_royalty.platform_fees_pct as u256), (v0 as u256)) as u64);
        0x2::balance::join<0x2::sui::SUI>(&mut arg4.buidlers_royalty, 0x2::balance::split<0x2::sui::SUI>(&mut v7, v8));
        let v9 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u128((v5 as u128), (arg4.configuration.breeding_royalty.gov_yield_pct as u128), (v0 as u128)) as u64);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::collect_fee_for_coin<0x2::sui::SUI>(arg3, 0x2::balance::split<0x2::sui::SUI>(&mut v7, v9));
        let v10 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v5 as u256), (arg4.configuration.breeding_royalty.treasury_pct as u256), (v0 as u256)) as u64);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::add_to_treasury(arg2, 0x2::balance::split<0x2::sui::SUI>(&mut v7, v10));
        let v11 = 0x2::random::new_generator(arg1, arg10);
        let v12 = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::breed_bees(v2.queen_gene, arg5.genes, (0x2::random::generate_u128_in_range(&mut v11, 340282, 340384634633755) as u256) << 128 | (0x2::random::generate_u128_in_range(&mut v11, 340282, 340282366920938463463) as u256), (0x2::random::generate_u128_in_range(&mut v11, 340282, 340384634633755) as u256) << 128 | (0x2::random::generate_u128_in_range(&mut v11, 340282, 340282366920938463463) as u256));
        let v13 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(v2.queenBirthInfo.generation, arg5.birth_certificate.generation) + 1;
        ...
        let v18 = arg5.hive_energy / 10;
        let v19 = arg5.honey_health / 10;
        arg5.hive_energy = arg5.hive_energy - v18;
        arg5.honey_health = arg5.honey_health - v19;
        let v20 = UpdatedStingerBeesEnergyHealth{
            stinger_version : arg5.version,
            hive_energy     : arg5.hive_energy,
            honey_health    : arg5.honey_health,
        };
        0x2::event::emit<UpdatedStingerBeesEnergyHealth>(v20);
        v15.hive_energy = v18;
        v15.honey_health = v19;
        let v21 = BeeEgg{
            timestamp         : v1,
        ...
        0x2::linked_table::push_back<u64, BeeEgg>(&mut v17.incubating_eggs, arg5.version, v21);
        let v22 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(10, ((arg5.eggs_basket.cooldown_stage + 1) as u64));
        arg5.eggs_basket.cooldown_stage = (v22 as u8);
        arg5.eggs_basket.cooldown_till_ts = v1 + *0x2::linked_table::borrow<u64, u64>(&arg4.configuration.cooldown_periods, v22);
        let v23 = NewEggIncubated{
            child_version          : v16,
            incubated_at           : v1,
            ...
            stinger_gene           : arg5.genes,
            child_gene             : v12,
            hive_energy_for_egg    : v18,
            honey_health_for_egg   : v19,
        ...
        0x2::event::emit<NewEggIncubated>(v23);
        let v24 = BeeEggRecord{
            queenBeeId       : v3,
            queen_version    : arg6,
            child_gene       : v12,
            child_generation : v13,
        ...
        arg5.eggs_basket.hatch_egg_record = 0x1::option::some<BeeEggRecord>(v24);
    ...
    fun internal_infuse_bee_with_energy(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut MysticalBee, arg3: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg4: u64, arg5: u64) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        assert!(arg1.module_version == 4, 1079);
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg2.nectar.hive_locked) == 0) {
            assert!(arg5 <= 208, 1189);
        };
        let (v0, v1) = update_global_mystic_power(arg0, arg1, arg2, 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(), 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg3, arg4), arg5, false, false);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg3, v1);
        (arg3, v0)
    }

    fun internal_infuse_bee_with_honey(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut MysticalBee, arg3: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        assert!(arg1.module_version == 4, 1079);
        let (v0, v1) = update_global_mystic_power(arg0, arg1, arg2, arg3, 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(), 0, false, false);
        (v1, v0)
    }

    fun internal_kraft_dragon_trainer(arg0: &0x2::clock::Clock, arg1: 0x1::string::String, arg2: address, arg3: &mut DegenHiveMapStore, arg4: &mut BeesManager, arg5: &mut HiveGraph, arg6: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg7: 0x2::balance::Balance<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) : DragonTrainer {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg4.buidlers_royalty, 0x2::balance::split<0x2::sui::SUI>(&mut arg7, 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div(0x2::balance::value<0x2::sui::SUI>(&arg7), 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::admin_fee_trainer_kraft(), 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision())));
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::collect_fee_for_coin<0x2::sui::SUI>(arg6, arg7);
        ...
        let v6 = DragonTrainer{
            ...
            username         : v2,
            inscription      : v5,
            available_honey  : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
        ...
        let v7 = LockedDegenHiveAssets{
            ...
            hive_locked  : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
            honey_locked : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
        };
    ...
    fun internal_make_bee_queen(arg0: &mut BeesManager, arg1: &mut MysticalBee, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = (0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::get_family_type(arg1.genes) as u64);
    ...
    fun internal_replenish_master_key(arg0: &mut GameMasterKey, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg2: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg3: u64, arg4: u64) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        arg0.total_energy = arg0.total_energy + 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg2) + arg3;
        arg0.total_health = arg0.total_health + 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1) + arg4;
        let v0 = MasterKeyReplenished{
            addr             : 0x2::object::uid_to_address(&arg0.id),
            app_name         : arg0.app_name,
            honey_earned     : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1),
            energy_added     : arg3 + 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg2),
            health_added     : arg4 + 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1),
            available_energy : arg0.total_energy,
            available_health : arg0.total_health,
        };
        0x2::event::emit<MasterKeyReplenished>(v0);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.honey_incentives, arg1);
        arg2
    }

    fun internal_send_to_hidden_world(arg0: &0x2::clock::Clock, arg1: &mut BeesManager, arg2: &mut HiddenWorld, arg3: &mut YieldFarm, arg4: MysticalBee, arg5: address, arg6: &0x2::tx_context::TxContext) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        assert!(arg1.module_version == 4 && arg3.module_version == 4, 1079);
        let v0 = 0x2::clock::timestamp_ms(arg0);
        assert!(arg4.is_hatched, 1192);
        let v1 = 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg4.nectar.hive_locked);
        if (arg4.nectar.unlock_timestamp < v0) {
            v1 = 0;
        };
        let v2 = &mut arg4;
        let (v3, v4) = update_global_mystic_power(arg0, arg3, v2, 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(), 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(), 0, true, true);
        let v5 = v4;
        let v6 = v3;
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg1.hive_treasury, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v5, (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u128((v1 as u128), (10 as u128), (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision() as u128)) as u64)));
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v5, 0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg4.nectar.hive_locked));
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v6, 0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg4.nectar.honey_locked));
        ...
        let v7 = BeeSentToHiddenWorld{
            ...
            total_honey_claimed  : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v6),
            hive_unlocked        : v1,
    ...
    fun internal_unlock_hive_from_bee(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut MysticalBee) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        assert!(arg1.module_version == 4, 1079);
        let (v0, v1) = update_global_mystic_power(arg0, arg1, arg2, 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(), 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(), 0, true, false);
        (v1, v0)
    }
    ...
    public fun is_dragon_bee_egg_hatchable(arg0: &mut BeesManager, arg1: &mut DragonTrainer, arg2: u64) : bool {
        ...
        let v1 = 0x2::table::borrow<u64, DragonEggsBasket>(&arg0.dragon_eggs_basket, 420);
        if (!0x2::linked_table::contains<u64, 0x2::linked_table::LinkedTable<u64, 0x1::string::String>>(&v1.dragonbee_imgs_list, arg2)) {
            return false
        };
        if (0x2::linked_table::length<u64, 0x1::string::String>(0x2::linked_table::borrow<u64, 0x2::linked_table::LinkedTable<u64, 0x1::string::String>>(&v1.dragonbee_imgs_list, arg2)) == 0) {
            return false
        };
        true
    }
    ...
    public fun is_valid_bee_name(arg0: 0x1::string::String) : bool {
        ...
        if (0x1::ascii::length(&v0) > 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::max_trainer_name_length()) {
            return false
        };
    ...
    public fun kraft_dragon_school(arg0: &mut DegenHiveMapStore, arg1: 0x1::ascii::String, arg2: &mut 0x2::tx_context::TxContext) : DragonSchool {
        ...
        let v0 = DragonSchool{
            ...
            username        : arg1,
            available_hive  : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
            available_honey : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
            module_version  : 4,
        };
    ...
    public fun kraft_dragon_trainer(arg0: &0x2::clock::Clock, arg1: &mut DegenHiveMapStore, arg2: &mut BeesManager, arg3: &mut HiveGraph, arg4: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun kraft_dragon_trainer_and_return_sui(arg0: &0x2::clock::Clock, arg1: &mut DegenHiveMapStore, arg2: &mut BeesManager, arg3: &mut HiveGraph, arg4: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg1.module_version == 4 && arg2.module_version == 4, 1079);
    ...
    public fun launch_meme_pool_via_bee(arg0: &0x2::clock::Clock, arg1: &MemepadCapability, arg2: &mut BeesManager, arg3: &mut DragonTrainer, arg4: u64, arg5: 0x1::ascii::String) : MysticalBee {
        assert!(arg3.module_version == 4, 1079);
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = withdraw_bee_from_trainer(arg2, arg3, arg4, 0x2::object::uid_to_address(&arg1.id));
        assert!(v1.eggs_basket.cooldown_till_ts < v0, 1215);
        let v2 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(10, ((v1.eggs_basket.cooldown_stage + 1) as u64));
        v1.eggs_basket.cooldown_stage = (v2 as u8);
        v1.eggs_basket.cooldown_till_ts = v0 + *0x2::linked_table::borrow<u64, u64>(&arg2.configuration.cooldown_periods, v2);
        let v3 = MemeCoinLaunchedViaBee{
            meme_identifier  : arg5,
            bee_version      : arg4,
            cooldown_stage   : v2,
            cooldown_till_ts : v1.eggs_basket.cooldown_till_ts,
        };
        0x2::event::emit<MemeCoinLaunchedViaBee>(v3);
        v1
    }
    ...
    fun lay_dragon_egg(arg0: u64, arg1: u64, arg2: u64, arg3: address, arg4: u64, arg5: 0x1::option::Option<address>, arg6: 0x1::option::Option<address>, arg7: u256, arg8: 0x2::linked_table::LinkedTable<u64, 0x1::string::String>, arg9: address, arg10: &mut BeesManager, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : MysticalBee {
        ...
        let v3 = NectarStore{
            evolution_stage       : 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::get_evolution_stage(arg7),
            lockup_weeks          : 0,
            hive_locked           : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
    ...
    fun lay_genesis_dragonbee_egg(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut BeesManager, arg4: &mut ReferralStore, arg5: 0x1::option::Option<0x1::ascii::String>, arg6: &mut YieldFarm, arg7: &mut DragonTrainer, arg8: 0x2::balance::Balance<0x2::sui::SUI>, arg9: bool, arg10: u64, arg11: bool, arg12: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0x2::object::uid_to_address(&arg7.id);
        let v2 = 1;
        if (!0x2::linked_table::contains<address, ReferralInfo>(&arg4.owner_to_referral_map, v1)) {
            enable_referral_code(arg4, arg7, arg12);
        };
        ...
        *v4 = *v4 + v2;
        ...
        if (v5 == 0) {
            v5 = 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::compute_gene_price(v3.base_price, v3.curve_a, v3.eggs_laid);
        };
        if (arg11) {
            v5 = 0;
        };
        ...
        if (v5 > 0) {
            0x2::balance::join<0x2::sui::SUI>(&mut v7, 0x2::balance::split<0x2::sui::SUI>(&mut arg8, v5));
        };
        let v8 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision();
        if (v5 > 0) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::collect_fee_for_coin<0x2::sui::SUI>(arg2, 0x2::balance::split<0x2::sui::SUI>(&mut v7, (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((v5 as u256), (arg3.configuration.royalty.numerator as u256), (v8 as u256)) as u64)));
        };
        let v9 = if (0x1::option::is_some<0x1::ascii::String>(&arg5)) {
            if (v5 > 0) {
                *0x1::option::borrow<0x1::ascii::String>(&arg5) != arg7.username
            } else {
                false
            }
        } else {
        ...
        if (v9) {
            let v10 = *0x1::option::borrow<0x1::ascii::String>(&arg5);
            let v11 = 0x2::linked_table::borrow_mut<address, ReferralInfo>(&mut arg4.owner_to_referral_map, *0x2::linked_table::borrow<0x1::ascii::String, address>(&arg4.referrals_list, v10));
            let v12 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x2::sui::SUI>(&v7) as u256), (10 as u256), (v8 as u256)) as u64);
            0x2::balance::join<0x2::sui::SUI>(&mut v11.sui_custody, 0x2::balance::split<0x2::sui::SUI>(&mut v7, v12));
            v11.times_used = v11.times_used + 1;
            let v13 = UseHistory{
                trainer     : v1,
                username    : arg7.username,
                bee_version : arg3.bees_tracker.total_eggs_laid + 1,
                sui_earned  : v12,
                timestamp   : v0,
            };
            0x2::linked_table::push_back<u64, UseHistory>(&mut v11.history, v11.times_used, v13);
            let v14 = ReferralUsed{
                referral_code   : v10,
                sui_bonus       : v12,
                trainer         : v1,
                username        : arg7.username,
                bee_version     : arg3.bees_tracker.total_eggs_laid + 1,
                total_sui_bonus : 0x2::balance::value<0x2::sui::SUI>(&v11.sui_custody),
                times_used      : v11.times_used,
            };
            0x2::event::emit<ReferralUsed>(v14);
        };
        0x2::balance::join<0x2::sui::SUI>(&mut arg3.buidlers_royalty, v7);
        let v15 = 0x1::vector::length<u64>(&v3.bees_indexes);
        assert!(v15 > 0, 1184);
        let v16 = 0;
        let v17 = 0;
        let v18 = 0x2::random::new_generator(arg1, arg12);
        if (v15 > 1) {
            let v19 = 0x2::random::generate_u64_in_range(&mut v18, 0, v15 - 1);
            v17 = v19;
            v16 = *0x1::vector::borrow<u64>(&v3.bees_indexes, v19);
        };
        let v20 = false;
        while (!v20) {
            if (0x2::linked_table::contains<u64, u256>(&v3.genesis_genes_list, v16) && 0x2::linked_table::contains<u64, 0x2::linked_table::LinkedTable<u64, 0x1::string::String>>(&v3.images_list, v16)) {
                v20 = true;
                continue
            };
            let v21 = (v17 + 1) % v15;
            v17 = v21;
            v16 = *0x1::vector::borrow<u64>(&v3.bees_indexes, v21);
        };
        0x1::vector::remove<u64>(&mut v3.bees_indexes, v17);
        v3.eggs_laid = v3.eggs_laid + 1;
        let v22 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v3.honey_avail), 42000000000);
        let v23 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v3.hive_avail), 1000000000);
        let v24 = if (v22 > 420000000) {
            0x2::random::generate_u64_in_range(&mut v18, 420000000, v22)
        } else {
            v22
        };
        let v25 = if (v23 > 10000000) {
            0x2::random::generate_u64_in_range(&mut v18, 10000000, v23)
        } else {
            v23
        };
        let v26 = 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v3.honey_avail, v24);
        let v27 = 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v3.hive_avail, v25);
        let v28 = false;
        let v29 = v3.max_eggs_limit;
        if (!arg11) {
            arg10 = v3.queen_chance;
        };
        if (v3.queen_bee_eggs_count > 0 && (arg9 || 0x2::random::generate_u64_in_range(&mut v18, 0, 1000) < arg10)) {
            v28 = true;
            v3.queen_bee_eggs_count = v3.queen_bee_eggs_count - 1;
            v3.queen_eggs_laid = v3.queen_eggs_laid + 1;
        };
        0x2::linked_table::push_back<u64, 0x2::linked_table::LinkedTable<u64, 0x1::string::String>>(&mut v3.dragonbee_imgs_list, arg3.bees_tracker.total_eggs_laid + 1, 0x2::linked_table::new<u64, 0x1::string::String>(arg12));
        let v30 = lay_dragon_egg(0, v24, v0, v1, 0, 0x1::option::none<address>(), 0x1::option::none<address>(), 0x2::linked_table::remove<u64, u256>(&mut v3.genesis_genes_list, v16), 0x2::linked_table::remove<u64, 0x2::linked_table::LinkedTable<u64, 0x1::string::String>>(&mut v3.images_list, v16), v1, arg3, v5, arg12);
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v26) > 0) {
            let v31 = &mut v30;
            lock_honey_with_bee(arg6, v31, v26);
        } else {
            0x2::balance::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(v26);
        };
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v27) > 0) {
            let v32 = &mut v30;
            lock_hive_with_bee(0x2::clock::timestamp_ms(arg0), arg6, v32, v27, 0x2::random::generate_u64_in_range(&mut v18, 15, 208 / 4));
        } else {
            0x2::balance::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v27);
        };
        if (v28) {
            let v33 = &mut v30;
            internal_make_bee_queen(arg3, v33, v29, 0, arg12);
        };
        update_bee_ownership(arg3, v30.version, v1);
        deposit_bee_in_trainer(arg7, v30);
        arg8
    }

    fun lay_genesis_dragonbee_egg_loopV2(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut BeesManager, arg4: &mut ReferralStore, arg5: &mut YieldFarm, arg6: &mut DragonTrainer, arg7: 0x1::option::Option<0x1::ascii::String>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x2::table::borrow<u64, DragonEggsBasket>(&arg3.dragon_eggs_basket, 420);
        assert!(v0.eggs_count > v0.eggs_laid + arg9, 1162);
        let v1 = 0;
        let v2 = 0x2::coin::into_balance<0x2::sui::SUI>(arg8);
        while (v1 < arg9) {
            v2 = lay_genesis_dragonbee_egg(arg0, arg1, arg2, arg3, arg4, arg7, arg5, arg6, v2, false, 0, false, arg10);
            v1 = v1 + 1;
        };
        if (arg9 >= 10) {
            v2 = lay_genesis_dragonbee_egg(arg0, arg1, arg2, arg3, arg4, arg7, arg5, arg6, v2, false, 100, true, arg10);
        };
        v2
    }

    entry fun lay_genesis_dragonbee_eggs(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut BeesManager, arg4: &mut YieldFarm, arg5: &mut DragonTrainer, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::coin::into_balance<0x2::sui::SUI>(arg6), 0x2::tx_context::sender(arg8), arg8);
    }

    entry fun lay_genesis_dragonbee_eggsV2(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut BeesManager, arg4: &mut ReferralStore, arg5: &mut YieldFarm, arg6: &mut DragonTrainer, arg7: 0x1::option::Option<0x1::ascii::String>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = lay_genesis_dragonbee_egg_loopV2(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg10), arg10);
    }

    entry fun lay_genesis_dragonbee_eggsV3(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut BeesManager, arg4: &mut ReferralStore, arg5: &mut YieldFarm, arg6: &mut DragonTrainer, arg7: 0x1::option::Option<0x1::string::String>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::option::none<0x1::ascii::String>();
        if (0x1::option::is_some<0x1::string::String>(&arg7)) {
            0x1::option::fill<0x1::ascii::String>(&mut v0, 0x1::string::to_ascii(*0x1::option::borrow<0x1::string::String>(&arg7)));
        };
        let v1 = lay_genesis_dragonbee_egg_loopV2(arg0, arg1, arg2, arg3, arg4, arg5, arg6, v0, arg8, arg9, arg10);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg10), arg10);
    }

    entry fun lay_genesis_dragonbee_eggs_with_referral(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: &mut BeesManager, arg4: &mut ReferralStore, arg5: &mut YieldFarm, arg6: &mut DragonTrainer, arg7: 0x1::string::String, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = lay_genesis_dragonbee_egg_loopV2(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0x1::option::some<0x1::ascii::String>(0x1::string::to_ascii(arg7)), arg8, arg9, arg10);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg10), arg10);
    }

    public fun lock_assets_with_trainer(arg0: &mut DragonTrainer, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg2: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        ...
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v0.hive_locked, arg1);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v0.honey_locked, arg2);
    }

    fun lock_hive_with_bee(arg0: u64, arg1: &mut YieldFarm, arg2: &mut MysticalBee, arg3: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg4: u64) {
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg2.nectar.hive_locked, arg3);
        ...
        let v1 = compute_veHive(arg2.nectar.lockup_weeks, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg2.nectar.hive_locked), (arg2.nectar.evolution_stage as u64));
        ...
        let v2 = HiveEnergyInfusedInBee{
            ...
            add_hive_locked      : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg3),
            hive_locked_with_bee : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg2.nectar.hive_locked),
    ...
    fun lock_honey_with_bee(arg0: &mut YieldFarm, arg1: &mut MysticalBee, arg2: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>) {
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg2) == 0) {
            0x2::balance::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg2);
            return
        };
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg1.nectar.honey_locked, arg2);
        let v0 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1.nectar.honey_locked) as u256), (get_evolution_multiplier(0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::get_evolution_stage(arg1.genes)) as u256), (1000000 as u256)) as u128);
        ...
        let v2 = HealthInfusedInBee{
            version               : arg1.version,
            honey_added           : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg2),
            total_honey_locked    : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg1.nectar.honey_locked),
    ...
    public fun make_bee_queen(arg0: &0x2::coin::TreasuryCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg1: &mut BeesManager, arg2: &mut MysticalBee, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        internal_make_bee_queen(arg1, arg2, arg3, arg4, arg5);
    }

    public entry fun make_bid(arg0: &0x2::clock::Clock, arg1: &mut BeesManager, arg2: &mut MarketPlace, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg4: &mut DragonTrainer, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::coin::into_balance<0x2::sui::SUI>(arg5), 0x2::tx_context::sender(arg9), arg9);
    }

    public entry fun make_bidV2(arg0: &0x2::clock::Clock, arg1: &mut TradesCustodian, arg2: &mut BeesManager, arg3: &mut MarketPlace, arg4: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg5: &mut DragonTrainer, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.module_version == 4 && arg3.module_version == 4, 1079);
        ...
        assert!(arg8 >= arg2.configuration.min_bid_amt, 1040);
        assert!(arg8 <= 0x2::balance::value<0x2::sui::SUI>(&v3), 1185);
        assert!(v2 < arg9 && arg9 - v2 < 7776000000, 1030);
        let v4 = 0x2::linked_table::borrow<u64, Listing>(&arg3.active_listings, arg7);
        assert!(v4.expiration_sec > v2, 1032);
        let v5 = 0x2::balance::split<0x2::sui::SUI>(&mut v3, arg8);
        if (arg8 >= v4.min_price) {
            let v6 = &mut v5;
            let (v7, v8) = execute_sale(arg2, arg1, arg3, arg4, arg7, false, v1, arg8, v6, arg10);
            update_bee_ownership(arg2, arg7, v1);
            deposit_bee_in_trainer(arg5, v7);
            ...
            add_bid_to_table(v10, arg7, create_bid(v1, arg8, v5, arg9), arg2.configuration.max_bids_per_bee);
            0x2::linked_table::push_back<u64, BidRecord>(&mut arg5.bid_records, arg7, create_bid_record(arg7, arg8, arg9));
        };
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v3, v0, arg10);
    }
    ...
    entry fun match_active_trainers(arg0: &0x2::clock::Clock, arg1: &0x2::random::Random, arg2: &mut HiddenWorld, arg3: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::YieldFlow, arg4: &DragonTrainer, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.module_version == 4, 1079);
    ...
    public entry fun optional_increment_trainer(arg0: &mut DragonTrainer) {
        if (arg0.module_version < 4) {
            arg0.module_version = 4;
        };
    }
    ...
    fun process_royalty(arg0: 0x2::balance::Balance<0x2::sui::SUI>, arg1: &mut BeesManager, arg2: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::FeeCollector<0x2::sui::SUI>, arg3: u64, arg4: bool) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::constants::percent_precision();
        let v1 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u128((0x2::balance::value<0x2::sui::SUI>(&arg0) as u128), (arg1.configuration.royalty.numerator as u128), (v0 as u128)) as u64);
        let v2 = 0x2::balance::split<0x2::sui::SUI>(&mut arg0, v1);
        let v3 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u128((0x2::balance::value<0x2::sui::SUI>(&v2) as u128), (arg1.configuration.royalty.gov_yield_pct as u128), (v0 as u128)) as u64);
        let v4 = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u128((0x2::balance::value<0x2::sui::SUI>(&v2) as u128), (arg1.configuration.royalty.queen_pct as u128), (v0 as u128)) as u64);
        let v5 = v4;
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::collect_fee_for_coin<0x2::sui::SUI>(arg2, 0x2::balance::split<0x2::sui::SUI>(&mut v2, v3));
        if (!arg4) {
    ...
    fun remove_marketplace_bids(arg0: &mut TradesCustodian, arg1: &mut MarketPlace, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        if (0x2::linked_table::contains<u64, vector<Bid>>(&arg1.available_bids, arg2)) {
            let v0 = 0x2::linked_table::remove<u64, vector<Bid>>(&mut arg1.available_bids, arg2);
            while (0x1::vector::length<Bid>(&v0) > 0) {
                let (v1, v2, _, _, _) = destroy_bid(0x1::vector::remove<Bid>(&mut v0, 0), arg2);
                let v6 = v1;
                let v7 = BidDeleted{
                    version        : arg2,
                    bidder_trainer : v2,
                    bid_amt        : 0x2::balance::value<0x2::sui::SUI>(&v6),
                };
                0x2::event::emit<BidDeleted>(v7);
                add_sui_to_trader_custody(arg0, v2, arg2, v6, false, arg3);
            };
            0x1::vector::destroy_empty<Bid>(v0);
        };
    }
    ...
    public fun replenish_master_key(arg0: &mut GameMasterKey, arg1: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg2: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>) {
        let v0 = internal_replenish_master_key(arg0, arg1, arg2, 0, 0);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_incentives, v0);
    }

    public fun replenish_master_key_with_honey(arg0: &mut GameMasterKey, arg1: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg2: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: 0x2::token::Token<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = internal_replenish_master_key(arg0, 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::unwrap_honey_tokens_to_coins<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3, arg2, arg1, arg4, arg5)), 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(), 0, 0);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3, arg2, arg1, 0x2::token::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg3), 0x2::tx_context::sender(arg5), arg5);
        0x2::token::destroy_zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg3);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_incentives, v0);
    }

    public fun return_bee_from_competition(arg0: &0x2::coin::TreasuryCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg1: &mut BeesManager, arg2: &mut DragonTrainer, arg3: MysticalBee, arg4: u64, arg5: u64) {
    ...
    public entry fun send_to_hidden_world(arg0: &0x2::clock::Clock, arg1: &mut BeesManager, arg2: &mut YieldFarm, arg3: &mut HiddenWorld, arg4: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg5: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg6: &mut DragonTrainer, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2.trading_enabled) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v2, v0, arg8);
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg4, arg5, v3, v0, arg8);
        } else {
            ...
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v4.hive_locked, v2);
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v4.honey_locked, v3);
        };
    }

    public fun set_suins_domain_as_username(arg0: &BeesManager, arg1: &mut DegenHiveMapStore, arg2: &mut YieldFarm, arg3: &mut DragonTrainer, arg4: &mut 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg5: 0x2::coin::Coin<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(arg5);
        assert!(v3 <= 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v4), 1122);
        deposit_hive_for_distribution(arg2, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v4, v3));
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v4, 0x2::tx_context::sender(arg6), arg6);
    }

    public entry fun setup_bees_manager(arg0: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DeployerCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: bool, arg18: u64, arg19: u64, arg20: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = YieldFarm{
            ...
            governance_info         : v0,
            incoming_honey_for_bees : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
            incoming_hive_for_bees  : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
            honey_for_bees          : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
            hive_for_bees           : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
        ...
        let v2 = DragonEggsBasket{
            ...
            honey_avail                     : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
            hive_avail                      : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
        };
        ...
        let v10 = BeesManager{
            id                 : 0x2::object::new(arg20),
            configuration      : v7,
            hive_treasury      : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
            honey_treasury     : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
            bees_tracker       : v8,
            bee_transfers      : v9,
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::manager_setup_by_deployer(arg0);
    }

    public entry fun setup_hidden_world(arg0: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DeployerCap, arg1: 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::HiddenWorldCapability, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::hidden_world_setup_by_deployer(arg0);
    }

    public entry fun setup_referrals_store(arg0: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DeployerCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ReferralStore{
            id                    : 0x2::object::new(arg1),
            referrals_list        : 0x2::linked_table::new<0x1::ascii::String, address>(arg1),
            owner_to_referral_map : 0x2::linked_table::new<address, ReferralInfo>(arg1),
            module_version        : 4,
        };
        0x2::transfer::share_object<ReferralStore>(v0);
    }

    public entry fun setup_trades_custodian(arg0: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DeployerCap, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = TradesCustodian{
            id                   : 0x2::object::new(arg1),
            trainer_bids_custody : 0x2::linked_table::new<address, TraderInfo>(arg1),
            module_version       : 4,
        };
        0x2::transfer::share_object<TradesCustodian>(v0);
    }

    public fun store_exists_for_bee(arg0: &MysticalBee, arg1: 0x1::ascii::String) : bool {
        0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg0.id, arg1)
    }

    public fun switch_trading_enabled(arg0: &mut 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DeployerCap, arg1: &mut YieldFarm, arg2: bool) {
    ...
    public fun trainer_active_for_quest(arg0: &0x2::clock::Clock, arg1: &mut HiddenWorld, arg2: &mut BeesManager, arg3: &mut DragonTrainer, arg4: u64, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: bool, arg8: 0x1::option::Option<address>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v3, 0x2::tx_context::sender(arg9), arg9);
    }
    ...
    public entry fun transfer_bee_to_trainer(arg0: &mut BeesManager, arg1: &mut DragonTrainer, arg2: address, arg3: u64) {
        ...
        if (!0x2::linked_table::contains<address, vector<u64>>(&arg0.bee_transfers.incoming_boxes, arg2)) {
            0x2::linked_table::push_back<address, vector<u64>>(&mut arg0.bee_transfers.incoming_boxes, arg2, 0x1::vector::empty<u64>());
        };
        0x1::vector::push_back<u64>(0x2::linked_table::borrow_mut<address, vector<u64>>(&mut arg0.bee_transfers.incoming_boxes, arg2), v3);
        if (!0x2::linked_table::contains<address, vector<u64>>(&arg0.bee_transfers.outgoing_boxes, v1)) {
            0x2::linked_table::push_back<address, vector<u64>>(&mut arg0.bee_transfers.outgoing_boxes, v1, 0x1::vector::empty<u64>());
        };
    ...
    public fun transfer_hive_treasury_funds(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: &mut BeesManager, arg2: u64) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        assert!(arg1.module_version == 4, 1079);
        assert!(0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg1.hive_treasury) >= arg2, 1145);
        let v0 = HiveWithdrawnFromTreasury{hive_withdrawn: arg2};
        0x2::event::emit<HiveWithdrawnFromTreasury>(v0);
        0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg1.hive_treasury, arg2)
    }

    public fun transfer_honey_via_dragon_school(arg0: &mut DragonSchool, arg1: &mut DragonTrainer, arg2: u64) {
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg1.available_honey, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.available_honey, arg2));
        if (arg2 > 0) {
    ...
    public fun unlock_hive_from_bee(arg0: &0x2::clock::Clock, arg1: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg2: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &mut YieldFarm, arg4: &mut DragonTrainer, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3.trading_enabled) {
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v1, 0x2::tx_context::sender(arg6), arg6);
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg1, arg2, v2, 0x2::tx_context::sender(arg6), arg6);
        } else {
            let v3 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, LockedDegenHiveAssets>(&mut arg4.id, 0x1::string::utf8(b"LOCKED_DEGEN_HIVE_ASSETS"));
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v3.hive_locked, v1);
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v3.honey_locked, v2);
    ...
    public fun update_bees_manager_config(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: &mut BeesManager, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        assert!(arg1.module_version == 4, 1079);
        if (arg2 > 0) {
    ...
    public fun update_ema_quests_played(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        let v2 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256(0x6c442d664dffc25e3fda48f15370ffaecac1f94ecb6debb46cd41ac4b38bddfa::curved_math::halfpow(v1, (arg2 as u256), v0), (v0 as u256), 1000000000000000000);
        (((v1 * v2 + (arg0 as u256) * v0 * (v0 - v2)) / v0) as u64)
    }

    fun update_global_mystic_power(arg0: &0x2::clock::Clock, arg1: &mut YieldFarm, arg2: &mut MysticalBee, arg3: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg5: u64, arg6: bool, arg7: bool) : (0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>) {
        ...
        if (arg7) {
            ...
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v2, v5);
        };
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg4) > 0) {
            lock_hive_with_bee(v4, arg1, arg2, arg4, arg5);
        } else {
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v3, arg4);
        };
        if (0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg2.nectar.hive_locked) > 0 && arg6) {
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v3, withdraw_hive_from_bee(v4, arg1, arg2, arg7));
        };
        (v2, v3)
    }

    public fun update_hidden_world_params(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: &mut HiddenWorld, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64) {
        assert!(arg1.module_version == 4, 1079);
    ...
    public fun update_inscription(arg0: &BeesManager, arg1: &mut YieldFarm, arg2: &mut DragonTrainer, arg3: 0x2::coin::Coin<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg4: 0x1::string::String, arg5: vector<0x1::string::String>, arg6: &mut 0x2::tx_context::TxContext) {
        increment_global_yield_indexes(arg1);
        let v0 = arg0.configuration.mutation_fee;
        let v1 = 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(arg3);
        assert!(v0 <= 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v1), 1122);
        deposit_hive_for_distribution(arg1, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v1, v0));
    ...
    public fun update_royalty(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: &mut BeesManager, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64) {
        assert!(arg1.module_version == 4, 1079);
        if (arg2 > 0) {
    ...
    public fun update_username(arg0: &BeesManager, arg1: &mut DegenHiveMapStore, arg2: &mut YieldFarm, arg3: &mut DragonTrainer, arg4: 0x2::coin::Coin<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(arg4);
        assert!(v2 <= 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&v3), 1122);
        deposit_hive_for_distribution(arg2, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v3, v2));
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(v3, 0x2::tx_context::sender(arg6), arg6);
    }
    ...
    public fun validate_if_can_beed(arg0: &0x2::clock::Clock, arg1: &BeesManager, arg2: address, arg3: u64, arg4: u64, arg5: &MysticalBee) : (bool, u64, u64) {
        if ((0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::get_family_type(arg5.genes) as u64) != arg4) {
            return (false, 0, 0)
        };
        ...
        let v2 = if (0x2::linked_table::contains<u64, u64>(&v0.friends_list, arg5.version)) {
            *0x2::linked_table::borrow<u64, u64>(&v0.friends_list, arg5.version)
            ...
            0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::beescience::compute_gene_price(v0.base_price, v0.curve_a, v0.eggs_incubated)
        };
    ...
    public fun whitelist_user_for_genesis_mint(arg0: &GenesisBeesUploaderCapability, arg1: &mut BeesManager, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<u64, DragonEggsBasket>(&mut arg1.dragon_eggs_basket, 420);
        if (0x2::linked_table::contains<address, u64>(&v0.whitelist_trainers_pricing, arg2)) {
            0x2::linked_table::remove<address, u64>(&mut v0.whitelist_trainers_pricing, arg2);
            0x2::linked_table::remove<address, u64>(&mut v0.whitelist_trainers_availability, arg2);
        };
    ...
    public fun withdraw_bee_for_food(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonFoodCapability, arg1: &mut BeesManager, arg2: &mut DragonTrainer, arg3: u64, arg4: address) : MysticalBee {
        let v0 = 0x2::object::uid_to_address(&arg2.id);
    ...
    public fun withdraw_funds_from_trainer(arg0: &mut DragonTrainer, arg1: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg2: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &YieldFarm, arg4: bool, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        if (arg5 && arg3.trading_enabled) {
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v1, 0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg0.available_honey));
        };
        let v2 = FundsWithdrawnFromProfile{
            profile_addr    : 0x2::object::uid_to_address(&arg0.id),
            username        : arg0.username,
            withdrawn_sui   : 0x2::balance::value<0x2::sui::SUI>(&v0),
            withdrawn_honey : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v1),
        };
        0x2::event::emit<FundsWithdrawnFromProfile>(v2);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg1, arg2, v1, 0x2::tx_context::sender(arg6), arg6);
        v0
    }
    ...
    fun withdraw_hive_from_bee(arg0: u64, arg1: &mut YieldFarm, arg2: &mut MysticalBee, arg3: bool) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE> {
        if (!arg3) {
        ...
        let v1 = HiveUnlockedFromBee{
            ...
            version             : arg2.version,
            hive_unlocked       : 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg2.nectar.hive_locked),
            wHive_decrease      : v0,
            total_weighted_hive : arg1.governance_info.total_weighted_hive,
        };
        0x2::event::emit<HiveUnlockedFromBee>(v1);
        0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg2.nectar.hive_locked)
    }

    fun withdraw_honey_from_bee(arg0: &mut YieldFarm, arg1: &mut MysticalBee) : 0x2::balance::Balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY> {
        ...
        0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg1.nectar.honey_locked)
    }
    ...
    public fun withdraw_locked_assets(arg0: &YieldFarm, arg1: &mut DragonTrainer, arg2: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &0x2::token::TokenPolicyCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v0.hive_locked), 0x2::tx_context::sender(arg4), arg4);
        0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::transfer_honey_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(arg2, arg3, 0x2::balance::withdraw_all<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut v0.honey_locked), 0x2::tx_context::sender(arg4), arg4);
    }
