module 0xd8969c4e409adf21edbdef0870408840a241d867da3e84427ff11f53fb014d78::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0x3a00fe9ee52da14c7fe0737ea73570a4cd6fdc9c83d2d86fdb0ce901fa062890::mode::Mode,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0xa70f55735b83b2b048777db8091112d15f292bc46c19ee2d70db050f5b6431b3::bytes4::to_bytes(0xa70f55735b83b2b048777db8091112d15f292bc46c19ee2d70db050f5b6431b3::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0x3a00fe9ee52da14c7fe0737ea73570a4cd6fdc9c83d2d86fdb0ce901fa062890::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x3a00fe9ee52da14c7fe0737ea73570a4cd6fdc9c83d2d86fdb0ce901fa062890::mode::serialize(arg0.manager_mode));
