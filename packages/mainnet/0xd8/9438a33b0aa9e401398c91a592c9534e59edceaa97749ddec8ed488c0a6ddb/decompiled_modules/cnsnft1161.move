module 0xd89438a33b0aa9e401398c91a592c9534e59edceaa97749ddec8ed488c0a6ddb::cnsnft1161 {
    struct CNSNFT1161 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1161, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1161>(arg0, arg1);
