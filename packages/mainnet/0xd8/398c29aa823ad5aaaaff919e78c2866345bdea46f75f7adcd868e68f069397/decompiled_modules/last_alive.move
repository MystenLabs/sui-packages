module 0xd8398c29aa823ad5aaaaff919e78c2866345bdea46f75f7adcd868e68f069397::last_alive {
    ...
    struct BonusRewardsEvent has copy, drop {
        nft_id: 0x2::object::ID,
        game_round: u64,
        claimer: address,
        has_token_rewards: bool,
        has_nft_rewards: bool,
        token_rewards: vector<TokenReward>,
        nft_rewards: vector<NFTReward>,
    }

    struct BonusRewardsSentEvent has copy, drop {
        nft_id: 0x2::object::ID,
        game_round: u64,
        recipient: address,
        token_types_sent: vector<0x1::string::String>,
        nft_types_sent: vector<0x1::string::String>,
        sender: address,
    }

    struct PendingRewardsEvent has copy, drop {
        game_round: u64,
        has_token_rewards: bool,
        has_nft_rewards: bool,
        token_rewards: vector<TokenReward>,
    ...
    public entry fun add_external_nft_reward<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<T0>(arg2, 0x2::tx_context::sender(arg3));
    ...
    public entry fun claim_sui_rewards(arg0: &mut RewardsPool, arg1: &GameState, arg2: &mut NFT, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::table::contains<u64, vector<TokenReward>>(&arg0.pending_token_rewards, v1) && !0x1::vector::is_empty<TokenReward>(0x2::table::borrow<u64, vector<TokenReward>>(&arg0.pending_token_rewards, v1));
        let v7 = 0x2::table::contains<u64, vector<NFTReward>>(&arg0.pending_nft_rewards, v1) && !0x1::vector::is_empty<NFTReward>(0x2::table::borrow<u64, vector<NFTReward>>(&arg0.pending_nft_rewards, v1));
        if (v6 || v7) {
            let v8 = if (v6) {
                *0x2::table::borrow<u64, vector<TokenReward>>(&arg0.pending_token_rewards, v1)
            } else {
                0x1::vector::empty<TokenReward>()
            };
            let v9 = if (v7) {
                *0x2::table::borrow<u64, vector<NFTReward>>(&arg0.pending_nft_rewards, v1)
            } else {
                0x1::vector::empty<NFTReward>()
            };
            let v10 = BonusRewardsEvent{
                nft_id            : v0,
                game_round        : v1,
                claimer           : v2,
                has_token_rewards : v6,
                has_nft_rewards   : v7,
                token_rewards     : v8,
                nft_rewards       : v9,
            };
            0x2::event::emit<BonusRewardsEvent>(v10);
        };
        let v11 = ChampionUpdateEvent{
            nft_id     : v0,
            game_round : arg2.game_round,
            owner      : v2,
            timestamp  : 0x2::tx_context::epoch(arg3),
        };
        0x2::event::emit<ChampionUpdateEvent>(v11);
    }
    ...
    public entry fun list_pending_rewards(arg0: &RewardsPool, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::contains<u64, vector<TokenReward>>(&arg0.pending_token_rewards, arg1);
        let v1 = if (v0) {
            *0x2::table::borrow<u64, vector<TokenReward>>(&arg0.pending_token_rewards, arg1)
        } else {
            0x1::vector::empty<TokenReward>()
        };
        let v2 = 0x2::table::contains<u64, vector<NFTReward>>(&arg0.pending_nft_rewards, arg1);
        let v3 = if (v2) {
            *0x2::table::borrow<u64, vector<NFTReward>>(&arg0.pending_nft_rewards, arg1)
        } else {
            0x1::vector::empty<NFTReward>()
        };
        let v4 = PendingRewardsEvent{
            game_round        : arg1,
            has_token_rewards : v0,
            has_nft_rewards   : v2,
            token_rewards     : v1,
            nft_rewards       : v3,
            requester         : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<PendingRewardsEvent>(v4);
    }
    ...
    public entry fun send_bonus_rewards<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == arg0.owner, 4);
        let v0 = 0;
        if (0x2::table::contains<0x2::object::ID, NFTRegistry>(&arg0.nft_registry, arg2)) {
            assert!(0x2::table::borrow<0x2::object::ID, NFTRegistry>(&arg0.nft_registry, arg2).trait == 0x1::string::utf8(b"Champion"), 4);
        } else {
            let v1 = false;
            let v2 = 0;
            while (v2 <= arg0.current_round) {
                if (0x2::table::contains<u64, vector<WinnerRecord>>(&arg0.winners, v2)) {
                    let v3 = 0x2::table::borrow<u64, vector<WinnerRecord>>(&arg0.winners, v2);
                    let v4 = 0;
                    while (v4 < 0x1::vector::length<WinnerRecord>(v3)) {
                        let v5 = 0x1::vector::borrow<WinnerRecord>(v3, v4);
                        if (v5.nft_id == arg2) {
                            v0 = v5.round;
                            v1 = true;
                            break
        ...
        assert!(is_round_ended(arg0, v0), 11);
        assert!(0x2::coin::value<T0>(&arg3) >= arg4, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, arg4, arg6), arg5);
        ...
        0x1::vector::push_back<0x1::string::String>(&mut v6, 0x1::string::utf8(b"TOKEN"));
        let v7 = BonusRewardsSentEvent{
            nft_id           : arg2,
            game_round       : v0,
            recipient        : arg5,
            token_types_sent : v6,
            nft_types_sent   : 0x1::vector::empty<0x1::string::String>(),
            sender           : 0x2::tx_context::sender(arg6),
        };
        0x2::event::emit<BonusRewardsSentEvent>(v7);
    }

    public entry fun send_nft_bonus_reward<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::object::ID, arg3: T0, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_round_ended(arg0, v0), 11);
        0x2::transfer::public_transfer<T0>(arg3, arg4);
        let v6 = 0x1::vector::empty<0x1::string::String>();
        0x1::vector::push_back<0x1::string::String>(&mut v6, 0x1::string::utf8(b"EXTERNAL_NFT"));
        let v7 = BonusRewardsSentEvent{
            nft_id           : arg2,
            game_round       : v0,
            recipient        : arg4,
            token_types_sent : 0x1::vector::empty<0x1::string::String>(),
            nft_types_sent   : v6,
