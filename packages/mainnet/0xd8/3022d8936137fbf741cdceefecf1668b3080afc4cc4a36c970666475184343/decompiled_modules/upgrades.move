module 0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::upgrades {
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeCap, arg1: &mut 0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::state::State<T0>, arg2: 0x2::package::UpgradeReceipt) {
        0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::state::set_version<T0>(arg1, 0);
        0x2::package::commit_upgrade(&mut arg0.cap, arg2);
    }

    public fun check_version<T0>(arg0: VersionGated, arg1: &0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::state::State<T0>) {
        let VersionGated {  } = arg0;
        if (0xd83022d8936137fbf741cdceefecf1668b3080afc4cc4a36c970666475184343::state::get_version<T0>(arg1) != 0) {
