module 0xc91f57eb0fb3c35759a8c850fe1ee79f2b3bd7b93fbc32da54a8573f0916ec8d::ika_chan {
    struct IKA_CHAN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IKA_CHAN, arg1: &mut 0x2::tx_context::TxContext) {
        abort 1
    }
