module 0xd81186d0413aa3c5b681a2baff880ec2189c95cc37656f783160df7fbd72983a::gift7621 {
    struct GIFT7621 has drop {
        dummy_field: bool,
    }

    struct TICKET_7621 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7621(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7621>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7621>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7621, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7621>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7621>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7621>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7621>>(v5, 0x2::tx_context::sender(arg1));
    }
