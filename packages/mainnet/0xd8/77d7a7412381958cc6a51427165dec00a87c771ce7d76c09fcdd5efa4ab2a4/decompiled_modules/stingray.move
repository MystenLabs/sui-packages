module 0xd877d7a7412381958cc6a51427165dec00a87c771ce7d76c09fcdd5efa4ab2a4::stingray {
    ...
    public fun unfilled_amount<T0>(arg0: &Stingray, arg1: 0x2::object::ID) : u64 {
        let v0 = FeeCollector<T0>{dummy_field: false};
        0x2::vec_map::get<0x2::object::ID, UnfilledAmount>(&0x2::dynamic_field::borrow<FeeCollector<T0>, Collector<T0>>(&arg0.id, v0).record, &arg1).pos0
    }
