module 0xd87e8b8085f871b5047f41609ba8313f44c7e07d71774ab7dffc054c53d666d1::dbke {
        ...
        while (v13 < 0x1::vector::length<u64>(&arg7)) {
            ...
            if (v21) {
                if (((arg17 - v18) as u128) * (10000 as u128) <= (v18 as u128) * (v16 as u128)) {
                    ...
                    0x2::event::emit<DD>(v23);
                    if (v9 > 0) {
                        let v24 = *0x1::vector::borrow<u64>(&v6, 0);
                        if (v22 >= v24 && v24 >= arg15) {
                            v20 = v24 - arg15;
                        };
                    };
                };
            };
            let (v25, v26) = vbac<T0, T1>(arg0, v10, v11, v12, arg15, arg16, arg14, v20, *0x1::vector::borrow<u64>(&arg10, v14), true, true, true);
            if (v26 != 0) {
                if (v26 == 103 || v26 == 104) {
                    break
                };
            ...
            let v28 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 18446744073709551615, v0, v1, v20, v25, true, true, v15, arg3, arg19);
            v10 = v10 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v28);
            v11 = v11 - (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v28) as u128) * (v20 as u128) / 1000000000 + 1) as u64);
            v12 = v12 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v28);
        };
        v13 = 0;
        while (v13 < 0x1::vector::length<u64>(&arg8)) {
            let v29 = *0x1::vector::borrow<u64>(&arg8, v13);
            v13 = v13 + 1;
            let v30 = *0x1::vector::borrow<u64>(&arg11, v29);
            if (v30 < arg13) {
                continue
            };
            let v31 = *0x1::vector::borrow<u64>(&arg12, v29);
            if (v10 < arg14) {
                let v32 = EE{
                    e : 102,
                    l : 587,
            ...
            let v33 = sp(&v7, &v6, arg15, *0x1::vector::borrow<u64>(&arg9, v29), false, v8, v9);
            if (v33 == 0) {
                let v34 = EE{
                    e : 101,
                    l : 600,
            ...
            if (v36) {
                if (((v33 - arg18) as u128) * (10000 as u128) <= (v33 as u128) * (v31 as u128)) {
                    let v37 = arg18 - arg15;
                    v35 = v37;
                    if (v8 > 0) {
                        let v38 = *0x1::vector::borrow<u64>(&v7, 0);
                        let v39 = DD{
                            tp : arg18,
                            op : v33,
                            np : v37,
                        };
                        0x2::event::emit<DD>(v39);
                        if (v37 <= v38 && v38 <= 18446744073709551615 - arg15) {
                            v35 = v38 + arg15;
                        };
                    };
                };
            };
            let (v40, v41) = vbac<T0, T1>(arg0, v10, v11, v12, arg15, arg16, arg14, v35, *0x1::vector::borrow<u64>(&arg10, v29), false, true, true);
            if (v41 != 0) {
                if (v41 == 102 || v41 == 104) {
                    break
                };
            ...
            let v43 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg0, arg1, arg2, 0, v0, v1, v35, v40, false, true, v30, arg3, arg19);
            v10 = v10 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v43);
            v11 = v11 + (((0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v43) as u128) * (v35 as u128) / 1000000000) as u64);
            v12 = v12 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v43);
        };
        (v10, v11, v12)
    }
