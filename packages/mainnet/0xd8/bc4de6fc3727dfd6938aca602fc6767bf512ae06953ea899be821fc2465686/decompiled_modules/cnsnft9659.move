module 0xd8bc4de6fc3727dfd6938aca602fc6767bf512ae06953ea899be821fc2465686::cnsnft9659 {
    struct CNSNFT9659 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9659, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9659>(arg0, arg1);
