module 0xd8a4923f13916d16e8e0b920634e3ae98a754ae029307e901277ccb0aa506b87::cnsnft6136 {
    struct CNSNFT6136 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6136, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6136>(arg0, arg1);
