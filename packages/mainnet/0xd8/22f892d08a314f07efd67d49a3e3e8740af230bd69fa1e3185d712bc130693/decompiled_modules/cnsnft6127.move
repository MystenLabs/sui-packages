module 0xd822f892d08a314f07efd67d49a3e3e8740af230bd69fa1e3185d712bc130693::cnsnft6127 {
    struct CNSNFT6127 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6127, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6127>(arg0, arg1);
