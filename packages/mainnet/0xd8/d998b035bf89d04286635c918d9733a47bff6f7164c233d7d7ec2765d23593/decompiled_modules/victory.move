module 0xd8d998b035bf89d04286635c918d9733a47bff6f7164c233d7d7ec2765d23593::victory {
    ...
    struct Victory has store, key {
        ...
        url: 0x2::url::Url,
        attributes: 0xd8d998b035bf89d04286635c918d9733a47bff6f7164c233d7d7ec2765d23593::attributes::ImmAttributes,
    }
    ...
    public entry fun mint(arg0: &OwnerCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Victory{
            id         : 0x2::object::new(arg7),
            name       : 0x1::string::utf8(arg1),
            image_url  : 0x2::url::new_unsafe_from_bytes(arg2),
            url        : 0x2::url::new_unsafe_from_bytes(arg3),
            attributes : 0xd8d998b035bf89d04286635c918d9733a47bff6f7164c233d7d7ec2765d23593::attributes::from_vec(arg4, arg5),
        };
        0x2::transfer::transfer<Victory>(v0, arg6);
    }

    public entry fun mint_to_kiosk(arg0: &OwnerCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Victory{
            id         : 0x2::object::new(arg7),
            name       : 0x1::string::utf8(arg1),
            image_url  : 0x2::url::new_unsafe_from_bytes(arg2),
