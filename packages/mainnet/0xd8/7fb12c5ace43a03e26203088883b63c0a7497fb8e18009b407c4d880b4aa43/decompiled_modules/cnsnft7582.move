module 0xd87fb12c5ace43a03e26203088883b63c0a7497fb8e18009b407c4d880b4aa43::cnsnft7582 {
    struct CNSNFT7582 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7582, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTRU2LVfvwnEAZceKHWq2ZqZaJWjcNtV2Bqi2hkhVDpvB?ref=1420"));
        let v4 = 0x2::package::claim<CNSNFT7582>(arg0, arg1);
