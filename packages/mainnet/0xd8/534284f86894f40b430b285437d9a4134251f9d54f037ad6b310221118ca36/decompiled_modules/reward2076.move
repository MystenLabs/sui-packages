module 0xd8534284f86894f40b430b285437d9a4134251f9d54f037ad6b310221118ca36::reward2076 {
    struct REWARD2076 has drop {
        dummy_field: bool,
    }

    struct TICKET_2076 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2076(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2076>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2076>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2076, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2076>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2076>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2076>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2076>>(v5, 0x2::tx_context::sender(arg1));
    }
