module 0xd8bfa67e70f55bd1ff7094968f68db179f12d31aaac1e7a8ed5058346e4ebd72::cnsnft4427 {
    struct CNSNFT4427 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4427, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4427>(arg0, arg1);
