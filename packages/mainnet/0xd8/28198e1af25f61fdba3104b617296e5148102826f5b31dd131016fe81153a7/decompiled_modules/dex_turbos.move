module 0xd828198e1af25f61fdba3104b617296e5148102826f5b31dd131016fe81153a7::dex_turbos {
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0xd828198e1af25f61fdba3104b617296e5148102826f5b31dd131016fe81153a7::constants::get_turbos_sui_usdc_pool(),
        };
