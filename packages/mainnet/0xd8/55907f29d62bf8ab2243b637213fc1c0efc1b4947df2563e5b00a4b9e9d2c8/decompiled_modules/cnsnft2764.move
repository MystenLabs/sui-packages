module 0xd855907f29d62bf8ab2243b637213fc1c0efc1b4947df2563e5b00a4b9e9d2c8::cnsnft2764 {
    struct CNSNFT2764 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2764, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2764>(arg0, arg1);
