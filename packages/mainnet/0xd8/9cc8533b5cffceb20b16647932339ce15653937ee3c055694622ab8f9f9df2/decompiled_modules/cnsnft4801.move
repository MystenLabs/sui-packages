module 0xd89cc8533b5cffceb20b16647932339ce15653937ee3c055694622ab8f9f9df2::cnsnft4801 {
    struct CNSNFT4801 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4801, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4801>(arg0, arg1);
