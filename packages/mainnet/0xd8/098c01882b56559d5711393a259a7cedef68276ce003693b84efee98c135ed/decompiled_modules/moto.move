module 0xd8098c01882b56559d5711393a259a7cedef68276ce003693b84efee98c135ed::moto {
    struct MOTO has drop {
        dummy_field: bool,
    }

    fun init(arg0: MOTO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MOTO>(arg0, 6, b"MOTO", b"Moto Moto", b"Big, chunky, and impossible to ignore.  MOTO MOTO is crashing onto the Sui network with style.  Don't miss out, because MOTO MOTO's got his eyes on you!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/moto_1_a704118a0c.png")), arg1);
