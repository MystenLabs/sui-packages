module 0xd8ff73c12752443748e301ce85e89cba7688fe370d4d8fb70901aeadce77e0e4::it {
    struct IT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<IT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"It          ")))), trim_right(b"It Coin                         "), trim_right(b"See $it stack $it Send $it                                                                                                                                                                                                                                                                                                      "), v2, arg1);
