module 0xd8f5f1d3ff543b4dfe01c853c5765544a09d5b01b11391059be68a08292df33f::cnsnft8996 {
    struct CNSNFT8996 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8996, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8996>(arg0, arg1);
