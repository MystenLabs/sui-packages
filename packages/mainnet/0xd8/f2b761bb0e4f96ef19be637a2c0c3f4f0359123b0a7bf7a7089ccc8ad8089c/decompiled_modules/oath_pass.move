module 0xd8f2b761bb0e4f96ef19be637a2c0c3f4f0359123b0a7bf7a7089ccc8ad8089c::oath_pass {
    struct OATH_PASS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: OATH_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<OATH_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Oath Pass"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"With the Oath Pass, you have sworn allegiance to The Order, joining an elite circle of 666 seekers. Embark on a journey shrouded in mystery, where truths are revealed only to the devoted. www.theorder.site"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeih7wbdpkipkg5zqx2nhettf7klzd2o7aewoqf6si7rkxeizlk5mge"));
