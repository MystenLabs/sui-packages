module 0x1eafada0672ad3939134223bca1638124b1bd5512bf88398cf3bbc451b983c8c::admin {
    ...
    public fun admin_vault_transfer_balance<T0>(arg0: &AdminCap, arg1: &mut 0x1eafada0672ad3939134223bca1638124b1bd5512bf88398cf3bbc451b983c8c::vault::Vault<T0>, arg2: &mut 0x1eafada0672ad3939134223bca1638124b1bd5512bf88398cf3bbc451b983c8c::vault::Vault<T0>, arg3: u64, arg4: bool) {
        let v0 = if (arg4) {
            0x1::option::none<u64>()
        } else {
            0x1::option::some<u64>(arg3)
        };
        0x1eafada0672ad3939134223bca1638124b1bd5512bf88398cf3bbc451b983c8c::vault::transfer_balance<T0>(arg1, arg2, v0);
    }
    ...
    public fun admin_withdraw_to_address<T0>(arg0: &AdminCap, arg1: &mut 0x1eafada0672ad3939134223bca1638124b1bd5512bf88398cf3bbc451b983c8c::vault::Vault<T0>, arg2: address, arg3: u64, arg4: bool, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg4) {
            0x1::option::none<u64>()
        } else {
            0x1::option::some<u64>(arg3)
        };
        0x1eafada0672ad3939134223bca1638124b1bd5512bf88398cf3bbc451b983c8c::vault::transfer_to_address<T0>(arg1, arg2, v0, arg5);
    }
