module 0x79af4279befacb29edca11e3a0bd0fe9296e2704bf2a645007c2d5bf752e285d::subscription {
    ...
    public fun mint_test_usdc(arg0: &mut 0x2::coin::TreasuryCap<USDC>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<USDC>>(0x2::coin::mint<USDC>(arg0, arg1, arg3), arg2);
    }

    public fun pay_enterprise(arg0: &mut Treasury, arg1: 0x2::coin::Coin<USDC>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun pay_premium(arg0: &mut Treasury, arg1: 0x2::coin::Coin<USDC>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<USDC>(&arg1);
        assert!(v0 == 9990000, 1);
        0x2::balance::join<USDC>(&mut arg0.balance, 0x2::coin::into_balance<USDC>(arg1));
        let v1 = 0x2::object::new(arg3);
