module 0x2b71664477755b90f9fb71c9c944d5d0d3832fec969260e3f18efc7d855f57c4::farming_reward {
    ...
    public(friend) fun claim_rewarder<T0: drop>(arg0: u64, arg1: &mut RewardPool, arg2: &mut 0x2::vec_map::VecMap<0x2::object::ID, u256>, arg3: &mut 0x2::vec_map::VecMap<0x2::object::ID, u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        while (!0x1::vector::is_empty<0x2::object::ID>(&v1)) {
            ...
            if (v11 > 0) {
                0x2::coin::join<T0>(&mut v2, 0x2::coin::from_balance<T0>(0xe02f3a5e3f585b445a1b6af49361d813af747deef95e587db81caa1ff71ce914::balance_bag::split<T0>(&mut arg1.vault, v11), arg5));
    ...
    public(friend) fun remove_rewarder(arg0: &mut RewardPool, arg1: 0x2::object::ID) {
        ...
        let v2 = v1;
        assert!(v2.total_reward <= v2.reward_harvested + 1000, 0xe02f3a5e3f585b445a1b6af49361d813af747deef95e587db81caa1ff71ce914::error::reward_not_harvested());
