module 0x795d7c01227185cd574d2dbb8203be5c88bd07ce1d230857a43682e2638ac096::cnsnft1431 {
    struct CNSNFT1431 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1431, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1431>(arg0, arg1);
