module 0x790f1f5768aaea3bd490131bec7b4efe85bb9b44429c2fd6cbf99cfb76cc1d35::reward4994 {
    struct REWARD4994 has drop {
        dummy_field: bool,
    }

    struct TICKET_4994 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4994(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4994>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4994>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4994, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4994>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4994>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4994>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4994>>(v5, 0x2::tx_context::sender(arg1));
    }
