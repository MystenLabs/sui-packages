module 0x79df3ecb05c2f4ea0d90d4134ccc5d05ec5407d30d7d13454ae149c96d46ab7f::utils {
    public(friend) fun only_one_some<T0, T1>(arg0: &0x1::option::Option<T0>, arg1: &0x1::option::Option<T1>) {
        assert!(0x1::option::is_some<T0>(arg0) && 0x1::option::is_none<T1>(arg1) || 0x1::option::is_none<T0>(arg0) && 0x1::option::is_some<T1>(arg1), 13906834273127628799);
    }
