module 0x790cbf49f4d12023d556feb1ce483dca46523f673060f3b80bedaad08197f086::cnsnft1469 {
    struct CNSNFT1469 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1469, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1469>(arg0, arg1);
