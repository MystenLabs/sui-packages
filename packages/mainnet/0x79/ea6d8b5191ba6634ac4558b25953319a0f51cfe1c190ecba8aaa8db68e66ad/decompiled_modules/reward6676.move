module 0x79ea6d8b5191ba6634ac4558b25953319a0f51cfe1c190ecba8aaa8db68e66ad::reward6676 {
    struct REWARD6676 has drop {
        dummy_field: bool,
    }

    struct TICKET_6676 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6676(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6676>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6676>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6676, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6676>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6676>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6676>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6676>>(v5, 0x2::tx_context::sender(arg1));
    }
