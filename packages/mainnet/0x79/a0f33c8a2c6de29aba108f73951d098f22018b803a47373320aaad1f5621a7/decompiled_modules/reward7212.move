module 0x79a0f33c8a2c6de29aba108f73951d098f22018b803a47373320aaad1f5621a7::reward7212 {
    struct REWARD7212 has drop {
        dummy_field: bool,
    }

    struct TICKET_7212 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7212(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7212>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7212>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7212, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7212>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7212>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7212>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7212>>(v5, 0x2::tx_context::sender(arg1));
    }
