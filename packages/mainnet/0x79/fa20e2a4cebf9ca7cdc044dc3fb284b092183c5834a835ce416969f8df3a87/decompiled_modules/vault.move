module 0x79fa20e2a4cebf9ca7cdc044dc3fb284b092183c5834a835ce416969f8df3a87::vault {
    ...
    public entry fun receive_deposit<T0>(arg0: &mut Vault, arg1: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>) {
    ...
    public entry fun transfer_admin(arg0: AdminCap, arg1: &mut Vault, arg2: address, arg3: &0x2::tx_context::TxContext) {
    ...
    public entry fun withdraw_and_receive<T0>(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
