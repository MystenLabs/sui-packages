module 0x79639bf1a840e24434f4e6f6f7e7c43f147f71f69eb765cfe6d9b02ae30bfe1f::events {
    ...
    public(friend) fun emit_add_registry_event<T0>(arg0: vector<u8>, arg1: &0x2::tx_context::TxContext) {
        let v0 = AddRegistryEvent{
            ...
            xasset_type : 0x1::ascii::string(0x79639bf1a840e24434f4e6f6f7e7c43f147f71f69eb765cfe6d9b02ae30bfe1f::utils::type_to_bytes<T0>()),
            price_id    : arg0,
        };
