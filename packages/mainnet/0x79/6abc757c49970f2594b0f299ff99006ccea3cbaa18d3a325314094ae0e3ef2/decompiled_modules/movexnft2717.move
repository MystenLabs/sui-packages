module 0x796abc757c49970f2594b0f299ff99006ccea3cbaa18d3a325314094ae0e3ef2::movexnft2717 {
    struct MOVEXNFT2717 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2717, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2717>(arg0, arg1);
