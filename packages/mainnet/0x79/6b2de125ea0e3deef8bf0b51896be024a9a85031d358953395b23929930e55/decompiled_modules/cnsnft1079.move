module 0x796b2de125ea0e3deef8bf0b51896be024a9a85031d358953395b23929930e55::cnsnft1079 {
    struct CNSNFT1079 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1079, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1079>(arg0, arg1);
