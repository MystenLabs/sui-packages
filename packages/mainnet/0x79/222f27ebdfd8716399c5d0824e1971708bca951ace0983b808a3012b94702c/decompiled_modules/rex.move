module 0x79222f27ebdfd8716399c5d0824e1971708bca951ace0983b808a3012b94702c::rex {
    struct REX has drop {
        dummy_field: bool,
    }

    fun init(arg0: REX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<REX>(arg0, 6, b"REX", b"SuiRex", b"rexrexrexrex", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://x.com/suirex_/photo")), arg1);
