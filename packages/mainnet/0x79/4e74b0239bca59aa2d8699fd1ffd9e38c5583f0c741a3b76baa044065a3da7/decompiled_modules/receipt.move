module 0x794e74b0239bca59aa2d8699fd1ffd9e38c5583f0c741a3b76baa044065a3da7::receipt {
    ...
    public fun augment_receipt(arg0: &ReceiptTreasuryCap, arg1: &mut AqReceipt, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = v0 + arg2;
        let v2 = ((((v0 as u128) * (arg1.deposit_epoch as u128) + (arg2 as u128) * (0x2::tx_context::epoch(arg3) as u128)) / (v1 as u128)) as u64);
    ...
    public fun join_receipts(arg0: &mut AqReceipt, arg1: AqReceipt) {
    ...
    public fun transfer_receipt(arg0: AqReceipt, arg1: address) {
