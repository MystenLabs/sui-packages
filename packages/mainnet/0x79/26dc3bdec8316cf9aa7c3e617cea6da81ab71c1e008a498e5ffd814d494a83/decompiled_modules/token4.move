module 0x7926dc3bdec8316cf9aa7c3e617cea6da81ab71c1e008a498e5ffd814d494a83::token4 {
    ...
    fun init(arg0: TOKEN4, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN4>(arg0, 9, b"li.fi", b"li.fi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
