module 0x795be7029c17eca03e66182070dcbc31d7cc2208736c60df025d08d41d12ea7e::doge {
    struct DOGE has drop {
        dummy_field: bool,
    }

    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/0FtkKjLE9PIaIdfHCF_ppx74Apym8v4CWzBMOfaJcoM";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/0FtkKjLE9PIaIdfHCF_ppx74Apym8v4CWzBMOfaJcoM"))
        };
