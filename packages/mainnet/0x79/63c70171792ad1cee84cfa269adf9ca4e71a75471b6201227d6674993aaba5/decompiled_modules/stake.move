module 0x7963c70171792ad1cee84cfa269adf9ca4e71a75471b6201227d6674993aaba5::stake {
    ...
    public entry fun Stake<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<Staker<T0>>(v4, v1);
        let v5 = StakeAdded<T0>{
            lender     : v1,
            amount     : v3,
            start_time : v0,
        };
        0x2::event::emit<StakeAdded<T0>>(v5);
    }
