module 0x79d78336891321e64b035790f4f5233fab52048f000747016b582f2f907b8d34::cnsnft8463 {
    struct CNSNFT8463 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8463, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9063"));
        let v4 = 0x2::package::claim<CNSNFT8463>(arg0, arg1);
