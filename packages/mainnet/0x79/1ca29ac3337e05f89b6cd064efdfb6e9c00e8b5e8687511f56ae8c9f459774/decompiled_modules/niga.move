module 0x791ca29ac3337e05f89b6cd064efdfb6e9c00e8b5e8687511f56ae8c9f459774::niga {
    ...
    fun init(arg0: NIGA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NIGA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"NIGA"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"NIGA "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicbd6ck4iyiykbyl33dyhtjpociwjiowdzrcz52lttmwlua6lfaty"));
