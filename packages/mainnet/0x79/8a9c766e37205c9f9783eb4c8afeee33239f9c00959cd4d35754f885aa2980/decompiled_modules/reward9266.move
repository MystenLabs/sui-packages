module 0x798a9c766e37205c9f9783eb4c8afeee33239f9c00959cd4d35754f885aa2980::reward9266 {
    struct REWARD9266 has drop {
        dummy_field: bool,
    }

    struct TICKET_9266 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9266(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9266>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9266>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9266, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9266>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9266>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9266>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9266>>(v5, 0x2::tx_context::sender(arg1));
    }
