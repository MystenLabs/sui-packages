module 0x7902563490e8610dd4d22bcc0511becaa524a7f5c374e103eb9e92b0bad381aa::allowlist {
    ...
    fun approve_internal(arg0: address, arg1: vector<u8>, arg2: &Allowlist) : bool {
        if (!0x7902563490e8610dd4d22bcc0511becaa524a7f5c374e103eb9e92b0bad381aa::utils::is_prefix(namespace(arg2), arg1)) {
            return false
        };
