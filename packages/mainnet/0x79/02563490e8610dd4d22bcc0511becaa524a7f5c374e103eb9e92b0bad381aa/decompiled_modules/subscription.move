module 0x7902563490e8610dd4d22bcc0511becaa524a7f5c374e103eb9e92b0bad381aa::subscription {
    ...
    fun approve_internal(arg0: vector<u8>, arg1: &Subscription, arg2: &Service, arg3: &0x2::clock::Clock) : bool {
        ...
        0x7902563490e8610dd4d22bcc0511becaa524a7f5c374e103eb9e92b0bad381aa::utils::is_prefix(0x2::object::uid_to_bytes(&arg2.id), arg0)
    }
