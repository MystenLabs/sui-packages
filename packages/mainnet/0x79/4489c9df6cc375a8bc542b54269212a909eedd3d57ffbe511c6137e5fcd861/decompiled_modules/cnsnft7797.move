module 0x794489c9df6cc375a8bc542b54269212a909eedd3d57ffbe511c6137e5fcd861::cnsnft7797 {
    struct CNSNFT7797 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7797, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6295"));
        let v4 = 0x2::package::claim<CNSNFT7797>(arg0, arg1);
