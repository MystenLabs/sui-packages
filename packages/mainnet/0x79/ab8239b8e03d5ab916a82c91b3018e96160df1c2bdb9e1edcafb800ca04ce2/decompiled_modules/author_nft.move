module 0x79ab8239b8e03d5ab916a82c91b3018e96160df1c2bdb9e1edcafb800ca04ce2::author_nft {
    ...
    fun init(arg0: AUTHOR_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = LiteraryCollection{
            ...
            name             : 0x1::string::utf8(b"Literary Magazine Collection"),
            description      : 0x1::string::utf8(b"A curated collection of literary works published by our magazine, featuring stories, poems, and essays from talented authors."),
            website          : 0x1::string::utf8(b"https://your-magazine.com"),
            creator          : v1,
            total_minted     : 0,
            authors          : 0x2::vec_map::empty<0x1::string::String, u64>(),
            collection_image : 0x2::url::new_unsafe_from_bytes(b"https://your-magazine.com/collection-logo.png"),
            twitter          : 0x1::string::utf8(b"@your_magazine"),
            discord          : 0x1::string::utf8(b"https://discord.gg/your_magazine"),
        };
        ...
        0x2::display::add<LiteraryCollection>(&mut v6, 0x1::string::utf8(b"discord"), 0x1::string::utf8(b"{discord}"));
    ...
    public fun update_collection_info(arg0: &PublisherCap, arg1: &mut LiteraryCollection, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        arg1.name = arg2;
