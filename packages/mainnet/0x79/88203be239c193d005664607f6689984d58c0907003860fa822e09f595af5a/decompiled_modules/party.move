module 0x7988203be239c193d005664607f6689984d58c0907003860fa822e09f595af5a::party {
    ...
    public entry fun consumeCoin<T0>(arg0: &mut Reserve<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::coin::destroy_zero<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.sui, 0x2::balance::value<T0>(&arg0.sui)), arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.sui, 0), arg1), 0x2::tx_context::sender(arg1));
    }
