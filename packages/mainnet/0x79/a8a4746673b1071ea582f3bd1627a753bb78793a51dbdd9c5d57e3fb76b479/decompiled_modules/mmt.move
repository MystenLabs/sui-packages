module 0x79a8a4746673b1071ea582f3bd1627a753bb78793a51dbdd9c5d57e3fb76b479::mmt {
    struct MMT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MMT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<MMT>>(0x2::coin::mint<MMT>(&mut v2, 10000000000000000000, arg1), 0x2::tx_context::sender(arg1));
