module 0x795850160289c0ec8f84b3117a4afd37d7bf5638078af7131dabe9ffeea0a8dd::reward1950 {
    struct REWARD1950 has drop {
        dummy_field: bool,
    }

    struct TICKET_1950 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1950(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1950>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1950>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1950, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1950>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1950>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1950>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1950>>(v5, 0x2::tx_context::sender(arg1));
    }
