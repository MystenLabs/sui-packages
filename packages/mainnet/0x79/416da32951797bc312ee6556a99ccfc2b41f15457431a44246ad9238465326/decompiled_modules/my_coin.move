module 0x79416da32951797bc312ee6556a99ccfc2b41f15457431a44246ad9238465326::my_coin {
    struct MY_COIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: MY_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MY_COIN>(arg0, 6, b"MYC", b"My Coin", b"Coin deployed by f4tb3e", 0x1::option::none<0x2::url::Url>(), arg1);
