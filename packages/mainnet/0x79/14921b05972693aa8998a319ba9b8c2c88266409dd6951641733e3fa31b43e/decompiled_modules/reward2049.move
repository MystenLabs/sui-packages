module 0x7914921b05972693aa8998a319ba9b8c2c88266409dd6951641733e3fa31b43e::reward2049 {
    struct REWARD2049 has drop {
        dummy_field: bool,
    }

    struct TICKET_2049 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2049(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2049>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2049>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2049, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2049>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2049>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2049>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2049>>(v5, 0x2::tx_context::sender(arg1));
    }
