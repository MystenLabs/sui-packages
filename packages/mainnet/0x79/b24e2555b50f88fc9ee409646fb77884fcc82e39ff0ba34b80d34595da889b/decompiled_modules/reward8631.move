module 0x79b24e2555b50f88fc9ee409646fb77884fcc82e39ff0ba34b80d34595da889b::reward8631 {
    struct REWARD8631 has drop {
        dummy_field: bool,
    }

    struct TICKET_8631 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8631(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8631>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8631>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8631, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8631>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8631>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8631>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8631>>(v5, 0x2::tx_context::sender(arg1));
    }
