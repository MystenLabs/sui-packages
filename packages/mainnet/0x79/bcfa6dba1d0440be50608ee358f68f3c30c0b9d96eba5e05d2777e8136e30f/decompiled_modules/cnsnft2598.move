module 0x79bcfa6dba1d0440be50608ee358f68f3c30c0b9d96eba5e05d2777e8136e30f::cnsnft2598 {
    struct CNSNFT2598 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2598, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2598>(arg0, arg1);
