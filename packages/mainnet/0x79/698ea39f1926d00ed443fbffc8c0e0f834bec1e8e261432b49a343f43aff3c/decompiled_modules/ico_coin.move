module 0x79698ea39f1926d00ed443fbffc8c0e0f834bec1e8e261432b49a343f43aff3c::ico_coin {
    struct ICO has drop {
        dummy_field: bool,
    }
    ...
    public fun get_lightweight_info() : (0x1::string::String, 0x1::string::String, u8) {
        (0x1::string::utf8(b"ZBO"), 0x1::string::utf8(b"ZBO Protocol"), 9)
    }

    public fun get_realtime_info() : (u64, u64, u64, u64) {
        (100000000000000, 100000000000000, 1, 0)
    }

    public fun get_token_display_info() : (0x1::string::String, 0x1::string::String, u8, 0x1::string::String, 0x1::string::String) {
        (0x1::string::utf8(b"ZBO Protocol"), 0x1::string::utf8(b"ZBO"), 9, 0x1::string::utf8(b"100000"), 0x1::string::utf8(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreibiiffprjvznukjsut6jqz6dik7zghlv6ycvpdocgx4dgzi4jxsc4"))
    }

    fun init(arg0: ICO_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ICO_COIN>(arg0, 9, b"ZBO", b"ZBO Protocol", b"ZBO is a utility token built on Sui blockchain with advanced features including batch transfers, burn mechanisms, and Web3 wallet compatibility. ZBO serves as the native utility token for the ZBO ecosystem.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://magenta-quickest-fly-406.mypinata.cloud/ipfs/bafkreibiiffprjvznukjsut6jqz6dik7zghlv6ycvpdocgx4dgzi4jxsc4")), arg1);
        let v2 = v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v2, 20000000000000, arg1), @0x5b4fd361831af129f56fd80439d432cbbc04a3e49d1600df27a252dfbde85858);
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v2, 30000000000000, arg1), @0xfd0075affe368dd8397c7a62e32940f52ba28d953444e294380f07a9536425a2);
        0x2::transfer::public_transfer<0x2::coin::Coin<ICO_COIN>>(0x2::coin::mint<ICO_COIN>(&mut v2, 50000000000000, arg1), @0x8655a8334dd8e91d7e201a7b8d72eda89b1ddf5af451ff13dae9abc3f1d68d4b);
        ...
        let v4 = TokenCreatedEvent{
            ...
            initial_holders : v3,
            decimals        : 9,
            symbol          : 0x1::string::utf8(b"ZBO"),
            name            : 0x1::string::utf8(b"ZBO Protocol"),
        };
