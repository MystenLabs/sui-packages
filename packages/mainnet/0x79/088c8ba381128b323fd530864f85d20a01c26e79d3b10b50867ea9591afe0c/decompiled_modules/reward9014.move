module 0x79088c8ba381128b323fd530864f85d20a01c26e79d3b10b50867ea9591afe0c::reward9014 {
    struct REWARD9014 has drop {
        dummy_field: bool,
    }

    struct TICKET_9014 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9014(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9014>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9014>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9014, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9014>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9014>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9014>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9014>>(v5, 0x2::tx_context::sender(arg1));
    }
