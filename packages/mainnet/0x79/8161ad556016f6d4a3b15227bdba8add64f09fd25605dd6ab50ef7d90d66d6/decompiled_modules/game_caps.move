module 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::game_caps {
    ...
    public(friend) fun borrow_cap(arg0: &GameCapStore, arg1: address) : &0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::game::GameCap {
        0x2::dynamic_object_field::borrow<address, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::game::GameCap>(&arg0.id, arg1)
    }
    ...
    public(friend) fun store_cap(arg0: &mut GameCapStore, arg1: address, arg2: 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::game::GameCap, arg3: 0x1::option::Option<0x2::object::ID>) {
        0x2::dynamic_object_field::add<address, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::game::GameCap>(&mut arg0.id, arg1, arg2);
