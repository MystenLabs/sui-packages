module 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::game {
    ...
    struct Match has store, key {
        ...
        folded: vector<bool>,
        action_log: vector<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ActionLogEntry>,
        hand_summaries: vector<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::HandSummary>,
        entropy_counter: u64,
        start_time: u64,
    ...
    public(friend) fun action_log(arg0: &Match) : &vector<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ActionLogEntry> {
        &arg0.action_log
    }
    ...
    fun advance_forced_progress(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        ...
        loop {
            ...
            if (round_closed(arg0)) {
                if (arg0.street == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::river()) {
                    runout_and_showdown(arg0, arg1, arg2);
                    return
                };
                advance_street(arg0, arg1);
                emit_engine_action_taken(arg0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::engine_action_advance_street(), 0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::no_winner(), false, false, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::no_winner());
                continue
            };
    ...
    fun advance_street(arg0: &mut Match, arg1: &0x2::tx_context::TxContext) {
        arg0.street = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::street_next(arg0.street);
        ...
        *0x1::vector::borrow_mut<bool>(&mut arg0.acted_since_full_raise, 1) = false;
        ...
        if (arg0.street == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::flop()) {
    ...
    public(friend) fun apply_move(arg0: &mut Match, arg1: &GameCap, arg2: u8, arg3: u32, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        if (arg2 == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_fold()) {
            assert!(v4 > 0, 103);
            *0x1::vector::borrow_mut<bool>(&mut arg0.folded, v1) = true;
            log_action(arg0, v0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_fold(), 0);
        } else if (arg2 == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_check()) {
            assert!(v4 == 0, 103);
            *0x1::vector::borrow_mut<bool>(&mut arg0.acted_since_full_raise, v1) = true;
            log_action(arg0, v0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_check(), 0);
            arg0.to_act = 1 - v0;
        } else {
            assert!(arg2 == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_commit_to(), 103);
            ...
            *0x1::vector::borrow_mut<bool>(&mut arg0.acted_since_full_raise, v1) = true;
            log_action(arg0, v0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_commit_to(), arg3);
            arg0.to_act = 1 - v0;
        };
        arg0.last_update_time = 0x2::clock::timestamp_ms(arg5);
        let v7 = 0x1::vector::borrow<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ActionLogEntry>(&arg0.action_log, 0x1::vector::length<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ActionLogEntry>(&arg0.action_log) - 1);
        let v8 = 0x2::object::id<Match>(arg0);
        let v9 = ActionTaken{
            match_id        : 0x2::object::id_to_address(&v8),
            hand_index      : arg0.hand_index,
            street          : 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ale_street(v7),
            seat            : 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ale_seat(v7),
            action_type     : 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ale_action_type(v7),
            amount          : 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ale_amount(v7),
            agent_state     : arg4,
            pot             : arg0.pot,
    ...
    fun burn_before_board_if_random(arg0: &mut Match, arg1: &vector<u8>, arg2: address) {
        if (0x1::vector::length<u8>(&arg0.scheduled_board) == 0) {
            0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::burn_card(&mut arg0.deck, arg1, arg2, &mut arg0.entropy_counter);
        };
    }
    ...
    fun draw_board_card(arg0: &mut Match, arg1: &vector<u8>, arg2: address) : u8 {
        if (0x1::vector::length<u8>(&arg0.scheduled_board) > 0) {
            ...
            0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::draw_card(&mut arg0.deck, arg1, arg2, &mut arg0.entropy_counter)
        }
    }
    ...
    public(friend) fun hand_summaries(arg0: &Match) : &vector<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::HandSummary> {
        &arg0.hand_summaries
    }
    ...
    public fun is_legal(arg0: &Match, arg1: u8, arg2: u32) : bool {
        ...
        if (arg1 == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_fold()) {
            v4 > 0
        } else if (arg1 == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_check()) {
            v4 == 0
        } else if (arg1 == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::action_commit_to()) {
    ...
    fun log_action(arg0: &mut Match, arg1: u8, arg2: u8, arg3: u32) {
        0x1::vector::push_back<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ActionLogEntry>(&mut arg0.action_log, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::new_action_log_entry(arg0.street, arg1, arg2, arg3));
    }
    ...
    public(friend) fun new_match(arg0: u32, arg1: u32, arg2: u32, arg3: u32, arg4: u32, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (GameCap, Match) {
        ...
        let v5 = Match{
            ...
            hand_index             : 0,
            active                 : true,
            winner                 : 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::no_winner(),
            street                 : 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::preflop(),
            small_blind            : 0,
            big_blind              : 0,
            pot                    : 0,
            ...
            action_log             : 0x1::vector::empty<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ActionLogEntry>(),
            hand_summaries         : 0x1::vector::empty<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::HandSummary>(),
            entropy_counter        : 0,
            start_time             : v0,
            last_update_time       : v0,
        };
    ...
    fun resolve_fold(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        ...
        *0x1::vector::borrow_mut<u32>(&mut arg0.stacks, (v1 as u64)) = *0x1::vector::borrow<u32>(&arg0.stacks, (v1 as u64)) + v2;
        arg0.pot = 0;
        let v3 = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::new_hand_summary(arg0.hand_index, arg0.button, v2, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::hand_end_fold(), v1 == 0, v1 == 1, *0x1::vector::borrow<u32>(&arg0.stacks, 0), *0x1::vector::borrow<u32>(&arg0.stacks, 1));
    ...
    fun reveal_remaining_board(arg0: &mut Match, arg1: &0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<u8>(&arg0.community_cards) < 5) {
            let v3 = if (0x1::vector::length<u8>(&arg0.community_cards) == 0) {
                0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::flop()
            } else if (0x1::vector::length<u8>(&arg0.community_cards) == 3) {
                0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::turn()
            } else {
                0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::river()
            };
            burn_before_board_if_random(arg0, &v2, v1);
            if (v3 == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::flop()) {
                let v4 = draw_board_card(arg0, &v2, v1);
                let v5 = draw_board_card(arg0, &v2, v1);
                let v6 = draw_board_card(arg0, &v2, v1);
                0x1::vector::push_back<u8>(&mut arg0.community_cards, v4);
    ...
    fun runout_and_showdown(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        ...
        let v4 = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::eval::best_of_seven(&v0);
        let v5 = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::eval::best_of_seven(&v2);
        let v6 = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::eval::hand_rank_cmp(&v4, &v5);
        let (v7, v8) = if (v6 == 2) {
            (true, false)
        } else if (v6 == 0) {
            (false, true)
        ...
        arg0.pot = 0;
        let v10 = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::new_hand_summary(arg0.hand_index, arg0.button, v9, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::hand_end_showdown(), v7, v8, *0x1::vector::borrow<u32>(&arg0.stacks, 0), *0x1::vector::borrow<u32>(&arg0.stacks, 1));
    ...
    fun start_hand_with_depth(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        ...
        arg0.street = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::preflop();
        arg0.small_blind = v2;
        arg0.big_blind = v3;
        arg0.pot = 0;
        *0x1::vector::borrow_mut<u32>(&mut arg0.round_bet, 0) = 0;
        *0x1::vector::borrow_mut<u32>(&mut arg0.round_bet, 1) = 0;
        ...
        arg0.deck = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::standard_deck();
        ...
        *0x1::vector::borrow_mut<bool>(&mut arg0.folded, 1) = false;
        arg0.action_log = 0x1::vector::empty<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::ActionLogEntry>();
        let v4 = 0x2::object::id<Match>(arg0);
        let v5 = 0x2::object::id_to_address(&v4);
        let v6 = *0x2::tx_context::digest(arg1);
        let v7 = arg0.button;
        let v8 = 1 - v7;
        if (0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::scheduler_stage(arg0.hand_index) == 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::stage_random()) {
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v7 as u64) * 2) = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v8 as u64) * 2) = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v7 as u64) * 2 + 1) = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v8 as u64) * 2 + 1) = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
        } else {
            let (v9, v10) = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::deck::deal_tension_runout(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter, arg0.hand_index);
            let v11 = v9;
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v7 as u64) * 2) = *0x1::vector::borrow<u8>(&v11, 0);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v7 as u64) * 2 + 1) = *0x1::vector::borrow<u8>(&v11, 1);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v8 as u64) * 2) = *0x1::vector::borrow<u8>(&v11, 2);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v8 as u64) * 2 + 1) = *0x1::vector::borrow<u8>(&v11, 3);
            arg0.scheduled_board = v10;
        };
        post_blind(arg0, v7, v2);
        post_blind(arg0, v8, v3);
        emit_engine_action_taken(arg0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::engine_action_deal_hand(), 0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::no_winner(), false, false, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::no_winner());
    ...
    fun transition_after_hand(arg0: &mut Match, arg1: 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::HandSummary, arg2: &0x2::tx_context::TxContext, arg3: u8) {
        emit_engine_action_taken(arg0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::engine_action_complete_hand(), 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::hs_pot(&arg1), 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::hs_ended_by(&arg1), 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::hs_winner_0(&arg1), 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::hs_winner_1(&arg1), 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::no_winner());
        0x1::vector::push_back<0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::HandSummary>(&mut arg0.hand_summaries, arg1);
        if (*0x1::vector::borrow<u32>(&arg0.stacks, 0) == 0 || *0x1::vector::borrow<u32>(&arg0.stacks, 1) == 0) {
            arg0.active = false;
            let v0 = if (*0x1::vector::borrow<u32>(&arg0.stacks, 0) == 0) {
                1
            } else {
                0
            };
            arg0.winner = v0;
            emit_engine_action_taken(arg0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::engine_action_complete_match(), 0, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::no_winner(), arg0.winner == 0, arg0.winner == 1, arg0.winner);
            return
        };
