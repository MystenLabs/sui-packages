module 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::eval {
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        ...
        while (v3 < 5) {
            ...
            assert!(v4 < 52, 1);
            let v5 = 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0x798161ad556016f6d4a3b15227bdba8add64f09fd25605dd6ab50ef7d90d66d6::types::card_suit(v4));
