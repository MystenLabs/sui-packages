module 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::auto_position {
    ...
    public fun new<T0: store + key>(arg0: T0, arg1: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg2: address, arg3: u64, arg4: &0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::registry::ProxyCap) : AutoPosition<T0> {
        assert!(arg3 < 0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::constants::scaling_pips(), 2);
        AutoPosition<T0>{
            owner         : arg2,
    ...
    public fun unwrap<T0: store + key>(arg0: AutoPosition<T0>, arg1: &0x79fff5cdcaa1fe22f75986af2f244f935b196fba5a480e4991f3439f8a367467::registry::ProxyCap) : (address, T0, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, u64) {
        let AutoPosition {
            owner         : v0,
            inner         : v1,
            vault         : v2,
