module 0x799a92f9027e60860d8721635d3319a60600644bc128a312f3b55067175eb77a::cnsnft1294 {
    struct CNSNFT1294 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1294, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1294>(arg0, arg1);
