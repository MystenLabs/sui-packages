module 0x7993e4227a8faf4df2ab2e99d994d6279644e9a54c36b2d8f4f5a41d39485d09::cnsnft2489 {
    struct CNSNFT2489 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2489, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7045"));
        let v4 = 0x2::package::claim<CNSNFT2489>(arg0, arg1);
