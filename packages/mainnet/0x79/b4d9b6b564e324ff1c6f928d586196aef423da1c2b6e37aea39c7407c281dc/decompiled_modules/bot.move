module 0x79b4d9b6b564e324ff1c6f928d586196aef423da1c2b6e37aea39c7407c281dc::bot {
    struct EventBotStop has copy, drop, store {
        stopped: bool,
    }
    ...
    public(friend) fun change_funder<T0: store + key>(arg0: &0x2::package::Publisher, arg1: &mut Bot<T0>, arg2: address) {
        ...
        assert!(arg1.funder != arg2, 13906834917372723199);
        arg1.funder = arg2;
    }

    public(friend) fun change_operator<T0: store + key>(arg0: &0x2::package::Publisher, arg1: &mut Bot<T0>, arg2: address) {
        assert!(0x2::package::from_module<BOT>(arg0), 13906834938847559679);
        assert!(arg1.operator != arg2, 13906834943142526975);
        arg1.operator = arg2;
    }
    ...
    public fun create_bot<T0: store + key>(arg0: &0x2::package::Publisher, arg1: address, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : Bot<T0> {
        assert!(0x2::package::from_module<BOT>(arg0), 13906834376206843903);
        let v0 = Bot<T0>{
    ...
    public fun only_operator_funder<T0: store + key>(arg0: &Bot<T0>, arg1: address) {
        assert!(arg1 == arg0.operator || arg1 == arg0.funder, 13906834483581026303);
    }

    public(friend) fun stop_bot<T0: store + key>(arg0: &mut Bot<T0>, arg1: bool) {
        assert!(arg0.stop != arg1, 13906834998977101823);
        arg0.stop = arg1;
        let v0 = EventBotStop{stopped: arg1};
        0x2::event::emit<EventBotStop>(v0);
    }

    public(friend) fun stopped<T0: store + key>(arg0: &Bot<T0>) : bool {
        arg0.stop
    }
