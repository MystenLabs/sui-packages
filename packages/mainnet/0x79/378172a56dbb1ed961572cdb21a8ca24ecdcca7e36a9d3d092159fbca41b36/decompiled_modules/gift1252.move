module 0x79378172a56dbb1ed961572cdb21a8ca24ecdcca7e36a9d3d092159fbca41b36::gift1252 {
    struct GIFT1252 has drop {
        dummy_field: bool,
    }

    struct TICKET_1252 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1252(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1252>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1252>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1252, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1252>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1252>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1252>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1252>>(v5, 0x2::tx_context::sender(arg1));
    }
