module 0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::lp_pool {
    ...
    entry fun hotfix_remove_liquidity_pool<T0>(arg0: &0xcb1c8159eb40b02877c0ceed599cf019cc8e61e8ec19c4d64db15e20ff630f05::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = v0;
        0x2::table::destroy_empty<address, vector<DeactivatingShares<T0>>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::table::Table<address, vector<DeactivatingShares<T0>>>>(&mut v9, 0x1::string::utf8(b"deactivating_shares")));
        0x1::vector::destroy_empty<TokenPool>(v4);
