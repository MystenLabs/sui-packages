module 0x79178a21d80766081ca86280024720df7c0541be6e326dc937843ed4c9e19ef8::movexnft5509 {
    struct MOVEXNFT5509 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT5509, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT5509>(arg0, arg1);
