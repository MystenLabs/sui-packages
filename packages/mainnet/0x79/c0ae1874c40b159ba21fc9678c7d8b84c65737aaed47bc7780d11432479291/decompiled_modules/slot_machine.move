module 0x79c0ae1874c40b159ba21fc9678c7d8b84c65737aaed47bc7780d11432479291::slot_machine {
    ...
    public fun buy_turn(arg0: &mut SlotMachine, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.total_jackpot, 0x2::balance::split<0x2::sui::SUI>(v1, v0 - v0 * arg0.fee / 100));
        let v2 = randomSeed(arg3);
        let v3 = randomSeed(arg3);
        let v4 = Turn{
            id            : 0x2::object::new(arg3),
            turns_allowed : v0 / arg0.mist_price_for_turn + 1,
        ...
        0x2::transfer::transfer<Turn>(v4, 0x2::tx_context::sender(arg3));
    }
    ...
    public fun fill_turn(arg0: &mut Turn, arg1: &mut SlotMachine, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.total_jackpot, 0x2::balance::split<0x2::sui::SUI>(v1, v0 - v0 * arg1.fee / 100));
        0x1::debug::print<u64>(&v0);
        0x1::debug::print<u64>(&v3);
        let v4 = v0 / arg1.mist_price_for_turn + 1;
        0x1::debug::print<u64>(&v4);
        arg0.turns_allowed = v4;
        let v5 = randomSeed(arg4);
        arg0.seed1 = 0x2::clock::timestamp_ms(arg3);
        arg0.seed2 = v5;
        arg0.seed3 = randomSeed(arg4);
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.fee_balance, v2);
    }
