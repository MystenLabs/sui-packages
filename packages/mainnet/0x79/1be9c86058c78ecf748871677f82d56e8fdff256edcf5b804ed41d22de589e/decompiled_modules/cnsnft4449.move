module 0x791be9c86058c78ecf748871677f82d56e8fdff256edcf5b804ed41d22de589e::cnsnft4449 {
    struct CNSNFT4449 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4449, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4449>(arg0, arg1);
