module 0xe2042fcf0fc90234cb6049443f30efa03525eb8567c83b965a5f3625c2965419::position {
    ...
    fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0xe1262c3d7c8cf295a5ad90814cc06578186d43911a256ab7cf8e11d18e86815f::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 4);
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: vector<u128>, arg7: u128) : u128 {
        ...
        update_rewards_internal(v0, arg6);
        update_fullsail_distribution_internal(v0, arg7);
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u128::add_check(v0.liquidity, arg2), 7);
        v0.liquidity = v0.liquidity + arg2;
        arg1.liquidity = v0.liquidity;
        v0.liquidity
    }
    ...
    fun init(arg0: POSITION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(&mut v1, 0x1::string::utf8(b"https://app.fullsailfinance.io/position?chain=sui&id={id}"));
        ...
        0x1::vector::push_back<0x1::string::String>(&mut v1, 0x1::string::utf8(b"https://fullsailfinance.io"));
        0x1::vector::push_back<0x1::string::String>(&mut v1, 0x1::string::utf8(b"FULLSAIL"));
    ...
    public(friend) fun mark_position_staked(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: bool) {
        ...
        assert!(v0.fullsail_distribution_staked != arg2, 8);
    ...
    fun new_position_name(arg0: u64, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0xe2042fcf0fc90234cb6049443f30efa03525eb8567c83b965a5f3625c2965419::utils::str(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0xe2042fcf0fc90234cb6049443f30efa03525eb8567c83b965a5f3625c2965419::utils::str(arg1));
        v0
    }
    ...
    public fun set_display(arg0: &0xe2042fcf0fc90234cb6049443f30efa03525eb8567c83b965a5f3625c2965419::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_module<Position>(arg1), 9854893284345743338);
    ...
    public(friend) fun update_and_reset_rewards(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: vector<u128>, arg3: u64) : u64 {
        assert!(0x1::vector::length<u128>(&arg2) > arg3, 2);
        let v0 = borrow_mut_position_info(arg0, arg1);
    ...
    fun update_fullsail_distribution_internal(arg0: &mut PositionInfo, arg1: u128) {
        let v0 = (0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::full_math_u128::mul_shr(arg0.liquidity, 0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u128::wrapping_sub(arg1, arg0.fullsail_distribution_growth_inside), 64) as u64);
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u64::add_check(arg0.fullsail_distribution_owned, v0), 3);
    ...
    fun update_points_internal(arg0: &mut PositionInfo, arg1: u128) {
        ...
        assert!(0x273edb422b3404487a0e700224f541852e799957e4e289363a1675a8dcee158b::math_u128::add_check(arg0.points_owned, v0), 1);
    ...
    public fun validate_position_exists(arg0: &PositionManager, arg1: 0x2::object::ID) {
        assert!(0xe1262c3d7c8cf295a5ad90814cc06578186d43911a256ab7cf8e11d18e86815f::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 4);
        assert!(0xe1262c3d7c8cf295a5ad90814cc06578186d43911a256ab7cf8e11d18e86815f::linked_table::borrow<0x2::object::ID, PositionInfo>(&arg0.positions, arg1).position_id == arg1, 4);
    }
