module 0xe2e49ed6906d425ca08c4536231930e70a7836d799c865761bff609336f559ea::blockbolt_coin {
    ...
    public entry fun add_update_entry(arg0: &mut CombinedStorage, arg1: 0x1::string::String, arg2: 0x1::string::String) {
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg0.entries, &arg1)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut arg0.entries, &arg1) = arg2;
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut arg0.entries, arg1, arg2);
        };
    }
