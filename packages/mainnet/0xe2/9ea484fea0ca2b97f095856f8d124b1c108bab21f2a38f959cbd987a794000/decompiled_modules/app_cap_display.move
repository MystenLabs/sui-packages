module 0xe29ea484fea0ca2b97f095856f8d124b1c108bab21f2a38f959cbd987a794000::app_cap_display {
    ...
    public(friend) fun new(arg0: 0xe29ea484fea0ca2b97f095856f8d124b1c108bab21f2a38f959cbd987a794000::name::Name, arg1: bool) : AppCapDisplay {
        let v0 = if (arg1) {
            100
        } else {
            0
        ...
        AppCapDisplay{
            title            : 0xe29ea484fea0ca2b97f095856f8d124b1c108bab21f2a38f959cbd987a794000::name::to_string(&arg0),
            link_opacity     : v0,
    ...
    public(friend) fun uri_encode_text(arg0: 0xe29ea484fea0ca2b97f095856f8d124b1c108bab21f2a38f959cbd987a794000::name::Name) : 0x1::string::String {
        let v0 = 0x1::string::utf8(b"");
        let v1 = 0xe29ea484fea0ca2b97f095856f8d124b1c108bab21f2a38f959cbd987a794000::name::org_to_string(&arg0);
        ...
        let (v4, _) = render_batch(0xe29ea484fea0ca2b97f095856f8d124b1c108bab21f2a38f959cbd987a794000::name::app_to_string(&arg0), 13, v3 + 10, 26, 26, 0x1::string::utf8(b"FFFFFF"));
