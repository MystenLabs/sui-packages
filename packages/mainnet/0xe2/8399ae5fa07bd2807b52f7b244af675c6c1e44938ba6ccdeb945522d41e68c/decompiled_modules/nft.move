module 0xe28399ae5fa07bd2807b52f7b244af675c6c1e44938ba6ccdeb945522d41e68c::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun mint(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0, 0x1::string::utf8(b"Number"), 0x1::string::utf8(b"2"));
        let v1 = Nft{
