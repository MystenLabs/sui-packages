module 0xe228015a8462a2482635c64bb3e0a5bf4b3695b6da423392015ef1798c0963e3::cnsnft3478 {
    struct CNSNFT3478 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3478, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3478>(arg0, arg1);
