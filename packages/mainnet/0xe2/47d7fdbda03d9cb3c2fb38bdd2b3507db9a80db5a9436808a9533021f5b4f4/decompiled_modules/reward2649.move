module 0xe247d7fdbda03d9cb3c2fb38bdd2b3507db9a80db5a9436808a9533021f5b4f4::reward2649 {
    struct REWARD2649 has drop {
        dummy_field: bool,
    }

    struct TICKET_2649 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2649(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2649>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2649>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2649, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2649>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2649>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2649>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2649>>(v5, 0x2::tx_context::sender(arg1));
    }
