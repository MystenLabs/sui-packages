module 0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::ACL,
        package_version: u64,
        swap_fee_rate: u64,
    ...
    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        ...
        0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun check_acl_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    public fun check_acl_upload_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::has_role(&arg0.acl, arg1, 1), 4);
    }
    ...
    public fun claim_fee<T0>(arg0: &mut GlobalConfig, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        checked_package_version(arg0);
        assert!(0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 0), 1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::type_name::TypeName, u64>(&mut v0, 0x1::type_name::get<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(), 5000000000);
        ...
        0x2::table::add<0x1::type_name::TypeName, u64>(&mut v1, 0x1::type_name::get<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(), 5000000000);
        ...
        let v3 = GlobalConfig{
            ...
            acl                  : 0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::new(arg0),
            package_version      : 1,
            swap_fee_rate        : 0,
        ...
        0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::set_roles(&mut v3.acl, v5, 0 | 1 << 0);
    ...
    public fun set_init_fee<T0>(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0xe223870f7e12e0adf8bc43c27ddc0293d8103d2255d7abf188e5fcc1f7781418::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 0), 1);
        let v0 = 0x1::type_name::get<T0>();
