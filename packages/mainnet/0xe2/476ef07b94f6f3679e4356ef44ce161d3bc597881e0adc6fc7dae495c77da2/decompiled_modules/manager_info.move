module 0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::manager_info {
    ...
    public(friend) fun new_manager_info<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: &0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::margin_registry::MarginRegistry, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg7: &0x2::clock::Clock, arg8: 0x2::object::ID) : ManagerInfo {
        let v0 = 0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::oracle::calculate_target_amount<T0>(arg5, arg4, 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::float_scaling(), arg7);
        let v1 = 0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::oracle::calculate_target_amount<T1>(arg6, arg4, 0xd5377267e2527db33040fedc063d3990f9942b629b406931190e3685ac45621e::constants::float_scaling(), arg7);
        let v2 = if (arg2 > 0) {
            v0
        } else {
            v1
        ...
        let v7 = v3 + v4;
        let v8 = v5 + v6;
        let v9 = 0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::margin_constants::max_risk_ratio();
        ...
        ManagerInfo{
            ...
            quote_per_dollar        : v1,
            debt_per_dollar         : v2,
            user_liquidation_reward : 0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::margin_registry::user_liquidation_reward(arg4, arg8),
            pool_liquidation_reward : 0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::margin_registry::pool_liquidation_reward(arg4, arg8),
            target_ratio            : 0xe2476ef07b94f6f3679e4356ef44ce161d3bc597881e0adc6fc7dae495c77da2::margin_registry::target_liquidation_risk_ratio(arg4, arg8),
        }
    }
