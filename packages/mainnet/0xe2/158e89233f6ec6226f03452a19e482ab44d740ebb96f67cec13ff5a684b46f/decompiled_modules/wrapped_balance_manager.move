module 0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::wrapped_balance_manager {
    ...
    public fun deposit<T0>(arg0: &mut BalanceManagerRegistry, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::deep_infra::DeepSponsor, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun place_limit_order<T0, T1>(arg0: &mut BalanceManagerRegistry, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: u64, arg3: u8, arg4: u8, arg5: u64, arg6: u64, arg7: bool, arg8: bool, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::deep_infra::DeepSponsor, arg12: &mut 0x2::tx_context::TxContext) : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::OrderInfo {
        let v0 = &mut arg0.managers;
        ...
        if (arg7 && 0x1::type_name::get<T1>() == 0x1::type_name::get<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>()) {
            assert!(arg5 * arg6 <= get_balance_internal<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v1) - v1.sponsored_deep, 3);
            ...
            assert!(arg6 <= get_balance_internal<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v1) - v1.sponsored_deep, 3);
        };
        let v2 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(&mut v1.balance_manager, arg12);
        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg1, &mut v1.balance_manager, &v2, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg12)
    }

    public fun place_market_order<T0, T1>(arg0: &mut BalanceManagerRegistry, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: u64, arg3: u8, arg4: u64, arg5: bool, arg6: bool, arg7: &0x2::clock::Clock, arg8: &mut 0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::deep_infra::DeepSponsor, arg9: &mut 0x2::tx_context::TxContext) : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::OrderInfo {
        let v0 = &mut arg0.managers;
    ...
    public(friend) fun create_manager_if_not_found(arg0: &mut 0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::deep_infra::DeepSponsor, arg1: &mut 0x2::table::Table<address, WrappedBalanceManager>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<address, WrappedBalanceManager>(arg1, 0x2::tx_context::sender(arg3))) {
            ...
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::deposit<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&mut v0.balance_manager, 0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::deep_infra::get_sponsored_deep(arg0, arg2, arg3), arg3);
            v0.sponsored_deep = v0.sponsored_deep + arg2;
    ...
    public fun get_balance<T0>(arg0: &BalanceManagerRegistry, arg1: address) : u64 {
        ...
        if (0x1::type_name::get<T0>() == 0x1::type_name::get<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>()) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T0>(&v0.balance_manager) - v0.sponsored_deep
        } else {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T0>(&v0.balance_manager)
        }
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = BalanceManagerRegistry{
            ...
            sponsor_deep_amount : 100000,
        };
        0x2::transfer::share_object<BalanceManagerRegistry>(v0);
    }

    public fun set_sponsor_deep_amount(arg0: &0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::admin::AdminCap, arg1: &mut BalanceManagerRegistry, arg2: u64) {
        arg1.sponsor_deep_amount = arg2;
    }

    public fun withdraw_sponsored_deep(arg0: &0xe2158e89233f6ec6226f03452a19e482ab44d740ebb96f67cec13ff5a684b46f::admin::AdminCap, arg1: &mut BalanceManagerRegistry, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
