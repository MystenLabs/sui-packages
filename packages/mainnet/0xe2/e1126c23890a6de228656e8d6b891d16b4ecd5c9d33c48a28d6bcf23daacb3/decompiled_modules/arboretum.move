module 0xe2e1126c23890a6de228656e8d6b891d16b4ecd5c9d33c48a28d6bcf23daacb3::arboretum {
    struct Registry has key {
        ...
        planted_saplings: 0x2::table::Table<0x2::object::ID, bool>,
    }

    struct Sapling has store, key {
        id: 0x2::object::UID,
    ...
    entry fun apply_tool(arg0: &mut Registry, arg1: &mut Seed, arg2: Tool, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        } else if (v5 == b"watering_boost") {
            arg1.fertilizer_charges = arg1.fertilizer_charges + 1;
        } else if (v5 == b"compost") {
            arg1.watering_streak = arg1.watering_streak + 1;
        } else if (v5 == b"growth_tonic") {
            add_growth_points(arg0, arg1, 0x2::tx_context::sender(arg4), 20);
        } else if (v5 == b"miracle_grow") {
            arg1.miracle_grow_applied = true;
        } else if (v5 == b"mulch") {
            arg1.bottomless_can_expiry_ms = assert_season_active(arg0, arg3) + 3 * 86400000;
        } else if (v5 == b"rain_barrel") {
            arg1.last_watered_ms = assert_season_active(arg0, arg3);
        } else if (v5 == b"super_soil") {
            arg1.watering_streak = arg1.watering_streak + 3;
        } else if (v5 == b"sunstone") {
            add_growth_points(arg0, arg1, 0x2::tx_context::sender(arg4), 30);
        } else if (v5 == b"revival_kit") {
            arg1.revival_charges = arg1.revival_charges + 1;
        } else if (v5 == b"double_dose") {
            arg1.miracle_grow_applied = true;
            arg1.fertilizer_charges = arg1.fertilizer_charges + 2;
        } else if (v5 == b"drought_shield") {
            arg1.bottomless_can_expiry_ms = assert_season_active(arg0, arg3) + 7 * 86400000;
        } else if (v5 == b"ancient_bark") {
            add_growth_points(arg0, arg1, 0x2::tx_context::sender(arg4), 50);
        } else if (v5 == b"moon_water") {
            arg1.fertilizer_charges = arg1.fertilizer_charges + 5;
        } else if (v5 == b"earth_core") {
            arg1.fertilizer_charges = arg1.fertilizer_charges + 5;
        } else if (v5 == b"bottomless_can") {
            arg1.bottomless_can_expiry_ms = assert_season_active(arg0, arg3) + 8640000000000;
        } else if (v5 == b"philosophers_soil") {
            arg1.fertilizer_charges = arg1.fertilizer_charges + 10;
        } else if (v5 == b"timeless_seed") {
            arg1.watering_streak = arg1.watering_streak + 5;
            arg1.last_watered_ms = assert_season_active(arg0, arg3);
        } else if (v5 == b"crystal_water") {
            arg1.miracle_grow_applied = true;
            arg1.fertilizer_charges = arg1.fertilizer_charges + 9;
        } else if (v5 == b"forest_heart") {
    ...
    fun assert_season_active(arg0: &Registry, arg1: &0x2::clock::Clock) : u64 {
        ...
        assert!(v0 - arg0.season_start_ms < 8640000000000, 6);
        v0
    }
    ...
    entry fun claim_reward(arg0: &mut Registry, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 12);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(arg0.season_start_ms > 0, 13);
        assert!(0x2::clock::timestamp_ms(arg1) - arg0.season_start_ms >= 8640000000000, 6);
        assert!(0x2::table::contains<address, u64>(&arg0.player_growth, v0), 7);
        let v1 = *0x2::table::borrow<address, u64>(&arg0.player_growth, v0);
        assert!(v1 > 0, 7);
        let v2 = arg0.total_growth_points;
        let v3 = 0x2::balance::value<0x2::sui::SUI>(&arg0.reward_pool);
        if (v3 == 0 || v2 == 0) {
            *0x2::table::borrow_mut<address, u64>(&mut arg0.player_growth, v0) = 0;
            return
        };
        let v4 = v1 * v3 / v2;
        *0x2::table::borrow_mut<address, u64>(&mut arg0.player_growth, v0) = 0;
        let v5 = if (arg0.total_growth_points > v1) {
            arg0.total_growth_points - v1
        } else {
            0
        };
        arg0.total_growth_points = v5;
        let v6 = RewardClaimed{
            owner       : v0,
            amount_mist : v4,
        };
        0x2::event::emit<RewardClaimed>(v6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.reward_pool, v4), arg2), v0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            planted_saplings    : 0x2::table::new<0x2::object::ID, bool>(arg0),
        };
    ...
    entry fun plant_seed(arg0: &mut Registry, arg1: Sapling, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= 10000000000, 4);
        let v2 = 0x2::object::id<Sapling>(&arg1);
        assert!(!0x2::table::contains<0x2::object::ID, bool>(&arg0.planted_saplings, v2), 14);
        0x2::table::add<0x2::object::ID, bool>(&mut arg0.planted_saplings, v2, true);
        let v3 = 0x2::coin::split<0x2::sui::SUI>(&mut arg2, 10000000000, arg5);
        if (0x2::coin::value<0x2::sui::SUI>(&arg2) > 0) {
        ...
        if (0x1::option::is_some<address>(&arg3)) {
            ...
            if (v4 != v0 && !0x2::table::contains<address, address>(&arg0.referrers, v0)) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v3, 1000000000, arg5), v4);
                if (0x2::table::contains<address, u64>(&arg0.referral_earnings, v4)) {
                    *0x2::table::borrow_mut<address, u64>(&mut arg0.referral_earnings, v4) = *0x2::table::borrow<address, u64>(&arg0.referral_earnings, v4) + 1000000000;
                } else {
                    0x2::table::add<address, u64>(&mut arg0.referral_earnings, v4, 1000000000);
                };
                let v5 = ReferralPaid{
                    referrer    : v4,
                    referee     : v0,
        ...
        0x2::transfer::public_transfer<Sapling>(arg1, v0);
        0x2::transfer::public_transfer<Seed>(v6, v0);
    }

    public fun player_growth_points(arg0: &Registry, arg1: address) : u64 {
        if (0x2::table::contains<address, u64>(&arg0.player_growth, arg1)) {
    ...
    entry fun reset_season(arg0: &AdminCap, arg1: &mut Registry, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg1, arg3);
        if (arg1.season_start_ms > 0) {
            assert!(0x2::clock::timestamp_ms(arg2) - arg1.season_start_ms >= 8640000000000, 13);
        };
        assert!(arg1.total_growth_points == 0, 16);
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.reward_pool) == 0, 16);
        arg1.season_start_ms = 0;
        arg1.total_seeds = 0;
        let v0 = SeasonReset{season_id: arg1.current_season_id};
        0x2::event::emit<SeasonReset>(v0);
    }
    ...
    public fun sapling_is_planted(arg0: &Registry, arg1: 0x2::object::ID) : bool {
        0x2::table::contains<0x2::object::ID, bool>(&arg0.planted_saplings, arg1)
    }
    ...
    public fun seed_state_live(arg0: &Seed, arg1: &0x2::clock::Clock) : u8 {
        ...
        let v0 = (0x2::clock::timestamp_ms(arg1) - arg0.last_watered_ms) / 86400000;
        if (v0 >= 10) {
            2
        } else if (v0 >= 7) {
            1
    ...
    entry fun water_seed(arg0: &mut Registry, arg1: &mut Seed, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        if (v3 >= 10 && arg1.bottomless_can_expiry_ms < v1) {
            ...
            if (0x2::table::contains<address, u64>(&arg0.player_growth, v0)) {
                let v4 = *0x2::table::borrow<address, u64>(&arg0.player_growth, v0);
                if (v4 > 0) {
                    let v5 = if (v4 > arg1.growth_points) {
                        v4 - arg1.growth_points
                    } else {
                        0
                    };
                    *0x2::table::borrow_mut<address, u64>(&mut arg0.player_growth, v0) = v5;
                    let v6 = if (arg0.total_growth_points > arg1.growth_points) {
                        arg0.total_growth_points - arg1.growth_points
                    } else {
                        0
                    };
                    arg0.total_growth_points = v6;
                };
            };
        ...
        let v9 = if (arg1.watering_streak > 25) {
            50
        } else {
            arg1.watering_streak * 2
        };
        let v10 = 10 + arg1.permanent_gp_bonus + v9;
        let v11 = v10;
        ...
        add_growth_points(arg0, arg1, v0, v11);
        ...
        0x2::event::emit<SeedWatered>(v13);
    }
