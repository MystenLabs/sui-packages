module 0xe2a153badaff2dbef4e9aa8090b6d48982759f6ea7e321c27cc4371e8ea4f11a::reward6007 {
    struct REWARD6007 has drop {
        dummy_field: bool,
    }

    struct TICKET_6007 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6007(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_6007>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6007, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6007>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6007>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6007>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6007>>(v5, 0x2::tx_context::sender(arg1));
    }
