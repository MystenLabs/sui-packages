module 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::raffles {
    ...
    struct Raffle has store, key {
        ...
        total_tickets: u64,
        participants: 0x2::table::Table<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>,
        end_date: u64,
        winning_ticket: u64,
        winner: address,
        count: u64,
    ...
    fun buy_ticket_helper(arg0: &mut RaffleTreasury, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: address, arg4: u64, arg5: u64, arg6: 0x1::option::Option<0x1::type_name::TypeName>, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&v0.participants, arg3)) {
            let v2 = Ticket{
                first        : v1,
                last         : v0.total_tickets + arg4,
                total_number : arg4,
            };
            0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::push_back<Ticket>(0x2::table::borrow_mut<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&mut v0.participants, arg3), v2);
        } else {
            let v3 = 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::new<Ticket>(5000, arg8);
            let v4 = Ticket{
                first        : v1,
                last         : v0.total_tickets + arg4,
                total_number : arg4,
            };
            0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::push_back<Ticket>(&mut v3, v4);
            0x2::table::add<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&mut v0.participants, arg3, v3);
    ...
    public fun buy_tickets_from_deal<T0>(arg0: &mut RaffleTreasury, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: 0x1::option::Option<address>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&v5.participants, v7)) {
            let v8 = Ticket{
                first        : v6,
                last         : v5.total_tickets + v4,
                total_number : v4,
            };
            0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::push_back<Ticket>(0x2::table::borrow_mut<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&mut v5.participants, v7), v8);
        } else {
            let v9 = 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::new<Ticket>(5000, arg7);
            let v10 = Ticket{
                first        : v6,
                last         : v5.total_tickets + v4,
                total_number : v4,
            };
            0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::push_back<Ticket>(&mut v9, v10);
            0x2::table::add<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&mut v5.participants, v7, v9);
    ...
    public fun commit_winner(arg0: &mut RaffleTreasury, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: address) {
        ...
        let v1 = 0x2::table::remove<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&mut v0.participants, arg3);
        while (!0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::is_empty<Ticket>(&v1)) {
            let v2 = 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::pop_front<Ticket>(&mut v1);
            if (v0.winning_ticket >= v2.first && v0.winning_ticket <= v2.last) {
                ...
                0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::drop<Ticket>(v1);
                return
            };
        };
        abort 9
    ...
    public fun create_raffle(arg0: &mut RaffleTreasury, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v2 = Raffle{
            ...
            total_tickets       : 0,
            participants        : 0x2::table::new<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(arg6),
            end_date            : arg5,
            winning_ticket      : 0,
            winner              : @0x0,
            count               : 0,
    ...
    public fun is_participant(arg0: &Raffle, arg1: &mut 0x2::tx_context::TxContext) : bool {
        0x2::table::contains<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&arg0.participants, 0x2::tx_context::sender(arg1))
    }
    ...
    public fun my_tickets(arg0: &Raffle, arg1: &mut 0x2::tx_context::TxContext) : vector<vector<u64>> {
        ...
        let v0 = 0x2::table::borrow<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&arg0.participants, 0x2::tx_context::sender(arg1));
        let v1 = vector[];
        let v2 = 0;
        while (v2 < 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::length<Ticket>(v0)) {
            let v3 = 0x1::vector::empty<u64>();
            let v4 = &mut v3;
            0x1::vector::push_back<u64>(v4, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::nth<Ticket>(v0, v2).first);
            0x1::vector::push_back<u64>(v4, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::nth<Ticket>(v0, v2).last);
    ...
    public fun tickets_bought(arg0: &Raffle, arg1: address) : u64 {
        let v0 = 0;
        let v1 = 0x2::table::borrow<address, 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::BigQueue<Ticket>>(&arg0.participants, arg1);
        let v2 = 0;
        while (v2 < 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::length<Ticket>(v1)) {
            v0 = v0 + 0xe208f6a4963525d38b94628d4554c5d5b70fbd8a063512f72e7c8af8c6e40dde::big_queue::nth<Ticket>(v1, v2).total_number;
            v2 = v2 + 1;
        };
        v0
    }
