module 0xe2fe4a7354edbdce167490af5f3ac44b54fb05965d2e8a85edacff8a196f0854::auction_v2 {
    ...
    public entry fun accept_offer_create_kiosk<T0: store + key, T1: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::kiosk::Kiosk, arg5: 0x2::object::ID, arg6: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::new(arg9);
        let v2 = v1;
        let v3 = v0;
        let v4 = &mut v3;
        let v5 = accept_offer<T0, T1>(arg0, arg1, arg2, arg3, arg4, v4, &v2, arg5, arg6, arg7, arg9);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg6, &mut v5, arg8);
    ...
    public entry fun accept_offer_create_kiosk_pay<T0: store + key, T1: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::kiosk::Kiosk, arg5: 0x2::object::ID, arg6: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::new(arg9);
        let v2 = v1;
        let v3 = v0;
        let v4 = &mut v3;
