module 0xe29792e86d4dfb56355392b7b69b0cc8a18775d888ed8bce0323385125522e2e::reward_nft_w3 {
    struct REWARD_NFT_W3 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmXqcfQaXFRNrJ425K2FUuZuR4cGHHCj5Sd4sCYzFCtDq9"),
    ...
    fun init(arg0: REWARD_NFT_W3, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmXqcfQaXFRNrJ425K2FUuZuR4cGHHCj5Sd4sCYzFCtDq9"));
        ...
        let v4 = 0x2::package::claim<REWARD_NFT_W3>(arg0, arg1);
