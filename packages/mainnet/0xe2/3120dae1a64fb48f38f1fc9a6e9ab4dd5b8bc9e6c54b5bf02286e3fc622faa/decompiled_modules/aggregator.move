module 0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::aggregator {
    ...
    public fun new<T0>(arg0: &mut 0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::listing::ListingCap, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : PriceAggregator<T0> {
        if (arg1 == 0) {
        ...
        let v3 = NewPriceAggregator{
            aggregator_id         : v1,
            coin_type             : 0x1::type_name::into_string(0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::listing::register<T0>(arg0, v1)),
            weight_threshold      : arg1,
    ...
    public fun aggregate<T0>(arg0: &PriceAggregator<T0>, arg1: 0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::PriceCollector<T0>) : 0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::result::PriceResult<T0> {
        let v0 = &mut arg1;
        ...
        let v5 = 0x2::vec_map::keys<0x1::type_name::TypeName, 0x1::option::Option<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::Float>>(0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::contents<T0>(&arg1));
        ...
        while (v6 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
            ...
            let v8 = 0x2::vec_map::get<0x1::type_name::TypeName, 0x1::option::Option<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::Float>>(0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::contents<T0>(&arg1), &v7);
        ...
        0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::result::new<T0>(v15)
    }

    entry fun create<T0>(arg0: &mut 0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::listing::ListingCap, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun remove_outliers<T0>(arg0: &PriceAggregator<T0>, arg1: &mut 0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::PriceCollector<T0>) {
        let v0 = 0x2::vec_map::keys<0x1::type_name::TypeName, u8>(&arg0.weights);
        let v1 = &v0;
        let v2 = 0;
        let v3;
        while (v2 < 0x1::vector::length<0x1::type_name::TypeName>(v1)) {
            if (!0x2::vec_map::contains<0x1::type_name::TypeName, 0x1::option::Option<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::Float>>(0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::contents<T0>(arg1), 0x1::vector::borrow<0x1::type_name::TypeName>(v1, v2))) {
                v3 = false;
                /* label 6 */
                if (!v3) {
                ...
                while (v9 < 0x1::vector::length<0x1::type_name::TypeName>(v8)) {
                    0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::remove<T0>(arg1, 0x1::vector::borrow<0x1::type_name::TypeName>(v8, v9));
                    v9 = v9 + 1;
                };
                let v10 = 0x2::vec_map::keys<0x1::type_name::TypeName, 0x1::option::Option<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::Float>>(0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::contents<T0>(arg1));
                let v11 = 0;
                ...
                while (v17 < 0x1::vector::length<0x1::type_name::TypeName>(&v10)) {
                    ...
                    let v19 = 0x2::vec_map::get<0x1::type_name::TypeName, 0x1::option::Option<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::Float>>(0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::contents<T0>(arg1), &v18);
                ...
                let v25 = 0x2::vec_map::keys<0x1::type_name::TypeName, 0x1::option::Option<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::float::Float>>(0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::contents<T0>(arg1));
                ...
                while (v30 < 0x1::vector::length<0x1::type_name::TypeName>(v29)) {
                    0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::collector::remove<T0>(arg1, 0x1::vector::borrow<0x1::type_name::TypeName>(v29, v30));
                    v30 = v30 + 1;
                };
                return
            };
    ...
    public fun set_outlier_tolerance<T0>(arg0: &mut PriceAggregator<T0>, arg1: &0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::listing::ListingCap, arg2: u64) {
    ...
    public fun set_rule_weight<T0, T1>(arg0: &mut PriceAggregator<T0>, arg1: &0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::listing::ListingCap, arg2: u8) {
    ...
    public fun set_weight_threshold<T0>(arg0: &mut PriceAggregator<T0>, arg1: &0xe23120dae1a64fb48f38f1fc9a6e9ab4dd5b8bc9e6c54b5bf02286e3fc622faa::listing::ListingCap, arg2: u64) {
        if (arg2 == 0) {
            err_invalid_threshold();
        };
