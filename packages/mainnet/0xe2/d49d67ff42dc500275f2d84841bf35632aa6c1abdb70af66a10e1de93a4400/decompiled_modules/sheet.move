module 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::sheet {
    ...
    public fun collect<T0, T1: drop>(arg0: &mut Sheet<T0, T1>, arg1: Request<T0, T1>, arg2: T1) : 0x2::balance::Balance<T0> {
        ...
        while (!0x2::vec_map::is_empty<Entity, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(&v4)) {
            ...
            let v8 = v6;
            let v9 = if (0x2::vec_map::contains<Entity, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Credit<T0>>(credits<T0, T1>(arg0), &v8)) {
                let v10 = credit_against<T0, T1>(arg0, &v8);
                0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::settle_debt<T0>(v10, v7)
            } else {
                0x1::option::some<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(v7)
            };
            let v11 = v9;
            if (0x1::option::is_some<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(&v11)) {
                0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::add_debt<T0>(debt_against<T0, T1>(arg0, &v8), 0x1::option::destroy_some<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(v11));
                continue
            };
            0x1::option::destroy_none<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(v11);
        };
    ...
    public fun lend<T0, T1: drop, T2>(arg0: &mut Sheet<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: T1) : Loan<T0, T1, T2> {
        ...
        let v2 = entity<T2>();
        0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::add_credit<T0>(credit_against<T0, T1>(arg0, &v2), v0);
        Loan<T0, T1, T2>{
            balance : arg1,
            debt    : v1,
        }
    ...
    public fun pay<T0, T1, T2: drop>(arg0: &mut Sheet<T0, T2>, arg1: &mut Request<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: T2) {
        ...
        let v3 = entity<T1>();
        let v4 = if (0x2::vec_map::contains<Entity, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(debts<T0, T2>(arg0), &v3)) {
            let v5 = debt_against<T0, T2>(arg0, &v3);
            0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::settle_credit<T0>(v5, v1)
        } else {
            0x1::option::some<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Credit<T0>>(v1)
        };
        let v6 = v4;
        if (0x1::option::is_some<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Credit<T0>>(&v6)) {
            0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::add_credit<T0>(credit_against<T0, T2>(arg0, &v3), 0x1::option::destroy_some<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Credit<T0>>(v6));
        } else {
            0x1::option::destroy_none<0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Credit<T0>>(v6);
        };
        let v7 = entity<T2>();
        if (0x2::vec_map::contains<Entity, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(payer_debts<T0, T1>(arg1), &v7)) {
            0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::add_debt<T0>(0x2::vec_map::get_mut<Entity, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(&mut arg1.payer_debts, &v7), v2);
        } else {
            0x2::vec_map::insert<Entity, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::Debt<T0>>(&mut arg1.payer_debts, v7, v2);
        };
    }
    ...
    public fun receive<T0, T1, T2: drop>(arg0: &mut Sheet<T0, T2>, arg1: Loan<T0, T1, T2>, arg2: T2) : 0x2::balance::Balance<T0> {
        ...
        let v2 = entity<T1>();
        0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::liability::add_debt<T0>(debt_against<T0, T2>(arg0, &v2), v1);
        v0
    }
