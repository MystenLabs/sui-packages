module 0xe243f03ba0131aa5de7adec71c031bc08a86460f5c3e7b72bea6c157e3740bfe::reward7514 {
    struct REWARD7514 has drop {
        dummy_field: bool,
    }

    struct TICKET_7514 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7514(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7514>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7514>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7514, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7514>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7514>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7514>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7514>>(v5, 0x2::tx_context::sender(arg1));
    }
