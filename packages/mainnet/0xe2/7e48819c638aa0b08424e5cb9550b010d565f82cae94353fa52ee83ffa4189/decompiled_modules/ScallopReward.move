module 0xe27e48819c638aa0b08424e5cb9550b010d565f82cae94353fa52ee83ffa4189::ScallopReward {
    ...
    fun init(arg0: SCALLOPREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SCALLOPREWARD>(arg0, 9, b"$ rwsca.net - Scallop Reward Token", b"rwsca.net", b"$10,000 Reward Token for empowering Scallop Finance.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/rwscanet_0711/rwscanet_0711_0.jpg")), arg1);
