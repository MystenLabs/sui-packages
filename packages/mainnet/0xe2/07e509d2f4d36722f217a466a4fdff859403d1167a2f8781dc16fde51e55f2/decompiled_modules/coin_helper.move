module 0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::coin_helper {
    fun cmp_type_names(arg0: &0x1::type_name::TypeName, arg1: &0x1::type_name::TypeName) : u8 {
        ...
        let v4 = 0;
        while (v4 < 0x8358ebe688c25ea516ec1e6bf366dbde351a2b8b3ba2b17320f2777b8e2f3f4d::math::min_u64(v2, v3)) {
