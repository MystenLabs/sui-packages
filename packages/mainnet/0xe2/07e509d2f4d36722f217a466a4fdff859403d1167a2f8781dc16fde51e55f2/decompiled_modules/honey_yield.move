module 0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey_yield {
    ...
    struct HoneyYield has key {
        ...
        honey_bought_back: 0x2::balance::Balance<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>,
        honey_to_burn: 0x2::balance::Balance<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>,
    ...
    public fun add_honey_bought_back(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>) {
        0x2::balance::join<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>(&mut arg0.honey_bought_back, arg1);
    }
    ...
    public fun deposit_honey_to_burn(arg0: &mut HoneyYield, arg1: 0x2::balance::Balance<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>) {
        assert!(arg0.module_version == 0, 4010);
        0x2::balance::join<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>(&mut arg0.honey_to_burn, arg1);
    }
    ...
    public fun get_fee_info<T0>(arg0: &HoneyYield) : (u64, u64) {
        if (0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::curves::is_stable<T0>()) {
            return (arg0.pool_fee_config.stable_pool_fee.total_fee_bps, arg0.pool_fee_config.stable_pool_fee.protocol_fee_pct)
        };
        if (0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::curves::is_weighted<T0>()) {
            return (arg0.pool_fee_config.weighted_pool_fee.total_fee_bps, arg0.pool_fee_config.weighted_pool_fee.protocol_fee_pct)
        };
        if (0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::curves::is_curved<T0>()) {
    ...
    fun init(arg0: HONEY_YIELD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = HoneyYield{
            ...
            honey_bought_back  : 0x2::balance::zero<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>(),
            honey_to_burn      : 0x2::balance::zero<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>(),
    ...
    public fun mint_new_honey_claimer(arg0: &0x2::coin::TreasuryCap<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (address, ClaimHoneyCap) {
    ...
    public fun update_claimer_capability(arg0: &0x2::coin::TreasuryCap<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>, arg1: &mut ClaimHoneyCap, arg2: u64, arg3: u64) {
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut HoneyYield, arg1: &HoneyYieldAdminCap, arg2: u64, arg3: u64) {
        assert!(arg0.module_version == 0, 4010);
        0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::curves::assert_valid_curve<T0>();
        if (0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::curves::is_stable<T0>()) {
            let v0 = &mut arg0.pool_fee_config.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.pool_fee_config.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::curves::is_curved<T0>()) {
    ...
    public fun withdraw_honey_bought_back(arg0: &HoneyBoughtBackClaimCap, arg1: &mut HoneyYield) : 0x2::balance::Balance<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY> {
        let v0 = HoneyBoughtBackWithdrawn{amount: 0x2::balance::value<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>(&arg1.honey_bought_back)};
        0x2::event::emit<HoneyBoughtBackWithdrawn>(v0);
        0x2::balance::withdraw_all<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>(&mut arg1.honey_bought_back)
    }

    public fun withdraw_honey_to_burn(arg0: &mut HoneyYield, arg1: &0x2::coin::TreasuryCap<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>) : 0x2::balance::Balance<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY> {
        0x2::balance::withdraw_all<0xe207e509d2f4d36722f217a466a4fdff859403d1167a2f8781dc16fde51e55f2::honey::HONEY>(&mut arg0.honey_to_burn)
    }
