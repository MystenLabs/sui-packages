module 0xe2785270b2e6179e68204dd5901a43f9a0e1c566baf656cad705d45a419c4d3a::price_update_policy {
    struct PriceUpdateRequest<phantom T0> {
        for: 0x2::object::ID,
        receipts: 0x2::vec_set::VecSet<0x1::type_name::TypeName>,
        price_feeds: vector<0xe2785270b2e6179e68204dd5901a43f9a0e1c566baf656cad705d45a419c4d3a::price_feed::PriceFeed>,
    }
    ...
    public fun add_price_feed<T0, T1: drop>(arg0: T1, arg1: &mut PriceUpdateRequest<T0>, arg2: 0xe2785270b2e6179e68204dd5901a43f9a0e1c566baf656cad705d45a419c4d3a::price_feed::PriceFeed) {
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.receipts, 0x1::type_name::get<T1>());
        0x1::vector::push_back<0xe2785270b2e6179e68204dd5901a43f9a0e1c566baf656cad705d45a419c4d3a::price_feed::PriceFeed>(&mut arg1.price_feeds, arg2);
    }
    ...
    public(friend) fun add_rule_v2<T0, T1>(arg0: &mut PriceUpdatePolicy, arg1: &PriceUpdatePolicyCap) {
        ...
        let v3 = 0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(v1, v2);
        0x2::vec_set::insert<0x1::type_name::TypeName>(v3, 0x1::type_name::get<T1>());
        assert!(0x2::vec_set::size<0x1::type_name::TypeName>(v3) <= 1, 724);
    }

    public fun confirm_request<T0>(arg0: PriceUpdateRequest<T0>, arg1: &PriceUpdatePolicy) : vector<0xe2785270b2e6179e68204dd5901a43f9a0e1c566baf656cad705d45a419c4d3a::price_feed::PriceFeed> {
    ...
    public fun new_request<T0>(arg0: &PriceUpdatePolicy) : PriceUpdateRequest<T0> {
        PriceUpdateRequest<T0>{
            ...
            price_feeds : 0x1::vector::empty<0xe2785270b2e6179e68204dd5901a43f9a0e1c566baf656cad705d45a419c4d3a::price_feed::PriceFeed>(),
        }
    }
