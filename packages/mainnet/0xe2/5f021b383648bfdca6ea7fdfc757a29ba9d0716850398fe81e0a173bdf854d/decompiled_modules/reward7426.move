module 0xe25f021b383648bfdca6ea7fdfc757a29ba9d0716850398fe81e0a173bdf854d::reward7426 {
    struct REWARD7426 has drop {
        dummy_field: bool,
    }

    struct TICKET_7426 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7426(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7426>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7426>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7426, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7426>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7426>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7426>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7426>>(v5, 0x2::tx_context::sender(arg1));
    }
