module 0x156148204d752ec2e727b7f7d0c54d3e0eb84fb32652a2b07de7477c407c6596::dao {
    ...
    public fun join_or_insert_asset<T0>(arg0: &AdminCap, arg1: &0x156148204d752ec2e727b7f7d0c54d3e0eb84fb32652a2b07de7477c407c6596::dao_config::GlobalDaoConfig, arg2: &mut DAOFund, arg3: 0x2::coin::Coin<T0>, arg4: Loan, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x156148204d752ec2e727b7f7d0c54d3e0eb84fb32652a2b07de7477c407c6596::dao_config::check_package_version(arg1);
    ...
    public fun split_asset<T0>(arg0: &AdminCap, arg1: &0x156148204d752ec2e727b7f7d0c54d3e0eb84fb32652a2b07de7477c407c6596::dao_config::GlobalDaoConfig, arg2: &mut DAOFund, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: u64, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, Loan) {
        0x156148204d752ec2e727b7f7d0c54d3e0eb84fb32652a2b07de7477c407c6596::dao_config::check_package_version(arg1);
        validate_admin_cap(arg0, arg2);
        assert!(0x2::clock::timestamp_ms(arg8) < arg2.dao_end_at, 1013);
        assert!(0x2::clock::timestamp_ms(arg8) < arg6, 1026);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::bag::contains<0x1::ascii::String>(&arg2.assets, v0), 1018);
        verify_signature(0x156148204d752ec2e727b7f7d0c54d3e0eb84fb32652a2b07de7477c407c6596::dao_config::get_verifier_pubkey(arg1), 0x2::tx_context::sender(arg9), 0x2::object::id<DAOFund>(arg2), arg3, arg4, arg5, arg6, arg7);
        let v1 = 0x2::bag::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg2.assets, v0);
        assert!(0x2::balance::value<T0>(v1) >= arg3, 1019);
        ...
        (0x2::coin::from_balance<T0>(v2, arg9), v4)
    }
