module 0xe2da2c5c6d6f81bf9238d9235d55aa448a46c51b0771ec9a38729d5450fd5570::candy_machine {
    struct CandyMachine has store, key {
        id: 0x2::object::UID,
        box_ids: vector<0x2::object::ID>,
    }

    struct LoadEvent has copy, drop {
        candy: u256,
    }
    ...
    public fun load_candies(arg0: &mut CandyMachine, arg1: vector<u256>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x1::vector::is_empty<u256>(&arg1)) {
            ...
            while (!0x1::vector::is_empty<u256>(&arg1) && 0x1::vector::length<u256>(v4) < 5000) {
                let v5 = 0x1::vector::pop_back<u256>(&mut arg1);
                let v6 = LoadEvent{candy: v5};
                0x2::event::emit<LoadEvent>(v6);
                0x1::vector::push_back<u256>(v4, v5);
            };
            v1 = v1 + 1;
        };
    }
