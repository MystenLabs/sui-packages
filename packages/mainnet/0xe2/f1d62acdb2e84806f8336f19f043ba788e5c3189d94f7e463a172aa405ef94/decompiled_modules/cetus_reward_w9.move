module 0xe2f1d62acdb2e84806f8336f19f043ba788e5c3189d94f7e463a172aa405ef94::cetus_reward_w9 {
    struct CETUS_REWARD_W9 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun DisperseNFT(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmTELtf44RDv1vYQm6XN12N8mBPw16pntKrdjXvdi5XKrD"),
            };
    ...
    fun init(arg0: CETUS_REWARD_W9, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTELtf44RDv1vYQm6XN12N8mBPw16pntKrdjXvdi5XKrD"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_W9>(arg0, arg1);
