module 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool {
    ...
    struct IncentivePools has key {
        ...
        ve_sca_bind: 0x2::table::Table<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::obligation::Obligation>>,
    }
    ...
    public(friend) fun accrue_partial_pool_points(arg0: &mut IncentivePools, arg1: &vector<0x1::type_name::TypeName>, arg2: &0x2::clock::Clock) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x1::type_name::TypeName>(arg1)) {
            let v1 = 0x2::table::borrow_mut<0x1::type_name::TypeName, IncentivePool>(&mut arg0.pools, *0x1::vector::borrow<0x1::type_name::TypeName>(arg1, v0));
            accrue_points(v1, arg2);
            v0 = v0 + 1;
        };
    }
    ...
    fun accrue_points(arg0: &mut IncentivePool, arg1: &0x2::clock::Clock) {
        ...
        while (v0 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.points_list)) {
            ...
            let v3 = 0x1::u64::min(v1.distributed_point_per_period * v2, v1.points);
            v1.last_update = v1.last_update + v2 * v1.point_distribution_time;
            if (v3 == 0 || v1.weighted_amount == 0) {
                v0 = v0 + 1;
                continue
            };
            v1.distributed_point = v1.distributed_point + v3;
            v1.points = v1.points - v3;
            v1.index = v1.index + 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::utils::mul_div(1000000000, v3, v1.weighted_amount);
            v0 = v0 + 1;
        };
    }
    ...
    public(friend) fun add_similar_coin(arg0: &mut IncentivePools, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName) {
        if (!0x2::dynamic_field::exists_<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin>(&arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1))) {
            0x2::dynamic_field::add<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&mut arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1), 0x2::vec_set::singleton<0x1::type_name::TypeName>(arg2));
        } else {
            0x2::vec_set::insert<0x1::type_name::TypeName>(0x2::dynamic_field::borrow_mut<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&mut arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1)), arg2);
        };
    }
    ...
    public(friend) fun bind_ve_sca_to_incentive_account(arg0: &mut IncentivePools, arg1: 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, arg2: 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::obligation::Obligation>) {
        0x2::table::add<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::obligation::Obligation>>(&mut arg0.ve_sca_bind, arg1, arg2);
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut IncentivePools, arg1: 0x1::type_name::TypeName, arg2: u64) : (u64, 0x2::balance::Balance<T0>) {
        let v0 = 0x1::u64::min(arg2, remaining_rewards<T0>(arg0, arg1));
    ...
    public(friend) fun create_incentive_pools(arg0: &mut 0x2::tx_context::TxContext) : 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<IncentivePools> {
        let v0 = IncentivePools{
            ...
            ve_sca_bind            : 0x2::table::new<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::obligation::Obligation>>(arg0),
        };
        0x2::transfer::share_object<IncentivePools>(v0);
        0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::new<IncentivePools>(&v0)
    }
    ...
    public fun is_coin_similar(arg0: &IncentivePools, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName) : bool {
        0x2::vec_set::contains<0x1::type_name::TypeName>(0x2::dynamic_field::borrow<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1)), &arg2)
    }
    ...
    public fun is_ve_sca_binded(arg0: &IncentivePools, arg1: 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>) : bool {
        0x2::table::contains<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::obligation::Obligation>>(&arg0.ve_sca_bind, arg1)
    }
    ...
    public(friend) fun remove_similar_coin(arg0: &mut IncentivePools, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName) {
        assert!(0x2::dynamic_field::exists_<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin>(&arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1)), 3);
        0x2::vec_set::remove<0x1::type_name::TypeName>(0x2::dynamic_field::borrow_mut<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&mut arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1)), &arg2);
    }
    ...
    public fun reward_fee_recipient(arg0: &IncentivePools) : address {
        assert!(is_reward_fee_recipient_exist(arg0), 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::app_error::reward_fee_recipient_not_exist());
        *0x1::option::borrow<address>(&arg0.reward_fee_recipient)
    }

    public fun similar_coins(arg0: &IncentivePools, arg1: 0x1::type_name::TypeName) : 0x2::vec_set::VecSet<0x1::type_name::TypeName> {
        if (0x2::dynamic_field::exists_<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin>(&arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1))) {
            *0x2::dynamic_field::borrow<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::SimilarCoin, 0x2::vec_set::VecSet<0x1::type_name::TypeName>>(&arg0.id, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::incentive_pool_dynamic_keys::similar_coin_key(arg1))
        } else {
            0x2::vec_set::empty<0x1::type_name::TypeName>()
        }
    }
    ...
    public(friend) fun unbind_ve_sca_from_incentive_account(arg0: &mut IncentivePools, arg1: 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, arg2: 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::obligation::Obligation>) {
        assert!(0x2::table::remove<0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0xcfe2d87aa5712b67cad2732edb6a2201bfdf592377e5c0968b7cb02099bd8e21::ve_sca::VeScaKey>, 0xe22ed94b5aec53a2795ba615c0b512e6551a915dc26ccc3b6cbdae3c08d6d787::typed_id::TypedID<0x456458fcaa704eeebfc3d5c11e87393dc1f51d28650e58a0295e7ae14fa01b16::obligation::Obligation>>(&mut arg0.ve_sca_bind, arg1) == arg2, 2);
    }
