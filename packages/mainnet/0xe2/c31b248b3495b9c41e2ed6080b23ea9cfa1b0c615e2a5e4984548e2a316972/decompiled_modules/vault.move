    ...
    public(friend) fun process_clearing_house_for_force_withdraw<T0, T1>(arg0: &mut WithdrawSession<T0, T1>, arg1: 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::ClearingHouse<T1>, arg2: &0xa8172ed2a6f14cd0ee55124326685713d6f765039e7c5339f7a0b57be06fddb5::price_feed_storage::PriceFeedStorage, arg3: &0xa8172ed2a6f14cd0ee55124326685713d6f765039e7c5339f7a0b57be06fddb5::price_feed_storage::PriceFeedStorage, arg4: &0xa8172ed2a6f14cd0ee55124326685713d6f765039e7c5339f7a0b57be06fddb5::config::Config, arg5: &0x2::clock::Clock, arg6: u64, arg7: &vector<u128>, arg8: &0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<0x2::object::ID>(v2)) {
            ...
            if (0x1::vector::borrow<0x2::object::ID>(v2, v3) == &v5) {
                ...
                let v18 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::max(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::abs(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::add(v14, v17)), 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::abs(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::sub(v14, v16)));
                let v19 = if (v18 != 0) {
                    0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::max(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::div(v9, 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::abs(v18), v7)), v8)
                } else {
                ...
                let v20 = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::get_position<T1>(&arg1, v6);
                let (v21, _) = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::position::get_amounts(v20);
                let (v23, v24) = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::position::get_pending_amounts(v20);
                let v25 = if (v23 == 0) {
                    if (v24 == 0) {
                        0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::position::get_pending_orders_counter(v20) == 0
                    } else {
                        false
                    }
                } else {
                ...
                assert!(v25, 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::errors::wrong_order_ids_in_force_withdraw());
                let v26 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::to_balance(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::abs(v21), 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::constants::b9_scaling());
                let v27 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::less_than_eq(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::abs(v21), v7), arg0.vault.vault_params.min_force_withdraw_position_usd);
                let v28 = if (v27) {
                    v26
                } else {
                    0x1::u64::min(arg6, v26)
                };
                if (v28 != 0) {
                    let v29 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::is_neg(v21);
                    let v30 = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::interface::start_session<T1>(arg1, account_cap<T0, T1>(&arg0.vault), arg2, arg3, arg4, arg5, arg8);
                    0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::interface::place_market_order<T1>(&mut v30, !v29, v28, true);
                    let (v31, v32) = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::interface::end_session<T1>(v30, &mut arg0.account, false, 0x1::option::none<0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::IntegratorInfo>());
                    let v33 = v32;
                    arg1 = v31;
                    let v34 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::from_balance(v28, 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::constants::b9_scaling()), 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::get_session_execution_price(&v33, !v29));
                    let v35 = if (v29) {
                        0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::sub(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::from_balance(v28, 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::constants::b9_scaling()), v7), v34)
                    } else {
                        0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::sub(v34, 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::from_balance(v28, 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::constants::b9_scaling()), v7))
                    };
                    let v36 = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::get_market_params<T1>(&arg1);
                    let (_, v38) = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::market::get_maker_taker_fees(v36);
                    let v39 = get_additional_gas_price_taker_fee(0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::get_market_state<T1>(&arg1), v36, 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::from_u64(0x2::tx_context::gas_price(arg8)));
                    let v40 = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::position::get_taker_fee(0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::get_position<T1>(&arg1, v6));
                    let v41 = if (v40 != 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::constants::null_fee()) {
                        v40
                    } else {
                        v38
                    };
                    let v42 = v41;
                    if (v39 != 0) {
                        v42 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::add(v41, v39);
                    };
                    let v43 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::sub(v35, 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(v34, v42));
                    arg0.accumulated_slippage = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::add(arg0.accumulated_slippage, v43);
                    v12 = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::add(v11, v43);
                };
                ...
                if (v27) {
                    ...
                    let v44 = &arg0.vault.ch_ids;
                    let v45 = 0;
                    let v46;
                    while (v45 < 0x1::vector::length<0x2::object::ID>(v44)) {
                        if (*0x1::vector::borrow<0x2::object::ID>(v44, v45) == 0x2::object::id<0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::ClearingHouse<T1>>(&arg1)) {
                            v46 = 0x1::option::some<u64>(v45);
                            /* label 48 */
                            if (0x1::option::is_some<u64>(&v46)) {
                                0x1::vector::remove<0x2::object::ID>(&mut arg0.vault.ch_ids, 0x1::option::destroy_some<u64>(v46));
                            } else {
                                0x1::option::destroy_none<u64>(v46);
                            };
                            0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::interface::share_clearing_house<T1>(arg1);
                            return
                        };
                    ...
                    let (v47, v48) = get_vault_margin_in_market<T0, T1>(&arg0.vault, &arg1, v7, arg0.collateral_price, v19);
                    let v49 = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::get_position<T1>(&arg1, v6);
                    let (v50, _) = 0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::position::get_amounts(v49);
                    if (v28 != 0) {
                        if (v28 == v26) {
                            assert!(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::position::get_collateral(v49), arg0.collateral_price) <= 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::constants::min_force_withdraw_position_usd(), 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::errors::force_withdraw_collateral_leftover());
                        } else {
                            assert!(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::greater_than_eq(v47, v48), 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::errors::force_withdraw_below_margin_ratio());
                            assert!(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::greater_than_eq(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::add(v19, arg0.vault.vault_params.max_force_withdraw_mr_tolerance), 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::div(v47, 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::mul(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::abs(v50), v7))), 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::errors::force_withdraw_above_margin_ratio_tolerance());
                        };
                    } else if (v21 != 0) {
                        assert!(0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::greater_than_eq(v47, v48), 0xe2c31b248b3495b9c41e2ed6080b23ea9cfa1b0c615e2a5e4984548e2a316972::errors::force_withdraw_below_margin_ratio());
                    };
                    if (v50 == 0) {
                        0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::interface::deallocate_free_collateral<T1>(&mut arg1, account_cap<T0, T1>(&arg0.vault), &mut arg0.account, arg2, arg3, arg4, arg5);
                        let v52 = &arg0.vault.ch_ids;
                        let v53 = 0;
                        let v54;
                        while (v53 < 0x1::vector::length<0x2::object::ID>(v52)) {
                            if (*0x1::vector::borrow<0x2::object::ID>(v52, v53) == 0x2::object::id<0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::clearing_house::ClearingHouse<T1>>(&arg1)) {
                                v54 = 0x1::option::some<u64>(v53);
                                /* label 80 */
                                if (0x1::option::is_some<u64>(&v54)) {
                                    0x1::vector::remove<0x2::object::ID>(&mut arg0.vault.ch_ids, 0x1::option::destroy_some<u64>(v54));
                                } else {
                                    0x1::option::destroy_none<u64>(v54);
                                };
                                0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::interface::share_clearing_house<T1>(arg1);
                                return
                            };
                        ...
                        v54 = 0x1::option::none<u64>();
                        /* goto 80 */
                    } else {
                        arg0.vault_balance_value = 0x46234ba81f3a5ba6571383233df0f9ea5fe60a3a327537be1f5fec447bced693::ifixed::add(arg0.vault_balance_value, v47);
                        0x7652401d237449eaf43391ac9e089df3012bdf5978caf485a6da3b983c2c8be0::interface::share_clearing_house<T1>(arg1);
                        return
                    };
                };
