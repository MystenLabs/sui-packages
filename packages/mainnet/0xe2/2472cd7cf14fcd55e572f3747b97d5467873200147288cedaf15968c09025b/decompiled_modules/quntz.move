module 0xe22472cd7cf14fcd55e572f3747b97d5467873200147288cedaf15968c09025b::quntz {
    ...
    fun create_nft(arg0: &NFTCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : NFT {
        let v0 = 0x1::string::utf8(b"qxxxntz #");
        ...
        NFT{
            ...
            name        : v0,
            description : 0x1::string::utf8(b"When degens come together, they become qxxxntz"),
            image_url   : v2,
            attributes  : v1,
            token_id    : arg1,
        }
    ...
    fun init(arg0: QUNTZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = NFTCollection{
            ...
            mint_start        : 1744927200000,
            phase_end         : 1800000,
            admin_address     : @0x9728ec13d7321c7ee46669454e6d49857cc29fed09ba13696af7692c55e61a24,
            treasury_address  : @0xbf3f7889d1646a4d300bbd110c3bff9b6b3695677a9fb0b8ee0e72e9e529f900,
        };
        let v2 = 1;
        while (v2 <= 2700) {
