module 0xe28d4fcdd69405655e55c551b10b486bfc33fe8c28b2657158b3381840c3bbb5::sui_mint_pass {
    ...
    fun init(arg0: SUI_MINT_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_MINT_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Mint Pass"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://T0V9RVaG8QVbfkVkY2eIftuYeFr1faDTNfTuAriKJPc"));
