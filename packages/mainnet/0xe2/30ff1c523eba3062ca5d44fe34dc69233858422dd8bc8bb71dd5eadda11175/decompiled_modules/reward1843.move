module 0xe230ff1c523eba3062ca5d44fe34dc69233858422dd8bc8bb71dd5eadda11175::reward1843 {
    struct REWARD1843 has drop {
        dummy_field: bool,
    }

    struct TICKET_1843 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1843(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1843>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1843>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1843, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1843>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1843>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1843>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1843>>(v5, 0x2::tx_context::sender(arg1));
    }
