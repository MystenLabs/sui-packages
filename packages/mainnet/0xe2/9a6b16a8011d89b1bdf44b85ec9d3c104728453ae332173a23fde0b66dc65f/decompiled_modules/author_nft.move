module 0xe29a6b16a8011d89b1bdf44b85ec9d3c104728453ae332173a23fde0b66dc65f::author_nft {
    ...
    fun init(arg0: AUTHOR_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = LiteraryCollection{
            ...
            name             : 0x1::string::utf8(b"Walrus Protocol Poetry and Prose"),
            description      : 0x1::string::utf8(b"A curated collection of literary works published by our magazine, featuring stories, poems, and web3 explorations from talented authors."),
