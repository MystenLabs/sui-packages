module 0xe2aa47123dd17a6119b292b9c324ed534ea7914969d94b6920ee5e1598a02f19::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun burn_nft(arg0: TicketNFT, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0x633b8c6c3b3c59da128c871bc4e740d405ba3bdb22ed2b8568021453a9e2c19c, 1);
        let TicketNFT {
            id          : v0,
            name        : _,
            description : _,
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        if (0x2::tx_context::sender(arg3) != @0x633b8c6c3b3c59da128c871bc4e740d405ba3bdb22ed2b8568021453a9e2c19c) {
            abort 1
        };
        let v0 = TicketNFT{
