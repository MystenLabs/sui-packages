module 0x77a7f3abff4be8138360f283a2ce532a18315a1c1e3ef6b54f181715e0afb191::project_manager {
    ...
    public fun batch_add_whitelist<T0>(arg0: &0x77a7f3abff4be8138360f283a2ce532a18315a1c1e3ef6b54f181715e0afb191::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManager<T0>, arg2: vector<address>, arg3: vector<u64>) {
    ...
    public fun batch_remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0x77a7f3abff4be8138360f283a2ce532a18315a1c1e3ef6b54f181715e0afb191::launchpad_manager_config::LaunchManagerAdmin, arg2: vector<address>) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 <= 200, 13);
        let v1 = 0;
        while (v1 < v0) {
    ...
    public fun burn_pay_nft(arg0: PayNft) : (0x2::object::ID, u8, address, u64, u64, 0x1::type_name::TypeName) {
        let PayNft {
            id        : v0,
            status    : v1,
            owner     : v2,
    ...
    public fun change_pay_nft_status(arg0: &mut PayNft, arg1: &0x77a7f3abff4be8138360f283a2ce532a18315a1c1e3ef6b54f181715e0afb191::launchpad_manager_config::LaunchAdmin) {
        arg0.status = 1;
    }
    ...
    public(friend) fun fund_script<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut ProjectManager<T0>, arg2: &ProjectManagerConfig, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v4 = *0x2::table::borrow<address, u64>(&arg1.whitelist_buy_amount, 0x2::tx_context::sender(arg4));
        assert!(*0x2::table::borrow<address, u64>(&arg1.whitelist, 0x2::tx_context::sender(arg4)) >= v3 + v4, 10);
        ...
        *0x2::table::borrow_mut<address, u64>(&mut arg1.whitelist_buy_amount, 0x2::tx_context::sender(arg4)) = v4 + v3;
        ...
        let v6 = 0x2::object::id<ProjectManager<T0>>(arg1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ProjectConfig{
            level              : 0,
            max_funding_amount : 900000000000000,
            token_price        : 60,
            target_fund        : 54000000000000,
        };
    ...
    public entry fun initialize_project_manager<T0>(arg0: &0x77a7f3abff4be8138360f283a2ce532a18315a1c1e3ef6b54f181715e0afb191::launchpad_manager_config::LaunchAdmin, arg1: &mut PayNft, arg2: u64, arg3: u64, arg4: u64, arg5: u8, arg6: &mut ProjectManagerConfig, arg7: &mut 0x2::tx_context::TxContext) {
        assert_version(arg6);
        let v0 = if (arg5 == 0) {
            true
        } else if (arg5 == 1) {
        ...
        let (v1, _, v3) = get_project_fund_config_by_level(arg5, arg6);
        let v4 = 0x1::type_name::get<T0>();
        let v5 = 0x2::object::new(arg7);
        let v6 = 0x2::object::uid_to_address(&v5);
        0x2::table::add<address, address>(&mut arg6.projects, v6, arg1.owner);
        let v7 = ProjectAdmin{
            id                       : 0x2::object::new(arg7),
            project_manager          : v6,
            claimed_incentive_amount : 0,
        };
        0x2::transfer::transfer<ProjectAdmin>(v7, arg1.owner);
    ...
    public fun project_falied<T0>(arg0: &mut ProjectManager<T0>, arg1: &0x77a7f3abff4be8138360f283a2ce532a18315a1c1e3ef6b54f181715e0afb191::launchpad_manager_config::LaunchAdmin, arg2: &0x2::clock::Clock) {
    ...
    public fun set_project_config(arg0: &0x77a7f3abff4be8138360f283a2ce532a18315a1c1e3ef6b54f181715e0afb191::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u8, arg3: u64, arg4: u64, arg5: u64) {
