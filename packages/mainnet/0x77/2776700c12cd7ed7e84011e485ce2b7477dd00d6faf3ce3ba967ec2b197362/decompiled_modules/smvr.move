module 0x772776700c12cd7ed7e84011e485ce2b7477dd00d6faf3ce3ba967ec2b197362::smvr {
    ...
    entry fun mint_and_stake(arg0: &mut Registry, arg1: &mut 0x772776700c12cd7ed7e84011e485ce2b7477dd00d6faf3ce3ba967ec2b197362::pool::Pool, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg2) / 100;
        assert!(v0 <= 666666666666666666 - 0x2::coin::total_supply<SMVR>(&arg0.treasury_cap), 0);
        0x772776700c12cd7ed7e84011e485ce2b7477dd00d6faf3ce3ba967ec2b197362::pool::stake<SMVR>(arg1, 0x2::coin::mint<SMVR>(&mut arg0.treasury_cap, v0, arg4), arg3, arg4);
