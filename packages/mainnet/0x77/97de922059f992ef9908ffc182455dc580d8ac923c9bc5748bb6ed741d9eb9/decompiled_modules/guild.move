module 0x9e6d08c834126114d8ba66239a2c0637939087a4e5b91a752e956798f76be024::guild {
    ...
    public(friend) fun set_checkin_v2<T0>(arg0: &Config, arg1: &mut GlobalVault, arg2: &mut UserArchive, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock) : (u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg4);
        let v1 = start_of_day(v0);
        let v2 = get_max_check_in_days(arg0);
        let v3 = 0x2::dynamic_field::borrow_mut<vector<u8>, Checkin>(&mut arg2.id, b"CHECKIN_KEY");
        assert!(v2 > 0, 6025);
