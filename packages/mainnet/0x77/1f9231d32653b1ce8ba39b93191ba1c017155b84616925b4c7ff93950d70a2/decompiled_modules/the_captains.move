module 0x771f9231d32653b1ce8ba39b93191ba1c017155b84616925b4c7ff93950d70a2::the_captains {
    ...
    public fun admin_load_traits(arg0: &AdminCap, arg1: &mut TraitsRegistry, arg2: u64, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String) {
    ...
    public fun admin_load_traits_batch(arg0: &AdminCap, arg1: &mut TraitsRegistry, arg2: vector<u64>, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<0x1::string::String>, arg12: vector<0x1::string::String>) {
        ...
        while (v1 < v0) {
            ...
            let v3 = CaptainAttributes{
                horizon   : *0x1::vector::borrow<0x1::string::String>(&arg3, v1),
                sex       : *0x1::vector::borrow<0x1::string::String>(&arg4, v1),
                physique  : *0x1::vector::borrow<0x1::string::String>(&arg5, v1),
                companion : *0x1::vector::borrow<0x1::string::String>(&arg6, v1),
                garb      : *0x1::vector::borrow<0x1::string::String>(&arg7, v1),
                whiskers  : *0x1::vector::borrow<0x1::string::String>(&arg8, v1),
                headgear  : *0x1::vector::borrow<0x1::string::String>(&arg9, v1),
                gaze      : *0x1::vector::borrow<0x1::string::String>(&arg10, v1),
                trinkets  : *0x1::vector::borrow<0x1::string::String>(&arg11, v1),
                armament  : *0x1::vector::borrow<0x1::string::String>(&arg12, v1),
            };
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"attributes"));
        let v10 = 0x1::vector::empty<0x1::string::String>();
        let v11 = &mut v10;
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"The Captains #{token_id}"));
        ...
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"Coral Reef"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"3,333 captains are ready to assemble their crews, board their ships, and set sail to explore the Coral Reef."));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"{attributes}"));
    ...
    fun mint_core(arg0: &PubKey, arg1: u64, arg2: u64, arg3: u64, arg4: address, arg5: vector<u8>, arg6: u8, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: &mut Counter, arg12: &MintConfig, arg13: &mut MintStats, arg14: &Payout, arg15: 0x2::coin::Coin<0x2::sui::SUI>, arg16: &0x2::transfer_policy::TransferPolicy<PfpNFT>, arg17: &mut 0x2::kiosk::Kiosk, arg18: &0x2::kiosk::KioskOwnerCap, arg19: &0x2::clock::Clock, arg20: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_valid_hash_alg(arg6), 13);
    ...
    public fun mint_test(arg0: &PubKey, arg1: u64, arg2: u64, arg3: address, arg4: vector<u8>, arg5: u8, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: &mut Counter, arg11: &MintConfig, arg12: &mut MintStats, arg13: &Payout, arg14: &0x2::transfer_policy::TransferPolicy<PfpNFT>, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::new(arg16);
        let v2 = v1;
        let v3 = v0;
        let v4 = 0x2::coin::zero<0x2::sui::SUI>(arg16);
        let v5 = &mut v3;
        mint_core(arg0, arg1, 0, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, v4, arg14, v5, &v2, arg15, arg16);
        let v6 = KioskCreated{
            kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(&v3),
            cap_id   : 0x2::object::id<0x2::kiosk::KioskOwnerCap>(&v2),
        };
        0x2::event::emit<KioskCreated>(v6);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v3);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v2, 0x2::tx_context::sender(arg16));
    }

    public fun reveal(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut TraitsRegistry, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: &0x2::tx_context::TxContext) {
