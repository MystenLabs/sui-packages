module 0x77b5ff90a988beab0864e468bf3b006f2df0ad29b17fc590b139e4443396dd06::oracle {
    public(friend) fun calculate_pyth_primitive_prices(arg0: vector<u8>, arg1: &0x2::clock::Clock, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: u8, arg4: u64, arg5: u64, arg6: u8) : (u64, u64, u64, u64, u64, u64) {
        let v0 = 0x77b5ff90a988beab0864e468bf3b006f2df0ad29b17fc590b139e4443396dd06::safe_math::get_one_decimals();
        let (v1, v2, v3) = get_pyth_price(arg0, arg1, arg2, v0, arg4);
        (0x77b5ff90a988beab0864e468bf3b006f2df0ad29b17fc590b139e4443396dd06::safe_math::safe_mul_div_u64(v1, 0x1::u64::pow(10, v0 + arg6 - arg3), arg5), 0x77b5ff90a988beab0864e468bf3b006f2df0ad29b17fc590b139e4443396dd06::safe_math::safe_mul_div_u64(v2, 0x1::u64::pow(10, v0 + arg6 - arg3), arg5), 0x77b5ff90a988beab0864e468bf3b006f2df0ad29b17fc590b139e4443396dd06::safe_math::safe_mul_div_u64(arg5, 0x1::u64::pow(10, v0 + arg3 - arg6), v1), v1, v2, v3)
    }
    ...
    fun get_pyth_price_pro(arg0: u32, arg1: &0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::update::Update, arg2: &0x2::clock::Clock, arg3: u8, arg4: u64) : (u64, u64, u64) {
        ...
        let (v9, v10) = if (v8 < arg3) {
            ((v5 + v7) * 0x1::u64::pow(10, arg3 - v8), (v5 - v7) * 0x1::u64::pow(10, arg3 - v8))
        } else {
            ((v5 + v7) / 0x1::u64::pow(10, v8 - arg3), (v5 - v7) / 0x1::u64::pow(10, v8 - arg3))
        };
        (v9, v10, v6)
    }
