module 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_constant_product {
    struct MemezConstantProduct<phantom T0, phantom T1> has store {
        ...
        burner: 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_burner::MemezBurner,
    ...
    public(friend) fun new<T0, T1>(arg0: u64, arg1: u64, arg2: 0x2::balance::Balance<T0>, arg3: 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::Fee, arg4: 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::Fee, arg5: 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::BPS, arg6: 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::BPS, arg7: u64) : MemezConstantProduct<T0, T1> {
        MemezConstantProduct<T0, T1>{
            ...
            meme_balance           : arg2,
            burner                 : 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_burner::new(arg7, arg1),
            meme_swap_fee          : arg3,
            quote_swap_fee         : arg4,
    ...
    public(friend) fun burner<T0, T1>(arg0: &MemezConstantProduct<T0, T1>) : 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_burner::MemezBurner {
        arg0.burner
    }
    ...
    public(friend) fun dump<T0, T1>(arg0: &mut MemezConstantProduct<T0, T1>, arg1: &mut 0xa204bd0d48d49fc7b8b05c8ef3f3ae63d1b22d157526a88b91391b41e6053157::ipx_coin_standard::IPXTreasuryStandard, arg2: 0x2::coin::Coin<T0>, arg3: 0x1::option::Option<address>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::take_with_discount<T0>(arg0.meme_swap_fee, &mut arg2, arg0.meme_referrer_fee, arg5);
        let v4 = 0x2::coin::value<T0>(&arg2);
        assert!(v4 > 0, 2);
        let v5 = 0x2::balance::value<T0>(&arg0.meme_balance);
        let v6 = 0x2::balance::value<T1>(&arg0.quote_balance);
        let v7 = 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_burner::calculate(arg0.burner, v6);
        ...
        let v12 = v11 - 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::calculate_with_discount(arg0.quote_swap_fee, arg0.quote_referrer_fee, v11) - 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.quote_referrer_fee, v11);
        assert!(v12 >= arg4, 3);
        ...
        0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_events::dump<T0, T1>(arg0.memez_fun, arg0.inner_state, v9 + v3, v12, v3, 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::take_with_discount<T1>(arg0.quote_swap_fee, &mut v13, arg0.quote_referrer_fee, arg5), v8, 0x2::balance::value<T1>(&arg0.quote_balance), 0x2::balance::value<T0>(&arg0.meme_balance), arg0.virtual_liquidity, arg3, v1, v15);
        v13
    }
    ...
    public(friend) fun dump_amount<T0, T1>(arg0: &MemezConstantProduct<T0, T1>, arg1: u64) : vector<u64> {
        ...
        let v2 = 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::calculate_with_discount(arg0.meme_swap_fee, arg0.meme_referrer_fee, arg1) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.meme_referrer_fee, arg1);
        let v3 = arg1 - v2;
        let v4 = 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_burner::calculate(arg0.burner, v1), v3);
        assert!(v3 - v4 != 0, 1);
        ...
        let v7 = 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::calculate_with_discount(arg0.quote_swap_fee, arg0.quote_referrer_fee, v6) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.quote_referrer_fee, v6);
    ...
    public(friend) fun pump<T0, T1>(arg0: &mut MemezConstantProduct<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: 0x1::option::Option<address>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (bool, 0x2::coin::Coin<T0>) {
        ...
        let v3 = 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::take_with_discount<T1>(arg0.quote_swap_fee, &mut arg1, arg0.quote_referrer_fee, arg4);
        ...
        let v8 = v7 - 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::calculate_with_discount(arg0.meme_swap_fee, arg0.meme_referrer_fee, v7) - 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.meme_referrer_fee, v7);
        assert!(v8 >= arg3, 3);
        ...
        0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_events::pump<T0, T1>(arg0.memez_fun, arg0.inner_state, v4 + v3, v8, 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::take_with_discount<T0>(arg0.meme_swap_fee, &mut v9, arg0.meme_referrer_fee, arg4), v3, v10, 0x2::balance::value<T0>(&arg0.meme_balance), arg0.virtual_liquidity, arg2, v12, v1);
    ...
    public(friend) fun pump_amount<T0, T1>(arg0: &MemezConstantProduct<T0, T1>, arg1: u64) : vector<u64> {
        ...
        let v0 = 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::calculate_with_discount(arg0.quote_swap_fee, arg0.quote_referrer_fee, arg1) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.quote_referrer_fee, arg1);
        assert!(arg1 - v0 != 0, 1);
        ...
        let v3 = 0x77ad40b0364cc5d95406f55d7353bbccaf4284bce12b3ce4bf66de28ebaabc6d::memez_fees::calculate_with_discount(arg0.meme_swap_fee, arg0.meme_referrer_fee, v2) + 0xec50242b14f7ffdc37fb91ade8490cdce2f876e7e9c3c3d7d7d98e944397d8f2::bps::calc_up(arg0.meme_referrer_fee, v2);
