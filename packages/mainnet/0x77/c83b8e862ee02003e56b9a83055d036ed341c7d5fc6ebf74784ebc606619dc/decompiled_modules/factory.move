module 0x77c83b8e862ee02003e56b9a83055d036ed341c7d5fc6ebf74784ebc606619dc::factory {
    ...
    public fun create_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x77c83b8e862ee02003e56b9a83055d036ed341c7d5fc6ebf74784ebc606619dc::lp_coin::LP<T0, T1>> {
        ...
        let (v2, v3) = 0x77c83b8e862ee02003e56b9a83055d036ed341c7d5fc6ebf74784ebc606619dc::pool::create_pool<T0, T1>(arg2, arg3, arg4);
        let v4 = v2;
        let v5 = 0x2::object::id_address<0x77c83b8e862ee02003e56b9a83055d036ed341c7d5fc6ebf74784ebc606619dc::pool::Pool<T0, T1>>(&v4);
        0x2::table::add<PairKey, address>(&mut arg0.pools, v0, v5);
        0x77c83b8e862ee02003e56b9a83055d036ed341c7d5fc6ebf74784ebc606619dc::pool::share_pool<T0, T1>(v4);
        let v6 = PoolCreated{
            pool_id  : v5,
            coin_a   : v0.coin_a,
            coin_b   : v0.coin_b,
