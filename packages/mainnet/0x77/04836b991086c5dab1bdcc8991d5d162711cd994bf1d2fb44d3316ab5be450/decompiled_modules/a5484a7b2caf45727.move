module 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a5484a7b2caf45727 {
    ...
    public fun a5a9339fe7dd9e4a6(arg0: &0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::A0ea878587b719a64, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock) {
        if (!0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::a3e97cb17cc8b4c07(arg0)) {
            return
        };
    ...
    public(friend) fun a820350afdaf0c518<T0, T1>(arg0: &0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::A0ea878587b719a64, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: u64, arg3: u8, arg4: u8, arg5: address, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg7: &mut 0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg10: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg11: &mut 0x3::sui_system::SuiSystemState, arg12: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T1>, arg13: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg14: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::a28c70aa22a06b7eb(arg0);
        let v10 = if (v1 < v9) {
            v1
        } else {
            v9
        ...
        if (v12) {
            let v13 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::ad4985d21e71b208e(arg0);
            let v14 = if (v10 < v13) {
                v10
            } else {
                v13
        ...
        let v15 = if (!0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::a611ed42baa1839e4(arg0)) {
            if (arg4 != 10) {
                arg4 != 0
            } else {
                false
    ...
    fun a96caec0cf7d2a62c(arg0: &0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::A0ea878587b719a64, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: u64, arg3: u64, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::ab78d0325509532d4(arg0, arg1);
        let v1 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::a9d9f98ebd95b9dad(arg0, arg1);
        let v2 = v1;
        let v3 = 0;
        if (v1 < arg3) {
            v3 = arg3 - v1;
        };
        if (v3 > 0 && 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::a02b2fbebbd0b1747(arg0)) {
            let v4 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::ac89fc20276c7e30c(arg0, v3, arg2);
            let v5 = if (v4 < v0) {
                v4
            } else {
                v0
            };
            let v6 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a2ec4300f6df080d1::a099d08408fdb4a75(1);
            ...
            let v8 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a2ec4300f6df080d1::a213fd2a6b463b66d(&v6, v7, arg2 * 99 / 100);
            if (v7 < v8 && v5 > 0) {
                let (_, _) = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a2ec4300f6df080d1::a07270e6afe6ed38d(arg1, arg4, arg5, v5, v8, arg6, arg7);
            };
            v2 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::a9d9f98ebd95b9dad(arg0, arg1);
            0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::ab78d0325509532d4(arg0, arg1);
        };
        if (v2 < arg3) {
            v2
        } else {
    ...
    fun a9d7347eddbc97a66(arg0: &0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::A0ea878587b719a64, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: u64, arg3: u64, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::ab78d0325509532d4(arg0, arg1);
        let v1 = v0;
        0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::a9d9f98ebd95b9dad(arg0, arg1);
        let v2 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::ac89fc20276c7e30c(arg0, arg3, arg2);
        let v3 = 0;
        if (v0 < v2) {
            v3 = v2 - v0;
        };
        if (v3 > 0 && 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a783956f993d811bc::a02b2fbebbd0b1747(arg0)) {
            ...
            let v5 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a2ec4300f6df080d1::a099d08408fdb4a75(1);
            ...
            let v7 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a2ec4300f6df080d1::ac019152139aa990a(&v5, v6, arg2 * 100 / 99);
            if (v6 > v7 && v4 > 0) {
                let (_, _) = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a2ec4300f6df080d1::a35a29cc990f6dc81(arg1, arg4, arg5, v4, v7, arg6, arg7);
            };
            0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::a9d9f98ebd95b9dad(arg0, arg1);
            v1 = 0x7704836b991086c5dab1bdcc8991d5d162711cd994bf1d2fb44d3316ab5be450::a10868438248226c1::ab78d0325509532d4(arg0, arg1);
        };
        if (v1 < v2) {
            v1
        } else {
