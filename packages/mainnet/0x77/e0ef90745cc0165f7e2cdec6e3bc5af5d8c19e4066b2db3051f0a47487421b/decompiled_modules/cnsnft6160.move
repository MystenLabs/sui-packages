module 0x77e0ef90745cc0165f7e2cdec6e3bc5af5d8c19e4066b2db3051f0a47487421b::cnsnft6160 {
    struct CNSNFT6160 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6160, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTHHbY5SiMQA1nsLh5fvk9ifWsX9QGoSyrVnBBoBZEw1C?ref=4203"));
        let v4 = 0x2::package::claim<CNSNFT6160>(arg0, arg1);
