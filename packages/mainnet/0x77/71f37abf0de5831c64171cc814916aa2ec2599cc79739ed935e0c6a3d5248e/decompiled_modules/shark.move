module 0x7771f37abf0de5831c64171cc814916aa2ec2599cc79739ed935e0c6a3d5248e::shark {
    ...
    fun init(arg0: SHARK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"shark "));
