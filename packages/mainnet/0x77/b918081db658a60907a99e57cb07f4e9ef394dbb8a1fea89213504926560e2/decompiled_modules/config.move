module 0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::config {
    ...
    fun init(arg0: CONFIG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u8, bool>(&mut v0, 0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::version::module_type_archive(), false);
        0x2::table::add<u8, bool>(&mut v0, 0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::version::module_type_checkin(), false);
        0x2::table::add<u8, bool>(&mut v0, 0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::version::module_type_mission(), false);
        0x2::table::add<u8, bool>(&mut v0, 0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::version::module_type_game(), false);
        let v1 = Config{
    ...
    public fun pause_trigger(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: &mut Config, arg2: u8, arg3: bool) {
    ...
    public fun update_checkin_reward(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: &mut Config, arg2: u8, arg3: u64) {
    ...
    public fun update_energy(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: &mut Config, arg2: u16, arg3: u16, arg4: u64) {
        let v0 = if (arg2 == 2002) {
            true
        } else if (arg2 == 2003) {
            true
    ...
    public fun update_max_checkin_days(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: &mut Config, arg2: u8) {
        arg1.max_checkin_days = arg2;
    }

    public fun update_max_mating_times(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: &mut Config, arg2: u64) {
        assert!(arg2 != arg1.max_mating_times, 1010);
        arg1.max_mating_times = arg2;
    }

    public fun update_prey_reward(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: &mut Config, arg2: u16, arg3: u64, arg4: u64) {
    ...
    public fun update_time(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: &mut Config, arg2: u16, arg3: u64) {
        let v0 = if (arg2 == 2004) {
            true
        } else if (arg2 == 2001) {
            true
    ...
    public fun update_validator(arg0: &0x77b918081db658a60907a99e57cb07f4e9ef394dbb8a1fea89213504926560e2::manager::AdminCap, arg1: vector<u8>, arg2: &mut Config) {
