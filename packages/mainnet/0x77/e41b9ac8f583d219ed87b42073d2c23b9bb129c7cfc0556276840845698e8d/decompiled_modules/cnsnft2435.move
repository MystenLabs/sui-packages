module 0x77e41b9ac8f583d219ed87b42073d2c23b9bb129c7cfc0556276840845698e8d::cnsnft2435 {
    struct CNSNFT2435 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2435, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2888"));
        let v4 = 0x2::package::claim<CNSNFT2435>(arg0, arg1);
