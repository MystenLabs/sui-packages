module 0x779b9150826a7fc71f8de05088890cb8ce78a6af834296ad10048138e2c9333e::cnsnft9923 {
    struct CNSNFT9923 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9923, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9923>(arg0, arg1);
