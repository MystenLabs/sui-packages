module 0x77d8430f7218fbf3865f34e7521b7a827ca2d930a758a83a9815041dbb73b44f::the_captains {
    ...
    public entry fun claim_and_reveal_from_kiosk(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut TraitsRegistry, arg3: 0x2::object::ID, arg4: &0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, 0x1::string::utf8(b"Class"), v1.class);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, 0x1::string::utf8(b"Weapon"), v1.weapon);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, 0x1::string::utf8(b"Outfit"), v1.outfit);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, 0x1::string::utf8(b"Background"), v1.background);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v0.attributes, 0x1::string::utf8(b"Special"), v1.special);
    ...
    public fun get_attributes(arg0: &PfpNFT) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }
