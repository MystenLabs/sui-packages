module 0x77e09459d1880c38fc8a36941db31787e2c11aed6568a5d8e370092e071df3f6::test_coin {
    struct TEST_COIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 9, b"TEST", b"test", b"tet", 0x1::option::none<0x2::url::Url>(), arg1);
