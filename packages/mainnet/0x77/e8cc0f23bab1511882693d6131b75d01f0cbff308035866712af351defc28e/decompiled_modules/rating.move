module 0x77e8cc0f23bab1511882693d6131b75d01f0cbff308035866712af351defc28e::rating {
    ...
    public entry fun rating_and_comment(arg0: &mut 0x77e8cc0f23bab1511882693d6131b75d01f0cbff308035866712af351defc28e::community::Community, arg1: u64, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x77e8cc0f23bab1511882693d6131b75d01f0cbff308035866712af351defc28e::community::update_total_comments(arg0, arg4);
        0x77e8cc0f23bab1511882693d6131b75d01f0cbff308035866712af351defc28e::community::update_total_reviewers(arg0, arg1, arg4);
        0x2::transfer::share_object<RateAndComment>(v0);
    }

    public entry fun reply_comment(arg0: &mut 0x77e8cc0f23bab1511882693d6131b75d01f0cbff308035866712af351defc28e::community::Community, arg1: &mut RateAndComment, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = CommentChild{
            id          : 0x2::object::new(arg4),
            comment     : arg2,
            is_hidden   : 0,
