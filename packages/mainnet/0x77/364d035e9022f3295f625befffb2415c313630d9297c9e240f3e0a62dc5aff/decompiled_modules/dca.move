module 0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::dca {
    ...
    public fun new<T0, T1>(arg0: &0x2::clock::Clock, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u8, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) : DCA<T0, T1> {
        ...
        DCA<T0, T1>{
            ...
            time_scale       : arg5,
            input_balance    : v0,
            split_allocation : 0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::math::div(0x2::balance::value<T0>(&v0), arg4),
            trade_params     : v5,
            active           : true,
    ...
    fun assert_minimum_funding_per_trade(arg0: u64, arg1: u64) {
        assert!(arg0 >= 0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::math::mul(arg1, 100000), 14);
    }
    ...
    fun assert_time(arg0: u64, arg1: u64, arg2: u64, arg3: u8) {
        let v0 = if (arg3 == 0) {
            0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::time::has_n_seconds_passed(arg0, arg1, arg2)
        } else if (arg3 == 1) {
            0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::time::has_n_minutes_passed(arg0, arg1, arg2)
        } else if (arg3 == 2) {
            0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::time::has_n_hours_passed(arg0, arg1, arg2)
        } else if (arg3 == 3) {
            0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::time::has_n_days_passed(arg0, arg1, arg2)
        } else if (arg3 == 4) {
            0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::time::has_n_weeks_passed(arg0, arg1, arg2)
        } else {
            assert!(arg3 == 5, 0);
            0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::time::has_n_months_passed(arg0, arg1, arg2)
        };
        assert!(v0 == true, 7);
    }
    ...
    fun gas_budget_estimate(arg0: u64) : u64 {
        0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::math::mul(25000000, arg0)
    }
    ...
    fun get_min_output_amount<T0, T1>(arg0: &DCA<T0, T1>, arg1: u64) : u64 {
        if (0x1::option::is_none<u64>(&arg0.trade_params.max_price)) {
            ...
            0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::math::div(arg1, *0x1::option::borrow<u64>(&arg0.trade_params.max_price))
        }
    }
    ...
    public(friend) fun init_trade<T0, T1>(arg0: &mut DCA<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, TradePromise<T0, T1>) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v0, 0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::math::div(0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::math::mul(arg0.split_allocation, 5), 10000)), arg2), arg0.delegatee);
        let v1 = 0x2::balance::value<T0>(&v0);
        let v2 = TradePromise<T0, T1>{
            input      : v1,
            min_output : get_min_output_amount<T0, T1>(arg0, v1),
        };
        (0x2::coin::from_balance<T0>(v0, arg2), v2)
    }
    ...
    fun recompute_split_allocation_unsafe<T0, T1>(arg0: &mut DCA<T0, T1>) {
        arg0.split_allocation = 0x77364d035e9022f3295f625befffb2415c313630d9297c9e240f3e0a62dc5aff::math::div(0x2::balance::value<T0>(&arg0.input_balance), arg0.remaining_orders);
    }
