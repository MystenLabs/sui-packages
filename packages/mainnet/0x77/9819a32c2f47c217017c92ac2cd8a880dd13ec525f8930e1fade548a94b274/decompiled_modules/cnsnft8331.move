module 0x779819a32c2f47c217017c92ac2cd8a880dd13ec525f8930e1fade548a94b274::cnsnft8331 {
    struct CNSNFT8331 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8331, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8331>(arg0, arg1);
