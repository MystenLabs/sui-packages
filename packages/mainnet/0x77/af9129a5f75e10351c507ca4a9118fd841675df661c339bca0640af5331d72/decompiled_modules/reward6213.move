module 0x77af9129a5f75e10351c507ca4a9118fd841675df661c339bca0640af5331d72::reward6213 {
    struct REWARD6213 has drop {
        dummy_field: bool,
    }

    struct TICKET_6213 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6213(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6213>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6213>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6213, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6213>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6213>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6213>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6213>>(v5, 0x2::tx_context::sender(arg1));
    }
