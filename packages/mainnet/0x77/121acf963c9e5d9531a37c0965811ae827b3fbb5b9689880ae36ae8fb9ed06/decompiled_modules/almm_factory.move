module 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_factory {
    ...
    public fun add_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u64, arg3: u16, arg4: u32, arg5: u16, arg6: u16, arg7: u16, arg8: u32, arg9: u16, arg10: u32, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg9 <= 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::max_protocol_share(), 12);
        let v0 = Preset{
            base_factor                : arg4,
            filter_period              : arg5,
            decay_period               : arg6,
    ...
    public fun set_default_partner(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: &0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::partner::Partner) {
        version_only(arg0);
        ...
        0x1::option::fill<0x2::object::ID>(&mut arg0.default_partner, 0x2::object::id<0xb739751c5704a3e0262c63f058b1a9e9ea894988ff57e3caec1e73e097388035::partner::Partner>(arg2));
    }
    ...
    public fun update_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u64, arg3: u16, arg4: Preset) {
        ...
        assert!(arg4.protocol_share <= 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::max_protocol_share(), 12);
