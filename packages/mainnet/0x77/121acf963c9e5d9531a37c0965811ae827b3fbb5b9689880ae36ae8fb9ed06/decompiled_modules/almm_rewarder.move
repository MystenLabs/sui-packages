module 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_factory::Factory, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) : u64 {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_factory::AdminCap, arg1: &0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_factory::Factory, arg2: &mut RewarderGlobalVault, arg3: u64) : 0x2::balance::Balance<T0> {
        0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_factory::version_only(arg1);
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u256, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            ...
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + (v4 as u256) * 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).emissions_per_second / (arg1 >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset());
            v2 = v2 + 1;
        };
        arg0.points_released = arg0.points_released + (v1 as u256) * 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale();
        arg0.points_growth_global = arg0.points_growth_global + (v1 as u256) * 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale() / (arg1 >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset());
    }
    ...
    public(friend) fun update_emission<T0>(arg0: &mut RewarderManager, arg1: &RewarderGlobalVault, arg2: u256, arg3: u256, arg4: u64, arg5: u64) {
        ...
        if (arg3 > 0) {
            ...
            assert!((0x2::balance::value<T0>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&arg1.balances, v0)) as u256) << 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset() >= (0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::day() as u256) * arg3, 4);
        };
