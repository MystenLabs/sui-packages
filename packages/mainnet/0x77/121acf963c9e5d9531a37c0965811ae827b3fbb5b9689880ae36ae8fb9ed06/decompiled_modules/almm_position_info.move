module 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_position_info {
    ...
    public(friend) fun get_position_info_bin_fees(arg0: &PositionInfo, arg1: u32, arg2: u256, arg3: u256) : (u64, u64) {
        ...
        (arg0.fee_owned_x + 0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64((v1 >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset()) * (arg2 - *0x1::vector::borrow<u256>(&arg0.bin_fee_growth_x, v0)) >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset()), arg0.fee_owned_y + 0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64((v1 >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset()) * (arg3 - *0x1::vector::borrow<u256>(&arg0.bin_fee_growth_y, v0)) >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset()))
    }
    ...
    public(friend) fun position_info_rewards_remains_zero(arg0: &PositionInfo) : bool {
        ...
        while (v0 < arg0.bin_count) {
            ...
            while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(&v2)) {
                if (0x2::vec_map::get<0x1::type_name::TypeName, PositionReward>(v1, 0x1::vector::borrow<0x1::type_name::TypeName>(&v2, v3)).amount_owned >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset() > 0) {
                    return false
                };
                v3 = v3 + 1;
            };
    ...
    fun position_info_update_bin_fees_internal(arg0: &mut PositionInfo, arg1: u32, arg2: u256, arg3: u256) {
        let v0 = get_bin_index(arg0, arg1);
        let v1 = *0x1::vector::borrow<u256>(&arg0.bin_liquidity, v0);
        arg0.fee_owned_x = arg0.fee_owned_x + 0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64((v1 >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset()) * (arg2 - *0x1::vector::borrow<u256>(&arg0.bin_fee_growth_x, v0)) >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset());
    ...
    fun position_info_update_bin_rewarders_internal(arg0: &mut PositionInfo, arg1: u32, arg2: 0x1::type_name::TypeName, arg3: u256) {
        ...
        if (0x2::vec_map::contains<0x1::type_name::TypeName, PositionReward>(v1, &arg2)) {
            ...
            v2.amount_owned = v2.amount_owned + (arg3 - v2.growth_inside) * (*0x1::vector::borrow<u256>(&arg0.bin_liquidity, v0) >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset());
            v2.growth_inside = arg3;
        } else {
            let v3 = PositionReward{
                growth_inside : arg3,
                amount_owned  : arg3 * (*0x1::vector::borrow<u256>(&arg0.bin_liquidity, v0) >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset()),
            };
    ...
    public fun position_reward_amount_owned(arg0: &PositionReward) : u64 {
        0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(arg0.amount_owned >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset())
    }
    ...
    public(friend) fun reset_rewarder(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: u32, arg3: 0x1::type_name::TypeName, arg4: u256) : u64 {
        if (!0x2::vec_map::contains<0x1::type_name::TypeName, PositionReward>(bin_rewarder_growth(position_info(arg0, arg1), arg2), &arg3)) {
            ...
            if (v5 >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset() == 0) {
                0
            } else {
                let v6 = 0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64(v5 >> 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset());
                v4.amount_owned = v4.amount_owned - ((v6 as u256) << 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::scale_offset());
                v6
            }
        }
    }
    ...
    public(friend) fun update_bin_liquidity(arg0: &mut PositionInfo, arg1: u32, arg2: u256) {
        assert!(has_bin_id(arg0, arg1), 13906834724099194879);
        *0x1::vector::borrow_mut<u256>(&mut arg0.bin_liquidity, get_bin_index(arg0, arg1)) = arg2;
    }
