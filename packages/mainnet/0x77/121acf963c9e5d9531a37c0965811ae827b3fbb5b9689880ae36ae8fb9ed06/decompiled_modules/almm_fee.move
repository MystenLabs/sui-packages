module 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_fee {
    fun cap_fee_rate(arg0: u64) : u64 {
        if (arg0 >= 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::max_fee()) {
            return 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::max_fee()
        };
        arg0
    }
    ...
    public fun get_protocol_fee_amount(arg0: u64, arg1: u16) : u64 {
        ...
        0xfd4fb46fa9cab466edbc46e95c9f647644018022780041b53c0f39602dfb8d8a::uint_safe::safe64((arg0 as u256) * (arg1 as u256) / (0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::basis_point_max() as u256))
    }

    public fun verify_fee(arg0: u64) {
        assert!(arg0 <= 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::max_fee(), 13906834234472923137);
    }

    public fun verify_protocol_share(arg0: u16) {
        assert!(arg0 <= 0x77121acf963c9e5d9531a37c0965811ae827b3fbb5b9689880ae36ae8fb9ed06::almm_constants::max_protocol_share(), 13906834251652923395);
    }
