module 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service_affiliate {
    ...
    public(friend) fun add(arg0: &mut 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::Service, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Config{
    ...
    public(friend) fun add_affiliator_list(arg0: &mut 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::Service, arg1: 0x2::vec_map::VecMap<address, 0x1::string::String>) {
        let v0 = 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::utils::get_key_by_struct<Feature>();
        assert!(0x2::vec_set::contains<0x1::string::String>(0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::features(arg0), &v0), 702);
    ...
    public(friend) fun add_profit_by_affiliate<T0>(arg0: &mut 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::Service, arg1: 0x1::string::String, arg2: u64) {
        ...
        let v1 = 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::utils::get_key_by_struct<Feature>();
        if (0x2::vec_set::contains<0x1::string::String>(0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::features(arg0), &v1)) {
            let v2 = 0x2::dynamic_field::borrow_mut<0x1::string::String, Affiliator>(&mut 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::get_feature_mut<Feature, Config>(arg0).id, arg1);
    ...
    public(friend) fun check_valid_affiliate_code(arg0: &0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::Service, arg1: 0x1::string::String) {
        let v0 = 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::utils::get_key_by_struct<Feature>();
        if (0x2::vec_set::contains<0x1::string::String>(0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::features(arg0), &v0)) {
            let v1 = 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::get_feature<Feature, Config>(arg0);
    ...
    public(friend) fun remove_affiliator_list(arg0: &mut 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::Service, arg1: 0x2::vec_map::VecMap<address, 0x1::string::String>) {
        let v0 = 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::utils::get_key_by_struct<Feature>();
        assert!(0x2::vec_set::contains<0x1::string::String>(0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::features(arg0), &v0), 702);
        let v1 = 0x6e80d8698dad095892a8563b9384f6c7dad24ec855323af36882f1db5ddc4d41::service::get_feature_mut<Feature, Config>(arg0);
        while (!0x2::vec_map::is_empty<address, 0x1::string::String>(&arg1)) {
