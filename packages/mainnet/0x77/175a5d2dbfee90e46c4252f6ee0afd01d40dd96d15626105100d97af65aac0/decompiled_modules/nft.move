module 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::nft {
    ...
    public fun create_spec(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: &mut Factory, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Spec{
    ...
    public fun mint_to_sender(arg0: &mut Factory, arg1: 0x2::object::ID, arg2: &mut 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::Vault<0x2::sui::SUI>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : Nft {
        ...
        0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::deposit<0x2::sui::SUI>(arg2, arg3);
        let v1 = Nft{
        ...
        0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::events::emit_nft_minted_event(0x2::object::id<Nft>(&v1), 0x2::tx_context::sender(arg4), v1.name);
        v1
    }
