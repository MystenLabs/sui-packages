module 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::plinko {
    ...
    public fun bet<T0>(arg0: &mut PlinkoGame<T0>, arg1: &mut 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::Vault<T0>, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) {
        place_bet<T0>(arg0, arg1, arg2, arg3, arg4, arg5);
    }

    public fun create_plinko_config_and_add_to_game<T0>(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: &mut PlinkoGame<T0>, arg2: u8, arg3: vector<0x1::uq32_32::UQ32_32>, arg4: u64, arg5: u64, arg6: bool, arg7: u8) {
        private_create_plinko_config_and_add_to_game<T0>(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }

    public fun create_plinko_game<T0>(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: u64, arg2: u64, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun edit_plinko_config<T0>(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: &mut PlinkoGame<T0>, arg2: u8, arg3: u8, arg4: vector<0x1::uq32_32::UQ32_32>, arg5: u64, arg6: u64, arg7: bool) {
    ...
    public fun edit_plinko_game<T0>(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: &mut PlinkoGame<T0>, arg2: u64, arg3: u64, arg4: u8) {
        arg1.min_bet = arg2;
        arg1.max_bet = arg3;
    ...
    fun generate_ball_roll(arg0: vector<0x1::uq32_32::UQ32_32>, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : u8 {
        ...
        let v2 = u64_to_binary(0x2::random::generate_u64_in_range(&mut v1, 0, 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::math::pow(2, (v0 as u8)) - 1), v0);
        let v3 = 0;
        let v4 = 0;
    ...
    public fun initialize_plinko_configs<T0>(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: &mut PlinkoGame<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        private_initialize_plinko_configs<T0>(arg1);
    }

    fun place_bet<T0>(arg0: &mut PlinkoGame<T0>, arg1: &mut 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::Vault<T0>, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::deposit<T0>(arg1, arg3);
        let v4 = Bet<T0>{
            id                   : 0x2::object::new(arg5),
            gambler              : v2,
            number_of_balls      : arg4,
            total_stake_value    : v1,
            fund                 : 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::take_fund_balance<T0>(arg1, 0x1::uq32_32::int_mul(v1, get_max_value(v0.multipliers))),
            plinko_config_number : arg2,
        };
        0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::distribute_referral_rewards<T0>(arg1, v1, v2);
        0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::events::emit_plinko_bet_event(0x2::object::uid_to_inner(&v4.id), v1, arg4, v1, arg2, v0.num_rows, v2, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v5 = 0x2::object::uid_to_inner(&v4.id);
        0x2::vec_map::insert<0x2::object::ID, Bet<T0>>(&mut arg0.bets, v5, v4);
        v5
    }

    entry fun place_bet_and_reveal_onchain_randomness<T0>(arg0: &mut PlinkoGame<T0>, arg1: &mut 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::Vault<T0>, arg2: u8, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun reveal_bet<T0>(arg0: &mut PlinkoGame<T0>, arg1: &mut 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::Vault<T0>, arg2: 0x2::object::ID, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<0x1::uq32_32::UQ32_32>(&v13) > 0) {
            0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::events::emit_plinko_revealed_event(arg2, v11, 0x1::vector::pop_back<0x1::uq32_32::UQ32_32>(&mut v13), 0x1::vector::pop_back<u8>(&mut v14), 0x1::vector::pop_back<u64>(&mut v15), v8, v9.num_rows, v3, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
        };
        0x2::object::delete(v2);
    }

    entry fun reveal_bet_onchain_randomness<T0>(arg0: &mut PlinkoGame<T0>, arg1: &mut 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::Vault<T0>, arg2: 0x2::object::ID, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        reveal_bet<T0>(arg0, arg1, arg2, arg3, arg4);
    }

    public fun set_plinko_config_min_max_bet<T0>(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: &mut PlinkoGame<T0>, arg2: u8, arg3: u64, arg4: u64) {
        let v0 = 0x2::vec_map::get_mut<u8, PlinkoConfig<T0>>(&mut arg1.configs, &arg2);
        v0.min_bet = arg3;
        v0.max_bet = arg4;
    }

    public fun set_plinko_config_playable<T0>(arg0: &0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault::AdminCap, arg1: &mut PlinkoGame<T0>, arg2: u8, arg3: bool) {
