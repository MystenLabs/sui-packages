module 0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::vault {
    ...
    public fun claim_referee_rewards<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::events::emit_referee_rewards_claimed_event(0x2::balance::value<T0>(&v2));
    ...
    public fun claim_referrer_rewards<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x77175a5d2dbfee90e46c4252f6ee0afd01d40dd96d15626105100d97af65aac0::events::emit_referrer_rewards_claimed_event(0x2::balance::value<T0>(&v2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v2, arg1), v0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<AdminCap>(v1, @0x33958821a39c999e0a6f15c91f8d5b069d58b7a6dfff1404d8284b8c457efd4c);
