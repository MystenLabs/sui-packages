module 0x77d865d4d3cb65fb589047ecf16fb2c9ccdc9590bdc0e1cb23a28c92f110d973::cnsnft6724 {
    struct CNSNFT6724 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6724, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8032"));
        let v4 = 0x2::package::claim<CNSNFT6724>(arg0, arg1);
