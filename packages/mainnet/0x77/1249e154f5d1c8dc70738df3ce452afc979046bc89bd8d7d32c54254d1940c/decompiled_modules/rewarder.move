module 0x771249e154f5d1c8dc70738df3ce452afc979046bc89bd8d7d32c54254d1940c::rewarder {
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: u128, arg2: u64) {
        ...
        while (v2 < 0x1::vector::length<Rewarder>(&arg0.rewarders)) {
            0x1::vector::borrow_mut<Rewarder>(&mut arg0.rewarders, v2).growth_global = 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).growth_global + 0xec2104ea911f9583a68ed634183831609ffb7274e7e46ba1d491e10dd5423495::full_math_u128::mul_div_floor((v1 as u128), 0x1::vector::borrow<Rewarder>(&arg0.rewarders, v2).emissions_per_second, arg1);
            v2 = v2 + 1;
        };
        arg0.points_released = arg0.points_released + (v1 as u128) * 18446744073709551616000000;
        arg0.points_growth_global = arg0.points_growth_global + 0xec2104ea911f9583a68ed634183831609ffb7274e7e46ba1d491e10dd5423495::full_math_u128::mul_div_floor((v1 as u128), 18446744073709551616000000, arg1);
    }
