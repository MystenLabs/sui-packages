module 0x778f080d20a853686f69613fea2c6b458d0848957484f14e0f163c082367ea63::suiball_nft {
    struct SuiballNFT has key {
        id: 0x2::object::UID,
        owner: address,
    }

    struct SuiballNFTV2 has store, key {
        id: 0x2::object::UID,
        owner: address,
    }
    ...
    struct NFTMigrated has copy, drop {
        owner: address,
    }
    ...
    public fun get_owner_v2(arg0: &SuiballNFTV2) : address {
        arg0.owner
    }
    ...
    public fun migrate_to_v2(arg0: SuiballNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<SuiballNFTV2>(v3, v0);
        let v4 = NFTMigrated{owner: v0};
        0x2::event::emit<NFTMigrated>(v4);
    }
    ...
    public fun mint_to_sender_v2(arg0: &mut ItemStore, arg1: &MintConfig, arg2: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < arg3) {
            ...
            0x2::transfer::public_transfer<SuiballNFTV2>(v3, v1);
            v2 = v2 + 1;
        };
        let v4 = NFTMinted{
            minter           : v1,
    ...
    public fun setup_suiball_nft_v2_display(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<0x1::string::String>();
        let v1 = &mut v0;
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"name"));
        0x1::vector::push_back<0x1::string::String>(v1, 0x1::string::utf8(b"image_url"));
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suiball.com"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://bafybeic3qqffqp3bh7xtk47totgglx3nu3x5iezy42gp3vwp7vekpiiaza.ipfs.dweb.link/"));
        let v4 = 0x2::display::new_with_fields<SuiballNFTV2>(arg0, v0, v2, arg1);
        0x2::display::update_version<SuiballNFTV2>(&mut v4);
        0x2::transfer::public_transfer<0x2::display::Display<SuiballNFTV2>>(v4, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun verify_owner_v2(arg0: &SuiballNFTV2, arg1: address) : bool {
        arg0.owner == arg1
    }
