module 0x772ae4b7b71809550df3c3cc0bf82b04fe6c2b9b0cf6c16f6a963fc17f01b054::reward8659 {
    struct REWARD8659 has drop {
        dummy_field: bool,
    }

    struct TICKET_8659 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8659(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8659>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8659>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8659, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8659>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8659>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8659>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8659>>(v5, 0x2::tx_context::sender(arg1));
    }
