module 0x774e43f535c189181b2608cc9b81d84a6a075378bafbb4d7f3fb66e2014cd623::cnsnft2556 {
    struct CNSNFT2556 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2556, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2556>(arg0, arg1);
