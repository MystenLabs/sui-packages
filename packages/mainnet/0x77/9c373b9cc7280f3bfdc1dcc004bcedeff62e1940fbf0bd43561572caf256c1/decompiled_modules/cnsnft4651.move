module 0x779c373b9cc7280f3bfdc1dcc004bcedeff62e1940fbf0bd43561572caf256c1::cnsnft4651 {
    struct CNSNFT4651 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4651, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4651>(arg0, arg1);
