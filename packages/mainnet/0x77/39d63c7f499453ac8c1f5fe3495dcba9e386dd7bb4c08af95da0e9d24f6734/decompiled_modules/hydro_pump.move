module 0x7739d63c7f499453ac8c1f5fe3495dcba9e386dd7bb4c08af95da0e9d24f6734::hydro_pump {
    ...
    fun swap<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v6 = 0x1::ascii::string(b"in swap: pool.virtual_sui_reserves after");
        0x1::debug::print<0x1::ascii::String>(&v6);
        0x1::debug::print<u64>(&arg0.virtual_sui_reserves);
        let v7 = arg0.virtual_token_reserves + 0x2::coin::value<T0>(&arg1);
        let v8 = arg0.virtual_sui_reserves + 0x2::coin::value<0x2::sui::SUI>(&arg2);
        assert_lp_value_is_increased_or_not_changed(arg0.virtual_token_reserves, arg0.virtual_sui_reserves, v7, v8);
        arg0.virtual_token_reserves = v7;
        arg0.virtual_sui_reserves = v8;
        let v9 = 0x1::ascii::string(b"in swap: pool.virtual_sui_reserves final");
        0x1::debug::print<0x1::ascii::String>(&v9);
        0x1::debug::print<u64>(&arg0.virtual_sui_reserves);
        let v10 = 0x1::ascii::string(b"=============================");
        0x1::debug::print<0x1::ascii::String>(&v10);
    ...
    fun buy_<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: address, arg5: address, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        0x1::debug::print<0x1::ascii::String>(&v3);
        0x1::debug::print<u64>(&v2);
        let v4 = 0x7739d63c7f499453ac8c1f5fe3495dcba9e386dd7bb4c08af95da0e9d24f6734::curves::calculate_add_liquidity_cost(arg1.virtual_sui_reserves, arg1.virtual_token_reserves, v2);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg0, v8, arg8), arg4);
        let v10 = 0x2::coin::zero<T0>(arg8);
        let (v11, v12) = swap<T0>(arg1, v10, arg0, v2, v7 - v5 - v8, arg8);
        let v13 = v12;
        let v14 = v11;
        ...
        if (v1 == v2 || 0x2::coin::value<0x2::sui::SUI>(&arg1.real_sui_reserves) >= arg6) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Config{
            ...
            version                        : 1,
            fee_to                         : @0x5844140d23282dfe5953b93f4ad76ebf591561ebd380391292fd7b4f28730a9,
            migrator                       : @0x5844140d23282dfe5953b93f4ad76ebf591561ebd380391292fd7b4f28730a9,
            admin                          : @0x5844140d23282dfe5953b93f4ad76ebf591561ebd380391292fd7b4f28730a9,
            platform_fee                   : 100,
            migration_pool_fee             : 0,
            pool_deployment_fee            : 2000000000,
            initial_virtual_sui_reserves   : 25000000000,
            initial_virtual_token_reserves : 1000000000000000,
            remain_token_reserves          : 200000000000000,
            target_sui_reserves            : 7000000000000,
            token_decimals                 : 6,
        };
    ...
    entry fun migrate_version(arg0: &mut Config, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.admin == v0 || v0 == @0x5844140d23282dfe5953b93f4ad76ebf591561ebd380391292fd7b4f28730a9, 0);
        arg0.version = arg1;
    }
    ...
    public entry fun quick_buy<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x7739d63c7f499453ac8c1f5fe3495dcba9e386dd7bb4c08af95da0e9d24f6734::curves::calculate_token_amount_received(v4.virtual_sui_reserves, v4.virtual_token_reserves, v5 - v5 * v1 / 10000);
    ...
    public fun sell_returns<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        assert!(v3 > 0, 1);
        let v4 = 0x7739d63c7f499453ac8c1f5fe3495dcba9e386dd7bb4c08af95da0e9d24f6734::curves::calculate_remove_liquidity_return(v2.virtual_token_reserves, v2.virtual_sui_reserves, v3);
        assert!(0x1::option::is_some<u64>(&v4), 3);
    ...
    public fun skim<T0>(arg0: &mut Config, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == @0x5844140d23282dfe5953b93f4ad76ebf591561ebd380391292fd7b4f28730a9, 0);
    ...
    public entry fun update_config(arg0: &mut Config, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u8, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg0.admin || v0 == @0x5844140d23282dfe5953b93f4ad76ebf591561ebd380391292fd7b4f28730a9, 0);
        arg0.fee_to = arg1;
        arg0.migrator = arg2;
