module 0x77e00f96878ada95de53d5a3eb0737b1c736a96ad5c11d325a53bcf109c65499::gift1879 {
    struct GIFT1879 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift1879(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT1879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1879>(arg0, arg1);
