module 0x77f14bab59e1f927eb0f0f15f0d6d993e0c29960cbabbfdee81ab259ba33ec04::dex_turbos {
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0x77f14bab59e1f927eb0f0f15f0d6d993e0c29960cbabbfdee81ab259ba33ec04::constants::get_turbos_sui_usdc_pool(),
        };
