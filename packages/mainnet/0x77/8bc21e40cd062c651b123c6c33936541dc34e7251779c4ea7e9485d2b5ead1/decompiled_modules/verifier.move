module 0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::verifier {
    ...
    public fun validate_deposit_public_inputs(arg0: &vector<vector<u8>>, arg1: &vector<u8>, arg2: u64, arg3: address) {
        assert!(0x1::vector::length<vector<u8>>(arg0) == 3, 1);
        assert!(0x1::vector::borrow<vector<u8>>(arg0, 0) == arg1, 2);
        let v0 = 0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::helpers::u64_to_field_bytes(arg2);
        assert!(0x1::vector::borrow<vector<u8>>(arg0, 1) == &v0, 2);
        let v1 = 0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::helpers::address_to_field_bytes(arg3);
        assert!(0x1::vector::borrow<vector<u8>>(arg0, 2) == &v1, 2);
    }
    ...
    public fun verify_deposit_proof(arg0: &0x2::groth16::PreparedVerifyingKey, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<vector<u8>>) : bool {
        assert!(0x1::vector::length<u8>(&arg1) == 32, 3);
        assert!(0x1::vector::length<u8>(&arg2) == 64, 3);
        assert!(0x1::vector::length<u8>(&arg3) == 32, 3);
        assert!(0x1::vector::length<vector<u8>>(&arg4) == 3, 1);
        let v0 = 0x1::vector::empty<u8>();
        let v1 = 0;
        while (v1 < 3) {
            0x1::vector::append<u8>(&mut v0, *0x1::vector::borrow<vector<u8>>(&arg4, v1));
