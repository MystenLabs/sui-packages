module 0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::pool {
    ...
    struct VerifiedCommitmentInserted has copy, drop {
        commitment: vector<u8>,
        leaf_index: u64,
        pool_id: address,
        amount: u64,
    ...
    public fun deposit_v2<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<vector<u8>>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 11);
        assert!(0x1::vector::length<u8>(&arg2) == 32, 8);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 > 0, 3);
        ...
        0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::verifier::validate_deposit_public_inputs(&arg7, &arg2, arg3, v1);
        let v2 = 0x2::groth16::bn254();
        let v3 = 0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::deposit_verifying_key::bytes();
        let v4 = 0x2::groth16::prepare_verifying_key(&v2, &v3);
        assert!(0x9e935de41f29d842ced69c9e7c751cc565f7080274ffaa1223d98886bb9b9a07::verifier::verify_deposit_proof(&v4, arg4, arg5, arg6, arg7), 1);
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(arg1));
        let v5 = VerifiedCommitmentInserted{
            commitment : arg2,
            leaf_index : arg0.next_leaf_index,
            pool_id    : v1,
            amount     : arg3,
        };
        0x2::event::emit<VerifiedCommitmentInserted>(v5);
        arg0.next_leaf_index = arg0.next_leaf_index + 1;
        arg0.total_deposited = arg0.total_deposited + v0;
    }
