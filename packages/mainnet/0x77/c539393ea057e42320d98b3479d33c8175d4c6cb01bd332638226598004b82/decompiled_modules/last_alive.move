module 0x77c539393ea057e42320d98b3479d33c8175d4c6cb01bd332638226598004b82::last_alive {
    ...
    fun init(arg0: LAST_ALIVE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"{\"game\": \"{game_round}\", \"round\": \"{current_day}\", \"status\": \"{trait}\"}"));
