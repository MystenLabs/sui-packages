module 0x77ab60eff9045f27c985de8821de948ef3f30504288d915f1de3a42a56c6b34d::reward8271 {
    struct REWARD8271 has drop {
        dummy_field: bool,
    }

    struct TICKET_8271 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8271(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8271>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8271>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8271, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8271>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8271>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8271>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8271>>(v5, 0x2::tx_context::sender(arg1));
    }
