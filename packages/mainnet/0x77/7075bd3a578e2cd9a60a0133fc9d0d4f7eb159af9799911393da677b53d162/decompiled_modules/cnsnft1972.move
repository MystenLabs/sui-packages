module 0x777075bd3a578e2cd9a60a0133fc9d0d4f7eb159af9799911393da677b53d162::cnsnft1972 {
    struct CNSNFT1972 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1972, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1972>(arg0, arg1);
