module 0x778e73acf71766c06310df472b28acca8fa5e68a09423388026e0c567746a094::cnsnft3976 {
    struct CNSNFT3976 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3976, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3976>(arg0, arg1);
