module 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::strike_payout_tree {
    ...
    public(friend) fun settled_payout_liability(arg0: &StrikePayoutTree, arg1: u64, arg2: u64) : u64 {
        settlement_prefix_payout(&arg0.nodes, arg0.root, 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::range_codec::prefix_limit_tick(arg1, arg2), arg0.base)
    }
    ...
    public(friend) fun walk_linear(arg0: &StrikePayoutTree, arg1: &0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pricing::Pricer, arg2: u64) : u64 {
    ...
    public(friend) fun walk_linear_frozen(arg0: &StrikePayoutTree, arg1: &0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pricing::Pricer, arg2: u64, arg3: u64) : u64 {
    ...
    fun walk_linear_subtree(arg0: &0x2::table::Table<u64, PayoutNode>, arg1: 0x1::option::Option<u64>, arg2: &0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pricing::Pricer, arg3: u64, arg4: u64, arg5: &mut 0x1::option::Option<u64>) : (u64, u64) {
        if (0x1::option::is_none<u64>(&arg1)) {
            return (0, 0)
        };
        let v0 = *0x1::option::borrow<u64>(&arg1);
        ...
        let v7 = 0;
        if (v4 != 0 || v5 != 0) {
            let v8 = 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pricing::up_price(arg2, 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::range_codec::strike_from_tick(v0, arg3));
            if (0x1::option::is_some<u64>(arg5)) {
                assert!(v8 <= *0x1::option::borrow<u64>(arg5), 2);
            };
            *arg5 = 0x1::option::some<u64>(v8);
            if (v4 != v5) {
                v6 = 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::mul_down(v8, v4);
                v7 = 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::mul_down(v8, v5);
            };
        };
