module 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::market_manager {
    ...
    fun assert_cadence_config(arg0: &CadenceConfig) {
        ...
        assert!(v6, 7);
        0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::config_constants::assert_market_tick_size_bounds(v0);
        0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::config_constants::assert_market_tick_size_bounds(v1);
        assert!(v1 >= v0, 7);
        assert!(v1 % v0 == 0, 7);
        0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::config_constants::assert_cadence_window_size(v4);
    ...
    public(friend) fun next_deployable_market(arg0: &MarketManager, arg1: &0x2a63e378ab0138cdcb12651a093f3799f8b8e4f6c927ce6de0e8bc7ded0ec49d::registry::OracleRegistry, arg2: u32, arg3: u8, arg4: &0x2::clock::Clock) : DeployableMarket {
        ...
        while (v5 <= v3 + v2.window_size * v4) {
            ...
            let v7 = 0x2a63e378ab0138cdcb12651a093f3799f8b8e4f6c927ce6de0e8bc7ded0ec49d::registry::propbook_pyth_id_for_underlying(arg1, arg2);
            assert!(0x1::option::is_some<0x2::object::ID>(&v7), 8);
            let v8 = 0x2a63e378ab0138cdcb12651a093f3799f8b8e4f6c927ce6de0e8bc7ded0ec49d::registry::propbook_block_scholes_store_pair_for_underlying(arg1, arg2);
            assert!(0x1::option::is_some<0x2a63e378ab0138cdcb12651a093f3799f8b8e4f6c927ce6de0e8bc7ded0ec49d::registry::BlockScholesStorePair>(&v8), 9);
