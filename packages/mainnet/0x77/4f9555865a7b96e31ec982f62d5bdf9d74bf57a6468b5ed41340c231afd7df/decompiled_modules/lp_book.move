module 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::lp_book {
    ...
    fun drain_supply_queue<T0>(arg0: &mut LpBook<T0>, arg1: &mut 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pool_accounting::Ledger, arg2: &FlushMark, arg3: &FeeRates, arg4: 0x2::object::ID, arg5: u64, arg6: &0x1::option::Option<u64>, arg7: u64, arg8: u64) : (u64, u64) {
        let v0 = 0;
        let v1 = 0;
        ...
        while (under_budget(arg6, v1) && !is_empty<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&arg0.supply_queue)) {
            ...
            if (v18 < 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::mul_div_up(v3.min_output, v15, v3.amount)) {
                break
            };
            v1 = v1 + 1;
            let v23 = if (v16) {
            ...
            0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pool_accounting::receive_idle(arg1, v23);
            v2 = v2 + v15;
            0x2::balance::send_funds<T0>(0x2::coin::mint_balance<T0>(&mut arg0.treasury_cap, v18), v3.recipient);
            0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::vault_events::emit_supply_filled(arg4, v3.account_id, v3.recipient, v3.index, v15, v18, v19, v3.amount - v15, arg0.supply_queue.pending);
            v0 = v0 + 1;
            if (v16) {
                break
            };
    ...
    fun drain_withdraw_queue<T0>(arg0: &mut LpBook<T0>, arg1: &mut 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pool_accounting::Ledger, arg2: &FlushMark, arg3: &FeeRates, arg4: 0x2::object::ID, arg5: u64, arg6: &0x1::option::Option<u64>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = 0;
        let v1 = 0;
        while (under_budget(arg6, v1) && !is_empty<T0>(&arg0.withdraw_queue)) {
            ...
            let v14 = 0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pool_accounting::idle_balance(arg1);
            let (v15, v16, v17) = if (v14 >= v7) {
                (v2.amount, v7, v8)
            } else {
                let v18 = 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::try_mul_div_down(v14, arg2.total_supply, arg2.pool_value);
                if (0x1::option::is_none<u64>(&v18)) {
                    break
                };
                let v19 = 0x1::option::destroy_some<u64>(v18);
                let v20 = quote_withdraw_usdc(arg2, arg3, v19);
                if (0x1::option::is_none<FillQuote>(&v20) || 0x1::option::borrow<FillQuote>(&v20).output < 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::mul_div_up(v2.min_output, v19, v2.amount)) {
                    break
                };
                let FillQuote {
                    output : v21,
            ...
            0x2::balance::send_funds<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::pool_accounting::withdraw_idle(arg1, v16), v2.recipient);
            0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::vault_events::emit_withdraw_filled(arg4, v2.account_id, v2.recipient, v2.index, v15, v16, v17, v2.amount - v15, arg0.withdraw_queue.pending);
            v1 = v1 + 1;
            v0 = v0 + 1;
            if (v23) {
                break
    ...
    fun emit_request_limit_missed(arg0: 0x2::object::ID, arg1: &RequestEntry, arg2: bool, arg3: u64, arg4: u64, arg5: u64) {
        0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::vault_events::emit_request_limit_missed(arg0, arg1.account_id, arg1.recipient, arg1.index, arg1.amount, arg2, arg3, arg1.min_output, arg4, arg5);
    }
    ...
    fun fee_on(arg0: u64, arg1: u64) : u64 {
        ...
        0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::mul_div_up(arg0, arg1, 1000000000)
    }
    ...
    fun fill_front_partially<T0>(arg0: &mut RequestQueue<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        v0.min_output = 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::mul_div_up(v0.min_output, v1, v0.amount);
        v0.amount = v1;
    ...
    fun quote_supply_shares(arg0: &FlushMark, arg1: &FeeRates, arg2: u64) : 0x1::option::Option<FillQuote> {
        ...
        let v1 = 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::try_mul_div_down(arg2 - v0, arg0.total_supply, arg0.pool_value);
    ...
    fun quote_withdraw_usdc(arg0: &FlushMark, arg1: &FeeRates, arg2: u64) : 0x1::option::Option<FillQuote> {
        ...
        let v0 = 0xeb8212402af172cac87ef533a61a899334a75a745489432aaa31872fdc5ecb42::math::try_mul_div_down(arg2, arg0.pool_value, arg0.total_supply);
    ...
    fun refund_supply_request(arg0: 0x2::object::ID, arg1: RequestEntry, arg2: 0x2::balance::Balance<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: u8, arg4: u64) {
        ...
        0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::vault_events::emit_request_cancelled(arg0, arg1.account_id, arg1.recipient, arg1.index, arg1.amount, true, arg3, arg4);
    }
    ...
    fun refund_withdraw_request<T0>(arg0: 0x2::object::ID, arg1: RequestEntry, arg2: 0x2::balance::Balance<T0>, arg3: u8, arg4: u64) {
        ...
        0x774f9555865a7b96e31ec982f62d5bdf9d74bf57a6468b5ed41340c231afd7df::vault_events::emit_request_cancelled(arg0, arg1.account_id, arg1.recipient, arg1.index, arg1.amount, false, arg3, arg4);
    }
