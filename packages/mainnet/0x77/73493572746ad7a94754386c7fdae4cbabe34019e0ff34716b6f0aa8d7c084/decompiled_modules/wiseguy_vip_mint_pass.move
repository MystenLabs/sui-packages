module 0x7773493572746ad7a94754386c7fdae4cbabe34019e0ff34716b6f0aa8d7c084::wiseguy_vip_mint_pass {
    ...
    fun init(arg0: WISEGUY_VIP_MINT_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Check Discord for updates on who is participating with our pass!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidvyj26coucsbvyxsqh2t774hhod4sdid273ocei32b7zlan4s7jq"));
