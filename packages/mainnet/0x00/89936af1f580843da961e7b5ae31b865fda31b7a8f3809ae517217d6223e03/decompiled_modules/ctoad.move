module 0x89936af1f580843da961e7b5ae31b865fda31b7a8f3809ae517217d6223e03::ctoad {
    ...
    fun init(arg0: CTOAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<CTOAD>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<CTOAD>>(v4);
    }
