module 0x2e2f312ef9147e41f4faf500b7dd6aa0d6a235e38a1d9cb3d6b58172d1f30d::inheritance {
    ...
    public fun create_inheritance(arg0: &0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::Wallet, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::id(arg0);
        let v1 = 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::owner(arg0);
    ...
    public fun member_withdraw<T0>(arg0: &MemberCap, arg1: &mut Inheritance, arg2: &mut 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::Wallet, arg3: &0x2::accumulator::AccumulatorRoot, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_valid_member_cap(arg0, arg1, 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::id(arg2));
        ...
        let v1 = withdraw_amount_for_cap(arg1, v0, arg0.capID, 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::wallet::balance<T0>(arg2, arg3));
        let v2 = 0x2::tx_context::sender(arg5);
        let v3 = InheritanceService{dummy_field: false};
        let (v4, v5) = 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::intent::validate_and_pay_unmetered<InheritanceService, T0>(arg2, 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::intent::request_payment_unmetered<InheritanceService, T0>(v3, v1, v2), arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v4, v2);
        let v6 = InheritanceService{dummy_field: false};
        0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::intent::verify_and_clear<InheritanceService, T0>(v5, 0x24434ef7d9e99049d969974717bbd7b920d3453c5628ee344822709ca66d1de0::intent::create_receipt_sig<InheritanceService, T0>(v6, v1, v2));
