module 0x84fcb5788d02a30c99957a0b7826abd139fe5cfd5a555f12e998b88d8c1310::payment_policy {
    ...
    public fun createPolicy<T0: store + key, T1>(arg0: &0x2::package::Publisher, arg1: u64, arg2: u64, arg3: &0x84fcb5788d02a30c99957a0b7826abd139fe5cfd5a555f12e998b88d8c1310::version::Version, arg4: &mut 0x2::tx_context::TxContext) : PolicyVaultCap {
    ...
    public(friend) fun payByCoin<T0: store + key, T1>(arg0: &mut PolicyVault<T0>, arg1: 0x2::transfer_policy::TransferRequest<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, u64, u64) {
        ...
        let v4 = 0x84fcb5788d02a30c99957a0b7826abd139fe5cfd5a555f12e998b88d8c1310::constants::max_fee();
        let v5 = 0x84fcb5788d02a30c99957a0b7826abd139fe5cfd5a555f12e998b88d8c1310::math::div(0x84fcb5788d02a30c99957a0b7826abd139fe5cfd5a555f12e998b88d8c1310::math::mul(v3, arg5), v4);
        let v6 = 0x84fcb5788d02a30c99957a0b7826abd139fe5cfd5a555f12e998b88d8c1310::math::div(0x84fcb5788d02a30c99957a0b7826abd139fe5cfd5a555f12e998b88d8c1310::math::mul(v3, *v2), v4);
