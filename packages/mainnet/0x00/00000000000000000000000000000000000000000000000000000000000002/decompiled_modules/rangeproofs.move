module 0x2::rangeproofs {
    public fun verify_bulletproofs_ristretto255(arg0: &vector<u8>, arg1: u8, arg2: &vector<0x2::group_ops::Element<0x2::ristretto255::G>>, arg3: u8) : bool {
        ...
        verify_bulletproofs_ristretto255_internal(arg0, arg1, &v0)
    }

    native fun verify_bulletproofs_ristretto255_internal(arg0: &vector<u8>, arg1: u8, arg2: &vector<vector<u8>>) : bool;
