module 0x2::transfer_policy {
    ...
    struct TransferPolicyDestroyed<phantom T0> has copy, drop {
        id: 0x2::object::ID,
    }
    ...
    entry fun default<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = new<T0>(arg0, arg1);
        0x2::transfer::share_object<TransferPolicy<T0>>(v0);
        0x2::transfer::transfer<TransferPolicyCap<T0>>(v1, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun destroy_and_withdraw<T0>(arg0: TransferPolicy<T0>, arg1: TransferPolicyCap<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v5 = TransferPolicyDestroyed<T0>{id: v1};
        0x2::event::emit<TransferPolicyDestroyed<T0>>(v5);
