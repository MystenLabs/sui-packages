module 0xc08350c5933da679e263a76a4b9723eb142a8cd706371f159ce0b3ade5414c::cnsnft2448 {
    struct CNSNFT2448 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2448, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2448>(arg0, arg1);
