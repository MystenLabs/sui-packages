module 0x5b1c5e6ffe4850aa2834c9d52710e63706fd2a8c9cfda0a56c6ae111e7ef2c::a {
    ...
    public fun yd<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let (v1, v2, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg1, 0, &v0, 0x2::coin::value<T1>(&arg0), arg2, arg0, arg3);
        0xdee9::custodian_v2::delete_account_cap(v0);
        return_remaining_coin<T1>(v2, arg3);
        v1
    }
