        ...
        if (v0 > 0) {
            ...
            if (0x2::balance::value<0x2::sui::SUI>(&v2) >= v0) {
                ...
                if (v3 >= v4) {
                    ...
                    let (v11, _) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::flash_borrow<0x2::sui::SUI>(arg13, v10);
                    let v13 = v11;
                    let v14 = 0x2::balance::value<0x2::sui::SUI>(&v13);
                    0x2::balance::join<0x2::sui::SUI>(&mut v2, v13);
                    let v15 = v0 + v14 + (0x42fadd773836e6c04efb974f49ac94c74969b1c838137a91ead08ed9ced4db1a::utils::u256_mul_div((v14 as u256), (5 as u256), (10000 as u256)) as u64);
                    let v16 = v15;
                    if (v15 < 1000000000) {
                        v16 = 1000000000;
                    };
                    0x2::balance::join<0x2::sui::SUI>(&mut v2, revolving_repay_and_withdraw(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v2), v16, arg14));
                    abort 111111111
                };
            };
        };
