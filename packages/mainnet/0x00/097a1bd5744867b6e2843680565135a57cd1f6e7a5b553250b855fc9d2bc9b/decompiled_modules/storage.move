module 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::storage {
    ...
    public fun add_blob_share(arg0: &mut BlobStore, arg1: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::GlobalConfig, arg2: vector<u8>, arg3: address, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::length<address>(v0) < 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::max_viewers_per_store(arg1), 417);
    ...
    public fun add_viewer(arg0: &mut BlobStore, arg1: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::GlobalConfig, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::assert_not_paused(arg1);
        ...
        assert!(0x2::vec_set::length<address>(&arg0.viewers) < 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::max_viewers_per_store(arg1), 417);
    ...
    public fun extend_blob(arg0: &mut BlobStore, arg1: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::GlobalConfig, arg2: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::PlanRegistry, arg3: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::Subscription, arg4: 0x1::string::String, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::assert_not_paused(arg1);
        ...
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::is_active(arg3, 0x2::tx_context::epoch(arg6)), 412);
        let v0 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_max_walrus_epochs(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::get_plan(arg2, 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::sub_tier(arg3)));
        let v1 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::max_storage_epochs(arg1);
    ...
    public fun register_blob(arg0: &mut BlobStore, arg1: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::GlobalConfig, arg2: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::PlanRegistry, arg3: &mut 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::UserAccount, arg4: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::Subscription, arg5: BlobRef, arg6: &0x2::tx_context::TxContext) {
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::assert_not_paused(arg1);
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::assert_version(arg1);
        assert!(0x2::tx_context::sender(arg6) == arg0.owner, 407);
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::sub_owner(arg4) == 0x2::tx_context::sender(arg6), 407);
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::account_owner(arg3) == 0x2::tx_context::sender(arg6), 407);
        assert!(!0x2::table::contains<0x1::string::String, BlobRef>(&arg0.blobs, arg5.blob_id), 406);
        let v0 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::sub_tier(arg4);
        let v1 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::get_plan(arg2, v0);
        if (arg5.encrypted) {
            assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_has_seal(v1), 421);
        };
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::account_total_bytes(arg3) + arg5.size_bytes <= 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::effective_storage_limit(arg3, arg2, v0), 428);
        let v2 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_max_total_files(v1);
        if (v2 > 0) {
            assert!(arg0.total_blobs + 1 <= v2, 420);
        };
        let v3 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_max_walrus_epochs(v1);
        if (v3 > 0) {
        ...
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::add_storage(arg3, v5, 1, v6);
    ...
    public fun register_quilt(arg0: &mut BlobStore, arg1: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::GlobalConfig, arg2: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::PlanRegistry, arg3: &mut 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::UserAccount, arg4: &0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::Subscription, arg5: vector<BlobRef>, arg6: &0x2::tx_context::TxContext) {
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::assert_not_paused(arg1);
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::assert_version(arg1);
        assert!(0x2::tx_context::sender(arg6) == arg0.owner, 407);
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::sub_owner(arg4) == 0x2::tx_context::sender(arg6), 407);
        ...
        assert!(v0 > 0, 425);
        let v1 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::sub_tier(arg4);
        let v2 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::get_plan(arg2, v1);
        let v3 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_max_files_per_batch(v2);
        if (v3 > 0) {
            assert!(v0 <= v3, 419);
        };
        let v4 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_max_total_files(v2);
        if (v4 > 0) {
        ...
        let v8 = v5.encrypted;
        let v9 = 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_max_walrus_epochs(v2);
        if (v9 > 0) {
            assert!(v7 - v5.stored_epoch <= v9, 410);
        };
        if (v8) {
            assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::plan_has_seal(v2), 421);
        };
        let v10 = 0;
        let v11 = 0;
        while (v11 < v0) {
        ...
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::account_total_bytes(arg3) + v10 <= 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::effective_storage_limit(arg3, arg2, v1), 428);
        let v12 = 0;
        ...
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::add_storage(arg3, v12, v0, v8);
    ...
    public fun release_blob(arg0: &mut BlobStore, arg1: &mut 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::UserAccount, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) : BlobRef {
        assert!(0x2::tx_context::sender(arg3) == arg0.owner, 407);
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::account_owner(arg1) == 0x2::tx_context::sender(arg3), 407);
        ...
        arg0.total_blobs = v2;
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::release_storage(arg1, v0.size_bytes, 1, v0.encrypted);
        let v3 = BlobReleased{
            blob_id    : v0.blob_id,
            owner      : arg0.owner,
    ...
    public fun transfer_account(arg0: &mut 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::GlobalConfig, arg1: 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::UserAccount, arg2: 0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::Subscription, arg3: &mut BlobStore, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::account_owner(&arg1) == v0, 407);
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::sub_owner(&arg2) == v0, 407);
        assert!(arg3.owner == v0, 407);
        assert!(arg4 != v0, 413);
        assert!(0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::account_active_jobs(&arg1) == 0, 414);
        let v1 = 0x2::object::id<0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::UserAccount>(&arg1);
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::set_account_owner(&mut arg1, arg4);
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::set_sub_owner(&mut arg2, arg4);
        arg3.owner = arg4;
        arg3.viewers = 0x2::vec_set::empty<address>();
        assert!(0x1::vector::is_empty<vector<u8>>(&arg3.share_markers), 429);
        0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::admin::reassign_user_account(arg0, v0, arg4, v1, arg5);
        let v2 = AccountTransferred{
            from            : v0,
            to              : arg4,
            account_id      : v1,
            subscription_id : 0x2::object::id<0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::Subscription>(&arg2),
            store_id        : 0x2::object::id<BlobStore>(arg3),
            epoch           : 0x2::tx_context::epoch(arg5),
        };
        0x2::event::emit<AccountTransferred>(v2);
        0x2::transfer::public_transfer<0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::UserAccount>(arg1, arg4);
        0x2::transfer::public_transfer<0x97a1bd5744867b6e2843680565135a57cd1f6e7a5b553250b855fc9d2bc9b::subscription::Subscription>(arg2, arg4);
    }
