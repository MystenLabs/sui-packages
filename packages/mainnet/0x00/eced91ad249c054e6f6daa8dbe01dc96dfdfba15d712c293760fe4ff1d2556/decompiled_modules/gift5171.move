module 0xeced91ad249c054e6f6daa8dbe01dc96dfdfba15d712c293760fe4ff1d2556::gift5171 {
    struct GIFT5171 has drop {
        dummy_field: bool,
    }

    struct TICKET_5171 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5171(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5171>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5171>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5171, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5171>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5171>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5171>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5171>>(v5, 0x2::tx_context::sender(arg1));
    }
