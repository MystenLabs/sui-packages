module 0x1::u16 {
    ...
    public fun div_ceil(arg0: u16, arg1: u16) : u16 {
        if (arg0 % arg1 == 0) {
            arg0 / arg1
        } else {
            arg0 / arg1 + 1
    ...
    public fun mul_div(arg0: u16, arg1: u16, arg2: u16) : u16 {
        (((arg0 as u32) * (arg1 as u32) / (arg2 as u32)) as u16)
    }

    public fun mul_div_ceil(arg0: u16, arg1: u16, arg2: u16) : u16 {
        let v0 = (arg0 as u32) * (arg1 as u32);
        let v1 = (arg2 as u32);
        let v2 = if (v0 % v1 == 0) {
            v0 / v1
        } else {
