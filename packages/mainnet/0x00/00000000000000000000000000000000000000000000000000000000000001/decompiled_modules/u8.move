module 0x1::u8 {
    ...
    public fun div_ceil(arg0: u8, arg1: u8) : u8 {
        if (arg0 % arg1 == 0) {
            arg0 / arg1
        } else {
            arg0 / arg1 + 1
    ...
    public fun lossless_div(arg0: u8, arg1: u8) : 0x1::option::Option<u8> {
        if (arg1 == 0) {
            0x1::option::none<u8>()
        } else if (arg0 % arg1 == 0) {
            0x1::option::some<u8>(arg0 / arg1)
    ...
    public fun lossless_shl(arg0: u8, arg1: u8) : 0x1::option::Option<u8> {
        if (arg1 >= 8) {
            0x1::option::none<u8>()
        } else {
            let v1 = arg0 << arg1;
    ...
    public fun lossless_shr(arg0: u8, arg1: u8) : 0x1::option::Option<u8> {
        if (arg1 >= 8) {
            0x1::option::none<u8>()
        } else {
            let v1 = arg0 >> arg1;
    ...
    public fun mul_div(arg0: u8, arg1: u8, arg2: u8) : u8 {
        (((arg0 as u16) * (arg1 as u16) / (arg2 as u16)) as u8)
    }

    public fun mul_div_ceil(arg0: u8, arg1: u8, arg2: u8) : u8 {
        let v0 = (arg0 as u16) * (arg1 as u16);
        let v1 = (arg2 as u16);
        let v2 = if (v0 % v1 == 0) {
            v0 / v1
        } else {
    ...
    public fun saturating_add(arg0: u8, arg1: u8) : u8 {
        let v0 = 255;
        if (arg1 > v0 - arg0) {
            v0
        } else {
    ...
    public fun saturating_mul(arg0: u8, arg1: u8) : u8 {
        let v0 = 255;
        if (arg0 == 0 || arg1 == 0) {
            0
    ...
    public fun saturating_sub(arg0: u8, arg1: u8) : u8 {
        if (arg0 < arg1) {
            0
        } else {
            arg0 - arg1
