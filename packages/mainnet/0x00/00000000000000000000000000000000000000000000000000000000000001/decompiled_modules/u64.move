module 0x1::u64 {
    public fun bitwise_not(arg0: u64) : u64 {
    ...
    public fun lossless_div(arg0: u64, arg1: u64) : 0x1::option::Option<u64> {
        if (arg1 == 0) {
            0x1::option::none<u64>()
        } else if (arg0 % arg1 == 0) {
            0x1::option::some<u64>(arg0 / arg1)
    ...
    public fun lossless_shl(arg0: u64, arg1: u8) : 0x1::option::Option<u64> {
        if (arg1 >= 64) {
            0x1::option::none<u64>()
        } else {
            let v1 = arg0 << arg1;
    ...
    public fun lossless_shr(arg0: u64, arg1: u8) : 0x1::option::Option<u64> {
        if (arg1 >= 64) {
            0x1::option::none<u64>()
        } else {
            let v1 = arg0 >> arg1;
    ...
    public fun saturating_add(arg0: u64, arg1: u64) : u64 {
    ...
    public fun saturating_mul(arg0: u64, arg1: u64) : u64 {
        let v0 = 18446744073709551615;
        if (arg0 == 0 || arg1 == 0) {
            0
    ...
    public fun try_as_u16(arg0: u64) : 0x1::option::Option<u16> {
        if (arg0 > 65535) {
            0x1::option::none<u16>()
        } else {
    ...
    public fun try_as_u32(arg0: u64) : 0x1::option::Option<u32> {
        if (arg0 > 4294967295) {
            0x1::option::none<u32>()
        } else {
    ...
    public fun try_as_u8(arg0: u64) : 0x1::option::Option<u8> {
        if (arg0 > 255) {
            0x1::option::none<u8>()
        } else {
