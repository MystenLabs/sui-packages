module 0xfd33a445e524507064fe4218e117967a8b044369cc24340ad4896dd28282d3::usdt {
    struct USDT has drop {
        dummy_field: bool,
    }

    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/Yj-Q2zctCL1XRgbMyE_l321SW-cn1WeSbvzJ3AUTIV8";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/Yj-Q2zctCL1XRgbMyE_l321SW-cn1WeSbvzJ3AUTIV8"))
        };
