module 0x100355e984d1c6d3a468618cb090c2b0338e90bdfee7451c3fbffc1dcbbf52::slush_wallet_og_badge {
    struct SLUSH_WALLET_OG_BADGE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SLUSH_WALLET_OG_BADGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SLUSH_WALLET_OG_BADGE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Slush Wallet OG Badge"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Day 1 User OG Badge"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibydcrfjayxie5d5wowc2dptfkzhospdodngvw7ljtajein24vcv4"));
