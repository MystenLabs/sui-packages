module 0x9f01c4e45d80a37ef1053b341bbbe5dcc84a02a09e1a7f4fb59e5806b5da22b5::casino {
    ...
    public entry fun hilo_play_v2(arg0: &mut CasinoShrine, arg1: HiLoSession, arg2: &0x2::random::Random, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0;
        let v8 = arg3 == 0 && v2 == 13 || arg3 == 1 && v2 == 1;
        let (v9, v10) = if (v8) {
            ...
            if (v6 == v2) {
                let v11 = v3 * 12;
                let v12 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&arg0.prize_pool) / 10;
                let v13 = if (v11 > v12) {
                    arg0.jackpots_hit = arg0.jackpots_hit + 1;
                    let v14 = JackpotHit{
                        player : v1,
            ...
            let v15 = 126100 / ((13 - v2) as u64) * 100;
            let v10 = if (v6 > v2) {
                let v16 = v3 * v15 / 100;
                let v17 = 0x2::balance::value<0x618e05f8e7405d63339ddade6d5e64887651b5dde73453e53f92c5be7b93ce3c::jui_on_sui::JUI_ON_SUI>(&arg0.prize_pool) / 10;
                let v18 = if (v16 > v17) {
                    arg0.jackpots_hit = arg0.jackpots_hit + 1;
                    let v19 = JackpotHit{
                        player : v1,
