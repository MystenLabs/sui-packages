module 0x3c5f7c54b226e61f2f778c5f482d2f182c6ec25ff40cd254423715efb894df::validator_pool {
    struct ValidatorPool has store {
        ...
        total_weight: u64,
        manage: 0x3c5f7c54b226e61f2f778c5f482d2f182c6ec25ff40cd254423715efb894df::manage::Manage,
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : ValidatorPool {
        ValidatorPool{
            ...
            total_weight       : 0,
            manage             : 0x3c5f7c54b226e61f2f778c5f482d2f182c6ec25ff40cd254423715efb894df::manage::new(),
    ...
    public(friend) fun refresh(arg0: &mut ValidatorPool, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : bool {
        0x3c5f7c54b226e61f2f778c5f482d2f182c6ec25ff40cd254423715efb894df::manage::check_version(&arg0.manage);
