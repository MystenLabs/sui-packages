module 0x5122363860aca14da9c17ae111ddae826219c6ef08f0ee4988358589b527bd::account_module {
    ...
    public fun check_rate(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) : u64 {
        ...
        while (v5 < v4) {
            ...
            let (v9, v10, v11, _) = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::balance_sheet(0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::wit_table::borrow<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::BalanceSheets, 0x1::type_name::TypeName, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::BalanceSheet>(v2, v6));
            let v13 = APYEvent{apy: v5};
            0x2::event::emit<APYEvent>(v13);
            0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::borrow_dynamics::interest_rate(v7));
            0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::revenue_factor(v8));
            if (0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::type_name(v8) == 0x1::type_name::get<0x2::sui::SUI>()) {
                let v14 = APYEvent{apy: 10000};
                0x2::event::emit<APYEvent>(v14);
                let v15 = APYEvent{apy: 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::borrow_dynamics::interest_rate(v7))};
                0x2::event::emit<APYEvent>(v15);
                let v16 = APYEvent{apy: v10};
                0x2::event::emit<APYEvent>(v16);
                let v17 = APYEvent{apy: 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::revenue_factor(v8))};
                0x2::event::emit<APYEvent>(v17);
                let v18 = APYEvent{apy: v9};
                0x2::event::emit<APYEvent>(v18);
                let v19 = APYEvent{apy: v11};
                0x2::event::emit<APYEvent>(v19);
                return 0
            };
            v5 = v5 + 1;
        };
        let v20 = APYEvent{apy: v4};
