module 0x2d0b9edf45da7b998a802d4b54337b6c05a8c230d431dde78ad14f449a2483::amm {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LP<T0, T1>> {
        ...
        let (v6, v7, v8) = if (v2 == 0) {
            v5 = 1000;
            (0x2d0b9edf45da7b998a802d4b54337b6c05a8c230d431dde78ad14f449a2483::utils::mulsqrt_u64(v0, v1) - 1000, v0, v1)
        } else {
            let v9 = v0 * v2 / v3;
            let v10 = v1 * v2 / v4;
            if (v9 < v10) {
    ...
    fun pre_compute_value<T0, T1>(arg0: &Market<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) : PreComputeMarket {
        ...
        let v3 = 0x2d0b9edf45da7b998a802d4b54337b6c05a8c230d431dde78ad14f449a2483::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1);
        assert!(v2 > 0 && v3 > 0, 5);
        PreComputeMarket{
            rate_scalar : v1,
            total_asset : v3,
    ...
    fun set_initial_ln_implied_rate<T0, T1>(arg0: &mut Market<T0, T1>, arg1: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg2: &0x2::clock::Clock) {
        ...
        let v0 = arg0.expiry - 0x2::clock::timestamp_ms(arg2);
        arg0.last_ln_implied_rate = get_ln_implied_rate(0x2::balance::value<T0>(&arg0.total_pt), 0x2d0b9edf45da7b998a802d4b54337b6c05a8c230d431dde78ad14f449a2483::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg1), get_rate_scalar<T0, T1>(arg0, v0), arg0.initial_anchor, v0);
    }
    ...
    fun set_new_market_market_trade<T0, T1>(arg0: &mut Market<T0, T1>, arg1: PreComputeMarket, arg2: 0x2dc2de613e946a2a56434189b8875cfcc457ab2c6735e014bdb56209a1bedb6::fixed_point64::FixedPoint64, arg3: &0x2::clock::Clock) {
        arg0.last_ln_implied_rate = get_ln_implied_rate(0x2::balance::value<T0>(&arg0.total_pt), 0x2d0b9edf45da7b998a802d4b54337b6c05a8c230d431dde78ad14f449a2483::utils::sy_to_asset(0x2::balance::value<T1>(&arg0.total_sy), arg2), arg1.rate_scalar, arg1.rate_anchor, arg0.expiry - 0x2::clock::timestamp_ms(arg3));
