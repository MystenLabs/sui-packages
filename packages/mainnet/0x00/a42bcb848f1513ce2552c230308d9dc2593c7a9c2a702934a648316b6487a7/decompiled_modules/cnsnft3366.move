module 0xa42bcb848f1513ce2552c230308d9dc2593c7a9c2a702934a648316b6487a7::cnsnft3366 {
    struct CNSNFT3366 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3366, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3366>(arg0, arg1);
