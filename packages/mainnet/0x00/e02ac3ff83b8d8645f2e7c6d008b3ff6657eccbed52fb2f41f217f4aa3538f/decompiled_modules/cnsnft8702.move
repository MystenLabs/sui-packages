module 0xe02ac3ff83b8d8645f2e7c6d008b3ff6657eccbed52fb2f41f217f4aa3538f::cnsnft8702 {
    struct CNSNFT8702 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8702, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5751"));
        let v4 = 0x2::package::claim<CNSNFT8702>(arg0, arg1);
