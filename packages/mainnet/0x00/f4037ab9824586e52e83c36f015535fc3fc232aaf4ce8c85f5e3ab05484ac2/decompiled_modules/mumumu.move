module 0xf4037ab9824586e52e83c36f015535fc3fc232aaf4ce8c85f5e3ab05484ac2::mumumu {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Mumumu v7 #{token_id}"));
        ...
        let v12 = Mumumu{
            ...
            image_base          : 0x1::string::utf8(b"https://storage.googleapis.com/mmp-demo/sui/1.png"),
