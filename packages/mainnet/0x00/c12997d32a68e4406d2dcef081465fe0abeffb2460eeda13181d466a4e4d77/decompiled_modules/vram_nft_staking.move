module 0xc12997d32a68e4406d2dcef081465fe0abeffb2460eeda13181d466a4e4d77::vram_nft_staking {
    ...
    public entry fun stake_migrate<T0: store + key>(arg0: &mut Treasury, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: address, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x1::type_name::get<T0>();
        let v0 = ListingPersonal<T0>{
            id  : 0x2::object::new(arg7),
            cap : 0x2::kiosk::list_with_purchase_cap<T0>(arg1, arg2, arg3, arg5, arg7),
        };
        0x2::dynamic_object_field::add<0x2::object::ID, ListingPersonal<T0>>(&mut arg0.id, arg3, v0);
        arg0.totalStaked = arg0.totalStaked + 1;
        if (!0x2::vec_map::contains<0x2::object::ID, address>(&arg0.nftIdAcountOf, &arg3)) {
            0x2::vec_map::insert<0x2::object::ID, address>(&mut arg0.nftIdAcountOf, arg3, arg4);
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, address>(&mut arg0.nftIdAcountOf, &arg3) = arg4;
        };
        if (!0x2::vec_map::contains<0x2::object::ID, u64>(&arg0.stakedTimeOf, &arg3)) {
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.stakedTimeOf, arg3, 0x2::clock::timestamp_ms(arg6));
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg0.stakedTimeOf, &arg3) = 0x2::clock::timestamp_ms(arg6);
        };
        if (!0x2::vec_map::contains<0x2::object::ID, u64>(&arg0.rewardTimeOf, &arg3)) {
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.rewardTimeOf, arg3, 0x2::clock::timestamp_ms(arg6));
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg0.rewardTimeOf, &arg3) = 0x2::clock::timestamp_ms(arg6);
        };
        if (!0x2::vec_map::contains<0x2::object::ID, u64>(&arg0.periodTimeOf, &arg3)) {
            0x2::vec_map::insert<0x2::object::ID, u64>(&mut arg0.periodTimeOf, arg3, 0x2::clock::timestamp_ms(arg6));
        } else {
            *0x2::vec_map::get_mut<0x2::object::ID, u64>(&mut arg0.periodTimeOf, &arg3) = arg5;
        };
        let v1 = VRAMStaking{
