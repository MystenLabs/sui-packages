module 0xa90f4b8591c8e490f5fc14e8cbf76b0046c9fe0bb1843aac22aca07d98fb0::agent_nft {
    ...
    fun init(arg0: AGENT_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://x.com/5son"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"5SON"));
        ...
        0x2::transfer::public_share_object<UserArchive>(v5);
        let v6 = VaultConfig{
            id          : 0x2::object::new(arg1),
            version     : 1,
        ...
        0x2::transfer::public_share_object<VaultConfig>(v6);
    }
