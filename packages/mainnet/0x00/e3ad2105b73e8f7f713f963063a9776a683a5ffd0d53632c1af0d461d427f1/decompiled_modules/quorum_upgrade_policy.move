module 0xae627358027f3b53865d2403ecf5573c91d543a387d653764b650b8f85a2235c::quorum_upgrade_policy {
    ...
    struct UpgradeMetadata has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun add_metadata(arg0: &mut ProposedUpgrade, arg1: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.proposer == 0x2::tx_context::sender(arg2), 8);
        let v0 = UpgradeMetadata{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_with_type<UpgradeMetadata, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg0.id, v0), 9);
        let v1 = UpgradeMetadata{dummy_field: false};
        0x2::dynamic_field::add<UpgradeMetadata, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&mut arg0.id, v1, arg1);
    }

    fun authorize(arg0: &mut QuorumUpgradeCap, arg1: &mut ProposedUpgrade, arg2: &0x2::tx_context::TxContext) : 0x2::package::UpgradeTicket {
        ...
        let v2 = UpgradeMetadata{dummy_field: false};
        0x2::dynamic_field::remove_if_exists<UpgradeMetadata, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&mut arg1.id, v2);
        0x2::package::authorize_upgrade(&mut arg0.upgrade_cap, 0x2::package::upgrade_policy(&arg0.upgrade_cap), arg1.digest)
    }

    public fun authorize_upgrade_and_cleanup(arg0: &mut QuorumUpgradeCap, arg1: ProposedUpgrade, arg2: &0x2::tx_context::TxContext) : 0x2::package::UpgradeTicket {
        let v0 = &mut arg1;
        let ProposedUpgrade {
            id             : v1,
            upgrade_cap    : _,
        ...
        authorize(arg0, v0, arg2)
    }

    public fun create_upgrade(arg0: &QuorumUpgradeCap, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : ProposedUpgrade {
        internal_propose_upgrade(arg0, arg1, arg2)
    }
    ...
    fun internal_propose_upgrade(arg0: &QuorumUpgradeCap, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : ProposedUpgrade {
    ...
    public fun metadata(arg0: &ProposedUpgrade) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        let v0 = UpgradeMetadata{dummy_field: false};
        *0x2::dynamic_field::borrow<UpgradeMetadata, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg0.id, v0)
    }

    public fun migrate_quorum_to_v2(arg0: QuorumUpgradeCap, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x565f0f84b23e5d167ddf5efed362787d3ad2a9a5cdf86e76cfdca285a2debdf4::quorum_upgrade::new(v1, v2, v3, arg1);
        0x2::object::delete(v0);
    }
    ...
    public fun propose_upgrade(arg0: &QuorumUpgradeCap, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<ProposedUpgrade>(internal_propose_upgrade(arg0, arg1, arg2));
    }
    ...
    public fun share_upgrade_object(arg0: ProposedUpgrade) {
        0x2::transfer::share_object<ProposedUpgrade>(arg0);
    }
