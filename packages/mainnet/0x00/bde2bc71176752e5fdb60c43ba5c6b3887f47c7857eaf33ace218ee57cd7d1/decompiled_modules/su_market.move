module 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market {
    ...
    public fun borrow<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &Position, arg2: u64, arg3: 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::Price, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_operational<T0, T1, T2>(arg0);
        assert!(arg2 != 0, 20);
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::borrowed(id<T0, T1, T2>(arg0), v3, (arg2 as u128), v2, v1, account_state<T0, T1, T2>(arg0, v3), event_state<T0, T1, T2>(arg0));
    ...
    fun id<T0, T1, T2>(arg0: &Market<T0, T1, T2>) : 0x2::object::ID {
        0x2::object::id<Market<T0, T1, T2>>(arg0)
    }

    public fun new<T0, T1, T2>(arg0: 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::PriceMode, arg1: u64, arg2: u256, arg3: 0x2::coin::TreasuryCap<T2>, arg4: 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::InterestRateModel, arg5: u256, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (Market<T0, T1, T2>, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::Oracle, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap) {
        ...
        assert!(v3, 32);
        let v4 = 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::new(arg0, arg1, arg2, arg7);
        let v5 = 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::id(&v4);
        ...
        let v7 = id<T0, T1, T2>(&v6);
        let v8 = 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::new(v7, v5, arg7);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::market_created(v7, 0x2::object::id<0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap>(&v8), v5, v0, v1, v2, arg5, v6.fee, v6.last_update, v6.irm, event_state<T0, T1, T2>(&v6));
        (v6, v4, v8)
    }

    fun account_state<T0, T1, T2>(arg0: &Market<T0, T1, T2>, arg1: 0x2::object::ID) : 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::AccountState {
        let v0 = 0x2::table::borrow<0x2::object::ID, Account>(&arg0.accounts, arg1);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::account_state(v0.borrow_shares, to_assets_up(v0.borrow_shares, arg0.total_borrow_assets, arg0.total_borrow_shares), v0.collateral_shares, to_assets_down(v0.collateral_shares, arg0.total_collateral_assets, arg0.total_collateral_shares))
    }
    ...
    fun accrue<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        ...
        if (arg0.total_supply_assets == 0) {
            0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::interest_accrued(id<T0, T1, T2>(arg0), 0, 0, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::rate_at_target(&arg0.irm), arg0.last_update, event_state<T0, T1, T2>(arg0));
            return
        };
        let v1 = (0x1::u256::div_ceil((arg0.total_borrow_assets as u256) * 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::interest_factor_mut(&mut arg0.irm, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::utilization((arg0.total_borrow_assets as u256), (arg0.total_supply_assets as u256)), v0), 1000000000000000000) as u128);
        let v2 = 0;
        if (v1 != 0) {
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::interest_accrued(id<T0, T1, T2>(arg0), v1, v2, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::rate_at_target(&arg0.irm), arg0.last_update, event_state<T0, T1, T2>(arg0));
    }

    public fun add_liquidator<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap, arg2: address) {
        assert_unlocked<T0, T1, T2>(arg0);
        assert_supported_version<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::assert_market(arg1, id<T0, T1, T2>(arg0));
        if (!0x2::vec_set::contains<address>(&arg0.liquidators, &arg2)) {
            assert!(0x2::vec_set::length<address>(&arg0.liquidators) < 256, 41);
        };
        0x2::vec_set::insert<address>(&mut arg0.liquidators, arg2);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::liquidator_updated(id<T0, T1, T2>(arg0), arg2, true, 0x2::vec_set::into_keys<address>(arg0.liquidators));
    }
    ...
    fun assert_operational<T0, T1, T2>(arg0: &Market<T0, T1, T2>) {
        assert_unlocked<T0, T1, T2>(arg0);
        assert_supported_version<T0, T1, T2>(arg0);
        assert!(!arg0.paused, 40);
    }

    fun assert_position<T0, T1, T2>(arg0: &Market<T0, T1, T2>, arg1: &Position) {
        assert!(arg1.market == id<T0, T1, T2>(arg0), 25);
        assert!(0x2::table::contains<0x2::object::ID, Account>(&arg0.accounts, 0x2::object::id<Position>(arg1)), 25);
    }

    fun assert_supported_version<T0, T1, T2>(arg0: &Market<T0, T1, T2>) {
        assert!(arg0.version != 0 && arg0.version <= 1, 39);
    }
    ...
    fun checked_price<T0, T1, T2>(arg0: &Market<T0, T1, T2>, arg1: 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::Price) : (u256, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::PriceSnapshot) {
        let (v0, v1, v2, v3) = 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::destroy_price(arg1);
        assert!(v0 == arg0.oracle, 23);
        (v1, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::price_snapshot(v0, v1, v2, v3))
    }

    public fun close_position<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: Position) {
        assert_operational<T0, T1, T2>(arg0);
        let v0 = id<T0, T1, T2>(arg0);
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::position_closed(v0, v1, zero_account_state());
    }
    ...
    fun event_state<T0, T1, T2>(arg0: &Market<T0, T1, T2>) : 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::MarketState {
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::market_state(arg0.total_supply_assets, supply_shares<T0, T1, T2>(arg0), arg0.fee_shares, arg0.total_borrow_assets, arg0.total_borrow_shares, arg0.total_collateral_assets, arg0.total_collateral_shares, arg0.last_update, 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::rate_at_target(&arg0.irm), arg0.fee, arg0.flash_active)
    }
    ...
    public fun flash_loan<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>, FlashLoan) {
        ...
        let v2 = id<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::flash_loaned(v2, (arg1 as u128), (v0 as u128), (arg2 as u128), (v1 as u128), event_state<T0, T1, T2>(arg0));
        let v3 = FlashLoan{
            market            : v2,
            loan_amount       : arg1,
            loan_fee          : v0,
    ...
    public fun liquidate<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: 0x2::object::ID, arg2: u64, arg3: 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::Price, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, LiquidationReceipt) {
        assert_operational<T0, T1, T2>(arg0);
        assert!(arg2 != 0, 20);
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::liquidated(v3, arg1, v12, v15, v14, v16, v24, v2, account_state<T0, T1, T2>(arg0, arg1), event_state<T0, T1, T2>(arg0));
    ...
    public fun migrate<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap) {
        assert_unlocked<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::assert_market(arg1, id<T0, T1, T2>(arg0));
        assert!(arg0.version < 1, 39);
        arg0.version = 1;
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::market_version_migrated(id<T0, T1, T2>(arg0), arg0.version);
    }
    ...
    public fun open_position<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &mut 0x2::tx_context::TxContext) : Position {
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::position_opened(v0, v2, zero_account_state());
        v1
    }

    public fun pause<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap) {
        assert_unlocked<T0, T1, T2>(arg0);
        assert_supported_version<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::assert_market(arg1, id<T0, T1, T2>(arg0));
        if (!arg0.paused) {
            arg0.paused = true;
            0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::market_paused(id<T0, T1, T2>(arg0), true);
        };
    }

    public fun remove_liquidator<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap, arg2: address) {
        assert_unlocked<T0, T1, T2>(arg0);
        assert_supported_version<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::assert_market(arg1, id<T0, T1, T2>(arg0));
        0x2::vec_set::remove<address>(&mut arg0.liquidators, &arg2);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::liquidator_updated(id<T0, T1, T2>(arg0), arg2, false, 0x2::vec_set::into_keys<address>(arg0.liquidators));
    }
    ...
    public fun repay<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::repaid(id<T0, T1, T2>(arg0), arg1, v3, v4, account_state<T0, T1, T2>(arg0, arg1), event_state<T0, T1, T2>(arg0));
        arg2
    }
    ...
    public fun repay_flash_loan<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: FlashLoan, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T0>) {
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::flash_loan_repaid(v0, (v5 as u128), (v6 as u128), (v1 as u128), (v3 as u128), event_state<T0, T1, T2>(arg0));
    }
    ...
    public fun repay_liquidation<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: LiquidationReceipt, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T1>(&mut arg0.loan, 0x2::coin::into_balance<T1>(arg2));
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::liquidation_repaid(v0, v1, v2, event_state<T0, T1, T2>(arg0));
    }

    public fun set_fee<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_acl::AdminWitness, arg2: u256, arg3: &0x2::clock::Clock) {
        assert_unlocked<T0, T1, T2>(arg0);
        assert_supported_version<T0, T1, T2>(arg0);
        ...
        accrue<T0, T1, T2>(arg0, arg3);
        arg0.fee = arg2;
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::fee_set(id<T0, T1, T2>(arg0), arg2, event_state<T0, T1, T2>(arg0));
    }

    public fun set_irm<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap, arg2: 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::InterestRateModel, arg3: &0x2::clock::Clock) {
        assert_unlocked<T0, T1, T2>(arg0);
        assert_supported_version<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::assert_market(arg1, id<T0, T1, T2>(arg0));
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::assert_kinked(&arg0.irm);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::irm::assert_kinked(&arg2);
        accrue<T0, T1, T2>(arg0, arg3);
        arg0.irm = arg2;
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::interest_rate_model_set(id<T0, T1, T2>(arg0), arg0.irm, event_state<T0, T1, T2>(arg0));
    }
    ...
    public fun supply<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::supplied(id<T0, T1, T2>(arg0), v0, v1, event_state<T0, T1, T2>(arg0));
    ...
    public fun supply_collateral<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::collateral_supplied(id<T0, T1, T2>(arg0), arg1, v0, v1, account_state<T0, T1, T2>(arg0, arg1), event_state<T0, T1, T2>(arg0));
    }
    ...
    public fun unpause<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::MarketCap) {
        assert_unlocked<T0, T1, T2>(arg0);
        assert_supported_version<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_market_authority::assert_market(arg1, id<T0, T1, T2>(arg0));
        if (arg0.paused) {
            arg0.paused = false;
            0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::market_paused(id<T0, T1, T2>(arg0), false);
        };
    }
    ...
    public fun withdraw<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::withdrawn(id<T0, T1, T2>(arg0), v1, v0, event_state<T0, T1, T2>(arg0));
        0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.loan, (v1 as u64)), arg3)
    }

    public fun withdraw_collateral<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &Position, arg2: u64, arg3: 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_oracle::Price, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_operational<T0, T1, T2>(arg0);
        assert!(arg2 != 0, 20);
        assert!(arg2 <= 0x2::balance::value<T0>(&arg0.collateral), 21);
        assert_position<T0, T1, T2>(arg0, arg1);
        ...
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::collateral_withdrawn(id<T0, T1, T2>(arg0), v3, (arg2 as u128), v2, v1, account_state<T0, T1, T2>(arg0, v3), event_state<T0, T1, T2>(arg0));
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.collateral, arg2), arg5)
    }

    public fun withdraw_fee<T0, T1, T2>(arg0: &mut Market<T0, T1, T2>, arg1: &0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_acl::AdminWitness, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_operational<T0, T1, T2>(arg0);
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::su_acl::assert_has_role(arg1, 1);
        accrue<T0, T1, T2>(arg0, arg2);
        ...
        arg0.total_supply_assets = arg0.total_supply_assets - v1;
        arg0.fee_shares = 0;
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::fee_withdrawn(id<T0, T1, T2>(arg0), v1, v0, event_state<T0, T1, T2>(arg0));
        0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.loan, (v1 as u64)), arg3)
    }

    fun zero_account_state() : 0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::AccountState {
        0xbde2bc71176752e5fdb60c43ba5c6b3887f47c7857eaf33ace218ee57cd7d1::events::account_state(0, 0, 0, 0)
    }
