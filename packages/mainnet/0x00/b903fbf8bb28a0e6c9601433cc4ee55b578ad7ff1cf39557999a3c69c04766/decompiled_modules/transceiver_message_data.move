module 0xb903fbf8bb28a0e6c9601433cc4ee55b578ad7ff1cf39557999a3c69c04766::transceiver_message_data {
    struct TransceiverMessageData<T0> has copy, drop {
        ...
        ntt_manager_payload: 0xb903fbf8bb28a0e6c9601433cc4ee55b578ad7ff1cf39557999a3c69c04766::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0xb903fbf8bb28a0e6c9601433cc4ee55b578ad7ff1cf39557999a3c69c04766::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0xb903fbf8bb28a0e6c9601433cc4ee55b578ad7ff1cf39557999a3c69c04766::ntt_manager_message::to_bytes(v2);
        ...
        0x1::vector::append<u8>(&mut v3, 0xb903fbf8bb28a0e6c9601433cc4ee55b578ad7ff1cf39557999a3c69c04766::ntt_manager_message::to_bytes(v2));
        v3
    }
