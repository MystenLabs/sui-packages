module 0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::vault {
    ...
    struct Vault<phantom T0> has key {
        ...
        total_shares: u64,
        current_strategy: u8,
        treasury_cap: 0x2::coin::TreasuryCap<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN>,
    }
    ...
    public fun borrow_treasury_cap<T0>(arg0: &AdminCap, arg1: &Vault<T0>) : &0x2::coin::TreasuryCap<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN> {
        &arg1.treasury_cap
    }
    ...
    public fun create_vault<T0>(arg0: 0x2::coin::TreasuryCap<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN> {
        assert!(!is_paused(&arg0.id), 6);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 > 0, 1);
        let v1 = 0x2::tx_context::sender(arg2);
        if (0x2::table::contains<address, u64>(&arg0.user_balances, v1)) {
            let v2 = 0x2::table::borrow_mut<address, u64>(&mut arg0.user_balances, v1);
            *v2 = *v2 + v0;
        } else {
        ...
        0x2::coin::mint<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN>(&mut arg0.treasury_cap, v4, arg2)
    }

    public fun emergency_withdraw<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(is_paused(&arg0.id), 7);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 0x2::coin::burn<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN>(&mut arg0.treasury_cap, arg1);
        assert!(v1 > 0, 1);
    ...
    public fun keeper_heartbeat<T0>(arg0: &KeeperCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
        ...
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg1.id, v0)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg1.id, v0) = v1;
        } else {
            0x2::dynamic_field::add<0x1::string::String, u64>(&mut arg1.id, v0, v1);
        };
        let v2 = 0x1::string::utf8(b"keeper_timeout_ms");
        if (!0x2::dynamic_field::exists_<0x1::string::String>(&arg1.id, v2)) {
            0x2::dynamic_field::add<0x1::string::String, u64>(&mut arg1.id, v2, 14400000);
        };
    ...
    public fun request_withdrawal<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<0x1dd6cffcf41e79b261d82a598c45b2d59e0891ce27d3500733572c167a3633::token::TOKEN>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
