module 0x9b8920adeee1b9566a00206704b632cd1c0d04b98f6a64d3a0fbb7daf1447c::reward1473 {
    struct REWARD1473 has drop {
        dummy_field: bool,
    }

    struct TICKET_1473 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1473(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1473>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1473>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1473, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1473>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1473>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1473>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1473>>(v5, 0x2::tx_context::sender(arg1));
    }
