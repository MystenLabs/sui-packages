module 0xe51c097fa528a1dea649c03fd7e2a52a60091a323714f32ac9b5a28d4f26::reward4034 {
    struct REWARD4034 has drop {
        dummy_field: bool,
    }

    struct TICKET_4034 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4034(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4034>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4034>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4034, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4034>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4034>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4034>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4034>>(v5, 0x2::tx_context::sender(arg1));
    }
