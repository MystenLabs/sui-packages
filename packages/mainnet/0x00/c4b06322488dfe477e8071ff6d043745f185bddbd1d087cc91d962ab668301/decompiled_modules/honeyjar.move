module 0xc4b06322488dfe477e8071ff6d043745f185bddbd1d087cc91d962ab668301::honeyjar {
    ...
    struct MarketplaceChef has key {
        ...
        claim_locked: bool,
        honey_rewards: 0x2::balance::Balance<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>,
        last_claim_ts: u64,
    ...
    struct HoneyJar has key {
        ...
        claimable_amm_rewards: 0x2::balance::Balance<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>,
        bag: 0x2::bag::Bag,
        version: u64,
    }
    ...
    public fun claim_honey(arg0: &0x2::clock::Clock, arg1: &mut MarketplaceChef, arg2: &mut 0xc4b06322488dfe477e8071ff6d043745f185bddbd1d087cc91d962ab668301::honey_manager::HoneyManager, arg3: &mut HoneyJar, arg4: &mut 0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey_yield::HoneyYield, arg5: &mut 0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey_yield::FeeCollector<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>, arg6: &mut 0x2::token::TokenPolicy<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun add_to_honeyjar(arg0: &HoneyJarPointsCap, arg1: &0x2::clock::Clock, arg2: &mut MarketplaceChef, arg3: &mut 0xc4b06322488dfe477e8071ff6d043745f185bddbd1d087cc91d962ab668301::honey_manager::HoneyManager, arg4: &mut HoneyJar, arg5: u64) {
    ...
    public fun amm_add_claimable_rewards(arg0: &mut HoneyJar, arg1: 0x2::balance::Balance<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>) {
        0x2::balance::join<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>(&mut arg0.claimable_amm_rewards, arg1);
    }
    ...
    public fun claim_sui_collected(arg0: &mut MarketplaceChef, arg1: &HoneyJarFeeClaimCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.balance), arg2, arg3);
    }
    ...
    fun increment_global_index(arg0: &0x2::clock::Clock, arg1: &mut 0xc4b06322488dfe477e8071ff6d043745f185bddbd1d087cc91d962ab668301::honey_manager::HoneyManager, arg2: &mut MarketplaceChef) {
        if (arg2.active_points == 0) {
            return
        };
        let v0 = 0xc4b06322488dfe477e8071ff6d043745f185bddbd1d087cc91d962ab668301::honey_manager::claim_honey(&mut arg2.claim_honey_cap, arg1, arg0);
        let v1 = 0x2::balance::value<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>(&v0);
        arg2.global_claim_index = arg2.global_claim_index + 0x11f6d9808d4cbf6fa8b06b9bc1dc470c6924abdb0b43d5aff8fc7139bcdbae91::math::mul_div_u256((v1 as u256), (1000000000000 as u256), (arg2.active_points as u256));
        arg2.last_claim_ts = 0x2::clock::timestamp_ms(arg0);
        arg2.total_distributed = arg2.total_distributed + v1;
        0x2::balance::join<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>(&mut arg2.honey_rewards, v0);
    }

    fun increment_honeyjar_rewards(arg0: &0x2::clock::Clock, arg1: &mut 0xc4b06322488dfe477e8071ff6d043745f185bddbd1d087cc91d962ab668301::honey_manager::HoneyManager, arg2: &mut MarketplaceChef, arg3: &mut HoneyJar) {
        increment_global_index(arg0, arg1, arg2);
        arg3.claimable_rewards = arg3.claimable_rewards + (0x11f6d9808d4cbf6fa8b06b9bc1dc470c6924abdb0b43d5aff8fc7139bcdbae91::math::mul_div_u256(arg2.global_claim_index - arg3.claim_index, (arg3.active_points as u256), (1000000000000 as u256)) as u64);
    ...
    public fun init_marketplace_chef(arg0: &mut HoneyJarAdminCap, arg1: 0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey_yield::ClaimHoneyCap, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = MarketplaceChef{
            ...
            claim_locked       : true,
            honey_rewards      : 0x2::balance::zero<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>(),
    ...
    public fun mint_honeyjar(arg0: &0x2::clock::Clock, arg1: &mut MarketplaceChef, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg3), arg3);
        let v2 = HoneyJar{
            ...
            claimable_amm_rewards : 0x2::balance::zero<0xbac22372b7fcc8a59874b9a541df297e751f34c666960395081964df9efff4bb::honey::HONEY>(),
    ...
    public fun remove_from_honeyjar(arg0: &HoneyJarPointsCap, arg1: &0x2::clock::Clock, arg2: &mut MarketplaceChef, arg3: &mut 0xc4b06322488dfe477e8071ff6d043745f185bddbd1d087cc91d962ab668301::honey_manager::HoneyManager, arg4: &mut HoneyJar, arg5: u64) {
        validation_check(arg2);
        box_validation_check(arg4);
        increment_honeyjar_rewards(arg1, arg3, arg2, arg4);
        arg2.active_points = arg2.active_points - arg5;
