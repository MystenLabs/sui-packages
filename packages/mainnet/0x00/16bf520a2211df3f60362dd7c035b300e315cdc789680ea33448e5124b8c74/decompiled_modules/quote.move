module 0x170fece09f519e982f5c9b17a18293efe7328dd685818b3082d12912b89ff490::quote {
    ...
    fun metastable_withdraw_out<T0, T1>(arg0: &0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::vault::Vault<T0>, arg1: &0x546b4c792de9744e08cb89f8f52b25cf5384db0af44f613db6d383234f009bb9::registry::Registry, arg2: u64) : u64 {
        ...
        let v3 = 0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::math::multiply_and_divide(arg2, v2, v1);
        if (v3 == 0) {
            return 0
        };
        let v4 = 0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::math::multiply_and_divide(v3, (0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::vault::min_fee(0xca653d2fac70a49549c7ff8792027fa4fa418fd6619954ea0f45d6fd0d081b8e::vault::borrow<T0>(arg0, 0x1::type_name::get<T1>())) as u128), v2);
        if (v4 >= v3) {
            0
        } else {
            v3 - v4
