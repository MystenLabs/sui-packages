module 0x5dd1fb9f784129f0815c8e54ed917ad698401c0900ebeb1525f37fac98a94dda::walrus_names {
    ...
    struct CapLinked has copy, drop {
        name: 0x1::string::String,
    ...
    public fun admin_link(arg0: &AdminCap, arg1: &mut Registry, arg2: vector<0x1::string::String>, arg3: vector<0x2::object::ID>) {
        assert!(arg1.version == 1, 14);
        let v0 = 0x1::vector::length<0x1::string::String>(&arg2);
        assert!(v0 == 0x1::vector::length<0x2::object::ID>(&arg3), 17);
        let v1 = 0;
        while (v1 < v0) {
            let v2 = *0x1::vector::borrow<0x1::string::String>(&arg2, v1);
            assert!(0x2::table::contains<0x1::string::String, NameRecord>(&arg1.records, v2), 6);
            let v3 = CapKey{name: v2};
            if (!0x2::dynamic_field::exists<CapKey>(&arg1.id, v3)) {
                write_cap_link(arg1, v2, *0x1::vector::borrow<0x2::object::ID>(&arg3, v1), false);
            };
            v1 = v1 + 1;
        };
    }
    ...
    public fun burn_ept<T0>(arg0: &mut WalNamesTreasury, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 14);
        assert!(0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"ept_type"), 15);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(v0 == *0x2::dynamic_field::borrow<vector<u8>, 0x1::type_name::TypeName>(&arg0.id, b"ept_type") || 0x2::dynamic_field::exists_with_type<vector<u8>, 0x2::balance::Balance<T0>>(&arg0.id, b"ept_balance"), 16);
        assert!(0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"ept_balance"), 18);
        let v1 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg0.id, b"ept_balance");
        let v2 = 0x2::balance::value<T0>(v1);
        assert!(v2 > 0, 18);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v1, v2), arg1), @0x0);
        let v3 = EptBurned{
            coin_type : v0,
            amount    : v2,
        };
        0x2::event::emit<EptBurned>(v3);
    }
    ...
    public fun cap_id_of(arg0: &Registry, arg1: 0x1::string::String) : 0x1::option::Option<0x2::object::ID> {
        let v0 = CapKey{name: arg1};
        if (0x2::dynamic_field::exists<CapKey>(&arg0.id, v0)) {
            0x1::option::some<0x2::object::ID>(*0x2::dynamic_field::borrow<CapKey, 0x2::object::ID>(&arg0.id, v0))
        } else {
    ...
    public fun ept_balance<T0>(arg0: &WalNamesTreasury) : u64 {
        if (0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"ept_balance")) {
            0x2::balance::value<T0>(0x2::dynamic_field::borrow<vector<u8>, 0x2::balance::Balance<T0>>(&arg0.id, b"ept_balance"))
        } else {
            0
        }
    }

    public fun ept_fee_base(arg0: &WalNamesTreasury) : u64 {
        if (0x2::dynamic_field::exists<vector<u8>>(&arg0.id, b"ept_fee_base")) {
            *0x2::dynamic_field::borrow<vector<u8>, u64>(&arg0.id, b"ept_fee_base")
        } else {
            0
        }
    }
    ...
    public fun is_linked(arg0: &Registry, arg1: 0x1::string::String) : bool {
        let v0 = CapKey{name: arg1};
        0x2::dynamic_field::exists<CapKey>(&arg0.id, v0)
    }
    ...
    public fun link_cap(arg0: &mut Registry, arg1: &NameCap) {
        assert!(arg0.version == 1, 14);
        write_cap_link(arg0, arg1.name, 0x2::object::id<NameCap>(arg1), true);
    }
    ...
    public fun register(arg0: &mut Registry, arg1: &mut WalNamesTreasury, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        write_cap_link(arg0, v7.name, 0x2::object::id<NameCap>(&v7), true);
        0x2::transfer::transfer<NameCap>(v7, v3);
    }

    public fun register_with_ept<T0>(arg0: &mut Registry, arg1: &mut WalNamesTreasury, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 14);
        assert!(arg1.version == 1, 14);
        assert!(0x2::dynamic_field::exists<vector<u8>>(&arg1.id, b"ept_type"), 15);
        assert!(0x1::type_name::with_defining_ids<T0>() == *0x2::dynamic_field::borrow<vector<u8>, 0x1::type_name::TypeName>(&arg1.id, b"ept_type"), 16);
        let v0 = 0x1::string::as_bytes(&arg2);
        let v1 = 0x1::vector::length<u8>(v0);
        let v2 = 0x1::string::length(&arg3);
        assert!(v1 >= 3, 1);
        ...
        validate_chars(v0);
        let v3 = 0x2::tx_context::sender(arg5);
        let v4 = registration_fee(*0x2::dynamic_field::borrow<vector<u8>, u64>(&arg1.id, b"ept_fee_base"), v1);
        assert!(0x2::coin::value<T0>(&arg4) >= v4, 4);
        if (0x2::dynamic_field::exists<vector<u8>>(&arg1.id, b"ept_balance")) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg1.id, b"ept_balance"), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg4, v4, arg5)));
        } else {
            0x2::dynamic_field::add<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg1.id, b"ept_balance", 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg4, v4, arg5)));
        };
        ...
        write_cap_link(arg0, v6.name, 0x2::object::id<NameCap>(&v6), true);
    ...
    public fun set_ept_config<T0>(arg0: &AdminCap, arg1: &mut WalNamesTreasury, arg2: u64) {
        assert!(arg1.version == 1, 14);
        if (0x2::dynamic_field::exists<vector<u8>>(&arg1.id, b"ept_type")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, 0x1::type_name::TypeName>(&mut arg1.id, b"ept_type") = 0x1::type_name::with_defining_ids<T0>();
        } else {
            0x2::dynamic_field::add<vector<u8>, 0x1::type_name::TypeName>(&mut arg1.id, b"ept_type", 0x1::type_name::with_defining_ids<T0>());
        };
        if (0x2::dynamic_field::exists<vector<u8>>(&arg1.id, b"ept_fee_base")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, u64>(&mut arg1.id, b"ept_fee_base") = arg2;
        } else {
            0x2::dynamic_field::add<vector<u8>, u64>(&mut arg1.id, b"ept_fee_base", arg2);
        };
    }
    ...
    public fun withdraw_ept<T0>(arg0: &AdminCap, arg1: &mut WalNamesTreasury, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 14);
        assert!(0x2::dynamic_field::exists<vector<u8>>(&arg1.id, b"ept_balance"), 15);
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg1.id, b"ept_balance");
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v0, 0x2::balance::value<T0>(v0)), arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    fun write_cap_link(arg0: &mut Registry, arg1: 0x1::string::String, arg2: 0x2::object::ID, arg3: bool) {
        let v0 = CapKey{name: arg1};
        let v1 = if (0x2::dynamic_field::exists<CapKey>(&arg0.id, v0)) {
            let v2 = 0x2::dynamic_field::borrow_mut<CapKey, 0x2::object::ID>(&mut arg0.id, v0);
            let v3 = *v2 != arg2;
            if (v3) {
                *v2 = arg2;
            };
            ...
            0x2::dynamic_field::add<CapKey, 0x2::object::ID>(&mut arg0.id, v0, arg2);
            true
        };
        if (v1) {
            let v4 = CapLinked{
