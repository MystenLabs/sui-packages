module 0x9a1bc73c5b610c4b9e3a40cc5ab90f951f8e3373fbeb2f15cb4140ceaaa50::pepeonsui {
    ...
    fun init(arg0: PEPEONSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PEPEONSUI>(arg0, 4, b"PepeOnSui", b"Pepe On Sui", b"PepeOnSui. The most memeable memecoin On Sui Blockchain. Telegram : t.me/Pepecoinsui , Twitter : https://twitter.com/pepecoin_sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
