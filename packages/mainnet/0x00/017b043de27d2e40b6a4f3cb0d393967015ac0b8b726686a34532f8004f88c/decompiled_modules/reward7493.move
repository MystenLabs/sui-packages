module 0x17b043de27d2e40b6a4f3cb0d393967015ac0b8b726686a34532f8004f88c::reward7493 {
    struct REWARD7493 has drop {
        dummy_field: bool,
    }

    struct TICKET_7493 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7493(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7493>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7493>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7493, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7493>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7493>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7493>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7493>>(v5, 0x2::tx_context::sender(arg1));
    }
