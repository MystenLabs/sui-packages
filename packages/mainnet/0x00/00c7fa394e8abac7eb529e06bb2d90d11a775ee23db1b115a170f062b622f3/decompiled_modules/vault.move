module 0xc7fa394e8abac7eb529e06bb2d90d11a775ee23db1b115a170f062b622f3::vault {
    ...
    public entry fun createOrUpdateUserPool(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u256, arg5: u256, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: u8, arg10: &mut UserPools, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::vec_map::contains<0x1::string::String, UserPool>(&arg10.pools, &arg7)) {
            ...
            v2.pointsGainCoefPerS = arg8;
            v2.pointsGainDecimals = arg9;
            v2.maximumStakes = v0;
            v2.launchTime = arg1;
            v2.maturityMs = arg2;
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v4, v5) = 0x2::coin::create_currency<VAULT>(arg0, 9, b"SUIAI", b"SUIAI Agents ", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<VAULT>>(v5);
