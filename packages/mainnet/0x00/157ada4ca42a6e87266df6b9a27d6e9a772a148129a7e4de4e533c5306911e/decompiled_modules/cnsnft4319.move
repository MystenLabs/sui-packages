module 0x157ada4ca42a6e87266df6b9a27d6e9a772a148129a7e4de4e533c5306911e::cnsnft4319 {
    struct CNSNFT4319 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4319, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4319>(arg0, arg1);
