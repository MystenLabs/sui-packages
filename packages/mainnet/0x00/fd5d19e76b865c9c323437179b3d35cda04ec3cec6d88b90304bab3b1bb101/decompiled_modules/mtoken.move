module 0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::mtoken {
    ...
    public fun cc_receive<T0>(arg0: &mut State<T0>, arg1: &MessengerCap, arg2: vector<u8>, arg3: &0x2::deny_list::DenyList, arg4: &mut 0x2::tx_context::TxContext) : (address, 0x1::option::Option<0x2::coin::Coin<T0>>) {
        ...
        let v0 = 0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::message_codec::decode_cc_message(arg2);
        if (0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::message_codec::is_mint_budget(&v0)) {
            let v3 = 0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::message_codec::extract_mint_budget(v0);
            ...
            assert!(0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::message_codec::is_token(&v0), 111);
            let (v5, v6, v7) = 0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::message_codec::extract_token_info(v0);
    ...
    public fun msg_of_cc_send_mint_budget(arg0: u64) : vector<u8> {
        0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::message_codec::encode_cc_mint_budget_message(arg0)
    }

    public fun msg_of_cc_send_token(arg0: address, arg1: vector<u8>, arg2: u64) : vector<u8> {
        0xfcc3a7785cee55c4e9e7a34efc865cd3dd3671544c914c756d56c27b9792413a::message_codec::encode_cc_token_message(arg0, arg1, arg2)
    }
