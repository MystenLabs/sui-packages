module 0xf977f2b39ca9d20e1b6efe8479327699aba0fd3ada911e6210e1fc7651920f::cnsnft3916 {
    struct CNSNFT3916 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3916, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3916>(arg0, arg1);
