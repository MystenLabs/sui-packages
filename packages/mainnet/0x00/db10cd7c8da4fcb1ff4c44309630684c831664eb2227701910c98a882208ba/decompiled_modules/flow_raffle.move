module 0xdb10cd7c8da4fcb1ff4c44309630684c831664eb2227701910c98a882208ba::flow_raffle {
    ...
    public entry fun create_raffle_with_kiosk_reference(arg0: address, arg1: address, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = ObjectNFTRef{
            id              : 0x2::object::new(arg9),
            nft_id          : 0x2::object::id_from_address(arg0),
            owner_object_id : 0x2::object::id_from_address(arg1),
            nft_type        : 0x1::string::utf8(arg2),
            verified_owner  : v0,
        };
        0x2::dynamic_object_field::add<vector<u8>, ObjectNFTRef>(&mut v2.id, b"object_ref", v3);
