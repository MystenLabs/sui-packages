module 0x8d0ed686cf4cb14ffa7c319890a0484d2074cdf933857070c0c9083bc61e91::honey_oracle {
    ...
    struct HoneyOracle has store, key {
        id: 0x2::object::UID,
        nectar_cap: 0x403f5ab973aa723635e07e8b98b1008a09ab4a8452c8af3c04e04e8142e53aa::honey_yield::NectarCap,
    ...
    public fun admin_update_emission_rate(arg0: &0x403f5ab973aa723635e07e8b98b1008a09ab4a8452c8af3c04e04e8142e53aa::honey_yield::HoneyYieldAdminCap, arg1: &mut HoneyOracle, arg2: &mut 0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::HoneyManager, arg3: &0x2::clock::Clock, arg4: u64) {
        assert!(arg1.module_version == 0, 1975);
        assert!(arg4 > 0, 1980);
        arg1.emission_state.current_emission_rate = arg4;
        0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::update_distribution_rate_via_nectar(&arg1.nectar_cap, arg2, arg3, arg1.emission_state.current_emission_rate);
    ...
    fun calculate_twap(arg0: u256, arg1: u256, arg2: u64) : u256 {
        let v0 = if (arg0 >= arg1) {
            ...
            0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::overflow_add_u256(arg0, 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::sub_from_max_u256(arg1))
        };
        if (v0 == 0) {
            return 0
        };
        0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(v0 / (arg2 as u256), (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::pow_10(6) as u256), (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::pow_10(9) as u256))
    }
    ...
    fun init(arg0: HONEY_ORACLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<HoneyOracle>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"HONEY Price Oracle"));
        0x2::display::add<HoneyOracle>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Time-weighted average price (TWAP) oracle for the SUI-HONEY trading pair. Provides reliable on-chain price feeds for the HoneyPlay protocol."));
        0x2::display::add<HoneyOracle>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://assets.honeyplay.fun/global_objects/honey_oracle.png"));
    ...
    public fun setup_honey_oracle(arg0: &0x403f5ab973aa723635e07e8b98b1008a09ab4a8452c8af3c04e04e8142e53aa::honey_yield::HoneyYieldAdminCap, arg1: 0x403f5ab973aa723635e07e8b98b1008a09ab4a8452c8af3c04e04e8142e53aa::honey_yield::NectarCap, arg2: &mut 0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::HoneyManager, arg3: &0x2::clock::Clock, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 > 0, 1980);
        ...
        0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::update_distribution_rate_via_nectar(&v3.nectar_cap, arg2, arg3, v3.emission_state.current_emission_rate);
    ...
    public fun trigger_epoch_update_if_due(arg0: &mut HoneyOracle, arg1: &mut 0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::HoneyManager, arg2: &0x2::clock::Clock) {
        assert!(arg0.module_version == 0, 1975);
    ...
    fun update_emission_distribution(arg0: &mut HoneyOracle, arg1: &mut 0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::HoneyManager, arg2: &0x2::clock::Clock, arg3: u256, arg4: u64) {
        ...
        let v4 = if (arg3 >= arg0.emission_state.anchor_price) {
            (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u128(((arg3 - arg0.emission_state.anchor_price) as u128), (10000 as u128), (arg0.emission_state.anchor_price as u128)) as u64)
        } else {
            (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u128(((arg0.emission_state.anchor_price - arg3) as u128), (10000 as u128), (arg0.emission_state.anchor_price as u128)) as u64)
        };
        ...
        let v7 = if (arg3 >= v6) {
            (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u128(((arg3 - v6) as u128), (10000 as u128), (v6 as u128)) as u64)
        } else {
            (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u128(((v6 - arg3) as u128), (10000 as u128), (v6 as u128)) as u64)
        };
        let v8 = 3;
        if (arg3 < v6 && v7 >= v0) {
            ...
            arg0.emission_state.current_emission_rate = (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u128((arg0.emission_state.current_emission_rate as u128), ((10000 - v10) as u128), (10000 as u128)) as u64);
            ...
            if (arg0.emission_state.consec_up_epochs >= arg0.emission_config.raise_confirm_epochs) {
                if (arg0.emission_state.weekly_raises_sum + v2 <= arg0.emission_config.max_weekly_raise_bps) {
                    arg0.emission_state.current_emission_rate = (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u128((arg0.emission_state.current_emission_rate as u128), ((10000 + v2) as u128), (10000 as u128)) as u64);
        ...
        arg0.emission_state.last_price = arg3;
        arg0.emission_state.last_epoch_update = arg4;
        0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::update_distribution_rate_via_nectar(&arg0.nectar_cap, arg1, arg2, arg0.emission_state.current_emission_rate);
    ...
    public fun update_honey_oracle(arg0: &0x403f5ab973aa723635e07e8b98b1008a09ab4a8452c8af3c04e04e8142e53aa::honey_yield::HoneyYieldAdminCap, arg1: &mut HoneyOracle, arg2: 0x1::option::Option<address>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 0, 1975);
    ...
    public fun update_honey_oracle_emission_config(arg0: &0x403f5ab973aa723635e07e8b98b1008a09ab4a8452c8af3c04e04e8142e53aa::honey_yield::HoneyYieldAdminCap, arg1: &mut HoneyOracle, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<u64>) {
        assert!(arg1.module_version == 0, 1975);
    ...
    public fun update_honey_oracle_price<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &mut HoneyOracle, arg2: &mut 0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::honey_manager::HoneyManager, arg3: &0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::amm::LiquidityPool<T0, T1, T2>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::amm::get_liquidity_pool_id<T0, T1, T2>(arg3);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_honey_pool_addr), 1974);
        let (_, v4, v5) = 0x15ac50726be9928bda9ab3f369aaf88d8c40d6605259cc49ee58734597f111c::amm::get_pool_cumulative_prices<T0, T1, T2>(arg3);
