module 0x1dbcb77bc73e6650338fac1c58d32a1a94a8e25d2fad758dfa792e81a04023::game8162 {
    struct GAME8162 has drop {
        dummy_field: bool,
    }

    struct TICKET_8162 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8162(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8162>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8162>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME8162, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8162>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8162>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8162>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8162>>(v5, 0x2::tx_context::sender(arg1));
    }
