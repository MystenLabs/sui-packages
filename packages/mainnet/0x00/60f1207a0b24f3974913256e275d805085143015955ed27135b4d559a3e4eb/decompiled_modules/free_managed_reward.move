module 0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::free_managed_reward {
    ...
    public fun borrow_reward(arg0: &FreeManagedReward) : &0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::reward::Reward {
        &arg0.reward
    }
    ...
    public(friend) fun get_reward<T0>(arg0: &mut FreeManagedReward, arg1: address, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::reward::get_reward_internal<T0>(&mut arg0.reward, &arg0.reward_cap, arg1, arg2, arg3, arg4);
    ...
    public fun notify_reward_amount<T0>(arg0: &mut FreeManagedReward, arg1: 0x1::option::Option<0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::WhitelistedToken>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::reward::rewards_contains(&arg0.reward, v0)) {
            assert!(0x1::option::is_some<0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::WhitelistedToken>(&arg1), 9223372389042094079);
            0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::validate<T0>(0x1::option::extract<0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::WhitelistedToken>(&mut arg1), voter(arg0));
        ...
        if (0x1::option::is_some<0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::WhitelistedToken>(&arg1)) {
            0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::validate<T0>(0x1::option::extract<0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::WhitelistedToken>(&mut arg1), voter(arg0));
        };
        0x1::option::destroy_none<0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::whitelisted_tokens::WhitelistedToken>(arg1);
    ...
    public fun rewards_list(arg0: &FreeManagedReward) : vector<0x1::type_name::TypeName> {
        0x60f1207a0b24f3974913256e275d805085143015955ed27135b4d559a3e4eb::reward::rewards_list(&arg0.reward)
    }
