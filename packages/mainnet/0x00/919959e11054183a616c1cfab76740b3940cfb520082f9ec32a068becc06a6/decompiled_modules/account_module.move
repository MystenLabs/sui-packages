module 0x919959e11054183a616c1cfab76740b3940cfb520082f9ec32a068becc06a6::account_module {
    ...
    public fun check_rate(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) : u64 {
        ...
        while (v6 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
            ...
            if (0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::type_name(v9) == 0x1::type_name::get<0x2::sui::SUI>()) {
                let v14 = v1 * 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::borrow_dynamics::interest_rate(v8)) / 1361925194 * (v0 - 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::revenue_factor(v9))) / v0;
                let v15 = APYEvent{apy: v14};
                0x2::event::emit<APYEvent>(v15);
                let v16 = APYEvent{apy: v14};
                0x2::event::emit<APYEvent>(v16);
                let v17 = v14 * v1 * v11 / (v10 + v11 - v12) / v1;
                let v18 = APYEvent{apy: v17};
