module 0xd5bf2f64a2dda43aa78e13a8360c6756a2ca28162e1dc9d47e36371c4d05c1::native_token_transfer {
    struct NativeTokenTransfer has copy, drop, store {
        amount: 0xd5bf2f64a2dda43aa78e13a8360c6756a2ca28162e1dc9d47e36371c4d05c1::trimmed_amount::TrimmedAmount,
    ...
    public fun to_bytes(arg0: NativeTokenTransfer) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v7, 0xd5bf2f64a2dda43aa78e13a8360c6756a2ca28162e1dc9d47e36371c4d05c1::trimmed_amount::to_bytes(&v6));
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : NativeTokenTransfer {
        assert!(0xd5bf2f64a2dda43aa78e13a8360c6756a2ca28162e1dc9d47e36371c4d05c1::bytes4::to_bytes(0xd5bf2f64a2dda43aa78e13a8360c6756a2ca28162e1dc9d47e36371c4d05c1::bytes4::take(arg0)) == x"994e5454", 13906834603840176130);
        ...
        NativeTokenTransfer{
            amount       : 0xd5bf2f64a2dda43aa78e13a8360c6756a2ca28162e1dc9d47e36371c4d05c1::trimmed_amount::new(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u64_be(arg0), 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u8(arg0)),
