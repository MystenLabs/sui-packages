module 0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::pool {
    ...
    public(friend) fun admin_withdraw_all_liquidity<T0>(arg0: &mut Vault<T0>) : 0x2::balance::Balance<T0> {
        0x2::balance::withdraw_all<T0>(&mut arg0.liquidity)
    }

    public(friend) fun admin_withdraw_liquidity<T0>(arg0: &mut Vault<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 > 0, 15);
        assert!(arg1 <= 0x2::balance::value<T0>(&arg0.liquidity), 3);
        0x2::balance::split<T0>(&mut arg0.liquidity, arg1)
    }
    ...
    public(friend) fun emergency_withdraw<T0>(arg0: &mut Vault<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 <= 0x2::balance::value<T0>(&arg0.liquidity), 3);
        0x2::balance::split<T0>(&mut arg0.liquidity, arg1)
    }
    ...
    public(friend) fun set_vault_weight<T0>(arg0: &mut Vault<T0>, arg1: u256) {
        arg0.weight = 0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::decimal::from_raw(arg1);
    }
