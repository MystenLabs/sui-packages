module 0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::market {
    ...
    public entry fun admin_withdraw_all_vault_liquidity<T0, T1>(arg0: &0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::admin::AdminCap, arg1: &mut Market<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = VaultName<T1>{dummy_field: false};
        let v1 = 0x2::tx_context::sender(arg2);
        pay_from_balance<T1>(0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::pool::admin_withdraw_all_liquidity<T1>(0x2::bag::borrow_mut<VaultName<T1>, 0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::pool::Vault<T1>>(&mut arg1.vaults, v0)), v1, arg2);
    }

    public entry fun admin_withdraw_vault_liquidity<T0, T1>(arg0: &0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::admin::AdminCap, arg1: &mut Market<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = VaultName<T1>{dummy_field: false};
        let v1 = 0x2::tx_context::sender(arg3);
        pay_from_balance<T1>(0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::pool::admin_withdraw_liquidity<T1>(0x2::bag::borrow_mut<VaultName<T1>, 0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::pool::Vault<T1>>(&mut arg1.vaults, v0), arg2), v1, arg3);
    }
    ...
    public entry fun emergency_withdraw<T0, T1>(arg0: &0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::admin::AdminCap, arg1: &mut Market<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = VaultName<T1>{dummy_field: false};
        let v1 = 0x2::tx_context::sender(arg3);
        pay_from_balance<T1>(0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::pool::emergency_withdraw<T1>(0x2::bag::borrow_mut<VaultName<T1>, 0xceab84acf6bf70f503c3b0627acaff6b3f84cee0f2d7ed53d00fa6c2a168d14f::pool::Vault<T1>>(&mut arg1.vaults, v0), arg2), v1, arg3);
    }
