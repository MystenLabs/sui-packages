module 0x3c4323c4f7411056492a3d5da7a360e8824c0d11211ec7440328d798835e852::raffle {
    ...
    public fun terminate_raffle<T0: store + key, T1>(arg0: &mut MarketplaceRaffle<T1>, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::tx_context::TxContext) : 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::TransferRequest<T0> {
        ...
        let v2 = 0x2::coin::from_balance<T1>(v1, arg4);
        0x2::coin::put<T1>(&mut arg0.fee_balance, 0x2::coin::split<T1>(&mut v2, 0x2::balance::value<T1>(&v1) * (arg0.fee as u64) / 10000, arg4));
        let v3 = 0x2::coin::into_balance<T1>(v2);
        let v4 = 0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::transfer_delegated<T0>(arg2, arg3, v0.item, &v0.id, 0x2::balance::value<T1>(&v3), arg4);
