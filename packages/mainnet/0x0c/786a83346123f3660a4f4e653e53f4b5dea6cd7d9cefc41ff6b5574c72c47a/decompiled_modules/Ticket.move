module 0xc786a83346123f3660a4f4e653e53f4b5dea6cd7d9cefc41ff6b5574c72c47a::Ticket {
    ...
    entry fun buyTicket(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &TicketPrice, arg2: &mut 0xc786a83346123f3660a4f4e653e53f4b5dea6cd7d9cefc41ff6b5574c72c47a::prizePool::PrizePool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0) > 0, 1);
        let v0 = 0xc786a83346123f3660a4f4e653e53f4b5dea6cd7d9cefc41ff6b5574c72c47a::prizePool::getPoolLevel(arg2);
        ...
        0xc786a83346123f3660a4f4e653e53f4b5dea6cd7d9cefc41ff6b5574c72c47a::prizePool::updateBalance(arg2, arg0);
        let v4 = BuyTicket{
