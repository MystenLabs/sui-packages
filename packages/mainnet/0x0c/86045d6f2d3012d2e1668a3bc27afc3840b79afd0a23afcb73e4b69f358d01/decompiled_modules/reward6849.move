module 0xc86045d6f2d3012d2e1668a3bc27afc3840b79afd0a23afcb73e4b69f358d01::reward6849 {
    struct REWARD6849 has drop {
        dummy_field: bool,
    }

    struct TICKET_6849 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6849(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6849>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6849>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6849, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6849>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6849>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6849>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6849>>(v5, 0x2::tx_context::sender(arg1));
    }
