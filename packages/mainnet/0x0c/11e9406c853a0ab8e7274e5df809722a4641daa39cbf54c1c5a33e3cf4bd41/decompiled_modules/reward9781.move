module 0xc11e9406c853a0ab8e7274e5df809722a4641daa39cbf54c1c5a33e3cf4bd41::reward9781 {
    struct REWARD9781 has drop {
        dummy_field: bool,
    }

    struct TICKET_9781 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9781(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9781>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9781>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9781, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9781>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9781>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9781>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9781>>(v5, 0x2::tx_context::sender(arg1));
    }
