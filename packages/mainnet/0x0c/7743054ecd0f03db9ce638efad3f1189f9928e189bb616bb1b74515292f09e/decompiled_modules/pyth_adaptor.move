module 0x5060fa94bc49945536eae3d46583d1d85dd3b1c549e5b83b48b0dfe9833ff404::pyth_adaptor {
    ...
    fun get_pyth_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &PythFeedData, arg2: &0x2::clock::Clock) : (u64, u64, u8, u64) {
        ...
        let v1 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_feed::get_ema_price(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::get_price_feed(&v0));
        ...
        let v4 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v1);
        ...
        assert_price_conf_within_range(v3, v4, arg1.conf_tolerance);
        (v3, v4, (v6 as u8), 0x2::clock::timestamp_ms(arg2) / 1000)
    }
    ...
    public(friend) fun refresh_pyth_price<T0>(arg0: &0x2::table::Table<0x1::type_name::TypeName, PythFeedData>, arg1: &mut 0x2::table::Table<0x1::type_name::TypeName, 0x5060fa94bc49945536eae3d46583d1d85dd3b1c549e5b83b48b0dfe9833ff404::price_feed::PriceFeed>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        ...
        assert!(v7 > 0, 70145);
        let v8 = if (v0 == 0x1::type_name::get<0x2::sui::SUI>()) {
            50
        } else {
            1
        };
        if (!0x2::table::contains<0x1::type_name::TypeName, 0x5060fa94bc49945536eae3d46583d1d85dd3b1c549e5b83b48b0dfe9833ff404::price_feed::PriceFeed>(arg1, v0)) {
            0x2::table::add<0x1::type_name::TypeName, 0x5060fa94bc49945536eae3d46583d1d85dd3b1c549e5b83b48b0dfe9833ff404::price_feed::PriceFeed>(arg1, v0, 0x5060fa94bc49945536eae3d46583d1d85dd3b1c549e5b83b48b0dfe9833ff404::price_feed::new(v7 / v8, v5));
        } else {
            0x5060fa94bc49945536eae3d46583d1d85dd3b1c549e5b83b48b0dfe9833ff404::price_feed::update(0x2::table::borrow_mut<0x1::type_name::TypeName, 0x5060fa94bc49945536eae3d46583d1d85dd3b1c549e5b83b48b0dfe9833ff404::price_feed::PriceFeed>(arg1, v0), v7 / v8, v5);
        };
    }
