module 0xcf92c2b27213fd485c52885dd20f89c16848b89755388e3c87bb8ccea199b91::gift4573 {
    struct GIFT4573 has drop {
        dummy_field: bool,
    }

    struct TICKET_4573 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4573(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4573>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4573>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4573, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4573>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4573>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4573>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4573>>(v5, 0x2::tx_context::sender(arg1));
    }
