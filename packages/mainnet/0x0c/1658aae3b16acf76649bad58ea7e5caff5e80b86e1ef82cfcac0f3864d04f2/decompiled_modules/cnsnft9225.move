module 0xc1658aae3b16acf76649bad58ea7e5caff5e80b86e1ef82cfcac0f3864d04f2::cnsnft9225 {
    struct CNSNFT9225 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9225, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9225>(arg0, arg1);
