module 0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::credenza_asset_collection {
    struct CollectionCap has store, key {
        ...
        ownership: 0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::ownership::CredenzaOwnership,
    }
    ...
    public fun add_asset(arg0: &mut CollectionCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg4));
    ...
    public fun buy_asset<T0>(arg0: &mut CollectionCap, arg1: &0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::sellable::CredenzaSellableConfig<CREDENZA_ASSET_COLLECTION>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::sellable::accept_asset_payment_coin<CREDENZA_ASSET_COLLECTION, T0>(arg1, arg3, arg2, arg5);
    ...
    fun init(arg0: CREDENZA_ASSET_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = CollectionCap{
            ...
            ownership   : 0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        };
        0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
        let v2 = CollectionCapCreated{id: 0x2::object::id<CollectionCap>(&v1)};
        0x2::event::emit<CollectionCapCreated>(v2);
        let (_, v4) = 0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::sellable::create_config<CREDENZA_ASSET_COLLECTION>(arg0, arg1);
        0x2::transfer::public_share_object<CollectionCap>(v1);
        0x2::transfer::public_share_object<0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::sellable::CredenzaSellableConfig<CREDENZA_ASSET_COLLECTION>>(v4);
    }
    ...
    public fun set_owner(arg0: &mut CollectionCap, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::ownership::set_owner(&mut arg0.ownership, arg1, arg2);
    }
    ...
    public fun update_metadata(arg0: &mut CollectionCap, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        0xcaa4008ed1143f7c1b3af9d7e43575de9f26e37fd780f25e434bd9627f4f9cf::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg5));
