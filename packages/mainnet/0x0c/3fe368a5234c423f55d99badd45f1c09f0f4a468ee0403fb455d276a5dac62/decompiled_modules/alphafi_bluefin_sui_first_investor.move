module 0x754afbce8c72c8e491e3b9d536aa9d9766fdbc68650224ce01072189b235eee3::alphafi_bluefin_sui_first_investor {
    ...
    public(friend) fun autocompound<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T2> {
        let v0 = autocompound_internal<T0, T1, T2, T3>(arg0, arg2, arg3, arg4, arg5, arg6);
        let v1 = (0x2::balance::value<T2>(&v0) as u128) * (arg0.performance_fee as u128) / 10000;
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut v0, (v1 as u64)), arg6), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
    ...
    fun autocompound_internal<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T2> {
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T3>(arg2)) {
            let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T3>(arg4, arg1, arg2, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
            update_free_rewards<T0, T1, T3>(arg0, v1);
        };
        let (_, _, v4, v5) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg4, arg1, arg2, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v6 = v5;
        let v7 = v4;
        ...
        if (v8 >= arg0.minimum_swap_amount) {
            ...
            let (v11, v12) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg4, arg1, arg2, 0x2::balance::zero<T0>(), v6, false, true, v8, 0, v10);
        ...
        let v13 = 0x2::coin::zero<T3>(arg5);
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T3>())) {
            0x2::coin::join<T3>(&mut v13, 0x2::coin::from_balance<T3>(0x2::balance::withdraw_all<T3>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T3>>(&mut arg0.free_rewards, 0x1::type_name::get<T3>())), arg5));
        };
        let v14 = 0x2::coin::value<T3>(&v13);
        if (v14 >= arg0.minimum_swap_amount) {
            let (_, v16) = get_bluefin_sqrt_price_limits<T2, T3>(arg3);
            let (v17, v18) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T3>(arg4, arg1, arg3, 0x2::balance::zero<T2>(), 0x2::coin::into_balance<T3>(v13), false, true, v14, 0, v16);
            0x2::balance::destroy_zero<T3>(v18);
            update_free_rewards<T0, T1, T2>(arg0, v17);
        } else {
            update_free_rewards<T0, T1, T3>(arg0, 0x2::coin::into_balance<T3>(v13));
        };
    ...
    public fun rebalance<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::RebalanceCap, arg2: &0x754afbce8c72c8e491e3b9d536aa9d9766fdbc68650224ce01072189b235eee3::version::Version, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: u32, arg6: u32, arg7: u32, arg8: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg9: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg10: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg3, arg8, arg5, arg6, arg13);
        ...
        let (v8, v9) = get_sqrt_price_limits<T0, T1>(arg8, arg9, arg11);
        ...
        while (v12 < arg7 + 1) {
            ...
            let (_, _, v15, v16) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg3, arg8, &mut v0, v10, arg12);
            let v17 = v16;
            let v18 = v15;
            ...
            let (v19, v20) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, arg3, arg4, v18, v17, arg8, arg9, v8, v9, arg11, arg12, arg13);
            let (_, v22, v23, v24) = get_balances_in_ratio<T0, T1>(arg0, v19, v20, arg8, true, arg13);
            let v25 = v23;
            let v26 = v22;
            if (0x2::balance::value<T0>(&v26) > 100 || 0x2::balance::value<T1>(&v25) > 100) {
                let (v27, v28) = if (0x2::balance::value<T0>(&v26) == 0 || v24 == false) {
                    let (v29, v30, v31, v32) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg12, arg3, arg8, &mut v1, v26, v25, 0x2::balance::value<T1>(&v25), false);
                    let _ = v30;
                    let _ = v29;
                    (v31, v32)
                } else {
                    let (v35, v36, v37, v38) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg12, arg3, arg8, &mut v1, v26, v25, 0x2::balance::value<T0>(&v26), true);
                    let _ = v36;
                    let _ = v35;
                    (v37, v38)
                };
        ...
        let v39 = autocompound_internal<T0, T1, T2, T3>(arg0, arg3, arg8, arg10, arg12, arg13);
        update_free_rewards<T0, T1, T2>(arg0, v39);
        close_position<T0, T1>(arg8, 0x2::dynamic_field::remove<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"), arg3, arg12);
        ...
        free_balance_settle<T0, T1>(arg0, arg3, arg4, arg8, arg9, arg11, arg12, arg13);
