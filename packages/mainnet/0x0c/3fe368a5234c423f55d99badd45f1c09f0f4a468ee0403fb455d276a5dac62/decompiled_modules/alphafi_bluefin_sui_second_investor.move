module 0x754afbce8c72c8e491e3b9d536aa9d9766fdbc68650224ce01072189b235eee3::alphafi_bluefin_sui_second_investor {
    ...
    public(friend) fun autocompound<T0, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xe1b45a0e641b9955a20aa0ad1c1f4ad86aad8afb07296d4085e349a50e90bdca::blue::BLUE> {
        let v0 = autocompound_internal<T0, T1, T2>(arg0, arg2, arg3, arg4, arg5);
    ...
    fun autocompound_internal<T0, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg4: &0x2::clock::Clock) : 0x2::balance::Balance<0xe1b45a0e641b9955a20aa0ad1c1f4ad86aad8afb07296d4085e349a50e90bdca::blue::BLUE> {
        let (_, _, v2, v3) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg4, arg1, arg2, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"));
        let v4 = v3;
        let v5 = v2;
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T0>(arg2)) {
            0x2::balance::join<T0>(&mut v5, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg4, arg1, arg2, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")));
        };
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, T1>(arg2)) {
            0x2::balance::join<T1>(&mut v4, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T1>(arg4, arg1, arg2, 0x2::dynamic_field::borrow_mut<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position")));
        };
        ...
        if (0x1::type_name::get<T0>() == 0x1::type_name::get<0xe1b45a0e641b9955a20aa0ad1c1f4ad86aad8afb07296d4085e349a50e90bdca::blue::BLUE>()) {
            ...
            if (v7 >= arg0.minimum_swap_amount) {
                let (_, v9) = get_bluefin_sqrt_price_limits<T0, T1>(arg2);
                let (v10, v11) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg4, arg1, arg2, 0x2::balance::zero<T0>(), v4, false, true, v7, 0, v9);
            ...
            let v12 = 0x2::balance::value<T0>(&v5);
            if (v12 >= arg0.minimum_swap_amount) {
                let (v13, _) = get_bluefin_sqrt_price_limits<T0, T1>(arg2);
                let (v15, v16) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg4, arg1, arg2, v5, 0x2::balance::zero<T1>(), true, true, v12, 0, v13);
                0x2::balance::destroy_zero<T0>(v15);
                0x2::balance::join<T1>(&mut v4, v16);
            } else {
                update_free_rewards<T0, T1, T0>(arg0, v5);
            };
            let v17 = 0x2::balance::value<T1>(&v4);
            if (v17 >= arg0.minimum_swap_amount) {
                let (_, v19) = get_bluefin_sqrt_price_limits<T2, T1>(arg3);
                let (v20, v21) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T1>(arg4, arg1, arg3, 0x2::balance::zero<T2>(), v4, false, true, v17, 0, v19);
                0x2::balance::destroy_zero<T1>(v21);
                update_free_rewards<T0, T1, T2>(arg0, v20);
            } else {
                update_free_rewards<T0, T1, T1>(arg0, v4);
            };
        };
    ...
    public fun rebalance<T0, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::RebalanceCap, arg2: &0x754afbce8c72c8e491e3b9d536aa9d9766fdbc68650224ce01072189b235eee3::version::Version, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: u32, arg6: u32, arg7: u32, arg8: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg9: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg10: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        let v39 = autocompound_internal<T0, T1, T2>(arg0, arg3, arg8, arg10, arg12);
