module 0xc2413e1efbce6aecb3c86ca097ab0edabfefecc984586a01553a808dcabc77f::cnsnft3351 {
    struct CNSNFT3351 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3351, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9708"));
        let v4 = 0x2::package::claim<CNSNFT3351>(arg0, arg1);
