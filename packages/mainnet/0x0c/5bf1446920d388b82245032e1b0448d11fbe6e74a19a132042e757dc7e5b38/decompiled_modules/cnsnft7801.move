module 0xc5bf1446920d388b82245032e1b0448d11fbe6e74a19a132042e757dc7e5b38::cnsnft7801 {
    struct CNSNFT7801 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7801, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4815"));
        let v4 = 0x2::package::claim<CNSNFT7801>(arg0, arg1);
