module 0xc1bad229be39512aa536b1ebda66fb45c8921e3fc913dfb3b95bf377a0aa661::doubleup_citizen {
    struct DOUBLEUP_CITIZEN has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"f5cd5aae-2a1e-4b66-a1fd-7bc8b93dffe8"),
        };
    ...
    fun init(arg0: DOUBLEUP_CITIZEN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DOUBLEUP_CITIZEN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"DoubleUp Citizen"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A citizen on the DoubleUp Island!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmPmNdHofDDpCC2qAKUReVussmKergGa8GyNakr96qNfz3"));
