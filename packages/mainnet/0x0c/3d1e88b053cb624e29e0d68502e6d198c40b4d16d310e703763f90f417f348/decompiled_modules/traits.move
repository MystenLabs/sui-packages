module 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits {
    ...
    public fun category_name(arg0: &TraitCollection, arg1: u64) : 0x1::string::String {
        0x1::vector::borrow<TraitCategory>(&arg0.categories, arg1).name
    }
    ...
    public fun category_total_weight(arg0: &TraitCollection, arg1: u64) : u64 {
        let v0 = &0x1::vector::borrow<TraitCategory>(&arg0.categories, arg1).options;
        let v1 = 0;
        let v2 = 0;
        while (v2 < 0x1::vector::length<TraitOption>(v0)) {
            v1 = v1 + 0x1::vector::borrow<TraitOption>(v0, v2).rarity_weight;
            v2 = v2 + 1;
        };
        v1
    }
    ...
    public fun option_name(arg0: &TraitCollection, arg1: u64, arg2: u64) : 0x1::string::String {
        0x1::vector::borrow<TraitOption>(&0x1::vector::borrow<TraitCategory>(&arg0.categories, arg1).options, arg2).name
    }
