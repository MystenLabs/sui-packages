module 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::nft {
    ...
    fun format_pct_hundredths(arg0: u64, arg1: u64) : vector<u8> {
        if (arg1 == 0) {
            return b"0.00"
        };
        let v0 = arg0 * 10000 / arg1;
        let v1 = v0 % 100;
        let v2 = 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::svg::u64_to_bytes(v0 / 100);
        0x1::vector::append<u8>(&mut v2, b".");
        if (v1 < 10) {
            0x1::vector::push_back<u8>(&mut v2, 48);
        };
        0x1::vector::append<u8>(&mut v2, 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::svg::u64_to_bytes(v1));
        v2
    }

    fun format_token_amount(arg0: u64, arg1: u8) : vector<u8> {
        let v0 = (arg1 as u64);
        if (v0 == 0) {
            return 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::svg::u64_to_bytes(arg0)
        };
        let v1 = 1;
        let v2 = 0;
        while (v2 < v0) {
        ...
        let v3 = arg0 % v1;
        let v4 = 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::svg::u64_to_bytes(arg0 / v1);
        if (v3 == 0) {
            return v4
        };
        let v5 = 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::svg::u64_to_bytes(v3);
        let v6 = 0x1::vector::length<u8>(&v5);
        let v7 = b"";
        if ((v6 as u64) < v0) {
            let v8 = 0;
            while (v8 < v0 - (v6 as u64)) {
                0x1::vector::push_back<u8>(&mut v7, 48);
                v8 = v8 + 1;
            };
        };
        0x1::vector::append<u8>(&mut v7, v5);
        while (0x1::vector::length<u8>(&v7) > 0 && *0x1::vector::borrow<u8>(&v7, 0x1::vector::length<u8>(&v7) - 1) == 48) {
            0x1::vector::pop_back<u8>(&mut v7);
        };
        if (0x1::vector::length<u8>(&v7) == 0) {
            return v4
        };
    ...
    entry fun mint<T0>(arg0: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::config::GlobalConfig, arg1: &mut 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::Launch<T0>, arg2: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::TraitCollection, arg3: &0x2::random::Random, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = do_mint<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        0x2::transfer::public_transfer<SuiArtNFT>(v0, 0x2::tx_context::sender(arg6));
    }
    ...
    entry fun mint_final<T0>(arg0: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::config::GlobalConfig, arg1: &mut 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::Launch<T0>, arg2: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::TraitCollection, arg3: &0x2::random::Random, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::phronis_amm::PhronisRegistry, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = do_mint<T0>(arg0, arg1, arg2, arg3, arg4, arg6, arg7);
        0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::locked_lp::do_settle<T0>(arg5, arg1, arg6, arg7);
        0x2::transfer::public_transfer<SuiArtNFT>(v0, 0x2::tx_context::sender(arg7));
    }

    entry fun mint_final_v2<T0>(arg0: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::config::GlobalConfig, arg1: &mut 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::Launch<T0>, arg2: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::TraitCollection, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::random::Random, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::phronis_amm::PhronisRegistry, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::nft_count<T0>(arg1) + 1 == 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::max_supply<T0>(arg1), 209);
        let v0 = do_mint<T0>(arg0, arg1, arg2, arg4, arg5, arg7, arg8);
        let v1 = &mut v0;
        populate_metadata_inner<T0>(v1, arg2, arg3);
        0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::locked_lp::do_settle<T0>(arg6, arg1, arg7, arg8);
        0x2::transfer::public_transfer<SuiArtNFT>(v0, 0x2::tx_context::sender(arg8));
    }

    entry fun mint_v2<T0>(arg0: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::config::GlobalConfig, arg1: &mut 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::Launch<T0>, arg2: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::TraitCollection, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::random::Random, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::nft_count<T0>(arg1) + 1 < 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::launch::max_supply<T0>(arg1), 208);
        let v0 = do_mint<T0>(arg0, arg1, arg2, arg4, arg5, arg6, arg7);
        let v1 = &mut v0;
        populate_metadata_inner<T0>(v1, arg2, arg3);
        0x2::transfer::public_transfer<SuiArtNFT>(v0, 0x2::tx_context::sender(arg7));
    }
    ...
    entry fun populate_metadata<T0>(arg0: &mut SuiArtNFT, arg1: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::TraitCollection, arg2: &0x2::coin::CoinMetadata<T0>) {
        populate_metadata_inner<T0>(arg0, arg1, arg2);
    }

    fun populate_metadata_inner<T0>(arg0: &mut SuiArtNFT, arg1: &0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::TraitCollection, arg2: &0x2::coin::CoinMetadata<T0>) {
        assert!(0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::id(arg1) == arg0.trait_collection_id, 206);
        let v0 = strip_metadata_block(&arg0.description);
        0x1::vector::append<u8>(&mut v0, x"0a0a2d2d2d20537569417274204d65746164617461202d2d2d");
        0x1::vector::append<u8>(&mut v0, x"0a");
        let v1 = 0x2::coin::get_symbol<T0>(arg2);
        0x1::vector::append<u8>(&mut v0, b"Allocation: ");
        0x1::vector::append<u8>(&mut v0, format_token_amount(arg0.token_allocation, 0x2::coin::get_decimals<T0>(arg2)));
        0x1::vector::append<u8>(&mut v0, b" ");
        0x1::vector::append<u8>(&mut v0, *0x1::ascii::as_bytes(&v1));
        0x1::vector::append<u8>(&mut v0, x"0a0a5472616974733a0a");
        let v2 = &arg0.trait_indices;
        let v3 = 0;
        while (v3 < 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::num_categories(arg1) && v3 < 0x1::vector::length<u8>(v2)) {
            let v4 = (*0x1::vector::borrow<u8>(v2, v3) as u64);
            let v5 = 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::category_name(arg1, v3);
            let v6 = 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::option_name(arg1, v3, v4);
            0x1::vector::append<u8>(&mut v0, b"- ");
            0x1::vector::append<u8>(&mut v0, *0x1::string::as_bytes(&v5));
            0x1::vector::append<u8>(&mut v0, b": ");
            0x1::vector::append<u8>(&mut v0, *0x1::string::as_bytes(&v6));
            0x1::vector::append<u8>(&mut v0, b" (");
            0x1::vector::append<u8>(&mut v0, format_pct_hundredths(0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::get_rarity_weight(arg1, v3, v4), 0x7dcf92bed26dcef98a3909fef2391ac8f984a5925723471af23e51f512178a1f::traits::category_total_weight(arg1, v3)));
            0x1::vector::append<u8>(&mut v0, x"25290a");
            v3 = v3 + 1;
        };
        arg0.description = 0x1::string::utf8(v0);
    }

    fun strip_metadata_block(arg0: &0x1::string::String) : vector<u8> {
        let v0 = 0x1::string::as_bytes(arg0);
        let v1 = 0x1::vector::length<u8>(v0);
        let v2 = x"0a0a2d2d2d20537569417274204d65746164617461202d2d2d";
        let v3 = 0x1::vector::length<u8>(&v2);
        let v4 = b"";
        if (v3 == 0 || v1 < v3) {
            let v5 = 0;
        ...
        while (v6 + v3 <= v1) {
            ...
            let v8 = 0;
            while (v8 < v3) {
                if (*0x1::vector::borrow<u8>(v0, v6 + v8) != *0x1::vector::borrow<u8>(&v2, v8)) {
                    v7 = false;
                    break
                };
                v8 = v8 + 1;
            ...
            0x1::vector::push_back<u8>(&mut v4, *0x1::vector::borrow<u8>(v0, v6));
            v6 = v6 + 1;
        };
        while (v6 < v1) {
            0x1::vector::push_back<u8>(&mut v4, *0x1::vector::borrow<u8>(v0, v6));
