module 0xc5c14a7cde5d50ced153e1169f7132a68c0bee431911ac09d22073b13e0c624::pepesui {
    ...
    public entry fun mint(arg0: &mut 0x2::coin::TreasuryCap<PEPESUI>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::supply_value<PEPESUI>(0x2::coin::supply<PEPESUI>(arg0)) + arg1 <= 42000000000000, 1);
