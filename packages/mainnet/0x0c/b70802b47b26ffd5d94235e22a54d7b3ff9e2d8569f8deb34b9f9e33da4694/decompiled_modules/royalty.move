module 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty {
    ...
    public entry fun add_collection_share<T0>(arg0: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<T0>, arg1: address, arg2: u16, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun add_share(arg0: &mut RoyaltyDomain, arg1: address, arg2: u16, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = *v1 - arg2;
        if (*v1 == 0) {
            let (_, _) = 0x2::vec_map::remove<address, u16>(&mut arg0.royalty_shares_bps, &v0);
        };
    ...
    public entry fun remove_collection_share<T0>(arg0: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Witness{dummy_field: false};
        let v1 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::borrow_domain_mut<T0, RoyaltyDomain>(0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<RoyaltyDomain, Witness>(v0), arg0);
