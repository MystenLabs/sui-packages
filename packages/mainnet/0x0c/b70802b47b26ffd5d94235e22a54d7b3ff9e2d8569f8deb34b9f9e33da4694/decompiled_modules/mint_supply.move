module 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_supply {
    struct MintSupply<phantom T0> has store {
        frozen: bool,
        mint_cap: 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<T0>,
        supply: 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::utils_supply::Supply,
    }

    public fun new<T0>(arg0: 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<T0>, arg1: u64, arg2: bool) : MintSupply<T0> {
        MintSupply<T0>{
            frozen   : arg2,
            mint_cap : arg0,
    ...
    public fun delegate<T0>(arg0: &mut MintSupply<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<T0> {
        0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::utils_supply::increment(&mut arg0.supply, arg1);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::split<T0>(&mut arg0.mint_cap, arg1, arg2)
    }
    ...
    public fun delegate_and_transfer<T0>(arg0: &mut MintSupply<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<T0>>(v0, arg2);
        0x2::object::id<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<T0>>(&v0)
    }

    public fun delete<T0>(arg0: MintSupply<T0>) : 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<T0> {
        assert_not_frozen<T0>(&arg0);
        let MintSupply {
            frozen   : _,
            mint_cap : v1,
    ...
    public fun merge_delegated<T0>(arg0: &mut MintSupply<T0>, arg1: 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<T0>) {
        0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::utils_supply::decrement(&mut arg0.supply, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::supply<T0>(&arg1));
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::merge<T0>(&mut arg0.mint_cap, arg1);
    }
