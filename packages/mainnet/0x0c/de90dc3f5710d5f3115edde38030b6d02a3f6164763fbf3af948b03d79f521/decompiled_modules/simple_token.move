module 0xcde90dc3f5710d5f3115edde38030b6d02a3f6164763fbf3af948b03d79f521::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"MAGA@TRUMP", b"MAGA@TRUMP", b"Official token. Banner on Dexscreener paid!", 0x1::option::none<0x2::url::Url>(), arg1);
