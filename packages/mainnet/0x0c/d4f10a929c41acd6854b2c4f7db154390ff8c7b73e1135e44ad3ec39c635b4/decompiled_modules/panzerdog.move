module 0x41c06da395bc3f0ee621a66082f8f30f376da41a2db7bcce7c087444de200e41::panzerdog {
    ...
    public fun alter_dog_attributes_kiosk(arg0: &0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::Policy<0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::WithNft<Panzerdog, 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::borrow_request::BORROW_REQ>>, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &0x41c06da395bc3f0ee621a66082f8f30f376da41a2db7bcce7c087444de200e41::verifier::Signer, arg6: vector<u8>, arg7: u8, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::borrow_request::borrow_nft_ref_mut<0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::Witness, Panzerdog>(0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<Panzerdog, Witness>(v2), &mut v3).attributes = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::from_vec(arg3, arg4);
        0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::return_nft<Witness, Panzerdog>(arg1, v3, arg0);
    }

    public(friend) fun alter_dog_attributes_staked_friend(arg0: &mut Panzerdog, arg1: vector<0x1::ascii::String>, arg2: vector<0x1::ascii::String>) {
        arg0.attributes = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::from_vec(arg1, arg2);
    }
    ...
    public(friend) fun borrow_dog_uid_mut(arg0: &mut Panzerdog) : &mut 0x2::object::UID {
        &mut arg0.id
    }
    ...
    public fun create_new_mint_cap(arg0: &0x2::package::Publisher, arg1: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Panzerdog>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::display::is_authorized<Panzerdog>(arg0), 2);
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<Panzerdog>>(0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::split<Panzerdog>(arg1, arg2, arg4), arg3);
    }

    public(friend) fun emit_equip_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address) {
        let v0 = EquipEvent{
            dog_id       : arg0,
            equipment_id : arg1,
            sender       : arg2,
    ...
    public(friend) fun emit_unequip_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: address) {
        let v0 = UnequipEvent{
            dog_id       : arg0,
            equipment_id : arg1,
            sender       : arg2,
    ...
    public(friend) fun mutate_dog_image_staked_friend(arg0: &mut Panzerdog, arg1: 0x1::string::String, arg2: 0x1::string::String) {
    ...
    public(friend) fun withdraw_panzerdog(arg0: &0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::Policy<0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::request::WithNft<Panzerdog, 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::withdraw_request::WITHDRAW_REQ>>, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::tx_context::TxContext) : Panzerdog {
        let (v0, v1) = 0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::withdraw_nft_signed<Panzerdog>(arg2, arg1, arg3);
        let v2 = v1;
        let v3 = &mut v2;
        confirm_withdrawal<Panzerdog>(v3);
        0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::withdraw_request::confirm<Panzerdog>(v2, arg0);
        v0
    }
