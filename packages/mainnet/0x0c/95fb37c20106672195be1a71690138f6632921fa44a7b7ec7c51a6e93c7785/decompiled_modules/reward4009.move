module 0xc95fb37c20106672195be1a71690138f6632921fa44a7b7ec7c51a6e93c7785::reward4009 {
    struct REWARD4009 has drop {
        dummy_field: bool,
    }

    struct TICKET_4009 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4009(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4009>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4009>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4009, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4009>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4009>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4009>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4009>>(v5, 0x2::tx_context::sender(arg1));
    }
