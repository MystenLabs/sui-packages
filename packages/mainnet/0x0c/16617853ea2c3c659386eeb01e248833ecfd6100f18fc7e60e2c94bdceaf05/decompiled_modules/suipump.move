module 0xc16617853ea2c3c659386eeb01e248833ecfd6100f18fc7e60e2c94bdceaf05::suipump {
    struct SUIPUMP has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIPUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIPUMP>(arg0, 9, b"ONE", b"JustOneSui", b"Just One Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/VwGpbaZ.jpeg")), arg1);
        let v2 = v0;
