module 0xc31e7c6c8e22e9fb7d0f3f4beb862474dfbfc74fa90a4efccc97178adaefbfd::suid {
    ...
    fun init(arg0: SUID, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUID>(arg0, 9, b"Pepe", b"PepeCoin", b"PepeCoinn", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://www.interestprotocol.com")), arg1);
