module 0xca3f099e35108de4625833017993b8c398e304d9ac9597fba986064be1d5a0f::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<MyNft>(&mut v1, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"example.com"));
