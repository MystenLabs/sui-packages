module 0xca0b5304b4c74c15ca1e3590cd981aa2215fc672b98ffb64927b7e1b7c63f32::registry {
    ...
    public fun bank_id(arg0: &BankData) : 0x2::object::ID {
        arg0.bank_id
    }

    public fun btoken_type(arg0: &BankData) : 0x1::type_name::TypeName {
        arg0.btoken_type
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            extension_fields : 0x2::bag::new(arg0),
        };
        0x2::transfer::share_object<Registry>(v0);
    }

    public fun lending_market_id(arg0: &BankData) : 0x2::object::ID {
        arg0.lending_market_id
    }

    public(friend) fun register_bank(arg0: &mut Registry, arg1: 0x2::object::ID, arg2: 0x1::type_name::TypeName, arg3: 0x1::type_name::TypeName, arg4: 0x2::object::ID) {
        let v0 = BankKey{
    ...
    public fun set_fee_receivers(arg0: &mut Registry, arg1: &0xca0b5304b4c74c15ca1e3590cd981aa2215fc672b98ffb64927b7e1b7c63f32::global_config::GlobalConfig, arg2: vector<address>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        0xca0b5304b4c74c15ca1e3590cd981aa2215fc672b98ffb64927b7e1b7c63f32::global_config::check_package_version(arg1);
        0xca0b5304b4c74c15ca1e3590cd981aa2215fc672b98ffb64927b7e1b7c63f32::global_config::check_fee_manager_role(arg1, 0x2::tx_context::sender(arg4));
