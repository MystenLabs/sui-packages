module 0x6f6914a54e93ee3a861c7b32e9a17aa337795bb5ea19ca1e91e1557e6ce94fa6::ndlptest {
    ...
    public fun burn<T0>(arg0: &mut 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::coin::burn<T0>(arg0, arg1);
    }

    public fun deny_list_v2_add<T0>(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::deny_list_v2_add<T0>(arg0, arg1, arg2, arg3);
    }

    public fun deny_list_v2_remove<T0>(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCapV2<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::deny_list_v2_remove<T0>(arg0, arg1, arg2, arg3);
    }
