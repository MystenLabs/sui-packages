module 0xcb3cf3dd24778a40e49c35fca66068f904c1379372252bab3409b2e728ca27b::cnsnft8745 {
    struct CNSNFT8745 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8745, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8745>(arg0, arg1);
