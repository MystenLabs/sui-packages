module 0xc4320df013efd1bb78ef55dab83f67f23410dbaf2adf5c9483bc6719c1fa085::cnsnft9566 {
    struct CNSNFT9566 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9566, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9566>(arg0, arg1);
