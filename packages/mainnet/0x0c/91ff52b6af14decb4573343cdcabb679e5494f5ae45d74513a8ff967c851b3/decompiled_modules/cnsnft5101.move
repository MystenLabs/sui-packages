module 0xc91ff52b6af14decb4573343cdcabb679e5494f5ae45d74513a8ff967c851b3::cnsnft5101 {
    struct CNSNFT5101 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5101, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5101>(arg0, arg1);
