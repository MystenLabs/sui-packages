module 0xc12ade5a9c76c4b4dcc2bb81f724daf5cbd95737e4db3bb60caddf6fda7a7d6::reward9059 {
    struct REWARD9059 has drop {
        dummy_field: bool,
    }

    struct TICKET_9059 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9059(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9059>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9059>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9059, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9059>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9059>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9059>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9059>>(v5, 0x2::tx_context::sender(arg1));
    }
