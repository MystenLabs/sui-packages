module 0xcb7b0d70c05a72d5e7360284c046b4c3801f9a39d55a114d7e0ee9b13e350b1::incentive_new {
    ...
    public fun add_funds<T0>(arg0: &OwnerCap, arg1: &mut IncentiveFundsPool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = IncreasedFunds{
            ...
            balance_after  : 0x2::balance::join<T0>(&mut arg1.balance, 0x65d3b958fe52dad6ef61fbce9368877312a319957eab3d6946796079af862030::utils::split_coin_to_balance<T0>(arg2, arg3, arg4)),
        };
    ...
    public fun calculate_user_effective_amount(arg0: u8, arg1: u256, arg2: u256, arg3: u256) : u256 {
        ...
        let v2 = 0x65d3b958fe52dad6ef61fbce9368877312a319957eab3d6946796079af862030::ray_math::ray_mul(arg3, arg2);
        if (arg1 > v2) {
            return arg1 - v2
        };
        0
    ...
    public entry fun claim_reward<T0>(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut IncentiveFundsPool<T0>, arg3: &mut 0x65d3b958fe52dad6ef61fbce9368877312a319957eab3d6946796079af862030::storage::Storage, arg4: u8, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 > 0) {
            ...
            let v8 = (((v6 - v7) / 0x65d3b958fe52dad6ef61fbce9368877312a319957eab3d6946796079af862030::ray_math::ray()) as u64);
            let v9 = v8;
    ...
    fun update_reward_one(arg0: &0x2::clock::Clock, arg1: &mut IncentivePool, arg2: u256, arg3: address, arg4: u256) {
        ...
        let v2 = arg1.index_reward + 0x65d3b958fe52dad6ef61fbce9368877312a319957eab3d6946796079af862030::safe_math::div(0x65d3b958fe52dad6ef61fbce9368877312a319957eab3d6946796079af862030::safe_math::mul((calculate_release_rate(arg1) as u256), ((v1 - arg1.last_update_at) as u256)), arg2);
