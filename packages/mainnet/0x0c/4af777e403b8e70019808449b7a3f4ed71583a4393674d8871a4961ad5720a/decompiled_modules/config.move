module 0xba5196bb564ef37fb864ff86cd059447086998db541ea7caf8c687f87a7601f6::config {
    ...
    public(friend) fun assert_global_close_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_close_pause, 0xba5196bb564ef37fb864ff86cd059447086998db541ea7caf8c687f87a7601f6::errors::err_global_close_paused());
    }

    public(friend) fun assert_global_open_not_paused(arg0: &GlobalConfig) {
        assert!(!arg0.is_open_pause, 0xba5196bb564ef37fb864ff86cd059447086998db541ea7caf8c687f87a7601f6::errors::err_global_open_paused());
    }

    public(friend) fun assert_package_version(arg0: &GlobalConfig) {
        assert!(check_package_version(arg0), 0xba5196bb564ef37fb864ff86cd059447086998db541ea7caf8c687f87a7601f6::errors::err_wrong_version());
    }
