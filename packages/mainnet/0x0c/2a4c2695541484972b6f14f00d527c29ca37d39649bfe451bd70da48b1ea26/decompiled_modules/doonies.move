module 0x9f48e186b1527bd164960a03f392c14669acfd1ef560fb6138ad0918e6e712a3::doonies {
    ...
    public entry fun mint_all(arg0: &mut NFTCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<NFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 || v4, 6);
        let v6 = v3 + v5;
        let v7 = v3 * 5000000000 + v5 * 7000000000;
        assert!(v6 > 0, 7);
        if (v2 && v3 > 0) {
            assert!(arg0.phase1_minted + v3 <= 800, 15);
        };
        if (v4 && v5 > 0) {
            assert!(arg0.phase2_minted + v5 <= 3539, 15);
        };
        assert!(arg0.minted + v6 <= 4444, 1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= v7, 8);
        let v8 = 0;
        if (v2 && v3 > 0) {
            while (v8 < v3) {
                let v9 = select_random_id(arg0, arg4, arg7);
                let v10 = create_nft(arg0, v9, arg7);
                arg0.minted = arg0.minted + 1;
                arg0.phase1_minted = arg0.phase1_minted + 1;
                0x2::kiosk::lock<NFT>(arg5, arg6, arg2, v10);
                let v11 = NFTMinted{
                    nft_id   : 0x2::object::id<NFT>(&v10),
                    token_id : v9,
                    minter   : v0,
                    phase    : 1,
                };
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v7, arg7), arg0.treasury_address);
