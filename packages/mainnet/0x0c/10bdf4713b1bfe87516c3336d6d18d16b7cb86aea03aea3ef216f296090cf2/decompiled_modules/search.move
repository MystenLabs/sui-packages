module 0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::search {
    ...
    public fun find_optimal_cetus<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u64, arg4: u64, arg5: u8, arg6: u8) : u64 {
        ...
        while (v3 < arg5) {
            ...
            let v4 = 0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::simulate_swap<T0, T1>(arg0, arg1, v2);
            if (0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::sim_exceeded(&v4)) {
                break
            };
            let v5 = 0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::sim_total_cost(&v4);
            let v6 = 0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::sim_amount_out(&v4);
            if (v6 == 0 || v5 == 0) {
                break
            };
        ...
        while (v3 < arg6) {
            ...
            let v7 = (v1 + v2) / 2;
            let v8 = 0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::simulate_swap<T0, T1>(arg0, arg1, v7);
            let v9 = 0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::sim_total_cost(&v8);
            let v10 = 0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::sim_amount_out(&v8);
            let v11 = if (v10 > 0) {
                if (v9 > 0) {
                    !0xc10bdf4713b1bfe87516c3336d6d18d16b7cb86aea03aea3ef216f296090cf2::sim_cetus::sim_exceeded(&v8)
                } else {
                    false
                }
            } else {
