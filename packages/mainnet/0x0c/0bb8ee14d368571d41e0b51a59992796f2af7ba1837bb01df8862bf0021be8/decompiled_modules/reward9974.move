module 0xc0bb8ee14d368571d41e0b51a59992796f2af7ba1837bb01df8862bf0021be8::reward9974 {
    struct REWARD9974 has drop {
        dummy_field: bool,
    }

    struct TICKET_9974 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9974(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9974>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9974>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9974, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9974>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9974>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9974>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9974>>(v5, 0x2::tx_context::sender(arg1));
    }
