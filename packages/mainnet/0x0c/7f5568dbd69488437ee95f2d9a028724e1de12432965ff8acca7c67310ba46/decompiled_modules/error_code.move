module 0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::error_code {
    public fun add_existing_subscriber_to_whitelist() : u64 {
        1102
    }
    ...
    public fun remove_non_existing_subscriber_from_whitelist() : u64 {
        1103
    }
    ...
    public fun subscriber_not_whitelisted() : u64 {
        1104
    }

    public fun subscribers_not_notified() : u64 {
        1101
    }
