module 0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::ve_sca_subscriber {
    ...
    public(friend) fun add_subscriber_to_whitelist<T0: drop>(arg0: &mut VeScaSubscriberWhitelist) {
        ...
        assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelist, &v0), 0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::error_code::add_existing_subscriber_to_whitelist());
    ...
    public fun assert_subscriber_whitelisted<T0: drop>(arg0: &VeScaSubscriberWhitelist) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelist, &v0), 0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::error_code::subscriber_not_whitelisted());
    }
    ...
    public(friend) fun remove_subscriber<T0: drop>(arg0: &mut VeScaSubscriberWhitelist) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.whitelist, &v0), 0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::error_code::remove_non_existing_subscriber_from_whitelist());
