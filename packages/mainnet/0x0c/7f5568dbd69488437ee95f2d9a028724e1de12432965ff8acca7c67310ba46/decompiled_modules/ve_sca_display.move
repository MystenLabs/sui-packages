module 0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::ve_sca_display {
    ...
    fun init(arg0: VE_SCA_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::ve_sca::VeScaKey>(&v0, v1, v3, arg1);
        0x2::display::update_version<0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::ve_sca::VeScaKey>(&mut v5);
        let v6 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, v6);
        0x2::transfer::public_transfer<0x2::display::Display<0xc7f5568dbd69488437ee95f2d9a028724e1de12432965ff8acca7c67310ba46::ve_sca::VeScaKey>>(v5, v6);
    }
