module 0xca23687b10d8b4a6ece28f4b040e79ad35f88232c9a03a220ae038ea7e23e3c::delorean_ev {
    struct DELOREAN_EV has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"70b39f8d-cdc7-4d61-82f8-609574616bb9"),
        };
    ...
    fun init(arg0: DELOREAN_EV, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DELOREAN_EV>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Delorean EV"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The DeLorean EV NFT is associated with the  concept where each NFT represents a production slot."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmYGCdHJfCMPbBGAbQrmRuAoSeRQMN232enuddHCQBK3uG"));
