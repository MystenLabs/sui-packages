module 0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::kiosk_bidding_house_dynamic_royalty {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x2::clock::timestamp_ms(arg5);
        assert!(0x2::object::id<0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v30, v31), arg6), 0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::get_owner(arg1));
    ...
    public entry fun add_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg2: address, arg3: u16, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        assert!(0x2::object::id<0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::get_owner(arg1) == v0, 1);
    ...
    public fun buyout_nft_with_custom_royalty<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v40, arg8), 0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::get_owner(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg5, v9);
        (v42, v44)
    }

    public fun buyout_nft_with_custom_royalty_manual<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        let v39 = v2 - v6;
        if (v39 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v39, arg7), v0);
        };
        let v40 = calculate_fee(v6, v7);
        let v41 = if (v12 && v13 > 0) {
            0x2::coin::split<T1>(&mut arg5, v13, arg7)
        } else {
            0x2::coin::zero<T1>(arg7)
        };
        let (v42, v43) = 0x2::kiosk::purchase_with_cap<T0>(arg3, v30, 0x2::coin::zero<0x2::sui::SUI>(arg7));
        0x2::object::delete(v26);
        if (v12 && v13 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v41, v14);
            let v44 = CustomRoyaltyPaid{
                listing_id       : arg2,
                collection_type  : v11,
                collection_owner : v14,
                royalty_amount   : v13,
            ...
            0x2::event::emit<CustomRoyaltyPaid>(v44);
        } else {
            0x2::coin::destroy_zero<T1>(v41);
        };
        let v45 = ListingCompleted{
            listing_id      : arg2,
            seller          : v9,
            winner          : v0,
            final_price     : v6,
        ...
        0x2::event::emit<ListingCompleted>(v45);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v40, arg7), 0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::get_owner(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg5, v9);
        (v42, v43)
    }
    ...
    public entry fun create_and_share_kiosk_bidding_store(arg0: &0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Kiosk_Bidding_Store>(create_kiosk_bidding_store(arg0, arg1));
    }

    public fun create_kiosk_bidding_store(arg0: &0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Bidding_Store {
        let v0 = 0x2::object::new(arg1);
        let v1 = Kiosk_Bidding_Store{
            id               : v0,
            auction_house    : 0x2::object::id<0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse>(arg0),
    ...
    public entry fun emergency_recover_nft<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: 0x1::string::String, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg7);
        assert!(0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::get_owner(arg1) == v0, 1);
        assert!(0x2::object::id<0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
    ...
    public entry fun remove_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::object::id<0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::get_owner(arg1) == v0, 1);
        let v1 = get_collection_type<T0>();
    ...
    public entry fun update_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse, arg2: address, arg3: u16, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        assert!(0x2::object::id<0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(0xcc28abe783ff9f551323920b619a0dbc8293a3d56e610ed874c7614f81310bf::auctionhouse::get_owner(arg1) == v0, 1);
