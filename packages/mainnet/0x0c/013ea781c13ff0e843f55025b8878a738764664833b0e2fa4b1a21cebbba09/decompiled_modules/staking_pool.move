module 0xc013ea781c13ff0e843f55025b8878a738764664833b0e2fa4b1a21cebbba09::staking_pool {
    ...
    public entry fun create_staking_pool(arg0: address, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == @0x9d6b83272c5cc0cdcaeebef033699cf7e3e66cf0bd223f05a6cc1b6e86d57d80, 4);
        assert!(arg1 <= 1000, 11);
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public entry fun emergency_restore_admin(arg0: &mut StakingPool, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x9d6b83272c5cc0cdcaeebef033699cf7e3e66cf0bd223f05a6cc1b6e86d57d80, 4);
    ...
    public entry fun remove_admin(arg0: &mut StakingPool, arg1: &AdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::vec_set::contains<address>(&arg0.admins, &arg2), 4);
        let v2 = ValidatorUpdatedEvent{
            admin         : v0,
            pool_id       : 0x2::object::uid_to_address(&arg0.id),
            old_validator : arg2,
            new_validator : @0x0,
        };
        0x2::event::emit<ValidatorUpdatedEvent>(v2);
    }
