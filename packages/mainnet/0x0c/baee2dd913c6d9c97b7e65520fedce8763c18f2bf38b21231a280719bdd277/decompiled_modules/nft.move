module 0xcbaee2dd913c6d9c97b7e65520fedce8763c18f2bf38b21231a280719bdd277::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    struct NftCap<T0: drop + store> has store, key {
        id: 0x2::object::UID,
    ...
    public fun register_nft_type<T0: drop + store>(arg0: &0x2::package::Publisher, arg1: &0x2::package::Publisher, arg2: u64, arg3: u16, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (NftCap<T0>, 0x2::display::Display<Nft<T0>>, 0x2::transfer_policy::TransferPolicy<Nft<T0>>) {
        assert!(0x2::package::from_package<T0>(arg0), 1);
        let v0 = 0x2::display::new<Nft<T0>>(arg0, arg5);
        ...
        let (v1, v2) = 0x2::transfer_policy::new<Nft<T0>>(arg0, arg5);
        let v3 = v2;
        let v4 = v1;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<Nft<T0>>(&mut v4, &v3);
        if (arg3 > 0) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft<T0>>(&mut v4, &v3, arg3, arg4);
        };
        let v5 = NftCap<T0>{
            id           : 0x2::object::new(arg5),
            policy_cap   : 0x2::borrow::new<0x2::transfer_policy::TransferPolicyCap<Nft<T0>>>(v3, arg5),
            publisher_id : 0x2::object::id<0x2::package::Publisher>(arg1),
            max_supply   : arg2,
            minted       : 0,
        };
        (v5, v0, v4)
