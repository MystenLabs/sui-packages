module 0xc300fa1aa60a058f88aff69fa2e43f90a917939e56a0b88c99492394f358365::game3287 {
    struct GAME3287 has drop {
        dummy_field: bool,
    }

    struct TICKET_3287 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3287(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3287>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3287>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME3287, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3287>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3287>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3287>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3287>>(v5, 0x2::tx_context::sender(arg1));
    }
