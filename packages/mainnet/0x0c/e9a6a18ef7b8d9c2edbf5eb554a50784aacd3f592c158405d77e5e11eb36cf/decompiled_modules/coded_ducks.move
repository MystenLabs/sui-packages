module 0xce9a6a18ef7b8d9c2edbf5eb554a50784aacd3f592c158405d77e5e11eb36cf::coded_ducks {
    struct CODED_DUCKS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CODED_DUCKS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CODED_DUCKS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Coded Ducks"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"333 Coded Ducks | The origin block of $KODUCK"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeieyuhlsja5l4oik4epvu7wdazzqlwtlcsvnjdd42aroxtk6iy22wa"));
