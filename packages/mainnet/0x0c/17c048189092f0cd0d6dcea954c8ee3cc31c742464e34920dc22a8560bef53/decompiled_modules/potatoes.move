module 0xea15ee7c28ff237eeb8fa1fe64b507ab97c352a46bba54b67fa751dde42696e5::potatoes {
    public fun decode(arg0: 0x1::string::String) : vector<u8> {
        ...
        while (v3 < v1) {
            ...
            let v5 = if (48 <= v4 && v4 < 58) {
                v4 - 48
            } else if (v4 == 112 || v4 == 80) {
                10
            } else if (v4 == 111 || v4 == 79) {
                11
            } else if (v4 == 116 || v4 == 84) {
                12
            } else if (v4 == 97 || v4 == 65) {
                13
            } else if (v4 == 101 || v4 == 69) {
                14
            } else {
                assert!(v4 == 115 || v4 == 83, 1);
                15
            };
            let v6 = *0x1::vector::borrow<u8>(&v0, v3 + 1);
            let v7 = if (48 <= v6 && v6 < 58) {
                v6 - 48
            } else if (v6 == 112 || v6 == 80) {
                10
            } else if (v6 == 111 || v6 == 79) {
                11
            } else if (v6 == 116 || v6 == 84) {
                12
            } else if (v6 == 97 || v6 == 65) {
                13
            } else if (v6 == 101 || v6 == 69) {
                14
            } else {
                assert!(v6 == 115 || v6 == 83, 1);
                15
            };
            0x1::vector::push_back<u8>(&mut v2, v5 * 16 + v7);
            v3 = v3 + 2;
        };
        v2
    }
    ...
    public fun encode(arg0: vector<u8>) : 0x1::string::String {
        ...
        while (v2 < 0x1::vector::length<u8>(&arg0)) {
            let v3 = v1;
            0x1::vector::append<u8>(&mut v3, *0x1::vector::borrow<vector<u8>>(&v0, (0x1::vector::pop_back<u8>(&mut arg0) as u64)));
            v1 = v3;
            v2 = v2 + 1;
        };
