module 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::meme {
    ...
    public fun accept_connector<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector::Connector<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
    }

    public fun accept_connector_v2<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector_v2::ConnectorV2<T0>>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
    }

    public fun accept_connector_v3<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::clock::Clock, arg6: &mut MemeConfig, arg7: 0x2::transfer::Receiving<0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector_v3::ConnectorV3<T0>>, arg8: &0x2::coin::CoinMetadata<T0>, arg9: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg6);
        let v0 = 0x2::transfer::public_receive<0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector_v3::ConnectorV3<T0>>(&mut arg6.id, arg7);
        let v1 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector_v3::get_temp_id<T0>(&v0);
        ...
        let v5 = v2;
        assert!(0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector_v3::get_creator<T0>(&v0) == v4, 11);
    ...
    fun buy_returns_internal<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::clock::Clock, arg6: &mut BondingCurve<T0>, arg7: &MemeConfig, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: u64, arg10: u64, arg11: address, arg12: bool, arg13: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v3 = v2;
        let v4 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_amount_in(v2, v1, v0);
        let v5 = v4;
        let v6 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_fee_amount(v4, arg7.swap_fee_bps);
        let v7 = v6;
        if (0x2::coin::value<0x2::sui::SUI>(&arg8) < v4 + v6) {
            let v8 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_fee_amount(0x2::coin::value<0x2::sui::SUI>(&arg8), arg7.swap_fee_bps);
            v7 = v8;
            let v9 = 0x2::coin::value<0x2::sui::SUI>(&arg8) - v8;
            v5 = v9;
            let v10 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_amount_out(v9, v1, v0);
            v3 = v10;
            assert!(v10 >= arg10, 2);
        };
    ...
    fun create_bonding_curve_v3<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &0x2::coin::CoinMetadata<T0>, arg3: 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector_v3::ConnectorV3<T0>, arg4: &MemeConfig, arg5: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        enforce_config_version(arg4);
        let (v0, v1, v2, v3, v4, v5, v6) = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::connector_v3::deconstruct<T0>(arg3);
        let v7 = v6;
        ...
        0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::events::emit_curve_create<T0>(get_id<T0>(&v9), v5, 0x2::coin::get_name<T0>(arg2), 0x2::coin::get_symbol<T0>(arg2), 0x2::coin::get_description<T0>(arg2), 0x2::coin::get_icon_url<T0>(arg2), v2, v3, v4);
        v9
    }
    ...
    fun max_tick() : 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::I32 {
        0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::from(443636)
    }
    ...
    public fun migrate_to_dex<T0>(arg0: &MemeConfig, arg1: &mut BondingCurve<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::coin::CoinMetadata<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v4, v5, v6) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2_with_creation_cap<T0, 0x2::sui::SUI>(arg2, arg3, &mut arg1.pool_creation_cap, 200, calculate_sqrt_price(v2, v1), 0x1::string::utf8(b"SUI-Token Full Range Pool - from Eric"), 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::as_u32(0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::mul(0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::div(min_tick(), 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::from(200)), 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::from(200))), 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::as_u32(0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::mul(0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::div(max_tick(), 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::from(200)), 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::from(200))), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.token_balance, v1), arg8), 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_balance, v2), arg8), arg6, arg5, true, arg7, arg8);
        let v7 = v4;
    ...
    fun min_tick() : 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::I32 {
        0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::i32::neg_from(443636)
    }
    ...
    public fun place_dev_order(arg0: &mut MemeConfig, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_amount_in(arg3, arg0.virtual_sui_amount, 1000000000000000);
        let v2 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_fee_amount(v1, arg0.swap_fee_bps);
    ...
    public fun sell_returns<T0>(arg0: &mut BondingCurve<T0>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_amount_out(v0, 0x2::balance::value<T0>(&arg0.token_balance), arg0.virtual_sui_amount + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance));
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v2, 0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::math::get_fee_amount(v1, arg1.swap_fee_bps), arg4), @0xa8125cc1a3c3d425a317d405b4089402cf0a9e20fb8a484a0f98973baec09c0b);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v2) >= arg3, 2);
        0xc128bbcd3ebc450822c2f64f2defb727bccb9e255277b04979b41a8f4ae0318::events::emit_sell<T0>(get_id<T0>(arg0), 0x2::coin::value<0x2::sui::SUI>(&v2), v0, get_price_per_token_scaled<T0>(arg0), get_price_per_token_scaled<T0>(arg0), arg0.virtual_sui_amount, 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance), 0x2::balance::value<T0>(&arg0.token_balance), arg0.available_token_reserves);
        v2
    }
