module 0xc1905865fc51db979557a93230b8a3dbd08e7e204ebe3a66f5331e412990972::canvas {
    struct Attribute has copy, drop, store {
        key: 0x1::string::String,
        value: 0x1::string::String,
    }

    struct NFTAttributes has copy, drop, store {
    ...
    fun create_canvas(arg0: &mut GlobalState, arg1: u8, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = b"";
        let v1 = b"";
        let v2 = 0;
        while (v2 < 400) {
        ...
        let v3 = 400;
        let v4 = 0;
        let v5 = render_canvas_svg(&v0, &v1, arg1);
        let v6 = encode_base64(*0x1::string::as_bytes(&v5));
        let v7 = 0x1::string::utf8(b"data:image/svg+xml;base64,");
        0x1::string::append(&mut v7, v6);
        let v8 = 0x1::string::utf8(b"Imagine Canvas #");
        0x1::string::append(&mut v8, u64_to_str(arg0.total_supply));
        let v9 = Attribute{
        ...
        let v11 = Attribute{
            key   : 0x1::string::utf8(b"Total Ink Spent"),
            value : u64_to_str(v4),
        };
        let v12 = 0x1::vector::empty<Attribute>();
        let v13 = &mut v12;
        0x1::vector::push_back<Attribute>(v13, v9);
        0x1::vector::push_back<Attribute>(v13, v10);
        0x1::vector::push_back<Attribute>(v13, v11);
        let v14 = NFTAttributes{contents: v12};
        let v15 = CanvasNFT{
            id              : 0x2::object::new(arg3),
            name            : v8,
            image_url       : v7,
            description     : 0x1::string::utf8(b"A dynamic generative canvas on Sui."),
            pixels          : v0,
            effects         : v1,
            ink_level       : v3,
            total_ink_spent : v4,
        ...
        0x2::transfer::public_transfer<CanvasNFT>(v15, 0x2::tx_context::sender(arg3));
    }
    ...
    entry fun mint(arg0: &mut GlobalState, arg1: &0x2::random::Random, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        create_canvas(arg0, v2, v3, arg3);
    }

    entry fun mint_legendary_admin(arg0: &mut GlobalState, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0xcac2536a4c979c6256a719ee0286fbabe2f47132b7aa998913e127b1e562eb2f, 5);
        assert!(arg0.total_supply < 888, 1);
        create_canvas(arg0, 4, 0x1::string::utf8(b"Legendary"), arg1);
    }

    entry fun paint_overwrite(arg0: &mut CanvasNFT, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u8>(&arg1) == 400, 3);
        assert!(0x1::vector::length<u8>(&arg2) == 400, 3);
        let v0 = 0;
        let v1 = 0;
        while (v0 < 400) {
            let v2 = *0x1::vector::borrow<u8>(&arg1, v0);
            let v3 = *0x1::vector::borrow<u8>(&arg2, v0);
            if (v3 > 0) {
                assert!(arg0.palette_tier >= 3, 6);
            };
            ...
            if (v3 > 0 && *0x1::vector::borrow<u8>(&arg0.effects, v0) != v3) {
                v1 = v1 + 1;
            };
            v0 = v0 + 1;
        };
        ...
        arg0.total_ink_spent = arg0.total_ink_spent + v1;
        arg0.pixels = arg1;
        arg0.effects = arg2;
        0x1::vector::borrow_mut<Attribute>(&mut arg0.attributes.contents, 1).value = u64_to_str(arg0.ink_level);
        0x1::vector::borrow_mut<Attribute>(&mut arg0.attributes.contents, 2).value = u64_to_str(arg0.total_ink_spent);
        update_visuals(arg0);
    }
    ...
    fun render_canvas_svg(arg0: &vector<u8>, arg1: &vector<u8>, arg2: u8) : 0x1::string::String {
    ...
    fun update_visuals(arg0: &mut CanvasNFT) {
        let v0 = render_canvas_svg(&arg0.pixels, &arg0.effects, arg0.palette_tier);
        arg0.svg_data = encode_base64(*0x1::string::as_bytes(&v0));
        let v1 = 0x1::string::utf8(b"data:image/svg+xml;base64,");
        0x1::string::append(&mut v1, arg0.svg_data);
        arg0.image_url = v1;
    }
