module 0xc073994383e1356cd1937b018d15a5e1744f59bad5f2533a07810c6a2364266::cnsnft5104 {
    struct CNSNFT5104 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5104, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5104>(arg0, arg1);
