module 0xc0ba16549ddc8d940ec3a4b5d5064f14790301f548a43c079cddec7519dfe9f::privatecoin {
    ...
    fun init(arg0: PRIVATECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PRIVATECOIN>(arg0, 9, b"USDG ", b"Tatr U", b"123", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmZTdTrRfQhYMZhywkKBZiKWe3XXgKXoupH7eN5vEjw1Mf ")), arg1);
        let v2 = v0;
