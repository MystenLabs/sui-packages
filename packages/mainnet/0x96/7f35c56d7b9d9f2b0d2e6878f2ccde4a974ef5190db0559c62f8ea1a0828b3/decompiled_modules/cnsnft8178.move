module 0x967f35c56d7b9d9f2b0d2e6878f2ccde4a974ef5190db0559c62f8ea1a0828b3::cnsnft8178 {
    struct CNSNFT8178 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8178, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8178>(arg0, arg1);
