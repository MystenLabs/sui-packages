module 0x9655601113a5e3fa7e3aa537a2646adc325dd9bd59bae9944826ec14fef8ab5f::reward3235 {
    struct REWARD3235 has drop {
        dummy_field: bool,
    }

    struct TICKET_3235 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3235(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3235>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3235>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3235>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3235>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3235>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3235>>(v5, 0x2::tx_context::sender(arg1));
    }
