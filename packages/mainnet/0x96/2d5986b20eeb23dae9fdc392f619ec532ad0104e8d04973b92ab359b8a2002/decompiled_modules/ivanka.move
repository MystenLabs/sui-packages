module 0x962d5986b20eeb23dae9fdc392f619ec532ad0104e8d04973b92ab359b8a2002::ivanka {
    ...
    fun init(arg0: IVANKA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<IVANKA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"IVANKA  ")))), trim_right(b"IVANKA TRUMP MEME               "), trim_right(b"The Only Official Ivanka Trump Sui Meme. $IVANKA (Trump's daughter)                                                                                                                                                                                                                                                             "), v2, arg1);
        let v5 = v3;
