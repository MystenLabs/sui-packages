module 0x96d24015d2005f7a467ef2e9d489a1e5deca7f20787f4c277c437e8158b2f752::cbd {
    struct CBD has drop {
        dummy_field: bool,
    }
    ...
    public fun mint_max_supply(arg0: &mut 0x2::coin::TreasuryCap<CBD>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<CBD> {
        assert!(0x2::coin::total_supply<CBD>(arg0) + 10000000000 <= 10000000000, 0);
        0x2::coin::mint<CBD>(arg0, 10000000000, arg1)
    }
