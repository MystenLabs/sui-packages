module 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::partner_manager {
    ...
    public(friend) fun collect_commission_if_necessary<T0>(arg0: &mut PartnerRegistry, arg1: 0x1::string::String, arg2: &mut 0x2::coin::Coin<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : bool {
        let v0 = false;
        check_exists(arg0, arg1);
        let v1 = 0x2::bag::borrow_mut<0x1::string::String, PartnerInfo>(&mut arg0.partners, arg1);
        if (0x2::bag::contains<0x1::type_name::TypeName>(&v1.commissions, 0x1::type_name::get<T0>())) {
            let v2 = 0x2::bag::borrow<0x1::type_name::TypeName, Commission>(&v1.commissions, 0x1::type_name::get<T0>());
            let v3 = if (v2.type == 1) {
                if (v2.value > 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::math::mul_div(0x2::coin::value<T0>(arg2), arg0.max_comission_percentage, 1000000)) {
                    abort 2
                };
                v2.value
            } else {
                0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::math::mul_div(0x2::coin::value<T0>(arg2), v2.value, 1000000)
            };
            if (arg3 && v2.level == 0) {
                collect<T0>(v1, 0x2::coin::split<T0>(arg2, v3, arg4), arg4);
                v0 = true;
            } else if (v2.level == 1) {
                collect<T0>(v1, 0x2::coin::split<T0>(arg2, v3, arg4), arg4);
                v0 = true;
    ...
    public entry fun config_max_comission_percentage(arg0: &0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::admin_cap::AdminCap, arg1: &mut PartnerRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
    ...
    public entry fun register_partner(arg0: &0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::admin_cap::AdminCap, arg1: &mut PartnerRegistry, arg2: vector<u8>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(arg2);
