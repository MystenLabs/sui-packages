module 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::universal_router {
    ...
    public fun build<T0, T1>(arg0: &mut 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::partner_manager::PartnerRegistry, arg1: 0x1::option::Option<0x1::string::String>, arg2: 0x2::coin::Coin<T0>, arg3: u256, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) : Trade<T0, T1> {
        if (arg5 > 1000000) {
            abort 2
        };
        ...
        while (0x1::vector::is_empty<u64>(&arg7)) {
            ...
            let v3 = Route{
                trade_id  : arg3,
                amount_in : 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::math::mul_div(0x2::coin::value<T0>(&arg2), v2, 100),
                current   : 0,
        ...
        if (0x1::option::is_some<0x1::string::String>(&arg1)) {
            v4.commision_collected = 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::partner_manager::collect_commission_if_necessary<T0>(arg0, *0x1::option::borrow<0x1::string::String>(&arg1), &mut v4.coin_in, true, arg8);
        };
        v4
    }
    ...
    public entry fun set_fee_on(arg0: &0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::admin_cap::AdminCap, arg1: &mut Treasury, arg2: bool) {
        arg1.fee_on = arg2;
    }

    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: &mut 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::partner_manager::PartnerRegistry, arg2: Trade<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let Trade {
            trade_id            : v0,
            amount_in           : v1,
        ...
        let v11 = v8;
        let v12 = v7;
        if (!0x1::vector::is_empty<Route>(&v11)) {
            abort 5
        };
        if (0x2::clock::timestamp_ms(arg3) > v4) {
            abort 0
        };
        if (0x2::coin::value<T1>(&v12) < 0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::math::mul_div(1000000 - v3, v2, 1000000)) {
            abort 1
        };
        0x1::vector::destroy_empty<Route>(v11);
        refund_if_necessary<T0>(v6, 0x2::tx_context::sender(arg4));
        let v13 = &mut v12;
        pay_router_fee_if_necessary<T1>(arg0, v13, v2, arg4);
        if (0x1::option::is_some<0x1::string::String>(&v10) && !v5) {
            0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::partner_manager::collect_commission_if_necessary<T1>(arg1, 0x1::option::destroy_some<0x1::string::String>(v10), &mut v12, false, arg4);
        } else {
    ...
    public entry fun withdraw<T0>(arg0: &0x962838a0be587d5f70d761ec4c4cdc77853519183b60379cabd98e6b8f5a6144::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
