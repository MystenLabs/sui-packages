module 0x96aba92d790dd50c79164e01e3a2d51726ff71f2b2b8d5bc48de908e02ef201f::reward3304 {
    struct REWARD3304 has drop {
        dummy_field: bool,
    }

    struct TICKET_3304 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3304(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3304>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3304>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3304, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3304>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3304>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3304>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3304>>(v5, 0x2::tx_context::sender(arg1));
    }
