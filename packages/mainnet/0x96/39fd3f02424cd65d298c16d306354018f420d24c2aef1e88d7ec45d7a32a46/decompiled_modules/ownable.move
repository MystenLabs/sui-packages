module 0xa0e3b011012b80af4957afa30e556486eb3da0a7d96eeb733cf16ccd3aec32e0::ownable {
    ...
    public entry fun add_breaker_to_acl(arg0: &AdminCap, arg1: &mut ACL, arg2: address) {
        assert!(!0x1::vector::contains<address>(&arg1.breakers, &arg2), 4);
    ...
    public entry fun add_robot_to_acl(arg0: &AdminCap, arg1: &mut ACL, arg2: address) {
        assert!(!0x1::vector::contains<address>(&arg1.robots, &arg2), 4);
        0x1::vector::push_back<address>(&mut arg1.robots, arg2);
    }

    public fun assert_version(arg0: &AdminCap) {
        assert!(arg0.version <= 0xa0e3b011012b80af4957afa30e556486eb3da0a7d96eeb733cf16ccd3aec32e0::version::get_program_version(), 3);
    }
