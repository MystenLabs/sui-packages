module 0x96e49e7f672f3084028e11224a3616c18ab1805db62e6d0037fe56bf2792a1c9::warehouse {
    ...
    public(friend) fun destroy<T0: store + key>(arg0: Warehouse<T0>) {
    ...
    public(friend) fun redeem_nft_and_transfer<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun redeem_nft_at_index_and_transfer<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun redeem_nft_with_id_and_transfer<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<T0>(redeem_nft_with_id<T0>(arg0, arg1), 0x2::tx_context::sender(arg2));
    }

    public(friend) fun redeem_pseudorandom_nft<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: &mut 0x2::tx_context::TxContext) : T0 {
    ...
    public(friend) fun redeem_pseudorandom_nft_and_transfer<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = redeem_pseudorandom_nft<T0>(arg0, arg1);
        0x2::transfer::public_transfer<T0>(v0, 0x2::tx_context::sender(arg1));
    }

    public(friend) fun redeem_random_nft<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: RedeemCommitment, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : T0 {
        let v0 = supply<T0>(arg0);
        assert!(v0 != 0, 1);
        let RedeemCommitment {
            id                       : v1,
    ...
    public(friend) fun redeem_random_nft_and_transfer<T0: store + key>(arg0: &mut Warehouse<T0>, arg1: RedeemCommitment, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
