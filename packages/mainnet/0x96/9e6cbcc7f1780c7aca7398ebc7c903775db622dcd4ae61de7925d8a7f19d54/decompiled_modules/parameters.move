module 0x969e6cbcc7f1780c7aca7398ebc7c903775db622dcd4ae61de7925d8a7f19d54::parameters {
    struct Parameters has store {
        admin: address,
    ...
    public fun check_sender(arg0: &Parameters, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834663969652735);
    }
    ...
    public fun production_stonker_parameters(arg0: address) : Parameters {
        let v0 = 1000000000;
        Parameters{
            admin                                      : arg0,
    ...
    public fun staging_stonker_parameters(arg0: address) : Parameters {
