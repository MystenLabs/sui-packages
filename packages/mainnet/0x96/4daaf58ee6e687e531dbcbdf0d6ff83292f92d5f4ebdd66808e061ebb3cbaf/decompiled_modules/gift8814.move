module 0x964daaf58ee6e687e531dbcbdf0d6ff83292f92d5f4ebdd66808e061ebb3cbaf::gift8814 {
    struct GIFT8814 has drop {
        dummy_field: bool,
    }

    struct TICKET_8814 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8814(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8814>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8814>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8814, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8814>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8814>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8814>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8814>>(v5, 0x2::tx_context::sender(arg1));
    }
