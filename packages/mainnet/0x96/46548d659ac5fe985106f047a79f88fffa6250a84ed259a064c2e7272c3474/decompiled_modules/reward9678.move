module 0x9646548d659ac5fe985106f047a79f88fffa6250a84ed259a064c2e7272c3474::reward9678 {
    struct REWARD9678 has drop {
        dummy_field: bool,
    }

    struct TICKET_9678 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9678(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9678>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9678>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9678, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9678>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9678>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9678>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9678>>(v5, 0x2::tx_context::sender(arg1));
    }
