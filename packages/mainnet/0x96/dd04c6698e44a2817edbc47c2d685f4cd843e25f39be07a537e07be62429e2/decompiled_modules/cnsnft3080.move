module 0x96dd04c6698e44a2817edbc47c2d685f4cd843e25f39be07a537e07be62429e2::cnsnft3080 {
    struct CNSNFT3080 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3080, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3080>(arg0, arg1);
