module 0x964243e8f34c74c8855d469dd49da0a5f7f01e1ed63e4d57ee776cde039df174::reward9413 {
    struct REWARD9413 has drop {
        dummy_field: bool,
    }

    struct TICKET_9413 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9413(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9413>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9413>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9413, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9413>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9413>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9413>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9413>>(v5, 0x2::tx_context::sender(arg1));
    }
