module 0x96d720a67e3d75dd8604061ca76bcdbdfad2771fdbf7109eda4d0f87a849cbf3::cnsnft3195 {
    struct CNSNFT3195 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3195, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3195>(arg0, arg1);
