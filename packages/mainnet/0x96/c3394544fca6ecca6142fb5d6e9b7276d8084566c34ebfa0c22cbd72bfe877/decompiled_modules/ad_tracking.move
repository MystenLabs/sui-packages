module 0x96c3394544fca6ecca6142fb5d6e9b7276d8084566c34ebfa0c22cbd72bfe877::ad_tracking {
    ...
    public fun pause_registry(arg0: &mut ClickTokenRegistry, arg1: &0x2::clock::Clock, arg2: &0x96c3394544fca6ecca6142fb5d6e9b7276d8084566c34ebfa0c22cbd72bfe877::ad_payments::AdminCap) {
        arg0.paused = true;
        let v0 = TrackingPaused{timestamp: 0x2::clock::timestamp_ms(arg1)};
        0x2::event::emit<TrackingPaused>(v0);
    }

    public fun record_conversion(arg0: &mut ClickToken, arg1: &mut ClickTokenRegistry, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &0x96c3394544fca6ecca6142fb5d6e9b7276d8084566c34ebfa0c22cbd72bfe877::ad_payments::AdminCap) {
    ...
    public fun verify_conversion(arg0: &mut ClickTokenRegistry, arg1: vector<u8>, arg2: &0x96c3394544fca6ecca6142fb5d6e9b7276d8084566c34ebfa0c22cbd72bfe877::ad_payments::AdminCap) {
        assert!(!arg0.paused, 6);
