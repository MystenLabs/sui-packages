module 0x960285c765dbe4197b5995731e665ae4659349fc6ffb06a7f149879283d93152::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"MX1710182", b"MixedTest1 710182", b"Token for mixed operations test 1", 0x1::option::none<0x2::url::Url>(), arg1);
