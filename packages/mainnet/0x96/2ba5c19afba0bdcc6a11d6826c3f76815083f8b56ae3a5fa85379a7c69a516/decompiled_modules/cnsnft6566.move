module 0x962ba5c19afba0bdcc6a11d6826c3f76815083f8b56ae3a5fa85379a7c69a516::cnsnft6566 {
    struct CNSNFT6566 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6566, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2272"));
        let v4 = 0x2::package::claim<CNSNFT6566>(arg0, arg1);
