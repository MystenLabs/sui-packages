module 0x967a523da8e8916daaebe28af26a9c6e748fd0e386acde3f4cb22e26621bf94a::oggie {
    ...
    fun init(arg0: OGGIE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<OGGIE>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<OGGIE>>(v4);
    }
