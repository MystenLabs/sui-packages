module 0x96adb011e01c235cfc5577a54a3ec57d56f3e65c9947a1836ceaf3cc3827be29::gift1304 {
    struct GIFT1304 has drop {
        dummy_field: bool,
    }

    struct TICKET_1304 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1304(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1304>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1304>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1304, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1304>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1304>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1304>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1304>>(v5, 0x2::tx_context::sender(arg1));
    }
