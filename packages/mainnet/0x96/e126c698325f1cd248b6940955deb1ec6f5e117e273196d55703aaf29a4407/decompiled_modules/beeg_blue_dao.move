module 0x96e126c698325f1cd248b6940955deb1ec6f5e117e273196d55703aaf29a4407::beeg_blue_dao {
    ...
    fun init(arg0: BEEG_BLUE_DAO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BEEG_BLUE_DAO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Beeg Blue DAO"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicbzlazxbj5rz4dtqpeoygvdtukxqgbavicvoxi34dzpr3iectaye"));
