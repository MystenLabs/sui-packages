module 0x96949aec19e97a14e535ea5d815d17f9fc73bd439bd37c9008e022036545aec9::connector_v3 {
    ...
    public fun new<T0: drop>(arg0: T0, arg1: u64, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x96949aec19e97a14e535ea5d815d17f9fc73bd439bd37c9008e022036545aec9::events::emit_connector_create_v3<T0>(get_id<T0>(&v3));
        0x2::transfer::public_transfer<ConnectorV3<T0>>(v3, @0xb6838139275ed67d230600eaf930bfa6f6a976a3bedee975d8881f43f4564ff7);
    }
