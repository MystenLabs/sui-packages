module 0x964f498216778f66df8a512535eb5c84f87184ae3dcf511dbfe6c472c1d672c1::kang_swap {
    ...
    public entry fun create<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::balance::create_supply<LiquidityToken<T0, T1>>(v0);
        let v2 = Pool<T0, T1>{
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<LiquidityToken<T0, T1>>>(0x2::coin::from_balance<LiquidityToken<T0, T1>>(0x2::balance::increase_supply<LiquidityToken<T0, T1>>(&mut v1, 0x2::math::sqrt(0x2::coin::value<T0>(&arg0) * 0x2::coin::value<T1>(&arg1))), arg2), 0x2::tx_context::sender(arg2));
    }
