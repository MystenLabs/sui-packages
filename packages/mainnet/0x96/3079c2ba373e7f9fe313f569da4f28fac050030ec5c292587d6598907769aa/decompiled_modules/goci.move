module 0x963079c2ba373e7f9fe313f569da4f28fac050030ec5c292587d6598907769aa::goci {
    ...
    fun init(arg0: GOCI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<GOCI>(arg0, 6, b"GOCI", b"$GOCI", b"$GOCI is Goci's token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://www.shutterstock.com/shutterstock/photos/1917706844/display_1500/stock-vector-lucky-cat-bitcoin-crypto-currency-money-1917706844.jpg")), true, arg1);
        let v3 = v0;
