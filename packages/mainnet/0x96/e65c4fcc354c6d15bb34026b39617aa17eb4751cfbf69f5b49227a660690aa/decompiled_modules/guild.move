module 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild {
    ...
    public(friend) fun update_time_range_with_key(arg0: &mut UserArchive, arg1: vector<u8>, arg2: u64, arg3: u64) {
        assert!(arg3 >= arg2, 6020);
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, arg1)) {
            let v0 = CommissionTimeRange{
                min_time : arg2,
                max_time : arg3,
            };
            0x2::dynamic_field::add<vector<u8>, CommissionTimeRange>(&mut arg0.id, arg1, v0);
        } else {
            let v1 = 0x2::dynamic_field::borrow_mut<vector<u8>, CommissionTimeRange>(&mut arg0.id, arg1);
            assert!(arg2 > v1.max_time, 6021);
            v1.min_time = arg2;
            v1.max_time = arg3;
        };
    }
