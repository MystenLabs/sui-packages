module 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::boosting_v2 {
    ...
    public fun add_whitelist_manager_pre_subscribe(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::AdminCap, arg1: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg2: &mut PreSubscribe, arg3: vector<address>) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg1, 0x1::string::utf8(b"BOOSTING_MODULE"));
        let v0 = 0;
    ...
    public fun add_whitelist_pre_subscribe(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut PreSubscribe, arg2: u8, arg3: vector<address>, arg4: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
    ...
    public fun buying_stars<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut BoostingVault, arg2: &mut 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::UserArchive, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x2::balance::Balance<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
    ...
    public fun claim_bonus<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut BoostingVault, arg2: &mut 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::UserArchive, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_signature_v2(arg0, arg6, arg7);
        ...
        assert!(0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())) == 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v2)), 7005);
        assert!(v1 < 0x2::bcs::peel_u64(&mut v2), 7004);
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::update_time_range(arg2, arg4, arg5);
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::set_archive_last_name_time(arg2, v1);
    ...
    public fun claim_commission<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut BoostingVault, arg2: &mut 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::UserArchive, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>())) == 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v2)), 7005);
        assert!(v1 < 0x2::bcs::peel_u64(&mut v2), 7004);
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::update_time_range_with_key(arg2, b"BOOSTING_CLAIM_COMMISTION_TIME_RANGE", arg4, arg5);
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::set_archive_last_name_time(arg2, v1);
    ...
    public fun deposit_fund_to_vault<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::TreasureCap, arg1: &mut BoostingVault, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        deposit_to_vault<T0>(arg1, arg2, arg3);
    }

    public fun deposit_pre_subscribe<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut PreSubscribe, arg2: &mut BoostingVault, arg3: u8, arg4: 0x2::balance::Balance<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
        ...
        if (0x2::vec_set::contains<address>(&arg1.subscribers, &v3)) {
            ...
            if (!0x2::table::contains<address, u64>(&arg1.refund_amounts, v3)) {
                ...
                *0x2::table::borrow_mut<address, u64>(&mut arg1.refund_amounts, v3) = v5;
            };
        } else {
            assert!(v2 == v1, 7002);
        ...
        let v7 = DepositPreSubscribeEvent{
            pre_subscribe : 0x2::object::id<PreSubscribe>(arg1),
            subscriber    : v3,
            type          : arg3,
            amount        : v2,
        };
        0x2::event::emit<DepositPreSubscribeEvent>(v7);
    }
    ...
    public fun paused(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::AdminCap, arg1: &mut 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg2: bool) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::paused_v2(arg0, arg1, 0x1::string::utf8(b"BOOSTING_MODULE"), arg2);
    }

    public fun pre_subscribe<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut PreSubscribe, arg2: &mut BoostingVault, arg3: u8, arg4: 0x2::balance::Balance<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
        assert!(!arg1.paused, 7006);
        let v0 = 0x2::clock::timestamp_ms(arg5);
        assert!(v0 >= arg1.start_time && v0 <= arg1.start_time + arg1.duration, 7008);
        ...
        if (0x2::vec_set::contains<address>(&arg1.subscribers, &v1)) {
            assert!(arg3 == 1, 7009);
            let v4 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.subscribers_type, 0);
            if (!0x2::vec_set::contains<address>(v4, &v1)) {
                abort 7009
            };
            0x2::vec_set::remove<address>(v4, &v1);
            assert!(0x2::table::contains<u8, u64>(&arg1.price_per_class, 0), 7001);
            let v5 = *0x2::table::borrow<u8, u64>(&arg1.price_per_class, 0);
            assert!(0x2::balance::value<T0>(&arg4) == v3 - v5, 7002);
            let v6 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.subscribers_type, 1);
            assert!(!0x2::vec_set::contains<address>(v6, &v1), 7009);
            0x2::vec_set::insert<address>(v6, v1);
            if (!0x2::table::contains<address, u64>(&arg1.refund_amounts, v1)) {
                0x2::table::add<address, u64>(&mut arg1.refund_amounts, v1, v3 - v5);
            } else {
                *0x2::table::borrow_mut<address, u64>(&mut arg1.refund_amounts, v1) = v5;
            };
        } else {
        ...
        *v2 = *v2 - 1;
        assert!(arg1.fee_type == 0x1::type_name::get<T0>(), 7005);
        deposit_to_vault<T0>(arg2, arg4, arg5);
        let v7 = PreSubscribeEvent{
            subscriber : 0x2::tx_context::sender(arg6),
            type       : arg3,
            amount     : v3,
        };
        0x2::event::emit<PreSubscribeEvent>(v7);
    }

    public fun refund_pre_subscribe<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut PreSubscribe, arg2: &mut BoostingVault, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
        assert!(!arg1.paused, 7006);
        let v0 = 0x2::tx_context::sender(arg4);
    ...
    public fun remove_whitelist_manager_pre_subscribe(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::AdminCap, arg1: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg2: &mut PreSubscribe, arg3: vector<address>) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg1, 0x1::string::utf8(b"BOOSTING_MODULE"));
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg3)) {
            let v1 = *0x1::vector::borrow<address>(&arg3, v0);
    ...
    public fun remove_whitelist_pre_subscribe(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut PreSubscribe, arg2: u8, arg3: vector<address>, arg4: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::vec_set::contains<address>(&arg1.wl_manager, &v0), 7003);
        let v1 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.whitelisted, arg2);
    ...
    public fun remove_whitelist_subscribers_pre_subscribe(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut PreSubscribe, arg2: u8, arg3: vector<address>, arg4: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::vec_set::contains<address>(&arg1.wl_manager, &v0), 7003);
        let v1 = 0x2::table::borrow_mut<u8, 0x2::vec_set::VecSet<address>>(&mut arg1.whitelisted, arg2);
    ...
    public fun set_fund_receiver(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::AdminCap, arg1: &mut BoostingVault, arg2: address) {
    ...
    public fun set_refund_available_pre_subscribe(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::AdminCap, arg1: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg2: &mut PreSubscribe, arg3: bool) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg1, 0x1::string::utf8(b"BOOSTING_MODULE"));
    ...
    public fun subscribe<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut BoostingVault, arg2: &mut 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::UserArchive, arg3: u16, arg4: u8, arg5: vector<u8>, arg6: vector<u8>, arg7: 0x2::balance::Balance<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
    ...
    public fun swap_stars<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::Config, arg1: &mut BoostingVault, arg2: &mut 0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::UserArchive, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_config(arg0, 0x1::string::utf8(b"BOOSTING_MODULE"));
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::verify_signature_v2(arg0, arg5, arg6);
        let v0 = 0x2::tx_context::sender(arg8);
        0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::validate_archive_owner(arg2, arg8);
    ...
    public fun withdraw_amount_from_vault<T0>(arg0: &0x2fda1170e1488895ccacae7c6ae991a5b43266d006565a6dc36d414cc179b130::guild::TreasureCap, arg1: &mut BoostingVault, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
