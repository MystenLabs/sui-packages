module 0x969181f0e2cd7a3e5f49592dc29464cdf904d58d83d9732f3498f93d8d899f01::proofbase_characters {
    struct PROOFBASE_CHARACTERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PROOFBASE_CHARACTERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PROOFBASE_CHARACTERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ProofBase Characters"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Official Mascot of ProofBase"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeid4e2wojdnujpqc4tmra4vdabxwnjctchf64lsaijgdisybctizoy"));
