module 0x96a839af6325715bc493e277b41aaf52e808ae622a41e706042adeb16b6799e6::reward7488 {
    struct REWARD7488 has drop {
        dummy_field: bool,
    }

    struct TICKET_7488 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7488(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7488>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7488>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7488, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7488>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7488>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7488>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7488>>(v5, 0x2::tx_context::sender(arg1));
    }
