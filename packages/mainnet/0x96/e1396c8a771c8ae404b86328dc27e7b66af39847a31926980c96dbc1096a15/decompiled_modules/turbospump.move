module 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::turbospump {
    ...
    public fun buy_with_return<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let (v4, v5, v6) = if (arg4) {
            let v7 = 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::full_math_u64::mul_div_ceil(arg2, arg0.platform_fee, 1000000);
            let v8 = arg2 - v7;
            let v9 = 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::curves::calculate_token_return(v8, v2.virtual_sui_reserves, v2.virtual_token_reserves);
            assert!(v9 >= arg3, 6);
            assert!(v3 >= v9, 9);
            (v7, v8, v9)
        } else {
            let v10 = 0x1::u64::min(arg2, v3);
            let v11 = 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::curves::calculate_liquidity_cost(v2.virtual_sui_reserves, v2.virtual_token_reserves, v10);
            assert!(v11 <= arg3, 7);
            (0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::full_math_u64::mul_div_ceil(v11, arg0.platform_fee, 1000000), v11, v10)
        };
    ...
    public fun sell_with_return<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let (v3, v4, v5) = if (arg4) {
            let v6 = 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::curves::calculate_sui_return(arg2, v1.virtual_sui_reserves, v1.virtual_token_reserves);
            let v7 = 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::full_math_u64::mul_div_ceil(v6, arg0.platform_fee, 1000000);
            assert!(v6 - v7 >= arg3, 6);
            (v7, v6, arg2)
        } else {
            let v8 = 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::full_math_u64::mul_div_ceil(arg2, arg0.platform_fee, 1000000);
            let v9 = arg2 + v8;
            let v10 = 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::curves::calculate_token_return(v9, v1.virtual_sui_reserves, v1.virtual_token_reserves);
            assert!(v10 < arg3, 7);
            (v8, v9, v10)
        };
        assert!(v2 >= v5, 11);
