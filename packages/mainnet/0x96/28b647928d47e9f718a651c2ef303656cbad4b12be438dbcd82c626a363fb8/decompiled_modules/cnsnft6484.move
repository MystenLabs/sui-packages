module 0x9628b647928d47e9f718a651c2ef303656cbad4b12be438dbcd82c626a363fb8::cnsnft6484 {
    struct CNSNFT6484 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6484, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6484>(arg0, arg1);
