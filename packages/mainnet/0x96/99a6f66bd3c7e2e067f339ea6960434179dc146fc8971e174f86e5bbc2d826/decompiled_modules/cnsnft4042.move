module 0x9699a6f66bd3c7e2e067f339ea6960434179dc146fc8971e174f86e5bbc2d826::cnsnft4042 {
    struct CNSNFT4042 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4042, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4042>(arg0, arg1);
