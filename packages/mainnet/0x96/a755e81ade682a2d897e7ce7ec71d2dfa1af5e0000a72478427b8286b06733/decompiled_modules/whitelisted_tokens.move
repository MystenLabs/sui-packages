module 0xe616397e503278d406e184d2258bcbe7a263d0192cc0848de2b54b518165f832::whitelisted_tokens {
    ...
    public fun is_whitelisted_token<T0>(arg0: &WhitelistManager) : bool {
        ...
        0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.is_whitelisted_token, v0) && *0x2::table::borrow<0x1::type_name::TypeName, bool>(&arg0.is_whitelisted_token, v0)
    }
