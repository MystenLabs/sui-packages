module 0x966edd46d6b70e9c755b16770ce8ac844d85ee5788ee3a89fc00c022513eec65::usad {
    ...
    fun init(arg0: USAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4) = 0x2::coin::create_regulated_currency_v2<USAD>(arg0, 9, trim_right(b"USAD"), trim_right(b"USAD  "), trim_right(b"Uu"), v1, true, arg1);
        let v5 = v2;
        let v6 = 0x2::tx_context::sender(arg1);
        if (1000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USAD>>(0x2::coin::mint<USAD>(&mut v5, 1000000000000000, arg1), v6);
        };
