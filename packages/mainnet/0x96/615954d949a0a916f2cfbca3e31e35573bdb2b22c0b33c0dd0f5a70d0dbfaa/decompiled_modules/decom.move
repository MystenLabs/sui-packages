module 0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::decom {
    ...
    struct DecomAdminCap has store, key {
        ...
        ownership: 0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::ownership::CredenzaOwnership,
    }
    ...
    public fun buy_decom_token<T0>(arg0: &0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::sellable::CredenzaSellableConfig<DECOM>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::sellable::accept_payment_coin<DECOM, T0>(arg0, arg1, arg2);
        let v0 = DecomToken{
    ...
    fun init(arg0: DECOM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = DecomAdminCap{
            ...
            ownership            : 0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        };
        0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
        ...
        let (_, v4) = 0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::sellable::create_config<DECOM>(arg0, arg1);
        0x2::transfer::public_share_object<0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::sellable::CredenzaSellableConfig<DECOM>>(v4);
    }

    public fun mint(arg0: &DecomAdminCap, arg1: address, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg3));
        let v0 = DecomToken{
    ...
    public fun write_owner_render_data(arg0: &mut DecomAdminCap, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        0x96615954d949a0a916f2cfbca3e31e35573bdb2b22c0b33c0dd0f5a70d0dbfaa::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg2));
