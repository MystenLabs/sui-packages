module 0x3b910cca5dc1c1d29740c6bfb089ff0494f139239353ef53017ffd742af3f17f::deepbookv3_agg {
    struct DeepbookV3Agg has drop {
        dummy_field: bool,
    }

    public fun swap<T0, T1>(arg0: &0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::router::Router, arg1: &mut 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap::SwapContext, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg4: bool, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = if (arg4) {
            let v3 = DeepbookV3Agg{dummy_field: false};
            swap_a2b<T0, T1>(arg2, 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap::take_balance<DeepbookV3Agg, T0>(arg1, arg0, v3, arg5), arg3, arg6, arg7, arg8)
        } else {
            let v4 = DeepbookV3Agg{dummy_field: false};
            swap_b2a<T0, T1>(arg2, 0x34a3cefd2e70bef775b5ab069a06c041431d239a064fa8338b85f4205b44051::swap::take_balance<DeepbookV3Agg, T1>(arg1, arg0, v4, arg5), arg3, arg6, arg7, arg8)
        };
        let v5 = v2;
        let v6 = v1;
        let v7 = v0;
