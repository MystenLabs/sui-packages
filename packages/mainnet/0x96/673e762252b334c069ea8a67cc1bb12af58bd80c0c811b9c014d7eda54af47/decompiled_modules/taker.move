module 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::taker {
    ...
    public(friend) fun try_make_taker_trade(arg0: &0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::Parameters, arg1: &mut 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_manager::OrderManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg5: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg6: &0x2::clock::Clock, arg7: u64, arg8: bool, arg9: &0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_book::OrderBook, arg10: &mut u64, arg11: &0x2::tx_context::TxContext) {
        let v0 = arg7 * 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::trigger_bps_times_1k(arg0) / 1000 / 10000;
        if (arg8 && 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_book::best_ask(arg9) + v0 < arg7) {
            ...
            let v5 = 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::taker_minimum_order_size_base(arg0) + 1000000 * (arg7 - 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_book::best_ask(arg9) - v0) / 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_book::best_ask(arg9) * 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::taker_order_size_step_base(arg0) / 100;
            let v6 = v5;
            0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_manager::try_ensure_available_quote_balance(arg1, arg0, arg2, arg4, arg3, 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::common::convert_to_quote_at_price(arg0, v5, v4), arg6, arg11);
            let v7 = 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::common::convert_to_base_at_price(arg0, 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::common::get_available_quote_balance(arg0, arg2), v4);
            let v8 = v7;
            let v9 = 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::common::convert_to_base_at_price(arg0, 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::position_limit_quote(arg0), v4);
            let v10 = 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::common::get_available_base_balance(arg0, arg2);
            if (v10 >= v9) {
                v8 = 0;
            } else {
                let v11 = v9 - v10;
            ...
            let v12 = v6 / v2 * v2;
            if (v12 < 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::taker_minimum_order_size_base(arg0)) {
                emit_could_not_trade_event(b"at_limit");
                return
            };
            if (v4 > 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::maximum_buy_price_quote(arg0)) {
                emit_could_not_trade_event(b"price_limit");
                return
            };
            if (0x2::clock::timestamp_ms(arg6) < *arg10 + 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::cooldown_ms(arg0)) {
                emit_could_not_trade_event(b"within_cooldown");
                return
            };
            if (!0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::allowed_to_buy(arg0)) {
        ...
        if (!arg8 && arg7 + v0 < 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_book::best_bid(arg9)) {
            ...
            let v19 = 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::taker_minimum_order_size_base(arg0) + 1000000 * (0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_book::best_bid(arg9) - v0 - arg7) / 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_book::best_ask(arg9) * 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::taker_order_size_step_base(arg0) / 100;
            let v20 = v19;
            0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::order_manager::try_ensure_available_base_balance(arg1, arg0, arg2, arg4, arg3, v19, arg6, arg11);
            let v21 = 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::common::get_available_base_balance(arg0, arg2);
            if (v19 > v21) {
                v20 = v21;
            };
            let v22 = v20 / v16 * v16;
            if (v22 < 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::taker_minimum_order_size_base(arg0)) {
                emit_could_not_trade_event(b"at_limit");
                return
            };
            if (v18 < 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::minimum_sell_price_quote(arg0)) {
                emit_could_not_trade_event(b"price_limit");
                return
            };
            if (0x2::clock::timestamp_ms(arg6) < *arg10 + 0x96673e762252b334c069ea8a67cc1bb12af58bd80c0c811b9c014d7eda54af47::parameters::cooldown_ms(arg0)) {
