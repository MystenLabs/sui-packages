module 0x964f53c4dffce1c493231571ab5761268178994c19b4344047cc9a128c6c5688::walrus_nft {
    ...
    fun init(arg0: WALRUS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://aggregator.walrus-testnet.walrus.space/v1/{walrus_blob_id}"));
