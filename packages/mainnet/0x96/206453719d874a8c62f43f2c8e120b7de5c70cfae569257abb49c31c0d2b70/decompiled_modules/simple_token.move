module 0x96206453719d874a8c62f43f2c8e120b7de5c70cfae569257abb49c31c0d2b70::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"IMGAYLIKERONALDO", b"IMGAYLIKERONALDO", b"Official token. Banner and boost on dexscreener paid.Buy now", 0x1::option::none<0x2::url::Url>(), arg1);
