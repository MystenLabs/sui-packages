module 0x96b0cc6f65e60b9f0cdf2dddeb8de2cab0a02de9c1c20aa40dad540d4d278799::cnsnft9269 {
    struct CNSNFT9269 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9269, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9269>(arg0, arg1);
