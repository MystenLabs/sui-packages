module 0x96504965302b84439cae7cc30eae9d91d4b273623f8df4b51ea94b6dd9cc86d5::elon {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ELON>(arg0, 4, b"ELON", b"Elon Doge AI", b"", 0x1::option::none<0x2::url::Url>(), arg1);
