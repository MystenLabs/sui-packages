module 0x9683c766ba6a483120310777f13d2329a928f21c8b3ce0509a93f782b0438565::transceiver_registry {
    struct TransceiverRegistry has store, key {
        id: 0x2::object::UID,
        next_id: u8,
        enabled_bitmap: 0xc2c8b33fb45156406b7f1453bfc514bb99c6e08e9188bcd30c6ead481deb9a05::bitmap::Bitmap,
    }
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : TransceiverRegistry {
        TransceiverRegistry{
            ...
            next_id        : 0,
            enabled_bitmap : 0xc2c8b33fb45156406b7f1453bfc514bb99c6e08e9188bcd30c6ead481deb9a05::bitmap::empty(),
        }
    }

    public fun disable_transceiver(arg0: &mut TransceiverRegistry, arg1: u8) {
        0xc2c8b33fb45156406b7f1453bfc514bb99c6e08e9188bcd30c6ead481deb9a05::bitmap::disable(&mut arg0.enabled_bitmap, arg1);
    }

    public fun enable_transceiver(arg0: &mut TransceiverRegistry, arg1: u8) {
        0xc2c8b33fb45156406b7f1453bfc514bb99c6e08e9188bcd30c6ead481deb9a05::bitmap::enable(&mut arg0.enabled_bitmap, arg1);
    }

    public fun get_enabled_transceivers(arg0: &TransceiverRegistry) : 0xc2c8b33fb45156406b7f1453bfc514bb99c6e08e9188bcd30c6ead481deb9a05::bitmap::Bitmap {
        arg0.enabled_bitmap
    }
