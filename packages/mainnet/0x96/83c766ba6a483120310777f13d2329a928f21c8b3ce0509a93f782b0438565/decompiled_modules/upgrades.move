module 0x9683c766ba6a483120310777f13d2329a928f21c8b3ce0509a93f782b0438565::upgrades {
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeCap, arg1: &mut 0x9683c766ba6a483120310777f13d2329a928f21c8b3ce0509a93f782b0438565::state::State<T0>, arg2: 0x2::package::UpgradeReceipt) {
        0x9683c766ba6a483120310777f13d2329a928f21c8b3ce0509a93f782b0438565::state::set_version<T0>(arg1, 0);
        0x2::package::commit_upgrade(&mut arg0.cap, arg2);
    }

    public fun check_version<T0>(arg0: VersionGated, arg1: &0x9683c766ba6a483120310777f13d2329a928f21c8b3ce0509a93f782b0438565::state::State<T0>) {
        let VersionGated {  } = arg0;
        if (0x9683c766ba6a483120310777f13d2329a928f21c8b3ce0509a93f782b0438565::state::get_version<T0>(arg1) != 0) {
