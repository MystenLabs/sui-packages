module 0x931051321bfad33a5e325a35ee2eaa70885982f599d9662e79ddb62ea6f21f95::turbos_clmm {
    public fun fetch_pool_snapshot<T0, T1, T2>(arg0: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg1: 0x1::option::Option<u64>) : (u128, u32, u128, vector<u32>, vector<u128>, vector<u128>) {
        ...
        let v3 = 0x931051321bfad33a5e325a35ee2eaa70885982f599d9662e79ddb62ea6f21f95::clmm_common::resolve_tick_window(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::get_pool_tick_spacing<T0, T1, T2>(arg0));
        let (v4, v5, v6) = fetch_ticks_around<T0, T1, T2>(arg0, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::as_u32(v1), v3);
        (v0, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::as_u32(v1), v2, v4, v5, v6)
    }
