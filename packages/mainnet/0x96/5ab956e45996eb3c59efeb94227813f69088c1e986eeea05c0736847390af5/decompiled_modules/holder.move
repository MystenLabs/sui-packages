module 0x5922375f7a2e0d6c7cd69080352f40944061c2c4f33b5e02b24004e7b340832a::holder {
    ...
    public entry fun extract_asset_u8_key<T0: store + key>(arg0: &mut Holder, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        extract_asset<T0, u8>(arg0, arg1, arg2);
    }
    ...
    public entry fun store_asset_u8_key<T0: store + key>(arg0: &mut Holder, arg1: T0, arg2: u8) {
        0x2::dynamic_field::add<u8, T0>(&mut arg0.id, arg2, arg1);
    }
