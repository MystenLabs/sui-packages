module 0x9611b61b52f92f5dcfbb4722bc8d72eedad513a3bd7113614360c9874e1ae3f1::cnsnft7101 {
    struct CNSNFT7101 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7101, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7101>(arg0, arg1);
