module 0x96472879d03e9c9137f4135459a34059c9e925e6a71670d220cfd4df330c2710::reward1311 {
    struct REWARD1311 has drop {
        dummy_field: bool,
    }

    struct TICKET_1311 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1311(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1311>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1311>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1311, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1311>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1311>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1311>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1311>>(v5, 0x2::tx_context::sender(arg1));
    }
