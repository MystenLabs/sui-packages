module 0x96efd8928f9611f9f31fab6400b0324fedea532d6aef3cb7e26ed739adc12c13::cnsnft1117 {
    struct CNSNFT1117 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1117, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7590"));
        let v4 = 0x2::package::claim<CNSNFT1117>(arg0, arg1);
