module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::round_manager {
    ...
    fun claim_faith_internal(arg0: &mut Global, arg1: &mut 0x2::coin::TreasuryCap<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::claim_if_any_with_multiplier(arg2, 1000, soul_age_multiplier_bps_for_user(arg0, arg2), &mut arg0.cap, &mut arg0.idx, &mut arg0.buckets);
        if (v0 > 0) {
    ...
    fun settle(arg0: &mut Global, arg1: &0x2::random::Random, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
            ...
            if (v11 > 0) {
                ...
                while (v12 < v10 && v8 > 0) {
                    ...
                    if (v15 > 0) {
                        ...
                        0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::accrue_to(v13.owner, v14, &arg0.idx, &mut arg0.buckets, arg3);
                    };
                    v12 = v12 + 1;
                };
            };
        ...
        let v25 = 0;
        if (v10 > 0) {
            let (v26, v27, v28, v29, v30) = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::miracle::maybe_trigger(&mut arg0.miracle, 0x2::random::generate_u64(&mut v4));
            v21 = v26;
            v22 = v27;
            v23 = v28;
            v24 = v29;
        ...
        if (v31) {
                ...
                while (v37 < v10) {
                    ...
                    if (v39 > 0) {
                        ...
                        if (v41 > 0) {
                            ...
                            0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::accrue_to(v38.owner, v41, &arg0.idx, &mut arg0.buckets, arg3);
                        };
                    };
                    v37 = v37 + 1;
                };
            ...
            let v44 = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury::pilgrimage_balance(&arg0.vaults);
            if (v44 > 0) {
                let v45 = v44 / 50;
                let v46 = v45;
                if (v45 == 0) {
                ...
                if (v47 > 0) {
                    let v48 = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury::withdraw_pilgrimage(&mut arg0.vaults, v46, arg3);
                    let v49 = v46;
                    let v50 = 0;
                    while (v50 < v10 && v49 > 0) {
            ...
            while (v56 < 25) {
                ...
                if (v58 > 0) {
                    ...
                    while (v65 < v58) {
                        ...
                        let (_, _, v77) = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::preview_refinement(v66.owner, &arg0.idx, &arg0.buckets, 1000);
