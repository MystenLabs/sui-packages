module 0x7a4d081c482750bb489a3225d606ea1426079add752367e7dac49d02897f2cae::mm_demo {
    ...
    public fun destory_swap_cert<T0, T1>(arg0: FlashSwapCert<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut Vault, arg3: &0x2::clock::Clock) {
        let FlashSwapCert {
            loan_amount  : v0,
            repay_amount : v1,
            expired_at   : v2,
        } = arg0;
        assert!(0x2::coin::value<T0>(&arg1) == v1, err_insufficient_balance());
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg2.balances, v3)) {
            0x2::coin::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg2.balances, v3), arg1);
        } else {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::coin::Coin<T0>>(&mut arg2.balances, v3, arg1);
        };
        let v4 = SwapEvent{
    ...
    public fun destory_swap_cert_v2<T0, T1>(arg0: FlashSwapCert<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut Vault, arg3: &0x2::clock::Clock) {
        let FlashSwapCert {
            loan_amount  : v0,
            repay_amount : v1,
            expired_at   : v2,
    ...
    public fun new_swap_cert<T0, T1>(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: u64, arg4: 0x1::string::String, arg5: &0x2::clock::Clock) : (0x8c527eb289ee26634e9e96b1361bec1102443dab1c6787fb9b0b7e5d10618177::confirmer::ConfirmCert<T1>, FlashSwapCert<T0, T1>) {
        ...
        let v4 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::coin::Coin<T1>>(&mut arg0.balances, v3);
        assert!(0x2::coin::value<T1>(v4) > arg1, err_insufficient_balance());
        let v5 = FlashSwapCert<T0, T1>{
            loan_amount  : arg1,
            repay_amount : arg2,
            expired_at   : 0x2::clock::timestamp_ms(arg5) / 1000,
        };
        (0x8c527eb289ee26634e9e96b1361bec1102443dab1c6787fb9b0b7e5d10618177::confirmer::new_confirm_cert<T1>(0x2::balance::split<T1>(0x2::coin::balance_mut<T1>(v4), arg1)), v5)
    }

    public fun new_swap_cert_v2<T0, T1>(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: u64, arg4: 0x1::string::String, arg5: &0x2::clock::Clock) : (0x8c527eb289ee26634e9e96b1361bec1102443dab1c6787fb9b0b7e5d10618177::confirmer::ConfirmCert<T0>, FlashSwapCert<T0, T1>) {
        let v0 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        0x1::vector::append<u8>(&mut v0, 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T1>())));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg1));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg2));
