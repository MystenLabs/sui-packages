module 0x9676db99852779be445ef638e9e40803dcadd4a49b051cc13a851fd4a4b50250::ikachan {
    ...
    fun init(arg0: IKACHAN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<IKACHAN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ikachan"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"ikachan loves d3h3d"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://pRAfH2uo0KZ0oXLPj7y5FbK6s3HR3YqDG10UGgR2YTA"));
