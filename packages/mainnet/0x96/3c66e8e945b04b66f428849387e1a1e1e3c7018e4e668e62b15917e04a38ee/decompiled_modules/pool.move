module 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool {
    ...
    struct FlashSwapReceiptPartner<phantom T0, phantom T1> {
        pool_id: 0x2::object::ID,
        a_to_b: bool,
        pay_amount: u64,
    ...
    public(friend) fun swap<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: address, arg2: bool, arg3: u128, arg4: bool, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (u128, u128) {
        let v0 = compute_swap_result<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, false, 0, arg6, arg7);
    ...
    public fun check_position_exists<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: address, arg2: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg3: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32) : bool {
        0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, get_position_key_fix<T0, T1, T2>(arg0, arg1, arg2, arg3))
    }

    public fun check_position_exists_old<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: address, arg2: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg3: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32) : bool {
        0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, get_position_key_old(arg1, arg2, arg3))
    }
    ...
    public(friend) fun compute_swap_result<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: address, arg2: bool, arg3: u128, arg4: bool, arg5: u128, arg6: bool, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : ComputeSwapStateV2 {
        assert!(arg0.unlocked, 8);
        assert!(arg3 != 0, 7);
        ...
        let v0 = next_pool_reward_infos<T0, T1, T2>(arg0, 0x2::clock::timestamp_ms(arg8));
        ...
        while (v3.amount_specified_remaining > 0 && v3.sqrt_price != arg5) {
            ...
            if (v3.sqrt_price == v7) {
                if (v5) {
                    ...
                    let v17 = cross_tick<T0, T1, T2>(arg0, v6, v15, v16, &v0, arg6, arg9);
                    let v18 = v17;
                    if (arg2) {
            ...
            } else if (v3.sqrt_price != v3.sqrt_price) {
        ...
        if (!arg6) {
            ...
            if (arg7 > 0) {
                v3.partner_fee_amount = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::mul_div_floor(v3.protocol_fee, (arg7 as u128), 10000);
            };
            if (arg2) {
                arg0.fee_growth_global_a = v3.fee_growth_global;
                if (v3.protocol_fee > 0) {
                    arg0.protocol_fees_a = arg0.protocol_fees_a + (v3.protocol_fee as u64) - (v3.partner_fee_amount as u64);
                };
            } else {
                arg0.fee_growth_global_b = v3.fee_growth_global;
                if (v3.protocol_fee > 0) {
                    arg0.protocol_fees_b = arg0.protocol_fees_b + (v3.protocol_fee as u64) - (v3.partner_fee_amount as u64);
                };
            };
        };
    ...
    public(friend) fun convert_state_v2_to_v1(arg0: &ComputeSwapStateV2) : ComputeSwapState {
        ComputeSwapState{
            amount_a                   : arg0.amount_a,
            amount_b                   : arg0.amount_b,
            amount_specified_remaining : arg0.amount_specified_remaining,
            amount_calculated          : arg0.amount_calculated,
            sqrt_price                 : arg0.sqrt_price,
            tick_current_index         : arg0.tick_current_index,
            fee_growth_global          : arg0.fee_growth_global,
            protocol_fee               : arg0.protocol_fee,
            liquidity                  : arg0.liquidity,
    ...
    public(friend) fun fetch_ticks<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg2: u64) : (vector<TickInfo>, 0x1::option::Option<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32>) {
        assert!(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::gte(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::neg_from(443636)), 5);
        assert!(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::lte(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from(443636)), 5);
        let v0 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from_u32(443636);
        let v1 = arg0.tick_spacing;
        let v2 = 0x1::vector::empty<TickInfo>();
        let v3 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::mul(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from(v1), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::div(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from(v1)));
        let v4 = 0;
        while (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::lt(v3, v0) && v4 < arg2) {
            let (v5, v6) = next_initialized_tick_within_one_word<T0, T1, T2>(arg0, v3, false);
            if (v6) {
                let v7 = 0x2::dynamic_field::borrow<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, Tick>(&arg0.id, v5);
                let v8 = TickInfo{
                    id                     : 0x2::object::id<Tick>(v7),
                    tick_index             : v5,
                    liquidity_gross        : v7.liquidity_gross,
                    liquidity_net          : v7.liquidity_net,
                    fee_growth_outside_a   : v7.fee_growth_outside_a,
                    fee_growth_outside_b   : v7.fee_growth_outside_b,
                    reward_growths_outside : v7.reward_growths_outside,
                    initialized            : v7.initialized,
                };
                0x1::vector::push_back<TickInfo>(&mut v2, v8);
            };
            v4 = v4 + 1;
            v3 = v5;
        };
        if (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::lt(v3, v0) && v4 >= arg2) {
            (v2, 0x1::option::some<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32>(v3))
        } else {
            (v2, 0x1::option::none<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32>())
        }
    }

    public fun flash_swap<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: address, arg2: bool, arg3: u128, arg4: bool, arg5: u128, arg6: &0x2::clock::Clock, arg7: &Versioned, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, FlashSwapReceipt<T0, T1>) {
        check_version(arg7);
        assert!(arg0.unlocked, 8);
        let v0 = compute_swap_result<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, false, 0, arg6, arg8);
        let (v1, v2, v3) = if (arg2) {
            (0x2::coin::zero<T0>(arg8), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.coin_b, (v0.amount_b as u64)), arg8), (v0.amount_a as u64))
        } else {
            (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.coin_a, (v0.amount_a as u64)), arg8), 0x2::coin::zero<T1>(arg8), (v0.amount_b as u64))
        };
    ...
    public fun flash_swap_partner<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::Partner, arg2: bool, arg3: u128, arg4: bool, arg5: u128, arg6: &0x2::clock::Clock, arg7: &Versioned, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, FlashSwapReceiptPartner<T0, T1>) {
        check_version(arg7);
        assert!(arg0.unlocked, 8);
        let v0 = compute_swap_result<T0, T1, T2>(arg0, @0x0, arg2, arg3, arg4, arg5, false, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::current_ref_fee_rate(arg1, 0x2::clock::timestamp_ms(arg6) / 1000), arg6, arg8);
        let (v1, v2, v3) = if (arg2) {
            (0x2::coin::zero<T0>(arg8), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.coin_b, (v0.amount_b as u64)), arg8), (v0.amount_a as u64))
        } else {
            (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.coin_a, (v0.amount_a as u64)), arg8), 0x2::coin::zero<T1>(arg8), (v0.amount_b as u64))
        };
        let v4 = FlashSwapReceiptPartner<T0, T1>{
            pool_id            : 0x2::object::id<Pool<T0, T1, T2>>(arg0),
            a_to_b             : arg2,
            pay_amount         : v3,
            partner_id         : 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::Partner>(arg1),
            partner_fee_amount : (v0.partner_fee_amount as u64),
        };
        (v1, v2, v4)
    }

    public fun flash_swap_pay_amount<T0, T1>(arg0: &FlashSwapReceiptPartner<T0, T1>) : u64 {
        arg0.pay_amount
    }
    ...
    public fun get_pool_fee_growth_global<T0, T1, T2>(arg0: &Pool<T0, T1, T2>) : (u128, u128) {
    ...
    public fun get_pool_reward_last_updated_time_ms<T0, T1, T2>(arg0: &Pool<T0, T1, T2>) : u64 {
        arg0.reward_last_updated_time_ms
    }
    ...
    public fun get_position<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: address, arg2: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg3: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32) : &Position {
        get_position_by_key<T0, T1, T2>(arg0, get_position_key_fix<T0, T1, T2>(arg0, arg1, arg2, arg3))
    }
    ...
    public fun get_position_key_fix<T0, T1, T2>(arg0: &Pool<T0, T1, T2>, arg1: address, arg2: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg3: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32) : 0x1::string::String {
        let v0 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::string_tools::get_position_key_old(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::abs_u32(arg2), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::is_neg(arg2), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::abs_u32(arg3), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::is_neg(arg3));
        if (0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, v0)) {
            return v0
        };
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::string_tools::get_position_key(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::abs_u32(arg2), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::is_neg(arg2), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::abs_u32(arg3), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::is_neg(arg3))
    }

    public fun get_position_key_old(arg0: address, arg1: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg2: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32) : 0x1::string::String {
        0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::string_tools::get_position_key_old(arg0, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::abs_u32(arg1), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::is_neg(arg1), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::abs_u32(arg2), 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::is_neg(arg2))
    }
    ...
    fun get_position_mut<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: address, arg2: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg3: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32) : &mut Position {
        let v0 = get_position_key_fix<T0, T1, T2>(arg0, arg1, arg2, arg3);
        get_position_mut_by_key<T0, T1, T2>(arg0, v0)
    }
    ...
    public fun get_tick_fee_growth_outside(arg0: &Tick) : (u128, u128) {
        (arg0.fee_growth_outside_a, arg0.fee_growth_outside_b)
    }

    public fun get_tick_initialized(arg0: &Tick) : bool {
        arg0.initialized
    }

    public fun get_tick_liquidity_gross(arg0: &Tick) : u128 {
        arg0.liquidity_gross
    }

    public fun get_tick_liquidity_net(arg0: &Tick) : 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i128::I128 {
        arg0.liquidity_net
    }

    public fun get_tick_reward_growths_outside(arg0: &Tick) : vector<u128> {
        arg0.reward_growths_outside
    }
    ...
    public fun next_initialized_tick_within_one_word<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg2: bool) : (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, bool) {
        assert!(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::gte(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::neg_from(443636)), 5);
        assert!(0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::lte(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::from(443636)), 5);
    ...
    public fun repay_flash_swap<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: FlashSwapReceipt<T0, T1>, arg4: &Versioned) {
        check_version(arg4);
        ...
        assert!(arg0.unlocked, 8);
        assert!(v0 == 0x2::object::id<Pool<T0, T1, T2>>(arg0), 24);
        let v3 = 0x2::coin::into_balance<T0>(arg1);
        let v4 = 0x2::coin::into_balance<T1>(arg2);
        if (v1) {
            assert!(0x2::balance::value<T0>(&v3) == v2, 25);
            0x2::balance::join<T0>(&mut arg0.coin_a, v3);
            0x2::balance::destroy_zero<T1>(v4);
        } else {
            assert!(0x2::balance::value<T1>(&v4) == v2, 25);
            0x2::balance::join<T1>(&mut arg0.coin_b, v4);
            0x2::balance::destroy_zero<T0>(v3);
        };
    }

    public fun repay_flash_swap_partner<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::Partner, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: FlashSwapReceiptPartner<T0, T1>, arg5: &Versioned) {
        check_version(arg5);
        let FlashSwapReceiptPartner {
            pool_id            : v0,
            a_to_b             : v1,
            pay_amount         : v2,
            partner_id         : v3,
            partner_fee_amount : v4,
        } = arg4;
        assert!(arg0.unlocked, 8);
        assert!(v0 == 0x2::object::id<Pool<T0, T1, T2>>(arg0), 24);
        assert!(v3 == 0x2::object::id<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::Partner>(arg1), 27);
        let v5 = 0x2::coin::into_balance<T0>(arg2);
        let v6 = 0x2::coin::into_balance<T1>(arg3);
        if (v1) {
            assert!(0x2::balance::value<T0>(&v5) == v2, 25);
            if (v4 > 0) {
                0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::receive_ref_fee<T0>(arg1, 0x2::balance::split<T0>(&mut v5, v4));
            };
            0x2::balance::join<T0>(&mut arg0.coin_a, v5);
            0x2::balance::destroy_zero<T1>(v6);
        } else {
            assert!(0x2::balance::value<T1>(&v6) == v2, 25);
            if (v4 > 0) {
                0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner::receive_ref_fee<T1>(arg1, 0x2::balance::split<T1>(&mut v6, v4));
            };
            0x2::balance::join<T1>(&mut arg0.coin_b, v6);
            0x2::balance::destroy_zero<T0>(v5);
        };
    }

    public(friend) fun reset_reward<T0, T1, T2, T3>(arg0: &mut Pool<T0, T1, T2>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 < 3, 13);
        let v0 = 0x1::vector::borrow_mut<PoolRewardInfo>(&mut arg0.reward_infos, arg1);
        v0.growth_global = 0;
        v0.emissions_per_second = 0;
    }
    ...
    fun update_position<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: address, arg2: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg3: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg4: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i128::I128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = get_position_key_fix<T0, T1, T2>(arg0, arg1, arg2, arg3);
        update_position_metadata<T0, T1, T2>(arg0, v9, arg4, v6, v7, v8, arg6);
