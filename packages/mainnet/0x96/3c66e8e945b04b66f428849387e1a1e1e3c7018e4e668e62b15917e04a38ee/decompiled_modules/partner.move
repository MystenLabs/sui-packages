module 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::partner {
    struct PartnerAdminCap has store, key {
        id: 0x2::object::UID,
    }
    ...
    public fun claim_ref_fee<T0>(arg0: &PartnerCap, arg1: &mut Partner, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.partner_id == 0x2::object::id<Partner>(arg1), 5);
        let v0 = 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::get<T0>()));
        assert!(0x2::bag::contains<0x1::string::String>(&arg1.balances, v0), 6);
        let v1 = 0x2::bag::remove<0x1::string::String, 0x2::balance::Balance<T0>>(&mut arg1.balances, v0);
    ...
    public fun create_partner(arg0: &PartnerAdminCap, arg1: &mut Partners, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 > arg4, 4);
        assert!(arg5 >= 0x2::clock::timestamp_ms(arg7) / 1000, 4);
        assert!(arg3 < 10000, 2);
    ...
    public(friend) fun init_partners(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Partners{
            id       : 0x2::object::new(arg0),
            partners : 0x2::vec_map::empty<0x1::string::String, 0x2::object::ID>(),
        };
        let v1 = PartnerAdminCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<PartnerAdminCap>(v1, 0x2::tx_context::sender(arg0));
        0x2::transfer::share_object<Partners>(v0);
        let v2 = InitPartnerEvent{partners_id: 0x2::object::id<Partners>(&v0)};
        0x2::event::emit<InitPartnerEvent>(v2);
    }
    ...
    public fun update_ref_fee_rate(arg0: &PartnerAdminCap, arg1: &mut Partner, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 < 10000, 2);
    ...
    public fun update_time_range(arg0: &PartnerAdminCap, arg1: &mut Partner, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > arg2, 4);
        assert!(arg3 > 0x2::clock::timestamp_ms(arg4) / 1000, 4);
