module 0x5428f72551c41a53415e72788ec25068a4bed26e1ec7d649216dfe6dcc23a47e::newapp {
    ...
    public fun addFields<T0>(arg0: &Owner, arg1: &mut Contract<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = NewNetData{
            ...
            user_yy     : 0,
            admin_yy    : 0,
            user_table  : 0x2::table::new<address, u64>(arg2),
        };
        0x2::dynamic_field::add<vector<u8>, NewNetData>(&mut arg1.id, b"newNetData", v0);
    }
    ...
    public fun insertOrder<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, User>(v1, arg1), 9223374403381755903);
        ...
        0x5428f72551c41a53415e72788ec25068a4bed26e1ec7d649216dfe6dcc23a47e::event::purchase_event(arg1, arg2, v3, v4, v5);
    }
    ...
    public entry fun purchase<T0, T1, T2>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4 > 0) {
            ...
            deposit<T0>(v2, arg1, arg5, arg6, arg7, arg8, arg9);
        ...
        let v9 = 0;
        if (v8 > 0) {
            preSwap<T2, T0>(arg4, arg3 * (v8 as u64) / 100);
        ...
        0x5428f72551c41a53415e72788ec25068a4bed26e1ec7d649216dfe6dcc23a47e::event::purchase_event(v0, arg3, v11, v5, v9);
    }
    ...
    fun update_user_level(arg0: &0x2::table::Table<address, User>, arg1: address) : u8 {
        ...
        let v2 = if (v1 >= 100000000000) {
            3
        } else if (v1 >= 50000000000) {
            2
        } else if (v1 >= 10000000000) {
            1
        } else {
            0
        };
    ...
    public entry fun withdraw<T0, T1, T2>(arg0: &mut Contract<T1>, arg1: u64, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T0>, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg7: &0x2::clock::Clock, arg8: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = &arg0.vault;
        let v1 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, 0x2::tx_context::sender(arg9));
        assert!(arg1 > 0, 0);
        ...
        let v7 = 0x2::dynamic_field::borrow_mut<vector<u8>, NewNetData>(&mut arg0.id, b"newNetData");
        if (0x2::table::contains<address, u64>(&mut v7.user_table, 0x2::tx_context::sender(arg9))) {
            let v8 = 0x2::table::borrow_mut<address, u64>(&mut v7.user_table, 0x2::tx_context::sender(arg9));
            *v8 = *v8 + arg1;
        } else {
            0x2::table::add<address, u64>(&mut v7.user_table, 0x2::tx_context::sender(arg9), arg1);
        };
        if (v4 > 0) {
            let v9 = withdrawSui<T0>(v0, preSwap<T2, T0>(arg2, v4), arg3, arg4, arg5, arg6, arg7, arg8, arg9);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v9, 0x2::tx_context::sender(arg9));
            v7.consume_sui = v7.consume_sui + 0x2::coin::value<T0>(&v9);
        };
        if (v5 > 0) {
            let v10 = &mut arg0.yy_balace;
            preSwap<T2, T0>(arg2, v5);
            let v11 = 0;
            assert!(v11 <= 0x2::balance::value<T1>(v10), 5);
            let v12 = 0x2::coin::take<T1>(v10, v11, arg9);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v12, 0x2::tx_context::sender(arg9));
            v7.user_yy = v7.user_yy + 0x2::coin::value<T1>(&v12);
        };
        let v13 = v2 / 2;
        if (v13 > 0) {
            preSwap<T2, T0>(arg2, v13);
        };
        let v14 = &mut arg0.prize_pool;
        v14.level5_gross = v14.level5_gross + v13 * 50 / 100;
        v14.level6_gross = v14.level6_gross + v13 * 30 / 100;
        v14.level7_gross = v14.level7_gross + v13 * 20 / 100;
        0x5428f72551c41a53415e72788ec25068a4bed26e1ec7d649216dfe6dcc23a47e::event::withdraw_event(0x2::tx_context::sender(arg9), arg1, v13, v4, v5);
    }
