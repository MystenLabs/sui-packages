module 0x549cff449ff8e26f1b96809949462b125305df9fcfe0a59812143e162b90314a::cnsnft5974 {
    struct CNSNFT5974 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5974, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5974>(arg0, arg1);
