module 0x54565cf420aaf356d6abfc9e76345ffc6e1b13f094a1e46d3bbf2b5d7cee6091::reward9355 {
    struct REWARD9355 has drop {
        dummy_field: bool,
    }

    struct TICKET_9355 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9355(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9355>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9355>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9355, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9355>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9355>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9355>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9355>>(v5, 0x2::tx_context::sender(arg1));
    }
