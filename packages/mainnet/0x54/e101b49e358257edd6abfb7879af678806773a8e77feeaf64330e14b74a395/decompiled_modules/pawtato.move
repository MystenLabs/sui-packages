module 0x54e101b49e358257edd6abfb7879af678806773a8e77feeaf64330e14b74a395::pawtato {
    ...
    fun init(arg0: PAWTATO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pawtato"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The leading DeFi dApp Aggregator and Wallet Manager on Sui - built to equip you with powerful tools to thrive."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://RQ7QFlmAcbbMyiaWWzxKefFjGq06_XIg92rtSysNnh8"));
