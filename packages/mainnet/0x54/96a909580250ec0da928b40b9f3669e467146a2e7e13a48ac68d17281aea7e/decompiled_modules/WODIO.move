module 0x5496a909580250ec0da928b40b9f3669e467146a2e7e13a48ac68d17281aea7e::WODIO {
    ...
    fun init(arg0: WODIO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<WODIO>(arg0, 6, b"WODIO", b"Sui Wogtardio", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pump.mypinata.cloud/ipfs/QmSCi1fveJog1vpUCBnhUxqY4KvkvZfjH4iz9VMFeSUfww?img-width=256&img-dpr=2&img-onerror=redirect")), false, arg1);
        let v3 = v0;
