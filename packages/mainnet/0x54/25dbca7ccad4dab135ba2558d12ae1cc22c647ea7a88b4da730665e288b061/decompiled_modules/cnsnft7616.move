module 0x5425dbca7ccad4dab135ba2558d12ae1cc22c647ea7a88b4da730665e288b061::cnsnft7616 {
    struct CNSNFT7616 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7616, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7616>(arg0, arg1);
