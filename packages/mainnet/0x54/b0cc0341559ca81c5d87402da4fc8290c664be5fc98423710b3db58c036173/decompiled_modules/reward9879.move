module 0x54b0cc0341559ca81c5d87402da4fc8290c664be5fc98423710b3db58c036173::reward9879 {
    struct REWARD9879 has drop {
        dummy_field: bool,
    }

    struct TICKET_9879 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9879(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9879>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9879>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9879>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9879>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9879>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9879>>(v5, 0x2::tx_context::sender(arg1));
    }
