module 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::market {
    ...
    public fun check_version<T0>(arg0: &Market<T0>) {
        assert!(get_market_version<T0>(arg0) == 34, 29);
    }
    ...
    public entry fun execute_decrease_market_order<T0, T1, T2, T3, T4>(arg0: &0x2::clock::Clock, arg1: &mut Market<T0>, arg2: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::model::ReservingFeeModel, arg3: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::model::FundingFeeModel, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: address, arg7: address, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::fee::get_fee_collector(v15);
        let v17 = get_symbol_instant_exit_fee_config<T2, T3>(&arg1.id);
        let v18 = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::position::clone_position_instant_exit_fee_config(&v17);
        let (v19, v20) = get_referral_data(&arg1.referrals, arg6);
        let v21 = LossProtectionVaultName<T1>{dummy_field: false};
        let (v22, v23) = if (0x2::dynamic_object_field::exists_<LossProtectionVaultName<T1>>(&arg1.id, v21)) {
            if (0x2::dynamic_object_field::borrow<LossProtectionVaultName<T1>, LossProtectionVaultConfig<T1>>(&arg1.id, v21).enabled) {
                let v24 = 0x2::dynamic_object_field::borrow_mut<LossProtectionVaultName<T1>, LossProtectionVaultConfig<T1>>(&mut arg1.id, v21);
                0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::execute_decrease_market_order_with_loss_protection<T1, T4>(v6, v8, v10, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::fee::get_fee_rate(v15), 0x2::bag::borrow_mut<PositionName<T1, T2, T3>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::position::Position<T1>>(&mut arg1.positions, v4), arg2, arg3, &v11, &v14, v19, v3, lp_supply_amount<T0>(arg1), &v18, v0, v1, &mut v24.vault, v24.loss_percentage)
            } else {
        ...
        let (v25, v26, v27, v28, v29) = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::pool::unwrap_decrease_position_result_v2<T1>(v22);
        let v30 = v28;
        pay_from_balance<T1>(v25, arg6, arg9);
        pay_from_balance<T1>(v26, v20, arg9);
        pay_from_balance<T1>(v27, v16, arg9);
        if (0x2::balance::value<T1>(&v30) > 0) {
            if (0x1::option::is_some<0x2::object::ID>(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::get_scard_id_from_decrease_market_order<T4>(v6))) {
                let v31 = *0x1::option::borrow<0x2::object::ID>(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::get_scard_id_from_decrease_market_order<T4>(v6));
                pay_from_balance<T1>(v30, 0x2::object::id_to_address(&v31), arg9);
            } else {
                pay_from_balance<T1>(v30, v16, arg9);
            };
        } else {
            pay_from_balance<T1>(v30, v16, arg9);
        };
        let v32 = PositionClaimed<PositionName<T1, T2, T3>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::pool::DecreasePositionSuccessEventV2>{
            position_name : 0x1::option::some<PositionName<T1, T2, T3>>(v4),
            event         : v29,
        };
        let v33 = OrderExecuted<OrderName<T1, T2, T3, T4>, PositionClaimed<PositionName<T1, T2, T3>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::pool::DecreasePositionSuccessEventV2>>{
            executor   : v2,
            order_name : v5,
            claim      : v32,
        };
        0x2::event::emit<OrderExecuted<OrderName<T1, T2, T3, T4>, PositionClaimed<PositionName<T1, T2, T3>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::pool::DecreasePositionSuccessEventV2>>>(v33);
        pay_from_balance<T4>(v23, v2, arg9);
    }
    ...
    public entry fun execute_decrease_position_order_v2_1<T0, T1, T2, T3, T4>(arg0: &0x2::clock::Clock, arg1: &mut Market<T0>, arg2: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::model::ReservingFeeModel, arg3: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::model::FundingFeeModel, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: address, arg7: address, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let (v22, v23) = if (0x2::dynamic_object_field::exists_<LossProtectionVaultName<T1>>(&arg1.id, v21)) {
            if (0x2::dynamic_object_field::borrow<LossProtectionVaultName<T1>, LossProtectionVaultConfig<T1>>(&arg1.id, v21).enabled) {
                let v24 = 0x2::dynamic_object_field::borrow_mut<LossProtectionVaultName<T1>, LossProtectionVaultConfig<T1>>(&mut arg1.id, v21);
                0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::execute_decrease_position_order_v2_1_with_loss_protection<T1, T4>(v6, v8, v10, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::fee::get_fee_rate(v15), 0x2::bag::borrow_mut<PositionName<T1, T2, T3>, 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::position::Position<T1>>(&mut arg1.positions, v4), arg2, arg3, &v11, &v14, v19, v3, lp_supply_amount<T0>(arg1), &v18, v0, v1, &mut v24.vault, v24.loss_percentage)
            } else {
        ...
        if (0x2::balance::value<T1>(&v30) > 0) {
            if (0x1::option::is_some<0x2::object::ID>(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::get_scard_id_from_decrease_order_v2<T4>(v6))) {
                let v31 = *0x1::option::borrow<0x2::object::ID>(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::get_scard_id_from_decrease_order_v2<T4>(v6));
                pay_from_balance<T1>(v30, 0x2::object::id_to_address(&v31), arg9);
            } else {
                pay_from_balance<T1>(v30, v16, arg9);
            };
    ...
    public entry fun execute_open_market_order<T0, T1, T2, T3, T4>(arg0: &0x2::clock::Clock, arg1: &mut Market<T0>, arg2: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::model::ReservingFeeModel, arg3: &0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::model::FundingFeeModel, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: address, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v17, v18) = 0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::execute_open_market_order<T1, T4>(v5, v7, v9, v14, arg2, arg3, &v10, &v13, v15, v3, lp_supply_amount<T0>(arg1), v0, v1);
        ...
        if (0x2::balance::value<T1>(&v24) > 0) {
            if (0x1::option::is_some<0x2::object::ID>(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::get_scard_id_from_open_market_order<T1, T4>(v5))) {
                let v29 = *0x1::option::borrow<0x2::object::ID>(0xc44d97a4bc4e5a33ca847b72b123172c88a6328196b71414f32c3070233604b2::orders::get_scard_id_from_open_market_order<T1, T4>(v5));
