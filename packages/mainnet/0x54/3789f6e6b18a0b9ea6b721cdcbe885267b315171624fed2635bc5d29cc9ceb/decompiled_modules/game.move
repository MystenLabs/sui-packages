module 0x543789f6e6b18a0b9ea6b721cdcbe885267b315171624fed2635bc5d29cc9ceb::game {
    ...
    public entry fun place_bet(arg0: &mut GameState, arg1: &mut 0x543789f6e6b18a0b9ea6b721cdcbe885267b315171624fed2635bc5d29cc9ceb::player_registry::Registry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (0x543789f6e6b18a0b9ea6b721cdcbe885267b315171624fed2635bc5d29cc9ceb::player_registry::is_valid_referrer(arg1, arg3)) {
            let v4 = 0x543789f6e6b18a0b9ea6b721cdcbe885267b315171624fed2635bc5d29cc9ceb::player_registry::get_player_address(arg1, arg3);
            if (v4 == v0) {
                arg0.admin
            } else {
                v4
        ...
        if (v3 != arg0.admin) {
            let v7 = v1 * 1 / 100;
            if (v7 > 0) {
                0x543789f6e6b18a0b9ea6b721cdcbe885267b315171624fed2635bc5d29cc9ceb::player_registry::add_referral_reward(arg1, v3, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v6, v7), arg5), arg4);
            };
        };
