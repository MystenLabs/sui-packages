module 0x54f1e84c05c211534d478bd79ad7d1b36d867933607a0d92078fa2acdc62df71::passionnn {
    ...
    fun init(arg0: PASSIONNN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<AppCap>(v6, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun mint(arg0: &mut AppCap, arg1: 0x1::string::String, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"Cute"));
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(b"Happy"));
        let v3 = Passionnn{
