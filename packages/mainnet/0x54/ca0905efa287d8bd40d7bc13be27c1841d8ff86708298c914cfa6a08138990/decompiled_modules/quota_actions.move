module 0x54ca0905efa287d8bd40d7bc13be27c1841d8ff86708298c914cfa6a08138990::quota_actions {
    ...
    public fun do_set_quotas<T0: store, T1: drop>(arg0: &mut 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::executable::Executable<T0>, arg1: &mut 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::account::Account, arg2: &0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::package_registry::PackageRegistry, arg3: T1, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::action_validation::assert_action_type<SetQuotas>(v1);
        let v2 = 0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::intents::action_spec_data(v1);
        assert!(0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::intents::action_spec_version(v1) == 1, 0);
        ...
        0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::futarchy_config::set_quotas_from_execution<T0, ExecutionProgressWitness>(arg1, arg2, arg0, v11, v10.users, v10.period_ms, v10.feeless_proposal_amount, v10.sponsor_amount, arg4);
        ...
        0x3cacffe79bfedd8d0e1473d8e57b95b729803b680e4badb11a545e5cd2660cf2::executable::increment_action_idx<T0, SetQuotas, ExecutionProgressWitness>(arg0, arg2, v13);
    }
