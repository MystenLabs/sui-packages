module 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::rwa {
    struct RWA has drop {
        dummy_field: bool,
    }
    ...
    struct RwaProject has key {
        ...
        admin: address,
        financier: address,
        price: 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::Ratio,
        balance: 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::SBalance<RWA>,
        revenue_balance: 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::SBalance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>,
        dividend_records: 0x2::object_bag::ObjectBag,
        dividend_batches: u64,
        dividend_funds_balance: 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::SBalance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>,
    ...
    struct DividendBatchRecord has store, key {
        ...
        dividend_funds: u64,
        dividend_funds_ratio: 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::Ratio,
    ...
    fun do_add_dividend_list(arg0: &mut RwaProject, arg1: vector<u8>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(!0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::utils::has_duplicate<address>(&arg2), 100014);
        ...
        assert!(v0.dividend_funds >= 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::partial(v0.dividend_funds_ratio, (v2 as u64)), 100017);
        while (!0x1::vector::is_empty<address>(&arg2)) {
            ...
            let v7 = 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::partial(v0.dividend_funds_ratio, v6);
    ...
    fun do_buy_token(arg0: &mut TokenIdo, arg1: &mut 0x2::deny_list::DenyList, arg2: &mut RwaProject, arg3: vector<0x2::coin::Coin<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>>, arg4: u64, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::partial(arg2.price, arg4);
        0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::increase<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&mut arg2.revenue_balance, 0x2::coin::into_balance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::utils::merge_coins_to_amount_and_transfer_back_rest<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(arg3, v1, arg6)));
        0x2::transfer::public_transfer<0x2::coin::Coin<RWA>>(0x2::coin::from_balance<RWA>(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::split<RWA>(&mut arg2.balance, arg4), arg6), arg5);
        if (!arg2.isSoldOut) {
            0x2::table::add<address, bool>(&mut arg2.purchaseAddressesBeforeSoldOut, arg5, true);
        };
        if (0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::value<RWA>(&arg2.balance) == 0) {
            arg2.isSoldOut = true;
        ...
        let v2 = BuyRwaTokenEvent{
            ...
            user       : v0,
            recipient  : arg5,
            price      : 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::partial(arg2.price, 1000000000),
            buy_amount : arg4,
            pay_amount : v1,
        };
    ...
    fun do_claim_dividend_funds(arg0: &mut RwaProject, arg1: vector<u8>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::value<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&arg0.dividend_funds_balance) >= v2.dividend_income, 100022);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>>(0x2::coin::from_balance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::split<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&mut arg0.dividend_funds_balance, v2.dividend_income), arg3), arg2);
    ...
    fun do_increase_supply(arg0: &mut TokenBank, arg1: &mut RwaProject, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::increase<RWA>(&mut arg1.balance, 0x2::coin::into_balance<RWA>(0x2::coin::mint<RWA>(&mut arg0.treasury_cap, arg2, arg3)));
    ...
    fun do_set_price(arg0: &mut RwaProject, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 100008);
        assert!(arg0.version == 0, 100001);
        arg0.price = 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::ratio(arg1, 1000000000);
        let v0 = PriceChangedEvent{
            project_id : 0x2::object::id<RwaProject>(arg0),
            old_price  : 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::partial(arg0.price, 1000000000),
            new_price  : arg1,
        };
    ...
    fun do_submit_dividend_batch(arg0: &mut RwaProject, arg1: vector<u8>, arg2: vector<0x2::coin::Coin<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::increase<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&mut arg0.dividend_funds_balance, 0x2::coin::into_balance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::utils::merge_coins_to_amount_and_transfer_back_rest<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(arg2, arg3, arg5)));
        ...
        let v2 = DividendBatchRecord{
            ...
            dividend_funds             : arg3,
            dividend_funds_ratio       : 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::ratio(arg3, arg4),
    ...
    fun do_withdraw_dividend_funds(arg0: &mut RwaProject, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::value<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&arg0.dividend_funds_balance) >= arg1, 100006);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>>(0x2::coin::from_balance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::split<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&mut arg0.dividend_funds_balance, arg1), arg3), arg2);
    ...
    fun do_withdraw_revenue(arg0: &mut RwaProject, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == arg0.admin, 100008);
        assert!(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::value<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&arg0.revenue_balance) >= arg1, 100023);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>>(0x2::coin::from_balance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::split<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(&mut arg0.revenue_balance, arg1), arg3), arg2);
    ...
    fun init_impl(arg0: RWA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = RwaProject{
            id                             : v9,
            version                        : 0,
            rwa_key                        : b"8e1cec682df549bc8efd00798e78e8cf",
            freezeUntilSoldOut             : true,
            isSoldOut                      : false,
            admin                          : v4,
            financier                      : v4,
            price                          : 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::ratio::ratio(1000000000, 1000000000),
            balance                        : 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::from_balance<RWA>(0x2::coin::into_balance<RWA>(0x2::coin::mint<RWA>(&mut v3, 100, arg1))),
            revenue_balance                : 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::from_balance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(0x2::balance::zero<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>()),
            dividend_records               : 0x2::object_bag::new(arg1),
            dividend_batches               : 0,
            dividend_funds_balance         : 0x54e5333d83ba7253f634b3d0f6ef0656e690bd8a43820621332e4d9ae04fcd6d::sbalance::from_balance<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>(0x2::balance::zero<0xb7e0f3afadf787a173ea7e7b73386072d59ea41d7bcd86de6663aa9d20e31708::usdh::USDH>()),
            bank_id                        : v6,
            ido_id                         : v8,
