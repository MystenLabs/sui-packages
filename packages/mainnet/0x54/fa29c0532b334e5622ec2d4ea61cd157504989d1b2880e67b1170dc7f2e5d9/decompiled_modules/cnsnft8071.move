module 0x54fa29c0532b334e5622ec2d4ea61cd157504989d1b2880e67b1170dc7f2e5d9::cnsnft8071 {
    struct CNSNFT8071 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8071, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8071>(arg0, arg1);
