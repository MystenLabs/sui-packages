module 0x54bef48e6bd477d3cf8d7ee4bbecb67a2a4235074b8d3e65973a250bd4921aac::suibeacon {
    ...
    public entry fun mint(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut TeamRegistry, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<0x1::string::String, vector<address>>(&arg5.team_members, v1)) {
            0x2::table::add<0x1::string::String, vector<address>>(&mut arg5.team_members, v1, 0x1::vector::empty<address>());
        };
        let v2 = MemberNFT{
        ...
        0x2::transfer::public_transfer<MemberNFT>(v2, v0);
    }
