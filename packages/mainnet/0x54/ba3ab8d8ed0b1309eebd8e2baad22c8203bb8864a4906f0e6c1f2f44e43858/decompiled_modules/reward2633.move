module 0x54ba3ab8d8ed0b1309eebd8e2baad22c8203bb8864a4906f0e6c1f2f44e43858::reward2633 {
    struct REWARD2633 has drop {
        dummy_field: bool,
    }

    struct TICKET_2633 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2633(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2633>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2633>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2633, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2633>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2633>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2633>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2633>>(v5, 0x2::tx_context::sender(arg1));
    }
