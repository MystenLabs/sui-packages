module 0xf61ac5955974a2032d83c63c61638471e6373da50992b0856c6020093f33c43d::usdc_vault {
    ...
    struct USDCDirectDeposited has copy, drop {
    ...
    public fun claim_coin<T0>(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg3: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::transfer::public_receive<0x2::coin::Coin<T0>>(&mut arg0.id, arg2), @0x9ea517273b15e3cf09eaf69bd5b5195716edf473337a0e47be4c6ae82e5f795a);
    }
    ...
    public fun create_admin_cap_to(arg0: &USDCVault, arg1: &SuperAdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_direct(arg0: 0x1::string::String, arg1: &mut USDCVault, arg2: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &mut 0x2::tx_context::TxContext) {
        deposit(arg1, arg2, arg3);
        let v0 = USDCDirectDeposited{
            id        : arg0,
            vault_id  : 0x2::object::id<USDCVault>(arg1),
        ...
        0x2::event::emit<USDCDirectDeposited>(v0);
    }
    ...
    public fun deposit_with_super(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        deposit(arg0, arg2, arg3);
    }
    ...
    public fun pause(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        arg0.paused = true;
        let v0 = Paused{
            vault_id  : 0x2::object::id<USDCVault>(arg0),
    ...
    public fun revoke_admin_permission(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
    ...
    public fun unpause(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        arg0.paused = false;
        let v0 = Unpaused{
            vault_id  : 0x2::object::id<USDCVault>(arg0),
    ...
    public fun withdraw_with_super(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(withdraw(arg0, arg2, arg3), @0x9ea517273b15e3cf09eaf69bd5b5195716edf473337a0e47be4c6ae82e5f795a);
    }
