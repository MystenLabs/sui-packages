module 0xf61ac5955974a2032d83c63c61638471e6373da50992b0856c6020093f33c43d::meme_vault {
    ...
    public fun claim_coin<T0>(arg0: &mut VaultManager, arg1: &SuperAdminCap, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_admin_cap_to(arg0: &VaultManager, arg1: &SuperAdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_direct<T0>(arg0: 0x1::string::String, arg1: &mut VaultManager, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_with_super<T0>(arg0: &mut VaultManager, arg1: &SuperAdminCap, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        deposit<T0>(arg0, arg2, arg3);
    }
    ...
    public fun pause(arg0: &mut VaultManager, arg1: &SuperAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        arg0.paused = true;
        let v0 = Paused{
    ...
    public fun revoke_admin_permission(arg0: &mut VaultManager, arg1: &SuperAdminCap, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
    ...
    public fun unpause(arg0: &mut VaultManager, arg1: &SuperAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        arg0.paused = false;
        let v0 = Unpaused{
            vault_id  : 0x2::object::id<VaultManager>(arg0),
    ...
    public fun withdraw_with_super<T0>(arg0: &mut VaultManager, arg1: &SuperAdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
