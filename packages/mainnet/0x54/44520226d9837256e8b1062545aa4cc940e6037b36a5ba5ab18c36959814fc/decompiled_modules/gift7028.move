module 0x5444520226d9837256e8b1062545aa4cc940e6037b36a5ba5ab18c36959814fc::gift7028 {
    struct GIFT7028 has drop {
        dummy_field: bool,
    }

    struct TICKET_7028 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7028(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7028>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7028>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7028, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7028>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7028>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7028>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7028>>(v5, 0x2::tx_context::sender(arg1));
    }
