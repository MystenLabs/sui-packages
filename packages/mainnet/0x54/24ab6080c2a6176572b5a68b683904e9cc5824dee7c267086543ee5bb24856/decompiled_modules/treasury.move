module 0x5424ab6080c2a6176572b5a68b683904e9cc5824dee7c267086543ee5bb24856::treasury {
    struct Treasury has store, key {
        id: 0x2::object::UID,
        vaults: 0x2::bag::Bag,
    }

    public fun deposit<T0>(arg0: &0x5424ab6080c2a6176572b5a68b683904e9cc5824dee7c267086543ee5bb24856::admin_cap::AdminCap, arg1: &mut Treasury, arg2: 0x2::balance::Balance<T0>) {
    ...
    public entry fun withdraw<T0>(arg0: &0x5424ab6080c2a6176572b5a68b683904e9cc5824dee7c267086543ee5bb24856::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        if (!0x2::bag::contains<0x1::type_name::TypeName>(&arg1.vaults, v0)) {
            abort 20
        };
