module 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool {
    ...
    public(friend) fun fetch_ticks<T0, T1, T2>(arg0: &mut Pool<T0, T1, T2>, arg1: 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, arg2: u64) : (vector<TickInfo>, 0x1::option::Option<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32>) {
        ...
        let v2 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::sub(arg1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::mod_euclidean(arg1, arg0.tick_spacing));
        let v3 = 0;
        while (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::lt(v2, v0) && v3 < arg2) {
            let (v4, v5) = next_initialized_tick_within_one_word<T0, T1, T2>(arg0, v2, false);
            if (v5) {
                let v6 = 0x2::dynamic_field::borrow<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32, Tick>(&arg0.id, v4);
                let v7 = TickInfo{
                    id                     : 0x2::object::id<Tick>(v6),
                    tick_index             : v4,
                    liquidity_gross        : v6.liquidity_gross,
                    liquidity_net          : v6.liquidity_net,
                    fee_growth_outside_a   : v6.fee_growth_outside_a,
                    fee_growth_outside_b   : v6.fee_growth_outside_b,
                    reward_growths_outside : v6.reward_growths_outside,
                    initialized            : v6.initialized,
                };
                0x1::vector::push_back<TickInfo>(&mut v1, v7);
            };
            v3 = v3 + 1;
            v2 = v4;
        };
        if (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::lt(v2, v0) && v3 >= arg2) {
            (v1, 0x1::option::some<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32>(v2))
        } else {
            (v1, 0x1::option::none<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::i32::I32>())
        }
    }
