module 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_sqrt_price {
    ...
    fun get_next_sqrt_price_from_amount_a_rounding_up(arg0: u128, arg1: u128, arg2: u128, arg3: bool) : u128 {
        ...
        let v0 = (arg0 as u256);
        let v1 = (arg1 as u256);
        let (v2, v3) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_u256::checked_shlw(v1);
        assert!(!v3, 3);
        let v4 = if (arg3) {
            v2 + (arg2 as u256) * v0
        } else {
        ...
        (0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::math_u256::div_round(v1 * v0 << 64, v4, true) as u128)
    }
