module 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::interest_pool {
    ...
    public(friend) fun new<T0>(arg0: 0x2::vec_set::VecSet<0x1::type_name::TypeName>, arg1: 0x2::versioned::Versioned, arg2: &mut 0x2::tx_context::TxContext) : (InterestPool<T0>, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::PoolAdmin) {
        0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::curves::assert_curve<T0>();
        let v0 = 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::new(arg2);
        let v1 = InterestPool<T0>{
            id                 : 0x2::object::new(arg2),
            coins              : arg0,
            state              : arg1,
            pool_admin_address : 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::addy(&v0),
    ...
    public fun assert_pool_admin<T0>(arg0: &InterestPool<T0>, arg1: &0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::PoolAdmin) {
        assert!(arg0.pool_admin_address == 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::addy(arg1), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::invalid_pool_admin());
    }
    ...
    fun confirm<T0>(arg0: &InterestPool<T0>, arg1: Request) {
        ...
        let v4 = v3;
        let v5 = v1;
        assert!(addy<T0>(arg0) == v2, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::wrong_request_pool_address());
        ...
        assert!(!0x1::vector::is_empty<0x1::type_name::TypeName>(&v6), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::invalid_hook_name());
        let v7 = 0;
        while (0x1::vector::length<0x1::type_name::TypeName>(&v6) > v7) {
            assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&v4, 0x1::vector::borrow<0x1::type_name::TypeName>(&v6, v7)), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::rule_not_approved());
            v7 = v7 + 1;
        };
    }
    ...
    public fun finish<T0>(arg0: &InterestPool<T0>, arg1: Request) {
        ...
        assert!(0x1::string::index_of(&v0, &v1) == 0, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::must_be_finish_request());
        confirm<T0>(arg0, arg1);
    }

    public(friend) fun finish_add_liquidity<T0>(arg0: &InterestPool<T0>, arg1: Request) : Request {
        assert!(has_add_liquidity_hooks<T0>(arg0), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::pool_has_no_add_liquidity_hooks());
        let v0 = name(&arg1);
        let v1 = b"START_ADD_LIQUIDITY";
        assert!(0x1::string::bytes(&v0) == &v1, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::must_be_start_add_liquidity_request());
        confirm<T0>(arg0, arg1);
    ...
    public(friend) fun finish_donate<T0>(arg0: &InterestPool<T0>, arg1: Request) : Request {
        assert!(has_donate_hooks<T0>(arg0), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::pool_has_no_donate_hooks());
        let v0 = name(&arg1);
        let v1 = b"START_DONATE";
        assert!(0x1::string::bytes(&v0) == &v1, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::must_be_start_donate_request());
        confirm<T0>(arg0, arg1);
    ...
    public(friend) fun finish_remove_liquidity<T0>(arg0: &InterestPool<T0>, arg1: Request) : Request {
        assert!(has_remove_liquidity_hooks<T0>(arg0), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::pool_has_no_remove_liquidity_hooks());
        let v0 = name(&arg1);
        let v1 = b"START_REMOVE_LIQUIDITY";
        assert!(0x1::string::bytes(&v0) == &v1, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::must_be_start_remove_liquidity_request());
        confirm<T0>(arg0, arg1);
    ...
    public(friend) fun finish_swap<T0>(arg0: &InterestPool<T0>, arg1: Request) : Request {
        assert!(has_swap_hooks<T0>(arg0), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::pool_has_no_swap_hooks());
        let v0 = name(&arg1);
        let v1 = b"START_SWAP";
        assert!(0x1::string::bytes(&v0) == &v1, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::must_be_start_swap_request());
        confirm<T0>(arg0, arg1);
    ...
    public(friend) fun new_with_hooks<T0>(arg0: 0x2::vec_set::VecSet<0x1::type_name::TypeName>, arg1: 0x2::versioned::Versioned, arg2: HooksBuilder, arg3: &mut 0x2::tx_context::TxContext) : (InterestPool<T0>, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::PoolAdmin) {
        0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::curves::assert_curve<T0>();
        let HooksBuilder {
            rules  : v0,
            config : v1,
        } = arg2;
        let v2 = 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::new(arg3);
        let v3 = Hooks{
            rules  : v0,
            config : v1,
        };
        let v4 = InterestPool<T0>{
            ...
            coins              : arg0,
            state              : arg1,
            pool_admin_address : 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::addy(&v2),
    ...
    public fun uid_mut<T0>(arg0: &mut InterestPool<T0>, arg1: &0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_admin::PoolAdmin) : &mut 0x2::object::UID {
