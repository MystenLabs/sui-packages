module 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::pool_events {
    ...
    public(friend) fun emit_claim_admin_fees<T0>(arg0: u64) {
        let v0 = ClaimAdminFees<0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::curves::Volatile, T0>{amount: arg0};
        0x2::event::emit<ClaimAdminFees<0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::curves::Volatile, T0>>(v0);
    }
