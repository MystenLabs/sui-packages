module 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::volatile_math {
    fun assert_ann_is_within_range(arg0: u256, arg1: u64) {
        assert!(arg0 >= min_a(arg1) && arg0 <= max_a(arg1), 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::invalid_amplifier());
    }

    fun assert_balance_is_within_range(arg0: u256) {
        assert!(arg0 >= 10000000000000000 && arg0 <= 100000000000000000000, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::unsafe_value());
    }

    fun assert_gamma_is_within_range(arg0: u256) {
        assert!(arg0 >= 10000000000 && arg0 <= 50000000000000000, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::invalid_gamma());
    }
    ...
    public fun geometric_mean(arg0: vector<u256>, arg1: bool) : u256 {
        ...
        let v3 = 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::head<u256>(v1);
        let v4 = 0;
        while (0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::math256::diff(v4, v3) > 1 && 0x7ba65fa88ed4026304b7f95ee86f96f8169170efe84b56d465b4fe305e2486cb::math256::diff(v4, v3) * 1000000000000000000 >= v3) {
            ...
            let v8 = v3 * ((0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(v2) - 1) * 1000000000000000000 + v5);
            v3 = v8 / 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(v2) * 1000000000000000000;
        };
        v3
    }
    ...
    public fun half_pow(arg0: u256, arg1: u256) : u256 {
        ...
        if (v1 == 0) {
            return 1000000000000000000 / 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(0x2::math::pow(2, (v0 as u8)))
        } else {
            ...
            while (v5 < 256) {
                ...
                v3 = v9;
                if (v2 < arg1) {
                    return 1000000000000000000 / 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(0x2::math::pow(2, (v0 as u8))) * v9 / 1000000000000000000
                };
                v5 = v5 + 1;
            };
            abort 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::failed_to_converge()
        };
    }
    ...
    public fun invariant_(arg0: u256, arg1: u256, arg2: vector<u256>) : u256 {
        ...
        let v2 = 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::head<u256>(v1);
        assert!(v2 >= 1000000000 && v2 <= 1000000000000000 * 1000000000000000000, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::unsafe_value());
        let v3 = 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(v0);
        let v4 = 1;
        while (v0 > v4) {
            assert!(*0x1::vector::borrow<u256>(&v1, v4) * 1000000000000000000 / v2 >= 100000000000, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::unsafe_value());
            v4 = v4 + 1;
        };
    ...
    public fun max_a(arg0: u64) : u256 {
        0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(0x2::math::pow(arg0, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u8(arg0))) * 10000 * 1000
    }

    public fun min_a(arg0: u64) : u256 {
        0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(0x2::math::pow(arg0, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u8(arg0))) * 10000 / 100
    }
    ...
    public fun reduction_coefficient(arg0: vector<u256>, arg1: u256) : u256 {
        ...
        let v2 = 1000000000000000000;
        while (v1 < v0) {
            let v3 = v2 * 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(v0) * *0x1::vector::borrow<u256>(&arg0, v1);
    ...
    public fun y(arg0: u256, arg1: u256, arg2: &vector<u256>, arg3: u256, arg4: u64) : u256 {
        ...
        assert_ann_is_within_range(arg0, v0);
        assert_gamma_is_within_range(arg1);
        assert!(arg3 >= 100000000000000000 && arg3 <= 1000000000000000 * 1000000000000000000, 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::errors::invalid_invariant());
        let v1 = 0;
        while (v0 > v1) {
            if (v1 != arg4) {
        ...
        let v2 = 0x548268236e9cf7ed3ede3a5e0a0d62d50e9a5d0b07389822bb424dae927684e6::utils::to_u256(v0);
        let v3 = arg3 / v2;
