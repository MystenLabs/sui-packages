module 0x54d9841cbafeefe93e7716bade183388f09031693580969d62d9f21201730642::scratchaholics {
    struct SCRATCHAHOLICS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SCRATCHAHOLICS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SCRATCHAHOLICS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Scratchaholics"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"We are thrilled to introduce our inaugural collection, a groundbreaking set of exquisitely handcrafted, exclusive scratch cards, meticulously developed as a tremendously limited release. This innovative collection offers a completely novel and deeply engaging experience, specifically designed to captivate discerning purchasers and dedicated enthusiasts who deeply appreciate the intersection of artistry, unique design, and the exhilarating thrill of uncovering hidden treasures within each card."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigitthmoj6xudmciobztrjrxjppalpctv74dsxlvy6uxmrsphac54"));
