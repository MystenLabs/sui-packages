module 0x54ed96d77b9a32e17e8da2360c88382c9826c67fb4134a97b8284fefa8abbc2c::reward3381 {
    struct REWARD3381 has drop {
        dummy_field: bool,
    }

    struct TICKET_3381 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3381(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3381>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3381>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3381, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3381>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3381>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3381>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3381>>(v5, 0x2::tx_context::sender(arg1));
    }
