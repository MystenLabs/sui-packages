module 0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::outbox {
    struct Outbox<T0: store> has store {
        entries: 0x2::table::Table<OutboxKey, OutboxItem<T0>>,
        rate_limit: 0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::rate_limit::RateLimitState,
    }
    ...
    struct OutboxItem<T0> has store {
        ...
        released: 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::bitmap::Bitmap,
        ...
        data: 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun add<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxItem<T0>) : OutboxKey {
        let v0 = OutboxKey{id: 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::get_id<T0>(&arg1.data)};
    ...
    public(friend) fun new<T0: store>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Outbox<T0> {
        Outbox<T0>{
            ...
            rate_limit : 0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::rate_limit::new(arg0),
        }
    }

    public fun borrow_data<T0: store>(arg0: &OutboxItem<T0>) : &0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::NttManagerMessage<T0> {
        &arg0.data
    }

    public fun borrow_rate_limit_mut<T0: store>(arg0: &mut Outbox<T0>) : &mut 0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::rate_limit::RateLimitState {
        &mut arg0.rate_limit
    }
    ...
    public fun new_outbox_item<T0>(arg0: u64, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::ntt_manager_message::NttManagerMessage<T0>) : OutboxItem<T0> {
        OutboxItem<T0>{
            release_timestamp     : arg0,
            released              : 0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::bitmap::empty(),
    ...
    public(friend) fun try_release<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxKey, arg2: u8, arg3: &0x2::clock::Clock) : bool {
        ...
        if (0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::bitmap::get(&v0.released, arg2)) {
            abort 13906834586660241409
        };
        0xb5982a903a6b405cd1bdb4acff8c7338332bfe0cf8ba2126300f0cac8484c484::bitmap::enable(&mut v0.released, arg2);
        true
    }
