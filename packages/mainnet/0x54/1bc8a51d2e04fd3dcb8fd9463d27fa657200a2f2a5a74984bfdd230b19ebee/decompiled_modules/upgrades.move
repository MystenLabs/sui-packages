module 0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::upgrades {
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeCap, arg1: &mut 0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::state::State<T0>, arg2: 0x2::package::UpgradeReceipt) {
        0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::state::set_version<T0>(arg1, 0);
        0x2::package::commit_upgrade(&mut arg0.cap, arg2);
    }

    public fun check_version<T0>(arg0: VersionGated, arg1: &0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::state::State<T0>) {
        let VersionGated {  } = arg0;
        if (0x541bc8a51d2e04fd3dcb8fd9463d27fa657200a2f2a5a74984bfdd230b19ebee::state::get_version<T0>(arg1) != 0) {
