module 0x5425298b616e5ee91b816a341fc45248d4e3d10ba214050c0396a5b92f394e99::mustard {
    ...
    fun init(arg0: MUSTARD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<MUSTARD>(&mut v3, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
