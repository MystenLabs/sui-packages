module 0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::vault {
    ...
    public(friend) fun extend_lock<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        ...
        arg1.max_voting_power = 0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::calculator::get_max_voting_power(arg1.locked_amount, arg3);
    ...
    public(friend) fun lock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v3 = 0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::calculator::get_max_voting_power(v2, arg3);
    ...
    public(friend) fun lock_for_max_power<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v4 = 0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::calculator::get_max_voting_power(v3, v0);
        0x2::balance::join<T0>(&mut arg0.total_locked_balance, arg2);
    ...
    public(friend) fun merge_veToken<T0>(arg0: &mut VeTokenVault<T0>, arg1: &mut vector<VoteEscrowedToken<T0>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v11 = VoteEscrowedToken<T0>{
            ...
            base_token          : 0x1::type_name::get<T0>(),
            locked_amount       : v1,
            max_voting_power    : 0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::calculator::get_max_voting_power(v1, v2),
            lock_start_time     : v0,
            lock_period         : v2,
            lock_end_time       : v0 + v2,
            is_active           : true,
    ...
    public(friend) fun pre_unlock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        ...
        let v2 = (((v1 as u128) * (0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::calculator::get_penalty_ratio(v0 - arg1.lock_start_time, arg1.lock_period, arg3) as u128) / (1000000 as u128)) as u64);
        let v3 = (v1 as u64) - v2;
        ...
        arg1.max_voting_power = 0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::calculator::get_max_voting_power(v3, arg3);
    ...
    public(friend) fun switch_to_always_max_power<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock) {
        ...
        if (arg1.lock_period < 126144000000) {
            ...
            arg1.max_voting_power = 0x544ceb1d8b8b22bff3800899c19551c04de4a2208e4c856550bcce9b644e63c7::calculator::get_max_voting_power(arg1.locked_amount, 126144000000);
        };
        update_nft_lock_start_end_time<T0>(arg1, arg2);
