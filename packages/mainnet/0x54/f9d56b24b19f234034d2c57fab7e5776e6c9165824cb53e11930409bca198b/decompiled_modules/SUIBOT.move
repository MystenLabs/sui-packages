module 0x54f9d56b24b19f234034d2c57fab7e5776e6c9165824cb53e11930409bca198b::SUIBOT {
    ...
    fun init(arg0: SUIBOT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<SUIBOT>(&mut v3, 1000000000000, 0x2::tx_context::sender(arg1), arg1);
