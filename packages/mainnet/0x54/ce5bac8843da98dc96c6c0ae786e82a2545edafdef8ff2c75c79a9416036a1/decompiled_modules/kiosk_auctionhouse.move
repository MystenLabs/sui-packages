module 0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::kiosk_auctionhouse {
    ...
    public fun accept_swap_offer<T0: store + key, T1: store + key, T2>(arg0: &mut Kiosk_Auctionhouse_Store, arg1: &mut 0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::kiosk::Kiosk, arg6: 0x2::object::ID, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x2::kiosk::KioskOwnerCap, arg9: &0x2::transfer_policy::TransferPolicy<T0>, arg10: 0x2::coin::Coin<T2>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::coin::Coin<T2>) {
        ...
        assert!(0x2::object::id<0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        let SwapOffer {
            id            : v2,
            offerer       : v3,
            offered_kiosk : v4,
        ...
        let v15 = if (v14 > 0) {
            ...
            if (0x2::coin::value<T2>(&arg10) > v14) {
                if (0x1::type_name::get<T2>() == 0x1::type_name::get<0x2::sui::SUI>()) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::coin::into_balance<T2>(0x2::coin::split<T2>(&mut arg10, v14, arg12)), arg12), 0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::get_owner(arg1));
                } else {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut arg10, v14, arg12), 0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::get_owner(arg1));
                };
                arg10
            } else {
                if (0x1::type_name::get<T2>() == 0x1::type_name::get<0x2::sui::SUI>()) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(0x2::coin::into_balance<T2>(arg10), arg12), 0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::get_owner(arg1));
                } else {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(arg10, 0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::get_owner(arg1));
                };
    ...
    public entry fun create_and_share_kiosk_auctionhouse_store(arg0: &0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Kiosk_Auctionhouse_Store>(create_kiosk_auctionhouse(arg0, arg1));
    }

    public fun create_kiosk_auctionhouse(arg0: &0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Auctionhouse_Store {
        assert!(0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::is_admin(arg0, 0x2::tx_context::sender(arg1)), 1);
        Kiosk_Auctionhouse_Store{
            id            : 0x2::object::new(arg1),
            auction_house : 0x2::object::id<0x54ce5bac8843da98dc96c6c0ae786e82a2545edafdef8ff2c75c79a9416036a1::auctionhouse::AuctionHouse>(arg0),
        }
    }
