module 0x54f67a03aff5e987ba320f440d8683a993c6470fb1ecbb1188644b86aba8b240::pool_rewards {
    ...
    public fun stake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x54f67a03aff5e987ba320f440d8683a993c6470fb1ecbb1188644b86aba8b240::creature_nft::CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        assert!(v0.is_active, 2);
        let v1 = 0x2::clock::timestamp_ms(arg3);
    ...
    fun validate_nft_requirements(arg0: &Pool, arg1: &0x54f67a03aff5e987ba320f440d8683a993c6470fb1ecbb1188644b86aba8b240::creature_nft::CreatureNFT) {
