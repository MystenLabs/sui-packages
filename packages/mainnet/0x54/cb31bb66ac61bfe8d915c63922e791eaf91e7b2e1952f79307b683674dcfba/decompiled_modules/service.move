module 0x54cb31bb66ac61bfe8d915c63922e791eaf91e7b2e1952f79307b683674dcfba::service {
    ...
    public fun generate(arg0: &mut 0x2::coin::TreasuryCap<SERVICE>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<SERVICE> {
        0x2::coin::mint<SERVICE>(arg0, arg1, arg2)
    }

    public entry fun generate_to(arg0: &mut 0x2::coin::TreasuryCap<SERVICE>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
