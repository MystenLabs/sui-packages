module 0x74a73daff11c11ed05299c93ed770c62ec4dc6756fa99e271e251c2399f49fef::plinko {
    ...
    fun borrow_mut_parameters<T0>(arg0: &mut PlinkoSettings) : &mut Parameters<T0> {
        assert!(parameters_exist<T0>(arg0), 13835621722495385605);
    ...
    public fun borrow_plinko_settings(arg0: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &PlinkoSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<Plinko, PlinkoSettingsKey, PlinkoSettings>(arg0, v1, v0), 13835340110079590403);
    ...
    fun borrow_plinko_settings_mut(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &mut PlinkoSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<Plinko, PlinkoSettingsKey, PlinkoSettings>(arg0, v0, v1), 13835340170209132547);
    ...
    fun edit_config<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u8, arg2: u8, arg3: vector<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>, arg4: u64, arg5: u64, arg6: bool) {
        ...
        assert!(0x2::vec_map::contains<u8, PlinkoConfig>(&v1.configs, &arg1), 13837030175416385551);
    ...
    fun float_fraction(arg0: u64, arg1: u64) : 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float {
        assert!(arg1 > 0, 13835902862464778247);
    ...
    fun play_internal<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u8, arg5: vector<0x1::string::String>, arg6: vector<vector<u8>>, arg7: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::PriceQuote, arg8: &0x2::clock::Clock, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::vec_map::contains<u8, PlinkoConfig>(&v2.configs, &arg4), 13837033877678194703);
        let v3 = v2.min_stake;
        let v4 = v2.max_stake;
        ...
        let v11 = v7;
        assert!(v10, 13837315429964447761);
        assert!(v3 <= v4, 13835908059375206407);
        assert!(v5 > 0 && v5 <= 100, 13835908063670173703);
        assert!(arg3 > 0 && arg3 <= v5, 13836752492895666189);
        assert!(v6 > 0 && v6 <= 63, 13835908072260108295);
        assert!(0x1::vector::length<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(&v11) == (v6 as u64) + 1, 13837596926416125971);
        ...
        assert!(0x2::balance::value<T0>(&v13) == arg1, 13837878491587280917);
        ...
        0x13a877d974d59f54d8affa4d345bf794cf8e9e936d9d22100c801c95b415930f::loyalty::process_stake_ticket_with_quote<T0, Plinko>(&mut v16, arg0, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::utils::build_metadata<0x1::string::String, vector<u8>>(arg5, arg6), arg7, arg8, arg9, arg10);
        ...
        while (v19 < arg3) {
            ...
            assert!(v20 >= v3, 13836189813524922377);
            assert!(v20 <= v4, 13836471292796731403);
            assert!(v20 >= v8, 13836189822114856969);
            assert!(v20 <= v9, 13836471301386665995);
            let v21 = &mut v18;
    ...
    fun set_parameters<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 <= arg2, 13835903369270919175);
        assert!(arg3 > 0 && arg3 <= 100, 13835903373565886471);
    ...
    fun validate_config(arg0: u8, arg1: &vector<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>, arg2: u64, arg3: u64) {
        assert!(arg0 > 0, 13835903811652550663);
        assert!(arg0 <= 63, 13838155615762251799);
        assert!(0x1::vector::length<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(arg1) == (arg0 as u64) + 1, 13837592670103535635);
        assert!(arg3 > 0, 13835903824537452551);
        assert!(arg2 <= arg3, 13835903828832419847);
        let v0 = 0;
        while (v0 < 0x1::vector::length<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(arg1)) {
            assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(0x1::vector::borrow<0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float>(arg1, v0)), 13835903854602223623);
            v0 = v0 + 1;
        };
        ...
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&v1, &v2), 13838437159458570265);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::lt(&v1, &v3), 13838718638730379291);
    }
