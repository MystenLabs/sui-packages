module 0x5400c4e9bdbb6810d72dd9e7a080f09cd03dbc3f557906e039dd24bd5a69dcb3::contract_auth {
    ...
    public fun auth_as<T0, T1: key>(arg0: &T0, arg1: vector<u8>, arg2: &T1) : address {
        ...
        assert!(assert_auth_type<T0>(arg0, arg1) == 0x2::address::from_bytes(0x2::hex::decode(0x1::ascii::into_bytes(0x1::type_name::address_string(&v0)))), 13906834556595470337);
    ...
    public fun get_auth_address<T0>(arg0: vector<u8>) : 0x1::option::Option<address> {
        ...
        0x1::vector::append<u8>(&mut v1, 0x1::ascii::into_bytes(0x1::type_name::module_string(&v0)));
        0x1::vector::append<u8>(&mut v1, b"::");
