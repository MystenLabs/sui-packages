module 0x546174a157f36332b84f3e7167acc1ba8c9ce56258fa84b636d84d0f108dcdf7::test_coin {
    ...
    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 6, b"SUDC/DO", b"DOG", b"Template Coin Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"ccc"))), arg1);
