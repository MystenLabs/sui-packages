module 0x542647eab552b2b6118cb2d9e4d72cddbd9c993e088d3bc7274fe5cd3529e280::ffx {
    ...
    fun op<T0: store, T1: store>(arg0: &0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::LBPair<T0, T1>, arg1: bool, arg2: u128, arg3: u64, arg4: u64, arg5: u8, arg6: u8, arg7: u64, arg8: &0x2::clock::Clock) : u64 {
        assert!(arg3 > 0, 1);
        assert!(arg3 <= arg4, 2);
        assert!(arg7 < arg3, 3);
        let v0 = 0;
    ...
    fun sm<T0: store, T1: store>(arg0: &0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::LBPair<T0, T1>, arg1: u64, arg2: bool, arg3: u128, arg4: &0x2::clock::Clock) : (u64, u128, bool) {
        if (arg1 == 0) {
            return (0, 0, true)
        };
