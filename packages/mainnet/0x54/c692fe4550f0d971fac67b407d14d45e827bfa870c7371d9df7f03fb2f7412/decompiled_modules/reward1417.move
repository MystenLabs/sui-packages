module 0x54c692fe4550f0d971fac67b407d14d45e827bfa870c7371d9df7f03fb2f7412::reward1417 {
    struct REWARD1417 has drop {
        dummy_field: bool,
    }

    struct TICKET_1417 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1417(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1417>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1417>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1417, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1417>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1417>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1417>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1417>>(v5, 0x2::tx_context::sender(arg1));
    }
