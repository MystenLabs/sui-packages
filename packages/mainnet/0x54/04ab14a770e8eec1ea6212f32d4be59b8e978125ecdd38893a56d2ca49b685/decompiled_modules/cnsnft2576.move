module 0x5404ab14a770e8eec1ea6212f32d4be59b8e978125ecdd38893a56d2ca49b685::cnsnft2576 {
    struct CNSNFT2576 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2576, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://rwdsuinet-1126img-0141.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<CNSNFT2576>(arg0, arg1);
