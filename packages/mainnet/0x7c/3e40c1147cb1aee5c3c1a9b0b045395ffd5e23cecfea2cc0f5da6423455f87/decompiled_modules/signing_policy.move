module 0x7c3e40c1147cb1aee5c3c1a9b0b045395ffd5e23cecfea2cc0f5da6423455f87::signing_policy {
    ...
    public fun destroy(arg0: SigningPolicy, arg1: SigningPolicyCap) {
        ...
        let SigningPolicy {
            ...
            rule_change_delay        : _,
            pending_removals         : v6,
            requires_message_binding : _,
        } = arg0;
        0x2::table::destroy_empty<0x1::type_name::TypeName, u64>(v6);
        0x2::object::delete(v2);
        0x2::object::delete(v0);
        let v8 = SigningPolicyDestroyed{id: v1};
        0x2::event::emit<SigningPolicyDestroyed>(v8);
    }
    ...
    public fun new_with_protection(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : (SigningPolicy, SigningPolicyCap) {
        ...
        let v3 = SigningPolicy{
            ...
            requires_message_binding : false,
        };
    ...
    public fun requires_message_binding(arg0: &SigningPolicy) : bool {
        arg0.requires_message_binding
    }

    public fun set_requires_message_binding(arg0: &mut SigningPolicy, arg1: &SigningPolicyCap, arg2: bool) {
        assert!(0x2::object::id<SigningPolicy>(arg0) == arg1.policy_id, 4);
        arg0.requires_message_binding = arg2;
    }
