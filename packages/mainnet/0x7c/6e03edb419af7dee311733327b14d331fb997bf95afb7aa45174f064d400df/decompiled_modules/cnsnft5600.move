module 0x7c6e03edb419af7dee311733327b14d331fb997bf95afb7aa45174f064d400df::cnsnft5600 {
    struct CNSNFT5600 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9717"));
        let v4 = 0x2::package::claim<CNSNFT5600>(arg0, arg1);
