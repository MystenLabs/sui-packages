module 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::auctions {
    ...
    public fun bid(arg0: &mut Auction, arg1: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::UserStatsRegistry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.highest_bidder != arg0.creator && 0x2::balance::value<0x2::sui::SUI>(&arg0.highest_bidder_deposit) > 0) {
            0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::record_outbid(arg1, arg0.highest_bidder, v2, arg0.highest_bid, v1, arg4);
        ...
        0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::record_bid(arg1, v0, v2, v1, arg4);
    ...
    public fun cancel_auction<T0: store + key>(arg0: &mut Auction, arg1: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::Dashboard, arg2: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::UserStatsRegistry, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::kiosk::PurchaseCap<T0> {
        assert!(0x2::tx_context::sender(arg4) == arg0.creator, 3);
        assert!(arg0.highest_bid == 0, 6);
        assert!(arg0.active, 2);
        arg0.active = false;
        0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::remove_auction(arg1, 0x2::object::id<Auction>(arg0), 0, arg0.creator, arg4);
        0x2::dynamic_object_field::remove<0x1::type_name::TypeName, 0x2::kiosk::PurchaseCap<T0>>(&mut arg0.id, arg0.item_type)
    }

    public fun close_auction<T0: store + key>(arg0: &AdminCap, arg1: &mut Auction, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::Dashboard, arg5: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::UserStatsRegistry, arg6: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::leaderboard::Leaderboard, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.highest_bid > 0) {
            ...
            0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::record_auction_won(arg5, arg1.highest_bidder, v0, v1, arg8);
            0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::leaderboard::update_leaderboard(arg6, arg5, arg1.highest_bidder, arg8);
        };
        let v12 = 0;
        while (v12 < 0x1::vector::length<address>(&arg1.participants)) {
            let v13 = *0x1::vector::borrow<address>(&arg1.participants, v12);
            if (v13 != v2) {
                0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::remove_active_bid(arg5, v13, v0);
            };
            v12 = v12 + 1;
        };
        arg1.active = false;
        0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::remove_auction(arg4, v0, v1, v2, arg8);
    }

    public fun close_auction_no_policy<T0: store + key>(arg0: &AdminCap, arg1: &mut Auction, arg2: T0, arg3: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::Dashboard, arg4: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::UserStatsRegistry, arg5: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::leaderboard::Leaderboard, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Auction>(arg1);
        ...
        if (arg1.highest_bid > 0) {
            ...
            0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::record_auction_won(arg4, arg1.highest_bidder, v0, v1, arg7);
            0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::leaderboard::update_leaderboard(arg5, arg4, arg1.highest_bidder, arg7);
        } else {
        ...
        while (v3 < 0x1::vector::length<address>(&arg1.participants)) {
            ...
            if (v4 != v2) {
                0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::remove_active_bid(arg4, v4, v0);
            };
            v3 = v3 + 1;
        };
        arg1.active = false;
        0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::remove_auction(arg3, v0, v1, v2, arg7);
    }

    public fun create<T0: store + key>(arg0: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::Dashboard, arg1: &mut 0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::UserStatsRegistry, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        0x2::dynamic_object_field::add<0x1::type_name::TypeName, 0x2::kiosk::PurchaseCap<T0>>(&mut v2.id, v1, 0x2::kiosk::list_with_purchase_cap<T0>(arg2, arg3, arg4, 0, arg7));
        let v3 = 0x2::object::id<Auction>(&v2);
        0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::dashboard::add_auction(arg0, v3, arg7);
        0x7c892908566f4506d82774f89b5cc1fa9fd7046b8c0baed69f427cf2c38fd78a::user_stats::record_auction_created(arg1, v0, v3, arg7);
