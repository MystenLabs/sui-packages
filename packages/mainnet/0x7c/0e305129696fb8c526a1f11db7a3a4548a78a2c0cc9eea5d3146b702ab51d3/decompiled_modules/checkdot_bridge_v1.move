module 0x7c0e305129696fb8c526a1f11db7a3a4548a78a2c0cc9eea5d3146b702ab51d3::checkdot_bridge_v1 {
    ...
    public entry fun add_transfers_from(arg0: &mut Bridge, arg1: 0x1::string::String, arg2: address, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<vector<u8>, vector<u8>>(&mut arg0.transfers_hashs, arg4, arg4);
    }
    ...
    fun fees_in_sui<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: &Bridge) : u64 {
        ...
        assert!(v2 > 0, 400);
        (((arg1.fees_in_dollar as u256) * 0x1::u256::pow(10, 6) * (0x2::balance::value<T0>(v0) as u256) / (v2 as u256)) as u64)
    }
    ...
    public fun get_fees_in_sui<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: &Bridge) : u64 {
    ...
    public entry fun init_transfer<T0>(arg0: &mut Bridge, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::coin::Coin<0x711d2704034eeb509104481a99a556f17b6b444c7fed7cfb223fd5567af843ad::cdt::CDT>, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<Transfer>(&mut arg0.transfers, v4);
    }
