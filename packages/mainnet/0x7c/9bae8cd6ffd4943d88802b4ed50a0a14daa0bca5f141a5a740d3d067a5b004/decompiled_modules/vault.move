module 0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::vault {
    struct Vault has store, key {
        id: 0x2::object::UID,
        reward_balances: 0x2::bag::Bag,
        staked_balance: 0x2::balance::Balance<0x2::sui::SUI>,
    }
    ...
    public(friend) fun deposit_staked(arg0: &mut Vault, arg1: 0x2::balance::Balance<0x2::sui::SUI>) {
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.staked_balance, arg1);
    }
    ...
    public entry fun entry_withdraw_reward_coin<T0>(arg0: &mut Vault, arg1: &0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::config::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_vault_staked_balance(arg0: &Vault) : u64 {
        0x2::balance::value<0x2::sui::SUI>(&arg0.staked_balance)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault{
            ...
            staked_balance  : 0x2::balance::zero<0x2::sui::SUI>(),
        };
        0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::events::emit_init_vault(0x2::object::id<Vault>(&v0));
    ...
    public fun withdraw_reward_coin<T0>(arg0: &mut Vault, arg1: &0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::config::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2::coin::from_balance<T0>(withdraw_reward<T0>(arg0, arg2), arg3)
    }

    public(friend) fun withdraw_staked(arg0: &mut Vault, arg1: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
        0x2::balance::split<0x2::sui::SUI>(&mut arg0.staked_balance, arg1)
    }
