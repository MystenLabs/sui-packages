module 0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::config {
    ...
    public(friend) fun assert_allow_staking(arg0: &ProtocolConfig) {
        assert!(arg0.open_staking, 0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::errors::error_not_allow_stake());
    }

    public(friend) fun assert_current_version_invalid(arg0: &ProtocolConfig) {
        assert!(arg0.version >= 1, 0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::errors::error_invalid_protocol_version());
    }

    public(friend) fun assert_reward_info_registered(arg0: &ProtocolConfig, arg1: &0x1::type_name::TypeName) {
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs, arg1), 0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::errors::error_not_exist_reward_config());
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::events::emit_init_config(0x2::object::id<AdminCap>(&v1), 0x2::object::id<ProtocolConfig>(&v0));
    ...
    public(friend) fun set_reward_config<T0>(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::events::emit_update_reward_config(arg2, arg3, arg4);
    }
    ...
    public fun start_staking(arg0: &AdminCap, arg1: &mut ProtocolConfig) {
        ...
        0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::events::emit_update_staking_status(arg1.open_staking);
    }
    ...
    public fun update_package_version(arg0: &AdminCap, arg1: &mut ProtocolConfig, arg2: u64) {
        ...
        0x7c9bae8cd6ffd4943d88802b4ed50a0a14daa0bca5f141a5a740d3d067a5b004::events::emit_update_package_version(arg2);
    }
