module 0x971d70b4e40312c953adf5f773f326844a03708b0f0dfdb38cc006fc180a48dd::rotation_adapters {
    ...
    public fun exit_bluefin_deep_usdc_to_deep_sui<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &Registry, arg2: &BluefinDeepUsdcPortfolioCap<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg7: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg8: u32, arg9: u64, arg10: bool, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: &mut 0x2::tx_context::TxContext) {
        ...
        let (v16, v17) = centered_range(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg4), arg8, 1);
        let v18 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg3, arg4, v16, v17, arg18);
        let (v19, v20, v21, v22) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg0, arg3, arg4, &mut v18, v8, v14, arg9, arg10);
        v8 = v21;
        v14 = v22;
        let v23 = 0x2::balance::value<T0>(&v8);
        let v24 = 0x2::balance::value<T1>(&v14);
        assert!(v19 >= arg14, 8);
        assert!(v20 >= arg15, 9);
        assert!(v23 <= arg16, 10);
        assert!(v24 <= arg17, 11);
        let v25 = BluefinDeepUsdcExited{
        ...
        0x2::event::emit<BluefinDeepUsdcExited>(v25);
        0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v18, 0x2::tx_context::sender(arg18));
        let v26 = 0x2::tx_context::sender(arg18);
        transfer_nonzero<T0>(v8, v26, arg18);
        let v27 = 0x2::tx_context::sender(arg18);
        transfer_nonzero<T1>(v14, v27, arg18);
    }
    ...
    public fun open_bluefin_deep_sui_and_deep_usdc<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &Registry, arg2: &BluefinDeepUsdcPortfolioCap<T0, T1, T2>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg7: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg8: u64, arg9: u64, arg10: u32, arg11: u32, arg12: u64, arg13: bool, arg14: u64, arg15: bool, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = v15;
        let (v17, v18) = centered_range(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg4), arg10, 1);
        let v19 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg3, arg4, v17, v18, arg26);
        let (v20, v21, v22, v23) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg0, arg3, arg4, &mut v19, v8, v7, arg12, arg13);
        v8 = v22;
        v7 = v23;
        let (v24, v25) = centered_range(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T2>(arg5), arg11, 1);
        let v26 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T2>(arg3, arg5, v24, v25, arg26);
        let (v27, v28, v29, v30) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T2>(arg0, arg3, arg5, &mut v26, v13, v16, arg14, arg15);
        v16 = v30;
        0x2::balance::join<T0>(&mut v8, v29);
        let v31 = 0x2::balance::value<T0>(&v8);
        let v32 = 0x2::balance::value<T1>(&v7);
        let v33 = 0x2::balance::value<T2>(&v16);
        assert!(v20 >= arg19, 8);
        assert!(v21 >= arg20, 9);
        assert!(v27 >= arg21, 8);
        assert!(v28 >= arg22, 9);
        ...
        assert!(v32 <= arg24, 11);
        assert!(v33 <= arg25, 11);
        let v34 = BluefinDeepUsdcPortfolioOpened{
            route_id               : 0x2::object::id<BluefinDeepUsdcPortfolioCap<T0, T1, T2>>(arg2),
            source_position_id     : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&arg7),
            primary_position_id    : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&v19),
            farm_position_id       : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&v26),
            reward_deep            : 0x2::balance::value<T0>(&v0),
            fee_deep               : 0x2::balance::value<T0>(&v6),
            fee_sui                : 0x2::balance::value<T1>(&v5),
            profit_sui             : v12,
            ...
            primary_deposited_deep : v20,
            primary_deposited_sui  : v21,
            farm_deposited_deep    : v27,
            farm_deposited_usdc    : v28,
            primary_tick_lower     : v17,
            primary_tick_upper     : v18,
            farm_tick_lower        : v24,
            farm_tick_upper        : v25,
            residual_deep          : v31,
            residual_sui           : v32,
        ...
        0x2::event::emit<BluefinDeepUsdcPortfolioOpened>(v34);
        0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v19, 0x2::tx_context::sender(arg26));
        0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v26, 0x2::tx_context::sender(arg26));
        let v35 = 0x2::tx_context::sender(arg26);
        transfer_nonzero<T0>(v8, v35, arg26);
        let v36 = 0x2::tx_context::sender(arg26);
        transfer_nonzero<T1>(v7, v36, arg26);
        let v37 = 0x2::tx_context::sender(arg26);
        transfer_nonzero<T2>(v16, v37, arg26);
    }
