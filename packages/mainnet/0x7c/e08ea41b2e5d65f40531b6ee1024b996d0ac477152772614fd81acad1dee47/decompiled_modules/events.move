module 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::events {
    ...
    struct MigrationFeeCollected has copy, drop {
        curve_id: 0x2::object::ID,
        coin_type: 0x1::ascii::String,
        amount: u64,
        timestamp_ms: u64,
    ...
    struct FeeSplitChanged has copy, drop {
        creator_bps: u64,
        referrer_bps: u64,
        protocol_bps: u64,
        timestamp_ms: u64,
    ...
    struct LocalFeesFlushed has copy, drop {
        curve_id: 0x2::object::ID,
        coin_type: 0x1::ascii::String,
        amount: u64,
        creator_amount: u64,
    ...
    public(friend) fun fee_split_changed(arg0: u64, arg1: u64, arg2: u64, arg3: u64) {
        let v0 = FeeSplitChanged{
            creator_bps  : arg0,
            referrer_bps : arg1,
            protocol_bps : arg2,
            timestamp_ms : arg3,
        };
        0x2::event::emit<FeeSplitChanged>(v0);
    }
    ...
    public(friend) fun local_fees_flushed(arg0: 0x2::object::ID, arg1: 0x1::ascii::String, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        let v0 = LocalFeesFlushed{
            curve_id        : arg0,
            coin_type       : arg1,
            amount          : arg2,
            creator_amount  : arg3,
            referrer_amount : arg4,
            protocol_amount : arg5,
            referrers       : arg6,
            timestamp_ms    : arg7,
        };
        0x2::event::emit<LocalFeesFlushed>(v0);
    }
    ...
    public(friend) fun migration_fee_collected(arg0: 0x2::object::ID, arg1: 0x1::ascii::String, arg2: u64, arg3: u64) {
        let v0 = MigrationFeeCollected{
            curve_id     : arg0,
            coin_type    : arg1,
            amount       : arg2,
            timestamp_ms : arg3,
        };
        0x2::event::emit<MigrationFeeCollected>(v0);
    }
    ...
    public(friend) fun role_granted(arg0: 0x1::ascii::String, arg1: 0x2::object::ID, arg2: address, arg3: u64) {
        let v0 = RoleGranted{
            role         : arg0,
            cap_id       : arg1,
            holder       : arg2,
    ...
    public(friend) fun role_revoked(arg0: 0x1::ascii::String, arg1: 0x2::object::ID, arg2: bool, arg3: u64) {
        let v0 = RoleRevoked{
            role         : arg0,
            cap_id       : arg1,
            by_admin     : arg2,
