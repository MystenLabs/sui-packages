module 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::mock_dex {
    ...
    public fun collect_fees<T0>(arg0: &mut Pool<T0>, arg1: &LpBurnProof<T0>, arg2: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::fees::FeeVault, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.pool_id == 0x2::object::uid_to_inner(&arg0.id), 3);
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::router::deposit_pool_fees<T0>(arg2, arg0.curve_id, arg0.coin_type, 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::fees::creator_of(arg2, arg0.curve_id), 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.sui_fees), 0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.token_fees), arg4), arg3);
    }
    ...
    public fun migrate<T0>(arg0: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : LpBurnProof<T0> {
        ...
        0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::confirm<T0>(arg0, arg1, v9, 0x1::option::some<0x2::object::ID>(0x2::object::uid_to_inner(&v11.id)), arg2);
        v11
    }

    public fun migrate_and_share<T0>(arg0: &mut 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::migration::MigrationVault<T0>, arg1: &0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::config::MigrationCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun swap_sui_for_token<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(v0 > 0, 2);
        let v1 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::mul_bps(v0, 30);
        let v2 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::tokens_out(0x2::balance::value<0x2::sui::SUI>(&arg0.sui), 0x2::balance::value<T0>(&arg0.tokens), v0 - v1);
        assert!(v2 >= arg2, 1);
    ...
    public fun swap_token_for_sui<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(v0 > 0, 2);
        let v1 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::mul_bps(v0, 30);
        let v2 = 0xad6769be9937a4a818d3a8b222de9c4e99d2bc9012a2828aaf24ada1ff7e81b4::math::sui_out(0x2::balance::value<0x2::sui::SUI>(&arg0.sui), 0x2::balance::value<T0>(&arg0.tokens), v0 - v1);
        assert!(v2 >= arg2, 1);
