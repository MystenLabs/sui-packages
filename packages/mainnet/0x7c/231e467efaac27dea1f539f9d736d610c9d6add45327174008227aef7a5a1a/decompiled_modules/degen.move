module 0x7c231e467efaac27dea1f539f9d736d610c9d6add45327174008227aef7a5a1a::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://img1.wsimg.com/isteam/ip/d940415e-b09e-4727-bdfe-4f3387d70ac7/IMG_4058.PNG/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:806,h:806                                                                                                                                                                                          ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DEGEN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DEGEN     ")))), trim_right(b"DEGEN MILLIONAIRES              "), trim_right(b"'Degen Millionaire Club' meme coin, featuring a group of characters embodying the spirit of adventurous investing. They are surrounded by party scenes, and symbols of wealth, like stacks of money and a luxurious lifestyle                                                                                                   "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
