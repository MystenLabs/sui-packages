module 0x8ed903e3c72d63650861404d38fc1216d8653cb8ec97c6c5792dca72f2719aa2::vault {
    ...
    public fun set_lower_price<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: u128) {
        arg0.lower_price_scalling = arg1;
    }

    public fun set_lower_trigger<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: u128) {
        arg0.lower_trigger_price_scalling = arg1;
    }
    ...
    public fun set_upper_price<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: u128) {
        arg0.upper_price_scalling = arg1;
    }

    public fun set_upper_trigger<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: u128) {
        arg0.upper_trigger_price_scalling = arg1;
    }
