module 0x7c324553768e51fa89b79d6c78f320bd2f8a838c7639378286564699bbec42ba::reward7271 {
    struct REWARD7271 has drop {
        dummy_field: bool,
    }

    struct TICKET_7271 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7271(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7271>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7271>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7271, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7271>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7271>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7271>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7271>>(v5, 0x2::tx_context::sender(arg1));
    }
