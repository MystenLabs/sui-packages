module 0x7cca07dc8516809744982ef879b7268cab739aa9f1ba2a5588cd933efb38e340::cnsnft4113 {
    struct CNSNFT4113 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4113, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4113>(arg0, arg1);
