module 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle {
    ...
    public fun get_token_price(arg0: &0x2::clock::Clock, arg1: &PriceOracle, arg2: u8) : (bool, u256, u8) {
        ...
        assert!(0x2::table::contains<u8, Price>(v0, arg2), 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::non_existent_oracle());
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = PriceOracle{
            ...
            update_interval : 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_constants::default_update_interval(),
    ...
    public(friend) fun oracle_version_migrate(arg0: &OracleAdminCap, arg1: &mut PriceOracle) {
        assert!(arg1.version <= 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_version::this_version(), 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::not_available_version());
        arg1.version = 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_version::this_version();
    }

    public fun price_object(arg0: &PriceOracle, arg1: u8) : &Price {
        assert!(0x2::table::contains<u8, Price>(&arg0.price_oracles, arg1), 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::price_oracle_not_found());
    ...
    public entry fun register_token_price(arg0: &OracleAdminCap, arg1: &0x2::clock::Clock, arg2: &mut PriceOracle, arg3: u8, arg4: u256, arg5: u8) {
        ...
        assert!(arg5 <= 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_constants::default_decimal_limit() && arg5 > 0, 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::invalid_value());
        let v0 = &mut arg2.price_oracles;
        assert!(!0x2::table::contains<u8, Price>(v0, arg3), 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::oracle_already_exist());
        let v1 = Price{
            value     : arg4,
            decimal   : arg5,
    ...
    public entry fun set_update_interval(arg0: &OracleAdminCap, arg1: &mut PriceOracle, arg2: u64) {
        version_verification(arg1);
        assert!(arg2 > 0, 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::invalid_value());
    ...
    public entry fun update_token_price(arg0: &OracleFeederCap, arg1: &0x2::clock::Clock, arg2: &mut PriceOracle, arg3: u8, arg4: u256) {
        version_verification(arg2);
        let v0 = &mut arg2.price_oracles;
        assert!(0x2::table::contains<u8, Price>(v0, arg3), 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::non_existent_oracle());
    ...
    public entry fun update_token_price_batch(arg0: &OracleFeederCap, arg1: &0x2::clock::Clock, arg2: &mut PriceOracle, arg3: vector<u8>, arg4: vector<u256>) {
        ...
        assert!(v0 == 0x1::vector::length<u256>(&arg4), 0x7c6a8bdeb44b2f1fc4c2d8613756bbc617d14435c07177c17d076f4f06efe71e::oracle_error::price_length_not_match());
        let v1 = 0;
        while (v1 < v0) {
