module 0x7cdeb8a9dcef1f8088a6e136e049e37e69324e38e179d0c27bf7fd51dd019447::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0x9a6ef9b4de499fe0bd482e8d1f77f300977ad1327ed8e225ae7adbb9978aaac6::mode::Mode,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0x7134639f92ec616ce1c88087ad6b717365772ba654d24eea7a4552835ff90a59::bytes4::to_bytes(0x7134639f92ec616ce1c88087ad6b717365772ba654d24eea7a4552835ff90a59::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0x9a6ef9b4de499fe0bd482e8d1f77f300977ad1327ed8e225ae7adbb9978aaac6::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x9a6ef9b4de499fe0bd482e8d1f77f300977ad1327ed8e225ae7adbb9978aaac6::mode::serialize(arg0.manager_mode));
