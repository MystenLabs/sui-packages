module 0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::implements {
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LP<T0, T1>>, vector<u64>) {
        ...
        let v9 = if (0 == v6) {
            let v10 = 0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::math::sqrt(0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::math::mul_to_u128(v7, v8));
            assert!(v10 > 1000, 8);
    ...
    public fun calc_optimal_coin_values(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        ...
        let v0 = 0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::math::mul_div(arg0, arg5, arg4);
        if (v0 <= arg1) {
            assert!(v0 >= arg3, 4);
            return (arg0, v0)
        };
        let v1 = 0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::math::mul_div(arg1, arg4, arg5);
        assert!(v1 <= arg0, 6);
        assert!(v1 >= arg2, 3);
        (v1, arg1)
    }
    ...
    public fun get_amount_out(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::math::mul_div_u128(v0, (arg2 as u128), (arg1 as u128) * (10000 as u128) + v0)
    }
    ...
    public fun get_fee_to_fundation(arg0: u64) : u64 {
        0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::math::mul_div(arg0, 30 / 5, 10000)
    }
    ...
    public fun is_order<T0, T1>() : bool {
        ...
        let v2 = 0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::comparator::compare<0x1::type_name::TypeName>(&v0, &v1);
        assert!(!0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::comparator::is_equal(&v2), 9);
        0x7cc0e37931f6c7ab358d6cbb467789b8316a6ca5f1a1aef06fda79d63438c95e::comparator::is_smaller_than(&v2)
    }
