module 0x11b10f2e1c0149d51c47987f432fd5b43076f68cbd7ba33be93089e1a2bc66de::cyber_kingdom {
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"b748632a-be50-4817-b822-ae5473f64655"),
        };
    ...
    fun init(arg0: CYBER_KINGDOM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CYBER_KINGDOM>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Cyber Kingdom"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Cyber Kingdom: A futuristic realm where tech-enhanced royalty rule a world of nature and innovation."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmYGd1iXDxfXtdyreVsvL2pzdNb8rtVywH4Zf2DgCWV5MA"));
