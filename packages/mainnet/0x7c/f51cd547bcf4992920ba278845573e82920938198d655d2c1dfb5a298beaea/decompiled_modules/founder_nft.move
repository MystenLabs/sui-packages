module 0x7cf51cd547bcf4992920ba278845573e82920938198d655d2c1dfb5a298beaea::founder_nft {
    ...
    fun init(arg0: FOUNDER_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<OdysseyFounderNFT>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Odyssey Founder NFT"));
        0x2::display::add<OdysseyFounderNFT>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Commemorative NFT for the creator of an agent on Odyssey. Holders eligible for airdrops."));
