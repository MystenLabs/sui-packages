module 0x7c153bda85e4a7b37deb9e18529e2596c211f52d6c32b51c0661d1a459f64be5::meme_airdrop_tracker {
    ...
    public fun add_purchase_record(arg0: &GlobalConfig, arg1: &mut MemeStatsTable, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) : (bool, u64, u64) {
        ...
        if (!0x2::table::contains<0x1::string::String, MemeStats>(&arg1.stats, v1)) {
            ...
            0x2::table::add<0x1::string::String, MemeStats>(&mut arg1.stats, v1, v3);
        };
        let v4 = 0x2::table::borrow_mut<0x1::string::String, MemeStats>(&mut arg1.stats, v1);
