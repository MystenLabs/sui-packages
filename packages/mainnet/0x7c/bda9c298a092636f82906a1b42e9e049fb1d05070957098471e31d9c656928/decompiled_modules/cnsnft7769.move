module 0x7cbda9c298a092636f82906a1b42e9e049fb1d05070957098471e31d9c656928::cnsnft7769 {
    struct CNSNFT7769 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7769, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7769>(arg0, arg1);
