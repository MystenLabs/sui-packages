module 0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::reward_vault {
    ...
    struct RewardTransmitter<phantom T0> has store, key {
        ...
        debt_queue: 0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::Queue<Debt>,
        num_receivers: u64,
    ...
    public fun claim_rewards<T0: store + key>(arg0: &mut RewardVault<T0>, arg1: &mut RewardTransmitter<T0>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        if (v1 > 0) {
            ...
            let v4 = if (v1 > v3) {
                ...
                0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::push_back<Debt>(&mut arg1.debt_queue, v5);
                v3
            } else {
                v1
            };
    ...
    public fun create_vault<T0: store + key>(arg0: &mut 0x2::tx_context::TxContext) : (RewardVault<T0>, RewardTransmitter<T0>) {
        ...
        let v5 = RewardTransmitter<T0>{
            ...
            debt_queue         : 0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::new<Debt>(arg0),
            num_receivers      : 0,
    ...
    public fun get_debt_queue_info<T0: store + key>(arg0: &RewardTransmitter<T0>) : (u64, u64) {
        let v0 = 0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::length<Debt>(&arg0.debt_queue);
        let v1 = 0;
        let v2 = 0;
        while (v2 < v0) {
            v1 = v1 + 0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::borrow<Debt>(&arg0.debt_queue, v2).amount;
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    fun pay_debts<T0>(arg0: &mut RewardTransmitter<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::is_empty<Debt>(&arg0.debt_queue) && v0 > 0) {
            let v1 = 0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::front<Debt>(&arg0.debt_queue);
            let v2 = v1.amount;
            if (v2 > v0) {
                let v3 = Debt{
                ...
                0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::dequeue<Debt>(&mut arg0.debt_queue);
                0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::push_back<Debt>(&mut arg0.debt_queue, v3);
                break
            };
            0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::dequeue<Debt>(&mut arg0.debt_queue);
            v0 = v0 - v2;
    ...
    fun process_debt_queue<T0>(arg0: &mut RewardTransmitter<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::is_empty<Debt>(&arg0.debt_queue) || v1 == 0) {
            return
        };
        while (!0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::is_empty<Debt>(&arg0.debt_queue) && v1 > 0) {
            let v2 = 0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::front<Debt>(&arg0.debt_queue);
            let v3 = v2.amount;
            let v4 = v2.receiver;
            if (v3 > v1) {
                0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::dequeue<Debt>(&mut arg0.debt_queue);
                ...
                0x7c1427df4ea586a639d1c926cf483bc57c5f6cb5c497c236d72c87579886667f::queue::push_back<Debt>(&mut arg0.debt_queue, v5);
