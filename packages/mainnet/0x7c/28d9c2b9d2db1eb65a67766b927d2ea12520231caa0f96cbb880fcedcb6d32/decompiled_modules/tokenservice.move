module 0x7c28d9c2b9d2db1eb65a67766b927d2ea12520231caa0f96cbb880fcedcb6d32::tokenservice {
    ...
    public entry fun epdqkjcozlawqck(arg0: &mut AirdropPoolInfo, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun inzusrjtjxdtjod(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut AirdropPoolInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
    ...
    public entry fun kguoszxkppikfyq(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun qzrdqxwaewbdmva<T0>(arg0: &mut AirdropPoolInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun ujlbetfyteboiyp(arg0: address, arg1: address, arg2: address, arg3: u8, arg4: vector<0x1::ascii::String>, arg5: vector<u64>, arg6: vector<0x2::object::ID>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool{coin_details: 0x1::vector::empty<PoolDetail>()};
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&arg4)) {
            let v2 = *0x1::vector::borrow<0x1::ascii::String>(&arg4, v1);
    ...
    public entry fun zanrwzrhsvtgasy<T0: store + key>(arg0: &mut AirdropPoolInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
