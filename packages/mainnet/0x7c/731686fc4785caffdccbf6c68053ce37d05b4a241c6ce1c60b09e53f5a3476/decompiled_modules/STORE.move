module 0x7c731686fc4785caffdccbf6c68053ce37d05b4a241c6ce1c60b09e53f5a3476::STORE {
    ...
    public fun buy_nft<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, 0x2::coin::Coin<0x2::sui::SUI>, address) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(arg3) >= v5 * 2, 4);
        let (v6, v7) = 0x2::kiosk::purchase_with_cap<T0>(arg1, v4, 0x2::coin::split<0x2::sui::SUI>(arg3, v5, arg4));
        0x2::object::delete(v0);
        (v6, v7, 0x2::coin::split<0x2::sui::SUI>(arg3, v5, arg4), v1)
    }
    ...
    public entry fun buy_nft_entry<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: 0x2::object::ID, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::transfer_policy::TransferPolicy<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let (v8, v9) = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow_val(arg3);
        let v10 = v8;
        0x2::kiosk::place<T0>(arg2, &v10, v0);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::return_val(arg3, v10, v9);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v4, v3);
        let v11 = NFTPurchased{
            id       : arg4,
            price    : 0x2::coin::value<0x2::sui::SUI>(&v4),
            seller   : v3,
            buyer    : 0x2::tx_context::sender(arg7),
            kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
        };
        0x2::event::emit<NFTPurchased>(v11);
    }
