module 0x7c57c62d66e87e1c0b7797fb2d0a31503330cb26f17227828334ff534d8a9d6e::pool {
    ...
    public entry fun create_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: u64, arg2: u64, arg3: &0x2::coin::CoinMetadata<T0>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        create_pool_unit<T0, T1>(arg0, arg1, arg2, get_coin_unit<T0>(arg3), arg4, arg5, arg6);
    }

    public entry fun create_pool_unit<T0, T1>(arg0: &0x2::clock::Clock, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun earned<T0, T1>(arg0: &Pool<T0, T1>, arg1: UserInfo, arg2: u64) : u64 {
        0x7c57c62d66e87e1c0b7797fb2d0a31503330cb26f17227828334ff534d8a9d6e::math_extend::mul_div(arg1.balance_of, reward_per_token<T0, T1>(arg0, arg2) - arg1.user_reward_per_token_paid, arg0.stake_coin_unit) + arg1.pending_reward
    }
    ...
    fun reward_per_token<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        ...
        if (v0 == 0 || arg1 <= arg0.start_at) {
            ...
            ((0x7c57c62d66e87e1c0b7797fb2d0a31503330cb26f17227828334ff534d8a9d6e::math_extend::mul_to_u128(arg0.reward_per_second, last_time_reward_applicable<T0, T1>(arg0, arg1) - arg0.updated_at) * (arg0.stake_coin_unit as u128) / (v0 as u128) + (arg0.reward_per_token_stored as u128)) as u64)
        }
    }
