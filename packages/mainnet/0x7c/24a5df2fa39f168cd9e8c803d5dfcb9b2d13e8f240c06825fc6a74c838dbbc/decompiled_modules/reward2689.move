module 0x7c24a5df2fa39f168cd9e8c803d5dfcb9b2d13e8f240c06825fc6a74c838dbbc::reward2689 {
    struct REWARD2689 has drop {
        dummy_field: bool,
    }

    struct TICKET_2689 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2689(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2689>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2689>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2689, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2689>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2689>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2689>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2689>>(v5, 0x2::tx_context::sender(arg1));
    }
