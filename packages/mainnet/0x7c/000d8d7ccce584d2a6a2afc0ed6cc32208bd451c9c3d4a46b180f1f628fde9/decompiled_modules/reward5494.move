module 0x7c000d8d7ccce584d2a6a2afc0ed6cc32208bd451c9c3d4a46b180f1f628fde9::reward5494 {
    struct REWARD5494 has drop {
        dummy_field: bool,
    }

    struct TICKET_5494 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5494(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5494>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5494>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5494, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5494>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5494>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5494>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5494>>(v5, 0x2::tx_context::sender(arg1));
    }
