module 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken {
    ...
    public entry fun fix_treasury(arg0: &mut 0x2::coin::TreasuryCap<STORKTOKEN>, arg1: &mut ProtocolTreasury) {
        0x2::balance::join<STORKTOKEN>(&mut arg1.airdrop_supply, 0x2::coin::mint_balance<STORKTOKEN>(arg0, 2500000 * one_token() - 2500000));
        0x2::balance::join<STORKTOKEN>(&mut arg1.staking_supply, 0x2::coin::mint_balance<STORKTOKEN>(arg0, 22500000 * one_token() - 22500000));
        arg1.total_staking_supply = 22500000 * one_token();
        arg1.total_airdrop_supply = 2500000 * one_token();
    }
