module 0x6b110c792faadf8c1f928ad351bf3c9abad647b12bab83e7e075c169b0f9a2c1::bluefin_stable_lp {
    struct BLUEFIN_STABLE_LP has drop {
        dummy_field: bool,
    }
    ...
    struct BluefinLPTreasury has key {
        ...
        cap: 0x2::coin::TreasuryCap<BLUEFIN_STABLE_LP>,
    }
    ...
    fun burn(arg0: &mut BluefinLPTreasury, arg1: &mut BluefinLPVault, arg2: 0x2::coin::Coin<BLUEFIN_STABLE_LP>) {
        let v0 = 0x2::coin::value<BLUEFIN_STABLE_LP>(&arg2);
        assert!(v0 <= arg1.bluefin_lp_supply, 1);
        arg1.bluefin_lp_supply = arg1.bluefin_lp_supply - v0;
        0x2::coin::burn<BLUEFIN_STABLE_LP>(&mut arg0.cap, arg2);
    }

    fun mint(arg0: &mut BluefinLPTreasury, arg1: &mut BluefinLPVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<BLUEFIN_STABLE_LP> {
        arg1.bluefin_lp_supply = arg1.bluefin_lp_supply + arg2;
        0x2::coin::mint<BLUEFIN_STABLE_LP>(&mut arg0.cap, arg2, arg3)
    }
    ...
    public fun a_normalizer(arg0: &BluefinLPVault) : u64 {
        arg0.a_normalizer
    }

    public fun add_version(arg0: &AdminCap, arg1: &mut BluefinLPTreasury, arg2: u64) {
    ...
    public fun b_normalizer(arg0: &BluefinLPVault) : u64 {
        arg0.b_normalizer
    }
    ...
    public fun borrow_treasury_cap(arg0: &BluefinLPTreasury, arg1: &AdminCap) : &0x2::coin::TreasuryCap<BLUEFIN_STABLE_LP> {
        &arg0.cap
    }
    ...
    public fun claim_to_treasury<T0, T1>(arg0: &mut BluefinLPVault, arg1: &mut BluefinLPTreasury, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x2::clock::Clock) {
        let (_, _, v2, v3) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg4, arg2, arg3, &mut arg0.position);
        let v4 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg3);
        collect_fee<T0>(arg1, v4, v2);
        collect_fee<T1>(arg1, v4, v3);
    }
    ...
    fun init(arg0: BLUEFIN_STABLE_LP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BLUEFIN_STABLE_LP>(arg0, 9, b"BLUEFIN_STABLE_LP", b"Bluefin Stable LP", b"Fungible LP token for stable pair on Bluefin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://bluefin.io/images/nUSDC.gif")), arg1);
        ...
        0x2::transfer::public_transfer<0x2::coin::CoinMetadata<BLUEFIN_STABLE_LP>>(v1, v3);
    ...
    public fun remove_version(arg0: &AdminCap, arg1: &mut BluefinLPTreasury, arg2: u64) {
    ...
    public fun withdraw<T0, T1>(arg0: &mut BluefinLPTreasury, arg1: &mut BluefinLPVault, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &0x2::clock::Clock, arg5: 0x2::coin::Coin<BLUEFIN_STABLE_LP>, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert_valid_package_version(arg0);
        ...
        let v6 = 0x2::coin::value<BLUEFIN_STABLE_LP>(&arg5);
