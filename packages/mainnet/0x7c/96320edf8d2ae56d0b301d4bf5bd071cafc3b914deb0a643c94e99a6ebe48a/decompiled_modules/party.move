module 0x7c96320edf8d2ae56d0b301d4bf5bd071cafc3b914deb0a643c94e99a6ebe48a::party {
    ...
    public entry fun consumeCoin<T0>(arg0: &mut Reserve<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.sui, 0x2::balance::value<T0>(&arg0.sui)), arg2), 0x2::tx_context::sender(arg2));
