module 0x9e20798d97c110f6b36b7b3d8543aa9246322ef2fd8d83ad79ef3325d473bc2f::events {
    ...
    struct RevokeVaultAssistantCap has copy, drop {
        vault_id: 0x2::object::ID,
        assistant_cap_id: 0x2::object::ID,
    }
    ...
    public(friend) fun emit_revoke_vault_assistant_cap(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = RevokeVaultAssistantCap{
            vault_id         : arg0,
            assistant_cap_id : arg1,
        };
        0x2::event::emit<RevokeVaultAssistantCap>(v0);
    }
