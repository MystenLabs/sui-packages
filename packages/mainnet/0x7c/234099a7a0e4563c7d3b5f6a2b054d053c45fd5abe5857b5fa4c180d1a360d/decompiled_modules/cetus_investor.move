module 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::cetus_investor {
    ...
    public fun autocompound<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x2::sui::SUI, T1>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS, 0x2::sui::SUI>, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v4, v5 * arg0.performance_fee / 10000, arg8), 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::get_fee_wallet_address(arg1));
        let (v6, v7) = 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::converter::swap_a2b<0x2::sui::SUI, T1>(arg2, arg4, v4, true, v5, arg7, arg8);
        ...
        let v10 = v9;
        let v11 = v8;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, 0x2::balance::value<T0>(&v11) * arg0.performance_fee / 10000), arg8), 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::get_fee_wallet_address(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v10, 0x2::balance::value<T1>(&v10) * arg0.performance_fee / 10000), arg8), 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::get_fee_wallet_address(arg1));
    ...
    public(friend) fun get_balances_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool) : (u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (v4 <= v5) {
            if (arg4 == false) {
                assert!(((v5 - v4) as u128) * 1000000000 / (v5 as u128) <= 1000000, 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::error::difference_too_high());
            };
            0x2::balance::join<T1>(&mut arg0.free_balance_b, arg2);
            ...
            assert!(v10 <= v12, 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::error::insufficient_balance_to_add_liquidity());
            if (arg4 == false) {
                assert!(((v12 - v10) as u128) * 1000000000 / (v12 as u128) <= 1000000, 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::error::difference_too_high());
            };
            0x2::balance::join<T0>(&mut arg0.free_balance_a, arg1);
    ...
    public(friend) fun get_total_balance_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::Distributor, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (v7 > 0) {
            ...
            let (v10, v11) = 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::converter::swap_a2b<T0, T1>(arg2, arg5, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.free_balance_a, (v9 as u64)), arg7), true, (v9 as u64), arg6, arg7);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v10, 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::get_dust_wallet_address(arg1));
            ...
            let (v13, v14) = 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::converter::swap_b2a<T0, T1>(arg2, arg5, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.free_balance_b, (v12 as u64)), arg7), true, (v12 as u64), arg6, arg7);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v14, 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::get_dust_wallet_address(arg1));
    ...
    public fun rebalance<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::RebalanceCap, arg2: &0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::version::Version, arg3: &0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::Distributor, arg4: u32, arg5: u32, arg6: u32, arg7: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun set_performance_fee<T0, T1>(arg0: &0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::distributor::AdminCap, arg1: &0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::version::Version, arg2: &mut Investor<T0, T1>, arg3: u64) {
        0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.performance_fee_max_cap, 0x7c234099a7a0e4563c7d3b5f6a2b054d053c45fd5abe5857b5fa4c180d1a360d::error::fee_too_high_error());
