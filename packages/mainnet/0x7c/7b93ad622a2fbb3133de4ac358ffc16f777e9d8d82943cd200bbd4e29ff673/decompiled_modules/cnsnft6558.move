module 0x7c7b93ad622a2fbb3133de4ac358ffc16f777e9d8d82943cd200bbd4e29ff673::cnsnft6558 {
    struct CNSNFT6558 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6558, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6558>(arg0, arg1);
