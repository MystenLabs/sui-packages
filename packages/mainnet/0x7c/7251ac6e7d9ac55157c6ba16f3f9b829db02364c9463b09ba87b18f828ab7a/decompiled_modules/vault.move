module 0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::vault {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>,
    ...
    public entry fun depositReward(arg0: &AdminCap, arg1: 0x2::coin::Coin<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>, arg2: &mut Treasury, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(&mut arg2.rewardsTreasury, 0x2::coin::into_balance<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(arg1));
    }
    ...
    public entry fun getReward(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>>(0x2::coin::take<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(&mut arg2.rewardsTreasury, *v1, arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: 0x2::coin::Coin<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::coin::value<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(&arg1);
        ...
        0x2::balance::join<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(&mut arg4.rewardsTreasury, 0x2::coin::into_balance<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(arg1));
        ...
        assert!(arg3.rewardRate * arg3.duration <= 0x2::balance::value<0x7c7251ac6e7d9ac55157c6ba16f3f9b829db02364c9463b09ba87b18f828ab7a::stpop::STPOP>(&arg4.rewardsTreasury), 103);
    ...
    public entry fun stake(arg0: 0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>, arg1: &mut UserState, arg2: &mut RewardState, arg3: &mut Treasury, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::coin::value<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&arg0);
        ...
        updateReward(0x2::balance::value<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&arg3.stakedCoinsTreasury), v0, arg1, arg2, arg4);
    ...
    public entry fun withdraw(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 > 0, 102);
        assert!(arg3 <= *v1, 104);
        updateReward(0x2::balance::value<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&arg2.stakedCoinsTreasury), v0, arg0, arg1, arg4);
        let v2 = 0x2::vec_map::get_mut<address, u64>(&mut arg0.balanceOf, &v0);
        *v2 = *v2 - arg3;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>>(0x2::coin::take<0xa5acaa0f77c701fc014550491ea2f126b06124750f3237de18aa3b5dc66be87d::pop::POP>(&mut arg2.stakedCoinsTreasury, arg3, arg5), 0x2::tx_context::sender(arg5));
        let v3 = Withdrawn{
            user   : 0x2::tx_context::sender(arg5),
            amount : arg3,
        };
