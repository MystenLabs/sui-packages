module 0x7c818f1cf0aa440d5214b696f324c84925be25dad3fc93800be66384d744501f::oracle_example {
    ...
    struct PriceObserved has copy, drop {
        avg_tick_i32: 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::I32,
        sqrt_x64: u128,
        price: Price,
    }
    ...
    public fun price_via_observe<T0, T1>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock, arg3: u8, arg4: u8) : (0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::i32::I32, u128, Price) {
        ...
        let v8 = sqrt_price_x64_to_price(v7, arg3, arg4);
        let v9 = PriceObserved{
            avg_tick_i32 : v6,
            sqrt_x64     : v7,
            price        : v8,
        };
        0x2::event::emit<PriceObserved>(v9);
        (v6, v7, v8)
    }
    ...
    public fun sqrt_price_x64_to_price(arg0: u128, arg1: u8, arg2: u8) : Price {
        ...
        let v4 = if (!v1) {
            ...
            18446744073709551616 * v2
        };
        let v5 = Signed{
            negative  : false,
            magnitude : 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::full_math_u128::mul_div_floor(0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::full_math_u128::mul_div_floor(0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::full_math_u128::mul_div_floor(arg0, arg0, 1), 1, 18446744073709551616), v3, v4),
        };
        let v6 = Decimal{
            is_negative : true,
            magnitude   : 8,
