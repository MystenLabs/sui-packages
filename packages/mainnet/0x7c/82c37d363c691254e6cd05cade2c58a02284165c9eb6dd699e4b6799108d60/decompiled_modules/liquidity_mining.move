module 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::liquidity_mining {
    ...
    public(friend) fun force_close_expired_user_reward<T0>(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: &0x2::clock::Clock, arg3: u64) {
        let v0 = 0x1::option::borrow_mut<PoolReward>(0x1::vector::borrow_mut<0x1::option::Option<PoolReward>>(&mut arg0.pool_rewards, arg3));
        assert!(v0.coin_type == 0x1::type_name::with_defining_ids<T0>(), 2);
        assert!(0x2::clock::timestamp_ms(arg2) >= v0.end_time_ms, 5);
        let v1 = RewardBalance<T0>{dummy_field: false};
        assert!(0x2::balance::value<T0>(0x2::bag::borrow<RewardBalance<T0>, 0x2::balance::Balance<T0>>(&v0.additional_fields, v1)) == 0, 6);
        let v2 = 0x1::vector::borrow_mut<0x1::option::Option<UserReward>>(&mut arg1.rewards, arg3);
        if (0x1::option::is_some<UserReward>(v2)) {
            let UserReward {
                pool_reward_id               : _,
                earned_rewards               : _,
                cumulative_rewards_per_share : _,
            } = 0x1::option::extract<UserReward>(v2);
            v0.num_user_reward_managers = v0.num_user_reward_managers - 1;
        };
    }
