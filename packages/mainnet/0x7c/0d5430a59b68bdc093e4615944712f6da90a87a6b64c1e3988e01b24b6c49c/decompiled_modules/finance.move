module 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::finance {
    ...
    struct Finance has store, key {
        id: 0x2::object::UID,
        pcs: 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::ProfitCS,
        users: 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::UserPool,
        balance: 0x2::balance::Balance<0x2::sui::SUI>,
        investment_id: u64,
        investment_table: 0x2::table::Table<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>,
        version: u64,
    }
    ...
    public entry fun bind_inviter(arg0: &mut Finance, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = BindInviter{
            index   : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::bind_inviter(&mut arg0.users, v0, arg1),
            user    : v0,
            inviter : arg1,
        };
    ...
    public entry fun bind_inviter_by_admin(arg0: &FinanceCap, arg1: &mut Finance, arg2: vector<address>, arg3: vector<address>) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            let v3 = BindInviter{
                index   : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::bind_inviter(&mut arg1.users, v1, v2),
                user    : v1,
                inviter : v2,
            };
    ...
    public entry fun bind_inviter_by_admin2(arg0: &FinanceCap, arg1: &mut Finance, arg2: u64, arg3: vector<address>, arg4: vector<address>) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg3)) {
            ...
            assert!(!valid_user(arg1, v1), 6);
            0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::bind_inviter(&mut arg1.users, v1, *0x1::vector::borrow<address>(&arg4, v0));
            v0 = v0 + 1;
        };
        0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::set_pool_size(&mut arg1.users, arg2);
    }
    ...
    public entry fun bind_inviter_by_cap(arg0: &mut FinanceCap, arg1: &mut Finance, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = BindInviter{
            index   : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::bind_inviter(&mut arg1.users, arg2, arg3),
            user    : arg2,
            inviter : arg3,
        };
    ...
    fun claim_internal<T0>(arg0: address, arg1: &0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::ProfitCS, arg2: &mut 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment, arg3: &0x2::clock::Clock, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, T0>, arg5: bool) : (u64, u64, u64) {
        let v0 = 0;
        let v1 = 0;
        let (v2, v3, v4, v5, v6) = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::calculate_rewards(arg2, arg1, 0x2::clock::timestamp_ms(arg3));
        let (v7, _, _, _) = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::profit_config_value(v6);
        if (arg5) {
            assert!(v2 > 0, 4);
        };
        if (v2 > 0) {
            0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::claim_reward(arg2, v5);
            let v11 = v2 - v3;
            v1 = v11;
            let v12 = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::suiprice::get_amount_out_v3<T0>(arg4, v11, false);
            v0 = v12;
            let v13 = Claim{
                stake_id     : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::investment_id(arg2),
                claim_reward : v2,
                claim_amount : v12,
                subsidy      : v4,
                claim_fee    : v3,
    ...
    public entry fun fix_invt_value(arg0: &mut FinanceCap, arg1: &mut Finance, arg2: u64, arg3: u64, arg4: address) {
        ...
        assert!(0x2::table::contains<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&arg1.investment_table, arg4), 2);
        let v0 = 0x2::table::borrow_mut<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&mut arg1.investment_table, arg4);
        assert!(0x2::linked_table::contains<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v0, arg2), 7);
        0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::fix_investment_value(0x2::linked_table::borrow_mut<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v0, arg2), arg3);
    }
    ...
    public entry fun fix_invt_value_batch(arg0: &mut FinanceCap, arg1: &mut Finance, arg2: vector<u64>, arg3: vector<u64>, arg4: vector<address>) {
        ...
        while (v1 < v0) {
            ...
            assert!(0x2::table::contains<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&arg1.investment_table, v3), 2);
            let v4 = 0x2::table::borrow_mut<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&mut arg1.investment_table, v3);
            assert!(0x2::linked_table::contains<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v4, v2), 7);
            0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::fix_investment_value(0x2::linked_table::borrow_mut<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v4, v2), *0x1::vector::borrow<u64>(&arg3, v1));
            v1 = v1 + 1;
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Finance{
            ...
            pcs              : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::create_profit_cs(86400000),
            users            : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::create_user_pool(@0xcb579b13d314cf4fc1e1ea9115700ad7b5956b18c2880fbe6b9b38d168f441c6, arg0),
            balance          : 0x2::balance::zero<0x2::sui::SUI>(),
            investment_id    : 0,
            investment_table : 0x2::table::new<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(arg0),
            version          : 18,
        };
        ...
        while (v8 < 0x1::vector::length<u64>(&v3)) {
            0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::add_profict_config(v7, *0x1::vector::borrow<u64>(&v3, v8), *0x1::vector::borrow<u64>(&v4, v8), *0x1::vector::borrow<u64>(&v5, v8), *0x1::vector::borrow<u64>(&v6, v8));
            v8 = v8 + 1;
        };
    ...
    public entry fun init_investment_list(arg0: &mut FinanceCap, arg1: &mut Finance, arg2: vector<u64>, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>) {
        ...
        while (v2 < 0x1::vector::length<u64>(&arg2)) {
            0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::add_profict_config(v1, *0x1::vector::borrow<u64>(&arg2, v2), *0x1::vector::borrow<u64>(&arg3, v2), *0x1::vector::borrow<u64>(&arg4, v2), *0x1::vector::borrow<u64>(&arg5, v2));
            v2 = v2 + 1;
        };
    }
    ...
    public entry fun invt_info(arg0: &Finance, arg1: address, arg2: u64, arg3: &0x2::clock::Clock) {
        check_version(arg0);
        assert!(0x2::table::contains<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&arg0.investment_table, arg1), 8);
        let v0 = 0x2::table::borrow<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&arg0.investment_table, arg1);
        assert!(0x2::linked_table::contains<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v0, arg2), 9);
        let v1 = 0x2::linked_table::borrow<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v0, arg2);
        let (v2, v3, v4, v5, _) = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::investment_value(v1);
        let (v7, v8, _, v10, v11) = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::calculate_rewards(v1, &arg0.pcs, 0x2::clock::timestamp_ms(arg3));
        let (v12, v13, _, _) = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::profit_config_value(v11);
        let v16 = InvtInfo{
            id                 : v2,
            amount             : v3,
            fee_rate           : v12,
    ...
    public entry fun topup_v2<T0>(arg0: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, T0>, arg1: &mut SUIPool, arg2: &mut Finance, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = TopUpSui{
            id     : v4,
            amount : v0,
            value  : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::suiprice::get_amount_out_v3<T0>(arg0, v0, true),
    ...
    fun unstake_internal<T0>(arg0: &mut Finance, arg1: &mut UnStakeConfig, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, T0>, arg5: &mut 0x2::tx_context::TxContext, arg6: 0x1::option::Option<address>) {
        ...
        assert!(0x2::table::contains<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&arg0.investment_table, v0), 3);
        let v1 = 0x2::table::borrow_mut<address, 0x2::linked_table::LinkedTable<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>>(&mut arg0.investment_table, v0);
        assert!(0x2::linked_table::contains<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v1, arg2), 9);
        let v2 = 0x2::linked_table::borrow_mut<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v1, arg2);
        let (v3, v4, _) = claim_internal<T0>(v0, &arg0.pcs, v2, arg3, arg4, false);
        let (v6, v7, _, _, _) = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::investment_value(v2);
        0x2::linked_table::remove<u64, 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::investment::Investment>(v1, v6);
        let v11 = v7 * v4 / 10000;
        let v12 = (v7 - v11) * arg1.hr_rate / 10000;
        let v13 = v7 - v11 - v12;
        let v14 = 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::suiprice::get_amount_out_v3<T0>(arg4, v13, false);
    ...
    public fun user_info(arg0: &Finance, arg1: address) {
        check_version(arg0);
        let v0 = UserInfo{
            root    : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::root(&arg0.users),
            user    : arg1,
            inviter : 0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::find_inviter(&arg0.users, arg1),
        };
    ...
    public fun valid_user(arg0: &Finance, arg1: address) : bool {
        check_version(arg0);
        0x673ee2e1a21691ff2baddb00f6695ab822337f135ad814bdfa1ea982bdae606b::invite::valid_user(&arg0.users, arg1)
    }
