module 0x7c0d639e6302963e11c44de0b7c1147f213f2bbb4fde6dc9ac85397125e911eb::boysclub {
    struct BOYSCLUB has drop {
        dummy_field: bool,
    }

    fun init(arg0: BOYSCLUB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BOYSCLUB>(arg0, 9, b"BOYSCLUB", b"Boys Club On Sui", b"Boys Club On Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.ibb.co/rkQWcRr/1.jpg"))), arg1);
