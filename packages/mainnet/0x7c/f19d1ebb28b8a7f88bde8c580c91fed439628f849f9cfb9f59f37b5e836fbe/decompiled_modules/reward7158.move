module 0x7cf19d1ebb28b8a7f88bde8c580c91fed439628f849f9cfb9f59f37b5e836fbe::reward7158 {
    struct REWARD7158 has drop {
        dummy_field: bool,
    }

    struct TICKET_7158 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7158(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7158>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7158>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7158, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7158>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7158>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7158>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7158>>(v5, 0x2::tx_context::sender(arg1));
    }
