module 0x7c942c91e68cdc3bd3f48e8f341e370ad33a2abf50a5991c5ac994b27460d6b9::admin {
    ...
    public entry fun accept_reward(arg0: &ContractPublisher, arg1: &mut RewardPool, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>>(&mut arg1.id, 0x1::string::utf8(b"dummy"), 0x2::transfer::public_receive<0x2::coin::Coin<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>>(&mut arg1.id, arg2));
    }
    ...
    public(friend) fun get_mutable_reference_to_reward_balance(arg0: &mut RewardPool) : &mut 0x2::balance::Balance<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY> {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"dummy")), 1002);
        0x2::coin::balance_mut<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>>(&mut arg0.id, 0x1::string::utf8(b"dummy")))
    }
    ...
    public entry fun receive_dummy2(arg0: &ContractPublisher, arg1: &mut Dummy2Pool, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>>(&mut arg1.id, 0x1::string::utf8(b"dummy2"), 0x2::transfer::public_receive<0x2::coin::Coin<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>>(&mut arg1.id, arg2));
    }
    ...
    public entry fun send_reward(arg0: &mut RewardPool, arg1: &mut 0x2::coin::Coin<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>(arg1) >= arg2, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>>(0x2::coin::from_balance<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>(0x2::balance::split<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>(0x2::coin::balance_mut<0x65ebd1cc6028bf19cefb0aa66f1bccec3f311a86e52a2d3f2821a6aeb36d467a::dummy::DUMMY>(arg1), arg2), arg3), 0x2::object::uid_to_address(&arg0.id));
    }

    public entry fun top_up_dummy2(arg0: &mut Dummy2Pool, arg1: &mut 0x2::coin::Coin<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>(arg1) >= arg2, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>>(0x2::coin::from_balance<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>(0x2::balance::split<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>(0x2::coin::balance_mut<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>(arg1), arg2), arg3), 0x2::object::uid_to_address(&arg0.id));
    }
    ...
    public(friend) fun withdraw_dummy2(arg0: &mut Dummy2Pool, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2> {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"dummy2")), 1002);
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>>(&mut arg0.id, 0x1::string::utf8(b"dummy2"));
        assert!(0x2::coin::value<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>(v0) > arg1, 5);
        0x2::coin::split<0x6006c51e64f885301e5800dfd92bfad0fa970e181372f576d8107c58149f07ba::dummy2::DUMMY2>(v0, arg1, arg2)
    }
