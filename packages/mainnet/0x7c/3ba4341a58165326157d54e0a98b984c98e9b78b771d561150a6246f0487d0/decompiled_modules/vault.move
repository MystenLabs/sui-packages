module 0x7c3ba4341a58165326157d54e0a98b984c98e9b78b771d561150a6246f0487d0::vault {
    ...
    public(friend) fun borrow<T0>(arg0: &Vault) : &0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.id, 0x7c3ba4341a58165326157d54e0a98b984c98e9b78b771d561150a6246f0487d0::utils::get_type_name_string<T0>())
    }

    public(friend) fun borrow_mut<T0>(arg0: &mut Vault) : &mut 0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x7c3ba4341a58165326157d54e0a98b984c98e9b78b771d561150a6246f0487d0::utils::get_type_name_string<T0>())
    }
    ...
    fun makesure<T0>(arg0: &mut Vault) {
        let v0 = 0x7c3ba4341a58165326157d54e0a98b984c98e9b78b771d561150a6246f0487d0::utils::get_type_name_string<T0>();
