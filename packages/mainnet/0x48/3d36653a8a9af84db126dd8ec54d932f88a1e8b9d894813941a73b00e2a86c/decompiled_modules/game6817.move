module 0x483d36653a8a9af84db126dd8ec54d932f88a1e8b9d894813941a73b00e2a86c::game6817 {
    struct GAME6817 has drop {
        dummy_field: bool,
    }

    struct TICKET_6817 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6817(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6817>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6817>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME6817, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6817>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6817>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6817>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6817>>(v5, 0x2::tx_context::sender(arg1));
    }
