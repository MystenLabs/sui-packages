module 0x4881b228b2c14a3193df643b100e2f4ff80e5e52bf56203a7fe428719008661c::reward4657 {
    struct REWARD4657 has drop {
        dummy_field: bool,
    }

    struct TICKET_4657 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4657(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4657>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4657>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4657, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4657>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4657>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4657>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4657>>(v5, 0x2::tx_context::sender(arg1));
    }
