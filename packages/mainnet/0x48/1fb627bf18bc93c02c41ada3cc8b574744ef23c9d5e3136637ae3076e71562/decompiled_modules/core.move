module 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::core {
    struct Registry<T0: copy + drop + store, T1: copy + drop + store> has key {
        id: 0x2::object::UID,
        key_to_value: 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::IterableTable<T0, T1>,
    ...
    struct List<T0: copy + drop + store> has store, key {
        id: 0x2::object::UID,
        keys: 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::IterableTable<T0, Nothing>,
        approvers: vector<address>,
    }
    ...
    public(friend) fun add_to_list<T0: copy + drop + store, T1: copy + drop + store>(arg0: T0, arg1: &mut Registry<T0, T1>, arg2: &mut List<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::add<T0, Nothing>(&mut arg2.keys, arg0, v1);
    }

    fun add_to_registry<T0: copy + drop + store, T1: copy + drop + store>(arg0: T0, arg1: T1, arg2: bool, arg3: &mut Registry<T0, T1>) {
        if (!arg2) {
            assert!(!0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::contains<T0, T1>(&arg3.key_to_value, arg0), 2);
            assert!(!0x2::table::contains<T0, Nothing>(&arg3.uids, arg0), 6);
        } else {
            0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::remove<T0, T1>(&mut arg3.key_to_value, arg0);
            if (0x2::table::contains<T0, Nothing>(&arg3.uids, arg0)) {
                0x2::table::remove<T0, Nothing>(&mut arg3.uids, arg0);
            };
        };
        0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::add<T0, T1>(&mut arg3.key_to_value, arg0, arg1);
    ...
    public(friend) fun create_list<T0: copy + drop + store>(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = List<T0>{
            ...
            keys      : 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::new<T0, Nothing>(arg0),
            approvers : v1,
        };
    ...
    public(friend) fun get_all_registered_coin_info<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut FullList<T1>, arg1: &mut Registry<T0, T1>) {
        let v0 = 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::tail_key<T0, T1>(&arg1.key_to_value);
        while (0x1::option::is_some<T0>(&v0)) {
            let v1 = *0x1::option::borrow<T0>(&v0);
            0x1::vector::push_back<T1>(&mut arg0.value_list, *0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow<T0, T1>(&arg1.key_to_value, v1));
            let (_, v3, _) = 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow_iter<T0, T1>(&arg1.key_to_value, v1);
            v0 = v3;
        };
    }
    ...
    public(friend) fun get_all_registered_coin_info_with_limit<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut FullList<T1>, arg1: &mut Registry<T0, T1>, arg2: u64, arg3: u64) {
        ...
        while (0x1::option::is_some<T0>(&v0)) {
            ...
            if (arg2 <= v1) {
                0x1::vector::push_back<T1>(&mut arg0.value_list, *0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow<T0, T1>(&arg1.key_to_value, v2));
            };
            let (_, v4, _) = 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow_iter<T0, T1>(&arg1.key_to_value, v2);
            v0 = v4;
            v1 = v1 + 1;
    ...
    public(friend) fun get_full_list<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut List<T0>, arg1: &mut FullList<T1>, arg2: &mut Registry<T0, T1>) {
        let v0 = 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::tail_key<T0, Nothing>(&arg0.keys);
        while (0x1::option::is_some<T0>(&v0)) {
            let v1 = *0x1::option::borrow<T0>(&v0);
            0x1::vector::push_back<T1>(&mut arg1.value_list, *0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow<T0, T1>(&arg2.key_to_value, v1));
            let (_, v3, _) = 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow_iter<T0, Nothing>(&arg0.keys, v1);
            v0 = v3;
        };
    }
    ...
    public(friend) fun get_full_list_with_limit<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut List<T0>, arg1: &mut FullList<T1>, arg2: &mut Registry<T0, T1>, arg3: u64, arg4: u64) {
        ...
        while (0x1::option::is_some<T0>(&v0)) {
            let v2 = *0x1::option::borrow<T0>(&v0);
            if (arg3 <= v1) {
                0x1::vector::push_back<T1>(&mut arg1.value_list, *0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow<T0, T1>(&arg2.key_to_value, v2));
            };
            let (_, v4, _) = 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow_iter<T0, Nothing>(&arg0.keys, v2);
            v0 = v4;
            v1 = v1 + 1;
    ...
    public(friend) fun get_info<T0: copy + drop + store, T1: copy + drop + store>(arg0: T0, arg1: &mut Registry<T0, T1>) : T1 {
        *0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow<T0, T1>(&arg1.key_to_value, arg0)
    }
    ...
    public(friend) fun initialize<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Registry<T0, T1>{
            id           : 0x2::object::new(arg0),
            key_to_value : 0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::new<T0, T1>(arg0),
    ...
    public(friend) fun is_key_in_list<T0: copy + drop + store>(arg0: T0, arg1: &mut List<T0>) : bool {
        0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::contains<T0, Nothing>(&arg1.keys, arg0)
    }

    public(friend) fun is_key_registered<T0: copy + drop + store, T1: copy + drop + store>(arg0: T0, arg1: &mut Registry<T0, T1>) : bool {
        0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::contains<T0, T1>(&arg1.key_to_value, arg0)
    }
    ...
    public(friend) fun remove_from_list<T0: copy + drop + store>(arg0: T0, arg1: &mut List<T0>) {
        0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::remove<T0, Nothing>(&mut arg1.keys, arg0);
    }
    ...
    public(friend) fun set_info<T0: copy + drop + store, T1: copy + drop + store>(arg0: T0, arg1: T1, arg2: &mut Registry<T0, T1>) {
        *0x481fb627bf18bc93c02c41ada3cc8b574744ef23c9d5e3136637ae3076e71562::iterable_table::borrow_mut<T0, T1>(&mut arg2.key_to_value, arg0) = arg1;
    }
