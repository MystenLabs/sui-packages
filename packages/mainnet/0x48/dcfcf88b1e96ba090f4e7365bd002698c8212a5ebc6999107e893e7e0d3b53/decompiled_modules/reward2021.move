module 0x48dcfcf88b1e96ba090f4e7365bd002698c8212a5ebc6999107e893e7e0d3b53::reward2021 {
    struct REWARD2021 has drop {
        dummy_field: bool,
    }

    struct TICKET_2021 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2021(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2021>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2021>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2021, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2021>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2021>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2021>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2021>>(v5, 0x2::tx_context::sender(arg1));
    }
