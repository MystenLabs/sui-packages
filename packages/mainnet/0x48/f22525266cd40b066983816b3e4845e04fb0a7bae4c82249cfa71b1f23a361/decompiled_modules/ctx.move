module 0x48f22525266cd40b066983816b3e4845e04fb0a7bae4c82249cfa71b1f23a361::ctx {
    struct CTX has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CTX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CTX>(arg0, 9, b"LAME", b"LAME Token", b"The LAME token secures the LameBook protocol, the premier wholesale liquidity venue for on-chain trading.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://orange-giant-owl-725.mypinata.cloud/ipfs/QmRfonP3qTtHvgBrhhXKCcAFLYPiBjbRHKQmknZQeiVAQV")), arg1);
