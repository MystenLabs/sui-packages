module 0x48fae728a2d15b6085495a675082c8a4de18e06ec3956f17dd738153d5729aeb::reward6395 {
    struct REWARD6395 has drop {
        dummy_field: bool,
    }

    struct TICKET_6395 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6395(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6395>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6395>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6395, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6395>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6395>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6395>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6395>>(v5, 0x2::tx_context::sender(arg1));
    }
