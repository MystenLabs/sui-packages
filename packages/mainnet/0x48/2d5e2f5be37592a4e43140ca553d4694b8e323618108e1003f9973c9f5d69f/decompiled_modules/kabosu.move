module 0x482d5e2f5be37592a4e43140ca553d4694b8e323618108e1003f9973c9f5d69f::kabosu {
    ...
    fun init(arg0: KABOSU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<KABOSU>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KABOSU  ")))), trim_right(b"Baby Kabosu                     "), trim_right(b"BABY KABOSU is the next chapter in the legacy of Kabosu,                                                                                                                                                                                                                                                                        "), v2, arg1);
