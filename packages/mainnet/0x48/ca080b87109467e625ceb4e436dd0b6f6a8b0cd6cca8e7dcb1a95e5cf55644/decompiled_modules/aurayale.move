module 0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::aurayale {
    ...
    public fun merge(arg0: &mut MetadataRegistry, arg1: 0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::tokenized_asset::TokenizedAsset<AURAYALE>, arg2: 0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::tokenized_asset::TokenizedAsset<AURAYALE>, arg3: Dice, arg4: &mut 0x2::tx_context::TxContext) : 0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::tokenized_asset::TokenizedAsset<AURAYALE> {
        let v0 = 0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::tokenized_asset::metadata<AURAYALE>(&arg1);
        let v1 = 0x1::ascii::string(b"level");
        ...
        assert!(parse_u8_from_bytes(0x1::ascii::as_bytes(0x2::vec_map::get<0x1::ascii::String, 0x1::ascii::String>(&v2, &v3))) == parse_u8_from_bytes(0x1::ascii::as_bytes(0x2::vec_map::get<0x1::ascii::String, 0x1::ascii::String>(&v0, &v1))), 101);
        let Dice { value: v4 } = arg3;
        let v5 = if (v4 % 2 == 0) {
        ...
        let v6 = v5;
        let v7 = *0x2::vec_map::get<0x1::ascii::String, GemInfo>(&arg0.gems, &v6);
        let v8 = 0x2::vec_map::keys<0x1::ascii::String, NFTMetadata>(&v7.metadatas);
        let v9 = *0x1::vector::borrow<0x1::ascii::String>(&v8, ((v4 % (0x1::vector::length<0x1::ascii::String>(&v8) as u8)) as u64));
        0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::tokenized_asset::burn<AURAYALE>(&mut arg0.asset_cap, arg1);
        0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::tokenized_asset::burn<AURAYALE>(&mut arg0.asset_cap, arg2);
        let v10 = 0x1::vector::empty<0x1::ascii::String>();
        let v11 = &mut v10;
        0x1::vector::push_back<0x1::ascii::String>(v11, 0x1::ascii::string(b"gem"));
        0x1::vector::push_back<0x1::ascii::String>(v11, 0x1::ascii::string(b"name"));
        0x1::vector::push_back<0x1::ascii::String>(v11, 0x1::ascii::string(b"level"));
        0x1::vector::push_back<0x1::ascii::String>(v11, 0x1::ascii::string(b"description"));
        let v12 = *0x2::vec_map::get<0x1::ascii::String, NFTMetadata>(&v7.metadatas, &v9);
        let v13 = 0x1::vector::empty<0x1::ascii::String>();
        let v14 = &mut v13;
        0x1::vector::push_back<0x1::ascii::String>(v14, v6);
        0x1::vector::push_back<0x1::ascii::String>(v14, v9);
        0x1::vector::push_back<0x1::ascii::String>(v14, 0x1::string::to_ascii(0x1::u8::to_string(v7.start_level)));
        0x1::vector::push_back<0x1::ascii::String>(v14, v12.description);
        0x48ca080b87109467e625ceb4e436dd0b6f6a8b0cd6cca8e7dcb1a95e5cf55644::tokenized_asset::mint<AURAYALE>(&mut arg0.asset_cap, v10, v13, 1, 0x1::option::some<0x1::ascii::String>(v12.img_url), arg4)
    }
