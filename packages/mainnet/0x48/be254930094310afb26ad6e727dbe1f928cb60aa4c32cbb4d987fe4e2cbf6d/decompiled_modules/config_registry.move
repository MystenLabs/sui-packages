module 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry {
    ...
    struct PriceSignerKey has copy, drop, store {
        dummy_field: bool,
    }

    struct SignedPriceRefreshed has copy, drop, store {
        bps: u64,
        quote_ts_ms: u64,
        at_ms: u64,
    }
    ...
    public entry fun refresh_price_signed(arg0: &mut Config, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: &0x2::clock::Clock) {
        let v0 = PriceSignerKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<PriceSignerKey>(&arg0.id, v0), 114);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        assert!(v1 >= arg2 && v1 - arg2 <= 300000, 116);
        assert!(arg1 >= 500, 105);
        assert!(arg1 <= 200000, 104);
        let v2 = signed_price_message(0x2::object::id<Config>(arg0), arg1, arg2);
        let v3 = PriceSignerKey{dummy_field: false};
        assert!(0x2::ed25519::ed25519_verify(&arg3, 0x2::dynamic_field::borrow<PriceSignerKey, vector<u8>>(&arg0.id, v3), &v2), 115);
        let v4 = arg0.fixed_sui_usd_price_bps;
        if (is_fixed_price_fresh_internal(arg0, v1)) {
            let v5 = if (arg1 > v4) {
                arg1 - v4
            } else {
                v4 - arg1
            };
            assert!(v5 * 10000 <= v4 * 1000, 107);
        };
        arg0.fixed_sui_usd_price_bps = arg1;
        stamp_price_meta(arg0, v1);
        let v6 = SignedPriceRefreshed{
            bps         : arg1,
            quote_ts_ms : arg2,
            at_ms       : v1,
        };
        0x2::event::emit<SignedPriceRefreshed>(v6);
    }
    ...
    public entry fun set_price_signer(arg0: &0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::admin::AdminCap, arg1: &mut Config, arg2: vector<u8>) {
        assert!(0x1::vector::length<u8>(&arg2) == 32, 117);
        let v0 = PriceSignerKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PriceSignerKey>(&arg1.id, v0)) {
            let v1 = PriceSignerKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<PriceSignerKey, vector<u8>>(&mut arg1.id, v1) = arg2;
        } else {
            let v2 = PriceSignerKey{dummy_field: false};
            0x2::dynamic_field::add<PriceSignerKey, vector<u8>>(&mut arg1.id, v2, arg2);
        };
    }
    ...
    public fun signed_price_message(arg0: 0x2::object::ID, arg1: u64, arg2: u64) : vector<u8> {
        let v0 = b"TIMEVYN_PRICE_V1";
