module 0x48ae67242e3291977f45e1583ace09f42d01628be55b904a3e667b069c450382::utils {
    ...
    public fun calc_lock_duration_multiplier(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        0x1::u64::max(lock_multiplier_lower_bound() + ((((arg3 - lock_multiplier_lower_bound()) as u128) * ((arg0 - arg2) as u128) / ((arg1 - arg2) as u128)) as u64), arg3)
    }
    ...
    public fun calc_number_of_emissions_from_time_tn_to_tm(arg0: u64, arg1: u64, arg2: u64) : u64 {
        (arg1 - arg0) / arg2
    }
