module 0x48c5518a3017240f7ddf8acb07e62a3450fa85b4f72729158b52c29b32fab0f3::cnsnft8196 {
    struct CNSNFT8196 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8196, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9040"));
        let v4 = 0x2::package::claim<CNSNFT8196>(arg0, arg1);
