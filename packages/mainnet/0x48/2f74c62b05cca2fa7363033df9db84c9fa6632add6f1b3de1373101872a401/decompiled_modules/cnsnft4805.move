module 0x482f74c62b05cca2fa7363033df9db84c9fa6632add6f1b3de1373101872a401::cnsnft4805 {
    struct CNSNFT4805 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4805, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4805>(arg0, arg1);
