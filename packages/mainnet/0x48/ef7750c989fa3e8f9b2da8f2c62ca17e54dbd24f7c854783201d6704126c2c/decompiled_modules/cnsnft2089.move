module 0x48ef7750c989fa3e8f9b2da8f2c62ca17e54dbd24f7c854783201d6704126c2c::cnsnft2089 {
    struct CNSNFT2089 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2089, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2089>(arg0, arg1);
