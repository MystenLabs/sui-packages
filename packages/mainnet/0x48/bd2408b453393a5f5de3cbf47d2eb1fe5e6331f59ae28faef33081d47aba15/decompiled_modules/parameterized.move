module 0x48bd2408b453393a5f5de3cbf47d2eb1fe5e6331f59ae28faef33081d47aba15::parameterized {
    ...
    public entry fun execute_nft_transfer<T0: store + key>(arg0: &mut TransferParams, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        if (!arg0.initialized) {
            if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"pending_transfer")) {
                0x2::dynamic_field::add<vector<u8>, 0x2::object::ID>(&mut arg0.id, b"pending_transfer", arg1);
            } else {
                *0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::object::ID>(&mut arg0.id, b"pending_transfer") = arg1;
            };
        ...
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"pending_transfer"), 4);
        let NFTTransferDetails {
            recipient : v1,
            nft_id    : v2,
        } = *0x2::dynamic_field::borrow<vector<u8>, NFTTransferDetails>(&arg0.id, b"nft_details");
        assert!(arg1 == v2, 3);
        assert!(arg1 == *0x2::dynamic_field::borrow<vector<u8>, 0x2::object::ID>(&arg0.id, b"pending_transfer"), 3);
        ...
        0x2::dynamic_field::remove<vector<u8>, 0x2::object::ID>(&mut arg0.id, b"pending_transfer");
