module 0x485934d1aa24acdc771ccf5db8bb5e03c8584711f39968243d319e3bd9b0a6bd::reward5338 {
    struct REWARD5338 has drop {
        dummy_field: bool,
    }

    struct TICKET_5338 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5338(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5338>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5338>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5338, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5338>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5338>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5338>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5338>>(v5, 0x2::tx_context::sender(arg1));
    }
