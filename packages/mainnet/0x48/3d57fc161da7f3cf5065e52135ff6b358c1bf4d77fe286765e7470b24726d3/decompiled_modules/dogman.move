module 0x483d57fc161da7f3cf5065e52135ff6b358c1bf4d77fe286765e7470b24726d3::dogman {
    struct DOGMAN has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<DOGMAN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<DOGMAN>>(0x2::coin::mint<DOGMAN>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: DOGMAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<DOGMAN>>(0x2::coin::mint<DOGMAN>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
