module 0x48b6354119ef7b5b3e2d1b4915b2010886b403f27a2d2e02b41f7e928a01d4dd::zen_nft {
    ...
    fun assert_is_zen_coin<T0>() {
        assert!(0x1::type_name::into_string(0x1::type_name::get<T0>()) == 0x1::ascii::string(b"0x2665dc784c7ff17fddba2442b36cb8b2bbc8adfa9fe08794fd941d80ef2758ec::zen::ZEN"), 4);
    }
