module 0x4823579ed389f3901a1af1b3a1cdc5c9769bf184161144dc896ee26db7942742::reward9071 {
    struct REWARD9071 has drop {
        dummy_field: bool,
    }

    struct TICKET_9071 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9071(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9071>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9071>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9071, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9071>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9071>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9071>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9071>>(v5, 0x2::tx_context::sender(arg1));
    }
