module 0x56d2bf0e2808c3771dd7187b6af84f88c4bb3709d0fd94eac659cd341e27dd2d::atlansui_lab {
    ...
    public entry fun bulk_send(arg0: vector<AtlansuiLab>, arg1: address) {
        while (0x1::vector::length<AtlansuiLab>(&arg0) > 0) {
            0x2::transfer::transfer<AtlansuiLab>(0x1::vector::pop_back<AtlansuiLab>(&mut arg0), arg1);
        };
        0x1::vector::destroy_empty<AtlansuiLab>(arg0);
    }
