module 0x485fe9121796e9c08a697e370b91b96e481614edaa3f4bd931a6a89b051e4097::stake {
    ...
    fun find_and_update_order(arg0: &mut vector<StakingOrder>, arg1: u64, arg2: &0x2::clock::Clock) : &mut StakingOrder {
        ...
        while (v0 < 0x1::vector::length<StakingOrder>(arg0)) {
            ...
            if (v1.id == arg1) {
                ...
                v1.status = 1;
                v1.interest = get_daily_interest_rate((0x2::clock::timestamp_ms(arg2) - v1.timestamp) / 86400000);
                return v1
            };
            v0 = v0 + 1;
        };
    ...
    public fun orderList(arg0: &YubiBao, arg1: &mut 0x2::tx_context::TxContext) : vector<StakingOrder> {
        let v0 = 0x2::tx_context::sender(arg1);
        let v1 = &arg0.users;
        if (!0x2::table::contains<address, vector<StakingOrder>>(v1, v0)) {
            return 0x1::vector::empty<StakingOrder>()
        };
        *0x2::table::borrow<address, vector<StakingOrder>>(v1, v0)
    }

    public entry fun redemptionUSDC<T0>(arg0: u64, arg1: &mut YubiBao, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun stakeUSDC<T0>(arg0: &mut YubiBao, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
