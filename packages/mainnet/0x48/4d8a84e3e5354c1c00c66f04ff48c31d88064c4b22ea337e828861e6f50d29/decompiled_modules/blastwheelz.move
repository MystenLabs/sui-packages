module 0xdb5c9ffb5f00e4b4678eacc9c19a1fd512f8750b367275e732e5f27b1360db84::blastwheelz {
    ...
    public fun create_collection<T0>(arg0: &0xdb5c9ffb5f00e4b4678eacc9c19a1fd512f8750b367275e732e5f27b1360db84::cap::AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: BLASTWHEELZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        setup_transfer_policy_for_type<BlastWheel>(&v0, arg1);
    ...
    public fun setup_transfer_policy<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        0xdb5c9ffb5f00e4b4678eacc9c19a1fd512f8750b367275e732e5f27b1360db84::rules::add_personal_kiosk_rule<NFT<T0>>(&mut v3, &v2);
        0xdb5c9ffb5f00e4b4678eacc9c19a1fd512f8750b367275e732e5f27b1360db84::rules::add_kiosk_lock_rule<NFT<T0>>(&mut v3, &v2);
        0xdb5c9ffb5f00e4b4678eacc9c19a1fd512f8750b367275e732e5f27b1360db84::rules::add_royalty_rule<NFT<T0>>(&mut v3, &v2, 0xdb5c9ffb5f00e4b4678eacc9c19a1fd512f8750b367275e732e5f27b1360db84::rules::new_royalty_config(500, 0));
    ...
    public fun update_mint_supply<T0>(arg0: &0xdb5c9ffb5f00e4b4678eacc9c19a1fd512f8750b367275e732e5f27b1360db84::cap::AdminCap, arg1: &mut Collection<T0>, arg2: u64) {
