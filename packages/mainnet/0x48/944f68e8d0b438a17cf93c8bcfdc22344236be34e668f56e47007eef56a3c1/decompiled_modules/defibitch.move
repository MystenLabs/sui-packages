module 0x48944f68e8d0b438a17cf93c8bcfdc22344236be34e668f56e47007eef56a3c1::defibitch {
    ...
    fun init(arg0: DEFIBITCH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DEFIBITCH>(arg0, 9, b"defibitch", b"DEFIBITCH", b"defibitch testing bundler on cetus", 0x1::option::none<0x2::url::Url>(), arg1);
