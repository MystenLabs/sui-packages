module 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::order_registry {
    ...
    public fun cancel_order<T0>(arg0: &mut OrderRegistry, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig, arg2: Receipt, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
    ...
    public fun claim_completed_order<T0>(arg0: &mut OrderRegistry, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig, arg2: Receipt, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg1);
        let Receipt {
            id       : v0,
            order_id : v1,
    ...
    public fun create_order<T0, T1>(arg0: &mut OrderRegistry, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: u8, arg5: u64, arg6: u64, arg7: u8, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : Receipt {
        validate_global_config(arg1);
        assert!(arg5 > 0, 10);
        assert!(arg3 > 0, 11);
    ...
    fun internal_complete_execution<T0, T1>(arg0: &mut Order, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::ExecTicket, arg2: u64) : (u64, u64, u64, u64) {
        validate_order_types<T0, T1>(arg0);
        assert!(arg0.executing_flag, 27);
        let v0 = 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::get_cycle_number(arg1);
        assert!(v0 <= arg0.order_num, 27);
        assert!(arg2 >= arg0.min_amount_out, 25);
        assert!(arg2 <= arg0.max_amount_out, 25);
        let v1 = 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::get_execution_time(arg1);
        ...
        (v0, 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::get_amount_borrowed(arg1), 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::get_amount_in_max(arg1), v1)
    }
    ...
    public fun operator_end_execute<T0, T1>(arg0: &mut OrderRegistry, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig, arg2: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::OperatorCap, arg3: 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::ExecTicket, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock) {
        validate_global_config(arg1);
        let v0 = 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::get_order_id(&arg3);
        ...
        let (_, _, _, _, _, _, _, _) = 0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::destroy_exec_ticket(arg3);
    }

    public fun operator_finalize<T0>(arg0: &mut OrderRegistry, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig, arg2: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::OperatorCap, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
    ...
    public fun operator_refund_cycle<T0>(arg0: &mut OrderRegistry, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig, arg2: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::OperatorCap, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg1);
        assert!(0x2::table::contains<address, Order>(&arg0.orders, arg3), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg0.orders, arg3);
    ...
    public fun operator_start_execute<T0>(arg0: &mut OrderRegistry, arg1: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig, arg2: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::OperatorCap, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::ExecTicket, 0x2::coin::Coin<T0>) {
        validate_global_config(arg1);
        assert!(0x2::table::contains<address, Order>(&arg0.orders, arg3), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg0.orders, arg3);
        ...
        (0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::ticket::new_exec_ticket(arg3, v5, v5, v1, v2, v3, v4, v1), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v6, v5), arg5))
    }
    ...
    fun validate_global_config(arg0: &0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::GlobalConfig) {
        assert!(!0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::is_paused(arg0), 1);
        assert!(0x48d6b1afd4f3c8eca1002d7101ebf8fe7d465deef829236904b64189e7582d15::config::get_version(arg0) == 2, 2);
    }
