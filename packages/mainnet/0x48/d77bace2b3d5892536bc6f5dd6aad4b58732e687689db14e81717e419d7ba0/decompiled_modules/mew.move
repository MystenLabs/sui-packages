module 0x48d77bace2b3d5892536bc6f5dd6aad4b58732e687689db14e81717e419d7ba0::mew {
    struct MEW has drop {
        dummy_field: bool,
    }

    fun init(arg0: MEW, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEW>(arg0, 6, b"MeW", b"MeowWoof", b"Once upon a time, in the bustling city of SuiVille,  a fierce rivalry existed between two factions: the memes of cats and the dogs.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/IMG_20241103_074717_683_5063f07569.jpg")), arg1);
