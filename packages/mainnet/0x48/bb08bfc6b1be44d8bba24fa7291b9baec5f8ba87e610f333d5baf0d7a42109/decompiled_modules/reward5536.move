module 0x48bb08bfc6b1be44d8bba24fa7291b9baec5f8ba87e610f333d5baf0d7a42109::reward5536 {
    struct REWARD5536 has drop {
        dummy_field: bool,
    }

    struct TICKET_5536 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5536(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5536>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5536>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5536, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5536>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5536>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5536>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5536>>(v5, 0x2::tx_context::sender(arg1));
    }
