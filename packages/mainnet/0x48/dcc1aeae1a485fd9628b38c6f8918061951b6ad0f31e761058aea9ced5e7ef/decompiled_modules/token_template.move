module 0x48dcc1aeae1a485fd9628b38c6f8918061951b6ad0f31e761058aea9ced5e7ef::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"E2EI", b"E2E Icon Token", b"A token with icon", 0x1::option::none<0x2::url::Url>(), arg1);
