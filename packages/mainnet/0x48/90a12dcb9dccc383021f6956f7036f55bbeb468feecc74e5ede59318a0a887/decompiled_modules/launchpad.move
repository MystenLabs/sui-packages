module 0x74e959db259d1712977737f62ec30f57dddf2726913bfc07f50978cf4e2dac06::launchpad {
    ...
    public entry fun start_ido(arg0: &mut LaunchpadStorage, arg1: &mut WhitelistStorage, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg2 != 99999) {
            arg0.total_deposit = arg2;
        };
        if (arg3 != 99999) {
            arg1.total_deposit = arg3;
        };
    }
