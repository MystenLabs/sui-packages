module 0x489ef378b863b2c48df57da5606dbe81f69082e2f5da105f66ddb9051aecd962::cnsnft6994 {
    struct CNSNFT6994 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6994, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6994>(arg0, arg1);
