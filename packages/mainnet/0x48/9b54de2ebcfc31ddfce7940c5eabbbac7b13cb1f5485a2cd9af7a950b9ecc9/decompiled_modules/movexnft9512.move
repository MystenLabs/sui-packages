module 0x489b54de2ebcfc31ddfce7940c5eabbbac7b13cb1f5485a2cd9af7a950b9ecc9::movexnft9512 {
    struct MOVEXNFT9512 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT9512, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT9512>(arg0, arg1);
