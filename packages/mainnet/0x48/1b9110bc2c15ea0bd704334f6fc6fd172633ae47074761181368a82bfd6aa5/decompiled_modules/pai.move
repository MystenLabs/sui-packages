module 0x481b9110bc2c15ea0bd704334f6fc6fd172633ae47074761181368a82bfd6aa5::pai {
    struct PAI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/WVdXTu5EUsNke22WuRAEH1t81hPAnRRQURQE3R3pump.png?size=lg&key=207691                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PAI     ")))), trim_right(b"Patent AI                       "), trim_right(b"Patent AI is pioneering the future of innovation by harnessing our database of millions of historical patents. Through advanced AI analysis, we're accelerating community-driven patent research and creating unprecedented opportunities for technological advancement.                                                        "), v2, arg1);
        let v5 = v3;
