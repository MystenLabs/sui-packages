module 0x483f187f27ca69effd4a3fa131fdb36e0d322ba925c5a0ea13dc037795680bf9::reward5885 {
    struct REWARD5885 has drop {
        dummy_field: bool,
    }

    struct TICKET_5885 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5885(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5885>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5885>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5885, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5885>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5885>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5885>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5885>>(v5, 0x2::tx_context::sender(arg1));
    }
