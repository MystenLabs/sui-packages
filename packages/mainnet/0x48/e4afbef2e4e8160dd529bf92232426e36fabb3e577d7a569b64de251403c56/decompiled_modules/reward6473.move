module 0x48e4afbef2e4e8160dd529bf92232426e36fabb3e577d7a569b64de251403c56::reward6473 {
    struct REWARD6473 has drop {
        dummy_field: bool,
    }

    struct TICKET_6473 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6473(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6473>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6473>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6473, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6473>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6473>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6473>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6473>>(v5, 0x2::tx_context::sender(arg1));
    }
