module 0x4890600cda0a8dc4de3feb32955b46084b23914f17ed508d039a613ef7def64f::rcd {
    struct RCD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RCD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<RCD>(arg0, 9, b"RCD", b"RCD Coin", x"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmU4f5JNcctaDXTkuPDddMgbGFxeKN2rx3ExFZnN8piXjx")), arg1);
        let v2 = v0;
