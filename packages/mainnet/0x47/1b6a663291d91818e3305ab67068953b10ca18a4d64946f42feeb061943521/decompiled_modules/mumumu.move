module 0x471b6a663291d91818e3305ab67068953b10ca18a4d64946f42feeb061943521::mumumu {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Mumumu v6 #{token_id}"));
        ...
        let v10 = v9;
        let v11 = v8;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<NFT>(&mut v11, &v10, 1000, 10000000);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<NFT>(&mut v11, &v10);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<NFT>>(v10, v0);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<NFT>>(v11);
