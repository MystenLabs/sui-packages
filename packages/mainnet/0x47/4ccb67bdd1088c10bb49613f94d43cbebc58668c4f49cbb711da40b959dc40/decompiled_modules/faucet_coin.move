module 0x474ccb67bdd1088c10bb49613f94d43cbebc58668c4f49cbb711da40b959dc40::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 6, b"FAUCET COIN", b"FAUCET COIN", b"FAUCET COIN", 0x1::option::none<0x2::url::Url>(), arg1);
