module 0x47bd89438bf8f1323aa261a0a37b18108455b041f461724a8bf2e2ddafac5443::cnsnft9537 {
    struct CNSNFT9537 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9537, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9537>(arg0, arg1);
