module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts {
    ...
    public(friend) fun assert_signed_action_sender_authorized(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &SubAccounts, arg2: &0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::unified_address::UnifiedAddress, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::unified_address::identifier(arg2);
        let v2 = if (v0 == 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::gas_relayer(arg0)) {
            true
        } else if (v0 == v1) {
            true
        } else {
            is_sub_account(arg1, v1, v0)
        };
        assert!(v2, 920);
    }
    ...
    entry fun set_sub_account_v2(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &mut SubAccounts, arg2: &mut TxIndexer, arg3: &0x2::clock::Clock, arg4: vector<u8>, arg5: vector<u8>, arg6: bool, arg7: u128, arg8: u64, arg9: vector<u8>, arg10: vector<u8>) {
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::check_basic(arg0);
        let v0 = 0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::unified_address::from_tagged_bytes(arg4);
        let v1 = 0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::unified_address::from_tagged_bytes(arg5);
        0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::signature::assert_signed_payload_fresh(arg3, arg8, 34);
        let v2 = 0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::payload::set_sub_account(v0, v1, arg6, arg7, arg8);
        0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::signature::verify_user_signature(&v0, 0x1::vector::empty<address>(), v2, arg9, arg10, 52);
        validate_unique_tx(arg2, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::get_hash(v2));
        set_sub_account_internal(arg1, 0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::unified_address::identifier(&v0), 0x9041eddbe15edba576c8c0bd4237e07b19e2c17fb59b240658f96522261f10c4::unified_address::identifier(&v1), arg6);
    }

    public(friend) fun validate_unique_tx(arg0: &mut TxIndexer, arg1: vector<u8>) : u128 {
        assert!(!0x2::table::contains<vector<u8>, bool>(&arg0.map, arg1), 906);
