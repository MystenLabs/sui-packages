module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::perpetual {
    ...
    public(friend) fun get_fee(arg0: &Perpetual, arg1: address, arg2: bool) : u128 {
        if (0x2::table::contains<address, SpecialFee>(&arg0.special_fee, arg1)) {
            let v0 = 0x2::table::borrow<address, SpecialFee>(&arg0.special_fee, arg1);
            if (v0.status) {
                if (arg2) {
                    return v0.maker_fee
                };
    ...
    public(friend) fun perp_address(arg0: &Perpetual) : address {
    ...
    public fun set_maker_fee(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::roles::ExchangeManagerCap, arg2: &mut Perpetual, arg3: u128) {
        ...
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::roles::check_manager_validity(arg0, arg1);
        let v0 = arg3 / 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_uint();
        assert!(v0 <= 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_uint(), 99999);
        arg2.maker_fee = v0;
    ...
    public(friend) fun update_oracle_price_v2(arg0: &mut Perpetual, arg1: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::price_feed::PriceFeed, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::object::uid_to_inner(&arg0.id);
        assert!(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::price_feed::contains(arg1, &v0), 903);
