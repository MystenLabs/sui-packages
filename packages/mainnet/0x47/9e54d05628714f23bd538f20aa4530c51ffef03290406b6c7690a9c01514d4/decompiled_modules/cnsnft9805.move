module 0x479e54d05628714f23bd538f20aa4530c51ffef03290406b6c7690a9c01514d4::cnsnft9805 {
    struct CNSNFT9805 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9805, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9805>(arg0, arg1);
