module 0x478fead33dc04c8eedd90453be5a9b839fbf043176fc8826305e4861406259f8::cnsnft4246 {
    struct CNSNFT4246 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4246, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1031"));
        let v4 = 0x2::package::claim<CNSNFT4246>(arg0, arg1);
