module 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::rebalance {
    ...
    public fun lp_residual_amount<T0, T1, T2>(arg0: &mut 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: bool, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg4 && (0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_balance_a_val<T0, T1, T2>(arg0) > 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_threshold_a<T0, T1, T2>(arg0) || arg5 > 0)) {
            let (v0, v1) = if (arg5 == 0) {
                0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::get_optimal_swap_amount_for_single_sided_liquidity<T0, T1, T2>(arg0, arg1, 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_balance_a_val<T0, T1, T2>(arg0), true, 10)
            } else {
                (arg5, false)
            };
            let v2 = 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::get_free_balance_a<T0, T1, T2>(arg0);
            assert!(v0 <= 0x2::balance::value<T0>(&v2), 10);
            let (v3, v4) = 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::utils::swap<T0, T1>(arg2, arg1, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v2, v0), arg6), 0x2::coin::zero<T1>(arg6), true, true, v0, 4295048016, arg3, arg6);
            let v5 = v4;
            0x2::coin::destroy_zero<T0>(v3);
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg2, arg1, v2, 0x2::coin::into_balance<T1>(v5), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg2, arg1, 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::position_borrow_mut<T0, T1, T2>(arg0), 0x2::coin::value<T1>(&v5), v1, arg3));
            let v6 = LpResidualEvent{
            ...
            0x2::event::emit<LpResidualEvent>(v6);
        };
        if (!arg4 && (0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_balance_b_val<T0, T1, T2>(arg0) > 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_threshold_b<T0, T1, T2>(arg0) || arg5 > 0)) {
            let (v7, v8) = if (arg5 == 0) {
                0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::get_optimal_swap_amount_for_single_sided_liquidity<T0, T1, T2>(arg0, arg1, 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_balance_b_val<T0, T1, T2>(arg0), false, 10)
            } else {
                (arg5, false)
            };
            let v9 = 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::get_free_balance_b<T0, T1, T2>(arg0);
            assert!(v7 <= 0x2::balance::value<T1>(&v9), 11);
            let (v10, v11) = 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::utils::swap<T0, T1>(arg2, arg1, 0x2::coin::zero<T0>(arg6), 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v9, v7), arg6), false, true, v7, 79226673515401279992447579055, arg3, arg6);
            let v12 = v10;
            0x2::coin::destroy_zero<T1>(v11);
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg2, arg1, 0x2::coin::into_balance<T0>(v12), v9, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg2, arg1, 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::position_borrow_mut<T0, T1, T2>(arg0), 0x2::coin::value<T0>(&v12), v8, arg3));
            let v13 = LpResidualEvent{
                vault_id        : 0x2::object::id<0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::Vault<T0, T1, T2>>(arg0),
                residual_coin_a : 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_balance_a_val<T0, T1, T2>(arg0),
                residual_coin_b : 0x8721f299fb20d6d12749c257e3b9a0140fe25d1d64faf999b6cc055d1fcaf209::vault::free_balance_b_val<T0, T1, T2>(arg0),
            };
            0x2::event::emit<LpResidualEvent>(v13);
        };
    }
