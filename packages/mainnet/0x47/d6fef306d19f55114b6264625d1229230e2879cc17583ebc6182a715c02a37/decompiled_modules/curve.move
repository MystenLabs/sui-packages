module 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::curve {
    ...
    public fun burn_share(arg0: u64, arg1: u64, arg2: u64) : u64 {
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::math::mul_div(arg0, arg1, arg1 + arg2)
    }

    public(friend) fun buy(arg0: &mut 0x2::object::UID, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = CurveKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<CurveKey>(arg0, v0)) {
            return 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::math::output(arg3, arg2, arg1)
        };
        ...
        let v3 = if (v2.basis == 0) {
            ...
            0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::math::mul_div(arg3, v2.basis, arg2)
        };
        assert!(v3 > 0, 1);
        v2.basis = v2.basis + v3;
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::math::output(v3, v2.virtual_quote + v2.basis, arg1)
    }
    ...
    public(friend) fun install(arg0: &mut 0x2::object::UID, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg1 <= 1000000000000000, 1);
        if (arg1 == 0) {
            return
        };
        assert!(arg2 > 0 && arg1 <= arg2 * 100, 1);
    ...
    public fun min_bond_target() : u64 {
        100000000
    }
    ...
    public(friend) fun sell(arg0: &mut 0x2::object::UID, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = CurveKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<CurveKey>(arg0, v0)) {
            return 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::math::output(arg3, arg1, arg2)
        };
        let v1 = CurveKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<CurveKey, Curve>(arg0, v1);
        let v3 = 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::math::output(arg3, arg1, v2.virtual_quote + v2.basis);
        assert!(v3 <= v2.basis, 2);
        v2.basis = v2.basis - v3;
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::math::mul_div(v3, arg2, v2.basis)
    }
