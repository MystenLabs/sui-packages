module 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::config {
    ...
    public fun cancel_funding(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::cancel(&mut arg0.id);
    }

    public fun cancel_hibernation(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::cancel(&mut arg0.id);
    }
    ...
    public fun execute_funding(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::execute(&mut arg0.id, arg1);
    }

    public fun execute_hibernation(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::execute(&mut arg0.id, arg1);
    }
    ...
    public fun funding(arg0: &Config) : 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::Rules {
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::get(&arg0.id)
    }

    public fun funding_proposal(arg0: &Config) : (bool, 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::Rules, u64) {
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::pending(&arg0.id)
    }

    public fun hibernation(arg0: &Config) : 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::Rules {
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::get(&arg0.id)
    }

    public fun hibernation_proposal(arg0: &Config) : (bool, 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::Rules, u64) {
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::pending(&arg0.id)
    }
    ...
    public fun propose_funding(arg0: &mut Config, arg1: &AdminCap, arg2: 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::funding_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }

    public fun propose_hibernation(arg0: &mut Config, arg1: &AdminCap, arg2: 0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0x47d6fef306d19f55114b6264625d1229230e2879cc17583ebc6182a715c02a37::hibernation_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }
