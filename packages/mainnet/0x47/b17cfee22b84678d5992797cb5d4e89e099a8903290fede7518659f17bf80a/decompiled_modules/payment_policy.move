module 0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::payment_policy {
    ...
    public fun createPolicy<T0: store + key>(arg0: &0x2::package::Publisher, arg1: &0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun payByCoin<T0: store + key, T1>(arg0: &mut 0x2::transfer_policy::TransferRequest<T0>, arg1: &0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::public_kiosk::Order, arg2: &mut 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        let (_, v1, v2, v3) = 0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::public_kiosk::orderInfo(arg1);
    ...
    public fun payByToken<T0: store + key, T1>(arg0: &mut 0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::xbird::BirdPegVault<T1>, arg1: &mut 0x2::transfer_policy::TransferRequest<T0>, arg2: &0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::public_kiosk::Order, arg3: &mut 0x2::token::Token<T1>, arg4: &mut 0x2::tx_context::TxContext) {
        let (_, v1, v2, v3) = 0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::public_kiosk::orderInfo(arg2);
        ...
        let (_, _, _, _) = 0x2::token::confirm_with_treasury_cap<T1>(0x47b17cfee22b84678d5992797cb5d4e89e099a8903290fede7518659f17bf80a::xbird::borrowMutTreasure<T1>(arg0), 0x2::token::transfer<T1>(0x2::token::split<T1>(arg3, v4, arg4), v2, arg4), arg4);
