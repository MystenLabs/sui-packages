module 0x47d445051dcdab782c999932f826e8762d777c0229e7f1cefa422035d8629362::cnsnft8587 {
    struct CNSNFT8587 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8587, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8587>(arg0, arg1);
