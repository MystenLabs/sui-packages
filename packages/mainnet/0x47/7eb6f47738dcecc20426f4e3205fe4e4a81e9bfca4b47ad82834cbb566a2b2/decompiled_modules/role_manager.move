module 0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::role_manager {
    ...
    public entry fun activate_role(arg0: &mut Role, arg1: &0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT) {
        assert!(0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(arg1) == arg0.bot_nft_id, 103);
        assert!(!arg0.is_active, 101);
        assert!(arg0.health >= 1000000000, 102);
        arg0.is_active = true;
    }

    public entry fun add_skill(arg0: &mut Role, arg1: &0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT, arg2: &0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::skill_manager::Skill, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(arg1) == arg0.bot_nft_id, 103);
        assert!(0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::skill_manager::is_enabled(arg2), 107);
        let v0 = 0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::skill_manager::Skill>(arg2);
        let v1 = 0;
    ...
    public entry fun create_role(arg0: address, arg1: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>, arg2: 0x1::ascii::String, arg3: 0x1::ascii::String, arg4: 0x1::ascii::String, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg5) >= 100000000000 / 1000, 102);
        let v0 = 0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::mint_bot_nft(arg1, arg2, arg3, arg4, arg6);
        let v1 = Role{
            id              : 0x2::object::new(arg6),
            bot_nft_id      : 0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(&v0),
            health          : 100000000000,
            is_active       : true,
            is_locked       : false,
        ...
        0x2::transfer::public_transfer<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(v0, 0x2::tx_context::sender(arg6));
    }

    public entry fun deactivate_role(arg0: &mut Role, arg1: &0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT) {
        assert!(0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(arg1) == arg0.bot_nft_id, 103);
    ...
    public entry fun remove_skill(arg0: &mut Role, arg1: &0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT, arg2: 0x2::object::ID) {
        assert!(0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(arg1) == arg0.bot_nft_id, 103);
        let v0 = 0;
        let v1 = false;
    ...
    public entry fun toggle_lock(arg0: &mut Role, arg1: &0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT) {
        assert!(0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(arg1) == arg0.bot_nft_id, 103);
    ...
    public entry fun withdraw_sui_with_nft(arg0: &mut Role, arg1: &0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<0x477eb6f47738dcecc20426f4e3205fe4e4a81e9bfca4b47ad82834cbb566a2b2::bot_nft::BotNFT>(arg1) == arg0.bot_nft_id, 103);
