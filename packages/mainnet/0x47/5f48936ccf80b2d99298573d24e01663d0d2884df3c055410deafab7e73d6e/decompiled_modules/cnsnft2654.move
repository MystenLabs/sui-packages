module 0x475f48936ccf80b2d99298573d24e01663d0d2884df3c055410deafab7e73d6e::cnsnft2654 {
    struct CNSNFT2654 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2654, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2654>(arg0, arg1);
