module 0x47d7fa24f5374dfac46f1c1124ac5613cf6aea02d6ff097e45ce660c1a00adf1::pool {
    ...
    public fun new<T0>(arg0: 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::Pool<T0>, arg1: u16, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : (DaoFeePool<T0>, OwnerCap<T0>) {
        ...
        0x47d7fa24f5374dfac46f1c1124ac5613cf6aea02d6ff097e45ce660c1a00adf1::events::emit_created_pool_event(0x2::object::uid_to_inner(&v0.id), v0.pool_id, arg1, arg2);
        (v0, v2)
    }
    ...
    fun init(arg0: POOL, arg1: &mut 0x2::tx_context::TxContext) {
        0x47d7fa24f5374dfac46f1c1124ac5613cf6aea02d6ff097e45ce660c1a00adf1::version::init_package_version<POOL>(&arg0, arg1);
    ...
    public fun update_fee_bps<T0>(arg0: &OwnerCap<T0>, arg1: &mut DaoFeePool<T0>, arg2: u16) {
        0x47d7fa24f5374dfac46f1c1124ac5613cf6aea02d6ff097e45ce660c1a00adf1::events::emit_updated_fee_bps_event(0x2::object::uid_to_inner(&arg1.id), arg1.fee_bps, arg2);
        arg1.fee_bps = arg2;
    }

    public fun update_fee_recipient<T0>(arg0: &OwnerCap<T0>, arg1: &mut DaoFeePool<T0>, arg2: address) {
        0x47d7fa24f5374dfac46f1c1124ac5613cf6aea02d6ff097e45ce660c1a00adf1::events::emit_updated_fee_recipient_event(0x2::object::uid_to_inner(&arg1.id), arg1.fee_recipient, arg2);
