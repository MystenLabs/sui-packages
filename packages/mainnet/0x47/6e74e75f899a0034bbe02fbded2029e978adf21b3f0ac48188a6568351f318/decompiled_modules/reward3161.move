module 0x476e74e75f899a0034bbe02fbded2029e978adf21b3f0ac48188a6568351f318::reward3161 {
    struct REWARD3161 has drop {
        dummy_field: bool,
    }

    struct TICKET_3161 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3161(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_3161>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3161, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3161>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3161>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3161>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3161>>(v5, 0x2::tx_context::sender(arg1));
    }
