module 0x477c966614b844f27792404bba3a40e1f5dc03a9fb5f49c40e2bea67eeb202bc::db {
    ...
    public fun create_manager_badge(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : AtomaManagerBadge {
        assert!(0x2::package::from_module<0x477c966614b844f27792404bba3a40e1f5dc03a9fb5f49c40e2bea67eeb202bc::atoma::ATOMA>(arg0), 312012002);
    ...
    fun sample_node(arg0: &0x2::table::Table<SmallId, NodeEntry>, arg1: &mut 0x2::table_vec::TableVec<SmallId>, arg2: &mut 0x2::random::RandomGenerator) : 0x1::option::Option<SmallId> {
        ...
        loop {
            ...
            if (v2 == 0) {
                ...
                v0 = 0x1::option::none<SmallId>();
                return v0
            };
            let v4 = 0x2::random::generate_u64(arg2) % v2;
            v1 = *0x2::table_vec::borrow<SmallId>(arg1, v4);
            if (0x2::table::contains<SmallId, NodeEntry>(arg0, v1)) {
                let v5 = 0x2::table::borrow<SmallId, NodeEntry>(arg0, v1);
