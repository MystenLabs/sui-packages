module 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::position_core_clmm {
    ...
    public fun increase_debt_x_without_increasing_assets<T0, T1, T2, T3>(arg0: &mut Position<T0, T1, T3>, arg1: &PositionConfig, arg2: &mut 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::supply_pool::SupplyPool<T0, T2>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0xd9dd55ac7eb676dc78f7d0ae3bc5529d7fd6b52ac0d0edb2d7820c52d080026::access::ActionRequest) {
        assert!(position_config_id<T0, T1, T3>(arg0) == 0x2::object::id<PositionConfig>(arg1), 13906846741417689087);
        let (v0, v1) = 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::supply_pool::borrow<T0, T2>(arg2, lend_facil_cap(arg1), arg3, arg4);
        0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::supply_pool::fdb_add<T0, T2>(&mut arg0.debt_bag, v1);
        let v2 = AIncreaseDebt{dummy_field: false};
        (v0, 0xd9dd55ac7eb676dc78f7d0ae3bc5529d7fd6b52ac0d0edb2d7820c52d080026::access::new_request<AIncreaseDebt>(v2, arg5))
    }

    public fun increase_debt_y_without_increasing_assets<T0, T1, T2, T3>(arg0: &mut Position<T0, T1, T3>, arg1: &PositionConfig, arg2: &mut 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::supply_pool::SupplyPool<T1, T2>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0xd9dd55ac7eb676dc78f7d0ae3bc5529d7fd6b52ac0d0edb2d7820c52d080026::access::ActionRequest) {
        assert!(position_config_id<T0, T1, T3>(arg0) == 0x2::object::id<PositionConfig>(arg1), 13906846818727100415);
        let (v0, v1) = 0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::supply_pool::borrow<T1, T2>(arg2, lend_facil_cap(arg1), arg3, arg4);
        0x1f03f5e13daec5aa467a9a62cc11f0b9e141953adf1e90f073d76ce38f8fb48d::supply_pool::fdb_add<T1, T2>(&mut arg0.debt_bag, v1);
        let v2 = AIncreaseDebt{dummy_field: false};
        (v0, 0xd9dd55ac7eb676dc78f7d0ae3bc5529d7fd6b52ac0d0edb2d7820c52d080026::access::new_request<AIncreaseDebt>(v2, arg5))
    }
