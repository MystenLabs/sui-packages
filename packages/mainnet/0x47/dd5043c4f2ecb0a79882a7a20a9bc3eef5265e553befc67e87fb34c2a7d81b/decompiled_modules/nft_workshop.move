module 0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_workshop {
    ...
    fun buildAttr(arg0: &vector<vector<u8>>, arg1: &vector<vector<u8>>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::table::Table<vector<u8>, vector<u8>> {
        let v0 = 0x2::table::new<vector<u8>, vector<u8>>(arg2);
        let v1 = 0x1::vector::length<vector<u8>>(arg0);
        while (v1 > 0) {
            v1 = v1 - 1;
            0x2::table::add<vector<u8>, vector<u8>>(&mut v0, *0x1::vector::borrow<vector<u8>>(arg0, v1), *0x1::vector::borrow<vector<u8>>(arg1, v1));
        };
        v0
    }

    public entry fun burnNft(arg0: 0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = BurnNftEvent{
            sender : 0x2::tx_context::sender(arg1),
            nft    : 0x2::object::id_address<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(&arg0),
        };
        0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::burn(arg0);
    ...
    public entry fun claimNft(arg0: &mut Workshop, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::mint(v3.name, v3.link, *0x1::vector::borrow<vector<u8>>(&arg0.urls, ((v1 - v2 * v1 / v2) as u64)), v3.description, v3.project_url, v3.edition, v3.thumbnail_url, v3.creator, v6, arg1);
        let v9 = MintNftEvent{
            minter   : v0,
            receiver : v0,
            nft      : 0x2::object::id_address<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(&v8),
        };
        0x2::transfer::public_transfer<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(v8, v0);
    ...
    fun init(arg0: NFT_WORKSHOP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::display::new_with_fields<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(&v5, v1, v3, arg1);
        0x2::display::update_version<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(&mut v6);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::mint(b"Genesis NFT campaign", b"https://seapad.fund/nftcampaign", b"https://seapad.s3.ap-southeast-1.amazonaws.com/uploads/nft/new-year-nft.png", b"Genesis NFT campaign", b"https://seapad.fund/", 1, b"https://seapad.s3.ap-southeast-1.amazonaws.com/uploads/nft/new-year-nft.png", b"SeaPad Foundation", 0x2::table::new<vector<u8>, vector<u8>>(arg1), arg1), 0x2::tx_context::sender(arg1));
        let v7 = NftAdminCap{id: 0x2::object::new(arg1)};
        let v8 = &mut v0;
        setTemplate(&v7, b"Seapad New Year Collection", b"https://seapad.fund/nftcampaign", b"Seapad New Year Collection", b"https://seapad.fund/", 1, b"https://seapad.s3.ap-southeast-1.amazonaws.com/uploads/nft/new-year-nft.png", b"SeaPad Foundation", 0x1::vector::empty<vector<u8>>(), 0x1::vector::empty<vector<u8>>(), 100000, v8);
        let v9 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v9, b"https://seapad.s3.ap-southeast-1.amazonaws.com/uploads/nft/new-year-nft.png");
        let v10 = &mut v0;
    ...
    public entry fun mintBatch(arg0: &NftAdminCap, arg1: &mut Workshop, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.state == 2, 6100);
        assert!(arg1.total_mint < arg1.total_supply, 6103);
        assert!(arg3 > 0, 6102);
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::address::to_u256(v0) + (0x2::tx_context::epoch_timestamp_ms(arg4) as u256);
        let v2 = (0x1::vector::length<vector<u8>>(&arg1.urls) as u256);
        let v3 = 0x1::option::borrow_mut<Template>(&mut arg1.template);
        let v4 = &v3.attributes_names;
        let v5 = &v3.attributes_values;
        while (arg3 > 0) {
            arg3 = arg3 - 1;
            let v6 = buildAttr(v4, v5, arg4);
            let v7 = 0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::mint(v3.name, v3.link, *0x1::vector::borrow<vector<u8>>(&arg1.urls, ((v1 - v2 * v1 / v2) as u64)), v3.description, v3.project_url, v3.edition, v3.thumbnail_url, v3.creator, v6, arg4);
            let v8 = MintNftEvent{
                minter   : v0,
                receiver : arg2,
                nft      : 0x2::object::id_address<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(&v7),
            };
            0x2::transfer::public_transfer<0x47dd5043c4f2ecb0a79882a7a20a9bc3eef5265e553befc67e87fb34c2a7d81b::nft_private::PriNFT>(v7, arg2);
            arg1.total_mint = arg1.total_mint + 1;
