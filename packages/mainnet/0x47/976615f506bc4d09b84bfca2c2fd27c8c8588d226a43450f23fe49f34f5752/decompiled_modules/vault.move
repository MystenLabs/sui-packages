module 0x47976615f506bc4d09b84bfca2c2fd27c8c8588d226a43450f23fe49f34f5752::vault {
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<VAULT>(arg0, 9, b"ALPHA", b"ALPHA Token", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://decentanft.link/token-image/token-6QSaXfmcJ-.svg"))), arg1);
