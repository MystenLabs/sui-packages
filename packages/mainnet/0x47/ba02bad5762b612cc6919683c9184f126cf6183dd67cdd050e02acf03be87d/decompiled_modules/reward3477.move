module 0x47ba02bad5762b612cc6919683c9184f126cf6183dd67cdd050e02acf03be87d::reward3477 {
    struct REWARD3477 has drop {
        dummy_field: bool,
    }

    struct TICKET_3477 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3477(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3477>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3477>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3477, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3477>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3477>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3477>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3477>>(v5, 0x2::tx_context::sender(arg1));
    }
