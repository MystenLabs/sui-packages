module 0x471ffd788aba7038e51417909796eb8d0aacd9da8cf3e364da77f51f988b0b3e::movexnft6284 {
    struct MOVEXNFT6284 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT6284, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT6284>(arg0, arg1);
