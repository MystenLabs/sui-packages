module 0x47f78bab4a7c72bbb34f5d25cdabe9dc7632e223a5cc74cdf08c5a7405e3e5c4::elementals {
    ...
    public entry fun mint_element(arg0: &AdminRegistry, arg1: address, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg9) == arg1, 4);
        assert!(0x2::vec_set::contains<address>(&arg0.admins, &arg8), 3);
        let v0 = vector[b"Aether", b"Air", b"Fire", b"Earth", b"Water"];
        ...
        let v1 = ElementNFT{
            ...
            thumbnail_url : arg5,
            project_url   : arg6,
            creator       : 0x2::address::to_string(arg8),
            element_type  : arg7,
        };
