module 0x473875ed1305f8d39cbc9ae498a518450a3adc8e289bf461fd763de64dd82d14::comeback_pool {
    ...
    public entry fun verify_milestone(arg0: &mut Pool, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.navigator, 2);
        assert!(arg1 < 0x1::vector::length<Milestone>(&arg0.milestones), 3);
        let v0 = 0x1::vector::borrow_mut<Milestone>(&mut arg0.milestones, arg1);
        v0.completed = true;
        v0.verified_at = 0x2::clock::timestamp_ms(arg2);
    }
