module 0xb026eeb6fdb5161a148657ad8fd64abd238aae36e2eef2e0bbee0bcf10ba1c41::oracle_utils {
    ...
    public fun calculate_amplitude(arg0: u256, arg1: u256) : u64 {
        ...
        if (v0 > 0x2::address::max() / (0xb026eeb6fdb5161a148657ad8fd64abd238aae36e2eef2e0bbee0bcf10ba1c41::oracle_constants::multiple() as u256)) {
            return 18446744073709551615
        };
        let v1 = v0 * (0xb026eeb6fdb5161a148657ad8fd64abd238aae36e2eef2e0bbee0bcf10ba1c41::oracle_constants::multiple() as u256) / arg0;
