module 0x47cf688dff2f021c693de8bba024d89d1be4552703d951f273884a11a9964cc4::mycoin {
    struct MYCOIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: MYCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MYCOIN>(arg0, 2, b"w626w", b"w626w", b"", 0x1::option::none<0x2::url::Url>(), arg1);
