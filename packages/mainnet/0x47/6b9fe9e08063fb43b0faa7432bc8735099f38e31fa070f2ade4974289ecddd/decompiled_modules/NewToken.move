module 0x476b9fe9e08063fb43b0faa7432bc8735099f38e31fa070f2ade4974289ecddd::NewToken {
    ...
    fun init(arg0: NEWTOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NEWTOKEN>(arg0, 6, b"RWTOKEN", b"Reward Token", b"Token", 0x1::option::none<0x2::url::Url>(), arg1);
