module 0x47414744b641c38f1745bef4c2c4d819b61cb99e8476f6f56f2cbf7346e6a6a2::reward2151 {
    struct REWARD2151 has drop {
        dummy_field: bool,
    }

    struct TICKET_2151 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2151(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2151>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2151>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2151, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2151>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2151>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2151>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2151>>(v5, 0x2::tx_context::sender(arg1));
    }
