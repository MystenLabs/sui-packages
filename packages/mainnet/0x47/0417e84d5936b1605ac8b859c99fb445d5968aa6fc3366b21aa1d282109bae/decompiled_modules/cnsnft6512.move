module 0x470417e84d5936b1605ac8b859c99fb445d5968aa6fc3366b21aa1d282109bae::cnsnft6512 {
    struct CNSNFT6512 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6512, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6512>(arg0, arg1);
