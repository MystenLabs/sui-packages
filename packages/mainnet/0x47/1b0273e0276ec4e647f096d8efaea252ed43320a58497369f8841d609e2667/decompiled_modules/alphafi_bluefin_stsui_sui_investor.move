module 0x7df55a5cb5d91bc52b20b8b12daadc7bdc64091767bc2325b5da9afadea13069::alphafi_bluefin_stsui_sui_investor {
    ...
    fun autocompound_internal<T0, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg4: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0xe1b45a0e641b9955a20aa0ad1c1f4ad86aad8afb07296d4085e349a50e90bdca::blue::BLUE> {
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::is_reward_present<T0, T1, 0xe1b45a0e641b9955a20aa0ad1c1f4ad86aad8afb07296d4085e349a50e90bdca::blue::BLUE>(arg2)) {
            ...
            update_free_rewards<T0, T1, 0xe1b45a0e641b9955a20aa0ad1c1f4ad86aad8afb07296d4085e349a50e90bdca::blue::BLUE>(arg0, v6);
        };
        if (0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::lst_to_sui_redemption_price<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, 0x2::balance::value<T0>(&v5)) > 0) {
            let v7 = recast_balance_type<T0, T1, T0, 0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg0, v5);
            let v8 = recast_balance_type<T0, T1, 0x2::sui::SUI, T1>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::redeem<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, 0x2::coin::from_balance<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(v7, arg7), arg5, arg7)));
            0x2::balance::join<T1>(&mut v4, v8);
        } else {
            update_free_rewards<T0, T1, T0>(arg0, v5);
        };
        let v9 = 0x2::balance::value<T1>(&v4);
        if (v9 >= arg0.minimum_swap_amount) {
            let (_, v11) = get_bluefin_sqrt_price_limits<T2, T1>(arg3);
            let (v12, v13) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T2, T1>(arg6, arg1, arg3, 0x2::balance::zero<T2>(), v4, false, true, v9, 0, v11);
            0x2::balance::destroy_zero<T1>(v13);
            update_free_rewards<T0, T1, T2>(arg0, v12);
        } else {
    ...
    public(friend) fun free_balance_settle<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::withdraw_all<T0>(&mut arg0.free_balance_a);
        let v1 = 0x2::balance::withdraw_all<T1>(&mut arg0.free_balance_b);
        let (v2, v3) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, v0, v1, arg2, arg3, arg4, arg6);
        let (_, v5, v6, v7) = get_balances_in_ratio<T0, T1>(arg0, v2, v3, arg2, true, arg6);
        let v8 = v6;
        let v9 = v5;
        if (0x2::balance::value<T0>(&v9) > 100 || 0x2::balance::value<T1>(&v8) > 100) {
            deposit<T0, T1>(arg0, arg1, arg2, v9, v8, v7, arg5);
        } else {
    ...
    fun get_total_balance_in_ratio_with_limit<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg5: &mut 0x3::sui_system::SuiSystemState, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        if (0x2::balance::value<T0>(&arg1) == 0 || 0x2::balance::value<T1>(&arg2) == 0) {
        ...
        if (v16 > 0) {
            let v18 = v16 / 2;
            let v19 = (v7 as u256) * (0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::lst_to_sui_redemption_price<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, v18) as u256) + (v18 as u256) * (v8 as u256);
            let v20 = if (v19 > 0) {
                (v16 as u256) * (v8 as u256) * (v18 as u256) / v19
            } else {
                0
            };
            if (0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::lst_to_sui_redemption_price<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, (v20 as u64)) > 0) {
                let v21 = 0x2::balance::split<T0>(&mut arg0.free_balance_a, (v20 as u64));
                let v22 = recast_balance_type<T0, T1, T0, 0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg0, v21);
                let v23 = recast_balance_type<T0, T1, 0x2::sui::SUI, T1>(arg0, 0x2::coin::into_balance<0x2::sui::SUI>(0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::redeem<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, 0x2::coin::from_balance<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(v22, arg6), arg5, arg6)));
                0x2::balance::join<T1>(&mut v4, v23);
                0x2::balance::join<T0>(&mut v5, 0x2::balance::withdraw_all<T0>(&mut arg0.free_balance_a));
            };
        } else if (v17 > 0) {
            let v24 = v17 / 2;
            let v25 = (v8 as u256) * (0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::sui_to_lst_mint_price<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, v24) as u256) + (v24 as u256) * (v7 as u256);
            let v26 = if (v25 > 0) {
                (v17 as u256) * (v7 as u256) * (v24 as u256) / v25
            } else {
                0
            };
            if (0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::sui_to_lst_mint_price<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, (v26 as u64)) > 0) {
                let v27 = 0x2::balance::split<T1>(&mut arg0.free_balance_b, (v26 as u64));
                let v28 = recast_balance_type<T0, T1, T1, 0x2::sui::SUI>(arg0, v27);
                let v29 = recast_balance_type<T0, T1, 0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI, T0>(arg0, 0x2::coin::into_balance<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::mint<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>(arg4, arg5, 0x2::coin::from_balance<0x2::sui::SUI>(v28, arg6), arg6)));
    ...
    public fun rebalance<T0, T1, T2>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::RebalanceCap, arg2: &0x7df55a5cb5d91bc52b20b8b12daadc7bdc64091767bc2325b5da9afadea13069::version::Version, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: u32, arg5: u32, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T1>, arg8: &mut 0xc35ee7fee75782806890cf8ed8536b52b4ba0ace0fb46b944f1155cc5945baa3::liquid_staking::LiquidStakingInfo<0xd1b72982e40348d069bb1ff701e634c117bb5f741f44dff91e472d3b01461e55::stsui::STSUI>, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg3, arg6, arg4, arg5, arg11);
        let v2 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(&v0);
        let (v3, v4) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_amount_by_liquidity(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.upper_tick), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg6), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg6), v2, false);
        let v5 = arg0.lower_tick;
        let v6 = arg0.upper_tick;
        arg0.lower_tick = arg4;
        arg0.upper_tick = arg5;
        let v7 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg6);
        let (_, _, v10, v11) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg3, arg6, &mut v0, v2, arg10);
        let v12 = v11;
        let v13 = v10;
        ...
        let (v14, v15) = get_total_balance_in_ratio_with_limit<T0, T1>(arg0, v13, v12, arg6, arg8, arg9, arg11);
        let (_, v17, v18, v19) = get_balances_in_ratio<T0, T1>(arg0, v14, v15, arg6, true, arg11);
        let v20 = v18;
        let v21 = v17;
        if (0x2::balance::value<T0>(&v21) > 100 || 0x2::balance::value<T1>(&v20) > 100) {
            let (v22, v23) = if (0x2::balance::value<T0>(&v21) == 0 || v19 == false) {
                let (v24, v25, v26, v27) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg10, arg3, arg6, &mut v1, v21, v20, 0x2::balance::value<T1>(&v20), false);
                let _ = v25;
                let _ = v24;
                (v26, v27)
            } else {
                let (v30, v31, v32, v33) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg10, arg3, arg6, &mut v1, v21, v20, 0x2::balance::value<T0>(&v21), true);
                let _ = v31;
                let _ = v30;
                (v32, v33)
            };
        ...
        let v34 = autocompound_internal<T0, T1, T2>(arg0, arg3, arg6, arg7, arg8, arg9, arg10, arg11);
        update_free_rewards<T0, T1, 0xe1b45a0e641b9955a20aa0ad1c1f4ad86aad8afb07296d4085e349a50e90bdca::blue::BLUE>(arg0, v34);
        close_position<T0, T1>(arg6, 0x2::dynamic_field::remove<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&mut arg0.id, b"Position"), arg3, arg10);
        ...
        free_balance_settle<T0, T1>(arg0, arg3, arg6, arg8, arg9, arg10, arg11);
        let v35 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(0x2::dynamic_field::borrow<vector<u8>, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&arg0.id, b"Position"));
    ...
    fun recast_balance_type<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T2>) : 0x2::balance::Balance<T3> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T3>()) == true, 13906835660402065407);
