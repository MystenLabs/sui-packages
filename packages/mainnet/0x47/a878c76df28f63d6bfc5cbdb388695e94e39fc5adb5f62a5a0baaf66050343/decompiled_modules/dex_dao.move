module 0x47a878c76df28f63d6bfc5cbdb388695e94e39fc5adb5f62a5a0baaf66050343::dex_dao {
    struct DexDaoConfig has store, key {
        id: 0x2::object::UID,
        dex_dao_cap: 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::config::DexDaoCapability,
    ...
    struct PoolHive<phantom T0> has store, key {
        ...
        total_staked: u64,
        total_unbonding: u64,
        gems_available: 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::HiveGems,
    ...
    struct Proposal has store {
        proposal_id: u64,
        proposer: address,
        deposit: 0x2::balance::Balance<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>,
    ...
    fun accrue_hive_for_bee_box<T0>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut LpBeeBox<T0>, arg3: u64) : 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::HiveGems {
        let v0 = 0x2::object::uid_to_inner(&arg1.id);
        let v1 = *0x2::table::borrow<0x2::object::ID, u64>(&arg0.nectar_points, v0);
        if (v1 == 0) {
            return 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::zero()
        };
        let v2 = arg3 - arg1.last_claim_epoch;
        let v3 = 0;
        if (v2 > 0 && arg1.total_staked > 0) {
            let v4 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128((arg0.nectar_schedule.nectar_per_epoch as u128), (v1 as u128), (arg0.total_nectar_points as u128));
            let v5 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128((v2 as u128), (v4 as u128), (arg1.total_staked as u128));
            arg1.global_claim_index = arg1.global_claim_index + (v5 as u256);
            arg1.last_claim_epoch = arg3;
            let v6 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128((arg1.total_staked as u128), (v5 as u128), (1000000 as u128));
            let v7 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::zero();
            if (v6 <= 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::get_available_gems_in_profile(&arg0.hive_profile)) {
                0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::join(&mut v7, 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::withdraw_gems_from_profile(&mut arg0.hive_profile, v6));
            };
            0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::join(&mut arg1.gems_available, v7);
        ...
        if (v9 > 0 && arg1.global_claim_index > arg2.claim_index) {
            let v10 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128(((arg1.global_claim_index - arg2.claim_index) as u128), (v9 as u128), (1000000 as u128));
            v3 = v10;
            arg2.claim_index = arg1.global_claim_index;
            arg2.total_gems_earned = arg2.total_gems_earned + v10;
        };
        if (v3 > 0) {
            0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::split(&mut arg1.gems_available, v3)
        } else {
            0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::zero()
        }
    }
    ...
    public fun add_more_fruits<T0, T1>(arg0: &mut BeeFruit<T1>, arg1: &mut PoolHive<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        if (v0 >= arg0.start_epoch) {
            ...
            if (v6 > 0) {
                arg0.claim_index = arg0.claim_index + (0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div(1000000, 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div(arg0.fruits_per_epoch, v6, 1000000), arg1.total_staked) as u256);
                arg0.last_claim_epoch = v0;
            };
        };
        0x2::balance::join<T1>(&mut arg0.available_fruits, 0x2::balance::split<T1>(&mut arg2, arg3));
        let v7 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div(1000000, arg3, arg0.end_epoch - v5);
    ...
    fun claim_fruit_for_bee_box<T0, T1>(arg0: &mut BeeFruit<T1>, arg1: &mut LpBeeBox<T0>, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: address) : 0x2::balance::Balance<T1> {
        ...
        if (v3 > 0) {
            arg0.claim_index = arg0.claim_index + 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u256((1000000 as u256), 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u256((arg0.fruits_per_epoch as u256), (v3 as u256), (1000000 as u256)), (arg3 as u256));
        ...
        let v6 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128(((arg0.claim_index - *v5) as u128), (0x2::balance::value<T0>(&arg1.staked_balance) as u128), (1000000 as u128));
        *v5 = arg0.claim_index;
        if (v6 > 0) {
    ...
    fun deposit_gems_and_unbond_shares<T0>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: address, arg3: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg4: address, arg5: LpBeeBox<T0>, arg6: u64, arg7: u64) : 0x2::balance::Balance<T0> {
        ...
        let v3 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::value(&v2);
        if (v3 > 0) {
            0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::deposit_gems_in_profile(arg3, v2);
        } else {
            0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::destroy_zero(v2);
        };
    ...
    public fun deposit_hive_as_incentives(arg0: &mut DexDaoConfig, arg1: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HiveVault, arg2: 0x2::coin::Coin<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::burn_hive_for_gems(arg1, &mut arg0.hive_profile, arg2, arg3, arg4);
    }

    fun deposit_into_bee_box<T0>(arg0: address, arg1: 0x1::string::String, arg2: &mut DexDaoConfig, arg3: &mut PoolHive<T0>, arg4: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg5: LpBeeBox<T0>, arg6: 0x2::balance::Balance<T0>, arg7: u64) {
        let v0 = &mut arg5;
        let v1 = accrue_hive_for_bee_box<T0>(arg2, arg3, v0, arg7);
        let v2 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::value(&v1);
        if (v2 > 0) {
            0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::deposit_gems_in_profile(arg4, v1);
        } else {
            0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::destroy_zero(v1);
        };
    ...
    public fun deposit_into_bee_box_1_fruits<T0, T1>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: &mut BeeFruit<T1>, arg4: 0x2::balance::Balance<T0>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        let (v1, v2, v3, v4) = 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::get_profile_meta_info(arg2);
    ...
    public fun deposit_into_bee_box_2_fruits<T0, T1, T2>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: &mut BeeFruit<T1>, arg4: &mut BeeFruit<T2>, arg5: 0x2::balance::Balance<T0>, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>) {
    ...
    public fun deposit_into_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: &mut BeeFruit<T1>, arg4: &mut BeeFruit<T2>, arg5: &mut BeeFruit<T3>, arg6: 0x2::balance::Balance<T0>, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
    ...
    public fun deposit_into_bee_box_no_fruits<T0>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
    ...
    fun destroy_proposal(arg0: Proposal) : (u64, address, 0x2::balance::Balance<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>, 0x1::string::String, 0x1::string::String, 0x1::string::String, u64, u64, u64, u64, u64, u64, u64, u64, 0x1::option::Option<FruitLife>, 0x1::option::Option<vector<u64>>, 0x1::option::Option<vector<u64>>, 0x1::option::Option<vector<u64>>) {
        let Proposal {
            proposal_id           : v0,
            proposer              : v1,
            deposit               : v2,
    ...
    public entry fun evaluateProposal<T0>(arg0: &DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HiveVault, arg3: u64, arg4: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveDisperser, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        ...
        let v3 = if (v2 == 0) {
            ...
            0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128((1000000 as u128), (v1 as u128), (v2 as u128))
        };
        let v4 = 0x2::balance::withdraw_all<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(&mut v0.deposit);
        let v5 = 0;
        if (arg0.vote_config.proposal_required_quorum > v3) {
            v0.proposal_status = 5;
            let (v6, v7) = 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::burn_hive_and_return_gems(arg2, v4, 0x2::balance::value<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(&v4), arg5);
            0x2::balance::destroy_zero<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(v6);
            0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::deposit_gems_for_hive(arg4, v7);
        } else {
            let v8 = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128((1000000 as u128), (v0.yes_votes as u128), (v1 as u128));
            v5 = v8;
            ...
            destroy_or_transfer_balance<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(v4, v0.proposer, arg5);
        };
    ...
    public entry fun executeThreePoolProposal<T0, T1, T2, T3>(arg0: &DexDaoConfig, arg1: &mut PoolHive<0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::LP<T0, T1, T2, T3>>, arg2: &mut 0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::LiquidityPool<T0, T1, T2, T3>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg4);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x2::table::contains<u64, Proposal>(&arg1.proposal_list, arg3), 7024);
        ...
        if (v1.proposal_type == 0) {
            ...
            0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::update_fee_for_pool<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v2, 0), *0x1::vector::borrow<u64>(&v2, 1));
        };
        if (v1.proposal_type == 1) {
            let v3 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::update_stable_config<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v3, 0), *0x1::vector::borrow<u64>(&v3, 1), *0x1::vector::borrow<u64>(&v3, 2));
        };
        if (v1.proposal_type == 2) {
            let v4 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::update_weighted_config<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, 0x1::option::extract<vector<u64>>(&mut v1.new_weights), *0x1::vector::borrow<u64>(&v4, 0));
        };
        if (v1.proposal_type == 3) {
            let v5 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::update_curved_A_and_gamma<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v5, 0), *0x1::vector::borrow<u64>(&v5, 1), (*0x1::vector::borrow<u64>(&v5, 2) as u256), *0x1::vector::borrow<u64>(&v5, 3));
        };
        if (v1.proposal_type == 4) {
            let v6 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::update_curved_config_fee_params<T0, T1, T2, T3>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v6, 0), *0x1::vector::borrow<u64>(&v6, 1), *0x1::vector::borrow<u64>(&v6, 2), *0x1::vector::borrow<u64>(&v6, 3), *0x1::vector::borrow<u64>(&v6, 4), *0x1::vector::borrow<u64>(&v6, 5));
        };
    ...
    public entry fun executeTwoPoolProposal<T0, T1, T2>(arg0: &DexDaoConfig, arg1: &mut PoolHive<0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::LP<T0, T1, T2>>, arg2: &mut 0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::LiquidityPool<T0, T1, T2>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg4);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x2::table::contains<u64, Proposal>(&arg1.proposal_list, arg3), 7024);
        let v1 = 0x2::table::borrow_mut<u64, Proposal>(&mut arg1.proposal_list, arg3);
        ...
        if (v1.proposal_type == 0) {
            let v2 = 0x1::option::extract<vector<u64>>(&mut v1.new_fee_info);
            0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::update_fee_for_pool<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v2, 0), *0x1::vector::borrow<u64>(&v2, 1));
        };
        if (v1.proposal_type == 1) {
            let v3 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::update_stable_config<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v3, 0), *0x1::vector::borrow<u64>(&v3, 1), *0x1::vector::borrow<u64>(&v3, 2));
        };
        if (v1.proposal_type == 2) {
            let v4 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::update_weighted_config<T0, T1, T2>(arg2, &arg0.dex_dao_cap, 0x1::option::extract<vector<u64>>(&mut v1.new_weights), *0x1::vector::borrow<u64>(&v4, 0));
        };
        if (v1.proposal_type == 3) {
            let v5 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::update_curved_A_and_gamma<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v5, 0), *0x1::vector::borrow<u64>(&v5, 1), (*0x1::vector::borrow<u64>(&v5, 2) as u256), *0x1::vector::borrow<u64>(&v5, 3));
        };
        if (v1.proposal_type == 4) {
            let v6 = 0x1::option::extract<vector<u64>>(&mut v1.new_params);
            0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::update_curved_config_fee_params<T0, T1, T2>(arg2, &arg0.dex_dao_cap, *0x1::vector::borrow<u64>(&v6, 0), *0x1::vector::borrow<u64>(&v6, 1), *0x1::vector::borrow<u64>(&v6, 2), *0x1::vector::borrow<u64>(&v6, 3), *0x1::vector::borrow<u64>(&v6, 4), *0x1::vector::borrow<u64>(&v6, 5));
        };
        let v7 = ProposalExecuted{
            proposal_id   : v1.proposal_id,
            pool_hive_id  : 0x2::object::uid_to_inner(&arg1.id),
    ...
    public fun get_pool_hive<T0>(arg0: &PoolHive<T0>) : (u64, u64, u64, u256, u64, u64, vector<address>) {
        (arg0.total_staked, arg0.total_unbonding, 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::value(&arg0.gems_available), arg0.global_claim_index, arg0.last_claim_epoch, arg0.next_proposal_id, arg0.bee_fruit_list)
    }
    ...
    public fun init_dex_dao_config(arg0: 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::config::DexDaoCapability, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x11abe899a08f41297221c2854bdcfe92ddce5aaa3a4ff30b883f5497794765c3::hsui_vault::HSuiVault, arg3: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfileMappingStore, arg4: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfileConfig, arg5: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HSuiDisperser<0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hsui::HSUI>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg15 < 7, 7010);
        let (v1, v2) = 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::kraft_owned_hive_profile(arg1, arg2, arg3, arg4, arg5, arg6, 0x1::string::utf8(b"PoolHiveVault"), 0, 0, 0, arg16);
        ...
        let v4 = VoteConfig{
            ...
            proposal_required_quorum    : 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div(1000000, arg13, 100),
            proposal_approval_threshold : 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div(1000000, arg14, 100),
        };
        let v5 = DexDaoConfig{
    ...
    public entry fun kraft_new_pool_hive_three_token_amm<T0, T1, T2, T3>(arg0: &mut DexDaoConfig, arg1: &mut 0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::LiquidityPool<T0, T1, T2, T3>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::get<0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::LP<T0, T1, T2, T3>>();
        ...
        let v4 = PoolHive<0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::LP<T0, T1, T2, T3>>{
            id                 : v2,
            total_staked       : 0,
            total_unbonding    : 0,
            gems_available     : 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::zero(),
            global_claim_index : 0,
            last_claim_epoch   : v1,
            lp_bee_boxes       : 0x2::table::new<address, LpBeeBox<0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::LP<T0, T1, T2, T3>>>(arg2),
            proposal_list      : 0x2::table::new<u64, Proposal>(arg2),
            next_proposal_id   : 1,
            bee_fruit_list     : 0x1::vector::empty<address>(),
            module_version     : 0,
        };
        0x2::transfer::share_object<PoolHive<0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::LP<T0, T1, T2, T3>>>(v4);
        ...
        let v5 = PoolHiveCreated{
            pool_id       : 0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::get_liquidity_pool_id<T0, T1, T2, T3>(arg1),
            lp_identifier : v0,
            pool_hive_id  : v3,
            cur_epoch     : v1,
        };
        0x2::event::emit<PoolHiveCreated>(v5);
        0x92ab12b08b57cd51db2456d4acebd440783a0dc2db5cb81e73cbde01af7997b2::three_pool::set_pool_hive_id<T0, T1, T2, T3>(arg1, &arg0.dex_dao_cap, v3);
    }

    public entry fun kraft_new_pool_hive_two_token_amm<T0, T1, T2>(arg0: &mut DexDaoConfig, arg1: &mut 0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::LiquidityPool<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::get<0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::LP<T0, T1, T2>>();
        let v1 = 0x2::tx_context::epoch(arg2);
        assert!(!0x2::table::contains<0x1::type_name::TypeName, 0x2::object::ID>(&arg0.pool_hives, v0), 7005);
        let v2 = 0x2::object::new(arg2);
        let v3 = 0x2::object::uid_to_inner(&v2);
        let v4 = PoolHive<0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::LP<T0, T1, T2>>{
            id                 : v2,
            total_staked       : 0,
            total_unbonding    : 0,
            gems_available     : 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::hive_gems::zero(),
            global_claim_index : 0,
            last_claim_epoch   : v1,
            lp_bee_boxes       : 0x2::table::new<address, LpBeeBox<0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::LP<T0, T1, T2>>>(arg2),
            proposal_list      : 0x2::table::new<u64, Proposal>(arg2),
            next_proposal_id   : 1,
            bee_fruit_list     : 0x1::vector::empty<address>(),
            module_version     : 0,
        };
        0x2::transfer::share_object<PoolHive<0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::LP<T0, T1, T2>>>(v4);
        0x2::table::add<0x1::type_name::TypeName, 0x2::object::ID>(&mut arg0.pool_hives, v0, v3);
        0x2::table::add<0x2::object::ID, u64>(&mut arg0.nectar_points, v3, 0);
        arg0.active_pool_hives = arg0.active_pool_hives + 1;
        let v5 = PoolHiveCreated{
            pool_id       : 0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::get_liquidity_pool_id<T0, T1, T2>(arg1),
            lp_identifier : v0,
            pool_hive_id  : v3,
            cur_epoch     : v1,
        };
        0x2::event::emit<PoolHiveCreated>(v5);
        0x4a6d303972e02f2cb79004c720de972f7765ca642c76483bf031749ab096ae00::two_pool::set_pool_hive_id<T0, T1, T2>(arg1, &arg0.dex_dao_cap, v3);
    }

    public entry fun removeExpiredProposal<T0>(arg0: &mut PoolHive<T0>, arg1: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HiveVault, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveDisperser, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        ...
        let v19 = v3;
        if (0x2::balance::value<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(&v19) > 0) {
            let (v20, v21) = 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::burn_hive_and_return_gems(arg1, v19, 0x2::balance::value<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(&v19), arg4);
            0x2::balance::destroy_zero<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(v20);
            0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::deposit_gems_for_hive(arg2, v21);
        } else {
            0x2::balance::destroy_zero<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(v19);
        };
    ...
    public entry fun submit_proposal<T0>(arg0: &DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: 0x2::coin::Coin<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::option::Option<vector<u64>>, arg8: 0x1::option::Option<vector<u64>>, arg9: 0x1::option::Option<vector<u64>>, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch(arg10);
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v1 = 0x2::coin::into_balance<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(arg2);
        assert!(arg0.vote_config.proposal_required_deposit <= 0x2::balance::value<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(&v1), 7018);
        ...
        if (arg3 == 4) {
            ...
            0x821d30a353b28d4e8f47e4d2fd912a08dd2d3cadc37aa7681de0af40afb627f9::curved_math::assert_new_config_params(*0x1::vector::borrow<u64>(&v14, 0), *0x1::vector::borrow<u64>(&v14, 1), *0x1::vector::borrow<u64>(&v14, 2), *0x1::vector::borrow<u64>(&v14, 3), *0x1::vector::borrow<u64>(&v14, 4), *0x1::vector::borrow<u64>(&v14, 5));
            assert!(0x1::vector::length<u64>(&v14) >= 6, 7019);
        };
        let v15 = Proposal{
            proposal_id           : arg1.next_proposal_id,
            proposer              : 0x2::tx_context::sender(arg10),
            deposit               : 0x2::balance::split<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(&mut v1, arg0.vote_config.proposal_required_deposit),
            title                 : arg4,
            description           : arg5,
            link                  : arg6,
            proposal_type         : arg3,
        ...
        destroy_or_transfer_balance<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(v1, v17, arg10);
    }

    public entry fun submit_proposal_to_add_fruit<T0, T1>(arg0: &DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: 0x2::coin::Coin<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        destroy_or_transfer_balance<0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive::HIVE>(v1, v5, arg9);
    }
    ...
    public fun transition_into_next_hive_cycle(arg0: &mut DexDaoConfig, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.nectar_schedule.nectar_per_epoch = arg0.nectar_schedule.nectar_per_epoch + 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div_u128((arg0.nectar_schedule.nectar_per_epoch as u128), (v1 as u128), (1000000 as u128));
    ...
    public fun unbond_from_bee_box_1_fruit<T0, T1>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: &mut BeeFruit<T1>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public fun unbond_from_bee_box_2_fruits<T0, T1, T2>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: &mut BeeFruit<T1>, arg4: &mut BeeFruit<T2>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>) {
    ...
    public fun unbond_from_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: &mut BeeFruit<T1>, arg4: &mut BeeFruit<T2>, arg5: &mut BeeFruit<T3>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
    ...
    public fun unbond_from_bee_box_no_fruit<T0>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(0x1::vector::length<address>(&arg1.bee_fruit_list) == 0, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
    ...
    public fun unlock_from_bee_box<T0>(arg0: &mut PoolHive<T0>, arg1: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg2: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.module_version == 0, 7038);
        let (v0, v1, v2, v3) = 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::get_profile_meta_info(arg1);
    ...
    public fun update_dex_dao_config(arg0: &mut DexDaoConfig, arg1: &0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::config::HiveDaoCapability, arg2: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
        ...
        if (v5 >= 10) {
            arg0.vote_config.proposal_required_quorum = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div(1000000, v5, 100);
        };
        let v6 = *0x1::vector::borrow<u64>(&arg2, 6);
        if (v6 >= 50) {
            arg0.vote_config.proposal_approval_threshold = 0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::math::mul_div(1000000, v6, 100);
        };
    ...
    public fun update_instant_withdrawal_profiles(arg0: &mut DexDaoConfig, arg1: &0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::config::HiveDaoCapability, arg2: vector<address>, arg3: bool) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0;
    ...
    public fun update_nectar_per_epoch(arg0: &mut DexDaoConfig, arg1: &0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::config::HiveDaoCapability, arg2: u64) {
        assert!(arg0.module_version == 0, 7038);
    ...
    public fun update_pool_hive_points(arg0: &mut DexDaoConfig, arg1: &0xf99260f5a6d66df46ca77fba5b7bc986821243eb6c429b477cae0eae10b4218a::config::HiveDaoCapability, arg2: vector<0x2::object::ID>, arg3: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
    ...
    fun verify_and_extract_bee_box<T0>(arg0: &mut DexDaoConfig, arg1: &mut PoolHive<T0>, arg2: &mut 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::HiveProfile, arg3: &mut 0x2::tx_context::TxContext) : (LpBeeBox<T0>, address) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let (v0, _, v2, v3) = 0xac914b6678503487e43280ec674f997bd9894b81c0dd428c4783bdda38b938d7::hive_profile::get_profile_meta_info(arg2);
