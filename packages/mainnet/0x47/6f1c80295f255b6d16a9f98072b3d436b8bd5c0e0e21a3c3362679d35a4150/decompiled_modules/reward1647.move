module 0x476f1c80295f255b6d16a9f98072b3d436b8bd5c0e0e21a3c3362679d35a4150::reward1647 {
    struct REWARD1647 has drop {
        dummy_field: bool,
    }

    struct TICKET_1647 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1647(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1647>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1647>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1647, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1647>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1647>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1647>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1647>>(v5, 0x2::tx_context::sender(arg1));
    }
