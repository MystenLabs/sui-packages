module 0x47359fb1da2b2fe1f0cca16d7d5582d766c7d73b5c1f2cad31ddbdea5fd5fb3b::gift4055 {
    struct GIFT4055 has drop {
        dummy_field: bool,
    }

    struct TICKET_4055 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4055(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4055>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4055>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4055, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4055>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4055>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4055>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4055>>(v5, 0x2::tx_context::sender(arg1));
    }
