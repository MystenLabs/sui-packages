module 0x479ad9527fa57d66425a1fdc85727da2ef33bfe0dcdddb7665a71a90c783ca31::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"SMTST", b"SMTST", b"ASDASDAS ASD ASDA ASDA D", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suiagents-image-store.s3.amazonaws.com/uploads/0f2a88abb93e4be4b0f01a661be6e3dd.jpg")), arg1);
