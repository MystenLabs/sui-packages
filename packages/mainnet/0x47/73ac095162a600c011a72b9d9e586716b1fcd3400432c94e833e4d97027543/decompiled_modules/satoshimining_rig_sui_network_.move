module 0x4773ac095162a600c011a72b9d9e586716b1fcd3400432c94e833e4d97027543::satoshimining_rig_sui_network_ {
    struct SATOSHIMINING_RIG_SUI_NETWORK_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SATOSHIMINING_RIG_SUI_NETWORK_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SATOSHIMINING_RIG_SUI_NETWORK_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SatoshiMining Rig SUI Network "));
