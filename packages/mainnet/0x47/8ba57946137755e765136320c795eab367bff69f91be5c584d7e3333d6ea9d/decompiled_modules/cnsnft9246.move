module 0x478ba57946137755e765136320c795eab367bff69f91be5c584d7e3333d6ea9d::cnsnft9246 {
    struct CNSNFT9246 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9246, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9246>(arg0, arg1);
