module 0x4796135eee4d35818046506e7b7b70ce8efccba1539fc197202ab73ef2750c6a::collection16 {
    struct COLLECTION16 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: COLLECTION16, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<COLLECTION16>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"collection16"));
        ...
        let v7 = CreateCollectionEvent{
            ...
            collection_id      : 0x1::string::utf8(b"36aafdfd-9bda-40bc-b9c8-a2dc7c978703"),
        };
