module 0x22ef99c6b2630e85bdcd600909a531874417123eec41abfbce2086a58467513e::nft {
    ...
    public entry fun mint(arg0: &mut 0x9b7409d4ff148b6f728edfc7beeb424e904d7dbde7054602c7ac98d3d87feecc::archieve::UserArchieve, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x9b7409d4ff148b6f728edfc7beeb424e904d7dbde7054602c7ac98d3d87feecc::archieve::verify2(arg0, 0x2::tx_context::sender(arg1));
        let v0 = BirdNFT{
    ...
    public entry fun mint2(arg0: &mut 0x22ef99c6b2630e85bdcd600909a531874417123eec41abfbce2086a58467513e::archieve::NUserArchieve, arg1: &mut 0x2::tx_context::TxContext) {
        0x22ef99c6b2630e85bdcd600909a531874417123eec41abfbce2086a58467513e::archieve::verify(arg0);
        0x22ef99c6b2630e85bdcd600909a531874417123eec41abfbce2086a58467513e::archieve::verify2(arg0, 0x2::tx_context::sender(arg1));
        let v0 = BirdNFT{
            id    : 0x2::object::new(arg1),
            value : 1000,
        };
