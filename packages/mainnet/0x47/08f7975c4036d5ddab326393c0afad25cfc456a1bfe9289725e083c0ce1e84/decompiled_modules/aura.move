module 0x4708f7975c4036d5ddab326393c0afad25cfc456a1bfe9289725e083c0ce1e84::aura {
    ...
    fun init(arg0: AURA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/AuraAiXwQ61h11a9Rtktro9p3R6uBfEWo9qDGnJge3G1.png?size=lg&key=73d23f                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<AURA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"AURA      ")))), trim_right(b"AURA                            "), trim_right(b"First agent using PRIME framework                                                                                                                                                                                                                                                                                               "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
