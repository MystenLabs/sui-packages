module 0xd5dd28cc24009752905689b2ba2bf90bfc8de4549b9123f93519bb8ba9bf9981::ob_trade {
    ...
    struct OB_CHANGE_PRICE has copy, drop, store {
        nft_id: 0x2::object::ID,
        seller: address,
        new_amount: u64,
    }
    ...
    public entry fun ob_buy_nft<T0: store + key, T1>(arg0: &mut 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::Orderbook<T0, T1>, arg1: &mut 0x70e34fcd390b767edbddaf7573450528698188c84c5395af8c4b12e3e37622fa::allowlist::Allowlist, arg2: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::BpsRoyaltyStrategy<T0>, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &mut 0x2::kiosk::Kiosk, arg6: 0x2::object::ID, arg7: u64, arg8: 0x2::coin::Coin<T1>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = arg7 * 250 / 10000;
        assert!(arg7 + v0 == 0x2::coin::value<T1>(&arg8), 1);
        let v1 = 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::buy_nft<T0, T1>(arg0, arg4, arg5, arg6, arg7, &mut arg8, arg9);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg8, v0, arg9), @0x8084455a96bdde21edd8fe48ec3f15dbe1c82b2ee2e0e963d800f3d7d8fbbcd5);
        ...
        0x2::event::emit<OB_BUY_EVENT>(v2);
    }

    public entry fun ob_buy_nft_fee<T0: store + key, T1>(arg0: &mut 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::Orderbook<T0, T1>, arg1: &mut 0x70e34fcd390b767edbddaf7573450528698188c84c5395af8c4b12e3e37622fa::allowlist::Allowlist, arg2: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::BpsRoyaltyStrategy<T0>, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &mut 0x2::kiosk::Kiosk, arg6: 0x2::object::ID, arg7: u64, arg8: 0x2::coin::Coin<T1>, arg9: 0x2::coin::Coin<T1>, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg7 * 250 / 10000 == 0x2::coin::value<T1>(&arg9), 1);
        let v0 = 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::buy_nft<T0, T1>(arg0, arg4, arg5, arg6, arg7, &mut arg8, arg10);
        ...
        0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::confirm<T0, T1>(v0, arg3, arg10);
        if (0x2::coin::value<T1>(&arg8) > 0) {
            0x2::pay::keep<T1>(arg8, arg10);
        } else {
            0x2::coin::destroy_zero<T1>(arg8);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg9, @0x8084455a96bdde21edd8fe48ec3f15dbe1c82b2ee2e0e963d800f3d7d8fbbcd5);
        let v1 = OB_BUY_EVENT{
            nft_id : arg6,
    ...
    public fun ob_buy_nft_not_allowlist<T0: store + key, T1>(arg0: &mut 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::Orderbook<T0, T1>, arg1: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::BpsRoyaltyStrategy<T0>, arg2: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::kiosk::Kiosk, arg5: 0x2::object::ID, arg6: u64, arg7: 0x2::coin::Coin<T1>, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = arg6 * 250 / 10000;
        assert!(arg6 + v0 == 0x2::coin::value<T1>(&arg7), 1);
        let v1 = 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::buy_nft<T0, T1>(arg0, arg3, arg4, arg5, arg6, &mut arg7, arg8);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg7, v0, arg8), @0x8084455a96bdde21edd8fe48ec3f15dbe1c82b2ee2e0e963d800f3d7d8fbbcd5);
        if (0x2::coin::value<T1>(&arg7) > 0) {
            0x2::pay::keep<T1>(arg7, arg8);
        } else {
    ...
    public entry fun ob_change_price<T0: store + key, T1>(arg0: &mut 0x4e0629fa51a62b0c1d7c7b9fc89237ec5b6f630d7798ad3f06d820afb93a995a::orderbook::Orderbook<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = OB_CHANGE_PRICE{
            nft_id     : arg3,
            seller     : 0x2::tx_context::sender(arg5),
            new_amount : arg4,
        };
        0x2::event::emit<OB_CHANGE_PRICE>(v0);
    }
