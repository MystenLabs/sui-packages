module 0x474d29937f828083f53cc56fa11cc54e92a3572f9de17e6f9fb2db346b599234::cnsnft3090 {
    struct CNSNFT3090 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3090, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3090>(arg0, arg1);
