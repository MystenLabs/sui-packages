module 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::cetus_launch {
    ...
    struct HeldFeesKey has copy, drop, store {
        dummy_field: bool,
    }

    struct HeldFees<phantom T0> has store {
        creator: 0x2::balance::Balance<T0>,
    ...
    public fun claim_held_fees<T0, T1>(arg0: &mut WhirlpoolLaunch<T0, T1>, arg1: &CreatorCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg0);
        ...
        let v0 = held_mut<T0, T1>(arg0);
        let v1 = 0x2::balance::value<T0>(&v0.creator);
        assert!(v1 > 0, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::nothing_to_claim());
        let v2 = 0x2::balance::split<T0>(&mut v0.creator, v1);
        let v3 = arg0.fee_recipient;
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::events::emit_held_fees_claimed(0x2::object::id<WhirlpoolLaunch<T0, T1>>(arg0), v3, v1);
        pay<T0>(v2, v3, arg2);
    }
    ...
    public fun convert_held_fees_token_a<T0, T1>(arg0: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::BuybackCap, arg1: &mut WhirlpoolLaunch<T0, T1>, arg2: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::PlatformConfig, arg3: &mut 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::ProtocolRevenue, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert_collect<T0, T1>(arg1, arg2, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg5));
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::assert_fee_seller(arg2, arg0);
        assert!(arg1.token_is_a, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::wrong_pool());
        assert!(arg7 > 0, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::zero_amount());
        let (v0, v1) = take_held<T0, T1>(arg1, arg6);
        let (v2, v3, v4) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg4, arg5, true, true, arg6, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price() + 1, arg8);
        let v5 = v4;
        let v6 = v3;
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v5) == arg6, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::sale_exceeds_liquidity());
        assert!(0x2::balance::value<T1>(&v6) >= arg7, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::slippage_exceeded());
        0x2::balance::destroy_zero<T0>(v2);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg4, arg5, v0, 0x2::balance::zero<T1>(), v5);
        pay_converted<T0, T1>(arg1, arg2, arg3, arg6, v1, v6, arg9);
    }

    public fun convert_held_fees_token_b<T0, T1>(arg0: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::BuybackCap, arg1: &mut WhirlpoolLaunch<T0, T1>, arg2: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::PlatformConfig, arg3: &mut 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::ProtocolRevenue, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert_collect<T0, T1>(arg1, arg2, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>>(arg5));
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::assert_fee_seller(arg2, arg0);
        assert!(!arg1.token_is_a, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::wrong_pool());
        assert!(arg7 > 0, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::zero_amount());
        let (v0, v1) = take_held<T0, T1>(arg1, arg6);
        let (v2, v3, v4) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T1, T0>(arg4, arg5, false, true, arg6, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_sqrt_price() - 1, arg8);
        let v5 = v4;
        let v6 = v2;
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T0>(&v5) == arg6, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::sale_exceeds_liquidity());
        assert!(0x2::balance::value<T1>(&v6) >= arg7, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::slippage_exceeded());
        0x2::balance::destroy_zero<T0>(v3);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T1, T0>(arg4, arg5, 0x2::balance::zero<T1>(), v0, v5);
        pay_converted<T0, T1>(arg1, arg2, arg3, arg6, v1, v6, arg9);
    }
    ...
    public fun held_fees<T0, T1>(arg0: &WhirlpoolLaunch<T0, T1>) : (u64, u64) {
        let v0 = HeldFeesKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_with_type<HeldFeesKey, HeldFees<T0>>(&arg0.id, v0)) {
            return (0, 0)
        };
        let v1 = HeldFeesKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<HeldFeesKey, HeldFees<T0>>(&arg0.id, v1);
        (0x2::balance::value<T0>(&v2.creator), 0x2::balance::value<T0>(&v2.platform))
    }

    fun held_mut<T0, T1>(arg0: &mut WhirlpoolLaunch<T0, T1>) : &mut HeldFees<T0> {
        let v0 = HeldFeesKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_with_type<HeldFeesKey, HeldFees<T0>>(&arg0.id, v0)) {
            let v1 = HeldFeesKey{dummy_field: false};
            let v2 = HeldFees<T0>{
                creator  : 0x2::balance::zero<T0>(),
                platform : 0x2::balance::zero<T0>(),
            };
            0x2::dynamic_field::add<HeldFeesKey, HeldFees<T0>>(&mut arg0.id, v1, v2);
        };
        let v3 = HeldFeesKey{dummy_field: false};
        0x2::dynamic_field::borrow_mut<HeldFeesKey, HeldFees<T0>>(&mut arg0.id, v3)
    }

    fun hold_fees<T0, T1>(arg0: &mut WhirlpoolLaunch<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T0>) {
        ...
        let v2 = held_mut<T0, T1>(arg0);
        0x2::balance::join<T0>(&mut v2.creator, arg1);
        0x2::balance::join<T0>(&mut v2.platform, arg2);
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::events::emit_fees_held(0x2::object::id<WhirlpoolLaunch<T0, T1>>(arg0), v0, v1, 0x2::balance::value<T0>(&v2.creator), 0x2::balance::value<T0>(&v2.platform));
    }

    fun is_protocol_launch<T0, T1>(arg0: &WhirlpoolLaunch<T0, T1>, arg1: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::ProtocolRevenue) : bool {
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::protocol_launch(arg1) == 0x1::option::some<0x2::object::ID>(0x2::object::id<WhirlpoolLaunch<T0, T1>>(arg0))
    }
    ...
    fun pay_converted<T0, T1>(arg0: &WhirlpoolLaunch<T0, T1>, arg1: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::PlatformConfig, arg2: &mut 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::ProtocolRevenue, arg3: u64, arg4: u64, arg5: 0x2::balance::Balance<T1>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<T1>(&arg5);
        let v1 = 0x1::u64::mul_div(v0, arg4, arg3);
        let (v2, v3) = held_fees<T0, T1>(arg0);
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::events::emit_held_fees_converted(0x2::object::id<WhirlpoolLaunch<T0, T1>>(arg0), arg0.pool_id, arg3, arg4, v0, v1, arg0.fee_recipient, v2, v3);
        pay<T1>(0x2::balance::split<T1>(&mut arg5, v1), arg0.fee_recipient, arg6);
        let v4 = if (is_protocol_launch<T0, T1>(arg0, arg2)) {
            arg5
        } else {
            0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::take_buyback_share<T1>(arg2, arg5)
        };
        pay<T1>(v4, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::treasury(arg1), arg6);
    }
    ...
    fun route_creator_share<T0, T1>(arg0: &mut WhirlpoolLaunch<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::coin_registry::Currency<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg0.fee_route == 0) {
            ...
            hold_fees<T0, T1>(arg0, arg1, 0x2::balance::zero<T0>());
            return
        };
    ...
    public fun sweep_platform_held_fees<T0, T1>(arg0: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::AdminCap, arg1: &mut WhirlpoolLaunch<T0, T1>, arg2: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::PlatformConfig, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg1);
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::assert_version(arg2);
        let v0 = held_mut<T0, T1>(arg1);
        let v1 = 0x2::balance::value<T0>(&v0.platform);
        assert!(v1 > 0, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::nothing_to_claim());
        let v2 = 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::treasury(arg2);
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::events::emit_held_fees_claimed(0x2::object::id<WhirlpoolLaunch<T0, T1>>(arg1), v2, v1);
        pay<T0>(0x2::balance::split<T0>(&mut v0.platform, v1), v2, arg3);
    }

    fun take_held<T0, T1>(arg0: &mut WhirlpoolLaunch<T0, T1>, arg1: u64) : (0x2::balance::Balance<T0>, u64) {
        let v0 = held_mut<T0, T1>(arg0);
        let v1 = 0x2::balance::value<T0>(&v0.creator);
        let v2 = 0x2::balance::value<T0>(&v0.platform);
        assert!(arg1 > 0 && arg1 <= v1 + v2, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::nothing_to_claim());
        let v3 = 0x1::u64::mul_div(arg1, v1, v1 + v2);
        let v4 = 0x2::balance::split<T0>(&mut v0.creator, v3);
        0x2::balance::join<T0>(&mut v4, 0x2::balance::split<T0>(&mut v0.platform, arg1 - v3));
        (v4, v3)
    }
    ...
    fun take_platform_share<T0, T1>(arg0: &mut WhirlpoolLaunch<T0, T1>, arg1: &0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform::PlatformConfig, arg2: &mut 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::ProtocolRevenue, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v9 = if (is_protocol_launch<T0, T1>(arg0, arg2)) {
            0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::revenue::take_buyback_share<T0>(arg2, arg3)
        } else {
            arg3
        };
        hold_fees<T0, T1>(arg0, 0x2::balance::zero<T0>(), v9);
        (v3, v4)
    }
