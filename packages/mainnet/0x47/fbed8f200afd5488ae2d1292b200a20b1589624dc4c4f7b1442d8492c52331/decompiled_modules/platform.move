module 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::platform {
    ...
    struct FeeSellerKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public(friend) fun assert_fee_seller(arg0: &PlatformConfig, arg1: &BuybackCap) {
        assert!(fee_seller(arg0) == 0x1::option::some<0x2::object::ID>(0x2::object::id<BuybackCap>(arg1)), 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::unauthorized());
    }
    ...
    public(friend) fun assert_version(arg0: &PlatformConfig) {
        assert!(arg0.version == 2, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::wrong_version());
    }
    ...
    public fun fee_seller(arg0: &PlatformConfig) : 0x1::option::Option<0x2::object::ID> {
        let v0 = FeeSellerKey{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<FeeSellerKey, 0x2::object::ID>(&arg0.id, v0)) {
            let v2 = FeeSellerKey{dummy_field: false};
            0x1::option::some<0x2::object::ID>(*0x2::dynamic_field::borrow<FeeSellerKey, 0x2::object::ID>(&arg0.id, v2))
        } else {
    ...
    public fun migrate(arg0: &AdminCap, arg1: &mut PlatformConfig) {
        assert!(arg1.version < 2, 0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::errors::wrong_version());
        arg1.version = 2;
    }
    ...
    public fun set_fee_seller(arg0: &AdminCap, arg1: &mut PlatformConfig, arg2: 0x1::option::Option<0x2::object::ID>) {
        assert_version(arg1);
        let v0 = FeeSellerKey{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<FeeSellerKey, 0x2::object::ID>(&arg1.id, v0)) {
            let v1 = FeeSellerKey{dummy_field: false};
            0x2::dynamic_field::remove<FeeSellerKey, 0x2::object::ID>(&mut arg1.id, v1);
        };
        if (0x1::option::is_some<0x2::object::ID>(&arg2)) {
            let v2 = FeeSellerKey{dummy_field: false};
            0x2::dynamic_field::add<FeeSellerKey, 0x2::object::ID>(&mut arg1.id, v2, *0x1::option::borrow<0x2::object::ID>(&arg2));
        };
        0x1914927baefaf7cccfe02f6567b7e24e28d33e3cb153f9628829b818954a0769::events::emit_fee_seller_changed(0x2::object::id<PlatformConfig>(arg1), arg2);
    }
