module 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::vault {
    ...
    struct Vault<phantom T0, phantom T1> has store, key {
        ...
        time_locked_profit: 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::TimeLockedBalance<T0>,
    ...
    public fun new<T0, T1>(arg0: 0x2::coin::TreasuryCap<T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (AdminCap<T1>, Vault<T0, T1>) {
        ...
        let v0 = Vault<T0, T1>{
            ...
            time_locked_profit               : 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::create<T0>(0x2::balance::zero<T0>(), 0, 0),
            lp_treasury                      : arg0,
    ...
    public fun calc_rebalance_amounts<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock) : RebalanceAmounts {
        ...
        let v3 = 0 + 0x2::balance::value<T0>(&arg0.free_balance) + 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::max_withdrawable<T0>(&arg0.time_locked_profit, arg1);
        let v4 = 0;
        ...
        let v8 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(v3, arg0.total_allocated_bps, 10000);
        ...
        while (v10) {
            ...
            while (v11 < 0x1::vector::length<u64>(&v1)) {
                ...
                let v19 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(v8, v15.target_alloc_weight_bps, v9);
        ...
        while (v20 < 0x1::vector::length<u64>(&v1)) {
            ...
            let v26 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(v8, v23.target_alloc_weight_bps, v9);
            if (v26 >= v23.borrowed) {
        ...
        while (v27 < 0x1::vector::length<u64>(&v2)) {
            ...
            let v33 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(v8, v30.target_alloc_weight_bps, v9);
            if (v33 >= v30.borrowed) {
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        if (0x2::coin::total_supply<T1>(&arg0.lp_treasury) == 0) {
            0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0, arg2);
            0x2::balance::join<T0>(&mut arg0.free_balance, 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit));
            0x2::balance::join<T0>(&mut arg0.free_balance, 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg2));
        ...
        let v1 = if (v0 == 0) {
            ...
            0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(0x2::coin::total_supply<T1>(&arg0.lp_treasury), 0x2::balance::value<T0>(&arg1), v0)
        };
    ...
    entry fun pull_unlocked_profits_to_free_balance<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: &0x2::clock::Clock) {
        assert_version<T0, T1>(arg1);
        0x2::balance::join<T0>(&mut arg1.free_balance, 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::withdraw_all<T0>(&mut arg1.time_locked_profit, arg2));
    }
    ...
    public fun remove_strategy<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: StrategyRemovalTicket<T0, T1>, arg3: vector<0x2::object::ID>, arg4: vector<u64>, arg5: &0x2::clock::Clock) {
        ...
        if (v11 > v8) {
            0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::top_up<T0>(&mut arg1.time_locked_profit, 0x2::balance::split<T0>(&mut v2, v11 - v8), arg5);
        };
    ...
    public fun strategy_hand_over_profit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        let v0 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(0x2::balance::value<T0>(&arg2), arg0.performance_fee_bps, 10000);
        let v1 = if (v0 > 0) {
            let v2 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(0x2::coin::total_supply<T1>(&arg0.lp_treasury), v0, total_available_balance<T0, T1>(arg0, arg3) - v0);
        ...
        0x2::balance::join<T0>(&mut arg0.free_balance, 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg3));
        0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0, arg3);
        let v4 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit);
        0x2::balance::join<T0>(&mut v4, arg2);
        0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::change_unlock_start_ts_sec<T0>(&mut arg0.time_locked_profit, 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::timestamp_sec(arg3), arg3);
        0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0x1::u64::divide_and_round_up(0x2::balance::value<T0>(&v4), arg0.profit_unlock_duration_sec), arg3);
        0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::top_up<T0>(&mut arg0.time_locked_profit, v4, arg3);
    }
    ...
    public fun time_locked_profit<T0, T1>(arg0: &Vault<T0, T1>) : &0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::TimeLockedBalance<T0> {
        &arg0.time_locked_profit
    }

    public fun total_available_balance<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = 0 + 0x2::balance::value<T0>(&arg0.free_balance) + 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::max_withdrawable<T0>(&arg0.time_locked_profit, arg1);
        let v1 = 0;
    ...
    public fun vault_info<T0, T1>(arg0: &Vault<T0, T1>) : (u64, u64, u64, u64, u64, bool, 0x1::option::Option<u64>, u64) {
        (0x2::balance::value<T0>(&arg0.free_balance), 0x2::balance::value<T0>(0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::locked_balance<T0>(&arg0.time_locked_profit)), 0x2::balance::value<T0>(0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::unlocked_balance<T0>(&arg0.time_locked_profit)), 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::unlock_per_second<T0>(&arg0.time_locked_profit), 0x2::balance::value<T1>(&arg0.performance_fee_balance), arg0.withdraw_ticket_issued, arg0.tvl_cap, arg0.profit_unlock_duration_sec)
    }
    ...
    public fun withdraw<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: &0x2::clock::Clock) : WithdrawTicket<T0, T1> {
        ...
        0x2::balance::join<T0>(&mut arg0.free_balance, 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::time_locked_balance::withdraw_all<T0>(&mut arg0.time_locked_profit, arg2));
        let v1 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(0x2::balance::value<T1>(&v0.lp_to_burn), total_available_balance<T0, T1>(arg0, arg2), 0x2::coin::total_supply<T1>(&arg0.lp_treasury));
        ...
        while (v12 < 0x1::vector::length<0x2::object::ID>(&arg0.strategy_withdraw_priority_order)) {
            ...
            let v15 = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div(0x2::vec_map::get<0x2::object::ID, StrategyState>(&arg0.strategies, v13).borrowed - v14.to_withdraw, v3, v4);
    ...
    public fun withdraw_t_amt<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &mut 0x2::balance::Balance<T1>, arg3: &0x2::clock::Clock) : WithdrawTicket<T0, T1> {
        let v0 = 0x2::balance::split<T1>(arg2, 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::utils::mul_div_round_up(arg1, 0x2::coin::total_supply<T1>(&arg0.lp_treasury), total_available_balance<T0, T1>(arg0, arg3)));
