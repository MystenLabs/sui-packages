module 0x47bf877d2728eb108e0812c0f100ceed83008c1b15d5f0add71f733a858dcf30::reward6037 {
    struct REWARD6037 has drop {
        dummy_field: bool,
    }

    struct TICKET_6037 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6037(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6037>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6037>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6037, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6037>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6037>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6037>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6037>>(v5, 0x2::tx_context::sender(arg1));
    }
