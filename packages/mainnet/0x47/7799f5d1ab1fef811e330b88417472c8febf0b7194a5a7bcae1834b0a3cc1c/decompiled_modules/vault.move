module 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault {
    ...
    fun complete_wind_down<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) {
    ...
    public(friend) fun finalize_wind_down<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) {
        ...
        complete_wind_down<T0, T1, T2>(arg0);
    }

    public(friend) fun finalize_wind_down_retaining_position<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) {
        assert_unwinding<T0, T1, T2>(arg0);
        assert!(rewards_empty<T0, T1, T2>(arg0), 15);
        complete_wind_down<T0, T1, T2>(arg0);
    }
