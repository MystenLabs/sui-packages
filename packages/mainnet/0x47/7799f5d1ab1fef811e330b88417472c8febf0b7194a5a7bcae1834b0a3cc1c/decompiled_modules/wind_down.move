module 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::wind_down {
    ...
    struct AttackedPositionRetainedEvent has copy, drop {
        vault_id: 0x2::object::ID,
    ...
    public fun finalize_with_attacked_position<T0, T1, T2>(arg0: &0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::AdminCap, arg1: &mut 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::Vault<T0, T1, T2>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::version::assert_current_version(arg3);
        0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::assert_unwinding<T0, T1, T2>(arg1);
        0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::check_pool_compatibility<T0, T1, T2>(arg1, arg2);
        assert!(0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::has_position<T0, T1, T2>(arg1), 0);
        let v0 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::position_borrow<T0, T1, T2>(arg1));
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::position_borrow<T0, T1, T2>(arg1)) == 0, 1);
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::is_attacked_position<T0, T1>(arg2, v0), 4);
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::is_empty(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::borrow_position_info<T0, T1>(arg2, v0)), 5);
        0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::finalize_wind_down_retaining_position<T0, T1, T2>(arg1);
        let v1 = 0x2::tx_context::sender(arg4);
        let v2 = AttackedPositionRetainedEvent{
            vault_id    : 0x2::object::id<0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::Vault<T0, T1, T2>>(arg1),
            position_id : v0,
            sender      : v1,
        };
        0x2::event::emit<AttackedPositionRetainedEvent>(v2);
        let v3 = 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::seed_balance<T0, T1, T2>(arg1);
        let v4 = 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::total_supply<T0, T1, T2>(arg1);
        let v5 = WindDownFinalizedEvent{
            vault_id                      : 0x2::object::id<0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::Vault<T0, T1, T2>>(arg1),
            withdrawable_a                : 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::free_balance_a_val<T0, T1, T2>(arg1),
            withdrawable_b                : 0x27a995eb806f164ccb9cb4f5d4e83b71372b9db7e55bccd59dfe4666bdeae065::vault::free_balance_b_val<T0, T1, T2>(arg1),
            total_vault_coin_supply       : v4,
            seed_vault_coin_balance       : v3,
            circulating_vault_coin_supply : v4 - v3,
            sender                        : v1,
        };
        0x2::event::emit<WindDownFinalizedEvent>(v5);
    }
