module 0x47ba31b594eff1d3b053f2ebb6b367e2485f603be886cac1c1974377dcc9ddad::pool {
    ...
    public fun add_liquidity_buggy<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u256, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x47ba31b594eff1d3b053f2ebb6b367e2485f603be886cac1c1974377dcc9ddad::math_u256::checked_shlw(arg1);
        let (v2, v3) = 0x47ba31b594eff1d3b053f2ebb6b367e2485f603be886cac1c1974377dcc9ddad::math_u256::checked_shlw(arg1);
        let v4 = if (v1) {
            arg2 + 1
        } else {
            ((v0 >> 64) as u64)
