module 0x472cb0a34f22847aab5bfbf1edb565b5ead8e1ef8991ffdc2479fca08a7a332d::gift6602 {
    struct GIFT6602 has drop {
        dummy_field: bool,
    }

    struct TICKET_6602 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6602(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6602>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6602>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6602, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6602>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6602>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6602>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6602>>(v5, 0x2::tx_context::sender(arg1));
    }
