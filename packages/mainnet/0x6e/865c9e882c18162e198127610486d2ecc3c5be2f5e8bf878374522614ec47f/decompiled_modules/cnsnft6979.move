module 0x6e865c9e882c18162e198127610486d2ecc3c5be2f5e8bf878374522614ec47f::cnsnft6979 {
    struct CNSNFT6979 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6979, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6979>(arg0, arg1);
