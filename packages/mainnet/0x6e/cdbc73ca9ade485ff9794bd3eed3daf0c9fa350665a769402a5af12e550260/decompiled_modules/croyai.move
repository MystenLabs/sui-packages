module 0x6ecdbc73ca9ade485ff9794bd3eed3daf0c9fa350665a769402a5af12e550260::croyai {
    struct CROYAI has drop {
        dummy_field: bool,
    }

    public entry fun burn(arg0: &mut 0x2::coin::TreasuryCap<CROYAI>, arg1: 0x2::coin::Coin<CROYAI>) {
        0x2::coin::burn<CROYAI>(arg0, arg1);
    }

    fun mint_and_transfer(arg0: &mut 0x2::coin::TreasuryCap<CROYAI>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::mint_and_transfer<CROYAI>(arg0, arg1, arg2, arg3);
    }
