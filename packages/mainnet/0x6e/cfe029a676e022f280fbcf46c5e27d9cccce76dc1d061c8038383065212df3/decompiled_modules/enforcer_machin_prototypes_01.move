module 0x6ecfe029a676e022f280fbcf46c5e27d9cccce76dc1d061c8038383065212df3::enforcer_machin_prototypes_01 {
    ...
    fun init(arg0: ENFORCER_MACHIN_PROTOTYPES_01, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ENFORCER_MACHIN_PROTOTYPES_01>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Enforcer Machin Prototypes 01"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Enforcer Machin 578/3333 manufactured by the Triangle Company."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeighsu6csh6zxwwtagkoxjp2gdij7uuvvrrd4ykjyb3wen4hww3woi"));
