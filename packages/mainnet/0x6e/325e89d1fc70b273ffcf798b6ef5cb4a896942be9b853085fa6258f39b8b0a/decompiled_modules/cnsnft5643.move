module 0x6e325e89d1fc70b273ffcf798b6ef5cb4a896942be9b853085fa6258f39b8b0a::cnsnft5643 {
    struct CNSNFT5643 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5643, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5643>(arg0, arg1);
