module 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::meme {
    ...
    public fun accept_connector<T0>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::Connector<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
        let v0 = 0x2::transfer::public_receive<0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::Connector<T0>>(&mut arg0.id, arg1);
        let v1 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::get_creator<T0>(&v0);
        let v2 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::get_temp_id<T0>(&v0);
        assert!(0x2::dynamic_field::exists_<u64>(&arg0.id, v2), 7);
        let DevOrder {
            buy_coin     : v3,
            token_amount : v4,
        } = 0x2::dynamic_field::remove<u64, DevOrder>(&mut arg0.id, v2);
        let v5 = v3;
        assert!(0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::get_supply<T0>(&v0) == 0, 6);
        assert!(0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::get_decimals<T0>(&v0) == 6, 3);
        let v6 = create_bonding_curve<T0>(v0, arg0, arg2);
        if (0x2::coin::value<0x2::sui::SUI>(&v5) > 0) {
            let v7 = &mut v6;
            let (v8, v9) = buy_returns_internal<T0>(v7, arg0, v5, v4, v4, v1, true, arg2);
            delete_or_return<0x2::sui::SUI>(v8, v1);
    ...
    fun buy_returns_internal<T0>(arg0: &mut BondingCurve<T0>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: address, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        arg3 = v2;
        let v3 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_amount_in(v2, v1, v0);
        let v4 = v3;
        let v5 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_fee_amount(v3, arg1.swap_fee_bps);
        let v6 = v5;
        if (0x2::coin::value<0x2::sui::SUI>(&arg2) < v3 + v5) {
            let v7 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_fee_amount(0x2::coin::value<0x2::sui::SUI>(&arg2), arg1.swap_fee_bps);
            v6 = v7;
            let v8 = 0x2::coin::value<0x2::sui::SUI>(&arg2) - v7;
            v4 = v8;
            let v9 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_amount_out(v8, v1, v0);
            arg3 = v9;
            assert!(v9 >= arg4, 2);
        };
        ...
        if (arg0.available_token_reserves == 0) {
            arg0.status = 2;
            0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::events::emit_complete<T0>(get_id<T0>(arg0));
        };
        0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::events::emit_buy<T0>(get_id<T0>(arg0), v4 + v6, arg3, get_price_per_token_scaled<T0>(arg0), get_price_per_token_scaled<T0>(arg0), arg5, arg6, arg0.virtual_sui_amount, 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance), 0x2::balance::value<T0>(&arg0.token_balance), arg0.available_token_reserves);
        (arg2, v10)
    }

    public fun complete_migrate<T0>(arg0: &AdminCap, arg1: MigrateReceipt, arg2: 0x2::object::ID) {
        let MigrateReceipt { curve_id: v0 } = arg1;
        0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::events::emit_migrate<T0>(v0, arg2);
    }

    fun create_bonding_curve<T0>(arg0: 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::Connector<T0>, arg1: &MemeConfig, arg2: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        enforce_config_version(arg1);
        0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::get_creator<T0>(&arg0);
        let (v0, v1, v2, v3, v4, v5, v6) = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::connector::deconstruct<T0>(arg0);
        let v7 = v2;
        let v8 = v1;
        0x2::object::delete(v0);
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<T0>>(v8);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<T0>>(v7);
        let v9 = BondingCurve<T0>{
            id                       : 0x2::object::new(arg2),
            sui_balance              : 0x2::balance::zero<0x2::sui::SUI>(),
            virtual_sui_amount       : arg1.virtual_sui_amount,
            token_balance            : 0x2::coin::mint_balance<T0>(&mut v8, 1000000000000000),
            available_token_reserves : arg1.curve_supply,
            creator                  : v3,
            curve_type               : 0,
            status                   : 0,
        };
        0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::events::emit_curve_create<T0>(get_id<T0>(&v9), v3, 0x2::coin::get_name<T0>(&v7), 0x2::coin::get_symbol<T0>(&v7), 0x2::coin::get_description<T0>(&v7), 0x2::coin::get_icon_url<T0>(&v7), v4, v5, v6);
        v9
    }
    ...
    fun init(arg0: MEME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = MemeConfig{
            ...
            listing_fee        : 9000000000,
            swap_fee_bps       : 200,
            migration_fee      : 300000000000,
            treasury           : @0xcd9e76b1608a5360613ac523231699f09413a7b27de75b5960392623e2967ca8,
        };
    ...
    public fun place_dev_order(arg0: &mut MemeConfig, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_amount_in(arg3, arg0.virtual_sui_amount, 1000000000000000);
        let v2 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_fee_amount(v1, arg0.swap_fee_bps);
    ...
    public fun sell_returns<T0>(arg0: &mut BondingCurve<T0>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v1 = 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_amount_out(v0, 0x2::balance::value<T0>(&arg0.token_balance), arg0.virtual_sui_amount + 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance));
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v2, 0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::math::get_fee_amount(v1, arg1.swap_fee_bps), arg4), arg1.treasury);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v2) >= arg3, 2);
        0x6e8792c219fb8fc80df173662e2d9ce6b45de10cc007aec9454ca4028bc4caca::events::emit_sell<T0>(get_id<T0>(arg0), 0x2::coin::value<0x2::sui::SUI>(&v2), v0, get_price_per_token_scaled<T0>(arg0), get_price_per_token_scaled<T0>(arg0), arg0.virtual_sui_amount, 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance), 0x2::balance::value<T0>(&arg0.token_balance), arg0.available_token_reserves);
        v2
    }
