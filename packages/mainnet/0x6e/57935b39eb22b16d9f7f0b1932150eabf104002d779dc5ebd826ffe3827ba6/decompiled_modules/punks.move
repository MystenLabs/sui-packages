module 0x6e57935b39eb22b16d9f7f0b1932150eabf104002d779dc5ebd826ffe3827ba6::punks {
    ...
    fun init(arg0: PUNKS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/4qfin7Cnq8TAvCxVobmxSBzKPeaakmgNH9jhEGPmpump.png                                                                                                                                                                                                                               ");
