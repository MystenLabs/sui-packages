module 0x6e5aeb8e5f4787d7ec402690a6cf4d2e218d90fdf7beacc49cbeaf9baaca37af::farm {
    ...
    public fun borrow_mut_uid<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::OwnerCap<FarmWitness>) : &mut 0x2::object::UID {
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::assert_ownership<FarmWitness>(arg1, 0x2::object::id<Farm<T0, T1>>(arg0));
        &mut arg0.id
    }

    fun calculate_accrued_rewards_per_share(arg0: u64, arg1: u256, arg2: u64, arg3: u64, arg4: u64) : u256 {
        arg1 + 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math256::min((arg3 as u256), (arg0 as u256) * (arg4 as u256)) / (arg2 as u256)
    }
    ...
    public fun destroy_zero_farm<T0, T1>(arg0: Farm<T0, T1>, arg1: &0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::OwnerCap<FarmWitness>) {
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::assert_ownership<FarmWitness>(arg1, 0x2::object::id<Farm<T0, T1>>(&arg0));
        let Farm {
            id                        : v0,
    ...
    public fun new_cap(arg0: &mut 0x2::tx_context::TxContext) : 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::OwnerCap<FarmWitness> {
        let v0 = FarmWitness{dummy_field: false};
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::new<FarmWitness>(v0, 0x1::vector::empty<0x2::object::ID>(), arg0)
    }

    public fun new_farm<T0, T1>(arg0: &mut 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::OwnerCap<FarmWitness>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) : Farm<T0, T1> {
        assert!(arg3 > clock_timestamp_s(arg1), 3);
        let (v0, v1) = 0x2::kiosk::new(arg5);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v0);
        let v2 = 0x2::object::id<0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::OwnerCap<FarmWitness>>(arg0);
        let v3 = Farm<T0, T1>{
        ...
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::add<FarmWitness>(arg0, v5, v4);
    ...
    public fun stake<T0: store + key, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: &0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::kiosk::Kiosk, arg4: T0, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (0x2::table_vec::length<0x2::object::ID>(&arg1.nft_ids) != 0) {
            let v1 = 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math64::min(calculate_pending_rewards<T0, T1>(arg1, arg0.accrued_rewards_per_share), 0x2::balance::value<T1>(&arg0.balance_reward_coin));
            if (v1 != 0) {
    ...
    public fun unstake<T0: store + key, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        if (v1 != 0) {
            0x2::balance::join<T1>(0x2::coin::balance_mut<T1>(&mut v2), 0x2::balance::split<T1>(&mut arg0.balance_reward_coin, 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math64::min(v1, 0x2::balance::value<T1>(&arg0.balance_reward_coin))));
        };
        arg1.reward_debt = calculate_reward_debt(0x2::table_vec::length<0x2::object::ID>(&arg1.nft_ids), arg0.accrued_rewards_per_share);
    ...
    public fun update_rewards_per_second<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::OwnerCap<FarmWitness>, arg2: u64, arg3: &0x2::clock::Clock) {
        0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::owner::assert_ownership<FarmWitness>(arg1, 0x2::object::id<Farm<T0, T1>>(arg0));
    ...
    public fun withdraw_rewards<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (v0 != 0) {
            0x2::balance::join<T1>(0x2::coin::balance_mut<T1>(&mut v1), 0x2::balance::split<T1>(&mut arg0.balance_reward_coin, 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math64::min(v0, 0x2::balance::value<T1>(&arg0.balance_reward_coin))));
        };
        arg1.reward_debt = calculate_reward_debt(0x2::table_vec::length<0x2::object::ID>(&arg1.nft_ids), arg0.accrued_rewards_per_share);
