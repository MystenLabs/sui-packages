module 0x601a9f900ee01f6458809a881bef6115cc65762e2bd1fa022ea6bb6111862268::auction {
    ...
    entry fun new(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: 0x2::coin::Coin<0xf82dc05634970553615eef6112a1ac4fb7bf10272bf6cbe0f80ef44a6c489385::typus::TYPUS>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 >= arg2, invalid_duration());
        assert!(arg4 > 0 && arg4 == 0x2::coin::value<0xf82dc05634970553615eef6112a1ac4fb7bf10272bf6cbe0f80ef44a6c489385::typus::TYPUS>(&arg10), invalid_size());
        assert!(arg8 >= arg9 && arg9 > 0, invalid_pricing());
        let v1 = Auction{
    ...
    entry fun bid(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 >= arg1.start_ts_ms || 0x2::table::contains<address, WhiteList>(&arg1.whitelists, v2) && v1 >= arg1.whitelist_ts_ms, not_yet_started());
        assert!(v1 <= arg1.end_ts_ms, closed());
        assert!(arg2 > 0, zero_value());
        assert!(arg1.total_bid_size < arg1.max_size, max_size_reached());
        assert!(arg2 >= arg1.min_bid_size, min_size_violation());
        assert!(arg2 % arg1.lot_size == 0, lot_size_violation());
        let v3 = 0x1::u64::min(arg2, arg1.max_size - arg1.total_bid_size);
        let (v4, v5) = get_bid_info(arg1, v3, v1);
        assert!(v5 > 0, zero_value());
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= v5, insufficient_coin());
        ...
        if (v1 < arg1.start_ts_ms) {
            assert!(0x2::table::contains<address, WhiteList>(&arg1.whitelists, v2), invalid_whitelist());
            let v8 = 0x2::table::borrow_mut<address, WhiteList>(&mut arg1.whitelists, v2);
            v8.total_bid_size = v8.total_bid_size + v3;
            assert!(v8.total_bid_size <= v8.max_bid_size, max_whitelist_bid_size_reached());
        } else if (0x2::table::contains<address, WhiteList>(&arg1.whitelists, v2)) {
            assert!(v7.total_bid_size - 0x2::table::borrow_mut<address, WhiteList>(&mut arg1.whitelists, v2).total_bid_size + v3 <= arg1.max_bid_size, max_bid_size_reached());
        } else {
            assert!(v7.total_bid_size + v3 <= arg1.max_bid_size, max_bid_size_reached());
        };
    ...
    entry fun claim(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) > arg1.end_ts_ms || arg1.max_size == arg1.total_bid_size, not_yet_closed());
        assert!(0x2::table::contains<address, Bid>(&arg1.bids, v1), zero_value());
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg1.id, 0x1::string::utf8(b"claim_enabled")), claim_disabled());
        let v2 = 0x2::table::borrow_mut<address, Bid>(&mut arg1.bids, v1);
        assert!(!0x2::table::contains<address, bool>(&arg1.claims, v1), claimed());
    ...
    entry fun enable_claim(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: &0x2::tx_context::TxContext) {
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_authority(arg0, arg2);
        let v0 = VERSION{dummy_field: false};
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_witness<VERSION>(arg0, v0);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        0x2::dynamic_field::add<0x1::string::String, bool>(&mut arg1.id, 0x1::string::utf8(b"claim_enabled"), true);
    }
    ...
    fun insufficient_coin() : u64 {
        abort 0
    }

    fun invalid_duration() : u64 {
        abort 0
    }

    fun invalid_pricing() : u64 {
        abort 0
    }

    fun invalid_size() : u64 {
        abort 0
    }

    fun invalid_whitelist() : u64 {
        abort 0
    }
    ...
    fun max_bid_size_reached() : u64 {
        abort 0
    }

    fun max_size_reached() : u64 {
        abort 0
    }

    fun max_whitelist_bid_size_reached() : u64 {
        abort 0
    }
    ...
    fun not_yet_closed() : u64 {
        abort 0
    }

    fun not_yet_started() : u64 {
        abort 0
    }
    ...
    entry fun update_auction_config(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: &0x2::tx_context::TxContext) {
        ...
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_witness<VERSION>(arg0, v0);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        assert!(arg4 >= arg3, invalid_duration());
    ...
    entry fun update_deliver_price(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_authority(arg0, arg3);
        let v0 = VERSION{dummy_field: false};
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_witness<VERSION>(arg0, v0);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        assert!(arg1.max_size == arg1.total_bid_size, not_yet_closed());
        assert!(arg2 < arg1.deliver_price, invalid_pricing());
        arg1.deliver_price = arg2;
    }
    ...
    entry fun update_whitelist(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_witness<VERSION>(arg0, v0);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        assert!(0x2::clock::timestamp_ms(arg5) < arg1.start_ts_ms, already_started());
    ...
    entry fun whitelist(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_witness<VERSION>(arg0, v0);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        assert!(0x1::vector::length<address>(&arg2) == 0x1::vector::length<u64>(&arg3), invalid_size());
        assert!(0x2::clock::timestamp_ms(arg4) < arg1.start_ts_ms, already_started());
    ...
    entry fun withdraw(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_witness<VERSION>(arg0, v0);
        0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::verify_version(arg0, 2);
        assert!(0x2::clock::timestamp_ms(arg3) > arg1.end_ts_ms || arg1.max_size == arg1.total_bid_size, not_yet_closed());
