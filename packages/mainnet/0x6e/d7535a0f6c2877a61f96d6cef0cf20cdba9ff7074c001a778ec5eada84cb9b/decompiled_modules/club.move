module 0x6ed7535a0f6c2877a61f96d6cef0cf20cdba9ff7074c001a778ec5eada84cb9b::club {
    ...
    public entry fun delete_message(arg0: &mut Global, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<address, Club>(&mut arg0.clubs, arg1);
        assert!(arg2 < 0x2::table_vec::length<Message>(&v0.messages), 2);
        let v1 = 0x2::table_vec::borrow_mut<Message>(&mut v0.messages, arg2);
        assert!(v1.sender == 0x2::tx_context::sender(arg3), 1);
        assert!(!v1.deleted, 3);
