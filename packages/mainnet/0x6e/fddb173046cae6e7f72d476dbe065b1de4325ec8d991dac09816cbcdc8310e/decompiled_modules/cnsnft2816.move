module 0x6efddb173046cae6e7f72d476dbe065b1de4325ec8d991dac09816cbcdc8310e::cnsnft2816 {
    struct CNSNFT2816 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2816, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2816>(arg0, arg1);
