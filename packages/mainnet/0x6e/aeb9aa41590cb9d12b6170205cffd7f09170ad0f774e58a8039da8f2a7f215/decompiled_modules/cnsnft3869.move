module 0x6eaeb9aa41590cb9d12b6170205cffd7f09170ad0f774e58a8039da8f2a7f215::cnsnft3869 {
    struct CNSNFT3869 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3869, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6414"));
        let v4 = 0x2::package::claim<CNSNFT3869>(arg0, arg1);
