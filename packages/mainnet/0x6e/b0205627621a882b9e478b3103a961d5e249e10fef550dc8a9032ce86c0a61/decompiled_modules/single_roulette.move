module 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::single_roulette {
    ...
    struct RouletteTable<phantom T0> has store, key {
        ...
        host: address,
        max_risk: u64,
        risk_manager: 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::risk_manager::RiskManager,
    ...
    public fun add_bet<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut SinglePlayerRouletteConfig<T0>, arg2: address, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: 0x1::option::Option<u64>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::receipt::GameReceipt<T0, SingleRoulette>) {
        ...
        let (_, _) = 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::risk_manager::add_risk(&mut v0.risk_manager, arg4, arg5, 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::bet_manager::get_bet_payout(v1, arg4));
        assert!(0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::risk_manager::total_risk(&v0.risk_manager) <= v0.max_risk, 0);
        ...
        let v9 = SingleRoulette{dummy_field: false};
        (v6, 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::new_game_receipt<T0, SingleRoulette>(v9, arg0, v1))
    }
    ...
    public fun create_roulette_table<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut SinglePlayerRouletteConfig<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(!table_exists<T0>(arg1, v0), 18);
        let v1 = RouletteTable<T0>{
            id             : 0x2::object::new(arg2),
            host           : 0x2::tx_context::sender(arg2),
            max_risk       : max_risk<T0>(arg0),
            risk_manager   : 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::risk_manager::new_manager(),
        ...
        let v2 = 0x2::object::id<RouletteTable<T0>>(&v1);
        let v3 = GameTag<T0>{creator: v0};
        0x2::dynamic_object_field::add<GameTag<T0>, RouletteTable<T0>>(&mut arg1.id, v3, v1);
    ...
    public fun settle_or_continue<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut SinglePlayerRouletteConfig<T0>, arg2: address, arg3: 0x1::option::Option<u64>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v6 < v5 && 0x2::linked_table::length<address, vector<Bet>>(&v1.current_bets) > 0) {
            ...
            while (v6 < v5 && 0x1::vector::length<Bet>(&v10) != 0) {
                ...
                let v17 = 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::bet_manager::won_bet(v13, *v2, v14);
                ...
                if (v17) {
                    ...
                    let v20 = 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::split<T0, SingleRoulette>(v19, arg0, 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::bet_manager::get_bet_payout(v15, v13));
        ...
        if (0x2::linked_table::length<address, vector<Bet>>(&v1.current_bets) == 0) {
            v1.risk_manager = 0x6eb0205627621a882b9e478b3103a961d5e249e10fef550dc8a9032ce86c0a61::risk_manager::new_manager();
            v1.status = 0;
