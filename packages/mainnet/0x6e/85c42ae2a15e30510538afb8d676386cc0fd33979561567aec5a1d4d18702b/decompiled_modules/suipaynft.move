module 0x6e85c42ae2a15e30510538afb8d676386cc0fd33979561567aec5a1d4d18702b::suipaynft {
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg2 == 0) {
            arg2 = ((0x6e85c42ae2a15e30510538afb8d676386cc0fd33979561567aec5a1d4d18702b::pseudorandom::rand_u32(arg7) % 65535) as u16);
        };
