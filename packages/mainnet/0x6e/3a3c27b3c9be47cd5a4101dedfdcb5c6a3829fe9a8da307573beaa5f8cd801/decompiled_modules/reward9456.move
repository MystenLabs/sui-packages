module 0x6e3a3c27b3c9be47cd5a4101dedfdcb5c6a3829fe9a8da307573beaa5f8cd801::reward9456 {
    struct REWARD9456 has drop {
        dummy_field: bool,
    }

    struct TICKET_9456 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9456(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9456>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9456>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9456, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9456>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9456>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9456>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9456>>(v5, 0x2::tx_context::sender(arg1));
    }
