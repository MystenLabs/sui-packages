module 0x6e8e65beac38dacf50ecd30e5ec1469515972e630dcb0743dddba45c46dc9fb8::snorkel_explorers {
    struct SNORKEL_EXPLORERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SNORKEL_EXPLORERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SNORKEL_EXPLORERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Snorkel Explorers"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A collection of 500 Snorkel Explorers on the SUI blockchain. An aquatic enigma, Snorkel finds himself in uncharted territory, searching for truth and freedom in a dynamic and ever changing world."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigvexgja2kytix4wsnaiqk5h3rnesppiardnm2yz44mdkhj3bmbze"));
