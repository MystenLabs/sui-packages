module 0x6e90007d94ca7c79180831b498229f651a418d9bd8d820e78a10421eae72f483::gift1164 {
    struct GIFT1164 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift1164(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT1164, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1164>(arg0, arg1);
