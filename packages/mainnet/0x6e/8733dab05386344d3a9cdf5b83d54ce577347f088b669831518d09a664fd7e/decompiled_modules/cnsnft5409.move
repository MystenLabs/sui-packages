module 0x6e8733dab05386344d3a9cdf5b83d54ce577347f088b669831518d09a664fd7e::cnsnft5409 {
    struct CNSNFT5409 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5409, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1060"));
        let v4 = 0x2::package::claim<CNSNFT5409>(arg0, arg1);
