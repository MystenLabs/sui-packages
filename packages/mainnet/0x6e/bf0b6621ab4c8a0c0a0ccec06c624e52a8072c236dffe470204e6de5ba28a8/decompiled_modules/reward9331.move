module 0x6ebf0b6621ab4c8a0c0a0ccec06c624e52a8072c236dffe470204e6de5ba28a8::reward9331 {
    struct REWARD9331 has drop {
        dummy_field: bool,
    }

    struct TICKET_9331 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9331(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9331>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9331>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9331, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9331>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9331>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9331>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9331>>(v5, 0x2::tx_context::sender(arg1));
    }
