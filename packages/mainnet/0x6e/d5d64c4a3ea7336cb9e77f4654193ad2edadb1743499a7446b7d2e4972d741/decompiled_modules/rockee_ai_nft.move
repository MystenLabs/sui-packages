module 0x6ed5d64c4a3ea7336cb9e77f4654193ad2edadb1743499a7446b7d2e4972d741::rockee_ai_nft {
    ...
    public fun mint(arg0: &mut Config, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = MintedEvent{
            user        : v0,
            campaign_id : 0x2::object::id<Config>(arg0),
            nft_id      : 0x2::object::id<RockeeAINFT>(&v3),
            gen_id      : arg0.total_sold,
        };
        0x2::event::emit<MintedEvent>(v4);
        0x2::transfer::public_transfer<RockeeAINFT>(v3, v0);
    }
