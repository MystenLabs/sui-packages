module 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::seal_policy {
    ...
    entry fun seal_approve_email_fleet<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::mailgate::MailGateAccount<T0>, arg5: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) {
        assert!(arg0 == 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::mailgate::get_email_hash<T0>(arg4), 0);
        assert!(0x2::address::to_bytes(0x2::tx_context::sender(arg7)) == pk_to_address(&arg2), 0);
        assert!(is_timestamp_fresh(arg3, 0x2::clock::timestamp_ms(arg6)), 1);
        let v0 = WalletPK{pk: arg2};
        let v1 = 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::create_intent_message<WalletPK>(1, arg3, v0);
        let v2 = 0x2::bcs::to_bytes<0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::IntentMessage<WalletPK>>(&v1);
        assert!(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::verify_fleet_raw_signature<MAILGATE>(arg5, &arg1, &v2), 0);
    }
    ...
    entry fun seal_approve_enclave_bootstrap_v2(arg0: vector<u8>, arg1: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg2: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::Enclave<MAILGATE>, arg3: &0x2::tx_context::TxContext) {
        seal_approve_enclave_bootstrap_v2_impl(arg0, arg1, arg2, arg3);
    }

    public fun seal_approve_enclave_bootstrap_v2_impl(arg0: vector<u8>, arg1: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg2: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::Enclave<MAILGATE>, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0 == seal_identity_for_env(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::environment<MAILGATE>(arg1)), 2);
        assert!(0x2::address::to_bytes(0x2::tx_context::sender(arg3)) == pk_to_address(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::pk<MAILGATE>(arg2)), 0);
        assert!(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::config_version<MAILGATE>(arg2) == 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::version<MAILGATE>(arg1), 0);
    }

    entry fun seal_approve_enclave_secrets(arg0: vector<u8>, arg1: vector<u8>, arg2: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0 == seal_identity_for_secrets(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::environment<MAILGATE>(arg2)), 2);
        assert!(0x2::address::to_bytes(0x2::tx_context::sender(arg3)) == pk_to_address(&arg1), 0);
        let v0 = 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::bootstrap_pk<MAILGATE>(arg2);
        assert!(0x1::option::is_some<vector<u8>>(v0), 0);
        assert!(0x1::option::borrow<vector<u8>>(v0) == &arg1, 0);
    ...
    entry fun seal_approve_enclave_secrets_v2(arg0: vector<u8>, arg1: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg2: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::Enclave<MAILGATE>, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0 == seal_identity_for_secrets(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::environment<MAILGATE>(arg1)), 2);
        assert!(0x2::address::to_bytes(0x2::tx_context::sender(arg3)) == pk_to_address(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::pk<MAILGATE>(arg2)), 0);
        assert!(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::config_version<MAILGATE>(arg2) == 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::version<MAILGATE>(arg1), 0);
    }

    entry fun seal_approve_fleet(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        assert!(arg0 == x"00", 0);
        assert!(0x2::address::to_bytes(0x2::tx_context::sender(arg6)) == pk_to_address(&arg2), 0);
        assert!(is_timestamp_fresh(arg3, 0x2::clock::timestamp_ms(arg5)), 1);
        let v0 = WalletPK{pk: arg2};
        let v1 = 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::create_intent_message<WalletPK>(1, arg3, v0);
        let v2 = 0x2::bcs::to_bytes<0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::IntentMessage<WalletPK>>(&v1);
        assert!(0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::verify_fleet_raw_signature<MAILGATE>(arg4, &arg1, &v2), 0);
    }

    public fun seal_approve_fleet_pcr_v1(arg0: vector<u8>, arg1: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg2: &0x2::nitro_attestation::NitroAttestationDocument, arg3: &0x2::tx_context::TxContext) {
        abort 3
    }
    ...
    public fun seal_identity_for_secrets(arg0: &vector<u8>) : vector<u8> {
        let v0 = b"mailgate:sealed-env:";
        0x1::vector::append<u8>(&mut v0, *arg0);
        0x1::vector::append<u8>(&mut v0, b":v1");
        v0
    }

    entry fun set_fleet_master_seed(arg0: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::Cap<MAILGATE>, arg1: &mut 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::set_master_seed_blob<MAILGATE>(arg1, arg2);
    }

    entry fun set_fleet_master_seed_admin(arg0: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::caps::AdminCap<MAILGATE>, arg1: &mut 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::set_master_seed_blob<MAILGATE>(arg1, arg2);
    }

    entry fun set_fleet_master_seed_admin_v2(arg0: &0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::caps::AdminCap<MAILGATE>, arg1: &mut 0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::EnclaveConfig<MAILGATE>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        0x50ab30e6fb02425e856e2d0c7919875f285d1e12a1d747f29a130ddd22af8e83::enclave::set_master_seed_blob_and_enclave_pk<MAILGATE>(arg1, arg2, arg3);
    }
