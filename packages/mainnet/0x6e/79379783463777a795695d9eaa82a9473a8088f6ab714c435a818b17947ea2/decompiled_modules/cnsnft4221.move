module 0x6e79379783463777a795695d9eaa82a9473a8088f6ab714c435a818b17947ea2::cnsnft4221 {
    struct CNSNFT4221 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4221, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4221>(arg0, arg1);
