module 0x6e718cdafb81e2d37734f4908723227995e3786318b268300a0a53d59069f757::ape_on_sui {
    struct APE_ON_SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: APE_ON_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<APE_ON_SUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Ape on SUI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Ape on SUI is a 333-piece collection for ape and crypto enthusiasts, created with good vibes and love for Ape."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiahnvggvda2obuqq7qh37hyrlrd3yniazcsdmltscnsiemmewzfym"));
