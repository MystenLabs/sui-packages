module 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::alpha_router {
    ...
    fun after_execute<T0>(arg0: &MemeboxManager, arg1: &AdminCap, arg2: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::USDCVault, arg3: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::AdminCap, arg4: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::VaultManager, arg5: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::AdminCap, arg6: &mut IntermediateStorage, arg7: 0x2::object::ID, arg8: u8, arg9: 0x2::coin::Coin<T0>, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        verify_admin_permission(arg0, arg1, 0x2::tx_context::sender(arg11));
        assert!(0x2::object::id<IntermediateStorage>(arg6) == arg0.intermediate_storage_id, 1);
        assert!(exists_trade_receipt(arg6, arg7), 6);
        let v0 = get_trade_receipt(arg6, arg7);
        let v1 = 0x2::coin::value<T0>(&arg9);
        let v2 = v0.id;
        let v3 = 0x1::type_name::get<T0>();
        store_intermediate_coin<T0>(arg6, arg9);
        let v4 = TradeStep{
            dex    : arg8,
            coin   : v3,
            amount : v1,
        ...
        if (arg10 != 0) {
            ...
            if (is_usdc<T0>()) {
                let v6 = extract_intermediate_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg6, v1, arg11);
                0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::deposit(arg2, arg3, v6, arg11);
            } else {
                let v7 = extract_intermediate_coin<T0>(arg6, v1, arg11);
                0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::deposit<T0>(arg4, arg5, v7, arg11);
            };
        };
        v2
    }

    fun before_execute<T0>(arg0: &MemeboxManager, arg1: &AdminCap, arg2: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::USDCVault, arg3: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::AdminCap, arg4: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::VaultManager, arg5: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::AdminCap, arg6: &mut IntermediateStorage, arg7: 0x2::object::ID, arg8: u8, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::object::ID) {
        verify_admin_permission(arg0, arg1, 0x2::tx_context::sender(arg10));
        assert!(0x2::object::id<IntermediateStorage>(arg6) == arg0.intermediate_storage_id, 1);
        assert!(arg9 > 0, 3);
        let v0 = arg7;
        if (!exists_trade_receipt(arg6, arg7)) {
            if (is_usdc<T0>()) {
                store_intermediate_coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg6, 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::withdraw(arg2, arg3, arg9, arg10));
            } else {
                store_intermediate_coin<T0>(arg6, 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::withdraw<T0>(arg4, arg5, arg9, arg10));
            };
            v0 = create_trade_receipt(arg6, 0x1::type_name::get<T0>(), arg9, arg10);
        };
        let v1 = extract_intermediate_coin<T0>(arg6, arg9, arg10);
    ...
    public entry fun execute_cetus_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &AdminCap, arg2: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::USDCVault, arg3: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::AdminCap, arg4: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::VaultManager, arg5: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::AdminCap, arg6: &mut IntermediateStorage, arg7: bool, arg8: u64, arg9: 0x2::object::ID, arg10: u64, arg11: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg12: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg13: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) : (u64, 0x2::object::ID) {
        if (arg7) {
            let (v2, v3) = before_execute<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9, 1, arg8, arg15);
            ...
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, v3, 1, v4, arg10, arg15);
            (0x2::coin::value<T1>(&v4), v3)
        } else {
            let (v5, v6) = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9, 1, arg8, arg15);
            ...
            after_execute<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, v6, 1, v7, arg10, arg15);
    ...
    public entry fun execute_flowx_swap<T0, T1>(arg0: &mut MemeboxManager, arg1: &AdminCap, arg2: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::USDCVault, arg3: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::AdminCap, arg4: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::VaultManager, arg5: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::AdminCap, arg6: &mut IntermediateStorage, arg7: bool, arg8: u64, arg9: 0x2::object::ID, arg10: u64, arg11: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg12: &mut 0x2::tx_context::TxContext) : (u64, 0x2::object::ID) {
        if (arg7) {
            let (v2, v3) = before_execute<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9, 3, arg8, arg12);
            let v4 = 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::flowx_wrapper::swap_a2b<T0, T1>(arg11, v2, arg12);
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, v3, 3, v4, arg10, arg12);
            (0x2::coin::value<T1>(&v4), v3)
        } else {
            let (v5, v6) = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9, 3, arg8, arg12);
            let v7 = 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::flowx_wrapper::swap_b2a<T0, T1>(arg11, v5, arg12);
            after_execute<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, v6, 3, v7, arg10, arg12);
            (0x2::coin::value<T0>(&v7), v6)
        }
    }
    ...
    public entry fun execute_turbos_swap<T0, T1, T2>(arg0: &mut MemeboxManager, arg1: &AdminCap, arg2: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::USDCVault, arg3: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::usdc_vault::AdminCap, arg4: &mut 0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::VaultManager, arg5: &0x999ac2b5b27f994b2c75bd8a38548c13c5f7cd7a1d250ed57ae183bd79cd864c::meme_vault::AdminCap, arg6: &mut IntermediateStorage, arg7: bool, arg8: u64, arg9: 0x2::object::ID, arg10: u64, arg11: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg12: &0x2::clock::Clock, arg13: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg14: &mut 0x2::tx_context::TxContext) : (u64, 0x2::object::ID) {
        if (arg7) {
            let (v2, v3) = before_execute<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9, 2, arg8, arg14);
            ...
            after_execute<T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, v3, 2, v4, arg10, arg14);
            (0x2::coin::value<T1>(&v4), v3)
        } else {
            let (v5, v6) = before_execute<T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg9, 2, arg8, arg14);
            ...
            after_execute<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, v6, 2, v7, arg10, arg14);
            (0x2::coin::value<T0>(&v7), v6)
        }
    }
