module 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::tocen_stake_token {
    ...
    public entry fun add_pool_and_renew<T0>(arg0: &mut PoolStake<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        *v3 = *v3 + arg2;
        ...
        if (arg3 == 1) {
            v6 = true;
            *v5 = 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::math_time_claim(v0, arg0.type_pool);
        };
    ...
    public entry fun claim_pool_flexible<T0>(arg0: &mut Flexible<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::get_key();
    ...
    public entry fun claim_pool_month<T0>(arg0: &mut PoolStake<T0>, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::get_key();
    ...
    public entry fun create_poolStake<T0>(arg0: u64, arg1: vector<u8>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::witness::check_owner(arg4), 1);
        let v0 = PoolStake<T0>{
            ...
            key                    : 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::get_key(),
            sig_time               : 5 * 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::get_time_phut(),
        };
    ...
    public entry fun create_pool_flexible<T0>(arg0: u64, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::witness::check_owner(arg2), 1);
        let v0 = Flexible<T0>{
            ...
            key                    : 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::get_key(),
            sig_time               : 2 * 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::get_time_phut(),
        };
    ...
    public entry fun stake_pool_month<T0>(arg0: &mut PoolStake<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = InfoUserStake<T0>{
            ...
            timestamp_claim   : 0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::utils::math_time_claim(v0, arg0.type_pool),
        };
        arg0.total_stake = arg0.total_stake + arg2;
    ...
    public entry fun token_poolStake<T0>(arg0: &mut PoolStake<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x6e32475416ff1309631c514576959b06d8e6cc0814fefd2775606abfa7bb61e4::witness::check_owner(arg3), 1);
