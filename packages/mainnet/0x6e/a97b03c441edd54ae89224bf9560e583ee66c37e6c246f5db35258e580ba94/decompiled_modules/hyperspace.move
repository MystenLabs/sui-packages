module 0x9a84b6a7914aedd6741e73cc2ca23cbc77e22ed3c5f884c072a51868fedde45b::hyperspace {
    ...
    public fun purchase_silent<T0: store + key, T1: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: &mut 0x2::transfer_policy::TransferPolicy<Hyperspace>, arg5: &mut 0x2::transfer_policy::TransferPolicy<T1>, arg6: 0x2::object::ID, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: 0x2::coin::Coin<0x2::sui::SUI>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::kiosk::is_listed(arg0, arg6)) {
            ...
            let v6 = v5;
            let v7 = 0x2::transfer_policy::new_request<Hyperspace>(arg6, 0x2::transfer_policy::paid<T0>(&v6), 0x2::transfer_policy::from<T0>(&v6));
            let v8 = 0x2::transfer_policy::new_request<T1>(arg6, 0x2::transfer_policy::paid<T0>(&v6), 0x2::transfer_policy::from<T0>(&v6));
            let v9 = *0x2::transfer_policy::rules<T0>(arg3);
            let v10 = 0x1::type_name::get<0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>();
            if (0x2::vec_set::contains<0x1::type_name::TypeName>(&v9, &v10)) {
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T0>(arg3, &mut v6, arg8);
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg8, v0);
            };
            let v11 = 0x1::type_name::get<0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>();
            if (0x2::vec_set::contains<0x1::type_name::TypeName>(&v9, &v11)) {
                0x2::kiosk::lock<T0>(arg1, arg2, arg3, v4);
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v6, arg1);
            } else {
                0x2::kiosk::place<T0>(arg1, arg2, v4);
            };
            let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg3, v6);
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<Hyperspace>(arg4, &mut v7, arg9);
            let (_, _, _) = 0x2::transfer_policy::confirm_request<Hyperspace>(arg4, v7);
            let v18 = *0x2::transfer_policy::rules<T1>(arg5);
            let v19 = 0x1::type_name::get<0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>();
            if (0x2::vec_set::contains<0x1::type_name::TypeName>(&v18, &v19)) {
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T1>(arg5, &mut v8, arg10);
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg10, v0);
            };
            let (_, _, _) = 0x2::transfer_policy::confirm_request<T1>(arg5, v8);
        } else {
