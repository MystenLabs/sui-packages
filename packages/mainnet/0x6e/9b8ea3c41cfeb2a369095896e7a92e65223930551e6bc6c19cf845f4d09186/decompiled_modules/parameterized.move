module 0x6e9b8ea3c41cfeb2a369095896e7a92e65223930551e6bc6c19cf845f4d09186::parameterized {
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::dynamic_field::borrow<vector<u8>, TransferDetails>(&arg0.id, b"details");
        ...
        let v16 = *v2;
        0x1::vector::remove<CoinDetail>(&mut v16.coin_details, v5);
        if (0x1::vector::is_empty<CoinDetail>(&v16.coin_details)) {
            0x2::dynamic_field::remove<vector<u8>, TransferDetails>(&mut arg0.id, b"details");
        } else {
            0x2::dynamic_field::remove<vector<u8>, TransferDetails>(&mut arg0.id, b"details");
            0x2::dynamic_field::add<vector<u8>, TransferDetails>(&mut arg0.id, b"details", v16);
        };
        let v17 = DebugEvent{
