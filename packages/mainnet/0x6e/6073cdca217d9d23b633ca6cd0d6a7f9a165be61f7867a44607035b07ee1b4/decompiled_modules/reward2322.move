module 0x6e6073cdca217d9d23b633ca6cd0d6a7f9a165be61f7867a44607035b07ee1b4::reward2322 {
    struct REWARD2322 has drop {
        dummy_field: bool,
    }

    struct TICKET_2322 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2322(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2322>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2322>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2322, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2322>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2322>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2322>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2322>>(v5, 0x2::tx_context::sender(arg1));
    }
