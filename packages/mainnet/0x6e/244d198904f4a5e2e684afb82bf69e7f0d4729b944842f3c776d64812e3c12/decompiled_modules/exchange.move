module 0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::exchange {
    ...
    struct Curve<phantom T0, phantom T1> has store, key {
        ...
        presale_commits: 0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::BigVector<PresaleCommit>,
        b_inital_value: u64,
    ...
    public fun bid<T0, T1>(arg0: &mut AdminSettings, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::tx_context::TxContext) {
        ...
        0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::push_back<PresaleCommit>(&mut v0.presale_commits, v4);
    }
    ...
    public fun bid_with_custodial_account<T0, T1>(arg0: &mut AdminSettings, arg1: &mut CustodialPoolsIndex, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::push_back<PresaleCommit>(&mut v0.presale_commits, v5);
    }

    public fun create_curve<T0, T1>(arg0: &mut AdminSettings, arg1: 0x2::coin::TreasuryCap<T1>, arg2: &0x2::coin::CoinMetadata<T1>, arg3: u64, arg4: u64, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        assert_valid_version(arg0);
        ...
        let v5 = Curve<T0, T1>{
            ...
            presale_commits       : 0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::new<PresaleCommit>(slice_size(), arg8),
            b_inital_value        : v2,
            presale_total_commits : 0,
            presale_max_a         : (((v2 as u128) * (arg4 as u128) / ((v2 - safe_percentage(v2, v0)) as u128)) as u64),
            presale_end_time      : 0x2::clock::timestamp_ms(arg7) + v1,
            presale_completed     : false,
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0x2::coin::TreasuryCap<T1>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::get<T1>()), arg1);
        0x2::dynamic_object_field::add<0x2::object::ID, Curve<T0, T1>>(&mut arg0.id, v4, v5);
        v4
    }
    ...
    public fun disperse<T0, T1>(arg0: &mut AdminSettings, arg1: &mut CustodialPoolsIndex, arg2: 0x2::object::ID, arg3: &mut FeeCollector, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = if (0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::length<PresaleCommit>(&v0.presale_commits) > v4) {
            0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::length<PresaleCommit>(&v0.presale_commits) - v4
        } else {
            0
        };
        let v6 = 0x1::vector::empty<DisperseEvent>();
        while (0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::length<PresaleCommit>(&v0.presale_commits) > v5) {
            let v7 = 0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::pop_back<PresaleCommit>(&mut v0.presale_commits);
            let v8 = v7.amount * get_output_amount(v1, v0.virtual_a_amount, v0.b_inital_value) / v0.presale_total_commits;
        ...
        if (0x6e244d198904f4a5e2e684afb82bf69e7f0d4729b944842f3c776d64812e3c12::big_vector::length<PresaleCommit>(&v0.presale_commits) == 0) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = FeeCollector{id: 0x2::object::new(arg0)};
