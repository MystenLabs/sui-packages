module 0x6e8b3bcd570e06473d4763bb458cf79e5d3b9b49c94de6b4e70d398a7578a4f5::meme {
    ...
    fun init(arg0: MEME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v4;
        0x2::coin::mint_and_transfer<MEME>(&mut v6, 1000000000, 0x2::tx_context::sender(arg1), arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<MEME>>(v6, 0x2::tx_context::sender(arg1));
