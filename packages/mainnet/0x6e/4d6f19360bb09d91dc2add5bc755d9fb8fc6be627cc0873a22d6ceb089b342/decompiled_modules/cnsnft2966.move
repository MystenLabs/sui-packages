module 0x6e4d6f19360bb09d91dc2add5bc755d9fb8fc6be627cc0873a22d6ceb089b342::cnsnft2966 {
    struct CNSNFT2966 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2966, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2195"));
        let v4 = 0x2::package::claim<CNSNFT2966>(arg0, arg1);
