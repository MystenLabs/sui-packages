module 0x6e0191d5c9f87e4339f9067b687242d05ab6d0ae5e7197d7c0fae1b299d61f83::access_control {
    ...
    public fun assert_admin(arg0: address, arg1: vector<u8>, arg2: &AdminKey) : bool {
        if (!0x2::table::contains<vector<u8>, 0x2::table::Table<address, bool>>(&arg2.tenant_admins, arg1)) {
            return false
        };
