module 0x6e7b9e9074efbc822d0c770099e0a85aabee2c78ff6263ca0fabb3306c3d628c::battle_blades_core {
    struct BATTLE_BLADES_CORE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BATTLE_BLADES_CORE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BATTLE_BLADES_CORE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Battle Blades Core"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The power source of your Battle Blade. Cores determine your special ability cooldowns and effects. Each core has unique characteristics regardless of rarity."));
