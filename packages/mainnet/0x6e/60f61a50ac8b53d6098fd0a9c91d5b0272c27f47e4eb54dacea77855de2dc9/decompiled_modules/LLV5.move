module 0x6e60f61a50ac8b53d6098fd0a9c91d5b0272c27f47e4eb54dacea77855de2dc9::LLV5 {
    ...
    public entry fun set_pool_closed<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &Config, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = v0 >= *0x1::option::borrow<u64>(&arg0.close_deadline);
        if (!arg2) {
            assert!(!arg0.sold_out && !v1, 23);
        };
        arg0.pool_closed = arg2;
        let v2 = if (arg0.sold_out) {
            b"sold_out"
        } else if (v1) {
            b"deadline_passed"
        } else {
