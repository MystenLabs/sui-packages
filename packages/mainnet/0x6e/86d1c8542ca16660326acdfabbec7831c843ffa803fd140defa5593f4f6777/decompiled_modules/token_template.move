module 0x6e86d1c8542ca16660326acdfabbec7831c843ffa803fd140defa5593f4f6777::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T304924", b"Test 304924", b"Integration test token 2025-10-24T02:35:04.924Z", 0x1::option::none<0x2::url::Url>(), arg1);
