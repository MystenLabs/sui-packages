module 0x6e0e663100a75176615f7a105ea5b0a0ac418845986ed068a11b0f7c1952de09::membership {
    ...
    public fun buy_membership<T0>(arg0: &mut MembershipList, arg1: &0x6e0e663100a75176615f7a105ea5b0a0ac418845986ed068a11b0f7c1952de09::sellable::CredenzaSellableConfig<MEMBERSHIP>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(!0x2::table::contains<address, 0x1::string::String>(&arg0.members, v0), 1);
        0x6e0e663100a75176615f7a105ea5b0a0ac418845986ed068a11b0f7c1952de09::sellable::accept_payment_coin<MEMBERSHIP, T0>(arg1, arg2, arg3);
        set_membership_internal(arg0, v0, 0x1::string::utf8(b""));
    }

    fun init(arg0: MEMBERSHIP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::new(arg1);
        let (_, v2) = 0x6e0e663100a75176615f7a105ea5b0a0ac418845986ed068a11b0f7c1952de09::sellable::create_config<MEMBERSHIP>(arg0, arg1);
        ...
        0x6e0e663100a75176615f7a105ea5b0a0ac418845986ed068a11b0f7c1952de09::ownership::add_owner(&mut v3.ownership, 0x2::tx_context::sender(arg1));
        ...
        0x2::transfer::public_share_object<0x6e0e663100a75176615f7a105ea5b0a0ac418845986ed068a11b0f7c1952de09::sellable::CredenzaSellableConfig<MEMBERSHIP>>(v2);
    }
