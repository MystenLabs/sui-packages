module 0x6ec292808914576e15c9e21c9d0ee51651377d5f0f1465ffd8e4d6ddf669b4bf::state {
    ...
    struct State has store, key {
        ...
        cctp_mayan_recipient_registry: 0x2::table::Table<u32, address>,
    ...
    public(friend) fun add_cctp_mayan_recipient(arg0: &AdminCap, arg1: &mut State, arg2: u32, arg3: address) {
        assert!(!0x2::table::contains<u32, address>(&arg1.cctp_mayan_recipient_registry, arg2), 4);
        0x2::table::add<u32, address>(&mut arg1.cctp_mayan_recipient_registry, arg2, arg3);
    }
    ...
    public(friend) fun get_cctp_mayan_recipient(arg0: &State, arg1: u32) : address {
        *0x2::table::borrow<u32, address>(&arg0.cctp_mayan_recipient_registry, arg1)
    }
    ...
    public(friend) fun lock_fee_redeem<T0>(arg0: &mut State, arg1: u64, arg2: address, arg3: u64, arg4: 0x2::balance::Balance<T0>, arg5: &mut 0x2::tx_context::TxContext) : address {
        assert!(!0x2::table::contains<u64, LockedFeeBridge>(&arg0.locked_fee_registry, arg1), 5);
    ...
    public(friend) fun mark_mayan_nonce_used(arg0: &mut State, arg1: u32, arg2: u64) {
        ...
        assert!(!0x2::table::contains<address, bool>(&arg0.cctp_used_nonce, v0), 6);
    ...
    public(friend) fun new_state(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::emitter::EmitterCap, arg1: address, arg2: address, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : State {
        ...
        let v1 = State{
            ...
            cctp_mayan_recipient_registry : 0x2::table::new<u32, address>(arg4),
