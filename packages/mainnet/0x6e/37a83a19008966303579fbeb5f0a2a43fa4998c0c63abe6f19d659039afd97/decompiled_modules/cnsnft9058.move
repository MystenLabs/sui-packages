module 0x6e37a83a19008966303579fbeb5f0a2a43fa4998c0c63abe6f19d659039afd97::cnsnft9058 {
    struct CNSNFT9058 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9058, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2154"));
        let v4 = 0x2::package::claim<CNSNFT9058>(arg0, arg1);
