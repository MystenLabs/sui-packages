module 0x6eaf7d0d5f9317f6728bc74c18fcd450c441c7419255c37483ef3c850b2f179d::cnsnft9943 {
    struct CNSNFT9943 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9943, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9943>(arg0, arg1);
