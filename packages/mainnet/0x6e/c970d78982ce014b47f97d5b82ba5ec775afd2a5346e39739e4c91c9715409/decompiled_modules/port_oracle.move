module 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::port_oracle {
    ...
    public fun get_price<T0>(arg0: &PortOracle, arg1: &0x2::clock::Clock) : Price {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_exists());
        let v1 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v0);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 == v1.last_update_time, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_updated());
        v1
    }

    public fun add_pyth_oracle_info<T0>(arg0: &mut PortOracle, arg1: &0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::checked_package_version(arg1);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg6));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        ...
        let v2 = if (0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0)) {
            ...
            assert!(0x1::option::is_none<0x2::object::ID>(&v3.price_aggregator_id), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::switchboard_oracle_info_already_exists());
    ...
    public fun add_switchboard_oracle_info<T0>(arg0: &mut PortOracle, arg1: &0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::GlobalConfig, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::checked_package_version(arg1);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg5));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_exists());
        let v1 = if (0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0)) {
            ...
            assert!(0x1::option::is_none<vector<u8>>(&v2.price_pyth_feed_id), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::pyth_oracle_info_already_exists());
    ...
    public fun calculate_oracle_prices<T0, T1>(arg0: &PortOracle, arg1: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_not_exists());
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v1), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_not_exists());
        let v2 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v0);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 == v2.last_update_time, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_updated());
        let v3 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v1);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 == v3.last_update_time, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_updated());
    ...
    public fun external_update_price_from_pyth<T0>(arg0: &mut PortOracle, arg1: &0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::checked_package_version(arg1);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_not_exists());
        ...
        assert!(v5 <= 0x2::table::borrow<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0).usd_price_age, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_updated());
    ...
    public fun external_update_price_from_switchboard<T0>(arg0: &mut PortOracle, arg1: &0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::GlobalConfig, arg2: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg3: &0x2::clock::Clock) {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::checked_package_version(arg1);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_not_exists());
    ...
    public fun get_price_by_type(arg0: &PortOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : Price {
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, arg1), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_exists());
        let v0 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, arg1);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 == v0.last_update_time, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_updated());
        v0
    }
    ...
    public fun get_sqrt_price_from_oracle<T0, T1>(arg0: &PortOracle, arg1: &0x2::clock::Clock) : u128 {
        ...
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_utils::price_to_sqrt_price(v2, 10)
    }
    ...
    public fun pyth_price_from_oracle_info(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(v3, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::invalid_price_feed_id());
        ...
        assert!(v7 != 0, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::invalid_oracle_price());
    ...
    public fun remove_pyth_oracle_info<T0>(arg0: &mut PortOracle, arg1: &0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::GlobalConfig, arg2: &mut 0x2::tx_context::TxContext) {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::checked_package_version(arg1);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_not_exists());
    ...
    public fun remove_switchboard_oracle_info<T0>(arg0: &mut PortOracle, arg1: &0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::GlobalConfig, arg2: &mut 0x2::tx_context::TxContext) {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::checked_package_version(arg1);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_not_exists());
    ...
    public(friend) fun split_fee(arg0: &mut PortOracle, arg1: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.update_price_fee) >= arg1, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::update_price_fee_not_enough());
    ...
    public fun switchboard_price_from_oracle_info(arg0: &0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::Aggregator, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(v0, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::switchboard_aggregator_not_match());
        let v2 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::current_result(arg0);
        assert!(0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::max_timestamp_ms(v2) + arg1.usd_price_age * 1000 > 0x2::clock::timestamp_ms(arg2), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_not_updated());
        let v3 = 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::aggregator::result(v2);
        assert!(!0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::decimal::neg(v3), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::invalid_aggregator_price());
        ...
        assert!(v4 != 0, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::invalid_oracle_price());
        let v6 = if (v5 < 10) {
    ...
    public fun update_price_age<T0>(arg0: &mut PortOracle, arg1: &0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::GlobalConfig, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::checked_package_version(arg1);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg3));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::oracle_info_not_exists());
    ...
    fun update_price_from_type<T0>(arg0: &mut PortOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : Price {
        ...
        assert!(v2, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::price_object_not_match_with_coin_type());
        let v4 = Price{
