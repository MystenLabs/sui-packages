module 0x6e6ea6a4f086bbf2dadc85052abc4e30f6d3c852918c0d9a6d84bee0613d6c33::suilendgift {
    ...
    public entry fun GiftFromSuilend(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUILEND_GIFTBOX{
                id          : 0x2::object::new(arg1),
                name        : 0x1::string::utf8(b"Suilend Gift Box"),
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuilendcom_0811/giftsuilendcom_0811_1.jpg"),
    ...
    fun init(arg0: SUILENDGIFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuilendcom_0811/giftsuilendcom_0811_1.jpg"));
