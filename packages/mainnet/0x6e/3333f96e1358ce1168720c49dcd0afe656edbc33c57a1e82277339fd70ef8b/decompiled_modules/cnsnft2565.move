module 0x6e3333f96e1358ce1168720c49dcd0afe656edbc33c57a1e82277339fd70ef8b::cnsnft2565 {
    struct CNSNFT2565 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2565, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2565>(arg0, arg1);
