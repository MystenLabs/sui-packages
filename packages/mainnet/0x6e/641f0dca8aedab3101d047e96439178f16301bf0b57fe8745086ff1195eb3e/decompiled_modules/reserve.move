module 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve {
    ...
    public(friend) fun handle_borrow<T0>(arg0: &mut Reserve, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v1.cash >= arg1, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::reserve_not_enough_error());
    ...
    public(friend) fun redeem_underlying_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<MarketCoin<T0>>) : 0x2::balance::Balance<T0> {
        ...
        assert!(v3 > 0, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::redeem_market_coin_too_small_error());
        assert!(v2.cash >= v3, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::reserve_not_enough_error());
        v2.cash = v2.cash - v3;
