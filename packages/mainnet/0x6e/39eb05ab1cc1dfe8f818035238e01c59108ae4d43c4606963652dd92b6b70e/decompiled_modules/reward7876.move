module 0x6e39eb05ab1cc1dfe8f818035238e01c59108ae4d43c4606963652dd92b6b70e::reward7876 {
    struct REWARD7876 has drop {
        dummy_field: bool,
    }

    struct TICKET_7876 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7876(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7876>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7876>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7876, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7876>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7876>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7876>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7876>>(v5, 0x2::tx_context::sender(arg1));
    }
