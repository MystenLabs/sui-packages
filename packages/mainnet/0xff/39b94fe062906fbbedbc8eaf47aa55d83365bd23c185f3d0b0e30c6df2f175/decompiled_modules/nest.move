module 0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::nest {
    ...
    public entry fun clear_stale_stake(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::kiosk::has_item_with_type<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::duck_nft::DuckNFT>(arg1, v1), 1);
        ...
        update_user_stake_stats(arg2, v0, false, arg3);
        let v2 = DuckUnstaked{
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::NestMintCap, arg4: &mut 0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(arg0.owner == v0, 6);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.staked_duck_id), 13);
        let v1 = *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id);
        assert!(0x2::kiosk::has_item_with_type<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::duck_nft::DuckNFT>(arg1, v1), 2);
        ...
        if (v10 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SHTTOKEN>>(0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::mint_for_nest(arg3, arg4, v10, arg7), v0);
        };
        update_harvest_stats(arg2, v0, v5, v16, v10, arg6);
        arg0.last_harvest_time = v2;
        if (v5 > 1) {
    ...
    public fun is_staked_duck_in_kiosk(arg0: &Nest, arg1: &0x2::kiosk::Kiosk) : (bool, bool) {
        if (0x1::option::is_none<0x2::object::ID>(&arg0.staked_duck_id)) {
            ...
            (true, 0x2::kiosk::has_item_with_type<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::duck_nft::DuckNFT>(arg1, *0x1::option::borrow<0x2::object::ID>(&arg0.staked_duck_id)))
        }
    }

    public entry fun stake_duck(arg0: &0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut HarvestStats, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(arg3.owner == v0, 6);
        if (0x1::option::is_some<0x2::object::ID>(&arg3.staked_duck_id)) {
            if (0x2::kiosk::has_item_with_type<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::duck_nft::DuckNFT>(arg0, *0x1::option::borrow<0x2::object::ID>(&arg3.staked_duck_id))) {
                abort 12
            };
            ...
            update_user_stake_stats(arg4, v0, false, arg5);
        };
        let v1 = 0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::duck_nft::get_rarity_level(0x2::kiosk::borrow<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::duck_nft::DuckNFT>(arg0, arg1, arg2));
        let v2 = 0x2::clock::timestamp_ms(arg5);
        0x1::option::fill<0x2::object::ID>(&mut arg3.staked_duck_id, arg2);
        arg3.staked_at = v2;
        arg3.last_harvest_time = v2;
        arg3.duck_rarity = v1;
        arg3.duck_multiplier = get_duck_multiplier(v1);
        arg4.active_ducks_staked = arg4.active_ducks_staked + 1;
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &0x2::kiosk::Kiosk, arg2: &mut HarvestStats, arg3: &0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::NestMintCap, arg4: &mut 0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SharedTreasury, arg5: &0x2::random::Random, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::kiosk::has_item_with_type<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::duck_nft::DuckNFT>(arg1, v1)) {
            let v3 = (0x2::clock::timestamp_ms(arg6) - arg0.last_harvest_time) / 180000;
            if (v3 > 0) {
                let v4 = if (v3 > 30) {
                    30
                } else {
                ...
                if (v9 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SHTTOKEN>>(0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::mint_for_nest(arg3, arg4, v9, arg7), v0);
                };
                update_harvest_stats(arg2, v0, v4, v12, v9, arg6);
        ...
        update_user_stake_stats(arg2, v0, false, arg6);
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SHTTOKEN>, arg2: &mut 0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::burn(arg2, 0x2::coin::split<0xff39b94fe062906fbbedbc8eaf47aa55d83365bd23c185f3d0b0e30c6df2f175::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
