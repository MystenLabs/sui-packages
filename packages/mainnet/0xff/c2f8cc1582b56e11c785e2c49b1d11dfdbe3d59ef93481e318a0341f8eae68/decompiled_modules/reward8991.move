module 0xffc2f8cc1582b56e11c785e2c49b1d11dfdbe3d59ef93481e318a0341f8eae68::reward8991 {
    struct REWARD8991 has drop {
        dummy_field: bool,
    }

    struct TICKET_8991 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8991(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8991>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8991>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8991, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8991>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8991>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8991>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8991>>(v5, 0x2::tx_context::sender(arg1));
    }
