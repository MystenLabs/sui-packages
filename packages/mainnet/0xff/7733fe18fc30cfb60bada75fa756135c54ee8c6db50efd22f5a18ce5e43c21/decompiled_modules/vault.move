module 0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::vault {
    ...
    fun current_balance_with_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &vector<0x3::staking_pool::StakedSui>, arg2: u64) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v0 < 0x1::vector::length<0x3::staking_pool::StakedSui>(arg1)) {
            let v2 = 0x1::vector::borrow<0x3::staking_pool::StakedSui>(arg1, v0);
            if (arg2 > 0x3::staking_pool::stake_activation_epoch(v2)) {
                let v3 = v1 + 0x3::staking_pool::staked_sui_amount(v2);
                v1 = v3 + 0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::stake_data_provider::earnings_from_staked_sui(arg0, v2, arg2);
            } else {
    ...
    public entry fun fulfil_request(arg0: &mut VaultGlobal, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<u64>(&v1) > 0) {
            ...
            0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::event::redeem_event(0x2::object::id<VaultGlobal>(arg0), v2.amount, v2.sender, 0x2::tx_context::epoch(arg1));
        };
    }
    ...
    public entry fun mint(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut VaultGlobal, arg2: 0x3::staking_pool::StakedSui, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = mint_non_entry(arg0, arg1, arg2, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<VAULT>>(v0, 0x2::tx_context::sender(arg3));
        0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::event::mint_event(0x2::object::id<VaultGlobal>(arg1), 0x3::staking_pool::staked_sui_amount(&arg2), 0x2::coin::value<VAULT>(&v0), 0x2::tx_context::sender(arg3), 0x2::tx_context::epoch(arg3));
    }
    ...
    public entry fun mint_from_sui(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut VaultGlobal, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= 1000000000, 5);
        let v0 = next_validator(arg1, 0x2::coin::value<0x2::sui::SUI>(&arg2), arg3);
        let v1 = 0x3::sui_system::request_add_stake_non_entry(arg0, arg2, v0, arg3);
        mint(arg0, arg1, v1, arg3);
    }
    ...
    public fun mint_non_entry(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut VaultGlobal, arg2: 0x3::staking_pool::StakedSui, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<VAULT> {
        assert!(arg1.config.enable_mint == true, 7);
        assert!(0x3::staking_pool::staked_sui_amount(&arg2) >= 1000000000, 5);
        let v0 = 0x3::staking_pool::pool_id(&arg2);
        assert!(0x1::vector::contains<0x2::object::ID>(&arg1.config.staking_pool_ids, &v0), 8);
        let v1 = 0x3::staking_pool::staked_sui_amount(&arg2);
        if (0x1::option::is_some<u64>(&arg1.config.deposit_cap)) {
            assert!(*0x1::option::borrow<u64>(&arg1.config.deposit_cap) >= v1, 9);
            *0x1::option::borrow_mut<u64>(&mut arg1.config.deposit_cap) = *0x1::option::borrow<u64>(&arg1.config.deposit_cap) - v1;
        };
        let v2 = if (0x2::tx_context::epoch(arg3) > 0x3::staking_pool::stake_activation_epoch(&arg2)) {
            0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::stake_data_provider::earnings_from_staked_sui(arg0, &arg2, 0x2::tx_context::epoch(arg3))
        } else {
            0
        };
        let v3 = v1 + v2;
        let v4 = 0x2::balance::supply_value<VAULT>(&arg1.reserve.lp_supply);
        let v5 = current_balance_with_rewards(arg0, &arg1.reserve.staked_sui, 0x2::tx_context::epoch(arg3));
        let v6 = if (v4 == 0) {
            assert!(v3 > 1000, 10);
            0x2::balance::join<VAULT>(&mut arg1.reserve.min_liquidity, 0x2::balance::increase_supply<VAULT>(&mut arg1.reserve.lp_supply, 1000));
            v3 - 1000
        } else {
            (0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::fixed_point64::multiply_u128((v4 as u128), 0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::fixed_point64::create_from_rational((v3 as u128), (v5 as u128))) as u64)
        };
        0x1::vector::push_back<0x3::staking_pool::StakedSui>(&mut arg1.reserve.staked_sui, arg2);
        if (0x1::vector::length<0x3::staking_pool::StakedSui>(&arg1.reserve.staked_sui) > 1) {
            0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::vault_lib::sort_items(&mut arg1.reserve.staked_sui);
        };
        arg1.current_balance_with_rewards = v5 + v3;
        arg1.total_lp_amount = v4 + v6;
        let v7 = &mut arg1.reserve;
        mint_lp(v7, v6, arg3)
    }
    ...
    fun prepare_withdrawal(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut VaultGlobal, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2 > 0x2::balance::value<0x2::sui::SUI>(&arg1.pending_withdrawal)) {
            ...
            let v1 = 0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::vault_lib::find_one_with_minimal_excess(arg0, &arg1.reserve.staked_sui, v0, 0x2::tx_context::epoch(arg3));
            if (0x1::option::is_none<u64>(&v1)) {
                let v2 = 0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::vault_lib::find_combination(arg0, &arg1.reserve.staked_sui, v0, 0x2::tx_context::epoch(arg3));
                assert!(0x1::vector::length<u64>(&v2) > 0, 11);
                0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::vault_lib::sort_u64(&mut v2);
                let v3 = &mut v2;
    ...
    public entry fun request_redeem(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut VaultGlobal, arg2: 0x2::coin::Coin<VAULT>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = (0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::fixed_point64::multiply_u128((v0 as u128), 0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::fixed_point64::create_from_rational((v1 as u128), (0x2::balance::supply_value<VAULT>(&arg1.reserve.lp_supply) as u128))) as u64);
        ...
        0xff7733fe18fc30cfb60bada75fa756135c54ee8c6db50efd22f5a18ce5e43c21::event::request_redeem_event(0x2::object::id<VaultGlobal>(arg1), v0, v2, 0x2::tx_context::sender(arg3), 0x2::tx_context::epoch(arg3));
    }
    ...
    public entry fun restake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut VaultGlobal, arg2: &mut ManagerCap, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x3::staking_pool::StakedSui>(&mut arg1.reserve.staked_sui, 0x3::sui_system::request_add_stake_non_entry(arg0, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.pending_withdrawal, arg3), arg4), v0, arg4));
    }
    ...
    fun unstake_staked_sui(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut VaultGlobal, arg2: &mut vector<u64>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        while (0x1::vector::length<u64>(arg2) > 0) {
            let v1 = 0x1::vector::swap_remove<0x3::staking_pool::StakedSui>(&mut arg1.reserve.staked_sui, 0x1::vector::pop_back<u64>(arg2));
