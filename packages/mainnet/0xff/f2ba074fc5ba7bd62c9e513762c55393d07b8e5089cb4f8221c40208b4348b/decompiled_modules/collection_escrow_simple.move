module 0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::collection_escrow_simple {
    ...
    public fun accept_offer<T0: store + key>(arg0: &mut 0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::MarketPlace, arg1: T0, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x2::coin::take<0x2::sui::SUI>(&mut v1.balance, v1.market_fee, arg3);
        let v4 = 0x2::coin::value<0x2::sui::SUI>(&v3);
        0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::add_balance(arg0, v3);
        0x1::debug::print<u64>(&v4);
        let v5 = 0x2::coin::take<0x2::sui::SUI>(&mut v1.balance, v2 - v4, arg3);
        ...
        0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::marketplace::create_receipt<T0>(v11, v9, arg3);
        let v12 = 0x2::coin::zero<0x2::sui::SUI>(arg3);
        0x2::balance::join<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut v12), v10);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v12, 0x2::tx_context::sender(arg3));
        0x2::object::delete(v7);
        0x66a422f94f320db5f541fa1b7fa0c097fabbd9024e9496b3b0f3e45d5558ec51::collection_escrow::emit_offer_accepted_event<T0>(arg2, 0x2::object::id<T0>(&arg1), 0x2::tx_context::sender(arg3), v9, v2, v11);
    }
