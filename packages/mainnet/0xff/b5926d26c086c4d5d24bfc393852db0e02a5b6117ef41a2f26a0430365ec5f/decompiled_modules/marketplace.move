module 0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::marketplace {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Marketplace>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Extension>(arg0), 9223374175748620291);
        assert!(0x2::kiosk_extension::is_installed<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Extension>(arg1), 9223374180043587587);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg0), v0), 9223374184338685957);
        let v1 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg1), v1), 9223374188634046475);
    ...
    public fun accept_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut Collection, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Marketplace>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Extension>(arg0), 9223374381907050499);
        assert!(0x2::kiosk_extension::is_installed<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Extension>(arg1), 9223374386202017795);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg0), v0), 9223374390497116165);
        let v1 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg3.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg1), v1), 9223374394792476683);
        let v2 = ListItem{id: arg2};
        let Listing {
            seller       : v3,
            price        : _,
    ...
    public fun cancel_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Extension>(arg0), 9223373896575746051);
        let v0 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg0), v0), 9223373900871237643);
    ...
    public fun cancel_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Extension>(arg0), 9223374034014699523);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg0), v0), 9223374038310191115);
        let v1 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v2 = 0x1::bcs::to_bytes<0x2::object::ID>(&v1);
        let v3 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v2, 0x1::bcs::to_bytes<address>(&v3));
    ...
    public fun place_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &0x2::clock::Clock, arg8: vector<u8>, arg9: &mut MarketplaceConfig, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x2::bag::borrow<ListItem, Listing<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg2), v7);
        let v9 = &v8.seller;
        ...
        0x2::bag::add<BidItem, Bidding<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg0), v10, v11);
    ...
    public fun place_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: vector<u8>, arg6: &mut MarketplaceConfig, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::Extension>(arg0), 9223373741956923395);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(!0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg0), v0), 9223373746252283913);
        let v1 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v2 = 0x1::bcs::to_bytes<0x2::object::ID>(&v1);
        let v3 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v2, 0x1::bcs::to_bytes<address>(&v3));
        ...
        0x2::bag::add<CollectionBidItem, CollectionBid<T0, T1>>(0xffb5926d26c086c4d5d24bfc393852db0e02a5b6117ef41a2f26a0430365ec5f::extension::bag_mut(arg0), v7, v8);
