module 0xff5ffcf62dcace3cdde316a2c8e404635b9c9e6222abb1fe89db781a38407155::referral_reward {
    ...
    entry fun claim(arg0: &mut Referral, arg1: &mut Reward, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        verify_claim_signature(0x2::tx_context::sender(arg8), arg0.admin_pub_key, arg3, arg4, arg5, arg6);
        let v0 = get_claimed_amount(arg2, arg0);
        assert!(arg5 > v0, 1002);
        let v1 = arg5 - v0;
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg1.balance) >= v1, 1001);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.balance, v1), arg8), 0x2::tx_context::sender(arg8));
        if (!is_existed_user_id(arg0, arg2)) {
            let v2 = Record{
                claimed_address : 0x2::tx_context::sender(arg8),
                claimed_amount  : v1,
            };
            0x2::table::add<vector<u8>, Record>(&mut arg0.records, arg2, v2);
        } else {
            let v3 = 0x2::table::borrow_mut<vector<u8>, Record>(&mut arg0.records, arg2);
