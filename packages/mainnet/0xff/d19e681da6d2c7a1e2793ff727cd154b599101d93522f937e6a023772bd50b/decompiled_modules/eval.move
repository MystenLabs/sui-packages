module 0xffd19e681da6d2c7a1e2793ff727cd154b599101d93522f937e6a023772bd50b::eval {
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        ...
        while (v3 < 5) {
            ...
            let v5 = 0xffd19e681da6d2c7a1e2793ff727cd154b599101d93522f937e6a023772bd50b::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0xffd19e681da6d2c7a1e2793ff727cd154b599101d93522f937e6a023772bd50b::types::card_suit(v4));
