module 0xffd19e681da6d2c7a1e2793ff727cd154b599101d93522f937e6a023772bd50b::types {
    ...
    public fun engine_action_advance_street() : u8 {
        1
    }

    public fun engine_action_complete_hand() : u8 {
        2
    }

    public fun engine_action_complete_match() : u8 {
        3
    }

    public fun engine_action_deal_hand() : u8 {
        0
    }
    ...
    public fun street_next(arg0: u8) : u8 {
        assert!(arg0 < 3, 13906834273127956486);
        arg0 + 1
    }
