module 0xff2f5c58b3d14245065ee27296b6d156a269b38d7847eccbed7a7c3e5a8d2587::reward5058 {
    struct REWARD5058 has drop {
        dummy_field: bool,
    }

    struct TICKET_5058 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5058(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5058>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5058>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5058, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5058>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5058>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5058>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5058>>(v5, 0x2::tx_context::sender(arg1));
    }
