module 0xff81c68b3afc631407140e4854750f7c7b002642b8fa2c10e19e2810a91b8c80::pod_extension {
    ...
    public fun update_note(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(is_enabled(arg0), 2);
        let v0 = PodMarker{dummy_field: false};
        0x2::dynamic_field::borrow_mut<PodMarker, PodExtension>(0x2::kiosk::uid_mut_as_owner(arg0, arg1), v0).note = arg2;
        let v1 = NoteUpdated{
            kiosk_id  : 0x2::object::id<0x2::kiosk::Kiosk>(arg0),
            curator   : 0x2::tx_context::sender(arg4),
            timestamp : 0x2::clock::timestamp_ms(arg3),
            new_note  : arg2,
        };
        0x2::event::emit<NoteUpdated>(v1);
    }
