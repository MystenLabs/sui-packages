module 0xff164f7113bb8c63bfbbfb2f4c45e2c741df5203b28675bb70d11f733877c9cc::nemo_protocol {
    struct NEMO_PROTOCOL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NEMO_PROTOCOL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NEMO_PROTOCOL>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Nemo Protocol"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Nemo Protocol OG Airdrop"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifjq3l2kbfzrlb4dcxc6jdkdkuw4l5wwz7udiaqdhddeadfziexwa"));
