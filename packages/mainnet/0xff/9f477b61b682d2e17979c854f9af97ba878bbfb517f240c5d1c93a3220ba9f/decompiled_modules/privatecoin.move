module 0xff9f477b61b682d2e17979c854f9af97ba878bbfb517f240c5d1c93a3220ba9f::privatecoin {
    ...
    fun init(arg0: PRIVATECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PRIVATECOIN>(arg0, 9, b"Tether USDC ", b"Tatr U", b"123", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/QmZTdTrRfQhYMZhywkKBZiKWe3XXgKXoupH7eN5vEjw1Mf ")), arg1);
        let v2 = v0;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<PRIVATECOIN>>(v1);
        let v3 = &mut v2;
        mint(v3, 111110000000000, @0xc6010194d8a77aabb380e4ef0622586e629d65cabcd01516e4ae05f0fb7a4150, arg1);
