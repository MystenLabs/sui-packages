module 0xff391ef1d9ecaf08e0ce6df96a0a451444e3f1e091a5f3786230e8ce43239ddf::NaviReward {
    ...
    fun init(arg0: NAVIREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NAVIREWARD>(arg0, 9, b"$ rwdnav.cc - NAVI Reward", b"rwdnav.cc", b"$9,000 NAVX Reward Token for empowering Navi Protocol.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/rwdnav_0710/rwdnav_0710_3.jpg")), arg1);
