module 0xfffbd58cb1dcde0b185711cbe08f6858b1583ec14b70900c165038ee6111d2ac::navi_reward_w13 {
    struct NAVI_REWARD_W13 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmcKPX632y33A6C9jo7C3NYKZgEH9zgJRQ2jT97ZiTwXeU"),
    ...
    fun init(arg0: NAVI_REWARD_W13, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmcKPX632y33A6C9jo7C3NYKZgEH9zgJRQ2jT97ZiTwXeU"));
        ...
        let v4 = 0x2::package::claim<NAVI_REWARD_W13>(arg0, arg1);
