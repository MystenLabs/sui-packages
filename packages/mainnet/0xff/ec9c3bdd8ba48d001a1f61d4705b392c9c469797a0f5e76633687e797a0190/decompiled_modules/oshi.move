module 0xffec9c3bdd8ba48d001a1f61d4705b392c9c469797a0f5e76633687e797a0190::oshi {
    ...
    public fun mint(arg0: &ControlledTreasuryCap, arg1: &mut ControlledTreasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 13906834565185470466);
        assert!(0x2::coin::total_supply<OSHI>(borrow_treasury_cap(arg1)) + arg2 <= arg1.limit, 13906834582365470724);
    ...
    public fun metadata_to_shared(arg0: &ControlledTreasuryCap, arg1: &mut OshiCoinMetadata) {
        let v0 = CoinMetadataKey{dummy_field: false};
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<OSHI>>(0x2::dynamic_object_field::remove<CoinMetadataKey, 0x2::coin::CoinMetadata<OSHI>>(&mut arg1.id, v0));
    }
