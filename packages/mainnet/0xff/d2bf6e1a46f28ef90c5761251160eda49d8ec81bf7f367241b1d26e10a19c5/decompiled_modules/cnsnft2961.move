module 0xffd2bf6e1a46f28ef90c5761251160eda49d8ec81bf7f367241b1d26e10a19c5::cnsnft2961 {
    struct CNSNFT2961 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2961, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2961>(arg0, arg1);
