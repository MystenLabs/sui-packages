module 0xffc1b84e32ae198729ef241c04e542c7a1d88f31b6943436e533193d58ade8e6::gift5034 {
    struct GIFT5034 has drop {
        dummy_field: bool,
    }

    struct TICKET_5034 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5034(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5034>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5034>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5034, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5034>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5034>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5034>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5034>>(v5, 0x2::tx_context::sender(arg1));
    }
