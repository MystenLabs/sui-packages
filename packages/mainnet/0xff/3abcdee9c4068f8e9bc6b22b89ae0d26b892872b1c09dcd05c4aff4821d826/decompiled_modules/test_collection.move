module 0xff3abcdee9c4068f8e9bc6b22b89ae0d26b892872b1c09dcd05c4aff4821d826::test_collection {
    ...
    fun init(arg0: TEST_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is a Testcollection."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreib357czs4232qaiw6ilfg3gdxqrbt3bslvvr7hy5txjcgyy5hj76q"));
