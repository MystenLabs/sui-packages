module 0x88df7a1ddfa9524721fc850ad33dd47ab7921b7931a30b32ee2482545e394eed::cetus_adapter {
    ...
    fun consume_position_record(arg0: &mut ConsumePositionRecord, arg1: &CetusVault, arg2: u64) {
        let v0 = 0x2::vec_map::keys<u64, 0x2::object::ID>(&arg0.records);
        assert!(0x1::vector::length<u64>(&v0) == 1, 111111);
        let (v1, v2) = 0x2::vec_map::remove<u64, 0x2::object::ID>(&mut arg0.records, &arg2);
        if (v2 != 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(0x1::vector::borrow<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg1.positions, v1))) {
