module 0xff0f43936e11679d05c4ae33be8620a2dc94b3ecb2f5b7eb1b667124921520dc::swap {
    ...
    public fun cetus_swap_b2a<T0, T1, T2>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::partner::Partner, arg3: 0x2::coin::Coin<T0>, arg4: &mut HopGuard<T0, T2>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        arg4.nextAmount = 0x2::coin::value<T1>(&v1);
        v1
    }

    public fun hop_guard_id<T0, T1>(arg0: &HopGuard<T0, T1>) : 0x2::object::ID {
        0x2::object::uid_to_inner(&arg0.sid)
    }

    public fun mock_swap<T0, T1, T2>(arg0: 0x2::coin::Coin<T1>, arg1: &mut HopGuard<T0, T2>) : 0x2::coin::Coin<T1> {
        let v0 = 0x1::string::utf8(b"swap::mock_swap");
        0x1::debug::print<0x1::string::String>(&v0);
        arg1.nextAmount = 0x2::coin::value<T1>(&arg0);
        arg0
    }
