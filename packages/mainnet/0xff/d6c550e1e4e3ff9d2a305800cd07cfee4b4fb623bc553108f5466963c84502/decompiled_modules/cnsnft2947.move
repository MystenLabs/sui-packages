module 0xffd6c550e1e4e3ff9d2a305800cd07cfee4b4fb623bc553108f5466963c84502::cnsnft2947 {
    struct CNSNFT2947 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2947, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2947>(arg0, arg1);
