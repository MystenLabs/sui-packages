module 0xff3cf2c0f6a3a9aaf025f538418a6e9008d2e53c53d2d1ffe1b1e8f79e9f6523::float {
    ...
    public fun mul_div(arg0: Float, arg1: Float, arg2: Float) : Float {
        ...
        if (to_scaled_val(v0) > (0xff3cf2c0f6a3a9aaf025f538418a6e9008d2e53c53d2d1ffe1b1e8f79e9f6523::constants::max_u64() as u128)) {
            err_over_u64_max();
        };
        v0
    }
