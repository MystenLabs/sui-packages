module 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::profile {
    ...
    public fun new_point_dashboard<T0: drop>(arg0: &AdmincCap, arg1: &mut ProfileRegistry, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointDashBoard<T0>>(0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::new_point_dashboard<T0>(arg2));
    }

    public fun add_df_state<T0, T1: store>(arg0: &mut Profile, arg1: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>, arg2: T1) {
    ...
    public fun add_dof_state<T0, T1: store + key>(arg0: &mut Profile, arg1: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>, arg2: T1) {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun add_point_by_admin<T0>(arg0: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointDashBoard<T0>, arg1: &AdmincCap, arg2: 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::AddPointRequest<T0>) {
        0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::add_point<T0>(arg0, arg2);
    }
    ...
    public fun borrow_df_state<T0, T1: store>(arg0: &Profile, arg1: &0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : &T1 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 102);
        0x2::dynamic_field::borrow<0x1::type_name::TypeName, T1>(&arg0.id, v0)
    }

    public fun borrow_df_state_mut<T0, T1: store>(arg0: &mut Profile, arg1: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : &mut T1 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 102);
        0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, T1>(&mut arg0.id, v0)
    }

    public fun borrow_dof_state<T0, T1: store + key>(arg0: &Profile, arg1: &0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : &T1 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 102);
        0x2::dynamic_object_field::borrow<0x1::type_name::TypeName, T1>(&arg0.id, v0)
    }

    public fun borrow_dof_state_mut<T0, T1: store + key>(arg0: &mut Profile, arg1: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : &mut T1 {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 102);
    ...
    public fun df_state_exists<T0, T1: store>(arg0: &Profile, arg1: &0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : bool {
        0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, 0x1::type_name::get<T0>())
    }

    public fun df_state_exists_with_type<T0, T1: store>(arg0: &Profile, arg1: &0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : bool {
        0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, T1>(&arg0.id, 0x1::type_name::get<T0>())
    }

    public fun dof_state_exists<T0, T1: store + key>(arg0: &Profile, arg1: &0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : bool {
        0x2::dynamic_object_field::exists_<0x1::type_name::TypeName>(&arg0.id, 0x1::type_name::get<T0>())
    }

    public fun dof_state_exists_with_type<T0, T1: store + key>(arg0: &Profile, arg1: &0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : bool {
    ...
    public fun drop(arg0: Profile, arg1: &mut ProfileRegistry) {
        ...
        0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::event::profile_destroyed(v1, 0x2::table::remove<address, 0x2::object::ID>(&mut arg1.registry, v1));
    ...
    public fun point_key<T0: drop>(arg0: &ProfileRegistry) : &0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0> {
        0x2::dynamic_field::borrow<0x1::type_name::TypeName, 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>>(&arg0.id, 0x1::type_name::get<T0>())
    }

    public fun point_key_mut<T0: drop>(arg0: &mut ProfileRegistry, arg1: T0) : &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0> {
        0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>>(&mut arg0.id, 0x1::type_name::get<T0>())
    }
    ...
    fun register_(arg0: &mut ProfileRegistry, arg1: address, arg2: u64, arg3: 0x1::ascii::String, arg4: 0x1::ascii::String, arg5: 0x1::ascii::String, arg6: &mut 0x2::tx_context::TxContext) : Profile {
        ...
        0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::event::profile_created(arg1, v1);
    ...
    public fun register_point_module<T0: drop>(arg0: &AdmincCap, arg1: &mut ProfileRegistry, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_field::add<0x1::type_name::TypeName, 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>>(&mut arg1.id, v0, 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::new_point_key<T0>());
    }

    public fun remove_df_state<T0, T1: store>(arg0: &mut Profile, arg1: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : T1 {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun remove_dof_state<T0, T1: store + key>(arg0: &mut Profile, arg1: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>) : T1 {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun remove_point_module<T0: drop>(arg0: &AdmincCap, arg1: &mut ProfileRegistry, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::drop_point_key<T0>(0x2::dynamic_field::remove<0x1::type_name::TypeName, 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointKey<T0>>(&mut arg1.id, v0));
    }

    public fun stake_point_by_admin<T0, T1>(arg0: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointDashBoard<T0>, arg1: &AdmincCap, arg2: 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::StakePointRequest<T0, T1>) {
        0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::stake_point<T0, T1>(arg0, arg2);
    }

    public fun sub_point_by_admin<T0>(arg0: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointDashBoard<T0>, arg1: &AdmincCap, arg2: 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::SubPointRequest<T0>) {
        0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::sub_point<T0>(arg0, arg2);
    }

    public fun unstake_point_by_admin<T0, T1>(arg0: &mut 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::PointDashBoard<T0>, arg1: &AdmincCap, arg2: 0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::UnstakePointRequest<T0, T1>) {
        0xff6d83a04ee99b0a2d20da4200e84b60efa38a56e6f45f1519880dc02078e2c7::point::unstake_point<T0, T1>(arg0, arg2);
    }
