module 0xff4e8e299eb1e3678a50d593aba1f96bab02f74336a334219c28dc5775474098::token {
    ...
    struct SuitoshiPanda has store, key {
        id: 0x2::object::UID,
        number: u64,
    ...
    public(friend) fun id(arg0: &SuitoshiPanda) : 0x2::object::ID {
        0x2::object::id<SuitoshiPanda>(arg0)
    }

    public(friend) fun attributes(arg0: &SuitoshiPanda) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }

    fun burn(arg0: SuitoshiPanda, arg1: &mut Supply, arg2: &Data) : 0x2::object::UID {
        let SuitoshiPanda {
            id         : v0,
            number     : v1,
            image      : _,
    ...
    public fun buy_on_curve(arg0: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<SuitoshiPanda>, arg1: &Data, arg2: &mut Supply, arg3: &mut 0x2::tx_context::TxContext) : (vector<SuitoshiPanda>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<SuitoshiPanda>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg1.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_curve<SuitoshiPanda>(&arg0);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg1.curve), 0);
        (mint(arg1, arg2, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_size<SuitoshiPanda>(&arg0), arg3), arg0)
    }
    ...
    public(friend) fun image(arg0: &SuitoshiPanda) : &0x1::string::String {
        &arg0.image
    }

    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TOKEN>(arg0, arg1);
        let v1 = 0x2::display::new<SuitoshiPanda>(&v0, arg1);
        0x2::display::add<SuitoshiPanda>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Suitoshi Panda #{number}"));
        0x2::display::add<SuitoshiPanda>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Representing fun, joy, and wonderment, and a nod to Sui and Satoshi Nakamoto, Suitoshi Panda is a high-vibed and inspiring expression of tokenized upliftment."));
        0x2::display::add<SuitoshiPanda>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://{image}"));
        0x2::display::add<SuitoshiPanda>(&mut v1, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<SuitoshiPanda>(&mut v1);
        let v2 = Supply{
        ...
        0x2::transfer::public_transfer<0x2::display::Display<SuitoshiPanda>>(v1, 0x2::tx_context::sender(arg1));
        0x2::transfer::transfer<ManagerCap>(v4, 0x2::tx_context::sender(arg1));
    }

    fun mint(arg0: &Data, arg1: &mut Supply, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<SuitoshiPanda> {
        assert!(arg2 > 0 && arg2 <= 1000, 0);
        assert!(arg2 <= 0x1::vector::length<vector<u64>>(&arg1.bitmaps), 9223372706869673983);
        let v0 = 0;
        let v1 = 0x1::vector::empty<SuitoshiPanda>();
        while (v0 < arg2) {
            ...
            let v7 = SuitoshiPanda{
                id         : 0x2::object::new(arg3),
                number     : 0x1::vector::pop_back<u64>(&mut v2),
                image      : *0x2::table::borrow<u64, 0x1::string::String>(&arg0.images, v3),
                attributes : v6,
            };
            0x1::vector::push_back<SuitoshiPanda>(&mut v1, v7);
            v0 = v0 + 1;
        };
        v1
    }

    public(friend) fun number(arg0: &SuitoshiPanda) : u64 {
        arg0.number
    }
    ...
    public fun sell_on_curve(arg0: vector<SuitoshiPanda>, arg1: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<SuitoshiPanda>, arg2: &mut Supply, arg3: &Data) : (vector<0x2::object::UID>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<SuitoshiPanda>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg3.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_order_curve<SuitoshiPanda>(&arg1);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg3.curve), 0);
        let v1 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_asset_ids<SuitoshiPanda>(&arg1);
        assert!(0x1::vector::length<0x2::object::ID>(&v1) == 0x1::vector::length<SuitoshiPanda>(&arg0), 0);
        let v2 = 0;
        let v3 = 0x1::vector::empty<0x2::object::UID>();
        while (v2 < 0x1::vector::length<0x2::object::ID>(&v1)) {
            let v4 = 0x1::vector::pop_back<SuitoshiPanda>(&mut arg0);
            assert!(id(&v4) == 0x1::vector::pop_back<0x2::object::ID>(&mut v1), 0);
            0x1::vector::push_back<0x2::object::UID>(&mut v3, burn(v4, arg2, arg3));
            v2 = v2 + 1;
        };
        0x1::vector::destroy_empty<SuitoshiPanda>(arg0);
