module 0xff53dfd4b37a2cc28acddfed340869ea0ec742c86a50a3cfd3b15d8888e2cdfe::pixel_world_test {
    struct PIXEL_WORLD_TEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PIXEL_WORLD_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PIXEL_WORLD_TEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"pixel world test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is the test for the pixel world, that will be part for a better and bigger project if I can see that people are interested.If you buy this nft you will get white listed ofc, and when the bigger project comes out it will be MUCH cheaper for you.Thank you for reading this :)"));
