module 0xffd09ea1ad258b25faf77de1cc128f889cbe371e8024198f884e5fa674ba46c9::ika_squid {
    struct IKA_SQUID has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IKA_SQUID, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<IKA_SQUID>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"IKA SQUID"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreicng6hhctmakrnu2ugoozgozgoirhampgmzhtnpp7lgmekfz2n3ki"));
