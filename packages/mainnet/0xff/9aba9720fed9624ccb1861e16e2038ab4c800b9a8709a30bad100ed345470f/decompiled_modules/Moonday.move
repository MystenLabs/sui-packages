module 0xff9aba9720fed9624ccb1861e16e2038ab4c800b9a8709a30bad100ed345470f::Moonday {
    struct MOONDAY has drop {
        dummy_field: bool,
    }

    fun init(arg0: MOONDAY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = if (b"https://storage.googleapis.com/moonday/tokens/b15a98ef-a7ad-4c58-99b0-913e29dcf252/aicoin.webp" == b"") {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://storage.googleapis.com/moonday/tokens/b15a98ef-a7ad-4c58-99b0-913e29dcf252/aicoin.webp"))
        };
        let v1 = b"aGOTT";
