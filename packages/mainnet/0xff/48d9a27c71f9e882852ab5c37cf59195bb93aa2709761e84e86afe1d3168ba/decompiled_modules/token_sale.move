module 0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::token_sale {
    ...
    struct TokenSale has key {
        id: 0x2::object::UID,
        tokens_for_sale: 0x2::balance::Balance<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>,
    ...
    public entry fun claim_tokens(arg0: &mut TokenSale, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v1.claimed = true;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>>(0x2::coin::from_balance<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>(0x2::balance::split<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>(&mut arg0.tokens_for_sale, v2), arg2), v0);
    ...
    public entry fun deposit_tokens(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: 0x2::coin::Coin<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>) {
        0x2::balance::join<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>(&mut arg1.tokens_for_sale, 0x2::coin::into_balance<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>(arg2));
        arg1.tokens_remaining = 0x2::balance::value<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>(&arg1.tokens_for_sale);
        let v0 = TokensDeposited{
            amount          : 0x2::coin::value<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>(&arg2),
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TokenSale{
            ...
            tokens_for_sale          : 0x2::balance::zero<0xff48d9a27c71f9e882852ab5c37cf59195bb93aa2709761e84e86afe1d3168ba::shttoken::SHTTOKEN>(),
            tokens_remaining         : 0,
