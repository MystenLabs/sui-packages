module 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::lb_position {
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (((0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::mul_u128(v2, 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::sub_u128(arg3, v1.fee_growth_inside_last_x)) >> 64) as u64), ((0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::mul_u128(v2, 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::sub_u128(arg4, v1.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public(friend) fun get_pending_rewards(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u64, arg4: u128) : u64 {
        ...
        0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::u128_to_u64(v2 * (arg4 - v3) >> 64)
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 6) {
            ...
            v3 = 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::add_u64(v0, v3);
            v1 = 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }

    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: u128, arg6: u128, arg7: vector<u128>) {
        let v0 = borrow_mut_position_info(arg0, arg2);
        if (contains_bin(v0, arg3)) {
            let v1 = borrow_bin_mut(v0, arg3);
            v1.amount = 0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::safe_math::add_u128(v1.amount, arg4);
        ...
        0xff650a5324b803e653eabd48fa60648bfbcb77ed52f2ad719118dfaf08733682::bin_manager::increment_total_supply(arg1, arg3, arg4);
    }
