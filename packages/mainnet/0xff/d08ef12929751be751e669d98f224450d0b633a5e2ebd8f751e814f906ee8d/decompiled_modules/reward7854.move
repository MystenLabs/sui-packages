module 0xffd08ef12929751be751e669d98f224450d0b633a5e2ebd8f751e814f906ee8d::reward7854 {
    struct REWARD7854 has drop {
        dummy_field: bool,
    }

    struct TICKET_7854 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7854(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_7854>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7854, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7854>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7854>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7854>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7854>>(v5, 0x2::tx_context::sender(arg1));
    }
