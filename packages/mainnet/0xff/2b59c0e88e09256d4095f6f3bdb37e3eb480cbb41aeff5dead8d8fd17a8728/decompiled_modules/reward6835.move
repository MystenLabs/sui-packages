module 0xff2b59c0e88e09256d4095f6f3bdb37e3eb480cbb41aeff5dead8d8fd17a8728::reward6835 {
    struct REWARD6835 has drop {
        dummy_field: bool,
    }

    struct TICKET_6835 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6835(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6835>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6835>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6835, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6835>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6835>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6835>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6835>>(v5, 0x2::tx_context::sender(arg1));
    }
