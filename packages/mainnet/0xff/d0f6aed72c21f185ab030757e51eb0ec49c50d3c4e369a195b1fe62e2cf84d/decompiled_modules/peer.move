module 0xffd0f6aed72c21f185ab030757e51eb0ec49c50d3c4e369a195b1fe62e2cf84d::peer {
    struct Peer has store {
        ...
        token_decimals: u8,
        inbound_rate_limit: 0xffd0f6aed72c21f185ab030757e51eb0ec49c50d3c4e369a195b1fe62e2cf84d::rate_limit::RateLimitState,
    }
    ...
    public fun borrow_inbound_rate_limit_mut(arg0: &mut Peer) : &mut 0xffd0f6aed72c21f185ab030757e51eb0ec49c50d3c4e369a195b1fe62e2cf84d::rate_limit::RateLimitState {
    ...
    public fun new(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg1: u8, arg2: u64) : Peer {
        Peer{
            address            : arg0,
            token_decimals     : arg1,
            inbound_rate_limit : 0xffd0f6aed72c21f185ab030757e51eb0ec49c50d3c4e369a195b1fe62e2cf84d::rate_limit::new(arg2),
        }
    }
