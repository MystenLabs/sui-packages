module 0xff801b760d6fd20b9cc4d7b199ade914b7a8fb7324f3160ee354340b0fd04b5c::gift9069 {
    struct GIFT9069 has drop {
        dummy_field: bool,
    }

    struct TICKET_9069 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9069(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9069>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9069>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9069, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9069>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9069>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9069>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9069>>(v5, 0x2::tx_context::sender(arg1));
    }
