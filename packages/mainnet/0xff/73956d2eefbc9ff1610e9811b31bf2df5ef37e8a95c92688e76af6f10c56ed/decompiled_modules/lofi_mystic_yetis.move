module 0xff73956d2eefbc9ff1610e9811b31bf2df5ef37e8a95c92688e76af6f10c56ed::lofi_mystic_yetis {
    struct LOFI_MYSTIC_YETIS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LOFI_MYSTIC_YETIS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LOFI_MYSTIC_YETIS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"LOFI Mystic Yetis"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"For Lofi"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif4wrx6mdtrfyttny4dcenzngktfwrkayyrrj5wwvywuraspn47fq"));
