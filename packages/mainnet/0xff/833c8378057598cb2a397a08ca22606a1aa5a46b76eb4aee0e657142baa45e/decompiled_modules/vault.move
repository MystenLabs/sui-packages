module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault {
    ...
    public fun activate<T0>(arg0: &mut DepositVault, arg1: bool, arg2: &0x2::tx_context::TxContext) : u64 {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906835600272654339);
    ...
    fun add_deposit_share(arg0: &mut DepositVault, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<TypusDepositReceipt> {
        ...
        if (v0) {
            ...
            return 0x1::option::some<TypusDepositReceipt>(v1)
        };
    ...
    public fun adjust_user_share_ratio<T0>(arg0: &mut DepositVault, arg1: u8) {
        ...
        *v2 = v0;
        ...
        let v7 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice<DepositShare>(v4, 1);
        let v8 = 0;
        while (v8 < v5) {
            v3 = v3 + get_deposit_share_inner(0x1::vector::borrow<DepositShare>(v7, v8 % v6), arg1);
            if (v8 + 1 < v5 && (v8 + 1) % v6 == 0) {
                v7 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice<DepositShare>(v4, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_id<DepositShare>(v4, v8 + 1));
            };
            v8 = v8 + 1;
        };
        let v9 = get_mut_deposit_shares(arg0);
        let v10 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<DepositShare>(v9);
        let v11 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_size<DepositShare>(v9);
        let v12 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v9, 1);
        let v13 = 0;
        while (v13 < v10) {
            ...
            if (v13 + 1 < v10 && (v13 + 1) % v11 == 0) {
                v12 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v9, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_id<DepositShare>(v9, v13 + 1));
            };
            v13 = v13 + 1;
        };
        assert!(v1 == 0, 0);
    ...
    public fun calculate_exercise_value<T0>(arg0: &BidVault, arg1: &TypusBidReceipt) : u64 {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906837700511662083);
        assert!(0x1::option::is_none<0x1::type_name::TypeName>(&arg0.incentive_token), 13906837704806629379);
    ...
    public fun calculate_exercise_value_for_receipts<T0>(arg0: &BidVault, arg1: &vector<TypusBidReceipt>) : u64 {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906837601727414275);
        assert!(0x1::option::is_none<0x1::type_name::TypeName>(&arg0.incentive_token), 13906837606022381571);
        let v0 = 0;
        let v1 = 0;
    ...
    public fun charge_deposit_vault_inactive_token<T0>(arg0: &mut DepositVault, arg1: 0x2::balance::Balance<T0>) {
        abort 0
    }

    public fun charge_fee<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &DepositVault, arg2: &mut 0x2::balance::Balance<T0>) : (u64, u64) {
    ...
    public fun charge_fee_by_bp<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: u64, arg2: &mut 0x2::balance::Balance<T0>) : u64 {
        let v0 = (((0x2::balance::value<T0>(arg2) as u128) * (arg1 as u128) / 10000) as u64);
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::put<T0>(arg0, 0x2::balance::split<T0>(arg2, v0));
        v0
    }
    ...
    public fun compound_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        abort 0
    }
    ...
    public fun delivery<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906838031224143875);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg0.bid_token, 13906838035519111171);
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.deposit_token, 13906838039814078467);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg1.bid_token, 13906838044109045763);
    ...
    public fun delivery_b<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T1>, arg4: &0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906838555210153987);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg0.bid_token, 13906838559505121283);
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.deposit_token, 13906838563800088579);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg1.bid_token, 13906838568095055875);
    ...
    public fun delivery_d<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906838267447345155);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg0.bid_token, 13906838271742312451);
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.deposit_token, 13906838276037279747);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg1.bid_token, 13906838280332247043);
        let v0 = 0x2::balance::value<T1>(&arg2);
        let v1 = v0;
    ...
    public fun delivery_i<T0, T1, T2>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: 0x2::balance::Balance<T1>, arg3: 0x2::balance::Balance<T2>, arg4: &0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906838808613224451);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg0.bid_token, 13906838812908191747);
        assert!(0x1::option::some<0x1::type_name::TypeName>(0x1::type_name::with_defining_ids<T2>()) == arg0.incentive_token, 13906838817203159043);
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.deposit_token, 13906838821498126339);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg1.bid_token, 13906838825793093635);
        let v0 = 0x2::balance::value<T1>(&arg2);
        let v1 = v0;
    ...
    public fun deposit_from_lending<T0, T1>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: &mut 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: bool) : vector<u64> {
        let v0 = 0x2::balance::value<T0>(&arg3);
        let v1 = arg1.active_share_supply;
        let v2 = arg1.deactivating_share_supply;
        if (v0 < v1 + v2) {
            let v3 = v1 + v2 - v0;
            assert!(v3 <= 2, 13906845478698090509);
            0x2::balance::join<T0>(&mut arg3, 0x2::balance::split<T0>(arg2, v3));
        };
        let v4 = get_mut_deposit_vault_balance<T0>(arg1, 0);
        0x2::balance::join<T0>(v4, 0x2::balance::split<T0>(&mut arg3, v1));
        let v5 = get_mut_deposit_vault_balance<T0>(arg1, 1);
        0x2::balance::join<T0>(v5, 0x2::balance::split<T0>(&mut arg3, v2));
        if (!arg5) {
            let v6 = 0x1::vector::empty<u64>();
            let v7 = &mut v6;
            0x1::vector::push_back<u64>(v7, v0);
            0x1::vector::push_back<u64>(v7, 0x2::balance::value<T1>(&arg4));
            0x1::vector::push_back<u64>(v7, v1);
            0x1::vector::push_back<u64>(v7, v2);
            0x1::vector::push_back<u64>(v7, 0x2::balance::value<T0>(&arg3));
            0x1::vector::push_back<u64>(v7, 0);
            0x1::vector::push_back<u64>(v7, 0x2::balance::value<T1>(&arg4));
            0x1::vector::push_back<u64>(v7, 0);
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::put<T0>(arg0, arg3);
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::put<T1>(arg0, arg4);
            return v6
        };
        let (v8, v9) = get_deposit_vault_token_types(arg1);
        let v10 = 0x1::type_name::with_defining_ids<T1>();
        if (v10 != v8 && v10 != v9) {
            update_deposit_vault_incentive_token<T1>(arg1);
        };
        let v11 = &mut arg3;
        let (v12, v13) = charge_fee<T0>(arg0, arg1, v11);
        let (v14, v15) = if (v10 == v8) {
            let v16 = &mut arg4;
            charge_fee<T1>(arg0, arg1, v16)
        } else {
            (0, 0)
        };
        let v17 = 0;
        ...
        if (v0 > v1 + v2 || 0x2::balance::value<T1>(&arg4) != 0) {
            let v21 = arg1.active_share_supply + arg1.deactivating_share_supply;
            let v22 = 0x2::balance::value<T0>(&arg3);
            let v23 = 0x2::balance::value<T1>(&arg4);
            let v24 = get_mut_deposit_shares(arg1);
            let v25 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<DepositShare>(v24);
            let v26 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_size<DepositShare>(v24);
            let v27 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v24, 1);
            let v28 = 0;
            while (v28 < v25) {
                let v29 = 0x1::vector::borrow_mut<DepositShare>(v27, v28 % v26);
                let v30 = v29.active_share;
                let v31 = v30 + v29.deactivating_share;
                if (v31 > 0) {
                    if (v22 > 0) {
                        let v32 = (((v22 as u128) * (v31 as u128) / (v21 as u128)) as u64);
                        let v33 = (((v32 as u128) * (v30 as u128) / (v31 as u128)) as u64);
                        let v34 = v32 - v33;
                        v29.warmup_share = v29.warmup_share + v33;
                        v17 = v17 + v33;
                        v29.inactive_share = v29.inactive_share + v34;
                        v18 = v18 + v34;
                        v22 = v22 - v32;
                    };
                    if (v23 > 0) {
                        let v35 = (((v23 as u128) * (v31 as u128) / (v21 as u128)) as u64);
                        if (v10 == v8) {
                            let v36 = (((v35 as u128) * (v30 as u128) / (v31 as u128)) as u64);
                            let v37 = v35 - v36;
                            v29.warmup_share = v29.warmup_share + v36;
                            v19 = v19 + v36;
                            v29.inactive_share = v29.inactive_share + v37;
                            v20 = v20 + v37;
                        } else if (v10 == v9) {
                            v29.premium_share = v29.premium_share + v35;
                        } else {
                            v29.incentive_share = v29.incentive_share + v35;
                        };
                        v23 = v23 - v35;
                    };
                    v21 = v21 - v31;
                };
                if (v28 + 1 < v25 && (v28 + 1) % v26 == 0) {
                    v27 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v24, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_id<DepositShare>(v24, v28 + 1));
                };
                v28 = v28 + 1;
            };
        };
        let v38 = get_mut_deposit_vault_balance<T0>(arg1, 3);
        0x2::balance::join<T0>(v38, 0x2::balance::split<T0>(&mut arg3, v17));
        let v39 = get_mut_deposit_vault_balance<T0>(arg1, 2);
        0x2::balance::join<T0>(v39, 0x2::balance::split<T0>(&mut arg3, v18));
        ...
        if (v10 == v8) {
            let v40 = get_mut_deposit_vault_balance<T1>(arg1, 3);
            0x2::balance::join<T1>(v40, 0x2::balance::split<T1>(&mut arg4, v19));
            let v41 = get_mut_deposit_vault_balance<T1>(arg1, 2);
            0x2::balance::join<T1>(v41, 0x2::balance::split<T1>(&mut arg4, v20));
            arg1.warmup_share_supply = warmup_balance<T0>(arg1);
            arg1.inactive_share_supply = inactive_balance<T0>(arg1);
            0x2::balance::destroy_zero<T1>(arg4);
        } else if (v10 == v9) {
            let v42 = get_mut_deposit_vault_balance<T1>(arg1, 4);
            0x2::balance::join<T1>(v42, arg4);
            arg1.premium_share_supply = premium_balance<T1>(arg1);
        } else {
            let v43 = get_mut_deposit_vault_balance<T1>(arg1, 5);
            0x2::balance::join<T1>(v43, arg4);
            arg1.incentive_share_supply = incentive_balance<T1>(arg1);
        };
        let v44 = 0x1::vector::empty<u64>();
        let v45 = &mut v44;
        0x1::vector::push_back<u64>(v45, v0);
        0x1::vector::push_back<u64>(v45, 0x2::balance::value<T1>(&arg4));
        0x1::vector::push_back<u64>(v45, v1);
        0x1::vector::push_back<u64>(v45, v2);
        0x1::vector::push_back<u64>(v45, v12);
        0x1::vector::push_back<u64>(v45, v13);
        0x1::vector::push_back<u64>(v45, v14);
        0x1::vector::push_back<u64>(v45, v15);
        v44
    }
    ...
    public fun drop_deposit_vault<T0, T1>(arg0: DepositVault) {
        ...
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::destroy_empty<DepositShare>(0x2::dynamic_field::remove<vector<u8>, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::BigVector<DepositShare>>(&mut v18, b"deposit_shares"));
    ...
    public fun drop_refund_vault<T0>(arg0: RefundVault) {
        ...
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::destroy_empty<RefundShare>(0x2::dynamic_field::remove<vector<u8>, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::BigVector<RefundShare>>(&mut v5, b"refund_shares"));
    ...
    public fun extract_bid_shares(arg0: &mut BidVault, arg1: vector<TypusBidReceipt>) : (u64, vector<u64>) {
        ...
        while (!0x1::vector::is_empty<TypusBidReceipt>(&arg1)) {
            ...
            let v10 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<BidShare>(v9);
            let v11 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_size<BidShare>(v9);
            let v12 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice<BidShare>(v9, 1);
            let v13 = 0;
            while (v13 < v10) {
                if (0x1::vector::borrow<BidShare>(v12, v13 % v11).receipt == 0x2::object::uid_to_address(&v8)) {
                    let BidShare {
                        ...
                        share       : v15,
                        u64_padding : v16,
                    } = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::swap_remove<BidShare>(v9, v13);
                    let v17 = v16;
                    v0 = v0 + v15;
                    ...
                    if (v13 + 1 < v10 && (v13 + 1) % v11 == 0) {
                        v12 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice<BidShare>(v9, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_id<BidShare>(v9, v13 + 1));
                    };
                    v13 = v13 + 1;
                };
            };
    ...
    public fun get_deposit_share_inner(arg0: &DepositShare, arg1: u8) : u64 {
        if (arg1 == 0) {
            ...
            assert!(arg1 == 5, 13906843086400782341);
    ...
    public fun get_deposit_vault_balance<T0>(arg0: &DepositVault, arg1: u8) : &0x2::balance::Balance<T0> {
        if (arg1 == 0) {
            ...
            assert!(arg1 == 5, 13906841922464645125);
    ...
    public fun get_deposit_vault_share_supply(arg0: &DepositVault, arg1: u8) : u64 {
        if (arg1 == 0) {
            ...
            assert!(arg1 == 5, 13906842446450655237);
    ...
    public fun get_mut_deposit_share(arg0: &mut DepositVault, arg1: u64) : &mut DepositShare {
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_mut<DepositShare>(get_mut_deposit_shares(arg0), arg1)
    }
    ...
    public fun get_mut_deposit_share_inner(arg0: &mut DepositShare, arg1: u8) : &mut u64 {
        if (arg1 == 0) {
            ...
            assert!(arg1 == 5, 13906843185185030149);
            &mut arg0.incentive_share
        }
    }

    public fun get_mut_deposit_shares(arg0: &mut DepositVault) : &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::BigVector<DepositShare> {
    ...
    public fun get_mut_deposit_vault_balance<T0>(arg0: &mut DepositVault, arg1: u8) : &mut 0x2::balance::Balance<T0> {
        if (arg1 == 0) {
            ...
            assert!(arg1 == 5, 13906842021248892933);
    ...
    public fun get_mut_deposit_vault_share_supply(arg0: &mut DepositVault, arg1: u8) : &mut u64 {
        if (arg1 == 0) {
            ...
            assert!(arg1 == 5, 13906842545234903045);
    ...
    public fun harvest_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        abort 0
    }
    ...
    public fun public_compound<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<TypusDepositReceipt>, vector<u64>) {
        abort 0
    }
    ...
    public fun public_exercise<T0>(arg0: &mut BidVault, arg1: vector<TypusBidReceipt>) : (0x2::balance::Balance<T0>, vector<u64>) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906837455698526211);
        assert!(0x1::option::is_none<0x1::type_name::TypeName>(&arg0.incentive_token), 13906837459993493507);
    ...
    public fun public_new_bid(arg0: &mut BidVault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : TypusBidReceipt {
        ...
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::push_back<BidShare>(get_mut_bid_shares(arg0), v1);
        v0
    }

    public fun public_rebate<T0>(arg0: &mut RefundVault, arg1: address) : (0x1::option::Option<0x2::balance::Balance<T0>>, vector<u64>) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.token, 13906841278219419651);
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::BigVector<RefundShare>>(&mut arg0.id, b"refund_shares");
        let v1 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<RefundShare>(v0);
        let v2 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_size<RefundShare>(v0);
        let v3 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice<RefundShare>(v0, 1);
        let v4 = 0;
        ...
        let v5 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_mut<RefundShare>(v0, v4);
        let v6 = v5.share;
        v5.share = 0;
    ...
    public fun public_redeem<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<0x2::balance::Balance<T0>>, 0x1::option::Option<TypusDepositReceipt>, vector<u64>) {
        abort 0
    }
    ...
    public fun put_refund<T0>(arg0: &mut RefundVault, arg1: 0x2::balance::Balance<T0>, arg2: address) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.token, 13906839500102959107);
    ...
    public fun put_refunds<T0>(arg0: &mut RefundVault, arg1: 0x2::balance::Balance<T0>, arg2: vector<u64>, arg3: vector<u64>) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.token, 13906839706261389315);
        ...
        while (!0x1::vector::is_empty<u64>(&arg2) || !0x1::vector::is_empty<u64>(&arg3)) {
            let v1 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_mut<RefundShare>(v0, 0x1::vector::pop_back<u64>(&mut arg2));
            v1.share = v1.share + 0x1::vector::pop_back<u64>(&mut arg3);
        };
    }

    public fun raise_fund<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: 0x2::balance::Balance<T0>, arg4: bool, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) : (TypusDepositReceipt, vector<u64>) {
        assert!(arg1.has_next, 13906840238837858315);
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.deposit_token, 13906840243132301315);
    ...
    public fun recoup<T0>(arg0: &mut DepositVault, arg1: u64, arg2: &0x2::tx_context::TxContext) : (u64, u64) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906835840790822915);
    ...
    public fun redeem_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, 0x1::option::Option<vector<u8>>) {
        abort 0
    }

    public fun reduce_fund<T0, T1, T2>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: vector<TypusDepositReceipt>, arg3: u64, arg4: u64, arg5: bool, arg6: bool, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : (0x1::option::Option<TypusDepositReceipt>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, vector<u64>) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.deposit_token, 13906840659744129027);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg1.bid_token, 13906840664039096323);
        assert!(!arg7 || 0x1::option::some<0x1::type_name::TypeName>(0x1::type_name::with_defining_ids<T2>()) == arg1.incentive_token, 13906840668334063619);
        let (v0, v1, v2, v3, v4, v5, v6) = extract_deposit_shares(arg1, arg2);
        let v7 = v5;
        let v8 = v4;
        let v9 = v3;
        ...
        if (arg3 > 0) {
            ...
            0x2::balance::join<T0>(&mut v13, 0x2::balance::split<T0>(v18, v17));
            v9 = v3 - v17;
            arg1.warmup_share_supply = arg1.warmup_share_supply - v17;
            0x1::vector::push_back<u64>(&mut v16, v17);
        } else {
        ...
        if (arg4 > 0) {
            ...
            v12 = v0 - v19;
            arg1.active_share_supply = arg1.active_share_supply - v19;
            v11 = v1 + v19;
            arg1.deactivating_share_supply = arg1.deactivating_share_supply + v19;
            if (active_balance<T0>(arg1) > 0) {
                let v20 = get_mut_deposit_vault_balance<T0>(arg1, 0);
                let v21 = 0x2::balance::split<T0>(v20, v19);
                let v22 = get_mut_deposit_vault_balance<T0>(arg1, 1);
                0x2::balance::join<T0>(v22, v21);
            };
        ...
        if (arg5) {
            let v23 = get_mut_deposit_vault_balance<T1>(arg1, 4);
            let v24 = 0x2::balance::split<T1>(v23, v4);
            v8 = v4 - v4;
            arg1.premium_share_supply = arg1.premium_share_supply - v4;
            let v25 = &mut v24;
            let (v26, v27) = charge_fee<T1>(arg0, arg1, v25);
            0x2::balance::join<T1>(&mut v14, v24);
            let v28 = 0x1::vector::empty<u64>();
            let v29 = &mut v28;
            0x1::vector::push_back<u64>(v29, v4 - v26 - v27);
            0x1::vector::push_back<u64>(v29, v26);
            0x1::vector::push_back<u64>(v29, v27);
            0x1::vector::append<u64>(&mut v16, v28);
        } else {
            0x1::vector::append<u64>(&mut v16, vector[0, 0, 0]);
        };
        if (arg6) {
            let v30 = get_mut_deposit_vault_balance<T0>(arg1, 2);
            0x2::balance::join<T0>(&mut v13, 0x2::balance::split<T0>(v30, v2));
            v10 = v2 - v2;
        ...
        if (arg7) {
            let v31 = get_mut_deposit_vault_balance<T2>(arg1, 5);
            let v32 = 0x2::balance::split<T2>(v31, v5);
            v7 = v5 - v5;
            arg1.incentive_share_supply = arg1.incentive_share_supply - v5;
            let (v33, v34) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_flagged_u64_padding_value(&arg1.u64_padding, 0);
            let (v35, v36) = if (!v33) {
                let v37 = &mut v32;
                charge_fee<T2>(arg0, arg1, v37)
            } else {
                let v38 = &mut v32;
                (charge_fee_by_bp<T2>(arg0, v34, v38), 0)
            };
            0x2::balance::join<T2>(&mut v15, v32);
            let v39 = 0x1::vector::empty<u64>();
            let v40 = &mut v39;
            0x1::vector::push_back<u64>(v40, v5 - v35 - v36);
            0x1::vector::push_back<u64>(v40, v35);
            0x1::vector::push_back<u64>(v40, v36);
            0x1::vector::append<u64>(&mut v16, v39);
        } else {
            0x1::vector::append<u64>(&mut v16, vector[0, 0, 0]);
        };
    ...
    public fun register_refund<T0>(arg0: &mut RefundVault, arg1: address) : u64 {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.token, 13906839319714332675);
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::BigVector<RefundShare>>(&mut arg0.id, b"refund_shares");
        let v1 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::length<RefundShare>(v0);
        let v2 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_size<RefundShare>(v0);
        let v3 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<RefundShare>(v0, 1);
        let v4 = 0;
        while (v4 < v1) {
            ...
            if (v4 + 1 < v1 && (v4 + 1) % v2 == 0) {
                v3 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<RefundShare>(v0, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_id<RefundShare>(v0, v4 + 1));
            };
            v4 = v4 + 1;
        };
        let v5 = RefundShare{
        ...
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::push_back<RefundShare>(v0, v5);
        v4
    }
    ...
    public fun reward_from_lending<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut DepositVault, arg2: 0x2::balance::Balance<T0>, arg3: bool) : vector<u64> {
        ...
        if (!arg3) {
            ...
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::put<T0>(arg0, arg2);
            return v1
        };
        ...
        if (0x2::balance::value<T0>(&arg2) > 0) {
            ...
            let v16 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v13, 1);
            let v17 = 0;
            while (v17 < v14) {
                ...
                if (v17 + 1 < v14 && (v17 + 1) % v15 == 0) {
                    v16 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::borrow_slice_mut<DepositShare>(v13, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::slice_id<DepositShare>(v13, v17 + 1));
                };
                v17 = v17 + 1;
            };
        };
    ...
    public fun settle<T0, T1>(arg0: &mut DepositVault, arg1: &mut BidVault, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 13906836188683042817);
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906836192978141187);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg0.bid_token, 13906836197273108483);
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.deposit_token, 13906836201568075779);
        assert!(0x1::type_name::with_defining_ids<T1>() == arg1.bid_token, 13906836205863043075);
    ...
    public fun split_bid_receipt(arg0: &mut BidVault, arg1: vector<TypusBidReceipt>, arg2: 0x1::option::Option<u64>, arg3: &mut 0x2::tx_context::TxContext) : (u64, 0x1::option::Option<TypusBidReceipt>, 0x1::option::Option<TypusBidReceipt>) {
        ...
        let v5 = if (v3 > 0) {
            ...
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::push_back<BidShare>(v7, v8);
            v2 = v0 - v3;
        ...
        let v9 = if (v2 > 0) {
            ...
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::push_back<BidShare>(get_mut_bid_shares(arg0), v11);
    ...
    public fun terminate<T0>(arg0: &mut DepositVault, arg1: &0x2::tx_context::TxContext) {
        assert!(0x1::type_name::with_defining_ids<T0>() == arg0.deposit_token, 13906836721259118595);
    ...
    public fun update_bid_receipt_u64_padding(arg0: &mut TypusBidReceipt, arg1: vector<u64>) {
        arg0.u64_padding = arg1;
    }
    ...
    public fun update_deposit_vault_incentive_token<T0>(arg0: &mut DepositVault) {
        if (arg0.incentive_token != 0x1::option::some<0x1::type_name::TypeName>(0x1::type_name::with_defining_ids<T0>())) {
            0x1::option::fill<0x1::type_name::TypeName>(&mut arg0.incentive_token, 0x1::type_name::with_defining_ids<T0>());
    ...
    public fun update_incentive_fee(arg0: &mut DepositVault, arg1: u64) {
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut arg0.u64_padding, 0, arg1 + 9223372036854775808);
    }

    fun verify_bid_receipt(arg0: &BidVault, arg1: &TypusBidReceipt) {
        assert!(0x2::object::id<BidVault>(arg0) == arg1.vid && arg0.index == arg1.index, 13906845298309201929);
    }

    fun verify_deposit_receipt(arg0: &DepositVault, arg1: &TypusDepositReceipt) {
        assert!(0x2::object::id<DepositVault>(arg0) == arg1.vid && arg0.index == arg1.index, 13906845259654365191);
    }
