module 0xff16b049666596adfb470bc274cffa5b65fc26baa6ad678bd243ebce42655b77::suiOfficial_adapter {
    ...
    public fun xbridge_suiOfficial_commission<T0>(arg0: 0x1::string::String, arg1: u8, arg2: u8, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0xb::bridge::Bridge, arg6: vector<u8>, arg7: &mut 0x2::coin::Coin<T0>, arg8: u64, arg9: u64, arg10: address, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg9 <= 300, 1);
