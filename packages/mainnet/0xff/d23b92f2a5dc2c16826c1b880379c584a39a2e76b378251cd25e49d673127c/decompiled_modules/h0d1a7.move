module 0xffd23b92f2a5dc2c16826c1b880379c584a39a2e76b378251cd25e49d673127c::h0d1a7 {
    struct H7889f has copy, drop {
        h32609: u64,
        h9c1a1: u64,
    }

    struct H823f1 has copy, drop {
        hc4051: u64,
    }

    public fun h011fb<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0xc971a569f8ebe9c3a5a683bb0b20750f5052239a8d74d59a0f594b599fa95618::h637f4::H8e2ee, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: vector<u64>, arg15: u64, arg16: u64, arg17: 0x1::option::Option<0x2::object::ID>, arg18: 0x1::option::Option<u64>, arg19: &mut 0x2::tx_context::TxContext) {
        if (0x1::option::is_some<u64>(&arg18)) {
            let v0 = H823f1{hc4051: *0x1::option::borrow<u64>(&arg18)};
            0x2::event::emit<H823f1>(v0);
        };
        let v1 = 0xc971a569f8ebe9c3a5a683bb0b20750f5052239a8d74d59a0f594b599fa95618::h637f4::h0abe4(arg1, arg2, arg19);
        ...
        let v8 = v7;
        let v9 = v6;
        let (_, _, _) = ha78b6<T0, T1, T2>(arg0, arg2, &v1, arg3, arg4, arg5, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, v5, v4, v2, v3, &v9, &v8, arg19);
        ...
        let (_, _, _) = h0ac4a<T0, T1>(arg0, arg2, &v1, arg3, v16, v17, v15, arg6, arg7, arg10, arg11, arg12, v5, v4, v2, v3, arg19);
    }
    ...
    fun h0ac4a<T0, T1>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v13 < 0x1::vector::length<u64>(&arg7)) {
            ...
            if (v11 == 0) {
                ...
                0x2::event::emit<H7889f>(v18);
                break
            };
            if (!h43ff2(v17, true, &v7, &v6, v8, v9)) {
                break
            };
            let (v19, v20) = hd56ec<T0, T1>(arg0, v10, v11, v12, arg14, arg15, arg13, v17, *0x1::vector::borrow<u64>(&arg10, v14), true, false, true);
            if (v20 != 0) {
                let v21 = H7889f{
                    h32609 : v20,
                    h9c1a1 : 465,
                };
                0x2::event::emit<H7889f>(v21);
                continue
            };
        ...
        while (v13 < 0x1::vector::length<u64>(&arg8)) {
            ...
            if (v10 < arg13) {
                ...
                0x2::event::emit<H7889f>(v28);
                break
            };
            if (!h43ff2(v27, false, &v7, &v6, v8, v9)) {
                break
            };
            let (v29, v30) = hd56ec<T0, T1>(arg0, v10, v11, v12, arg14, arg15, arg13, v27, *0x1::vector::borrow<u64>(&arg10, v24), false, false, true);
            if (v30 != 0) {
                let v31 = H7889f{
                    h32609 : v30,
                    h9c1a1 : 549,
                };
                0x2::event::emit<H7889f>(v31);
                continue
            };
    ...
    fun ha78b6<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: &vector<u64>, arg20: &vector<u64>, arg21: &0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        while (v11 < 0x1::vector::length<u64>(&arg6)) {
            ...
            let v18 = hf29cd(arg17, *0x1::vector::borrow<u64>(&arg8, v16), true, v8, v9, *0x1::vector::borrow<u64>(&arg11, v16), haf5ec(arg19, h1fdbf(arg17, *0x1::vector::borrow<u64>(&arg8, v16), true, v8, v9), true));
            if (v18 > 0) {
            ...
            while (v20 < v1) {
                if (!*0x1::vector::borrow<bool>(&v10, v20)) {
                    ...
                    if (hc4910(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v21))) {
                        ...
                        if (h9d383(v18, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::price(v21)) <= *0x1::vector::borrow<u64>(&arg12, v16) && v23 > arg15 + arg14) {
        ...
        while (v11 < 0x1::vector::length<u64>(&arg7)) {
            ...
            let v30 = hf29cd(arg17, *0x1::vector::borrow<u64>(&arg8, v28), false, v8, v9, *0x1::vector::borrow<u64>(&arg11, v28), haf5ec(arg20, h1fdbf(arg17, *0x1::vector::borrow<u64>(&arg8, v28), false, v8, v9), false));
            if (v30 > 0) {
            ...
            while (v32 < v1) {
                if (!*0x1::vector::borrow<bool>(&v10, v32)) {
                    ...
                    if (!hc4910(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v33))) {
                        ...
                        if (h9d383(v30, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::price(v33)) <= *0x1::vector::borrow<u64>(&arg12, v28) && v35 > arg15 + arg14) {
        ...
        h22b6d<T0, T1>(arg0, arg1, arg2, arg3, v42, v43, v41, v15, v27, arg8, arg9, arg10, arg15, arg16, arg17, arg18, arg21)
    }
    ...
    public fun hdd3c9(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut 0xc971a569f8ebe9c3a5a683bb0b20750f5052239a8d74d59a0f594b599fa95618::h637f4::H8e2ee, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 < arg3) {
            ...
            let v2 = 0xc971a569f8ebe9c3a5a683bb0b20750f5052239a8d74d59a0f594b599fa95618::h637f4::h4a4fe(arg1, arg4);
            0xc971a569f8ebe9c3a5a683bb0b20750f5052239a8d74d59a0f594b599fa95618::h637f4::h661eb(arg1, v2, arg4);
    ...
    public fun he605f<T0, T1, T2>(arg0: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg1: &mut 0xc971a569f8ebe9c3a5a683bb0b20750f5052239a8d74d59a0f594b599fa95618::h637f4::H8e2ee, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2::clock::Clock, arg4: bool, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: vector<u64>, arg10: vector<u64>, arg11: vector<u64>, arg12: vector<u64>, arg13: vector<u64>, arg14: vector<u64>, arg15: 0x1::option::Option<0x2::object::ID>, arg16: 0x1::option::Option<u64>, arg17: &mut 0x2::tx_context::TxContext) {
        if (0x1::option::is_some<u64>(&arg16)) {
            let v0 = H823f1{hc4051: *0x1::option::borrow<u64>(&arg16)};
            0x2::event::emit<H823f1>(v0);
        };
        let v1 = 0xc971a569f8ebe9c3a5a683bb0b20750f5052239a8d74d59a0f594b599fa95618::h637f4::h0abe4(arg1, arg2, arg17);
        if (arg4) {
        ...
        let (v11, v12, v13) = h0ac4a<T0, T1>(arg0, arg2, &v1, arg3, v8, v9, v7, arg7, arg8, arg11, arg12, arg13, v10, v4, v2, v3, arg17);
        ...
        while (v26 < 0x1::vector::length<u64>(&arg9)) {
            ...
            let v28 = hf29cd(v2, *0x1::vector::borrow<u64>(&arg11, v27), true, v24, v25, *0x1::vector::borrow<u64>(&arg14, v27), haf5ec(&v17, h1fdbf(v2, *0x1::vector::borrow<u64>(&arg11, v27), true, v24, v25), true));
            if (v28 > 0) {
        ...
        while (v26 < 0x1::vector::length<u64>(&arg10)) {
            ...
            let v30 = hf29cd(v2, *0x1::vector::borrow<u64>(&arg11, v29), false, v24, v25, *0x1::vector::borrow<u64>(&arg14, v29), haf5ec(&v16, h1fdbf(v2, *0x1::vector::borrow<u64>(&arg11, v29), false, v24, v25), false));
            if (v30 > 0) {
                *0x1::vector::borrow_mut<u64>(&mut arg11, v29) = v30;
            };
            v26 = v26 + 1;
        };
        let (_, _, _) = h22b6d<T0, T1>(arg0, arg2, &v1, arg3, v11, v12, v13, arg9, arg10, arg11, arg12, arg13, v10, v4, v2, v3, arg17);
    }

    fun hf29cd(arg0: u64, arg1: u64, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : u64 {
        let v0 = h1fdbf(arg0, arg1, arg2, arg3, arg4);
        if (v0 == 0) {
            return 0
        };
        let v1 = v0;
