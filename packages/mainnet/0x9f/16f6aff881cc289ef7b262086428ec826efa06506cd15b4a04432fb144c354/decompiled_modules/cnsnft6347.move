module 0x9f16f6aff881cc289ef7b262086428ec826efa06506cd15b4a04432fb144c354::cnsnft6347 {
    struct CNSNFT6347 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6347, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6347>(arg0, arg1);
