module 0x9f028dca60d4ad9885377e048cf03e53aaef7a093fa95e411dcf041728755267::mte {
    ...
    fun tt<T0, T1>(arg0: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg1: &mut 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v3 = !arg6;
        let (v4, v5, v6) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::flash_swap<T0, T1>(arg0, v3, true, v2, arg5, arg4, arg3, arg12);
        let v7 = v6;
        let v8 = v5;
        let v9 = v4;
        ...
        assert!(v13 >= v14, 13906835308214812674);
        let (v15, v16) = if (v3) {
            (0x2::coin::zero<T1>(arg12), 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T0>(arg1, arg2, v10, arg12))
        } else {
            (0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T1>(arg1, arg2, v11, arg12), 0x2::coin::zero<T0>(arg12))
        };
        let v17 = v15;
        let v18 = v16;
        let (v19, v20) = if (v3) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v18, v10, arg12)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v17, v11, arg12)))
        };
        0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::repay_flash_swap<T0, T1>(arg0, v7, v19, v20, arg3, arg12);
