module 0x9f028dca60d4ad9885377e048cf03e53aaef7a093fa95e411dcf041728755267::cte {
    ...
    fun opt<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64) : u64 {
        assert!(arg4 > 0, 13906835205135728644);
        assert!(arg4 <= arg5, 13906835209430827014);
        assert!(arg8 < arg4, 13906835213725925384);
        let v0 = 0;
        let v1 = 0;
        let v2 = arg4;
        let v3 = 0;
        while (v3 < arg6) {
            ...
            let (v4, v5, v6) = scs<T0, T1>(arg0, v2, arg1, arg2);
            if (v6) {
                break
            };
            if (!pok(v5, arg3, arg1)) {
        ...
        while (v3 < arg7) {
            ...
            let v7 = (v1 + v2) / 2;
            let (v8, v9, v10) = scs<T0, T1>(arg0, v7, arg1, arg2);
    ...
    fun tt<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: &mut 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let (v3, v4, v5) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg3, arg0, arg6, true, v2, isp(arg5), arg4);
        let v6 = v5;
        let v7 = v4;
        let v8 = v3;
        ...
        let (v14, v15) = if (arg6) {
            (0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T0>(arg1, arg2, v9, arg12), 0x2::coin::zero<T1>(arg12))
        } else {
            (0x2::coin::zero<T0>(arg12), 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T1>(arg1, arg2, v9, arg12))
        };
        let v16 = v15;
        let v17 = v14;
        let (v18, v19) = if (arg6) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v17, v12, arg12)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v16, v13, arg12)))
        };
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg3, arg0, v18, v19, v6);
        0x2::coin::join<T0>(&mut v17, 0x2::coin::from_balance<T0>(v8, arg12));
        0x2::coin::join<T1>(&mut v16, 0x2::coin::from_balance<T1>(v7, arg12));
        0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::dp<T0>(arg1, arg2, v17, arg12);
        0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::dp<T1>(arg1, arg2, v16, arg12);
        (v9, v10)
    }
