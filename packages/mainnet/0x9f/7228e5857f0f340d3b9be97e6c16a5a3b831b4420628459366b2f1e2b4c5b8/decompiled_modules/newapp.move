module 0x2b5d7ef1f557f2924ba37ed92b6dccdebc4519b6f8987027bb0bb698a5e95680::newapp {
    ...
    public entry fun syn_stake<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u8, arg3: u8, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg3 == 1) {
            let v2 = &mut v0.stake_orders;
            del_and_syn_update_order(v2);
        };
        let v3 = &mut v0.stake_orders;
        if (!find_and_syn_update_order(v3, &v1)) {
            0x1::vector::push_back<StakeOrder>(&mut v0.stake_orders, v1);
        } else {
            destroy_stake_order(v1);
        };
    }
