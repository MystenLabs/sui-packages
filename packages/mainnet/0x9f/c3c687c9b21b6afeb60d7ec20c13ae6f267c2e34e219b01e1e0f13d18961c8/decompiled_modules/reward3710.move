module 0x9fc3c687c9b21b6afeb60d7ec20c13ae6f267c2e34e219b01e1e0f13d18961c8::reward3710 {
    struct REWARD3710 has drop {
        dummy_field: bool,
    }

    struct TICKET_3710 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3710(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3710>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3710>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3710, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3710>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3710>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3710>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3710>>(v5, 0x2::tx_context::sender(arg1));
    }
