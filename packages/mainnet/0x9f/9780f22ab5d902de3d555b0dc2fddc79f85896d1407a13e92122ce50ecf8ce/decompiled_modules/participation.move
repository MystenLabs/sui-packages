module 0x9f9780f22ab5d902de3d555b0dc2fddc79f85896d1407a13e92122ce50ecf8ce::participation {
    ...
    public(friend) fun process_end_of_day(arg0: &mut Participation, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        if (arg2 > 0) {
            ...
            if (arg0.stake >= arg3) {
                ...
                assert!(arg3 - arg0.stake <= 0x9f9780f22ab5d902de3d555b0dc2fddc79f85896d1407a13e92122ce50ecf8ce::constants::precision_error_allowance(), 5);
                arg0.stake = 0;
            };
        };
