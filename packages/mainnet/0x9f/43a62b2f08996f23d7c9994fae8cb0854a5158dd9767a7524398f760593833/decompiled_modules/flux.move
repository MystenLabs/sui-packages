module 0x9f43a62b2f08996f23d7c9994fae8cb0854a5158dd9767a7524398f760593833::flux {
    struct FLUX has drop {
        dummy_field: bool,
    }
    ...
    public entry fun burn(arg0: 0x2::coin::Coin<FLUX>, arg1: &mut 0x2::coin::TreasuryCap<FLUX>, arg2: &mut GlobalConfig, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<FLUX>(&arg0);
        assert!(v0 > 0, 9);
        arg2.total_supply = arg2.total_supply - v0;
        0x2::coin::burn<FLUX>(arg1, arg0);
        let v1 = TokensBurned{
    ...
    public entry fun mint(arg0: &MinterCap, arg1: &mut 0x2::coin::TreasuryCap<FLUX>, arg2: &mut GlobalConfig, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<FLUX>>(0x2::coin::mint<FLUX>(arg1, arg3, arg5), arg4);
        let v1 = TokensMinted{
    ...
    fun init(arg0: FLUX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FLUX>(arg0, 9, b"FLUX", b"Flux Zone", b"Core of Flux Zone. Innovative DeFi token on Sui Network for staking and cutting-edge features", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://ipfs.io/ipfs/bafkreiaog5tkmv2gfdtrgtazwcb3up4stev2teoot5gbvuooatt473qygu"))), arg1);
        let v2 = v0;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<FLUX>>(0x2::coin::mint<FLUX>(&mut v2, v6, arg1), 0x2::tx_context::sender(arg1));
        v5.total_supply = v6;
        let v7 = MinterCap{
            id        : 0x2::object::new(arg1),
            minter_id : 0x2::tx_context::sender(arg1),
        };
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<FLUX>>(v2, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::coin::CoinMetadata<FLUX>>(v1, 0x2::tx_context::sender(arg1));
