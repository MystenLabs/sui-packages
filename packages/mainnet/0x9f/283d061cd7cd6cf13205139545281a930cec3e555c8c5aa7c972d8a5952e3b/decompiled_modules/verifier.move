module 0x9f283d061cd7cd6cf13205139545281a930cec3e555c8c5aa7c972d8a5952e3b::verifier {
    ...
    struct Game has store, key {
        ...
        answers: 0x2::table::Table<UserQuest, Answer>,
    }

    struct UserQuest has copy, drop, store {
        user: address,
        quest: address,
    }
    ...
    public entry fun professor_create_game(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Game{
            ...
            answers           : 0x2::table::new<UserQuest, Answer>(arg0),
        };
    ...
    public entry fun professor_score_answer(arg0: &mut Quest, arg1: &mut Game, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        *0x1::vector::borrow_mut<u8>(&mut v7, 31) = 0;
        ...
        assert!(0x2::table::contains<UserQuest, Answer>(v6, v8), 3);
        let v9 = UserQuest{
            user  : arg2,
            quest : v5,
        };
        let v10 = 0x2::table::borrow<UserQuest, Answer>(v6, v9);
        assert!(unlock(arg3, arg4, arg5, v7, *v4, v10.student_aH_x, v10.student_aH_y), 4);
        let v11 = arg4 == v10.akP_x && arg5 == v10.akP_y;
        let v12 = &mut arg1.profiles;
        if (!0x2::table::contains<address, UserProfile>(v12, arg2)) {
            let v13 = UserProfile{
            ...
            0x2::table::add<address, UserProfile>(v12, arg2, v13);
        };
        let v14 = 0x2::table::borrow_mut<address, UserProfile>(v12, arg2);
        if (v11) {
            0x2::table::add<address, bool>(v3, arg2, true);
            v14.level = v14.level + *v1;
            0x1::vector::push_back<address>(&mut v14.answered_right, v5);
            if (v14.level == 1 || v14.level == 3 || v14.level == 7 || v14.level == 10) {
                ...
                let v16 = RewardNFT{
                    ...
                    url         : 0x2::url::new_unsafe(get_blob_from_number(v14.level)),
                    b36addr     : to_b36(0x2::object::uid_to_address(&v15)),
                    level       : v14.level,
                    game        : arg0.game,
                };
                0x2::transfer::transfer<RewardNFT>(v16, v10.student_address);
            };
        } else {
            if (!0x2::vec_map::contains<address, u64>(&v14.wrong_attempts, &v5)) {
                0x2::vec_map::insert<address, u64>(&mut v14.wrong_attempts, v5, 0);
            };
            let v17 = 0x2::vec_map::get_mut<address, u64>(&mut v14.wrong_attempts, &v5);
            *v17 = *v17 + 1;
        };
        let v18 = UserQuest{
            user  : arg2,
        ...
        0x2::table::remove<UserQuest, Answer>(v6, v18);
    }

    public entry fun student_answer_question(arg0: &mut Game, arg1: &mut Quest, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: &0x2::clock::Clock, arg11: &0x2::tx_context::TxContext) {
        let v0 = 0x2::object::uid_to_address(&arg1.id);
        let v1 = 0x2::tx_context::sender(arg11);
        let v2 = &mut arg1.game;
        let v3 = &mut arg1.professor_address;
        let v4 = &mut arg1.professor_kP_x;
        let v5 = &mut arg1.professor_kP_y;
        assert!(!0x2::table::contains<address, bool>(&mut arg1.winners, v1), 94411);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) > 1000000000 / 10000000, 7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, *v3);
        let v6 = UserQuest{
            user  : v1,
            quest : v0,
        };
        let v7 = !0x2::table::contains<UserQuest, Answer>(&arg0.answers, v6);
        assert!(v7, 3);
        let v8 = 0x2::address::to_bytes(v1);
        *0x1::vector::borrow_mut<u8>(&mut v8, 31) = 0;
        0x1::debug::print<vector<u8>>(&v8);
        assert!(commit(arg3, arg4, arg5, arg6, v8), 8);
        assert!(unlock(arg7, arg8, arg9, v8, arg4, *v4, *v5), 5);
        let v9 = 0x2::clock::timestamp_ms(arg10);
        let v10 = Answer{
            quest              : 0x2::object::uid_to_address(&arg1.id),
            student_a_hash     : arg4,
            student_aH_x       : arg5,
            student_aH_y       : arg6,
            timestamp_answered : v9,
            student_address    : v1,
            akP_x              : arg8,
            akP_y              : arg9,
        };
        if (v7) {
            ...
            0x2::table::add<UserQuest, Answer>(&mut arg0.answers, v11, v10);
        };
        let v12 = StudentAnsweredEvent{
            game_id            : *v2,
            question_id        : 0x2::object::uid_to_address(&arg1.id),
            timestamp_answered : v9,
            student_address    : v1,
            akP_x              : arg8,
            akP_y              : arg9,
        ...
        0x2::event::emit<StudentAnsweredEvent>(v12);
    }
