module 0x9fc25b53c61ddbc0ff9b9c956ff6a2672e5039a14cb26abbba29003dec05b37e::acl {
    struct Zgsqeqoclmtnrjk has key {
        id: 0x2::object::UID,
        coombuckets: 0x2::table::Table<0x1::ascii::String, Hpvuspgnkxrzddb>,
    }

    struct Hpvuspgnkxrzddb has store {
        coomer: address,
        zoomer: address,
        cooming: bool,
    ...
    public entry fun ahwbqshaegbclmb(arg0: &mut Zgsqeqoclmtnrjk, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x1::ascii::String, Hpvuspgnkxrzddb>(&arg0.coombuckets, arg1)) {
            let v4 = 0x2::table::borrow_mut<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg0.coombuckets, arg1);
            ...
            0x2::table::add<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg0.coombuckets, arg1, v5);
        };
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Zgsqeqoclmtnrjk{
            id          : 0x2::object::new(arg0),
            coombuckets : 0x2::table::new<0x1::ascii::String, Hpvuspgnkxrzddb>(arg0),
        };
        0x2::transfer::share_object<Zgsqeqoclmtnrjk>(v0);
    }

    public entry fun mhdhtnnwzaljhkj<T0>(arg0: &mut Zgsqeqoclmtnrjk, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hpvuspgnkxrzddb>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun njucfhvdbcvfdki(arg0: &mut Zgsqeqoclmtnrjk, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hpvuspgnkxrzddb>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun obmuzyskgntqbbe<T0: store + key>(arg0: &mut Zgsqeqoclmtnrjk, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hpvuspgnkxrzddb>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg0.coombuckets, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.zoomer, 0);
    ...
    public entry fun tutcdwyssvxphfb(arg0: &mut Zgsqeqoclmtnrjk, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hpvuspgnkxrzddb>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun xlbxpqxrxmywihq(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Zgsqeqoclmtnrjk, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hpvuspgnkxrzddb>(&arg2.coombuckets, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg2.coombuckets, arg3);
        if (v0.cooming) {
            assert!(0x1::option::is_some<Reserve>(&v0.coomtails), 1);
    ...
    public entry fun xveryberglqomiv(arg0: &mut Zgsqeqoclmtnrjk, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Hpvuspgnkxrzddb{
        ...
        0x2::table::add<0x1::ascii::String, Hpvuspgnkxrzddb>(&mut arg0.coombuckets, arg1, v0);
    }
