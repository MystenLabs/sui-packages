module 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::staking_factory {
    ...
    struct StakingFactory<phantom T0, phantom T1, phantom T2> has store, key {
        id: 0x2::object::UID,
        access_control: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::AccessControl<FactoryTag<T0, T1, T2>>,
        normal_pool: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::Pool<T0, T1>,
        boosted_pool: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::Pool<T0, T2>,
        normal_admin: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::AdminCap,
        boosted_admin: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::AdminCap,
        max_eps_normal: u64,
        max_eps_boosted: u64,
        ...
        base_apr_bps: u64,
        boost_delta_bps: u64,
        lk_token_auth: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::treasury::ToCoinCap<T2>,
    }
    ...
    struct OpenPosition<phantom T0> has store, key {
        ...
        shares: u64,
        unlock_ts: u64,
        pos: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::accumulation_distributor::Position,
    }
    ...
    public fun pause<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &mut 0x2::tx_context::TxContext) {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::pause<FactoryTag<T0, T1, T2>>(&mut arg0.access_control, arg1);
    }

    public fun unpause<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &mut 0x2::tx_context::TxContext) {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::unpause<FactoryTag<T0, T1, T2>>(&mut arg0.access_control, arg1);
    }
    ...
    fun assert_owner<T0, T1, T2>(arg0: &StakingFactory<T0, T1, T2>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::roles::is_owner<FactoryTag<T0, T1, T2>>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::roles<FactoryTag<T0, T1, T2>>(&arg0.access_control), 0x2::tx_context::sender(arg1)), 5);
    }

    public fun change_owner<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::update_owner<FactoryTag<T0, T1, T2>>(&mut arg0.access_control, arg1, arg2);
    }

    public fun change_pauser<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::update_pauser<FactoryTag<T0, T1, T2>>(&mut arg0.access_control, arg1, arg2);
    }
    ...
    public(friend) fun claim_internal<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &mut OpenPosition<T1>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::assert_not_paused<FactoryTag<T0, T1, T2>>(&arg0.access_control);
        0x2::coin::from_balance<T0>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::claim_all<T0, T1>(&mut arg0.normal_pool, &mut arg1.pos), arg2)
    }
    ...
    public fun claim_locked_internal<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &mut OpenPosition<T2>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::assert_not_paused<FactoryTag<T0, T1, T2>>(&arg0.access_control);
        0x2::coin::from_balance<T0>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::claim_all<T0, T2>(&mut arg0.boosted_pool, &mut arg1.pos), arg2)
    }
    ...
    public fun destroy_position<T0>(arg0: OpenPosition<T0>) {
        ...
        assert!(v2 == 0, 1);
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::accumulation_distributor::position_destroy_empty(v4);
    ...
    fun fund_and_poke_boosted<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        let v0 = 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::pre_accrue_need<T0, T2>(&arg0.boosted_pool, 0x2::clock::timestamp_ms(arg1) / 1000);
        if (v0 > 0) {
            assert!(v0 <= 0x2::balance::value<T0>(&arg0.reserve_r), 3);
            0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::fund_reserve<T0, T2>(&mut arg0.boosted_pool, 0x2::balance::split<T0>(&mut arg0.reserve_r, v0));
        };
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::poke<T0, T2>(&mut arg0.boosted_pool, arg1);
    }

    fun fund_and_poke_normal<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &0x2::clock::Clock) {
        let v0 = 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::pre_accrue_need<T0, T1>(&arg0.normal_pool, 0x2::clock::timestamp_ms(arg1) / 1000);
        if (v0 > 0) {
            assert!(v0 <= 0x2::balance::value<T0>(&arg0.reserve_r), 3);
            0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::fund_reserve<T0, T1>(&mut arg0.normal_pool, 0x2::balance::split<T0>(&mut arg0.reserve_r, v0));
        };
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::poke<T0, T1>(&mut arg0.normal_pool, arg1);
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public fun launch_with_boosted<T0, T1, T2>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::treasury::ToCoinCap<T2>, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::create<T0, T1>(arg0, arg2, arg7);
        let (v2, v3) = 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::create<T0, T2>(arg0 + arg1, arg3, arg7);
        let v4 = StakingFactory<T0, T1, T2>{
            id                : 0x2::object::new(arg7),
            access_control    : 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::new<FactoryTag<T0, T1, T2>>(0x2::tx_context::sender(arg7), 0x2::tx_context::sender(arg7), arg7),
            normal_pool       : v0,
            boosted_pool      : v2,
            normal_admin      : v1,
            boosted_admin     : v3,
    ...
    public(friend) fun request_unstake_internal<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &mut OpenPosition<T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : UnbondingTicket<T1> {
        ...
        UnbondingTicket<T1>{
            ...
            escrow    : 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::withdraw_shares<T0, T1>(&mut arg0.normal_pool, &mut arg1.pos, arg2, arg3),
        }
    }
    ...
    public(friend) fun request_unstake_locked_internal<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &mut OpenPosition<T2>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : UnbondingTicket<T2> {
        ...
        UnbondingTicket<T2>{
            ...
            tier      : arg1.tier,
            unlock_ts : v0,
            escrow    : 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::withdraw_shares<T0, T2>(&mut arg0.boosted_pool, &mut arg1.pos, arg2, arg3),
        }
    }
    ...
    public(friend) fun stake_internal<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : OpenPosition<T1> {
        ...
        OpenPosition<T1>{
            ...
            shares    : v1,
            unlock_ts : 0,
            pos       : 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::deposit_new<T0, T1>(&mut arg0.normal_pool, v0, arg2),
        }
    }

    public fun stake_locked<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::treasury::Treasury<T2>, arg2: 0x2::token::Token<T2>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::treasury::to_coin<T2>(arg1, &arg0.lk_token_auth, arg2, arg4);
    ...
    public(friend) fun stake_locked_internal<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: 0x2::coin::Coin<T2>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : OpenPosition<T2> {
        ...
        OpenPosition<T2>{
            ...
            pos       : 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::deposit_new<T0, T2>(&mut arg0.boosted_pool, v0, arg2),
        }
    }
    ...
    public fun stake_more<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &mut OpenPosition<T1>, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::balance::value<T1>(&v0);
        assert!(v1 > 0, 1);
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::deposit_more<T0, T1>(&mut arg0.normal_pool, &mut arg1.pos, v0, arg3);
    ...
    public fun stake_more_locked<T0, T1, T2>(arg0: &mut StakingFactory<T0, T1, T2>, arg1: &0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::treasury::Treasury<T2>, arg2: &mut OpenPosition<T2>, arg3: 0x2::token::Token<T2>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::access_control::assert_not_paused<FactoryTag<T0, T1, T2>>(&arg0.access_control);
        assert!(arg2.tier == 1, 4);
        fund_and_poke_boosted<T0, T1, T2>(arg0, arg4);
        let v0 = 0x2::coin::into_balance<T2>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::treasury::to_coin<T2>(arg1, &arg0.lk_token_auth, arg3, arg5));
        let v1 = 0x2::balance::value<T2>(&v0);
        assert!(v1 > 0, 1);
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::apr_pool::deposit_more<T0, T2>(&mut arg0.boosted_pool, &mut arg2.pos, v0, arg4);
