module 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::treasury {
    ...
    struct Treasury<phantom T0> has store, key {
        id: 0x2::object::UID,
        roles: 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::Roles<T0>,
    ...
    public fun new<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::token::TokenPolicyCap<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : Treasury<T0> {
        let v0 = Treasury<T0>{
            ...
            roles                 : 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::new<T0>(arg2, arg3),
            active_authorizations : 0x2::table::new<0x2::object::ID, bool>(arg3),
            compatible_versions   : 0x2::vec_set::singleton<u64>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::token_version_control::current_version()),
        };
    ...
    public fun abort_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        0xe0917b74a5912e4ad186ac634e29c922ab83903f71af7500969f9411706f9b9a::two_step_role::assert_sender_is_active_role<0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::OwnerRole<T0>>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::owner_role<T0>(&arg0.roles), arg1);
        ...
        assert!(v0 == 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::token_version_control::current_version(), 6);
    ...
    public fun accept_ownership<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::pending_owner<T0>(&arg0.roles);
        ...
        assert!(v1, 1);
        0xe0917b74a5912e4ad186ac634e29c922ab83903f71af7500969f9411706f9b9a::two_step_role::accept_role<0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::OwnerRole<T0>>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::owner_role_mut<T0>(&mut arg0.roles), arg1);
    }
    ...
    public(friend) fun assert_is_compatible<T0>(arg0: &Treasury<T0>) {
        0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::token_version_control::assert_object_version_is_compatible_with_package(arg0.compatible_versions);
    }
    ...
    public fun complete_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::u64::max(v0, v1) == 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::token_version_control::current_version(), 6);
    ...
    fun create_from_coin_cap<T0>(arg0: &mut Treasury<T0>, arg1: &mut 0x2::tx_context::TxContext) : FromCoinCap<T0> {
        assert!(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::owner<T0>(&arg0.roles) == 0x2::tx_context::sender(arg1), 1);
    ...
    public fun mint_coin_to_receiver<T0>(arg0: &mut Treasury<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::owner<T0>(&arg0.roles) == 0x2::tx_context::sender(arg3), 1);
    ...
    public fun revoke_authorization<T0>(arg0: &mut Treasury<T0>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::owner<T0>(&arg0.roles) == 0x2::tx_context::sender(arg2), 1);
    ...
    public fun start_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(*0x1::vector::borrow<u64>(0x2::vec_set::keys<u64>(&arg0.compatible_versions), 0) < 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::token_version_control::current_version(), 5);
        0x2::vec_set::insert<u64>(&mut arg0.compatible_versions, 0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::token_version_control::current_version());
    ...
    public fun transfer_ownership<T0>(arg0: &mut Treasury<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert!(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::owner<T0>(&arg0.roles) == 0x2::tx_context::sender(arg2), 1);
        0xe0917b74a5912e4ad186ac634e29c922ab83903f71af7500969f9411706f9b9a::two_step_role::begin_role_transfer<0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::OwnerRole<T0>>(0x9fff8d2936c3536148fe61b49e42ba885d7b38c822a779dc33e0c408fa725693::lk_roles::owner_role_mut<T0>(&mut arg0.roles), arg1, arg2);
    }
