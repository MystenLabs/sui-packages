module 0x9fdfe5df1b2f4baacc49dae9f398ccece8cbf4a29774286601088989447df4f9::bonkman {
    struct BONKMAN has drop {
        dummy_field: bool,
    }

    fun init(arg0: BONKMAN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BONKMAN>(arg0, 6, b"BONKMAN", b"Bonkman", b"Creator of Hop.fun", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/OHI4WnQ.jpeg")), arg1);
