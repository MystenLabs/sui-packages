module 0x9fd90cb674a7d9fb45b080a4923b254a914c8fb8530e582e690dade9bc8fc57b::reward1235 {
    struct REWARD1235 has drop {
        dummy_field: bool,
    }

    struct TICKET_1235 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1235(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1235>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1235>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1235>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1235>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1235>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1235>>(v5, 0x2::tx_context::sender(arg1));
    }
