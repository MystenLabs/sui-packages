module 0x9f94ecf82582eb320e3fef8a75f2ca8db2c822f6c34f9ae459c0c343eef0e06a::lottery_ticket {
    ...
    public(friend) fun getTicket(arg0: &mut TicketPool, arg1: u64, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) : Ticket {
        ...
        let v1 = if (0x2::table_vec::length<Ticket>(v0) == 1) {
            0x2::table_vec::pop_back<Ticket>(&mut arg0.tickets)
        } else {
            let v2 = 0x2::random::new_generator(arg2, arg3);
            0x2::table_vec::swap_remove<Ticket>(v0, 0x2::random::generate_u64_in_range(&mut v2, 0, 0x2::table_vec::length<Ticket>(v0) - 1))
        };
        let v3 = v1;
        v3.pool_no = arg1;
        v3.is_in_pool = true;
