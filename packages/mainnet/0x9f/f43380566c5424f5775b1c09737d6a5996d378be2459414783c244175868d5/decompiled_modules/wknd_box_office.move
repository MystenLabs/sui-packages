module 0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::wknd_box_office {
    ...
    public fun add_movie(arg0: &mut 0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::MogulCentral, arg1: &mut WeekendBoxOffice, arg2: u128, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_version_package(arg0);
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_manager_package(arg0, 0x2::tx_context::sender(arg6));
        let v0 = MovieData{
            imdb_id              : arg3,
            title                : arg4,
            genre                : arg5,
    ...
    public fun add_prediction(arg0: &mut 0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::MogulCentral, arg1: &mut WeekendBoxOffice, arg2: u128, arg3: u128, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_version_package(arg0);
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_manager_package(arg0, 0x2::tx_context::sender(arg9));
    ...
    public fun add_tickets(arg0: &mut 0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::MogulCentral, arg1: &mut WeekendBoxOffice, arg2: &mut 0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::ticket::TicketRegistry, arg3: u64, arg4: u64, arg5: u128, arg6: u128, arg7: u64, arg8: 0x1::string::String, arg9: address, arg10: &mut 0x2::tx_context::TxContext) {
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_version_package(arg0);
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_manager_package(arg0, 0x2::tx_context::sender(arg10));
        ...
        while (v3 < 0x1::vector::length<FinalizedWeekData>(v2)) {
            if (arg7 == 0x1::vector::borrow<FinalizedWeekData>(v2, v3).week) {
                ...
                0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::ticket::give_ticket<TicketData>(arg2, arg0, arg3, 0x1::string::utf8(b"wknd_box_office"), v6, arg4, arg9, arg10);
                return
            };
            v3 = v3 + 1;
        };
    ...
    public fun create_weekend_box_office(arg0: &mut 0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::MogulCentral, arg1: &mut 0x2::tx_context::TxContext) {
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_version_package(arg0);
    ...
    public fun finalize_week_data(arg0: &mut 0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::MogulCentral, arg1: &mut WeekendBoxOffice, arg2: u128, arg3: u64, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_version_package(arg0);
        0x9ff43380566c5424f5775b1c09737d6a5996d378be2459414783c244175868d5::mogul::assert_valid_manager_package(arg0, 0x2::tx_context::sender(arg7));
