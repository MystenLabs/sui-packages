module 0x9f6de0f9c1333cecfafed4fd51ecf445d237a6295bd6ae88754821c8f8189789::campaign {
    ...
    struct WhitelistRemovedEvent has copy, drop {
        user: address,
        removed_at: u64,
    }
    ...
    public entry fun batch_remove_whitelist(arg0: &Campaign, arg1: vector<UserWhitelist>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg3), 100);
        while (!0x1::vector::is_empty<UserWhitelist>(&arg1)) {
            let v0 = 0x1::vector::pop_back<UserWhitelist>(&mut arg1);
            let v1 = WhitelistRemovedEvent{
                user       : v0.user,
                removed_at : 0x2::clock::timestamp_ms(arg2),
            };
            0x2::event::emit<WhitelistRemovedEvent>(v1);
            let UserWhitelist {
                id             : v2,
                user           : _,
                permission     : _,
        ...
        0x1::vector::destroy_empty<UserWhitelist>(arg1);
    }
    ...
    public entry fun remove_whitelist(arg0: &Campaign, arg1: UserWhitelist, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg3), 100);
        assert!(arg1.referees_count == 0, 2);
        assert!(!arg1.is_referee, 3);
        let v0 = WhitelistRemovedEvent{
            user       : arg1.user,
            removed_at : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<WhitelistRemovedEvent>(v0);
        let UserWhitelist {
            id             : v1,
            user           : _,
            permission     : _,
