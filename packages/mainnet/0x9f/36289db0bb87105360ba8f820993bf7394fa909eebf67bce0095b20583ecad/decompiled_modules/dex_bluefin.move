module 0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::dex_bluefin {
    ...
    fun call_bluefin_multidex_swap(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = BluefinSwapExecuted{
            ...
            min_amount_out : arg1,
            pool_id        : 0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::constants::bluefin_sui_usdc_pool(),
    ...
    public fun get_pool_config() : (address, address, u128) {
        (0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::constants::bluefin_sui_usdc_pool(), 0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::constants::bluefin_global_config(), 0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::constants::bluefin_sqrt_price_limit())
    }
    ...
    public entry fun swap_sui_to_usdc_gateway(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        call_bluefin_gateway_swap_assets(arg0, 0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::constants::bluefin_global_config(), 0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::constants::bluefin_sui_usdc_pool(), arg1, true, true, v0, arg2, 0x9f36289db0bb87105360ba8f820993bf7394fa909eebf67bce0095b20583ecad::constants::bluefin_sqrt_price_limit(), arg3);
    }
