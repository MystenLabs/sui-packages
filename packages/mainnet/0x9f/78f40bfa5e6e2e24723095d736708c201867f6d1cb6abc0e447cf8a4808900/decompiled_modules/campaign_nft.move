module 0x9f78f40bfa5e6e2e24723095d736708c201867f6d1cb6abc0e447cf8a4808900::campaign_nft {
    ...
    public fun add_whitelist(arg0: &mut CampaignConfig, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = AddWhiteListEvent{
            campaign_id : 0x2::object::id<CampaignConfig>(arg0),
            users       : arg1,
        };
    ...
    public fun pause(arg0: &AdminCap, arg1: &mut CampaignConfig, arg2: bool) {
        ...
        let v0 = StartPauseEvent{
            campaign_id : 0x2::object::id<CampaignConfig>(arg1),
            paused      : arg2,
        };
    ...
    fun setup_nft_display(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : 0x2::display::Display<CampaignNFT> {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://assets.thebirds.ai/nfts/quest-hub/seafi/{gen-id}.json"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://assets.thebirds.ai/nfts/quest-hub/seafi/{gen-id}.png"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://assets.thebirds.ai/nfts/birds/quest-hub/seafi/{gen-id}-thumbnail.jpg"));
    ...
    public fun update_name(arg0: &AdminCap, arg1: &mut CampaignConfig, arg2: vector<u8>) {
        assert!(arg1.version == 1, 1002);
