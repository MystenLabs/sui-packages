module 0x9f5a865eac3cc69bccf2bb49cf4bb110d7813d9ce48b40dba9f58e2bf7007740::reward3786 {
    struct REWARD3786 has drop {
        dummy_field: bool,
    }

    struct TICKET_3786 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3786(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3786>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3786>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3786, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3786>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3786>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3786>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3786>>(v5, 0x2::tx_context::sender(arg1));
    }
