module 0x9f682917d643161ed32499340b2bac1587fb2cdbb64b147949a4fe59da547fb9::cnsnft4410 {
    struct CNSNFT4410 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4410, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4410>(arg0, arg1);
