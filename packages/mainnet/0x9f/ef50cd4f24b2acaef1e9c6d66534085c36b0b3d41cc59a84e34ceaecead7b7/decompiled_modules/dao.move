module 0x9fef50cd4f24b2acaef1e9c6d66534085c36b0b3d41cc59a84e34ceaecead7b7::dao {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x9fef50cd4f24b2acaef1e9c6d66534085c36b0b3d41cc59a84e34ceaecead7b7::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0x9fef50cd4f24b2acaef1e9c6d66534085c36b0b3d41cc59a84e34ceaecead7b7::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x9fef50cd4f24b2acaef1e9c6d66534085c36b0b3d41cc59a84e34ceaecead7b7::dao_config::set_platform_fee(arg1, arg2, arg3, arg4);
    }
    ...
    public entry fun start_allowance<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 1014);
        let v1 = 0;
        while (v1 < v0) {
