module 0x9ffd7032f8e38bbff070a74ba59970197a8ecf9513365b795029776ca2d1ab09::cnsnft2379 {
    struct CNSNFT2379 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2379, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2379>(arg0, arg1);
