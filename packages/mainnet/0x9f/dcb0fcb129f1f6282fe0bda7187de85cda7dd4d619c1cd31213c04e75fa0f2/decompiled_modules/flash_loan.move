module 0x9fdcb0fcb129f1f6282fe0bda7187de85cda7dd4d619c1cd31213c04e75fa0f2::flash_loan {
    ...
    public entry fun initialize_contract(arg0: &mut 0x2::tx_context::TxContext) {
    ...
    public fun repay(arg0: &mut FlashLender, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: Receipt, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(0x2::object::id<FlashLender>(arg0) == arg2.flash_lender_id, 1002);
        assert!(v0 >= arg2.repay_amount, 1001);
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.to_lend, arg1);
        0x2::coin::take<0x2::sui::SUI>(&mut arg0.to_lend, v0 - arg2.repay_amount, arg3)
    }
