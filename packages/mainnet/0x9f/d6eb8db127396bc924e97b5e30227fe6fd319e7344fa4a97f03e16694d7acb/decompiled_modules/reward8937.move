module 0x9fd6eb8db127396bc924e97b5e30227fe6fd319e7344fa4a97f03e16694d7acb::reward8937 {
    struct REWARD8937 has drop {
        dummy_field: bool,
    }

    struct TICKET_8937 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8937(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8937>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8937>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8937, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8937>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8937>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8937>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8937>>(v5, 0x2::tx_context::sender(arg1));
    }
