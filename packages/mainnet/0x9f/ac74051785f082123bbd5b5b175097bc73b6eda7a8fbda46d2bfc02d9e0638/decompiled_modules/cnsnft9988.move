module 0x9fac74051785f082123bbd5b5b175097bc73b6eda7a8fbda46d2bfc02d9e0638::cnsnft9988 {
    struct CNSNFT9988 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9988, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9988>(arg0, arg1);
