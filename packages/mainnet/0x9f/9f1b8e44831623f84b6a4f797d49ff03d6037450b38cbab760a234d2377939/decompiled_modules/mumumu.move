module 0x9f9f1b8e44831623f84b6a4f797d49ff03d6037450b38cbab760a234d2377939::mumumu {
    ...
    struct TransferPolicyManager has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun airdrop(arg0: &mut Mumumu, arg1: address, arg2: u64, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        mint_nft(arg0, arg1, arg2, arg3, arg4, arg5);
    }
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Mumumu v9 #{token_id}"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"{description}"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"{image_base}"));
        ...
        let v9 = v8;
        let v10 = v7;
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<NFT>(&mut v10, &v9, 1000, 0);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<NFT>(&mut v10, &v9);
        let v11 = TransferPolicyManager{
            id                  : 0x2::object::new(arg1),
            display             : v6,
            policy              : v10,
            transfer_policy_cap : v9,
            balance             : 0x2::balance::zero<0x2::sui::SUI>(),
        };
        0x2::transfer::share_object<TransferPolicyManager>(v11);
        ...
        let v12 = Mumumu{
            ...
            image_base          : 0x1::string::utf8(b"https://storage.googleapis.com/mmp-demo/sui/2.png"),
            character_types     : 0x2::table::new<u64, 0x1::string::String>(arg1),
        };
        0x2::transfer::share_object<Mumumu>(v12);
    }
    ...
    public entry fun mint(arg0: &mut Mumumu, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        mint_nft(arg0, v0, arg1, arg3, arg4, arg5);
    ...
    fun mint_nft(arg0: &mut Mumumu, arg1: address, arg2: u64, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < arg2) {
            ...
            0x2::kiosk::place<NFT>(arg3, arg4, v2);
            v0 = v0 + 1;
        };
    }
    ...
    public entry fun place_nft_in_kiosk(arg0: NFT, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == 0x2::kiosk::owner(arg1), 9);
        0x2::kiosk::place<NFT>(arg1, arg2, arg0);
    }
    ...
    public entry fun purchase_token(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::transfer_policy::TransferPolicy<NFT>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<NFT>(&mut v2, &v6);
    ...
    public entry fun update_royalty_fee(arg0: &mut TransferPolicyManager, arg1: &Mumumu, arg2: u16, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg1.admin, 0);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<NFT>(&mut arg0.policy, &arg0.transfer_policy_cap, arg2, arg3);
    }

    public entry fun withdraw_balance(arg0: &mut TransferPolicyManager, arg1: &Mumumu, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg1.admin, 0);
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg0.balance);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.balance, v0), arg2), arg1.treasury);
        };
    }
