module 0x9f1105f1c9d0120a50f154525ee4cbc3ac4387ee6fa078613139e76f2bbe78a4::pool_events {
    ...
    public(friend) fun emit_claim_admin_fees<T0>(arg0: u64) {
        let v0 = ClaimAdminFees<0x9f1105f1c9d0120a50f154525ee4cbc3ac4387ee6fa078613139e76f2bbe78a4::curves::Volatile, T0>{amount: arg0};
        0x2::event::emit<ClaimAdminFees<0x9f1105f1c9d0120a50f154525ee4cbc3ac4387ee6fa078613139e76f2bbe78a4::curves::Volatile, T0>>(v0);
    }
    ...
    public(friend) fun emit_new_2_pool<T0, T1, T2, T3>(arg0: address, arg1: address) {
        let v0 = New2Pool<T0, T1, T2, T3>{
            pool  : arg0,
            state : arg1,
        };
    ...
    public(friend) fun emit_new_3_pool<T0, T1, T2, T3, T4>(arg0: address, arg1: address) {
        let v0 = New3Pool<T0, T1, T2, T3, T4>{
            pool  : arg0,
            state : arg1,
        };
    ...
    public(friend) fun emit_new_4_pool<T0, T1, T2, T3, T4, T5>(arg0: address, arg1: address) {
        let v0 = New4Pool<T0, T1, T2, T3, T4, T5>{
            pool  : arg0,
            state : arg1,
        };
    ...
    public(friend) fun emit_new_5_pool<T0, T1, T2, T3, T4, T5, T6>(arg0: address, arg1: address) {
        let v0 = New5Pool<T0, T1, T2, T3, T4, T5, T6>{
            pool  : arg0,
            state : arg1,
        };
