module 0x9f0d3657fda032a7c00ecce66ae107ac10da2ca465e05388b24417f862c6e79b::dca_order {
    ...
    public fun fill_dca_order<T0, T1>(arg0: &0x9f0d3657fda032a7c00ecce66ae107ac10da2ca465e05388b24417f862c6e79b::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: DcaOrderPrefill, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun place_dca_order<T0, T1>(arg0: &mut 0x9f0d3657fda032a7c00ecce66ae107ac10da2ca465e05388b24417f862c6e79b::config::GlobalReserve, arg1: vector<0x2::coin::Coin<T0>>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun prefill_dca_order<T0, T1>(arg0: &0x9f0d3657fda032a7c00ecce66ae107ac10da2ca465e05388b24417f862c6e79b::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, DcaOrderPrefill) {
        assert!(0x9f0d3657fda032a7c00ecce66ae107ac10da2ca465e05388b24417f862c6e79b::config::is_admin(arg0, 0x2::tx_context::sender(arg2)) == true, 4);
