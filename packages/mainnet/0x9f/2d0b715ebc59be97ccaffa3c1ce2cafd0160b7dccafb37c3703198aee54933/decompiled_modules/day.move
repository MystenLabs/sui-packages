module 0x425980cb460145b83397586891239f7d570c8a6897581469486225ad06d0a4ef::day {
    ...
    struct StrategyFactoryAnchorKey has copy, drop, store {
        dummy_field: bool,
    }

    struct StrategyFactoryAnchor has copy, drop, store {
    ...
    public(friend) fun anchor_strategy_factory(arg0: &mut ProtocolConfig, arg1: 0x2::object::ID) {
        assert!(!strategy_factory_bootstrapped(arg0), 7);
        let v0 = StrategyFactoryAnchorKey{dummy_field: false};
        let v1 = StrategyFactoryAnchor{factory_id: arg1};
        0x2::dynamic_field::add<StrategyFactoryAnchorKey, StrategyFactoryAnchor>(&mut arg0.id, v0, v1);
    }
    ...
    public(friend) fun assert_canonical_strategy_factory_binding(arg0: &ProtocolConfig, arg1: 0x2::object::ID) {
        assert!(strategy_factory_bootstrapped(arg0), 8);
        let v0 = StrategyFactoryAnchorKey{dummy_field: false};
        assert!(0x2::dynamic_field::borrow<StrategyFactoryAnchorKey, StrategyFactoryAnchor>(&arg0.id, v0).factory_id == arg1, 8);
    }
    ...
    public fun canonical_strategy_factory_id(arg0: &ProtocolConfig) : 0x1::option::Option<0x2::object::ID> {
        if (!strategy_factory_bootstrapped(arg0)) {
            return 0x1::option::none<0x2::object::ID>()
        };
        let v0 = StrategyFactoryAnchorKey{dummy_field: false};
        0x1::option::some<0x2::object::ID>(0x2::dynamic_field::borrow<StrategyFactoryAnchorKey, StrategyFactoryAnchor>(&arg0.id, v0).factory_id)
    }
    ...
    public(friend) fun strategy_factory_bootstrapped(arg0: &ProtocolConfig) : bool {
        let v0 = StrategyFactoryAnchorKey{dummy_field: false};
        0x2::dynamic_field::exists<StrategyFactoryAnchorKey>(&arg0.id, v0)
    }
