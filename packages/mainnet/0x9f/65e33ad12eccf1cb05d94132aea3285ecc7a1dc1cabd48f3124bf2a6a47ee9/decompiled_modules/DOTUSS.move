module 0x9f65e33ad12eccf1cb05d94132aea3285ecc7a1dc1cabd48f3124bf2a6a47ee9::DOTUSS {
    ...
    fun init(arg0: DOTUSS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DOTUSS>(arg0, 9, b"DOTUSS", b"DOGE CETUS", b"First Doge on DOTUS DAPPS join us  @dogecetus  ", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmQuFgSXCac4K2BgckEwLsix2pXU7i2mnPqeYiZ8V2UYjS?_gl=1*pw85y3*rs_ga*NGMxYTE0YzUtNjg3OS00MTMxLThhM2EtMGZiMjljNzQ2OWYz*rs_ga_5RMPXG14TE*MTY4MzcxMDMxMy40LjEuMTY4MzcxMDY0Mi42MC4wLjA.")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<DOTUSS>(&mut v2, 10000000000000, v3, arg1);
