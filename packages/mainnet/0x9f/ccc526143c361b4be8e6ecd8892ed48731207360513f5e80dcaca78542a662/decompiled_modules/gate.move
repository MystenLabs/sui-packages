module 0xd7a2b43235459be0a72b2a7ae83a22d8b1437bd254a443a579d1237839af6e7f::gate {
    ...
    public fun hot_account_state_batch(arg0: &0x2::clock::Clock, arg1: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: address, arg4: vector<address>, arg5: bool) : (vector<u256>, vector<bool>, vector<vector<u8>>, vector<vector<u8>>, vector<u256>, vector<u256>, vector<bool>, vector<u64>, vector<vector<u8>>, vector<vector<u256>>, vector<vector<u256>>, vector<vector<u256>>, vector<vector<u256>>) {
        ...
        let v16 = vector[];
        let v17 = 0;
        while (v17 < 0x1::vector::length<address>(&arg4)) {
            let v18 = *0x1::vector::borrow<address>(&arg4, v17);
            let v19 = *0x1::vector::borrow<u256>(&v11, v17) <= 1000000000000000000000000000 && *0x1::vector::borrow<bool>(&v10, v17);
            let v20 = b"";
            if (v19) {
                let v21 = 0x1::vector::borrow<vector<u8>>(&v9, v17);
                let v22 = 0;
                while (v22 < 0x1::vector::length<u8>(v21)) {
                    0x1::vector::push_back<u8>(&mut v20, *0x1::vector::borrow<u8>(v21, v22));
                    v22 = v22 + 1;
                };
                let v23 = 0x1::vector::borrow<vector<u8>>(&v8, v17);
                v22 = 0;
                while (v22 < 0x1::vector::length<u8>(v23)) {
                    let v24 = *0x1::vector::borrow<u8>(v23, v22);
                    if (!0x1::vector::contains<u8>(&v20, &v24)) {
                        0x1::vector::push_back<u8>(&mut v20, v24);
                    };
                    v22 = v22 + 1;
                };
            };
            ...
            let v28 = vector[];
            let v29 = 0;
            while (v29 < 0x1::vector::length<u8>(&v20)) {
                let v30 = *0x1::vector::borrow<u8>(&v20, v29);
                let (v31, v32) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_balance(arg2, v30, v18);
                0x1::vector::push_back<u256>(&mut v25, v31);
                0x1::vector::push_back<u256>(&mut v26, v32);
                0x1::vector::push_back<u256>(&mut v27, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_collateral_balance(arg2, v30, v18));
                0x1::vector::push_back<u256>(&mut v28, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_balance(arg2, v30, v18));
                v29 = v29 + 1;
            };
            0x1::vector::push_back<vector<u8>>(&mut v12, v20);
            0x1::vector::push_back<vector<u256>>(&mut v13, v25);
            0x1::vector::push_back<vector<u256>>(&mut v14, v26);
            0x1::vector::push_back<vector<u256>>(&mut v15, v27);
            0x1::vector::push_back<vector<u256>>(&mut v16, v28);
            v17 = v17 + 1;
        };
        (v11, v10, v9, v8, v4, v5, v6, v7, v12, v13, v14, v15, v16)
    }
