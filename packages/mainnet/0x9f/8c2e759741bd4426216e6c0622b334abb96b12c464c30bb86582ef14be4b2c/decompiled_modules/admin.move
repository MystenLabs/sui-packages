module 0x9f8c2e759741bd4426216e6c0622b334abb96b12c464c30bb86582ef14be4b2c::admin {
    ...
    public entry fun accept_reward(arg0: &ContractPublisher, arg1: &mut RewardPool, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>>(&mut arg1.id, 0x1::string::utf8(b"dummy"), 0x2::transfer::public_receive<0x2::coin::Coin<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>>(&mut arg1.id, arg2));
    }
    ...
    public(friend) fun get_mutable_reference_to_reward_balance(arg0: &mut RewardPool) : &mut 0x2::balance::Balance<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY> {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"dummy")), 1002);
        0x2::coin::balance_mut<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>>(&mut arg0.id, 0x1::string::utf8(b"dummy")))
    }
    ...
    public entry fun receive_dummy2(arg0: &ContractPublisher, arg1: &mut Dummy2Pool, arg2: 0x2::transfer::Receiving<0x2::coin::Coin<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>>(&mut arg1.id, 0x1::string::utf8(b"dummy2"), 0x2::transfer::public_receive<0x2::coin::Coin<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>>(&mut arg1.id, arg2));
    }
    ...
    public entry fun send_reward(arg0: &mut RewardPool, arg1: &mut 0x2::coin::Coin<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>(arg1) >= arg2, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>>(0x2::coin::from_balance<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>(0x2::balance::split<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>(0x2::coin::balance_mut<0x75e246e6731eab633677f546f47962db8793aa2773f07b7947d7474eba310f3a::dummy::DUMMY>(arg1), arg2), arg3), 0x2::object::uid_to_address(&arg0.id));
    }

    public entry fun top_up_dummy2(arg0: &mut Dummy2Pool, arg1: &mut 0x2::coin::Coin<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>(arg1) >= arg2, 5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>>(0x2::coin::from_balance<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>(0x2::balance::split<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>(0x2::coin::balance_mut<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>(arg1), arg2), arg3), 0x2::object::uid_to_address(&arg0.id));
    }
    ...
    public(friend) fun withdraw_dummy2(arg0: &mut Dummy2Pool, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2> {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"dummy2")), 1002);
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::Coin<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>>(&mut arg0.id, 0x1::string::utf8(b"dummy2"));
        assert!(0x2::coin::value<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>(v0) > arg1, 5);
        0x2::coin::split<0x9751fe8ba2b35c158a470cda8806d506bd5d7d08ee9c0b0053e4860c1f6f4962::dummy2::DUMMY2>(v0, arg1, arg2)
    }
