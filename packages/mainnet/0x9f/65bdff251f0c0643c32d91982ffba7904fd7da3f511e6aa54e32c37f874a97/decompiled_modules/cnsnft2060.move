module 0x9f65bdff251f0c0643c32d91982ffba7904fd7da3f511e6aa54e32c37f874a97::cnsnft2060 {
    struct CNSNFT2060 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2060, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2060>(arg0, arg1);
