module 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::launchpad_sale {
    ...
    public(friend) fun withdraw<T0: store + key, T1: store>(arg0: &mut Sale<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : T0 {
        let v0 = &mut arg0.reg;
        v0.born = v0.born + 1;
        0x2::object_table::remove<0x2::object::ID, T0>(&mut arg0.nfts, 0x1::vector::swap_remove<0x2::object::ID>(&mut v0.nft_index, 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::random::rand_u64_range(0, 0x1::vector::length<0x2::object::ID>(&arg0.reg.nft_index), arg1)))
    }
