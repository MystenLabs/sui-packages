module 0x9fd16b308ab3833fa512ac7b845585217c320d5c9420294b72a5da4b7bb4579c::cnsnft4792 {
    struct CNSNFT4792 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4792>(arg0, arg1);
