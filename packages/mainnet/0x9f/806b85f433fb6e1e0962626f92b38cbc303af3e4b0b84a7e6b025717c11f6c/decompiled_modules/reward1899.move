module 0x9f806b85f433fb6e1e0962626f92b38cbc303af3e4b0b84a7e6b025717c11f6c::reward1899 {
    struct REWARD1899 has drop {
        dummy_field: bool,
    }

    struct TICKET_1899 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1899(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1899>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1899>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1899, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1899>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1899>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1899>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1899>>(v5, 0x2::tx_context::sender(arg1));
    }
