module 0x9f405c1d352c6eb31b9b6f98a03d75a9fd273dc74bb5af266f4a23eb48755fce::octopus {
    ...
    fun init(arg0: OCTOPUS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<OCTOPUS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"octopus"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"octopus "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibq2sbmvzqpmysii47jkkvux7eiktzdxrysg2ju76e2drk7lto4oq"));
