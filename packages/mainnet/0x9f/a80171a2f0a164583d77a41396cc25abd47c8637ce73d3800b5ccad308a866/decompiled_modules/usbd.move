module 0x9fa80171a2f0a164583d77a41396cc25abd47c8637ce73d3800b5ccad308a866::usbd {
    ...
    fun init(arg0: USBD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (1000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USBD>>(0x2::coin::mint<USBD>(&mut v5, 1000000000000000, arg1), v6);
        };
