module 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::main {
    ...
    public fun cancel_order<T0, T1>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public fun claim_order<T0, T1>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        validate_global_config(arg0);
        let Receipt {
            id       : v0,
            order_id : v1,
    ...
    public fun create_batch_orders<T0>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: vector<BatchOrderParams<T0>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, vector<Receipt>) {
        validate_global_config(arg0);
    ...
    public fun create_order<T0, T1>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : Receipt {
        validate_global_config(arg0);
        assert!(arg4 > 0, 10);
        assert!(arg3 > 0, 11);
    ...
    public fun end_execute_order<T0, T1>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::ExecTicket, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg0);
        let v0 = 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::get_order_id(&arg2);
        ...
        let v2 = 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::get_cycle_number(&arg2);
        ...
        let v5 = 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::get_execution_time(&arg2);
        ...
        if (v1.current_cycle >= v1.order_num) {
            ...
            v1.next_execution_time = calc_next_exec_time_after(v1, v1.current_cycle);
        };
        v1.executing_flag = false;
        let v6 = OrderFilled{
            recipe_id            : v0,
            cycle_number         : 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::get_cycle_number(&arg2),
            fulfilled_time       : v5,
            from_coin_type       : 0x1::type_name::with_defining_ids<T0>(),
            to_coin_type         : 0x1::type_name::with_defining_ids<T1>(),
            amount_in_borrowed   : 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::get_amount_borrowed(&arg2),
            amount_in_spent      : 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::get_amount_in_max(&arg2),
            amount_out           : v3,
            protocol_fee_charged : 0,
        };
        0x2::event::emit<OrderFilled>(v6);
        let (_, _, _, _, _, _, _, _) = 0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::destroy_exec_ticket(arg2);
    }
    ...
    public fun start_execute_order<T0>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::OperatorCap, arg1: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg2: &mut OrderRegistry, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::ExecTicket, 0x2::coin::Coin<T0>) {
        ...
        (0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::types::new_exec_ticket(arg3, v5, v5, v1, v2, v3, v4, v1), 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v6, v5), arg5))
    }
    ...
    fun validate_global_config(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig) {
        assert!(!0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::is_paused(arg0), 1);
        assert!(0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::get_version(arg0) == 2, 2);
    }
    ...
    public fun withdraw_output<T0>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
    ...
    public fun withdraw_output_amount<T0>(arg0: &0x9f547e7cdb5b6cda3f9087b789c7536caa89dec83e4fd4d9bf1496d8c3f4dbf0::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
        assert!(0x2::table::contains<address, Order>(&arg1.orders, arg2.order_id), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg1.orders, arg2.order_id);
