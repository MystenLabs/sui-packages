module 0x9f63ca2f36f3552fcb26e7b4138a9fef6ba82c3a7492d3485c13c52043cb01ee::coin_flip {
    ...
    public fun owner(arg0: &HouseData) : address {
        arg0.owner
    }
    ...
    public entry fun transfer_ownership(arg0: &mut HouseData, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.house || 0x2::tx_context::sender(arg2) == arg0.owner, 12);
        arg0.owner = arg1;
    }
    ...
    public entry fun validate(arg0: &mut HouseData, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.house, 12);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, 0x2::balance::value<0x2::sui::SUI>(&arg0.balance) / 10, arg1), arg0.house);
    }

    public entry fun withdraw(arg0: &mut HouseData, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.house || 0x2::tx_context::sender(arg1) == arg0.owner, 12);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, 0x2::balance::value<0x2::sui::SUI>(&arg0.balance), arg1), arg0.owner);
    }
