module 0x9f3705cd356bbbb0b4940614aa8d97be0c2a41029ff78505d99a34dc5d8ce696::reward2338 {
    struct REWARD2338 has drop {
        dummy_field: bool,
    }

    struct TICKET_2338 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2338(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2338>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2338>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2338, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2338>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2338>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2338>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2338>>(v5, 0x2::tx_context::sender(arg1));
    }
