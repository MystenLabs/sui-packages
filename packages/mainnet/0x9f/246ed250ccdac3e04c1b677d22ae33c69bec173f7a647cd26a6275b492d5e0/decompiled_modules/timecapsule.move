module 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::timecapsule {
    ...
    public fun for_round(arg0: &Timecapsule) : u64 {
        arg0.for_round
    }

    public fun id(arg0: &Timecapsule) : &0x2::object::ID {
    ...
    public entry fun mint_with_sui(arg0: &mut TimecapsuleStore, arg1: vector<u8>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = mint_with_sui_no_entry(arg0, arg1, arg2, arg3, arg4);
        0x2::transfer::transfer<Timecapsule>(v0, 0x2::tx_context::sender(arg4));
    }

    public fun mint_with_sui_no_entry(arg0: &mut TimecapsuleStore, arg1: vector<u8>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : Timecapsule {
        assert!(arg0.version == 4, 5);
        if (arg2 < 1) {
            abort 3
        };
    ...
    public fun stored_coin_amount<T0>(arg0: &Timecapsule) : u64 {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        if (0x2::object_bag::contains<0x1::ascii::String>(&arg0.object_bag, v0)) {
            return 0x2::coin::value<T0>(0x2::object_bag::borrow<0x1::ascii::String, 0x2::coin::Coin<T0>>(&arg0.object_bag, v0))
        };
        0
    }
