module 0x9f5027a9933c6e3f36377513b34001a41b64b30f1ef24d311f56c4bfaf234e2a::cnsnft3667 {
    struct CNSNFT3667 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3667, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3667>(arg0, arg1);
