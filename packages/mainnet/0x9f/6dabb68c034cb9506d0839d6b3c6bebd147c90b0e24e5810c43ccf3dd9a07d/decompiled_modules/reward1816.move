module 0x9f6dabb68c034cb9506d0839d6b3c6bebd147c90b0e24e5810c43ccf3dd9a07d::reward1816 {
    struct REWARD1816 has drop {
        dummy_field: bool,
    }

    struct TICKET_1816 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1816(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1816>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1816>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1816, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1816>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1816>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1816>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1816>>(v5, 0x2::tx_context::sender(arg1));
    }
