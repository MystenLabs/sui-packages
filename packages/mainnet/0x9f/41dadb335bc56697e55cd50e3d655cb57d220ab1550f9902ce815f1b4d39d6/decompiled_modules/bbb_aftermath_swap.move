module 0x9f41dadb335bc56697e55cd50e3d655cb57d220ab1550f9902ce815f1b4d39d6::bbb_aftermath_swap {
    ...
    public fun swap<T0, T1, T2>(arg0: AftermathSwapPromise, arg1: &mut 0x9f41dadb335bc56697e55cd50e3d655cb57d220ab1550f9902ce815f1b4d39d6::bbb_vault::BBBVault, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &mut 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::Pool<T0>, arg5: &0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool_registry::PoolRegistry, arg6: &0x2d9316f1f1a95f6d7c85a4e690ef7c359e6649773ef2c37ad7d9857adb6bef06::vault::ProtocolFeeVault, arg7: &mut 0x64213b0e4a52bac468d4ac3f140242f70714381653a1919a6d57cd49c628207a::treasury::Treasury, arg8: &mut 0xa6baab1e668c7868991c1c3c11e144100f5734c407d020f72a01b9d1a8bcb97f::insurance_fund::InsuranceFund, arg9: &0xc66fabf1a9253e43c70f1cc02d40a1d18db183140ecaae2a3f58fa6b66c55acf::referral_vault::ReferralVault, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(&v5 == feed_in(&v0), 1001);
        let v6 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v4);
        assert!(&v6 == feed_out(&v0), 1002);
        let v7 = 0x2::object::id<0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::Pool<T0>>(arg4);
        assert!(&v7 == pool_id(&v0), 1000);
        let v8 = 0x1::type_name::get<T1>();
        let v9 = 0x1::type_name::get<T2>();
        assert!(&v8 == type_in(&v0), 1003);
        assert!(&v9 == type_out(&v0), 1004);
        let v10 = 0x2::coin::from_balance<T1>(0x9f41dadb335bc56697e55cd50e3d655cb57d220ab1550f9902ce815f1b4d39d6::bbb_vault::withdraw<T1>(arg1), arg11);
        let v11 = 0x2::coin::value<T1>(&v10);
        if (v11 == 0) {
            0x2::coin::destroy_zero<T1>(v10);
            return
        };
        let v12 = 0x9f41dadb335bc56697e55cd50e3d655cb57d220ab1550f9902ce815f1b4d39d6::bbb_pyth::calc_amount_out(arg2, arg3, v0.decimals_in, v0.decimals_out, v11, v0.max_age_secs, arg10);
        let v13 = 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::swap::swap_exact_in<T0, T1, T2>(arg4, arg5, arg6, arg7, arg8, arg9, v10, v12, v0.slippage, arg11);
        let v14 = 0x2::coin::value<T2>(&v13);
        assert!(v14 >= (((v12 as u256) * (v0.slippage as u256) / 1000000000000000000) as u64), 1005);
        0x9f41dadb335bc56697e55cd50e3d655cb57d220ab1550f9902ce815f1b4d39d6::bbb_vault::deposit<T2>(arg1, v13);
        let v15 = AftermathSwapEvent{
        ...
        0x2::event::emit<AftermathSwapEvent>(v15);
    }
    ...
    public fun new<T0, T1, T2>(arg0: &0x9f41dadb335bc56697e55cd50e3d655cb57d220ab1550f9902ce815f1b4d39d6::bbb_admin::BBBAdminCap, arg1: u8, arg2: u8, arg3: vector<u8>, arg4: vector<u8>, arg5: &0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::Pool<T0>, arg6: u64, arg7: u64) : AftermathSwap {
