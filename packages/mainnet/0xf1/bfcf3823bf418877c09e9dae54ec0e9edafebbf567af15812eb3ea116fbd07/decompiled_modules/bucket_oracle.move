module 0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle {
    ...
    public fun add_rule<T0, T1: drop>(arg0: &AdminCap, arg1: &mut BucketOracle) {
        0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::single_oracle::add_rule<T0, T1>(borrow_single_oracle_mut<T0>(arg1));
    }
    ...
    public fun remove_rule<T0, T1: drop>(arg0: &AdminCap, arg1: &mut BucketOracle) {
        0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::single_oracle::remove_rule<T0, T1>(borrow_single_oracle_mut<T0>(arg1));
    }
    ...
    public entry fun update_price_from_supra<T0>(arg0: &mut BucketOracle, arg1: &0x2::clock::Clock, arg2: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg3: u32) {
        let v0 = borrow_single_oracle_mut<T0>(arg0);
        let v1 = 0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::single_oracle::issue_price_collector<T0>();
        0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::single_oracle::collect_price_from_supra<T0>(v0, &mut v1, arg2, arg3);
        0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::single_oracle::update_oracle_price<T0>(v0, arg1, v1);
    }
