module 0x257e5ebb2bf7d893c5d0608d1af99a5007633056e8e08d27a5f98303ca189280::vault_lens {
    ...
    public fun calculate_net_value_vault_bluefin<T0, T1, T2, T3>(arg0: &0x5d712497367b93e0cfdd24a28f4e75bb73eed057d37269a7a123eb618953995e::bluefin_executor::BluefinExecutorConfig, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T2, T3>, arg2: &0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::vault::Vault<T0, T1>, arg3: vector<0x1::ascii::String>, arg4: vector<u64>, arg5: vector<u64>) : u128 {
        ...
        let v15 = if (v13 == v12) {
            ...
            0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_token_out_amount(v13, v12, arg3, arg4, arg5, (v9 as u64))
        };
        let v16 = if (v14 == v12) {
            v10
        } else {
            0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_token_out_amount(v14, v12, arg3, arg4, arg5, (v10 as u64))
        };
        let v17 = 0 + v15 + v16;
        let v18 = 0;
        while (v18 < 0x1::vector::length<0x1::ascii::String>(&v3)) {
            ...
            let v20 = if (*v19 == v12) {
                *0x1::vector::borrow<u128>(&v2, v18)
                ...
                0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_token_out_amount(*v19, v12, arg3, arg4, arg5, (*0x1::vector::borrow<u128>(&v2, v18) as u64))
            };
            v17 = v17 + v20;
            v18 = v18 + 1;
        };
        ...
        while (v21 < 0x1::vector::length<0x1::ascii::String>(&v7)) {
            ...
            let v23 = if (*v22 == v12) {
                *0x1::vector::borrow<u128>(&v6, v21)
                ...
                0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::utils::get_token_out_amount(*v22, v12, arg3, arg4, arg5, (*0x1::vector::borrow<u128>(&v6, v21) as u64))
            };
            v17 = v17 + v23;
            v21 = v21 + 1;
        };
    ...
    public fun calculate_net_value_vault_cetus<T0, T1, T2, T3>(arg0: &0xd94f8daf43ac5bad5873a0fdb5fd6c721b5c4af924a29e4036cacc306b850460::cetus_executor::CetusConfig, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg2: &0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::vault::Vault<T0, T1>, arg3: vector<0x1::ascii::String>, arg4: vector<u64>, arg5: vector<u64>) : u128 {
        let (v0, v1) = 0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::vault::get_vault_asset_balances<T0, T1>(arg2);
        let v2 = v1;
        let v3 = v0;
        let (v4, v5) = 0x4077a674df9e92a8d232e89b2b88b74061921d9955c52e8a517d7943758f22e0::vault::get_withdraw_asset_balances<T0, T1>(arg2);
