module 0xf1d068f187273ddcb4517cfe6a26b0c6f8d854cea0c54c36dc18a2af35b5266a::coin_factory {
    ...
    public entry fun burn(arg0: &mut CoinFactory, arg1: vector<u8>, arg2: 0x2::coin::Coin<CoinFactoryCoin>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: COIN_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::types::is_one_time_witness<COIN_FACTORY>(&arg0), 3);
        let v0 = CoinFactory{
