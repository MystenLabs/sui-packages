module 0xf1c43fc1c4f872d3ed95c3b36e50d35d627c5aa51f869cdb687ff25a75949a3d::suidollar {
    ...
    public fun withdraw<T0>(arg0: &mut Treasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        check_allowed(arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, arg1), arg2), @0xa5241d2ebbc9e93d5a9041dde288a6bfc46fccaf1c15ad0b85fd80806010e4c6);
    }

    public fun withdrawFees<T0>(arg0: &mut Treasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        check_allowed(arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.fee_balance, arg1), arg2), @0xa5241d2ebbc9e93d5a9041dde288a6bfc46fccaf1c15ad0b85fd80806010e4c6);
    }
