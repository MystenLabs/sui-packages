module 0x73c593882cdb557703e903603f20bd373261fe6ba6e1a40515f4b62f10553e6a::liquidation_vault {
    ...
    struct AuthorizedTradersKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    fun assert_trader(arg0: &LiquidationVault, arg1: &0x2::tx_context::TxContext) {
        let v0 = AuthorizedTradersKey{dummy_field: false};
        let v1 = 0x2::tx_context::sender(arg1);
        assert!(0x2::vec_set::contains<address>(0x2::dynamic_field::borrow<AuthorizedTradersKey, 0x2::vec_set::VecSet<address>>(&arg0.id, v0), &v1), 2);
    }

    public fun authorize_trader(arg0: &mut LiquidationVault, arg1: &LiquidationAdminCap, arg2: address) {
        let v0 = AuthorizedTradersKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<AuthorizedTradersKey>(&arg0.id, v0)) {
            0x2::dynamic_field::add<AuthorizedTradersKey, 0x2::vec_set::VecSet<address>>(&mut arg0.id, v0, 0x2::vec_set::empty<address>());
        };
        0x2::vec_set::insert<address>(0x2::dynamic_field::borrow_mut<AuthorizedTradersKey, 0x2::vec_set::VecSet<address>>(&mut arg0.id, v0), arg2);
    }
    ...
    public fun deauthorize_trader(arg0: &mut LiquidationVault, arg1: &LiquidationAdminCap, arg2: address) {
        let v0 = AuthorizedTradersKey{dummy_field: false};
        0x2::vec_set::remove<address>(0x2::dynamic_field::borrow_mut<AuthorizedTradersKey, 0x2::vec_set::VecSet<address>>(&mut arg0.id, v0), &arg2);
    }
    ...
    public fun swap_base_to_quote<T0, T1>(arg0: &mut LiquidationVault, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_trader(arg0, arg6);
        let v0 = withdraw_int<T0>(arg0, arg2);
        let v1 = withdraw_int<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg0, arg3);
        let (v2, v3, v4) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::swap_exact_base_for_quote<T0, T1>(arg1, 0x2::coin::from_balance<T0>(v0, arg6), 0x2::coin::from_balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v1, arg6), arg4, arg5, arg6);
        deposit_int<T0>(arg0, 0x2::coin::into_balance<T0>(v2));
        deposit_int<T1>(arg0, 0x2::coin::into_balance<T1>(v3));
        deposit_int<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg0, 0x2::coin::into_balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v4));
    }

    public fun swap_quote_to_base<T0, T1>(arg0: &mut LiquidationVault, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_trader(arg0, arg6);
        let v0 = withdraw_int<T1>(arg0, arg2);
        let v1 = withdraw_int<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg0, arg3);
        let (v2, v3, v4) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::swap_exact_quote_for_base<T0, T1>(arg1, 0x2::coin::from_balance<T1>(v0, arg6), 0x2::coin::from_balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v1, arg6), arg4, arg5, arg6);
        deposit_int<T0>(arg0, 0x2::coin::into_balance<T0>(v2));
        deposit_int<T1>(arg0, 0x2::coin::into_balance<T1>(v3));
        deposit_int<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(arg0, 0x2::coin::into_balance<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(v4));
    }
