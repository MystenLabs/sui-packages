module 0xf14ace555eea51403f605434747533567b445cb86f8e490a4a4241b9ab97d26d::trump {
    ...
    fun init(arg0: TRUMP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/EXVUTukPd4W5EhLkWju67wo5kZ6UiVHdaUXXQHPwpump.png?size=lg&key=7015cc                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRUMP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TRUMP     ")))), trim_right(b"Donald J. Trump                 "), trim_right(b"Welcome Back, President Trump!  America is ready as Donald J. Trump returns as the 47th President! Lets Make America Great AgainAGAIN!                                                                                                                                                                                          "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
