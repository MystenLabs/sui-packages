module 0x2494d5ad8dbbb092289a2654ce38bed7cd0ae3faede33c6c3b32a14a708bb9a8::utils {
    public fun get_description_nft() : vector<u8> {
        b"Nemo's Gold Voyage - a collection of 888 NFTs that celebrates our extraordinary in the Fingding"
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeibq3wxb35vhu32zamwgjqbeafgf7gkpncpf5xiedvqphy7vk4szru/"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeigu3sb7xdngcgdr3j556pmcxff5wl57exzup26kp2yarkwoiqmhxa/"
    }

    public fun get_name_nft() : vector<u8> {
        b"Nemo's Gold Voyage #"
    }
