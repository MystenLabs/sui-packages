module 0xf1c482174585b0109a711648137fc68ed93621ec536d506ac15d8118a5eccc00::reward7202 {
    struct REWARD7202 has drop {
        dummy_field: bool,
    }

    struct TICKET_7202 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7202(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7202>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7202>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7202, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7202>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7202>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7202>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7202>>(v5, 0x2::tx_context::sender(arg1));
    }
