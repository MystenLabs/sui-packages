module 0xf1f91be100c00e561fc333443b0a6a8ac3de1912e1fc21faa7fa16784d2bb6b1::cnsnft8498 {
    struct CNSNFT8498 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8498, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8498>(arg0, arg1);
