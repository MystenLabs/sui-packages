module 0xf1207462f6ee39938cd9f6e93285e4dc0a8034d49cb6bfb55cb5a827ba4f0cb6::tree_roots {
    struct TREE_ROOTS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TREE_ROOTS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TREE_ROOTS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Tree Roots"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Plant those roots"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidrrzvdk6hdjjbihsps2u2gi4prpjpnsdtfpq4prb7wrqumbgpfty"));
