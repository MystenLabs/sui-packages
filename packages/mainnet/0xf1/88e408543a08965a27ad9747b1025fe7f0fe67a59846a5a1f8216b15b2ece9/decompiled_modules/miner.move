module 0xcc3ac0c9cc23c0bcc31ec566ef4baf6f64adcee83175924030829a3f82270f37::miner {
    ...
    public(friend) fun update_rewards(arg0: &mut Miner, arg1: u256) {
        if (arg1 > arg0.rewards_factor) {
            ...
            assert!(v0 >= 0, 0);
            arg0.refined_aur = arg0.refined_aur + ((v0 * (arg0.rewards_aur as u256) / (1000000 as u256)) as u64);
        };
        arg0.rewards_factor = arg1;
    }
