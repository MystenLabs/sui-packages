module 0xf1d8fe23cb1e21e1a8c1458561effecacef0f3eb4d9bd48670b09b30e43a15ca::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"Chain", b"Rytkhtr", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-30T09-15-48.398Z-image-5.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Rytkhtr"),
            symbol     : 0x1::string::utf8(b"Chain"),
            decimals   : 9,
