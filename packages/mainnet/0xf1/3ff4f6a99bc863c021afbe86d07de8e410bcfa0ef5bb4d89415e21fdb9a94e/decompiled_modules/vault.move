module 0xf13ff4f6a99bc863c021afbe86d07de8e410bcfa0ef5bb4d89415e21fdb9a94e::vault {
    ...
    public(friend) fun add_funds<T0>(arg0: &OrderCap, arg1: &mut Vault<T0>, arg2: 0x2::coin::Coin<T0>) {
        assert!(arg1.version == 1, 13906835278150696972);
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(arg2));
    }

    public(friend) fun adjust_taker_balance<T0>(arg0: &OrderCap, arg1: &mut Vault<T0>, arg2: address, arg3: u64, arg4: bool) {
    ...
    public(friend) fun transfer_fee_to_treasury<T0>(arg0: &OrderCap, arg1: &mut Vault<T0>, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public(friend) fun transfer_to_maker_vault<T0>(arg0: &OrderCap, arg1: &mut Vault<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
