module 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::abyss_vault {
    struct Vault<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        margin_pool_id: 0x2::object::ID,
        abyss_vault_state: VaultState,
        protocol_config: 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::config::ProtocolConfig,
        atoken_treasury_cap: 0x2::coin::TreasuryCap<T1>,
        atoken_incentives: VaultIncentives,
        fee_manager: 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::fee_manager::FeeManager<T0>,
    ...
    public fun supply<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg2: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultRegistry, arg3: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg4: 0x2::coin::Coin<T0>, arg5: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::AbyssSupplierCap, arg6: 0x1::option::Option<0x2::object::ID>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_inner(arg2);
        let v0 = 0x2::coin::value<T0>(&arg4);
        assert!(v0 > 0, 8);
        assert!(v0 <= max_supply<T0>(arg1, arg7), 2);
        let v1 = 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_supplier_cap(arg5);
    ...
    public fun withdraw<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg2: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultRegistry, arg3: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg4: 0x2::coin::Coin<T1>, arg5: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::AbyssSupplierCap, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_inner(arg2);
        let v0 = 0x2::coin::value<T1>(&arg4);
        assert!(v0 > 0, 1);
        let v1 = convert_to_assets<T0, T1>(arg0, arg1, v0, arg6);
        assert!(v1 <= max_withdraw<T0>(arg1, arg6), 3);
        let v2 = 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_supplier_cap(arg5);
    ...
    public fun add_incentives<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultRegistry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg4: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultIncentivesManagerCap, arg5: &0x2::clock::Clock) {
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_inner(arg1);
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::validate_vault_incentives_manager_cap(arg4, vault_id<T0, T1>(arg0));
        ...
        let v0 = VaultIncentivesAccrued{
            vault_id                 : 0x2::object::id<Vault<T0, T1>>(arg0),
            margin_pool_id           : arg0.margin_pool_id,
            incentive_manager_cap_id : 0x2::object::id<0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultIncentivesManagerCap>(arg4),
            asset_type               : 0x1::type_name::with_defining_ids<T0>(),
    ...
    fun apply_fee<T0, T1>(arg0: &Vault<T0, T1>) : bool {
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::config::protocol_fee(&arg0.protocol_config) > 0
    }
    ...
    public fun compound_incentives<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultRegistry, arg2: &mut 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg3: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry::MarginRegistry, arg4: 0x2::coin::Coin<T0>, arg5: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::AbyssSupplierCap, arg6: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultIncentivesManagerCap, arg7: 0x1::option::Option<0x2::object::ID>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : u64 {
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_inner(arg1);
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::validate_vault_incentives_manager_cap(arg6, vault_id<T0, T1>(arg0));
        assert!(0x2::coin::value<T0>(&arg4) > 0, 7);
        assert!(0x2::balance::supply_value<T1>(0x2::coin::supply_immut<T1>(&arg0.atoken_treasury_cap)) >= 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::config::min_atoken_supply(&arg0.protocol_config), 6);
        let v0 = 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_supplier_cap(arg5);
        let v1 = 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::config::protocol_fee(&arg0.protocol_config);
        let v2 = &mut arg4;
        ...
        let v5 = VaultIncentivesCompounded{
            vault_id                 : 0x2::object::id<Vault<T0, T1>>(arg0),
            margin_pool_id           : arg0.margin_pool_id,
            incentive_manager_cap_id : 0x2::object::id<0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultIncentivesManagerCap>(arg6),
            asset_type               : 0x1::type_name::with_defining_ids<T0>(),
    ...
    public fun create_vault<T0>(arg0: &0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::MarginPool<T0>, arg1: &mut 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultRegistry, arg2: &mut 0x2::coin_registry::CoinRegistry, arg3: 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::config::ProtocolConfig, arg4: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::AbyssAdminCap, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u8, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin_registry::MetadataCap<AToken<T0>>, 0x2::object::ID) {
        assert!(arg9 >= 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::abyss_constants::min_underlying_decimals() && arg9 <= 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::abyss_constants::max_underlying_decimals(), 9);
        ...
        let v4 = Vault<T0, AToken<T0>>{
            ...
            fee_manager         : 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::fee_manager::new_fee_manager<T0>(arg11),
            underlying_decimals : arg9,
        };
        let v5 = 0x1::type_name::with_defining_ids<T0>();
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::register_vault(arg1, arg4, v5, 0x2::object::id<Vault<T0, AToken<T0>>>(&v4), arg10, arg11);
        let v6 = VaultCreated{
            vault_id            : 0x2::object::id<Vault<T0, AToken<T0>>>(&v4),
            margin_pool_id      : 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_pool::id<T0>(arg0),
            admin_cap_id        : 0x2::object::id<0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::AbyssAdminCap>(arg4),
            asset_type          : v5,
            protocol_config     : arg3,
            underlying_decimals : arg9,
    ...
    fun take_fee<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        if (apply_fee<T0, T1>(arg0)) {
            let v0 = VaultFeesAccrued{
                ...
                margin_pool_id : arg0.margin_pool_id,
                asset_type     : 0x1::type_name::with_defining_ids<T0>(),
                fee_amount     : 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::fee_manager::take_fee<T0>(&mut arg0.fee_manager, arg1, arg2, arg4),
    ...
    public fun take_incentives<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultRegistry, arg2: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultIncentivesManagerCap, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>) {
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_inner(arg1);
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::validate_vault_incentives_manager_cap(arg2, vault_id<T0, T1>(arg0));
        ...
        let v14 = VaultIncentivesTaken{
            vault_id                 : 0x2::object::id<Vault<T0, T1>>(arg0),
            margin_pool_id           : arg0.margin_pool_id,
            incentive_manager_cap_id : 0x2::object::id<0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultIncentivesManagerCap>(arg2),
            asset_type               : 0x1::type_name::with_defining_ids<T0>(),
    ...
    public fun update_protocol_config<T0>(arg0: &mut Vault<T0, AToken<T0>>, arg1: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultRegistry, arg2: 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::config::ProtocolConfig, arg3: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::VaultManagerCap, arg4: &0x2::clock::Clock) {
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::load_inner(arg1);
        0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::validate_vault_manager_cap(arg3, vault_id<T0, AToken<T0>>(arg0));
        arg0.protocol_config = arg2;
        let v0 = VaultConfigUpdated{
            vault_id             : vault_id<T0, AToken<T0>>(arg0),
            vault_manager_cap_id : 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::vault_manager_cap_id(arg3),
    ...
    public fun withdraw_protocol_fees<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::AbyssAdminCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::fee_manager::withdraw_protocol_fees<T0>(&mut arg0.fee_manager, arg3);
        let v1 = VaultFeesCollected{
            vault_id       : 0x2::object::id<Vault<T0, T1>>(arg0),
            margin_pool_id : arg0.margin_pool_id,
            asset_type     : 0x1::type_name::with_defining_ids<T0>(),
            admin_cap_id   : 0x2::object::id<0xf1684efcebfea0daaeada7ab324cf3824192e16af5af1dc1a8bb2f476de77e96::vault_registry::AbyssAdminCap>(arg1),
