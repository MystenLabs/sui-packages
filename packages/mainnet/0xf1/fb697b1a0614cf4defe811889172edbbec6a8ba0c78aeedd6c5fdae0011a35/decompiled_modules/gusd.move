module 0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::gusd {
    ...
    struct AdminManager has store, key {
        id: 0x2::object::UID,
        access_manager: 0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::AccessManager,
        deny_cap: 0x2::coin::DenyCapV2<GUSD>,
        paused: bool,
        blacklisted: 0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::set::Set<address>,
    }
    ...
    entry fun grant_role<T0>(arg0: &mut AdminManager, arg1: &AdminCap, arg2: address, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!arg3) {
            0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::grant_role<T0>(&mut arg0.access_manager, arg2, arg4);
        } else {
            let v1 = 0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::generate_role_cap<T0>(arg2, arg4);
            v0 = 0x1::option::some<0x2::object::ID>(0x2::object::id<0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap>(&v1));
            0x2::transfer::public_transfer<0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap>(v1, arg2);
        };
    ...
    entry fun revoke_role<T0>(arg0: &mut AdminManager, arg1: &AdminCap, arg2: address) {
        verify_admin(arg1);
        verify_role_defined<T0>();
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::revoke_role<T0>(&mut arg0.access_manager, arg2);
    ...
    entry fun revoke_role_cap<T0>(arg0: &mut AdminManager, arg1: &AdminCap, arg2: 0x2::object::ID) {
        verify_admin(arg1);
        verify_role_defined<T0>();
        let v0 = 0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::revoke_role_cap(&mut arg0.access_manager, arg2);
        assert!(v0 != @0x0, 4);
    ...
    fun verify_role<T0>(arg0: &AdminManager, arg1: address) {
        assert!(0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::verify_role<T0>(&arg0.access_manager, arg1), 2);
    }

    fun verify_role_cap<T0>(arg0: &AdminManager, arg1: &0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap, arg2: address) {
        assert!(0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::verify_role_cap<T0>(&arg0.access_manager, arg1, arg2), 2);
    }
    ...
    entry fun blacklist(arg0: &mut AdminManager, arg1: &mut 0x2::deny_list::DenyList, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::set::insert<address>(&mut arg0.blacklisted, arg2);
    ...
    entry fun blacklist_with_cap(arg0: &mut AdminManager, arg1: &0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap, arg2: &mut 0x2::deny_list::DenyList, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        verify_role_cap<BLACKLIST_ROLE>(arg0, arg1, v0);
        verify_role<BLACKLIST_ROLE>(arg0, v0);
        0x2::coin::deny_list_v2_add<GUSD>(arg2, &mut arg0.deny_cap, arg3, arg4);
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::set::insert<address>(&mut arg0.blacklisted, arg3);
        let v1 = BlacklistEvent{
            sender  : v0,
            account : arg3,
        };
    ...
    entry fun has_role<T0>(arg0: &AdminManager, arg1: address) : bool {
        verify_role_defined<T0>();
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::verify_role<T0>(&arg0.access_manager, arg1)
    }

    entry fun has_role_with_cap<T0>(arg0: &AdminManager, arg1: &0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap, arg2: address) : bool {
        verify_role_defined<T0>();
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::verify_role_cap<T0>(&arg0.access_manager, arg1, arg2)
    }
    ...
    fun init(arg0: GUSD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = AdminManager{
            ...
            access_manager : 0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::new(arg1),
            deny_cap       : v1,
            paused         : false,
            blacklisted    : 0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::set::new<address>(arg1),
        };
    ...
    entry fun is_blacklisted(arg0: &AdminManager, arg1: address) : bool {
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::set::contains<address>(&arg0.blacklisted, arg1)
    }
    ...
    entry fun pause_with_cap(arg0: &mut AdminManager, arg1: &0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap, arg2: &mut 0x2::deny_list::DenyList, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg0.paused) {
            return
        };
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    entry fun unblacklist(arg0: &mut AdminManager, arg1: &mut 0x2::deny_list::DenyList, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::set::remove<address>(&mut arg0.blacklisted, arg2);
    ...
    entry fun unblacklist_with_cap(arg0: &mut AdminManager, arg1: &0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap, arg2: &mut 0x2::deny_list::DenyList, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        verify_role_cap<UNBLACKLIST_ROLE>(arg0, arg1, v0);
        0x2::coin::deny_list_v2_remove<GUSD>(arg2, &mut arg0.deny_cap, arg3, arg4);
        0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::set::remove<address>(&mut arg0.blacklisted, arg3);
        let v1 = UnblacklistEvent{
            sender  : v0,
            account : arg3,
        };
    ...
    entry fun unpause_with_cap(arg0: &mut AdminManager, arg1: &mut 0x2::deny_list::DenyList, arg2: &0xf1fb697b1a0614cf4defe811889172edbbec6a8ba0c78aeedd6c5fdae0011a35::access_manager::RoleCap, arg3: &mut 0x2::tx_context::TxContext) {
        if (!arg0.paused) {
            return
        };
        let v0 = 0x2::tx_context::sender(arg3);
