module 0xf1a24c6b1947f47c5811a0e2c4adeeafa5fc9383ebbb93eea91bb5eadc79ed4e::house {
    ...
    public(friend) fun get_fee_from_payment<T0>(arg0: &mut House, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.fee_balance, v0), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg1, 0xf1a24c6b1947f47c5811a0e2c4adeeafa5fc9383ebbb93eea91bb5eadc79ed4e::utils::mul_div_u64(0x2::coin::value<T0>(arg1), arg0.fee_percentage, 10000), arg2)));
    }
