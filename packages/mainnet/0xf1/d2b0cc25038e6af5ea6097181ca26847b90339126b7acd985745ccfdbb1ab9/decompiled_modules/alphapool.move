module 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::alphapool {
    ...
    public fun deposit<T0>(arg0: &0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        let v7 = (v6 as u64);
        let v8 = arg2.locking_start_day + arg2.locked_period_in_days * 86400000;
        ...
        0x1::option::destroy_none<Receipt>(arg1);
        let v20 = BeforeAndAfterEvent{
            coin_type      : 0x1::type_name::get<T0>(),
            tokensInvested : arg2.tokensInvested,
            xTokenSupply   : arg2.xTokenSupply,
        };
        0x2::event::emit<BeforeAndAfterEvent>(v20);
    ...
    public fun withdraw<T0>(arg0: &0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::distributor::Distributor, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        if (arg6 == true) {
            ...
            assert!(arg4 <= (arg1.balance as u64), 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::error::insufficient_balance_error());
        };
        ...
        if (arg4 > (arg1.balance as u64)) {
            let v6 = 0x2::math::min(((((arg4 - (arg1.balance as u64)) as u128) * 10000 / ((10000 - arg2.instant_withdraw_fee) as u128)) as u64), (((arg1.xTokenBalance as u256) * v2 / (1000000000000000000000000000000000000 as u256) - arg1.balance) as u64));
            arg4 = (arg1.balance as u64) + v6;
            let v7 = &mut arg1;
            unlock_xtokens_from_locked(v7, (((v6 as u256) * (1000000000000000000000000000000000000 as u256) / v2) as u64));
            arg1.balance = 0;
            v5 = (v6 as u128) * (arg2.instant_withdraw_fee as u128) / 10000;
        } else {
            arg1.balance = arg1.balance - (arg4 as u256);
        };
        let v8 = (((arg4 as u256) * (1000000000000000000000000000000000000 as u256) / v2) as u64);
        ...
        0x2::event::emit<FeeEvent>(v10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.alpha_bal, v9), arg7), 0xadc68a25c487095ddf94b9d5a5811d9f266eb296b583dd553dd119539fd3d462::distributor::get_fee_wallet_address(arg3));
        ...
        let v11 = BeforeAndAfterEvent{
            coin_type      : 0x1::type_name::get<T0>(),
            tokensInvested : arg2.tokensInvested,
            xTokenSupply   : arg2.xTokenSupply,
        };
        0x2::event::emit<BeforeAndAfterEvent>(v11);
