module 0xf114558333c9de79bcc05c64b79a961ac84f3d92a559b6c07484dd7f68ac93db::daox_ai {
    ...
    public entry fun buy<T0, T1>(arg0: &mut DaoxAi<T0>, arg1: &mut Pool<T0, T1>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            ...
            let (v3, v4) = if (v1 * (10000 - arg0.fee_bps) / 10000 < v2) {
                (0x2::coin::value<T0>(&arg3), 0x2::coin::split<T0>(&mut arg3, v1 * arg0.fee_bps / 10000, arg4))
            } else {
                let v5 = v2 * arg0.fee_bps / (10000 - arg0.fee_bps);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v1 - v2 - v5, arg4), v0);
                arg1.complete = true;
                (v2, 0x2::coin::split<T0>(&mut arg3, v5, arg4))
            };
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg1.pool_coin, (v6 as u64), arg4), v0);
