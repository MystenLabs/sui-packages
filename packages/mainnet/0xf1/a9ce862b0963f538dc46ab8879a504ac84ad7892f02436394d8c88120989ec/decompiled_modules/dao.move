module 0xf1a9ce862b0963f538dc46ab8879a504ac84ad7892f02436394d8c88120989ec::dao {
    ...
    public entry fun create_dao_fund<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<T0>(&arg5) == arg3, 1005);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xf1a9ce862b0963f538dc46ab8879a504ac84ad7892f02436394d8c88120989ec::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0xf1a9ce862b0963f538dc46ab8879a504ac84ad7892f02436394d8c88120989ec::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0xf1a9ce862b0963f538dc46ab8879a504ac84ad7892f02436394d8c88120989ec::dao_config::set_platform_fee(arg1, arg2, arg3, arg4);
    }
    ...
    public entry fun withdraw<T0>(arg0: &mut DAOFund<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_existed_user_dao<T0>(arg0, 0x2::tx_context::sender(arg4)), 1001);
