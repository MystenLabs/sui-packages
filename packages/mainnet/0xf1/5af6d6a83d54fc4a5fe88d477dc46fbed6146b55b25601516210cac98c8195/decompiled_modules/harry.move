module 0xf15af6d6a83d54fc4a5fe88d477dc46fbed6146b55b25601516210cac98c8195::harry {
    struct HARRY has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<HARRY>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<HARRY>>(0x2::coin::mint<HARRY>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: HARRY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<HARRY>>(0x2::coin::mint<HARRY>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
