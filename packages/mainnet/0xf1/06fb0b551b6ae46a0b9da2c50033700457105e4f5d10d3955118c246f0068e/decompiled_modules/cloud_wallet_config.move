module 0xf106fb0b551b6ae46a0b9da2c50033700457105e4f5d10d3955118c246f0068e::cloud_wallet_config {
    ...
    public fun delete_quick_withdraw_cap(arg0: QuickWithdrawCap) {
        let QuickWithdrawCap { id: v0 } = arg0;
        0x2::object::delete(v0);
    }

    public(friend) fun delete_withdraw_allow_list<T0>(arg0: &mut CloudWalletTokenHolder, arg1: address) {
        let v0 = 0x1::type_name::get<T0>();
        when_vault_created(arg0, v0);
        let v1 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, CloudWalletVault<T0>>(&mut arg0.vault_bag, v0);
        if (0x2::table::contains<address, bool>(&v1.withdraw_whitelist, arg1)) {
            0x2::table::remove<address, bool>(&mut v1.withdraw_whitelist, arg1);
        };
    }
    ...
    public fun mint_withdraw_cap(arg0: &mut CloudWalletConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun set_withdraw_allow_list<T0>(arg0: &mut CloudWalletTokenHolder, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        create_vault_if_not_exist<T0>(arg0, arg2);
        let v0 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, CloudWalletVault<T0>>(&mut arg0.vault_bag, 0x1::type_name::get<T0>());
        if (!0x2::table::contains<address, bool>(&v0.withdraw_whitelist, arg1)) {
            0x2::table::add<address, bool>(&mut v0.withdraw_whitelist, arg1, true);
        };
    }

    public fun signer_length(arg0: &CloudWalletConfig, arg1: u8) : u64 {
        if (arg1 == 1) {
            0x1::vector::length<vector<u8>>(&arg0.signers_v1)
        } else {
            0x1::vector::length<vector<u8>>(&arg0.signers_v2)
        }
    }

    public fun signers_v1(arg0: &CloudWalletConfig) : &vector<vector<u8>> {
        &arg0.signers_v1
    }

    public fun signers_v2(arg0: &CloudWalletConfig) : &vector<vector<u8>> {
        &arg0.signers_v2
    }
