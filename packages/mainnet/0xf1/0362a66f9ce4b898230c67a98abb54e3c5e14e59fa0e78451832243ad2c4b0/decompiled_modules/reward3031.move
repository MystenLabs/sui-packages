module 0xf10362a66f9ce4b898230c67a98abb54e3c5e14e59fa0e78451832243ad2c4b0::reward3031 {
    struct REWARD3031 has drop {
        dummy_field: bool,
    }

    struct TICKET_3031 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3031(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3031>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3031>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3031>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3031>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3031>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3031>>(v5, 0x2::tx_context::sender(arg1));
    }
