module 0xf182cfd5e7a598b4fdcecf9551a70cc9635753253beddf5dc0d9b64e558839fe::cnsnft7083 {
    struct CNSNFT7083 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7083, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4635"));
        let v4 = 0x2::package::claim<CNSNFT7083>(arg0, arg1);
