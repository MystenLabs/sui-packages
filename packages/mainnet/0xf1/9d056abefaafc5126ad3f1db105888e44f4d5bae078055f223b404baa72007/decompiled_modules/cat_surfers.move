module 0xf19d056abefaafc5126ad3f1db105888e44f4d5bae078055f223b404baa72007::cat_surfers {
    struct CAT_SURFERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CAT_SURFERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CAT_SURFERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Cat Surfers"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Catch some waves meow on SUI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiev44qbnmewielrrlhebzfwfv2bmxxv2yqidz4lt55bw2kptkviq4"));
