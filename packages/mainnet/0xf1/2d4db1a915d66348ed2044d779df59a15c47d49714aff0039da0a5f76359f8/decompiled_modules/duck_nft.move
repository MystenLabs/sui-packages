module 0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::duck_nft {
    ...
    public entry fun admin_update_staking_policy_nest_registry(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<DuckNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<DuckNFT>, arg3: address) {
        0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::staking_rule::update_nest_registry<DuckNFT>(arg1, arg2, arg3);
    }
    ...
    fun apply_genesis_purchase(arg0: &mut PackSupply, arg1: &Whitelist, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (arg0.whitelist_phase_active) {
            ...
            if (arg0.whitelist_packs_sold >= 15) {
                arg0.whitelist_phase_active = false;
    ...
    public fun get_supply_constants(arg0: &PackSupply) : (u64, u64, u64, u64, u64, u64) {
        (100, 20, 15, 20 - 15, 10, arg0.total_nfts_minted_globally)
    }
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::burn(arg8, 0x2::coin::split<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>>(0x2::coin::split<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>>(0x2::coin::split<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::shttoken::SHTTOKEN>(arg12);
        };
    ...
    fun init(arg0: DUCK_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = v12;
        let v14 = v11;
        0xf12d4db1a915d66348ed2044d779df59a15c47d49714aff0039da0a5f76359f8::staking_rule::add<DuckNFT>(&mut v14, &v13, @0x0);
