module 0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::sca {
    struct SCA has drop {
        dummy_field: bool,
    }
    ...
    struct ScaTreasury has key {
        id: 0x2::object::UID,
        hard_cap: u64,
        x_supply: 0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::XSupply<SCA>,
    }

    struct ScaTreasuryCap has store, key {
        id: 0x2::object::UID,
        x_supply_cap: 0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::XSupplyCap<SCA>,
    }
    ...
    public fun add_issuer<T0: drop>(arg0: &ScaTreasuryCap, arg1: &mut ScaTreasury) {
        0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::add_issuer<SCA, T0>(&arg0.x_supply_cap, &mut arg1.x_supply);
    ...
    public fun current_supply(arg0: &ScaTreasury) : u64 {
        0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::supply_value<SCA>(&arg0.x_supply)
    }
    ...
    fun init_state(arg0: SCA, arg1: &mut 0x2::tx_context::TxContext) : (ScaTreasury, ScaTreasuryCap, 0x2::coin::CoinMetadata<SCA>) {
        ...
        let (v2, v3) = 0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::create_x_supply<SCA>(0x2::coin::treasury_into_supply<SCA>(v0), arg1);
        let v4 = ScaTreasury{
    ...
    public fun mint<T0: drop>(arg0: T0, arg1: &mut ScaTreasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<SCA> {
        assert!(0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::supply_value<SCA>(&arg1.x_supply) + arg2 <= arg1.hard_cap, 503);
        let v0 = ScaMinted{
            issuer_type : 0x1::type_name::get<T0>(),
            amount      : arg2,
        };
        0x2::event::emit<ScaMinted>(v0);
        0x2::coin::from_balance<SCA>(0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::increase_supply<SCA, T0>(arg0, &mut arg1.x_supply, arg2), arg3)
    }
    ...
    public fun mint_with_cap(arg0: &ScaTreasuryCap, arg1: &mut ScaTreasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<SCA> {
        ...
        0x2::event::emit<ScaMinted>(v0);
        0x2::coin::from_balance<SCA>(0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::increase_supply_with_cap<SCA>(&arg0.x_supply_cap, &mut arg1.x_supply, arg2), arg3)
    }

    public fun remove_issuer<T0: drop>(arg0: &ScaTreasuryCap, arg1: &mut ScaTreasury) {
        0xf193611c70dc40011c30e09a0c737fd7a16fe07c6a1d118edf1b5ee5551ec10c::x_supply::remove_issuer<SCA, T0>(&arg0.x_supply_cap, &mut arg1.x_supply);
