module 0xf1a3a3636ee389909c99922676e1be32b5a4ab0a59ba458ab2f114114df042fc::yolo {
    ...
    public entry fun transfer(arg0: 0x2::coin::Coin<YOLO>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<YOLO>>(arg0, arg1);
    }

    fun init(arg0: YOLO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<YOLO>(arg0, 9, b"YOLO", b"YOLO", b"YOLO", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"H")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<YOLO>(&mut v2, 1000000000000, v3, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<YOLO>>(v2, v3);
