module 0xf199954fc3d7c7576a1ab598f16ffc7f3a3940c3d1759c1caa5517c25194f1c3::aaapepe {
    ...
    fun init(arg0: AAAPEPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<AAAPEPE>(arg0, 2, b"PP", b"AAAPepe", b"AAAPepeee IS THE PEPE BUT ON SUI https://t.me/aaapepeglobal", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
