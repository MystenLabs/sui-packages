module 0xf1beef47062714d5e516a60e0146e668b5c500af227ce55b54900b47aba0c9dc::TOKENIZER {
    ...
    fun init(arg0: TOKENIZER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKENIZER>(arg0, 9, b"CICC", b"Council of International Chambers of Commerce", b"Tokenized representation of real world assets backed by ART20 NFTs", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://salmon-accused-puma-149.mypinata.cloud/ipfs/bafkreifufqxd6etuy47bosqlwwu5coffoup2a5rrpi3jqrcvdygodgnueu?pinataGatewayToken=Nc4R8TH9sXtjJQUiqvn_ZXvRnNYOlp6eH8lT7JTr0zEUEZV2BjEMU-81HiF2dy5x")), arg1);
        let v2 = v0;
