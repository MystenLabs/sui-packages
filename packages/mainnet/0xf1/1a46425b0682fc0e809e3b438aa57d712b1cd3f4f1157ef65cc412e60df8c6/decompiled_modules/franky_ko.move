module 0xf11a46425b0682fc0e809e3b438aa57d712b1cd3f4f1157ef65cc412e60df8c6::franky_ko {
    struct FRANKY_KO has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FRANKY_KO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<FRANKY_KO>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Franky-Ko"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"We just know what happened at Linea, and we also know what will happen now."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://P_RoVihln3oHFVgQFiaI_M12X7i3glKOQAXYhJ4gqq4"));
