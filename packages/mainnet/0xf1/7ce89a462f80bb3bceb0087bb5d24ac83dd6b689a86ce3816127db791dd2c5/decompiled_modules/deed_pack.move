module 0x5a6016832b2754a5961cb1788f0db9d722a85f17f356e51bc04efdb026f9bfbe::deed_pack {
    ...
    public(friend) fun burn(arg0: DeedPack, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x5a6016832b2754a5961cb1788f0db9d722a85f17f356e51bc04efdb026f9bfbe::secure_events::emit_deed_burned(0x2::object::uid_to_inner(&v3), v1, v2, arg1, arg2);
    ...
    fun init(arg0: DEED_PACK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://momentum-statics.s3.us-west-1.amazonaws.com/Momentum+Vertical+Logo+(Light+Background).svg"));
    ...
    public(friend) fun mint(arg0: address, arg1: u8, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x5a6016832b2754a5961cb1788f0db9d722a85f17f356e51bc04efdb026f9bfbe::secure_events::emit_minted(arg0, 0x2::object::uid_to_inner(&v0.id), arg1, arg2);
    }
