module 0xf19e17f745011583bcc718afe265f4452a74ea27b6ab3c61fd777c109d20b833::dialog_management {
    ...
    public entry fun send_message(arg0: &mut UserDialogs, arg1: &mut UserDialogHashes, arg2: &mut ChatCounts, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        if (!0x2::table::contains<vector<u8>, 0x2::table::Table<u64, Message>>(&arg0.dialogs, arg3)) {
            0x2::table::add<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg3, 0x2::table::new<u64, Message>(arg5));
            let v1 = ChatCountEvent{
                address : v0,
        ...
        if (!0x2::table::contains<address, vector<u8>>(&arg1.dialog_hashes, v0)) {
            0x2::table::add<address, vector<u8>>(&mut arg1.dialog_hashes, v0, arg3);
        };
        let v2 = 0x2::table::borrow_mut<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg3);
        let v3 = Message{
            sender    : v0,
