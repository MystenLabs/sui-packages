module 0xf1d150ebf34fa57d078ffd5643bf94600aaa276593051c881a5b59ceecefeb42::gumball {
    ...
    fun init(arg0: GUMBALL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/DyKXpVW96LA7a8yx4D8ZvaKjkpDBcVn4Bz3MUHyLpump.png?size=lg&key=e206b6                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<GUMBALL>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"GUMBALL ")))), trim_right(b"Gumball                         "), trim_right(b"Oh, hi there! Didnt expect to see you here, but hey, now that youve found me, welcome to my world. Im Gumballyep, the one and only. Bright, bouncy, and bursting with personality.                                                                                                                                              "), v2, arg1);
        let v5 = v3;
