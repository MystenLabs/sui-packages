module 0xf1cb9c734018d9cb94a5b929990c96c8c178ef99bb3d4af29b99bff71c998f20::cnsnft7046 {
    struct CNSNFT7046 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7046, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7046>(arg0, arg1);
