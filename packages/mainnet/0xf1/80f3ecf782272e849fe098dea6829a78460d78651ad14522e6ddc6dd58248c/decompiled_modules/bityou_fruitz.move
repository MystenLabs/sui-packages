module 0xf180f3ecf782272e849fe098dea6829a78460d78651ad14522e6ddc6dd58248c::bityou_fruitz {
    struct BITYOU_FRUITZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BITYOU_FRUITZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BITYOU_FRUITZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Bityou Fruitz"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Exclusively distributed by `bityou.app`"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifufsuxnq2767wpmr55e5q6nbbc4vdcrsbmygs5srfm2ojcsymemm"));
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<Nft>(&mut v5, &v4, 1200, 0);
