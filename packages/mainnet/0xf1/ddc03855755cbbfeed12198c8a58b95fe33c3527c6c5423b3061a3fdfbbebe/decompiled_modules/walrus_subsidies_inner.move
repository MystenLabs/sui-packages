module 0x14b874da49e152d2b2910122330f7eb925d75bdb0a0f8e2c6b9b1162a5560a8c::walrus_subsidies_inner {
    ...
    public(friend) fun process_fixed_rate_subsidies(arg0: &mut WalrusSubsidiesInnerV1, arg1: &mut 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::Staking) : bool {
        ...
        let v1 = v0 - 1;
        if (arg0.latest_epoch >= v1) {
            return false
        };
        let (v2, v3) = 0x2::vec_map::into_keys_values<0x2::object::ID, vector<u16>>(0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::committee::to_inner(0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::previous_committee(arg1)));
        let v4 = 0x1::vector::empty<0x2::balance::Balance<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>>();
        let v5 = v3;
        0x1::vector::reverse<vector<u16>>(&mut v5);
        let v6 = 0;
        while (v6 < 0x1::vector::length<vector<u16>>(&v5)) {
            let v7 = &mut v4;
            let v8 = 0x1::vector::pop_back<vector<u16>>(&mut v5);
            let v9 = arg0.base_subsidy + 0x1::vector::length<u16>(&v8) * arg0.subsidy_per_shard;
            assert!(0x2::balance::value<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&arg0.subsidy_pool) >= v9, 1);
            0x1::vector::push_back<0x2::balance::Balance<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>>(v7, 0x2::balance::split<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>(&mut arg0.subsidy_pool, v9));
            v6 = v6 + 1;
        };
        0x1::vector::destroy_empty<vector<u16>>(v5);
        0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::staking::add_commission_to_pools(arg1, v2, v4);
        arg0.latest_epoch = v1;
        true
    }
