module 0xf11cec8d94a3aadd5abe4e74abb10efa47b75089943266fa399bbdb7cae27367::reward4403 {
    struct REWARD4403 has drop {
        dummy_field: bool,
    }

    struct TICKET_4403 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4403(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4403>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4403>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4403, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4403>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4403>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4403>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4403>>(v5, 0x2::tx_context::sender(arg1));
    }
