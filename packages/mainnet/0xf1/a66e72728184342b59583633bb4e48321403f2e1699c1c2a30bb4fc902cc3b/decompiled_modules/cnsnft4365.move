module 0xf1a66e72728184342b59583633bb4e48321403f2e1699c1c2a30bb4fc902cc3b::cnsnft4365 {
    struct CNSNFT4365 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4365, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4365>(arg0, arg1);
