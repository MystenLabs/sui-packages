module 0xf1be51bfbd3629fc6b338df9386208c016f6693998b6c2c0e987aebbcd60be92::reward2564 {
    struct REWARD2564 has drop {
        dummy_field: bool,
    }

    struct TICKET_2564 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2564(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2564>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2564>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2564, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2564>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2564>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2564>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2564>>(v5, 0x2::tx_context::sender(arg1));
    }
