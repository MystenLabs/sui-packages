module 0xf15d8c57f3ff2e8c77b1164720d3949f657c435a568f75accec89c938d441427::tpnut {
    ...
    fun init(arg0: TPNUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/Nx7dk25rFRCgqwXY84XqCD8fmdZg2iMsXFWfizK5rzZ.png?size=lg&key=93b450                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TPNUT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Tpnut   ")))), trim_right(b"Trump and Squirre               "), trim_right(b"Make America Great Again                                                                                                                                                                                                                                                                                                        "), v2, arg1);
        let v5 = v3;
