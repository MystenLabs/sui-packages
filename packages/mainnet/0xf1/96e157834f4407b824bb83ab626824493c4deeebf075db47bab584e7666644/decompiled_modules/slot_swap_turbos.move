module 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::slot_swap_turbos {
    public entry fun swap_turbos<T0, T1, T2>(arg0: &mut 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::slot::Slot, arg1: u64, arg2: bool, arg3: u64, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg5: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg6: &0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::platform::Platform, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            0x2::coin::join<T0>(&mut v0, 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::slot::take_from_balance_with_permission<T0>(arg0, arg1, arg6, arg7, arg8));
        } else {
            0x2::coin::join<T1>(&mut v1, 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::slot::take_from_balance_with_permission<T1>(arg0, arg1, arg6, arg7, arg8));
        };
        let (v2, v3) = 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::turbos_clmm_protocol::swap<T0, T1, T2>(arg4, v0, v1, arg5, arg7, arg8);
        if (arg3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::slot::take_from_balance_with_permission<0x2::sui::SUI>(arg0, arg3, arg6, arg7, arg8), 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::platform::get_address(arg6));
        };
    ...
    public entry fun swap_with_base<T0, T1>(arg0: &mut 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::slot::Slot, arg1: u64, arg2: bool, arg3: &mut 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::bank::Bank, arg4: &mut 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::fee::FeeManager, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, 0x2::sui::SUI, T1>, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: &0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::platform::Platform, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::turbos_clmm_protocol::swap<T0, 0x2::sui::SUI, T1>(arg8, v1, v0, arg9, arg11, arg12);
        let v4 = v3;
        if (!arg2) {
