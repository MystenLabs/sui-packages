module 0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::slot {
    ...
    public(friend) fun take_from_balance_with_permission<T0>(arg0: &mut Slot, arg1: u64, arg2: &0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::platform::Platform, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        if (!0xf196e157834f4407b824bb83ab626824493c4deeebf075db47bab584e7666644::platform::has_permission(arg2, owner(arg0), arg3, arg4)) {
