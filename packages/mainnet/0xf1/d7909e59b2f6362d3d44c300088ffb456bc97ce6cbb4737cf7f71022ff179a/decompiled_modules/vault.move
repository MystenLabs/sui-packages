module 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::vault {
    ...
    public fun rebalance<T0, T1, T2>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::OperatorCap, arg1: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg2: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg3: &mut Strategy, arg4: 0x2::object::ID, arg5: bool, arg6: bool, arg7: u32, arg8: bool, arg9: u32, arg10: bool, arg11: u32, arg12: bool, arg13: u32, arg14: bool, arg15: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg16: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg17: &0x2::clock::Clock, arg18: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg19: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = get_vault_base_clmm_position_id(arg3, arg4);
        let v9 = get_vault_base_liquidity(arg3, arg4);
        let v10 = get_vault_limit_clmm_position_id(arg3, arg4);
        let v11 = get_vault_limit_liquidity(arg3, arg4);
        let v12 = get_vault_base_last_tick_index(arg3, arg4);
        get_vault_limit_last_tick_index(arg3, arg4);
        if (is_clmm_limit_nft_exists(arg3, arg4)) {
            let v13 = borrow_mut_clmm_limit_nft(arg3, arg4);
            let (_, _, v16) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v13));
            if (v16 > 0) {
                let (v17, v18) = decrease_clmm_liquidity<T0, T1, T2>(v13, arg15, arg16, v16, arg17, arg18, arg19);
                v11 = 0;
                merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v17));
                merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v18));
            };
        ...
        if (is_clmm_base_nft_exists(arg3, arg4)) {
            if (arg6) {
                if (calculate_liquidity(v6, v0, v2, get_vault_balance<T0>(arg3, arg4), get_vault_balance<T1>(arg3, arg4)) > 0) {
                    let v21 = take_vault_balance<T0>(arg3, arg4);
                    let v22 = 0x2::coin::from_balance<T0>(v21, arg19);
                    let v23 = take_vault_balance<T1>(arg3, arg4);
                    let v24 = 0x2::coin::from_balance<T1>(v23, arg19);
                    let (v25, v26, v27, v28, v29) = increase_clmm_liquidity<T0, T1, T2>(arg3, arg4, true, arg15, arg16, v22, v24, arg17, arg18, arg19);
                    v9 = v29;
                    v3 = v28;
                    v1 = v27;
                    merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v25));
                    merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v26));
                };
            } else {
                let v30 = borrow_mut_clmm_base_nft(arg3, arg4);
                let (_, _, v33) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v30));
                let (v34, v35) = decrease_clmm_liquidity<T0, T1, T2>(v30, arg15, arg16, v33, arg17, arg18, arg19);
                merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v34));
                merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v35));
                burn_clmm_base_nft<T0, T1, T2>(arg3, arg4, arg16, arg18, arg19);
                v9 = 0;
                if (calculate_liquidity(v6, v0, v2, get_vault_balance<T0>(arg3, arg4), get_vault_balance<T1>(arg3, arg4)) > 0) {
                    let v36 = take_vault_balance<T0>(arg3, arg4);
                    let v37 = 0x2::coin::from_balance<T0>(v36, arg19);
                    let v38 = take_vault_balance<T1>(arg3, arg4);
                    let v39 = 0x2::coin::from_balance<T1>(v38, arg19);
                    let (v40, v41, v42) = mint_clmm_liquidity<T0, T1, T2>(arg15, arg16, v37, v39, v0, v2, arg17, arg18, arg19);
                    let v43 = v40;
                    merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v41));
                    merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v42));
                    let (_, _, v46) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&v43));
                    v9 = v46;
                    v8 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::position_id(&v43);
                    fill_clmm_base_nft(arg3, arg4, v43);
                };
                v12 = v7;
            };
        } else {
            if (calculate_liquidity(v6, v0, v2, get_vault_balance<T0>(arg3, arg4), get_vault_balance<T1>(arg3, arg4)) > 0) {
                let v47 = take_vault_balance<T0>(arg3, arg4);
                let v48 = 0x2::coin::from_balance<T0>(v47, arg19);
                let v49 = take_vault_balance<T1>(arg3, arg4);
                let v50 = 0x2::coin::from_balance<T1>(v49, arg19);
                let (v51, v52, v53) = mint_clmm_liquidity<T0, T1, T2>(arg15, arg16, v48, v50, v0, v2, arg17, arg18, arg19);
                let v54 = v51;
                merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v52));
                merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v53));
                let (_, _, v57) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&v54));
                v9 = v57;
                v8 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::position_id(&v54);
                fill_clmm_base_nft(arg3, arg4, v54);
            };
            v12 = v7;
        };
        let v58 = get_vault_balance<T0>(arg3, arg4);
        let v59 = get_vault_balance<T1>(arg3, arg4);
        let v60 = floor_tick_index(v7, arg3.tick_spacing, true);
        let v61 = floor_tick_index(v7, arg3.tick_spacing, false);
        let v62 = calculate_liquidity(v6, v4, v60, v58, v59);
        let v63 = calculate_liquidity(v6, v61, v5, v58, v59);
        if (v62 > 0 || v63 > 0) {
            let (v64, v65) = if (v62 > v63) {
                (v4, v60)
            } else {
                (v61, v5)
            };
            v19 = v65;
            v20 = v64;
            let v66 = take_vault_balance<T0>(arg3, arg4);
            let v67 = 0x2::coin::from_balance<T0>(v66, arg19);
            let v68 = take_vault_balance<T1>(arg3, arg4);
            let v69 = 0x2::coin::from_balance<T1>(v68, arg19);
            let (v70, v71, v72) = mint_clmm_liquidity<T0, T1, T2>(arg15, arg16, v67, v69, v64, v65, arg17, arg18, arg19);
            let v73 = v70;
            let (_, _, v76) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg16, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(&v73));
            v11 = v76;
            v10 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::position_id(&v73);
            fill_clmm_limit_nft(arg3, arg4, v73);
            merge_vault_balance<T0>(arg3, arg4, 0x2::coin::into_balance<T0>(v71));
            merge_vault_balance<T1>(arg3, arg4, 0x2::coin::into_balance<T1>(v72));
        };
        update_vault_info_with_tick_range(arg3, arg4, v8, v1, v3, v9, v10, v20, v19, v11, v6, v12, v7);
        update_strategy_reward_info(arg2, arg3, arg4, arg17);
        let v77 = CheckRebalance{
            vault_id           : arg4,
            rebalance          : arg5,
            base_lower_index   : v1,
            base_upper_index   : v3,
            base_just_increase : arg6,
            limit_lower_index  : v20,
            limit_upper_index  : v19,
        };
        let v78 = RebalanceEvent{
            vault_id       : arg4,
        ...
        0x2::event::emit<RebalanceEvent>(v78);
    }
    ...
    public fun withdraw<T0, T1, T2>(arg0: &0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::config::GlobalConfig, arg1: &mut 0xd7599867e87c3e2d4eacfab112397144b8e3f5918fdfad6e29a893c34a9313af::rewarder::RewarderManager, arg2: &mut Strategy, arg3: &mut Vault, arg4: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Pool<T0, T1, T2>, arg5: &mut 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::Positions, arg6: u64, arg7: bool, arg8: &0x2::clock::Clock, arg9: &0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::pool::Versioned, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v2 = 0x2::coin::zero<T0>(arg10);
        let v3 = 0x2::coin::zero<T1>(arg10);
        let v4 = 0;
        let v5 = is_clmm_base_nft_exists(arg2, v1);
        if (v5) {
            let v6 = borrow_mut_clmm_base_nft(arg2, v1);
            let (_, _, v9) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v6));
            if (v9 > 0) {
                let (v10, v11) = decrease_clmm_liquidity<T0, T1, T2>(v6, arg4, arg5, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::mul_div_floor(v9, (arg6 as u128), (1000000 as u128)), arg8, arg9, arg10);
                let (_, _, v14) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v6));
                v4 = v14;
        ...
        let v15 = 0;
        let v16 = is_clmm_limit_nft_exists(arg2, v1);
        if (v16) {
            let v17 = borrow_mut_clmm_limit_nft(arg2, v1);
            let (_, _, v20) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v17));
            if (v20 > 0) {
                let (v21, v22) = decrease_clmm_liquidity<T0, T1, T2>(v17, arg4, arg5, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u128::mul_div_floor(v20, (arg6 as u128), (1000000 as u128)), arg8, arg9, arg10);
                let (_, _, v25) = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_manager::get_position_info(arg5, 0x2::object::id_address<0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::position_nft::TurbosPositionNFT>(v17));
                v15 = v25;
                0x2::coin::join<T0>(&mut v2, v21);
                0x2::coin::join<T1>(&mut v3, v22);
            };
        };
        let v26 = vault_balance_amount<T1>(arg2, v1);
        let v27 = 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u64::mul_div_floor(vault_balance_amount<T0>(arg2, v1), arg6, 1000000);
        let v28 = take_vault_balance_by_amount<T0>(arg2, v1, v27);
        let v29 = take_vault_balance_by_amount<T1>(arg2, v1, 0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1::full_math_u64::mul_div_floor(v26, arg6, 1000000));
        0x2::coin::join<T0>(&mut v2, 0x2::coin::from_balance<T0>(v28, arg10));
        0x2::coin::join<T1>(&mut v3, 0x2::coin::from_balance<T1>(v29, arg10));
        let v30 = arg2.protocol_fee_rate;
        let (v31, v32) = if (v30 == 0) {
            ...
            merge_protocol_asset<T0>(arg2, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v2, v33, arg10)));
            merge_protocol_asset<T1>(arg2, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v3, v34, arg10)));
            (v33, v34)
        };
        if (arg7 && arg6 == 1000000) {
            if (v5) {
        ...
        update_vault_info(arg2, v1, v4, v15, v0);
