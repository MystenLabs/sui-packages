module 0xf182bc004d2ac6bfe6dbf12c1eacc37c26bce51ee8c9d5d3213ca2b098a16d66::cnsnft4784 {
    struct CNSNFT4784 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4784, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4784>(arg0, arg1);
