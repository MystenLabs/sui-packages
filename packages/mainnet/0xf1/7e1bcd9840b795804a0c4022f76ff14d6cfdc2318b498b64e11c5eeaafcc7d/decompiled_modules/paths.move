module 0xf17e1bcd9840b795804a0c4022f76ff14d6cfdc2318b498b64e11c5eeaafcc7d::paths {
        ...
        while (v1 < 0x1::vector::length<PriceNode>(arg1)) {
            ...
            if (v4 > 0) {
                ...
                while (v5 < v4) {
                    ...
                    let v8 = 0xf17e1bcd9840b795804a0c4022f76ff14d6cfdc2318b498b64e11c5eeaafcc7d::arithmetic::mul_128(0x1::vector::borrow<Route>(&v3, v5).sqrtPrice, v2.sqrtPrice);
                    if (v8 > v7 || v6 < arg2) {
