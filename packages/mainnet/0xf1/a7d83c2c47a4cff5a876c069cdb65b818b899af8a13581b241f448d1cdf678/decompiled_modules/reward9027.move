module 0xf1a7d83c2c47a4cff5a876c069cdb65b818b899af8a13581b241f448d1cdf678::reward9027 {
    struct REWARD9027 has drop {
        dummy_field: bool,
    }

    struct TICKET_9027 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9027(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9027>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9027>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9027, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9027>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9027>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9027>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9027>>(v5, 0x2::tx_context::sender(arg1));
    }
