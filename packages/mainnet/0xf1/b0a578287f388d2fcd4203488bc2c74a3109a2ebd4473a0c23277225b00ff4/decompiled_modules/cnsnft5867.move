module 0xf1b0a578287f388d2fcd4203488bc2c74a3109a2ebd4473a0c23277225b00ff4::cnsnft5867 {
    struct CNSNFT5867 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5867, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6036"));
        let v4 = 0x2::package::claim<CNSNFT5867>(arg0, arg1);
