module 0xa6171d15bdbf19c187cba7dbda031c0e1f367f5753e6056eeb7ce648288d8e66::reward8280 {
    struct REWARD8280 has drop {
        dummy_field: bool,
    }

    struct TICKET_8280 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8280(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8280>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8280>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8280, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8280>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8280>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8280>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8280>>(v5, 0x2::tx_context::sender(arg1));
    }
