module 0xa63a8692c56dc8ee10d20e238b23f5e9ec04155d5020b2ff15baeb316b370a22::pepe_on_sui_og_collection {
    ...
    fun init(arg0: PEPE_ON_SUI_OG_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PEPE_ON_SUI_OG_COLLECTION>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pepe on Sui OG Collection"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibwvkqoop6nk4nu2uadiew7flw3ibixdwsacvyzcsvf3lldsmti7e"));
