module 0xa60f1a615f56876b450d057529892eb1b2ac043cd40d8ff8c9d535765d6c6099::reward2229 {
    struct REWARD2229 has drop {
        dummy_field: bool,
    }

    struct TICKET_2229 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2229(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2229>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2229>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2229, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2229>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2229>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2229>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2229>>(v5, 0x2::tx_context::sender(arg1));
    }
