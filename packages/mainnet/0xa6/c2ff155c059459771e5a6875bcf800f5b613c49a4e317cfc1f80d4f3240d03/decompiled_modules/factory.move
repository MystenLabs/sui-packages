module 0xbcf1564932be855733bd9c1b13e4926206729e685f44bfbb9907a46074ea3bf3::factory {
    ...
    public fun create_pool<T0, T1>(arg0: &mut Factory, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xbcf1564932be855733bd9c1b13e4926206729e685f44bfbb9907a46074ea3bf3::lp_coin::LP<T0, T1>> {
        ...
        let (v2, v3) = 0xbcf1564932be855733bd9c1b13e4926206729e685f44bfbb9907a46074ea3bf3::pool::create_pool<T0, T1>(arg2, arg3, arg0.fee_collector, arg4);
        let v4 = v2;
        let v5 = 0x2::object::id_address<0xbcf1564932be855733bd9c1b13e4926206729e685f44bfbb9907a46074ea3bf3::pool::Pool<T0, T1>>(&v4);
        0x2::table::add<PairKey, address>(&mut arg0.pools, v0, v5);
        0xbcf1564932be855733bd9c1b13e4926206729e685f44bfbb9907a46074ea3bf3::pool::share_pool<T0, T1>(v4);
        let v6 = PoolCreated{
            pool_id  : v5,
            coin_a   : v0.coin_a,
            coin_b   : v0.coin_b,
