module 0xa6aaa7cad356c0e74acd5047db87217bfb10e18a8f2a71ccdcc6be62e1aa9908::oracle {
    ...
    public fun update_price(arg0: &mut KriyaOracle, arg1: &mut 0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg2: 0x1::type_name::TypeName) {
        let (v0, v1) = 0xa6aaa7cad356c0e74acd5047db87217bfb10e18a8f2a71ccdcc6be62e1aa9908::supra_adapter::get_supra_price(arg1, *0x2::table::borrow<0x1::type_name::TypeName, u32>(&arg0.supra_pair_ids, arg2));
        assert!(v0 > 0, 0);
        let v2 = Price{
            price      : v0,
            updated_at : v1,
