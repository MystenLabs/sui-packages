module 0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::pools {
    ...
    public fun create_reward_pool<T0>(arg0: &0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::manager::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_reward_pool_game<T0, T1>(arg0: &0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::manager::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_reward<T0>(arg0: &0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::manager::TreasureCap, arg1: 0x2::coin::Coin<T0>, arg2: &mut RewardPool<T0>, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun deposit_reward_pool_game<T0, T1>(arg0: &0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::manager::TreasureCap, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut RewardPoolGame<T0, T1>, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun emergency_reward_withdraw<T0>(arg0: &0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::manager::TreasureCap, arg1: &mut RewardPool<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun emergency_reward_withdraw_pool_game<T0, T1>(arg0: &0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::manager::TreasureCap, arg1: &mut RewardPoolGame<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
    ...
    public(friend) fun transfer_reward_checkin<T0>(arg0: &mut 0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::archive::UserArchive, arg1: u64, arg2: &mut RewardPool<T0>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0xa6a641454327f341e3b014d6891e0cee0538fbd0cd92db9be79c237bdb9acf75::archive::inc_checkin_reward(arg0, arg1)
    }
    ...
    public(friend) fun transfer_reward_misson<T0>(arg0: &mut RewardPool<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
