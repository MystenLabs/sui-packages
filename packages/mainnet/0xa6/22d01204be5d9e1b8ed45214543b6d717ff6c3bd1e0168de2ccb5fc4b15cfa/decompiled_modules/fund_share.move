module 0xa622d01204be5d9e1b8ed45214543b6d717ff6c3bd1e0168de2ccb5fc4b15cfa::fund_share {
    ...
    public(friend) fun burn<T0>(arg0: BurnRequest<T0>, arg1: FundShare) {
        let BurnRequest { fund_id: v0 } = arg0;
        assert_if_fund_id_not_matched(&arg1, v0);
        let FundShare {
            id              : v1,
            fund_id         : _,
            is_init         : _,
    ...
    public(friend) fun create_burn_request<T0>(arg0: &0xa622d01204be5d9e1b8ed45214543b6d717ff6c3bd1e0168de2ccb5fc4b15cfa::config::GlobalConfig, arg1: 0x2::object::ID) : BurnRequest<T0> {
    ...
    public(friend) fun create_mint_request<T0>(arg0: &0xa622d01204be5d9e1b8ed45214543b6d717ff6c3bd1e0168de2ccb5fc4b15cfa::config::GlobalConfig, arg1: 0x2::object::ID, arg2: bool, arg3: address, arg4: 0x1::string::String, arg5: u64, arg6: address, arg7: address) : MintRequest<T0> {
        0xa622d01204be5d9e1b8ed45214543b6d717ff6c3bd1e0168de2ccb5fc4b15cfa::config::assert_if_version_not_matched(arg0, 1);
        MintRequest<T0>{
            fund_id         : arg1,
            is_init         : arg2,
    ...
    public fun mint<T0>(arg0: &mut 0xa622d01204be5d9e1b8ed45214543b6d717ff6c3bd1e0168de2ccb5fc4b15cfa::config::GlobalConfig, arg1: MintRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : FundShare {
        0xa622d01204be5d9e1b8ed45214543b6d717ff6c3bd1e0168de2ccb5fc4b15cfa::config::assert_if_version_not_matched(arg0, 1);
        let MintRequest {
            fund_id         : v0,
            is_init         : v1,
    ...
    public(friend) fun zero(arg0: 0x2::object::ID, arg1: bool, arg2: address, arg3: 0x1::string::String, arg4: u64, arg5: address, arg6: address, arg7: &mut 0x2::tx_context::TxContext) : FundShare {
        FundShare{
