module 0xa66da896777763298f7a678e25cd99d92ff53a5a27df201f4a86225e11117eff::float {
    ...
    public fun int_div(arg0: u64, arg1: Decimal) : u64 {
        0xa66da896777763298f7a678e25cd99d92ff53a5a27df201f4a86225e11117eff::u64::safe_from_u256(1000000000000000000 * (arg0 as u256) / arg1.value)
    }

    public fun int_mul(arg0: Decimal, arg1: u64) : u64 {
        0xa66da896777763298f7a678e25cd99d92ff53a5a27df201f4a86225e11117eff::u64::safe_from_u256(arg0.value * (arg1 as u256) / 1000000000000000000)
    }
