module 0xa0c4bb412c1d6121c1b6a40954ef76c3b1f75248211209e94726496f46a59ce0::iturf {
    ...
    entry fun issue_luca_cap(arg0: &AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = LucaCap{id: 0x2::object::new(arg2)};
        0x2::transfer::public_transfer<LucaCap>(v0, arg1);
    }
    ...
    entry fun rebate_tuf(arg0: &LucaCap, arg1: TurfInformation, arg2: &mut TurfSystem, arg3: &mut MapConfig) {
        let TurfInformation {
            id             : v0,
            x              : v1,
            x_neg          : v2,
        ...
        0x2::table::remove<Coordinates, 0x2::object::ID>(&mut arg2.coordinates_turfs, new_coordinates(v1, v2, v3, v4));
        arg3.turf_count = arg3.turf_count - 1;
    }
