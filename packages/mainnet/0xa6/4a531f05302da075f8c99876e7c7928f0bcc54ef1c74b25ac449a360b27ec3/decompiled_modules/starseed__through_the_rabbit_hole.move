module 0xa64a531f05302da075f8c99876e7c7928f0bcc54ef1c74b25ac449a360b27ec3::starseed__through_the_rabbit_hole {
    struct STARSEED__THROUGH_THE_RABBIT_HOLE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STARSEED__THROUGH_THE_RABBIT_HOLE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STARSEED__THROUGH_THE_RABBIT_HOLE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"STARSEED: THROUGH THE RABBIT HOLE"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A journey through curiosity, mystery, nostalgia, and the unknown. STARSEED: THROUGH THE RABBIT HOLE is a collection of unique digital artworks following Starseed across worlds where science, myth, imagination, pop culture, and real questions collide. Look closer. Question everything."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeidelikjuywsx52k5zyiy7pknej6poalw2y3g3jzrrqd3lvqkenwqy"));
