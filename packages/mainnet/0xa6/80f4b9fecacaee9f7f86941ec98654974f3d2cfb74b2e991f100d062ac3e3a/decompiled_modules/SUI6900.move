module 0xa680f4b9fecacaee9f7f86941ec98654974f3d2cfb74b2e991f100d062ac3e3a::SUI6900 {
    ...
    fun init(arg0: SUI6900, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUI6900>(arg0, 0, b"SUI6900", b"SUI 6900", b"CoinDesc", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"ICON_URL")), arg1);
