module 0xa6a36114ffceede4cbfbb80b63ee42df2c7852b5fe99886c96a365bc7a89ea8f::cnsnft8134 {
    struct CNSNFT8134 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8134, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8134>(arg0, arg1);
