module 0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::vault {
    ...
    public entry fun burn_sgc<T0>(arg0: &mut AdminAddr_fee, arg1: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::SGC>>(0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::mini_swap::swap<0x2::sui::SUI, 0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::SGC>(arg1, 0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::mini_swap::swap<T0, 0x2::sui::SUI>(arg1, v0, arg2), arg2), @0x0);
    }
    ...
    public entry fun deposit_fee<T0>(arg0: &mut AdminAddr_fee, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x2::dynamic_field::exists_with_type<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.id, key_of<T0>())) {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg0.id, key_of<T0>()), 0x2::coin::into_balance<T0>(arg1));
        } else {
            0x2::dynamic_field::add<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg0.id, key_of<T0>(), 0x2::coin::into_balance<T0>(arg1));
        };
    }

    public entry fun entry_get_sgc_coin<T0>(arg0: &mut 0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::Minter, arg1: &mut 0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg4) / 1000;
        0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg5)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg5))) / arg3.sgc_weight, arg5);
    ...
    fun get_sgc_coin<T0>(arg0: &mut 0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::Minter, arg1: &mut 0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg5) / 1000;
        if (arg4) {
            0x42f17fbb971bc4b9544fdf40c7a2ecadcdd03c154ffef6abe172de6502b8323e::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg6)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg6))) / arg3.sgc_weight, arg6);
    ...
    entry fun withdraw_burning_sgaaaaaaaaaac(arg0: &mut AdminAddr_fee, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::dynamic_field::exists_with_type<0x1::ascii::String, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.id, key_of<0x2::sui::SUI>()), 9);
        let v0 = 0x2::coin::from_balance<0x2::sui::SUI>(0x2::dynamic_field::remove<0x1::ascii::String, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.id, key_of<0x2::sui::SUI>()), arg1);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v0) > 0, 10);
    ...
    fun withdraw_burning_sgc<T0>(arg0: &mut AdminAddr_fee, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::dynamic_field::exists_with_type<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.id, key_of<T0>()), 9);
        let v0 = 0x2::coin::from_balance<T0>(0x2::dynamic_field::remove<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg0.id, key_of<T0>()), arg1);
        assert!(0x2::coin::value<T0>(&v0) > 0, 10);
        v0
    }
