module 0xa6819402b4c5885676b069ec41204e5540675860e000a4b080b4c9b3cd8cd7db::cnsnft6531 {
    struct CNSNFT6531 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6531, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6531>(arg0, arg1);
