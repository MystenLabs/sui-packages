module 0xa615aa0c084248f062c8e65ef60fbbb7614d1a54f492d3bccadb1f687ad813d7::astrobats_again {
    struct ASTROBATS_AGAIN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ASTROBATS_AGAIN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ASTROBATS_AGAIN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"AstroBats Again"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Relaunching AstroBats because some guy in Arkansas minted them all."));
