module 0xa673a0369a0c834d2ae4fd8ca721926041d1ea999c5a59ee9c05cd5b0d726cbf::reward4953 {
    struct REWARD4953 has drop {
        dummy_field: bool,
    }

    struct TICKET_4953 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4953(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4953>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4953>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4953, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4953>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4953>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4953>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4953>>(v5, 0x2::tx_context::sender(arg1));
    }
