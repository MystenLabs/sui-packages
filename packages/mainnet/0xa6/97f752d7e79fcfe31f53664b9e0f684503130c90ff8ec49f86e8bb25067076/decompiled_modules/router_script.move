module 0xa697f752d7e79fcfe31f53664b9e0f684503130c90ff8ec49f86e8bb25067076::router_script {
    public entry fun cetus<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: vector<0x2::coin::Coin<T1>>, arg3: u128, arg4: u128, arg5: u64, arg6: u32, arg7: u32, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut v0;
        cetus_swap<T0, T1>(arg0, arg1, v1, arg8, arg3, arg4, arg9, arg10);
        let v2 = &mut v0;
        cetus_liquidity<T0, T1>(arg0, arg1, v2, arg6, arg7, arg5, arg9, arg10);
    ...
    public entry fun deepbook<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: vector<0x2::coin::Coin<T0>>, arg3: vector<0x2::coin::Coin<T1>>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T0>(arg2, arg5);
        let v1 = 0x2::coin::split<T0>(&mut v0, 5000000000, arg5);
        let v2 = merge_coins<T1>(arg3, arg5);
        let v3 = 0xdee9::clob_v2::create_account(arg5);
        0xdee9::clob_v2::deposit_base<T0, T1>(arg0, v1, &v3);
        0xdee9::clob_v2::deposit_quote<T0, T1>(arg0, 0x2::coin::split<T1>(&mut v2, 5000000, arg5), &v3);
        let (v4, v5, _) = 0xdee9::clob_v2::swap_exact_base_for_quote<T0, T1>(arg0, arg1, &v3, 5000000000, 0xdee9::clob_v2::withdraw_base<T0, T1>(arg0, 5000000000, &v3, arg5), 0x2::coin::zero<T1>(arg5), arg4, arg5);
        let v7 = v5;
        0x2::coin::join<T0>(&mut v0, v4);
        let (v8, v9, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg0, arg1, &v3, 0x2::coin::value<T1>(&v7), arg4, v7, arg5);
        0x2::coin::join<T0>(&mut v0, v8);
        0x2::coin::join<T1>(&mut v2, 0xdee9::clob_v2::withdraw_quote<T0, T1>(arg0, 5000000, &v3, arg5));
        0x2::coin::join<T1>(&mut v2, v9);
        send_coin<T0>(v0, 0x2::tx_context::sender(arg5));
        send_coin<T1>(v2, 0x2::tx_context::sender(arg5));
        0x2::transfer::public_transfer<0xdee9::custodian_v2::AccountCap>(v3, 0x2::tx_context::sender(arg5));
    }
    ...
    public entry fun navi<T0>(arg0: &0xa9cdb9d8e80465c75dcdad061cf1d462a9cf662da071412ca178d579d8df2855::version::Version, arg1: &mut 0xa9cdb9d8e80465c75dcdad061cf1d462a9cf662da071412ca178d579d8df2855::market::Market, arg2: vector<0x2::coin::Coin<T0>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T0>(arg2, arg4);
        send_coin<T0>(0xa9cdb9d8e80465c75dcdad061cf1d462a9cf662da071412ca178d579d8df2855::redeem::redeem<T0>(arg0, arg1, 0xa9cdb9d8e80465c75dcdad061cf1d462a9cf662da071412ca178d579d8df2855::mint::mint<T0>(arg0, arg1, v0, arg3, arg4), arg3, arg4), 0x2::tx_context::sender(arg4));
    }

    public entry fun scallop<T0>(arg0: &0x2::clock::Clock, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: u8, arg5: vector<0x2::coin::Coin<T0>>, arg6: u64, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = merge_coins<T0>(arg5, arg8);
        0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::deposit<T0>(arg0, arg1, arg3, arg4, 0x2::coin::split<T0>(&mut v0, arg6, arg8), arg6, arg7, arg8);
