module 0x6221afb1dbd7647aeeebc2d9a9a473ee1c077183298f1f3739302951afc66d26::alphafi_lyf_investor {
    ...
    public(friend) fun autocompound_internal<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &mut 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::LendingProtocol, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, bool) {
        ...
        assert!(0x1::vector::length<0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::rewards::ClaimableReward>(&v11) == 0, 13906838065583751167);
    ...
    fun destroy_potatoes<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &mut 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::LendingProtocol, arg2: 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::FlashTransactionHotPotato, arg3: 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::FlashTransactionHotPotato, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<T0>(&v0) == 0, 13906838413476102143);
        assert!(0x2::coin::value<T1>(&v1) == 0, 13906838417771069439);
    ...
    public(friend) fun rebalance_bluefin<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg2: &mut 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::LendingProtocol, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: u32, arg5: u32, arg6: u32, arg7: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        let v3 = get_total_borrowed_in_dollars<T0, T1>(arg0, arg2, arg9);
        let (v4, v5) = calculate_token_amounts_from_dollars<T0, T1>(arg0, v3, arg2, arg7, &v2);
        let v6 = &mut v2;
        withdraw_and_repay<T0, T1>(arg0, v4 + 1, v5 + 1, arg2, arg3, arg7, v6, arg9, arg10);
        ...
        let v7 = 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::remove_bluefin_lp_collateral(arg2, &arg0.position_cap);
        let v8 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg3, arg7, arg4, arg5, arg10);
        let v9 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(&v7);
        let (v10, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_amount_by_liquidity(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.upper_tick), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg7), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg7), v9, false);
        let v12 = arg0.lower_tick;
        let v13 = arg0.upper_tick;
        arg0.lower_tick = arg4;
        arg0.upper_tick = arg5;
        let v14 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg7);
        let (v15, v16) = get_bluefin_sqrt_price_limits<T0, T1>(arg7);
        let v17 = v9 / (arg6 as u128);
        let v18 = v9 % (arg6 as u128);
        let v19 = 0;
        while (v19 < arg6 + 1) {
            if (v19 == arg6) {
                if (v18 == 0) {
            ...
            let (_, _, v22, v23) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg3, arg7, &mut v7, v17, arg9);
            let v24 = v23;
            let v25 = v22;
            ...
            let (v26, v27) = get_total_balance_in_ratio_with_limit_bluefin<T0, T1>(arg0, arg3, v25, v24, arg7, v15, v16, arg9, arg10);
            let (_, v29, v30, v31) = get_balances_in_ratio<T0, T1>(arg0, v26, v27, arg7, true, arg10);
            let v32 = v30;
            let v33 = v29;
            if (0x2::balance::value<T0>(&v33) > 100 || 0x2::balance::value<T1>(&v32) > 100) {
                let (v34, v35) = if (0x2::balance::value<T0>(&v33) == 0 || v31 == false) {
                    let (v36, v37, v38, v39) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg9, arg3, arg7, &mut v8, v33, v32, 0x2::balance::value<T1>(&v32), false);
                    let _ = v37;
                    let _ = v36;
                    (v38, v39)
                } else {
                    let (v42, v43, v44, v45) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg9, arg3, arg7, &mut v8, v33, v32, 0x2::balance::value<T0>(&v33), true);
                    let _ = v43;
                    let _ = v42;
                    (v44, v45)
                };
        ...
        let v46 = &mut v7;
        let (v47, v48, _) = autocompound_internal<T0, T1>(arg0, arg1, arg2, arg3, arg7, v46, arg9, arg10);
        update_free_rewards<T0, T1, T0>(arg0, v47);
        update_free_rewards<T0, T1, T1>(arg0, v48);
        close_position<T0, T1>(arg7, v7, arg3, arg9);
        let v50 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(&v8);
        let (v51, v52) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_amount_by_liquidity(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0.upper_tick), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T0, T1>(arg7), 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_sqrt_price<T0, T1>(arg7), v50, false);
        let v53 = RebalancePoolEvent{
        ...
        let (v54, v55) = get_amounts<T0, T1>(arg0, arg7, &v8);
        let v56 = 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::div(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::mul(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::add(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::mul(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(v54), 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::get_asset_price(arg2, arg0.market_id_a)), 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::mul(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(v55), 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::get_asset_price(arg2, arg0.market_id_b))), arg0.current_debt_to_supply_ratio), 0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::sub(0x9f940d202e7e147ea512d0ea84f5d84cb9575850a95cea485d2fa94eb229d6c0::math::from(1), arg0.current_debt_to_supply_ratio));
        let v57 = &mut v8;
        let (v58, v59) = borrow_and_supply<T0, T1>(arg0, v56, arg2, arg3, arg7, v57, arg8, arg9, arg10);
        0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::add_bluefin_lp_collateral<T0, T1>(arg2, &arg0.position_cap, v8, arg7, arg9, arg10);
        destroy_potatoes<T0, T1>(arg0, arg2, v58, v59, arg9, arg10);
    ...
    public(friend) fun rebalance_debts<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: u64, arg2: bool, arg3: &0xfcadd5525628c306cc87d980c18aec71daa8a51f17a5eba34e3a105eb64a8b7e::distributor::Distributor, arg4: &mut 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::LendingProtocol, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 >= arg0.minimum_swap_amount, 13906839452858187775);
        ...
        if (arg2) {
            ...
            let v12 = v10;
            assert!(0x2::balance::value<T0>(&v12) == 0, 13906839517282697215);
            ...
            let v24 = v23;
            assert!(0x2::balance::value<T1>(&v24) == 0, 13906839590297141247);
    ...
    fun recast_balance_type<T0, T1, T2, T3>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T2>) : 0x2::balance::Balance<T3> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T3>()) == true, 13906838890217471999);
    ...
    public(friend) fun withdraw_and_repay<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: u64, arg2: u64, arg3: &mut 0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::LendingProtocol, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (v11 > 0) {
            ...
            let (v12, v13) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg7, arg4, arg5, 0x2::coin::into_balance<T0>(v7), 0x2::balance::zero<T1>(), true, true, v11, 0, v9);
            let v14 = v12;
            assert!(0x2::balance::value<T0>(&v14) == 0, 13906839190865182719);
            0x2::balance::destroy_zero<T0>(v14);
            let v15 = 0x2::coin::into_balance<T1>(0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::repay<T1>(arg3, &arg0.position_cap, arg0.market_id_b, 0x2::coin::from_balance<T1>(v13, arg8), arg7, arg8));
            update_free_rewards<T0, T1, T1>(arg0, v15);
        } else {
            0x2::coin::destroy_zero<T0>(v7);
            let (v16, v17) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T0, T1>(arg7, arg4, arg5, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(v8), false, true, 0x2::coin::value<T1>(&v8), 0, v10);
            let v18 = v17;
            assert!(0x2::balance::value<T1>(&v18) == 0, 13906839225224921087);
            0x2::balance::destroy_zero<T1>(v18);
            let v19 = 0x2::coin::into_balance<T0>(0xc28e118194bb9900107e2eb690d5787d567614d61140041df67b45a75faeb445::alpha_lending::repay<T0>(arg3, &arg0.position_cap, arg0.market_id_a, 0x2::coin::from_balance<T0>(v16, arg8), arg7, arg8));
            update_free_rewards<T0, T1, T0>(arg0, v19);
        };
    }
