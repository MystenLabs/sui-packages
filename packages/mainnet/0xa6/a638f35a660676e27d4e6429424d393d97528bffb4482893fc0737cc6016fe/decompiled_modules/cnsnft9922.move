module 0xa6a638f35a660676e27d4e6429424d393d97528bffb4482893fc0737cc6016fe::cnsnft9922 {
    struct CNSNFT9922 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9922, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9922>(arg0, arg1);
