module 0xa6698822bddf1ceef834b4ffae5b866fc44e13cfc35f5227d42791126f68f890::pool {
    ...
    struct Vault<phantom T0> has store, key {
        ...
        coin_type_a: 0x1::type_name::TypeName,
        coin_type_b: 0x1::type_name::TypeName,
        buffer_assets: 0xa6698822bddf1ceef834b4ffae5b866fc44e13cfc35f5227d42791126f68f890::balance_bag::BalanceBag,
    ...
    public fun add_coin<T0: drop, T1>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T1>) {
        0xa6698822bddf1ceef834b4ffae5b866fc44e13cfc35f5227d42791126f68f890::balance_bag::join<T1>(&mut arg0.buffer_assets, 0x2::coin::into_balance<T1>(arg1));
    }
    ...
    public fun new_vault<T0, T1>(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
            ...
            coin_type_a   : 0x1::type_name::with_defining_ids<T0>(),
            coin_type_b   : 0x1::type_name::with_defining_ids<T1>(),
            buffer_assets : 0xa6698822bddf1ceef834b4ffae5b866fc44e13cfc35f5227d42791126f68f890::balance_bag::new_balance_bag(arg0),
