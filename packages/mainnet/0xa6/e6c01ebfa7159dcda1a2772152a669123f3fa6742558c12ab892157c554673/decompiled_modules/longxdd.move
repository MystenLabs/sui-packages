module 0xa6e6c01ebfa7159dcda1a2772152a669123f3fa6742558c12ab892157c554673::longxdd {
    struct LONGXDD has drop {
        dummy_field: bool,
    }

    fun init(arg0: LONGXDD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LONGXDD>(arg0, 0, b"Longxdd", b"Longxdd", b"Longxdd standard Sui coin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
