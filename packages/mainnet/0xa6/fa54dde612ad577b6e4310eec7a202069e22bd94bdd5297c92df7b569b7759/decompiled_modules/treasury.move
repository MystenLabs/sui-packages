module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury {
    ...
    public(friend) fun deposit_to_manifest_internal(arg0: &mut Vaults, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x2::coin::join<0x2::sui::SUI>(&mut arg0.manifest_buyback, arg1);
    }

    public(friend) fun deposit_to_ops_internal(arg0: &mut Vaults, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x2::coin::join<0x2::sui::SUI>(&mut arg0.ops, arg1);
    }
