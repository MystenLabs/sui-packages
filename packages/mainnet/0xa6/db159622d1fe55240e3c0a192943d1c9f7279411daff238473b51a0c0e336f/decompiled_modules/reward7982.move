module 0xa6db159622d1fe55240e3c0a192943d1c9f7279411daff238473b51a0c0e336f::reward7982 {
    struct REWARD7982 has drop {
        dummy_field: bool,
    }

    struct TICKET_7982 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7982(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7982>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7982>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7982, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7982>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7982>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7982>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7982>>(v5, 0x2::tx_context::sender(arg1));
    }
