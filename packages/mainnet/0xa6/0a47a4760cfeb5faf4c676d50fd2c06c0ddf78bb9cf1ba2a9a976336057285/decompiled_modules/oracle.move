module 0xa60a47a4760cfeb5faf4c676d50fd2c06c0ddf78bb9cf1ba2a9a976336057285::oracle {
    ...
    public fun update_price<T0>(arg0: &mut KriyaOracle, arg1: &mut 0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder) {
        let v0 = 0x1::type_name::get<T0>();
        let (v1, v2) = 0xa60a47a4760cfeb5faf4c676d50fd2c06c0ddf78bb9cf1ba2a9a976336057285::supra_adapter::get_supra_price(arg1, *0x2::table::borrow<0x1::type_name::TypeName, u32>(&arg0.supra_pair_ids, v0));
        assert!(v1 > 0, 0);
        let v3 = Price{
            price      : v1,
            updated_at : v2,
