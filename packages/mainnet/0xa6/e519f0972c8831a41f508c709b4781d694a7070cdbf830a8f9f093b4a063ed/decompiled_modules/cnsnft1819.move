module 0xa6e519f0972c8831a41f508c709b4781d694a7070cdbf830a8f9f093b4a063ed::cnsnft1819 {
    struct CNSNFT1819 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1819, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1819>(arg0, arg1);
