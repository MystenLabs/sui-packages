module 0xa6e7b2980111388cb469b2ccb93f55abfd336b6a088b09b4344d4f10f4a42b2b::reward1923 {
    struct REWARD1923 has drop {
        dummy_field: bool,
    }

    struct TICKET_1923 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1923(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1923>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1923>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1923, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1923>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1923>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1923>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1923>>(v5, 0x2::tx_context::sender(arg1));
    }
