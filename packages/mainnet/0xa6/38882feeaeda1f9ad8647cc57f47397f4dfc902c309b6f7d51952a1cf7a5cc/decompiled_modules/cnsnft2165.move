module 0xa638882feeaeda1f9ad8647cc57f47397f4dfc902c309b6f7d51952a1cf7a5cc::cnsnft2165 {
    struct CNSNFT2165 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2165, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9475"));
        let v4 = 0x2::package::claim<CNSNFT2165>(arg0, arg1);
