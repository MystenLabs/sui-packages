module 0xa653f8b58d59c14596011927175185d9f3063aa02293e63e1650a93762446ca2::scallop_box {
    ...
    fun get_image_url(arg0: u64) : 0x1::string::String {
        if (arg0 == 1) {
            0x1::string::utf8(b"bafkreia6qrn2tqbw25mvavpi3px7pyp3j37y3y6hrjtt2xgtbnqftoz3ti")
        } else if (arg0 == 2) {
            0x1::string::utf8(b"bafkreiebemcoorsjafwnp2oma45xqtkmj32ec4mpe6ahea2t5r4imimso4")
        } else if (arg0 == 3) {
            0x1::string::utf8(b"bafkreibq3w2kpmft66bozwk7ai7fkqr4znn665kziiebsatn4z36rleg7a")
        } else if (arg0 == 4) {
            0x1::string::utf8(b"bafkreidrw4ztkm5gwpwcwyfz6p6nwtbnapxg6xxmpc2qs6idte6euoewly")
        } else if (arg0 == 5) {
            0x1::string::utf8(b"bafkreicj5dgxywxkcwlodlnrlwwa5hzxrucaytxyg4owohjzs24n3pcpxq")
        } else {
            assert!(arg0 == 6, 0);
            0x1::string::utf8(b"bafkreigj7nqcpzvijygtn5cohtvhpv2p6jgdp6wrykjowojw2vjf6wtp24")
        }
    }
