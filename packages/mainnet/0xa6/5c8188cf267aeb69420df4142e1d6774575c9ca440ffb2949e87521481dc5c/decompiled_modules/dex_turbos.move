module 0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::dex_turbos {
    ...
    fun call_turbos_swap_a_b(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = TurbosSwapExecuted{
            ...
            amount_in      : arg2,
            min_amount_out : arg3,
            pool_id        : 0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::constants::turbos_sui_usdc_pool(),
    ...
    public fun get_pool_config() : address {
        0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::constants::turbos_sui_usdc_pool()
    }
