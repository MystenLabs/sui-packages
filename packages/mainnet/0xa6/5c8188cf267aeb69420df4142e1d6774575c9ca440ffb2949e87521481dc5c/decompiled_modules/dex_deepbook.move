module 0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::dex_deepbook {
    ...
    fun call_deepbook_swap_exact_base_for_quote(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = DeepBookSwapExecuted{
            ...
            method         : b"swap_exact_base_for_quote_worker3_v3_6param_corrected",
        };
        0x2::event::emit<DeepBookSwapExecuted>(v1);
    }
    ...
    public fun get_deep_token_package() : address {
        0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::constants::deep_token_package()
    }

    public fun get_deepbook_config() : (address, address, address) {
        (0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::constants::deepbook_package(), 0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::constants::deepbook_registry(), 0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::constants::deepbook_treasury())
    }
    ...
    public fun swap_sui_to_usdc<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0 > 0, 3401);
        assert!(arg0 == 0xa65c8188cf267aeb69420df4142e1d6774575c9ca440ffb2949e87521481dc5c::constants::deepbook_sui_usdc_pool(), 3403);
