module 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::rip_station {
    ...
    struct Store has store, key {
        ...
        vaults: 0x2::table::Table<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>,
    ...
    entry fun init_card_type<T0: store + key>(arg0: &mut Store, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == 0x1::type_name::with_defining_ids<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(), 14);
        let (v1, v2) = 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::init_card_type(arg1, arg2);
        0x2::bag::add<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>>(&mut arg0.transfer_policies, v0, v1);
        0x2::bag::add<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicyCap<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>>(&mut arg0.transfer_policy_caps, v0, v2);
    }
    ...
    entry fun burn_cards(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: vector<0x2::object::ID>, arg4: u64, arg5: vector<u8>, arg6: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&arg1.vaults, arg2), 10);
        let v2 = 0x2::table::borrow_mut<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&mut arg1.vaults, arg2);
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            let v4 = *0x1::vector::borrow<0x2::object::ID>(&arg3, v3);
            assert!(0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::card_type(v2) == 0x1::type_name::with_defining_ids<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(), 14);
            0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::burn_card(0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::remove_by_id<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(v2, v4), false);
    ...
    entry fun buy_packs_with_personal_kiosk(arg0: &0x2::random::Random, arg1: &mut Store, arg2: 0x1::string::String, arg3: u64, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg7: &mut 0x2::tx_context::TxContext) : vector<0x2::object::ID> {
        verify_version(arg1);
        assert!(0x2::table::contains<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&arg1.vaults, arg2), 10);
        let v0 = 0x2::table::borrow_mut<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&mut arg1.vaults, arg2);
        ...
        while (arg3 > 0) {
            ...
            while (v5 < v1.pack_size) {
                assert!(0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::card_type(v0) == 0x1::type_name::with_defining_ids<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(), 14);
                let v6 = 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::remove_by_index<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(v0, 0x2::random::generate_u64_in_range(v3, 0, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::length(v0) - 1));
                0x1::vector::push_back<0x2::object::ID>(&mut v4, 0x2::object::id<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(&v6));
                0x2::kiosk::lock<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(arg5, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg6), 0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>>(&arg1.transfer_policies, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::card_type(v0)), v6);
                v5 = v5 + 1;
            };
    ...
    entry fun deposit_card_for_reveal<T0: store + key>(arg0: &Store, arg1: 0x2::object::ID, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 == 0x1::type_name::with_defining_ids<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(), 14);
        let (v2, v3) = 0x2::kiosk::purchase_with_cap<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(arg2, 0x2::kiosk::list_with_purchase_cap<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(arg2, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg3), arg1, 0, arg4), 0x2::coin::zero<0x2::sui::SUI>(arg4));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>>(&arg0.transfer_policies, v1), v3);
        let v7 = RipStationRevealExt{dummy_field: false};
        let v8 = RevealTicket{card_id: arg1};
        0x2::bag::add<RevealTicket, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(0x2::kiosk_extension::storage_mut<RipStationRevealExt>(v7, arg2), v8, v2);
    ...
    fun init(arg0: RIP_STATION, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Store{
            ...
            vaults               : 0x2::table::new<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(arg1),
    ...
    entry fun mint_cards(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: vector<0x1::string::String>, arg3: vector<vector<u8>>, arg4: 0x1::string::String, arg5: u64, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&arg1.vaults, arg4), 10);
        let v2 = 0x2::table::borrow_mut<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&mut arg1.vaults, arg4);
        ...
        while (v5 < v4) {
            assert!(0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::card_type(v2) == 0x1::type_name::with_defining_ids<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(), 14);
            let v6 = 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::mint_card(v3.placeholder_name, v3.placeholder_description, v3.placeholder_media_url, 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>(), *0x1::vector::borrow<vector<u8>>(&arg3, v5), false, arg7);
            0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::add<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(v2, v6);
            let v7 = CardMintedEvent{
                id         : *0x1::vector::borrow<0x1::string::String>(&arg2, v5),
                card_id    : 0x2::object::id<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(&v6),
                vault_name : arg4,
            };
    ...
    public fun redeem_card<T0: store + key>(arg0: &Store, arg1: &mut RedeemCardsRequest, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 == 0x1::type_name::with_defining_ids<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(), 14);
        let (v3, v4) = 0x2::kiosk::purchase_with_cap<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(arg3, 0x2::kiosk::list_with_purchase_cap<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(arg3, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg4), arg2, 0, arg5), 0x2::coin::zero<0x2::sui::SUI>(arg5));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>>(&arg0.transfer_policies, v2), v4);
        0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::burn_card(v3, true);
    ...
    entry fun reveal_and_return<T0: store + key>(arg0: &Store, arg1: 0x2::object::ID, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: vector<0x1::string::String>, arg6: vector<0x1::string::String>, arg7: vector<u8>, arg8: &mut 0x2::kiosk::Kiosk, arg9: &0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::bag::remove<RevealTicket, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(v2, v3);
        0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::reveal_card(&mut v4, arg2, arg3, arg4, 0x2::vec_map::from_keys_values<0x1::string::String, 0x1::string::String>(arg5, arg6), arg7);
        let v5 = RipStationRevealExt{dummy_field: false};
        0x2::kiosk_extension::lock<RipStationRevealExt, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(v5, arg8, v4, 0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>>(&arg0.transfer_policies, v0));
    ...
    entry fun sell_card<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: u128, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: &mut 0x2::kiosk::Kiosk, arg9: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::type_name::with_defining_ids<T0>();
        assert!(v2 == 0x1::type_name::with_defining_ids<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(), 14);
        let (v3, v4) = 0x2::kiosk::purchase_with_cap<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(arg8, 0x2::kiosk::list_with_purchase_cap<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(arg8, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg9), arg3, 0, arg10), 0x2::coin::zero<0x2::sui::SUI>(arg10));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::transfer_policy::TransferPolicy<0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::Card>>(&arg1.transfer_policies, v2), v4);
        0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::pokemon::burn_card(v3, true);
    ...
    entry fun set_vault_config<T0: store + key>(arg0: &mut Store, arg1: 0x1::string::String, arg2: bool, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&arg0.vaults, arg1)) {
            0x2::table::add<0x1::string::String, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::Vault>(&mut arg0.vaults, arg1, 0xa6859616548dafef5df0fcd6de7116d44c226f206de06d1a208d440117422b88::vault::new<T0>(arg8));
        };
