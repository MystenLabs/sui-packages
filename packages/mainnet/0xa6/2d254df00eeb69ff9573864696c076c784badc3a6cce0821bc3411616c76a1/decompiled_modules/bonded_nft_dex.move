module 0xa62d254df00eeb69ff9573864696c076c784badc3a6cce0821bc3411616c76a1::bonded_nft_dex {
    ...
    struct Collection has key {
        ...
        twitter: 0x1::option::Option<0x1::string::String>,
        telegram: 0x1::option::Option<0x1::string::String>,
    ...
    public fun create_collection(arg0: &PlatformConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u8, arg12: vector<u8>, arg13: vector<u8>, arg14: vector<u8>, arg15: vector<u8>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg8 == 0;
        let v2 = if (0x1::vector::is_empty<u8>(&arg12)) {
            0x1::option::none<0x1::string::String>()
        } else {
            0x1::option::some<0x1::string::String>(0x1::string::utf8(arg12))
        };
        let v3 = if (0x1::vector::is_empty<u8>(&arg13)) {
            0x1::option::none<0x1::string::String>()
        } else {
            0x1::option::some<0x1::string::String>(0x1::string::utf8(arg13))
        };
        let v4 = if (0x1::vector::is_empty<u8>(&arg14)) {
            0x1::option::none<0x1::string::String>()
        } else {
            0x1::option::some<0x1::string::String>(0x1::string::utf8(arg14))
        };
        let v5 = if (0x1::vector::is_empty<u8>(&arg15)) {
            0x1::option::none<0x1::string::String>()
        } else {
            0x1::option::some<0x1::string::String>(0x1::string::utf8(arg15))
        };
        let v6 = 0x1::vector::empty<0x1::ascii::String>();
        0x1::vector::push_back<0x1::ascii::String>(&mut v6, 0x1::type_name::into_string(0x1::type_name::get_with_original_ids<0x2::sui::SUI>()));
        let v7 = Collection{
            ...
            ft_total_supply        : 0,
            creator                : v0,
            allowed_payment_tokens : v6,
            liquidity_reserves     : 0x2::bag::new(arg16),
            total_liquidity        : 0x2::table::new<0x1::ascii::String, u64>(arg16),
            lp_shares              : 0x2::table::new<0x1::ascii::String, 0x2::bag::Bag>(arg16),
        };
        let v8 = CollectionCreated{
            collection_id     : 0x2::object::id<Collection>(&v7),
            creator           : v0,
            name              : 0x1::string::utf8(arg2),
            token_symbol      : 0x1::string::utf8(arg6),
            max_supply        : arg8,
