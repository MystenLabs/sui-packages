module 0xa64c30d14aa05eb405783dc596d2ebb8ae62ee16397f966c570d0564baaa4173::gift8831 {
    struct GIFT8831 has drop {
        dummy_field: bool,
    }

    struct TICKET_8831 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8831(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8831>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8831>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8831, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8831>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8831>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8831>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8831>>(v5, 0x2::tx_context::sender(arg1));
    }
