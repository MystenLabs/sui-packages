module 0xa679eafaf0fb21bc339ea10307fc4cd423eb2d09e844b4243c6de364bb8d9523::ownable {
    ...
    public fun assert_version(arg0: &AdminCap) {
        assert!(arg0.version == 0xa679eafaf0fb21bc339ea10307fc4cd423eb2d09e844b4243c6de364bb8d9523::version::get_program_version(), 2);
    }
    ...
    public(friend) fun grant_admin_cap(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = AdminCap{
            ...
            version : 0xa679eafaf0fb21bc339ea10307fc4cd423eb2d09e844b4243c6de364bb8d9523::version::get_program_version(),
        };
    ...
    public(friend) fun migrate(arg0: &mut AdminCap, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0xa679eafaf0fb21bc339ea10307fc4cd423eb2d09e844b4243c6de364bb8d9523::version::get_program_version();
