module 0xa61cd9c8f010e5e37b3c2c4efcb7079086a2a8e5d1a1dad01aab19c54b848e95::cnsnft3034 {
    struct CNSNFT3034 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3034, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3034>(arg0, arg1);
