module 0xa62b810ee41fbc43aab1b072922ed19960e2aadd5e4cd85a89186c2a8b294fa5::reward4637 {
    struct REWARD4637 has drop {
        dummy_field: bool,
    }

    struct TICKET_4637 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4637(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4637>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4637>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4637, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4637>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4637>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4637>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4637>>(v5, 0x2::tx_context::sender(arg1));
    }
