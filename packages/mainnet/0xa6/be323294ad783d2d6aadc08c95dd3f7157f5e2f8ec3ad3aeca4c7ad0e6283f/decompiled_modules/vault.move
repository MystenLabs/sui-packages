module 0xa6be323294ad783d2d6aadc08c95dd3f7157f5e2f8ec3ad3aeca4c7ad0e6283f::vault {
    ...
    public entry fun createOrUpdateUserPool(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u256, arg5: u256, arg6: u64, arg7: 0x1::string::String, arg8: &mut UserPools, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = arg5 * arg4;
        if (!0x2::vec_map::contains<0x1::string::String, UserPool>(&arg8.pools, &arg7)) {
            let v1 = UserPool{
            ...
            0x2::vec_map::insert<0x1::string::String, UserPool>(&mut arg8.pools, arg7, v1);
        } else {
            let v2 = 0x2::vec_map::get_mut<0x1::string::String, UserPool>(&mut arg8.pools, &arg7);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<UserPools>(v0);
        let v1 = UsersStates{
            id          : 0x2::object::new(arg0),
            usersStates : 0x2::vec_map::empty<address, UserStakingState>(),
        };
        0x2::transfer::share_object<UsersStates>(v1);
    ...
    public entry fun withdraw<T0>(arg0: &mut UsersStates, arg1: &mut Treasury<T0>, arg2: &mut UserPools, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3.stakeTime + 0x2::vec_map::get<0x1::string::String, UserPool>(&arg2.pools, &v3.poolUsed).maturityMs;
        if (v1 <= v4) {
            let v5 = UnstakeError{
                user       : v0,
            ...
            0x2::event::emit<UnstakeError>(v5);
        } else {
