module 0xa6fac3da4eb2d0ca866da7dfb4b492cb9a05bb41c8ad6da3b9d6b3dc8e3eec45::daox_ai {
    ...
    public entry fun buy<T0, T1>(arg0: &mut DaoxAi<T0>, arg1: &mut Pool<T0, T1>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            ...
            let v3 = arg1.max_pool_daox - 0x2::balance::value<T0>(&arg1.pool_daox);
            let (v4, v5) = if (v1 - v2 <= v3) {
                (v1 - v2, 0x2::coin::split<T0>(&mut arg3, v2, arg4))
            } else {
                let v6 = v3 * arg0.fee_bps / (10000 - arg0.fee_bps);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v1 - v3 - v6, arg4), v0);
                arg1.complete = true;
                (v3, 0x2::coin::split<T0>(&mut arg3, v6, arg4))
            };
            let v7 = arg1.virtual_coin_reserves - arg1.virtual_daox_reserves * arg1.virtual_coin_reserves / (arg1.virtual_daox_reserves + (v4 as u128));
            arg1.virtual_daox_reserves = arg1.virtual_daox_reserves + (v4 as u128);
            arg1.virtual_coin_reserves = arg1.virtual_coin_reserves - v7;
            assert!(v7 >= (arg2 as u128) * (v4 as u128) * (10000 as u128) / (v1 as u128) * ((10000 - arg0.fee_bps) as u128), 3);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg1.pool_coin, (v7 as u64), arg4), v0);
            0x2::balance::join<T0>(&mut arg0.daox_balance, 0x2::coin::into_balance<T0>(v5));
            0x2::balance::join<T0>(&mut arg1.pool_daox, 0x2::coin::into_balance<T0>(arg3));
            let v8 = SwapEvent{
                pool_id               : 0x2::object::id<Pool<T0, T1>>(arg1),
                sender                : v0,
                daox_amount           : v4,
                coin_amount           : (v7 as u64),
                is_buy                : true,
            ...
            if (arg1.complete == true) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg1.pool_coin, 0x2::balance::value<T1>(&arg1.pool_coin), arg4), arg0.admin);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.pool_daox, 0x2::balance::value<T0>(&arg1.pool_daox), arg4), arg0.admin);
    ...
    public entry fun start_new_coin<T0, T1>(arg0: &mut DaoxAi<T0>, arg1: &0x2::coin::CoinMetadata<T1>, arg2: 0x2::coin::TreasuryCap<T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u8, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: 0x1::string::String, arg15: 0x1::string::String, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Pool<T0, T1>{
            ...
            pool_coin             : 0x2::coin::into_balance<T1>(0x2::coin::mint<T1>(&mut arg2, 1000000000000000, arg16)),
        ...
        let v1 = AgentCreatedEvent{
            ...
            total_supply          : 1000000000000000,
            max_pool_daox         : arg0.max_pool_daox,
            virtual_coin_reserves : v0.virtual_coin_reserves,
            virtual_daox_reserves : v0.virtual_daox_reserves,
        ...
        let v2 = &mut v0;
        buy<T0, T1>(arg0, v2, 0, arg3, arg16);
