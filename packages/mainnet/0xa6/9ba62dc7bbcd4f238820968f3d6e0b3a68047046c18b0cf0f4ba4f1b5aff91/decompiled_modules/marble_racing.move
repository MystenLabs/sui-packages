module 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::marble_racing {
    ...
    struct AddBetEvent has copy, drop {
        ...
        bet_size: u64,
        payout: u64,
        option: vector<0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::Placement>,
        coin_type: 0x1::type_name::TypeName,
    }

    struct BetResultsEvent<phantom T0> has copy, drop {
    ...
    struct RaceConfig has store, key {
        ...
        page_size: u64,
        bet_manager: 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::BetManager,
        max_combo: u8,
    }
    ...
    struct Race has store, key {
        ...
        race_event_id: 0x1::string::String,
        status: u64,
        risk_manager: 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::risk_manager::RiskManager,
        bet_setting: 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::BetSetting,
    ...
    struct BetResult<phantom T0> has copy, drop, store {
        bet_id: 0x2::object::ID,
        player: address,
        bet_options: vector<0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::Placement>,
        bet_size: u64,
        bet_returned: u64,
        outcome: vector<u64>,
    }
    ...
    fun remove(arg0: &mut RaceConfig, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::risk_manager::destroy_manager(v4);
    ...
    public fun set_house_edge(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64) {
        ...
        0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::set_house_edge(&mut arg0.bet_manager, arg2);
    }
    ...
    public fun add_bet<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut RaceConfig, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: vector<u64>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(v0.status == 1, 1);
        let v1 = create_option(arg4, arg5);
        assert!(0x1::vector::length<0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::Placement>(&v1) <= (arg1.max_combo as u64), 6);
        let v2 = 0x2::tx_context::sender(arg6);
        let v3 = 0x2::coin::into_balance<T0>(arg3);
        let v4 = 0x2::balance::value<T0>(&v3);
        let (v5, v6) = 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::get_bet_payout(&arg1.bet_manager, &v0.bet_setting, v4, v1, 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::risk_manager::marble_ids(&v0.risk_manager));
        let v7 = 0x1::type_name::get<T0>();
        0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::risk_manager::add_risk(&mut v0.risk_manager, 0x1::type_name::get<T0>(), v1, v6);
        let v8 = MarbleRacing{dummy_field: false};
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::assert_within_risk<T0, MarbleRacing>(arg0, v8, 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::risk_manager::total_risk(&v0.risk_manager, v7), arg6);
    ...
    public fun create(arg0: 0x1::string::String, arg1: &mut RaceConfig, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = Race{
            ...
            race_event_id : arg0,
            status        : 0,
            risk_manager  : 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::risk_manager::new_manager(arg2, arg3),
            bet_setting   : 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::new_bet_setting(arg2),
    ...
    fun create_option(arg0: vector<u64>, arg1: vector<u8>) : vector<0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::Placement> {
        assert!(0x1::vector::length<u64>(&arg0) == 0x1::vector::length<u8>(&arg1), 10);
        let v0 = 0x1::vector::empty<0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::Placement>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            0x1::vector::push_back<0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::Placement>(&mut v0, 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::new_placement(*0x1::vector::borrow<u64>(&arg0, v1), *0x1::vector::borrow<u8>(&arg1, v1)));
            v1 = v1 + 1;
        };
        v0
    }

    fun emit_bet_results<T0>(arg0: 0x2::object::ID, arg1: vector<BetResult<T0>>) {
        let v0 = BetResultsEvent<T0>{
            race_id     : arg0,
            bet_results : arg1,
        };
        0x2::event::emit<BetResultsEvent<T0>>(v0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RaceConfig{
            ...
            page_size   : 200,
            bet_manager : 0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::new_bet_manager(),
            max_combo   : 3,
        };
    ...
    public fun resolve<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: 0x2::object::ID, arg2: vector<u64>, arg3: &mut RaceConfig, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x1::vector::empty<BetResult<T0>>();
        ...
        while (v7 < v6 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            ...
            while (v7 < v6 && 0x1::vector::length<BetSlip>(&v10) != 0) {
                ...
                if (v11.coin_type == 0x1::type_name::get<T0>()) {
                    ...
                    if (0xa69ba62dc7bbcd4f238820968f3d6e0b3a68047046c18b0cf0f4ba4f1b5aff91::bet_manager::won_bet(v11.option, arg2)) {
                        v3 = v3 + v16;
                    ...
                    let v20 = BetResult<T0>{
                        bet_id       : 0x2::object::id<BetSlip>(&v11),
                        player       : v8,
                        bet_options  : v17,
                        bet_size     : v15,
                        bet_returned : v12,
                    ...
                    0x1::vector::push_back<BetResult<T0>>(&mut v5, v20);
        ...
        if (!0x1::vector::is_empty<PlayerWin<T0>>(&v2)) {
            let v21 = MarbleRacing{dummy_field: false};
            let v22 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::split_with_reimbursement<T0, MarbleRacing>(arg0, v21, v3);
            while (!0x1::vector::is_empty<PlayerWin<T0>>(&v2)) {
                ...
                let v26 = 0x2::balance::split<T0>(&mut v22, v25);
                0x2::balance::join<T0>(&mut v26, v24);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v26, arg5), v23);
            };
            0x2::balance::destroy_zero<T0>(v22);
        };
        0x1::vector::destroy_empty<PlayerWin<T0>>(v2);
        if (0x2::balance::value<T0>(&v4) != 0) {
            let v27 = MarbleRacing{dummy_field: false};
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::put_with_fee<T0, MarbleRacing>(arg0, v27, 0x2::coin::from_balance<T0>(v4, arg5));
        } else {
            0x2::balance::destroy_zero<T0>(v4);
        };
        emit_bet_results<T0>(arg1, v5);
        if (0x2::linked_table::length<address, vector<BetSlip>>(v1) == 0) {
