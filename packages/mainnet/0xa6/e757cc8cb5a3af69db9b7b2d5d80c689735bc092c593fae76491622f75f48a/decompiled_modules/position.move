module 0xa6e757cc8cb5a3af69db9b7b2d5d80c689735bc092c593fae76491622f75f48a::position {
    ...
    public(friend) fun decrease_lend_share(arg0: &mut Position, arg1: u128) {
        arg0.lend_share = arg0.lend_share - arg1;
    }
    ...
    public(friend) fun increase_lend_share(arg0: &mut Position, arg1: u128) {
        arg0.lend_share = arg0.lend_share + arg1;
    }

    public fun info(arg0: &Position) : (0x2::object::ID, u128, u128, u128) {
        (arg0.farm_id, arg0.deposit_share, arg0.debt_share, arg0.lend_share)
    }

    public fun lend_share(arg0: &Position) : u128 {
        arg0.lend_share
    }
    ...
    public fun merge(arg0: &mut Position, arg1: Position) {
        ...
        arg0.lend_share = arg0.lend_share + arg1.lend_share;
        let Position {
            id            : v0,
            farm_id       : _,
            deposit_share : _,
