module 0xa6c8f32015b5b41d34ee09995a2e9d7a21cdecf0e1910a50b264fd252cd33831::block_scholes_store {
    ...
    public fun svi_sid(arg0: &BlockScholesSVIStore, arg1: u64) : u256 {
        0xa6c8f32015b5b41d34ee09995a2e9d7a21cdecf0e1910a50b264fd252cd33831::block_scholes_sid::svi(&arg0.block_scholes_base_asset, arg1)
    }
    ...
    public fun spot(arg0: &BlockScholesValueStore) : 0x1::option::Option<BsRead<u128>> {
        if (0x1::vector::is_empty<BsRead<u128>>(&arg0.spot_reads)) {
            return 0x1::option::none<BsRead<u128>>()
        };
        let v0 = if (arg0.next_spot_write == 0) {
            0x1::vector::length<BsRead<u128>>(&arg0.spot_reads) - 1
        } else {
            arg0.next_spot_write - 1
        };
        0x1::option::some<BsRead<u128>>(*0x1::vector::borrow<BsRead<u128>>(&arg0.spot_reads, v0))
    }
    ...
    fun apply_spot(arg0: &mut BlockScholesValueStore, arg1: u256, arg2: BsRead<u128>) : bool {
        if (!has_valid_timestamp<u128>(&arg2)) {
            return false
        };
        let v0 = spot(arg0);
        if (0x1::option::is_some<BsRead<u128>>(&v0) && arg2.source_timestamp_ms <= 0x1::option::borrow<BsRead<u128>>(&v0).source_timestamp_ms) {
            return false
        };
        if (0x1::vector::length<BsRead<u128>>(&arg0.spot_reads) < 10) {
            0x1::vector::push_back<BsRead<u128>>(&mut arg0.spot_reads, arg2);
        } else {
            *0x1::vector::borrow_mut<BsRead<u128>>(&mut arg0.spot_reads, arg0.next_spot_write) = arg2;
        };
        arg0.next_spot_write = (arg0.next_spot_write + 1) % 10;
        let v1 = BlockScholesObservationRecorded<BsRead<u128>>{
            propbook_underlying_id : arg0.propbook_underlying_id,
            propbook_oracle_id     : value_store_id(arg0),
            sid                    : arg1,
            series_kind            : 0,
        ...
        0x2::event::emit<BlockScholesObservationRecorded<BsRead<u128>>>(v1);
        true
    }
    ...
    public(friend) fun create_and_share_value_store(arg0: u32, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = BlockScholesValueStore{
            ...
            block_scholes_base_asset : arg1,
            version                  : 1,
            spot_reads               : 0x1::vector::empty<BsRead<u128>>(),
            next_spot_write          : 0,
    ...
    public fun forward_sid(arg0: &BlockScholesValueStore, arg1: u64) : u256 {
        0xa6c8f32015b5b41d34ee09995a2e9d7a21cdecf0e1910a50b264fd252cd33831::block_scholes_sid::forward(&arg0.block_scholes_base_asset, arg1)
    }
    ...
    public fun recent_spot_at(arg0: &BlockScholesValueStore, arg1: u64) : 0x1::option::Option<BsRead<u128>> {
        let v0 = 0;
        while (v0 < 0x1::vector::length<BsRead<u128>>(&arg0.spot_reads)) {
            let v1 = 0x1::vector::borrow<BsRead<u128>>(&arg0.spot_reads, v0);
            if (v1.source_timestamp_ms == arg1) {
                return 0x1::option::some<BsRead<u128>>(*v1)
            };
            v0 = v0 + 1;
        };
        0x1::option::none<BsRead<u128>>()
    }
    ...
    public fun spot_sid(arg0: &BlockScholesValueStore) : u256 {
        0xa6c8f32015b5b41d34ee09995a2e9d7a21cdecf0e1910a50b264fd252cd33831::block_scholes_sid::spot(&arg0.block_scholes_base_asset)
    }
