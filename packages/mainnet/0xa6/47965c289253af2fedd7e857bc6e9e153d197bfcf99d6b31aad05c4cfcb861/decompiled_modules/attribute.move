module 0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::attribute {
    ...
    fun attach_accessory(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: KumoAccessory) {
        0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::kumo::set_attribute<KumoAccessory>(arg0, arg1, arg2, 0x1::string::utf8(b"Accessory"), accessory_name(&arg3), accessory_rarity_score(&arg3), arg3);
    }

    fun attach_background(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: KumoBackground) {
        0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::kumo::set_attribute<KumoBackground>(arg0, arg1, arg2, 0x1::string::utf8(b"Background"), background_name(&arg3), background_rarity_score(&arg3), arg3);
    }

    fun attach_eyes(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: KumoEyes) {
        0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::kumo::set_attribute<KumoEyes>(arg0, arg1, arg2, 0x1::string::utf8(b"Eyes"), eyes_name(&arg3), eyes_rarity_score(&arg3), arg3);
    }

    fun attach_fur_colour(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: KumoFurColour) {
        0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::kumo::set_attribute<KumoFurColour>(arg0, arg1, arg2, 0x1::string::utf8(b"FurColour"), fur_colour_name(&arg3), fur_colour_rarity_score(&arg3), arg3);
    }

    fun attach_mouth(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: KumoMouth) {
        0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::kumo::set_attribute<KumoMouth>(arg0, arg1, arg2, 0x1::string::utf8(b"Mouth"), mouth_name(&arg3), mouth_rarity_score(&arg3), arg3);
    }

    fun attach_one_of_one(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: KumoOneOfOne) {
        0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::kumo::set_attribute<KumoOneOfOne>(arg0, arg1, arg2, 0x1::string::utf8(b"OneOfOne"), one_of_one_name(&arg3), one_of_one_rarity_score(&arg3), arg3);
    }

    fun attach_tail(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: KumoTail) {
        0xa647965c289253af2fedd7e857bc6e9e153d197bfcf99d6b31aad05c4cfcb861::kumo::set_attribute<KumoTail>(arg0, arg1, arg2, 0x1::string::utf8(b"Tail"), tail_name(&arg3), tail_rarity_score(&arg3), arg3);
    }
