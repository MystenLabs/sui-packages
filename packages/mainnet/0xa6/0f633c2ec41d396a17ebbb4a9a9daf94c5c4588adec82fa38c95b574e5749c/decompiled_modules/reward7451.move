module 0xa60f633c2ec41d396a17ebbb4a9a9daf94c5c4588adec82fa38c95b574e5749c::reward7451 {
    struct REWARD7451 has drop {
        dummy_field: bool,
    }

    struct TICKET_7451 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7451(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7451>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7451>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7451, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7451>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7451>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7451>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7451>>(v5, 0x2::tx_context::sender(arg1));
    }
