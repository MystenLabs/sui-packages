module 0xa6d5ea19d71288ab5eb1f70dad707915217b67fa9758276a36bb6a49debacedf::swap {
    struct Swaping {
        id: 0x2::object::ID,
    ...
    public fun after_swap<T0>(arg0: 0x2::coin::Coin<T0>, arg1: Swaping) : 0x2::coin::Coin<T0> {
        let Swaping {
            id                    : _,
            from_coin_type        : _,
            total_from_amount     : _,
    ...
    public fun before_swap<T0, T1>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Swaping {
    ...
    public fun get_swaping_id(arg0: &Swaping) : 0x2::object::ID {
        arg0.id
    }
