module 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::marble_racing {
    ...
    struct AddBetEvent has copy, drop {
        ...
        bet_size: u64,
        payout: u64,
        option: vector<0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::Placement>,
    ...
    struct RaceConfig has store, key {
        ...
        page_size: u64,
        bet_manager: 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::BetManager,
        max_combo: u8,
    }
    ...
    struct Race has store, key {
        ...
        race_event_id: 0x1::string::String,
        status: u64,
        risk_manager: 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::risk_manager::RiskManager,
        bet_setting: 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::BetSetting,
    ...
    fun remove(arg0: &mut RaceConfig, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::risk_manager::destroy_manager(v4);
    ...
    public fun set_house_edge(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64) {
        ...
        0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::set_house_edge(&mut arg0.bet_manager, arg2);
    }
    ...
    public fun add_bet<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut RaceConfig, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: vector<u64>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(0x1::vector::length<0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::Placement>(&v1) <= (arg1.max_combo as u64), 6);
        let v2 = 0x2::tx_context::sender(arg6);
        let v3 = 0x2::coin::into_balance<T0>(arg3);
        let v4 = 0x2::balance::value<T0>(&v3);
        let (v5, v6) = 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::get_bet_payout(&arg1.bet_manager, &v0.bet_setting, v4, v1, 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::risk_manager::marble_ids(&v0.risk_manager));
        let v7 = 0x1::type_name::get<T0>();
        0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::risk_manager::add_risk(&mut v0.risk_manager, 0x1::type_name::get<T0>(), v1, v6);
        let v8 = MarbleRacing{dummy_field: false};
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::assert_within_risk<T0, MarbleRacing>(arg0, v8, 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::risk_manager::total_risk(&v0.risk_manager, v7), arg6);
    ...
    public fun cancel_race_bets<T0>(arg0: 0x2::object::ID, arg1: &mut RaceConfig, arg2: 0x1::option::Option<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = arg1.page_size;
        if (0x1::option::is_some<u64>(&arg2)) {
            v3 = *0x1::option::borrow<u64>(&arg2);
        };
        let v4 = 0;
        while (v4 < v3 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            let (v5, v6) = 0x2::linked_table::pop_back<address, vector<BetSlip>>(v1);
            let v7 = v6;
            while (v4 < v3 && 0x1::vector::length<BetSlip>(&v7) != 0) {
                let v8 = 0x1::vector::pop_back<BetSlip>(&mut v7);
                let v9 = 0x2::object::id<BetSlip>(&v8);
                if (v8.coin_type == 0x1::type_name::get<T0>()) {
                    let BetSlip {
                        id             : v10,
                        player_address : _,
                        bet_size       : _,
                    ...
                    0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::dynamic_field::remove<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut v0.id, v9), arg3), v5);
                    0x1::vector::push_back<0x2::object::ID>(&mut v2, v9);
                    0x2::object::delete(v10);
                } else {
                    0x1::vector::push_back<BetSlip>(&mut v7, v8);
                };
                v4 = v4 + 1;
            };
            if (!0x1::vector::is_empty<BetSlip>(&v7)) {
                0x2::linked_table::push_back<address, vector<BetSlip>>(v1, v5, v7);
                continue
            };
            0x1::vector::destroy_empty<BetSlip>(v7);
        };
        let v16 = BetCancelEvent{
            race_id        : arg0,
            cancelled_bets : v2,
        };
        0x2::event::emit<BetCancelEvent>(v16);
    ...
    public fun create(arg0: 0x1::string::String, arg1: &mut RaceConfig, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = Race{
            ...
            race_event_id : arg0,
            status        : 0,
            risk_manager  : 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::risk_manager::new_manager(arg2, arg3),
            bet_setting   : 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::new_bet_setting(arg2),
    ...
    fun create_option(arg0: vector<u64>, arg1: vector<u8>) : vector<0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::Placement> {
        assert!(0x1::vector::length<u64>(&arg0) == 0x1::vector::length<u8>(&arg1), 10);
        let v0 = 0x1::vector::empty<0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::Placement>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            0x1::vector::push_back<0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::Placement>(&mut v0, 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::new_placement(*0x1::vector::borrow<u64>(&arg0, v1), *0x1::vector::borrow<u8>(&arg1, v1)));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RaceConfig{
            ...
            page_size   : 200,
            bet_manager : 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::new_bet_manager(),
            max_combo   : 3,
        };
        ...
        while (v7 < v6 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            ...
            while (v7 < v6 && 0x1::vector::length<BetSlip>(&v10) != 0) {
                ...
                if (v11.coin_type == 0x1::type_name::get<T0>()) {
                    ...
                    let v19 = v17;
                    if (0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::won_bet(v11.option, arg2)) {
                        v3 = v3 + v16;
                    ...
                    while (v21 < 0x1::vector::length<0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::Placement>(&v19)) {
                        0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::Placement>(&mut v22, 0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::create_unihouse_placement(*0x1::vector::borrow<0xa61ffbb87fc77cb7d308e427157c345505156ee8aa63ee5d45a6d4448f088e6e::bet_manager::Placement>(&v19, v21)));
                        v21 = v21 + 1;
                    };
