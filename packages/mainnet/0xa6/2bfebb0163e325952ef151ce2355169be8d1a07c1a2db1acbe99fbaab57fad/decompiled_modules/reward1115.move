module 0xa62bfebb0163e325952ef151ce2355169be8d1a07c1a2db1acbe99fbaab57fad::reward1115 {
    struct REWARD1115 has drop {
        dummy_field: bool,
    }

    struct TICKET_1115 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1115(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1115>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1115>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1115, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1115>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1115>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1115>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1115>>(v5, 0x2::tx_context::sender(arg1));
    }
