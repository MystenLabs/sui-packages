module 0xa6801bc17ba9e30a9c092a2e29a9f52317099e928e7738bb5a9aa78d4d589ae8::reward2600 {
    struct REWARD2600 has drop {
        dummy_field: bool,
    }

    struct TICKET_2600 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2600(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2600>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2600>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2600>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2600>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2600>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2600>>(v5, 0x2::tx_context::sender(arg1));
    }
