module 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::q64x64 {
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::bit_math::most_significant_bit_u128(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
