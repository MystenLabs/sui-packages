module 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::oracle_helper {
    ...
    public fun get_sample_at(arg0: &Oracle, arg1: u16, arg2: u64) : (u64, u64, u64, u64) {
        ...
        let v8 = v7;
        let v9 = v6;
        let (v10, v11, v12) = get_weighted_average(&v9, &v8, 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::sub_u64(get_sample_last_update(&v8), arg2), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::sub_u64(arg2, get_sample_last_update(&v9)));
        (arg2, v10, v11, v12)
    }
    ...
    public fun get_sample_last_update(arg0: &Sample) : u64 {
        0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(arg0.created_at, (arg0.sample_lifetime as u64))
    }
    ...
    public fun get_weighted_average(arg0: &Sample, arg1: &Sample, arg2: u64, arg3: u64) : (u64, u64, u64) {
        ...
        let v0 = (arg2 as u128);
        let v1 = (arg3 as u128);
        let v2 = (0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(arg2, arg3) as u128);
        (0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::u128_to_u64((0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg0.cumulative_id as u128), v0) + 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg1.cumulative_id as u128), v1)) / v2), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::u128_to_u64((0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg0.cumulative_volatility as u128), v0) + 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg1.cumulative_volatility as u128), v1)) / v2), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::u128_to_u64((0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg0.cumulative_bin_crossed as u128), v0) + 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg1.cumulative_bin_crossed as u128), v1)) / v2))
    }
    ...
    public fun update(arg0: &mut Oracle, arg1: &mut 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::pair_parameter_helper::PairParameters, arg2: u32, arg3: &0x2::clock::Clock) : bool {
        let v0 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::pair_parameter_helper::get_oracle_id(arg1);
        let v1 = v0;
        if (v0 == 0) {
            return false
        };
        ...
        let v4 = v3;
        let v5 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(v3, (v2.sample_lifetime as u64));
        let v6 = 0x2::clock::timestamp_ms(arg3) / 1000;
        if (v6 > v5) {
            let (v7, v8, v9) = update_sample(&v2, 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::sub_u64(v6, v5), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::pair_parameter_helper::get_active_id(arg1), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::pair_parameter_helper::get_volatility_accumulator(arg1), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::pair_parameter_helper::get_delta_id(arg1, arg2));
            let v10 = v2.oracle_length;
            let v11 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::sub_u64(v6, v3);
            let v12 = v11;
            if (v11 > 120) {
                let v13 = v0 % v10 + 1;
                v1 = v13;
                v12 = 0;
                v4 = v6;
                0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::pair_parameter_helper::set_oracle_id(arg1, v13);
            };
            set_sample(arg0, v1, create_sample(v10, v7, v8, v9, 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::u64_to_u8(v12), v4));
            return true
        };
        false
    }
    ...
    public fun update_sample(arg0: &Sample, arg1: u64, arg2: u32, arg3: u32, arg4: u32) : (u64, u64, u64) {
        let v0 = (arg1 as u128);
        (0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::u128_to_u64(0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u128((arg0.cumulative_id as u128), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg2 as u128), v0))), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::u128_to_u64(0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u128((arg0.cumulative_volatility as u128), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg3 as u128), v0))), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::u128_to_u64(0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u128((arg0.cumulative_bin_crossed as u128), 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::mul_u128((arg4 as u128), v0))))
    }
