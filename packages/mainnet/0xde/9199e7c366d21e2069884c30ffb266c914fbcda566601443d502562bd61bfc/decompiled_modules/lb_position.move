module 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::lb_position {
    ...
    public fun calculate_pending_rewards<T0>(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: &vector<u128>, arg4: &0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::rewarder::RewarderManager) : u64 {
        let v0 = borrow_position_info(arg0, 0x2::object::id<LBPosition>(arg1));
        if (!0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg2)) {
            return 0
        };
        let v1 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::rewarder::rewarder_index<T0>(arg4);
        ...
        let v5 = if (v2 < 0x1::vector::length<u128>(arg3)) {
            0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::rewarder::calculate_rewards_owed(v3.amount, v4.growth_inside_last, *0x1::vector::borrow<u128>(arg3, v2))
        } else {
            0
        };
        0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(v4.amount_owed, v5)
    }
    ...
    public(friend) fun collect_and_withdraw_rewards<T0>(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: &vector<u128>, arg4: &0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::rewarder::RewarderManager) : u64 {
        ...
        if (v2 < 0x1::vector::length<u128>(arg3)) {
            ...
            v5.amount_owed = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(v5.amount_owed, 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::rewarder::calculate_rewards_owed(v3.amount, v5.growth_inside_last, v6));
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        if (0x2::table::contains<u32, LBBinPosition>(&v2.bins, arg2)) {
            ...
            v3.fees_pending_x = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(v3.fees_pending_x, v0);
            v3.fees_pending_y = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(v3.fees_pending_y, v1);
    ...
    public fun get_total_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (u64, u64) {
        ...
        while (arg2 <= arg3) {
            if (0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg2)) {
                let v3 = 0x2::table::borrow<u32, LBBinPosition>(&v0.bins, arg2);
                v1 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(v1, v3.fees_pending_x);
                v2 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u64(v2, v3.fees_pending_y);
            };
            arg2 = arg2 + 1;
        };
        (v1, v2)
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128) : u128 {
        ...
        if (0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg2)) {
            let v1 = 0x2::table::borrow_mut<u32, LBBinPosition>(&mut v0.bins, arg2);
            v1.amount = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u128(v1.amount, arg3);
        } else {
        ...
        *v3 = 0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::safe_math::add_u128(*v3, arg3);
        *v3
    }
    ...
    public(friend) fun update_reward_info(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: &vector<u128>, arg4: &0xde9199e7c366d21e2069884c30ffb266c914fbcda566601443d502562bd61bfc::rewarder::RewarderManager) {
        let v0 = borrow_mut_position_info(arg0, 0x2::object::id<LBPosition>(arg1));
        if (0x2::table::contains<u32, LBBinPosition>(&v0.bins, arg2)) {
            let v1 = 0x2::table::borrow_mut<u32, LBBinPosition>(&mut v0.bins, arg2);
