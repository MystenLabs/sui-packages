module 0xde591b4f2724011398af580d141faddbf900825f1176c3219de96ea9641174b8::TITANX {
    struct TITANX has drop {
        dummy_field: bool,
    }

    fun init(arg0: TITANX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<TITANX>(arg0, 2, b"TITANX", b"TITANX", b"TITANX", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/iKF7eTvlLRug94puq8lKjY5B1yX0gWdrXdl7aYCnZyM?ext=png")), arg1);
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<TITANX>(&mut v3, 10000000000, 0x2::tx_context::sender(arg1), arg1);
