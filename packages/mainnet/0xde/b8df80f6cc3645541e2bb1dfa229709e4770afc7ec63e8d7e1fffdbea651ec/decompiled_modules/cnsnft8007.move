module 0xdeb8df80f6cc3645541e2bb1dfa229709e4770afc7ec63e8d7e1fffdbea651ec::cnsnft8007 {
    struct CNSNFT8007 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8007, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9314"));
        let v4 = 0x2::package::claim<CNSNFT8007>(arg0, arg1);
