module 0xde56a59ac30a16385e008bf216c82022b5b43b153d9228505d3205a433db22df::five_minutes {
    ...
    entry fun latestRound(arg0: &Round) : (u64, u64, u8, u64) {
        let v0 = 0x2::table::length<u64, RoundMetadata>(&arg0.rounds);
        (v0, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).end_time_ms, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).status, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).round)
    }
