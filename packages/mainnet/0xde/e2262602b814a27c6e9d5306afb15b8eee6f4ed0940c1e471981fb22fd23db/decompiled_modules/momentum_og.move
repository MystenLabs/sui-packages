module 0xdee2262602b814a27c6e9d5306afb15b8eee6f4ed0940c1e471981fb22fd23db::momentum_og {
    ...
    fun init(arg0: MOMENTUM_OG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MOMENTUM_OG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Momentum OG"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Momentum OG "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://f2tenoxS01k04qzwieADgF1Z9pla82a1SMqWzirLN58"));
