module 0xded986da50153aec778ecea95dcf00768987d3e5c59955b1716ab0f662d234ac::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"cBTC", b"Cyclos Bitcoin", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-12-23T02-01-19.748Z-bit.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Cyclos Bitcoin"),
            symbol     : 0x1::string::utf8(b"cBTC"),
            decimals   : 9,
