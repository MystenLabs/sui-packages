module 0xde178193872fe4a84e5f0da1297dc2fc5d653d80617632f325c15aa86ec8f5ca::chop_locker {
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<Lock<T0>>(v3, 0x2::tx_context::sender(arg4));
    }
    ...
    public entry fun withdraw_tokens<T0>(arg0: Lock<T0>, arg1: &mut PoolConfig<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        arg1.total_staked = arg1.total_staked - 0x2::balance::value<T0>(&v5);
