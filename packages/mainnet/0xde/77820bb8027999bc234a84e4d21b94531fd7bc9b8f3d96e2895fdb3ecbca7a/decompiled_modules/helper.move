module 0xde77820bb8027999bc234a84e4d21b94531fd7bc9b8f3d96e2895fdb3ecbca7a::helper {
    public fun calculate_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        let v4 = if (v2 == 0) {
            (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::mul_div_u256((arg2 as u256), (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::mul_to_u128(get_sui_amount(&v3), 1) as u256), (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::mul_to_u128(1, get_token_amount(&v3)) as u256)) as u64)
        } else {
            (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::mul_div_u256((arg2 as u256), (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::mul_to_u128(get_sui_amount(&v3), get_token_amount(&v1)) as u256), (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::mul_to_u128(v2, get_token_amount(&v3)) as u256)) as u64)
        };
        v4 - arg2
    }
