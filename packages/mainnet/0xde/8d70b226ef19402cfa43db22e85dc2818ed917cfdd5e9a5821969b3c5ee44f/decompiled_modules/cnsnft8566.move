module 0xde8d70b226ef19402cfa43db22e85dc2818ed917cfdd5e9a5821969b3c5ee44f::cnsnft8566 {
    struct CNSNFT8566 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8566, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8566>(arg0, arg1);
