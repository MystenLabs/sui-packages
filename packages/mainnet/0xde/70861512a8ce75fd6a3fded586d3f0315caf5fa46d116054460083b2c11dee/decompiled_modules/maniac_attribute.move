module 0xde70861512a8ce75fd6a3fded586d3f0315caf5fa46d116054460083b2c11dee::maniac_attribute {
    ...
    fun create_attribute(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : ManiacAttributeNft {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"type"), 0x1::string::utf8(b"Attribute"));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"attribute type"), 0x1::string::utf8(arg0));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v3, 0x1::string::utf8(b"attribute value"), 0x1::string::utf8(arg1));
        ManiacAttributeNft{
            id          : v0,
