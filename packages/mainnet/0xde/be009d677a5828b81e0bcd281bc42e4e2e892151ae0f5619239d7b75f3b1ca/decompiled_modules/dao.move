module 0xdebe009d677a5828b81e0bcd281bc42e4e2e892151ae0f5619239d7b75f3b1ca::dao {
    ...
    public entry fun commit<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!is_existed_user_dao<T0>(arg0, 0x2::tx_context::sender(arg4))) {
            ...
            assert!(v4.total_committed_amount + arg1 <= v4.max_committable_amount, 1007);
    ...
    public entry fun create_dao_fund<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: &mut SharedObj, arg7: 0x2::transfer::Receiving<0x2::coin::TreasuryCap<T0>>, arg8: &0xdebe009d677a5828b81e0bcd281bc42e4e2e892151ae0f5619239d7b75f3b1ca::dao_config::GlobalDaoFee, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg10);
        let v1 = ((arg3 / arg5 * 110 / 100) as u64);
        let (v2, v3, _, _, _, _) = 0xdebe009d677a5828b81e0bcd281bc42e4e2e892151ae0f5619239d7b75f3b1ca::dao_config::get_dao_fee_config(arg8);
        let v8 = ((arg5 * v2 / v3) as u64);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg9) >= v8, 1005);
        let v9 = DAOFund<T0>{
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xdebe009d677a5828b81e0bcd281bc42e4e2e892151ae0f5619239d7b75f3b1ca::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_dao_fee_config(arg0: &OperatorCap, arg1: &mut 0xdebe009d677a5828b81e0bcd281bc42e4e2e892151ae0f5619239d7b75f3b1ca::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::tx_context::TxContext) {
        0xdebe009d677a5828b81e0bcd281bc42e4e2e892151ae0f5619239d7b75f3b1ca::dao_config::set_dao_fee_config(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }
    ...
    fun validate_commit_amount<T0>(arg0: &DAOFund<T0>, arg1: u64) {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.balance) + arg1 <= ((arg0.fundraise_goal * 110 / 100) as u64), 1006);
    }
