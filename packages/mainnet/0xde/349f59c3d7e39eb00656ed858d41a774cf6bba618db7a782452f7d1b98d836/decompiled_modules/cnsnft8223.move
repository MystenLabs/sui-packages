module 0xde349f59c3d7e39eb00656ed858d41a774cf6bba618db7a782452f7d1b98d836::cnsnft8223 {
    struct CNSNFT8223 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8223, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5727"));
        let v4 = 0x2::package::claim<CNSNFT8223>(arg0, arg1);
