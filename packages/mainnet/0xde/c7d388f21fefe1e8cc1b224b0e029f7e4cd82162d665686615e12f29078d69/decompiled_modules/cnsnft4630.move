module 0xdec7d388f21fefe1e8cc1b224b0e029f7e4cd82162d665686615e12f29078d69::cnsnft4630 {
    struct CNSNFT4630 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4630, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4630>(arg0, arg1);
