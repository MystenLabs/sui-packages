module 0xde11c0d5b2b28ca3ade6f1aa3c345a7d6fe7ba74a198f11f284525920be90eb6::dice {
    ...
    fun place_bet<T0>(arg0: &mut DiceGame<T0>, arg1: &mut 0xde11c0d5b2b28ca3ade6f1aa3c345a7d6fe7ba74a198f11f284525920be90eb6::vault::Vault<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: bool, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v4 = Bet<T0>{
            ...
            fund              : 0xde11c0d5b2b28ca3ade6f1aa3c345a7d6fe7ba74a198f11f284525920be90eb6::vault::take_fund_balance<T0>(arg1, 0x1::uq32_32::int_mul(v0, 0x1::uq32_32::mul(v2, 0x1::uq32_32::add(arg0.min_rtp, 0x1::uq32_32::mul(v3, 0x1::uq32_32::sub(arg0.max_rtp, arg0.min_rtp)))))),
        };
        ...
        0xde11c0d5b2b28ca3ade6f1aa3c345a7d6fe7ba74a198f11f284525920be90eb6::events::emit_dice_bet_event(0x2::object::uid_to_inner(&v4.id), v0, arg3, arg4, arg5, 0x2::tx_context::sender(arg6), 0x1::type_name::into_string(0x1::type_name::get<T0>()));
