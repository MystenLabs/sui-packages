module 0xdeb1102d4f61ba7f6f22fffb7fcf6e13e370052c97de3b0b32b41bf861bb751c::reward2148 {
    struct REWARD2148 has drop {
        dummy_field: bool,
    }

    struct TICKET_2148 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2148(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2148>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2148>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2148, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2148>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2148>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2148>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2148>>(v5, 0x2::tx_context::sender(arg1));
    }
