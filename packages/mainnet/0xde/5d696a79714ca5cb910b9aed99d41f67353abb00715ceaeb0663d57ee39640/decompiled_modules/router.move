module 0x33ec64e9bb369bf045ddc198c81adbf2acab424da37465d95296ee02045d2b17::router {
    struct SwapContext {
    ...
    public fun confirm_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::balance::value<T0>(&v10) >= v5, 0x33ec64e9bb369bf045ddc198c81adbf2acab424da37465d95296ee02045d2b17::errors::err_amount_out_slippage_check_failed());
        assert!(0x2::bag::is_empty(&v9), 0x33ec64e9bb369bf045ddc198c81adbf2acab424da37465d95296ee02045d2b17::errors::err_remains_balance());
    ...
    public fun new_swap_context<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: u32, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg3) > 0, 0x33ec64e9bb369bf045ddc198c81adbf2acab424da37465d95296ee02045d2b17::errors::err_amount_in_is_zero());
        if (arg4 > 0) {
            assert!(arg5 != @0x0, 0x33ec64e9bb369bf045ddc198c81adbf2acab424da37465d95296ee02045d2b17::errors::err_invalid_fee_recipient());
        };
        assert!(arg4 <= 100000, 0x33ec64e9bb369bf045ddc198c81adbf2acab424da37465d95296ee02045d2b17::errors::err_too_large_fee_rate());
    ...
    public fun new_swap_context_v2<T0, T1>(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: u32, arg6: address, arg7: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg4) <= arg1, 0x33ec64e9bb369bf045ddc198c81adbf2acab424da37465d95296ee02045d2b17::errors::err_exceed_max_amount_in());
