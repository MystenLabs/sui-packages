module 0xdeda63bf55fd43ab9238a1b0e882c4a73723e4c1753b391d56b5af3dd9d9276e::cnsnft1337 {
    struct CNSNFT1337 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1337, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4189"));
        let v4 = 0x2::package::claim<CNSNFT1337>(arg0, arg1);
