module 0xdecc9768912cabfed59e85073ee2b21b8843ac8750cf979ec7a39b6d8280e14e::walrus_nft {
    ...
    fun init(arg0: WALRUS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WALRUS_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Walrus NFT"));
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidhkx6ohxf3jdum6x6qltxl5linq326axunvxlcachfhelkkznxgi"));
