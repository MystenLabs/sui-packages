module 0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::sui_sf {
    ...
    struct BridgeData has store, key {
        id: 0x2::object::UID,
        tokens_escrow: 0x2::table_vec::TableVec<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>,
        fee_rate: u64,
    ...
    public entry fun bridge_coins_to_token(arg0: &mut BridgeData, arg1: 0x2::coin::Coin<SUI_SF>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v5 < v3) {
            let v7 = 0x2::table_vec::pop_back<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(&mut arg0.tokens_escrow);
            0x1::vector::push_back<0x2::object::ID>(&mut v6, 0x2::object::id<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(&v7));
            0x2::transfer::public_transfer<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(v7, v0);
            v5 = v5 + 1;
        };
    ...
    public entry fun bridge_tokens_to_coin(arg0: &mut BridgeData, arg1: vector<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = 0x1::vector::length<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(&arg1);
        let v2 = 0;
        let v3 = 0x1::vector::empty<0x2::object::ID>();
        while (v2 < v1) {
            let v4 = 0x1::vector::pop_back<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(&mut arg1);
            0x1::vector::push_back<0x2::object::ID>(&mut v3, 0x2::object::id<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(&v4));
            0x2::table_vec::push_back<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(&mut arg0.tokens_escrow, v4);
            v2 = v2 + 1;
        };
        ...
        0x1::vector::destroy_empty<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(arg1);
    ...
    public fun get_tokens_escrow(arg0: &BridgeData) : u64 {
        0x2::table_vec::length<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(&arg0.tokens_escrow)
    }
    ...
    fun init(arg0: SUI_SF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = BridgeData{
            ...
            tokens_escrow : 0x2::table_vec::empty<0xd1427c2bb84737cdaa2bbae778a61c86f2e0d4fc1d05dfa78a2c636bbf2264aa::bluemove_launchpad::SUIS>(arg1),
            fee_rate      : 30,
            treasury_cap  : v0,
        };
