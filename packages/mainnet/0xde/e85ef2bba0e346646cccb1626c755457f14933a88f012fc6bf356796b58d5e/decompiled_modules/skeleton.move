module 0xdee85ef2bba0e346646cccb1626c755457f14933a88f012fc6bf356796b58d5e::skeleton {
    ...
    fun init(arg0: SKELETON, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SKELETON>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SKELETON"));
