module 0xde7f1b05a47e8aabceb7c7c25cdbfa8ed0ccb83baf052cf71b673291af158e9d::cnsnft8018 {
    struct CNSNFT8018 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8018, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8018>(arg0, arg1);
