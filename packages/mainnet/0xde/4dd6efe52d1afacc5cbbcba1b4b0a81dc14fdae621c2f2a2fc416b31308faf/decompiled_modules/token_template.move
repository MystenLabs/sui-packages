module 0xde4dd6efe52d1afacc5cbbcba1b4b0a81dc14fdae621c2f2a2fc416b31308faf::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T941533", b"Test 941533", b"Integration test token 2025-11-01T04:05:41.533Z", 0x1::option::none<0x2::url::Url>(), arg1);
