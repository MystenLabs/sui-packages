module 0xde1e6bbcc09c453ed9491a8e1c0ba9f6c7cae4b313f3a1349be33b0a5ca378de::executor {
    ...
    public fun aftermath<T0, T1, T2>(arg0: &0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool_registry::PoolRegistry, arg1: &0x2d9316f1f1a95f6d7c85a4e690ef7c359e6649773ef2c37ad7d9857adb6bef06::vault::ProtocolFeeVault, arg2: &mut 0x64213b0e4a52bac468d4ac3f140242f70714381653a1919a6d57cd49c628207a::treasury::Treasury, arg3: &mut 0xa6baab1e668c7868991c1c3c11e144100f5734c407d020f72a01b9d1a8bcb97f::insurance_fund::InsuranceFund, arg4: &0xc66fabf1a9253e43c70f1cc02d40a1d18db183140ecaae2a3f58fa6b66c55acf::referral_vault::ReferralVault, arg5: &mut 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::Pool<T0>, arg6: vector<0x2::coin::Coin<T1>>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : vector<0x2::coin::Coin<T2>> {
        let v0 = 0x2::coin::zero<T1>(arg8);
        0x2::pay::join_vec<T1>(&mut v0, arg6);
        let v1 = 0x1::vector::empty<0x2::coin::Coin<T2>>();
        0x1::vector::push_back<0x2::coin::Coin<T2>>(&mut v1, 0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::swap::swap_exact_in<T0, T1, T2>(arg5, arg0, arg1, arg2, arg3, arg4, v0, arg7, 1000000000000000000, arg8));
        v1
    }
    ...
    public fun borrow_flash_loan(arg0: &Caller, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (vector<0x2::coin::Coin<0x2::sui::SUI>>, 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::FlashLoan<0x2::sui::SUI>) {
        let (v0, v1) = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::flash_loan::borrow_flash_loan<0x2::sui::SUI>(arg1, arg2, arg3, arg4);
        let v2 = 0x1::vector::empty<0x2::coin::Coin<0x2::sui::SUI>>();
        0x1::vector::push_back<0x2::coin::Coin<0x2::sui::SUI>>(&mut v2, v0);
        (v2, v1)
    }
    ...
    public fun repay_flash_loan(arg0: &Caller, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: u64, arg4: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg5: 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::FlashLoan<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::zero<0x2::sui::SUI>(arg6);
        0x2::pay::join_vec<0x2::sui::SUI>(&mut v0, arg4);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v0) > arg3, 0);
        0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::flash_loan::repay_flash_loan<0x2::sui::SUI>(arg1, arg2, 0x2::coin::split<0x2::sui::SUI>(&mut v0, arg3, arg6), arg5, arg6);
