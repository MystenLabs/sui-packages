module 0xde8f58bca8f20f63bdf3d24cda30f003c458ddeac68b30ce8564181505b2bcde::bonded_nft_dex {
    ...
    public entry fun add_allowed_token(arg0: &mut Collection, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
    ...
    public entry fun add_liquidity<T0>(arg0: &mut Collection, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_collection(arg0: &PlatformConfig, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::ascii::String>(&mut v1, 0x1::ascii::string(b"0x2::sui::SUI"));
        let v2 = Collection{
            ...
            total_minted           : 0,
            creator                : v0,
            allowed_payment_tokens : v1,
            liquidity_reserves     : 0x2::bag::new(arg11),
            total_liquidity        : 0x2::table::new<0x1::ascii::String, u64>(arg11),
            lp_shares              : 0x2::table::new<0x1::ascii::String, 0x2::bag::Bag>(arg11),
        };
        let v3 = CollectionCreated{
            collection_id     : 0x2::object::id<Collection>(&v2),
            creator           : v0,
            name              : 0x1::string::utf8(arg2),
            token_symbol      : 0x1::string::utf8(arg6),
            max_supply        : arg8,
    ...
    public entry fun create_nft_display(arg0: &CollectionPublisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<BoundNft>(&mut v0, 0x1::string::utf8(b"embedded_tokens"), 0x1::string::utf8(b"{token_amount}"));
    ...
    public entry fun create_transfer_policy(arg0: &CollectionPublisher, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_nft_info(arg0: &BoundNft) : (0x1::string::String, 0x1::string::String, u64) {
        (arg0.name, arg0.description, arg0.token_amount)
    }
    ...
    public entry fun mint_nft<T0>(arg0: &PlatformConfig, arg1: &mut Collection, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v6, v4), arg3), arg1.creator);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v6, v5), arg3), arg0.platform_treasury);
        0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg1.liquidity_reserves, v2), 0x2::balance::split<T0>(&mut v6, v0 - v4 - v5));
        ...
        0x1::string::append(&mut v7, u64_to_string(arg1.total_minted + 1));
        let v8 = BoundNft{
        ...
        let v9 = NftMinted{
            collection_id : 0x2::object::id<Collection>(arg1),
            nft_id        : 0x2::object::id<BoundNft>(&v8),
            buyer         : v3,
            price_paid    : v1,
            token_type    : 0x1::string::utf8(*0x1::ascii::as_bytes(&v2)),
        ...
        0x2::transfer::public_transfer<BoundNft>(v8, v3);
    }

    public entry fun sell_nft<T0>(arg0: &mut Collection, arg1: BoundNft, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun update_platform_treasury(arg0: &mut PlatformConfig, arg1: address, arg2: &0x2::tx_context::TxContext) {
