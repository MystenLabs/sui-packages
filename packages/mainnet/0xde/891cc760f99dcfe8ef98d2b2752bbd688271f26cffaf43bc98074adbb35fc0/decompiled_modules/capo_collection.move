module 0xde891cc760f99dcfe8ef98d2b2752bbd688271f26cffaf43bc98074adbb35fc0::capo_collection {
    ...
    public entry fun burn_nft(arg0: CapoNFT, arg1: &mut 0x2::tx_context::TxContext) {
        let CapoNFT {
            id            : v0,
            name          : v1,
            description   : _,
