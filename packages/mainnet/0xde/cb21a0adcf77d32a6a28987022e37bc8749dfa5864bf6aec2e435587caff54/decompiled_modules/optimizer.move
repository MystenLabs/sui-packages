module 0xdecb21a0adcf77d32a6a28987022e37bc8749dfa5864bf6aec2e435587caff54::optimizer {
    ...
    fun record_v2_plateau_candidate(arg0: &vector<Hop>, arg1: u128, arg2: u128, arg3: &mut OptimizeResult) {
        ...
        if (v2) {
            record_candidate(v0, quote_route(arg0, v0), arg3);
        };
    }
    ...
    public fun resume_coefficients(arg0: &mut OptimizeState) {
        ...
        while (arg0.cursor < arg0.max_amount_in && arg0.result.segments < arg0.max_segments) {
            ...
            if (v7 == v6) {
                let v11 = quote_route(&arg0.route, v7);
                let v12 = &mut arg0.result;
                record_candidate_if_valid(&arg0.route, v7, arg0.cursor + v7, arg0.cursor_output + v11, v12);
                if (arg0.cursor == 0) {
                    let v13 = &mut arg0.result;
                    record_v2_plateau_candidate(&arg0.route, v7, v11, v13);
                };
                arg0.finished = true;
                return
            };
            let v14 = &mut arg0.route;
            let (v15, v16, v17) = advance_route(v14, v7);
            arg0.cursor = arg0.cursor + v7;
            arg0.cursor_output = arg0.cursor_output + v15;
            arg0.result.crossed_ticks = arg0.result.crossed_ticks + v16;
            arg0.result.crossed_orders = arg0.result.crossed_orders + v17;
            let v18 = &mut arg0.result;
            record_candidate_if_valid(&arg0.route, 0, arg0.cursor, arg0.cursor_output, v18);
        };
