module 0xde452aaf3df1e8891af5e279c735c1fde9643ac06bc51f08c0e3ae47091a2540::labubu {
    ...
    fun init(arg0: LABUBU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<LABUBU>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"LABUBU  ")))), trim_right(b"Labubu                          "), trim_right(b"Labubu Labubu                                                                                                                                                                                                                                                                                                                   "), v2, arg1);
