module 0xf1980203ac583f48fdc4cde7b8dfe8b6a46952db239cf03eeb4282174dd0d275::admin {
    ...
    public(friend) fun setTeamCount(arg0: &mut GlobalNetworkData, arg1: u8, arg2: u64) {
        let v0 = &arg1;
        if (*v0 == 1) {
            arg0.team_count.level_1_count = arg2;
        } else if (*v0 == 2) {
            arg0.team_count.level_2_count = arg2;
        } else if (*v0 == 3) {
            arg0.team_count.level_3_count = arg2;
        } else if (*v0 == 4) {
            arg0.team_count.level_4_count = arg2;
        } else if (*v0 == 5) {
            arg0.team_count.level_5_count = arg2;
        } else if (*v0 == 6) {
            arg0.team_count.level_6_count = arg2;
        } else if (*v0 == 7) {
            arg0.team_count.level_7_count = arg2;
        } else if (*v0 == 8) {
            arg0.team_count.level_8_count = arg2;
        } else if (*v0 == 9) {
            arg0.team_count.level_9_count = arg2;
        };
    }
