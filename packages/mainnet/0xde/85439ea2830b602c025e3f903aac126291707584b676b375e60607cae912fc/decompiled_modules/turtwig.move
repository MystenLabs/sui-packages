module 0xde85439ea2830b602c025e3f903aac126291707584b676b375e60607cae912fc::turtwig {
    struct TURTWIG has drop {
        dummy_field: bool,
    }

    fun init(arg0: TURTWIG, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TURTWIG>(arg0, 6, b"Turtwig", b"Turtwig Sui", x"5475727477696720697320612047726173732d7479706520506f6bc3a96d6f6e20696e74726f647563656420696e2047656e65726174696f6e2049562c207265636f676e697a6564206173207468652054696e79204c65616620506f6bc3a96d6f6e", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafkreibene56kollwueqxifonu7hxjbdgokmto2ndmsuenbfc5cbfnqr2u")), arg1);
