module 0xde0a3bc72b5348ab109ce52ba8a6d9a9e20a52e96330ec3db310473b074dc477::creature_nft {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = BrainrotCollection{
            ...
            public_recipes  : 0x2::table::new<vector<u8>, PublicRecipe>(arg0),
            recipe_list     : 0x1::vector::empty<vector<u8>>(),
            used_names      : 0x2::table::new<0x1::string::String, address>(arg0),
            names_list      : 0x1::vector::empty<0x1::string::String>(),
            recipes_by_item : 0x2::table::new<u64, vector<vector<u8>>>(arg0),
        };
