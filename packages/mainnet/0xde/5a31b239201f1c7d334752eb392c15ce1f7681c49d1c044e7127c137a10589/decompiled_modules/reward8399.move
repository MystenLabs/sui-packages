module 0xde5a31b239201f1c7d334752eb392c15ce1f7681c49d1c044e7127c137a10589::reward8399 {
    struct REWARD8399 has drop {
        dummy_field: bool,
    }

    struct TICKET_8399 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8399(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8399>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8399>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8399, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8399>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8399>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8399>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8399>>(v5, 0x2::tx_context::sender(arg1));
    }
