module 0xdef29c09e49aa9b08aa63fb747a9f50233e7abb83d2086f18f7edb447d992e44::suisohi {
    ...
    fun init(arg0: SUISOHI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUISOHI>(arg0, 2, b"FLAME", b"FLAME", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://d1fdloi71mui9q.cloudfront.net/yWduRMdxTbWuSE175lzY_0Uy0NiSvRD8s1av5")), arg1);
