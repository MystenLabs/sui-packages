module 0xdecd800e4cfddc694c84ee3904da418bd7a2e9ee9a450cd3f09fcd0512b65dff::capybara_lootbox {
    ...
    public fun mint_fruit_by_admin(arg0: &0xdecd800e4cfddc694c84ee3904da418bd7a2e9ee9a450cd3f09fcd0512b65dff::capybara_game_card::AdminCap, arg1: &mut DataStorage, arg2: vector<0x1::string::String>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
    ...
    public fun update_storage(arg0: &0xdecd800e4cfddc694c84ee3904da418bd7a2e9ee9a450cd3f09fcd0512b65dff::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
