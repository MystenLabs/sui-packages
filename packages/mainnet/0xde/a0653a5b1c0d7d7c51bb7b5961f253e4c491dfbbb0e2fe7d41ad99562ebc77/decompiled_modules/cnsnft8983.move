module 0xdea0653a5b1c0d7d7c51bb7b5961f253e4c491dfbbb0e2fe7d41ad99562ebc77::cnsnft8983 {
    struct CNSNFT8983 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8983, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8983>(arg0, arg1);
