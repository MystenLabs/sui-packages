module 0xde522e46fbf9ce5c4b87834f0c791efa8106338088318df99e1190fb2302bf16::test_coin {
    ...
    fun init(arg0: TEST_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TEST_COIN>(arg0, 6, b"test", b"teste", b"Template Coin Description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://ts3.tc.mm.bing.net/th/id/ODF.IZLJjDFkxzF8L18jciUW9Q?w=32&h=32&qlt=90&pcl=fffffc&o=6&pid=1.2"))), arg1);
