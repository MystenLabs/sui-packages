module 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access {
    ...
    public(friend) fun add_lock_key<T0: drop>(arg0: &mut ObligationAccessStore) {
        ...
        assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.lock_keys, &v0), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::obligation_access_store_key_exists());
    ...
    public(friend) fun add_reward_key<T0: drop>(arg0: &mut ObligationAccessStore) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.reward_keys, &v0), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::obligation_access_store_key_exists());
    ...
    public fun assert_lock_key_in_store<T0: drop>(arg0: &ObligationAccessStore, arg1: T0) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.lock_keys, &v0), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::obligation_access_lock_key_not_in_store());
    }

    public fun assert_reward_key_in_store<T0: drop>(arg0: &ObligationAccessStore, arg1: T0) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.reward_keys, &v0), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::obligation_access_reward_key_not_in_store());
    }
    ...
    public(friend) fun remove_lock_key<T0: drop>(arg0: &mut ObligationAccessStore) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.lock_keys, &v0), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::obligation_access_store_key_not_found());
    ...
    public(friend) fun remove_reward_key<T0: drop>(arg0: &mut ObligationAccessStore) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.reward_keys, &v0), 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::error::obligation_access_store_key_not_found());
