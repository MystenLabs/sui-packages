module 0xde31180541a5503dcda023e511bfe0a0204a1697e4f9e7ea87917b2373c9791e::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"SPC", b"karupu", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-11-06T09-27-07.125Z-image 16.png")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"karupu"),
            symbol     : 0x1::string::utf8(b"SPC"),
            decimals   : 9,
