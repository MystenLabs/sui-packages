module 0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>,
        init_reward: u64,
    ...
    entry fun add_treasury_cap(arg0: &mut GameInfo, arg1: 0x2::coin::TreasuryCap<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 4);
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury"), arg1);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version      : 1,
            balance      : 0x2::balance::zero<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>(),
    ...
    entry fun remove_treasury_cap(arg0: &mut GameInfo, arg1: &0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg1));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>>(0x2::coin::from_balance<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>(0x2::balance::split<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>>(0x2::coin::from_balance<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>(0x2::balance::withdraw_all<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>>(0x2::coin::mint<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0xdec18dff2c435b5db465beba9346c2423304dfc95a1aeb529678bc380151129a::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
