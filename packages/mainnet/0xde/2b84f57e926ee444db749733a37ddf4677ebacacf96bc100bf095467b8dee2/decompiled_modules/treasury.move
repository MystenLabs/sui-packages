module 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::treasury {
    struct Treasury<phantom T0> has store, key {
        id: 0x2::object::UID,
        controllers: 0x2::table::Table<address, 0x2::object::ID>,
        mint_allowances: 0x2::table::Table<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>,
        roles: 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::Roles<T0>,
    ...
    public fun new<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::DenyCapV2<T0>, arg2: address, arg3: address, arg4: address, arg5: address, arg6: address, arg7: &mut 0x2::tx_context::TxContext) : Treasury<T0> {
        let v0 = Treasury<T0>{
            ...
            mint_allowances     : 0x2::table::new<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(arg7),
            roles               : 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::new<T0>(arg2, arg3, arg4, arg5, arg6, arg7),
            compatible_versions : 0x2::vec_set::singleton<u64>(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::version_control::current_version()),
        };
    ...
    public fun mint_allowance<T0>(arg0: &Treasury<T0>, arg1: 0x2::object::ID) : u64 {
        ...
        0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::value<T0>(0x2::table::borrow<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&arg0.mint_allowances, arg1))
    }

    public fun roles<T0>(arg0: &Treasury<T0>) : &0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::Roles<T0> {
        &arg0.roles
    }

    entry fun abort_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::two_step_role::assert_sender_is_active_role<0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::OwnerRole<T0>>(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::owner_role<T0>(&arg0.roles), arg1);
        ...
        assert!(v0 == 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::version_control::current_version(), 103);
    ...
    public(friend) fun assert_is_compatible<T0>(arg0: &Treasury<T0>) {
        0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::version_control::assert_object_version_is_compatible_with_package(arg0.compatible_versions);
    }
    ...
    entry fun blocklist<T0>(arg0: &mut Treasury<T0>, arg1: &mut 0x2::deny_list::DenyList, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::blocklister<T0>(&arg0.roles) == 0x2::tx_context::sender(arg3), 4);
    ...
    entry fun complete_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::u64::max(v0, v1) == 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::version_control::current_version(), 103);
    ...
    entry fun configure_controller<T0>(arg0: &mut Treasury<T0>, arg1: address, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::master_minter<T0>(&arg0.roles) == 0x2::tx_context::sender(arg3), 6);
    ...
    entry fun configure_minter<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::deny_list::DenyList, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&arg0.mint_allowances, v2)) {
            let v3 = 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::new<T0>();
            0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::set<T0>(&mut v3, arg2);
            0x2::table::add<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&mut arg0.mint_allowances, v2, v3);
        } else {
            0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::set<T0>(0x2::table::borrow_mut<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&mut arg0.mint_allowances, v2), arg2);
        };
    ...
    fun create_mint_cap<T0>(arg0: &Treasury<T0>, arg1: &mut 0x2::tx_context::TxContext) : MintCap<T0> {
        assert_is_compatible<T0>(arg0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::master_minter<T0>(&arg0.roles) == 0x2::tx_context::sender(arg1), 6);
    ...
    entry fun increment_mint_allowance<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::deny_list::DenyList, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::increase<T0>(0x2::table::borrow_mut<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&mut arg0.mint_allowances, v2), arg2);
        let v3 = MinterAllowanceIncremented<T0>{
            controller          : v0,
            mint_cap            : v2,
            allowance_increment : arg2,
            new_allowance       : 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::value<T0>(0x2::table::borrow<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&arg0.mint_allowances, v2)),
        };
    ...
    public fun is_authorized_mint_cap<T0>(arg0: &Treasury<T0>, arg1: 0x2::object::ID) : bool {
        0x2::table::contains<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&arg0.mint_allowances, arg1)
    }
    ...
    public fun mint<T0>(arg0: &mut Treasury<T0>, arg1: &MintCap<T0>, arg2: &0x2::deny_list::DenyList, arg3: u64, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(is_authorized_mint_cap<T0>(arg0, v0), 11);
        assert!(arg3 > 0, 12);
        let v1 = 0x2::table::borrow_mut<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&mut arg0.mint_allowances, v0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::value<T0>(v1) >= arg3, 3);
        0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::decrease<T0>(v1, arg3);
    ...
    entry fun pause<T0>(arg0: &mut Treasury<T0>, arg1: &mut 0x2::deny_list::DenyList, arg2: &mut 0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::pauser<T0>(&arg0.roles) == 0x2::tx_context::sender(arg2), 8);
    ...
    entry fun remove_controller<T0>(arg0: &mut Treasury<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::master_minter<T0>(&arg0.roles) == 0x2::tx_context::sender(arg2), 6);
    ...
    entry fun remove_minter<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        let v1 = get_mint_cap_id<T0>(arg0, v0);
        let v2 = *0x1::option::borrow<0x2::object::ID>(&v1);
        0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::destroy<T0>(0x2::table::remove<0x2::object::ID, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::mint_allowance::MintAllowance<T0>>(&mut arg0.mint_allowances, v2));
    ...
    public(friend) fun roles_mut<T0>(arg0: &mut Treasury<T0>) : &mut 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::Roles<T0> {
        &mut arg0.roles
    }
    ...
    entry fun start_migration<T0>(arg0: &mut Treasury<T0>, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(*0x1::vector::borrow<u64>(0x2::vec_set::keys<u64>(&arg0.compatible_versions), 0) < 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::version_control::current_version(), 102);
        0x2::vec_set::insert<u64>(&mut arg0.compatible_versions, 0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::version_control::current_version());
    ...
    entry fun unpause<T0>(arg0: &mut Treasury<T0>, arg1: &mut 0x2::deny_list::DenyList, arg2: &mut 0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::pauser<T0>(roles<T0>(arg0)) == 0x2::tx_context::sender(arg2), 8);
        let v0 = borrow_deny_cap_mut<T0>(arg0);
        if (0x2::coin::deny_list_v2_is_global_pause_enabled_next_epoch<T0>(arg1)) {
    ...
    entry fun update_metadata<T0>(arg0: &Treasury<T0>, arg1: &mut 0x2::coin::CoinMetadata<T0>, arg2: 0x1::string::String, arg3: 0x1::ascii::String, arg4: 0x1::string::String, arg5: 0x1::ascii::String, arg6: &0x2::tx_context::TxContext) {
        assert_is_compatible<T0>(arg0);
        assert!(0xde2b84f57e926ee444db749733a37ddf4677ebacacf96bc100bf095467b8dee2::roles::metadata_updater<T0>(&arg0.roles) == 0x2::tx_context::sender(arg6), 7);
