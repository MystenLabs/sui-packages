module 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::rize_v1 {
    struct RizeV1 has store, key {
        id: 0x2::object::UID,
        vault: 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::Vault,
        role: 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::Role,
        version: 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::version::Version,
        withdraw: bool,
    }
    ...
    public fun accept_admin(arg0: &mut RizeV1, arg1: &0x2::tx_context::TxContext) : 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap {
        check_version(arg0);
        let (v0, v1) = 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::accept_admin(&mut arg0.role, arg1);
    ...
    public fun admin_withdraw_balance<T0>(arg0: &mut RizeV1, arg1: &0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_version(arg0);
        assert_withdraw(arg0);
        0x2::coin::from_balance<T0>(0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::take_balance<T0>(&mut arg0.vault, arg2), arg3)
    }

    public fun admin_withdraw_object<T0: copy + drop + store, T1: store + key>(arg0: &mut RizeV1, arg1: &0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap, arg2: T0) : T1 {
        check_version(arg0);
        assert_withdraw(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::take_object<T0, T1>(&mut arg0.vault, arg2)
    }
    ...
    fun check_version(arg0: &RizeV1) {
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::version::check_version(&arg0.version);
    }

    public fun get_operator(arg0: &RizeV1) : address {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::get_operator(&arg0.role)
    }

    public fun get_pending_admin_transfer(arg0: &RizeV1) : (address, address) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::get_pending_transfer(&arg0.role)
    }

    public fun get_vault_balance<T0>(arg0: &RizeV1) : u64 {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::get_balance<T0>(&arg0.vault)
    }

    fun init(arg0: RIZE_V1, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::types::is_one_time_witness<RIZE_V1>(&arg0), 0);
        let (v0, v1) = 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::init_role(arg1);
        let v2 = 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::create_vault(arg1);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::navi::setup(&mut v2, arg1);
        let v3 = RizeV1{
            id       : 0x2::object::new(arg1),
            vault    : v2,
            role     : v0,
            version  : 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::version::init_version(),
            withdraw : false,
        };
        0x2::transfer::share_object<RizeV1>(v3);
        0x2::transfer::public_transfer<0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap>(v1, 0x2::tx_context::sender(arg1));
    }

    public fun init_transfer_admin(arg0: &mut RizeV1, arg1: 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::init_transfer_admin(&mut arg0.role, arg1, arg2, arg3);
    ...
    public fun is_admin_transfer_in_progress(arg0: &RizeV1) : bool {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::is_transfer_in_progress(&arg0.role)
    }
    ...
    public fun navi_address(arg0: &RizeV1) : address {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::navi::account_cap_address(&arg0.vault)
    }
    ...
    public fun navi_balance(arg0: &RizeV1, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: u8) : (u256, u256) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::navi::balance(&arg0.vault, arg1, arg2)
    }
    ...
    public fun navi_claim<T0>(arg0: &mut RizeV1, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::IncentiveFundsPool<T0>, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg5: u8, arg6: u8, arg7: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg7);
        let v0 = 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::navi::claim_reward<T0>(&arg0.vault, arg1, arg2, arg3, arg4, arg5, arg6);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::put_balance<T0>(&mut arg0.vault, v0, arg7);
    ...
    public fun navi_deposit<T0>(arg0: &mut RizeV1, arg1: &0x2::clock::Clock, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg4: u8, arg5: u64, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg8: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg8);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::navi::deposit<T0>(&arg0.vault, arg1, arg2, arg3, arg4, 0x2::coin::from_balance<T0>(0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::take_balance<T0>(&mut arg0.vault, arg5), arg8), arg6, arg7);
    ...
    public fun navi_withdraw<T0>(arg0: &mut RizeV1, arg1: &0x2::clock::Clock, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: u8, arg6: u64, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg9);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::put_balance<T0>(&mut arg0.vault, 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::navi::withdraw<T0>(&arg0.vault, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8), arg9);
    ...
    public fun receive_coin<T0>(arg0: &mut RizeV1, arg1: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::vault::put_balance<T0>(&mut arg0.vault, 0x2::coin::into_balance<T0>(v0), arg2);
        let v1 = ReceivedCoinEvent<T0>{amount: 0x2::coin::value<T0>(&v0)};
        0x2::event::emit<ReceivedCoinEvent<T0>>(v1);
    }

    public fun reclaim_admin(arg0: &mut RizeV1, arg1: &0x2::tx_context::TxContext) : 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap {
        check_version(arg0);
        let v0 = ReclaimAdminEvent{admin: 0x2::tx_context::sender(arg1)};
        0x2::event::emit<ReclaimAdminEvent>(v0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::reclaim_admin(&mut arg0.role, arg1)
    }
    ...
    public fun redeem_reward_spool<T0, T1>(arg0: &mut RizeV1, arg1: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T1>, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg4);
        let v0 = ScallopRedeemRewardEvent<T0, T1>{amount: 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::scallop::redeem_rewards_spool<T0, T1>(&mut arg0.vault, arg1, arg2, arg3, arg4)};
    ...
    public fun scallop_mint_market<T0>(arg0: &mut RizeV1, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg5);
        let v0 = 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::scallop::mint_market<T0>(&mut arg0.vault, arg1, arg2, arg3, arg4, arg5);
    ...
    public fun scallop_redeem_market<T0>(arg0: &mut RizeV1, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg2: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = ScallopRedeemMarketEvent<T0>{
            ...
            redeem_amount      : 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::scallop::redeem_market<T0>(&mut arg0.vault, arg1, arg2, arg3, arg4, arg5),
        };
    ...
    public fun scallop_setup<T0>(arg0: &mut RizeV1, arg1: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg3);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::scallop::setup<T0>(&mut arg0.vault, arg1, arg2, arg3);
    ...
    public fun scallop_spool_account<T0>(arg0: &RizeV1) : &0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::SpoolAccount<T0> {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::scallop::borrow_spool_account<T0>(&arg0.vault)
    }
    ...
    public fun scallop_stake_spool<T0>(arg0: &mut RizeV1, arg1: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg4);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::scallop::stake_spool<T0>(&mut arg0.vault, arg1, arg2, arg3, arg4);
    ...
    public fun scallop_unstake_spool<T0>(arg0: &mut RizeV1, arg1: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        check_version(arg0);
        0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::only_operator(&arg0.role, arg4);
        let v0 = 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::scallop::unstake_spool<T0>(&mut arg0.vault, arg1, arg2, arg3, arg4);
        let v1 = ScallopUnstakeSpoolEvent<T0>{amount: v0};
        0x2::event::emit<ScallopUnstakeSpoolEvent<T0>>(v1);
        v0
    }

    public fun set_operator(arg0: &mut RizeV1, arg1: &0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap, arg2: address) {
        check_version(arg0);
        let v0 = SetOperatorEvent{
            prev : 0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::set_operator(&mut arg0.role, arg1, arg2),
            new  : arg2,
        };
        0x2::event::emit<SetOperatorEvent>(v0);
    }

    public fun set_withdraw(arg0: &mut RizeV1, arg1: &0xdeb90f49dbcc929e9959bdd46e2c26a2c064262460e229ab65210e26aa55e24f::role::AdminCap, arg2: bool) {
        check_version(arg0);
        arg0.withdraw = arg2;
