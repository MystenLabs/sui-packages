module 0x2d31d6275950d419151f6f42b0a77cec325c8656129e2e57aa6b93e82b0a9e0c::cnsnft3397 {
    struct CNSNFT3397 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3397, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3397>(arg0, arg1);
