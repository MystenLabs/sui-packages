module 0x2d1d7f6e66cdab784d623c631164c51e2981e1ec9ca52217e00adbf0577d9674::CHILLGUY {
    ...
    fun init(arg0: CHILLGUY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CHILLGUY>(arg0, 9, b"CHILLGUY", x"f09f9fa7", b"Just a Chill Guy", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/b6nmFqY/png3.webp")), arg1);
        let v2 = v0;
