module 0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_accountant {
    ...
    public fun add_capability<T0, T1: drop + store>(arg0: &mut Accountant<T0>, arg1: address, arg2: T1, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg3)), 5);
        assert!(!0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<T1>(&arg0.auth, arg1), 8);
    ...
    public fun auth<T0>(arg0: &Accountant<T0>) : &0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::Auth {
        &arg0.auth
    }
    ...
    public(friend) fun new_accountant<T0>(arg0: address, arg1: u64, arg2: u16, arg3: u16, arg4: u64, arg5: u16, arg6: u16, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : Accountant<T0> {
        let v0 = Accountant<T0>{
            ...
            total_shares                       : 0,
            one_share                          : arg7,
            auth                               : 0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::new_auth(arg8),
        };
        0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::add_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&mut v0.auth, 0x2::tx_context::sender(arg8), 0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::new_owner_cap());
        v0
    }

    public fun pause<T0>(arg0: &mut Accountant<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::PauserCap>(&arg0.auth, 0x2::tx_context::sender(arg1)), 5);
        arg0.is_paused = true;
    ...
    public fun remove_capability<T0, T1: drop + store>(arg0: &mut Accountant<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<T1>(&arg0.auth, arg1), 5);
        if (0x1::type_name::get<T1>() == 0x1::type_name::get<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>()) {
            assert!(*0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::owner_count_mut(&mut arg0.auth) > 1, 9);
            *0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::owner_count_mut(&mut arg0.auth) = *0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::owner_count_mut(&mut arg0.auth) - 1;
        };
    ...
    public fun reset_highwater_mark<T0>(arg0: &mut Accountant<T0>, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
    ...
    public fun unpause<T0>(arg0: &mut Accountant<T0>, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::PauserCap>(&arg0.auth, 0x2::tx_context::sender(arg1)), 5);
    ...
    public fun update_delay<T0>(arg0: &mut Accountant<T0>, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1 <= 1209600000, 0);
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
        ...
        arg0.minimum_update_delay_in_mseconds = arg1;
    }

    public fun update_exchange_rate<T0>(arg0: &mut Accountant<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::UpdateExchangeRateCap>(&arg0.auth, 0x2::tx_context::sender(arg3)), 5);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        if (before_update_exchange_rate<T0>(arg0, arg1, v0)) {
            arg0.is_paused = true;
        } else {
            calculate_fees_owed<T0>(arg0, arg1, v0);
        };
        arg0.exchange_rate = arg1;
        arg0.total_shares_last_updated = arg0.total_shares;
        arg0.last_update_timestamp = v0;
    ...
    public fun update_lower<T0>(arg0: &mut Accountant<T0>, arg1: u16, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1 <= 10000, 3);
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
        ...
        arg0.allowed_exchange_rate_change_lower = arg1;
    }

    public fun update_payout_address<T0>(arg0: &mut Accountant<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
    ...
    public fun update_performance_fee<T0>(arg0: &mut Accountant<T0>, arg1: u16, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1 <= 5000, 2);
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
    ...
    public fun update_platform_fee<T0>(arg0: &mut Accountant<T0>, arg1: u16, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1 <= 2000, 1);
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
    ...
    public fun update_upper<T0>(arg0: &mut Accountant<T0>, arg1: u16, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1 >= 10000, 4);
        assert!(0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::has_cap<0x2dd68ecd6a1e16df849dde5df83ee7704069360a4a9e112ffab655cb9b69845b::test_auth::OwnerCap>(&arg0.auth, 0x2::tx_context::sender(arg2)), 5);
        ...
        arg0.allowed_exchange_rate_change_upper = arg1;
    }
