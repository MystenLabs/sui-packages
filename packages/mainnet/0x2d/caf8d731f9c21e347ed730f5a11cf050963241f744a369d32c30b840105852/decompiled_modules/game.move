module 0xe39b9ba59dd4c523df7a3a8d0eacf0e18576a88b38138b58ccbf1f0daa8aa64d::game {
    ...
    struct PartnerConfig has copy, drop, store {
        cosmetic_type_id: u64,
    }

    struct PartnerRegistryKey has copy, drop, store {
        dummy_field: bool,
    }

    struct PartnerClaimsRegistryKey has copy, drop, store {
        dummy_field: bool,
    }

    struct PartnerPackClaimedV2 has copy, drop {
        partner: 0x1::type_name::TypeName,
        player: address,
        nft_id: address,
        tank_upgraded_to: u8,
        bubblers_minted: vector<u8>,
    ...
    entry fun admin_init_partner_registry<T0, T1>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = PartnerRegistryKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<PartnerRegistryKey>(&arg0.id, v0), 401);
        let v1 = PartnerRegistryKey{dummy_field: false};
        0x2::dynamic_field::add<PartnerRegistryKey, 0x2::table::Table<0x1::type_name::TypeName, PartnerConfig>>(&mut arg0.id, v1, 0x2::table::new<0x1::type_name::TypeName, PartnerConfig>(arg2));
        let v2 = PartnerClaimsRegistryKey{dummy_field: false};
        0x2::dynamic_field::add<PartnerClaimsRegistryKey, 0x2::table::Table<0x1::type_name::TypeName, 0x2::table::Table<address, bool>>>(&mut arg0.id, v2, 0x2::table::new<0x1::type_name::TypeName, 0x2::table::Table<address, bool>>(arg2));
    }
    ...
    entry fun admin_register_partner<T0, T1, T2>(arg0: &mut GameState<T0, T1>, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<u64, CosmeticType>(&arg0.cosmetic_types, arg2), 1);
        let v0 = 0x1::type_name::with_defining_ids<T2>();
        let v1 = PartnerRegistryKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<PartnerRegistryKey, 0x2::table::Table<0x1::type_name::TypeName, PartnerConfig>>(&mut arg0.id, v1);
        assert!(!0x2::table::contains<0x1::type_name::TypeName, PartnerConfig>(v2, v0), 401);
        let v3 = PartnerConfig{cosmetic_type_id: arg2};
        0x2::table::add<0x1::type_name::TypeName, PartnerConfig>(v2, v0, v3);
        let v4 = PartnerClaimsRegistryKey{dummy_field: false};
        0x2::table::add<0x1::type_name::TypeName, 0x2::table::Table<address, bool>>(0x2::dynamic_field::borrow_mut<PartnerClaimsRegistryKey, 0x2::table::Table<0x1::type_name::TypeName, 0x2::table::Table<address, bool>>>(&mut arg0.id, v4), v0, 0x2::table::new<address, bool>(arg3));
    }
    ...
    entry fun claim_partner_pack_v2<T0, T1, T2: key>(arg0: &mut GameState<T0, T1>, arg1: &T2, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        do_claim_partner_pack_v2<T0, T1, T2>(arg0, 0x2::object::id_address<T2>(arg1), arg2, arg3);
    }

    public fun claim_partner_pack_v2_kiosk<T0, T1, T2: store + key>(arg0: &mut GameState<T0, T1>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::borrow_val<T2>(arg1, arg2, 0x2::object::id_from_address(arg3));
        let v2 = v0;
        do_claim_partner_pack_v2<T0, T1, T2>(arg0, 0x2::object::id_address<T2>(&v2), arg4, arg5);
        0x2::kiosk::return_val<T2>(arg1, v2, v1);
    }
    ...
    fun do_claim_partner_pack_v2<T0, T1, T2>(arg0: &mut GameState<T0, T1>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 6);
        let v0 = 0x1::type_name::with_defining_ids<T2>();
        let v1 = PartnerRegistryKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<PartnerRegistryKey, 0x2::table::Table<0x1::type_name::TypeName, PartnerConfig>>(&arg0.id, v1);
        assert!(0x2::table::contains<0x1::type_name::TypeName, PartnerConfig>(v2, v0), 400);
        let v3 = 0x2::table::borrow<0x1::type_name::TypeName, PartnerConfig>(v2, v0).cosmetic_type_id;
        let v4 = 0x2::tx_context::sender(arg3);
        let v5 = PartnerClaimsRegistryKey{dummy_field: false};
        let v6 = 0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<address, bool>>(0x2::dynamic_field::borrow_mut<PartnerClaimsRegistryKey, 0x2::table::Table<0x1::type_name::TypeName, 0x2::table::Table<address, bool>>>(&mut arg0.id, v5), v0);
        assert!(!0x2::table::contains<address, bool>(v6, arg1), 402);
        assert!(!0x2::table::contains<address, bool>(v6, v4), 402);
        0x2::table::add<address, bool>(v6, arg1, true);
        0x2::table::add<address, bool>(v6, v4, true);
        if (!0x2::table::contains<address, PlayerTank>(&arg0.player_tanks, v4)) {
            let v7 = 0x1::vector::empty<u8>();
            let v8 = 0;
            while (v8 < 5) {
                0x1::vector::push_back<u8>(&mut v7, 0);
                v8 = v8 + 1;
            };
            let v9 = PlayerTank{
                tier                   : 0,
            ...
            0x2::table::add<address, PlayerTank>(&mut arg0.player_tanks, v4, v9);
            arg0.total_players = arg0.total_players + 1;
        };
        let v10 = 0x2::table::borrow_mut<address, PlayerTank>(&mut arg0.player_tanks, v4);
        if (v10.tier < 4) {
            v10.tier = 4;
            v10.last_upgrade_time = 0x2::clock::timestamp_ms(arg2);
        };
        let v11 = x"030507";
        let v12 = 0x1::vector::empty<u8>();
        let v13 = 0;
        while (v13 < 0x1::vector::length<u8>(&v11)) {
            let v14 = *0x1::vector::borrow<u8>(&v11, v13);
            let (v15, v16, _, v18, v19) = get_bubbler_stats(v14);
            let v20 = arg0.next_bubbler_id;
            arg0.next_bubbler_id = v20 + 1;
            let v21 = BubbleGenerator{
                id              : 0x2::object::new(arg3),
                bubbler_id      : v20,
                tier            : v14,
                name            : v18,
                ...
                tank_pressure   : v16,
                image_url       : v19,
                attributes      : make_bubbler_attrs(v14, v18),
            };
            0x2::transfer::public_transfer<BubbleGenerator>(v21, v4);
            0x1::vector::push_back<u8>(&mut v12, v14);
            v13 = v13 + 1;
        };
        assert!(0x2::table::contains<u64, CosmeticType>(&arg0.cosmetic_types, v3), 1);
        let v22 = 0x2::table::borrow_mut<u64, CosmeticType>(&mut arg0.cosmetic_types, v3);
        assert!(v22.minted < v22.max_supply, 15);
        let v23 = v22.name;
        let v24 = v22.bubble_pressure;
        v22.minted = v22.minted + 1;
        let v25 = arg0.next_cosmetic_instance_id;
        arg0.next_cosmetic_instance_id = v25 + 1;
        let v26 = BubbleCosmetic{
            id                   : 0x2::object::new(arg3),
            cosmetic_instance_id : v25,
            cosmetic_type_id     : v3,
            name                 : v23,
            bubble_pressure      : v24,
            image_url            : v22.image_url,
            attributes           : make_cosmetic_attrs(v23),
        };
        0x2::transfer::public_transfer<BubbleCosmetic>(v26, v4);
        let v27 = PartnerPackClaimedV2{
            partner          : v0,
            player           : v4,
            nft_id           : arg1,
            tank_upgraded_to : 4,
        ...
        0x2::event::emit<PartnerPackClaimedV2>(v27);
    }
    ...
    public fun get_tier(arg0: &BubbleGenerator) : u8 {
        arg0.tier
    }
