module 0x2d3bac45af9888c84c1cf46bd48c263bd94a7fcb1bbe05ebf78d7d24fec26580::gift4947 {
    struct GIFT4947 has drop {
        dummy_field: bool,
    }

    struct TICKET_4947 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4947(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4947>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4947>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4947, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4947>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4947>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4947>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4947>>(v5, 0x2::tx_context::sender(arg1));
    }
