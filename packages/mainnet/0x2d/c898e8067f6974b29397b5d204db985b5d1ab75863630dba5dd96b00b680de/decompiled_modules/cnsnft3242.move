module 0x2dc898e8067f6974b29397b5d204db985b5d1ab75863630dba5dd96b00b680de::cnsnft3242 {
    struct CNSNFT3242 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3242, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3242>(arg0, arg1);
