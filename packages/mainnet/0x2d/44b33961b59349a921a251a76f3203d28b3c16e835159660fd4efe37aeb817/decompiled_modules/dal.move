module 0x2d44b33961b59349a921a251a76f3203d28b3c16e835159660fd4efe37aeb817::dal {
    struct DAL has drop {
        dummy_field: bool,
    }

    fun init(arg0: DAL, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/pPU8kbCrdwcLxf_roIzrMO7XG2cXHlYLcbWjwy_mbqg";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/pPU8kbCrdwcLxf_roIzrMO7XG2cXHlYLcbWjwy_mbqg"))
        };
        ...
        if (10000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<DAL>>(0x2::coin::mint<DAL>(&mut v5, 10000000000000000, arg1), v6);
        };
