module 0x2da5caf9516b6ffb48412a16e82074fef8627c43078dcb0b9ed23e39f492beb2::PIPPIN {
    struct PIPPIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: PIPPIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<PIPPIN>(arg0, 2, b"PIPPIN", b"Pippin", b"Pippin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/VcS5u7ATuQDs0SIHkTs7gwNZtrQTO08OT0PvAedYVh4?ext=png")), arg1);
