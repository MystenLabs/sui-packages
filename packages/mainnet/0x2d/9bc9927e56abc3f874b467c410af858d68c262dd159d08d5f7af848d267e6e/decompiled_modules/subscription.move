module 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::subscription {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun finalize_market<T0, T1>(arg0: &0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::LpVault<T0, T1> {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(0x2::balance::value<T1>(&arg1.balance_y) >= arg1.soft_cap && v0 > arg1.market_close, 9);
        if (v0 < arg1.market_close + 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::main::curator_finalizing_cooldown(arg0)) {
        ...
        let v1 = @0x0;
        let v2 = 0;
        let v3 = 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::main::admin_key_id(arg0), arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v11) {
                ...
                0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::add_position<T0, T1>(&mut v3, v20);
                let v23 = 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::id<T0, T1>(&v3);
                let v24 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::id_to_address(&v23),
                ...
                0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::add_position<T0, T1>(&mut v3, v31);
                let v34 = 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::id<T0, T1>(&v3);
                let v35 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault::id_to_address(&v34),
                    curator          : arg1.curator,
                    pool_address     : v33,
        ...
        let v36 = arg1.soft_cap - arg1.soft_cap * 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::main::finalize_market_fee_bps(arg0) / 10000;
        let v37 = v36;
        if (arg1.is_auto_add_liquidity) {
    ...
    fun validate_params(arg0: &0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::main::MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::main::finalize_market_fee_bps(arg0) <= 10000, 1);
        let v0 = 0;
        if (arg5) {
