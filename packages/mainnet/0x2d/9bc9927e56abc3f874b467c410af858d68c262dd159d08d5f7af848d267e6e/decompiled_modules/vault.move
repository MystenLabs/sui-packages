module 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::vault {
    ...
    public fun claim<T0, T1>(arg0: &mut LpVault<T0, T1>, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v2 = 0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::get_id(&arg0.id);
        let v3 = 0x1::string::utf8(0x2::object::id_to_bytes(&v2));
        0x1::string::append(&mut v3, 0x1::u64::to_string(arg1));
        0x1::string::append(&mut v3, 0x2::address::to_string(v0));
        0x1::string::append(&mut v3, 0x1::u64::to_string(arg2));
        assert!(0x1::string::utf8(arg3) == v3, 2);
        assert!(0x2::table::contains<u64, u64>(&v1.epoch_totals, arg1), 2);
        let v4 = 0x2::table::borrow<u64, u64>(&v1.epoch_totals, arg1);
        let v5 = if (!0x2::table::contains<address, 0x2::table::Table<u64, u64>>(&v1.claims, v0)) {
        ...
        assert!(!0x2::table::contains<u64, u64>(v5, arg1), 3);
        0x2::table::add<u64, u64>(v5, arg1, arg2);
        0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::emit_fee_claimed<T0, T1>(0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::get_id(&v1.id), v0, 0, arg2, arg2, *v4);
    ...
    public fun collect_lp_fee<T0, T1>(arg0: &mut LpVault<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::emit_fee_collected<T0, T1>(0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::get_id(&arg0.id), v6, v7, arg4, v0, arg3);
    }
    ...
    public fun id<T0, T1>(arg0: &LpVault<T0, T1>) : 0x2::object::ID {
        0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::get_id(&arg0.id)
    }
    ...
    public fun new_lp_vault<T0, T1>(arg0: 0x2::bag::Bag, arg1: address, arg2: vector<u8>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : LpVault<T0, T1> {
        ...
        0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::emit_vault_created<T0, T1>(0x2d9bc9927e56abc3f874b467c410af858d68c262dd159d08d5f7af848d267e6e::events::get_id(&v0.id), arg1, arg2, v0.epoch);
        LpVault<T0, T1>{
            id           : 0x2::object::new(arg4),
            position_bag : arg0,
            curator      : arg1,
