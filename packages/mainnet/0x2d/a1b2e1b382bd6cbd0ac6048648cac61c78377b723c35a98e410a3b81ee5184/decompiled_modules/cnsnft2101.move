module 0x2da1b2e1b382bd6cbd0ac6048648cac61c78377b723c35a98e410a3b81ee5184::cnsnft2101 {
    struct CNSNFT2101 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2101, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2101>(arg0, arg1);
