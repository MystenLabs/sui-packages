module 0x32e26b26aec256b3fac5f8823d0d98955f9d4eda378a17994d88067299e9b473::stake {
    ...
    public fun last_time_kb(arg0: &StakePool, arg1: address) : u64 {
        assert!(0x2::table::contains<address, u64>(&arg0.time_kb, arg1), 1);
        *0x2::table::borrow<address, u64>(&arg0.time_kb, arg1)
    }

    public fun last_time_kc(arg0: &StakePool, arg1: address) : u64 {
        assert!(0x2::table::contains<address, u64>(&arg0.time_kc, arg1), 1);
        *0x2::table::borrow<address, u64>(&arg0.time_kc, arg1)
    }

    public fun last_time_ks(arg0: &StakePool, arg1: address) : u64 {
        assert!(0x2::table::contains<address, u64>(&arg0.time_ks, arg1), 1);
        *0x2::table::borrow<address, u64>(&arg0.time_ks, arg1)
    }
