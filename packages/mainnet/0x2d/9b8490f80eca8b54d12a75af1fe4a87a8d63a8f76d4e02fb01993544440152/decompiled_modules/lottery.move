module 0xff7fed37f3d61ca2cb7f2628f527e5c0a26294f1589c8565333aeb1a66b02c60::lottery {
    ...
    public fun admin_redeem<T0>(arg0: &mut LotteryStore, arg1: 0x2::object::ID, arg2: &LotterySuperAdminCap, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (0x1::vector::length<Ticket<T0>>(v1) > 800) {
            800
        } else {
            0x1::vector::length<Ticket<T0>>(v1)
        };
        let v4 = 0;
        while (v4 < v3 && 0x1::vector::length<Ticket<T0>>(v1) > 0) {
            let v5 = 0x1::vector::pop_back<Ticket<T0>>(v1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v2, 0x2::balance::value<T0>(&v2), arg4), arg3);
    }
