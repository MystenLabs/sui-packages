module 0x2d6f0743f9c0e8fd460b09819cd64d827d00b78efc8944710315bedb860f390c::cnsnft6999 {
    struct CNSNFT6999 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6999, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6999>(arg0, arg1);
