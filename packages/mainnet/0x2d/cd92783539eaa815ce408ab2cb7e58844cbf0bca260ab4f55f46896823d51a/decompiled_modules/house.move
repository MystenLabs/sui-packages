module 0x8011111bda5f6df303604624f3e0aa8f8a78f82967b1d0d3118f36289a3742::house {
    ...
    public fun fee_balance<T0>(arg0: &House<T0>) : u64 {
    ...
    public(friend) fun join_from_pipe<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<PipeDebt<T0>>) {
        0x2::balance::join<T0>(&mut arg0.pool, arg1);
    ...
    public(friend) fun join_with_fee<T0>(arg0: &mut House<T0>, arg1: 0x2::balance::Balance<T0>) {
        let v0 = 0x8011111bda5f6df303604624f3e0aa8f8a78f82967b1d0d3118f36289a3742::math::mul_rate(0x2::balance::value<T0>(&arg1), 300000);
    ...
    public fun max_risk<T0>(arg0: &House<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.pool) / 10
    }
    ...
    public fun pool_changes(arg0: u64) : (u64, u64) {
        (arg0, 0x8011111bda5f6df303604624f3e0aa8f8a78f82967b1d0d3118f36289a3742::math::mul_rate(arg0, 300000))
    }
    ...
    public(friend) fun split_for_pipe<T0>(arg0: &mut House<T0>, arg1: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<PipeDebt<T0>>) {
    ...
    public(friend) fun split_with_reimbursement<T0>(arg0: &mut House<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(arg1 <= max_risk<T0>(arg0), 0);
        assert!(arg1 <= 0x2::balance::value<T0>(&arg0.pool), 1);
        let v0 = 0x8011111bda5f6df303604624f3e0aa8f8a78f82967b1d0d3118f36289a3742::math::mul_rate(arg1, 300000);
