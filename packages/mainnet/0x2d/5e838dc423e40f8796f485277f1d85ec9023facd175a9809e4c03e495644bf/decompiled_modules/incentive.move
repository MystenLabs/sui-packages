module 0xb85ec914c911ffb40f144c7246f525a627d38d024d4ee91de16c97c89f2cd736::incentive {
    ...
    fun update_reward(arg0: &0x2::clock::Clock, arg1: &mut Incentive, arg2: &mut 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::Storage, arg3: u8, arg4: u8, arg5: address) {
        ...
        let (v5, v6) = 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_user_balance(arg2, arg3, arg5);
        let (v7, v8) = 0x57085c1f4a2d163d23aae1906e8055f80cf856464ac4fc55d6f05f4c863b9588::storage::get_total_supply(arg2, arg3);
        let v9 = v7;
        if (arg4 == 3) {
            v9 = v8;
        };
        while (v4 > 0) {
            ...
            let (v12, v13) = calculate_one(v10, 0x2::clock::timestamp_ms(arg0), v9, arg5, v11);
            v10.index_reward = v12;
            if (0x2::table::contains<address, u256>(&v10.index_rewards_paids, arg5)) {
                0x2::table::remove<address, u256>(&mut v10.index_rewards_paids, arg5);
            };
            0x2::table::add<address, u256>(&mut v10.index_rewards_paids, arg5, v12);
            if (0x2::table::contains<address, u256>(&v10.total_rewards_of_users, arg5)) {
                0x2::table::remove<address, u256>(&mut v10.total_rewards_of_users, arg5);
            };
            0x2::table::add<address, u256>(&mut v10.total_rewards_of_users, arg5, v13);
            v4 = v4 - 1;
        };
    }
