module 0x9711179ad9d6f030e9825d2d246fa2b8e1aa14a929de4fe30323136532f58c9a::atlansui {
    ...
    public fun repayment_offer_kiosk<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::coin::Coin<T0>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk::has_access(arg4, arg5), 4);
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, arg1), 2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Collection<T0, T1>>(&mut arg0.id, arg1);
