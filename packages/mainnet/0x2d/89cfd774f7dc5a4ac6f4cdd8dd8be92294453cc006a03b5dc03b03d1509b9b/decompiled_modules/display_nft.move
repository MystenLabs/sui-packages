module 0x2d89cfd774f7dc5a4ac6f4cdd8dd8be92294453cc006a03b5dc03b03d1509b9b::display_nft {
    ...
    fun init(arg0: DISPLAY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"THIS IS A GIFT NFT FORM SINGMIN!"));
        ...
        let v6 = MyNFT{
            ...
            name      : 0x1::string::utf8(b"SINGMIN DISPLAY NFT"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/74779427?v=4"),
        };
