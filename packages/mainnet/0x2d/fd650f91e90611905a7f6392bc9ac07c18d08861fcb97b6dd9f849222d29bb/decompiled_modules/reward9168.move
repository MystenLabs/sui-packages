module 0x2dfd650f91e90611905a7f6392bc9ac07c18d08861fcb97b6dd9f849222d29bb::reward9168 {
    struct REWARD9168 has drop {
        dummy_field: bool,
    }

    struct TICKET_9168 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9168(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9168>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9168>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9168, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9168>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9168>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9168>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9168>>(v5, 0x2::tx_context::sender(arg1));
    }
