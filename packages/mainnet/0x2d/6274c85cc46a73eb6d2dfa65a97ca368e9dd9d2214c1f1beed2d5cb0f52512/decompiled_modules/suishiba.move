module 0x1e520f3bb4b93938cf2bc90fb8d709ed3042dbf3c0290824c0ace15e583e8162::suishiba {
    ...
    fun calculate_vesting_amount(arg0: &mut Distribution, arg1: u64) : u64 {
        ...
        if (v0 > 0 && arg0.vesting.tge_status) {
            let v2 = 0x1e520f3bb4b93938cf2bc90fb8d709ed3042dbf3c0290824c0ace15e583e8162::math::mul_div(arg0.vesting.total_amount, v0, 100);
    ...
    fun init(arg0: SUISHIBA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = VestingMap{
            ...
            tge_status            : true,
            tge_percent           : 0,
            cycle_amount          : 0x1e520f3bb4b93938cf2bc90fb8d709ed3042dbf3c0290824c0ace15e583e8162::math::mul_div(15000000000000000, 10, 100),
        };
        let v7 = Distribution{
            id      : 0x2::object::new(arg1),
