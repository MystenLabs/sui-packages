module 0x2d9709675066280efd00fbcc2885fb348785e192fdeb807ad7d6b1cf012476cd::cnsnft8677 {
    struct CNSNFT8677 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8677, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1623"));
        let v4 = 0x2::package::claim<CNSNFT8677>(arg0, arg1);
