module 0x2d6eb7d37e1480bdf59f52c144554cdee5d970bbc656d61ef9d0e92353381337::suigpt_test_2 {
    ...
    struct SUIGPT_TEST_2 has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIGPT_TEST_2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SuiGPT Test 2"));
        ...
        let v4 = 0x2::package::claim<SUIGPT_TEST_2>(arg0, arg1);
