module 0x2d31c3e65541f0398bcbdc038358a56e0455e75b6127ed6a3330f42de131823b::reward9319 {
    struct REWARD9319 has drop {
        dummy_field: bool,
    }

    struct TICKET_9319 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9319(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9319>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9319>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9319, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9319>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9319>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9319>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9319>>(v5, 0x2::tx_context::sender(arg1));
    }
