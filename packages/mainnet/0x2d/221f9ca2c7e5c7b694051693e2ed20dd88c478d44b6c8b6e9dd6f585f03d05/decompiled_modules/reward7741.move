module 0x2d221f9ca2c7e5c7b694051693e2ed20dd88c478d44b6c8b6e9dd6f585f03d05::reward7741 {
    struct REWARD7741 has drop {
        dummy_field: bool,
    }

    struct TICKET_7741 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7741(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7741>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7741>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7741, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7741>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7741>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7741>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7741>>(v5, 0x2::tx_context::sender(arg1));
    }
