module 0x2db568f2c5da6e195b4dd9b341801db7333dacb10e7791b83fa311e5ac28e1ab::fast_price_feed {
    ...
    public fun test(arg0: &vector<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>, arg1: &0x2::clock::Clock) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg0)) {
            let (_, _) = get_price(0x1::vector::borrow<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg0, v0), 6, 60000000, arg1);
            v0 = v0 + 1;
        };
    }
