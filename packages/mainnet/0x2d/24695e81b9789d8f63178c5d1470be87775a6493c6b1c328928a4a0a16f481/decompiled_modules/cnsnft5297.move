module 0x2d24695e81b9789d8f63178c5d1470be87775a6493c6b1c328928a4a0a16f481::cnsnft5297 {
    struct CNSNFT5297 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5297, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1750"));
        let v4 = 0x2::package::claim<CNSNFT5297>(arg0, arg1);
