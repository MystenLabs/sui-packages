module 0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::loot_box {
    ...
    struct LootBoxesOpened has copy, drop {
        box_template: 0x2::object::ID,
        claim_ids: vector<0x2::object::ID>,
    }
    ...
    public(friend) fun claim_batch(arg0: vector<BoxClaim>, arg1: vector<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::PM>, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::Item>, arg5: &mut 0x2::random::RandomGenerator, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!0x1::vector::is_empty<BoxClaim>(&arg0) && 0x1::vector::length<BoxClaim>(&arg0) <= (50 as u64), 2910);
        assert!(0x1::vector::length<BoxClaim>(&arg0) == 0x1::vector::length<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::PM>(&arg1), 2907);
        0x1::vector::reverse<BoxClaim>(&mut arg0);
        0x1::vector::reverse<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::PM>(&mut arg1);
        while (!0x1::vector::is_empty<BoxClaim>(&arg0)) {
            let BoxClaim {
                id              : v0,
                box_template    : v1,
                rolled_template : v2,
                amount          : v3,
            } = 0x1::vector::pop_back<BoxClaim>(&mut arg0);
            0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::deliver_claim(0x1::vector::pop_back<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::PM>(&mut arg1), v2, v3, arg2, arg3, arg4, arg5, arg6);
            let v4 = LootClaimed{
                box_template    : v1,
                rolled_template : v2,
                amount          : v3,
                opener          : 0x2::tx_context::sender(arg6),
            };
            0x2::event::emit<LootClaimed>(v4);
            0x2::object::delete(v0);
        };
        0x1::vector::destroy_empty<BoxClaim>(arg0);
    }
    ...
    public(friend) fun claim_loot(arg0: BoxClaim, arg1: &0xaaa207456758bfc1c608e7e3032ab367235aadec966511784c340b1962bdfd53::item_rows::ItemTemplate, arg2: 0x1::option::Option<0x2::object::ID>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::Item>, arg6: &mut 0x2::random::RandomGenerator, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0xaaa207456758bfc1c608e7e3032ab367235aadec966511784c340b1962bdfd53::item_rows::template_id(arg1) == arg0.rolled_template, 2907);
        let v0 = 0x1::vector::empty<BoxClaim>();
        0x1::vector::push_back<BoxClaim>(&mut v0, arg0);
        let v1 = 0x1::vector::empty<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::PM>();
        0x1::vector::push_back<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::PM>(&mut v1, 0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::prepare_plan(arg1, arg2));
        claim_batch(v0, v1, arg3, arg4, arg5, arg6, arg7);
    }
    ...
    public(friend) fun open_box(arg0: &LootRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &0xaaa207456758bfc1c608e7e3032ab367235aadec966511784c340b1962bdfd53::item_rows::ItemTemplate, arg5: &0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::protected_policy::AresRPG_TransferPolicy<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::Item>, arg6: &mut 0x2::random::RandomGenerator, arg7: &mut 0x2::tx_context::TxContext) {
        open_boxes(arg0, arg1, arg2, arg3, arg4, arg5, 1, arg6, arg7);
    }

    public(friend) fun open_boxes(arg0: &LootRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &0xaaa207456758bfc1c608e7e3032ab367235aadec966511784c340b1962bdfd53::item_rows::ItemTemplate, arg5: &0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::protected_policy::AresRPG_TransferPolicy<0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::Item>, arg6: u32, arg7: &mut 0x2::random::RandomGenerator, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg6 > 0 && arg6 <= 50, 2910);
        ...
        0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item::burn(arg1, arg2, arg5, arg3, arg6, arg8);
        let v3 = 0x1::vector::empty<0x2::object::ID>();
        let v4 = 0;
        while (v4 < arg6) {
            let v5 = 0xa0834c4478e642a381211fa2348b444106fceabeb7a41dda5a93a6645f4aca2d::loot_table::pick(&v1, 0x2::random::generate_u64_in_range(arg7, 0, v2 - 1));
            let v6 = 0xa0834c4478e642a381211fa2348b444106fceabeb7a41dda5a93a6645f4aca2d::loot_table::template(&v5);
            let v7 = 0xa0834c4478e642a381211fa2348b444106fceabeb7a41dda5a93a6645f4aca2d::loot_table::amount(&v5);
            let v8 = 0x2::tx_context::sender(arg8);
            let v9 = 0x2::object::new(arg8);
            0x1::vector::push_back<0x2::object::ID>(&mut v3, 0x2::object::uid_to_inner(&v9));
            let v10 = LootBoxOpened{
                box_template    : v0,
                rolled_template : v6,
                amount          : v7,
                opener          : v8,
            };
            0x2::event::emit<LootBoxOpened>(v10);
            let v11 = BoxClaim{
                id              : v9,
                box_template    : v0,
                rolled_template : v6,
            ...
            0x2::transfer::transfer<BoxClaim>(v11, v8);
            v4 = v4 + 1;
        };
        let v12 = LootBoxesOpened{
            box_template : v0,
            claim_ids    : v3,
        };
        0x2::event::emit<LootBoxesOpened>(v12);
    }
