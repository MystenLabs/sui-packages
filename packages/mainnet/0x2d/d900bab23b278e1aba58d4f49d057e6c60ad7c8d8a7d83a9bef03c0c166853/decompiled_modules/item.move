module 0x427af9b0d1cc5145a5112bd5b473dd615d48b5389de296eb7c512afdec160e1d::item {
    ...
    public(friend) fun deliver_claim(arg0: PM, arg1: 0x2::object::ID, arg2: u32, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<Item>, arg6: &mut 0x2::random::RandomGenerator, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.template == arg1, 204);
        deposit(arg3, arg4, arg5, arg0.existing, mint_from_plan(&arg0, arg2, arg6, arg7));
    }
