module 0x2d9316f1f1a95f6d7c85a4e690ef7c359e6649773ef2c37ad7d9857adb6bef06::vault {
    ...
    public fun collect_fees<T0>(arg0: &ProtocolFeeVault, arg1: &mut 0x64213b0e4a52bac468d4ac3f140242f70714381653a1919a6d57cd49c628207a::treasury::Treasury, arg2: &mut 0xa6baab1e668c7868991c1c3c11e144100f5734c407d020f72a01b9d1a8bcb97f::insurance_fund::InsuranceFund, arg3: &0xc66fabf1a9253e43c70f1cc02d40a1d18db183140ecaae2a3f58fa6b66c55acf::referral_vault::ReferralVault, arg4: &mut 0x2::coin::Coin<T0>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0);
        let v0 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_by_fraction(0x2::coin::value<T0>(arg4), arg0.fee_percentages.total_protocol_fee);
        let v1 = if (0xc66fabf1a9253e43c70f1cc02d40a1d18db183140ecaae2a3f58fa6b66c55acf::referral_vault::has_referrer(arg3, arg5)) {
            let v2 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_by_fraction(v0, arg0.fee_percentages.treasury);
            v2 - 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_by_fraction(v2, arg0.fee_percentages.referee_discount)
        } else {
            0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_by_fraction(v0, arg0.fee_percentages.treasury)
        };
        if (v1 > 0) {
        ...
        let v3 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_by_fraction(v0, arg0.fee_percentages.insurance_fund);
        if (v3 > 0) {
        ...
        let v4 = 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::mul_by_fraction(v0, arg0.fee_percentages.dev_wallet);
        if (v4 > 0) {
    ...
    public fun minimum_before_fees(arg0: &ProtocolFeeVault, arg1: u64) : u64 {
        assert_version(arg0);
        0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::div_up_by_fraction(arg1, 0x73baa782c55003b3a359dec04b189312565d18e7309d4a51f5f112f891e3b2ab::fixed::complement64(arg0.fee_percentages.total_protocol_fee))
    }
