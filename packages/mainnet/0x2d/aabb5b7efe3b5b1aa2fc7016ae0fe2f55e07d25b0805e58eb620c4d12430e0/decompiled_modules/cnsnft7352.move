module 0x2daabb5b7efe3b5b1aa2fc7016ae0fe2f55e07d25b0805e58eb620c4d12430e0::cnsnft7352 {
    struct CNSNFT7352 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7352, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4868"));
        let v4 = 0x2::package::claim<CNSNFT7352>(arg0, arg1);
