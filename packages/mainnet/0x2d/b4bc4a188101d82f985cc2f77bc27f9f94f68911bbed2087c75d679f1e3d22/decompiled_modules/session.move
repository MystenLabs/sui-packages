module 0xac55259d62fd8c30dd638f46afab109bc6a1066c4e92093b791d60e6bad266e7::session {
    ...
    public(friend) fun sender(arg0: &Session) : address {
        arg0.sender
    }
    ...
    public(friend) fun flash_fee(arg0: &Session) : u64 {
        arg0.flash_fee
    }
    ...
    public(friend) fun min_profit(arg0: &Session) : u64 {
        arg0.min_profit
    }
    ...
    public(friend) fun new_probe_session<T0>(arg0: u128, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u8, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : Session {
        assert!(arg7 > 0 && arg7 <= 8, 102);
        assert!(arg2 <= arg3 && arg3 <= arg4, 114);
        assert!(arg4 > 0 && arg4 <= arg1, 114);
        assert!(arg1 > 0, 112);
    ...
    public(friend) fun notional(arg0: &Session) : u64 {
        arg0.notional
    }
    ...
    public(friend) fun set_probes(arg0: &mut Session, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg0.phase == 0, 103);
        assert!(arg1 <= arg2 && arg2 <= arg3, 114);
        assert!(arg3 <= arg0.notional, 114);
        let v0 = (3 as u64);
        *0x1::vector::borrow_mut<u64>(&mut arg0.expected, v0) = arg1;
        *0x1::vector::borrow_mut<u64>(&mut arg0.expected, v0 + 1) = arg2;
        *0x1::vector::borrow_mut<u64>(&mut arg0.expected, v0 + 2) = arg3;
        let v1 = 0;
        while (v1 < v0) {
            *0x1::vector::borrow_mut<u64>(&mut arg0.expected, v1) = 0;
            *0x1::vector::borrow_mut<u8>(&mut arg0.quoted, v1) = 0;
            v1 = v1 + 1;
        };
    }
