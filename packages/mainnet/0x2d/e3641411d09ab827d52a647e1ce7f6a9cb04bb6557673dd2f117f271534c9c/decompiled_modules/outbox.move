module 0x2de3641411d09ab827d52a647e1ce7f6a9cb04bb6557673dd2f117f271534c9c::outbox {
    struct Outbox<T0: store> has store {
        entries: 0x2::table::Table<OutboxKey, OutboxItem<T0>>,
        rate_limit: 0x2de3641411d09ab827d52a647e1ce7f6a9cb04bb6557673dd2f117f271534c9c::rate_limit::RateLimitState,
    }
    ...
    struct OutboxItem<T0> has store {
        ...
        released: 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::bitmap::Bitmap,
        ...
        data: 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun add<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxItem<T0>) : OutboxKey {
        let v0 = OutboxKey{id: 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::get_id<T0>(&arg1.data)};
    ...
    public(friend) fun new<T0: store>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Outbox<T0> {
        Outbox<T0>{
            ...
            rate_limit : 0x2de3641411d09ab827d52a647e1ce7f6a9cb04bb6557673dd2f117f271534c9c::rate_limit::new(arg0),
        }
    }
    ...
    public fun borrow_data<T0: store>(arg0: &OutboxItem<T0>) : &0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::NttManagerMessage<T0> {
        &arg0.data
    }

    public fun borrow_rate_limit_mut<T0: store>(arg0: &mut Outbox<T0>) : &mut 0x2de3641411d09ab827d52a647e1ce7f6a9cb04bb6557673dd2f117f271534c9c::rate_limit::RateLimitState {
        &mut arg0.rate_limit
    }
    ...
    public fun new_outbox_item<T0>(arg0: u64, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::NttManagerMessage<T0>) : OutboxItem<T0> {
        OutboxItem<T0>{
            release_timestamp     : arg0,
            released              : 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::bitmap::empty(),
    ...
    public(friend) fun try_release<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxKey, arg2: u8, arg3: &0x2::clock::Clock) : bool {
        ...
        if (0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::bitmap::get(&v0.released, arg2)) {
            abort 13906834586660241409
        };
        0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::bitmap::enable(&mut v0.released, arg2);
        true
    }
