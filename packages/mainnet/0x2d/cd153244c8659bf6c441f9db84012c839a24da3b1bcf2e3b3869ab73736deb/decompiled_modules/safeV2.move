module 0x2dcd153244c8659bf6c441f9db84012c839a24da3b1bcf2e3b3869ab73736deb::safeV2 {
    ...
    public fun access_list_add(arg0: &mut AccessList, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x1e0ee81e545383c820d452f66316783858a08ac21afb72537e461408e2b9be6a, 1);
    ...
    public fun new_access_list(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0x1e0ee81e545383c820d452f66316783858a08ac21afb72537e461408e2b9be6a, 1);
        let v0 = AccessList{
            id   : 0x2::object::new(arg0),
            list : 0x1::vector::singleton<address>(@0x1e0ee81e545383c820d452f66316783858a08ac21afb72537e461408e2b9be6a),
        };
