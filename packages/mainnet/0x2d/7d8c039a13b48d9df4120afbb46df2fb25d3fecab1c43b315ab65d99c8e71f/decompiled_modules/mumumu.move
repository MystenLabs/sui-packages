module 0x2d7d8c039a13b48d9df4120afbb46df2fb25d3fecab1c43b315ab65d99c8e71f::mumumu {
    ...
    fun generate_metadata(arg0: u64, arg1: &Mumumu) : 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = &mut v5;
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"Mumumu #{token_id}"));
        ...
        let v10 = v9;
        let v11 = v8;
        0x2d7d8c039a13b48d9df4120afbb46df2fb25d3fecab1c43b315ab65d99c8e71f::royalty_rule::add<NFT>(&mut v11, &v10, 1000, 0);
        0x2d7d8c039a13b48d9df4120afbb46df2fb25d3fecab1c43b315ab65d99c8e71f::kiosk_lock_rule::add<NFT>(&mut v11, &v10);
    ...
    public entry fun purchase_token(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::transfer_policy::TransferPolicy<NFT>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2d7d8c039a13b48d9df4120afbb46df2fb25d3fecab1c43b315ab65d99c8e71f::kiosk_lock_rule::prove<NFT>(&mut v2, &v6);
