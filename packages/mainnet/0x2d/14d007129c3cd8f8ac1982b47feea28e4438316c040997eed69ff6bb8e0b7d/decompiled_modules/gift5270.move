module 0x2d14d007129c3cd8f8ac1982b47feea28e4438316c040997eed69ff6bb8e0b7d::gift5270 {
    struct GIFT5270 has drop {
        dummy_field: bool,
    }

    struct TICKET_5270 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5270(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5270>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5270>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5270, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5270>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5270>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5270>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5270>>(v5, 0x2::tx_context::sender(arg1));
    }
