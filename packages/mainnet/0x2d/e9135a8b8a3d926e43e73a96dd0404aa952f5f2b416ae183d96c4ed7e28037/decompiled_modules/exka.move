module 0x2de9135a8b8a3d926e43e73a96dd0404aa952f5f2b416ae183d96c4ed7e28037::exka {
    struct EXKA has drop {
        dummy_field: bool,
    }

    fun init(arg0: EXKA, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::epoch(arg1) == 810 || 0x2::tx_context::epoch(arg1) == 811, 1);
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<EXKA>(&mut v2, 500000000000000, @0xe4fa4ff3b902d184f653431599fe1965c2189c729a8a8dfcea110c6fafc41f20, arg1);
