module 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::pool {
    ...
    struct GlobalConfig has key {
        id: 0x2::object::UID,
        config_cap: 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::admin::GlobalConfigCap,
    ...
    fun get_price<T0, T1>(arg0: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg1: &0x2::clock::Clock) : (u128, bool) {
        let (v0, v1) = 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::get_valid_price<T0, T1>(arg0, arg1);
        let v2 = v0;
        let v3 = 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::price_data_price<T0, T1>(&v2);
        (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::internal_price::get_price<T0, T1>(&v3), v1)
    }

    public fun add_quote_asset<T0, T1>(arg0: &GlobalConfig, arg1: &mut LiquidityPool<T0>, arg2: &mut 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<u64>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::check_asset_pair_exists<T0, T1>(arg2) || 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::check_asset_pair_exists<T1, T0>(arg2), 4014);
    ...
    public fun calc_claimable_rewards<T0>(arg0: &LiquidityPool<T0>, arg1: &LPPosition<T0>, arg2: u64) : ClaimableRewardsInfo {
        ...
        let v3 = (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v1 - v2, (arg1.shares as u128), (1000000000000000000 as u128)) as u64);
        let v4 = v3;
    ...
    fun calc_dynamic_fee<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &QuoteAssetReserve<T1>, arg2: u64, arg3: bool, arg4: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg5: &0x2::clock::Clock) : (u64, u128) {
        let (v0, _) = get_pool_liquidity<T0>(arg0);
        let (v2, v3) = get_price<T1, T0>(arg4, arg5);
        let v4 = if (v3) {
            0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((v0 as u128), 1000000000000000000, v2)
        } else {
            0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((v0 as u128), v2, 1000000000000000000)
        };
        let v5 = 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v4, (arg1.ideal_reserve_pct as u128), 10000);
        let v6 = 0x2::balance::value<T1>(&arg1.balance);
        let v7 = if (arg3) {
            assert!(v6 >= arg2, 4000);
            v6 - arg2
        } else {
        ...
        let v8 = (v7 as u128);
        let v9 = if (v8 <= v5) {
            (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((arg1.fee_base as u128), v8, v5) as u64)
        } else {
            arg1.fee_base + (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((arg1.fee_max as u128), v8, (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v4, (arg1.max_reserve_pct as u128), 10000) as u128)) as u64)
        };
        (v9, v5)
    }

    fun calculate_net_and_fee_amount(arg0: u64, arg1: u64) : (u64, u64) {
        let v0 = (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((arg0 as u128), ((10000 - arg1) as u128), (10000 as u128)) as u64);
        (v0, arg0 - v0)
    }
    ...
    public fun create_pool<T0>(arg0: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::admin::ProtocolAdminCap, arg1: &mut GlobalConfig, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
    ...
    fun increment_reward_rps<T0>(arg0: &mut LiquidityPool<T0>, arg1: u64) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        *0x2::table::borrow_mut<0x1::ascii::String, u128>(&mut arg0.reward_rps, v0) = *0x2::table::borrow<0x1::ascii::String, u128>(&arg0.reward_rps, v0) + 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((arg1 as u128), (1000000000000000000 as u128), (arg0.total_lp_shares as u128));
    }
    ...
    public fun initialize_global_config(arg0: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::admin::ProtocolAdminCap, arg1: 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::admin::GlobalConfigCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun quote_limit<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &QuoteAssetReserve<T1>, arg2: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg3: &0x2::clock::Clock) : u64 {
        let (v0, _) = get_pool_liquidity<T0>(arg0);
        let (v2, v3) = get_price<T1, T0>(arg2, arg3);
        let v4 = if (v3) {
            0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((v0 as u128), 1000000000000000000, v2)
        } else {
            0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((v0 as u128), v2, 1000000000000000000)
        };
        0x1::u64::min((0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((v4 as u128), (0x1::option::get_with_default<u64>(&arg1.limit_ratio, arg0.limit_ratio) as u128), 100) as u64), 0x1::option::get_with_default<u64>(&arg1.limit_fixed, 18446744073709551615))
    }
    ...
    public fun set_protocol_pause(arg0: &mut GlobalConfig, arg1: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::admin::ProtocolAdminCap, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun simulate_buy_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4001);
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>());
        ...
        assert!(0x2::dynamic_field::exists_<0x1::ascii::String>(&arg0.id, v0), 4003);
        let v1 = 0x2::dynamic_field::borrow<0x1::ascii::String, QuoteAssetReserve<T1>>(&arg0.id, v0);
        assert!(0x2::balance::value<T1>(&v1.balance) + arg3 <= quote_limit<T0, T1>(arg0, v1, arg1, arg2), 4009);
        let (v2, _) = get_price<T1, T0>(arg1, arg2);
        let v4 = 0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((arg3 as u128), v2, 1000000000000000000);
        assert!(v4 != 0, 4016);
        let (v5, v6) = calc_dynamic_fee<T0, T1>(arg0, v1, arg3, false, arg1, arg2);
        let v7 = v5 + arg0.swap_fee_pct;
        let v8 = 0;
        let v9 = 0;
        if (v7 > 0) {
            let v10 = if (arg0.lp_fee_pct > 0) {
                1 + 1
            } else {
                1
            };
            let v11 = 0x1::u128::min(0x1::u128::max(0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v4, (v7 as u128), 10000), (v10 as u128)), v4);
            v8 = v11;
            if (arg0.lp_fee_pct > 0) {
                v9 = 0x1::u128::max(0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v11, (arg0.lp_fee_pct as u128), 10000), 1);
            };
        };
        let v12 = v4 - v8;
        SwapSimulationResult{
            base_out        : (v12 as u64),
            quote_out       : (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v12, 1000000000000000000, v2) as u64),
            swap_fee_pct    : arg0.swap_fee_pct,
            dynamic_fee_pct : v5,
            ideal_quote_amt : v6,
            swap_fee        : (v8 as u64),
            lp_fee          : (v9 as u64),
            protocol_fee    : ((v8 - v9) as u64),
            price_used      : v2,
        }
    }

    public fun simulate_sell_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4001);
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>());
        assert!(0x1::vector::contains<0x1::ascii::String>(&arg0.supported_assets, &v0), 4003);
        ...
        let (v3, v4) = calc_dynamic_fee<T0, T1>(arg0, 0x2::dynamic_field::borrow<0x1::ascii::String, QuoteAssetReserve<T1>>(&arg0.id, v0), (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((arg3 as u128), 1000000000000000000, v1) as u64), true, arg1, arg2);
        let v5 = v3 + arg0.swap_fee_pct;
        let v6 = 0;
        let v7 = 0;
        if (v5 > 0) {
            let v8 = if (arg0.lp_fee_pct > 0) {
                1 + 1
            } else {
                1
            };
            let v9 = 0x1::u128::min(0x1::u128::max(0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128((arg3 as u128), (v5 as u128), 10000), (v8 as u128)), (arg3 as u128));
            v6 = v9;
            if (arg0.lp_fee_pct > 0) {
                v7 = 0x1::u128::max(0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v9, (arg0.lp_fee_pct as u128), 10000), 1);
            };
        };
        let v10 = (arg3 as u128) - v6;
        SwapSimulationResult{
            base_out        : (v10 as u64),
            quote_out       : (0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::math::mul_div_u128(v10, 1000000000000000000, v1) as u64),
            swap_fee_pct    : arg0.swap_fee_pct,
            dynamic_fee_pct : v3,
            ideal_quote_amt : v4,
            swap_fee        : (v6 as u64),
            lp_fee          : (v7 as u64),
            protocol_fee    : ((v6 - v7) as u64),
            price_used      : v1,
        }
    }

    public fun simulate_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64, arg4: bool) : SwapSimulationResult {
        if (arg4) {
    ...
    public fun swap_buy<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: 0x2::balance::Balance<T1>, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(!arg0.is_paused, 4005);
    ...
    public fun swap_sell<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: 0x2::balance::Balance<T0>, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(!arg0.is_paused, 4005);
        ...
        0x2::balance::join<T0>(&mut arg0.base_reserve, 0x2::balance::split<T0>(&mut arg3, v2));
        let v11 = 0x2::dynamic_field::borrow_mut<0x1::ascii::String, QuoteAssetReserve<T1>>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()));
    ...
    public fun update_global_config(arg0: &mut GlobalConfig, arg1: &0x2d37d68120d8146007f49b33e2107acfa9889fcf31a58fd83a1a6e9f0d804865::admin::ProtocolAdminCap, arg2: 0x1::option::Option<u64>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: &mut 0x2::tx_context::TxContext) {
