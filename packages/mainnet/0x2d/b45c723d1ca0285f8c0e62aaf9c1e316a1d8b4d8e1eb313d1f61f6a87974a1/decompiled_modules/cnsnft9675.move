module 0x2db45c723d1ca0285f8c0e62aaf9c1e316a1d8b4d8e1eb313d1f61f6a87974a1::cnsnft9675 {
    struct CNSNFT9675 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9675, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9675>(arg0, arg1);
