module 0x2d06f5f7c608f2f5f53ccf79b53d6b1a545f36e8770ef3f985ea2f46745f8484::game9078 {
    struct GAME9078 has drop {
        dummy_field: bool,
    }

    struct TICKET_9078 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9078(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9078>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9078>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME9078, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME9078>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9078>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9078>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9078>>(v5, 0x2::tx_context::sender(arg1));
    }
