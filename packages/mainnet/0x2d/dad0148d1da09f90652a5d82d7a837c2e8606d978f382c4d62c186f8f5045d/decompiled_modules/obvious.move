module 0x2ddad0148d1da09f90652a5d82d7a837c2e8606d978f382c4d62c186f8f5045d::obvious {
    ...
    fun init(arg0: OBVIOUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/8SQQ1urC3Dynq9C2ieM6AozWgi4GCrLE6fnRoiWdpump.png?size=lg&key=1cfc1c                                                                                                                                                                                                            ");
