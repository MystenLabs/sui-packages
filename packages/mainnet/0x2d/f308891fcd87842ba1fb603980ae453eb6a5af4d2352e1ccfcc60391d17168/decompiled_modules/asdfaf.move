module 0x2df308891fcd87842ba1fb603980ae453eb6a5af4d2352e1ccfcc60391d17168::asdfaf {
    struct ASDFAF has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ASDFAF, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ASDFAF>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"asdfaf"));
