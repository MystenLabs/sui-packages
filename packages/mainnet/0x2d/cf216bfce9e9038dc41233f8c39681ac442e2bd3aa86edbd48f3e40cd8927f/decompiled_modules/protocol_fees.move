module 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::protocol_fees {
    ...
    public(friend) fun claim_default_referral_fees(arg0: &mut ProtocolFees) : u64 {
        let v0 = 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::margin_constants::default_referral();
    ...
    public(friend) fun decrease_shares(arg0: &mut ProtocolFees, arg1: 0x1::option::Option<0x2::object::ID>, arg2: u64) {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, ReferralTracker>(&mut arg0.referrals, 0x1::option::destroy_with_default<0x2::object::ID>(arg1, 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::margin_constants::default_referral()));
        update_unclaimed_fees(v0, arg0.fees_per_share);
    ...
    public(friend) fun default_protocol_fees(arg0: &mut 0x2::tx_context::TxContext) : ProtocolFees {
        ...
        0x2::table::add<0x2::object::ID, ReferralTracker>(&mut v0.referrals, 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::margin_constants::default_referral(), v1);
        v0
    }
    ...
    public(friend) fun increase_fees_accrued(arg0: &mut ProtocolFees, arg1: 0x2::object::ID, arg2: u64) {
        ...
        if (arg0.total_shares > 0) {
            arg0.fees_per_share = arg0.fees_per_share + 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::div(v2, arg0.total_shares);
    ...
    public(friend) fun referral_tracker(arg0: &ProtocolFees, arg1: 0x2::object::ID) : (u64, u64) {
        ...
        (v0.current_shares, v0.unclaimed_fees + 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::mul(v0.current_shares, arg0.fees_per_share - v0.last_fees_per_share))
    }
    ...
    fun update_unclaimed_fees(arg0: &mut ReferralTracker, arg1: u64) {
        arg0.unclaimed_fees = arg0.unclaimed_fees + 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::mul(arg0.current_shares, arg1 - arg0.last_fees_per_share);
