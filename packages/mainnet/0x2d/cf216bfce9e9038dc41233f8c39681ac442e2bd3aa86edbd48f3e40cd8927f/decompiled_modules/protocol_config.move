module 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::protocol_config {
    ...
    public(friend) fun calculate_interest_with_borrow(arg0: &ProtocolConfig, arg1: u64, arg2: u64, arg3: u64) : u64 {
        0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::mul(0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::mul(arg3, interest_rate(arg0, arg1)), 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::div(arg2, 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::margin_constants::year_ms()))
    }
    ...
    public(friend) fun interest_rate(arg0: &ProtocolConfig, arg1: u64) : u64 {
        ...
        if (arg1 < v0) {
            0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::mul(arg1, arg0.interest_config.base_slope) + arg0.interest_config.base_rate
        } else {
            arg0.interest_config.base_rate + 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::mul(v0, arg0.interest_config.base_slope) + 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::math::mul(arg1 - v0, arg0.interest_config.excess_slope)
        }
    }
    ...
    public fun new_interest_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : InterestConfig {
        assert!(arg2 <= 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::constants::float_scaling(), 1);
        InterestConfig{
            base_rate           : arg0,
            base_slope          : arg1,
    ...
    public fun new_margin_pool_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : MarginPoolConfig {
        assert!(arg1 <= 0x246cbd7d87b1ce5ac9c5112e225be6367380c58be0282179f793c87fde37ffb4::constants::float_scaling(), 1);
        assert!(arg3 >= 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::margin_constants::min_min_borrow(), 1);
        assert!(arg2 <= 0x2dcf216bfce9e9038dc41233f8c39681ac442e2bd3aa86edbd48f3e40cd8927f::margin_constants::max_protocol_spread(), 1);
        MarginPoolConfig{
            supply_cap           : arg0,
