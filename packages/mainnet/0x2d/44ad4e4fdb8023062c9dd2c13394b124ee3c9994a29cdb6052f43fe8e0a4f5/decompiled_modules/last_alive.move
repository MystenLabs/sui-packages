module 0x2d44ad4e4fdb8023062c9dd2c13394b124ee3c9994a29cdb6052f43fe8e0a4f5::last_alive {
    ...
    public entry fun add_usdc_reward(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 4);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) >= arg3, 0);
        let v0 = arg0.current_round;
        ...
        let v2 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>>(&mut arg1.token_balances, v0);
        if (!0x2::table::contains<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>(v2, v1)) {
            0x2::table::add<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>(v2, v1, 0x2::coin::split<0x2::sui::SUI>(&mut arg2, arg3, arg4));
        } else {
            0x2::coin::join<0x2::sui::SUI>(0x2::table::borrow_mut<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>(v2, v1), 0x2::coin::split<0x2::sui::SUI>(&mut arg2, arg3, arg4));
        };
        if (0x2::coin::value<0x2::sui::SUI>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, 0x2::tx_context::sender(arg4));
        } else {
        ...
        let v3 = 0x2::object::id_from_address(@0xffffffffffffffffffffffffffffffff);
        ...
        let v4 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, vector<TokenReward>>>(&mut arg1.token_rewards, v0);
        let v5 = TokenReward{
            token_type : v1,
            token_id   : 0x2::object::id_from_address(@0x0),
            amount     : arg3,
        };
        if (!0x2::table::contains<0x2::object::ID, vector<TokenReward>>(v4, v3)) {
            0x2::table::add<0x2::object::ID, vector<TokenReward>>(v4, v3, 0x1::vector::singleton<TokenReward>(v5));
        } else {
            0x1::vector::push_back<TokenReward>(0x2::table::borrow_mut<0x2::object::ID, vector<TokenReward>>(v4, v3), v5);
        };
        let v6 = RewardAddedEvent{
            round       : v0,
            reward_type : v1,
            amount      : arg3,
            added_by    : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<RewardAddedEvent>(v6);
    }
    ...
    public fun assign_usdc_rewards_to_winner(arg0: &mut RewardsPool, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, vector<TokenReward>>>(&arg0.token_rewards, arg2)) {
            0x2::table::add<u64, 0x2::table::Table<0x2::object::ID, vector<TokenReward>>>(&mut arg0.token_rewards, arg2, 0x2::table::new<0x2::object::ID, vector<TokenReward>>(arg3));
        };
        let v0 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, vector<TokenReward>>>(&mut arg0.token_rewards, arg2);
        let v1 = 0x2::object::id_from_address(@0xffffffffffffffffffffffffffffffff);
        if (0x2::table::contains<0x2::object::ID, vector<TokenReward>>(v0, v1)) {
            let v2 = 0x2::table::borrow_mut<0x2::object::ID, vector<TokenReward>>(v0, v1);
            let v3 = 0x1::vector::empty<TokenReward>();
            let v4 = 0;
            let v5 = 0x1::vector::length<TokenReward>(v2);
            while (v4 < v5) {
                let v6 = v5 - v4 - 1;
                if (0x1::vector::borrow<TokenReward>(v2, v6).token_type == 0x1::string::utf8(b"USDC")) {
                    0x1::vector::push_back<TokenReward>(&mut v3, 0x1::vector::swap_remove<TokenReward>(v2, v6));
                };
                v4 = v4 + 1;
            };
            if (!0x2::table::contains<0x2::object::ID, vector<TokenReward>>(v0, arg1)) {
            ...
            if (!0x1::vector::is_empty<TokenReward>(&v3)) {
                let v7 = 0x2::table::borrow_mut<0x2::object::ID, vector<TokenReward>>(v0, arg1);
                while (!0x1::vector::is_empty<TokenReward>(&v3)) {
                    0x1::vector::push_back<TokenReward>(v7, 0x1::vector::pop_back<TokenReward>(&mut v3));
                };
            };
        };
    }
    ...
    public entry fun claim_usdc_rewards(arg0: &mut RewardsPool, arg1: &NFT, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.trait == 0x1::string::utf8(b"Champion"), 4);
        let v0 = 0x2::object::uid_to_inner(&arg1.id);
        let v1 = arg1.game_round;
        assert!(0x2::table::contains<u64, 0x2::table::Table<0x2::object::ID, vector<TokenReward>>>(&arg0.token_rewards, v1), 19);
        let v2 = 0x2::table::borrow<u64, 0x2::table::Table<0x2::object::ID, vector<TokenReward>>>(&arg0.token_rewards, v1);
        assert!(0x2::table::contains<0x2::object::ID, vector<TokenReward>>(v2, v0), 19);
        let v3 = 0x2::table::borrow<0x2::object::ID, vector<TokenReward>>(v2, v0);
        let v4 = 0x1::string::utf8(b"USDC");
        let v5 = 0;
        let v6 = 0x1::vector::length<TokenReward>(v3);
        let v7 = 0;
        while (v7 < v6) {
            let v8 = 0x1::vector::borrow<TokenReward>(v3, v7);
            if (v8.token_type == v4) {
                v5 = v5 + v8.amount;
            };
            v7 = v7 + 1;
        ...
        assert!(v5 > 0, 19);
        assert!(0x2::table::contains<u64, 0x2::table::Table<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>>(&arg0.token_balances, v1), 19);
        let v9 = 0x2::table::borrow_mut<u64, 0x2::table::Table<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>>(&mut arg0.token_balances, v1);
        assert!(0x2::table::contains<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>(v9, v4), 19);
        let v10 = 0x2::table::borrow_mut<0x1::string::String, 0x2::coin::Coin<0x2::sui::SUI>>(v9, v4);
        assert!(0x2::coin::value<0x2::sui::SUI>(v10) >= v5, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(v10, v5, arg2), 0x2::tx_context::sender(arg2));
        let v11 = TokenClaimEvent{
            nft_id          : v0,
            token_type      : v4,
            amount          : v5,
        ...
        0x2::event::emit<TokenClaimEvent>(v11);
        let v12 = 0x1::vector::empty<TokenReward>();
        let v13 = 0;
        while (v13 < v6) {
            let v14 = 0x1::vector::borrow<TokenReward>(v3, v13);
            if (v14.token_type != v4) {
                0x1::vector::push_back<TokenReward>(&mut v12, *v14);
            };
            v13 = v13 + 1;
        };
        *0x2::table::borrow_mut<0x2::object::ID, vector<TokenReward>>(0x2::table::borrow_mut<u64, 0x2::table::Table<0x2::object::ID, vector<TokenReward>>>(&mut arg0.token_rewards, v1), v0) = v12;
    }
    ...
    public entry fun finish_game(arg0: &mut GameState, arg1: &mut RewardsPool, arg2: &0x2::clock::Clock, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assign_usdc_rewards_to_winner(arg1, v1, v0, arg4);
        if (0x2::table::contains<u64, vector<NFTReward>>(&arg1.pending_nft_rewards, v0)) {
