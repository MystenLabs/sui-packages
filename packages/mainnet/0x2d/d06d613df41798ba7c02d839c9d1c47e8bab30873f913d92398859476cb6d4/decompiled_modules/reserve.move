module 0x2dd06d613df41798ba7c02d839c9d1c47e8bab30873f913d92398859476cb6d4::reserve {
    ...
    public fun borrow_flash_loan<T0>(arg0: &mut Reserve, arg1: u64) : (0x2::balance::Balance<T0>, FlashLoan<T0>) {
        let v0 = FlashLoan<T0>{amount: arg1};
    ...
    public fun return_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>, arg2: FlashLoan<T0>) {
