module 0x2d6733a32e957430324196dc5d786d7c839f3c7bbfd92b83c469448b988413b1::coin_flip {
    ...
    public entry fun play(arg0: &mut Game, arg1: vector<u8>, arg2: &mut HouseData, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg1, &arg2.public_key, &v2), 10);
        let v3 = arg0.guess == *0x1::vector::borrow<u8>(&arg1, 0) % 2;
        if (v3) {
