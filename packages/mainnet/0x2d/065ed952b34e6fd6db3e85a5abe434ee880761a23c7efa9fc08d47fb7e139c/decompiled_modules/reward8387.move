module 0x2d065ed952b34e6fd6db3e85a5abe434ee880761a23c7efa9fc08d47fb7e139c::reward8387 {
    struct REWARD8387 has drop {
        dummy_field: bool,
    }

    struct TICKET_8387 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8387(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8387>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8387>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8387, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8387>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8387>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8387>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8387>>(v5, 0x2::tx_context::sender(arg1));
    }
