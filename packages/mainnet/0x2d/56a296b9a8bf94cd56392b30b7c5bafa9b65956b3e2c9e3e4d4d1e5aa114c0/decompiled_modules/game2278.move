module 0x2d56a296b9a8bf94cd56392b30b7c5bafa9b65956b3e2c9e3e4d4d1e5aa114c0::game2278 {
    struct GAME2278 has drop {
        dummy_field: bool,
    }

    struct TICKET_2278 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2278(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2278>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2278>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME2278, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME2278>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2278>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2278>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2278>>(v5, 0x2::tx_context::sender(arg1));
    }
