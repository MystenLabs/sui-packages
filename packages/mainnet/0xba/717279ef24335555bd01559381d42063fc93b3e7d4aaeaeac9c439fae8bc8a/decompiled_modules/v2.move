module 0xb84e63d22ea4822a0a333c250e790f69bf5c2ef0c63f4e120e05a6415991368f::v2 {
    ...
    struct FlashSwap has copy, drop {
        ...
        borrow_amt: u64,
        repay_amt: u64,
        intermediate_amt: u64,
    }

    struct FlashSwapV2 has copy, drop {
        is_borrow_x: bool,
        borrow_amt: u64,
        repay_amt: u64,
        curr_x: u64,
    ...
    public fun trader_swap_and_repay<T0, T1>(arg0: &mut TradingPair<T0, T1>, arg1: u64, arg2: u64, arg3: Borrow<T0, T1>, arg4: 0x1::option::Option<0x2::coin::Coin<T0>>, arg5: 0x1::option::Option<0x2::coin::Coin<T1>>, arg6: &0x2::clock::Clock) {
        ...
        if (!v0) {
            ...
            0x2::event::emit<FlashSwap>(v7);
        } else {
            0x1::option::destroy_none<0x2::coin::Coin<T0>>(arg4);
            let v8 = 0x1::option::destroy_some<0x2::coin::Coin<T1>>(arg5);
            let (v9, v10) = quote_y_to_x<T0, T1>(arg0, 0x2::coin::value<T1>(&v8));
            let v11 = v9 + v10;
            assert!(v1 <= v11, v11);
            0x2::balance::join<T1>(&mut arg0.reserve_y, 0x2::coin::into_balance<T1>(v8));
            let v12 = v9 * arg0.mult_x / 1000000;
            update_volume_record<T0, T1>(arg0, arg6, v12);
        };
    }
    ...
    public fun trader_swap_and_repay2<T0, T1>(arg0: &mut TradingPair<T0, T1>, arg1: u64, arg2: u64, arg3: Borrow<T0, T1>, arg4: u64, arg5: 0x1::option::Option<0x2::coin::Coin<T0>>, arg6: 0x1::option::Option<0x2::coin::Coin<T1>>, arg7: &0x2::clock::Clock) {
        ...
        let v2 = (0x2::balance::value<T0>(&arg0.reserve_x) as u64);
        if (!v0) {
            0x1::option::destroy_none<0x2::coin::Coin<T1>>(arg6);
            let v3 = 0x1::option::destroy_some<0x2::coin::Coin<T0>>(arg5);
            let v4 = 0x2::coin::value<T0>(&v3);
            let (v5, v6) = quote_x_to_y<T0, T1>(arg0, v4);
            let v7 = v5 + v6;
            let v8 = FlashSwapV2{
                is_borrow_x      : v0,
                borrow_amt       : v1,
            ...
            0x2::event::emit<FlashSwapV2>(v8);
            assert!(v7 >= arg4, v7);
            0x2::balance::join<T0>(&mut arg0.reserve_x, 0x2::coin::into_balance<T0>(v3));
            let v9 = v5 * arg0.mult_y / 1000000;
            update_volume_record<T0, T1>(arg0, arg7, v9);
        } else {
            0x1::option::destroy_none<0x2::coin::Coin<T0>>(arg5);
            let v10 = 0x1::option::destroy_some<0x2::coin::Coin<T1>>(arg6);
            let v11 = 0x2::coin::value<T1>(&v10);
            let (v12, v13) = quote_y_to_x<T0, T1>(arg0, v11);
            let v14 = v12 + v13;
            let v15 = FlashSwapV2{
                is_borrow_x      : v0,
                borrow_amt       : v1,
                repay_amt        : v14,
                curr_x           : v2,
                intermediate_amt : v11,
            };
            0x2::event::emit<FlashSwapV2>(v15);
            assert!(v14 >= arg4, v14);
            0x2::balance::join<T1>(&mut arg0.reserve_y, 0x2::coin::into_balance<T1>(v10));
            let v16 = v12 * arg0.mult_x / 1000000;
            update_volume_record<T0, T1>(arg0, arg7, v16);
        };
    }
