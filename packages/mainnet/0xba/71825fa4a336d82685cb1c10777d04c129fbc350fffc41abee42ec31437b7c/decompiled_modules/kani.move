module 0xba71825fa4a336d82685cb1c10777d04c129fbc350fffc41abee42ec31437b7c::kani {
    ...
    public entry fun create_collection(arg0: &0x2::package::Publisher, arg1: 0x1::string::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun mint_to_sender(arg0: &mut NFTCollection, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: vector<u8>, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
