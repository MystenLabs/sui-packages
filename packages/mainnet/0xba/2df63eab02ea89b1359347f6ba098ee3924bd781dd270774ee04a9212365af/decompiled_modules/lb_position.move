module 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::lb_position {
    ...
    public(friend) fun add_bin(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: u32, arg3: LBBinPosition) {
        if (arg1.total_bins + 1 > 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::constants::max_bins_in_position()) {
            abort 205
        };
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }

    public(friend) fun increase_bin_liquidity(arg0: &mut LBBinPosition, arg1: u128) {
        arg0.amount = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::add_u128(arg0.amount, arg1);
    }

    public(friend) fun increase_position_total_bins(arg0: &mut LBPosition, arg1: u64) {
        if (arg0.total_bins + arg1 > 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::constants::max_bins_in_position()) {
            abort 205
        };
    ...
    public(friend) fun remove_bin(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: u32) : bool {
        ...
        arg1.total_bins = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::sub_u64(arg1.total_bins, 1);
    ...
    public(friend) fun remove_bins(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: vector<u32>) {
        ...
        while (v2 < 0x1::vector::length<u32>(&arg2)) {
            ...
            if (v6 != v3) {
                let v8 = if (v3 != 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::constants::max_u32()) {
    ...
    public(friend) fun settle_position_fees(arg0: &mut LBPosition, arg1: &mut LBBinPosition, arg2: u128, arg3: u128) : (u64, u64) {
        ...
        let v0 = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::u128_to_u64(arg1.amount * 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::sub_u128(arg2, arg1.fee_growth_inside_last_x) >> 64);
        let v1 = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::u128_to_u64(arg1.amount * 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::sub_u128(arg3, arg1.fee_growth_inside_last_y) >> 64);
        arg0.saved_fees_x = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::add_u64(arg0.saved_fees_x, v0);
        arg0.saved_fees_y = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::add_u64(arg0.saved_fees_y, v1);
        arg1.fee_growth_inside_last_x = arg2;
        arg1.fee_growth_inside_last_y = arg3;
        (v0, v1)
    }
    ...
    public(friend) fun settle_position_rewards(arg0: &mut LBPosition, arg1: &mut LBBinPosition, arg2: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg2)) {
            ...
            if (v1 > v2) {
                let v3 = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::u128_to_u64(arg1.amount * (v1 - v2) >> 64);
                if (v3 > 0) {
                    while (0x1::vector::length<u64>(&arg0.saved_rewards) <= v0) {
                        0x1::vector::push_back<u64>(&mut arg0.saved_rewards, 0);
                    };
                    *0x1::vector::borrow_mut<u64>(&mut arg0.saved_rewards, v0) = 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg0.saved_rewards, v0), v3);
                };
            };
            v0 = v0 + 1;
        };
    ...
    public fun simulate_settle_position_rewards(arg0: &LBBinPosition, arg1: vector<u128>) : vector<u64> {
        ...
        while (v1 < 0x1::vector::length<u128>(&arg1)) {
            ...
            if (v2 > v3) {
                0x1::vector::push_back<u64>(&mut v0, 0xe6cb7c7a4ed30221e1d264d6dd5f47f3be7238d07fa4be02cc641ceda99d8022::safe_math::u128_to_u64(arg0.amount * (v2 - v3) >> 64));
            } else {
