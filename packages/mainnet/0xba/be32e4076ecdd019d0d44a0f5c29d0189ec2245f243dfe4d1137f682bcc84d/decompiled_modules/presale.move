module 0xbabe32e4076ecdd019d0d44a0f5c29d0189ec2245f243dfe4d1137f682bcc84d::presale {
    ...
    public entry fun purchase_token(arg0: &mut PresaleStorage, arg1: &0x2::clock::Clock, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<address, u64>(&mut arg0.balances, 0x2::tx_context::sender(arg3), v0);
        arg0.totalRaised = arg0.totalRaised + v0;
    }
