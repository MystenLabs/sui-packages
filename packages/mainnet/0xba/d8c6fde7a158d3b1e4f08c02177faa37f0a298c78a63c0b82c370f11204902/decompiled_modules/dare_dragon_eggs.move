module 0x34db0e1c931a35abf2cf30d28b4dbf97ea4a98e199a8bc228d1e095bfdc688da::dare_dragon_eggs {
    ...
    public entry fun setup_airdrop(arg0: &0x2::package::Publisher, arg1: &0x801d62e2937916fca8cdb25e9248fa958c9094c529943528cb602f4f1a114129::warehouse_pseudorandom::WarehousePseudorandom<DareDragonEgg>, arg2: &0xd8036c369aac5f19303f8d87a18a6933974be30a5c962c6f42c396ad47ae8889::airdrop::Airdrop, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<DareDragonEgg>(arg0), 0);
        let (v0, v1) = 0x2::transfer_policy::new<DareDragonEgg>(arg0, arg3);
        let v2 = v1;
        let v3 = v0;
        0x801d62e2937916fca8cdb25e9248fa958c9094c529943528cb602f4f1a114129::warehouse_pseudorandom_rule::add_withdraw<DareDragonEgg>(&mut v3, &v2, arg1);
        0xd8036c369aac5f19303f8d87a18a6933974be30a5c962c6f42c396ad47ae8889::airdrop_lock_rule::add<DareDragonEgg>(&mut v3, &v2, arg2);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<DareDragonEgg>>(v2, 0x2::tx_context::sender(arg3));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<DareDragonEgg>>(v3);
    }
