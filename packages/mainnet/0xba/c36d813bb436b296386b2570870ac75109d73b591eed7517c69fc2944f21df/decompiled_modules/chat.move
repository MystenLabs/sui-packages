module 0xbac36d813bb436b296386b2570870ac75109d73b591eed7517c69fc2944f21df::chat {
    ...
    public entry fun batch_delete(arg0: vector<u64>, arg1: &mut Channel, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<u64>(&arg0)) {
            ...
            let Message {
                ...
                timestamp      : _,
                message        : _,
            } = 0x2::dynamic_object_field::remove<address, Message>(&mut arg1.id, 0x2::address::from_u256((*v1 as u256)));
    ...
    public entry fun delete_message(arg0: u64, arg1: &mut Channel, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let Message {
            ...
            timestamp      : _,
            message        : _,
        } = 0x2::dynamic_object_field::remove<address, Message>(&mut arg1.id, 0x2::address::from_u256((arg0 as u256)));
    ...
    public entry fun send_message(arg0: 0x1::string::String, arg1: &mut Channel, arg2: &0x2::clock::Clock, arg3: 0x1::option::Option<0x1::string::String>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<address, Message>(&mut arg1.id, 0x2::address::from_u256((v0 as u256)), v1);
    }
