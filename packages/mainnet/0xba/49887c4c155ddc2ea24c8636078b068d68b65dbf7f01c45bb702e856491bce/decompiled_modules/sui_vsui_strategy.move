        ...
        if (v1 > 0) {
            ...
            if (0x2::balance::value<0x2::sui::SUI>(&v3) >= v1) {
                ...
                if (v4 >= v5) {
                    ...
                    let (v10, v11) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_loan_with_account_cap<0x2::sui::SUI>(arg14, arg9, v9, &arg0.navi_cap);
                    let v12 = v10;
                    let v13 = 0x2::balance::value<0x2::sui::SUI>(&v12);
                    let v14 = (0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::utils::u256_mul_div((v13 as u256), (6 as u256), (10000 as u256)) as u64);
                    0x2::balance::join<0x2::sui::SUI>(&mut v3, v12);
                    let v15 = revolving_repay_and_withdraw(arg0, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut v3), v1 + v13 + v14, arg15);
                    0x2::balance::join<0x2::sui::SUI>(&mut v3, v15);
                    0x2::balance::join<0x2::sui::SUI>(&mut v3, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_repay_with_account_cap<0x2::sui::SUI>(arg7, arg8, arg9, v11, 0x2::balance::split<0x2::sui::SUI>(&mut v3, v13 + v14), &arg0.navi_cap));
                    0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::strategy_repay<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2, &arg0.vault_access, 0x2::balance::split<0x2::sui::SUI>(&mut v3, v1));
                };
            ...
            let v17 = 0x1::u64::min(v0, 0x2::balance::value<0x2::sui::SUI>(0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::free_balance<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2)));
            let v18 = 0x2::coin::from_balance<0x2::sui::SUI>(0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::strategy_borrow<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>(arg2, &arg0.vault_access, v17), arg15);
            let v19 = BorrowEvent{
                vault_id    : 0x2::object::id<0x5f3e4afcd9a8090929ef0cfd5f9fa9f6307b7fb5b2657947e715890a66f74487::vault::Vault<0x2::sui::SUI, 0x867147a1682a9b3486a5dfb7bf828ab5e5ce3e43b62dd7d1a0c7a8711de5ba1a::st_sui::ST_SUI>>(arg2),
                strategy_id : *0x2::object::uid_as_inner(&arg0.id),
                borrow_amt  : v17,
