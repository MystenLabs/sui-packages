module 0xba46d8ef339bf22c36e57b0b2f075bd426025d5bc883f47a562aca92f7c250bb::reward2014 {
    struct REWARD2014 has drop {
        dummy_field: bool,
    }

    struct TICKET_2014 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2014(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2014>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2014>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2014, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2014>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2014>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2014>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2014>>(v5, 0x2::tx_context::sender(arg1));
    }
