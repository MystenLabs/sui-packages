module 0xbaf01d8dc99acaf6a57f080815e97072a29d7afe5643b546e4e10b47098fb9e9::NUTZ {
    struct NUTZ has drop {
        dummy_field: bool,
    }

    fun init(arg0: NUTZ, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NUTZ>(arg0, 2, b"NUTZ", b"NUTZ", b"Can you suck my $NUTZ?", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.postimg.cc/Gt7gKV2x/51ivdymq5-ZL.jpg")), arg1);
