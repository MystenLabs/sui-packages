module 0xba6e22a4af3b83ea6a19d0ceeec99dd5ee346213da49c42e2d80ad2e62150e06::deed_pack {
    ...
    public(friend) fun burn(arg0: DeedPack, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0xba6e22a4af3b83ea6a19d0ceeec99dd5ee346213da49c42e2d80ad2e62150e06::events::emit_deed_burned(0x2::object::uid_to_address(&v3), v1, v2, arg1, arg2);
    ...
    public(friend) fun mint(arg0: address, arg1: u8, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xba6e22a4af3b83ea6a19d0ceeec99dd5ee346213da49c42e2d80ad2e62150e06::events::emit_minted(arg0, arg1, arg2);
    }
