module 0xba7068a45a01436dc9251ae7b3ed528b1ec5f86a915a87229dd6e22cd6959464::gift8219 {
    struct GIFT8219 has drop {
        dummy_field: bool,
    }

    struct TICKET_8219 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8219(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8219>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8219>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8219, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8219>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8219>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8219>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8219>>(v5, 0x2::tx_context::sender(arg1));
    }
