module 0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch {
    ...
    struct PoolInfoStore has store {
        ...
        coin_mole: 0x2::balance::Balance<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>,
    ...
    struct Storage has key {
        ...
        emergency_status: 0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::EmergencyStatus,
        pools: 0x2::bag::Bag,
        mole_admin_cap: 0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::AdminCap,
        package_version: u64,
    }
    ...
    public entry fun manual_mint(arg0: &AdminCap, arg1: &mut Storage, arg2: &mut 0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MoleCoinInfo, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg1);
        0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::manual_mint(&mut arg1.mole_admin_cap, arg2, arg3, arg4, arg5);
    }

    public fun upgrade_package_version(arg0: &AdminCap, arg1: &mut Storage, arg2: u64) {
    ...
    public entry fun add_pool<T0>(arg0: &AdminCap, arg1: &mut Storage, arg2: u64, arg3: bool, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg1);
        assert!(0x1::type_name::get<T0>() != 0x1::type_name::get<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(), 2);
    ...
    public entry fun deposit_single<T0>(arg0: &mut Storage, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>>(deposit_with_cap<T0>(arg0, &v1, arg1, false, v0, arg4, arg5), arg1);
    }

    public fun deposit_with_cap<T0>(arg0: &mut Storage, arg1: &UserCapability<T0>, arg2: address, arg3: bool, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE> {
        checked_package_version(arg0);
        0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::assert_no_emergency(&arg0.emergency_status);
        let v0 = arg1.user;
    ...
    public entry fun harvest<T0>(arg0: &mut Storage, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>>(v1, 0x2::tx_context::sender(arg2));
    }

    public fun harvest_with_cap<T0>(arg0: &mut Storage, arg1: &UserCapability<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE> {
        checked_package_version(arg0);
        0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::assert_no_emergency(&arg0.emergency_status);
        let v0 = get_pid<T0>(arg0);
    ...
    public entry fun initialize(arg0: &AdminCap, arg1: 0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = PoolInfoStore{
            dev_addr                   : 0x2::tx_context::sender(arg5),
            dev_percent                : arg2,
            mole_per_second            : arg3,
            max_mole_per_second        : arg4,
            pools                      : 0x1::vector::empty<PoolInfo>(),
            total_alloc_point          : 0,
            coin_mole                  : 0x2::balance::zero<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(),
            stake_debt_token_allowance : 0x2::table::new<u64, 0x2::table::Table<User, bool>>(arg5),
        };
        let v1 = Storage{
            id               : 0x2::object::new(arg5),
            pool_infos       : v0,
            emergency_status : 0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::initialize(arg5),
    ...
    public entry fun pause(arg0: &0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::EmergencyAdminCap, arg1: &mut Storage) {
        checked_package_version(arg1);
        0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::pause(arg0, &mut arg1.emergency_status);
    }
    ...
    public entry fun resume(arg0: &0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::EmergencyAdminCap, arg1: &mut Storage) {
        checked_package_version(arg1);
        0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::resume(arg0, &mut arg1.emergency_status);
    }

    fun safe_mole_extract(arg0: &mut 0x2::balance::Balance<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE> {
        if (arg1 == 0) {
            return 0x2::coin::zero<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(arg2)
        };
        let v0 = 0x2::balance::value<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(arg0);
        if (arg1 > v0) {
            return 0x2::coin::from_balance<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(0x2::balance::split<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(arg0, v0), arg2)
        };
        0x2::coin::from_balance<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(0x2::balance::split<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(arg0, arg1), arg2)
    }

    public entry fun set_dev(arg0: &mut Storage, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        let v0 = &mut arg0.pool_infos;
        assert!(v0.dev_addr == 0x2::tx_context::sender(arg2), 8);
        v0.dev_addr = arg1;
    }
    ...
    public fun update_pool(arg0: &mut Storage, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (now_seconds(arg2) > v1.last_reward_time) {
            if (v1.staked_balance > 0) {
                ...
                0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::mint_to(&mut arg0.mole_admin_cap, v0.dev_addr, mul_div(v2, v0.dev_percent, 10000), arg3);
                0x2::balance::join<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(&mut v0.coin_mole, 0x2::coin::into_balance<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>(0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::mint(&mut arg0.mole_admin_cap, v2, arg3)));
    ...
    public fun upgrade_mole_coin_version(arg0: &AdminCap, arg1: &mut Storage, arg2: u64) {
        0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::upgrade_package_version(&mut arg1.mole_admin_cap, arg2);
    }
    ...
    fun withdraw_inner<T0>(arg0: &mut Storage, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>>(v3, v0);
    }

    public fun withdraw_with_cap<T0>(arg0: &mut Storage, arg1: &UserCapability<T0>, arg2: address, arg3: bool, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x7a0caf79f7be8324397b6e139c202630149651ed6456c5ff2c79de05a7401fac::mole::MOLE>) {
        checked_package_version(arg0);
        0xba0311e40e1a18d048a20a0cbd1f5ca50c7b8a3c9b06e9b08f4e76b2489b2830::fair_launch_emergency::assert_no_emergency(&arg0.emergency_status);
        let v0 = arg1.user;
        let v1 = get_pid<T0>(arg0);
