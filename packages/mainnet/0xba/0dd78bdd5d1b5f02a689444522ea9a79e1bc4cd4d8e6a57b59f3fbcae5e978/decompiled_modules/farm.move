module 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::farm {
    ...
    public(friend) fun add_reward<T0, T1>(arg0: &mut Farm<T0>, arg1: 0x2::balance::Balance<T1>, arg2: u64, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock) {
        ...
        assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.reward_types, &v0), 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::error::invalid_reward_type());
    ...
    fun assert_farm_id<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) {
        assert!(arg1.farm_id == 0x2::object::id<Farm<T0>>(arg0), 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::error::invalid_stake_receipt_for_farm());
    }
    ...
    public(friend) fun claim_reward<T0, T1>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        let v1 = 0x2::table::borrow_mut<0x1::type_name::TypeName, RewardInfo>(&mut arg0.reward_infos, v0);
        assert!(v1.is_claimable, 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::error::reward_not_claimable());
    ...
    public(friend) fun harvest<T0>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) {
        ...
        while (v4 < 0x1::vector::length<0x1::type_name::TypeName>(v3)) {
            ...
            let v7 = 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor(v2, v5.total_rewards, v6);
            ...
            v5.cumulative_index = v5.cumulative_index + 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((v7 as u128), 18446744073709551616, (arg0.total_weight as u128));
            v4 = v4 + 1;
        };
        *v1 = v0;
    }
    ...
    public(friend) fun harvest_for_user<T0>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(v0)) {
            ...
            if (0x2::table::contains<0x1::type_name::TypeName, UserRewardInfo>(&arg1.reward_infos, v2)) {
                ...
                v4.harvested_rewards = v4.harvested_rewards + (0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((arg1.shares as u128), v3.cumulative_index - v4.cumulative_index, 18446744073709551616) as u64);
                v4.cumulative_index = v3.cumulative_index;
            } else {
                let v5 = UserRewardInfo{
                    cumulative_index  : v3.cumulative_index,
                    harvested_rewards : (0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((arg1.shares as u128), v3.cumulative_index, 18446744073709551616) as u64),
                };
    ...
    fun harvest_points_for_user<T0>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: &0x2::clock::Clock) {
        ...
        let v0 = (0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((arg1.shares as u128), arg0.points_info.index - arg1.user_points_info.index, 18446744073709551616) as u64);
    ...
    public fun simulate_current_points<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) : u64 {
        ...
        arg0.points_info.total_claimed_points + (0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((arg1.shares as u128), arg0.points_info.index - arg1.user_points_info.index, 18446744073709551616) as u64)
    }
    ...
    public fun simulate_current_rewards<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) : (vector<0x1::ascii::String>, vector<u64>) {
        ...
        while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(v0)) {
            ...
            if (0x2::table::contains<0x1::type_name::TypeName, UserRewardInfo>(&arg1.reward_infos, v4)) {
                ...
                0x1::vector::push_back<u64>(&mut v2, v6.harvested_rewards + (0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((arg1.shares as u128), v5.cumulative_index - v6.cumulative_index, 18446744073709551616) as u64));
            } else {
                0x1::vector::push_back<u64>(&mut v2, (0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128((arg1.shares as u128), v5.cumulative_index, 18446744073709551616) as u64));
            };
            v3 = v3 + 1;
        };
        (v1, v2)
    ...
    public(friend) fun unstake<T0>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: u64, arg3: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        harvest<T0>(arg0, arg3);
        harvest_for_user<T0>(arg0, arg1, arg3);
        assert!(arg2 <= arg1.shares, 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::error::unstake_amount_too_much());
    ...
    public(friend) fun update_points<T0>(arg0: &mut Farm<T0>, arg1: u64, arg2: &0x2::clock::Clock) {
        arg0.points_info.index = arg0.points_info.index + 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::utils::mul_factor_u128(((arg1 - arg0.points_info.total_accumulated_points) as u128), 18446744073709551616, (arg0.total_weight as u128));
    ...
    public(friend) fun withdraw_unharvested<T0, T1>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        assert!(v1.harvested_rewards < v3, 0xba0dd78bdd5d1b5f02a689444522ea9a79e1bc4cd4d8e6a57b59f3fbcae5e978::error::no_unharvested_rewards());
