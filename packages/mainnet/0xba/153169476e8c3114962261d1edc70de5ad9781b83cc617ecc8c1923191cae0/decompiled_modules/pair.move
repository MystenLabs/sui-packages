module 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::pair {
    ...
    public fun burn<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: &0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::treasury::Treasury, arg2: 0x2::coin::Coin<LP<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v3 = mint_fee<T0, T1>(arg0, 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::treasury::treasurer(arg1), arg3);
    ...
    public fun mint<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: &0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::treasury::Treasury, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LP<T0, T1>> {
        ...
        let v3 = 0x2::coin::value<T1>(&arg3);
        let v4 = mint_fee<T0, T1>(arg0, 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::treasury::treasurer(arg1), arg4);
        let v5 = (total_lp_supply<T0, T1>(arg0) as u128);
        let v6 = if (v5 == 0) {
            let v7 = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::math::sqrt_u128((v2 as u128) * (v3 as u128));
            ...
            (0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::math::min_u128((v2 as u128) * v5 / (v0 as u128), (v3 as u128) * v5 / (v1 as u128)) as u64)
        };
        assert!(v6 > 0, 0);
    ...
    fun mint_fee<T0, T1>(arg0: &mut PairMetadata<T0, T1>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        if (arg1 != @0x0) {
            if (arg0.k_last != 0) {
                let v3 = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::math::sqrt_u128((v1 as u128) * (v2 as u128));
                let v4 = 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::math::sqrt_u128(arg0.k_last);
                if (v3 > v4) {
