module 0xba351c1dc07bfa3a0c47ac70d2162a53d30f1f1232891bdc8bb5111a8b2bfab5::reward3046 {
    struct REWARD3046 has drop {
        dummy_field: bool,
    }

    struct TICKET_3046 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3046(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3046>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3046>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3046, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3046>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3046>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3046>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3046>>(v5, 0x2::tx_context::sender(arg1));
    }
