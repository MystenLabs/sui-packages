module 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::discount_mint {
    ...
    entry fun execute_mint(arg0: &mut Pool, arg1: &0x2::transfer_policy::TransferPolicy<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v5 == arg0.price || v5 == arg0.price * (100 - 40) / 100) {
            ...
            let v7 = 0x2::table_vec::length<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&arg0.tails);
            let v8 = if (v7 == 1) {
                0x2::table_vec::pop_back<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg0.tails)
            } else {
                0x2::table_vec::swap<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg0.tails, (generate_answer(v7, &v6) as u64), v7 - 1);
                0x2::table_vec::pop_back<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg0.tails)
            };
            let v9 = v8;
            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::emit_mint_event(&v9, v0);
            let (v10, v11) = 0x2::kiosk::new(arg3);
            let v12 = v11;
            let v13 = v10;
            0x2::kiosk::lock<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut v13, &v12, arg1, v9);
            ...
            let v17 = DiscountEventV3{
                ...
                user           : v0,
                vrf_input      : v3,
                level          : 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::tails_level(&v9),
            };
    ...
    entry fun migrate_pool(arg0: &mut Pool, arg1: &mut Pool, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::table_vec::length<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&arg0.tails);
        while (arg3 < v0 && arg4 > 0) {
            if (0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::tails_level(0x2::table_vec::borrow<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&arg0.tails, arg3)) > arg2) {
                0x2::table_vec::swap<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg0.tails, arg3, v0 - 1);
                deposit_nft(arg1, 0x2::table_vec::pop_back<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg0.tails));
                v0 = v0 - 1;
                continue
            };
            arg3 = arg3 + 1;
    ...
    entry fun send_nft(arg0: &0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::ManagerCap, arg1: &mut Pool, arg2: &0x2::transfer_policy::TransferPolicy<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.authority == 0x2::tx_context::sender(arg4), 0);
        let (v0, v1) = 0x2::kiosk::new(arg4);
        let v2 = v1;
        let v3 = v0;
        let v4 = 0x2::table_vec::pop_back<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg1.tails);
        0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::emit_mint_event(&v4, arg3);
        arg1.num = arg1.num - 1;
        0x2::kiosk::lock<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut v3, &v2, arg2, v4);
    ...
    entry fun update_pool_nft(arg0: &0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::ManagerCap, arg1: &mut Pool, arg2: u64, arg3: 0x2::object::ID, arg4: u64, arg5: vector<u8>, arg6: &0x2::tx_context::TxContext) {
        assert!(arg1.authority == 0x2::tx_context::sender(arg6), 0);
        0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::update_nft(arg0, 0x2::table_vec::borrow_mut<0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg1.tails, arg2), arg3, arg4, arg5);
    }
