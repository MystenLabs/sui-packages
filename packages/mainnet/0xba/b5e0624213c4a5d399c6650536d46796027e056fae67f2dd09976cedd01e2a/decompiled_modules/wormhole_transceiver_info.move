module 0xbab5e0624213c4a5d399c6650536d46796027e056fae67f2dd09976cedd01e2a::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::mode::Mode,
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::mode::serialize(arg0.manager_mode));
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0x8892c7655d1581b8f70edd0e94a48e71de9c703eff04f863bea4653a95cf00d::bytes4::to_bytes(0x8892c7655d1581b8f70edd0e94a48e71de9c703eff04f863bea4653a95cf00d::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
    ...
    public(friend) fun new(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg1: 0xa584604180246368403690b710b92986fc1d7c108361321786b12be3ed2717c5::mode::Mode, arg2: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg3: u8) : WormholeTransceiverInfo {
        WormholeTransceiverInfo{
