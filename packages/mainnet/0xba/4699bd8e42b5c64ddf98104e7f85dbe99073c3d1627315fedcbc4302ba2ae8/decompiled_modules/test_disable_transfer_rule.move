module 0xba4699bd8e42b5c64ddf98104e7f85dbe99073c3d1627315fedcbc4302ba2ae8::test_disable_transfer_rule {
    struct TEST_DISABLE_TRANSFER_RULE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_DISABLE_TRANSFER_RULE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_DISABLE_TRANSFER_RULE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test disable_transfer_rule"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"disable_transfer_rule"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibbnkyzbamku47qcyt5vyh6xhjbmgt4am5bhlbvwmfg24ig5jha7m"));
