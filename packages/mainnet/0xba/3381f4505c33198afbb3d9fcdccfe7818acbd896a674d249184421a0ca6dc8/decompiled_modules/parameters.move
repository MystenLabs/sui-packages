module 0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters {
    ...
    public fun check_sender(arg0: &Parameters, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834659674685439);
    }
    ...
    public fun production_stonker_parameters(arg0: &mut 0x2::tx_context::TxContext) : Parameters {
        ...
        Parameters{
            ...
            maker_max_shallow_quantity_base             : 1200 * v0,
