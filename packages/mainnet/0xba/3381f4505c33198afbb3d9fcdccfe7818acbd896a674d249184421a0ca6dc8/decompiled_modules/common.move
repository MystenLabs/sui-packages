module 0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::common {
    public(friend) fun convert_to_base_at_price(arg0: &0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::Parameters, arg1: u64, arg2: u64) : u64 {
        (((arg1 as u128) * (0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::single_base(arg0) as u128) / (arg2 as u128)) as u64)
    }

    public(friend) fun convert_to_quote_at_price(arg0: &0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::Parameters, arg1: u64, arg2: u64) : u64 {
        (((arg1 as u128) * (arg2 as u128) / (0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::single_base(arg0) as u128)) as u64)
    }
    ...
    public(friend) fun get_available_base_balance(arg0: &0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::Parameters, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager) : u64 {
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1);
        if (v0 < 0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::minimum_base_in_balance_manager(arg0)) {
            0
        } else {
            v0 - 0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::minimum_base_in_balance_manager(arg0)
        }
    }

    public(friend) fun get_available_quote_balance(arg0: &0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::Parameters, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager) : u64 {
        ...
        if (v0 < 0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::minimum_quote_in_balance_manager(arg0)) {
            0
        } else {
            v0 - 0xba3381f4505c33198afbb3d9fcdccfe7818acbd896a674d249184421a0ca6dc8::parameters::minimum_quote_in_balance_manager(arg0)
        }
    }
