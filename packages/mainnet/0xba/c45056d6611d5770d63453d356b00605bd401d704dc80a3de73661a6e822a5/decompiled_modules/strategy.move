module 0x6ff4dc407e25a940b345dceca99fc50e8ba27d4de5eec5050100b8036bb0eced::strategy {
    ...
    public fun get_reward_apy_bps(arg0: &StrategyRegistry, arg1: u8) : u64 {
        let v0 = 0x1::string::utf8(reward_key(arg1));
    ...
    fun reward_key(arg0: u8) : vector<u8> {
        let v0 = b"reward_";
    ...
    public fun select_best_protocol(arg0: &StrategyRegistry) : (u8, u64, u64) {
        ...
        while (v3 < 0x1::vector::length<ProtocolInfo>(&arg0.protocols)) {
            ...
            if (v4.is_available && v4.rate_den > 0) {
                let v5 = (v4.rate_num as u128) * 1000000000 / (v4.rate_den as u128) + (get_reward_apy_bps(arg0, v4.strategy_id) as u128) * 100000;
    ...
    public fun update_reward_apy(arg0: &mut StrategyRegistry, arg1: u8, arg2: u64, arg3: &0x2::clock::Clock) {
        let v0 = 0x1::string::utf8(reward_key(arg1));
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, v0)) {
