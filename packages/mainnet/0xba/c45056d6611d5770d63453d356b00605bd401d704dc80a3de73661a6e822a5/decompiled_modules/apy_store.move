module 0x6ff4dc407e25a940b345dceca99fc50e8ba27d4de5eec5050100b8036bb0eced::apy_store {
    ...
    public fun push_base_apys(arg0: &mut ApyStore, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock) {
        update_apy(arg0, 1, arg1);
        update_apy(arg0, 2, arg2);
        update_apy(arg0, 3, arg3);
        update_apy(arg0, 4, arg4);
        update_apy(arg0, 6, arg5);
        update_apy(arg0, 7, arg6);
        update_apy(arg0, 8, arg7);
    }

    public fun update_apy(arg0: &mut ApyStore, arg1: u8, arg2: u64) {
