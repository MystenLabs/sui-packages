module 0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::draw {
    ...
    public fun is_valid_picks(arg0: &DrawConfig, arg1: &0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::picks::Picks) : bool {
        if (0x2::vec_set::size<u8>(0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::picks::normal_numbers(arg1)) == (arg0.normal_count as u64)) {
            let v0 = 0x2::vec_set::keys<u8>(0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::picks::normal_numbers(arg1));
            let v1 = 0;
            let v2;
            while (v1 < 0x1::vector::length<u8>(v0)) {
                if (!0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::range::contains(&arg0.normal_range, 0x1::vector::borrow<u8>(v0, v1))) {
                    v2 = false;
                    /* label 8 */
                    let v3 = if (v2) {
                        let v3;
                        if (0x2::vec_set::size<u8>(0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::picks::special_numbers(arg1)) == (arg0.special_count as u64)) {
                            let v4 = 0x2::vec_set::keys<u8>(0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::picks::special_numbers(arg1));
                            let v5 = 0;
                            while (v5 < 0x1::vector::length<u8>(v4)) {
                                if (!0x1ba01940bb5b49fc687ca6ba92dcf53d6abbee293d960af70232de67ac01edc0::range::contains(&arg0.special_range, 0x1::vector::borrow<u8>(v4, v5))) {
                                    /* label 19 */
                                    v3 = false;
                                    return v3
                                } else {
