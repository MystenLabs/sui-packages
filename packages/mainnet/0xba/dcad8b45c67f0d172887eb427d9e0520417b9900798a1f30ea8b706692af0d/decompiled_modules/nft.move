module 0xbadcad8b45c67f0d172887eb427d9e0520417b9900798a1f30ea8b706692af0d::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v9;
        let v11 = v8;
        0xbadcad8b45c67f0d172887eb427d9e0520417b9900798a1f30ea8b706692af0d::royalty_policy::set<Item>(&mut v11, &v10, 300);
    ...
    fun verifyMintSignature(arg0: address, arg1: address, arg2: u8, arg3: u8, arg4: vector<u8>, arg5: vector<u8>) : bool {
        ...
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0xbadcad8b45c67f0d172887eb427d9e0520417b9900798a1f30ea8b706692af0d::string::u8_to_string(arg2));
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0xbadcad8b45c67f0d172887eb427d9e0520417b9900798a1f30ea8b706692af0d::string::u8_to_string(arg3));
