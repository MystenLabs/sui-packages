module 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::safu {
        ...
        if (v4 > 0) {
            ...
            while (v7 < v4) {
                ...
                if (v7 + 1 < v4 && (v7 + 1) % v5 == 0) {
                    ...
                    v6 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice<Share>(&v0.share, v15);
                };
                v7 = v7 + 1;
            };
        };
    ...
    entry fun hotfix_create_i_closed(arg0: &0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: &0x2::tx_context::TxContext) {
        0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::verify(arg0, arg2);
        let v0 = 0;
        while (v0 < 6) {
            *0x1::vector::borrow_mut<u64>(&mut 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, v0).info, 10) = 0;
            v0 = v0 + 1;
        };
    }
    ...
    fun is_empty(arg0: &Share) : bool {
        if (*0x1::vector::borrow<u64>(&arg0.u64_padding, 4) > 0) {
            return false
        };
        let v0 = 0;
    ...
    public fun post_bid_balance_v2<T0>(arg0: &mut 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v7 > 0) {
            ...
            while (v10 < v7 && v6 > 0) {
                ...
                let v12 = (((v5 as u128) * ((*0x1::vector::borrow<u64>(&v11.share, 0) + *0x1::vector::borrow<u64>(&v11.share, 1)) as u128) / (v6 as u128)) as u64);
                if (*0x1::vector::borrow<u64>(&v11.share, 0) > 0) {
                    *0x1::vector::borrow_mut<u64>(&mut v11.share, 3) = *0x1::vector::borrow<u64>(&v11.share, 3) + v12;
                } else {
                    *0x1::vector::borrow_mut<u64>(&mut v11.share, 2) = *0x1::vector::borrow<u64>(&v11.share, 2) + v12;
                };
                v5 = v5 - v12;
                v6 = v6 - *0x1::vector::borrow<u64>(&v11.share, 0) + *0x1::vector::borrow<u64>(&v11.share, 1);
