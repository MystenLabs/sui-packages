module 0xba4e04a6db0c32faa9a55ce38fd5560e2fd800b39ede2ce850710dd2955d6d86::cnsnft9499 {
    struct CNSNFT9499 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9499>(arg0, arg1);
