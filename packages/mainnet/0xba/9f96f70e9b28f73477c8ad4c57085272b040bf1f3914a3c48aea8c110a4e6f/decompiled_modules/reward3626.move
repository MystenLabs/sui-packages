module 0xba9f96f70e9b28f73477c8ad4c57085272b040bf1f3914a3c48aea8c110a4e6f::reward3626 {
    struct REWARD3626 has drop {
        dummy_field: bool,
    }

    struct TICKET_3626 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3626(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3626>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3626>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3626, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3626>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3626>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3626>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3626>>(v5, 0x2::tx_context::sender(arg1));
    }
