module 0xba394b6c78269bdd3600ad7436d9e00b0fa74c2f708cff2b6b439965cbdc3479::reward6913 {
    struct REWARD6913 has drop {
        dummy_field: bool,
    }

    struct TICKET_6913 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6913(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6913>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6913>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6913, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6913>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6913>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6913>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6913>>(v5, 0x2::tx_context::sender(arg1));
    }
