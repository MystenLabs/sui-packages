module 0xba841497741c44a14d4081f8544bc925b2329ad670d716185b18210ceb7cd075::cnsnft4292 {
    struct CNSNFT4292 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4292, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4292>(arg0, arg1);
