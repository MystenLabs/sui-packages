module 0xba8f4260fde4dc5b239fb8bc8f448ef75c9b484a20ab7b11495665a8a5356923::reward3095 {
    struct REWARD3095 has drop {
        dummy_field: bool,
    }

    struct TICKET_3095 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3095(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_3095>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3095, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3095>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3095>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3095>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3095>>(v5, 0x2::tx_context::sender(arg1));
    }
