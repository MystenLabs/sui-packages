module 0xbaa1dcbe34f56ea6d798a1366f6f66a3f3effddd84dc299815cd9140af3fc4ee::reward2477 {
    struct REWARD2477 has drop {
        dummy_field: bool,
    }

    struct TICKET_2477 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2477(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2477>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2477>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2477, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2477>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2477>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2477>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2477>>(v5, 0x2::tx_context::sender(arg1));
    }
