module 0xbab5f0b6fa820c1950df799e3ed76f43e1df04c500203ef54b1400dac24daa95::cnsnft9592 {
    struct CNSNFT9592 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9592, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9592>(arg0, arg1);
