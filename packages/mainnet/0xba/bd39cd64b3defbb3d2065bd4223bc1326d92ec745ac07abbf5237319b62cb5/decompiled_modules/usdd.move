module 0xbabd39cd64b3defbb3d2065bd4223bc1326d92ec745ac07abbf5237319b62cb5::usdd {
    ...
    fun init(arg0: USDD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://gateway.irys.xyz/BCeKVQWTeL317sNPn23aKTJZf7eMAA2LSZdVXqN8ZJc4                                                                                                                                                                                                                                                           ");
