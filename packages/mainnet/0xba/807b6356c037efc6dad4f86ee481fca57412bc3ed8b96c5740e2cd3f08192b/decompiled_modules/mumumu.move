module 0xba807b6356c037efc6dad4f86ee481fca57412bc3ed8b96c5740e2cd3f08192b::mumumu {
    ...
    fun init(arg0: MUMUMU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = &mut v4;
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"Mumumu10 #{token_id}"));
        ...
        let v11 = Mumumu{
            ...
            image_base          : 0x1::string::utf8(b"https://storage.googleapis.com/mmp-demo/sui/3.png"),
