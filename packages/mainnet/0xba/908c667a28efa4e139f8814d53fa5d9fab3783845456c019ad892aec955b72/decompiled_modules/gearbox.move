module 0xba908c667a28efa4e139f8814d53fa5d9fab3783845456c019ad892aec955b72::gearbox {
    ...
    public fun claim_rewards<T0>(arg0: &0x2::clock::Clock, arg1: &mut GearBoxChef, arg2: &mut GearBox, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2.claimable_rewards > 0) {
            ...
            0xbc8a0a8883a7c5a3ec499f452507df0452856b10c5ecf58114f600da32f6f1d4::math::destroy_or_transfer_balance<T0>(0x2::balance::split<T0>(&mut v0.coin_balance, arg2.claimable_rewards), 0x2::tx_context::sender(arg3), arg3);
    ...
    public fun claim_sui_collected(arg0: &GearBoxFeeClaimCap, arg1: &mut GearBoxChef, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xbc8a0a8883a7c5a3ec499f452507df0452856b10c5ecf58114f600da32f6f1d4::math::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.balance), arg2, arg3);
    }
    ...
    public fun finish_prelaunch_campaign<T0>(arg0: &GearBoxAdminCap, arg1: &0x2::clock::Clock, arg2: &mut GearBoxChef, arg3: 0x2::coin::Coin<T0>, arg4: u64) {
        ...
        arg2.global_claim_index = 0xbc8a0a8883a7c5a3ec499f452507df0452856b10c5ecf58114f600da32f6f1d4::math::mul_div_u256((arg4 as u256), (1000000000000000000 as u256), (arg2.active_points as u256));
    ...
    fun increment_gear_box_rewards(arg0: &0x2::clock::Clock, arg1: &mut GearBoxChef, arg2: &mut GearBox) {
        ...
        arg2.claimable_rewards = arg2.claimable_rewards + (0xbc8a0a8883a7c5a3ec499f452507df0452856b10c5ecf58114f600da32f6f1d4::math::mul_div_u256(arg1.global_claim_index - arg2.claim_index, (arg2.active_points as u256), (1000000000000000000 as u256)) as u64);
    ...
    fun increment_global_index(arg0: &0x2::clock::Clock, arg1: &mut GearBoxChef) {
        ...
        let v1 = (0xbc8a0a8883a7c5a3ec499f452507df0452856b10c5ecf58114f600da32f6f1d4::math::mul_div_u256(((v0 - arg1.last_claim_ts) as u256), (arg1.distribution_rate as u256), (1000000000000000000 as u256)) as u64);
        arg1.global_claim_index = arg1.global_claim_index + 0xbc8a0a8883a7c5a3ec499f452507df0452856b10c5ecf58114f600da32f6f1d4::math::mul_div_u256((v1 as u256), (1000000000000000000 as u256), (arg1.active_points as u256));
    ...
    public fun mint_gear_box(arg0: &0x2::clock::Clock, arg1: &mut GearBoxChef, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xbc8a0a8883a7c5a3ec499f452507df0452856b10c5ecf58114f600da32f6f1d4::math::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg4), arg4);
