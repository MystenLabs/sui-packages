module 0xbab44eb854fe235f3af4e7b934ca6adce78dd377198a00231863e668f4e1ab23::reward6617 {
    struct REWARD6617 has drop {
        dummy_field: bool,
    }

    struct TICKET_6617 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6617(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6617>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6617>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6617, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6617>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6617>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6617>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6617>>(v5, 0x2::tx_context::sender(arg1));
    }
