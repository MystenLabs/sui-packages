module 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::epoch_bus_factory {
    ...
    public entry fun migrate_tick_record_to_v2_entry(arg0: &mut 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::DeployRecord, arg1: 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::TickRecord, arg2: &mut 0x2::tx_context::TxContext) {
        migrate_tick_record_to_v2(arg0, arg1, arg2);
    }

    public fun migrate_tick_record_to_v2_no_drop(arg0: &mut 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::DeployRecord, arg1: &mut 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::TickRecord, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = WITNESS{dummy_field: false};
        let (v1, v2, v3, v4, v5) = 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::migrate_tick_record_to_v2_no_drop<WITNESS>(arg0, arg1, v0, arg2);
        let v6 = v1;
        let v7 = if (0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_v2_remain(&v6) == 0 || !(0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_v2_total_transactions(&v6) > 0)) {
            0x2::table::new<u64, EpochRecord>(arg2)
        } else {
            let v8 = 0x2::table::new<u64, EpochRecord>(arg2);
            0x2::table::add<u64, EpochRecord>(&mut v8, v4, migrate_epoch_record(0x2::table::remove<u64, 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::EpochRecord>(0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_epoch_records(arg1), v4)));
            v8
        };
        let v9 = EpochBusFactory{
            init_locked_sui : v5,
            start_time_ms   : v2,
            epoch_count     : v3,
            epoch_amount    : 0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_v2_total_supply(&v6) / v3,
            current_epoch   : v4,
            epoch_records   : v7,
        };
        let v10 = WITNESS{dummy_field: false};
        0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::tick_record_add_df<EpochBusFactory, WITNESS>(&mut v6, v9, v10);
        0x2::transfer::public_share_object<0x830fe26674dc638af7c3d84030e2575f44a2bdc1baa1f4757cfe010a4b106b6a::movescription::TickRecordV2>(v6);
    }
