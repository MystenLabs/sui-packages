module 0xba27c95375b535c68c9cccfe353860f64c06c0373ab1ceb63f2f84f5656c7f0a::mystemons {
    ...
    fun init(arg0: MYSTEMONS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<MystemonV2>(&mut v3, 0x1::string::utf8(b"icon_url"), 0x1::string::utf8(b"https://i.imgur.com/8z1Zz0s.png"));
