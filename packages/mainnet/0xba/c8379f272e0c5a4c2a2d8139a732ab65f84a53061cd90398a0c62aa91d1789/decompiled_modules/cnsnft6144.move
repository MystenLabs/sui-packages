module 0xbac8379f272e0c5a4c2a2d8139a732ab65f84a53061cd90398a0c62aa91d1789::cnsnft6144 {
    struct CNSNFT6144 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6144, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7765"));
        let v4 = 0x2::package::claim<CNSNFT6144>(arg0, arg1);
