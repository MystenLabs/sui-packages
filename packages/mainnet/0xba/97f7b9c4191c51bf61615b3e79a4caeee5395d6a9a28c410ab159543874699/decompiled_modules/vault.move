module 0xba97f7b9c4191c51bf61615b3e79a4caeee5395d6a9a28c410ab159543874699::vault {
    ...
    public fun get_optimal_swap_amount_for_single_sided_liquidity<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: u64, arg3: bool, arg4: u64) : u64 {
        ...
        let v5 = arg2 / 2;
        while (v4 < arg4) {
            let v6 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculate_swap_result<T0, T1>(arg1, arg3, true, v5);
            ...
            let v10 = (v8 as u128) * (v2 as u128) / (v9 as u128);
            if (v4 == 0) {
            } else if (v10 > v3) {
                if (arg3) {
                    let v11 = (arg2 - v5) / 2;
