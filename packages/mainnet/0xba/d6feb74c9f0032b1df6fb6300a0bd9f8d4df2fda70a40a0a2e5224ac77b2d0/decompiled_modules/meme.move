module 0xbad6feb74c9f0032b1df6fb6300a0bd9f8d4df2fda70a40a0a2e5224ac77b2d0::meme {
    ...
    fun init(arg0: MEME, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME>(arg0, 0, b"MEME", b"MEME Exchange", b"MEME Exchange, Mining Pool, Defi, Launch Pad, Top MEME exchange, DAO Community Governance Exchange", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://ipfs.io/ipfs/QmWGqd4SdwwtDyTC1bTdpELaZsffSaPZKq1CGyZGwMPCFN/"))), arg1);
