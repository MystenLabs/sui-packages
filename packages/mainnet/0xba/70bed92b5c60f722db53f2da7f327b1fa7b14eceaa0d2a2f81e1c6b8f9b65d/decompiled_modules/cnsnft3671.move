module 0xba70bed92b5c60f722db53f2da7f327b1fa7b14eceaa0d2a2f81e1c6b8f9b65d::cnsnft3671 {
    struct CNSNFT3671 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3671, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6745"));
        let v4 = 0x2::package::claim<CNSNFT3671>(arg0, arg1);
