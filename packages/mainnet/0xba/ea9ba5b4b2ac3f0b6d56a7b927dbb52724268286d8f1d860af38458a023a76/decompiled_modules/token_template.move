module 0xbaea9ba5b4b2ac3f0b6d56a7b927dbb52724268286d8f1d860af38458a023a76::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T171266", b"Test 171266", b"Integration test token 2025-10-28T00:42:51.266Z", 0x1::option::none<0x2::url::Url>(), arg1);
