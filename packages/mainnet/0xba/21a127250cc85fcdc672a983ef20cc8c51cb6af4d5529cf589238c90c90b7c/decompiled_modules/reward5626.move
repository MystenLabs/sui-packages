module 0xba21a127250cc85fcdc672a983ef20cc8c51cb6af4d5529cf589238c90c90b7c::reward5626 {
    struct REWARD5626 has drop {
        dummy_field: bool,
    }

    struct TICKET_5626 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5626(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5626>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5626>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5626, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5626>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5626>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5626>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5626>>(v5, 0x2::tx_context::sender(arg1));
    }
