module 0xba23939465d1030638180172595a6ba2e3d55c77c1d48c5ccb6559e986c64d8c::endpoints_v2 {
    ...
    struct AccountBalance has copy, drop, store {
        base_avail: u64,
        base_locked: u64,
        quote_avail: u64,
        quote_locked: u64,
    ...
    struct PlaceLimitOrder has copy, drop, store {
        base_filled: u64,
        quote_filled: u64,
        maker_injected: bool,
        maker_order_id: u64,
    ...
    struct MarketPrice has copy, drop, store {
        best_bid_price: u64,
        best_ask_price: u64,
    }
    ...
    public entry fun account_balance<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: &0xdee9::custodian_v2::AccountCap) {
        let (v0, v1, v2, v3) = 0xdee9::clob_v2::account_balance<T0, T1>(arg0, arg1);
        let v4 = AccountBalance{
            base_avail   : v0,
            base_locked  : v1,
            quote_avail  : v2,
            quote_locked : v3,
        };
        0x2::event::emit<AccountBalance>(v4);
    }
    ...
    public entry fun get_market_price<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>) {
        let (v0, v1) = 0xdee9::clob_v2::get_market_price<T0, T1>(arg0);
        let v2 = v1;
        let v3 = v0;
        let v4 = MarketPrice{
            best_bid_price : *0x1::option::borrow<u64>(&v3),
            best_ask_price : *0x1::option::borrow<u64>(&v2),
        };
        0x2::event::emit<MarketPrice>(v4);
    }

    public entry fun list_open_orders<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: &0xdee9::custodian_v2::AccountCap) {
        0xdee9::clob_v2::list_open_orders<T0, T1>(arg0, arg1);
    }

    public entry fun place_limit_order<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool, arg4: u64, arg5: u8, arg6: &0x2::clock::Clock, arg7: &0xdee9::custodian_v2::AccountCap, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0xdee9::clob_v2::place_limit_order<T0, T1>(arg0, 0, arg1, arg2, 0, arg3, arg4, arg5, arg6, arg7, arg8);
        let v4 = PlaceLimitOrder{
            base_filled    : v0,
            quote_filled   : v1,
            maker_injected : v2,
            maker_order_id : v3,
        };
        0x2::event::emit<PlaceLimitOrder>(v4);
    }
