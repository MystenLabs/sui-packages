module 0xba1f3e5ad52d40ce714efe1d8052f93cfbe85ffb37fd6a316d2cd3bd67bbb5e8::wukong {
    ...
    fun init(arg0: WUKONG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CmEZPyahCkpBEEjJKYugoy73E1zFTWGPAVNyD8habonk.png?size=lg&key=486950                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<WUKONG>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Wukong  ")))), trim_right(b"Wukong                          "), trim_right(b"$WukongThe legendary warrior from Chinese mythology.                                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
