module 0xba83175c207e9edafed75e6aea05d45bd985127ad2edfba639230d9438da549b::cnsnft3455 {
    struct CNSNFT3455 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3455, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3455>(arg0, arg1);
