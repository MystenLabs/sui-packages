module 0xbadfa6c3e41e52880b40ea931ff39cfb1a696ea27b6b6097798c82ba25640c44::SuiGameNFT {
    ...
    public entry fun feed(arg0: &mut NFTPool, arg1: &mut SuiGameNFT, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<address, address>(&arg0.addressInvite, v0)) {
            ...
            if (!0x2::table::contains<address, address>(&arg0.addressInvite, *v1)) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, 10000000 * 90 / 100, arg4), arg0.addressVault);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, *v1);
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, 10000000 * 85 / 100, arg4), arg0.addressVault);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, 10000000 * 10 / 100, arg4), *v1);
    ...
    public entry fun mint(arg0: &mut NFTPool, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = *v1 + 1;
        let v2 = SuiGameNFT{
            ...
            feedTime    : 0,
            hashrate    : 1,
            hp          : 0xbadfa6c3e41e52880b40ea931ff39cfb1a696ea27b6b6097798c82ba25640c44::random::rand_u64_range(1, 10, arg1),
            str         : 0xbadfa6c3e41e52880b40ea931ff39cfb1a696ea27b6b6097798c82ba25640c44::random::rand_u64_range(1, 100, arg1),
            mag         : 0xbadfa6c3e41e52880b40ea931ff39cfb1a696ea27b6b6097798c82ba25640c44::random::rand_u64_range(100, 1000, arg1),
            inT         : 0xbadfa6c3e41e52880b40ea931ff39cfb1a696ea27b6b6097798c82ba25640c44::random::rand_u64_range(100, 1000, arg1),
            gold        : 0xbadfa6c3e41e52880b40ea931ff39cfb1a696ea27b6b6097798c82ba25640c44::random::rand_u64_range(1, 100, arg1),
