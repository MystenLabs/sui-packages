module 0xba01fb8304960724634e3d60a07dcb1dcb9062bcca421ec45be4cfebc81c6a19::game {
    ...
    fun daily_lottery(arg0: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = get_random(arg0, arg1, arg2);
        if (v0 % 16 == 0) {
            send_claim_nft(b"copper", b"https://ipfs.io/ipfs/bafkreiel7xfens3mgrvgycgj3qiv6qao44me76eu4f3ugwthhmnffjiafi", 101, arg2);
            let v1 = ObtainCard{result: 101};
            0x2::event::emit<ObtainCard>(v1);
        } else if (v0 % 3 == 0) {
            send_claim_nft(b"silver", b"https://ipfs.io/ipfs/bafkreiarcgkfez4xn4kvcuntvd3h54rp34tif6phhg66aenykg7ha7x4wy", 102, arg2);
            let v2 = ObtainCard{result: 102};
            0x2::event::emit<ObtainCard>(v2);
        } else {
            send_claim_nft(b"gold", b"https://ipfs.io/ipfs/bafkreihkanwafumvbi7kcr7i5mawdofpscagnw7tzvg5j4hbqhutb7fmza", 103, arg2);
    ...
    fun get_random(arg0: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) : u64 {
        ...
        let v2 = ((0x2::bcs::peel_u64(&mut v1) % 123) as u64);
    ...
    public entry fun start_game(arg0: &0x8378b3bd39931aa74a6aa3a820304c1109d327426e4275183ed0b797eb6660a8::weather::WeatherOracle, arg1: &mut GamePoolHouse, arg2: u8, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = get_random(arg0, arg3, arg6) % 3;
