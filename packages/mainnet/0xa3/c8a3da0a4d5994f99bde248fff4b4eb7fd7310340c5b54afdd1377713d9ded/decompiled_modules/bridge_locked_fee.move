module 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::bridge_locked_fee {
    ...
    public fun bridge_locked_fee<T0: drop>(arg0: &mut 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::State, arg1: &mut 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::state::State, arg2: &0x2::coin::CoinMetadata<T0>, arg3: BridgeLockedFeeTicket<T0>, arg4: &mut 0x2::tx_context::TxContext) : (CctpBurnRequestBridgeLockedFee<T0>, 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::deposit_for_burn::DepositForBurnWithCallerTicket<T0, CircleAuth>) {
        ...
        assert!(v2 != 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::solana_cctp_domain(), 4);
        let v7 = 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::get_cctp_mayan_caller(arg0, v2);
    ...
    public fun store_bridge_locked_fee<T0>(arg0: &mut 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::State, arg1: &0x2::coin::CoinMetadata<T0>, arg2: CctpBurnRequestBridgeLockedFee<T0>, arg3: &0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::Message, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::from_bytes(&v9);
        assert!(v0 == 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::destination_domain(arg3), 5);
        assert!(v1 == 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::mint_recipient(&v10), 5);
        assert!(v2 == 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::burn_token(&v10), 5);
        assert!(v3 == (0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::amount(&v10) as u64), 5);
        ...
        let v12 = BridgeLockedFeeSubmitted{
            ...
            locked_fee_id    : 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::lock_fee_redeem<T0>(arg0, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::nonce(arg3), v1, v6, 0x2::coin::into_balance<T0>(v8), arg4),
            addr_dest        : v1,
        };
