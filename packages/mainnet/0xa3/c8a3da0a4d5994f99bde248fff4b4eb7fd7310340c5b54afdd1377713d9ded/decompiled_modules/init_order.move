module 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::init_order {
    ...
    public fun initialize_order<T0: drop>(arg0: &0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::State, arg1: &0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::state::State, arg2: &0x2::coin::CoinMetadata<T0>, arg3: InitOrderTicket<T0>, arg4: 0xa78bf5adc9b7a2b6a71eea973ca3e9a1c2a185a732f740a7a0a67e4f5bf783c6::calculate_mctp_fee::MctpInitOrderParams) : (CctpBurnRequestInitOrder, 0x2aa6c5d56376c371f88a6cc42e852824994993cb9bab8d3e6450cbe3cb32b94e::deposit_for_burn::DepositForBurnWithCallerTicket<T0, CircleAuth>) {
        ...
        let v17 = 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::get_cctp_mayan_recipient(arg0, v5, 0x2::object::id_to_address(&v16));
        let v18 = 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::get_cctp_mayan_caller(arg0, v5);
    ...
    public fun publish_init_order(arg0: &mut 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::state::State, arg1: CctpBurnRequestInitOrder, arg2: &0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::Message) : 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::publish_message::MessageTicket {
        ...
        let v21 = 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::from_bytes(&v20);
        assert!(v0 == 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::destination_domain(arg2), 2);
        assert!(v1 == 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::mint_recipient(&v21), 2);
        assert!(v2 == 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::burn_token(&v21), 2);
        assert!(v3 == (0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::burn_message::amount(&v21) as u64), 2);
        assert!(v4 == 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::destination_caller(arg2), 2);
        let v22 = 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::swap_order::new(v5, v6, v7, v8, v3, v9, v10, v11, v12, v13, v14, v15, v16, v17, v18, 0x8d87d37ba49e785dde270a83f8e979605b03dc552b5548f26fdf2f49bf7ed1b::message::nonce(arg2), v19);
        let v23 = 0xa3c8a3da0a4d5994f99bde248fff4b4eb7fd7310340c5b54afdd1377713d9ded::swap_order::to_hash(&v22);
