module 0xa3b77f856a8efe1ca2f0ef63e433365fb11b3d1fef3998b82a99b73e3654408a::mermaidplace {
    ...
    public entry fun addSponsor(arg0: &mut MermaidplaceConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::table::add<address, address>(&mut arg0.table_sponsor, 0x2::tx_context::sender(arg2), arg1);
    }

    public entry fun addSponsor2(arg0: &mut MermaidplaceConfig, arg1: address) {
        0x1::vector::push_back<address>(&mut arg0.vec_sponsor, arg1);
    }

    public entry fun buy<T0: store + key>(arg0: &mut MermaidplaceConfig, arg1: &mut 0xa3b77f856a8efe1ca2f0ef63e433365fb11b3d1fef3998b82a99b73e3654408a::royalty_fee::RoyaltyBag, arg2: 0x2::object::ID, arg3: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0xa3b77f856a8efe1ca2f0ef63e433365fb11b3d1fef3998b82a99b73e3654408a::royalty_fee::charge_royalty<T0>(arg1, v3, &mut v1, arg4);
        assert!(v8 + v9 < v3, 5);
        let v10 = v3 - v8 - v9;
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xa3b77f856a8efe1ca2f0ef63e433365fb11b3d1fef3998b82a99b73e3654408a::royalty_fee::init_royalty_bag(arg0);
    }
