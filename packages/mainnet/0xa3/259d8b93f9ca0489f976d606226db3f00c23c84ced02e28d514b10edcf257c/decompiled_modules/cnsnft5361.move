module 0xa3259d8b93f9ca0489f976d606226db3f00c23c84ced02e28d514b10edcf257c::cnsnft5361 {
    struct CNSNFT5361 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5361, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5361>(arg0, arg1);
