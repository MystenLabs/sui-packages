module 0xa329d8a3d499f6c811caa208455d81d648fe79ff04d8ffb351a52466a57958a4::whitelisted_pools {
    struct WhitelistRegistry has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x2::object::ID, bool>,
    }

    public entry fun add_pool_to_whitelist(arg0: &0xa329d8a3d499f6c811caa208455d81d648fe79ff04d8ffb351a52466a57958a4::admin::AdminCap, arg1: &mut WhitelistRegistry, arg2: 0x2::object::ID) {
    ...
    public entry fun remove_pool_from_whitelist(arg0: &0xa329d8a3d499f6c811caa208455d81d648fe79ff04d8ffb351a52466a57958a4::admin::AdminCap, arg1: &mut WhitelistRegistry, arg2: 0x2::object::ID) {
