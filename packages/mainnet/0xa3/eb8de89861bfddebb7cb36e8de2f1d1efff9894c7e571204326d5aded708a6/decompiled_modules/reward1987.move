module 0xa3eb8de89861bfddebb7cb36e8de2f1d1efff9894c7e571204326d5aded708a6::reward1987 {
    struct REWARD1987 has drop {
        dummy_field: bool,
    }

    struct TICKET_1987 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1987(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1987>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1987>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1987, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1987>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1987>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1987>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1987>>(v5, 0x2::tx_context::sender(arg1));
    }
