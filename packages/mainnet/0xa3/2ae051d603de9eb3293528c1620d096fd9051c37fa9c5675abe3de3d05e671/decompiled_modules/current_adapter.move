module 0x4121c31df41bfb26121fd8727e00afce980b55f5da04351217b4bea8be89e1b2::current_adapter {
    ...
    public fun select_ctoken_withdraw_amount_floor<T0, T1>(arg0: &0xfe1d8929d13b00aaecd7642dec1c6d41cab82882a1b139efa46bf61dfd6380bf::market::Market<T0>, arg1: u128, arg2: u64, arg3: u64) : u64 {
        let v0 = if (arg1 == 0) {
            true
        } else if (arg2 == 0) {
            true
        ...
        let v4 = 0xf01bf3d01c8f50247fdf597e3f565b865e00b4a20a01b353d44d71c993f36e9a::float::int_div((v3 as u64), exchange_rate<T0, T1>(arg0));
        if (v4 > arg2) {
            arg2
        } else {
            v4
