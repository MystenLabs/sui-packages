module 0x1507d872386da97dc346d4adfab5170fe542f8b8ec412b270432cab651aef211::reward_manager {
    ...
    public(friend) fun deposit_reward<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>) : u64 {
        ...
        if (!0x2::table::contains<0x1::type_name::TypeName, u128>(&arg0.available_balance, v0)) {
            ...
            if (v3) {
                abort 0x1507d872386da97dc346d4adfab5170fe542f8b8ec412b270432cab651aef211::error::available_balance_overflow()
            };
    ...
    public(friend) fun emergent_withdraw<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!((arg2 as u128) << 64 <= *0x2::table::borrow<0x1::type_name::TypeName, u128>(&arg0.available_balance, v0), 0x1507d872386da97dc346d4adfab5170fe542f8b8ec412b270432cab651aef211::error::incorrect_withdraw_amount());
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: u64) {
        ...
        assert!(v0 <= arg3, 0x1507d872386da97dc346d4adfab5170fe542f8b8ec412b270432cab651aef211::error::invalid_time());
