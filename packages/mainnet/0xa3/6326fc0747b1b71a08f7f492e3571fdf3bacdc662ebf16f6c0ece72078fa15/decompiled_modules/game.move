module 0xbdbce887a808bbcb74be342cdcc3913be1e753fc6d6ef557b0417c6a7aab3c9a::game {
    ...
    fun init(arg0: GAME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GameRegistry{
            ...
            games       : 0x2::table::new<0x2::object::ID, GameInfo>(arg1),
            total_games : 0,
            admins      : v0,
        };
        0x2::transfer::share_object<GameRegistry>(v1);
        let v2 = 0x2::package::claim<GAME>(arg0, arg1);
        let v3 = 0x2::display::new<SuidokuGame>(&v2, arg1);
        0x2::display::add<SuidokuGame>(&mut v3, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"Suidoku Game"));
        0x2::display::add<SuidokuGame>(&mut v3, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"On-chain Sudoku puzzle game on Sui. Solve the puzzle and prove your skills!"));
        0x2::display::add<SuidokuGame>(&mut v3, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://frontend-dry-dust-3698.fly.dev/suidoku-nft.png"));
        0x2::display::add<SuidokuGame>(&mut v3, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://frontend-dry-dust-3698.fly.dev"));
        0x2::display::add<SuidokuGame>(&mut v3, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Suidoku"));
        0x2::display::add<SuidokuGame>(&mut v3, 0x1::string::utf8(b"difficulty"), 0x1::string::utf8(b"{difficulty}"));
        0x2::display::add<SuidokuGame>(&mut v3, 0x1::string::utf8(b"completed"), 0x1::string::utf8(b"{completed}"));
        0x2::display::update_version<SuidokuGame>(&mut v3);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v2, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<SuidokuGame>>(v3, 0x2::tx_context::sender(arg1));
    }
