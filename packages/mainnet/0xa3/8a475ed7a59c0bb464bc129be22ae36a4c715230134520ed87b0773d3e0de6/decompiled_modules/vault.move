module 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::vault {
    ...
    public fun accrue_performance_fee_with_adapter<T0>(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::get_suilend_reserve<T0, 0x2::sui::SUI>(arg3);
        let v0 = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::get_suilend_fee_receiver<T0>(arg3);
    ...
    public entry fun admin_claim_and_compound_reward<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::get_suilend_fee_receiver<T0>(arg1);
        let v0 = borrow_reserve_slot_shared<T0>(arg0, arg3);
        let v1 = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::claim_rewards_from_suilend<T0, 0x2::sui::SUI>(arg1, &v0.obligation_cap, arg2, arg3, arg4, arg5, arg6);
    ...
    public entry fun admin_claim_reward<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == arg0.admin, 1001);
        let v0 = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::get_suilend_fee_receiver<T0>(arg1);
        let v1 = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::claim_rewards_from_suilend<T0, T1>(arg1, &borrow_reserve_slot_shared<T0>(arg0, arg3).obligation_cap, arg2, arg3, arg4, arg5, arg6);
    ...
    public entry fun borrow_from_vault<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::borrow_from_suilend<T0, T1>(arg1, arg2, &borrow_reserve_slot_shared<T0>(arg0, arg2).obligation_cap, arg3, arg4, arg5), 0x2::tx_context::sender(arg5));
        let v0 = VaultEvent{
            kind      : 5,
    ...
    public entry fun deposit<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg3: &0x2::clock::Clock, arg4: &0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Strategies, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 0);
        assert!(0x2::object::id<0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Strategies>(arg4) == arg0.strategies_id, 9999);
        ...
        let v2 = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::get_allocations(arg4);
        let v3 = 0x1::vector::length<0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Allocation>(&v2);
        assert!(v3 > 0, 9998);
        let v4 = 0;
        while (v4 < v3 - 1) {
            let (v5, v6, v7) = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::get_allocation_fields(0x1::vector::borrow<0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Allocation>(&v2, v4));
            assert!(v5 == 0, 9997);
            ensure_reserve_slot<T0>(arg0, arg2, v6, arg5);
            let v8 = borrow_reserve_slot_shared<T0>(arg0, v6);
            0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::deposit_to_suilend<T0>(arg2, v6, arg3, 0x2::coin::split<0x2::sui::SUI>(&mut arg1, v0 * v7 / 10000, arg5), &v8.obligation_cap, arg5);
            v4 = v4 + 1;
        };
        if (v3 > 0) {
            let (v9, v10, _) = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::get_allocation_fields(0x1::vector::borrow<0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Allocation>(&v2, v3 - 1));
            assert!(v9 == 0, 9997);
            ensure_reserve_slot<T0>(arg0, arg2, v10, arg5);
            0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::deposit_to_suilend<T0>(arg2, v10, arg3, arg1, &borrow_reserve_slot_shared<T0>(arg0, v10).obligation_cap, arg5);
        } else {
    ...
    public entry fun deposit_with_suilend_loop<T0, T1: drop>(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Strategies, arg6: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg7: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::allocate_and_execute(arg5, v0, arg9);
    ...
    public entry fun emergency_liquidate<T0, T1, T2>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, _) = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::liquidate_obligation<T0, T1, T2>(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v2 = v0;
    ...
    fun ensure_reserve_slot<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::dynamic_field::exists_<ReserveKey>(&arg0.id, v0)) {
            let v1 = VaultReserveSlot<T0>{obligation_cap: 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::create_obligation_cap<T0>(arg1, arg3)};
    ...
    public entry fun harvest_rewards<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::tx_context::sender(arg6) == arg0.admin, 1001);
        let v0 = borrow_reserve_slot_shared<T0>(arg0, arg3);
        let v1 = 0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::claim_rewards_from_suilend<T0, T1>(arg1, &v0.obligation_cap, arg2, arg3, arg4, arg5, arg6);
        let v2 = 0x2::coin::value<T1>(&v1);
        if (v2 > 0) {
    ...
    public entry fun set_strategies(arg0: &mut Vault, arg1: &0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Strategies, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        arg0.strategies_id = 0x2::object::id<0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::strategy::Strategies>(arg1);
        let v0 = VaultEvent{
            kind      : 2,
    ...
    public entry fun withdraw<T0>(arg0: &mut Vault, arg1: &mut 0x2::coin::Coin<VAULT>, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::withdraw_liquidity_from_suilend<T0, 0x2::sui::SUI>(arg3, arg4, arg5, &borrow_reserve_slot_shared<T0>(arg0, arg4).obligation_cap, v0, arg6), 0x2::tx_context::sender(arg6));
        let v1 = VaultEvent{
            kind      : 1,
    ...
    public entry fun withdraw_with_suilend_loop<T0, T1: drop>(arg0: &mut Vault, arg1: &mut 0x2::coin::Coin<VAULT>, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: u64, arg6: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xba97dc73a07638d03d77ad2161484eb21db577edc9cadcd7035fef4b4f2f6fa1::strategy_wrapper::StrategyOwnerCap<T0>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        0xa38a475ed7a59c0bb464bc129be22ae36a4c715230134520ed87b0773d3e0de6::suilend_adapter::repay_borrow<T0, 0x2::sui::SUI>(arg3, arg5, &v2.obligation_cap, arg7, &mut v1, arg10);
