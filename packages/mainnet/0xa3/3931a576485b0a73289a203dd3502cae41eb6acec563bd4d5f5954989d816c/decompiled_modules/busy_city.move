module 0xa33931a576485b0a73289a203dd3502cae41eb6acec563bd4d5f5954989d816c::busy_city {
    struct BUSY_CITY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BUSY_CITY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BUSY_CITY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Busy City"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Busy City is inspired by the bustling and story-filled urban community."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Zt0z5QdnCCOqm2lBVSDcsr9pV3zbsQScHHGRN4s6NmM"));
