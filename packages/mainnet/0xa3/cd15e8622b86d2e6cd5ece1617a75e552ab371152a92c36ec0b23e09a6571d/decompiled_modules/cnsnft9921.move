module 0xa3cd15e8622b86d2e6cd5ece1617a75e552ab371152a92c36ec0b23e09a6571d::cnsnft9921 {
    struct CNSNFT9921 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9921, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9921>(arg0, arg1);
