module 0xa30ed0e9278837c582504335711d489908ed2c5c0c1e4acbf79d1d15d399a69d::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"FIX772080", b"Fixed 772080", b"Fixed supply test token", 0x1::option::none<0x2::url::Url>(), arg1);
