module 0xa3ff793aa1aebb8e7961bf495931e2bf7e8673fc143edecb3cbdc9351afdddee::cnsnft8049 {
    struct CNSNFT8049 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8049, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8049>(arg0, arg1);
