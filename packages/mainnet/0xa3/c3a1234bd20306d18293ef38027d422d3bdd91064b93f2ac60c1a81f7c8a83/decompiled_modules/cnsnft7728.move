module 0xa3c3a1234bd20306d18293ef38027d422d3bdd91064b93f2ac60c1a81f7c8a83::cnsnft7728 {
    struct CNSNFT7728 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7728, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7338"));
        let v4 = 0x2::package::claim<CNSNFT7728>(arg0, arg1);
