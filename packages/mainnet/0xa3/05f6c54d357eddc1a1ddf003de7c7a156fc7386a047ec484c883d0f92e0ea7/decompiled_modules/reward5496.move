module 0xa305f6c54d357eddc1a1ddf003de7c7a156fc7386a047ec484c883d0f92e0ea7::reward5496 {
    struct REWARD5496 has drop {
        dummy_field: bool,
    }

    struct TICKET_5496 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5496(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5496>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5496>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5496, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5496>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5496>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5496>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5496>>(v5, 0x2::tx_context::sender(arg1));
    }
