module 0xa3ce4718dbcd374c630bf0afd9192e3d986f7711b38ae247fa4b2f972ad97078::cnsnft6462 {
    struct CNSNFT6462 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6462, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6462>(arg0, arg1);
