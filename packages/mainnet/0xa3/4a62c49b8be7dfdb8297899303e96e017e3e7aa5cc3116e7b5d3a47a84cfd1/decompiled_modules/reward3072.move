module 0xa34a62c49b8be7dfdb8297899303e96e017e3e7aa5cc3116e7b5d3a47a84cfd1::reward3072 {
    struct REWARD3072 has drop {
        dummy_field: bool,
    }

    struct TICKET_3072 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3072(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3072>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3072>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3072, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3072>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3072>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3072>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3072>>(v5, 0x2::tx_context::sender(arg1));
    }
