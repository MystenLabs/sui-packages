module 0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::nft {
    ...
    public fun get_halving_nonce(arg0: &mut GameData) : u64 {
        if (0x1::vector::length<u64>(&arg0.extra_data) == 3) {
            0x1::vector::push_back<u64>(&mut arg0.extra_data, 1);
        };
        let v0 = calculate_halving_nonce(arg0);
        if (v0 > *0x1::vector::borrow<u64>(&arg0.extra_data, 3)) {
            *0x1::vector::borrow_mut<u64>(&mut arg0.extra_data, 3) = v0;
        };
        v0
    }
