module 0xa35b22a23fdc6ec69b67d75f0b9514cdf1b182ab68d12ab9f2f16787ba8e9b0a::registry {
    ...
    public(friend) fun add(arg0: u16, arg1: 0x2::object::ID, arg2: &mut Registry) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg2.pfps) as u16) == 0xa35b22a23fdc6ec69b67d75f0b9514cdf1b182ab68d12ab9f2f16787ba8e9b0a::collection::size()) {
            arg2.is_initialized = true;
        };
    }

    public fun admin_freeze_registry(arg0: &0xa35b22a23fdc6ec69b67d75f0b9514cdf1b182ab68d12ab9f2f16787ba8e9b0a::admin::AdminCap, arg1: Registry, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun pfp_id_from_number(arg0: u16, arg1: &Registry) : 0x2::object::ID {
        assert!(arg0 >= 1 && arg0 <= 0xa35b22a23fdc6ec69b67d75f0b9514cdf1b182ab68d12ab9f2f16787ba8e9b0a::collection::size(), 1);
