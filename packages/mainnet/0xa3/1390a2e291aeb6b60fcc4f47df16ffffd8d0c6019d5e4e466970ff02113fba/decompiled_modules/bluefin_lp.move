module 0x80cc0b607ac71dc2c4e33f36096fcb0bf9c43586a474fcd8cb30acc59361818b::bluefin_lp {
    ...
    public fun delete_vault<T0, T1>(arg0: &AdminCap, arg1: &BluefinLPTreasury, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: &mut BluefinLPVault, arg5: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert_valid_package_version(arg1);
        let v0 = &mut arg4.position;
        let (v1, v2, v3, v4) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::remove_liquidity<T0, T1>(arg2, arg3, v0, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::liquidity(v0), arg5);
        let v5 = DestroyVault<T0, T1>{
            vault_id  : 0x2::object::uid_to_inner(&mut arg4.id),
            pool_id   : 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg3),
            removal_a : v1,
            removal_b : v2,
        };
        0x2::event::emit<DestroyVault<T0, T1>>(v5);
        (v3, v4)
    }

    public fun deposit<T0, T1>(arg0: &mut BluefinLPTreasury, arg1: &mut BluefinLPVault, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: u128, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: u64, arg8: bool, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<BLUEFIN_LP>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert_valid_package_version(arg0);
        let v0 = liquidity_to_bluefin_lp_amount(arg1, arg4);
        let v1 = mint(arg0, arg1, v0, arg10);
        let (v2, v3, v4, v5) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity_with_fixed_amount<T0, T1>(arg9, arg2, arg3, &mut arg1.position, 0x2::coin::into_balance<T0>(arg5), 0x2::coin::into_balance<T1>(arg6), arg7, arg8);
        let v6 = Deposit<T0, T1>{
            vault_id          : 0x2::object::id<BluefinLPVault>(arg1),
            amount_a          : v2,
            amount_b          : v3,
            bluefin_lp_amount : v0,
        };
