module 0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::dao_vault {
    ...
    struct TotalValueLocked has copy, drop {
        pos0: u64,
    }
    ...
    public fun add_deposit_coin<T0>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg2, &v0), 22);
        process_add_deposit_coin<T0>(arg0);
    }

    public fun add_swap_coin<T0>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg2, &v0), 22);
    ...
    public fun batch_add_swap_tokens<T0, T1, T2, T3, T4>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg3: u8) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        ...
        if (arg3 >= 2) {
            ...
            assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg2, &v1), 22);
            process_add_swap_coin<T1>(arg0, v1);
        };
        if (arg3 >= 3) {
            let v2 = 0x1::type_name::into_string(0x1::type_name::get<T2>());
            assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg2, &v2), 22);
            process_add_swap_coin<T2>(arg0, v2);
        };
        if (arg3 >= 4) {
            let v3 = 0x1::type_name::into_string(0x1::type_name::get<T3>());
            assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg2, &v3), 22);
            process_add_swap_coin<T3>(arg0, v3);
        };
        if (arg3 >= 5) {
            let v4 = 0x1::type_name::into_string(0x1::type_name::get<T4>());
            assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg2, &v4), 22);
            process_add_swap_coin<T4>(arg0, v4);
        };
    }

    public fun batch_add_tokens<T0, T1, T2, T3, T4>(arg0: &mut Vault, arg1: &ManagerCap, arg2: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg3: u8) {
        assert!(arg1.vault_id == 0x2::object::id<Vault>(arg0), 5);
        assert!(arg3 >= 1 && arg3 <= 5, 2);
        if (arg3 >= 1) {
            let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
    ...
    fun calculate_and_collect_performance_fee(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v0 = arg3 * (arg1 - arg2) * arg0.performance_fee_bps / 10000 / arg2;
        if (v0 > 0) {
    ...
    fun calculate_protocol_fee(arg0: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg1: u64) : u64 {
        arg1 * 0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::get_protocol_fee(arg0) / 10000
    }

    public fun calculate_total_value_locked_in_usd<T0>(arg0: &Vault, arg1: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg2: &mut TotalValueLockedCalculation, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock) {
        let v0 = 0x1::vector::pop_back<0x1::ascii::String>(&mut arg2.remaining_coins);
        arg2.value = arg2.value + 0x2::balance::value<T0>(0x2::bag::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.balance_storage, v0)) * 0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::price::usd_price(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::get_price_feed_id(arg1, &v0), arg4, arg5) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg3));
    }
    ...
    public fun deposit_coin<T0>(arg0: &mut Vault, arg1: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg2: TotalValueLocked, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: 0x2::coin::Coin<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.support_all_registry_tokens) {
            assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg1, &v1), 22);
        ...
        let v3 = usd_to_shares(arg0, arg2, v0 * 0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::price::usd_price(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::get_price_feed_id(arg1, &v1), arg4, arg5) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg3)));
        assert!(v3 > 0, 2);
    ...
    public fun execute_withdrawal<T0>(arg0: &mut Vault, arg1: &mut Withdrawal, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) >= arg1.unlock_time, 23);
        let v0 = arg1.lp_value;
        let v1 = 0x2::balance::value<T0>(balance<T0>(arg0)) * v0 * 100 / total_shares(arg0) / 100;
    ...
    public fun finalize_withdrawal(arg0: &mut Vault, arg1: Withdrawal, arg2: &mut 0x2::tx_context::TxContext) {
        let Withdrawal {
            id          : v0,
            vault_id    : v1,
            position_id : v2,
        ...
        burn_lp(arg0, v2, v3, arg2);
        while (!0x1::vector::is_empty<0x1::ascii::String>(&v7)) {
            0x1::vector::pop_back<0x1::ascii::String>(&mut v7);
        };
        0x1::vector::destroy_empty<0x1::ascii::String>(v7);
        0x2::object::delete(v0);
    }

    public fun flashloan_for_swap<T0>(arg0: &mut Vault, arg1: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg2: &ManagerCap, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanForSwap) {
        assert!(arg5 > 0, 2);
        assert!(arg2.vault_id == 0x2::object::id<Vault>(arg0), 5);
        assert!(!arg0.paused, 1);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        if (arg0.support_all_registry_tokens) {
            assert!(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::is_token_allowed(arg1, &v0), 22);
        ...
        let v1 = arg5 * 0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::price::usd_price(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::get_price_feed_id(arg1, &v0), arg4, arg6) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg3));
    ...
    public fun initiate_withdrawal(arg0: &mut Vault, arg1: 0x2::object::ID, arg2: TotalValueLocked, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Withdrawal {
        assert!(!arg0.paused, 1);
        let v0 = get_position(arg0, arg1);
        assert!(v0.owner == 0x2::tx_context::sender(arg4), 34);
        let v1 = v0.amount;
        let v2 = calculate_lp_token_price(arg0, &arg2);
        let v3 = calculate_and_collect_performance_fee(arg0, v2, v0.entry_price, v1, arg4);
        Withdrawal{
            ...
            unlock_time : 0x2::clock::timestamp_ms(arg3) + 7200000,
            fee_amount  : v3,
        }
    }
    ...
    public fun return_flashloan_from_swap<T0>(arg0: &mut Vault, arg1: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: FlashLoanForSwap, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::coin::value<T0>(&arg5) * 0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::price::usd_price(0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::get_price_feed_id(arg1, &v3), arg3, arg6) / 0x1::u64::pow(10, 0x2::coin::get_decimals<T0>(arg2));
    ...
    public fun withdraw_protocol_fees<T0>(arg0: &mut Vault, arg1: &0xa3f9fd6b764e65a378336674f2a78b924e0d1c868f9380099a255d9c07264837::protocol_config::ProtocolConfig, arg2: &Guardian, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
