module 0xa3523fab9fdbb693f48a1b2e23a4fc8805ec5d180c0f510a8540dd12f05f5210::cnsnft8642 {
    struct CNSNFT8642 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8642, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8642>(arg0, arg1);
