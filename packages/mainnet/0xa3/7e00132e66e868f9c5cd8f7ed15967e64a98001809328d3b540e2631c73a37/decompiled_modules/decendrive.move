module 0x96458b85b6b653a17ccf01f2c5691824e7177be2069d299737451ab657ead362::decendrive {
    ...
    struct DriveProfile has store, key {
        id: 0x2::object::UID,
        owner: address,
        state_blob_id: 0x1::string::String,
        state_version: u64,
        updated_at: u64,
    }
    ...
    public entry fun create_drive_profile(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg0);
        let v1 = DriveProfile{
            id            : 0x2::object::new(arg0),
            owner         : v0,
            state_blob_id : 0x1::string::utf8(b""),
            state_version : 0,
            updated_at    : 0,
        };
        0x2::transfer::public_transfer<DriveProfile>(v1, v0);
    }
    ...
    public entry fun register_file(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = FileRegisteredEvent{
            file_id     : 0x2::object::id<File>(&v1),
            blob_id     : v1.blob_id,
            owner       : v0,
            uploaded_at : arg2,
        };
        0x2::event::emit<FileRegisteredEvent>(v2);
    ...
    public entry fun update_drive_state(arg0: &mut DriveProfile, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg4), 1);
        arg0.state_blob_id = arg1;
        arg0.state_version = arg2;
