module 0xa3f0c5ce91f3818c2a11a3b358ca4379902edeb7e76317f6b498d350c0599234::fee_manager {
    ...
    public fun is_verified(arg0: &PlatformConfig, arg1: 0x1::type_name::TypeName) : bool {
        0x2::table::contains<0x1::type_name::TypeName, CollectionConfig>(&arg0.registry, arg1) && 0x2::table::borrow<0x1::type_name::TypeName, CollectionConfig>(&arg0.registry, arg1).is_verified
    }
    ...
    public fun withdraw_fees(arg0: &AdminCap, arg1: &mut PlatformConfig, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.fees_collected, arg2), arg3), v0);
