module 0xa3c374d1d496bd3b600578757aab6ade03463933d364f2d0b5ec532d8f1ece09::walrus_meme {
    struct WALRUS_MEME has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WALRUS_MEME, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WALRUS_MEME>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Walrus Meme"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Walruscan is a block explorer and analytics platform for Walrus - a decentralized data storage and availability protocol developed by Mysten Labs."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifcqotnjqnnujgmathaa53shovsrb2ersep7zyg7j6eclwhys34mu"));
