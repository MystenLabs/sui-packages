module 0xa3156663b8e8d9c2c5e8c4ad155b895749c40f11aa10133e7e2ebc99ac9d5648::swap_fees {
    ...
    public fun take_fee_on_sui_out(arg0: &mut Fees, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, v0 - v0 * 100 / 10000, arg2), 0x2::tx_context::sender(arg2));
    }
