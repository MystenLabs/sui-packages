module 0xa315d8223138a58fc8e32d62099197df5940c2c0ec49862be40d4cf220570469::tugo {
    ...
    fun init(arg0: TUGO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<TUGO>(&mut v2, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
