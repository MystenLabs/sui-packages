module 0xa3ddd17452216589d56639ecdc79fb1f4c0855181b807eb5ac38655da1ed918d::reward9070 {
    struct REWARD9070 has drop {
        dummy_field: bool,
    }

    struct TICKET_9070 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9070(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9070>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9070>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9070, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9070>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9070>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9070>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9070>>(v5, 0x2::tx_context::sender(arg1));
    }
