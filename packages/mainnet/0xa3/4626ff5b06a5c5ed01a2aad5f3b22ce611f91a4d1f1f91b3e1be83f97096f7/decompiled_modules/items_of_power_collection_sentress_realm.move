module 0xa34626ff5b06a5c5ed01a2aad5f3b22ce611f91a4d1f1f91b3e1be83f97096f7::items_of_power_collection_sentress_realm {
    struct ITEMS_OF_POWER_COLLECTION_SENTRESS_REALM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ITEMS_OF_POWER_COLLECTION_SENTRESS_REALM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ITEMS_OF_POWER_COLLECTION_SENTRESS_REALM>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Items of Power Collection-Sentress Realm"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Items of Power Collection features relics from across the sacred gardens, celestial corridors, and hidden sanctuaries of the Sentress Realm. Hold onto them to unlock special powers in upcoming games,alternate realms,hidden treasure chests or puzzle pathways secret transmissions and more."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://_NO0a7YsH3-FJwdAvB3sy886qw-44ArvHpzhrVvbL8g"));
