module 0xa3199e63a6faea7128454d5abaaf2674d0522906e5e2854405ed5c2e8b60fb95::xnft {
    ...
    struct XcetusManager has key {
        id: 0x2::object::UID,
        nfts: 0xa3199e63a6faea7128454d5abaaf2674d0522906e5e2854405ed5c2e8b60fb95::linked_table::LinkedTable<0x2::object::ID, RewardNftInfo>,
    }
    ...
    fun init(arg0: XNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = XcetusManager{
            ...
            nfts : 0xa3199e63a6faea7128454d5abaaf2674d0522906e5e2854405ed5c2e8b60fb95::linked_table::new<0x2::object::ID, RewardNftInfo>(arg1),
        };
    ...
    public fun mint(arg0: &mut XcetusManager, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xa3199e63a6faea7128454d5abaaf2674d0522906e5e2854405ed5c2e8b60fb95::linked_table::push_back<0x2::object::ID, RewardNftInfo>(&mut arg0.nfts, v1, v2);
    ...
    public fun nfts(arg0: &XcetusManager) : &0xa3199e63a6faea7128454d5abaaf2674d0522906e5e2854405ed5c2e8b60fb95::linked_table::LinkedTable<0x2::object::ID, RewardNftInfo> {
        &arg0.nfts
    }
