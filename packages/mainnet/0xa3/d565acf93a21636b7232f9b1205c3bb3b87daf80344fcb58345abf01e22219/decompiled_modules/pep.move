module 0xa3d565acf93a21636b7232f9b1205c3bb3b87daf80344fcb58345abf01e22219::pep {
    struct PEP has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PEP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/BKmYE8w1GEQ6khhLkvMj4ULvV4Gq7zLfJZSgsHE5pump.png?size=lg&key=1cfc1c                                                                                                                                                                                                            ");
