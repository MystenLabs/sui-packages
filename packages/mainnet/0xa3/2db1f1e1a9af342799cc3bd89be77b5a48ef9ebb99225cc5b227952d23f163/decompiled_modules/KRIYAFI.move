module 0xa32db1f1e1a9af342799cc3bd89be77b5a48ef9ebb99225cc5b227952d23f163::KRIYAFI {
    ...
    public entry fun RewardVoucher(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = KRIYAFI_VOUCHER{
                ...
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/kriya_0703/kriya_0703_0.jpg"),
    ...
    fun init(arg0: KRIYAFI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/kriya_0703/kriya_0703_0.jpg"));
