module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    fun auto_claim_resources(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : ResourceAmounts {
        ...
        if (v2 >= 300000) {
            consume_durability_for_production_tools(arg0, v0);
        };
    ...
    fun calculate_max_storage_caps_with_land_types_readonly(arg0: &StakingPool, arg1: &vector<LandInfo>, arg2: u128) : ResourceAmounts {
        ...
        while (v1 < 0x1::vector::length<LandInfo>(arg1)) {
            ...
            if (0x1::option::is_none<u64>(&v2.cooldown_ts)) {
                let v3 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Land Type");
                let v4 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Plot");
    ...
    fun calculate_user_storage_caps_with_land_types(arg0: &mut StakingPool, arg1: address) : ResourceAmounts {
        let v0 = get_tool_boost(arg0, &0x2::table::borrow<address, UserInfo>(&arg0.users, arg1).items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_wheelbarrow());
    ...
    public fun check_version(arg0: &StakingPool) {
        assert!(arg0.version == 8, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_version_mismatch());
    }
    ...
    fun compute_single_land_production(arg0: &StakingPool, arg1: 0x2::object::ID, arg2: u64, arg3: &0x1::option::Option<vector<u8>>) : ResourceAmounts {
        let (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) = if (0x1::option::is_some<vector<u8>>(arg3)) {
            ...
            let v15 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Wood");
            let v16 = get_attribute_or_default(v11, &v15, &v12);
            let v17 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Stone");
            let v18 = get_attribute_or_default(v11, &v17, &v12);
            let v19 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Water");
            let v20 = get_attribute_or_default(v11, &v19, &v12);
            let v21 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Coal");
            let v22 = get_attribute_or_default(v11, &v21, &v12);
            let v23 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Iron");
            let v24 = get_attribute_or_default(v11, &v23, &v12);
            let v25 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Gold");
            let v26 = get_attribute_or_default(v11, &v25, &v12);
            let v27 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Crystal");
            let v28 = get_attribute_or_default(v11, &v27, &v12);
            let v29 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Sky");
            let v30 = get_attribute_or_default(v11, &v29, &v13);
            let v31 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Soil");
            let v32 = get_attribute_or_default(v11, &v31, &v14);
            let v33 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Land Type");
            let v34 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Plot");
    ...
    fun compute_user_production_with_storage_boost_by_address(arg0: &mut StakingPool, arg1: address, arg2: u64, arg3: u64) : ResourceAmounts {
        ...
        let v12 = get_tool_boost(arg0, &v11.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_axe());
        let v13 = get_tool_boost(arg0, &v11.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_bucket());
        let v14 = get_tool_boost(arg0, &v11.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_pickaxe());
        let v15 = get_tool_boost(arg0, &v11.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_magic_siphon());
        let v16 = calculate_user_storage_caps_with_land_types(arg0, arg1);
        if (v12 > 10000) {
    ...
    fun compute_user_production_with_storage_boost_readonly(arg0: &StakingPool, arg1: &vector<LandInfo>, arg2: &vector<ItemInfo>, arg3: u64, arg4: address, arg5: u64) : ResourceAmounts {
        ...
        let v4 = get_tool_boost(arg0, arg2, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_axe());
        let v5 = get_tool_boost(arg0, arg2, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_bucket());
        let v6 = get_tool_boost(arg0, arg2, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_pickaxe());
        let v7 = get_tool_boost(arg0, arg2, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_magic_siphon());
        let v8 = calculate_max_storage_caps_with_land_types_readonly(arg0, arg1, get_tool_boost(arg0, arg2, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_wheelbarrow()));
        let v9 = 0;
        let v10 = 0;
        while (v10 < v1) {
    ...
    fun consume_durability_for_production_tools(arg0: &mut StakingPool, arg1: address) {
        let v0 = 0x2::table::borrow<address, UserInfo>(&arg0.users, arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<ItemInfo>(&v0.items)) {
            let v2 = 0x1::vector::borrow<ItemInfo>(&v0.items, v1);
            if (0x1::option::is_none<u64>(&v2.cooldown_ts) && 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::is_production_tool(v2.item_type)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::consume_durability(0x2::kiosk::borrow_mut<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&mut arg0.kiosk, &arg0.kiosk_owner_cap, v2.nft_id), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_durability_cost_auto_claim());
            };
            v1 = v1 + 1;
        };
    }

    fun consume_durability_for_urr_raffle(arg0: &mut StakingPool, arg1: address, arg2: u8) {
        let v0 = 0x2::table::borrow<address, UserInfo>(&arg0.users, arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<ItemInfo>(&v0.items)) {
            let v2 = 0x1::vector::borrow<ItemInfo>(&v0.items, v1);
            if (v2.item_type == arg2 && 0x1::option::is_none<u64>(&v2.cooldown_ts)) {
    ...
    public entry fun consume_gilded_prism(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0xdbdd4b81cddb13a01c074f9b912408a82c42cff31528c6cb61b9427162c56ee7::pawtato_coin_gilded_prism::PAWTATO_COIN_GILDED_PRISM>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::clock::timestamp_ms(arg3) + 604800000;
        let v2 = 1;
        let v3 = GildedPrismBoost{
            expires_at : v1,
            level      : v2,
        };
        let v4 = user_address_to_gilded_prism_key(v0);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v4)) {
            0x2::dynamic_field::remove<vector<u8>, GildedPrismBoost>(&mut arg0.id, v4);
        };
        0x2::dynamic_field::add<vector<u8>, GildedPrismBoost>(&mut arg0.id, v4, v3);
        let v5 = MaterialConsumed{
            user             : v0,
            material         : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xdbdd4b81cddb13a01c074f9b912408a82c42cff31528c6cb61b9427162c56ee7::pawtato_coin_gilded_prism::PAWTATO_COIN_GILDED_PRISM>(),
            boost_expires_at : v1,
            level            : v2,
        };
        0x2::event::emit<MaterialConsumed>(v5);
    }
    ...
    public entry fun consume_primal_loam(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0xcc1bc09171bf5cff318ffa804077cbd47504d9ae0f2436d248dc6b9edc4556e4::pawtato_coin_primal_loam::PAWTATO_COIN_PRIMAL_LOAM>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::clock::timestamp_ms(arg3) + 259200000;
        let v2 = 1;
        let v3 = PrimalLoamBoost{
            expires_at : v1,
            level      : v2,
        };
        let v4 = user_address_to_primal_loam_key(v0);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, v4)) {
            0x2::dynamic_field::remove<vector<u8>, PrimalLoamBoost>(&mut arg0.id, v4);
        };
        0x2::dynamic_field::add<vector<u8>, PrimalLoamBoost>(&mut arg0.id, v4, v3);
        let v5 = MaterialConsumed{
            user             : v0,
            material         : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xcc1bc09171bf5cff318ffa804077cbd47504d9ae0f2436d248dc6b9edc4556e4::pawtato_coin_primal_loam::PAWTATO_COIN_PRIMAL_LOAM>(),
            boost_expires_at : v1,
            level            : v2,
        };
        0x2::event::emit<MaterialConsumed>(v5);
        ...
        if (0x2::dynamic_field::exists_<0x2::object::ID>(&arg0.id, arg1)) {
            ...
            if (0x1::vector::length<u8>(v1) > 9) {
                *v1
                ...
                let v4 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Land Type");
            ...
            let v12 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Wood");
            let v13 = get_attribute_or_default(v6, &v12, &v7);
            0x1::vector::push_back<u8>(&mut v11, string_to_size_enum_u8(&v13));
            let v14 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Stone");
            let v15 = get_attribute_or_default(v6, &v14, &v7);
            0x1::vector::push_back<u8>(&mut v11, string_to_size_enum_u8(&v15));
            let v16 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Water");
            let v17 = get_attribute_or_default(v6, &v16, &v7);
            0x1::vector::push_back<u8>(&mut v11, string_to_size_enum_u8(&v17));
            let v18 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Coal");
            let v19 = get_attribute_or_default(v6, &v18, &v7);
            0x1::vector::push_back<u8>(&mut v11, string_to_size_enum_u8(&v19));
            let v20 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Iron");
            let v21 = get_attribute_or_default(v6, &v20, &v7);
            0x1::vector::push_back<u8>(&mut v11, string_to_size_enum_u8(&v21));
            let v22 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Gold");
            let v23 = get_attribute_or_default(v6, &v22, &v7);
            0x1::vector::push_back<u8>(&mut v11, string_to_size_enum_u8(&v23));
            let v24 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Crystal");
            let v25 = get_attribute_or_default(v6, &v24, &v7);
            0x1::vector::push_back<u8>(&mut v11, string_to_size_enum_u8(&v25));
            let v26 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Sky");
            let v27 = get_attribute_or_default(v6, &v26, &v8);
            0x1::vector::push_back<u8>(&mut v11, string_to_sky_enum_u8(&v27));
            let v28 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Soil");
            let v29 = get_attribute_or_default(v6, &v28, &v9);
            0x1::vector::push_back<u8>(&mut v11, string_to_soil_enum_u8(&v29));
            let v30 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Land Type");
    ...
    fun get_plot_lands_without_cooldown_count(arg0: &StakingPool, arg1: &vector<LandInfo>) : u128 {
        ...
        while (v1 < 0x1::vector::length<LandInfo>(arg1)) {
            ...
            if (0x1::option::is_none<u64>(&v2.cooldown_ts)) {
                let v3 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Land Type");
                let v4 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Plot");
                if (get_attribute_or_default(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato::get_attributes(0x2::kiosk::borrow<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato::LAND>(&arg0.kiosk, &arg0.kiosk_owner_cap, v2.nft_id)), &v3, &v4) == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::utf8(b"Plot")) {
                    v0 = v0 + 1;
                };
            };
            v1 = v1 + 1;
    ...
    fun get_tool_boost(arg0: &StakingPool, arg1: &vector<ItemInfo>, arg2: u8) : u128 {
        ...
        while (v1 < v0) {
            ...
            if (v2.item_type == arg2 && 0x1::option::is_none<u64>(&v2.cooldown_ts)) {
                return if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_wheelbarrow()) {
                    (0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_storage_multiplier(0x2::kiosk::borrow<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&arg0.kiosk, &arg0.kiosk_owner_cap, v2.nft_id)) as u128)
                } else if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_idol_of_axomamma()) {
                    (0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_idol_raffle_multiplier(0x2::kiosk::borrow<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&arg0.kiosk, &arg0.kiosk_owner_cap, v2.nft_id)) as u128)
                } else if (v2.item_type == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_shovel()) {
                    (0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_shovel_urr_chance(0x2::kiosk::borrow<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&arg0.kiosk, &arg0.kiosk_owner_cap, v2.nft_id)) as u128)
                } else {
                    (0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_prod_mul(0x2::kiosk::borrow<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(&arg0.kiosk, &arg0.kiosk_owner_cap, v2.nft_id)) as u128)
                }
            };
            v1 = v1 + 1;
        };
    ...
    public fun get_user_dashboard_info(arg0: &StakingPool, arg1: address, arg2: &0x2::clock::Clock) : UserDashboardInfo {
        ...
        UserDashboardInfo{
            storage_caps               : calculate_max_storage_caps_with_land_types_readonly(arg0, &v0.lands, get_tool_boost(arg0, &v0.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_wheelbarrow())),
    ...
    fun has_active_gilded_prism_boost(arg0: &StakingPool, arg1: address, arg2: u64) : bool {
        let v0 = user_address_to_gilded_prism_key(arg1);
    ...
    fun has_active_primal_loam_boost(arg0: &StakingPool, arg1: address, arg2: u64) : bool {
        let v0 = user_address_to_primal_loam_key(arg1);
    ...
    fun maybe_raffle(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::table::borrow<address, UserInfo>(&arg0.users, v0);
        let (v2, v3, v4, v5, v6, v7) = if (arg2 < v1.last_raffle_ts + 86400000) {
            (false, 0, 10000, 0, 0, 0)
        } else {
            let v8 = get_plot_lands_without_cooldown_count(arg0, &v1.lands);
            let v9 = get_tool_boost(arg0, &v1.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_idol_of_axomamma());
            let v10 = get_tool_boost(arg0, &v1.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_shovel());
        ...
        if (v4 > 10000) {
            consume_durability_for_urr_raffle(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_idol_of_axomamma());
        };
        if (v5 > 0) {
            consume_durability_for_urr_raffle(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_type_shovel());
        };
        ...
        if (v15 < v18) {
            ...
            0x1::vector::push_back<0x1::string::String>(&mut v23, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x6e82bb8cbed21683ac0109171135b4d75187fc74749593163f3dc426ef3b32b4::pawtato_coin_phoenix_feather::PAWTATO_COIN_PHOENIX_FEATHER>());
            let v24 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v24, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v21));
            ...
            0x1::vector::push_back<0x1::string::String>(&mut v28, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x30021448e6d54825ced6d2b73f3b763a0da8a28c1c42fd6f0b864323ac60ab45::pawtato_coin_titanium_splinter::PAWTATO_COIN_TITANIUM_SPLINTER>());
            let v29 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v29, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v26));
            ...
            0x1::vector::push_back<0x1::string::String>(&mut v33, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xecc04712d7513fe9e9b27bb7366ded7c0acc78746c06276bc9fe8d17fc14061f::pawtato_coin_chaos_seed::PAWTATO_COIN_CHAOS_SEED>());
            let v34 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v34, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v31));
            ...
            if (v15 < v36 + v5 * v3 * v4 / 10000 / 2) {
                ...
                let v38 = WonRareResource{
                    user     : 0x2::tx_context::sender(arg4),
                    resource : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xaf5981f9bee15d210e25f2933671ed587a810ed8cb8819d05fa967f2d4913ff::pawtato_coin_dawnstone::PAWTATO_COIN_DAWNSTONE>(),
                    amount   : (v37 as u64),
                    roll     : v15,
                };
                0x2::event::emit<WonRareResource>(v38);
                let v39 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v39, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xaf5981f9bee15d210e25f2933671ed587a810ed8cb8819d05fa967f2d4913ff::pawtato_coin_dawnstone::PAWTATO_COIN_DAWNSTONE>());
                let v40 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v40, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v37));
                ...
                let v43 = WonRareResource{
                    user     : 0x2::tx_context::sender(arg4),
                    resource : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xcc1bc09171bf5cff318ffa804077cbd47504d9ae0f2436d248dc6b9edc4556e4::pawtato_coin_primal_loam::PAWTATO_COIN_PRIMAL_LOAM>(),
                    amount   : (v42 as u64),
                    roll     : v15,
                };
                0x2::event::emit<WonRareResource>(v43);
                let v44 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v44, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xcc1bc09171bf5cff318ffa804077cbd47504d9ae0f2436d248dc6b9edc4556e4::pawtato_coin_primal_loam::PAWTATO_COIN_PRIMAL_LOAM>());
                let v45 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v45, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v42));
    ...
    fun mint_resource(arg0: &StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: u8, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_wood()) {
            ...
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::transfer_dawnstone_new(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_dawnstone_new(arg1, 0x2::object::id<StakingPool>(arg0), (arg3 as u64), arg4), 0x2::tx_context::sender(arg4));
            ...
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::transfer_primal_loam_new(0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::mint_primal_loam_new(arg1, 0x2::object::id<StakingPool>(arg0), (arg3 as u64), arg4), 0x2::tx_context::sender(arg4));
        };
    }
    ...
    public entry fun unlock_advanced_blacksmithing(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0xe1b0d1a2c2eebaf6dd20a1fd88c4f89fdb3d34774722d30f672b074cffee8182::pawtato_coin_iron_bar::PAWTATO_COIN_IRON_BAR>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        check_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(get_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_blacksmithing()) == 0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_upgrade_already_purchased());
        validate_and_consume_coin<0xe1b0d1a2c2eebaf6dd20a1fd88c4f89fdb3d34774722d30f672b074cffee8182::pawtato_coin_iron_bar::PAWTATO_COIN_IRON_BAR>(arg1, arg2, 1000000000000, arg3);
        set_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_blacksmithing(), 1, arg3);
        let v1 = SlotUpgraded{
            user      : v0,
            category  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_blacksmithing(),
            new_level : 1,
            resource  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xe1b0d1a2c2eebaf6dd20a1fd88c4f89fdb3d34774722d30f672b074cffee8182::pawtato_coin_iron_bar::PAWTATO_COIN_IRON_BAR>(),
            cost      : 1000000000000,
        };
    ...
    public entry fun unlock_advanced_masonry(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0x3249eeffb225547af777a21ecc4a084fea1e90fc8f4fe34caf0a62a4fa4a3e46::pawtato_coin_stone_block::PAWTATO_COIN_STONE_BLOCK>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        check_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(get_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_masonry()) == 0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_upgrade_already_purchased());
        validate_and_consume_coin<0x3249eeffb225547af777a21ecc4a084fea1e90fc8f4fe34caf0a62a4fa4a3e46::pawtato_coin_stone_block::PAWTATO_COIN_STONE_BLOCK>(arg1, arg2, 1000000000000, arg3);
        set_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_masonry(), 1, arg3);
        let v1 = SlotUpgraded{
            user      : v0,
            category  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_masonry(),
            new_level : 1,
            resource  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x3249eeffb225547af777a21ecc4a084fea1e90fc8f4fe34caf0a62a4fa4a3e46::pawtato_coin_stone_block::PAWTATO_COIN_STONE_BLOCK>(),
            cost      : 1000000000000,
        };
        0x2::event::emit<SlotUpgraded>(v1);
    }
    ...
    public entry fun unlock_advanced_woodworking(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0x8c683dd440007891ca76e883c80f3ee94141ab11d80028b20b97f62043db6dab::pawtato_coin_wooden_plank::PAWTATO_COIN_WOODEN_PLANK>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        check_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(get_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_woodworking()) == 0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_upgrade_already_purchased());
        validate_and_consume_coin<0x8c683dd440007891ca76e883c80f3ee94141ab11d80028b20b97f62043db6dab::pawtato_coin_wooden_plank::PAWTATO_COIN_WOODEN_PLANK>(arg1, arg2, 1000000000000, arg3);
        set_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_woodworking(), 1, arg3);
        let v1 = SlotUpgraded{
            user      : v0,
            category  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_advanced_woodworking(),
            new_level : 1,
            resource  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x8c683dd440007891ca76e883c80f3ee94141ab11d80028b20b97f62043db6dab::pawtato_coin_wooden_plank::PAWTATO_COIN_WOODEN_PLANK>(),
            cost      : 1000000000000,
        };
        0x2::event::emit<SlotUpgraded>(v1);
    }
    ...
    public entry fun upgrade_misc_slots_stone_blocks(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0x3249eeffb225547af777a21ecc4a084fea1e90fc8f4fe34caf0a62a4fa4a3e46::pawtato_coin_stone_block::PAWTATO_COIN_STONE_BLOCK>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        check_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(get_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous()) == 0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_upgrade_already_purchased());
        validate_and_consume_coin<0x3249eeffb225547af777a21ecc4a084fea1e90fc8f4fe34caf0a62a4fa4a3e46::pawtato_coin_stone_block::PAWTATO_COIN_STONE_BLOCK>(arg1, arg2, 1000000000000, arg3);
        set_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous(), 1, arg3);
        let v1 = SlotUpgraded{
            user      : v0,
            category  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous(),
            new_level : 1,
            resource  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x3249eeffb225547af777a21ecc4a084fea1e90fc8f4fe34caf0a62a4fa4a3e46::pawtato_coin_stone_block::PAWTATO_COIN_STONE_BLOCK>(),
            cost      : 1000000000000,
        };
    ...
    public entry fun upgrade_misc_slots_water(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0xdbc712df0c412a0fcd6d4aec441e9748d05a0db16ff1fbdb04aa233a9eda454d::pawtato_coin_water::PAWTATO_COIN_WATER>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        check_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(get_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous()) == 2, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_upgrade_prerequisite_not_met());
        validate_and_consume_coin<0xdbc712df0c412a0fcd6d4aec441e9748d05a0db16ff1fbdb04aa233a9eda454d::pawtato_coin_water::PAWTATO_COIN_WATER>(arg1, arg2, 1000000000000, arg3);
        set_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous(), 3, arg3);
        let v1 = SlotUpgraded{
            user      : v0,
            category  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous(),
            new_level : 3,
            resource  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xdbc712df0c412a0fcd6d4aec441e9748d05a0db16ff1fbdb04aa233a9eda454d::pawtato_coin_water::PAWTATO_COIN_WATER>(),
            cost      : 1000000000000,
        };
        0x2::event::emit<SlotUpgraded>(v1);
    }
    ...
    public entry fun upgrade_misc_slots_wooden_planks(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: 0x2::coin::Coin<0x8c683dd440007891ca76e883c80f3ee94141ab11d80028b20b97f62043db6dab::pawtato_coin_wooden_plank::PAWTATO_COIN_WOODEN_PLANK>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        check_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(get_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous()) == 1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_upgrade_prerequisite_not_met());
        validate_and_consume_coin<0x8c683dd440007891ca76e883c80f3ee94141ab11d80028b20b97f62043db6dab::pawtato_coin_wooden_plank::PAWTATO_COIN_WOODEN_PLANK>(arg1, arg2, 1000000000000, arg3);
        set_user_category_upgrade_level(arg0, v0, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous(), 2, arg3);
        let v1 = SlotUpgraded{
            user      : v0,
            category  : 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous(),
            new_level : 2,
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 8, 13906836772798595071);
        arg1.version = 8;
    ...
    fun user_address_to_boost_key(arg0: address, arg1: vector<u8>) : vector<u8> {
        0x1::vector::append<u8>(&mut arg1, 0x1::bcs::to_bytes<address>(&arg0));
        arg1
    }

    fun user_address_to_gilded_prism_key(arg0: address) : vector<u8> {
        user_address_to_boost_key(arg0, b"gilded_prism_boost")
    }

    fun user_address_to_primal_loam_key(arg0: address) : vector<u8> {
        user_address_to_boost_key(arg0, b"primal_loam_boost")
    }
