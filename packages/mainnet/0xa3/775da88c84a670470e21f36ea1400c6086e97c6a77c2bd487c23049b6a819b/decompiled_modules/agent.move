module 0xa3775da88c84a670470e21f36ea1400c6086e97c6a77c2bd487c23049b6a819b::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"LOL", b"lolo", b"SSSSSSSSSSSSSSSSSSSSSSSSSS", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suiagents-image-store.s3.amazonaws.com/uploads/5e6366bd4087432f979a28bdc73154f5.webp")), arg1);
