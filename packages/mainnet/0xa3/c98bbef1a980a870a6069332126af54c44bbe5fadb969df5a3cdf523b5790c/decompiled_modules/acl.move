module 0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::acl {
    struct ACL has store {
        permissions: 0x2::vec_map::VecMap<address, u128>,
    }

    public fun add_role(arg0: &mut ACL, arg1: address, arg2: u8) {
        assert!(arg2 < 128, 0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::error::invalid_argument(0));
