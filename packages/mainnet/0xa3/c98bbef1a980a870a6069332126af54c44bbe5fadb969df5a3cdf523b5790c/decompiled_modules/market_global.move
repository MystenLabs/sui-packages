module 0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::market_global {
    struct MarketFactoryConfig has key {
        id: 0x2::object::UID,
        treasury: address,
        reserveFeePercent: 0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::fixed_point64::FixedPoint64,
    ...
    public fun get_reserve_fee_percent(arg0: &MarketFactoryConfig) : 0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::fixed_point64::FixedPoint64 {
    ...
    public fun init_config(arg0: u128, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::fixed_point64::less_or_equal(v0, 0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::fixed_point64::create_from_rational(1, 1)), 0xa3c98bbef1a980a870a6069332126af54c44bbe5fadb969df5a3cdf523b5790c::error::market_factory_reserve_fee_too_high());
