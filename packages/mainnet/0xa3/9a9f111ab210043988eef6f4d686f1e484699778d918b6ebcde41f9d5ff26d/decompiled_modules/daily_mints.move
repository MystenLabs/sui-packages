module 0xa39a9f111ab210043988eef6f4d686f1e484699778d918b6ebcde41f9d5ff26d::daily_mints {
    ...
    public(friend) fun record_mint_activity(arg0: &mut DailyMints, arg1: address, arg2: u8, arg3: &0x2::clock::Clock) {
        if (arg2 == 1) {
    ...
    public(friend) fun try_claim_global_reward(arg0: &mut DailyMints, arg1: address, arg2: &0x2::clock::Clock) : bool {
