module 0xa39a9f111ab210043988eef6f4d686f1e484699778d918b6ebcde41f9d5ff26d::tvyn {
    ...
    public entry fun create_and_share_mint_vault(arg0: 0x2::coin::TreasuryCap<TVYN>, arg1: &mut 0xa39a9f111ab210043988eef6f4d686f1e484699778d918b6ebcde41f9d5ff26d::config_registry::Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MintVault{
            id  : 0x2::object::new(arg2),
            cap : arg0,
        };
        0xa39a9f111ab210043988eef6f4d686f1e484699778d918b6ebcde41f9d5ff26d::config_registry::set_mint_vault_id(arg1, 0x2::object::id<MintVault>(&v0));
