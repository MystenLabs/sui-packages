module 0xa3200e269e69ebc815dec866b51e0bac700cd9e1bcf252af50572559d00b125a::trader {
    ...
    public entry fun mint(arg0: &mut 0xa3200e269e69ebc815dec866b51e0bac700cd9e1bcf252af50572559d00b125a::config::GlobalConfig, arg1: &mut HostController, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun rename(arg0: &0xa3200e269e69ebc815dec866b51e0bac700cd9e1bcf252af50572559d00b125a::config::GlobalConfig, arg1: 0xd22b24490e0bae52676651b4f56660a5ff8022a2576e0089f79b3c88d44e08f0::suins_registration::SuinsRegistration, arg2: &mut Trader, arg3: &mut 0x2::tx_context::TxContext) {
        0xa3200e269e69ebc815dec866b51e0bac700cd9e1bcf252af50572559d00b125a::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun updatePfp(arg0: &0xa3200e269e69ebc815dec866b51e0bac700cd9e1bcf252af50572559d00b125a::config::GlobalConfig, arg1: &mut Trader, arg2: 0x1::string::String, arg3: 0x1::string::String) {
        0xa3200e269e69ebc815dec866b51e0bac700cd9e1bcf252af50572559d00b125a::config::assert_if_version_not_matched(arg0, 1);
        arg1.pfp_img = arg2;
        arg1.card_img = arg3;
        let v0 = UpdatePFP{
    ...
    public fun withdraw(arg0: &0xa3200e269e69ebc815dec866b51e0bac700cd9e1bcf252af50572559d00b125a::config::AdminCap, arg1: &mut HostController, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
