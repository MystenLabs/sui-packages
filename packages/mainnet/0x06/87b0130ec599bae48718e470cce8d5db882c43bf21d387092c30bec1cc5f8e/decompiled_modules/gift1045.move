module 0x687b0130ec599bae48718e470cce8d5db882c43bf21d387092c30bec1cc5f8e::gift1045 {
    struct GIFT1045 has drop {
        dummy_field: bool,
    }

    struct TICKET_1045 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1045(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1045>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1045>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1045, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1045>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1045>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1045>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1045>>(v5, 0x2::tx_context::sender(arg1));
    }
