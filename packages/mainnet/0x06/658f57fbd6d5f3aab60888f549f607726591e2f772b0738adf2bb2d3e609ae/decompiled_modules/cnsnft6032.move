module 0x6658f57fbd6d5f3aab60888f549f607726591e2f772b0738adf2bb2d3e609ae::cnsnft6032 {
    struct CNSNFT6032 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6032, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6032>(arg0, arg1);
