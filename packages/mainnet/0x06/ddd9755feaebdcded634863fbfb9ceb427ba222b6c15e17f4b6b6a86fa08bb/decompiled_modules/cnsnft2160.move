module 0x6ddd9755feaebdcded634863fbfb9ceb427ba222b6c15e17f4b6b6a86fa08bb::cnsnft2160 {
    struct CNSNFT2160 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2160, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2160>(arg0, arg1);
