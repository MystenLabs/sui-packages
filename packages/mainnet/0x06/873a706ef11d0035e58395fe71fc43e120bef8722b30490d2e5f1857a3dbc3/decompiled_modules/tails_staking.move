module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking {
    ...
    entry fun claim_profit_sharing<T0>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::dynamic_field::exists_<vector<u8>>(registry_uid(arg0), b"nft_extension"), 0);
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, NftExtension>(registry_mut_uid(arg0), b"nft_extension");
        let v1 = 0x2::object_table::borrow_mut<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut v0.nft_table, 0x2::tx_context::sender(arg1));
        let v2 = 0x2::dynamic_field::borrow_mut<0x1::string::String, ProfitSharing<T0>>(&mut v0.id, 0x1::string::utf8(b"dice_profit_sharing"));
        assert!(0x2::balance::value<T0>(&v2.pool) == v2.remaining, 7);
        let v3 = 0;
        if (!0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::contains_u64_padding(&v0.nft_manager_cap, v1, 0x1::string::utf8(b"dice_profit"))) {
            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::insert_u64_padding(&v0.nft_manager_cap, v1, 0x1::string::utf8(b"dice_profit"), 0);
        } else {
            v3 = 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::get_u64_padding(&v0.nft_manager_cap, v1, 0x1::string::utf8(b"dice_profit"));
            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::update_u64_padding(&v0.nft_manager_cap, v1, 0x1::string::utf8(b"dice_profit"), 0);
        };
        v2.remaining = v2.remaining - v3;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v2.pool, v3), arg1), 0x2::tx_context::sender(arg1));
        assert!(0x2::balance::value<T0>(&v2.pool) == v2.remaining, 7);
        let v4 = ClaimProfitSharingEvent{
            ...
            level  : 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::tails_level(v1),
        };
