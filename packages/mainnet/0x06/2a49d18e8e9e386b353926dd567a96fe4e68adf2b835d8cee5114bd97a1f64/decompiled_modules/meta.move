module 0x62a49d18e8e9e386b353926dd567a96fe4e68adf2b835d8cee5114bd97a1f64::meta {
    ...
    fun init(arg0: META, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<META>(arg0, 9, b"META", b"META", b"META", 0x1::option::some<0x2::url::Url>(0x62a49d18e8e9e386b353926dd567a96fe4e68adf2b835d8cee5114bd97a1f64::icon::get_icon_url()), arg1);
        let v2 = v1;
        let v3 = v0;
