module 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_config {
    ...
    struct GlobalConfig has key {
        ...
        package_version: u64,
        acl: 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::ACL,
    }
    ...
    public fun add_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        ...
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::add_role(&mut arg0.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun remove_role(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u8) {
        checked_package_version(arg0);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::remove_role(&mut arg0.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun check_operation_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 1) || 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 2), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::no_operation_manager_permission());
    }

    public fun check_oracle_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 4), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::no_oracle_manager_permission());
    }

    public fun check_pool_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 3), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::no_pool_manager_permission());
    }

    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 0), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::no_protocol_fee_claim_permission());
    }

    public fun check_rebalance_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 2), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::no_operation_manager_permission());
    }

    public fun check_reinvest_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 1), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::no_operation_manager_permission());
    }

    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(1 >= arg0.package_version, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::package_version_deprecate());
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            ...
            package_version         : 1,
            acl                     : 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::new(arg0),
        };
    ...
    public fun is_operation_manager_role(arg0: &GlobalConfig, arg1: address) : bool {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 1) || 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 2)
    }

    public fun is_oracle_manager_role(arg0: &GlobalConfig, arg1: address) : bool {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 4)
    }

    public fun is_pool_manager_role(arg0: &GlobalConfig, arg1: address) : bool {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 3)
    }

    public fun is_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) : bool {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 0)
    }

    public fun is_rebalance_role(arg0: &GlobalConfig, arg1: address) : bool {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 2)
    }

    public fun is_reinvest_role(arg0: &GlobalConfig, arg1: address) : bool {
        0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::vault_acl::has_role(&arg0.acl, arg1, 1)
    }
    ...
    public fun set_swap_slippage<T0>(arg0: &mut GlobalConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 <= get_swap_slippage_denominator(), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::invalid_swap_slippage());
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        let v1 = 0;
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.swap_slippages, &v0)) {
    ...
    public fun update_package_version(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: u64) {
        ...
        assert!(arg2 > v0, 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::wrong_package_version());
    ...
    public fun update_protocol_fee_rate(arg0: &mut GlobalConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_pool_manager_role(arg0, 0x2::tx_context::sender(arg2));
        assert!(arg1 <= get_max_protocol_fee_rate(), 0x9a7f6bb7cdad3343846381f4a0b43552adee23fd051fd450532bbd5981f0ac96::error::invalid_protocol_fee_rate());
