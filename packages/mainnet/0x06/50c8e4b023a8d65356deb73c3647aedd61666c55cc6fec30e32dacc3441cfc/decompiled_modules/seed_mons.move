module 0x650c8e4b023a8d65356deb73c3647aedd61666c55cc6fec30e32dacc3441cfc::seed_mons {
    struct SEED_MONS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SEED_MONS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SEED_MONS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SEED Mons"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"#26"));
