module 0x656fa136d32885a7c9065deda34c28bfefe3f619fb92e991a4e531fac0c767d::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<MANAGED>(arg0, 2, b"LUCKY", b"lucky coin", b"Opis tokena", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/2bJNwVp.jpg")), false, arg1);
