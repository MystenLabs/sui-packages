module 0x6c71ea85aec632db334084038bd518ce61ce34e240f781e2736954e03740930::reward7863 {
    struct REWARD7863 has drop {
        dummy_field: bool,
    }

    struct TICKET_7863 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7863(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_7863>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7863, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7863>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7863>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7863>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7863>>(v5, 0x2::tx_context::sender(arg1));
    }
