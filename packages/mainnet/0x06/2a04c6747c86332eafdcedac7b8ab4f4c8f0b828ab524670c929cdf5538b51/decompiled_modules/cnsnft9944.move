module 0x62a04c6747c86332eafdcedac7b8ab4f4c8f0b828ab524670c929cdf5538b51::cnsnft9944 {
    struct CNSNFT9944 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9944, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9944>(arg0, arg1);
