module 0x6e33eb36cc423b80c4bf7c7d05a0fec3aedb8dac5f597ab3e7c9f9b88b4c804::cetus_vampire_attack {
    ...
    struct CetusLockdropForPool<phantom T0, phantom T1> has key {
        ...
        total_hive_incentives: 0x2::balance::Balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>,
        hive_incentives: u64,
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut CetusLockdropForPool<T0, T1>, arg2: &CetusAttackConfig, arg3: 0x2::coin::Coin<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
        ...
        0x2::balance::join<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(&mut arg1.total_hive_incentives, 0x2::balance::split<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(&mut v0, arg4));
    ...
    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &CetusLockdropForPool<T0, T1>, arg4: &mut 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg5: address, arg6: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, u128) {
        ...
        } = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::remove_app_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg6);
        let v5 = v2;
        let v6 = v1;
    ...
    public fun does_user_have_position<T0, T1>(arg0: &0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg1: &CetusLockdropForPool<T0, T1>) : bool {
    ...
    public entry fun extract_liquidity_from_cetus<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::DegenHiveDeployerCap, arg2: &CetusAttackConfig, arg3: &mut CetusLockdropForPool<T0, T1>, arg4: u64, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg8: &0x2::tx_context::TxContext) {
        ...
        while (v1 < arg4 && 0x1::option::is_some<address>(&v0)) {
            ...
            let v3 = 0x2::linked_table::remove<address, UserCetusLockup>(&mut arg3.participants_position_mapping, v2);
            let v4 = 0;
            while (v4 < 0x1::vector::length<u64>(&v3.lockup_weeks)) {
                ...
                let v9 = make_position_identifier(v2, v5);
                if (!*0x2::linked_table::borrow<0x1::string::String, bool>(&arg3.liquidity_extracted_bool, v9)) {
                    *0x2::linked_table::borrow_mut<0x1::string::String, bool>(&mut arg3.liquidity_extracted_bool, v9) = true;
                    arg3.liquidity_extracted_positions_count = arg3.liquidity_extracted_positions_count + 1;
                };
                v4 = v4 + 1;
            };
            0x2::linked_table::push_back<address, UserCetusLockup>(&mut arg3.participants_position_mapping, v2, v3);
            v0 = *0x2::linked_table::next<address, UserCetusLockup>(&arg3.participants_position_mapping, v2);
            v1 = v1 + 1;
        };
    }

    public fun get_user_position<T0, T1>(arg0: &0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg1: &CetusLockdropForPool<T0, T1>) : (vector<u64>, vector<u128>, vector<u64>, vector<u128>, vector<u64>, u128, u64) {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0x1::vector::empty<u128>();
        let v2 = 0x1::vector::empty<u64>();
        let v3 = 0x1::vector::empty<u128>();
        let v4 = 0x1::vector::empty<u64>();
        let v5 = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_hive_app_name(&arg1.user_profile_access_cap);
        if (!0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::exists_for_profile(arg0, v5)) {
            return (v0, v1, v2, v3, v4, 0, 0)
        };
        let v6 = 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::borrow_from_profile<UserCetusHivePosition>(arg0, v5);
        v0 = v6.lockup_weeks;
        let v7 = 0;
    ...
    public entry fun initialize_attack_on_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveAppAccessCapability, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &CetusAttackConfig, arg5: 0x1::string::String, arg6: u8, arg7: 0x2::coin::Coin<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : address {
        ...
        let v3 = CetusLockdropForPool<T0, T1>{
            ...
            participants_position_mapping       : 0x2::linked_table::new<address, UserCetusLockup>(arg9),
            ...
            total_hive_incentives               : 0x2::balance::split<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(&mut v0, arg8),
        ...
        0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::coin_helper::destroy_or_transfer_balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>(v0, 0x2::tx_context::sender(arg9), arg9);
    ...
    public entry fun initialize_cetus_attack(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
    ...
    public fun query_all_position_identifiers<T0, T1>(arg0: &CetusLockdropForPool<T0, T1>, arg1: 0x1::option::Option<0x1::string::String>, arg2: u64) : (vector<0x1::string::String>, vector<bool>, u64) {
    ...
    public fun stake_cetus_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &mut CetusLockdropForPool<T0, T1>, arg4: &mut 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::HiveProfile, arg5: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (u128, 0x1::string::String, u8) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        ...
        let v5 = if (0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::exists_for_profile(arg4, 0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::get_hive_app_name(&arg3.user_profile_access_cap))) {
            0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::remove_app_from_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, arg7)
        } else {
        ...
        if (!0x2::linked_table::contains<address, UserCetusLockup>(&arg3.participants_position_mapping, v1)) {
            let v6 = kraft_cetus_lockup(arg7);
            0x2::linked_table::push_back<address, UserCetusLockup>(&mut arg3.participants_position_mapping, v1, v6);
        };
        ...
        assert!(v7 > 0, 9817);
        let v8 = arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window + arg6 * 0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::constants::week_multiplier();
        let v9 = calculate_weighted_units(v7, arg6, arg2);
        let v10 = &mut v5;
        kraft_cetus_receipt(v10, arg6, v7, v9, v8);
        let v11 = 0x2::linked_table::remove<address, UserCetusLockup>(&mut arg3.participants_position_mapping, v1);
        ...
        0x2::linked_table::push_back<address, UserCetusLockup>(&mut arg3.participants_position_mapping, v1, v11);
        ...
        0xb0c1fd7c7adbb94d6632da260646db7ae8a82247be2c5407b204156db4d24e3d::hive_profile::add_app_to_profile<UserCetusHivePosition>(&arg3.user_profile_access_cap, arg4, v5, arg7);
        (v7, arg3.identifier, arg3.precision)
    }

    public fun transfer_liquidity_from_cetus<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x5c6927587fc9c45ffc3e657da035ff84b5edf1b3d024b0676e9302491987e178::config::HiveEntryCap, arg2: &CetusAttackConfig, arg3: &mut CetusLockdropForPool<T0, T1>, arg4: &0x2::tx_context::TxContext) : (u128, u8, u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>, 0x2::balance::Balance<0xeb4f708cfe7a37392080f260e3e0ef645309dda88123903e2e5400b2ee4b20ff::hive::HIVE>) {
        assert!(0x2::clock::timestamp_ms(arg0) > arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9812);
