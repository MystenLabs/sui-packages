module 0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::registry {
    ...
    public fun assert_output(arg0: &Registry, arg1: u64, arg2: u64) {
        ...
        assert!(0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::safe_math::mul_div_u64(v0, 0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::constants::scaling_pips(), arg1) <= arg0.max_output_delta_pips, 4);
    }
    ...
    public fun assert_price(arg0: &Registry, arg1: u128, arg2: u128) {
        ...
        assert!((0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::safe_math::mul_div_u128(v0, 0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::constants::scaling_pips_u128(), arg1) as u64) <= arg0.max_price_delta_pips, 3);
    }

    public(friend) fun assert_witness<T0>(arg0: &Registry) {
        assert!(arg0.version <= 0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::constants::current_version(), 0);
        let v0 = type_name<T0>();
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            version               : 0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::constants::current_version(),
    ...
    public fun update_max_output_delta_pips(arg0: &mut Registry, arg1: u64, arg2: &AdminCap) {
        assert!(arg1 < 0x615d4063233d7485ad0613fe4f3553c5485106ff069c991c1d14fe0fd105c79::constants::scaling_pips(), 2);
