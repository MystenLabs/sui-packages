module 0x60f59c42a52398dfbdee4aafe58b60676f4b0fb7986bb27867302f20795ece3::kurosui {
    ...
    fun init(arg0: KUROSUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://i.ibb.co/bMbGqxLL/z7607748235820-160fc1d4a3dbbaf99f45e8679487f5a3.jpg                                                                                                                                                                                                                                                   ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<KUROSUI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KuroSui ")))), trim_right(b"Kuromi on Sui                   "), trim_right(b"KuroSui is a community-driven token inspired by the mischievous charm of Kuromi and powered by the speed and scalability of the Sui Network.                                                                                                                                                                                    "), v2, arg1);
        let v5 = v3;
