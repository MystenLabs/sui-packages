module 0x6f4d5c6ba322b447a1b0776bebf98fdad91d20a537d0ba4bb73e0e0d1941848::cnsnft8923 {
    struct CNSNFT8923 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8923, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8923>(arg0, arg1);
