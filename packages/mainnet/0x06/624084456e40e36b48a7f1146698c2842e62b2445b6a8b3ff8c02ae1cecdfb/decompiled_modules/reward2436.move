module 0x6624084456e40e36b48a7f1146698c2842e62b2445b6a8b3ff8c02ae1cecdfb::reward2436 {
    struct REWARD2436 has drop {
        dummy_field: bool,
    }

    struct TICKET_2436 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2436(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2436>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2436>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2436, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2436>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2436>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2436>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2436>>(v5, 0x2::tx_context::sender(arg1));
    }
