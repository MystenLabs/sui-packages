module 0x6a3afa32dd51844664c537d5c8046862647e0263201c3c2d877a3eb740558fe::gem {
    struct GEM has drop {
        dummy_field: bool,
    }

    fun init(arg0: GEM, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<GEM>(arg0, 9, b"T_GEM", b"GEM Test", b"GEM Test", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/2537.png")), true, arg1);
