module 0xdbbf6848ae454663012ac7da73b670e6646eabb0e722b18af57a732ee31c2794::bluefin_rewards {
    ...
    public entry fun deploy_loose_into_existing_deep_sui<T0, T1, T2, T3>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T3>, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T2>, arg8: 0x2::coin::Coin<T3>, arg9: bool, arg10: u64, arg11: u64, arg12: bool, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T2>(&arg7);
        let v1 = 0x2::coin::value<T3>(&arg8);
        let v2 = 0x2::coin::into_balance<T0>(arg6);
        let v3 = if (v0 > 0) {
            swap_b_to_a_balance<T0, T2>(arg0, arg1, arg4, 0x2::coin::into_balance<T2>(arg7))
        } else {
        ...
        let v5 = if (v1 > 0) {
            swap_b_to_a_balance<T1, T3>(arg0, arg1, arg5, 0x2::coin::into_balance<T3>(arg8))
        } else {
        ...
        if (arg10 > 0) {
            if (arg9) {
                let v8 = swap_a_to_b_balance<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T0>(&mut v2, arg10));
                v7 = 0x2::balance::value<T1>(&v8);
                0x2::balance::join<T1>(&mut v6, v8);
            } else {
                let v9 = swap_b_to_a_balance<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v6, arg10));
                v7 = 0x2::balance::value<T0>(&v9);
                0x2::balance::join<T0>(&mut v2, v9);
            };
        };
        let (v10, v11) = top_up_position_balances<T0, T1>(arg0, arg1, arg2, arg3, v2, v6, arg11, arg12);
        let v12 = v11;
        let v13 = v10;
        ...
        transfer_nonzero<T0>(v13, v19, arg17);
        let v20 = 0x2::tx_context::sender(arg17);
        transfer_nonzero<T1>(v12, v20, arg17);
    }
    ...
    public entry fun harvest_and_deploy_loose_into_existing_deep_sui<T0, T1, T2, T3>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T3>, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T2>, arg8: 0x2::coin::Coin<T3>, arg9: bool, arg10: u64, arg11: u64, arg12: bool, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_reward<T0, T1, T0>(arg0, arg1, arg2, arg3);
        let (v1, v2) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::get_accrued_fee(arg3);
        let (v3, v4) = if (v1 > 0 || v2 > 0) {
            let (_, _, v7, v8) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::collect_fee<T0, T1>(arg0, arg1, arg2, arg3);
        ...
        let v11 = if (0x2::balance::value<T0>(&v0) > 0) {
            swap_a_to_b_balance<T0, T1>(arg0, arg1, arg2, v0)
        } else {
        ...
        deploy_loose_into_existing_deep_sui<T0, T1, T2, T3>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg14, arg15, arg16, arg17, arg18);
    }
    ...
    public entry fun harvest_recenter_and_deploy_loose_deep_sui<T0, T1, T2, T3>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T2>, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T3>, arg6: 0x2::coin::Coin<T0>, arg7: 0x2::coin::Coin<T2>, arg8: 0x2::coin::Coin<T3>, arg9: 0x2::coin::Coin<T1>, arg10: u32, arg11: bool, arg12: u64, arg13: u64, arg14: bool, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: &mut 0x2::tx_context::TxContext) {
        assert!(arg10 > 0, 0);
        let v0 = 0x2::coin::value<T2>(&arg7);
        let v1 = 0x2::coin::value<T3>(&arg8);
        ...
        let v3 = 0x2::balance::value<T0>(&v2);
        let (v4, v5, v6, v7) = close_with_fees<T0, T1>(arg0, arg1, arg2, arg3);
        let v8 = v7;
        let v9 = v6;
        let v10 = v5;
        let v11 = v4;
        ...
        let v14 = if (0x2::balance::value<T0>(&v2) > 0) {
            swap_a_to_b_balance<T0, T1>(arg0, arg1, arg2, v2)
        } else {
        ...
        if (arg12 > 0) {
            if (arg11) {
                let v22 = swap_a_to_b_balance<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T0>(&mut v11, arg12));
                v21 = 0x2::balance::value<T1>(&v22);
                0x2::balance::join<T1>(&mut v10, v22);
            } else {
                let v23 = swap_b_to_a_balance<T0, T1>(arg0, arg1, arg2, 0x2::balance::split<T1>(&mut v10, arg12));
        ...
        transfer_nonzero<T0>(v38, v42, arg20);
        let v43 = 0x2::tx_context::sender(arg20);
        transfer_nonzero<T1>(v37, v43, arg20);
    }
