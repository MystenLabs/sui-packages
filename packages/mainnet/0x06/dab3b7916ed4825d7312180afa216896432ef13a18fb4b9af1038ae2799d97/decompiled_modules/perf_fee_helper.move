module 0xb0e65c2cf7a8cf017b9361918a8b4575f0153ed11674da27945f41f26a9a5037::perf_fee_helper {
    ...
    struct PerformanceFeeRecord has copy, drop {
        helper_id: address,
        vault_id: address,
        fee_amount: u64,
        expected_fee: u64,
    ...
    fun compute_fee(arg0: u256, arg1: u256, arg2: u256, arg3: u64) : u256 {
        ...
        arg2 * (arg0 - arg1) * (arg3 as u256) / 1000000000000000000 * 10000
    }

    public fun create_helper<T0>(arg0: &HelperAdminCap, arg1: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::Vault<T0>, arg2: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::OracleConfig, arg3: &0x2::clock::Clock, arg4: u64, arg5: address, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : HelperOperatorCap {
        assert!(arg4 <= 5000, 5);
    ...
    public fun helper_vault_id<T0>(arg0: &VaultHelper<T0>) : address {
        arg0.vault_id
    }
    ...
    public fun last_claimed_ms<T0>(arg0: &VaultHelper<T0>) : u64 {
        arg0.last_claimed_ms
    }

    public fun last_price_ratio<T0>(arg0: &VaultHelper<T0>) : u256 {
    ...
    public fun migrate_and_reprice<T0>(arg0: &HelperAdminCap, arg1: &mut VaultHelper<T0>, arg2: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::Vault<T0>, arg3: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::OracleConfig, arg4: &0x2::clock::Clock) {
        assert!(arg1.version + 1 == 2, 10);
        assert!(0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::vault_id<T0>(arg2) == arg1.vault_id, 1);
        let (v0, _, _, _, v4) = current_state<T0>(arg2, arg3, arg4);
        assert!(v4 > 0, 8);
        let v5 = StateReset{
            ...
            new_last_claimed_ms : arg1.last_claimed_ms,
        };
        0x2::event::emit<StateReset>(v5);
        arg1.last_price_ratio = v0;
        arg1.version = 2;
    }
    ...
    public fun pre_calculate_perf_fee<T0>(arg0: &VaultHelper<T0>, arg1: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::Vault<T0>, arg2: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::OracleConfig, arg3: &0x2::clock::Clock, arg4: bool, arg5: u64) : u64 {
        ...
        let (_, v1, _, _, v4) = current_state<T0>(arg1, arg2, arg3);
        let v5 = (arg5 as u256);
        let v6 = if (arg4) {
            v1 + v5
        } else if (v1 > v5) {
        ...
        let v8 = compute_fee(v7, arg0.last_price_ratio, v4, arg0.fee_rate_bps);
        assert!(v8 <= 18446744073709551615, 6);
        (v8 as u64)
    }

    fun ratio_advance_from_fee(arg0: u256, arg1: u256, arg2: u64) : u256 {
        arg0 * 1000000000000000000 * 10000 / arg1 * (arg2 as u256)
    }

    fun ratio_of(arg0: u256, arg1: u256) : u256 {
        arg0 * 1000000000000000000 / arg1
    }

    public fun ratio_scale() : u256 {
        1000000000000000000
    }

    public fun record_execution_no_fee<T0>(arg0: &mut VaultHelper<T0>, arg1: &HelperOperatorCap, arg2: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::Vault<T0>, arg3: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::OracleConfig, arg4: &0x2::clock::Clock) {
        assert!(arg0.version == 2, 10);
    ...
    public fun unclaimed_performance_fee<T0>(arg0: &VaultHelper<T0>, arg1: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::Vault<T0>, arg2: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::OracleConfig, arg3: &0x2::clock::Clock) : u64 {
        assert!(arg0.version == 2, 10);
        assert!(0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::vault_id<T0>(arg1) == arg0.vault_id, 1);
    ...
    public fun verify_and_record_performance_fee<T0>(arg0: &mut VaultHelper<T0>, arg1: &HelperOperatorCap, arg2: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault::Vault<T0>, arg3: &0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_oracle::OracleConfig, arg4: &0x2::balance::Balance<T0>, arg5: address, arg6: &0x2::clock::Clock) {
        assert!(arg0.version == 2, 10);
        ...
        0x2::event::emit<PerformanceFeeRecord>(v11);
    }
