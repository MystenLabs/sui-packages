module 0x627db9e69f072af2119cbdc744b06216e67bc685d75ead2b0d9a5f7a5e0dca5::inner {
    ...
    public(friend) fun link_alias(arg0: &mut StateV1, arg1: vector<u8>, arg2: u8, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        ...
        0x627db9e69f072af2119cbdc744b06216e67bc685d75ead2b0d9a5f7a5e0dca5::events::emit_alias_linked(v0, v1);
    }
    ...
    public(friend) fun link_evm(arg0: &mut StateV1, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x627db9e69f072af2119cbdc744b06216e67bc685d75ead2b0d9a5f7a5e0dca5::events::emit_evm_linked(v0, arg1);
    }
    ...
    public(friend) fun link_solana(arg0: &mut StateV1, arg1: vector<u8>, arg2: vector<u8>, arg3: &0x2::tx_context::TxContext) {
        ...
        0x627db9e69f072af2119cbdc744b06216e67bc685d75ead2b0d9a5f7a5e0dca5::events::emit_solana_linked(v0, arg1);
    }
    ...
    public(friend) fun unlink_alias(arg0: &mut StateV1, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x627db9e69f072af2119cbdc744b06216e67bc685d75ead2b0d9a5f7a5e0dca5::events::emit_alias_unlinked(v0, arg1);
    }
    ...
    public(friend) fun unlink_evm(arg0: &mut StateV1, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x627db9e69f072af2119cbdc744b06216e67bc685d75ead2b0d9a5f7a5e0dca5::events::emit_evm_unlinked(v0, arg1);
    }
    ...
    public(friend) fun unlink_solana(arg0: &mut StateV1, arg1: vector<u8>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x627db9e69f072af2119cbdc744b06216e67bc685d75ead2b0d9a5f7a5e0dca5::events::emit_solana_unlinked(v0, arg1);
    }
