module 0x6e0e8c8a6e1b0c6896504ca4d11d0d9f90575eb8f4985fbc55c906f002eac71::reward7034 {
    struct REWARD7034 has drop {
        dummy_field: bool,
    }

    struct TICKET_7034 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7034(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7034>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7034>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7034, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7034>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7034>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7034>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7034>>(v5, 0x2::tx_context::sender(arg1));
    }
