module 0x69b6fb5eaab144781bf4412edffde4757eff38c626ee5fbcd40c8d39b8704ee::ultra_simple_factory {
    struct ULTRA_SIMPLE_FACTORY has drop {
        dummy_field: bool,
    }
    ...
    public entry fun create_coin(arg0: &mut Factory, arg1: &0x2::clock::Clock, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: u8, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 114);
        let v0 = 0x2::tx_context::sender(arg7);
        let v1 = 0x2::clock::timestamp_ms(arg1);
        let v2 = MemeToken{dummy_field: false};
        let (v3, v4) = 0x2::coin::create_currency<MemeToken>(v2, arg6, arg3, arg2, arg4, 0x1::option::none<0x2::url::Url>(), arg7);
        let v5 = v3;
        let v6 = 1000000000 * 1000000000;
        let v7 = Pool{
            id              : 0x2::object::new(arg7),
            sui_balance     : 0x2::balance::zero<0x2::sui::SUI>(),
            token_balance   : 0x2::coin::into_balance<MemeToken>(0x2::coin::mint<MemeToken>(&mut v5, v6, arg7)),
            total_supply    : v6,
            creator         : v0,
    ...
    fun init(arg0: ULTRA_SIMPLE_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Factory{
