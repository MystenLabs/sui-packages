module 0x65e7507c4381696f4faab8d5afdf44db77e226abc02e3adf8f19b12e800baa7::gawblenz_ {
    ...
    fun init(arg0: GAWBLENZ_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GAWBLENZ_>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://HCxjex_5ui7Hoz6tz-377MBwZygfGKSQcI68YTB123Q"));
