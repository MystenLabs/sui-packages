module 0x6f60b6ba14b1012c2bebd7e638a759e75d8c425122c43fbe09c901cac3982ba::reward1250 {
    struct REWARD1250 has drop {
        dummy_field: bool,
    }

    struct TICKET_1250 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1250(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1250>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1250>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1250, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1250>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1250>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1250>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1250>>(v5, 0x2::tx_context::sender(arg1));
    }
