module 0x6ad9ac7b4f2a8b6fb2449e4fcae8dc650a6c81488690e4db51cc076f280055c::storage {
    ...
    public entry fun init_reserve<T0>(arg0: &0x2::clock::Clock, arg1: &mut Storage, arg2: bool, arg3: u256, arg4: u256, arg5: u256, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: &mut 0x2::tx_context::TxContext) {
        only_configurator(arg1, arg14);
        let v0 = arg1.reserves_count;
        assert!(v0 < 255, 43003);
        reserve_validation<T0>(arg1);
        let v1 = TokenBalance{
            user_state   : 0x2::table::new<address, u256>(arg14),
            total_supply : 0,
            treasury     : 0,
        };
        let v2 = TokenBalance{
