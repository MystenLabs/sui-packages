module 0x6ce7233d87876a2dc3997685b3c65eb7e8de666a2ae58cb972501965e1e2a49::reward6038 {
    struct REWARD6038 has drop {
        dummy_field: bool,
    }

    struct TICKET_6038 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6038(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6038>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6038>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6038, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6038>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6038>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6038>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6038>>(v5, 0x2::tx_context::sender(arg1));
    }
