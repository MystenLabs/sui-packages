module 0x6e926b65a3cf39c48b12fa2506ea968bd688657be7c35a9a15cd6f7a6e8c42d::reward4174 {
    struct REWARD4174 has drop {
        dummy_field: bool,
    }

    struct TICKET_4174 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4174(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4174>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4174>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4174, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4174>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4174>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4174>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4174>>(v5, 0x2::tx_context::sender(arg1));
    }
