module 0x66215520888558e782f5bd4933001e6a6b7a9caa7651d01a361716309e7fdc3::reward8499 {
    struct REWARD8499 has drop {
        dummy_field: bool,
    }

    struct TICKET_8499 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8499(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8499>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8499>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8499>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8499>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8499>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8499>>(v5, 0x2::tx_context::sender(arg1));
    }
