module 0x68482c01fdb7d96cd61dce70c4ef449cbb188a3d8455cf74ebba789bbcaf47e::reward7729 {
    struct REWARD7729 has drop {
        dummy_field: bool,
    }

    struct TICKET_7729 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7729(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7729>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7729>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7729, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7729>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7729>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7729>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7729>>(v5, 0x2::tx_context::sender(arg1));
    }
