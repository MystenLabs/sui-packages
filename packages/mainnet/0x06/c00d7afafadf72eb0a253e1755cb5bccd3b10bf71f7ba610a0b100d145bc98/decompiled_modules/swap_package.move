module 0x6c00d7afafadf72eb0a253e1755cb5bccd3b10bf71f7ba610a0b100d145bc98::swap_package {
    ...
    public fun swap_ab_bc<T0, T1, T2>(arg0: &WhiteList, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg4: &mut CoinWallet<T0>, arg5: bool, arg6: u64, arg7: u64, arg8: u128, arg9: &0x2::clock::Clock, arg10: address, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg11);
        white_list_check(arg0, &v0);
        let v1 = 0x2::coin::take<T0>(&mut arg4.token, arg6, arg11);
        let v2 = 0x2::coin::zero<T1>(arg11);
        let v3 = 0x2::coin::zero<T2>(arg11);
        let (v4, v5, v6) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg2, true, arg5, arg6, arg8, arg9);
        let v7 = v6;
        let v8 = v5;
        0x2::balance::value<T1>(&v8);
        0x2::coin::join<T0>(&mut v1, 0x2::coin::from_balance<T0>(v4, arg11));
        0x2::coin::join<T1>(&mut v2, 0x2::coin::from_balance<T1>(v8, arg11));
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v1, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v7), arg11)), 0x2::balance::zero<T1>(), v7);
        let (v9, v10, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T1, T2>(arg1, arg3, true, arg5, arg6, arg8, arg9);
        let v12 = v11;
        let v13 = v10;
        assert!(0x2::balance::value<T2>(&v13) > arg7, 502);
        0x2::coin::join<T1>(&mut v2, 0x2::coin::from_balance<T1>(v9, arg11));
        0x2::coin::join<T2>(&mut v3, 0x2::coin::from_balance<T2>(v13, arg11));
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T1, T2>(arg1, arg3, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v2, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&v12), arg11)), 0x2::balance::zero<T2>(), v12);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v2, arg10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, arg10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v3, arg10);
    }
