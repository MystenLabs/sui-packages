module 0x6424e58f4bb66204581418e3798c8ade71dbce319c83e18479170f00921d18d::last_alive {
    ...
    public entry fun batch_burn_and_mint(arg0: &mut GameState, arg1: &mut WalletMintLimit, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: vector<0x2::object::ID>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.mint_proceeds, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(arg2, v3, arg6)));
    ...
    public entry fun batch_mint(arg0: &mut GameState, arg1: &mut WalletMintLimit, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.mint_enabled, 3);
        let v0 = arg0.max_supply - arg0.total_supply;
        let v1 = if (arg3 > v0) {
            v0
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(arg2) >= v3, 1);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.mint_proceeds, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(arg2, v3, arg5)));
