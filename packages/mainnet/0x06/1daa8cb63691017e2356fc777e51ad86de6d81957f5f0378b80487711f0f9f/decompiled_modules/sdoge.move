module 0x61daa8cb63691017e2356fc777e51ad86de6d81957f5f0378b80487711f0f9f::sdoge {
    ...
    fun init(arg0: SDOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SDOGE>(arg0, 4, b"SDOGE", b"Super Doge Token", b"", 0x1::option::none<0x2::url::Url>(), arg1);
