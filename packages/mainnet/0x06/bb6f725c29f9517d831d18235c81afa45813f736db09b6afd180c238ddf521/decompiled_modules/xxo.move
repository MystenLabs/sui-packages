module 0x6bb6f725c29f9517d831d18235c81afa45813f736db09b6afd180c238ddf521::xxo {
    struct XXO has drop {
        dummy_field: bool,
    }

    fun init(arg0: XXO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/BGGKurlhAscOvywfY86uzQPdE9D1shksbu_z3aC4Pxo";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/BGGKurlhAscOvywfY86uzQPdE9D1shksbu_z3aC4Pxo"))
        };
