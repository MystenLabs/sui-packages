module 0x6fe3c16c81994fc0c555f9288b2a9bc2265be45cc5a9a1107bdbc7f405b0f8a::tenmm {
    ...
    public fun reward_quote(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : u64 {
        ...
        emission_between_slots(arg2, arg3, v3) * arg0 / arg1
    }

    public entry fun seed_liquidity(arg0: &mut Market, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<TENMM>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) > 0, 0);
        assert!(0x2::coin::value<TENMM>(&arg2) > 0, 0);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
        0x2::balance::join<TENMM>(&mut arg0.tenmm, 0x2::coin::into_balance<TENMM>(arg2));
    }
