module 0x603346ba4d4ff4b26a7892bee31935fdfa2e4fd23ea091cd03fcc2c8566a949::allowlist {
    ...
    fun approve_internal(arg0: address, arg1: vector<u8>, arg2: &Allowlist) : bool {
        if (!0x603346ba4d4ff4b26a7892bee31935fdfa2e4fd23ea091cd03fcc2c8566a949::utils::is_prefix(namespace(arg2), arg1)) {
            return false
        };
