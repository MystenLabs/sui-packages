module 0x6dbcbf047d9afeb6add14d1fd5cf8c27ec760db6789de3b51e912f37a05f5ee::public_kiosk {
    ...
    public(friend) fun delist<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg3: &0x2::tx_context::TxContext) {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg2, 2);
    ...
    public(friend) fun list<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: u64, arg3: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg4: &0x2::tx_context::TxContext) {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg3, 2);
        validatePair<T0, T1>(arg0);
    ...
    public(friend) fun place<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: T0, arg2: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg3: &0x2::tx_context::TxContext) {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg2, 2);
        validatePair<T0, T1>(arg0);
    ...
    public(friend) fun purchase<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg3: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, KOrder) {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg2, 2);
        validatePair<T0, T1>(arg0);
    ...
    public(friend) fun take<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg3: &0x2::tx_context::TxContext) : u128 {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg2, 2);
        validatePair<T0, T1>(arg0);
    ...
    public(friend) fun createPublicKiosk<T0: store + key, T1>(arg0: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg1: &mut 0x2::tx_context::TxContext) : PublicKiosk {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg0, 2);
    ...
    public(friend) fun delistAndTake<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg3: &0x2::tx_context::TxContext) : u128 {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg2, 2);
    ...
    public(friend) fun placeAndList<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: T0, arg2: u64, arg3: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg4: &0x2::tx_context::TxContext) {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg3, 2);
        place<T0, T1>(arg0, arg1, arg3, arg4);
        list<T0, T1>(arg0, 0x2::object::id<T0>(&arg1), arg2, arg3, arg4);
    }

    public(friend) fun updatePrice<T0: store + key, T1>(arg0: &mut PublicKiosk, arg1: 0x2::object::ID, arg2: u64, arg3: &0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::Version, arg4: &0x2::tx_context::TxContext) {
        0xdae753211be298b641a7885b3dbe929c90dc129be24ed7adaa87fb25477c17cd::version::checkVersion(arg3, 2);
        validatePair<T0, T1>(arg0);
        let v0 = 0x2::dynamic_field::borrow_mut<0x2::object::ID, KOrder>(0x2::kiosk::uid_mut_as_owner(&mut arg0.kiosk, &arg0.ownerCap), arg1);
        assert!(v0.owner == 0x2::tx_context::sender(arg4), 3001);
