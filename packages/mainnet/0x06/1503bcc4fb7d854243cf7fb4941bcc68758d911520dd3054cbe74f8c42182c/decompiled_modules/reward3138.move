module 0x61503bcc4fb7d854243cf7fb4941bcc68758d911520dd3054cbe74f8c42182c::reward3138 {
    struct REWARD3138 has drop {
        dummy_field: bool,
    }

    struct TICKET_3138 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3138(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3138>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3138>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3138, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3138>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3138>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3138>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3138>>(v5, 0x2::tx_context::sender(arg1));
    }
