module 0x6715c0e8a5196dd2fd309ad3abc239f9c7ce49971ea069829bc311f2e02c0c2::suiball {
    ...
    public fun get_owner(arg0: &Suiball) : address {
        arg0.owner
    }
    ...
    fun init(arg0: SUIBALL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<SUIBALL>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<Suiball>(&v4, v0, v2, arg1);
        0x2::display::update_version<Suiball>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Suiball>>(v5, 0x2::tx_context::sender(arg1));
        let v6 = ItemStore{
    ...
    public fun is_owner(arg0: &Suiball, arg1: address) : bool {
        arg0.owner == arg1
    }
    ...
    public entry fun mint_to_sender(arg0: &mut ItemStore, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        loop {
            ...
            0x2::transfer::transfer<Suiball>(v2, v1);
            v0 = v0 + 1;
            if (v0 == arg2) {
                break
            };
    ...
    public fun verify_owner(arg0: &Suiball, arg1: address) : bool {
        arg0.owner == arg1
    }
