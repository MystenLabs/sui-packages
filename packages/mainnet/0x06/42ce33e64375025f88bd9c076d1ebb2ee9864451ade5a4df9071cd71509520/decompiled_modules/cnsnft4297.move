module 0x642ce33e64375025f88bd9c076d1ebb2ee9864451ade5a4df9071cd71509520::cnsnft4297 {
    struct CNSNFT4297 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4297, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4297>(arg0, arg1);
