module 0x6da9b9bfd00a3dc5c5b702692900eb12808b9a8dc393c16de288e499f05bb73::offramp {
    ...
    fun init(arg0: OFFRAMP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = SourceChainConfigSet{
            source_chain_selector : 14767482510784806043,
            source_chain_config   : v6,
        };
        0x2::event::emit<SourceChainConfigSet>(v8);
        let v9 = OffRampObject{id: 0x2::object::new(arg1)};
        let v10 = OffRampStatePointer{
            id                 : 0x2::object::new(arg1),
            off_ramp_state_id  : 0x2::object::uid_to_address(&v4.id),
            owner_cap_id       : @0x0,
            off_ramp_object_id : 0x2::object::id_address<OffRampObject>(&v9),
        };
        let v11 = 0x1::vector::empty<address>();
        0x1::vector::push_back<address>(&mut v11, v2);
        let v12 = OffRampState{
            id          : 0x2::derived_object::claim<vector<u8>>(&mut v9.id, b"OffRampState"),
            package_ids : v11,
        };
        0x2::transfer::share_object<OffRampState>(v4);
        0x2::transfer::share_object<OffRampState>(v12);
        0x2::transfer::share_object<OffRampObject>(v9);
        0x2::transfer::public_share_object<CCIPObjectRef>(v5);
        0x2::transfer::transfer<OffRampStatePointer>(v10, v2);
    }
