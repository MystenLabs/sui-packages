module 0x2ac28ecb9082473f7d58e99f5cdce9fa5c794dcba03ea1b21bb3d3c33043151f::c1 {
    ...
    public fun gucav(arg0: &0x2ac28ecb9082473f7d58e99f5cdce9fa5c794dcba03ea1b21bb3d3c33043151f::admin::AdminCap, arg1: &0x2::clock::Clock, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: address) : 0x2::vec_map::VecMap<u8, u256> {
        let (v0, _) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_assets(arg3, arg4);
        let v2 = v0;
        let v3 = 0x2::vec_map::empty<u8, u256>();
        let v4 = 0;
        while (v4 < 0x1::vector::length<u8>(&v2)) {
            let v5 = 0x1::vector::borrow<u8>(&v2, v4);
            0x2::vec_map::insert<u8, u256>(&mut v3, *v5, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_collateral_value(arg1, arg2, arg3, *v5, arg4));
            v4 = v4 + 1;
        };
        v3
    }

    public fun gudav(arg0: &0x2ac28ecb9082473f7d58e99f5cdce9fa5c794dcba03ea1b21bb3d3c33043151f::admin::AdminCap, arg1: &0x2::clock::Clock, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: address) : 0x2::vec_map::VecMap<u8, u256> {
        let (_, v1) = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_user_assets(arg3, arg4);
        let v2 = v1;
        let v3 = 0x2::vec_map::empty<u8, u256>();
        let v4 = 0;
        while (v4 < 0x1::vector::length<u8>(&v2)) {
            let v5 = 0x1::vector::borrow<u8>(&v2, v4);
            0x2::vec_map::insert<u8, u256>(&mut v3, *v5, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::logic::user_loan_value(arg1, arg2, arg3, *v5, arg4));
            v4 = v4 + 1;
        };
        v3
    }
