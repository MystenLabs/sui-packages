module 0x6d62c8a84f19bfcd3cf7066c955a2dfa9b66e48fe48ccd9fb9ea2727a153f45::reward3487 {
    struct REWARD3487 has drop {
        dummy_field: bool,
    }

    struct TICKET_3487 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3487(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3487>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3487>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3487, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3487>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3487>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3487>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3487>>(v5, 0x2::tx_context::sender(arg1));
    }
