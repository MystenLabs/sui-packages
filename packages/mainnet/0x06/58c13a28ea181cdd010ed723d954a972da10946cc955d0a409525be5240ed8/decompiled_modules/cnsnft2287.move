module 0x658c13a28ea181cdd010ed723d954a972da10946cc955d0a409525be5240ed8::cnsnft2287 {
    struct CNSNFT2287 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2287, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2287>(arg0, arg1);
