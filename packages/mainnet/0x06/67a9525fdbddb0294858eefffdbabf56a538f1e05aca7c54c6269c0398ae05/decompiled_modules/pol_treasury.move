module 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::pol_treasury {
    ...
    public entry fun add_liquidity_permissionless(arg0: &mut Treasury, arg1: &mut 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::MintVault, arg2: &0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::Config, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN, 0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_treasury(arg0, arg2);
        assert_mint_vault(arg1, arg2);
        assert!(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::pool_registered(arg2), 5);
        assert!(0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN, 0x2::sui::SUI>>(arg4) == 0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::config_registry::registered_pool_id(arg2), 4);
        ...
        let (v2, v3) = full_range_ticks(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::tick_spacing<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN, 0x2::sui::SUI>(arg4));
        let v4 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN, 0x2::sui::SUI>(arg3, arg4, v2, v3, arg6);
        let v5 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN, 0x2::sui::SUI>(arg3, arg4, &mut v4, v0, false, arg5);
        let (v6, v7) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_pay_amount<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN, 0x2::sui::SUI>(&v5);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN, 0x2::sui::SUI>(arg3, arg4, 0x2::coin::into_balance<0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::TVYN>(0x143bd9071ea4f375d4321f2eb424d083b74a34388710e2cc7fbc31a9c45f1793::tvyn::mint_for_protocol(arg1, v6, arg6)), 0x2::balance::split<0x2::sui::SUI>(&mut v1, v7), v5);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_accum, v1);
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(&v4) > 0, 14);
        let v8 = LiquidityAssetsProvided{
            sui_amount   : v7,
            tvyn_minted  : v6,
            timestamp_ms : 0x2::clock::timestamp_ms(arg5),
        };
        0x2::event::emit<LiquidityAssetsProvided>(v8);
        let v9 = 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v4);
        0x2::bag::add<0x2::object::ID, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg0.lp_assets, v9, v4);
        let v10 = pay_keeper_reward(arg0, arg2, arg6);
        let v11 = LpPositionDeposited{
            depositor          : 0x2::tx_context::sender(arg6),
            asset_id           : v9,
            keeper_reward_paid : v10,
        };
        0x2::event::emit<LpPositionDeposited>(v11);
    }
    ...
    fun full_range_ticks(arg0: u32) : (u32, u32) {
        let v0 = 443636 / arg0 * arg0;
        assert!(v0 > 0, 15);
        (((4294967296 - (v0 as u64)) as u32), v0)
    }
