module 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::lock {
    ...
    public fun seed_and_lock_bluefin_with_fee<T0, T1>(arg0: &mut 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::Pool<T0, T1>, arg1: &0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::Config, arg2: &0x2::clock::Clock, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::bluefin::creation_fee_amount<0x2::sui::SUI>(arg3);
        assert!(v0, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::invalid_fee());
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg6) >= v1, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::invalid_fee());
        let (v2, v3) = 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::take_reserves_for_lock<T0, T1>(arg0);
        let v4 = if (v1 == 0) {
            0x2::balance::zero<0x2::sui::SUI>()
        } else {
            0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg6, v1, arg7))
        };
        send_residual_coin<0x2::sui::SUI>(arg6, 0x2::tx_context::sender(arg7));
        seed_and_lock_internal<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, v4, v2, v3, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::math::sqrt_price_x64(0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::token_reserves<T0, T1>(arg0), 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::virtual_quote<T0, T1>(arg0) + 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::quote_reserves<T0, T1>(arg0)), arg7);
    }

    fun seed_and_lock_internal<T0, T1>(arg0: &0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::Pool<T0, T1>, arg1: &0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::Config, arg2: &0x2::clock::Clock, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: 0x2::balance::Balance<0x2::sui::SUI>, arg7: 0x2::balance::Balance<T0>, arg8: 0x2::balance::Balance<T1>, arg9: u128, arg10: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::Pool<T0, T1>>(arg0);
        let v1 = 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::pool::creator<T0, T1>(arg0);
        let v2 = 0x2::balance::value<T0>(&arg7);
        let v3 = 0x2::balance::value<T1>(&arg8);
        assert!(v2 > 0 && v3 > 0, 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::errors::insufficient_liquidity());
        let (v4, v5) = 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::bluefin::full_range_tick_bits(arg3);
        let v6 = 0x2::coin::get_symbol<T0>(arg4);
        let v7 = *0x1::ascii::as_bytes(&v6);
        0x1::vector::append<u8>(&mut v7, b"-");
        let v8 = 0x2::coin::get_symbol<T1>(arg5);
        0x1::vector::append<u8>(&mut v7, *0x1::ascii::as_bytes(&v8));
        let v9 = 0x2::coin::get_symbol<T0>(arg4);
        let v10 = 0x2::coin::get_symbol<T1>(arg5);
        let (v11, v12, _, _, v15, v16) = 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::bluefin::create_and_seed<T0, T1, 0x2::sui::SUI>(arg2, arg3, v7, metadata_url<T0>(arg4), *0x1::ascii::as_bytes(&v9), 0x2::coin::get_decimals<T0>(arg4), metadata_url<T0>(arg4), *0x1::ascii::as_bytes(&v10), 0x2::coin::get_decimals<T1>(arg5), metadata_url<T1>(arg5), arg9, arg6, v4, v5, arg7, arg8, v3, false, arg10);
        let v17 = v12;
        send_residual<T0>(v15, v1, arg10);
        send_residual<T1>(v16, v1, arg10);
        let v18 = 0x2::clock::timestamp_ms(arg2) + 0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::config::lp_lock_ms(arg1);
        let v19 = BluefinPositionLock{
            id              : 0x2::object::new(arg10),
            pool_id         : v0,
            bluefin_pool_id : v11,
            position        : 0x1::option::some<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v17),
            beneficiary     : v1,
            unlock_ms       : v18,
        };
        0x5cfddf8ba23be6835644a8ea22482ff6ebb0081e42cc1bc052b5f770ca8bbdea::events::emit_bluefin_lock(0x2::object::id<BluefinPositionLock>(&v19), v0, v1, v18, v2, v3, v11, 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(&v17));
        0x2::transfer::share_object<BluefinPositionLock>(v19);
    }
