module 0x63cfe6c068eb85c7619b240415f24d04d1aec6d4db10ef49db987b0986a5de2::reclaim {
    ...
    fun recover_signers_of_signed_claim(arg0: SignedClaim) : vector<vector<u8>> {
        ...
        while (v6 < 0x1::vector::length<vector<u8>>(&arg0.signatures)) {
            0x1::vector::push_back<vector<u8>>(&mut v0, 0x63cfe6c068eb85c7619b240415f24d04d1aec6d4db10ef49db987b0986a5de2::ecdsa::ecrecover_to_eth_address(*0x1::vector::borrow<vector<u8>>(&arg0.signatures, v6), *v5));
            v6 = v6 + 1;
        };
        v0
    }
