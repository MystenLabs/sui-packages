module 0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::token_sale {
    ...
    struct TokenSale has key {
        id: 0x2::object::UID,
        tokens_for_sale: 0x2::balance::Balance<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>,
    ...
    public entry fun claim_tokens(arg0: &mut TokenSale, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        v1.claimed = true;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>>(0x2::coin::from_balance<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(0x2::balance::split<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(&mut arg0.tokens_for_sale, v2), arg2), v0);
    ...
    public entry fun deposit_tokens(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: 0x2::coin::Coin<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>) {
        0x2::balance::join<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(&mut arg1.tokens_for_sale, 0x2::coin::into_balance<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(arg2));
        arg1.tokens_remaining = 0x2::balance::value<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(&arg1.tokens_for_sale);
        let v0 = TokensDeposited{
            amount          : 0x2::coin::value<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(&arg2),
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = TokenSale{
            ...
            tokens_for_sale          : 0x2::balance::zero<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(),
            tokens_remaining         : 0,
    ...
    public entry fun withdraw_unsold_tokens(arg0: &SaleAdminCap, arg1: &mut TokenSale, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.sold_out, 9);
        if (0x2::balance::value<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(&arg1.tokens_for_sale) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>>(0x2::coin::from_balance<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(0x2::balance::withdraw_all<0x6746bde696b9f9e057a163ee9c57c372dd46b76435212d885bdaa4bcf5da449::shttoken::SHTTOKEN>(&mut arg1.tokens_for_sale), arg2), arg1.treasury_wallet);
        };
    }
