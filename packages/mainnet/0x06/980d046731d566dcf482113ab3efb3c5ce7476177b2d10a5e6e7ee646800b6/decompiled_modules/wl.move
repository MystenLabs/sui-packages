module 0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::wl {
    ...
    public fun claim(arg0: &mut WL, arg1: &0x75a2c16938fba807c6e9ff14069bb55e3b7309d184e61e93f2cda22622a29b9::port::Stake, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.cur_index <= arg0.total_wl, 4);
        assert!(!0x2::table::contains<address, Record>(&arg0.user_record, v0), 5);
        assert!(0x1::string::length(&arg2) == 42, 6);
        let v2 = Record{wl_addr: arg2};
        0x2::table::add<address, Record>(&mut arg0.user_record, v0, v2);
        arg0.cur_index = arg0.cur_index + 1;
    }

    public fun create_wl_record(arg0: &0x2::package::Publisher, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<WL>(arg0), 1);
        let v0 = WL{
            ...
            total_wl    : arg3,
            cur_index   : 0,
            user_record : 0x2::table::new<address, Record>(arg4),
        };
    ...
    public fun update_wl_record(arg0: &0x2::package::Publisher, arg1: &mut WL, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<WL>(arg0), 1);
        arg1.start_at = arg2;
        arg1.end_at = arg3;
        arg1.total_wl = arg4;
