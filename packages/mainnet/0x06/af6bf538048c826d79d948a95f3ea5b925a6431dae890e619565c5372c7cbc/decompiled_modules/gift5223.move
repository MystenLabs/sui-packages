module 0x6af6bf538048c826d79d948a95f3ea5b925a6431dae890e619565c5372c7cbc::gift5223 {
    struct GIFT5223 has drop {
        dummy_field: bool,
    }

    struct TICKET_5223 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5223(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5223>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5223>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5223, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5223>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5223>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5223>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5223>>(v5, 0x2::tx_context::sender(arg1));
    }
