module 0x6e0d9687effac493166a8c15015c158fc96d44eb853af84eeed364364e89704::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"GARD", b"GRAD", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-07T13-46-31.710Z-download (4).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"GRAD"),
            symbol     : 0x1::string::utf8(b"GARD"),
            decimals   : 9,
