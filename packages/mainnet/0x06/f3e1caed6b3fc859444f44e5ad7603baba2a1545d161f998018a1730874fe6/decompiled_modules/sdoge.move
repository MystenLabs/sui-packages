module 0x6f3e1caed6b3fc859444f44e5ad7603baba2a1545d161f998018a1730874fe6::sdoge {
    ...
    fun init(arg0: SDOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SDOGE>(arg0, 6, b"SDOGE", b"SUIDOGE Token", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/Qmc4rzRTCGZiZkTKtA1hZMd9LG6eK2wTTMjo5ZFh6QiJma")), arg1);
        let v2 = 0x2::coin::treasury_into_supply<SDOGE>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<SDOGE>>(0x2::coin::from_balance<SDOGE>(0x2::balance::increase_supply<SDOGE>(&mut v2, 1000000000000000000), arg1), 0x2::tx_context::sender(arg1));
        let v3 = SDOGEAdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<SDOGEAdminCap>(v3, 0x2::tx_context::sender(arg1));
        let v4 = SDOGEStorage{
