module 0x64170e730327e3d0d11d9102bcb4a827b9301d2fc613758262ee9a588c4958c::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v9;
        let v11 = v8;
        0x64170e730327e3d0d11d9102bcb4a827b9301d2fc613758262ee9a588c4958c::royalty_policy::set<Item>(&mut v11, &v10, 200);
    ...
    fun verifyMintSignature(arg0: address, arg1: address, arg2: u8, arg3: u8, arg4: vector<u8>, arg5: vector<u8>) : bool {
        ...
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0x64170e730327e3d0d11d9102bcb4a827b9301d2fc613758262ee9a588c4958c::string::u8_to_string(arg2));
        0x1::string::append(&mut v0, 0x1::string::utf8(b"-"));
        0x1::string::append(&mut v0, 0x64170e730327e3d0d11d9102bcb4a827b9301d2fc613758262ee9a588c4958c::string::u8_to_string(arg3));
