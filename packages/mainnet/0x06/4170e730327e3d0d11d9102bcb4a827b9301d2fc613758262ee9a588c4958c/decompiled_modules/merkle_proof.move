module 0x64170e730327e3d0d11d9102bcb4a827b9301d2fc613758262ee9a588c4958c::merkle_proof {
    ...
    fun hash_pair(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
        if (0x64170e730327e3d0d11d9102bcb4a827b9301d2fc613758262ee9a588c4958c::vectors::lt(arg0, arg1)) {
    ...
    public fun verify_with_index(arg0: &vector<vector<u8>>, arg1: vector<u8>, arg2: vector<u8>) : (bool, u256) {
        ...
        while (v1 < 0x1::vector::length<vector<u8>>(arg0)) {
            ...
            let v5 = if (0x64170e730327e3d0d11d9102bcb4a827b9301d2fc613758262ee9a588c4958c::vectors::lt(v0, v4)) {
