module 0x2bd6cc353424ab866a49ebe6f0f16cf1557ac3ab310a36d32d57ae51c9e7e123::cnsnft4239 {
    struct CNSNFT4239 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4239>(arg0, arg1);
