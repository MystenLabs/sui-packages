module 0x2b85fa9c13d78a163ea508043d02c5332ad0cb21dd5a7e01c693a2bb18b5162b::movexnft2540 {
    struct MOVEXNFT2540 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2540, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2540>(arg0, arg1);
