module 0x2b1398399d247ff5802d298fad2d0ae08c7af89e691fa6fb064289d896dbee6d::broc {
    ...
    fun init(arg0: BROC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/GZBPiZUYmYMVhmt3fVGXueH92QdcCgWXfdyRQosmbEG5.png?size=lg&key=146690                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BROC>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BROC    ")))), trim_right(b"Broc                            "), trim_right(b"$BROC is a memecoin inspired by Broc, a whimsical character created by artist Ella May. Blending art, AI, and crypto culture, Broc spreads joy and creativity.                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
