module 0x2b7f00a9d0740527b403cf981214a42c37375049192495a7eceee350307da701::helper {
    public fun calculate_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        let v4 = if (v2 == 0) {
            (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_div_u256((arg2 as u256), (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_to_u128(get_sui_amount(&v3), 1) as u256), (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_to_u128(1, get_token_amount(&v3)) as u256)) as u64)
        } else {
            (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_div_u256((arg2 as u256), (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_to_u128(get_sui_amount(&v3), get_token_amount(&v1)) as u256), (0xd4d2e21e2813cae22c0c62d6b79168689dbdae2bfb67faab57292eac8bdd035e::math::mul_to_u128(v2, get_token_amount(&v3)) as u256)) as u64)
        };
        v4 - arg2
    }
