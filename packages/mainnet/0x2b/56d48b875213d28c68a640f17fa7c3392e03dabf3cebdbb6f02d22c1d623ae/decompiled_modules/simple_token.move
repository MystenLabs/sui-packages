module 0x2b56d48b875213d28c68a640f17fa7c3392e03dabf3cebdbb6f02d22c1d623ae::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"TRUMPGOLD", b"Trump Gold", b"Official token", 0x1::option::none<0x2::url::Url>(), arg1);
