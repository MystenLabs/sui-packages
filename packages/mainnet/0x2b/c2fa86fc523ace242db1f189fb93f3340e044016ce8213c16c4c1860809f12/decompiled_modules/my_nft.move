module 0x2bc2fa86fc523ace242db1f189fb93f3340e044016ce8213c16c4c1860809f12::my_nft {
    ...
    public entry fun mint(arg0: &AdminCap, arg1: vector<u8>, arg2: vector<u8>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = NFT{
            ...
            image_url : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/201323230?v=4"),
        };
