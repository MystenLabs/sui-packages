module 0x2bae7cde1d89fe0f3280905b93c07eb71c2daeb258209c6bc24a9b2c38b6acc6::reward5952 {
    struct REWARD5952 has drop {
        dummy_field: bool,
    }

    struct TICKET_5952 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5952(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5952>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5952>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5952, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5952>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5952>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5952>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5952>>(v5, 0x2::tx_context::sender(arg1));
    }
