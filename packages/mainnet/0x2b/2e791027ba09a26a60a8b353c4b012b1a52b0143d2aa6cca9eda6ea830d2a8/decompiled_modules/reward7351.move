module 0x2b2e791027ba09a26a60a8b353c4b012b1a52b0143d2aa6cca9eda6ea830d2a8::reward7351 {
    struct REWARD7351 has drop {
        dummy_field: bool,
    }

    struct TICKET_7351 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7351(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7351>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7351>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7351, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7351>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7351>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7351>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7351>>(v5, 0x2::tx_context::sender(arg1));
    }
