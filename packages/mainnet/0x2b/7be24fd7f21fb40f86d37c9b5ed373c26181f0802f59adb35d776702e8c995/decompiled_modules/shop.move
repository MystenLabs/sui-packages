module 0x2b7be24fd7f21fb40f86d37c9b5ed373c26181f0802f59adb35d776702e8c995::shop {
    ...
    public fun add_employees<T0>(arg0: &OwnerCap, arg1: &mut DonutShop<T0>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 0x2::table::length<address, bool>(&arg1.employees)) {
    ...
    public fun cetus_cake_for_donut<T0, T1>(arg0: &mut DonutShop<T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u64, arg4: u64, arg5: u128, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg0.employees, 0x2::tx_context::sender(arg8)), 0);
        assert!(0x2::balance::value<T1>(&arg0.balance) >= arg3, 2);
        let v0 = 0x2::coin::take<T1>(&mut arg0.balance, arg3, arg8);
        let v1 = 0x2::coin::zero<T0>(arg8);
        let (v2, v3) = swap<T0, T1>(arg1, arg2, v1, v0, false, arg3, arg5, arg7, arg8);
        let v4 = v2;
        assert!(0x2::balance::value<T0>(0x2::coin::balance<T0>(&v4)) >= arg4, 3);
    ...
    public fun cetus_donut_for_cake<T0, T1>(arg0: &mut DonutShop<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: u64, arg4: u64, arg5: u128, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, bool>(&arg0.employees, 0x2::tx_context::sender(arg8)), 0);
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg3, 2);
        let v0 = 0x2::coin::take<T0>(&mut arg0.balance, arg3, arg8);
        let v1 = 0x2::coin::zero<T1>(arg8);
        let (v2, v3) = swap<T0, T1>(arg1, arg2, v0, v1, true, arg3, arg5, arg7, arg8);
        let v4 = v3;
        assert!(0x2::balance::value<T1>(0x2::coin::balance<T1>(&v4)) >= arg4, 3);
