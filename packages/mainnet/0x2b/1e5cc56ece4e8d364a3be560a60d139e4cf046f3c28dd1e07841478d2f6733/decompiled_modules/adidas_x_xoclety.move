module 0x2b1e5cc56ece4e8d364a3be560a60d139e4cf046f3c28dd1e07841478d2f6733::adidas_x_xoclety {
    struct ADIDAS_X_XOCLETY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ADIDAS_X_XOCLETY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ADIDAS_X_XOCLETY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ADIDAS x XOClETY"));
