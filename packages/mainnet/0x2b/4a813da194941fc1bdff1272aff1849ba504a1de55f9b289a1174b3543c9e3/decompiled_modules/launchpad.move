module 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::launchpad {
    ...
    struct Manager has store, key {
        ...
        pseudorandom_counter: 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::pseudorandom::PseudoRandomCounter,
    }

    struct Collection has store, key {
        id: 0x2::object::UID,
        collection_id: 0x1::string::String,
        mint_box: 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::MintBox,
    ...
    entry fun create_collection(arg0: &Manager, arg1: 0x1::string::String, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::signature::verify_signature<Request>(arg2, arg0.public_key, &v2);
        let v3 = Collection{
            id                : 0x2::object::new(arg3),
            collection_id     : arg1,
            mint_box          : 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::new(arg3),
    ...
    entry fun drop_collection(arg0: &Manager, arg1: Collection, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::destroy(v2);
    ...
    entry fun fund_collection(arg0: &mut Manager, arg1: &Collection, arg2: u64, arg3: vector<u8>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::tx_context::TxContext) {
        ...
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::signature::verify_signature<Request>(arg3, arg0.public_key, &v2);
    ...
    fun init(arg0: LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Manager{
            ...
            balance              : 0x2::balance::zero<0x2::sui::SUI>(),
            pseudorandom_counter : 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::pseudorandom::new(arg1),
        };
    ...
    entry fun load_mint_box(arg0: &Manager, arg1: &mut Collection, arg2: u64, arg3: vector<u256>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::load(&mut arg1.mint_box, arg2, arg3, arg4);
    ...
    entry fun migrate_collection(arg0: &Manager, arg1: 0x1::string::String, arg2: vector<0x1::string::String>, arg3: vector<u64>, arg4: vector<u64>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Collection{
            ...
            collection_id     : arg1,
            mint_box          : 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::new(arg6),
    ...
    public fun mint_edition_nft<T0: store + key>(arg0: &mut Manager, arg1: &0x2::transfer_policy::TransferPolicy<T0>, arg2: &0x2::clock::Clock, arg3: &mut Collection, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: vector<0x1::string::String>, arg11: vector<0x1::string::String>, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: &mut Verification, arg17: vector<u8>, arg18: 0x2::coin::Coin<0x2::sui::SUI>, arg19: T0, arg20: &mut 0x2::kiosk::Kiosk, arg21: &0x2::kiosk::KioskOwnerCap, arg22: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        let v0 = arg3.collection_id;
        0x1::string::append_utf8(&mut v0, b"::");
        let v1 = 0x1::type_name::get<T0>();
        0x1::string::append(&mut v0, 0x1::string::from_ascii(*0x1::type_name::borrow_string(&v1)));
        let v2 = 0x2::tx_context::sender(arg22);
        let v3 = 0x2::tx_context::sender(arg22);
        let v4 = Request{
            sender               : 0x2::bcs::to_bytes<address>(&v2),
            nft_id               : 0x1::vector::empty<u8>(),
            edition_id           : arg4,
            collection_id        : v0,
            order_id             : arg5,
            ...
            price                : arg12,
            fee                  : arg13,
            recipient            : 0x2::bcs::to_bytes<address>(&v3),
        };
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::signature::verify_signature<Request>(arg17, arg0.public_key, &v4);
        ...
        let v5 = upsert_supply(arg3, arg4, arg14, 0x1::option::some<u64>(arg15));
        let v6 = MintNftEvent{
    ...
    public fun mint_nft<T0: store + key>(arg0: &Manager, arg1: &0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut Collection, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: vector<0x1::string::String>, arg9: vector<0x1::string::String>, arg10: u64, arg11: u64, arg12: u64, arg13: address, arg14: &mut Verification, arg15: vector<u8>, arg16: T0, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg2.collection_id;
        0x1::string::append_utf8(&mut v0, b"::");
        let v1 = 0x1::type_name::get<T0>();
        0x1::string::append(&mut v0, 0x1::string::from_ascii(*0x1::type_name::borrow_string(&v1)));
        let v2 = 0x2::tx_context::sender(arg17);
        let v3 = Request{
            sender               : 0x2::bcs::to_bytes<address>(&v2),
            nft_id               : 0x1::vector::empty<u8>(),
            edition_id           : arg3,
        ...
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::signature::verify_signature<Request>(arg15, arg0.public_key, &v3);
        ...
        let (v5, v6) = 0x2::kiosk::new(arg17);
        let v7 = v6;
        let v8 = v5;
        0x2::kiosk::lock<T0>(&mut v8, &v7, arg1, arg16);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v7, arg13);
    ...
    public fun mint_order(arg0: &mut Manager, arg1: &0x2::clock::Clock, arg2: &mut Collection, arg3: 0x1::string::String, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u8>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::signature::verify_signature<Request>(arg7, arg0.public_key, &v2);
        upsert_order(arg2, arg3, 0);
        assert!(0x2::clock::timestamp_ms(arg1) < arg4 * 1000, 3);
        let v3 = MintOrderEvent{
            collection_id : arg2.collection_id,
            order_id      : arg3,
            nft_hash      : 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::get(&mut arg2.mint_box, &mut arg0.pseudorandom_counter, arg9),
        };
    ...
    entry fun unload_mint_box(arg0: &Manager, arg1: &mut Collection, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        while (0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::size(&arg1.mint_box) > arg2 - 0x2::table::length<0x1::string::String, u64>(&arg1.orders)) {
            0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box::pop_back(&mut arg1.mint_box);
        };
    ...
    entry fun withdraw_collection_balance(arg0: &Manager, arg1: &mut Collection, arg2: &CollectionOwnerCap, arg3: u64, arg4: address, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::signature::verify_signature<Request>(arg5, arg0.public_key, &v1);
