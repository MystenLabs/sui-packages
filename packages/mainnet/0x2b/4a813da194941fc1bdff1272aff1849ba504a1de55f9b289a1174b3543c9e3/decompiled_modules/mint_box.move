module 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::mint_box {
    ...
    public(friend) fun get(arg0: &mut MintBox, arg1: &mut 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::pseudorandom::PseudoRandomCounter, arg2: &mut 0x2::tx_context::TxContext) : u256 {
        assert!(!is_empty(arg0), 2);
        let v0 = &mut arg0.box_ids;
        let v1 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v1, 0x2::object::uid_to_bytes(&arg0.id));
        let v2 = 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::pseudorandom::rand(arg1, v1, arg2);
        let v3 = 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::pseudorandom::select_u64(0x1::vector::length<0x2::object::ID>(v0), &v2);
        ...
        let v5 = 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::pseudorandom::rand(arg1, v1, arg2);
        arg0.size = arg0.size - 1;
        ...
        0x1::vector::swap_remove<u256>(v4, 0x2b4a813da194941fc1bdff1272aff1849ba504a1de55f9b289a1174b3543c9e3::pseudorandom::select_u64(0x1::vector::length<u256>(v4), &v5))
    }
