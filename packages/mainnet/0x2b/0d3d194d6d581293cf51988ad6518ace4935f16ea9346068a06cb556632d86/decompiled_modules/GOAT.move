module 0x2b0d3d194d6d581293cf51988ad6518ace4935f16ea9346068a06cb556632d86::GOAT {
    struct GOAT has drop {
        dummy_field: bool,
    }

    fun init(arg0: GOAT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<GOAT>(arg0, 2, b"GOAT", b"Goatseus Maximus", b"Goatseus Maximus", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/xojCqVkmj98LxMX6Dv8yM2-8XksJ5MFXhiOUDehQxis?ext=png")), arg1);
