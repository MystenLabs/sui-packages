module 0x2b5b3cad20a1dfe3563236cac056877d725fed931037bb0a4518a330958f9fcb::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"FISH", b"Fish Coin", b"holders get rewards!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/2bYAz1s.jpg")), arg1);
