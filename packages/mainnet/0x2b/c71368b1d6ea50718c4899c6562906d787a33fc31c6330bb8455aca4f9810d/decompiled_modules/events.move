module 0x51c44bb2ad3ba608cf9adbc6e37ee67268ef9313a4ff70957d4c6e7955dc7eef::events {
    ...
    struct AllowanceDeposited has copy, drop {
        owner: address,
        amount: u64,
        new_balance: u64,
    }

    struct AllowanceDeducted has copy, drop {
        owner: address,
        amount: u64,
        feature: u8,
        remaining: u64,
    ...
    struct AllowanceWithdrawn has copy, drop {
        owner: address,
        amount: u64,
    }
    ...
    public(friend) fun emit_allowance_created(arg0: address, arg1: 0x2::object::ID) {
        let v0 = AllowanceCreated{
            owner        : arg0,
            allowance_id : arg1,
        };
        0x2::event::emit<AllowanceCreated>(v0);
    }

    public(friend) fun emit_allowance_deducted(arg0: address, arg1: u64, arg2: u8, arg3: u64) {
        let v0 = AllowanceDeducted{
            owner     : arg0,
            amount    : arg1,
            feature   : arg2,
            remaining : arg3,
        };
        0x2::event::emit<AllowanceDeducted>(v0);
    }

    public(friend) fun emit_allowance_deposited(arg0: address, arg1: u64, arg2: u64) {
        let v0 = AllowanceDeposited{
            owner       : arg0,
            amount      : arg1,
            new_balance : arg2,
        };
        0x2::event::emit<AllowanceDeposited>(v0);
    }

    public(friend) fun emit_allowance_withdrawn(arg0: address, arg1: u64) {
        let v0 = AllowanceWithdrawn{
            owner  : arg0,
            amount : arg1,
        };
        0x2::event::emit<AllowanceWithdrawn>(v0);
    }
