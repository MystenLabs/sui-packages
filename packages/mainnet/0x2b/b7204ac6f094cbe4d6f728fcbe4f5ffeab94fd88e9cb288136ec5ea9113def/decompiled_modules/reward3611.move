module 0x2bb7204ac6f094cbe4d6f728fcbe4f5ffeab94fd88e9cb288136ec5ea9113def::reward3611 {
    struct REWARD3611 has drop {
        dummy_field: bool,
    }

    struct TICKET_3611 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3611(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3611>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3611>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3611, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3611>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3611>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3611>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3611>>(v5, 0x2::tx_context::sender(arg1));
    }
