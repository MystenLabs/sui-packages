module 0x2b4bc53650d454c4bb092566c91ec8bf9019bbbb56084e625eec0921bc694bee::coffeecoin {
    ...
    fun init(arg0: COFFEECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<COFFEECOIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"coffeecoin  ")))), trim_right(b"coffeecoin                      "), trim_right(b"Building the largest community of coffee lovers in crypto.                                                                                                                                                                                                                                                                      "), v2, arg1);
