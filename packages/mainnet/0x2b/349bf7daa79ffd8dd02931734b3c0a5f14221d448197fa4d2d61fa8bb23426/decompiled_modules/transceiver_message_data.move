module 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::transceiver_message_data {
    struct TransceiverMessageData<T0> has copy, drop {
        ...
        ntt_manager_payload: 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::to_bytes(v2);
        ...
        0x1::vector::append<u8>(&mut v3, 0x2b349bf7daa79ffd8dd02931734b3c0a5f14221d448197fa4d2d61fa8bb23426::ntt_manager_message::to_bytes(v2));
        v3
    }
