module 0x2b3a5b47c0f8055c15dfa854933e44277a4920bd9dc166312fe6911265b2d64a::cnsnft7214 {
    struct CNSNFT7214 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7214, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7214>(arg0, arg1);
