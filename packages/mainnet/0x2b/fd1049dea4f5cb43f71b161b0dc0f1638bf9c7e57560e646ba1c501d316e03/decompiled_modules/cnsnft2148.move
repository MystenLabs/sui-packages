module 0x2bfd1049dea4f5cb43f71b161b0dc0f1638bf9c7e57560e646ba1c501d316e03::cnsnft2148 {
    struct CNSNFT2148 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2148, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2148>(arg0, arg1);
