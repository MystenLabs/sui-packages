module 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::port_oracle {
    ...
    public fun add_pyth_oracle_info_v2<T0>(arg0: &mut PortOracle, arg1: &0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::vault_config::GlobalConfig, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun external_update_price_from_pyth_v2<T0>(arg0: &mut PortOracle, arg1: &0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::vault_config::GlobalConfig, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::vault_config::checked_package_version(arg1);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::error::oracle_info_not_exists());
        let v1 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::get_price_info_from_price_info_object(arg2);
        ...
        let v3 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_timestamp(&v2);
    ...
    public fun pyth_price_from_oracle_info_v2(arg0: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        let v3 = if (0x1::option::is_some<vector<u8>>(&arg1.price_pyth_feed_id)) {
            let v4 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::get_bytes(&v2);
        ...
        let v6 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_price(&v0);
        let v7 = if (0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_is_negative(&v6)) {
            0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_negative(&v6)
        } else {
            0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v6)
        };
        ...
        if (0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_is_negative(&v5)) {
            let v9 = (0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_negative(&v5) as u8);
            if (v9 < 10) {
            ...
            v7 * 0x1::u64::pow(10, (0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v5) as u8) + 10)
        }
    }
    ...
    fun update_price_from_type<T0>(arg0: &mut PortOracle, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : Price {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::error::oracle_info_not_exists());
        ...
        let v2 = if (0x1::option::is_some<0x2::object::ID>(&v1.price_info_object_id)) {
            let v3 = 0x2::object::id<0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject>(arg1);
        ...
        let v4 = Price{
            price            : pyth_price_from_oracle_info_v2(arg1, v1, arg2),
    ...
    public fun update_price_v2<T0>(arg0: &mut PortOracle, arg1: &0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::vault_config::GlobalConfig, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::state::State, arg3: 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::hot_potato_vector::HotPotatoVector<0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfo>, arg4: &mut 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::hot_potato_vector::HotPotatoVector<0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfo> {
        0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::vault_config::checked_package_version(arg1);
        let v0 = split_fee(arg0, 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::state::get_base_update_fee(arg2));
        ...
        0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::pyth::update_single_price_feed(arg2, arg3, arg4, 0x2::coin::from_balance<0x2::sui::SUI>(v0, arg6), arg5)
    }
