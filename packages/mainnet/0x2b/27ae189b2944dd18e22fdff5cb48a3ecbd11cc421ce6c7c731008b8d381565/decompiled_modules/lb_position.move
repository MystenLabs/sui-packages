module 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::lb_position {
    ...
    public(friend) fun change_toggle(arg0: &mut LBPositionInfo) {
        ...
        if (arg0.toggle == 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::constants::max_u16()) {
            arg0.toggle = 0;
        };
    }
    ...
    public(friend) fun collect_saved_fees(arg0: &mut LBPosition) : (u64, u64) {
        arg0.saved_fees_x = 0;
        arg0.saved_fees_y = 0;
        (0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::u128_to_u64(arg0.saved_fees_x >> 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::q64x64::scale_offset()), 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::u128_to_u64(arg0.saved_fees_y >> 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::q64x64::scale_offset()))
    }
    ...
    public(friend) fun collect_saved_rewards(arg0: &mut LBPosition, arg1: u64) : u64 {
        ...
        *0x1::vector::borrow_mut<u128>(&mut arg0.saved_rewards, arg1) = 0;
        0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::u128_to_u64(*0x1::vector::borrow<u128>(&arg0.saved_rewards, arg1) >> 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::q64x64::scale_offset())
    }
    ...
    public(friend) fun decrease_bin_liquidity(arg0: &mut LBBinPosition, arg1: u128) {
        ...
        arg0.amount = 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::sub_u128(arg0.amount, arg1);
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }

    public(friend) fun increase_bin_liquidity(arg0: &mut LBBinPosition, arg1: u128) {
        arg0.amount = 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::add_u128(arg0.amount, arg1);
    }

    public(friend) fun increase_position_total_bins(arg0: &mut LBPosition, arg1: u64) {
        if (arg0.total_bins + arg1 > 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::constants::max_bins()) {
            abort 205
        };
    ...
    public(friend) fun remove_bins(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: vector<u32>) {
        ...
        while (v2 < 0x1::vector::length<u32>(&arg2)) {
            ...
            if (v6 != v3) {
                let v8 = if (v3 != 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::constants::max_u32()) {
            ...
            if (is_bin_active_in_bitmap(v5.active_bins_bitmap, v7)) {
                arg1.total_bins = 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::sub_u64(arg1.total_bins, 1);
        ...
        let v9 = if (v3 != 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::constants::max_u32()) {
            if (v5.active_bins_bitmap == 0) {
                !0x1::vector::contains<u32>(&v1, &v3)
            } else {
                false
    ...
    public(friend) fun settle_position_fees(arg0: &mut LBPosition, arg1: &mut LBBinPosition, arg2: u128, arg3: u128) {
        ...
        arg0.saved_fees_x = 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::add_u128(arg0.saved_fees_x, arg1.amount * 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::sub_u128(arg2, arg1.fee_growth_inside_last_x));
        arg0.saved_fees_y = 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::add_u128(arg0.saved_fees_y, arg1.amount * 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::sub_u128(arg3, arg1.fee_growth_inside_last_y));
        arg1.fee_growth_inside_last_x = arg2;
        arg1.fee_growth_inside_last_y = arg3;
    }
        ...
        while (v0 < 0x1::vector::length<u128>(&arg2)) {
            ...
            if (v1 > v2) {
                ...
                if (v3 > 0) {
                    ...
                    *0x1::vector::borrow_mut<u128>(&mut arg0.saved_rewards, v0) = 0x2b27ae189b2944dd18e22fdff5cb48a3ecbd11cc421ce6c7c731008b8d381565::safe_math::add_u128(*0x1::vector::borrow<u128>(&arg0.saved_rewards, v0), v3);
                };
            };
            v0 = v0 + 1;
        };
