module 0x2ba44bd01fad9422c749143674395d2c8f2c8720f74ba2dbe40cbd96405f66e3::reward5057 {
    struct REWARD5057 has drop {
        dummy_field: bool,
    }

    struct TICKET_5057 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5057(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5057>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5057>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5057, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5057>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5057>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5057>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5057>>(v5, 0x2::tx_context::sender(arg1));
    }
