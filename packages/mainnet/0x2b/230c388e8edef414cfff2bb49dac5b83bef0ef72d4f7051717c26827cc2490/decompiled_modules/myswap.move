module 0x2b230c388e8edef414cfff2bb49dac5b83bef0ef72d4f7051717c26827cc2490::myswap {
    ...
    public entry fun Add<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<T0>(&mut arg0.coin_a, 0x2::balance::split<T0>(0x2::coin::balance_mut<T0>(arg1), 1));
