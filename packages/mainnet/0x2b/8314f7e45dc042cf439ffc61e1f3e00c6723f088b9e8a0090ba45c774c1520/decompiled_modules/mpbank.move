module 0x2b8314f7e45dc042cf439ffc61e1f3e00c6723f088b9e8a0090ba45c774c1520::mpbank {
    ...
    public fun add_to_bank<T0>(arg0: &mut Bank<T0>, arg1: 0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(&arg1) > 0, 0);
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(arg1));
    }

    public fun create_bank<T0>(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_from_bank<T0>(arg0: &0x2::package::Publisher, arg1: &mut Bank<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x2::package::from_package<MPBANK>(arg0), 1);
