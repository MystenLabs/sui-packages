module 0x2be27c8cef30acff1b8a6e26d83408f013bf17a5f1cf0e4250b5e1813259338f::reward4345 {
    struct REWARD4345 has drop {
        dummy_field: bool,
    }

    struct TICKET_4345 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4345(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4345>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4345>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4345, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4345>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4345>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4345>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4345>>(v5, 0x2::tx_context::sender(arg1));
    }
