module 0x2b60d547a2c8dd3d0d0a8fe25744e3abbcfc8bf6d4ead1dd4396247cc057020f::ELON {
    ...
    fun init(arg0: ELON, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<ELON>(arg0, 9, b"MEOWTH", b"MEOWTH Trump Power", b"MEOWTH Trump Power great again", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
