module 0x2bb3bb3a677c643a5e5df2b47e9e3167c5085fbb7720c9186971c9cce071d839::toonfrenz {
    struct TOONFRENZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TOONFRENZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TOONFRENZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ToonFRENZ"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeienhpos3bxuirm72f6joyi73c4auzjuk7ze7fgcuyflzlep6onipa"));
