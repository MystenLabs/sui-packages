module 0x2b81c0cdaf89f7a4ed4470ac8e39679e04d4a9a89ce3409fad76803d7fbdaf30::pdiddy {
    ...
    fun init(arg0: PDIDDY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PDIDDY>(arg0, 6, b"DIDDY", b"P.DIDDY", b"P. Diddy Memecoin $DIDDY is a cryptocurrency inspired by the larger-than-life personality of P. Diddy (Sean Combs).    https://x.com/stevesuicoin   https://t.me/stevesui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://belaunchio.infura-ipfs.io/ipfs/QmXNEFzsdmLBWQ1ZH5Q89sibNn5pzh55jxFCZx4jisbNX8")), arg1);
