module 0x2b591e11b043f353218a257000a6f2e0c2668f934606a0c495070329947b2fc1::nft {
    ...
    public(friend) fun new(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : CoCoNFT {
        CoCoNFT{
    ...
    public(friend) fun uid_mut_as_owner(arg0: &mut CoCoNFT) : &mut 0x2::object::UID {
        &mut arg0.id
    }
