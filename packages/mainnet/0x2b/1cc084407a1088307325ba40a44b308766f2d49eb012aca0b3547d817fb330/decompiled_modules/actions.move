module 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::actions {
    ...
    public fun claim_maya(arg0: 0x2::coin::Coin<0x3bf0aeb7b9698b18ec7937290a5701088fcd5d43ad11a2564b074d022a6d71ec::maya::MAYA>, arg1: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::booster_pool::BoosterPool, arg2: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::ChakraNFT, arg3: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::leaderboard::Leaderboard, arg4: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::GlobalConfig, arg5: &0x2::clock::Clock) {
        ...
        let v3 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::referee_code(arg2);
        if (!0x1::string::is_empty(&v3)) {
            let (v4, v5) = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::referral_bonus_percentage(arg4);
            let v6 = v1 * v4 / v5;
            if (v6 > 0) {
                0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::increment_claimable_from_referral(arg4, v3, v6);
            };
        };
        let v7 = 0;
        if (v2 > 0) {
            let v8 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::booster_pool::calc_bonus(v2, v1);
            v7 = v8;
            0x2::balance::join<0x3bf0aeb7b9698b18ec7937290a5701088fcd5d43ad11a2564b074d022a6d71ec::maya::MAYA>(&mut v0, 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::booster_pool::take_bonus(arg1, v8));
        };
        let (v9, v10) = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::bonus_percentage_per_claim(arg4);
        let v11 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::max_bonus_per_claim(arg4);
        let v12 = v1 * v9 / v10;
        let v13 = v12;
        if (v12 > v11) {
            v13 = v11;
        };
        0x2::balance::join<0x3bf0aeb7b9698b18ec7937290a5701088fcd5d43ad11a2564b074d022a6d71ec::maya::MAYA>(&mut v0, 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::booster_pool::take_bonus(arg1, v13));
        let v14 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::booster_pool::burn_maya(arg1, v0);
        ...
        0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::add_maya_burnt(arg2, arg4, v14);
    ...
    public fun set_version(arg0: &0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::admin::AdminCap, arg1: &0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::version::VersionCap, arg2: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::GlobalConfig, arg3: u64, arg4: u64) {
        0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::version::set_version(0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::version_mut(arg0, arg2), arg1, arg3, arg4);
    }

    public fun update_retro_allo(arg0: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::ChakraNFT, arg1: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::GlobalConfig, arg2: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::retro::RetroUsersList, arg3: &mut 0x2::tx_context::TxContext) {
        0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::version::assert_v(0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::version(arg1));
        assert!(0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::retro::exists(arg2, 0x2::tx_context::sender(arg3)), 109);
        let (v0, v1) = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::retro::get_user_info(arg2, 0x2::tx_context::sender(arg3));
        0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::update_s_alloc(arg0, v0, v1);
    }

    public fun upgrade_major(arg0: &0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::admin::AdminCap, arg1: &0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::version::VersionCap, arg2: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::GlobalConfig) {
        0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::version::upgrade_major(0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::version_mut(arg0, arg2), arg1);
    }

    public fun upgrade_minor(arg0: &0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::admin::AdminCap, arg1: &0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::version::VersionCap, arg2: &mut 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::GlobalConfig, arg3: u64) {
        0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::version::upgrade_minor(0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::chakra_nft::version_mut(arg0, arg2), arg3, arg1);
    }
