module 0x2b051bedae48f58b4cb12314790bf1c3b8962f2d691a684367053fe21f41ff4b::me {
    struct ME has drop {
        dummy_field: bool,
    }

    fun init(arg0: ME, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ME>(arg0, 6, b"ME", b"MemEconomy", b"MemEconomy combines the best of meme culture with tokenomics. We're not just another meme token  we're the economy of memes itself. Built by meme lovers, for meme lovers.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/Qm_Zha_BKS_Bf_KGUJZK_Pvzxis_Gb_L_Ew9_Qi_W5_H_Lv_B_Av_NFP_Qk_MJ_4_7f1c4d71b8.jpg")), arg1);
