module 0x2b17e5b7a5c7cf9e2e4849bb43a7b62f7a14015c4af81854829872828fddec65::game6337 {
    struct GAME6337 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeTicket6337(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GAME6337, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6337>(arg0, arg1);
