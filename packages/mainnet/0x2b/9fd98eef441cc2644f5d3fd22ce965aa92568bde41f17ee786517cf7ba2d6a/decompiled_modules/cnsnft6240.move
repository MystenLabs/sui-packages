module 0x2b9fd98eef441cc2644f5d3fd22ce965aa92568bde41f17ee786517cf7ba2d6a::cnsnft6240 {
    struct CNSNFT6240 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6240, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6240>(arg0, arg1);
