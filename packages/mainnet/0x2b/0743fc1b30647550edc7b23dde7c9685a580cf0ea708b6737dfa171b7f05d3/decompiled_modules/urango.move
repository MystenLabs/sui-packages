module 0x2b0743fc1b30647550edc7b23dde7c9685a580cf0ea708b6737dfa171b7f05d3::urango {
    ...
    fun init(arg0: URANGO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<URANGO>(arg0, 9, b"Urango", b"TAN", b"Unchain haven for me.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://ipfs.io/ipfs/bafkreihlwhhnezzp5crm2rhaksxtzxkfgc6gbkjz76seipklsvsyt3griq")), arg1);
        let v2 = v0;
        ...
        let v3 = Socials{
            ...
            website  : 0x1::string::utf8(b"https://urango.com"),
