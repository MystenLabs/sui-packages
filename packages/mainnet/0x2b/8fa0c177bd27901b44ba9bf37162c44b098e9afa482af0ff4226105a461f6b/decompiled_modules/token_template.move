module 0x2b8fa0c177bd27901b44ba9bf37162c44b098e9afa482af0ff4226105a461f6b::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T123941", b"Test 123941", b"Integration test token 2025-10-28T00:42:03.941Z", 0x1::option::none<0x2::url::Url>(), arg1);
