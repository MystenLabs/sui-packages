module 0x2bfd94873b722b9e24baf6fef41916ac2a6545f3a27990f705690b3ac09fb053::reward2718 {
    struct REWARD2718 has drop {
        dummy_field: bool,
    }

    struct TICKET_2718 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2718(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2718>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2718>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2718, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2718>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2718>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2718>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2718>>(v5, 0x2::tx_context::sender(arg1));
    }
