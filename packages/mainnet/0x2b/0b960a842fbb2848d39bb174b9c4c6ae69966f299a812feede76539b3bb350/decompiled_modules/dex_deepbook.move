module 0x2b0b960a842fbb2848d39bb174b9c4c6ae69966f299a812feede76539b3bb350::dex_deepbook {
    ...
    public fun get_deepbook_package() : address {
        0x2b0b960a842fbb2848d39bb174b9c4c6ae69966f299a812feede76539b3bb350::constants::deepbook_package()
    }
    ...
    public fun validate_sui_usdc_swap(arg0: u64, arg1: u64, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : bool {
        ...
        let v0 = DeepBookRealSwapExecuted{
            ...
            pool_id         : arg2,
            package         : 0x2b0b960a842fbb2848d39bb174b9c4c6ae69966f299a812feede76539b3bb350::constants::deepbook_package(),
