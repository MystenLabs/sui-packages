module 0x2b32fc2783b7bd2ae641706014c7e9c3bca01636807a8da65bd36a54ac40a15f::cnsnft6458 {
    struct CNSNFT6458 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6458, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9486"));
        let v4 = 0x2::package::claim<CNSNFT6458>(arg0, arg1);
