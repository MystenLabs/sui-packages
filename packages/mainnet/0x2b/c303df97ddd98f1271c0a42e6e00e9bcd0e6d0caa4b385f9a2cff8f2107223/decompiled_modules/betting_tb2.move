module 0xc6ea3100c63cd2e27f9a75b9a6ea2db33f58be4b39a07bb11bf5f424b212aa76::betting_tb2 {
    ...
    public entry fun mint_oracle_cap_self(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = OracleCap{id: 0x2::object::new(arg2)};
        let v2 = OracleCapMinted{
            oracle_cap_id : 0x2::object::id<OracleCap>(&v1),
            recipient     : v0,
            timestamp     : 0x2::clock::timestamp_ms(arg1),
        };
        0x2::event::emit<OracleCapMinted>(v2);
    ...
    public entry fun settle_bet_td2_admin(arg0: &AdminCap, arg1: &mut BettingPlatformTb2, arg2: &mut BetTb2, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = TokenStateKey<0xd7ca095524ec25cd3a276506d8045ef4992c82381145dec375a9ede9b34b5b02::td2::TD2>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<TokenStateKey<0xd7ca095524ec25cd3a276506d8045ef4992c82381145dec375a9ede9b34b5b02::td2::TD2>>(&arg1.id, v0), 32);
        let v1 = OracleCap{id: 0x2::object::new(arg5)};
        settle_bet<0xd7ca095524ec25cd3a276506d8045ef4992c82381145dec375a9ede9b34b5b02::td2::TD2>(&v1, arg1, arg2, arg3, arg4, arg5);
        let OracleCap { id: v2 } = v1;
