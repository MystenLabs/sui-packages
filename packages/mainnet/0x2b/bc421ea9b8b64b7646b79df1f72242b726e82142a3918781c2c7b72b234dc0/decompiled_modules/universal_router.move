module 0x41d242496b2a3e7cb591a5e66fc984e314e298d9314dc10eca068bd0d450ce91::universal_router {
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0x41d242496b2a3e7cb591a5e66fc984e314e298d9314dc10eca068bd0d450ce91::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
