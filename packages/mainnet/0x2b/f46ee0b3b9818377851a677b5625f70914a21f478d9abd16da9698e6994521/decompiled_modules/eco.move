module 0x2bf46ee0b3b9818377851a677b5625f70914a21f478d9abd16da9698e6994521::eco {
    struct ECO has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ECO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<ECO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ECO       ")))), trim_right(b"ECO AI                          "), trim_right(b"EcoAI: AI-driven agents ecosystem creating innovative utilities, generating revenue, and promoting sustainability.                                                                                                                                                                                                              "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
