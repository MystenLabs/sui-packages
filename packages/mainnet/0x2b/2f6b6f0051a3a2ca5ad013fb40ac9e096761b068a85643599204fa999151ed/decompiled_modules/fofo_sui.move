module 0x2b2f6b6f0051a3a2ca5ad013fb40ac9e096761b068a85643599204fa999151ed::fofo_sui {
    struct FOFO_SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FOFO_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<FOFO_SUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"fofo sui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"fofo sui meme nft for haha :)"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihkcnm2ipojwygd2o3f73ql5sqzdcpnrdqda734bxgzfawfp2ketq"));
