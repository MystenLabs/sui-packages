module 0x2be1fd58b35339691dda1f29bf2f2d04a07be7a149d5e3f8c79563cfdaaef7c2::babysui {
    ...
    fun init(arg0: BABYSUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<BABYSUI>(&mut v2, 10000000000, 0x2::tx_context::sender(arg1), arg1);
