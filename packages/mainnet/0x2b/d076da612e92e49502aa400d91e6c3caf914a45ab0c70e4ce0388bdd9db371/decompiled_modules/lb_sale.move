module 0x2bd076da612e92e49502aa400d91e6c3caf914a45ab0c70e4ce0388bdd9db371::lb_sale {
    ...
    public entry fun deposit_lb<T0, T1>(arg0: &mut SaleConfig<T0, T1>, arg1: &AdminCap, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert_admin<T0, T1>(arg0, v0);
        0x2::balance::join<T1>(&mut arg0.lb_balance, 0x2::coin::into_balance<T1>(arg2));
        let v1 = LBDeposited{
            amount        : 0x2::coin::value<T1>(&arg2),
            deposited_by  : v0,
            total_balance : 0x2::balance::value<T1>(&arg0.lb_balance),
        };
        0x2::event::emit<LBDeposited>(v1);
    }
