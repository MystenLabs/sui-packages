module 0x2be6f494afd396821aaf69faf196bd1ae14597d549e814e7b8832e849ba0ea32::ouroboros {
    ...
    fun init(arg0: OUROBOROS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<OUROBOROS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Ouroboros"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Symbol of The Order"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeigb6xrpj2med6ddergq7wyeuvklpoih5ipr52tz3zu7ttnfiytupi"));
