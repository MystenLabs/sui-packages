module 0x2bfcb1e2ecc8f909681f1207e6359655ea04a73919e10d642c9250ba53fb73f0::staking_pool {
    ...
    public entry fun withdraw(arg0: &mut StakingPool, arg1: u64, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        *0x2::table::borrow_mut<address, u64>(&mut arg0.user_staked_amounts, v0) = v16;
        if (v16 == 0) {
            let v17 = 0;
            while (v17 < 0x1::vector::length<address>(&arg0.user_addresses)) {
                if (*0x1::vector::borrow<address>(&arg0.user_addresses, v17) == v0) {
                    0x1::vector::remove<address>(&mut arg0.user_addresses, v17);
                    break
                };
                v17 = v17 + 1;
            };
