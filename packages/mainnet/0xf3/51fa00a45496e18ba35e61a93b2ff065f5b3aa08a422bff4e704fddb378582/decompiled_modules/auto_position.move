module 0xf351fa00a45496e18ba35e61a93b2ff065f5b3aa08a422bff4e704fddb378582::auto_position {
    ...
    public fun new<T0: store + key>(arg0: T0, arg1: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg2: address, arg3: u64, arg4: &0xf351fa00a45496e18ba35e61a93b2ff065f5b3aa08a422bff4e704fddb378582::registry::ProxyCap) : AutoPosition<T0> {
        assert!(arg3 < 0xf351fa00a45496e18ba35e61a93b2ff065f5b3aa08a422bff4e704fddb378582::constants::scaling_pips(), 2);
        AutoPosition<T0>{
            owner         : arg2,
    ...
    public(friend) fun set_slippage_pips<T0: store + key>(arg0: &mut AutoPosition<T0>, arg1: u64) {
        assert!(arg1 < 0xf351fa00a45496e18ba35e61a93b2ff065f5b3aa08a422bff4e704fddb378582::constants::scaling_pips(), 2);
    ...
    public fun unwrap<T0: store + key>(arg0: AutoPosition<T0>, arg1: &0xf351fa00a45496e18ba35e61a93b2ff065f5b3aa08a422bff4e704fddb378582::registry::ProxyCap) : (address, T0, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, u64) {
        let AutoPosition {
            owner         : v0,
            inner         : v1,
            vault         : v2,
