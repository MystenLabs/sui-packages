module 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::oracle_ag {
    ...
    fun new(arg0: &mut 0x2::tx_context::TxContext) : (OracleAggregator, OracleAggregatorCap) {
        let v0 = OracleAggregator{
            ...
            max_age               : 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::consts::GET_PYTH_MAX_AGE(),
    ...
    public fun assert_oracle_aggregator_cap(arg0: &OracleAggregator, arg1: &OracleAggregatorCap) {
        assert!(0x2::object::id<OracleAggregator>(arg0) == arg1.oracle_aggregator, 13906834410566582271);
    }
    ...
    public fun assert_price_object_type_v2<T0>(arg0: &OracleAggregator, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject) {
        ...
        assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::get_bytes(&v2) == *0x2::table::borrow<0x1::ascii::String, vector<u8>>(&arg0.pyth_price_id_table, v0), 0);
    }
    ...
    public fun calc_usd_value_v2<T0>(arg0: &OracleAggregator, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        assert_price_object_type_v2<T0>(arg0, arg1);
        let (v0, v1, _) = get_price_v2<T0>(arg0, arg1, arg3);
        0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_math::scale_from_float(0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_math::mul_u128(0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_math::scale_to_float(arg2, (get_coin_decimal<T0>(arg0) as u64)), 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::lotus_math::scale_to_float(v0, v1)), 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::consts::GET_USDC_DECIMALS())
    }
    ...
    public fun get_price_v2<T0>(arg0: &OracleAggregator, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u64, u64) {
        let v0 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::pyth::get_price_no_older_than(arg1, arg2, arg0.max_age);
        let v1 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::get_price_info_from_price_info_object(arg1);
        let v2 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::get_price_identifier(&v1);
        ...
        assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::get_bytes(&v2) == *0x2::table::borrow<0x1::ascii::String, vector<u8>>(&arg0.pyth_price_id_table, v3), 0);
        ...
        let (v6, v7) = if (0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_is_negative(&v5) == true) {
            let v8 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v4);
            assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_conf(&v0) < v8 * 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::consts::GET_MAX_PRICE_CONF_BPS() / 10000, 2);
            (v8, 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_negative(&v5))
        } else {
            let v9 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v4) * 0x1::u64::pow(10, (0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v5) as u8));
            assert!(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_conf(&v0) < v9 * 0x5415784bf0d7bbcbffadf8e3b62090aba53706808378e9340013fdda81ed0140::consts::GET_MAX_PRICE_CONF_BPS() / 10000, 2);
            (v9, 0)
        };
        (v6, v7, 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_timestamp(&v0))
    }
    ...
    public fun update_max_age(arg0: &mut OracleAggregator, arg1: &OracleAggregatorCap, arg2: u64) {
        assert_oracle_aggregator_cap(arg0, arg1);
        assert!(arg2 >= 1 && arg2 <= 60, 13906834900192854015);
        arg0.max_age = arg2;
    }
