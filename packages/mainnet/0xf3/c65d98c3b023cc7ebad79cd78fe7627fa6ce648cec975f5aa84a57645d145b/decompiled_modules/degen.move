module 0xf3c65d98c3b023cc7ebad79cd78fe7627fa6ce648cec975f5aa84a57645d145b::degen {
    ...
    public fun authorize_app<T0>(arg0: &mut 0x2::object::UID, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://api.degensdragonsgame.com/degen-avatars/DEGEN_{head}_{body}_{weapon}.webp?token_id={token_id}"));
        ...
        let v5 = 0x2::display::new_with_fields<Degen<0xf3c65d98c3b023cc7ebad79cd78fe7627fa6ce648cec975f5aa84a57645d145b::collectible::Collectible>>(&v4, v0, v2, arg1);
        0x2::display::update_version<Degen<0xf3c65d98c3b023cc7ebad79cd78fe7627fa6ce648cec975f5aa84a57645d145b::collectible::Collectible>>(&mut v5);
        let v6 = AdminCap{id: 0x2::object::new(arg1)};
        0x2::transfer::public_transfer<AdminCap>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Degen<0xf3c65d98c3b023cc7ebad79cd78fe7627fa6ce648cec975f5aa84a57645d145b::collectible::Collectible>>>(v5, 0x2::tx_context::sender(arg1));
    }
    ...
    public fun setup_transfer_policy<T0>(arg0: &AdminCap, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::transfer_policy::new<Degen<T0>>(arg1, arg2);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<Degen<T0>>>(v0);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Degen<T0>>>(v1, 0x2::tx_context::sender(arg2));
    }
