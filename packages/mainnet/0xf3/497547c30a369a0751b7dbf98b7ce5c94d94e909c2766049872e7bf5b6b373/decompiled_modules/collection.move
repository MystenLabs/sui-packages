module 0xf3497547c30a369a0751b7dbf98b7ce5c94d94e909c2766049872e7bf5b6b373::collection {
    ...
    public entry fun changeCollectionDescription(arg0: 0x1::string::String, arg1: &mut Collection, arg2: &mut 0x2::tx_context::TxContext) {
        0xf3497547c30a369a0751b7dbf98b7ce5c94d94e909c2766049872e7bf5b6b373::admin::is_admin(arg1.admin, 0x2::tx_context::sender(arg2));
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Collection{
            ...
            name                   : 0x1::string::utf8(b"BUDDY"),
            description            : 0x1::string::utf8(b"Cute, lovable, and fun-loving dogs roaming in the Web 3 space."),
            supply                 : 420,
            url                    : 0x2::url::new_unsafe_from_bytes(b"https://bettasui.xyz/collection/38/profile.png"),
            metadata_uri           : 0x1::string::utf8(b"https://ipfs.io/ipfs/QmPS67tDLtJk6JMi36nwFAVbKy8UDmRnmLe1mHsAZZGXyi/420 buddies labs"),
            minted                 : 0,
            max_mint_per_whitelist : 1,
            whitelist_price        : 0,
            max_public_per_wallet  : 5,
            public_price           : 1000000000,
            launchpad_fee          : 3,
            creator                : @0xbf75e6c2ea0c595dbd78f4edfd64b82351d3b90f8d1ae007a70f1e29c45fd9f5,
