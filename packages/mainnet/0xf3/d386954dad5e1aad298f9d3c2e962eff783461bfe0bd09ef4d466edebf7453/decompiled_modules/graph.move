module 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::graph {
    struct SignedFixedLayer has copy, drop {
        name: vector<u8>,
        layer_type: vector<u8>,
        in_dim: u64,
        out_dim: u64,
        weight_tensor: 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor,
        bias_tensor: 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor,
    }

    struct SignedFixedGraph has drop {
    ...
    public fun DenseSignedFixed(arg0: &mut SignedFixedGraph, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: u64) : SignedFixedLayer {
        ...
        let v9 = SignedFixedLayer{
            ...
            in_dim        : arg1,
            out_dim       : arg2,
            weight_tensor : 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::create_signed_fixed(v3, v0, v1, arg4),
            bias_tensor   : 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::create_signed_fixed(v8, v5, v6, arg4),
        };
    ...
    public fun apply_dense_signed_fixed(arg0: &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor, arg1: &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor, arg2: &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor) : 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor {
        let v0 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_shape(arg0);
        let v1 = *0x1::vector::borrow<u64>(&v0, 0);
        let v2 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_shape(arg0);
        let v3 = *0x1::vector::borrow<u64>(&v2, 1);
        let v4 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_shape(arg1);
        let v5 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_shape(arg1);
        let v6 = *0x1::vector::borrow<u64>(&v5, 1);
        let v7 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_shape(arg2);
        assert!(v3 == *0x1::vector::borrow<u64>(&v4, 0), 10001);
        assert!(v6 == *0x1::vector::borrow<u64>(&v7, 0), 10002);
        let v8 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_scale(arg0);
        assert!(v8 == 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_scale(arg1), 10003);
        assert!(v8 == 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_scale(arg2), 10004);
        ...
        while (v12 < v1) {
            ...
            while (v13 < v6) {
                ...
                while (v16 < v3) {
                    let v17 = v12 * v3 + v16;
                    let v18 = v16 * v6 + v13;
                    let v19 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_sign(arg0);
                    let v20 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_magnitude(arg0);
                    let v21 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_sign(arg1);
                    let v22 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_magnitude(arg1);
                ...
                let v26 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_sign(arg2);
                let v27 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_magnitude(arg2);
                let (v28, v29) = signed_add_element(v14, v15, *0x1::vector::borrow<u64>(&v26, v13), *0x1::vector::borrow<u64>(&v27, v13) * 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::scale_up(1, v8));
                let v30 = v28;
                let v31 = v29;
                if (v28 == 1) {
                    v30 = 0;
                ...
                0x1::vector::push_back<u64>(&mut v10, v31 / 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::scale_up(1, v8));
                v13 = v13 + 1;
            };
            v12 = v12 + 1;
        };
        0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::create_signed_fixed(v9, v10, v11, v8)
    }

    public fun apply_dense_signed_fixed_2(arg0: &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor, arg1: &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor, arg2: &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor, arg3: u64) : 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor {
        let v0 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_shape(arg0);
        let v1 = *0x1::vector::borrow<u64>(&v0, 0);
        let v2 = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::get_shape(arg0);
        let v3 = *0x1::vector::borrow<u64>(&v2, 1);
    ...
    public fun create_signed_graph() : SignedFixedGraph {
        SignedFixedGraph{layers: 0x1::vector::empty<SignedFixedLayer>()}
    }
    ...
    public fun get_bias_tensor(arg0: &SignedFixedLayer) : &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor {
        &arg0.bias_tensor
    }
    ...
    public fun get_weight_tensor(arg0: &SignedFixedLayer) : &0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::SignedFixedTensor {
        &arg0.weight_tensor
    }
    ...
    public fun set_layer_weights_signed_fixed(arg0: &mut SignedFixedGraph, arg1: vector<u8>, arg2: vector<u64>, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: u64, arg7: u64, arg8: u64) {
        ...
        while (v0 < 0x1::vector::length<SignedFixedLayer>(&arg0.layers)) {
            ...
            if (v1.name == arg1) {
                ...
                v1.weight_tensor = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::create_signed_fixed(v2, arg2, arg3, arg8);
                let v4 = 0x1::vector::empty<u64>();
                0x1::vector::push_back<u64>(&mut v4, arg7);
                v1.bias_tensor = 0xf3d386954dad5e1aad298f9d3c2e962eff783461bfe0bd09ef4d466edebf7453::tensor::create_signed_fixed(v4, arg4, arg5, arg8);
                return
            };
            v0 = v0 + 1;
        };
