module 0xf392d97c1af2189a14ffd4d60a5709ba71bb8e73225d4e5c3bf93f7af432a4dc::rewards_pool {
    ...
    public(friend) fun new<T0>(arg0: &0xf392d97c1af2189a14ffd4d60a5709ba71bb8e73225d4e5c3bf93f7af432a4dc::spool::Spool, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : RewardsPool<T0> {
        RewardsPool<T0>{
    ...
    public fun assert_spool_id<T0>(arg0: &RewardsPool<T0>, arg1: &0xf392d97c1af2189a14ffd4d60a5709ba71bb8e73225d4e5c3bf93f7af432a4dc::spool::Spool) {
        assert!(arg0.spool_id == 0x2::object::id<0xf392d97c1af2189a14ffd4d60a5709ba71bb8e73225d4e5c3bf93f7af432a4dc::spool::Spool>(arg1), 16);
    }
    ...
    public(friend) fun redeem_rewards<T0, T1>(arg0: &mut RewardsPool<T1>, arg1: &mut 0xf392d97c1af2189a14ffd4d60a5709ba71bb8e73225d4e5c3bf93f7af432a4dc::spool_account::SpoolAccount<T0>) : 0x2::balance::Balance<T1> {
        let v0 = 0x2::math::min(calculate_point_to_reward<T1>(arg0, 0xf392d97c1af2189a14ffd4d60a5709ba71bb8e73225d4e5c3bf93f7af432a4dc::spool_account::points<T0>(arg1)), 0x2::balance::value<T1>(&arg0.rewards));
        arg0.claimed_rewards = arg0.claimed_rewards + v0;
        0xf392d97c1af2189a14ffd4d60a5709ba71bb8e73225d4e5c3bf93f7af432a4dc::spool_account::redeem_point<T0>(arg1, calculate_reward_to_point<T1>(arg0, v0));
