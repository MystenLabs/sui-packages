module 0xf3901b58b8de91cdd4411052d7059314b2e87bea02e769ba4965cd731c4a8aff::cnsnft5183 {
    struct CNSNFT5183 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5183, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5183>(arg0, arg1);
