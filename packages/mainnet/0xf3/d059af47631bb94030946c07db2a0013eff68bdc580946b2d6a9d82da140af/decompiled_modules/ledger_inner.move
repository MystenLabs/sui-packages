module 0xf3d059af47631bb94030946c07db2a0013eff68bdc580946b2d6a9d82da140af::ledger_inner {
    ...
    public(friend) fun add_presign(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : address {
        let v0 = arg0.dwallet_network_encryption_key_id;
        let v1 = app_state_mut(arg0, arg2);
        assert!(!v1.paused, 14);
        assert!(arg3 < v1.wallet_count, 8);
        assert!(0x1::vector::length<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(&wallet(v1, arg3).unverified_presign_caps) < 100, 0);
        let (v2, v3) = withdraw_payment_coins(v1, arg4);
        let v4 = v3;
        let v5 = v2;
        let v6 = wallet_mut(v1, arg3);
        let v7 = random_session_identifier(arg1, arg4);
        0x1::vector::push_back<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(&mut v6.unverified_presign_caps, 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_global_presign(arg1, v0, v6.curve, v6.signature_algorithm, v7, &mut v5, &mut v4, arg4));
        0xf3d059af47631bb94030946c07db2a0013eff68bdc580946b2d6a9d82da140af::events::emit_presign_added(arg2, v6.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v6.dwallet_cap), 0x1::vector::length<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::UnverifiedPresignCap>(&v6.unverified_presign_caps));
        return_payment_coins(v1, v5, v4);
        v6.dwallet
    }
    ...
    public(friend) fun add_wallet(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: u32, arg8: u32, arg9: u32, arg10: &mut 0x2::tx_context::TxContext) : (u64, address) {
        let v0 = arg0.dwallet_network_encryption_key_id;
        let v1 = app_state_mut(arg0, arg2);
        assert!(!v1.paused, 14);
        let (v2, v3) = withdraw_payment_coins(v1, arg10);
        let v4 = v3;
        let v5 = v2;
        let (v6, _) = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::request_dwallet_dkg_with_public_user_secret_key_share(arg1, v0, arg7, arg3, arg4, arg5, 0x1::option::none<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::SignDuringDKGRequest>(), 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::register_session_identifier(arg1, arg6, arg10), &mut v5, &mut v4, arg10);
        let v8 = v6;
        let v9 = 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::dwallet_id(&v8);
        ...
        let v12 = v1.wallet_count;
        0xf3d059af47631bb94030946c07db2a0013eff68bdc580946b2d6a9d82da140af::events::emit_wallet_added(arg2, v11.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v11.dwallet_cap), v12, arg7, arg8, arg9);
        0x2::object_table::add<u64, Wallet>(&mut v1.wallets, v12, v11);
        v1.wallet_count = v1.wallet_count + 1;
        return_payment_coins(v1, v5, v4);
        (v12, v10)
    }
    ...
    public(friend) fun decrement_balance(arg0: &mut StateV1, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: vector<u8>, arg5: vector<u8>, arg6: address, arg7: u8, arg8: vector<u8>, arg9: u256, arg10: &mut 0x2::tx_context::TxContext) : (u256, 0x2::object::ID) {
        ...
        0xf3d059af47631bb94030946c07db2a0013eff68bdc580946b2d6a9d82da140af::events::emit_decrement_balance(arg2, arg3, arg6, arg7, arg8, arg9, v1, arg4, arg5, v14, v8.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v8.dwallet_cap));
    ...
    public(friend) fun increment_balance(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: vector<u8>, arg3: u64, arg4: address, arg5: u8, arg6: vector<u8>, arg7: u256, arg8: &mut 0x2::tx_context::TxContext) : u256 {
        ...
        *v2 = v3;
        ...
        0xf3d059af47631bb94030946c07db2a0013eff68bdc580946b2d6a9d82da140af::events::emit_increment_balance(arg1, arg2, arg3, arg4, arg5, arg6, arg7, v3, v4.dwallet, 0x2::object::id_address<0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap>(&v4.dwallet_cap));
        v3
    }
    ...
    public(friend) fun init_app(arg0: &mut StateV1, arg1: 0x1::type_name::TypeName, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xf3d059af47631bb94030946c07db2a0013eff68bdc580946b2d6a9d82da140af::events::emit_app_initialized(arg1);
    }

    public(friend) fun new_state_v1(arg0: 0x2::object::ID, arg1: &mut 0x2::tx_context::TxContext) : StateV1 {
        StateV1{
            id                                : 0x2::object::new(arg1),
            dwallet_network_encryption_key_id : arg0,
            allowed_chains                    : 0x2::vec_set::empty<u8>(),
            apps                              : 0x2::object_table::new<0x1::type_name::TypeName, AppState>(arg1),
    ...
    public(friend) fun set_dwallet_network_encryption_key_id(arg0: &mut StateV1, arg1: 0x2::object::ID) {
        arg0.dwallet_network_encryption_key_id = arg1;
    }
