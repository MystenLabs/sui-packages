module 0xf3bf2059ce568d36bef50bf298d5c1d61db13461550c6d93208eec53ff9191a1::concord_errors {
    ...
    public fun cancel_penalty_exceeds_permit() : u64 {
        90
    }
    ...
    public fun invalid_share_metadata() : u64 {
        87
    }
    ...
    public fun oracle_price_deviation() : u64 {
        44
    }
    ...
    public fun oracle_price_no_reference() : u64 {
        43
    }

    public fun oracle_sample_too_soon() : u64 {
        88
    }
    ...
    public fun preminted_share_supply() : u64 {
        85
    }

    public fun processor_cancel_permit_expired() : u64 {
        89
    }
    ...
    public fun token_decimals_not_registered() : u64 {
        86
    }
    ...
    public fun upgrade_timelock_below_floor() : u64 {
        63
    }
