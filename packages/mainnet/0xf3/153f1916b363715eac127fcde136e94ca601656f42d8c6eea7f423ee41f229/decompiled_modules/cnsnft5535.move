module 0xf3153f1916b363715eac127fcde136e94ca601656f42d8c6eea7f423ee41f229::cnsnft5535 {
    struct CNSNFT5535 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5535, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5535>(arg0, arg1);
