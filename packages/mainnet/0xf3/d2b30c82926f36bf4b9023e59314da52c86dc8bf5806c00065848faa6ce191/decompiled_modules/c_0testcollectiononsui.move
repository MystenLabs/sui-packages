module 0xf3d2b30c82926f36bf4b9023e59314da52c86dc8bf5806c00065848faa6ce191::c_0testcollectiononsui {
    struct C_0TESTCOLLECTIONONSUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_0TESTCOLLECTIONONSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_0TESTCOLLECTIONONSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"0TestCollectionOnSui"));
