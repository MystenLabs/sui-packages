module 0xf312332ff5bf99eb5bc49e97079d5f62bda1593df92202399c51c33bbc670ec7::test {
    ...
    fun init(arg0: TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<TEST>(arg0, 6, b"test", b"TEST", b"Dev at work, testing testing testing......", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dkpo6c3me/image/upload/v1728334146/test_dax41f.webp")), false, arg1);
