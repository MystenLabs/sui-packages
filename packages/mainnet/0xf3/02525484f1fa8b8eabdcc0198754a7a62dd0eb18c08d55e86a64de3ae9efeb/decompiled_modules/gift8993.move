module 0xf302525484f1fa8b8eabdcc0198754a7a62dd0eb18c08d55e86a64de3ae9efeb::gift8993 {
    struct GIFT8993 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift8993(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT8993, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8993>(arg0, arg1);
