module 0xf333fa7a82c14be29808b19ec0b6a1e88d8458e00c8c883450e7b78eb746d3bb::foxmoon_coin {
    ...
    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<FOXMOON_COIN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<FOXMOON_COIN>>(0x2::coin::mint<FOXMOON_COIN>(arg0, arg1, arg3), arg2);
    }
