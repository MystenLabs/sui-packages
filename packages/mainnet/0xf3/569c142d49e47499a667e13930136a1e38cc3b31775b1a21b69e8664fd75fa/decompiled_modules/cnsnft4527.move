module 0xf3569c142d49e47499a667e13930136a1e38cc3b31775b1a21b69e8664fd75fa::cnsnft4527 {
    struct CNSNFT4527 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4527, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9711"));
        let v4 = 0x2::package::claim<CNSNFT4527>(arg0, arg1);
