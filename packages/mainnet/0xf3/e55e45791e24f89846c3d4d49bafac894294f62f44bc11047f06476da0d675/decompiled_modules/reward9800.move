module 0xf3e55e45791e24f89846c3d4d49bafac894294f62f44bc11047f06476da0d675::reward9800 {
    struct REWARD9800 has drop {
        dummy_field: bool,
    }

    struct TICKET_9800 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9800(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9800>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9800>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9800, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9800>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9800>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9800>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9800>>(v5, 0x2::tx_context::sender(arg1));
    }
