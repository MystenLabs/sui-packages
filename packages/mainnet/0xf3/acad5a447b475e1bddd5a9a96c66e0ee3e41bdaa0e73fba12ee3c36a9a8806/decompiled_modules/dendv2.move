module 0x166e208aa77fa699e47748fb1dc6bfc14559715a6e5368eb66c48c321fb48302::dendv2 {
    ...
    fun add_dividend_v2(arg0: &mut Manager, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>) : bool {
        ...
        let v2 = if (0x2::vec_map::size<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends) == 0) {
            0
        } else {
            let (v3, _) = 0x2::vec_map::get_entry_by_idx<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends, 0x2::vec_map::size<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends) - 1);
            *v3
        };
        if (v2 == arg2) {
