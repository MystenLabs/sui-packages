module 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket {
    ...
    public fun create_ticket(arg0: &0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::admin::AdminCap, arg1: u8, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: u16, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::multisig::check_if_sender_is_multisig_address(arg2, arg3, arg4, arg6), 5);
        let v0 = AdminTicket{
