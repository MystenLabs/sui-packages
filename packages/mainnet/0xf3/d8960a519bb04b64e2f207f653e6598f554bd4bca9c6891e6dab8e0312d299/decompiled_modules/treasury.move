module 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::treasury {
    ...
    public fun disable_version(arg0: &mut Treasury, arg1: &0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::admin::AdminCap, arg2: u16, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: u16, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::multisig::check_if_sender_is_multisig_address(arg3, arg4, arg5, arg6), 6);
        assert!(arg2 != 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::helper::current_version(), 3);
    ...
    public fun enable_version(arg0: &mut Treasury, arg1: &0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::admin::AdminCap, arg2: u16, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: u16, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::multisig::check_if_sender_is_multisig_address(arg3, arg4, arg5, arg6), 6);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Treasury{
            ...
            allowed_versions            : 0x2::vec_set::singleton<u16>(0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::helper::current_version()),
    ...
    public(friend) fun unsettled_fees(arg0: &Treasury) : &0x2::bag::Bag {
        &arg0.unsettled_fees
    }

    public(friend) fun unsettled_fees_mut(arg0: &mut Treasury) : &mut 0x2::bag::Bag {
        verify_version(arg0);
        &mut arg0.unsettled_fees
    }

    public(friend) fun verify_version(arg0: &Treasury) {
        let v0 = 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::helper::current_version();
        assert!(0x2::vec_set::contains<u16>(&arg0.allowed_versions, &v0), 5);
    }

    public fun withdraw_deep_reserves(arg0: &mut Treasury, arg1: 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::AdminTicket, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
        verify_version(arg0);
        0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::validate_ticket(&arg1, 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::withdraw_deep_reserves_ticket_type(), arg3, arg4);
    ...
    public fun withdraw_deep_reserves_coverage_fee<T0>(arg0: &mut Treasury, arg1: 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::AdminTicket, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version(arg0);
        0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::validate_ticket(&arg1, 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::withdraw_coverage_fee_ticket_type(), arg2, arg3);
        0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::destroy_ticket(arg1, arg2);
        let v0 = ChargedFeeKey<T0>{dummy_field: false};
        if (0x2::bag::contains<ChargedFeeKey<T0>>(&arg0.deep_reserves_coverage_fees, v0)) {
    ...
    public fun withdraw_protocol_fee<T0>(arg0: &mut Treasury, arg1: 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::AdminTicket, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version(arg0);
        0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::validate_ticket(&arg1, 0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::withdraw_protocol_fee_ticket_type(), arg2, arg3);
        0xf3d8960a519bb04b64e2f207f653e6598f554bd4bca9c6891e6dab8e0312d299::ticket::destroy_ticket(arg1, arg2);
        let v0 = ChargedFeeKey<T0>{dummy_field: false};
        if (0x2::bag::contains<ChargedFeeKey<T0>>(&arg0.protocol_fees, v0)) {
