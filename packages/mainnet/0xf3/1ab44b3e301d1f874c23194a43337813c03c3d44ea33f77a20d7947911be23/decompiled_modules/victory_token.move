module 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token {
    ...
    fun init(arg0: VICTORY_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<VICTORY_TOKEN>(arg0, 6, b"TVIC", b"TVIC Token", b"Reward token for Suitrump Farm - Max Supply: 500M", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cryptomischief.mypinata.cloud/ipfs/bafybeid2ef3p7qxc3znj5ztbkmidfmbgb43dzclc6c2qyjfqfi5jr65nnm/Victory.png")), arg1);
