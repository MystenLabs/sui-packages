module 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token_locker {
    ...
    struct LockedTokenVault has key {
        id: 0x2::object::UID,
        locked_balance: 0x2::balance::Balance<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>,
    ...
    public entry fun admin_batch_create_user_locks(arg0: &mut TokenLocker, arg1: &mut LockedTokenVault, arg2: 0x2::coin::Coin<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>, arg3: vector<address>, arg4: vector<u64>, arg5: vector<u64>, arg6: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg7: &AdminCap, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg2);
        assert!(v0 > 0, 3);
        ...
        let v5 = 0;
        while (v5 < v1) {
            let v6 = 0x2::coin::split<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&mut arg2, *0x1::vector::borrow<u64>(&arg4, v5), arg9);
        ...
        if (0x2::coin::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>>(arg2, 0x2::tx_context::sender(arg9));
        } else {
            0x2::coin::destroy_zero<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(arg2);
        };
    }
    ...
    fun admin_create_single_lock_internal(arg0: &mut TokenLocker, arg1: &mut LockedTokenVault, arg2: 0x2::coin::Coin<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>, arg3: address, arg4: u64, arg5: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg2);
        assert!(v0 > 0, 3);
        assert!(arg3 != @0x0, 30);
        let v1 = if (arg4 == 7) {
        ...
        0x2::balance::join<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&mut arg1.locked_balance, 0x2::coin::into_balance<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(arg2));
    ...
    public entry fun admin_sweep_sui_reward_vault(arg0: &mut SUIRewardVault, arg1: u64, arg2: address, arg3: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg4: &AdminCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 != @0x0, 30);
        assert!(arg1 > 0, 46);
    ...
    public entry fun admin_sweep_victory_reward_vault(arg0: &mut VictoryRewardVault, arg1: u64, arg2: address, arg3: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg4: &AdminCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 != @0x0, 30);
        assert!(arg1 > 0, 46);
        assert!(0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) >= arg1, 47);
        let (v0, v1, v2) = validate_emission_state(arg3, arg5);
        assert!(v2 || v0 && !v1, 44);
        ...
        let v3 = AdminVaultSweep{
            ...
            amount                  : arg1,
            recipient               : arg2,
            remaining_vault_balance : 0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.victory_balance),
            timestamp               : 0x2::clock::timestamp_ms(arg5) / 1000,
        };
        0x2::event::emit<AdminVaultSweep>(v3);
    }
    ...
    public entry fun batch_claim_epochs_for_lock(arg0: &mut TokenLocker, arg1: &mut SUIRewardVault, arg2: u64, arg3: vector<u64>, arg4: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun calculate_emission_week_from_timestamp_precise(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: u64) : u64 {
    ...
    fun calculate_emission_week_start_precise(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: u64) : u64 {
    ...
    fun calculate_intelligent_lock_end(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: u64, arg2: u64) : u64 {
        let v0 = arg1 + arg2 * 86400;
        let (v1, _) = 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::get_config_info(arg0);
        if (v1 == 0) {
            return v0
        };
    ...
    public fun calculate_pending_victory_rewards(arg0: &TokenLocker, arg1: address, arg2: u64, arg3: u64, arg4: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg5: &0x2::clock::Clock) : u64 {
        calculate_pending_victory_rewards_at_time(arg0, arg1, arg2, arg3, arg4, 0x2::clock::timestamp_ms(arg5) / 1000)
    }

    public fun calculate_pending_victory_rewards_at_time(arg0: &TokenLocker, arg1: address, arg2: u64, arg3: u64, arg4: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg5: u64) : u64 {
    ...
    fun calculate_period_rewards_multi_week(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: u64, arg2: u64, arg3: u64) : u256 {
        if (arg2 >= arg3) {
            return 0
        };
    ...
    fun check_unlock_balance(arg0: &LockedTokenVault, arg1: u64) : bool {
        0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.locked_balance) >= arg1
    }

    public entry fun claim_pool_sui_rewards(arg0: &mut TokenLocker, arg1: &mut SUIRewardVault, arg2: u64, arg3: u64, arg4: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x2::clock::timestamp_ms(arg5) / 1000;
        validate_claim_allowed(arg4, arg5);
    ...
    public entry fun claim_victory_rewards(arg0: &mut TokenLocker, arg1: &mut VictoryRewardVault, arg2: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x2::clock::timestamp_ms(arg5) / 1000;
    ...
    public entry fun create_locked_token_vault(arg0: &AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = LockedTokenVault{
            ...
            locked_balance        : 0x2::balance::zero<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(),
    ...
    fun create_victory_position(arg0: &mut TokenLocker, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun deposit_victory_tokens(arg0: &mut VictoryRewardVault, arg1: &mut TokenLocker, arg2: 0x2::coin::Coin<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>, arg3: &AdminCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg2);
        assert!(v0 > 0, 3);
        let v1 = 0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.victory_balance);
        assert!(v1 + v0 >= v1, 18);
        assert!(arg0.total_deposited + v0 >= arg0.total_deposited, 19);
        0x2::balance::join<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&mut arg0.victory_balance, 0x2::coin::into_balance<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(arg2));
        arg0.total_deposited = arg0.total_deposited + v0;
        let v2 = VaultDeposit{
            vault_type    : 0x1::string::utf8(b"Victory Rewards"),
            amount        : (v0 as u64),
            total_balance : (0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) as u64),
            timestamp     : 0x2::clock::timestamp_ms(arg4) / 1000,
        };
    ...
    fun distribute_victory_from_vault(arg0: &mut VictoryRewardVault, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.victory_balance) >= arg1, 7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>>(0x2::coin::from_balance<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(0x2::balance::split<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&mut arg0.victory_balance, arg1), arg3), arg2);
        arg0.total_distributed = arg0.total_distributed + arg1;
    }
    ...
    fun find_and_prepare_unlock(arg0: &TokenLocker, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig) : (Lock, u64) {
    ...
    public fun get_balance_overview(arg0: &TokenLocker, arg1: &LockedTokenVault, arg2: &VictoryRewardVault, arg3: &SUIRewardVault) : (u64, u64, u64, u64, u64, u64, u64, u64) {
        (0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg1.locked_balance), get_total_locked(arg0), 0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg2.victory_balance), get_total_reward_tokens_from_vault(arg2), 0x2::balance::value<0x2::sui::SUI>(&arg3.sui_balance), arg3.total_deposited, arg1.total_locked_amount, arg1.total_unlocked_amount)
    }
    ...
    public fun get_emission_status_for_locker(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (bool, bool, bool, u64, u8) {
    ...
    public fun get_locked_vault_statistics(arg0: &LockedTokenVault) : (u64, u64, u64, u64, u64) {
        (0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.locked_balance), arg0.total_locked_amount, arg0.total_unlocked_amount, arg0.lock_count, arg0.unlock_count)
    }
    ...
    public fun get_reward_vault_statistics(arg0: &VictoryRewardVault) : (u64, u64, u64) {
        (0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg0.victory_balance), arg0.total_deposited, arg0.total_distributed)
    }
    ...
    fun get_victory_allocation_for_emission_week_precise(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: u64) : u256 {
        if (arg1 == 0 || arg1 > 156) {
            return 0
        };
        0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::get_victory_allocation_for_week(arg0, arg1)
    }

    fun get_victory_allocation_safe(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : u256 {
        let (v0, v1, v2) = validate_emission_state(arg0, arg1);
        let v3 = if (!v0) {
            true
        } else if (!v1) {
        ...
        0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::get_victory_allocation(arg0, arg1)
    }

    public fun get_victory_allocation_with_status(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) : (u256, bool, 0x1::string::String) {
        let (v0, v1, v2) = validate_emission_state(arg0, arg1);
        let v3 = if (!v0) {
    ...
    public entry fun lock_tokens(arg0: &mut TokenLocker, arg1: &mut LockedTokenVault, arg2: 0x2::coin::Coin<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>, arg3: u64, arg4: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg2);
        assert!(v0 > 0, 3);
    ...
    fun simulate_accumulator_update(arg0: &VictoryPoolAccumulator, arg1: &TokenLocker, arg2: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg3: u64) : u256 {
        if (arg0.total_staked == 0) {
            return arg0.acc_victory_per_share
        };
        let (v0, _) = 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::get_config_info(arg2);
    ...
    public entry fun unlock_tokens(arg0: &mut TokenLocker, arg1: &mut LockedTokenVault, arg2: &mut VictoryRewardVault, arg3: &mut SUIRewardVault, arg4: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>>(0x2::coin::take<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&mut arg1.locked_balance, v4.amount, arg8), v0);
        ...
        let v13 = if (v11 > 0) {
            let v14 = 0x2::balance::value<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::victory_token::VICTORY_TOKEN>(&arg2.victory_balance);
            let v15 = if (v11 > v14) {
                v14
            } else {
                v11
    ...
    fun update_victory_accumulator_for_period(arg0: &mut TokenLocker, arg1: u64, arg2: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg3: &0x2::clock::Clock, arg4: u64) {
        let v0 = get_dynamic_victory_allocation(arg0, arg1);
        let v1 = get_victory_accumulator_mut(arg0, arg1);
        let (v2, _) = 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::get_config_info(arg2);
        let v4 = get_emission_end_timestamp(arg2);
        let v5 = if (arg4 > v4) {
            v4
        } else {
    ...
    fun validate_new_lock_allowed(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) {
        let (v0, v1, v2) = validate_emission_state(arg0, arg1);
        assert!(v0, 22);
        assert!(v1, 23);
        assert!(!v2, 24);
    ...
    fun validate_unlock_allowed(arg0: &0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::global_emission_controller::GlobalEmissionConfig, arg1: &0x2::clock::Clock) {
        let (v0, _, v2) = validate_emission_state(arg0, arg1);
        assert!(v0, 22);
        assert!(!v2, 24);
    }
