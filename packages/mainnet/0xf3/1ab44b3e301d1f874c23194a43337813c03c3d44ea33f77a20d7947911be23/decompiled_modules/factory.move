module 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::factory {
    ...
    struct Factory has key {
        ...
        pending_pause_admin: 0x1::option::Option<address>,
    }
    ...
    struct PauseAdminProposed has copy, drop {
        current_pause_admin: address,
        pending_pause_admin: address,
    }

    public entry fun accept_admin(arg0: &mut Factory, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x1::option::is_some<address>(&arg0.pending_admin), 10);
        assert!(*0x1::option::borrow<address>(&arg0.pending_admin) == v0, 11);
        arg0.admin = v0;
    ...
    public entry fun accept_pause_admin(arg0: &mut Factory, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x1::option::is_some<address>(&arg0.pending_pause_admin), 12);
        assert!(*0x1::option::borrow<address>(&arg0.pending_pause_admin) == v0, 13);
        arg0.pause_admin = v0;
        arg0.pending_pause_admin = 0x1::option::none<address>();
        let v1 = PauseAdminTransferred{
            old_pause_admin : arg0.pause_admin,
            new_pause_admin : v0,
        };
        0x2::event::emit<PauseAdminTransferred>(v1);
    }
    ...
    public entry fun cancel_pending_admin(arg0: &mut Factory, arg1: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.admin, 4);
        arg0.pending_admin = 0x1::option::none<address>();
    }

    public entry fun cancel_pending_pause_admin(arg0: &mut Factory, arg1: &0x2::tx_context::TxContext) {
    ...
    public(friend) fun create_pair<T0, T1>(arg0: &mut Factory, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : address {
        ...
        let v3 = 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::pair::new<T0, T1>(arg1, arg2, arg0.team_1_address, arg0.team_2_address, arg0.dev_address, arg0.locker_address, arg0.buyback_address, arg3);
        let v4 = 0x2::object::id_address<0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::pair::Pair<T0, T1>>(&v3);
        0x2::table::add<TokenPair, address>(&mut arg0.pairs, v2, v4);
        0x1::vector::push_back<address>(&mut arg0.all_pairs, v4);
        0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::pair::share_pair<T0, T1>(v3);
        let v5 = PairCreated{
            token0   : v0,
            token1   : v1,
            pair     : v4,
    ...
    public fun get_pending_admin(arg0: &Factory) : 0x1::option::Option<address> {
        arg0.pending_admin
    }

    public fun get_pending_pause_admin(arg0: &Factory) : 0x1::option::Option<address> {
        arg0.pending_pause_admin
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Factory{
            ...
            team_1_address      : @0x75f38c1d3059b6c14e4d22abba2961cccadd0d2505bc942fd364a4bcdbbc9ba5,
            team_2_address      : @0xb81aa00ad7f9e863628fe95c2c2f78490cdc8b1e25cd20eea47d9029e6195406,
            ...
            pending_pause_admin : 0x1::option::none<address>(),
        };
    ...
    public entry fun propose_admin(arg0: &mut Factory, arg1: address, arg2: &0x2::tx_context::TxContext) {
    ...
    public entry fun propose_pause_admin(arg0: &mut Factory, arg1: address, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.pause_admin, 7);
        assert!(arg1 != @0x0, 3);
        arg0.pending_pause_admin = 0x1::option::some<address>(arg1);
        let v0 = PauseAdminProposed{
            current_pause_admin : arg0.pause_admin,
            pending_pause_admin : arg1,
        };
        0x2::event::emit<PauseAdminProposed>(v0);
    }
    ...
    public entry fun update_pair_fee_addresses<T0, T1>(arg0: &Factory, arg1: &mut 0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::pair::Pair<T0, T1>, arg2: address, arg3: address, arg4: address, arg5: address, arg6: address, arg7: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg7) == arg0.admin, 4);
        0xf31ab44b3e301d1f874c23194a43337813c03c3d44ea33f77a20d7947911be23::pair::update_fee_addresses<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6);
    }
