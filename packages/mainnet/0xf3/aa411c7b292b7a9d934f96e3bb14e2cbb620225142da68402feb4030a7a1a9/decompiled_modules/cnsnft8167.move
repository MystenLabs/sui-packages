module 0xf3aa411c7b292b7a9d934f96e3bb14e2cbb620225142da68402feb4030a7a1a9::cnsnft8167 {
    struct CNSNFT8167 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8167, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2503"));
        let v4 = 0x2::package::claim<CNSNFT8167>(arg0, arg1);
