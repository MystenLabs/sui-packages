module 0xf39b46d8fc0664593eee15482172d87692d2b540f4aa083749f8ec1e30e6bc69::gift3477 {
    struct GIFT3477 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift3477(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT3477, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3477>(arg0, arg1);
