module 0xf3e236552a58ceafe194c9261330a21dcba77c27676b136367e5ad7eaa928aed::suigpt {
    ...
    fun init(arg0: SUIGPT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"1736167157568"));
