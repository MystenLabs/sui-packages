module 0xf3f4cee9aa11baaece24202f8c56d0e6db0164fe0413f0fe95e320e4b372d61b::qanda {
    ...
    public entry fun question(arg0: &mut 0xf3f4cee9aa11baaece24202f8c56d0e6db0164fe0413f0fe95e320e4b372d61b::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
        ...
        0xf3f4cee9aa11baaece24202f8c56d0e6db0164fe0413f0fe95e320e4b372d61b::community::update_qandas(arg0, arg3);
        0x2::transfer::share_object<Qanda>(v0);
    }

    public entry fun question_by_admin(arg0: &mut 0xf3f4cee9aa11baaece24202f8c56d0e6db0164fe0413f0fe95e320e4b372d61b::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
            ...
            owner           : 0xf3f4cee9aa11baaece24202f8c56d0e6db0164fe0413f0fe95e320e4b372d61b::community::get_address_admin(),
            users_voted     : 0x1::vector::empty<address>(),
            users_downvoted : 0x1::vector::empty<address>(),
        };
        let v1 = QandaCreatedEvent{qanda_id: 0x2::object::id<Qanda>(&v0)};
    ...
    public entry fun reply_qanda(arg0: &mut 0xf3f4cee9aa11baaece24202f8c56d0e6db0164fe0413f0fe95e320e4b372d61b::community::Community, arg1: &mut Qanda, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
