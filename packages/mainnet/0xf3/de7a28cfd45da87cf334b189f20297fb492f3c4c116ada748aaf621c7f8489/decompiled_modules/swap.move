module 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::swap {
    ...
    struct EscrowCoinsV2<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        token_x: 0x2::balance::Balance<T0>,
        token_y: 0x2::balance::Balance<T1>,
    }
    ...
    fun swap<T0, T1>(arg0: u64, arg1: u64, arg2: &mut Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        if (0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg2.id, v2)) {
            let v3 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, EscrowCoinsV2<T0, T1>>(&mut arg2.id, v2);
            ...
            let v14 = if (v13) {
                ...
                let v15 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::u256::mul_u128(v9, v10);
                let v16 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::u256::mul_u128(v11, v12);
                0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::u256::ge(&v15, &v16)
            };
            assert!(v14, 15);
            ...
            let v27 = if (v26) {
                ...
                let v28 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::u256::mul_u128(v22, v23);
                let v29 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::u256::mul_u128(v24, v25);
                0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::u256::ge(&v28, &v29)
            };
            assert!(v27, 15);
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: u64, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        let v11 = Add_Liquidity_Pool{
            ...
            user              : v9,
            token_x_name      : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T0>(),
            token_y_name      : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T1>(),
    ...
    fun add_liquidity_direct<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, 0x2::coin::Coin<LSP<T0, T1>>, u64, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let (v2, v3) = if (arg2.reserve_x == 0 && arg2.reserve_y == 0) {
            ...
            let v4 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::quote(v0, arg2.reserve_x, arg2.reserve_y);
            if (v4 <= v1) {
                (v0, v4)
            } else {
                let v5 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::quote(v1, arg2.reserve_y, arg2.reserve_x);
                assert!(v5 <= v0, 8);
                (v5, v1)
            }
        };
        ...
        let (v9, v10) = if (!0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg2.id, v8)) {
            ...
            0x2::dynamic_object_field::add<0x2::object::ID, EscrowCoinsV2<T0, T1>>(&mut arg2.id, v8, v11);
            mint<T0, T1>(arg2, 0x2::balance::value<T0>(&v11.token_x), 0x2::balance::value<T1>(&v11.token_y), arg3)
        } else {
            let v12 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, EscrowCoinsV2<T0, T1>>(&mut arg2.id, v8);
    ...
    public fun add_swap_event_with_address<T0, T1>(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut Pool<T0, T1>) {
        let v0 = Swap_Event<T0, T1>{
            ...
            user         : arg0,
            token_x_in   : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T0>(),
            amount_x_in  : arg1,
            token_y_in   : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T1>(),
            amount_y_in  : arg2,
            token_x_out  : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T0>(),
            amount_x_out : arg3,
            token_y_out  : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T1>(),
            amount_y_out : arg4,
        };
    ...
    fun add_swap_event_with_address_internal<T0, T1>(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut Dex_Info) {
        if (0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::sort_token_type<T0, T1>()) {
    ...
    public fun assert_version_contract(arg0: &Dex_Info) {
        assert!(0x2::dynamic_object_field::borrow<0x2::object::ID, VersionManage>(&arg0.id, 0x2::object::uid_to_inner(&arg0.id)).version == 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_contract_version(), 25);
    }
    ...
    fun burn<T0, T1>(arg0: 0x2::coin::Coin<LSP<T0, T1>>, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, u64) {
        ...
        let v7 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, EscrowCoinsV2<T0, T1>>(&mut arg1.id, 0x2::object::uid_to_inner(&arg1.id));
    ...
    public fun check_pool_exist<T0, T1>(arg0: &Dex_Info) : bool {
        0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_lp_name<T0, T1>())
    }
    ...
    fun create_pool_internal<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_lp_name<T0, T1>();
    ...
    public entry fun freeze_pool<T0, T1>(arg0: bool, arg1: &mut Dex_Info, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::sort_token_type<T0, T1>()) {
            ...
            let v4 = Freeze_Event{
                ...
                token_x_in  : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T1>(),
                token_y_out : 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_token_name<T0>(),
    ...
    public fun get_pool<T0, T1>(arg0: &mut Dex_Info) : &mut Pool<T0, T1> {
        ...
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, Pool<T0, T1>>(&mut arg0.id, 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_lp_name<T0, T1>())
    }
    ...
    public entry fun migrate_escown_coins<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::sort_token_type<T0, T1>()) {
            ...
            let EscownCoins {
                ...
                token_x : v3,
                token_y : v4,
            } = 0x2::dynamic_object_field::remove<0x2::object::ID, EscownCoins<T0, T1>>(&mut v0.id, v1);
            0x2::object::delete(v2);
            let v5 = EscrowCoinsV2<T0, T1>{
                id      : 0x2::object::new(arg1),
                token_x : v3,
                token_y : v4,
            };
            0x2::dynamic_object_field::add<0x2::object::ID, EscrowCoinsV2<T0, T1>>(&mut v0.id, v1, v5);
        } else {
            ...
            let EscownCoins {
                ...
                token_x : v9,
                token_y : v10,
            } = 0x2::dynamic_object_field::remove<0x2::object::ID, EscownCoins<T1, T0>>(&mut v6.id, v7);
            0x2::object::delete(v8);
            let v11 = EscrowCoinsV2<T1, T0>{
                id      : 0x2::object::new(arg1),
                token_x : v9,
                token_y : v10,
            };
            0x2::dynamic_object_field::add<0x2::object::ID, EscrowCoinsV2<T1, T0>>(&mut v6.id, v7, v11);
        };
    }
    ...
    fun mint<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LSP<T0, T1>>, u64) {
        ...
        let v4 = if (v3 == 0) {
            let v5 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::sqrt(v0 * v1);
            assert!(v5 > 1000, 4);
            0x2::balance::join<LSP<T0, T1>>(&mut arg0.minimum_liq, 0x2::balance::increase_supply<LSP<T0, T1>>(&mut arg0.lsp_supply, (1000 as u64)));
            v5 - 1000
        } else {
            let v6 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::min(v0 * v3 / (arg0.reserve_x as u128), v1 * v3 / (arg0.reserve_y as u128));
            assert!(v6 > 0, 4);
            v6
        };
    ...
    fun mint_fee<T0, T1>(arg0: &mut Pool<T0, T1>) : u64 {
        let v0 = 0;
        if (arg0.k_last != 0) {
            let v1 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::sqrt((arg0.reserve_x as u128) * (arg0.reserve_y as u128));
            let v2 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::sqrt(arg0.k_last);
            if (v1 > v2) {
    ...
    public(friend) fun swap_exact_x_to_y_direct<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v3 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_amount_out_fee(v0, v1, v2);
        let (v4, v5) = swap<T0, T1>(0, v3, arg1, 0x2::coin::into_balance<T0>(arg0), 0x2::balance::zero<T1>(), arg2);
        let v6 = v5;
        let v7 = v4;
        0x2::balance::join<T1>(&mut arg1.fee_y, 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v6, v3 - 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_amount_out(v0, v1, v2), arg2)));
    ...
    public(friend) fun swap_exact_y_to_x_direct<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: &mut Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v1 = arg1.reserve_x;
        let v2 = arg1.reserve_y;
        let v3 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_amount_out_fee(v0, v2, v1);
        let (v4, v5) = swap<T0, T1>(v3, 0, arg1, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(arg0), arg2);
        let v6 = v5;
        let v7 = v4;
        0x2::balance::join<T0>(&mut arg1.fee_x, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v7, v3 - 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::get_amount_out(v0, v2, v1), arg2)));
    ...
    public fun sync_pool<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        if (0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::sort_token_type<T0, T1>()) {
            let v0 = get_pool<T0, T1>(arg0);
            let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, EscrowCoinsV2<T0, T1>>(&mut v0.id, 0x2::object::uid_to_inner(&v0.id));
            ...
            let v3 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, EscrowCoinsV2<T1, T0>>(&mut v2.id, 0x2::object::uid_to_inner(&v2.id));
    ...
    public fun token_balances<T0, T1>(arg0: &Pool<T0, T1>) : (u64, u64) {
        let v0 = 0x2::object::uid_to_inner(&arg0.id);
        if (0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, v0)) {
            let v3 = 0x2::dynamic_object_field::borrow<0x2::object::ID, EscrowCoinsV2<T0, T1>>(&arg0.id, v0);
    ...
    fun transfer_withdraw_fee<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div(0x2::balance::value<LSP<T0, T1>>(&arg0.fee_amount), arg1, 10000);
        if (v0 > 0) {
        ...
        let v1 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div(0x2::balance::value<T0>(&arg0.fee_x), arg1, 10000);
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.fee_x, v1), arg3), arg2);
        };
        let v2 = 0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::math::mul_div(0x2::balance::value<T1>(&arg0.fee_y), arg1, 10000);
        if (v2 > 0) {
    ...
    public entry fun withdraw_fee<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = if (v0 == arg0.fee_to) {
            ...
            v0 == @0x85bf745a737a34bf73f360c22d5c8aea1f1767f3c458f5269a7c2f821b9d3781
        };
        assert!(v1, 17);
        if (0xd979dc3d56634db2f0e9beaa2f9e6b48d43f4bfb2a848e039eb3f92b196e6579::utils::sort_token_type<T0, T1>()) {
