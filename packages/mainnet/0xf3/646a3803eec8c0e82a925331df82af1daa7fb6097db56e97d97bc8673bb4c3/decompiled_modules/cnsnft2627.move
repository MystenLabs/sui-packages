module 0xf3646a3803eec8c0e82a925331df82af1daa7fb6097db56e97d97bc8673bb4c3::cnsnft2627 {
    struct CNSNFT2627 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2627, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2627>(arg0, arg1);
