module 0xf3093adcc409ceda53b434765dda5ff1348400aaeb7cda94024063de4edba04f::ipx_standard_impl {
    public fun mint_and_lock_treasury<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        0x103bc8a715277926ad0821a2b754c493e705dc5f0943b9f354338c9482d40492::ipx_coin_standard::set_maximum_supply(&mut v2, 100000000000000);
        let v4 = 0x103bc8a715277926ad0821a2b754c493e705dc5f0943b9f354338c9482d40492::ipx_coin_standard::create_mint_cap(&mut v2, arg1);
        let v5 = 0x103bc8a715277926ad0821a2b754c493e705dc5f0943b9f354338c9482d40492::ipx_coin_standard::mint<T0>(&v4, &mut v3, 100000000000000, arg1);
        ...
        0x103bc8a715277926ad0821a2b754c493e705dc5f0943b9f354338c9482d40492::ipx_coin_standard::cap_burn<T0>(&v6, &mut v3, 0x2::coin::split<T0>(&mut v5, 100000000000000 / 50, arg1));
