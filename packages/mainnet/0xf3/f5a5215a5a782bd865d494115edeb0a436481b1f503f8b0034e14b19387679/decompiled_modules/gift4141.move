module 0xf3f5a5215a5a782bd865d494115edeb0a436481b1f503f8b0034e14b19387679::gift4141 {
    struct GIFT4141 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift4141(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT4141, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4141>(arg0, arg1);
