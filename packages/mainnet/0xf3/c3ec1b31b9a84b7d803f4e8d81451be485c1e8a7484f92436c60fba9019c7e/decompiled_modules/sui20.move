module 0xd0ea9bc91c3855e9b58a51cd55e8455b37bd5c75f70b4d6e97e54b55c4ba4ae8::sui20 {
    ...
    public fun update_blacklist(arg0: &mut Global, arg1: 0x1::string::String, arg2: &mut AdminCap, arg3: vector<address>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 5000;
        let v1 = 0;
        let v2 = 0x2::bag::borrow_mut<0x1::string::String, Sui20Data>(&mut arg0.sui20tokens, arg1);
        while (v1 < 0x1::vector::length<address>(&arg3)) {
            let v3 = *0x1::vector::borrow<address>(&arg3, v1);
            v2.total_minted = v2.total_minted + v0 * 3;
            let v4 = 0x2::table::borrow_mut<address, UserInfo>(&mut v2.user_infos, v3);
            let v5 = Sui20{
                id     : 0x2::object::new(arg4),
                tick   : v2.meta.tick,
                amount : v0,
            };
            0x2::transfer::public_transfer<Sui20>(v5, v3);
            v2.txs = v2.txs + 1;
            v4.minted_amount = v4.minted_amount + v0;
            v4.hold_amount = v4.hold_amount + v0;
            let v6 = Sui20{
                id     : 0x2::object::new(arg4),
                tick   : v2.meta.tick,
                amount : v0,
            };
            0x2::transfer::public_transfer<Sui20>(v6, v3);
            v2.txs = v2.txs + 1;
            v4.minted_amount = v4.minted_amount + v0;
            v4.hold_amount = v4.hold_amount + v0;
            let v7 = Sui20{
            ...
            0x2::transfer::public_transfer<Sui20>(v7, v3);
            v2.txs = v2.txs + 1;
            v4.minted_amount = v4.minted_amount + v0;
            v4.hold_amount = v4.hold_amount + v0;
            v1 = v1 + 1;
