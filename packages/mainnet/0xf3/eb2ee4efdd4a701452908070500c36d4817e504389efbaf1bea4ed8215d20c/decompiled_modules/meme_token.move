module 0xf3eb2ee4efdd4a701452908070500c36d4817e504389efbaf1bea4ed8215d20c::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"OU", b"obito uchiha", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-31T12-37-04.141Z-G12LfxKbsAA1ggf.jpg")), arg1);
