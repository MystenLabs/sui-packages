module 0xf326cb90904b829b4850601635b8d5c6f177b856c67d3b22888abcc34920a491::bout {
    ...
    fun init(arg0: BOUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[b"BOUT", b"Blasting Out the Trenches", b"This is for the trenches, all memes are welcome!", b"https://api.interestlabs.io/files/c56c4d0ff36f1d2857e9b435d0aa940fe3a2165e2108934c.jpg"];
        let v2 = vector[b"BOUT", b"Blasting Out the Trenches", b"This is for the trenches, all memes are welcome!", b"https://api.interestlabs.io/files/c56c4d0ff36f1d2857e9b435d0aa940fe3a2165e2108934c.jpg"];
        let v3 = vector[b"BOUT", b"Blasting Out the Trenches", b"This is for the trenches, all memes are welcome!", b"https://api.interestlabs.io/files/c56c4d0ff36f1d2857e9b435d0aa940fe3a2165e2108934c.jpg"];
        let v4 = vector[b"BOUT", b"Blasting Out the Trenches", b"This is for the trenches, all memes are welcome!", b"https://api.interestlabs.io/files/c56c4d0ff36f1d2857e9b435d0aa940fe3a2165e2108934c.jpg"];
