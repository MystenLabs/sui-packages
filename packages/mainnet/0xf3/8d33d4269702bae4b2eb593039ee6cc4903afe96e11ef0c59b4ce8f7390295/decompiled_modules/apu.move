module 0xf38d33d4269702bae4b2eb593039ee6cc4903afe96e11ef0c59b4ce8f7390295::apu {
    struct APU has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: APU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<APU>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"APU     ")))), trim_right(b"Apu Apustaja                    "), trim_right(b"After an attempt on President Trump's life during his last speech, he told everyone to FIGHT, encouraging us to continue fighting to Make America Great Again                                                                                                                                                                   "), v2, arg1);
