module 0xf36023736c4cc7fc4a99b509150dc7970f475e2c898dd4245ce9b037a49325dd::reward7291 {
    struct REWARD7291 has drop {
        dummy_field: bool,
    }

    struct TICKET_7291 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7291(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7291>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7291>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7291, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7291>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7291>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7291>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7291>>(v5, 0x2::tx_context::sender(arg1));
    }
