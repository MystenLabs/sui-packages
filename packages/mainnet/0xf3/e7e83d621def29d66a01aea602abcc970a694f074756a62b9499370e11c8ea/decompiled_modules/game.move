module 0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>,
        gas_fee: u16,
        owner: address,
        ref1: u16,
        ref2: u16,
    ...
    entry fun add_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: 0x2::coin::TreasuryCap<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>) {
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury"), arg2);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version : 1,
            balance : 0x2::balance::zero<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>(),
            gas_fee : 1,
            owner   : v0,
            ref1    : 5,
            ref2    : 1,
    ...
    entry fun remove_treasury_cap(arg0: &OwnerCap, arg1: &mut GameInfo, arg2: &0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>>(&mut arg1.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg2));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>>(0x2::coin::from_balance<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>(0x2::balance::split<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>>(0x2::coin::from_balance<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>(0x2::balance::withdraw_all<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>>(0x2::coin::mint<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0xf3e7e83d621def29d66a01aea602abcc970a694f074756a62b9499370e11c8ea::tonminer::TONMINER>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
