module 0xf3bb05190d73f252324b3fdcd3509044d3da6bdf03ff4a41ecf052874f4f7a04::stonker {
    ...
    public fun input_signal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = abs_diff(v0, arg4) * 10000;
        let v2 = InputSignalEvent{
            estimated_valuation   : arg4,
            current_dex_mid       : v0,
            opportunity_times_10k : v1,
        };
        0x2::event::emit<InputSignalEvent>(v2);
        if (v1 < arg4 * arg0.parameters.trigger_bps) {
            return
        };
        let v3 = arg4 > v0;
        ...
        let v8 = v4 / v5 * v5;
        let v9 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg5);
        let v10 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(arg2, arg1, &v9, 0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::immediate_or_cancel(), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::self_matching_allowed(), v8, arg0.parameters.order_size_base, v3, false, 0x2::clock::timestamp_ms(arg3) + 1000, arg3, arg5);
        let v11 = OrderMadeEvent{
            price              : v8,
            is_bid             : v3,
            original_quantity  : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::original_quantity(&v10),
            executed_quantity  : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::executed_quantity(&v10),
            paid_fees          : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::paid_fees(&v10),
            status             : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::status(&v10),
            fill_limit_reached : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::fill_limit_reached(&v10),
        };
        0x2::event::emit<OrderMadeEvent>(v11);
    }
