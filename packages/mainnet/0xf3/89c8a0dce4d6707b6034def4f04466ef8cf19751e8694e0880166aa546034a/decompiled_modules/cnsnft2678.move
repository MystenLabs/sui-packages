module 0xf389c8a0dce4d6707b6034def4f04466ef8cf19751e8694e0880166aa546034a::cnsnft2678 {
    struct CNSNFT2678 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2678, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2678>(arg0, arg1);
