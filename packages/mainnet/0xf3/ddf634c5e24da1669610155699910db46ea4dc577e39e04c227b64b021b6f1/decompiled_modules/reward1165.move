module 0xf3ddf634c5e24da1669610155699910db46ea4dc577e39e04c227b64b021b6f1::reward1165 {
    struct REWARD1165 has drop {
        dummy_field: bool,
    }

    struct TICKET_1165 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1165(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1165>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1165>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1165, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1165>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1165>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1165>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1165>>(v5, 0x2::tx_context::sender(arg1));
    }
