module 0xf3902ad57d49450729bf4e9a44c465b61479887fe672bfdced5935d7bd31fbb1::aggregator {
    ...
    public fun aggregate_batch<T0>(arg0: &mut MetricsHub, arg1: 0x1::ascii::String, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x2::object::ID, DataPoint>(&v0.datapoints, arg2)) {
            0x2::table::borrow_mut<0x2::object::ID, DataPoint>(&mut v0.datapoints, arg2).aggregated = true;
        };
        let v3 = v2 * (v0.sample_rate as u64) / 100;
        if (v3 == 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, v0.archive_store);
        } else if (v3 == v2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, v0.primary_store);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg3, v3, arg4), v0.primary_store);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, v0.archive_store);
        };
    ...
    public fun archive_point(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut MetricsHub, arg2: 0x1::ascii::String, arg3: 0x2::object::ID, arg4: 0x3::staking_pool::StakedSui, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, CollectorConfig>(&arg1.datapoints, arg2), 101);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, CollectorConfig>(&mut arg1.datapoints, arg2);
        let v1 = 0x2::tx_context::sender(arg5);
        assert!(v1 == v0.collector, 100);
        if (!(v0.status & 1 != 0)) {
        ...
        let v2 = if (0x2::table::contains<0x2::object::ID, DataPoint>(&v0.datapoints, arg3)) {
            let v3 = 0x2::table::borrow<0x2::object::ID, DataPoint>(&v0.datapoints, arg3);
        ...
        if (0x2::table::contains<0x2::object::ID, DataPoint>(&v0.datapoints, arg3)) {
            0x2::table::borrow_mut<0x2::object::ID, DataPoint>(&mut v0.datapoints, arg3).aggregated = true;
        };
        ...
        let v6 = v5 * (v0.sample_rate as u64) / 100;
        if (v6 == 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v4, v0.archive_store);
        } else if (v6 == v5) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v4, v0.primary_store);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v4, v6, arg5), v0.primary_store);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v4, v0.archive_store);
        };
    ...
    public fun collect_metric<T0: store + key>(arg0: &mut MetricsHub, arg1: 0x1::ascii::String, arg2: 0x2::object::ID, arg3: T0, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (0x2::table::contains<0x2::object::ID, DataPoint>(&v0.datapoints, arg2)) {
            let v3 = 0x2::table::borrow<0x2::object::ID, DataPoint>(&v0.datapoints, arg2);
            !v3.aggregated && v3.magnitude > 0
        } else {
            false
        };
        ...
        0x2::transfer::public_transfer<T0>(arg3, v0.archive_store);
        let v4 = AggregationCompleted{
            hub_id           : arg1,
            point_id         : arg2,
            result_magnitude : 1,
