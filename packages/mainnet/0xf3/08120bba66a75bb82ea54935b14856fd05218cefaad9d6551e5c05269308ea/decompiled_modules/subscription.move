module 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::subscription {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, arg1.contributed * 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::finalize_market_fee_bps(arg0) / 10000), arg2), 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::fee_recipient(arg0));
    }

    fun collect_open_market_fee<T0>(arg0: &0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::MainConfig, arg1: 0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(&arg1) == 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::open_market_fee(arg0), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::fee_recipient(arg0));
    }
    ...
    public fun finalize_market<T0, T1>(arg0: &0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v10) {
                ...
                0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::events::emit_lp_vault_created<T0, T1>(0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::events::get_id(&arg1.id), 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::vault::new_lp_vault<T0, T1>(v19, arg1.lp_lock_period + v0, arg1.curator, arg1.admin_public_key, 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::admin_key_id(arg0), arg7), arg1.curator, v21, v13, v3, v4, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v19));
            } else {
        ...
        let v31 = arg1.soft_cap - arg1.soft_cap * 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::finalize_market_fee_bps(arg0) / 10000;
        let v32 = v31;
        if (arg1.is_auto_add_liquidity) {
    ...
    fun validate_params(arg0: &0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + 0xf308120bba66a75bb82ea54935b14856fd05218cefaad9d6551e5c05269308ea::main::finalize_market_fee_bps(arg0) <= 10000, 1);
        let v0 = 0;
        if (arg5) {
