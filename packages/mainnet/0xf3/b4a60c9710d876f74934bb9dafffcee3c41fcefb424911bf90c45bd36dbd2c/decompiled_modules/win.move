module 0xf3b4a60c9710d876f74934bb9dafffcee3c41fcefb424911bf90c45bd36dbd2c::win {
    struct WIN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<WIN>>(0x2::coin::mint<WIN>(&mut v3, 10000000000000000000, arg1), 0x2::tx_context::sender(arg1));
