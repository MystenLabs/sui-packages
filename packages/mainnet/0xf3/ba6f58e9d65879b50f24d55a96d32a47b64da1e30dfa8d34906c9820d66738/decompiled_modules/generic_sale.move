module 0xf3ba6f58e9d65879b50f24d55a96d32a47b64da1e30dfa8d34906c9820d66738::generic_sale {
    ...
    public entry fun create_vault<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ClaimVault<T0>{
            ...
            sui_receiver      : @0xc60dc2616f655d917fb778db4643aae8994330104d230baad1685445f069f139,
            admin             : v0,
