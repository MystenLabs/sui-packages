module 0xf3a43885c5dfa432f67eb68e5f52eb658d2fe9c47e24b73fda0afc1c5dfc0fb2::marketplace {
    ...
    struct MarketPlaceStore has key {
        id: 0x2::object::UID,
        points_admin_cap: 0x24de40e4ee9f1f424b6f07e88cdb6efd99284ae65d2a5844c76d0958645f09b4::soulbound::PointsAdminCap,
        commission_pct: u64,
    ...
    public fun buy<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, u64) {
        ...
        0xf3a43885c5dfa432f67eb68e5f52eb658d2fe9c47e24b73fda0afc1c5dfc0fb2::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v6, v0, arg4);
        (v13, v12, v9)
    }
    ...
    public fun cancel_bid<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: 0x1::option::Option<0x2::object::ID>, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf3a43885c5dfa432f67eb68e5f52eb658d2fe9c47e24b73fda0afc1c5dfc0fb2::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v4, v0, arg3);
    ...
    public fun collect_commissions(arg0: &mut MarketPlaceStore, arg1: &CollectorCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xf3a43885c5dfa432f67eb68e5f52eb658d2fe9c47e24b73fda0afc1c5dfc0fb2::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.available_sui), arg2, arg3);
    }
    ...
    public fun init_marketplace(arg0: &AdminCap, arg1: 0x24de40e4ee9f1f424b6f07e88cdb6efd99284ae65d2a5844c76d0958645f09b4::soulbound::PointsAdminCap, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun make_bid<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: 0x1::option::Option<0x2::object::ID>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xf3a43885c5dfa432f67eb68e5f52eb658d2fe9c47e24b73fda0afc1c5dfc0fb2::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v4, v0, arg4);
    }
    ...
    public fun update_active_collections<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: &AdminCap, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            ...
            0x2::linked_table::remove<0x1::ascii::String, bool>(&mut arg0.active_collections, v0);
        };
