module 0xf3a6095f435ef2f14a72f92f65d7464e83d8f500590a88c8e9b16ccc7c080ef6::phonebooth_ps_verified__ {
    struct PHONEBOOTH_PS_VERIFIED__ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"e2a8126c-2779-4825-b784-7935e7d38c84"),
        };
    ...
    fun init(arg0: PHONEBOOTH_PS_VERIFIED__, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PHONEBOOTH_PS_VERIFIED__>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"50686f6e65626f6f746820505320566572696669656420e29c85"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Phonebooth Studio Physical & Digital Products and Services Verified and Managed through our LLC.  "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmfJ3M5FgAhLYA1eLmvho1sTFb1dNqTXJ6Qh9FEyGM9pNh"));
