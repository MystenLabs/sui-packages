module 0xf3b685374c4e126885a1c7722f44dac6867b4a05ea3429899639cf0b66283c90::vault {
    ...
    struct Vault has key {
        id: 0x2::object::UID,
        ggsui_kraft_cap: 0x2::coin::TreasuryCap<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>,
    ...
    public fun claim_collected_lsd_fee(arg0: &mut Vault, arg1: &mut 0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::honey_yield::FeeCollector<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 9002);
        let v0 = LsdFeeCollected{amt: 0x2::balance::value<0x2::sui::SUI>(&arg0.protocol_fee_vault)};
        0x2::event::emit<LsdFeeCollected>(v0);
        0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::honey_yield::collect_fee_for_coin<0x2::sui::SUI>(arg1, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.protocol_fee_vault));
    }
    ...
    public fun get_ggsui_by_sui(arg0: &Vault, arg1: u64) : u64 {
        ...
        (0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::mul_div_u256((arg1 as u256), (arg0.ggsui_supply as u256), (v0 as u256)) as u64)
    }
    ...
    fun get_sui_amount(arg0: &0x3::staking_pool::PoolTokenExchangeRate, arg1: u64) : u64 {
        ...
        (0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::mul_div_u256((v0 as u256), (arg1 as u256), (v1 as u256)) as u64)
    }
    ...
    public fun get_sui_by_ggsui(arg0: &Vault, arg1: u64) : u64 {
        ...
        (0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::mul_div_u256((v0 as u256), (arg1 as u256), (arg0.ggsui_supply as u256)) as u64)
    }
    ...
    public fun get_sui_claimable_per_ggsui(arg0: &Vault) : u128 {
        ...
        (0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::mul_div_u256((v0 as u256), (1000000000 as u256), (v1 as u256)) as u128)
    }
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Vault>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Liquid staking for SUI: mint ggSUI, earn yields, and keep capital usable across the Financial OS."));
        0x2::display::add<Vault>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://assets.honeyplay.ai/global_objects/ggsui_vault.png"));
    ...
    public fun init_vault(arg0: 0x2::coin::TreasuryCap<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ConfigParams{
            pause_stake           : false,
    ...
    fun internal_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg1.version == 0, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        let v0 = get_sui_by_ggsui(arg1, 0x2::balance::value<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&arg2));
        ...
        let v4 = 0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::mul_div(v0, arg3, 10000);
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.addon_staking_rewards, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v4));
        0x2::coin::burn<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(arg2, arg4));
        arg1.ggsui_supply = 0x2::coin::total_supply<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
        let v5 = get_sui_claimable_per_ggsui(arg1);
        arg1.sui_claimable_per_ggsui = v5;
        let v6 = UserUnstakedInstantly{
            owner                   : 0x2::tx_context::sender(arg4),
            sui_withdrawn           : v0,
            ggsui_burnt             : 0x2::balance::value<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&arg2),
            redemption_fees         : v4,
    ...
    public fun query_request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        (v0, 0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::mul_div(v0, arg1.config_params.redeem_fee_bps, 10000))
    }
    ...
    public fun request_delayed_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : UnstakeRequest {
        assert!(arg1.version == 0, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        let v0 = 0x2::tx_context::epoch(arg3);
        update_accrued_rewards(arg1, arg0, arg3);
        let v1 = get_sui_by_ggsui(arg1, 0x2::balance::value<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&arg2));
        ...
        let v4 = UnstakeRequest{
            ...
            ggsui_amount       : 0x2::balance::value<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&arg2),
            sui_amount         : v1,
            requested_at_epoch : v0,
        };
        0x2::coin::burn<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(arg2, arg3));
        arg1.ggsui_supply = 0x2::coin::total_supply<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
    ...
    public fun request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = arg1.config_params.redeem_fee_bps;
        internal_instant_unstake(arg0, arg1, arg2, v0, arg3)
    }

    public fun request_instant_unstake_disc(arg0: &RedeemFeeDiscCap, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut Vault, arg3: 0x2::balance::Balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
    ...
    public fun stake_sui_request(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Vault, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI> {
        assert!(arg1.version == 0, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        ...
        0x2::coin::mint_balance<0x44427466f8bd3e4a9e3476139027401775c1fbc4639db3aa1b129e79f0c3d259::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, v1)
    }
    ...
    fun unstake_from_inactive_stake(arg0: &mut Vault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v1 = 0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::max_u64(arg3, 1000000000);
    ...
    public fun update_accrued_rewards(arg0: &mut Vault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (refresh_validator_pools(arg0, arg1, arg2)) {
            ...
            let v2 = 0;
            if (v1 > v0) {
                v2 = (0x1ba840a419648fedd184ada1f61fe907daa4aedfffd0d1423ddd8aaa90e4d623::math::mul_div_u256(((v1 - v0) as u256), (arg0.config_params.protocol_fee_percent as u256), (10000 as u256)) as u64);
            };
