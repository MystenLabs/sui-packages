module 0xf3e887b89e26816753c86cdfe3cac5797770671b53126317bf84c245b07327ad::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"TWRAE", b"TWRAE", b"Official token on Sui. Banner, ads and boost on dexscreener paid.", 0x1::option::none<0x2::url::Url>(), arg1);
