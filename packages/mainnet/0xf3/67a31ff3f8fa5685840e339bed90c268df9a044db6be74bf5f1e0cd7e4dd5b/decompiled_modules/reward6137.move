module 0xf367a31ff3f8fa5685840e339bed90c268df9a044db6be74bf5f1e0cd7e4dd5b::reward6137 {
    struct REWARD6137 has drop {
        dummy_field: bool,
    }

    struct TICKET_6137 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6137(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6137>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6137>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6137, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6137>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6137>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6137>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6137>>(v5, 0x2::tx_context::sender(arg1));
    }
