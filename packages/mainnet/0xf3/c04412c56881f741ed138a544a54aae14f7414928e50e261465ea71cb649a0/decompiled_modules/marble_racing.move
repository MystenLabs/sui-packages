module 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing {
    ...
    struct AddBetEvent has copy, drop {
        ...
        bet_size: u64,
        payout: u64,
        option: vector<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>,
    ...
    struct BetResultV2<phantom T0> has copy, drop {
        ...
        player: address,
        bet_options: vector<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>,
        bet_size: u64,
        bet_returned: u64,
        outcome: vector<u64>,
    }
    ...
    struct RaceConfig has store, key {
        ...
        page_size: u64,
        bet_manager: 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::BetManager,
        max_combo: u8,
    ...
    struct Race has store, key {
        ...
        bet_end_time: u64,
        status: u64,
        risk_manager: 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::risk_manager::RiskManager,
        bet_setting: 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::BetSetting,
    ...
    fun remove(arg0: &mut RaceConfig, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::risk_manager::destroy_manager(v6);
    ...
    public fun set_house_edge(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64) {
        ...
        0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::set_house_edge(&mut arg0.bet_manager, arg2);
    }
    ...
    public fun add_bet<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut RaceConfig, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: vector<u64>, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(0x1::vector::length<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>(&v1) <= (arg1.max_combo as u64), 6);
        let v2 = 0x2::tx_context::sender(arg7);
        let v3 = 0x2::coin::into_balance<T0>(arg3);
        let v4 = 0x2::balance::value<T0>(&v3);
        let (v5, v6) = 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::get_bet_payout(&arg1.bet_manager, &v0.bet_setting, v4, v1, 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::risk_manager::marble_ids(&v0.risk_manager));
        let v7 = 0x1::type_name::get<T0>();
        0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::risk_manager::add_risk(&mut v0.risk_manager, 0x1::type_name::get<T0>(), v1, v6);
    ...
    public fun create(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: &mut RaceConfig, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = Race{
            ...
            bet_end_time   : arg2,
            status         : 0,
            risk_manager   : 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::risk_manager::new_manager(arg4, arg6),
            bet_setting    : 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::new_bet_setting(arg4),
    ...
    public fun create_bank<T0>(arg0: &AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::new_bank<T0>(arg1);
    }

    fun create_option(arg0: vector<u64>, arg1: vector<u8>) : vector<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement> {
        assert!(0x1::vector::length<u64>(&arg0) == 0x1::vector::length<u8>(&arg1), 10);
        let v0 = 0x1::vector::empty<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            0x1::vector::push_back<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>(&mut v0, 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::new_placement(*0x1::vector::borrow<u64>(&arg0, v1), *0x1::vector::borrow<u8>(&arg1, v1)));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RaceConfig{
            ...
            page_size    : 200,
            bet_manager  : 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::new_bet_manager(),
            max_combo    : 3,
    ...
    public fun put_to_bank<T0>(arg0: &AdminCap, arg1: &mut 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::MarbleRacingBank<T0>, arg2: 0x2::coin::Coin<T0>) {
        0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::put_to_bank<T0>(arg1, arg2);
    }
    ...
    public fun resolve<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: 0x2::object::ID, arg2: vector<u64>, arg3: &mut RaceConfig, arg4: 0x1::option::Option<u64>, arg5: &mut 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::MarbleRacingBank<T0>, arg6: &mut 0x2::tx_context::TxContext) {
        assert_valid_package_version(arg3);
        assert_sender_is_manager(arg3, arg6);
        ...
        while (v8 < v7 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            ...
            while (v8 < v7 && 0x1::vector::length<BetSlip>(&v11) != 0) {
                ...
                if (v12.coin_type == 0x1::type_name::get<T0>()) {
                    ...
                    let v19 = v17;
                    if (0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::won_bet(v12.option, arg2)) {
                        v4 = v4 + v16;
                        ...
                        0x1::vector::push_back<PlayerWin<T0>>(&mut v3, v20);
                    } else {
                    ...
                    let v21 = 0;
                    let v22 = 0x1::vector::empty<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>();
                    while (v21 < 0x1::vector::length<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>(&v19)) {
                        0x1::vector::push_back<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>(&mut v22, *0x1::vector::borrow<0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::bet_manager::Placement>(&v19, v21));
                        v21 = v21 + 1;
                    };
                    let v23 = BetResultV2<T0>{
                    ...
                    0x1::vector::push_back<BetResultV2<T0>>(&mut v6, v23);
        ...
        if (!0x1::vector::is_empty<PlayerWin<T0>>(&v3)) {
            while (!0x1::vector::is_empty<PlayerWin<T0>>(&v3)) {
                ...
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::get_from_bank<T0>(arg5, v26), arg6), v24);
                0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::put_to_bank<T0>(arg5, 0x2::coin::from_balance<T0>(v25, arg6));
            };
        };
        0x1::vector::destroy_empty<PlayerWin<T0>>(v3);
        if (0x2::balance::value<T0>(&v5) != 0) {
            0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::put_to_bank<T0>(arg5, 0x2::coin::from_balance<T0>(v5, arg6));
        } else {
            0x2::balance::destroy_zero<T0>(v5);
        };
        let v27 = BetResultsV2<T0>{
            race_id : 0x1::option::some<0x2::object::ID>(arg1),
            origin  : 0x1::option::none<0x1::string::String>(),
            bets    : v6,
        };
        0x2::event::emit<BetResultsV2<T0>>(v27);
        if (0x2::linked_table::length<address, vector<BetSlip>>(v1) == 0) {
            remove(arg3, arg1, arg6);
        };
    }
    ...
    public fun withdraw_from_bank<T0>(arg0: &AdminCap, arg1: address, arg2: &mut 0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::MarbleRacingBank<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xf3c04412c56881f741ed138a544a54aae14f7414928e50e261465ea71cb649a0::marble_racing_bank::withdraw_from_bank<T0>(arg1, arg2, arg3);
    }
