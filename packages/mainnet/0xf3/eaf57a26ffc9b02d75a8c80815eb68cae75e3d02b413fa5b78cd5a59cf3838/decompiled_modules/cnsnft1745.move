module 0xf3eaf57a26ffc9b02d75a8c80815eb68cae75e3d02b413fa5b78cd5a59cf3838::cnsnft1745 {
    struct CNSNFT1745 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1745, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3236"));
        let v4 = 0x2::package::claim<CNSNFT1745>(arg0, arg1);
