module 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::oracle {
    ...
    public(friend) fun add_attestation(arg0: &mut Oracle, arg1: Attestation, arg2: u64) {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<Attestation>(&v1)) {
            let v3 = 0x1::vector::pop_back<Attestation>(&mut v1);
            let v4 = &v3;
            if (v4.timestamp_ms + 600000 > arg2 && v4.guardian_id != arg1.guardian_id) {
                0x1::vector::push_back<Attestation>(&mut v0, v3);
            };
            v2 = v2 + 1;
        };
    ...
    public(friend) fun disable(arg0: &mut Oracle) {
        arg0.secp256k1_key = b"";
        arg0.mr_enclave = b"";
        arg0.expiration_time_ms = 0;
    }
    ...
    public fun version(arg0: &Oracle) : u8 {
        arg0.version
    }
