module 0xc3c7e6eb7202e9fb0389a2f7542b91cc40e4f7a33c02554fec11c4c92f938ea3::queue {
    ...
    public(friend) fun new(arg0: vector<u8>, arg1: address, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: u64, arg6: u64, arg7: 0x2::object::ID, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        if (arg8) {
            let v1 = Queue{
                ...
                fee_types                 : 0x1::vector::singleton<0x1::type_name::TypeName>(0x1::type_name::with_defining_ids<0x2::coin::Coin<0x2::sui::SUI>>()),
                version                   : 1,
            };
    ...
    public(friend) fun add_fee_type<T0>(arg0: &mut Queue) {
        let v0 = 0x1::type_name::with_defining_ids<0x2::coin::Coin<T0>>();
        if (0x1::vector::contains<0x1::type_name::TypeName>(&arg0.fee_types, &v0)) {
            return
        };
        0x1::vector::push_back<0x1::type_name::TypeName>(&mut arg0.fee_types, 0x1::type_name::with_defining_ids<0x2::coin::Coin<T0>>());
    }
    ...
    public fun is_paused(arg0: &Queue) : bool {
        0x1::vector::is_empty<0x1::type_name::TypeName>(&arg0.fee_types)
    }
    ...
    public(friend) fun set_version(arg0: &mut Queue, arg1: u8) {
        arg0.version = arg1;
    }
