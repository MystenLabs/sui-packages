module 0xea050839932d9f4c1986f7761ad19762d2d52f8777ddeb842d4aac9b0c42b6e8::giant_puppy {
    struct GIANT_PUPPY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GIANT_PUPPY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GIANT_PUPPY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Giant Puppy"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"109 unique pixel art dogs with random traits, from the GiantPuppy universe!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibq4plnitvslgsce7sdw54mvrugdal6pa3cpiuqclxugh5vsjcj4a"));
