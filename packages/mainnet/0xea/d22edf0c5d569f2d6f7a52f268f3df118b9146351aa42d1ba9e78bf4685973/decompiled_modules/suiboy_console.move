module 0xead22edf0c5d569f2d6f7a52f268f3df118b9146351aa42d1ba9e78bf4685973::suiboy_console {
    ...
    public entry fun mint_console(arg0: 0x1::string::String, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 3000000000;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) >= v0, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v0, arg2), @0xe1089d77e25643ea64ea003106ee093f9d066ad1579027ac8f5f2e0779e190a8);
