module 0xeab12cd4717f4c95ec91d842fc77a8adffaa328aac7d09dcddb5e232ad12ff4c::dal {
    struct DAL has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DAL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (100000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<DAL>>(0x2::coin::mint<DAL>(&mut v5, 100000000000000, arg1), v6);
        };
