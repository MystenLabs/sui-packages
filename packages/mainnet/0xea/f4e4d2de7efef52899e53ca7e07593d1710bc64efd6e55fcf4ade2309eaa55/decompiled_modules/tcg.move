module 0x99add1c09a42cdd15ee526f1da6f479c52482d81a7777bf6984489d39a982096::tcg {
    ...
    public(friend) fun init_card_type(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferPolicy<Card>, 0x2::transfer_policy::TransferPolicyCap<Card>) {
        ...
        0x2::display::add<Card>(&mut v0, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Fantasy TCG 007"));
        0x2::display::add<Card>(&mut v0, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A Generic TCG"));
        0x2::display::add<Card>(&mut v0, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidonvncombv26657nc2ejt3hyw6earrs4r3wk352klutglgby5cju"));
