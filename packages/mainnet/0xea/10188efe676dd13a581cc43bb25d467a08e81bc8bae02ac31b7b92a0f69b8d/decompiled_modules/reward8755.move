module 0xea10188efe676dd13a581cc43bb25d467a08e81bc8bae02ac31b7b92a0f69b8d::reward8755 {
    struct REWARD8755 has drop {
        dummy_field: bool,
    }

    struct TICKET_8755 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8755(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8755>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8755>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8755, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8755>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8755>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8755>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8755>>(v5, 0x2::tx_context::sender(arg1));
    }
