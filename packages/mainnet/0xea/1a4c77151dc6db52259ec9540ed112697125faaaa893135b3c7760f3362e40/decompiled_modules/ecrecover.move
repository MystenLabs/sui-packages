module 0xea1a4c77151dc6db52259ec9540ed112697125faaaa893135b3c7760f3362e40::ecrecover {
    ...
    public fun test_ecrecover(arg0: address, arg1: u64, arg2: &vector<u8>, arg3: &0x2::clock::Clock) {
        ...
        let v7 = EcrecoverDebugEvent{
            ...
            final_msg           : v2,
            struct_hash         : v1,
            message_hash        : 0x2::hash::keccak256(&v2),
            compressed_pubkey   : v3,
            uncompressed_pubkey : v4,
            pubkey_wo_prefix    : v5,
