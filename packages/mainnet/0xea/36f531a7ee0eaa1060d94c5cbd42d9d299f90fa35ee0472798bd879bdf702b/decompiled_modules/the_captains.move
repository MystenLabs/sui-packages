module 0xea36f531a7ee0eaa1060d94c5cbd42d9d299f90fa35ee0472798bd879bdf702b::the_captains {
    ...
    public fun admin_add_royalty_rule(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<PfpNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<PfpNFT>, arg3: u16, arg4: u64) {
        0xea36f531a7ee0eaa1060d94c5cbd42d9d299f90fa35ee0472798bd879bdf702b::fixed_royalty_rule::add<PfpNFT>(arg1, arg2, arg3, arg4);
    }
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = v13;
        let v15 = v12;
        0xea36f531a7ee0eaa1060d94c5cbd42d9d299f90fa35ee0472798bd879bdf702b::fixed_royalty_rule::add<PfpNFT>(&mut v15, &v14, 100, 10000000);
