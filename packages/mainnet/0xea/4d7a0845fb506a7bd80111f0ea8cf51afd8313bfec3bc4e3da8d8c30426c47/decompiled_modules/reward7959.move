module 0xea4d7a0845fb506a7bd80111f0ea8cf51afd8313bfec3bc4e3da8d8c30426c47::reward7959 {
    struct REWARD7959 has drop {
        dummy_field: bool,
    }

    struct TICKET_7959 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7959(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7959>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7959>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7959, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7959>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7959>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7959>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7959>>(v5, 0x2::tx_context::sender(arg1));
    }
