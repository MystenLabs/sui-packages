module 0xeafbb16788c200df6d11c57824fd9cc4c0ac18de6e964323000cbb169917a658::reward6731 {
    struct REWARD6731 has drop {
        dummy_field: bool,
    }

    struct TICKET_6731 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6731(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6731>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6731>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6731, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6731>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6731>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6731>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6731>>(v5, 0x2::tx_context::sender(arg1));
    }
