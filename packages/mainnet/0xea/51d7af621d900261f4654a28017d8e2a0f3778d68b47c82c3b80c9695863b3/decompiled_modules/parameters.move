module 0xea51d7af621d900261f4654a28017d8e2a0f3778d68b47c82c3b80c9695863b3::parameters {
    ...
    public fun check_sender(arg0: &Parameters, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834668264620031);
    }
    ...
    public fun production_stonker_parameters(arg0: &mut 0x2::tx_context::TxContext) : Parameters {
        ...
        Parameters{
            ...
            maker_max_deep_sell_quantity_base          : 2 * v0,
            maker_max_deep_buy_quantity_base           : 3 * v0,
