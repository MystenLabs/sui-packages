module 0xeabb9e11de24213f24f1f8dba2b3b5324c0570b360f1ce1be8460ef5fe7e07ef::game7005 {
    struct GAME7005 has drop {
        dummy_field: bool,
    }

    struct TICKET_7005 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7005(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7005>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7005>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7005, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7005>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7005>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7005>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7005>>(v5, 0x2::tx_context::sender(arg1));
    }
