module 0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_protocol_params {
    ...
    public fun create_cetus_config(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: 0x2::object::ID, arg7: 0x2::object::ID, arg8: u64, arg9: u64) : 0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::ProtocolConfig {
        ...
        0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::create_config(v0, v2, 0x2::vec_map::empty<u8, vector<u8>>())
    }

    public fun create_hearn_config(arg0: 0x2::object::ID, arg1: u64) : 0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::ProtocolConfig {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, arg0);
        let v1 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v1, arg1);
        0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::create_config(v0, v1, 0x2::vec_map::empty<u8, vector<u8>>())
    }

    public fun create_navi_config(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: u8) : 0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::ProtocolConfig {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, arg0);
        0x1::vector::push_back<0x2::object::ID>(v1, arg1);
    ...
    public fun create_scallop_config(arg0: 0x2::object::ID, arg1: 0x2::object::ID) : 0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::ProtocolConfig {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        let v1 = &mut v0;
        0x1::vector::push_back<0x2::object::ID>(v1, arg0);
        0x1::vector::push_back<0x2::object::ID>(v1, arg1);
        0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::create_config(v0, vector[], 0x2::vec_map::empty<u8, vector<u8>>())
    }

    public fun create_suilend_config(arg0: 0x2::object::ID, arg1: u64) : 0xea4576ec5af22bc9dfc80ae3982c2163a3cd44f229565804975606552cae0b02::llv_pool::ProtocolConfig {
        let v0 = 0x1::vector::empty<0x2::object::ID>();
        0x1::vector::push_back<0x2::object::ID>(&mut v0, arg0);
        let v1 = 0x1::vector::empty<u64>();
        0x1::vector::push_back<u64>(&mut v1, arg1);
