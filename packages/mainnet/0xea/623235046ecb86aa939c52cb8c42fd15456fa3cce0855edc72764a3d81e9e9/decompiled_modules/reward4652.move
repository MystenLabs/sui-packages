module 0xea623235046ecb86aa939c52cb8c42fd15456fa3cce0855edc72764a3d81e9e9::reward4652 {
    struct REWARD4652 has drop {
        dummy_field: bool,
    }

    struct TICKET_4652 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4652(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4652>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4652>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4652, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4652>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4652>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4652>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4652>>(v5, 0x2::tx_context::sender(arg1));
    }
