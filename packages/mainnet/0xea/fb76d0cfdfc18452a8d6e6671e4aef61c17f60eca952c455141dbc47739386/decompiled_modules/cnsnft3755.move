module 0xeafb76d0cfdfc18452a8d6e6671e4aef61c17f60eca952c455141dbc47739386::cnsnft3755 {
    struct CNSNFT3755 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3755, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6863"));
        let v4 = 0x2::package::claim<CNSNFT3755>(arg0, arg1);
