module 0xeac43fe10f04537eac5e9ee734166641af69176d3b520256124f8721d442c8a5::pool {
    ...
    public(friend) fun deposit_treasury<T0>(arg0: &mut Pool<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 0xeac43fe10f04537eac5e9ee734166641af69176d3b520256124f8721d442c8a5::error::insufficient_balance());
    ...
    public fun withdraw_treasury<T0>(arg0: &mut PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1.treasury_balance) >= arg2, 0xeac43fe10f04537eac5e9ee734166641af69176d3b520256124f8721d442c8a5::error::insufficient_balance());
