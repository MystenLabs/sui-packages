module 0xea6c273ba68e66a53722e6ddcc9d583786482ffed0e91f438bdb75e937512007::suitradingbot {
    ...
    fun init(arg0: SUITRADINGBOT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUITRADINGBOT>(arg0, 9, b"sui trading bot", b"sbot", b"Discover Sui Trading Bot, the top Telegram trading bot, revolutionizing DeFi on Sui Network. Our advanced technology offers unmatched trading and sniping tools, redefining digital asset trading. Website: https://suitradingbot.io Twitter: https://x.com/sui_tradingbot", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/AUen6xg.png")), arg1);
        let v2 = v0;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<SUITRADINGBOT>>(v1);
        0x2::coin::mint_and_transfer<SUITRADINGBOT>(&mut v2, 1000000000, 0x2::tx_context::sender(arg1), arg1);
