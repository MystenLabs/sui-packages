module 0xead632f4aaff26dc606eedc78d992e3e61b9b832a64e5fee75d22edfc23960ca::cnsnft3923 {
    struct CNSNFT3923 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3923, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3923>(arg0, arg1);
