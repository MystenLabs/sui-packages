module 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::sdeusd {
    ...
    struct CooldownUnrestrictedStakerAdded has copy, drop, store {
        sender: address,
        staker: address,
    }

    struct CooldownUnrestrictedStakerRemoved has copy, drop, store {
        sender: address,
        staker: address,
    }
    ...
    public fun add_cooldown_unrestricted_staker(arg0: &mut 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::check_package_version(arg0);
        assert!(0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::has_role(arg0, 0x2::tx_context::sender(arg2), 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::roles::role_cooldown_unrestricted_staker_manager()), 1);
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::add_role_internal(arg0, arg1, 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::roles::role_cooldown_unrestricted_staker());
    }
    ...
    public fun cooldown_assets(arg0: &mut SdeUSDManagement, arg1: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg2: u64, arg3: &mut 0x2::coin::Coin<SDEUSD>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        update_user_cooldown(arg0, arg1, v0, arg2, arg4);
    ...
    public fun cooldown_shares(arg0: &mut SdeUSDManagement, arg1: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg2: &mut 0x2::coin::Coin<SDEUSD>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        update_user_cooldown(arg0, arg1, v0, v2, arg3);
    ...
    public fun is_cooldown_unrestricted_staker(arg0: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg1: address) : bool {
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::has_role(arg0, arg1, 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::roles::role_cooldown_unrestricted_staker())
    }
    ...
    public fun remove_cooldown_unrestricted_staker(arg0: &mut 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::check_package_version(arg0);
        assert!(0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::has_role(arg0, 0x2::tx_context::sender(arg2), 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::roles::role_cooldown_unrestricted_staker_manager()), 1);
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::remove_role_internal(arg0, arg1, 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::roles::role_cooldown_unrestricted_staker());
    }
    ...
    fun update_user_cooldown(arg0: &mut SdeUSDManagement, arg1: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        let v0 = if (0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::has_role(arg1, arg2, 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::roles::role_cooldown_unrestricted_staker())) {
            0
        } else {
            arg0.cooldown_duration
        };
        if (0x2::table::contains<address, UserCooldown>(&arg0.cooldowns, arg2)) {
            let v1 = 0x2::table::borrow_mut<address, UserCooldown>(&mut arg0.cooldowns, arg2);
            v1.cooldown_end = 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::clock_utils::timestamp_seconds(arg4) + v0;
            v1.underlying_amount = v1.underlying_amount + arg3;
        } else {
            let v2 = UserCooldown{
                cooldown_end      : 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::clock_utils::timestamp_seconds(arg4) + v0,
                underlying_amount : arg3,
            };
            0x2::table::add<address, UserCooldown>(&mut arg0.cooldowns, arg2, v2);
        };
    }
