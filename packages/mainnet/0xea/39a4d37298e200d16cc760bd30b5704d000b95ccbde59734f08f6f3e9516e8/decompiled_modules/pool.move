module 0xea39a4d37298e200d16cc760bd30b5704d000b95ccbde59734f08f6f3e9516e8::pool {
    ...
    public(friend) fun add_reserved_amount(arg0: &mut Stats, arg1: u64, arg2: u64) {
        ...
        if (0x2::vec_map::size<u64, u64>(&arg0.reserved_amount_by_epoch) > 0xea39a4d37298e200d16cc760bd30b5704d000b95ccbde59734f08f6f3e9516e8::constants::num_keeps_to_reserve()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = StatsKey{
            name           : 0xea39a4d37298e200d16cc760bd30b5704d000b95ccbde59734f08f6f3e9516e8::constants::open_ended_str(),
        ...
        let v3 = StatsKey{
            name           : 0xea39a4d37298e200d16cc760bd30b5704d000b95ccbde59734f08f6f3e9516e8::constants::locked_str(),
    ...
    public fun total_locked_amount(arg0: &RewardPool, arg1: u64, arg2: &0x2::tx_context::TxContext) : u64 {
        total_staked_amount(arg0, 0xea39a4d37298e200d16cc760bd30b5704d000b95ccbde59734f08f6f3e9516e8::constants::locked_str(), 0x1::option::some<u64>(arg1)) + current_total_reserved_amount(arg0, 0xea39a4d37298e200d16cc760bd30b5704d000b95ccbde59734f08f6f3e9516e8::constants::locked_str(), 0x1::option::some<u64>(arg1), arg2)
    }
