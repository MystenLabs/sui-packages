module 0xea33cef938e039b9d9d9d022e387262525843861a609e73d17f604d63e372d98::reward4978 {
    struct REWARD4978 has drop {
        dummy_field: bool,
    }

    struct TICKET_4978 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4978(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4978>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4978>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4978, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4978>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4978>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4978>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4978>>(v5, 0x2::tx_context::sender(arg1));
    }
