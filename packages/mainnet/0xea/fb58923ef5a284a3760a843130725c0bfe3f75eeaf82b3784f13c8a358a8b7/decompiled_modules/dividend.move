module 0x785248249ac457dfd378bdc6d2fbbfec9d1daf65e9d728b820eb4888c8da2c10::dividend {
    ...
    struct VeNFTDividends has key {
        id: 0x2::object::UID,
        venft_dividends: 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::LinkedTable<0x2::object::ID, VeNFTDividendInfoV2>,
    }
    ...
    struct DividendInfoEvent has copy, drop, store {
        info: 0x2::vec_map::VecMap<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>,
    }

    struct InitVeNFTDividendsEvent has copy, drop {
        id: 0x2::object::ID,
    }
    ...
    fun add_dividend(arg0: &mut DividendManager, arg1: 0x2::object::ID, arg2: u64, arg3: 0x1::type_name::TypeName, arg4: u64) : bool {
        if (!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, VeNFTDividendInfo>(&arg0.venft_dividends, arg1)) {
        ...
        if (!0x2::vec_map::contains<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends, &arg2)) {
    ...
    fun add_dividend_v2(arg0: &mut VeNFTDividends, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg4: &mut 0x2::tx_context::TxContext) : bool {
        if (!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, VeNFTDividendInfoV2>(&arg0.venft_dividends, arg1)) {
            let v0 = VeNFTDividendInfoV2{dividends: 0x2::table::new<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(arg4)};
            0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::push_back<0x2::object::ID, VeNFTDividendInfoV2>(&mut arg0.venft_dividends, arg1, v0);
        };
        let v1 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<0x2::object::ID, VeNFTDividendInfoV2>(&mut arg0.venft_dividends, arg1);
    ...
    public fun checked_package_version(arg0: &DividendManager) {
        assert!(arg0.package_version <= 5, 7);
    }
    ...
    public fun fetch_dividend_info(arg0: &DividendManager, arg1: 0x2::object::ID) {
        let v0 = DividendInfoEvent{info: 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, VeNFTDividendInfo>(&arg0.venft_dividends, arg1).dividends};
        0x2::event::emit<DividendInfoEvent>(v0);
    }

    public fun fetch_dividend_info_v2(arg0: &DividendManager, arg1: &VeNFTDividends, arg2: 0x2::object::ID) {
        let v0 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, VeNFTDividendInfo>(&arg0.venft_dividends, arg2).dividends;
        let v1 = &0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, VeNFTDividendInfoV2>(&arg1.venft_dividends, arg2).dividends;
        let v2 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::head<u64, DividendInfo>(&arg0.dividends);
        while (0x1::option::is_some<u64>(&v2)) {
            let v3 = *0x1::option::borrow<u64>(&v2);
            if (0x2::table::contains<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(v1, v3)) {
                0x2::vec_map::insert<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut v0, v3, *0x2::table::borrow<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(v1, v3));
            };
            v2 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::next<u64, DividendInfo>(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_node<u64, DividendInfo>(&arg0.dividends, v3));
        };
        let v4 = DividendInfoEvent{info: v0};
        0x2::event::emit<DividendInfoEvent>(v4);
    }
    ...
    public entry fun init_venft_dividends(arg0: &AdminCap, arg1: &mut DividendManager, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_field::exists_with_type<0x1::string::String, 0x2::object::ID>(&arg1.id, 0x1::string::utf8(b"VeNFTDividends")), 409);
        let v0 = VeNFTDividends{
            id              : 0x2::object::new(arg2),
            venft_dividends : 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::new<0x2::object::ID, VeNFTDividendInfoV2>(arg2),
        };
        let v1 = InitVeNFTDividendsEvent{id: 0x2::object::id<VeNFTDividends>(&v0)};
        0x2::event::emit<InitVeNFTDividendsEvent>(v1);
        0x2::dynamic_field::add<0x1::string::String, 0x2::object::ID>(&mut arg1.id, 0x1::string::utf8(b"VeNFTDividends"), 0x2::object::id<VeNFTDividends>(&v0));
        0x2::transfer::share_object<VeNFTDividends>(v0);
    }
    ...
    public entry fun redeem_extra<T0>(arg0: &AdminCap, arg1: &mut DividendManager, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::length<u64, DividendInfo>(&arg1.dividends)) {
            let v2 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<u64, DividendInfo>(&mut arg1.dividends, v1 + 1);
            if (v2.is_settled) {
                let v3 = key<T0>();
                let v4 = key<T0>();
    ...
    fun redeem_token<T0>(arg0: &mut DividendManager, arg1: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT, arg2: &0x2::clock::Clock) : u64 {
        checked_package_version(arg0);
        let v0 = 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg1);
        if (!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, VeNFTDividendInfo>(&arg0.venft_dividends, v0)) {
            return 0
        };
        ...
        while (v2 < 0x2::vec_map::size<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends)) {
            let v8 = 0x1::vector::borrow<u64>(&v3, v2);
            if (arg0.start_time + *v8 * 86400 * (arg0.interval_day as u64) > 0x2::clock::timestamp_ms(arg2) / 1000) {
                v2 = v2 + 1;
                continue
            };
            0x1::vector::push_back<u64>(&mut v7, *v8);
            let v9 = 0x2::vec_map::get_mut<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut v1.dividends, v8);
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(v9, &v6)) {
                let (_, v11) = 0x2::vec_map::remove<0x1::type_name::TypeName, u64>(v9, &v6);
                v4 = v4 + v11;
                0x2::vec_map::insert<u64, u64>(&mut v5, *v8, v11);
            };
            if (0x2::vec_map::size<0x1::type_name::TypeName, u64>(v9) == 0) {
                let (_, _) = 0x2::vec_map::remove<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut v1.dividends, v8);
            };
            v2 = v2 + 1;
        };
        if (v4 == 0) {
    ...
    fun redeem_token_v2<T0>(arg0: &mut DividendManager, arg1: &mut VeNFTDividends, arg2: vector<u64>, arg3: &0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT, arg4: &0x2::clock::Clock) : u64 {
        checked_package_version(arg0);
        let v0 = 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg3);
        if (!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, VeNFTDividendInfoV2>(&arg1.venft_dividends, v0)) {
            return 0
        };
        let v1 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<0x2::object::ID, VeNFTDividendInfoV2>(&mut arg1.venft_dividends, v0);
        let v2 = 0;
        let v3 = 0;
        ...
        while (v2 < 0x1::vector::length<u64>(&arg2)) {
            ...
            if (arg0.start_time + v7 * 86400 * (arg0.interval_day as u64) > 0x2::clock::timestamp_ms(arg4) / 1000) {
                v2 = v2 + 1;
                continue
            };
            assert!(0x2::table::contains<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&v1.dividends, v7), 404);
            let v8 = 0x2::table::borrow_mut<u64, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>>(&mut v1.dividends, v7);
            if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(v8, &v5)) {
                let (_, v10) = 0x2::vec_map::remove<0x1::type_name::TypeName, u64>(v8, &v5);
                v3 = v3 + v10;
                0x2::vec_map::insert<u64, u64>(&mut v4, v7, v10);
        ...
        let v11 = RedeemEvent{
            venft_id      : 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg3),
            phases        : v6,
            redeemed_nums : v4,
            amount        : v3,
        };
    ...
    public fun redeem_v2<T0>(arg0: &mut DividendManager, arg1: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = redeem_token<T0>(arg0, arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(take<T0>(arg0, v0), arg3), 0x2::tx_context::sender(arg3));
        let v1 = RedeemV2Event{
            venft_id : 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg1),
            type     : 0x1::type_name::get<T0>(),
            amount   : v0,
        };
        0x2::event::emit<RedeemV2Event>(v1);
    }

    public fun redeem_v3<T0>(arg0: &mut DividendManager, arg1: &mut VeNFTDividends, arg2: vector<u64>, arg3: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = redeem_token<T0>(arg0, arg3, arg4);
        let v1 = redeem_token_v2<T0>(arg0, arg1, arg2, arg3, arg4);
        let v2 = v0 + v1;
        assert!(v2 > 0, 15);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(take<T0>(arg0, v2), arg5), 0x2::tx_context::sender(arg5));
        let v3 = RedeemV3Event{
            venft_id : 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg3),
            type     : 0x1::type_name::get<T0>(),
            amount   : v2,
        };
        0x2::event::emit<RedeemV3Event>(v3);
    }

    public fun redeem_xtoken(arg0: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::locking::LockUpManager, arg1: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XcetusManager, arg2: &mut DividendManager, arg3: &mut 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = redeem_token<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XCETUS>(arg2, arg3, arg4);
        0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::locking::convert(arg0, arg1, 0x1::vector::singleton<0x2::coin::Coin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>>(0x2::coin::from_balance<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(take<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(arg2, v0), arg5)), v0, arg3, arg5);
        let v1 = RedeemV2Event{
            venft_id : 0x2::object::id<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNFT>(arg3),
            type     : 0x1::type_name::get<0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XCETUS>(),
            amount   : v0,
        };
        0x2::event::emit<RedeemV2Event>(v1);
    }
    ...
    public fun register_bonus<T0>(arg0: &AdminCap, arg1: &mut DividendManager, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (arg2 > 1) {
            ...
            assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<u64, DividendInfo>(&arg1.dividends, arg2 - 1).is_settled, 2);
        };
        checked_package_version(arg1);
        let v0 = 0x1::type_name::get<T0>();
        ...
        let v3 = key<T0>();
        assert!(!0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&v2.bonus, &v3), 16);
    ...
    public fun settle_v2(arg0: &SettleCap, arg1: &mut VeNFTDividends, arg2: &mut DividendManager, arg3: &0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::XcetusManager, arg4: u64, arg5: vector<0x2::object::ID>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::object::ID> {
        checked_package_version(arg2);
        assert!(arg2.is_open, 4);
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<u64, DividendInfo>(&arg2.dividends, arg4), 5);
        assert!(!0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<u64, DividendInfo>(&arg2.dividends, arg4).is_settled, 1);
        let v0 = 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::nfts(arg3);
        let v1 = if (0x1::vector::is_empty<0x2::object::ID>(&arg5)) {
            ...
            assert!(0x1::vector::length<0x2::object::ID>(&arg5) == 1, 6);
            0x1::option::some<0x2::object::ID>(0x1::vector::pop_back<0x2::object::ID>(&mut arg5))
        };
        let v2 = v1;
        ...
        let v3 = 0;
        let v4 = 0;
        let v5 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<u64, DividendInfo>(&arg2.dividends, arg4).bonus_types;
        let v6 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<u64, DividendInfo>(&arg2.dividends, arg4).bonus;
        let v7 = (0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::effective_totol_amount(arg3) as u128);
        if (v7 == 0) {
            0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<u64, DividendInfo>(&mut arg2.dividends, arg4).is_settled = true;
            let v8 = SettleEvent{
                phase   : arg4,
                start   : arg5,
                limit   : arg6,
                next_id : 0x1::option::none<0x2::object::ID>(),
                count   : 0,
            };
            0x2::event::emit<SettleEvent>(v8);
            return 0x1::option::none<0x2::object::ID>()
        };
        while (0x1::option::is_some<0x2::object::ID>(&v2) && v3 < arg6) {
            let v9 = *0x1::option::borrow<0x2::object::ID>(&v2);
            let v10 = 0;
            let v11 = 0x2::vec_map::empty<0x1::type_name::TypeName, u64>();
            while (v10 < 0x1::vector::length<0x1::type_name::TypeName>(&v5)) {
                let v12 = *0x1::vector::borrow<0x1::type_name::TypeName>(&v5, v10);
                0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v11, v12, (((0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::effective_xcetus_amount(arg3, 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNftInfo>(v0, v9)) as u128) * (*0x2::vec_map::get<0x1::type_name::TypeName, u64>(&v6, &v12) as u128) / v7) as u64));
                v10 = v10 + 1;
            };
            if (add_dividend_v2(arg1, v9, arg4, v11, arg7)) {
                v4 = v4 + 1;
            };
            v2 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::next<0x2::object::ID, 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNftInfo>(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_node<0x2::object::ID, 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::VeNftInfo>(v0, v9));
            v3 = v3 + 1;
        };
        let v13 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_mut<u64, DividendInfo>(&mut arg2.dividends, arg4);
        v13.settled_num = v13.settled_num + v4;
        if (v13.settled_num >= 0x9e69acc50ca03bc943c4f7c5304c2a6002d507b51c11913b247159c60422c606::xcetus::total_holder(arg3)) {
            v13.is_settled = true;
        };
        let v14 = SettleEvent{
            phase   : arg4,
        ...
        0x2::event::emit<SettleEvent>(v14);
        v2
    }
