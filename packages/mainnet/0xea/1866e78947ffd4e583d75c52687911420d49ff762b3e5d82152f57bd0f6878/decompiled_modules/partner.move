module 0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::partner {
    ...
    public fun claim_ref_fee<T0>(arg0: &0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::GlobalConfig, arg1: &PartnerCap, arg2: &mut Partner, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_partner(arg0: &0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::GlobalConfig, arg1: &mut Partners, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: address, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::checked_package_version(arg0);
        0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::check_partner_manager_role(arg0, 0x2::tx_context::sender(arg8));
        let v0 = Partner{
    ...
    public fun max_ref_fee_rate() : u64 {
        80 * 0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::protocol_fee_rate_denom() / 100
    }
    ...
    public fun update_ref_fee_rate(arg0: &0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::GlobalConfig, arg1: &mut Partner, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        assert!(arg2 < max_ref_fee_rate(), 930926203952059348);
        0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::checked_package_version(arg0);
        0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::check_partner_manager_role(arg0, 0x2::tx_context::sender(arg3));
    ...
    public fun update_time_range(arg0: &0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::GlobalConfig, arg1: &mut Partner, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert!(arg3 > arg2, 934628203496823095);
        assert!(arg3 > 0x2::clock::timestamp_ms(arg4) / 1000, 934628203496823095);
        0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::checked_package_version(arg0);
        0xea1866e78947ffd4e583d75c52687911420d49ff762b3e5d82152f57bd0f6878::config::check_partner_manager_role(arg0, 0x2::tx_context::sender(arg5));
