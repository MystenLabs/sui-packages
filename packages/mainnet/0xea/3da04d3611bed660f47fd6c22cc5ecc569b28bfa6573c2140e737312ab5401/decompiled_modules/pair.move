module 0xea3da04d3611bed660f47fd6c22cc5ecc569b28bfa6573c2140e737312ab5401::pair {
    ...
    public(friend) fun mint<T0, T1>(arg0: &mut Pair<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1>> {
        ...
        let v2 = if (arg0.total_supply == 0) {
            let v3 = 0xea3da04d3611bed660f47fd6c22cc5ecc569b28bfa6573c2140e737312ab5401::math_utils::integer_sqrt(v0 * v1);
            assert!(v3 > 1000, 102);
            v3 - 1000
        } else {
            ...
            let v4 = v0 * arg0.total_supply / arg0.reserve0;
            let v5 = v1 * arg0.total_supply / arg0.reserve1;
            assert!(v4 > 0, 112);
            assert!(v5 > 0, 112);
            if (v4 < v5) {
                v4
        ...
        let v6 = arg0.reserve0 + v0;
        let v7 = arg0.reserve1 + v1;
        update<T0, T1>(arg0, v6, v7, arg3, arg4);
        let v8 = &mut arg0.lp_supply;
        let v9 = safe_increase_supply<LPCoin<T0, T1>>(v8, v2, arg4);
        let v10 = LPMint<T0, T1>{
            sender       : 0x2::tx_context::sender(arg4),
            lp_coin_id   : 0x2::object::id<0x2::coin::Coin<LPCoin<T0, T1>>>(&v9),
            token0_type  : 0x1::type_name::get<T0>(),
            token1_type  : 0x1::type_name::get<T1>(),
            amount0      : v0,
            amount1      : v1,
        ...
        0x2::event::emit<LPMint<T0, T1>>(v10);
        v9
    }
