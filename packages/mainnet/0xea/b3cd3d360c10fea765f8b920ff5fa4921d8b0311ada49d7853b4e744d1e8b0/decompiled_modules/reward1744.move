module 0xeab3cd3d360c10fea765f8b920ff5fa4921d8b0311ada49d7853b4e744d1e8b0::reward1744 {
    struct REWARD1744 has drop {
        dummy_field: bool,
    }

    struct TICKET_1744 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1744(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1744>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1744>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1744, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1744>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1744>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1744>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1744>>(v5, 0x2::tx_context::sender(arg1));
    }
