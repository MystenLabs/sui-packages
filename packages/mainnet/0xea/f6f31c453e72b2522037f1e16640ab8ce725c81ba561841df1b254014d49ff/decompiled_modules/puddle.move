module 0xeaf6f31c453e72b2522037f1e16640ab8ce725c81ba561841df1b254014d49ff::puddle {
    ...
    public entry fun arbitrage<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0xeaf6f31c453e72b2522037f1e16640ab8ce725c81ba561841df1b254014d49ff::admin::TeamFunds, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xeaf6f31c453e72b2522037f1e16640ab8ce725c81ba561841df1b254014d49ff::cetus_invest::arbitrage<T0, T1>(arg2, arg3, v1, arg4, arg5, arg6);
        ...
        if (v3 < 0x2::balance::value<T1>(&v2)) {
            ...
            0xeaf6f31c453e72b2522037f1e16640ab8ce725c81ba561841df1b254014d49ff::admin::deposit<T1>(0x2::balance::split<T1>(&mut v2, v4 * 5 / 1000), arg7, arg8);
    ...
    public entry fun invest<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::uid_to_inner(&arg1.id) == arg0.puddle_id, 3);
        let v0 = *0x2::object::borrow_id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg3);
        if (0x1::vector::contains<0x2::object::ID>(&arg1.investments.invests, &v0)) {
            ...
            0x2::balance::join<T0>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0), 0xeaf6f31c453e72b2522037f1e16640ab8ce725c81ba561841df1b254014d49ff::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
            ...
            0x2::bag::add<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0, 0xeaf6f31c453e72b2522037f1e16640ab8ce725c81ba561841df1b254014d49ff::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
            0x1::debug::print<0x2::balance::Balance<T0>>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0));
        };
    }
    ...
    public entry fun buy_shares<T0: drop>(arg0: &mut Puddles<T0>, arg1: &mut SaleItem<T0>, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0.owner;
        let v3 = 0x2::table::remove<address, u64>(&mut arg0.holder_info.holder_amount_table, v2) - v0.shares;
        if (v3 != 0) {
            0x2::table::add<address, u64>(&mut arg0.holder_info.holder_amount_table, v2, v3);
        };
        let v4 = 0;
        if (0x2::table::contains<address, u64>(&arg0.holder_info.holder_amount_table, v1)) {
            v4 = 0x2::table::remove<address, u64>(&mut arg0.holder_info.holder_amount_table, v1);
        };
        0x2::table::add<address, u64>(&mut arg0.holder_info.holder_amount_table, v1, v4 + v0.shares);
        ...
        let (_, v7) = 0x1::vector::index_of<0x2::object::ID>(&arg0.market_info.items, &v5);
        0x1::vector::swap_remove<0x2::object::ID>(&mut arg0.market_info.items, v7);
        v0.owner = v1;
    ...
    public entry fun modify_puddle_trader<T0: drop>(arg0: PuddleCap<T0>, arg1: &mut Puddles<T0>, arg2: address) {
        ...
        0x2::transfer::transfer<PuddleCap<T0>>(arg0, arg2);
    }
