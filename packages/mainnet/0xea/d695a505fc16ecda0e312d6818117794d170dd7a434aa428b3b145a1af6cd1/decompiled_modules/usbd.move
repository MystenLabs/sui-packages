module 0xead695a505fc16ecda0e312d6818117794d170dd7a434aa428b3b145a1af6cd1::usbd {
    ...
    fun init(arg0: USBD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (10000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USBD>>(0x2::coin::mint<USBD>(&mut v5, 10000000000000000, arg1), v6);
        };
