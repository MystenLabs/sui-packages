module 0xea16cdaad8cb79f56506d82f0fa4275facbb300d7092fe0dcf008749eec4781f::reward9300 {
    struct REWARD9300 has drop {
        dummy_field: bool,
    }

    struct TICKET_9300 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9300(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9300>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9300>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9300, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9300>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9300>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9300>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9300>>(v5, 0x2::tx_context::sender(arg1));
    }
