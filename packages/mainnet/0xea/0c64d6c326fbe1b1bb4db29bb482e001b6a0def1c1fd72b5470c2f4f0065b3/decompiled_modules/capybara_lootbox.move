module 0x99a1800ce832f92814fac7f0b5ed1e98317a33d5325b2498d6c62356b08a39f4::capybara_lootbox {
    ...
    public entry fun init_lootbox(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Money Bag"));
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://api.capybara.vip/api/nft/bag"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://api.capybara.vip/api/nft/bag"));
        let v4 = 0x2::display::new_with_fields<NFTLootbox>(arg0, v0, v2, arg1);
        0x2::display::update_version<NFTLootbox>(&mut v4);
        let v5 = DataStorage{
        ...
        0x2::transfer::share_object<DataStorage>(v5);
        0x2::transfer::public_transfer<0x2::display::Display<NFTLootbox>>(v4, 0x2::address::from_bytes(0x2::address::to_bytes(@0xf322f525e7370de05cf773b522c4611b483c94533b61f2da4cb9d4f81d3ff2d)));
    }

    entry fun migrate(arg0: &mut DataStorage, arg1: &0x99a1800ce832f92814fac7f0b5ed1e98317a33d5325b2498d6c62356b08a39f4::capybara_game_card::AdminCap) {
        arg0.version = 2;
    }
    ...
    public entry fun mint_lootbox(arg0: &mut DataStorage, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &mut 0x2::tx_context::TxContext) {
