module 0xea5351afa17f7e686012b1822d27e4f5cf0942c04b6abd97231612bbeeea6023::burp {
    ...
    fun init(arg0: BURP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<BURP>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<BURP>>(v4);
    }
