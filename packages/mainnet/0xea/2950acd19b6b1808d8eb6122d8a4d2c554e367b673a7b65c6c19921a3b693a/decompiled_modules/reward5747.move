module 0xea2950acd19b6b1808d8eb6122d8a4d2c554e367b673a7b65c6c19921a3b693a::reward5747 {
    struct REWARD5747 has drop {
        dummy_field: bool,
    }

    struct TICKET_5747 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5747(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5747>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5747>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5747, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5747>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5747>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5747>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5747>>(v5, 0x2::tx_context::sender(arg1));
    }
