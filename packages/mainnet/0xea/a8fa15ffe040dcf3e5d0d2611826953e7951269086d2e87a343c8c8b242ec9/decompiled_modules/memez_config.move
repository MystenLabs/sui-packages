module 0xeaa8fa15ffe040dcf3e5d0d2611826953e7951269086d2e87a343c8c8b242ec9::memez_config {
    ...
    public(friend) fun fees<T0>(arg0: &MemezConfig) : 0xeaa8fa15ffe040dcf3e5d0d2611826953e7951269086d2e87a343c8c8b242ec9::memez_fees::MemezFees {
        let v0 = 0x1::type_name::get<FeesKey<T0>>();
        assert!(0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 17);
        *0x2::dynamic_field::borrow<0x1::type_name::TypeName, 0xeaa8fa15ffe040dcf3e5d0d2611826953e7951269086d2e87a343c8c8b242ec9::memez_fees::MemezFees>(&arg0.id, v0)
    }
    ...
    public fun set_fees<T0>(arg0: &mut MemezConfig, arg1: &0xb877fe150db8e9af55c399b4e49ba8afe658bd05317cb378c940344851125e9a::access_control::AdminWitness<0x6101835e1df12852440c3ad3f079130e31702fe201eb1e3b77d141a0c6a58539::memez::MEMEZ>, arg2: vector<vector<u64>>, arg3: vector<vector<address>>, arg4: &mut 0x2::tx_context::TxContext) {
        add<FeesKey<T0>, 0xeaa8fa15ffe040dcf3e5d0d2611826953e7951269086d2e87a343c8c8b242ec9::memez_fees::MemezFees>(arg0, 0xeaa8fa15ffe040dcf3e5d0d2611826953e7951269086d2e87a343c8c8b242ec9::memez_fees::new(arg2, arg3));
    }
