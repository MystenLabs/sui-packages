module 0xead40bafc0216e37bf4d7e7856cca9cd60ac082aeb2bb5555eac676a89fb4973::game_room {
    ...
    public fun complete_game(arg0: &mut GameRoomStore, arg1: address, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v13 < v5) {
            ...
            if (0x2::table::contains<address, GameRoomParticipant>(&v0.participants, v22)) {
                let v23 = 0x2::table::borrow_mut<address, GameRoomParticipant>(&mut v0.participants, v22);
                v23.is_winner = true;
                v23.earnings = v21;
    ...
    public fun leave_room(arg0: &mut GameRoomStore, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC> {
        ...
        let v3 = 0;
        let v4 = false;
        while (v3 < 0x1::vector::length<address>(&v0.participant_vector) && !v4) {
        ...
        v0.current_players = v0.current_players - 1;
        v0.updated_at = 0x2::clock::timestamp_ms(arg2);
        let v5 = 0x2::table::borrow_mut<address, GameRoomParticipant>(&mut v0.participants, v1);
        assert!(v5.is_active, 9);
        v5.is_active = false;
        ...
        0x2::coin::take<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg0.usdc_treasury, v6, arg3)
    }
