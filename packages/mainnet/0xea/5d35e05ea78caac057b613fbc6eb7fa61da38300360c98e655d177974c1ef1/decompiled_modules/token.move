module 0xea5d35e05ea78caac057b613fbc6eb7fa61da38300360c98e655d177974c1ef1::token {
    ...
    struct DoompaperNftPoints has store, key {
        id: 0x2::object::UID,
        number: u64,
    ...
    public(friend) fun id(arg0: &DoompaperNftPoints) : 0x2::object::ID {
        0x2::object::id<DoompaperNftPoints>(arg0)
    }

    public(friend) fun attributes(arg0: &DoompaperNftPoints) : &0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String> {
        &arg0.attributes
    }

    fun burn(arg0: DoompaperNftPoints, arg1: &mut Supply, arg2: &Data) : 0x2::object::UID {
        let DoompaperNftPoints {
            id         : v0,
            number     : v1,
            image      : _,
            attributes : v3,
    ...
    public fun buy_on_curve(arg0: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<DoompaperNftPoints>, arg1: &Data, arg2: &mut Supply, arg3: &mut 0x2::tx_context::TxContext) : (vector<DoompaperNftPoints>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveBuyOrder<DoompaperNftPoints>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg1.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_curve<DoompaperNftPoints>(&arg0);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg1.curve), 0);
        (mint(arg1, arg2, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::buy_order_size<DoompaperNftPoints>(&arg0), arg3), arg0)
    }
    ...
    public(friend) fun image(arg0: &DoompaperNftPoints) : &0x1::string::String {
        &arg0.image
    }

    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TOKEN>(arg0, arg1);
        let v1 = 0x2::display::new<DoompaperNftPoints>(&v0, arg1);
        0x2::display::add<DoompaperNftPoints>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"DOOMPAPER NFT POINTS #{number}"));
        0x2::display::add<DoompaperNftPoints>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"The project https://doompaper.xyz   **DOOMPAPER**  is dedicated to exposing scam and RUG-type projects.  The more **NFT stamps** you hold, the **bigger your airdrop** and monthly rewards will be!  After an initial wave of short-term investors, **were still standing strong!**"));
        0x2::display::add<DoompaperNftPoints>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://{image}"));
        0x2::display::add<DoompaperNftPoints>(&mut v1, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<DoompaperNftPoints>(&mut v1);
        let v2 = Supply{
        ...
        let v5 = Created{id: 0x1::string::utf8(b"a2ef818c-00a0-40cf-aa59-5a4d3f157282")};
        0x2::event::emit<Created>(v5);
        0x2::transfer::public_share_object<Supply>(v2);
        0x2::transfer::public_share_object<Data>(v3);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<DoompaperNftPoints>>(v1, 0x2::tx_context::sender(arg1));
        0x2::transfer::transfer<ManagerCap>(v4, 0x2::tx_context::sender(arg1));
    }

    fun mint(arg0: &Data, arg1: &mut Supply, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<DoompaperNftPoints> {
        assert!(arg2 > 0 && arg2 <= 1000, 0);
        assert!(arg2 <= 0x1::vector::length<vector<u64>>(&arg1.bitmaps), 9223372745524379647);
        let v0 = 0;
        let v1 = 0x1::vector::empty<DoompaperNftPoints>();
        while (v0 < arg2) {
            ...
            let v7 = DoompaperNftPoints{
                id         : 0x2::object::new(arg3),
                number     : 0x1::vector::pop_back<u64>(&mut v2),
                image      : *0x2::table::borrow<u64, 0x1::string::String>(&arg0.images, v3),
                attributes : v6,
            };
            0x1::vector::push_back<DoompaperNftPoints>(&mut v1, v7);
            v0 = v0 + 1;
        };
        v1
    }

    public(friend) fun number(arg0: &DoompaperNftPoints) : u64 {
        arg0.number
    }
    ...
    public fun sell_on_curve(arg0: vector<DoompaperNftPoints>, arg1: 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<DoompaperNftPoints>, arg2: &mut Supply, arg3: &Data) : (vector<0x2::object::UID>, 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::CurveSellOrder<DoompaperNftPoints>) {
        assert!(0x1::option::is_some<0x2::object::ID>(&arg3.curve), 0);
        let v0 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_order_curve<DoompaperNftPoints>(&arg1);
        assert!(&v0 == 0x1::option::borrow<0x2::object::ID>(&arg3.curve), 0);
        let v1 = 0x50a3ac2280430c3b668535d82b56c7fe860cac42132b687ca1e1cd11dfe8c918::curve::sell_asset_ids<DoompaperNftPoints>(&arg1);
        assert!(0x1::vector::length<0x2::object::ID>(&v1) == 0x1::vector::length<DoompaperNftPoints>(&arg0), 0);
        let v2 = 0;
        let v3 = 0x1::vector::empty<0x2::object::UID>();
        while (v2 < 0x1::vector::length<0x2::object::ID>(&v1)) {
            let v4 = 0x1::vector::pop_back<DoompaperNftPoints>(&mut arg0);
            assert!(id(&v4) == 0x1::vector::pop_back<0x2::object::ID>(&mut v1), 0);
            0x1::vector::push_back<0x2::object::UID>(&mut v3, burn(v4, arg2, arg3));
            v2 = v2 + 1;
        };
        0x1::vector::destroy_empty<DoompaperNftPoints>(arg0);
    ...
    public fun set_traits(arg0: &ManagerCap, arg1: vector<0x1::string::String>, arg2: vector<vector<0x1::string::String>>, arg3: &mut Data) {
        ...
        while (v0 <= 0x1::vector::length<vector<0x1::string::String>>(&arg3.values)) {
            ...
            assert!(v1 >= 5 && v1 <= 16, 9223372590905556991);
            v0 = v0 + 1;
        };
        arg3.values = arg2;
        arg3.labels = arg1;
