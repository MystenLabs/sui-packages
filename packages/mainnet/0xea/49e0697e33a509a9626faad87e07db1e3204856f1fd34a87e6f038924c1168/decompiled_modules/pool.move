module 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool {
    ...
    public fun get_price<T0, T1>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg1: &0x2::clock::Clock) : (u128, bool) {
    ...
    fun calc_dynamic_fee<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u128, arg3: bool) : (u64, u128, u64, u64) {
        ...
        let v5 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(v2, (v3.max_reserve_pct as u128), 10000);
        ...
        let v9 = if (v4 == 0) {
            ...
            (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(((v3.fee_base * 1000) as u128), v8, v4) as u64)
        } else if (v5 == 0) {
            v3.fee_base * 1000
        } else {
            v3.fee_base * 1000 + (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128(((v3.fee_max * 1000) as u128), v8, v5) as u64)
        };
    ...
    fun calculate_fees<T0>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u64) : (u64, u64) {
        ...
        let v1 = arg1 - (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg1 as u128), v0 - ((arg2 + ((arg0.swap_fee_pct * 1000) as u64)) as u128), v0) as u64);
        let v2 = (0x1::u128::max(0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v1 as u128), (arg0.lp_fee_pct as u128), 10000), 1) as u64);
    ...
    public fun claim_owned_coins<T0, T1: store + key>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: 0x2::transfer::Receiving<T1>, arg3: &mut 0x2::tx_context::TxContext) : T1 {
    ...
    public fun simulate_buy_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        let v2 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), v0, 1000000000000000000);
        assert!(v2 != 0, 4016);
        ...
        SwapSimulationResult{
            base_out        : (v7 as u64),
            quote_out       : (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v7 as u128), 1000000000000000000, v0) as u64),
    ...
    public fun simulate_sell_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, v3, v4, _) = calc_dynamic_fee<T0, T1>(arg0, (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0) as u64), v0, true);
        let (v6, v7, v8) = calculate_swap_fees<T0>(arg0, arg3, v2);
        let v9 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v6 as u128), 1000000000000000000, v0);
    ...
    public fun simulate_sell_swap_reverse<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        validate_pool_version<T0>(arg0);
        assert!(arg3 > 0, 4020);
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T1, T0>(arg1, arg2);
        let (v2, _, _, _) = calc_dynamic_fee<T0, T1>(arg0, arg3, v0, true);
        let v6 = (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), v0, 1000000000000000000) as u64);
        let (v7, v8) = calculate_fees<T0>(arg0, v6, v2);
        let v9 = ((10000 * 1000) as u128);
        let v10 = get_quote_balance<T0, T1>(arg0);
        assert!(arg3 <= v10, 4021);
        let v11 = (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v10 as u128), v0, 1000000000000000000) as u64);
        let v12 = 0x1::u64::max(0x1::u64::min((0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v6 as u128), v9, v9 - ((v2 + ((arg0.swap_fee_pct * 1000) as u64)) as u128)) as u64), v11), v7 + v8 + arg0.min_base_out);
    ...
    public fun update_module_version(arg0: &mut GlobalConfig) {
        assert!(arg0.version < 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version(), 4011);
    ...
    public fun version() : u64 {
        0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version()
    }
