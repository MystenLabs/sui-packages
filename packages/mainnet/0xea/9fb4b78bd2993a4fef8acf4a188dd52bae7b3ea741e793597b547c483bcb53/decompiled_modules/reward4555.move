module 0xea9fb4b78bd2993a4fef8acf4a188dd52bae7b3ea741e793597b547c483bcb53::reward4555 {
    struct REWARD4555 has drop {
        dummy_field: bool,
    }

    struct TICKET_4555 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4555(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4555>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4555>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4555, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4555>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4555>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4555>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4555>>(v5, 0x2::tx_context::sender(arg1));
    }
