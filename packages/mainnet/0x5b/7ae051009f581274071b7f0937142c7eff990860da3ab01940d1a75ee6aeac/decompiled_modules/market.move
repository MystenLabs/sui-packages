module 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::market {
    struct AdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct Store has store {
        obj: 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20,
        price: u64,
        owner: address,
    }
    ...
    public fun buy_v2(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let (_, v12) = 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::get_sui20_data(&v10);
        ...
        0x2::transfer::public_transfer<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(v10, v0);
    ...
    public fun delist_v2(arg0: &mut Global, arg1: 0x1::string::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(v2, v0);
        ...
        if (0x2::table::contains<address, UserInfo>(&v1.user_infos, v0)) {
            ...
            while (v10 < 0x1::vector::length<0x2::object::ID>(&v9)) {
                ...
                if (0x2::bag::contains<0x2::object::ID>(&v1.stores, v11)) {
                    ...
                    let (_, v14) = 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::get_sui20_data(&v12.obj);
                    let v15 = ListedItem{
                        id     : v11,
                        amount : v14,
                        price  : v12.price,
    ...
    public fun get_market_data_v2(arg0: &Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<address>(&v1.upgrade_bag, v0)) {
            ...
            while (v11 < 0x1::vector::length<u64>(&v10)) {
                ...
                if (0x2::bag::contains<u64>(&v1.stores, v12)) {
                    ...
                    let (_, v15) = 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::get_sui20_data(&v13.obj);
                    let v16 = ListedItemV2{
                        store_index   : v12,
                        id            : 0x2::object::id<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(&v13.obj),
                        amount        : v15,
                        price         : v13.price,
        ...
        if (v2.size > v19) {
            while (0x2::bag::contains<u64>(&v1.stores, v18)) {
                ...
                let (_, v23) = 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::get_sui20_data(&v21.obj);
                let v24 = ListedItemV2{
                    store_index   : v18,
                    id            : 0x2::object::id<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(&v21.obj),
                    amount        : v23,
                    price         : v21.price,
    ...
    public fun list(arg0: &mut Global, arg1: 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(arg1, 0x2::tx_context::sender(arg3));
    }

    public fun list_v2(arg0: &mut Global, arg1: &mut 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Global, arg2: 0x1::string::String, arg3: vector<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(&arg3)) {
            0x2::transfer::public_transfer<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(0x1::vector::pop_back<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(&mut arg3), 0x2::tx_context::sender(arg5));
        };
        0x1::vector::destroy_empty<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(arg3);
    }

    public fun list_v3(arg0: &mut Global, arg1: &mut 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Global, arg2: 0x1::string::String, arg3: vector<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(&arg3)) {
            0x2::transfer::public_transfer<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(0x1::vector::pop_back<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(&mut arg3), 0x2::tx_context::sender(arg6));
        };
        0x1::vector::destroy_empty<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(arg3);
    }

    public fun list_v4(arg0: &mut Global, arg1: &mut 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Global, arg2: 0x1::string::String, arg3: vector<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        only_allowed_version(arg0);
        only_not_paused(arg0);
        assert!(arg6 >= 100000, 1006);
        assert!(arg4 > 0, 1005);
        let v0 = 0x2::tx_context::sender(arg7);
        let (v1, v2, v3, v4) = 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::merge_v2(arg1, arg2, arg3, arg6, arg7);
        assert!(arg6 > 0, 1006);
        assert!(v3 >= arg6, 1010);
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::Sui20>(v2, v0);
        } else {
            0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20::destroy_zero(v2);
        };
