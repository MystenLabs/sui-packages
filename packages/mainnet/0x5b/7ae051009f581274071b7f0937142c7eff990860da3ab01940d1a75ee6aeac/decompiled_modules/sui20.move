module 0x3262ef2312d381aeaecb10048d3ac7e3cc3e928f559d9bbf1296a08b16aac55a::sui20 {
    ...
    public fun wrap<T0>(arg0: &mut Global, arg1: 0x1::string::String, arg2: Sui20, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1 == arg1, 1021);
        0x2::object::delete(v0);
        let v3 = 0x2::bag::borrow_mut<0x1::string::String, Sui20WrapCoin<T0>>(&mut arg0.upgrade_bag, v1);
        0x2::coin::mint_and_transfer<T0>(&mut v3.treasury_cap, v2 * v3.coin_unit, arg3, arg4);
    }
