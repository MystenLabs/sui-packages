module 0x5b081552c220d90f64578e3f6d01dd858ba10cfb97071e874d99787cd8940487::cnsnft4267 {
    struct CNSNFT4267 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4267, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4267>(arg0, arg1);
