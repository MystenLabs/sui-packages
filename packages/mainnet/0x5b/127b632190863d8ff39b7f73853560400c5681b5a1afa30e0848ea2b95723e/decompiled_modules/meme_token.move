module 0x5b127b632190863d8ff39b7f73853560400c5681b5a1afa30e0848ea2b95723e::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"ADY", b"aden", b"ADY was launched by the X account.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/media/G2wH1_8bUAAeggv.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"aden"),
            symbol     : 0x1::string::utf8(b"ADY"),
            decimals   : 9,
