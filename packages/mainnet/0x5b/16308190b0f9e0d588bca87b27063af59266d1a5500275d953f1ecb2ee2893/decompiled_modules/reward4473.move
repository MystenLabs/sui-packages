module 0x5b16308190b0f9e0d588bca87b27063af59266d1a5500275d953f1ecb2ee2893::reward4473 {
    struct REWARD4473 has drop {
        dummy_field: bool,
    }

    struct TICKET_4473 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4473(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4473>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4473>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4473, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4473>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4473>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4473>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4473>>(v5, 0x2::tx_context::sender(arg1));
    }
