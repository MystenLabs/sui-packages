module 0x5b6272d768b84a2a6d6cf5501d4863ebaef03ce2629d01a5354895a5dba03282::reward5822 {
    struct REWARD5822 has drop {
        dummy_field: bool,
    }

    struct TICKET_5822 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5822(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5822>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5822>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5822, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5822>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5822>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5822>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5822>>(v5, 0x2::tx_context::sender(arg1));
    }
