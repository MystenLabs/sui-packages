module 0x5b49842ead7a1c014dbb824d30e25ffd3ae5098b24d3063ea27abda90548f1b6::leondev1024_avator_nft {
    struct LEONDEV1024_AVATOR_NFT has drop {
        dummy_field: bool,
    }

    struct NTF has store, key {
        id: 0x2::object::UID,
        nft_id: u64,
    ...
    public entry fun burn(arg0: &mut MintRecord, arg1: NTF) {
    ...
    fun init(arg0: LEONDEV1024_AVATOR_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::package::claim<LEONDEV1024_AVATOR_NFT>(arg0, arg1);
        let v6 = 0x2::display::new_with_fields<NTF>(&v5, v0, v2, arg1);
        0x2::transfer::share_object<MintRecord>(v4);
        0x2::display::update_version<NTF>(&mut v6);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<NTF>>(v6, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun mint(arg0: &mut MintRecord, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = NFTMinted{
            object_id : 0x2::object::id<NTF>(&v1),
            creator   : 0x2::tx_context::sender(arg4),
            name      : v1.name,
        };
        0x2::event::emit<NFTMinted>(v2);
        0x2::transfer::public_transfer<NTF>(v1, arg3);
    }
