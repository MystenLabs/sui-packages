module 0x5b982f3aeeba7ff096f8ded15952c8984c23acfaed9c1a498359c7b9cd952a31::pool {
    ...
    public(friend) fun assert_pool_version<T0, T1>(arg0: &PoolState<T0, T1>) {
        assert!(arg0.version == 0x5b982f3aeeba7ff096f8ded15952c8984c23acfaed9c1a498359c7b9cd952a31::version::get_program_version(), 8);
    }
    ...
    public(friend) fun claim_assets<T0, T1>(arg0: &mut PoolState<T0, T1>, arg1: 0x2::coin::Coin<BasePoolLiquidityCoin<T0, T1>>, arg2: 0x2::coin::Coin<QuotePoolLiquidityCoin<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v4 = if (v0 > 0 && v2 > 0) {
            0x5b982f3aeeba7ff096f8ded15952c8984c23acfaed9c1a498359c7b9cd952a31::safe_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg0.base_coin), v0, v2)
        } else {
            0
        };
        let v5 = if (v1 > 0 && v3 > 0) {
            0x5b982f3aeeba7ff096f8ded15952c8984c23acfaed9c1a498359c7b9cd952a31::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg0.quote_coin), v1, v3)
        } else {
            0
        };
