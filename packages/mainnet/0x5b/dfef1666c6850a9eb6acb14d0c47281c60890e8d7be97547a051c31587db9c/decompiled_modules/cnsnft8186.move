module 0x5bdfef1666c6850a9eb6acb14d0c47281c60890e8d7be97547a051c31587db9c::cnsnft8186 {
    struct CNSNFT8186 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8186, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8186>(arg0, arg1);
