module 0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dapp_service {
    ...
    public(friend) fun accept_invitation_in_scene_permit<T0>(arg0: &mut ScenePermit<T0>, arg1: address) {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::not_participant(v0);
    ...
    public(friend) fun add_participant_in_scene_permit<T0>(arg0: &mut ScenePermit<T0>, arg1: address) {
        ...
        if (0x1::option::is_some<u64>(&arg0.meta.max_participants)) {
            0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::scene_full(arg0.meta.participant_count < *0x1::option::borrow<u64>(&arg0.meta.max_participants));
        };
    ...
    public(friend) fun delete_global_field<T0: copy + drop>(arg0: &mut DappStorage, arg1: vector<vector<u8>>, arg2: vector<u8>) {
        ...
        if (0x2::dynamic_field::exists_<vector<vector<u8>>>(&arg0.id, arg1)) {
            ...
            0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_delete_field(v0, v0, arg1, arg2);
        } else {
            0x1::vector::pop_back<vector<u8>>(&mut arg1);
        };
    }
    ...
    public(friend) fun delete_global_record<T0: copy + drop>(arg0: &mut DappStorage, arg1: vector<vector<u8>>, arg2: vector<vector<u8>>) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::invalid_key(0x2::dynamic_field::exists_<vector<vector<u8>>>(&arg0.id, arg1));
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_delete_record(v0, v0, arg1);
        let v1 = 0;
    ...
    public(friend) fun delete_user_field<T0: copy + drop>(arg0: &mut UserStorage, arg1: vector<vector<u8>>, arg2: vector<u8>) {
        ...
        if (0x2::dynamic_field::exists_<vector<vector<u8>>>(&arg0.id, arg1)) {
            0x2::dynamic_field::remove<vector<vector<u8>>, vector<u8>>(&mut arg0.id, arg1);
            0x1::vector::pop_back<vector<u8>>(&mut arg1);
            0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_delete_field(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), 0x2::address::to_ascii_string(arg0.canonical_owner), arg1, arg2);
        } else {
            0x1::vector::pop_back<vector<u8>>(&mut arg1);
        };
    }
    ...
    public(friend) fun delete_user_record<T0: copy + drop>(arg0: &mut UserStorage, arg1: vector<vector<u8>>, arg2: vector<vector<u8>>) {
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::invalid_key(0x2::dynamic_field::exists_<vector<vector<u8>>>(&arg0.id, arg1));
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_delete_record(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), 0x2::address::to_ascii_string(arg0.canonical_owner), arg1);
        let v0 = 0;
    ...
    public(friend) fun emit_fee_state_record<T0: copy + drop>(arg0: &DappStorage) {
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_dapp_fee_state_updated(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), arg0.base_fee_per_write, arg0.bytes_fee_per_byte, arg0.free_credit, arg0.credit_pool, arg0.total_settled);
    }

    public(friend) fun emit_revenue_state_record<T0: copy + drop, T1>(arg0: &DappStorage) {
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_dapp_revenue_state_updated(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), dapp_revenue_balance<T1>(arg0), 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>()));
    }

    public fun ensure_has_global_record<T0: copy + drop>(arg0: &DappStorage, arg1: vector<vector<u8>>) {
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::invalid_key(has_global_record<T0>(arg0, arg1));
    }
    ...
    public fun ensure_has_not_user_record<T0: copy + drop>(arg0: &UserStorage, arg1: vector<vector<u8>>) {
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::invalid_key(!has_user_record<T0>(arg0, arg1));
    }
    ...
    public(friend) fun new_object_storage<T0>(arg0: 0x1::ascii::String, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) : ObjectStorage<T0> {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_object_created(v0.dapp_key, v0.object_type, 0x2::object::uid_to_address(&v0.id), v0.entity_id);
        v0
    }
    ...
    public(friend) fun new_scene_permit_with_invitations<T0>(arg0: 0x1::ascii::String, arg1: vector<u8>, arg2: vector<address>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: &mut 0x2::tx_context::TxContext) : ScenePermit<T0> {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_scene_permit_created(v0.dapp_key, v0.permit_type, 0x2::object::uid_to_address(&v0.id), v0.meta.expires_at, v0.meta.invites_expire_at, v0.meta.max_participants, v0.meta.participant_count);
        v0
    }
    ...
    public(friend) fun new_scene_permit_with_participants<T0>(arg0: 0x1::ascii::String, arg1: vector<u8>, arg2: vector<address>, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: &mut 0x2::tx_context::TxContext) : ScenePermit<T0> {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_scene_permit_created(v0.dapp_key, v0.permit_type, v4, v0.meta.expires_at, v0.meta.invites_expire_at, v0.meta.max_participants, v0.meta.participant_count);
        let v5 = 0;
        while (v5 < v2) {
            0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_scene_permit_join(v0.dapp_key, v0.permit_type, v4, *0x1::vector::borrow<address>(&arg2, v5));
            v5 = v5 + 1;
        };
        v0
    }
    ...
    public(friend) fun new_scene_storage_system<T0>(arg0: 0x1::ascii::String, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) : SceneStorage<T0> {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_scene_created(v0.dapp_key, v0.scene_type, 0x2::object::uid_to_address(&v0.id), b"system", v0.authorized_permit_id);
        v0
    }
    ...
    public(friend) fun new_scene_storage_with_permit<T0, T1>(arg0: 0x1::ascii::String, arg1: vector<u8>, arg2: &ScenePermit<T0>, arg3: &mut 0x2::tx_context::TxContext) : SceneStorage<T1> {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_scene_created(v0.dapp_key, v0.scene_type, 0x2::object::uid_to_address(&v0.id), b"permit", v0.authorized_permit_id);
        v0
    }
    ...
    public(friend) fun register_object_entity_id(arg0: &mut DappStorage, arg1: vector<u8>, arg2: vector<u8>, arg3: address) {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::entity_id_already_exists(!0x2::dynamic_field::exists_<ObjectEntityIdKey>(&arg0.id, v0));
    ...
    public(friend) fun set_global_field<T0: copy + drop>(arg0: &mut DappStorage, arg1: vector<vector<u8>>, arg2: vector<u8>, arg3: vector<u8>) {
        ...
        0x1::vector::pop_back<vector<u8>>(&mut arg1);
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_set_field(v0, v0, arg1, arg2, arg3);
    }
    ...
    public(friend) fun set_global_record<T0: copy + drop>(arg0: &mut DappStorage, arg1: vector<vector<u8>>, arg2: vector<vector<u8>>, arg3: vector<vector<u8>>, arg4: bool) {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::length_mismatch(v0 == 0x1::vector::length<vector<u8>>(&arg3));
        let v1 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>());
        if (arg4) {
            0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_set_record(v1, v1, arg1, arg3);
            return
        };
        if (!0x2::dynamic_field::exists_<vector<vector<u8>>>(&arg0.id, arg1)) {
    ...
    public(friend) fun set_user_field<T0: copy + drop>(arg0: &mut UserStorage, arg1: vector<vector<u8>>, arg2: vector<u8>, arg3: vector<u8>) {
        ...
        0x1::vector::pop_back<vector<u8>>(&mut arg1);
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_set_field(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), 0x2::address::to_ascii_string(arg0.canonical_owner), arg1, arg2, arg3);
    }
    ...
    public(friend) fun set_user_record<T0: copy + drop>(arg0: &mut UserStorage, arg1: vector<vector<u8>>, arg2: vector<vector<u8>>, arg3: vector<vector<u8>>, arg4: bool) {
        ...
        0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::error::length_mismatch(v0 == 0x1::vector::length<vector<u8>>(&arg3));
        if (arg4) {
            0x5bc40de124588b1e3514ca50f5e7109869351c4d9544e5f0cb9d30dd47bf8de7::dubhe_events::emit_store_set_record(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()), 0x2::address::to_ascii_string(arg0.canonical_owner), arg1, arg3);
            return
        };
        if (!0x2::dynamic_field::exists_<vector<vector<u8>>>(&arg0.id, arg1)) {
            0x2::dynamic_field::add<vector<vector<u8>>, bool>(&mut arg0.id, arg1, true);
