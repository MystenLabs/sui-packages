module 0xa8e405958c7f49c381f67ce47ab2dd554e913400ba08a784efb1c838c9d3288b::swap_executor {
    ...
    entry fun add_access_cap(arg0: &AdminCap, arg1: &mut SwapExecutorConfig, arg2: 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::AccessCap) {
    ...
    fun calculate_min_output_with_oracle<T0, T1>(arg0: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) : (u64, u64, u64) {
        ...
        let (v6, v7) = if (v4 >= v1) {
            (v2 * 0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::pow10(((v4 - v1) as u8)), v5)
        } else {
            (v2, v5 * 0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::pow10(((v1 - v4) as u8)))
        };
        let v8 = 0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::safe_mul_div_u64(arg3, v6, v7);
    ...
    fun get_amount_usd<T0>(arg0: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        ...
        let v3 = if (8 >= v1) {
            0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::pow10(((8 - v1) as u8))
        } else {
            0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::pow10(((v1 - 8) as u8))
        };
        if (8 >= v1) {
            0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::safe_mul_div_u64(arg2, v3, v2)
        } else {
            0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::safe_mul_div_u64(arg2, 1, v2 * v3)
        }
    }
    ...
    fun get_price_oracle<T0>(arg0: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (vector<u8>, u64, u64) {
        ...
        let (v2, v3) = 0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::get_price_guarded(arg1, v1, 0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::get_max_age(arg0), 0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::get_max_conf(arg0), arg2);
    ...
    public fun secure_deposit<T0, T1, T2, T3>(arg0: &SwapExecutorConfig, arg1: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::VaultConfig, arg2: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>, arg3: 0x2::coin::Coin<T3>, arg4: SecureSwapReceipt<T2, T3>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::add_harvest_assets<T0, T1, T3>(arg1, arg2, arg3, 0x1::option::borrow<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::AccessCap>(&arg0.access_cap));
    }

    public fun secure_deposit_with_collateral<T0, T1, T2>(arg0: &SwapExecutorConfig, arg1: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::VaultConfig, arg2: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: SecureSwapReceipt<T2, T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 2);
        assert!(arg0.enable, 3);
        assert!(check_operator(arg0, 0x2::tx_context::sender(arg6)), 5);
        validate_receipt<T0, T1, T2, T0>(arg2, arg4, 0x2::coin::value<T0>(&arg3), arg5);
        0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::add_fund<T0, T1>(arg2, arg3, arg6);
    }

    public fun secure_withdraw<T0, T1, T2, T3>(arg0: &mut SwapExecutorConfig, arg1: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::VaultConfig, arg2: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>, arg3: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: u64, arg7: u64, arg8: u64, arg9: vector<vector<u8>>, arg10: vector<vector<u8>>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, SecureSwapReceipt<T2, T3>) {
        assert!(arg0.version == 1, 2);
        assert!(arg0.enable, 3);
        ...
        let v5 = 0x2::object::id<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::VaultConfig>(arg1);
        let v6 = 0x2::object::id<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>>(arg2);
        ...
        0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::verify_signature(arg1, v3, arg9, arg10);
        let (v10, v11, v12) = calculate_min_output_with_oracle<T2, T3>(arg3, arg4, arg5, arg6, arg7, arg11);
        let v13 = SecureSwapReceipt<T2, T3>{
            vault_id            : 0x2::object::id<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>>(arg2),
        ...
        (0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::spend_harvest_asset<T0, T1, T2>(arg1, arg2, arg6, 0x1::option::borrow<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::AccessCap>(&arg0.access_cap), arg12), v13)
    }

    public fun secure_withdraw_with_collateral<T0, T1, T2>(arg0: &mut SwapExecutorConfig, arg1: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::VaultConfig, arg2: &mut 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>, arg3: &0x49e2fa4035f91c4c404f4738b9cfbd6213569fe6aaf4608da10e781b0a128c23::price_feed::PriceFeedConfig, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: u64, arg7: u64, arg8: u64, arg9: vector<vector<u8>>, arg10: vector<vector<u8>>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, SecureSwapReceipt<T0, T2>) {
        assert!(arg0.version == 1, 2);
        assert!(arg0.enable, 3);
        assert!(check_operator(arg0, 0x2::tx_context::sender(arg12)), 5);
        assert!(arg7 >= 0 && arg7 <= 10000, 6);
        ...
        let v4 = 0x2::object::id<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::VaultConfig>(arg1);
        let v5 = 0x2::object::id<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>>(arg2);
        ...
        0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::verify_signature(arg1, v2, arg9, arg10);
        ...
        (0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::spend_vault_funds<T0, T1>(arg1, arg2, arg6, 0x1::option::borrow<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::AccessCap>(&arg0.access_cap), arg12), v12)
    }
    ...
    fun validate_receipt<T0, T1, T2, T3>(arg0: &0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>, arg1: SecureSwapReceipt<T2, T3>, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        assert!(0x2::object::id<0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault::Vault<T0, T1>>(arg0) == v0, 12);
        assert!(v5 > 0 && v6 > 0, 10);
        assert!(v3 <= 10000, 6);
        let v7 = 0x2::clock::timestamp_ms(arg3);
        assert!(v7 <= v4, 13);
        assert!(arg2 >= v2, 14);
        let v8 = 0xa152a29be45afa721fd2d665bcf176574277b082faf19afe08d6f92b6b48f2e::fast_price_feed::safe_mul_div_u64(v1, v5, v6);
        let v9 = if (v8 > arg2) {
            (v8 - arg2) * 10000 / v8
        } else {
            0
