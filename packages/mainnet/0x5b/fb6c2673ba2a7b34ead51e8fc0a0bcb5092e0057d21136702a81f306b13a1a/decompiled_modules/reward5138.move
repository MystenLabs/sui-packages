module 0x5bfb6c2673ba2a7b34ead51e8fc0a0bcb5092e0057d21136702a81f306b13a1a::reward5138 {
    struct REWARD5138 has drop {
        dummy_field: bool,
    }

    struct TICKET_5138 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5138(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5138>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5138>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5138, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5138>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5138>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5138>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5138>>(v5, 0x2::tx_context::sender(arg1));
    }
