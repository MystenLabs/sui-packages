module 0x5bd8f5f248b7a97b78fcc21aa5338a07130aeb05fc58af7b739e86f3d09bec18::vault {
    ...
    public fun collect_fees<T0>(arg0: &ProtocolFeeVault, arg1: &mut 0x64213b0e4a52bac468d4ac3f140242f70714381653a1919a6d57cd49c628207a::treasury::Treasury, arg2: &mut 0xa6baab1e668c7868991c1c3c11e144100f5734c407d020f72a01b9d1a8bcb97f::insurance_fund::InsuranceFund, arg3: &0xc66fabf1a9253e43c70f1cc02d40a1d18db183140ecaae2a3f58fa6b66c55acf::referral_vault::ReferralVault, arg4: &mut 0x2::coin::Coin<T0>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0);
        let v0 = 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::mul_by_fraction(0x2::coin::value<T0>(arg4), arg0.fee_percentages.total_protocol_fee);
        let v1 = if (0xc66fabf1a9253e43c70f1cc02d40a1d18db183140ecaae2a3f58fa6b66c55acf::referral_vault::has_referrer(arg3, arg5)) {
            let v2 = 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::mul_by_fraction(v0, arg0.fee_percentages.treasury);
            v2 - 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::mul_by_fraction(v2, arg0.fee_percentages.referee_discount)
        } else {
            0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::mul_by_fraction(v0, arg0.fee_percentages.treasury)
        };
        if (v1 > 0) {
        ...
        let v3 = 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::mul_by_fraction(v0, arg0.fee_percentages.insurance_fund);
        if (v3 > 0) {
        ...
        let v4 = 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::mul_by_fraction(v0, arg0.fee_percentages.dev_wallet);
        if (v4 > 0) {
    ...
    public fun minimum_before_fees(arg0: &ProtocolFeeVault, arg1: u64) : u64 {
        assert_version(arg0);
        0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::div_up_by_fraction(arg1, 0xaca10f85b508736ebce633d33581b0c511cc1b098283dbd2a4c359cab8e66a84::fixed::complement64(arg0.fee_percentages.total_protocol_fee))
    }
