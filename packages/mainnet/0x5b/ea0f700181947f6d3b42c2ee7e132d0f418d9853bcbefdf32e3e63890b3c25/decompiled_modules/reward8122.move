module 0x5bea0f700181947f6d3b42c2ee7e132d0f418d9853bcbefdf32e3e63890b3c25::reward8122 {
    struct REWARD8122 has drop {
        dummy_field: bool,
    }

    struct TICKET_8122 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8122(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8122>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8122>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8122, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8122>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8122>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8122>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8122>>(v5, 0x2::tx_context::sender(arg1));
    }
