module 0x5bdfeb07bb53dfa888f8c2afe7d19fbc8fe2bb308d6b02a1b1418eca5796cdf1::gift5648 {
    struct GIFT5648 has drop {
        dummy_field: bool,
    }

    struct TICKET_5648 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5648(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5648>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5648>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5648, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5648>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5648>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5648>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5648>>(v5, 0x2::tx_context::sender(arg1));
    }
