module 0x5b0ca3f2f087e0e5392abac408489c6d69af0aeb9e67a32fc59ac0ff6ef4d583::cnsnft1048 {
    struct CNSNFT1048 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1048, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2352"));
        let v4 = 0x2::package::claim<CNSNFT1048>(arg0, arg1);
