module 0x34f6453d58530cefc26f917586c45f0c84dc1f4288811357bf7d6ff2355e0dde::para {
    ...
    public fun create_swap_receipt<T0, T1, T2: store>(arg0: T2, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: u64, arg4: bool) : SwapReceipt<T0, T1, T2> {
        SwapReceipt<T0, T1, T2>{
            flash_loan_receipt : arg0,
            balance_a          : arg1,
            balance_b          : arg2,
            repay_amount       : arg3,
            a2b                : arg4,
    ...
    public fun destroy_swap_receipt<T0, T1, T2: drop + store>(arg0: SwapReceipt<T0, T1, T2>) {
        let SwapReceipt {
    ...
    public fun extract_flash_receipt<T0, T1, T2: store>(arg0: &mut SwapReceipt<T0, T1, T2>) : T2 {
        abort 401
    }

    public fun get_repay_amount<T0, T1, T2: store>(arg0: &SwapReceipt<T0, T1, T2>) : u64 {
        arg0.repay_amount
    }
    ...
    public fun get_swap_direction<T0, T1, T2: store>(arg0: &SwapReceipt<T0, T1, T2>) : bool {
        arg0.a2b
    }
