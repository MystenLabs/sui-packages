module 0x5b46494e7808559bc64dabc7de93a6bea11fd9dfff687288e7f8922128e765be::peng_genesis {
    struct PENG_GENESIS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PENG_GENESIS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PENG_GENESIS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Peng Genesis"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"GameFi project built on the Web3. With a unique mechanism, 98% of revenue in ETH will be used to buy back and add liquidity"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigvvvpob53ijyaj4hu6eku5y2t7lasi3izei2iqx6g2epsmgwmjgi"));
