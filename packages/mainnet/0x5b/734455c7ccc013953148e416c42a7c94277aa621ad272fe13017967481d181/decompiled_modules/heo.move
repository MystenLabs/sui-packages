module 0x4b7cbfe12b1c96e05ddc3a6c57d8bad8195ed51fb3905aae114fbb5d3acb251c::heo {
    ...
    public entry fun p<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::Pool<T1, T0>, arg3: bool, arg4: bool, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg4) {
            ...
            let (v8, v9) = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::do_swap_x_to_y_direct<T1, T0>(arg2, 0x1::vector::singleton<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v5, arg7)), v7, arg6, arg7);
            let v10 = v9;
            let v11 = v8;
            ...
            assert!(0x2::balance::value<T1>(&v5) == 0, 3);
            0x2::balance::destroy_zero<T1>(v5);
            let (v13, v14) = 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::do_swap_y_to_x_direct<T1, T0>(arg2, 0x1::vector::singleton<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v6, arg7)), v12, arg6, arg7);
            let v15 = v14;
            let v16 = v13;
            assert!(0x2::coin::value<T0>(&v16) == 0, 4);
            0x2::coin::destroy_zero<T0>(v16);
            0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg0, arg1, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v15, v12, arg7)), v4);
            if (arg3) {
                0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::swap_x_to_y_all<T1, T0>(arg2, 0x1::vector::singleton<0x2::coin::Coin<T1>>(v15), 0, arg6, arg7);
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v15, 0x2::tx_context::sender(arg7));
            };
        };
    }
