module 0x5bb373a6e10234f8ad91581d0a0aff81d37aea87b03c31f7abcdd9cb57feedb7::cnsnft2282 {
    struct CNSNFT2282 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2282, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2282>(arg0, arg1);
