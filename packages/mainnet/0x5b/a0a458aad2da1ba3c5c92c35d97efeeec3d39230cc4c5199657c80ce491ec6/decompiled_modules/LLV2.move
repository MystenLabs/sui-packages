module 0x5ba0a458aad2da1ba3c5c92c35d97efeeec3d39230cc4c5199657c80ce491ec6::LLV2 {
    ...
    public entry fun new_lotus_pool<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: address, arg16: &0x2::clock::Clock, arg17: &Config, arg18: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0, 5);
        assert!(arg5 > 0, 5);
        let v0 = 0x2::tx_context::sender(arg18);
        assert!(!arg0.locked || 0x1::vector::contains<address>(&arg0.allowlist, &v0), 4);
        let v1 = 0x2::coin::split<T1>(&mut arg4, arg5, arg18);
        let v2 = 0x2::coin::value<T1>(&v1);
        let v3 = v2 * arg17.init_b_percent / 10000;
        let v4 = v2 * arg17.reward_percent / 10000;
        assert!(v3 > 0, 21);
        assert!(v4 > 0, 21);
        assert!(v3 == arg8 * arg9, 23);
        let v5 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg18));
        let v6 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v1, v3, arg18));
        let v7 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v1, v4, arg18));
        create_lotus_pool<T0, T1>(arg1, v5, v6, v7, 0x2::coin::into_balance<T1>(v1), arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg18);
        destroy_zero_or_transfer_balance<T0>(0x2::coin::into_balance<T0>(arg2), v0, arg18);
        destroy_zero_or_transfer_balance<T1>(0x2::coin::into_balance<T1>(arg4), v0, arg18);
    }
    ...
    public entry fun update_init_b_percent(arg0: &mut Config, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 4);
        assert!(arg1 > 0, 3);
        assert!(arg1 + arg0.reward_percent <= 10000, 3);
        arg0.init_b_percent = arg1;
    }
    ...
    public entry fun update_reward_percent(arg0: &mut Config, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 4);
        assert!(arg1 > 0, 3);
        assert!(arg1 + arg0.init_b_percent <= 10000, 3);
        arg0.reward_percent = arg1;
    }
