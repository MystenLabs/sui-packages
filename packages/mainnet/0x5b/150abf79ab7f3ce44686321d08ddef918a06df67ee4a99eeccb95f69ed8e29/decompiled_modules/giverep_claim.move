module 0x5b150abf79ab7f3ce44686321d08ddef918a06df67ee4a99eeccb95f69ed8e29::giverep_claim {
    ...
    public fun init_pool<T0>(arg0: &Whitelist, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x1::vector::contains<address>(&arg0.whitelist, &v0), 1);
        let v1 = Pool<T0>{
