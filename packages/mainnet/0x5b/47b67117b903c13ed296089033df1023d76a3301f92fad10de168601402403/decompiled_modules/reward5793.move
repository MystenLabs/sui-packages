module 0x5b47b67117b903c13ed296089033df1023d76a3301f92fad10de168601402403::reward5793 {
    struct REWARD5793 has drop {
        dummy_field: bool,
    }

    struct TICKET_5793 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5793(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5793>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5793>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5793, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5793>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5793>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5793>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5793>>(v5, 0x2::tx_context::sender(arg1));
    }
