module 0x5bdf0cbd446499ef5bb2fb08e7464f52efa4aa0bd32b92bad2b52a37031254f1::boost_payement {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = Config{
            ...
            setter       : @0xbf57bec395cbfe4072d932a2260db6ef5e877cc1e5c44a2bf33def58205f0361,
            pay_to       : @0xbf57bec395cbfe4072d932a2260db6ef5e877cc1e5c44a2bf33def58205f0361,
            boost_option : v0,
        };
    ...
    public entry fun replace_boost_options(arg0: &mut Config, arg1: vector<u64>, arg2: vector<u64>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg0.setter || v0 == @0xbf57bec395cbfe4072d932a2260db6ef5e877cc1e5c44a2bf33def58205f0361, 1);
    ...
    public entry fun set_pay_to(arg0: &mut Config, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == @0xbf57bec395cbfe4072d932a2260db6ef5e877cc1e5c44a2bf33def58205f0361 || v0 == arg0.setter, 1);
        arg0.pay_to = arg1;
    }
    ...
    public entry fun update_manage_config(arg0: &mut ManageConfig, arg1: address, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == @0xbf57bec395cbfe4072d932a2260db6ef5e877cc1e5c44a2bf33def58205f0361, 1);
        arg0.is_live = arg3;
        arg0.pay_to = arg1;
        arg0.fee = arg2;
    }
