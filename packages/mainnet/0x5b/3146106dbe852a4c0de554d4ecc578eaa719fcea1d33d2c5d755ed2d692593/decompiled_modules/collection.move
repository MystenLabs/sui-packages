module 0x56e430bc0cc42baa5cc5242d914f2de249b5ffeb7a663dc2079de769d077744b::collection {
    ...
    public fun buy_open(arg0: &mut Gate, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut ArtTicket, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.supply == 0 || arg0.minted < arg0.supply, 230);
        assert!(!arg2.used, 231);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) == arg0.price_mist, 232);
        ...
        0x2::transfer::public_transfer<Blub>(v2, 0x2::tx_context::sender(arg3));
