module 0x5b3b0c1c2fc783e751086332fd7322e6dadfe2a1d430faf61e4930f08f0bf220::dev_sahur {
    ...
    fun init(arg0: DEV_SAHUR, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DEV_SAHUR>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Dev Sahur"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Description of thirty symbols "));
