module 0x5b81832cc9e4ba6e6f8a26dff5632c614c6a52e2d8aa58bb92762eaafb7cfab4::fetcher {
    ...
    public entry fun fetch_deepbook_status_ask_side<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock) {
        ...
        let v9 = v8;
        loop {
            let v10 = 0xdee9::order_query::iter_asks<T0, T1>(arg0, arg3, arg4, 0x1::option::none<u64>(), 0x1::option::none<u64>(), true);
            let v11 = 0xdee9::order_query::orders(&v10);
            let v12 = 0x1::vector::length<0xdee9::clob_v2::Order>(v11);
            if (v12 == 0) {
                break
            };
            let v13 = 0;
            while (v13 < v12) {
                let v14 = 0xdee9::order_query::tick_level(0x1::vector::borrow<0xdee9::clob_v2::Order>(v11, v13));
                if (v13 == 0) {
                    if (0x1::vector::length<PriceRange>(&v0) == 0) {
                        let v15 = calc_ask_check_point(v14, arg2);
                        v3 = v15;
                        0x1::vector::push_back<u64>(&mut v2, v15);
                        let v16 = &mut v0;
                        add_price_range_to_vec(v16, v14, 0);
                        v9 = v14;
                        v13 = v13 + 1;
                        continue
                    };
                ...
                if (v14 > v3) {
                    0x1::vector::borrow_mut<PriceRange>(&mut v0, v4).price_high = v8;
                    let v17 = v4 + 1;
                    v4 = v17;
                    if (v17 >= arg1) {
                        if (v13 != v12 - 1) {
                            let v18 = 0x1::vector::borrow<0xdee9::clob_v2::Order>(v11, v13 + 1);
                            v7 = true;
                            v6 = 0x1::option::some<u64>(0xdee9::order_query::order_id(v18));
                            v5 = 0x1::option::some<u64>(0xdee9::order_query::tick_level(v18));
                            break
                        };
                        if (0xdee9::order_query::has_next_page(&v10)) {
                            v7 = true;
                            v6 = 0xdee9::order_query::next_order_id(&v10);
                            v5 = 0xdee9::order_query::next_tick_level(&v10);
                            break
                        };
                        break
                    };
                    let v19 = &mut v0;
                    add_price_range_to_vec(v19, v14, 0);
                    let v20 = calc_ask_check_point(v14, arg2);
                    v3 = v20;
            ...
            if (!0xdee9::order_query::has_next_page(&v10)) {
                0x1::vector::borrow_mut<PriceRange>(&mut v0, v4).price_high = v9;
                break
            };
            arg3 = 0xdee9::order_query::next_tick_level(&v10);
            arg4 = 0xdee9::order_query::next_order_id(&v10);
        };
        let v21 = 0;
        while (v21 < 0x1::vector::length<PriceRange>(&v0)) {
            let v22 = 0x1::vector::borrow<PriceRange>(&v0, v21);
            let (_, v24) = 0xdee9::clob_v2::get_level2_book_status_ask_side<T0, T1>(arg0, v22.price_low, v22.price_high, arg5);
            let v25 = v24;
            let v26 = &mut v1;
            add_price_data_to_vec(v26, calc_ask_check_point(v22.price_low, arg2), sum_depth(&v25));
            v21 = v21 + 1;
        };
        let v27 = FetchDeepbookStatusEvent{
            has_next_page   : v7,
            next_tick_level : v5,
            next_order_id   : v6,
            prices          : v1,
        ...
        0x2::event::emit<FetchDeepbookStatusEvent>(v27);
    }
