module 0x5b05e2c12f617b33b64ea2b004d89cc18c46b270bc0c214ddd32654fa9a8c84c::math {
    ...
    public fun check_imbalance_ratios(arg0: &0x2::vec_map::VecMap<u8, u256>, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: &0x2::vec_map::VecMap<u8, u256>, arg3: u8, arg4: u8, arg5: u256, arg6: u256, arg7: u256, arg8: &0x2::vec_map::VecMap<u8, u256>, arg9: &0x2::vec_map::VecMap<u8, u256>, arg10: u8, arg11: u8, arg12: u256, arg13: u256) : bool {
        ...
        *v5 = *v5 - arg6;
        let v6 = imbalance_ratios(&v1, arg1, arg2, arg8, arg9, arg10, arg11);
        arg12 - arg13 <= *0x2::vec_map::get<u8, u256>(&v6, &arg4) && *0x2::vec_map::get<u8, u256>(&v6, &arg3) <= arg12 + arg13
    }
    ...
    public(friend) fun compute_B_and_L(arg0: &0x2::vec_map::VecMap<u8, u256>, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: &0x2::vec_map::VecMap<u8, u256>, arg3: &0x2::vec_map::VecMap<u8, u256>, arg4: &0x2::vec_map::VecMap<u8, u256>, arg5: u8, arg6: u8) : (u256, u256) {
        let v0 = 0;
        let v1 = 0;
        let v2 = 0;
        while (v2 < (0x2::vec_map::size<u8, u256>(arg0) as u8)) {
            let v3 = *0x2::vec_map::get<u8, u256>(arg3, &v2);
            let v4 = *0x2::vec_map::get<u8, u256>(arg2, &v2) * *0x2::vec_map::get<u8, u256>(arg4, &v2);
            v0 = v0 + mul(v4, *0x2::vec_map::get<u8, u256>(arg0, &v2) * v3, arg5, arg6);
            v1 = v1 + mul(v4, *0x2::vec_map::get<u8, u256>(arg1, &v2) * v3, arg5, arg6);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public fun imbalance_ratios(arg0: &0x2::vec_map::VecMap<u8, u256>, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: &0x2::vec_map::VecMap<u8, u256>, arg3: &0x2::vec_map::VecMap<u8, u256>, arg4: &0x2::vec_map::VecMap<u8, u256>, arg5: u8, arg6: u8) : 0x2::vec_map::VecMap<u8, u256> {
        let (v0, v1) = compute_B_and_L(arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        let v2 = 0x2::vec_map::empty<u8, u256>();
        let v3 = 0;
        while (v3 < (0x2::vec_map::size<u8, u256>(arg0) as u8)) {
            if (*0x2::vec_map::get<u8, u256>(arg1, &v3) != 0) {
                0x2::vec_map::insert<u8, u256>(&mut v2, v3, div(mul(*0x2::vec_map::get<u8, u256>(arg0, &v3) * *0x2::vec_map::get<u8, u256>(arg3, &v3), v1, arg5, arg6), mul(v0, *0x2::vec_map::get<u8, u256>(arg1, &v3) * *0x2::vec_map::get<u8, u256>(arg3, &v3), arg5, arg6), arg5, arg6));
            } else {
    ...
    public fun scaled_fee_and_leverage(arg0: &0x2::vec_map::VecMap<u8, u256>, arg1: &0x2::vec_map::VecMap<u8, u256>, arg2: &0x2::vec_map::VecMap<u8, u256>, arg3: u8, arg4: u8, arg5: &0x2::vec_map::VecMap<u8, u256>, arg6: &0x2::vec_map::VecMap<u8, u256>, arg7: u256, arg8: u256, arg9: u8, arg10: u8) : (u256, u256) {
        let v0 = imbalance_ratios(arg0, arg1, arg2, arg5, arg6, arg9, arg10);
        let v1 = adjust(*0x2::vec_map::get<u8, u256>(&v0, &arg3), arg9, arg10);
        let v2 = adjust(*0x2::vec_map::get<u8, u256>(&v0, &arg4), arg9, arg10);
        (div(mul(v1, arg7, arg9, arg10), v2, arg9, arg10), div(mul(v2, arg8, arg9, arg10), v1, arg9, arg10))
    }
