module 0x5b2c2c915297d14f1e7ebc8c5000b9a8f610c19d6d495897f276313357ad834c::cnsnft9624 {
    struct CNSNFT9624 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9624, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2496"));
        let v4 = 0x2::package::claim<CNSNFT9624>(arg0, arg1);
