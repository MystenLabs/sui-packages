module 0x5b7b6f3dab35f922b77dca31419e9b8eab678129f6b986736222078d5c43ea0c::vault {
    ...
    public(friend) fun assert_deposits_enabled<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: u64) {
        assert!(arg0.deposits_enabled && 0x2::balance::value<T2>(&arg0.seed_vt) > 0 && arg1 < arg0.deposit_limit, 0x5b7b6f3dab35f922b77dca31419e9b8eab678129f6b986736222078d5c43ea0c::error::deposits_disabled());
    }

    public(friend) fun assert_vault_cap<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &VaultCap) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1, T2>>(arg0), 0x5b7b6f3dab35f922b77dca31419e9b8eab678129f6b986736222078d5c43ea0c::error::invalid_vault_cap());
    }
