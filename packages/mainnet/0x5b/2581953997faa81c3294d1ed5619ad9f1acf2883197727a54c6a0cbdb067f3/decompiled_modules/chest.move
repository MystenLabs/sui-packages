module 0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::chest {
    ...
    public fun access(arg0: &mut Chest, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &mut 0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::Abyss, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.access_fee == 0) {
            ...
            0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::receive_chest_access(arg2, 0x2::coin::split<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&mut arg1, v1 * 300 / 10000, arg4), arg3, arg4);
    ...
    public fun burn(arg0: &mut Chest, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &mut 0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::Abyss, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.state == 0, 1);
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 2);
        0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::receive_chest_burn(arg2, arg1, arg3, arg4);
        arg0.blob_id = b"";
        arg0.seal_id = b"";
        arg0.state = 1;
    ...
    public fun extend(arg0: &mut Chest, arg1: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &mut 0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::Abyss, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(is_alive(arg0, arg4), 6);
        assert!(0x2::tx_context::sender(arg5) == arg0.owner, 2);
        0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::receive_chest_extend(arg2, arg1, arg4, arg5);
    ...
    public fun open(arg0: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg1: &mut 0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::Abyss, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: vector<u8>, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 <= 2, 4);
        assert!(arg6 <= max_bytes(arg5), 5);
        assert!(arg7 == 0 || arg7 >= 10000, 3);
        0x23a10fe5bd4a7b78087d6e716a1e810168e0b3332ff022637606a02d001fc9f1::abyss::receive_chest_open(arg1, arg0, arg5, arg9, arg10);
