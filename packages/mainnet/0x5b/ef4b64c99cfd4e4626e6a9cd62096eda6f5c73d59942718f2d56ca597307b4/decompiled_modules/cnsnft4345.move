module 0x5bef4b64c99cfd4e4626e6a9cd62096eda6f5c73d59942718f2d56ca597307b4::cnsnft4345 {
    struct CNSNFT4345 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4345, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3515"));
        let v4 = 0x2::package::claim<CNSNFT4345>(arg0, arg1);
