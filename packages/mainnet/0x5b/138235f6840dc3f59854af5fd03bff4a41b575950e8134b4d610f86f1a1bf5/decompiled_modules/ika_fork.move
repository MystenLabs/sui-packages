module 0x5b138235f6840dc3f59854af5fd03bff4a41b575950e8134b4d610f86f1a1bf5::ika_fork {
    ...
    fun init(arg0: IKA_FORK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<IKA_FORK>>(0x2::coin::mint<IKA_FORK>(&mut v2, 1000000000000000, arg1), 0x2::tx_context::sender(arg1));
