module 0x5bf0bf893481cffd88f0a06f969f2e44b8a861fc25c123816edaf60e1ad8e40b::aiastakingpool1 {
    ...
    struct AdminSetStakeEvent has copy, drop {
        user: address,
        stake_ts: u64,
        amount: u64,
    }
    ...
    public fun admin_set_stake<T0>(arg0: &DevAdminCap, arg1: &mut StakingPoolState<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: vector<u64>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<address>(&arg2) == 0x1::vector::length<u64>(&arg3), 0);
        let v0 = now_seconds(arg5);
        let v1 = 0;
        while (v1 < 0x1::vector::length<address>(&arg2)) {
            ...
            let v4 = StakeInfo<T0>{
                ...
                stake_amount           : v3,
                stake_timestamp        : v0,
                withdrawable_timestamp : v0 + arg1.lock_period,
                withdrawn              : false,
            };
            ...
            let v5 = StakeEvent{
                stake_object_id        : 0x2::object::uid_to_inner(&v4.id),
                user                   : v2,
                amount                 : v3,
                stake_timestamp        : v0,
                withdrawable_timestamp : v4.withdrawable_timestamp,
                early_stake_id         : *0x1::vector::borrow<u64>(&arg4, v1),
            ...
            0x1::vector::push_back<StakeInfo<T0>>(0x2::table::borrow_mut<address, vector<StakeInfo<T0>>>(&mut arg1.user_stake_records, v2), v4);
            v1 = v1 + 1;
        };
        let v6 = AdminEvent{
        ...
        0x2::event::emit<AdminEvent>(v6);
    }

    public fun cancel_user_stakes<T0>(arg0: &DevAdminCap, arg1: &mut StakingPoolState<T0>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        if (0x2::table::contains<address, vector<StakeInfo<T0>>>(&arg1.user_stake_records, arg2)) {
            ...
            while (v1 < 0x1::vector::length<StakeInfo<T0>>(v0)) {
                ...
                if (!v2.withdrawn && v2.stake_amount > 0) {
                    let v3 = StakeCancelEvent{
                    ...
                    0x2::event::emit<StakeCancelEvent>(v3);
                    v2.stake_amount = 0;
    ...
    public fun stake<T0>(arg0: &mut StakingPoolState<T0>, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<StakeInfo<T0>>(0x2::table::borrow_mut<address, vector<StakeInfo<T0>>>(&mut arg0.user_stake_records, v0), v3);
    }
    ...
    public fun withdraw<T0>(arg0: &mut StakingPoolState<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < 0x1::vector::length<StakeInfo<T0>>(v1)) {
            let v5 = 0x1::vector::borrow_mut<StakeInfo<T0>>(v1, v4);
            if (!v5.withdrawn && v2 >= v5.withdrawable_timestamp) {
                v5.withdrawn = true;
                let v6 = v3 + v5.stake_amount;
                v3 = v6;
