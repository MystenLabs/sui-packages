module 0xb352dc323c18255d27cab4b40230dc9eaceb6dd70b68339d9cd2eb5069eff482::cnsnft2371 {
    struct CNSNFT2371 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2371, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2371>(arg0, arg1);
