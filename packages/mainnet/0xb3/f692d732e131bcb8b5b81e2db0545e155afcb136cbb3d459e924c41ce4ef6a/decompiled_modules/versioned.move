module 0xb3f692d732e131bcb8b5b81e2db0545e155afcb136cbb3d459e924c41ce4ef6a::versioned {
    ...
    public fun pause(arg0: &0xb3f692d732e131bcb8b5b81e2db0545e155afcb136cbb3d459e924c41ce4ef6a::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public fun unpause(arg0: &0xb3f692d732e131bcb8b5b81e2db0545e155afcb136cbb3d459e924c41ce4ef6a::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public fun upgrade(arg0: &0xb3f692d732e131bcb8b5b81e2db0545e155afcb136cbb3d459e924c41ce4ef6a::admin_cap::AdminCap, arg1: &mut Versioned) {
        assert!(arg1.version < 0, 1000);
