module 0xb35f777f670c9c2086b1e964d5810de59c5abc23cd7447fd9182fc8d3e81efc8::reward3044 {
    struct REWARD3044 has drop {
        dummy_field: bool,
    }

    struct TICKET_3044 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3044(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3044>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3044>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3044, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3044>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3044>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3044>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3044>>(v5, 0x2::tx_context::sender(arg1));
    }
