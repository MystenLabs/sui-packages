module 0xb309645f5e06fad9eea94d894860cd20434db9f67a4994065f2e47057d7f1999::cnsnft3416 {
    struct CNSNFT3416 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3416, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3416>(arg0, arg1);
