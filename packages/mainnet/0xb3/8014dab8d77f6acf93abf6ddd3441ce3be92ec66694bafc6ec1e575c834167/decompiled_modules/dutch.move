module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch {
    ...
    public fun new_bid_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault, arg1: &mut Auction, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: 0x2::balance::Balance<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address) {
        ...
        assert!(arg2 > 0, 6);
        assert!(arg1.total_bid_size + arg2 <= arg1.size, 5);
        assert!(arg1.token == 0x1::type_name::get<T0>(), 4);
        let (v1, v2, v3, v4) = get_bid_info(arg1, arg2, arg5, v0);
        let v5 = v3 + v4;
        assert!(v5 > 0, 12);
        let v6 = 0x2::balance::value<T0>(&arg4);
        ...
        let (v10, v11) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::public_extract_balance<T0>(arg3, v9);
        let v12 = v10;
        let v13 = 0x2::balance::zero<T0>();
        while (!0x1::vector::is_empty<0x2::coin::Coin<T0>>(&v12)) {
            0x2::balance::join<T0>(&mut v13, 0x2::coin::into_balance<T0>(0x1::vector::pop_back<0x2::coin::Coin<T0>>(&mut v12)));
        };
        0x1::vector::destroy_empty<0x2::coin::Coin<T0>>(v12);
        if (0x2::balance::value<T0>(&v13) > 0) {
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::put_refund<T0>(arg0, v13, v8);
        } else {
        ...
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::push_back<Bid>(&mut arg1.bids, v14);
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg1.id, b"bidder_balance"), v11);
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg1.id, b"incentive_balance"), arg4);
        let v15 = NewBid{
            signer            : v8,
            index             : arg1.index,
            token             : 0x1::type_name::get<T0>(),
    ...
    public fun public_new_bid<T0>(arg0: address, arg1: &mut Auction, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: 0x2::balance::Balance<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address, 0x2::coin::Coin<T0>) {
        ...
        let v9 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::merge_coins<T0>(arg3);
        let v10 = Bid{
            index             : v7,
            bidder            : arg0,
            price             : v1,
        ...
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg1.id, b"bidder_balance"), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v9, v8, arg7)));
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg1.id, b"incentive_balance"), arg4);
        let v11 = NewBid{
            signer            : arg0,
            index             : arg1.index,
