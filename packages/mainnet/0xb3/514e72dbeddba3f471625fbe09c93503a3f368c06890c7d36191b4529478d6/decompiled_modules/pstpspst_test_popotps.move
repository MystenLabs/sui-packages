module 0xb3514e72dbeddba3f471625fbe09c93503a3f368c06890c7d36191b4529478d6::pstpspst_test_popotps {
    struct PSTPSPST_TEST_POPOTPS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PSTPSPST_TEST_POPOTPS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PSTPSPST_TEST_POPOTPS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"pstpspst test popotps"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"sadasda"));
