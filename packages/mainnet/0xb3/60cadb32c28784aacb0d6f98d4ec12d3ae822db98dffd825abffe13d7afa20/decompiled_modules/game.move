module 0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::game {
    ...
    struct Stake has store, key {
        id: 0x2::object::UID,
        player: address,
        amount: 0x2::coin::Coin<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>,
    }
    ...
    public entry fun cancel_game(arg0: &mut Game, arg1: Stake, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>>(v4, arg0.player1);
        let v5 = GameCancelled{
            game_id         : 0x2::object::uid_to_inner(&arg0.id),
            cancelled_by    : v0,
            refunded_amount : 0x2::coin::value<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>(&v4),
        };
    ...
    public entry fun create_game(arg0: address, arg1: 0x2::coin::Coin<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>, arg2: u8, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 == 1 || arg2 == 3 || arg2 == 5, 1000);
        let v0 = 0x2::coin::value<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>(&arg1);
    ...
    public entry fun finalize_game(arg0: &mut Game, arg1: Stake, arg2: Stake, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::coin::join<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>(&mut v3, v7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>>(v3, v8);
        let v9 = GameFinished{
            game_id        : 0x2::object::uid_to_inner(&arg0.id),
            winner         : v8,
            final_score_p1 : arg0.player1_score,
            final_score_p2 : arg0.player2_score,
            payout_amount  : 0x2::coin::value<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>(&v3) + 0x2::coin::value<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>(&v7),
        };
    ...
    public entry fun join_game(arg0: &mut Game, arg1: 0x2::coin::Coin<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.state == 1, 1002);
        assert!(0x2::coin::value<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>(&arg1) == arg0.stake, 1003);
        let v0 = 0x2::tx_context::sender(arg3);
        if (arg0.player2 != @0x0) {
        ...
        let v2 = StakeSubmitted{
            game_id : 0x2::object::uid_to_inner(&arg0.id),
            player  : v0,
            amount  : 0x2::coin::value<0xb360cadb32c28784aacb0d6f98d4ec12d3ae822db98dffd825abffe13d7afa20::rps_token::RPS_TOKEN>(&arg1),
        };
