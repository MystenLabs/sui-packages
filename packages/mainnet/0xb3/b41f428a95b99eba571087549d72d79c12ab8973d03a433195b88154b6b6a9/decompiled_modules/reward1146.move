module 0xb3b41f428a95b99eba571087549d72d79c12ab8973d03a433195b88154b6b6a9::reward1146 {
    struct REWARD1146 has drop {
        dummy_field: bool,
    }

    struct TICKET_1146 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1146(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1146>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1146>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1146, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1146>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1146>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1146>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1146>>(v5, 0x2::tx_context::sender(arg1));
    }
