module 0xb325b431b8e19a142a8ecef1242fccbbd0d5156bed5180b583c294f435960f5b::sbt_nft {
    ...
    public fun create_collection(arg0: &mut ModuleState, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::epoch_timestamp_ms(arg8);
        if (v0 > arg6) {
            assert!(v0 - arg6 < 900000, 6);
        };
        assert!(0x2::coin::value<0x2::sui::SUI>(arg7) >= arg0.collection_fee_amount, 3);
        let v1 = 0x1::string::utf8(b"");
        0x1::string::append(&mut v1, arg1);
        0x1::string::append(&mut v1, arg2);
        0x1::string::append(&mut v1, arg3);
        0x1::string::append(&mut v1, 0x2::address::to_string(0x2::tx_context::sender(arg8)));
        0x1::string::append(&mut v1, arg4);
        0x1::string::append(&mut v1, 0x1::u64::to_string(arg6));
        let v2 = 0x2::hex::decode(0x1::string::into_bytes(arg0.public_key));
        let v3 = 0x2::hex::decode(0x1::string::into_bytes(arg5));
        assert!(0x2::ed25519::ed25519_verify(&v3, &v2, 0x1::string::as_bytes(&v1)), 2);
        if (arg0.collection_fee_amount > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg7, arg0.collection_fee_amount, arg8), arg0.deployer);
            let v4 = FeeCollected{
        ...
        let v8 = 0x2::table::new<address, bool>(arg8);
        0x2::table::add<address, bool>(&mut v8, v5, true);
        if (arg0.deployer != v5) {
        ...
        let v9 = Collection{
            ...
            sbtId       : arg4,
            minted_sbts : 0x2::table::new<address, bool>(arg8),
            admins      : v8,
        };
    ...
    fun init(arg0: SBT_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = ModuleState{
            ...
            fee_amount            : 0,
            public_key            : 0x1::string::utf8(b"8109ca1357d2ffe3e7b639194007aea5be337b5e83d4a90663f4a3d69cbe72ce"),
    ...
    public fun mint(arg0: &mut ModuleState, arg1: &mut Collection, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(arg4) >= arg0.fee_amount, 3);
        if (arg0.fee_amount > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg4, arg0.fee_amount, arg5), arg0.deployer);
            let v5 = FeeCollected{
                amount    : arg0.fee_amount,
                recipient : arg0.deployer,
            };
