module 0xb32f84367489bd889578c55fd5e0c8d8c79d5dd829703a187a1cb9346c5ee21c::nft_market {
    ...
    public fun buy_print(arg0: &mut UserRegistry, arg1: &mut NFT, arg2: u64, arg3: &Config, arg4: &mut 0xb32f84367489bd889578c55fd5e0c8d8c79d5dd829703a187a1cb9346c5ee21c::nft_treasury::Treasury, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xb32f84367489bd889578c55fd5e0c8d8c79d5dd829703a187a1cb9346c5ee21c::nft_treasury::set_allowance(arg4, arg1.owner, arg1.revenue);
        0x1::vector::push_back<vector<u8>>(&mut get_or_create_user(arg0, v0, arg5).print_history, 0x2::object::uid_to_bytes(&arg1.id));
    }

    public fun claim_revenue(arg0: &mut NFT, arg1: &mut 0xb32f84367489bd889578c55fd5e0c8d8c79d5dd829703a187a1cb9346c5ee21c::nft_treasury::Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 5);
        let v0 = arg0.revenue;
        assert!(v0 > 0, 4);
        0xb32f84367489bd889578c55fd5e0c8d8c79d5dd829703a187a1cb9346c5ee21c::nft_treasury::withdraw_allowance(arg1, v0, arg2);
        arg0.revenue = 0;
    }
