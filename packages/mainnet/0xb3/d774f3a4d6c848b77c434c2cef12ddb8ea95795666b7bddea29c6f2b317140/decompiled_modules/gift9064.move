module 0xb3d774f3a4d6c848b77c434c2cef12ddb8ea95795666b7bddea29c6f2b317140::gift9064 {
    struct GIFT9064 has drop {
        dummy_field: bool,
    }

    struct TICKET_9064 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9064(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9064>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9064>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9064, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9064>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9064>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9064>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9064>>(v5, 0x2::tx_context::sender(arg1));
    }
