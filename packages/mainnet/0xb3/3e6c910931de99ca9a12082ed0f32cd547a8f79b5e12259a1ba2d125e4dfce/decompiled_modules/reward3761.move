module 0xb33e6c910931de99ca9a12082ed0f32cd547a8f79b5e12259a1ba2d125e4dfce::reward3761 {
    struct REWARD3761 has drop {
        dummy_field: bool,
    }

    struct TICKET_3761 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3761(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3761>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3761>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3761, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3761>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3761>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3761>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3761>>(v5, 0x2::tx_context::sender(arg1));
    }
