module 0xb363eb96f5e3d6130d77b4451072317757716182897c81bd2e928640b5206da9::reward9618 {
    struct REWARD9618 has drop {
        dummy_field: bool,
    }

    struct TICKET_9618 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9618(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9618>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9618>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9618, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9618>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9618>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9618>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9618>>(v5, 0x2::tx_context::sender(arg1));
    }
