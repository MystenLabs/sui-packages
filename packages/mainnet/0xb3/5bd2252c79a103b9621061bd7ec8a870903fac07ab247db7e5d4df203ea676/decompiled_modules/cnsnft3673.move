module 0xb35bd2252c79a103b9621061bd7ec8a870903fac07ab247db7e5d4df203ea676::cnsnft3673 {
    struct CNSNFT3673 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3673, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3673>(arg0, arg1);
