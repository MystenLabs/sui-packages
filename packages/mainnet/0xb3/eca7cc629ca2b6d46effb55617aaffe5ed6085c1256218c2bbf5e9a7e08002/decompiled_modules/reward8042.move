module 0xb3eca7cc629ca2b6d46effb55617aaffe5ed6085c1256218c2bbf5e9a7e08002::reward8042 {
    struct REWARD8042 has drop {
        dummy_field: bool,
    }

    struct TICKET_8042 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8042(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8042>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8042>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8042, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8042>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8042>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8042>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8042>>(v5, 0x2::tx_context::sender(arg1));
    }
