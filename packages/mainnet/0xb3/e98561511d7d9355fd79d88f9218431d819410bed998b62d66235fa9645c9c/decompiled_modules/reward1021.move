module 0xb3e98561511d7d9355fd79d88f9218431d819410bed998b62d66235fa9645c9c::reward1021 {
    struct REWARD1021 has drop {
        dummy_field: bool,
    }

    struct TICKET_1021 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1021(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1021>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1021>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1021, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1021>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1021>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1021>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1021>>(v5, 0x2::tx_context::sender(arg1));
    }
