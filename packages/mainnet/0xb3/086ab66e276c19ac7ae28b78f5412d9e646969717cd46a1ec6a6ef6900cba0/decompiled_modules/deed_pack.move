module 0xb3086ab66e276c19ac7ae28b78f5412d9e646969717cd46a1ec6a6ef6900cba0::deed_pack {
    ...
    public(friend) fun burn(arg0: DeedPack, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0xb3086ab66e276c19ac7ae28b78f5412d9e646969717cd46a1ec6a6ef6900cba0::events::emit_deed_burned(0x2::object::uid_to_inner(&v3), v1, v2, arg1, arg2);
    ...
    public(friend) fun mint(arg0: address, arg1: u8, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xb3086ab66e276c19ac7ae28b78f5412d9e646969717cd46a1ec6a6ef6900cba0::events::emit_minted(arg0, 0x2::object::uid_to_inner(&v0.id), arg1, arg2);
    }
