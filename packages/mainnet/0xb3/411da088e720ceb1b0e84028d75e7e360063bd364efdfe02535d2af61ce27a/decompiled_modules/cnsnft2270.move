module 0xb3411da088e720ceb1b0e84028d75e7e360063bd364efdfe02535d2af61ce27a::cnsnft2270 {
    struct CNSNFT2270 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2270, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2233"));
        let v4 = 0x2::package::claim<CNSNFT2270>(arg0, arg1);
