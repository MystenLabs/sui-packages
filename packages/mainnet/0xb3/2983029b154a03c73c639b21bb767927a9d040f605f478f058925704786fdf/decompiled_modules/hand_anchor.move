module 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::hand_anchor {
    ...
    fun execute_settle<T0>(arg0: &mut 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: vector<u64>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 501);
        assert!(arg1.table_id == 0x2::object::id<0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>>(arg0), 502);
        ...
        while (v3 < v0) {
            ...
            0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::apply_seat_outcome<T0>(arg0, v4.seat_idx, v4.seat_epoch, v4.address, *0x1::vector::borrow<u64>(&arg2, v3));
            v3 = v3 + 1;
        };
        if (arg3 > 0) {
            assert!(arg3 <= 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::escrow_value<T0>(arg0), 511);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::take_from_escrow<T0>(arg0, arg3), arg5), @0x117c5e19bc1884228f68ecaab30767dd016daaf3976bf2e3e0018e66fd45be71);
        };
        arg1.status = 2;
        0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::clear_active_hand<T0>(arg0, 0x2::object::id<HandAnchor>(arg1));
        let v5 = HandSettled{
        ...
        0x2::event::emit<HandSettled>(v5);
    }

    fun execute_void<T0>(arg0: &mut 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg1.status == 1, 501);
        assert!(arg1.table_id == 0x2::object::id<0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>>(arg0), 502);
        let v0 = 0;
        while (v0 < 0x1::vector::length<HandPlayer>(&arg1.player_list)) {
            let v1 = 0x1::vector::borrow<HandPlayer>(&arg1.player_list, v0);
            0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::apply_seat_outcome<T0>(arg0, v1.seat_idx, v1.seat_epoch, v1.address, v1.start_stack);
            v0 = v0 + 1;
        };
        arg1.status = 3;
        0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::clear_active_hand<T0>(arg0, 0x2::object::id<HandAnchor>(arg1));
    ...
    public fun open_board_card(arg0: &mut HandAnchor, arg1: &0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::CoordinatorRegistry, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::assert_coordinator(arg1, arg3);
    ...
    public fun settle_hand<T0>(arg0: &mut 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::CoordinatorRegistry, arg3: vector<u64>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::assert_coordinator(arg2, arg6);
        execute_settle<T0>(arg0, arg1, arg3, arg4, arg5, arg6);
    }

    public fun settle_hand_with_quorum<T0>(arg0: &mut 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: vector<u64>, arg3: u64, arg4: u64, arg5: vector<vector<u8>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 501);
        let v0 = 0x1::vector::length<HandPlayer>(&arg1.player_list);
        assert!(0x1::vector::length<u64>(&arg2) == v0, 508);
        ...
        arg1.trust_model = 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::version::trust_player_quorum();
    ...
    public fun start_hand<T0>(arg0: &mut 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>, arg1: &0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::CoordinatorRegistry, arg2: u64, arg3: vector<HandPlayer>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<address>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::assert_coordinator(arg1, arg9);
        ...
        let v2 = 0;
        while (v2 < v0) {
            let v3 = 0x1::vector::borrow<HandPlayer>(&arg3, v2);
            0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::assert_seat_matches<T0>(arg0, v3.seat_idx, v3.seat_epoch, v3.address, v3.account_id);
            assert!(v3.start_stack == 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::seat_current_stack<T0>(arg0, v3.seat_idx), 512);
            let v4 = 0x1::vector::length<u8>(&v3.session_pubkey);
            assert!(v4 == 0 || v4 == 32, 516);
            v2 = v2 + 1;
        };
        let v5 = 0x2::object::id<0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>>(arg0);
        let v6 = HandAnchor{
            ...
            committee_list      : arg6,
            status              : 1,
            trust_model         : 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::version::trust_prototype(),
        ...
        let v7 = 0x2::object::id<HandAnchor>(&v6);
        0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::mark_active_hand<T0>(arg0, v7);
        let v8 = HandStarted{
            hand_id           : v7,
            table_id          : v5,
            hand_seq          : v6.hand_seq,
            player_list       : v6.player_list,
            deck_root         : v6.deck_root,
            proof_bundle_hash : v6.proof_bundle_hash,
            deadline_at_ms    : v6.deadline_at_ms,
            trust_model       : v6.trust_model,
            started_at_ms     : v6.started_at_ms,
        };
        0x2::event::emit<HandStarted>(v8);
        0x2::transfer::share_object<HandAnchor>(v6);
    }
    ...
    public fun void_hand<T0>(arg0: &mut 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::CoordinatorRegistry, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::coordinator_registry::assert_coordinator(arg2, arg5);
        execute_void<T0>(arg0, arg1, arg3, arg4);
    }

    public fun void_hand_after_deadline<T0>(arg0: &mut 0xb32983029b154a03c73c639b21bb767927a9d040f605f478f058925704786fdf::table_anchor::TableAnchor<T0>, arg1: &mut HandAnchor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.status == 1, 501);
