module 0x2cb0b99942ceccbffa67a991a01b0ddc78a96fb1895f426868699c6da27c424::core {
    ...
    fun current_total_share(arg0: &RewardConfig, arg1: u64, arg2: u64) : u64 {
    ...
    fun get_reward<T0>(arg0: &Deposit<T0>, arg1: &RewardConfig, arg2: &0x1::type_name::TypeName) : u64 {
        (((share_in_the_reward_config<T0>(arg0, arg1) as u128) * arg1.per_share / 10000000000) as u64) - get_debt<T0>(arg0, arg2)
    }
    ...
    public(friend) fun set_reward_rate<T0, T1>(arg0: &mut Pool<T0>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    fun share_in_the_reward_config<T0>(arg0: &Deposit<T0>, arg1: &RewardConfig) : u64 {
    ...
    fun update_reward_rate(arg0: &mut RewardConfig, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
