module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank {
    struct Tank<phantom T0, phantom T1> has store, key {
        ...
        current_scale: u64,
        bkt_pool: 0x2::balance::Balance<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>,
    ...
    public(friend) fun new<T0, T1>(arg0: &mut 0x2::tx_context::TxContext) : Tank<T0, T1> {
        ...
        Tank<T0, T1>{
            ...
            current_p               : 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::p_initial_value(),
            current_epoch           : 0,
            epoch_scale_sum_map     : v1,
            current_scale           : 0,
            bkt_pool                : 0x2::balance::zero<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(),
            epoch_scale_gain_map    : new_table(arg0),
            total_flash_loan_amount : 0,
        }
    }

    public fun claim<T0, T1>(arg0: &mut Tank<T0, T1>, arg1: &mut 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BktTreasury, arg2: &mut ContributorToken<T0, T1>, arg3: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>) {
        ...
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank_events::emit_withdraw<T1>(0, v2, 0x2::balance::value<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(&v0));
        if (0x2::tx_context::epoch(arg3) - arg2.ctx_epoch > 7) {
            (0x2::balance::split<T1>(&mut arg0.collateral_pool, v2), v0)
        } else {
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::collect_bkt(arg1, v0);
            (0x2::balance::split<T1>(&mut arg0.collateral_pool, v2), 0x2::balance::zero<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>())
        }
    }

    public(friend) fun collect_bkt<T0, T1>(arg0: &mut Tank<T0, T1>, arg1: 0x2::balance::Balance<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>) {
        let v0 = 0x2::balance::value<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(&arg1);
        0x2::balance::join<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(&mut arg0.bkt_pool, arg1);
        ...
        *v3 = *v3 + 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg0.current_p, v0, get_reserve_balance<T0, T1>(arg0));
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank_events::emit_collect_bkt<T1>(v0);
    }
    ...
    public(friend) fun absorb<T0, T1>(arg0: &mut Tank<T0, T1>, arg1: 0x2::balance::Balance<T1>, arg2: u64) : 0x2::balance::Balance<T0> {
        ...
        *v5 = *v5 + 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg0.current_p, v0, v1);
        ...
        if (v2 == 0) {
            ...
            arg0.current_p = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::p_initial_value();
            arg0.current_scale = 0;
            let v7 = &mut arg0.epoch_scale_sum_map;
            add_table(v7, arg0.current_epoch, arg0.current_scale);
        } else if (v6 < 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::scale_factor()) {
            arg0.current_p = v6 * 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::scale_factor();
        ...
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank_events::emit_absorb<T1>(arg2, v0);
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank_events::emit_tank_update<T1>(arg0.current_epoch, arg0.current_scale, arg0.current_p);
    ...
    public fun airdrop_bkt<T0, T1>(arg0: &mut Tank<T0, T1>, arg1: 0x2::balance::Balance<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>) {
        0x2::balance::join<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(&mut arg0.bkt_pool, arg1);
    }
    ...
    fun claim_bkt<T0, T1>(arg0: &mut Tank<T0, T1>, arg1: &ContributorToken<T0, T1>) : 0x2::balance::Balance<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT> {
        ...
        0x2::balance::split<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(&mut arg0.bkt_pool, get_bkt_reward_amount<T0, T1>(arg0, arg1))
    }
    ...
    public fun deposit<T0, T1>(arg0: &mut Tank<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &mut 0x2::tx_context::TxContext) : ContributorToken<T0, T1> {
        ...
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank_events::emit_deposit<T1>(v0);
    ...
    public fun get_bkt_pool_balance<T0, T1>(arg0: &Tank<T0, T1>) : u64 {
        0x2::balance::value<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(&arg0.bkt_pool)
    }
    ...
    public fun get_bkt_reward_amount<T0, T1>(arg0: &Tank<T0, T1>, arg1: &ContributorToken<T0, T1>) : u64 {
        ...
        let v2 = if (0x2::table::contains<EpochAndScale, u64>(&arg0.epoch_scale_gain_map, v1)) {
            ...
            *0x2::table::borrow<EpochAndScale, u64>(&arg0.epoch_scale_gain_map, v3) / 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::scale_factor()
        } else {
            0
        };
    ...
    public fun get_collateral_reward_amount<T0, T1>(arg0: &Tank<T0, T1>, arg1: &ContributorToken<T0, T1>) : u64 {
        ...
        0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg1.deposit_amount, *0x2::table::borrow<EpochAndScale, u64>(&arg0.epoch_scale_sum_map, v0) - arg1.start_s + v2 / 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::scale_factor(), arg1.start_p)
    }
    ...
    public fun get_token_weight<T0, T1>(arg0: &Tank<T0, T1>, arg1: &ContributorToken<T0, T1>) : u64 {
        ...
        if (v0 == 0) {
            ...
            0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg1.deposit_amount, arg0.current_p, arg1.start_p) / 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::scale_factor()
        } else {
            0
        }
    }
    ...
    public(friend) fun withdraw<T0, T1>(arg0: &mut Tank<T0, T1>, arg1: &mut 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BktTreasury, arg2: ContributorToken<T0, T1>, arg3: &0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>) {
        ...
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::tank_events::emit_withdraw<T1>(v0, 0x2::balance::value<T0>(&v1), 0x2::balance::value<0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bkt::BKT>(&v5));
        (v1, v3, v5)
    }
