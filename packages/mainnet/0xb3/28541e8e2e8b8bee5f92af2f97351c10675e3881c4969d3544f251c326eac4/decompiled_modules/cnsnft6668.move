module 0xb328541e8e2e8b8bee5f92af2f97351c10675e3881c4969d3544f251c326eac4::cnsnft6668 {
    struct CNSNFT6668 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6668, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8963"));
        let v4 = 0x2::package::claim<CNSNFT6668>(arg0, arg1);
