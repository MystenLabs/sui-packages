module 0xb31b797693c335f1fcd4a8b0c6417558217ca4f603e4cb99dadead6900871246::cnsnft8086 {
    struct CNSNFT8086 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8086, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8086>(arg0, arg1);
