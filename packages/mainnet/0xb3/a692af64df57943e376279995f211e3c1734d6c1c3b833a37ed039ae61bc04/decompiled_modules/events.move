module 0xb3a692af64df57943e376279995f211e3c1734d6c1c3b833a37ed039ae61bc04::events {
    ...
    struct BatchTimeoutUpdated has copy, drop {
        new_timeout_ms: u64,
    }

    struct BatchSettleTimeoutUpdated has copy, drop {
        new_settle_timeout_ms: u64,
    }

    struct BatchSizeUpdated has copy, drop {
        new_batch_size: u16,
    }
    ...
    public(friend) fun emit_batch_settle_timeout_updated(arg0: u64) {
        let v0 = BatchSettleTimeoutUpdated{new_settle_timeout_ms: arg0};
        0x2::event::emit<BatchSettleTimeoutUpdated>(v0);
    }

    public(friend) fun emit_batch_size_updated(arg0: u16) {
        let v0 = BatchSizeUpdated{new_batch_size: arg0};
        0x2::event::emit<BatchSizeUpdated>(v0);
    }

    public(friend) fun emit_batch_timeout_updated(arg0: u64) {
        let v0 = BatchTimeoutUpdated{new_timeout_ms: arg0};
        0x2::event::emit<BatchTimeoutUpdated>(v0);
    }
