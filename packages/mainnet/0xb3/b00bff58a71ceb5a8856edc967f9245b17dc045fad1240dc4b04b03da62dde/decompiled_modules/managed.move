module 0xb3b00bff58a71ceb5a8856edc967f9245b17dc045fad1240dc4b04b03da62dde::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"X-Coin", b"X-Coin", b"https://iili.io/2tmTR1t.png", 0x1::option::none<0x2::url::Url>(), arg1);
