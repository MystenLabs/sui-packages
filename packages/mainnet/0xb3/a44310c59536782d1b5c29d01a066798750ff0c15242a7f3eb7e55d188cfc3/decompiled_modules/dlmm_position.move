module 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_position {
    ...
    public(friend) fun create(arg0: 0x2::object::ID, arg1: vector<u32>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) : Position {
        let v0 = 0x2::table::new<u32, u64>(arg3);
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg2)) {
            0x2::table::add<u32, u64>(&mut v0, *0x1::vector::borrow<u32>(&arg1, v1), *0x1::vector::borrow<u64>(&arg2, v1));
            v1 = v1 + 1;
        };
        Position{
    ...
    public(friend) fun shrink(arg0: &mut Position, arg1: u32, arg2: u64) {
        ...
        assert!(v0, 9223372303142748159);
        assert!(*0x2::table::borrow<u32, u64>(&arg0.shares, arg1) >= arg2, 9223372307437715455);
