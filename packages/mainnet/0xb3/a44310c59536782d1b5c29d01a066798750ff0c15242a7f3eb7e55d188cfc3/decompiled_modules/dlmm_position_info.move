module 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_position_info {
    ...
    public(friend) fun get_position_info_bin_fees(arg0: &PositionInfo, arg1: u32, arg2: u256, arg3: u256) : (u64, u64) {
        ...
        (arg0.fee_owned_x + 0x8d2541f1486688d752dc67119fb6fe0ac416ec1edb8b9772fe3de67d7ca37c42::uint_safe::safe64((v0 >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset()) * (arg2 - v1) >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset()), arg0.fee_owned_y + 0x8d2541f1486688d752dc67119fb6fe0ac416ec1edb8b9772fe3de67d7ca37c42::uint_safe::safe64((v0 >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset()) * (arg3 - v2) >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset()))
    }
    ...
    fun position_info_update_bin_distribution_internal(arg0: &mut PositionInfo, arg1: u32, arg2: u256) {
        let v0 = if (0x2::table::contains<u32, u256>(&arg0.bin_liquidity, arg1)) {
            *0x2::table::borrow<u32, u256>(&arg0.bin_liquidity, arg1)
        } else {
            0
        };
        let v1 = if (0x2::table::contains<u32, u256>(&arg0.bin_distribution_growth, arg1)) {
            *0x2::table::borrow<u32, u256>(&arg0.bin_distribution_growth, arg1)
        } else {
            0
        };
        arg0.distribution_owned = arg0.distribution_owned + 0x8d2541f1486688d752dc67119fb6fe0ac416ec1edb8b9772fe3de67d7ca37c42::uint_safe::safe64(v0 * (arg2 - v1) >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset());
    ...
    fun position_info_update_bin_fees_internal(arg0: &mut PositionInfo, arg1: u32, arg2: u256, arg3: u256) {
        ...
        arg0.fee_owned_x = arg0.fee_owned_x + 0x8d2541f1486688d752dc67119fb6fe0ac416ec1edb8b9772fe3de67d7ca37c42::uint_safe::safe64((v0 >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset()) * (arg2 - v1) >> 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_constants::scale_offset());
    ...
    public(friend) fun sub_bin_liquidity(arg0: &mut PositionInfo, arg1: u32, arg2: u256) {
        ...
        assert!(v0 >= arg2, 9223372642445164543);
        0x2::table::add<u32, u256>(&mut arg0.bin_liquidity, arg1, v0 - arg2);
    }
    ...
    public(friend) fun sub_bin_shares(arg0: &mut PositionInfo, arg1: u32, arg2: u64) {
        ...
        assert!(v0 >= arg2, 9223372724049543167);
        0x2::table::add<u32, u64>(&mut arg0.bin_shares, arg1, v0 - arg2);
    }
