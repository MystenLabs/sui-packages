module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    fun charge_fee<T0>(arg0: &mut FeePool, arg1: &mut 0x2::balance::Balance<T0>) {
        let v0 = (((0x2::balance::value<T0>(arg1) as u128) * 10 / 100) as u64);
        if (v0 == 0) {
            return
        };
        let v1 = 0x2::balance::split<T0>(arg1, v0);
        let v2 = 0;
        while (v2 < 0x1::vector::length<FeeInfo>(&arg0.fee_infos)) {
            let v3 = 0x1::vector::borrow_mut<FeeInfo>(&mut arg0.fee_infos, v2);
            if (v3.token == 0x1::type_name::get<T0>()) {
                v3.value = v3.value + 0x2::balance::value<T0>(&v1);
                0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::type_name::get<T0>()), v1);
                return
            };
            v2 = v2 + 1;
        };
        ...
        0x1::vector::push_back<FeeInfo>(&mut arg0.fee_infos, v4);
        0x2::dynamic_field::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::type_name::get<T0>(), v1);
    }
    ...
    entry fun redeem<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        version_check(arg0);
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = &mut arg0.deposit_vault_registry.id;
        let v2 = get_mut_deposit_vault<T0>(v1, arg1);
        let v3 = &mut arg0.bid_vault_registry.id;
        let (v4, v5, v6) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::redeem<ManagerCap, T0, T1>(&mut arg0.deposit_vault_registry.user_share_registry, v2, &mut arg0.bid_vault_registry.user_share_registry, get_mut_bid_vault<T1>(v3, arg1), arg2);
        let v7 = v5;
        let v8 = v4;
        let v9 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, FeePool>(&mut arg0.id, b"fee_pool");
        if (0x2::balance::value<T0>(&v8) != 0) {
            let v10 = &mut v8;
            charge_fee<T0>(v9, v10);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v8, arg2), v0);
        } else {
            0x2::balance::destroy_zero<T0>(v8);
        };
        if (0x2::balance::value<T1>(&v7) != 0) {
            let v11 = &mut v7;
            charge_fee<T1>(v9, v11);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(v7, arg2), v0);
        } else {
            0x2::balance::destroy_zero<T1>(v7);
        };
        let v12 = RedeemEvent{
            index   : arg1,
            d_token : 0x1::type_name::get<T0>(),
            b_token : 0x1::type_name::get<T1>(),
            log     : v6,
        };
    ...
    entry fun send_fee<T0>(arg0: &mut Registry, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 0x1::vector::length<FeeInfo>(&v0.fee_infos)) {
            ...
            if (v2.token == 0x1::type_name::get<T0>()) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::type_name::get<T0>())), arg1), @0xb90d6bddf3df46fc5590d412d062c00145dfae1d31446c0f206c61edf02ef5ba);
                let v3 = SendFeeEvent{
                    token  : 0x1::type_name::get<T0>(),
                    amount : v2.value,
                };
    ...
    entry fun set_fee_pool(arg0: &mut Registry, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = FeePool{
            id        : 0x2::object::new(arg1),
            fee_infos : 0x1::vector::empty<FeeInfo>(),
        };
        0x2::dynamic_object_field::add<vector<u8>, FeePool>(&mut arg0.id, b"fee_pool", v0);
    }

    entry fun upgrade_registry(arg0: &mut Registry) {
        assert!(400 > arg0.version, 1000);
        arg0.version = 400;
    }
