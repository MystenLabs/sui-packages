module 0xb3a16dfc733ecae37766b0b0e9839f64ff636215b76e4236fed4b429d03b46a1::dogesui {
    ...
    fun init(arg0: DOGESUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DOGESUI>(arg0, 4, b"DOGESUI", b"Dogesui", b"The first Meme Coin on Sui Blockchain. Telegram : t.me/Dogecoinsui , Twitter : https://twitter.com/Dogecoinsui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = 0x2::coin::treasury_into_supply<DOGESUI>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<DOGESUI>>(0x2::coin::from_balance<DOGESUI>(0x2::balance::increase_supply<DOGESUI>(&mut v2, 10000000000000000), arg1), 0x2::tx_context::sender(arg1));
