module 0xb35e5dbd190d62ce46adb4065947a2c2be28b530ca90d9311f2f6f7a0b2e11ce::pumpkin_voucherv3 {
    ...
    struct PUMPKIN_VOUCHERV3 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PUMPKIN_VOUCHERV3, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = MinterCap{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<MinterCap>(v0, 0x2::tx_context::sender(arg1));
        let v1 = 0x2::package::claim<PUMPKIN_VOUCHERV3>(arg0, arg1);
