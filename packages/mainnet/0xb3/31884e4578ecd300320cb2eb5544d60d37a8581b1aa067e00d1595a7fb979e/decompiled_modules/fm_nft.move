module 0xb331884e4578ecd300320cb2eb5544d60d37a8581b1aa067e00d1595a7fb979e::fm_nft {
    ...
    public fun mint(arg0: &mut MintCap, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<FMNFT>(v3, 0x2::tx_context::sender(arg6));
    }
