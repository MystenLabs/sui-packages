module 0xb39641f65cb11fe12f0c301163cde12ab7742862eaa59332e5f4ad1a10b79cd3::robo_sui {
    ...
    fun init(arg0: ROBO_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Mint your Robo Sui to support maitreyn financially. Created for community and fun."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeig2tdcl5nfj76piwcdb5kyh7odpt5tsbzhzszwglmirfpw3us4c4a"));
