module 0xb3aa4adfcf18c41ef45cac50ae442190b8c762a46e5c78053ec88447d46ac297::gift3141 {
    struct GIFT3141 has drop {
        dummy_field: bool,
    }

    struct TICKET_3141 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3141(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3141>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3141>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3141, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3141>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3141>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3141>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3141>>(v5, 0x2::tx_context::sender(arg1));
    }
