module 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market {
    ...
    public entry fun adjust_price<T0: store + key, T1>(arg0: &mut Marketplace<T1>, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2.seller == 0x2::tx_context::sender(arg3), 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::err_code::not_auth_operator());
        v2.price = arg2;
        0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market_event::item_adjust_price_event(0x2::object::id<Collection<T0, T1>>(v1), arg1, 0x2::tx_context::sender(arg3), v0, 0x1::type_name::into_string(0x1::type_name::get<T1>()), arg2);
    }
    ...
    public fun buy_script<T0: store + key, T1>(arg0: &mut Marketplace<T1>, arg1: &mut RoyaltyCollection, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v5 = v2;
        assert!(0x2::coin::value<T1>(arg3) >= v3, 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::err_code::err_input_amount());
        ...
        let v10 = v3 - v6 - v7;
        assert!(v10 > 0, 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::err_code::err_amount_is_zero());
        0x2::pay::split_and_transfer<T1>(arg3, v10, v4, arg4);
        0x2::coin::join<T1>(&mut arg0.balance, 0x2::coin::split<T1>(arg3, v6, arg4));
        0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market_event::item_buy_event(0x2::object::id<Collection<T0, T1>>(v1), arg2, v4, 0x2::tx_context::sender(arg4), v0, 0x1::type_name::into_string(0x1::type_name::get<T1>()), v3);
    ...
    public entry fun collect_profit_collection<T0: store + key, T1>(arg0: &mut RoyaltyCollection, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::tx_context::sender(arg2) == v1.beneficiary, 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::err_code::not_auth_operator());
        ...
        0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market_event::collection_withdrawal(0x2::object::id<RoyaltyCollection>(arg0), 0x2::tx_context::sender(arg2), arg1, v0, 0x1::type_name::into_string(0x1::type_name::get<T1>()), v2);
    }
    ...
    public entry fun createMarket<T0>(arg0: &0x2::package::Publisher, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market_event::market_created_event(0x2::object::id<Marketplace<0x2::sui::SUI>>(&v0), 0x2::object::id<RoyaltyCollection>(&v1), 0x2::tx_context::sender(arg2));
    ...
    public fun delist<T0: store + key, T1>(arg0: &mut Marketplace<T1>, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v6 = v3;
        assert!(0x2::tx_context::sender(arg2) == v5, 0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::err_code::not_auth_operator());
        0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market_event::item_delisted_event(0x2::object::id<Collection<T0, T1>>(v1), arg1, 0x2::object::id<Listing>(&v2), 0x2::tx_context::sender(arg2), v0, 0x1::type_name::into_string(0x1::type_name::get<T1>()), v4);
    ...
    fun init(arg0: MARKET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market_event::market_created_event(0x2::object::id<Marketplace<0x2::sui::SUI>>(&v0), 0x2::object::id<RoyaltyCollection>(&v1), 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<Marketplace<0x2::sui::SUI>>(v0);
        0x2::transfer::share_object<RoyaltyCollection>(v1);
    ...
    public entry fun list<T0: store + key, T1>(arg0: &mut Marketplace<T1>, arg1: T0, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x9fd90ae353953fb1215e4bf70e0399042bdd5f4540abb9e61ca464cf17e6c93f::market_event::item_list_event(0x2::object::id<Collection<T0, T1>>(v5), v0, 0x2::object::id<Listing>(&v1), 0x2::tx_context::sender(arg3), arg2, v2, 0x1::type_name::into_string(0x1::type_name::get<T1>()), v3);
    }
