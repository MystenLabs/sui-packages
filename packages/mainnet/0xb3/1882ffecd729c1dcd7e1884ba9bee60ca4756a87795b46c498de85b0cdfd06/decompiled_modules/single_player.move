module 0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::single_player {
    ...
    public fun start_single_player_game2(arg0: &mut 0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::find_four_game::GamesTracker, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::find_four_game::initialize_game(0x2::tx_context::sender(arg1), @0x66696e64342e696f, 1, arg1);
        0xd9fc80a30c89489764bc07f557dc17162a477d34a9b44e65aae48af8ead006e7::find_four_game::addGameToTracker(0x2::tx_context::sender(arg1), v0, arg0);
        let v1 = SinglePlayerGameStartedEvent{
            game : v0,
            p1   : 0x2::tx_context::sender(arg1),
        };
