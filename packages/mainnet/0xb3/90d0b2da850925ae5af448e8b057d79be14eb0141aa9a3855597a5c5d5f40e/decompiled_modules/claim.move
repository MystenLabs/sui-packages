module 0xb390d0b2da850925ae5af448e8b057d79be14eb0141aa9a3855597a5c5d5f40e::claim {
    ...
    struct Claim<phantom T0> has store, key {
        ...
        start_time: u64,
        end_time: u64,
        balance: 0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::NonTransferCoin<T0>,
    ...
    public entry fun claim<T0>(arg0: &mut Claim<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<address>(&arg0.claim_members, v0)) {
            ...
            assert!(*v2 > *v3, 1002);
            *v3 = *v2;
            0x2::transfer::public_transfer<0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::NonTransferCoin<T0>>(0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::split<T0>(&mut arg0.balance, v0, *v2 - *v3, arg2), v0);
            let v4 = ClaimEvent{
                address : v0,
                amount  : *v2 - *v3,
            };
            ...
            0x2::transfer::public_transfer<0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::NonTransferCoin<T0>>(0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::split<T0>(&mut arg0.balance, v0, *v5, arg2), v0);
            let v6 = ClaimEvent{
                address : v0,
                amount  : *v5,
            };
    ...
    public entry fun create_claim<T0>(arg0: 0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::NonTransferCoin<T0>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Claim<T0>{
    ...
    public entry fun emergency_depost<T0>(arg0: &mut Claim<T0>, arg1: &ManageCap<T0>, arg2: 0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::NonTransferCoin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<Claim<T0>>(arg0) == arg1.claim_id, 1000);
        0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::join<T0>(&mut arg0.balance, arg2);
    }
    ...
    public entry fun emergency_withdraw<T0>(arg0: &mut Claim<T0>, arg1: &ManageCap<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::object::id<Claim<T0>>(arg0) == arg1.claim_id, 1000);
        0x2::transfer::public_transfer<0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::NonTransferCoin<T0>>(0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::split<T0>(&mut arg0.balance, 0x2::tx_context::sender(arg2), 0xe396f5271ce6a2f9ac54dbefea06850c7f94fdf915be1c60c9700ae69c657a26::nonTransferCoin::value<T0>(&arg0.balance), arg2), 0x2::tx_context::sender(arg2));
    }
