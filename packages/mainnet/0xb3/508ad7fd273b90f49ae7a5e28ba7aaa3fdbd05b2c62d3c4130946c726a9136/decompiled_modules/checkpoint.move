module 0xb3508ad7fd273b90f49ae7a5e28ba7aaa3fdbd05b2c62d3c4130946c726a9136::checkpoint {
    ...
    public(friend) fun load_next<T0, T1>(arg0: &mut Payload<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0.next;
        add<0x2::coin::Coin<T0>>(v0, 0x2::coin::split<T0>(&mut arg0.coin_start, arg1, arg2));
    }

    public(friend) fun place_next<T0, T1, T2, T3>(arg0: &mut Payload<T0, T1>, arg1: 0x2::coin::Coin<T3>) {
        let v0 = &mut arg0.next;
        0x2::coin::destroy_zero<T2>(remove<0x2::coin::Coin<T2>>(v0));
        let v1 = &mut arg0.next;
        add<0x2::coin::Coin<T3>>(v1, arg1);
    }

    public(friend) fun return_next<T0, T1>(arg0: &mut Payload<T0, T1>) {
        let v0 = &mut arg0.next;
