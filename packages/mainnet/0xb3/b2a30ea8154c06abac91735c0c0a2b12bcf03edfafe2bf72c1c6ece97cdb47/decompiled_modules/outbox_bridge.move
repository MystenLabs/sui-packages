module 0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::outbox_bridge {
    ...
    fun assert_bridge_version(arg0: &OutboxBridge) {
        assert!(arg0.package_version == 2, 12);
    }
    ...
    fun create_merkle_update_message_hash(arg0: u64, arg1: vector<u8>) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::utils::u64_to_be_bytes(arg0));
    ...
    fun create_outbox_proof_hash(arg0: vector<u8>, arg1: vector<u8>, arg2: u64) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v1, 0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::utils::u64_to_be_bytes(arg2));
    ...
    fun verify_receive_signature(arg0: vector<u8>, arg1: vector<u8>, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: vector<u8>) {
        assert!(0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::merkle::verify_merkle_aggregation(arg2, arg4, arg3, arg1), 7);
        let (v0, _) = 0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::bn254::hash_to_g1(arg0);
        assert!(0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::bn254::verify(arg5, arg4, v0), 8);
    }
    ...
    fun verify_update_signature(arg0: u64, arg1: vector<u8>, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>) {
        assert!(0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::merkle::verify_merkle_aggregation(arg2, arg4, arg3, arg6), 7);
        let (v0, _) = 0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::bn254::hash_to_g1(create_merkle_update_message_hash(arg0, arg1));
        assert!(0xe26ebb010bbce66dfb657993ed8b5a87cc5905ccf07fb146f60730195a79ca80::bn254::verify(arg5, arg4, v0), 8);
    }
