module 0xb355bf0160f6f6ce8adba2e4db00acd1dc7f96294a13584f39a5609b523d84e2::babyaxol {
    ...
    fun init(arg0: BABYAXOL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BABYAXOL>(arg0, 9, b"AXOL", b"Baby Axol", b"Baby Axol a protege of the major Axol, making splashes gives the chance after missing the major Axol fair launch,SAFU no team allocation coins.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1840528169536991232/pMMnEviu_400x400.jpg")), arg1);
        let v2 = v0;
