module 0xb3ebf51f99c115a487e957cc343b00a2d4f659fdf2a4b1b66388ec7b842dfbbc::cnsnft9749 {
    struct CNSNFT9749 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9749, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9828"));
        let v4 = 0x2::package::claim<CNSNFT9749>(arg0, arg1);
