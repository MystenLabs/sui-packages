module 0xb3e90f2dfcd44a6dcabe0eb7ae107870976d17283618cb233d4dd88e23d30c05::truth {
    ...
    fun init(arg0: TRUTH, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/FBnKUSCNTWs2e1ENpuWo3mHiuBx6tyU2AhZ1y9aZpump.png?size=lg&key=fb5f43                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRUTH>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Truth   ")))), trim_right(b"Proverbs 23:23                  "), trim_right(b"Proverbs 23:23  Buy the $Truth and do not sell it wisdom, instruction and insight as well.                                                                                                                                                                                                                                      "), v2, arg1);
        let v5 = v3;
