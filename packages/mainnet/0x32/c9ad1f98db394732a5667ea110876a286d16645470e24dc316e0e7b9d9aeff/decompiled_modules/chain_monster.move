module 0x32c9ad1f98db394732a5667ea110876a286d16645470e24dc316e0e7b9d9aeff::chain_monster {
    ...
    fun init(arg0: CHAIN_MONSTER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CHAIN_MONSTER>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Chain Monster"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A collection of Monster Hackers in the Chain"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeias26bhtifvc2gkcslyztrjh2j6stiojhjckg6y2gntdnalfqszee"));
