module 0x320573c79238246e8d61c0e2e454ebdf3672fbaa3ee41dfaf9444d26824cac96::nubdog {
    ...
    fun init(arg0: NUBDOG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<NUBDOG>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<NUBDOG>>(v4);
    }
