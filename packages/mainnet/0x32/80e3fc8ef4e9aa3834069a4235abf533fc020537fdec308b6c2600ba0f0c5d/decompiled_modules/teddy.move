module 0x3280e3fc8ef4e9aa3834069a4235abf533fc020537fdec308b6c2600ba0f0c5d::teddy {
    ...
    fun init(arg0: TEDDY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<TEDDY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TEDDY   ")))), trim_right(b"Drunk Teddy                     "), trim_right(b"Teddy is a cute bear with some anger issues and a drinking problem. Hes lucky his coin is making lots of money or no one would put up with him                                                                                                                                                                                  "), v2, arg1);
