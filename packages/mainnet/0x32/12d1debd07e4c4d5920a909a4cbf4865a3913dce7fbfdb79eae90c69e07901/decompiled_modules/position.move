module 0x3212d1debd07e4c4d5920a909a4cbf4865a3913dce7fbfdb79eae90c69e07901::position {
    ...
    fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 606);
    ...
    public fun fetch_positions(arg0: &PositionManager, arg1: vector<0x2::object::ID>, arg2: u64) : vector<PositionInfo> {
        ...
        let v1 = if (0x1::vector::is_empty<0x2::object::ID>(&arg1)) {
            ...
            assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, v2), 606);
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: vector<u128>) : u128 {
        ...
        update_points_internal(v0, arg5);
        update_rewards_internal(v0, arg6);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::add_check(v0.liquidity, arg2), 608);
        v0.liquidity = v0.liquidity + arg2;
        arg1.liquidity = v0.liquidity;
        v0.liquidity
    }
    ...
    fun new_position_name(arg0: u64, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x3212d1debd07e4c4d5920a909a4cbf4865a3913dce7fbfdb79eae90c69e07901::utils::str(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0x3212d1debd07e4c4d5920a909a4cbf4865a3913dce7fbfdb79eae90c69e07901::utils::str(arg1));
        v0
    }
    ...
    public fun set_display(arg0: &0x3212d1debd07e4c4d5920a909a4cbf4865a3913dce7fbfdb79eae90c69e07901::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun update_fee_internal(arg0: &mut PositionInfo, arg1: u128, arg2: u128) {
        ...
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(arg0.fee_owned_a, v0), 601);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(arg0.fee_owned_b, v1), 601);
    ...
    fun update_points_internal(arg0: &mut PositionInfo, arg1: u128) {
        ...
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::add_check(arg0.points_owned, v0), 603);
        ...
        if (v0 > 0) {
            ...
            while (v1 < v0) {
                ...
                if (0x1::vector::length<PositionReward>(&arg0.rewards) > v1) {
                    ...
                    assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(v3.amount_owned, v4), 602);
                    v3.growth_inside = v2;
