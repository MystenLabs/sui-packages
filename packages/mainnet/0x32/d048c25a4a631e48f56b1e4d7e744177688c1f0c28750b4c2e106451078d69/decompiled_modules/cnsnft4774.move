module 0x32d048c25a4a631e48f56b1e4d7e744177688c1f0c28750b4c2e106451078d69::cnsnft4774 {
    struct CNSNFT4774 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4774, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4774>(arg0, arg1);
