    ...
    public fun verify(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>) : address {
        if (arg2 == b"Bluefin Pro Withdrawal") {
            ...
            let v1 = if (arg2 == b"Bluefin Pro Setting Funding Rate") {
                ...
                true
            } else if (arg2 == b"Bluefin Pro Liquidation") {
                true
            } else if (arg2 == b"Bluefin Pro TEE Asset Update") {
                true
            } else if (arg2 == b"Bluefin Pro TEE Position Update") {
                true
            } else if (arg2 == b"Bluefin Pro TEE User Authorized Accounts Update") {
                true
            } else {
                arg2 == b"Bluefin Pro TEE User Trade Fee Update"
            };
            assert!(v1, 2004);
