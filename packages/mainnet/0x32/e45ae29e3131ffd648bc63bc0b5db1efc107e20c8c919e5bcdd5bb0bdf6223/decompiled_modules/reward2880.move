module 0x32e45ae29e3131ffd648bc63bc0b5db1efc107e20c8c919e5bcdd5bb0bdf6223::reward2880 {
    struct REWARD2880 has drop {
        dummy_field: bool,
    }

    struct TICKET_2880 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2880(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2880>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2880>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2880, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2880>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2880>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2880>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2880>>(v5, 0x2::tx_context::sender(arg1));
    }
