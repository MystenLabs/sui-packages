module 0x3247b1cf39adc1886e188e1733fee278e3b95cd0486d81f62dd1176b6b07c41d::nft_sale {
    ...
    fun init(arg0: NFT_SALE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = Collection{
            ...
            base_url     : 0x1::string::utf8(b"ipfs://QmYmWsn1LekrcQ6oPe3rQwcyWvaznTdyQHJvRUzVx4ZFdS/"),
            total        : 500,
            current      : 0,
    ...
    public entry fun mint_nft(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: vector<u8>, arg3: &mut Collection, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        loop {
            ...
            0x1::string::append(&mut v6, 0x1::string::utf8(num_to_str(1)));
