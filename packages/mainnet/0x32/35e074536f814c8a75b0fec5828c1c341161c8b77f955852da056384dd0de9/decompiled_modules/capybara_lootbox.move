module 0x3235e074536f814c8a75b0fec5828c1c341161c8b77f955852da056384dd0de9::capybara_lootbox {
    ...
    fun init(arg0: CAPYBARA_LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://capybara_static.8gen.team/lootbox.png"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://capybara_static.8gen.team/lootbox_preview.png"));
    ...
    public fun update_storage(arg0: &0x3235e074536f814c8a75b0fec5828c1c341161c8b77f955852da056384dd0de9::capybara_game_card::AdminCap, arg1: vector<u8>, arg2: bool, arg3: &mut DataStorage, arg4: &mut 0x2::tx_context::TxContext) {
        arg3.pk = arg1;
