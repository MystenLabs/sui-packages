module 0x32f270fce2fa95847fab3804a42bf4b852a1ec26aa70068185f79e8a0b57eb87::cnsnft8725 {
    struct CNSNFT8725 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8725, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1398"));
        let v4 = 0x2::package::claim<CNSNFT8725>(arg0, arg1);
