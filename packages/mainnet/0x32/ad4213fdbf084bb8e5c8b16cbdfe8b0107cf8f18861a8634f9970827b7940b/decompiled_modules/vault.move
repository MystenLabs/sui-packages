module 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault {
    ...
    fun redeem_dual_token_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<0x1::ascii::String>, arg4: vector<u64>, arg5: vector<u64>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        ...
        let v24 = get_dynamic_field_or_default<T0, T1, u64>(arg1, b"hwm", (arg1.liquidity as u64));
        if (v24 >= v14) {
            set_dynamic_field<T0, T1, u64>(arg1, b"hwm", v24 - v14);
        } else {
            set_dynamic_field<T0, T1, u64>(arg1, b"hwm", 0);
        };
        arg1.pending_redemptions = arg1.pending_redemptions - (v13 as u128);
        let v25 = spend_withdraw_asset<T0, T1, T2>(arg1, v11, arg11);
        let v26 = spend_withdraw_asset<T0, T1, T3>(arg1, v12, arg11);
        let v27 = calculate_fee(v11, arg1.withdraw.fee_bps);
        let v28 = calculate_fee(v12, arg1.withdraw.fee_bps);
        arg1.withdraw.total_fee = arg1.withdraw.total_fee + calculate_fee(v14, arg1.withdraw.fee_bps);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v25, v27, arg11), arg1.fee_receiver);
        0x2::transfer::public_transfer<0x2::coin::Coin<T3>>(0x2::coin::split<T3>(&mut v26, v28, arg11), arg1.fee_receiver);
        let v29 = get_dynamic_field_or_default<T0, T1, u128>(arg1, b"total_withdraw", 0) + (v14 as u128);
        set_dynamic_field<T0, T1, u128>(arg1, b"total_withdraw", v29);
