module 0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::fee_voting_reward {
    ...
    public fun balance<T0>(arg0: &FeeVotingReward) : u64 {
        0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::reward::balance<T0>(&arg0.reward)
    }

    public fun borrow_reward(arg0: &FeeVotingReward) : &0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::reward::Reward {
        &arg0.reward
    }
    ...
    public(friend) fun create(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: vector<0x1::type_name::TypeName>, arg3: &mut 0x2::tx_context::TxContext) : FeeVotingReward {
        ...
        let (v1, v2) = 0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::reward::create(0x2::object::uid_to_inner(&v0), arg2, true, arg3);
        FeeVotingReward{
            id         : v0,
            gauge      : arg1,
            voter      : arg0,
    ...
    public fun deposit(arg0: &mut FeeVotingReward, arg1: &0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::voter_cap::VoterCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_reward<T0, T1>(arg0: &mut FeeVotingReward, arg1: &0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::voter_cap::VoterCap, arg2: &0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::voting_escrow::VotingEscrow<T0>, arg3: &0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::voting_escrow::Lock, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        validate_voter_cap(arg0, arg1);
    ...
    public fun notify_reward_amount<T0>(arg0: &mut FeeVotingReward, arg1: &0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::voter_cap::VoterCap, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        validate_voter_cap(arg0, arg1);
        assert!(0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::reward::rewards_contains(&arg0.reward, 0x1::type_name::get<T0>()), 9223372427696799743);
    ...
    public fun update_balances(arg0: &mut FeeVotingReward, arg1: &0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::voter_cap::VoterCap, arg2: vector<u64>, arg3: vector<0x2::object::ID>, arg4: u64, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        validate_voter_cap(arg0, arg1);
    ...
    public fun validate_voter_cap(arg0: &FeeVotingReward, arg1: &0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::voter_cap::VoterCap) {
        assert!(0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::voter_cap::get_voter_id(arg1) == arg0.voter, 785091986893168000);
    }

    public fun withdraw(arg0: &mut FeeVotingReward, arg1: &0x32fe1a93a598eef2af12732c7fec0d3bb19be96d95c170ed4b1c18a42e496777::voter_cap::VoterCap, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        validate_voter_cap(arg0, arg1);
