module 0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::marketplace {
    ...
    public fun collect_commissions(arg0: &mut MarketPlaceStore, arg1: &CollectorCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.available_sui), arg2, arg3);
    }
    ...
    fun get_ion_points(arg0: bool, arg1: bool, arg2: u64, arg3: u64, arg4: bool, arg5: u64, arg6: u64) : u64 {
        ...
        let v1 = if (arg0) {
            0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::helpers::calculate_listing_proximity_multiplier(arg5, arg6)
        } else {
            0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::helpers::calculate_bid_proximity_multiplier(arg5, arg6)
        };
        0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::helpers::calculate_ion_points(0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::helpers::integer_sqrt(arg5), v0, v1, 0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::helpers::calculate_time_multiplier(arg3, arg4))
    }
    ...
    public fun permissionless_add_collection<T0: store + key>(arg0: &mut MarketPlaceStore, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x320b1a11cc46fa88540e788d3f28521ec3efe1099432ba012fb459278cb1c315::helpers::destroy_or_transfer_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg2), arg2);
        0x2::linked_table::push_back<0x1::ascii::String, bool>(&mut arg0.active_collections, v0, true);
