module 0x32017b1e6dc418a66ee7b4ffd6eb3f5668529da0e178433d1bc3bacc84c56d5d::cnsnft5883 {
    struct CNSNFT5883 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5883, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7401"));
        let v4 = 0x2::package::claim<CNSNFT5883>(arg0, arg1);
