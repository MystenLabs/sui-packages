module 0x61952f894dd7c301a0b95aa7e456ff21a2927f49316b2a853ac35adbe2da1e49::sec2 {
    ...
    struct BurnStatsEvent has copy, drop {
        timestamp: u64,
        internal_pool: u64,
        boost_end_ts: u64,
        end_ts: u64,
    ...
    fun apply_burn(arg0: &mut BurnVault, arg1: &mut BurnAuthority, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!arg0.initialized) {
            ...
            let v1 = BurnStatsEvent{
                timestamp     : v0,
                internal_pool : 0x2::balance::value<SEC2>(&arg0.internal_pool),
                boost_end_ts  : arg0.boost_end_ts,
                end_ts        : arg0.end_ts,
                initialized   : arg0.initialized,
            };
            0x2::event::emit<BurnStatsEvent>(v1);
            return
        };
        if (v0 <= arg0.last_ts || arg0.last_ts >= arg0.end_ts) {
            return
        };
        let v2 = if (v0 > arg0.end_ts) {
            arg0.end_ts
        } else {
            v0
        };
        let v3 = if (arg0.last_ts < arg0.boost_end_ts && v2 <= arg0.boost_end_ts) {
            (v2 - arg0.last_ts) * arg0.boost_rate * 1000000000
        } else if (arg0.last_ts >= arg0.boost_end_ts) {
            (v2 - arg0.last_ts) * arg0.normal_rate * 1000000000
        } else {
            (arg0.boost_end_ts - arg0.last_ts) * arg0.boost_rate * 1000000000 + (v2 - arg0.boost_end_ts) * arg0.normal_rate * 1000000000
        };
        let v4 = 0x2::balance::value<SEC2>(&arg0.internal_pool);
        let v5 = if (v3 > v4) {
            v4
        } else {
            v3
        ...
        if (v5 > 0) {
            0x2::coin::burn<SEC2>(&mut arg1.cap, 0x2::coin::from_balance<SEC2>(0x2::balance::split<SEC2>(&mut arg0.internal_pool, v5), arg3));
        };
        arg0.last_ts = v2;
        let v6 = BurnStatsEvent{
            timestamp     : v2,
            internal_pool : 0x2::balance::value<SEC2>(&arg0.internal_pool),
            boost_end_ts  : arg0.boost_end_ts,
            end_ts        : arg0.end_ts,
        ...
        0x2::event::emit<BurnStatsEvent>(v6);
    }

    public fun get_burn_stats(arg0: &BurnVault) : (u64, u64, u64, u64, bool) {
        (0x2::balance::value<SEC2>(&arg0.internal_pool), arg0.last_ts, arg0.boost_end_ts, arg0.end_ts, arg0.initialized)
    }

    entry fun hook_before_swap(arg0: &mut BurnVault, arg1: &mut BurnAuthority, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        apply_burn(arg0, arg1, arg2, arg3);
    }
