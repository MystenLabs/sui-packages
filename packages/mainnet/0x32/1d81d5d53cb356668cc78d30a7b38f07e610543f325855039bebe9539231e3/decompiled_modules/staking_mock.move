module 0x321d81d5d53cb356668cc78d30a7b38f07e610543f325855039bebe9539231e3::staking_mock {
    struct Pool<phantom T0> has key {
        ...
        another_staking_without_fee: vector<address>,
        total_deposit: u64,
    }
    ...
    public fun add_pool_liquidity<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_pool<T0>(arg0: &Admin, arg1: address, arg2: u64, arg3: u64, arg4: u64, arg5: bool, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool<T0>{
            ...
            another_staking_without_fee : 0x1::vector::empty<address>(),
            total_deposit               : 0,
        };
        0x2::transfer::share_object<Pool<T0>>(v0);
    }

    public fun deposit<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit_all<T0>(arg0: &mut Pool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.stop_deposit, 0);
    ...
    public fun get_another_staking_without_fee<T0>(arg0: &Pool<T0>) : vector<address> {
    ...
    public fun migrate_to_another_staking<T0>() {
    }
    ...
    public fun set_another_staking_adresses<T0>(arg0: &Admin, arg1: &mut Pool<T0>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw<T0>(arg0: &mut Pool<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.pause, 1);
        let v0 = 0x2::tx_context::sender(arg2);
        ...
        let v2 = if (0x2::clock::timestamp_ms(arg1) < *0x2::table::borrow<address, u64>(&arg0.current_dates, v0) + arg0.lock_period) {
            let v3 = 1000;
            let v4 = v1 * (v3 - arg0.withdrawal_penalty) / v3;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.token, v1 - v4), arg2), arg0.addressFee);
            v4
        } else {
        ...
        *0x2::table::borrow_mut<address, u64>(&mut arg0.current_dates, v0) = 0;
        let v5 = WithdrawEvent{dummy_field: false};
    ...
    public fun withdraw_all_funds_and_bonus_for_users<T0>(arg0: &Admin, arg1: &mut Pool<T0>, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            ...
            assert!(v2 > 0, 6);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.token, v2 + v2 * arg1.bonus_amounts / 100), arg3), v1);
