module 0x32d8635f325578beb5cc4c3f36954bae8dbd3d1ce1f0c25abe8004e00a874f4c::reward1994 {
    struct REWARD1994 has drop {
        dummy_field: bool,
    }

    struct TICKET_1994 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1994(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1994>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1994>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1994, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1994>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1994>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1994>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1994>>(v5, 0x2::tx_context::sender(arg1));
    }
