module 0x32faca641f0e3cffdd8ebb1413e2c222435d6e49ff85796a2260155270ebce28::quiet_moment_by_ma {
    struct QUIET_MOMENT_BY_MA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: QUIET_MOMENT_BY_MA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<QUIET_MOMENT_BY_MA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Quiet Moment by ma"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeib5sxz666hpr3sjzbrmzhurqshh3voqcnytf6pey2f6uu4hwz74oa"));
