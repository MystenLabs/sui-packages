module 0x32346834a91c2b36ab2d5bc86e180b443b15c5a920e6cacba01f8c90d8d72da7::cnsnft7138 {
    struct CNSNFT7138 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7138, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4575"));
        let v4 = 0x2::package::claim<CNSNFT7138>(arg0, arg1);
