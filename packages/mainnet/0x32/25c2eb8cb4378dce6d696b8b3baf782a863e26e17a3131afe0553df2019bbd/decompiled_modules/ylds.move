module 0x3225c2eb8cb4378dce6d696b8b3baf782a863e26e17a3131afe0553df2019bbd::ylds {
    struct YLDS has drop {
        dummy_field: bool,
    }

    fun init(arg0: YLDS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/9QsPOep82n8GCj8RZ5iI79CVa7O6BvZJsiWuxX1QRho";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/9QsPOep82n8GCj8RZ5iI79CVa7O6BvZJsiWuxX1QRho"))
        };
