module 0x3268b032c5c893eabc3496987e1ea38f85311c66da112a699a15fa4a6fb8f22c::blackbook {
    ...
    fun init(arg0: BLACKBOOK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://www.blackbook.com/"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Blackbook"));
