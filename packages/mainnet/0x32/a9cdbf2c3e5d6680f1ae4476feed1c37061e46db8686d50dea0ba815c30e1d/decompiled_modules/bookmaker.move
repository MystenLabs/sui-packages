module 0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::bookmaker {
    struct Markets has store, key {
        ...
        balance: 0x2::balance::Balance<0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::wsd::WSD>,
    }
    ...
    public entry fun add_liquidity(arg0: &mut Markets, arg1: 0x2::coin::Coin<0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::wsd::WSD>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::balance::join<0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::wsd::WSD>(&mut arg0.balance, 0x2::coin::into_balance<0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::wsd::WSD>(arg1));
    }
    ...
    public entry fun claim_win(arg0: Bet, arg1: 0x1::string::String, arg2: &mut Markets, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::wsd::WSD>>(0x2::coin::take<0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::wsd::WSD>(&mut arg2.balance, ((arg0.amount + arg0.payout) as u64), arg3), 0x2::tx_context::sender(arg3));
        let Bet {
            id     : v1,
            result : _,
            amount : _,
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Markets{
            ...
            balance        : 0x2::balance::zero<0x32a9cdbf2c3e5d6680f1ae4476feed1c37061e46db8686d50dea0ba815c30e1d::wsd::WSD>(),
        };
        0x2::transfer::share_object<Markets>(v0);
    }

    public entry fun make_bet(arg0: u8, arg1: u64, arg2: 0x1::string::String, arg3: &mut Markets, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 == 0 || arg0 == 1, 5);
        let v0 = get_market(arg2, arg3);
        let v1 = v0.lp.a;
        let v2 = v0.lp.a;
        let v3 = v0.lp.k;
        let v4 = if (arg0 == 0) {
        ...
        0x2::transfer::public_transfer<Bet>(v5, 0x2::tx_context::sender(arg5));
    }
