module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single {
    ...
    public(friend) fun activate_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let (v16, v17, v18) = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000);
        0x1::string::append_utf8(&mut v15, b"-");
        0x1::string::append_utf8(&mut v15, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v18));
        0x1::string::append_utf8(&mut v15, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_month_short_string(v17));
        0x1::string::append_utf8(&mut v15, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_pad_2_number_string(v16));
        0x1::vector::reverse<u64>(&mut v7);
        while (!0x1::vector::is_empty<u64>(&v7)) {
            0x1::string::append_utf8(&mut v15, b"-");
            0x1::string::append_utf8(&mut v15, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v7), v5));
        };
        if (v1.info.option_type == 0) {
            ...
            0x1::string::append_utf8(&mut v15, b"-CallButterfly");
        } else if (v1.info.option_type == 5) {
            0x1::string::append_utf8(&mut v15, b"-PutButterfly");
        };
        0x2::dynamic_object_field::add<u64, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::BidVault>(&mut arg0.bid_vault_registry, arg1, 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::new_bid_vault<T0, T1>(v1.info.index, v15, arg4));
    ...
    public(friend) fun delivery_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, u64) {
        ...
        let v20 = if (v1.config.deposit_incentive_bp > 0 && 0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.id, 0x1::type_name::get<T1>())) {
            ...
            let v23 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::get_u64_padding_value(&v1.config.u64_padding, 0);
            let v24 = if (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::match_types<T0, T1>()) {
                ((((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_balance<T0>(v3) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_balance<T0>(v3)) as u128) * (v13 as u128) / (v1.info.delivery_infos.max_size as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64)
            } else if (v1.info.option_type % 2 == 0) {
                (((((((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_balance<T0>(v3) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_balance<T0>(v3)) as u128) * (v13 as u128) / (v1.info.delivery_infos.max_size as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64) as u128) * (v1.info.oracle_info.price as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v1.info.oracle_info.decimal) as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            } else {
                (((((((0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::active_balance<T0>(v3) + 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::deactivating_balance<T0>(v3)) as u128) * (v13 as u128) / (v1.info.delivery_infos.max_size as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64) as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v1.info.oracle_info.decimal) as u128) / (v1.info.oracle_info.price as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            };
            let v25 = if (v24 > v22) {
                if (v22 > v23) {
            ...
            let v26 = v25;
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, v23 - 0x2::balance::value<T1>(&v26));
            v26
        } else {
            0x2::balance::zero<T1>()
        };
        let v27 = v20;
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::delivery_b<T0, T1>(v3, v5, v10, v27, arg4);
    ...
    public(friend) fun emit_compound_event(arg0: &PortfolioVault, arg1: u64, arg2: &0x2::tx_context::TxContext) {
    ...
    public(friend) fun emit_exercise_event(arg0: &PortfolioVault, arg1: u64, arg2: 0x1::option::Option<0x1::type_name::TypeName>, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        let v0 = ExerciseEvent{
            signer           : 0x2::tx_context::sender(arg4),
            index            : arg0.info.index,
            token            : arg0.info.deposit_token,
            amount           : arg1,
            decimal          : arg0.info.d_token_decimal,
            incentive_token  : arg2,
            incentive_amount : arg3,
            u64_padding      : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<ExerciseEvent>(v0);
    }

    public(friend) fun emit_harvest_event(arg0: &PortfolioVault, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        let v0 = HarvestEvent{
    ...
    public(friend) fun new_portfolio_vault_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: bool, arg26: vector<PayoffConfig>, arg27: u64, arg28: u64, arg29: u64, arg30: u64, arg31: vector<address>, arg32: &0x2::clock::Clock, arg33: &mut 0x2::tx_context::TxContext) : (u64, Info, Config) {
        ...
        if (arg1 == 0) {
            ...
            0x1::string::append_utf8(&mut v14, b"-CallButterfly");
        } else if (arg1 == 5) {
            0x1::string::append_utf8(&mut v14, b"-PutButterfly");
        };
    ...
    public(friend) fun new_registry_(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Registry{
            ...
            fee_pool                   : 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::new(0x1::vector::singleton<address>(@0x978f65df8570a075298598a9965c18de9087f9e888eb3430fe20334f5c554cfd), arg0),
