module 0x322d24023c6ffd95f2096b6d3a27532ba263628a8c75f2df886bf9c02f1b0f9b::reward8170 {
    struct REWARD8170 has drop {
        dummy_field: bool,
    }

    struct TICKET_8170 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8170(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8170>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8170>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8170, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8170>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8170>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8170>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8170>>(v5, 0x2::tx_context::sender(arg1));
    }
