module 0x85414a4d2a076f209b1eaddb1d3143832acc478601dfe3ecbc40bd7dfea6e000::project {
    ...
    struct ProjectCreatorCap has store, key {
        id: 0x2::object::UID,
        max_projects: u64,
    ...
    struct CreatorCapGrantedEvent has copy, drop {
    ...
    struct CreatorCapRevokedEvent has copy, drop {
        cap_id: 0x2::object::ID,
        timestamp: u64,
    }
    ...
    public fun create_project_as_creator<T0>(arg0: &mut ProjectCreatorCap, arg1: &mut 0x85414a4d2a076f209b1eaddb1d3143832acc478601dfe3ecbc40bd7dfea6e000::platform::DonationPlatform, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        if (arg0.max_projects > 0) {
            assert!(arg0.projects_created < arg0.max_projects, 2);
        };
        arg0.projects_created = arg0.projects_created + 1;
        let v0 = 0x2::object::new(arg6);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = 0x2::tx_context::sender(arg6);
        let v3 = 0x2::tx_context::epoch_timestamp_ms(arg6);
    ...
    public fun get_creator_cap_info(arg0: &ProjectCreatorCap) : (u64, u64) {
        (arg0.max_projects, arg0.projects_created)
    }
    ...
    public fun grant_creator_cap(arg0: &0x85414a4d2a076f209b1eaddb1d3143832acc478601dfe3ecbc40bd7dfea6e000::platform::PlatformAdminCap, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::new(arg3);
        let v1 = ProjectCreatorCap{
            id               : v0,
            max_projects     : arg1,
            projects_created : 0,
        };
        let v2 = CreatorCapGrantedEvent{
            cap_id       : 0x2::object::uid_to_inner(&v0),
            recipient    : arg2,
            max_projects : arg1,
            timestamp    : 0x2::tx_context::epoch_timestamp_ms(arg3),
        };
        0x2::event::emit<CreatorCapGrantedEvent>(v2);
        0x2::transfer::transfer<ProjectCreatorCap>(v1, arg2);
    }
    ...
    public fun revoke_creator_cap(arg0: &0x85414a4d2a076f209b1eaddb1d3143832acc478601dfe3ecbc40bd7dfea6e000::platform::PlatformAdminCap, arg1: ProjectCreatorCap, arg2: &0x2::tx_context::TxContext) {
        let v0 = CreatorCapRevokedEvent{
            cap_id    : 0x2::object::id<ProjectCreatorCap>(&arg1),
            timestamp : 0x2::tx_context::epoch_timestamp_ms(arg2),
        };
        0x2::event::emit<CreatorCapRevokedEvent>(v0);
        let ProjectCreatorCap {
            id               : v1,
            max_projects     : _,
            projects_created : _,
        } = arg1;
    ...
    public fun update_project_metadata<T0>(arg0: &ProjectCap, arg1: &mut Project<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>) {
        assert!(arg0.project_id == 0x2::object::id<Project<T0>>(arg1), 0);
        arg1.metadata.title = arg2;
        arg1.metadata.description = arg3;
        arg1.metadata.category = arg4;
        arg1.metadata.cover_image_url = arg5;
    }
