module 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket {
    ...
    public(friend) fun mint_ticket_and_emit(arg0: 0x2::object::ID, arg1: &0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::metadata::Metadata, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Ticket {
        let (v0, v1, _, _, _, _, _, _, _, _) = 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::metadata::get_metadata_props(arg1);
        let v10 = Ticket{
