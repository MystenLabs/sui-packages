module 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::launchpad {
    ...
    public entry fun redeem<T0>(arg0: &mut Launchpad<T0>, arg1: 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg2) >= 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::get_unlock_time(&arg1), 1002);
        assert!(0x2::object::id<Launchpad<T0>>(arg0) == 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::get_launchpad_id(&arg1), 1005);
        let v0 = 0x2::balance::withdraw_all<T0>(&mut 0x2::table::borrow_mut<0x2::object::ID, Record<T0>>(&mut 0x2::table::borrow_mut<address, TicketRecord<T0>>(&mut arg0.tracked_addresses, 0x2::tx_context::sender(arg3)).records, 0x2::object::id<0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket>(&arg1)).balance);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0x2::tx_context::sender(arg3));
        0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::burn_ticket_and_emit(arg1, arg3);
    ...
    public entry fun redeem_with_lock_duration<T0>(arg0: &mut Launchpad<T0>, arg1: 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg5) < 1737046799000, 1006);
        assert!(0x2::object::id<Launchpad<T0>>(arg0) == 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::get_launchpad_id(&arg1), 1005);
        verify_signature(0x2::tx_context::sender(arg6), 0x2::object::id<0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket>(&arg1), arg2, arg3, arg4);
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, Record<T0>>(&mut 0x2::table::borrow_mut<address, TicketRecord<T0>>(&mut arg0.tracked_addresses, 0x2::tx_context::sender(arg6)).records, 0x2::object::id<0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket>(&arg1));
        ...
        0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::burn_ticket_and_emit(arg1, arg6);
    ...
    public fun set_diamond_list<T0>(arg0: &AdminCap, arg1: &mut Launchpad<T0>, arg2: &0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::metadata::Metadata, arg3: vector<address>, arg4: &mut 0x2::tx_context::TxContext) {
        let (_, _, _, _, v4, _, _, _, _, _) = 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::metadata::get_metadata_props(arg2);
        let v10 = 0;
    ...
    public entry fun unstake<T0>(arg0: &mut Launchpad<T0>, arg1: &0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::metadata::Metadata, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, _, v6, v7, v8, v9, v10, v11, v12, v13) = 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::metadata::get_metadata_props(arg1);
        ...
        let v16 = 0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::mint_ticket_and_emit(v15, arg1, arg2, v14, arg4);
        let v17 = Record<T0>{
            launchpad_id : v15,
            ticket_id    : 0x2::object::id<0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket>(&v16),
            sender       : v0,
            balance      : v3,
        ...
        if (!0x2::table::contains<address, TicketRecord<T0>>(&arg0.tracked_addresses, v0)) {
            ...
            0x2::table::add<0x2::object::ID, Record<T0>>(&mut v18, 0x2::object::id<0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket>(&v16), v17);
            let v19 = TicketRecord<T0>{records: v18};
            0x2::table::add<address, TicketRecord<T0>>(&mut arg0.tracked_addresses, v0, v19);
        } else {
            0x2::table::add<0x2::object::ID, Record<T0>>(&mut 0x2::table::borrow_mut<address, TicketRecord<T0>>(&mut arg0.tracked_addresses, 0x2::tx_context::sender(arg4)).records, 0x2::object::id<0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::Ticket>(&v16), v17);
        };
        0x3287b47708c762359353b46bc5df077486d7d0bffcf8f535c339d202b70296d5::ticket::transfer(v16, v0);
