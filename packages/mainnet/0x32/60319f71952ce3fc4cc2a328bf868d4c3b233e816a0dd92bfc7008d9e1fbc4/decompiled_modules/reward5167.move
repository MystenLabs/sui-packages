module 0x3260319f71952ce3fc4cc2a328bf868d4c3b233e816a0dd92bfc7008d9e1fbc4::reward5167 {
    struct REWARD5167 has drop {
        dummy_field: bool,
    }

    struct TICKET_5167 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5167(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5167>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5167>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5167, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5167>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5167>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5167>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5167>>(v5, 0x2::tx_context::sender(arg1));
    }
