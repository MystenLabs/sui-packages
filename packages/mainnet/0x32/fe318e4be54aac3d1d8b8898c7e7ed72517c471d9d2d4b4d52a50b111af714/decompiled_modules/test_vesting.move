module 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting {
    ...
    public entry fun available_amount(arg0: &mut 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::Category, arg1: &StartVesting, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &UpgradeVersion, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg4.version == 0, 8);
        let v0 = 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::locker(arg0, arg2);
    ...
    public entry fun change_owner(arg0: Owner, arg1: 0x2::package::UpgradeCap, arg2: VestedTokens, arg3: 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::Category, arg4: StartVesting, arg5: address, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::Category>(arg3, arg5);
    ...
    fun get_available_amount(arg0: &mut 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::Locker, arg1: &StartVesting, arg2: &0x2::clock::Clock) : (u64, u64, u64) {
        assert!(arg1.vesting_started == true, 7);
        let v0 = time_in_months(time_in_secs(arg2) - arg1.start_time);
        let v1 = 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::scheme(arg0);
        let v2 = 0x1::vector::length<u64>(&v1);
        let v3 = 0;
        let v4 = 0;
        let v5 = v4;
        let v6 = 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::scheme(arg0);
        if (v0 < v2) {
            while (v3 <= v0) {
        ...
        let v7 = v5 - 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::spent_amount(arg0);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::set_available_amount(arg0, v7);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::set_released_amount(arg0, v5);
        (v7, v5, v0)
    }

    fun init(arg0: TEST_VESTING, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::Category>(0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::cagtegory_init(arg1), 0x2::tx_context::sender(arg1));
        let v0 = Owner{
    ...
    public entry fun multiple_withdraw(arg0: &Owner, arg1: &mut 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::Category, arg2: &mut VestedTokens, arg3: &StartVesting, arg4: vector<address>, arg5: vector<u64>, arg6: 0x1::string::String, arg7: &0x2::clock::Clock, arg8: &UpgradeVersion, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::locker(arg1, arg6);
        let v1 = 0;
        ...
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::set_released_amount(v0, v3);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::set_spent_amount(v0, 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::spent_amount(v0) + v1);
    ...
    public entry fun start_vesting(arg0: &mut Owner, arg1: &mut 0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>, arg2: u64, arg3: &mut StartVesting, arg4: &mut 0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::Category, arg5: &mut VestedTokens, arg6: &0x2::clock::Clock, arg7: &UpgradeVersion, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::seed_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::strategic_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::institutional_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::public_round_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::ecosystem_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::foundation_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::marketing_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::liquidity_initial_release(arg4);
        0x32fe318e4be54aac3d1d8b8898c7e7ed72517c471d9d2d4b4d52a50b111af714::test_vesting_schedule::employeetokenoption_initial_release(arg4);
