module 0x32a79c4bad5cc29fff97bde86e3f4ba6b394443763fb1a01312530fd9caeb2bc::cnsnft6590 {
    struct CNSNFT6590 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6590, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4438"));
        let v4 = 0x2::package::claim<CNSNFT6590>(arg0, arg1);
