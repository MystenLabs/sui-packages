module 0x3c485f57f8a1187c548dd89d1253f7eb37142e3bb2437fd43a3a57a5e12c6c04::sbt_nft {
    ...
    fun do_mint(arg0: &mut Collection, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = SBT{
        ...
        let v1 = SBTMinted{
            sbt_id        : 0x2::object::id<SBT>(&v0),
            collection_id : 0x2::object::uid_to_inner(&arg0.id),
            recipient     : arg1,
        };
        0x2::event::emit<SBTMinted>(v1);
        0x2::table::add<address, bool>(&mut arg0.minted_sbts, arg1, true);
        0x2::transfer::transfer<SBT>(v0, arg1);
    }
    ...
    public fun mint(arg0: &mut ModuleState, arg1: &mut Collection, arg2: u64, arg3: 0x1::string::String, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        do_mint(arg1, v0, arg5);
    }

    public fun mint_with_fee(arg0: &ModuleState, arg1: &mut Collection, arg2: u64, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::string::append(&mut v2, 0x2::address::to_string(v0));
        0x1::string::append(&mut v2, arg1.sbtId);
        0x1::string::append(&mut v2, 0x1::u64::to_string(arg3));
        let v3 = 0x2::hex::decode(0x1::string::into_bytes(arg0.public_key));
        let v4 = 0x2::hex::decode(0x1::string::into_bytes(arg4));
        assert!(0x2::ed25519::ed25519_verify(&v4, &v3, 0x1::string::as_bytes(&v2)), 2);
        assert!(!arg0.paused, 1);
        assert!(!arg1.paused, 1);
        assert!(!0x2::table::contains<address, bool>(&arg1.minted_sbts, v0), 5);
        assert!(arg3 <= arg1.fee_amount, 4);
        assert!(0x2::coin::value<0x2::sui::SUI>(arg5) >= arg3, 3);
        if (arg3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg5, arg3, arg6), arg0.deployer);
            let v5 = FeeCollected{
                amount    : arg3,
                recipient : arg0.deployer,
            };
