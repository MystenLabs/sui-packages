module 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_official_nft {
    ...
    public(friend) fun mint(arg0: 0x2::object::ID, arg1: u64, arg2: 0x2::url::Url, arg3: 0x1::string::String, arg4: address, arg5: address, arg6: u64, arg7: u64, arg8: vector<CollectionOfficialSupporter>, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : CollectionOfficialNft {
        let v0 = 0x2::clock::timestamp_ms(arg10);
        let v1 = CollectionOfficialNft{
            ...
            total_support   : arg7,
            supporters      : arg8,
            supporter_index : arg9,
            timestamp_ms    : v0,
        };
        0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_events::emit_collection_official_nft_minted(0x2::object::uid_to_inner(&v1.id), arg0, arg2, arg3, arg4, arg5, arg6, arg9, v0);
        v1
    }
