module 0xe8e44efa7d34c6abd845c368a7998ae01feb4378019135adf8f143aa77111530::collection_events {
    ...
    struct CollectionOfficialNftMinted has copy, drop {
        nft_id: 0x2::object::ID,
        elected_nft_id: 0x2::object::ID,
        image_url: 0x2::url::Url,
        title: 0x1::string::String,
    ...
    public(friend) fun emit_collection_official_nft_minted(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::url::Url, arg3: 0x1::string::String, arg4: address, arg5: address, arg6: u64, arg7: u64, arg8: u64) {
        let v0 = CollectionOfficialNftMinted{
            nft_id         : arg0,
            elected_nft_id : arg1,
            image_url      : arg2,
            title          : arg3,
        ...
        0x2::event::emit<CollectionOfficialNftMinted>(v0);
    }
