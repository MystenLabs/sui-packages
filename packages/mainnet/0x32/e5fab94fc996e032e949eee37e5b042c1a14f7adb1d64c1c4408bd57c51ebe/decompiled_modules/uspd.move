module 0x32e5fab94fc996e032e949eee37e5b042c1a14f7adb1d64c1c4408bd57c51ebe::uspd {
    ...
    fun init(arg0: USPD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (100000000000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<USPD>>(0x2::coin::mint<USPD>(&mut v5, 100000000000000000, arg1), v6);
        };
