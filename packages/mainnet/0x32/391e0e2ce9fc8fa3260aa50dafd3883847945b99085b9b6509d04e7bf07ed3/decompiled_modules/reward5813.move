module 0x32391e0e2ce9fc8fa3260aa50dafd3883847945b99085b9b6509d04e7bf07ed3::reward5813 {
    struct REWARD5813 has drop {
        dummy_field: bool,
    }

    struct TICKET_5813 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5813(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5813>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5813>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5813, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5813>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5813>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5813>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5813>>(v5, 0x2::tx_context::sender(arg1));
    }
