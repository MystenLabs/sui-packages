module 0x324da6341a19633d542867859d3e25edbce5e7344598fd93df14484af19a45fb::cnsnft7785 {
    struct CNSNFT7785 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7785, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4335"));
        let v4 = 0x2::package::claim<CNSNFT7785>(arg0, arg1);
