module 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::safu {
    ...
    public fun refresh(arg0: &0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(*0x1::vector::borrow<u64>(&v0.info, 7) == 1 || v1 == 0, 11);
        assert!(*0x1::vector::borrow<u64>(&v0.info, 8) == 1 || v1 == 0, 11);
        let v2 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::length(&v0.share);
        if (v2 > 0) {
            let v3 = (0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::slice_size(&v0.share) as u64);
            let v4 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice_mut<Share>(&mut v0.share, 0);
            let v5 = 0;
            while (v5 < v2) {
                let v6 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_from_slice_mut<Share>(v4, v5 % v3);
                *0x1::vector::borrow_mut<u64>(&mut v6.share, 4) = *0x1::vector::borrow<u64>(&v6.share, 0) + *0x1::vector::borrow<u64>(&v6.share, 1);
                *0x1::vector::borrow_mut<u64>(&mut v6.share, 2) = *0x1::vector::borrow<u64>(&v6.share, 2) + *0x1::vector::borrow<u64>(&v6.share, 1);
                *0x1::vector::borrow_mut<u64>(&mut v6.share, 1) = 0;
                *0x1::vector::borrow_mut<u64>(&mut v6.share, 0) = *0x1::vector::borrow<u64>(&v6.share, 0) + *0x1::vector::borrow<u64>(&v6.share, 3);
                *0x1::vector::borrow_mut<u64>(&mut v6.share, 3) = 0;
                if (v5 + 1 < v2 && (v5 + 1) % v3 == 0) {
                    let v7 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::get_slice_idx<Share>(v4) + 1;
                    v4 = 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::big_vector::borrow_slice_mut<Share>(&mut v0.share, v7);
                };
                v5 = v5 + 1;
            };
        };
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 6) = arg4;
        ...
        0x1::vector::push_back<u64>(v9, arg4);
        0x1::vector::push_back<u64>(v9, *0x1::vector::borrow<u64>(&v0.share_supply, 0));
        0x1::vector::push_back<u64>(v9, *0x1::vector::borrow<u64>(&v0.share_supply, 1));
        0x1::vector::push_back<u64>(v9, *0x1::vector::borrow<u64>(&v0.share_supply, 2));
        0x1::vector::push_back<u64>(v9, *0x1::vector::borrow<u64>(&v0.share_supply, 3));
        let v10 = ManagerEvent{
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.share_supply, 3) = 0;
        let v11 = if (*0x1::vector::borrow<u64>(&v0.config, 6) > 0 && *0x1::vector::borrow<u64>(&v0.share_supply, 0) > 0) {
            0
        } else {
            1
        };
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 7) = v11;
        let v12 = if (*0x1::vector::borrow<u64>(&v0.config, 7) > 0 && *0x1::vector::borrow<u64>(&v0.share_supply, 0) > 0) {
            0
        } else {
            1
        };
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 8) = v12;
    }
    ...
    public fun withdraw_scallop_basic<T0>(arg0: &mut 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 4) = 0;
        ...
        0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::charge_fee<T0>(arg0, 0x2::balance::split<T0>(&mut v1, v3));
        let v4 = 0x1::vector::empty<u64>();
        let v5 = &mut v4;
        0x1::vector::push_back<u64>(v5, arg2);
        0x1::vector::push_back<u64>(v5, *0x1::vector::borrow<u64>(&v0.info, 1));
    ...
    public fun withdraw_scallop_spool<T0, T1>(arg0: &mut 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg4: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg5: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg6: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 4) = 0;
        ...
        0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::charge_fee<T0>(arg0, 0x2::balance::split<T0>(&mut v4, v6));
        let v7 = (((0x2::balance::value<T1>(&v3) as u128) * (*0x1::vector::borrow<u64>(&v0.config, 3) as u128) / 10000) as u64);
        0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::charge_fee<T1>(arg0, 0x2::balance::split<T1>(&mut v3, v7));
        let v8 = 0x1::vector::empty<u64>();
        let v9 = &mut v8;
        0x1::vector::push_back<u64>(v9, arg2);
        0x1::vector::push_back<u64>(v9, *0x1::vector::borrow<u64>(&v0.info, 1));
    ...
    public fun withdraw_suilend<T0>(arg0: &mut 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        *0x1::vector::borrow_mut<u64>(&mut v0.info, 4) = 0;
        ...
        0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::charge_fee<T0>(arg0, 0x2::balance::split<T0>(&mut v3, v5));
        let v6 = 0x1::vector::empty<u64>();
        let v7 = &mut v6;
        0x1::vector::push_back<u64>(v7, arg2);
        0x1::vector::push_back<u64>(v7, *0x1::vector::borrow<u64>(&v0.info, 1));
