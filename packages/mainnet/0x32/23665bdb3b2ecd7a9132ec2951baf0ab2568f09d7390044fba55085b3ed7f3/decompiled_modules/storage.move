module 0x3223665bdb3b2ecd7a9132ec2951baf0ab2568f09d7390044fba55085b3ed7f3::storage {
    ...
    public fun get_reserve_type(arg0: &mut Storage, arg1: u8) : 0x1::ascii::String {
        0x2::table::borrow<u8, ReserveData>(&arg0.reserves, arg1).coin_type
    }
    ...
    public entry fun init_reserve<T0>(arg0: &0x2::clock::Clock, arg1: &mut Storage, arg2: u8, arg3: bool, arg4: u256, arg5: u256, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: u256, arg16: &0x2::coin::CoinMetadata<T0>, arg17: &mut 0x2::tx_context::TxContext) {
        only_configurator(arg1, arg17);
        let v0 = arg1.reserves_count;
        assert!(v0 < 255, 43003);
        reserve_validation<T0>(arg1);
        let v1 = TokenBalance{
            user_state   : 0x2::table::new<address, u256>(arg17),
            total_supply : 0,
        };
        let v2 = TokenBalance{
            user_state   : 0x2::table::new<address, u256>(arg17),
        ...
        let v3 = BorrowRateFactors{
            base_rate            : arg6,
            multiplier           : arg8,
            jump_rate_multiplier : arg9,
            reserve_factor       : arg10,
        ...
        let v5 = ReserveData{
            ...
            is_isolated           : arg3,
            supply_cap_ceiling    : arg4,
            borrow_cap_ceiling    : arg5,
            current_supply_rate   : 0,
            current_borrow_rate   : 0,
            current_supply_index  : 0xc8c4af310f3f745d2e4bfe3f2ad0a8b9fc55020126cac8a25cb62909a3202eb5::ray_math::ray(),
            current_borrow_index  : 0xc8c4af310f3f745d2e4bfe3f2ad0a8b9fc55020126cac8a25cb62909a3202eb5::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
            last_update_timestamp : 0x2::clock::timestamp_ms(arg0),
            ltv                   : arg11,
            treasury_factor       : arg12,
            treasury_balance      : 0,
        ...
        0x3223665bdb3b2ecd7a9132ec2951baf0ab2568f09d7390044fba55085b3ed7f3::pool::create_pool<T0>(0x2::coin::get_decimals<T0>(arg16), arg17);
    }

    public fun is_configurator(arg0: &Storage, arg1: address) : bool {
        if (0x2::table::contains<address, bool>(&arg0.configurator, arg1)) {
            return *0x2::table::borrow<address, bool>(&arg0.configurator, arg1)
        };
        false
    }
    ...
    public fun reserve_validation<T0>(arg0: &Storage) {
        ...
        while (v0 < arg0.reserves_count) {
            assert!(0x2::table::borrow<u8, ReserveData>(&arg0.reserves, v0).coin_type != 0x1::type_name::into_string(0x1::type_name::get<T0>()), 43005);
            v0 = v0 + 1;
        };
    }
