module 0x32ff1d8b394b8fdfe6411669c5bc59f6b39fc2a4523616fa518419a985a3e8a2::mcms_account {
    ...
    public(friend) fun accept_ownership_as_timelock(arg0: &mut AccountState, arg1: &mut 0x2::tx_context::TxContext) {
        accept_ownership_internal(arg0, 0x32ff1d8b394b8fdfe6411669c5bc59f6b39fc2a4523616fa518419a985a3e8a2::mcms_registry::get_multisig_address());
    }
    ...
    public fun execute_ownership_transfer(arg0: OwnerCap, arg1: &mut AccountState, arg2: &mut 0x32ff1d8b394b8fdfe6411669c5bc59f6b39fc2a4523616fa518419a985a3e8a2::mcms_registry::Registry, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v2 == 0x32ff1d8b394b8fdfe6411669c5bc59f6b39fc2a4523616fa518419a985a3e8a2::mcms_registry::get_multisig_address()) {
            let v3 = PublisherKey{dummy_field: false};
            0x32ff1d8b394b8fdfe6411669c5bc59f6b39fc2a4523616fa518419a985a3e8a2::mcms_registry::register_entrypoint<McmsAccountProof, OwnerCap>(arg2, 0x32ff1d8b394b8fdfe6411669c5bc59f6b39fc2a4523616fa518419a985a3e8a2::mcms_registry::create_publisher_wrapper<McmsAccountProof>(0x2::dynamic_field::borrow<PublisherKey, 0x2::package::Publisher>(&arg0.id, v3), create_mcms_account_proof()), create_mcms_account_proof(), arg0, vector[b"mcms_account", b"mcms_deployer", b"mcms_registry"], arg4);
        } else {
    ...
    public fun transfer_ownership_to_self(arg0: &OwnerCap, arg1: &mut AccountState, arg2: &mut 0x2::tx_context::TxContext) {
        transfer_ownership(arg0, arg1, 0x32ff1d8b394b8fdfe6411669c5bc59f6b39fc2a4523616fa518419a985a3e8a2::mcms_registry::get_multisig_address(), arg2);
    }
