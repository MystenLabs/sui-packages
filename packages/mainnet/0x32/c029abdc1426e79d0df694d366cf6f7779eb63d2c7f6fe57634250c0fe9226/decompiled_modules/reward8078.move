module 0x32c029abdc1426e79d0df694d366cf6f7779eb63d2c7f6fe57634250c0fe9226::reward8078 {
    struct REWARD8078 has drop {
        dummy_field: bool,
    }

    struct TICKET_8078 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8078(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8078>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8078>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8078, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8078>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8078>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8078>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8078>>(v5, 0x2::tx_context::sender(arg1));
    }
