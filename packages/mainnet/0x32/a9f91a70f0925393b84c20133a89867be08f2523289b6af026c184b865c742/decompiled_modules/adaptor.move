module 0xa9e83945ef68ad05a252271b814ae34e71a6d4529d0bd4d3c647bea2cd3d19db::adaptor {
    ...
    public fun get_each_price(arg0: &SupraRegistry, arg1: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg2: u32, arg3: &0x5ba7c7ba602dcfd4f7cf31e2be48d522c6f6102b6cf192bb4ed2935ed8377c3e::navi_aggregator::NaviAggregator) : (u8, u256, u8, u64) {
    ...
    public fun get_sui_price(arg0: &SupraRegistry, arg1: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg2: u32, arg3: u32, arg4: &0x5ba7c7ba602dcfd4f7cf31e2be48d522c6f6102b6cf192bb4ed2935ed8377c3e::navi_aggregator::NaviAggregator) : (u8, u256, u8, u64) {
    ...
    public entry fun set_supra_price_batch_v2(arg0: &SupraRegistry, arg1: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg2: u32, arg3: vector<u32>, arg4: &0x5ba7c7ba602dcfd4f7cf31e2be48d522c6f6102b6cf192bb4ed2935ed8377c3e::navi_aggregator::NaviAggregatorCap, arg5: &mut 0x5ba7c7ba602dcfd4f7cf31e2be48d522c6f6102b6cf192bb4ed2935ed8377c3e::navi_aggregator::NaviAggregator, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<u8>();
        let v1 = 0x1::vector::empty<u256>();
        let v2 = 0x1::vector::empty<u64>();
        let (v3, v4, v5, v6) = get_each_price(arg0, arg1, arg2, arg5);
        let v7 = 0;
        while (v7 < 0x1::vector::length<u32>(&arg3)) {
            let v8 = *0x1::vector::borrow<u32>(&arg3, v7);
            if (v8 == arg2) {
                0x1::vector::push_back<u8>(&mut v0, v3);
                0x1::vector::push_back<u256>(&mut v1, v4);
                0x1::vector::push_back<u64>(&mut v2, v6);
            ...
            let (v9, v10, _, v12) = get_each_price(arg0, arg1, v8, arg5);
            0x1::vector::push_back<u8>(&mut v0, v9);
            0x1::vector::push_back<u64>(&mut v2, v12);
            0x1::vector::push_back<u256>(&mut v1, v10 * v4 / (0x2::math::pow(10, v5) as u256));
            v7 = v7 + 1;
        };
        0x5ba7c7ba602dcfd4f7cf31e2be48d522c6f6102b6cf192bb4ed2935ed8377c3e::navi_aggregator::update_internal_token_price_batch(arg4, arg5, 2, v0, v1, v2, arg6);
    }
