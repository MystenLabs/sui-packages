module 0x320bba473980840d77abb947e7a0b937c41c26d18e76956043122df3e789c59c::cnsnft5469 {
    struct CNSNFT5469 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5469, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5469>(arg0, arg1);
