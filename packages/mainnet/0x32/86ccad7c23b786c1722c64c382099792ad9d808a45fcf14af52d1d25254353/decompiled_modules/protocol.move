module 0x3286ccad7c23b786c1722c64c382099792ad9d808a45fcf14af52d1d25254353::protocol {
    ...
    public fun create_offer_from_kiosk<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: T0, arg2: 0x2::object::ID, arg3: u64, arg4: 0x1::option::Option<address>, arg5: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        internal_create_offer<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }

    public fun execute_kiosk_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: T1, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x3286ccad7c23b786c1722c64c382099792ad9d808a45fcf14af52d1d25254353::fee_manager::PlatformConfig, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x3286ccad7c23b786c1722c64c382099792ad9d808a45fcf14af52d1d25254353::fee_manager::get_flat_fee(arg6, 0x1::type_name::get<T1>());
        if (v11 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg5) >= v7 + v11, 4);
            0x3286ccad7c23b786c1722c64c382099792ad9d808a45fcf14af52d1d25254353::fee_manager::collect_fee(arg6, 0x2::coin::split<0x2::sui::SUI>(&mut arg5, v11, arg8));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v12 = v1;
    ...
    public fun execute_swap<T0: store + key, T1: store + key>(arg0: &mut GlobalRegistry, arg1: SwapOffer, arg2: T1, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x3286ccad7c23b786c1722c64c382099792ad9d808a45fcf14af52d1d25254353::fee_manager::PlatformConfig, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = 0x3286ccad7c23b786c1722c64c382099792ad9d808a45fcf14af52d1d25254353::fee_manager::get_flat_fee(arg4, 0x1::type_name::get<T1>());
        if (v11 > 0) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= v7 + v11, 4);
            0x3286ccad7c23b786c1722c64c382099792ad9d808a45fcf14af52d1d25254353::fee_manager::collect_fee(arg4, 0x2::coin::split<0x2::sui::SUI>(&mut arg3, v11, arg6));
        };
        0x2::table::remove<0x2::object::ID, bool>(&mut arg0.active_offers, v4);
        let v12 = v1;
        let v13 = OfferedNftKey{dummy_field: false};
