module 0x3200434607acb7092cab4aeb0daa55d0c4be0b135d4c223d403313aa9f0504c5::reward3828 {
    struct REWARD3828 has drop {
        dummy_field: bool,
    }

    struct TICKET_3828 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3828(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3828>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3828>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3828, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3828>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3828>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3828>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3828>>(v5, 0x2::tx_context::sender(arg1));
    }
