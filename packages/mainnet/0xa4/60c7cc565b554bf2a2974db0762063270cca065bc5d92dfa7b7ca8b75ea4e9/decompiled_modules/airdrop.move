module 0xa460c7cc565b554bf2a2974db0762063270cca065bc5d92dfa7b7ca8b75ea4e9::airdrop {
    struct AirdropEvent has copy, drop {
        amount: u64,
        recipient: address,
    }

    public entry fun send_by_allocation<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: vector<address>, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
