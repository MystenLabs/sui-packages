module 0xa4c1627f03e10853a72ae7aa2bcac1899c32c2f65f24355d7b7a69a7a01198a4::reward2161 {
    struct REWARD2161 has drop {
        dummy_field: bool,
    }

    struct TICKET_2161 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2161(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2161>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2161>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2161, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2161>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2161>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2161>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2161>>(v5, 0x2::tx_context::sender(arg1));
    }
