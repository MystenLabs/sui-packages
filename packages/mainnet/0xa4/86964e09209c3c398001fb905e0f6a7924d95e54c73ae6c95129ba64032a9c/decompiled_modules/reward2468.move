module 0xa486964e09209c3c398001fb905e0f6a7924d95e54c73ae6c95129ba64032a9c::reward2468 {
    struct REWARD2468 has drop {
        dummy_field: bool,
    }

    struct TICKET_2468 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2468(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2468>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2468>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2468, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2468>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2468>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2468>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2468>>(v5, 0x2::tx_context::sender(arg1));
    }
