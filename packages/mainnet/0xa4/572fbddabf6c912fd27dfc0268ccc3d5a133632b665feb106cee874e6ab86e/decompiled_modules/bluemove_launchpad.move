module 0xa4572fbddabf6c912fd27dfc0268ccc3d5a133632b665feb106cee874e6ab86e::bluemove_launchpad {
    ...
    public entry fun claim_nfts(arg0: &mut LaunchpadData, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 > 0) {
            ...
            let v18 = MintNFTEvent{
                object_id : 0x2::object::id<SuiPunksClub>(&v17),
                creator   : v0,
                name      : v14,
            };
            0x2::event::emit<MintNFTEvent>(v18);
            0x2::transfer::public_transfer<SuiPunksClub>(v17, v0);
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"SuiPunksClub #"),
            base_url       : 0x1::string::utf8(b"https://static.bluemove.net/suipunksclub/"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.bluemove.net/uploads2/suipunksclub/images/"),
            description    : 0x1::string::utf8(b"Collection of 5,000 unique 24*24 pixels, we're building the strongest connection between Nfts and the cryptocurrency world."),
            ...
            fund_address   : @0xb5c4b0dd693d949e13a206973700e302175832c1d772ab60b7fd5062c2ff6d2,
