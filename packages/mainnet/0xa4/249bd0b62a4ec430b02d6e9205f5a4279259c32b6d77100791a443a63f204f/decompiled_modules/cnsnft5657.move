module 0xa4249bd0b62a4ec430b02d6e9205f5a4279259c32b6d77100791a443a63f204f::cnsnft5657 {
    struct CNSNFT5657 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5657, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5657>(arg0, arg1);
