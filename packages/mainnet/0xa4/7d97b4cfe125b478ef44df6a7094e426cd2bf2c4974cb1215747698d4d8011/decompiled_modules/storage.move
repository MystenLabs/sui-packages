module 0xe35f634b757251eca416105462c1da91b725d2a5119a7f78cad1683bfab160b4::storage {
    ...
    public fun increase_treasury_balance(arg0: &mut Storage, arg1: u8, arg2: u256) {
        let v0 = &mut 0x2::table::borrow_mut<u8, ReserveData>(&mut arg0.reserves, arg1).supply_balance;
        v0.treasury = v0.treasury + arg2;
    }
    ...
    public entry fun init_reserve<T0>(arg0: &0x2::clock::Clock, arg1: &mut Storage, arg2: bool, arg3: u256, arg4: u256, arg5: u256, arg6: u256, arg7: u256, arg8: u256, arg9: u256, arg10: u256, arg11: u256, arg12: u256, arg13: u256, arg14: u256, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = ReserveData{
            ...
            current_supply_index  : 0x9797ab8550aee44759adb138af7463822f032d9eda386cc49401cd5c1cb8db4a::ray_math::ray(),
            current_borrow_index  : 0x9797ab8550aee44759adb138af7463822f032d9eda386cc49401cd5c1cb8db4a::ray_math::ray(),
            supply_balance        : v1,
            borrow_balance        : v2,
