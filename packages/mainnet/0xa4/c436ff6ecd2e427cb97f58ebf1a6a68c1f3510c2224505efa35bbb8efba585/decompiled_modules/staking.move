module 0xa4c436ff6ecd2e427cb97f58ebf1a6a68c1f3510c2224505efa35bbb8efba585::staking {
    ...
    public entry fun unstake(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut StakingVault, arg3: &mut 0xa4c436ff6ecd2e427cb97f58ebf1a6a68c1f3510c2224505efa35bbb8efba585::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        ...
        if (v2 > 0) {
            if (v2 >= 0xa4c436ff6ecd2e427cb97f58ebf1a6a68c1f3510c2224505efa35bbb8efba585::storktoken::remaining_staking_supply(arg3)) {
                v3 = 0xa4c436ff6ecd2e427cb97f58ebf1a6a68c1f3510c2224505efa35bbb8efba585::storktoken::remaining_staking_supply(arg3);
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<0xa4c436ff6ecd2e427cb97f58ebf1a6a68c1f3510c2224505efa35bbb8efba585::storktoken::STORKTOKEN>>(0xa4c436ff6ecd2e427cb97f58ebf1a6a68c1f3510c2224505efa35bbb8efba585::storktoken::withdraw_staking(arg3, v3, arg4), v0);
        };
    }
