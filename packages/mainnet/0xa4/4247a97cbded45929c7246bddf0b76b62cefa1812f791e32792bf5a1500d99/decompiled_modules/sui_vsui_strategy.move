        ...
        if (v0 > 0) {
            ...
            if (0x549e8b69270defbfafd4f94e17ec44cdbdd99820b33bda2278dea3b9a32d3f55::native_pool::from_shares(arg3, arg4, v2) < 1000000000) {
                ...
                if (v6 >= v3) {
                    ...
                    assert!(v6 >= (v13 as u64), (v6 as u64));
                ...
                let (v15, v16) = 0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::vault::flash_loan<0x2::sui::SUI, 0x372a7e85b4c0e5951902b19e9539c7c142acc7499be4f73aec3eca27833fbf9e::st_sui::ST_SUI>(arg1, &arg0.vault_access, v1);
                let v17 = revolving_repay_and_withdraw(arg0, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, v15, v0, arg14);
                0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::vault::repay_flash_loan<0x2::sui::SUI, 0x372a7e85b4c0e5951902b19e9539c7c142acc7499be4f73aec3eca27833fbf9e::st_sui::ST_SUI>(arg1, &arg0.vault_access, v16, 0x2::balance::split<0x2::sui::SUI>(&mut v17, v1));
                0x47d7b98d50077c273f4b257611bd380e630cca513dfc74de355f619d3d240cfc::vault::strategy_withdraw_to_ticket<0x2::sui::SUI, 0x372a7e85b4c0e5951902b19e9539c7c142acc7499be4f73aec3eca27833fbf9e::st_sui::ST_SUI>(arg2, &arg0.vault_access, 0x2::balance::split<0x2::sui::SUI>(&mut v17, v0));
