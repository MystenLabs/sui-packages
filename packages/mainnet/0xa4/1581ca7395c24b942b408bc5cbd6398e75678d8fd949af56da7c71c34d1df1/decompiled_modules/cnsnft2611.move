module 0xa41581ca7395c24b942b408bc5cbd6398e75678d8fd949af56da7c71c34d1df1::cnsnft2611 {
    struct CNSNFT2611 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2611, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2611>(arg0, arg1);
