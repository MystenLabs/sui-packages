module 0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction {
    ...
    public fun create_auction<T0: store + key, T1>(arg0: &0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: T0, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Auction<T0, T1> {
        let v0 = 0x2::object::id<T0>(&arg2);
        0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::deposit_item<T0>(arg0, arg1, arg2);
    ...
    public fun finalize_auction<T0: store + key, T1>(arg0: &mut 0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: Auction<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<address>(&v8)) {
            ...
            0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::get_fee_from_payment<T1>(arg0, &mut v12, arg4);
            let v13 = 0x2::coin::value<T1>(&v12);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v12, v2);
            0x2::transfer::public_transfer<T0>(0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::withdraw_item<T0>(arg0, arg1, v1), v11);
            ...
            0x2::transfer::public_transfer<T0>(0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::withdraw_item<T0>(arg0, arg1, v1), v2);
    ...
    public fun finalize_auction_with_lock<T0: store + key, T1>(arg0: &mut 0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::AuctionHouse, arg1: &mut 0x2::kiosk::Kiosk, arg2: Auction<T0, T1>, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<address>(&v8)) {
            ...
            0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::get_fee_from_payment<T1>(arg0, &mut v12, arg5);
            let v13 = 0x2::coin::value<T1>(&v12);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v12, v2);
            let (v14, v15) = 0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::withdraw_item_with_lock<T0>(arg0, arg1, v1, arg5);
            ...
            0x2::balance::destroy_zero<T1>(v7);
            let (v20, v21) = 0xa4a5aead360bebe382f86ba809783e22cdd5021219091c87417e38633a12b9d7::auction_house::withdraw_item_with_lock<T0>(arg0, arg1, v1, arg5);
