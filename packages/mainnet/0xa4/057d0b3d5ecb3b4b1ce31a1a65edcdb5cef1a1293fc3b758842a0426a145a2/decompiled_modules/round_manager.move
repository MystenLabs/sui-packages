module 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::round_manager {
    ...
    fun claim_faith_internal(arg0: &mut Global, arg1: &mut 0x2::coin::TreasuryCap<0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::FAITH>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : u64 {
    ...
    public entry fun create_global_shared(arg0: address, arg1: 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::SupplyCap, arg2: 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::RadianceIndex, arg3: 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::Buckets, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury::create(arg6);
        let v2 = Round{
        ...
        let v3 = Global{
            ...
            idx              : arg2,
            buckets          : arg3,
            miracle          : 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::miracle::create(arg4, arg5, arg6),
    ...
    fun settle(arg0: &mut Global, arg1: &0x2::random::Random, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v32) {
            ...
            if (v45 > 0) {
                ...
                if (v48 > 0) {
                    let v49 = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::treasury::withdraw_pilgrimage(&mut arg0.vaults, v47, arg3);
                    let v50 = v47;
                    let v51 = 0;
                    while (v51 < v10 && v50 > 0) {
                        ...
                        if (v54 > 0) {
                            v50 = v50 - v54;
                            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v49, v53, arg3), v52.owner);
                        };
                        v51 = v51 + 1;
                    };
                    0x2::coin::destroy_zero<0x2::sui::SUI>(v49);
                    let v56 = PilgrimageDripEvent{
                        round_index   : arg0.round.index,
                        drip_atoms    : v47,
                        drought_tests : v24,
                    };
                    0x2::event::emit<PilgrimageDripEvent>(v56);
                };
            };
        };
        if (arg0.round.total > 0) {
            let v57 = 0;
            while (v57 < 25) {
                let v58 = 0x1::vector::borrow<vector<Entry>>(&arg0.round.entries, v57);
                let v59 = 0x1::vector::length<Entry>(v58);
                if (v59 > 0) {
                    let v60 = if (v57 == v5) {
                        if (v10 > 0) {
                            v8 > 0
                    ...
                    let v66 = 0;
                    while (v66 < v59) {
                        let v67 = *0x1::vector::borrow<Entry>(v58, v66);
                        let v68 = if (v60) {
                            if (v61 > 0) {
                                v8 > 0
                            } else {
                        ...
                        let v69 = if (v68) {
                            let v69 = if (v66 == v65) {
                                ...
                                let v70 = (((v8 as u128) * (v67.amount as u128) / v62) as u64);
                                let v71 = v70;
                                if (v70 == 0 && v64 > 0) {
                                    v71 = 1;
                                };
                        ...
                        let v72 = &mut arg0.player_records;
                        let v73 = ensure_record(v72, v67.owner, arg0.round.index).unclaimed_sui;
                        let v74 = get_sui_delta(&v0, &v1, v67.owner);
                        let v75 = if (v73 >= v74) {
                            v73 - v74
                        } else {
                            0
                        };
                        let (_, _, v78) = 0x965c6cb391f2e240cea5f43a10de3495004c78c057d4c233159205c40c7e03e3::faith::preview_refinement(v67.owner, &arg0.idx, &arg0.buckets, 1500);
                        let v79 = PlayerRoundSettled{
                            round_index                : arg0.round.index,
                            player                     : v67.owner,
                            sui_deployed_atoms         : v67.amount,
                            sui_won_atoms              : v69,
                            unclaimed_sui_before_atoms : v75,
                            unclaimed_sui_after_atoms  : v73,
                            unclaimed_faith_atoms      : v78,
                            had_miracle                : v22,
                            ts_ms                      : arg2,
                        };
                        0x2::event::emit<PlayerRoundSettled>(v79);
                        v66 = v66 + 1;
                    };
                };
                v57 = v57 + 1;
        ...
        arg0.round.phase = 0;
        let v80 = RoundSettled{
            index         : arg0.round.index,
            winning       : v5,
            fee           : v7,
            redistributed : v8,
        };
        0x2::event::emit<RoundSettled>(v80);
    }
