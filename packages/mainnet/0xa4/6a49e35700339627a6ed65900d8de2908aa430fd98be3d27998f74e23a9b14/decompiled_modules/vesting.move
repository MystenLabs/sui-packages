module 0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::vesting {
    ...
    public fun addFunds<T0>(arg0: &ManagerCap, arg1: &mut ProjectRegistry, arg2: &mut Pool<T0>, arg3: 0x2::coin::Coin<T0>, arg4: vector<u128>, arg5: vector<address>, arg6: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg7: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg6, 1);
    ...
    public fun addFundsWithReleased<T0>(arg0: &ManagerCap, arg1: &mut ProjectRegistry, arg2: &mut Pool<T0>, arg3: 0x2::coin::Coin<T0>, arg4: vector<u128>, arg5: vector<address>, arg6: vector<u128>, arg7: bool, arg8: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg9: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg8, 1);
        ...
        while (v0 < 0x1::vector::length<address>(&arg5)) {
            let v1 = *0x1::vector::borrow<address>(&arg5, v0);
            let v2 = *0x1::vector::borrow<u128>(&arg4, v0);
            let (v3, v4, v5) = getFundUser<T0>(arg2, v1);
            if (v3 > 0 || v3 > 0 && v4 == 0) {
                let v6 = 0x2::table::borrow_mut<address, Fund>(&mut arg2.funds, v1);
                v6.total = v6.total + v2;
                v6.locked = v6.locked + v2;
                v6.released = v6.released + v5;
            } else {
                let v7 = Fund{
                    owner         : v1,
                    total         : v2,
            ...
            if (arg7) {
                arg2.funds_claimed = arg2.funds_claimed + v5;
            };
            addPoolToRegistry(arg1, v1, 0x2::object::id_address<Pool<T0>>(arg2));
            0x2::coin::join<T0>(&mut arg2.funds_total, 0x2::coin::split<T0>(&mut arg3, (v2 as u64), arg9));
            let v8 = AddFundReleasedEvent{
                pool_id         : 0x2::object::id_address<Pool<T0>>(arg2),
                user            : v1,
                fund_amount     : v2,
                released_amount : v5,
            };
            0x2::event::emit<AddFundReleasedEvent>(v8);
            v0 = v0 + 1;
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, 0x2::tx_context::sender(arg9));
    }

    public fun addMemberInVault(arg0: &Admincap, arg1: address, arg2: &mut Vault, arg3: &mut 0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg3, 1);
    ...
    public fun changeMemberInVault(arg0: &Admincap, arg1: address, arg2: &mut Vault, arg3: &mut 0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg3, 1);
    ...
    public fun changeOperationWallet(arg0: &mut Operation, arg1: &Vault, arg2: address, arg3: &mut 0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg3, 1);
    ...
    public fun claim<T0>(arg0: &mut Pool<T0>, arg1: &0x2::clock::Clock, arg2: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg2, 1);
    ...
    public fun createPool<T0>(arg0: &ManagerCap, arg1: &mut ProjectRegistry, arg2: vector<u8>, arg3: u8, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: vector<u64>, arg9: vector<u64>, arg10: u128, arg11: &mut 0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg12: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg11, 1);
    ...
    public fun depositFund<T0>(arg0: &TreasureCap, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg3, 1);
    ...
    public fun disableChangeFund<T0>(arg0: &ManagerCap, arg1: &mut Pool<T0>, arg2: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg2, 1);
        arg1.enable_change_fund = false;
    }

    public fun enableChangeFund<T0>(arg0: &Operation, arg1: &mut Pool<T0>, arg2: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg3: &Vault, arg4: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg2, 1);
    ...
    public fun end<T0>(arg0: &ManagerCap, arg1: &mut Pool<T0>, arg2: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg2, 1);
    ...
    fun init(arg0: VESTING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::cap_vault::createVault<Admincap>(arg1);
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::cap_vault::createVault<ManagerCap>(arg1);
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::cap_vault::createVault<TreasureCap>(arg1);
    ...
    public fun pause<T0>(arg0: &ManagerCap, arg1: &mut Pool<T0>, arg2: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg2, 1);
        assert!(arg1.state != 3, 1015);
        arg1.state = 3;
    }

    public fun removeFunds<T0>(arg0: &ManagerCap, arg1: &mut ProjectRegistry, arg2: &Operation, arg3: &mut Pool<T0>, arg4: vector<address>, arg5: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg5, 1);
        let v0 = 0;
    ...
    public fun start<T0>(arg0: &ManagerCap, arg1: &mut Pool<T0>, arg2: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg2, 1);
        assert!(arg1.state == 1 || arg1.state == 3, 1016);
        arg1.state = 2;
    }

    public fun updateVestingConfig<T0>(arg0: &Operation, arg1: &mut Pool<T0>, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: vector<u64>, arg9: u128, arg10: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg11: &Vault, arg12: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg10, 1);
    ...
    public fun withdrawFundAll<T0>(arg0: &TreasureCap, arg1: &Operation, arg2: &mut Pool<T0>, arg3: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg3, 1);
    ...
    public fun withdrawFundAmount<T0>(arg0: &TreasureCap, arg1: &Operation, arg2: &mut Pool<T0>, arg3: u128, arg4: &0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::Version, arg5: &mut 0x2::tx_context::TxContext) {
        0xa46a49e35700339627a6ed65900d8de2908aa430fd98be3d27998f74e23a9b14::version::checkVersion(arg4, 1);
        assert!(arg3 > 0, 1008);
        let v0 = 0x2::coin::value<T0>(&arg2.funds_total);
