module 0xa4edcd9698c6238d99672b5528ae6efcc32e967c799af059c6b207ac1dd41cac::just_a_bread {
    struct JUST_A_BREAD has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: JUST_A_BREAD, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<JUST_A_BREAD>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"JUST A BREAD"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"WTF WE BOTH LIKE TOAST"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidfeeaphrsyqgqyktqbtjbzawks76nbqf4ko44vsi2apwmu4ccthy"));
