module 0xa4e386712fd05324063f886149f581b18c5c1abfdba5b80f1a9da4deede5f020::cnsnft3383 {
    struct CNSNFT3383 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3383, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3383>(arg0, arg1);
