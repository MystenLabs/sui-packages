module 0xa4cc677e1d26c4752455d46337a67c69b3b88fda3dfb76ac8e1c8c2772c66166::global_config {
    ...
    public fun withdraw<T0>(arg0: &mut GlobalConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun withdraw_all<T0>(arg0: &mut GlobalConfig, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
