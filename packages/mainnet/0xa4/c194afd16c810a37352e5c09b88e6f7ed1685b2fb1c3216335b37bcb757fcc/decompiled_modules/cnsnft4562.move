module 0xa4c194afd16c810a37352e5c09b88e6f7ed1685b2fb1c3216335b37bcb757fcc::cnsnft4562 {
    struct CNSNFT4562 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4562, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1851"));
        let v4 = 0x2::package::claim<CNSNFT4562>(arg0, arg1);
