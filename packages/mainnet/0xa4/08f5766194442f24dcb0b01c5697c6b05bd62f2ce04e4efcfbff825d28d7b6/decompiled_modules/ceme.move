module 0xa408f5766194442f24dcb0b01c5697c6b05bd62f2ce04e4efcfbff825d28d7b6::ceme {
    ...
    fun init(arg0: CEME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"GBmh-2JzEuQLhN60                                                                                                                                                                                                                                                                                                                ");
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<CEME>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<CEME>>(v4);
    }
