module 0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::atomic_arbitrage {
    ...
    public entry fun arb_sui_usdc_aftermath(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_aftermath::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg3, arg4), 1103);
    ...
    public entry fun arb_sui_usdc_bluefin(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg3) <= arg2, 1102);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_bluefin::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg3, arg4), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg4));
        let v0 = RealArbitrageExecuted{
    ...
    public entry fun arb_sui_usdc_cetus(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg3) <= arg2, 1102);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_cetus::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg3, arg4), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg4));
        let v0 = RealArbitrageExecuted{
    ...
    public entry fun arb_sui_usdc_deepbook(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg3) <= arg2, 1102);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_deepbook::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg3, arg4), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg4));
        let v0 = RealArbitrageExecuted{
    ...
    public entry fun arb_sui_usdc_kriya(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg3) <= arg2, 1102);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_kriya::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg3, arg4), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg4));
        let v0 = RealArbitrageExecuted{
    ...
    public entry fun arb_sui_usdc_turbos(arg0: u64, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg3) <= arg2, 1102);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_turbos::validate_sui_usdc_swap(arg0, 1, arg1, arg3, arg4), 1103);
        let v0 = RealArbitrageExecuted{
    ...
    fun execute_aftermath_swap_ptb(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_aftermath::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg2, arg3), 1103);
    ...
    fun execute_bluefin_swap_ptb(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_bluefin::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg2, arg3), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
    }
    ...
    fun execute_cetus_swap_ptb(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_cetus::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg2, arg3), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
    }
    ...
    fun execute_deepbook_swap_ptb(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_deepbook::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg2, arg3), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
    }
    ...
    fun execute_kriya_swap_ptb(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_kriya::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg2, arg3), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
    }
    ...
    fun execute_turbos_swap_ptb(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(0xa45e1445c1be99640c5a66f3a380e0e57c14fcb98ab558b8b19e65c8a6694181::dex_turbos::validate_sui_usdc_swap(0x2::coin::value<0x2::sui::SUI>(&arg0), 1, arg1, arg2, arg3), 1103);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
    }
