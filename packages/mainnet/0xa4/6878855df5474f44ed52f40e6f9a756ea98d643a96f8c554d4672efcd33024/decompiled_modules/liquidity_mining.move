module 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::liquidity_mining {
    ...
    struct PoolReward has store, key {
        ...
        end_time_ms: u64,
        total_rewards: u64,
        allocated_rewards: 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::Decimal,
        cumulative_rewards_per_share: 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::Decimal,
    ...
    struct UserReward has store {
        ...
        earned_rewards: 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::Decimal,
        cumulative_rewards_per_share: 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::Decimal,
    }
    ...
    public(friend) fun add_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = PoolReward{
            ...
            allocated_rewards            : 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(0),
            cumulative_rewards_per_share : 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(0),
    ...
    public(friend) fun cancel_pool_reward<T0>(arg0: &mut PoolRewardManager, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        0x2::balance::split<T0>(0x2::bag::borrow_mut<RewardBalance<T0>, 0x2::balance::Balance<T0>>(&mut v0.additional_fields, v1), 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::floor(0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::sub(0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(v0.total_rewards), v0.allocated_rewards)))
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut PoolRewardManager, arg1: &mut UserRewardManager, arg2: &0x2::clock::Clock, arg3: u64) : 0x2::balance::Balance<T0> {
        ...
        let v3 = 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::floor(v2.earned_rewards);
        v2.earned_rewards = 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::sub(v2.earned_rewards, 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(v3));
    ...
    fun update_pool_reward_manager(arg0: &mut PoolRewardManager, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x1::option::Option<PoolReward>>(&arg0.pool_rewards)) {
            ...
            let v4 = 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::div(0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::mul(0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(v3.total_rewards), 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(0x2::math::min(v0, v3.end_time_ms) - 0x2::math::max(v3.start_time_ms, arg0.last_update_time_ms))), 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(v3.end_time_ms - v3.start_time_ms));
            v3.allocated_rewards = 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::add(v3.allocated_rewards, v4);
            v3.cumulative_rewards_per_share = 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::add(v3.cumulative_rewards_per_share, 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::div(v4, 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(arg0.total_shares)));
            v1 = v1 + 1;
        };
        arg0.last_update_time_ms = v0;
    }
            ...
            if (0x1::option::is_none<UserReward>(v3)) {
                if (arg1.last_update_time_ms <= v2.end_time_ms) {
                    let v4 = if (arg1.last_update_time_ms <= v2.start_time_ms) {
                        0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::mul(v2.cumulative_rewards_per_share, 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(arg1.share))
                    } else {
                ...
                v6.earned_rewards = 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::add(v6.earned_rewards, 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::mul(0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::sub(v2.cumulative_rewards_per_share, v6.cumulative_rewards_per_share), 0xa46878855df5474f44ed52f40e6f9a756ea98d643a96f8c554d4672efcd33024::decimal::from(arg1.share)));
