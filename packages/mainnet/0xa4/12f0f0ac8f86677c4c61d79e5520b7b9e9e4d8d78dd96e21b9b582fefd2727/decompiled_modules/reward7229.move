module 0xa412f0f0ac8f86677c4c61d79e5520b7b9e9e4d8d78dd96e21b9b582fefd2727::reward7229 {
    struct REWARD7229 has drop {
        dummy_field: bool,
    }

    struct TICKET_7229 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7229(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7229>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7229>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7229, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7229>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7229>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7229>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7229>>(v5, 0x2::tx_context::sender(arg1));
    }
