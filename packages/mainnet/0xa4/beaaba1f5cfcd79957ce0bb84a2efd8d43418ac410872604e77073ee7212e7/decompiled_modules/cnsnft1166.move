module 0xa4beaaba1f5cfcd79957ce0bb84a2efd8d43418ac410872604e77073ee7212e7::cnsnft1166 {
    struct CNSNFT1166 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1166, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1166>(arg0, arg1);
