module 0xa48b3fb92296396cf4abd4afc024de8e092c11f5a54fceaf93e3524c2a058a95::reward7663 {
    struct REWARD7663 has drop {
        dummy_field: bool,
    }

    struct TICKET_7663 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7663(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7663>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7663>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7663, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7663>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7663>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7663>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7663>>(v5, 0x2::tx_context::sender(arg1));
    }
