module 0xa48307cc93a049bc1bfd42ad91eb9de4c11854ac9653481289689948a4b18ebb::collectible {
    ...
    fun init(arg0: COLLECTIBLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"FlowX Loyalty Pass"));
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://bafybeibckarc4654c3t3rqwcu2rv5al4i5lxsxrr6atepsfjckzuzstqwm"));
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"Certificate for active participants in the TradeX and LoyaX of FlowX Finance. The certification is non-transferable and cannot be exchanged."));
        ...
        let v3 = State{
            ...
            started_at_ms : 1697014800000,
            ended_at_ms   : 1699693200000,
    ...
    public entry fun mint(arg0: &mut State, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.total_supply < 500, 0);
