module 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::weighted_math {
    ...
    public fun add_liquidity_computation(arg0: &WeightedConfig, arg1: vector<u256>, arg2: vector<u256>, arg3: u64, arg4: u256) : (u256, vector<u256>) {
        ...
        let (v2, v3) = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::get_non_zero_count_and_index_u256(arg2);
        ...
        let v4 = if (v2 == 1) {
            ...
            *0x1::vector::borrow_mut<u256>(&mut v1, v3) = v6;
            ...
            let v11 = v10;
            let v12 = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::create_zero_vector_u256(v0);
            let v13 = 0;
            while (v13 < v0) {
            ...
            v9 + 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::vector_sum_u256(v12)
        };
        (v4, v1)
    }
    ...
    public fun calc_minted_shares_given_single_asset_in(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u64) : (u256, u256) {
        ...
        let v0 = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(arg0, fee_ratio(arg1, (arg4 as u256)), (1000000000000000000 as u256));
    ...
    public fun calc_shares_given_single_asset_out(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u64) : (u256, u256) {
        let v0 = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(arg3, (1000000000000000000 as u256), fee_ratio(arg0, (arg4 as u256)));
    ...
    public fun computeScalingFactor(arg0: u8) : u256 {
        assert!(18 >= arg0, 5212);
        0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::pow_10_u256(18 - arg0)
    }

    public fun compute_ask_amount(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u256) : u256 {
        assert!(arg0 <= 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(arg1, 300000000000000000, (1000000000000000000 as u256)), 5210);
    ...
    public fun fee_ratio(arg0: u256, arg1: u256) : u256 {
        (1000000000000000000 as u256) - 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256((1000000000000000000 as u256) - arg0, 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(arg1, (1000000000000000000 as u256), (10000 as u256)), (1000000000000000000 as u256))
    }
    ...
    public fun get_weight_and_sf_at_index(arg0: &WeightedConfig, arg1: u64, arg2: bool) : (u64, u256) {
        let v0 = if (!arg2) {
            *0x1::vector::borrow<u64>(&arg0.weights, arg1)
            ...
            (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256((*0x1::vector::borrow<u64>(&arg0.weights, arg1) as u256), (1000000000000000000 as u256), (arg0.total_weight as u256)) as u64)
        };
    ...
    public fun imbalanced_liquidity_withdraw(arg0: &WeightedConfig, arg1: vector<u256>, arg2: u256, arg3: vector<u256>, arg4: u64) : (u256, vector<u256>) {
        let v0 = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::create_zero_vector_u256(0x1::vector::length<u256>(&arg1));
        let (v1, v2) = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::get_non_zero_count_and_index_u256(arg3);
        assert!(v1 == 1, 5214);
    ...
    public fun maximal_exact_ratio_join(arg0: vector<u256>, arg1: vector<u256>, arg2: u256) : (u256, vector<u256>) {
        ...
        let v5 = 0;
        while (v5 < v0) {
            let v6 = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(*0x1::vector::borrow<u256>(&arg0, v5), (1000000000000000000 as u256), *0x1::vector::borrow<u256>(&arg1, v5));
            v2 = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::min_u256(v2, v6);
            v3 = 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::min_u256(v3, v6);
        ...
        if (v2 != v3) {
            while (v5 < v0) {
                ...
                0x1::vector::push_back<u256>(&mut v4, *0x1::vector::borrow<u256>(&arg0, v5) - 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(v2, *0x1::vector::borrow<u256>(&arg1, v5), (1000000000000000000 as u256)));
                v5 = v5 + 1;
            };
        } else {
            while (v5 < v0) {
        ...
        (0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(v2, arg2, (1000000000000000000 as u256)), v4)
    }
    ...
    public fun solve_for_invariant(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u256) : u256 {
        0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::mul_div_u256(arg3, 0xa4491edd3a3a63c01e0afb0c81fd7062c7c94c770095958cc1426a714d58d960::math::subtract_mod_u256((1000000000000000000 as u256), calculate_pow(arg0, arg1, arg2, arg4)), (1000000000000000000 as u256))
    }
