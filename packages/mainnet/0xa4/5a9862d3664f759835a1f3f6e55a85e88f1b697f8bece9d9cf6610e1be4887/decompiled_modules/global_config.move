module 0x89b9f7074cc8556a4900509c0cdbb89206d55eb74b48358365224db7653a830c::global_config {
    ...
    public(friend) fun add_sponsor_record(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<0x2::object::ID, u64>(&v1.sponsor_fee_records, v0)) {
            ...
            let v2 = 0x2::table::borrow_mut<0x2::object::ID, u64>(&mut v1.sponsor_fee_records, v0);
            if (!0x2::table::contains<address, bool>(&v1.whitelist, 0x2::tx_context::sender(arg2))) {
