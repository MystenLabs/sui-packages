module 0xa472f2829a2ab4ff3135f2b84fbf48b2dd3e3d5f8ca73e6894e23cb375668d7a::SUIPUMP {
    struct SUIPUMP has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIPUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<SUIPUMP>(arg0, 6, b"SUI PUMP", b"SUI PUMP", b"SUI PUMP", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/MkTLbPnuiUVwNfDvP2pfUUaUEASEM7KlVLonoLB7Cag?ext=png")), arg1);
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<SUIPUMP>(&mut v3, 100000000000000, 0x2::tx_context::sender(arg1), arg1);
