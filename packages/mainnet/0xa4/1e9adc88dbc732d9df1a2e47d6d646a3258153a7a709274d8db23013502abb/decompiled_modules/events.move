module 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::events {
    ...
    struct FinalRewardsForClaimSet has copy, drop {
        pool_id: 0x2::object::ID,
        receiver: address,
        amount: u64,
        expiry: u64,
    ...
    public(friend) fun emit_final_rewards_for_claim_set(arg0: 0x2::object::ID, arg1: address, arg2: u64, arg3: u64) {
        let v0 = FinalRewardsForClaimSet{
            pool_id  : arg0,
            receiver : arg1,
            amount   : arg2,
            expiry   : arg3,
        };
        0x2::event::emit<FinalRewardsForClaimSet>(v0);
    }
