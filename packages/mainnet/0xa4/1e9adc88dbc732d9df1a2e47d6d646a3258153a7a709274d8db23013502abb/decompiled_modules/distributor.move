module 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::distributor {
    ...
    entry fun final_rewards_claim<T0>(arg0: &mut RewardPool<T0>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"final_rewards_for_claim"), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::final_rewards_for_claim_not_set());
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::table::Table<address, vector<vector<u8>>>>(&mut arg0.id, b"final_rewards_for_claim");
        assert!(0x2::table::contains<address, vector<vector<u8>>>(v0, arg1), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::no_rewards_for_user_to_claim());
        let v1 = 0x2::table::remove<address, vector<vector<u8>>>(v0, arg1);
        let v2 = 0;
        while (v2 < 0x1::vector::length<vector<u8>>(&v1)) {
            let (_, _, v5, v6, v7, _) = 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::utils::decode_payload(*0x1::vector::borrow<vector<u8>>(&v1, v2));
            if (!0x2::table::contains<u128, bool>(&arg0.claimed, v7)) {
                if (v5 > 0x2::clock::timestamp_ms(arg2)) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.reward_balance, v6, arg3), arg1);
                    0x2::table::add<u128, bool>(&mut arg0.claimed, v7, true);
                    0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::events::emit_rewards_claimed_event(0x2::object::uid_to_inner(&arg0.id), 0x2::tx_context::sender(arg3), arg1, v6, v7);
                };
            };
            v2 = v2 + 1;
        };
    ...
    entry fun set_final_rewards_for_claim<T0>(arg0: &mut RewardPool<T0>, arg1: vector<vector<u8>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::get_version(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::version_mismatch());
        assert!(arg0.controller == 0x2::tx_context::sender(arg3), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::unauthorized());
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"final_rewards_for_claim")) {
            0x2::dynamic_field::add<vector<u8>, 0x2::table::Table<address, vector<vector<u8>>>>(&mut arg0.id, b"final_rewards_for_claim", 0x2::table::new<address, vector<vector<u8>>>(arg3));
        };
        let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::table::Table<address, vector<vector<u8>>>>(&mut arg0.id, b"final_rewards_for_claim");
        let v1 = 0;
        while (v1 < 0x1::vector::length<vector<u8>>(&arg1)) {
            let v2 = *0x1::vector::borrow<vector<u8>>(&arg1, v1);
            let (v3, v4, v5, v6, v7, v8) = 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::utils::decode_payload(v2);
            assert!(v3 == 0x2::object::uid_to_address(&arg0.id), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::target_address_do_not_match());
            assert!(v8 == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::claim_rewards_payload_type(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::payload_type_do_not_match());
            assert!(v5 > 0x2::clock::timestamp_ms(arg2), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::rewards_expired());
            assert!(!0x2::table::contains<u128, bool>(&arg0.claimed, v7), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::already_claimed());
            if (!0x2::table::contains<address, vector<vector<u8>>>(v0, v4)) {
                0x2::table::add<address, vector<vector<u8>>>(v0, v4, 0x1::vector::empty<vector<u8>>());
            };
            0x1::vector::push_back<vector<u8>>(0x2::table::borrow_mut<address, vector<vector<u8>>>(v0, v4), v2);
            0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::events::emit_final_rewards_for_claim_set(0x2::object::uid_to_inner(&arg0.id), v4, v6, v5);
            v1 = v1 + 1;
        };
    }
