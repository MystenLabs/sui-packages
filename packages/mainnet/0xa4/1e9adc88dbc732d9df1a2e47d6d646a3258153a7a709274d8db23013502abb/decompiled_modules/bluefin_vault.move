module 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::bluefin_vault {
    ...
    entry fun claim_withdrawn_funds<T0>(arg0: &0x2::clock::Clock, arg1: &mut Vault<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.type == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::no_pnl_sharing_vault_type() || arg1.type == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::no_trading_vault_type(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::invalid_vault_type());
    ...
    entry fun create_non_trading_vault<T0>(arg0: &0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::roles::AdminCap, arg1: vector<u8>, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::new(arg4);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = 0x1::string::utf8(arg1);
        let v3 = @0x0;
        let v4 = 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::no_trading_vault_type();
        let v5 = Vault<T0>{
            id                           : v0,
            bank                         : v1,
            bank_account                 : v3,
        ...
        0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::events::emit_created_vault_event(v1, v3, v2, arg3, v3, v3, arg2, v4);
    }
    ...
    entry fun deposit_to_non_trading_vault<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.type == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::no_trading_vault_type(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::invalid_vault_type());
        assert!(!arg0.deposit_paused, 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::deposit_paused());
        arg0.total_locked_amount = arg0.total_locked_amount + arg2;
        assert!(arg0.total_locked_amount < arg0.max_cap, 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::vault_max_cap_reached());
        if (!0x2::table::contains<address, User>(&arg0.users, arg3)) {
            0x2::table::add<address, User>(&mut arg0.users, arg3, create_user());
        };
        let v0 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, arg3);
        v0.amount_locked = v0.amount_locked + arg2;
        assert!(arg2 <= 0x2::coin::value<T0>(arg1), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::insufficient_funds());
        0x2::coin::put<T0>(&mut arg0.coin_balance, 0x2::coin::take<T0>(0x2::coin::balance_mut<T0>(arg1), arg2, arg4));
        arg0.sequence_number = arg0.sequence_number + 1;
        0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::events::emit_funds_deposited_event(0x2::object::uid_to_inner(&arg0.id), 0x2::tx_context::sender(arg4), arg3, arg2, v0.amount_locked, arg0.total_locked_amount, arg0.sequence_number);
    }
    ...
    entry fun final_withdrawal<T0>(arg0: &mut Vault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::get_version(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::version_mismatch());
        ...
        let v1 = 0x2::table::remove<address, User>(&mut arg0.users, v0);
        let v2 = v1.amount_locked + v1.pending_withdrawal;
        assert!(v2 > 0, 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::insufficient_funds());
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.coin_balance, v2, arg1), v0);
        0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::events::emit_funds_withdrawn_event(0x2::object::uid_to_inner(&arg0.id), v0, v2, 0, 0, 0, arg0.sequence_number);
    }
    ...
    entry fun move_funds_across_vaults<T0>(arg0: &0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::roles::AdminCap, arg1: &mut 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::margin_bank::BankV2<T0>, arg2: &mut 0xc9ba51116d85cfbb401043f5e0710ab582c4b9b04a139b7df223f8f06bb66fa5::roles::Sequencer, arg3: &mut Vault<T0>, arg4: &mut Vault<T0>, arg5: vector<address>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg5)) {
            ...
            arg4.total_locked_amount = arg4.total_locked_amount + v4;
    ...
    entry fun request_withdraw_from_vault<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.version == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::get_version(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::version_mismatch());
        assert!(arg0.type == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::no_pnl_sharing_vault_type() || arg0.type == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::no_trading_vault_type(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::invalid_vault_type());
    ...
    entry fun update_vault_holding_account<T0>(arg0: &0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::roles::AdminCap, arg1: &mut Vault<T0>, arg2: address) {
        assert!(arg1.version == 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::get_version(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::version_mismatch());
        assert!(arg1.type != 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::constants::no_trading_vault_type(), 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::action_not_allowed());
        assert!(arg2 != @0x0, 0x9added62ef3a869653ef13e754d51fb62adc9f93e2717d2e23ba1214c4ef8d15::errors::zero_address());
