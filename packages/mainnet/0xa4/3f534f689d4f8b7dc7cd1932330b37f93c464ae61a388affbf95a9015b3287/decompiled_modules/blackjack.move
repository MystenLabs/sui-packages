module 0xa43f534f689d4f8b7dc7cd1932330b37f93c464ae61a388affbf95a9015b3287::blackjack {
    ...
    public fun process_player_move<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut BlackjackConfig, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = borrow_mut_blackjack_table<T0>(arg1, 0x2::tx_context::sender(arg2));
        dealer_move<T0>(arg0, v0, arg2);
    }
