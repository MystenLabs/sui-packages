module 0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::swap {
    struct OrderService has key {
        id: 0x2::object::UID,
        balances: 0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::BalanceBag,
    ...
    public entry fun deposit<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: 0x2::coin::Coin<T0>) {
        ...
        if (!0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::contains<T0>(&arg0.balances)) {
            0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::init_balance<T0>(&mut arg0.balances);
            0x1::vector::push_back<0x1::type_name::TypeName>(&mut arg0.coins, 0x1::type_name::get<T0>());
        };
        0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::join<T0>(&mut arg0.balances, 0x2::coin::into_balance<T0>(arg2));
    }

    public entry fun get_balance<T0>(arg0: &mut OrderService, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::value<T0>(&arg0.balances)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = OrderService{
            ...
            balances : 0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::new(arg0),
    ...
    fun withdraw<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_admin(arg0, arg1);
        assert!(0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::value<T0>(&arg0.balances) >= arg2, 4);
        0x2::coin::from_balance<T0>(0xa42824ba40efd0f3ddab4af1297d85636943873c4284b2b6d643916d1e08666c::balance_bag::split<T0>(&mut arg0.balances, arg2), arg3)
    }
