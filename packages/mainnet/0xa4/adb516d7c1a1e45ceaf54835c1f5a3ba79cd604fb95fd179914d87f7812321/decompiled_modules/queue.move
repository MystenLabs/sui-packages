module 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::queue {
    ...
    public(friend) fun new(arg0: vector<u8>, arg1: address, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: u64, arg6: u64, arg7: 0x2::object::ID, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        if (arg8) {
            let v1 = Queue{
                ...
                existing_oracles          : 0x1::vector::empty<ExistingOracle>(),
    ...
    public(friend) fun add_existing_oracle(arg0: &mut Queue, arg1: vector<u8>, arg2: 0x2::object::ID) {
        ...
        0x1::vector::push_back<ExistingOracle>(&mut arg0.existing_oracles, v0);
    }
    ...
    public fun existing_oracles(arg0: &Queue) : vector<ExistingOracle> {
        arg0.existing_oracles
    }

    public fun existing_oracles_contains(arg0: &Queue, arg1: &vector<u8>) : bool {
        let v0 = 0;
        while (v0 < 0x1::vector::length<ExistingOracle>(&arg0.existing_oracles)) {
            if (0x1::vector::borrow<ExistingOracle>(&arg0.existing_oracles, v0).oracle_key == *arg1) {
                return true
            };
            v0 = v0 + 1;
        };
