module 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::aggregator {
    struct CurrentResult has drop, store {
        result: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal,
        min_timestamp_ms: u64,
        max_timestamp_ms: u64,
        min_result: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal,
        max_result: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal,
        stdev: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal,
        range: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal,
        mean: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal,
    }
    ...
    public(friend) fun new(arg0: 0x2::object::ID, arg1: 0x1::string::String, arg2: address, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: u32, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v1 = CurrentResult{
            result           : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::zero(),
            min_timestamp_ms : 0,
            max_timestamp_ms : 0,
            min_result       : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::zero(),
            max_result       : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::zero(),
            stdev            : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::zero(),
            range            : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::zero(),
            mean             : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::zero(),
        };
        let v2 = UpdateState{
    ...
    public(friend) fun add_result(arg0: &mut Aggregator, arg1: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal, arg2: u64, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock) {
    ...
    fun compute_current_result(arg0: &Aggregator, arg1: u64) : 0x1::option::Option<CurrentResult> {
        ...
        let v6 = 0;
        let v7 = 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::max_value();
        let v8 = 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::zero();
        ...
        while (v17 < 0x1::vector::length<u64>(v16)) {
            ...
            let v19 = 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::value(&v18.result);
            let v20 = 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::neg(&v18.result);
            let v21 = v15 + 1;
            v15 = v21;
            ...
            v6 = v6 + v19;
            let v30 = &v7;
            v7 = 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::min(v30, &v18.result);
            let v31 = &v8;
            v8 = 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::max(v31, &v18.result);
        ...
        let v33 = CurrentResult{
            ...
            min_result       : v7,
            max_result       : v8,
            stdev            : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::new(0x1::u128::sqrt(v13 / (v15 - 1)), false),
            range            : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::sub(&v8, &v7),
            mean             : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::new(v11, false),
        };
    ...
    public fun max_result(arg0: &CurrentResult) : &0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal {
        &arg0.max_result
    }
    ...
    public fun mean(arg0: &CurrentResult) : &0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal {
        &arg0.mean
    }

    fun median_result(arg0: &UpdateState, arg1: &mut vector<u64>) : 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal {
        let v0 = &arg0.results;
        ...
        while (v3 < v4) {
            let v5 = v3;
            while (v3 < v4) {
                if (0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::lt(&0x1::vector::borrow<Update>(v0, *0x1::vector::borrow<u64>(arg1, v3)).result, &0x1::vector::borrow<Update>(v0, *0x1::vector::borrow<u64>(arg1, v4)).result)) {
    ...
    public fun min_result(arg0: &CurrentResult) : &0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal {
        &arg0.min_result
    }
    ...
    public fun range(arg0: &CurrentResult) : &0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal {
        &arg0.range
    }

    public fun result(arg0: &CurrentResult) : &0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal {
        &arg0.result
    }
    ...
    fun set_update(arg0: &mut UpdateState, arg1: 0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal, arg2: 0x2::object::ID, arg3: u64) {
    ...
    public fun stdev(arg0: &CurrentResult) : &0xa4adb516d7c1a1e45ceaf54835c1f5a3ba79cd604fb95fd179914d87f7812321::decimal::Decimal {
        &arg0.stdev
    }
