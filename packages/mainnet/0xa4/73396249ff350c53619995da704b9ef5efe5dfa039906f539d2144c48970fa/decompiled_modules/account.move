module 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::account {
    ...
    public(friend) fun add_integrator_config<T0>(arg0: &mut Account<T0>, arg1: address, arg2: u256) {
        ...
        0x2::dynamic_field::add<0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::keys::IntegratorConfig, IntegratorConfig>(&mut arg0.id, 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::keys::integrator_config(arg1), v0);
        0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::events::emit_added_integrator_config<T0>(arg0.account_id, arg1, arg2);
    }

    public fun check_valid_account_cap<T0, T1>(arg0: &Account<T0>, arg1: &AccountCap<T1>) {
        assert!(has_authority<T0, T1>(arg1, arg0), 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::errors::invalid_account_cap());
    }
    ...
    public(friend) fun consume_policy_and_share_account<T0>(arg0: Account<T0>, arg1: AccountSharePolicy) {
        ...
        assert!(0x2::object::uid_to_inner(&arg0.id) == v0, 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::errors::invalid_share_policy());
    ...
    public(friend) fun create_account<T0>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : (Account<T0>, AccountSharePolicy, AccountCap<ADMIN>) {
        ...
        0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::events::emit_created_account<T0>(v1, 0x2::tx_context::sender(arg1), arg0);
        (v0, v2, v3)
    }
    ...
    public(friend) fun deposit_collateral<T0>(arg0: &mut Account<T0>, arg1: 0x2::coin::Coin<T0>) {
        ...
        0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::events::emit_deposited_collateral<T0>(arg0.account_id, v0);
    }
    ...
    public fun get_integrator_config<T0>(arg0: &Account<T0>, arg1: address) : &IntegratorConfig {
        0x2::dynamic_field::borrow<0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::keys::IntegratorConfig, IntegratorConfig>(&arg0.id, 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::keys::integrator_config(arg1))
    }
    ...
    public(friend) fun new_assistant_account_cap<T0>(arg0: &mut Account<T0>, arg1: &mut 0x2::tx_context::TxContext) : AccountCap<ASSISTANT> {
        assert!(0x1::vector::length<0x2::object::ID>(&arg0.active_assistants) < 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::constants::max_assistats_per_account(), 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::errors::too_many_assistants_per_account());
        ...
        0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::events::emit_created_assistant_account_cap(arg0.account_id, 0x2::object::uid_to_inner(&v0.id));
        v0
    }

    public(friend) fun remove_integrator_config<T0>(arg0: &mut Account<T0>, arg1: address) {
        let IntegratorConfig {  } = 0x2::dynamic_field::remove<0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::keys::IntegratorConfig, IntegratorConfig>(&mut arg0.id, 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::keys::integrator_config(arg1));
        0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::events::emit_removed_integrator_config<T0>(arg0.account_id, arg1);
    }
    ...
    public(friend) fun revoke_assistant_account_cap<T0>(arg0: &mut Account<T0>, arg1: 0x2::object::ID) {
        ...
        while (v1 < 0x1::vector::length<0x2::object::ID>(v0)) {
            if (*0x1::vector::borrow<0x2::object::ID>(v0, v1) == arg1) {
                ...
                0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::events::emit_revoked_assistant_account_cap(arg0.account_id, arg1);
                return
            };
            v1 = v1 + 1;
        };
    ...
    public(friend) fun withdraw_collateral<T0>(arg0: &mut Account<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg1 != 0, 0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::errors::deposit_or_withdraw_amount_zero());
        0xa473396249ff350c53619995da704b9ef5efe5dfa039906f539d2144c48970fa::events::emit_withdrew_collateral<T0>(arg0.account_id, arg1);
