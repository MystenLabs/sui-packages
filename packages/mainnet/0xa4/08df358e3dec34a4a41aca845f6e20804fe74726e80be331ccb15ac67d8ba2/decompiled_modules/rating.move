module 0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::rating {
    ...
    public entry fun rating_and_comment(arg0: &mut 0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::Community, arg1: u64, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::update_total_comments(arg0, arg4);
        0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::update_total_reviewers(arg0, arg1, arg4);
        0x2::transfer::public_transfer<RateAndComment>(v0, 0x2::tx_context::sender(arg4));
    }

    public entry fun reply_comment(arg0: &mut 0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::Community, arg1: &mut RateAndComment, arg2: 0x1::string::String, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = CommentChild{
            id          : 0x2::object::new(arg4),
            comment     : arg2,
            is_hidden   : 0,
