module 0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::qanda {
    ...
    public entry fun question(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
            ...
            owner           : 0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::get_address_admin(),
    ...
    public entry fun question_by_admin(arg0: &mut 0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::Community, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = Qanda{
    ...
    public entry fun reply_qanda(arg0: &mut 0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::Community, arg1: address, arg2: &mut Qanda, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        0xa408df358e3dec34a4a41aca845f6e20804fe74726e80be331ccb15ac67d8ba2::community::validate_owner_community(arg0, arg4);
        let v0 = CommentChild{
