module 0xa42ea0a06c903fe500d4754c89a83ddb5d965c1edb7c0d36f7cb82a058499e6a::reward2353 {
    struct REWARD2353 has drop {
        dummy_field: bool,
    }

    struct TICKET_2353 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2353(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2353>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2353>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2353, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2353>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2353>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2353>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2353>>(v5, 0x2::tx_context::sender(arg1));
    }
