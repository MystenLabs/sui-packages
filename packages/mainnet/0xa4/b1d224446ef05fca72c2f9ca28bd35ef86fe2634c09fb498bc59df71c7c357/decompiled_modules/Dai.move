module 0xa4b1d224446ef05fca72c2f9ca28bd35ef86fe2634c09fb498bc59df71c7c357::Dai {
    struct DAI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DAI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DAI>(arg0, 9, b"TOKEN_B", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
