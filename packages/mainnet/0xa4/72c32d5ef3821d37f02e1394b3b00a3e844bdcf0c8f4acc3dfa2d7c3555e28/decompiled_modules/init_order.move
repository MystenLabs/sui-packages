module 0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::init_order {
    ...
    public fun initialize_order<T0>(arg0: &mut 0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::state::State, arg1: &0x2::coin::CoinMetadata<T0>, arg2: InitOrderTicket<T0>, arg3: 0x52646a9931b961c292e202dd8cd36351a9ac74912e71cdd6694e3515546b63c5::calculate_swift_fee::SwiftInitParams, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::state::is_paused(arg0), 0);
        ...
        let v21 = 0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::amount::normalize_amount(0x2::balance::value<T0>(&v19), 0x2::coin::get_decimals<T0>(arg1));
        assert!(v21 > v8 + v9, 3);
        ...
        let v25 = 0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::order::new(v0, v1, 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::state::chain_id(), v23, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v24, v14, v15, v16, v17, v18);
        let v26 = 0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::order::to_hash(&v25);
        assert!(!0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::state::has_source_order(arg0, v26), 1);
        assert!(!0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::state::has_dest_order(arg0, v26), 1);
        let (v27, v28) = 0xa472c32d5ef3821d37f02e1394b3b00a3e844bdcf0c8f4acc3dfa2d7c3555e28::state::add_source_order<T0>(arg0, v19, v26, v1, v23, v4, v8, v9, arg4);
    ...
    public fun log_initialize_order<T0>(arg0: &0x2::coin::Coin<T0>, arg1: &0x2::coin::CoinMetadata<T0>, arg2: vector<u8>) {
    ...
    public fun preapare_initialize_order<T0>(arg0: u8, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: address, arg5: u16, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u16, arg13: address, arg14: u8, arg15: u8, arg16: u64, arg17: u64, arg18: address, arg19: address) : InitOrderTicket<T0> {
