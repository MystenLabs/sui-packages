module 0xa4aa409e457a4bb2e5190c126827c2e2f11f86e055a9c5c18a77b7ec33f28e5a::xxo {
    struct XXO has drop {
        dummy_field: bool,
    }

    fun init(arg0: XXO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/mmjhxxCUYhEVjvfT13nou-zYwJ88hFwdppohoQVaLQg";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/mmjhxxCUYhEVjvfT13nou-zYwJ88hFwdppohoQVaLQg"))
        };
