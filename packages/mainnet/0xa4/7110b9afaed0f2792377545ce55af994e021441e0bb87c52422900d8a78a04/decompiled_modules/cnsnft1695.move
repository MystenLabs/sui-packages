module 0xa47110b9afaed0f2792377545ce55af994e021441e0bb87c52422900d8a78a04::cnsnft1695 {
    struct CNSNFT1695 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1695, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5540"));
        let v4 = 0x2::package::claim<CNSNFT1695>(arg0, arg1);
