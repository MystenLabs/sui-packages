module 0xb7d3fd091e3fef1cf80f8a69f4675fbf3ae549249553deb29ff99884c6a4dda5::wolf {
    ...
    fun init(arg0: WOLF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<WOLF>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WOLF    ")))), trim_right(b"Wolfius Maximus of SUI          "), trim_right(b"Wolfius Maximus of Solstreet                                                                                                                                                                                                                                                                                                    "), v2, arg1);
