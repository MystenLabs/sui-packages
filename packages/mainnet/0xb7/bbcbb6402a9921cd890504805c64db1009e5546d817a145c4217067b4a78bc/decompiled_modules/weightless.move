module 0xb7bbcbb6402a9921cd890504805c64db1009e5546d817a145c4217067b4a78bc::weightless {
    ...
    public entry fun create_vault<T0>(arg0: 0x2::coin::TreasuryCap<WEIGHTLESS>, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = CopyVault<T0>{
    ...
    public entry fun verify_x_handle<T0>(arg0: &mut CopyVault<T0>, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.x_verifier, 4);
        assert!(!arg0.x_verified, 5);
        arg0.x_handle = arg1;
        arg0.x_verified = true;
    ...
    public fun x_verifier<T0>(arg0: &CopyVault<T0>) : address {
        arg0.x_verifier
    }
