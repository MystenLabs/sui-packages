module 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::cetus_investor {
    ...
    public(friend) fun get_balances_in_ratio<T0, T1>(arg0: &mut Investor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool) : (u128, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (v4 <= v5) {
            if (arg4 == false) {
                assert!(((v5 - v4) as u128) * 1000000000 / (v5 as u128) <= 1000000, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::difference_too_high());
            };
            ...
            assert!(v10 <= v12, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::insufficient_balance_to_add_liquidity());
            if (arg4 == false) {
                assert!(((v12 - v10) as u128) * 1000000000 / (v12 as u128) <= 1000000, 0xb7e3e3759b3e2bde75c1abc169b182fa6ba9292728210b2931c0848cfc62cb1c::error::difference_too_high());
            };
