module 0xb74fbebffff623bc5e6e7073240150032d1257846da176548b858d5294cc2d54::market_position {
    ...
    public fun edit_lp_position_unsafe(arg0: u64, arg1: &mut MarketPosition, arg2: &mut 0x2::tx_context::TxContext) {
        arg1.lp_amount = arg0;
    }
    ...
    public fun join(arg0: &mut MarketPosition, arg1: MarketPosition, arg2: &0x2::clock::Clock) {
        assert!(market_state_id(arg0) == market_state_id(&arg1), 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::market_invalid_market_position());
    ...
    public(friend) fun update_lp_display<T0: drop>(arg0: &mut MarketPosition, arg1: &0xb74fbebffff623bc5e6e7073240150032d1257846da176548b858d5294cc2d54::py::PyState<T0>) {
        let v0 = 9;
        if (0x2::dynamic_field::exists_<0x1::type_name::TypeName>(0xb74fbebffff623bc5e6e7073240150032d1257846da176548b858d5294cc2d54::py::get_state_id<T0>(arg1), 0x1::type_name::with_defining_ids<T0>())) {
            v0 = *0x2::dynamic_field::borrow<0x1::type_name::TypeName, u8>(0xb74fbebffff623bc5e6e7073240150032d1257846da176548b858d5294cc2d54::py::get_state_id<T0>(arg1), 0x1::type_name::with_defining_ids<T0>());
        };
