module 0xb74fbebffff623bc5e6e7073240150032d1257846da176548b858d5294cc2d54::farming_reward {
    struct RewardPool has store {
        vault: 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::BalanceBag,
    ...
    public(friend) fun add_rewarder<T0: drop>(arg0: 0x1::type_name::TypeName, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &mut RewardPool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        if (!0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::contains<T0>(&arg4.vault)) {
            0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::init_balance<T0>(&mut arg4.vault);
        };
        0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::join<T0>(&mut arg4.vault, 0x2::coin::into_balance<T0>(arg1));
    ...
    public fun borrow_pool_vault(arg0: &RewardPool) : &0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::BalanceBag {
        &arg0.vault
    }
    ...
    public(friend) fun claim_rewarder<T0: drop>(arg0: u64, arg1: &mut RewardPool, arg2: &mut 0x2::vec_map::VecMap<0x2::object::ID, u256>, arg3: &mut 0x2::vec_map::VecMap<0x2::object::ID, u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        while (!0x1::vector::is_empty<0x2::object::ID>(&v1)) {
            ...
            if (v12 > 0) {
                0x2::coin::join<T0>(&mut v2, 0x2::coin::from_balance<T0>(0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::split<T0>(&mut arg1.vault, v12), arg5));
    ...
    public(friend) fun emergency_withdraw_rewarder<T0: drop>(arg0: &mut RewardPool, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        v0.active = false;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::split<T0>(&mut arg0.vault, v1), arg3), v0.owner);
        v1
    }

    public(friend) fun enable_rewarder(arg0: &mut RewardPool, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::vec_map::get_mut<0x2::object::ID, PoolRewarderInfo>(&mut arg0.rewarders, &arg1);
        assert!(v0.owner == 0x2::tx_context::sender(arg2), 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::acl_invalid_permission());
        assert!(v0.active == false, 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::pool_rewarder_already_active());
        v0.active = true;
    }
    ...
    public fun init_reward_pool(arg0: &mut 0x2::tx_context::TxContext) : RewardPool {
        RewardPool{
            vault              : 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::new(arg0),
    ...
    public(friend) fun stop_rewarder(arg0: &mut RewardPool, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::vec_map::get_mut<0x2::object::ID, PoolRewarderInfo>(&mut arg0.rewarders, &arg1);
        assert!(v0.owner == 0x2::tx_context::sender(arg2), 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::acl_invalid_permission());
        assert!(v0.active == true, 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::pool_rewarder_not_active());
        v0.active = false;
    }
    ...
    public(friend) fun supplement_additional_reward_token<T0: drop>(arg0: &mut RewardPool, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock) {
        ...
        0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::join<T0>(&mut arg0.vault, 0x2::coin::into_balance<T0>(arg2));
    }
    ...
    public(friend) fun update_rewarder<T0: drop>(arg0: &mut RewardPool, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::vec_map::get_mut<0x2::object::ID, PoolRewarderInfo>(&mut arg0.rewarders, &arg1);
        assert!(v0.active == true, 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::pool_rewarder_not_active());
        assert!((arg3 - v0.start_time) / 1000 * arg2 - v0.total_reward <= 0x2::coin::value<T0>(&arg4), 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::emission_exceeds_total_reward());
        assert!(0x1::type_name::with_defining_ids<T0>() == v0.reward_token, 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::reward_token_type_mismatch());
        assert!(v0.owner == 0x2::tx_context::sender(arg6), 0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::error::acl_invalid_permission());
        0xc42c2c2503a8a1ad3f20e351b958d30aaba8635d21c2fe0e858ed4834314df9::balance_bag::join<T0>(&mut arg0.vault, 0x2::coin::into_balance<T0>(arg4));
