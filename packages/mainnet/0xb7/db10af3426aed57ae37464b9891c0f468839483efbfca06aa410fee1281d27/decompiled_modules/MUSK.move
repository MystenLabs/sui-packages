module 0xb7db10af3426aed57ae37464b9891c0f468839483efbfca06aa410fee1281d27::MUSK {
    struct MUSK has drop {
        dummy_field: bool,
    }

    fun init(arg0: MUSK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MUSK>(arg0, 9, b"POLO", b"Polo Lolo", b"Polo Lolo Boost", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
