module 0xb3f10f2c9a52b615ab8b0b930ee55e019bacb407b29f5f534e6d9c3291341db8::utils {
    ...
    public fun try_get_bottle_by_account<T0>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg1: &0x2::clock::Clock, arg2: address) : 0x1::option::Option<BottleData> {
        let v0 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::borrow_bucket<T0>(arg0);
        if (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::bottle_exists<T0>(v0, arg2)) {
            let (v2, v3) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_bottle_info_with_interest_by_debtor<T0>(v0, arg2, arg1);
            let v4 = BottleData{
                debtor      : arg2,
                coll_amount : v2,
                debt_amount : v3,
            };
            0x1::option::some<BottleData>(v4)
        } else if (0x2::table::contains<address, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::Bottle>(0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::borrow_surplus_bottle_table<T0>(v0), arg2)) {
            let (v5, v6) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket::get_surplus_bottle_info_by_debtor<T0>(v0, arg2);
            let v7 = BottleData{
                debtor      : arg2,
                coll_amount : v5,
                debt_amount : v6,
            };
            0x1::option::some<BottleData>(v7)
        } else {
            0x1::option::none<BottleData>()
        }
    }

    public fun try_get_bottle_by_proof<T0, T1>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg1: &0x2::clock::Clock, arg2: &0x5d019c033bb8051fe9631cf910d0f4d077364d64ed4bb1940e98e6dc419a8d59::fountain::StakeProof<T0, T1>) : 0x1::option::Option<BottleData> {
        let v0 = 0x5d019c033bb8051fe9631cf910d0f4d077364d64ed4bb1940e98e6dc419a8d59::fountain::strap_address<T0, T1>(arg2);
        let v1 = try_get_bottle_by_account<T0>(arg0, arg1, v0);
        if (0x1::option::is_some<BottleData>(&v1)) {
            v1
        } else {
            0x1::option::destroy_none<BottleData>(v1);
            let v3 = BottleData{
                debtor      : v0,
                coll_amount : 0,
                debt_amount : 0,
            };
            0x1::option::some<BottleData>(v3)
        }
    }

    public fun try_get_bottle_by_strap<T0>(arg0: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::buck::BucketProtocol, arg1: &0x2::clock::Clock, arg2: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::strap::BottleStrap<T0>) : 0x1::option::Option<BottleData> {
