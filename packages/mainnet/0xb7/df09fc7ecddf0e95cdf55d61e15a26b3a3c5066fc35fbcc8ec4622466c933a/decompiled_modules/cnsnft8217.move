module 0xb7df09fc7ecddf0e95cdf55d61e15a26b3a3c5066fc35fbcc8ec4622466c933a::cnsnft8217 {
    struct CNSNFT8217 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8217, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8217>(arg0, arg1);
