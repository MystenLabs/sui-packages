module 0xb79152e5100a5760dcd3b602adc46e704f247e8bd2d7fce8612963f8bd9ee861::trumpxbt {
    ...
    fun init(arg0: TRUMPXBT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/YntfLjcUR3bpq5dc4kAqipmpA2vfXajzcFLZztGpump.png?size=lg&key=1f1602                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<TRUMPXBT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"TRUMPXBT")))), trim_right(b"Trump XBT                       "), trim_right(b"TRUMPXBT - an AI voice of Trump, dropping market-shaking tweets 24/7. Built to win, programmed to pump!                                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
