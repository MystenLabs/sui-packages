module 0xb76ed338286c59db05fdbad8163bd759afc49f1626aa3dd62759283dac903f82::reward7312 {
    struct REWARD7312 has drop {
        dummy_field: bool,
    }

    struct TICKET_7312 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7312(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7312>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7312>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7312, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7312>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7312>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7312>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7312>>(v5, 0x2::tx_context::sender(arg1));
    }
