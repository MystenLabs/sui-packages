module 0xad248eb3e370c6e969dd5cd71d5e9dd39cec207f32005aba7549cacf6231762f::pool {
    ...
    public fun newFoo(arg0: u64, arg1: u64) : Foo {
        Foo{
            a : arg0,
            b : arg1,
        }
    ...
    public fun newKek(arg0: u64, arg1: u64) : Kek {
        Kek{
            c : arg0,
            d : arg1,
        }
