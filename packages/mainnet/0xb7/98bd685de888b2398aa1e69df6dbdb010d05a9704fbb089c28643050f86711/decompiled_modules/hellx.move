module 0xb798bd685de888b2398aa1e69df6dbdb010d05a9704fbb089c28643050f86711::hellx {
    ...
    fun init(arg0: HELLX, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HELLX>(arg0, 9, b"hellx", b"HELLX", b"hell is x", 0x1::option::none<0x2::url::Url>(), arg1);
