module 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::sudoz_artifacts_v2 {
    ...
    struct GlobalStats has key {
        ...
        evolution_auth: 0x1::option::Option<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>,
    }
    ...
    public fun disable_evolution_system(arg0: &AdminCap, arg1: &mut GlobalStats) : 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth {
        arg1.burn_mechanisms_enabled = false;
        0x1::option::extract<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(&mut arg1.evolution_auth)
    }
    ...
    public fun enable_burn_mechanisms(arg0: &AdminCap, arg1: &mut GlobalStats, arg2: &0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedStats) {
        assert!(0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::get_evolved_minted(arg2) >= 5555, 7);
        arg1.burn_mechanisms_enabled = true;
    }

    public entry fun enable_evolution_system(arg0: &AdminCap, arg1: &mut GlobalStats, arg2: 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth) {
        arg1.burn_mechanisms_enabled = true;
        0x1::option::fill<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(&mut arg1.evolution_auth, arg2);
    }

    public entry fun entry_evolve_artifact(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedStats, arg3: &0x2::random::Random, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut 0x2::tx_context::TxContext) {
        evolve_artifact(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
    }

    public entry fun entry_evolve_artifact_with_policy(arg0: SudozArtifact, arg1: &0x2::transfer_policy::TransferPolicy<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedSudoz>, arg2: &mut GlobalStats, arg3: &mut 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedStats, arg4: &0x2::random::Random, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: &mut 0x2::tx_context::TxContext) {
    ...
    public fun evolve_artifact(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedStats, arg3: &0x2::random::Random, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_some<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), 7);
        let v10 = 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::mint_evolved_for_evolution(0x1::option::borrow<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), v0, *0x1::option::borrow<u8>(&arg0.path), arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
        let v11 = ArtifactBurnedForEvolved{
            artifact_id     : 0x2::object::uid_to_inner(&arg0.id),
            evolved_id      : 0x2::object::id<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedSudoz>(&v10),
            artifact_number : v0,
            evolved_number  : 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::get_evolved_number(&v10),
        };
        0x2::event::emit<ArtifactBurnedForEvolved>(v11);
        0x2::transfer::public_transfer<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedSudoz>(v10, 0x2::tx_context::sender(arg12));
    }

    public entry fun evolve_artifact_to_kiosk(arg0: SudozArtifact, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedSudoz>, arg4: &mut GlobalStats, arg5: &mut 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedStats, arg6: &0x2::random::Random, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: 0x1::string::String, arg14: 0x1::string::String, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_some<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(&arg4.evolution_auth), 7);
        ...
        0x2::kiosk::lock<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedSudoz>(arg1, arg2, arg3, v10);
        let v11 = ArtifactBurnedForEvolved{
    ...
    public fun evolve_artifact_with_policy(arg0: SudozArtifact, arg1: &0x2::transfer_policy::TransferPolicy<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedSudoz>, arg2: &mut GlobalStats, arg3: &mut 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedStats, arg4: &0x2::random::Random, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.level == 10, 8);
        let v0 = arg0.number;
        ...
        assert!(0x1::option::is_some<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(&arg2.evolution_auth), 7);
        ...
        let v13 = v12;
        let v14 = v11;
        0x2::kiosk::lock<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolvedSudoz>(&mut v14, &v13, arg1, v10);
    ...
    fun init(arg0: SUDOZ_ARTIFACTS_V2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = GlobalStats{
            ...
            evolution_auth          : 0x1::option::none<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(),
        };
    ...
    public entry fun store_evolution_auth(arg0: &AdminCap, arg1: &mut GlobalStats, arg2: 0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth, arg3: &mut 0x2::tx_context::TxContext) {
        0x1::option::fill<0xb7df9e4a5ce0c9097271a59cd1e5702a9c730480de76db18c8efc58f4809336f::evolved_sudoz::EvolutionAuth>(&mut arg1.evolution_auth, arg2);
    }
