module 0xb763668eb721db450472a206b9f51d51772d59679eeac78a632eba547cfea526::gusd2 {
    ...
    fun init(arg0: GUSD2, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin_registry::new_currency_with_otw<GUSD2>(arg0, 9, 0x1::string::utf8(b"GUSD2"), 0x1::string::utf8(b"Generalized USD v2"), 0x1::string::utf8(b"GUSD2 vault token with instant withdrawals"), 0x1::string::utf8(b"https://aftermath.finance/gusd.png"), arg1);
