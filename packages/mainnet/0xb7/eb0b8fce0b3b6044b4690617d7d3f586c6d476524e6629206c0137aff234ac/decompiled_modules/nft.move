module 0xb7eb0b8fce0b3b6044b4690617d7d3f586c6d476524e6629206c0137aff234ac::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun burn_nft(arg0: TicketNFT, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == @0x2448cfc1dd831cb6733096dd0ad2c8f8ec90e86f8462e29b9f2224e9a0842ddb, 1);
        let TicketNFT {
            id          : v0,
            name        : _,
            description : _,
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        if (0x2::tx_context::sender(arg3) != @0x2448cfc1dd831cb6733096dd0ad2c8f8ec90e86f8462e29b9f2224e9a0842ddb) {
            abort 1
        };
        let v0 = TicketNFT{
