module 0xb75d93fa4d04dc263c612cb06022f2441fd95ffbf7025182f5090ddb3453a5fc::strategy {
    ...
    public fun new(arg0: vector<u8>, arg1: vector<u8>, arg2: u8, arg3: u8, arg4: address, arg5: &vector<address>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        let v1;
        while (v0 < 0x1::vector::length<address>(arg5)) {
            if (*0x1::vector::borrow<address>(arg5, v0) == arg4) {
                ...
                let v2 = Strategy{
                    ...
                    current_admin            : arg4,
                    completed                : false,
                    create_timestamp_ms      : 0x2::clock::timestamp_ms(arg6),
                    last_update_timestamp_ms : 0x2::clock::timestamp_ms(arg6),
