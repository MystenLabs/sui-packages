module 0xae8bcbc58ed4958d5f76e47ea1a22e9cbc8f9594b6ac39d3a4fb1f38fa62cdbc::navi_adapter {
    ...
    public fun new_navi_state<T0: drop>(arg0: &mut NaviVault, arg1: 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<T0, Navi>, arg2: &mut 0x2::tx_context::TxContext) : (NaviState, 0x777766ca12cd15f493bc72b315288b6552aead358620425172fc9c284b747a0f::message::Message<Navi, T0>) {
        ...
        while (0x1::vector::length<0x1::ascii::String>(&v3) > 0) {
            ...
            add_amount(v5, v4, 0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::ceil(0xb6cb55601fd59efd9e3ab08cb0b9e8af4ecc45ca6a7ee03339799978ba3e6445::float::mul_u64(v0, *0x2::vec_map::get<0x1::ascii::String, u64>(&arg0.record.reward, &v4))));
        };
