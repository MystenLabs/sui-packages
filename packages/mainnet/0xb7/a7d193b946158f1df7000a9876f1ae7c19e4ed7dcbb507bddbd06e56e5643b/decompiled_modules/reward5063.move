module 0xb7a7d193b946158f1df7000a9876f1ae7c19e4ed7dcbb507bddbd06e56e5643b::reward5063 {
    struct REWARD5063 has drop {
        dummy_field: bool,
    }

    struct TICKET_5063 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5063(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5063>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5063>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5063, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5063>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5063>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5063>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5063>>(v5, 0x2::tx_context::sender(arg1));
    }
