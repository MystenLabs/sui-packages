module 0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::dao {
    ...
    public entry fun cancel_purchase<T0>(arg0: &mut DAOFund<T0>, arg1: &mut 0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::dao_config::GlobalDaoFee, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = v6 / 10;
        arg0.current_raise = arg0.current_raise - v6;
        let v8 = v6 - v7;
        ...
        let (_, _, v11) = 0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::dao_config::get_dao_fee_config(arg1);
    ...
    public entry fun commit<T0>(arg0: &mut DAOFund<T0>, arg1: u64, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.current_raise < v0, 1006);
        let v1 = if (arg0.current_raise + arg1 > v0) {
            v0 - arg0.current_raise
        } else {
            arg1
        };
        if (!is_existed_user_dao<T0>(arg0, 0x2::tx_context::sender(arg4))) {
            assert!(v1 <= arg0.max_purchase_amount, 1007);
            assert!(v1 >= arg0.min_purchase_amount, 1022);
            let v2 = UserDAO{
                dao_type               : 0x1::string::utf8(b"fcfs"),
                max_committable_amount : arg0.max_purchase_amount,
                total_committed_amount : v1,
                is_claim               : false,
                is_refund              : false,
            };
            0x2::table::add<address, UserDAO>(&mut arg0.tracked_addresses, 0x2::tx_context::sender(arg4), v2);
        } else {
            let v3 = 0x2::table::borrow_mut<address, UserDAO>(&mut arg0.tracked_addresses, 0x2::tx_context::sender(arg4));
            let v4 = v3.max_committable_amount;
            if (v3.dao_type == 0x1::string::utf8(b"fcfs")) {
                v4 = arg0.max_purchase_amount;
            };
            assert!(v3.total_committed_amount + v1 <= v4, 1007);
            v3.total_committed_amount = v3.total_committed_amount + v1;
        };
        arg0.current_raise = arg0.current_raise + v1;
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v1, arg4)));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg2, 0x2::tx_context::sender(arg4));
        let v5 = CommittedEvent{
            dao_fund_id : 0x2::object::id<DAOFund<T0>>(arg0),
            sender      : 0x2::tx_context::sender(arg4),
            amount      : v1,
        };
        0x2::event::emit<CommittedEvent>(v5);
    }

    public entry fun create_dao_fund<T0>(arg0: &DAOSeller, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: u64, arg10: 0x2::coin::Coin<T0>, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        assert!(is_existed_seller_dao(arg0, 0x2::tx_context::sender(arg16)), 1021);
        assert!(0x2::coin::value<T0>(&arg10) == arg9, 1005);
        assert!(arg11 >= 0x2::clock::timestamp_ms(arg15), 1015);
        let v0 = calculate_price(arg9, arg12);
        let v1 = DAOFund<T0>{
            ...
            start_at              : arg11,
            dao_end_at            : arg11 + 31536000000,
            fundraise_end_at      : arg11 + 604800000,
            price                 : v0,
            fundraise_goal        : arg12,
            current_raise         : 0,
            balance               : 0x2::balance::zero<0x2::sui::SUI>(),
            phase                 : 0x1::string::utf8(b"whitelist"),
            fundraise_status      : 0x1::string::utf8(b"fundraising"),
            tracked_addresses     : 0x2::table::new<address, UserDAO>(arg16),
            dao_token_balance     : 0x2::coin::into_balance<T0>(arg10),
            min_purchase_amount   : arg13,
            max_purchase_amount   : arg14,
        ...
        0x2::transfer::transfer<AdminCap>(v4, 0x2::tx_context::sender(arg16));
    ...
    public entry fun finalize_dao<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.dao_fund_id == 0x2::object::id<DAOFund<T0>>(arg1), 1013);
        ...
        if (arg1.dao_end_at > 0) {
            0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::lock::lock_nft_to<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v14, arg1.creator, 31536000000, arg6, arg7);
        } else {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::dao_config::new_global_dao_fee_and_shared(arg0);
        let v1 = DAOSeller{
    ...
    public entry fun operator_change_fund_refund_status<T0>(arg0: &OperatorCap, arg1: &mut DAOFund<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.fundraise_status = 0x1::string::utf8(b"refunded");
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: address, arg5: &0x2::tx_context::TxContext) {
        0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::dao_config::set_platform_fee(arg1, arg2, arg3, arg4, arg5);
    }
    ...
    public fun unlock_nft<T0: store + key>(arg0: 0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::lock::LockedNFT<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::lock::unlock_nft<T0>(arg0, arg1, arg2);
    }

    public fun unlock_nft_by_operator<T0: store + key>(arg0: &OperatorCap, arg1: 0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::lock::LockedNFT<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::lock::unlock_nft_by_operator<T0>(arg1, arg2);
    }

    public entry fun update_dao_fund<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.dao_fund_id == 0x2::object::id<DAOFund<T0>>(arg1), 1013);
        assert!(arg10 >= 0x2::clock::timestamp_ms(arg14), 1015);
        let v0 = calculate_price(arg1.total_supply, arg11);
        arg1.name = arg2;
        arg1.symbol = arg3;
        arg1.description = arg4;
        arg1.icon_url = arg5;
        arg1.start_at = arg10;
        arg1.fundraise_goal = arg11;
        arg1.dao_end_at = arg10 + 31536000000;
        arg1.fundraise_end_at = arg10 + 604800000;
        arg1.price = v0;
        arg1.min_purchase_amount = arg12;
        arg1.max_purchase_amount = arg13;
        arg1.twitter = arg6;
        arg1.telegram = arg7;
        arg1.website = arg8;
        arg1.user_id = arg9;
