module 0xb79de848e6e336e2a65851aff186c5a57782910dd013ee443b32b2cbe549a33e::lock {
    ...
    public(friend) fun lock_nft_to<T0: store + key>(arg0: T0, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun unlock_nft<T0: store + key>(arg0: LockedNFT<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun unlock_nft_by_operator<T0: store + key>(arg0: LockedNFT<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let LockedNFT {
            id            : v0,
            nft           : v1,
            locked_at     : _,
        ...
        0x2::transfer::public_transfer<T0>(v1, 0x2::tx_context::sender(arg1));
