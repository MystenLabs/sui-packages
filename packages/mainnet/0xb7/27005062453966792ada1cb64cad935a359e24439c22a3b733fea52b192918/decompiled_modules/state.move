module 0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::state {
    struct State has store, key {
        id: 0x2::object::UID,
        emitter_cap: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::emitter::EmitterCap,
        relayer_fee: 0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::relayer_fee::RelayerFee,
    ...
    public(friend) fun new(arg0: &0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::state::State, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : State {
        State{
            ...
            relayer_fee       : 0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::relayer_fee::new(arg1, arg2),
    ...
    public fun fee_precision(arg0: &State) : u64 {
        0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::relayer_fee::precision(&arg0.relayer_fee)
    }

    public fun fee_value(arg0: &State) : u64 {
        0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::relayer_fee::value(&arg0.relayer_fee)
    }
    ...
    public fun get_relayer_fee(arg0: &State, arg1: u64) : u64 {
        0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::relayer_fee::compute(&arg0.relayer_fee, arg1)
    }
    ...
    public(friend) fun register_foreign_contract(arg0: &mut State, arg1: u16, arg2: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress) {
        if (contract_registered(arg0, arg1)) {
            0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::foreign_contracts::update(&mut arg0.foreign_contracts, arg1, arg2);
        } else {
            0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::foreign_contracts::add(&mut arg0.foreign_contracts, arg1, arg2);
        };
    }

    public(friend) fun update_relayer_fee(arg0: &mut State, arg1: u64, arg2: u64) {
        0xb727005062453966792ada1cb64cad935a359e24439c22a3b733fea52b192918::relayer_fee::update(&mut arg0.relayer_fee, arg1, arg2);
    }
