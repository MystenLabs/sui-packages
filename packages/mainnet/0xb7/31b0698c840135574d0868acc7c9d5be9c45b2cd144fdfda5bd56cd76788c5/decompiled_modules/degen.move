module 0xb731b0698c840135574d0868acc7c9d5be9c45b2cd144fdfda5bd56cd76788c5::degen {
    ...
    fun init(arg0: DEGEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/Cv5w6oLCquS4M3WN7DcwFrFiCCJwiL31MCJu3jTXpump.png?size=lg&key=b6f8f8                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DEGEN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Degen   ")))), trim_right(b"Degen Cartman                   "), trim_right(b"Step aside and let a true crypto mastermind do his thing. Respect my decentralized authority!                                                                                                                                                                                                                                   "), v2, arg1);
        let v5 = v3;
