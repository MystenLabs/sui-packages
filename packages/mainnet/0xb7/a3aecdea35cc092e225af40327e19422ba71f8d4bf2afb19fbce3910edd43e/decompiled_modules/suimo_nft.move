module 0xb7a3aecdea35cc092e225af40327e19422ba71f8d4bf2afb19fbce3910edd43e::suimo_nft {
    ...
    fun init(arg0: SUIMO_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://twitter.com/martian_wallet"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{img_url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"You Martian Champion!"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://twitter.com/martian_wallet"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Martian"));
        ...
        let v6 = Collection{
            ...
            name         : 0x1::string::utf8(b"Winner Martian SuiLLioner"),
            description  : 0x1::string::utf8(b"You Martian Champion! In the intellectual game SuiLLioner."),
            base_url     : 0x1::string::utf8(b"ipfs://QmaiDh56ihoosfgZZYE9NNrmxp7LFc1BRfo1RnT4LzyDdE/"),
            total        : 505,
            current      : 0,
