module 0xb7f3fd145cf03855d76e0c7778d518d3d1ee7d854605c422c15677261024facc::adidas_x_xociety {
    ...
    fun init(arg0: ADIDAS_X_XOCIETY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Something extraordinary is on the horizon. Adidas, a name synonymous with athletic excellence, is joining forces with the immersive world of XOCIETY. This unprecedented collaboration, which will be revealed on May 8th, promises to deliver unique experiences and set a new benchmark. Stay tuned for a partnership that will redefine impact."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihm4e2t5pkb4pvoncvfbhnbxsjvzkazqukplbmkuunvlyug7lsmla"));
