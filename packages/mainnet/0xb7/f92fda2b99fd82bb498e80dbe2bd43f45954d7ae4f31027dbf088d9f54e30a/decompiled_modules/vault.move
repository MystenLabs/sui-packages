module 0xb7f92fda2b99fd82bb498e80dbe2bd43f45954d7ae4f31027dbf088d9f54e30a::vault {
    ...
    public(friend) entry fun add_member(arg0: &AdminCap, arg1: &mut Vault, arg2: address) {
        0x2::vec_set::insert<address>(&mut arg1.members, arg2);
    }

    public(friend) entry fun deposit<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<T0>) {
    ...
    public(friend) entry fun receive_deposit<T0>(arg0: &mut Vault, arg1: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>) {
        let v0 = 0x2::transfer::public_receive<0x2::coin::Coin<T0>>(&mut arg0.id, arg1);
        deposit<T0>(arg0, v0);
    }

    public(friend) entry fun revoke_membership(arg0: &AdminCap, arg1: &mut Vault, arg2: address) {
        0x2::vec_set::remove<address>(&mut arg1.members, &arg2);
    }

    public(friend) entry fun transfer_admin(arg0: AdminCap, arg1: &mut Vault, arg2: address, arg3: &0x2::tx_context::TxContext) {
    ...
    public(friend) entry fun withdraw_and_receive<T0>(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
