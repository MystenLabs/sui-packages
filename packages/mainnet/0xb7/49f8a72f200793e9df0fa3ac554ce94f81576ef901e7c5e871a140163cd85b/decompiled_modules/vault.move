module 0xb749f8a72f200793e9df0fa3ac554ce94f81576ef901e7c5e871a140163cd85b::vault {
    ...
    public fun deposit<T0: store>(arg0: &AdminCap, arg1: &mut Vault, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg1, arg3);
        put_balance<T0>(arg1, 0x2::coin::into_balance<T0>(arg2));
    }

    public fun deposit_with_trade_cap<T0: store>(arg0: &TradeCap, arg1: &mut Vault, arg2: 0x2::coin::Coin<T0>) {
        assert_trade_cap_vault(arg0, arg1);
        put_balance<T0>(arg1, 0x2::coin::into_balance<T0>(arg2));
    }
    ...
    fun put_balance<T0: store>(arg0: &mut Vault, arg1: 0x2::balance::Balance<T0>) {
    ...
    public fun put_balance_with_admin_cap<T0: store>(arg0: &AdminCap, arg1: &mut Vault, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg1, arg3);
        put_balance<T0>(arg1, arg2);
    }

    public fun put_balance_with_trade_cap<T0: store>(arg0: &TradeCap, arg1: &mut Vault, arg2: 0x2::balance::Balance<T0>) {
        assert_trade_cap_vault(arg0, arg1);
        put_balance<T0>(arg1, arg2);
    }
