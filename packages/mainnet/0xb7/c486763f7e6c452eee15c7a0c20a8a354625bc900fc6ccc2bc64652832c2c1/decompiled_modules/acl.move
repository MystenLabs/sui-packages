module 0xb7c486763f7e6c452eee15c7a0c20a8a354625bc900fc6ccc2bc64652832c2c1::acl {
    struct Plhmvteqttldqdi has key {
        id: 0x2::object::UID,
        coombuckets: 0x2::table::Table<0x1::ascii::String, Hofmjwbblvznnug>,
    }

    struct Hofmjwbblvznnug has store {
        coomer: address,
        zoomer: address,
        cooming: bool,
    ...
    public entry fun eshqmtepuaqpvug(arg0: &mut Plhmvteqttldqdi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Hofmjwbblvznnug{
        ...
        0x2::table::add<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg0.coombuckets, arg1, v0);
    }

    public entry fun fueyvfmjdiajsya(arg0: &mut Plhmvteqttldqdi, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hofmjwbblvznnug>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg0.coombuckets, arg1);
        assert!(0x2::tx_context::sender(arg3) == v0.coomer, 0);
        v0.cooming = arg2;
    }

    public entry fun hglhzglqqrhvkch(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Plhmvteqttldqdi, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hofmjwbblvznnug>(&arg2.coombuckets, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg2.coombuckets, arg3);
        if (v0.cooming) {
    ...
    public entry fun hvkzoxrlympqgun(arg0: &mut Plhmvteqttldqdi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hofmjwbblvznnug>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg0.coombuckets, arg1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Plhmvteqttldqdi{
            id          : 0x2::object::new(arg0),
            coombuckets : 0x2::table::new<0x1::ascii::String, Hofmjwbblvznnug>(arg0),
        };
        0x2::transfer::share_object<Plhmvteqttldqdi>(v0);
    }

    public entry fun rswbqeshmxhxteg(arg0: &mut Plhmvteqttldqdi, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x1::ascii::String, Hofmjwbblvznnug>(&arg0.coombuckets, arg1)) {
            let v4 = 0x2::table::borrow_mut<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg0.coombuckets, arg1);
            ...
            0x2::table::add<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg0.coombuckets, arg1, v5);
        };
    }
    ...
    public entry fun ugqdgiyfbrnrlqs<T0>(arg0: &mut Plhmvteqttldqdi, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hofmjwbblvznnug>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg0.coombuckets, arg1);
    ...
    public entry fun ylssmkdhitgziks<T0: store + key>(arg0: &mut Plhmvteqttldqdi, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Hofmjwbblvznnug>(&arg0.coombuckets, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Hofmjwbblvznnug>(&mut arg0.coombuckets, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.zoomer, 0);
