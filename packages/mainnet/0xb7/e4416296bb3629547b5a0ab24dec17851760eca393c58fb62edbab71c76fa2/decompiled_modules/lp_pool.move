module 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool {
    ...
    fun withdraw_scallop_basic<T0>(arg0: &mut 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut LiquidityPool, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::set_u64_vector_value(&mut v12.state.current_lending_amount, 0, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::get_u64_vector_value(&v12.state.current_lending_amount, 0) - v7);
        v12.state.liquidity_amount = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::get_u64_vector_value(&v12.state.current_lending_amount, 0) + 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::get_u64_vector_value(&v12.state.current_lending_amount, 1) + v10;
        let v13 = 0x1::vector::empty<u64>();
        let v14 = &mut v13;
        0x1::vector::push_back<u64>(v14, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::get_u64_vector_value(&v12.state.current_lending_amount, 0));
    ...
    public fun burn_lp<T0, T1>(arg0: &mut 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::treasury_caps::TreasuryCaps, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x2::object::id_address<0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle>(arg4) == v6.config.oracle_id, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::oracle_mismatched());
        ...
        assert!(v12.state.liquidity_amount >= v12.state.reserved_amount, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::liquidity_not_enough());
        ...
        0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::token_interface::burn<T1>(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::treasury_caps::get_mut_treasury_cap<T1>(arg3), 0x2::coin::from_balance<T1>(v3, arg7));
        0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::charge_fee<T0>(arg0, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v13.id, v0), v10));
        let v14 = BurnLpEvent{
    ...
    entry fun manager_emergency_withdraw<T0, T1>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut Registry, arg2: u64, arg3: ManagerDepositReceipt, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::type_name::get<T0>();
        ...
        0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::verify(arg0, arg4);
        assert!(v0 == v2, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::invalid_token_type());
        let v4 = get_liquidity_pool(arg1, arg2);
        assert!(0x1::type_name::get<T1>() == v4.lp_token_type, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::lp_token_type_mismatched());
        assert!(v4.pool_info.is_active, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::pool_inactive());
        assert!(get_token_pool(v4, &v0).state.is_active, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::token_pool_inactive());
        let v5 = 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut get_mut_liquidity_pool(arg1, arg2).id, v0), v3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v5, arg4), 0x2::tx_context::sender(arg4));
        let v6 = ManagerEmergencyWithdrawEvent{
            sender               : 0x2::tx_context::sender(arg4),
            index                : arg2,
            liquidity_token_type : v0,
        ...
        0x2::event::emit<ManagerEmergencyWithdrawEvent>(v6);
    }
    ...
    entry fun new_liquidity_pool<T0>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut Registry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
