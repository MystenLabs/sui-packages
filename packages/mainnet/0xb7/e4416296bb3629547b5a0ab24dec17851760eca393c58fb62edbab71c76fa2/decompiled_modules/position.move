module 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::position {
    ...
    public(friend) fun check_option_collateral_position_liquidated<T0>(arg0: &0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &Position, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock) : bool {
        ...
        let v3 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(arg3.size, arg3.size_decimal, arg6, arg7);
        let v4 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(v3, arg3.collateral_token_decimal, arg4, arg5);
        let v5 = if (arg3.collateral_amount >= v4) {
            0
        } else {
            v4 - arg3.collateral_amount
        };
        let v6 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(arg3.unrealized_loss + arg3.unrealized_trading_fee + arg3.unrealized_borrow_fee + (((v5 as u128) * ((arg10 - arg3.entry_borrow_index) as u128) / (0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::multiplier(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool::get_borrow_rate_decimal()) as u128)) as u64), arg3.collateral_token_decimal, arg4, arg5);
        if (!v1) {
            let v8 = if (v0 > v2 + v6) {
                v0 - v2 - v6
            } else {
    ...
    public(friend) fun order_filled<T0>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg3: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::tails_staking::TailsStakingRegistry, arg4: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::competition::CompetitionConfig, arg5: TradingOrder, arg6: 0x1::option::Option<Position>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: bool, arg14: u64, arg15: u64, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) : (Position, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64, bool, u64, u64) {
        ...
        let v46 = 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v44.id, 0x1::string::utf8(b"collateral")), v19);
        let v47 = if (!v24) {
            0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v44.id, 0x1::string::utf8(b"collateral")), v45)
        } else {
            0x2::balance::zero<T0>()
        };
        let v48 = if (v23 && v24) {
        ...
        let v49 = v44.unrealized_borrow_fee;
        v44.unrealized_borrow_fee = 0;
        0x2::balance::join<T0>(&mut v46, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut v44.id, 0x1::string::utf8(b"collateral")), v49));
        ...
        let v51 = OrderFilledEvent{
            ...
            realized_borrow_fee    : v49,
            realized_fee_in_usd    : 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v19 + v49, v44.collateral_token_decimal, arg8, arg9),
            realized_amount        : v45,
            realized_amount_sign   : v24,
            u64_padding            : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<OrderFilledEvent>(v51);
        (v44, v47, v46, v48, v44.unrealized_funding_sign, v44.unrealized_funding_fee, v20)
    }
