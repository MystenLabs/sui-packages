module 0xb70b1143444de27b16b80618bfbb4d2c60c2c5ed42651f919ffc473212e18b7b::kekius {
    ...
    fun init(arg0: KEKIUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/XC78JjRHnSqaysrHiTrhR8eRngFbvX3rrHyRjWEpump.png?size=lg&key=57257f                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<KEKIUS>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KEKIUS    ")))), trim_right(b"Kekius Maximus                  "), trim_right(b"The OG Kekius Maximus on Solana.                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
