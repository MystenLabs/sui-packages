module 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        ...
        assert!(points_of(arg0, arg1) >= arg2, 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::insufficient_points());
    ...
    public fun record(arg0: &mut Recorder, arg1: &RecordCap, arg2: address, arg3: u64) {
        assert!(arg0.version == 1, 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::wrong_version());
        assert!(0x2::object::id<RecordCap>(arg1) == arg0.record_cap, 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::invalid_record_cap());
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 >= earned_of(arg0, arg1), 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
