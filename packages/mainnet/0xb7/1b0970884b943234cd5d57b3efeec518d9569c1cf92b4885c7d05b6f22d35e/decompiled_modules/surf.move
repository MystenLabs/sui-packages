module 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::surf {
    ...
    public fun mint(arg0: &mut MintConfig, arg1: &mut 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::recorder::Recorder, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : SurfNFT {
        assert!(arg0.version == 1, 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::wrong_version());
        let v0 = if (arg0.live) {
            if (arg0.season >= 2) {
                arg0.mint_cost > 0
        ...
        assert!(v0, 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::not_configured());
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = current_week(arg0, arg2);
        assert!(0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::recorder::points_of(arg1, v1) >= arg0.threshold, 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::below_threshold());
        if (v2 >= 2 && arg0.weekly_cap > 0) {
            assert!(weekly_minted(arg0, v1, v2) < arg0.weekly_cap, 0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::errors::weekly_cap_reached());
        };
        0xb71b0970884b943234cd5d57b3efeec518d9569c1cf92b4885c7d05b6f22d35e::recorder::add_spent(arg1, v1, arg0.mint_cost);
