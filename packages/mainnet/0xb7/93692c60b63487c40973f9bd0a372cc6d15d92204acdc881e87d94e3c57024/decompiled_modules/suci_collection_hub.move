module 0xb793692c60b63487c40973f9bd0a372cc6d15d92204acdc881e87d94e3c57024::suci_collection_hub {
    struct SUCI_COLLECTION_HUB has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUCI_COLLECTION_HUB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUCI_COLLECTION_HUB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Suci Collection Hub"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Suci Collection"));
