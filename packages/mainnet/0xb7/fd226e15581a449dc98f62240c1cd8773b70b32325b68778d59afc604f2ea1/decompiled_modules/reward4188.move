module 0xb7fd226e15581a449dc98f62240c1cd8773b70b32325b68778d59afc604f2ea1::reward4188 {
    struct REWARD4188 has drop {
        dummy_field: bool,
    }

    struct TICKET_4188 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4188(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4188>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4188>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4188, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4188>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4188>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4188>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4188>>(v5, 0x2::tx_context::sender(arg1));
    }
