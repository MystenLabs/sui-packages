module 0xb700b55e48cd486ea0c94207f30bffbdf2e0e04aba5034287e78ec1a23f8d8b6::five_minutes {
    ...
    entry fun close(arg0: &mut Round, arg1: vector<vector<u8>>, arg2: vector<vector<u8>>, arg3: vector<u8>, arg4: &0x2::clock::Clock) {
        let v0 = 0x1::vector::length<RoundMetadata>(&arg0.rounds);
        assert!(0x1::vector::borrow<RoundMetadata>(&arg0.rounds, v0 - 1).status != 1, 1);
        assert!(0x1::vector::borrow<RoundMetadata>(&arg0.rounds, v0 - 1).end_time_ms < 0x2::clock::timestamp_ms(arg4), 0);
