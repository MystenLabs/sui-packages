module 0xb703b7edf0f83e5a8ef1cd0482b6fa28ffe1f6868c1c7815b6091421dfac6b27::gift4662 {
    struct GIFT4662 has drop {
        dummy_field: bool,
    }

    struct TICKET_4662 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4662(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4662>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4662>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4662, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4662>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4662>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4662>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4662>>(v5, 0x2::tx_context::sender(arg1));
    }
