module 0xb7e48d8683a4825654c50e9da0894e73f05d75d3b1ba9d56f5a0114623eafa11::reward5601 {
    struct REWARD5601 has drop {
        dummy_field: bool,
    }

    struct TICKET_5601 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5601(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5601>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5601>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5601, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5601>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5601>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5601>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5601>>(v5, 0x2::tx_context::sender(arg1));
    }
