module 0xb71bb32e066734ecac70678cd1f28f582f443fd4bc42e3e06b703c7ec50da439::cnsnft2649 {
    struct CNSNFT2649 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2649, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2649>(arg0, arg1);
