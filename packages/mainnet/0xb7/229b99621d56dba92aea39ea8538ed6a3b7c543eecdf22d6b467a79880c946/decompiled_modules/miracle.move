module 0xb7229b99621d56dba92aea39ea8538ed6a3b7c543eecdf22d6b467a79880c946::miracle {
    ...
    public fun create(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Miracle {
        assert!(arg0 > 0, 0xb7229b99621d56dba92aea39ea8538ed6a3b7c543eecdf22d6b467a79880c946::errors::E_BAD_SPLIT());
        Miracle{
    ...
    public fun maybe_trigger(arg0: &mut Miracle, arg1: u64) : (bool, u64) {
        ...
        assert!(v0 > 0, 0xb7229b99621d56dba92aea39ea8538ed6a3b7c543eecdf22d6b467a79880c946::errors::E_BAD_SPLIT());
        if (arg1 % v0 == 0) {
    ...
    public fun set_params(arg0: &mut Miracle, arg1: u64, arg2: u64) {
        assert!(arg1 > 0, 0xb7229b99621d56dba92aea39ea8538ed6a3b7c543eecdf22d6b467a79880c946::errors::E_BAD_SPLIT());
        arg0.base_odds = arg1;
