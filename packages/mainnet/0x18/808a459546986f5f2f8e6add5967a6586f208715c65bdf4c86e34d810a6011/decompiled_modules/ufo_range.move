module 0x4e8fe4c1a63ca6e44255e64e84e90a9d58d55f12fcfabb938ba54715b6884be7::ufo_range {
    ...
    entry fun play_with_partners<T0, T1: store + key>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &0x2::random::Random, arg2: 0x2::coin::Coin<T0>, arg3: vector<u64>, arg4: vector<vector<u64>>, arg5: &0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::partners::PartnerList, arg6: vector<T1>, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x1::vector::is_empty<u64>(&arg3)) {
            let v7 = 0x1::vector::pop_back<vector<u64>>(&mut arg4);
            assert!(0x1::vector::length<u64>(&v7) == 2, 6);
            let v8 = &mut v4;
            let (v9, v10) = one_game<T0>(arg0, v8, v6 / v2, 0x1::vector::pop_back<u64>(&mut arg3), *0x1::vector::borrow<u64>(&v7, 1), *0x1::vector::borrow<u64>(&v7, 0), v1, arg8);
            0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::RangeGame>(&mut v3, v9);
            v5 = v5 + v10;
        };
        settle_game_helper<T0>(arg0, arg2, v5, v6, arg8);
