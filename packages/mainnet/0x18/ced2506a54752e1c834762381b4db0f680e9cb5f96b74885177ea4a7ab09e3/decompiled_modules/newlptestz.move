module 0x18ced2506a54752e1c834762381b4db0f680e9cb5f96b74885177ea4a7ab09e3::newlptestz {
    struct NEWLPTESTZ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NEWLPTESTZ, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NEWLPTESTZ>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"newlptestz"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"newlptestz "));
