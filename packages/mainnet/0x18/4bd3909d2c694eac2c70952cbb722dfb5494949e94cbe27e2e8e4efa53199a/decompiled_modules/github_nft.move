module 0x184bd3909d2c694eac2c70952cbb722dfb5494949e94cbe27e2e8e4efa53199a::github_nft {
    ...
    fun init(arg0: GITHUB_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{SEAL Final Phase} #{ID}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Badge for loyal SealionSui supporters. Collect all season badges to earn an exclusive Airdrop."));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://moccasin-applicable-coyote-183.mypinata.cloud/ipfs/bafkreigpn4g5nkptqbwqrutibargjbx3dyp6fc5dqswh2nhefqyjoqsdpe"));
