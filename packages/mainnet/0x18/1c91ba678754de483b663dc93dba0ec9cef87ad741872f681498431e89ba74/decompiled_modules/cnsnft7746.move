module 0x181c91ba678754de483b663dc93dba0ec9cef87ad741872f681498431e89ba74::cnsnft7746 {
    struct CNSNFT7746 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7746, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7746>(arg0, arg1);
