module 0x18c0536c63e0e4c8cd116f777b2b634ea70ffb85e3e4b3617ef83207cf74eceb::cnsnft1584 {
    struct CNSNFT1584 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1584, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1584>(arg0, arg1);
