module 0x18b9bfe4ad09e7cfc911db20bb2d3980bddc6e09caf39c590890c945c5c00fa1::reward2780 {
    struct REWARD2780 has drop {
        dummy_field: bool,
    }

    struct TICKET_2780 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2780(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2780>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2780>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2780, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2780>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2780>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2780>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2780>>(v5, 0x2::tx_context::sender(arg1));
    }
