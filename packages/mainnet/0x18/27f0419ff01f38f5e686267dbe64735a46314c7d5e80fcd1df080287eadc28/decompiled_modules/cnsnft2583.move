module 0x1827f0419ff01f38f5e686267dbe64735a46314c7d5e80fcd1df080287eadc28::cnsnft2583 {
    struct CNSNFT2583 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2583, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2583>(arg0, arg1);
