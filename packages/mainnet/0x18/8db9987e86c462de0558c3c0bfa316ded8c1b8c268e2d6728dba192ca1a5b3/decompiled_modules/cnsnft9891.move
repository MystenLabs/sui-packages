module 0x188db9987e86c462de0558c3c0bfa316ded8c1b8c268e2d6728dba192ca1a5b3::cnsnft9891 {
    struct CNSNFT9891 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9891, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3032"));
        let v4 = 0x2::package::claim<CNSNFT9891>(arg0, arg1);
