module 0x18042e06665ee0cd1cfd4dc764925873b5f3ff3fb4ed97e49418a1477b50ef49::reward6545 {
    struct REWARD6545 has drop {
        dummy_field: bool,
    }

    struct TICKET_6545 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6545(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6545>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6545>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6545, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6545>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6545>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6545>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6545>>(v5, 0x2::tx_context::sender(arg1));
    }
