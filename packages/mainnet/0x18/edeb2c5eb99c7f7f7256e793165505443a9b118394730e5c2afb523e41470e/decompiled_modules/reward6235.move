module 0x18edeb2c5eb99c7f7f7256e793165505443a9b118394730e5c2afb523e41470e::reward6235 {
    struct REWARD6235 has drop {
        dummy_field: bool,
    }

    struct TICKET_6235 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6235(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6235>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6235>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6235, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6235>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6235>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6235>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6235>>(v5, 0x2::tx_context::sender(arg1));
    }
