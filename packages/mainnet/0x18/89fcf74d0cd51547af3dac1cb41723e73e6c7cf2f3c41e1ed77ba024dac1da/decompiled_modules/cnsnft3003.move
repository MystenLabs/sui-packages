module 0x1889fcf74d0cd51547af3dac1cb41723e73e6c7cf2f3c41e1ed77ba024dac1da::cnsnft3003 {
    struct CNSNFT3003 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3003, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3003>(arg0, arg1);
