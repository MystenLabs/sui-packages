module 0xc48e220589bbbc5b1e8f41525799ef295403d27395d8c8297709403f65383e36::moonbags_token_lock {
    ...
    public entry fun update_lock_contract<T0>(arg0: &AdminCap, arg1: &mut LockContract<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        arg1.locker = arg2;
        arg1.recipient = arg2;
        let v0 = UpdateLockContractEvent{
            contract_id   : 0x2::object::uid_to_address(&arg1.id),
            token_address : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            old_locker    : 0x2::address::to_ascii_string(arg1.locker),
            new_locker    : 0x2::address::to_ascii_string(arg2),
            old_recipient : 0x2::address::to_ascii_string(arg1.recipient),
            new_recipient : 0x2::address::to_ascii_string(arg2),
            updated_by    : 0x2::address::to_ascii_string(0x2::tx_context::sender(arg3)),
        };
        0x2::event::emit<UpdateLockContractEvent>(v0);
    }
