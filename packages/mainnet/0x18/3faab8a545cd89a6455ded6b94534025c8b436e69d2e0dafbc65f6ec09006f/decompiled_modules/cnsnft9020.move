module 0x183faab8a545cd89a6455ded6b94534025c8b436e69d2e0dafbc65f6ec09006f::cnsnft9020 {
    struct CNSNFT9020 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9020, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9020>(arg0, arg1);
