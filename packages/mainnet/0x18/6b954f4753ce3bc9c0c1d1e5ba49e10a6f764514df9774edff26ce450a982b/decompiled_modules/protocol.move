module 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::protocol {
    ...
    struct ChannelTreasury has store, key {
        id: 0x2::object::UID,
        owner: address,
    }
    ...
    public fun add_balance_to_channel_treasury<T0>(arg0: &mut ChannelTreasury, arg1: 0x2::coin::Coin<T0>) {
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg0.id, v0)) {
            0x2::coin::put<T0>(0x2::coin::balance_mut<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::coin::Coin<T0>>(&mut arg0.id, v0)), arg1);
        } else {
    ...
    public fun add_treasuries_v1(arg0: vector<Channel>, arg1: &mut 0x2::tx_context::TxContext) {
        while (!0x1::vector::is_empty<Channel>(&arg0)) {
            let v0 = 0x1::vector::pop_back<Channel>(&mut arg0);
            let v1 = ChannelTreasury{
                id    : 0x2::object::new(arg1),
                owner : 0x2::object::uid_to_address(&v0.id),
            };
            0x2::dynamic_field::add<0x1::string::String, address>(&mut v0.id, 0x1::string::utf8(b"channel_treasury"), 0x2::object::uid_to_address(&v1.id));
            0x2::transfer::share_object<ChannelTreasury>(v1);
            0x2::transfer::transfer<Channel>(v0, 0x2::tx_context::sender(arg1));
        };
        0x1::vector::destroy_empty<Channel>(arg0);
    }

    public fun admin_mint_wild_channels(arg0: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractPublisher, arg1: vector<0x1::string::String>, arg2: 0x1::string::String, arg3: vector<0x1::string::String>, arg4: &mut ChannelList, arg5: address, arg6: &mut 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::RewardPool, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<0x1::string::String>(&arg1) == 0x1::vector::length<0x1::string::String>(&arg3), 32);
        let v0 = 0;
        while (v0 < 0x1::vector::length<0x1::string::String>(&arg1)) {
            let v1 = *0x1::vector::borrow<0x1::string::String>(&arg1, v0);
            assert!(0x1::string::length(&v1) <= 63, 11);
            let v2 = 0x2::object::new(arg7);
            let v3 = MovieWallet{
                id      : 0x2::object::new(arg7),
                balance : 0x2::coin::zero<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(arg7),
                owner   : 0x2::object::uid_to_address(&v2),
            };
            let v4 = 0x1::string::utf8(b"w-");
            0x1::string::append_utf8(&mut v4, 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::convert_channel_name_to_handle(0x1::string::as_bytes(&v1)));
            let v5 = Channel{
                id                  : v2,
                channel_name        : v1,
                handle              : v4,
                channel_description : arg2,
                movie_wallet        : 0x2::object::uid_to_address(&v3.id),
                url                 : *0x1::vector::borrow<0x1::string::String>(&arg3, v0),
                content_links       : 0x2::table::new<0x1::string::String, Content>(arg7),
            };
            let v6 = ChannelTreasury{
                id    : 0x2::object::new(arg7),
                owner : 0x2::object::uid_to_address(&v5.id),
            };
            0x2::dynamic_field::add<0x1::string::String, address>(&mut v5.id, 0x1::string::utf8(b"channel_treasury"), 0x2::object::uid_to_address(&v6.id));
            let v7 = MintChannelEvent{
                object_id : 0x2::object::uid_to_inner(&v5.id),
                creator   : arg5,
                name      : v5.channel_name,
            };
            0x2::event::emit<MintChannelEvent>(v7);
            0x2::coin::put<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(0x2::coin::balance_mut<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(&mut v3.balance), 0x2::coin::take<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::get_mutable_reference_to_reward_balance(arg6), 50000000000, arg7));
            0x2::transfer::public_share_object<ChannelTreasury>(v6);
            0x2::transfer::share_object<MovieWallet>(v3);
            registry(arg4, v4, 0x2::object::uid_to_inner(&v5.id));
            0x2::transfer::transfer<Channel>(v5, arg5);
            v0 = v0 + 1;
        };
    }

    public fun admin_update_channel_image_url(arg0: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractPublisher, arg1: &mut Channel, arg2: 0x1::string::String) {
        arg1.url = arg2;
    }

    public fun admin_update_display_name(arg0: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractPublisher, arg1: &mut Channel, arg2: 0x1::string::String, arg3: 0x1::string::String) {
        let v0 = 0x1::string::as_bytes(&arg1.handle);
        if (*0x1::vector::borrow<u8>(v0, 0) == 119 && *0x1::vector::borrow<u8>(v0, 1) == 45) {
            let v1 = 0x1::string::utf8(b"w-");
            0x1::string::append_utf8(&mut v1, 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::convert_channel_name_to_handle(0x1::string::as_bytes(&arg2)));
            assert!(arg1.handle == v1, 30);
        } else {
            assert!(arg1.handle == 0x1::string::utf8(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::convert_channel_name_to_handle(0x1::string::as_bytes(&arg2))), 30);
        };
        arg1.channel_name = arg2;
        arg1.url = arg3;
    }
    ...
    public fun authority_mint_blocked_name(arg0: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractPublisher, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut ChannelList, arg5: &mut 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::BlockList, arg6: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::BlackList, arg7: address, arg8: &mut 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::RewardPool, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::string::utf8(b"w-");
        0x1::string::append_utf8(&mut v2, 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::convert_channel_name_to_handle(0x1::string::as_bytes(&arg1)));
        let v3 = Channel{
            id                  : v0,
            channel_name        : arg1,
            handle              : v2,
            channel_description : arg2,
            movie_wallet        : 0x2::object::uid_to_address(&v1.id),
            url                 : arg3,
            content_links       : 0x2::table::new<0x1::string::String, Content>(arg9),
        };
        let v4 = ChannelTreasury{
            id    : 0x2::object::new(arg9),
            owner : 0x2::object::uid_to_address(&v3.id),
        };
        0x2::dynamic_field::add<0x1::string::String, address>(&mut v3.id, 0x1::string::utf8(b"channel_treasury"), 0x2::object::uid_to_address(&v4.id));
        let v5 = MintChannelEvent{
            object_id : 0x2::object::uid_to_inner(&v3.id),
            creator   : arg7,
            name      : v3.channel_name,
        };
        0x2::event::emit<MintChannelEvent>(v5);
        0x2::coin::put<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(0x2::coin::balance_mut<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(&mut v1.balance), 0x2::coin::take<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::get_mutable_reference_to_reward_balance(arg8), 50000000000, arg9));
        0x2::transfer::share_object<MovieWallet>(v1);
        registry(arg4, v2, 0x2::object::uid_to_inner(&v3.id));
        0x2::transfer::public_share_object<ChannelTreasury>(v4);
    ...
    public fun get_channel_object_id(arg0: 0x1::string::String, arg1: &ChannelList) : 0x2::object::ID {
        assert!(0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg1.list, arg0), 20);
        *0x2::table::borrow<0x1::string::String, 0x2::object::ID>(&arg1.list, arg0)
    }

    public fun get_display_name_update_fee(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ReservedChannelList, arg3: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::FrequentWordList, arg4: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::PriceModel, arg5: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::GoldList) : u64 {
        let v0 = 200000000;
        if (0x1::string::length(&arg0) != 0x1::string::length(&arg1)) {
            let v1 = calculate_mint_fee(arg1, arg4, arg5, arg2, arg3);
            let v2 = calculate_mint_fee(arg0, arg4, arg5, arg2, arg3);
            if (v1 >= v2) {
                return v0
            };
            let v3 = v2 - v1;
    ...
    fun init(arg0: PROTOCOL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"The Wild Channel Collection"));
    ...
    public fun mint_apex_channel(arg0: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractPublisher, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut ChannelList, arg5: address, arg6: &mut 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::RewardPool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<Channel>(v3, arg5);
    }

    public entry fun mint_v2(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut ChannelList, arg4: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ReservedChannelList, arg5: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::BlackList, arg6: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::FrequentWordList, arg7: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::BlockList, arg8: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::PriceModel, arg9: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::GoldList, arg10: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg11: &mut 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractManager, arg12: &mut 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::RewardPool, arg13: vector<u8>, arg14: &mut 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::CouponInfoV2, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::convert_channel_name_to_handle(0x1::string::as_bytes(&arg0));
        if (0x1::string::utf8(arg13) == 0x1::string::utf8(b"") || 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::check_is_coupon_special_v2(arg13, arg14) == false) {
            assert!(0x1::string::length(&arg0) >= 5, 11);
        };
        assert!(0x1::string::length(&arg0) <= 63, 11);
        assert!(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::query_block_channel(arg7, 0x1::string::utf8(v0)) == false, 12);
        ...
        let v2 = v1;
        if (0x1::string::utf8(arg13) != 0x1::string::utf8(b"")) {
            let v3 = 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::claim_coupon_discount_percentage_v2(arg13, arg14, arg15, arg16);
            assert!(v3 != 0, 18);
            v2 = v1 - v1 * v3 / 100;
        };
        assert!(0x2::coin::value<0x2::sui::SUI>(arg10) >= v2, 16);
        ...
        let v7 = 0x1::string::utf8(b"w-");
        0x1::string::append_utf8(&mut v7, v0);
        let v8 = Channel{
            id                  : v5,
            channel_name        : arg0,
            handle              : v7,
        ...
        let v9 = ChannelTreasury{
            id    : 0x2::object::new(arg16),
            owner : 0x2::object::uid_to_address(&v8.id),
        };
        0x2::dynamic_field::add<0x1::string::String, address>(&mut v8.id, 0x1::string::utf8(b"channel_treasury"), 0x2::object::uid_to_address(&v9.id));
        let v10 = MintChannelEvent{
            object_id : 0x2::object::uid_to_inner(&v8.id),
            creator   : v4,
            name      : v8.channel_name,
        };
        0x2::event::emit<MintChannelEvent>(v10);
        0x2::coin::put<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(0x2::coin::balance_mut<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(&mut v6.balance), 0x2::coin::take<0xca21eeed96a49846e09e880cf960deeae437fdf396bf6962bf86d40be87db740::movie::MOVIE>(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::get_mutable_reference_to_reward_balance(arg12), 50000000000, arg16));
        0x2::transfer::public_share_object<ChannelTreasury>(v9);
        0x2::transfer::share_object<MovieWallet>(v6);
        registry(arg3, v7, 0x2::object::uid_to_inner(&v8.id));
        0x2::transfer::transfer<Channel>(v8, v4);
    }

    fun pay_fee(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractManager, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(arg0) >= arg1, 16);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(arg0), arg1), arg3), 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::get_mutable_reference_to_contract_manager(arg2));
    }
    ...
    public fun query_channel_flag_status(arg0: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::BlackList, arg1: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::BlockList, arg2: &ChannelList, arg3: 0x1::string::String) : u8 {
        if (0x2::table::contains<0x1::string::String, 0x2::object::ID>(&arg2.list, arg3)) {
            3
        } else if (0x2::table::contains<0x1::string::String, bool>(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::get_reference_from_black_list(arg0), arg3)) {
            1
        } else if (0x2::table::contains<0x1::string::String, bool>(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::get_reference_from_block_list(arg1), arg3)) {
            2
        } else {
            0
        }
    ...
    public entry fun update_channel_display_name(arg0: &mut Channel, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractManager, arg5: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ReservedChannelList, arg6: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::FrequentWordList, arg7: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::PriceModel, arg8: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::GoldList, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::as_bytes(&arg0.handle);
        if (*0x1::vector::borrow<u8>(v0, 0) == 119 && *0x1::vector::borrow<u8>(v0, 1) == 45) {
            let v1 = 0x1::string::utf8(b"w-");
            0x1::string::append_utf8(&mut v1, 0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::convert_channel_name_to_handle(0x1::string::as_bytes(&arg1)));
            assert!(arg0.handle == v1, 30);
        } else {
            assert!(arg0.handle == 0x1::string::utf8(0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::validation::convert_channel_name_to_handle(0x1::string::as_bytes(&arg1))), 30);
        };
        assert!(arg0.channel_name == arg1 == false, 31);
        pay_fee(arg3, get_display_name_update_fee(arg1, arg0.channel_name, arg5, arg6, arg7, arg8), arg4, arg9);
        arg0.channel_name = arg1;
        arg0.url = arg2;
    }

    public entry fun update_channel_image_url(arg0: &mut Channel, arg1: 0x1::string::String, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0xc90cf2d853b8ee8d592ee61bbbfa4e41bcc0150bae6b53f347376d7fb34e5f9b::admin::ContractManager, arg4: &mut 0x2::tx_context::TxContext) {
        pay_fee(arg2, 200000000, arg3, arg4);
        arg0.url = arg1;
    }
