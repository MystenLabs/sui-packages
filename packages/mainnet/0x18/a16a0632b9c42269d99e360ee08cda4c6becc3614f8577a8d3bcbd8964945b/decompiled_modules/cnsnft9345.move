module 0x18a16a0632b9c42269d99e360ee08cda4c6becc3614f8577a8d3bcbd8964945b::cnsnft9345 {
    struct CNSNFT9345 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9345, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6515"));
        let v4 = 0x2::package::claim<CNSNFT9345>(arg0, arg1);
