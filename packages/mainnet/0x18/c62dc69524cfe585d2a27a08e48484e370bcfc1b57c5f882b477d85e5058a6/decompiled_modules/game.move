module 0x2cef85db37c28fccda8b409e2a321ee5932e1b292b596877184245972250004e::game {
    ...
    entry fun settle(arg0: &mut Board, arg1: &mut 0x39019f183d8d19df19bd7c3e14fed735c7a1b11e2aa02669eba1089602394c3e::gts::Treasury, arg2: &mut 0x2cef85db37c28fccda8b409e2a321ee5932e1b292b596877184245972250004e::staking::StakePool, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        settle_with_odds(arg0, arg1, arg2, arg3, arg4, 100, arg5);
    }
    ...
    fun settle_with_odds(arg0: &mut Board, arg1: &mut 0x39019f183d8d19df19bd7c3e14fed735c7a1b11e2aa02669eba1089602394c3e::gts::Treasury, arg2: &mut 0x2cef85db37c28fccda8b409e2a321ee5932e1b292b596877184245972250004e::staking::StakePool, arg3: &0x2::random::Random, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = MotherlodeKey{dummy_field: false};
        if (!0x2::dynamic_field::exists<MotherlodeKey>(&arg0.id, v9)) {
            let v10 = MotherlodeKey{dummy_field: false};
            0x2::dynamic_field::add<MotherlodeKey, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.id, v10, 0x2::balance::zero<0x2::sui::SUI>());
        };
        let v11 = 0;
        let v12 = 0;
        if (v3 == 0) {
            if (v7 > 0) {
                let v13 = MotherlodeKey{dummy_field: false};
                0x2::balance::join<0x2::sui::SUI>(0x2::dynamic_field::borrow_mut<MotherlodeKey, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.id, v13), 0x2::balance::split<0x2::sui::SUI>(&mut arg0.pot, v7));
                v11 = v7;
                v8 = 0;
            };
        } else {
            let v14 = MotherlodeKey{dummy_field: false};
            let v15 = 0x2::dynamic_field::borrow_mut<MotherlodeKey, 0x2::balance::Balance<0x2::sui::SUI>>(&mut arg0.id, v14);
            if (0x2::random::generate_u64_in_range(&mut v0, 0, arg5 - 1) == 0 && 0x2::balance::value<0x2::sui::SUI>(v15) > 0) {
                let v16 = 0x2::balance::value<0x2::sui::SUI>(v15);
                v12 = v16;
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.pot, 0x2::balance::withdraw_all<0x2::sui::SUI>(v15));
                v8 = v7 + v16;
                let v17 = JackpotKey{round_id: arg0.cur_id};
                0x2::dynamic_field::add<JackpotKey, u64>(&mut arg0.id, v17, v16);
            };
        };
        let v18 = MotherlodeKey{dummy_field: false};
        let v19 = MotherlodeUpdate{
            round_id : arg0.cur_id,
            added    : v11,
            paid     : v12,
            balance  : 0x2::balance::value<0x2::sui::SUI>(0x2::dynamic_field::borrow<MotherlodeKey, 0x2::balance::Balance<0x2::sui::SUI>>(&arg0.id, v18)),
        };
        0x2::event::emit<MotherlodeUpdate>(v19);
        let v20 = reward_for_round(arg0.cur_id);
        let v21 = v20 * 1000 / 10000;
        if (v21 > 0) {
            0x2cef85db37c28fccda8b409e2a321ee5932e1b292b596877184245972250004e::staking::add_rewards(arg2, 0x2::coin::into_balance<0x39019f183d8d19df19bd7c3e14fed735c7a1b11e2aa02669eba1089602394c3e::gts::GTS>(0x39019f183d8d19df19bd7c3e14fed735c7a1b11e2aa02669eba1089602394c3e::gts::mint(arg1, 0x1::option::borrow<0x39019f183d8d19df19bd7c3e14fed735c7a1b11e2aa02669eba1089602394c3e::gts::MinterCap>(&arg0.minter), v21, arg4, arg6)), arg4);
        };
        let v22 = RoundInfo{
        ...
        0x2::table::add<u64, RoundInfo>(&mut arg0.rounds, arg0.cur_id, v22);
        let v23 = RoundSettled{
            round_id       : arg0.cur_id,
            winning_square : v2,
            total_deployed : arg0.cur_total,
            winners_total  : v3,
        ...
        0x2::event::emit<RoundSettled>(v23);
