module 0x18e7123986777d66c5e725473193b40e3fa683b8fd631f2b9d21c793b168d582::SHAWK {
    ...
    fun init(arg0: SHAWK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SHAWK>>(0x2::coin::mint<SHAWK>(&mut v3, 10000000000000000, arg1), 0x2::tx_context::sender(arg1));
