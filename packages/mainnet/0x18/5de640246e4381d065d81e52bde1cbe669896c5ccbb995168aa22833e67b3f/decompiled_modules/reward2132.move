module 0x185de640246e4381d065d81e52bde1cbe669896c5ccbb995168aa22833e67b3f::reward2132 {
    struct REWARD2132 has drop {
        dummy_field: bool,
    }

    struct TICKET_2132 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2132(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2132>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2132>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2132, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2132>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2132>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2132>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2132>>(v5, 0x2::tx_context::sender(arg1));
    }
