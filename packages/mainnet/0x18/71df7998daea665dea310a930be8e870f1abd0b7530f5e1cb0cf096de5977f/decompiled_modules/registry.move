module 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::registry {
    ...
    public(friend) fun add_balance_manager(arg0: &mut Registry, arg1: address, arg2: 0x2::object::ID) {
        ...
        assert!(0x2::vec_set::length<0x2::object::ID>(v2) <= 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::constants::max_balance_managers(), 9);
    }
    ...
    public fun disable_version(arg0: &mut Registry, arg1: u64, arg2: &DeepbookAdminCap) {
        ...
        assert!(arg1 != 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::constants::current_version(), 6);
    ...
    fun init(arg0: REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = RegistryInner{
            allowed_versions : 0x2::vec_set::singleton<u64>(0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::constants::current_version()),
            pools            : 0x2::bag::new(arg1),
            treasury_address : 0x2::tx_context::sender(arg1),
        };
        let v1 = Registry{
            id    : 0x2::object::new(arg1),
            inner : 0x2::versioned::create<RegistryInner>(0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::constants::current_version(), v0, arg1),
        };
