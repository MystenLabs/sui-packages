module 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::deep_price {
    ...
    public(friend) fun deep_quantity_u128(arg0: &OrderDeepPrice, arg1: u128, arg2: u128) : u128 {
        if (arg0.asset_is_base) {
            0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul_u128(arg1, (arg0.deep_per_asset as u128))
        } else {
            0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul_u128(arg2, (arg0.deep_per_asset as u128))
        }
    }
    ...
    public(friend) fun fee_quantity(arg0: &OrderDeepPrice, arg1: u64, arg2: u64, arg3: bool) : 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::balances::Balances {
        let v0 = if (arg0.asset_is_base) {
            0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul(arg1, arg0.deep_per_asset)
        } else {
            0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul(arg2, arg0.deep_per_asset)
        };
        if (arg0.deep_per_asset > 0) {
            0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::balances::new(0, 0, v0)
        } else if (arg3) {
            0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::balances::new(0, 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul(arg2, 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::constants::fee_penalty_multiplier()), 0)
        } else {
            0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::balances::new(0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::math::mul(arg1, 0x1871df7998daea665dea310a930be8e870f1abd0b7530f5e1cb0cf096de5977f::constants::fee_penalty_multiplier()), 0, 0)
        }
    }
