module 0x18ff421f14995a823753675f76660f36568ba100174be31db62ab376a361868c::game {
    ...
    public entry fun scout(arg0: &mut GameWorld, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<address, 0x2::object::ID>(&arg0.nodes, arg1)) {
            let v0 = ValidatorNode{
                id                : 0x2::object::new(arg2),
                validator_address : arg1,
                faction           : 0,
                daemons           : 0x2::bag::new(arg2),
                links             : 0x2::vec_set::empty<address>(),
            };
            0x2::table::add<address, 0x2::object::ID>(&mut arg0.nodes, arg1, 0x2::object::id<ValidatorNode>(&v0));
