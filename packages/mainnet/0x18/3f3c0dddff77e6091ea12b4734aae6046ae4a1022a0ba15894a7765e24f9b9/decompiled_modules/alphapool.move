module 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::alphapool {
    ...
    public fun create<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::DevCap, arg1: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun deposit<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        if (0x1::option::is_some<Receipt>(&arg1) == true) {
            if (0x1::option::borrow<Receipt>(&arg1).owner != 0x2::tx_context::sender(arg6)) {
                0x2::transfer::public_transfer<Receipt>(0x1::option::extract<Receipt>(&mut arg1), 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::get_onhold_receipts_wallet_address(arg3));
        ...
        assert!(0x2::coin::value<T0>(&arg4) > 0, 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::zero_deposit_error());
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v0, (v1 as u64)), arg6), 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::get_fee_wallet_address(arg3));
        ...
        assert!(v3 > 0, 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::insufficient_deposit_amount());
    ...
    fun destroy_receipt_and_transfer_rewards<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg0);
        assert!(arg1.xTokenBalance < 2, 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::receipt_not_empty());
        let v0 = &mut arg1;
    ...
    public fun get_pool_rewards_all<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: &mut Pool<T0>, arg2: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg0);
    ...
    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x1::type_name::get<0x3813ca8aa2849b6369106ea749b0bdc5d72a671a267bf55a4be68c6c86fb911f::beta::BETA>()) {
            let v1 = 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::get_rewards<T0>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v1, (v2 as u64)), arg3), 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::get_fee_wallet_address(arg1));
            0x2::balance::join<T0>(&mut arg0.alpha_bal, v1);
        } else {
            let v4 = 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    public fun get_user_rewards_all<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: &mut Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg0);
    ...
    entry fun set_instant_withdraw_fee<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::AdminCap, arg1: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.instant_withdraw_fee_max_cap, 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::fee_too_high_error());
        arg2.instant_withdraw_fee = arg3;
    }

    entry fun set_lock_period_in_ms<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::AdminCap, arg1: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg1);
    ...
    entry fun set_performance_fee<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::AdminCap, arg1: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg2: &mut Pool<T0>, arg3: u64) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg1);
        assert!(arg3 <= arg2.performance_fee_max_cap, 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::fee_too_high_error());
    ...
    public fun transfer_receipt_option(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut 0x2::tx_context::TxContext) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg0);
        if (0x1::option::is_some<Receipt>(&arg1) == true) {
    ...
    public fun user_deposit<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg0);
    ...
    public fun user_withdraw<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg0);
    ...
    public fun withdraw<T0>(arg0: &0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::Version, arg1: Receipt, arg2: &mut Pool<T0>, arg3: &mut 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::Distributor, arg4: u64, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::version::assert_current_version(arg0);
        if (arg1.owner != 0x2::tx_context::sender(arg7)) {
            0x2::transfer::public_transfer<Receipt>(arg1, 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::get_onhold_receipts_wallet_address(arg3));
            return 0x1::option::none<Receipt>()
        };
        assert!(arg2.paused == false, 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::pool_paused());
        ...
        if (arg6 == true) {
            assert!(arg4 <= (((arg1.xTokenBalance as u256) * v1 / (1000000000000000000000000000000000000 as u256)) as u64), 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::insufficient_balance_error());
        } else {
            assert!(arg4 <= (v3 as u64), 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::error::insufficient_balance_error());
        };
        let v4 = 0;
        if (arg4 > (v3 as u64)) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.alpha_bal, v8), arg7), 0x183f3c0dddff77e6091ea12b4734aae6046ae4a1022a0ba15894a7765e24f9b9::distributor::get_fee_wallet_address(arg3));
