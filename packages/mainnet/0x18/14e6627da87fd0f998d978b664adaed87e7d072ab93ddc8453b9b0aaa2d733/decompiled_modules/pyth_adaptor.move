module 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::pyth_adaptor {
    ...
    fun assert_price_conf_within_range(arg0: u64, arg1: u64, arg2: u64) {
        assert!(((((arg1 * 10000 * 100) as u128) / (arg0 as u128)) as u64) <= arg2 * 100, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::pyth_price_conf_too_large());
    }
    ...
    fun assert_price_not_stale(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::Price, arg1: &0x2::clock::Clock) : u64 {
        ...
        assert!(v0 >= v1 - 30, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::pyth_price_too_old());
        assert!(v0 <= v1, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::future_pyth_price());
        v0
    }
    ...
    public(friend) fun assert_pyth_price_info_object(arg0: &PythFeedData, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        assert!(0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1) == arg0.feed, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::illegal_pyth_price_object());
    }
    ...
    fun ensure_price_ok(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::Price, arg1: u64, arg2: &0x2::clock::Clock) : (u64, u8, u64) {
        ...
        assert!(v3 <= 255, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::pyth_price_decimals_too_large());
    ...
    public(friend) fun get_pyth_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &PythFeedData, arg2: &0x2::clock::Clock) : (0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::price_feed::PriceFeedComponent, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::price_feed::PriceFeedComponent) {
        ...
        assert!(v5 == v8, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::pyth_spot_ema_price_decimals_not_match());
        (0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::price_feed::new_component(normalize_decimals(v4, v5), v6), 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::price_feed::new_component(normalize_decimals(v7, v5), v9))
    }

    fun normalize_decimals(arg0: u64, arg1: u8) : u64 {
        let v0 = 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::price_feed::decimals();
        let v1 = if (arg1 < v0) {
            arg0 * pow10_u64(v0 - arg1)
        } else {
            arg0 / pow10_u64(arg1 - v0)
        };
        assert!(v1 > 0, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::pyth_price_decimals_too_large());
        v1
    }
    ...
    public(friend) fun register_pyth_feed<T0>(arg0: &mut 0x2::table::Table<0x1::type_name::TypeName, PythFeedData>, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: u64) {
        assert!(arg2 <= 10000, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::invalid_conf_range());
        assert!(arg3 <= 10000, 0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::oracle_error::invalid_conf_range());
