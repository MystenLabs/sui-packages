module 0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::deep_price {
    ...
    public(friend) fun deep_quantity_u128(arg0: &OrderDeepPrice, arg1: u128, arg2: u128) : u128 {
        if (arg0.asset_is_base) {
            0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::math::mul_u128(arg1, (arg0.deep_per_asset as u128))
        } else {
            0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::math::mul_u128(arg2, (arg0.deep_per_asset as u128))
        }
    }
    ...
    public(friend) fun fee_quantity(arg0: &OrderDeepPrice, arg1: u64, arg2: u64, arg3: bool) : 0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::balances::Balances {
        let v0 = if (arg0.asset_is_base) {
            0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::math::mul(arg1, arg0.deep_per_asset)
        } else {
            0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::math::mul(arg2, arg0.deep_per_asset)
        };
        if (arg0.deep_per_asset > 0) {
            0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::balances::new(0, 0, v0)
        } else if (arg3) {
            0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::balances::new(0, 0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::math::mul(arg2, 0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::constants::fee_penalty_multiplier()), 0)
        } else {
            0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::balances::new(0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::math::mul(arg1, 0x18792d763d641d12167b039ca6b358d7c81be0836d015f02a05e47facad72ca1::constants::fee_penalty_multiplier()), 0, 0)
        }
    }
