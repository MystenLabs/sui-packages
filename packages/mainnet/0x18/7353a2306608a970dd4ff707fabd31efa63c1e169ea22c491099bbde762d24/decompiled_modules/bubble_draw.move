module 0x817f244fc50df064cef85684b7fb1024f6b904aa91d2118dfa704d820d05e920::bubble_draw {
    ...
    entry fun distribute_pop_sui<T0>(arg0: &mut BubbleDraw<T0>, arg1: u64, arg2: &AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 0x1::vector::length<address>(&v0.participants)) {
            ...
            if (!v3) {
                ...
                if (v7 > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.pop_sui, v7), arg3), v2);
