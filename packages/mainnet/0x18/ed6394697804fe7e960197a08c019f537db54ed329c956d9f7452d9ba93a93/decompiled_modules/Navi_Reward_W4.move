module 0x18ed6394697804fe7e960197a08c019f537db54ed329c956d9f7452d9ba93a93::Navi_Reward_W4 {
    struct NAVI_REWARD_W4 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun GiveReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVI_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmXpzK7MRNSRL11e12yBP43gGCafbtu8pt4ygFr1wZpAJA"),
            };
    ...
    fun init(arg0: NAVI_REWARD_W4, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmXpzK7MRNSRL11e12yBP43gGCafbtu8pt4ygFr1wZpAJA"));
        ...
        let v4 = 0x2::package::claim<NAVI_REWARD_W4>(arg0, arg1);
