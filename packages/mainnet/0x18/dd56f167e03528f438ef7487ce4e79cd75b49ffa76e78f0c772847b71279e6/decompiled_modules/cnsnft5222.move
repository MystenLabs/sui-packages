module 0x18dd56f167e03528f438ef7487ce4e79cd75b49ffa76e78f0c772847b71279e6::cnsnft5222 {
    struct CNSNFT5222 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5222, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5222>(arg0, arg1);
