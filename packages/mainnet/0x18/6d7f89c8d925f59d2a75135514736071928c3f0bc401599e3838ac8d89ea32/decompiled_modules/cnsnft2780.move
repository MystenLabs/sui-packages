module 0x186d7f89c8d925f59d2a75135514736071928c3f0bc401599e3838ac8d89ea32::cnsnft2780 {
    struct CNSNFT2780 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2780, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2262"));
        let v4 = 0x2::package::claim<CNSNFT2780>(arg0, arg1);
