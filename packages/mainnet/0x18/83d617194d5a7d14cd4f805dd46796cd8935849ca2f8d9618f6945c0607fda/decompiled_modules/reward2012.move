module 0x1883d617194d5a7d14cd4f805dd46796cd8935849ca2f8d9618f6945c0607fda::reward2012 {
    struct REWARD2012 has drop {
        dummy_field: bool,
    }

    struct TICKET_2012 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2012(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2012>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2012>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2012, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2012>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2012>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2012>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2012>>(v5, 0x2::tx_context::sender(arg1));
    }
