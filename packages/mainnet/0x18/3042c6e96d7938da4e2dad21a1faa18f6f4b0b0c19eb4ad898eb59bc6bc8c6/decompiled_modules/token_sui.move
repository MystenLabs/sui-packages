module 0x183042c6e96d7938da4e2dad21a1faa18f6f4b0b0c19eb4ad898eb59bc6bc8c6::token_sui {
    struct TOKEN_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_SUI>(arg0, 9, b"autism", b"autism", b"The Official Unofficial Sui Mascot. The First Meme Fair Launch Platform on SUI Network. We are bullish on the future of the Sui. To the moon!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dd.dexscreener.com/ds-data/tokens/solana/BkVeSP2GsXV3AYoRJBSZTpFE8sXmcuGnRQcFgoWspump.png?size=xl&key=446d55")), arg1);
        let v2 = v0;
