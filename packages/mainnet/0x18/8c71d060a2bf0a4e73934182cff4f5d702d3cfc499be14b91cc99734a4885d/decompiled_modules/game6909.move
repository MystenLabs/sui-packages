module 0x188c71d060a2bf0a4e73934182cff4f5d702d3cfc499be14b91cc99734a4885d::game6909 {
    struct GAME6909 has drop {
        dummy_field: bool,
    }

    struct TICKET_6909 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6909(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6909>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6909>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME6909, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6909>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6909>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6909>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6909>>(v5, 0x2::tx_context::sender(arg1));
    }
