module 0x1875f2b491d43544cfb790d5203767efd06ea548a74d866b2712256563bf2025::reward2577 {
    struct REWARD2577 has drop {
        dummy_field: bool,
    }

    struct TICKET_2577 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2577(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2577>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2577>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2577, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2577>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2577>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2577>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2577>>(v5, 0x2::tx_context::sender(arg1));
    }
