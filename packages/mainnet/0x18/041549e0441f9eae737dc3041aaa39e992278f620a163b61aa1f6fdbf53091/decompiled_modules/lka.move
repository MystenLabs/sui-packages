module 0x18041549e0441f9eae737dc3041aaa39e992278f620a163b61aa1f6fdbf53091::lka {
    struct LKA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LKA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LKA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"lka"));
