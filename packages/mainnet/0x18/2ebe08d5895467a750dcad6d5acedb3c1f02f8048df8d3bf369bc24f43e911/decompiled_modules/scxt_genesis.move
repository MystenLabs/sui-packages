module 0x182ebe08d5895467a750dcad6d5acedb3c1f02f8048df8d3bf369bc24f43e911::scxt_genesis {
    ...
    fun init(arg0: SCXT_GENESIS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SCXT_GENESIS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SCXT Genesis"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeihg3w33riimj4tjghoqc4c5cnp6qdh5yrnbfxee6rust66gmiztqi"));
