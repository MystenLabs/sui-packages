module 0x18979e532db304348b7d794226fd507a224cb7d4c0b9a4476f9a5bca3b518bcd::cnsnft8408 {
    struct CNSNFT8408 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8408, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8408>(arg0, arg1);
