module 0x189d946c738c8b57996c53700c3ea9968dada0a343c92c10bd56bc9839540abf::subscription {
    ...
    fun approve_internal(arg0: vector<u8>, arg1: &Subscription, arg2: &Service, arg3: &0x2::clock::Clock) : bool {
        ...
        0x189d946c738c8b57996c53700c3ea9968dada0a343c92c10bd56bc9839540abf::utils::is_prefix(0x2::object::uid_to_bytes(&arg2.id), arg0)
    }
