module 0x18b39942b11b214b0b2e2f06f721c8decdb0d6dfa8ee921caae3d910cbf9699f::author_nft {
    ...
    fun init(arg0: AUTHOR_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = LiteraryCollection{
            ...
            name             : 0x1::string::utf8(b"Walrus Lit Blob Issue 0.5 Collection"),
            ...
            collection_image : 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/nbhx7g7kLT_O3kqZIMsA2mdQes4f4bXBq2HDfVNEM28"),
        ...
        0x2::display::add<AuthorNFT>(&mut v5, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{title}"));
        ...
        0x2::display::add<AuthorNFT>(&mut v5, 0x1::string::utf8(b"link"), 0x1::string::utf8(b"{story_url}"));
        ...
        0x2::display::add<AuthorNFT>(&mut v5, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<AuthorNFT>(&mut v5, 0x1::string::utf8(b"edition"), 0x1::string::utf8(b"{edition}"));
        0x2::display::add<AuthorNFT>(&mut v5, 0x1::string::utf8(b"total_supply"), 0x1::string::utf8(b"{total_supply}"));
