module 0x302edfd10144e23db411752828c782616acefea01e009b9b873622e77ff057d1::cnsnft8510 {
    struct CNSNFT8510 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8510, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6157"));
        let v4 = 0x2::package::claim<CNSNFT8510>(arg0, arg1);
