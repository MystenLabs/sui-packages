module 0x3016c0b2e8dd2be405810404a0529054218550d0b2ae7d665b5a32b6690b2f50::cnsnft2398 {
    struct CNSNFT2398 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2398, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2398>(arg0, arg1);
