module 0x30e076508cc294aa16a9ea4a5d6c853b9457d2f9442f611d08e3fc8425e6b878::cult {
    ...
    fun init(arg0: CULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/ethereum/0x0000000000c5dc95539589fbd24be07c6c14eca4.png?size=lg&key=d87f22                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<CULT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CULT    ")))), trim_right(b"Milady Cult Coin                "), trim_right(b"Milady world order Cult coin                                                                                                                                                                                                                                                                                                    "), v2, arg1);
        let v5 = v3;
