module 0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::bank {
    ...
    public(friend) fun prepare_for_pending_withdraw<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 == 0) {
            ...
            let v3 = 0x1::u64::min(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::ceil(ctoken_amount<T0, T1, T2>(arg0, arg1, 0x1::u64::max(v1, arg0.min_token_block_size))), v2.ctokens);
            if (v3 == 0) {
            } else {
                let v4 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::withdraw_ctokens<T0, T1>(arg1, v2.reserve_array_index, &v2.obligation_cap, arg3, v3, arg4);
                let v5 = 0x2::coin::value<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::CToken<T0, T1>>(&v4);
                let v6 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::redeem_ctokens_and_withdraw_liquidity<T0, T1>(arg1, v2.reserve_array_index, arg3, v4, 0x1::option::none<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::RateLimiterExemption<T0, T1>>(), arg4);
                let v7 = 0x1::option::borrow_mut<Lending<T0>>(&mut arg0.lending);
                v7.ctokens = v7.ctokens - v5;
                0x2::balance::join<T1>(&mut arg0.funds_available, 0x2::coin::into_balance<T1>(v6));
                let v8 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::ctoken_ratio<T0>(0x1::vector::borrow<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::Reserve<T0>>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserves<T0>(arg1), v7.reserve_array_index));
                assert!(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::mul(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(v7.ctokens), v8)) >= 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(funds_deployed<T0, T1, T2>(arg0, 0x1::option::some<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::Decimal>(v8))), 6);
                let v9 = BankLiquidityEvent{
                    bank_id         : 0x2::object::id<Bank<T0, T1, T2>>(arg0),
                    funds_available : 0x2::balance::value<T1>(&arg0.funds_available),
                    funds_deployed  : 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(funds_deployed<T0, T1, T2>(arg0, 0x1::option::some<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::Decimal>(v8))),
                };
                0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::events::emit_event<BankLiquidityEvent>(v9);
                let v10 = RecallEvent{
                    bank_id           : 0x2::object::id<Bank<T0, T1, T2>>(arg0),
                    lending_market_id : 0x2::object::id<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>>(arg1),
                    recalled_amount   : 0x2::coin::value<T1>(&v6),
                    ctokens_burned    : v5,
                };
                0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::events::emit_event<RecallEvent>(v10);
            };
        };
    }
    ...
    public fun rebalance<T0, T1, T2>(arg0: &mut Bank<T0, T1, T2>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 < v2 - v3) {
            ...
            if (v0 < arg0.min_token_block_size) {
                return
            };
            ...
            if (v5 == 0) {
                ...
                let v7 = 0x1::u64::min(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::ceil(ctoken_amount<T0, T1, T2>(arg0, arg1, 0x1::u64::max(v5, arg0.min_token_block_size))), v6.ctokens);
                if (v7 == 0) {
                } else {
                    let v8 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::withdraw_ctokens<T0, T1>(arg1, v6.reserve_array_index, &v6.obligation_cap, arg2, v7, arg3);
                    let v9 = 0x2::coin::value<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::CToken<T0, T1>>(&v8);
                    let v10 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::redeem_ctokens_and_withdraw_liquidity<T0, T1>(arg1, v6.reserve_array_index, arg2, v8, 0x1::option::none<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::RateLimiterExemption<T0, T1>>(), arg3);
                    let v11 = 0x1::option::borrow_mut<Lending<T0>>(&mut arg0.lending);
                    v11.ctokens = v11.ctokens - v9;
                    0x2::balance::join<T1>(&mut arg0.funds_available, 0x2::coin::into_balance<T1>(v10));
                    let v12 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::ctoken_ratio<T0>(0x1::vector::borrow<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::Reserve<T0>>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserves<T0>(arg1), v11.reserve_array_index));
                    assert!(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::mul(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(v11.ctokens), v12)) >= 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(funds_deployed<T0, T1, T2>(arg0, 0x1::option::some<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::Decimal>(v12))), 6);
                    let v13 = BankLiquidityEvent{
                        bank_id         : 0x2::object::id<Bank<T0, T1, T2>>(arg0),
                        funds_available : 0x2::balance::value<T1>(&arg0.funds_available),
                        funds_deployed  : 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(funds_deployed<T0, T1, T2>(arg0, 0x1::option::some<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::Decimal>(v12))),
                    };
                    0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::events::emit_event<BankLiquidityEvent>(v13);
                    let v14 = RecallEvent{
                        bank_id           : 0x2::object::id<Bank<T0, T1, T2>>(arg0),
                        lending_market_id : 0x2::object::id<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>>(arg1),
                        recalled_amount   : 0x2::coin::value<T1>(&v10),
                        ctokens_burned    : v9,
                    };
                    0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::events::emit_event<RecallEvent>(v14);
                };
            };
        };
    }
    ...
    public fun rebalance_sui<T0, T1>(arg0: &mut Bank<T0, 0x2::sui::SUI, T1>, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 < v2 - v3) {
            ...
            if (v5 == 0) {
                ...
                let v7 = 0x1::u64::min(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::ceil(ctoken_amount<T0, 0x2::sui::SUI, T1>(arg0, arg1, 0x1::u64::max(v5, arg0.min_token_block_size))), v6.ctokens);
                if (v7 == 0) {
                } else {
                    let v8 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::withdraw_ctokens<T0, 0x2::sui::SUI>(arg1, v6.reserve_array_index, &v6.obligation_cap, arg3, v7, arg4);
                    let v9 = 0x2::coin::value<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::CToken<T0, 0x2::sui::SUI>>(&v8);
                    let v10 = v6.reserve_array_index;
                    let v11 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::redeem_ctokens_and_withdraw_liquidity_request<T0, 0x2::sui::SUI>(arg1, v10, arg3, v8, 0x1::option::none<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::RateLimiterExemption<T0, 0x2::sui::SUI>>(), arg4);
                    0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::unstake_sui_from_staker<T0>(arg1, v10, &v11, arg2, arg4);
                    let v12 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::fulfill_liquidity_request<T0, 0x2::sui::SUI>(arg1, v10, v11, arg4);
                    let v13 = 0x1::option::borrow_mut<Lending<T0>>(&mut arg0.lending);
                    v13.ctokens = v13.ctokens - v9;
                    0x2::balance::join<0x2::sui::SUI>(&mut arg0.funds_available, 0x2::coin::into_balance<0x2::sui::SUI>(v12));
                    let v14 = 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::ctoken_ratio<T0>(0x1::vector::borrow<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::reserve::Reserve<T0>>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::reserves<T0>(arg1), v13.reserve_array_index));
                    assert!(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::mul(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::from(v13.ctokens), v14)) >= 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(funds_deployed<T0, 0x2::sui::SUI, T1>(arg0, 0x1::option::some<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::Decimal>(v14))), 6);
                    let v15 = BankLiquidityEvent{
                        bank_id         : 0x2::object::id<Bank<T0, 0x2::sui::SUI, T1>>(arg0),
                        funds_available : 0x2::balance::value<0x2::sui::SUI>(&arg0.funds_available),
                        funds_deployed  : 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::floor(funds_deployed<T0, 0x2::sui::SUI, T1>(arg0, 0x1::option::some<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::decimal::Decimal>(v14))),
                    };
                    0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::events::emit_event<BankLiquidityEvent>(v15);
                    let v16 = RecallEvent{
                        bank_id           : 0x2::object::id<Bank<T0, 0x2::sui::SUI, T1>>(arg0),
                        lending_market_id : 0x2::object::id<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>>(arg1),
                        recalled_amount   : 0x2::coin::value<0x2::sui::SUI>(&v12),
                        ctokens_burned    : v9,
                    };
                    0x4fb1cf45dffd6230305f1d269dd1816678cc8e3ba0b747a813a556921219f261::events::emit_event<RecallEvent>(v16);
                };
            };
        };
    }
