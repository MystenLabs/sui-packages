module 0x30149d26989947f382199a09ec9ecf02ef6b12327ec80247022a241ad946f2b0::giverep_genesis_nft {
    struct GIVEREP_GENESIS_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GIVEREP_GENESIS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GIVEREP_GENESIS_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"GiveRep Genesis NFT"));
