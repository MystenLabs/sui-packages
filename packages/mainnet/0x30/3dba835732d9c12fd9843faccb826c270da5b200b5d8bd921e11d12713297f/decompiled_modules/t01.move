module 0x303dba835732d9c12fd9843faccb826c270da5b200b5d8bd921e11d12713297f::t01 {
    struct T01 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: T01, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<T01>(arg0, 6, b"T01", b"Test1", b"yolo", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
