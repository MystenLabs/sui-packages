module 0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::router {
    ...
    fun assert_admin_has_authorized_package(arg0: &0x2::object::UID) {
        assert!(0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::admin::has_authorized(arg0), 0);
    }
    ...
    public fun begin_router_tx_and_collect_fees<T0>(arg0: vector<u8>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::protocol_fee::ProtocolFeeConfig, arg4: &0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::treasury::Treasury, arg5: &mut 0x2::tx_context::TxContext) : RouterSwapCap<T0> {
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert_route_starts_with_non_zero_value(v0);
        0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::protocol_fee::distribute_protocol_fees<T0>(arg3, arg4, &mut arg1, arg5);
        let v1 = SwapMetadata{
    ...
    public fun end_router_tx<T0>(arg0: RouterSwapCap<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::events::emit_swap_completed_event(v8.typeName, v8.amount, v7.typeName, v7.amount, arg1);
    }

    fun init(arg0: ROUTER, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_transfer<0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::admin::AdminCap>(0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::admin::create_admin_cap(arg1), v0);
        let (v1, v2) = 0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::protocol_fee::create_config<ROUTER>(&arg0, arg1);
        0x2::transfer::public_share_object<0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::protocol_fee::ProtocolFeeConfig>(v1);
        0x2::transfer::public_transfer<0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::protocol_fee::ChangeFeeCap>(v2, v0);
        0x2::transfer::public_share_object<0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::treasury::Treasury>(0x3006e6a6435e6ec339d4aaf603d3547097efc00c00ee06ea195deba1b9ba7a78::treasury::create_treasury(arg1));
    ...
    public fun update_path_metadata<T0>(arg0: vector<u8>, arg1: &mut RouterSwapCap<T0>, arg2: &0x2::object::UID, arg3: u64) {
        assert_admin_has_authorized_package(arg2);
