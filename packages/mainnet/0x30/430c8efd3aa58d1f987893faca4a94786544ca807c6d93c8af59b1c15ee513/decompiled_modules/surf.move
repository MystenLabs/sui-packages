module 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::surf {
    ...
    public fun mint(arg0: &mut MintConfig, arg1: &mut 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::recorder::Recorder, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : SurfNFT {
        assert!(arg0.version == 1, 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::wrong_version());
        let v0 = if (arg0.live) {
            if (arg0.season >= 1) {
                arg0.mint_cost > 0
        ...
        assert!(v0, 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::not_configured());
        let v1 = 0x2::tx_context::sender(arg3);
        let v2 = current_week(arg0, arg2);
        assert!(0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::recorder::points_of(arg1, v1) >= arg0.threshold, 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::below_threshold());
        if (v2 >= 2 && arg0.weekly_cap > 0) {
            assert!(weekly_minted(arg0, v1, v2) < arg0.weekly_cap, 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::weekly_cap_reached());
        };
        0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::recorder::add_spent(arg1, v1, arg0.mint_cost);
