module 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg0.version == 1, 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::wrong_version());
        assert!(points_of(arg0, arg1) >= arg2, 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::insufficient_points());
    ...
    public fun migrate(arg0: &AdminCap, arg1: &mut Recorder) {
        assert!(arg1.version < 1, 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::wrong_version());
        arg1.version = 1;
    }
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 >= earned_of(arg0, arg1), 0x30430c8efd3aa58d1f987893faca4a94786544ca807c6d93c8af59b1c15ee513::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
