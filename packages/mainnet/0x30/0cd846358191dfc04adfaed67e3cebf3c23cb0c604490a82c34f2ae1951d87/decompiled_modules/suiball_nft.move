module 0x300cd846358191dfc04adfaed67e3cebf3c23cb0c604490a82c34f2ae1951d87::suiball_nft {
    ...
    fun init(arg0: SUIBALL_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"NFT received for Pre-Ordering Suiball Hardware Wallet. NFT will be used to claim the hardware wallets. Website: Suiball.com"));
