module 0x30d8f7a7d1220654348877fba9eaa8002013d6ac4d4a2c828a1fec88d01c09f6::its {
    ...
    public fun register_transaction(arg0: &mut 0x2b839b25c7133e5e0f8f585cb2e89bf430a6585a88c4a0343ae3b246372d431c::discovery::RelayerDiscovery, arg1: &Singleton, arg2: &0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService, arg3: &0x2::clock::Clock) {
        ...
        0x1::vector::push_back<vector<u8>>(v1, 0x30d8f7a7d1220654348877fba9eaa8002013d6ac4d4a2c828a1fec88d01c09f6::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService>(arg2))));
        0x1::vector::push_back<vector<u8>>(v1, x"03");
        0x1::vector::push_back<vector<u8>>(v1, 0x30d8f7a7d1220654348877fba9eaa8002013d6ac4d4a2c828a1fec88d01c09f6::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0x2::clock::Clock>(arg3))));
    ...
    public fun get_final_transaction(arg0: &Singleton, arg1: &0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService, arg2: vector<u8>, arg3: &0x2::clock::Clock) : 0x2b839b25c7133e5e0f8f585cb2e89bf430a6585a88c4a0343ae3b246372d431c::transaction::Transaction {
        ...
        0x1::vector::push_back<vector<u8>>(v1, 0x30d8f7a7d1220654348877fba9eaa8002013d6ac4d4a2c828a1fec88d01c09f6::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<Singleton>(arg0))));
        0x1::vector::push_back<vector<u8>>(v1, 0x30d8f7a7d1220654348877fba9eaa8002013d6ac4d4a2c828a1fec88d01c09f6::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0xc3c0222e59c9d3b34ab804840e271ef9a0e6f0adcc280133c9db9b9e060887ca::interchain_token_service::InterchainTokenService>(arg1))));
        0x1::vector::push_back<vector<u8>>(v1, 0x30d8f7a7d1220654348877fba9eaa8002013d6ac4d4a2c828a1fec88d01c09f6::utils::concat<u8>(x"00", 0x2::address::to_bytes(0x2::object::id_address<0x2::clock::Clock>(arg3))));
