module 0x30d1cd6e02e77b34cf9f5686ede28217b615d15ebd2651c876a782711ed1fd9a::usacoin {
    ...
    fun init(arg0: USACOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/FkhDua761MF8oDXEfiCKsmMm2v45aFNZCTnKVtrLpump.png?size=lg&key=bf79f1                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<USACOIN>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"USACOIN   ")))), trim_right(b"USACOIN                         "), trim_right(b"USACOIN (USACOIN)                                                                                                                                                                                                                                                                                                               "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
