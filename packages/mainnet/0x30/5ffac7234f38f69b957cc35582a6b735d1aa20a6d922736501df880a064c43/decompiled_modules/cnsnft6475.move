module 0x305ffac7234f38f69b957cc35582a6b735d1aa20a6d922736501df880a064c43::cnsnft6475 {
    struct CNSNFT6475 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6475, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1727"));
        let v4 = 0x2::package::claim<CNSNFT6475>(arg0, arg1);
