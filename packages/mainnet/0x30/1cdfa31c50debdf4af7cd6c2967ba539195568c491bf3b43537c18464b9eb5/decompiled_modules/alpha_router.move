module 0xdd929584996781499a3e66892353833b0cea2589c6cf485e7aa6aad9655548a::alpha_router {
    ...
    public entry fun clear_trade_data<T0>(arg0: &mut MemeboxManager, arg1: &mut IntermediateStorage, arg2: &SuperAdminCap, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::length<0x1::type_name::TypeName>(&v4) == 0x2::table::length<0x1::type_name::TypeName, u64>(&0x2::table::borrow<0x1::string::String, ClearingTrade>(&arg1.clearing_trades, arg3).amounts)) {
