module 0x30a15f33145d511779c27a207ae2a9bff0962ee9bf9f8acd413071feccbce7bc::cnsnft6003 {
    struct CNSNFT6003 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6003, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6003>(arg0, arg1);
