module 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch {
    ...
    public fun delivery_calculation_loop<T0, T1>(arg0: &T0, arg1: &Auction<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: u64, arg9: 0x1::option::Option<u64>, arg10: 0x1::option::Option<u64>, arg11: 0x1::option::Option<u64>, arg12: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64) {
        ...
        if (v2 == arg1.bid_index) {
            let v7 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg4);
            let v8 = if (0x1::option::is_some<u64>(&arg6)) {
                ((((v7 * 30) as u128) * (arg5 as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(*0x1::option::borrow<u64>(&arg6)) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4) as u128) * (v7 as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(arg3) as u128)) as u64)
            } else {
                v7 * 30 / 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4)
            };
            let v9 = v3 * 1000 / 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(4);
            let v10 = if (v8 > v9) {
                v9
            } else {
                v8
            ...
            0x2::event::emit<Delivery<T1>>(v11);
        };
        (v2, v3, v4, v6)
    }
