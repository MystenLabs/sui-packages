module 0x308ef87fd0f97b00dcf067264528a57d01c05cbe671d59e89cbaa199627e56d2::scallop_incentive_pass_w {
    ...
    public entry fun DistributeReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SCALLOP_INCENTIVE_PASS{
                ...
                description : 0x1::string::utf8(b"Scallop Incentive Reward of $3000 SCA is ready for you. Claim your reward at https://scallopfi.com"),
    ...
    fun init(arg0: SCALLOP_INCENTIVE_PASS_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Scallop Incentive Reward of $3000 SCA is ready for you. Claim your reward at https://scallopfi.com"));
