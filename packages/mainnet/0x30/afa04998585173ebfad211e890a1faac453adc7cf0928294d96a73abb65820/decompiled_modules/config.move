module 0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::config {
    ...
    public fun deposit_gems_to_treasury(arg0: &mut GemsTreasury, arg1: 0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::hive_gems::HiveGems, arg2: u64) : 0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::hive_gems::HiveGems {
        let v0 = GemsAddedToTreasury{deposit_amt: arg2};
        0x2::event::emit<GemsAddedToTreasury>(v0);
        0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::hive_gems::join(&mut arg0.available_gems, 0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::hive_gems::split(&mut arg1, arg2));
        arg1
    }
    ...
    public entry fun get_fee_info<T0>(arg0: &Config) : (u64, u64) {
        if (0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::curves::is_stable<T0>()) {
            return (arg0.stable_pool_fee.total_fee_bps, arg0.stable_pool_fee.hive_fee_percent)
        };
        if (0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::curves::is_weighted<T0>()) {
            return (arg0.weighted_pool_fee.total_fee_bps, arg0.weighted_pool_fee.hive_fee_percent)
        };
        if (0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::curves::is_curved<T0>()) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = Treasury<0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::hsui::HSUI>{
            id      : 0x2::object::new(arg0),
            balance : 0x2::balance::zero<0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::hsui::HSUI>(),
        };
        0x2::transfer::share_object<Treasury<0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::hsui::HSUI>>(v8);
        let v9 = GemsTreasury{
            id             : 0x2::object::new(arg0),
    ...
    public fun update_default_fee_for_curve<T0>(arg0: &mut Config, arg1: &HiveDaoCapability, arg2: u64, arg3: u64) {
        0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::curves::assert_valid_curve<T0>();
        if (0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::curves::is_stable<T0>()) {
            let v0 = &mut arg0.stable_pool_fee;
            update_fee(v0, arg2, arg3);
        } else if (0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::curves::is_weighted<T0>()) {
            let v1 = &mut arg0.weighted_pool_fee;
            update_fee(v1, arg2, arg3);
        } else if (0x30afa04998585173ebfad211e890a1faac453adc7cf0928294d96a73abb65820::curves::is_curved<T0>()) {
