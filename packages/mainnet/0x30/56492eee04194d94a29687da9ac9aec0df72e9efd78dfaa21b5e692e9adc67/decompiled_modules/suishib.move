module 0x3056492eee04194d94a29687da9ac9aec0df72e9efd78dfaa21b5e692e9adc67::suishib {
    ...
    fun init(arg0: SUISHIB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUISHIB>(arg0, 4, b"SUISHIB", b"SuiShiba Inu", b"The first meme token on Sui Blockchain, @SuiShibaInu", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suishibainu.xyz/images/small-logo.png")), arg1);
