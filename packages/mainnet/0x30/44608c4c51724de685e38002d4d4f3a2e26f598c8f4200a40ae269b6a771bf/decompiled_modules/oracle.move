module 0x3044608c4c51724de685e38002d4d4f3a2e26f598c8f4200a40ae269b6a771bf::oracle {
    ...
    public fun update_price(arg0: &mut KriyaOracle, arg1: &mut 0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg2: 0x1::type_name::TypeName) {
        let (v0, v1) = 0x3044608c4c51724de685e38002d4d4f3a2e26f598c8f4200a40ae269b6a771bf::supra_adapter::get_supra_price(arg1, *0x2::table::borrow<0x1::type_name::TypeName, u32>(&arg0.supra_pair_ids, arg2));
        assert!(v0 > 0, 0);
        let v2 = Price{
            price      : v0,
            updated_at : v1,
