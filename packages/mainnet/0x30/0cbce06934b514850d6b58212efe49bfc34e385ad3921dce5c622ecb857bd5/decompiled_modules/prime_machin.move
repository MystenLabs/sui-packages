module 0x300cbce06934b514850d6b58212efe49bfc34e385ad3921dce5c622ecb857bd5::prime_machin {
    ...
    fun init(arg0: PRIME_MACHIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Prime Machin are 3,333 robots manufactured by the Triangle Company."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiewoxwlw34ehrwfwrk2geo2ojn67hmhyz4v5yk2bkyuleux5hpvv4"));
