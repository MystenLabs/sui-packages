module 0x30ea7f7b798479aa3f99b7b4cb8b37c0f2374490c863bdaa7aaa93928a002787::vnd {
    struct VND has drop {
        dummy_field: bool,
    }

    fun init(arg0: VND, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<VND>(arg0, 6, b"VND", b"VUNDIO", b"Start to manage your collectibles on SUI Network. Vundio's sleek design and user-friendly features make the experience enjoyable and efficient. $VND.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/photo_2024_10_13_19_51_06_65ac2abfdd.jpg")), arg1);
