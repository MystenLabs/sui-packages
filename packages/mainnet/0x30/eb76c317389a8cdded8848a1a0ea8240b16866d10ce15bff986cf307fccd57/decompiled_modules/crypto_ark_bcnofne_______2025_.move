module 0x30eb76c317389a8cdded8848a1a0ea8240b16866d10ce15bff986cf307fccd57::crypto_ark_bcnofne_______2025_ {
    struct CRYPTO_ARK_BCNOFNE_______2025_ has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"3a5e23bf-9160-4695-b95f-f398599f6618"),
        };
    ...
    fun init(arg0: CRYPTO_ARK_BCNOFNE_______2025_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CRYPTO_ARK_BCNOFNE_______2025_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(x"43727970746f2041726b3a42434e4f464e657ee69982e58c96e38289e381a3e381a1e38287323032357e"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"20506c65617365206275792026666f6c6c6f77206d65206f6e205820284041796e79616e6e29202e205468656e2c20444d2077697468207468652070687261736520e2809ce69982e58c96e38289e381a3e381a1e382872ee2809d2050726f6261626c79206e6f7468696e67202e"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmYGj9s91h4uu5qFstm3ZiAicvcpBUfmg7oPcZWxXc3kP3"));
    ...
    public entry fun mint_nft(arg0: &0x2::clock::Clock, arg1: &mut Manager, arg2: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg3: 0x1::string::String, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: 0x1::string::String, arg8: u64, arg9: u64, arg10: u64, arg11: vector<u8>, arg12: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg13: &mut 0x2::kiosk::Kiosk, arg14: &0x2::kiosk::KioskOwnerCap, arg15: &0x2::transfer_policy::TransferPolicy<Nft>, arg16: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = MintNftEvent{
            ...
            price                     : arg9 + arg10,
            collection_id             : 0x1::string::utf8(b"3a5e23bf-9160-4695-b95f-f398599f6618"),
            collection_creator_wallet : @0x901b1354a381950a9c15954c184b136ea5346079e8d0696473377e9089e157ef,
