module 0x30a750074e0a401b6afbe8da86d7f9b2477b8fa2d3cc0e04e7dc802dfd0a88d9::cnsnft3987 {
    struct CNSNFT3987 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3987, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3862"));
        let v4 = 0x2::package::claim<CNSNFT3987>(arg0, arg1);
