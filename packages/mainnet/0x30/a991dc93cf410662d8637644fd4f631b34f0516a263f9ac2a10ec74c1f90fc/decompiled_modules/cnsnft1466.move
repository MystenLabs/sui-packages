module 0x30a991dc93cf410662d8637644fd4f631b34f0516a263f9ac2a10ec74c1f90fc::cnsnft1466 {
    struct CNSNFT1466 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1466, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1466>(arg0, arg1);
