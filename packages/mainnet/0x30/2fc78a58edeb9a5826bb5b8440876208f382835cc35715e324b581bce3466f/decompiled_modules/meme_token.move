module 0x302fc78a58edeb9a5826bb5b8440876208f382835cc35715e324b581bce3466f::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"Zo", b"Test pre", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-08T08-54-03.991Z-images (7).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Test pre"),
            symbol     : 0x1::string::utf8(b"Zo"),
            decimals   : 9,
