module 0x30022e38d421b3eb5817810e566b7b302713697764fbd0767a4a02919734c49f::usdc {
    struct USDC has drop {
        dummy_field: bool,
    }

    fun init(arg0: USDC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0xaee66d8555b18e3229269d273c0bdb58a86a879434b36ac1527491bc27def5db::upgrade_service::new<USDC>(arg0, 0x2::tx_context::sender(arg1), arg1);
        ...
        0x2::transfer::public_share_object<0x3c4f21f316149879cdec24dfc20f175f82520dd242a8e648e27e0013a458f93a::treasury::Treasury<USDC>>(0x3c4f21f316149879cdec24dfc20f175f82520dd242a8e648e27e0013a458f93a::treasury::new<USDC>(v2, v3, 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), 0x2::tx_context::sender(arg1), arg1));
        0x2::transfer::public_share_object<0xaee66d8555b18e3229269d273c0bdb58a86a879434b36ac1527491bc27def5db::upgrade_service::UpgradeService<USDC>>(v0);
    }
