module 0x309ff19e68d7baa8a7ee4bb9e464485f25249f6fda375a2e47084f81794727a6::ipx_coin_standard {
    struct CapWitness {
        treasury: address,
    ...
    public fun destroy_burn_cap(arg0: BurnCap, arg1: &mut IPXTreasuryStandard) {
        let BurnCap {
            id       : v0,
            treasury : v1,
            name     : v2,
        } = arg0;
        assert!(v1 == 0x2::object::uid_to_address(&arg1.id), 3);
        arg1.burn_cap = 0x1::option::none<address>();
        let v3 = DestroyBurnCap{pos0: v2};
        0x2::event::emit<DestroyBurnCap>(v3);
        0x2::object::delete(v0);
    }

    public fun destroy_cap_witness(arg0: CapWitness, arg1: &mut IPXTreasuryStandard) {
        let CapWitness {
            treasury             : v0,
            name                 : _,
            mint_cap_address     : v2,
        ...
        assert!(v0 == 0x2::object::uid_to_address(&arg1.id), 3);
        arg1.mint_cap = v2;
        arg1.burn_cap = v3;
        arg1.metadata_cap = v4;
    }

    public fun destroy_metadata_cap(arg0: MetadataCap, arg1: &mut IPXTreasuryStandard) {
        let MetadataCap {
            id       : v0,
            treasury : v1,
            name     : v2,
        ...
        assert!(v1 == 0x2::object::uid_to_address(&arg1.id), 3);
        arg1.metadata_cap = 0x1::option::none<address>();
        let v3 = DestroyMetadataCap{pos0: v2};
        0x2::event::emit<DestroyMetadataCap>(v3);
        0x2::object::delete(v0);
    }

    public fun destroy_mint_cap(arg0: MintCap, arg1: &mut IPXTreasuryStandard) {
        let MintCap {
            id       : v0,
            treasury : v1,
            name     : v2,
        ...
        assert!(v1 == 0x2::object::uid_to_address(&arg1.id), 3);
        arg1.mint_cap = 0x1::option::none<address>();
