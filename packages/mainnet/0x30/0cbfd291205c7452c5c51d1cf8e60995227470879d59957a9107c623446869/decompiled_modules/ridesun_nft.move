module 0x300cbfd291205c7452c5c51d1cf8e60995227470879d59957a9107c623446869::ridesun_nft {
    struct RIDESUN_NFT has drop {
        dummy_field: bool,
    }

    struct RidesunNFT has store, key {
        id: 0x2::object::UID,
        nft_id: u64,
    ...
    public entry fun burn(arg0: &mut MintRecord, arg1: RidesunNFT) {
    ...
    fun init(arg0: RIDESUN_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::package::claim<RIDESUN_NFT>(arg0, arg1);
        let v6 = 0x2::display::new_with_fields<RidesunNFT>(&v5, v0, v2, arg1);
        0x2::transfer::share_object<MintRecord>(v4);
        0x2::display::update_version<RidesunNFT>(&mut v6);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<RidesunNFT>>(v6, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun mint(arg0: &mut MintRecord, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = NFTMinted{
            object_id : 0x2::object::id<RidesunNFT>(&v1),
            creator   : 0x2::tx_context::sender(arg4),
            name      : v1.name,
        };
        0x2::event::emit<NFTMinted>(v2);
        0x2::transfer::public_transfer<RidesunNFT>(v1, arg3);
    }
