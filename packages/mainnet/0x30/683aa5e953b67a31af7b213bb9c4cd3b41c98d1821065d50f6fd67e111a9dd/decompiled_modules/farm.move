module 0x30683aa5e953b67a31af7b213bb9c4cd3b41c98d1821065d50f6fd67e111a9dd::farm {
    ...
    public fun claim<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &mut KriyaFarm<T0, T1, T2>, arg2: &mut StakedPosition<T0, T1, T2>) : 0x2::balance::Balance<T2> {
        ...
        let v1 = (0x30683aa5e953b67a31af7b213bb9c4cd3b41c98d1821065d50f6fd67e111a9dd::math::mul_factor_u128((arg2.stake_weight as u128), arg1.cumulative_unit - arg2.start_unit, 18446744073709551616) as u64);
    ...
    fun collect_rewards<T0, T1, T2>(arg0: &mut KriyaFarm<T0, T1, T2>, arg1: 0x2::balance::Balance<T2>) {
        ...
        if (v0 > 0) {
            ...
            arg0.cumulative_unit = arg0.cumulative_unit + 0x30683aa5e953b67a31af7b213bb9c4cd3b41c98d1821065d50f6fd67e111a9dd::math::mul_factor_u128((v0 as u128), 18446744073709551616, (arg0.total_weight as u128));
        } else {
    ...
    public fun get_virtual_released_amount<T0, T1, T2>(arg0: &KriyaFarm<T0, T1, T2>, arg1: u64) : u64 {
        if (arg1 > arg0.last_harvest_time) {
            let v1 = 0x30683aa5e953b67a31af7b213bb9c4cd3b41c98d1821065d50f6fd67e111a9dd::math::mul_factor(arg0.reward_amount, arg1 - arg0.last_harvest_time, arg0.reward_interval);
            let v2 = v1;
    ...
    public fun new_<T0, T1, T2>(arg0: &AdminCap, arg1: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : KriyaFarm<T0, T1, T2> {
        KriyaFarm<T0, T1, T2>{
    ...
    fun release_rewards<T0, T1, T2>(arg0: &mut KriyaFarm<T0, T1, T2>, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<T2> {
        ...
        if (v0 > arg0.last_harvest_time) {
            let v2 = 0x30683aa5e953b67a31af7b213bb9c4cd3b41c98d1821065d50f6fd67e111a9dd::math::mul_factor(arg0.reward_amount, v0 - arg0.last_harvest_time, arg0.reward_interval);
            let v3 = v2;
    ...
    public fun stake<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &mut KriyaFarm<T0, T1, T2>, arg2: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : StakedPosition<T0, T1, T2> {
        ...
        let v1 = 0x30683aa5e953b67a31af7b213bb9c4cd3b41c98d1821065d50f6fd67e111a9dd::math::compute_weight(v0, arg3, arg1.min_lock_time, arg1.max_lock_time);
