module 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin {
    ...
    struct LockCoinEvent has copy, drop, store {
        type: 0x1::type_name::TypeName,
        amount: u64,
        locked_until_time: u64,
    }

    struct UnlockCoinEvent has copy, drop, store {
        type: 0x1::type_name::TypeName,
        amount: u64,
    ...
    public fun unlock_coin<T0>(arg0: LockedCoin<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v4 = v1;
        let v5 = v0;
        assert!(v3 <= 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::utils::now_timestamp(arg1), 1);
