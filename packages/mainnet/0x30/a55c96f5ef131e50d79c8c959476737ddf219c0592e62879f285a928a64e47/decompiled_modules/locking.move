module 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::locking {
    ...
    public fun cancel_redeem_lock(arg0: &mut LockUpManager, arg1: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::XcetusManager, arg2: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT, arg3: 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::LockedCoin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>, arg4: &0x2::clock::Clock) {
        ...
        assert!(0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::lock_time<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&arg3) > 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::utils::now_timestamp(arg4), 5);
        let v0 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow<0x2::object::ID, LockInfo>(&arg0.lock_infos, 0x2::object::id<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::LockedCoin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>>(&arg3));
        assert!(v0.venft_id == 0x2::object::id<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT>(arg2), 4);
        assert!(0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::value<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&arg3) == v0.cetus_amount, 4);
        let (v1, v2) = 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::destory_lock<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(arg3);
        assert!(v2 == v0.lock_id, 4);
        0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::update_unlocked(arg1, arg2, v0.xcetus_amount);
    ...
    public fun convert(arg0: &mut LockUpManager, arg1: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::XcetusManager, arg2: vector<0x2::coin::Coin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>>, arg3: u64, arg4: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT, arg5: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        let v0 = 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::utils::merge_coins<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(arg2, arg5);
        ...
        0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::mint(arg1, arg4, arg3);
        ...
        let v1 = ConvertEvent{
            venft_id     : 0x2::object::id<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT>(arg4),
            amount       : arg3,
            lock_manager : 0x2::object::id<LockUpManager>(arg0),
        };
    ...
    fun init(arg0: LOCKING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::display::new_with_fields<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT>(&v5, v1, v3, arg1);
        0x2::display::update_version<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT>(&mut v6);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT>>(v6, 0x2::tx_context::sender(arg1));
    ...
    public fun mint_and_convert(arg0: &mut LockUpManager, arg1: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::XcetusManager, arg2: vector<0x2::coin::Coin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        let v0 = 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::mint_venft_object(arg1, arg4);
        let v1 = &mut v0;
        convert(arg0, arg1, arg2, arg3, v1, arg4);
        0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::transfer_venft(v0, arg4);
    }
    ...
    public fun redeem(arg0: &mut LockUpManager, arg1: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::XcetusManager, arg2: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT, arg3: 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::LockedCoin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.venft_id == 0x2::object::id<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT>(arg2), 4);
        assert!(0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::value<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(&arg3) == v0.cetus_amount, 4);
        let v1 = 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::unlock_coin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(arg3, arg4, arg5);
        assert!(v1 == v0.lock_id, 4);
        0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::update_unlocked(arg1, arg2, v0.xcetus_amount);
        0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::burn(arg1, arg2, v0.xcetus_amount, arg5);
    ...
    public fun redeem_lock(arg0: &mut LockUpManager, arg1: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::XcetusManager, arg2: &mut 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(arg3 <= 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::available_value(arg1, arg2), 1);
        ...
        assert!(v0 <= arg3, 3);
        let v1 = take(arg0, v0);
        let v2 = 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::lock_coin::lock_coin<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(0x2::coin::from_balance<0x6864a6f921804860930db6ddbe2e16acdf8504495ea7481637a1c8b9a8fe54b::cetus::CETUS>(v1, arg6), 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::utils::now_timestamp(arg5), 0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::utils::now_timestamp(arg5) + arg4 * 60, 0x2::tx_context::sender(arg6), arg6);
        let v3 = 0x2::object::id<0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::VeNFT>(arg2);
        let v4 = LockInfo{
            venft_id      : v3,
            lock_id       : v2,
            xcetus_amount : arg3,
        ...
        0x30a55c96f5ef131e50d79c8c959476737ddf219c0592e62879f285a928a64e47::xcetus::update_locked(arg1, arg2, arg3);
    ...
    fun redeem_num(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : u64 {
        if (arg1 == arg0) {
            ((100000000000 * (arg2 as u128) * (arg5 as u128) / 1000) as u64)
        } else {
