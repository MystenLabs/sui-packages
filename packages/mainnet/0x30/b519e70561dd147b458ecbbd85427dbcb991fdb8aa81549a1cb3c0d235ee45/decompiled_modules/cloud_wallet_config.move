module 0x30b519e70561dd147b458ecbbd85427dbcb991fdb8aa81549a1cb3c0d235ee45::cloud_wallet_config {
    ...
    public(friend) fun check_mm_withdraw_id_used(arg0: &CloudWalletConfig, arg1: u256) {
        assert!(!0x2::table::contains<u256, bool>(0x2::dynamic_field::borrow<0x1::ascii::String, 0x2::table::Table<u256, bool>>(&arg0.id, 0x1::ascii::string(b"mm_withdraw_id")), arg1), 20009);
    }
    ...
    public fun init_mm_withdraw_id_used(arg0: &mut CloudWalletConfig, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::dynamic_field::exists_<0x1::ascii::String>(&arg0.id, 0x1::ascii::string(b"mm_withdraw_id")), 20018);
        0x2::dynamic_field::add<0x1::ascii::String, 0x2::table::Table<u256, bool>>(&mut arg0.id, 0x1::ascii::string(b"mm_withdraw_id"), 0x2::table::new<u256, bool>(arg1));
    }

    public(friend) fun mark_mm_withdraw_id_used(arg0: &mut CloudWalletConfig, arg1: u256) {
        0x2::table::add<u256, bool>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::table::Table<u256, bool>>(&mut arg0.id, 0x1::ascii::string(b"mm_withdraw_id")), arg1, true);
    }
