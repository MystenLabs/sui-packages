module 0x30c745e730bf96dbbfe8cb58732afa810920e5457b75112ee8936804a3d6c36a::five_minutes {
    ...
    entry fun start(arg0: &mut Round, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        let v3 = RoundStartEvent{
            round_id      : 0x1::vector::borrow<RoundMetadata>(&arg0.rounds, v2).round,
            status        : 0,
            start_time_ms : 0x2::clock::timestamp_ms(arg2),
            end_time_ms   : 0x2::clock::timestamp_ms(arg2) + arg1,
        };
        0x2::event::emit<RoundStartEvent>(v3);
        0x1::debug::print<Round>(arg0);
