module 0x30c12bbae3cc64ee424bc1e19d9848d1b0cc0f1ea5ab9e2058a581acbbb13232::cnsnft3941 {
    struct CNSNFT3941 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3941, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3941>(arg0, arg1);
