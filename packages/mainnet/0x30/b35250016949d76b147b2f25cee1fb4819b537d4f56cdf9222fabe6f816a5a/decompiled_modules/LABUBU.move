module 0x30b35250016949d76b147b2f25cee1fb4819b537d4f56cdf9222fabe6f816a5a::LABUBU {
    ...
    fun init(arg0: LABUBU, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<LABUBU>>(0x2::coin::mint<LABUBU>(&mut v3, 8600000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
