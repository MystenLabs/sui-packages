module 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::user_manager {
    ...
    public fun new(arg0: &0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : UserManager {
        UserManager{relations: 0x2::table::new<address, UserRelation>(arg1)}
    }

    public fun accept_friend_request(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun can_send_friend_request(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : bool {
    ...
    public fun create_friend_request(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::blacklist::assert_not_banned(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(can_send_friend_request(arg0, arg1, arg2), 100);
        let v1 = FriendRequestInfo{dummy_field: false};
        0x2::table::add<address, FriendRequestInfo>(&mut 0x2::table::borrow_mut<address, UserRelation>(&mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::app_object_mut<0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::version::UserManagerV1, UserManager>(arg0).relations, arg1).friend_requests_received, v0, v1);
    ...
    public fun create_relation(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: &mut 0x2::tx_context::TxContext) {
        0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::blacklist::assert_not_banned(arg0, 0x2::tx_context::sender(arg1));
        let v0 = 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::app_object_mut<0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::version::UserManagerV1, UserManager>(arg0);
        internal_create_relation(v0, arg1);
    }

    public fun get_friend_info(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : &FriendInfo {
        0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::blacklist::assert_not_banned(arg0, 0x2::tx_context::sender(arg2));
        0x2::table::borrow<address, FriendInfo>(&get_or_create_relation(arg0, arg2).friends, arg1)
    }

    fun get_or_create_relation(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: &mut 0x2::tx_context::TxContext) : &UserRelation {
        let v0 = 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::app_object_mut<0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::version::UserManagerV1, UserManager>(arg0);
    ...
    fun get_or_create_relation_from_address(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : &UserRelation {
        let v0 = 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::app_object_mut<0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::version::UserManagerV1, UserManager>(arg0);
    ...
    fun get_or_create_relation_mut(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: &mut 0x2::tx_context::TxContext) : &mut UserRelation {
        let v0 = 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::app_object_mut<0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::version::UserManagerV1, UserManager>(arg0);
        let v1 = 0x2::tx_context::sender(arg1);
        if (!0x2::table::contains<address, UserRelation>(&v0.relations, v1)) {
            internal_create_relation(v0, arg1);
    ...
    public fun reject_friend_request(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::blacklist::assert_not_banned(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x2::tx_context::sender(arg2);
    ...
    public fun remove_friend(arg0: &mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::blacklist::assert_not_banned(arg0, 0x2::tx_context::sender(arg2));
        let v0 = 0x2::tx_context::sender(arg2);
        let v1 = get_or_create_relation_mut(arg0, arg2);
        0x2::table::remove<address, FriendInfo>(&mut v1.friends, arg1);
        0x2::table::remove<address, FriendInfo>(&mut 0x2::table::borrow_mut<address, UserRelation>(&mut 0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::app::app_object_mut<0x30ec21c0f650e2047376699d71879f65a9103b35316ac3f72c272686ee132499::version::UserManagerV1, UserManager>(arg0).relations, arg1).friends, v0);
        let v2 = FriendRequestEvent{
            from   : v0,
            to     : arg1,
