module 0x8ea59960d1d3816a29c736fb83fcca26a7f2f54c231b82138819b56c9c16e984::RIF {
    struct RIF has drop {
        dummy_field: bool,
    }

    fun init(arg0: RIF, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<RIF>(arg0, 2, b"Bat", b"Rifampicin", b"Rifampicin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/lBxlGfZzOKSYnijmRwXSnxAxFfwz5WHHDBrHnLRzjuM?ext=png")), arg1);
