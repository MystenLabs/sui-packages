module 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault {
    ...
    public fun hotfix_bid_vault<T0, T1>(arg0: &mut UserShareRegistry, arg1: &mut BidVault<T0, T1>, arg2: 0x1::option::Option<UserShareKey>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<UserShareKey> {
        if (0x2::balance::value<T1>(&arg1.premium_sub_vault.balance) != arg1.premium_sub_vault.share_supply) {
            ...
            while (arg3 > 0 && 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::length<UserShareKey, u64>(&mut arg1.performance_fee_sub_vault.user_shares) > 0) {
            ...
            0x1::option::none<UserShareKey>()
        } else if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::length<UserShareKey, u64>(&mut arg1.bidder_sub_vault.user_shares) != 0) {
            while (arg3 > 0 && 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::length<UserShareKey, u64>(&mut arg1.bidder_sub_vault.user_shares) > 0) {
                let (_, v5) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::linked_list::pop_front<UserShareKey, u64>(&mut arg0.id, &mut arg1.bidder_sub_vault.user_shares);
                arg1.bidder_sub_vault.share_supply = arg1.bidder_sub_vault.share_supply - v5;
                arg3 = arg3 - 1;
            };
            0x1::option::none<UserShareKey>()
        } else {
    ...
    public fun settle_adjust_active_user_share_ratio<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut DepositVault<T0, T1>, arg3: 0x1::option::Option<UserShareKey>, arg4: u64) : 0x1::option::Option<UserShareKey> {
        let v0 = &mut arg2.active_sub_vault;
        adjust_user_share_limited<T1>(arg1, v0, arg3, arg4)
    }
    ...
    public fun settle_remained_performance_fee_combination<T0, T1>(arg0: &T0, arg1: &mut UserShareRegistry, arg2: &mut BidVault<T0, T1>, arg3: u64) {
        if (0x2::balance::value<T1>(&arg2.performance_fee_sub_vault.balance) > 0) {
