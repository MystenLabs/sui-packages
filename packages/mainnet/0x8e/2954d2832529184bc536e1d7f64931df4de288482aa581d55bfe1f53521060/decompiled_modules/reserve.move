module 0x8e2954d2832529184bc536e1d7f64931df4de288482aa581d55bfe1f53521060::reserve {
    struct Reserve has key {
        ...
        reserve_cap: 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::ReserveCap,
        issuer_account: 0x1::option::Option<u64>,
        source_chain: vector<u8>,
        swaplock_chain_id: vector<u8>,
    }
    ...
    public fun approve_account_upgrade(arg0: &Reserve, arg1: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg2: &0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::AdminCap, arg3: vector<u8>, arg4: u32, arg5: u32) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::MessageApproval {
        assert_swaplock_chain(arg0, &arg3);
    ...
    public fun approve_asset_create(arg0: &Reserve, arg1: &0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::BridgeCore, arg2: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg3: &0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::AdminCap, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: u32, arg8: u32) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::MessageApproval {
        assert_swaplock_chain(arg0, &arg6);
        let (v0, _, v2, _, _, _, v6) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_info(arg1, arg4, arg5);
        assert!(v6 == 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_status_pending(), 14);
    ...
    public fun approve_mint(arg0: &Reserve, arg1: &mut 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::BridgeCore, arg2: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg3: vector<u8>, arg4: vector<u8>, arg5: u32, arg6: u32) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::MessageApproval {
        let (v0, v1) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::consume_withdrawal(arg1, &arg0.reserve_cap, arg3);
        let v2 = v1;
        assert_swaplock_chain(arg0, &arg4);
        let v3 = slice(&v2, 8, 28);
        assert!(0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::has_asset(arg1, arg0.source_chain, v3), 18);
        let (_, v5, _, _, _, v9, v10) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_info(arg1, arg0.source_chain, v3);
        assert!(v10 == 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_status_active(), 19);
        assert!(v0 <= v9, 21);
    ...
    public fun approve_redemption(arg0: &Reserve, arg1: &mut 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::BridgeCore, arg2: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg3: &EthAddressRegistry, arg4: vector<u8>, arg5: vector<u8>, arg6: u32, arg7: u32) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::MessageApproval {
        let (v0, v1) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::consume_withdrawal(arg1, &arg0.reserve_cap, arg4);
        let v2 = v1;
        let v3 = le_u64_at(&v2, 0);
        let v4 = le_u64_at(&v2, 8);
        assert!(0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::has_asset_by_id(arg1, v4), 18);
        let (v5, v6) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::route_by_asset_id(arg1, v4);
        let (_, v8, _, _, v11, _, v13) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_info(arg1, v5, v6);
        assert!(v13 == 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_status_active(), 19);
        assert!(v8 == v4, 20);
    ...
    public fun approve_redemption_v2(arg0: &Reserve, arg1: &mut 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::BridgeCore, arg2: &mut 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator::DWalletCoordinator, arg3: vector<u8>, arg4: vector<u8>, arg5: u32, arg6: u32) : 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::MessageApproval {
        let (v0, v1) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::consume_withdrawal(arg1, &arg0.reserve_cap, arg3);
        let v2 = v1;
        ...
        let (v5, v6) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::route_by_asset_id(arg1, v4);
        let v7 = v6;
        let (_, v9, _, _, v12, _, v14) = 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_info(arg1, v5, v7);
        assert!(v14 == 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::asset_status_active(), 19);
        assert!(v9 == v4, 20);
    ...
    fun assert_swaplock_chain(arg0: &Reserve, arg1: &vector<u8>) {
        assert!(chain_prefix_matches(arg1, &arg0.swaplock_chain_id), 27);
    }
    ...
    fun chain_prefix_matches(arg0: &vector<u8>, arg1: &vector<u8>) : bool {
    ...
    public fun create(arg0: 0xdd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317::coordinator_inner::DWalletCap, arg1: 0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::ReserveCap, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u8>(&arg3) == 32, 28);
        let v0 = Reserve{
    ...
    public fun set_issuer_account(arg0: &mut Reserve, arg1: &0xcdf7dc7063a62404c34cbfaf43d077dbab4f08c0db15a55a74095f5482eda5b5::core::AdminCap, arg2: u64) {
