module 0x8e7ef916f34185bde8d9a48f09ada08c3bf8152a53beb87cd4691a7dcac4c0f8::reward1660 {
    struct REWARD1660 has drop {
        dummy_field: bool,
    }

    struct TICKET_1660 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1660(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1660>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1660>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1660, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1660>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1660>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1660>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1660>>(v5, 0x2::tx_context::sender(arg1));
    }
