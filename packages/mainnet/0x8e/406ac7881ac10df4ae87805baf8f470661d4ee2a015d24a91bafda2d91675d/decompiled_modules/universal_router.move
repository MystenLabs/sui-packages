module 0x8e406ac7881ac10df4ae87805baf8f470661d4ee2a015d24a91bafda2d91675d::universal_router {
    ...
    fun deepbook_prune_input<T0>(arg0: &mut Treasury, arg1: &mut 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        refund_if_necessary<T0>(0x2::coin::split<T0>(arg1, 0x2::coin::value<T0>(arg1) % arg2, arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    public fun deepbook_swap_exact_base_for_quote<T0, T1>(arg0: &mut Treasury, arg1: &mut Route, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::option::extract<0x2::coin::Coin<T0>>(&mut v0.coin_in);
        let v2 = &mut v1;
        deepbook_prune_input<T0>(arg0, v2, arg3, arg5);
        ...
        let v6 = v3;
        if (0x2::coin::value<T0>(&v6) > arg3) {
            abort 6
        };
        refund_if_necessary<T0>(v6, 0x2::tx_context::sender(arg5));
        0x1::option::fill<0x2::coin::Coin<T1>>(&mut v0.coin_out, v4);
    }

    public fun deepbook_swap_exact_quote_for_base<T0, T1>(arg0: &mut Treasury, arg1: &mut Route, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = borrow_mut_current_path<T1, T0>(arg1);
        let v1 = 0x1::option::extract<0x2::coin::Coin<T1>>(&mut v0.coin_in);
        let v2 = &mut v1;
        deepbook_prune_input<T1>(arg0, v2, arg3, arg5);
        ...
        let v6 = v4;
        if (0x2::coin::value<T1>(&v6) > arg3) {
            abort 6
        };
        refund_if_necessary<T1>(v6, 0x2::tx_context::sender(arg5));
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0x8e406ac7881ac10df4ae87805baf8f470661d4ee2a015d24a91bafda2d91675d::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
