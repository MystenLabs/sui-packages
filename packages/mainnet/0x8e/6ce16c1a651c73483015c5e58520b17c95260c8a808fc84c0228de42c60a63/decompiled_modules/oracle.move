module 0x8e6ce16c1a651c73483015c5e58520b17c95260c8a808fc84c0228de42c60a63::oracle {
    ...
    public fun query_price_oracle(arg0: &PriceOracle, arg1: &vector<0x2::object::ID>) {
        let v0 = 0x2::dynamic_field::borrow<vector<u8>, 0x2::table::Table<0x2::object::ID, u128>>(&arg0.id, b"cetus");
        let v1 = 0;
