module 0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::oracle {
    ...
    public fun insert_to_price_feed_map<T0>(arg0: &mut PriceFeedsMap<T0>, arg1: &0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::auth::Auth<T0>, arg2: &0x1::string::String, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        assert!(0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::auth::has_cap<T0, 0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg4)), 4);
    ...
    public fun peg_to_base<T0>(arg0: &mut PriceFeedsMap<T0>, arg1: &0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::auth::Auth<T0>, arg2: &0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun remove_from_price_feed_map<T0>(arg0: &mut PriceFeedsMap<T0>, arg1: &0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::auth::Auth<T0>, arg2: &0x1::string::String, arg3: &0x2::tx_context::TxContext) {
        assert!(0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::auth::has_cap<T0, 0x8e217f39b8282d7fcb3a87b665ea06ce457cc01f89be834547bf90cf6ed0455d::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
        let (_, _) = 0x2::vec_map::remove<0x1::string::String, vector<u8>>(&mut arg0.map, arg2);
    }
