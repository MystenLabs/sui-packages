module 0x8e77aec5bdeb9ce7e634a76e86083f4d85ec9be0bfb046e4df4ca21fc152ea6b::cert {
    ...
    fun init(arg0: CERT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CERT>(arg0, 9, b"voloSUI", b"Volo Staked SUI", b"Volo's SUI staking solution provides the best user experience and highest level of decentralization, security, combined with an attractive reward mechanism and instant staking liquidity through a bond-like synthetic token called voloSUI.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://volo.fi/voloSUI.png")), arg1);
    ...
    entry fun migrate(arg0: &mut Metadata<CERT>, arg1: &0x8e77aec5bdeb9ce7e634a76e86083f4d85ec9be0bfb046e4df4ca21fc152ea6b::ownership::OwnerCap) {
        assert!(arg0.version < 1, 1);
