module 0x8e7a191986ab97c753a3fa276628a0fb133f7267d0e1c7d544c3f059402ac448::reward1173 {
    struct REWARD1173 has drop {
        dummy_field: bool,
    }

    struct TICKET_1173 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1173(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1173>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1173>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1173, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1173>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1173>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1173>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1173>>(v5, 0x2::tx_context::sender(arg1));
    }
