module 0x8e9f67f345ee11f2f575519ad47aa10970433540f87225c96712d777d802934a::orderbook_analyzer {
    ...
    public fun find_queue_snipe_price(arg0: &OrderbookSnapshot, arg1: u64, arg2: bool, arg3: u64, arg4: u64) : (u64, bool) {
        let v0 = if (arg2) {
            ...
            let v6 = arg0.first_nonzero_ask;
            let v7 = 0;
            while (v7 < 0x1::vector::length<u64>(&arg0.ask_prices)) {
                let v8 = *0x1::vector::borrow<u64>(&arg0.ask_prices, v7);
                if (v8 >= arg1 && *0x1::vector::borrow<u64>(&arg0.ask_quantities, v7) >= arg4) {
                    if (v8 > 2 * arg3) {
                        let v9 = v8 - 2 * arg3;
                        let v10 = if (v8 != v6) {
                            if (v6 > 0) {
