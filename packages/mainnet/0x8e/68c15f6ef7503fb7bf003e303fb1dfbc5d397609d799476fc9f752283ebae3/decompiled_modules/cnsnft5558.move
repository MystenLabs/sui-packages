module 0x8e68c15f6ef7503fb7bf003e303fb1dfbc5d397609d799476fc9f752283ebae3::cnsnft5558 {
    struct CNSNFT5558 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5558, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5558>(arg0, arg1);
