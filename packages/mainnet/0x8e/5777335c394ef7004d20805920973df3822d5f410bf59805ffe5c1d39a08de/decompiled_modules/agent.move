module 0x8e5777335c394ef7004d20805920973df3822d5f410bf59805ffe5c1d39a08de::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 9, b"ELCH", b"Eliza Chatbot", b"For pure testing purposes only", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://dapp.suiagents.ai/assets/images/nft-images/agent.jpg")), arg1);
