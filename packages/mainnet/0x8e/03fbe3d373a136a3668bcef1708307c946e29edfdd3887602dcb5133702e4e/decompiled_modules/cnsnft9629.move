module 0x8e03fbe3d373a136a3668bcef1708307c946e29edfdd3887602dcb5133702e4e::cnsnft9629 {
    struct CNSNFT9629 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9629, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8731"));
        let v4 = 0x2::package::claim<CNSNFT9629>(arg0, arg1);
