module 0x8e48fd9317b1726dfbd494eb398bacbc1a3c96fdd45add2090185da5c6134002::cult {
    ...
    fun init(arg0: CULT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<CULT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CULT    ")))), trim_right(b"Milady Cult Coin                "), trim_right(b"Milady Cult Coin                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
