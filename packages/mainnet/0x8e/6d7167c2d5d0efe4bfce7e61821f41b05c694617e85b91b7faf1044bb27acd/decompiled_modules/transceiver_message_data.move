module 0x8e6d7167c2d5d0efe4bfce7e61821f41b05c694617e85b91b7faf1044bb27acd::transceiver_message_data {
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : TransceiverMessageData<vector<u8>> {
        ...
        TransceiverMessageData<vector<u8>>{
            ...
            ntt_manager_payload           : 0x8e6d7167c2d5d0efe4bfce7e61821f41b05c694617e85b91b7faf1044bb27acd::ntt_manager_message::take_bytes(arg0),
        }
    }
    ...
    public fun to_bytes(arg0: TransceiverMessageData<vector<u8>>) : vector<u8> {
        ...
        let v4 = 0x8e6d7167c2d5d0efe4bfce7e61821f41b05c694617e85b91b7faf1044bb27acd::ntt_manager_message::to_bytes(v2);
