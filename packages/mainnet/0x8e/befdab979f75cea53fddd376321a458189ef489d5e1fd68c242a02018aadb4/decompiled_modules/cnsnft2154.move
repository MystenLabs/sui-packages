module 0x8ebefdab979f75cea53fddd376321a458189ef489d5e1fd68c242a02018aadb4::cnsnft2154 {
    struct CNSNFT2154 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2154, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2154>(arg0, arg1);
