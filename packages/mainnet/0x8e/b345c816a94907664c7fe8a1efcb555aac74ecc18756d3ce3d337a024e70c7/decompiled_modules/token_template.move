module 0x8eb345c816a94907664c7fe8a1efcb555aac74ecc18756d3ce3d337a024e70c7::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"VT584522", b"ValidToken 584522", b"This should succeed", 0x1::option::none<0x2::url::Url>(), arg1);
