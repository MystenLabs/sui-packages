module 0x8eeca2e386af22071e751d5972c12708da71fab7271a50660a31784e26215bd8::reward6364 {
    struct REWARD6364 has drop {
        dummy_field: bool,
    }

    struct TICKET_6364 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6364(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6364>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6364>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6364, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6364>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6364>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6364>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6364>>(v5, 0x2::tx_context::sender(arg1));
    }
