module 0x8ee402eb4a5fb2701cc4e2e05eae70b843cb76e6ee61ac3ad66c829ad42d31d9::reward3691 {
    struct REWARD3691 has drop {
        dummy_field: bool,
    }

    struct TICKET_3691 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3691(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3691>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3691>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3691, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3691>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3691>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3691>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3691>>(v5, 0x2::tx_context::sender(arg1));
    }
