module 0xb88f9149c55d6314b7ae436a730cfbf3a5d53522f37e2d56288531bb8adc7071::market_event {
    ...
    struct HigestBidEvent has copy, drop {
        bid_id: vector<0x2::object::ID>,
        price: vector<u64>,
        bidder: vector<address>,
        unit_price: vector<u64>,
        amt: vector<u64>,
    }
    ...
    struct BidInfoEvent has copy, drop {
        id: 0x2::object::ID,
    }

    public(friend) fun bid_info_event(arg0: 0x2::object::ID) {
        let v0 = BidInfoEvent{id: arg0};
        0x2::event::emit<BidInfoEvent>(v0);
    }
    ...
    public(friend) fun higest_bid_event(arg0: vector<0x2::object::ID>, arg1: vector<u64>, arg2: vector<address>, arg3: vector<u64>, arg4: vector<u64>) {
        let v0 = HigestBidEvent{
            bid_id     : arg0,
            price      : arg1,
            bidder     : arg2,
            unit_price : arg3,
        ...
        0x2::event::emit<HigestBidEvent>(v0);
    }
