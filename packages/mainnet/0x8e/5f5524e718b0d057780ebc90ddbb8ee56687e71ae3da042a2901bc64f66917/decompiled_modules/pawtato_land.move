module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    public entry fun stake_tool(arg0: &mut StakingPool, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::transfer_policy::TransferPolicy<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>, arg5: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::get_quality_string(v2);
        let v7 = if (0x1::option::is_none<0x1::string::String>(&v4)) {
            true
        } else if (0x1::option::is_none<0x1::string::String>(&v5)) {
            true
        } else {
            0x1::option::is_none<0x1::string::String>(&v6)
        };
        if (v7) {
            let v8 = 0x2::kiosk::borrow_mut<0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::TOOL>(arg1, arg2, arg3);
            if (0x1::option::is_none<0x1::string::String>(&v4)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_durability_if_missing(v8);
            };
            if (0x1::option::is_none<0x1::string::String>(&v5)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_category_if_missing(v8);
            };
            if (0x1::option::is_none<0x1::string::String>(&v6)) {
                0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools::add_quality_if_missing(v8);
            };
        };
        ...
        let v9 = get_or_create_user(arg0, v0, arg7);
        ...
        if (v10 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_production()) {
            assert!(count_items_by_category(&v9.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_production()) < 3, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_production_slots_full());
        } else if (v10 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous()) {
            assert!(count_items_by_category(&v9.items, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_miscellaneous()) < 3, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_miscellaneous_slots_full());
        } else {
            let v11 = if (v10 == 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::item_category_woodworking()) {
                true
            ...
            if (v11) {
                assert!(count_items_by_category(&v9.items, v10) < 1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_crafting_category_slot_full());
            };
        };
        let v12 = 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::items::get_item_stake_limit(v3);
        if (v12 > 0) {
            assert!(count_items_by_type(&v9.items, v3) < v12, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_staked_item_limit_reached());
        };
        let v13 = ItemInfo{
            nft_id      : arg3,
            item_type   : v3,
        ...
        0x1::vector::push_back<ItemInfo>(&mut v9.items, v13);
        let v14 = ItemStaked{
            user      : v1,
            nft_id    : arg3,
            item_type : v3,
