module 0x8ec5d179f7f30e0757fe28f884f2de2301c9dab14742b62f5921ec85e4e96c2e::allocation {
    ...
    public fun create_and_transfer_allocation_nft(arg0: &mut 0x8ec5d179f7f30e0757fe28f884f2de2301c9dab14742b62f5921ec85e4e96c2e::up::UpAdmin, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x8ec5d179f7f30e0757fe28f884f2de2301c9dab14742b62f5921ec85e4e96c2e::up::is_manager(arg0, 0x2::tx_context::sender(arg3)), 0);
        let v0 = 0x1::string::utf8(b"data:image/svg+xml,");
        0x1::string::append(&mut v0, 0x8ec5d179f7f30e0757fe28f884f2de2301c9dab14742b62f5921ec85e4e96c2e::urlencode::encode(0x1::string::into_bytes(0x1::string::utf8(b"<svg width=200 height=100 xmlns=http://www.w3.org/2000/svg> <rect width=100% height=100% fill=blue /><text x=50% y=50% font-size=24 fill=white text-anchor=middle dominant-baseline=middle>1000 UP</text></svg>"))));
        let v1 = UPAirdropNFT{
