module 0x8ea7d7dcfcaf5dff6c24a73caf6c1171a16d7677a6b12cf3c93011eeb84bb44f::reserve {
    ...
    public(friend) fun repay_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>, arg2: FlashLoan<T0>) {
        ...
        assert!(0x2::balance::value<T0>(&arg1) >= v0, 0x8ea7d7dcfcaf5dff6c24a73caf6c1171a16d7677a6b12cf3c93011eeb84bb44f::error::flash_loan_repay_not_enough_error());
        0x350fe3231df82efee1a1d15af4e132a92ba2b445cbdd92208ba5270132f68a79::balance_bag::join<T0>(&mut arg0.underlying_balances, arg1);
    }
