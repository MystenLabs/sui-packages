module 0x8e728b009ddf7f8c0eb4872df55b64d7e0c5f0752fd39d62f36eb405cb0d3e87::reward9328 {
    struct REWARD9328 has drop {
        dummy_field: bool,
    }

    struct TICKET_9328 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9328(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9328>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9328>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9328, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9328>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9328>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9328>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9328>>(v5, 0x2::tx_context::sender(arg1));
    }
