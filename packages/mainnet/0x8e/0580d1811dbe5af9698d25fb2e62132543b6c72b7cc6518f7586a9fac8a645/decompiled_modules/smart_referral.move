module 0x8e0580d1811dbe5af9698d25fb2e62132543b6c72b7cc6518f7586a9fac8a645::smart_referral {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut v1;
        new_percentage_edge(&v0, v2, 0x1::string::utf8(b"blackjack"), 100000, 5000);
        let v3 = &mut v1;
        new_percentage_edge(&v0, v3, 0x1::string::utf8(b"limbo"), 100000, 100000);
        let v4 = &mut v1;
        new_percentage_edge(&v0, v4, 0x1::string::utf8(b"live"), 100000, 100000);
        let v5 = &mut v1;
        new_percentage_edge(&v0, v5, 0x1::string::utf8(b"slots"), 100000, 200000);
        let v6 = &mut v1;
        new_percentage_edge(&v0, v6, 0x1::string::utf8(b"coinflip"), 100000, 100000);
        let v7 = &mut v1;
        new_percentage_edge(&v0, v7, 0x1::string::utf8(b"rps"), 100000, 100000);
        let v8 = &mut v1;
        new_percentage_edge(&v0, v8, 0x1::string::utf8(b"range"), 100000, 100000);
        let v9 = &mut v1;
        new_percentage_edge(&v0, v9, 0x1::string::utf8(b"plinko"), 100000, 300000);
        let v10 = &mut v1;
        new_percentage_edge(&v0, v10, 0x1::string::utf8(b"raffle"), 100000, 1);
        let v11 = &mut v1;
        new_percentage_edge(&v0, v11, 0x1::string::utf8(b"lottery"), 100000, 250000);
        let v12 = &mut v1;
        new_percentage_edge(&v0, v12, 0x1::string::utf8(b"roulette"), 100000, 52000);
