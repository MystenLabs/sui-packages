module 0x8e26f39cb465f258da67c458e1606eb64af0a9ed7790c32478a62c3d90d374f3::fluxpay_usdc {
    ...
    struct FluxPayPool<phantom T0> has key {
        id: 0x2::object::UID,
        total_volume: u64,
        total_fees: u64,
    ...
    public entry fun complete_transaction<T0>(arg0: &mut FluxPayPool<T0>, arg1: Escrow<T0>, arg2: &AdminCap, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Escrow<T0>>(&arg1);
        ...
        let v2 = 0x2::balance::value<T0>(&arg1.amount);
        let v3 = v2 * 500 / 10000;
        ...
        let v19 = v10;
        0x2::balance::join<T0>(&mut arg0.fee_balance, 0x2::balance::split<T0>(&mut v19, v3));
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v19, arg4), arg0.admin_wallet);
    ...
    public entry fun create_escrow<T0>(arg0: &mut FluxPayPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<Escrow<T0>>(v9, v1);
    }

    public fun escrow_exists<T0>(arg0: &FluxPayPool<T0>, arg1: 0x2::object::ID) : bool {
        0x2::table::contains<0x2::object::ID, EscrowInfo>(&arg0.escrows, arg1)
    }

    public fun get_admin_wallet<T0>(arg0: &FluxPayPool<T0>) : address {
        arg0.admin_wallet
    }

    public fun get_network_analytics<T0>(arg0: &FluxPayPool<T0>) : (u64, u64, u64, u64, u64, u64, u64, u64) {
    ...
    public fun get_pool_stats<T0>(arg0: &FluxPayPool<T0>) : (u64, u64, u64, u64) {
        (arg0.total_volume, arg0.total_fees, arg0.total_transactions, arg0.failed_transactions)
    }

    public fun get_service_analytics<T0>(arg0: &FluxPayPool<T0>) : (u64, u64, u64, u64, u64, u64, u64, u64) {
    ...
    public fun get_user_history<T0>(arg0: &FluxPayPool<T0>, arg1: address) : vector<TransactionRecord> {
    ...
    public fun init_pool<T0>(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = FluxPayPool<T0>{
            ...
            escrows             : 0x2::table::new<0x2::object::ID, EscrowInfo>(arg1),
            user_history        : 0x2::table::new<address, vector<TransactionRecord>>(arg1),
            service_analytics   : v0,
            network_analytics   : v1,
        };
        let v3 = AdminCap{
            id      : 0x2::object::new(arg1),
            pool_id : 0x2::object::id<FluxPayPool<T0>>(&v2),
        };
        0x2::transfer::share_object<FluxPayPool<T0>>(v2);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
    }

    public entry fun refund_transaction<T0>(arg0: &mut FluxPayPool<T0>, arg1: Escrow<T0>, arg2: vector<u8>, arg3: &AdminCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<Escrow<T0>>(&arg1);
        assert!(0x2::table::contains<0x2::object::ID, EscrowInfo>(&arg0.escrows, v0), 3);
        assert!(arg1.status == 0, 5);
    ...
    public entry fun update_admin_wallet<T0>(arg0: &mut FluxPayPool<T0>, arg1: address, arg2: &AdminCap) {
        arg0.admin_wallet = arg1;
    }
    ...
    fun update_network_analytics(arg0: &mut NetworkAnalytics, arg1: &0x1::string::String, arg2: u64) {
        ...
        } else if (*arg1 == 0x1::string::utf8(b"GLO") || *arg1 == 0x1::string::utf8(b"Glo")) {
    ...
    public entry fun withdraw_fees<T0>(arg0: &mut FluxPayPool<T0>, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.fee_balance), arg2), arg0.admin_wallet);
    }
