module 0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sitizens {
    ...
    struct Sale has key {
        ...
        sity_price: u64,
        sui_price: u64,
        sity_balance: 0x2::balance::Balance<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>,
    ...
    fun init(arg0: SITIZENS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = Sale{
            ...
            sity_price                : 0,
            sui_price                 : 0,
            sity_balance              : 0x2::balance::zero<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>(),
    ...
    public fun mint_with_sity(arg0: &mut Sale, arg1: &Collection, arg2: &0x2::transfer_policy::TransferPolicy<Sitizen>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::coin::Coin<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 9);
        ...
        assert!(0x2::coin::value<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>(&arg5) >= arg0.sity_price * arg6, 6);
        0x2::balance::join<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>(&mut arg0.sity_balance, 0x2::coin::into_balance<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>(arg5));
        let v3 = 0;
        while (v3 < arg6) {
            arg0.total_mints = arg0.total_mints + 1;
    ...
    public fun withdraw_sity(arg0: &mut Sale, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>(&arg0.sity_balance);
        if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>>(0x2::coin::from_balance<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>(0x2::balance::split<0x8eca81415d9338343aeb8b07d52211246c182c42a92755288a1fcfd2297081a5::sity::SITY>(&mut arg0.sity_balance, v0), arg2), 0x2::tx_context::sender(arg2));
        };
    }
