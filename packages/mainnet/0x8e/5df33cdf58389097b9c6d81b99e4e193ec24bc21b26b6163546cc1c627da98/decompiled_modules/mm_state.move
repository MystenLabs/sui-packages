module 0x8e5df33cdf58389097b9c6d81b99e4e193ec24bc21b26b6163546cc1c627da98::mm_state {
    ...
    public fun create(arg0: &0x8e5df33cdf58389097b9c6d81b99e4e193ec24bc21b26b6163546cc1c627da98::mm_registry::MMRegistry, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : MMState {
        let v0 = MMState{
            id                 : 0x2::object::new(arg2),
            owner              : 0x2::tx_context::sender(arg2),
            registry_id        : 0x8e5df33cdf58389097b9c6d81b99e4e193ec24bc21b26b6163546cc1c627da98::mm_registry::registry_id(arg0),
            current_price      : 0,
            current_spread     : 0,
            price_sequence     : 0,
            execution_count    : 0,
        ...
        0x8e5df33cdf58389097b9c6d81b99e4e193ec24bc21b26b6163546cc1c627da98::events::emit_state_created(0x2::object::id<MMState>(&v0), 0x2::tx_context::sender(arg2), 0x2::clock::timestamp_ms(arg1));
        v0
    }
    ...
    public(friend) fun pause(arg0: &mut MMState, arg1: u64, arg2: u64) {
        ...
        0x8e5df33cdf58389097b9c6d81b99e4e193ec24bc21b26b6163546cc1c627da98::events::emit_trading_paused(0x2::object::id<MMState>(arg0), arg1, arg2);
    }
