module 0x8ec206e9c0a3247cd0c5d900ee87a268539e43a02e128e7f430efc3ac3ffc625::img {
    struct IMG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: IMG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v2;
        0x2::coin::mint_and_transfer<IMG>(&mut v4, 1000000000000, 0x2::tx_context::sender(arg1), arg1);
