module 0x8eeb081ddf811a471055ad0415996208f09f3d5a5b13efc69de3b74fda8f236d::cnsnft5050 {
    struct CNSNFT5050 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5050, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5050>(arg0, arg1);
