module 0x8e7f3cfad811252a3245a715b1f69f4689a2c2acf0b0c3d79518581bacb9005f::tvyn {
    ...
    public entry fun create_and_share_mint_vault(arg0: 0x2::coin::TreasuryCap<TVYN>, arg1: &mut 0x8e7f3cfad811252a3245a715b1f69f4689a2c2acf0b0c3d79518581bacb9005f::config_registry::Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MintVault{
            id  : 0x2::object::new(arg2),
            cap : arg0,
        };
        0x8e7f3cfad811252a3245a715b1f69f4689a2c2acf0b0c3d79518581bacb9005f::config_registry::set_mint_vault_id(arg1, 0x2::object::id<MintVault>(&v0));
    ...
    fun init(arg0: TVYN, arg1: &mut 0x2::tx_context::TxContext) {
        create_currency_and_supply_internal(arg0, b"AAAAAAAA", b"AAAA", b"AAAAA TOKEN. Visit https://AAAAAA.com", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://amethyst-high-woodpecker-414.mypinata.cloud/ipfs/bafkreigzhutlov22epryhddcdqlxitarif7nsodzrcxuxqz7fn67z4wb24")), 9, arg1);
    }
