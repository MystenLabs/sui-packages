module 0x8e7d5143380a0f904c77c57d0e6484ae308313faedf17d7aecb09de9292f77e5::umi_container {
    ...
    fun init(arg0: UMI_CONTAINER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"A cross-chain NFT container powered by Umi"));
