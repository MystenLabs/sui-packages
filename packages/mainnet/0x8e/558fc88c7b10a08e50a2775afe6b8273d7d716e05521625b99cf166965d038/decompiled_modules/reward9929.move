module 0x8e558fc88c7b10a08e50a2775afe6b8273d7d716e05521625b99cf166965d038::reward9929 {
    struct REWARD9929 has drop {
        dummy_field: bool,
    }

    struct TICKET_9929 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9929(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9929>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9929>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9929, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9929>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9929>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9929>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9929>>(v5, 0x2::tx_context::sender(arg1));
    }
