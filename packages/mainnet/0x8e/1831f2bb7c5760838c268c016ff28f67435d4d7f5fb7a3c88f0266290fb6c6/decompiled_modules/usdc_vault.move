module 0x8e1831f2bb7c5760838c268c016ff28f67435d4d7f5fb7a3c88f0266290fb6c6::usdc_vault {
    ...
    struct SharePriceUpdate has copy, drop {
        vault_id: 0x2::object::ID,
        timestamp: u64,
        share_price: u64,
        total_assets: u64,
    ...
    public fun add_strategy_profit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        emit_share_price_update<T0, T1>(arg0, arg3, b"profit");
    }
    ...
    public fun collect_management_fees<T0, T1>(arg0: &AdminCap, arg1: &mut Vault<T0, T1>, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        emit_share_price_update<T0, T1>(arg1, arg3, b"management_fee");
    }
    ...
    public fun defund_strategy<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        emit_share_price_update<T0, T1>(arg0, arg4, b"defund");
    }

    public fun deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        0x2::coin::into_balance<T1>(0x2::coin::mint<T1>(&mut arg0.share_token_supply, v1, arg4))
    }
    ...
    public fun emergency_defund_strategy<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        emit_share_price_update<T0, T1>(arg0, arg3, b"emergency_defund");
    }

    fun emit_share_price_update<T0, T1>(arg0: &Vault<T0, T1>, arg1: &0x2::clock::Clock, arg2: vector<u8>) {
        let v0 = SharePriceUpdate{
            vault_id     : 0x2::object::id<Vault<T0, T1>>(arg0),
            timestamp    : 0x2::clock::timestamp_ms(arg1),
            share_price  : calculate_current_share_price<T0, T1>(arg0),
            total_assets : arg0.total_assets,
            total_supply : 0x2::coin::total_supply<T1>(&arg0.share_token_supply),
            idle_funds   : 0x2::balance::value<T0>(&arg0.idle_funds),
            trigger_type : arg2,
        };
        0x2::event::emit<SharePriceUpdate>(v0);
    }
