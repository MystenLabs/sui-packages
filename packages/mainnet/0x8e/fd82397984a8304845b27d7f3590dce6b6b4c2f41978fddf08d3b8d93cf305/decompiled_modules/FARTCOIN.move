module 0x8efd82397984a8304845b27d7f3590dce6b6b4c2f41978fddf08d3b8d93cf305::FARTCOIN {
    struct FARTCOIN has drop {
        dummy_field: bool,
    }

    fun init(arg0: FARTCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<FARTCOIN>(arg0, 2, b"FARTCOIN", b"Fartcoin", b"Fartcoin", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/Mc23boR3dawttlwZ_1Qkygig8mR6xT3NEMLzehpgsOs?ext=png")), arg1);
