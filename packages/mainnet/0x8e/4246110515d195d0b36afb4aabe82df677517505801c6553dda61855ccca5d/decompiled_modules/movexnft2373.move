module 0x8e4246110515d195d0b36afb4aabe82df677517505801c6553dda61855ccca5d::movexnft2373 {
    struct MOVEXNFT2373 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2373, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2373>(arg0, arg1);
