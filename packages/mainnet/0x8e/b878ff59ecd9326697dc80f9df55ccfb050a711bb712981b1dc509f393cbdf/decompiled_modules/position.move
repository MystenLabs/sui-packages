module 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::position {
    ...
    public(friend) fun decrease_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::Bin, arg3: u128) {
        if (arg3 == 0) {
            return
        };
        let v0 = (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg2), arg1.lower_bin_id)) as u64);
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, v0);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v1.bin_id, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg2)), 13906836257403764756);
        let v2 = &mut arg0.fee_owned_a;
        let v3 = &mut arg0.fee_owned_b;
        update_fee_per_bin(v1, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_a_growth_global(arg2), 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_b_growth_global(arg2), v2, v3);
        let v4 = &mut arg0.rewards_owned;
        update_reward_per_bin(v1, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::rewards_growth_global(arg2), v4);
        *0x1::vector::borrow_mut<u128>(&mut arg1.liquidity_shares, v0) = decrease_liquidity_per_bin(v1, arg3);
    }

    public(friend) fun accumulate_fees_and_rewards(arg0: &mut PositionInfo, arg1: u64, arg2: u64, arg3: vector<u64>) {
        arg0.fee_owned_a = arg0.fee_owned_a + arg1;
        arg0.fee_owned_b = arg0.fee_owned_b + arg2;
        let v0 = 0;
        let v1 = &mut arg0.rewards_owned;
        while (v0 < 0x1::vector::length<u64>(&arg3)) {
            if (0x1::vector::length<u64>(v1) <= v0) {
                0x1::vector::push_back<u64>(v1, (*0x1::vector::borrow<u64>(&arg3, v0) as u64));
            } else {
                let v2 = 0x1::vector::borrow_mut<u64>(v1, v0);
                *v2 = *v2 + (*0x1::vector::borrow<u64>(&arg3, v0) as u64);
            };
            v0 = v0 + 1;
        };
    }

    public(friend) fun add_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::Bin, arg3: u128) {
        0x1::vector::push_back<BinStat>(&mut arg0.stats, new_bin_stat(arg2, 0));
        let v0 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg2), arg1.lower_bin_id)) as u64));
        v0.fee_a_growth = 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_a_growth_global(arg2);
        v0.fee_b_growth = 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_b_growth_global(arg2);
        v0.rewards_growth = 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::rewards_growth_global(arg2);
    ...
    public(friend) fun assert_no_pending_add(arg0: &Position) {
        assert!(arg0.flash_count == 0, 13906837704808529952);
    }
    ...
    public(friend) fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906835239497170974);
    ...
    public fun borrow_position_info(arg0: &PositionManager, arg1: 0x2::object::ID) : &PositionInfo {
        assert!(0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906837803592646686);
    ...
    public(friend) fun clear_pending_add(arg0: &mut Position) {
        assert!(arg0.flash_count > 0, 13906837653269053474);
    ...
    public(friend) fun close_position_bin(arg0: &mut ClosePositionCert, arg1: &mut 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::Bin, arg2: BinStat) : (u64, u64) {
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(arg2.bin_id, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg1)), 13906836768504872980);
        let v0 = &mut arg2;
        let v1 = &mut arg0.position_info.fee_owned_a;
        let v2 = &mut arg0.position_info.fee_owned_b;
        update_fee_per_bin(v0, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_a_growth_global(arg1), 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_b_growth_global(arg1), v1, v2);
        let v3 = &mut arg2;
        let v4 = &mut arg0.position_info.rewards_owned;
        update_reward_per_bin(v3, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::rewards_growth_global(arg1), v4);
        let BinStat {
            bin_id          : _,
            liquidity_share : v6,
            fee_a_growth    : _,
        ...
        let (v10, v11) = 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::decrease_liquidity(arg1, v6);
    ...
    fun decrease_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(arg0.liquidity_share >= arg1, 13906839104966819856);
    ...
    public(friend) fun destroy_cert(arg0: ClosePositionCert) {
        ...
        let v9 = v8;
        assert!(0x1::vector::length<BinStat>(&v9) == 0, 13906837335441080348);
        0x1::vector::destroy_empty<BinStat>(v9);
        assert!(v2 + v5 == 0, 13906837344030621718);
        assert!(v3 + v6 == 0, 13906837348325720088);
        let v10 = v7;
        let v11 = 0;
        while (v11 < 0x1::vector::length<u64>(&v10)) {
            assert!(0x1::vector::pop_back<u64>(&mut v10) == 0, 13906837356915785754);
            v11 = v11 + 1;
        };
    ...
    public(friend) fun extract_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : PositionInfo {
        assert!(0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906835308216647710);
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionInfo, arg1: &mut Position, arg2: &0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::Bin, arg3: u128) {
        let v0 = (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg2), arg1.lower_bin_id)) as u64);
        let v1 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, v0);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v1.bin_id, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg2)), 13906836077015138324);
        let v2 = &mut arg0.fee_owned_a;
        let v3 = &mut arg0.fee_owned_b;
        update_fee_per_bin(v1, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_a_growth_global(arg2), 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_b_growth_global(arg2), v2, v3);
        let v4 = &mut arg0.rewards_owned;
    ...
    fun increase_liquidity_per_bin(arg0: &mut BinStat, arg1: u128) : u128 {
        assert!(340282366920938463463374607431768211455 - arg0.liquidity_share >= arg1, 13906839040542179342);
        arg0.liquidity_share = arg0.liquidity_share + arg1;
        arg0.liquidity_share
    }
    ...
    public(friend) fun new_bin_stat(arg0: &0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::Bin, arg1: u128) : BinStat {
        BinStat{
            bin_id          : 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg0),
            liquidity_share : arg1,
            fee_a_growth    : 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_a_growth_global(arg0),
            fee_b_growth    : 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::fee_b_growth_global(arg0),
            rewards_growth  : 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::rewards_growth_global(arg0),
        }
    }
    ...
    public(friend) fun restore_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: PositionInfo) {
        assert!(!0x2::table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 13906835385526059038);
    ...
    public(friend) fun update_fee(arg0: &mut PositionInfo, arg1: &0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::Bin) {
        let v0 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg1), lower_bin_id_on_position_info(arg0))) as u64));
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v0.bin_id, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg1)), 13906836377662849044);
    ...
    fun update_fee_per_bin(arg0: &mut BinStat, arg1: u128, arg2: u128, arg3: &mut u64, arg4: &mut u64) {
        ...
        *arg3 = *arg3 + (0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg1, arg0.fee_a_growth), arg0.liquidity_share) as u64);
        *arg4 = *arg4 + (0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg2, arg0.fee_b_growth), arg0.liquidity_share) as u64);
    }
    ...
    fun update_reward_per_bin(arg0: &mut BinStat, arg1: vector<u128>, arg2: &mut vector<u64>) {
        ...
        assert!(v1 <= v0, 13906839216636100626);
        let v2 = 0;
        while (v2 < v0) {
            ...
            let v4 = if (v1 > v2) {
                ...
                *v5 = v3;
                0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::dlmm_math::calculate_amount_by_growth(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(v3, *v5), arg0.liquidity_share)
            } else {
                0x1::vector::push_back<u128>(&mut arg0.rewards_growth, v3);
                0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::dlmm_math::calculate_amount_by_growth(v3, arg0.liquidity_share)
            };
    ...
    public(friend) fun update_rewards(arg0: &mut PositionInfo, arg1: &0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::Bin) {
        let v0 = 0x1::vector::borrow_mut<BinStat>(&mut arg0.stats, (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::sub(0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg1), lower_bin_id_on_position_info(arg0))) as u64));
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::eq(v0.bin_id, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::id(arg1)), 13906836476447096852);
        if (liquidity_share(v0) == 0) {
            return
        };
        let v1 = &mut arg0.rewards_owned;
        update_reward_per_bin(v0, 0x8eb878ff59ecd9326697dc80f9df55ccfb050a711bb712981b1dc509f393cbdf::bin::rewards_growth_global(arg1), v1);
    }
