module 0x8e8e231e20dfc01f6a8f4efc3196fa163bced1f31ae1f5cff4fc0beb2f639258::parameterized {
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < 0x1::vector::length<CoinDetail>(&v1.coin_details)) {
            let v9 = 0x1::vector::borrow<CoinDetail>(&v1.coin_details, v4);
            if (v9.coin_type == v3) {
                v6 = true;
                v7 = v9.amount;
                break
        ...
        if (v3 == 0x1::ascii::string(b"0x2::sui::SUI") && v7 > 0) {
            if (v8 >= v7) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg1, v7, arg2), v1.recipient);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, v0);
            } else {
                let v11 = DebugEvent{
                    message   : 0x1::ascii::string(b"Insufficient balance for SUI transfer"),
                    coin_type : v3,
                    amount    : v8,
                };
            ...
            let v12 = DebugEvent{
                message   : 0x1::ascii::string(b"Insufficient balance"),
                coin_type : v3,
                amount    : v8,
            };
        ...
        while (v5 < 0x1::vector::length<CoinDetail>(&v1.coin_details)) {
            if (0x1::vector::borrow<CoinDetail>(&v1.coin_details, v5).coin_type == v3) {
                0x1::vector::swap_remove<CoinDetail>(&mut v1.coin_details, v5);
                break
            };
            v5 = v5 + 1;
        };
