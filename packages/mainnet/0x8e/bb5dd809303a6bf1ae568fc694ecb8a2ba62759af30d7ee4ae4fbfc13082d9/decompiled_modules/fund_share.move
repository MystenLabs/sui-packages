module 0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::fund_share {
    ...
    struct Invested has copy, drop {
        ...
        investor: address,
        sponsor: address,
        sponsor_pool: 0x1::option::Option<0x2::object::ID>,
    }
    ...
    public(friend) fun burn<T0>(arg0: &0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::config::GlobalConfig, arg1: BurnRequest<T0>, arg2: FundShare) {
    ...
    public(friend) fun create_burn_request<T0>(arg0: &0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::config::GlobalConfig, arg1: 0x2::object::ID) : BurnRequest<T0> {
        0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::config::assert_if_version_not_matched(arg0, 1);
        BurnRequest<T0>{fund_id: arg1}
    }

    public(friend) fun create_mint_request<T0>(arg0: &0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::config::GlobalConfig, arg1: 0x2::object::ID, arg2: bool, arg3: address, arg4: 0x1::string::String, arg5: u64, arg6: address, arg7: address) : MintRequest<T0> {
        0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::config::assert_if_version_not_matched(arg0, 1);
        MintRequest<T0>{
            fund_id         : arg1,
            is_init         : arg2,
    ...
    public fun mint<T0>(arg0: &mut 0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::config::GlobalConfig, arg1: MintRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : FundShare {
        0x8ebb5dd809303a6bf1ae568fc694ecb8a2ba62759af30d7ee4ae4fbfc13082d9::config::assert_if_version_not_matched(arg0, 1);
        let MintRequest {
            fund_id         : v0,
            is_init         : v1,
        ...
        if (v5 == v6) {
            let v8 = Invested{
                ...
                sponsor       : v5,
                sponsor_pool  : 0x1::option::none<0x2::object::ID>(),
            };
            ...
            let v9 = Invested{
                ...
                investor      : 0x2::tx_context::sender(arg2),
                sponsor       : v5,
                sponsor_pool  : 0x1::option::some<0x2::object::ID>(0x2::object::id_from_address(v5)),
            };
