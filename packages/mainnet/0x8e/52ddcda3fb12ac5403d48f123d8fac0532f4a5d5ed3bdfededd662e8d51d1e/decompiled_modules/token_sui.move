module 0x8e52ddcda3fb12ac5403d48f123d8fac0532f4a5d5ed3bdfededd662e8d51d1e::token_sui {
    struct TOKEN_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_SUI>(arg0, 9, b"NOPE", x"e28885", b"The Official Unofficial Sui Mascot. The First Meme Fair Launch Platform on SUI Network. We are bullish on the future of the Sui. To the moon!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cdn.dribbble.com/userupload/17264090/file/original-55e79a61bddacc9d71aa85ee20e84047.png?resize=752x564")), arg1);
        let v2 = v0;
