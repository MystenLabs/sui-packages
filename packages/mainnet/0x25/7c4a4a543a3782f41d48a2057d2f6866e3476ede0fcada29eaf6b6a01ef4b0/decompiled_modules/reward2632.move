module 0x257c4a4a543a3782f41d48a2057d2f6866e3476ede0fcada29eaf6b6a01ef4b0::reward2632 {
    struct REWARD2632 has drop {
        dummy_field: bool,
    }

    struct TICKET_2632 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2632(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2632>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2632>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2632, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2632>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2632>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2632>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2632>>(v5, 0x2::tx_context::sender(arg1));
    }
