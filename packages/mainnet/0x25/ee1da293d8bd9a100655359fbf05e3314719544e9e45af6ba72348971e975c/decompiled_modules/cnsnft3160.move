module 0x25ee1da293d8bd9a100655359fbf05e3314719544e9e45af6ba72348971e975c::cnsnft3160 {
    struct CNSNFT3160 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3160, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3160>(arg0, arg1);
