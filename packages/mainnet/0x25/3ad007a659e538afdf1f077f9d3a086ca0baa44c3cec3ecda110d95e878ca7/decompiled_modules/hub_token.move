module 0x253ad007a659e538afdf1f077f9d3a086ca0baa44c3cec3ecda110d95e878ca7::hub_token {
    ...
    public entry fun transfer<T0>(arg0: &mut HubStorage, arg1: 0x2::token::Token<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::contains<address>(&v0.members, &v1), 0);
        ...
        0x2::event::emit<Transferred>(v6);
    }

    public entry fun create<T0>(arg0: &0x253ad007a659e538afdf1f077f9d3a086ca0baa44c3cec3ecda110d95e878ca7::factory::CollectionCap, arg1: 0x2::token::TokenPolicyCap<T0>, arg2: &mut HubStorage, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Hub<T0>{
            policy_cap : arg1,
    ...
    public entry fun join_hub<T0>(arg0: &mut HubStorage, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::contains<address>(&0x2::bag::borrow_mut<0x1::ascii::String, Hub<T0>>(&mut arg0.hubs, 0x1::type_name::into_string(0x1::type_name::get<T0>())).members, &v0), 1);
