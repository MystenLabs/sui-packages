module 0x25430e83ddde7864e1719f7b2a7165599308a461cb5082197136b83a3a04fbd3::suiup {
    struct SUIUP has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<SUIUP>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<SUIUP>>(0x2::coin::mint<SUIUP>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: SUIUP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SUIUP>>(0x2::coin::mint<SUIUP>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
