module 0x25e7b6ec10b1208a02342fea53d303ba5864df9716ca5311bd3c28dafdf8a5f8::cnsnft8195 {
    struct CNSNFT8195 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8195, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8195>(arg0, arg1);
