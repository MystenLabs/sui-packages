module 0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::request {
    ...
    entry fun migrate_as_pub<T0>(arg0: &mut Policy<T0>, arg1: &0x2::package::Publisher) {
        assert!(0x2::package::from_package<0x2587163aa906f7d4235f675ae6266cf49d6e43f4b66a106a39ba2cf9c178ddb2::ob_request::OB_REQUEST>(arg1), 0);
        assert!(arg0.version < 1, 999);
        arg0.version = 1;
    }
