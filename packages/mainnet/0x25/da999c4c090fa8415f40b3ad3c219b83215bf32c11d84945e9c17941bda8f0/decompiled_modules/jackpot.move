module 0x25da999c4c090fa8415f40b3ad3c219b83215bf32c11d84945e9c17941bda8f0::jackpot {
    ...
    public fun commit(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut Record, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        0x2::dynamic_field::add<u64, Ticket>(&mut arg0.id, v8, v9);
    ...
    entry fun reveal(arg0: &mut Vault, arg1: u64, arg2: &0x2::random::Random, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = v9 / 4;
        let v11 = mul_div(v1, v3, 100);
        let v12 = v11;
        if (v11 > v10) {
            v12 = v10;
        };
        let v13 = 0x2::random::new_generator(arg2, arg4);
        let v14 = 0x2::random::generate_u64_in_range(&mut v13, 0, v9);
        let v15 = 0x2::random::generate_u64_in_range(&mut v13, 0, 10000);
        let v16 = if (v15 < 9000) {
            800
        } else if (v15 < 9800) {
            3500
        ...
        let v17 = mul_div(v8, v16, 10000);
        let v18 = v14 < v12 && v17 > 0;
        arg0.tickets_open = arg0.tickets_open - 1;
        let v19 = if (v18) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.jackpot, v17), arg4), v4);
            arg0.wins = arg0.wins + 1;
            arg0.total_paid_mist = arg0.total_paid_mist + v17;
            ...
            let v24 = Trophy{
                ...
                won_at_ms       : v7,
                winner          : v4,
                payout_display  : mist_to_string(v17),
            ...
            0x2::transfer::transfer<Trophy>(v24, v4);
            v17
        } else {
            0
        };
