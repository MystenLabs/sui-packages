module 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund {
    ...
    fun assert_if_base_over_limit<T0>(arg0: &Fund<T0>, arg1: u64) {
        assert!(arg0.limit_amount >= arg1, 19);
    }

    fun assert_if_fund_has_nonbasic_asset<T0>(arg0: &Fund<T0>) {
        assert!(0x1::vector::length<0x1::type_name::TypeName>(&arg0.asset.asset_types) == 1, 11);
        let v0 = 0x1::type_name::get<0x2::balance::Balance<T0>>();
        assert!(0x1::vector::borrow<0x1::type_name::TypeName>(&arg0.asset.asset_types, 0) == &v0, 12);
    }

    fun assert_if_in_end_time<T0>(arg0: &Fund<T0>, arg1: &0x2::clock::Clock) {
        assert!(arg0.time.end_time < 0x2::clock::timestamp_ms(arg1), 22);
    }

    fun assert_if_init_value_not_enough<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: u64, arg2: &0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(arg2) >= arg1 * 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::trader_init_percentage(arg0) / 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::base_percentage(arg0), 17);
    }

    fun assert_if_init_value_over_limit<T0>(arg0: u64, arg1: &0x2::coin::Coin<T0>) {
        assert!(arg0 >= 0x2::coin::value<T0>(arg1), 18);
    }

    fun assert_if_is_settled<T0>(arg0: &Fund<T0>) {
        assert!(!arg0.is_settle, 21);
    }
    ...
    fun assert_if_not_arrived_invest_duration<T0>(arg0: &Fund<T0>, arg1: &0x2::clock::Clock) {
        assert!(arg0.time.start_time <= 0x2::clock::timestamp_ms(arg1), 15);
    }

    fun assert_if_not_finished(arg0: &SettleRequest) {
        assert!(arg0.is_finished, 10);
    }
    ...
    fun assert_if_not_settle<T0>(arg0: &Fund<T0>) {
        assert!(arg0.is_settle, 13);
    }

    fun assert_if_over_invest_duration<T0>(arg0: &Fund<T0>, arg1: &0x2::clock::Clock) {
        assert!(arg0.time.start_time + arg0.time.invest_duration >= 0x2::clock::timestamp_ms(arg1), 14);
    }

    fun assert_if_over_max_trader_fee(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: u64) {
        assert!(0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::max_trader_fee(arg0) >= arg1, 0);
    }
    ...
    fun assert_if_shares_empty(arg0: &vector<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>) {
        assert!(0x1::vector::length<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>(arg0) != 0, 23);
    }

    fun assert_if_take_action_not_available<T0>(arg0: &Fund<T0>, arg1: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg1) >= arg0.time.start_time + arg0.time.invest_duration, 20);
    }
    ...
    fun assert_if_trader_not_matched<T0>(arg0: &Fund<T0>, arg1: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader) {
        assert!(0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::id(arg1) == arg0.trader, 9);
    }
    ...
    public fun claim<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        assert_if_not_settle<T0>(arg1);
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::burn<T0>(arg0, 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.time.end_time), arg2);
        if (arg1.after_amount < arg1.base) {
            let v1 = arg1.after_amount * 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::invest_amount(&arg2) / arg1.share_amount;
            let v2 = Claimed<T0>{
        ...
        } else if (arg1.after_amount - arg1.base >= 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::min_rewards(arg0)) {
            let v3 = (arg1.after_amount - (arg1.after_amount - arg1.base) * 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::platform_fee(arg0) / 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::base_percentage(arg0) - (arg1.after_amount - arg1.base) * arg1.trader_fee / 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::base_percentage(arg0)) * 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::invest_amount(&arg2) / arg1.share_amount;
            let v4 = Claimed<T0>{
                receiver : 0x2::tx_context::sender(arg3),
                amount   : v3,
            };
            ...
            let v5 = arg1.base * 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::invest_amount(&arg2) / arg1.share_amount;
            let v6 = Claimed<T0>{
                receiver : 0x2::tx_context::sender(arg3),
                amount   : v5,
            };
    ...
    public fun create<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: 0x2::coin::Coin<T0>, arg13: &mut 0x2::tx_context::TxContext) : (Fund<T0>, 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::MintRequest<T0>) {
        ...
        let v6 = Fund<T0>{
            ...
            description  : arg2,
            fund_img     : arg3,
            trader       : 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::id(arg4),
            trader_fee   : arg5,
            asset        : v4,
            base         : v0,
            time         : v5,
        ...
        (v6, 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::create_mint_request<T0>(arg0, *0x2::object::uid_as_inner(&v6.id), v6.trader, v8, v0, v6.time.end_time))
    }

    public fun create_settle_request<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: bool, arg3: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare, arg4: &0x2::tx_context::TxContext) : SettleRequest {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        SettleRequest{
    ...
    public fun deinvest<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: vector<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        ...
        let v0 = 0x1::vector::pop_back<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>(&mut arg2);
        arg1.share_amount = arg1.share_amount - arg3;
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>(&arg2)) {
            0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::join(&mut v0, 0x1::vector::pop_back<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>(&mut arg2));
            v1 = v1 + 1;
        };
        let v2 = 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::split(&mut v0, arg3, arg5);
        if (0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::invest_amount(&v0) == 0) {
            0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::burn<T0>(arg0, 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.time.end_time), v0);
            let v3 = Deinvested{
            ...
            let v4 = Deinvested{
                remain_share           : 0x1::option::some<0x2::object::ID>(0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::id(&v0)),
                withdraw_invest_amount : arg3,
            };
            0x2::event::emit<Deinvested>(v4);
            0x2::transfer::public_transfer<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>(v0, 0x2::tx_context::sender(arg5));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.asset.assets, 0x1::type_name::get<0x2::balance::Balance<T0>>()), 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::invest_amount(&v2)), arg5), 0x2::tx_context::sender(arg5));
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::burn<T0>(arg0, 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.time.end_time), v2);
        0x1::vector::destroy_empty<0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::FundShare>(arg2);
    }
    ...
    public fun finish_settle_request(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut SettleRequest) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun invest<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock) : 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::MintRequest<T0> {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        ...
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::fund_share::create_mint_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.trader, v1, v0, arg1.time.end_time)
    }
    ...
    fun pay_platforem_fee<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.asset.assets, 0x1::type_name::get<0x2::balance::Balance<T0>>()), arg2), arg3), 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::platform(arg0));
    }
    ...
    public fun put_1_liquidity_for_1_liquidity_by_all<T0, T1, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>, arg3: 0x2::balance::Balance<T1>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_liquidity_for_1_nonliquidity_by_all<T0, T1: store, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>, arg3: T1) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_liquidity_for_2_liquidity_by_all<T0, T1, T2, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_nonliquidity_for_2_liquidity_by_all<T0: store, T1, T2, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun settle<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: SettleRequest, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        ...
        let v6 = arg1.base;
        let v7 = v6 * arg1.expected_roi / 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::base_percentage(arg0);
        arg1.after_amount = v5;
        if (v5 > v6) {
            if (arg1.base < 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::min_rewards(arg0)) {
                ...
                let v11 = v5 - v6;
                let v12 = v11 * 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::platform_fee(arg0) / 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::base_percentage(arg0);
                let v13 = 0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.asset.assets, 0x1::type_name::get<0x2::balance::Balance<T0>>()), (v11 - v12) * 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::settle_percentage(arg0) / 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::base_percentage(arg0));
    ...
    public fun settle_1_liquidity_for_1_liquidity<T0, T1, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>, arg3: 0x2::balance::Balance<T1>, arg4: SettleRequest, arg5: bool) : SettleRequest {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        put_1_liquidity_for_1_liquidity<T0, T1, T2>(arg1, arg2, arg3);
    ...
    public fun settle_1_liquidity_for_1_nonliquidity<T0, T1: store, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>, arg3: T1, arg4: SettleRequest, arg5: bool) : SettleRequest {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        put_1_liquidity_for_1_nonliquidity<T0, T1, T2>(arg1, arg2, arg3);
        arg4.is_finished = arg5;
        arg4
    ...
    fun take_1_liquidity_for_1_liquidity<T0, T1, T2>(arg0: &mut Fund<T2>, arg1: u64, arg2: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>) {
        ...
        if (arg1 == v1) {
            ...
            let (_, v7) = 0x1::vector::index_of<0x1::type_name::TypeName>(&arg0.asset.asset_types, &v5);
            0x1::vector::remove<0x1::type_name::TypeName>(&mut arg0.asset.asset_types, v7);
        };
        (v2, v4)
    }

    public fun take_1_liquidity_for_1_liquidity_by_trader<T0, T1, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T2>(arg1, arg2);
        take_1_liquidity_for_1_liquidity<T0, T1, T2>(arg1, arg3, arg4)
    }

    public fun take_1_liquidity_for_1_liquidity_over_end_time<T0, T1, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun take_1_liquidity_for_1_nonliquidity_by_trader<T0, T1: store, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T2>(arg1, arg2);
        take_1_liquidity_for_1_nonliquidity<T0, T1, T2>(arg1, arg3, arg4)
    }

    public fun take_1_liquidity_for_1_nonliquidity_over_end_time<T0, T1: store, T2>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        assert_if_in_end_time<T2>(arg1, arg3);
    ...
    public fun take_1_liquidity_for_2_liquidity_by_trader<T0, T1, T2, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T3>(arg1, arg2);
        take_1_liquidity_for_2_liquidity<T0, T1, T2, T3>(arg1, arg3, arg4)
    }

    public fun take_1_liquidity_for_2_liquidity_over_end_time<T0, T1, T2, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    fun take_1_nonliquidity_for_2_liquidity<T0: store, T1, T2, T3>(arg0: &mut Fund<T3>, arg1: &0x2::clock::Clock) : (T0, Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        ...
        let (_, v3) = 0x1::vector::index_of<0x1::type_name::TypeName>(&arg0.asset.asset_types, &v0);
        0x1::vector::remove<0x1::type_name::TypeName>(&mut arg0.asset.asset_types, v3);
    ...
    public fun take_1_nonliquidity_for_2_liquidity_by_trader<T0: store, T1, T2, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader, arg3: &0x2::clock::Clock) : (T0, Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T3>(arg1, arg2);
        take_1_nonliquidity_for_2_liquidity<T0, T1, T2, T3>(arg1, arg3)
    }

    public fun take_1_nonliquidity_for_2_liquidity_over_end_time<T0: store, T1, T2, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x2::clock::Clock) : (T0, Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    fun take_2_liquidity_for_1_nonliquidity<T0, T1, T2, T3>(arg0: &mut Fund<T3>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, Take_2_Liquidity_For_1_NonLiquidity_Request<T0, T1, T2>) {
        ...
        if (arg1 == v1) {
            let v8 = 0x1::type_name::get<0x2::balance::Balance<T0>>();
            let (_, v10) = 0x1::vector::index_of<0x1::type_name::TypeName>(&arg0.asset.asset_types, &v8);
            0x1::vector::remove<0x1::type_name::TypeName>(&mut arg0.asset.asset_types, v10);
        };
        if (arg2 == v4) {
            let v11 = 0x1::type_name::get<0x2::balance::Balance<T1>>();
            let (_, v13) = 0x1::vector::index_of<0x1::type_name::TypeName>(&arg0.asset.asset_types, &v11);
            0x1::vector::remove<0x1::type_name::TypeName>(&mut arg0.asset.asset_types, v13);
        };
        (v2, v5, v7)
    }

    public fun take_2_liquidity_for_1_nonliquidity_by_trader<T0, T1, T2: store, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, Take_2_Liquidity_For_1_NonLiquidity_Request<T0, T1, T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T3>(arg1, arg2);
        take_2_liquidity_for_1_nonliquidity<T0, T1, T2, T3>(arg1, arg3, arg4, arg5)
    }

    public fun take_2_liquidity_for_1_nonliquidity_over_end_time<T0, T1, T2: store, T3>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, Take_2_Liquidity_For_1_NonLiquidity_Request<T0, T1, T2>) {
        0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun trader_claim<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_if_trader_not_matched<T0>(arg1, arg2);
        assert_if_not_settle<T0>(arg1);
        if (arg1.after_amount >= arg1.base) {
            if (arg1.after_amount - arg1.base >= 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::min_rewards(arg0)) {
                let v1 = (arg1.after_amount - arg1.base) * arg1.trader_fee / 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::base_percentage(arg0);
                let v2 = TraderClaimed<T0>{
                    trader   : 0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::id(arg2),
                    receiver : 0x2::tx_context::sender(arg3),
                    amount   : v1,
                };
    ...
    public(friend) fun update_description<T0>(arg0: &mut Fund<T0>, arg1: 0x1::string::String, arg2: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::trader::Trader) {
    ...
    public entry fun withdraw<T0>(arg0: &0x251dfa25eaa367f0dd434d3b14b05dc68fef38023b6170899e704a8bcb923315::config::AdminCap, arg1: &mut Fund<T0>, arg2: &mut 0x2::tx_context::TxContext) {
