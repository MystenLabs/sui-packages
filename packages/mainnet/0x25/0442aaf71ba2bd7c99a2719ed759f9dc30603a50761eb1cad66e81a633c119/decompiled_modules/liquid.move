module 0x250442aaf71ba2bd7c99a2719ed759f9dc30603a50761eb1cad66e81a633c119::liquid {
    ...
    fun init(arg0: LIQUID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Suisses Event"));
