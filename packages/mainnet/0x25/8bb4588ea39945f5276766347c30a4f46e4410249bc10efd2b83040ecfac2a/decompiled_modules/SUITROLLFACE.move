module 0x258bb4588ea39945f5276766347c30a4f46e4410249bc10efd2b83040ecfac2a::SUITROLLFACE {
    ...
    fun init(arg0: SUITROLLFACE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUITROLLFACE>(arg0, 9, b"$STROLL", b"SUITROLLFACELAUCNHTOMORROW https://t.me/suitroll", b"https://t.me/suitroll", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://https-pinksale.finance/anhcuatung/trollface.png")), arg1);
