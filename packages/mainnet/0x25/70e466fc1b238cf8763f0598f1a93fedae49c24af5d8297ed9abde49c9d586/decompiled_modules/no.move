module 0x2570e466fc1b238cf8763f0598f1a93fedae49c24af5d8297ed9abde49c9d586::no {
    struct NO has drop {
        dummy_field: bool,
    }
    ...
    public fun get_coin<T0>(arg0: &mut SpamData, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        assert!(arg1 >= arg2, 3);
