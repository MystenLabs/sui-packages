module 0x25a3950c625ba0e887a1c8a82e11a9f585039c0b35059968f7eab30b9b449dfe::cnsnft9466 {
    struct CNSNFT9466 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9466, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9466>(arg0, arg1);
