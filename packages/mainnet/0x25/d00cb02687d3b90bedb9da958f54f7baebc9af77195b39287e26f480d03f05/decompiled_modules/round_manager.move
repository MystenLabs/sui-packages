    ...
    fun settle(arg0: &mut Global, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4 > 0 && v2 > 0) {
            ...
            while (v5 < v4) {
                ...
                0x7264c7a35fa3057ede9be33866f3e38cb91a2322773ed9bfa9f20e5783f69fc4::faith::accrue_to(v6.owner, v8, &mut arg0.cap, &mut arg0.idx, &mut arg0.buckets, arg3);
        ...
        let (v10, v11) = 0x7264c7a35fa3057ede9be33866f3e38cb91a2322773ed9bfa9f20e5783f69fc4::godlode::maybe_hit(&mut arg0.godlode, arg2);
        let v12 = if (v10) {
            if (v4 > 0) {
                v2 > 0
            } else {
        ...
        if (v12) {
            ...
            while (v13 < v4) {
                ...
                0x7264c7a35fa3057ede9be33866f3e38cb91a2322773ed9bfa9f20e5783f69fc4::faith::accrue_to(v14.owner, v15, &mut arg0.cap, &mut arg0.idx, &mut arg0.buckets, arg3);
