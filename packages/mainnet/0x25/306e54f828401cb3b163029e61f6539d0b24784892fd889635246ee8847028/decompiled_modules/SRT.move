module 0x25306e54f828401cb3b163029e61f6539d0b24784892fd889635246ee8847028::SRT {
    struct SRT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SRT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SRT>(arg0, 9, b"SUI", b"Sui", b"Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://res.cloudinary.com/dovgmcejr/image/upload/v1716471902/suiRewardToken/sui_w3tjn9.svg")), arg1);
