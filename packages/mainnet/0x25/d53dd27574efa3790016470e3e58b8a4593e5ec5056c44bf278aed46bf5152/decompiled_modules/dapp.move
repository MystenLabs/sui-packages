module 0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::dapp {
    ...
    public fun appointUserLevel<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::updateLevel(&mut arg0.global_network_data, get_user_level(v0), arg2);
    ...
    public fun batch_update_area_stats<T0>(arg0: &mut Contract<T0>, arg1: vector<address>, arg2: vector<u64>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<address>(&arg1)) {
            ...
            let v2 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, *0x1::vector::borrow<address>(&arg1, v0));
            v2.area_performance = v1;
            v2.area_invest_amount = *0x1::vector::borrow<u64>(&arg3, v0);
            let v3 = get_level_by_performance(v1);
            let v4 = get_user_level(v2);
            if (v3 > v4 || v3 < v4 && v2.benefit_expiry < 0x2::clock::timestamp_ms(arg4)) {
                0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::updateLevel(&mut arg0.global_network_data, v4, v3);
                v2.level = v3;
            };
            v0 = v0 + 1;
        };
    ...
    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &mut 0xbd318e196f39fadcf4f13e8a1f219596c4def96f6e22d5124d2d8ff64b93e449::implements::Global, arg2: &0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::price_oracle::PriceOracle, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 13906839109260804095);
    ...
    public entry fun claimBalance<T0, T1>(arg0: &mut Contract<T1>, arg1: &0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0xbd318e196f39fadcf4f13e8a1f219596c4def96f6e22d5124d2d8ff64b93e449::implements::Global, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::get_current_rank_reward(v0) < 500000000) {
    ...
    public fun distribute_rank_share<T0>(arg0: &mut Contract<T0>, arg1: &mut 0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::rank_list::TodayRank, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::rank_list::distribute_reward(arg1, 0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::get_current_rank_reward(&arg0.global_network_data), arg2);
        0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::clean_rank_reward(&mut arg0.global_network_data);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::rank_list::RankItem>(&v0)) {
            let v2 = 0x1::vector::borrow<0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::rank_list::RankItem>(&v0, v1);
            let v3 = &mut arg0.users;
            let v4 = &mut arg0.global_network_data;
            add_user_balance(0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::rank_list::get_user(v2), 0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::rank_list::get_amount(v2), v3, v4);
            v1 = v1 + 1;
        };
    }
    ...
    fun update_dynamic_power(arg0: &mut 0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: bool) {
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            let v3 = 0x1::option::extract<address>(&mut v0);
            let v4 = 0;
            let v5 = &0x2::table::borrow<address, User>(arg1, v3).invitees;
            let v6 = 0;
            while (v6 < 0x1::vector::length<address>(v5)) {
                let v7 = *0x1::vector::borrow<address>(v5, v6);
                if (0x2::table::contains<address, User>(arg1, v7)) {
                    if (0x2::table::borrow<address, User>(arg1, v7).invest_amount > 0) {
                        v4 = v4 + 1;
                    };
                };
                v6 = v6 + 1;
            };
            let v8 = get_share_reward_percent(v1, v4);
            let v9 = 0x2::table::borrow_mut<address, User>(arg1, v3);
            if (v9.invest_amount > 0 && v8 > 0) {
                let v10 = arg3 / 100 * v8;
                if (v1 == 1 && arg4) {
                    let v11 = v10 / 10;
                    let v12 = v9.static_power - v9.total_earning;
                    let v13 = if (v11 < v12) {
                        v11
                    } else {
                        v12
                    };
                    v9.balance = v9.balance + v13;
                    v9.today_earning = v9.today_earning + v13;
                    v9.total_earning = v9.total_earning + v13;
                    0x1::vector::push_back<address>(&mut v2, v3);
                    v9.dynamic_power = v9.dynamic_power + v10 - v13;
                    0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::add_total_dynamic_power_distributed(arg0, v10 - v13);
                    0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::add_total_share_reward(arg0, v13);
                    0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::add_total_user_balance(arg0, v13);
                } else {
                    v9.dynamic_power = v9.dynamic_power + v10;
                    0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::add_total_dynamic_power_distributed(arg0, v10);
                };
                if (v1 == 1) {
                    v9.quota = v9.quota + v10;
                    0x56ee956e8784a11c548990367c2cf164474cf843ecbbe918cab634916aa5384f::admin::add_total_pre_buy_quota(arg0, v10);
                };
            };
            v0 = v9.inviter;
            v1 = v1 + 1;
        ...
        let v14 = 0;
        while (v14 < 0x1::vector::length<address>(&v2)) {
            handler_out(arg0, *0x1::vector::borrow<address>(&v2, v14), arg1);
            v14 = v14 + 1;
        };
    }
