module 0x250a736ce66d37b1c8a9753dbb6bcc036c9f7afbdf670c48544563d66aa357b2::look {
    struct LOOK has drop {
        dummy_field: bool,
    }

    fun init(arg0: LOOK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/460px-Iconic-Memes-Step-4-kitCU0OEpe13w3ZDpfeSMk2w9oT9AO.jpg";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/460px-Iconic-Memes-Step-4-kitCU0OEpe13w3ZDpfeSMk2w9oT9AO.jpg"))
        };
