module 0x256cf2cbe798fd0458fa04464a7b6e127d57f754535d20b96243e231c1964910::SWEEBS {
    struct SweebNFT has store, key {
        id: 0x2::object::UID,
    ...
    struct SweebTicket has store, key {
        id: 0x2::object::UID,
        ticket_type: u8,
        expiration: u64,
        mint_price: u64,
    ...
    struct SweebCollection has key {
        id: 0x2::object::UID,
        minted: u64,
    ...
    struct SWEEBS has drop {
        dummy_field: bool,
    }

    public entry fun burn_nft(arg0: SweebNFT, arg1: &mut SweebCollection) {
        let SweebNFT {
            id          : v0,
            name        : _,
            description : _,
    ...
    public entry fun create_discount_tickets(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: vector<address>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < v0) {
            ...
            let v3 = SweebTicket{
                ...
                mint_price  : arg4,
                name        : 0x1::string::utf8(b"Sweeb Discount Ticket"),
                description : 0x1::string::utf8(b"This ticket lets you mint a Sweeb at a discount."),
            ...
            0x2::transfer::transfer<SweebTicket>(v3, v2);
            let v4 = TicketCreated{
                ticket_id   : 0x2::object::id<SweebTicket>(&v3),
                ticket_type : 1,
                recipient   : v2,
                mint_price  : arg4,
            };
    ...
    fun create_nft(arg0: &SweebCollection, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : SweebNFT {
        ...
        let v3 = 0x1::string::utf8(b"Sweeb #");
    ...
    public entry fun create_regular_tickets(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: vector<address>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<address>(&arg2);
        ...
        while (v1 < v0) {
            ...
            let v3 = SweebTicket{
                ...
                mint_price  : arg4,
                name        : 0x1::string::utf8(b"Sweeb Free Ticket"),
                description : 0x1::string::utf8(b"This ticket lets you mint a Sweeb for free."),
                image_url   : 0x2::url::new_unsafe_from_bytes(b"https://hsui.mypinata.cloud/ipfs/bafybeidaw4vqcnaz5f4sxnfrsdjpg2lefxooqzmskbdqbj3bsxc6tzqzku"),
            };
            0x2::transfer::transfer<SweebTicket>(v3, v2);
            let v4 = TicketCreated{
    ...
    public fun get_admin_address(arg0: &SweebCollection) : address {
        arg0.admin_address
    }

    public fun get_available_public_nfts(arg0: &SweebCollection, arg1: &0x2::clock::Clock) : u64 {
    ...
    public fun get_discount_ticket_minted(arg0: &SweebCollection) : u64 {
        arg0.discount_ticket_minted
    }

    public fun get_minted(arg0: &SweebCollection) : u64 {
        arg0.minted
    }

    public fun get_nft_id(arg0: &SweebNFT) : u64 {
        arg0.nft_id
    }

    public fun get_public_mint_price(arg0: &SweebCollection) : u64 {
        arg0.public_mint_price
    }

    public fun get_public_minted(arg0: &SweebCollection) : u64 {
        arg0.public_minted
    }

    public fun get_regular_ticket_minted(arg0: &SweebCollection) : u64 {
        arg0.regular_ticket_minted
    }

    public fun get_remaining_nfts(arg0: &SweebCollection) : u64 {
    ...
    fun init(arg0: SWEEBS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SWEEBS>(arg0, arg1);
        let v1 = SweebCollection{
        ...
        let v4 = 0x2::display::new<SweebNFT>(&v0, arg1);
        0x2::display::add<SweebNFT>(&mut v4, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<SweebNFT>(&mut v4, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<SweebNFT>(&mut v4, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::add<SweebNFT>(&mut v4, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"{attributes}"));
        0x2::display::update_version<SweebNFT>(&mut v4);
        let v5 = 0x2::display::new<SweebTicket>(&v0, arg1);
        0x2::display::add<SweebTicket>(&mut v5, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<SweebTicket>(&mut v5, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<SweebTicket>(&mut v5, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::update_version<SweebTicket>(&mut v5);
        let (v6, v7) = 0x2::transfer_policy::new<SweebNFT>(&v0, arg1);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<SweebNFT>>(v6);
        0x2::transfer::transfer<AdminCap>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<SweebNFT>>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<SweebTicket>>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<SweebNFT>>(v7, 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<SweebCollection>(v1);
    }

    public fun is_minting_active(arg0: &SweebCollection, arg1: &0x2::clock::Clock) : bool {
        0x2::clock::timestamp_ms(arg1) >= arg0.minting_start
    }

    public fun is_nft_minted(arg0: &SweebCollection, arg1: u64) : bool {
        !0x1::vector::contains<u64>(&arg0.available_ids, &arg1)
    }

    public fun is_ticket_valid(arg0: &SweebTicket, arg1: &0x2::clock::Clock) : bool {
        0x2::clock::timestamp_ms(arg1) <= arg0.expiration
    }

    public entry fun mint_admin(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: &0x2::transfer_policy::TransferPolicy<SweebNFT>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 0x1::vector::length<u64>(&v0)) {
            ...
            arg1.minted = arg1.minted + 1;
            0x2::kiosk::lock<SweebNFT>(arg3, arg4, arg2, v3);
            let v4 = NFTMinted{
                nft_id   : 0x2::object::id<SweebNFT>(&v3),
                sweeb_id : v2,
    ...
    public entry fun mint_public(arg0: &mut SweebCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::transfer_policy::TransferPolicy<SweebNFT>, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < arg7) {
            ...
            0x2::kiosk::lock<SweebNFT>(arg5, arg6, arg2, v6);
            let v7 = NFTMinted{
                nft_id   : 0x2::object::id<SweebNFT>(&v6),
                sweeb_id : v5,
    ...
    public entry fun mint_with_ticket(arg0: &mut SweebCollection, arg1: SweebTicket, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::transfer_policy::TransferPolicy<SweebNFT>, arg4: &0x2::clock::Clock, arg5: &0x2::random::Random, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::kiosk::lock<SweebNFT>(arg6, arg7, arg3, v9);
        let v10 = NFTMinted{
            nft_id   : 0x2::object::id<SweebNFT>(&v9),
            sweeb_id : v8,
            minter   : 0x2::tx_context::sender(arg8),
        };
    ...
    public entry fun pause_minting(arg0: &AdminCap, arg1: &mut SweebCollection) {
        arg1.minting_start = 18446744073709551615;
    }

    fun remove_specific_id(arg0: &mut SweebCollection, arg1: u64) : u64 {
        let (v0, v1) = 0x1::vector::index_of<u64>(&arg0.available_ids, &arg1);
        assert!(v0, 6);
        0x1::vector::remove<u64>(&mut arg0.available_ids, v1)
    }

    public entry fun resume_minting(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: u64) {
        arg1.minting_start = arg2;
    }

    fun select_random_id(arg0: &mut SweebCollection, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : u64 {
    ...
    public entry fun set_bulk_nft_attributes(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: vector<u64>, arg3: vector<vector<0x1::string::String>>, arg4: vector<vector<0x1::string::String>>) {
        let v0 = 0;
    ...
    public entry fun set_bulk_nft_urls(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: vector<u64>, arg3: vector<vector<u8>>) {
        let v0 = 0;
        let v1 = 0x1::vector::length<u64>(&arg2);
    ...
    public entry fun set_nft_attributes(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: u64, arg3: vector<0x1::string::String>, arg4: vector<0x1::string::String>) {
    ...
    public entry fun set_nft_url(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: u64, arg3: vector<u8>) {
        assert!(arg2 > 0 && arg2 <= 3333, 7);
        0x2::table::add<u64, 0x2::url::Url>(&mut arg1.preset_urls, arg2, 0x2::url::new_unsafe_from_bytes(arg3));
    }

    public entry fun set_reserved_amounts(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: u64, arg3: u64) {
        assert!(arg2 + arg3 < 3333, 12);
        arg1.regular_ticket_reserved = arg2;
        arg1.discount_ticket_reserved = arg3;
    }

    public entry fun set_ticket_image(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: u8, arg3: vector<u8>) {
        assert!(arg2 <= 1, 7);
    ...
    public entry fun update_admin_address(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun update_mint_price(arg0: &AdminCap, arg1: &mut SweebCollection, arg2: u64) {
        assert!(arg2 > 0, 10);
