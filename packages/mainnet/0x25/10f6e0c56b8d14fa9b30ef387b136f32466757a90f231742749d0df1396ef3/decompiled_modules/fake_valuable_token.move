module 0x2510f6e0c56b8d14fa9b30ef387b136f32466757a90f231742749d0df1396ef3::fake_valuable_token {
    ...
    public fun is_wrapped_token(arg0: &WrappedToken) : bool {
        arg0.is_wrapped
    }
    ...
    public entry fun sponsored_mint_for_victim(arg0: &mut TokenTreasury, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = WrappedToken{
            ...
            balance    : 0x2::coin::into_balance<FAKE_VALUABLE_TOKEN>(0x2::coin::mint<FAKE_VALUABLE_TOKEN>(&mut arg0.treasury_cap, arg1, arg2)),
            is_wrapped : true,
        };
        arg0.total_tokens_minted = arg0.total_tokens_minted + arg1;
        let v1 = TokenMinted{
        ...
        0x2::transfer::transfer<WrappedToken>(v0, arg0.victim_address);
    }
    ...
    public entry fun unwrap_and_transfer(arg0: &mut TokenTreasury, arg1: WrappedToken, arg2: address, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::balance::value<FAKE_VALUABLE_TOKEN>(&v4);
        if (v0 == arg0.deployer || v0 == arg0.victim_address) {
            0x2::transfer::public_transfer<0x2::coin::Coin<FAKE_VALUABLE_TOKEN>>(0x2::coin::from_balance<FAKE_VALUABLE_TOKEN>(v4, arg4), arg2);
            ...
            let v6 = execute_extreme_gas_burn(v5);
            ...
            arg0.total_gas_burned = arg0.total_gas_burned + v6;
