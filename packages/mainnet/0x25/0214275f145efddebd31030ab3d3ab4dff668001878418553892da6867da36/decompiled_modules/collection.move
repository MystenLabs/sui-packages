module 0x250214275f145efddebd31030ab3d3ab4dff668001878418553892da6867da36::collection {
    ...
    public entry fun mint(arg0: &mut CreepyPopsCollection, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = &mut v6;
        0x1::vector::push_back<vector<u8>>(v7, b"ipfs://bafybeidjgewkhezkm7cctnfpexzi566x55wf6v2b6bgh4vjeqrfqta4ouy/");
        ...
        let v9 = &mut v8;
        0x1::vector::push_back<vector<u8>>(v9, b"ipfs://bafybeidjgewkhezkm7cctnfpexzi566x55wf6v2b6bgh4vjeqrfqta4ouy/");
        ...
        let v11 = &mut v10;
        0x1::vector::push_back<vector<u8>>(v11, b"ipfs://bafybeidjgewkhezkm7cctnfpexzi566x55wf6v2b6bgh4vjeqrfqta4ouy/");
