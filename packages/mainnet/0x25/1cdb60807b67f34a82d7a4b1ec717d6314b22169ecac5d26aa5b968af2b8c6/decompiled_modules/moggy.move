module 0x251cdb60807b67f34a82d7a4b1ec717d6314b22169ecac5d26aa5b968af2b8c6::moggy {
    ...
    fun init(arg0: MOGGY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<MOGGY>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<MOGGY>>(v4);
    }
