module 0x462e270491da3d2302b8f2a20c97f408dbc763c7c7fa88ea7a9015f9dea83b42::user_staking_info {
    ...
    public(friend) fun add_stake_v2<T0>(arg0: &mut UserStakingInfo<T0>, arg1: u64, arg2: 0x2::object::ID) {
    ...
    public(friend) fun remove_stake_v2<T0>(arg0: &mut UserStakingInfo<T0>, arg1: u64, arg2: 0x2::object::ID) : bool {
        if (arg0.total_locked < arg1) {
            arg0.total_locked = 0;
        } else {
            arg0.total_locked = arg0.total_locked - arg1;
        };
        let (v0, v1) = find_token_index<T0>(arg0, arg2);
        if (v0) {
