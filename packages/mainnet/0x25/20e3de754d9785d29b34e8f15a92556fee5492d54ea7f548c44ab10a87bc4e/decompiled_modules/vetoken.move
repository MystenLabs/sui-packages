module 0x462e270491da3d2302b8f2a20c97f408dbc763c7c7fa88ea7a9015f9dea83b42::vetoken {
    ...
    public(friend) fun add_locked_amount<T0>(arg0: &mut VeHAEDAL<T0>, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        let v0 = get_add_vehaedal_amount<T0>(arg0, arg1, arg2);
        let v1 = arg0.initial_amount + v0;
        arg0.locked_amount = arg0.locked_amount + arg1;
        arg0.initial_amount = v1;
    ...
    public(friend) fun extend_lock<T0>(arg0: &mut VeHAEDAL<T0>, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        let (v0, v1) = if (!arg0.is_decaying) {
            ...
            (v2, (v2 - 0x2::clock::timestamp_ms(arg2)) / 7 * 86400 * 1000)
        };
    ...
    public fun get_add_vehaedal_amount<T0>(arg0: &mut VeHAEDAL<T0>, arg1: u64, arg2: &0x2::clock::Clock) : u64 {
        ((arg1 * get_current_lock_weeks<T0>(arg0, arg2) / 52) as u64)
    }

    public fun get_current_lock_weeks<T0>(arg0: &mut VeHAEDAL<T0>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = if (!arg0.is_decaying) {
            get_remaining_lock_weeks_when_stopped_decay<T0>(arg0)
        } else {
            let v1 = 0x2::clock::timestamp_ms(arg1);
            if (v1 >= arg0.lock_end_time) {
                0
            } else {
                (arg0.lock_end_time - v1) / 7 * 86400 * 1000
            }
        };
        (v0 as u64)
    }
