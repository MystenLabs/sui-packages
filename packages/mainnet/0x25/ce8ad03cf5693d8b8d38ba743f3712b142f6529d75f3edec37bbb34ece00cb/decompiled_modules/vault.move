module 0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::vault {
    ...
    struct Vault<phantom T0, phantom T1, phantom T2> has store, key {
        ...
        swap_routes: 0x2::table::Table<0x1::type_name::TypeName, vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>>,
    }

    public(friend) fun add_swap_route<T0, T1, T2, T3>(arg0: &mut Vault<T0, T1, T2>, arg1: vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>) {
        let v0 = 0x1::type_name::get<T3>();
        if (0x2::table::contains<0x1::type_name::TypeName, vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>>(&arg0.swap_routes, v0)) {
            let v1 = 0x2::table::remove<0x1::type_name::TypeName, vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>>(&mut arg0.swap_routes, v0);
            while (!0x1::vector::is_empty<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>(&v1)) {
                let (_, _) = 0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::unwrap(0x1::vector::pop_back<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>(&mut v1));
            };
            0x1::vector::destroy_empty<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>(v1);
        };
        0x2::table::add<0x1::type_name::TypeName, vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>>(&mut arg0.swap_routes, v0, arg1);
    }
    ...
    public fun get_swap_route<T0, T1, T2, T3>(arg0: &Vault<T0, T1, T2>) : vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value> {
        *0x2::table::borrow<0x1::type_name::TypeName, vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>>(&arg0.swap_routes, 0x1::type_name::get<T3>())
    }
    ...
    public(friend) fun initialize<T0, T1, T2>(arg0: 0x2::coin::TreasuryCap<T2>, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u128, arg5: u128, arg6: &0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_config::IncentiveConfig, arg7: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_pool::IncentivePools, arg8: &mut 0x2875153e09f8145ab63527bc85c00f2bd102e12f9573c47f8cdf1a1cb62934::incentive_account::IncentiveAccounts, arg9: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::obligation_access::ObligationAccessStore, arg10: &0x2::clock::Clock, arg11: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg12: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v5 = Vault<T0, T1, T2>{
            ...
            swap_routes     : 0x2::table::new<0x1::type_name::TypeName, vector<0x25ce8ad03cf5693d8b8d38ba743f3712b142f6529d75f3edec37bbb34ece00cb::bag_value::Value>>(arg12),
        };
