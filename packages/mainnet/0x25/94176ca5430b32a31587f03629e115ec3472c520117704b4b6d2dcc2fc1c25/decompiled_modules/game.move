module 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::game {
    ...
    struct Match has store, key {
        ...
        folded: vector<bool>,
        action_log: vector<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ActionLogEntry>,
        hand_summaries: vector<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::HandSummary>,
        action_count: u32,
        entropy_counter: u64,
        start_time: u64,
    ...
    public(friend) fun action_log(arg0: &Match) : &vector<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ActionLogEntry> {
        &arg0.action_log
    }
    ...
    fun advance_forced_progress(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        assert!(arg2 < 100, 13906836729849446409);
        loop {
            if (!arg0.active) {
                return
            };
            ...
            if (round_closed(arg0)) {
                if (arg0.street == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::river()) {
                    runout_and_showdown(arg0, arg1, arg2);
                    return
                };
                advance_street(arg0, arg1);
                emit_engine_action_taken(arg0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::engine_action_advance_street(), 0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner(), false, false, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner());
                continue
            };
    ...
    fun advance_street(arg0: &mut Match, arg1: &0x2::tx_context::TxContext) {
        arg0.street = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::street_next(arg0.street);
        ...
        *0x1::vector::borrow_mut<bool>(&mut arg0.acted_since_full_raise, 1) = false;
        ...
        if (arg0.street == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::flop()) {
    ...
    public(friend) fun apply_move(arg0: &mut Match, arg1: &GameCap, arg2: u8, arg3: u32, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        assert!(arg1.game_id == 0x2::object::id<Match>(arg0), 13906836278877749255);
        assert!(arg0.active, 13906836283172454403);
        let v0 = arg0.to_act;
        let v1 = (v0 as u64);
        assert!(!*0x1::vector::borrow<bool>(&arg0.folded, v1), 13906836300352454661);
        assert!(*0x1::vector::borrow<u32>(&arg0.stacks, v1) > 0 || arg3 == 0, 13906836304647421957);
        ...
        if (arg2 == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_fold()) {
            assert!(v4 > 0, 13906836334712193029);
            *0x1::vector::borrow_mut<bool>(&mut arg0.folded, v1) = true;
            log_action(arg0, v0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_fold(), 0);
        } else if (arg2 == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_check()) {
            assert!(v4 == 0, 13906836351892062213);
            *0x1::vector::borrow_mut<bool>(&mut arg0.acted_since_full_raise, v1) = true;
            log_action(arg0, v0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_check(), 0);
            arg0.to_act = 1 - v0;
        } else {
            assert!(arg2 == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_commit_to(), 13906836459266244613);
            let (v5, v6) = classify_commit_to(arg0, v0, arg3);
            assert!(v5, 13906836386251800581);
            ...
            *0x1::vector::borrow_mut<bool>(&mut arg0.acted_since_full_raise, v1) = true;
            log_action(arg0, v0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_commit_to(), arg3);
            arg0.to_act = 1 - v0;
        };
        arg0.last_update_time = 0x2::clock::timestamp_ms(arg5);
        let v7 = 0x1::vector::borrow<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ActionLogEntry>(&arg0.action_log, 0x1::vector::length<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ActionLogEntry>(&arg0.action_log) - 1);
        let v8 = 0x2::object::id<Match>(arg0);
        let v9 = ActionTaken{
            match_id        : 0x2::object::id_to_address(&v8),
            hand_index      : arg0.hand_index,
            street          : 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ale_street(v7),
            seat            : 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ale_seat(v7),
            action_type     : 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ale_action_type(v7),
            amount          : 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ale_amount(v7),
            agent_state     : arg4,
            pot             : arg0.pot,
    ...
    public fun blinds_for_hand(arg0: u32, arg1: u32, arg2: u32, arg3: u32, arg4: u8, arg5: u32) : (u32, u32) {
        assert!(arg4 == 0 || arg4 == 1, 13906838340461658113);
        let v0 = if (arg5 <= 1) {
            0
        } else {
            (arg5 - 1) / max(arg1, 1)
    ...
    fun build_match(arg0: MatchConfig, arg1: vector<0x1::string::String>, arg2: vector<u32>, arg3: u8, arg4: u32, arg5: vector<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::HandSummary>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (GameCap, Match) {
        ...
        assert!(*0x1::vector::borrow<u32>(&arg2, 0) > 0 && *0x1::vector::borrow<u32>(&arg2, 1) > 0, 13906835660402065409);
        assert!((*0x1::vector::borrow<u32>(&arg2, 0) as u64) + (*0x1::vector::borrow<u32>(&arg2, 1) as u64) <= 4294967295, 13906835686171869185);
        assert!(arg3 == 0 || arg3 == 1, 13906835694761803777);
        ...
        let v1 = Match{
            ...
            hand_index             : arg4,
            active                 : true,
            winner                 : 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner(),
            street                 : 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::preflop(),
            small_blind            : 0,
            big_blind              : 0,
            pot                    : 0,
            ...
            action_log             : 0x1::vector::empty<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ActionLogEntry>(),
            hand_summaries         : arg5,
            action_count           : 0,
            entropy_counter        : 0,
            start_time             : v0,
    ...
    fun burn_before_board_if_random(arg0: &mut Match, arg1: &vector<u8>, arg2: address) {
        if (0x1::vector::length<u8>(&arg0.scheduled_board) == 0) {
            0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::burn_card(&mut arg0.deck, arg1, arg2, &mut arg0.entropy_counter);
        };
    }
    ...
    fun chip_leader(arg0: &Match) : u8 {
        if (*0x1::vector::borrow<u32>(&arg0.stacks, 0) > *0x1::vector::borrow<u32>(&arg0.stacks, 1)) {
            ...
            0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner()
        }
    }
    ...
    fun complete_match(arg0: &mut Match, arg1: u8) {
        arg0.active = false;
        arg0.winner = arg1;
        emit_engine_action_taken(arg0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::engine_action_complete_match(), 0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner(), arg1 == 0, arg1 == 1, arg1);
    }
    ...
    fun draw_board_card(arg0: &mut Match, arg1: &vector<u8>, arg2: address) : u8 {
        if (0x1::vector::length<u8>(&arg0.scheduled_board) > 0) {
            ...
            0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::draw_card(&mut arg0.deck, arg1, arg2, &mut arg0.entropy_counter)
        }
    }
    ...
    public(friend) fun hand_summaries(arg0: &Match) : &vector<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::HandSummary> {
        &arg0.hand_summaries
    }
    ...
    public fun is_legal(arg0: &Match, arg1: u8, arg2: u32) : bool {
        ...
        if (arg1 == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_fold()) {
            v4 > 0
        } else if (arg1 == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_check()) {
            v4 == 0
        } else if (arg1 == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::action_commit_to()) {
    ...
    fun log_action(arg0: &mut Match, arg1: u8, arg2: u8, arg3: u32) {
        0x1::vector::push_back<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ActionLogEntry>(&mut arg0.action_log, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::new_action_log_entry(arg0.street, arg1, arg2, arg3));
    }
    ...
    public(friend) fun new_match(arg0: u32, arg1: u32, arg2: u32, arg3: u32, arg4: u32, arg5: u8, arg6: u32, arg7: u32, arg8: vector<u8>, arg9: vector<u8>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (GameCap, Match) {
        ...
        0x1::vector::push_back<u32>(v4, arg0);
        build_match(v0, v1, v3, 0, 0, 0x1::vector::empty<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::HandSummary>(), arg10, arg11)
    }

    public(friend) fun new_match_from_snapshot(arg0: u32, arg1: u32, arg2: u32, arg3: u32, arg4: u32, arg5: u8, arg6: u32, arg7: u32, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<u32>, arg11: u8, arg12: u32, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : (GameCap, Match) {
        assert!(0x1::vector::length<u32>(&arg10) == 2, 13906836107078664193);
        let v0 = MatchConfig{
            starting_stack      : arg0,
            opening_big_blind   : arg1,
            hands_per_level     : arg2,
        ...
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(arg8));
        0x1::vector::push_back<0x1::string::String>(v2, 0x1::string::utf8(arg9));
        build_match(v0, v1, arg10, arg11, arg12, 0x1::vector::empty<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::HandSummary>(), arg13, arg14)
    }
    ...
    fun resolve_fold(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        ...
        *0x1::vector::borrow_mut<u32>(&mut arg0.stacks, (v1 as u64)) = *0x1::vector::borrow<u32>(&arg0.stacks, (v1 as u64)) + v2;
        arg0.pot = 0;
        let v3 = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::new_hand_summary(arg0.hand_index, arg0.button, v2, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::hand_end_fold(), v1 == 0, v1 == 1, *0x1::vector::borrow<u32>(&arg0.stacks, 0), *0x1::vector::borrow<u32>(&arg0.stacks, 1));
    ...
    fun reveal_remaining_board(arg0: &mut Match, arg1: &0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<u8>(&arg0.community_cards) < 5) {
            let v3 = if (0x1::vector::length<u8>(&arg0.community_cards) == 0) {
                0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::flop()
            } else if (0x1::vector::length<u8>(&arg0.community_cards) == 3) {
                0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::turn()
            } else {
                0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::river()
            };
            burn_before_board_if_random(arg0, &v2, v1);
            if (v3 == 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::flop()) {
                let v4 = draw_board_card(arg0, &v2, v1);
                let v5 = draw_board_card(arg0, &v2, v1);
                let v6 = draw_board_card(arg0, &v2, v1);
                0x1::vector::push_back<u8>(&mut arg0.community_cards, v4);
    ...
    fun runout_and_showdown(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        ...
        let v4 = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::eval::best_of_seven(&v0);
        let v5 = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::eval::best_of_seven(&v2);
        let v6 = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::eval::hand_rank_cmp(&v4, &v5);
        let (v7, v8) = if (v6 == 2) {
            (true, false)
        } else if (v6 == 0) {
            (false, true)
        ...
        arg0.pot = 0;
        let v10 = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::new_hand_summary(arg0.hand_index, arg0.button, v9, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::hand_end_showdown(), v7, v8, *0x1::vector::borrow<u32>(&arg0.stacks, 0), *0x1::vector::borrow<u32>(&arg0.stacks, 1));
    ...
    fun start_hand_with_depth(arg0: &mut Match, arg1: &0x2::tx_context::TxContext, arg2: u8) {
        assert!(arg2 < 100, 13906837915260420105);
        ...
        arg0.street = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::preflop();
        arg0.small_blind = v2;
        arg0.big_blind = v3;
        arg0.pot = 0;
        *0x1::vector::borrow_mut<u32>(&mut arg0.round_bet, 0) = 0;
        *0x1::vector::borrow_mut<u32>(&mut arg0.round_bet, 1) = 0;
        ...
        arg0.deck = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::standard_deck();
        ...
        *0x1::vector::borrow_mut<bool>(&mut arg0.folded, 1) = false;
        arg0.action_log = 0x1::vector::empty<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::ActionLogEntry>();
        ...
        if (v9 == 0) {
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v7 as u64) * 2) = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v8 as u64) * 2) = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v7 as u64) * 2 + 1) = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
            *0x1::vector::borrow_mut<u8>(&mut arg0.hole_cards, (v8 as u64) * 2 + 1) = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::draw_card(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter);
        } else {
            let (v10, v11) = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::deck::deal_preflop_pressure_runout(&mut arg0.deck, &v6, v5, &mut arg0.entropy_counter, v7, v9);
            arg0.hole_cards = v10;
            arg0.scheduled_board = v11;
        };
        post_blind(arg0, v7, v2);
        post_blind(arg0, v8, v3);
        emit_engine_action_taken(arg0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::engine_action_deal_hand(), 0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner(), false, false, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner());
    ...
    fun transition_after_hand(arg0: &mut Match, arg1: 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::HandSummary, arg2: &0x2::tx_context::TxContext, arg3: u8) {
        emit_engine_action_taken(arg0, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::engine_action_complete_hand(), 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::hs_pot(&arg1), 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::hs_ended_by(&arg1), 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::hs_winner_0(&arg1), 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::hs_winner_1(&arg1), 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner());
        0x1::vector::push_back<0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::HandSummary>(&mut arg0.hand_summaries, arg1);
        let v0 = terminal_winner_after_hand(arg0);
        if (v0 != 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::no_winner()) {
