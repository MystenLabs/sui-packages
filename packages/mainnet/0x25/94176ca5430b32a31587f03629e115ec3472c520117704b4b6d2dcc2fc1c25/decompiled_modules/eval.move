module 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::eval {
    ...
    public fun evaluate_five(arg0: &vector<u8>) : HandRank {
        ...
        while (v3 < 5) {
            ...
            let v5 = 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::card_rank(v4);
            0x1::vector::push_back<u8>(&mut v1, v5);
            0x1::vector::push_back<u8>(&mut v2, 0x2594176ca5430b32a31587f03629e115ec3472c520117704b4b6d2dcc2fc1c25::types::card_suit(v4));
