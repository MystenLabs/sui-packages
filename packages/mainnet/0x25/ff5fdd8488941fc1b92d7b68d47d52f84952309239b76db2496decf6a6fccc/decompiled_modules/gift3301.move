module 0x25ff5fdd8488941fc1b92d7b68d47d52f84952309239b76db2496decf6a6fccc::gift3301 {
    struct GIFT3301 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift3301(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT3301, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3301>(arg0, arg1);
