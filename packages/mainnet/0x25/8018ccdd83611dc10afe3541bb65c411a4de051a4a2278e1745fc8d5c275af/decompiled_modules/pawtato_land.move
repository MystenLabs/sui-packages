module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    public fun check_version(arg0: &StakingPool) {
        assert!(arg0.version == 7, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors::error_code_version_mismatch());
    }
    ...
    fun maybe_raffle(arg0: &mut StakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg2: u64, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3, v4, v5, v6, v7) = if (arg2 < v1.last_raffle_ts + 86400000) {
            ...
            let v8 = get_shovel_urr_chance_from_staked_items(arg0, &v1.items);
            let (v9, v10) = get_gilded_prism_boost(arg0, v0, arg2);
            let v11 = if (v8 > 0) {
                v10 / 4
            } else {
                v10 / 2
            };
            (true, get_lands_without_cooldown_count(&v1.lands), get_idol_raffle_boost_from_staked_items(arg0, &v1.items), v8, v9, v11)
        };
        if (!v2) {
            return
        };
        0x2::table::borrow_mut<address, UserInfo>(&mut arg0.users, v0).last_raffle_ts = arg2;
        let v12 = 0x2::random::new_generator(arg3, arg4);
        let v13 = 0x2::random::generate_u128(&mut v12) % 1000000;
        let v14 = RaffleStarted{
            user : 0x2::tx_context::sender(arg4),
            roll : v13,
        };
        0x2::event::emit<RaffleStarted>(v14);
        let v15 = v7 * 10000;
        let v16 = (17 * v3 * v4 + v6 * 10000) / 10000;
        let v17 = (270 * v3 * v4 + v15) / 10000;
        let v18 = (270 * v3 * v4 + v15) / 10000;
        if (v13 < v16) {
            let v19 = 1 * 1000000000;
            mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_phoenix_feather(), v19, arg4);
            let v20 = WonRareResource{
                user     : 0x2::tx_context::sender(arg4),
            ...
            0x2::event::emit<WonRareResource>(v20);
            let v21 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v21, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x6e82bb8cbed21683ac0109171135b4d75187fc74749593163f3dc426ef3b32b4::pawtato_coin_phoenix_feather::PAWTATO_COIN_PHOENIX_FEATHER>());
            let v22 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v22, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v19));
            let v23 = ResourcesProduced{
                user      : 0x2::tx_context::sender(arg4),
                resources : v21,
                amounts   : v22,
            };
            0x2::event::emit<ResourcesProduced>(v23);
        } else if (v13 < v16 + v17) {
            let v24 = 1 * 1000000000;
            mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_titanium_splinter(), v24, arg4);
            let v25 = WonRareResource{
                user     : 0x2::tx_context::sender(arg4),
            ...
            0x2::event::emit<WonRareResource>(v25);
            let v26 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v26, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0x30021448e6d54825ced6d2b73f3b763a0da8a28c1c42fd6f0b864323ac60ab45::pawtato_coin_titanium_splinter::PAWTATO_COIN_TITANIUM_SPLINTER>());
            let v27 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v27, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v24));
            let v28 = ResourcesProduced{
                user      : 0x2::tx_context::sender(arg4),
                resources : v26,
                amounts   : v27,
            };
            0x2::event::emit<ResourcesProduced>(v28);
        } else if (v13 < v16 + v17 + v18) {
            let v29 = 1 * 1000000000;
            mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_chaos_seed(), v29, arg4);
            let v30 = WonRareResource{
                user     : 0x2::tx_context::sender(arg4),
            ...
            0x2::event::emit<WonRareResource>(v30);
            let v31 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v31, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xecc04712d7513fe9e9b27bb7366ded7c0acc78746c06276bc9fe8d17fc14061f::pawtato_coin_chaos_seed::PAWTATO_COIN_CHAOS_SEED>());
            let v32 = 0x1::vector::empty<0x1::string::String>();
            0x1::vector::push_back<0x1::string::String>(&mut v32, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v29));
            let v33 = ResourcesProduced{
                user      : 0x2::tx_context::sender(arg4),
                resources : v31,
                amounts   : v32,
            };
            0x2::event::emit<ResourcesProduced>(v33);
        } else if (v5 > 0) {
            let v34 = v16 + v17 + v18;
            if (v13 < v34 + v5 * v3 * v4 / 10000 / 2) {
                let v35 = 1 * 1000000000;
                mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_dawnstone(), v35, arg4);
                let v36 = WonRareResource{
                    user     : 0x2::tx_context::sender(arg4),
                ...
                0x2::event::emit<WonRareResource>(v36);
                let v37 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v37, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xaf5981f9bee15d210e25f2933671ed587a810ed8cb8819d05fa967f2d4913ff::pawtato_coin_dawnstone::PAWTATO_COIN_DAWNSTONE>());
                let v38 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v38, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v35));
                let v39 = ResourcesProduced{
                    user      : 0x2::tx_context::sender(arg4),
                    resources : v37,
                    amounts   : v38,
                };
                0x2::event::emit<ResourcesProduced>(v39);
            } else if (v13 < v34 + v5 * v3 * v4 / 10000) {
                let v40 = 1 * 1000000000;
                mint_resource(arg0, arg1, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::resource_type_primal_loam(), v40, arg4);
                let v41 = WonRareResource{
                    user     : 0x2::tx_context::sender(arg4),
                ...
                0x2::event::emit<WonRareResource>(v41);
                let v42 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v42, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::get_coin_type_string_with_0x<0xcc1bc09171bf5cff318ffa804077cbd47504d9ae0f2436d248dc6b9edc4556e4::pawtato_coin_primal_loam::PAWTATO_COIN_PRIMAL_LOAM>());
                let v43 = 0x1::vector::empty<0x1::string::String>();
                0x1::vector::push_back<0x1::string::String>(&mut v43, 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u128_to_string(v40));
                let v44 = ResourcesProduced{
                    user      : 0x2::tx_context::sender(arg4),
                    resources : v42,
                    amounts   : v43,
                };
                0x2::event::emit<ResourcesProduced>(v44);
            };
        };
    }
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 7, 13906836661129445375);
        arg1.version = 7;
