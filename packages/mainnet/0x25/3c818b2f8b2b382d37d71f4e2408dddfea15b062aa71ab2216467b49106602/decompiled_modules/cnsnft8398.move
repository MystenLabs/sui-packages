module 0x253c818b2f8b2b382d37d71f4e2408dddfea15b062aa71ab2216467b49106602::cnsnft8398 {
    struct CNSNFT8398 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8398, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9970"));
        let v4 = 0x2::package::claim<CNSNFT8398>(arg0, arg1);
