module 0x25fab4108347f348ed82cc5fc4dd22be248cfd704a2bfeb63bb52df26f8278c2::mermaid {
    ...
    struct Mermaid has store, key {
        ...
        number: u64,
        attributes: 0x25fab4108347f348ed82cc5fc4dd22be248cfd704a2bfeb63bb52df26f8278c2::attributes::Attributes,
    }
    ...
    fun init(arg0: MERMAID, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x25fab4108347f348ed82cc5fc4dd22be248cfd704a2bfeb63bb52df26f8278c2::collection::display(&v4, arg1);
        ...
        0x2::transfer::public_share_object<0x25fab4108347f348ed82cc5fc4dd22be248cfd704a2bfeb63bb52df26f8278c2::collection::Collection>(0x25fab4108347f348ed82cc5fc4dd22be248cfd704a2bfeb63bb52df26f8278c2::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: u64, arg1: vector<0x1::ascii::String>, arg2: vector<0x1::ascii::String>, arg3: &mut 0x2::tx_context::TxContext) : Mermaid {
        let v0 = Mermaid{
            ...
            number      : arg0,
            attributes  : 0x25fab4108347f348ed82cc5fc4dd22be248cfd704a2bfeb63bb52df26f8278c2::attributes::new_from_vec(arg1, arg2),
        };
    ...
    public(friend) fun mint_special_nft(arg0: u64, arg1: vector<u8>, arg2: vector<0x1::ascii::String>, arg3: vector<0x1::ascii::String>, arg4: &mut 0x2::tx_context::TxContext) : Mermaid {
        Mermaid{
            ...
            project_url : 0x2::url::new_unsafe_from_bytes(b"https://atlansui.xyz/"),
            number      : arg0,
            attributes  : 0x25fab4108347f348ed82cc5fc4dd22be248cfd704a2bfeb63bb52df26f8278c2::attributes::new_from_vec(arg2, arg3),
        }
    }
