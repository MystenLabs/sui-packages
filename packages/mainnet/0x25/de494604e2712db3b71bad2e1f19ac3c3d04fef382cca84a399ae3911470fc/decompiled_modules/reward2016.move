module 0x25de494604e2712db3b71bad2e1f19ac3c3d04fef382cca84a399ae3911470fc::reward2016 {
    struct REWARD2016 has drop {
        dummy_field: bool,
    }

    struct TICKET_2016 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2016(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2016>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2016>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2016, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2016>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2016>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2016>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2016>>(v5, 0x2::tx_context::sender(arg1));
    }
