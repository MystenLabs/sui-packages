module 0x258655b04bfabf6a91fa4fdc81ffeec3fce04f55e927b8058631b4ec4297adab::merkle_proof {
    ...
    fun hash_pair(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
        if (0x258655b04bfabf6a91fa4fdc81ffeec3fce04f55e927b8058631b4ec4297adab::vectors::lt(&arg0, &arg1)) {
    ...
    fun process_multi_proof(arg0: &vector<vector<u8>>, arg1: &vector<bool>, arg2: &vector<vector<u8>>) : vector<u8> {
        ...
        assert!(v0 + 0x1::vector::length<vector<u8>>(arg0) - 1 == v1, 65536);
    ...
    public fun process_proof(arg0: &vector<vector<u8>>, arg1: vector<u8>) : vector<u8> {
        let v0 = arg1;
        let v1 = 0;
