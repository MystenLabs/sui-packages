module 0x25ca791a32cb6a2d76a9a830da42e7e2c67ea6799fbcd62a9f31b1c361c62096::cnsnft7604 {
    struct CNSNFT7604 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7604, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7604>(arg0, arg1);
