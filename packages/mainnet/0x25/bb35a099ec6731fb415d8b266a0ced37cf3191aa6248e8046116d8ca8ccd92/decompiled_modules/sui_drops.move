module 0x25bb35a099ec6731fb415d8b266a0ced37cf3191aa6248e8046116d8ca8ccd92::sui_drops {
    ...
    fun init(arg0: SUI_DROPS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Sui Blue Chip "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://jfnnwAiFZeE5R-oZevlI7-TiMqjxArWk0QdwOeNwt2g"));
