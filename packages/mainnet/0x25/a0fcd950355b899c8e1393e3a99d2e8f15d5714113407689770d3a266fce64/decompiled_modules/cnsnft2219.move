module 0x25a0fcd950355b899c8e1393e3a99d2e8f15d5714113407689770d3a266fce64::cnsnft2219 {
    struct CNSNFT2219 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2219, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2219>(arg0, arg1);
