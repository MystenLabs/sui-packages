module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick {
    ...
    public fun borrow_tick_for_swap(arg0: &TickManager, arg1: u64, arg2: bool) : (&Tick, 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::option_u64::OptionU64) {
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list::contains<Tick>(&arg0.ticks, arg1), 3);
    ...
    public fun fetch_ticks(arg0: &TickManager, arg1: vector<u32>, arg2: u64) : vector<Tick> {
        ...
        let v1 = if (0x1::vector::is_empty<u32>(&arg1)) {
            ...
            let v2 = tick_score(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(*0x1::vector::borrow<u32>(&arg1, 0)));
            assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::skip_list::contains<Tick>(&arg0.ticks, v2), 3);
