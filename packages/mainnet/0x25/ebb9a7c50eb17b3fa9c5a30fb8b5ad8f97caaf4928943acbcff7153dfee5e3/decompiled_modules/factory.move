module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory {
    ...
    public(friend) fun create_pool_v3_<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pools, arg2: u32, arg3: u128, arg4: 0x1::string::String, arg5: u32, arg6: u32, arg7: 0x2::coin::Coin<T0>, arg8: 0x2::coin::Coin<T1>, arg9: u64, arg10: u64, arg11: bool, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::checked_package_version(arg0);
        assert!(is_allowed_coin_v2<T0>(arg1), 12);
        assert!(is_allowed_coin_v2<T1>(arg1), 12);
        let v0 = create_pool_internal<T0, T1>(arg1, arg0, arg2, arg3, arg4, arg12, arg13);
        let v1 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T0, T1>(arg0, &mut v0, arg5, arg6, arg13);
        let v2 = if (arg11) {
            arg9
        } else {
            arg10
        };
        let v3 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg0, &mut v0, &mut v1, v2, arg11, arg12);
        ...
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T0, T1>(arg0, &mut v0, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg7, v4, arg13)), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg8, v5, arg13)), v3);
    ...
    public fun in_allowed_list<T0>(arg0: &Pools) : bool {
        assert!(0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"deny_coin_list")), 20);
        0x2::table::contains<0x1::type_name::TypeName, bool>(&0x2::dynamic_object_field::borrow<0x1::string::String, DenyCoinList>(&arg0.id, 0x1::string::utf8(b"deny_coin_list")).allowed_list, 0x1::type_name::with_defining_ids<T0>())
    }

    public fun in_denied_list<T0>(arg0: &Pools) : bool {
        assert!(0x2::dynamic_object_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"deny_coin_list")), 20);
        0x2::table::contains<0x1::type_name::TypeName, bool>(&0x2::dynamic_object_field::borrow<0x1::string::String, DenyCoinList>(&arg0.id, 0x1::string::utf8(b"deny_coin_list")).denied_list, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    public entry fun init_manager_and_whitelist(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut Pools, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u32>>(&v0.allowed_pair_config, 0x1::type_name::with_defining_ids<0x2::sui::SUI>()), 24);
        0x2::table::add<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u32>>(&mut v0.allowed_pair_config, 0x1::type_name::with_defining_ids<0x2::sui::SUI>(), 0x2::vec_set::singleton<u32>(v1));
    ...
    public fun is_allowed_coin_v2<T0>(arg0: &mut Pools) : bool {
        in_allowed_list<T0>(arg0) || !in_denied_list<T0>(arg0)
    }
    ...
    fun register_permission_pair_internal<T0, T1>(arg0: &mut Pools, arg1: &PoolCreationCap, arg2: u32, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::type_name::with_defining_ids<T0>() == arg1.coin_type, 13);
    ...
    fun unregister_permission_pair_internal<T0, T1>(arg0: &mut Pools, arg1: &PoolCreationCap, arg2: u32) {
        ...
        let v4 = UnregisterPermissionPairEvent{
            ...
            pool_key     : v1,
            coin_type    : 0x1::string::from_ascii(0x1::type_name::into_string(arg1.coin_type)),
            coin_pair    : 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>())),
            tick_spacing : arg2,
        };
