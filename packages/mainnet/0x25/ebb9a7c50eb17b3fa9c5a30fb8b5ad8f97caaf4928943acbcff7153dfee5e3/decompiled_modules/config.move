module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config {
    ...
    public fun check_emergency_pause_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::acl::has_role(&arg0.acl, arg1, 5), 13);
    }
    ...
    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(14 >= arg0.package_version, 10);
    }
    ...
    public fun emergency_unpause(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(arg1 >= 0x2::dynamic_field::remove<vector<u8>, u64>(&mut arg0.id, b"emergency_pause_before"), 16);
