module 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position {
    ...
    public(friend) fun apply_liquidity_cut(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: vector<u128>) : u128 {
    ...
    public fun check_position_tick_range(arg0: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg1: 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32, arg2: u32) {
        let v0 = if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(arg0, arg1)) {
            if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::gte(arg0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_tick())) {
                if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lte(arg1, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::max_tick())) {
                    if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::mod(arg0, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(arg2)) == 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::zero()) {
                        0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::mod(arg1, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from(arg2)) == 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::zero()
                    } else {
                        false
                    }
                } else {
    ...
    public fun fetch_positions(arg0: &PositionManager, arg1: vector<0x2::object::ID>, arg2: u64) : vector<PositionInfo> {
        if (arg2 == 0) {
            return 0x1::vector::empty<PositionInfo>()
        };
        ...
        let v1 = if (0x1::vector::is_empty<0x2::object::ID>(&arg1)) {
            ...
            assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, v2), 6);
            0x1::option::some<0x2::object::ID>(v2)
        };
        let v3 = v1;
        let v4 = 0;
        while (0x1::option::is_some<0x2::object::ID>(&v3)) {
            let v5 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_node<0x2::object::ID, PositionInfo>(&arg0.positions, *0x1::option::borrow<0x2::object::ID>(&v3));
            v3 = 0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::next<0x2::object::ID, PositionInfo>(v5);
            0x1::vector::push_back<PositionInfo>(&mut v0, *0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::borrow_value<0x2::object::ID, PositionInfo>(v5));
            let v6 = v4 + 1;
            v4 = v6;
            if (v6 == arg2) {
                break
    ...
    public(friend) fun remove_position_info_for_restore(arg0: &mut PositionManager, arg1: 0x2::object::ID) {
        assert!(0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 6);
        0xbe21a06129308e0495431d12286127897aff07a8ade3970495a4404d97f9eaaa::linked_table::remove<0x2::object::ID, PositionInfo>(&mut arg0.positions, arg1);
    }
    ...
    public fun set_display(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::package::from_module<Position>(arg1), 11);
        update_display_internal(arg1, arg2, arg3, arg4, arg5, arg6);
    }
    ...
    fun update_fee_internal(arg0: &mut PositionInfo, arg1: u128, arg2: u128) {
        let v0 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_shr(arg0.liquidity, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg1, arg0.fee_growth_inside_a), 64);
        assert!(v0 <= 18446744073709551615, 1);
        let v1 = (v0 as u64);
        let v2 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_shr(arg0.liquidity, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(arg2, arg0.fee_growth_inside_b), 64);
        assert!(v2 <= 18446744073709551615, 1);
        let v3 = (v2 as u64);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(arg0.fee_owned_a, v1), 1);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(arg0.fee_owned_b, v3), 1);
        ...
        if (v0 > 0) {
            ...
            while (v1 < v0) {
                ...
                if (0x1::vector::length<PositionReward>(&arg0.rewards) > v1) {
                    ...
                    let v4 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_shr(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u128::wrapping_sub(v2, v3.growth_inside), arg0.liquidity, 64);
                    assert!(v4 <= 18446744073709551615, 2);
                    let v5 = (v4 as u64);
                    assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::math_u64::add_check(v3.amount_owned, v5), 2);
                    v3.growth_inside = v2;
                    v3.amount_owned = v3.amount_owned + v5;
                } else {
                    let v6 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_shr(v2, arg0.liquidity, 64);
                    assert!(v6 <= 18446744073709551615, 2);
