module 0x228b8c174f281b87bc31f98597f877b95cdd3af3c7c54011b126acc0f5d79c48::reward7115 {
    struct REWARD7115 has drop {
        dummy_field: bool,
    }

    struct TICKET_7115 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7115(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7115>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7115>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7115, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7115>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7115>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7115>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7115>>(v5, 0x2::tx_context::sender(arg1));
    }
