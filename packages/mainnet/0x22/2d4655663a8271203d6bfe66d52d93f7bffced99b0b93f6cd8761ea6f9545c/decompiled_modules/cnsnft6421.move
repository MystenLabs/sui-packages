module 0x222d4655663a8271203d6bfe66d52d93f7bffced99b0b93f6cd8761ea6f9545c::cnsnft6421 {
    struct CNSNFT6421 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6421, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6421>(arg0, arg1);
