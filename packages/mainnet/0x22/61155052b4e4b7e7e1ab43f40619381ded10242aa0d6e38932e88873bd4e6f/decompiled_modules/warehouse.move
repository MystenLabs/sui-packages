module 0x2261155052b4e4b7e7e1ab43f40619381ded10242aa0d6e38932e88873bd4e6f::warehouse {
    ...
    public fun add_card_template_to_pack(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: u64) {
        ...
        assert!(0x2::vec_map::contains<0x2::object::ID, CardTemplate>(&arg1.card_templates, &arg3), 10003);
    ...
    public(friend) fun borrow_card_template(arg0: &mut Warehouse, arg1: 0x2::object::ID) : &mut CardTemplate {
        assert!(0x2::vec_map::contains<0x2::object::ID, CardTemplate>(&arg0.card_templates, &arg1), 10003);
    ...
    public fun delete_card_template(arg0: &AdminCap, arg1: &mut Warehouse, arg2: 0x2::object::ID) {
        assert!(is_admincap_valid(arg1, arg0), 10006);
        assert!(0x2::vec_map::contains<0x2::object::ID, CardTemplate>(&arg1.card_templates, &arg2), 10003);
