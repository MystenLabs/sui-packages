module 0x22a69d453ef07fe265c38768de24e685f808363e9a1ab432b899bb32f118014c::ll {
    struct LL has drop {
        dummy_field: bool,
    }
    ...
    public entry fun transfer(arg0: 0x2::coin::Coin<LL>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<LL>>(arg0, arg1);
    }

    fun init(arg0: LL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LL>(arg0, 9, b"LL", b"LOL", b"LOL", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"F")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<LL>(&mut v2, 5000000000, v3, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<LL>>(v2, v3);
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<LL>>(v1);
    }
