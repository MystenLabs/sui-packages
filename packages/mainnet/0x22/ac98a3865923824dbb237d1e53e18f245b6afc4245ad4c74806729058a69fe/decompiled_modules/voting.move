module 0x22ac98a3865923824dbb237d1e53e18f245b6afc4245ad4c74806729058a69fe::voting {
    ...
    public entry fun create_vote(arg0: &mut 0x22ac98a3865923824dbb237d1e53e18f245b6afc4245ad4c74806729058a69fe::launchpadINO::LaunchpadINO, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == 0x22ac98a3865923824dbb237d1e53e18f245b6afc4245ad4c74806729058a69fe::launchpadINO::get_admin(), 0);
        ...
        0x22ac98a3865923824dbb237d1e53e18f245b6afc4245ad4c74806729058a69fe::launchpadINO::update_vote_id(arg0, v3);
    ...
    public entry fun update_vote(arg0: &mut Vote, arg1: u64, arg2: u64, arg3: u8, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == 0x22ac98a3865923824dbb237d1e53e18f245b6afc4245ad4c74806729058a69fe::launchpadINO::get_admin(), 0);
        arg0.status = arg3;
