module 0x22531dc739e87b97e5c7410685d843fa22f7a6c884b3977bb16265eb90c0519c::fuck_sui {
    ...
    fun init(arg0: FUCK_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Capy Rotten Zombie"));
        ...
        let v6 = Collection{
            ...
            name         : 0x1::string::utf8(b"Fuck Sui"),
    ...
    public entry fun mint_nft(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: vector<u8>, arg3: &mut Collection, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        loop {
            ...
            0x1::string::append(&mut v3, 0x1::string::utf8(num_to_str(3)));
