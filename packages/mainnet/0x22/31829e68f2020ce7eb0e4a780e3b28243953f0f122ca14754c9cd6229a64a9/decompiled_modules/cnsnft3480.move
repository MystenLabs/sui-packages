module 0x2231829e68f2020ce7eb0e4a780e3b28243953f0f122ca14754c9cd6229a64a9::cnsnft3480 {
    struct CNSNFT3480 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3480, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3480>(arg0, arg1);
