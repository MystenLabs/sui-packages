module 0x22e27307be128bc4b84cf12f791d87e4f67dff143fd8ca56f4153c5119673163::souk_test_nft {
    ...
    public entry fun register_transfer_policy(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::transfer_policy::new<SoukTestNFT>(arg0, arg1);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<SoukTestNFT>>(v0);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<SoukTestNFT>>(v1, 0x2::tx_context::sender(arg1));
    }
