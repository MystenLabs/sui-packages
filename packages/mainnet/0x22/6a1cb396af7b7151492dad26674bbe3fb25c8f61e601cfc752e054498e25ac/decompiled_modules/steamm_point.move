module 0x226a1cb396af7b7151492dad26674bbe3fb25c8f61e601cfc752e054498e25ac::steamm_point {
    ...
    fun init(arg0: STEAMM_POINT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<STEAMM_POINT>(arg0, 6, b"SPOINT", b"Steamm Points", b"Steamm Points", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suilend-assets.s3.us-east-2.amazonaws.com/steamm/STEAMM%20Points.svg")), arg1);
