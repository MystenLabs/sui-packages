module 0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::stonker {
    ...
    fun check_sender(arg0: &Stonker, arg1: &0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.parameters_id == 0x2::object::id<0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters>(arg1), 13906834943142526975);
        0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::check_sender(arg1, arg2);
    }
    ...
    public fun create_stonker(arg0: bool, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg0) {
            0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::production_stonker_parameters(arg1)
        } else {
            0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::staging_stonker_parameters(arg1)
        };
        let v1 = v0;
        let v2 = Stonker{
            id                                   : 0x2::object::new(arg1),
            parameters_id                        : 0x2::object::id<0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters>(&v1),
            next_signal_index                    : 0,
        ...
        0x2::transfer::public_share_object<0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters>(v1);
    }
    ...
    fun ensure_gas_coin_is_funded(arg0: &Stonker, arg1: &0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        if (0x2::coin::value<0x2::sui::SUI>(arg3) >= 0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::minimum_amount_in_gas_coin(arg1)) {
            return
        };
        let v0 = 0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::target_amount_in_gas_coin(arg1) - 0x2::coin::value<0x2::sui::SUI>(arg3);
        let v1 = v0;
    ...
    public fun input_signal(arg0: &mut Stonker, arg1: &0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg6: &0x2::clock::Clock, arg7: u64, arg8: u64, arg9: u8, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_book::get_order_book_without_our_orders(arg1, arg4, &v1, 8, arg6);
        let v3 = 0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_manager::create_order_manager(v1, arg6);
        let v4 = InputSignalEvent{
            ...
            best_dex_bids                 : *0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_book::bid_prices(&v2),
            best_dex_bid_quantities       : *0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_book::bid_quantities(&v2),
            best_dex_asks                 : *0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_book::ask_prices(&v2),
            best_dex_ask_quantities       : *0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_book::ask_quantities(&v2),
            dex_spread                    : 0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_book::best_ask(&v2) - 0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_book::best_bid(&v2),
        ...
        0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::order_manager::adjust_maker_orders(&mut v3, arg1, arg3, &v0, arg4, arg6, arg0.latest_estimated_valuation, arg0.latest_maker_volatility_bps_times_1k, &v2, arg12);
        if (arg9 == 0 || arg9 == 1) {
            0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::taker::try_make_taker_trade(arg1, &mut v3, arg3, arg4, &v0, arg5, arg6, arg0.latest_estimated_valuation, arg9 == 0, &v2, &mut arg0.last_trade_time_ms, arg12);
        };
    }

    public fun kill_all_orders(arg0: &mut Stonker, arg1: &0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg4: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &0x2::clock::Clock, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public fun make_limit_maker_buy(arg0: &Stonker, arg1: &0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        check_sender(arg0, arg1, arg7);
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg2, arg7);
    ...
    public fun make_limit_sell(arg0: &Stonker, arg1: &0x22faf0f671a6ed5035a3d9e70a06d532e05106187057e14fc6667854360ec50a::parameters::Parameters, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        check_sender(arg0, arg1, arg7);
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg2, arg7);
