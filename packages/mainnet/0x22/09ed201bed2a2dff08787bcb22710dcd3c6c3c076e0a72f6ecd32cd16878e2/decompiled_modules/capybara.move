module 0x2209ed201bed2a2dff08787bcb22710dcd3c6c3c076e0a72f6ecd32cd16878e2::capybara {
    ...
    fun init(arg0: CAPYBARA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<CAPYBARA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CAPYBARA")))), trim_right(b"#1 chill animal                 "), trim_right(b"As time passes, a lot of meme coins rise... But only $GNOME must rule them all...                                                                                                                                                                                                                                               "), v2, arg1);
        let v5 = v3;
