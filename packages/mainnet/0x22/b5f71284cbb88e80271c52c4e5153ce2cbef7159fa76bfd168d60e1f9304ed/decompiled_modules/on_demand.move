module 0x22b5f71284cbb88e80271c52c4e5153ce2cbef7159fa76bfd168d60e1f9304ed::on_demand {
    ...
    fun init(arg0: ON_DEMAND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x22b5f71284cbb88e80271c52c4e5153ce2cbef7159fa76bfd168d60e1f9304ed::queue::new(x"963fead0d455c024345ec1c3726843693bbe6426825862a6d38ba9ccd8e5bd7c", 0x2::tx_context::sender(arg1), 0x1::string::utf8(b"Mainnet Guardian Queue"), 0, 0x2::tx_context::sender(arg1), 3, 157680000000, 0x2::object::id_from_address(@0x963fead0d455c024345ec1c3726843693bbe6426825862a6d38ba9ccd8e5bd7c), true, arg1);
        let v1 = State{
            id                   : 0x2::object::new(arg1),
            oracle_queue         : 0x22b5f71284cbb88e80271c52c4e5153ce2cbef7159fa76bfd168d60e1f9304ed::queue::new(x"86807068432f186a147cf0b13a30067d386204ea9d6c8b04743ac2ef010b0752", 0x2::tx_context::sender(arg1), 0x1::string::utf8(b"Mainnet Oracle Queue"), 0, 0x2::tx_context::sender(arg1), 3, 604800000, v0, false, arg1),
            guardian_queue       : v0,
