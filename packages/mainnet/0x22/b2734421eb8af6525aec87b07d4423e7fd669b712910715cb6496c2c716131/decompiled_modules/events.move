module 0x22b2734421eb8af6525aec87b07d4423e7fd669b712910715cb6496c2c716131::events {
    ...
    public(friend) fun emit_add_registry_event<T0>(arg0: vector<u8>, arg1: &0x2::tx_context::TxContext) {
        let v0 = AddRegistryEvent{
            ...
            xasset_type : 0x1::ascii::string(0x22b2734421eb8af6525aec87b07d4423e7fd669b712910715cb6496c2c716131::utils::type_to_bytes<T0>()),
            price_id    : arg0,
        };
