module 0x25f86586e21c3ef07ebae82af959373df3e3deee870a88e638b9f4e725d0065d::presale {
    ...
    fun new<T0>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : Presale<T0> {
        assert!(arg0 > 0, 4097);
        ...
        Presale<T0>{
            ...
            investments     : 0x2::table::new<address, u64>(arg8),
            is_private_sale : arg7,
            whitelist       : vector[],
        }
    }

    public fun admin_change_whitelist<T0>(arg0: &AdminCap, arg1: &mut Presale<T0>, arg2: address, arg3: bool) {
        if (arg3) {
            0x1::vector::push_back<address>(&mut arg1.whitelist, arg2);
            ...
            let (_, v2) = 0x1::vector::index_of<address>(&arg1.whitelist, &arg2);
    ...
    public fun admin_change_whitelist_vector<T0>(arg0: &AdminCap, arg1: &mut Presale<T0>, arg2: vector<address>) {
        arg1.whitelist = arg2;
    }

    public fun admin_config<T0>(arg0: &AdminCap, arg1: &mut Presale<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: bool) {
        update<T0>(arg1, arg4, arg2, arg3, arg5, arg6, arg7, arg8, arg9);
    }

    public fun admin_create<T0>(arg0: &AdminCap, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: bool, arg9: &mut 0x2::tx_context::TxContext) {
        share<T0>(new<T0>(arg3, arg1, arg2, arg4, arg5, arg6, arg7, arg8, arg9));
    }
    ...
    fun update<T0>(arg0: &mut Presale<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: bool) {
        assert!(arg1 > 0, 4097);
