module 0x22dda615442d48d817a4b69c344bf861c19e1990c7c97c53afbb92927e349fa3::reward1265 {
    struct REWARD1265 has drop {
        dummy_field: bool,
    }

    struct TICKET_1265 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1265(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1265>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1265>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1265, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1265>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1265>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1265>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1265>>(v5, 0x2::tx_context::sender(arg1));
    }
