module 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_factory {
    ...
    public fun accept_version(arg0: &mut FactoryRegistry, arg1: &FactoryAdminCap, arg2: &0x2::clock::Clock) {
        assert!(arg1.factory_id == 0x2::object::id<FactoryRegistry>(arg0), 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::unauthorized());
        assert_version(arg0);
        assert!(0x1::option::is_some<PendingVersion>(&arg0.pending_version), 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::factory_no_pending_version_change());
        let v0 = 0x1::option::extract<PendingVersion>(&mut arg0.pending_version);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 >= v0.timestamp + arg0.version_change_cooldown_secs, 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::factory_version_change_timelock_active());
    ...
    public fun propose_version(arg0: &mut FactoryRegistry, arg1: &FactoryAdminCap, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg1.factory_id == 0x2::object::id<FactoryRegistry>(arg0), 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::unauthorized());
        assert_version(arg0);
        assert!(arg2 != arg0.current_version, 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::factory_version_unchanged());
    ...
    public fun register_vault(arg0: &mut FactoryRegistry, arg1: &FactoryAdminCap, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) {
        ...
        0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_events::emit_factory_vault_created(0x2::object::id<FactoryRegistry>(arg0), arg2, arg0.vault_count, 0x2::clock::timestamp_ms(arg3));
    }
