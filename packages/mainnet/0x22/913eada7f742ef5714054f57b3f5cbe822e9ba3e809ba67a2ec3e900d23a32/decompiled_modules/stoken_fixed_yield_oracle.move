module 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_fixed_yield_oracle {
    ...
    public fun accept_cooldown<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.oracle_id == 0x2::object::id<FixedYieldOracle<T0>>(arg0), 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::unauthorized());
    ...
    public fun accept_yield_parameters<T0>(arg0: &mut FixedYieldOracle<T0>, arg1: &FixedYieldOracleManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::unauthorized());
        assert!(0x1::option::is_some<PendingYieldParams>(&arg0.pending_yield_params), 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::no_pending_fees_change());
        let v0 = 0x1::option::extract<PendingYieldParams>(&mut arg0.pending_yield_params);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.cooldown_secs, 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::fee_change_timelock_active());
    ...
    public fun create_fixed_yield_oracle<T0>(arg0: 0x2::object::ID, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (FixedYieldOracleAdminCap, FixedYieldOracleManagerCap) {
        ...
        assert!(arg3 > 0, 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::invalid_price());
        ...
        assert!(arg5 >= 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_math::min_cooldown_secs() && arg5 <= 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_math::max_cooldown_secs(), 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::invalid_argument());
    ...
    public fun update_vault_price_from_yield<T0, T1>(arg0: &mut FixedYieldOracle<T0>, arg1: &mut 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_vault::Vault<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.authority, 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::unauthorized());
        ...
        assert!(v0 > 0, 0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_errors::invalid_price());
        0x22913eada7f742ef5714054f57b3f5cbe822e9ba3e809ba67a2ec3e900d23a32::stoken_vault::update_price_from_oracle_service<T0, T1>(arg1, v0, arg2);
