module 0x22b48433eef3a8a11670d550668fcac8307f1e4d68b2102c5e36a2f46e6c5de0::last_alive {
    ...
    public entry fun add_batch_direct_token_rewards<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<T0>, arg3: vector<u64>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.owner, 4);
        let v0 = 0;
        let v1 = 0x1::vector::length<u64>(&arg3);
        let v2 = 0;
        while (v2 < v1) {
            v0 = v0 + *0x1::vector::borrow<u64>(&arg3, v2);
            v2 = v2 + 1;
        };
        assert!(0x2::coin::value<T0>(&arg2) >= v0, 0);
        let v3 = create_token_marker(arg4);
        let v4 = v3.token_type;
        let v5 = arg0.current_round;
        if (!0x2::dynamic_field::exists_<TokenStoreMarker>(&arg1.id, v3)) {
            0x2::dynamic_field::add<TokenStoreMarker, 0x2::balance::Balance<T0>>(&mut arg1.id, v3, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, v0, arg5)));
        } else {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<TokenStoreMarker, 0x2::balance::Balance<T0>>(&mut arg1.id, v3), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, v0, arg5)));
        };
        v2 = 0;
        while (v2 < v1) {
            ...
            if (v6 > 0) {
                ...
                if (!0x2::table::contains<u64, vector<TokenReward>>(&arg1.pending_token_rewards, v5)) {
                    0x2::table::add<u64, vector<TokenReward>>(&mut arg1.pending_token_rewards, v5, 0x1::vector::empty<TokenReward>());
                };
                0x1::vector::push_back<TokenReward>(0x2::table::borrow_mut<u64, vector<TokenReward>>(&mut arg1.pending_token_rewards, v5), v7);
    ...
    public entry fun add_batch_token_rewards<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<T0>, arg3: vector<u64>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < v1) {
            ...
            if (v4 > 0) {
                ...
                if (!0x2::table::contains<u64, vector<TokenReward>>(&arg1.pending_token_rewards, v3)) {
                    0x2::table::add<u64, vector<TokenReward>>(&mut arg1.pending_token_rewards, v3, 0x1::vector::empty<TokenReward>());
                };
                0x1::vector::push_back<TokenReward>(0x2::table::borrow_mut<u64, vector<TokenReward>>(&mut arg1.pending_token_rewards, v3), v5);
                let v6 = TokenWrapper<T0>{
                    id      : 0x2::object::new(arg4),
                    balance : 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, v4, arg4)),
                    game_id : 0x2::object::uid_to_inner(&arg1.id),
                    round   : v3,
                    amount  : v4,
                };
                if (!0x2::table::contains<u64, vector<0x2::object::ID>>(&arg1.pending_token_wrappers, v3)) {
                    0x2::table::add<u64, vector<0x2::object::ID>>(&mut arg1.pending_token_wrappers, v3, 0x1::vector::empty<0x2::object::ID>());
                };
                0x1::vector::push_back<0x2::object::ID>(0x2::table::borrow_mut<u64, vector<0x2::object::ID>>(&mut arg1.pending_token_wrappers, v3), 0x2::object::uid_to_inner(&v6.id));
                0x2::transfer::share_object<TokenWrapper<T0>>(v6);
            };
            v2 = v2 + 1;
        };
        if (0x2::coin::value<T0>(&arg2) > 0) {
    ...
    public entry fun add_direct_token_reward<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.owner, 4);
        assert!(0x2::coin::value<T0>(&arg2) >= arg3, 0);
        let v0 = arg0.current_round;
        let v1 = create_token_marker(arg4);
        let v2 = v1.token_type;
        if (!0x2::dynamic_field::exists_<TokenStoreMarker>(&arg1.id, v1)) {
            0x2::dynamic_field::add<TokenStoreMarker, 0x2::balance::Balance<T0>>(&mut arg1.id, v1, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg5)));
        } else {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<TokenStoreMarker, 0x2::balance::Balance<T0>>(&mut arg1.id, v1), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg5)));
        };
        let v3 = TokenReward{
            token_type : v2,
            token_id   : 0x2::object::id<0x2::coin::Coin<T0>>(&arg2),
        ...
        0x1::vector::push_back<TokenReward>(0x2::table::borrow_mut<u64, vector<TokenReward>>(&mut arg1.pending_token_rewards, v0), v3);
        if (0x2::coin::value<T0>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0x2::tx_context::sender(arg5));
        } else {
            0x2::coin::destroy_zero<T0>(arg2);
        ...
        0x2::object::delete(0x2::object::new(arg5));
    }

    public entry fun add_direct_token_reward_simple<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 4);
        ...
        let v2 = create_token_marker(b"TOKEN");
        let v3 = v2.token_type;
        if (!0x2::dynamic_field::exists_<TokenStoreMarker>(&arg1.id, v2)) {
            0x2::dynamic_field::add<TokenStoreMarker, 0x2::balance::Balance<T0>>(&mut arg1.id, v2, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg4)));
        } else {
            0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<TokenStoreMarker, 0x2::balance::Balance<T0>>(&mut arg1.id, v2), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg4)));
        };
        let v4 = TokenReward{
            token_type : v3,
            token_id   : 0x2::object::id_from_address(@0x0),
            amount     : arg3,
        };
        if (!0x2::table::contains<u64, vector<TokenReward>>(&arg1.pending_token_rewards, v1)) {
            0x2::table::add<u64, vector<TokenReward>>(&mut arg1.pending_token_rewards, v1, 0x1::vector::empty<TokenReward>());
        };
        0x1::vector::push_back<TokenReward>(0x2::table::borrow_mut<u64, vector<TokenReward>>(&mut arg1.pending_token_rewards, v1), v4);
        if (0x2::coin::value<T0>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0x2::tx_context::sender(arg4));
        } else {
            0x2::coin::destroy_zero<T0>(arg2);
