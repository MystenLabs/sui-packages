module 0x2272b52cef5779e5488417ca9fcafdd148058135244d09d19af1296e636406d1::config {
    ...
    public(friend) fun new_uncorrelated_config(arg0: 0x1::ascii::String, arg1: u128, arg2: u128, arg3: u128, arg4: u128) : Config<Uncorrelated> {
        let v0 = Uncorrelated{
            target_adapter               : arg0,
            lower_trigger_price          : arg1,
            upper_trigger_price          : arg2,
            upper_trigger_price_scalling : arg3,
            lower_trigger_price_scalling : arg4,
        };
