module 0x2212d9f2ce69d09dea5c388d7a486d34791076f5874d4c7b10ce525daadd25e0::eason {
    ...
    struct EASON has drop {
        dummy_field: bool,
    }

    fun init(arg0: EASON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Eason"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Demo"));
        ...
        let v4 = 0x2::package::claim<EASON>(arg0, arg1);
