module 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::nft_auctionhouse {
    ...
    public fun accept_direct_nft_offer<T0: store + key, T1: store + key>(arg0: &mut NFT_Auctionhouse_Store, arg1: &mut 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: T1, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (T0, 0x2::coin::Coin<0x2::sui::SUI>) {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x2::clock::timestamp_ms(arg5);
        assert!(0x2::object::id<0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse>(arg1) == arg0.marketplace, 15);
        ...
        0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg4));
        let DirectNftOffer {
            id               : v12,
            offerer          : _,
            offered_nft_id   : _,
    ...
    public entry fun create_and_share_nft_auctionhouse_store(arg0: &0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_nft_auctionhouse(arg0: &0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : NFT_Auctionhouse_Store {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::is_admin(arg0, v0), 21);
        let v1 = 0x2::object::new(arg1);
        let v2 = NFT_Auctionhouse_Store{
            id                 : v1,
            marketplace        : 0x2::object::id<0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse>(arg0),
            deployer           : v0,
        ...
        let v3 = NFTAuctionhouseStoreCreated{
            ...
            marketplace_id : 0x2::object::id<0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse>(arg0),
            deployer       : v0,
        };
