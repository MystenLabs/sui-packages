module 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::kiosk_bidding_house_dynamic_coins {
    ...
    struct CompletedListing has store, key {
        id: 0x2::object::UID,
        listing_id: 0x2::object::ID,
        winner: address,
        nft_id: 0x2::object::ID,
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let (v27, v28) = 0x2::kiosk::purchase_with_cap<T0>(arg3, v11, 0x2::coin::zero<0x2::sui::SUI>(arg6));
        let v29 = v27;
        let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg4, v28);
        let v33 = CompletedListing{
            id              : 0x2::object::new(arg6),
            listing_id      : arg2,
            winner          : v3,
            nft_id          : 0x2::object::id<T0>(&v29),
            final_price     : v4,
            completed_at_ms : v1,
        };
        let v34 = 0x2::object::id<CompletedListing>(&v33);
        0x2::dynamic_object_field::add<0x2::object::ID, CompletedListing>(&mut arg0.id, v34, v33);
        0x2::dynamic_object_field::add<0x2::object::ID, T0>(&mut arg0.id, v34, v29);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v25, v26), arg6), 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::get_owner(arg1));
    ...
    public fun buyout_nft<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        assert!(!is_listing_expired(v3.expires_at_ms, arg6), 10);
        ...
        let v34 = v2 - v6;
        if (v34 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v34, arg7), v0);
        };
        let v35 = calculate_fee(v6, v7);
        let (v36, v37) = 0x2::kiosk::purchase_with_cap<T0>(arg3, v25, 0x2::coin::zero<0x2::sui::SUI>(arg7));
        0x2::object::delete(v21);
        let v38 = ListingCompleted{
            listing_id      : arg2,
            seller          : v9,
            winner          : v0,
            final_price     : v6,
        ...
        0x2::event::emit<ListingCompleted>(v38);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v35, arg7), 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::get_owner(arg1));
    ...
    public entry fun buyout_nft_entry<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        let (v4, v5) = buyout_nft<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg7, arg8);
        let v6 = v5;
    ...
    public entry fun claim_nft<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, CompletedListing>(&arg0.id, arg1), 5);
        let v1 = 0x2::dynamic_object_field::borrow<0x2::object::ID, CompletedListing>(&arg0.id, arg1);
        ...
        let CompletedListing {
            ...
            final_price     : _,
            completed_at_ms : _,
        } = 0x2::dynamic_object_field::remove<0x2::object::ID, CompletedListing>(&mut arg0.id, arg1);
        ...
        0x2::event::emit<NftClaimed>(v9);
        0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<0x2::object::ID, T0>(&mut arg0.id, arg1), v0);
    }
    ...
    public entry fun create_and_share_kiosk_bidding_store(arg0: &0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Kiosk_Bidding_Store>(create_kiosk_bidding_store(arg0, arg1));
    }

    public fun create_kiosk_bidding_store(arg0: &0x22842583da32b3db7cb127aaaa91087d71d5d54e98b0e1cd287cb8b21a64c7ce::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Bidding_Store {
    ...
    public fun get_system_limits() : (u64, u64, u16, u16, u64, u64) {
        (2592000000, 10000000, 1000, 2500, 604800000, 100000000000000000)
    }
