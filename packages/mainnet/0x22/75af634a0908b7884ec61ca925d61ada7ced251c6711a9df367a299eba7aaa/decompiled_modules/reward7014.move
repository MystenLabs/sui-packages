module 0x2275af634a0908b7884ec61ca925d61ada7ced251c6711a9df367a299eba7aaa::reward7014 {
    struct REWARD7014 has drop {
        dummy_field: bool,
    }

    struct TICKET_7014 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7014(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7014>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7014>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7014, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7014>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7014>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7014>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7014>>(v5, 0x2::tx_context::sender(arg1));
    }
