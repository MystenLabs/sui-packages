module 0x224f4cb17187809b26dcc29b97db94484c88344a16aaeb9141748ecd8d50f1aa::reward6764 {
    struct REWARD6764 has drop {
        dummy_field: bool,
    }

    struct TICKET_6764 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6764(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6764>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6764>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6764, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6764>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6764>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6764>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6764>>(v5, 0x2::tx_context::sender(arg1));
    }
