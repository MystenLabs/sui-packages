module 0x220b57aac1982feea49d9ff4ee9add016e7ce124d5a569ee271610900fbd269e::ipx_coin_standard {
    struct Witness {
        treasury: address,
    ...
    public fun add_burn_capability(arg0: &mut Witness, arg1: &mut IPXTreasuryStandard) {
    ...
    public fun destroy_witness(arg0: &mut IPXTreasuryStandard, arg1: Witness) {
        let Witness {
            treasury             : v0,
            name                 : _,
            mint_cap_address     : v2,
