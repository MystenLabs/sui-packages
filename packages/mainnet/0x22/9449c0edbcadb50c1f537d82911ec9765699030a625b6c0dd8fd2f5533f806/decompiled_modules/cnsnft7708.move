module 0x229449c0edbcadb50c1f537d82911ec9765699030a625b6c0dd8fd2f5533f806::cnsnft7708 {
    struct CNSNFT7708 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7708, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7708>(arg0, arg1);
