module 0x225ed123a794741b98c9881c43a272967a2233a0f994b5fe8f0402b8b29efab5::cnsnft1167 {
    struct CNSNFT1167 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1167, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1167>(arg0, arg1);
