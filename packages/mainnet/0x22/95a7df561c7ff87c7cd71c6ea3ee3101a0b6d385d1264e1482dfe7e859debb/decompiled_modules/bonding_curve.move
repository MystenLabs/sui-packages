module 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::bonding_curve {
    struct BondingCurve<phantom T0> has store, key {
        ...
        ended: bool,
        coin_metadata: 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::CoinMetadata,
        tick_spacing: u32,
        fee_rate: u64,
        end_sqrt_price: u128,
    ...
    public(friend) fun buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg7: 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::CoinMetadata, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::locked_coin::LockedCoin<T0>, 0x2::balance::Balance<0x2::sui::SUI>) {
        assert!(!arg0.ended, 3);
        ...
        let v14 = if (v13 >= arg0.lock_amount) {
            0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::locked_coin::zero<T0>(arg8)
        } else {
            ...
            v12 = v15;
            0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::locked_coin::from_balance<T0>(0x2::balance::split<T0>(&mut v11, v15), arg8)
        };
    ...
    public(friend) fun create_<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: &0x2::coin::CoinMetadata<T0>, arg2: u64, arg3: u64, arg4: u32, arg5: u64, arg6: u128, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        ...
        let v13 = BondingCurve<T0>{
            ...
            ended                      : false,
            coin_metadata              : 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata(v9, *0x1::ascii::as_bytes(&v12), 0x2::coin::get_decimals<T0>(arg1)),
            tick_spacing               : arg4,
            fee_rate                   : arg5,
            end_sqrt_price             : arg6,
    ...
    fun seed_to_dex<T0>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg1: &mut BondingCurve<T0>, arg2: 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::CoinMetadata, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        let v5 = 0x2::balance::value<T0>(&arg1.coin_vault);
        let v6 = *0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_symbol(&arg2);
        0x1::vector::append<u8>(&mut v6, b"-");
        0x1::vector::append<u8>(&mut v6, *0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_symbol(&arg1.coin_metadata));
        ...
        let (_, v11, _, _, v14, v15) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::create_pool_with_liquidity<0x2::sui::SUI, T0, 0x2::sui::SUI>(arg3, arg0, v6, b"", *0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_symbol(&arg2), 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_decimals(&arg2), *0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_url(&arg2), *0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_symbol(&arg1.coin_metadata), 0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_decimals(&arg1.coin_metadata), *0x2295a7df561c7ff87c7cd71c6ea3ee3101a0b6d385d1264e1482dfe7e859debb::utils::coin_metadata_url(&arg1.coin_metadata), arg1.tick_spacing, arg1.fee_rate, arg1.end_sqrt_price, 0x2::balance::split<0x2::sui::SUI>(&mut arg1.sui_vault, v1), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::neg_from(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v9))), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v9), v3, 0x2::balance::split<T0>(&mut arg1.coin_vault, v5), v5, false, arg4);
