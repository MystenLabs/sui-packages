module 0x22974775d5829ea508c2e08ab6b206529092c050342ee978299afbe360cb6404::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"testCoin", b"testCoin", b"testCoin", 0x1::option::none<0x2::url::Url>(), arg1);
