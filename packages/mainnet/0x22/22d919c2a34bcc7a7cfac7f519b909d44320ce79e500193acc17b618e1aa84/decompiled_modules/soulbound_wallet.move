module 0x2222d919c2a34bcc7a7cfac7f519b909d44320ce79e500193acc17b618e1aa84::soulbound_wallet {
    ...
    public fun create_soulbound_grow<T0, T1>(arg0: &mut 0x2::tx_context::TxContext) : SoulboundWallet<T0, T1> {
        ...
        0x2222d919c2a34bcc7a7cfac7f519b909d44320ce79e500193acc17b618e1aa84::events::soulbound_grow_created(0x2::object::id_address<SoulboundWallet<T0, T1>>(&v0), 0x1::type_name::get<T0>(), 0x1::type_name::get<T1>());
        v0
    }
    ...
    public fun deposit_growcoins_to_soulbound<T0, T1>(arg0: &mut SoulboundWallet<T0, T1>, arg1: 0x2::coin::Coin<T0>) {
        ...
        0x2222d919c2a34bcc7a7cfac7f519b909d44320ce79e500193acc17b618e1aa84::events::soulbound_grow_deposit(0x2::object::id_address<SoulboundWallet<T0, T1>>(arg0), 0x2::coin::value<T0>(&arg1));
    }
    ...
    public fun withdraw_growcoins_from_soulbound<T0, T1>(arg0: &mut SoulboundWallet<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2222d919c2a34bcc7a7cfac7f519b909d44320ce79e500193acc17b618e1aa84::events::soulbound_grow_withdraw(0x2::object::id_address<SoulboundWallet<T0, T1>>(arg0), arg1);
