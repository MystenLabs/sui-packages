module 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::bonding_curve {
    ...
    public fun start_bonding_curve_v2<T0, T1>(arg0: &mut 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::Configs, arg1: &mut BondingCurves, arg2: BondingCurveStartCapV2, arg3: 0x2::coin::TreasuryCap<T0>, arg4: &mut BondingCurve<T0>, arg5: 0x2::coin::Coin<T1>, arg6: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg7: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg8: &0x2::coin::CoinMetadata<T0>, arg9: &0x2::clock::Clock, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::coin::get_name<T0>(arg8);
        let v5 = 0x2::coin::get_symbol<T0>(arg8);
        assert!(!is_name_symbol_exist(arg1, v4, v5), 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::name_symbol_key_already_exists());
        0x2::table::add<0x2::object::ID, bool>(&mut arg1.name_symbol_registry, new_key_from_name_symbol(v4, v5), true);
        let (v6, _, v8) = verify_internal(arg0, 0x1::ascii::into_bytes(0x2::url::inner_url(0x1::option::borrow<0x2::url::Url>(&arg4.url))), &arg10);
        assert!(v8 + 300 >= 0x2::clock::timestamp_ms(arg9) / 1000, 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::signature_expired());
        assert!(v6, 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::invalid_signature());
        0x2::table::add<0x2::object::ID, bool>(&mut arg1.list, v1, true);
        ...
        let v9 = 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::init_fee<T1>(arg0);
        assert!(0x2::coin::value<T1>(&arg5) == v9, 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::incorrect_fee_amount());
        ...
        let (v10, v11, v12, v13) = 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::config::bonding_curve_config(arg0);
        0x2::balance::join<T0>(&mut arg4.balance, 0x2::coin::mint_balance<T0>(&mut arg3, v13));
        let v14 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::mint_pool_creation_cap<T0>(arg6, arg7, &mut arg3, arg11);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::register_permission_pair<T0, 0x2::sui::SUI>(arg6, arg7, 200, &v14, arg11);
        0x2::dynamic_object_field::add<0x1::string::String, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::PoolCreationCap>(&mut arg4.id, 0x1::string::utf8(b"ClmmPoolCreationCap"), v14);
        let (v15, v16) = 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::math::get_init_liquidity_from_sui(v10, v11, v12);
        assert!(v13 >= v16, 0x5f01358a165203a8e94970aacc3685ff776748f526ee813d91f3065b9a7648ba::errors::init_curve_config_error());
        arg4.start_sqrt_price = v10;
        arg4.current_sqrt_price = v10;
        arg4.end_sqrt_price = v11;
        arg4.liquidity = v15;
        arg4.status = 1;
