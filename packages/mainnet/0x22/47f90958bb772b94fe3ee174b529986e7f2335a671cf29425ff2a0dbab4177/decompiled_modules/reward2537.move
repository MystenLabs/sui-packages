module 0x2247f90958bb772b94fe3ee174b529986e7f2335a671cf29425ff2a0dbab4177::reward2537 {
    struct REWARD2537 has drop {
        dummy_field: bool,
    }

    struct TICKET_2537 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2537(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2537>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2537>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2537, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2537>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2537>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2537>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2537>>(v5, 0x2::tx_context::sender(arg1));
    }
