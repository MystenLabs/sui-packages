module 0x224b43a621bd56b98fc177d3da4ceddb9ab7ad3127cb999d8fc5cffa00888d40::vectors {
    public fun find_upper_bound(arg0: &vector<u64>, arg1: u64) : u64 {
        ...
        while (v0 < v1) {
            v1 = 0x224b43a621bd56b98fc177d3da4ceddb9ab7ad3127cb999d8fc5cffa00888d40::math::average(v0, v1);
    ...
    public fun gt(arg0: &vector<u8>, arg1: &vector<u8>) : bool {
        ...
        assert!(v1 == 0x1::vector::length<u8>(arg1), 65536);
        while (v0 < v1) {
