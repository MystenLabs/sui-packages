module 0x224b43a621bd56b98fc177d3da4ceddb9ab7ad3127cb999d8fc5cffa00888d40::nft {
    ...
    fun isWhitelist<T0>(arg0: &mut Phaser<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0x224b43a621bd56b98fc177d3da4ceddb9ab7ad3127cb999d8fc5cffa00888d40::merkle_proof::verify(&arg2, arg0.whitelist_merkle_root, 0x1::hash::sha2_256(0x2::bcs::to_bytes<Ticket>(&v0)))
    }
