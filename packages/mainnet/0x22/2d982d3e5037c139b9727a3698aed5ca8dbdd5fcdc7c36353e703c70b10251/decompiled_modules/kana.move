module 0x222d982d3e5037c139b9727a3698aed5ca8dbdd5fcdc7c36353e703c70b10251::kana {
    ...
    fun init(arg0: KANA, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<KANA>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"kana"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"kana "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiagqvjuu6bse37x7ezxbq477fvicuip7qhydj4a767mfpbhw76tvq"));
