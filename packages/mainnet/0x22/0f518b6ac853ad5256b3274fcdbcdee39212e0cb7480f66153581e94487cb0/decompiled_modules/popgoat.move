module 0x220f518b6ac853ad5256b3274fcdbcdee39212e0cb7480f66153581e94487cb0::popgoat {
    ...
    fun init(arg0: POPGOAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<POPGOAT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POPGOAT ")))), trim_right(b"Goatseus Poppimus               "), trim_right(b"Goatseus Poppimus                                                                                                                                                                                                                                                                                                               "), v2, arg1);
