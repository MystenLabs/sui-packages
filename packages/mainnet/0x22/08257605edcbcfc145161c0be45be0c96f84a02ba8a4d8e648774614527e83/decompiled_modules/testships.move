module 0x2208257605edcbcfc145161c0be45be0c96f84a02ba8a4d8e648774614527e83::testships {
    ...
    public fun update_attributes(arg0: &PubKey, arg1: &mut MintStats, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: vector<u8>, arg6: u8, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: 0x1::string::String, arg17: 0x1::string::String, arg18: u64) {
        ...
        0x1::vector::append<u8>(&mut v2, string_to_bytes_copy(&arg7));
        ...
        0x1::vector::append<u8>(&mut v2, 0x1::string::into_bytes(0x1::u64::to_string(arg12)));
        ...
        0x1::vector::append<u8>(&mut v2, string_to_bytes_copy(&arg16));
        0x1::vector::append<u8>(&mut v2, string_to_bytes_copy(&arg17));
        0x1::vector::append<u8>(&mut v2, 0x1::string::into_bytes(0x1::u64::to_string(arg18)));
        assert!(is_valid_hash_alg(arg6), 11);
        ...
        v1.health = arg15;
        v1.upgrades = arg16;
        v1.specialisation = arg17;
        let v3 = 0x1::string::utf8(b"Type");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v3)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v3) = clone_string(&v1.ship_type);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v3, clone_string(&v1.ship_type));
        };
        let v4 = 0x1::string::utf8(b"Rarity");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v4)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v4) = clone_string(&v1.rarity);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v4, clone_string(&v1.rarity));
        };
        let v5 = 0x1::string::utf8(b"Speed");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v5)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v5) = u64_to_string(arg12);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v5, u64_to_string(arg12));
        };
        let v6 = 0x1::string::utf8(b"Attack");
        ...
        let v7 = 0x1::string::utf8(b"Defence");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v7)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v7) = u64_to_string(arg14);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v7, u64_to_string(arg14));
        };
        let v8 = 0x1::string::utf8(b"Health");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v8)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v8) = u64_to_string(arg15);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v8, u64_to_string(arg15));
        };
        let v9 = 0x1::string::utf8(b"Upgrades");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v9)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v9) = clone_string(&v1.upgrades);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v9, clone_string(&v1.upgrades));
        };
        let v10 = 0x1::string::utf8(b"Specialisation");
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v10)) {
            *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v10) = clone_string(&v1.specialisation);
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v10, clone_string(&v1.specialisation));
        };
    }
    ...
    public fun upgrade(arg0: &UpgradeManager, arg1: vector<ShipNFT>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &Payout, arg4: &0x2::transfer_policy::TransferPolicy<ShipNFT>, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut Counter, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v30.attributes, 0x1::string::utf8(b"Speed"), u64_to_string(v30.speed));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v30.attributes, 0x1::string::utf8(b"Attack"), u64_to_string(v30.attack));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v30.attributes, 0x1::string::utf8(b"Defence"), u64_to_string(v30.defence));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v30.attributes, 0x1::string::utf8(b"Health"), u64_to_string(v30.health));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v30.attributes, 0x1::string::utf8(b"Upgrades"), clone_string(&v30.upgrades));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v30.attributes, 0x1::string::utf8(b"Specialisation"), clone_string(&v30.specialisation));
        0x2::kiosk::lock<ShipNFT>(arg5, arg6, arg4, v30);
        let v31 = ShipUpgraded{
        ...
        0x2::event::emit<ShipUpgraded>(v31);
    }
