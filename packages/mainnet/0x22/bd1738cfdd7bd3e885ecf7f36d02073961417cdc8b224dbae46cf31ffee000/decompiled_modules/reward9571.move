module 0x22bd1738cfdd7bd3e885ecf7f36d02073961417cdc8b224dbae46cf31ffee000::reward9571 {
    struct REWARD9571 has drop {
        dummy_field: bool,
    }

    struct TICKET_9571 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9571(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9571>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9571>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9571, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9571>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9571>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9571>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9571>>(v5, 0x2::tx_context::sender(arg1));
    }
