module 0xcd714a5ffde199ef5b3bf7e7db3bfe4b9e7bdbb5039d65b515823f965e3596bf::paws {
    ...
    struct WithdrawReservedNftEvent has copy, drop {
        id: 0x2::object::ID,
        price: u64,
    }
    ...
    fun init(arg0: PAWS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PAWS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Paws NFT"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"3333 little paws bringing innovation and creativity to SUI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"https://byzantion.mypinata.cloud/ipfs/QmUjonamriXKAjVk8egV7WvnVNX4XjSsrRVsU1yKBka7WP"));
    ...
    public entry fun withdraw_balance_and_royalties(arg0: &0x2::package::Publisher, arg1: &mut Manager, arg2: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Nft>(arg0), 2);
        let v0 = 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg1.balance), arg3);
        0x2::pay::join<0x2::sui::SUI>(&mut v0, 0x2::transfer_policy::withdraw<Nft>(arg2, &arg1.transfer_policy_cap, 0x1::option::none<u64>(), arg3));
        0x2::pay::keep<0x2::sui::SUI>(v0, arg3);
    }
    ...
    public entry fun withdraw_reserved_nfts(arg0: &0x2::package::Publisher, arg1: &mut Manager, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: &0x2::transfer_policy::TransferPolicy<Nft>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < 0x1::vector::length<Nft>(&arg1.reserved_nfts)) {
            v0 = v0 + 1;
            let v1 = 0x1::vector::pop_back<Nft>(&mut arg1.reserved_nfts);
            let v2 = WithdrawReservedNftEvent{
                id    : 0x2::object::id<Nft>(&v1),
                price : 0,
            };
            0x2::event::emit<WithdrawReservedNftEvent>(v2);
            0x2::kiosk::lock<Nft>(arg2, arg3, arg4, v1);
        };
    }
