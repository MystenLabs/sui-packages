module 0x92ac6b70cf57e600f19887c5b1958e5625060f20e6a6234a33a841aa0f40fe35::reward4031 {
    struct REWARD4031 has drop {
        dummy_field: bool,
    }

    struct TICKET_4031 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4031(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4031>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4031>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4031>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4031>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4031>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4031>>(v5, 0x2::tx_context::sender(arg1));
    }
