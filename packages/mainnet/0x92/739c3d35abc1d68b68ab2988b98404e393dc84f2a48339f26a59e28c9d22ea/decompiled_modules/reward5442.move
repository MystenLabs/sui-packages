module 0x92739c3d35abc1d68b68ab2988b98404e393dc84f2a48339f26a59e28c9d22ea::reward5442 {
    struct REWARD5442 has drop {
        dummy_field: bool,
    }

    struct TICKET_5442 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5442(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5442>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5442>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5442, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5442>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5442>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5442>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5442>>(v5, 0x2::tx_context::sender(arg1));
    }
