module 0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::sui_safe {
    ...
    struct YieldLock<phantom T0> has store, key {
        ...
        strategy: u8,
        market_coin: 0x2::coin::Coin<0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::reserve::MarketCoin<T0>>,
    }
    ...
    public entry fun configure_scallop(arg0: &AdminCap, arg1: &mut Platform, arg2: &mut 0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::market::Market, arg3: &0x2::package::Publisher, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == arg1.admin, 1);
        assert!(0x2::object::id<AdminCap>(arg0) == arg1.admin_cap_id, 7);
        arg1.scallop_configured = true;
        0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::whitelist::allow_all(0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::market::uid_mut_delegated(arg2, 0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::witness::from_publisher<0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::market::Market>(arg3)));
    ...
    public entry fun create_yield_lock<T0>(arg0: &Platform, arg1: &mut UserRegistry, arg2: &0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::version::Version, arg3: &mut 0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::market::Market, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused_deposits, 6);
        assert!(arg5 > 0, 0);
        ...
        let v4 = 0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::mint::mint<T0>(arg2, arg3, arg4, arg6, arg7);
        let v5 = YieldLock<T0>{
        ...
        let v7 = YieldLockCreated<T0>{
            ...
            start_time         : v2,
            duration_ms        : arg5,
            market_coin_amount : 0x2::coin::value<0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::reserve::MarketCoin<T0>>(&v4),
        };
    ...
    public entry fun withdraw_yield_lock<T0>(arg0: YieldLock<T0>, arg1: &mut Platform, arg2: &mut UserRegistry, arg3: &0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::version::Version, arg4: &mut 0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.paused_withdrawals, 6);
        ...
        let v11 = 0x9234ea1cfb6beb439cdd34891c8762614f68f01d6bc1a978defbb5179120ef01::redeem::redeem<T0>(arg3, arg4, v8, arg5, arg6);
