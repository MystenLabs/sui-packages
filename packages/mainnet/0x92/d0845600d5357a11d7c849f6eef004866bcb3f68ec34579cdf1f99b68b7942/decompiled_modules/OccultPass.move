module 0x92d0845600d5357a11d7c849f6eef004866bcb3f68ec34579cdf1f99b68b7942::OccultPass {
    ...
    fun init(arg0: OCCULTPASS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v2;
        let v4 = v1;
        0x92d0845600d5357a11d7c849f6eef004866bcb3f68ec34579cdf1f99b68b7942::rule::add<OccultPass>(&mut v4, &v3, 0, 0);
        ...
        0x2::transfer::public_share_object<Mint>(v11);
    }
    ...
    public entry fun mint_with(arg0: &mut Mint, arg1: &MintCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < arg2) {
