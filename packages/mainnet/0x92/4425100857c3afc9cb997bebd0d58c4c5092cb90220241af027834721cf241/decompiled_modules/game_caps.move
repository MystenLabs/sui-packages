module 0x924425100857c3afc9cb997bebd0d58c4c5092cb90220241af027834721cf241::game_caps {
    ...
    public(friend) fun assert_execution(arg0: &GameCapStore, arg1: address, arg2: 0x1::option::Option<0x2::object::ID>) {
        ...
        assert!(*0x2::dynamic_field::borrow<ExecutionBindingKey, 0x2::object::ID>(&arg0.id, v1) == 0x1::option::destroy_some<0x2::object::ID>(arg2), 200);
    }

    public(friend) fun borrow_cap(arg0: &GameCapStore, arg1: address) : &0x924425100857c3afc9cb997bebd0d58c4c5092cb90220241af027834721cf241::game::GameCap {
        0x2::dynamic_object_field::borrow<address, 0x924425100857c3afc9cb997bebd0d58c4c5092cb90220241af027834721cf241::game::GameCap>(&arg0.id, arg1)
    }
    ...
    public(friend) fun store_cap(arg0: &mut GameCapStore, arg1: address, arg2: 0x924425100857c3afc9cb997bebd0d58c4c5092cb90220241af027834721cf241::game::GameCap, arg3: 0x1::option::Option<0x2::object::ID>) {
        0x2::dynamic_object_field::add<address, 0x924425100857c3afc9cb997bebd0d58c4c5092cb90220241af027834721cf241::game::GameCap>(&mut arg0.id, arg1, arg2);
