module 0x9238d35aaa5974dbe7c58e32abb5129fcb277d049e278122af822e63fb9414b6::voting_dao {
    ...
    fun is_checkpoint_in_new_block(arg0: &VotingDAO, arg1: 0x2::object::ID, arg2: u64) : bool {
        ...
        let v1 = v0 > 0 && arg2 - 0x2::table::borrow<u64, Checkpoint>(0x2::table::borrow<0x2::object::ID, 0x2::table::Table<u64, Checkpoint>>(&arg0.checkpoints, arg1), v0 - 1).from_timestamp < 0x9238d35aaa5974dbe7c58e32abb5129fcb277d049e278122af822e63fb9414b6::common::get_time_to_finality();
        !v1
    }
