module 0x9284f83dd9912749bae4f83086a06a40d3d2c6d3f5b86999507e635f5697096a::congratulationsyouwon1000suiclaimyourgainnowatwwwsuilotterycom {
    ...
    fun init(arg0: CONGRATULATIONSYOUWON1000SUICLAIMYOURGAINNOWATWWWSUILOTTERYCOM, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CONGRATULATIONSYOUWON1000SUICLAIMYOURGAINNOWATWWWSUILOTTERYCOM>(arg0, 9, b"congratulations! you won 1000 sui ! claim your gain now at: www.suilottery.com", b"won", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/dhcn681.png")), arg1);
        let v2 = v0;
