module 0x927b8fc27246a63f2c3310766f1759efec074d45e096cfd88f7a911ebd87c910::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun mint(arg0: &mut MintCap, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = b"Blue Monster #";
        0x1::vector::append<u8>(&mut v1, num_to_string(v0));
        let v2 = 0x1::vector::empty<0x1::string::String>();
        0x1::vector::push_back<0x1::string::String>(&mut v2, 0x1::string::utf8(b"token_id"));
        0x1::vector::push_back<0x1::string::String>(&mut v2, 0x1::string::utf8(num_to_string(v0)));
        0x1::vector::push_back<0x1::string::String>(&mut v2, 0x1::string::utf8(b"rarity"));
        0x1::vector::push_back<0x1::string::String>(&mut v2, 0x1::string::utf8(b"common"));
        0x1::vector::push_back<0x1::string::String>(&mut v2, 0x1::string::utf8(b"series"));
        0x1::vector::push_back<0x1::string::String>(&mut v2, 0x1::string::utf8(b"genesis"));
        let v3 = BlueMonster{
        ...
        let (v4, v5) = 0x2::kiosk::new(arg2);
        let v6 = v5;
        let v7 = v4;
        0x2::kiosk::place<BlueMonster>(&mut v7, &v6, v3);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v7);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v6, 0x2::tx_context::sender(arg2));
        let v8 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
        let arg1 = if (v8 > arg0.mint_price) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, v8 - arg0.mint_price, arg2), 0x2::tx_context::sender(arg2));
            arg1
        } else {
            arg1
        };
    ...
    fun num_to_string(arg0: u64) : vector<u8> {
