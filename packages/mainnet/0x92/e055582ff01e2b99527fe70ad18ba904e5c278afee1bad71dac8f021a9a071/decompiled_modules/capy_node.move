module 0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::capy_node {
    ...
    entry fun create_super_node<T0: store + key>(arg0: &mut Registry, arg1: &mut Config, arg2: &mut MinerPool, arg3: &NFTNode, arg4: &T0, arg5: u8, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: 0x2::coin::Coin<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 7, 27);
        assert!(arg1.version == 7, 27);
        assert!(arg2.version == 7, 27);
    ...
    entry fun create_super_node_from_kiosk<T0: store + key>(arg0: &mut Registry, arg1: &mut Config, arg2: &mut MinerPool, arg3: &NFTNode, arg4: &0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: u8, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: 0x2::coin::Coin<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (v6 < 5) {
            ...
            assert!(0x2::coin::value<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&arg9) >= 100000000000000, 15);
            0x2::balance::join<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&mut arg2.reward_balance, 0x2::coin::into_balance<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(0x2::coin::split<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&mut arg9, 100000000000000, arg10)));
        };
        ...
        if (0x2::coin::value<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&arg9) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>>(arg9, v0);
        } else {
            0x2::coin::destroy_zero<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(arg9);
        };
        let v7 = v5 + 1;
        if (v5 == 0) {
            0x2::table::add<0x1::ascii::String, u64>(&mut arg1.super_count, v3, v7);
    ...
    public fun fund_pool(arg0: &mut MinerPool, arg1: 0x2::coin::Coin<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>) {
        assert!(arg0.version == 7, 27);
        assert!(0x2::coin::value<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&arg1) >= 1000, 29);
    ...
    entry fun reveal_mine_from_personal_kiosk<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &0x2::kiosk::Kiosk, arg4: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg5: 0x2::object::ID, arg6: MiningCommit, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &0x2::random::Random, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (((v10 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v5 && v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>>(0x2::coin::from_balance<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(0x2::balance::split<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&mut arg1.reward_balance, v4), arg10), v1);
    ...
    entry fun reveal_with_super_from_personal_kiosk<T0: store + key>(arg0: &mut ShardPool, arg1: &mut MinerPool, arg2: &mut NFTNode, arg3: &0x2::kiosk::Kiosk, arg4: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg5: 0x2::object::ID, arg6: &SuperNode, arg7: MiningCommit, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &0x2::random::Random, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::object::delete(v14);
        if (((v10 % 1000000) as u128) < (arg2.power as u128) * 1000 / (arg0.difficulty_factor as u128) * 1000000 / v5 && v4 > 0) {
            let v20 = 0x2::balance::split<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&mut arg1.reward_balance, v4);
            let v21 = v4 * (arg6.fee_percent as u64) / 100;
            if (v21 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>>(0x2::coin::from_balance<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(0x2::balance::split<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(&mut v20, v21), arg11), arg6.creator);
                let v22 = RoyaltyPaid{
                    super_node_id : 0x2::object::id<SuperNode>(arg6),
                    miner         : v1,
                    creator       : arg6.creator,
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>>(0x2::coin::from_balance<0x14bd61802d31291fb410bd75757e3347221bf8019707307e5926afeebf4667cf::cbtc::CBTC>(v20, arg11), v1);
