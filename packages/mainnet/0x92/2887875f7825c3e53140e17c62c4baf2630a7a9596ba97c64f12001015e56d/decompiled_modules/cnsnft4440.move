module 0x922887875f7825c3e53140e17c62c4baf2630a7a9596ba97c64f12001015e56d::cnsnft4440 {
    struct CNSNFT4440 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4440, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4440>(arg0, arg1);
