module 0x92bc35686ab84ff2ae83c0f97f922065b147264e15e115d32be9c248dd30a7a4::reward9635 {
    struct REWARD9635 has drop {
        dummy_field: bool,
    }

    struct TICKET_9635 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9635(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9635>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9635>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9635, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9635>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9635>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9635>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9635>>(v5, 0x2::tx_context::sender(arg1));
    }
