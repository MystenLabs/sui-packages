module 0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::swap {
    ...
    struct SwapPaymentReceiverUpdated has copy, drop {
        pool_id: 0x2::object::ID,
    ...
    struct SwapPaymentCollected has copy, drop {
        pool_id: 0x2::object::ID,
        payer: address,
        receiver: address,
        asset: u8,
    ...
    fun buy_ast_internal<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, u64) {
        ...
        let v4 = arg0.payment_receiver;
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg1, v4);
        let v5 = 0x2::balance::split<T0>(&mut arg0.ast_reserve, v3);
        if (v2 > 0) {
        ...
        let v6 = buy_fee_bps<T0, T1>(arg0);
        record_ast_fee<T0, T1>(arg0, v2);
        let v7 = SwapPaymentCollected{
        ...
        0x2::event::emit<SwapPaymentCollected>(v7);
        emit_swap<T0, T1>(arg0, 1, v0, v1, v3, v2, v6, arg6, arg7);
        (v5, v3)
    }
    ...
    entry fun create_empty_pool<T0, T1>(arg0: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg1: u8, arg2: u8, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        create_pool_internal<T0, T1>(v0, v1, arg1, arg2, arg3, 0, 100, v2, v3, v4, v5, arg4, arg5);
    }

    entry fun create_empty_pool_with_fees<T0, T1>(arg0: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg1: u8, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg0);
        ...
        create_pool_internal<T0, T1>(v0, v1, arg1, arg2, arg3, arg4, arg5, v2, v3, v4, v5, arg6, arg7);
    }

    entry fun create_empty_pool_with_roles<T0, T1>(arg0: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg1: u8, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: address, arg7: address, arg8: address, arg9: address, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg0);
        let v0 = 0x2::coin::zero<T0>(arg11);
        let v1 = 0x2::coin::zero<T1>(arg11);
        create_pool_internal<T0, T1>(v0, v1, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
    }

    entry fun create_pool<T0, T1>(arg0: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: u8, arg4: u8, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg0);
        let v0 = 0x2::tx_context::sender(arg7);
        let v1 = 0x2::tx_context::sender(arg7);
        let v2 = 0x2::tx_context::sender(arg7);
        let v3 = 0x2::tx_context::sender(arg7);
        create_pool_internal<T0, T1>(arg1, arg2, arg3, arg4, arg5, 0, 100, v0, v1, v2, v3, arg6, arg7);
    }

    fun create_pool_internal<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: u8, arg3: u8, arg4: u64, arg5: u64, arg6: u64, arg7: address, arg8: address, arg9: address, arg10: address, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 > 0, 1);
        assert!(arg2 <= 9, 2);
        assert!(arg3 <= 9, 2);
        let v0 = if (arg7 != @0x0) {
        ...
        let v1 = SwapPool<T0, T1>{
            ...
            payment_receiver         : arg10,
            payment_receiver_version : 1,
            paused                   : false,
            ast_decimals             : arg2,
            usdc_decimals            : arg3,
            ast_unit                 : pow10(arg2),
    ...
    public fun get_payment_receiver_info<T0, T1>(arg0: &SwapPool<T0, T1>) : (address, u64) {
        (arg0.payment_receiver, arg0.payment_receiver_version)
    }
    ...
    public fun owner_replace_pause_admin<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun owner_replace_price_admin<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
        assert!(arg2 != @0x0, 16);
    ...
    public fun owner_replace_reserve_admin<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
        assert!(arg2 != @0x0, 16);
    ...
    public fun owner_set_fees<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
        set_fees_internal<T0, T1>(arg0, arg2, arg3, arg4);
    }

    public fun owner_set_paused<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: bool, arg3: &0x2::clock::Clock) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
        set_paused_internal<T0, T1>(arg0, arg2, arg3);
    }

    public fun owner_set_payment_receiver<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: address, arg3: &0x2::clock::Clock) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
        set_payment_receiver_internal<T0, T1>(arg0, arg2, arg3);
    }

    public fun owner_set_price<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: u64, arg3: &0x2::clock::Clock) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
        set_price_internal<T0, T1>(arg0, arg2, arg3);
    }

    public fun owner_withdraw_ast<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
        withdraw_ast_internal<T0, T1>(arg0, arg2, arg3, arg4, arg5);
    }

    public fun owner_withdraw_usdc<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::ProtocolOwnerCap, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x927ad9b847910e986145ed57b8e7ef555ae6ffd34a02db26713b16b0a72f1401::governance::assert_owner(arg1);
    ...
    public fun set_payment_receiver<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &SwapAdminCap<T0, T1>, arg2: address, arg3: &0x2::clock::Clock) {
        assert_admin<T0, T1>(arg0, arg1);
        set_payment_receiver_internal<T0, T1>(arg0, arg2, arg3);
    }

    fun set_payment_receiver_internal<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: address, arg2: &0x2::clock::Clock) {
        assert!(arg1 != @0x0, 14);
        arg0.payment_receiver = arg1;
        arg0.payment_receiver_version = arg0.payment_receiver_version + 1;
        let v0 = SwapPaymentReceiverUpdated{
            pool_id          : 0x2::object::id<SwapPool<T0, T1>>(arg0),
            old_receiver     : arg0.payment_receiver,
            new_receiver     : arg1,
            receiver_version : arg0.payment_receiver_version,
            timestamp_ms     : 0x2::clock::timestamp_ms(arg2),
        };
        0x2::event::emit<SwapPaymentReceiverUpdated>(v0);
    }
    ...
    entry fun swap_ast_for_usdc<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<SwapPaymentCollected>(v7);
        emit_swap<T0, T1>(arg0, 2, v0, v1, v3, v2, v6, arg6, arg7);
