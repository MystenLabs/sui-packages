module 0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::oracle {
    ...
    public fun get_price<T0>(arg0: &0x2::clock::Clock, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x1::string::String, arg3: &PriceFeedsMap<T0>, arg4: u64, arg5: u64) : 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::Price {
        ...
        assert!((0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v0) as u256) * 100 <= (((0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::oracle_operations::get_magnitude(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_price(&v0)) as u256) * (arg5 as u256)) as u256), 2);
    ...
    public fun insert_to_price_feed_map<T0>(arg0: &mut PriceFeedsMap<T0>, arg1: &0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::auth::Auth<T0>, arg2: &0x1::string::String, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        assert!(0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::auth::has_cap<T0, 0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg4)), 4);
        0x2::vec_map::insert<0x1::string::String, vector<u8>>(&mut arg0.map, *arg2, arg3);
        0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::events::emit_price_feed_inserted<T0>(0x1::string::to_ascii(*arg2), arg3);
    }
    ...
    public fun peg_to_base<T0>(arg0: &mut PriceFeedsMap<T0>, arg1: &0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::auth::Auth<T0>, arg2: &0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::events::emit_price_feed_pegged_to_base<T0>(0x1::string::to_ascii(*arg2));
    }

    public fun remove_from_price_feed_map<T0>(arg0: &mut PriceFeedsMap<T0>, arg1: &0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::auth::Auth<T0>, arg2: &0x1::string::String, arg3: &0x2::tx_context::TxContext) {
        assert!(0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::auth::has_cap<T0, 0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::auth::OwnerCap>(arg1, 0x2::tx_context::sender(arg3)), 4);
        let (_, _) = 0x2::vec_map::remove<0x1::string::String, vector<u8>>(&mut arg0.map, arg2);
        0x9276a5ac9dc763275c3f2a3b058c278302c305bf18c79f5e8bc501fb2aabf0f4::events::emit_price_feed_removed<T0>(0x1::string::to_ascii(*arg2));
    }
