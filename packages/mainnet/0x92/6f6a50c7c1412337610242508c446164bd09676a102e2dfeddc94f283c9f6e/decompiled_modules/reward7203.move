module 0x926f6a50c7c1412337610242508c446164bd09676a102e2dfeddc94f283c9f6e::reward7203 {
    struct REWARD7203 has drop {
        dummy_field: bool,
    }

    struct TICKET_7203 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7203(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7203>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7203>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7203, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7203>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7203>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7203>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7203>>(v5, 0x2::tx_context::sender(arg1));
    }
