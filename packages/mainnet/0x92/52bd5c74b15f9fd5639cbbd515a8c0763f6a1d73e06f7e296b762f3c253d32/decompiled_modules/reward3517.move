module 0x9252bd5c74b15f9fd5639cbbd515a8c0763f6a1d73e06f7e296b762f3c253d32::reward3517 {
    struct REWARD3517 has drop {
        dummy_field: bool,
    }

    struct TICKET_3517 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3517(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3517>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3517>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3517, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3517>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3517>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3517>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3517>>(v5, 0x2::tx_context::sender(arg1));
    }
