module 0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::bluefin {
    ...
    public fun batch<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg3: &0x2::clock::Clock, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: u64, arg6: vector<bool>, arg7: vector<u64>, arg8: vector<u64>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::utils::check_deadline(arg3, arg5, true);
        if (v0 != 0) {
        ...
        while (v8 < 0x1::vector::length<bool>(&arg6)) {
            ...
            let v11 = if (v9) {
                0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::min_sqrt_price() + 1
            } else {
                0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::max_sqrt_price() - 1
            };
            let (v12, v13) = validate_swap<T0, T1>(arg0, v2, v3, v9, *0x1::vector::borrow<u64>(&arg7, v8), v10, v11);
            if (v12 != 0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_no_error()) {
            ...
            if (v15 != 0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_no_error()) {
    ...
    fun swap_exact_in<T0, T1>(arg0: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg1: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: bool, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(v8 >= arg6, 0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_amount_out_too_low());
        ...
        (0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_no_error(), v10, v11, v6, v7)
    }

    fun validate_swap<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool, arg4: u64, arg5: u64, arg6: u128) : (u64, u64) {
        ...
        if (0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::get_swap_result_amount_calculated(&v0) < arg5) {
            return (0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_amount_out_too_low(), 0)
        };
        if (arg3) {
            if (v1 > arg1) {
                return (0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_insufficient_input_balance(), 0)
            };
        } else if (v1 > arg2) {
            return (0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_insufficient_input_balance(), 0)
        };
        (0x9246b6c2782e4be8fe6bdb8d4015a4949fbe19f4b734ea8637d180f7ee0fb647::consts::e_no_error(), v1)
    }
