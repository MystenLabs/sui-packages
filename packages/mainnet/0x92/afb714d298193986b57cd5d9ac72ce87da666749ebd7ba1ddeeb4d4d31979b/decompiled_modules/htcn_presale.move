module 0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn_presale {
    struct UserState has key {
        id: 0x2::object::UID,
        is_claimed: 0x2::vec_map::VecMap<address, bool>,
        purchased_amount: 0x2::vec_map::VecMap<address, u64>,
        claimable_token: 0x2::vec_map::VecMap<address, u64>,
    }
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        token: 0x2::balance::Balance<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>,
    ...
    public entry fun claim(arg0: &mut UserState, arg1: &mut Treasury, arg2: &mut PresalePool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!*v1, 4);
        *v1 = true;
        let v2 = 0x2::vec_map::get_mut<address, u64>(&mut arg0.claimable_token, &v0);
        *v2 = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>>(0x2::coin::take<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(&mut arg1.token, *v2, arg4), v0);
    }
    ...
    public entry fun contribute(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut UserState, arg2: &mut Treasury, arg3: &mut PresalePool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::vec_map::contains<address, u64>(&arg1.purchased_amount, &v1)) {
            ...
            0x2::vec_map::insert<address, u64>(&mut arg1.claimable_token, v1, 0);
        };
        ...
        *v2 = *v2 + v0;
        let v3 = 0x2::vec_map::get_mut<address, u64>(&mut arg1.claimable_token, &v1);
        *v3 = *v3 + v0 * arg3.token_per_sui;
    }
    ...
    public entry fun get_treasury(arg0: &Treasury) : (u64, u64) {
        (0x2::balance::value<0x2::sui::SUI>(&arg0.purchased), 0x2::balance::value<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(&arg0.token))
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PresalePool{
            ...
            allocated     : 0,
            start_time    : 1731852000000,
            end_time      : 1731938400000,
            token_per_sui : 10000,
            is_claimable  : false,
        };
        ...
        let v1 = UserState{
            ...
            claimable_token  : 0x2::vec_map::empty<address, u64>(),
        };
        0x2::transfer::share_object<UserState>(v1);
        let v2 = Treasury{
            id        : 0x2::object::new(arg0),
            token     : 0x2::balance::zero<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::coin::Coin<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>) {
        0x2::balance::join<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(&mut arg1.token, 0x2::balance::split<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(0x2::coin::balance_mut<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(arg3), arg2));
    }
    ...
    public entry fun withdrawToken(arg0: &AdminCap, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>>(0x2::coin::take<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(&mut arg1.token, 0x2::balance::value<0x92afb714d298193986b57cd5d9ac72ce87da666749ebd7ba1ddeeb4d4d31979b::htcn::HTCN>(&arg1.token), arg2), 0x2::tx_context::sender(arg2));
    }
