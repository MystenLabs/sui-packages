module 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_swap {
    ...
    fun swap<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: 0x2::balance::Balance<T1>, arg4: u64) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        (0x2::balance::split<T0>(&mut arg0.coin_a, arg4), 0x2::balance::split<T1>(&mut arg0.coin_b, arg2), 0x2::balance::split<T0>(&mut arg0.coin_a, 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_div_u64(v0, v8, v9)), 0x2::balance::split<T1>(&mut arg0.coin_b, 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_div_u64(v1, v8, v9)))
    }

    fun assert_lp_value_incr(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) {
        assert!(0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_compare_mul_u64(arg2, arg3, arg0 * arg4, arg1 * arg4), 1);
    }
    ...
    fun burn<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<PoolLiquidityCoin<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v4 = 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_div_u64(v0, v1, v3);
        let v5 = 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_div_u64(v0, v2, v3);
        assert!(v4 > 0 && v5 > 0, 3);
    ...
    fun calc_swap_protocol_fee_rate<T0, T1>(arg0: &Pool<T0, T1>) : (u64, u64) {
        ...
        (0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_u64(v0, v2), 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_u64(v1, v3))
    }
    ...
    public(friend) fun flash_swap<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, FlashSwapReceipt<T0, T1>) {
        ...
        let v12 = FlashSwapReceipt<T0, T1>{
            ...
            a2b                 : arg3,
            pay_amount          : arg1,
            protocol_fee_amount : 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_div_u64(arg1, v10, v11),
        };
        (v4, v5, v12)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = InitEvent{
            ...
            global_paulse_status_id : 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_config::new_global_pause_status_and_shared(arg0),
        };
        0x2::event::emit<InitEvent>(v1);
    }

    public(friend) fun init_pool<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    fun mint<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::balance::Balance<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<PoolLiquidityCoin<T0, T1>> {
        ...
        let v3 = if (v2 == 0) {
            ...
            0x2::math::min(0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_div_u64(0x2::balance::value<T0>(&arg1), v2, v0), 0x923dfcc4e38715d1e3bc21d3d9fbe19a126f9396bbecc203fc27415433a5425b::amm_math::safe_mul_div_u64(0x2::balance::value<T1>(&arg2), v2, v1))
        };
        assert!(v3 > 0, 2);
        0x2::balance::join<T0>(&mut arg0.coin_a, arg1);
