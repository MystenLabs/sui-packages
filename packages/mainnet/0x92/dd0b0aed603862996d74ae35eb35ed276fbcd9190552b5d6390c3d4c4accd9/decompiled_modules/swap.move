module 0x92dd0b0aed603862996d74ae35eb35ed276fbcd9190552b5d6390c3d4c4accd9::swap {
    ...
    public fun swap_b2a<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let (v0, v1, v2) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::flash_swap<T0, T1>(arg1, false, true, 0x2::coin::value<T1>(&arg0), 79226673515401279992447579055, arg2, arg3, arg5);
        let v3 = v2;
        0x2::balance::destroy_zero<T1>(v1);
        let (_, v5) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::swap_receipt_debts(&v3);
        0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::repay_flash_swap<T0, T1>(arg1, v3, 0x2::coin::into_balance<T0>(0x2::coin::zero<T0>(arg5)), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg0, v5, arg5)), arg3, arg5);
        transfer_or_destroy_coin<T1>(arg0, 0x2::tx_context::sender(arg5), arg5);
        let v6 = 0x2::coin::from_balance<T0>(v0, arg5);
        if (0x2::coin::value<T0>(&v6) < arg4) {
            abort 404
        };
        v6
    }
