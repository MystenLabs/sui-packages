module 0x92731200c9bedaa6316709943ba499361b26f03fb7cd973f09685b6c3cf803ab::snowbara {
    ...
    fun assert_score_fits_level(arg0: u64, arg1: u64) {
        assert!(arg1 >= 1, 13906835037632593933);
        ...
        while (v2 < arg1 + 1) {
            ...
            if (v1 > (arg0 as u128) * 1000000) {
                assert!(v2 + 1 >= arg1, 13906835089172463633);
                return
            };
            let v3 = v0 * 10405;
            v0 = v3 / 10000;
        };
        abort 13906835119237103631
    }
    ...
    public fun submit_score(arg0: &mut Leaderboard, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 13906834809999065097);
        assert!(0x1::string::length(&arg1) <= 40, 13906834814294163467);
