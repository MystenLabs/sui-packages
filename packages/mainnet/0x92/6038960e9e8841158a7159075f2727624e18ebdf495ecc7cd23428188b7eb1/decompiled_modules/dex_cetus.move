module 0x926038960e9e8841158a7159075f2727624e18ebdf495ecc7cd23428188b7eb1::dex_cetus {
    ...
    public fun swap<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v2 = v0 - v1;
        let v3 = v2 - v2 * calculate_price_impact(v0, arg0) / 10000;
        assert!(v3 >= arg2, 603);
        let v4 = if (arg3 > 0) {
            arg3
        } else {
    ...
    public fun flash_swap<T0, T1>(arg0: address, arg1: u64, arg2: bool, arg3: u128, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, u64) {
        (0x2::coin::from_balance<T1>(0x2::balance::zero<T1>(), arg4), arg1 * 10025 / 10000)
    }
