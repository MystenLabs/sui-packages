module 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::swap {
    ...
    public fun test_swap(arg0: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg1: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg3: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, u64) {
        ...
        let (v4, v5, _) = 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::common::get_best_prices(arg3, arg6);
    ...
    fun try_cetus_buy(arg0: &0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::parameters::Parameters, arg1: &mut 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::order_manager::OrderManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : SwapResult {
        ...
        v0.initial_price = v2;
        let v3 = 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::parameters::swap_threshold_bps_times_1k(arg0) * v2 / 10000 / 1000;
        if (v2 + v3 > arg7) {
            return v0
        };
        let v4 = 10 * 1000000000;
        let v5 = v4;
        0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::order_manager::try_ensure_available_quote_balance(arg1, arg0, arg2, arg3, arg6, 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::common::convert_to_quote_at_price(arg0, v4, v2), arg8, arg9);
        let v6 = 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::common::convert_to_base_at_price(arg0, 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::common::get_available_quote_balance(arg0, arg2), v2);
        if (v4 > v6) {
            v5 = v6;
        };
        if (v5 < 1 * 1000000000) {
        ...
        let v8 = (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculated_swap_result_amount_in(&v7) + 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculated_swap_result_fee_amount(&v7)) * 1000000000 / v5;
        v0.quantity_price = v8;
        if (v8 + v3 > arg7) {
            v0.too_much_slippage = true;
            return v0
        };
        let (v9, v10, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>(arg5, arg4, true, false, v5, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::tick_math::min_sqrt_price(), arg8);
        let v12 = v11;
        let v13 = v9;
        assert!(0x2::balance::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&v13) == 0, 13906836188683042815);
    ...
    fun try_cetus_sell(arg0: &0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::parameters::Parameters, arg1: &mut 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::order_manager::OrderManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : SwapResult {
        let v0 = SwapResult{
            initial_price      : 0,
            quantity_price     : 0,
            wanted_to_swap     : false,
        ...
        let v4 = 10 * 1000000000;
        let v5 = v4;
        0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::order_manager::try_ensure_available_base_balance(arg1, arg0, arg2, arg3, arg6, v4, arg8, arg9);
        let v6 = 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::common::get_available_base_balance(arg0, arg2);
        if (v4 > v6) {
            v5 = v6;
        };
        if (v5 < 1 * 1000000000) {
        ...
        let v7 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculate_swap_result<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC, 0x2::sui::SUI>(arg4, false, true, cetus_remove_sui_for_fees(arg4, v5));
        ...
        let v12 = v11;
        let v13 = v10;
        assert!(0x2::balance::value<0x2::sui::SUI>(&v13) == 0, 13906835737711476735);
    ...
    fun try_mmt_buy(arg0: &0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::parameters::Parameters, arg1: &mut 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::order_manager::OrderManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg6: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : SwapResult {
        ...
        assert!(0x2::balance::value<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(&v13) == 0, 13906835235200303103);
        assert!(v14 == 0, 13906835239495270399);
        0x2::balance::destroy_zero<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(v13);
    ...
    fun try_mmt_sell(arg0: &0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::parameters::Parameters, arg1: &mut 0x92265e821105984401168c73ec867a0d2e46a2048e7566cc05cfa1e63052beac::order_manager::OrderManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg4: &mut 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::version::Version, arg6: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : SwapResult {
        let v0 = SwapResult{
            initial_price      : 0,
            quantity_price     : 0,
            wanted_to_swap     : false,
        ...
        let v13 = v9;
        let (v14, v15) = 0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::trade::swap_receipt_debts(&v12);
        assert!(0x2::balance::value<0x2::sui::SUI>(&v13) == 0, 13906834741279064063);
        assert!(v15 == 0, 13906834745574031359);
        0x2::balance::destroy_zero<0x2::sui::SUI>(v13);
