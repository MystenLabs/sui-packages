module 0x9208c6b5e179a794a32fe42040ff3d4cb55af245c0156a86c7422f6a4a68de8f::rudolph {
    ...
    fun init(arg0: RUDOLPH, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<RUDOLPH>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"RUDOLPH ")))), trim_right(b"RUDOLPH                         "), trim_right(b"Rudolph the Red-Nosed Reindeer                                                                                                                                                                                                                                                                                                  "), v2, arg1);
        let v5 = v3;
