module 0x9237337d846fc90b0a7acbdee4ab91809298691873d28e1d64d91e6303ff6ba4::price_feed {
    ...
    public(friend) fun add_feed(arg0: &mut vector<PriceFeed>, arg1: u16, arg2: 0x2::object::ID, arg3: u128, arg4: u64, arg5: u64) {
        ...
        assert!(!v0, 13835059081779347457);
    ...
    public(friend) fun maybe_set_price(arg0: &mut PriceFeed, arg1: u128, arg2: u64) : bool {
        if (arg2 <= arg0.timestamp_ms || arg1 == 0) {
            return false
        };
    ...
    public(friend) fun new(arg0: u16, arg1: 0x2::object::ID, arg2: u128, arg3: u64, arg4: u64) : PriceFeed {
        assert!(arg4 > 0, 13835621314473492485);
        assert!(arg2 != 0, 13835902793745301511);
        PriceFeed{
            source_id      : arg0,
            from           : arg1,
            price          : arg2,
