module 0x92f15aaa6b6d8185e84d0dd626ab815785c5e37ad5859556b30305b18aad9daa::walrus_airdrop_claim_nfts {
    struct WALRUS_AIRDROP_CLAIM_NFTS has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"2db91d5f-1f1c-41c8-a72c-473ffacb4227"),
        };
    ...
    fun init(arg0: WALRUS_AIRDROP_CLAIM_NFTS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WALRUS_AIRDROP_CLAIM_NFTS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Walrus Airdrop Claim NFTs"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This soulbound NFT is your claim to WAL tokens at time of Mainnet launch. More information soon!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmTwbXcg8AMx1hGq1r9spj7K9RyhjJWR14fgyWX9XN9yoh"));
