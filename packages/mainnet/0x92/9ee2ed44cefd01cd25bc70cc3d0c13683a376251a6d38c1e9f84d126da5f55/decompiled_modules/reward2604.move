module 0x929ee2ed44cefd01cd25bc70cc3d0c13683a376251a6d38c1e9f84d126da5f55::reward2604 {
    struct REWARD2604 has drop {
        dummy_field: bool,
    }

    struct TICKET_2604 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2604(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2604>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2604>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2604, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2604>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2604>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2604>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2604>>(v5, 0x2::tx_context::sender(arg1));
    }
