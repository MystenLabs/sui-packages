module 0x923f9bfc2c3c7e95ab884f45b291845f4d72d2ba8e22bcdf43580888b49e68cf::reward4465 {
    struct REWARD4465 has drop {
        dummy_field: bool,
    }

    struct TICKET_4465 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4465(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4465>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4465>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4465, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4465>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4465>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4465>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4465>>(v5, 0x2::tx_context::sender(arg1));
    }
