module 0x92a81eded159299fe13c255669f0faf17497a252727b3520f647eae5103b930f::auto_position {
    ...
    public fun new<T0: store + key>(arg0: T0, arg1: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg2: address, arg3: u64, arg4: &0x92a81eded159299fe13c255669f0faf17497a252727b3520f647eae5103b930f::registry::ProxyCap) : AutoPosition<T0> {
        assert!(arg3 < 0x92a81eded159299fe13c255669f0faf17497a252727b3520f647eae5103b930f::constants::scaling_pips(), 2);
        AutoPosition<T0>{
            owner         : arg2,
    ...
    public(friend) fun set_slippage_pips<T0: store + key>(arg0: &mut AutoPosition<T0>, arg1: u64) {
        assert!(arg1 < 0x92a81eded159299fe13c255669f0faf17497a252727b3520f647eae5103b930f::constants::scaling_pips(), 2);
    ...
    public fun unwrap<T0: store + key>(arg0: AutoPosition<T0>, arg1: &0x92a81eded159299fe13c255669f0faf17497a252727b3520f647eae5103b930f::registry::ProxyCap) : (address, T0, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, u64) {
        let AutoPosition {
            owner         : v0,
            inner         : v1,
            vault         : v2,
