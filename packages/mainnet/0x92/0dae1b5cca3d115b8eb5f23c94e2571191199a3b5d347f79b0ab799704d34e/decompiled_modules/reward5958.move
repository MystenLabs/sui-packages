module 0x920dae1b5cca3d115b8eb5f23c94e2571191199a3b5d347f79b0ab799704d34e::reward5958 {
    struct REWARD5958 has drop {
        dummy_field: bool,
    }

    struct TICKET_5958 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5958(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5958>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5958>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5958, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5958>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5958>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5958>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5958>>(v5, 0x2::tx_context::sender(arg1));
    }
