module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::isolated_trading {
    ...
    fun apply_isolated_margin(arg0: 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::evaluator::TradeChecks, arg1: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::Position, arg2: 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::order::Order, arg3: Fill, arg4: u128, arg5: u64, arg6: bool, arg7: bool) : IMResponse {
        ...
        let (v6, v7) = if (v1 == 0 || v0 == v2) {
            assert!(!arg7, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::insurance_active_account_can_only_have_reduce_only_orders());
    ...
    public(friend) fun trade(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: address, arg2: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::perpetual::Perpetual, arg3: &mut 0x2::table::Table<vector<u8>, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::order::OrderStatus>, arg4: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::SubAccounts, arg5: TradeData, arg6: u128) : TradeResponse {
        ...
        let v16 = if (0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::order::price(*v3) == 0) {
        ...
        let v17 = *0x2::table::borrow<address, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::Position>(v11, v4);
        let v18 = *0x2::table::borrow<address, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::Position>(v11, v5);
        verify_order(v17, arg3, arg4, *v2, v12, v14, arg5.maker_signature, arg5.maker_publicKey, v0, v1, 0, arg6, v10 == v4);
        verify_order(v18, arg3, arg4, *v3, v13, v15, arg5.taker_signature, arg5.taker_publicKey, v0, v1, 1, arg6, v10 == v5);
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::evaluator::verify_price_checks(v7, v0.price);
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::evaluator::verify_qty_checks(v7, v0.quantity, v16);
        ...
        let v19 = caculate_gas_fee(arg3, v14, v0.quantity, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::maker_gas_fee(arg0));
        let v20 = caculate_gas_fee(arg3, v15, v0.quantity, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::taker_gas_fee(arg0));
        if (v4 == v5) {
            let v21 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(v0.price, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::perpetual::get_fee(v4, arg2, true)), v0.quantity);
            let v22 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul(v0.price, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::perpetual::get_fee(v5, arg2, false)), v0.quantity);
            let v23 = TradeExecutedEvent{
                tx_index         : arg6,
                sender           : arg1,
                ...
                maker_mro        : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::mro(&v17),
                taker_mro        : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::mro(&v18),
                maker_trade_fee  : v21,
                maker_gas_fee    : v19,
                taker_trade_fee  : v22,
                taker_gas_fee    : v20,
            ...
            0x2::event::emit<TradeExecutedEvent>(v23);
            return TradeResponse{
                maker_funds_flow : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::add_u128(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::from(v21, true), v19),
                taker_funds_flow : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::add_u128(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::from(v22, true), v20),
                trade_fee        : v21 + v22,
                gas_fee          : v19 + v20,
            }
        };
        let v24 = 0x2::table::borrow_mut<address, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::Position>(v11, v4);
        let v25 = apply_isolated_margin(v7, v24, *v2, v0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul_up(v0.price, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::perpetual::get_fee(v4, arg2, true)), 0, 0x2::vec_set::contains<address>(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::privileged_addresses(arg0), &v4), v10 == v4);
        let v26 = 0x2::table::borrow_mut<address, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::Position>(v11, v5);
        let v27 = apply_isolated_margin(v7, v26, *v3, v0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::base_mul_up(v0.price, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::perpetual::get_fee(v5, arg2, false)), 1, 0x2::vec_set::contains<address>(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::privileged_addresses(arg0), &v5), v10 == v5);
        let v28 = *0x2::table::borrow<address, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::Position>(v11, v4);
        let v29 = *0x2::table::borrow<address, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::Position>(v11, v5);
        if (v10 != v4) {
            0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::verify_collat_checks(&v17, &v28, v8, v9, v6, 1, 0);
        };
        if (v10 != v5) {
            0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::verify_collat_checks(&v18, &v29, v8, v9, v6, 1, 1);
        };
        v25.funds_flow = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::add_u128(v25.funds_flow, v19);
        v27.funds_flow = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::s128::add_u128(v27.funds_flow, v20);
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::emit_position_update_event(v28, arg1, 0, arg6);
        0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::emit_position_update_event(v29, arg1, 0, arg6);
        let v30 = TradeExecutedEvent{
            tx_index         : arg6,
            sender           : arg1,
            perp_id          : 0x2::object::uid_to_inner(0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::perpetual::id(arg2)),
            trade_type       : 1,
            ...
            make_order_hash  : v14,
            taker_order_hash : v15,
            maker_mro        : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::mro(&v28),
            taker_mro        : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::position::mro(&v29),
            maker_trade_fee  : v25.trade_fee,
            maker_gas_fee    : v19,
            taker_trade_fee  : v27.trade_fee,
            taker_gas_fee    : v20,
            maker_pnl        : v25.pnl,
            taker_pnl        : v27.pnl,
            trade_quantity   : v0.quantity,
        ...
        0x2::event::emit<TradeExecutedEvent>(v30);
        TradeResponse{
            maker_funds_flow : v25.funds_flow,
            taker_funds_flow : v27.funds_flow,
            trade_fee        : v27.trade_fee + v25.trade_fee,
            gas_fee          : v19 + v20,
        }
    }
