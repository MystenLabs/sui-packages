module 0x9220ee0342d8058f36a3aeba5922b252426f1b41a63723b5811e9060e32af058::cnsnft3967 {
    struct CNSNFT3967 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3967, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3967>(arg0, arg1);
