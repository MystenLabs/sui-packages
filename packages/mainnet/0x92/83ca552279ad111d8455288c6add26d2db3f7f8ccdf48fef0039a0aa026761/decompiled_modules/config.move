module 0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::ACL,
        package_version: u64,
        swap_fee_rate: u64,
    ...
    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        ...
        0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun check_acl_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    public fun check_acl_upload_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::has_role(&arg0.acl, arg1, 1), 4);
    }
    ...
    public fun claim_fee<T0>(arg0: &mut GlobalConfig, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        checked_package_version(arg0);
        assert!(0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 0), 1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = GlobalConfig{
            ...
            acl                  : 0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::new(arg0),
            package_version      : 1,
            swap_fee_rate        : 0,
        ...
        0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::set_roles(&mut v3.acl, v5, 0 | 1 << 0);
    ...
    public fun set_init_fee<T0>(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0x9283ca552279ad111d8455288c6add26d2db3f7f8ccdf48fef0039a0aa026761::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 0), 1);
        let v0 = 0x1::type_name::get<T0>();
