module 0x9281bf3d6f116cf67a71f6a8817c578ef594a66802426ff850c2f4ef3f0ab347::cnsnft8388 {
    struct CNSNFT8388 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8388, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8388>(arg0, arg1);
