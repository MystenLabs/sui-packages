module 0x92c50d698203a87fc87a506f13bbc0be0c11928829ae860931ee19da05be3f73::dao {
    ...
    public entry fun create_dao_fund<T0>(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: u64, arg6: &mut SharedObj, arg7: 0x2::transfer::Receiving<0x2::coin::TreasuryCap<T0>>, arg8: &0x92c50d698203a87fc87a506f13bbc0be0c11928829ae860931ee19da05be3f73::dao_config::GlobalDaoFee, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg10);
        let v1 = ((arg3 / arg5 * 110 / 100) as u64);
        let (v2, v3, _, _, _, _) = 0x92c50d698203a87fc87a506f13bbc0be0c11928829ae860931ee19da05be3f73::dao_config::get_dao_fee_config(arg8);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x92c50d698203a87fc87a506f13bbc0be0c11928829ae860931ee19da05be3f73::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_dao_fee_config(arg0: &OperatorCap, arg1: &mut 0x92c50d698203a87fc87a506f13bbc0be0c11928829ae860931ee19da05be3f73::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::tx_context::TxContext) {
        0x92c50d698203a87fc87a506f13bbc0be0c11928829ae860931ee19da05be3f73::dao_config::set_dao_fee_config(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }
    ...
    public entry fun withdraw_by_operator<T0>(arg0: &OperatorCap, arg1: &mut DAOFund<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0x2::sui::SUI>(&arg1.balance) - arg1.fundraise_goal;
