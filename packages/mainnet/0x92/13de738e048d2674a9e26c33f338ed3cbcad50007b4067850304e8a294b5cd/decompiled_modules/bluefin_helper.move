module 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::bluefin_helper {
    ...
    public fun close_position_and_try_reopen<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T1>, arg6: u8, arg7: u8, arg8: u128, arg9: bool, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v40 = with_position_ratio_u128(0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v39));
        let v41 = with_position_ratio_u128(0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::uq128_128::to_u128(&v38));
        let v42 = if (v41 > v14) {
            v41 - v14
        } else if (v40 > v13) {
            v13 - v40
        ...
        let v43 = OpenParameters{
            ...
            a2b               : v41 > v14,
            swap_amount       : v42,
            a_position_amount : v40,
            b_position_amount : v41,
        };
        0x2::event::emit<OpenParameters>(v43);
        if (v40 < v13 && v41 < v14) {
            let (v44, v45, v46) = 0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::get_liquidity_by_amount(v43.lower_tick, v43.upper_tick, v17, v18, (v40 as u64), arg9);
            let v47 = if (v44 <= 1) {
                true
            } else if (v13 <= (v45 as u128)) {
                true
            } else {
                v14 <= (v46 as u128)
            };
            ...
            let v48 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::open_position<T0, T1>(arg1, arg2, 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v43.lower_tick), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::as_u32(v43.upper_tick), arg10);
            let (_, _, v51, v52) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::add_liquidity<T0, T1>(arg0, arg1, arg2, &mut v48, v11, v12, v44 - 1);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T0>(v51, 0x2::tx_context::sender(arg10), arg10);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T1>(v52, 0x2::tx_context::sender(arg10), arg10);
            0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v48, 0x2::tx_context::sender(arg10));
        } else {
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T0>(v11, 0x2::tx_context::sender(arg10), arg10);
            0x43decceb4b8b58128d69e2f9278fd0595b15e56fb3ae61c0c8b562cc9fc89f10::utils::transfer_balance<T1>(v12, 0x2::tx_context::sender(arg10), arg10);
        };
