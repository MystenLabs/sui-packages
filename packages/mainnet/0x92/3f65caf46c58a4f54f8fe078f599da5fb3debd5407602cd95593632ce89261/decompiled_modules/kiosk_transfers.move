module 0x923f65caf46c58a4f54f8fe078f599da5fb3debd5407602cd95593632ce89261::kiosk_transfers {
    ...
    public entry fun admin_upgrade_escrow(arg0: &mut Store, arg1: 0x2::object::ID, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun cancel_with_purchase_cap<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_escrow_receiver(arg0: &Store, arg1: 0x2::object::ID) : address {
        if (0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Escrow>(&arg0.id, arg1)) {
            0x2::dynamic_object_field::borrow<0x2::object::ID, Escrow>(&arg0.id, arg1).receiver
        } else {
            0x2::dynamic_object_field::borrow<0x2::object::ID, RevertableEscrow>(&arg0.id, arg1).receiver
        }
    }

    public fun has_escrow(arg0: &Store, arg1: 0x2::object::ID) : bool {
    ...
    public entry fun transfer_with_purchase_capability<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
