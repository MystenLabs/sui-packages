module 0x924f12c4a5e78538abe8d64202c1ccfb39c79119782df49050063a9770d37bff::airdrop {
    ...
    public entry fun create_pool<T0>(arg0: &0x2::clock::Clock, arg1: vector<u8>, arg2: u64, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 != @0xbd98eff8cb12fbcb269a334137c00c693d704ce878d8e1fed640acedb235254f || v0 != @0xbd98eff8cb12fbcb269a334137c00c693d704ce878d8e1fed640acedb235254f) {
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg3) >= 300000000000, 7);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut arg3, 300000000000, arg4), @0xbd98eff8cb12fbcb269a334137c00c693d704ce878d8e1fed640acedb235254f);
