module 0xa0a47d9cc8fc040da45d5bd89c0b0f0a01dd49f4929014933823bf6603737445::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun mint_bookie_tiered(arg0: &mut BookieRegistry, arg1: &BookieAttributes, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::transfer_policy::TransferPolicy<Bookie>, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x2::kiosk::KioskOwnerCap, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.can_mint, 9223374669669859331);
        assert!(arg3 > 0, 9223375500000000004);
        verify_mint_signature_v2(arg0, 0x2::tx_context::sender(arg9), arg2, arg3, &arg4);
        let v0 = arg2 * arg3;
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg5) >= v0, 9223373750546726913);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.balance, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg5, v0, arg9)));
    ...
    public entry fun mint_bookie_with_coin_tiered<T0>(arg0: &mut BookieRegistry, arg1: &BookieAttributes, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::transfer_policy::TransferPolicy<Bookie>, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x2::kiosk::KioskOwnerCap, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.can_mint, 9223374669669859331);
        assert!(arg3 > 0, 9223375500000000004);
        verify_mint_signature_v2(arg0, 0x2::tx_context::sender(arg9), arg2, arg3, &arg4);
        assert!(0x2::coin::value<T0>(&arg5) >= arg2 * arg3, 9223373750546726913);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg5, arg0.treasury);
        mint(arg0, arg1, arg2, arg6, arg7, arg8, arg9);
    }
    ...
    fun verify_mint_signature_v2(arg0: &BookieRegistry, arg1: address, arg2: u64, arg3: u64, arg4: &vector<u8>) {
        assert!(!0x1::vector::is_empty<u8>(&arg0.signer_public_key), 9223375500000000002);
        let v0 = 0x2::bcs::to_bytes<address>(&arg1);
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg2));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&arg3));
        assert!(0x2::ed25519::ed25519_verify(arg4, &arg0.signer_public_key, &v0), 9223375500000000003);
    }
