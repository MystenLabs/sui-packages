module 0x92ca2ad7f21c03107f663206f71103412f00569aaba78ca5d084017fce28695a::reward3995 {
    struct REWARD3995 has drop {
        dummy_field: bool,
    }

    struct TICKET_3995 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3995(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_3995>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3995, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3995>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3995>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3995>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3995>>(v5, 0x2::tx_context::sender(arg1));
    }
