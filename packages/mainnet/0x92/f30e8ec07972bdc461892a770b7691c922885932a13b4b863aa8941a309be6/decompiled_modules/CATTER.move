module 0x92f30e8ec07972bdc461892a770b7691c922885932a13b4b863aa8941a309be6::CATTER {
    ...
    fun init(arg0: CATTER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<CATTER>(arg0, 9, b"WATTER", b"WATER CAT", b"WATER CAT is literally a wet cat", 0x1::option::some<0x2::url::Url>(v0), arg1);
        let v3 = v1;
        0x2::transfer::public_transfer<0x2::coin::Coin<CATTER>>(0x2::coin::mint<CATTER>(&mut v3, 10000000000000000, arg1), 0x2::tx_context::sender(arg1));
