module 0x92c854ec3d4a39bf55ebcd3e57d3bb957b59b8b186c39cfefbbb0494041fcf86::mobfi_ring {
    struct MOBFI_RING has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOBFI_RING, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MOBFI_RING>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"MOBFI RING"));
