module 0x92d0d093cfd8680fcadd9486056beaf1684654e2788269a94aaaa9c61db8f3ba::agu_token {
    ...
    fun init(arg0: AGU_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGU_TOKEN>(arg0, 6, b"BEAM", b"BEAM", b"BEAM Token on Sui Network", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://icon.suntool.cc/file/onbeam.png")), arg1);
        let v2 = v0;
