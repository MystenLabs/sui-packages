module 0x9257fad54f8bdd741c667c50535b3ba53ec446392e92e4048cc114567a93289b::kkdb {
    struct KKDB has drop {
        dummy_field: bool,
    }

    fun init(arg0: KKDB, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<KKDB>(arg0, 9, b"KKDB", b"KKDB", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/bafkreif6nvlmg2kwmd4zpfnpeeosshgdefipm3df4hezsylpz3qblfoex4")), arg1);
        let v2 = v0;
