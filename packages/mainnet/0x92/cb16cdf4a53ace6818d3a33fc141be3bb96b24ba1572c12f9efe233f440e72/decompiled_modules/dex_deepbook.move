module 0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::dex_deepbook {
    ...
    public fun get_deep_token_package() : address {
        0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::constants::deep_token_package()
    }

    public fun get_deepbook_config() : (address, address, address) {
        (0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::constants::deepbook_package(), 0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::constants::deepbook_registry(), 0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::constants::deepbook_treasury())
    }
    ...
    public fun swap_sui_to_usdc<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0 > 0, 3401);
        assert!(arg0 == 0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::constants::deepbook_sui_usdc_pool(), 3403);
