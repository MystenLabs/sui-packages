module 0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::dex_turbos {
    ...
    fun call_turbos_swap_a_b(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = TurbosSwapExecuted{
            ...
            amount_in      : arg2,
            min_amount_out : arg3,
            pool_id        : 0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::constants::turbos_sui_usdc_pool(),
    ...
    public fun get_pool_config() : address {
        0x92cb16cdf4a53ace6818d3a33fc141be3bb96b24ba1572c12f9efe233f440e72::constants::turbos_sui_usdc_pool()
    }
