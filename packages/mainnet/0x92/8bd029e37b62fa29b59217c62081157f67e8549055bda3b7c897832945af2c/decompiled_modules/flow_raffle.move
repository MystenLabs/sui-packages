module 0x928bd029e37b62fa29b59217c62081157f67e8549055bda3b7c897832945af2c::flow_raffle {
    ...
    public entry fun claim_prize<T0: store + key>(arg0: &mut Raffle, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::option::is_some<address>(&arg0.winner_address), 14);
        let v0 = *0x1::option::borrow<address>(&arg0.winner_address);
        assert!(0x2::tx_context::sender(arg1) == v0, 13);
        assert!(!arg0.prize_claimed, 12);
    ...
    public entry fun create_raffle<T0: store + key>(arg0: T0, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun draw_winner(arg0: &mut Raffle, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.creator, 4);
        assert!(arg0.active, 2);
        assert!(arg0.tickets_sold > 0, 3);
        arg0.active = false;
        arg0.winner_address = 0x1::option::some<address>(arg1);
        let v0 = RaffleEnded{
            raffle_id      : 0x2::object::id<Raffle>(arg0),
            winner         : arg1,
    ...
    public entry fun withdraw_nft<T0: store + key>(arg0: &mut Raffle, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.creator, 4);
        assert!(0x2::clock::timestamp_ms(arg1) >= arg0.end_time, 15);
        assert!(arg0.tickets_sold == 0, 16);
        arg0.active = false;
        if (0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"nft")) {
            0x2::transfer::public_transfer<T0>(0x2::dynamic_object_field::remove<vector<u8>, T0>(&mut arg0.id, b"nft"), arg0.creator);
            arg0.nft_id = 0x1::string::utf8(b"");
        };
    }
