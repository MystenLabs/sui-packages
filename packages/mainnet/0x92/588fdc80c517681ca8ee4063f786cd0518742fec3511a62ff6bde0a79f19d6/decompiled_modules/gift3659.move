module 0x92588fdc80c517681ca8ee4063f786cd0518742fec3511a62ff6bde0a79f19d6::gift3659 {
    struct GIFT3659 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift3659(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT3659, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3659>(arg0, arg1);
