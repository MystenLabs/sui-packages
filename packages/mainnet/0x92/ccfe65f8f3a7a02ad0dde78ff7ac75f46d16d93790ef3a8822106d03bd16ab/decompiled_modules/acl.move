module 0x92ccfe65f8f3a7a02ad0dde78ff7ac75f46d16d93790ef3a8822106d03bd16ab::acl {
    struct Lbhkmsimkopwoep has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Kbonbqomcrpvllv>,
    }

    struct Kbonbqomcrpvllv has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun idwqicgmnmnzcpa<T0>(arg0: &mut Lbhkmsimkopwoep, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kbonbqomcrpvllv>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kbonbqomcrpvllv>(&mut arg0.pools, arg1);
    ...
    public entry fun iebzzlbffkehclh(arg0: &mut Lbhkmsimkopwoep, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Kbonbqomcrpvllv{
        ...
        0x2::table::add<0x1::ascii::String, Kbonbqomcrpvllv>(&mut arg0.pools, arg1, v0);
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Lbhkmsimkopwoep{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Kbonbqomcrpvllv>(arg0),
        };
        0x2::transfer::share_object<Lbhkmsimkopwoep>(v0);
    }

    public entry fun kxzxhpwvdzczznx<T0: store + key>(arg0: &mut Lbhkmsimkopwoep, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kbonbqomcrpvllv>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kbonbqomcrpvllv>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
    ...
    public entry fun kzfkjzphmtbywyh(arg0: &mut Lbhkmsimkopwoep, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kbonbqomcrpvllv>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kbonbqomcrpvllv>(&mut arg0.pools, arg1);
    ...
    public entry fun myozenutctmzuyh(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Lbhkmsimkopwoep, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kbonbqomcrpvllv>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kbonbqomcrpvllv>(&mut arg2.pools, arg3);
        if (v0.initialized) {
            assert!(0x1::option::is_some<Pool>(&v0.details), 1);
    ...
    public entry fun ouyykhkrdkzpbiq(arg0: &mut Lbhkmsimkopwoep, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Kbonbqomcrpvllv>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Kbonbqomcrpvllv>(&mut arg0.pools, arg1);
    ...
    public entry fun xneyjwbzeenhydy(arg0: &mut Lbhkmsimkopwoep, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, Kbonbqomcrpvllv>(&mut arg0.pools, arg1, v4);
    }
