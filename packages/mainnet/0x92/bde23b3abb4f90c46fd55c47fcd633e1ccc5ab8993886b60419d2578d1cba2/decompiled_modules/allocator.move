module 0x92bde23b3abb4f90c46fd55c47fcd633e1ccc5ab8993886b60419d2578d1cba2::allocator {
    ...
    public(friend) fun add_new_pool(arg0: &mut Allocator, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::vec_map::contains<0x2::object::ID, Pool_info>(&arg0.members, &arg1) == false, 0x92bde23b3abb4f90c46fd55c47fcd633e1ccc5ab8993886b60419d2578d1cba2::error::pool_already_present_error());
    ...
    public(friend) fun delete_pool(arg0: &mut Allocator, arg1: 0x2::object::ID) {
        assert!(0x2::vec_map::contains<0x2::object::ID, Pool_info>(&arg0.members, &arg1) == true, 0x92bde23b3abb4f90c46fd55c47fcd633e1ccc5ab8993886b60419d2578d1cba2::error::pool_not_present_error());
        ...
        assert!(v3 == true, 0x92bde23b3abb4f90c46fd55c47fcd633e1ccc5ab8993886b60419d2578d1cba2::error::pool_has_weight_error());
        assert!(v4 == false, 0x92bde23b3abb4f90c46fd55c47fcd633e1ccc5ab8993886b60419d2578d1cba2::error::pending_rewards_error());
