module 0x92be29308989b0fa8b593a6d1fa5d337b013e42c2d1cfd0784b30320b92dbfa9::cnsnft3914 {
    struct CNSNFT3914 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3914, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1529"));
        let v4 = 0x2::package::claim<CNSNFT3914>(arg0, arg1);
