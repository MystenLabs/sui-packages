module 0x92381f6d50b1859d54b004491f0135de3d38185729abd48e787aa6c507d6969b::catchemAll {
    ...
    public entry fun play_game(arg0: &mut CatchemAll, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg3))) {
            v4 = 0x2::table::length<u64, History>(0x2::table::borrow<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3)));
        };
        let v5 = get_hash(0x2::clock::timestamp_ms(arg2) + v3 + 1 + v4 + 1);
        let v6 = b"lose";
        let v7 = 0;
        if ((safe_selection(999, &v5) + (*0x1::vector::borrow<u8>(&v2, 0) as u64)) % 2 == 0) {
            v6 = b"win";
            let v8 = v0 * 2;
            ...
            let v10 = v8 - v9;
            v7 = v10;
            0x2::coin::join<0x2::sui::SUI>(&mut arg1, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v10 - v0, arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, 0x2::tx_context::sender(arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v9, arg3), arg0.treasury);
        } else {
            if (arg0.fee > 0) {
        ...
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg3))) {
            0x2::table::add<u64, History>(0x2::table::borrow_mut<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3)), v4 + 1, v11);
        } else {
            let v12 = 0x2::table::new<u64, History>(arg3);
            0x2::table::add<u64, History>(&mut v12, 1, v11);
            0x2::table::add<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3), v12);
        };
        0x2::table::add<u64, History>(&mut arg0.history_all, v3 + 1, v11);
