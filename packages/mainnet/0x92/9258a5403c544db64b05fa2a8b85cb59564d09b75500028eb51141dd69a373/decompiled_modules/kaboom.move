module 0x929258a5403c544db64b05fa2a8b85cb59564d09b75500028eb51141dd69a373::kaboom {
    ...
    fun init(arg0: KABOOM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<KABOOM>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<KABOOM>>(v4);
    }
