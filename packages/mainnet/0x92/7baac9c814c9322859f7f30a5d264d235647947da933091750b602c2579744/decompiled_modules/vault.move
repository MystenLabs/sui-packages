module 0x927baac9c814c9322859f7f30a5d264d235647947da933091750b602c2579744::vault {
    ...
    public fun borrow<T0>(arg0: &mut Matrix, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoan) {
        ...
        (0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v1, arg1), arg2), v2)
    }

    public fun borrow_vec<T0>(arg0: &mut Matrix, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (vector<0x2::coin::Coin<T0>>, FlashLoan) {
