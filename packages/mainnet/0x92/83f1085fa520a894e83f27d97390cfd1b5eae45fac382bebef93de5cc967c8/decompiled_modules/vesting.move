module 0xff2cfa3438beb90b23b6783f7c0dced77ba4f69bd2c084e70b6870aa260b4129::vesting {
    ...
    struct VestingVault has key {
        id: 0x2::object::UID,
        vote_capability: 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::VoteByVestedTokensCapability,
    ...
    public fun kraft_genesis_honey(arg0: &mut VestingVault, arg1: &mut 0x6a7ea1255160d2d3c77aa80440f17d4ae9092ef547141a34185e5b41c1c31c66::dragon_food::DragonFood, arg2: 0x2::coin::TreasuryCap<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &mut 0x84f8a4ed68568c4f30592d03dfcaf7bedcae27e3a1e84a1ba7dfd4886c511cbc::dragon_trainer::BeesManager, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x6a7ea1255160d2d3c77aa80440f17d4ae9092ef547141a34185e5b41c1c31c66::dragon_food::kraft_genesis_honey(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
        let v1 = 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&v0);
    ...
    public entry fun accept_proposed_new_beneficiary(arg0: &VestingAdminCapability, arg1: &mut VestingSchedule, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 1, 5110);
    ...
    public entry fun add_hive_for_vesting(arg0: &mut VestingVault, arg1: &VestingAdminCapability, arg2: 0x2::coin::Coin<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::into_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(arg2);
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg0.hive_available, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut v0, arg3));
    ...
    public entry fun add_to_vesting_schedule(arg0: &0x2::clock::Clock, arg1: &VestingAdminCapability, arg2: &mut VestingVault, arg3: &mut VestingSchedule, arg4: u64, arg5: u64) {
        ...
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg3.available_hive, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg2.hive_available, arg4));
        arg3.hive_release_rate = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg3.available_hive) as u256), (1000000000 as u256), (arg3.vesting_duration as u256)) as u128);
        arg3.total_vested_hive_amt = arg3.total_vested_hive_amt + arg4;
        0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3.available_honey, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg2.honey_available, arg5));
        arg3.honey_release_rate = (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg3.available_honey) as u256), (1000000000 as u256), (arg3.vesting_duration as u256)) as u128);
    ...
    fun calc_vested_amt(arg0: u128, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        if (arg3 > arg1 + arg2) {
            (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg0 as u256), (arg2 as u256), (1000000000 as u256)) as u64)
        } else {
            (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg0 as u256), ((arg3 - arg1) as u256), (1000000000 as u256)) as u64)
        }
    }

    public entry fun claim_released_tokens(arg0: &0x2::clock::Clock, arg1: &mut VestingVault, arg2: &0x1609ad341cc5ef030d782ee7c2d84070d0768c6cede910e216c3ff1873a84bc1::honey_trade::HoneyManager<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg3: &mut VestingSchedule, arg4: &mut 0x2::token::TokenPolicy<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.module_version == 1 && arg3.module_version == 1, 5110);
        assert!(0x2::tx_context::sender(arg5) == arg3.beneficiary, 5102);
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let v1 = 0;
        let v2 = 0;
        if (v0 > arg3.unlock_timestamp) {
            let v3 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(calc_vested_amt(arg3.hive_release_rate, arg3.start_timestamp, arg3.vesting_duration, v0) - arg3.claimed_hive_amt, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg3.available_hive));
            v1 = v3;
            0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::coin_helper::destroy_or_transfer_balance<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg3.available_hive, v3), arg3.beneficiary, arg5);
            let v4 = 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(calc_vested_amt(arg3.honey_release_rate, arg3.start_timestamp, arg3.vesting_duration, v0) - arg3.claimed_honey_amt, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg3.available_honey));
            v2 = v4;
            0x1609ad341cc5ef030d782ee7c2d84070d0768c6cede910e216c3ff1873a84bc1::honey_trade::transfer_honey_balance(arg4, arg2, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3.available_honey, v4), arg3.beneficiary, arg5);
        ...
        arg1.honey_claimed = arg1.honey_claimed + v2;
    ...
    public entry fun clawback_unvested_gems(arg0: &0x2::clock::Clock, arg1: &VestingAdminCapability, arg2: &mut VestingVault, arg3: &mut VestingSchedule, arg4: u64, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        ...
        assert!(arg2.module_version == 1 && arg3.module_version == 1, 5110);
        if (arg4 > 0) {
            ...
            arg3.total_vested_hive_amt = arg3.total_vested_hive_amt - arg4;
            arg2.hive_to_vest = arg2.hive_to_vest + arg4;
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg2.hive_available, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg3.available_hive, arg4));
        };
        if (arg5 > 0) {
            ...
            arg3.total_vested_honey_amt = arg3.total_vested_honey_amt - arg5;
            arg2.honey_to_vest = arg2.honey_to_vest + arg5;
            0x2::balance::join<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg2.honey_available, 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg3.available_honey, arg5));
        };
        let v0 = ClawedBack{
            schedule_id            : 0x2::object::uid_to_address(&arg3.id),
            beneficiary            : arg3.beneficiary,
    ...
    public fun get_released_and_claimable_hive_for_schedule(arg0: &VestingSchedule, arg1: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        let (v2, v3) = if (arg0.unlock_timestamp < 0x2::clock::timestamp_ms(arg1)) {
            (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(v0 - arg0.claimed_hive_amt, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&arg0.available_hive)), 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::min_u64(v1 - arg0.claimed_honey_amt, 0x2::balance::value<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&arg0.available_honey)))
        } else {
            (0, 0)
        };
        (v0, v2, v1, v3)
    ...
    public entry fun increment_schedule(arg0: &mut VestingSchedule) {
        assert!(arg0.module_version < 1, 5111);
    ...
    public entry fun init_vesting_schedule(arg0: &0x2::clock::Clock, arg1: &mut VestingVault, arg2: &VestingAdminCapability, arg3: address, arg4: u64, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        arg1.honey_to_vest = arg1.honey_to_vest - arg5;
        let v0 = VestingSchedule{
            id                       : 0x2::object::new(arg10),
            beneficiary              : arg3,
            proposed_new_beneficiary : 0x1::option::none<address>(),
            available_hive           : 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(&mut arg1.hive_available, arg4),
            available_honey          : 0x2::balance::split<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(&mut arg1.honey_available, arg5),
            total_vested_hive_amt    : arg4,
            total_vested_honey_amt   : arg5,
            claimed_hive_amt         : 0,
            claimed_honey_amt        : 0,
            hive_release_rate        : (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg4 as u256), (1000000000 as u256), (arg9 as u256)) as u128),
            honey_release_rate       : (0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::math::mul_div_u256((arg5 as u256), (1000000000 as u256), (arg9 as u256)) as u128),
    ...
    public entry fun kraft_vesting_vault_obj(arg0: 0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::VoteByVestedTokensCapability, arg1: &VestingAdminCapability, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = VestingVault{
    ...
    public entry fun set_proposed_new_beneficiary(arg0: &mut VestingSchedule, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 1, 5110);
