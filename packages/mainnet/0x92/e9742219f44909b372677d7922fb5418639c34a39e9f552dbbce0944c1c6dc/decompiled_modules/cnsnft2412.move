module 0x92e9742219f44909b372677d7922fb5418639c34a39e9f552dbbce0944c1c6dc::cnsnft2412 {
    struct CNSNFT2412 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2412, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2412>(arg0, arg1);
