module 0xf40c5a8133e633aa919e9f2db15341a642ceedae1946ea7b303f450dcdfc422f::native_token_transfer {
    struct NativeTokenTransfer has copy, drop, store {
        amount: 0xf40c5a8133e633aa919e9f2db15341a642ceedae1946ea7b303f450dcdfc422f::trimmed_amount::TrimmedAmount,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : NativeTokenTransfer {
        assert!(0xf40c5a8133e633aa919e9f2db15341a642ceedae1946ea7b303f450dcdfc422f::bytes4::to_bytes(0xf40c5a8133e633aa919e9f2db15341a642ceedae1946ea7b303f450dcdfc422f::bytes4::take(arg0)) == x"994e5454", 13906834603840176130);
        ...
        NativeTokenTransfer{
            amount       : 0xf40c5a8133e633aa919e9f2db15341a642ceedae1946ea7b303f450dcdfc422f::trimmed_amount::new(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u64_be(arg0), 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_u8(arg0)),
    ...
    public fun to_bytes(arg0: NativeTokenTransfer) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v7, 0xf40c5a8133e633aa919e9f2db15341a642ceedae1946ea7b303f450dcdfc422f::trimmed_amount::to_bytes(&v6));
