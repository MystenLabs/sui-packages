module 0xf41a3537cc49c6c34edaa8fd495971e8485b71c0a2e04bf2a123c8fc5eb67fc9::cetus {
    struct CETUS has drop {
        dummy_field: bool,
    }

    fun init(arg0: CETUS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CETUS>(arg0, 6, b"CETUS", b"aCETUS v3 (Bridge at: cetusv2.com)", b"Cetus", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/200x200/25114.png")), arg1);
        let v2 = v0;
