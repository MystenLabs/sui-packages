module 0xf4660462d11d5fcb6e44f4e8221324f8f93b95508e14e6412024a85685fe0465::satoshik {
    ...
    fun init(arg0: SATOSHIK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SATOSHIK>(&mut v2, 100000000000000, 0x2::tx_context::sender(arg1), arg1);
