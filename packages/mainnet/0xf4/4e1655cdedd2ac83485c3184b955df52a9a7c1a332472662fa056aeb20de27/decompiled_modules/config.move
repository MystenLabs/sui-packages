module 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::config {
    ...
    public fun cancel_funding(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::cancel(&mut arg0.id);
    }

    public fun cancel_hibernation(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::cancel(&mut arg0.id);
    }
    ...
    public fun execute_funding(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::execute(&mut arg0.id, arg1);
    }

    public fun execute_hibernation(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::execute(&mut arg0.id, arg1);
    }
    ...
    public fun funding(arg0: &Config) : 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::Rules {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::get(&arg0.id)
    }

    public fun funding_proposal(arg0: &Config) : (bool, 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::Rules, u64) {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::pending(&arg0.id)
    }

    public fun hibernation(arg0: &Config) : 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::Rules {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::get(&arg0.id)
    }

    public fun hibernation_proposal(arg0: &Config) : (bool, 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::Rules, u64) {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::pending(&arg0.id)
    }
    ...
    public fun propose_funding(arg0: &mut Config, arg1: &AdminCap, arg2: 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::funding_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }

    public fun propose_hibernation(arg0: &mut Config, arg1: &AdminCap, arg2: 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::hibernation_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }
