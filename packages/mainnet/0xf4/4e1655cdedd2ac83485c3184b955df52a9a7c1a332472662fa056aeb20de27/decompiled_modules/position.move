module 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::position {
    ...
    public(friend) fun join<T0>(arg0: &mut Position<T0>, arg1: Position<T0>) {
        assert!(arg0.pool == arg1.pool && 0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::locks::same(&arg0.lock, &arg1.lock), 1);
    ...
    public(friend) fun upgrade<T0>(arg0: &mut Position<T0>, arg1: u8, arg2: u64, arg3: &0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::config::Params) {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::locks::upgrade(&mut arg0.lock, arg1, arg2, arg3);
    }
    ...
    public(friend) fun clear_lock<T0>(arg0: &mut Position<T0>) {
        0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::locks::clear(&mut arg0.lock);
    }
    ...
    public(friend) fun fee<T0>(arg0: &Position<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        while (v2 < 0x1::vector::length<Lot>(v1)) {
            let v3 = 0x1::vector::borrow<Lot>(v1, v2);
            v0 = v0 + (v3.amount as u256) * (0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::math::decay(arg1 - v3.entry_ms, arg2, arg3, arg4) as u256);
            v2 = v2 + 1;
        };
        (((v0 + 9999) / 10000) as u64)
    }

    public fun lock<T0>(arg0: &Position<T0>) : &0xf44e1655cdedd2ac83485c3184b955df52a9a7c1a332472662fa056aeb20de27::locks::Lock {
        &arg0.lock
    }
