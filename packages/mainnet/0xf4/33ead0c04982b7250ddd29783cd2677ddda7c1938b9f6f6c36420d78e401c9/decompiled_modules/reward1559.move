module 0xf433ead0c04982b7250ddd29783cd2677ddda7c1938b9f6f6c36420d78e401c9::reward1559 {
    struct REWARD1559 has drop {
        dummy_field: bool,
    }

    struct TICKET_1559 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1559(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1559>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1559>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1559, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1559>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1559>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1559>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1559>>(v5, 0x2::tx_context::sender(arg1));
    }
