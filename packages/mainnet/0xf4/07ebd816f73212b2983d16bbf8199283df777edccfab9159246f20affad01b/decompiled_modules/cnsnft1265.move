module 0xf407ebd816f73212b2983d16bbf8199283df777edccfab9159246f20affad01b::cnsnft1265 {
    struct CNSNFT1265 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1265, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1265>(arg0, arg1);
