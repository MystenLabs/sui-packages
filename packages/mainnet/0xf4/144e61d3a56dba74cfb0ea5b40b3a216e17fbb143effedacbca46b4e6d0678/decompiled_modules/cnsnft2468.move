module 0xf4144e61d3a56dba74cfb0ea5b40b3a216e17fbb143effedacbca46b4e6d0678::cnsnft2468 {
    struct CNSNFT2468 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2468, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4233"));
        let v4 = 0x2::package::claim<CNSNFT2468>(arg0, arg1);
