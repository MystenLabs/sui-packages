module 0xf414aef464471ff6b58c2297351455bb6c16986a8fb277f6ebe5dfb44daeacc2::role {
    ...
    public fun create_random_role_for_cards(arg0: &Global, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::get_random_num(0, 1000, arg1, arg2);
    ...
    public fun get_random_role_by_power(arg0: &Global, arg1: u8, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : Role {
        let v0 = 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::get_random_num(0, 1000, arg1, arg4);
        if (v0 < arg3) {
    ...
    public fun permenant_increase_role_hp(arg0: &mut vector<Role>, arg1: &0x2::vec_map::VecMap<0x1::string::String, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::Int_wrapper>) {
        let v0 = 0x2::vec_map::keys<0x1::string::String, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::Int_wrapper>(arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::string::String>(&v0)) {
            ...
            while (v3 < 0x1::vector::length<Role>(arg0)) {
                if (&0x1::vector::borrow_mut<Role>(arg0, v3).class == v2) {
                    ...
                    increase_hp(v4, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::get_int(0x2::vec_map::get<0x1::string::String, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::Int_wrapper>(arg1, v2)));
                    break
                };
                v3 = v3 + 1;
            };
    ...
    public fun print_role(arg0: &Role) {
        ...
        0x1::string::append(&mut v0, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::u8_to_string(arg0.level));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", attack: "));
        0x1::string::append(&mut v0, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::u64_to_string(arg0.attack));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", hp: "));
        0x1::string::append(&mut v0, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::u64_to_string(arg0.hp));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", speed: "));
        0x1::string::append(&mut v0, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::u64_to_string(arg0.speed));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", sp: "));
        0x1::string::append(&mut v0, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::u8_to_string(arg0.sp));
        0x1::string::append(&mut v0, 0x1::string::utf8(b", sp_cap: "));
        0x1::string::append(&mut v0, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::u8_to_string(arg0.sp_cap));
        ...
        0x1::string::append(&mut v0, 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::u8_to_string(arg0.gold_cost));
    ...
    public fun upgrade(arg0: &Global, arg1: &Role, arg2: &mut Role) : bool {
        ...
        if (v0 < 9 && v1 < 9) {
            ...
            let v9 = 0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::get_class_by_level(0xb997f87e60159a25103a3f8dc79eaefd9c5d4a48b8c056c40e124923745991b8::utils::removeSuffix(arg2.class), v3);
