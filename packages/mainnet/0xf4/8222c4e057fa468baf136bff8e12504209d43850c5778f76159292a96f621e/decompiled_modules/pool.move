module 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool {
    ...
    public fun cancel_live_order<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: u128, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        let v0 = account_open_orders<T0, T1>(arg0, arg1);
        if (0x2::vec_set::contains<u128>(&v0, &arg3)) {
            cancel_order<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5);
        };
    }

    public fun cancel_live_orders<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: vector<u128>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        let v0 = account_open_orders<T0, T1>(arg0, arg1);
        let v1 = 0;
        while (v1 < 0x1::vector::length<u128>(&arg3)) {
            let v2 = *0x1::vector::borrow<u128>(&arg3, v1);
            if (0x2::vec_set::contains<u128>(&v0, &v2)) {
                0x2::vec_set::remove<u128>(&mut v0, &v2);
                cancel_order<T0, T1>(arg0, arg1, arg2, v2, arg4, arg5);
            };
            v1 = v1 + 1;
        };
    }
