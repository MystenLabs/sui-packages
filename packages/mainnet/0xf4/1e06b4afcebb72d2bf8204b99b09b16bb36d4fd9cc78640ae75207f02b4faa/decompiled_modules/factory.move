module 0xf41e06b4afcebb72d2bf8204b99b09b16bb36d4fd9cc78640ae75207f02b4faa::factory {
    ...
    public entry fun add_allowed_list<T0>(arg0: &mut PoolSimpleInfo, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun add_allowed_pair_config<T0: store + key>(arg0: &mut PoolSimpleInfo, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.delegate, 0);
    ...
    public entry fun register_permission_pair(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut PoolSimpleInfo, arg3: &mut 0x2::tx_context::TxContext) {
        if (arg2.initialized) {
