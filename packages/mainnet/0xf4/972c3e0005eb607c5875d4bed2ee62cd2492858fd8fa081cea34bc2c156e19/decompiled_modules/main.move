module 0xe97aca0af0c4bce6aa6ab5d5750b78c65098440e09922ec501dafdfd9d4fd902::main {
    ...
    struct EcosystemToppedEvent has copy, drop {
        user: address,
        amount: u64,
    }
    ...
    public fun top_up_ecosystem(arg0: &mut 0xe97aca0af0c4bce6aa6ab5d5750b78c65098440e09922ec501dafdfd9d4fd902::estia::Central, arg1: 0x2::coin::Coin<0xe97aca0af0c4bce6aa6ab5d5750b78c65098440e09922ec501dafdfd9d4fd902::estia::ESTIA>, arg2: &0x2::tx_context::TxContext) {
        assert!(0xe97aca0af0c4bce6aa6ab5d5750b78c65098440e09922ec501dafdfd9d4fd902::estia::version(arg0) == 0, 996);
        let v0 = EcosystemToppedEvent{
            user   : 0x2::tx_context::sender(arg2),
            amount : 0x2::coin::value<0xe97aca0af0c4bce6aa6ab5d5750b78c65098440e09922ec501dafdfd9d4fd902::estia::ESTIA>(&arg1),
        };
        0xe97aca0af0c4bce6aa6ab5d5750b78c65098440e09922ec501dafdfd9d4fd902::estia::deposit_to_ecosystem(arg0, 0x2::coin::into_balance<0xe97aca0af0c4bce6aa6ab5d5750b78c65098440e09922ec501dafdfd9d4fd902::estia::ESTIA>(arg1));
        0x2::event::emit<EcosystemToppedEvent>(v0);
    }
