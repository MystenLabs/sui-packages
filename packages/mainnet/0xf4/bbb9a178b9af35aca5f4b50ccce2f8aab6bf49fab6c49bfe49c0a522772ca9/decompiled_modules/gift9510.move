module 0xf4bbb9a178b9af35aca5f4b50ccce2f8aab6bf49fab6c49bfe49c0a522772ca9::gift9510 {
    struct GIFT9510 has drop {
        dummy_field: bool,
    }

    struct TICKET_9510 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9510(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9510>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9510>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9510, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9510>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9510>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9510>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9510>>(v5, 0x2::tx_context::sender(arg1));
    }
