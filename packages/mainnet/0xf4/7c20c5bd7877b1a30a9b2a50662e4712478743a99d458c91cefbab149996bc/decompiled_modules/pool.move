module 0x87c13bb9157c3d51d61c7802704539d9d4782e838aadc41df0d6f0cc117298ba::pool {
    ...
    struct CredentialV2<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        lock_until: u64,
        acc_reward_per_share: u128,
        stake: 0x2::balance::Balance<T0>,
    ...
    public fun create_pool<T0, T1>(arg0: &0x87c13bb9157c3d51d61c7802704539d9d4782e838aadc41df0d6f0cc117298ba::admin::AdminCap, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<vector<u8>, PoolVersion>(&mut v1.id, b"POOL_VERSION", v2);
        0x87c13bb9157c3d51d61c7802704539d9d4782e838aadc41df0d6f0cc117298ba::event::pool_version_updated<T0, T1>(0, 7);
    ...
    fun check_version<T0, T1>(arg0: &Pool<T0, T1>) {
        ...
        assert!(0x2::dynamic_object_field::borrow<vector<u8>, PoolVersion>(&arg0.id, b"POOL_VERSION").version <= 7, 13);
    }
    ...
    public fun claim_rewards_ptb_v2<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut CredentialV2<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(arg0.enabled, 0);
        check_version<T0, T1>(arg0);
        let v0 = 0x2::clock::timestamp_ms(arg1) / 1000;
        assert!(v0 >= 0x1::u64::min(arg2.lock_until, arg0.end_time), 6);
    ...
    public fun claim_rewards_v2<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut CredentialV2<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) {
        check_version<T0, T1>(arg0);
        let v0 = claim_rewards_ptb_v2<T0, T1>(arg0, arg1, arg2, arg3);
        let v1 = 0x2::tx_context::sender(arg3);
        pay_from_balance<T1>(0x2::coin::into_balance<T1>(v0), v1, arg3);
    }
    ...
    public fun clear_empty_credential_v2<T0, T1>(arg0: CredentialV2<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        if (0x2::balance::value<T0>(&arg0.stake) == 0) {
            destory_credential_v2<T0, T1>(arg0);
        } else {
            0x2::transfer::transfer<CredentialV2<T0, T1>>(arg0, 0x2::tx_context::sender(arg1));
        };
    }

    public fun credential_acc_reward_per_share<T0, T1>(arg0: &Credential<T0, T1>) : u128 {
        arg0.acc_reward_per_share
    }

    public fun credential_lock_until<T0, T1>(arg0: &Credential<T0, T1>) : u64 {
        arg0.lock_until
    }

    public fun credential_stake_ref<T0, T1>(arg0: &Credential<T0, T1>) : &0x2::balance::Balance<T0> {
        &arg0.stake
    }

    public fun credential_staked_amount<T0, T1>(arg0: &Credential<T0, T1>) : u64 {
        0x2::balance::value<T0>(&arg0.stake)
    }

    public fun credential_v2_acc_reward_per_share<T0, T1>(arg0: &CredentialV2<T0, T1>) : u128 {
        arg0.acc_reward_per_share
    }

    public fun credential_v2_lock_until<T0, T1>(arg0: &CredentialV2<T0, T1>) : u64 {
        arg0.lock_until
    }

    public fun credential_v2_stake_ref<T0, T1>(arg0: &CredentialV2<T0, T1>) : &0x2::balance::Balance<T0> {
        &arg0.stake
    }

    public fun credential_v2_staked_amount<T0, T1>(arg0: &CredentialV2<T0, T1>) : u64 {
        0x2::balance::value<T0>(&arg0.stake)
    }

    public fun deposit_ptb_v2<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) : CredentialV2<T0, T1> {
        assert!(arg0.enabled, 0);
        check_version<T0, T1>(arg0);
        let v0 = 0x2::clock::timestamp_ms(arg1) / 1000;
        assert!(v0 >= arg0.start_time, 10);
        ...
        arg0.staked_amount = arg0.staked_amount + v1;
        0x87c13bb9157c3d51d61c7802704539d9d4782e838aadc41df0d6f0cc117298ba::event::deposit<T0, T1>(0x2::tx_context::sender(arg3), v1, v2);
        v3
    }

    public fun deposit_v2<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.enabled, 0);
        check_version<T0, T1>(arg0);
        let v0 = 0x2::clock::timestamp_ms(arg1) / 1000;
        assert!(v0 >= arg0.start_time, 10);
        ...
        arg0.staked_amount = arg0.staked_amount + v1;
        let v4 = 0x2::tx_context::sender(arg3);
        0x2::transfer::transfer<CredentialV2<T0, T1>>(v3, v4);
        0x87c13bb9157c3d51d61c7802704539d9d4782e838aadc41df0d6f0cc117298ba::event::deposit<T0, T1>(v4, v1, v2);
    }
    ...
    fun destory_credential_v2<T0, T1>(arg0: CredentialV2<T0, T1>) {
        assert!(0x2::balance::value<T0>(&arg0.stake) == 0, 9);
        let CredentialV2 {
            id                   : v0,
            lock_until           : _,
    ...
    public fun pool_acc_reward_per_share<T0, T1>(arg0: &Pool<T0, T1>) : u128 {
        arg0.acc_reward_per_share
    }

    public fun pool_enabled<T0, T1>(arg0: &Pool<T0, T1>) : bool {
        arg0.enabled
    }

    public fun pool_end_time<T0, T1>(arg0: &Pool<T0, T1>) : u64 {
        arg0.end_time
    }

    public fun pool_last_updated_time<T0, T1>(arg0: &Pool<T0, T1>) : u64 {
        arg0.last_updated_time
    }

    public fun pool_lock_duration<T0, T1>(arg0: &Pool<T0, T1>) : u64 {
        arg0.lock_duration
    }

    public fun pool_reward_rate<T0, T1>(arg0: &Pool<T0, T1>) : u128 {
        arg0.reward_rate
    }

    public fun pool_reward_vault_ref<T0, T1>(arg0: &Pool<T0, T1>) : &0x2::balance::Balance<T1> {
        &arg0.reward_vault
    }

    public fun pool_reward_vault_value<T0, T1>(arg0: &Pool<T0, T1>) : u64 {
        0x2::balance::value<T1>(&arg0.reward_vault)
    }

    public fun pool_staked_amount<T0, T1>(arg0: &Pool<T0, T1>) : u64 {
        arg0.staked_amount
    }

    public fun pool_start_time<T0, T1>(arg0: &Pool<T0, T1>) : u64 {
        arg0.start_time
    }
    ...
    public fun withdraw_ptb_v2<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut CredentialV2<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg0.enabled, 0);
        check_version<T0, T1>(arg0);
        assert!(0x2::balance::value<T0>(&arg2.stake) >= arg3, 5);
        let v0 = 0x2::clock::timestamp_ms(arg1) / 1000;
    ...
    public fun withdraw_v2<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: CredentialV2<T0, T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        check_version<T0, T1>(arg0);
        let v0 = &mut arg2;
        let v1 = claim_rewards_ptb_v2<T0, T1>(arg0, arg1, v0, arg4);
        let v2 = &mut arg2;
        let v3 = withdraw_ptb_v2<T0, T1>(arg0, arg1, v2, arg3, arg4);
        let v4 = 0x2::tx_context::sender(arg4);
        pay_from_balance<T1>(0x2::coin::into_balance<T1>(v1), v4, arg4);
        pay_from_balance<T0>(0x2::coin::into_balance<T0>(v3), v4, arg4);
        if (0x2::balance::value<T0>(&arg2.stake) == 0) {
            destory_credential_v2<T0, T1>(arg2);
        } else {
            0x2::transfer::transfer<CredentialV2<T0, T1>>(arg2, v4);
        };
    }
