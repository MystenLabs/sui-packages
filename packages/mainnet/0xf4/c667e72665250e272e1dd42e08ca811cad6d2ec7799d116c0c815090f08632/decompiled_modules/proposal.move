module 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::proposal {
    struct Proposal<phantom T0, phantom T1> has store, key {
        ...
        amm_pools: vector<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>,
    ...
    public(friend) fun create<T0, T1>(arg0: 0x2::object::ID, arg1: u64, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: vector<0x1::string::String>, arg12: u64, arg13: u128, arg14: u64, arg15: 0x1::option::Option<vector<u64>>, arg16: u64, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) : (0x2::object::ID, 0x2::object::ID, u8) {
        ...
        let v20 = 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::market_state::new(v19, arg0, arg1, arg11, arg17, arg18);
        let v21 = 0x2::object::id<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::market_state::MarketState>(&v20);
        let v22 = 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::coin_escrow::new<T0, T1>(v20, arg18);
        let v23 = 0x2::object::id<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::coin_escrow::TokenEscrow<T0, T1>>(&v22);
        assert!(0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::coin_escrow::get_market_state_id<T0, T1>(&v22) == v21, 2);
        let (v24, v25) = 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::liquidity_initialize::create_outcome_markets<T0, T1>(&mut v22, arg1, v2, v3, arg12, arg13, arg14, arg2, arg3, arg17, arg18);
        ...
        let v29 = 0;
        while (v29 < 0x1::vector::length<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(v27)) {
            0x1::vector::push_back<0x2::object::ID>(&mut v28, 0x2::object::uid_to_inner(0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::oracle::get_id(0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::get_oracle(0x1::vector::borrow<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(v27, v29)))));
            v29 = v29 + 1;
        };
        ...
        0x2::transfer::public_share_object<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::coin_escrow::TokenEscrow<T0, T1>>(v22);
    ...
    public fun get_amm_pool_ids<T0, T1>(arg0: &Proposal<T0, T1>) : vector<0x2::object::ID> {
        ...
        let v1 = 0;
        while (v1 < 0x1::vector::length<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(&arg0.amm_pools)) {
            0x1::vector::push_back<0x2::object::ID>(&mut v0, 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::get_id(0x1::vector::borrow<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(&arg0.amm_pools, v1)));
            v1 = v1 + 1;
        };
        v0
    }

    public fun get_amm_pools<T0, T1>(arg0: &Proposal<T0, T1>) : &vector<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool> {
        &arg0.amm_pools
    }

    public(friend) fun get_amm_pools_mut<T0, T1>(arg0: &mut Proposal<T0, T1>) : &mut vector<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool> {
        &mut arg0.amm_pools
    }
    ...
    fun get_pool_mut(arg0: &mut vector<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>, arg1: u8) : &mut 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool {
        let v0 = 0;
        while (v0 < 0x1::vector::length<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(arg0)) {
            let v1 = 0x1::vector::borrow_mut<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(arg0, v0);
            if (0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::get_outcome_idx(v1) == arg1) {
                return v1
            };
            v0 = v0 + 1;
        };
    ...
    public(friend) fun get_pool_mut_by_outcome<T0, T1>(arg0: &mut Proposal<T0, T1>, arg1: u8) : &mut 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool {
    ...
    public fun get_twaps_for_proposal<T0, T1>(arg0: &mut Proposal<T0, T1>, arg1: &0x2::clock::Clock) : vector<u128> {
        ...
        let v2 = 0;
        while (v2 < 0x1::vector::length<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(v0)) {
            0x1::vector::push_back<u128>(&mut v1, 0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::get_twap(0x1::vector::borrow_mut<0xf4c667e72665250e272e1dd42e08ca811cad6d2ec7799d116c0c815090f08632::amm::LiquidityPool>(v0, v2), arg1));
            v2 = v2 + 1;
        };
        v1
    }
