module 0xf4129b2dfd7e6e1563878e1c74059a525213da6af34e33f5f2b7d732a1d78c30::kiosk_marketplace {
    ...
    public entry fun list<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &T0, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy<T0: store + key>(arg0: &mut MarketplaceConfig, arg1: &0x2::transfer_policy::TransferPolicy<T0>, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 103);
        ...
        assert!(!0x2::kiosk::is_listed(arg2, arg3), 106);
        let v6 = &mut v1;
        let v7 = charge_service_fee(arg0, v3, v6, arg5);
        assert!(v7 < v3, 105);
        let v8 = v3 - v7;
        let (v9, v10) = 0x2::kiosk::purchase<T0>(arg2, arg3, 0x2::coin::split<0x2::sui::SUI>(&mut v1, v8, arg5));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg1, v10);
        0x2::transfer::public_transfer<T0>(v9, v0);
