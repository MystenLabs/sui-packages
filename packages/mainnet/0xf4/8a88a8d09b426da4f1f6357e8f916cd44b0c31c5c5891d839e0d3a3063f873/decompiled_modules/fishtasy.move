module 0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::fishtasy {
    ...
    struct Records has store, key {
        ...
        request_ids: 0x2::table::Table<0x1::string::String, bool>,
    }
    ...
    entry fun add_reserve<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg3);
    ...
    entry fun add_reward<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg3);
        validate_coin_type<T0>(arg0);
    ...
    entry fun assign_primary_coin<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg2);
        arg0.coin_type = 0x1::option::some<0x1::ascii::String>(0x1::type_name::into_string(0x1::type_name::with_original_ids<T0>()));
        ...
        let v0 = PrimaryCoinAssigned{coin_type: 0x1::type_name::into_string(0x1::type_name::with_original_ids<T0>())};
        0x2::event::emit<PrimaryCoinAssigned>(v0);
    }

    entry fun avoid_halving<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: &mut Records, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::option::Option<0x1::string::String>, arg5: u64, arg6: u64, arg7: address, arg8: u64, arg9: 0x1::string::String, arg10: vector<u8>, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        validate_coin_type<T0>(arg0);
        assert!(0x2::tx_context::sender(arg12) == arg7, 1012);
        validate_request_id(arg2, arg9);
        assert!(0x2::coin::value<T0>(&arg3) >= arg6, 1003);
        assert!(0x2::clock::timestamp_ms(arg11) < arg8, 1006);
        if (arg5 == 1) {
            assert!(0x1::option::is_some<0x1::string::String>(&arg4), 1010);
        } else {
            assert!(arg5 > 0 && 0x1::option::is_none<0x1::string::String>(&arg4), 1011);
        };
        verify_avoid_halving_signature(0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::get_verifier_pubkey(arg1), arg5, arg6, arg7, arg8, arg9, arg10);
        0x2::table::add<0x1::string::String, bool>(&mut arg2.request_ids, arg9, true);
        distribute_reward<T0>(arg0, arg1, arg6, arg3, arg12);
    ...
    entry fun buy_box<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: &mut Records, arg3: u8, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        validate_coin_type<T0>(arg0);
    ...
    entry fun change_aquarium_upgrade_prices(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg3);
    ...
    entry fun change_box_prices(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg3);
        ...
        let v2 = 0;
        while (v2 < v0) {
            0x2::vec_map::insert<u8, u64>(&mut v1, ((v2 + 1) as u8), *0x1::vector::borrow<u64>(&arg2, v2));
            v2 = v2 + 1;
        };
        arg0.box_prices = v1;
    ...
    entry fun distribute_reserve<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg3);
        validate_coin_type<T0>(arg0);
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::string::utf8(b"reserve_pool_balance"));
    ...
    fun distribute_reward<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::utils::send_coin<T0>(0x2::coin::split<T0>(&mut arg3, v0, arg4), 0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::get_admin(arg1));
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg4));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Records{
            ...
            request_ids : 0x2::table::new<0x1::string::String, bool>(arg0),
        };
        let v1 = Fishtasy{
            id                      : 0x2::object::new(arg0),
        ...
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::new_configuration_and_shared(arg0);
    ...
    entry fun split_reserve<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg3);
        validate_coin_type<T0>(arg0);
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::string::utf8(b"reserve_pool_balance"));
        assert!(0x2::balance::value<T0>(v0) >= arg2, 1014);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::utils::send_coin<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v0, arg2), arg3), 0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::get_admin(arg1));
    ...
    entry fun take_reward<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::validate_admin(arg1, arg2);
        validate_coin_type<T0>(arg0);
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::balance::Balance<T0>>(&mut arg0.id, 0x1::string::utf8(b"reward_pool_balance"));
    ...
    entry fun upgrade_aquarium<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: &mut Records, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        validate_coin_type<T0>(arg0);
    ...
    fun validate_coin_type<T0>(arg0: &Fishtasy) {
        ...
        assert!(0x1::type_name::into_string(0x1::type_name::with_original_ids<T0>()) == *0x1::option::borrow<0x1::ascii::String>(&arg0.coin_type), 1001);
    }

    fun validate_request_id(arg0: &Records, arg1: 0x1::string::String) {
        assert!(!0x2::table::contains<0x1::string::String, bool>(&arg0.request_ids, arg1), 1015);
    }

    fun verify_avoid_halving_signature(arg0: vector<u8>, arg1: u64, arg2: u64, arg3: address, arg4: u64, arg5: 0x1::string::String, arg6: vector<u8>) {
        let v0 = b"FISHTASY";
        ...
        assert!(0x2::ed25519::ed25519_verify(&arg6, &arg0, &v0), 1005);
    }

    fun verify_withdraw_signature(arg0: vector<u8>, arg1: u64, arg2: address, arg3: u64, arg4: 0x1::string::String, arg5: vector<u8>) {
        let v0 = b"FISHTASY";
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<u64>(&arg1));
    ...
    entry fun withdraw<T0>(arg0: &mut Fishtasy, arg1: &0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::Configuration, arg2: &mut Records, arg3: u64, arg4: address, arg5: u64, arg6: 0x1::string::String, arg7: vector<u8>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::check_package_version(arg1);
        validate_coin_type<T0>(arg0);
        assert!(0x2::tx_context::sender(arg9) == arg4, 1012);
        validate_request_id(arg2, arg6);
        assert!(0x2::clock::timestamp_ms(arg8) < arg5, 1006);
        verify_withdraw_signature(0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::configuration::get_verifier_pubkey(arg1), arg3, arg4, arg5, arg6, arg7);
        ...
        assert!(0x2::balance::value<T0>(v0) >= arg3, 1014);
        0xf48a88a8d09b426da4f1f6357e8f916cd44b0c31c5c5891d839e0d3a3063f873::utils::send_coin<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(v0, arg3), arg9), arg4);
        0x2::table::add<0x1::string::String, bool>(&mut arg2.request_ids, arg6, true);
