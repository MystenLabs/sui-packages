module 0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::order_book {
    ...
    public(friend) fun get_dimed_price(arg0: &OrderBook, arg1: &0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::parameters::Parameters, arg2: u64, arg3: bool, arg4: u64) : u64 {
        if (arg3) {
            let v0 = 0;
            while (v0 < 0x1::vector::length<u64>(&arg0.bid_prices)) {
                ...
                if (*0x1::vector::borrow<u64>(&arg0.bid_quantities, v0) < 0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::parameters::minimum_considered_volume(arg1)) {
                    v0 = v0 + 1;
                    continue
                };
                return v1 + arg4
            ...
            while (v2 < 0x1::vector::length<u64>(&arg0.ask_prices)) {
                ...
                if (*0x1::vector::borrow<u64>(&arg0.ask_quantities, v2) < 0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::parameters::minimum_considered_volume(arg1)) {
                    v2 = v2 + 1;
                    continue
                };
                return v3 - arg4
    ...
    public(friend) fun get_order_book_without_our_orders(arg0: &0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::parameters::Parameters, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg2: &vector<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>, arg3: u64, arg4: &0x2::clock::Clock) : OrderBook {
        ...
        while (v8 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(arg2)) {
            ...
            let (v10, v11, _) = 0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::common::decode_order_id(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v9));
            let v13 = v11;
            if (v10) {
        ...
        while (v22 < 0x1::vector::length<u64>(&v7)) {
            if (*0x1::vector::borrow<u64>(&v6, v22) < 0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::parameters::minimum_considered_volume(arg0)) {
                v22 = v22 + 1;
            } else {
                break
            };
        ...
        while (v23 < 0x1::vector::length<u64>(&v5)) {
            if (*0x1::vector::borrow<u64>(&v4, v23) < 0xf4048f2d63fe581056f200fcd343c1ab0fc059a5e94255eeee76c509e490b1ae::parameters::minimum_considered_volume(arg0)) {
                v23 = v23 + 1;
            } else {
                break
            };
