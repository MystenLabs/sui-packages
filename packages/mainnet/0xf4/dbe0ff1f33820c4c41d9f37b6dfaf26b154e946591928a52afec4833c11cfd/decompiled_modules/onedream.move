module 0xf4dbe0ff1f33820c4c41d9f37b6dfaf26b154e946591928a52afec4833c11cfd::onedream {
    ...
    fun init(arg0: ONEDREAM, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ONEDREAM>(arg0, 9, trim_right(b"ONEDREAM"), trim_right(b"ONEDREAM "), trim_right(b"ONEDREAM  "), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreial2xyjmbuastq7cqhasfc4sq55rmsrvu6mpol4k7xympvfmnlw7i"))), arg1);
        let v2 = v0;
