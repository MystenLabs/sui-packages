module 0xf483bbcfc66ec469278c497a3fb7118d2f338eab3f583e4543b30228cff74fe9::useful_coin {
    ...
    public fun update_manager(arg0: &mut CapManager<USEFUL_COIN>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.manager || arg0.manager != arg1, 0);
        arg0.manager = arg1;
    }
