module 0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::kiosk_nft_offers {
    ...
    public fun get_owner(arg0: &0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse) : address {
        0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::get_owner(arg0)
    }

    public fun accept_nft_offer<T0: store + key, T1>(arg0: &mut Kiosk_Offers_Store, arg1: &mut 0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg7);
        assert!(0x2::object::id<0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
    ...
    public entry fun add_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Offers_Store, arg1: &0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse, arg2: address, arg3: u16, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_and_share_kiosk_offers_store(arg0: &0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse, arg1: u16, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Kiosk_Offers_Store>(create_kiosk_offers_store(arg0, arg1, arg2));
    }

    public fun create_kiosk_offers_store(arg0: &0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse, arg1: u16, arg2: &mut 0x2::tx_context::TxContext) : Kiosk_Offers_Store {
        validate_fee_bps(arg1);
        let v0 = 0x2::object::new(arg2);
        let v1 = Kiosk_Offers_Store{
            id               : v0,
            auction_house    : 0x2::object::id<0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse>(arg0),
    ...
    public entry fun remove_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Offers_Store, arg1: &0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::object::id<0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(get_owner(arg1) == v0, 1);
        let v1 = get_collection_type<T0>();
    ...
    public entry fun update_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Offers_Store, arg1: &0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse, arg2: address, arg3: u16, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        assert!(0x2::object::id<0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(get_owner(arg1) == v0, 1);
    ...
    public entry fun update_global_fee(arg0: &mut Kiosk_Offers_Store, arg1: &0xf4b0b8ad07a41be9d844de4d917bea443d9889502cc14233a3fc1c9d78c0cd96::auctionhouse::AuctionHouse, arg2: u16, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
