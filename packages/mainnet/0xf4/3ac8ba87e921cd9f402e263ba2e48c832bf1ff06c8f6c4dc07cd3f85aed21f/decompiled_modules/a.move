module 0xf43ac8ba87e921cd9f402e263ba2e48c832bf1ff06c8f6c4dc07cd3f85aed21f::a {
    struct A has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: A, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<A>(arg0, 9, trim_right(b"B"), trim_right(b"A"), trim_right(b""), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b" "))), arg1);
        let v2 = v0;
