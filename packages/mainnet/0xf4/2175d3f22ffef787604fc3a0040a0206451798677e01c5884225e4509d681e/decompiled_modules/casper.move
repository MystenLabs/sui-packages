module 0xf42175d3f22ffef787604fc3a0040a0206451798677e01c5884225e4509d681e::casper {
    ...
    fun init(arg0: CASPER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/AjzTVTctPAVwcLbVaP67uv2H35QqTuq1LWkptv64gdog.png                                                                                                                                                                                                                               ");
