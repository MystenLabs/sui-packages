module 0xf4f04d93ed14f584fed31dc593eff268b468c6c1d27640206d73c53892be5158::five_minutes {
    ...
    entry fun getRound(arg0: &Round, arg1: u64) : (u64, u64, u8, u64, vector<vector<u8>>, vector<vector<u8>>, vector<vector<u8>>, vector<u8>) {
    ...
    entry fun latestRound(arg0: &Round) : (u64, u64, u8, u64, vector<vector<u8>>, vector<vector<u8>>, vector<vector<u8>>, vector<u8>) {
        let v0 = 0x2::table::length<u64, RoundMetadata>(&arg0.rounds);
        (0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).end_time_ms, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).start_time_ms, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).status, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).round, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).seed, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).proof, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).outputs, 0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0).draw_numbers)
    }
