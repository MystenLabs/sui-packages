module 0xf447cb937056dad287b30c39aa766bed0be138cbc88f84a35244cf3cf4ddf3fc::cnsnft8786 {
    struct CNSNFT8786 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8786, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8786>(arg0, arg1);
