module 0xf4b71e4fbe8096b8202a1fe175f5a616bcc7400c6f2d75b59b31bb37b9cede78::canvas {
    ...
    entry fun mint(arg0: &mut GlobalState, arg1: &0x2::random::Random, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 400;
        let v7 = 0;
        let v8 = render_canvas_svg(&v4, v2);
        let v9 = encode_base64(*0x1::string::as_bytes(&v8));
        let v10 = 0x1::string::utf8(b"data:image/svg+xml;base64,");
        0x1::string::append(&mut v10, v9);
        let v11 = 0x1::string::utf8(b"Imagine Canvas #");
        0x1::string::append(&mut v11, u64_to_str(arg0.total_supply));
        let v12 = Attribute{
        ...
        let v15 = 0x1::vector::empty<Attribute>();
        let v16 = &mut v15;
        0x1::vector::push_back<Attribute>(v16, v12);
        0x1::vector::push_back<Attribute>(v16, v13);
        0x1::vector::push_back<Attribute>(v16, v14);
        let v17 = NFTAttributes{contents: v15};
        let v18 = CanvasNFT{
        ...
        0x2::transfer::public_transfer<CanvasNFT>(v18, 0x2::tx_context::sender(arg3));
    }
    ...
    fun render_canvas_svg(arg0: &vector<u8>, arg1: u8) : 0x1::string::String {
    ...
    fun update_visuals(arg0: &mut CanvasNFT) {
        let v0 = render_canvas_svg(&arg0.pixels, arg0.palette_tier);
