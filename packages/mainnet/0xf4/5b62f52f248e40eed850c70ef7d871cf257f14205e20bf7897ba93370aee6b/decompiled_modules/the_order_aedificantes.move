module 0xf45b62f52f248e40eed850c70ef7d871cf257f14205e20bf7897ba93370aee6b::the_order_aedificantes {
    struct THE_ORDER_AEDIFICANTES has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: THE_ORDER_AEDIFICANTES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<THE_ORDER_AEDIFICANTES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"The Order Aedificantes"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Order Aedificantes collection is an exclusive ensemble of unique 1-of-1 NFTs, bestowed upon the foundational builders and visionaries who have shaped the Sui ecosystem. Each piece serves as a tribute to their pivotal contributions and enduring legacy in crafting the future"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://jtCd_MyX0j1LfFDyEdP5R6xwdzmxgfyjyQjbRj5NI94"));
