module 0xb006bd91a0b4961dc8a2ca276715c3b8a12a484890e79b79225765f628a97e73::atlansui {
    ...
    public fun cancel_offer_with_scallop_admin_new<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, arg1), 2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Collection<T0, T1>>(&mut arg0.id, arg1);
        let v2 = 0x2::vec_map::get_mut<address, Offers>(&mut v1.offers, &arg3);
        assert!(v2.counter > arg2, 104);
        let v3 = 0x2::object_table::remove<u64, Offer>(&mut v2.offers, arg2);
        assert!(v0 == @0xaeb9024621fed36d03a326d091d6de75040aad71b189e1d34bf578f17e911e0a, 401);
        assert!(!v3.is_started, 103);
        ...
        let v20 = 0x2::coin::from_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v19, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>>(v20, v0);
        0x2::object::delete(v14);
        0x2::object::delete(v17);
        v1.total_value = v1.total_value - v10;
        v1.total_scoin_value = v1.total_scoin_value - 0x2::coin::value<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(&v20);
        if (0x1::option::contains<address>(&v1.best_offer_user, &arg3) && v1.best_idx == arg2) {
            v1.best_offer_value = 0;
            let v21 = 0x2::vec_map::keys<address, Offers>(&v1.offers);
            while (0x1::vector::length<address>(&v21) > 0) {
                let v22 = 0x1::vector::pop_back<address>(&mut v21);
