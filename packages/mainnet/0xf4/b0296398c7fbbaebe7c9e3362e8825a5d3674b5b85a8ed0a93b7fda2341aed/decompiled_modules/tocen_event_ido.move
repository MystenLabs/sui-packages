module 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::tocen_event_ido {
    ...
    public fun init_ido(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PoolDeposit{
            timestamp_start : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_time_start_private(),
            timestamp_end   : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_time_end_private(),
            user_buy_min    : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_user_buy_min_private(),
            user_buy_max    : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_user_buy_max_private(),
            total_sale      : 0,
            supply          : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_supply_private(),
        };
        let v1 = PoolDeposit{
            timestamp_start : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_time_start_public(),
            timestamp_end   : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_time_end_public(),
            user_buy_min    : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_user_buy_min_public(),
            user_buy_max    : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_user_buy_max_public(),
            total_sale      : 0,
            supply          : 0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::utils::get_supply_public(),
        };
        let v2 = TocenIdoData{
    ...
    public entry fun update_time_private(arg0: &mut TocenIdoData, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::witness::check_owner(arg3), 1);
        if (arg1 == 1) {
    ...
    public entry fun withraw(arg0: &mut TocenIdoData, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0xf4b0296398c7fbbaebe7c9e3362e8825a5d3674b5b85a8ed0a93b7fda2341aed::witness::check_owner(arg2), 1);
