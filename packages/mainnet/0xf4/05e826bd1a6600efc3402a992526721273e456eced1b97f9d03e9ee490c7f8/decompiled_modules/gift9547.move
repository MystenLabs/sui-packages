module 0xf405e826bd1a6600efc3402a992526721273e456eced1b97f9d03e9ee490c7f8::gift9547 {
    struct GIFT9547 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift9547(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT9547, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9547>(arg0, arg1);
