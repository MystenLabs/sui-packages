module 0xf4e7e9c5a9a5489b6e085f427ed2d19417840ef1a9760376124c64e0d10c5065::neo {
    struct NEO has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NEO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/D9mCVAP9eby1NSUkyDKJHWfCPvQQyTDHTiPY5Ddopump.png?size=lg&key=12fc15                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<NEO>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"NEO       ")))), trim_right(b"NEO AI                          "), trim_right(b"MAKE TRADING MORE PROFITABLE WITH NEO AI                                                                                                                                                                                                                                                                                        "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
