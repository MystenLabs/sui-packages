module 0xf4a1d39e207110d3abe05c9df7e89844ec56fe2b85d86b674cc018a336a030d8::executor_option {
    ...
    public fun decode_lz_compose_option(arg0: vector<u8>) : LzComposeOption {
        ...
        let v2 = if (v0 == 34) {
            0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::read_u128(&mut v1)
        } else {
            0
        };
        LzComposeOption{
            index : 0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::read_u16(&mut v1),
            gas   : 0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::read_u128(&mut v1),
            value : v2,
        }
    }
    ...
    public fun decode_native_drop_option(arg0: vector<u8>) : NativeDropOption {
        ...
        NativeDropOption{
            amount   : 0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::read_u128(&mut v0),
    ...
    public fun next_executor_option(arg0: &mut 0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::Reader) : (u8, vector<u8>) {
        0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::skip(arg0, 1);
        (0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::read_u8(arg0), 0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::read_fixed_len_bytes(arg0, ((0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::read_u16(arg0) - 1) as u64)))
    }
    ...
    public fun parse_executor_options(arg0: vector<u8>, arg1: bool, arg2: u128) : ExecutorOptionsAgg {
        ...
        let v2 = 0;
        while (0xd35b1f15a0d77503d17611e52f9ef602192fed38bd5a6f30ceea390adb000dc0::buffer_reader::remaining_length(&v0) > 0) {
            let v3 = &mut v0;
