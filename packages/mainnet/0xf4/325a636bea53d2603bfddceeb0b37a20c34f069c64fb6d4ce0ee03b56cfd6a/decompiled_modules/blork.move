module 0xf4325a636bea53d2603bfddceeb0b37a20c34f069c64fb6d4ce0ee03b56cfd6a::blork {
    ...
    fun init(arg0: BLORK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifgthrsxwtiijneuvtqz25fx7hmxiej4xbbahhpgytjqnxgttckmi"));
