module 0xf44e7d8dd8d9a8532e0844485f1f522934c5bfb321b2ef32aed949cc9d0b29f8::cnsnft8063 {
    struct CNSNFT8063 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8063, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8063>(arg0, arg1);
