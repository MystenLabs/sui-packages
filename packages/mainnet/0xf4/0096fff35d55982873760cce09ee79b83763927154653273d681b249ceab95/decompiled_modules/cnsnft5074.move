module 0xf40096fff35d55982873760cce09ee79b83763927154653273d681b249ceab95::cnsnft5074 {
    struct CNSNFT5074 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5074, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5074>(arg0, arg1);
