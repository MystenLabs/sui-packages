module 0xf41799cb1372d01e7dcceb1206f5d75e16fb40f6695ed89d5218cfc8aa1e7266::reward6557 {
    struct REWARD6557 has drop {
        dummy_field: bool,
    }

    struct TICKET_6557 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6557(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6557>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6557>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6557, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6557>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6557>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6557>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6557>>(v5, 0x2::tx_context::sender(arg1));
    }
