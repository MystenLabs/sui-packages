module 0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::game {
    ...
    struct GameInfo has key {
        id: 0x2::object::UID,
        version: u8,
        balance: 0x2::balance::Balance<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>,
        init_reward: u64,
    ...
    struct PlayerInfo has store, key {
        ...
        fisherman_level: u64,
        fisherman_speed: u64,
        fisherman_item: 0x1::string::String,
        sea_level: u64,
        sea_reward: u64,
        board_level: u64,
        board_peroid: u64,
    ...
    entry fun add_treasury_cap(arg0: &mut GameInfo, arg1: 0x2::coin::TreasuryCap<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>, arg2: &0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 4);
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::TreasuryCap<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury"), arg1);
    }
    ...
    entry fun create_user(arg0: &mut GameInfo, arg1: address, arg2: address, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version <= 1, 2);
        assert!(arg0.owner == 0x2::tx_context::sender(arg11), 4);
        ...
        if (v3 > 0) {
            send_tokens(arg0, arg1, v3, arg11);
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = GameInfo{
            ...
            version      : 1,
            balance      : 0x2::balance::zero<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>(),
    ...
    entry fun remove_treasury_cap(arg0: &mut GameInfo, arg1: &0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>>(0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::TreasuryCap<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), 0x2::tx_context::sender(arg1));
    }

    fun send_tokens(arg0: &mut GameInfo, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>(&arg0.balance);
        let v1 = 0;
        if (v0 >= arg2) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>>(0x2::coin::from_balance<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>(0x2::balance::split<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>(&mut arg0.balance, arg2), arg3), arg1);
        } else if (v0 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>>(0x2::coin::from_balance<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>(0x2::balance::withdraw_all<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>(&mut arg0.balance), arg3), arg1);
            v1 = arg2 - v0;
        } else {
            v1 = arg2;
        };
        if (v1 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>>(0x2::coin::mint<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::coin::TreasuryCap<0xf4286b6ca5a6c612e1362fd4e43bd4a30ffc0d564e4889bb1a3dde90b84a1ccf::wsm::WSM>>(&mut arg0.id, 0x1::string::utf8(b"treasury")), v1, arg3), arg1);
        };
    }
