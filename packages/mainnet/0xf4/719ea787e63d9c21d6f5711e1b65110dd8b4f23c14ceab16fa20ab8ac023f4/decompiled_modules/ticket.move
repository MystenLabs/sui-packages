module 0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::ticket {
    ...
    public(friend) fun add_lucky_numbers(arg0: &mut 0x2::vec_map::VecMap<0x2::object::ID, TicketInfo>, arg1: vector<u8>, arg2: 0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::prize::PrizeLevelDistribution, arg3: u64) {
        let v0 = 0;
        while (v0 < 0x2::vec_map::size<0x2::object::ID, TicketInfo>(arg0)) {
            ...
            let v4 = 0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::helper::calc_prize_level(&arg1, &v3);
            v2.lucky_number = 0x1::option::some<vector<u8>>(arg1);
            v2.prize_level = 0x1::option::some<u8>(v4);
            v2.prize_bonus = 0x1::option::some<u64>(0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::prize::get_prize_level_amount(&arg2, v4));
    ...
    public(friend) fun generate_a_ticket_number(arg0: &0x2::random::Random, arg1: &mut 0x2::tx_context::TxContext) : u8 {
        0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::helper::generate_u8(arg0, arg1, 0, 9)
    }
    ...
    public fun split_prize_level_by_lucky_number(arg0: vector<TicketInfo>, arg1: vector<u8>) : 0x2::vec_map::VecMap<u8, vector<0x2::object::ID>> {
        ...
        while (v1 < 0x1::vector::length<TicketInfo>(&arg0)) {
            ...
            let v3 = 0xf4719ea787e63d9c21d6f5711e1b65110dd8b4f23c14ceab16fa20ab8ac023f4::helper::calc_prize_level(&arg1, &v2.ticket_number);
