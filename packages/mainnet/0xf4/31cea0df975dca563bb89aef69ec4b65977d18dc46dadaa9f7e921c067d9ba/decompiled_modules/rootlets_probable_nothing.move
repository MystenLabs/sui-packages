module 0xf431cea0df975dca563bb89aef69ec4b65977d18dc46dadaa9f7e921c067d9ba::rootlets_probable_nothing {
    struct ROOTLETS_PROBABLE_NOTHING has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"07060557-96a8-4028-926c-f4bf7d0a2e35"),
        };
    ...
    fun init(arg0: ROOTLETS_PROBABLE_NOTHING, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ROOTLETS_PROBABLE_NOTHING>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Rootlets.probable.nothing"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Probably nothing I believe "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmTkABF5Tk6JT6HZyCpNc2GyGuCCdGxxzC4QBdzy2GQxf3"));
