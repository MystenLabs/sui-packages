module 0xf43cc96bff62488ae7c5e4d4d43d820e1e79942e0227f680d65e44efc9149181::cnsnft4053 {
    struct CNSNFT4053 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4053, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4053>(arg0, arg1);
