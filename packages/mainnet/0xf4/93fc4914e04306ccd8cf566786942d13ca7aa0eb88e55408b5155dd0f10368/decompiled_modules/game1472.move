module 0xf493fc4914e04306ccd8cf566786942d13ca7aa0eb88e55408b5155dd0f10368::game1472 {
    struct GAME1472 has drop {
        dummy_field: bool,
    }

    struct TICKET_1472 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1472(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1472>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1472>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME1472, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME1472>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1472>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1472>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1472>>(v5, 0x2::tx_context::sender(arg1));
    }
