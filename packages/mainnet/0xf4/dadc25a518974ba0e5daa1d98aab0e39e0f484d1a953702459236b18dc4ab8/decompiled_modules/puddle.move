module 0xf4dadc25a518974ba0e5daa1d98aab0e39e0f484d1a953702459236b18dc4ab8::puddle {
    ...
    public entry fun arbitrage<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0xf4dadc25a518974ba0e5daa1d98aab0e39e0f484d1a953702459236b18dc4ab8::admin::TeamFunds, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xf4dadc25a518974ba0e5daa1d98aab0e39e0f484d1a953702459236b18dc4ab8::cetus_invest::arbitrage<T0, T1>(arg2, arg3, v1, arg4, arg5, arg6);
        ...
        if (v3 < 0x2::balance::value<T1>(&v2)) {
            ...
            0xf4dadc25a518974ba0e5daa1d98aab0e39e0f484d1a953702459236b18dc4ab8::admin::deposit<T1>(0x2::balance::split<T1>(&mut v2, v4 * 5 / 1000), arg7, arg8);
    ...
    public entry fun invest<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::contains<0x2::object::ID>(&arg1.investments.invests, &v0)) {
            ...
            0x2::balance::join<T0>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0), 0xf4dadc25a518974ba0e5daa1d98aab0e39e0f484d1a953702459236b18dc4ab8::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
            ...
            0x2::bag::add<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0, 0xf4dadc25a518974ba0e5daa1d98aab0e39e0f484d1a953702459236b18dc4ab8::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
            0x1::debug::print<0x2::balance::Balance<T0>>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balance_bag, v0));
        };
    }
    ...
    public entry fun buy_shares<T0: drop>(arg0: &mut Puddles<T0>, arg1: &mut SaleItem<T0>, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, v5) = 0x1::vector::index_of<0x2::object::ID>(&arg0.market_info.items, &v3);
        0x1::vector::swap_remove<0x2::object::ID>(&mut arg0.market_info.items, v5);
        v0.owner = v1;
