module 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_concord_adapter {
    ...
    public fun allocate_to_lending_vault<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &mut 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CcamProcessorCap, arg3: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg4: &0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_offer_book::OfferBook, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<ConcordAdapter<T0, T1>>(arg0);
        let v1 = 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::push_to_adapter<T0>(arg1, arg2, 0x2::object::id_to_address(&v0), arg5, arg7, arg8);
    ...
    fun assert_admin<T0, T1>(arg0: &ConcordAdapter<T0, T1>, arg1: &ConcordAdapterAdminCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.adapter_id == 0x2::object::id<ConcordAdapter<T0, T1>>(arg0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::unauthorized());
        assert_version<T0, T1>(arg0);
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::unauthorized());
    }

    fun assert_escrow_processor<T0, T1>(arg0: &ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &0x2::tx_context::TxContext) {
        assert_version<T0, T1>(arg0);
        assert!(arg0.escrow_id == 0x2::object::id<0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>>(arg1), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_caller_not_escrow());
        assert!(0x2::tx_context::sender(arg2) == 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::get_processor<T0>(arg1), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_caller_not_escrow());
    }

    fun assert_version<T0, T1>(arg0: &ConcordAdapter<T0, T1>) {
        assert!(arg0.version == 5, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::wrong_version());
    }
    ...
    public fun deposit<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg3: &0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_offer_book::OfferBook, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert_escrow_processor<T0, T1>(arg0, arg1, arg7);
        assert!(!arg0.paused, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_paused());
        let v0 = vault_addr<T0, T1, T2>(arg2);
        assert!(is_vault_allowed_internal<T0, T1>(arg0, v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_vault_not_allowed());
        let v1 = 0x2::coin::value<T0>(&arg4);
        assert!(v1 > 0, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_amount());
        assert!(0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::preview_deposit<T0, T1, T2>(arg2, v1) >= arg5, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_slippage_too_high());
        ...
        assert!(v4 >= arg5, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_slippage_too_high());
    ...
    public fun execute<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg3: u32, arg4: RedeemParams, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg3 == 2, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        assert!(vault_addr<T0, T1, T2>(arg2) == arg4.vault, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        execute_redeem<T0, T1, T2>(arg0, arg1, arg2, arg4.shares, arg4.min_assets_out, arg5, arg6)
    }

    public fun execute_deposit<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg3: &0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_offer_book::OfferBook, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        deposit<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }

    public fun execute_deposit_action<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg3: &0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_offer_book::OfferBook, arg4: DepositParams, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(vault_addr<T0, T1, T2>(arg2) == arg4.vault, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        execute_deposit<T0, T1, T2>(arg0, arg1, arg2, arg3, arg5, arg4.min_shares_out, arg6, arg7);
    }

    public fun execute_redeem<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun execute_redeem_same_asset<T0, T1: key>(arg0: &mut ConcordAdapter<T0, T0>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T0, T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
    ...
    public fun migrate<T0, T1>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &ConcordAdapterAdminCap) {
        assert!(arg1.adapter_id == 0x2::object::id<ConcordAdapter<T0, T1>>(arg0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::unauthorized());
        assert!(arg0.version < 5, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::not_upgrade());
        arg0.version = 5;
    }
    ...
    public fun push_and_execute<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &mut 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CcamProcessorCap, arg3: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg4: &0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_offer_book::OfferBook, arg5: u64, arg6: u32, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg6 == 1, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
    ...
    public fun redeem<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(!arg0.paused, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_paused());
        assert!(arg3 > 0, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_zero_shares());
        let v0 = vault_addr<T0, T1, T2>(arg2);
        assert!(is_vault_allowed_internal<T0, T1>(arg0, v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_vault_not_allowed());
        assert!(0x2::table::contains<address, 0x2::bag::Bag>(&arg0.share_bags, v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_no_position());
        ...
        assert!(v1 >= arg4, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_slippage_too_high());
        ...
        if (0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::is_collateral_mode<T0, T1, T2>(arg2)) {
            abort 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument()
        };
        ...
        assert!(0x2::coin::value<T0>(&v4) >= arg4, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_slippage_too_high());
        if (0x2::table::contains<address, Position>(&arg0.positions, v0)) {
            let v5 = 0x2::table::borrow_mut<address, Position>(&mut arg0.positions, v0);
    ...
    public fun redeem_collateral<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T1, T2>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert_escrow_processor<T0, T1>(arg0, arg1, arg6);
        assert!(!arg0.paused, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_paused());
        assert!(arg3 > 0, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_zero_shares());
        let v0 = vault_addr<T0, T1, T2>(arg2);
        assert!(is_vault_allowed_internal<T0, T1>(arg0, v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_vault_not_allowed());
        assert!(0x2::table::contains<address, 0x2::bag::Bag>(&arg0.share_bags, v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_no_position());
        assert!(0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::is_collateral_mode<T0, T1, T2>(arg2), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        ...
        assert!(0x2::coin::value<T1>(&v4) >= arg4, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_slippage_too_high());
        if (0x2::table::contains<address, Position>(&arg0.positions, v0)) {
            let v5 = 0x2::table::borrow_mut<address, Position>(&mut arg0.positions, v0);
            let v6 = if (v5.shares_received > arg3) {
                v5.shares_received - arg3
    ...
    public fun redeem_same_asset<T0, T1: key>(arg0: &mut ConcordAdapter<T0, T0>, arg1: &0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_cross_chain_asset_manager::CrossChainAssetManager<T0>, arg2: &mut 0x38887fa7aa3bedeb6964bdf271bd1415b032b8606fcc23ec687c13ddfde8721b::concord_lending_vault::LendingVault<T0, T0, T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        assert!(is_vault_allowed_internal<T0, T0>(arg0, v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_vault_not_allowed());
        assert!(0x2::table::contains<address, 0x2::bag::Bag>(&arg0.share_bags, v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_no_position());
        ...
        let v5 = v4;
        assert!(0x2::coin::value<T0>(&v5) >= arg4, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_slippage_too_high());
        if (0x2::table::contains<address, Position>(&arg0.positions, v0)) {
    ...
    fun take_custodied_shares<T0, T1, T2: key>(arg0: &mut ConcordAdapter<T0, T1>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        let v0 = 0x2::table::borrow_mut<address, 0x2::bag::Bag>(&mut arg0.share_bags, arg1);
        let v1 = ShareCustodyKey<T2>{dummy_field: false};
        assert!(0x2::bag::contains<ShareCustodyKey<T2>>(v0, v1), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::adapter_no_position());
