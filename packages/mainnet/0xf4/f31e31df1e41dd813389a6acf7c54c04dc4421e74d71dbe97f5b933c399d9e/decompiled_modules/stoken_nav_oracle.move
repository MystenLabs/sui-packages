module 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_nav_oracle {
    ...
    public fun accept_cooldown<T0>(arg0: &mut NavOracle<T0>, arg1: &NavOracleManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.nav_oracle_id == 0x2::object::id<NavOracle<T0>>(arg0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::unauthorized());
    ...
    public fun accept_nav_provider<T0>(arg0: &mut NavOracle<T0>, arg1: &NavOracleManagerCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert_version<T0>(arg0);
        assert!(0x2::tx_context::sender(arg3) == arg0.manager, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::unauthorized());
        assert!(0x1::option::is_some<PendingNavProvider>(&arg0.pending_nav_provider), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::no_pending_roles_change());
        let v0 = 0x1::option::extract<PendingNavProvider>(&mut arg0.pending_nav_provider);
        assert!(now_secs(arg2) >= v0.proposed_at + arg0.nav_provider_change_cooldown_secs, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::role_change_timelock_active());
    ...
    public fun create_nav_oracle<T0>(arg0: 0x2::object::ID, arg1: address, arg2: address, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (NavOracleAdminCap, NavOracleManagerCap, NavOracleProviderCap) {
        ...
        assert!(arg3 >= 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_math::min_cooldown_secs() && arg3 <= 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_math::max_cooldown_secs(), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        let v0 = NavOracle<T0>{
    ...
    public fun propose_nav_provider<T0>(arg0: &mut NavOracle<T0>, arg1: &NavOracleManagerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(arg2 != 0x2::object::id_to_address(&v0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        assert!(arg2 != 0x2::object::id_to_address(&arg0.vault_id), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        assert!(arg2 != arg0.nav_provider, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::governance_no_op());
        assert!(0x1::option::is_none<PendingNavProvider>(&arg0.pending_nav_provider), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::governance_no_op());
    ...
    public fun update_vault_price_from_nav<T0, T1>(arg0: &mut NavOracle<T0>, arg1: &mut 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_vault::Vault<T0, T1>, arg2: &NavOracleProviderCap, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert_version<T0>(arg0);
        ...
        assert!(arg2.nav_oracle_id == 0x2::object::id<NavOracle<T0>>(arg0), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::unauthorized());
        assert!(0x2::tx_context::sender(arg5) == arg0.nav_provider, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::unauthorized());
        let v0 = 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_vault::total_shares<T0, T1>(arg1);
        assert!(v0 > 0, 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_errors::invalid_argument());
        let v1 = 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_math::mul_div(arg3 + 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_vault::total_idle<T0, T1>(arg1), 0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_math::price_precision(), v0);
        ...
        0xaba12ff07741a77fa678d8a37cb0dffc8b148217fadc214747346800fe68a3b1::stoken_vault::update_price_from_oracle_service<T0, T1>(arg1, v1, arg4);
    }
