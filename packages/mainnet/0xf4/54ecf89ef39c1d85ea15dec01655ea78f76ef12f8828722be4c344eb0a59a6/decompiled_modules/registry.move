module 0xf454ecf89ef39c1d85ea15dec01655ea78f76ef12f8828722be4c344eb0a59a6::registry {
    ...
    public(friend) fun add(arg0: u16, arg1: 0x2::object::ID, arg2: &mut Registry) {
        ...
        if ((0x2::table::length<u16, 0x2::object::ID>(&arg2.pfps) as u16) == 0xf454ecf89ef39c1d85ea15dec01655ea78f76ef12f8828722be4c344eb0a59a6::collection::size()) {
            arg2.is_initialized = true;
        };
    }

    public fun admin_freeze_registry(arg0: &0xf454ecf89ef39c1d85ea15dec01655ea78f76ef12f8828722be4c344eb0a59a6::admin::AdminCap, arg1: Registry, arg2: &0x2::tx_context::TxContext) {
    ...
    public fun pfp_id_from_number(arg0: u16, arg1: &Registry) : 0x2::object::ID {
        assert!(arg0 >= 1 && arg0 <= 0xf454ecf89ef39c1d85ea15dec01655ea78f76ef12f8828722be4c344eb0a59a6::collection::size(), 1);
