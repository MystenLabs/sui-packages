module 0xf453cfcf36cbee5669c0f43d02ab419aec4e8314b9fc6c92223a04e7f2b02c6f::cnsnft2617 {
    struct CNSNFT2617 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2617, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2617>(arg0, arg1);
