module 0xf423b78d0635ceecd3c820d469d9edeb900ad585b4abaee4134f52712287f9ac::cnsnft7239 {
    struct CNSNFT7239 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7239>(arg0, arg1);
