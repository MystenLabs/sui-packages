module 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::ordered_map {
    struct Map<phantom T0> has store, key {
        id: 0x2::object::UID,
        size: u64,
        counter: u64,
        root: u64,
    ...
    struct Pair<T0> has copy, drop, store {
        key: u128,
        val: T0,
    }
    ...
    public fun empty<T0: store>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Map<T0> {
    ...
    public fun borrow<T0: store>(arg0: &Map<T0>, arg1: u128) : &T0 {
        ...
        assert!(v2 < v1, 13871369589998419972);
        let v3 = 0x1::vector::borrow<Pair<T0>>(v0, v2);
        assert!(arg1 == v3.key, 13871369598588354564);
        &v3.val
    }

    public fun borrow_mut<T0: store>(arg0: &mut Map<T0>, arg1: u128) : &mut T0 {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Leaf<T0>>(&mut arg0.id, find_leaf<T0>(arg0, arg1));
        let v1 = &v0.keys_vals;
        let v2 = 0x1::vector::length<Pair<T0>>(v1);
        let v3 = binary_search_p<T0>(v1, v2, arg1);
        assert!(v3 < v2, 13871369650127962116);
        let v4 = 0x1::vector::borrow_mut<Pair<T0>>(&mut v0.keys_vals, v3);
        assert!(arg1 == v4.key, 13871369658717896708);
        &mut v4.val
    }

    public fun destroy_empty<T0: store>(arg0: Map<T0>) {
        assert!(is_empty<T0>(&arg0), 13871931912886878216);
        let Map {
            id                 : v0,
            size               : _,
            counter            : _,
        ...
        let Leaf {
            keys_vals : v12,
            next      : _,
        } = 0x2::dynamic_field::remove<u64, Leaf<T0>>(&mut v11, v3);
        0x1::vector::destroy_empty<Pair<T0>>(v12);
        0x2::object::delete(v11);
    }

    public fun insert<T0: store>(arg0: &mut Map<T0>, arg1: u128, arg2: T0) {
        let v0 = vector[];
        let v1 = arg0.root;
    ...
    public fun remove<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u128) : T0 {
        let v0 = arg0.root;
    ...
    fun append_left<T0>(arg0: vector<T0>, arg1: &mut vector<T0>) {
        reverse<T0>(arg1);
        append_reversed_right<T0>(arg1, arg0);
        reverse<T0>(arg1);
    }

    fun append_reversed_right<T0>(arg0: &mut vector<T0>, arg1: vector<T0>) {
    ...
    fun append_right<T0: copy>(arg0: &mut vector<T0>, arg1: &vector<T0>) {
        let v0 = 0;
    ...
    public fun batch_drop<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u128, arg2: bool) {
        if (!arg2) {
            if (arg1 == 0) {
                return
            };
    ...
    fun binary_search_p<T0>(arg0: &vector<Pair<T0>>, arg1: u64, arg2: u128) : u64 {
        let v0 = 0;
        while (v0 < arg1) {
            arg1 = v0 + arg1 >> 1;
    ...
    fun binary_search_rightmost<T0>(arg0: &vector<Pair<T0>>, arg1: u64, arg2: u128) : u64 {
        let v0 = 0;
        while (v0 < arg1) {
            let v1 = v0 + arg1 >> 1;
    ...
    public fun change_params<T0>(arg0: &mut Map<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        check_map_params(arg1, arg2, arg3, arg4, arg5, arg6);
        assert!(arg0.size > 3, 13872213581137248266);
        assert!(arg1 <= arg0.branch_min && arg0.branch_max <= arg3, 13871087694114783234);
        assert!(arg4 <= arg0.leaf_min && arg0.leaf_max <= arg6, 13871087711294652418);
    ...
    fun check_map_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        assert!(2 <= arg0 && arg0 <= arg2 / 2, 13871089270367780866);
        assert!(2 * arg0 <= arg1 && arg1 <= arg2, 13871089287547650050);
        assert!(2 <= arg3 && arg3 <= (arg5 + 1) / 2, 13871089304727519234);
        assert!(2 * arg3 - 1 <= arg4 && arg4 <= arg5, 13871089321907388418);
    }

    public fun clear<T0: drop + store>(arg0: &mut Map<T0>) {
        let v0 = arg0.root;
        let v1 = v0;
        if (9223372036854775808 & v0 == 0) {
            let v2;
            ...
            loop {
                ...
                let v5 = &v4.kids;
                v3 = 0x1::vector::length<u64>(v5) - 1;
                v2 = *0x1::vector::borrow<u64>(v5, v3);
                v1 = v2;
            ...
            drop_first_leaves<T0>(arg0, v3);
            arg0.root = v2;
        };
        clear_leaf<T0>(arg0, v1);
    }

    fun clear_leaf<T0: drop + store>(arg0: &mut Map<T0>, arg1: u64) {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Leaf<T0>>(&mut arg0.id, arg1);
        v0.keys_vals = 0x1::vector::empty<Pair<T0>>();
        arg0.size = arg0.size - 0x1::vector::length<Pair<T0>>(&v0.keys_vals);
    }

    fun copy_slice<T0: copy>(arg0: &vector<T0>, arg1: u64, arg2: u64) : vector<T0> {
    ...
    fun cut_reversed_left<T0: copy + drop>(arg0: &mut vector<T0>, arg1: u64) : vector<T0> {
        let v0 = 0x1::vector::empty<T0>();
        let v1 = arg1;
        while (v1 > 0) {
            v1 = v1 - 1;
    ...
    fun cut_reversed_left1<T0: copy + drop>(arg0: &mut vector<T0>, arg1: u64) : (T0, vector<T0>) {
        let v0 = 0x1::vector::empty<T0>();
        let v1 = arg1 - 1;
        let v2 = v1;
    ...
    fun cut_reversed_right<T0>(arg0: &mut vector<T0>, arg1: u64) : vector<T0> {
        let v0 = 0x1::vector::empty<T0>();
        while (arg1 > 0) {
    ...
    fun cut_right<T0>(arg0: &mut vector<T0>, arg1: u64) : vector<T0> {
    ...
    public fun drop<T0: drop + store>(arg0: Map<T0>) {
        let v0 = &mut arg0;
        clear<T0>(v0);
        destroy_empty<T0>(arg0);
    }

    fun drop_branch<T0: drop + store>(arg0: &mut Map<T0>, arg1: u64) {
    ...
    fun drop_first<T0: drop>(arg0: &mut vector<T0>) {
    ...
    fun drop_first_leaves<T0: drop + store>(arg0: &mut Map<T0>, arg1: u64) {
        let v0 = 0;
        let v1 = arg0.first;
        while (arg1 > 0) {
    ...
    fun drop_kids<T0: drop + store>(arg0: &mut Map<T0>, arg1: u64, arg2: bool, arg3: vector<u64>) {
        if (arg1 == 0) {
            return
        };
        if (arg2) {
    ...
    fun drop_left<T0: copy + drop>(arg0: &mut vector<T0>, arg1: u64) {
        let v0 = 0x1::vector::length<T0>(arg0);
        if (2 * arg1 > v0) {
    ...
    fun drop_right<T0: drop>(arg0: &mut vector<T0>, arg1: u64) {
        while (arg1 > 0) {
            0x1::vector::pop_back<T0>(arg0);
            arg1 = arg1 - 1;
        };
    ...
    fun drop_second<T0: drop>(arg0: &mut vector<T0>) {
        let v0 = 0x1::vector::length<T0>(arg0);
        while (v0 != 2) {
            v0 = v0 - 1;
    ...
    public fun elem<T0>(arg0: &Leaf<T0>, arg1: u64) : (u128, &T0) {
        let v0 = 0x1::vector::borrow<Pair<T0>>(&arg0.keys_vals, arg1);
        (v0.key, &v0.val)
    }

    public fun elem_mut<T0>(arg0: &mut Leaf<T0>, arg1: u64) : (u128, &mut T0) {
        let v0 = 0x1::vector::borrow_mut<Pair<T0>>(&mut arg0.keys_vals, arg1);
        (v0.key, &mut v0.val)
    }

    public fun find_index<T0>(arg0: &Leaf<T0>, arg1: u128) : u64 {
        let v0 = &arg0.keys_vals;
        binary_search_p<T0>(v0, 0x1::vector::length<Pair<T0>>(v0), arg1)
    }

    public fun find_leaf<T0>(arg0: &Map<T0>, arg1: u128) : u64 {
        let v0 = arg0.root;
    ...
    public fun first_leaf_ptr<T0>(arg0: &Map<T0>) : u64 {
        arg0.first
    }

    public fun get_leaf<T0: store>(arg0: &Map<T0>, arg1: u64) : &Leaf<T0> {
        0x2::dynamic_field::borrow<u64, Leaf<T0>>(&arg0.id, arg1)
    }

    public fun get_leaf_mut<T0: store>(arg0: &mut Map<T0>, arg1: u64) : &mut Leaf<T0> {
        0x2::dynamic_field::borrow_mut<u64, Leaf<T0>>(&mut arg0.id, arg1)
    }

    public fun has_key<T0: store>(arg0: &Map<T0>, arg1: u128) : bool {
        let v0 = &0x2::dynamic_field::borrow<u64, Leaf<T0>>(&arg0.id, find_leaf<T0>(arg0, arg1)).keys_vals;
        let v1 = 0x1::vector::length<Pair<T0>>(v0);
        let v2 = binary_search_p<T0>(v0, v1, arg1);
    ...
    fun insert_into_leaf<T0>(arg0: &mut Leaf<T0>, arg1: u128, arg2: T0) : u64 {
        let v0 = &arg0.keys_vals;
        let v1 = 0x1::vector::length<Pair<T0>>(v0);
        let v2 = binary_search_p<T0>(v0, v1, arg1);
        assert!(v2 == v1 || arg1 != 0x1::vector::borrow<Pair<T0>>(v0, v2).key, 13871652443659763718);
        let v3 = Pair<T0>{
            key : arg1,
            val : arg2,
        };
    ...
    public fun is_empty<T0>(arg0: &Map<T0>) : bool {
        arg0.size == 0
    }

    fun last<T0>(arg0: &vector<T0>) : &T0 {
        0x1::vector::borrow<T0>(arg0, 0x1::vector::length<T0>(arg0) - 1)
    }

    public fun map_size<T0>(arg0: &Map<T0>) : u64 {
        arg0.size
    }

    fun merge_branches<T0>(arg0: &mut Map<T0>, arg1: u64, arg2: u128, arg3: u64) {
        let Branch {
            keys : v0,
            kids : v1,
    ...
    fun migrate_to_left_branch<T0>(arg0: &mut Map<T0>, arg1: u64, arg2: u64, arg3: u128, arg4: u64) : u128 {
    ...
    fun migrate_to_left_branch1<T0>(arg0: &mut Map<T0>, arg1: u64, arg2: u64, arg3: u128, arg4: u64) : (u128, u128, u64) {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Branch>(&mut arg0.id, arg4);
        let v1 = arg2 + 0x1::vector::length<u64>(&v0.kids);
        if (v1 <= arg0.branches_merge_max) {
            let Branch {
    ...
    fun migrate_to_right_branch<T0>(arg0: &mut Map<T0>, arg1: u64, arg2: u128, arg3: u64, arg4: u64) : u128 {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Branch>(&mut arg0.id, arg1);
    ...
    public fun min_key<T0: store>(arg0: &Map<T0>) : u128 {
        0x1::vector::borrow<Pair<T0>>(&0x2::dynamic_field::borrow<u64, Leaf<T0>>(&arg0.id, arg0.first).keys_vals, 0).key
    }

    public fun next<T0>(arg0: &Leaf<T0>) : u64 {
        arg0.next
    }

    public fun remove_at<T0>(arg0: &mut vector<T0>, arg1: u64) : T0 {
    ...
    fun remove_from_leaf<T0: store>(arg0: &mut Map<T0>, arg1: u64, arg2: u128) : (T0, u64) {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Leaf<T0>>(&mut arg0.id, arg1);
        let v1 = &v0.keys_vals;
        let v2 = 0x1::vector::length<Pair<T0>>(v1);
        let v3 = binary_search_p<T0>(v1, v2, arg2);
        assert!(v3 < v2, 13871372377432195076);
        let v4 = &mut v0.keys_vals;
        let Pair {
            key : v5,
            val : v6,
        } = remove_at<Pair<T0>>(v4, v3);
        assert!(arg2 == v5, 13871372386022129668);
        arg0.size = arg0.size - 1;
        (v6, v2 - 1)
    }
    ...
    public fun size<T0>(arg0: &Leaf<T0>) : u64 {
    ...
    fun split_leaf<T0>(arg0: &mut Leaf<T0>, arg1: &mut u64, arg2: u64) : (u64, u128, Leaf<T0>) {
        let v0 = arg2 >> 1;
    ...
    public fun try_remove<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u128) : 0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::Option<T0> {
        let v0 = arg0.root;
        if (9223372036854775808 & v0 == 0) {
            let (v1, v2) = try_remove_from_branch<T0>(arg0, v0, arg1);
            if (v2 == 1) {
                let v3 = 0x2::dynamic_field::remove<u64, Branch>(&mut arg0.id, v0);
                arg0.root = 0x1::vector::pop_back<u64>(&mut v3.kids);
            };
        ...
        let (v4, _) = try_remove_from_leaf<T0>(arg0, v0, arg1);
        v4
    }

    fun try_remove_from_branch<T0: copy + drop + store>(arg0: &mut Map<T0>, arg1: u64, arg2: u128) : (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::Option<T0>, u64) {
        let v0 = 0x2::dynamic_field::borrow<u64, Branch>(&arg0.id, arg1);
        let v1 = &v0.keys;
        let v2 = 0x1::vector::length<u128>(v1);
        let v3 = binary_search(v1, v2, arg2);
        ...
        if (9223372036854775808 & v5 == 0) {
            if (v3 < v2) {
                let v6 = v3 + 1;
                let (v7, v8) = try_remove_from_branch<T0>(arg0, v5, arg2);
                let v9 = v7;
                if (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::is_none<T0>(&v9)) {
                    return (v9, v2 + 1)
                };
                if (v8 < arg0.branch_min) {
                    let v10 = migrate_to_left_branch<T0>(arg0, v5, v8, *0x1::vector::borrow<u128>(v1, v3), *0x1::vector::borrow<u64>(v4, v6));
                    let v11 = &mut v2;
                    update_after_migration<T0>(arg0, arg1, v11, v3, v10, v6);
                };
                return (v9, v2 + 1)
            };
            let v12 = v3 - 1;
            let (v13, v14) = try_remove_from_branch<T0>(arg0, v5, arg2);
            let v15 = v13;
            if (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::is_none<T0>(&v15)) {
                return (v15, v2 + 1)
            };
            if (v14 < arg0.branch_min) {
                let v16 = migrate_to_right_branch<T0>(arg0, *0x1::vector::borrow<u64>(v4, v12), *0x1::vector::borrow<u128>(v1, v12), v5, v14);
                let v17 = &mut v2;
                update_after_migration_last<T0>(arg0, arg1, v17, v12, v16);
            };
            return (v15, v2 + 1)
        };
        if (v3 < v2) {
            let v18 = v3 + 1;
            let (v19, v20) = try_remove_from_leaf<T0>(arg0, v5, arg2);
            let v21 = v19;
            if (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::is_none<T0>(&v21)) {
                return (v21, v2 + 1)
            };
            if (v20 < arg0.leaf_min) {
                let v22 = migrate_to_left_leaf<T0>(arg0, v5, v20, *0x1::vector::borrow<u64>(v4, v18));
                let v23 = &mut v2;
                update_after_migration<T0>(arg0, arg1, v23, v3, v22, v18);
            };
            return (v21, v2 + 1)
        };
        let v24 = v3 - 1;
        let (v25, v26) = try_remove_from_leaf<T0>(arg0, v5, arg2);
        let v27 = v25;
        if (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::is_none<T0>(&v27)) {
            return (v27, v2 + 1)
        };
        if (v26 < arg0.leaf_min) {
            let v28 = migrate_to_right_leaf<T0>(arg0, *0x1::vector::borrow<u64>(v4, v24), v5, v26);
            let v29 = &mut v2;
            update_after_migration_last<T0>(arg0, arg1, v29, v24, v28);
        };
        (v27, v2 + 1)
    }

    fun try_remove_from_leaf<T0: store>(arg0: &mut Map<T0>, arg1: u64, arg2: u128) : (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::Option<T0>, u64) {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Leaf<T0>>(&mut arg0.id, arg1);
        let v1 = &v0.keys_vals;
        let v2 = 0x1::vector::length<Pair<T0>>(v1);
        let v3 = binary_search_p<T0>(v1, v2, arg2);
        if (v3 == v2 || arg2 != 0x1::vector::borrow<Pair<T0>>(v1, v3).key) {
            return (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::none<T0>(), v2)
        };
        let v4 = &mut v0.keys_vals;
        let Pair {
            key : _,
        ...
        arg0.size = arg0.size - 1;
        (0xf453864f39b7c6122551f665d4fe961b8625853cf89bcae55be4b3b99e848126::enum_option::some<T0>(v6), v2 - 1)
    }

    fun update_after_migration<T0>(arg0: &mut Map<T0>, arg1: u64, arg2: &mut u64, arg3: u64, arg4: u128, arg5: u64) {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Branch>(&mut arg0.id, arg1);
        if (arg4 == 0) {
            let v1 = &mut v0.keys;
    ...
    fun update_after_migration_last<T0>(arg0: &mut Map<T0>, arg1: u64, arg2: &mut u64, arg3: u64, arg4: u128) {
        let v0 = 0x2::dynamic_field::borrow_mut<u64, Branch>(&mut arg0.id, arg1);
        if (arg4 == 0) {
