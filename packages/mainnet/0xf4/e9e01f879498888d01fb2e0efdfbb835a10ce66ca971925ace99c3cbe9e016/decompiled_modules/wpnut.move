module 0xf4e9e01f879498888d01fb2e0efdfbb835a10ce66ca971925ace99c3cbe9e016::wpnut {
    ...
    fun init(arg0: WPNUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CopKnqjztCoRRgXzHNkLafSwvtX33x1PrWPRsHjfpump.png?size=lg&key=010114                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<WPNUT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WPNUT   ")))), trim_right(b"WIF PNUT                        "), trim_right(b"The next DOGWIFHAT is here. WIFPNUT!                                                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
