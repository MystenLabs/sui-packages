module 0xf4af24cc6346a2bc0e524fca680e202d560516a6e0efbf232d418d3ccaa195dd::cnsnft1611 {
    struct CNSNFT1611 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1611, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1611>(arg0, arg1);
