module 0xf4acbdd077e82a1a229490f95423f7dff14fb74b34ce01bfe6579260d74105c0::cnsnft9361 {
    struct CNSNFT9361 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9361, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9361>(arg0, arg1);
