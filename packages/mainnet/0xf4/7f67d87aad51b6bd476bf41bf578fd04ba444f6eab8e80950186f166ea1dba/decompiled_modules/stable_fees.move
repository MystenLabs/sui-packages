module 0xf47f67d87aad51b6bd476bf41bf578fd04ba444f6eab8e80950186f166ea1dba::stable_fees {
    ...
    public fun update_admin_fee_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        assert!(200000000000000000 >= v0, 0xf47f67d87aad51b6bd476bf41bf578fd04ba444f6eab8e80950186f166ea1dba::errors::invalid_fee());
    ...
    public fun update_fee_in_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        let v0 = 0x1::option::extract<u256>(&mut arg1);
        assert!(20000000000000000 >= v0, 0xf47f67d87aad51b6bd476bf41bf578fd04ba444f6eab8e80950186f166ea1dba::errors::invalid_fee());
