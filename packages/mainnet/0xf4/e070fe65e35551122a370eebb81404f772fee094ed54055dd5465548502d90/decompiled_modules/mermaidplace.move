module 0xf4e070fe65e35551122a370eebb81404f772fee094ed54055dd5465548502d90::mermaidplace {
    ...
    public entry fun buy<T0: store + key>(arg0: &mut MermaidplaceConfig, arg1: &mut 0xf4e070fe65e35551122a370eebb81404f772fee094ed54055dd5465548502d90::royalty_fee::RoyaltyBag, arg2: 0x2::object::ID, arg3: vector<0x2::coin::Coin<0x2::sui::SUI>>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0xf4e070fe65e35551122a370eebb81404f772fee094ed54055dd5465548502d90::royalty_fee::charge_royalty<T0>(arg1, v3, &mut v1, arg4);
        assert!(v8 + v9 < v3, 5);
        let v10 = v3 - v8 - v9;
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xf4e070fe65e35551122a370eebb81404f772fee094ed54055dd5465548502d90::royalty_fee::init_royalty_bag(arg0);
    }
