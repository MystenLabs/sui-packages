module 0xf40e1bf0d98b589043552b9bc8b8d0dad74df507a36ca79109aaa40f515af81a::maidens_of_chaos_2 {
    struct MAIDENS_OF_CHAOS_2 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MAIDENS_OF_CHAOS_2, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<MAIDENS_OF_CHAOS_2>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Maidens of Chaos 2"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Maidens of Chaos"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreihevibgwpcc5zs6f6cdihc3le77x7sio45lelyc4dun4oaecnyexu"));
