module 0xf47040df08f61f6d4f4ddee8aade6d056db3ef4f5d1f538e4b6b797d5b385659::reward9129 {
    struct REWARD9129 has drop {
        dummy_field: bool,
    }

    struct TICKET_9129 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9129(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9129>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9129>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9129, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9129>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9129>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9129>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9129>>(v5, 0x2::tx_context::sender(arg1));
    }
