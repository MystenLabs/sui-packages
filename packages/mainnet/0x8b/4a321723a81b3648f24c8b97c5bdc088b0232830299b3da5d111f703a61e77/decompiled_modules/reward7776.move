module 0x8b4a321723a81b3648f24c8b97c5bdc088b0232830299b3da5d111f703a61e77::reward7776 {
    struct REWARD7776 has drop {
        dummy_field: bool,
    }

    struct TICKET_7776 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7776(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7776>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7776>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7776, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7776>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7776>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7776>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7776>>(v5, 0x2::tx_context::sender(arg1));
    }
