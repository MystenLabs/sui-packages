module 0x8be81fccb26f6ea7ff7ab57fd73f8cc5c073f2a25bb4f8045ae8c597f351bbbf::reward7252 {
    struct REWARD7252 has drop {
        dummy_field: bool,
    }

    struct TICKET_7252 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7252(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7252>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7252>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7252, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7252>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7252>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7252>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7252>>(v5, 0x2::tx_context::sender(arg1));
    }
