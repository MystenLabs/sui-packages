module 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::coin_factory {
    ...
    public fun buy_<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg4: &0x2::coin::CoinMetadata<T0>, arg5: address, arg6: &mut BondingCurve<T0>, arg7: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg8: bool, arg9: u64, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v15 = CoinTraded{
            ...
            amountOut            : v2,
            fee                  : v3,
            curveCoinBalance     : arg6.virtual_coin_reserve,
            curveNativeBalance   : arg6.virtual_sui_reserve,
    ...
    public fun create_<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg2: 0x2::coin::TreasuryCap<T0>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: 0x1::ascii::String, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: bool, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        ...
        let v7 = CoinCreated{
            coin_id              : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            bonding_curve_id     : 0x2::object::uid_to_inner(&v6.id),
            creator              : 0x2::tx_context::sender(arg12),
            virtual_sui_reserve  : arg8,
            virtual_coin_reserve : v2,
            total_supply         : arg5,
            ...
            symbol               : v5,
            coinAddress          : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            curveAddress         : 0x2::object::uid_to_inner(&v6.id),
            supply               : arg5,
    ...
    public fun first_buy_<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: bool, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<T0>) {
        ...
        let v15 = CoinTraded{
            ...
            amountOut            : v2,
            fee                  : v3,
            curveCoinBalance     : arg0.virtual_coin_reserve,
            curveNativeBalance   : arg0.virtual_sui_reserve,
    ...
    fun max_tick() : 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::I32 {
        0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::from(443636)
    }
    ...
    public fun migrate_to_dex<T0>(arg0: &mut BondingCurve<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg3: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg4: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg5: &0x2::coin::CoinMetadata<T0>, arg6: &0x2::clock::Clock, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v0 - v4 - v5;
        let (v7, v8, v9) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool_creator::create_pool_v2_with_creation_cap<T0, 0x2::sui::SUI>(arg1, arg2, &mut arg0.pool_creation_cap, 200, calculate_sqrt_price(v6, v1 - 40000000000000000), 0x1::string::utf8(b"SUI-Token Full Range Pool - from Eric"), 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::as_u32(0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::mul(0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::div(min_tick(), 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::from(200)), 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::from(200))), 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::as_u32(0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::mul(0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::div(max_tick(), 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::from(200)), 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::from(200))), 0x2::coin::from_balance<T0>(v2, arg8), 0x2::coin::from_balance<0x2::sui::SUI>(v3, arg8), arg5, arg4, true, arg6, arg8);
        let v10 = v7;
        let v11 = CoinBonded{
            coin_id          : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            bonding_curve_id : 0x2::object::uid_to_inner(&arg0.id),
    ...
    fun min_tick() : 0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::I32 {
        0x8b9a7c1dd931b5f066f8279b1653d31e69b3761803f824860cc8d1c6b6a5f77c::i32::neg_from(443636)
    }
    ...
    public fun sell_<T0>(arg0: &mut BondingCurve<T0>, arg1: 0x2::coin::Coin<T0>, arg2: bool, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<0x2::sui::SUI>, 0x2::coin::Coin<0x2::sui::SUI>) {
        assert!(!arg0.ended, 0);
        assert!(arg0.first_buy, 1);
        ...
        let v13 = v3 + v4;
        let v14 = 0x2::tx_context::sender(arg6);
        ...
        *v15 = *v15 - v1;
        ...
        (0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_vault, v3), arg6), 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_vault, v4), arg6))
    }
