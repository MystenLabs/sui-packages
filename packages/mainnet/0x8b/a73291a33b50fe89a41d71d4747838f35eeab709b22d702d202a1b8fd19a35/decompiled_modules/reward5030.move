module 0x8ba73291a33b50fe89a41d71d4747838f35eeab709b22d702d202a1b8fd19a35::reward5030 {
    struct REWARD5030 has drop {
        dummy_field: bool,
    }

    struct TICKET_5030 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5030(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5030>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5030>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5030, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5030>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5030>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5030>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5030>>(v5, 0x2::tx_context::sender(arg1));
    }
