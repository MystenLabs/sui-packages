module 0x8b23a1bed27584f01e73eff752499749f9937b11b2546855364931a9775af5c3::game {
    ...
    public entry fun create_game(arg0: address, arg1: u64, arg2: u8, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 == 1 || arg2 == 3 || arg2 == 5, 1000);
        let v0 = 0x2::object::new(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        let v2 = Game{
            id                      : v0,
            player1                 : 0x2::tx_context::sender(arg4),
            player2                 : arg0,
            stake                   : arg1,
            best_of                 : arg2,
            state                   : 1,
    ...
    public entry fun submit_stake(arg0: &mut Game, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg0.player1 || v0 == arg0.player2, 1004);
        if (v0 == arg0.player1) {
            assert!(!arg0.player1_stake_submitted, 1002);
            arg0.player1_stake_submitted = true;
        } else {
        ...
        arg0.last_action_at = 0x2::clock::timestamp_ms(arg2);
        if (arg0.player1_stake_submitted && arg0.player2_stake_submitted) {
            arg0.state = 2;
        };
