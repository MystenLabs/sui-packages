module 0x8bde146b40bd7e9889078ebdf4e77a1de9811e95319cec3e22003699f420c15a::test_pajama_boyz_dsds {
    struct TEST_PAJAMA_BOYZ_DSDS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TEST_PAJAMA_BOYZ_DSDS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST_PAJAMA_BOYZ_DSDS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"test pajama boyz dsds"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"test pajama boyz dsds "));
