module 0x2e4677e45a5c6ce48e4f3c609fa626606855f8927d984d9900f6c3a538d96489::package {
    ...
    struct ChildCount has copy, drop, store {
        dummy_field: bool,
    }

    struct DerivedObject has store, key {
        id: 0x2::object::UID,
        index: u64,
        name: 0x1::string::String,
    }
    ...
    public fun derive_child(arg0: &mut Object) : DerivedObject {
        let v0 = ChildCount{dummy_field: false};
        if (!0x2::dynamic_field::exists_<ChildCount>(&arg0.id, v0)) {
            let v1 = ChildCount{dummy_field: false};
            0x2::dynamic_field::add<ChildCount, u64>(&mut arg0.id, v1, 0);
        };
        let v2 = ChildCount{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<ChildCount, u64>(&mut arg0.id, v2);
        let v4 = *v3;
        *v3 = *v3 + 1;
        DerivedObject{
            id    : 0x2::derived_object::claim<u64>(&mut arg0.id, v4),
            index : v4,
            name  : 0x1::string::utf8(b"Child Object"),
        }
    }
