module 0x17192ccd391112180395ca60d6cd68ad97816ed1a8557e83c995c43c24b7a67f::invite {
    ...
    entry fun bind_v2(arg0: &mut Invite, arg1: address, arg2: &0x17192ccd391112180395ca60d6cd68ad97816ed1a8557e83c995c43c24b7a67f::global::Global, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun is_bind(arg0: &Invite, arg1: address) : bool {
        0x2::vec_map::contains<address, address>(&arg0.inviters, &arg1)
    }
    ...
    public fun uid(arg0: &Invite) : &0x2::object::UID {
        &arg0.id
    }
