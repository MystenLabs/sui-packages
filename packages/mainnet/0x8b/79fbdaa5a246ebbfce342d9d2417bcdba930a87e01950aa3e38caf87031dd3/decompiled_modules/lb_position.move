module 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::lb_position {
    ...
    struct LBPositionInfo has store {
        ...
        total_fees_gen: u128,
        total_fees_gen_snapshot: 0x2::table::Table<u64, u128>,
        reward_per_fee_snapshot: 0x2::table::Table<u64, u128>,
        pending_reward: 0x2::table::Table<u64, u64>,
        reward_dump: bool,
    ...
    public(friend) fun add_total_fees_collected(arg0: &mut LBPositionInfo, arg1: u128) {
        arg0.total_fees_gen = 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::add_u128(arg0.total_fees_gen, arg1);
    }
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        let v3 = v2.amount;
        v2.fee_growth_inside_last_x = arg3;
        v2.fee_growth_inside_last_y = arg4;
        add_or_update_bin(v0, arg2, v2);
        (((0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::mul_u128(v3, 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::sub_u128(arg3, v2.fee_growth_inside_last_x)) >> 64) as u64), ((0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::mul_u128(v3, 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::sub_u128(arg4, v2.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public(friend) fun decrease_liquidity(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: &0x2::clock::Clock) {
        ...
        let v2 = 0x1::option::extract<LBBinPosition>(&mut v1);
        assert!(v2.amount >= arg3, 3);
        let v3 = v2.amount - arg3;
        if (v3 == 0) {
            remove_bin(v0, arg2);
        } else {
            v2.amount = v3;
    ...
    fun destroy_position_info(arg0: LBPositionInfo) {
        let LBPositionInfo {
            ...
            bins                    : v1,
            total_fees_gen          : _,
            total_fees_gen_snapshot : v3,
            reward_per_fee_snapshot : v4,
            pending_reward          : v5,
            reward_dump             : _,
        ...
        0x2::table::drop<u64, u128>(v4);
        0x2::table::drop<u64, u128>(v3);
    ...
    public(friend) fun get_mut_pending_rewards(arg0: &mut LBPositionInfo, arg1: u64) : &mut u64 {
        if (0x2::table::contains<u64, u64>(&arg0.pending_reward, arg1)) {
            0x2::table::borrow_mut<u64, u64>(&mut arg0.pending_reward, arg1)
        } else {
            0x2::table::add<u64, u64>(&mut arg0.pending_reward, arg1, 0);
            0x2::table::borrow_mut<u64, u64>(&mut arg0.pending_reward, arg1)
        }
    }
    ...
    public fun get_pending_rewards(arg0: &LBPositionInfo, arg1: u64) : u64 {
        if (0x2::table::contains<u64, u64>(&arg0.pending_reward, arg1)) {
            *0x2::table::borrow<u64, u64>(&arg0.pending_reward, arg1)
        } else {
            0
        }
    }

    public fun get_position_snapshot(arg0: &LBPositionInfo, arg1: u64) : (u128, u128) {
        let v0 = if (0x2::table::contains<u64, u128>(&arg0.reward_per_fee_snapshot, arg1)) {
            *0x2::table::borrow<u64, u128>(&arg0.reward_per_fee_snapshot, arg1)
        } else {
            0
        };
        let v1 = if (0x2::table::contains<u64, u128>(&arg0.total_fees_gen_snapshot, arg1)) {
            *0x2::table::borrow<u64, u128>(&arg0.total_fees_gen_snapshot, arg1)
        } else {
            0
        };
        (v0, v1)
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 6) {
            ...
            v3 = 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }

    public fun get_total_fees_collected(arg0: &LBPositionInfo) : u128 {
        arg0.total_fees_gen
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::add_u64(v0, v3);
            v1 = 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128) {
        ...
        if (0x1::option::is_some<LBBinPosition>(&v1)) {
            ...
            let v3 = LBBinPosition{
                bin_id                   : arg3,
                amount                   : 0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::safe_math::add_u128(v2.amount, arg4),
        ...
        0x8b79fbdaa5a246ebbfce342d9d2417bcdba930a87e01950aa3e38caf87031dd3::bin_manager::increment_total_supply(arg1, arg3, arg4);
    }
    ...
    public(friend) fun open_position<T0, T1>(arg0: &mut LBPositionManager, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : LBPosition {
        ...
        let v2 = LBPositionInfo{
            ...
            total_fees_gen          : 0,
            total_fees_gen_snapshot : 0x2::table::new<u64, u128>(arg3),
            reward_per_fee_snapshot : 0x2::table::new<u64, u128>(arg3),
            pending_reward          : 0x2::table::new<u64, u64>(arg3),
            reward_dump             : true,
    ...
    public(friend) fun update_position_snapshot(arg0: &mut LBPositionInfo, arg1: u64, arg2: u128, arg3: u128) {
        if (0x2::table::contains<u64, u128>(&arg0.reward_per_fee_snapshot, arg1)) {
            *0x2::table::borrow_mut<u64, u128>(&mut arg0.reward_per_fee_snapshot, arg1) = arg2;
        } else {
            0x2::table::add<u64, u128>(&mut arg0.reward_per_fee_snapshot, arg1, arg2);
        };
        if (0x2::table::contains<u64, u128>(&arg0.total_fees_gen_snapshot, arg1)) {
            *0x2::table::borrow_mut<u64, u128>(&mut arg0.total_fees_gen_snapshot, arg1) = arg3;
        } else {
            0x2::table::add<u64, u128>(&mut arg0.total_fees_gen_snapshot, arg1, arg3);
        };
    }

    public(friend) fun update_reward_dump(arg0: &mut LBPositionInfo, arg1: u64) {
        assert!(arg1 < 8, 9);
        if (arg0.reward_dump) {
            let v0 = 1 << (arg1 as u8);
