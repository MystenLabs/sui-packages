module 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_locked_loop_investor {
    ...
    fun assert_price_slippage<T0, T1, T2>(arg0: &Investor<T0>, arg1: &0x378b2a104e8bcd7ed0317f5e6a0ec4fd271d4d12e2fe6c99bcd1f12be725cf4f::oracle::Oracle, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock) {
        ...
        assert!(0x2::dynamic_field::exists<SwapInfoMapKey>(&arg0.id, v0), 2011);
        ...
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, CoinSwapInfo>(v2, &v3), 2011);
        assert!(0x2::vec_map::contains<0x1::type_name::TypeName, CoinSwapInfo>(v2, &v4), 2011);
    ...
    public(friend) fun collect_reward_and_swap_bluefin<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: &0x378b2a104e8bcd7ed0317f5e6a0ec4fd271d4d12e2fe6c99bcd1f12be725cf4f::oracle::Oracle, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T1, T2>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: bool, arg6: bool, arg7: u64, arg8: 0x1::option::Option<u64>, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5) {
            let v5 = collect_reward<T0, T1>(arg0, arg2, arg10, arg11);
            ...
            if (v6 >= arg7 && arg6) {
                ...
                let (v9, v10) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T1, T2>(arg10, arg4, arg3, v3, 0x2::balance::zero<T2>(), true, true, v6, 0, v7);
                let v11 = v10;
                let v12 = v9;
                assert!(0x2::balance::value<T1>(&v12) == 0, 2004);
                0x2::balance::destroy_zero<T1>(v12);
                if (!arg9) {
                    assert_price_slippage<T0, T1, T2>(arg0, arg1, arg2, v6, 0x2::balance::value<T2>(&v11), v1, arg10);
                };
            ...
            let v13 = collect_reward<T0, T2>(arg0, arg2, arg10, arg11);
            ...
            if (v14 >= arg7 && arg6) {
                ...
                let (v17, v18) = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::swap<T1, T2>(arg10, arg4, arg3, 0x2::balance::zero<T1>(), v4, false, true, v14, 0, v16);
                let v19 = v18;
                let v20 = v17;
                assert!(0x2::balance::value<T2>(&v19) == 0, 2005);
                0x2::balance::destroy_zero<T2>(v19);
                if (!arg9) {
                    assert_price_slippage<T0, T2, T1>(arg0, arg1, arg2, v14, 0x2::balance::value<T1>(&v20), v1, arg10);
                };
    ...
    public(friend) fun emergency_repay<T0>(arg0: &mut Investor<T0>, arg1: u64, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::ge(v3, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(v4, v2)), 2009);
        let v5 = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::safe_sub(v2, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from_bps(arg1));
        let v6 = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::to_u64(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::div(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::safe_sub(v3, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(v5, v4)), 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::sub(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(1), v5)));
        if (v6 > 0) {
    ...
    fun get_pool_slippage_bps<T0>(arg0: &Investor<T0>, arg1: 0x2::object::ID) : u64 {
        let v0 = AllowedPoolsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<AllowedPoolsKey>(&arg0.id, v0), 2010);
        let v1 = AllowedPoolsKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<AllowedPoolsKey, 0x2::vec_map::VecMap<0x2::object::ID, u64>>(&arg0.id, v1);
        assert!(0x2::vec_map::contains<0x2::object::ID, u64>(v2, &arg1), 2010);
    ...
    public(friend) fun withdraw_from_alphalend<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v2 = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::round_up_u64(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::div_round_up(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(arg2), 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(v1)), 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(arg3)));
        let v3 = v2;
        if (v2 == v1 && v1 > 0) {
            v3 = v2 + 1;
        };
