module 0x8b1f7b0c27ef57ba6793766bc2a279a06ea89fe9721f58e5b5e9e22839c41f8c::house_data {
    ...
    public fun claim_fees(arg0: &mut HouseData, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == houser(arg0), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.fees, fees(arg0), arg1), houser(arg0));
    }
    ...
    public fun houser(arg0: &HouseData) : address {
        arg0.houser
    }
    ...
    public fun initialize_house_data(arg0: HouseCap, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = HouseData{
            ...
            houser         : 0x2::tx_context::sender(arg3),
            public_key     : arg2,
    ...
    public fun update_max_stake(arg0: &mut HouseData, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == houser(arg0), 1);
        arg0.max_stake = arg1;
    }
    ...
    public fun withdraw(arg0: &mut HouseData, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == houser(arg0), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, balance(arg0), arg1), houser(arg0));
    }
