module 0x8badbaf235021cc552d2d76bcff5d446bb3ebb4e6c8a873f95975745f0716e19::universal_router {
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0x8badbaf235021cc552d2d76bcff5d446bb3ebb4e6c8a873f95975745f0716e19::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
