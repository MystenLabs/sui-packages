module 0x8bf772ca7a024a97cfd223c67d040bc2fe109384ddcca3613bd99ed911def698::flow {
    ...
    fun init(arg0: FLOW, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<FLOW>(&mut v2, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
