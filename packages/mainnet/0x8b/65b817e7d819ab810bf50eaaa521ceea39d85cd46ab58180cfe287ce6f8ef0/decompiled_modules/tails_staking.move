module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking {
    ...
    public fun bid<T0, T1>(arg0: &0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::ecosystem::Version, arg1: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::user::TypusUserRegistry, arg2: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::tgld::TgldRegistry, arg3: &mut 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::leaderboard::TypusLeaderboardRegistry, arg4: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg5: u64, arg6: vector<0x2::coin::Coin<T1>>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::TypusBidReceipt, 0x2::coin::Coin<T1>, vector<u64>) {
        ...
        let (v1, v2, v3) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tds_user_entry::bid<T0, T1>(arg4, arg5, arg6, arg7, arg8, arg9);
        let v4 = v3;
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(registry_uid(arg4), b"nft_extension")) {
            ...
            if (0x2::object_table::contains<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v8, v0)) {
                let v9 = 0x2::object_table::borrow_mut<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v8, v0);
                0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::first_bid(&v7.nft_manager_cap, v9);
                0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::nft_exp_up(&v7.nft_manager_cap, v9, v5 * 200);
            };
        };
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::add_accumulated_tgld_amount(registry_uid(arg4), arg0, arg1, arg2, v0, v5 * 200, arg9);
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::add_leaderboard_score(registry_uid(arg4), arg0, arg3, 0x1::ascii::string(b"bidding_leaderboard"), v0, *0x1::vector::borrow<u64>(&v4, 1), arg8, arg9);
        (v1, v2, v4)
    }
    ...
    public fun reduce_usd_in_deposit(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: address, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_field::exists_<vector<u8>>(registry_uid(arg0), b"nft_extension")) {
            let v0 = 0x2::dynamic_field::borrow_mut<vector<u8>, NftExtension>(registry_mut_uid(arg0), b"nft_extension");
            if (0x2::object_table::contains<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&v0.nft_table, arg1)) {
                let v1 = snapshot_(v0, arg3, arg1);
                let v2 = 0x2::object_table::borrow_mut<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut v0.nft_table, arg1);
                let v3 = if (v1 > arg2) {
                    v1 - arg2
                } else {
                    0
                };
                0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::update_u64_padding(&v0.nft_manager_cap, v2, 0x1::string::utf8(b"usd_in_deposit"), v3);
    ...
    fun snapshot_(arg0: &mut NftExtension, arg1: &0x2::clock::Clock, arg2: address) : u64 {
        ...
        let v1 = 0x2::object_table::borrow_mut<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(&mut arg0.nft_table, arg2);
