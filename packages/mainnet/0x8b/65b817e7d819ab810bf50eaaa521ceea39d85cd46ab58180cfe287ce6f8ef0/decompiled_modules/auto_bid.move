module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::auto_bid {
    ...
    public fun close_strategy<T0, T1>(arg0: &0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        assert!(0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking::get_staked_level(arg0, v3) > 0, 1);
        (v1, v2)
    }
            ...
            if ((0x1::vector::contains<u64>(&v24.target_rounds, &v17) || 0x1::vector::length<u64>(&v24.target_rounds) == 0) && v24.bid_times < v24.max_times && v24.bid_round < v17 && 100 - (0x2::clock::timestamp_ms(arg8) - v20) * 100 / v21 <= v24.price_percentage && v24.active) {
                ...
                if (0x2::balance::value<T1>(v27) >= v31) {
                    if (v29 > 0) {
                        ...
                        let v41 = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::calculate_in_usd<T1>(v13, v36, false);
                        let (v42, v43) = 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking::mut_nft_table(v1);
                        if (0x2::object_table::contains<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v42, v24.user)) {
                            let v44 = 0x2::object_table::borrow_mut<address, 0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::Tails>(v42, v24.user);
                            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::first_bid(v43, v44);
                            0xbd147bc7f12f38f175d78947a61364e8e077b9b188b00e7094bc0c3623162196::typus_nft::nft_exp_up(v43, v44, v41 * 200);
                        };
                        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::add_accumulated_tgld_amount(v1, arg0, arg1, arg2, v24.user, v41 * 200, arg9);
    ...
    public fun new_strategy<T0, T1>(arg0: &0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: vector<u64>, arg8: 0x2::coin::Coin<T1>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::portfolio_vault_token_check<T0, T1>(arg0, arg2);
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking::get_staked_level(arg0, v0) > 0, 1);
    ...
    public fun update_strategy<T0, T1>(arg0: &0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: &mut StrategyPoolV2, arg2: u64, arg3: u64, arg4: u64, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: vector<u64>, arg9: vector<0x2::coin::Coin<T1>>, arg10: &0x2::tx_context::TxContext) {
        ...
        assert!(v0.user == v1, 0);
        assert!(0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking::get_staked_level(arg0, v1) > 0, 1);
