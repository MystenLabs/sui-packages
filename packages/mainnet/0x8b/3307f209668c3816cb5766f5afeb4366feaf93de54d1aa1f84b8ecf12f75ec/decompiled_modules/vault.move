module 0x8b3307f209668c3816cb5766f5afeb4366feaf93de54d1aa1f84b8ecf12f75ec::vault {
    ...
    public entry fun emergency_withdraw<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 1);
        if (0x2::balance::value<T0>(&arg0.pending_fees_a) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.pending_fees_a), arg1), arg0.owner);
        };
        if (0x2::balance::value<T1>(&arg0.pending_fees_b) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.pending_fees_b), arg1), arg0.owner);
        };
    }
    ...
    public entry fun zap_in<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::tx_context::TxContext) {
        0x2::balance::join<T0>(&mut arg0.pending_fees_a, 0x2::coin::into_balance<T0>(arg1));
        0x2::balance::join<T1>(&mut arg0.pending_fees_b, 0x2::coin::into_balance<T1>(arg2));
        let v0 = ZapIn{
            vault_id : 0x2::object::uid_to_inner(&arg0.id),
