module 0x8bfbec444203e17f62fbfb7a18bab6c87be1720b4eb68ed6515db15c1cf6a062::oracle_provider {
    ...
    public fun switchboard_provider() : OracleProvider {
        OracleProvider{name: 0x1::ascii::string(b"SwitchboardOracleProvider")}
    }
