module 0x8ba3e7ac6bac33d93fdea6a1feaa2b4a5b843f8ab20313ae4f44fe192db87fcc::reward8541 {
    struct REWARD8541 has drop {
        dummy_field: bool,
    }

    struct TICKET_8541 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8541(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8541>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8541>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8541, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8541>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8541>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8541>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8541>>(v5, 0x2::tx_context::sender(arg1));
    }
