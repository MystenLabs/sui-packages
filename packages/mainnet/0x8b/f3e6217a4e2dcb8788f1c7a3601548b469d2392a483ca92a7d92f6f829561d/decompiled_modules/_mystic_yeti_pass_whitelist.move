module 0x8bf3e6217a4e2dcb8788f1c7a3601548b469d2392a483ca92a7d92f6f829561d::_mystic_yeti_pass_whitelist {
    struct _MYSTIC_YETI_PASS_WHITELIST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _MYSTIC_YETI_PASS_WHITELIST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_MYSTIC_YETI_PASS_WHITELIST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" Mystic Yeti Pass Whitelist"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Pass for the whitelist sale"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidzphblmm3rdkc5ho2jh3t3xazpki56ekw3bjkg725kdkmpxvlchu"));
