module 0x8b717ab537f2e1da78344a6edc7822da83cba71d1bf6844834f0d3a0996aced8::cnsnft7669 {
    struct CNSNFT7669 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7669, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7669>(arg0, arg1);
