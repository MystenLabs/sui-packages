module 0x8bcb609542b889f194363c7cc7da608329a3acd35457dd85e801f4234ea21b49::reward9140 {
    struct REWARD9140 has drop {
        dummy_field: bool,
    }

    struct TICKET_9140 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9140(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9140>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9140>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9140, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9140>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9140>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9140>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9140>>(v5, 0x2::tx_context::sender(arg1));
    }
