module 0x8b4aeec249fad1c84c418ed556d2d2bd7d2bb917a4d80660eee78af7325623eb::merkle {
    ...
    fun concat_mut(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
    ...
    fun parent(arg0: vector<u8>, arg1: vector<u8>) : vector<u8> {
        if (bytes_lt(&arg0, &arg1)) {
            let v1 = concat_mut(arg0, arg1);
            0x2::hash::keccak256(&v1)
        } else {
            let v2 = concat_mut(arg1, arg0);
