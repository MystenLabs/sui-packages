module 0x8b4aeec249fad1c84c418ed556d2d2bd7d2bb917a4d80660eee78af7325623eb::distributor {
    ...
    public entry fun claim<T0>(arg0: &mut Distributor<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > v2, 4);
        let v3 = 0x8b4aeec249fad1c84c418ed556d2d2bd7d2bb917a4d80660eee78af7325623eb::merkle::leaf(v1, arg1);
        assert!(0x8b4aeec249fad1c84c418ed556d2d2bd7d2bb917a4d80660eee78af7325623eb::merkle::verify(&arg0.merkle_root, &v3, &arg2), 5);
        let v4 = arg1 - v2;
        ...
        arg0.total_claimed = arg0.total_claimed + (v4 as u128);
    ...
    public entry fun set_time<T0>(arg0: &mut Distributor<T0>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.operator, 2);
        let v0 = 0x2::clock::timestamp_ms(arg3) / 1000;
        assert!(arg1 > v0, 3);
        assert!(arg1 <= v0 + 7776000, 3);
        assert!(arg2 > 0, 14);
        assert!(arg2 <= 31536000, 14);
        let v1 = v0 >= arg0.start_time_s && v0 <= arg0.end_time_s;
        assert!(!v1, 9);
        arg0.start_time_s = arg1;
        arg0.end_time_s = arg1 + arg2;
        let v2 = TimeSet{
            id           : id_address<T0>(arg0),
            start_time_s : arg1,
