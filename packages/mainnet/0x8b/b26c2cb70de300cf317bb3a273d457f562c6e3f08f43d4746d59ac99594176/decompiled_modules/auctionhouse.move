module 0x8bb26c2cb70de300cf317bb3a273d457f562c6e3f08f43d4746d59ac99594176::auctionhouse {
    ...
    public entry fun create_and_share_kiosk_auctionhouse_store(arg0: &AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_kiosk_auctionhouse(arg0: &AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Auctionhouse_Store {
        assert!(0x2::tx_context::sender(arg1) == arg0.owner, 1);
        let v0 = Kiosk_Auctionhouse_Store{
            id            : 0x2::object::new(arg1),
            auction_house : 0x2::object::id<AuctionHouse>(arg0),
            orphaned_caps : 0x2::object::new(arg1),
        };
        let v1 = KioskAuctionhouseStoreCreated{
            creator          : 0x2::tx_context::sender(arg1),
            auction_house_id : 0x2::object::id<AuctionHouse>(arg0),
        };
        0x2::event::emit<KioskAuctionhouseStoreCreated>(v1);
        v0
    }
    ...
    public fun get_app_link_string(arg0: &AuctionHouse) : 0x1::string::String {
        0x1::string::utf8(arg0.app_link)
    }
    ...
    public fun get_description_string(arg0: &AuctionHouse) : 0x1::string::String {
        0x1::string::utf8(arg0.description)
    }
    ...
    public fun get_name_string(arg0: &AuctionHouse) : 0x1::string::String {
        0x1::string::utf8(arg0.name)
    }
    ...
    fun init(arg0: AUCTIONHOUSE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = &mut v10;
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(v2));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(v3));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"{owner}"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"https://media.discordapp.net/attachments/1356391217281237132/1370447922399023144/suiverse_bg_1.jpeg?ex=681f8896&is=681e3716&hm=84dbf1ec9c8bd813de1db95f419384417728d4894b4035260692c64b01890f87&=&format=webp&width=525&height=350"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"https://portal.example.com"));
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(v4));
    ...
    public entry fun update_display(arg0: &AuctionHouse, arg1: &0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(arg0.name));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(arg0.description));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{owner}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://c4.wallpaperflare.com/wallpaper/698/492/43/world-of-warcraft-world-of-warcraft-the-war-within-hd-wallpaper-preview.jpg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://portal.example.com"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(arg0.app_link));
    ...
    public entry fun update_metadata(arg0: &mut AuctionHouse, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: &0x2::package::Publisher, arg7: &mut 0x2::tx_context::TxContext) {
