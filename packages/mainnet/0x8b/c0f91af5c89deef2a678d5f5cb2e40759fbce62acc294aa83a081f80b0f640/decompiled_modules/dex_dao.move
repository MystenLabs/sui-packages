module 0x8bc0f91af5c89deef2a678d5f5cb2e40759fbce62acc294aa83a081f80b0f640::dex_dao {
    struct PoolsGovernor has store, key {
        id: 0x2::object::UID,
        hive_profile: 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile,
        gems_cycle: u64,
        gems_schedule: GemsSchedule,
        total_gems_points: u64,
        gems_points_map: 0x2::linked_table::LinkedTable<address, u64>,
        dex_dao_cap: 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::config::DexDaoCapability,
    ...
    struct PoolHive<phantom T0> has store, key {
        ...
        gems_available: 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::HiveGems,
    ...
    struct Proposal has store {
        proposal_id: u64,
        proposer: address,
        deposit: 0x2::balance::Balance<0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive::HIVE>,
    ...
    fun accrue_hive_for_bee_box<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut LpBeeBox<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::HiveGems {
        ...
        if (v1 == 0) {
            ...
            return 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::zero()
        };
        let v2 = arg3 - arg1.last_claim_epoch;
        let v3 = 0;
        if (v2 > 0 && arg1.total_staked > 0) {
            let v4 = 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u256((arg0.gems_schedule.gems_per_epoch as u256), (v1 as u256), (arg0.total_gems_points as u256));
            let v5 = 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u256((v2 as u256), (v4 as u256), (arg1.total_staked as u256));
            arg1.global_claim_index = arg1.global_claim_index + v5;
            arg1.last_claim_epoch = arg3;
            let v6 = (0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u256((arg1.total_staked as u256), (v5 as u256), (1000000 as u256)) as u64);
            let v7 = 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::zero();
            if (v6 <= 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::get_available_gems_in_profile(&arg0.hive_profile)) {
                0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::join(&mut v7, 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::withdraw_gems_from_profile(&mut arg0.hive_profile, v6, arg4));
            };
            0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::join(&mut arg1.gems_available, v7);
        ...
        if (v9 > 0 && arg1.global_claim_index > arg2.claim_index) {
            let v10 = (0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u256(((arg1.global_claim_index - arg2.claim_index) as u256), (v9 as u256), (1000000 as u256)) as u64);
            v3 = v10;
            arg2.claim_index = arg1.global_claim_index;
            arg2.total_gems_earned = arg2.total_gems_earned + v10;
        };
        if (v3 > 0) {
            0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::split(&mut arg1.gems_available, v3)
        } else {
            0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::zero()
        }
    }
    ...
    fun claim_fruit_for_bee_box<T0, T1>(arg0: &mut BeeFruit<T1>, arg1: &mut LpBeeBox<T0>, arg2: address, arg3: u64, arg4: u64, arg5: address, arg6: 0x1::string::String) : 0x2::balance::Balance<T1> {
        ...
        if (v3 > 0) {
            arg0.claim_index = arg0.claim_index + 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u256((1000000 as u256), 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u256((arg0.fruits_per_epoch as u256), (v3 as u256), (1000000 as u256)), (arg3 as u256));
        ...
        let v6 = (0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u256(((arg0.claim_index - *v5) as u256), (0x2::balance::value<T0>(&arg1.staked_balance) as u256), (1000000 as u256)) as u64);
        *v5 = arg0.claim_index;
        if (v6 > 0) {
    ...
    fun deposit_gems_and_unbond_shares<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: address, arg3: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg4: address, arg5: LpBeeBox<T0>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(0x2::balance::value<T0>(&arg5.staked_balance) >= arg6, 7008);
        let v0 = &mut arg5;
        let v1 = accrue_hive_for_bee_box<T0>(arg0, arg1, v0, arg7, arg8);
        let v2 = 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::value(&v1);
        if (v2 > 0) {
            0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::deposit_gems_in_profile(arg3, v1);
        } else {
    ...
    public fun deposit_hive_as_incentives(arg0: &mut PoolsGovernor, arg1: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive::HiveVault, arg2: 0x2::coin::Coin<0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive::burn_hive_for_gems(arg1, &mut arg0.hive_profile, arg2, arg3, arg4);
    }

    fun deposit_into_bee_box<T0>(arg0: address, arg1: 0x1::string::String, arg2: &mut PoolsGovernor, arg3: &mut PoolHive<T0>, arg4: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg5: LpBeeBox<T0>, arg6: 0x2::balance::Balance<T0>, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg5;
        let v1 = accrue_hive_for_bee_box<T0>(arg2, arg3, v0, arg7, arg8);
        let v2 = 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::value(&v1);
        if (v2 > 0) {
            0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::deposit_gems_in_profile(arg4, v1);
        } else {
            0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::destroy_zero(v1);
        };
    ...
    public fun deposit_into_bee_box_1_fruits<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        ...
        let (v2, v3, v4, v5) = 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::get_profile_meta_info(arg2);
    ...
    public fun deposit_into_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
    ...
    public fun deposit_into_bee_box_no_fruits<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: 0x2::balance::Balance<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let v0 = 0x2::tx_context::epoch(arg4);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 0, 7006);
        let (v1, v2, v3, v4) = 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::get_profile_meta_info(arg2);
    ...
    public fun initialize_pools_manager(arg0: &0x2::clock::Clock, arg1: 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::config::DexDaoCapability, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0xabc387c8963287e6ec69e5a74ced236cbdb8311b4dadb930818fbc2e9f84410::hsui_vault::HSuiVault, arg4: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfileMappingStore, arg5: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveManager, arg6: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HSuiDisperser<0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hsui::HSUI>, arg7: 0x2::coin::Coin<0x2::sui::SUI>, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = VoteConfig{
            ...
            proposal_required_quorum    : 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div(1000000, arg14, 100),
            proposal_approval_threshold : 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div(1000000, arg15, 100),
        };
    ...
    public entry fun kraft_new_pool_hive_three_token_amm<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut 0x39cfbc6782cb766f5aa86bddbc236c0a0ca91f93895d3698c0eb3560ea156a07::three_pool::LiquidityPool<T0, T1, T2, T3>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<0x39cfbc6782cb766f5aa86bddbc236c0a0ca91f93895d3698c0eb3560ea156a07::three_pool::LP<T0, T1, T2, T3>>());
        let v1 = 0x39cfbc6782cb766f5aa86bddbc236c0a0ca91f93895d3698c0eb3560ea156a07::three_pool::get_liquidity_pool_id<T0, T1, T2, T3>(arg1);
        ...
        let v6 = PoolHive<0x39cfbc6782cb766f5aa86bddbc236c0a0ca91f93895d3698c0eb3560ea156a07::three_pool::LP<T0, T1, T2, T3>>{
            id                 : v3,
            total_staked       : 0,
            total_unbonding    : 0,
            lp_bee_boxes       : 0x2::linked_table::new<address, LpBeeBox<0x39cfbc6782cb766f5aa86bddbc236c0a0ca91f93895d3698c0eb3560ea156a07::three_pool::LP<T0, T1, T2, T3>>>(arg2),
            gems_available     : 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::zero(),
        ...
        0x2::transfer::share_object<PoolHive<0x39cfbc6782cb766f5aa86bddbc236c0a0ca91f93895d3698c0eb3560ea156a07::three_pool::LP<T0, T1, T2, T3>>>(v6);
        ...
        0x39cfbc6782cb766f5aa86bddbc236c0a0ca91f93895d3698c0eb3560ea156a07::three_pool::set_pool_hive_addr<T0, T1, T2, T3>(arg1, &arg0.dex_dao_cap, v5);
    }

    public entry fun kraft_new_pool_hive_two_token_amm<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut 0x411d17ead50580bcf5b268d9dc93809145ad74b14ed654e876ac3e8eacab93cc::two_pool::LiquidityPool<T0, T1, T2>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<0x411d17ead50580bcf5b268d9dc93809145ad74b14ed654e876ac3e8eacab93cc::two_pool::LP<T0, T1, T2>>());
        let v1 = 0x411d17ead50580bcf5b268d9dc93809145ad74b14ed654e876ac3e8eacab93cc::two_pool::get_liquidity_pool_id<T0, T1, T2>(arg1);
        let v2 = 0x2::tx_context::epoch(arg2);
        assert!(!0x2::linked_table::contains<0x1::ascii::String, address>(&arg0.pool_hives, v0), 7005);
        let v3 = 0x2::object::new(arg2);
        let v4 = 0x2::object::uid_to_inner(&v3);
        let v5 = 0x2::object::id_to_address(&v4);
        let v6 = PoolHive<0x411d17ead50580bcf5b268d9dc93809145ad74b14ed654e876ac3e8eacab93cc::two_pool::LP<T0, T1, T2>>{
            id                 : v3,
            total_staked       : 0,
            total_unbonding    : 0,
            lp_bee_boxes       : 0x2::linked_table::new<address, LpBeeBox<0x411d17ead50580bcf5b268d9dc93809145ad74b14ed654e876ac3e8eacab93cc::two_pool::LP<T0, T1, T2>>>(arg2),
            gems_available     : 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::hive_gems::zero(),
            global_claim_index : 0,
            last_claim_epoch   : v2,
            bee_fruit_list     : 0x1::vector::empty<0x1::ascii::String>(),
        ...
        0x2::transfer::share_object<PoolHive<0x411d17ead50580bcf5b268d9dc93809145ad74b14ed654e876ac3e8eacab93cc::two_pool::LP<T0, T1, T2>>>(v6);
        0x2::linked_table::push_back<0x1::ascii::String, address>(&mut arg0.pool_hives, v0, v5);
        0x2::linked_table::push_back<address, u64>(&mut arg0.gems_points_map, v5, 0);
        arg0.active_pool_hives = arg0.active_pool_hives + 1;
        let v7 = PoolHiveKraftd{
        ...
        0x2::event::emit<PoolHiveKraftd>(v7);
        0x411d17ead50580bcf5b268d9dc93809145ad74b14ed654e876ac3e8eacab93cc::two_pool::set_pool_hive_addr<T0, T1, T2>(arg1, &arg0.dex_dao_cap, v5);
    }
    ...
    public fun transition_into_next_gems_cycle(arg0: &mut PoolsGovernor, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.gems_schedule.gems_per_epoch = arg0.gems_schedule.gems_per_epoch + 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div_u128((arg0.gems_schedule.gems_per_epoch as u128), (v1 as u128), (1000000 as u128));
    ...
    public fun unbond_from_bee_box_1_fruit<T0, T1>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 1, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
    ...
    public fun unbond_from_bee_box_2_fruits<T0, T1, T2>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 2, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
    ...
    public fun unbond_from_bee_box_3_fruits<T0, T1, T2, T3>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T3>) {
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 3, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
        let (v2, v3, v4) = verify_and_extract_bee_box<T0>(arg0, arg1, arg2, arg4);
    ...
    public fun unbond_from_bee_box_no_fruit<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(0x1::vector::length<0x1::ascii::String>(&arg1.bee_fruit_list) == 0, 7006);
        let v0 = 0x2::tx_context::epoch(arg4);
        let v1 = 0x2::object::uid_to_address(&arg1.id);
    ...
    public fun unlock_from_bee_box<T0>(arg0: &mut PoolHive<T0>, arg1: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg2: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.module_version == 0, 7038);
        let (v0, v1, v2, v3) = 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::get_profile_meta_info(arg1);
    ...
    public fun update_gems_per_epoch(arg0: &mut PoolsGovernor, arg1: &0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::config::HiveDaoCapability, arg2: u64) {
        assert!(arg0.module_version == 0, 7038);
        assert!(arg2 < 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::get_available_gems_in_profile(&arg0.hive_profile) / 3, 7040);
    ...
    public fun update_instant_withdrawal_profiles(arg0: &mut PoolsGovernor, arg1: &0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::config::HiveDaoCapability, arg2: vector<address>, arg3: bool) {
        assert!(arg0.module_version == 0, 7038);
        let v0 = 0;
    ...
    public fun update_pool_hive_points(arg0: &mut PoolsGovernor, arg1: &0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::config::HiveDaoCapability, arg2: vector<address>, arg3: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
    ...
    public fun update_pools_governance_params(arg0: &mut PoolsGovernor, arg1: &0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::config::HiveDaoCapability, arg2: vector<u64>) {
        assert!(arg0.module_version == 0, 7038);
        ...
        if (50 >= v5 && v5 >= 10) {
            arg0.vote_config.proposal_required_quorum = 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div(1000000, v5, 100);
        };
        let v6 = *0x1::vector::borrow<u64>(&arg2, 6);
        if (70 > v6 && v6 >= 40) {
            arg0.vote_config.proposal_approval_threshold = 0x970d364f540a64b17eeaf105872b9d139b7ec334be138ed8306cf57ac4755579::math::mul_div(1000000, v6, 100);
        };
    ...
    fun verify_and_extract_bee_box<T0>(arg0: &mut PoolsGovernor, arg1: &mut PoolHive<T0>, arg2: &mut 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::HiveProfile, arg3: &mut 0x2::tx_context::TxContext) : (LpBeeBox<T0>, address, 0x1::string::String) {
        assert!(arg0.module_version == 0 && arg1.module_version == 0, 7038);
        let (v0, v1, v2, v3) = 0xef6e7cde6cdf819a05052195ad9fbd74f4a9779eae39fb0e453070ecd4ae673e::hive_profile::get_profile_meta_info(arg2);
