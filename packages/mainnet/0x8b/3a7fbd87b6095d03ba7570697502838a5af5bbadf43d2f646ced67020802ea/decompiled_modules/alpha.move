module 0x8b3a7fbd87b6095d03ba7570697502838a5af5bbadf43d2f646ced67020802ea::alpha {
    ...
    public fun add_admin(arg0: &Admin_cap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Admin_cap{
            ...
            owner_id : 0x2::tx_context::sender(arg2),
        };
    ...
    fun init(arg0: ALPHA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<ALPHA>>(0x2::coin::mint<ALPHA>(&mut v2, 1000000, arg1), @0x45);
        0x2::transfer::public_transfer<0x2::coin::Coin<ALPHA>>(0x2::coin::mint<ALPHA>(&mut v2, 500000, arg1), @0x456);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<ALPHA>>(v2, 0x2::tx_context::sender(arg1));
        let v3 = Burn_start_cap{id: 0x2::object::new(arg1)};
        0x2::transfer::public_transfer<Burn_start_cap>(v3, 0x2::tx_context::sender(arg1));
        let v4 = Admin_cap{
            id       : 0x2::object::new(arg1),
            owner_id : 0x2::tx_context::sender(arg1),
        };
        0x2::transfer::public_transfer<Admin_cap>(v4, 0x2::tx_context::sender(arg1));
    }
