module 0x8bea4f559c6f51ac4f28d7ff1e88e3a7ec97adb0efcc5217cda4cf38b5f4f4e0::source_chain_guard {
    ...
    public fun cancel_order<T0, T1, T2>(arg0: Order<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::balance::value<T0>(&v10) == 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v10, arg2), v4);
        };
    }
    ...
    public fun create_order<T0, T1, T2>(arg0: &Guard<T0, T2>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
