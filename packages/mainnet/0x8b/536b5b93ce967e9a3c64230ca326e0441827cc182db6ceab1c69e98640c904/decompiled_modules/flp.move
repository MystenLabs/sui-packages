module 0x8b536b5b93ce967e9a3c64230ca326e0441827cc182db6ceab1c69e98640c904::flp {
    struct FLP has drop {
        dummy_field: bool,
    }
    ...
    struct FLPAmountUpdated has copy, drop {
        ...
        amount: u64,
        deposit_amount: 0x19a53942ca9b7cef4fbc820e0b06ebbf213e4853457ce8b7a5149ebcb4131766::float::Decimal,
    }
    ...
    public fun deposit<T0>(arg0: &mut FLPApp, arg1: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::app::ProtocolApp, arg2: &mut 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market::Market<0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market_type::MainMarket>, arg3: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::obligation::ObligationOwnerCap, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        let v0 = &mut arg0.obligation_flps;
        let v1 = borrow_or_create_obligation_flp(v0, 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::obligation::id(arg3));
        let v2 = 0x1::type_name::with_defining_ids<T0>();
        if (v2 == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
            let v3 = 0x2::coin::value<T0>(&arg4) / 5000000000;
            v1.amount.sui_flp_amount = v1.amount.sui_flp_amount + v3;
            arg0.total_amount.sui_flp_amount = arg0.total_amount.sui_flp_amount + v3;
        } else {
            assert!(v2 == 0x1::type_name::with_defining_ids<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>(), 5);
            let v4 = 0x2::coin::value<T0>(&arg4) / 5000000;
            v1.amount.usdc_flp_amount = v1.amount.usdc_flp_amount + v4;
            arg0.total_amount.usdc_flp_amount = arg0.total_amount.usdc_flp_amount + v4;
        };
    ...
    fun deposit_amount<T0>(arg0: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market::Market<T0>, arg1: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::obligation::Obligation<T0>, arg2: 0x1::type_name::TypeName) : 0x19a53942ca9b7cef4fbc820e0b06ebbf213e4853457ce8b7a5149ebcb4131766::float::Decimal {
        0x19a53942ca9b7cef4fbc820e0b06ebbf213e4853457ce8b7a5149ebcb4131766::float::mul_u64(0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market::exchange_rate<T0>(arg0, arg2), 0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::obligation::ctoken_amount_by_coin<T0>(arg1, arg2))
    }
    ...
    public fun lock_flp(arg0: &AdminCap, arg1: &mut FLPApp, arg2: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market::Market<0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market_type::MainMarket>, arg3: vector<0x2::object::ID>) {
        ...
        while (v0 < 0x1::vector::length<0x2::object::ID>(&arg3)) {
            ...
            assert!(!v2.scanned, 3);
            v2.scanned = true;
            snapshot_obligation_flp_quota<0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market_type::MainMarket>(arg2, v1, v2);
            v0 = v0 + 1;
        };
    }
    ...
    fun snapshot_obligation_flp_quota<T0>(arg0: &0xa377cac91d12de361e03940bad7f17ceaaa9dc095ae2c30b284110ef099cb8b6::market::Market<T0>, arg1: 0x2::object::ID, arg2: &ObligationFLP) {
