module 0x8b49178823290ee3227325768bba7b324550c55b49e13ee4cee1d4b3b41597a7::events {
    ...
    public(friend) fun emit_add_registry_event<T0>(arg0: vector<u8>, arg1: &0x2::tx_context::TxContext) {
        let v0 = AddRegistryEvent{
            ...
            xasset_type : 0x1::ascii::string(0x8b49178823290ee3227325768bba7b324550c55b49e13ee4cee1d4b3b41597a7::utils::type_to_bytes<T0>()),
            price_id    : arg0,
        };
