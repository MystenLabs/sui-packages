module 0x8b2606046677f0ea8e9b53b87c4f1bc0a79277327bec75a4acf6a35a23926b6e::reward5308 {
    struct REWARD5308 has drop {
        dummy_field: bool,
    }

    struct TICKET_5308 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5308(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_5308>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5308, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5308>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5308>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5308>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5308>>(v5, 0x2::tx_context::sender(arg1));
    }
