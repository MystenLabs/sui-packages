module 0x8b2066cb96ce59199e0f2277b6c433929bb6cbb4867b8272a34ae6038d280e4f::sui {
    struct SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SUI>(&mut v2, 30000000 * 0x1::u64::pow(10, 9), 0x2::tx_context::sender(arg1), arg1);
