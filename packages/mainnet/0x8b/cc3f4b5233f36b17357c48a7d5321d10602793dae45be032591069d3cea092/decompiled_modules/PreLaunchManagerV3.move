module 0x8bcc3f4b5233f36b17357c48a7d5321d10602793dae45be032591069d3cea092::PreLaunchManagerV3 {
    ...
    public entry fun addLiq<T0>(arg0: &0x2::clock::Clock, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x2::sui::SUI, T0>, arg3: &mut 0x2::tx_context::TxContext) {
        open_position_with_liquidity_with_all<0x2::sui::SUI, T0>(arg1, arg2, 1, 100, 10, 10, false, arg0, arg3);
    }
    ...
    public entry fun finish_round(arg0: &mut PreLaunchManagerV3, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::borrow_mut<Round>(&mut arg0.rounds, arg1);
        assert_is_owner(v0.creator, 0x2::tx_context::sender(arg2));
        v0.is_finished = true;
    }
    ...
    public entry fun start_round(arg0: &mut PreLaunchManagerV3, arg1: vector<u8>, arg2: address, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u64>, arg10: vector<u8>, arg11: bool, arg12: &0x2::clock::Clock, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: &mut 0x2::tx_context::TxContext) {
