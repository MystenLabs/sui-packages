module 0x8bd872178f056ecd44c70c9c02328646479789d7ea4df6571b82e5d996c1dabf::V19Test {
    ...
    public fun deepbook_a_to_b_test<T0, T1>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut AccessList, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        check_valid(arg5, arg6);
        let v0 = 0xdee9::clob_v2::create_account(arg6);
        let (v1, v2) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg2, &v0, arg3, arg0, false, arg1, 0x2::coin::from_balance<T1>(0x2::balance::zero<T1>(), arg6), arg4, arg6);
        let v3 = v2;
        let v4 = v1;
        ...
        let v5 = MEVStepEvent{
            ...
            coin_in_left : 0x2::coin::value<T0>(&arg1),
        };
        0x2::event::emit<MEVStepEvent>(v5);
        0x2::pay::keep<T0>(v4, arg6);
        0xdee9::custodian_v2::delete_account_cap(v0);
        v3
    }
