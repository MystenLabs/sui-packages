module 0x6435e67af83654e55b9ea83334a0c6ee0c80c95b3bb66f856e1658b23830adb2::multisig_escrow {
    ...
    public fun cancel_listing_by_admin(arg0: &mut Listings, arg1: &AdminListingCap, arg2: 0x2::object::ID) {
        check_package_available(arg0);
        assert!(0x2::dynamic_object_field::borrow<0x2::object::ID, Listing>(&arg0.id, arg2).in_escrow_amount == 0, 11);
        delete_listing(arg0, arg2);
    }
    ...
    fun check_version(arg0: &Listings) : bool {
        0x2::table::contains<u64, bool>(&0x2::dynamic_object_field::borrow<vector<u8>, VersionRegistry>(&arg0.id, b"version_registry").allowed_versions, 5)
    }
    ...
    public(friend) fun set_version_registry(arg0: &mut Listings, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u64, bool>(&mut v0.allowed_versions, 5, true);
