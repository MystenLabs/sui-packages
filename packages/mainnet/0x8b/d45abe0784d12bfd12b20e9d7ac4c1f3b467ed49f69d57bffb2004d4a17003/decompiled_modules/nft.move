module 0x8bd45abe0784d12bfd12b20e9d7ac4c1f3b467ed49f69d57bffb2004d4a17003::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"JoJo-Ben"),
            description : 0x1::string::utf8(b"JoJo-Ben NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/173065194?v=4"),
        };
