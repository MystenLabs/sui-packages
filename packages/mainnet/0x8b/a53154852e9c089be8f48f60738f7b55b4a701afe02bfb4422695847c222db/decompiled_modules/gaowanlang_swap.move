module 0x8ba53154852e9c089be8f48f60738f7b55b4a701afe02bfb4422695847c222db::gaowanlang_swap {
    ...
    fun add_liquidity_inner<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        assert!(0x2::balance::join<T0>(&mut arg0.coin_a, v3) < 1844674407370955 && 0x2::balance::join<T1>(&mut arg0.coin_b, v4) < 1844674407370955, 1);
    ...
    public fun calc_output_amount(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        let v0 = (arg1 as u128);
        let v1 = (arg2 as u128);
        ((v1 - v0 * v1 / (v0 + (arg0 as u128) * (10000 - (arg3 as u128)) / 10000)) as u64)
    }

    public entry fun create_pool<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = createa_pool_inner<T0, T1>(arg0, arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<LSP<T0, T1>>>(v0, 0x2::tx_context::sender(arg2));
    }

    fun createa_pool_inner<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        let v0 = 0x2::coin::value<T0>(&arg0);
        let v1 = 0x2::coin::value<T1>(&arg1);
        assert!(v0 > 0 && v1 > 0, 0);
        assert!(v0 < 1844674407370955 && v1 < 1844674407370955, 1);
        let v2 = LSP<T0, T1>{dummy_field: false};
        let v3 = 0x2::balance::create_supply<LSP<T0, T1>>(v2);
        let v4 = Pool<T0, T1>{
            id          : 0x2::object::new(arg2),
            coin_a      : 0x2::coin::into_balance<T0>(arg0),
            coin_b      : 0x2::coin::into_balance<T1>(arg1),
            lsp_supply  : v3,
    ...
    public fun get_amounts<T0, T1>(arg0: &Pool<T0, T1>) : (u64, u64, u64) {
        (0x2::balance::value<T0>(&arg0.coin_a), 0x2::balance::value<T1>(&arg0.coin_b), 0x2::balance::supply_value<LSP<T0, T1>>(&arg0.lsp_supply))
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LSP<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    fun remove_liquidity_inner<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LSP<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x2::coin::take<T0>(&mut arg0.coin_a, v2 * v0 / v3, arg2), 0x2::coin::take<T1>(&mut arg0.coin_b, v1 * v0 / v3, arg2))
    }
    ...
    fun swap_a_to_b_inner<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x2::coin::take<T1>(&mut arg0.coin_b, sell_token_a<T0, T1>(arg0, v0), arg2)
    }
    ...
    fun swap_b_to_a_inner<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::coin::take<T0>(&mut arg0.coin_a, sell_token_b<T0, T1>(arg0, v0), arg2)
    }
