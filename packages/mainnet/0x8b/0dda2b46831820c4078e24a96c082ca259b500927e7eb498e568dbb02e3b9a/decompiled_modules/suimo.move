module 0x8b0dda2b46831820c4078e24a96c082ca259b500927e7eb498e568dbb02e3b9a::suimo {
    ...
    fun init(arg0: SUIMO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Suimo"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Welcome to Suimo on Sui, Limited Edition NFTs! Don't miss out on these great limited run of NFTs to support Suimo Meme Coin project"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibzms6sbr6mlq4sisc4srdiphkn6uy6oel546xzqxgcpkimjy6kzu"));
