module 0x8b1b5c34bb517c4a0e7ca35ee73ea5be90607b7c2bd99fb07d5e09c77cc95dc8::reward7026 {
    struct REWARD7026 has drop {
        dummy_field: bool,
    }

    struct TICKET_7026 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7026(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7026>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7026>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7026, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7026>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7026>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7026>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7026>>(v5, 0x2::tx_context::sender(arg1));
    }
