module 0xc91878df094985a3d14874e8e1cce6d03fb6a55be231c1022aea8f9977a8e559::credenza_asset_collection {
    ...
    public fun add_asset(arg0: &mut CollectionCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        0xc91878df094985a3d14874e8e1cce6d03fb6a55be231c1022aea8f9977a8e559::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg4));
    ...
    public fun buy_asset<T0>(arg0: &mut CollectionCap, arg1: &0xc91878df094985a3d14874e8e1cce6d03fb6a55be231c1022aea8f9977a8e559::sellable::CredenzaSellableConfig<CREDENZA_ASSET_COLLECTION>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        0xc91878df094985a3d14874e8e1cce6d03fb6a55be231c1022aea8f9977a8e559::sellable::accept_asset_payment_coin<CREDENZA_ASSET_COLLECTION, T0>(arg1, arg3, arg2, arg5);
    ...
    fun init(arg0: CREDENZA_ASSET_COLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (_, v4) = 0xc91878df094985a3d14874e8e1cce6d03fb6a55be231c1022aea8f9977a8e559::sellable::create_config<CREDENZA_ASSET_COLLECTION>(arg0, arg1);
        0x2::transfer::public_share_object<CollectionCap>(v1);
        0x2::transfer::public_share_object<0xc91878df094985a3d14874e8e1cce6d03fb6a55be231c1022aea8f9977a8e559::sellable::CredenzaSellableConfig<CREDENZA_ASSET_COLLECTION>>(v4);
    }
    ...
    public fun update_metadata(arg0: &mut CollectionCap, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        0xc91878df094985a3d14874e8e1cce6d03fb6a55be231c1022aea8f9977a8e559::ownership::assert_owner(&arg0.ownership, 0x2::tx_context::sender(arg5));
