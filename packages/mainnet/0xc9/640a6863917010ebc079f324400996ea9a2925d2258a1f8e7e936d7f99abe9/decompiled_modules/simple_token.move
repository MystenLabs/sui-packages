module 0xc9640a6863917010ebc079f324400996ea9a2925d2258a1f8e7e936d7f99abe9::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"SUINAMI", b"SUINAMI", b"Official token. Banner on Dexscreener paid and Boost!", 0x1::option::none<0x2::url::Url>(), arg1);
