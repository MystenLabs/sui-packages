module 0xc98a223c093e0981e7220e4de19a202de6681bdd730436342ef9ac060d4478f2::reward4328 {
    struct REWARD4328 has drop {
        dummy_field: bool,
    }

    struct TICKET_4328 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4328(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4328>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4328>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4328, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4328>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4328>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4328>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4328>>(v5, 0x2::tx_context::sender(arg1));
    }
