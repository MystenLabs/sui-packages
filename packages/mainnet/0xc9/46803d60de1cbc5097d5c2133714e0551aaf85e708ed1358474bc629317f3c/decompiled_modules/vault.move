module 0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::vault {
    ...
    public(friend) fun borrow<T0>(arg0: &Vault) : &0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x2::balance::Balance<T0>>(&arg0.id, 0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::utils::get_type_name_string<T0>())
    }

    public(friend) fun borrow_mut<T0>(arg0: &mut Vault) : &mut 0x2::balance::Balance<T0> {
        0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut arg0.id, 0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::utils::get_type_name_string<T0>())
    }
    ...
    fun makesure<T0>(arg0: &mut Vault) {
        let v0 = 0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::utils::get_type_name_string<T0>();
