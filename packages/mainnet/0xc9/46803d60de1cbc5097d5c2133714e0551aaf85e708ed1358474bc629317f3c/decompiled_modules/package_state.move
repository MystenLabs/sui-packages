module 0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::package_state {
    ...
    public(friend) fun check_version(arg0: &State) {
        assert!(0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::consts::VERSION() >= arg0.available_version, 3);
    }

    fun get_feature_bit(arg0: &State, arg1: u8, arg2: u8) : bool {
        0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::utils::get_bit(*0x1::vector::borrow<u256>(&arg0.features, (arg1 as u64)), arg2)
    }
    ...
    public(friend) fun init_(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = State{
            ...
            available_version : 0xc946803d60de1cbc5097d5c2133714e0551aaf85e708ed1358474bc629317f3c::consts::VERSION(),
