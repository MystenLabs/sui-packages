module 0xc98d0ea4bc6ca2937a03e29350c65660ad93d2d6bed81915a340efcf14100731::reward1622 {
    struct REWARD1622 has drop {
        dummy_field: bool,
    }

    struct TICKET_1622 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1622(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1622>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1622>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1622, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1622>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1622>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1622>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1622>>(v5, 0x2::tx_context::sender(arg1));
    }
