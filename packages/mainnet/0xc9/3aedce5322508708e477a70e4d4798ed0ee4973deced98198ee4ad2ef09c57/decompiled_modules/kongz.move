module 0xc93aedce5322508708e477a70e4d4798ed0ee4973deced98198ee4ad2ef09c57::kongz {
    ...
    fun init(arg0: KONGZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/3qhShHhZvduHoea19hYLBsZd358gKLc9mLrUVCHye6YV.png?size=lg&key=863390                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<KONGZ>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KONGZ     ")))), trim_right(b"CyberKongz on Sui               "), trim_right(b"$KONGZ - The NFT Utility Token on Sui                                                                                                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
