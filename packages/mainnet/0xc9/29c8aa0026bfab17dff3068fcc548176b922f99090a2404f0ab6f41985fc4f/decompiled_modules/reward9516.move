module 0xc929c8aa0026bfab17dff3068fcc548176b922f99090a2404f0ab6f41985fc4f::reward9516 {
    struct REWARD9516 has drop {
        dummy_field: bool,
    }

    struct TICKET_9516 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9516(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9516>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9516>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9516, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9516>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9516>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9516>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9516>>(v5, 0x2::tx_context::sender(arg1));
    }
