module 0xc97d96a8ed8c5a4c3e7171d06429622b0273716aedc99829d2435c6b14d5f164::holy {
    ...
    fun init(arg0: HOLY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/3qEJsZCpUtWUykipdQXKZ88aexQKVcuGRJYA3ezmUMHt.png?size=lg&key=736feb                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<HOLY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"HOLY      ")))), trim_right(b"Holy Grail                      "), trim_right(b"The ultimate crypto gem, delivering speed, security, and freedom. Redefine your financial future with ease and innovation!                                                                                                                                                                                                      "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
