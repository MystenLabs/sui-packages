module 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::tails_staking {
    ...
    entry fun set_profit_sharing<T0>(arg0: &mut 0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg1: vector<u64>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::version_check(arg0);
        0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::validate_registry_authority(arg0, arg3);
        ...
        let v6 = ProfitSharingEvent{
            level_profits : arg1,
            value         : 0x2::coin::value<T0>(&arg2),
            token         : 0x1::type_name::get<T0>(),
        };
        0x2::event::emit<ProfitSharingEvent>(v6);
        let v7 = ProfitSharing<T0>{
            level_profits : arg1,
        ...
        0x2::dynamic_field::add<0x1::string::String, ProfitSharing<T0>>(&mut v0.id, 0x1::string::utf8(b"dice_profit_sharing"), v7);
    }
