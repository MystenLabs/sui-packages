module 0xc91176bdfec3601174c544b4a2924f91fbcc6078ee02799b0e464dda03b8c71b::suipaynft {
    ...
    fun mintInternal(arg0: vector<0x1::string::String>, arg1: &mut ContractInfo, arg2: u64, arg3: 0x1::string::String, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = gen_next_free(0xc91176bdfec3601174c544b4a2924f91fbcc6078ee02799b0e464dda03b8c71b::pseudorandom::rand_u32(arg6) % (50 as u32), arg1);
        let v1 = calc_traits(v0, arg1);
        let v2 = 0;
        while (v2 < 0x1::vector::length<Feature>(&v1)) {
            let v3 = 0x1::vector::borrow<Feature>(&v1, v2);
            0x1::vector::push_back<0x1::string::String>(&mut arg0, append(v3.name, 0x1::string::utf8(b"Body"), 0x1::vector::borrow<Trait>(&v3.traits, 0).name));
            v2 = v2 + 1;
        };
        let v4 = NFT{
    ...
    fun u64_to_vector_u8(arg0: u64) : vector<u8> {
        let v0 = 0x1::vector::empty<u8>();
        let v1 = 56;
        while (v1 >= 0) {
            0x1::vector::push_back<u8>(&mut v0, ((arg0 >> v1 & 255) as u8));
