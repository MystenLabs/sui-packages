module 0xc9b9231a0e459b94da1c8cf7059fe924ce9952c257ca2e82eccf52f277d9233f::shockwave {
    ...
    fun init(arg0: SHOCKWAVE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[b"SHOCKWAVE", b"Shock Wave", b"What happens when 99% of the supply is out of circulation? Let's find out. ", b"https://api.interestlabs.io/files/96dfd6a12b2e65e2b8a398583e44c8ca05a953bf97700f79.jpg"];
        let v2 = vector[b"SHOCKWAVE", b"Shock Wave", b"What happens when 99% of the supply is out of circulation? Let's find out. ", b"https://api.interestlabs.io/files/96dfd6a12b2e65e2b8a398583e44c8ca05a953bf97700f79.jpg"];
        let v3 = vector[b"SHOCKWAVE", b"Shock Wave", b"What happens when 99% of the supply is out of circulation? Let's find out. ", b"https://api.interestlabs.io/files/96dfd6a12b2e65e2b8a398583e44c8ca05a953bf97700f79.jpg"];
        let v4 = vector[b"SHOCKWAVE", b"Shock Wave", b"What happens when 99% of the supply is out of circulation? Let's find out. ", b"https://api.interestlabs.io/files/96dfd6a12b2e65e2b8a398583e44c8ca05a953bf97700f79.jpg"];
