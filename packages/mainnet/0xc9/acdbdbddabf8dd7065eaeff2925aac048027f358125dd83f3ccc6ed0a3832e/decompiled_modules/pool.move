module 0xc9acdbdbddabf8dd7065eaeff2925aac048027f358125dd83f3ccc6ed0a3832e::pool {
    ...
    public(friend) fun deposit_treasury<T0>(arg0: &mut Pool<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 0xc9acdbdbddabf8dd7065eaeff2925aac048027f358125dd83f3ccc6ed0a3832e::error::insufficient_balance());
    ...
    public(friend) fun withdraw_reserve_balance<T0>(arg0: &PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 >= arg2, 0xc9acdbdbddabf8dd7065eaeff2925aac048027f358125dd83f3ccc6ed0a3832e::error::insufficient_balance());
    ...
    public fun withdraw_treasury<T0>(arg0: &mut PoolAdminCap, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::balance::value<T0>(&arg1.treasury_balance) >= arg2, 0xc9acdbdbddabf8dd7065eaeff2925aac048027f358125dd83f3ccc6ed0a3832e::error::insufficient_balance());
