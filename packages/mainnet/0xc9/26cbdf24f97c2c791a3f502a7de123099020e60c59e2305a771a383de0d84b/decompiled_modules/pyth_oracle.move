module 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::pyth_oracle {
    ...
    public fun get_price<T0>(arg0: &PythOracle, arg1: &0x2::clock::Clock) : Price {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, v0), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::price_not_exists());
        let v1 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v0);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 - v1.last_update_time <= 0x2::table::borrow<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0).usd_price_age, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::price_not_stale());
        v1
    }
    ...
    public fun add_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: &0x2::tx_context::TxContext) {
        ...
        0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg6));
        let v0 = 0x1::type_name::get<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::oracle_info_exists());
    ...
    public fun calculate_oracle_prices<T0, T1>(arg0: &PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::oracle_info_not_exists());
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v1), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::oracle_info_not_exists());
        ...
        assert!(v2.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::price_object_not_match_with_coin_type());
        assert!(v3.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::price_object_not_match_with_coin_type());
    ...
    fun calculate_prices_from_base_quote(arg0: u64, arg1: u64, arg2: u8, arg3: u8) : (u64, u64) {
        (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_floor(arg0, 0x1::u64::pow(10, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::utils::oracle_price_multiplier_decimal() + arg3 - arg2), arg1), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_floor(arg1, 0x1::u64::pow(10, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::utils::oracle_price_multiplier_decimal() + arg2 - arg3), arg0))
    }
    ...
    public fun get_price_by_type(arg0: &PythOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : Price {
        ...
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 - v0.last_update_time <= 0x2::table::borrow<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, arg1).usd_price_age, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::price_not_stale());
        v0
    }
    ...
    public fun pyth_price_from_oracle_info(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(arg1.price_feed_id == 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::invalid_price_feed_id());
        ...
        assert!(v5 != 0, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::invalid_oracle_price());
        if (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v3)) {
            ...
            if (v7 < 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::utils::oracle_price_multiplier_decimal()) {
                v5 * 0x1::u64::pow(10, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::utils::oracle_price_multiplier_decimal() - v7)
            } else {
                v5 / 0x1::u64::pow(10, v7 - 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::utils::oracle_price_multiplier_decimal())
            }
        } else {
            v5 * 0x1::u64::pow(10, (0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v3) as u8) + 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::utils::oracle_price_multiplier_decimal())
        }
    }

    public fun remove_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::GlobalConfig, arg2: &0x2::tx_context::TxContext) {
        0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::checked_package_version(arg1);
        0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg2));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::oracle_info_not_exists());
    ...
    public(friend) fun split_fee(arg0: &mut PythOracle, arg1: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.update_price_fee) >= arg1, 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::update_price_fee_not_enough());
    ...
    public fun update_price<T0>(arg0: &mut PythOracle, arg1: &0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::GlobalConfig, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::hot_potato_vector::HotPotatoVector<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfo>, arg4: &mut 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::hot_potato_vector::HotPotatoVector<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfo> {
        ...
        let v2 = UpdatePriceEvent{
            ...
            price            : price_value(&v1),
            last_update_time : last_update_time(&v1),
        };
    ...
    public fun update_price_age<T0>(arg0: &mut PythOracle, arg1: &0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::GlobalConfig, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::checked_package_version(arg1);
        0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg3));
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::oracle_info_not_exists());
    ...
    fun update_price_from_type<T0>(arg0: &mut PythOracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : Price {
        ...
        assert!(v1.price_info_object_id == 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg1), 0xc926cbdf24f97c2c791a3f502a7de123099020e60c59e2305a771a383de0d84b::error::price_object_not_match_with_coin_type());
        let v2 = Price{
