module 0xc9e28008222597c1a872ceceb0971389ec3e220dc9d3a13430e89fb578df5cca::rich_kid_walrus {
    struct RICH_KID_WALRUS has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"502b4f49-fc94-4935-a80a-a971c868df10"),
        };
    ...
    fun init(arg0: RICH_KID_WALRUS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RICH_KID_WALRUS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Rich Kid Walrus"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A blobby adorable baby walrus, here to recognise the original Walrus community"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmQsY8BU9HFSjBEwqwtUUQ7LF9UT2Myw6vTn3RZwG3ZUWb"));
