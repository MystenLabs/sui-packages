module 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::market {
    ...
    public fun initialize(arg0: &mut MarketConfig, arg1: &mut 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::LockData, arg2: address, arg3: vector<vector<u8>>, arg4: vector<u64>) {
        assert!(!arg0.initialized, 113);
        arg0.initialized = true;
        0x2::table::add<address, bool>(&mut arg0.admin_members, arg2, true);
        0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::update_lock_wait_times(arg1, arg3, arg4);
    }

    public fun job_close(arg0: &mut Marketplace, arg1: &mut 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::LockData, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        ...
        assert!(0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::unlock(arg1, rate_lock_selector(), job_id_bytes(arg2), arg3) == 0, 111);
        job_close_internal(arg0, arg1, arg2, arg3, arg4);
    }

    fun job_close_internal(arg0: &mut Marketplace, arg1: &mut 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::LockData, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::table::borrow_mut<u128, Job>(&mut arg0.jobs, arg2);
        ...
        0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::revert_lock(arg1, rate_lock_selector(), job_id_bytes(arg2));
    ...
    public fun job_revise_rate_cancel(arg0: &mut Marketplace, arg1: &mut 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::LockData, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        ...
        assert!(0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::lock_status(arg1, &v0, &v1, arg3) != 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::lock_status_none(), 112);
        0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::revert_lock(arg1, v0, v1);
        let v2 = JobReviseRateCancelled{job_id: arg2};
        0x2::event::emit<JobReviseRateCancelled>(v2);
    }

    public fun job_revise_rate_finalize(arg0: &mut Marketplace, arg1: &mut 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::LockData, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        let v0 = 0x2::table::borrow_mut<u128, Job>(&mut arg0.jobs, arg2);
        assert!(v0.owner == 0x2::tx_context::sender(arg4), 105);
        revise_job_rate(v0, arg2, (0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::unlock(arg1, rate_lock_selector(), job_id_bytes(arg2), arg3) as u64), arg3, arg4);
    }

    public fun job_revise_rate_initiate(arg0: &mut Marketplace, arg1: &mut 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::LockData, arg2: u128, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        assert!(0x2::table::borrow_mut<u128, Job>(&mut arg0.jobs, arg2).owner == 0x2::tx_context::sender(arg5), 105);
        0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::lock(arg1, rate_lock_selector(), job_id_bytes(arg2), (arg3 as u256), arg4);
    ...
    public fun job_withdraw(arg0: &mut Marketplace, arg1: &mut 0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::LockData, arg2: u128, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        assert!(arg3 > 0, 106);
        let v0 = 0x2::table::borrow_mut<u128, Job>(&mut arg0.jobs, arg2);
        ...
        let v3 = ((((v0.rate as u128) * (0xc94d6d2b8f439ade046beb8653d486d8933ebf182a9d89671211a5488e938fbf::lock::lock_wait_time_ms(arg1, rate_lock_selector()) as u128) + v2 - 1) / v2) as u64);
