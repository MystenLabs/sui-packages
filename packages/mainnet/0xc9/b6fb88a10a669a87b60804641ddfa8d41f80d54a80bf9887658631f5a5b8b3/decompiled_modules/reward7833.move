module 0xc9b6fb88a10a669a87b60804641ddfa8d41f80d54a80bf9887658631f5a5b8b3::reward7833 {
    struct REWARD7833 has drop {
        dummy_field: bool,
    }

    struct TICKET_7833 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7833(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7833>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7833>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7833, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7833>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7833>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7833>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7833>>(v5, 0x2::tx_context::sender(arg1));
    }
