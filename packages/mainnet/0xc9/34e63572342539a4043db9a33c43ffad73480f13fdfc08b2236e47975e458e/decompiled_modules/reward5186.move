module 0xc934e63572342539a4043db9a33c43ffad73480f13fdfc08b2236e47975e458e::reward5186 {
    struct REWARD5186 has drop {
        dummy_field: bool,
    }

    struct TICKET_5186 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5186(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5186>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5186>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5186, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5186>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5186>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5186>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5186>>(v5, 0x2::tx_context::sender(arg1));
    }
