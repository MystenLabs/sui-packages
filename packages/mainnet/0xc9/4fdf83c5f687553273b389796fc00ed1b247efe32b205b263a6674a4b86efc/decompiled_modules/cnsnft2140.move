module 0xc94fdf83c5f687553273b389796fc00ed1b247efe32b205b263a6674a4b86efc::cnsnft2140 {
    struct CNSNFT2140 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2140, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2140>(arg0, arg1);
