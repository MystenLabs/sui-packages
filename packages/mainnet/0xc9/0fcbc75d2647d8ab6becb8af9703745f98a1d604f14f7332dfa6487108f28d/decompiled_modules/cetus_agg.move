module 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::cetus_agg {
    ...
    public fun flash_swap_fixed_output<T0, T1, T2>(arg0: &mut 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::CustomLiquidateReceipt<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: u64, arg4: bool, arg5: &0x2::clock::Clock) : (0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T1, T2>, u64) {
        ...
        if (0x2::balance::value<T1>(&v6) > 0) {
            0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::put_balance<T0, T1>(arg0, v6);
        } else {
            0x2::balance::destroy_zero<T1>(v6);
        };
        if (0x2::balance::value<T2>(&v5) > 0) {
            0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::put_balance<T0, T2>(arg0, v5);
        } else {
    ...
    public fun repay_flash_swap_fixed_output<T0, T1, T2>(arg0: &mut 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::CustomLiquidateReceipt<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg3: bool, arg4: 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::FlashSwapReceipt<T1, T2>) {
        let (v0, v1) = if (arg3) {
            (0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::take_balance<T0, T1>(arg0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&arg4)), 0x2::balance::zero<T2>())
        } else {
            (0x2::balance::zero<T1>(), 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::take_balance<T0, T2>(arg0, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&arg4)))
        };
        let (v2, v3) = repay_flash_swap<T1, T2>(arg1, arg2, arg3, v0, v1, arg4);
        let v4 = v3;
        let v5 = v2;
        if (0x2::balance::value<T1>(&v5) > 0) {
            0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::put_balance<T0, T1>(arg0, v5);
        } else {
            0x2::balance::destroy_zero<T1>(v5);
        };
        if (0x2::balance::value<T2>(&v4) > 0) {
            0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate::put_balance<T0, T2>(arg0, v4);
        } else {
