module 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::custom_liquidate {
    ...
    public fun custom_liquidate<T0, T1, T2>(arg0: &0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::liquidator::Liquidator, arg1: &mut CustomLiquidateReceipt<T1>, arg2: 0x2::coin::Coin<T2>, arg3: &0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::app::ProtocolApp, arg4: 0x2::object::ID, arg5: &mut 0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::market::Market<T0>, arg6: &0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::coin_decimals_registry::CoinDecimalsRegistry, arg7: &0x1814e6627da87fd0f998d978b664adaed87e7d072ab93ddc8453b9b0aaa2d733::x_oracle::XOracle, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x871ed8559523f2762d279cafe38ac8cf9b1f136d925a60abf5319c667ee6507b::liquidate::liquidate_as_coin<T0, T2, T1>(arg3, 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::liquidator::borrow_package_caller_cap(arg0), arg4, arg5, arg2, arg6, arg7, arg8, arg9);
        let v2 = v1;
        put_balance<T1, T1>(arg1, 0x2::coin::into_balance<T1>(v0));
        if (0x2::coin::value<T2>(&v2) == 0) {
            0x2::coin::destroy_zero<T2>(v2);
        } else {
            put_balance<T1, T2>(arg1, 0x2::coin::into_balance<T2>(v2));
        };
    }
    ...
    public fun create_receipt<T0>(arg0: &0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::liquidator::Liquidator, arg1: &mut 0x2::tx_context::TxContext) : CustomLiquidateReceipt<T0> {
        0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::liquidator::ensure_caller_whitelisted(arg0, 0x2::tx_context::sender(arg1));
        ...
        if (0x2::table::contains<u8, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&arg0.flash_loan_debts, arg1)) {
            ...
            if (0x2::table::contains<0x1::type_name::TypeName, u64>(v1, v0)) {
                ...
                *v2 = *v2 - arg2;
                ...
                0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::error::invalid_coin_type();
            };
        } else {
            0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::error::invalid_protocol_id();
        };
    }

    public(friend) fun take_balance<T0, T1>(arg0: &mut CustomLiquidateReceipt<T0>, arg1: u64) : 0x2::balance::Balance<T1> {
        let v0 = 0x1::type_name::with_defining_ids<T1>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::error::invalid_coin_type());
        let v1 = 0x2::balance::value<T1>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.balances, v0));
        assert!(v1 >= arg1, 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::error::insufficient_balance());
        if (arg1 == v1) {
    ...
    public fun verify_custom_liquidate<T0>(arg0: &0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::liquidator::Liquidator, arg1: CustomLiquidateReceipt<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        let v3 = v0;
        assert!(0x2::table::is_empty<u8, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&v2), 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::error::flash_loan_debts_not_empty());
        0x2::table::destroy_empty<u8, 0x2::table::Table<0x1::type_name::TypeName, u64>>(v2);
        assert!(0x2::bag::is_empty(&v3), 0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::error::balances_not_empty());
        0x2::bag::destroy_empty(v3);
        0xc90fcbc75d2647d8ab6becb8af9703745f98a1d604f14f7332dfa6487108f28d::liquidator::transfer_to_recipient<T0>(arg0, 0x2::coin::from_balance<T0>(0x2::bag::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v3, 0x1::type_name::with_defining_ids<T0>()), arg2));
    }
