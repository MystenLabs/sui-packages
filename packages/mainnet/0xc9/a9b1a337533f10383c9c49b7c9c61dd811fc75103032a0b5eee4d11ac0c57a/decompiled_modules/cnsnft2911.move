module 0xc9a9b1a337533f10383c9c49b7c9c61dd811fc75103032a0b5eee4d11ac0c57a::cnsnft2911 {
    struct CNSNFT2911 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2911, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2911>(arg0, arg1);
