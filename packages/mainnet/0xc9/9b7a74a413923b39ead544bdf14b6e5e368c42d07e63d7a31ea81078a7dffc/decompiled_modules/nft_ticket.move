module 0xc99b7a74a413923b39ead544bdf14b6e5e368c42d07e63d7a31ea81078a7dffc::nft_ticket {
    ...
    public entry fun mint(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = LotteryTicket{
            ...
            image_url   : 0x2::url::new_unsafe_from_bytes(b"https://color-jump.xyz/nfts/myimage.jpg"),
        };
