module 0xc9860208869ad1cce0b4e8ec114ebabbacb0d61450f0cd45ae044074b89c0ade::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T679570", b"Test 679570", b"Integration test token 2025-10-29T11:51:19.570Z", 0x1::option::none<0x2::url::Url>(), arg1);
