module 0xc9d7594a3cc03213d90cda9c65394657394825981e683800cc341131ac8ce489::sui_paradox {
    struct SUI_PARADOX has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_PARADOX, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_PARADOX>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sui Paradox"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
