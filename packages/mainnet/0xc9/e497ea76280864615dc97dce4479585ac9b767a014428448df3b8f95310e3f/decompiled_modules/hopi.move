module 0xc9e497ea76280864615dc97dce4479585ac9b767a014428448df3b8f95310e3f::hopi {
    struct HOPI has drop {
        dummy_field: bool,
    }

    fun init(arg0: HOPI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HOPI>(arg0, 6, b"HOPI", b"Hopionsui", x"5468652068696c6172696f75736c7920636c75656c65737320686970706f206f6e20537569f09fa69bf09f92ab", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmQv4usd5eMQYMp93E5pASEWyQP9JCi7QM3bAaWhVfz4pn")), arg1);
        let v2 = v0;
