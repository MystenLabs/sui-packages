module 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::timecapsule {
    ...
    entry fun migrate(arg0: &mut TimecapsuleStore, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version < 3, 5);
        arg0.version = 3;
    }
    ...
    public entry fun put_object_to_bag<T0: store + key>(arg0: &mut TimecapsuleStore, arg1: &mut Timecapsule, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 3, 5);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        if (0x2::object_bag::contains<0x1::ascii::String>(&arg1.object_bag, v0)) {
            ...
            let v3 = false;
            let v4 = b"{str:s}_{suffix:i}";
            let v5 = b"";
            let v6 = b"str";
            let v7 = 0x1::ascii::into_bytes(v0);
            0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::set<vector<u8>>(&mut v5, 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::key(&v6), &v7);
            while (!v3) {
                let v8 = b"suffix";
                0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::set<u64>(&mut v5, 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::key(&v8), &v1);
                let v9 = 0x1::ascii::string(0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::format::format(&v4, &v5));
                v2 = v9;
                v1 = v1 + 1;
                if (!0x2::object_bag::contains<0x1::ascii::String>(&arg1.object_bag, v9)) {
                    v3 = true;
                };
            };
            0x2::object_bag::add<0x1::ascii::String, T0>(&mut arg1.object_bag, v2, arg2);
        } else {
            arg1.level = arg1.level + 1;
            if (arg1.level == 1) {
                arg1.image = 0x1::string::utf8(b"https://suidouble.github.io/hexcapsule/capsule_gold.png");
            ...
            0x2::object_bag::add<0x1::ascii::String, T0>(&mut arg1.object_bag, v0, arg2);
        };
    }
    ...
    public fun take_out_object_no_entry<T0: store + key>(arg0: &mut TimecapsuleStore, arg1: &mut Timecapsule, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        assert!(arg0.version == 3, 5);
        if (!arg1.decrypted) {
            abort 6
        };
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<T0>());
        assert!(0x2::object_bag::contains<0x1::ascii::String>(&arg1.object_bag, v0), 7);
        let v1 = v0;
        let v2 = 1;
        let v3 = true;
        let v4 = b"{str:s}_{suffix:i}";
        ...
        while (v3) {
            let v8 = b"suffix";
            0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::set<u64>(&mut v5, 0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::metadata::key(&v8), &v2);
            let v9 = 0x1::ascii::string(0x20abcd433df2c68f62b794d0751d3a839945dcb6776ecf9fac76d3f0324a274::format::format(&v4, &v5));
            v2 = v2 + 1;
            if (0x2::object_bag::contains<0x1::ascii::String>(&arg1.object_bag, v9)) {
                v1 = v9;
        ...
        0x2::object_bag::remove<0x1::ascii::String, T0>(&mut arg1.object_bag, v1)
    }

    public entry fun take_out_objects<T0: store + key>(arg0: &mut TimecapsuleStore, arg1: &mut Timecapsule, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 3, 5);
        if (!arg1.decrypted) {
            abort 6
        };
        while (0x2::object_bag::contains<0x1::ascii::String>(&arg1.object_bag, 0x1::type_name::into_string(0x1::type_name::get<T0>()))) {
            let v0 = take_out_object_no_entry<T0>(arg0, arg1, arg2);
