module 0xf727a044d11130969df158f61fe79907c8a8b56ae8f5adf12bf004323d368f6::crates {
    ...
    struct AuthorizedBotsKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public entry fun admin_add_bot<T0, T1>(arg0: &AdminCap, arg1: &mut CratePool<T0, T1>, arg2: address) {
        let v0 = &mut arg1.id;
        let v1 = AuthorizedBotsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<AuthorizedBotsKey>(v0, v1), 13);
        let v2 = AuthorizedBotsKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<AuthorizedBotsKey, 0x2::table::Table<address, bool>>(v0, v2);
        assert!(!0x2::table::contains<address, bool>(v3, arg2), 14);
        0x2::table::add<address, bool>(v3, arg2, true);
    }

    public entry fun admin_emergency_withdraw_sui<T0, T1>(arg0: &AdminCap, arg1: &mut CratePool<T0, T1>, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun admin_init_bots<T0, T1>(arg0: &AdminCap, arg1: &mut CratePool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg1.id;
        let v1 = AuthorizedBotsKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<AuthorizedBotsKey>(v0, v1), 12);
        let v2 = AuthorizedBotsKey{dummy_field: false};
        0x2::dynamic_field::add<AuthorizedBotsKey, 0x2::table::Table<address, bool>>(v0, v2, 0x2::table::new<address, bool>(arg2));
    }

    public entry fun admin_remove_bot<T0, T1>(arg0: &AdminCap, arg1: &mut CratePool<T0, T1>, arg2: address) {
        let v0 = &mut arg1.id;
        let v1 = AuthorizedBotsKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<AuthorizedBotsKey>(v0, v1), 13);
        let v2 = AuthorizedBotsKey{dummy_field: false};
        let v3 = 0x2::dynamic_field::borrow_mut<AuthorizedBotsKey, 0x2::table::Table<address, bool>>(v0, v2);
        assert!(0x2::table::contains<address, bool>(v3, arg2), 15);
        0x2::table::remove<address, bool>(v3, arg2);
    }
    ...
    public entry fun buy_ticket<T0, T1>(arg0: &mut CratePool<T0, T1>, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.enabled, 7);
        assert!(total_bubblers(&arg0.bubbler_keys) + total_cosmetics(&arg0.cosmetic_keys) > arg0.pending_count, 5);
    ...
    fun is_authorized_bot<T0, T1>(arg0: &CratePool<T0, T1>, arg1: address) : bool {
        if (arg1 == arg0.bot) {
            return true
        };
        let v0 = &arg0.id;
        let v1 = AuthorizedBotsKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<AuthorizedBotsKey>(v0, v1)) {
            return false
        };
        let v2 = AuthorizedBotsKey{dummy_field: false};
        0x2::table::contains<address, bool>(0x2::dynamic_field::borrow<AuthorizedBotsKey, 0x2::table::Table<address, bool>>(v0, v2), arg1)
    }
    ...
    public entry fun reveal_ticket<T0, T1, T2: store + key, T3: store + key>(arg0: &mut CratePool<T0, T1>, arg1: u64, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!v8 && v3 > 0) {
            assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.sui_treasury) >= v3, 5);
        ...
        0x2::event::emit<CrateOpened>(v21);
    }

    public entry fun reveal_ticket_v2<T0, T1, T2: store + key, T3: store + key>(arg0: &mut CratePool<T0, T1>, arg1: u64, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(is_authorized_bot<T0, T1>(arg0, 0x2::tx_context::sender(arg3)), 8);
        assert!(0x2::table::contains<u64, PendingTicket>(&arg0.pending_tickets, arg1), 6);
        arg0.pending_count = arg0.pending_count - 1;
        let PendingTicket {
            owner           : v0,
