module 0xc901264d0fe1815bc5279b36942744792e29115339215fe4337f556e60aabad3::catchemAll {
    ...
    public entry fun play_game(arg0: &mut CatchemAll, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (safe_selection(999, &v2) % 2 == 0) {
            ...
            let v7 = v5 - v6;
            v4 = v7;
            0x2::coin::join<0x2::sui::SUI>(&mut arg1, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v7 - v0, arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, 0x2::tx_context::sender(arg3));
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.bank, v6, arg3), arg0.treasury);
        } else {
            if (arg0.fee > 0) {
        ...
        if (0x2::table::contains<address, 0x2::table::Table<u64, History>>(&arg0.history, 0x2::tx_context::sender(arg3))) {
            0x2::table::add<u64, History>(0x2::table::borrow_mut<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3)), 0x2::table::length<u64, History>(0x2::table::borrow<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3))) + 1, v8);
        } else {
            let v9 = 0x2::table::new<u64, History>(arg3);
            0x2::table::add<u64, History>(&mut v9, 1, v8);
            0x2::table::add<address, 0x2::table::Table<u64, History>>(&mut arg0.history, 0x2::tx_context::sender(arg3), v9);
        };
