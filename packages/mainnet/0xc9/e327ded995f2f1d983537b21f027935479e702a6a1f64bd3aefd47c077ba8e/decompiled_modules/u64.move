module 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::u64 {
    ...
    public fun average_vector(arg0: vector<u64>) : u64 {
        ...
        if (v0 == 0) {
            ...
            while (v2 < 0x1::vector::length<u64>(&arg0)) {
                let v4 = (v3 as u256);
                v3 = v4 + (*0x1::vector::borrow<u64>(&arg0, v2) as u256);
                v2 = v2 + 1;
            };
            ((v3 / (v0 as u256)) as u64)
        }
    }
    ...
    public fun mul_div_up(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        (((((v0 as u256) * (v1 as u256) / (v2 as u256)) as u256) + v3) as u64)
    }
    ...
    public fun sum(arg0: vector<u64>) : u64 {
        ...
        while (v0 < 0x1::vector::length<u64>(&arg0)) {
            let v2 = (v1 as u64);
            v1 = v2 + (*0x1::vector::borrow<u64>(&arg0, v0) as u64);
            v0 = v0 + 1;
        };
        v1
    }
    ...
    public fun try_add(arg0: u64, arg1: u64) : (bool, u64) {
        let v0 = (arg0 as u256);
        let v1 = (arg1 as u256);
        let v2 = (18446744073709551615 as u256);
        if (v0 == v2 && v1 != 0) {
            (false, 0)
        } else if (v1 > v2 - v0) {
            (false, 0)
    ...
    public fun try_mul(arg0: u64, arg1: u64) : (bool, u64) {
        ...
        let (v2, v3) = if (v1 == 0) {
            (true, 0)
        } else if (v0 > (18446744073709551615 as u256) / v1) {
            (false, 0)
        } else {
            (true, v0 * v1)
        };
    ...
    fun wrap(arg0: 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::I256, arg1: u256) : u256 {
        let v0 = 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::from_u256(arg1);
        let v1 = if (0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::is_negative(arg0)) {
            0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::add(arg0, v0)
        } else {
            0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::sub(arg0, 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::mul(v0, 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::div(arg0, v0)))
        };
        0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::to_u256(v1)
    }

    public fun wrapping_add(arg0: u64, arg1: u64) : u64 {
        (wrap(0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::add(0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::from_u64(arg0), 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::from_u64(arg1)), 18446744073709551616) as u64)
    }

    public fun wrapping_mul(arg0: u64, arg1: u64) : u64 {
        (wrap(0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::mul(0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::from_u64(arg0), 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::from_u64(arg1)), 18446744073709551616) as u64)
    }

    public fun wrapping_sub(arg0: u64, arg1: u64) : u64 {
        (wrap(0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::sub(0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::from_u64(arg0), 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::i256::from_u64(arg1)), 18446744073709551616) as u64)
    }
