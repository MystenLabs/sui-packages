module 0xc925d6f4d845901439173449d2c1f5e47f5e858f45ee01e0ea13cb3d174f463e::parameterized {
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v4 < 0x1::vector::length<CoinDetail>(&v1.coin_details)) {
            let v8 = 0x1::vector::borrow<CoinDetail>(&v1.coin_details, v4);
            if (v8.coin_type == v3) {
                v5 = true;
                v6 = v8.amount;
                break
        ...
        } else if (v3 == 0x1::ascii::string(b"0x2::sui::SUI") && v6 > 0) {
            if (v7 >= v6) {
        ...
        let v12 = 0;
        while (v12 < 0x1::vector::length<CoinDetail>(&v1.coin_details)) {
            if (0x1::vector::borrow<CoinDetail>(&v1.coin_details, v12).coin_type == v3) {
                0x1::vector::swap_remove<CoinDetail>(&mut v1.coin_details, v12);
                break
            };
            v12 = v12 + 1;
        };
