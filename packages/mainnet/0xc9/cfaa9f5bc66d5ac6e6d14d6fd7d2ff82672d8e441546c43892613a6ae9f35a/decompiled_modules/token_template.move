module 0xc9cfaa9f5bc66d5ac6e6d14d6fd7d2ff82672d8e441546c43892613a6ae9f35a::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"CT2763467", b"ConcurrentToken2 763467", b"Second concurrent deployment", 0x1::option::none<0x2::url::Url>(), arg1);
