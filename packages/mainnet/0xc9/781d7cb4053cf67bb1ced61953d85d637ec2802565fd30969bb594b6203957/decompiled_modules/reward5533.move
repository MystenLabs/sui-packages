module 0xc9781d7cb4053cf67bb1ced61953d85d637ec2802565fd30969bb594b6203957::reward5533 {
    struct REWARD5533 has drop {
        dummy_field: bool,
    }

    struct TICKET_5533 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5533(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5533>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5533>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5533, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5533>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5533>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5533>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5533>>(v5, 0x2::tx_context::sender(arg1));
    }
