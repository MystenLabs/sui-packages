module 0xc9156cb6b53dd497aa18f097e7d00c83f1ada7619fc62f4ee9dcfe9d3ade4082::cnsnft3712 {
    struct CNSNFT3712 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3712, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3712>(arg0, arg1);
