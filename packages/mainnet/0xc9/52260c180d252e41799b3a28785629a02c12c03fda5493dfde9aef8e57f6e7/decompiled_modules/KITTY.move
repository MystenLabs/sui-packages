module 0xc952260c180d252e41799b3a28785629a02c12c03fda5493dfde9aef8e57f6e7::KITTY {
    ...
    fun init(arg0: KITTY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<KITTY>(arg0, 9, b"HARRIS", b"Kamala Harris", b"Kamala Harris fund", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
