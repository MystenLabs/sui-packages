module 0xc94f9e8c8f5cfc0a9b95065847a2952295478b74731f0e355dde939dc9d1ecdb::reward1253 {
    struct REWARD1253 has drop {
        dummy_field: bool,
    }

    struct TICKET_1253 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1253(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1253>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1253>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1253, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1253>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1253>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1253>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1253>>(v5, 0x2::tx_context::sender(arg1));
    }
