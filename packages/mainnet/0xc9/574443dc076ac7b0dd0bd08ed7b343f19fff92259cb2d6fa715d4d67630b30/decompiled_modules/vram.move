module 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::vram {
    ...
    public fun accept_connector_v4<T0, T1>(arg0: &mut MemeConfig, arg1: 0x2::transfer::Receiving<0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::connector_v4::ConnectorV4<T0>>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        enforce_config_version(arg0);
        let v0 = 0x2::transfer::public_receive<0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::connector_v4::ConnectorV4<T0>>(&mut arg0.id, arg1);
        0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::connector_v4::get_temp_id<T0>(&v0);
        let v1 = 0x2::tx_context::sender(arg5);
        assert!(0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::connector_v4::get_creator<T0>(&v0) == v1, 11);
    ...
    fun buy_returns_internal<T0, T1>(arg0: &mut BondingCurve<T0, T1>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: address, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>) {
        ...
        if (0x2::coin::value<T1>(&arg2) < v4 + v6) {
            let v8 = 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::math::get_fee_amount(0x2::coin::value<T1>(&arg2), arg1.swap_fee_bps);
            v7 = v8;
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg2, v7, arg7), arg1.treasury);
        ...
        if (get_price_per_token_scaled<T0, T1>(arg0) * arg1.price / 1000 / 1000 >= arg1.bonding_curve_limit) {
            arg0.status = 2;
            0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::events::emit_complete<T0>(get_id<T0, T1>(arg0));
        };
    ...
    fun create_bonding_curve_v4<T0, T1>(arg0: &0x2::coin::CoinMetadata<T0>, arg1: 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::connector_v4::ConnectorV4<T0>, arg2: &MemeConfig, arg3: &mut 0x2::tx_context::TxContext) : BondingCurve<T0, T1> {
        enforce_config_version(arg2);
        let (v0, v1, v2, v3, v4, v5) = 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::connector_v4::deconstruct<T0>(arg1);
        ...
        0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::events::emit_curve_create<T0>(get_id<T0, T1>(&v6), v5, 0x2::coin::get_name<T0>(arg0), 0x2::coin::get_symbol<T0>(arg0), 0x2::coin::get_description<T0>(arg0), 0x2::coin::get_icon_url<T0>(arg0), v2, v3, v4);
        v6
    }
    ...
    public fun place_dev_order<T0>(arg0: &mut MemeConfig, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::math::get_amount_in(arg3, arg0.virtual_sui_amount, 1000000000000000);
        assert!(0x2::coin::value<T0>(&arg2) >= arg0.listing_fee + v0 + 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::math::get_fee_amount(v0, arg0.swap_fee_bps), 5);
    ...
    public fun sell_returns<T0, T1>(arg0: &mut BondingCurve<T0, T1>, arg1: &MemeConfig, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::math::get_amount_out(v0, 0x2::balance::value<T0>(&arg0.token_balance), arg0.virtual_sui_amount + 0x2::balance::value<T1>(&arg0.sui_balance));
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v2, 0x415857b748ca0787d5e26f6ae07c03b94941c1f49a4c879c4499305cbbe3c8f6::math::get_fee_amount(v1, arg1.swap_fee_bps), arg4), arg1.treasury);
