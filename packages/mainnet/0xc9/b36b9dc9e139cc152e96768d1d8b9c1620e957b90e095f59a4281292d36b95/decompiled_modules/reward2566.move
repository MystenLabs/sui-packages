module 0xc9b36b9dc9e139cc152e96768d1d8b9c1620e957b90e095f59a4281292d36b95::reward2566 {
    struct REWARD2566 has drop {
        dummy_field: bool,
    }

    struct TICKET_2566 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2566(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2566>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2566>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2566, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2566>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2566>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2566>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2566>>(v5, 0x2::tx_context::sender(arg1));
    }
