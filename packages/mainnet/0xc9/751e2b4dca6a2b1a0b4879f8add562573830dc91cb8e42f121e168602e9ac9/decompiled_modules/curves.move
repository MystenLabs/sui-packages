module 0xc9751e2b4dca6a2b1a0b4879f8add562573830dc91cb8e42f121e168602e9ac9::curves {
    struct Volatile {
        dummy_field: bool,
    }
    ...
    public fun assert_curve<T0>() {
        assert!(is_curve<T0>(), 0xc9751e2b4dca6a2b1a0b4879f8add562573830dc91cb8e42f121e168602e9ac9::errors::invalid_curve());
    }
