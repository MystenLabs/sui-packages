module 0xc9751e2b4dca6a2b1a0b4879f8add562573830dc91cb8e42f121e168602e9ac9::stable_fees {
    ...
    public fun update_admin_fee_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        assert!(200000000000000000 >= v0, 0xc9751e2b4dca6a2b1a0b4879f8add562573830dc91cb8e42f121e168602e9ac9::errors::invalid_fee());
    ...
    public fun update_fee_in_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        let v0 = 0x1::option::extract<u256>(&mut arg1);
        assert!(20000000000000000 >= v0, 0xc9751e2b4dca6a2b1a0b4879f8add562573830dc91cb8e42f121e168602e9ac9::errors::invalid_fee());
