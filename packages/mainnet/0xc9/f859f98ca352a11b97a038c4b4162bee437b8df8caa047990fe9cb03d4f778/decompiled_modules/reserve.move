module 0xc9f859f98ca352a11b97a038c4b4162bee437b8df8caa047990fe9cb03d4f778::reserve {
    ...
    fun borrow_flash_loan_internal<T0>(arg0: &mut Reserve, arg1: u64, arg2: u64, arg3: u64) : (0x2::balance::Balance<T0>, FlashLoan<T0>) {
        ...
        let v2 = FlashLoan<T0>{
            loan_amount : arg1,
            fee         : v1 - 0xad013d5fde39e15eabda32b3dbdafd67dac32b798ce63237c27a8f73339b9b6f::u64::mul_div(v1, arg2, arg3),
        };
        (0x779b5c547976899f5474f3a5bc0db36ddf4697ad7e5a901db0415c2281d28162::balance_bag::split<T0>(&mut arg0.underlying_balances, arg1), v2)
    }

    public(friend) fun borrow_flash_loan_with_ticket<T0>(arg0: &mut Reserve, arg1: 0xc9f859f98ca352a11b97a038c4b4162bee437b8df8caa047990fe9cb03d4f778::ticket_accesses::TicketForFlashLoanFeeDiscount, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoan<T0>) {
        let (v0, v1) = 0xc9f859f98ca352a11b97a038c4b4162bee437b8df8caa047990fe9cb03d4f778::ticket_accesses::get_flash_loan_fee_discount(&arg1);
    ...
    public(friend) fun handle_borrow<T0>(arg0: &mut Reserve, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v1.cash >= v1.revenue, 0xc9f859f98ca352a11b97a038c4b4162bee437b8df8caa047990fe9cb03d4f778::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun mint_market_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<MarketCoin<T0>> {
        ...
        assert!(v3 > 0, 0xc9f859f98ca352a11b97a038c4b4162bee437b8df8caa047990fe9cb03d4f778::error::mint_market_coin_too_small_error());
        v2.cash = v2.cash + v0;
    ...
    public(friend) fun redeem_underlying_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<MarketCoin<T0>>) : 0x2::balance::Balance<T0> {
        ...
        assert!(v2.cash >= v2.revenue, 0xc9f859f98ca352a11b97a038c4b4162bee437b8df8caa047990fe9cb03d4f778::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun repay_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoan<T0>) {
        ...
        assert!(v2 >= v0 + v1, 0xc9f859f98ca352a11b97a038c4b4162bee437b8df8caa047990fe9cb03d4f778::error::flash_loan_repay_not_enough_error());
        let v3 = v2 - v0;
