module 0xc9e5444808359c96bc5ee38ec6b0bc4b13496af71944485e110e9f002d727822::cnsnft9425 {
    struct CNSNFT9425 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9425, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8009"));
        let v4 = 0x2::package::claim<CNSNFT9425>(arg0, arg1);
