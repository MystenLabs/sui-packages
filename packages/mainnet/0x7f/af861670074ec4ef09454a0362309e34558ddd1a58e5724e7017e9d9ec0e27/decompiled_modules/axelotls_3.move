module 0x7faf861670074ec4ef09454a0362309e34558ddd1a58e5724e7017e9d9ec0e27::axelotls_3 {
    struct AXELOTLS_3 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: AXELOTLS_3, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<AXELOTLS_3>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Axelotls 3"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Axelotls 3 "));
