module 0x7f1eafc98ca5940955699da351cd383cee364827d6204be8ea7784569d37b5aa::pre_deposit_vault {
    ...
    public fun extend_lock<T0>(arg0: &mut VaultPosition<T0>, arg1: u64, arg2: &EmergencyState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 >= 3600000, 7);
        assert!(arg1 <= 31536000000, 7);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 <= 18446744073709551615 - arg1, 9);
        let v1 = v0 + arg1;
        assert!(v1 > arg0.unlock_time_ms, 5);
        arg0.unlock_time_ms = v1;
        assert!(v1 >= arg0.deposit_time_ms, 9);
        arg0.lock_duration_ms = arg1;
        let v2 = LockExtensionEvent{
        ...
        0x2::event::emit<LockExtensionEvent>(v2);
    }
    ...
    fun init(arg0: PRE_DEPOSIT_VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::package::Publisher>(0x2::package::claim<PRE_DEPOSIT_VAULT>(arg0, arg1), 0x2::tx_context::sender(arg1));
        let v0 = AdminCap{id: 0x2::object::new(arg1)};
        let v1 = EmergencyState{
        ...
        0x2::transfer::share_object<VaultConfig>(v2);
        0x2::transfer::share_object<EmergencyState>(v1);
    }
    ...
    public fun setup_token<T0>(arg0: &AdminCap, arg1: &0x2::package::Publisher, arg2: &mut VaultConfig, arg3: 0x1::string::String, arg4: u8, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x1::type_name::get<T0>();
        let (v1, _) = 0x1::vector::index_of<0x1::type_name::TypeName>(&arg2.supported_tokens, &v0);
        assert!(!v1, 13);
        0x1::vector::push_back<0x1::type_name::TypeName>(&mut arg2.supported_tokens, v0);
        0x1::vector::push_back<0x1::string::String>(&mut arg2.token_symbols, arg3);
        0x1::vector::push_back<u8>(&mut arg2.token_decimals, arg4);
        let v3 = Treasury<T0>{
        ...
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"token_symbol"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"amount"));
        0x1::vector::push_back<0x1::string::String>(v5, 0x1::string::utf8(b"unlock_time"));
        let v6 = 0x1::vector::empty<0x1::string::String>();
        let v7 = &mut v6;
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"{token_symbol} Vault Position #{id}"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"A locked {token_symbol} position in the multi-token vault"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b""));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b""));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"{token_symbol}"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"{amount}"));
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"{unlock_time}"));
        let v8 = 0x2::display::new_with_fields<VaultPosition<T0>>(arg1, v4, v6, arg5);
        0x2::display::update_version<VaultPosition<T0>>(&mut v8);
        0x2::transfer::public_transfer<0x2::display::Display<VaultPosition<T0>>>(v8, 0x2::tx_context::sender(arg5));
        let v9 = TokenAddedEvent{
            token_type : v0,
            symbol     : arg3,
            decimals   : arg4,
        };
        0x2::event::emit<TokenAddedEvent>(v9);
        0x2::object::id<Treasury<T0>>(&v3)
    }
