module 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::nest {
    ...
    struct StakedDuck has store {
        duck: 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT,
        stake_time: u64,
    ...
    public fun get_duck_harvest_stats(arg0: &Nest) : (u8, u8, u8) {
        ...
        let v0 = 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::get_rarity_level(&0x1::option::borrow<StakedDuck>(&arg0.staked_duck).duck);
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::NestMintCap, arg3: &mut 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::get_rarity_level(&v2.duck);
        let v6 = 0x2::object::id<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(&v2.duck);
        ...
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SHTTOKEN>>(0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::mint_for_nest(arg2, arg3, v11, arg6), v0);
        };
    ...
    public entry fun stake_duck(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &NestRegistry, arg5: &0x2::transfer_policy::TransferPolicy<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>, arg6: &mut HarvestStats, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg3.owner == v0, 6);
        assert!(0x1::option::is_none<StakedDuck>(&arg3.staked_duck), 1);
        0x2::kiosk::list<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(arg0, arg1, arg2, 0);
        let (v1, v2) = 0x2::kiosk::purchase<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(arg0, arg2, 0x2::coin::zero<0x2::sui::SUI>(arg8));
        let v3 = v2;
        let v4 = v1;
        0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::staking_rule::prove<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(arg5, &mut v3, 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::staking_rule::create_proof(0x2::object::id_address<NestRegistry>(arg4)));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(arg5, v3);
        ...
        let v10 = DuckStaked{
            ...
            duck_id    : 0x2::object::id<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(&v4),
            owner      : v0,
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::NestMintCap, arg3: &mut 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &0x2::transfer_policy::TransferPolicy<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (v3 > 0) {
            ...
            if (v11 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SHTTOKEN>>(0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::mint_for_nest(arg2, arg3, v11, arg9), v0);
            };
        ...
        let v20 = DuckUnstaked{
            nest_id    : v1,
            duck_id    : 0x2::object::id<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(&v19.duck),
            owner      : v0,
        ...
        0x2::kiosk::lock<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::duck_nft::DuckNFT>(arg5, arg6, arg7, v21);
    }
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SHTTOKEN>, arg2: &mut 0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::burn(arg2, 0x2::coin::split<0x7fb4c9e0dc0884526f8e81c8fd0e0355f960428b12ced32d0f8d2e00bc780708::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
