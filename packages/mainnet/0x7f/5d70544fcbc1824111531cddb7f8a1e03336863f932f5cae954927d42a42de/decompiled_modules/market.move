module 0x7fd8aba1652c58b6397c799fd375e748e5053145cb7e126d303e0a1545fd1fec::market {
    ...
    entry fun add_keeper<T0>(arg0: &0x7fd8aba1652c58b6397c799fd375e748e5053145cb7e126d303e0a1545fd1fec::admin::AdminCap, arg1: &mut Market<T0>, arg2: address) {
    ...
    entry fun clear_keepers<T0>(arg0: &0x7fd8aba1652c58b6397c799fd375e748e5053145cb7e126d303e0a1545fd1fec::admin::AdminCap, arg1: &mut Market<T0>) {
        let v0 = KeepersKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<KeepersKey>(&arg1.id, v0)) {
    ...
    entry fun remove_keeper<T0>(arg0: &0x7fd8aba1652c58b6397c799fd375e748e5053145cb7e126d303e0a1545fd1fec::admin::AdminCap, arg1: &mut Market<T0>, arg2: address) {
        let v0 = KeepersKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<KeepersKey>(&arg1.id, v0)) {
            let v1 = 0x2::dynamic_field::borrow_mut<KeepersKey, 0x2::vec_set::VecSet<address>>(&mut arg1.id, v0);
            if (0x2::vec_set::contains<address>(v1, &arg2)) {
