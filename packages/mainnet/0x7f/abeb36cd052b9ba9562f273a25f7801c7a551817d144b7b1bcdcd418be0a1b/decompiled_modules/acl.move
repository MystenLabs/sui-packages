module 0x7fabeb36cd052b9ba9562f273a25f7801c7a551817d144b7b1bcdcd418be0a1b::acl {
    struct Kxgvkbidjdgkzws has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Wtlqkbqxckxaqxl>,
    }

    struct Wtlqkbqxckxaqxl has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun ehsndahkqyeznda<T0>(arg0: &mut Kxgvkbidjdgkzws, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wtlqkbqxckxaqxl>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wtlqkbqxckxaqxl>(&mut arg0.pools, arg1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Kxgvkbidjdgkzws{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Wtlqkbqxckxaqxl>(arg0),
        };
        0x2::transfer::share_object<Kxgvkbidjdgkzws>(v0);
    }

    public entry fun kveoqvqfglxlwyk<T0: store + key>(arg0: &mut Kxgvkbidjdgkzws, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wtlqkbqxckxaqxl>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wtlqkbqxckxaqxl>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
    ...
    public entry fun lghbnoqmbdbixfu(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Kxgvkbidjdgkzws, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wtlqkbqxckxaqxl>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wtlqkbqxckxaqxl>(&mut arg2.pools, arg3);
        if (v0.initialized) {
            assert!(0x1::option::is_some<Pool>(&v0.details), 1);
    ...
    public entry fun pszlztwrpgyrcbr(arg0: &mut Kxgvkbidjdgkzws, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Wtlqkbqxckxaqxl{
        ...
        0x2::table::add<0x1::ascii::String, Wtlqkbqxckxaqxl>(&mut arg0.pools, arg1, v0);
    }

    public entry fun qgmvvffzsffflwy(arg0: &mut Kxgvkbidjdgkzws, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wtlqkbqxckxaqxl>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wtlqkbqxckxaqxl>(&mut arg0.pools, arg1);
    ...
    public entry fun wlrpugroujjzvwi(arg0: &mut Kxgvkbidjdgkzws, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<0x1::ascii::String, Wtlqkbqxckxaqxl>(&mut arg0.pools, arg1, v4);
    }

    public entry fun wtzmmzplhobaqpi(arg0: &mut Kxgvkbidjdgkzws, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Wtlqkbqxckxaqxl>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Wtlqkbqxckxaqxl>(&mut arg0.pools, arg1);
