module 0x7f3bfd9c54ff85c4c6c9ae1c3d9affe2586f9129a87dcf2af937fe0b777e487a::a {
    struct A has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: A, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<A>(arg0, 9, trim_right(b"b"), trim_right(b"A"), trim_right(b""), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreia5rvs6rqavph5ghbhynm3rjiqxcja75mcfantjy4zognl33jp4ge"))), arg1);
        let v2 = v0;
