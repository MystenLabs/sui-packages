module 0x7fcdf6623cd374d5fc1c851da1713575d274905d54eab697c89c1b3fbd40a094::cnsnft7314 {
    struct CNSNFT7314 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7314, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7314>(arg0, arg1);
