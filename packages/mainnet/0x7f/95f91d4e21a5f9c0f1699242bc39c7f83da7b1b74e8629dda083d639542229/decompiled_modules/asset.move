module 0x7f95f91d4e21a5f9c0f1699242bc39c7f83da7b1b74e8629dda083d639542229::asset {
    ...
    public(friend) fun new<T0>(arg0: 0x7f95f91d4e21a5f9c0f1699242bc39c7f83da7b1b74e8629dda083d639542229::interest::InterestModel, arg1: AssetConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
    ...
    fun assert_not_equal_and_set<T0: copy + drop + store>(arg0: &mut 0x2::object::UID, arg1: T0, arg2: bool) {
        ...
        assert!(*v0 != arg2, 0x7f95f91d4e21a5f9c0f1699242bc39c7f83da7b1b74e8629dda083d639542229::error::updating_with_same_value());
        *v0 = arg2;
    }
    ...
    public(friend) fun change_operation_status<T0>(arg0: &mut Asset<T0>, arg1: u8, arg2: bool) {
        ...
        if (*v0 == 0) {
            ...
            assert!(*v0 == 4, 0x7f95f91d4e21a5f9c0f1699242bc39c7f83da7b1b74e8629dda083d639542229::error::invalid_operation_status());
            let v9 = &mut arg0.id;
    ...
    public(friend) fun interest_model<T0>(arg0: &Asset<T0>) : &0x7f95f91d4e21a5f9c0f1699242bc39c7f83da7b1b74e8629dda083d639542229::interest::InterestModel {
        &arg0.interest_model
    }
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0x7f95f91d4e21a5f9c0f1699242bc39c7f83da7b1b74e8629dda083d639542229::interest::InterestModel) {
