module 0xdc66338d84e3d73e8c245fa7b7f551a8100c073161e35fc81990a011afed7280::claim {
    ...
    struct GrantBudget has key {
        id: 0x2::object::UID,
        pool: u64,
        issued: u64,
        epochs: 0x2::table::Table<u64, bool>,
    }
    ...
    struct GrantRootPublished has copy, drop {
        epoch: u64,
        root: vector<u8>,
        total: u64,
        grant_issued: u64,
    ...
    struct GrantPoolSet has copy, drop {
        amount: u64,
    }
    ...
    public fun close_grant_epoch(arg0: &0xdc66338d84e3d73e8c245fa7b7f551a8100c073161e35fc81990a011afed7280::llama::AdminCap, arg1: &mut ClaimRegistry, arg2: &mut GrantBudget, arg3: u64) : u64 {
        assert!(0x2::table::contains<u64, vector<u8>>(&arg1.roots, arg3), 1);
        assert!(0x2::table::contains<u64, bool>(&arg2.epochs, arg3), 10);
        assert!(!0x2::table::contains<u64, bool>(&arg1.closed, arg3), 7);
        let v0 = *0x2::table::borrow<u64, u64>(&arg1.reserved, arg3);
        let v1 = *0x2::table::borrow<u64, u64>(&arg1.distributed, arg3);
        let v2 = v0 - v1;
        0x2::table::add<u64, bool>(&mut arg1.closed, arg3, true);
        arg2.issued = arg2.issued - v2;
        let v3 = EpochClosed{
            epoch       : arg3,
            reserved    : v0,
            distributed : v1,
    ...
    public fun create_grant_budget(arg0: &0xdc66338d84e3d73e8c245fa7b7f551a8100c073161e35fc81990a011afed7280::llama::AdminCap, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 5);
        let v0 = GrantBudget{
            id     : 0x2::object::new(arg2),
            pool   : arg1,
            issued : 0,
            epochs : 0x2::table::new<u64, bool>(arg2),
        };
        0x2::transfer::share_object<GrantBudget>(v0);
        let v1 = GrantPoolSet{amount: arg1};
        0x2::event::emit<GrantPoolSet>(v1);
    }
    ...
    public fun grant_issued(arg0: &GrantBudget) : u64 {
        arg0.issued
    }

    public fun grant_pool(arg0: &GrantBudget) : u64 {
        arg0.pool
    }

    public fun grant_remaining(arg0: &GrantBudget) : u64 {
    ...
    public fun is_grant_epoch(arg0: &GrantBudget, arg1: u64) : bool {
        0x2::table::contains<u64, bool>(&arg0.epochs, arg1)
    }
    ...
    public fun publish_grant_root(arg0: &0xdc66338d84e3d73e8c245fa7b7f551a8100c073161e35fc81990a011afed7280::llama::AdminCap, arg1: &mut ClaimRegistry, arg2: &mut GrantBudget, arg3: u64, arg4: vector<u8>, arg5: u64) {
        assert!(0x1::vector::length<u8>(&arg4) == 32, 6);
        assert!(!0x2::table::contains<u64, vector<u8>>(&arg1.roots, arg3), 0);
        assert!(arg5 > 0, 5);
        assert!(arg2.issued + arg5 <= arg2.pool, 9);
        arg2.issued = arg2.issued + arg5;
        0x2::table::add<u64, bool>(&mut arg2.epochs, arg3, true);
        0x2::table::add<u64, vector<u8>>(&mut arg1.roots, arg3, arg4);
        0x2::table::add<u64, u64>(&mut arg1.distributed, arg3, 0);
        0x2::table::add<u64, u64>(&mut arg1.reserved, arg3, arg5);
        let v0 = GrantRootPublished{
            epoch           : arg3,
            root            : arg4,
            total           : arg5,
            grant_issued    : arg2.issued,
            grant_remaining : arg2.pool - arg2.issued,
        };
        0x2::event::emit<GrantRootPublished>(v0);
    }
