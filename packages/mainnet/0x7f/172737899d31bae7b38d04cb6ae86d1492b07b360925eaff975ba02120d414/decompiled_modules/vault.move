module 0x8404e665609111801ec4231c748faf586da4e740d809c0c43ba80a5bd61f6d0a::vault {
    ...
    fun redeem_dual_token_internal<T0, T1, T2, T3>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<vector<0x1::ascii::String>>, arg4: vector<u64>, arg5: vector<vector<u64>>, arg6: vector<u64>, arg7: u64, arg8: vector<vector<u8>>, arg9: vector<vector<u8>>, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x2::coin::Coin<T3>) {
        ...
        while (v15 < v10) {
            ...
            let (v19, v20) = 0x1::vector::index_of<u64>(&arg4, &v18.withdraw_time);
            assert!(v19, 29);
        ...
        let v29 = if (arg1.pending_redemptions >= (v13 as u128)) {
            arg1.pending_redemptions - (v13 as u128)
        } else {
            0
        };
        arg1.pending_redemptions = v29;
        assert!(v11 > 0, 25);
        assert!(v12 > 0, 26);
        ...
        let v34 = get_dynamic_field_or_default<T0, T1, u128>(arg1, b"total_withdraw", 0) + (v14 as u128);
        set_dynamic_field<T0, T1, u128>(arg1, b"total_withdraw", v34);
