module 0x7fa0bfb6b0862031467a79bd4b5320b5c122a9e441b3eb409e99f7eed3eb946d::cnsnft3966 {
    struct CNSNFT3966 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3966, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3966>(arg0, arg1);
