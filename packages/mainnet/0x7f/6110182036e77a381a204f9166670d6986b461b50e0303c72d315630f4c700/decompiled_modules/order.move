module 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::order {
    ...
    entry fun create_pool<T0, T1>(arg0: &0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::ExchangePool<T0, T1>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        create_pool_internal<T0, T1>(arg0, arg1, v0, arg2, arg3);
    }

    fun create_pool_internal<T0, T1>(arg0: &0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::ExchangePool<T0, T1>, arg1: address, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 != @0x0, 14);
        let v0 = 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::get_pool_id<T0, T1>(arg0);
    ...
    public fun get_payment_range<T0, T1>(arg0: &0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::ExchangePool<T0, T1>) : (u64, u64) {
        let v0 = 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::get_usdc_unit<T0, T1>(arg0);
        (100 * v0, 10000 * v0)
    }
    ...
    fun subscribe_with_period<T0, T1>(arg0: &mut OrderPool<T0, T1>, arg1: &mut 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::ExchangePool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: address, arg6: u64, arg7: u64, arg8: u8, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 1);
        assert!(arg0.exchange_pool_id == 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::get_pool_id<T0, T1>(arg1), 2);
        assert!(arg8 >= 9 && arg8 <= 99, 4);
        let v0 = 0x2::coin::value<T1>(&arg2);
        let v1 = 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::get_usdc_unit<T0, T1>(arg1);
        assert!(v0 >= 100 * v1 && v0 <= 10000 * v1, 3);
        let (v2, v3) = 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange::buy_for_order<T0, T1>(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg9, arg10);
