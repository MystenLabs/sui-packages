module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    fun delivery_<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut AdditionalConfigRegistry, arg2: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg3: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg4: &mut PortfolioVault<T0, T1, T2>, arg5: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::DepositVault<ManagerCap, T0>, arg6: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::BidVault<ManagerCap, T1>, arg7: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        update_portfolio_step(arg1, arg4.info.index, 0);
    ...
    fun evolution_<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut AdditionalConfigRegistry, arg2: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg3: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareRegistry, arg4: &mut PortfolioVault<T0, T1, T2>, arg5: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::DepositVault<ManagerCap, T0>, arg6: &mut 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::BidVault<ManagerCap, T1>, arg7: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::has_next<ManagerCap, T0>(arg5)) {
            ...
            update_portfolio_step(arg1, arg4.info.index, 4);
        };
        update_portfolio_step(arg1, arg4.info.index, 11);
    }
    ...
    public(friend) entry fun settle_adjust_deactivating_user_share_ratio_v2<T0>(arg0: &ManagerCap, arg1: &mut Registry, arg2: &mut AdditionalConfigRegistry, arg3: u64, arg4: u64) {
        ...
        if (0x1::option::is_none<0x1::option::Option<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareKey>>(&v3)) {
            let v4 = AdditionalConfigKey{
                index : arg3,
                tag   : b"deactivating_share_supply",
            };
            update_additional_config<u64>(arg2, v4, 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::deactivating_share_supply<ManagerCap, T0>(v1));
            let v5 = AdditionalConfigKey{
                index : arg3,
                tag   : b"deactivating_balance_value",
            };
            update_additional_config<u64>(arg2, v5, 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::deactivating_balance<ManagerCap, T0>(v1));
        };
        let v6 = AdditionalConfigKey{
            index : arg3,
            tag   : b"deactivating_share_supply",
        ...
        let v9 = get_additional_config<u64>(arg2, v8);
        let (v10, v11, v12) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::settle_adjust_deactivating_user_share_ratio_v2<ManagerCap, T0>(arg0, &mut arg1.deposit_vault_registry.user_share_registry, v1, *0x1::option::borrow<u64>(&v7), *0x1::option::borrow<u64>(&v9), 0x1::option::get_with_default<0x1::option::Option<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareKey>>(&v3, 0x1::option::none<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareKey>()), arg4);
        let v13 = v10;
        if (!0x1::option::is_some<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::UserShareKey>(&v13)) {
    ...
    public(friend) entry fun settle_performance_fee_balance<T0, T1, T2>(arg0: &ManagerCap, arg1: &mut Registry, arg2: &mut AdditionalConfigRegistry, arg3: u64, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = &mut arg1.bid_vault_registry.id;
        let v5 = get_mut_bid_vault<T1>(v4, arg3);
        let (v6, v7) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::get_twap_price(arg4, arg5);
        assert!(0x2::clock::timestamp_ms(arg5) >= v1.config.expiration_ts_ms, 1);
        if (0x1::option::is_none<DeliveryInfo>(&v1.info.delivery_info) || 0x1::option::borrow<DeliveryInfo>(&v1.info.delivery_info).round != v1.info.round) {
            assert!(0x1::option::is_none<0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::dutch::Auction<ManagerCap, T1>>(&v1.auction), 14);
            abort 12
        };
        let v8 = 0x1::option::borrow<DeliveryInfo>(&v1.info.delivery_info).size;
        let v9 = calculate_portfolio_payoff_by_price(v1.config.option_type, v6, v7, v1.config.d_token_decimal, v1.config.active_vault_config.payoff_configs, 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(2), v8, v1.config.o_token_decimal);
        let v10 = 0x1::option::borrow<DeliveryInfo>(&v1.info.delivery_info).premium;
        let v11 = if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T0, T1>()) {
            v10
        } else if (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T0, T2>()) {
            (((v10 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(v7) as u128) / (v6 as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(v1.config.d_token_decimal) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(v1.config.b_token_decimal) as u128)) as u64)
        } else {
            (((v10 as u128) * (v6 as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(v7) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(v1.config.d_token_decimal) as u128) / (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(v1.config.b_token_decimal) as u128)) as u64)
        };
        let v12 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::from(v11);
        let v13 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::add(&v9, &v12);
        let v14 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::active_balance<ManagerCap, T0>(v3) + 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::deactivating_balance<ManagerCap, T0>(v3);
        let v15 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::from(v14);
        let v16 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::add(&v15, &v13);
        let v17 = if (v14 != 0) {
            (((0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(8) as u128) * (0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::as_u64(&v16) as u128) / (v14 as u128)) as u64)
        } else {
            0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::multiplier(8)
        };
        let v18 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::match_types<T0, T1>();
        let v19 = if (v18) {
            10
        } else {
            v6
        ...
        let (v21, v22, v23, v24) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::settle_performance_fee_balance<ManagerCap, T0, T1, T2>(arg0, v3, v5, v1.config.d_token_decimal, v1.config.b_token_decimal, v17, 8, v19, v20, arg6);
        let v25 = AdditionalConfigKey{
            index : arg3,
            tag   : b"settled_share_price_without_premium",
        };
        update_additional_config<u64>(arg2, v25, v22);
        let v26 = AdditionalConfigKey{
            index : arg3,
            tag   : b"active_balance_value",
        };
        update_additional_config<u64>(arg2, v26, v23);
        let v27 = AdditionalConfigKey{
            index : arg3,
            tag   : b"deactivating_balance_value",
        };
        update_additional_config<u64>(arg2, v27, v24);
        let v28 = AdditionalConfigKey{
            index : arg3,
            tag   : b"active_share_supply",
        };
        update_additional_config<u64>(arg2, v28, 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::vault::active_share_supply<ManagerCap, T0>(v3));
        update_portfolio_step(arg2, arg3, 1);
        v1.config.activation_ts_ms = v1.config.expiration_ts_ms;
        if (v1.config.period == 0) {
            v1.config.expiration_ts_ms = v1.config.expiration_ts_ms + 86400000;
        } else if (v1.config.period == 1) {
            v1.config.expiration_ts_ms = v1.config.expiration_ts_ms + 604800000;
        } else if (v1.config.period == 2) {
            let (_, v30, _) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::get_date_from_ts(v1.config.expiration_ts_ms / 1000 + 2419200);
            let (_, v33, _) = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::utils::get_date_from_ts(v1.config.expiration_ts_ms / 1000 + 3024000);
            if (v30 != v33) {
                v1.config.expiration_ts_ms = v1.config.expiration_ts_ms + 2419200000;
            } else {
                v1.config.expiration_ts_ms = v1.config.expiration_ts_ms + 3024000000;
            };
        };
        let v35 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::abs(&v9);
        let v36 = 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::abs(&v13);
        let v37 = Settle<T0, T1, T2>{
            signer                        : 0x2::tx_context::sender(arg6),
            index                         : v1.info.index,
            round                         : v1.info.round,
            oracle_price                  : v6,
            delivery_size                 : v8,
            portfolio_payoff              : 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::as_u64(&v35),
            portfolio_payoff_is_neg       : 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::is_neg(&v9),
            original_premium              : v10,
            portfolio_final_payoff        : 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::as_u64(&v36),
            portfolio_final_payoff_is_neg : 0xd60bbb359c55e2c60c2360defa75a5e8446c36cc794ac55bb14cf339f5a62bf5::i64::is_neg(&v13),
            total_balance                 : v14,
            share_price                   : v17,
            performance_fee               : v21,
            activation_ts_ms              : v1.config.activation_ts_ms,
            expiration_ts_ms              : v1.config.expiration_ts_ms,
        };
        0x2::event::emit<Settle<T0, T1, T2>>(v37);
    }
    ...
    public(friend) entry fun upgrade_registry(arg0: &ManagerCap, arg1: &mut Registry) {
        assert!(16 > arg1.version, 1000);
        arg1.version = 16;
    }

    fun version_check(arg0: &Registry) {
        assert!(16 == arg0.version, 1000);
    }
