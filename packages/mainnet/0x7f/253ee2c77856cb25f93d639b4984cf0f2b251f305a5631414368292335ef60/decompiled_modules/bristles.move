module 0x7f253ee2c77856cb25f93d639b4984cf0f2b251f305a5631414368292335ef60::bristles {
    struct BRISTLES has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BRISTLES, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BRISTLES>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Bristles"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Bristles is a collection of 100 units on the blockchain, created with good vibes and love for SUI."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifcqanh7ouhvd6mtom6klejllp5eyzavd26uo767nf2ow6bluuvr4"));
