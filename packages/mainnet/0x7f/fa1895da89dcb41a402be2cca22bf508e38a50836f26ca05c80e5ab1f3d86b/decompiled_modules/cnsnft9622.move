module 0x7ffa1895da89dcb41a402be2cca22bf508e38a50836f26ca05c80e5ab1f3d86b::cnsnft9622 {
    struct CNSNFT9622 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9622, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9622>(arg0, arg1);
