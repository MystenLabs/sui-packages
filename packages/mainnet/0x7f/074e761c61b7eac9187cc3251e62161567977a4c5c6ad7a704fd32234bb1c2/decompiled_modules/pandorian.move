module 0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::pandorian {
    ...
    struct PandorianStoreMintedEvent has copy, drop {
    ...
    struct PandorianStore has drop, store {
        name: 0x1::string::String,
        description: 0x1::string::String,
        url: vector<u8>,
        attribute_keys: vector<0x1::ascii::String>,
    ...
    struct Pandorian has store, key {
        ...
        description: 0x1::string::String,
        url: 0x2::url::Url,
        attributes: 0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::attributes::Attributes,
    }
    ...
    fun init(arg0: PANDORIAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::collection::display(&v0, arg1);
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"{url}"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://test.xyz"));
        ...
        0x2::transfer::public_share_object<0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::collection::Collection>(0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &mut 0x2::tx_context::TxContext) : Pandorian {
        let v0 = Pandorian{
            ...
            attributes  : 0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::attributes::new_from_vec(arg3, arg4),
        };
    ...
    public(friend) fun mint_nft_by_stored_data(arg0: PandorianStore, arg1: &mut 0x2::tx_context::TxContext) : Pandorian {
        let PandorianStore {
            name             : v0,
            description      : v1,
            url              : v2,
        ...
        let v5 = Pandorian{
            ...
            attributes  : 0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::attributes::new_from_vec(v3, v4),
        };
    ...
    public(friend) fun new_pandorian_store(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &mut 0x2::tx_context::TxContext) : PandorianStore {
        0x7f074e761c61b7eac9187cc3251e62161567977a4c5c6ad7a704fd32234bb1c2::attributes::new_from_vec(arg3, arg4);
        let v0 = PandorianStore{
            name             : arg0,
            description      : arg1,
            url              : arg2,
            attribute_keys   : arg3,
        ...
        let v1 = PandorianStoreMintedEvent{
            name             : arg0,
            description      : arg1,
            url              : arg2,
            attribute_keys   : arg3,
        ...
        0x2::event::emit<PandorianStoreMintedEvent>(v1);
        v0
    }
