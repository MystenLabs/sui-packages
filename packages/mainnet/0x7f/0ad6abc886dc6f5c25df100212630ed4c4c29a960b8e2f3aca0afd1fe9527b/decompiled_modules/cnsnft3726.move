module 0x7f0ad6abc886dc6f5c25df100212630ed4c4c29a960b8e2f3aca0afd1fe9527b::cnsnft3726 {
    struct CNSNFT3726 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3726, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4852"));
        let v4 = 0x2::package::claim<CNSNFT3726>(arg0, arg1);
