module 0x971d70b4e40312c953adf5f773f326844a03708b0f0dfdb38cc006fc180a48dd::rotation_adapters {
    ...
    public fun split_bluefin_deep_sui_with_cetus_usdc_sui<T0, T1, T2>(arg0: &0x2::clock::Clock, arg1: &Registry, arg2: &BluefinDeepSuiToCetusUsdcSuiCap<T0, T1, T2>, arg3: &BluefinDeepRewardAdapter<T0, T1>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg6: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg7: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg8: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg9: u64, arg10: u64, arg11: u64, arg12: u32, arg13: u64, arg14: bool, arg15: u64, arg16: bool, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: &mut 0x2::tx_context::TxContext) {
        ...
        v8 = v20;
        v7 = v21;
        let v22 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::tick_spacing<T2, T1>(arg8);
        let (v23, v24) = centered_range(0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::current_tick_index<T2, T1>(arg8), v22, v22);
        let v25 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::open_position<T2, T1>(arg7, arg8, v23, v24, arg27);
        let v26 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T2, T1>(arg7, arg8, &mut v25, arg15, arg16, arg0);
        let (v27, v28) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_pay_amount<T2, T1>(&v26);
        assert!(0x2::balance::value<T2>(&v14) >= v27, 8);
        assert!(0x2::balance::value<T1>(&v13) >= v28, 9);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_add_liquidity<T2, T1>(arg7, arg8, 0x2::balance::split<T2>(&mut v14, v27), 0x2::balance::split<T1>(&mut v13, v28), v26);
        let v29 = 0x2::balance::value<T0>(&v8);
        let v30 = 0x2::balance::value<T2>(&v14);
        let v31 = 0x2::balance::value<T1>(&v7) + 0x2::balance::value<T1>(&v13);
        assert!(v18 >= arg20, 8);
        assert!(v19 >= arg21, 9);
        assert!(v27 >= arg22, 8);
        assert!(v28 >= arg23, 9);
        ...
        assert!(v30 <= arg25, 10);
        assert!(v31 <= arg26, 11);
        let v32 = BluefinCetusPortfolioOpened{
            reward_deep            : 0x2::balance::value<T0>(&v0),
            fee_deep               : 0x2::balance::value<T0>(&v6),
            fee_sui                : 0x2::balance::value<T1>(&v5),
            profit_sui             : v12,
            ...
            cetus_tick_lower       : v23,
            cetus_tick_upper       : v24,
            bluefin_deposited_deep : v18,
            bluefin_deposited_sui  : v19,
            cetus_deposited_usdc   : v27,
            cetus_deposited_sui    : v28,
            residual_deep          : v29,
            residual_usdc          : v30,
            residual_sui           : v31,
        };
        0x2::event::emit<BluefinCetusPortfolioOpened>(v32);
        ...
        0x2::transfer::public_transfer<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v25, 0x2::tx_context::sender(arg27));
        0x2::balance::join<T1>(&mut v7, v13);
        let v33 = 0x2::tx_context::sender(arg27);
        transfer_nonzero<T0>(v8, v33, arg27);
        let v34 = 0x2::tx_context::sender(arg27);
        transfer_nonzero<T2>(v14, v34, arg27);
        let v35 = 0x2::tx_context::sender(arg27);
        transfer_nonzero<T1>(v7, v35, arg27);
    }
