module 0x7f6aaf28dfdb743746557bdb358091978d43320936a14f0d14064d8488892668::fetcher {
    ...
    public entry fun fetch_deepbook_status_ask_side<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock) {
        ...
        let v7 = v6;
        loop {
            let v8 = 0xdee9::order_query::iter_asks<T0, T1>(arg0, arg3, arg4, 0x1::option::none<u64>(), 0x1::option::none<u64>(), true);
            let v9 = 0xdee9::order_query::orders(&v8);
            let v10 = 0x1::vector::length<0xdee9::clob_v2::Order>(v9);
            if (v10 == 0) {
                break
            };
            let v11 = 0;
            while (v11 < v10) {
                let v12 = 0xdee9::order_query::tick_level(0x1::vector::borrow<0xdee9::clob_v2::Order>(v9, v11));
                if (v11 == 0) {
                    if (0x1::vector::length<PriceRange>(&v0) == 0) {
                        v1 = calc_ask_check_point(v12, arg2);
                        let v13 = &mut v0;
                        add_price_range_to_vec(v13, v12, 0);
                        v7 = v12;
                        v11 = v11 + 1;
                        continue
                    };
                ...
                if (v12 <= v1) {
                    ...
                    0x1::vector::borrow_mut<PriceRange>(&mut v0, v2).price_high = v6;
                    let v14 = v2 + 1;
                    v2 = v14;
                    if (v14 >= arg1) {
                        if (v11 != v10 - 1) {
                            let v15 = 0x1::vector::borrow<0xdee9::clob_v2::Order>(v9, v11 + 1);
                            v5 = true;
                            v4 = 0x1::option::some<u64>(0xdee9::order_query::order_id(v15));
                            v3 = 0x1::option::some<u64>(0xdee9::order_query::tick_level(v15));
                            break
                        };
                        if (0xdee9::order_query::has_next_page(&v8)) {
                            v5 = true;
                            v4 = 0xdee9::order_query::next_order_id(&v8);
                            v3 = 0xdee9::order_query::next_tick_level(&v8);
                            break
                        };
                        break
                    };
                    let v16 = &mut v0;
                    add_price_range_to_vec(v16, v12, 0);
                    v1 = calc_ask_check_point(v12, arg2);
                };
                v11 = v11 + 1;
            };
            ...
            if (!0xdee9::order_query::has_next_page(&v8)) {
                0x1::vector::borrow_mut<PriceRange>(&mut v0, v2).price_high = v7;
                break
            };
            arg3 = 0xdee9::order_query::next_tick_level(&v8);
            arg4 = 0xdee9::order_query::next_order_id(&v8);
        };
        let v17 = FetchDeepbookStatusEvent{
            has_next_page   : v5,
            next_tick_level : v3,
            next_order_id   : v4,
            prices          : 0x1::vector::empty<PriceData>(),
            price_range     : v0,
        };
        0x2::event::emit<FetchDeepbookStatusEvent>(v17);
    }
