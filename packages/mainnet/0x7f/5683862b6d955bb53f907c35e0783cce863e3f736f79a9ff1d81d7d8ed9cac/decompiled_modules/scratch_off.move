module 0x7f5683862b6d955bb53f907c35e0783cce863e3f736f79a9ff1d81d7d8ed9cac::scratch_off {
    ...
    struct ScratchOff has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun buy_ticket<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: &mut ConvenienceStore<T0>, arg2: 0x2::coin::Coin<T0>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : (Ticket, 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::receipt::GameReceipt<T0, ScratchOff>) {
        ...
        0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::add_volume<T0, ScratchOff>(v1, arg0, v0, arg4);
        0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::put<T0, ScratchOff>(v1, arg0, arg2);
        let v2 = Ticket{
            id                   : 0x2::object::new(arg4),
            convenience_store_id : 0x2::object::uid_to_inner(&arg1.id),
            player               : arg3,
        };
        (v2, 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::new_game_receipt<T0, ScratchOff>(v1, arg0, v0))
    }
    ...
    public fun finish_evaluation<T0>(arg0: &mut 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::UniHouse, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: &mut ConvenienceStore<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::math::safe_selection(tickets_left<T0>(arg3), &v5);
        let v7 = 0;
        let v8 = 0;
        while (v7 < v6) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0xf0978635bb456d2cb2e594cd4a018c9aed486d6cb68c7890abe5ef56838034bf::unihouse::take<T0, ScratchOff>(v10, arg0, v9.prize_value, arg4), v2);
