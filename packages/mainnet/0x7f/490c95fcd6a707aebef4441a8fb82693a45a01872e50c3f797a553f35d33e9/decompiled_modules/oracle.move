module 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle {
    ...
    public fun close_oracle(arg0: Oracle, arg1: &UpdateCaps, arg2: &0x2::tx_context::TxContext) {
        version_check(&arg0);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x1::vector::contains<address>(&arg1.for, &v0), 13906835411294289926);
        let Oracle {
            id               : v1,
            base_token       : _,
            quote_token      : _,
    ...
    public fun get_price(arg0: &Oracle, arg1: &0x2::clock::Clock) : (u64, u64) {
        assert!(0x2::clock::timestamp_ms(arg1) - arg0.ts_ms < arg0.time_interval, 13906836502216376332);
        (arg0.price, arg0.decimal)
    }

    public fun get_price_with_interval_ms(arg0: &Oracle, arg1: &0x2::clock::Clock, arg2: u64) : (u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        assert!(v0 - arg0.ts_ms < arg0.time_interval && v0 - arg0.ts_ms <= arg2, 13906836583820754956);
        (arg0.price, arg0.decimal)
    }
    ...
    public fun get_twap_price(arg0: &Oracle, arg1: &0x2::clock::Clock) : (u64, u64) {
        assert!(0x2::clock::timestamp_ms(arg1) - arg0.ts_ms < arg0.time_interval, 13906836540871081996);
    ...
    fun update_(arg0: &mut Oracle, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 13906836373366702082);
        assert!(arg2 > 0, 13906836377661669378);
    ...
    entry fun update_pyth_oracle_usd(arg0: &mut Oracle, arg1: &ManagerCap, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject) {
        version_check(arg0);
        assert!(arg0.quote_token == 0x1::ascii::string(b"USD") || arg0.base_token == 0x1::ascii::string(b"USD"), 13906835806431543306);
        arg0.pyth = 0x1::option::some<0x2::object::ID>(0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2));
        let v0 = UpdatePythOracleEvent{
            oracle_id               : 0x2::object::id<Oracle>(arg0),
            base_price_info_object  : 0x1::option::some<0x2::object::ID>(0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2)),
    ...
    public fun update_with_pyth(arg0: &mut Oracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        version_check(arg0);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg0.pyth), 13906835896625856522);
        let v0 = 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2);
        assert!(0x1::option::borrow<0x2::object::ID>(&arg0.pyth) == &v0, 13906835900920430596);
        let v1 = 0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg3);
        assert!(0x2::dynamic_field::borrow<0x1::string::String, 0x2::object::ID>(&arg0.id, 0x1::string::utf8(b"quote_price_info_object")) == &v1, 13906835905215397892);
        ...
        assert!(v2 > 0, 13906835922395136002);
        assert!(v5 > 0, 13906835926690103298);
        ...
        assert!(v9 > 0, 13906835961049841666);
        assert!(v12 > 0, 13906835965344808962);
    ...
    public fun update_with_pyth_usd(arg0: &mut Oracle, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        version_check(arg0);
        assert!(arg0.quote_token == 0x1::ascii::string(b"USD") || arg0.base_token == 0x1::ascii::string(b"USD") && arg0.quote_token == 0x1::ascii::string(b"JPY"), 13906836051244679178);
        assert!(!0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"quote_price_info_object")), 13906836059834220548);
        assert!(arg0.pyth == 0x1::option::some<0x2::object::ID>(0x2::object::id<0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject>(arg2)), 13906836068424155140);
        let (v0, v1, _) = 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::pyth_parser::get_price(arg1, arg2, arg3);
        assert!(v0 > 0, 13906836081308925954);
        ...
        assert!(v4 > 0, 13906836107078729730);
    ...
    public fun update_with_signature(arg0: &mut Oracle, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg2, 13906836227338600462);
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg1, 0x2::dynamic_field::borrow<0x1::string::String, vector<u8>>(&arg0.id, 0x1::string::utf8(b"bls_public_key")), &arg2), 13906836248813568016);
        let v2 = 0x1::ascii::string(arg3);
        assert!(0x1::type_name::as_string(&arg0.base_token_type) == &v2, 13906836253108666386);
        assert!(0x1::u64::diff(0x2::clock::timestamp_ms(arg7), arg6) < arg0.time_interval, 13906836257403240460);
        assert!(arg0.ts_ms < arg6, 13906836261698732052);
    ...
    fun version_check(arg0: &Oracle) {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"VERSION")), 13906836330417422344);
        assert!(2 >= *0x2::dynamic_field::borrow<0x1::string::String, u64>(&arg0.id, 0x1::string::utf8(b"VERSION")), 13906836313237553160);
    }
