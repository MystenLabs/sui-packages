module 0x7f9cf5320e13bd6ea4dddaad84c52324d17456009244da677399349132e86e39::cnsnft7949 {
    struct CNSNFT7949 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7949, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1884"));
        let v4 = 0x2::package::claim<CNSNFT7949>(arg0, arg1);
