module 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity {
    struct MetaIdentity has key {
        ...
        bind_status: bool,
        items: 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::items::Items,
        wallet: address,
    }
    ...
    struct MetaInfoGlobal has key {
        ...
        beta_whitelist: 0x2::table::Table<address, u64>,
    ...
    public fun get_items_info(arg0: &MetaIdentity, arg1: &0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::items::ItemGlobal) : 0x1::string::String {
        0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::items::get_items_info(arg1, &arg0.items)
    }

    public fun add_whitelist_by_type(arg0: &mut MetaInfoGlobal, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(@0x800ad2d2649ce4ec148a2c90a67136780fd3c8c3a915831852903b40d1197a09 == 0x2::tx_context::sender(arg3), 4);
        assert!(arg2 >= 0 && arg2 <= 1, 17);
        let v0 = if (arg2 == 0) {
            &mut arg0.alpha_whitelist
        } else {
            &mut arg0.beta_whitelist
        };
    ...
    public entry fun deleteMeta(arg0: MetaIdentity) {
        ...
        0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::items::destroy_empty(v6);
    ...
    fun generateUid(arg0: &mut MetaInfoGlobal, arg1: address) : u64 {
        if (0x2::table::contains<address, u64>(&arg0.alpha_whitelist, arg1)) {
            ...
            v0
        } else if (0x2::table::contains<address, u64>(&arg0.beta_whitelist, arg1)) {
            let v2 = 10000 + arg0.meta_beta_count;
            let v0 = v2;
            if (v2 > 20000) {
                v0 = get_common_metaid(arg0);
            } else {
                arg0.meta_beta_count = arg0.meta_beta_count + 1;
            };
            v0
        } else {
    ...
    fun get_common_metaid(arg0: &mut MetaInfoGlobal) : u64 {
        ...
        20000 + arg0.meta_common_user_count
    }

    public fun get_items(arg0: &mut MetaIdentity) : &mut 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::items::Items {
        &mut arg0.items
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = MetaInfoGlobal{
            ...
            beta_whitelist         : 0x2::table::new<address, u64>(arg0),
            ...
            register_owner         : @0x800ad2d2649ce4ec148a2c90a67136780fd3c8c3a915831852903b40d1197a09,
    ...
    public entry fun mintInviteMeta(arg0: &mut MetaInfoGlobal, arg1: u64, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: address, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MetaIdentity{
            ...
            email       : arg4,
            bind_status : true,
            items       : 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::items::new(arg6),
    ...
    public entry fun mintMeta(arg0: &mut MetaInfoGlobal, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MetaIdentity{
            ...
            email       : arg3,
            bind_status : true,
            items       : 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::items::new(arg5),
