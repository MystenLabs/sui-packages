module 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::shui_ticket {
    ...
    fun init(arg0: SHUI_TICKET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"https://shui.one"));
        ...
        0x1::vector::push_back<0x1::string::String>(v7, 0x1::string::utf8(b"https://shui.one/game/#/"));
        ...
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"https://shui.one"));
        ...
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"https://shui.one/game/#/"));
        ...
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"https://shui.one"));
        ...
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"https://shui.one/game/#/"));
