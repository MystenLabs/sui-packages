module 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::market {
    ...
    public entry fun list_game_item(arg0: &mut MarketGlobal, arg1: &mut 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: 0x1::string::String, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::tree_of_life::extract_drop_items(arg1, arg2, arg4);
        let v0 = &mut arg0.game_sales;
        let v1 = 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::getMetaId(arg1);
    ...
    public entry fun list_nft_item<T0: store + key>(arg0: &mut MarketGlobal, arg1: &mut 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: 0x1::string::String, arg5: &0x2::clock::Clock, arg6: T0, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        let v0 = &mut arg0.game_sales;
        let v1 = 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::getMetaId(arg1);
        ...
        if (0x2::linked_table::contains<u64, vector<OnSale>>(v0, v1)) {
            let v2 = 0x2::linked_table::borrow_mut<u64, vector<OnSale>>(v0, v1);
            assert!(0x1::vector::length<OnSale>(v2) <= 10, 4);
            0x1::vector::push_back<OnSale>(v2, new_nft_sale<T0>(0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::getMetaId(arg1), arg2, arg3, arg4, arg5, 0x1::string::utf8(b"nft"), arg6, arg7));
        } else {
            let v3 = 0x1::vector::empty<OnSale>();
            0x1::vector::push_back<OnSale>(&mut v3, new_nft_sale<T0>(0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::getMetaId(arg1), arg2, arg3, arg4, arg5, 0x1::string::utf8(b"nft"), arg6, arg7));
            0x2::linked_table::push_back<u64, vector<OnSale>>(v0, v1, v3);
        };
    }
    ...
    public entry fun purchase_game_item<T0>(arg0: &mut MarketGlobal, arg1: &mut 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::MetaIdentity, arg2: u64, arg3: 0x1::string::String, arg4: u64, arg5: vector<0x2::coin::Coin<T0>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        ...
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg3 && v3.num == arg4 && v3.price <= 0x2::coin::value<T0>(&v0)) {
                ...
                0x2::event::emit<TransactionRecord>(v15);
                if (v8 == 0x1::string::utf8(b"SUI")) {
                    ...
                    assert!(0x1::string::utf8(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<T0>()))) == 0x1::string::utf8(0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::get<0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::shui::SHUI>()))), 5);
                };
                ...
                0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::tree_of_life::fill_items(arg1, v5, v6);
                break
            };
            v2 = v2 + 1;
        };
    ...
    public entry fun purchase_nft_item<T0, T1: store + key>(arg0: &mut MarketGlobal, arg1: &mut 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::MetaIdentity, arg2: u64, arg3: 0x1::string::String, arg4: u64, arg5: vector<0x2::coin::Coin<T0>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        assert!(arg2 != 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::getMetaId(arg1), 6);
        let v0 = merge_coins<T0>(arg5, arg7);
        assert!(0x2::linked_table::contains<u64, vector<OnSale>>(&arg0.game_sales, arg2), 2);
        let v1 = 0x2::linked_table::borrow_mut<u64, vector<OnSale>>(&mut arg0.game_sales, arg2);
        let v2 = 0;
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg3 && v3.num == arg4 && v3.price <= 0x2::coin::value<T0>(&v0)) {
                ...
                if (0x2::bag::length(&v15) > 0) {
                    0x2::transfer::public_transfer<T1>(0x2::bag::remove<u64, T1>(&mut v15, 0), 0x2::tx_context::sender(arg7));
                };
    ...
    public entry fun unlist_game_item(arg0: &mut MarketGlobal, arg1: &mut 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        let v0 = 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::getMetaId(arg1);
        ...
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg2 && v3.num == arg3 && v3.price == arg4) {
                ...
                0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::tree_of_life::fill_items(arg1, arg2, arg3);
                break
            };
            v2 = v2 + 1;
        };
    ...
    public entry fun unlist_nft_item<T0: store + key>(arg0: &mut MarketGlobal, arg1: &mut 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::MetaIdentity, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 0, 8);
        let v0 = 0x7fb2e9c62b68bfe3568b9c5df5aecc2fe07f1830a34aee25f1a9dbc61d1b75d1::metaIdentity::getMetaId(arg1);
        assert!(0x2::linked_table::contains<u64, vector<OnSale>>(&arg0.game_sales, v0), 2);
        let v1 = 0x2::linked_table::borrow_mut<u64, vector<OnSale>>(&mut arg0.game_sales, v0);
        ...
        while (v2 < 0x1::vector::length<OnSale>(v1)) {
            ...
            if (v3.name == arg2 && v3.num == arg3 && v3.price == arg4) {
                ...
                if (0x2::bag::length(&v15) > 0) {
                    0x2::transfer::public_transfer<T0>(0x2::bag::remove<u64, T0>(&mut v15, 0), 0x2::tx_context::sender(arg6));
                };
                0x2::bag::destroy_empty(v15);
                0x2::object::delete(v4);
                if (0x1::vector::length<OnSale>(v1) == 0) {
