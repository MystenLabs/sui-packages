module 0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::kiosk_bidding_house_dynamic_royalty {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x2::clock::timestamp_ms(arg5);
        assert!(0x2::object::id<0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v30, v31), arg6), 0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::get_owner(arg1));
    ...
    public entry fun add_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg2: address, arg3: u16, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        assert!(0x2::object::id<0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::get_owner(arg1) == v0, 1);
    ...
    public fun buyout_nft_with_custom_royalty<T0: store + key, T1>(arg0: &mut Kiosk_Bidding_Store, arg1: &mut 0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<T1>, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut arg5, v40, arg8), 0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::get_owner(arg1));
    ...
    public entry fun create_and_share_kiosk_bidding_store(arg0: &0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Kiosk_Bidding_Store>(create_kiosk_bidding_store(arg0, arg1));
    }

    public fun create_kiosk_bidding_store(arg0: &0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : Kiosk_Bidding_Store {
        let v0 = 0x2::object::new(arg1);
        let v1 = Kiosk_Bidding_Store{
            id               : v0,
            auction_house    : 0x2::object::id<0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse>(arg0),
    ...
    public entry fun emergency_recover_nft<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: 0x1::string::String, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        let v1 = 0x2::clock::timestamp_ms(arg7);
        assert!(0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::get_owner(arg1) == v0, 1);
        assert!(0x2::object::id<0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
    ...
    public entry fun remove_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::object::id<0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::get_owner(arg1) == v0, 1);
        let v1 = get_collection_type<T0>();
    ...
    public entry fun update_collection_royalty<T0: store + key>(arg0: &mut Kiosk_Bidding_Store, arg1: &0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse, arg2: address, arg3: u16, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        assert!(0x2::object::id<0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::AuctionHouse>(arg1) == arg0.auction_house, 1);
        assert!(0x7fb5d28e8701952bb524db05b78a0f92085b6d94cec141bf4507b106e3f39cf1::auctionhouse::get_owner(arg1) == v0, 1);
