module 0x7fdb121f4eee6eab9e5565fb46c96a2f2f47c53a9c65a01c7a6658a5788e24eb::joji {
    ...
    fun init(arg0: JOJI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<JOJI>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<JOJI>>(v4);
    }
