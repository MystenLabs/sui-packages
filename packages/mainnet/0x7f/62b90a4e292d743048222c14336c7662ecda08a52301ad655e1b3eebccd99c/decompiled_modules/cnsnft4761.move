module 0x7f62b90a4e292d743048222c14336c7662ecda08a52301ad655e1b3eebccd99c::cnsnft4761 {
    struct CNSNFT4761 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4761, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4504"));
        let v4 = 0x2::package::claim<CNSNFT4761>(arg0, arg1);
