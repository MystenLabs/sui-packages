module 0x7f6330ae5213a19314ae5e645a71b222997156fd9a28196d147ed6c6e447bdb5::reward6098 {
    struct REWARD6098 has drop {
        dummy_field: bool,
    }

    struct TICKET_6098 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6098(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6098>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6098>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6098, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6098>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6098>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6098>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6098>>(v5, 0x2::tx_context::sender(arg1));
    }
