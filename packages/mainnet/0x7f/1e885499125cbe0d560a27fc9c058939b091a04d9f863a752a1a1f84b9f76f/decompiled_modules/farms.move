module 0x7f1e885499125cbe0d560a27fc9c058939b091a04d9f863a752a1a1f84b9f76f::farms {
    ...
    public fun add_reward<T0>(arg0: &AdminCap, arg1: 0x2::object::ID, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun harvest<T0>(arg0: &mut RewardInfo, arg1: &mut RewardBalance<T0>, arg2: &mut FarmPosition, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        if (arg2.liquidity == 0) {
            abort 0
        };
    ...
    public fun withdraw<T0>(arg0: &mut RewardInfo, arg1: &mut RewardBalance<T0>, arg2: FarmPosition, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        if (arg2.pool_id != arg0.pool_id) {
            abort 2
        };
        if (arg2.reward_info_id != 0x2::object::uid_to_inner(&arg0.id)) {
