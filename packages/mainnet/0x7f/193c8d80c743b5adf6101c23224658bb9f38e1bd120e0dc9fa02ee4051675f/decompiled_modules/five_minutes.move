module 0x7f193c8d80c743b5adf6101c23224658bb9f38e1bd120e0dc9fa02ee4051675f::five_minutes {
    ...
    entry fun start(arg0: &mut Round, arg1: u64, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::table::length<u64, RoundMetadata>(&arg0.rounds);
        if (v0 > 0) {
            assert!(0x2::table::borrow<u64, RoundMetadata>(&arg0.rounds, v0 - 1).status == 1, 0);
        };
