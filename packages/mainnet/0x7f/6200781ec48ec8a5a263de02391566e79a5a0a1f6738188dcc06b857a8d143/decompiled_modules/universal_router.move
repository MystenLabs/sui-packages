module 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::universal_router {
    ...
    public fun build<T0, T1>(arg0: &mut 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::trade_id_tracker::TradeIdTracker, arg1: &mut 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::partner_manager::PartnerRegistry, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: vector<u64>, arg7: 0x1::option::Option<address>, arg8: u8, arg9: u64, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) : Trade<T0, T1> {
        if (arg4 > 1000000) {
            abort 2
        };
        if (arg8 != 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::commission_type::percentage() && arg8 != 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::commission_type::flat() || arg8 == 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::commission_type::percentage() && arg9 > 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::partner_manager::max_comission_percentage(arg1) || arg9 == 0) {
            abort 7
        };
        0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::trade_id_tracker::increment(arg0);
        let v0 = 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::trade_id_tracker::current(arg0);
        let v1 = 0x1::vector::empty<Route>();
        let v2 = 0;
        while (0x1::vector::is_empty<u64>(&arg6)) {
            ...
            let v4 = Route{
                trade_id  : v0,
                amount_in : 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::math::mul_div(0x2::coin::value<T0>(&arg2), v3, 100),
                current   : 0,
                paths     : 0x2::bag::new(arg11),
            };
            0x1::vector::push_back<Route>(&mut v1, v4);
        };
        if (v2 != 100) {
            abort 6
        };
        ...
        if (0x1::option::is_some<address>(&arg7) && arg10) {
            0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::partner_manager::register_partner_if_necessary(arg1, *0x1::option::borrow<address>(&arg7), arg11);
            0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::partner_manager::collect_commission_if_necessary<T0>(arg1, &mut v5.coin_in, *0x1::option::borrow<address>(&arg7), arg8, arg9, arg11);
        };
        v5
    }
    ...
    public entry fun set_fee_on(arg0: &0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::admin_cap::AdminCap, arg1: &mut Treasury, arg2: bool) {
        arg1.fee_on = arg2;
    }

    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: &mut 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::partner_manager::PartnerRegistry, arg2: Trade<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let Trade {
            trade_id                    : v0,
            amount_in                   : v1,
        ...
        if (0x2::coin::value<T1>(&v14) < 0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::math::mul_div(1000000 - v3, v2, 1000000)) {
            abort 1
        };
        ...
        if (0x1::option::is_some<address>(&v12) && !v7) {
            0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::partner_manager::collect_commission_if_necessary<T1>(arg1, &mut v14, *0x1::option::borrow<address>(&v12), v5, v6, arg4);
        };
        let v16 = Swap{
    ...
    public entry fun withdraw<T0>(arg0: &0x7f6200781ec48ec8a5a263de02391566e79a5a0a1f6738188dcc06b857a8d143::admin_cap::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
