module 0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::state {
    ...
    entry fun set_config<T0: copy + drop + store, T1: copy + drop + store>(arg0: &mut State, arg1: T0, arg2: T1, arg3: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::capability::AdminCap) {
        0x2::dynamic_field::remove_if_exists<T0, T1>(&mut arg0.id, arg1);
        0x2::dynamic_field::add<T0, T1>(&mut arg0.id, arg1, arg2);
    }

    entry fun update(arg0: &mut State, arg1: bool, arg2: u16, arg3: u256, arg4: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::capability::AdminCap) {
