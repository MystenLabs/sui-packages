module 0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::swap_kriya_clmm {
    public fun swap<T0, T1, T2, T3>(arg0: 0x1::option::Option<0x2::coin::Coin<T0>>, arg1: 0x1::option::Option<0x2::coin::Coin<T1>>, arg2: &mut 0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::version::Version, arg5: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::swap_transaction::SwapTransaction<T2, T3>, arg6: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::state::State, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let (v0, v1) = 0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::utils::parse_amount_and_direction<T0, T1>(&arg0, &arg1);
        let v2 = if (v1) {
        ...
        0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::swap_event::emit_common_swap<T0, T1>(0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::consts::DEX_KRIYA_CLMM(), 0x2::object::id_to_address(&v10), v1, v0, v11, true);
        (0x2::coin::from_balance<T0>(v7, arg7), 0x2::coin::from_balance<T1>(v6, arg7))
    }

    public fun swap_a2b<T0, T1, T2, T3>(arg0: 0x1::option::Option<0x2::coin::Coin<T0>>, arg1: &mut 0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::version::Version, arg4: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::swap_transaction::SwapTransaction<T2, T3>, arg5: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::state::State, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let (v0, v1) = swap<T0, T1, T2, T3>(arg0, 0x1::option::none<0x2::coin::Coin<T1>>(), arg1, arg2, arg3, arg4, arg5, arg6);
        0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::utils::transfer_or_destroy<T0>(v0, arg6);
        v1
    }

    public fun swap_b2a<T0, T1, T2, T3>(arg0: 0x1::option::Option<0x2::coin::Coin<T1>>, arg1: &mut 0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0xf6c05e2d9301e6e91dc6ab6c3ca918f7d55896e1f1edd64adc0e615cde27ebf1::version::Version, arg4: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::swap_transaction::SwapTransaction<T2, T3>, arg5: &0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::state::State, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let (v0, v1) = swap<T0, T1, T2, T3>(0x1::option::none<0x2::coin::Coin<T0>>(), arg0, arg1, arg2, arg3, arg4, arg5, arg6);
        0x7ff4b566635dba94bcf06f76bfc2931ef2eb07f639b4108cebe87b68da3d135a::utils::transfer_or_destroy<T1>(v1, arg6);
        v0
    }
