module 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault {
    ...
    struct EmissionEndTimestampsMsKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct InitEmissionEndTimestampsMsVecCap<phantom T0> {
        for: 0x2::object::ID,
        emission_end_timestamps_ms: vector<u64>,
    }
    ...
    public fun new<T0>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (AfterburnerVault<T0>, OwnerCap) {
        ...
        let v1 = EmissionEndTimestampsMsKey{dummy_field: false};
        0x2::dynamic_field::add<EmissionEndTimestampsMsKey, vector<u64>>(&mut v0.id, v1, vector[]);
        let v2 = OwnerCap{
            id                   : 0x2::object::new(arg5),
    ...
    fun add_reward_<T0, T1>(arg0: &mut AfterburnerVault<T0>, arg1: 0x2::coin::Coin<T1>) {
        ...
        *0x1::vector::borrow_mut<u64>(&mut arg0.rewards, v1) = rewards_of<T0, T1>(arg0) + v2;
        ...
        increase_remaining_rewards_for_<T0>(arg0, v1, v2);
        let v3 = last_reward_timestamp_ms_for<T0, T1>(arg0) + emission_schedule_ms_for<T0, T1>(arg0) * remaining_rewards_for<T0>(arg0, v1) / emission_rate_for<T0, T1>(arg0);
        set_emission_end_timestamp_ms_for_index_<T0>(arg0, v3, v1);
    ...
    public(friend) fun adjust_emission_start_timestamps_ms<T0>(arg0: &mut AfterburnerVault<T0>, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<u64>(&arg0.rewards)) {
            if (*0x1::vector::borrow<u64>(&arg0.emission_start_timestamps_ms, v1) < v0) {
                ...
                *0x1::vector::borrow_mut<u64>(&mut arg0.last_reward_timestamps_ms, v1) = v0;
                let v2 = calc_emission_end_timestamp_for<T0>(arg0, arg1, v1);
                set_emission_end_timestamp_ms_for_index_<T0>(arg0, v2, v1);
            };
            v1 = v1 + 1;
        };
    }

    public fun begin_init_emission_end_timestamps_ms_vec_tx<T0>(arg0: &mut AfterburnerVault<T0>) : InitEmissionEndTimestampsMsVecCap<T0> {
        let v0 = EmissionEndTimestampsMsKey{dummy_field: false};
        assert!(!0x2::dynamic_field::exists_<EmissionEndTimestampsMsKey>(&arg0.id, v0), 13);
        let v1 = vector[];
        let v2 = 0;
        while (v2 < 0x1::vector::length<0x1::ascii::String>(&arg0.type_names)) {
            0x1::vector::push_back<u64>(&mut v1, 0);
            v2 = v2 + 1;
        };
        InitEmissionEndTimestampsMsVecCap<T0>{
            for                        : 0x2::object::id<AfterburnerVault<T0>>(arg0),
            emission_end_timestamps_ms : v1,
        }
    }

    public(friend) fun calc_emission_end_timestamp<T0>(arg0: &AfterburnerVault<T0>, arg1: &0x2::clock::Clock) : u64 {
        let v0 = 0;
        let v1 = v0;
        let v2 = 0;
        while (v2 < 0x1::vector::length<u64>(&arg0.rewards)) {
            let v3 = calc_emission_end_timestamp_for<T0>(arg0, arg1, v2);
            if (v0 < v3) {
                v1 = v3;
            };
            v2 = v2 + 1;
    ...
    fun calc_emission_end_timestamp_for<T0>(arg0: &AfterburnerVault<T0>, arg1: &0x2::clock::Clock, arg2: u64) : u64 {
        0x2::clock::timestamp_ms(arg1) + (((1 + ((remaining_rewards_for<T0>(arg0, arg2) as u128) - 1) / (*0x1::vector::borrow<u64>(&arg0.emission_rates, arg2) as u128)) * (*0x1::vector::borrow<u64>(&arg0.emission_schedules_ms, arg2) as u128)) as u64)
    }
    ...
    public fun end_init_emission_end_timestamps_ms_vec_tx<T0>(arg0: InitEmissionEndTimestampsMsVecCap<T0>, arg1: &mut AfterburnerVault<T0>) {
        assert!(arg0.for == 0x2::object::id<AfterburnerVault<T0>>(arg1), 1);
        let InitEmissionEndTimestampsMsVecCap {
            for                        : _,
            emission_end_timestamps_ms : v1,
        } = arg0;
        let v2 = v1;
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x1::ascii::String>(&arg1.type_names)) {
            assert!(*0x1::vector::borrow<u64>(&v2, v3) > 0, 14);
            v3 = v3 + 1;
        };
        let v4 = EmissionEndTimestampsMsKey{dummy_field: false};
        0x2::dynamic_field::add<EmissionEndTimestampsMsKey, vector<u64>>(&mut arg1.id, v4, v2);
    }
    ...
    fun initialize_reward_<T0, T1>(arg0: &mut AfterburnerVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: u64) {
        ...
        let v3 = EmissionEndTimestampsMsKey{dummy_field: false};
        let v4 = 0x2::dynamic_field::borrow_mut<EmissionEndTimestampsMsKey, vector<u64>>(&mut arg0.id, v3);
        0x1::vector::push_back<u64>(v4, v2 + arg3 * v1 / arg4);
        arg0.emission_end_timestamp_ms = 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::utils::max(v4);
    ...
    public fun remove_reward<T0, T1>(arg0: &OwnerCap, arg1: &mut AfterburnerVault<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.afterburner_vault_id == 0x2::object::id<AfterburnerVault<T0>>(arg1), 1);
        let v0 = 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::utils::type_to_string<T1>();
        assert!(contains_type_name<T0>(arg1, v0), 5);
        let v1 = 0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T1>>(&mut arg1.id, v0);
        assert!(0x2::balance::value<T1>(v1) >= arg2, 10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(v1, arg2), arg3), 0x2::tx_context::sender(arg3));
        let v2 = type_to_index<T0, T1>(arg1);
        decrease_remaining_rewards_for_<T0>(arg1, v2, arg2);
    }
    ...
    public fun set_emission_end_timestamp_ms<T0>(arg0: &OwnerCap, arg1: &mut AfterburnerVault<T0>, arg2: u64) {
        abort 11
    }

    public fun set_emission_end_timestamp_ms_for<T0, T1>(arg0: &mut InitEmissionEndTimestampsMsVecCap<T0>, arg1: &mut AfterburnerVault<T0>, arg2: &0x2::clock::Clock) {
        assert!(arg0.for == 0x2::object::id<AfterburnerVault<T0>>(arg1), 1);
        assert!(contains_type<T0, T1>(arg1), 5);
        let v0 = type_to_index<T0, T1>(arg1);
        *0x1::vector::borrow_mut<u64>(&mut arg0.emission_end_timestamps_ms, v0) = calc_emission_end_timestamp_for<T0>(arg1, arg2, v0);
    }

    fun set_emission_end_timestamp_ms_for_index_<T0>(arg0: &mut AfterburnerVault<T0>, arg1: u64, arg2: u64) {
        let v0 = EmissionEndTimestampsMsKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<EmissionEndTimestampsMsKey, vector<u64>>(&mut arg0.id, v0);
        *0x1::vector::borrow_mut<u64>(v1, arg2) = arg1;
        arg0.emission_end_timestamp_ms = 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::utils::max(v1);
    }

    fun set_emission_end_timestamp_ms_for_type_<T0, T1>(arg0: &mut AfterburnerVault<T0>, arg1: u64) {
        set_emission_end_timestamp_ms_for_type_name_<T0>(arg0, arg1, 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::utils::type_to_string<T1>());
    }

    fun set_emission_end_timestamp_ms_for_type_name_<T0>(arg0: &mut AfterburnerVault<T0>, arg1: u64, arg2: 0x1::ascii::String) {
        let v0 = type_name_to_index<T0>(arg0, arg2);
        set_emission_end_timestamp_ms_for_index_<T0>(arg0, arg1, v0);
    }

    public fun set_min_stake_amount<T0>(arg0: &OwnerCap, arg1: &mut AfterburnerVault<T0>, arg2: u64) {
        assert!(arg0.afterburner_vault_id == 0x2::object::id<AfterburnerVault<T0>>(arg1), 1);
        arg1.min_stake_amount = arg2;
    }

    public fun set_remaining_rewards<T0, T1>(arg0: &OwnerCap, arg1: &mut AfterburnerVault<T0>, arg2: u64) {
        assert!(arg0.afterburner_vault_id == 0x2::object::id<AfterburnerVault<T0>>(arg1), 1);
        *0x1::vector::borrow_mut<u64>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, vector<u64>>(&mut arg1.id, rewards_remaining_df_key()), type_to_index<T0, T1>(arg1)) = arg2;
    }
    ...
    public fun update_emissions_for<T0, T1>(arg0: &OwnerCap, arg1: &mut AfterburnerVault<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        assert!(arg0.afterburner_vault_id == 0x2::object::id<AfterburnerVault<T0>>(arg1), 1);
        update_emissions_for_<T0, T1>(arg1, arg2, arg3, arg4);
    }

    fun update_emissions_for_<T0, T1>(arg0: &mut AfterburnerVault<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64) {
        assert!(contains_type<T0, T1>(arg0), 3);
        emit_rewards<T0>(arg0, arg1);
        let v0 = type_to_index<T0, T1>(arg0);
        *0x1::vector::borrow_mut<u64>(&mut arg0.emission_schedules_ms, v0) = arg2;
        *0x1::vector::borrow_mut<u64>(&mut arg0.emission_rates, v0) = arg3;
        let v1 = calc_emission_end_timestamp_for<T0>(arg0, arg1, v0);
        set_emission_end_timestamp_ms_for_index_<T0>(arg0, v1, v0);
        0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::events::emit_increased_emissions_event<T1>(0x2::object::id<AfterburnerVault<T0>>(arg0), arg2, arg3);
    }

    public fun update_emissions_for_and_consume_admin_cap<T0, T1>(arg0: OneTimeAdminCap<T1>, arg1: &mut AfterburnerVault<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        assert!(arg0.afterburner_vault_id == 0x2::object::id<AfterburnerVault<T0>>(arg1), 1);
        update_emissions_for_<T0, T1>(arg1, arg2, arg3, arg4);
        let OneTimeAdminCap {
            id                   : v0,
