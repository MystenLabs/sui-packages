module 0x7f04d2b7668d354b266d29bf72e57e014badd4cb368db752c787dc698b1b8c18::cnsnft5201 {
    struct CNSNFT5201 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5201, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5201>(arg0, arg1);
