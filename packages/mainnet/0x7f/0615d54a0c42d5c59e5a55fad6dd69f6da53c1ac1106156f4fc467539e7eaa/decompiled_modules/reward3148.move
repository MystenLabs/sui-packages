module 0x7f0615d54a0c42d5c59e5a55fad6dd69f6da53c1ac1106156f4fc467539e7eaa::reward3148 {
    struct REWARD3148 has drop {
        dummy_field: bool,
    }

    struct TICKET_3148 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3148(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3148>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3148>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3148, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3148>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3148>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3148>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3148>>(v5, 0x2::tx_context::sender(arg1));
    }
