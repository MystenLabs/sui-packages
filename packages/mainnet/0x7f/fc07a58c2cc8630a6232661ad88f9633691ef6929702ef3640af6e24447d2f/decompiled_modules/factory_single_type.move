module 0x7ffc07a58c2cc8630a6232661ad88f9633691ef6929702ef3640af6e24447d2f::factory_single_type {
    ...
    public entry fun create_treasury_cap(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<TokenMarker>(v0, 9, b"MTKN", b"TokenMarker", b"TokenMarker for Factory", 0x1::option::none<0x2::url::Url>(), arg0);
