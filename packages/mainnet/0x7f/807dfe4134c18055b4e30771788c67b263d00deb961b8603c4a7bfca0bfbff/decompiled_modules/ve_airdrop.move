module 0xe34258dd742ee90853fdfb708bc438e4b166a0807ca9387b74079af1f4bcb4c6::ve_airdrop {
    ...
    public fun get_airdrop_v2<T0>(arg0: &mut VeAirdrop<T0>, arg1: &mut 0x2469959951798462ecba5efc3b93276560472be279494561331d384baeedab4c::voting_escrow::VotingEscrow<T0>, arg2: vector<vector<u8>>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = EventVeAirdropClaimed{
            airdrop_id : 0x2::object::id<VeAirdrop<T0>>(arg0),
            amount     : arg3,
            user       : 0x2::tx_context::sender(arg5),
        ...
        0x2::event::emit<EventVeAirdropClaimed>(v0);
        0x2469959951798462ecba5efc3b93276560472be279494561331d384baeedab4c::voting_escrow::create_lock<T0>(arg1, 0xe34258dd742ee90853fdfb708bc438e4b166a0807ca9387b74079af1f4bcb4c6::airdrop::get_airdrop<T0>(&mut arg0.airdrop, arg2, arg4, arg3, arg5), 1456, true, arg4, arg5);
    }
