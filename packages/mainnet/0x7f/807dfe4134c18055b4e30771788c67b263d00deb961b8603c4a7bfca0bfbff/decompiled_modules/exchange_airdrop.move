module 0xe34258dd742ee90853fdfb708bc438e4b166a0807ca9387b74079af1f4bcb4c6::exchange_airdrop {
    ...
    public fun get_airdrop<T0, T1>(arg0: &mut ExchangeAirdrop<T0, T1>, arg1: &mut 0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::voting_escrow::VotingEscrow<T1>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x49a7dda98c6dfd2115cee9c00727cf493c01804e55c89b325b08397e414898eb::voting_escrow::create_lock<T1>(arg1, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reserves, v0), arg4), 1456, true, arg3, arg4);
    }

    public fun get_airdrop_v2<T0, T1>(arg0: &mut ExchangeAirdrop<T0, T1>, arg1: &mut 0x2469959951798462ecba5efc3b93276560472be279494561331d384baeedab4c::voting_escrow::VotingEscrow<T1>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.start <= 0x2::clock::timestamp_ms(arg3), 830914020413490200);
        assert!(0x2::balance::value<T1>(&arg0.reserves) >= 0x2::coin::value<T0>(&arg2), 653209817586432800);
        let v0 = 0x2::coin::value<T0>(&arg2);
        0x2::balance::join<T0>(&mut arg0.collected, 0x2::coin::into_balance<T0>(arg2));
        ...
        0x2::event::emit<EventAirdropClaimed>(v1);
        0x2469959951798462ecba5efc3b93276560472be279494561331d384baeedab4c::voting_escrow::create_lock<T1>(arg1, 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.reserves, v0), arg4), 1456, true, arg3, arg4);
    }
