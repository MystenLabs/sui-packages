module 0x3d35632bdbeddfc17fc42fc0d915a02e5925f2d5054f147f41b1311f20c35a87::cnsnft9619 {
    struct CNSNFT9619 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9619, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7156"));
        let v4 = 0x2::package::claim<CNSNFT9619>(arg0, arg1);
