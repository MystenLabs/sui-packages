module 0x3d88c65211f532b8bd9e3253fdb6c75c5717df7397466b9ee079b4014928ff6c::cnsnft8548 {
    struct CNSNFT8548 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8548, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1275"));
        let v4 = 0x2::package::claim<CNSNFT8548>(arg0, arg1);
