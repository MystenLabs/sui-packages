module 0x3d4bf339955d05d65739a1d9ff92974a3dbd25e4c03ccd6b9046c158af412243::reward8561 {
    struct REWARD8561 has drop {
        dummy_field: bool,
    }

    struct TICKET_8561 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8561(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8561>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8561>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8561, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8561>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8561>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8561>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8561>>(v5, 0x2::tx_context::sender(arg1));
    }
