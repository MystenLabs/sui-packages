module 0xc5c833991ed1123d70b1001c0bcdb01ec5728b09f25dfc42a0edaf16005d404d::entitlement {
    ...
    entry fun seal_approve_subscription(arg0: vector<u8>, arg1: u64, arg2: u64, arg3: &Subscription, arg4: &0x2::tx_context::TxContext) {
        assert!(arg3.subscriber == 0x2::tx_context::sender(arg4), 1);
        assert!(arg0 == period_identity(arg3.vault, arg1, arg2), 5);
        assert!(arg3.tier >= arg1, 7);
        let v0 = arg2 * 2592000000;
        assert!(arg3.started_at_ms <= v0, 6);
        assert!(v0 < arg3.expires_at_ms, 6);
    }
