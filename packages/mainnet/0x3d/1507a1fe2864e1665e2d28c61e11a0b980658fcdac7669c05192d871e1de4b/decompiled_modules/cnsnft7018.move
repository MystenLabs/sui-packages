module 0x3d1507a1fe2864e1665e2d28c61e11a0b980658fcdac7669c05192d871e1de4b::cnsnft7018 {
    struct CNSNFT7018 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7018, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7018>(arg0, arg1);
