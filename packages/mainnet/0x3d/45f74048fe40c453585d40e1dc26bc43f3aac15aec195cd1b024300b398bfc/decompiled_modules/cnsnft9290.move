module 0x3d45f74048fe40c453585d40e1dc26bc43f3aac15aec195cd1b024300b398bfc::cnsnft9290 {
    struct CNSNFT9290 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9290, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9290>(arg0, arg1);
