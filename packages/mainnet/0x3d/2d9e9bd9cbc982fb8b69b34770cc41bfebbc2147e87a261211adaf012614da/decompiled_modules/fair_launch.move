module 0x3d2d9e9bd9cbc982fb8b69b34770cc41bfebbc2147e87a261211adaf012614da::fair_launch {
    ...
    public fun create_fair_launch<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: 0x2::coin::Coin<T0>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(arg0 < arg1, 1);
        assert!(arg0 > 0x2::clock::timestamp_ms(arg9), 1);
        validate_params(arg2, arg3, arg4, arg6, arg7, 0x2::coin::value<T0>(&arg8));
        let v0 = FairLaunch<T0, T1>{
            id                 : 0x2::object::new(arg10),
            curator            : 0x2::tx_context::sender(arg10),
            start_time         : arg0,
            end_time           : arg1,
            soft_cap           : arg2,
            ...
            lp_lock_period     : arg5,
            total_tokens       : arg6,
            total_sell_token_x : arg7,
            balance_x          : 0x2::coin::into_balance<T0>(arg8),
    ...
    fun validate_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        assert!(arg0 > 0, 1);
        assert!(arg1 > 0, 1);
        assert!(arg2 >= 5100, 10);
