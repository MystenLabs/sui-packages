module 0x3dd45d5814b2072649b9fb83124100a64135a2371186e277f2a881a0403db6f5::rug_n_slug {
    struct RUG_N_SLUG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RUG_N_SLUG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RUG_N_SLUG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Rug N Slug"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"rug n slug"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreib4k274r2hfi4jvj6e6a2zfslsquvv4t7vswuv6q3kityulpaa25q"));
