module 0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::custom_liquidate {
    ...
    public(friend) fun take_balance<T0, T1>(arg0: &mut CustomLiquidateReceipt<T0>, arg1: u64) : 0x2::balance::Balance<T1> {
        let v0 = 0x1::type_name::with_defining_ids<T1>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.balances, v0), 0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::error::invalid_coin_type());
        let v1 = 0x2::balance::value<T1>(0x2::bag::borrow<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.balances, v0));
        assert!(v1 >= arg1, 0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::error::insufficient_balance());
        if (arg1 == v1) {
    ...
    public fun verify_custom_liquidate<T0>(arg0: &0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::liquidator::Liquidator, arg1: CustomLiquidateReceipt<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let CustomLiquidateReceipt { balances: v0 } = arg1;
        assert!(0x2::bag::is_empty(&v0), 0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::error::balances_not_empty());
        0x2::bag::destroy_empty(v0);
        0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::liquidator::transfer_to_recipient<T0>(arg0, 0x2::coin::from_balance<T0>(0x2::bag::remove<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v0, 0x1::type_name::with_defining_ids<T0>()), arg2));
    }
