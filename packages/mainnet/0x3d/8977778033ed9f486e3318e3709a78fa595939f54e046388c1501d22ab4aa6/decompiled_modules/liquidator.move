module 0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::liquidator {
    ...
    public(friend) fun ensure_caller_whitelisted(arg0: &Liquidator, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg1), 0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::error::not_whitelisted());
    }
    ...
    public fun update_slippage_tolerance(arg0: &LiquidatorAdminCap, arg1: &mut Liquidator, arg2: u32) {
        assert!(arg2 <= 10000, 0x3d8977778033ed9f486e3318e3709a78fa595939f54e046388c1501d22ab4aa6::error::invalid_slippage());
