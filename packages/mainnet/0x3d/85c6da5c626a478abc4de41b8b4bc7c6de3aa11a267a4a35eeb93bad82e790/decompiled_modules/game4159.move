module 0x3d85c6da5c626a478abc4de41b8b4bc7c6de3aa11a267a4a35eeb93bad82e790::game4159 {
    struct GAME4159 has drop {
        dummy_field: bool,
    }

    struct TICKET_4159 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4159(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4159>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4159>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME4159, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME4159>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4159>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4159>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4159>>(v5, 0x2::tx_context::sender(arg1));
    }
