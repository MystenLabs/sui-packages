module 0x3d9c24362d5ceb01516a53e0ac0a0359191044a7ce0dfdf5c6b874aa3bb726be::rare_sui_names__for_buisness_ {
    struct RARE_SUI_NAMES__FOR_BUISNESS_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: RARE_SUI_NAMES__FOR_BUISNESS_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<RARE_SUI_NAMES__FOR_BUISNESS_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Rare Sui Names (for buisness)"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"A small collection of rare sui names (NS), dedicated to Defi businesses. "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://3u5Ghj2UJuu3yWesEfvMQzvgspxNqUn9CjY64ctoWSg"));
