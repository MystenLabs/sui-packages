module 0x3dd64fea9f03f0cf9b741c6ef3ad2d9de1fa9b6e3fb139d2916aa676fbc05443::reward7284 {
    struct REWARD7284 has drop {
        dummy_field: bool,
    }

    struct TICKET_7284 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7284(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7284>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7284>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7284, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7284>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7284>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7284>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7284>>(v5, 0x2::tx_context::sender(arg1));
    }
