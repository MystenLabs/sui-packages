module 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::pool {
    ...
    struct Pool<phantom T0, phantom T1, T2: store> has store, key {
        ...
        protocol_fees: 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::Fees<T0, T1>,
        pool_fee_config: 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::FeeConfig,
    ...
    struct SwapResult has copy, drop, store {
        ...
        amount_in: u64,
        amount_out: u64,
        output_fees: 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::SwapFee,
        a2b: bool,
        balance_a: u64,
        balance_b: u64,
    }
    ...
    public(friend) fun swap<T0, T1, T2: store>(arg0: &mut Pool<T0, T1, T2>, arg1: &mut 0x2::coin::Coin<T0>, arg2: &mut 0x2::coin::Coin<T1>, arg3: 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::SwapQuote, arg4: u64, arg5: &0x2::tx_context::TxContext) : SwapResult {
        let v0 = 0x2::coin::value<T0>(arg1) == 0 && 0x2::coin::value<T1>(arg2) == 0;
        assert!(!v0, 10);
        assert!(!is_pool_paused<T0, T1, T2>(arg0), 11);
        assert!(0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_out(&arg3) > 0, 6);
        assert!(0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_out(&arg3) >= arg4, 3);
        let (v1, v2) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::balances_mut<T0, T1>(&mut arg0.protocol_fees);
        if (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::a2b(&arg3)) {
        ...
        let v15 = SwapResult{
            ...
            amount_in   : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_in(&arg3),
            amount_out  : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_out(&arg3),
            output_fees : *0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::output_fees(&arg3),
            a2b         : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::a2b(&arg3),
    ...
    public(friend) fun new<T0, T1, T2: store>(arg0: &mut 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::registry::Registry, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: &mut 0x2::coin_registry::CoinRegistry, arg3: u64, arg4: T2, arg5: &0x2::coin_registry::Currency<T0>, arg6: &0x2::coin_registry::Currency<T1>, arg7: 0x1::type_name::TypeName, arg8: 0x1::type_name::TypeName, arg9: &mut 0x2::tx_context::TxContext) : Pool<T0, T1, T2> {
        ...
        let v5 = Pool<T0, T1, T2>{
            ...
            protocol_fees          : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::new<T0, T1>(2000, 10000, 0),
            pool_fee_config        : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::new_config(arg3, 10000, 0),
            trading_data           : v4,
            is_paused              : false,
        ...
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::registry::register_pool(arg0, v6.pool_id, v6.coin_type_a, v6.coin_type_b, v6.lp_token_type, v6.swap_fee_bps, v6.quoter_type);
        v5
    }
    ...
    public(friend) fun collect_protocol_fees<T0, T1, T2: store>(arg0: &mut Pool<T0, T1, T2>) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::withdraw<T0, T1>(&mut arg0.protocol_fees)
    }

    public(friend) fun compute_swap_fees_<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>, arg1: u64, arg2: 0x1::option::Option<u64>) : (u64, u64) {
        let (v0, v1) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::fee_ratio<T0, T1>(&arg0.protocol_fees);
        let (v2, v3) = if (0x1::option::is_some<u64>(&arg2)) {
            let (v4, v5) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::fee_ratio_(&arg0.pool_fee_config);
            ...
            0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::fee_ratio_(&arg0.pool_fee_config)
        };
        let v6 = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::base_math::safe_mul_div_up(arg1, v2, v3);
        let v7 = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::base_math::safe_mul_div_up(v6, v0, v1);
        (v7, v6 - v7)
    }

    public fun deposit_liquidity<T0, T1, T2: store>(arg0: &mut Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<LpToken<T0, T1>>, DepositResult) {
        ...
        0x2::balance::join<T0>(&mut arg0.balance_a, 0x2::balance::split<T0>(0x2::coin::balance_mut<T0>(arg2), 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::deposit_a(&v1)));
        0x2::balance::join<T1>(&mut arg0.balance_b, 0x2::balance::split<T1>(0x2::coin::balance_mut<T1>(arg3), 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::deposit_b(&v1)));
        let v5 = 0x2::coin::from_balance<LpToken<T0, T1>>(0x2::balance::increase_supply<LpToken<T0, T1>>(&mut arg0.lp_supply, 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::mint_lp(&v1)), arg6);
        let v6 = DepositResult{
            user      : 0x2::tx_context::sender(arg6),
            pool_id   : 0x2::object::id<Pool<T0, T1, T2>>(arg0),
            deposit_a : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::deposit_a(&v1),
            deposit_b : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::deposit_b(&v1),
            mint_lp   : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::mint_lp(&v1),
            balance_a : 0x2::balance::value<T0>(&arg0.balance_a),
            balance_b : 0x2::balance::value<T1>(&arg0.balance_b),
        };
        0x2::event::emit<DepositResult>(v6);
        if (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::initial_deposit(&v1)) {
    ...
    public(friend) fun get_quote<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: u64, arg3: u64, arg4: bool, arg5: 0x1::option::Option<u64>) : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::SwapQuote {
        let (v0, v1) = compute_swap_fees_<T0, T1, T2>(arg0, arg3, arg5);
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::quote(arg1, 0x2::object::id<Pool<T0, T1, T2>>(arg0), arg2, arg3 - v0 - v1, v0, v1, arg4)
    }
    ...
    public fun lp_token_type<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>) : 0x1::type_name::TypeName {
        arg0.lp_token_type
    }
    ...
    public(friend) fun pause_pool<T0, T1, T2: store>(arg0: &mut Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig) {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::check_package_version(arg1);
        arg0.is_paused = true;
    }

    public fun pool_fee_config<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>) : &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::FeeConfig {
    ...
    public fun protocol_fees<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>) : &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::fees::Fees<T0, T1> {
        &arg0.protocol_fees
    }
    ...
    public fun quote_deposit<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: u64, arg3: u64) : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::DepositQuote {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::check_package_version(arg1);
        quote_deposit_<T0, T1, T2>(arg0, arg1, arg2, arg3)
    }

    fun quote_deposit_<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: u64, arg3: u64) : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::DepositQuote {
        let (v0, v1) = balance_amounts<T0, T1, T2>(arg0);
        let (v2, v3, v4) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::pool_math::quote_deposit(v0, v1, lp_supply_val<T0, T1, T2>(arg0), arg2, arg3);
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::deposit_quote(arg1, lp_supply_val<T0, T1, T2>(arg0) == 0, v2, v3, v4)
    }

    public fun quote_redeem<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: u64) : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::RedeemQuote {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::check_package_version(arg1);
        quote_redeem_<T0, T1, T2>(arg0, arg1, arg2, 0, 0)
    }

    fun quote_redeem_<T0, T1, T2: store>(arg0: &Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: u64, arg3: u64, arg4: u64) : 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::RedeemQuote {
        let (v0, v1) = balance_amounts<T0, T1, T2>(arg0);
        let (v2, v3) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::pool_math::quote_redeem(v0, v1, lp_supply_val<T0, T1, T2>(arg0), arg2, arg3, arg4);
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::redeem_quote(arg1, v2, v3, arg2)
    }
    ...
    public fun redeem_liquidity<T0, T1, T2: store>(arg0: &mut Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig, arg2: 0x2::coin::Coin<LpToken<T0, T1>>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, RedeemResult) {
        ...
        assert!(0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::burn_lp(&v0) == v2, 0);
        0x2::balance::decrease_supply<LpToken<T0, T1>>(&mut arg0.lp_supply, 0x2::coin::into_balance<LpToken<T0, T1>>(arg2));
        let v3 = 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance_a, 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::withdraw_a(&v0)), arg5);
        let v4 = 0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.balance_b, 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::withdraw_b(&v0)), arg5);
    ...
    public(friend) fun resume_pool<T0, T1, T2: store>(arg0: &mut Pool<T0, T1, T2>, arg1: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::GlobalConfig) {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::global_config::check_package_version(arg1);
        arg0.is_paused = false;
    }

    fun swap_inner<T0, T1>(arg0: &0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::SwapQuote, arg1: &mut 0x2::balance::Balance<T0>, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut u128, arg4: &mut 0x2::balance::Balance<T1>, arg5: &mut 0x2::balance::Balance<T1>, arg6: &mut 0x2::coin::Coin<T1>, arg7: &mut u128, arg8: &mut u64, arg9: &mut u64) {
        assert!(0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_out(arg0) <= 0x2::balance::value<T1>(arg5), 4);
        assert!(0x2::coin::value<T0>(arg2) >= 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_in(arg0), 7);
        0x2::balance::join<T0>(arg1, 0x2::balance::split<T0>(0x2::coin::balance_mut<T0>(arg2), 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_in(arg0)));
        let v0 = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::protocol_fees(0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::output_fees(arg0));
        0x2::balance::join<T1>(arg4, 0x2::balance::split<T1>(arg5, v0));
        0x2::balance::join<T1>(0x2::coin::balance_mut<T1>(arg6), 0x2::balance::split<T1>(arg5, 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_out(arg0)));
        *arg8 = *arg8 + v0;
        *arg9 = *arg9 + 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::pool_fees(0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::output_fees(arg0));
        *arg3 = *arg3 + (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_in(arg0) as u128);
        *arg7 = *arg7 + (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::amount_out(arg0) as u128);
    }
    ...
    public fun swap_result_pool_fees(arg0: &SwapResult) : u64 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::pool_fees(&arg0.output_fees)
    }
    ...
    public fun swap_result_protocol_fees(arg0: &SwapResult) : u64 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::quote::protocol_fees(&arg0.output_fees)
    }
