module 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math128 {
    ...
    public fun log10_down(arg0: u128) : u8 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::log10_down((arg0 as u256))
    }

    public fun log10_up(arg0: u128) : u8 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::log10_up((arg0 as u256))
    }

    public fun log256_down(arg0: u128) : u8 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::log256_down((arg0 as u256))
    }

    public fun log256_up(arg0: u128) : u8 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::log256_up((arg0 as u256))
    }

    public fun log2_down(arg0: u128) : u8 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::log2_down((arg0 as u256))
    }

    public fun log2_up(arg0: u128) : u16 {
        0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::log2_up((arg0 as u256))
    }
    ...
    public fun mul_div_down(arg0: u128, arg1: u128, arg2: u128) : u128 {
        (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::mul_div_down((arg0 as u256), (arg1 as u256), (arg2 as u256)) as u128)
    }

    public fun mul_div_up(arg0: u128, arg1: u128, arg2: u128) : u128 {
        (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::mul_div_up((arg0 as u256), (arg1 as u256), (arg2 as u256)) as u128)
    }

    public fun pow(arg0: u128, arg1: u128) : u128 {
        (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::pow((arg0 as u256), (arg1 as u256)) as u128)
    }

    public fun sqrt_down(arg0: u128) : u128 {
        (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::sqrt_down((arg0 as u256)) as u128)
    }

    public fun sqrt_up(arg0: u128) : u128 {
        (0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::sqrt_up((arg0 as u256)) as u128)
    }
    ...
    public fun try_mul(arg0: u128, arg1: u128) : (bool, u128) {
        let (v0, v1) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::try_mul((arg0 as u256), (arg1 as u256));
    ...
    public fun try_mul_div_down(arg0: u128, arg1: u128, arg2: u128) : (bool, u128) {
        let (v0, v1) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::try_mul_div_down((arg0 as u256), (arg1 as u256), (arg2 as u256));
        if (!v0 || v1 > 340282366920938463463374607431768211455) {
            (false, 0)
        } else {
            (true, (v1 as u128))
    ...
    public fun try_mul_div_up(arg0: u128, arg1: u128, arg2: u128) : (bool, u128) {
        let (v0, v1) = 0x3de33d108bbadcfdd40d74247537ae20d28a62d5aac49b8fcccd019d8f0d41a9::math256::try_mul_div_up((arg0 as u256), (arg1 as u256), (arg2 as u256));
        if (!v0 || v1 > 340282366920938463463374607431768211455) {
            (false, 0)
        } else {
            (true, (v1 as u128))
