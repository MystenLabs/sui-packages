module 0x3dbbeb41168d7c3cee6a0b5d9a4c47fa783d5324b2213210c44761ace1528382::lootbox {
    ...
    fun init(arg0: LOOTBOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Lootbox>(&mut v3, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"S Card Lootbox"));
        0x2::display::add<Lootbox>(&mut v3, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"A mysterious lootbox"));
        ...
        0x2::display::add<Lootbox>(&mut v3, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://img.sudo.finance/lootbox.webp"));
