module 0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::staked_share {
    ...
    public entry fun new_and_share_number_pool<T0: store, T1: store + key>(arg0: &0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::AdminCap, arg1: &mut 0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = NumberPool<T0, T1>{
            id               : 0x2::object::new(arg2),
            available_shares : 0x1::vector::empty<StakedPoolShare<T0, T1>>(),
        };
        0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::fill_number_pool<T0, T1>(arg1, 0x2::object::uid_to_inner(&v0.id));
        0x2::transfer::share_object<NumberPool<T0, T1>>(v0);
    }

    public(friend) fun new_share<T0, T1: store + key>(arg0: &0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::Pool<T0, T1>, arg1: &mut NumberPool<T0, T1>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : vector<StakedPoolShare<T0, T1>> {
        let v0 = arg2;
        if (0x1::vector::length<StakedPoolShare<T0, T1>>(&arg1.available_shares) == 0) {
            let v2 = StakedPoolShare<T0, T1>{
                id        : 0x2::object::new(arg3),
                start_num : 0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::total_amount<T0, T1>(arg0) - arg2 + 1,
                end_num   : 0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::total_amount<T0, T1>(arg0),
            };
            ...
            if (v0 != 0) {
                let v9 = StakedPoolShare<T0, T1>{
                    id        : 0x2::object::new(arg3),
                    start_num : 0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::total_amount<T0, T1>(arg0) - v0 + 1,
                    end_num   : 0x3dd15974de01d41c8881432b9fdd75b787972b980e8a97ecdbc864ab24005edc::pool::total_amount<T0, T1>(arg0),
                };
