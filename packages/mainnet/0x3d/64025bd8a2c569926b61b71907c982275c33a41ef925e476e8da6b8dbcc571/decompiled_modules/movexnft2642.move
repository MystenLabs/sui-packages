module 0x3d64025bd8a2c569926b61b71907c982275c33a41ef925e476e8da6b8dbcc571::movexnft2642 {
    struct MOVEXNFT2642 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2642, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://qehowo3843.icu/img/{id}"));
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2642>(arg0, arg1);
