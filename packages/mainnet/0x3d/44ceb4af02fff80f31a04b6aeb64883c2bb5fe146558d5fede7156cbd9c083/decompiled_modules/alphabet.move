module 0x3d44ceb4af02fff80f31a04b6aeb64883c2bb5fe146558d5fede7156cbd9c083::alphabet {
    ...
    public fun common_letters() : vector<u8> {
        b"ETAOINS"
    }
    ...
    public fun other_letters() : vector<u8> {
        b"BCDFGHJKLMPRUVWY"
    }
