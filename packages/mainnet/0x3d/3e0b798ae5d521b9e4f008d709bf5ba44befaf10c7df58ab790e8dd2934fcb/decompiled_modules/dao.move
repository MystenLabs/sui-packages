module 0x3d3e0b798ae5d521b9e4f008d709bf5ba44befaf10c7df58ab790e8dd2934fcb::dao {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x3d3e0b798ae5d521b9e4f008d709bf5ba44befaf10c7df58ab790e8dd2934fcb::dao_config::new_global_dao_fee_and_shared(arg0);
    }
    ...
    public entry fun set_platform_fee(arg0: &OperatorCap, arg1: &mut 0x3d3e0b798ae5d521b9e4f008d709bf5ba44befaf10c7df58ab790e8dd2934fcb::dao_config::GlobalDaoFee, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x3d3e0b798ae5d521b9e4f008d709bf5ba44befaf10c7df58ab790e8dd2934fcb::dao_config::set_platform_fee(arg1, arg2, arg3, arg4);
    }
    ...
    public entry fun start_vips<T0>(arg0: &AdminCap, arg1: &mut DAOFund<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::length<address>(&arg2);
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 1014);
        let v1 = 0;
        while (v1 < v0) {
