module 0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::debt_info {
    ...
    public fun add<T0>(arg0: &mut DebtInfo, arg1: &0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::debt::DebtRegistry<T0>) {
        let v0 = DebtInfoEntry{
            supply_x64          : 0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::debt::supply_x64<T0>(arg1),
            liability_value_x64 : 0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::debt::liability_value_x64<T0>(arg1),
        };
        0x2::vec_map::insert<0x1::type_name::TypeName, DebtInfoEntry>(&mut arg0.map, 0x1::type_name::get<T0>(), v0);
    }

    public fun add_from_supply_pool<T0, T1>(arg0: &mut DebtInfo, arg1: &mut 0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::supply_pool::SupplyPool<T0, T1>, arg2: &0x2::clock::Clock) {
        let v0 = arg0.facil_id;
        add<T1>(arg0, 0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::supply_pool::borrow_debt_registry<T0, T1>(arg1, &v0, arg2));
    }
    ...
    fun calc_repay_for_amount(arg0: &ValidatedDebtInfo, arg1: 0x1::type_name::TypeName, arg2: u64) : u128 {
        ...
        0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::util::muldiv_u128((arg2 as u128) * 18446744073709551616, v0.supply_x64, v0.liability_value_x64)
    }

    fun calc_repay_lossy(arg0: &ValidatedDebtInfo, arg1: 0x1::type_name::TypeName, arg2: u128) : u64 {
        (0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::util::divide_and_round_up_u128(calc_repay_x64(arg0, arg1, arg2), 18446744073709551616) as u64)
    }

    fun calc_repay_x64(arg0: &ValidatedDebtInfo, arg1: 0x1::type_name::TypeName, arg2: u128) : u128 {
        let v0 = 0x2::vec_map::get<0x1::type_name::TypeName, DebtInfoEntry>(&arg0.map, &arg1);
        0x3df363b3ac27f370a02f4dbd4a555651e50aa5e101e9c4be36e787345bc61cec::util::muldiv_round_up_u128(v0.liability_value_x64, arg2, v0.supply_x64)
    }
