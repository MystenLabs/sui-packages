module 0x3dcd1f9fc276fb931536c81b40a880416a1bb93ea10934f0e42c188121143c15::cnsnft2829 {
    struct CNSNFT2829 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2829, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9009"));
        let v4 = 0x2::package::claim<CNSNFT2829>(arg0, arg1);
