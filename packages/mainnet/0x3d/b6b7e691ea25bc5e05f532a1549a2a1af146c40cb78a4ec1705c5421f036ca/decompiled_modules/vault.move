module 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::vault {
    ...
    public fun accrue_performance_fee_with_adapter<T0>(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::get_suilend_reserve<T0, 0x2::sui::SUI>(arg3);
        let v0 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::get_suilend_fee_receiver<T0>(arg3);
    ...
    public entry fun admin_claim_and_compound_reward<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::get_suilend_reserve<T0, 0x2::sui::SUI>(arg1);
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::get_suilend_fee_receiver<T0>(arg1);
        let v0 = borrow_reserve_slot_shared<T0>(arg0, arg3);
        let v1 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::claim_rewards_from_suilend<T0, 0x2::sui::SUI>(arg1, &v0.obligation_cap, arg2, arg3, arg4, arg5, arg6);
    ...
    public entry fun admin_claim_reward<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == arg0.admin, 1001);
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::get_suilend_reserve<T0, T1>(arg1);
        let v0 = borrow_reserve_slot_shared<T0>(arg0, arg3);
        let v1 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::claim_rewards_from_suilend<T0, T1>(arg1, &v0.obligation_cap, arg2, arg3, arg4, arg5, arg6);
        let v2 = 0x2::coin::value<T1>(&v1);
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v1, 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::get_suilend_fee_receiver<T0>(arg1));
    ...
    fun borrow_and_redeposit<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v1 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::borrow_from_suilend<T0, 0x2::sui::SUI>(arg1, arg2, &v0.obligation_cap, arg4, arg3, arg5);
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::deposit_to_suilend<T0>(arg1, arg2, arg4, v1, &borrow_reserve_slot_shared<T0>(arg0, arg2).obligation_cap, arg5);
    ...
    public entry fun borrow_from_vault<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = borrow_reserve_slot_shared<T0>(arg0, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::borrow_from_suilend<T0, T1>(arg1, arg2, &v0.obligation_cap, arg3, arg4, arg5), 0x2::tx_context::sender(arg5));
        let v1 = BorrowEvent{
            vault_id        : 0x2::object::id_address<Vault>(arg0),
    ...
    public entry fun borrow_test<T0, T1: drop>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::borrow_from_suilend<T0, T1>(arg1, arg3, arg2, arg4, arg5, arg6), 0x2::tx_context::sender(arg6));
        let v0 = BorrowEvent{
            vault_id        : 0x2::object::id_address<Vault>(arg0),
    ...
    public entry fun deposit<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::Strategies, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::allocate_and_execute(arg5, v0, arg6);
        ensure_reserve_slot<T0>(arg0, arg2, arg3, arg6);
        let v2 = borrow_reserve_slot_shared<T0>(arg0, arg3);
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::deposit_to_suilend<T0>(arg2, arg3, arg4, arg1, &v2.obligation_cap, arg6);
        let v3 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::first_active_loop(arg5);
        if (0x1::option::is_some<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(&v3)) {
            let v4 = 0x1::option::extract<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(&mut v3);
            execute_leverage_loop<T0>(arg0, arg2, arg3, &v4, v0, arg4, arg6);
            0x1::option::destroy_none<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(v3);
        } else {
            0x1::option::destroy_none<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(v3);
        };
        let v5 = DepositEvent{
    ...
    public entry fun emergency_liquidate<T0, T1, T2>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, _) = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::liquidate_obligation<T0, T1, T2>(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v2 = v0;
    ...
    fun ensure_reserve_slot<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::dynamic_field::exists_<ReserveKey>(&arg0.id, v0)) {
            let v1 = VaultReserveSlot<T0>{obligation_cap: 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::create_obligation_cap<T0>(arg1, arg3)};
            0x2::dynamic_field::add<ReserveKey, VaultReserveSlot<T0>>(&mut arg0.id, v0, v1);
        };
    }

    fun execute_leverage_loop<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = target_borrow_for_amount(arg4, 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::loop_leverage_bps(arg3));
        if (v0 == 0) {
            return
        };
        let v1 = v0;
        let v2 = 0;
        let v3 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::loop_max_iterations(arg3);
        while (v1 > 0 && v2 < v3) {
            let v4 = v1 / (v3 - v2);
            let v5 = v4;
            if (v4 == 0) {
            ...
            assert!(v7 >= 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::loop_hf_stop_bps(arg3), 2000);
            if (v6 >= v1) {
                v1 = 0;
            } else {
                v1 = v1 - v6;
            ...
            v2 = v2 + 1;
            if (v7 <= 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::loop_hf_warn_bps(arg3)) {
                break
            };
        };
        assert!(v1 == 0, 2001);
    ...
    fun repay_borrow_portion<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: u64, arg4: &0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        while (arg3 > 0 && v0 < v2) {
            ...
            let v6 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::withdraw_liquidity_from_suilend<T0>(arg1, arg2, arg5, &v5.obligation_cap, v4, arg6);
            let v7 = borrow_reserve_slot_shared<T0>(arg0, arg2);
            0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::repay_borrow<T0, 0x2::sui::SUI>(arg1, arg2, &v7.obligation_cap, arg5, &mut v6, arg6);
            ...
            assert!(health_factor_bps<T0>(arg1, borrow_reserve_slot_shared<T0>(arg0, arg2)) >= 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::loop_hf_stop_bps(arg4), 2002);
            v0 = v0 + 1;
        };
        assert!(arg3 == 0, 2001);
    ...
    public entry fun suilend_loop_step<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        ensure_reserve_slot<T0>(arg0, arg2, arg3, arg6);
        let v0 = borrow_reserve_slot_shared<T0>(arg0, arg3);
        0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::deposit_to_suilend<T0>(arg2, arg3, arg5, arg1, &v0.obligation_cap, arg6);
        let v1 = borrow_reserve_slot_shared<T0>(arg0, arg3);
        0x2::balance::join<0x2::sui::SUI>(0x2::coin::balance_mut<0x2::sui::SUI>(&mut arg0.coin), 0x2::coin::into_balance<0x2::sui::SUI>(0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::borrow_from_suilend<T0, 0x2::sui::SUI>(arg2, arg3, &v1.obligation_cap, arg5, arg4, arg6)));
    ...
    public entry fun withdraw<T0>(arg0: &mut Vault, arg1: &mut 0x2::coin::Coin<VAULT>, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: u64, arg5: &0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::Strategies, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > (arg0.hwm as u128)) {
            let v2 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::get_suilend_fee_receiver<T0>(arg3);
        ...
        let v7 = 0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::first_active_loop(arg5);
        if (0x1::option::is_some<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(&v7)) {
            let v8 = 0x1::option::extract<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(&mut v7);
            ...
            0x1::option::destroy_none<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(v7);
        } else {
            0x1::option::destroy_none<0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::strategy::LoopSettings>(v7);
        };
        ...
        0x2::balance::join<0x2::sui::SUI>(&mut v6, 0x2::coin::into_balance<0x2::sui::SUI>(0x3db6b7e691ea25bc5e05f532a1549a2a1af146c40cb78a4ec1705c5421f036ca::suilend_adapter::withdraw_liquidity_from_suilend<T0>(arg3, arg4, arg6, &borrow_reserve_slot_shared<T0>(arg0, arg4).obligation_cap, v1, arg7)));
