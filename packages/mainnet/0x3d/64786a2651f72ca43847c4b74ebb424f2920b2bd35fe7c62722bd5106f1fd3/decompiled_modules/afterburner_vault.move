module 0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::afterburner_vault {
    ...
    fun add_reward_<T0, T1>(arg0: &mut AfterburnerVault<T0>, arg1: 0x2::coin::Coin<T1>) {
        ...
        let v2 = rewards_of<T0, T1>(arg0) + v1;
        *0x1::vector::borrow_mut<u64>(&mut arg0.rewards, type_name_to_index<T0>(arg0, v0)) = v2;
        ...
        let v3 = last_reward_timestamp_ms_for<T0, T1>(arg0) + emission_schedule_ms_for<T0, T1>(arg0) * v2 / emission_rate_for<T0, T1>(arg0);
        if (arg0.emission_end_timestamp_ms < v3) {
            arg0.emission_end_timestamp_ms = v3;
        };
        0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::events::emit_added_reward_event<T1>(0x2::object::id<AfterburnerVault<T0>>(arg0), v1);
    }
    ...
    public fun calc_emitted_rewards<T0>(arg0: &AfterburnerVault<T0>) : vector<u64> {
        ...
        while (v2 < 0x1::vector::length<0x1::ascii::String>(&v1)) {
            0x1::vector::push_back<u64>(&mut v0, calc_rewards_emitted_from_time_tm_to_tn_<T0>(arg0, *0x1::vector::borrow<u64>(&arg0.emission_start_timestamps_ms, v2), *0x1::vector::borrow<u64>(&arg0.last_reward_timestamps_ms, v2), v2));
            v2 = v2 + 1;
        };
        v0
    }
    ...
    public fun calc_emitted_rewards_for<T0, T1>(arg0: &AfterburnerVault<T0>) : u64 {
        ...
        calc_rewards_emitted_from_time_tm_to_tn_<T0>(arg0, *0x1::vector::borrow<u64>(&arg0.emission_start_timestamps_ms, v0), *0x1::vector::borrow<u64>(&arg0.last_reward_timestamps_ms, v0), v0)
    }
    ...
    fun calc_rewards_to_emit_<T0>(arg0: &AfterburnerVault<T0>, arg1: &0x2::clock::Clock, arg2: u64) : u64 {
        let v0 = *0x1::vector::borrow<u64>(&arg0.last_reward_timestamps_ms, arg2);
        let v1 = calc_rewards_emitted_from_time_tm_to_tn_<T0>(arg0, *0x1::vector::borrow<u64>(&arg0.emission_start_timestamps_ms, arg2), v0, arg2);
        let v2 = *0x1::vector::borrow<u64>(&arg0.rewards, arg2);
        let v3 = if (v1 < v2) {
            v2 - v1
        } else {
            0
        };
        0x2::math::min(v3, calc_rewards_emitted_from_time_tm_to_tn_<T0>(arg0, v0, 0x2::clock::timestamp_ms(arg1), arg2))
    }
    ...
    public fun increase_emissions_for<T0, T1>(arg0: &OwnerCap, arg1: &mut AfterburnerVault<T0>, arg2: u64, arg3: u64) {
        ...
        *0x1::vector::borrow_mut<u64>(&mut arg1.emission_schedules_ms, v0) = arg2;
        *0x1::vector::borrow_mut<u64>(&mut arg1.emission_rates, v0) = arg3;
        arg1.emission_end_timestamp_ms = calc_emission_end_timestamp_ms<T0>(arg1);
        0x4f0a1a923dd063757fd37e04a9c2cee8980008e94433c9075c390065f98e9e4b::events::emit_increased_emissions_event<T1>(0x2::object::id<AfterburnerVault<T0>>(arg1), arg2, arg3);
    }
