module 0x3d3abb1370f0f72c04cfa97f43959553bf3a37f33a26b27c369b8eef2536a2b4::utils {
    public fun are_coins_suitable<T0, T1>() : bool {
        assert!(0x1::type_name::get<T0>() != 0x1::type_name::get<T1>(), 0x3d3abb1370f0f72c04cfa97f43959553bf3a37f33a26b27c369b8eef2536a2b4::errors::select_different_coins());
        true
    }
    ...
    public fun assert_coin_integrity<T0, T1, T2>(arg0: &0x2::coin::TreasuryCap<T0>, arg1: &0x2::coin::CoinMetadata<T0>, arg2: &0x2::coin::TreasuryCap<T2>, arg3: &0x2::coin::CoinMetadata<T2>) {
        ...
        assert!(0x1::type_name::get<T1>() == 0x1::type_name::get<0x2::sui::SUI>(), 0x3d3abb1370f0f72c04cfa97f43959553bf3a37f33a26b27c369b8eef2536a2b4::errors::invalid_quote_token());
    ...
    public fun assert_coin_integrity_tm<T0>(arg0: &0x2::coin::TreasuryCap<T0>, arg1: &0x2::coin::CoinMetadata<T0>) {
        assert!(0x2::coin::get_decimals<T0>(arg1) == 6, 0x3d3abb1370f0f72c04cfa97f43959553bf3a37f33a26b27c369b8eef2536a2b4::errors::meme_and_ticket_coins_must_have_6_decimals());
        assert!(0x2::coin::total_supply<T0>(arg0) == 0, 0x3d3abb1370f0f72c04cfa97f43959553bf3a37f33a26b27c369b8eef2536a2b4::errors::should_have_0_total_supply());
    }

    public fun assert_ticket_coin_integrity<T0, T1, T2>(arg0: &0x2::coin::CoinMetadata<T0>) {
        assert!(0x2::coin::get_decimals<T0>(arg0) == 6, 0x3d3abb1370f0f72c04cfa97f43959553bf3a37f33a26b27c369b8eef2536a2b4::errors::meme_and_ticket_coins_must_have_6_decimals());
    ...
    fun assert_ticket_coin_otw<T0, T1, T2>() {
        ...
        assert!(0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::comparator::eq(&v5), 0x3d3abb1370f0f72c04cfa97f43959553bf3a37f33a26b27c369b8eef2536a2b4::errors::wrong_module_name());
    }
