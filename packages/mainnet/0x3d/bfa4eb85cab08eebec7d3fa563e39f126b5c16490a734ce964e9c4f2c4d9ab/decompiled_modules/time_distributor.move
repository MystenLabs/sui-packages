module 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_distributor {
    ...
    struct TimeDistributor<phantom T0, T1: copy> has store {
        tlb: 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::TimeLockedBalance<T0>,
    ...
    public fun change_unlock_per_second<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) {
        ...
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.tlb, arg1, arg2);
    }

    public fun change_unlock_start_ts_sec<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) {
        update<T0, T1>(arg0, arg2);
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::change_unlock_start_ts_sec<T0>(&mut arg0.tlb, arg1, arg2);
    }
    ...
    public fun create<T0, T1: copy>(arg0: 0x2::balance::Balance<T0>, arg1: u64) : TimeDistributor<T0, T1> {
        TimeDistributor<T0, T1>{
            tlb              : 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::create<T0>(arg0, arg1, 0),
    ...
    public fun extraneous_locked_amount<T0, T1: copy>(arg0: &TimeDistributor<T0, T1>) : u64 {
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::extraneous_locked_amount<T0>(&arg0.tlb)
    }

    public fun final_unlock_ts_sec<T0, T1: copy>(arg0: &TimeDistributor<T0, T1>) : u64 {
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::final_unlock_ts_sec<T0>(&arg0.tlb)
    }

    fun member_unlock<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::math::max(arg0.update_ts_sec, 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::unlock_start_ts_sec<T0>(&arg0.tlb));
        let v1 = 0x2::math::min(0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::final_unlock_ts_sec<T0>(&arg0.tlb), 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::primitives_util::timestamp_sec(arg2));
        let (_, v3) = 0x2::vec_map::get_entry_by_idx_mut<T1, Member<T0>>(&mut arg0.members, arg1);
        if (v0 < v1) {
            let v4 = muldiv((v1 - v0) * 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::unlock_per_second<T0>(&arg0.tlb), (v3.weight as u64), (arg0.total_weight as u64)) - v3.unlocked_since_update;
    ...
    public fun member_withdraw_all_by_idx<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        0x2::balance::join<T0>(&mut arg0.unlocked_balance, 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::withdraw_all<T0>(&mut arg0.tlb, arg2));
    ...
    public fun remove_member_by_idx<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>, arg1: u64, arg2: &0x2::clock::Clock) : (T1, 0x2::balance::Balance<T0>) {
        ...
        if (arg0.total_weight == 0) {
            0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.tlb, 0, arg2);
        };
        (v0, v3)
    }

    public fun skim_extraneous_balance<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>) : 0x2::balance::Balance<T0> {
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.tlb)
    }

    public fun top_up<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: &0x2::clock::Clock) {
        if (0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::primitives_util::timestamp_sec(arg2) > 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::final_unlock_ts_sec<T0>(&arg0.tlb)) {
            update<T0, T1>(arg0, arg2);
        };
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::top_up<T0>(&mut arg0.tlb, arg1, arg2);
    }

    public fun unlock_per_second<T0, T1: copy>(arg0: &TimeDistributor<T0, T1>) : u64 {
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::unlock_per_second<T0>(&arg0.tlb)
    }

    public fun unlock_start_ts_sec<T0, T1: copy>(arg0: &TimeDistributor<T0, T1>) : u64 {
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::unlock_start_ts_sec<T0>(&arg0.tlb)
    }

    fun update<T0, T1: copy>(arg0: &mut TimeDistributor<T0, T1>, arg1: &0x2::clock::Clock) {
        let v0 = 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::primitives_util::timestamp_sec(arg1);
        if (arg0.update_ts_sec == v0) {
            return
        };
        0x2::balance::join<T0>(&mut arg0.unlocked_balance, 0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::withdraw_all<T0>(&mut arg0.tlb, arg1));
        let v1 = 0;
        ...
        0x3dbfa4eb85cab08eebec7d3fa563e39f126b5c16490a734ce964e9c4f2c4d9ab::time_locked_balance::top_up<T0>(&mut arg0.tlb, 0x2::balance::split<T0>(&mut arg0.unlocked_balance, 0x2::balance::value<T0>(&arg0.unlocked_balance)), arg1);
