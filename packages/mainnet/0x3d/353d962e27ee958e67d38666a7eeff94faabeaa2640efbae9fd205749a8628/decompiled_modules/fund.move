module 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund {
    ...
    fun assert_if_init_value_not_enough<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: u64, arg2: &0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(arg2) >= arg1 * 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::trader_init_percentage(arg0) / 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::base_percentage(arg0), 17);
    }
    ...
    fun assert_if_over_max_trader_fee(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: u64) {
        assert!(0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::max_trader_fee(arg0) >= arg1, 0);
    }
    ...
    fun assert_if_trader_not_matched<T0>(arg0: &Fund<T0>, arg1: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader) {
        assert!(0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::id(arg1) == arg0.trader, 9);
    }
    ...
    public fun claim<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        assert_if_not_settle<T0>(arg1);
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::burn<T0>(arg0, 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.time.end_time), arg2);
        if (arg1.after_amount < arg1.base) {
            let v1 = arg1.after_amount * 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::invest_amount(&arg2) / arg1.share_amount;
            let v2 = Claimed<T0>{
        ...
        } else if (arg1.after_amount - arg1.base >= 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::min_rewards(arg0)) {
            let v3 = (arg1.after_amount - (arg1.after_amount - arg1.base) * 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::platform_fee(arg0) / 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::base_percentage(arg0) - (arg1.after_amount - arg1.base) * arg1.trader_fee / 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::base_percentage(arg0)) * 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::invest_amount(&arg2) / arg1.share_amount;
            let v4 = Claimed<T0>{
                receiver : 0x2::tx_context::sender(arg3),
                amount   : v3,
            };
            ...
            let v5 = arg1.base * 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::invest_amount(&arg2) / arg1.share_amount;
            let v6 = Claimed<T0>{
                receiver : 0x2::tx_context::sender(arg3),
                amount   : v5,
            };
    ...
    public fun create<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader, arg5: u64, arg6: bool, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: 0x2::coin::Coin<T0>, arg13: &mut 0x2::tx_context::TxContext) : (Fund<T0>, 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::MintRequest<T0>) {
        ...
        let v6 = Fund<T0>{
            ...
            description  : arg2,
            fund_img     : arg3,
            trader       : 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::id(arg4),
            trader_fee   : arg5,
            asset        : v4,
            base         : v0,
            time         : v5,
        ...
        (v6, 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::create_mint_request<T0>(arg0, *0x2::object::uid_as_inner(&v6.id), v6.trader, v8, v0, v6.time.end_time))
    }

    public fun create_settle_request<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: bool, arg3: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare, arg4: &0x2::tx_context::TxContext) : SettleRequest {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        SettleRequest{
    ...
    public fun deinvest<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: vector<0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        assert_if_over_invest_duration<T0>(arg1, arg4);
        assert_if_not_arrived_invest_duration<T0>(arg1, arg4);
        let v0 = 0x1::vector::pop_back<0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare>(&mut arg2);
        arg1.share_amount = arg1.share_amount - 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::invest_amount(&v0);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare>(&arg2) - 1) {
            0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::join(&mut v0, 0x1::vector::pop_back<0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare>(&mut arg2));
            v1 = v1 + 1;
        };
        let v2 = 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::split(&mut v0, arg3, arg5);
        if (0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::invest_amount(&v0) == 0) {
            0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::burn<T0>(arg0, 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.time.end_time), v0);
        } else {
            0x2::transfer::public_transfer<0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare>(v0, 0x2::tx_context::sender(arg5));
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.asset.assets, 0x1::type_name::get<0x2::balance::Balance<T0>>()), 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::invest_amount(&v2)), arg5), 0x2::tx_context::sender(arg5));
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::burn<T0>(arg0, 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::create_burn_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.time.end_time), v2);
        0x1::vector::destroy_empty<0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::FundShare>(arg2);
    }
    ...
    public fun finish_settle_request(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut SettleRequest) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun invest<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock) : 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::MintRequest<T0> {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        ...
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::fund_share::create_mint_request<T0>(arg0, *0x2::object::uid_as_inner(&arg1.id), arg1.trader, v1, v0, arg1.time.end_time)
    }
    ...
    fun pay_platforem_fee<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.asset.assets, 0x1::type_name::get<0x2::balance::Balance<T0>>()), arg2), arg3), 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::platform(arg0));
    }
    ...
    public fun put_1_liquidity_for_1_liquidity_by_all<T0, T1, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>, arg3: 0x2::balance::Balance<T1>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_liquidity_for_1_nonliquidity_by_all<T0, T1: store, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>, arg3: T1) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_liquidity_for_2_liquidity_by_all<T0, T1, T2, T3>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T2>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun put_1_nonliquidity_for_2_liquidity_by_all<T0: store, T1, T2, T3>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>, arg3: 0x2::balance::Balance<T1>, arg4: 0x2::balance::Balance<T2>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun settle<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: SettleRequest, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        ...
        let v6 = arg1.base;
        let v7 = v6 * arg1.expected_roi / 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::base_percentage(arg0);
        arg1.after_amount = v5;
        if (v5 > v6) {
            if (arg1.base < 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::min_rewards(arg0)) {
                ...
                let v11 = v5 - v6;
                let v12 = v11 * 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::platform_fee(arg0) / 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::base_percentage(arg0);
                let v13 = 0x2::balance::split<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg1.asset.assets, 0x1::type_name::get<0x2::balance::Balance<T0>>()), (v11 - v12) * 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::settle_percentage(arg0) / 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::base_percentage(arg0));
    ...
    public fun settle_1_liquidity_for_1_liquidity<T0, T1, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>, arg3: 0x2::balance::Balance<T1>, arg4: SettleRequest, arg5: bool) : SettleRequest {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        put_1_liquidity_for_1_liquidity<T0, T1, T2>(arg1, arg2, arg3);
    ...
    public fun settle_1_liquidity_for_1_nonliquidity<T0, T1: store, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>, arg3: T1, arg4: SettleRequest, arg5: bool) : SettleRequest {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        put_1_liquidity_for_1_nonliquidity<T0, T1, T2>(arg1, arg2, arg3);
        arg4.is_finished = arg5;
        arg4
    ...
    public fun take_1_liquidity_for_1_liquidity_by_trader<T0, T1, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T2>(arg1, arg2);
        take_1_liquidity_for_1_liquidity<T0, T1, T2>(arg1, arg3, arg4)
    }

    public fun take_1_liquidity_for_1_liquidity_over_end_time<T0, T1, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_Liquidity_Request<T0, T1>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun take_1_liquidity_for_1_nonliquidity_by_trader<T0, T1: store, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T2>(arg1, arg2);
        take_1_liquidity_for_1_nonliquidity<T0, T1, T2>(arg1, arg3, arg4)
    }

    public fun take_1_liquidity_for_1_nonliquidity_over_end_time<T0, T1: store, T2>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T2>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_1_NonLiquidity_Request<T0, T1>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        assert_if_in_end_time<T2>(arg1, arg3);
    ...
    public fun take_1_liquidity_for_2_liquidity_by_trader<T0, T1, T2, T3>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader, arg3: u64, arg4: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T3>(arg1, arg2);
        take_1_liquidity_for_2_liquidity<T0, T1, T2, T3>(arg1, arg3, arg4)
    }

    public fun take_1_liquidity_for_2_liquidity_over_end_time<T0, T1, T2, T3>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: u64, arg3: &0x2::clock::Clock) : (0x2::balance::Balance<T0>, Take_1_Liquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun take_1_nonliquidity_for_2_liquidity_by_trader<T0: store, T1, T2, T3>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader, arg3: &0x2::clock::Clock) : (T0, Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
        assert_if_trader_not_matched<T3>(arg1, arg2);
        take_1_nonliquidity_for_2_liquidity<T0, T1, T2, T3>(arg1, arg3)
    }

    public fun take_1_nonliquidity_for_2_liquidity_over_end_time<T0: store, T1, T2, T3>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T3>, arg2: &0x2::clock::Clock) : (T0, Take_1_NonLiquidity_For_2_Liquidity_Request<T0, T1, T2>) {
        0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::assert_if_version_not_matched(arg0, 1);
    ...
    public fun trader_claim<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::GlobalConfig, arg1: &mut Fund<T0>, arg2: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_if_trader_not_matched<T0>(arg1, arg2);
        assert_if_not_settle<T0>(arg1);
        if (arg1.after_amount >= arg1.base) {
            if (arg1.after_amount - arg1.base >= 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::min_rewards(arg0)) {
                let v1 = (arg1.after_amount - arg1.base) * arg1.trader_fee / 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::base_percentage(arg0);
                let v2 = TraderClaimed<T0>{
                    trader   : 0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::id(arg2),
                    receiver : 0x2::tx_context::sender(arg3),
                    amount   : v1,
                };
    ...
    public(friend) fun update_description<T0>(arg0: &mut Fund<T0>, arg1: 0x1::string::String, arg2: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::trader::Trader) {
    ...
    public entry fun withdraw<T0>(arg0: &0x3d353d962e27ee958e67d38666a7eeff94faabeaa2640efbae9fd205749a8628::config::AdminCap, arg1: &mut Fund<T0>, arg2: &mut 0x2::tx_context::TxContext) {
