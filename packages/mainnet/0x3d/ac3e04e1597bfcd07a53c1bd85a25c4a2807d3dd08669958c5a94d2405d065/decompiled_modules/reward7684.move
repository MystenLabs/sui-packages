module 0x3dac3e04e1597bfcd07a53c1bd85a25c4a2807d3dd08669958c5a94d2405d065::reward7684 {
    struct REWARD7684 has drop {
        dummy_field: bool,
    }

    struct TICKET_7684 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7684(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7684>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7684>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7684, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7684>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7684>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7684>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7684>>(v5, 0x2::tx_context::sender(arg1));
    }
