module 0x3d400b83e506dd20e4b4bfaec353dd23d27d3a168a466b304bf057dadb228558::cnsnft2955 {
    struct CNSNFT2955 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2955, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2955>(arg0, arg1);
