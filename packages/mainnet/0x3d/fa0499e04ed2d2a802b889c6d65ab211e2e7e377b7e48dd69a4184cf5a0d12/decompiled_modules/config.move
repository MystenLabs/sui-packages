module 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::config {
    ...
    public fun assert_active(arg0: &LotusConfig, arg1: u64) {
        assert!(arg1 == arg0.version, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::wrong_version());
        assert!(1 == arg0.version, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::wrong_version());
        assert!(arg0.status == 0, status_error_code(arg0.status));
    }

    public fun assert_admin(arg0: &LotusConfig, arg1: &ProtocolAdminCap) {
        assert!(arg1.config_id == 0x2::object::uid_to_inner(&arg0.id), 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::cap_vault_mismatch());
        let v0 = 0x2::object::id<ProtocolAdminCap>(arg1);
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_caps, &v0), 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::cap_revoked());
    }

    public fun assert_designated_oracle<T0, T1>(arg0: &LotusConfig, arg1: 0x2::object::ID) {
        let v0 = OracleFor<T0, T1>{dummy_field: false};
        assert!(0x2::dynamic_field::exists_<OracleFor<T0, T1>>(&arg0.id, v0), 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::oracle_not_designated());
        assert!(*0x2::dynamic_field::borrow<OracleFor<T0, T1>, 0x2::object::ID>(&arg0.id, v0) == arg1, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::oracle_not_designated());
    }
    ...
    public fun assert_not_paused(arg0: &LotusConfig, arg1: u64) {
        assert!(arg1 == arg0.version, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::wrong_version());
        assert!(1 == arg0.version, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::wrong_version());
        assert!(arg0.status != 2, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::protocol_paused());
    }
    ...
    public fun bump_version(arg0: &mut LotusConfig, arg1: &ProtocolUpgradeCap, arg2: u64) {
        ...
        assert!(arg2 > arg0.version, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::wrong_version());
        arg0.version = arg2;
        0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::events::emit_version_updated(0x2::object::uid_to_inner(&arg0.id), arg0.version, arg2);
    }
    ...
    public fun clear_oracle_for_pair<T0, T1>(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u64) {
        ...
        if (0x2::dynamic_field::exists_<OracleFor<T0, T1>>(&arg0.id, v0)) {
            0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::events::emit_oracle_designated(0x2::object::uid_to_inner(&arg0.id), 0x1::option::some<0x2::object::ID>(0x2::dynamic_field::remove<OracleFor<T0, T1>, 0x2::object::ID>(&mut arg0.id, v0)), 0x2::object::id_from_address(@0x0));
        };
    }
    ...
    fun do_revoke(arg0: &mut LotusConfig, arg1: 0x2::object::ID, arg2: u8) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_caps, &arg1), 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::cap_not_in_allowlist());
        0x2::vec_set::remove<0x2::object::ID>(&mut arg0.allowed_caps, &arg1);
        0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::events::emit_protocol_cap_revoked(0x2::object::uid_to_inner(&arg0.id), arg1, arg2);
    }
    ...
    public fun enable_dex(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u8) {
        ...
        assert!(v0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::unknown_dex());
        if (!0x2::vec_set::contains<u8>(&arg0.allowed_dex, &arg2)) {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::events::emit_initialized(v1, 0x2::tx_context::sender(arg0), v12.version);
    ...
    public fun set_buy_fee_caps(arg0: &mut LotusConfig, arg1: &ProtocolFeeCap, arg2: u64, arg3: u64, arg4: u64) {
        ...
        assert!(arg3 <= 10000, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_fee_bps());
        assert!(arg4 > 0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_period_ms());
    ...
    public fun set_oracle_config(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64) {
        assert_admin(arg0, arg1);
        assert!(arg2 > 0 && arg3 > 0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_oracle_param());
        assert!(arg4 > 0 && arg7 > 0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_oracle_param());
        assert!(arg5 > 0 && arg5 <= 10000, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_oracle_param());
        assert!(arg6 > 0 && arg6 <= 10000, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_oracle_param());
        assert!(arg8 <= 10000, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_oracle_param());
        let v0 = OracleConfig{
    ...
    public fun set_oracle_for_pair<T0, T1>(arg0: &mut LotusConfig, arg1: &ProtocolAdminCap, arg2: u64, arg3: 0x2::object::ID) {
        ...
        0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::events::emit_oracle_designated(0x2::object::uid_to_inner(&arg0.id), v1, arg3);
    }
    ...
    public fun set_risk_config(arg0: &mut LotusConfig, arg1: &ProtocolRiskCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        ...
        assert!(arg4 > 0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_risk_param());
        assert!(arg6 > 0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_risk_param());
        assert!(arg7 > 0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_risk_param());
        let v0 = RiskConfig{
    ...
    public fun set_status(arg0: &mut LotusConfig, arg1: &ProtocolPauseCap, arg2: u8) {
        ...
        assert!(v0, 0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::bad_risk_param());
        arg0.status = arg2;
        0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::events::emit_status_changed(0x2::object::uid_to_inner(&arg0.id), arg0.status, arg2);
    }
    ...
    fun status_error_code(arg0: u8) : u64 {
        if (arg0 == 2) {
            0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::protocol_paused()
        } else if (arg0 == 1) {
            0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::protocol_frozen()
        } else {
            0xc34002e41317989305d3d522421289152d9399209b8efd63103b947718cf1c1f::errors::protocol_paused()
        }
    }
