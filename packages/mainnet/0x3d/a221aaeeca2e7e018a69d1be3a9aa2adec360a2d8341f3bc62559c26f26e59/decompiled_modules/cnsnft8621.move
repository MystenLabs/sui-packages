module 0x3da221aaeeca2e7e018a69d1be3a9aa2adec360a2d8341f3bc62559c26f26e59::cnsnft8621 {
    struct CNSNFT8621 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8621, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8621>(arg0, arg1);
