module 0xc48667e60b29c84063d55e53cf3c25d1e161de0c72fdc537cacda835340d58a3::atomic_flash {
    ...
    fun finish<T0, T1>(arg0: &mut 0xc48667e60b29c84063d55e53cf3c25d1e161de0c72fdc537cacda835340d58a3::atomic_vault::LiquidationVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>, arg4: u64, arg5: u64, arg6: u64, arg7: u8) {
        ...
        let v1 = arg4 - v0;
        assert!(v1 >= arg5, 13906836089898795007);
    ...
    fun finish_redeemed_lst<T0, T1>(arg0: &mut 0xc48667e60b29c84063d55e53cf3c25d1e161de0c72fdc537cacda835340d58a3::atomic_vault::LiquidationVault, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<0x2::sui::SUI>, arg4: u64, arg5: u64, arg6: u64, arg7: u64) {
        let v0 = 0x2::balance::value<T0>(&arg2);
        let v1 = arg4 - v0;
        assert!(v1 >= arg5, 13906836231632715775);
        0xc48667e60b29c84063d55e53cf3c25d1e161de0c72fdc537cacda835340d58a3::atomic_vault::deposit_balance<T0>(arg0, arg2);
    ...
    public fun try_lst_two_ba_ab_stored<T0, T1, T2, T3: drop>(arg0: &mut 0xc48667e60b29c84063d55e53cf3c25d1e161de0c72fdc537cacda835340d58a3::atomic_vault::LiquidationVault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, 0x2::sui::SUI>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T2>, arg5: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T3>, arg6: &mut 0x3::sui_system::SuiSystemState, arg7: 0x2::object::ID, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u128, arg13: u128, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) : bool {
        ...
        if (!0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::obligation::is_liquidatable<T0>(0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::obligation<T0>(arg1, arg7))) {
            emit_noop<T2, T3>(arg0, arg7);
            return false
        };
        let (v0, v1, v2) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T1, T2>(arg2, arg4, true, false, arg10, arg13, arg15);
        let v3 = v2;
        let (v4, v5, v6) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T1, 0x2::sui::SUI>(arg2, arg3, false, false, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, T2>(&v3), arg12, arg15);
        let v7 = v6;
        let v8 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T1, 0x2::sui::SUI>(&v7);
        let v9 = 0x2::coin::from_balance<T2>(v1, arg16);
        let v10 = &mut v9;
        let v11 = liquidate<T0, T2, T3>(arg1, v10, arg7, arg8, arg9, arg15, arg16);
        let v12 = 0x2::coin::into_balance<0x2::sui::SUI>(0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::redeem<T3>(arg5, v11, arg6, arg16));
        0x2::balance::join<0x2::sui::SUI>(&mut v12, v5);
        require_profit<0x2::sui::SUI>(&v12, v8, arg14);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T1, 0x2::sui::SUI>(arg2, arg3, 0x2::balance::zero<T1>(), 0x2::balance::split<0x2::sui::SUI>(&mut v12, v8), v7);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T1, T2>(arg2, arg4, v4, 0x2::balance::zero<T2>(), v3);
        0x2::balance::destroy_zero<T1>(v0);
        finish_redeemed_lst<T2, T3>(arg0, arg7, 0x2::coin::into_balance<T2>(v9), v12, arg10, arg11, 0x2::coin::value<T3>(&v11), v8);
        true
    }
    ...
    public fun try_two_ba_ab<T0, T1, T2, T3>(arg0: &mut 0xc48667e60b29c84063d55e53cf3c25d1e161de0c72fdc537cacda835340d58a3::atomic_vault::LiquidationVault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T3>, arg5: 0x2::object::ID, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u128, arg11: u128, arg12: u64, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) : bool {
        0xc48667e60b29c84063d55e53cf3c25d1e161de0c72fdc537cacda835340d58a3::atomic_vault::assert_authorized(arg0, arg14);
        assert!(arg10 > 0 && arg11 > 0, 0);
        let v0 = prepare<T0>(arg1, arg5, arg13);
        if (!v0) {
        ...
        let (v1, v2, v3) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T2, T3>(arg2, arg4, true, false, arg8, arg11, arg13);
        let v4 = v3;
        let (v5, v6, v7) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T2, T1>(arg2, arg3, false, false, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T2, T3>(&v4), arg10, arg13);
        let v8 = v7;
        let v9 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T2, T1>(&v8);
        let v10 = 0x2::coin::from_balance<T3>(v2, arg14);
        let v11 = &mut v10;
        let v12 = 0x2::coin::into_balance<T1>(liquidate<T0, T3, T1>(arg1, v11, arg5, arg6, arg7, arg13, arg14));
        0x2::balance::join<T1>(&mut v12, v6);
        require_profit<T1>(&v12, v9, arg12);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T2, T1>(arg2, arg3, 0x2::balance::zero<T2>(), 0x2::balance::split<T1>(&mut v12, v9), v8);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T2, T3>(arg2, arg4, v5, 0x2::balance::zero<T3>(), v4);
