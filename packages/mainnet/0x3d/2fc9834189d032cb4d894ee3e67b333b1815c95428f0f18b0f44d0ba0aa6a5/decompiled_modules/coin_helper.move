module 0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::coin_helper {
    fun cmp_type_names(arg0: &0x1::type_name::TypeName, arg1: &0x1::type_name::TypeName) : u8 {
        ...
        let v4 = 0;
        while (v4 < 0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::min_u64(v2, v3)) {
    ...
    public fun process_coin_balances_processing_for_swap<T0, T1>(arg0: &mut 0x2::balance::Balance<T0>, arg1: &mut 0x2::balance::Balance<T0>, arg2: u64, arg3: &mut 0x2::balance::Balance<T1>, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: u64, arg7: u64) : (0x2::balance::Balance<T1>, u64) {
        ...
        let v2 = 0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::math::mul_div(arg6, arg7, 100);
        0x2::balance::join<T1>(arg3, v1);
        (0x2::balance::split<T1>(&mut v1, v2), v2)
    }

    public fun valid_curved_coins_2_pool<T0, T1>(arg0: &0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::config::Config) : bool {
        if (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::config::is_stable_identifier<T0>(arg0)) {
            return true
        };
        is_sorted<T0, T1>()
    }

    public fun valid_curved_coins_3_pool<T0, T1, T2>(arg0: &0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::config::Config) : bool {
        if (0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::config::is_stable_identifier<T0>(arg0)) {
            return is_sorted<T1, T2>()
        };
        assert!(!0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::config::is_stable_identifier<T1>(arg0) && !0x3d2fc9834189d032cb4d894ee3e67b333b1815c95428f0f18b0f44d0ba0aa6a5::config::is_stable_identifier<T2>(arg0), 3002);
