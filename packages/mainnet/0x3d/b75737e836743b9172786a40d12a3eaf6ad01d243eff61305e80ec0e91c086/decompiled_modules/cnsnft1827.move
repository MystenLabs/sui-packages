module 0x3db75737e836743b9172786a40d12a3eaf6ad01d243eff61305e80ec0e91c086::cnsnft1827 {
    struct CNSNFT1827 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1827, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1827>(arg0, arg1);
