module 0x3d1b9784842ed9ab6560ed4e065bbbae993652f9433b704d4a050f3f9390caa3::cnsnft2909 {
    struct CNSNFT2909 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2909, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2909>(arg0, arg1);
