module 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool {
    ...
    public fun create_pool<T0>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::admin::ProtocolAdminCap, arg1: &mut GlobalConfig, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v3 = NetBaseFeeMultiplierKey{dummy_field: false};
        0x2::dynamic_field::add<NetBaseFeeMultiplierKey, u64>(&mut v2.id, v3, 1000);
        let v4 = PoolCreated{
    ...
    fun get_pool_liquidity_for_fee_calculation<T0>(arg0: &LiquidityPool<T0>) : (u64, u64) {
        (arg0.total_lp_shares / get_pool_net_base_fee_multiplier<T0>(arg0), 0x2::balance::value<T0>(&arg0.base_reserve))
    }

    fun get_pool_net_base_fee_multiplier<T0>(arg0: &LiquidityPool<T0>) : u64 {
        let v0 = NetBaseFeeMultiplierKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<NetBaseFeeMultiplierKey>(&arg0.id, v0)) {
            let v2 = NetBaseFeeMultiplierKey{dummy_field: false};
            *0x2::dynamic_field::borrow<NetBaseFeeMultiplierKey, u64>(&arg0.id, v2)
        } else {
            1000
        }
    }
    ...
    fun quote_limit<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u128, arg2: &QuoteAssetReserve<T1>) : u64 {
        ...
        0x1::u64::min((0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v0 as u128), arg1, 1000000000000000000) as u128), (0x1::option::get_with_default<u64>(&arg2.limit_ratio, arg0.limit_ratio) as u128), 100) as u64), 0x1::option::get_with_default<u64>(&arg2.limit_fixed, 18446744073709551615))
    }
    ...
    public fun update_net_base_fee_multiplier<T0>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        validate_pool_version<T0>(arg1);
        let v0 = NetBaseFeeMultiplierKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<NetBaseFeeMultiplierKey>(&arg1.id, v0)) {
            let v1 = NetBaseFeeMultiplierKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<NetBaseFeeMultiplierKey, u64>(&mut arg1.id, v1) = arg2;
        } else {
            let v2 = NetBaseFeeMultiplierKey{dummy_field: false};
            0x2::dynamic_field::add<NetBaseFeeMultiplierKey, u64>(&mut arg1.id, v2, arg2);
        };
        let v3 = NetBaseFeeMultiplierKeyUpdated{
            pool_id                     : 0x2::object::uid_to_inner(&arg1.id),
            new_net_base_fee_multiplier : arg2,
        };
        0x2::event::emit<NetBaseFeeMultiplierKeyUpdated>(v3);
    }

    public fun update_pool_version<T0>(arg0: &mut LiquidityPool<T0>) {
        assert!(arg0.version < 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version(), 4011);
        let v0 = NetBaseFeeMultiplierKey{dummy_field: false};
        0x2::dynamic_field::add<NetBaseFeeMultiplierKey, u64>(&mut arg0.id, v0, 1000);
        arg0.version = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version();
    }
