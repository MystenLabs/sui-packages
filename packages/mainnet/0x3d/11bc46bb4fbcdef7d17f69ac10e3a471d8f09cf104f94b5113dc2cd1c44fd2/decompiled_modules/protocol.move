module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol {
    ...
    public(friend) fun check_version(arg0: &ProtocolConfig) {
        assert!(arg0.version == 3, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::invalid_protocol_version());
    }
    ...
    public(friend) fun upgrade(arg0: &mut ProtocolConfig) {
        assert!(arg0.version + 1 == 3, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::invalid_protocol_version());
        arg0.version = 3;
    }
