module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::bank {
    ...
    entry fun deposit_v2<T0>(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &mut Bank<T0>, arg2: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::TxIndexer, arg3: address, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg4 > 0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::deposit_amount_must_be_greater_than_zero());
        assert!(arg4 <= v0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::coin_does_not_have_enough_amount());
    ...
    entry fun withdraw_all_v2<T0>(arg0: &0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::protocol::ProtocolConfig, arg1: &mut Bank<T0>, arg2: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::TxIndexer, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (0x2::table::contains<address, BankAccount>(v1, arg3)) {
            0x2::table::borrow<address, BankAccount>(v1, arg3).balance
        } else {
            0
        };
        ...
        let v4 = *v3 / 1000;
        let v5 = v4 * 1000;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.coin_balance, (v4 as u64), arg4), arg3);
        *v3 = *v3 - v5;
        let v6 = BankBalanceUpdateEvent{
            tx_index     : 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::increment_tx_index(arg2),
            action       : 1,
            src_address  : v0,
            dest_address : arg3,
            amount       : v5,
        ...
        0x2::event::emit<BankBalanceUpdateEvent>(v6);
    }
    ...
    public(friend) fun withdraw_internal<T0>(arg0: &mut Bank<T0>, arg1: &mut 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::sub_accounts::TxIndexer, arg2: address, arg3: address, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v0 = &mut arg0.accounts;
        assert!(0x2::table::contains<address, BankAccount>(v0, arg2), 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::user_has_no_bank_account());
        assert!(arg4 > 0, 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error::withdraw_amount_must_be_greater_than_zero());
        let v1 = 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::library::convert_usdc_to_base_decimals(arg4);
        let v2 = if (0x2::table::contains<address, BankAccount>(v0, arg3)) {
            0x2::table::borrow<address, BankAccount>(v0, arg3).balance
        } else {
            0
        };
        let v3 = &mut 0x2::table::borrow_mut<address, BankAccount>(v0, arg2).balance;
        ...
        *v3 = *v3 - v1;
        ...
        0x2::coin::take<T0>(&mut arg0.coin_balance, (arg4 as u64), arg5)
    }
