module 0x978fed071cca22dd26bec3cf4a5d5a00ab10f39cb8c659bbfdfbec4397241001::error {
    ...
    public(friend) fun insurance_active_account_can_only_have_reduce_only_orders() : u64 {
        118
    }
    ...
    public(friend) fun invalid_insurance_operator() : u64 {
        119
    }
    ...
    public(friend) fun max_oi_open_vector_too_short() : u64 {
        303
    }
