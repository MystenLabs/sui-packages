module 0x3d0b6d2feadcae05c7f368fc66d67fd386832391272f048a1a7656bd4363b3f4::nft {
    ...
    entry fun mint(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = Nft{
            ...
            name        : 0x1::string::utf8(b"lyanna95"),
            description : 0x1::string::utf8(b"lyanna95 NFT"),
            creator     : 0x2::tx_context::sender(arg1),
            url         : 0x2::url::new_unsafe_from_bytes(b"https://avatars.githubusercontent.com/u/172299107?v=4"),
        };
