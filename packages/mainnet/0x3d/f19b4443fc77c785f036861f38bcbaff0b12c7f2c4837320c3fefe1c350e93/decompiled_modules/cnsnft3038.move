module 0x3df19b4443fc77c785f036861f38bcbaff0b12c7f2c4837320c3fefe1c350e93::cnsnft3038 {
    struct CNSNFT3038 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3038, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3038>(arg0, arg1);
