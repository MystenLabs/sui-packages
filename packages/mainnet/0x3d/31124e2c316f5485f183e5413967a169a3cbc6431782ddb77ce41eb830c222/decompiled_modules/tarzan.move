module 0x3d31124e2c316f5485f183e5413967a169a3cbc6431782ddb77ce41eb830c222::tarzan {
    struct TARZAN has drop {
        dummy_field: bool,
    }

    public entry fun mint(arg0: &mut 0x2::coin::TreasuryCap<TARZAN>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<TARZAN>>(0x2::coin::mint<TARZAN>(arg0, arg2 * 1000000000, arg3), arg1);
    }
