module 0x3db1d2822d0c31d447c6924ae6bc2dcaf9ff78fac76a1dd6bad1b8454ed4fae9::ethy {
    ...
    fun init(arg0: ETHY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/u5mbunmbXziNeCA6?width=128&height=128&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<ETHY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ETHY    ")))), trim_right(b"Ethy AI                         "), trim_right(b"Ethy is the AI Trading Operator for onchain markets. Create, backtest, automate, and share strategies in plain English, tap into social trading from top creators and expert agents, and let your agent monitor markets and execute from your pocket.                                                                           "), v2, arg1);
        let v5 = v3;
