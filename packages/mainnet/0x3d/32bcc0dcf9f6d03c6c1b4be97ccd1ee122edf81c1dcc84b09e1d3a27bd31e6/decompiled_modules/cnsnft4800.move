module 0x3d32bcc0dcf9f6d03c6c1b4be97ccd1ee122edf81c1dcc84b09e1d3a27bd31e6::cnsnft4800 {
    struct CNSNFT4800 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4800, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4800>(arg0, arg1);
