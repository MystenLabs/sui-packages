module 0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::utils {
    ...
    public fun get_id_from_price(arg0: u128, arg1: u16) : 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::I32 {
        assert!(arg0 > 0, 13835902999903731719);
        if (arg0 == 1) {
            let v0 = 1180591620717411303424 / log2_q64(get_base(arg1));
            assert!(v0 <= 443636, 13835621563581595653);
        ...
        if (arg0 < 18446744073709551616) {
            ...
            assert!(v3 <= 340282366920938463463374607431768211455, 13835621628006105093);
            v2 = (v3 as u128);
            v1 = true;
        };
        let v4 = log2_q64(v2) / log2_q64(get_base(arg1));
        assert!(v4 <= 443636, 13835621670955778053);
        let v5 = if (!v1) {
            (v4 as u32)
        } else {
    ...
    fun log2_q64(arg0: u128) : u128 {
        assert!(arg0 >= 18446744073709551616, 13835340303353118723);
