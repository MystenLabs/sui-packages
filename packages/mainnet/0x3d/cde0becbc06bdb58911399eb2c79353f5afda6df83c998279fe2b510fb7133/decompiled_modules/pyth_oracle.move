module 0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::pyth_oracle {
    ...
    public fun get_price<T0>(arg0: &PythOracle, arg1: &0x2::clock::Clock) : Price {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, v0), 13837031828978991122);
        let v1 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, v0);
        assert!(0x2::clock::timestamp_ms(arg1) / 1000 == v1.last_update_time, 13837313321135702036);
        v1
    }
    ...
    public fun add_oracle_info_by_currency_pyth2<T0>(arg0: &mut PythOracle, arg1: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::config::GlobalConfig, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::state::State, arg3: &0x2::coin_registry::Currency<T0>, arg4: vector<u8>, arg5: u64, arg6: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::versioned::Versioned, arg7: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835622607258845192);
        assert!(arg5 > 0 && arg5 <= 600, 13837592936391704598);
    ...
    public fun add_oracle_info_pyth2<T0>(arg0: &mut PythOracle, arg1: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::config::GlobalConfig, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::state::State, arg3: &0x2::coin::CoinMetadata<T0>, arg4: vector<u8>, arg5: u64, arg6: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::versioned::Versioned, arg7: &0x2::tx_context::TxContext) {
        ...
        0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::config::check_oracle_manager_role(arg1, 0x2::tx_context::sender(arg7));
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(!0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835622332380938248);
        assert!(arg5 > 0 && arg5 <= 600, 13837592661513797654);
        let v1 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::state::get_price_info_object_id(arg2, arg4);
        let v2 = OracleInfo{
            price_feed_id        : arg4,
            price_info_object_id : v1,
    ...
    public fun calculate_oracle_prices_pyth2<T0, T1>(arg0: &PythOracle, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64) {
        ...
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904670646206474);
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v1), 13835904674941173770);
        ...
        assert!(v2.price_info_object_id == 0x2::object::id<0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject>(arg1), 13836186171392851980);
        assert!(v3.price_info_object_id == 0x2::object::id<0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject>(arg2), 13836186188572721164);
    ...
    public fun get_price_by_type(arg0: &PythOracle, arg1: 0x1::type_name::TypeName, arg2: &0x2::clock::Clock) : Price {
        assert!(0x2::table::contains<0x1::type_name::TypeName, Price>(&arg0.prices, arg1), 13837031932058206226);
        let v0 = *0x2::table::borrow<0x1::type_name::TypeName, Price>(&arg0.prices, arg1);
        assert!(0x2::clock::timestamp_ms(arg2) / 1000 == v0.last_update_time, 13837313424214917140);
        v0
    }
    ...
    public fun pyth_price_from_oracle_info_pyth2(arg0: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg1: &OracleInfo, arg2: &0x2::clock::Clock) : u64 {
        ...
        assert!(arg1.price_feed_id == 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_identifier::get_bytes(&v2), 13836468539722891278);
        ...
        assert!(!0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_is_negative(&v4), 13835061186313519108);
        let v5 = 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::i64::get_magnitude_if_positive(&v4);
        assert!(v5 != 0, 13836750044764504080);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_round(0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price::get_conf(&v0), 10000, v5) <= 500, 13837875961851740184);
    ...
    public fun remove_oracle_info<T0>(arg0: &mut PythOracle, arg1: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::config::GlobalConfig, arg2: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::versioned::Versioned, arg3: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904266919280650);
    ...
    public(friend) fun split_fee(arg0: &mut PythOracle, arg1: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.update_price_fee) >= arg1, 13835340578231222278);
    ...
    public fun update_price_age<T0>(arg0: &mut PythOracle, arg1: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::config::GlobalConfig, arg2: u64, arg3: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::versioned::Versioned, arg4: &0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835904438717972490);
        let v1 = 0x2::table::borrow_mut<0x1::type_name::TypeName, OracleInfo>(&mut arg0.oracle_infos, v0);
        assert!(v1.usd_price_age != arg2, 13837593301463924758);
        assert!(arg2 > 0 && arg2 <= 600, 13837593305758892054);
    ...
    fun update_price_from_type<T0>(arg0: &mut PythOracle, arg1: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : Price {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835905289121497098);
        let v1 = 0x2::table::borrow<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0);
        assert!(v1.price_info_object_id == 0x2::object::id<0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject>(arg1), 13836186781278208012);
        let v2 = Price{
    ...
    public fun update_price_into_pyth_oracle<T0>(arg0: &mut PythOracle, arg1: &mut 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::versioned::Versioned, arg4: &0x2::tx_context::TxContext) {
        abort 13838156878482833434
    }

    public fun update_price_into_pyth_oracle_pyth2<T0>(arg0: &mut PythOracle, arg1: &mut 0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg2: &0x2::clock::Clock, arg3: &0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::versioned::Versioned, arg4: &0x2::tx_context::TxContext) {
        0xa4f8ed601f3d742ba63230fecb59f87726203cf94129b74b922bf8a6b883e582::versioned::check_version(arg3);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, OracleInfo>(&arg0.oracle_infos, v0), 13835905130207707146);
