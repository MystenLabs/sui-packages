module 0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::global_config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::ACL,
        package_version: u64,
    ...
    public fun acl(arg0: &GlobalConfig) : &0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::Member> {
        0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u128) {
        checked_package_version(arg1);
        0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::set_roles(&mut arg1.acl, arg2, arg3);
    ...
    public fun check_dividend_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::has_role(&arg0.acl, arg1, 1), 2);
    }

    public fun check_dividend_settle_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::has_role(&arg0.acl, arg1, 2), 3);
    }

    public fun check_locking_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    public fun check_xturbos_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::has_role(&arg0.acl, arg1, 3), 4);
    }

    public fun checked_package_version(arg0: &GlobalConfig) {
        assert!(1 >= arg0.package_version, 5);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            ...
            acl              : 0x3d1a7e90b9c5eab428d73de62b84b7e215b24edea7d81e03238ccbb902a9cdf1::acl::new(arg0),
            package_version  : 1,
    ...
    public fun remove_extension_config(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg1);
        assert!(0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg1.extension_fields, &arg2), 6);
    ...
    public fun update_package_version(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: u64) {
        assert!(arg2 > arg1.package_version && arg2 <= 1, 5);
