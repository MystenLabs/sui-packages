module 0x3d5cddb60da2074d5d395f772f27a6acc139c3c7ac1cc563068512575ee125f9::cnsnft8102 {
    struct CNSNFT8102 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8102, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8102>(arg0, arg1);
