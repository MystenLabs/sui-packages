module 0x3d3e2506c9ad7420d55aeb376c9a3cd497573fe85c0149fe134a49feeb257c4f::the_captains {
    ...
    public fun admin_add_royalty_rule(arg0: &AdminCap, arg1: &mut 0x2::transfer_policy::TransferPolicy<PfpNFT>, arg2: &0x2::transfer_policy::TransferPolicyCap<PfpNFT>, arg3: u16, arg4: u64) {
        0x3d3e2506c9ad7420d55aeb376c9a3cd497573fe85c0149fe134a49feeb257c4f::fixed_royalty_rule::add<PfpNFT>(arg1, arg2, arg3, arg4);
    }
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = v13;
        let v15 = v12;
        0x3d3e2506c9ad7420d55aeb376c9a3cd497573fe85c0149fe134a49feeb257c4f::fixed_royalty_rule::add<PfpNFT>(&mut v15, &v14, 100, 10000000);
