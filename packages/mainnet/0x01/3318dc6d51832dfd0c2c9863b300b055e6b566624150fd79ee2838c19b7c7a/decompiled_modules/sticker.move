module 0x664d58be00187e024697aae7b004990e4bb2f655955813b560ed2650a3c7f47a::sticker {
    ...
    entry fun open_chest(arg0: &mut StickerCatalog, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x1::vector::length<StickerDesign>(&arg0.designs);
        let v4 = 0;
        while (v4 < v3) {
            if (v3 == v3) {
                let v5 = 0x1::vector::borrow<StickerDesign>(&arg0.designs, v4);
        ...
        assert!(v3 < v3, 1);
        let v6 = 0x1::vector::borrow_mut<StickerDesign>(&mut arg0.designs, v3);
        ...
        let v8 = StickerMinted{
            sticker_id : 0x2::object::uid_to_address(&v7.id),
            design_id  : v6.design_id,
            minter     : 0x2::tx_context::sender(arg2),
        };
        0x2::event::emit<StickerMinted>(v8);
        0x2::transfer::public_transfer<Sticker>(v7, 0x2::tx_context::sender(arg2));
    }
