module 0x1731f000c204bd8c1f55088f37a7f788718ca75ad4dfb4ef164a2bb398fc653::coin123 {
    ...
    fun init(arg0: COIN123, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<COIN123>(&mut v3, 333000000000, 0x2::tx_context::sender(arg1), arg1);
