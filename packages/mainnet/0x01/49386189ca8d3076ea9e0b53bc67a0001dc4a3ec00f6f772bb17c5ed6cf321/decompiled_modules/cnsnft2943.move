module 0x149386189ca8d3076ea9e0b53bc67a0001dc4a3ec00f6f772bb17c5ed6cf321::cnsnft2943 {
    struct CNSNFT2943 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2943, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2943>(arg0, arg1);
