module 0x1632726f5f8841d9b6bc67d8388618817b697f2bf2a4c78c2c0341ac1d5b509::cnsnft9031 {
    struct CNSNFT9031 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9031>(arg0, arg1);
