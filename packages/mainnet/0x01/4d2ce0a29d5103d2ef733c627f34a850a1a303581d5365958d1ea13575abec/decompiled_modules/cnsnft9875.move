module 0x14d2ce0a29d5103d2ef733c627f34a850a1a303581d5365958d1ea13575abec::cnsnft9875 {
    struct CNSNFT9875 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9875, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9875>(arg0, arg1);
