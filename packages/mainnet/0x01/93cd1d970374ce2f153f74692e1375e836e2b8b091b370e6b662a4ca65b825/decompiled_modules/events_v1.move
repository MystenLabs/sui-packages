module 0xc436a8ccc36e649e0fd8c7cec88ca89747b69ba5bdefb15be2f93ae1ae632800::events_v1 {
    ...
    public fun emit_guard_savings_allocation_set_event(arg0: 0x2::object::ID, arg1: 0x1::ascii::String, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = GuardSavingsAllocationSetEvent{
            vault_id       : arg0,
            type_name      : arg1,
            allocation_bps : arg2,
            total_staked   : arg3,
    ...
    public fun emit_guard_savings_deposit_enriched_event(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        ...
        0x2::event::emit<GuardSavingsDepositEnrichedEvent>(v0);
    }

    public fun emit_guard_savings_deposited_event(arg0: address, arg1: u64, arg2: 0x2::object::ID) {
        let v0 = GuardSavingsDepositedEvent{
            user        : arg0,
            dori_amount : arg1,
            pool_id     : arg2,
        };
        0x2::event::emit<GuardSavingsDepositedEvent>(v0);
    }

    public fun emit_guard_savings_dori_restaked_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64) {
        let v0 = GuardSavingsDoriRestakedEvent{
            pool_id          : arg0,
            amount           : arg1,
            new_total_staked : arg2,
        };
        0x2::event::emit<GuardSavingsDoriRestakedEvent>(v0);
    }

    public fun emit_guard_savings_gdori_burned_event(arg0: address, arg1: u64, arg2: u64) {
        let v0 = GuardSavingsGdoriBurnedEvent{
            user          : arg0,
            gdori_burned  : arg1,
            dori_entitled : arg2,
        };
        0x2::event::emit<GuardSavingsGdoriBurnedEvent>(v0);
    }

    public fun emit_guard_savings_gdori_minted_event(arg0: address, arg1: u64, arg2: u64) {
        let v0 = GuardSavingsGdoriMintedEvent{
            user                 : arg0,
            gdori_minted         : arg1,
            total_dori_deposited : arg2,
        };
        0x2::event::emit<GuardSavingsGdoriMintedEvent>(v0);
    }

    public fun emit_guard_savings_liquidation_notified_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = GuardSavingsLiquidationNotifiedEvent{
            pool_id  : arg0,
            vault_id : arg1,
        };
        0x2::event::emit<GuardSavingsLiquidationNotifiedEvent>(v0);
    }
    ...
    public fun emit_guard_savings_pool_registered_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x1::ascii::String, arg3: u64, arg4: vector<0x2::object::ID>, arg5: u64) {
        let v0 = GuardSavingsPoolRegisteredEvent{
            vault_id     : arg0,
            pool_id      : arg1,
            type_name    : arg2,
            pool_balance : arg3,
        ...
        0x2::event::emit<GuardSavingsPoolRegisteredEvent>(v0);
    }

    public fun emit_guard_savings_settlement_completed_event(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = GuardSavingsSettlementCompletedEvent{
            pool_id  : arg0,
            vault_id : arg1,
        };
        0x2::event::emit<GuardSavingsSettlementCompletedEvent>(v0);
    }
    ...
    public fun emit_guard_savings_vault_initialized_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: vector<0x2::object::ID>) {
        let v0 = GuardSavingsVaultInitializedEvent{
            vault_id     : arg0,
            version      : arg1,
            gdori_supply : arg2,
            total_staked : arg3,
    ...
    public fun emit_guard_savings_withdraw_enriched_event(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        ...
        0x2::event::emit<GuardSavingsWithdrawEnrichedEvent>(v0);
    }

    public fun emit_guard_savings_withdrawn_event(arg0: address, arg1: u64, arg2: 0x2::object::ID) {
        let v0 = GuardSavingsWithdrawnEvent{
            user          : arg0,
            dori_redeemed : arg1,
            pool_id       : arg2,
        };
        0x2::event::emit<GuardSavingsWithdrawnEvent>(v0);
    }
    ...
    public fun emit_savings_deposit_enriched_event(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = SavingsDepositEnrichedEvent{
            user               : arg0,
            dori_deposited     : arg1,
            sdori_minted       : arg2,
            total_dori_balance : arg3,
            total_sdori_supply : arg4,
            exchange_rate      : arg5,
        };
        0x2::event::emit<SavingsDepositEnrichedEvent>(v0);
    }
    ...
    public fun emit_savings_vault_initialized_event(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = SavingsVaultInitializedEvent{
            vault_id                    : arg0,
            version                     : arg1,
            dori_balance                : arg2,
            sdori_supply                : arg3,
            total_yield_distributed     : arg4,
            last_distribution_timestamp : arg5,
        };
        0x2::event::emit<SavingsVaultInitializedEvent>(v0);
    }

    public fun emit_savings_withdraw_enriched_event(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        let v0 = SavingsWithdrawEnrichedEvent{
            user               : arg0,
            sdori_burned       : arg1,
            dori_withdrawn     : arg2,
            total_dori_balance : arg3,
        ...
        0x2::event::emit<SavingsWithdrawEnrichedEvent>(v0);
    }
