module 0x1e067be96b626ce5ffe4451c90fd121110098364e4500dff9d7641517ef1c1e::cnsnft1325 {
    struct CNSNFT1325 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1325, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1325>(arg0, arg1);
