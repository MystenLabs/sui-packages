module 0x1a2ae1d2b89ad02db07bf56eb595e248dd5c2230b11a1b38a5043b4e54e853a::faith {
    ...
    public fun accrue_to(arg0: address, arg1: u64, arg2: &mut SupplyCap, arg3: &RefiningIndex, arg4: &mut Buckets, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.minted + arg1 <= arg2.cap, 0x1a2ae1d2b89ad02db07bf56eb595e248dd5c2230b11a1b38a5043b4e54e853a::errors::E_SUPPLY_CAP());
    ...
    public fun claim(arg0: address, arg1: u64, arg2: &mut SupplyCap, arg3: &mut RefiningIndex, arg4: &mut Buckets) : u64 {
        let (v0, v1) = find_bucket_index(&arg4.owners, arg0);
        assert!(v0, 0x1a2ae1d2b89ad02db07bf56eb595e248dd5c2230b11a1b38a5043b4e54e853a::errors::E_NOTHING_TO_CLAIM());
        let v2 = 0x1::vector::borrow_mut<Unclaimed>(&mut arg4.buckets, v1);
        let v3 = refine_amount(v2.raw, v2.index_snap, arg3.index_accum);
        assert!(v3 > 0, 0x1a2ae1d2b89ad02db07bf56eb595e248dd5c2230b11a1b38a5043b4e54e853a::errors::E_NOTHING_TO_CLAIM());
