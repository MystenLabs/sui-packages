module 0x1aa010472146e8e4ed356269f216f4dd9e32ff96d41534824a1f172c4ad91a5::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"TIMUR", b"timur", b"TIMUR Token", 0x1::option::none<0x2::url::Url>(), arg1);
