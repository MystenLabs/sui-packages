module 0x13be5765a26f0b9d257e986905dfdcc46f743aff96c1fb5bd2224fc3e934a9a::kohime {
    ...
    fun init(arg0: KOHIME, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<KOHIME>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"KOHIME  ")))), trim_right(b"Kohime Ai                       "), trim_right(b"\"Chiikawa\" is an abbreviation of \"some kind of small and cute creature\" (nanka chiisakute kawaii yatsu) in Japanese.                                                                                                                                                                                                            "), v2, arg1);
