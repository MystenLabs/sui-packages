module 0x1da4a3538f3eb7bb785c3530c3489667a83b95c2fc6629210707c90bd37971b::quants {
    ...
    fun init(arg0: QUANTS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"3,000 Quants minting on Sui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://h531UrcENO5rIyo43bfrQO7-rKaOfyQqj2HOaToRfjI"));
