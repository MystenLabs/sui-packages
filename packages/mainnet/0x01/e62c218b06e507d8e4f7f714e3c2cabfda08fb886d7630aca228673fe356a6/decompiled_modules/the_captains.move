module 0x1e62c218b06e507d8e4f7f714e3c2cabfda08fb886d7630aca228673fe356a6::the_captains {
    ...
    fun init(arg0: THE_CAPTAINS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v11 = &mut v10;
        0x1::vector::push_back<0x1::string::String>(v11, 0x1::string::utf8(b"The Captain #{token_id}"));
    ...
    public fun reveal(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut TraitsRegistry, arg3: 0x2::object::ID, arg4: &0x2::tx_context::TxContext) {
