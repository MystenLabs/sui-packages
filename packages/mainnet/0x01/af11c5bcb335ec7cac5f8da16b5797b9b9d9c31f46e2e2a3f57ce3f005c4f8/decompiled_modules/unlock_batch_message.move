module 0x5b7716fc5f08c1e25a642f32df7b145503707e304102d1bb8296bc13bd169ea7::unlock_batch_message {
    ...
    public(friend) fun deserialize_items(arg0: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>, arg1: u64, arg2: u16) : UnlockBatchMessage {
        ...
        while (arg2 > 0) {
            let v1 = UnlockBatchMessageItem{
                ...
                unlock_receiver : 0x2::address::from_bytes(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(&mut arg0, 32)),
    ...
    public(friend) fun get_item(arg0: &UnlockBatchMessage, arg1: u16) : (address, u16, address, address, u8, u8, address, address, u64) {
        ...
        (v0.hash, v0.chain_source, v0.token_in, v0.addr_ref, v0.fee_rate_ref, v0.fee_rate_mayan, v0.unlock_receiver, v0.winner, v0.fulfill_time)
    }
