module 0x16a62da3cbd89942a62dec1f69dafbab606260b9afd09b1fabd4dc49c75b823::puddle {
    ...
    public entry fun arbitrage<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = *0x2::object::borrow_id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg3);
        let v1 = 0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balanec_bag, v0);
        assert!(arg4 <= 0x2::balance::value<T0>(v1), 14);
        let v2 = 0x16a62da3cbd89942a62dec1f69dafbab606260b9afd09b1fabd4dc49c75b823::cetus_invest::arbitrage<T0, T1>(arg2, arg3, v1, arg4, arg5, arg6);
        let v3 = *0x2::table::borrow<0x2::object::ID, u64>(&arg1.investments.cost_table, v0);
        let v4 = 0x2::balance::value<T1>(&v2) - v3;
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v2, v4 * (arg1.commission_percentage as u64) / 100), arg7), arg1.metadata.trader);
        if (0x2::balance::value<T1>(&v2) > v3) {
            let v5 = 0x2::balance::split<T1>(&mut v2, v4 * (100 - (arg1.commission_percentage as u64)) / 100);
            let v6 = &mut v5;
            give_out_bonus<T1>(arg1, v6, arg7);
    ...
    public entry fun invest<T0: drop, T1: drop>(arg0: &mut PuddleCap<T1>, arg1: &mut Puddles<T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::vector::contains<0x2::object::ID>(&arg1.investments.invests, &v0)) {
            ...
            0x2::balance::join<T0>(0x2::bag::borrow_mut<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balanec_bag, v0), 0x16a62da3cbd89942a62dec1f69dafbab606260b9afd09b1fabd4dc49c75b823::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
        } else {
            ...
            0x2::bag::add<0x2::object::ID, 0x2::balance::Balance<T0>>(&mut arg1.investments.balanec_bag, v0, 0x16a62da3cbd89942a62dec1f69dafbab606260b9afd09b1fabd4dc49c75b823::cetus_invest::invest<T0, T1>(arg2, arg3, &mut arg1.balance, arg4, arg5, arg6));
        };
    }
