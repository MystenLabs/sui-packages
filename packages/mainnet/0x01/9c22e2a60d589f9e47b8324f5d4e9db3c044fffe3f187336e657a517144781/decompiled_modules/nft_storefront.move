module 0x19c22e2a60d589f9e47b8324f5d4e9db3c044fffe3f187336e657a517144781::nft_storefront {
    ...
    public fun mint_and_list(arg0: &AdminCap, arg1: &mut Marketplace, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: 0x1::string::String, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = ArtNFT{
    ...
    public fun relist(arg0: &AdminCap, arg1: &mut Marketplace, arg2: ArtNFT, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object::id<ArtNFT>(&arg2);
        let v1 = Listing{
            nft_id : v0,
            price  : arg3,
            seller : 0x2::tx_context::sender(arg4),
        };
        0x2::table::add<0x2::object::ID, Listing>(&mut arg1.listings, v0, v1);
        0x2::object_table::add<0x2::object::ID, ArtNFT>(&mut arg1.nfts, v0, arg2);
        let v2 = NFTListed{
            nft_id : v0,
            price  : arg3,
        };
