module 0x1df37d5b5a14bdb1d5afa88b06acbf179b2ec1339ac5129e6823cb5282d2f5e::alphalend_slush_investor {
    ...
    public(friend) fun recast_balance_type<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: 0x2::balance::Balance<T1>) : 0x2::balance::Balance<T2> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>()) == true, 13906834728394162175);
    ...
    public(friend) fun split_external_reward<T0>(arg0: &mut Investor<T0>, arg1: &mut 0x2::balance::Balance<T0>, arg2: 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::Number, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg4: &0x2::clock::Clock) {
        ...
        let v2 = v1;
        if (v1 > 0x2::balance::value<T0>(arg1)) {
            let v3 = LessExternalRewards{
                amount                 : v1,
                total_external_rewards : 0x2::balance::value<T0>(arg1),
            };
            0x2::event::emit<LessExternalRewards>(v3);
            v2 = 0x2::balance::value<T0>(arg1);
        };
        let v4 = RewardEvent{
            coin_type : 0x1::type_name::with_defining_ids<T0>(),
            amount    : v2,
        ...
        0x2::event::emit<RewardEvent>(v4);
        update_free_rewards<T0, T0>(arg0, 0x2::balance::split<T0>(arg1, v2));
    }
