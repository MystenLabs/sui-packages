module 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::vault {
    ...
    public fun redeem_withdraw_ticket<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: WithdrawTicket<T0, T1>) : 0x2::balance::Balance<T0> {
        ...
        let v4 = v2;
        while (0x2::vec_map::size<0x2::object::ID, StrategyWithdrawInfo<T0>>(&v4) > 0) {
            let (v5, v6) = 0x2::vec_map::pop<0x2::object::ID, StrategyWithdrawInfo<T0>>(&mut v4);
            let v7 = v5;
            let StrategyWithdrawInfo {
                to_withdraw       : v8,
                withdrawn_balance : v9,
                has_withdrawn     : v10,
            } = v6;
            if (v8 > 0) {
                assert!(v10, 5);
            };
            let v11 = 0x2::vec_map::get_mut<0x2::object::ID, StrategyState>(&mut arg0.strategies, &v7);
            v11.borrowed = v11.borrowed - v8;
            0x2::balance::join<T0>(&mut v0, v9);
        };
        0x2::vec_map::destroy_empty<0x2::object::ID, StrategyWithdrawInfo<T0>>(v4);
        0x2::balance::join<T0>(&mut v0, 0x2::balance::split<T0>(&mut arg0.free_balance, v1));
        0x2::balance::decrease_supply<T1>(0x2::coin::supply_mut<T1>(&mut arg0.lp_treasury), v3);
        arg0.withdraw_ticket_issued = false;
        v0
    }

    public(friend) fun remove_strategy<T0, T1>(arg0: &AdminCap<T1>, arg1: &mut Vault<T0, T1>, arg2: StrategyRemovalTicket<T0, T1>, arg3: vector<0x2::object::ID>, arg4: vector<u64>, arg5: &0x2::clock::Clock) {
        assert_version<T0, T1>(arg1);
    ...
    public(friend) fun strategy_hand_over_profit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &VaultAccess, arg2: 0x2::balance::Balance<T0>, arg3: &0x2::clock::Clock) {
        ...
        if (v0 > 0) {
            0x2::balance::join<T1>(&mut arg0.performance_fee_balance, 0x2::coin::mint_balance<T1>(&mut arg0.lp_treasury, 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::util::muldiv(0x2::coin::total_supply<T1>(&arg0.lp_treasury), v0, total_available_balance<T0, T1>(arg0, arg3) - v0)));
        };
        ...
        let v1 = 0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::skim_extraneous_balance<T0>(&mut arg0.time_locked_profit);
        ...
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::change_unlock_per_second<T0>(&mut arg0.time_locked_profit, 0x2::math::divide_and_round_up(0x2::balance::value<T0>(&v1), arg0.profit_unlock_duration_sec), arg3);
        0x1c389a85310b47e7630a9361d4e71025bc35e4999d3a645949b1b68b26f2273::time_locked_balance::top_up<T0>(&mut arg0.time_locked_profit, v1, arg3);
    }
