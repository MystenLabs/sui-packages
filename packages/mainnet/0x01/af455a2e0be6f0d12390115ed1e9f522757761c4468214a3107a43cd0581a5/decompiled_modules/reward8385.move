module 0x1af455a2e0be6f0d12390115ed1e9f522757761c4468214a3107a43cd0581a5::reward8385 {
    struct REWARD8385 has drop {
        dummy_field: bool,
    }

    struct TICKET_8385 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8385(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8385>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8385>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8385, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8385>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8385>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8385>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8385>>(v5, 0x2::tx_context::sender(arg1));
    }
