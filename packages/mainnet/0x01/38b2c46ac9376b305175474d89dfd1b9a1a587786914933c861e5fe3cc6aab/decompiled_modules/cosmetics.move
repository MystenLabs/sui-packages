module 0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::cosmetics {
    ...
    struct RewardVault has store, key {
        ...
        bones_sale_balance: 0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>,
        bones_sale_unit: u64,
    ...
    public entry fun admin_fund_bones(arg0: &CosmeticAdminCap, arg1: &CosmeticCollection, arg2: &mut RewardVault, arg3: 0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg1.admin_address, 1);
        0x2::coin::join<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(&mut arg2.bones_sale_balance, arg3);
    }
    ...
    public entry fun buy_bones(arg0: &mut RewardVault, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(&arg0.bones_sale_balance) >= v1, 10);
        let v2 = 0x2::coin::split<0x2::sui::SUI>(arg1, v0, arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>>(0x2::coin::split<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(&mut arg0.bones_sale_balance, v1, arg3), 0x2::tx_context::sender(arg3));
    ...
    public entry fun buy_free_pass(arg0: &mut RewardVault, arg1: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::object::id<0x2::coin::Coin<0x2::sui::SUI>>(&v1);
        0x2::dynamic_object_field::add<0x2::object::ID, 0x2::coin::Coin<0x2::sui::SUI>>(&mut arg0.id, v2, v1);
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.token_prize_ids, v2);
        let v3 = 0;
        while (v3 < arg2) {
            let v4 = FreePassNFT{
            ...
            0x2::transfer::public_transfer<FreePassNFT>(v4, 0x2::tx_context::sender(arg3));
    ...
    fun init(arg0: COSMETICS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v5, v6) = 0x2::transfer_policy::new<CosmeticNFT>(&v0, arg1);
        let v7 = GodNFTList{
            id                : 0x2::object::new(arg1),
        ...
        let v8 = RewardVault{
            ...
            nft_direct_prize_ids : 0x1::vector::empty<0x2::object::ID>(),
            nft_kiosk_prize_ids  : 0x1::vector::empty<0x2::object::ID>(),
            bones_sale_balance   : 0x2::coin::zero<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(arg1),
            ...
            nft_prize_bps        : 200,
            free_pass_bps        : 1000,
            free_pass_price_sui  : 1,
            free_pass_max_supply : 0,
            free_pass_total_sold : 0,
        };
        0x2::transfer::transfer<CosmeticAdminCap>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<CosmeticNFT>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<CosmeticNFT>>(v5);
        0x2::transfer::share_object<CosmeticCollection>(v3);
        0x2::transfer::share_object<GodNFTList>(v7);
        0x2::transfer::share_object<RewardVault>(v8);
    }
    ...
    fun perform_roll(arg0: &mut CosmeticCollection, arg1: &mut RewardVault, arg2: &mut GodNFTList, arg3: &mut 0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFTCollection, arg4: 0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFT, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFT>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::random::Random, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        let v1 = 0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::get_token_id(&arg4);
        ...
        if (0x2::random::generate_u64_in_range(&mut v2, 0, 10000) < arg1.god_prize_bps) {
            ...
            0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::burn_nft_internal(arg4, arg3);
            let v4 = 0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::create_nft_with_attributes(arg3, v1, *0x2::table::borrow<u64, 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>>(&arg2.god_nfts, *0x1::vector::borrow<u64>(&arg2.available_god_ids, v3)), arg9);
            let v5 = 0x2::object::id<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFT>(&v4);
            0x2::kiosk::lock<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFT>(arg6, arg7, arg5, v4);
            ...
            let v8 = 0x2::random::generate_u64_in_range(&mut v2, 0, 10000);
            if (v8 < arg1.token_prize_bps && !0x1::vector::is_empty<0x2::object::ID>(&arg1.token_prize_ids)) {
                let v9 = 0x2::random::generate_u64_in_range(&mut v2, 0, 0x1::vector::length<0x2::object::ID>(&arg1.token_prize_ids));
                let v10 = *0x1::vector::borrow<0x2::object::ID>(&arg1.token_prize_ids, v9);
                0x1::vector::push_back<0x2::object::ID>(&mut get_or_create_pending(arg0, v0, arg9).token_prize_ids, v10);
                0x1::vector::swap_remove<0x2::object::ID>(&mut arg1.token_prize_ids, v9);
                let v11 = VaultPrizeRolled{
                    sender     : v0,
                    prize_type : 0x1::string::utf8(b"token"),
                    prize_id   : v10,
                };
                0x2::event::emit<VaultPrizeRolled>(v11);
            } else if (v8 < arg1.token_prize_bps + arg1.nft_prize_bps) {
                if (!0x1::vector::is_empty<0x2::object::ID>(&arg1.nft_direct_prize_ids)) {
                    let v12 = 0x2::random::generate_u64_in_range(&mut v2, 0, 0x1::vector::length<0x2::object::ID>(&arg1.nft_direct_prize_ids));
                    let v13 = *0x1::vector::borrow<0x2::object::ID>(&arg1.nft_direct_prize_ids, v12);
                    0x1::vector::push_back<0x2::object::ID>(&mut get_or_create_pending(arg0, v0, arg9).nft_direct_prize_ids, v13);
                    0x1::vector::swap_remove<0x2::object::ID>(&mut arg1.nft_direct_prize_ids, v12);
                    let v14 = VaultPrizeRolled{
                        sender     : v0,
                        prize_type : 0x1::string::utf8(b"nft"),
                        prize_id   : v13,
                    };
                    0x2::event::emit<VaultPrizeRolled>(v14);
                } else if (!0x1::vector::is_empty<0x2::object::ID>(&arg1.nft_kiosk_prize_ids)) {
                    let v15 = 0x2::random::generate_u64_in_range(&mut v2, 0, 0x1::vector::length<0x2::object::ID>(&arg1.nft_kiosk_prize_ids));
                    let v16 = *0x1::vector::borrow<0x2::object::ID>(&arg1.nft_kiosk_prize_ids, v15);
                    0x1::vector::push_back<0x2::object::ID>(&mut get_or_create_pending(arg0, v0, arg9).nft_kiosk_prize_ids, v16);
                    0x1::vector::swap_remove<0x2::object::ID>(&mut arg1.nft_kiosk_prize_ids, v15);
                    let v17 = VaultPrizeRolled{
                        sender     : v0,
                        prize_type : 0x1::string::utf8(b"nft"),
                        prize_id   : v16,
                    };
                    0x2::event::emit<VaultPrizeRolled>(v17);
                };
            } else if (v8 < arg1.token_prize_bps + arg1.nft_prize_bps + arg1.free_pass_bps) {
                if (arg1.free_pass_price_sui > 0) {
                    ...
                    0x2::transfer::public_transfer<FreePassNFT>(v18, v0);
                    let v19 = VaultPrizeRolled{
                        sender     : v0,
                        prize_type : 0x1::string::utf8(b"pass"),
                        prize_id   : 0x2::object::id<FreePassNFT>(&v18),
                    };
                    0x2::event::emit<VaultPrizeRolled>(v19);
                };
            };
            0x2::kiosk::lock<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFT>(arg6, arg7, arg5, arg4);
        };
    }

    public entry fun purchase_cosmetic(arg0: &mut CosmeticCollection, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x2::table::contains<0x2::object::ID, CosmeticTemplate>(&arg0.cosmetic_catalog, arg1), 10);
        ...
        assert!(0x2::coin::value<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(&arg2) >= v2, 12);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>>(0x2::coin::split<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(&mut arg2, v2, arg3), arg0.admin_address);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>>(arg2, v0);
    ...
    public entry fun roll_vault_prize(arg0: &mut CosmeticCollection, arg1: &mut RewardVault, arg2: &mut GodNFTList, arg3: &mut 0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFTCollection, arg4: 0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFT, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::doonies::NFT>, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::random::Random, arg9: 0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>, arg10: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(&arg9) >= 1000, 12);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>>(0x2::coin::split<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>(&mut arg9, 1000, arg10), arg0.admin_address);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x138b2c46ac9376b305175474d89dfd1b9a1a587786914933c861e5fe3cc6aab::bones::BONES>>(arg9, 0x2::tx_context::sender(arg10));
