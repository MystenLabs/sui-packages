module 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy {
    struct Request {
    ...
    public(friend) fun add_receipt<T0>(arg0: &mut Request) {
        0x2::vec_set::insert<0x1::string::String>(&mut arg0.receipts, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_key_by_struct<T0>());
    }
    ...
    public(friend) fun get_rule<T0, T1: drop + store>(arg0: &Policy) : &T1 {
        0x2::dynamic_field::borrow<0x1::string::String, T1>(&arg0.id, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_key_by_struct<T0>())
    }
