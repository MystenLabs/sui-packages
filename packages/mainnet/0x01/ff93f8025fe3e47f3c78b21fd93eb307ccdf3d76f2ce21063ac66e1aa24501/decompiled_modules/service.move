module 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service {
    ...
    public(friend) fun add_feature<T0, T1: store + key>(arg0: &mut Service, arg1: T1) {
        let v0 = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_key_by_struct<T0>();
    ...
    public(friend) fun get_feature<T0, T1: store + key>(arg0: &Service) : &T1 {
        0x2::dynamic_object_field::borrow<0x1::string::String, T1>(&arg0.id, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_key_by_struct<T0>())
    }

    public(friend) fun get_feature_mut<T0, T1: store + key>(arg0: &mut Service) : &mut T1 {
        0x2::dynamic_object_field::borrow_mut<0x1::string::String, T1>(&mut arg0.id, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_key_by_struct<T0>())
    }
