module 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::ido {
    struct Round has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        project: 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::project::ProjectInfo,
    ...
    public(friend) fun add_payment<T0>(arg0: &mut Round, arg1: u64, arg2: u8, arg3: u8) {
        assert!(arg3 <= 18, 304);
        let v0 = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_full_type<T0>();
        ...
        let v3 = Payment{
            ...
            ratio_decimal   : arg2,
            method_type     : 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_full_type<T0>(),
    ...
    fun cal_payment_amount(arg0: &0x2::vec_map::VecMap<0x1::string::String, Payment>, arg1: 0x1::string::String, arg2: u64, arg3: u8) : u64 {
        ...
        0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::mul_u64_div_decimal(0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::mul_u64_div_decimal(v0.ratio_per_token, arg2, v0.ratio_decimal), (0x2::math::pow(10, v0.payment_decimal) as u64), arg3)
    }

    public fun claim_vesting<T0>(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        let v2 = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service_vesting::update_withdraw(arg0, v1, arg2, v0);
        assert!(v2 > 0, 300);
        assert!(0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service_vesting::check_is_open_claim_vesting(v1), 301);
        0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::withdraw<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::Vaults>(&mut arg1.other, 0x1::string::utf8(b"VAULT")), v2, v0, arg3);
        let v3 = ClaimVesting{
    ...
    public(friend) fun get_mut_policy(arg0: &mut Round) : &mut 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy::Policy {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy::Policy>(&mut arg0.other, 0x1::string::utf8(b"POLICY"))
    }

    public(friend) fun get_mut_service(arg0: &mut Round) : &mut 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service::Service {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service::Service>(&mut arg0.other, 0x1::string::utf8(b"SERVICE"))
    }

    public(friend) fun get_mut_vault(arg0: &mut Round) : &mut 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::Vaults {
        0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::Vaults>(&mut arg0.other, 0x1::string::utf8(b"VAULT"))
    }

    public fun get_project(arg0: &Round) : 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::project::ProjectInfo {
        arg0.project
    }
    ...
    fun new_policy(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy::Policy>(arg1, v0, v1);
    }

    public(friend) fun new_round<T0>(arg0: 0x1::string::String, arg1: 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::project::ProjectInfo, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : Round {
        let v0 = 0x2::object::new(arg6);
        let v1 = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_full_type<T0>();
        ...
        let v10 = NewRound{
            ...
            round_name    : arg0,
            project_name  : 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::project::get_project_name(&arg1),
            token_type    : v1,
            token_decimal : arg2,
            total_supply  : arg5,
    ...
    fun new_service(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service::Service>(arg1, v0, v1);
    }
    ...
    fun new_vault(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, 0x2::object::ID>, arg1: &mut 0x2::object_bag::ObjectBag, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::new(arg2);
        0x2::vec_map::insert<0x1::string::String, 0x2::object::ID>(arg0, v0, v2);
        0x2::object_bag::add<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::Vaults>(arg1, v0, v1);
    }
    ...
    public fun purchase<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut Round, arg2: u64, arg3: vector<0x2::coin::Coin<T1>>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::get_full_type<T1>();
        ...
        let v8 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy::Policy>(&mut arg1.other, 0x1::string::utf8(b"POLICY"));
        let v9 = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy::new_request(0x2::object::uid_to_inner(&arg1.id));
        0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy_purchase::check(v8, &mut v9, arg2);
        0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::policy::confirm_request(v8, v9);
        update_state_purchase<T1>(arg1, v0, arg2, v3, arg3, arg5);
        let v10 = 0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service::Service>(&mut arg1.other, 0x1::string::utf8(b"SERVICE"));
        0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service_affiliate::add_profit_by_affiliate<T1>(v10, arg4, v3);
        0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::service_vesting::execute_add_vesting(v10, arg2, v1);
        let v11 = Purchase{
            round_id            : 0x2::object::uid_to_inner(&arg1.id),
            token_amount        : arg2,
            payment_amount      : v3,
    ...
    fun update_state_purchase<T0>(arg0: &mut Round, arg1: u64, arg2: u64, arg3: u64, arg4: vector<0x2::coin::Coin<T0>>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::vec_set::contains<address>(&arg0.participants, &v0)) {
            ...
            0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::certificate::issue_investment_certificate(arg1, arg0.project, arg0.name, arg0.token_type, arg5);
        };
        let (v1, v2) = 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::utils::merge_and_split<T0>(arg4, arg3, arg5);
        0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::deposit<T0>(0x2::object_bag::borrow_mut<0x1::string::String, 0x1ff93f8025fe3e47f3c78b21fd93eb307ccdf3d76f2ce21063ac66e1aa24501::vault::Vaults>(&mut arg0.other, 0x1::string::utf8(b"VAULT")), v1, arg5);
