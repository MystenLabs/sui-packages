module 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::cetus_manager {
    ...
    public(friend) fun close_position<T0, T1>(arg0: &mut CetusManager<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: bool, arg4: u8) {
        ...
        assert!((arg4 as u64) < 0x1::vector::length<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v0.positions), 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_offset());
    ...
    public(friend) fun collect_reward<T0, T1, T2>(arg0: &mut CetusManager<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: bool, arg4: u8, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg6: &0x2::clock::Clock) {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&v1.rewards, v2)) {
            0x2::balance::join<T2>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut v1.rewards, v2), 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_reward<T0, T1, T2>(arg1, arg2, borrow_position_mut(v0, arg4), arg5, true, arg6));
        } else {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T2>>(&mut v1.rewards, v2, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_reward<T0, T1, T2>(arg1, arg2, borrow_position_mut(v0, arg4), arg5, true, arg6));
        };
    }
    ...
    public(friend) fun add_liquidity<T0, T1>(arg0: &mut PositionManager, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &mut 0x2::balance::Balance<T0>, arg4: &mut 0x2::balance::Balance<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        assert!(v7 >= v14 && v8 >= v15, 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_amount());
        let v16 = if (v14 > 0) {
    ...
    public(friend) fun adjust_balance<T0, T1>(arg0: &PositionManager, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &mut 0x2::balance::Balance<T0>, arg4: &mut 0x2::balance::Balance<T1>, arg5: u64, arg6: &0x2::clock::Clock) : (u64, u64) {
        ...
        if (v0 > 0) {
            ...
            let (v4, v5) = if (v1) {
                (0x2::balance::split<T0>(arg3, v3), 0x2::balance::zero<T1>())
            } else {
                (0x2::balance::zero<T0>(), 0x2::balance::split<T1>(arg4, v3))
            };
            let (v6, v7) = flash_swap<T0, T1>(arg1, arg2, v4, v5, v1, v3, arg5, arg6);
            0x2::balance::join<T0>(arg3, v6);
            0x2::balance::join<T1>(arg4, v7);
        };
        let v8 = 0x2::balance::value<T0>(arg3);
        let v9 = 0x2::balance::value<T1>(arg4);
        let v10 = BalanceAdjusted{
        ...
        0x2::event::emit<BalanceAdjusted>(v10);
        (v8, v9)
    }
    ...
    public(friend) fun borrow_position_mut(arg0: &mut PositionManager, arg1: u8) : &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position {
        assert!((arg1 as u64) < 0x1::vector::length<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg0.positions), 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_offset());
    ...
    fun calculate_optimal_swap<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: u32, arg4: u32, arg5: bool) : (u64, bool) {
        assert!(arg1 > 0 || arg2 > 0, 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_amount());
        let v0 = 1000000000;
        ...
        let (_, v4, v5) = get_liquidity_from_amount<T0, T1>(arg0, arg3, arg4, ((v0 * 1000) as u64), false);
    ...
    public(friend) fun calculate_reasonable_tick_range<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg1: u32, arg2: u32) : (u32, u32) {
        ...
        assert!(arg1 < 10000, 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_tick_range());
    ...
    public(friend) fun rebalance<T0, T1>(arg0: &mut CetusManager<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: bool, arg4: u32, arg5: u32, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = total_liquidity<T0, T1>(v0, arg2);
        if (v2 > 0) {
            let (_, v4, v5) = remove_liquidity<T0, T1>(v0, arg1, arg2, v2, arg7);
            0x2::balance::join<T0>(&mut v1.balance_a, v4);
            0x2::balance::join<T1>(&mut v1.balance_b, v5);
        };
        let v6 = if (arg4 != v0.lower_tick || arg5 != v0.upper_tick) {
            if (arg4 != 0) {
                arg5 != 0
            } else {
                false
        ...
        if (v6) {
            assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg4), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg5)), 0x8c60507737c396fa7298eaff6ff999acec1b9d9cc1ce48e095265db7c4288e9c::errors::invalid_tick_range());
            v0.lower_tick = arg4;
            v0.upper_tick = arg5;
            v0.need_rebalance = true;
        };
        if (0x2::balance::value<T0>(&v1.balance_a) > 0 || 0x2::balance::value<T1>(&v1.balance_b) > 0) {
    ...
    public entry fun transfer_positions_to_admin<T0, T1>(arg0: &mut CetusManager<T0, T1>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg1) {
            &mut arg0.core_position
        } else {
            &mut arg0.profit_position
        };
        let v1 = 0x1::vector::length<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v0.positions);
        if (v1 > 1) {
            let v2 = 0;
            while (v2 < v1 - 1) {
                let v3 = 0x1::vector::remove<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut v0.positions, 0);
                0x2::transfer::public_transfer<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(v3, @0x668fe68cc71fc5741c427bd6539617c7e3265457dae598faadff782a37bcfcf9);
    ...
    public entry fun transfer_positions_to_admin_v2<T0, T1>(arg0: &mut CetusManager<T0, T1>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg1) {
            &mut arg0.core_position
        } else {
            &mut arg0.profit_position
