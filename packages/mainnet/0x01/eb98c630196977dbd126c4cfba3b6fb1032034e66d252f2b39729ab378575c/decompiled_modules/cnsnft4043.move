module 0x1eb98c630196977dbd126c4cfba3b6fb1032034e66d252f2b39729ab378575c::cnsnft4043 {
    struct CNSNFT4043 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4043, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4043>(arg0, arg1);
