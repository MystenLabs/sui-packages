module 0x16a35737368b1013160523a57613e3231c97d2ea5ef562969551eb9b03994e3::reward7387 {
    struct REWARD7387 has drop {
        dummy_field: bool,
    }

    struct TICKET_7387 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7387(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7387>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7387>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7387, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7387>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7387>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7387>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7387>>(v5, 0x2::tx_context::sender(arg1));
    }
