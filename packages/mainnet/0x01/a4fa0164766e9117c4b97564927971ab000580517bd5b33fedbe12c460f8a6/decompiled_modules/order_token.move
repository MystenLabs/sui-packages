module 0x7e7ecad0be935628ff0ac677ef50719dbe6c64847c607f74da80a9e1fa759ea7::order_token {
    ...
    public(friend) fun from_bytes(arg0: vector<u8>) : OrderToken {
        let v0 = 0x2::bcs::new(arg0);
        OrderToken{
            token_type    : 0x7e7ecad0be935628ff0ac677ef50719dbe6c64847c607f74da80a9e1fa759ea7::order_token_type::from_discriminant(0x2::bcs::peel_u8(&mut v0)),
            token_address : 0x2::bcs::peel_address(&mut v0),
            token_id      : 0x2::bcs::peel_u256(&mut v0),
            token_amount  : 0x2::bcs::peel_u256(&mut v0),
        }
    }
    ...
    public(friend) fun read_order_type_vector_from_abi_reader(arg0: &mut 0x7e7ecad0be935628ff0ac677ef50719dbe6c64847c607f74da80a9e1fa759ea7::abi::AbiReader) : vector<OrderToken> {
        ...
        let v1 = 0x7e7ecad0be935628ff0ac677ef50719dbe6c64847c607f74da80a9e1fa759ea7::abi::read_vector_bytes(arg0);
        0x1::vector::reverse<vector<u8>>(&mut v1);
        while (0x1::vector::length<vector<u8>>(&v1) != 0) {
            0x1::vector::push_back<OrderToken>(&mut v0, from_bytes(0x1::vector::pop_back<vector<u8>>(&mut v1)));
        };
