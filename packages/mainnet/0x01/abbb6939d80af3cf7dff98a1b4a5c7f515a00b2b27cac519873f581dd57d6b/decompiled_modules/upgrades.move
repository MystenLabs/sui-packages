module 0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::upgrades {
    ...
    public fun commit_upgrade<T0>(arg0: &mut UpgradeCap, arg1: &mut 0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::state::State<T0>, arg2: 0x2::package::UpgradeReceipt) {
        0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::state::set_version<T0>(arg1, 0);
        0x2::package::commit_upgrade(&mut arg0.cap, arg2);
    }

    public fun check_version<T0>(arg0: VersionGated, arg1: &0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::state::State<T0>) {
        let VersionGated {  } = arg0;
        if (0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::state::get_version<T0>(arg1) != 0) {
