module 0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::outbox {
    struct Outbox<T0: store> has store {
        entries: 0x2::table::Table<OutboxKey, OutboxItem<T0>>,
        rate_limit: 0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::rate_limit::RateLimitState,
    }
    ...
    struct OutboxItem<T0> has store {
        ...
        released: 0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::bitmap::Bitmap,
        ...
        data: 0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::ntt_manager_message::NttManagerMessage<T0>,
    }
    ...
    public fun add<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxItem<T0>) : OutboxKey {
        let v0 = OutboxKey{id: 0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::ntt_manager_message::get_id<T0>(&arg1.data)};
    ...
    public(friend) fun new<T0: store>(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Outbox<T0> {
        Outbox<T0>{
            ...
            rate_limit : 0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::rate_limit::new(arg0),
        }
    }

    public fun borrow_data<T0: store>(arg0: &OutboxItem<T0>) : &0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::ntt_manager_message::NttManagerMessage<T0> {
        &arg0.data
    }

    public fun borrow_rate_limit_mut<T0: store>(arg0: &mut Outbox<T0>) : &mut 0x1abbb6939d80af3cf7dff98a1b4a5c7f515a00b2b27cac519873f581dd57d6b::rate_limit::RateLimitState {
        &mut arg0.rate_limit
    }
    ...
    public fun new_outbox_item<T0>(arg0: u64, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::external_address::ExternalAddress, arg2: 0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::ntt_manager_message::NttManagerMessage<T0>) : OutboxItem<T0> {
        OutboxItem<T0>{
            release_timestamp     : arg0,
            released              : 0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::bitmap::empty(),
    ...
    public(friend) fun try_release<T0: store>(arg0: &mut Outbox<T0>, arg1: OutboxKey, arg2: u8, arg3: &0x2::clock::Clock) : bool {
        ...
        if (0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::bitmap::get(&v0.released, arg2)) {
            abort 13906834586660241409
        };
        0x8d9b25a3ee37c85b3792574b65c7aec4e45b80ccf1801bef929f75d8ffd2df3f::bitmap::enable(&mut v0.released, arg2);
        true
    }
