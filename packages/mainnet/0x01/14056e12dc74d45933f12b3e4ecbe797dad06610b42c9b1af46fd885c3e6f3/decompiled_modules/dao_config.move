module 0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::dao_config {
    ...
    public fun default_governance_config() : GovernanceConfig {
        GovernanceConfig{
            max_outcomes              : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_max_outcomes(),
            max_actions_per_outcome   : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_max_actions_per_outcome(),
            proposal_creation_fee     : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_proposal_creation_fee(),
            proposal_fee_per_outcome  : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_proposal_fee_per_outcome(),
            fee_in_asset_token        : false,
            proposal_intent_expiry_ms : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_proposal_intent_expiry_ms(),
        }
    }
    ...
    public fun default_trading_params() : TradingParams {
        TradingParams{
            ...
            review_period_ms                    : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::one_day_ms(),
            trading_period_ms                   : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::one_week_ms(),
            conditional_amm_fee_bps             : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_conditional_amm_fee_bps(),
            conditional_liquidity_ratio_percent : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_conditional_liquidity_percent(),
        }
    }
    ...
    public fun default_twap_config() : TwapConfig {
        TwapConfig{
            start_delay         : 0,
            cap_ppm             : 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_twap_max_movement_ppm(),
            initial_observation : 0x1::option::none<u128>(),
            threshold           : (0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::default_twap_threshold() as u128),
    ...
    public fun new_governance_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64) : GovernanceConfig {
        assert!(arg0 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_outcomes(), 3);
        assert!(arg0 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::protocol_max_outcomes(), 10);
        assert!(arg1 > 0 && arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::protocol_max_actions_per_outcome(), 11);
        assert!(arg2 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_proposal_creation_fee(), 19);
        assert!(arg3 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_proposal_fee_per_outcome(), 19);
        assert!(arg5 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_proposal_intent_expiry_ms(), 8);
    ...
    public fun new_trading_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : TradingParams {
        assert!(arg0 > 0, 0);
        assert!(arg1 > 0, 0);
        assert!(arg0 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::protocol_min_liquidity_amount(), 16);
        assert!(arg1 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::protocol_min_liquidity_amount(), 16);
        assert!(arg2 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_review_period_ms(), 1);
        assert!(arg2 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_trading_duration_ms(), 1);
        assert!(arg3 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_trading_period_ms(), 1);
        assert!(arg3 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_trading_duration_ms(), 1);
        assert!(arg4 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_amm_fee_bps(), 2);
        assert!(arg5 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_conditional_liquidity_percent() && arg5 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_conditional_liquidity_percent(), 2);
        TradingParams{
    ...
    public fun new_twap_config(arg0: u64, arg1: u64, arg2: 0x1::option::Option<u128>, arg3: u128) : TwapConfig {
        assert!(arg0 < 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::one_week_ms(), 7);
        assert!(arg0 % 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::twap_price_cap_window() == 0, 7);
        assert!(arg1 > 0, 7);
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::ppm_denominator(), 7);
        if (0x1::option::is_some<u128>(&arg2)) {
            assert!(*0x1::option::borrow<u128>(&arg2) > 0, 7);
        };
        assert!(arg3 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::twap_threshold_base(), 7);
        TwapConfig{
            start_delay         : arg0,
            cap_ppm             : arg1,
    ...
    public fun new_twap_config_with_sponsored_threshold(arg0: u64, arg1: u64, arg2: 0x1::option::Option<u128>, arg3: u128, arg4: u128) : TwapConfig {
        ...
        assert!(arg3 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::twap_threshold_base(), 7);
        assert!(arg4 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_sponsored_threshold(), 7);
        TwapConfig{
            start_delay         : arg0,
            cap_ppm             : arg1,
            initial_observation : arg2,
    ...
    public(friend) fun set_conditional_amm_fee_bps(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_amm_fee_bps(), 2);
    ...
    public(friend) fun set_conditional_liquidity_ratio_percent(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_conditional_liquidity_percent() && arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_conditional_liquidity_percent(), 2);
    ...
    public(friend) fun set_max_outcomes(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_outcomes(), 3);
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::protocol_max_outcomes(), 10);
    ...
    public(friend) fun set_proposal_creation_fee(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_proposal_creation_fee(), 19);
        arg0.proposal_creation_fee = arg1;
    }

    public(friend) fun set_proposal_fee_per_outcome(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_proposal_fee_per_outcome(), 19);
        arg0.proposal_fee_per_outcome = arg1;
    }

    public(friend) fun set_proposal_intent_expiry_ms(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_proposal_intent_expiry_ms(), 8);
    ...
    public(friend) fun set_review_period_ms(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_review_period_ms(), 1);
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_trading_duration_ms(), 1);
        arg0.review_period_ms = arg1;
    }

    public(friend) fun set_sponsored_threshold(arg0: &mut TwapConfig, arg1: u128) {
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_sponsored_threshold(), 7);
    ...
    public(friend) fun set_start_delay(arg0: &mut TwapConfig, arg1: u64) {
        assert!(arg1 < 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::one_week_ms(), 7);
        assert!(arg1 % 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::twap_price_cap_window() == 0, 7);
        arg0.start_delay = arg1;
    }

    public(friend) fun set_threshold(arg0: &mut TwapConfig, arg1: u128) {
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::twap_threshold_base(), 7);
        arg0.threshold = arg1;
    }

    public(friend) fun set_trading_period_ms(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 >= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::min_trading_period_ms(), 1);
        assert!(arg1 <= 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::max_trading_duration_ms(), 1);
