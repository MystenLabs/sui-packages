module 0x114056e12dc74d45933f12b3e4ecbe797dad06610b42c9b1af46fd885c3e6f3::emergency_cap {
    ...
    public fun assert_ready(arg0: &EmergencyCap, arg1: &0x2::clock::Clock) {
        ...
        let v2 = if (arg0.created_at > 0 && v1 - arg0.created_at < 60 * 0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::one_day_ms()) {
            0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::one_day_ms()
        } else {
            0xada535b9a93c1785cb9bc8918c6f133da5f167ab3c9f189c7eda8f2fa82cb6a3::constants::one_week_ms()
        };
