module 0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::acl {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : ACL {
        ...
        0x2::vec_set::insert<address>(&mut v0, @0x586ce4f16b94006599955337bc8a49569e8c64c029a1a6deef2e7a4e52c78d5d);
        0x2::vec_set::insert<address>(&mut v0, @0x2d0db5434bfce8a9dcdd9cb0b1192581acfc91c59d84846c90211846c7c2d931);
    ...
    public(friend) fun execute(arg0: &mut ACL, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v1 >= v2.executable_after, 3);
        if (v3 || !v4) {
            0x2::table::remove<u64, Proposal>(&mut arg0.proposals, arg1);
        ...
        assert!(count_valid_admin_votes(arg0, &v2.supporters) >= 0x2::vec_set::size<address>(&arg0.admins) / 2 + 1, 2);
    ...
    public fun get_fund_receiver(arg0: &ACL) : address {
        assert!(0x1::option::is_some<address>(&arg0.fund_receiver), 13);
        *0x1::option::borrow<address>(&arg0.fund_receiver)
    }

    public fun get_reward_receiver(arg0: &ACL) : address {
        assert!(0x1::option::is_some<address>(&arg0.reward_receiver), 14);
    ...
    public(friend) fun set_publisher(arg0: &mut ACL, arg1: 0x2::package::Publisher, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(is_admin(arg0, v0), 1);
        assert!(0x2::package::from_package<ACL>(&arg1), 16);
    ...
    public(friend) fun set_upgrade_cap(arg0: &mut ACL, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(is_admin(arg0, v0), 1);
        assert!(get_upgrade_cap_id(&arg1) == @0x13bd64310147dcaa5687af515de25c71fea048233a228ce63fcfcc64ca587585, 16);
    ...
    fun validate_proposal_creation(arg0: &ACL, arg1: u8, arg2: address, arg3: u8) {
        if (arg1 == 0) {
            assert!(!0x2::vec_set::contains<address>(&arg0.admins, &arg2), 17);
        } else if (arg1 == 1) {
            assert!(0x2::vec_set::contains<address>(&arg0.admins, &arg2), 18);
            assert!(0x2::vec_set::size<address>(&arg0.admins) > 1, 6);
        } else if (arg1 == 2) {
            assert!(!0x2::vec_set::contains<address>(0x2::table::borrow<u8, 0x2::vec_set::VecSet<address>>(&arg0.roles, arg3), &arg2), 19);
        } else if (arg1 == 3) {
            assert!(0x2::vec_set::contains<address>(0x2::table::borrow<u8, 0x2::vec_set::VecSet<address>>(&arg0.roles, arg3), &arg2), 20);
        };
    }
