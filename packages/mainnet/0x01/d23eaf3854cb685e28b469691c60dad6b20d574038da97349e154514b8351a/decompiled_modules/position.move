module 0x1d23eaf3854cb685e28b469691c60dad6b20d574038da97349e154514b8351a::position {
    ...
    struct PositionManager has store {
        tick_spacing: u32,
        position_index: u64,
        positions: 0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::LinkedTable<0x2::object::ID, PositionInfo>,
    }
    ...
    struct Position has store, key {
        ...
        tick_lower_index: 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32,
        tick_upper_index: 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32,
        liquidity: u128,
    }
    ...
    public(friend) fun new(arg0: u32, arg1: &mut 0x2::tx_context::TxContext) : PositionManager {
        PositionManager{
            tick_spacing   : arg0,
            position_index : 0,
            positions      : 0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::new<0x2::object::ID, PositionInfo>(arg1),
        }
    }

    fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 6);
        let v0 = 0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::borrow_mut<0x2::object::ID, PositionInfo>(&mut arg0.positions, arg1);
    ...
    public fun borrow_position_info(arg0: &PositionManager, arg1: 0x2::object::ID) : &PositionInfo {
        assert!(0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 6);
        let v0 = 0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::borrow<0x2::object::ID, PositionInfo>(&arg0.positions, arg1);
        assert!(v0.position_id == arg1, 6);
        v0
    }

    public fun check_position_tick_range(arg0: 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32, arg1: 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32, arg2: u32) {
        assert!(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::lt(arg0, arg1) && 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::gte(arg0, 0x1d23eaf3854cb685e28b469691c60dad6b20d574038da97349e154514b8351a::tick_math::min_tick()) && 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::lte(arg1, 0x1d23eaf3854cb685e28b469691c60dad6b20d574038da97349e154514b8351a::tick_math::max_tick()) && 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::mod(arg0, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::from(arg2)) == 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::zero() && 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::mod(arg1, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::from(arg2)) == 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::zero(), 5);
    }
    ...
    public(friend) fun close_position(arg0: &mut PositionManager, arg1: Position) {
        ...
        0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::remove<0x2::object::ID, PositionInfo>(&mut arg0.positions, v0);
        destroy(arg1);
    }
    ...
    public fun fetch_positions(arg0: &PositionManager, arg1: vector<0x2::object::ID>, arg2: u64) : vector<PositionInfo> {
        ...
        let v1 = if (0x1::vector::is_empty<0x2::object::ID>(&arg1)) {
            0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::head<0x2::object::ID, PositionInfo>(&arg0.positions)
        } else {
            0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::next<0x2::object::ID, PositionInfo>(0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::borrow_node<0x2::object::ID, PositionInfo>(&arg0.positions, *0x1::vector::borrow<0x2::object::ID>(&arg1, 0)))
        };
        let v2 = v1;
        let v3 = 0;
        while (0x1::option::is_some<0x2::object::ID>(&v2)) {
            let v4 = 0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::borrow_node<0x2::object::ID, PositionInfo>(&arg0.positions, *0x1::option::borrow<0x2::object::ID>(&v2));
            v2 = 0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::next<0x2::object::ID, PositionInfo>(v4);
            0x1::vector::push_back<PositionInfo>(&mut v0, *0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::borrow_value<0x2::object::ID, PositionInfo>(v4));
            let v5 = v3 + 1;
            v3 = v5;
            if (v5 == arg2) {
                break
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: vector<u128>, arg7: u128) : u128 {
        ...
        update_rewards_internal(v0, arg6);
        update_magma_distribution_internal(v0, arg7);
        assert!(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u128::add_check(v0.liquidity, arg2), 8);
        v0.liquidity = v0.liquidity + arg2;
        arg1.liquidity = v0.liquidity;
        v0.liquidity
    }
    ...
    public fun info_tick_range(arg0: &PositionInfo) : (0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32) {
    ...
    public fun inited_rewards_count(arg0: &PositionManager, arg1: 0x2::object::ID) : u64 {
        0x1::vector::length<PositionReward>(&0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::borrow<0x2::object::ID, PositionInfo>(&arg0.positions, arg1).rewards)
    }

    public fun is_position_exist(arg0: &PositionManager, arg1: 0x2::object::ID) : bool {
        0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1)
    }
    ...
    fun new_position_name(arg0: u64, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x1d23eaf3854cb685e28b469691c60dad6b20d574038da97349e154514b8351a::utils::str(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0x1d23eaf3854cb685e28b469691c60dad6b20d574038da97349e154514b8351a::utils::str(arg1));
        v0
    }

    public(friend) fun open_position<T0, T1>(arg0: &mut PositionManager, arg1: 0x2::object::ID, arg2: u64, arg3: 0x1::string::String, arg4: 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32, arg5: 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32, arg6: &mut 0x2::tx_context::TxContext) : Position {
        ...
        0x646af00bcbf03c9b705540f87eb4109afdbebee3e12ba216ec82f3b3bfe05fc6::linked_table::push_back<0x2::object::ID, PositionInfo>(&mut arg0.positions, v2, v3);
    ...
    public fun set_display(arg0: &0x1d23eaf3854cb685e28b469691c60dad6b20d574038da97349e154514b8351a::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun tick_range(arg0: &Position) : (0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::i32::I32) {
        (arg0.tick_lower_index, arg0.tick_upper_index)
    }
    ...
    fun update_fee_internal(arg0: &mut PositionInfo, arg1: u128, arg2: u128) {
        let v0 = (0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::full_math_u128::mul_shr(arg0.liquidity, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u128::wrapping_sub(arg1, arg0.fee_growth_inside_a), 64) as u64);
        let v1 = (0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::full_math_u128::mul_shr(arg0.liquidity, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u128::wrapping_sub(arg2, arg0.fee_growth_inside_b), 64) as u64);
        assert!(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u64::add_check(arg0.fee_owned_a, v0), 1);
        assert!(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u64::add_check(arg0.fee_owned_b, v1), 1);
    ...
    fun update_magma_distribution_internal(arg0: &mut PositionInfo, arg1: u128) {
        let v0 = (0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::full_math_u128::mul_shr(arg0.liquidity, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u128::wrapping_sub(arg1, arg0.magma_distribution_growth_inside), 64) as u64);
        assert!(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u64::add_check(arg0.magma_distribution_owned, v0), 9223374347547181055);
    ...
    fun update_points_internal(arg0: &mut PositionInfo, arg1: u128) {
        let v0 = 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::full_math_u128::mul_shr(arg0.liquidity, 0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u128::wrapping_sub(arg1, arg0.points_growth_inside), 64);
        assert!(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u128::add_check(arg0.points_owned, v0), 3);
    ...
    fun update_rewards_internal(arg0: &mut PositionInfo, arg1: vector<u128>) {
        ...
        while (v0 < 0x1::vector::length<u128>(&arg1)) {
            ...
            if (0x1::vector::length<PositionReward>(&arg0.rewards) > v0) {
                ...
                let v3 = (0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::full_math_u128::mul_shr(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u128::wrapping_sub(v1, v2.growth_inside), arg0.liquidity, 64) as u64);
                assert!(0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::math_u64::add_check(v2.amount_owned, v3), 1);
                v2.growth_inside = v1;
                v2.amount_owned = v2.amount_owned + v3;
            } else {
                let v4 = PositionReward{
                    growth_inside : v1,
                    amount_owned  : (0x810344e626dbc98b93565b08cc435ead55513182604bae4f34b4228dfb2a680d::full_math_u128::mul_shr(v1, arg0.liquidity, 64) as u64),
                };
