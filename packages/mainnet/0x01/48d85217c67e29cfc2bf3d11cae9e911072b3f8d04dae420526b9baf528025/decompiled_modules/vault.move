module 0xde111311106fdfe3279bb3612b17792ebe40b62180f25d3cfbedbbd357a9c3a1::vault {
    ...
    public fun coin_loan<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, Receipt<T0>) {
    ...
    public entry fun create0<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun donate<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>) {
    ...
    public fun loan<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, Receipt<T0>, u64) {
        let v0 = &mut arg0.to_lend;
        assert!(0x2::balance::value<T0>(v0) >= arg1, 0);
        let v1 = 0x2::coin::take<T0>(v0, arg1, arg2);
        let v2 = arg1 + arg1 / 10000 * arg0.fee_bps + arg0.fee_fix;
        let v3 = Receipt<T0>{
            vault_id     : 0x2::object::id<Vault<T0>>(arg0),
            repay_amount : v2,
        };
    ...
    public fun loan_<T0>(arg0: &mut Vault<T0>, arg1: u64) : (0x2::balance::Balance<T0>, Receipt<T0>, u64) {
        let v0 = &mut arg0.to_lend;
        assert!(0x2::balance::value<T0>(v0) >= arg1, 0);
    ...
    public fun repay_<T0>(arg0: &mut Vault<T0>, arg1: 0x2::balance::Balance<T0>, arg2: Receipt<T0>) {
        ...
        assert!(0x2::object::id<Vault<T0>>(arg0) == v0, 2);
        assert!(0x2::balance::value<T0>(&arg1) >= v1, 1);
