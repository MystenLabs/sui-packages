module 0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::registry {
    ...
    public(friend) fun assert_incentive_within_ratio(arg0: &IronBankRegistry, arg1: u64, arg2: u64) {
        assert!(arg1 <= 0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::math::mul(arg2, load_inner(arg0).max_incentive_ratio), 13906835333985730579);
    }
    ...
    public fun max_incentive_ratio(arg0: &IronBankRegistry) : u64 {
        load_inner(arg0).max_incentive_ratio
    }
    ...
    public fun register_entity<T0: drop>(arg0: &mut IronBankRegistry, arg1: &IronBankAdminCap, arg2: &0x2::clock::Clock) {
        ...
        if (!0x2::table::contains<0x1::type_name::TypeName, EntityInfo>(&v0.entities, v1)) {
            ...
            0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::events::emit_entity_registered(v1, v2);
        } else {
            let v4 = 0x2::table::borrow_mut<0x1::type_name::TypeName, EntityInfo>(&mut v0.entities, v1);
            assert!(!v4.enabled, 13906834681149784069);
            v4.enabled = true;
            0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::events::emit_entity_enabled(v1, v2);
        };
    }
    ...
    public fun revoke_entity<T0: drop>(arg0: &mut IronBankRegistry, arg1: &IronBankAdminCap, arg2: &0x2::clock::Clock) {
        ...
        v2.enabled = false;
        0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::events::emit_entity_revoked(v1, 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun set_max_deposit<T0: drop>(arg0: &mut IronBankRegistry, arg1: &IronBankAdminCap, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        v2.max_deposit = arg2;
        0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::events::emit_max_deposit_updated(v1, v3, arg2, 0x2::clock::timestamp_ms(arg3));
    }

    public fun set_max_incentive_ratio(arg0: &mut IronBankRegistry, arg1: &IronBankAdminCap, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg2 <= 0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::constants::max_incentive_ratio_ceiling(), 13906834917373771793);
        let v0 = load_inner_mut(arg0);
        let v1 = v0.max_incentive_ratio;
        if (v1 == arg2) {
            return
        };
        v0.max_incentive_ratio = arg2;
        0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::events::emit_max_incentive_ratio_updated(v1, arg2, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    fun share_new(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = RegistryInner{
            ...
            max_incentive_ratio : 0x1e290a1aa6e278daec347d542a4b81d8fd02ec287b5f97e05c8e206ccdb6f8f::constants::default_max_incentive_ratio(),
        };
