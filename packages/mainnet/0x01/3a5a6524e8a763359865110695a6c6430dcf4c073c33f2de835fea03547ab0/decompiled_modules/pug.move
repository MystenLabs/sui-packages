module 0x13a5a6524e8a763359865110695a6c6430dcf4c073c33f2de835fea03547ab0::pug {
    struct PUG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PUG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<PUG>(&mut v2, 10000000000000000, 0x2::tx_context::sender(arg1), arg1);
