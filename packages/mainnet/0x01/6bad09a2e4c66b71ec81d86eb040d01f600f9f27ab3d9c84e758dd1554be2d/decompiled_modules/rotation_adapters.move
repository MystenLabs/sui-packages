module 0x971d70b4e40312c953adf5f773f326844a03708b0f0dfdb38cc006fc180a48dd::rotation_adapters {
    ...
    struct ManagedBluefinPositionCap<phantom T0, phantom T1, phantom T2> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
        bluefin_pool_id: 0x2::object::ID,
        bluefin_position_id: 0x2::object::ID,
    ...
    struct BluefinVacancyRouteCap<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> has store, key {
        id: 0x2::object::UID,
        registry_id: 0x2::object::ID,
    ...
    struct VacancyRotationReceipt<phantom T0, phantom T1, phantom T2, phantom T3, phantom T4, phantom T5> {
        registry_id: 0x2::object::ID,
    ...
    struct ManagedBluefinPositionRegistered has copy, drop {
        registry_id: 0x2::object::ID,
    ...
    struct BluefinVacancyRouteRegistered has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_bluefin_pool_id: 0x2::object::ID,
        target_bluefin_pool_id: 0x2::object::ID,
    ...
    struct BluefinVacancyRotationBegun has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_managed_cap_id: 0x2::object::ID,
        source_allocation_cap_id: 0x2::object::ID,
    ...
    struct BluefinVacancyRotationSettled has copy, drop {
        registry_id: 0x2::object::ID,
        route_id: 0x2::object::ID,
        source_managed_cap_id: 0x2::object::ID,
        source_allocation_cap_id: 0x2::object::ID,
    ...
    fun assert_bluefin_vacancy_route_owner<T0, T1, T2, T3, T4, T5>(arg0: &Registry, arg1: &BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>, arg2: &0x2::tx_context::TxContext) {
        assert_registry(arg0);
        assert!(arg1.registry_id == 0x2::object::id<Registry>(arg0), 1);
    ...
    public fun authenticate_bluefin_vacancy_cetus_pool<T0, T1, T2, T3, T4, T5, T6, T7>(arg0: &Registry, arg1: &BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>, arg2: VacancyRotationReceipt<T0, T1, T2, T3, T4, T5>, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T6, T7>, arg4: &0x2::tx_context::TxContext) : VacancyRotationReceipt<T0, T1, T2, T3, T4, T5> {
        assert_bluefin_vacancy_route_owner<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg4);
        assert!(arg2.registry_id == 0x2::object::id<Registry>(arg0), 1);
        assert!(arg2.route_id == 0x2::object::id<BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>>(arg1), 1);
    ...
    public fun begin_bluefin_vacancy_rotation<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &Registry, arg2: &BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>, arg3: ManagedBluefinPositionCap<T0, T1, T2>, arg4: KaiStableAllocationCap<T0, T1>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg7: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg8: 0x2::balance::Balance<T0>, arg9: 0x2::balance::Balance<T1>, arg10: u128, arg11: u32, arg12: u32, arg13: u64, arg14: u64, arg15: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, VacancyRotationReceipt<T0, T1, T2, T3, T4, T5>) {
        assert_bluefin_vacancy_route_owner<T0, T1, T2, T3, T4, T5>(arg1, arg2, arg15);
        let v0 = 0x2::object::id<Registry>(arg1);
        let v1 = 0x2::object::id<BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>>(arg2);
        ...
        let v5 = 0x2::object::id<ManagedBluefinPositionCap<T0, T1, T2>>(&arg3);
        let v6 = 0x2::object::id<KaiStableAllocationCap<T0, T1>>(&arg4);
        ...
        let (v10, v11, v12, v13) = close_bluefin_with_fees<T0, T1>(arg0, arg5, arg6, arg7);
        let v14 = v13;
        let v15 = v12;
        let v16 = v11;
        let v17 = v10;
        ...
        let v26 = VacancyRotationReceipt<T0, T1, T2, T3, T4, T5>{
            registry_id                  : v0,
            route_id                     : v1,
        ...
        let v27 = BluefinVacancyRotationBegun{
            registry_id              : v0,
            route_id                 : v1,
            source_managed_cap_id    : v5,
            source_allocation_cap_id : v6,
        ...
        0x2::event::emit<BluefinVacancyRotationBegun>(v27);
        let ManagedBluefinPositionCap {
            id                  : v28,
            registry_id         : _,
            bluefin_pool_id     : _,
            bluefin_position_id : _,
    ...
    public fun finish_bluefin_vacancy_rotation<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &Registry, arg2: &BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>, arg3: VacancyRotationReceipt<T0, T1, T2, T3, T4, T5>, arg4: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg5: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg6: 0x2::balance::Balance<T3>, arg7: 0x2::balance::Balance<T4>, arg8: 0x2::balance::Balance<0x2::sui::SUI>, arg9: u32, arg10: u32, arg11: u64, arg12: bool, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64, arg25: u64, arg26: u64, arg27: u128, arg28: &mut 0x2::tx_context::TxContext) {
        ...
        let (v9, v10) = centered_range(0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::current_tick_index<T3, T4>(arg5), v8 * 2, v8);
        assert!(arg9 == v9, 3);
        assert!(arg10 == v10, 3);
        ...
        let v23 = ManagedBluefinPositionCap<T3, T4, T5>{
        ...
        let v24 = KaiStableAllocationCap<T3, T4>{
            id                  : 0x2::object::new(arg28),
            registry_id         : v0,
            bluefin_pool_id     : v2,
            bluefin_position_id : v12,
        ...
        let v25 = BluefinVacancyRotationSettled{
            registry_id                   : v0,
            route_id                      : v1,
            source_managed_cap_id         : arg3.source_managed_cap_id,
            source_allocation_cap_id      : arg3.source_allocation_cap_id,
            replacement_managed_cap_id    : 0x2::object::id<ManagedBluefinPositionCap<T3, T4, T5>>(&v23),
            replacement_allocation_cap_id : 0x2::object::id<KaiStableAllocationCap<T3, T4>>(&v24),
        ...
        0x2::event::emit<BluefinVacancyRotationSettled>(v25);
        let VacancyRotationReceipt {
            registry_id                  : _,
            route_id                     : _,
        ...
        0x2::transfer::public_transfer<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(v11, v3);
        transfer_nonzero<T3>(v18, v3, arg28);
        transfer_nonzero<T4>(v17, v3, arg28);
        0x2::transfer::public_transfer<ManagedBluefinPositionCap<T3, T4, T5>>(v23, v3);
        0x2::transfer::public_transfer<KaiStableAllocationCap<T3, T4>>(v24, v3);
    }
    ...
    fun mint_bluefin_vacancy_route<T0, T1, T2, T3, T4, T5>(arg0: &Registry, arg1: &AdminCap, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg4: vector<0x2::object::ID>, arg5: u32, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>{
        ...
        let v7 = BluefinVacancyRouteRegistered{
            registry_id            : v1,
            route_id               : 0x2::object::id<BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>>(&v6),
            source_bluefin_pool_id : v2,
            target_bluefin_pool_id : v3,
            owner_authority        : arg6,
            target_tick_spacing    : arg5,
        ...
        0x2::event::emit<BluefinVacancyRouteRegistered>(v7);
        0x2::transfer::public_transfer<BluefinVacancyRouteCap<T0, T1, T2, T3, T4, T5>>(v6, arg6);
    }
    ...
    public fun register_bluefin_vacancy_route_1<T0, T1, T2, T3, T4, T5, T6, T7>(arg0: &Registry, arg1: &AdminCap, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T6, T7>, arg5: u32, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        mint_bluefin_vacancy_route<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg2, arg3, v0, arg5, arg6, arg7);
    }

    public fun register_bluefin_vacancy_route_2<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>(arg0: &Registry, arg1: &AdminCap, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T3, T4>, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T6, T7>, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T8, T9>, arg6: u32, arg7: address, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        mint_bluefin_vacancy_route<T0, T1, T2, T3, T4, T5>(arg0, arg1, arg2, arg3, v2, arg6, arg7, arg8);
    }
    ...
    public fun register_managed_bluefin_position<T0, T1, T2>(arg0: &Registry, arg1: &AdminCap, arg2: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg4: u32, arg5: u32, arg6: address, arg7: &mut 0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1);
        assert!(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg4), 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg5)), 3);
        let v0 = 0x2::object::id<Registry>(arg0);
        let v1 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>>(arg2);
        let v2 = 0x2::object::id<0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position>(arg3);
        let v3 = ManagedBluefinPositionCap<T0, T1, T2>{
            id                  : 0x2::object::new(arg7),
            registry_id         : v0,
            bluefin_pool_id     : v1,
            bluefin_position_id : v2,
        ...
        let v4 = ManagedBluefinPositionRegistered{
            registry_id         : v0,
            managed_cap_id      : 0x2::object::id<ManagedBluefinPositionCap<T0, T1, T2>>(&v3),
            bluefin_pool_id     : v1,
            bluefin_position_id : v2,
            owner_authority     : arg6,
            tick_lower          : arg4,
        ...
        0x2::event::emit<ManagedBluefinPositionRegistered>(v4);
        0x2::transfer::public_transfer<ManagedBluefinPositionCap<T0, T1, T2>>(v3, arg6);
    }
