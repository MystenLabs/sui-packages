module 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_cetus_swap {
    ...
    public fun inner(arg0: &CetusSwapPromise) : &CetusSwap {
        &arg0.swap
    }

    public fun input_output_types(arg0: &CetusSwap) : (&0x1::type_name::TypeName, &0x1::type_name::TypeName) {
        if (arg0.a2b) {
            (&arg0.type_a, &arg0.type_b)
        } else {
            (&arg0.type_b, &arg0.type_a)
        }
    }
    ...
    public fun new<T0, T1>(arg0: &0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_admin::BBBAdminCap, arg1: bool, arg2: u8, arg3: u8, arg4: vector<u8>, arg5: vector<u8>, arg6: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: u64, arg8: u64) : CetusSwap {
    ...
    fun swap_internal<T0, T1>(arg0: CetusSwapPromise, arg1: &mut 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::BBBVault, arg2: u64, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::get_price_info_from_price_info_object(arg4);
        let v4 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::get_price_identifier(&v3);
        assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v2) == v0.feed_a, 1001);
        assert!(0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_identifier::get_bytes(&v4) == v0.feed_b, 1002);
        assert!(0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>>(arg6) == v0.pool_id, 1000);
        let v5 = 0x1::type_name::get<T0>();
        let v6 = 0x1::type_name::get<T1>();
        assert!(v5 == v0.type_a, 1003);
        assert!(v6 == v0.type_b, 1004);
        if (v0.a2b) {
            let v7 = if (arg2 > 0) {
                0x2::coin::from_balance<T0>(0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::withdraw_partial<T0>(arg1, arg2), arg8)
            } else {
                0x2::coin::from_balance<T0>(0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::withdraw<T0>(arg1), arg8)
            };
            let v8 = v7;
            ...
            let v10 = 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_pyth::calc_amount_out(arg3, arg4, v0.decimals_a, v0.decimals_b, v9, v0.max_age_secs, arg7);
            let v11 = swap_a2b<T0, T1>(arg5, arg6, v8, arg7, arg8);
            let v12 = 0x2::coin::value<T1>(&v11);
            assert!(v12 >= (((v10 as u256) * (v0.slippage as u256) / 1000000000000000000) as u64), 1005);
            0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::deposit<T1>(arg1, v11);
            let v13 = CetusSwapEvent{
            ...
            0x2::event::emit<CetusSwapEvent>(v13);
        } else {
            let v14 = if (arg2 > 0) {
                0x2::coin::from_balance<T1>(0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::withdraw_partial<T1>(arg1, arg2), arg8)
            } else {
                0x2::coin::from_balance<T1>(0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::withdraw<T1>(arg1), arg8)
            };
            let v15 = v14;
            ...
            let v17 = 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_pyth::calc_amount_out(arg4, arg3, v0.decimals_b, v0.decimals_a, v16, v0.max_age_secs, arg7);
            let v18 = swap_b2a<T0, T1>(arg5, arg6, v15, arg7, arg8);
            let v19 = 0x2::coin::value<T0>(&v18);
            assert!(v19 >= (((v17 as u256) * (v0.slippage as u256) / 1000000000000000000) as u64), 1005);
            0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::deposit<T0>(arg1, v18);
            let v20 = CetusSwapEvent{
                type_in      : 0x1::type_name::into_string(v6),
                type_out     : 0x1::type_name::into_string(v5),
                amount_in    : v16,
                amount_out   : v19,
                expected_out : v17,
            };
    ...
    public fun swap_partial<T0, T1>(arg0: CetusSwapPromise, arg1: &mut 0x6268d072063a311f6f0a1db516d06d97c06a3fa6d10e797cad578937a47b3992::bbb_vault::BBBVault, arg2: u64, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg5: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg6: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        swap_internal<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8);
    }
