module 0x1db3a54b99c2741bf8b8aaa8266d6e7b6daf0c702a5ef5b0d6e9e6cf12527a90::gateway {
    ...
    struct MessageContext has store, key {
        id: 0x2::object::UID,
        sender: 0x1::ascii::String,
        target: address,
    }
    ...
    public fun active_message_context(arg0: &Gateway) : 0x2::object::ID {
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"active_message_context")) {
            *0x2::dynamic_field::borrow<vector<u8>, 0x2::object::ID>(&arg0.id, b"active_message_context")
        } else {
    ...
    public entry fun donate<T0>(arg0: &mut Gateway, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        check_receiver_and_deposit_to_vault<T0>(arg0, arg1, 0x1::ascii::string(b"0x0000000000000000000000000000000000000000"));
        let v0 = DonateEvent{
            coin_type : coin_name<T0>(),
            amount    : 0x2::coin::value<T0>(&arg1),
    ...
    entry fun increase_nonce(arg0: &mut Gateway, arg1: u64, arg2: u64, arg3: &WithdrawCap, arg4: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = withdraw_impl<0x2::sui::SUI>(arg0, 0, arg1, arg2, arg3, arg4);
        0x2::coin::destroy_zero<0x2::sui::SUI>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v1, 0x2::tx_context::sender(arg4));
        let v2 = NonceIncreaseEvent{
            sender : 0x2::tx_context::sender(arg4),
            nonce  : arg0.nonce,
        };
        0x2::event::emit<NonceIncreaseEvent>(v2);
    }
    ...
    entry fun issue_message_context(arg0: &mut Gateway, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = issue_message_context_impl(arg0, arg1, arg2);
        0x2::transfer::transfer<MessageContext>(v0, 0x2::tx_context::sender(arg2));
    }

    public fun issue_message_context_impl(arg0: &mut Gateway, arg1: &AdminCap, arg2: &mut 0x2::tx_context::TxContext) : MessageContext {
        0x2::dynamic_field::remove_if_exists<vector<u8>, 0x2::object::ID>(&mut arg0.id, b"active_message_context");
        let v0 = MessageContext{
            id     : 0x2::object::new(arg2),
            sender : 0x1::ascii::string(b""),
            target : @0x0,
        };
        0x2::dynamic_field::add<vector<u8>, 0x2::object::ID>(&mut arg0.id, b"active_message_context", 0x2::object::id<MessageContext>(&v0));
        v0
    }
    ...
    public fun message_context_sender(arg0: &MessageContext) : 0x1::ascii::String {
        arg0.sender
    }

    public fun message_context_target(arg0: &MessageContext) : address {
        arg0.target
    }
    ...
    entry fun refund<T0>(arg0: &mut Gateway, arg1: u64, arg2: address, arg3: &AdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = refund_impl<T0>(arg0, arg1, arg2, arg3, arg4);
    ...
    public fun refund_impl<T0>(arg0: &mut Gateway, arg1: u64, arg2: address, arg3: &AdminCap, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(arg2 != @0x0, 1);
        assert!(arg1 > 0, 10);
        let v0 = coin_name<T0>();
        assert!(0x2::bag::contains_with_type<0x1::ascii::String, Vault<T0>>(&arg0.vaults, v0), 9);
        0x2::coin::take<T0>(&mut 0x2::bag::borrow_mut<0x1::ascii::String, Vault<T0>>(&mut arg0.vaults, v0).balance, arg1, arg4)
    }

    entry fun reset_message_context(arg0: &mut MessageContext) {
        arg0.sender = 0x1::ascii::string(b"");
        arg0.target = @0x0;
    }
    ...
    entry fun set_message_context(arg0: &mut MessageContext, arg1: 0x1::ascii::String, arg2: address) {
        assert!(0x1db3a54b99c2741bf8b8aaa8266d6e7b6daf0c702a5ef5b0d6e9e6cf12527a90::evm::is_valid_evm_address(arg1), 8);
        assert!(arg2 != @0x0, 1);
        arg0.sender = arg1;
        arg0.target = arg2;
    }
