module 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::alphapool {
    ...
    public fun deposit<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::version::Version, arg1: 0x1::option::Option<Receipt>, arg2: &mut Pool<T0>, arg3: &mut 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<Receipt> {
        ...
        assert!(!0x1::option::is_some<Receipt>(&arg1), 13906835595977555967);
    ...
    public fun destroy_alpha_receipt<T0, T1: drop>(arg0: Receipt, arg1: &Pool<T0>, arg2: T1, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(0x1::type_name::get_address(&v0) == *0x2::dynamic_field::borrow<vector<u8>, 0x1::ascii::String>(&arg1.id, b"authorized_package_id"), 13906834792818671615);
        let Receipt {
            id                         : v1,
            owner                      : v2,
            name                       : _,
        ...
        let v11 = v8;
        assert!(v2 == 0x2::tx_context::sender(arg3), 13906834801408606207);
    ...
    public fun remove_alpha<T0, T1: drop>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::AdminCap, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::version::Version, arg2: &mut Pool<T0>, arg3: &mut 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg4: T1, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, u64) {
