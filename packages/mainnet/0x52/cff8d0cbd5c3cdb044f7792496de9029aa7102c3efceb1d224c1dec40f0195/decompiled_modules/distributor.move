module 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor {
    ...
    public fun new_rebalance_cap(arg0: &AdminCap, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::version::assert_current_version(arg1);
        let v0 = RebalanceCap{id: 0x2::object::new(arg2)};
        0x2::transfer::public_transfer<RebalanceCap>(v0, 0x2::tx_context::sender(arg2));
    }
