module 0x52fce18dced00486c196eb7663cfd31bd6d1588576dce809c94fb5ca1556ef4f::gift5241 {
    struct GIFT5241 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift5241(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT5241, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5241>(arg0, arg1);
