module 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::math {
    public fun div_down(arg0: u64, arg1: u64) : u64 {
        (((arg0 as u128) * 1000000000 / (arg1 as u128)) as u64)
    }

    public fun exp(arg0: &0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::I64) : u64 {
        let v0 = 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::magnitude(arg0);
        let v1 = 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::is_negative(arg0);
        if (v0 == 0) {
            return 1000000000
        };
    ...
    public fun ln(arg0: u64) : 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::I64 {
        assert!(arg0 > 0, 0);
        if (arg0 == 1000000000) {
            return 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::zero()
        };
        if (arg0 < 1000000000) {
            let v0 = ln(((1000000000 * 1000000000 / (arg0 as u128)) as u64));
            return 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::neg(&v0)
        };
        let (v1, v2) = normalize(arg0);
        0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::from_u64((ln_u128((v1 as u128), (v2 as u128)) as u64))
    }
    ...
    public fun normal_cdf(arg0: &0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::I64) : u64 {
        let v0 = 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::magnitude(arg0);
        if (v0 > 8000000000) {
            return if (0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::is_negative(arg0)) {
                0
            } else {
                1000000000
            }
        };
        (normal_cdf_u128((v0 as u128), 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::is_negative(arg0)) as u64)
    }
    ...
    public fun normal_pdf(arg0: &0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::I64) : u64 {
        let v0 = 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::magnitude(arg0);
        if (v0 > 8000000000) {
            return 0
        };
        let v1 = 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::i64::from_parts((((v0 as u128) * (v0 as u128) / 2 * 1000000000) as u64), true);
