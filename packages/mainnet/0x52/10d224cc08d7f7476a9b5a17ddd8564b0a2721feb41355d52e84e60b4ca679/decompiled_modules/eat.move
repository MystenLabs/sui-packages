module 0x5210d224cc08d7f7476a9b5a17ddd8564b0a2721feb41355d52e84e60b4ca679::eat {
    struct EAT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: EAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<EAT>(&mut v3, 99000000000000, 0x2::tx_context::sender(arg1), arg1);
