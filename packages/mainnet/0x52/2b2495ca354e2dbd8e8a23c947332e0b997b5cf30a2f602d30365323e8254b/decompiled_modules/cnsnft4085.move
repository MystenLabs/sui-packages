module 0x522b2495ca354e2dbd8e8a23c947332e0b997b5cf30a2f602d30365323e8254b::cnsnft4085 {
    struct CNSNFT4085 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4085, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5095"));
        let v4 = 0x2::package::claim<CNSNFT4085>(arg0, arg1);
