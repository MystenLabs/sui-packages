module 0x1f087b0343dccd6f8353cf448ae9b7885e54ee34e2d0cf398b386b9cfa808a97::atlansui {
    ...
    struct NewCollection<phantom T0, phantom T1: store + key> has store, key {
        id: 0x2::object::UID,
        balance: 0x2::balance::Balance<T0>,
        total_value: u64,
    ...
    public fun accept_offer_with_kiosk<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, NewCollection<T0, T1>>(&mut arg0.id, arg1);
    ...
    public fun accept_offer_with_kiosk_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: address, arg5: u64, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: 0x2::object::ID, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<T0>(&v16) > v9.value) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v17, v9.value, arg10), v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v17, arg10), v9.creator);
        } else {
    ...
    public fun accept_offer_with_nft_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: address, arg5: u64, arg6: T1, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<T0>(&v25) > v9.value) {
            let v26 = 0x2::coin::into_balance<T0>(v25);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v26, v9.value, arg8), v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v26, arg8), v9.creator);
        } else {
        ...
        let v27 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : v15,
            creator            : v9.creator,
            borrower           : v0,
        ...
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v27);
    }
    ...
    public fun accept_offer_with_originbyte_kiosk_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: address, arg5: u64, arg6: &mut 0x2::kiosk::Kiosk, arg7: 0x2::object::ID, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::coin::value<T0>(&v17) > v9.value) {
            let v18 = 0x2::coin::into_balance<T0>(v17);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v18, v9.value, arg9), v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v18, arg9), v9.creator);
        } else {
    ...
    public fun cancel_offer<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, arg1), 2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, NewCollection<T0, T1>>(&mut arg0.id, arg1);
    ...
    public entry fun change_interest<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &AdminCap, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::dynamic_object_field::borrow_mut<0x2::object::ID, NewCollection<T0, T1>>(&mut arg0.id, arg1).interest = arg3;
    }
    ...
    public entry fun change_loan_duration<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &AdminCap, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        0x2::dynamic_object_field::borrow_mut<0x2::object::ID, NewCollection<T0, T1>>(&mut arg0.id, arg1).loan_duration = arg3;
    }
    ...
    public fun create_collection<T0, T1: store + key>(arg0: &mut Platform, arg1: &AdminCap, arg2: 0x1::ascii::String, arg3: 0x1::ascii::String, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::object::id<NewCollection<T0, T1>>(&v0);
        0x2::dynamic_object_field::add<0x2::object::ID, NewCollection<T0, T1>>(&mut arg0.id, v1, v0);
    ...
    public fun create_offer<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        v2.total_value = v2.total_value + arg3;
    ...
    public fun create_offer_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = CreateOfferWithScallopEvent<Collection<T0, T1>>{
        ...
        0x2::event::emit<CreateOfferWithScallopEvent<Collection<T0, T1>>>(v9);
    }
    ...
    public fun deposit_into_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<ScallopKey<T0>, Scallop<T0>>(&mut v3.id, v7, v8);
        v1.total_scoin_value = v1.total_scoin_value + v6;
        let v9 = ScallopDepositEvent<Collection<T0, T1>>{
            id           : 0x2::object::id<Offer>(v3),
            key          : arg4,
            collection   : v1.name,
            creator      : v0,
        ...
        0x2::event::emit<ScallopDepositEvent<Collection<T0, T1>>>(v9);
    }
    ...
    public entry fun emergency_remove_auth_transfer<T0, T1: store + key>(arg0: &AdminCap, arg1: &mut Platform, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x95a441d389b07437d00dd07e0b6f05f513d7659b13fd7c5d3923c7d9d847199b::ob_kiosk::remove_auth_transfer(arg3, arg4, &0x2::dynamic_object_field::borrow<0x2::object::ID, NewCollection<T0, T1>>(&arg1.id, arg2).id);
    }
    ...
    public entry fun emergency_remove_purchase_cap<T0, T1: store + key>(arg0: &AdminCap, arg1: &mut Platform, arg2: 0x2::object::ID, arg3: address, arg4: u64, arg5: &mut 0x2::kiosk::Kiosk, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg1.id, arg2), 2);
        let v0 = 0x2::vec_map::get_mut<address, Offers>(&mut 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, NewCollection<T0, T1>>(&mut arg1.id, arg2).offers, &arg3);
    ...
    public entry fun migrate_collection<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &AdminCap, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, arg1), 2);
        let Collection {
            id               : v0,
            balance          : v1,
            ...
            best_offer_user  : v8,
            best_idx         : v9,
        } = 0x2::dynamic_object_field::remove<0x2::object::ID, Collection<T0, T1>>(&mut arg0.id, arg1);
        let v10 = v1;
        let v11 = NewCollection<T0, T1>{
            id                : 0x2::object::new(arg3),
            balance           : v10,
            total_value       : 0x2::balance::value<T0>(&v10),
            total_scoin_value : 0,
            offers            : v2,
            interest          : v3,
            name              : v4,
        ...
        0x2::dynamic_object_field::add<0x2::object::ID, NewCollection<T0, T1>>(&mut arg0.id, 0x2::object::id<NewCollection<T0, T1>>(&v11), v11);
