module 0x52bdaf1b07ae1799274312513779ccdc7f2d4013733ae7dd634353adc2b4a61a::reward2366 {
    struct REWARD2366 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeReward2366(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: REWARD2366, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2366>(arg0, arg1);
