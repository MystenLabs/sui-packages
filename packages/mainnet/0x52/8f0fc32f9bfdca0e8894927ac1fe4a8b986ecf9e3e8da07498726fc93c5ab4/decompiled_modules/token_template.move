module 0x528f0fc32f9bfdca0e8894927ac1fe4a8b986ecf9e3e8da07498726fc93c5ab4::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT1744703", b"BatchToken1 744703", b"First serial deployment", 0x1::option::none<0x2::url::Url>(), arg1);
