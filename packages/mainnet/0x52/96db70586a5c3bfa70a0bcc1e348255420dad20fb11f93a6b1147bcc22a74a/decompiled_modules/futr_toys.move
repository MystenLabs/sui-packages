module 0x5296db70586a5c3bfa70a0bcc1e348255420dad20fb11f93a6b1147bcc22a74a::futr_toys {
    struct FUTR_TOYS has drop {
        dummy_field: bool,
    }

    struct dsddsf has store, key {
        id: 0x2::object::UID,
        issue: u64,
        token_id: u64,
    ...
    public fun add_new_toy(arg0: &0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::registry::RegistryCap, arg1: &mut 0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::registry::Registry, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>) {
        0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::registry::add_new_toy<dsddsf>(arg1, arg0, 0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::toy::create(0x1::string::utf8(b"dsddsf"), 23, 0x1::string::utf8(b"fdsfds"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/TBohCEFSw9WgQfc44auQL7QlP5qsX-tDPOjPHQT0YvYBAQAKAA"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/TBohCEFSw9WgQfc44auQL7QlP5qsX-tDPOjPHQT0YvYBWACVAg"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/TBohCEFSw9WgQfc44auQL7QlP5qsX-tDPOjPHQT0YvYBCgBYAA"), 0x2::vec_map::from_keys_values<0x1::string::String, 0x1::string::String>(arg2, arg3), 0, 10));
    }

    public fun burn(arg0: dsddsf, arg1: &mut 0x2::tx_context::TxContext) {
        let dsddsf {
            id          : v0,
            issue       : _,
            token_id    : _,
    ...
    public fun init_display(arg0: &mut 0x2::display_registry::DisplayRegistry, arg1: 0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::string::utf8(b"dsddsf");
        ...
        let (v5, v6) = 0x2::display_registry::new_with_publisher<dsddsf>(arg0, &mut arg1, arg2);
        let v7 = v6;
        let v8 = v5;
        let v9 = 0;
        while (v9 < 0x1::vector::length<0x1::string::String>(&v0)) {
            0x2::display_registry::set<dsddsf>(&mut v8, &v7, *0x1::vector::borrow<0x1::string::String>(&v0, v9), *0x1::vector::borrow<0x1::string::String>(&v3, v9));
            v9 = v9 + 1;
        };
        0x2::display_registry::share<dsddsf>(v8);
        0x2::transfer::public_transfer<0x2::display_registry::DisplayCap<dsddsf>>(v7, 0x2::tx_context::sender(arg2));
    ...
    public fun premint_toys(arg0: &0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::store::StoreCap, arg1: &mut 0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::store::Store, arg2: &mut 0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::registry::Registry, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<dsddsf>();
        let v1 = 0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::registry::borrow_toy<dsddsf>(arg2);
        let v2 = 1;
        while (v2 <= arg3) {
            let v3 = dsddsf{
            ...
            0x1::vector::push_back<dsddsf>(&mut v0, v3);
            v2 = v2 + 1;
        };
        0x4ae76c2ed29d3ffeda5444af9bdf45317ef76b157d0db9c6f99165d3cf324b19::store::add_preminted<dsddsf>(arg1, arg0, arg2, v0, arg4);
