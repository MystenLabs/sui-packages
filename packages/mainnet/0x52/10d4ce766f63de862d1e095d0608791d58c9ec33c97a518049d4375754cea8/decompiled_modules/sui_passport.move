module 0x5210d4ce766f63de862d1e095d0608791d58c9ec33c97a518049d4375754cea8::sui_passport {
    ...
    public fun hide_stamp(arg0: &mut SuiPassport, arg1: &0x5210d4ce766f63de862d1e095d0608791d58c9ec33c97a518049d4375754cea8::stamp::Stamp, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::object::id<0x5210d4ce766f63de862d1e095d0608791d58c9ec33c97a518049d4375754cea8::stamp::Stamp>(arg1);
        if (0x2::table::contains<0x2::object::ID, bool>(&arg0.collections, v0)) {
            *0x2::table::borrow_mut<0x2::object::ID, bool>(&mut arg0.collections, v0) = false;
            ...
            arg0.points = arg0.points + 0x5210d4ce766f63de862d1e095d0608791d58c9ec33c97a518049d4375754cea8::stamp::points(arg1);
    ...
    public fun show_stamp(arg0: &mut SuiPassport, arg1: &0x5210d4ce766f63de862d1e095d0608791d58c9ec33c97a518049d4375754cea8::stamp::Stamp, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::object::id<0x5210d4ce766f63de862d1e095d0608791d58c9ec33c97a518049d4375754cea8::stamp::Stamp>(arg1);
        if (0x2::table::contains<0x2::object::ID, bool>(&arg0.collections, v0)) {
