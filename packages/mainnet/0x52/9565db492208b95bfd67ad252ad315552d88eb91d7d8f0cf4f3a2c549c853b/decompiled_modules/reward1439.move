module 0x529565db492208b95bfd67ad252ad315552d88eb91d7d8f0cf4f3a2c549c853b::reward1439 {
    struct REWARD1439 has drop {
        dummy_field: bool,
    }

    struct TICKET_1439 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1439(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1439>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1439>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1439, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1439>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1439>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1439>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1439>>(v5, 0x2::tx_context::sender(arg1));
    }
