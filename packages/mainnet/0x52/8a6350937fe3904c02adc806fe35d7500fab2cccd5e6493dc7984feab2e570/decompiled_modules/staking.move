module 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::staking {
    ...
    public fun pre_staking_v2_deposit(arg0: &mut StakingPoolConfig, arg1: &AirdropPackageCap, arg2: 0x2::coin::Coin<0x76a49ebaf991fa2d4cb6a352af14425d453fe2ba6802b5ed2361b227150b6689::take::TAKE>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.version == 2, 0);
        assert!(!arg0.paused, 8);
        assert!(0x2::table::contains<u64, StakingPool>(&arg0.pool_details, v0), 3);
        let v1 = 0x2::coin::value<0x76a49ebaf991fa2d4cb6a352af14425d453fe2ba6802b5ed2361b227150b6689::take::TAKE>(&arg2);
        assert!(v1 >= 10000, 6);
        let v2 = 0x2::clock::timestamp_ms(arg3);
        update_pool_rewards_internal(arg0, v2);
        let v3 = 0x2::table::borrow_mut<u64, StakingPool>(&mut arg0.pool_details, v0);
        assert!(v3.is_active, 15);
        v3.total_principal = 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::safe_math::safe_add_u64(v3.total_principal, v1);
        let v4 = 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::safe_math::safe_mul_div_u64(v1, v3.multiplier, 100);
        arg0.total_share = 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::safe_math::safe_add_u256(arg0.total_share, (v4 as u256));
        let v5 = StakingReceipt{
            id                      : 0x2::object::new(arg4),
            pool_config_id          : 0x2::object::uid_to_inner(&arg0.id),
            principal_balance       : v1,
            stake_timestamp         : v2,
            lockup_end_timestamp    : 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::safe_math::safe_add_u64(v2, 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::safe_math::safe_mul_u64(v3.lockup_duration_seconds, 1000)),
            lockup_duration_seconds : v0,
            reward_debt             : 0x2b5b2081ce2428bdd67057ed6d62d1112173ded3588eab63ab93c2042a0b296a::safe_math::safe_mul_div_u256((v4 as u256), arg0.acc_reward_per_share, 1000000000000000000),
        };
        0x2::balance::join<0x76a49ebaf991fa2d4cb6a352af14425d453fe2ba6802b5ed2361b227150b6689::take::TAKE>(&mut arg0.principal_balance, 0x2::coin::into_balance<0x76a49ebaf991fa2d4cb6a352af14425d453fe2ba6802b5ed2361b227150b6689::take::TAKE>(arg2));
        let v6 = DepositedEvent{
            pool_id            : 0x2::object::uid_to_inner(&v3.id),
            staking_receipt_id : 0x2::object::uid_to_inner(&v5.id),
            user               : 0x2::tx_context::sender(arg4),
            amount             : v1,
            shares_minted      : (v4 as u256),
            timestamp          : v2,
        };
        0x2::event::emit<DepositedEvent>(v6);
        0x2::transfer::transfer<StakingReceipt>(v5, 0x2::tx_context::sender(arg4));
    }
