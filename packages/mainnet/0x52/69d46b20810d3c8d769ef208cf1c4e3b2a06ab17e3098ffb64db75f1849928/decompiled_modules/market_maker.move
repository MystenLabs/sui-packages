module 0x5269d46b20810d3c8d769ef208cf1c4e3b2a06ab17e3098ffb64db75f1849928::market_maker {
    ...
    public fun place_optimal_order<T0, T1>(arg0: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg1: &0xdee9::custodian_v2::AccountCap, arg2: bool, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            let v8 = 0x1::option::destroy_some<u64>(v7) + 0xdee9::clob_v2::tick_size<T0, T1>(arg0);
            let v9 = mul_div(v2, 1000000000, v8) - 100;
            if (v9 / arg3 > 0) {
                place_limit_order<T0, T1>(arg0, arg1, true, v8, v9 / arg3 * arg3, arg4, arg5);
            };
        } else {
            let v10 = 0x1::option::destroy_some<u64>(v6) - 0xdee9::clob_v2::tick_size<T0, T1>(arg0);
            if (v0 / arg3 > 0) {
                place_limit_order<T0, T1>(arg0, arg1, false, v10, v0 / arg3 * arg3, arg4, arg5);
            };
        };
    }
