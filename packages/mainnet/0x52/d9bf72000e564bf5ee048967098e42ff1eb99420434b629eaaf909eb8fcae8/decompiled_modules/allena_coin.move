module 0x52d9bf72000e564bf5ee048967098e42ff1eb99420434b629eaaf909eb8fcae8::allena_coin {
    ...
    fun init(arg0: ALLENA_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ALLENA_COIN>(arg0, 9, b"ALLENA", b"Allena Coin", b"Allena Coin - Earn Crypto by Working Out", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://public.allena.ai/allenacoin.png")), arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<ALLENA_COIN>>(v1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<ALLENA_COIN>>(v0, 0x2::tx_context::sender(arg1));
    }
