module 0xe14726c336e81b32328e92afc37345d159f5b550b09fa92bd43640cfdd0a0cfd::usdb {
    ...
    public fun claimable_map<T0>(arg0: &Treasury) : &0x2::vec_map::VecMap<0x1::type_name::TypeName, 0x2::balance::Balance<T0>> {
        if (!0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::vec_map::VecMap<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>>(&arg0.id, 0x1::type_name::with_defining_ids<T0>())) {
            err_coin_type_not_found();
        };
        0x2::dynamic_field::borrow<0x1::type_name::TypeName, 0x2::vec_map::VecMap<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>>(&arg0.id, 0x1::type_name::with_defining_ids<T0>())
    }
    ...
    public fun is_claimable_map_exists_type<T0>(arg0: &Treasury) : bool {
        0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::vec_map::VecMap<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>>(&arg0.id, 0x1::type_name::with_defining_ids<T0>())
    }
