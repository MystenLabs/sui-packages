module 0x52beea2a70ff5cb3b757fad3a015b2ece32f95e49811f64fe8a93a390069be98::strip_club {
    struct STRIP_CLUB has drop {
        dummy_field: bool,
    }
    ...
    public entry fun add_nft_metadata(arg0: &0x2::package::Publisher, arg1: &mut 0x7112eaa13769bf331de6c8e42875021fb6ef72e4f5e52dd62f162cb06ef6f603::tradeport_launchpad::Store, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: vector<0x1::string::String>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = AddNftMetadataEvent{
            ...
            type          : arg3,
            index         : arg4,
            collection_id : 0x1::string::utf8(b"4c565dbb-8c3c-44c2-a14d-60eb42724f38"),
        };
    ...
    fun init(arg0: STRIP_CLUB, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STRIP_CLUB>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Strip Club"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x"4f776e2061207069656365206f66207468652066616e746173792e2057656c636f6d6520746f2074686520666f7262696464656e2e20f09f928ef09f9283f09f94a5"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_cover_url"), 0x1::string::utf8(b"ipfs://QmRXkECJMJRscXbsMJV2TsKTeqFD2rf7AzBj6CypXUSsn2"));
