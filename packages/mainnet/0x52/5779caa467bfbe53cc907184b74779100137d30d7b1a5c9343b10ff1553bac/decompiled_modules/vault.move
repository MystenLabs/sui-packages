module 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::vault {
    ...
    fun init(arg0: VAULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3) = 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::constants::lp_token_metadata();
    ...
    fun mint_lp_token(arg0: &mut 0x2::coin::TreasuryCap<VAULT>, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<VAULT> {
        ...
        let v1 = if (v0 == 0) {
            ...
            assert!(v2 > 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::constants::minimal_liquidity(), 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::notEnoughInitialLiquidity());
            v2
        } else {
            0x2::math::min(0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::safe_math::safe_mul_div_u64(arg3, v0, arg1), 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::safe_math::safe_mul_div_u64(arg4, v0, arg2))
        };
        assert!(v1 > 0, 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::liquidityInsufficientMinted());
        0x2::coin::mint<VAULT>(arg0, v1, arg5)
    }

    public fun new_vault<T0, T1>(arg0: &0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::app::AdminCap, arg1: &mut 0x2::tx_context::TxContext) : (Vault<T0, T1>, VaultCap) {
        let v0 = Vault<T0, T1>{
    ...
    public fun process_deposits<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1>(arg1), 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::invalid_vault_cap());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg5)), 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::address_not_whitelisted());
        let v0 = &arg1.deepbook_account_cap;
        let (v1, v2, v3, v4) = get_deepbook_account_assets<T0, T1>(arg1, arg2);
        assert!(v2 == 0, 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::locked_base_asset_found());
        assert!(v4 == 0, 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::locked_quote_asset_found());
        ...
        while (0x1::vector::length<DepositRequest<T1>>(&arg1.deposit_requests) > 0) {
            ...
            let v12 = v10;
            let v13 = if (v3 == 0) {
                0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&v12), 1, 2)
            } else {
                0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::safe_math::safe_mul_div_u64(0x2::balance::value<T1>(&v12), v1, 1000 * v3 + v1)
            };
            let (v14, v15) = 0xdee9::clob_v2::place_market_order<T0, T1>(arg2, v0, 1, 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::safe_math::safe_mul_div_u64(v13, v7, 1000000) * 1000, true, 0x2::coin::zero<T0>(arg5), 0x2::coin::from_balance<T1>(v12, arg5), arg4, arg5);
            let v16 = v15;
            let v17 = v14;
            let v18 = v8 + 0x2::coin::value<T0>(&v17);
            v8 = v18;
            let v19 = v9 + 0x2::coin::value<T1>(&v16);
            v9 = v19;
            0xdee9::clob_v2::deposit_base<T0, T1>(arg2, v17, v0);
            0xdee9::clob_v2::deposit_quote<T0, T1>(arg2, v16, v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<VAULT>>(mint_lp_token(arg3, v18, v19, 0x2::coin::value<T0>(&v17), 0x2::coin::value<T1>(&v16), arg5), v11);
        };
    }
    ...
    public fun process_withdrawals<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg3: &mut 0x2::coin::TreasuryCap<VAULT>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(get_vault_id_from_vault_cap(arg0) == get_vault_id_from_vault<T0, T1>(arg1), 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::invalid_vault_cap());
        assert!(is_address_whitelisted_for_trading<T0, T1>(arg1, 0x2::tx_context::sender(arg4)), 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::address_not_whitelisted());
        let v0 = &arg1.deepbook_account_cap;
    ...
    public fun revoke_trading_permission<T0, T1>(arg0: &VaultCap, arg1: &mut Vault<T0, T1>, arg2: address) {
        ...
        assert!(v0, 0x525779caa467bfbe53cc907184b74779100137d30d7b1a5c9343b10ff1553bac::error::address_not_whitelisted());
