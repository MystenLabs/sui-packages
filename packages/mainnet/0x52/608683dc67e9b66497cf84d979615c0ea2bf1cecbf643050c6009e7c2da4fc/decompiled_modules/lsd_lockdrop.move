module 0x52608683dc67e9b66497cf84d979615c0ea2bf1cecbf643050c6009e7c2da4fc::lsd_lockdrop {
    struct LsdLockdropVault has key {
        ...
        hive_incentives_balance: 0x2::balance::Balance<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>,
    }
    ...
    public fun add_hive_incentives(arg0: &0x2::clock::Clock, arg1: &mut LsdLockdropVault, arg2: 0x2::coin::Coin<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(0x2::clock::timestamp_ms(arg0) <= arg1.init_timestamp + arg1.deposit_window, 5100);
        let v0 = 0x2::coin::into_balance<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>(arg2);
        0x2::balance::join<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>(&mut arg1.hive_incentives_balance, 0x2::balance::split<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>(&mut v0, arg3));
        arg1.total_hive_incentives = arg1.total_hive_incentives + arg3;
        0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::coin_helper::destroy_or_transfer_balance<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>(v0, 0x2::tx_context::sender(arg4), arg4);
    ...
    public fun add_to_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::HiveProfile, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v5 = if (0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::exists_for_profile(arg3, 0x1::string::to_ascii(0x1::string::utf8(b"lsd_vampire_attack")))) {
            0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg7)
        } else {
        ...
        0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg7);
        0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(v6, 0x2::tx_context::sender(arg7), arg7);
        (v9, v10)
    }
    ...
    public fun destroy_user_position(arg0: &0x2::clock::Clock, arg1: &0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::config::HiveEntryCap, arg2: &LsdLockdropVault, arg3: &mut 0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::HiveProfile, arg4: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, 0x2::table::Table<u64, u64>, u128, u128) {
        ...
        if (!0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::exists_for_profile(arg3, 0x1::string::to_ascii(0x1::string::utf8(b"lsd_vampire_attack")))) {
        ...
        } = 0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg4);
        0x2::object::delete(v0);
        0x2::table::drop<u64, bool>(v5);
        (v1, v2, v3, v4, (v6 as u128), v7)
    }

    public fun get_user_position(arg0: &0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::HiveProfile, arg1: &LsdLockdropVault) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u64, u64) {
        let v0 = 0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::borrow_from_profile<UserLsdLockdropPosition>(arg0, 0x1::string::to_ascii(0x1::string::utf8(b"lsd_vampire_attack")));
    ...
    public fun infuse_sui_hsui_pool(arg0: &0x2::clock::Clock, arg1: &0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x24bc76f3e97e7299b0e91432c3cdcdb7080bb5f976a45d9fb2fb6431b3173a8::hsui_vault::HSuiVault, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::hsui::HSUI>, 0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>, u64, u128) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        ...
        let v2 = 0x24bc76f3e97e7299b0e91432c3cdcdb7080bb5f976a45d9fb2fb6431b3173a8::hsui_vault::stake_sui_request(arg3, arg4, 0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, v1), 0x1::option::none<address>(), arg5);
        let v3 = SuiStakedForHiveSui{
            cur_timestamp      : v0,
            total_sui_locked   : arg2.total_sui_locked,
            sui_to_stake       : v1,
            total_hsui_krafted : 0x2::balance::value<0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::hsui::HSUI>(&v2),
        };
        0x2::event::emit<SuiStakedForHiveSui>(v3);
        (v2, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg2.sui_locked_balance), 0x2::balance::withdraw_all<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>(&mut arg2.hive_incentives_balance), arg2.total_sui_locked, arg2.total_sui_weighted_units)
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
    }

    public entry fun initialize_global_lsd_lockdrop(arg0: &0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::config::HiveEntryCap, arg1: 0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::ProfileDofOwnershipCapability, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : address {
        let v0 = LsdLockdropVault{
            ...
            hive_incentives_balance  : 0x2::balance::zero<0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive::HIVE>(),
        };
    ...
    public fun withdraw_from_lsd_lockup_position(arg0: &0x2::clock::Clock, arg1: &0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::config::HiveEntryCap, arg2: &mut LsdLockdropVault, arg3: &mut 0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::HiveProfile, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        assert!(0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::exists_for_profile(arg3, 0x1::string::to_ascii(0x1::string::utf8(b"lsd_vampire_attack"))), 5104);
        let v5 = 0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::entry_remove_from_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, arg6);
        ...
        0xdb900dc1968ceaa3e1e3a93579682a83fbf4b9d382e2205abf4ab086c925d50c::hive_profile::entry_add_to_profile<UserLsdLockdropPosition>(&arg2.user_profile_access_cap, arg3, v5, arg6);
        0x9006b6a9074a409702a34ab92502dd985cebdf5fc5bea62f56e10bc03388b7b3::coin_helper::destroy_or_transfer_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg2.sui_locked_balance, arg4), v4, arg6);
        (v11, v12)
    }
