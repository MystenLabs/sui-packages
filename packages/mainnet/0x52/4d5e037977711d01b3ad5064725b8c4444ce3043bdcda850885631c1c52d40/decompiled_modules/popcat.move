module 0x524d5e037977711d01b3ad5064725b8c4444ce3043bdcda850885631c1c52d40::popcat {
    ...
    fun init(arg0: POPCAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/7GCihgDB8fe6KNjn2MYtkzZcRjQy3t9GHdC8uHYmW2hr.png?size=lg&key=af7c36                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<POPCAT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POPCAT  ")))), trim_right(b"Popcat                          "), trim_right(b"Popcat the cat that pops, now popping on the SUI blockchain!                                                                                                                                                                                                                                                                    "), v2, arg1);
        let v5 = v3;
