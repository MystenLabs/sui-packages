module 0x593a2e87f393dcb14e0f8c88d587c04e9bc98295e13212e8992343377bf7f313::moonbags_token_lock {
    ...
    public entry fun update_lock_contract<T0>(arg0: &AdminCap, arg1: &mut LockContract<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::tx_context::sender(arg3) == arg1.locker, 3);
        arg1.locker = arg2;
        arg1.recipient = arg2;
    ...
    public entry fun withdraw<T0>(arg0: &Configuration, arg1: &mut LockContract<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg1.recipient || v0 == arg1.locker, 3);
        assert!(!arg1.closed, 1);
        ...
        arg1.closed = true;
        let v1 = TokensWithdrawnEvent{
            contract_id : 0x2::object::uid_to_address(&arg1.id),
            sender      : v0,
            recipient   : arg1.recipient,
            amount      : 0x2::balance::value<T0>(&arg1.balance),
        };
        0x2::event::emit<TokensWithdrawnEvent>(v1);
    }
