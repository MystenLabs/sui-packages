module 0x593a2e87f393dcb14e0f8c88d587c04e9bc98295e13212e8992343377bf7f313::moonbags {
    ...
    struct BackingConfig has copy, drop, store {
        hedge_wallet: address,
        bps: u16,
    }

    struct PoolBackingSet has copy, drop, store {
    ...
    fun apply_backing_split<T0>(arg0: &0x2::object::UID, arg1: 0x1::ascii::String, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        if (!0x2::dynamic_field::exists_<vector<u8>>(arg0, b"backing")) {
            return
        };
        let v0 = *0x2::dynamic_field::borrow<vector<u8>, BackingConfig>(arg0, b"backing");
        let v1 = (v0.bps as u64);
        let v2 = 0x2::coin::value<T0>(arg2) * v1 / 10000;
        let v3 = 0x2::coin::value<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(arg3) * v1 / 10000;
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg2, v2, arg5), v0.hedge_wallet);
        };
        if (v3 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>>(0x2::coin::split<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(arg3, v3, arg5), @0x0);
        };
        let v4 = FeesBackingRouted{
            token_address  : arg1,
            token_to_hedge : v2,
            aida_burned    : v3,
            ts             : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<FeesBackingRouted>(v4);
    }
    ...
    public entry fun set_pool_backing<T0>(arg0: &AdminCap, arg1: &mut Configuration, arg2: address, arg3: u16, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_version(arg1.version);
        assert!((arg3 as u64) <= 10000, 52);
        assert!(arg2 != @0x0, 53);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x1::type_name::get_address(&v0);
        let v2 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, Pool<T0>>(&mut arg1.id, v1);
        assert!(!0x2::dynamic_field::exists_<vector<u8>>(&v2.id, b"backing"), 51);
        let v3 = BackingConfig{
            hedge_wallet : arg2,
            bps          : arg3,
        };
        0x2::dynamic_field::add<vector<u8>, BackingConfig>(&mut v2.id, b"backing", v3);
        let v4 = PoolBackingSet{
            token_address : v1,
            hedge_wallet  : arg2,
            bps           : arg3,
            ts            : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<PoolBackingSet>(v4);
    }
    ...
    public fun withdraw_fee_cetus<T0, T1>(arg0: &mut Configuration, arg1: &mut 0x593a2e87f393dcb14e0f8c88d587c04e9bc98295e13212e8992343377bf7f313::moonbags_stake::Configuration, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::collect_fee<T0, 0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(arg2, arg3, arg4, 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::CetusLPBurnProof>(&mut v2.id, b"burn_proof"), arg6);
        let v5 = v4;
        let v6 = v3;
        let v7 = &mut v6;
        let v8 = &mut v5;
        ...
        0x2::coin::join<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&mut v2.fee_recipient, v5);
    ...
    public fun withdraw_fee_cetus_swapped<T0, T1>(arg0: &mut Configuration, arg1: &mut 0x593a2e87f393dcb14e0f8c88d587c04e9bc98295e13212e8992343377bf7f313::moonbags_stake::Configuration, arg2: &mut 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::BurnManager, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA, T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2.is_completed, 9);
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&v2.id, b"burn_proof"), 9);
        let (v3, v4) = 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::collect_fee<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA, T0>(arg2, arg3, arg4, 0x2::dynamic_object_field::borrow_mut<vector<u8>, 0x12d73de9a6bc3cb658ec9dc0fe7de2662be1cea5c76c092fcc3606048cdbac27::lp_burn::CetusLPBurnProof>(&mut v2.id, b"burn_proof"), arg6);
        let v5 = v4;
        let v6 = v3;
        let v7 = &mut v5;
        let v8 = &mut v6;
        ...
        0x2::coin::join<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&mut v2.fee_recipient, v6);
        distribute_fees<T0, T1>(v2, arg0.fee_platform_recipient, arg0.init_platform_fee_withdraw, arg0.init_creator_fee_withdraw, arg0.init_stake_fee_withdraw, arg0.init_platform_stake_fee_withdraw, arg1, arg5, arg6);
    }
