module 0x593a2e87f393dcb14e0f8c88d587c04e9bc98295e13212e8992343377bf7f313::moonbags_stake {
    ...
    struct StakingPool<phantom T0> has store, key {
        ...
        sui_token: 0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>,
        total_supply: u64,
        reward_index: u128,
    ...
    public entry fun claim_creator_pool<T0>(arg0: &mut Configuration, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v2 = 0x2::coin::value<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&v1.sui_token);
        assert!(v2 > 0, 7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>>(0x2::coin::split<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&mut v1.sui_token, v2, arg2), v1.creator);
    ...
    public entry fun claim_staking_pool<T0>(arg0: &mut Configuration, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v5 > 0, 7);
        v4.earned = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>>(0x2::coin::split<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&mut v1.sui_token, v5, arg2), v2);
    ...
    public entry fun deposit_creator_pool<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<CreatorPool<T0>>());
        assert!(0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg0.id, v0), 2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, CreatorPool<T0>>(&mut arg0.id, v0);
        let v2 = 0x2::coin::value<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&arg1);
        assert!(v2 > 0, 6);
        0x2::coin::join<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(&mut v1.sui_token, arg1);
    ...
    public(friend) entry fun initialize_creator_pool<T0>(arg0: &mut Configuration, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = CreatorPool<T0>{
            ...
            sui_token : 0x2::coin::zero<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(arg3),
            creator   : arg1,
        };
    ...
    public entry fun initialize_staking_pool<T0>(arg0: &mut Configuration, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = StakingPool<T0>{
            ...
            sui_token               : 0x2::coin::zero<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>(arg2),
            total_supply            : 0,
            reward_index            : 0,
    ...
    public entry fun stake<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1.pending_initial_rewards > 0) {
            v1.reward_index = v1.reward_index + (v1.pending_initial_rewards as u128) * 10000000000000000 / (v1.total_supply as u128);
            v1.pending_initial_rewards = 0;
            v4.reward_index = v1.reward_index;
        };
    ...
    public entry fun update_creator<T0>(arg0: &AdminCap, arg1: &mut Configuration, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<CreatorPool<T0>>());
        assert!(0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg1.id, v0), 2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, CreatorPool<T0>>(&mut arg1.id, v0);
        v1.creator = arg2;
        let v2 = UpdateCreatorEvent{
            token_address : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
            creator_pool  : 0x2::object::id<CreatorPool<T0>>(v1),
            old_creator   : 0x2::address::to_ascii_string(v1.creator),
            new_creator   : 0x2::address::to_ascii_string(arg2),
            updated_by    : 0x2::address::to_ascii_string(0x2::tx_context::sender(arg3)),
        };
        0x2::event::emit<UpdateCreatorEvent>(v2);
    }

    public entry fun update_reward_index<T0>(arg0: &mut Configuration, arg1: 0x2::coin::Coin<0xcee208b8ae33196244b389e61ffd1202e7a1ae06c8ec210d33402ff649038892::aida::AIDA>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg0.version);
        let v0 = 0x1::type_name::into_string(0x1::type_name::get<StakingPool<T0>>());
        assert!(0x2::dynamic_object_field::exists_<0x1::ascii::String>(&arg0.id, v0), 1);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::ascii::String, StakingPool<T0>>(&mut arg0.id, v0);
