module 0x5201b5492cfc5590641413e8d70bdf9d83a256111646bb7f2b0fc500e4c23d96::cnsnft2188 {
    struct CNSNFT2188 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2188, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2188>(arg0, arg1);
