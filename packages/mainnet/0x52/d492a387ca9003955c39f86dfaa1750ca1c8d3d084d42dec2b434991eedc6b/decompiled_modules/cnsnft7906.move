module 0x52d492a387ca9003955c39f86dfaa1750ca1c8d3d084d42dec2b434991eedc6b::cnsnft7906 {
    struct CNSNFT7906 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7906, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3428"));
        let v4 = 0x2::package::claim<CNSNFT7906>(arg0, arg1);
