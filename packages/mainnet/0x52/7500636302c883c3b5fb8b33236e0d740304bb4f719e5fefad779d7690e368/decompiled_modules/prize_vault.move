module 0x527500636302c883c3b5fb8b33236e0d740304bb4f719e5fefad779d7690e368::prize_vault {
    ...
    public entry fun claim_escrowed_kiosk_nft_prize<T0: store + key>(arg0: &mut PrizeVault, arg1: ClaimTicket, arg2: &0x527500636302c883c3b5fb8b33236e0d740304bb4f719e5fefad779d7690e368::raffle_kiosk::RaffleKiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x527500636302c883c3b5fb8b33236e0d740304bb4f719e5fefad779d7690e368::raffle_kiosk::transfer_nft_to_kiosk<T0>(arg2, arg3, arg4, arg5, arg6, *0x2::dynamic_field::borrow<0x1::string::String, 0x2::object::ID>(&arg0.id, 0x1::string::utf8(b"nft_id")), arg7, 0x2::tx_context::sender(arg9), arg9);
