module 0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::exchange {
    ...
    struct Curve<phantom T0, phantom T1> has store, key {
        ...
        presale_commits: 0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::BigVector<PresaleCommit>,
        b_inital_value: u64,
    ...
    public fun bid<T0, T1>(arg0: &mut AdminSettings, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::tx_context::TxContext) {
        ...
        0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::push_back<PresaleCommit>(&mut v0.presale_commits, v4);
    }
    ...
    public fun bid_with_custodial_account<T0, T1>(arg0: &mut AdminSettings, arg1: &mut CustodialPoolsIndex, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::push_back<PresaleCommit>(&mut v0.presale_commits, v5);
    }
    ...
    public fun create_curve<T0, T1>(arg0: &mut AdminSettings, arg1: 0x2::coin::TreasuryCap<T1>, arg2: &0x2::coin::CoinMetadata<T1>, arg3: u64, arg4: u64, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<u64>, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v5 = Curve<T0, T1>{
            ...
            presale_commits       : 0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::new<PresaleCommit>(slice_size(), arg8),
            b_inital_value        : v2,
    ...
    public fun disperse<T0, T1>(arg0: &mut AdminSettings, arg1: &mut CustodialPoolsIndex, arg2: 0x2::object::ID, arg3: &mut FeeCollector, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = if (0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::length<PresaleCommit>(&v0.presale_commits) > v4) {
            0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::length<PresaleCommit>(&v0.presale_commits) - v4
        } else {
            0
        };
        let v6 = 0x1::vector::empty<DisperseEvent>();
        while (0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::length<PresaleCommit>(&v0.presale_commits) > v5) {
            let v7 = 0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::pop_back<PresaleCommit>(&mut v0.presale_commits);
        ...
        if (0x52073f62e3754206ad398b550503459066c8d2ecb45ecee0056c08b42c1aaea5::big_vector::length<PresaleCommit>(&v0.presale_commits) == 0) {
