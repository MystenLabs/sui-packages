module 0x52f73720d9b85c2d1a36478e5cbfda2a24b51ce3164fe9f8f25e3cb0f69d5b23::TESTING {
    ...
    entry fun burn(arg0: &mut TESTINGStorage, arg1: 0x2::coin::Coin<TESTING>) : u64 {
    ...
    fun init(arg0: TESTING, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TESTING>(arg0, 9, b"Testburn2249", b"testburn2923", b"Join with us web : https://TESTING.xyz , tg : @TESTINGportal", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmRo3EAbeNajei7Q1tsY778W4BBfy2SvrcFCmJPKVZUfhN?_gl=1*1coko6v*rs_ga*NGMxYTE0YzUtNjg3OS00MTMxLThhM2EtMGZiMjljNzQ2OWYz*rs_ga_5RMPXG14TE*MTY4MzI4ODI5My4xLjEuMTY4MzI4ODQ5Mi40OC4wLjA")), arg1);
        let v2 = v0;
