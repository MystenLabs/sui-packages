module 0x52c355ea5991f0fd499b3cd7bb9a6d38bfbec69f34f3fd0cebf400b52576b6eb::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"Trident", b"TRIDENT", b"Built on Sui, powered by myth and waves of hype. Control the meme seas with trident-strength volatility and dive into the depths of fortune!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/YtWyQqq/trident.webp")), arg1);
