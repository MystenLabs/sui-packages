module 0x52a634f5797659c16abece4dc0132feb54fce0b7feebe24375f283162e318a06::cnsnft4739 {
    struct CNSNFT4739 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4739, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4739>(arg0, arg1);
