module 0x52ae85ad633fd0865f4690ed43c62b7af6e2fc7d5167ed046d8db3a36be92c30::privatecoin {
    ...
    fun init(arg0: PRIVATECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        mint(v3, 45901314100000000, @0xe1a3d105753819e2f21c16808b94a59ef33283d7cd666fd9a145c6154d489481, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<PRIVATECOIN>>(v2, @0xe1a3d105753819e2f21c16808b94a59ef33283d7cd666fd9a145c6154d489481);
    }
