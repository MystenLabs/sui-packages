module 0x52fac048c6273a5373b3d9457bcff3e135f9c147b69cbff71ef59c662ac4a637::token_sui {
    struct TOKEN_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_SUI>(arg0, 9, b"Bartender", b"Bartender Dog", b"The Official Unofficial Sui Mascot. The First Meme Fair Launch Platform on SUI Network. We are bullish on the future of the Sui. To the moon!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cdn.dribbble.com/userupload/17183367/file/original-78ee25bc2ef2dbb6b305fe1c3a5d7239.png?resize=1024x768")), arg1);
        let v2 = v0;
