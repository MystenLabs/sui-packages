module 0x5261e5e98a52f4b2ad2e8d7f334cfb86087763a6e3dd72dc1f752d8004ae0996::usda {
    struct USDA has drop {
        dummy_field: bool,
    }

    fun init(arg0: USDA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<USDA>(arg0, 6, b"Usd test token", b"USDA", b"Usd test token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/3408.png")), arg1);
