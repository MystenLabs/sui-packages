module 0x52396c58b39f95bdbd9d362ee525b83e7df7454653220c9810bb367fb3f9a02b::cnsnft5906 {
    struct CNSNFT5906 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5906, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8495"));
        let v4 = 0x2::package::claim<CNSNFT5906>(arg0, arg1);
