module 0x52b5bf2096166ead93b80743e8da995fde1c176d5ded0cdca1247403ef8cf3a9::reward1535 {
    struct REWARD1535 has drop {
        dummy_field: bool,
    }

    struct TICKET_1535 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1535(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1535>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1535>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1535, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1535>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1535>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1535>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1535>>(v5, 0x2::tx_context::sender(arg1));
    }
