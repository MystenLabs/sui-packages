module 0x524ab529e90663de0f0f85de65405d2b2dfc0c341417eee58a0cc98cc681257d::MARKET {
    ...
    public fun batch_accept_buy_offers<T0>(arg0: &mut TradeLedger, arg1: vector<0x2::object::ID>, arg2: vector<u64>, arg3: vector<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::NFT>, arg4: vector<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>, arg5: &0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::CollectionCap, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        while (v4 < v2 && v3 < v1) {
            ...
            assert!(0x2::table::contains<0x2::object::ID, BuyOffer>(&arg0.buy_offers, v5), 2);
            let v7 = 0x2::table::borrow_mut<0x2::object::ID, BuyOffer>(&mut arg0.buy_offers, v5);
            assert!(v7.status == 0, 3);
            assert!(v6 > 0 && v6 <= v7.requested_asset_count, 4);
            let v8 = 0x1::vector::empty<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::NFT>();
            let v9 = 0;
            while (v9 < v6) {
                0x1::vector::push_back<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::NFT>(&mut v8, 0x1::vector::pop_back<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::NFT>(&mut arg3));
                v9 = v9 + 1;
            };
            let v10 = 0x1::vector::empty<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>();
            0x1::vector::push_back<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>(&mut v10, 0x1::vector::pop_back<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>(&mut arg4));
            accept_buy_offer<T0>(arg0, v5, v8, v10, arg5, v6, arg6, arg7);
            v3 = v3 + v6;
            v4 = v4 + 1;
        };
        ...
        let v11 = BatchBuyOffersAccepted{
            accepter     : v0,
            total_filled : v3,
            total_cost   : 0,
            timestamp    : 0x2::clock::timestamp_ms(arg6),
        ...
        0x2::event::emit<BatchBuyOffersAccepted>(v11);
        v3
    }
    ...
    public fun batch_accept_offers<T0>(arg0: &mut TradeLedger, arg1: 0x2::coin::Coin<T0>, arg2: vector<0x2::object::ID>, arg3: vector<u64>, arg4: &0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::CollectionCap, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v5 = 0;
        while (v5 < v1) {
            let v6 = *0x1::vector::borrow<0x2::object::ID>(&arg2, v5);
            let v7 = *0x1::vector::borrow<u64>(&arg3, v5);
            assert!(0x2::table::contains<0x2::object::ID, TradeOffer>(&arg0.offers, v6), 2);
            let v8 = 0x2::table::borrow<0x2::object::ID, TradeOffer>(&arg0.offers, v6);
            assert!(v8.status == 0, 3);
            assert!(v7 > 0 && v7 <= 0x1::vector::length<u64>(&v8.offered_asset_ids), 4);
            let v9 = safe_mul(v8.requested_amount, v7);
            assert!(v4 >= v9, 3);
            let v10 = 0x2::coin::split<T0>(&mut arg1, v9, arg6);
            accept_offer<T0>(arg0, v6, v10, arg4, v7, arg5, arg6);
            v2 = v2 + v7;
            v3 = v3 + v9;
            v5 = v5 + 1;
        };
        ...
        0x2::event::emit<BatchOffersAccepted>(v11);
        v2
    }
