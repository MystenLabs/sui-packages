module 0x522ce9c51609d5fd4fafe13e8c87a83ced0958316c45fb041ba896cea6f739c8::ducky {
    ...
    fun init(arg0: DUCKY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<DUCKY>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DUCKY   ")))), trim_right(b"Ducky                           "), trim_right(b"Launched stealth with no presale, zero taxes, LP burnt and contract renounced, DUCKY is for the people - forever. It's time for the most recognizable bear in the world to claim his rightful position on the charts at the start of a life changing bull market                                                                "), v2, arg1);
        let v5 = v3;
