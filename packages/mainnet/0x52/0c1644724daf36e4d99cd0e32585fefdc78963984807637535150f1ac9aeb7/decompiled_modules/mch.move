module 0x520c1644724daf36e4d99cd0e32585fefdc78963984807637535150f1ac9aeb7::mch {
    struct MCH has drop {
        dummy_field: bool,
    }

    fun init(arg0: MCH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MCH>(arg0, 6, b"MCH", b"MetaChain", b"MetaChain (MCH) is a next-generation blockchain solution built on SUI, designed to revolutionize decentralized applications (dApps) by providing seamless scalability, ultra-fast transaction speeds, and low fees. MetaChain focuses on interoperability, ensuring developers and users can easily interact with multiple blockchain networks. Its robust security architecture offers maximum protection, making it the ideal choice for innovative dApps, DeFi platforms, and NFT ecosystems.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.movepump.com/uploads/666_5e0d081bbe.webp")), arg1);
