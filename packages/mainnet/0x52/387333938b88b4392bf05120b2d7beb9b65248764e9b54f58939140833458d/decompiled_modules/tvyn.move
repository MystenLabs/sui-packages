module 0x52387333938b88b4392bf05120b2d7beb9b65248764e9b54f58939140833458d::tvyn {
    ...
    public entry fun create_and_share_mint_vault(arg0: 0x2::coin::TreasuryCap<TVYN>, arg1: &mut 0x52387333938b88b4392bf05120b2d7beb9b65248764e9b54f58939140833458d::config_registry::Config, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MintVault{
            id  : 0x2::object::new(arg2),
            cap : arg0,
        };
        0x52387333938b88b4392bf05120b2d7beb9b65248764e9b54f58939140833458d::config_registry::set_mint_vault_id(arg1, 0x2::object::id<MintVault>(&v0));
