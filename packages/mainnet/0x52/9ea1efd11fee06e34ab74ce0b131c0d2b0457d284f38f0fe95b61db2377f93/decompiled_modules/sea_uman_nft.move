module 0x326537301c41889c15e3265c1674f86a0dcf9a6f51f8308ee420136a560276b3::sea_uman_nft {
    ...
    public entry fun take_out_and_burn(arg0: &MintCap<SeaUmanNFT>, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        burn_nft(arg0, 0x2::kiosk::take<SeaUmanNFT>(arg1, arg2, arg3), arg4);
    }

    public entry fun transfer_to_sender<T0: store + key>(arg0: T0, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
