module 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::governance_v1 {
    ...
    public entry fun activate_governance(arg0: 0x2::package::UpgradeCap, arg1: &mut GovernanceInfo, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::option::fill<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceManagerCap>(&mut arg1.governance_manager_cap, 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::init_genesis(arg0, arg2));
        arg1.active = true;
    }

    public fun add_member(arg0: &0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: address) {
    ...
    public fun remove_member(arg0: &0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceCap, arg1: &mut GovernanceInfo, arg2: address) {
    ...
    public fun vote_proposal<T0: drop + store>(arg0: &GovernanceInfo, arg1: T0, arg2: &mut Proposal<T0>, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceCap> {
        ...
        if (0x1::option::is_none<u64>(&arg2.end_vote) || v0 >= *0x1::option::borrow<u64>(&arg2.end_vote)) {
            ...
            return 0x1::option::none<0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::genesis::GovernanceCap>()
        };
