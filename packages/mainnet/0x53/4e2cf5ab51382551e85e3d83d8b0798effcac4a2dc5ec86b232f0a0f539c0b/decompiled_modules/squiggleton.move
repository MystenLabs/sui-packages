module 0x534e2cf5ab51382551e85e3d83d8b0798effcac4a2dc5ec86b232f0a0f539c0b::squiggleton {
    ...
    fun init(arg0: SQUIGGLETON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SQUIGGLETON>(&mut v2, 1000000000000000000, @0x86d23a68cdddbdb748c8d40aa226afed8e5f87c5d5dc8e904c13971759339c73, arg1);
