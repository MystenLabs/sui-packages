module 0x53e8b766beba448b53dae964148675e1b68871b5ad0e0090f27bd5d8790067b1::jk {
    ...
    public fun jujubeswap_0<T0, T1>(arg0: &mut AccessList, arg1: &mut 0xf435e16e002dd0cbe7afe9a449498ae5f589712365cad41ad0854a9cec5487e2::liquidity_pool::SwapInfo, arg2: &mut 0xf435e16e002dd0cbe7afe9a449498ae5f589712365cad41ad0854a9cec5487e2::dao_storage::DaoStorageInfo, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) : vector<0x2::coin::Coin<T1>> {
        assert!(is_valid(arg0, arg5), 10000000002);
        ...
        0x1::vector::singleton<0x2::coin::Coin<T1>>(v5)
    }

    public fun jujubeswap_1<T0, T1>(arg0: &mut AccessList, arg1: &mut 0xf435e16e002dd0cbe7afe9a449498ae5f589712365cad41ad0854a9cec5487e2::liquidity_pool::SwapInfo, arg2: &mut 0xf435e16e002dd0cbe7afe9a449498ae5f589712365cad41ad0854a9cec5487e2::dao_storage::DaoStorageInfo, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<T1>, arg5: &mut 0x2::tx_context::TxContext) : vector<0x2::coin::Coin<T0>> {
        assert!(is_valid(arg0, arg5), 10000000002);
        ...
        0x1::vector::singleton<0x2::coin::Coin<T0>>(v4)
    }
