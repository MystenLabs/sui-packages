module 0x535fa534929544099fe151b37487265a494d30c17f658b34d8db420c1af80ff4::cnsnft3094 {
    struct CNSNFT3094 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3094, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3094>(arg0, arg1);
