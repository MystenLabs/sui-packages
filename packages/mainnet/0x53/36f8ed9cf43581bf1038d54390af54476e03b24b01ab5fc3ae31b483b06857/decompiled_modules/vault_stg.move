module 0x5336f8ed9cf43581bf1038d54390af54476e03b24b01ab5fc3ae31b483b06857::vault_stg {
    ...
    public fun new<T0, T1, T2>(arg0: &0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::Pool<T0, T1>, arg1: 0x2::coin::TreasuryCap<T2>, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: u128, arg7: u128, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = Vault<T0, T1, T2>{
            ...
            clmm_pool_id                 : 0x2::object::id<0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::Pool<T0, T1>>(arg0),
            lower_tick                   : 0,
            upper_tick                   : 0,
    ...
    public fun check_pool_compatibility<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::Pool<T0, T1>) {
        assert!(arg0.clmm_pool_id == 0x2::object::id<0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::Pool<T0, T1>>(arg1), 4);
    }
    ...
    public fun get_amount_by_liquidity<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::Pool<T0, T1>, arg2: bool) : (u64, u64) {
        let v0 = position_borrow<T0, T1, T2>(arg0);
        let v1 = if (arg2) {
            0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::liquidity(v0)
        } else {
            0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::liquidity<T0, T1>(arg1)
        };
        0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::liquidity_math::get_amounts_for_liquidity(0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::sqrt_price<T0, T1>(arg1), 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::tick_math::get_sqrt_price_at_tick(0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::tick_lower_index(v0)), 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::tick_math::get_sqrt_price_at_tick(0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::tick_upper_index(v0)), v1, true)
    }
    ...
    public fun get_optimal_swap_amount_for_single_sided_liquidity<T0, T1, T2>(arg0: &Vault<T0, T1, T2>, arg1: &0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::pool::Pool<T0, T1>, arg2: u64, arg3: bool, arg4: u64) : (u64, bool) {
        ...
        if (v0 == 0) {
            ...
            while (v6 < arg4) {
                let v10 = 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::trade::compute_swap_result<T0, T1>(arg1, arg3, true, v9, v7);
                let v11 = 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::trade::get_state_amount_calculated(&v10);
                let v12 = if (arg3) {
                    arg2 - v7
                } else {
                    v11
    ...
    public fun get_position_assets<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : (u64, u64) {
        let v0 = position_borrow<T0, T1, T2>(arg0);
        (0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::owed_coin_x(v0), 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::owed_coin_x(v0))
    }

    public fun get_position_tick_range<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : (0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::i32::I32, 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::i32::I32) {
        let v0 = position_borrow<T0, T1, T2>(arg0);
        (0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::tick_lower_index(v0), 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::tick_upper_index(v0))
    }
    ...
    public(friend) fun insert_position<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>, arg1: 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position) {
        0x2::dynamic_field::add<vector<u8>, 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position>(&mut arg0.id, b"position", arg1);
    }
    ...
    public fun issue_rebalance_cap(arg0: &VaultCap, arg1: address, arg2: &0x5336f8ed9cf43581bf1038d54390af54476e03b24b01ab5fc3ae31b483b06857::version_stg::Version, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun position_borrow<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : &0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position {
        0x2::dynamic_field::borrow<vector<u8>, 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position>(&arg0.id, b"position")
    }

    public(friend) fun position_borrow_mut<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) : &mut 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position>(&mut arg0.id, b"position")
    }

    public fun position_id<T0, T1, T2>(arg0: &Vault<T0, T1, T2>) : 0x2::object::ID {
        0x2::object::id<0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position>(0x2::dynamic_field::borrow<vector<u8>, 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position>(&arg0.id, b"position"))
    }

    public(friend) fun remove_position<T0, T1, T2>(arg0: &mut Vault<T0, T1, T2>) : 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position {
        0x2::dynamic_field::remove<vector<u8>, 0x852221d796eaeb9680897ff2b77d2ba607c8a4fdd9a9f76e9eedd787deccc216::position::Position>(&mut arg0.id, b"position")
    }
    ...
    public fun update_rebalance_cap_ownership(arg0: &VaultCap, arg1: &mut RebalanceCap, arg2: address, arg3: &0x5336f8ed9cf43581bf1038d54390af54476e03b24b01ab5fc3ae31b483b06857::version_stg::Version) {
