module 0x68114ffc0a0d7c4a582b4494d2370205a23d93e96b9ef6a750d0ba5f8f52b7db::implements {
    ...
    public(friend) fun swap_out<T0, T1>(arg0: &mut Global, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : vector<u64> {
        ...
        if (arg3) {
            ...
            is_tax_coin<T0>(0x1::ascii::into_bytes(v21.tax_coin));
            let (v22, v23, _) = get_reserves_size<T1, T0>(v21);
            assert!(v22 > 0 && v23 > 0, 1);
            let v25 = 0x2::coin::value<T0>(&arg1);
            let v26 = 0x2::coin::into_balance<T0>(arg1);
            let v27 = get_fee_to_fundation(v25, v0);
            let v28 = v25 - v27;
            let v29 = get_amount_out(v28, v23, v22);
            assert!(v29 >= arg2, 7);
            0x2::balance::join<T0>(&mut v21.fee_coin_y, 0x2::balance::split<T0>(&mut v26, v27));
            0x2::balance::join<T0>(&mut v21.coin_y, v26);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut v21.coin_x, v29, arg4), 0x2::tx_context::sender(arg4));
            let (v30, v31, _) = get_reserves_size<T1, T0>(v21);
            assert_lp_value_is_increased(v22, v23, v30, v31);
            let v33 = 0x1::vector::empty<u64>();
            0x1::vector::push_back<u64>(&mut v33, 0);
            0x1::vector::push_back<u64>(&mut v33, v29);
            0x1::vector::push_back<u64>(&mut v33, v28);
            0x1::vector::push_back<u64>(&mut v33, 0);
            v33
        }
    }
