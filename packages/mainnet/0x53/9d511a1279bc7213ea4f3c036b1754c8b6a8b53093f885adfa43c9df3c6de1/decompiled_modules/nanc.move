module 0x539d511a1279bc7213ea4f3c036b1754c8b6a8b53093f885adfa43c9df3c6de1::nanc {
    ...
    fun init(arg0: NANC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NANC>(arg0, 2, b"NANC", b"NO AIRDROP NO COMMUNITY", b"https://svgshare.com/i/11Tm.svg", 0x1::option::none<0x2::url::Url>(), arg1);
