module 0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::bird {
    ...
    public fun claimPreyReward(arg0: &mut BirdArchieve, arg1: &0x2::clock::Clock, arg2: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg2, 1);
    ...
    public fun claimReferallReward(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
    ...
    public fun claimReward<T0>(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut RewardPool<T0>, arg3: &mut BirdStore, arg4: &mut BirdArchieve, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
    ...
    public fun configRewardPool<T0>(arg0: &AdminCap, arg1: &mut RewardPool<T0>, arg2: bool, arg3: u64, arg4: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg4, 1);
        arg1.active = arg2;
        arg1.reward_limit = arg3;
    }

    public fun createRewardPool<T0>(arg0: &AdminCap, arg1: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg2: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg1, 1);
    ...
    public fun deposit<T0>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg3, 1);
    ...
    public fun depositReward<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut RewardPool<T0>, arg2: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg2, 1);
    ...
    public fun emergencyRewardWithdraw<T0>(arg0: &TreasureCap, arg1: &mut RewardPool<T0>, arg2: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg2, 1);
    ...
    public fun feedWorm(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
    ...
    fun init(arg0: BIRD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::cap_vault::createVault<AdminCap>(arg1);
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::cap_vault::createVault<TreasureCap>(arg1);
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::cap_vault::createVault<0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::VAdminCap>(arg1);
    }

    public fun mineBird(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
        verifySignature(arg0, arg1, arg2);
        let v0 = 0x2::bcs::new(arg1);
    ...
    public fun mineNft(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
        verifySignature(arg0, arg1, arg2);
    ...
    public fun preyBird(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
        let v0 = 0x2::clock::timestamp_ms(arg4);
        verifySignature(arg0, arg1, arg2);
        let v1 = 0x2::bcs::new(arg1);
    ...
    public fun register(arg0: &mut BirdReg, arg1: &0x2::clock::Clock, arg2: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg3: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg2, 1);
    ...
    public fun skip(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
        verifySignature(arg0, arg1, arg2);
        let v0 = 0x2::bcs::new(arg1);
        let v1 = 0x2::bcs::peel_address(&mut v0);
    ...
    public fun updateValidator(arg0: &AdminCap, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg3, 1);
        0x1::option::swap_or_fill<vector<u8>>(&mut arg2.validator, arg1);
    }

    public fun upgrade(arg0: vector<u8>, arg1: vector<u8>, arg2: &mut BirdStore, arg3: &mut BirdArchieve, arg4: &0x2::clock::Clock, arg5: &0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::Version, arg6: &mut 0x2::tx_context::TxContext) {
        0x5346e74ae4a4a6081ae914cb3055ddeb905e2481b307915092737b4c8e2dad49::version::checkVersion(arg5, 1);
        verifySignature(arg0, arg1, arg2);
        let v0 = 0x2::bcs::new(arg1);
        let v1 = 0x2::bcs::peel_address(&mut v0);
