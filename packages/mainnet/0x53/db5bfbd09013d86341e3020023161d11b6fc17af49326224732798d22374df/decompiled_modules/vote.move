module 0x53db5bfbd09013d86341e3020023161d11b6fc17af49326224732798d22374df::vote {
    ...
    struct VoteClone has copy, drop {
        id: 0x2::object::ID,
        balance: u64,
        proposal_id: 0x2::object::ID,
        vote_type_id: 0x2::object::ID,
    ...
    public(friend) fun new_from_vote<T0>(arg0: &Vote<T0>) : VoteClone {
        VoteClone{
            id           : 0x2::object::id<Vote<T0>>(arg0),
            balance      : 0x2::balance::value<T0>(&arg0.balance),
            proposal_id  : arg0.proposal_id,
            vote_type_id : arg0.vote_type_id,
        }
    }
