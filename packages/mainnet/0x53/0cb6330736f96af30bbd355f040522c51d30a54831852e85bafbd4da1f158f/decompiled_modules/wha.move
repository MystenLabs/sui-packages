module 0x530cb6330736f96af30bbd355f040522c51d30a54831852e85bafbd4da1f158f::wha {
    struct WHA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WHA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<WHA>(arg0, 5, b"SLERF", b"SLERF", b"SLERF token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
        let v3 = &mut v2;
