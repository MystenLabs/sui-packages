module 0x7a9967b4baa1c107a357dea6243955a4dfc78386c7f958c4e11e447dd8ea2521::staking {
    ...
    entry fun withdraw(arg0: &mut StakingPool, arg1: StakingLock, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v0;
        let v7 = WithdrawStakeEvent{
            staking_lock_id : 0x2::object::uid_to_inner(&v6),
            amount          : arg1.amount,
        };
        0x2::event::emit<WithdrawStakeEvent>(v7);
        0x2::object::delete(v6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>>(0x2::coin::take<0xe4239cd951f6c53d9c41e25270d80d31f925ad1655e5ba5b543843d4a66975ee::SUIP::SUIP>(&mut arg0.vault, arg1.amount, arg3), 0x2::tx_context::sender(arg3));
    }
