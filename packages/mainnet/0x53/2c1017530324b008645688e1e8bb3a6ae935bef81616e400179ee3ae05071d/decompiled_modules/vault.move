module 0x7a9967b4baa1c107a357dea6243955a4dfc78386c7f958c4e11e447dd8ea2521::vault {
    ...
    public(friend) fun claim_investment<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg0.invested_amount < arg0.target_amount) {
            let v1 = ((((arg0.target_amount - arg0.invested_amount) as u128) * 10000000 / get_token_price<T0, T1>(arg0)) as u64);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::take<T1>(&mut arg0.reward_balance, v1, arg1), 0x2::tx_context::sender(arg1));
            let v2 = WithdrawUnsoldTokensEvent{
                campaign_id : arg0.campaign_id,
                amount      : v1,
            };
            0x2::event::emit<WithdrawUnsoldTokensEvent>(v2);
        };
        let v3 = WithdrawInvestmentEvent{
            campaign_id : arg0.campaign_id,
            amount      : v0,
        };
        0x2::event::emit<WithdrawInvestmentEvent>(v3);
    ...
    public fun get_user_deposit(arg0: &InvestCertificate) : u64 {
        arg0.deposit
    }
    ...
    public(friend) fun insurance_claimed(arg0: &mut InvestCertificate) {
        arg0.insured = false;
    }

    public fun is_insured(arg0: &InvestCertificate) : bool {
        arg0.insured
    }
    ...
    public(friend) fun set_distribution_time<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64) {
