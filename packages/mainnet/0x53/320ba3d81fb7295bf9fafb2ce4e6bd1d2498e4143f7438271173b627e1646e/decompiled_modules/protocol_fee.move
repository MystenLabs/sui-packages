module 0x53320ba3d81fb7295bf9fafb2ce4e6bd1d2498e4143f7438271173b627e1646e::protocol_fee {
    ...
    fun assert_interacting_with_most_up_to_date_package(arg0: &ProtocolFeeConfig) {
        0x53320ba3d81fb7295bf9fafb2ce4e6bd1d2498e4143f7438271173b627e1646e::version::assert_interacting_with_most_up_to_date_package(arg0.version);
    }
    ...
    public(friend) fun create_config<T0: drop>(arg0: &T0, arg1: &mut 0x2::tx_context::TxContext) : (ProtocolFeeConfig, ChangeFeeCap) {
        ...
        let v0 = ProtocolFeeConfig{
            ...
            version                            : 0x53320ba3d81fb7295bf9fafb2ce4e6bd1d2498e4143f7438271173b627e1646e::version::current_version(),
            dev_wallet                         : @0x834824362bf9abb713743ca460c5ebde62c823abe725c71728a268af068,
            total_protocol_fee_percent_base_18 : 1000000000000000,
            treasury_fee_percent_base_18       : 1000000000000000,
    ...
    public fun distribute_protocol_fees<T0>(arg0: &ProtocolFeeConfig, arg1: &0x53320ba3d81fb7295bf9fafb2ce4e6bd1d2498e4143f7438271173b627e1646e::treasury::Treasury, arg2: &mut 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 > 0) {
            0x53320ba3d81fb7295bf9fafb2ce4e6bd1d2498e4143f7438271173b627e1646e::treasury::deposit<T0>(arg1, 0x2::coin::split<T0>(arg2, v0, arg3));
        };
    ...
    public fun update_dev_wallet_address(arg0: &0x53320ba3d81fb7295bf9fafb2ce4e6bd1d2498e4143f7438271173b627e1646e::admin::AdminCap, arg1: &mut ProtocolFeeConfig, arg2: address) {
        assert_interacting_with_most_up_to_date_package(arg1);
