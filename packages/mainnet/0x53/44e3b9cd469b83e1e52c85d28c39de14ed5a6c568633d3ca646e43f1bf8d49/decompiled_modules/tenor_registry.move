module 0x3799d826b982e62e033ebfe4bca1aba4b5ab8d3cc31d5ea908fb5072b2ffddc4::tenor_registry {
    ...
    struct PoolInfoKey has copy, drop, store {
        market_id: 0x2::object::ID,
    }
    ...
    public fun pool_info(arg0: &MarketRegistry, arg1: 0x2::object::ID) : 0x1::option::Option<PoolInfo> {
        let v0 = PoolInfoKey{market_id: arg1};
        if (0x2::dynamic_field::exists<PoolInfoKey>(&arg0.id, v0)) {
            0x1::option::some<PoolInfo>(*0x2::dynamic_field::borrow<PoolInfoKey, PoolInfo>(&arg0.id, v0))
        } else {
    ...
    public(friend) fun set_pool_info(arg0: &mut MarketRegistry, arg1: 0x2::object::ID, arg2: 0x1::string::String, arg3: address) {
        ...
        if (0x2::dynamic_field::exists<PoolInfoKey>(&arg0.id, v0)) {
            ...
            *0x2::dynamic_field::borrow_mut<PoolInfoKey, PoolInfo>(&mut arg0.id, v0) = v1;
        } else {
            let v2 = PoolInfo{
                dex     : arg2,
                pool_id : arg3,
            };
            0x2::dynamic_field::add<PoolInfoKey, PoolInfo>(&mut arg0.id, v0, v2);
        };
