module 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::rate_limits {
    ...
    fun decode_and_verify_payload(arg0: &mut Config, arg1: vector<u8>, arg2: &0x2::clock::Clock) : (0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::Actions, vector<u8>) {
        let v0 = 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::payload::decode(&arg1);
        let v1 = 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::payload::get_message(&v0);
        assert!(0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::message::has_expired(&v1, arg2) == false, 6);
        assert!(0x2::table::contains<u64, bool>(&arg0.executed_messages, 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::message::get_deadline(&v1)), 10);
        0x2::table::add<u64, bool>(&mut arg0.executed_messages, 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::message::get_deadline(&v1), true);
        (0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::message::get_actions(&v1), 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::payload::recover_signer(&v0))
    }
    ...
    entry fun pause_s(arg0: &mut Config, arg1: vector<u8>, arg2: &0x2::clock::Clock) {
        ...
        let v2 = v0;
        assert!(0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::is_pause(&v2), 4);
    ...
    fun process_message(arg0: &mut Config, arg1: vector<u8>, arg2: &0x2::clock::Clock) {
        let (v0, v1) = decode_and_verify_payload(arg0, arg1, arg2);
        let v2 = v0;
        if (0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::is_set_hub_admin(&v2)) {
            assert!(v1 == arg0.hub_admin, 5);
            arg0.hub_admin = 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::get_hub_admin(&v2);
        } else if (0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::is_set_hub_signers(&v2)) {
            assert!(v1 == arg0.hub_admin, 5);
            arg0.hub_signers = 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::get_hub_signers(&v2);
        } else if (0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::is_set_rate_limit(&v2)) {
            assert!(is_authorized(arg0, v1), 5);
            let (v3, v4, v5) = 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::get_rate_limit(&v2);
            set_rate_limit_inner(arg0, v4, v5, timestamp_s(arg2), v3);
        } else if (0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::is_reset_rate_limit(&v2)) {
            assert!(is_authorized(arg0, v1), 5);
            reset_rate_limit(arg0, 0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::get_reset_token(&v2), timestamp_s(arg2));
        } else {
            assert!(0x53a138f54cda167455b4b52d7cfc128321372e5a5f384de25a10500ad0844ccd::actions::is_pause(&v2), 4);
            assert!(is_authorized(arg0, v1), 5);
            arg0.paused = true;
