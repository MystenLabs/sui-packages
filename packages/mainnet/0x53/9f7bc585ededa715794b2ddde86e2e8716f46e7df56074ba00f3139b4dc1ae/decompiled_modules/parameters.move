module 0x539f7bc585ededa715794b2ddde86e2e8716f46e7df56074ba00f3139b4dc1ae::parameters {
    struct Parameters has store, key {
        ...
        swap_threshold_bps_times_1k: u64,
        swap_minimum_start_quantity: u64,
        swap_step_start_quantity: u64,
    }
    ...
    public fun check_sender(arg0: &Parameters, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg1), 13906834724099194879);
    }
    ...
    public fun production_stonker_parameters(arg0: &mut 0x2::tx_context::TxContext) : Parameters {
        ...
        Parameters{
            ...
            maker_shallow_place_bps_times_1k            : 300,
            maker_deep_place_bps_times_1k               : 15000,
            maker_order_ttl_ms                          : 60000,
            maker_minimum_shallow_quantity_base         : 1000 * v0,
            ...
            swap_minimum_portfolio                      : 30000 * 1000000,
            ...
            single_base                                 : v0,
            position_limit_quote                        : 50000 * 1000000,
            ...
            swap_threshold_bps_times_1k                 : 300,
            swap_minimum_start_quantity                 : 300 * 1000000000,
            swap_step_start_quantity                    : 100 * 1000000000,
        }
    }
    ...
    public fun staging_stonker_parameters(arg0: &mut 0x2::tx_context::TxContext) : Parameters {
        ...
        v0.swap_minimum_portfolio = 0;
        v0.maker_trades_enabled = false;
        v0.trigger_bps_times_1k = 10000000;
        v0.swap_minimum_start_quantity = 2 * 1000000000;
        v0.swap_step_start_quantity = 1 * 1000000000;
        v0
    }

    public fun swap_minimum_portfolio(arg0: &Parameters) : u64 {
        arg0.swap_minimum_portfolio
    }

    public fun swap_minimum_start_quantity(arg0: &Parameters) : u64 {
        arg0.swap_minimum_start_quantity
    }

    public fun swap_step_start_quantity(arg0: &Parameters) : u64 {
        arg0.swap_step_start_quantity
    }

    public fun swap_threshold_bps_times_1k(arg0: &Parameters) : u64 {
        arg0.swap_threshold_bps_times_1k
    }
