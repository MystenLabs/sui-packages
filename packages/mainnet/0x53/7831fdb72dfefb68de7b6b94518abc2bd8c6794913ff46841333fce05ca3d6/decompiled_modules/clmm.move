module 0x537831fdb72dfefb68de7b6b94518abc2bd8c6794913ff46841333fce05ca3d6::clmm {
    ...
    public(friend) fun solve_optimal_zero_for_one(arg0: &SwapState) : u128 {
        ...
        let v6 = 1000000 - v5;
        let v7 = (v1 as u256) << 64;
        let v8 = (v0 as u128) + (((1000000 as u256) * v7 / (v6 as u256) * (v2 as u256)) as u128);
        let v9 = v8 - ((v7 / (v4 as u256)) as u128);
        assert!(v9 >= (v0 as u128), 1);
