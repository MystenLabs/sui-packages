module 0x53e39debafe345a5f8bbdd0b4daa5428ed05463945c063a7819ce0c47ad444a6::cnsnft3780 {
    struct CNSNFT3780 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3780, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3108"));
        let v4 = 0x2::package::claim<CNSNFT3780>(arg0, arg1);
