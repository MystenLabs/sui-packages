module 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault {
    ...
    public(friend) fun extend_lock<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        check_version(arg0.version);
        check_enabled(arg0.enabled);
        ...
        arg1.max_voting_power = 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::calculator::get_max_voting_power(arg1.locked_amount, arg3);
    ...
    public(friend) fun get_display_info(arg0: u64) : (0x1::string::String, 0x1::string::String, 0x2::url::Url) {
        ...
        let v1 = 0x1::string::utf8(b"https://veNAVX.com/image/");
    ...
    public(friend) fun lock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v3 = 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::calculator::get_max_voting_power(v2, arg3);
    ...
    public(friend) fun lock_for_max_power<T0>(arg0: &mut VeTokenVault<T0>, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : VoteEscrowedToken<T0> {
        ...
        let v4 = 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::calculator::get_max_voting_power(v3, v0);
        0x2::balance::join<T0>(&mut arg0.total_locked_balance, arg2);
    ...
    public(friend) fun merge_veToken<T0>(arg0: &mut VeTokenVault<T0>, arg1: vector<VoteEscrowedToken<T0>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (VoteEscrowedToken<T0>, vector<VoteEscrowedToken<T0>>) {
        ...
        let (v7, v8, v9) = get_display_info(arg0.ve_token_count);
        let v10 = PreUnlockVesting{
            amount         : 0,
            start_time     : 0,
            vesting_period : 0,
            claimed_amount : 0,
        };
        let v11 = VoteEscrowedToken<T0>{
            id                  : 0x2::object::new(arg3),
            base_token          : 0x1::type_name::get<T0>(),
            locked_amount       : v1,
            max_voting_power    : 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::calculator::get_max_voting_power(v1, v2),
            lock_start_time     : v0,
            lock_period         : v2,
            lock_end_time       : v0 + v2,
            is_active           : true,
            is_always_max_power : false,
            pre_unlock_vesting  : v10,
            name                : v7,
            description         : v8,
            url                 : v9,
        };
        arg0.ve_token_count = arg0.ve_token_count + 1;
        let v12 = VeTokenMerged{
            nft_ids           : v3,
            new_nft_id        : 0x2::object::uid_to_address(&v11.id),
            new_locked_amount : v1,
            new_lock_period   : v2,
        };
        0x2::event::emit<VeTokenMerged>(v12);
        (v11, arg1)
    }
    ...
    public(friend) fun pre_unlock<T0>(arg0: &mut VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock, arg3: u64) {
        ...
        let v2 = (((v1 as u128) * (0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::calculator::get_penalty_ratio(v0 - arg1.lock_start_time, arg1.lock_period, arg3) as u128) / (1000000 as u128)) as u64);
        let v3 = (v1 as u64) - v2;
        ...
        arg1.max_voting_power = 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::calculator::get_max_voting_power(v3, arg3);
        arg0.total_max_voting_power = arg0.total_max_voting_power - arg1.max_voting_power - arg1.max_voting_power;
    ...
    public(friend) fun switch_to_always_max_power<T0>(arg0: &VeTokenVault<T0>, arg1: &mut VoteEscrowedToken<T0>, arg2: &0x2::clock::Clock) {
        check_version(arg0.version);
        check_enabled(arg0.enabled);
        check_nft_active<T0>(arg1);
        check_already_pre_unlock_vesting<T0>(arg1);
        ...
        if (arg1.lock_period < 63072000000) {
            ...
            arg1.max_voting_power = 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::calculator::get_max_voting_power(arg1.locked_amount, 63072000000);
        };
        update_nft_lock_start_end_time<T0>(arg1, arg2);
        let v0 = SwitchedToAlwaysMaxPower{nft_id: 0x2::object::uid_to_address(&arg1.id)};
        0x2::event::emit<SwitchedToAlwaysMaxPower>(v0);
    }
    ...
    public(friend) fun update_pre_unlock<T0>(arg0: &mut VoteEscrowedToken<T0>, arg1: &0x2::clock::Clock) : (u64, bool) {
        ...
        let v3 = 0x1::ascii::string(b"passed_period: ");
        0x1::debug::print<0x1::ascii::String>(&v3);
        0x1::debug::print<u64>(&v1);
        let v4 = 0x1::ascii::string(b"vesting_period: ");
        0x1::debug::print<0x1::ascii::String>(&v4);
        0x1::debug::print<u64>(&v2);
        let (v5, v6) = if (v1 >= v2) {
            (v0.amount, true)
        } else {
            let v7 = (v1 as u128) * (1000000 as u128) / (v2 as u128);
            let v8 = 0x1::ascii::string(b"ratio: ");
            0x1::debug::print<0x1::ascii::String>(&v8);
            0x1::debug::print<u128>(&v7);
            let v9 = 0x1::ascii::string(b"pre_unlock_vesting.amount: ");
            0x1::debug::print<0x1::ascii::String>(&v9);
            0x1::debug::print<u64>(&v0.amount);
            ((((v0.amount as u128) * v7 / (1000000 as u128)) as u64), false)
        };
        let v10 = if (v5 > v0.claimed_amount) {
            v0.claimed_amount = v5;
            v5 - v0.claimed_amount
        } else {
            0
        };
        (v10, v6)
