module 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::reward {
    ...
    public(friend) fun claim_reward<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg2: &0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VoteEscrowedToken<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
        check_version(arg0);
        check_vault_id(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg1));
        update_nft_reward<T0>(arg0, arg2, arg1, arg3, arg4);
        let v0 = 0x1::type_name::get<T1>();
        let v1 = 0x2::table::borrow_mut<address, 0x2::table::Table<0x1::type_name::TypeName, u256>>(&mut arg0.nft_unclaimed_rewards, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::nft_id<T0>(arg2));
    ...
    public(friend) fun create_reward_manager<T0>(arg0: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg0);
        ...
        0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::set_reward_manager<T0>(arg0, 0x2::object::uid_to_address(&v1.id));
    ...
    public(friend) fun distribute_reward<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg2: u256, arg3: &0x2::clock::Clock) {
        check_version(arg0);
        check_vault_id(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg1));
        let v0 = 0x1::type_name::get<T1>();
    ...
    public(friend) fun init_update_nft_reward<T0>(arg0: &mut RewardManager, arg1: &0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VoteEscrowedToken<T0>, arg2: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        check_vault_id(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg2));
        update_reward_distributions<T0>(arg0, arg2, arg3);
        finish_update_nft_reward(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::nft_id<T0>(arg1), 0, arg4);
    }
    ...
    public(friend) fun set_reward_rate<T0, T1>(arg0: &mut RewardManager, arg1: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg2: u256, arg3: &0x2::clock::Clock) {
        check_version(arg0);
        check_vault_id(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg1));
    ...
    public fun update_nft_reward<T0>(arg0: &mut RewardManager, arg1: &0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VoteEscrowedToken<T0>, arg2: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        check_version(arg0);
        check_vault_id(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg2));
        update_reward_distributions<T0>(arg0, arg2, arg3);
        let v0 = if (0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::nft_is_active<T0>(arg1)) {
            0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::nft_max_voting_power<T0>(arg1)
        } else {
            0
        };
        finish_update_nft_reward(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::nft_id<T0>(arg1), v0, arg4);
    }

    public fun update_reward_distribution<T0>(arg0: &mut RewardManager, arg1: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg2: &0x2::clock::Clock, arg3: 0x1::type_name::TypeName) {
        check_version(arg0);
        check_vault_id(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg1));
        ...
        if (v0 > v1.last_update_time) {
            if (v1.rate == 0) {
                ...
                let v3 = (0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_total_max_voting_power<T0>(arg1) as u256);
    ...
    public fun update_reward_distributions<T0>(arg0: &mut RewardManager, arg1: &mut 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::VeTokenVault<T0>, arg2: &0x2::clock::Clock) {
        check_version(arg0);
        check_vault_id(arg0, 0x533e1310b59fc560850fd7782c209a63eaf722cefad462c3d36a15f28c5cfc12::vault::vault_id<T0>(arg1));
        let v0 = 0x2::vec_map::keys<0x1::type_name::TypeName, Distribution>(&arg0.distributions);
        let v1 = &v0;
