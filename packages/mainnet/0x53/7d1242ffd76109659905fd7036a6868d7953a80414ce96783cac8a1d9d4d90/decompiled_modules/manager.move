module 0x537d1242ffd76109659905fd7036a6868d7953a80414ce96783cac8a1d9d4d90::manager {
    ...
    fun consume_signature(arg0: &GalxeTable, arg1: &vector<u8>, arg2: &vector<u8>) {
        ...
        assert!(arg2 != &v0 && arg0.public_key != 0x1::vector::empty<u8>(), 13906835114941874187);
    }
