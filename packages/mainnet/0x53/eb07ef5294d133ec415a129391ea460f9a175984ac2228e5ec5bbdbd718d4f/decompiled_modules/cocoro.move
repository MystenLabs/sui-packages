module 0x53eb07ef5294d133ec415a129391ea460f9a175984ac2228e5ec5bbdbd718d4f::cocoro {
    ...
    fun init(arg0: COCORO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/base/0x937a1cfaf0a3d9f5dc4d0927f72ee5e3e5f82a00.png?claimId=E9upPqPjZBhxegGm                                                                                                                                                                                                          ");
