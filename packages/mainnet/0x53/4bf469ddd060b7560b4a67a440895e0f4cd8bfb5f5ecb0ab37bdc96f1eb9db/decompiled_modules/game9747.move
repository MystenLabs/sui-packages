module 0x534bf469ddd060b7560b4a67a440895e0f4cd8bfb5f5ecb0ab37bdc96f1eb9db::game9747 {
    struct GAME9747 has drop {
        dummy_field: bool,
    }

    struct TICKET_9747 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket9747(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9747>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9747>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME9747, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME9747>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9747>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9747>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9747>>(v5, 0x2::tx_context::sender(arg1));
    }
