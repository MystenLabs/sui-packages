module 0x53e17a6c7a5f7796e886d634e342466d088d4d167b3a9f1acb8c9b82971f5148::cnsnft2727 {
    struct CNSNFT2727 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2727, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2727>(arg0, arg1);
