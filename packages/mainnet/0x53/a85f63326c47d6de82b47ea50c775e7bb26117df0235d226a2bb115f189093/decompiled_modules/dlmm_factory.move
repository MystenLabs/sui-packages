module 0xb3a44310c59536782d1b5c29d01a066798750ff0c15242a7f3eb7e55d188cfc3::dlmm_factory {
    struct EventCreateFactory has copy, drop, store {
        factory_id: 0x2::object::ID,
    }

    struct DLMM_FACTORY has drop {
        dummy_field: bool,
    }
    ...
    struct Factory has store, key {
        ...
        opened_bin_steps: 0x2::vec_set::VecSet<u16>,
        available_bin_steps: 0x2::table::Table<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>>,
    ...
    public(friend) fun add_available_bin_step(arg0: &mut Factory, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName, arg3: u16, arg4: &mut 0x2::tx_context::TxContext) {
        if (!0x2::table::contains<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>>(&arg0.available_bin_steps, arg1)) {
            0x2::table::add<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>>(&mut arg0.available_bin_steps, arg1, 0x2::table::new<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>(arg4));
        };
        let v0 = 0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>>(&mut arg0.available_bin_steps, arg1);
        if (!0x2::table::contains<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>(v0, arg2)) {
            0x2::table::add<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>(v0, arg2, 0x2::vec_set::empty<u16>());
        };
        0x2::vec_set::insert<u16>(0x2::table::borrow_mut<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>(v0, arg2), arg3);
    }
    ...
    public fun add_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u16, arg3: u16, arg4: u16, arg5: u16, arg6: u16, arg7: u32, arg8: u16, arg9: u32) {
        check_admin(arg0, arg1);
        assert!(arg2 >= 1 && arg2 <= 1000, 8);
        assert!(!0x2::table::contains<u16, Preset>(&arg0.presets, arg2), 5);
        let v0 = Preset{
            base_factor                : arg3,
            filter_period              : arg4,
            decay_period               : arg5,
            ...
            protocol_share             : arg8,
            max_volatility_accumulator : arg9,
        };
        0x2::table::add<u16, Preset>(&mut arg0.presets, arg2, v0);
    ...
    public fun base_factor(arg0: &Preset) : u16 {
        arg0.base_factor
    }
    ...
    public fun close_bin_step_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u16) {
        check_admin(arg0, arg1);
        assert!(0x2::vec_set::contains<u16>(&arg0.opened_bin_steps, &arg2), 9223373265215422463);
        0x2::vec_set::remove<u16>(&mut arg0.opened_bin_steps, &arg2);
    ...
    public fun get_bin_step_preset(arg0: &Factory, arg1: u16) : Preset {
        assert!(0x2::vec_set::contains<u16>(&arg0.opened_bin_steps, &arg1), 3);
        assert!(0x2::table::contains<u16, Preset>(&arg0.presets, arg1), 4);
        *0x2::table::borrow<u16, Preset>(&arg0.presets, arg1)
    }

    public fun get_opened_bin_steps(arg0: &Factory) : &vector<u16> {
        0x2::vec_set::keys<u16>(&arg0.opened_bin_steps)
    }
    ...
    public fun grant_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Factory>(arg1), 9223372809948889087);
    ...
    public fun grant_protocol_fee_cap(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<Factory>(arg1), 9223373024697253887);
    ...
    fun init(arg0: DLMM_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DLMM_FACTORY>(arg0, arg1);
        let v1 = Factory{
            ...
            presets                     : 0x2::table::new<u16, Preset>(arg1),
            opened_bin_steps            : 0x2::vec_set::empty<u16>(),
            available_bin_steps         : 0x2::table::new<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, 0x2::vec_set::VecSet<u16>>>(arg1),
    ...
    public fun is_bin_step_preset_open(arg0: &Factory, arg1: u16) : bool {
        0x2::vec_set::contains<u16>(&arg0.opened_bin_steps, &arg1)
    }
    ...
    public fun open_bin_step_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u16) {
        check_admin(arg0, arg1);
        assert!(0x2::table::contains<u16, Preset>(&arg0.presets, arg2), 4);
        assert!(!0x2::vec_set::contains<u16>(&arg0.opened_bin_steps, &arg2), 9223373239445618687);
        0x2::vec_set::insert<u16>(&mut arg0.opened_bin_steps, arg2);
        let v0 = EventOpenBinStepPreset{
            bin_step : arg2,
            opened   : true,
        };
    ...
    public fun remove_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u16) {
        check_admin(arg0, arg1);
        assert!(0x2::table::contains<u16, Preset>(&arg0.presets, arg2), 1);
        if (0x2::vec_set::contains<u16>(&arg0.opened_bin_steps, &arg2)) {
            0x2::vec_set::remove<u16>(&mut arg0.opened_bin_steps, &arg2);
        };
        let v0 = EventRemovePreset{
            bin_step : arg2,
            preset   : 0x2::table::remove<u16, Preset>(&mut arg0.presets, arg2),
        };
        0x2::event::emit<EventRemovePreset>(v0);
    }

    public fun revoke_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_admin, &arg2), 9223372865783463935);
    ...
    public fun revoke_protocol_fee_cap(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_protocol_fee_cap, &arg2), 9223373080531828735);
        0x2::vec_set::remove<0x2::object::ID>(&mut arg0.allowed_admin, &arg2);
    ...
    public fun set_default_partner(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: &0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::partner::Partner) {
        assert!(0x2::package::from_package<Factory>(arg1), 9223372908733136895);
        if (0x1::option::is_some<0x2::object::ID>(&arg0.default_partner)) {
            0x1::option::extract<0x2::object::ID>(&mut arg0.default_partner);
        };
        0x1::option::fill<0x2::object::ID>(&mut arg0.default_partner, 0x2::object::id<0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::partner::Partner>(arg2));
    }

    public fun set_max_bins_in_position(arg0: &mut Factory, arg1: &AdminCap, arg2: u64) {
        let v0 = arg0.max_bins_in_position;
        assert!(v0 != arg2, 9223372977452613631);
    ...
    public fun update_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u16, arg3: Preset) {
        check_admin(arg0, arg1);
        assert!(0x2::table::contains<u16, Preset>(&arg0.presets, arg2), 4);
        0x2::table::add<u16, Preset>(&mut arg0.presets, arg2, arg3);
        let v0 = EventUpdatePreset{
            bin_step : arg2,
            old      : 0x2::table::remove<u16, Preset>(&mut arg0.presets, arg2),
            new      : arg3,
        };
