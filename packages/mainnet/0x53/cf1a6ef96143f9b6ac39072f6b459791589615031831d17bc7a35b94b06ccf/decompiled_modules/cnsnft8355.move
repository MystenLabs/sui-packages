module 0x53cf1a6ef96143f9b6ac39072f6b459791589615031831d17bc7a35b94b06ccf::cnsnft8355 {
    struct CNSNFT8355 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8355, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8355>(arg0, arg1);
