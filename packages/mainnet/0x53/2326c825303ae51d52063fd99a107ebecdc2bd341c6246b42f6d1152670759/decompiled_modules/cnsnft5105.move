module 0x532326c825303ae51d52063fd99a107ebecdc2bd341c6246b42f6d1152670759::cnsnft5105 {
    struct CNSNFT5105 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5105, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8606"));
        let v4 = 0x2::package::claim<CNSNFT5105>(arg0, arg1);
