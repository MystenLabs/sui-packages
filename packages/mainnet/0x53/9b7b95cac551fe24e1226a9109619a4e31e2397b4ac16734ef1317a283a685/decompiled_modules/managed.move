module 0x539b7b95cac551fe24e1226a9109619a4e31e2397b4ac16734ef1317a283a685::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"XRS", b"Xronos", b"Xronos is ready!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/33xaQ1V.webp")), arg1);
