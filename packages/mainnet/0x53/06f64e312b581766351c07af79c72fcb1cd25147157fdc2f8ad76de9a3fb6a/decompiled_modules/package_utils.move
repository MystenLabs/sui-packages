module 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::package_utils {
    ...
    public fun authorize_upgrade(arg0: &mut 0x2::object::UID, arg1: &mut 0x2::package::UpgradeCap, arg2: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes32::Bytes32) : 0x2::package::UpgradeTicket {
        set_authorized_digest(arg0, arg2);
        0x2::package::authorize_upgrade(arg1, 0x2::package::upgrade_policy(arg1), 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes32::to_bytes(arg2))
    }
    ...
    public fun authorized_digest(arg0: &0x2::object::UID) : 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes32::Bytes32 {
    ...
    public fun current_digest(arg0: &0x2::object::UID) : 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes32::Bytes32 {
    ...
    public fun init_package_info<T0: store>(arg0: &mut 0x2::object::UID, arg1: T0, arg2: &0x2::package::UpgradeCap) {
        ...
        let v2 = PackageInfo{
            package : v0,
            digest  : 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes32::default(),
        };
    ...
    fun set_authorized_digest(arg0: &mut 0x2::object::UID, arg1: 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes32::Bytes32) {
        let v0 = PendingPackage{dummy_field: false};
