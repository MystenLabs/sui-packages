module 0x535639b192b85666eedaa2a346777c5f21ece686eaf74bfff76c76c2df8c5ce0::protocol {
    ...
    public entry fun initialize(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = MessageRegistryV2{
            id       : 0x2::object::new(arg0),
            messages : 0x2::table::new<u64, MessageRecordV2>(arg0),
            next_id  : 0,
        };
        0x2::transfer::share_object<MessageRegistryV2>(v3);
    }
