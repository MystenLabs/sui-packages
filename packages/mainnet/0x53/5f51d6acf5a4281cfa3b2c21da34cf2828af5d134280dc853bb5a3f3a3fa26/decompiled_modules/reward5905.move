module 0x535f51d6acf5a4281cfa3b2c21da34cf2828af5d134280dc853bb5a3f3a3fa26::reward5905 {
    struct REWARD5905 has drop {
        dummy_field: bool,
    }

    struct TICKET_5905 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5905(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_5905>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5905, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5905>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5905>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5905>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5905>>(v5, 0x2::tx_context::sender(arg1));
    }
