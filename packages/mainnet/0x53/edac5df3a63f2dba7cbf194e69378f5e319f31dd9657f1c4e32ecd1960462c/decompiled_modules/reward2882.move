module 0x53edac5df3a63f2dba7cbf194e69378f5e319f31dd9657f1c4e32ecd1960462c::reward2882 {
    struct REWARD2882 has drop {
        dummy_field: bool,
    }

    struct TICKET_2882 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2882(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2882>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2882>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2882, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2882>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2882>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2882>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2882>>(v5, 0x2::tx_context::sender(arg1));
    }
