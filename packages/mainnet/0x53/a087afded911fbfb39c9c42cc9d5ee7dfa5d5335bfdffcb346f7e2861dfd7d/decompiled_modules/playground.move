module 0x9db741d5dfea02b1aadedaff43e73bde3972adf82beadf7cc6da26f107bfbc54::playground {
    ...
    struct WorkspaceRegistry has key {
        id: 0x2::object::UID,
        members: 0x2::table::Table<0x2::object::ID, 0x2::vec_set::VecSet<address>>,
    }
    ...
    struct AppUpdatedV2 has copy, drop {
        app_id: 0x2::object::ID,
        tree_hash: 0x1::string::String,
        manifest_blob: 0x1::string::String,
        archive_blob: 0x1::string::String,
    ...
    struct WorkspaceMemberInvited has copy, drop {
        app_id: 0x2::object::ID,
        builder: address,
        member: address,
    }

    struct WorkspaceMemberRevoked has copy, drop {
        app_id: 0x2::object::ID,
        builder: address,
        member: address,
    }
    ...
    public fun create_workspace_registry(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = WorkspaceRegistry{
            id      : 0x2::object::new(arg0),
            members : 0x2::table::new<0x2::object::ID, 0x2::vec_set::VecSet<address>>(arg0),
        };
        0x2::transfer::share_object<WorkspaceRegistry>(v0);
    }

    public fun deposit_fee(arg0: &mut Treasury, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
    ...
    fun ensure_workspace(arg0: &mut WorkspaceRegistry, arg1: 0x2::object::ID) : &mut 0x2::vec_set::VecSet<address> {
        if (!0x2::table::contains<0x2::object::ID, 0x2::vec_set::VecSet<address>>(&arg0.members, arg1)) {
            0x2::table::add<0x2::object::ID, 0x2::vec_set::VecSet<address>>(&mut arg0.members, arg1, 0x2::vec_set::empty<address>());
        };
        0x2::table::borrow_mut<0x2::object::ID, 0x2::vec_set::VecSet<address>>(&mut arg0.members, arg1)
    }
    ...
    public fun invite_workspace_member(arg0: &mut WorkspaceRegistry, arg1: &PublishedApp, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.builder, 4);
        let v0 = 0x2::object::id<PublishedApp>(arg1);
        let v1 = ensure_workspace(arg0, v0);
        if (!0x2::vec_set::contains<address>(v1, &arg2)) {
            0x2::vec_set::insert<address>(v1, arg2);
        };
        let v2 = WorkspaceMemberInvited{
            app_id  : v0,
            builder : arg1.builder,
            member  : arg2,
        };
        0x2::event::emit<WorkspaceMemberInvited>(v2);
    }
    ...
    public fun is_workspace_member(arg0: &WorkspaceRegistry, arg1: 0x2::object::ID, arg2: address) : bool {
        0x2::table::contains<0x2::object::ID, 0x2::vec_set::VecSet<address>>(&arg0.members, arg1) && 0x2::vec_set::contains<address>(0x2::table::borrow<0x2::object::ID, 0x2::vec_set::VecSet<address>>(&arg0.members, arg1), &arg2)
    }
    ...
    public(friend) fun pay_from_treasury(arg0: &mut Treasury, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun revoke_workspace_member(arg0: &mut WorkspaceRegistry, arg1: &PublishedApp, arg2: address, arg3: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg1.builder, 4);
        let v0 = 0x2::object::id<PublishedApp>(arg1);
        if (0x2::table::contains<0x2::object::ID, 0x2::vec_set::VecSet<address>>(&arg0.members, v0)) {
            let v1 = 0x2::table::borrow_mut<0x2::object::ID, 0x2::vec_set::VecSet<address>>(&mut arg0.members, v0);
            if (0x2::vec_set::contains<address>(v1, &arg2)) {
                0x2::vec_set::remove<address>(v1, &arg2);
            };
        };
        let v2 = WorkspaceMemberRevoked{
            app_id  : v0,
            builder : arg1.builder,
            member  : arg2,
        };
        0x2::event::emit<WorkspaceMemberRevoked>(v2);
    }

    entry fun seal_approve_app_member(arg0: vector<u8>, arg1: &PublishedApp, arg2: &WorkspaceRegistry, arg3: &0x2::tx_context::TxContext) {
        assert!(id_in_app(arg1, &arg0), 14);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == arg1.builder || is_workspace_member(arg2, 0x2::object::id<PublishedApp>(arg1), v0), 15);
    }
    ...
    public fun update_app_v2(arg0: &mut PublishedApp, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == arg0.builder, 4);
        arg0.manifest_blob = arg1;
        arg0.archive_blob = arg2;
        arg0.tree_hash = arg3;
        let v0 = AppUpdatedV2{
            ...
            archive_blob  : arg0.archive_blob,
            updated_at_ms : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<AppUpdatedV2>(v0);
    }
