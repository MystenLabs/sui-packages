module 0x53ba435d4a6b4ca3b3e5b454a0346cf5b658bd85512bf54467974570f1d395e8::stable_math {
    ...
    public fun add_liquidity_computation(arg0: u64, arg1: vector<u256>, arg2: vector<u256>, arg3: u64, arg4: u256) : (u256, vector<u256>) {
        ...
        let v3 = 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::add_vectors_u256(arg1, arg2);
        ...
        let v5 = if (arg4 == 0) {
            ...
            0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div_u256(arg4, compute_d(arg0, 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::subtract_vectors_u256(v3, v1)) - v2, v2)
        };
        (v5, v1)
    }
    ...
    fun calc_y(arg0: u64, arg1: u64, arg2: u256, arg3: vector<u256>, arg4: u64) : u256 {
        ...
        while (v9 < 256) {
            let v10 = v8;
            let v11 = (v8 * v8 + v2 * v1 / (0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_to_u128(v4, v0) as u256)) / (v8 + v8 + v3 + v1 / (v4 as u256) - v1);
            v8 = v11;
    ...
    public fun calculate_fee_charged(arg0: u256, arg1: u256, arg2: u256, arg3: u256, arg4: u64) : u256 {
        0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div_u256(0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::subtract_mod_u256(arg1, 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div_u256(arg3, arg0, arg2)), (arg4 as u256), (0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::constants::amm_fee_precision() as u256))
    }
    ...
    public fun compute_current_amp(arg0: &0x2::clock::Clock, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        if (v0 > arg2 && v0 < arg4) {
            ...
            if (arg3 > arg1) {
                arg1 + 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div(v2, v0 - arg2, arg4 - arg2)
            } else {
                arg1 - 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div(v2, v0 - arg2, arg4 - arg2)
            }
        } else {
    ...
    public fun compute_d(arg0: u64, arg1: vector<u256>) : u256 {
        ...
        while (v6 < 256) {
            ...
            v3 = 0;
            while (v3 < v0) {
                v7 = 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div_u256(v7, v4, *0x1::vector::borrow<u256>(&arg1, v3) * (v0 as u256));
                v3 = v3 + 1;
            };
            let v8 = v4;
    ...
    public fun compute_offer_amount(arg0: u64, arg1: u256, arg2: u64, arg3: u64, arg4: vector<u256>, arg5: u64) : (u256, u256) {
        ...
        let v1 = 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div_u256(arg1, (v0 as u256), ((v0 - arg5) as u256));
    ...
    public fun imbalanced_liquidity_withdraw(arg0: u64, arg1: vector<u256>, arg2: u256, arg3: vector<u256>, arg4: u64) : (u256, vector<u256>) {
        ...
        let v1 = 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::create_zero_vector_u256(v0);
        let v2 = compute_d(arg0, arg1);
        let v3 = 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::subtract_vectors_u256(arg1, arg3);
        let v4 = 0;
        while (v4 < v0) {
        ...
        (0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::mul_div_u256(arg2, v2 - compute_d(arg0, 0xaac0b9fd410a5c3035452af62cdf3440de0e214f0829c4a8624ecb0a3657d786::math::subtract_vectors_u256(v3, v1)), v2), v1)
    }
