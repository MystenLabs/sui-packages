module 0x48393b16be854688f6c54ba562530e278f154ba1f49edc267402ec75e4bff105::springsui_lsd {
    struct SpringsuiLsdSwapEvent has copy, drop {
    ...
    public fun swap_a2b<T0: drop>(arg0: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T0>, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = SpringsuiLsdSwapEvent{
            pool_id      : 0x2::object::id<0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T0>>(arg0),
            a2b          : true,
        ...
        0x2::event::emit<SpringsuiLsdSwapEvent>(v1);
        v0
    }
