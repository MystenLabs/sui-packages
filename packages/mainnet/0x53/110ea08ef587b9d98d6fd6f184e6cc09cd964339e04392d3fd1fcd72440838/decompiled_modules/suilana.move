module 0x53110ea08ef587b9d98d6fd6f184e6cc09cd964339e04392d3fd1fcd72440838::suilana {
    ...
    fun init(arg0: SUILANA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SUILANA>(&mut v2, 10000000000000000, 0x2::tx_context::sender(arg1), arg1);
