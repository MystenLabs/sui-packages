module 0x53558f5dc4e73ab7742cf0ed4fe1fbfd9845ef4a47b5e0d2140c16b225987068::reward6441 {
    struct REWARD6441 has drop {
        dummy_field: bool,
    }

    struct TICKET_6441 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6441(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6441>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6441>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6441, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6441>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6441>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6441>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6441>>(v5, 0x2::tx_context::sender(arg1));
    }
