module 0x530754497297ef889826280e5545c28652ad5854e33b375a9ea8d883f65c1350::reward1616 {
    struct REWARD1616 has drop {
        dummy_field: bool,
    }

    struct TICKET_1616 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1616(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1616>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1616>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1616, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1616>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1616>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1616>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1616>>(v5, 0x2::tx_context::sender(arg1));
    }
