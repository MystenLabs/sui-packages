module 0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::project_registry {
    ...
    fun assert_global_admin(arg0: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::Registry, arg1: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::AdminCap, arg2: address) {
        assert!(0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::is_admin(arg0, arg2, 0x2::object::id<0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::AdminCap>(arg1)), 1);
    }

    fun assert_global_owner(arg0: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::Registry, arg1: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::OwnerCap, arg2: address) {
        assert!(0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::is_owner(arg0, arg2, 0x2::object::id<0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::OwnerCap>(arg1)), 1);
    }
    ...
    fun assert_project_reviewer(arg0: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::Registry, arg1: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::ReviewerCap, arg2: address) {
        assert!(0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::is_reviewer(arg0, arg2, 0x2::object::id<0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::ReviewerCap>(arg1)), 3);
    }
    ...
    public fun create_form(arg0: &mut Project, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = next_form_id(&arg0.forms);
    ...
    public fun create_project(arg0: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::AdminCap, arg1: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::Registry, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : ProjectOwnerCap {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun create_project_by_owner(arg0: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::OwnerCap, arg1: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::Registry, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) : ProjectOwnerCap {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    fun next_form_id(arg0: &vector<Form>) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v0 < 0x1::vector::length<Form>(arg0)) {
            let v2 = 0x1::vector::borrow<Form>(arg0, v0);
            if (v2.form_id >= v1) {
                v1 = v2.form_id + 1;
            };
            v0 = v0 + 1;
    ...
    entry fun seal_approve_project_reviewer(arg0: vector<u8>, arg1: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::Registry, arg2: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::ReviewerCap, arg3: &Project, arg4: &0x2::tx_context::TxContext) {
    ...
    entry fun seal_approve_project_signal_reviewer(arg0: vector<u8>, arg1: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::Registry, arg2: &0x53c9d83b3eb4cace2b7c2a0a71588fc05c0c17adad87ae1c424742d4ce384be1::access_control::ReviewerCap, arg3: &Project, arg4: &0x2::tx_context::TxContext) {
        assert_project_reviewer(arg1, arg2, 0x2::tx_context::sender(arg4));
