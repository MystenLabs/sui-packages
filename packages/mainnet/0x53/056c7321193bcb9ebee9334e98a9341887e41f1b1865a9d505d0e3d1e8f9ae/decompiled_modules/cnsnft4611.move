module 0x53056c7321193bcb9ebee9334e98a9341887e41f1b1865a9d505d0e3d1e8f9ae::cnsnft4611 {
    struct CNSNFT4611 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4611, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4611>(arg0, arg1);
