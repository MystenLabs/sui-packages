module 0x5381746ba2cbfca08e173a13ae37469df4312d7906a4e3c215ad6db4b6a8ebca::cnsnft5494 {
    struct CNSNFT5494 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5494, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7996"));
        let v4 = 0x2::package::claim<CNSNFT5494>(arg0, arg1);
