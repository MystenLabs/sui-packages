module 0x5326a49e7ca07df6236f28a71eaa14b9b05452afae517f17fd3b784b5b592504::reward6879 {
    struct REWARD6879 has drop {
        dummy_field: bool,
    }

    struct TICKET_6879 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6879(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6879>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6879>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6879>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6879>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6879>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6879>>(v5, 0x2::tx_context::sender(arg1));
    }
