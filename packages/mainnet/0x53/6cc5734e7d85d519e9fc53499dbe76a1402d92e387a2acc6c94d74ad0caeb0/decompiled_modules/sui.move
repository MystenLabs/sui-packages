module 0x536cc5734e7d85d519e9fc53499dbe76a1402d92e387a2acc6c94d74ad0caeb0::sui {
    struct SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUI>(arg0, 9, b"SUI", b"SUI", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://assets-currency.kucoin.com/644b3314022eae0001db3110_coin-logo.png")), arg1);
        let v2 = v0;
