module 0x53bbf6edd1e79663d1e514c931a62590ea5afcaa0a61fcf7c838674efe49e330::managed {
    struct MANAGED has drop {
        dummy_field: bool,
    }

    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"FlokiSUI", b"3", b"2", 0x1::option::none<0x2::url::Url>(), arg1);
