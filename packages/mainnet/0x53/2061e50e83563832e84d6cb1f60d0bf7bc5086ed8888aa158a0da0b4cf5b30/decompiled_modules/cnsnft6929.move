module 0x532061e50e83563832e84d6cb1f60d0bf7bc5086ed8888aa158a0da0b4cf5b30::cnsnft6929 {
    struct CNSNFT6929 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6929, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6929>(arg0, arg1);
