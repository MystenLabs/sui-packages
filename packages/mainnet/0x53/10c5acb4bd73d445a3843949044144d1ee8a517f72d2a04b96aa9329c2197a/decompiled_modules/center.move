module 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::center {
    ...
    struct BiglottoCenter<phantom T0> has key {
        ...
        payment_config: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payment::PaymentConfig,
        draw_config: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::draw::DrawConfig,
        payouts_config: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payouts::PayoutsConfig,
        jackpot_combination: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::combination::Combination,
    ...
    public fun create<T0>(arg0: &AdminCap, arg1: vector<address>, arg2: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payment::PaymentConfig, arg3: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::draw::DrawConfig, arg4: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payouts::PayoutsConfig, arg5: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::combination::Combination, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    public fun draw_config<T0>(arg0: &BiglottoCenter<T0>) : &0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::draw::DrawConfig {
        &arg0.draw_config
    }
    ...
    public fun jackpot_combination<T0>(arg0: &BiglottoCenter<T0>) : 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::combination::Combination {
    ...
    public fun payment_config<T0>(arg0: &BiglottoCenter<T0>) : &0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payment::PaymentConfig {
        &arg0.payment_config
    }

    public fun payouts_config<T0>(arg0: &BiglottoCenter<T0>) : &0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payouts::PayoutsConfig {
        &arg0.payouts_config
    }
    ...
    public fun ticket_cost<T0>(arg0: &BiglottoCenter<T0>) : u64 {
        0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payment::ticket_cost(payment_config<T0>(arg0))
    }

    public fun update_draw_config<T0>(arg0: &AdminCap, arg1: &mut BiglottoCenter<T0>, arg2: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::draw::DrawConfig) {
        assert_valid_package_version<T0>(arg1);
        arg1.draw_config = arg2;
    }

    public fun update_payment_config<T0>(arg0: &AdminCap, arg1: &mut BiglottoCenter<T0>, arg2: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payment::PaymentConfig) {
        assert_valid_package_version<T0>(arg1);
        arg1.payment_config = arg2;
    }

    public fun update_payouts_config<T0>(arg0: &AdminCap, arg1: &mut BiglottoCenter<T0>, arg2: 0x5310c5acb4bd73d445a3843949044144d1ee8a517f72d2a04b96aa9329c2197a::payouts::PayoutsConfig) {
        assert_valid_package_version<T0>(arg1);
