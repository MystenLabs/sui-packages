module 0x53bff86161ab0d435bf698c8dd346d42893c91fee1d23f97d56b8db07356044b::reward8437 {
    struct REWARD8437 has drop {
        dummy_field: bool,
    }

    struct TICKET_8437 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8437(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8437>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8437>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8437, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8437>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8437>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8437>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8437>>(v5, 0x2::tx_context::sender(arg1));
    }
