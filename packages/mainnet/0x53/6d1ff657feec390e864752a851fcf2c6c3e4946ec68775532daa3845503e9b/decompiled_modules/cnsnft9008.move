module 0x536d1ff657feec390e864752a851fcf2c6c3e4946ec68775532daa3845503e9b::cnsnft9008 {
    struct CNSNFT9008 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9008, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9008>(arg0, arg1);
