module 0x53882a39ddca19989b9f4a5aa07cce5c356ba929addbbf69aafd781940021055::version {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : Version {
        Version{
            ...
            major_version : 0x53882a39ddca19989b9f4a5aa07cce5c356ba929addbbf69aafd781940021055::current_version::current_major_version(),
            minor_version : 0x53882a39ddca19989b9f4a5aa07cce5c356ba929addbbf69aafd781940021055::current_version::current_minor_version(),
        }
    }
    ...
    public fun is_supported_major_version(arg0: &Version) : bool {
        arg0.major_version == 0x53882a39ddca19989b9f4a5aa07cce5c356ba929addbbf69aafd781940021055::current_version::current_major_version()
    }

    public fun is_supported_minor_version(arg0: &Version) : bool {
        0x53882a39ddca19989b9f4a5aa07cce5c356ba929addbbf69aafd781940021055::current_version::current_minor_version() >= arg0.minor_version
    }
    ...
    public fun upgrade_major(arg0: &mut Version, arg1: &VersionCap) {
        arg0.major_version = 0x53882a39ddca19989b9f4a5aa07cce5c356ba929addbbf69aafd781940021055::current_version::current_major_version() + 1;
    }
