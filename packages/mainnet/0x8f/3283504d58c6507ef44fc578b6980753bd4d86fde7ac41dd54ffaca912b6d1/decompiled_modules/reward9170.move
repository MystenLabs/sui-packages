module 0x8f3283504d58c6507ef44fc578b6980753bd4d86fde7ac41dd54ffaca912b6d1::reward9170 {
    struct REWARD9170 has drop {
        dummy_field: bool,
    }

    struct TICKET_9170 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9170(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9170>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9170>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9170, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9170>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9170>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9170>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9170>>(v5, 0x2::tx_context::sender(arg1));
    }
