module 0x8f6e16f3d18246e405ab163eeec33d97c4a96d3f491ae904c4b6f327fe462d75::cnsnft8147 {
    struct CNSNFT8147 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8147, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8147>(arg0, arg1);
