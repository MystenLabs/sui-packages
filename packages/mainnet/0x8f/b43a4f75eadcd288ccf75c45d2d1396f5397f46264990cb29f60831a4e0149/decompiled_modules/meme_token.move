module 0x8fb43a4f75eadcd288ccf75c45d2d1396f5397f46264990cb29f60831a4e0149::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"RG", b"Ronaldo Gem", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raidenimage.blob.core.windows.net/raidenimg/2025-09-12T14-04-06.743Z-toji-fushiguro-anime-character-mqjc41j5m0opdlf8.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Ronaldo Gem"),
            symbol     : 0x1::string::utf8(b"RG"),
            decimals   : 9,
