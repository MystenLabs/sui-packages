module 0x8fe31dfad78ad6229a581f3d5a017dfdef92d19a0b5b71758d13a5e35557abc3::suipump {
    struct SUIPUMP has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIPUMP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUIPUMP>(arg0, 9, b"SUICAT", b"Suicat", b"The Bald Cat of Sui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/eXzg8r3.jpeg")), arg1);
        let v2 = v0;
