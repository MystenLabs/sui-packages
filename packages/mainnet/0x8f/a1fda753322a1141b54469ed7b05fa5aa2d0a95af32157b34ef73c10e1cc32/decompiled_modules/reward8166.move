module 0x8fa1fda753322a1141b54469ed7b05fa5aa2d0a95af32157b34ef73c10e1cc32::reward8166 {
    struct REWARD8166 has drop {
        dummy_field: bool,
    }

    struct TICKET_8166 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8166(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8166>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8166>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8166, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8166>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8166>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8166>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8166>>(v5, 0x2::tx_context::sender(arg1));
    }
