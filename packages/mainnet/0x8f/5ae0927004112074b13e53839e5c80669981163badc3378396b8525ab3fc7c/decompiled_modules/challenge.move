module 0x8f5ae0927004112074b13e53839e5c80669981163badc3378396b8525ab3fc7c::challenge {
    ...
    entry fun solve(arg0: &mut Challenge, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::string::utf8(b"bbe2ecd0-7ba2-4817-a410-1df7e8b8b3b3");
        let v1 = 0x1::hash::sha3_256(*0x1::string::as_bytes(&arg0.secret));
        let v2 = 0x1::bcs::to_bytes<0x1::string::String>(&arg0.secret);
        0x1::vector::append<u8>(&mut v2, *0x1::string::as_bytes(&v0));
        let v3 = *0x1::string::as_bytes(&arg0.secret);
        let v4 = 0x1::vector::length<u8>(&v3) * 2;
        let v5 = arg0.current_score % 1000 + v4;
        get_flag((*0x1::vector::borrow<u8>(&v1, 0) as u64) << 24 | (*0x1::vector::borrow<u8>(&v1, 1) as u64) << 16 | (*0x1::vector::borrow<u8>(&v1, 2) as u64) << 8 | (*0x1::vector::borrow<u8>(&v1, 3) as u64), b"", 0x1::hash::sha3_256(v2), v0, v5, v4, arg0, arg1, arg2);
    }
