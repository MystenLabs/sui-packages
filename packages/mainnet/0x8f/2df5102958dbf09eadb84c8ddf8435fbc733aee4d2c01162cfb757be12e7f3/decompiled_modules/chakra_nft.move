module 0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::chakra_nft {
    ...
    struct GlobalConfig has key {
        ...
        version: 0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::version::Version,
    }
    ...
    public fun admin_add_whale_refferal_wl(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0x2::table::add<address, bool>(&mut arg1.whale_refferal_wl, arg2, true);
    }

    public fun admin_overwrite_referral(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: u64, arg3: &mut GlobalConfig, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun admin_remove_whale_refferal_wl(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: &0x2::tx_context::TxContext) {
        0x2::table::remove<address, bool>(&mut arg1.whale_refferal_wl, arg2);
    }

    public fun admin_set_base_price(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.base_price = arg1;
    }

    public fun admin_set_boost_a(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_a = arg1;
    }

    public fun admin_set_boost_b(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_b = arg1;
    }

    public fun admin_set_boost_c(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_c = arg1;
    }

    public fun admin_set_boost_d(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_d = arg1;
    }

    public fun admin_set_boost_e(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_e = arg1;
    }

    public fun admin_set_boost_f(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.boost_f = arg1;
    }

    public fun admin_set_display_url(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut 0x2::display::Display<ChakraNFT>, arg2: 0x1::string::String, arg3: &0x2::tx_context::TxContext) {
        0x2::display::edit<ChakraNFT>(arg1, 0x1::string::utf8(b"image_url"), arg2);
        0x2::display::update_version<ChakraNFT>(arg1);
    }

    public fun admin_set_referral_price(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.referral_price = arg1;
    }

    public fun admin_set_refferal_limit_per_acc(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.max_codes_per_acc = arg1;
    }

    public fun admin_set_refferal_limit_per_whale(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: u64, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.max_codes_per_whale = arg1;
    }

    public fun admin_set_status(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: bool, arg2: &mut GlobalConfig, arg3: &0x2::tx_context::TxContext) {
        arg2.status = arg1;
    }
    ...
    public fun batch_update_a(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
    ...
    public fun batch_update_b(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 1,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_c(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 2,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_d(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 3,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_e(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 4,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    public fun batch_update_f(arg0: &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::admin::AdminCap, arg1: &mut GlobalConfig, arg2: vector<address>, arg3: bool, arg4: &0x2::tx_context::TxContext) {
        let v0 = BatchBoostUpdateEvent{
            boost_category    : 5,
            is_added          : arg3,
            updated_addresses : arg2,
    ...
    fun init(arg0: CHAKRA_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = GlobalConfig{
            ...
            total_maya_burnt    : 0,
            version             : 0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::version::new(arg1),
        };
    ...
    public fun version(arg0: &GlobalConfig) : &0x8f2df5102958dbf09eadb84c8ddf8435fbc733aee4d2c01162cfb757be12e7f3::version::Version {
        &arg0.version
    }
