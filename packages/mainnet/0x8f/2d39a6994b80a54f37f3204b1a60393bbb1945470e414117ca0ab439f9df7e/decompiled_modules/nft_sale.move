module 0x8f2d39a6994b80a54f37f3204b1a60393bbb1945470e414117ca0ab439f9df7e::nft_sale {
    ...
    public entry fun burn3(arg0: NFT) {
        let NFT {
            id          : v0,
            token_id    : _,
            name        : _,
    ...
    fun init(arg0: NFT_SALE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Rotten Us 10 unique rotten characters on Sui."));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://twitter.com/Rotten_Us"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"RTN"));
        ...
        let v6 = Collection{
            ...
            name         : 0x1::string::utf8(b"Rotten us "),
            description  : 0x1::string::utf8(b"Rotten Us 10 unique rotten characters on Sui."),
            base_url     : 0x1::string::utf8(b"ipfs://QmU4GxmFpyBiAJCExpdMAFiBfTDhPceuxZhVrFWnjWcET9/"),
            total        : 2222,
            current      : 350,
    ...
    public entry fun mint_nft(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: vector<u8>, arg3: &mut Collection, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        loop {
            ...
            0x1::string::append(&mut v7, 0x1::string::utf8(b".jpg"));
