module 0x7452c8ce8db1991fe41e500a4778b04f5b1d8891528b0376988f966cbdae5409::plan {
    ...
    public(friend) fun advance<T0>(arg0: &mut Plan<T0>, arg1: u64, arg2: 0x2::object::ID) {
        ...
        if (0x1::vector::is_empty<RouteState>(&arg0.routes)) {
    ...
    public fun is_direct<T0>(arg0: &Plan<T0>) : bool {
        0x1::vector::is_empty<RouteState>(&arg0.routes)
    }
    ...
    public(friend) fun new_direct<T0>(arg0: 0x2::balance::Balance<T0>, arg1: u64, arg2: u64) : Plan<T0> {
        let v0 = 0x2::balance::value<T0>(&arg0);
        assert!(arg1 >= v0, 11);
        assert!(arg2 <= v0, 11);
        Plan<T0>{
