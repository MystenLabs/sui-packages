module 0x8f4bcbae32ab0ac1135ddd631e1634efd7cafe5f519ca387ef444ff96a99e64a::reward9825 {
    struct REWARD9825 has drop {
        dummy_field: bool,
    }

    struct TICKET_9825 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9825(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9825>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9825>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9825, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9825>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9825>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9825>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9825>>(v5, 0x2::tx_context::sender(arg1));
    }
