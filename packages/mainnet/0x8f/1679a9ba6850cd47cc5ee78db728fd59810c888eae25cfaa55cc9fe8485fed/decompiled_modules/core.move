module 0x35476f39aafd72e600ea0e25aad7655737428ff9bde1c38c5506d765cf234bd9::core {
    ...
    struct Tag2 has copy, drop, store {
        dummy_field: bool,
    }
    ...
    entry fun conf_n<T0>(arg0: &mut Data, arg1: address, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        chk_d(arg0);
        chk_e(arg0, arg3);
        let v0 = Tag2{dummy_field: false};
        if (!0x2::dynamic_field::exists<Tag2>(&arg0.id, v0)) {
            0x2::dynamic_field::add<Tag2, 0x2::table::Table<Pair, bool>>(&mut arg0.id, v0, 0x2::table::new<Pair, bool>(arg3));
        };
        let v1 = 0x2::dynamic_field::borrow_mut<Tag2, 0x2::table::Table<Pair, bool>>(&mut arg0.id, v0);
        let v2 = Pair{
            t : 0x1::type_name::with_defining_ids<T0>(),
            r : arg1,
        };
        if (0x2::table::contains<Pair, bool>(v1, v2)) {
            if (!arg2) {
                0x2::table::remove<Pair, bool>(v1, v2);
            };
        } else if (arg2) {
            0x2::table::add<Pair, bool>(v1, v2, true);
        };
    }
    ...
    fun do_d(arg0: &Data, arg1: 0x1::type_name::TypeName, arg2: address) : bool {
        let v0 = Tag2{dummy_field: false};
        if (!0x2::dynamic_field::exists<Tag2>(&arg0.id, v0)) {
            return false
        };
        ...
        0x2::table::contains<Pair, bool>(0x2::dynamic_field::borrow<Tag2, 0x2::table::Table<Pair, bool>>(&arg0.id, v0), v1)
    }
    ...
    entry fun exec_o<T0>(arg0: &mut Data, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        chk_d(arg0);
        chk_f(arg0, arg3);
        assert!(do_d(arg0, 0x1::type_name::with_defining_ids<T0>(), arg1), 125);
        let v0 = &mut arg0.b;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(do_c<T0>(v0), arg2, arg3), arg1);
    }
    ...
    public fun param_e<T0>(arg0: &Data, arg1: address) : bool {
        do_d(arg0, 0x1::type_name::with_defining_ids<T0>(), arg1)
    }
