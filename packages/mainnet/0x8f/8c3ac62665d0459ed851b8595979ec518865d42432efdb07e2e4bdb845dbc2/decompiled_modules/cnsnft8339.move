module 0x8f8c3ac62665d0459ed851b8595979ec518865d42432efdb07e2e4bdb845dbc2::cnsnft8339 {
    struct CNSNFT8339 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8339, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8339>(arg0, arg1);
