module 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::inbox_bridge {
    ...
    fun create_inbox_message_hash(arg0: u64, arg1: u32, arg2: address, arg3: &vector<u8>) : vector<u8> {
        let v0 = b"";
        0x1::vector::push_back<u8>(&mut v0, 1);
        0x1::vector::append<u8>(&mut v0, 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::utils::u64_to_be_bytes(arg0));
        0x1::vector::append<u8>(&mut v0, 0x8f5d8eecedc3ec113c7d23b4d9816c33f495d8e1829b3e250275e4d3a31fdce7::utils::u32_to_be_bytes(arg1));
    ...
    public fun submit_inbox_message<T0: drop>(arg0: &mut InboxBridge, arg1: T0, arg2: vector<u8>, arg3: &0x2::clock::Clock) : (u8, u64, vector<u8>) {
        assert_bridge_version(arg0);
        ...
        let v4 = create_inbox_message_hash(v2, 2000, v3, &arg2);
    ...
    entry fun submit_inbox_message_as_eoa(arg0: &mut InboxBridge, arg1: vector<u8>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        let v2 = InboxMessageEvent{
            ...
            min_finality_threshold : 2000,
            sender                 : v1,
            msg_hash               : create_inbox_message_hash(v0, 2000, v1, &arg1),
