module 0x8f399f8eccf75fd08068a08769db165946da50ba49f8af76643a031091c9ca8e::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"Cosmos", b"COSMOS", b"https://iili.io/dRCEzSn.jpg", 0x1::option::none<0x2::url::Url>(), arg1);
