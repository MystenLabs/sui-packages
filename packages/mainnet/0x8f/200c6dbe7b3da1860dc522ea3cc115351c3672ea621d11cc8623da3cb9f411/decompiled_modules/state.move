module 0x37fe800bad222b151fb080afc701ccf2b3a139106f6908857ad0a27e6e52c319::state {
    ...
    public(friend) fun allow_deposits_of_coin_type_into_navi<T0>(arg0: &mut ExtensionStateV1, arg1: &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: u8) {
        ...
        assert!(0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::get_coin_type(arg1, arg2) == 0x1::type_name::into_string(v0), 2);
        assert!(!0x1::vector::contains<u8>(&arg0.asset_ids, &arg2), 3);
