module 0x8f02266235ae1b745e4d8cd6cb98c5739b1fef5827abd00cde8b010b67ff6b47::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"SUIIIII", b"SUI", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-23T09-58-16.647Z-images.jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            ...
            symbol     : 0x1::string::utf8(b"SUIIIII"),
            decimals   : 9,
