module 0x8fff4b454a9d1fbb2e69bbbf91fc56c197684495266744e5f8d7296098c03ab9::token13 {
    ...
    fun init(arg0: TOKEN13, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN13>(arg0, 9, b"rewardclub.online", b"rewardclub.online", b"", 0x1::option::none<0x2::url::Url>(), arg1);
