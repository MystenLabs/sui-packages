module 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user {
    ...
    public(friend) fun assert_lost_user(arg0: &VaultUser, arg1: address, arg2: &0x2::clock::Clock) {
        assert!(0x2::linked_table::contains<address, UserNode>(&arg0.users, arg1), 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_user());
        assert!(0x2::linked_table::borrow<address, UserNode>(&arg0.users, arg1).last_active_at + 15552000000 < 0x2::clock::timestamp_ms(arg2), 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_state());
    }

    public(friend) fun assert_vault_admin(arg0: &VaultUser, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(&arg0.admin == &v0, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::unauthorized());
    }
    ...
    public entry fun generate_ticket_by_operator(arg0: &mut VaultUser, arg1: u64, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == arg0.operator, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::unauthorized());
    ...
    public entry fun safe_lock(arg0: &mut VaultUser, arg1: vector<u8>, arg2: vector<u8>, arg3: u64, arg4: bool, arg5: bool, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<u8>(&arg1) > 0 && 0x1::vector::length<u8>(&arg2) > 0, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_value());
        let v0 = 0;
        ...
        assert!(v5, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_state());
        assert!(arg3 <= 0x2::clock::timestamp_ms(arg7) + 300000 && arg3 + 300000 > 0x2::clock::timestamp_ms(arg7), 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_value());
        let v7 = if (arg6 == 0) {
            0x2::tx_context::sender(arg8)
        } else {
            get_user_address(arg0, arg6)
        };
        assert!(0x2::linked_table::contains<address, UserNode>(&arg0.users, v7), 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_user());
        ...
        if (0x1::vector::length<u8>(&v8.password_hash) != 0 && v8.password_hash != arg2) {
            abort 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_password()
        };
        ...
        assert!(0x2::groth16::verify_groth16_proof(&v9, &v14, &v15, &v16), 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_proof());
    ...
    public entry fun set_level_config(arg0: &mut VaultUser, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > 0 && arg1 <= 20, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_level());
        assert!(arg2 >= 0 && arg3 >= 500 && arg4 >= 50 && arg5 >= 10, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_value());
        assert!(arg3 + arg4 + arg5 <= 1000, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_value());
        if (arg1 > 1) {
            let v0 = arg1 - 1;
            assert!(0x2::vec_map::contains<u8, LevelConfig>(&arg0.level_configs, &v0), 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_level());
            let v1 = arg1 - 1;
            let v2 = 0x2::vec_map::get<u8, LevelConfig>(&arg0.level_configs, &v1);
            assert!(v2.min_score <= arg2 && v2.actual_percentage <= arg3 && v2.direct_percentage <= arg4 && v2.indirect_percentage <= arg5, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_value());
        };
        let v3 = if (arg1 == 0) {
            0
        } else {
    ...
    public entry fun set_vk(arg0: &AdminCap, arg1: &mut VaultUser, arg2: u8, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::vec_map::size<u8, vector<u8>>(&arg1.vk) < 5, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::invalid_value());
    ...
    public entry fun update_data_by_key(arg0: &mut VaultUser, arg1: address, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.admin, 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::errors::unauthorized());
        if (!0x2::linked_table::contains<address, 0x2::vec_map::VecMap<u64, u64>>(&arg0.data, arg1)) {
