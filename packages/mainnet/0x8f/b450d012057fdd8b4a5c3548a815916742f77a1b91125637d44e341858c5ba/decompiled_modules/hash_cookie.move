module 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::hash_cookie {
    ...
    public entry fun create_global_cookie(arg0: &0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::VaultUser, arg1: &mut 0x2::tx_context::TxContext) {
        0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::assert_vault_admin(arg0, arg1);
        let v0 = GlobalCookie{
    ...
    public entry fun mint(arg0: &mut GlobalCookie, arg1: &mut 0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::VaultUser, arg2: &mut 0x2::tx_context::TxContext) {
        if (arg0.next_serial_number > 999999) {
            return
        };
        assert!(0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::consume_ticket(arg1, 0, arg2), 1);
        let v0 = 0x2::tx_context::sender(arg2);
    ...
    public entry fun set_operator(arg0: &mut GlobalCookie, arg1: &0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::VaultUser, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::assert_vault_admin(arg1, arg3);
        arg0.operator = arg2;
    }

    public entry fun set_prize_amount(arg0: &mut GlobalCookie, arg1: &0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::VaultUser, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x8fb450d012057fdd8b4a5c3548a815916742f77a1b91125637d44e341858c5ba::vault_user::assert_vault_admin(arg1, arg3);
