module 0x8f96d6612be64f0997da43ed97d70f77241c24f53509bc22509c4bbe841837f3::cnsnft8978 {
    struct CNSNFT8978 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8978, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3321"));
        let v4 = 0x2::package::claim<CNSNFT8978>(arg0, arg1);
