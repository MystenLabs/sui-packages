module 0x8fd3c74f7ec3c43408aead92bc851533bd51d7a5bf21f5dacbe2900500b2040a::distributor {
    ...
    public entry fun claim<T0>(arg0: &mut Distributor<T0>, arg1: u64, arg2: vector<vector<u8>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > v2, 4);
        let v3 = 0x8fd3c74f7ec3c43408aead92bc851533bd51d7a5bf21f5dacbe2900500b2040a::merkle::leaf(v1, arg1);
        assert!(0x8fd3c74f7ec3c43408aead92bc851533bd51d7a5bf21f5dacbe2900500b2040a::merkle::verify(&arg0.merkle_root, &v3, &arg2), 5);
        let v4 = arg1 - v2;
