module 0x8fbb5a3742223437a5cc1ced48b8266afe0e23f50ea100aa3e16872822f47617::farm {
    ...
    fun earned<T0, T1>(arg0: &Pool<T0, T1>, arg1: UserInfo, arg2: u64) : u64 {
        0x8fbb5a3742223437a5cc1ced48b8266afe0e23f50ea100aa3e16872822f47617::math_extend::mul_div((arg1.ve_balance_of as u64), reward_per_token<T0, T1>(arg0, arg2) - arg1.user_reward_per_token_paid, arg0.stake_coin_unit) + arg1.pending_reward
    }
    ...
    public entry fun lock_stake<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x8fbb5a3742223437a5cc1ced48b8266afe0e23f50ea100aa3e16872822f47617::math_extend::mul_div_to_u128(v1, v4.unlock_at - v0, 2592000);
    ...
    fun reward_per_token<T0, T1>(arg0: &Pool<T0, T1>, arg1: u64) : u64 {
        ...
        if (v0 == 0 || arg1 <= arg0.start_at) {
            ...
            ((0x8fbb5a3742223437a5cc1ced48b8266afe0e23f50ea100aa3e16872822f47617::math_extend::mul_to_u128(arg0.reward_per_second, last_time_reward_applicable<T0, T1>(arg0, arg1) - arg0.updated_at) * (arg0.stake_coin_unit as u128) / v0 + (arg0.reward_per_token_stored as u128)) as u64)
        }
    }
    ...
    public entry fun withdraw<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: &0x2::clock::Clock, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (v3.unlock_at <= v2) {
            ...
            0x8fbb5a3742223437a5cc1ced48b8266afe0e23f50ea100aa3e16872822f47617::math_extend::mul_div_to_u128(v3.locked_amount, v3.unlock_at - v2, 2592000)
        };
        v3.ve_balance_of = v4;
