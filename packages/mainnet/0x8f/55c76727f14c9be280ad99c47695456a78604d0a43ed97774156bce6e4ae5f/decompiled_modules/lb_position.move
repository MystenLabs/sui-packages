module 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::lb_position {
    ...
    public(friend) fun collect_fees(arg0: &mut LBBinPosition, arg1: u128, arg2: u128) : (u64, u64) {
        ...
        (((0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::mul_u128(arg0.amount, 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::sub_u128(arg1, arg0.fee_growth_inside_last_x)) >> 64) as u64), ((0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::mul_u128(arg0.amount, 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::sub_u128(arg2, arg0.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public(friend) fun collect_reward(arg0: &mut LBBinPosition, arg1: u64, arg2: u128) : u64 {
        ...
        *0x1::vector::borrow_mut<u128>(&mut arg0.reward_growth_inside_last, arg1) = arg2;
        0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::u128_to_u64(arg0.amount * 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::sub_u128(arg2, v0) >> 64)
    }
    ...
    public(friend) fun get_pending_fees(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(arg1.saved_fee_x, ((v1 * (arg3 - v0.fee_growth_inside_last_x) >> 64) as u64)), 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(arg1.saved_fee_y, ((v1 * (arg4 - v0.fee_growth_inside_last_y) >> 64) as u64)))
    }
    ...
    public(friend) fun get_pending_rewards(arg0: &LBBinPosition, arg1: u64, arg2: u128) : u64 {
        ...
        0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::u128_to_u64(v0 * (arg2 - v1) >> 64)
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 3) {
            ...
            v3 = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(v0, v3);
            v1 = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut LBPosition, arg2: vector<u32>, arg3: vector<u128>, arg4: vector<u128>, arg5: vector<u128>, arg6: vector<vector<u128>>) {
        ...
        while (v2 < v0) {
            ...
            if (is_bin_active_in_bitmap(v5.active_bins_bitmap, v11)) {
                ...
                if (v13.amount > 0) {
                    arg1.saved_fee_x = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(arg1.saved_fee_x, 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::u128_to_u64(v13.amount * 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::sub_u128(v7, v13.fee_growth_inside_last_x) >> 64));
                    arg1.saved_fee_y = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(arg1.saved_fee_y, 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::u128_to_u64(v13.amount * 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::sub_u128(v8, v13.fee_growth_inside_last_y) >> 64));
                    let v14 = 0;
                    ...
                    while (v14 < v17) {
                        ...
                        if (v18 > v19) {
                            let v20 = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::u128_to_u64(v13.amount * (v18 - v19) >> 64);
                            if (v20 > 0) {
                                while (0x1::vector::length<u64>(&arg1.saved_rewards) <= v14) {
                                    0x1::vector::push_back<u64>(&mut arg1.saved_rewards, 0);
                                };
                                *0x1::vector::borrow_mut<u64>(&mut arg1.saved_rewards, v14) = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg1.saved_rewards, v14), v20);
                            };
                        };
                        v14 = v14 + 1;
                    };
                };
                v13.amount = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u128(v13.amount, *0x1::vector::borrow<u128>(&arg3, v2));
    ...
    public(friend) fun remove_bins(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: vector<u32>) {
        ...
        let v3 = 0;
        let v4 = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::constants::max_u32();
        let v5 = PackedBins{
            active_bins_bitmap : 0,
            bin_data           : 0x1::vector::empty<LBBinPosition>(),
        };
        ...
        while (v3 < v0) {
            ...
            if (v7 != v4) {
                let v9 = if (v4 != 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::constants::max_u32()) {
        ...
        let v10 = if (v4 != 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::constants::max_u32()) {
            if (v6.active_bins_bitmap == 0) {
                !0x1::vector::contains<u32>(&v2, &v4)
            } else {
                false
    ...
    public(friend) fun save_reward(arg0: &mut LBPosition, arg1: u64, arg2: u64) {
        if (arg2 > 0) {
            ...
            *0x1::vector::borrow_mut<u64>(&mut arg0.saved_rewards, arg1) = 0x8f55c76727f14c9be280ad99c47695456a78604d0a43ed97774156bce6e4ae5f::safe_math::add_u64(*0x1::vector::borrow<u64>(&arg0.saved_rewards, arg1), arg2);
        };
    }
