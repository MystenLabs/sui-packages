module 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::market {
    struct AdminCap has store, key {
        id: 0x2::object::UID,
    }

    struct Store has store {
        obj: 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20,
        price: u64,
        owner: address,
    }
    ...
    public fun buy(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: 0x2::object::ID, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let (_, v7) = 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::get_sui20_data(&v5);
        ...
        0x2::transfer::public_transfer<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(v5, v0);
    ...
    public fun buy_v2(arg0: &mut Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let (_, v12) = 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::get_sui20_data(&v10);
        0x2::object::id<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(&v10);
        ...
        0x2::transfer::public_transfer<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(v10, v0);
        if (!0x2::bag::contains<address>(&v1.upgrade_bag, v0)) {
            let v15 = UserInfoV2{
                listed_index : vector[],
                extra_data   : 0,
            };
            0x2::bag::add<address, UserInfoV2>(&mut v1.upgrade_bag, v0, v15);
            v1.traders = v1.traders + 1;
        };
        remove_listed_index(v1, v6, v7);
    ...
    public fun delist(arg0: &mut Global, arg1: 0x1::string::String, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v4 == v0, 1003);
        0x2::transfer::public_transfer<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(v2, v0);
    ...
    public fun delist_v2(arg0: &mut Global, arg1: 0x1::string::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v6 == v0, 1003);
        0x2::object::id<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(&v10);
        let v11 = 0x2::bag::borrow_mut<0x1::string::String, DoubleLinkList>(&mut v1.stores, arg1);
        update_link_list(v11, v7, v8, v9);
        if (v8 > 0) {
            0x2::bag::borrow_mut<u64, StoreV2>(&mut v1.stores, v8).next_index = v9;
        };
        if (v9 > 0) {
        ...
        if (0x2::table::contains<address, UserInfo>(&v1.user_infos, v0)) {
            ...
            while (v10 < 0x1::vector::length<0x2::object::ID>(&v9)) {
                ...
                if (0x2::bag::contains<0x2::object::ID>(&v1.stores, v11)) {
                    ...
                    let (_, v14) = 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::get_sui20_data(&v12.obj);
                    let v15 = ListedItem{
                        id     : v11,
                        amount : v14,
                        price  : v12.price,
    ...
    public fun get_market_data_v2(arg0: &Global, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: &0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<address>(&v1.upgrade_bag, v0)) {
            ...
            while (v11 < 0x1::vector::length<u64>(&v10)) {
                ...
                if (0x2::bag::contains<u64>(&v1.stores, v12)) {
                    ...
                    let (_, v15) = 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::get_sui20_data(&v13.obj);
                    let v16 = ListedItemV2{
                        store_index   : v12,
                        id            : 0x2::object::id<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(&v13.obj),
                        amount        : v15,
                        price         : v13.price,
        ...
        let v19 = 0;
        while (0x2::bag::contains<u64>(&v1.stores, v18) && v19 < arg4) {
            let v20 = 0x2::bag::borrow<u64, StoreV2>(&v1.stores, v18);
            let (_, v22) = 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::get_sui20_data(&v20.obj);
            let v23 = ListedItemV2{
                store_index   : v18,
                id            : 0x2::object::id<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(&v20.obj),
                amount        : v22,
                price         : v20.price,
                store_v2_info : get_store_v2_info(&v1.stores, v18),
            };
            0x1::vector::push_back<ListedItemV2>(&mut v17, v23);
            v18 = v20.next_index;
            v19 = v19 + 1;
        };
        let v24 = QueryDataEventV2{
            tick          : arg2,
            traders       : v1.traders,
            txs           : v1.txs,
            volume_24h    : v6,
        ...
        0x2::event::emit<QueryDataEventV2>(v24);
    }
    ...
    public fun list(arg0: &mut Global, arg1: 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        only_allowed_version(arg0);
        only_not_paused(arg0);
        let v0 = 0x2::tx_context::sender(arg3);
        let (v1, v2) = 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::get_sui20_data(&arg1);
        assert!(v2 > 0, 1006);
        assert!(arg2 > 0, 1005);
        let v3 = 0x2::object::id<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(&arg1);
        let v4 = Store{
            obj   : arg1,
            price : arg2,
    ...
    public fun list_v2(arg0: &mut Global, arg1: &mut 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Global, arg2: 0x1::string::String, arg3: vector<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        only_allowed_version(arg0);
        only_not_paused(arg0);
        assert!(arg4 > 0, 1005);
        let v0 = 0x2::tx_context::sender(arg5);
        let (v1, v2) = 0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::merge(arg1, arg2, arg3, arg5);
        let v3 = v1;
        0x2::object::id<0x8fccf4b3a3bfd4b160ffe21fa1aae678e1cb76fa7a80d74e0161aae76ab20d76::sui20::Sui20>(&v3);
        assert!(v2 > 0, 1006);
        ...
        if (!0x2::bag::contains<address>(&v4.upgrade_bag, v0)) {
            let v10 = UserInfoV2{
                listed_index : vector[],
                extra_data   : 0,
            };
            0x2::bag::add<address, UserInfoV2>(&mut v4.upgrade_bag, v0, v10);
            v4.traders = v4.traders + 1;
        };
        0x1::vector::push_back<u64>(&mut 0x2::bag::borrow_mut<address, UserInfoV2>(&mut v4.upgrade_bag, v0).listed_index, v8);
        let v11 = *0x2::bag::borrow<0x1::string::String, DoubleLinkList>(&v4.stores, arg2);
        v11.store_v2_lastest_index = v8;
        ...
        if (v11.head == 0 && v11.tail == 0 && v11.size == 0) {
            ...
            v11.tail = v8;
            v11.size = 1;
            let v13 = &mut v4.stores;
            set_link_list(v13, arg2, v11);
            return
        };
        v11.size = v11.size + 1;
        let v14 = get_store_v2_info(&v4.stores, v8);
        let v15 = get_store_v2_info(&v4.stores, v7);
        let v16 = v15.prev_index;
        let v17 = v15.index;
        while (v14.price_per_amount >= v15.price_per_amount) {
            ...
            v15.next_index = v14.index;
            let v19 = &mut v4.stores;
            update_store_v2(v19, v15);
            v14.prev_index = v15.index;
            v14.next_index = 0;
            let v20 = &mut v4.stores;
            update_store_v2(v20, v14);
            v11.tail = v14.index;
            let v21 = &mut v4.stores;
            set_link_list(v21, arg2, v11);
            return
        };
        v14.next_index = v17;
        v14.prev_index = v15.prev_index;
        let v22 = &mut v4.stores;
        update_store_v2(v22, v14);
        v15.prev_index = v14.index;
        let v23 = &mut v4.stores;
        update_store_v2(v23, v15);
        if (v16 > 0) {
            0x2::bag::borrow_mut<u64, StoreV2>(&mut v4.stores, v16).next_index = v14.index;
        };
        if (v14.prev_index == 0) {
            v11.head = v14.index;
        };
        let v24 = &mut v4.stores;
        set_link_list(v24, arg2, v11);
    }
    ...
    fun remove_listed_index(arg0: &mut Sui20OrderData, arg1: address, arg2: u64) {
        let v0 = 0x2::bag::borrow_mut<address, UserInfoV2>(&mut arg0.upgrade_bag, arg1);
        let (v1, _) = 0x1::vector::index_of<u64>(&v0.listed_index, &arg2);
        if (v1) {
            0x1::vector::swap_remove<u64>(&mut v0.listed_index, arg2);
        };
    }
