module 0x250880a4c1a268da8011b164f599d4e100cefce84f862d36396cd1a943ee8a35::policy {
    ...
    public fun add_allowed_coin(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: vector<u8>) {
        ...
        if (!0x1::vector::contains<vector<u8>>(&arg0.allowed_coins, &arg2)) {
            0x1::vector::push_back<vector<u8>>(&mut arg0.allowed_coins, arg2);
    ...
    public fun add_allowed_protocol(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: address) {
        assert!(arg1.policy_id == 0x2::object::id<AgentPolicy>(arg0), 7);
        if (!0x1::vector::contains<address>(&arg0.allowed_protocols, &arg2)) {
            0x1::vector::push_back<address>(&mut arg0.allowed_protocols, arg2);
    ...
    fun protocol_allowed(arg0: &AgentPolicy, arg1: address) : bool {
        if (arg1 == @0x0) {
            true
        } else if (0x1::vector::is_empty<address>(&arg0.allowed_protocols)) {
            true
        } else {
            0x1::vector::contains<address>(&arg0.allowed_protocols, &arg1)
        }
    }
    ...
    public fun recipient_allowed(arg0: &AgentPolicy, arg1: address) : bool {
        if (!0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"lyra.recipients")) {
            return true
        };
        let v0 = 0x2::dynamic_field::borrow<vector<u8>, vector<address>>(&arg0.id, b"lyra.recipients");
        0x1::vector::is_empty<address>(v0) || 0x1::vector::contains<address>(v0, &arg1)
    }
    ...
    public fun remove_allowed_coin(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: vector<u8>) {
        assert!(arg1.policy_id == 0x2::object::id<AgentPolicy>(arg0), 7);
        let (v0, v1) = 0x1::vector::index_of<vector<u8>>(&arg0.allowed_coins, &arg2);
        if (v0) {
            0x1::vector::swap_remove<vector<u8>>(&mut arg0.allowed_coins, v1);
            let v2 = CoinAllowlistChanged{
                policy_id : 0x2::object::id<AgentPolicy>(arg0),
                count     : 0x1::vector::length<vector<u8>>(&arg0.allowed_coins),
            };
            0x2::event::emit<CoinAllowlistChanged>(v2);
        };
    }

    public fun remove_allowed_protocol(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: address) {
        assert!(arg1.policy_id == 0x2::object::id<AgentPolicy>(arg0), 7);
        let (v0, v1) = 0x1::vector::index_of<address>(&arg0.allowed_protocols, &arg2);
        if (v0) {
            0x1::vector::swap_remove<address>(&mut arg0.allowed_protocols, v1);
            let v2 = ProtocolAllowlistChanged{
                policy_id : 0x2::object::id<AgentPolicy>(arg0),
                count     : 0x1::vector::length<address>(&arg0.allowed_protocols),
            };
            0x2::event::emit<ProtocolAllowlistChanged>(v2);
        };
    }
    ...
    public fun set_allowed_recipients(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: vector<address>) {
        assert!(arg1.policy_id == 0x2::object::id<AgentPolicy>(arg0), 7);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"lyra.recipients")) {
            0x2::dynamic_field::remove<vector<u8>, vector<address>>(&mut arg0.id, b"lyra.recipients");
        };
        0x2::dynamic_field::add<vector<u8>, vector<address>>(&mut arg0.id, b"lyra.recipients", arg2);
