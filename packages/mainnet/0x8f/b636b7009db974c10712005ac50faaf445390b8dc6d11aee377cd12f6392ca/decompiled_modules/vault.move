module 0x8fb636b7009db974c10712005ac50faaf445390b8dc6d11aee377cd12f6392ca::vault {
    ...
    public entry fun withdraw_pending_fees_for_position<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &BotCap, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::withdraw_all<T0>(&mut arg0.pending_fees_a), arg2), 0x2::tx_context::sender(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::withdraw_all<T1>(&mut arg0.pending_fees_b), arg2), 0x2::tx_context::sender(arg2));
    }
