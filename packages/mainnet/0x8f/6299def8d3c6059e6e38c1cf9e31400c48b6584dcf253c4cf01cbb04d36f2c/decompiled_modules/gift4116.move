module 0x8f6299def8d3c6059e6e38c1cf9e31400c48b6584dcf253c4cf01cbb04d36f2c::gift4116 {
    struct GIFT4116 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift4116(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT4116, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4116>(arg0, arg1);
