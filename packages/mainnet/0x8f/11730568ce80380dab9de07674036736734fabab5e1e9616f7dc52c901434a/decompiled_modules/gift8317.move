module 0x8f11730568ce80380dab9de07674036736734fabab5e1e9616f7dc52c901434a::gift8317 {
    struct GIFT8317 has drop {
        dummy_field: bool,
    }

    struct TICKET_8317 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8317(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8317>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8317>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8317, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8317>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8317>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8317>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8317>>(v5, 0x2::tx_context::sender(arg1));
    }
