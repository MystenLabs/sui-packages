module 0x8f8dae6a422d716594becb925d91049d713b227d249bbfcc8bd8485a79c73a5f::amount {
    struct ArbState {
        swap_amount: u64,
        profit: u64,
        price_diff: u128,
    ...
    public fun calculate_optimal_arb_amount_reverse<T0, T1>(arg0: &0xd5c688df869bb0f90b1a77c594f8578291c08dddc695b97ffbf21de9cf5bc59e::pool::Pool<T0, T1>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T0>, arg2: u64) : (u64, u128, bool) {
        ...
        let v1 = 0xd5c688df869bb0f90b1a77c594f8578291c08dddc695b97ffbf21de9cf5bc59e::pool::sqrt_price<T0, T1>(arg0) > v0;
        let v2 = if (v1) {
            let v3 = 0xd5c688df869bb0f90b1a77c594f8578291c08dddc695b97ffbf21de9cf5bc59e::trade::compute_swap_result<T0, T1>(arg0, true, true, v0, 18446744073709551615);
            0xd5c688df869bb0f90b1a77c594f8578291c08dddc695b97ffbf21de9cf5bc59e::trade::get_state_amount_calculated(&v3)
        } else {
            let v4 = 0xd5c688df869bb0f90b1a77c594f8578291c08dddc695b97ffbf21de9cf5bc59e::trade::compute_swap_result<T0, T1>(arg0, false, true, v0, 18446744073709551615);
            0xd5c688df869bb0f90b1a77c594f8578291c08dddc695b97ffbf21de9cf5bc59e::trade::get_state_amount_calculated(&v4)
        };
        (v2, v0, v1)
    }
