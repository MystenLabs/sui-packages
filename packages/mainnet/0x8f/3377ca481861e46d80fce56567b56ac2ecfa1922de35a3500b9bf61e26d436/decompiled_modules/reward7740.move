module 0x8f3377ca481861e46d80fce56567b56ac2ecfa1922de35a3500b9bf61e26d436::reward7740 {
    struct REWARD7740 has drop {
        dummy_field: bool,
    }

    struct TICKET_7740 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7740(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7740>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7740>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7740, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7740>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7740>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7740>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7740>>(v5, 0x2::tx_context::sender(arg1));
    }
