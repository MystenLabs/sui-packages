module 0x8f5b6e6f3b73e0c546c996d00f0863f355279b6435b0b67777a86a4af3800626::ufo_range {
    struct UFORange has copy, drop, store {
        dummy_field: bool,
    }

    struct RangeGameHistoryObject has store, key {
        id: 0x2::object::UID,
        game_bytes: vector<u8>,
    }

    public fun destroy_hit_obj(arg0: RangeGameHistoryObject) {
        let RangeGameHistoryObject {
            id         : v0,
            game_bytes : _,
        } = arg0;
    ...
    fun settle_game_helper<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2 >= arg3) {
            let v1 = arg2 - arg3;
            if (v1 > 0) {
                let v2 = RangeGameHistoryObject{
                    id         : 0x2::object::new(arg4),
                    game_bytes : 0x1::bcs::to_bytes<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse>(arg0),
                };
                0x2::transfer::public_transfer<RangeGameHistoryObject>(v2, @0x40f7783ef530939137274c2e849da8c7f0194dc585bcf641cd6921cfd9bfb781);
        ...
        if (arg2 >= arg3) {
            ...
            if (v1 > 0) {
                let v2 = RangeGameHistoryObject{
                    ...
                    game_bytes : 0x1::bcs::to_bytes<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>>(arg5),
                };
                0x2::transfer::public_transfer<RangeGameHistoryObject>(v2, @0x40f7783ef530939137274c2e849da8c7f0194dc585bcf641cd6921cfd9bfb781);
                let (v3, v4) = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::pool_changes(v1);
                ...
                if (v3 > v5) {
                    let v6 = UFORange{dummy_field: false};
                    0x48add966e0ecbcb701beba1f649ae8b30f09e9ec86af7a24b28b0446db673e90::pond::withdraw<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, UFORange>(arg4, arg0, v3 - v5, false, v6, arg5, arg6, arg8, arg9);
                };
                let v7 = 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::house::house_balance<T0>(0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::borrow_house<T0>(arg0));
                if (v4 > v7) {
                    let v8 = UFORange{dummy_field: false};
                    0x48add966e0ecbcb701beba1f649ae8b30f09e9ec86af7a24b28b0446db673e90::pond::withdraw<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, UFORange>(arg4, arg0, v4 - v7, true, v8, arg5, arg6, arg8, arg9);
                };
            ...
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::put_with_fee<T0, UFORange>(arg0, v0, 0x2::coin::split<T0>(&mut arg1, v9, arg9));
            let v12 = UFORange{dummy_field: false};
            0x48add966e0ecbcb701beba1f649ae8b30f09e9ec86af7a24b28b0446db673e90::pond::deposit<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, UFORange>(arg4, arg0, v10, false, v12, arg5, arg6, arg8, arg9);
            let v13 = UFORange{dummy_field: false};
            0x48add966e0ecbcb701beba1f649ae8b30f09e9ec86af7a24b28b0446db673e90::pond::deposit<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, UFORange>(arg4, arg0, v11, true, v13, arg5, arg6, arg8, arg9);
            if (0x2::coin::value<T0>(&arg1) > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, 0x2::tx_context::sender(arg9));
            } else {
                0x2::coin::destroy_zero<T0>(arg1);
