module 0x8f76903a7569f6ee11a7ab3ae58cdd854f54a0cae986fecd95ccf9453eecaafc::af_lp {
    ...
    fun init(arg0: AF_LP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = &mut v1;
        0x1::vector::push_back<u64>(v2, 501000000000000000);
        0x1::vector::push_back<u64>(v2, 499000000000000018);
        ...
        while (v3 < 0x1::vector::length<u64>(&v1)) {
            ...
            let v8 = if (b"https://caribdao.com/wp-content/uploads/2022/03/cropped-PngItem_467799.png" == b"https://caribdao.com/wp-content/uploads/2022/03/cropped-PngItem_467799.png") {
                0x1::option::none<0x2::url::Url>()
            } else {
                0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://caribdao.com/wp-content/uploads/2022/03/cropped-PngItem_467799.png"))
            };
            0x2::transfer::public_transfer<0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::CreatePoolCapV2>(0xefe170ec0be4d762196bedecd7a065816576198a6527c99282a2551aaa7da38c::pool::create_pool_cap_and_set_decimals<AF_LP>(arg0, b"CARIB_SUI", b"CARIB/SUI", b"LP coin for CARIB/SUI", v8, 0x1::option::some<vector<u8>>(v6), false, v0, 144 - 144, arg1), 0x2::tx_context::sender(arg1));
            return
        };
        /* goto 4 */
    }
