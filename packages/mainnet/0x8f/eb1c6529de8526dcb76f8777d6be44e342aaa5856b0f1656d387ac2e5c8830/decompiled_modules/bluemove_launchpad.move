module 0x8feb1c6529de8526dcb76f8777d6be44e342aaa5856b0f1656d387ac2e5c8830::bluemove_launchpad {
    ...
    struct AlphaDragon has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        description: 0x1::string::String,
    ...
    public entry fun burn_nft(arg0: AlphaDragon, arg1: &mut 0x2::tx_context::TxContext) {
        let AlphaDragon {
            id          : v0,
            name        : v1,
            description : _,
        ...
        let v5 = BurnEvent{
            object_id : 0x2::object::id<AlphaDragon>(&arg0),
    ...
    fun init(arg0: BLUEMOVE_LAUNCHPAD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadData{
            ...
            minted         : 0,
            current_nft    : 0,
            base_name      : 0x1::string::utf8(b"Alpha Dragon #"),
            base_url       : 0x1::string::utf8(b"https://bluemovecdn.s3.ap-northeast-1.amazonaws.com/alpha-dragon/"),
            base_image_url : 0x1::string::utf8(b"https://ipfs.bluemove.net/sei/alpha-dragon/images/"),
            description    : 0x1::string::utf8(b"Building an ALPHA COMMUNITY of Builders in Web3."),
            ...
            fund_address   : @0xe7b32c4cea335ea24e0d8687da250cfae51af6e464851b2a6da5396efd18571c,
        ...
        let (v3, v4) = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::create_with_mint_cap<BLUEMOVE_LAUNCHPAD, AlphaDragon>(&arg0, 0x1::option::some<u64>(v0), arg1);
        let v5 = v3;
        let v6 = Witness{dummy_field: false};
        let v7 = 0x16c5f17f2d55584a6e6daa442ccf83b4530d10546a8e7dedda9ba324e012fc40::witness::from_witness<AlphaDragon, Witness>(v6);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<AlphaDragon, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::Creators>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::creators::new(0x2::vec_set::singleton<address>(v2)));
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::add_domain<AlphaDragon, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::DisplayInfo>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::display_info::new(0x1::string::utf8(b"Alpha Dragon"), 0x1::string::utf8(b"Building an ALPHA COMMUNITY of Builders in Web3.")));
        ...
        let v11 = 0x2::display::new<AlphaDragon>(&v8, arg1);
        0x2::display::add<AlphaDragon>(&mut v11, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"{name}"));
        0x2::display::add<AlphaDragon>(&mut v11, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"{description}"));
        0x2::display::add<AlphaDragon>(&mut v11, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{image_url}"));
        0x2::display::add<AlphaDragon>(&mut v11, 0x1::string::utf8(b"tags"), 0x859eb18bd5b5e8cc32deb6dfb1c39941008ab3c6e27f0b8ce2364be7102bb7cb::display::from_vec(v9));
        0x2::display::update_version<AlphaDragon>(&mut v11);
        0x2::transfer::public_transfer<0x2::display::Display<AlphaDragon>>(v11, 0x2::tx_context::sender(arg1));
        let (v12, v13) = 0xe2c7a6843cb13d9549a9d2dc1c266b572ead0b4b9f090e7c3c46de2714102b43::transfer_request::init_policy<AlphaDragon>(&v8, arg1);
        let v14 = v13;
        let v15 = v12;
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::enforce<AlphaDragon>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::transfer_allowlist::enforce<AlphaDragon>(&mut v15, &v14);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::create_domain_and_add_strategy<AlphaDragon>(v7, &mut v5, 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::from_address(@0xe7b32c4cea335ea24e0d8687da250cfae51af6e464851b2a6da5396efd18571c, arg1), 1000, arg1);
        0x2::transfer::public_transfer<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<AlphaDragon>>(v4, v2);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v8, v2);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<AlphaDragon>>(v14, v2);
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<AlphaDragon>>(v15);
        0x2::transfer::public_share_object<0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<AlphaDragon>>(v5);
    ...
    public entry fun mint_with_quantity(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &mut LaunchpadData, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg3 > 0) {
            let v8 = arg2.current_nft;
            assert!(v8 < arg2.total_nft, 1);
            let v9 = v8 + 1;
            let v10 = v9 + arg2.start_order;
            let v11 = arg2.base_name;
            0x1::string::append(&mut v11, num_str(v10));
            let v12 = arg2.base_image_url;
            0x1::string::append(&mut v12, num_str(v10));
            0x1::string::append(&mut v12, 0x1::string::utf8(b".webp"));
            let v13 = arg2.base_url;
            0x1::string::append(&mut v13, num_str(v10));
            0x1::string::append(&mut v13, 0x1::string::utf8(b".json"));
            let v14 = AlphaDragon{
            ...
            let v15 = MintNFTEvent{
                object_id : 0x2::object::id<AlphaDragon>(&v14),
                creator   : v0,
                name      : v11,
            };
            0x2::event::emit<MintNFTEvent>(v15);
            0x2::transfer::public_transfer<AlphaDragon>(v14, v0);
            arg2.current_nft = v9;
            arg3 = arg3 - 1;
        };
    ...
    public entry fun pre_nfts(arg0: &mut LaunchpadData, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg1 > 0) {
            ...
            0x2::transfer::public_transfer<AlphaDragon>(v4, arg2);
            arg0.current_nft = v0;
