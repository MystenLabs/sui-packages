module 0x8f50c14ea0d49823af8066a9918b906b51b1fc56a800b51794f99e97f17dc9e5::gift4758 {
    struct GIFT4758 has drop {
        dummy_field: bool,
    }

    struct TICKET_4758 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4758(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4758>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4758>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4758>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4758>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4758>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4758>>(v5, 0x2::tx_context::sender(arg1));
    }
