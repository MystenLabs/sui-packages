module 0x8f09f6831493b6b24d2f010493760a58ee545f43504ac1efc043d25f9634f9aa::cnsnft2499 {
    struct CNSNFT2499 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2499, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2499>(arg0, arg1);
