module 0x8f6e09b782da12769ca23546c82392c6697d947823ce73b3e5ea051f020f797b::bangui {
    ...
    fun init(arg0: BANGUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BANGUI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BANGUI  ")))), trim_right(b"Bangui CentralAfricanRepublic   "), trim_right(b"Bangui is the capital and largest city of the Central African Republic. BANGUI MEME TOKEN                                                                                                                                                                                                                                       "), v2, arg1);
