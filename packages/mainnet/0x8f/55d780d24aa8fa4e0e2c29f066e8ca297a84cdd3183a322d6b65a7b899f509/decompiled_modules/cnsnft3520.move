module 0x8f55d780d24aa8fa4e0e2c29f066e8ca297a84cdd3183a322d6b65a7b899f509::cnsnft3520 {
    struct CNSNFT3520 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3520, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3520>(arg0, arg1);
