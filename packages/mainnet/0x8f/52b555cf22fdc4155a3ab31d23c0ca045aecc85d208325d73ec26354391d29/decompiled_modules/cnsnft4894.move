module 0x8f52b555cf22fdc4155a3ab31d23c0ca045aecc85d208325d73ec26354391d29::cnsnft4894 {
    struct CNSNFT4894 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4894, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7383"));
        let v4 = 0x2::package::claim<CNSNFT4894>(arg0, arg1);
