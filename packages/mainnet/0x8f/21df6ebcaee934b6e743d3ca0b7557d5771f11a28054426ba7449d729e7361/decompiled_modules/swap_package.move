module 0x8f21df6ebcaee934b6e743d3ca0b7557d5771f11a28054426ba7449d729e7361::swap_package {
    ...
    public fun fetch_pools<T0, T1>(arg0: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg1: u64) {
        ...
        loop {
            ...
            let v5 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::pool_id(&v2);
            let v6 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::pool_key(&v2);
            let v7 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::tick_spacing(&v2);
            if (v3 == 0x1::type_name::get<T0>() && v4 == 0x1::type_name::get<T1>()) {
                let v8 = PoolSimpleInfoEvent{
                    pool_id      : v5,
                    pool_key     : v6,
                    coin_type_a  : v3,
                    coin_type_b  : v4,
                ...
                0x2::event::emit<PoolSimpleInfoEvent>(v8);
                continue
            };
            let v9 = PoolSimpleInfoEvent{
                pool_id      : v5,
                pool_key     : v6,
                coin_type_a  : v3,
                coin_type_b  : v4,
            ...
            0x2::event::emit<PoolSimpleInfoEvent>(v9);
        };
    }
