module 0x8fbfc305c6db48f994922eb98fe6dd07f1e259b89dda08fc032c3cf6048e87ec::reward2511 {
    struct REWARD2511 has drop {
        dummy_field: bool,
    }

    struct TICKET_2511 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2511(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2511>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2511>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2511, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2511>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2511>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2511>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2511>>(v5, 0x2::tx_context::sender(arg1));
    }
