module 0x5981eed244deb1815dbde765a6b27dcac7a8333e48136a0384a379f7f14c8d63::reward4880 {
    struct REWARD4880 has drop {
        dummy_field: bool,
    }

    struct TICKET_4880 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4880(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4880>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4880>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4880, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4880>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4880>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4880>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4880>>(v5, 0x2::tx_context::sender(arg1));
    }
