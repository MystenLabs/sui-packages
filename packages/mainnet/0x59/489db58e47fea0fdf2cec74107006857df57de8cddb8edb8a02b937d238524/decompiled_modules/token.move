module 0x59489db58e47fea0fdf2cec74107006857df57de8cddb8edb8a02b937d238524::token {
    ...
    fun init(arg0: TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN>(arg0, 9, b"BaBy Mu", b"BaBy", b"DESCRIPTION", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://cdn.tusky.io/5ab323c3-19e1-48b1-a5e2-f01b2fb3a097")), arg1);
        let v2 = v0;
