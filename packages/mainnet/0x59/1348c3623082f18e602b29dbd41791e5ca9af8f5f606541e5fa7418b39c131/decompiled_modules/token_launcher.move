module 0x591348c3623082f18e602b29dbd41791e5ca9af8f5f606541e5fa7418b39c131::token_launcher {
    ...
    public fun get_config(arg0: &Launchpad) : Configuration {
        arg0.config
    }
    ...
    public fun get_platform_fee(arg0: &Launchpad) : u64 {
        arg0.config.platform_fee
    }
    ...
    public fun get_treasury(arg0: &Launchpad) : &0x2::balance::Balance<0x2::sui::SUI> {
        &arg0.treasury
    }
    ...
    public entry fun update_launchpad_config(arg0: &mut Launchpad, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8, arg9: u64, arg10: u64, arg11: u64, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.admin == 0x2::tx_context::sender(arg12), 0);
        assert!(arg9 + arg10 == 10000, 2);
        arg0.config.version = arg1;
        arg0.config.platform_fee = arg2;
        ...
        let v0 = ConfigurationUpdatedEvent{
            ...
            old_platform_fee           : arg0.config.platform_fee,
