module 0x59e616aab525a9961cc95a16e31de3b033ca317d08fe9542296b6a17fa898327::sealion_early_constributor {
    struct SEALION_EARLY_CONSTRIBUTOR has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SEALION_EARLY_CONSTRIBUTOR, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SEALION_EARLY_CONSTRIBUTOR>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Sealion Early constributor"));
