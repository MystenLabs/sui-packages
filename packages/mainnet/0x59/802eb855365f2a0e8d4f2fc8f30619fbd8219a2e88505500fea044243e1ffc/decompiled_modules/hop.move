module 0x59802eb855365f2a0e8d4f2fc8f30619fbd8219a2e88505500fea044243e1ffc::hop {
    struct HOP has drop {
        dummy_field: bool,
    }

    fun init(arg0: HOP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HOP>(arg0, 6, b"HOP", b"hop.fun", b"Governance token for Hop.fun", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://x.com/HopAggregator/photo")), arg1);
