module 0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault {
    ...
    public fun accept_admin_change<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_admin_change_completed(v1, v2);
    }

    public fun accept_operator_change<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::clock::Clock, arg2: &0x2::tx_context::TxContext) {
        verify_version<T0, T1>(arg0);
        let v0 = role_state<T0, T1>(arg0);
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_operator_change_completed(v1, v2);
    }
    ...
    public fun cancel_admin_change<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_admin_change_cancelled(v0.pending_admin);
    }
    ...
    public fun cancel_deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut PendingDeposits<T0>, arg2: &mut UserRecords, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_deposit_cancelled(v0, v7, v1, v5, v4);
    }
    ...
    public fun cancel_deposit_by_id<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut PendingDeposits<T0>, arg2: &mut UserRecords, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_deposit_cancelled(v0, arg3, v4, v16, v15);
    }
    ...
    public fun cancel_operator_change<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_operator_change_cancelled(v0.pending_operator);
    }
    ...
    public fun claim<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut Claims<T0>, arg2: &mut UserRecords, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_claimed(v0, arg3);
    }
    ...
    public fun credit_claim<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut Claims<T0>, arg2: &mut UserRecords, arg3: address, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        verify_version<T0, T1>(arg0);
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_claim_allocated(arg3, v0);
    }
    ...
    public fun deposit<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut PendingDeposits<T0>, arg2: &mut UserRecords, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v3 > 0) {
            ...
            0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_fees_taken(v3, 0);
        };
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_deposit_record_created(v0, add_user_record(arg2, v0, 0, v4, v3, 0, 0, v2, 0), v4, v3, v2);
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_deposit_queued(v0, v4, v3);
    }
    ...
    public fun deposit_reserve<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_reserve_fund_deposited(0x2::coin::value<T0>(&arg1), 0x2::balance::value<T0>(&arg0.reserve_fund));
    }
    ...
    public fun finalize_redeems<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut PendingRedeems<T1>, arg2: &mut UserRecords, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            ...
            0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_fees_taken(v1, 1);
        };
        ...
        while (!0x1::vector::is_empty<address>(&arg1.users) && v6 < 100) {
            ...
            if (v8 > 0) {
                ...
                0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_claimed(v7, v8);
            };
            v6 = v6 + 1;
        };
        if (0x2::balance::value<T0>(&v5) > 0) {
            ...
            0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_dust_withdrawn(arg0.fee_recipient, 0x2::balance::value<T0>(&v5));
        } else {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_redeem_finalized(v3, v2, v1);
    }
    ...
    public fun get_prunable_records_count(arg0: &UserRecords, arg1: address) : (u64, u64) {
        if (!0x2::table::contains<address, vector<UserRecord>>(&arg0.records, arg1)) {
            return (0, 0)
        };
    ...
    public fun get_redeem_settled<T0, T1>(arg0: &Vault<T0, T1>) : bool {
        arg0.redeem_settled
    }
    ...
    public fun get_vault_info<T0, T1>(arg0: &Vault<T0, T1>) : (u128, u64, u64, u64, u64, bool) {
    ...
    public fun get_version<T0, T1>(arg0: &Vault<T0, T1>) : u64 {
        arg0.version
    }
    ...
    public fun initiate_admin_change<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: address, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_admin_change_initiated(arg0.admin, arg1, v1);
    }
    ...
    public fun initiate_operator_change<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: address, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_operator_change_initiated(arg0.operator, arg1, v1);
    }
    ...
    public fun instant_redeem<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut Balances<T1>, arg2: &mut UserRecords, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_instant_redeemed(v0, arg3, v3, v5, v4);
    }

    public fun migrate_vault<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::tx_context::TxContext) {
        only_admin<T0, T1>(arg0, arg1);
        let v0 = arg0.version;
        if (v0 < 1) {
            arg0.version = 1;
            0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_vault_migrated(v0, 1);
        };
    }
    ...
    public fun prune_user_records<T0, T1>(arg0: &Vault<T0, T1>, arg1: &mut UserRecords, arg2: address, arg3: u64, arg4: &0x2::tx_context::TxContext) : u64 {
        verify_version<T0, T1>(arg0);
        ...
        *v0 = v2;
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_user_records_pruned(arg2, v3, v7);
        v3
    }
    ...
    public fun queue_redeem<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut PendingRedeems<T1>, arg2: &mut Balances<T1>, arg3: &mut UserRecords, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_redeem_queued(v0, arg4, arg4);
    }
    ...
    public fun set_fees<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_fees_updated(arg1, arg2, arg3);
    }
    ...
    public fun set_operator<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_operator_change_completed(v0, arg1);
    }
    ...
    public fun set_pause<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: bool, arg2: &0x2::tx_context::TxContext) {
        ...
        only_admin<T0, T1>(arg0, arg2);
        arg0.paused = arg1;
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_paused(arg1);
    }
    ...
    public fun set_role_change_delay<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_role_change_delay_updated(v0.role_change_delay_ms, arg1);
    }
    ...
    public fun settle_deposits<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut PendingDeposits<T0>, arg2: &mut UserRecords, arg3: &mut Balances<T1>, arg4: &mut DepositSettlementState, arg5: 0x2::coin::Coin<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        verify_version<T0, T1>(arg0);
        verify_pending_deposits<T0, T1>(arg0, arg1);
        verify_user_records<T0, T1>(arg0, arg2);
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_deposit_settled(v4, v3);
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_share_price_synced(arg0.share_price, arg0.total_shares);
    }
    ...
    public fun settle_redeems<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_redeem_settled(v1);
    }
        ...
        while (v1 < 0x1::vector::length<UserRecord>(v0) && arg2 > 0) {
            ...
            if (v2.action == 0 && v2.status == 0) {
                if (v2.amount <= arg2) {
                    ...
                    v2.settled_at = arg4;
                    arg2 = arg2 - v2.amount;
                    0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_deposit_record_settled(arg1, v2.record_id, v3, arg4);
                };
            };
            v1 = v1 + 1;
        };
    ...
    public fun take_pending_rcusdp<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        verify_version<T0, T1>(arg0);
        only_operator<T0, T1>(arg0, arg1);
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_pending_rcusdp_taken(0x2::tx_context::sender(arg1), 0x2::balance::value<T1>(&arg0.pending_redeem_rcusdp));
    ...
    public fun take_pending_usdc<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        verify_version<T0, T1>(arg0);
        only_operator<T0, T1>(arg0, arg1);
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_pending_usdc_taken(0x2::tx_context::sender(arg1), 0x2::balance::value<T0>(&arg0.pending_deposit));
    ...
    public fun verify_vault_type_config<T0, T1>(arg0: &Vault<T0, T1>, arg1: &VaultTypeConfig) {
        assert!(arg1.vault_id == 0x2::object::id<Vault<T0, T1>>(arg0), 14);
    ...
    public fun withdraw_rcusdp<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &mut Balances<T1>, arg2: &mut UserRecords, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_rcusdp_withdrawn(v0, arg3, arg3, v3, v2);
    }
    ...
    public fun withdraw_reserve<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x59b8620f8d4a1f3c6b776d0e6f564c503aace69bc398b0fb04fe9f28af6719ae::vault_events::emit_reserve_fund_withdrawn(arg1, 0x2::balance::value<T0>(&arg0.reserve_fund));
