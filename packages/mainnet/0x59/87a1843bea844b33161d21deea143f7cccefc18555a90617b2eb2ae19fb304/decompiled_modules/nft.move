module 0x5987a1843bea844b33161d21deea143f7cccefc18555a90617b2eb2ae19fb304::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"deed"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://ipfs.io/ipfs/QmPoeXAf4WaRcxACmTED4AT8w5xAWnxPcbPTWXejFWSgMY"));
