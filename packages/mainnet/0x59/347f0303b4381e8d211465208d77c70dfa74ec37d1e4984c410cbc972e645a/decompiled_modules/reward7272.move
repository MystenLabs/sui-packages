module 0x59347f0303b4381e8d211465208d77c70dfa74ec37d1e4984c410cbc972e645a::reward7272 {
    struct REWARD7272 has drop {
        dummy_field: bool,
    }

    struct TICKET_7272 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7272(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7272>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7272>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7272, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7272>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7272>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7272>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7272>>(v5, 0x2::tx_context::sender(arg1));
    }
