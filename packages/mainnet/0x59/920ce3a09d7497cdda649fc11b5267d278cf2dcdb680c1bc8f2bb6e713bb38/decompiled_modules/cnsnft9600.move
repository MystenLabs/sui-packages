module 0x59920ce3a09d7497cdda649fc11b5267d278cf2dcdb680c1bc8f2bb6e713bb38::cnsnft9600 {
    struct CNSNFT9600 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9600>(arg0, arg1);
