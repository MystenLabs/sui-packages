module 0x59c4966549dee839f3c1a5b0cb87afd48bea1b1a411989aacfda4a6c2148128a::shar {
    ...
    fun init(arg0: SHAR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SHAR>(&mut v2, 10000000000000000, 0x2::tx_context::sender(arg1), arg1);
