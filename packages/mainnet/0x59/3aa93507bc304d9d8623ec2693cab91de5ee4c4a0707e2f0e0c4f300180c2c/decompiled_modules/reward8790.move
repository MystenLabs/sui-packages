module 0x593aa93507bc304d9d8623ec2693cab91de5ee4c4a0707e2f0e0c4f300180c2c::reward8790 {
    struct REWARD8790 has drop {
        dummy_field: bool,
    }

    struct TICKET_8790 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8790(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8790>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8790>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8790, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8790>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8790>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8790>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8790>>(v5, 0x2::tx_context::sender(arg1));
    }
