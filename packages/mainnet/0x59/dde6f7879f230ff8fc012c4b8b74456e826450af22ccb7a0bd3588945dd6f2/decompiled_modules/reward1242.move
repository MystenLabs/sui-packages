module 0x59dde6f7879f230ff8fc012c4b8b74456e826450af22ccb7a0bd3588945dd6f2::reward1242 {
    struct REWARD1242 has drop {
        dummy_field: bool,
    }

    struct TICKET_1242 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1242(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1242>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1242>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1242, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1242>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1242>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1242>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1242>>(v5, 0x2::tx_context::sender(arg1));
    }
