module 0x59d95a1eaab544fb33a8cf84de724be9450e508fa544cf27b467b743c7577753::common_coin {
    ...
    fun init(arg0: COMMON_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COMMON_COIN>(arg0, 6, b"Blue Bottle", b"BOTTLE", b"description", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://movepump.com/_next/image?url=https%3A%2F%2Fapi.movepump.com%2Fuploads%2Fa_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_a_001_11_41338d765b.png&w=640&q=75"))), arg1);
