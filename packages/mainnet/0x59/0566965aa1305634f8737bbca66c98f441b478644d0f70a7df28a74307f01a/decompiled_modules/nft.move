module 0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::nft {
    ...
    fun create_meme_nft(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::blob::Blob, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::capability::new_creator_cap(v2, arg6);
        0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::meme_events::emit_meme_nft_created(v2, v0, v3.title, 0x1::option::none<0x2::object::ID>(), 0x2::tx_context::epoch(arg6));
        0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::meme_events::emit_creator_cap_created(0x2::object::id<0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::capability::CreatorCap>(&v4), v2);
        0x2::transfer::share_object<MemeNFT>(v3);
        0x2::transfer::public_transfer<0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::capability::CreatorCap>(v4, v0);
    }

    entry fun create_remix(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::blob::Blob, arg5: vector<u8>, arg6: &MemeNFT, arg7: &mut 0x2::tx_context::TxContext) {
        create_remix_nft(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
    }

    fun create_remix_nft(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::blob::Blob, arg5: vector<u8>, arg6: &MemeNFT, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        let v1 = 0x2::object::new(arg7);
        let v2 = 0x2::object::uid_to_inner(&v1);
        let v3 = 0x2::object::id<MemeNFT>(arg6);
        let v4 = &arg6.parent_hierarchy;
        assert!(0x1::vector::length<0x2::object::ID>(v4) + 1 < 10, 3);
        ...
        let v9 = MemeNFT{
            ...
            image_url        : 0x1::string::utf8(arg5),
            likes            : 0,
            liked_by         : 0x2::table::new<address, bool>(arg7),
            total_tip_amount : 0,
            created_at       : 0x2::tx_context::epoch(arg7),
        };
        let v10 = 0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::capability::new_creator_cap(v2, arg7);
        0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::meme_events::emit_meme_nft_created(v2, v0, v9.title, 0x1::option::some<0x2::object::ID>(v3), 0x2::tx_context::epoch(arg7));
        0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::meme_events::emit_creator_cap_created(0x2::object::id<0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::capability::CreatorCap>(&v10), v2);
        0x2::transfer::share_object<MemeNFT>(v9);
        0x2::transfer::public_transfer<0x590566965aa1305634f8737bbca66c98f441b478644d0f70a7df28a74307f01a::capability::CreatorCap>(v10, v0);
    }
