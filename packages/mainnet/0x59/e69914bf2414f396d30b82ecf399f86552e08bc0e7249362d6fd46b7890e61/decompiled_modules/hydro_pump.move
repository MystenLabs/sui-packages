module 0x59e69914bf2414f396d30b82ecf399f86552e08bc0e7249362d6fd46b7890e61::hydro_pump {
    ...
    fun buy_<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: address, arg5: address, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v2 = 0x59e69914bf2414f396d30b82ecf399f86552e08bc0e7249362d6fd46b7890e61::curves::calculate_add_liquidity_cost(arg1.virtual_sui_reserves, arg1.virtual_token_reserves, v1);
    ...
    public entry fun quick_buy<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x59e69914bf2414f396d30b82ecf399f86552e08bc0e7249362d6fd46b7890e61::curves::calculate_token_amount_received(v4.virtual_sui_reserves, v4.virtual_token_reserves, v5 - v5 * v1 / 10000);
    ...
    public fun sell_returns<T0>(arg0: &mut Config, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x2::sui::SUI>) {
        ...
        let v0 = arg0.fee_to;
        let v1 = arg0.platform_fee;
        let v2 = arg0.target_sui_reserves;
        let v3 = get_pool_mut<T0>(arg0);
        assert!(!v3.is_completed, 2);
        let v4 = 0x2::coin::value<T0>(&arg1);
        assert!(v4 > 0, 1);
        let v5 = 0x59e69914bf2414f396d30b82ecf399f86552e08bc0e7249362d6fd46b7890e61::curves::calculate_remove_liquidity_return(v3.virtual_token_reserves, v3.virtual_sui_reserves, v4);
        assert!(0x1::option::is_some<u64>(&v5), 3);
        let v6 = 0x1::option::extract<u64>(&mut v5);
        let v7 = v6 * v1 / 10000;
        assert!(v6 - v7 >= arg2, 3);
        let v8 = 0x2::coin::zero<0x2::sui::SUI>(arg4);
        let (v9, v10) = swap<T0>(v3, arg1, v8, 0, v6, arg4);
        let v11 = v10;
        v3.virtual_sui_reserves = v3.virtual_sui_reserves - 0x2::coin::value<0x2::sui::SUI>(&v11);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(&mut v11, v7, arg4), v0);
        let v12 = TradedEvent{
