module 0x591068c76db033021bc3ca7d09ee0608adc21143ecf506036de79747de37d76f::cnsnft6829 {
    struct CNSNFT6829 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6829, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6829>(arg0, arg1);
