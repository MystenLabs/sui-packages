module 0x59ef244ece7affe0afc8dd56cb48147061f5cf4e742fff2888fa82c72d9a4e17::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 6, b"SMPL", b"Simple Token", b"Simple Token showcases", 0x1::option::none<0x2::url::Url>(), arg1);
