module 0x59f486e378705f2b41ae4f9d37b97e7f09666baffd8b1da0c4f142bfa5177261::Ticket {
    ...
    entry fun buyTicket(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &TicketPrice, arg2: &mut 0x59f486e378705f2b41ae4f9d37b97e7f09666baffd8b1da0c4f142bfa5177261::prizePool::PrizePool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0) > 0, 1);
        let v0 = 0x59f486e378705f2b41ae4f9d37b97e7f09666baffd8b1da0c4f142bfa5177261::prizePool::getPoolLevel(arg2);
        if (v0 == 0x1::string::utf8(b"gold")) {
            ...
            let v1 = Ticket{
                ...
                image   : 0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/74.png"),
            ...
            let v2 = Ticket{
                id      : 0x2::object::new(arg4),
                price   : 0x2::coin::value<0x2::sui::SUI>(&arg0),
                image   : 0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/5994.png"),
                buyTime : 0x2::clock::timestamp_ms(arg3),
            ...
            let v3 = Ticket{
                id      : 0x2::object::new(arg4),
                price   : 0x2::coin::value<0x2::sui::SUI>(&arg0),
                image   : 0x2::url::new_unsafe_from_bytes(b"https://s2.coinmarketcap.com/static/img/coins/64x64/33258.png"),
                buyTime : 0x2::clock::timestamp_ms(arg3),
                level   : 0x1::string::utf8(b"bronze"),
            };
            0x2::transfer::public_transfer<Ticket>(v3, 0x2::tx_context::sender(arg4));
        };
        0x59f486e378705f2b41ae4f9d37b97e7f09666baffd8b1da0c4f142bfa5177261::prizePool::updateBalance(arg2, arg0);
        let v4 = BuyTicket{
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = TicketPrice{
            ...
            goldPrice   : 100000000,
            sliverPrice : 50000000,
            bronzePrice : 10000000,
        };
