module 0x59b1553410431f16092945da9fce5d601b81a654e42c474440733a210ac62c4a::sellable {
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                      : v0,
            ownership               : 0x59b1553410431f16092945da9fce5d601b81a654e42c474440733a210ac62c4a::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        ...
        0x59b1553410431f16092945da9fce5d601b81a654e42c474440733a210ac62c4a::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
