module 0x593d634861b3e89536109ae2dccd1e7edee7c4fd21f3f4c49e4dd208cabae8b8::config {
    ...
    public(friend) fun increase_version(arg0: &mut GlobalConfig) : (u64, u64) {
        assert!(arg0.version < 5, 0x593d634861b3e89536109ae2dccd1e7edee7c4fd21f3f4c49e4dd208cabae8b8::errors::verion_cant_be_increased());
    ...
    public(friend) fun remove_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(verify_reward_manager(arg0, arg1), 0x593d634861b3e89536109ae2dccd1e7edee7c4fd21f3f4c49e4dd208cabae8b8::errors::reward_manager_not_found());
        let v0 = 0;
    ...
    public(friend) fun set_reward_manager(arg0: &mut GlobalConfig, arg1: address) {
        assert!(!verify_reward_manager(arg0, arg1), 0x593d634861b3e89536109ae2dccd1e7edee7c4fd21f3f4c49e4dd208cabae8b8::errors::already_a_reward_manger());
    ...
    public fun verify_version(arg0: &GlobalConfig) {
        assert!(arg0.version == 5, 0x593d634861b3e89536109ae2dccd1e7edee7c4fd21f3f4c49e4dd208cabae8b8::errors::version_mismatch());
    }
