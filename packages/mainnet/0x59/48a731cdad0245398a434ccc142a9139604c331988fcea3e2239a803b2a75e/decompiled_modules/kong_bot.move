module 0x5948a731cdad0245398a434ccc142a9139604c331988fcea3e2239a803b2a75e::kong_bot {
    struct KongBot<phantom T0> has key {
        ...
        version: u64,
        bananas_active: 0x2::table::Table<address, BananaSimpleInfo<T0>>,
    }
    ...
    public entry fun create_banana<T0>(arg0: &mut KongBot<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::table::contains<address, BananaSimpleInfo<T0>>(&arg0.bananas_active, v0), 0);
        ...
        0x2::table::add<address, BananaSimpleInfo<T0>>(&mut arg0.bananas_active, v0, v3);
        0x2::transfer::share_object<Banana<0x2::sui::SUI>>(v1);
    }

    public fun get_banana_id<T0>(arg0: &mut KongBot<T0>, arg1: address) : 0x2::object::ID {
        0x2::table::borrow_mut<address, BananaSimpleInfo<T0>>(&mut arg0.bananas_active, arg1).banana_id
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = KongBot<0x2::sui::SUI>{
            ...
            version        : 1,
            bananas_active : 0x2::table::new<address, BananaSimpleInfo<0x2::sui::SUI>>(arg0),
        };
        0x2::transfer::share_object<KongBot<0x2::sui::SUI>>(v1);
    }

    entry fun migrate<T0>(arg0: &BotOwnerCap, arg1: &mut KongBot<T0>) {
        assert!(arg1.version < 1, 2);
        arg1.version = 1;
    }

    public fun transfer_bananas<T0>(arg0: &mut KongBot<T0>, arg1: &mut Banana<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T0>) {
        transfer_bananas_internal<T0>(arg0, arg1, arg2, arg3)
    }

    fun transfer_bananas_internal<T0>(arg0: &mut KongBot<T0>, arg1: &mut Banana<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) : (u64, 0x2::coin::Coin<T0>) {
