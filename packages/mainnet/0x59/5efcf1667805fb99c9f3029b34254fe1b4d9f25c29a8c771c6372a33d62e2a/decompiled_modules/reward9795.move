module 0x595efcf1667805fb99c9f3029b34254fe1b4d9f25c29a8c771c6372a33d62e2a::reward9795 {
    struct REWARD9795 has drop {
        dummy_field: bool,
    }

    struct TICKET_9795 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9795(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9795>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9795>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9795, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9795>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9795>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9795>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9795>>(v5, 0x2::tx_context::sender(arg1));
    }
