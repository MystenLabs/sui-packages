module 0xec47541a6f78ad5eb8abc227ec3f204e3ffedc9c31f935606e0a4583a4abccd4::seal_team_echo {
    struct SEAL_TEAM_ECHO has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SEAL_TEAM_ECHO, arg1: &mut 0x2::tx_context::TxContext) {
        abort 1
    }
