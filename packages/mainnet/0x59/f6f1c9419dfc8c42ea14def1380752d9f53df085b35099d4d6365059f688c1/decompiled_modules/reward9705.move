module 0x59f6f1c9419dfc8c42ea14def1380752d9f53df085b35099d4d6365059f688c1::reward9705 {
    struct REWARD9705 has drop {
        dummy_field: bool,
    }

    struct TICKET_9705 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9705(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9705>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9705>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9705, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9705>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9705>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9705>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9705>>(v5, 0x2::tx_context::sender(arg1));
    }
