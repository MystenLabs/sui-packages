module 0x59aafaa13a61994d146ccb10bd216d9b3f51f226c81e8d730e51df9934e223f5::soulseed_hero_nft {
    ...
    fun init(arg0: SOULSEED_HERO_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"TestBananaHeads Heroes v2"));
        0x1::vector::push_back<0x1::string::String>(v6, 0x1::string::utf8(b"TestBananaHeads Heroes v2"));
