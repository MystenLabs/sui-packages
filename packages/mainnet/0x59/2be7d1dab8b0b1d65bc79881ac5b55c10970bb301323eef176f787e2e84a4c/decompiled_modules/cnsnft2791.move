module 0x592be7d1dab8b0b1d65bc79881ac5b55c10970bb301323eef176f787e2e84a4c::cnsnft2791 {
    struct CNSNFT2791 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2791, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2791>(arg0, arg1);
