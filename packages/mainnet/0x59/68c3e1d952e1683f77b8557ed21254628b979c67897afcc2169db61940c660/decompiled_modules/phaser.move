module 0x5968c3e1d952e1683f77b8557ed21254628b979c67897afcc2169db61940c660::phaser {
    ...
    fun generate_merkle_root(arg0: address, arg1: u64, arg2: vector<address>) : address {
        ...
        0x2::address::from_bytes(0x258655b04bfabf6a91fa4fdc81ffeec3fce04f55e927b8058631b4ec4297adab::merkle_proof::process_proof(&v1, 0x1::hash::sha2_256(0x1::bcs::to_bytes<Ticket>(&v0))))
    }
