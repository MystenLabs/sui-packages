module 0x59a1653ee08a8831f6ac4f26d4dcb2afb7864670c6d30c8ad14f181c6c82b322::recorder {
    ...
    public(friend) fun add_spent(arg0: &mut Recorder, arg1: address, arg2: u64) {
        ...
        assert!(points_of(arg0, arg1) >= arg2, 0x59a1653ee08a8831f6ac4f26d4dcb2afb7864670c6d30c8ad14f181c6c82b322::errors::insufficient_points());
    ...
    fun ensure_record_cap_working(arg0: &Recorder, arg1: &RecordCap) {
        assert!(0x2::object::id<RecordCap>(arg1) == arg0.record_cap, 0x59a1653ee08a8831f6ac4f26d4dcb2afb7864670c6d30c8ad14f181c6c82b322::errors::invalid_record_cap());
    }
    ...
    public fun record_batch(arg0: &mut Recorder, arg1: &RecordCap, arg2: vector<address>, arg3: vector<u64>) {
        ...
        assert!(v0 == 0x1::vector::length<u64>(&arg3), 0x59a1653ee08a8831f6ac4f26d4dcb2afb7864670c6d30c8ad14f181c6c82b322::errors::length_mismatch());
        let v1 = 0;
        while (v1 < v0) {
    ...
    fun write_earned(arg0: &mut Recorder, arg1: address, arg2: u64) {
        assert!(arg2 > earned_of(arg0, arg1), 0x59a1653ee08a8831f6ac4f26d4dcb2afb7864670c6d30c8ad14f181c6c82b322::errors::invalid_earned());
        if (0x2::table::contains<address, u64>(&arg0.earned, arg1)) {
