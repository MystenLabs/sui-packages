module 0x5923ac6266d4fe798c003f9883895a369ffa35a2d9dbfdde68f1f0ed5b2915a1::cnsnft6854 {
    struct CNSNFT6854 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6854, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6854>(arg0, arg1);
