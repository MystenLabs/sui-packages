module 0x59700309ad443410c043457907778a62fd314ee75fdd42b3ff8a6b3d38abd1eb::portfolio {
    ...
    fun init(arg0: PORTFOLIO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::display::Display<Portfolio>>(0x2::display::new_with_fields<Portfolio>(&v0, v1, v3, arg1), 0x2::tx_context::sender(arg1));
    }
