module 0x5928d81d8e083d1bc3c19983ba0548da7e388aa691b6cf53703cb57bc1c12f8a::nft_swap {
    ...
    public fun accept_trade_improved<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::transfer_policy::TransferPolicy<T0>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        while (v27 < 0x1::vector::length<0x2::object::ID>(&v13)) {
            ...
            let (_, _, _) = 0x2::transfer_policy::confirm_request<T0>(arg6, v30);
            v27 = v27 + 1;
        };
        let v34 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Trade>(&mut arg0.id, arg4);
        let v35 = 0;
        while (v35 < 0x1::vector::length<0x2::object::ID>(&v11)) {
            let v36 = *0x1::vector::borrow<0x2::object::ID>(&v11, v35);
            let v37 = 0x2::bcs::to_bytes<0x2::object::ID>(&v36);
            if (0x2::dynamic_object_field::exists_<vector<u8>>(&v34.id, v37)) {
                let (v38, v39) = 0x2::kiosk::purchase_with_cap<T0>(arg1, 0x2::dynamic_object_field::remove<vector<u8>, 0x2::kiosk::PurchaseCap<T0>>(&mut v34.id, v37), 0x2::coin::zero<0x2::sui::SUI>(arg7));
                0x2::kiosk::lock<T0>(arg2, arg3, arg6, v38);
    ...
    public entry fun accept_trade_single_kiosks<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &0x2::transfer_policy::TransferPolicy<T0>, arg7: &mut 0x2::tx_context::TxContext) {
