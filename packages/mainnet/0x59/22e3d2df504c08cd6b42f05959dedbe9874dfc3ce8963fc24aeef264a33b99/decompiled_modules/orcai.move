module 0x5922e3d2df504c08cd6b42f05959dedbe9874dfc3ce8963fc24aeef264a33b99::orcai {
    ...
    fun init(arg0: ORCAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/XcJMX827YrA5mpc5bz6nhv6rTzvKRx6CQKJV8ACpump.png?size=lg&key=69b8ed                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<ORCAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ORCAI   ")))), trim_right(b"Orca AI                         "), trim_right(b"Orca is a multiplatform AI agent powered by DeepSeek's advanced neural networks. Operating across social media and chat platforms, OrcaAI demonstrates cutting-edge AI capabilities through real-time interactions and technology insights.                                                                                     "), v2, arg1);
        let v5 = v3;
