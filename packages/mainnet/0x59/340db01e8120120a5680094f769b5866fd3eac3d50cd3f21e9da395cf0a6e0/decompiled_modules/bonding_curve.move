module 0x59340db01e8120120a5680094f769b5866fd3eac3d50cd3f21e9da395cf0a6e0::bonding_curve {
    ...
    entry fun ban_referrer(arg0: &AdminCap, arg1: &mut Blacklist, arg2: address, arg3: &0x2::clock::Clock) {
    ...
    entry fun blacklist_address(arg0: &AdminCap, arg1: &mut Blacklist, arg2: address, arg3: &0x2::clock::Clock) {
    ...
    entry fun buy<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: &mut BondingPool<T0>, arg4: &mut ReferralRegistry, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun buy_with_referrer<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: &mut BondingPool<T0>, arg4: &mut ReferralRegistry, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: address, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun cancel_graduation<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>, arg2: &0x2::clock::Clock) {
    ...
    entry fun create_admin_cap(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_token_exponential<T0: drop>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: T0, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: u8, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_token_linear<T0: drop>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: T0, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: u8, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg12) >= arg1.creation_fee, 1);
        let v0 = CurveParams{
            curve_type       : 0,
            base_price       : (arg8 as u128),
    ...
    entry fun emergency_withdraw<T0>(arg0: &AdminCap, arg1: &LaunchpadConfig, arg2: &mut BondingPool<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun force_graduate<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>, arg2: &0x2::clock::Clock) {
    ...
    entry fun pause_pool<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>) {
        arg1.status = 2;
    }

    entry fun remove_referrer(arg0: &AdminCap, arg1: &mut ReferralRegistry, arg2: address) {
        if (0x2::table::contains<address, address>(&arg1.referrals, arg2)) {
            0x2::table::remove<address, address>(&mut arg1.referrals, arg2);
        };
    }

    entry fun revoke_admin_cap(arg0: AdminCap, arg1: &mut AdminRegistry, arg2: &0x2::clock::Clock) {
    ...
    entry fun sell<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: &mut BondingPool<T0>, arg4: &mut ReferralRegistry, arg5: 0x2::coin::Coin<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.status == 0, 2);
        assert!(!arg0.is_paused, 2);
    ...
    entry fun set_max_admins(arg0: &AdminCap, arg1: &mut AdminRegistry, arg2: u64) {
        assert!(arg2 >= arg1.admin_count, 9);
        arg1.max_admins = arg2;
    }

    entry fun set_max_supply<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>, arg2: u128) {
        assert!(arg2 >= arg1.current_supply, 9);
        arg1.max_supply = arg2;
    }

    entry fun set_paused(arg0: &AdminCap, arg1: &mut LaunchpadConfig, arg2: bool) {
        arg1.is_paused = arg2;
    }

    entry fun transfer_pool_ownership<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>, arg2: address, arg3: &0x2::clock::Clock) {
        arg1.creator = arg2;
    ...
    entry fun unban_referrer(arg0: &AdminCap, arg1: &mut Blacklist, arg2: address, arg3: &0x2::clock::Clock) {
        if (0x2::table::contains<address, bool>(&arg1.banned_referrers, arg2)) {
    ...
    entry fun unpause_pool<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>) {
        assert!(arg1.status == 2, 2);
        arg1.status = 0;
    }

    entry fun update_creation_fee(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    entry fun update_default_graduation_mcap(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: u64) {
        assert!(arg2 > 0, 9);
        arg1.default_graduation_mcap = arg2;
    }

    entry fun update_fee_distribution(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) {
    ...
    entry fun update_pool_graduation_mcap<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>, arg2: u64) {
        assert!(arg2 > 0, 9);
        assert!(arg1.status == 0, 8);
        arg1.graduation_mcap = arg2;
    }

    entry fun update_pool_metadata<T0>(arg0: &AdminCap, arg1: &mut BondingPool<T0>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock) {
    ...
    entry fun update_project_wallet(arg0: &AdminCap, arg1: &mut LaunchpadConfig, arg2: address) {
        arg1.project_wallet = arg2;
    }

    entry fun update_trading_fees(arg0: &AdminCap, arg1: &mut FeeConfig, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) {
    ...
    entry fun whitelist_address(arg0: &AdminCap, arg1: &mut Blacklist, arg2: address, arg3: &0x2::clock::Clock) {
        if (0x2::table::contains<address, bool>(&arg1.addresses, arg2)) {
