module 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::sudoz_artifacts_v2 {
    ...
    struct GlobalStats has key {
        ...
        evolution_auth: 0x1::option::Option<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth>,
    }
    ...
    public fun enable_burn_mechanisms(arg0: &AdminCap, arg1: &mut GlobalStats, arg2: &0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedStats) {
        assert!(0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::get_evolved_minted(arg2) >= 5555, 7);
        arg1.burn_mechanisms_enabled = true;
    }

    public entry fun entry_evolve_artifact(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedStats, arg3: &0x2::random::Random, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut 0x2::tx_context::TxContext) {
        evolve_artifact(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
    }

    public entry fun entry_evolve_artifact_with_kiosk(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedStats, arg3: &0x2::transfer_policy::TransferPolicy<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedSudoz>, arg4: &0x2::random::Random, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: &mut 0x2::tx_context::TxContext) {
    ...
    public fun evolve_artifact(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedStats, arg3: &0x2::random::Random, arg4: u64, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x1::option::is_some<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), 7);
        let v10 = 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::mint_evolved_for_evolution(0x1::option::borrow<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), v0, *0x1::option::borrow<u8>(&arg0.path), arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12);
        let v11 = ArtifactBurnedForEvolved{
            artifact_id     : 0x2::object::uid_to_inner(&arg0.id),
            evolved_id      : 0x2::object::id<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedSudoz>(&v10),
            artifact_number : v0,
            evolved_number  : 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::get_evolved_number(&v10),
        };
        0x2::event::emit<ArtifactBurnedForEvolved>(v11);
        0x2::transfer::public_transfer<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedSudoz>(v10, 0x2::tx_context::sender(arg12));
    }

    public fun evolve_artifact_with_kiosk(arg0: SudozArtifact, arg1: &mut GlobalStats, arg2: &mut 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedStats, arg3: &0x2::transfer_policy::TransferPolicy<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolvedSudoz>, arg4: &0x2::random::Random, arg5: u64, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: 0x1::string::String, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.level == 10, 8);
        let v0 = arg0.number;
        let SudozArtifact {
            id          : v1,
        ...
        arg1.level_10_burns = arg1.level_10_burns + 1;
        assert!(0x1::option::is_some<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), 7);
        0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::mint_evolved_and_lock(0x1::option::borrow<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth>(&arg1.evolution_auth), v0, *0x1::option::borrow<u8>(&arg0.path), arg2, arg3, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13);
        let v10 = ArtifactBurnedForEvolved{
            artifact_id     : 0x2::object::uid_to_inner(&arg0.id),
            evolved_id      : 0x2::object::id_from_address(@0x0),
            artifact_number : v0,
            evolved_number  : 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::get_evolved_minted(arg2),
        };
    ...
    fun init(arg0: SUDOZ_ARTIFACTS_V2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = GlobalStats{
            ...
            evolution_auth          : 0x1::option::none<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth>(),
        };
    ...
    public entry fun store_evolution_auth(arg0: &AdminCap, arg1: &mut GlobalStats, arg2: 0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth, arg3: &mut 0x2::tx_context::TxContext) {
        0x1::option::fill<0x59528edff82bf6e94a6bd5e024aa8feeedd692983931a51c2ac69274dbc61204::evolved_sudoz::EvolutionAuth>(&mut arg1.evolution_auth, arg2);
    }
