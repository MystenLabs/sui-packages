module 0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::swap {
    struct OrderService has store, key {
        id: 0x2::object::UID,
        balances: 0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::BalanceBag,
    ...
    public entry fun deposit<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: 0x2::coin::Coin<T0>) {
        ...
        if (!0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::contains<T0>(&arg0.balances)) {
            0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::init_balance<T0>(&mut arg0.balances);
            0x1::vector::push_back<0x1::type_name::TypeName>(&mut arg0.coins, 0x1::type_name::get<T0>());
        };
        0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::join<T0>(&mut arg0.balances, 0x2::coin::into_balance<T0>(arg2));
    }

    public entry fun get_balance<T0>(arg0: &mut OrderService, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = BalanceResultEvent{balance: 0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::value<T0>(&arg0.balances)};
        0x2::event::emit<BalanceResultEvent>(v0);
        0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::value<T0>(&arg0.balances)
    }

    public entry fun get_coins(arg0: &mut OrderService, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = CoinsResultEvent{coins: arg0.coins};
        0x2::event::emit<CoinsResultEvent>(v0);
    }

    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = OrderService{
            id       : 0x2::object::new(arg0),
            balances : 0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::new(arg0),
    ...
    fun withdraw<T0>(arg0: &mut OrderService, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_admin(arg0, arg1);
        assert!(0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::value<T0>(&arg0.balances) >= arg2, 4);
        0x2::coin::from_balance<T0>(0x59279ae5d60eb3ee3d1e184c88b71c973badc19c76520aae52acb8f5c6d33e7e::balance_bag::split<T0>(&mut arg0.balances, arg2), arg3)
    }
