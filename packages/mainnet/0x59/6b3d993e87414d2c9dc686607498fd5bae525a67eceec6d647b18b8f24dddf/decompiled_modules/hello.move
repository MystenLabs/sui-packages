module 0x596b3d993e87414d2c9dc686607498fd5bae525a67eceec6d647b18b8f24dddf::hello {
    ...
    fun init(arg0: HELLO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HELLO>(arg0, 10, b"HL", b"HELLO", b"HELLO", 0x1::option::none<0x2::url::Url>(), arg1);
