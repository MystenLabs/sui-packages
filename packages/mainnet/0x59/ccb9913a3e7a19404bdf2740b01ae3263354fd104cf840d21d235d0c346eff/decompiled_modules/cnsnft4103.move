module 0x59ccb9913a3e7a19404bdf2740b01ae3263354fd104cf840d21d235d0c346eff::cnsnft4103 {
    struct CNSNFT4103 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4103, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4103>(arg0, arg1);
