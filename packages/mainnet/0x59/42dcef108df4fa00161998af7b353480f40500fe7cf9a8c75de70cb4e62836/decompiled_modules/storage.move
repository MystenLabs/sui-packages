module 0x5942dcef108df4fa00161998af7b353480f40500fe7cf9a8c75de70cb4e62836::storage {
    ...
    public(friend) fun join_stake(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: 0x3::staking_pool::StakedSui, arg3: &mut 0x2::tx_context::TxContext) {
        if (0x3::staking_pool::stake_activation_epoch(&arg2) <= 0x2::tx_context::epoch(arg3)) {
            ...
            let v1 = get_or_add_validator_index_by_staking_pool_id_mut(arg0, arg1, 0x3::staking_pool::pool_id(&arg2), arg3);
            join_inactive_stake_to_validator(arg0, v1, arg2);
        };
    }
    ...
    fun split_from_active_stake(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        0x3::sui_system::redeem_fungible_staked_sui(arg1, 0x3::staking_pool::split_fungible_staked_sui(0x1::option::borrow_mut<0x3::staking_pool::FungibleStakedSui>(&mut 0x1::vector::borrow_mut<ValidatorInfo>(&mut arg0.validator_infos, arg2).active_stake), arg3, arg4), arg4)
    }
    ...
    fun split_from_inactive_stake(arg0: &mut Storage, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x3::staking_pool::StakedSui {
        refresh_validator_info(arg0, arg1);
        0x3::staking_pool::split(0x1::option::borrow_mut<0x3::staking_pool::StakedSui>(&mut 0x1::vector::borrow_mut<ValidatorInfo>(&mut arg0.validator_infos, arg1).inactive_stake), arg2, arg3)
    }

    public(friend) fun split_from_sui_pool(arg0: &mut Storage, arg1: u64) : 0x2::balance::Balance<0x2::sui::SUI> {
    ...
    public(friend) fun split_n_sui(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        while (v0 > 0) {
            let v1 = 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool);
            if (v1 >= arg2) {
                break
            };
            v0 = v0 - 1;
            unstake_approx_n_sui_from_inactive_stake(arg0, arg1, v0, arg2 - v1, arg3);
        };
        let v2 = 0x1::vector::length<ValidatorInfo>(validators(arg0));
        while (v2 > 0) {
            let v3 = 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool);
            if (v3 >= arg2) {
                break
            };
            v2 = v2 - 1;
            unstake_approx_n_sui_from_active_stake(arg0, arg1, v2, arg2 - v3 + 100, arg3);
        };
    ...
    fun take_active_stake(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: &0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        refresh_validator_info(arg0, arg2);
        0x3::sui_system::redeem_fungible_staked_sui(arg1, 0x1::option::extract<0x3::staking_pool::FungibleStakedSui>(&mut 0x1::vector::borrow_mut<ValidatorInfo>(&mut arg0.validator_infos, arg2).active_stake), arg3)
    }

    fun take_from_inactive_stake(arg0: &mut Storage, arg1: u64) : 0x3::staking_pool::StakedSui {
        refresh_validator_info(arg0, arg1);
        0x1::option::extract<0x3::staking_pool::StakedSui>(&mut 0x1::vector::borrow_mut<ValidatorInfo>(&mut arg0.validator_infos, arg1).inactive_stake)
    }
    ...
    public(friend) fun unstake_approx_n_sui_from_active_stake(arg0: &mut Storage, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v2 = 0x3::staking_pool::fungible_staked_sui_value(0x1::option::borrow<0x3::staking_pool::FungibleStakedSui>(&v0.active_stake));
        let v3 = get_sui_amount(&v0.exchange_rate, v2);
        let v4 = if (v3 <= v1) {
            take_active_stake(arg0, arg1, arg2, arg4)
        } else {
            split_from_active_stake(arg0, arg1, arg2, (((((v1 as u128) * (v2 as u128) + (v3 as u128) - 1) / (v3 as u128)) as u64) as u64), arg4)
        };
        let v5 = v4;
