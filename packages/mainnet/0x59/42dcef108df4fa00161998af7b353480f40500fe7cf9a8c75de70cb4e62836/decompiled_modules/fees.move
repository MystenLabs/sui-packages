module 0x5942dcef108df4fa00161998af7b353480f40500fe7cf9a8c75de70cb4e62836::fees {
    ...
    public(friend) fun calculate_custom_redeem_fee(arg0: &FeeConfig, arg1: u64) : u64 {
        if (arg0.custom_redeem_fee_bps == 0) {
            return 0
        };
        ((((arg1 as u128) * (arg0.custom_redeem_fee_bps as u128) + 9999) / 10000) as u64)
    }
