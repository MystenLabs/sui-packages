module 0x59b376717ba5b88ddfcf1193f6bf775975555090ab4c974786b8a290db169c42::reward6759 {
    struct REWARD6759 has drop {
        dummy_field: bool,
    }

    struct TICKET_6759 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6759(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6759>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6759>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6759, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6759>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6759>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6759>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6759>>(v5, 0x2::tx_context::sender(arg1));
    }
