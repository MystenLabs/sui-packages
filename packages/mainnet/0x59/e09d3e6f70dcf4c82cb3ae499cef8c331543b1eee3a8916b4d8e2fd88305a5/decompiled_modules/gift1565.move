module 0x59e09d3e6f70dcf4c82cb3ae499cef8c331543b1eee3a8916b4d8e2fd88305a5::gift1565 {
    struct GIFT1565 has drop {
        dummy_field: bool,
    }

    struct TICKET_1565 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift1565(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1565>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1565>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT1565, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1565>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1565>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1565>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1565>>(v5, 0x2::tx_context::sender(arg1));
    }
