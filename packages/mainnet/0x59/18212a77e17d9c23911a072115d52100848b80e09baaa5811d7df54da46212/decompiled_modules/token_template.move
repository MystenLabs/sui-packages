module 0x5918212a77e17d9c23911a072115d52100848b80e09baaa5811d7df54da46212::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T007479", b"Test 007479", b"Integration test token 2025-11-01T04:06:47.479Z", 0x1::option::none<0x2::url::Url>(), arg1);
