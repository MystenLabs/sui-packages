module 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::blub_ambassador {
    ...
    public fun activate_ambassador(arg0: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg1: &mut BlubAmbassador, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::check_staff(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0x2::object::id<BlubAmbassador>(arg1);
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::set_ambassador_pause(arg0, v0, false, arg4);
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::set_ambassador_requested_time(arg0, v0, 0x2::clock::timestamp_ms(arg3), arg4);
    ...
    public entry fun add_staff(arg0: &0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AdminCap, arg1: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg2: address) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::set_staff(arg0, arg1, arg2);
    }
    ...
    public fun collect_salary<T0, T1, T2>(arg0: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg1: &mut BlubAmbassador, arg2: &mut AmbassadorRewards, arg3: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T1>, arg5: bool, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::set_ambassador_requested_time(arg0, v1, v2 + v4 * 400000, arg7);
        arg1.wait_claimed_rewards = 0;
    }

    public fun create_ambassador(arg0: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg1: vector<0x1::string::String>, arg2: vector<0x1::string::String>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg3 != @0x0) {
            arg3
        } else {
        ...
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::set_ambassador_owner(arg0, 0x2::object::id<BlubAmbassador>(&v2), v0);
    ...
    public entry fun deactivate_ambassador(arg0: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg1: &BlubAmbassador, arg2: &mut 0x2::tx_context::TxContext) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::check_staff(arg0, 0x2::tx_context::sender(arg2));
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::set_ambassador_pause(arg0, 0x2::object::id<BlubAmbassador>(arg1), true, arg2);
    }
    ...
    public entry fun remove_staff(arg0: &0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AdminCap, arg1: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg2: address) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::remove_staff(arg0, arg1, arg2);
    }
    ...
    public entry fun update_ambassador_payment_every_week(arg0: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg1: &mut BlubAmbassador, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::check_staff(arg0, 0x2::tx_context::sender(arg4));
        let v0 = 0x2::object::id<BlubAmbassador>(arg1);
        let v1 = 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::get_ambassador_requested_time(arg0, v0);
        let v2 = (0x2::clock::timestamp_ms(arg3) - v1) / 400000;
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::set_ambassador_requested_time(arg0, v0, v1 + v2 * 400000, arg4);
        arg1.payment_every_week = arg2;
        arg1.wait_claimed_rewards = arg1.wait_claimed_rewards + v2 * arg2;
    }

    public entry fun update_factor(arg0: &mut 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AmbassadorConfig, arg1: &mut AmbassadorRewards, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::check_staff(arg0, 0x2::tx_context::sender(arg3));
        arg1.factor = arg2;
    }

    public entry fun withdraw_rewards<T0, T1>(arg0: &0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config::AdminCap, arg1: &mut AmbassadorRewards, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
