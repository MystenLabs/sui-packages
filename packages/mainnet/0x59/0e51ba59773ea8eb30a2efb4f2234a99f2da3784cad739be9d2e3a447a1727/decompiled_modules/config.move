module 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::config {
    ...
    struct AmbassadorConfig has store, key {
        id: 0x2::object::UID,
        acl: 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::acl::ACL,
    ...
    public fun add_role(arg0: &AdminCap, arg1: &mut AmbassadorConfig, arg2: address, arg3: u8) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut AmbassadorConfig, arg2: address, arg3: u8) {
        0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public(friend) fun check_staff(arg0: &AmbassadorConfig, arg1: address) {
        assert!(0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::acl::has_role(&arg0.acl, arg1, 0), 0);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = AmbassadorConfig{
            ...
            acl                     : 0x590e51ba59773ea8eb30a2efb4f2234a99f2da3784cad739be9d2e3a447a1727::acl::new(arg0),
