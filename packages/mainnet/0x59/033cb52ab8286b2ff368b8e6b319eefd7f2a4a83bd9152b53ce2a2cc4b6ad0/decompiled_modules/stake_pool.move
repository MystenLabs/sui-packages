module 0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::stake_pool {
    ...
    entry fun activate_incentive_token<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg3);
        let v0 = &mut arg1.id;
    ...
    entry fun add_incentive_token<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg6);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0x1::type_name::get<T0>();
    ...
    public(friend) fun allocate_incentive(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::version_check(arg0);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0;
        while (v2 < 0x1::vector::length<Incentive>(&v1.incentives)) {
            ...
            if (v3.info.active && v4 > v5) {
                let v6 = (((v3.config.period_incentive_amount as u128) * ((v4 - v5) as u128) / (v3.config.incentive_interval_ts_ms as u128)) as u64);
                let v7 = if (v1.pool_info.total_share > 0) {
                    (((multiplier(9) as u128) * (v6 as u128) / (v1.pool_info.total_share as u128)) as u64)
                } else {
                    0
                };
    ...
    public(friend) fun create_user_last_incentive_ts_ms(arg0: &StakePool, arg1: u64) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64> {
    ...
    entry fun deactivate_incentive_token<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg3);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0x1::type_name::get<T0>();
    ...
    entry fun deposit_incentive<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0x1::type_name::get<T0>();
        let v3 = get_incentive_tokens(v1);
    ...
    public(friend) fun get_incentive(arg0: &StakePool, arg1: &0x1::type_name::TypeName) : &Incentive {
        let v0 = 0;
    ...
    public(friend) fun get_incentive_tokens(arg0: &StakePool) : vector<0x1::type_name::TypeName> {
        let v0 = 0;
    ...
    public(friend) fun get_last_incentive_price_index(arg0: &StakePool) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64> {
        let v0 = arg0.incentives;
        let v1 = 0x2::vec_map::empty<0x1::type_name::TypeName, u64>();
        while (0x1::vector::length<Incentive>(&v0) > 0) {
            let v2 = 0x1::vector::pop_back<Incentive>(&mut v0);
    ...
    public(friend) fun get_mut_incentive(arg0: &mut StakePool, arg1: &0x1::type_name::TypeName) : &mut Incentive {
        let v0 = 0;
        while (v0 < 0x1::vector::length<Incentive>(&arg0.incentives)) {
            if (0x1::vector::borrow<Incentive>(&arg0.incentives, v0).token_type == *arg1) {
    ...
    public(friend) fun get_mut_stake_pool(arg0: &mut 0x2::object::UID, arg1: u64) : &mut StakePool {
        0x2::dynamic_object_field::borrow_mut<u64, StakePool>(arg0, arg1)
    }

    public(friend) fun get_stake_pool(arg0: &0x2::object::UID, arg1: u64) : &StakePool {
        0x2::dynamic_object_field::borrow<u64, StakePool>(arg0, arg1)
    }

    public(friend) fun get_user_share_ids(arg0: &StakePool, arg1: address) : vector<u64> {
    ...
    public fun harvest_per_user_share<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::version_check(arg0);
    ...
    entry fun new_stake_pool<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg3);
        assert!(arg2 > 0, 7);
        ...
        let v5 = NewStakePoolEvent{
            sender            : 0x2::tx_context::sender(arg3),
            stake_pool_info   : v4.pool_info,
            stake_pool_config : v4.config,
            u64_padding       : 0x1::vector::empty<u64>(),
        };
        0x2::event::emit<NewStakePoolEvent>(v5);
        0x2::dynamic_object_field::add<u64, StakePool>(&mut arg1.id, arg1.num_pool, v4);
        arg1.num_pool = arg1.num_pool + 1;
    }

    public(friend) fun remove_incentive(arg0: &mut StakePool, arg1: &0x1::type_name::TypeName) : Incentive {
        let v0 = 0;
        while (v0 < 0x1::vector::length<Incentive>(&arg0.incentives)) {
            if (0x1::vector::borrow<Incentive>(&arg0.incentives, v0).token_type == *arg1) {
    ...
    public fun remove_incentive_token<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg3);
    ...
    public fun stake<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::version_check(arg0);
        ...
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v2.id, v3), v4);
        let v6 = if (0x1::option::is_some<u64>(&arg4)) {
            let v7 = &mut v2.id;
            let v8 = remove_user_share_by_id(v7, 0x2::tx_context::sender(arg6), *0x1::option::borrow<u64>(&arg4));
            assert!(v0 == v8.user, 5);
            assert!(harvest_progress_updated(v2, &v8), 8);
            v8.stake_ts_ms = 0x2::clock::timestamp_ms(arg5);
            v8.total_shares = v8.total_shares + v5;
            v8.active_shares = v8.active_shares + v5;
            v8.last_incentive_price_index = get_last_incentive_price_index(v2);
            v8
        } else {
            let v9 = LpUserShare{
                user                       : v0,
                user_share_id              : v2.pool_info.next_user_share_id,
                stake_ts_ms                : 0x2::clock::timestamp_ms(arg5),
                total_shares               : v5,
                active_shares              : v5,
        ...
        let v12 = &mut v2.id;
        store_user_shares(v12, v0, 0x1::vector::singleton<LpUserShare>(v10));
    ...
    public fun unstake<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::version_check(arg0);
        allocate_incentive(arg0, arg1, arg2, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        ...
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v2), v7), arg5)
    }

    public fun unsubscribe<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: 0x1::option::Option<u64>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::version_check(arg0);
        allocate_incentive(arg0, arg1, arg2, arg5);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    entry fun update_incentive_config<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: &0x2::clock::Clock, arg4: 0x1::option::Option<u64>, arg5: 0x1::option::Option<u64>, arg6: 0x1::option::Option<vector<u64>>, arg7: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg7);
    ...
    entry fun update_unlock_countdown_ts_ms(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg4);
        assert!(arg3 > 0, 7);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
    ...
    public fun withdraw_incentive<T0>(arg0: &0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::Version, arg1: &mut StakePoolRegistry, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x59033cb52ab8286b2ff368b8e6b319eefd7f2a4a83bd9152b53ce2a2cc4b6ad0::admin::verify(arg0, arg4);
        let v0 = &mut arg1.id;
        let v1 = get_mut_stake_pool(v0, arg2);
        let v2 = 0x1::type_name::get<T0>();
