module 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap {
    ...
    fun assert_k_increase(arg0: AdminData, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        ...
        let v4 = 100000000;
        if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::is_overflow_mul(v1, v2) || 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::is_overflow_mul(v3, v4)) {
    ...
    public fun calc_optimal_coin_values<T0, T1>(arg0: &mut LiquidityPools, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u64, u64) {
        ...
        if (v2 == 0 && v3 == 0) {
            ...
            let v6 = 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::quote(arg1, v2, v3);
            if (v6 <= arg2) {
                assert!(v6 >= arg4, 109);
                (arg1, v6)
            } else {
                let v7 = 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::quote(arg2, v3, v2);
                assert!(v7 <= arg1, 102);
                assert!(v7 >= arg3, 108);
                (v7, arg2)
            }
    ...
    public fun create_pair<T0, T1>(arg0: &mut LiquidityPools, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T0, T1>(), 119);
        let v0 = check_pair_exist<T0, T1>(arg0);
        assert!(!v0, 115);
        assert_not_paused(arg0);
    ...
    public fun get_amounts_in<T0, T1>(arg0: &mut LiquidityPools, arg1: u64) : u64 {
        if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T0, T1>()) {
            let (v1, v2) = get_pool<T0, T1>(arg0);
            let v3 = v2;
            let (v4, v5) = get_reserves_size<T0, T1>(v1);
            0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_in(arg1, v4, v5, v3.swap_fee)
        } else {
            let (v6, v7) = get_pool<T1, T0>(arg0);
            let v8 = v7;
            let (v9, v10) = get_reserves_size<T1, T0>(v6);
            0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_in(arg1, v10, v9, v8.swap_fee)
        }
    }

    public fun get_amounts_in_2_pair<T0, T1, T2>(arg0: &mut LiquidityPools, arg1: u64) : u64 {
        let v0 = if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T1, T2>()) {
        ...
        if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T0, T1>()) {
            ...
            0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_in(v0, v15, v16, v14.swap_fee)
        } else {
            let (v17, v18) = get_pool<T1, T0>(arg0);
            let v19 = v18;
            let (v20, v21) = get_reserves_size<T1, T0>(v17);
            0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_in(v0, v21, v20, v19.swap_fee)
        }
    }
    ...
    public fun get_amounts_out<T0, T1>(arg0: &mut LiquidityPools, arg1: u64) : u64 {
        if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T0, T1>()) {
            ...
            let v3 = v2;
            let (v4, v5) = get_reserves_size<T0, T1>(v1);
            0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_out(arg1, v4, v5, v3.swap_fee)
        } else {
            let (v6, v7) = get_pool<T1, T0>(arg0);
            let v8 = v7;
            let (v9, v10) = get_reserves_size<T1, T0>(v6);
            0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_out(arg1, v10, v9, v8.swap_fee)
        }
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = AdminData{
            dao_fee_to    : @0x99086ae0f5ff55df0de1f9f1707ebe7b4c36a67b39503d304b4a7fe549339b4f,
            admin_address : @0x99086ae0f5ff55df0de1f9f1707ebe7b4c36a67b39503d304b4a7fe549339b4f,
            dao_fee       : 5,
            swap_fee      : 30,
            dao_fee_on    : true,
            is_pause      : false,
    ...
    public fun mint<T0, T1>(arg0: &mut LiquidityPools, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>) : 0x2::balance::Balance<LPCoin<T0, T1>> {
        ...
        let v10 = if (v7 == 0) {
            ...
            0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::sqrt(v3, v4) - 1000
        } else {
    ...
    fun mint_fee_internal<T0, T1>(arg0: &mut LiquidityPools) : bool {
        ...
        if (v3) {
            if (v4 != 0) {
                ...
                let v7 = 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::sqrt(v5, v6);
                ...
                if (v7 > v8) {
                    ...
                    if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::is_overflow_mul(v9, v10)) {
    ...
    public fun swap_balance_for_balance<T0, T1>(arg0: &mut LiquidityPools, arg1: &0x2::clock::Clock, arg2: 0x2::balance::Balance<T0>, arg3: 0x2::balance::Balance<T1>) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        if (v3 > 0) {
            ...
            swap<T0, T1>(arg0, arg1, arg2, 0, arg3, 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_out(v3, v7, v8, v2.swap_fee))
        } else {
            let (v9, v10) = get_reserves_size<T0, T1>(v0);
            swap<T0, T1>(arg0, arg1, arg2, 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::get_amount_out(v4, v10, v9, v2.swap_fee), arg3, 0)
        }
    }
    ...
    public entry fun swap_coins_for_exact_coins_2_pair_entry<T0, T1, T2>(arg0: &mut LiquidityPools, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 <= arg4, 110);
        let v1 = if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T0, T1>()) {
        ...
        let v10 = if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T1, T2>()) {
    ...
    public entry fun swap_exact_coins_for_coins_2_pair_entry<T0, T1, T2>(arg0: &mut LiquidityPools, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T0, T1>()) {
        ...
        let v9 = if (0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::compare<T1, T2>()) {
    ...
    fun update_internal<T0, T1>(arg0: &mut LiquidityPool<T0, T1>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: u64, arg5: u64) {
        ...
        if (v1 > 0 && arg4 != 0 && arg5 != 0) {
            arg0.last_price_x_cumulative = 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::overflow_add(arg0.last_price_x_cumulative, 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::uq64x64::to_u128(0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::uq64x64::fraction(arg5, arg4)) * v1);
            arg0.last_price_y_cumulative = 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::memeswap_library::overflow_add(arg0.last_price_y_cumulative, 0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::uq64x64::to_u128(0x59076b1be07dc473d97a8db478b3f50d8fadd98d3cd69f2a903c45c79fedd2ec::uq64x64::fraction(arg4, arg5)) * v1);
        };
