module 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::big_vector {
    ...
    fun leaf_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: T0) : (u128, u64) {
        ...
        let v3 = Slice<T0>{
            prev : arg1,
            next : v0.next,
            keys : 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_until<u128>(&mut v0.keys, v2),
            vals : 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_until<T0>(&mut v0.vals, v2),
            size : 0,
        };
    ...
    fun leaf_remove<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: u64, arg4: u128, arg5: u64, arg6: u128) : (T0, u8, u128) {
        ...
        if (v3 == 2) {
            ...
            let v6 = 0x2::dynamic_field::borrow_mut<u64, Slice<T0>>(&mut arg0.id, arg3);
            v6.size = 0x1::vector::length<T0>(&v6.vals);
        };
        (v2, v3, v4)
    }
    ...
    fun node_insert<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u8, arg3: u128, arg4: T0) : (u128, u64) {
        ...
        let v7 = Slice<u64>{
            prev : arg1,
            next : v5.next,
            keys : 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_until<u128>(&mut v5.keys, v6),
            vals : 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_until<u64>(&mut v5.vals, v6),
            size : 0,
        };
    ...
    fun slice_redistribute<T0: store, T1: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u128, arg3: u64) : u128 {
        ...
        let (v8, v22) = if (v21) {
            let v23 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_until<T1>(&mut v8, v19);
            0x1::vector::append<T1>(&mut v23, v15);
            (v8, v23)
        } else {
            0x1::vector::append<T1>(&mut v8, v15);
            (v8, 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_n<T1>(&mut v15, v20))
        };
        let v24 = v22;
        let (v9, v25, v26) = if (v2 && v21) {
            let v27 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_until<u128>(&mut v9, v19);
            0x1::vector::append<u128>(&mut v27, v12);
            (v9, *0x1::vector::borrow<u128>(&v27, 0), v27)
        } else if (v2 && !v21) {
            let v28 = v12;
            let v29 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_n<u128>(&mut v28, v20);
            0x1::vector::append<u128>(&mut v9, v28);
            (v9, *0x1::vector::borrow<u128>(&v29, 0), v29)
        } else {
            let (v30, v9, v31) = if (!v2 && v21) {
                let v32 = 0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_until<u128>(&mut v9, v19);
                ...
                (0x66f3283a3a4ed92aa4de92a3105f90dc1dd07921a43585785b206d9d708a3193::utils::pop_n<u128>(&mut v33, v20 - 1), v9, 0x1::vector::pop_back<u128>(&mut v33))
            };
            (v9, v31, v30)
        };
        let v34 = Slice<T1>{
        ...
        if (v2) {
            ...
            while (v39 < 0x1::vector::length<T1>(&v8)) {
                if (0x2::dynamic_field::exists_with_type<u64, Slice<u64>>(v38, *0x1::vector::borrow<u64>(&v42.vals, v39))) {
                    v40 = v40 + 0x2::dynamic_field::borrow<u64, Slice<u64>>(v38, *0x1::vector::borrow<u64>(&v42.vals, v39)).size;
                } else if (0x2::dynamic_field::exists_with_type<u64, Slice<T0>>(v38, *0x1::vector::borrow<u64>(&v42.vals, v39))) {
                    v40 = v40 + 0x2::dynamic_field::borrow<u64, Slice<T0>>(v38, *0x1::vector::borrow<u64>(&v42.vals, v39)).size;
                };
                v39 = v39 + 1;
            };
            v39 = 0;
            let v43 = 0x2::dynamic_field::borrow<u64, Slice<u64>>(v38, arg3);
            while (v39 < 0x1::vector::length<T1>(&v24)) {
                if (0x2::dynamic_field::exists_with_type<u64, Slice<u64>>(v38, *0x1::vector::borrow<u64>(&v43.vals, v39))) {
                    v41 = v41 + 0x2::dynamic_field::borrow<u64, Slice<u64>>(v38, *0x1::vector::borrow<u64>(&v43.vals, v39)).size;
                } else if (0x2::dynamic_field::exists_with_type<u64, Slice<T0>>(v38, *0x1::vector::borrow<u64>(&v43.vals, v39))) {
                    v41 = v41 + 0x2::dynamic_field::borrow<u64, Slice<T0>>(v38, *0x1::vector::borrow<u64>(&v43.vals, v39)).size;
                };
                v39 = v39 + 1;
            };
    ...
    fun update_size<T0: store>(arg0: &mut BigVector<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u8) {
        if (arg4 == 2) {
            ...
            let v1 = 0;
            let v2 = 0;
            while (v2 < 0x1::vector::length<u64>(&v0.vals)) {
                v1 = v1 + safe_borrow_size<T0>(arg0, *0x1::vector::borrow<u64>(&v0.vals, v2));
                v2 = v2 + 1;
            };
            let v3 = 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, arg1);
            v2 = 0;
            let v4 = 0;
            while (v2 < 0x1::vector::length<u64>(&v3.vals)) {
                v4 = v4 + safe_borrow_size<T0>(arg0, *0x1::vector::borrow<u64>(&v3.vals, v2));
                v2 = v2 + 1;
            };
            ...
            let v5 = 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, arg2);
            let v6 = 0;
            let v7 = 0;
            let v8 = 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, arg3);
            while (v7 < 0x1::vector::length<u64>(&v5.vals)) {
                if (0x2::dynamic_field::exists_with_type<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v5.vals, v7))) {
                    v6 = v6 + 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v5.vals, v7)).size;
                } else if (0x2::dynamic_field::exists_with_type<u64, Slice<T0>>(&arg0.id, *0x1::vector::borrow<u64>(&v5.vals, v7))) {
                    v6 = v6 + 0x2::dynamic_field::borrow<u64, Slice<T0>>(&arg0.id, *0x1::vector::borrow<u64>(&v5.vals, v7)).size;
                };
                v7 = v7 + 1;
            };
            v7 = 0;
            let v9 = 0;
            while (v7 < 0x1::vector::length<u64>(&v8.vals)) {
                if (0x2::dynamic_field::exists_with_type<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v8.vals, v7))) {
                    v9 = v9 + 0x2::dynamic_field::borrow<u64, Slice<u64>>(&arg0.id, *0x1::vector::borrow<u64>(&v8.vals, v7)).size;
                } else if (0x2::dynamic_field::exists_with_type<u64, Slice<T0>>(&arg0.id, *0x1::vector::borrow<u64>(&v8.vals, v7))) {
                    v9 = v9 + 0x2::dynamic_field::borrow<u64, Slice<T0>>(&arg0.id, *0x1::vector::borrow<u64>(&v8.vals, v7)).size;
                };
                v7 = v7 + 1;
            };
            0x2::dynamic_field::borrow_mut<u64, Slice<u64>>(&mut arg0.id, arg3).size = v9;
            0x2::dynamic_field::borrow_mut<u64, Slice<u64>>(&mut arg0.id, arg2).size = v6;
        };
    }
