module 0x5ed6cff2d8c1f697b3742f0fcc67337bfd33b574ae4382305d2beda28997ef9::vaults {
    ...
    public entry fun remove_v2<T0, T1, T2>(arg0: &VaultsManager, arg1: &mut Vault<T2>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_pool_manager_role(arg0, 0x2::tx_context::sender(arg6));
        assert!(!arg1.is_pause, 6);
        assert!(arg1.status == 1, 17);
        assert!(0x1::vector::length<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg1.positions) == 1, 2);
        total_token_amount<T2>(arg1);
        arg1.liquidity = arg1.liquidity - arg4;
        let (v0, v1) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::remove_liquidity<T0, T1>(arg2, arg3, 0x1::vector::borrow_mut<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&mut arg1.positions, 0), arg4, arg5);
    ...
    public entry fun withdraw_all<T0, T1>(arg0: &VaultsManager, arg1: &mut Vault<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        check_reinvest_role(arg0, 0x2::tx_context::sender(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(take_harvest_asset<T1, T0>(arg1), arg2), 0x2::tx_context::sender(arg2));
    }
