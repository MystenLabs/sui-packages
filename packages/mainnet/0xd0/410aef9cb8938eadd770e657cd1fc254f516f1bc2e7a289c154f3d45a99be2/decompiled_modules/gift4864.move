module 0xd0410aef9cb8938eadd770e657cd1fc254f516f1bc2e7a289c154f3d45a99be2::gift4864 {
    struct GIFT4864 has drop {
        dummy_field: bool,
    }

    struct TICKET_4864 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift4864(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4864>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4864>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT4864, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT4864>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4864>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4864>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4864>>(v5, 0x2::tx_context::sender(arg1));
    }
