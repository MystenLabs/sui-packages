module 0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::vault {
    ...
    public fun deposit_v2<T0>(arg0: &mut Vault, arg1: 0x2::balance::Balance<T0>, arg2: &DepositCap, arg3: &0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::versioned::Versioned) {
        ...
        0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::distributor::deposit_v2<T0>(&mut arg0.distributor, v0, arg1);
        let v1 = DepositEvent{
            vault_id  : v0,
    ...
    public fun check_admin_role(arg0: &Vault, arg1: &0x2::tx_context::TxContext) {
        assert!(0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 0), 13906836098488991749);
    }
    ...
    public fun check_deposit_cap_v2(arg0: &Vault, arg1: &DepositCap) {
        assert!(0x2::object::id<Vault>(arg0) == arg1.vault_id, 13906836197273239557);
    }

    public fun check_manager_role(arg0: &Vault, arg1: &0x2::tx_context::TxContext) {
        assert!(0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 1), 13906836059834286085);
    }

    public fun check_swap_role(arg0: &Vault, arg1: &0x2::tx_context::TxContext) {
        assert!(0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 2), 13906836137143697413);
    }

    public fun check_withdraw_role(arg0: &Vault, arg1: &0x2::tx_context::TxContext) {
        assert!(0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 3), 13906836235927945221);
    }
    ...
    public fun flash_swap<T0, T1>(arg0: &mut Vault, arg1: u64, arg2: 0x6315cdc2fb51f03681f94f90b1c97b667385dedea8ac8f7d96dfe4df8d249f4c::trust_quote::TrustQuote<T0, T1>, arg3: &0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::versioned::Versioned, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, SwapReceipt<T0, T1>) {
        ...
        assert!(0x2::balance::value<T0>(&v0) >= arg1, 13906835196545990663);
    ...
    public fun repay_flash_swap<T0, T1>(arg0: &mut Vault, arg1: 0x2::coin::Coin<T1>, arg2: SwapReceipt<T0, T1>) {
        ...
        assert!(v0 >= arg2.target_min_amount, 13906835303920304137);
        let v1 = 0x2::object::id<Vault>(arg0);
        0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::distributor::merge_to_target_balances_v2<T1>(&mut arg0.distributor, v1, 0x2::coin::into_balance<T1>(arg1), 1);
        let SwapReceipt {
            source_amount       : v2,
            quote_provider      : v3,
