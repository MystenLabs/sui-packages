module 0xd0e33d135d52084249d07734054cdb9003b1ca9876a36c793cc2bcc36ccb66cc::nft {
    struct VS10 has store, key {
        id: 0x2::object::UID,
    ...
    struct VS10MintEvent has copy, drop {
    ...
    public fun transfer(arg0: VS10, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<VS10>(arg0, arg1);
    }

    public fun burn(arg0: VS10, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x2::display::new_with_fields<VS10>(&v0, v3, v5, arg1);
        0x2::display::update_version<VS10>(&mut v7);
        let (v8, v9) = 0x2::transfer_policy::new<VS10>(&v0, arg1);
        let v10 = v9;
        let v11 = v8;
        if (213 > 0) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<VS10>(&mut v11, &v10, 213, 0);
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<VS10>(&mut v11, &v10);
        };
        0x2::transfer::public_share_object<0x2::transfer_policy::TransferPolicy<VS10>>(v11);
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<VS10>>(v10, v1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, v1);
        0x2::transfer::public_transfer<0x2::display::Display<VS10>>(v7, v1);
        0x2::transfer::transfer<AdminCap>(v2, v1);
    }

    public fun mint_to_multiple_destinations(arg0: &AdminCap, arg1: &0x2::transfer_policy::TransferPolicy<VS10>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: bool, arg9: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg10: vector<AnimationUrl>, arg11: vector<address>, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg11)) {
            ...
            if (213 > 0) {
                ...
                let v4 = v3;
                let v5 = v2;
                let v6 = VS10MintEvent{
                    object_id       : 0x2::object::id<VS10>(&v1),
                ...
                0x2::event::emit<VS10MintEvent>(v6);
                0x2::kiosk::lock<VS10>(&mut v5, &v4, arg1, v1);
                ...
                0x2::event::emit<VS10MintEvent>(v7);
                0x2::transfer::public_transfer<VS10>(v1, *0x1::vector::borrow<address>(&arg11, v0));
            };
            v0 = v0 + 1;
        };
    }
    ...
    public fun update_animation_urls(arg0: &AdminCap, arg1: &mut VS10, arg2: vector<AnimationUrl>, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.animation_urls = arg2;
    }

    public fun update_attributes(arg0: &AdminCap, arg1: &mut VS10, arg2: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.attributes = arg2;
    }

    public fun update_background_color(arg0: &AdminCap, arg1: &mut VS10, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.background_color = 0x1::string::utf8(arg2);
    }

    public fun update_description(arg0: &AdminCap, arg1: &mut VS10, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.description = 0x1::string::utf8(arg2);
    }

    public fun update_image_url(arg0: &AdminCap, arg1: &mut VS10, arg2: 0x2::url::Url, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.image_url = arg2;
    }

    public fun update_link(arg0: &AdminCap, arg1: &mut VS10, arg2: 0x2::url::Url, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.link = arg2;
    }

    public fun update_metadata(arg0: &AdminCap, arg1: &mut VS10, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: bool, arg9: 0x2::vec_map::VecMap<0x1::string::String, 0x1::string::String>, arg10: vector<AnimationUrl>, arg11: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_name(arg0: &AdminCap, arg1: &mut VS10, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.name = 0x1::string::utf8(arg2);
    }

    public fun update_thumbnail_url(arg0: &AdminCap, arg1: &mut VS10, arg2: 0x2::url::Url, arg3: &mut 0x2::tx_context::TxContext) {
