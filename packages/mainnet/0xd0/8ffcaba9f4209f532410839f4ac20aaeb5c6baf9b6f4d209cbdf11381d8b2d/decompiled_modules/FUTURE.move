module 0xd08ffcaba9f4209f532410839f4ac20aaeb5c6baf9b6f4d209cbdf11381d8b2d::FUTURE {
    ...
    fun init(arg0: FUTURE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FUTURE>(arg0, 9, b"FUTURE", b"FUTURE", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
