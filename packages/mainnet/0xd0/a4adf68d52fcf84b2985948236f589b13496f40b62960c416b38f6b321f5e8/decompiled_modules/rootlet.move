module 0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::rootlet {
    ...
    public fun admin_mint(arg0: &mut Sale, arg1: &0x2::transfer_policy::TransferPolicy<Rootlet>, arg2: &mut 0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::CollectionData, arg3: &AdminCap, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.active, 9223373007517384703);
        let (v0, v1, v2, v3) = 0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::get_nft(arg2, 0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::nfts_left(arg2) - 1);
        let v4 = if (0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::is_robot(v0)) {
    ...
    fun assert_can_mint(arg0: &Sale, arg1: vector<Pass>, arg2: u64, arg3: u64, arg4: u64) {
        ...
        if (0x1::vector::is_empty<Pass>(&arg1)) {
            ...
            assert!(arg4 > *0x1::vector::borrow<u64>(&arg0.start_times, v4 - 1), 1);
    ...
    fun init(arg0: ROOTLET, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = &mut v8;
        0x1::vector::push_back<0x1::string::String>(v9, 0x1::string::utf8(b"A Whitelist #{whitelist} pass to become a Rootlet!"));
    ...
    entry fun mint(arg0: &mut Sale, arg1: &mut 0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::CollectionData, arg2: vector<Pass>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg6 > 0) {
            let v0 = if (0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::nfts_left(arg1) == 1) {
                0
            } else {
                0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::pseuso_random::rng(0, 0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::nfts_left(arg1) - 1, arg8)
            };
            let (v1, v2, v3, v4) = 0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::get_nft(arg1, v0);
            let v5 = if (0xd0a4adf68d52fcf84b2985948236f589b13496f40b62960c416b38f6b321f5e8::attributes::is_robot(v1)) {
                0x1::string::utf8(b"Robot")
            } else {
                0x1::string::utf8(b"Rootlets")
            };
