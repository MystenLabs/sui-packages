module 0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::registry {
    ...
    public fun assert_output(arg0: &Registry, arg1: u64, arg2: u64) {
        ...
        assert!(0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::safe_math::mul_div_u64(v0, 0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::constants::scaling_pips(), arg1) <= arg0.max_output_delta_pips, 4);
    }
    ...
    public fun assert_price(arg0: &Registry, arg1: u128, arg2: u128) {
        ...
        assert!((0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::safe_math::mul_div_u128(v0, 0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::constants::scaling_pips_u128(), arg1) as u64) <= arg0.max_price_delta_pips, 3);
    }

    public(friend) fun assert_witness<T0>(arg0: &Registry) {
        assert!(arg0.version <= 0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::constants::current_version(), 0);
        let v0 = type_name<T0>();
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            version               : 0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::constants::current_version(),
    ...
    public fun update_fee_configs(arg0: &mut Registry, arg1: vector<vector<u64>>, arg2: vector<u64>, arg3: &AdminCap) {
        ...
        while (v1 < 0x1::vector::length<u64>(&arg2)) {
            ...
            while (v3 < 0x1::vector::length<u64>(v2)) {
                if (!(*0x1::vector::borrow<u64>(v2, v3) < 0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::constants::scaling_pips())) {
                    v4 = false;
                    /* label 9 */
                    assert!(v4, 2);
                    assert!(v0 < *0x1::vector::borrow<u64>(&arg2, v1) && *0x1::vector::borrow<u64>(&arg2, v1) < 0xd00f9cae82c412dc8d928fe733b0033510194f33b956cc2e5ea7063f2776f222::constants::scaling_pips(), 2);
