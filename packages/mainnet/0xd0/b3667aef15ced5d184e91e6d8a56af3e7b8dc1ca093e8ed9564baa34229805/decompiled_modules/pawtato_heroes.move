module 0xd0b3667aef15ced5d184e91e6d8a56af3e7b8dc1ca093e8ed9564baa34229805::pawtato_heroes {
    ...
    fun init(arg0: PAWTATO_HEROES, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"15000 Pawtato Heroes."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreib7bpkdmjggbvnl6cebdwp43w6xs5hgt4fymknnxjpsexvtpcp5we"));
