module 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::marble_racing {
    ...
    struct AddBetEvent has copy, drop {
        ...
        bet_size: u64,
        payout: u64,
        option: vector<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement>,
    ...
    struct RaceConfig has store, key {
        ...
        page_size: u64,
        bet_manager: 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::BetManager,
        max_combo: u8,
    }
    ...
    struct Race has store, key {
        ...
        race_event_id: 0x1::string::String,
        status: u64,
        risk_manager: 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::risk_manager::RiskManager,
        bet_setting: 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::BetSetting,
    ...
    struct BetResult<phantom T0> has copy, drop, store {
        bet_id: 0x2::object::ID,
        player: address,
        bet_options: vector<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement>,
        bet_size: u64,
        bet_returned: u64,
        outcome: vector<u64>,
    }
    ...
    fun remove(arg0: &mut RaceConfig, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::risk_manager::destroy_manager(v4);
    ...
    public fun set_house_edge(arg0: &mut RaceConfig, arg1: &AdminCap, arg2: u64) {
        ...
        0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::set_house_edge(&mut arg0.bet_manager, arg2);
    }
    ...
    public fun add_bet<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut RaceConfig, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<T0>, arg4: vector<u64>, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(0x1::vector::length<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement>(&v1) <= (arg1.max_combo as u64), 6);
        let v2 = 0x2::tx_context::sender(arg6);
        let v3 = 0x2::coin::into_balance<T0>(arg3);
        let v4 = 0x2::balance::value<T0>(&v3);
        let (v5, v6) = 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::get_bet_payout(&arg1.bet_manager, &v0.bet_setting, v4, v1, 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::risk_manager::marble_ids(&v0.risk_manager));
        let v7 = 0x1::type_name::get<T0>();
        0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::risk_manager::add_risk(&mut v0.risk_manager, 0x1::type_name::get<T0>(), v1, v6);
        let v8 = MarbleRacing{dummy_field: false};
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::assert_within_risk<T0, MarbleRacing>(arg0, v8, 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::risk_manager::total_risk(&v0.risk_manager, v7), arg6);
    ...
    public fun create(arg0: 0x1::string::String, arg1: &mut RaceConfig, arg2: vector<u64>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v0 = Race{
            ...
            race_event_id : arg0,
            status        : 0,
            risk_manager  : 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::risk_manager::new_manager(arg2, arg3),
            bet_setting   : 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::new_bet_setting(arg2),
    ...
    fun create_option(arg0: vector<u64>, arg1: vector<u8>) : vector<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement> {
        assert!(0x1::vector::length<u64>(&arg0) == 0x1::vector::length<u8>(&arg1), 10);
        let v0 = 0x1::vector::empty<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0)) {
            0x1::vector::push_back<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement>(&mut v0, 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::new_placement(*0x1::vector::borrow<u64>(&arg0, v1), *0x1::vector::borrow<u8>(&arg1, v1)));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = RaceConfig{
            ...
            page_size   : 200,
            bet_manager : 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::new_bet_manager(),
            max_combo   : 3,
        };
        ...
        while (v7 < v6 && 0x2::linked_table::length<address, vector<BetSlip>>(v1) > 0) {
            ...
            while (v7 < v6 && 0x1::vector::length<BetSlip>(&v10) != 0) {
                ...
                if (v11.coin_type == 0x1::type_name::get<T0>()) {
                    ...
                    let v19 = v17;
                    if (0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::won_bet(v11.option, arg2)) {
                        v3 = v3 + v16;
                    ...
                    while (v21 < 0x1::vector::length<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement>(&v19)) {
                        0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::Placement>(&mut v22, 0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::create_unihouse_placement(*0x1::vector::borrow<0xd0e9a32f2e496f544ac6c7006b0e09040433548cadf6259112659eadaf5853b0::bet_manager::Placement>(&v19, v21)));
                        v21 = v21 + 1;
                    };
