module 0xd01aa7c26dd35b0a46af821c99450b95709007da21ab4e7338b05a69cf273cb7::oracle {
    struct HiveOracle has store, key {
        id: 0x2::object::UID,
        update_cap: 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::TwapUpdateCap,
    ...
    fun calculate_twap(arg0: u256, arg1: u256, arg2: u64) : u256 {
        let v0 = if (arg0 >= arg1) {
            ...
            0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::math::overflow_add_u256(arg0, 0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::math::sub_from_max_u256(arg1))
        };
        v0 / (arg2 as u256)
    }
    ...
    public fun setup_hive_oracle(arg0: 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::TwapUpdateCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = HiveOracle{
    ...
    public fun update_hive_oracle(arg0: &0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::config::HiveDaoCapability, arg1: &mut HiveOracle, arg2: 0x1::option::Option<address>, arg3: 0x1::option::Option<address>, arg4: &0x2::tx_context::TxContext) {
    ...
    public entry fun update_hive_oracle_price<T0, T1, T2, T3, T4, T5>(arg0: &0x2::clock::Clock, arg1: &mut HiveOracle, arg2: &mut 0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::HiveManager, arg3: &0xd01aa7c26dd35b0a46af821c99450b95709007da21ab4e7338b05a69cf273cb7::two_pool::LiquidityPool<T0, T1, T4>, arg4: &0xd01aa7c26dd35b0a46af821c99450b95709007da21ab4e7338b05a69cf273cb7::two_pool::LiquidityPool<T2, T3, T5>, arg5: &0x2::tx_context::TxContext) {
        ...
        let v2 = 0xd01aa7c26dd35b0a46af821c99450b95709007da21ab4e7338b05a69cf273cb7::two_pool::get_liquidity_pool_id<T2, T3, T5>(arg4);
        assert!(0x2::object::id_to_address(&v2) == *0x1::option::borrow<address>(&arg1.sui_hive_pool_addr), 1974);
        let v3 = 0xd01aa7c26dd35b0a46af821c99450b95709007da21ab4e7338b05a69cf273cb7::two_pool::get_liquidity_pool_id<T0, T1, T4>(arg3);
        assert!(0x2::object::id_to_address(&v3) == *0x1::option::borrow<address>(&arg1.usdc_sui_pool_addr), 1974);
        let (_, v5, _) = 0xd01aa7c26dd35b0a46af821c99450b95709007da21ab4e7338b05a69cf273cb7::two_pool::get_pool_cumulative_prices<T2, T3, T5>(arg4);
        let (_, v8, _) = 0xd01aa7c26dd35b0a46af821c99450b95709007da21ab4e7338b05a69cf273cb7::two_pool::get_pool_cumulative_prices<T0, T1, T4>(arg3);
        ...
        assert!(v25 > 0, 1975);
        0xa6e20989ee96243767dbed744febdcab8083727880b4bb46a8efcf6f9afa54a2::hive_profile::update_hive_twap_info(&arg1.update_cap, arg0, arg2, v24, v25, 0xdc1e7c5db31e34a2b39ac70c5c5343f0ac82151725063d7b0447898731f8516e::math::mul_div_u256(v24, v25, (1000000000000000000 as u256)));
