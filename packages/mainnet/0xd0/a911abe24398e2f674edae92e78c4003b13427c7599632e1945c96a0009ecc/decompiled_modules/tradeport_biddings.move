module 0xd0a911abe24398e2f674edae92e78c4003b13427c7599632e1945c96a0009ecc::tradeport_biddings {
    ...
    struct MuiltiBid has store, key {
        id: 0x2::object::UID,
        buyer: address,
    ...
    fun accept_bid<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &Store, arg2: SingleBid, arg3: &T0, arg4: 0x1::option::Option<0x2::object::ID>) {
        ...
        assert!(arg2.nft_type == *0x1::type_name::borrow_string(&v0), 7);
        if (0x1::option::is_some<0x2::object::ID>(&arg2.maybe_nft_id)) {
            assert!(0x2::object::id<T0>(arg3) == 0x1::option::extract<0x2::object::ID>(&mut arg2.maybe_nft_id), 7);
        };
        if (0x1::option::is_some<vector<u8>>(&arg2.maybe_nft_bcs)) {
            assert!(0x1::bcs::to_bytes<T0>(arg3) == 0x1::option::extract<vector<u8>>(&mut arg2.maybe_nft_bcs), 8);
        };
        if (0x1::option::is_some<u64>(&arg2.maybe_expire_at)) {
            assert!(0x2::clock::timestamp_ms(arg0) <= 0x1::option::extract<u64>(&mut arg2.maybe_expire_at), 6);
        };
    ...
    public fun accept_bid_with_transfer_policy<T0: store + key>(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x2::object::ID, arg3: 0x1::option::Option<0x2::object::ID>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg8: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(&v0.balance) == v0.price + v0.fee + v0.royalty, 9);
        let v1 = v0.price;
        let v2 = 0;
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::Rule>(arg7)) {
            ...
            v2 = v3;
            if (v3 != v0.royalty) {
                v2 = 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::fee_amount<T0>(arg7, v0.price);
                v1 = 0;
            };
        };
        assert!(v2 <= v0.royalty, 5);
        if (v1 == 0) {
            assert!(!0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::floor_price_rule::Rule>(arg7), 5);
        };
    ...
    public fun cancel_multi_bid(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, MuiltiBid>(&arg0.id, arg1), 4);
        let v0 = 0x2::dynamic_object_field::remove<0x2::object::ID, MuiltiBid>(&mut arg0.id, arg1);
        assert!(v0.buyer == 0x2::tx_context::sender(arg2) || arg0.admin == 0x2::tx_context::sender(arg2), 2);
        let v1 = CancelMultiBidEvent{
            multi_bid_id : 0x2::object::id<MuiltiBid>(&v0),
            buyer        : v0.buyer,
    ...
    fun create_bid<T0: store + key>(arg0: &mut Store, arg1: u64, arg2: address, arg3: 0x1::option::Option<0x2::object::ID>, arg4: 0x1::option::Option<0x2::object::ID>, arg5: 0x1::option::Option<vector<u8>>, arg6: 0x1::option::Option<u64>, arg7: u64, arg8: u64, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<0x2::object::ID>(&arg3)) {
            ...
            assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, MuiltiBid>(&arg0.id, v5), 4);
            let v6 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, MuiltiBid>(&mut arg0.id, v5);
            ...
            if (0x2::coin::value<0x2::sui::SUI>(&arg9) > 0) {
                ...
                let v7 = UpdateMultiBidEvent{
                    multi_bid_id : 0x2::object::id<MuiltiBid>(v6),
                    buyer        : v6.buyer,
            ...
            assert!(0x2::balance::value<0x2::sui::SUI>(&v6.balance) >= arg7 + v2 + arg8, 9);
            ...
            assert!(0x1::option::is_none<u64>(&arg6), 7);
            assert!(0x2::coin::value<0x2::sui::SUI>(&arg9) == arg7 + v2 + arg8, 9);
    ...
    public fun create_multi_bid(arg0: &mut Store, arg1: 0x1::option::Option<0x1::ascii::String>, arg2: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        let v0 = MuiltiBid{
        ...
        let v1 = CreateMultiBidEvent{
            multi_bid_id : 0x2::object::id<MuiltiBid>(&v0),
            buyer        : v0.buyer,
            maybe_name   : arg1,
            balance      : 0,
        };
        0x2::event::emit<CreateMultiBidEvent>(v1);
        0x2::dynamic_object_field::add<0x2::object::ID, MuiltiBid>(&mut arg0.id, 0x2::object::id<MuiltiBid>(&v0), v0);
    }
    ...
    fun get_bid(arg0: &mut Store, arg1: 0x2::object::ID, arg2: 0x1::option::Option<0x2::object::ID>, arg3: bool) : SingleBid {
        ...
        if (0x1::option::is_some<0x2::object::ID>(&arg2)) {
            ...
            assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, MuiltiBid>(&arg0.id, v1), 4);
            let v2 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, MuiltiBid>(&mut arg0.id, v1);
            assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SingleBid>(&v2.id, arg1), 4);
            let v3 = 0x2::dynamic_object_field::remove<0x2::object::ID, SingleBid>(&mut v2.id, arg1);
            if (arg3) {
                let v4 = v3.price + v3.fee + v3.royalty;
                assert!(0x2::balance::value<0x2::sui::SUI>(&v2.balance) >= v4, 9);
                0x2::balance::join<0x2::sui::SUI>(&mut v3.balance, 0x2::balance::split<0x2::sui::SUI>(&mut v2.balance, v4));
                let v5 = UpdateMultiBidEvent{
                    multi_bid_id : 0x2::object::id<MuiltiBid>(v2),
                    buyer        : v2.buyer,
            ...
            assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SingleBid>(&arg0.id, arg1), 4);
    ...
    public fun update_multi_bid(arg0: &mut Store, arg1: 0x2::object::ID, arg2: 0x1::option::Option<0x1::ascii::String>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        verify_version(arg0);
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, MuiltiBid>(&arg0.id, arg1), 4);
        let v0 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, MuiltiBid>(&mut arg0.id, arg1);
        assert!(v0.buyer == 0x2::tx_context::sender(arg4), 2);
        if (0x1::option::is_some<0x1::ascii::String>(&arg2)) {
            v0.maybe_name = arg2;
        };
        0x2::coin::put<0x2::sui::SUI>(&mut v0.balance, arg3);
        let v1 = UpdateMultiBidEvent{
            multi_bid_id : 0x2::object::id<MuiltiBid>(v0),
            buyer        : v0.buyer,
            maybe_name   : v0.maybe_name,
            balance      : 0x2::balance::value<0x2::sui::SUI>(&v0.balance),
        };
        0x2::event::emit<UpdateMultiBidEvent>(v1);
    }
