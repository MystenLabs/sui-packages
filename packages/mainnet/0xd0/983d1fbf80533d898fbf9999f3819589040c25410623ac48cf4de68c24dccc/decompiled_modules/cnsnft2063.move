module 0xd0983d1fbf80533d898fbf9999f3819589040c25410623ac48cf4de68c24dccc::cnsnft2063 {
    struct CNSNFT2063 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2063, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2063>(arg0, arg1);
