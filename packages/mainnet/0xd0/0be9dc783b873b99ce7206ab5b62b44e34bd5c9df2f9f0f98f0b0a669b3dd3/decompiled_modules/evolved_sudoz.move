module 0xd00be9dc783b873b99ce7206ab5b62b44e34bd5c9df2f9f0f98f0b0a669b3dd3::evolved_sudoz {
    ...
    fun init(arg0: EVOLVED_SUDOZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::transfer<EvolvedAdminCap>(v5, @0xf1df42d3b603f6d22fc276c25dd1eee4c3f767d7a7e7ec36bf9c3d416a74e228);
    ...
    public entry fun mint_and_lock_to_kiosk(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<EvolvedSudoz>, arg4: u64, arg5: &mut EvolvedStats, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 == @0xf1df42d3b603f6d22fc276c25dd1eee4c3f767d7a7e7ec36bf9c3d416a74e228 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        assert!(arg5.evolved_minted < 5555, 0);
        assert!(arg4 >= 1 && arg4 <= 5555, 2);
        let v1 = &mut arg5.available_metadata_ids;
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg4));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Number"), u64_to_string(v2));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve - Locked"));
        ...
        0x2::kiosk::lock<EvolvedSudoz>(arg1, arg2, arg3, v11);
    ...
    public entry fun mint_developer_reserve_batch(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: &mut EvolvedStats, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        while (v3 < arg2) {
            let v4 = 0x1::vector::swap_remove<u64>(&mut arg3.available_metadata_ids, 0x2::random::generate_u64_in_range(&mut v2, 0, 0x1::vector::length<u64>(&arg3.available_metadata_ids) - 1));
            let v5 = arg3.evolved_minted + 1;
            let v6 = 0x1::string::utf8(b"Unknown");
            let v7 = 0x1::string::utf8(b"Unknown");
            let v8 = 0x1::string::utf8(b"Unknown");
            let v9 = 0x1::string::utf8(b"Unknown");
            ...
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v13, 0x1::string::utf8(b"Metadata ID"), u64_to_string(v4));
            ...
            let v14 = EvolvedSudoz{
                ...
                name                     : build_evolved_name(v4),
                description              : 0x1::string::utf8(b"An evolved form of the SUDOZ artifact with unique traits"),
                image_url                : 0x2::url::new_unsafe(0x1::string::to_ascii(get_evolved_url(v4))),
                number                   : v5,
                metadata_id              : v4,
                original_artifact_number : 0,
                original_path            : 0,
    ...
    public entry fun mint_developer_reserve_batch_to_kiosk_with_traits(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<EvolvedSudoz>, arg4: u64, arg5: &mut EvolvedStats, arg6: &0x2::random::Random, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(v0 == @0xf1df42d3b603f6d22fc276c25dd1eee4c3f767d7a7e7ec36bf9c3d416a74e228 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        assert!(arg4 > 0 && arg4 <= 50, 4);
        assert!(arg5.evolved_minted + arg4 <= 5555, 0);
        ...
        while (v2 < arg4) {
            let v3 = 0x1::vector::swap_remove<u64>(&mut arg5.available_metadata_ids, 0x2::random::generate_u64_in_range(&mut v1, 0, 0x1::vector::length<u64>(&arg5.available_metadata_ids) - 1));
            let v4 = arg5.evolved_minted + 1;
            let v5 = generate_traits_from_metadata_id(v3);
            let v6 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Background"), v5.background);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Skin"), v5.skin);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Clothes"), v5.clothes);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Hats"), v5.hats);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Eyewear"), v5.eyewear);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Mouth"), v5.mouth);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Earrings"), v5.earrings);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Metadata ID"), u64_to_string(v3));
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Number"), u64_to_string(v4));
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v6, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve"));
            let v7 = EvolvedSudoz{
                id                       : 0x2::object::new(arg7),
                name                     : build_evolved_name(v3),
                description              : 0x1::string::utf8(b"An evolved form of the SUDOZ artifact with unique traits"),
                ...
                eyewear                  : v5.eyewear,
                mouth                    : v5.mouth,
                earrings                 : v5.earrings,
                attributes               : v6,
            };
            arg5.evolved_minted = arg5.evolved_minted + 1;
            0x2::kiosk::lock<EvolvedSudoz>(arg1, arg2, arg3, v7);
            let v8 = EvolvedMinted{
                evolved_id               : 0x2::object::id<EvolvedSudoz>(&v7),
                recipient                : 0x2::tx_context::sender(arg7),
                number                   : v4,
                metadata_id              : v3,
                original_artifact_number : 0,
    ...
    public entry fun mint_developer_reserve_one_of_ones(arg0: &EvolvedAdminCap, arg1: address, arg2: &mut EvolvedStats, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v3 < 0x1::vector::length<u64>(&v1)) {
            ...
            let v5 = &mut arg2.available_metadata_ids;
            assert!(remove_specific_metadata_id(v5, v4), 3);
            let v6 = arg2.evolved_minted + 1;
            let v7 = 0x1::string::utf8(b"AI Generated");
            let v8 = 0x1::string::utf8(b"1/1 Exclusive");
            let v9 = 0x1::string::utf8(b"Special Edition");
            let v10 = 0x1::string::utf8(b"One of One");
            let v11 = 0x1::string::utf8(b"Unique");
            let v12 = 0x1::string::utf8(b"Limited");
            let v13 = 0x1::string::utf8(b"AI 1/1S");
            let v14 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Background"), v7);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Skin"), v8);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Clothes"), v9);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Hats"), v10);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Eyewear"), v11);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Mouth"), v12);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Earrings"), v13);
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Metadata ID"), u64_to_string(v4));
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Number"), u64_to_string(v6));
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v14, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve - 1/1"));
            let v15 = EvolvedSudoz{
            ...
            let v16 = 0x2::object::id<EvolvedSudoz>(&v15);
            arg2.evolved_minted = arg2.evolved_minted + 1;
            0x1::vector::push_back<0x2::object::ID>(&mut v2, v16);
            let v17 = EvolvedMinted{
                evolved_id               : v16,
                recipient                : arg1,
                number                   : v6,
                metadata_id              : v4,
            ...
            0x2::event::emit<EvolvedMinted>(v17);
            0x2::transfer::public_transfer<EvolvedSudoz>(v15, arg1);
            v3 = v3 + 1;
        };
    }
    ...
    public entry fun mint_developer_reserve_specific(arg0: &EvolvedAdminCap, arg1: address, arg2: u64, arg3: &mut EvolvedStats, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut arg3.available_metadata_ids;
        assert!(remove_specific_metadata_id(v1, arg2), 3);
        let v2 = arg3.evolved_minted + 1;
        let (v3, v4, v5, v6, v7, v8, v9) = if (is_one_of_one(arg2)) {
        ...
        let v10 = 0x2::vec_map::empty<0x1::string::String, 0x1::string::String>();
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Background"), v3);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Skin"), v9);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Clothes"), v4);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Hats"), v7);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Eyewear"), v6);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Mouth"), v8);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Earrings"), v5);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg2));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Number"), u64_to_string(v2));
        if (is_one_of_one(arg2)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve - 1/1"));
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve"));
        };
        let v11 = EvolvedSudoz{
        ...
        0x2::event::emit<EvolvedMinted>(v12);
        0x2::transfer::public_transfer<EvolvedSudoz>(v11, arg1);
    }
    ...
    public entry fun mint_developer_reserve_to_kiosk(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: u64, arg4: &mut EvolvedStats, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = &mut arg4.available_metadata_ids;
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Mouth"), v8);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Earrings"), v9);
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg3));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Number"), u64_to_string(v2));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v10, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve"));
        let v11 = EvolvedSudoz{
            id                       : 0x2::object::new(arg5),
        ...
        0x2::kiosk::place<EvolvedSudoz>(arg1, arg2, v11);
        let v12 = EvolvedMinted{
            evolved_id               : 0x2::object::id<EvolvedSudoz>(&v11),
    ...
    public entry fun mint_developer_reserve_to_kiosk_with_traits(arg0: &EvolvedAdminCap, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<EvolvedSudoz>, arg4: u64, arg5: &mut EvolvedStats, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(v0 == @0xf1df42d3b603f6d22fc276c25dd1eee4c3f767d7a7e7ec36bf9c3d416a74e228 || v0 == @0x9a5b0ad3a18964ab7c0dbf9ab4cdecfd6b3899423b47313ae6e78f4b801022a3, 1);
        assert!(arg5.evolved_minted < 5555, 0);
        assert!(arg4 >= 1 && arg4 <= 5555, 2);
        ...
        assert!(remove_specific_metadata_id(v1, arg4), 3);
        let v2 = arg5.evolved_minted + 1;
        let v3 = generate_traits_from_metadata_id(arg4);
        ...
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v4, 0x1::string::utf8(b"Metadata ID"), u64_to_string(arg4));
        0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v4, 0x1::string::utf8(b"Number"), u64_to_string(v2));
        if (is_one_of_one(arg4)) {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v4, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve - 1/1"));
        } else {
            0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v4, 0x1::string::utf8(b"Type"), 0x1::string::utf8(b"Developer Reserve"));
        };
        let v5 = EvolvedSudoz{
            id                       : 0x2::object::new(arg6),
            name                     : build_evolved_name(arg4),
        ...
        arg5.evolved_minted = arg5.evolved_minted + 1;
        0x2::kiosk::lock<EvolvedSudoz>(arg1, arg2, arg3, v5);
