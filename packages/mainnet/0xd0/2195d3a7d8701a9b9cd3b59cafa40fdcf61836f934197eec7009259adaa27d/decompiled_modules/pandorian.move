module 0xd02195d3a7d8701a9b9cd3b59cafa40fdcf61836f934197eec7009259adaa27d::pandorian {
    ...
    struct Pandorian has store, key {
        ...
        description: 0x1::string::String,
        url: 0x2::url::Url,
        attributes: 0xd02195d3a7d8701a9b9cd3b59cafa40fdcf61836f934197eec7009259adaa27d::attributes::Attributes,
    }
    ...
    fun init(arg0: PANDORIAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xd02195d3a7d8701a9b9cd3b59cafa40fdcf61836f934197eec7009259adaa27d::collection::display(&v0, arg1);
        ...
        0x2::transfer::public_share_object<0xd02195d3a7d8701a9b9cd3b59cafa40fdcf61836f934197eec7009259adaa27d::collection::Collection>(0xd02195d3a7d8701a9b9cd3b59cafa40fdcf61836f934197eec7009259adaa27d::collection::new(arg1));
    }
    ...
    public(friend) fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: vector<0x1::ascii::String>, arg4: vector<0x1::ascii::String>, arg5: &mut 0x2::tx_context::TxContext) : Pandorian {
        let v0 = Pandorian{
            ...
            attributes  : 0xd02195d3a7d8701a9b9cd3b59cafa40fdcf61836f934197eec7009259adaa27d::attributes::new_from_vec(arg3, arg4),
        };
