module 0xd0432a16846c8034083a080d5c3f22fe679ec3e65a0b595b1e1b50ee0f9bffd7::chop_locker {
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = calculate_apy(v1);
        let v4 = calculate_adjusted_reward_rate(calculate_base_reward_rate(v1, v3), 0x2::balance::value<T0>(&arg0.reward_balance), arg0.total_rewards_added_by_admin);
        let v5 = v0 * v4 / 1000000000;
        let v6 = v0 * v4 / 1000000000;
        let v7 = arg0.total_weighted_stake + v6;
        let v8 = if (v7 > 0) {
            v6 * 0x2::balance::value<T0>(&arg0.reward_balance) / v7
        } else {
        ...
        assert!(v9 <= 0x2::balance::value<T0>(&arg0.reward_balance), 11);
        let v10 = &mut arg0.reward_balance;
        let v11 = withdraw_from_balance<T0>(v10, v9, arg5);
        arg0.total_weighted_stake = v7;
        let v12 = Lock<T0>{
        ...
        0x2::transfer::transfer<Lock<T0>>(v12, 0x2::tx_context::sender(arg5));
    }
