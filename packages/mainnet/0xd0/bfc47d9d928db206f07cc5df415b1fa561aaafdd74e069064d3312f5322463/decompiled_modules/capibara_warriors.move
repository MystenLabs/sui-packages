module 0xd0bfc47d9d928db206f07cc5df415b1fa561aaafdd74e069064d3312f5322463::capibara_warriors {
    ...
    fun init(arg0: CAPIBARA_WARRIORS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CAPIBARA_WARRIORS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Capibara Warriors"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Cto2XGiZ26PEqcPtsSC-sibK3euM6aydS8v7Wp2aCk0"));
