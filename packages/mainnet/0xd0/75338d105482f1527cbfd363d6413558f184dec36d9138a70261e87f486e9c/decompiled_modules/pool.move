module 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool {
    ...
    fun create_pool_internal<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u8, arg6: vector<u8>, arg7: vector<u8>, arg8: u8, arg9: vector<u8>, arg10: u32, arg11: u64, arg12: u128, arg13: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::verify_version(arg1);
        let v0 = if (0x1::vector::length<u8>(&arg3) == 0) {
        ...
        let v2 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::tick_math::get_tick_at_sqrt_price(arg12);
        let v3 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::utils::get_type_string<T0>();
        let v4 = 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::utils::get_type_string<T1>();
        assert!(v3 != v4, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::errors::invalid_coins());
        let v5 = Pool<T0, T1>{
            id                       : v1,
            ...
            current_tick_index       : v2,
            liquidity                : 0,
            reward_infos             : 0x1::vector::empty<PoolRewardInfo>(),
            is_paused                : false,
            icon_url                 : 0x1::string::utf8(v0),
            position_index           : 0,
            sequence_number          : 0,
        };
        0x2::dynamic_field::add<0x1::string::String, address>(&mut v5.id, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::constants::manager(), 0x2::tx_context::sender(arg13));
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::events::emit_pool_created_event(0x2::object::uid_to_inner(&v1), v3, 0x1::string::utf8(arg4), arg5, 0x1::string::utf8(arg6), v4, 0x1::string::utf8(arg7), arg8, 0x1::string::utf8(arg9), arg12, v2, arg10, arg11, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::constants::protocol_fee_share());
        v5
    }
    ...
    public fun get_pool_name<T0, T1>(arg0: &Pool<T0, T1>) : 0x1::string::String {
        arg0.name
    }
    ...
    public(friend) fun set_pool_icon_url<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x1::string::String) {
        assert!(arg0.icon_url != arg1, 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::errors::same_value_provided());
        arg0.icon_url = arg1;
        let v0 = increase_sequence_number<T0, T1>(arg0);
        0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::events::emit_pool_icon_url_update_event(0x2::object::uid_to_inner(&arg0.id), arg1, v0);
    }
