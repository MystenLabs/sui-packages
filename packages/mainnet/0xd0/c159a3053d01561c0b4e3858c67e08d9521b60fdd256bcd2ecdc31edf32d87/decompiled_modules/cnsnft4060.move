module 0xd0c159a3053d01561c0b4e3858c67e08d9521b60fdd256bcd2ecdc31edf32d87::cnsnft4060 {
    struct CNSNFT4060 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4060, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4060>(arg0, arg1);
