module 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::reward_manager {
    ...
    public(friend) fun deposit_reward<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<T0>) : u64 {
        ...
        if (!0x2::table::contains<0x1::type_name::TypeName, u128>(&arg0.available_balance, v0)) {
            ...
            if (v3) {
                abort 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::error::available_balance_overflow()
            };
    ...
    public(friend) fun emergent_withdraw<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!((arg2 as u128) << 64 <= *0x2::table::borrow<0x1::type_name::TypeName, u128>(&arg0.available_balance, v0), 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::error::incorrect_withdraw_amount());
    ...
    public(friend) fun settle(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: u64) {
        ...
        assert!(v0 <= arg3, 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::error::invalid_time());
    ...
    public(friend) fun update_emission<T0>(arg0: &mut RewarderManager, arg1: 0x2::object::ID, arg2: u64, arg3: u128, arg4: u64) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x1::vector::contains<0x1::type_name::TypeName>(&arg0.types, &v0), 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::error::incentive_reward_not_found());
        settle(arg0, arg1, arg2, arg4);
        if (arg3 > 0) {
            assert!(0x2::table::contains<0x1::type_name::TypeName, u128>(&arg0.available_balance, v0) && *0x2::table::borrow<0x1::type_name::TypeName, u128>(&arg0.available_balance, v0) >= 0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_shr((86400 as u128) << 64, arg3, 64), 0x4ddf9276519dee634ec187b09dedc5d6627f8c578cbacb3c91bbca7dd73aab50::error::insufficient_incentive_balance());
        };
