module 0xd0a74b008fc0e948951033556545d32a6aeea090706afd4262d943c25fb748f7::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T001973", b"Test 001973", b"Integration test token 2025-10-28T00:40:01.973Z", 0x1::option::none<0x2::url::Url>(), arg1);
