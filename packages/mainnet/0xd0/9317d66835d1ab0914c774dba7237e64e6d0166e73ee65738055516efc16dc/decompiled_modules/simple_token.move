module 0xd09317d66835d1ab0914c774dba7237e64e6d0166e73ee65738055516efc16dc::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"dog.png", b"dog.png", b"Official token on sui. Banner, ads and boost on dexscreener.", 0x1::option::none<0x2::url::Url>(), arg1);
