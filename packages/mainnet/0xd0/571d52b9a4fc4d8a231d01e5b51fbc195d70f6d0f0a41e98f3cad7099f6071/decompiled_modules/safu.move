module 0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::safu {
    ...
    entry fun hotfix_vault_5<T0>(arg0: &0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::Version, arg1: &mut Registry, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::tx_context::TxContext) {
        0x8e4f745b9c0748d24d3c4248658a385822c5ae6c38dba4d8739ad2389a14529f::version::verify(arg0, arg3);
        let v0 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.id, 5);
        assert!(0x2::coin::value<T0>(&arg2) == 612, 0);
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"deposit_balance")), 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::type_name::get<T0>()), 9));
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::ascii::String, 0x2::balance::Balance<T0>>(&mut v0.id, 0x1::ascii::string(b"deposit_balance")), 0x2::coin::into_balance<T0>(arg2));
    }
