module 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_machine {
    ...
    struct Store has store, key {
        ...
        vaults: 0x2::table::Table<0x1::string::String, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::GachaVault<Card>>,
        pack_index: u128,
    ...
    entry fun burn_card_in_vault(arg0: &mut Store, arg1: 0x1::string::String, arg2: 0x2::object::ID, arg3: &0x2::tx_context::TxContext) {
        ...
        let Card {
            ...
            media_url   : _,
            attributes  : _,
        } = 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::remove_by_id<Card>(0x2::table::borrow_mut<0x1::string::String, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::GachaVault<Card>>(&mut arg0.vaults, arg1), arg2);
    ...
    fun buy_packs(arg0: &0x2::random::Random, arg1: &mut Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: 0x1::string::String, arg5: u64, arg6: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::table::borrow_mut<0x1::string::String, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg4);
        while (arg5 > 0) {
            let v6 = 0;
            let v7 = arg1.pack_index + 1;
            let v8 = 0x1::vector::empty<0x2::object::ID>();
            while (v6 < v3.pack_size) {
                let v9 = 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::remove_by_index<Card>(v5, 0x2::random::generate_u64_in_range(v1, 0, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::length<Card>(v5) - 1));
    ...
    fun init(arg0: GACHA_MACHINE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Card>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Test Gacha Collection"));
        0x2::display::add<Card>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This a test collection"));
        ...
        let v5 = Store{
            ...
            vaults              : 0x2::table::new<0x1::string::String, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::GachaVault<Card>>(arg1),
            pack_index          : 0,
            transfer_policy     : v2,
    ...
    entry fun mint_card(arg0: &mut Store, arg1: vector<u8>, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: vector<0x1::string::String>, arg7: vector<0x1::string::String>, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<0x1::string::String, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::GachaVault<Card>>(&arg0.vaults, arg2)) {
            0x2::table::add<0x1::string::String, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::GachaVault<Card>>(&mut arg0.vaults, arg2, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::new<Card>(arg8));
        };
        let v1 = CardMinted{
        ...
        0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::add<Card>(0x2::table::borrow_mut<0x1::string::String, 0xd04b672f9f2c71674f373ab309d9e20bf3bc4f8ca7539beadf07db775438a983::gacha_vault::GachaVault<Card>>(&mut arg0.vaults, arg2), v0);
    }
