module 0xd0c5bde7b4d6dcd82b51ec077e52811c3666a9607ac1069990ea64bbef06cf2b::pyth {
    ...
    public fun add(arg0: &mut 0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::Oracle, arg1: &0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_market_authority::MarketCap, arg2: vector<u8>, arg3: u256, arg4: u64) {
        assert!(0x1::vector::length<u8>(&arg2) == 32, 13835058652282945542);
        assert!(arg3 != 0 && arg4 != 0, 13836466031461990414);
        0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::add(arg0, arg1, 0x1::type_name::with_defining_ids<PythFeed>());
        ...
        0x2::dynamic_field::add<PythConfigKey, PythConfig>(0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::uid_mut(arg0, arg1), v0, v1);
        let v2 = PythConfigSet{
            oracle         : 0x2::object::id<0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::Oracle>(arg0),
            feed_id        : arg2,
            max_confidence : arg3,
            max_age_secs   : arg4,
        };
    ...
    public fun remove(arg0: &mut 0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::Oracle, arg1: &0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_market_authority::MarketCap) {
        0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::remove(arg0, arg1, 0x1::type_name::with_defining_ids<PythFeed>());
        let v0 = PythConfigKey{dummy_field: false};
        let PythConfig {
            feed_id        : v1,
            max_confidence : v2,
            max_age_secs   : v3,
        } = 0x2::dynamic_field::remove<PythConfigKey, PythConfig>(0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::uid_mut(arg0, arg1), v0);
    ...
    public fun report(arg0: &0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::Oracle, arg1: &mut 0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::Request, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) {
        assert!(0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::request_oracle_id(arg1) == 0x2::object::id<0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::Oracle>(arg0), 13836184363211620364);
        let v0 = PythConfigKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow<PythConfigKey, PythConfig>(0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::uid(arg0), v0);
        ...
        0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::report<PythFeed>(arg1, v8, 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_timestamp(&v4) * 1000, (v7 as u128), 18);
    }
    ...
    public fun update_config(arg0: &mut 0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::Oracle, arg1: &0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_market_authority::MarketCap, arg2: u256, arg3: u64) {
        assert!(arg2 != 0 && arg3 != 0, 13836466113066369038);
        let v0 = PythConfigKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<PythConfigKey, PythConfig>(0x35bb2811abb1378bcac0b35e56064745a13015d50d16548c70a7e873920d67b7::su_oracle::uid_mut(arg0, arg1), v0);
