module 0xd07a0af8aa6605f06c178968ffc6bbcf4775a8dcc9abca00950dbd4061d6bb72::sswp {
    ...
    fun init(arg0: SSWP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<SSWP>>(0x2::coin::from_balance<SSWP>(0x2::balance::increase_supply<SSWP>(&mut v2, 10000000000000000000), arg1), 0x2::tx_context::sender(arg1));
