module 0xd0035491d1aec0ecc533b08f57a0bc69dbd1c19cd71bf3ea8be6da53f52a238f::lottery {
    ...
    struct Lottery has key {
        id: 0x2::object::UID,
        admin: address,
        fee_pool: 0x2::balance::Balance<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>,
    ...
    entry fun collect_revenue(arg0: &mut Lottery, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg1) == arg0.admin, 0);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>>(0x2::coin::take<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>(&mut arg0.fee_pool, 0x2::balance::value<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>(&arg0.fee_pool), arg1), arg0.admin);
    }

    entry fun deposit_prize(arg0: &mut Lottery, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.admin, 0);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.prize_pool, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
        let v0 = PrizeDeposited{amount: 0x2::coin::value<0x2::sui::SUI>(&arg1)};
    ...
    entry fun distribute_prize(arg0: &mut Lottery, arg1: &mut LotClock, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        if (v1 > 0) {
            let v4 = 0x2::balance::value<0x2::sui::SUI>(&arg0.prize_pool) / v1;
            v2 = v4;
            v3 = v4 * v1;
            let v5 = 0;
            while (v5 < v1) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.prize_pool, v4, arg3), *0x1::vector::borrow<address>(&v0, v5));
                v5 = v5 + 1;
            };
            let v6 = WinnersDrawn{
    ...
    entry fun draw_winning_numbers(arg0: &mut Lottery, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (0x1::vector::length<u64>(&v1) < 3) {
            0x1::vector::push_back<u64>(&mut v1, 0x2::random::generate_u64_in_range(&mut v0, 1, 25 + 1));
        };
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Lottery{
            ...
            fee_pool            : 0x2::balance::zero<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>(),
    ...
    entry fun purchase_ticket(arg0: &mut Lottery, arg1: vector<u64>, arg2: 0x2::coin::Coin<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>, arg3: &0x2::tx_context::TxContext) {
        assert!(arg0.is_open_for_entries, 1);
        assert!(0x2::coin::value<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>(&arg2) == 10000, 4);
        validate_ticket_numbers(&arg1);
        0x2::balance::join<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>(&mut arg0.fee_pool, 0x2::coin::into_balance<0xc7f1f37f32f9c539426e10fa6ff1fd1be45b94573f83f8a72e54cdc7072735be::pui::PUI>(arg2));
