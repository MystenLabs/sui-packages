module 0xd0e1135963743ecc12a02b44b3b961f7c9a87720f683fba23299d910067d6081::movexnft9758 {
    struct MOVEXNFT9758 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT9758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://jyzaru180.vercel.app/api/{id}"));
        ...
        let v4 = 0x2::package::claim<MOVEXNFT9758>(arg0, arg1);
