module 0xd0d5823698eadbe8f632c3606ba5277c5980052567e61da7432e5db369c4fb2b::PYTHIA {
    struct PYTHIA has drop {
        dummy_field: bool,
    }

    fun init(arg0: PYTHIA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<PYTHIA>(arg0, 2, b"PYTHIA", b"PYTHIA", b"PYTHIA", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/r_-9alwox7DzkJwzKJw7YzoBEoBA5vXz2YjgjQFqkwY?ext=png")), arg1);
