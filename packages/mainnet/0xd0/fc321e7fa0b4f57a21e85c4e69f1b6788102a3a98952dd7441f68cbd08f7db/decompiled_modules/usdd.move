module 0xd0fc321e7fa0b4f57a21e85c4e69f1b6788102a3a98952dd7441f68cbd08f7db::usdd {
    ...
    fun init(arg0: USDD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://gateway.irys.xyz/8Dr2k3CnpsVnVQKtKNWpZETqYGUfCMVPZS8Dquk9b6Um                                                                                                                                                                                                                                                           ");
