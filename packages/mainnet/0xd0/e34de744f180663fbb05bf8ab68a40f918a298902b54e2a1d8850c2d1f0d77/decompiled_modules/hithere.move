module 0xd0e34de744f180663fbb05bf8ab68a40f918a298902b54e2a1d8850c2d1f0d77::hithere {
    struct HITHERE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: HITHERE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<HITHERE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Hithere"));
