module 0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::mtoken {
    ...
    public fun cc_receive<T0>(arg0: &mut State<T0>, arg1: &MessengerCap, arg2: vector<u8>, arg3: &0x2::deny_list::DenyList, arg4: &mut 0x2::tx_context::TxContext) : (address, 0x1::option::Option<0x2::coin::Coin<T0>>) {
        ...
        let v0 = 0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::message_codec::decode_cc_message(arg2);
        if (0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::message_codec::is_mint_budget(&v0)) {
            let v3 = 0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::message_codec::extract_mint_budget(v0);
            ...
            assert!(0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::message_codec::is_token(&v0), 111);
            let (v5, v6, v7) = 0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::message_codec::extract_token_info(v0);
    ...
    public fun msg_of_cc_send_mint_budget(arg0: u64) : vector<u8> {
        0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::message_codec::encode_cc_mint_budget_message(arg0)
    }

    public fun msg_of_cc_send_token(arg0: address, arg1: vector<u8>, arg2: u64) : vector<u8> {
        0xd0f58f70d9b1add5026ee9cefe306d9be9d29c54df48db27b75831e6c3ab23b8::message_codec::encode_cc_token_message(arg0, arg1, arg2)
    }
