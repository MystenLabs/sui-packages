module 0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::roles {
    ...
    public(friend) fun new<T0>(arg0: address, arg1: address, arg2: address, arg3: address, arg4: address, arg5: &mut 0x2::tx_context::TxContext) : Roles<T0> {
        ...
        0x2::bag::add<OwnerKey, 0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::TwoStepRole<OwnerRole<T0>>>(&mut v0, v1, 0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::new<OwnerRole<T0>>(v2, arg0));
    ...
    public fun owner<T0>(arg0: &Roles<T0>) : address {
        0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::active_address<OwnerRole<T0>>(owner_role<T0>(arg0))
    }

    public(friend) fun owner_role<T0>(arg0: &Roles<T0>) : &0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::TwoStepRole<OwnerRole<T0>> {
        let v0 = OwnerKey{dummy_field: false};
        0x2::bag::borrow<OwnerKey, 0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::TwoStepRole<OwnerRole<T0>>>(&arg0.data, v0)
    }

    public(friend) fun owner_role_mut<T0>(arg0: &mut Roles<T0>) : &mut 0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::TwoStepRole<OwnerRole<T0>> {
        let v0 = OwnerKey{dummy_field: false};
        0x2::bag::borrow_mut<OwnerKey, 0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::TwoStepRole<OwnerRole<T0>>>(&mut arg0.data, v0)
    }
    ...
    public fun pending_owner<T0>(arg0: &Roles<T0>) : 0x1::option::Option<address> {
        0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::pending_address<OwnerRole<T0>>(owner_role<T0>(arg0))
    }
    ...
    public(friend) fun update_blocklister<T0>(arg0: &mut Roles<T0>, arg1: address, arg2: &0x2::tx_context::TxContext) {
        0xd06f08bfb901fc3c4db6764d8a75595d8e8d6956802e4df7187375e606f6edee::two_step_role::assert_sender_is_active_role<OwnerRole<T0>>(owner_role<T0>(arg0), arg2);
        let v0 = BlocklisterKey{dummy_field: false};
