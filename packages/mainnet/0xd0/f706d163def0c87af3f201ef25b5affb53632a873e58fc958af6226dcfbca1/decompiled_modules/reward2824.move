module 0xd0f706d163def0c87af3f201ef25b5affb53632a873e58fc958af6226dcfbca1::reward2824 {
    struct REWARD2824 has drop {
        dummy_field: bool,
    }

    struct TICKET_2824 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2824(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2824>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2824>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2824, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2824>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2824>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2824>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2824>>(v5, 0x2::tx_context::sender(arg1));
    }
