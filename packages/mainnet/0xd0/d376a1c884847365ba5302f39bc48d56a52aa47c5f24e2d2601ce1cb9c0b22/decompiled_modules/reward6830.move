module 0xd0d376a1c884847365ba5302f39bc48d56a52aa47c5f24e2d2601ce1cb9c0b22::reward6830 {
    struct REWARD6830 has drop {
        dummy_field: bool,
    }

    struct TICKET_6830 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6830(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6830>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6830>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6830, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6830>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6830>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6830>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6830>>(v5, 0x2::tx_context::sender(arg1));
    }
