module 0xd01690d28a7836f7a2422299a32f05abc45eb8290d72208137f757ac88c7c176::test {
    struct TEST has drop {
        dummy_field: bool,
    }

    struct TestRegistry has store, key {
        id: 0x2::object::UID,
        supply: u16,
        total_supply: u16,
    ...
    public fun add_admin(arg0: &0x2::package::Publisher, arg1: &mut TestRegistry, arg2: address) {
        assert!(0x2::package::from_package<TEST>(arg0), 9);
        assert!(0x2::vec_set::size<address>(&arg1.admin_addresses) < 10, 12);
        0x2::vec_set::insert<address>(&mut arg1.admin_addresses, arg2);
    }

    public fun burn(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg2: 0x2::object::ID, arg3: &0x2::transfer_policy::TransferPolicy<TestNFT>, arg4: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::purchase_with_cap<TestNFT>(arg0, 0x2::kiosk::list_with_purchase_cap<TestNFT>(arg0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg1), arg2, 0, arg4), 0x2::coin::zero<0x2::sui::SUI>(arg4));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<TestNFT>(arg3, v1);
        let TestNFT {
            id        : v5,
            number_id : _,
        } = v0;
    ...
    public fun config_is_shuffled(arg0: &TestRegistry) : bool {
        arg0.is_shuffled
    }

    public fun config_map(arg0: &TestRegistry) : &0x2::table::Table<u16, ItemDetails> {
        &arg0.map
    }

    public fun config_prizes(arg0: &TestRegistry) : vector<Prize> {
        arg0.prizes
    }

    public fun config_shuffle_vector(arg0: &TestRegistry) : &vector<u16> {
        &arg0.shuffle_vector
    }

    public fun config_supply(arg0: &TestRegistry) : u16 {
        arg0.supply
    }

    public fun config_total_supply(arg0: &TestRegistry) : u16 {
        arg0.total_supply
    }

    public fun config_version(arg0: &TestRegistry) : u64 {
        arg0.version
    }

    public fun distribute_next_prize(arg0: &mut TestRegistry, arg1: &0x2::tx_context::TxContext) {
    ...
    public fun get_nft_id(arg0: u16, arg1: &TestRegistry) : &0x2::object::ID {
        &0x2::table::borrow<u16, ItemDetails>(&arg1.map, arg0).id
    }

    public fun get_prize(arg0: u16, arg1: &TestRegistry) : &Prize {
        0x1::option::borrow<Prize>(&0x2::table::borrow<u16, ItemDetails>(&arg1.map, arg0).prize)
    }

    fun init(arg0: TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TEST>(arg0, arg1);
        ...
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b""));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b""));
        let v5 = 0x2::display::new_with_fields<TestNFT>(&v0, v1, v3, arg1);
        ...
        0x2::transfer::share_object<TestRegistry>(v6);
    }
    ...
    public fun mint_nft_to_kiosk(arg0: &mut TestRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::transfer_policy::TransferPolicy<TestNFT>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xd01690d28a7836f7a2422299a32f05abc45eb8290d72208137f757ac88c7c176::extension::lock<TestNFT>(arg1, v2, arg2);
    }

    public fun mint_nft_to_non_personal_kiosk(arg0: &mut TestRegistry, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<TestNFT>, arg4: address, arg5: &mut 0x2::tx_context::TxContext) : Promise {
        ...
        0xd01690d28a7836f7a2422299a32f05abc45eb8290d72208137f757ac88c7c176::extension::add_(arg1, arg2, arg5);
        0xd01690d28a7836f7a2422299a32f05abc45eb8290d72208137f757ac88c7c176::extension::lock<TestNFT>(arg1, v1, arg3);
        Promise{receiver: arg4}
    }

    public fun prizes_sum(arg0: &TestRegistry) : u16 {
        let v0 = &arg0.prizes;
        let v1 = vector[];
        let v2 = 0;
    ...
    public fun register_prize(arg0: 0x1::string::String, arg1: u16, arg2: &mut TestRegistry, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun remove_admin(arg0: &0x2::package::Publisher, arg1: &mut TestRegistry, arg2: address) {
        assert!(0x2::package::from_package<TEST>(arg0), 9);
        0x2::vec_set::remove<address>(&mut arg1.admin_addresses, &arg2);
        assert!(0x2::vec_set::size<address>(&arg1.admin_addresses) > 0, 11);
    }

    public fun reset_prizes(arg0: &mut TestRegistry, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x2::vec_set::contains<address>(&arg0.admin_addresses, &v0), 10);
        assert!(arg0.version == 1, 8);
    ...
    entry fun shuffle_vector(arg0: &0x2::random::Random, arg1: &mut TestRegistry, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_total_supply(arg0: &mut TestRegistry, arg1: u16, arg2: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::vec_set::contains<address>(&arg0.admin_addresses, &v0), 10);
        assert!(arg0.version == 1, 8);
