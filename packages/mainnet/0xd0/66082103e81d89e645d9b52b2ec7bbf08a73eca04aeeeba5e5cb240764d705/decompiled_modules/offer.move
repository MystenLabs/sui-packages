module 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::offer {
    ...
    public fun create<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: u64, arg3: u64, arg4: u8, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(v1, 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::invalid_fill_policy());
        ...
        let v4 = 0x2::object::id<LiquidityOffer<T0, T1>>(&v3);
        0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::events::emit_offer_created_v2(v4, v2, 0x1::type_name::get<T0>(), 0x1::type_name::get<T1>(), v0, arg1, arg2, arg3, arg4, arg5);
        0x2::transfer::public_share_object<LiquidityOffer<T0, T1>>(v3);
        v4
    }
    ...
    public fun fill_full<T0, T1>(arg0: &mut LiquidityOffer<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (FillReceipt<T0, T1>, 0x2::coin::Coin<T1>) {
        ...
        let v2 = validate_payment_in_range(v1, v0, arg0.min_price, arg0.max_price);
        ...
        (v3, 0x2::coin::from_balance<T1>(0x2::balance::zero<T1>(), arg3))
    }
    ...
    public fun fill_full_and_settle<T0, T1>(arg0: &mut LiquidityOffer<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = fill_full<T0, T1>(arg0, arg1, arg2, arg3);
        let (v3, _, _, _, _) = unpack_receipt<T0, T1>(v1, arg3);
    ...
    public fun fill_partial<T0, T1>(arg0: &mut LiquidityOffer<T0, T1>, arg1: u64, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (FillReceipt<T0, T1>, 0x2::coin::Coin<T1>) {
        ...
        let v1 = validate_payment_in_range(v0, arg1, arg0.min_price, arg0.max_price);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg2, arg0.maker);
        (v4, 0x2::coin::from_balance<T1>(0x2::balance::zero<T1>(), arg4))
    }
    ...
    public fun fill_partial_and_settle<T0, T1>(arg0: &mut LiquidityOffer<T0, T1>, arg1: u64, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = fill_partial<T0, T1>(arg0, arg1, arg2, arg3, arg4);
        let (v3, _, _, _, _) = unpack_receipt<T0, T1>(v1, arg4);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v3, v0);
        0x2::coin::destroy_zero<T1>(v2);
    }

    public fun fill_partial_gated<T0, T1>(arg0: &mut LiquidityOffer<T0, T1>, arg1: u64, arg2: 0x2::coin::Coin<T1>, arg3: &0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::capability::PartialFillCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (FillReceipt<T0, T1>, 0x2::coin::Coin<T1>) {
        assert_fillable<T0, T1>(arg0, arg4);
        assert!(arg0.fill_policy == 2, 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::partial_fill_cap_required());
        assert!(arg1 > 0, 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::zero_amount());
        assert!(arg1 <= 0x2::balance::value<T0>(&arg0.offer_balance), 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::fill_exceeds_remaining());
        assert!(arg1 >= arg0.min_fill_amount, 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::fill_below_minimum());
        check_no_dust<T0, T1>(arg0, arg1);
        ...
        0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::events::emit_offer_filled(0x2::object::id<LiquidityOffer<T0, T1>>(arg0), 0x2::tx_context::sender(arg5), arg1, v0, v1, v3, v2);
        let v4 = FillReceipt<T0, T1>{
            offer_balance  : 0x2::balance::split<T0>(&mut arg0.offer_balance, arg1),
            fill_amount    : arg1,
            payment_amount : v0,
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg2, arg0.maker);
        (v4, 0x2::coin::from_balance<T1>(0x2::balance::zero<T1>(), arg5))
    }

    public fun fill_partial_gated_and_settle<T0, T1>(arg0: &mut LiquidityOffer<T0, T1>, arg1: u64, arg2: 0x2::coin::Coin<T1>, arg3: &0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::capability::PartialFillCap, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let (v1, v2) = fill_partial_gated<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5);
        let (v3, _, _, _, _) = unpack_receipt<T0, T1>(v1, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v3, v0);
        0x2::coin::destroy_zero<T1>(v2);
    }
    ...
    public fun fill_policy_partial_gated() : u8 {
        2
    }
    ...
    public fun quote_fill_amount<T0, T1>(arg0: &LiquidityOffer<T0, T1>, arg1: u64, arg2: u64) : u64 {
        let v0 = 0x2::balance::value<T0>(&arg0.offer_balance);
        assert!(arg0.status == 0 || arg0.status == 1, 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::invalid_status_for_fill());
        assert!(arg1 > 0, 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::zero_amount());
        assert!(arg2 > 0, 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::zero_price());
    ...
    fun validate_payment_in_range(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        assert!(arg0 >= calc_payment(arg1, arg2), 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::price_too_low());
        assert!(arg0 <= calc_payment(arg1, arg3), 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::errors::price_too_high());
        calculate_price(arg0, arg1)
    }
