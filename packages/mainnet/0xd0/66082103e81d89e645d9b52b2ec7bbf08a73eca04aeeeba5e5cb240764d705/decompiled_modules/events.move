module 0xf53c071b6575ee2e5b1b19158acbbf21944aa6474d7b8e688365015295a7c0a7::events {
    ...
    struct OfferCreatedV2 has copy, drop {
        offer_id: 0x2::object::ID,
        maker: address,
        offer_asset: 0x1::type_name::TypeName,
        want_asset: 0x1::type_name::TypeName,
        initial_offer_amount: u64,
        min_price: u64,
        max_price: u64,
        expiry_timestamp_ms: u64,
    ...
    struct IntentSubmittedV2 has copy, drop {
        intent_id: 0x2::object::ID,
        creator: address,
        receive_asset: 0x1::type_name::TypeName,
        pay_asset: 0x1::type_name::TypeName,
        receive_amount: u64,
        max_pay_amount: u64,
        escrowed_amount: u64,
        min_price: u64,
    ...
    public fun emit_intent_submitted_v2(arg0: 0x2::object::ID, arg1: address, arg2: 0x1::type_name::TypeName, arg3: 0x1::type_name::TypeName, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64) {
        let v0 = IntentSubmittedV2{
            intent_id           : arg0,
            creator             : arg1,
            receive_asset       : arg2,
            pay_asset           : arg3,
            receive_amount      : arg4,
            max_pay_amount      : arg5,
            escrowed_amount     : arg6,
            min_price           : arg7,
            max_price           : arg8,
            expiry_timestamp_ms : arg9,
        };
        0x2::event::emit<IntentSubmittedV2>(v0);
    }
    ...
    public fun emit_offer_created_v2(arg0: 0x2::object::ID, arg1: address, arg2: 0x1::type_name::TypeName, arg3: 0x1::type_name::TypeName, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8, arg9: u64) {
        let v0 = OfferCreatedV2{
            offer_id             : arg0,
            maker                : arg1,
            offer_asset          : arg2,
            want_asset           : arg3,
            initial_offer_amount : arg4,
            min_price            : arg5,
            max_price            : arg6,
            expiry_timestamp_ms  : arg7,
            fill_policy          : arg8,
            min_fill_amount      : arg9,
        };
        0x2::event::emit<OfferCreatedV2>(v0);
    }
