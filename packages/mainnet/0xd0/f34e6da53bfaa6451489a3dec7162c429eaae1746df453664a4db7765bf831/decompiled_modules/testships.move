module 0xd0f34e6da53bfaa6451489a3dec7162c429eaae1746df453664a4db7765bf831::testships {
    ...
    public fun update_attributes(arg0: &PubKey, arg1: &mut MintStats, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: vector<u8>, arg6: u8, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: 0x1::string::String, arg10: 0x1::string::String, arg11: 0x1::string::String, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: 0x1::string::String, arg17: 0x1::string::String, arg18: u64) {
        ...
        } else if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v5)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v5);
        };
        let v8 = 0x1::string::utf8(b"Attack");
        if (arg13 != 0) {
            if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v8)) {
                *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v8) = u64_to_string(arg13);
            } else {
                0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v8, u64_to_string(arg13));
            };
        } else if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v8)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v8);
        };
        let v11 = 0x1::string::utf8(b"Defence");
        if (arg14 != 0) {
            if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v11)) {
                *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v11) = u64_to_string(arg14);
            } else {
                0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v11, u64_to_string(arg14));
            };
        } else if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v11)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v11);
        };
        let v14 = 0x1::string::utf8(b"Health");
        if (arg15 != 0) {
            if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v14)) {
                *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v14) = u64_to_string(arg15);
            } else {
                0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v14, u64_to_string(arg15));
            };
        } else if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v14)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v14);
        };
        let v17 = 0x1::string::utf8(b"Upgrades");
        if (0x1::string::length(&v1.upgrades) != 0) {
            if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v17)) {
                *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v17) = clone_string(&v1.upgrades);
            } else {
                0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v17, clone_string(&v1.upgrades));
            };
        } else if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v17)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v17);
        };
        let v20 = 0x1::string::utf8(b"Specialisation");
        if (0x1::string::length(&v1.specialisation) != 0) {
            if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v20)) {
                *0x2::vec_map::get_mut<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v20) = clone_string(&v1.specialisation);
            } else {
                0x2::vec_map::insert<0x1::string::String, 0x1::string::String>(&mut v1.attributes, v20, clone_string(&v1.specialisation));
            };
        } else if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&v1.attributes, &v20)) {
            let (_, _) = 0x2::vec_map::remove<0x1::string::String, 0x1::string::String>(&mut v1.attributes, &v20);
        };
    }
