module 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::sbalance {
    ...
    public fun deposit<T0>(arg0: &mut SBalance<T0>, arg1: 0x2::balance::Balance<T0>) {
        assert!(0x2::balance::value<T0>(&arg0.balance) + 0x2::balance::value<T0>(&arg1) <= arg0.supply, 164004);
