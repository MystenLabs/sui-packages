module 0x8cb9f9914a114c832f516249fa6decc55d859cbc44d84b901dd4de872914b27e::keys {
    ...
    struct RegistryAccountAssistantCapKey has copy, drop, store {
        account_cap_id: 0x2::object::ID,
    }

    struct AuthorizedMultitonAuthorityCapKey<phantom T0, phantom T1> has copy, drop, store {
    ...
    public(friend) fun authorized_multiton_authority_cap<T0, T1>(arg0: 0x2::object::ID) : AuthorizedMultitonAuthorityCapKey<T0, T1> {
        AuthorizedMultitonAuthorityCapKey<T0, T1>{cap_id: arg0}
    }
    ...
    public(friend) fun registry_account_assistant_cap(arg0: 0x2::object::ID) : RegistryAccountAssistantCapKey {
        RegistryAccountAssistantCapKey{account_cap_id: arg0}
    }
