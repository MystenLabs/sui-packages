module 0xd0633aadf9b73eb735702f77277ba57b57aaa0b10d08461207dcfbb6b3e14a3a::reward3609 {
    struct REWARD3609 has drop {
        dummy_field: bool,
    }

    struct TICKET_3609 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3609(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3609>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3609>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3609, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3609>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3609>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3609>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3609>>(v5, 0x2::tx_context::sender(arg1));
    }
