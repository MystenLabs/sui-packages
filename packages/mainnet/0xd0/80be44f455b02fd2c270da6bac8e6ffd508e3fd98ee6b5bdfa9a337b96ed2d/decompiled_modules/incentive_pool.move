module 0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::incentive_pool {
    ...
    struct IncentivePools<phantom T0> has store, key {
        ...
        reward_pool: 0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool::RewardPool<T0>,
    }
    ...
    public(friend) fun add_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: 0x2::balance::Balance<T0>) {
        0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool::add_reward<T0>(&mut arg0.reward_pool, arg1);
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : (u64, 0x2::balance::Balance<T0>) {
        0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool::claim_reward<T0>(&mut arg0.reward_pool, arg1)
    }
    ...
    public(friend) fun create_incentive_pools<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : IncentivePools<T0> {
        IncentivePools<T0>{
            ...
            reward_pool : 0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool::new<T0>(arg0, arg1),
        }
    }
    ...
    public fun reward_pool<T0>(arg0: &IncentivePools<T0>) : &0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool::RewardPool<T0> {
        &arg0.reward_pool
    }
    ...
    public(friend) fun take_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool::remove_reward<T0>(&mut arg0.reward_pool, arg1)
    }
    ...
    public(friend) fun update_reward_pool<T0>(arg0: &mut IncentivePools<T0>, arg1: u64, arg2: u64) {
        0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool::update_reward_pool<T0>(&mut arg0.reward_pool, arg1, arg2);
    }
