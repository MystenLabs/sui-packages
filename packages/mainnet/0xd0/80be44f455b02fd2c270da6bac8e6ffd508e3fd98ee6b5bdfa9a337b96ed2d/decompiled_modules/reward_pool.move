module 0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::reward_pool {
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64) : RewardPool<T0> {
        assert!(arg1 > 0, 0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::app_error::reward_exchange_rate_numerator_zero());
        RewardPool<T0>{
    ...
    public(friend) fun update_reward_pool<T0>(arg0: &mut RewardPool<T0>, arg1: u64, arg2: u64) {
        assert!(arg2 > 0, 0xd080be44f455b02fd2c270da6bac8e6ffd508e3fd98ee6b5bdfa9a337b96ed2d::app_error::reward_exchange_rate_numerator_zero());
