module 0xd0274c26b4f51564407529b26027cbd2f4b24bf15ae6d6febc65e36f23406a55::cnsnft2760 {
    struct CNSNFT2760 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2760, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2760>(arg0, arg1);
