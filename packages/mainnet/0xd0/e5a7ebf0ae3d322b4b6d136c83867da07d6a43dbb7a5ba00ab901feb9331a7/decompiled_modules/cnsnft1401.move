module 0xd0e5a7ebf0ae3d322b4b6d136c83867da07d6a43dbb7a5ba00ab901feb9331a7::cnsnft1401 {
    struct CNSNFT1401 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1401, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1401>(arg0, arg1);
