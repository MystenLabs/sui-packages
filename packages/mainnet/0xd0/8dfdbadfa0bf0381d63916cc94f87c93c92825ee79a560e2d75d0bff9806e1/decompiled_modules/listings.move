module 0xd08dfdbadfa0bf0381d63916cc94f87c93c92825ee79a560e2d75d0bff9806e1::listings {
    ...
    public fun buy<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg2, v7, arg3), v8);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg2, v6 - v7, arg3), v5);
        let v9 = BuyEvent{
            listing_id  : arg1,
    ...
    public fun ob_buy<T0: store + key>(arg0: &mut Store, arg1: 0x2::object::ID, arg2: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::Collection<T0>, arg3: &mut 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::BpsRoyaltyStrategy<T0>, arg4: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::dynamic_object_field::remove<0x2::object::ID, Listing>(&mut arg0.id, arg1);
        ...
        let v9 = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty_strategy_bps::calculate<T0>(arg3, v6);
        0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::royalty::collect_royalty<T0, 0x2::sui::SUI>(arg2, 0x2::coin::balance_mut<0x2::sui::SUI>(arg4), v9);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg4, v6 - v9 - v7, arg5), v5);
        let v10 = BuyEvent{
            listing_id  : arg1,
            nft_id      : 0x2::object::id<T0>(&v3),
            seller      : v5,
