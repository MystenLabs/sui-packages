module 0xaff9333d3d69aec8d4eca3acc80722bdb4607f53544201d1384fa54e5c7955da::alphafi_swapper_utils {
    ...
    public fun destroy_or_transfer_coin_to_sender<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun split_coins_in_ratio<T0, T1>(arg0: u32, arg1: u128, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u32, arg5: u32, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v2 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::from_u32(arg0);
        let v3 = 0x2::coin::value<T0>(&arg2);
        let v4 = 0x2::coin::value<T1>(&arg3);
        if (v3 == 0 || v4 == 0) {
            (arg2, arg3, 0x2::coin::zero<T0>(arg6), 0x2::coin::zero<T1>(arg6))
        } else if (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::i32::lt(v2, v1)) {
            let (_, _, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_liquidity_from_amount(v0, v1, v2, arg1, v3, true);
            if (v11 <= v4) {
                (arg2, 0x2::coin::split<T1>(&mut arg3, v11, arg6), 0x2::coin::zero<T0>(arg6), arg3)
            } else {
                let (_, v13, _) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::get_liquidity_from_amount(v0, v1, v2, arg1, v4, false);
                assert!(v13 <= v3, 12345);
                (0x2::coin::split<T0>(&mut arg2, v13, arg6), arg3, arg2, 0x2::coin::zero<T1>(arg6))
            }
        } else {
            (0x2::coin::zero<T0>(arg6), arg3, arg2, 0x2::coin::zero<T1>(arg6))
        }
    }
