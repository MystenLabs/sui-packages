module 0x6b8df2ad1e623afb7594ba45078588eca20d15c729633fffa2765cfacb26cc84::parameterized {
    ...
    public entry fun execute_nft_transfer<T0: store + key>(arg0: &mut TransferParams, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = NFTDebugEvent{
            message : 0x1::ascii::string(b"NFT transfer details removed, ready for transfer"),
            nft_id  : arg1,
        };
