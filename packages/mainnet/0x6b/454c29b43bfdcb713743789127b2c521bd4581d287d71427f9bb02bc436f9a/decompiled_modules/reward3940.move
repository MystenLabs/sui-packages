module 0x6b454c29b43bfdcb713743789127b2c521bd4581d287d71427f9bb02bc436f9a::reward3940 {
    struct REWARD3940 has drop {
        dummy_field: bool,
    }

    struct TICKET_3940 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3940(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3940>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3940>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3940, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3940>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3940>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3940>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3940>>(v5, 0x2::tx_context::sender(arg1));
    }
