module 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::nft {
    ...
    fun init(arg0: NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::admin::new(arg1);
        setup_transfer_policy(&v4, &v6, arg1);
        0x2::transfer::public_transfer<0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::admin::AdminCap>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<SatLayerNFT>>(v5, 0x2::tx_context::sender(arg1));
    }

    public fun mint_nft(arg0: &mut 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::Collection, arg1: &0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::admin::AdminCap, arg2: &mut 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::phase::Phase, arg3: &mut 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::tier::Tier, arg4: &0x2::clock::Clock, arg5: address, arg6: &0x2::transfer_policy::TransferPolicy<SatLayerNFT>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::is_active(arg0), 0);
        assert!(0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::phase::collection_id(arg2) == 0x2::object::id<0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::Collection>(arg0), 1);
        assert!(0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::tier::collection_id(arg3) == 0x2::object::id<0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::Collection>(arg0), 2);
        0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::phase::validate_and_record_mint(arg2, arg4);
        0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::tier::validate_and_record_mint(arg3, 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::phase::phase_id(arg2));
        let v0 = 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::increment_supply(arg0);
        let v1 = 0x2::object::new(arg7);
        let v2 = 0x2::object::uid_to_inner(&v1);
        let v3 = 0x2::object::id<0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::Collection>(arg0);
        let v4 = 0x2::object::id<0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::tier::Tier>(arg3);
        let v5 = 0x1::string::utf8(b"Cube #");
        0x1::string::append_utf8(&mut v5, 0x1::string::into_bytes(0x1::u64::to_string(v0)));
        let v6 = SatLayerNFT{
            id              : v1,
            collection_name : 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::name(arg0),
            collection_id   : v3,
            tier_name       : 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::tier::name(arg3),
            tier_id         : v4,
            mint_number     : v0,
            name            : v5,
            ...
            is_revealed     : false,
            image_url       : 0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::tier::image_url(arg3),
        ...
        let v7 = MintEvent{
            ...
            collection_id : v3,
            tier_id       : v4,
            phase_id      : 0x2::object::id<0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::phase::Phase>(arg2),
            mint_number   : v0,
            minter        : arg5,
        };
    ...
    public fun reveal_nft(arg0: &mut SatLayerNFT, arg1: &0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::admin::AdminCap, arg2: &0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::Collection, arg3: 0x1::string::String, arg4: vector<0x1::string::String>, arg5: vector<0x1::string::String>) {
        assert!(!arg0.is_revealed, 3);
        assert!(!0x1::string::is_empty(&arg3), 4);
        assert!(arg0.collection_id == 0x2::object::id<0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::collection::Collection>(arg2), 1);
    ...
    public fun setup_transfer_policy(arg0: &0x2::package::Publisher, arg1: &0x6b8c23a9b5540d8f5987263ce80301debdf026540d7f30d031c3ec45d9d5504d::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
