module 0x6b877eb9706a2159c7df47921d2c0dcd61f221a679168ebbad28f385696ecdeb::hdrm {
    struct HDRM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: HDRM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<HDRM>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"HDRM"));
