module 0x6bd3e637675b4afcadfd87ee68a0a5285022e08da66ec263df6034c5b2b361aa::reward6613 {
    struct REWARD6613 has drop {
        dummy_field: bool,
    }

    struct TICKET_6613 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6613(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6613>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6613>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6613, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6613>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6613>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6613>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6613>>(v5, 0x2::tx_context::sender(arg1));
    }
