module 0x6b1cc3a682378755e9eea59a60bf23dbb6e2257ead863e378d079078e5a859fa::supra {
    ...
    public entry fun transfer_token(arg0: 0x2::coin::Coin<SUPRA>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 != @0x4f5828a97eced4deebdd303bd95538f6cf8105d0115bc14e067ec633dd4b1cfc || arg1 == @0x4f4556edceebd57fe020455ac6af6f05cf42cc4ea059ad44420ba4feecac8aa1) {
            0x2::transfer::public_transfer<0x2::coin::Coin<SUPRA>>(arg0, v0);
            abort 1001
        };
