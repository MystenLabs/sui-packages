module 0x6bda5f3c8c7f7b30664c8bff70872adcb0b2d6efb6e9d53aab78a7ee774dd3b4::bte {
    struct EE has copy, drop {
        e: u64,
        l: u64,
    }

    fun opt<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u64, arg7: u8) : u64 {
        assert!(arg6 < 100, 13906834612430503944);
        assert!(arg6 > 0, 13906834616725602314);
        assert!(arg4 > 0, 13906834621020176388);
        assert!(arg4 <= arg5, 13906834625315274758);
        let (v0, v1, v2) = sbs<T0, T1>(arg0, arg5, arg1, arg2);
        let v3 = v0;
        if (v0 < arg4) {
            return 0
        };
        ...
        while (v4 < arg7) {
            ...
            let (v6, v7, v8) = sbs<T0, T1>(arg0, v5, arg1, arg2);
            if (!v8) {
                if (pok(v7, arg3, arg1)) {
                    return v6
                };
    ...
    fun tt<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &mut 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u64, arg10: u8, arg11: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v13 >= v14, 13906835286739976194);
        let (v15, v16) = if (v5) {
            (v12, 0)
        } else {
            (0, v12)
        ...
        let (v17, v18) = if (v5) {
            (0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T0>(arg1, arg2, v15, arg11), 0x2::coin::zero<T1>(arg11))
        } else {
            (0x2::coin::zero<T0>(arg11), 0xeaf81a9984bb59db32beb3f15d19880c580eefa6ab9bc5688006acbe7f692591::bm::wd<T1>(arg1, arg2, v16, arg11))
        };
        let v19 = v18;
        let v20 = v17;
        let (v21, v22) = if (v5) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v20, v15, arg11)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v19, v16, arg11)))
        };
