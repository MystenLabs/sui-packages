module 0x6b6a7be430b45621ec132807ec8fda0da3e61acf503136be354f6c1b4ff5602e::private_coin {
    ...
    fun init(arg0: PRIVATE_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PRIVATE_COIN>(arg0, 9, trim_right(b"USDD"), trim_right(b"private coin"), trim_right(b"jingongyule"), 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(trim_right(b"https://ipfs.io/ipfs/bafkreieqqgjgqf3gn7b4achnshhnauakglkou7h2oc6mpf7ilnacrmluvi"))), arg1);
        let v2 = v0;
        if (75982162000000000 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<PRIVATE_COIN>>(0x2::coin::mint<PRIVATE_COIN>(&mut v2, 75982162000000000, arg1), 0x2::tx_context::sender(arg1));
        };
