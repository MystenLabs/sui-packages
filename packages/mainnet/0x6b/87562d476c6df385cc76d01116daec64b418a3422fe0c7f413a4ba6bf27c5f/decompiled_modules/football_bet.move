module 0x6b87562d476c6df385cc76d01116daec64b418a3422fe0c7f413a4ba6bf27c5f::football_bet {
    ...
    public fun claim(arg0: Bet, arg1: &mut Match, arg2: &mut AdminList, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v13 = mul_div_floor(v4, v11, 2);
        let v14 = if (v10 == 0 || v13 == 0) {
            0
        } else {
            v13 * (arg1.locked_home_pool_total + arg1.locked_away_pool_total - mul_div_floor(arg1.locked_home_pool_total, v7, 2) + mul_div_floor(arg1.locked_away_pool_total, v9, 2)) / v10
        };
        let v15 = mul_div_floor(v4, v12, 2) + v14;
        if (v15 > 0) {
            assert!(100 <= 10000, 10);
            let v16 = calc_fee(v15, 100);
            if (v16 > 0) {
