module 0x92f4cb8739f22c63a82206191aa4aceafe59c083dbc2c27274f55474faaf4eb0::bonding_curve {
    ...
    fun buy_internal<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: &mut BondingPool<T0>, arg4: &mut ReferralRegistry, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u64, arg7: 0x1::option::Option<address>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!is_blacklisted(arg2, v0), 16);
    ...
    public entry fun create_pool_with_treasury_exponential<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: 0x2::coin::TreasuryCap<T0>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        let v0 = CurveParams{
            curve_type       : 1,
        ...
        create_pool_with_treasury_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, v0, arg10, arg11, arg12, arg13, arg14);
    }

    fun create_pool_with_treasury_internal<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: 0x2::coin::TreasuryCap<T0>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: CurveParams, arg9: u64, arg10: u64, arg11: 0x2::coin::Coin<0x2::sui::SUI>, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 17);
        let v0 = 0x2::tx_context::sender(arg13);
        let v1 = 0x2::clock::timestamp_ms(arg12);
        assert!(!is_blacklisted(arg2, v0), 16);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg11) >= arg1.creation_fee, 1);
        ...
        arg0.total_fees_collected = arg0.total_fees_collected + (arg1.creation_fee as u128);
        let v4 = TokenCreated{
    ...
    public entry fun create_pool_with_treasury_linear<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: 0x2::coin::TreasuryCap<T0>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        let v0 = CurveParams{
            curve_type       : 0,
            base_price       : (arg8 as u128),
            slope            : (arg9 as u128),
    ...
    public entry fun create_pool_with_treasury_sigmoid<T0>(arg0: &mut LaunchpadConfig, arg1: &FeeConfig, arg2: &Blacklist, arg3: 0x2::coin::TreasuryCap<T0>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: 0x2::coin::Coin<0x2::sui::SUI>, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        let v0 = CurveParams{
            curve_type       : 2,
            base_price       : (arg8 as u128),
            slope            : (arg11 as u128),
        ...
        create_pool_with_treasury_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, v0, arg12, arg13, arg14, arg15, arg16);
    }
