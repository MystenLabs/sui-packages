module 0x6b93ca86a7e39f7db7eeaf959eabbf1b6a7d9820c1e0b4a7803d76c43ad50679::cnsnft2936 {
    struct CNSNFT2936 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2936, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2936>(arg0, arg1);
