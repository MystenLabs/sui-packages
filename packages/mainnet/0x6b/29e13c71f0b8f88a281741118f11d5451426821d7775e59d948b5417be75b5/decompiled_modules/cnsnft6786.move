module 0x6b29e13c71f0b8f88a281741118f11d5451426821d7775e59d948b5417be75b5::cnsnft6786 {
    struct CNSNFT6786 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6786, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6786>(arg0, arg1);
