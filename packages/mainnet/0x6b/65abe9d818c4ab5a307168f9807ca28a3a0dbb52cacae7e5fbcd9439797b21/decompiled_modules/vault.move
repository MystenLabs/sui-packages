module 0x6b65abe9d818c4ab5a307168f9807ca28a3a0dbb52cacae7e5fbcd9439797b21::vault {
    ...
    struct GgSuiVault has key {
        id: 0x2::object::UID,
        ggsui_kraft_cap: 0x2::coin::TreasuryCap<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>,
    ...
    public fun claim_collected_lsd_fee(arg0: &mut GgSuiVault, arg1: &mut 0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::FeeCollector<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 9002);
        let v0 = LsdFeeCollected{amt: 0x2::balance::value<0x2::sui::SUI>(&arg0.protocol_fee_vault)};
        0x2::event::emit<LsdFeeCollected>(v0);
        0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::honey_yield::collect_fee_for_coin<0x2::sui::SUI>(arg1, 0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.protocol_fee_vault));
    }
    ...
    public fun get_ggsui_by_sui(arg0: &GgSuiVault, arg1: u64) : u64 {
        ...
        (0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::mul_div_u256((arg1 as u256), (arg0.ggsui_supply as u256), (v0 as u256)) as u64)
    }
    ...
    fun get_sui_amount(arg0: &0x3::staking_pool::PoolTokenExchangeRate, arg1: u64) : u64 {
        ...
        (0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::mul_div_u256((v0 as u256), (arg1 as u256), (v1 as u256)) as u64)
    }
    ...
    public fun get_sui_by_ggsui(arg0: &GgSuiVault, arg1: u64) : u64 {
        ...
        (0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::mul_div_u256((v0 as u256), (arg1 as u256), (arg0.ggsui_supply as u256)) as u64)
    }
    ...
    public fun get_sui_claimable_per_ggsui(arg0: &GgSuiVault) : u128 {
        ...
        (0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::mul_div_u256((v0 as u256), (1000000000 as u256), (v1 as u256)) as u128)
    }
    ...
    public fun init_vault(arg0: 0x2::coin::TreasuryCap<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = ConfigParams{
            pause_stake           : false,
    ...
    fun internal_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        let v0 = get_sui_by_ggsui(arg1, 0x2::balance::value<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&arg2));
        let v1 = 0x2::balance::value<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&arg2);
        ...
        let v14 = 0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::mul_div(v0, arg3, 10000);
        0x2::balance::join<0x2::sui::SUI>(&mut arg1.addon_staking_rewards, 0x2::balance::split<0x2::sui::SUI>(&mut v2, v14));
        0x2::coin::burn<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(arg2, arg4));
        arg1.ggsui_supply = 0x2::coin::total_supply<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
    ...
    public fun query_request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        (v0, 0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::mul_div(v0, arg1.config_params.redeem_fee_bps, 10000))
    }
    ...
    public fun request_delayed_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : UnstakeRequest {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        let v0 = 0x2::tx_context::epoch(arg3);
        update_accrued_rewards(arg1, arg0, arg3);
        let v1 = get_sui_by_ggsui(arg1, 0x2::balance::value<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&arg2));
        ...
        let v4 = UnstakeRequest{
            ...
            ggsui_amount       : 0x2::balance::value<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&arg2),
            sui_amount         : v1,
            requested_at_epoch : v0,
        };
        0x2::coin::burn<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, 0x2::coin::from_balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(arg2, arg3));
        arg1.ggsui_supply = 0x2::coin::total_supply<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&arg1.ggsui_kraft_cap);
    ...
    public fun request_instant_unstake(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        let v0 = arg1.config_params.redeem_fee_bps;
        internal_instant_unstake(arg0, arg1, arg2, v0, arg3)
    }

    public fun request_instant_unstake_disc(arg0: &RedeemFeeDiscCap, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut GgSuiVault, arg3: 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
    ...
    public fun stake_sui_request(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut GgSuiVault, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: 0x1::option::Option<address>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI> {
        assert!(arg1.version == 1, 9002);
        assert!(!arg1.config_params.pause_stake, 9003);
        update_accrued_rewards(arg1, arg0, arg4);
        ...
        0x2::coin::mint_balance<0x80cc29f3e85da6016b12538f05bacaa05f83d269530b97200be840f63e40ae87::ggsui::GGSUI>(&mut arg1.ggsui_kraft_cap, v1)
    }
    ...
    fun unstake_from_inactive_stake(arg0: &mut GgSuiVault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: address, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        let v1 = 0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::max_u64(arg3, 1000000000);
    ...
    public fun update_accrued_rewards(arg0: &mut GgSuiVault, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (refresh_validator_pools(arg0, arg1, arg2)) {
            ...
            let v2 = 0;
            if (v1 > v0) {
                v2 = (0xc9a6f26e30f389cb6e436096295a39956f0f4a28d47067c0ab812869030896e1::math::mul_div_u256(((v1 - v0) as u256), (arg0.config_params.protocol_fee_percent as u256), (10000 as u256)) as u64);
            };
