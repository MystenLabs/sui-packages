module 0x6bcc28ca5a5c22404ef063cea0a249b2f796f4a6dce68c5d815384c74c2fe87c::gift5713 {
    struct GIFT5713 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift5713(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT5713, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5713>(arg0, arg1);
