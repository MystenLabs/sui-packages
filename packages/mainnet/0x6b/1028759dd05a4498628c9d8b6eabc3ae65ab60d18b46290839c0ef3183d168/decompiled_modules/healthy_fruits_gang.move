module 0x6b1028759dd05a4498628c9d8b6eabc3ae65ab60d18b46290839c0ef3183d168::healthy_fruits_gang {
    struct HEALTHY_FRUITS_GANG has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: HEALTHY_FRUITS_GANG, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<HEALTHY_FRUITS_GANG>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Healthy Fruits Gang"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The Healthy Fruit Gang is a cheerful bunch of adorable fruits, each bursting with personality and charm. From playful apples to brave pumpkins, every fruit has a story to tell. Join the gang on their fun-filled adventures, where cuteness, courage, and friendship come together in a world full of color, laughter, and healthy vibes."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeif3v2l3d45xtlp6hl462bu2tbbtwp7gytsix3xh7vsswpm4iti7xm"));
