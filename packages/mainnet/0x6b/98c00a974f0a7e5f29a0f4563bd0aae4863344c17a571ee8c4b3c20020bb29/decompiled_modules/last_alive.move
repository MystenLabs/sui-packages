module 0x6b98c00a974f0a7e5f29a0f4563bd0aae4863344c17a571ee8c4b3c20020bb29::last_alive {
    ...
    public entry fun send_token_to_biggitybo<T0: store + key>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg0);
        assert!(v0 >= arg1, 0);
        if (v0 == arg1) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg0, @0x6aab0f72185b35edb89fb125533593104acaf7e1d99bcc3400838cd1b2f62f3f);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0, arg1, arg2), @0x6aab0f72185b35edb89fb125533593104acaf7e1d99bcc3400838cd1b2f62f3f);
