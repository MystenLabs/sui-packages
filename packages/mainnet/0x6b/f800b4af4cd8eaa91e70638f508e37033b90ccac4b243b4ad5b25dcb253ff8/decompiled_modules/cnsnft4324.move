module 0x6bf800b4af4cd8eaa91e70638f508e37033b90ccac4b243b4ad5b25dcb253ff8::cnsnft4324 {
    struct CNSNFT4324 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4324, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4324>(arg0, arg1);
