module 0x6b0bd0c082596ea3e805764a025a2b63c83c90e25b9dc6a957f49b52d729f9ed::public_sale {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PresaleData{
            ...
            icoStartTimestamp      : 1685106000000,
            icoEndTimestamp        : 1685192400000,
            suiPerToken            : 110000000,
            totalTokensForSale     : 3000000 * 1000000000,
            totalSuiDeposited      : 0x2::balance::zero<0x2::sui::SUI>(),
            amountToBeRaisedSui    : 300000 * 1000000000,
            actualAmountRaisedSui  : 0,
            minimumContributionSui : 20000000000,
    ...
    public entry fun read_bonus_rewards(arg0: &mut PresaleData, arg1: &mut UserData, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = get_is_whitelisted(arg0, 0x2::tx_context::sender(arg2));
        let v1 = 0;
        if (v0) {
            v1 = calculate_bonus_reward(arg1.investedSui, arg0.bonusRewardPool, 0x2::balance::value<0x2::sui::SUI>(&arg0.totalSuiDeposited));
        };
        v1
    }

    public entry fun read_tokens_rewards(arg0: &mut PresaleData, arg1: &mut UserData) : u64 {
        calculate_reward(arg1.investedSui, arg0.suiPerToken, arg0.totalTokensForSale, arg0.amountToBeRaisedSui, arg0.actualAmountRaisedSui)
    }
