module 0x6bde1403201e7e0dd9daa27bef9d134440cc2a8111e0c67a0c620d3d1736281e::SIMPLE_NFT {
    ...
    public entry fun create_display(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::display::new_with_fields<SimpleNFT>(arg0, v0, v2, arg1);
        0x2::display::update_version<SimpleNFT>(&mut v4);
        0x2::transfer::public_transfer<0x2::display::Display<SimpleNFT>>(v4, 0x2::tx_context::sender(arg1));
    }
