module 0x6b5846f5954a252148d8d3aceea7c5b5cbdecb9e4d6fe5656d646b90f7b003f6::ai_nft2 {
    ...
    fun init(arg0: AI_NFT2, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_share_object<UserArchive>(v1);
        let v2 = VaultConfig{
            id          : 0x2::object::new(arg1),
            version     : 1,
        ...
        0x2::transfer::public_share_object<VaultConfig>(v2);
    }
