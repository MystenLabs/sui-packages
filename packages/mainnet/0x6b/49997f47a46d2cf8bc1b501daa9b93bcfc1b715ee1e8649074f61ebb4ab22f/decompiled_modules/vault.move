module 0x6b49997f47a46d2cf8bc1b501daa9b93bcfc1b715ee1e8649074f61ebb4ab22f::vault {
    ...
    public entry fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 201);
        0x2::balance::join<T0>(&mut arg0.balance, 0x2::coin::into_balance<T0>(arg1));
        0x6b49997f47a46d2cf8bc1b501daa9b93bcfc1b715ee1e8649074f61ebb4ab22f::events::emit_admin(0x2::object::id<Vault<T0>>(arg0), b"deposit", v0, 0x2::balance::value<T0>(&arg0.balance), 0x2::balance::value<T0>(&arg0.balance), arg0.reserved, arg0.reserved, 0x2::tx_context::epoch_timestamp_ms(arg2), 0x2::tx_context::sender(arg2));
    }
    ...
    public entry fun payout<T0>(arg0: &mut Vault<T0>, arg1: &AdminCap, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x6b49997f47a46d2cf8bc1b501daa9b93bcfc1b715ee1e8649074f61ebb4ab22f::events::emit_admin(0x2::object::id<Vault<T0>>(arg0), b"payout", arg2, 0x2::balance::value<T0>(&arg0.balance), 0x2::balance::value<T0>(&arg0.balance), arg0.reserved, arg0.reserved, 0x2::tx_context::epoch_timestamp_ms(arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    public entry fun release<T0>(arg0: &mut Vault<T0>, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.reserved >= arg2, 203);
        arg0.reserved = arg0.reserved - arg2;
        0x6b49997f47a46d2cf8bc1b501daa9b93bcfc1b715ee1e8649074f61ebb4ab22f::events::emit_admin(0x2::object::id<Vault<T0>>(arg0), b"release", arg2, 0x2::balance::value<T0>(&arg0.balance), 0x2::balance::value<T0>(&arg0.balance), arg0.reserved, arg0.reserved, 0x2::tx_context::epoch_timestamp_ms(arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    public entry fun reserve<T0>(arg0: &mut Vault<T0>, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        arg0.reserved = arg0.reserved + arg2;
        0x6b49997f47a46d2cf8bc1b501daa9b93bcfc1b715ee1e8649074f61ebb4ab22f::events::emit_admin(0x2::object::id<Vault<T0>>(arg0), b"reserve", arg2, 0x2::balance::value<T0>(&arg0.balance), 0x2::balance::value<T0>(&arg0.balance), arg0.reserved, arg0.reserved, 0x2::tx_context::epoch_timestamp_ms(arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    public entry fun set_reserve_floor<T0>(arg0: &mut Vault<T0>, arg1: &AdminCap, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        0x6b49997f47a46d2cf8bc1b501daa9b93bcfc1b715ee1e8649074f61ebb4ab22f::events::emit_admin(0x2::object::id<Vault<T0>>(arg0), b"set_reserve_floor", arg2, 0x2::balance::value<T0>(&arg0.balance), 0x2::balance::value<T0>(&arg0.balance), arg0.reserved, arg0.reserved, 0x2::tx_context::epoch_timestamp_ms(arg3), 0x2::tx_context::sender(arg3));
    }
    ...
    public entry fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: &AdminCap, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert_floor_after<T0>(arg0, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, arg2), arg4), arg3);
        0x6b49997f47a46d2cf8bc1b501daa9b93bcfc1b715ee1e8649074f61ebb4ab22f::events::emit_admin(0x2::object::id<Vault<T0>>(arg0), b"withdraw", arg2, 0x2::balance::value<T0>(&arg0.balance), 0x2::balance::value<T0>(&arg0.balance), arg0.reserved, arg0.reserved, 0x2::tx_context::epoch_timestamp_ms(arg4), 0x2::tx_context::sender(arg4));
    }
