module 0x6b174527b8bab7295a5dbf33afdef601395a233e859c1309226a262faaec4022::chop_locker {
    ...
    fun calculate_adjusted_reward_rate(arg0: u64, arg1: u64, arg2: u64) : u64 {
        arg0 * calculate_depletion_factor(arg1, arg2) * 1000000000
    }
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = if (0x2::balance::value<T0>(&arg0.reward_balance) > 0) {
            ...
            let v7 = v0 * v5 / 1000000000;
            let v8 = arg0.total_weighted_stake + v7;
            let v9 = if (v8 > 0) {
                v7 * 0x2::balance::value<T0>(&arg0.reward_balance) / v8
            } else {
            ...
            assert!(v10 <= 0x2::balance::value<T0>(&arg0.reward_balance), 11);
            let v11 = &mut arg0.reward_balance;
            let v4 = withdraw_from_balance<T0>(v11, v10, arg5);
            arg0.total_weighted_stake = v8;
            v4
        } else {
