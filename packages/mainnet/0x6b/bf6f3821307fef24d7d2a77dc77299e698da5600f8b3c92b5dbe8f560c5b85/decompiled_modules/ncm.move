module 0x6bbf6f3821307fef24d7d2a77dc77299e698da5600f8b3c92b5dbe8f560c5b85::ncm {
    struct NCM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: NCM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/9AgmjFkN5YjxaxvvGiQefgFtGu9hGLcduRryJmpmpump.png                                                                                                                                                                                                                               ");
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<NCM>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<NCM>>(v4);
    }
