module 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::dlmm_math {
    public fun calculate_amount_by_growth(arg0: u128, arg1: u128) : u64 {
        ...
        assert!(v0 <= 18446744073709551615, 13906835776366182401);
        (v0 as u64)
    }
    ...
    public fun calculate_composition_fee(arg0: u64, arg1: u64) : u64 {
        ...
        let v0 = 0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u128::mul_div_ceil(0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::full_mul(arg0, arg1), ((1000000000 + arg1) as u128), 1000000000000000000);
        assert!(v0 <= (arg0 as u128), 13906835527259389973);
        (v0 as u64)
    }
    ...
    public fun calculate_growth_by_amount(arg0: u64, arg1: u128) : u128 {
        assert!(arg1 > 0, 13906835621748015115);
        if (arg0 == 0) {
            return 0
        };
