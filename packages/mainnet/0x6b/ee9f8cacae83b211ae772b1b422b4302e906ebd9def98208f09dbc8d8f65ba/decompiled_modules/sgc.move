module 0x6dd7807b2ad7e6dc4d48294df3b4dcaf9d736850c2100379fd5ec269b30703a7::sgc {
    struct SGC has drop {
        dummy_field: bool,
    }
    ...
    public entry fun admin_mint(arg0: &mut Minter, arg1: &mut AdminTotal, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg2);
        if (v0 >= arg1.cycle) {
            arg1.cycle = v0 + 2592000000;
            arg1.total = arg1.total - 500000000000000;
            0x2::coin::mint_and_transfer<SGC>(&mut arg0.cap, 500000000000000, 0x2::tx_context::sender(arg3), arg3);
        };
    }
