module 0x6bcc547e7913ed821bd3515c12940946e4c1aeda37561f7c9d355794d1bc9b85::test_publisher_node_collatoral {
    struct PublisherNodeVault has store, key {
        id: 0x2::object::UID,
        total_staked: 0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>,
    ...
    public entry fun add_collatoral(arg0: &MaintainerRole, arg1: address, arg2: 0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>, arg3: u64, arg4: 0x1::string::String, arg5: vector<u64>, arg6: &mut PublisherNodeVault, arg7: &0x2::clock::Clock, arg8: &UpgradeVersion, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(&arg2);
        ...
        assert!(v0 != 0, 1);
        0x2::coin::join<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(&mut arg6.total_staked, arg2);
    ...
    fun init(arg0: TEST_PUBLISHER_NODE_COLLATORAL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = PublisherNodeVault{
            id              : 0x2::object::new(arg1),
            total_staked    : 0x2::coin::zero<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(arg1),
    ...
    public entry fun remove_collatoral(arg0: &MaintainerRole, arg1: address, arg2: &mut PublisherNodeVault, arg3: 0x1::string::String, arg4: u64, arg5: &0x2::clock::Clock, arg6: &UpgradeVersion, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>>(0x2::coin::split<0xf29428618abe285833214f7041e60462465b323b9ef7e4793cf25fdc3aeda674::test_token::TEST_TOKEN>(&mut arg2.total_staked, v2.price, arg7), arg1);
