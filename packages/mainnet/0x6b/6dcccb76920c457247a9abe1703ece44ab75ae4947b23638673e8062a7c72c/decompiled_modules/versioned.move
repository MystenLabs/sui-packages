module 0x6b6dcccb76920c457247a9abe1703ece44ab75ae4947b23638673e8062a7c72c::versioned {
    ...
    public fun pause(arg0: &0x6b6dcccb76920c457247a9abe1703ece44ab75ae4947b23638673e8062a7c72c::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public fun unpause(arg0: &0x6b6dcccb76920c457247a9abe1703ece44ab75ae4947b23638673e8062a7c72c::admin_cap::AdminCap, arg1: &mut Versioned, arg2: &0x2::tx_context::TxContext) {
        check_version(arg1);
        let v0 = GlobalPauseDfKey{dummy_field: false};
    ...
    public fun upgrade(arg0: &0x6b6dcccb76920c457247a9abe1703ece44ab75ae4947b23638673e8062a7c72c::admin_cap::AdminCap, arg1: &mut Versioned) {
