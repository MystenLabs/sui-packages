module 0x6b2092834426be2f856a0a3c8e2cd2ef2fbc6d4f4e1a063c77f245ed7ae9117a::suinami {
    ...
    fun init(arg0: SUINAMI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUINAMI>(arg0, 6, b"NAMI", b"Suinami", b"Suinami. Surf the wave.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/j8wYDMc.png")), arg1);
