module 0x6b7d8e3b252786aede4f2c6041280e109afacc476a9155ca4501bebf8dd1c89c::dialog_management {
    ...
    struct UserDialogHashes has key {
        id: 0x2::object::UID,
        dialog_hashes: 0x2::table::Table<vector<u8>, vector<u8>>,
    }
    ...
    public entry fun add_dialog_hash(arg0: &mut UserDialogHashes, arg1: vector<u8>, arg2: vector<u8>) {
        0x2::table::add<vector<u8>, vector<u8>>(&mut arg0.dialog_hashes, arg1, arg2);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = UserDialogHashes{
            id            : 0x2::object::new(arg0),
            dialog_hashes : 0x2::table::new<vector<u8>, vector<u8>>(arg0),
        };
        0x2::transfer::share_object<UserDialogHashes>(v2);
    }

    public entry fun read_user_dialog_hash(arg0: &UserDialogHashes, arg1: vector<u8>, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x2::table::contains<vector<u8>, vector<u8>>(&arg0.dialog_hashes, arg1)) {
            let v0 = UserDialogHashesEvent{
                address     : arg1,
                dialog_hash : *0x2::table::borrow<vector<u8>, vector<u8>>(&arg0.dialog_hashes, arg1),
            };
            0x2::event::emit<UserDialogHashesEvent>(v0);
        };
    }

    public entry fun send_message(arg0: &mut UserDialogs, arg1: &mut UserDialogHashes, arg2: &mut ChatCounts, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x2::table::contains<vector<u8>, vector<u8>>(&arg1.dialog_hashes, arg3)) {
            0x2::table::add<vector<u8>, vector<u8>>(&mut arg1.dialog_hashes, arg3, arg5);
        };
        if (!0x2::table::contains<vector<u8>, vector<u8>>(&arg1.dialog_hashes, arg4)) {
            0x2::table::add<vector<u8>, vector<u8>>(&mut arg1.dialog_hashes, arg4, arg5);
        };
        let v3 = 0x2::table::borrow_mut<vector<u8>, 0x2::table::Table<u64, Message>>(&mut arg0.dialogs, arg5);
        let v4 = Message{
            sender    : v0,
