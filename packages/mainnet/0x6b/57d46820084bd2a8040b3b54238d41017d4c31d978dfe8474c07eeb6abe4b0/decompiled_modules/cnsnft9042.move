module 0x6b57d46820084bd2a8040b3b54238d41017d4c31d978dfe8474c07eeb6abe4b0::cnsnft9042 {
    struct CNSNFT9042 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9042, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2654"));
        let v4 = 0x2::package::claim<CNSNFT9042>(arg0, arg1);
