module 0x6bbd7981802eb9c522488804541655c525bec20839529f9be0abe7ee01428955::cnsnft6327 {
    struct CNSNFT6327 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6327, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6327>(arg0, arg1);
