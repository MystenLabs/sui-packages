module 0x6bd123e1924f6724081cea89b4ec031ae0fd37a37d9c4ce2eac5e7b30ba6c801::cnsnft2124 {
    struct CNSNFT2124 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2124, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2124>(arg0, arg1);
