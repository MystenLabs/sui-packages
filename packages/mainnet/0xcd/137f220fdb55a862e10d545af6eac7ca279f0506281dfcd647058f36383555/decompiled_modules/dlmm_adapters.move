module 0xcd137f220fdb55a862e10d545af6eac7ca279f0506281dfcd647058f36383555::dlmm_adapters {
    ...
    fun append_if_nonincreasing(arg0: &mut vector<u128>, arg1: &mut vector<u128>, arg2: u128, arg3: u128, arg4: u128, arg5: u64, arg6: u128, arg7: u64, arg8: bool, arg9: u64) : bool {
        if (arg6 > 0) {
            if (arg8 && (arg4 as u256) * ((arg9 - arg5) as u256) > (arg6 as u256) * ((arg9 - arg7) as u256) || ((arg9 - arg5) as u256) * (arg6 as u256) > ((arg9 - arg7) as u256) * (arg4 as u256)) {
                return false
            };
        };
                    ...
                    if (arg2) {
                        loop {
                            ...
                            if (v16 > 0) {
                                let v19 = &mut v8;
                                let v20 = &mut v9;
                                if (!append_if_nonincreasing(v19, v20, v15, v16, v17, v18, v6, v7, arg2, 1000000000)) {
                                    v5 = true;
                                    break
                                };
                        ...
                        while (v2 < 16 && 0x1::vector::length<u128>(&v9) < arg3) {
                            ...
                            if (v22 > 0) {
                                let v25 = &mut v8;
                                let v26 = &mut v9;
                                if (!append_if_nonincreasing(v25, v26, v21, v22, v23, v24, v6, v7, arg2, 1000000000)) {
                                    v5 = true;
                                    break
                                };
    ...
    public fun ferra_after_gate<T0, T1>(arg0: &0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::LBPair<T0, T1>, arg1: &0x2::clock::Clock, arg2: bool, arg3: u64, arg4: u64) : (vector<u128>, vector<u128>, vector<u128>, vector<u64>, bool) {
        ...
        let v11 = vector[];
        let v12 = vector[];
        while (0x1::vector::length<u128>(&v10) < arg3 && v6 < arg4) {
            if (arg2 && v5 < v4 || !arg2 && v5 > v3) {
                v7 = true;
                break
            };
            let (v13, v14) = 0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::get_bin<T0, T1>(arg0, v5);
            let v15 = if (arg2) {
                v14
            } else {
                v13
            ...
            if (v15 > 0) {
                let v16 = &mut v2;
                ferra_update_volatility(v16, v5);
                let v17 = 0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::get_price_from_id<T0, T1>(arg0, v5);
                let v18 = ferra_total_fee(&v2);
                let v19 = &mut v9;
                let v20 = &mut v10;
                if (!append_if_nonincreasing(v19, v20, ferra_bin_input_capacity(v15, v17, arg2, v18), (v15 as u128), v17, v18, 0, 0, arg2, 1000000000)) {
                    v8 = true;
                    break
                };
                0x1::vector::push_back<u128>(&mut v11, v17);
    ...
    fun ferra_base_fee_prefix(arg0: &vector<u8>, arg1: u16) : (u64, bool) {
        assert!(0x1::vector::length<u8>(arg0) >= 39 && *0x1::vector::borrow<u8>(arg0, 32) <= 1, 801);
        let v0 = (*0x1::vector::borrow<u8>(arg0, 33) as u16) | (*0x1::vector::borrow<u8>(arg0, 34) as u16) << 8;
        assert!(v0 == arg1, 801);
        let v1 = (v0 as u64) * ((*0x1::vector::borrow<u8>(arg0, 35) as u64) | (*0x1::vector::borrow<u8>(arg0, 36) as u64) << 8 | (*0x1::vector::borrow<u8>(arg0, 37) as u64) << 16 | (*0x1::vector::borrow<u8>(arg0, 38) as u64) << 24);
        assert!(v1 <= 100000000, 801);
        (v1, *0x1::vector::borrow<u8>(arg0, 32) == 1)
    }
    ...
    public fun ferra_current<T0, T1>(arg0: &0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::LBPair<T0, T1>, arg1: bool) : u128 {
        let v0 = 0x1::bcs::to_bytes<0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::LBPair<T0, T1>>(arg0);
        let (v1, v2) = ferra_base_fee_prefix(&v0, 0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::get_bin_step<T0, T1>(arg0));
        if (v2) {
            return 0
        };
        rate_x64(0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::get_price_from_id<T0, T1>(arg0, 0x5a5c1d10e4782dbbdec3eb8327ede04bd078b294b97cfdba447b11b846b383ac::lb_pair::get_active_id<T0, T1>(arg0)), arg1, v1, 1000000000)
    }
