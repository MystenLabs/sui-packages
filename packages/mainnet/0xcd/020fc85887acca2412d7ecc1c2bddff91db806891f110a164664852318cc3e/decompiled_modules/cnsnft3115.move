module 0xcd020fc85887acca2412d7ecc1c2bddff91db806891f110a164664852318cc3e::cnsnft3115 {
    struct CNSNFT3115 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3115, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3115>(arg0, arg1);
