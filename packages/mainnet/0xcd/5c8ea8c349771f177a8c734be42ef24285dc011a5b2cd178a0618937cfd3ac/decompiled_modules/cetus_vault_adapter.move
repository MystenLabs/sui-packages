module 0xcd5c8ea8c349771f177a8c734be42ef24285dc011a5b2cd178a0618937cfd3ac::cetus_vault_adapter {
    ...
    public fun calculate_max_accounted_gap(arg0: u64) : u64 {
        ...
        let v0 = ((((arg0 as u128) * (10 as u128) + 9999) / 10000) as u64);
        if (v0 == 0) {
            1
        } else {
            v0
    ...
    public fun get_net_sui_by_hasui(arg0: &0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg1: u64) : u64 {
        net_sui_value_after_instant_unstake(get_sui_by_hasui(arg0, arg1))
    }
    ...
    public fun get_underlying_balance_in_sui<T0>(arg0: &0xd3453d9be7e35efe222f78a810bb3af1859fd1600926afced8b4936d825c9a05::vaults::Vault<T0>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI, 0x2::sui::SUI>, arg2: &0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking::Staking, arg3: u64) : u128 {
        ...
        (v0 as u128) + (get_net_sui_by_hasui(arg2, v1) as u128)
    }
    ...
    public fun net_sui_value_after_instant_unstake(arg0: u64) : u64 {
        apply_rate_discount(arg0, 2000, 10000000)
    }
