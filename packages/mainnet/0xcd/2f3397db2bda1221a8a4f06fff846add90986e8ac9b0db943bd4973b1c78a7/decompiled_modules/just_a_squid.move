module 0xcd2f3397db2bda1221a8a4f06fff846add90986e8ac9b0db943bd4973b1c78a7::just_a_squid {
    struct JUST_A_SQUID has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: JUST_A_SQUID, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<JUST_A_SQUID>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Just a Squid"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Ika got delayed :("));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreib24iojrzi2gd7y23mor3z44nfemyhtcuxdnq7ohhfermvwwramy4"));
