module 0xcd1999623a1880bb157a898d5b6d30e79aea79161c103353653044d092b8c3d4::reward7713 {
    struct REWARD7713 has drop {
        dummy_field: bool,
    }

    struct TICKET_7713 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7713(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7713>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7713>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7713, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7713>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7713>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7713>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7713>>(v5, 0x2::tx_context::sender(arg1));
    }
