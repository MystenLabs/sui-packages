module 0xcdb9db765f089b1e98aba4e52cf8dfb65ec7604d7b51ff5d995c1b28c7ff3f00::nano_world_editions {
    ...
    fun init(arg0: NANO_WORLD_EDITIONS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<NANO_WORLD_EDITIONS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Nano World Editions"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The first Nano World collection on SUI blockchain"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifcyrfzo5d5utg7t5e4x4cirscnguoez2vy6aw75i43ba2spgicaq"));
