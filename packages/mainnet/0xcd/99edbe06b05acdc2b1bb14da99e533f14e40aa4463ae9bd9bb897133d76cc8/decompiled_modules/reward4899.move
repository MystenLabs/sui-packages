module 0xcd99edbe06b05acdc2b1bb14da99e533f14e40aa4463ae9bd9bb897133d76cc8::reward4899 {
    struct REWARD4899 has drop {
        dummy_field: bool,
    }

    struct TICKET_4899 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4899(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4899>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4899>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4899, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4899>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4899>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4899>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4899>>(v5, 0x2::tx_context::sender(arg1));
    }
