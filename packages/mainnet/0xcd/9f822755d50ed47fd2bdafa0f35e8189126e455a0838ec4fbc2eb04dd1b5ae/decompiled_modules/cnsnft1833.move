module 0xcd9f822755d50ed47fd2bdafa0f35e8189126e455a0838ec4fbc2eb04dd1b5ae::cnsnft1833 {
    struct CNSNFT1833 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1833, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1833>(arg0, arg1);
