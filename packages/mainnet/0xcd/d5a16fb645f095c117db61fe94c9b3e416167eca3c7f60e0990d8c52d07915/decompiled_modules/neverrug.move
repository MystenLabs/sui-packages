module 0xcdd5a16fb645f095c117db61fe94c9b3e416167eca3c7f60e0990d8c52d07915::neverrug {
    ...
    fun init(arg0: NEVERRUG, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NEVERRUG>(arg0, 6, b"Never Rug Token", b"NEVERRUG", b"This token is created to be 100% profit investment, say no to rug", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
