module 0xcd4dcfe730791bfb0c096e1d3e2fba99946174676631e5267012841d3d6eb830::reward7067 {
    struct REWARD7067 has drop {
        dummy_field: bool,
    }

    struct TICKET_7067 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7067(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7067>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7067>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7067, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7067>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7067>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7067>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7067>>(v5, 0x2::tx_context::sender(arg1));
    }
