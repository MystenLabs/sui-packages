module 0xcdc45e86e5386fdadb5c270d3e8780a15190c5f3f18d88e509738bc9b1416af0::dogesui {
    ...
    fun init(arg0: DOGESUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DOGESUI>(arg0, 4, b"DOGESUI", b"Dogecoin Sui", b"The first Meme Coin on Sui Blockchain. LP HAS BEEN BURNT 100%! SAFE 100%. Telegram : t.me/Dogecoinsui , Twitter : https://twitter.com/dogecoinsui", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
