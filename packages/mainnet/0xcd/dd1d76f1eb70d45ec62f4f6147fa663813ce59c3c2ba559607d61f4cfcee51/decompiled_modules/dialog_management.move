module 0xcddd1d76f1eb70d45ec62f4f6147fa663813ce59c3c2ba559607d61f4cfcee51::dialog_management {
    ...
    public fun get_messages_after_time(arg0: &UserDialogs, arg1: vector<u8>, arg2: u64, arg3: u64) {
        ...
        while (v4 < arg3) {
            if (0x2::table::contains<u64, Message>(v2, v3)) {
                let v5 = 0x2::table::borrow<u64, Message>(v2, v3);
                if (v5.timestamp >= arg2) {
                    0x1::vector::push_back<Message>(&mut v0, *v5);
                    v4 = v4 + 1;
                };
            };
            v3 = v3 + 1;
        };
        let v6 = MessagesEvent{
            dialog_hash : arg1,
            messages    : v0,
        };
