module 0x5e8e04ba8cbe15a242f2e72fc4d46f547407b95acfaa05ebc98c2d35562b98ef::pet_display {
    ...
    fun create_display(arg0: PET_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<0x5e8e04ba8cbe15a242f2e72fc4d46f547407b95acfaa05ebc98c2d35562b98ef::frajder::Pet>(&mut v2, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"FRAJDER Genesis Pet #{catalog_id}"));
        ...
        0x2::display::add<0x5e8e04ba8cbe15a242f2e72fc4d46f547407b95acfaa05ebc98c2d35562b98ef::frajder::Pet>(&mut v2, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://QmUJmKmCVFT9NrtRqUPw1kAhTtSBREMATZqJe45nEn88hC/images/{catalog_id}.png"));
        0x2::display::add<0x5e8e04ba8cbe15a242f2e72fc4d46f547407b95acfaa05ebc98c2d35562b98ef::frajder::Pet>(&mut v2, 0x1::string::utf8(b"metadata_url"), 0x1::string::utf8(b"ipfs://QmQzvVQLgAGAPgiKZU24ajmcFDfhZiJAxGJjRs83F497d6/metadata/{catalog_id}.json"));
