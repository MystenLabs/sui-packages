module 0xcd1ec3a2cb66848b3ee7b6f622adebfa246f89f4f336769ef7210f50bf9e330e::seed_nft {
    ...
    public entry fun buy<T0: store + key>(arg0: &mut Marketplace, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        let List {
            id            : v0,
            seller        : v1,
            nft           : v2,
        ...
        assert!(0x2::tx_context::sender(arg3) != v1, 126);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg2) == v3, 125);
    ...
    public entry fun mint_to_sender(arg0: vector<u8>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: address, arg5: address, arg6: address, arg7: u128, arg8: u128, arg9: u128, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = SeedNFT{
            ...
            transfer_count          : 0,
            caretors                : 0x1::vector::empty<Creator>(),
