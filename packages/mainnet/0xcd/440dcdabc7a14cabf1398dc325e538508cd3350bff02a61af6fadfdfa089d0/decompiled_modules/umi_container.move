module 0xcd440dcdabc7a14cabf1398dc325e538508cd3350bff02a61af6fadfdfa089d0::umi_container {
    ...
    public fun deposit_cap<T0: store + key>(arg0: &mut UmiContainer, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!contains_id(&arg0.cap_ids, v1), 2);
        0x2::dynamic_object_field::add<0x2::object::ID, T0>(&mut arg0.id, v1, arg1);
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.cap_ids, v1);
        let v2 = CapDeposited{
            container_id : 0x2::object::id<UmiContainer>(arg0),
            owner        : v0,
            cap_id       : v1,
        };
        0x2::event::emit<CapDeposited>(v2);
    }
