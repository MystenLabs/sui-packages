module 0xcd1d52c0bcfdc6bd67d6d79340c9995774e1b128b15afea467c94bb0ba3a37b7::pat {
    struct PAT has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<PAT>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<PAT>>(0x2::coin::mint<PAT>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: PAT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<PAT>>(0x2::coin::mint<PAT>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
