module 0xcd76061f164b1f3d524c954020e52643ef9d41ca55d3ac4b3c758134a59ad79b::ve_sca_display {
    ...
    fun init(arg0: VE_SCA_DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::display::new_with_fields<0xcd76061f164b1f3d524c954020e52643ef9d41ca55d3ac4b3c758134a59ad79b::ve_sca::VeScaKey>(&v0, v1, v3, arg1);
        0x2::display::update_version<0xcd76061f164b1f3d524c954020e52643ef9d41ca55d3ac4b3c758134a59ad79b::ve_sca::VeScaKey>(&mut v5);
        let v6 = 0x2::tx_context::sender(arg1);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, v6);
        0x2::transfer::public_transfer<0x2::display::Display<0xcd76061f164b1f3d524c954020e52643ef9d41ca55d3ac4b3c758134a59ad79b::ve_sca::VeScaKey>>(v5, v6);
    }
