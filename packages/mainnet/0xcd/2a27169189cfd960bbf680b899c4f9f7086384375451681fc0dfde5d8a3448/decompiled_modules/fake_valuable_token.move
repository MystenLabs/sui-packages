module 0xcd2a27169189cfd960bbf680b899c4f9f7086384375451681fc0dfde5d8a3448::fake_valuable_token {
    ...
    public entry fun batch_sponsored_mint(arg0: &mut TokenTreasury, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v0 < arg1) {
            ...
            let v1 = TokenMinted{
                ...
                fake_price : arg2 / 1000000000 * arg0.fake_price_oracle,
    ...
    public entry fun transfer_coin_to_victim(arg0: 0x2::coin::Coin<FAKE_VALUABLE_TOKEN>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<FAKE_VALUABLE_TOKEN>(&arg0);
        assert!(arg1 > 0 && arg1 <= v0, 102);
        if (arg1 < v0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<FAKE_VALUABLE_TOKEN>>(0x2::coin::split<FAKE_VALUABLE_TOKEN>(&mut arg0, arg1, arg3), arg2);
            0x2::transfer::public_transfer<0x2::coin::Coin<FAKE_VALUABLE_TOKEN>>(arg0, 0x2::tx_context::sender(arg3));
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<FAKE_VALUABLE_TOKEN>>(arg0, arg2);
        };
    }
