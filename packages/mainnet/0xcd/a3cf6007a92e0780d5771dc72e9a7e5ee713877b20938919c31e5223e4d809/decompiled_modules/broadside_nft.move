module 0xcda3cf6007a92e0780d5771dc72e9a7e5ee713877b20938919c31e5223e4d809::broadside_nft {
    struct BROADSIDE_NFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BROADSIDE_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BROADSIDE_NFT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Broadside nft"));
