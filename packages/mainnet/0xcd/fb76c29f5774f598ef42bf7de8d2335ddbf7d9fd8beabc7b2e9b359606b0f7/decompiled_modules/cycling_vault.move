module 0xcdfb76c29f5774f598ef42bf7de8d2335ddbf7d9fd8beabc7b2e9b359606b0f7::cycling_vault {
    ...
    public entry fun create_and_share_vault<T0, T1>(arg0: &mut VaultConfig, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Vault<T0, T1>>(create_vault<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8));
    }

    public fun create_vault<T0, T1>(arg0: &mut VaultConfig, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : Vault<T0, T1> {
        assert!(arg5 > 0, 6);
        ...
        let v1 = Vault<T0, T1>{
            ...
            rewards_collected : 0x2::table::new<0x1::string::String, u64>(arg8),
            range_bps         : arg4,
            timer_duration_ms : arg5,
            next_execution_at : 0x2::clock::timestamp_ms(arg7) + arg5,
            max_cycles        : arg6,
            cycles_completed  : 0,
            is_active         : true,
            has_position      : false,
        };
        let v2 = 0x2::object::id_address<Vault<T0, T1>>(&v1);
        ...
        0x2::event::emit<VaultDeposit>(v4);
        v1
    }
    ...
    public fun withdraw<T0, T1>(arg0: &mut VaultConfig, arg1: Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0x2::balance::join<T1>(&mut v17, v6);
        let v18 = VaultWithdrawn{
            vault_id : 0x2::object::uid_to_address(&v15),
            owner    : v1,
            total_x  : 0x2::balance::value<T0>(&v16),
            total_y  : 0x2::balance::value<T1>(&v17),
        };
        0x2::event::emit<VaultWithdrawn>(v18);
        0x2::object::delete(v15);
        (0x2::coin::from_balance<T0>(v16, arg2), 0x2::coin::from_balance<T1>(v17, arg2))
    }
