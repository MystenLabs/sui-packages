module 0xcdfb76c29f5774f598ef42bf7de8d2335ddbf7d9fd8beabc7b2e9b359606b0f7::lp_registry {
    ...
    public fun exit<T0: store + key>(arg0: &mut LPRegistry, arg1: RegisteredPosition, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        ...
        let v16 = v0;
        let v17 = 0x2::dynamic_object_field::remove<vector<u8>, T0>(&mut v16, b"position");
        0x2::object::delete(v16);
        arg0.total_exited = arg0.total_exited + 1;
        let v18 = PositionExited{
            registry_id : 0x2::object::uid_to_address(&v16),
            position_id : 0x2::object::id_address<T0>(&v17),
            owner       : v1,
        };
        0x2::event::emit<PositionExited>(v18);
        v17
    }
    ...
    public fun get_position_info(arg0: &RegisteredPosition) : (address, address, bool, bool, u64, u64, u64, bool, bool) {
        (arg0.owner, arg0.pool_id, arg0.auto_rebalance, arg0.auto_compound, arg0.recurring_count, arg0.rebalance_delay_ms, arg0.range_percent_bps, arg0.is_paused, arg0.is_position_held)
    }
    ...
    public entry fun register_position<T0: store + key>(arg0: &mut LPRegistry, arg1: T0, arg2: address, arg3: bool, arg4: bool, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun update_settings(arg0: &mut RegisteredPosition, arg1: bool, arg2: bool, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.last_activity_at = 0x2::clock::timestamp_ms(arg6);
