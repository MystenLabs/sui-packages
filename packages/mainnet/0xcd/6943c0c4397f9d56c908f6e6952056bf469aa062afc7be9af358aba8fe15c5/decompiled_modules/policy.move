module 0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::policy {
    ...
    struct MaxPerTxSet has copy, drop {
        policy_id: 0x2::object::ID,
        max_per_tx_mist: u64,
    }

    struct BudgetSet has copy, drop {
        policy_id: 0x2::object::ID,
        budget_mist: u64,
    }

    struct WindowBudgetSet has copy, drop {
        policy_id: 0x2::object::ID,
        window_budget_mist: u64,
    }
    ...
    public fun add_allowed_coin(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: vector<u8>) {
        ...
        if (0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::allowlist::insert_bytes(&mut arg0.allowed_coins, arg2)) {
    ...
    public fun add_allowed_protocol(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: address) {
        assert_owner(arg0, arg1);
        if (0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::allowlist::insert_addr(&mut arg0.allowed_protocols, arg2)) {
    ...
    fun assert_current_version(arg0: &AgentPolicy) {
        assert!(arg0.version == 0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::constants::version(), 10);
    }
    ...
    fun coin_allowed(arg0: &AgentPolicy, arg1: &vector<u8>) : bool {
        0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::allowlist::allows_bytes(&arg0.allowed_coins, arg1)
    }

    entry fun create_policy(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<vector<u8>>, arg7: vector<address>, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = new_policy(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        0x2::transfer::public_transfer<PolicyOwnerCap>(v1, 0x2::tx_context::sender(arg10));
    ...
    public fun enforce_spend<T0>(arg0: &mut AgentPolicy, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::receipt::ActionReceipt {
        ...
        if (arg0.window_ms > 0) {
            if (v0 >= arg0.window_start_ms + arg0.window_ms) {
                arg0.window_start_ms = v0;
                arg0.window_spent_mist = 0;
            };
            assert!(arg0.window_spent_mist + arg1 <= arg0.window_budget_mist, 12);
            arg0.window_spent_mist = arg0.window_spent_mist + arg1;
        };
        ...
        0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::receipt::issue(0x2::object::id<AgentPolicy>(arg0), arg0.agent, arg3, v1, arg2, arg1, arg0.spent_mist, arg4, v0, arg6)
    }
    ...
    public fun migrate(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap) {
        assert_owner(arg0, arg1);
        let v0 = arg0.version;
        assert!(v0 < 0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::constants::version(), 11);
    ...
    public fun new_policy(arg0: address, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: vector<vector<u8>>, arg7: vector<address>, arg8: u64, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : (AgentPolicy, PolicyOwnerCap) {
        ...
        let v2 = AgentPolicy{
            ...
            window_ms          : arg3,
            window_budget_mist : arg4,
            window_spent_mist  : 0,
            window_start_ms    : v1,
            max_slippage_bps   : arg5,
            allowed_coins      : arg6,
            allowed_protocols  : arg7,
            allowed_recipients : vector[],
            expiry_ms          : arg8,
            revoked            : false,
            created_ms         : v1,
        };
        let v3 = 0x2::object::id<AgentPolicy>(&v2);
        let v4 = PolicyOwnerCap{
            id        : 0x2::object::new(arg10),
            policy_id : v3,
        };
        let v5 = PolicyCreated{
            policy_id       : v3,
            owner           : v0,
            agent           : arg0,
            budget_mist     : arg1,
        ...
        0x2::event::emit<PolicyCreated>(v5);
        (v2, v4)
    }
    ...
    fun protocol_allowed(arg0: &AgentPolicy, arg1: address) : bool {
        arg1 == 0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::constants::no_protocol() || 0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::allowlist::allows_addr(&arg0.allowed_protocols, arg1)
    }

    public fun recipient_allowed(arg0: &AgentPolicy, arg1: address) : bool {
        0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::allowlist::allows_addr(&arg0.allowed_recipients, arg1)
    }

    entry fun record_action<T0>(arg0: &AgentPolicy, arg1: u64, arg2: address, arg3: vector<u8>, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_current_version(arg0);
        assert!(0x2::tx_context::sender(arg6) == arg0.agent, 0);
        assert!(!arg0.revoked, 1);
        0x2::transfer::public_transfer<0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::receipt::ActionReceipt>(0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::receipt::issue(0x2::object::id<AgentPolicy>(arg0), arg0.agent, arg3, 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>())), arg2, arg1, arg0.spent_mist, arg4, 0x2::clock::timestamp_ms(arg5), arg6), arg0.owner);
    }
    ...
    public fun remove_allowed_coin(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: vector<u8>) {
        assert_owner(arg0, arg1);
        if (0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::allowlist::remove_bytes(&mut arg0.allowed_coins, &arg2)) {
            emit_coin_changed(arg0);
        };
    }
    ...
    public fun remove_allowed_protocol(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: address) {
        assert_owner(arg0, arg1);
        if (0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::allowlist::remove_addr(&mut arg0.allowed_protocols, arg2)) {
            emit_protocol_changed(arg0);
        };
    }
    ...
    public fun set_budget(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: u64) {
        assert_owner(arg0, arg1);
        assert!(arg2 >= arg0.spent_mist, 13);
        arg0.budget_mist = arg2;
        let v0 = BudgetSet{
            policy_id   : 0x2::object::id<AgentPolicy>(arg0),
            budget_mist : arg2,
        };
        0x2::event::emit<BudgetSet>(v0);
    }

    public fun set_max_per_tx(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: u64) {
        assert_owner(arg0, arg1);
        arg0.max_per_tx_mist = arg2;
        let v0 = MaxPerTxSet{
            policy_id       : 0x2::object::id<AgentPolicy>(arg0),
            max_per_tx_mist : arg2,
        };
        0x2::event::emit<MaxPerTxSet>(v0);
    }

    public fun set_window_budget(arg0: &mut AgentPolicy, arg1: &PolicyOwnerCap, arg2: u64) {
        assert_owner(arg0, arg1);
        arg0.window_budget_mist = arg2;
        let v0 = WindowBudgetSet{
            policy_id          : 0x2::object::id<AgentPolicy>(arg0),
            window_budget_mist : arg2,
        };
        0x2::event::emit<WindowBudgetSet>(v0);
    }
    ...
    public fun window_budget_mist(arg0: &AgentPolicy) : u64 {
        arg0.window_budget_mist
    }

    public fun window_ms(arg0: &AgentPolicy) : u64 {
        arg0.window_ms
    }

    public fun window_spent_mist(arg0: &AgentPolicy) : u64 {
        arg0.window_spent_mist
    }

    public fun would_allow<T0>(arg0: &AgentPolicy, arg1: u64, arg2: address, arg3: &0x2::clock::Clock) : bool {
        if (arg0.version == 0x8b2412e9a5d931cafa533d29daf8c91edacda28d6a689cbdecacf2a092380e14::constants::version()) {
            if (!arg0.revoked) {
                if (arg1 > 0) {
