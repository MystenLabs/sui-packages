module 0xcdd99d67cbd727b154763503daa0b90b26b2c5079c8c2ee2467d6a327cda6b86::reward2805 {
    struct REWARD2805 has drop {
        dummy_field: bool,
    }

    struct TICKET_2805 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2805(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2805>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2805>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2805, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2805>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2805>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2805>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2805>>(v5, 0x2::tx_context::sender(arg1));
    }
