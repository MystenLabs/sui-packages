module 0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::gas_optimized_arbitrage {
    ...
    fun execute_real_swap_step_1<T0>(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u8, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        if (arg1 == 0) {
            0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_aftermath::get_real_router_package_address();
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
            0x2::coin::zero<T0>(arg3)
        } else if (arg1 == 1) {
            0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_cetus::get_cetus_package();
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
            0x2::coin::zero<T0>(arg3)
        } else if (arg1 == 2) {
            let (_, _, _) = 0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_bluefin::bluefin_swap_exact_sui_for_token<T0>(0x2::coin::value<0x2::sui::SUI>(&arg0), 0, arg3);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
            0x2::coin::zero<T0>(arg3)
        } else if (arg1 == 3) {
            let (_, _, _) = 0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_kriya::kriya_swap_exact_sui_for_token<T0>(0x2::coin::value<0x2::sui::SUI>(&arg0), 0, arg3);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
            0x2::coin::zero<T0>(arg3)
        } else if (arg1 == 4) {
            let (_, _, _, _, _) = 0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_turbos::turbos_swap_exact_sui_for_token<T0>(0x2::coin::value<0x2::sui::SUI>(&arg0), 0, 4295048016, 999999999999, arg3);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
            0x2::coin::zero<T0>(arg3)
        } else {
            0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_deepbook::get_deepbook_package();
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg0, 0x2::tx_context::sender(arg3));
            0x2::coin::zero<T0>(arg3)
        }
    }
    ...
    fun execute_real_swap_step_2<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u8, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        if (arg1 == 0) {
            ...
            let (_, _, _) = 0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_bluefin::bluefin_swap_exact_token_for_sui<T0>(0x2::coin::value<T0>(&arg0), arg3, arg4);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg0, 0x2::tx_context::sender(arg4));
            0x2::coin::zero<0x2::sui::SUI>(arg4)
        } else if (arg1 == 3) {
            let (_, _, _) = 0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_kriya::kriya_swap_exact_token_for_sui<T0>(0x2::coin::value<T0>(&arg0), arg3, arg4);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg0, 0x2::tx_context::sender(arg4));
            0x2::coin::zero<0x2::sui::SUI>(arg4)
        } else if (arg1 == 4) {
            let (_, _, _, _, _) = 0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_turbos::turbos_swap_exact_token_for_sui<T0>(0x2::coin::value<T0>(&arg0), arg3, 79226673515401279992447579055, 999999999999, arg4);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg0, 0x2::tx_context::sender(arg4));
            0x2::coin::zero<0x2::sui::SUI>(arg4)
        } else {
            0xcddaa2147a45108af6804fdcb17b1dd9848005b72f1865e0091800826b47326c::dex_deepbook::get_deepbook_package();
