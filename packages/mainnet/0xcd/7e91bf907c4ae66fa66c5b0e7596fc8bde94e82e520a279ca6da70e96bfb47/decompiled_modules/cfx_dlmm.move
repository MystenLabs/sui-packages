module 0xcd7e91bf907c4ae66fa66c5b0e7596fc8bde94e82e520a279ca6da70e96bfb47::cfx_dlmm {
    ...
    fun sw<T0, T1>(arg0: &mut 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::Pool<T0, T1>, arg1: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg3: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::config::GlobalConfig, arg4: &0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::versioned::Versioned, arg5: &0x2::clock::Clock, arg6: u128, arg7: bool, arg8: u64, arg9: u64, arg10: u8, arg11: u8, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        loop {
            ...
            let (v5, v6, v7) = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::flash_swap<T0, T1>(arg0, arg7, true, v4, arg3, arg4, arg5, arg13);
            let v8 = v7;
            let v9 = v6;
            let v10 = v5;
            let v11 = 0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::pay_amount<T0, T1>(&v8);
            if (v11 == 0) {
                let v12 = 0x2::coin::from_balance<T0>(v10, arg13);
                if (0x2::coin::value<T0>(&v12) > 0) {
                    0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::deposit_coin<T0>(arg1, v12);
                } else {
                    0x2::coin::destroy_zero<T0>(v12);
                };
                let v13 = 0x2::coin::from_balance<T1>(v9, arg13);
                if (0x2::coin::value<T1>(&v13) > 0) {
                    0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::deposit_coin<T1>(arg2, v13);
                } else {
                    0x2::coin::destroy_zero<T1>(v13);
                };
                0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::repay_flash_swap<T0, T1>(arg0, 0x2::balance::zero<T0>(), 0x2::balance::zero<T1>(), v8, arg4);
                break
            };
            assert!(v11 <= v3, 5);
            let v14 = if (arg7) {
            ...
            assert!(v14 >= imo(v11, arg6, arg7), 6);
            let (v15, v16) = if (arg7) {
                (0x2::coin::into_balance<T0>(0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T0>(arg1, v11, arg13)), 0x2::balance::zero<T1>())
            } else {
                (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::withdraw_coin<T1>(arg2, v11, arg13)))
            };
            0x5664f9d3fd82c84023870cfbda8ea84e14c8dd56ce557ad2116e0668581a682b::pool::repay_flash_swap<T0, T1>(arg0, v15, v16, v8, arg4);
            let v17 = 0x2::coin::from_balance<T0>(v10, arg13);
            ...
            let v18 = 0x2::coin::from_balance<T1>(v9, arg13);
