module 0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::raffle {
    ...
    public fun add_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun add_ticket_options<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg2: vector<u64>, arg3: vector<u64>) {
    ...
    public fun create(arg0: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg1: Prize, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_treasury(arg0: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun disable_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap) {
        let v0 = 0x1::type_name::get<T0>();
    ...
    public fun enable_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.accepted_coins, v0)) {
    ...
    public fun extend_raffle(arg0: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg1: &mut Raffle, arg2: u64, arg3: &0x2::clock::Clock) {
    ...
    public fun lucky_number(arg0: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg1: &mut Raffle, arg2: &0x2::clock::Clock, arg3: vector<u8>, arg4: vector<u8>) {
        assert!(0x2::clock::timestamp_ms(arg2) > arg1.end_date, 4);
        assert!(arg1.winning_ticket == 0, 5);
        let v0 = 0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::drand_utils::safe_selection(arg1.total_tickets, arg1.drand_round, arg3, arg4);
    ...
    public fun new_prize(arg0: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg1: 0x1::string::String, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : Prize {
        Prize{
    ...
    public fun remove_accepted_coin_type<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap) {
        let v0 = 0x1::type_name::get<T0>();
        if (0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.accepted_coins, v0)) {
    ...
    public fun remove_ticket_option<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg2: u64) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::table::contains<0x1::type_name::TypeName, bool>(&arg0.accepted_coins, v0), 16);
    ...
    public fun update_ticket_options<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg2: vector<u64>, arg3: vector<u64>) {
        assert!(0x1::vector::length<u64>(&arg2) == 0x1::vector::length<u64>(&arg3), 8);
        let v0 = get_valid_coin_type<T0>(arg0);
        while (!0x1::vector::is_empty<u64>(&arg2)) {
            let v1 = 0x1::vector::pop_back<u64>(&mut arg2);
    ...
    public fun withdraw_proceeds<T0>(arg0: &mut RaffleTreasury, arg1: &0xcd56b7bd65f1a1f7b91dc3360ba570bc36214039e4bf8e78f081a2281f5a179a::admin::AdminCap, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x1::type_name::get<T0>();
