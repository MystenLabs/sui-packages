module 0xcd2ef053a12b63c99bb52454d8dd4d1d252a3e5c9006bca27ce6f4f10d818c49::cnsnft5463 {
    struct CNSNFT5463 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5463, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5463>(arg0, arg1);
