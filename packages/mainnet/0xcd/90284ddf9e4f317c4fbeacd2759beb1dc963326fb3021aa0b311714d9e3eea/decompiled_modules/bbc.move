module 0xcd90284ddf9e4f317c4fbeacd2759beb1dc963326fb3021aa0b311714d9e3eea::bbc {
    struct BBC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BBC, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CmAtKbUSM2HErtaQmonrxiV7qXo3mDganWw9KEimbutt.png?size=lg&key=0ebd4e                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BBC>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BBC     ")))), trim_right(b"Blue Butt Cheese                "), trim_right(b"Blue Butt Cheese is the ultimate memecoin for degens, inspired by Matt Furies wild Hedz collection. Packed with humour,                                                                                                                                                                                                         "), v2, arg1);
        let v5 = v3;
