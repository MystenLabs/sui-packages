module 0xcd9e090a3609aa3c1702331fa9d133fce503dc69f3fbc0f6071a80e3da319e5f::atomic_arbitrage {
    ...
    public entry fun execute_arbitrage(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1 > 0, 701);
        0xcd9e090a3609aa3c1702331fa9d133fce503dc69f3fbc0f6071a80e3da319e5f::dex_bluefin::swap_sui_to_usdc(arg0, arg1, arg2, arg3);
    }
    ...
    public entry fun swap_tokens_bluefin(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 700);
        0xcd9e090a3609aa3c1702331fa9d133fce503dc69f3fbc0f6071a80e3da319e5f::dex_bluefin::swap_sui_to_usdc(arg0, arg1, arg3, arg4);
        let v1 = SwapExecuted{
    ...
    public entry fun swap_tokens_cetus(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 700);
        0xcd9e090a3609aa3c1702331fa9d133fce503dc69f3fbc0f6071a80e3da319e5f::dex_cetus::swap_sui_to_usdc(arg0, arg1, arg3, arg4);
        let v1 = SwapExecuted{
            sender     : 0x2::tx_context::sender(arg4),
    ...
    public entry fun swap_tokens_turbos(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 700);
        0xcd9e090a3609aa3c1702331fa9d133fce503dc69f3fbc0f6071a80e3da319e5f::dex_turbos::swap_sui_to_usdc(arg0, arg1, arg3, arg4);
        let v1 = SwapExecuted{
            sender     : 0x2::tx_context::sender(arg4),
