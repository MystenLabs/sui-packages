module 0xcd1b2f3de8833b77293bf9dd25498e6a5b38bf6ac15e859069bc79bc8d0ebfb0::cnsnft1361 {
    struct CNSNFT1361 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1361, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9104"));
        let v4 = 0x2::package::claim<CNSNFT1361>(arg0, arg1);
