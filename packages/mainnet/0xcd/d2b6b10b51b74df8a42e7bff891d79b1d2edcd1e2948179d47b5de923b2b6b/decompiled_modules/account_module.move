module 0xcdd2b6b10b51b74df8a42e7bff891d79b1d2edcd1e2948179d47b5de923b2b6b::account_module {
    ...
    public fun check_rate(arg0: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market) : u64 {
        ...
        while (v7 < 0x1::vector::length<0x1::type_name::TypeName>(&v6)) {
            ...
            if (0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::type_name(v10) == 0x1::type_name::get<0x2::sui::SUI>()) {
                let v15 = v2 * 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::borrow_dynamics::interest_rate(v9)) * (v1 - 0x1::fixed_point32::get_raw_value(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::interest_model::revenue_factor(v10))) / v1 / 1361925194;
                let v16 = APYEvent{apy: v15};
                0x2::event::emit<APYEvent>(v16);
                let v17 = APYEvent{apy: v15};
                0x2::event::emit<APYEvent>(v17);
                let v18 = APYEvent{apy: v0};
