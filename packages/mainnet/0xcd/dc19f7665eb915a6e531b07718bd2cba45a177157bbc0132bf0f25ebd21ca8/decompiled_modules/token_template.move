module 0xcddc19f7665eb915a6e531b07718bd2cba45a177157bbc0132bf0f25ebd21ca8::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T085212", b"Test 085212", b"Integration test token 2025-10-28T00:41:25.212Z", 0x1::option::none<0x2::url::Url>(), arg1);
