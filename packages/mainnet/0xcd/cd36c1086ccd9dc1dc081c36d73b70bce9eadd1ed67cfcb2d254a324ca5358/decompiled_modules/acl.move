module 0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::acl {
    ...
    public fun new(arg0: &mut 0x2::tx_context::TxContext) : ACL {
        ...
        0x2::vec_set::insert<address>(&mut v1, @0xe802f70133f9da29298de788b2229107d57f2f80867da2695c57ab60072c0da1);
        let v2 = 0x2::table::new<u8, 0x2::vec_set::VecSet<address>>(arg0);
        0x2::table::add<u8, 0x2::vec_set::VecSet<address>>(&mut v2, 0, v1);
        0x2::table::add<u8, 0x2::vec_set::VecSet<address>>(&mut v2, 1, v0);
        0x2::table::add<u8, 0x2::vec_set::VecSet<address>>(&mut v2, 2, v0);
        ACL{
            admins           : v0,
            roles            : v2,
    ...
    public fun cancel(arg0: &mut ACL, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
    ...
    public fun execute(arg0: &mut ACL, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(is_admin(arg0, v0), 1);
        assert!(0x2::table::contains<u64, Proposal>(&arg0.proposals, arg1), 5);
        let v1 = 0x2::table::borrow<u64, Proposal>(&arg0.proposals, arg1);
    ...
    public fun propose(arg0: &mut ACL, arg1: u8, arg2: u8, arg3: address, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : u64 {
    ...
    public fun set_publisher(arg0: &mut ACL, arg1: 0x2::package::Publisher, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun set_upgrade_cap(arg0: &mut ACL, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
    ...
    public fun vote(arg0: &mut ACL, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(is_admin(arg0, v0), 1);
        assert!(0x2::table::contains<u64, Proposal>(&arg0.proposals, arg1), 5);
