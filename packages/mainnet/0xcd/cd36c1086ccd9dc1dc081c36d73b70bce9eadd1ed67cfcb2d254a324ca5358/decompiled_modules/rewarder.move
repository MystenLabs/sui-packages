module 0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) {
    ...
    public fun emergent_withdraw<T0>(arg0: &0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::config::checked_package_version(arg0);
        0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::config::check_reward_role(arg0, 0x2::tx_context::sender(arg3));
        let v0 = withdraw_reward<T0>(arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::config::get_reward_receiver(arg0));
    ...
    public(friend) fun update_emission<T0>(arg0: &RewarderGlobalVault, arg1: &mut RewarderManager, arg2: 0x2::object::ID, arg3: u128) {
        ...
        if (arg3 > v2 && arg3 > 0) {
            assert!(balance_of<T0>(arg0) >= 0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::safe_math::u128_to_u64(0xcdcd36c1086ccd9dc1dc081c36d73b70bce9eadd1ed67cfcb2d254a324ca5358::safe_math::mul_u128(arg3, (86400 as u128))), 3003);
        };
