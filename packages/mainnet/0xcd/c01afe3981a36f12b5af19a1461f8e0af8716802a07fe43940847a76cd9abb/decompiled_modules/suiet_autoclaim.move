module 0xcdc01afe3981a36f12b5af19a1461f8e0af8716802a07fe43940847a76cd9abb::suiet_autoclaim {
    ...
    fun init(arg0: SUIET_AUTOCLAIM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<AutoclaimNFT>(&mut v1, 0x1::string::utf8(b"project_url"), 0x1::string::utf8(b"https://suiet.app"));
        0x2::display::add<AutoclaimNFT>(&mut v1, 0x1::string::utf8(b"creator"), 0x1::string::utf8(b"Suiet"));
