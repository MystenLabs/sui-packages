module 0xcdf014c01d7af4a4a30c128fe7773034c4ff3e48399236ba46af867d90548bb9::cnsnft6933 {
    struct CNSNFT6933 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6933, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6933>(arg0, arg1);
