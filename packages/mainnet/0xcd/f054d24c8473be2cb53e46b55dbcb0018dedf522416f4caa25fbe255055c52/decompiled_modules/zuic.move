module 0xcdf054d24c8473be2cb53e46b55dbcb0018dedf522416f4caa25fbe255055c52::zuic {
    ...
    fun init(arg0: ZUIC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<ZUIC>(arg0, 18, b"ZUIC", b"ZUIC", b"ZUIC COIN is platform token for ZUIC ecosystem", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://www.svgrepo.com/show/33322/dollar-coin.svg")), arg1);
