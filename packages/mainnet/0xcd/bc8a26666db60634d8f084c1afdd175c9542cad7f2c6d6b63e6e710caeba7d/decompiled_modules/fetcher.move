module 0xcdbc8a26666db60634d8f084c1afdd175c9542cad7f2c6d6b63e6e710caeba7d::fetcher {
    ...
    public entry fun test<T0, T1>(arg0: &0xdee9::clob_v2::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
        let (v0, v1) = 0xdee9::clob_v2::get_level2_book_status_bid_side<T0, T1>(arg0, 0, 1000000, arg3);
        let v2 = v1;
        let v3 = v0;
        let v4 = TestEvent{
