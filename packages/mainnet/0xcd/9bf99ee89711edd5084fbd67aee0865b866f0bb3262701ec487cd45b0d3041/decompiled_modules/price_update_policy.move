module 0xcd9bf99ee89711edd5084fbd67aee0865b866f0bb3262701ec487cd45b0d3041::price_update_policy {
    struct PriceUpdateRequest<phantom T0> {
        for: 0x2::object::ID,
        receipts: 0x2::vec_set::VecSet<0x1::type_name::TypeName>,
        price_feeds: vector<0xcd9bf99ee89711edd5084fbd67aee0865b866f0bb3262701ec487cd45b0d3041::price_feed::PriceFeed>,
    }
    ...
    public fun add_price_feed<T0, T1: drop>(arg0: T1, arg1: &mut PriceUpdateRequest<T0>, arg2: 0xcd9bf99ee89711edd5084fbd67aee0865b866f0bb3262701ec487cd45b0d3041::price_feed::PriceFeed) {
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg1.receipts, 0x1::type_name::get<T1>());
        0x1::vector::push_back<0xcd9bf99ee89711edd5084fbd67aee0865b866f0bb3262701ec487cd45b0d3041::price_feed::PriceFeed>(&mut arg1.price_feeds, arg2);
    }

    public fun add_rule<T0>(arg0: &mut PriceUpdatePolicy, arg1: &PriceUpdatePolicyCap) {
        assert!(0x2::object::id<PriceUpdatePolicy>(arg0) == arg1.for, 2);
        0x2::vec_set::insert<0x1::type_name::TypeName>(&mut arg0.rules, 0x1::type_name::get<T0>());
    }

    public fun confirm_request<T0>(arg0: PriceUpdateRequest<T0>, arg1: &PriceUpdatePolicy) : vector<0xcd9bf99ee89711edd5084fbd67aee0865b866f0bb3262701ec487cd45b0d3041::price_feed::PriceFeed> {
        let PriceUpdateRequest {
            for         : v0,
            receipts    : v1,
            price_feeds : v2,
        } = arg0;
        assert!(v0 == 0x2::object::id<PriceUpdatePolicy>(arg1), 1);
        let v3 = 0x2::vec_set::into_keys<0x1::type_name::TypeName>(v1);
        let v4 = 0x1::vector::length<0x1::type_name::TypeName>(&v3);
        assert!(v4 == 0x2::vec_set::size<0x1::type_name::TypeName>(&arg1.rules), 0);
        let v5 = 0;
        while (v5 < v4) {
            let v6 = 0x1::vector::pop_back<0x1::type_name::TypeName>(&mut v3);
            assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg1.rules, &v6), 0);
            v5 = v5 + 1;
        };
        v2
    }
    ...
    public fun new_request<T0>(arg0: &PriceUpdatePolicy) : PriceUpdateRequest<T0> {
        PriceUpdateRequest<T0>{
            ...
            price_feeds : 0x1::vector::empty<0xcd9bf99ee89711edd5084fbd67aee0865b866f0bb3262701ec487cd45b0d3041::price_feed::PriceFeed>(),
        }
    }
