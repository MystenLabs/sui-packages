module 0xcdaf7a58b45b4f92374973259e6d5a66c028dc37b8a69be999de19f29f5c1522::cnsnft9503 {
    struct CNSNFT9503 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9503, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3227"));
        let v4 = 0x2::package::claim<CNSNFT9503>(arg0, arg1);
