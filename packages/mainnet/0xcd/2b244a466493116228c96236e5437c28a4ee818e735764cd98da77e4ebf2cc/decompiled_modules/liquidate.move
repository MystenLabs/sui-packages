module 0xcd2b244a466493116228c96236e5437c28a4ee818e735764cd98da77e4ebf2cc::liquidate {
    ...
    public fun repay_and_assert<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg3: LiqReceipt<T0>, arg4: 0x2::balance::Balance<T0>, arg5: 0x2::balance::Balance<T1>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let LiqReceipt {
            receipt : v0,
            change  : v1,
        } = arg3;
        0x2::balance::join<T0>(&mut arg4, v1);
        assert!(0x2::balance::value<T1>(&arg5) >= arg6, 1);
        let v2 = 0x2::tx_context::sender(arg7);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(arg5, arg7), v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::lending::flash_repay_with_ctx<T0>(arg0, arg1, arg2, v0, arg4, arg7), arg7), v2);
    }
