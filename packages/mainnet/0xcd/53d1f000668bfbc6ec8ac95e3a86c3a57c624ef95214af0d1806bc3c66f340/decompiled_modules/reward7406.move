module 0xcd53d1f000668bfbc6ec8ac95e3a86c3a57c624ef95214af0d1806bc3c66f340::reward7406 {
    struct REWARD7406 has drop {
        dummy_field: bool,
    }

    struct TICKET_7406 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7406(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7406>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7406>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7406, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7406>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7406>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7406>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7406>>(v5, 0x2::tx_context::sender(arg1));
    }
