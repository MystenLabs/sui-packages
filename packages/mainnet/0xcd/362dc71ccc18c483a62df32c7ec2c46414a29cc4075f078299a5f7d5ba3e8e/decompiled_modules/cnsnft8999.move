module 0xcd362dc71ccc18c483a62df32c7ec2c46414a29cc4075f078299a5f7d5ba3e8e::cnsnft8999 {
    struct CNSNFT8999 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8999, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8999>(arg0, arg1);
