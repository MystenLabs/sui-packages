module 0xcd2acd8820102c2eb580b0b65b61f95471c433e8bfe40f108401fc5429bf12eb::routing {
    ...
    public entry fun swap<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: bool, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg4) {
            assert!(c_min_amount_out(arg7, 0x2::coin::value<T1>(&arg3)), 2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg3, 0x2::tx_context::sender(arg9));
            0x2::coin::destroy_zero<T0>(arg2);
        } else {
            assert!(c_min_amount_out(arg7, 0x2::coin::value<T0>(&arg2)), 2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0x2::tx_context::sender(arg9));
            0x2::coin::destroy_zero<T1>(arg3);
        };
    }

    public entry fun add_user(arg0: &DexCap, arg1: &mut DexSwapInfo, arg2: vector<address>) {
        0x1::vector::append<address>(&mut arg1.user_list, arg2);
    }

    fun c_min_amount_out(arg0: u64, arg1: u64) : bool {
        arg1 > arg0
    }

    public fun dep_c(arg0: &mut DexSwapInfo, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x2::coin::put<0x2::sui::SUI>(&mut arg0.balance, arg1);
    }

    public fun get_dep_c(arg0: &mut DexSwapInfo, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<DexSwapInfo>(v0);
        let v1 = DexCap{id: 0x2::object::new(arg0)};
        0x2::transfer::transfer<DexCap>(v1, 0x2::tx_context::sender(arg0));
    }
    ...
    public entry fun stop_funding(arg0: &DexCap, arg1: &mut DexSwapInfo, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun swap_all<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: bool, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = if (arg4) {
            4295048018
        } else {
            79226673515401279992447579054
        ...
        if (arg4) {
            assert!(c_min_amount_out(arg6, 0x2::coin::value<T1>(&arg3)), 2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg3, 0x2::tx_context::sender(arg8));
            0x2::coin::destroy_zero<T0>(arg2);
        } else {
            assert!(c_min_amount_out(arg6, 0x2::coin::value<T0>(&arg2)), 2);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg2, 0x2::tx_context::sender(arg8));
            0x2::coin::destroy_zero<T1>(arg3);
        };
    }

    public fun swap_return<T0, T1>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: bool, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        let v0 = if (arg4) {
            4295048018
        } else {
            79226673515401279992447579054
