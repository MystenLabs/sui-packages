module 0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::pyth_adaptor {
    ...
    public(friend) fun refresh_pyth_price<T0>(arg0: &0x2::table::Table<0x1::type_name::TypeName, PythFeedData>, arg1: &mut 0x2::table::Table<0x1::type_name::TypeName, 0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::price_feed::PriceFeed>, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &0x2::clock::Clock) {
        ...
        let v6 = 0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::price_feed::decimals();
        let v7 = if (v4 < v6) {
            v2 * pow10_u64(v6 - v4)
        } else {
            v2 / pow10_u64(v4 - v6)
        ...
        assert!(v7 > 0, 70145);
        if (!0x2::table::contains<0x1::type_name::TypeName, 0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::price_feed::PriceFeed>(arg1, v0)) {
            0x2::table::add<0x1::type_name::TypeName, 0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::price_feed::PriceFeed>(arg1, v0, 0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::price_feed::new(v7, v5));
        } else {
            0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::price_feed::update(0x2::table::borrow_mut<0x1::type_name::TypeName, 0xcd9847dcdef37af236b3c6e3fe953a886e53daff970697c4db4414c15723f9f3::price_feed::PriceFeed>(arg1, v0), v7, v5);
        };
    }
