module 0xcd2700b093a487dacfaec200ce8cb0343c7d264ab39530c14d1bf58a5afa7592::tarus {
    ...
    fun init(arg0: TARUS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TARUS>(arg0, 9, b"USDC", b"TarUS", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://raw.githubusercontent.com/tokenusdt/USDTlogo1/refs/heads/main/USD_Coin_logo_(cropped).png")), arg1);
