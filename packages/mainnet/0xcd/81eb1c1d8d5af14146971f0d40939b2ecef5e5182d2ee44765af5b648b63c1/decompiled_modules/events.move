module 0xcd81eb1c1d8d5af14146971f0d40939b2ecef5e5182d2ee44765af5b648b63c1::events {
    ...
    struct RevokeVaultTreasuryCap has copy, drop {
        vault_id: 0x2::object::ID,
        treasury_cap_id: 0x2::object::ID,
    }
    ...
    struct RevokePackagePauseGuardianCap has copy, drop {
        config_id: 0x2::object::ID,
        pause_guardian_cap_id: 0x2::object::ID,
    }

    struct RevokePackageAssistantCap has copy, drop {
        config_id: 0x2::object::ID,
        assistant_cap_id: 0x2::object::ID,
    }
    ...
    struct RevokePackageMaintenanceCap has copy, drop {
        config_id: 0x2::object::ID,
        maintenance_cap_id: 0x2::object::ID,
    }
    ...
    public(friend) fun emit_revoke_package_assistant_cap(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = RevokePackageAssistantCap{
            config_id        : arg0,
            assistant_cap_id : arg1,
        };
        0x2::event::emit<RevokePackageAssistantCap>(v0);
    }

    public(friend) fun emit_revoke_package_maintenance_cap(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = RevokePackageMaintenanceCap{
            config_id          : arg0,
            maintenance_cap_id : arg1,
        };
        0x2::event::emit<RevokePackageMaintenanceCap>(v0);
    }

    public(friend) fun emit_revoke_package_pause_guardian_cap(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = RevokePackagePauseGuardianCap{
            config_id             : arg0,
            pause_guardian_cap_id : arg1,
        };
        0x2::event::emit<RevokePackagePauseGuardianCap>(v0);
    }
    ...
    public(friend) fun emit_revoke_vault_treasury_cap(arg0: 0x2::object::ID, arg1: 0x2::object::ID) {
        let v0 = RevokeVaultTreasuryCap{
            vault_id        : arg0,
            treasury_cap_id : arg1,
        };
        0x2::event::emit<RevokeVaultTreasuryCap>(v0);
    }
