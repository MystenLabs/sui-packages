module 0x88a042907b2d931d3e2124d861e6bb1d0f7c2811424d9e3cf4d05900a405b804::divine_art {
    ...
    fun init(arg0: DIVINE_ART, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"Divine Art 33"));
        0x1::vector::push_back<0x1::string::String>(v8, 0x1::string::utf8(b"https://clutchy.app"));
