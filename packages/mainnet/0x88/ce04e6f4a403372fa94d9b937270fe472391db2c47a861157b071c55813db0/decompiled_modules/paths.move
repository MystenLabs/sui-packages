module 0x88ce04e6f4a403372fa94d9b937270fe472391db2c47a861157b071c55813db0::paths {
        ...
        while (v1 < 0x1::vector::length<PriceNode>(arg1)) {
            ...
            if (v4 > 0) {
                ...
                while (v5 < v4) {
                    ...
                    let v8 = 0x88ce04e6f4a403372fa94d9b937270fe472391db2c47a861157b071c55813db0::arithmetic::mul_128(0x1::vector::borrow<Route>(&v3, v5).sqrtPrice, v2.sqrtPrice);
                    if (v8 > v7 || v6 < arg2) {
