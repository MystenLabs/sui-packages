module 0x8844284b27fc756c08182504f83777cb448dd36c9180871e4218a352f5648d1f::reward4672 {
    struct REWARD4672 has drop {
        dummy_field: bool,
    }

    struct TICKET_4672 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4672(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4672>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4672>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4672, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4672>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4672>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4672>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4672>>(v5, 0x2::tx_context::sender(arg1));
    }
