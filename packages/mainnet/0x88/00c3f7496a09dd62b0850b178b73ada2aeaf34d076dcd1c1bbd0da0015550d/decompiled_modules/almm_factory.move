module 0x532bf64e6f0bf702353387d53a28a3239249f47c39d58954f2c0a1f9f4436c20::almm_factory {
    ...
    public fun close_bin_step_preset(arg0: &mut Factory, arg1: &AdminCap, arg2: u64, arg3: u16) {
        version_only(arg0);
        check_admin(arg0, arg1);
        assert!(0x2::vec_map::contains<u64, 0x2::vec_set::VecSet<u16>>(&arg0.opened_bin_steps, &arg2) && 0x2::vec_set::contains<u16>(0x2::vec_map::get<u64, 0x2::vec_set::VecSet<u16>>(&arg0.opened_bin_steps, &arg2), &arg3), 13906835776366182399);
    ...
    public fun grant_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        version_only(arg0);
        assert!(0x2::package::from_package<Factory>(arg1), 13906835256675139583);
    ...
    public fun grant_protocol_fee_cap(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        version_only(arg0);
        assert!(0x2::package::from_package<Factory>(arg1), 13906835497193308159);
    ...
    public fun pair_uniq2<T0, T1>(arg0: u64, arg1: u16) : 0x2::object::ID {
        assert!(is_token_pair_sequence_valid<T0, T1>(), 7);
        let v0 = 0x1::ascii::into_bytes(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()));
        let v1 = 0x1::type_name::into_string(0x1::type_name::with_defining_ids<T1>());
        let v2 = 0x1::ascii::as_bytes(&v1);
    ...
    public fun revoke_admin(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        version_only(arg0);
        assert!(0x2::package::from_module<Factory>(arg1), 13906835316804681727);
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_admin, &arg2), 13906835321099649023);
    ...
    public fun revoke_protocol_fee_cap(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: 0x2::object::ID) {
        version_only(arg0);
        assert!(0x2::package::from_module<Factory>(arg1), 13906835557322850303);
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_protocol_fee_cap, &arg2), 13906835561617817599);
    ...
    public fun set_default_partner(arg0: &mut Factory, arg1: &0x2::package::Publisher, arg2: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::partner::Partner) {
        version_only(arg0);
        assert!(0x2::package::from_package<Factory>(arg1), 13906835368344289279);
    ...
    public fun set_max_bins_in_position(arg0: &mut Factory, arg1: &AdminCap, arg2: u64) {
        ...
        assert!(v0 != arg2, 13906835445653700607);
