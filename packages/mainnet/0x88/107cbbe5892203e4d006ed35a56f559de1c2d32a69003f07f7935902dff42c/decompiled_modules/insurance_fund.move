module 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::insurance_fund {
    ...
    public(friend) fun create_insurance_fund(arg0: 0x2::object::ID, arg1: address, arg2: address, arg3: u64, arg4: u128) : InsuranceFund {
        ...
        assert!(arg1 != arg2, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_active_account_can_not_be_same_as_security_account());
        assert!(arg3 > 0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_interval_not_met());
        assert!(arg4 > 0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_amount_must_be_greater_than_zero());
    ...
    public(friend) fun set_active_account(arg0: &mut InsuranceFund, arg1: address) {
        assert!(arg1 != @0x0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::address_cannot_be_zero());
        assert!(arg1 != arg0.security_account, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_active_account_can_not_be_same_as_security_account());
    ...
    public(friend) fun set_amount_limit(arg0: &mut InsuranceFund, arg1: u128) {
        assert!(arg1 > 0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_amount_must_be_greater_than_zero());
    ...
    public(friend) fun set_security_account(arg0: &mut InsuranceFund, arg1: address) {
        assert!(arg1 != @0x0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::address_cannot_be_zero());
        assert!(arg1 != arg0.active_account, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_active_account_can_not_be_same_as_security_account());
    ...
    public(friend) fun set_transfer_interval(arg0: &mut InsuranceFund, arg1: u64) {
        assert!(arg1 > 0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_interval_not_met());
    ...
    public(friend) fun transfer_from_active_to_security<T0>(arg0: &InsuranceFund, arg1: &0x2::clock::Clock, arg2: &mut 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::bank::Bank<T0>, arg3: u128, arg4: u128) {
        assert!(arg3 > 0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_amount_must_be_greater_than_zero());
        0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::bank::transfer<T0>(arg2, arg0.active_account, arg0.security_account, arg3, 0, arg4);
    ...
    public(friend) fun transfer_from_security_to_active<T0>(arg0: &mut InsuranceFund, arg1: &0x2::clock::Clock, arg2: &mut 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::bank::Bank<T0>, arg3: u128, arg4: u128) {
        assert!(arg3 > 0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_amount_must_be_greater_than_zero());
        assert!(arg3 <= arg0.transfer_amount_limit, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_amount_exceeds_limit());
        let v0 = 0x2::clock::timestamp_ms(arg1);
        if (arg0.last_transfer_time > 0) {
            assert!(v0 - arg0.last_transfer_time >= arg0.transfer_interval, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::insurance_fund_transfer_interval_not_met());
        };
        0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::bank::transfer<T0>(arg2, arg0.security_account, arg0.active_account, arg3, 0, arg4);
