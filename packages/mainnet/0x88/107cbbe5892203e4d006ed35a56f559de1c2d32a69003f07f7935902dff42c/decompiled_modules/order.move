module 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::order {
    ...
    entry fun cancel_order(arg0: &0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::protocol::ProtocolConfig, arg1: &0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::sub_accounts::SubAccounts, arg2: &mut 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::sub_accounts::TxIndexer, arg3: &mut 0x2::table::Table<vector<u8>, OrderStatus>, arg4: address, arg5: u8, arg6: u128, arg7: u128, arg8: u128, arg9: u64, arg10: u128, arg11: address, arg12: vector<u8>, arg13: vector<u8>, arg14: vector<u8>, arg15: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg11 || 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::sub_accounts::is_sub_account(arg1, arg11, v0), 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::sender_does_not_have_permission_for_account(2));
        let v1 = get_serialized_order(pack_order(arg4, arg5, arg6, arg7, arg8, arg11, arg9, arg10));
        let v2 = 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::get_hash(v1);
        create_order(arg3, v2);
        let v3 = 0x2::table::borrow_mut<vector<u8>, OrderStatus>(arg3, v2);
        assert!(v3.status, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::order_is_canceled(0));
        v3.status = false;
        let v4 = OrderCancelEvent{
            tx_index   : 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::sub_accounts::validate_unique_tx(arg2, arg14),
            caller     : v0,
            sig_maker  : verify_order_signature(arg1, arg11, v1, arg12, arg13, 0, 0x2::vec_set::contains<address>(0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::protocol::privileged_addresses(arg0), &arg11)),
            perpetual  : arg4,
            order_hash : v2,
        };
    ...
    public(friend) fun to_1x9(arg0: Order) : Order {
        Order{
            ...
            ioc            : arg0.ioc,
            flags          : arg0.flags,
            price          : arg0.price / 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::base_uint(),
            quantity       : arg0.quantity / 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::base_uint(),
            leverage       : arg0.leverage / 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::base_uint(),
    ...
    public(friend) fun verify_and_fill_order_qty(arg0: &mut 0x2::table::Table<vector<u8>, OrderStatus>, arg1: Order, arg2: vector<u8>, arg3: u128, arg4: u128, arg5: bool, arg6: u128, arg7: address, arg8: u64, arg9: u128) {
        assert!(arg1.is_long && arg3 <= arg1.price || arg3 >= arg1.price, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::fill_price_invalid(arg8));
        if (arg1.reduce_only) {
            assert!(arg1.is_long != arg5 && arg4 <= arg6, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::fill_does_not_decrease_size(arg8));
        };
        let v0 = 0x2::table::borrow_mut<vector<u8>, OrderStatus>(arg0, arg2);
        v0.filled_qty = v0.filled_qty + arg4;
        assert!(v0.filled_qty <= arg1.quantity, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::cannot_overfill_order(arg8));
    ...
    public(friend) fun verify_order_expiry(arg0: u64, arg1: u64, arg2: u64) {
        assert!(arg0 == 0 || arg0 > arg1 - 1800000, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::order_expired(arg2));
    }

    public(friend) fun verify_order_leverage(arg0: u128, arg1: u128, arg2: u64) {
        assert!(arg1 > 0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::leverage_must_be_greater_than_zero(arg2));
        assert!(arg0 == 0 || 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::compute_mro(arg1) == arg0, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::invalid_leverage(arg2));
    }

    public(friend) fun verify_order_signature(arg0: &0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::sub_accounts::SubAccounts, arg1: address, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: bool) : address {
        if (arg6) {
            return arg1
        };
        let v0 = 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::verify_signature(arg3, arg4, arg2);
        assert!(0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::get_result_status(v0), 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::order_has_invalid_signature(arg5));
        let v1 = if (0x1::vector::pop_back<u8>(&mut arg3) == 3) {
            0x2::address::from_bytes(arg4)
        } else {
            0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::get_public_address(0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::library::get_result_public_key(v0))
        };
        assert!(arg1 == v1 || 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::sub_accounts::is_sub_account(arg0, arg1, v1), 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::order_has_invalid_signature(arg5));
        v1
    }

    public(friend) fun verify_order_state(arg0: &0x2::table::Table<vector<u8>, OrderStatus>, arg1: vector<u8>, arg2: u64) {
        assert!(0x2::table::borrow<vector<u8>, OrderStatus>(arg0, arg1).status, 0x88107cbbe5892203e4d006ed35a56f559de1c2d32a69003f07f7935902dff42c::error::order_is_canceled(arg2));
    }
