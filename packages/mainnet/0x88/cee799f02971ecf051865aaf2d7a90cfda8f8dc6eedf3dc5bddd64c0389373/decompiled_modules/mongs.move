module 0x88cee799f02971ecf051865aaf2d7a90cfda8f8dc6eedf3dc5bddd64c0389373::mongs {
    ...
    fun init(arg0: MONGS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MONGS>(arg0, 9, b"MS", b"MONGS", b"https://t.me/MongSUI", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://i.imgur.com/h0omlTj.jpg"))), arg1);
