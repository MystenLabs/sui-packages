module 0x885a904f2d3afed3805d4deaa79d8925adb0589fb07d6a8d7646ead876c121e1::suiturbo {
    ...
    fun init(arg0: SUITURBO, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SUITURBO>(&mut v2, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
