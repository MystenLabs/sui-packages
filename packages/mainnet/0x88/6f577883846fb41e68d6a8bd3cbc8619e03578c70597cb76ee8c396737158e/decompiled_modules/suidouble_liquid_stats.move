module 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_stats {
    ...
    public(friend) fun get_metadata_token_fee_permyriad(arg0: &SuidoubleLiquidStats, arg1: u64) : u64 {
        let v0 = 0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_metadata::get_metadata_u64_with_default(&arg0.metadata, 1, arg1);
        if (v0 > arg1) {
            return arg1
        };
        v0
    ...
    public(friend) fun set_metadata_token_fee_permyriad(arg0: &mut SuidoubleLiquidStats, arg1: u64) : bool {
        0x67e77b4e79e8c157e42c18eecf68e25047f6f95e657bd65387189411f2898ce3::suidouble_liquid_metadata::set_metadata_u64(&mut arg0.metadata, 1, arg1)
    }
