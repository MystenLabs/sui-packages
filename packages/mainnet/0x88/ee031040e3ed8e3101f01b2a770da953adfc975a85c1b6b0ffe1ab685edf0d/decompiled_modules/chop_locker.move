module 0x88ee031040e3ed8e3101f01b2a770da953adfc975a85c1b6b0ffe1ab685edf0d::chop_locker {
    ...
    fun calculate_apy(arg0: u64) : u64 {
        let v0 = if (arg0 > 1) {
            arg0 - 1
        } else {
            0
        };
        2000000000 + (15000000000 - 2000000000) * v0 / (365 - 1)
    }
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0;
        let v5 = if (0x2::balance::value<T0>(&arg0.reward_balance) > 0) {
            arg0.total_staked = arg0.total_staked + v0;
            let v6 = calculate_apy(v1);
            v2 = v6;
            let v7 = calculate_adjusted_reward_rate(calculate_base_reward_rate(v1, v6), 0x2::balance::value<T0>(&arg0.reward_balance), arg0.total_rewards_added_by_admin);
            v4 = v7;
            let v8 = (v0 as u128) * (v7 as u128) / 1000000000;
            let v9 = (v0 as u128) / 1000000000 * (v7 as u128);
            let v10 = (arg0.total_weighted_stake as u128) + v9;
            let v11 = if (v10 > 0) {
                (v9 as u128) * (0x2::balance::value<T0>(&arg0.reward_balance) as u128) / (v10 as u128)
            } else {
            ...
            assert!(v12 <= (0x2::balance::value<T0>(&arg0.reward_balance) as u128), 11);
            let v13 = &mut arg0.reward_balance;
            let v5 = withdraw_from_balance<T0>(v13, (v12 as u64), arg5);
            arg0.total_weighted_stake = (v10 as u64);
            v5
        } else {
            let v14 = &mut arg0.reward_balance;
            withdraw_from_balance<T0>(v14, 0, arg5)
        };
        let v15 = Lock<T0>{
            ...
            adjusted_reward_rate  : v4,
        };
        arg0.active_lockers = arg0.active_lockers + 1;
        0x2::transfer::transfer<Lock<T0>>(v15, 0x2::tx_context::sender(arg5));
    }
