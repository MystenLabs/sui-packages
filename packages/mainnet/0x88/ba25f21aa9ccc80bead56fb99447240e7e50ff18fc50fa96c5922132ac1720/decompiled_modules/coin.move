module 0x88ba25f21aa9ccc80bead56fb99447240e7e50ff18fc50fa96c5922132ac1720::coin {
    ...
    entry fun claim_airdrop(arg0: &mut State, arg1: &mut 0x2::coin::TreasuryCap<COIN>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (!0x1::vector::contains<address>(&arg0.users, &v0)) {
    ...
    fun init(arg0: COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<COIN>(arg0, 6, b"HIPPO", b"sudeng", b"SuDeng is the cutest $HIPPO on SUI, bringing $HIPPO to the world of memes.  No cats, no dogs. Only $HIPPO.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.imgur.com/j2EuFh5.png")), arg1);
    ...
    entry fun pay_with_coins<T0>(arg0: &mut State, arg1: vector<0x2::coin::Coin<T0>>, arg2: &0x2::tx_context::TxContext) {
        ...
        let (_, v4) = 0x1::vector::index_of<address>(&arg0.users, &v2);
        0x1::vector::remove<address>(&mut arg0.users, v4);
    }
