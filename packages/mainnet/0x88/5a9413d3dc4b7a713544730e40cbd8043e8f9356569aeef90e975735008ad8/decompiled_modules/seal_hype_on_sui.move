module 0x885a9413d3dc4b7a713544730e40cbd8043e8f9356569aeef90e975735008ad8::seal_hype_on_sui {
    ...
    fun init(arg0: SEAL_HYPE_ON_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Collection on Sui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreihttyguecbmd3b2kthd5xckxtbfr5dypiagrhnhx6i7ck5rmm77aa"));
