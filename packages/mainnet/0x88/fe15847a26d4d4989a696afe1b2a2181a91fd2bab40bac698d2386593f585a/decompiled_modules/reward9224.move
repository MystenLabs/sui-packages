module 0x88fe15847a26d4d4989a696afe1b2a2181a91fd2bab40bac698d2386593f585a::reward9224 {
    struct REWARD9224 has drop {
        dummy_field: bool,
    }

    struct TICKET_9224 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9224(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9224>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9224>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9224, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9224>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9224>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9224>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9224>>(v5, 0x2::tx_context::sender(arg1));
    }
