module 0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_workshop {
    ...
    public entry fun burnNft(arg0: 0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = BurnNftEvent{
            sender : 0x2::tx_context::sender(arg1),
            nft    : 0x2::object::id_address<0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT>(&arg0),
        };
        0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::burn(arg0);
    ...
    public entry fun claimNft(arg0: &mut Workshop, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = 0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::mint(v3.name, v3.link, *0x1::vector::borrow<vector<u8>>(&arg0.urls, ((v1 - v2 * v1 / v2) as u64)), v3.description, v3.project_url, v3.edition, v3.thumbnail_url, v3.creator, v6, arg1);
        let v9 = MintNftEvent{
            sender : v0,
            nft    : 0x2::object::id_address<0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT>(&v8),
        };
        0x2::transfer::public_transfer<0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT>(v8, v0);
    ...
    fun init(arg0: NFT_WORKSHOP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x2::display::new_with_fields<0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT>(&v5, v1, v3, arg1);
        0x2::display::update_version<0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT>(&mut v6);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT>>(v6, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::PriNFT>(0x88a5787010d0d0844a7254f0d45bc0f9530e91d61abc71094663388eaab30224::nft_private::mint(b"Genesis NFT campaign", b"https://seapad.fund/nftcampaign", b"https://seapad.s3.ap-southeast-1.amazonaws.com/uploads/PROD/public/media/images/logo_1686475080033.png", b"Genesis NFT campaign", b"https://seapad.fund/", 1, b"https://seapad.s3.ap-southeast-1.amazonaws.com/uploads/PROD/public/media/images/logo_1686475080033.png", b"SeaPadFoundation", 0x2::table::new<vector<u8>, vector<u8>>(arg1), arg1), 0x2::tx_context::sender(arg1));
        let v7 = NftAdminCap{id: 0x2::object::new(arg1)};
        let v8 = &mut v0;
        setTemplate(&v7, b"Seapad New Year Collection", b"https://seapad.fund/nftcampaign", b"Seapad New Year Collection", b"https://seapad.fund/", 1, b"https://amethyst-careful-angelfish-202.mypinata.cloud/ipfs/QmerJGWjJfYCvXTnzCQn492KKzNUQgxCumCPW9R64pdJhx", b"SeaPad Foundation", 0x1::vector::empty<vector<u8>>(), 0x1::vector::empty<vector<u8>>(), 100000, v8);
        let v9 = 0x1::vector::empty<vector<u8>>();
        0x1::vector::push_back<vector<u8>>(&mut v9, b"https://amethyst-careful-angelfish-202.mypinata.cloud/ipfs/QmerJGWjJfYCvXTnzCQn492KKzNUQgxCumCPW9R64pdJhx");
        let v10 = &mut v0;
