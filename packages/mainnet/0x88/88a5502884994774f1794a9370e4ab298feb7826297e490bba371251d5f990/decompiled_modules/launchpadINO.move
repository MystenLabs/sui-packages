module 0x8888a5502884994774f1794a9370e4ab298feb7826297e490bba371251d5f990::launchpadINO {
    ...
    public entry fun create_launchpad(arg0: address, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<0x1::string::String>, arg7: vector<u8>, arg8: vector<u8>, arg9: vector<u8>, arg10: vector<0x1::string::String>, arg11: vector<u8>, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = LaunchpadINO{
            ...
            create_date  : 0x2::clock::timestamp_ms(arg12),
            update_date  : 0,
        };
    ...
    public entry fun get_fees(arg0: &mut AdminConfig) : u64 {
        arg0.fees_sales
    }
    ...
    public entry fun update_fees(arg0: &mut AdminConfig, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.owner, 135289670007);
        arg0.fees_sales = arg1;
    }

    public entry fun update_launchpad(arg0: &mut LaunchpadINO, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<0x1::string::String>, arg5: vector<u8>, arg6: vector<u8>, arg7: vector<u8>, arg8: vector<0x1::string::String>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.socials = arg8;
        arg0.update_date = 0x2::clock::timestamp_ms(arg9);
    }
