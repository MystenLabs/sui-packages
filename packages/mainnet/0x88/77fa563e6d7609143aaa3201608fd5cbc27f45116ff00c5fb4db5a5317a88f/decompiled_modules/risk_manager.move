module 0x8877fa563e6d7609143aaa3201608fd5cbc27f45116ff00c5fb4db5a5317a88f::risk_manager {
    ...
    public(friend) fun add_risk(arg0: &mut RiskManager, arg1: 0x1::type_name::TypeName, arg2: vector<0x8877fa563e6d7609143aaa3201608fd5cbc27f45116ff00c5fb4db5a5317a88f::bet_manager::Placement>, arg3: u64) {
        ...
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x8877fa563e6d7609143aaa3201608fd5cbc27f45116ff00c5fb4db5a5317a88f::bet_manager::Placement>(&arg2)) {
            let (v4, v5) = 0x8877fa563e6d7609143aaa3201608fd5cbc27f45116ff00c5fb4db5a5317a88f::bet_manager::get_placement_data(0x1::vector::borrow<0x8877fa563e6d7609143aaa3201608fd5cbc27f45116ff00c5fb4db5a5317a88f::bet_manager::Placement>(&arg2, v3));
