module 0x8852cca7a9153dd70c52b40d5125c23c364c04a19587c8edd3392a5bc1fe0169::vault {
    ...
    entry fun change_limit<T0>(arg0: &mut Vault<T0>, arg1: &0x8852cca7a9153dd70c52b40d5125c23c364c04a19587c8edd3392a5bc1fe0169::owner_cap::OwnerCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x8852cca7a9153dd70c52b40d5125c23c364c04a19587c8edd3392a5bc1fe0169::owner_cap::is_owned(&arg0.id, arg1);
        arg0.limit = arg2;
    ...
    entry fun create_vault<T0>(arg0: 0x2::coin::Coin<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x8852cca7a9153dd70c52b40d5125c23c364c04a19587c8edd3392a5bc1fe0169::owner_cap::create_owner_cap(&v0.id, 0x2::tx_context::sender(arg2), arg2);
    ...
    entry fun liquidate_vault<T0>(arg0: &mut Vault<T0>, arg1: &0x8852cca7a9153dd70c52b40d5125c23c364c04a19587c8edd3392a5bc1fe0169::owner_cap::OwnerCap, arg2: &mut 0x2::tx_context::TxContext) {
        0x8852cca7a9153dd70c52b40d5125c23c364c04a19587c8edd3392a5bc1fe0169::owner_cap::is_owned(&arg0.id, arg1);
