module 0x88b2b6b9c9669a19c8188eb2db861aa7ac24d8975140ef04e4c1a1c9ab803858::cnsnft2502 {
    struct CNSNFT2502 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2502, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2502>(arg0, arg1);
