module 0x880fe9b78ec5ce391eb99f8c23310e42ade9ce09e3127480abcb7f4b47a0a784::critbit {
    ...
    public(friend) fun is_empty<T0: store>(arg0: &CritbitTree<T0>) : bool {
        0x2::table::is_empty<u64, Leaf<T0>>(&arg0.leaves)
    }

    public(friend) fun new<T0: store>(arg0: &mut 0x2::tx_context::TxContext) : CritbitTree<T0> {
        CritbitTree<T0>{
    ...
    public(friend) fun insert_leaf<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64, arg2: T0) : u64 {
        let v0 = Leaf<T0>{
            key    : arg1,
            value  : arg2,
        ...
        assert!(v3 != arg1, 4);
        let v4 = 1 << 64 - 0x880fe9b78ec5ce391eb99f8c23310e42ade9ce09e3127480abcb7f4b47a0a784::math::count_leading_zeros(((v3 ^ arg1) as u128)) - 64 - 1;
        let v5 = InternalNode{
            mask        : v4,
    ...
    public(friend) fun size<T0: store>(arg0: &CritbitTree<T0>) : u64 {
