module 0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::staking {
    ...
    public entry fun claim(arg0: address, arg1: &mut StakingVault, arg2: &mut 0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::ProtocolTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = *0x2::table::borrow<address, vector<0x2::object::ID>>(&mut arg1.reverse_owners, arg0);
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            ...
            let v4 = calculate_stake(v3, *0x2::table::borrow<0x2::object::ID, u64>(&mut arg1.token_timestamps, v2), arg3);
            if (v4 > 0) {
                0x2::table::remove<0x2::object::ID, u64>(&mut arg1.token_timestamps, v2);
                0x2::table::add<0x2::object::ID, u64>(&mut arg1.token_timestamps, v2, 0x2::tx_context::epoch_timestamp_ms(arg3));
                0x2::transfer::public_transfer<0x2::coin::Coin<0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::STORKTOKEN>>(0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::withdraw_staking(arg2, v4, arg3), *0x2::table::borrow<0x2::object::ID, address>(&arg1.owners, 0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::id(v3)));
            };
            v1 = v1 + 1;
        };
    }
    ...
    public entry fun unstake(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut StakingVault, arg3: &mut 0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        unstake_stork(arg0, arg1, arg2, arg3, arg4);
    }

    public entry fun unstake_all(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut StakingVault, arg2: &mut 0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::ProtocolTreasury, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun unstake_stork(arg0: 0x2::object::ID, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut StakingVault, arg3: &mut 0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        ...
        arg2.total_staked = arg2.total_staked - 1;
        if (v2 > 0) {
            if (v2 >= 0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::remaining_staking_supply(arg3)) {
                v3 = 0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::remaining_staking_supply(arg3);
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::STORKTOKEN>>(0x88b4bd27e60a0051341a2da6373707b5a4a9cfb78ed436105466acdc6744f69b::storktoken::withdraw_staking(arg3, v3, arg4), v0);
        };
