module 0x88df65ec9fcdfa043b824bf1b0705ef401ed7e5b0836358a9322c3e4cb2b5683::reward6591 {
    struct REWARD6591 has drop {
        dummy_field: bool,
    }

    struct TICKET_6591 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6591(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6591>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6591>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6591, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6591>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6591>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6591>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6591>>(v5, 0x2::tx_context::sender(arg1));
    }
