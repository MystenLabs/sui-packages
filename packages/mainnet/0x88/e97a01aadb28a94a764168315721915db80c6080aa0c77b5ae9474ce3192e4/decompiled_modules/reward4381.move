module 0x88e97a01aadb28a94a764168315721915db80c6080aa0c77b5ae9474ce3192e4::reward4381 {
    struct REWARD4381 has drop {
        dummy_field: bool,
    }

    struct TICKET_4381 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4381(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4381>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4381>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4381, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4381>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4381>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4381>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4381>>(v5, 0x2::tx_context::sender(arg1));
    }
