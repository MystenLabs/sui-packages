module 0x88d64e8d66c8420cc6285c0a9b6f6fa3efe098d383437891563eb6e126812037::reward6246 {
    struct REWARD6246 has drop {
        dummy_field: bool,
    }

    struct TICKET_6246 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6246(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6246>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6246>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6246, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6246>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6246>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6246>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6246>>(v5, 0x2::tx_context::sender(arg1));
    }
