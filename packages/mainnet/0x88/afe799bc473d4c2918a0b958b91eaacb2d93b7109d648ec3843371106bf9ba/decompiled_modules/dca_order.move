module 0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::dca_order {
    ...
    public fun fill_dca_order<T0, T1>(arg0: &0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: DcaOrderPrefill, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun place_dca_order<T0, T1>(arg0: &0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::config::GlobalConfig, arg1: vector<0x2::coin::Coin<T0>>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::vector::length<0x2::coin::Coin<T0>>(&arg1) > 0, 0);
        assert!(0x1::vector::length<0x2::coin::Coin<T0>>(&arg1) <= 0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::config::get_max_dca_order_count(arg0), 0);
        assert!(arg2 <= 0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::config::get_max_interval(arg0), 10);
    ...
    public fun prefill_dca_order<T0, T1>(arg0: &0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, DcaOrderPrefill) {
        assert!(0x1::vector::length<0x2::balance::Balance<T0>>(&arg1.pay_balance) > 0, 4);
        0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::config::only_operator(arg0, arg4);
        ...
        0x88afe799bc473d4c2918a0b958b91eaacb2d93b7109d648ec3843371106bf9ba::config::only_valid_fee(arg0, arg2, v1);
        let v2 = v1 - arg2;
