module 0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::ACL,
        package_version: u64,
    ...
    public fun acl(arg0: &GlobalConfig) : &0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::ACL {
        &arg0.acl
    }

    public fun add_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::add_role(&mut arg1.acl, arg2, arg3);
        let v0 = AddRoleEvent{
            member : arg2,
            role   : arg3,
        };
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::Member> {
        0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address) {
        checked_package_version(arg1);
        0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::remove_member(&mut arg1.acl, arg2);
    ...
    public fun remove_role(arg0: &AdminCap, arg1: &mut GlobalConfig, arg2: address, arg3: u8) {
        checked_package_version(arg1);
        0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::remove_role(&mut arg1.acl, arg2, arg3);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        ...
        0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun check_add_whitelist_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::has_role(&arg0.acl, arg1, 4), 11);
    }

    public fun check_fee_tier_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::has_role(&arg0.acl, arg1, 1), 6);
    }

    public fun check_pair_creator_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::has_role(&arg0.acl, arg1, 5), 6);
    }
    ...
    public fun check_protocol_fee_claim_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::has_role(&arg0.acl, arg1, 2), 9);
    }

    public fun check_rewarder_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::has_role(&arg0.acl, arg1, 3), 8);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::new(arg0),
            package_version       : 1,
    ...
    public fun is_pool_manager(arg0: &GlobalConfig, arg1: address) : bool {
        0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::acl::has_role(&arg0.acl, arg1, 0)
    }
