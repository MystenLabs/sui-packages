module 0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::position {
    ...
    fun borrow_mut_position_info(arg0: &mut PositionManager, arg1: 0x2::object::ID) : &mut PositionInfo {
        assert!(0x6fb44bc08db47ce51eed4341019ec3efa01f8571c9f29d13c83ca3bcc1abee23::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, arg1), 6);
    ...
    public fun fetch_positions(arg0: &PositionManager, arg1: vector<0x2::object::ID>, arg2: u64) : vector<PositionInfo> {
        ...
        let v1 = if (0x1::vector::is_empty<0x2::object::ID>(&arg1)) {
            ...
            assert!(0x6fb44bc08db47ce51eed4341019ec3efa01f8571c9f29d13c83ca3bcc1abee23::linked_table::contains<0x2::object::ID, PositionInfo>(&arg0.positions, v2), 6);
    ...
    public(friend) fun increase_liquidity(arg0: &mut PositionManager, arg1: &mut Position, arg2: u128, arg3: u128, arg4: u128, arg5: u128, arg6: vector<u128>) : u128 {
        ...
        update_points_internal(v0, arg5);
        update_rewards_internal(v0, arg6);
        assert!(0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::math_u128::add_check(v0.liquidity, arg2), 8);
        v0.liquidity = v0.liquidity + arg2;
        arg1.liquidity = v0.liquidity;
        v0.liquidity
    }
    ...
    fun new_position_name(arg0: u64, arg1: u64) : 0x1::string::String {
        ...
        0x1::string::append(&mut v0, 0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::utils::str(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, 0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::utils::str(arg1));
        v0
    }
    ...
    public fun set_display(arg0: &0x88833f79df96d4465298650785e121766727ee926a3916b4fd6c7a2b12e5b4ff::config::GlobalConfig, arg1: &0x2::package::Publisher, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    fun update_fee_internal(arg0: &mut PositionInfo, arg1: u128, arg2: u128) {
        ...
        assert!(0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::math_u64::add_check(arg0.fee_owned_a, v0), 1);
        assert!(0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::math_u64::add_check(arg0.fee_owned_b, v1), 1);
    ...
    fun update_points_internal(arg0: &mut PositionInfo, arg1: u128) {
        ...
        assert!(0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::math_u128::add_check(arg0.points_owned, v0), 3);
        ...
        if (v0 > 0) {
            ...
            while (v1 < v0) {
                ...
                if (0x1::vector::length<PositionReward>(&arg0.rewards) > v1) {
                    ...
                    assert!(0x5f7a7744be085d6f92587f4a0aa5d6ff85a6c804196c5a1f1bb34b0cb2db6c54::math_u64::add_check(v3.amount_owned, v4), 2);
                    v3.growth_inside = v2;
