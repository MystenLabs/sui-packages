module 0x88df2d5c43766015da5d80861a32d4c33bd5ecb1fd658404c3e4558a816f1df9::suiman {
    ...
    fun init(arg0: SUIMAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SuiMan: Your unique digital identity in the Sui ecosystem. This is a collection of exclusive 1/1 NFTs, each a hand-crafted, animated pixel portrait imbued with captivating GIF animation. Every SuiMan doesn't just move; it unveils a part of your exclusive digital signature, frame by frame (PRO-100-DCX), making each NFT truly unique and personal. Own a SuiMan and feel like a superhero, paving the way for the future of Sui. Become part of the elite who value not only art but also innovation."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreif2vheez76spewhnr5gj5bvrhkr6ilxhfvj6grl6uoemdjhxk3t6y"));
