module 0x817f244fc50df064cef85684b7fb1024f6b904aa91d2118dfa704d820d05e920::bubble_draw {
    ...
    entry fun fund_referral_pool<T0>(arg0: &mut BubbleDraw<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>) {
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.referral_pool, 0x2::coin::into_balance<0x2::sui::SUI>(arg1));
    }
