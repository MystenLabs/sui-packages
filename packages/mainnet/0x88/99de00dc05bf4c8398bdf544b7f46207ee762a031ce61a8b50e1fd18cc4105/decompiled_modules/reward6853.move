module 0x8899de00dc05bf4c8398bdf544b7f46207ee762a031ce61a8b50e1fd18cc4105::reward6853 {
    struct REWARD6853 has drop {
        dummy_field: bool,
    }

    struct TICKET_6853 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6853(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6853>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6853>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6853, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6853>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6853>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6853>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6853>>(v5, 0x2::tx_context::sender(arg1));
    }
