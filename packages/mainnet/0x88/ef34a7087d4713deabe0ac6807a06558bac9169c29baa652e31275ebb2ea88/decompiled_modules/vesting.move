module 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::vesting {
    ...
    public fun destroy_empty<T0>(arg0: Vesting<T0>, arg1: VestingCap, arg2: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg3: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry) {
        let Vesting {
            id                           : v0,
            dao_address                  : _,
            balance                      : v2,
        ...
        assert!(arg1.dao_address == 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::addr(arg2), 8);
        assert!(0x2::balance::value<T0>(&v13) == 0, 0);
        let v16 = VestingRegistryKey{dummy_field: false};
        if (0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::has_managed_data<VestingRegistryKey>(arg2, v16)) {
            let v17 = VestingRegistryKey{dummy_field: false};
            let v18 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_mut_with_package_witness<VestingRegistryKey, VestingRegistry>(arg2, arg3, v17, 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::actions_version::current());
    ...
    public fun cleanup_depleted_vesting<T0>(arg0: &Vesting<T0>, arg1: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg2: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry) {
        assert!(arg0.dao_address == 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::addr(arg1), 7);
        ...
        if (0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::has_managed_data<VestingRegistryKey>(arg1, v1)) {
            let v2 = VestingRegistryKey{dummy_field: false};
            let v3 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_mut_with_package_witness<VestingRegistryKey, VestingRegistry>(arg1, arg2, v2, 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::actions_version::current());
    ...
    public fun do_cancel_vesting<T0: store, T1, T2: drop>(arg0: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable::Executable<T0>, arg1: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg2: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg3: Vesting<T1>, arg4: &0x2::clock::Clock, arg5: T2, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_validation::assert_action_type<CancelVesting<T1>>(v1);
        assert!(0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::intents::action_spec_version(v1) == 1, 6);
        ...
        assert!(arg3.dao_address == 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::addr(arg1), 7);
        assert!(arg3.is_cancellable, 4);
        let v4 = VestingRegistryKey{dummy_field: false};
        if (0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::has_managed_data<VestingRegistryKey>(arg1, v4)) {
            let v5 = VestingRegistryKey{dummy_field: false};
            let v6 = ExecutionProgressWitness{dummy_field: false};
            let v7 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_mut<VestingRegistryKey, VestingRegistry, T0, ExecutionProgressWitness>(arg1, arg2, v5, arg0, v6);
        ...
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable_resources::provide_coin<T1, T0, ExecutionProgressWitness>(arg0, arg2, v26, 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v2)), 0x2::coin::from_balance<T1>(v23, arg6), arg6);
        let v27 = ExecutionProgressWitness{dummy_field: false};
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable::increment_action_idx<T0, CancelVesting<T1>, ExecutionProgressWitness>(arg0, arg2, v27);
    }
    ...
    fun do_claim_internal<T0>(arg0: &mut Vesting<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let (v2, v3, v4) = 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::stream_utils::calculate_available_with_tracking(arg0.amount_per_iteration, arg0.first_unclaimed_iteration, arg0.partial_claimed_in_iteration, arg0.start_time, arg0.iterations_total, arg0.iteration_period_ms, v0, &v1);
        assert!(v2 >= arg1, 10);
        assert!(0x2::balance::value<T0>(&arg0.balance) >= arg1, 10);
        let (v5, v6) = 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::stream_utils::advance_claim_tracking(v3, v4, arg1, arg0.amount_per_iteration);
    ...
    public fun do_create_vesting<T0: store, T1: store, T2, T3: drop>(arg0: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable::Executable<T1>, arg1: &mut 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg2: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry, arg3: &0x2::clock::Clock, arg4: T3, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::action_validation::assert_action_type<CreateVesting<T2>>(v1);
        assert!(0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::intents::action_spec_version(v1) == 1, 6);
        let v2 = 0x2::bcs::new(*0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::intents::action_spec_data(v1));
        ...
        assert!(0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::stream_utils::validate_iteration_parameters(v10, v7, v8, &v11, 0x2::clock::timestamp_ms(arg3)), 15);
        assert!(v4 > 0, 16);
        let v12 = ExecutionProgressWitness{dummy_field: false};
        let v13 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable_resources::take_coin<T2, T1, ExecutionProgressWitness>(arg0, arg2, v12, 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v2)));
        ...
        let v17 = VestingRegistryKey{dummy_field: false};
        if (!0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::has_managed_data<VestingRegistryKey>(arg1, v17)) {
            ...
            0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::add_managed_data<VestingRegistryKey, VestingRegistry, T1, ExecutionProgressWitness>(arg1, arg2, v18, v19, arg0, v20);
        };
        let v21 = VestingRegistryKey{dummy_field: false};
        let v22 = ExecutionProgressWitness{dummy_field: false};
        let v23 = 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_mut<VestingRegistryKey, VestingRegistry, T1, ExecutionProgressWitness>(arg1, arg2, v21, arg0, v22);
        ...
        let v25 = Vesting<T2>{
            id                           : v15,
            dao_address                  : 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::addr(arg1),
        ...
        let v27 = VestingCreated{
            ...
            account_id           : 0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::addr(arg1),
            coin_type            : 0x1::type_name::get<T2>(),
            beneficiary          : v3,
        ...
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::executable::increment_action_idx<T1, CreateVesting<T2>, ExecutionProgressWitness>(arg0, arg2, v28);
    }

    public fun has_vesting_registry(arg0: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account) : bool {
        let v0 = VestingRegistryKey{dummy_field: false};
        0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::has_managed_data<VestingRegistryKey>(arg0, v0)
    }
    ...
    public fun vesting_registry_entries(arg0: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::Account, arg1: &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::package_registry::PackageRegistry) : &0x2::vec_map::VecMap<0x2::object::ID, VestingEntry> {
        let v0 = VestingRegistryKey{dummy_field: false};
        &0x3510687b6de0d3c29bc68191a256943aaf57902ca6f7b5a54f62ca72dc61923d::account::borrow_managed_data_with_package_witness<VestingRegistryKey, VestingRegistry>(arg0, arg1, v0, 0x88ef34a7087d4713deabe0ac6807a06558bac9169c29baa652e31275ebb2ea88::actions_version::current()).entries
    }
