module 0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle {
    ...
    public fun get_price(arg0: &Oracle, arg1: &0x2::clock::Clock) : (u64, u64) {
        assert!(0x2::clock::timestamp_ms(arg1) - arg0.ts_ms < arg0.time_interval, 13906836381957292044);
        (arg0.price, arg0.decimal)
    }

    public fun get_price_with_interval_ms(arg0: &Oracle, arg1: &0x2::clock::Clock, arg2: u64) : (u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        assert!(v0 - arg0.ts_ms < arg0.time_interval && v0 - arg0.ts_ms <= arg2, 13906836463561670668);
        (arg0.price, arg0.decimal)
    }
    ...
    public fun get_twap_price(arg0: &Oracle, arg1: &0x2::clock::Clock) : (u64, u64) {
        assert!(0x2::clock::timestamp_ms(arg1) - arg0.ts_ms < arg0.time_interval, 13906836420611997708);
    ...
    fun update_(arg0: &mut Oracle, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 13906836253107617794);
        assert!(arg2 > 0, 13906836257402585090);
    ...
    public fun update_with_signature(arg0: &mut Oracle, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        ...
        assert!(v0 == arg2, 13906836107079516174);
        assert!(0x2::bls12381::bls12381_min_pk_verify(&arg1, 0x2::dynamic_field::borrow<0x1::string::String, vector<u8>>(&arg0.id, 0x1::string::utf8(b"bls_public_key")), &arg2), 13906836128554483728);
        let v1 = 0x1::ascii::string(arg3);
        assert!(0x1::type_name::as_string(&arg0.base_token_type) == &v1, 13906836132849582098);
        assert!(0x1::u64::diff(0x2::clock::timestamp_ms(arg7), arg6) < arg0.time_interval, 13906836137144156172);
        assert!(arg0.ts_ms < arg6, 13906836141439647764);
    ...
    fun version_check(arg0: &Oracle) {
        assert!(0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, 0x1::string::utf8(b"VERSION")), 13906836210158338056);
        assert!(2 >= *0x2::dynamic_field::borrow<0x1::string::String, u64>(&arg0.id, 0x1::string::utf8(b"VERSION")), 13906836192978468872);
    }
