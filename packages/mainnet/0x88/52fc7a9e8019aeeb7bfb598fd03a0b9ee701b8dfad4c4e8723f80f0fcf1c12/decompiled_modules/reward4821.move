module 0x8852fc7a9e8019aeeb7bfb598fd03a0b9ee701b8dfad4c4e8723f80f0fcf1c12::reward4821 {
    struct REWARD4821 has drop {
        dummy_field: bool,
    }

    struct TICKET_4821 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4821(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4821>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4821>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4821, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4821>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4821>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4821>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4821>>(v5, 0x2::tx_context::sender(arg1));
    }
