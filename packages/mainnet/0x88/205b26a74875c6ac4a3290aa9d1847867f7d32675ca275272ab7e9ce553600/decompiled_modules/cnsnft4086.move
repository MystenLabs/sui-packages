module 0x88205b26a74875c6ac4a3290aa9d1847867f7d32675ca275272ab7e9ce553600::cnsnft4086 {
    struct CNSNFT4086 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4086, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4086>(arg0, arg1);
