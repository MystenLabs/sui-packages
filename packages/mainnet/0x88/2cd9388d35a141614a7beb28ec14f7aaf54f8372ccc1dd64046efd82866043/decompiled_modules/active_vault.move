module 0x882cd9388d35a141614a7beb28ec14f7aaf54f8372ccc1dd64046efd82866043::active_vault {
    ...
    public(friend) fun deposit<T0>(arg0: &mut ActiveVault<T0>, arg1: &Config, arg2: &mut 0x882cd9388d35a141614a7beb28ec14f7aaf54f8372ccc1dd64046efd82866043::secure_vault::SecureVault<T0>, arg3: address, arg4: 0x2::balance::Balance<T0>) {
        when_not_paused(arg1);
        when_deposit_not_disabled<T0>(arg0);
        version_verification(arg1);
        active_vault_version_verification<T0>(arg0);
        0x882cd9388d35a141614a7beb28ec14f7aaf54f8372ccc1dd64046efd82866043::secure_vault::secure_vault_version_verification<T0>(arg2);
        ...
        if (arg0.config.max_vault_balance != 0 && 0x2::balance::value<T0>(&arg0.balance) + v0 > arg0.config.max_vault_balance) {
            0x882cd9388d35a141614a7beb28ec14f7aaf54f8372ccc1dd64046efd82866043::secure_vault::deposit_secure_vault<T0>(arg2, arg4);
            v1 = 0x882cd9388d35a141614a7beb28ec14f7aaf54f8372ccc1dd64046efd82866043::secure_vault::to_address<T0>(arg2);
        } else {
