module 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::exchange {
    ...
    entry fun create_empty_pool<T0, T1>(arg0: u8, arg1: u8, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::zero<T0>(arg5);
        let v1 = 0x2::tx_context::sender(arg5);
        create_pool_internal<T0, T1>(v0, arg0, arg1, arg2, arg3, v1, arg4, arg5);
    }

    entry fun create_pool<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u8, arg2: u8, arg3: u64, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        create_pool_internal<T0, T1>(arg0, arg1, arg2, arg3, arg4, v0, arg5, arg6);
    }

    fun create_pool_internal<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: u8, arg2: u8, arg3: u64, arg4: address, arg5: address, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 != @0x0, 1);
        assert!(arg3 > 0, 2);
        assert!(arg1 <= 9, 3);
        assert!(arg2 <= 9, 3);
        let v0 = ExchangePool<T0, T1>{
        ...
        let v1 = 0x2::object::id<ExchangePool<T0, T1>>(&v0);
        let v2 = ExchangeAdminCap<T0, T1>{
            id             : 0x2::object::new(arg7),
            schema_version : 1,
            pool_id        : v1,
        };
        let v3 = ExchangePoolCreated{
            pool_id             : v1,
            admin               : arg5,
            receiver            : arg4,
            ast_decimals        : arg1,
        ...
        0x2::event::emit<ExchangePoolCreated>(v3);
        0x2::transfer::share_object<ExchangePool<T0, T1>>(v0);
        0x2::transfer::transfer<ExchangeAdminCap<T0, T1>>(v2, arg5);
    }
    ...
    public fun set_paused<T0, T1>(arg0: &mut ExchangePool<T0, T1>, arg1: &ExchangeAdminCap<T0, T1>, arg2: bool, arg3: &0x2::clock::Clock) {
        assert_admin<T0, T1>(arg0, arg1);
        arg0.paused = arg2;
    ...
    public fun set_price<T0, T1>(arg0: &mut ExchangePool<T0, T1>, arg1: &ExchangeAdminCap<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock) {
        assert_admin<T0, T1>(arg0, arg1);
        assert!(arg2 > 0, 2);
        arg0.price_e8 = arg2;
    ...
    public fun withdraw_ast_reserve<T0, T1>(arg0: &mut ExchangePool<T0, T1>, arg1: &ExchangeAdminCap<T0, T1>, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_admin<T0, T1>(arg0, arg1);
        assert!(arg3 != @0x0, 1);
        assert!(0x2::balance::value<T0>(&arg0.ast_reserve) >= arg2, 10);
        let v0 = ExchangeReserveUpdated{
            pool_id       : 0x2::object::id<ExchangePool<T0, T1>>(arg0),
            deposited     : false,
            amount        : arg2,
