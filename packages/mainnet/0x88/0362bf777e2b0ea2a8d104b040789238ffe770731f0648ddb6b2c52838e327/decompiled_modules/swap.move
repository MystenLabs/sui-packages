module 0x7f6110182036e77a381a204f9166670d6986b461b50e0303c72d315630f4c700::swap {
    ...
    struct SwapFeeConfig has store {
        schema_version: u64,
        paused: bool,
        buy_fee_bps: u64,
        sell_fee_bps: u64,
    ...
    fun assert_trade_ready<T0, T1>(arg0: &SwapPool<T0, T1>, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        if (0x2::dynamic_field::exists_with_type<FeeConfigKey, SwapFeeConfig>(&arg0.id, v0)) {
            assert!(!0x2::dynamic_field::borrow<FeeConfigKey, SwapFeeConfig>(&arg0.id, v0).paused, 3);
        } else {
    ...
    entry fun create_empty_pool<T0, T1>(arg0: u8, arg1: u8, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        create_pool_internal<T0, T1>(v0, v1, arg0, arg1, arg2, 0, 100, v2, arg3, arg4);
    }
    ...
    entry fun create_empty_pool_with_fees<T0, T1>(arg0: u8, arg1: u8, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        create_pool_internal<T0, T1>(v0, v1, arg0, arg1, arg2, arg3, arg4, v2, arg5, arg6);
    }
    ...
    entry fun create_pool<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: u8, arg3: u8, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        create_pool_internal<T0, T1>(arg0, arg1, arg2, arg3, arg4, 0, 100, v0, arg5, arg6);
    }

    fun create_pool_internal<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: u8, arg3: u8, arg4: u64, arg5: u64, arg6: u64, arg7: address, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg4 > 0, 1);
        assert!(arg2 <= 9, 2);
        assert!(arg3 <= 9, 2);
        ...
        0x2::dynamic_field::add<FeeConfigKey, SwapFeeConfig>(&mut v0.id, v1, v2);
        let v3 = 0x2::object::id<SwapPool<T0, T1>>(&v0);
        let v4 = SwapAdminCap<T0, T1>{
            id             : 0x2::object::new(arg9),
            schema_version : 1,
            pool_id        : v3,
        };
        let v5 = SwapPoolCreated{
            pool_id              : v3,
            admin                : arg7,
            ast_decimals         : arg2,
            usdc_decimals        : arg3,
        ...
        0x2::event::emit<SwapPoolCreated>(v5);
        0x2::transfer::share_object<SwapPool<T0, T1>>(v0);
        0x2::transfer::transfer<SwapAdminCap<T0, T1>>(v4, arg7);
    }
    ...
    fun fee_bps<T0, T1>(arg0: &SwapPool<T0, T1>) : (u64, u64) {
        ...
        let v1 = 0x2::dynamic_field::borrow<FeeConfigKey, SwapFeeConfig>(&arg0.id, v0);
        (v1.buy_fee_bps, v1.sell_fee_bps)
    }
    ...
    public fun get_fee_info<T0, T1>(arg0: &SwapPool<T0, T1>) : (bool, bool, u64, u64, u128, u128) {
        let v0 = FeeConfigKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_with_type<FeeConfigKey, SwapFeeConfig>(&arg0.id, v0)) {
            return (false, arg0.paused, 0, 0, 0, 0)
        };
        let v1 = 0x2::dynamic_field::borrow<FeeConfigKey, SwapFeeConfig>(&arg0.id, v0);
        (true, v1.paused, v1.buy_fee_bps, v1.sell_fee_bps, v1.total_ast_fee, v1.total_usdc_fee)
    }
    ...
    fun record_fee<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: u8, arg2: u64) {
        ...
        let v0 = FeeConfigKey{dummy_field: false};
        let v1 = 0x2::dynamic_field::borrow_mut<FeeConfigKey, SwapFeeConfig>(&mut arg0.id, v0);
        if (arg1 == 1) {
            v1.total_ast_fee = v1.total_ast_fee + (arg2 as u128);
        } else {
            v1.total_usdc_fee = v1.total_usdc_fee + (arg2 as u128);
        };
    }
    ...
    public fun set_fees<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &SwapAdminCap<T0, T1>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        let (v0, v1) = fee_bps<T0, T1>(arg0);
        let v2 = FeeConfigKey{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<FeeConfigKey, SwapFeeConfig>(&arg0.id, v2)) {
            let v3 = 0x2::dynamic_field::borrow_mut<FeeConfigKey, SwapFeeConfig>(&mut arg0.id, v2);
            v3.buy_fee_bps = arg2;
            v3.sell_fee_bps = arg3;
        } else {
            let v4 = SwapFeeConfig{
                schema_version : 1,
                paused         : true,
                buy_fee_bps    : arg2,
                sell_fee_bps   : arg3,
            ...
            0x2::dynamic_field::add<FeeConfigKey, SwapFeeConfig>(&mut arg0.id, v2, v4);
        };
        arg0.paused = true;
        arg0.price_version = arg0.price_version + 1;
        let v5 = SwapFeeUpdated{
            pool_id          : 0x2::object::id<SwapPool<T0, T1>>(arg0),
            old_buy_fee_bps  : v0,
        ...
        0x2::event::emit<SwapFeeUpdated>(v5);
    }
    ...
    public fun set_paused<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: &SwapAdminCap<T0, T1>, arg2: bool, arg3: &0x2::clock::Clock) {
        ...
        let v0 = FeeConfigKey{dummy_field: false};
        if (0x2::dynamic_field::exists_with_type<FeeConfigKey, SwapFeeConfig>(&arg0.id, v0)) {
            0x2::dynamic_field::borrow_mut<FeeConfigKey, SwapFeeConfig>(&mut arg0.id, v0).paused = arg2;
            arg0.paused = true;
        } else {
            arg0.paused = arg2;
        };
        let v1 = SwapPauseUpdated{
            pool_id      : 0x2::object::id<SwapPool<T0, T1>>(arg0),
            paused       : arg2,
            timestamp_ms : 0x2::clock::timestamp_ms(arg3),
        };
        0x2::event::emit<SwapPauseUpdated>(v1);
    }
    ...
    entry fun swap_usdc_for_ast<T0, T1>(arg0: &mut SwapPool<T0, T1>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 >= arg4, 7);
        assert!(0x2::balance::value<T0>(&arg0.ast_reserve) >= v3, 8);
