module 0x88f1d097ed30e68aa89ca45910d43c0e6ad329de5a6aa3e59bad92e5a3eea5c2::cnsnft8592 {
    struct CNSNFT8592 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8592, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8592>(arg0, arg1);
