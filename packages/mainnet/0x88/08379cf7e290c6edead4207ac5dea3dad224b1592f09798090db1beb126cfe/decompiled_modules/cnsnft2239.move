module 0x8808379cf7e290c6edead4207ac5dea3dad224b1592f09798090db1beb126cfe::cnsnft2239 {
    struct CNSNFT2239 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2239>(arg0, arg1);
