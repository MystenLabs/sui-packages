module 0x8856a81f0681e063ad501abdc99a932e88787caf2e9752ca44c6916525a62a63::ninja_store {
    ...
    public entry fun OfferSwap<T0: store + key>(arg0: T0, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = NFTTypeInfo{type_name: 0x1::string::utf8(arg2)};
        let v4 = SwapListing{
