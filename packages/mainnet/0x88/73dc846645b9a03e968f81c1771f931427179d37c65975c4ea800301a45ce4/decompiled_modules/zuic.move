module 0x8873dc846645b9a03e968f81c1771f931427179d37c65975c4ea800301a45ce4::zuic {
    ...
    public fun debitToken(arg0: &mut CoinStore, arg1: 0x2::balance::Balance<ZUIC>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::coin::put<ZUIC>(&mut arg0.balance, 0x2::coin::from_balance<ZUIC>(arg1, arg2));
    }
