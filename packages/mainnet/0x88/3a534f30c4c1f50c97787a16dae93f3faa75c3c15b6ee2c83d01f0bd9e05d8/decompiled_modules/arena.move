module 0x31e51f357710927c7d63bfaf283944e0ebc8f9422ebd09b17330bf62c536beb0::arena {
    ...
    public fun battle_loki<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: bool, arg3: &mut 0xdee9::clob_v2::Pool<T0, T1>, arg4: &0x2::clock::Clock, arg5: u64, arg6: &0xdee9::custodian_v2::AccountCap, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        if (arg2) {
            let v2 = place_wager<T0, T1>(arg2, &arg0, &arg1) / arg5 * arg5;
            let (v3, v4, _) = 0xdee9::clob_v2::swap_exact_base_for_quote<T0, T1>(arg3, 0, arg6, v2, 0x2::coin::split<T0>(&mut arg0, v2, arg7), arg1, arg4, arg7);
            let v6 = v3;
            0x2::coin::join<T0>(&mut v6, arg0);
            (v6, v4)
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg0, 0x2::tx_context::sender(arg7));
            let (v7, v8, _) = 0xdee9::clob_v2::swap_exact_quote_for_base<T0, T1>(arg3, 0, arg6, place_wager<T0, T1>(arg2, &arg0, &arg1), arg4, arg1, arg7);
            (v7, v8)
        }
    }
