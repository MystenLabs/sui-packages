module 0x27019faad080c39c3c1735969fe4358d3d2fd288012c259e1a562a85ef559fb::cetus {
    ...
    fun init(arg0: CETUS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<CETUS>(arg0, 9, b"CETUS", b"CETUS", x"434554555320e280942043657475732050726f746f636f6c20746f6b656e206f6e205375692e", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://imagedelivery.net/cBNDGgkrsEA-b_ixIp9SkQ/cetus.jpeg/public")), arg1);
