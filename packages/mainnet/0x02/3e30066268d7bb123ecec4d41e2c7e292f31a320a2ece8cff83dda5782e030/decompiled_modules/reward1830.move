module 0x23e30066268d7bb123ecec4d41e2c7e292f31a320a2ece8cff83dda5782e030::reward1830 {
    struct REWARD1830 has drop {
        dummy_field: bool,
    }

    struct TICKET_1830 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1830(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1830>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1830>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1830, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1830>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1830>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1830>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1830>>(v5, 0x2::tx_context::sender(arg1));
    }
