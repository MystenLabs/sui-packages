module 0x2b53dcd9732bf2f944281b3ed3d70c33303619df5d9355e6f352bb02091cf31::REWARDS {
    ...
    public entry fun add_coin_to_field<T0, T1, T2>(arg0: &mut Pool<T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0);
        0x2::dynamic_field::add<0x1::string::String, 0x2::coin::Coin<T0>>(&mut arg0.id, arg2, arg1);
        let v1 = AddCoinToFieldEvent{
            sender      : 0x2::tx_context::sender(arg3),
            coin_amount : v0,
            field_name  : arg2,
            coin_type   : 0x1::string::utf8(b"CoinType"),
        };
        0x2::event::emit<AddCoinToFieldEvent>(v1);
    }
    ...
    public entry fun remove_coin_from_field<T0, T1, T2>(arg0: &mut Pool<T1, T2>, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::Coin<T0>>(&mut arg0.id, arg1);
        let v2 = RemoveCoinFromFieldEvent{
            sender      : v0,
            coin_amount : 0x2::coin::value<T0>(&v1),
            field_name  : arg1,
            coin_type   : 0x1::string::utf8(b"CoinType"),
        };
        0x2::event::emit<RemoveCoinFromFieldEvent>(v2);
    ...
    public entry fun swap_with_dynamic_fields<T0, T1, T2>(arg0: &mut Pool<T1, T2>, arg1: u64, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        let v1 = 0x2::dynamic_field::remove<0x1::string::String, 0x2::coin::Coin<T0>>(&mut arg0.id, 0x1::string::utf8(b"coin_in"));
        let v2 = 0x2::coin::value<T0>(&v1);
        assert!(v2 > 0 && (arg1 > 0 || arg2 > 0), 0);
        if (arg1 > 0) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v1, arg0.treasury);
        if (arg1 > 0) {
