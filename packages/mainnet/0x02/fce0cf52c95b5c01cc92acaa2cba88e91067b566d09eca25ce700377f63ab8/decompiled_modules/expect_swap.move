module 0x2fce0cf52c95b5c01cc92acaa2cba88e91067b566d09eca25ce700377f63ab8::expect_swap {
    ...
    public fun compute_swap_step(arg0: u128, arg1: u128, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: bool) : (u256, u256, u128, u256) {
        ...
        let (v0, v1, v2, v3) = if (arg6) {
            ...
            (v7, v1, (0x714a63a0dba6da4f017b42d5d0fb78867f18bcde904868e51d951a5a6f5b7f57::full_math_u64::mul_div_ceil((v7 as u64), arg4, 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::clmm_math::fee_rate_denominator() - arg4) as u256), v3)
        };
        (v0, v1, v3, v2)
    }
