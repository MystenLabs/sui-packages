module 0x2da60e3b6aa5cf450cd3f82a68650b3fa2cf1ade624d5a71333a8744da2363b::poe {
    struct POE has drop {
        dummy_field: bool,
    }

    public fun mint(arg0: &mut 0x2::coin::TreasuryCap<POE>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<POE>>(0x2::coin::mint<POE>(arg0, arg1, arg3), arg2);
    }
    ...
    fun init(arg0: POE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<POE>>(v4);
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<POE>>(v5);
        0x2::transfer::public_transfer<0x2::coin::Coin<POE>>(0x2::coin::mint<POE>(&mut v5, 1000000000000000000, arg1), 0x2::tx_context::sender(arg1));
    }
