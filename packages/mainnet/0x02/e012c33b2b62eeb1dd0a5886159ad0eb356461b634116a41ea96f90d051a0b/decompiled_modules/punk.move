module 0x2e012c33b2b62eeb1dd0a5886159ad0eb356461b634116a41ea96f90d051a0b::punk {
    ...
    fun init(arg0: PUNK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PUNK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Punk"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Nft"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeifpyqbfnfv5hpmzefaldk7ipvloexohnsvjgn6dp6rzcw5527rpve"));
