module 0x2020d7ebce426aead22a743b8b0f454302be8fb982837e02ef5a75f45466fb9::limbo {
    ...
    public fun settle<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: &mut Verifier, arg2: 0x2::object::ID, arg3: vector<u8>) {
        ...
        while (!0x1::vector::is_empty<Bet<T0>>(&v7)) {
            ...
            let v16 = v15;
            let v17 = v14;
            let v18 = 0x2020d7ebce426aead22a743b8b0f454302be8fb982837e02ef5a75f45466fb9::math::player_won(v13, v12);
            let v19 = if (v18) {
                0x2::coin::join<T0>(&mut v16, v17);
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v16, v2);
                0x2::coin::value<T0>(&v16)
            } else {
                0x2::coin::join<T0>(&mut v17, v16);
                let v20 = Limbo{dummy_field: false};
                0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::put<T0, Limbo>(v20, arg0, v17);
    ...
    public fun start_game<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: &mut Verifier, arg2: vector<u8>, arg3: vector<u64>, arg4: vector<0x2::coin::Coin<T0>>, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        assert!(v3 <= 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::house::max_risk<T0, Limbo>(0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::borrow_house<T0>(arg0)) / 200, 6);
