module 0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::dca {
    ...
    public(friend) fun assert_max_price<T0, T1>(arg0: u64, arg1: u64, arg2: &DCA<T0, T1>) {
        if (0x1::option::is_some<u64>(&arg2.trade_params.max_price)) {
            assert!(arg0 <= 0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::math::mul(*0x1::option::borrow<u64>(&arg2.trade_params.max_price), arg1), 11);
        };
    }
    ...
    fun assert_minimum_funding_per_trade<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64) {
        assert!(0x2::balance::value<T0>(arg0) >= 0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::math::mul(arg1, 10000), 14);
    }
    ...
    fun assert_time(arg0: u64, arg1: u64, arg2: u64, arg3: u8) {
        let v0 = if (arg3 == 0) {
            0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::time::has_n_seconds_passed(arg0, arg1, arg2)
        } else if (arg3 == 1) {
            0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::time::has_n_minutes_passed(arg0, arg1, arg2)
        } else if (arg3 == 2) {
            0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::time::has_n_hours_passed(arg0, arg1, arg2)
        } else if (arg3 == 3) {
            0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::time::has_n_days_passed(arg0, arg1, arg2)
        } else if (arg3 == 4) {
            0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::time::has_n_weeks_passed(arg0, arg1, arg2)
        } else {
            assert!(arg3 == 5, 0);
            0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::time::has_n_months_passed(arg0, arg1, arg2)
        };
        assert!(v0 == true, 7);
    }
    ...
    fun compute_min_output(arg0: u64, arg1: u64) : u64 {
        0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::math::div(arg0, arg1)
    }
    ...
    public(friend) fun fee_amount(arg0: u64) : u64 {
        0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::math::div(0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::math::mul(arg0, 5), 10000)
    }
    ...
    fun gas_budget_estimate(arg0: u64) : u64 {
        0x21464c5246d6ec60b10fc46a0adb7ff9915f6f07c8fc0bcbc8607541db912de::math::mul(25000000, arg0)
    }
