module 0x2b03e989f9080ba7cd179fbf576371bf9f3c811ca75d679cdc6d6dd478519ab::dlmsr {
    fun base_cost_internal(arg0: vector<u64>, arg1: u64, arg2: u8) : u64 {
    ...
    public fun cost(arg0: u64, arg1: u64, arg2: vector<u64>, arg3: u64, arg4: u64, arg5: u8) : u64 {
        ...
        while (v2 < 0x1::vector::length<u64>(&arg2)) {
            let v3 = &mut v1;
            let v4 = if (v0 == arg0) {
                let (v5, v6) = 0xc9e327ded995f2f1d983537b21f027935479e702a6a1f64bd3aefd47c077ba8e::u64::try_add(0x1::vector::pop_back<u64>(&mut arg2), arg1);
                assert!(v5, 4);
                v6
            } else {
            ...
            v0 = v0 + 1;
            0x1::vector::push_back<u64>(v3, v4);
            v2 = v2 + 1;
        };
        0x1::vector::destroy_empty<u64>(arg2);
        base_cost_internal(v1, effective_liquidity(v1, arg3, arg4), arg5) - base_cost_internal(arg2, effective_liquidity(arg2, arg3, arg4), arg5)
    }
    ...
    public fun payout(arg0: u64, arg1: u64, arg2: vector<u64>, arg3: u64, arg4: u64, arg5: u8) : u64 {
        ...
        0x1::vector::destroy_empty<u64>(arg2);
        base_cost_internal(arg2, effective_liquidity(arg2, arg3, arg4), arg5) - base_cost_internal(v1, effective_liquidity(v1, arg3, arg4), arg5)
    }
