module 0x24be07d011980486b2b869a805a80ae32ac6fdab9ff5d6cefb449cbbc482e6a::reward9840 {
    struct REWARD9840 has drop {
        dummy_field: bool,
    }

    struct TICKET_9840 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9840(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9840>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9840>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9840, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9840>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9840>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9840>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9840>>(v5, 0x2::tx_context::sender(arg1));
    }
