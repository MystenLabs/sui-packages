module 0x2e4cba9bd46b8363153bd714fd9d36ddb9bf985f6eb369c058dc6d04981d246::cnsnft3431 {
    struct CNSNFT3431 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3431, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3431>(arg0, arg1);
