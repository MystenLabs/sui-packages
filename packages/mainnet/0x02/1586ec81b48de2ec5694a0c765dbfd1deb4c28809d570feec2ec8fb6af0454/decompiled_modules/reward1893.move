module 0x21586ec81b48de2ec5694a0c765dbfd1deb4c28809d570feec2ec8fb6af0454::reward1893 {
    struct REWARD1893 has drop {
        dummy_field: bool,
    }

    struct TICKET_1893 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1893(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1893>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1893>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1893, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1893>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1893>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1893>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1893>>(v5, 0x2::tx_context::sender(arg1));
    }
