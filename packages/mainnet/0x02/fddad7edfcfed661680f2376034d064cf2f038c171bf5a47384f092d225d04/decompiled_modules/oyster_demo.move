module 0x2fddad7edfcfed661680f2376034d064cf2f038c171bf5a47384f092d225d04::oyster_demo {
    ...
    fun init(arg0: OYSTER_DEMO, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2fddad7edfcfed661680f2376034d064cf2f038c171bf5a47384f092d225d04::enclave::new_cap<OYSTER_DEMO>(arg0, arg1);
        0x2fddad7edfcfed661680f2376034d064cf2f038c171bf5a47384f092d225d04::enclave::create_enclave_config<OYSTER_DEMO>(&v0, 0x1::string::utf8(b"SUI Price Oracle Enclave"), x"3aa0e6e6ed7d8301655fced7e6ddcc443a3e57bf62f070caa6becf337069e859c0f03d68136440ff1cab8adefd20634c", x"b0d319fa64f9c2c9d7e9187bc21001ddacfab4077e737957fa1b8b97cc993bed43a79019aebfd40ee5f6f213147909f8", x"fdb2295dc5d9b67a653ed5f3ead5fc8166ec3cae1de1c7c6f31c3b43b2eb26ab5d063f414f3d2b93163426805dfe057e", arg1);
        0x2::transfer::public_transfer<0x2fddad7edfcfed661680f2376034d064cf2f038c171bf5a47384f092d225d04::enclave::Cap<OYSTER_DEMO>>(v0, 0x2::tx_context::sender(arg1));
    }
    ...
    fun update_price<T0: drop>(arg0: &mut PriceOracle<T0>, arg1: &0x2fddad7edfcfed661680f2376034d064cf2f038c171bf5a47384f092d225d04::enclave::Enclave<T0>, arg2: u64, arg3: u64, arg4: vector<u8>) {
        ...
        let v3 = compress_secp256k1_pubkey(0x2fddad7edfcfed661680f2376034d064cf2f038c171bf5a47384f092d225d04::enclave::pk<T0>(arg1));
        assert!(0x2::ecdsa_k1::secp256k1_verify(&arg4, &v3, &v2, 1), 0);
    ...
    entry fun update_sui_price(arg0: &mut PriceOracle<OYSTER_DEMO>, arg1: &0x2fddad7edfcfed661680f2376034d064cf2f038c171bf5a47384f092d225d04::enclave::Enclave<OYSTER_DEMO>, arg2: u64, arg3: u64, arg4: vector<u8>) {
