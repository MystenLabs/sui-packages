module 0x262fe1b9948defed706cc151bb568585936863afacb2f3af48fbdb9d69f4f0f::proof_verifier {
    ...
    public fun update_proof_verification_result(arg0: Proof, arg1: bool, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::tx_context::TxContext) {
        ...
        let v0 = ProofVerified{
            proof               : 0x2::object::id<Proof>(&arg0),
            verification_result : arg1,
            verified_at         : 0x2::tx_context::epoch_timestamp_ms(arg4),
            committee_address   : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<ProofVerified>(v0);
        0x2::transfer::public_transfer<Proof>(arg0, 0x2::tx_context::sender(arg4));
    }
