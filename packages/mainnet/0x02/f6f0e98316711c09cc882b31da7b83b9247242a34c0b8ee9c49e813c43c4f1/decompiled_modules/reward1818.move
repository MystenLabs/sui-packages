module 0x2f6f0e98316711c09cc882b31da7b83b9247242a34c0b8ee9c49e813c43c4f1::reward1818 {
    struct REWARD1818 has drop {
        dummy_field: bool,
    }

    struct TICKET_1818 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1818(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1818>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1818>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1818, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1818>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1818>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1818>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1818>>(v5, 0x2::tx_context::sender(arg1));
    }
