module 0x2dbf5a3419b5ae449b83f7debfc2d6f6f940013dda9f30032c43ab812dd945a::m {
    ...
    fun tt<T0, T1>(arg0: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg1: &mut 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::CBM, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg3: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg4: &0x2::clock::Clock, arg5: u128, arg6: bool, arg7: u64, arg8: u64, arg9: u8, arg10: u8, arg11: u64, arg12: bool, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let (v6, v7, v8) = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::flash_swap<T0, T1>(arg3, arg0, v4, true, v3, v5, arg4);
        let v9 = v8;
        let v10 = v7;
        let v11 = v6;
        let v12 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::swap_pay_amount<T0, T1>(&v9);
        let v13 = if (v4) {
        ...
        let v14 = if (arg6) {
            (((v12 as u128) * 1000000000000 / v2) as u64)
        } else {
            (((v12 as u128) * v2 / 1000000000000) as u64)
        };
        assert!(v13 >= v14, 13906836025474351106);
        let (v15, v16) = if (v4) {
            (v12, 0)
        } else {
            (0, v12)
        ...
        let (v17, v18) = if (v4) {
            ...
            (0x2::coin::zero<T0>(arg13), 0xca032a8e5955ee029d8be796b2963b402baaa9fa62aece62c03e7ca6fba52dd4::bm::wd<T1>(arg1, arg2, v12, arg13))
        };
        let v19 = v18;
        let v20 = v17;
        let (v21, v22) = if (v4) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v20, v15, arg13)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v19, v16, arg13)))
        };
        0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::repay_flash_swap<T0, T1>(arg3, arg0, v21, v22, v9);
