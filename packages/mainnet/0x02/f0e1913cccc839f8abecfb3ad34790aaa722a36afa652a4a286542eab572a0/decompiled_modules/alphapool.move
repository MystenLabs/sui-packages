module 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::alphapool {
    ...
    public fun create<T0>(arg0: &0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::alpha::Admin_cap, arg1: u64, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = Pool<T0>{
    ...
    fun deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg3: 0x2::balance::Balance<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::balance::value<T0>(&arg3);
        arg1.tokensInvested = arg1.tokensInvested + v0;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg3, 0x2::balance::value<T0>(&arg3) * arg1.deposit_fee / 100), arg5), 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::get_fee_wallet_address(arg2));
    ...
    fun destroy_receipt_and_transfer_rewards<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0;
    ...
    fun get_rewards<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::string::index_of(&v0, &v1) < 0x1::string::length(&v0)) {
            0x2::balance::join<T0>(&mut arg0.alpha_bal, 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::get_rewards<T0>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3));
        } else {
            let v2 = 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::get_rewards<T1>(arg1, 0x2::object::uid_to_inner(&arg0.id), arg2, arg3);
    ...
    public fun get_user_rewards<T0, T1>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T1> {
    ...
    public fun get_user_rewards_all<T0>(arg0: &mut Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun set_lock_period<T0>(arg0: &0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::alpha::Admin_cap, arg1: &mut Pool<T0>, arg2: u64) {
    ...
    public fun user_deposit<T0>(arg0: 0x1::option::Option<Receipt>, arg1: &mut Pool<T0>, arg2: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun user_withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        update_pool<T0>(arg1, arg4);
    ...
    fun withdraw<T0>(arg0: Receipt, arg1: &mut Pool<T0>, arg2: &mut 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::Distributor, arg3: u64, arg4: &0x2::clock::Clock, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v5, 0x2::balance::value<T0>(&v5) * arg1.withdrawal_fee / 100), arg6), 0x2f0e1913cccc839f8abecfb3ad34790aaa722a36afa652a4a286542eab572a0::distributor::get_fee_wallet_address(arg2));
