module 0x29c0c63df356177e374df60d7bcda6cf8ea862cbdf16347016f0c81a3332fdd::cnsnft9907 {
    struct CNSNFT9907 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9907, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9907>(arg0, arg1);
