module 0x2c9b5d5fb2d9fab2894dad360e5cbe76ff210c269f12b2163cebf6cfeb6bd9e::banana_bois_core_return {
    struct BANANA_BOIS_CORE_RETURN has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BANANA_BOIS_CORE_RETURN, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BANANA_BOIS_CORE_RETURN>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"banana bois core return"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"banana bois core return "));
