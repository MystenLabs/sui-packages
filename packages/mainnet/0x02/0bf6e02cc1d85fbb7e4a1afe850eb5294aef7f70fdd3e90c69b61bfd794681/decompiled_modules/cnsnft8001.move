module 0x20bf6e02cc1d85fbb7e4a1afe850eb5294aef7f70fdd3e90c69b61bfd794681::cnsnft8001 {
    struct CNSNFT8001 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8001, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8001>(arg0, arg1);
