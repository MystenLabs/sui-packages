module 0x2c40dd8493e3fbc85dcb36cf3a9ca069385cf74b5947e1018d5bfe02d3d913a::reward9585 {
    struct REWARD9585 has drop {
        dummy_field: bool,
    }

    struct TICKET_9585 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9585(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9585>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9585>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9585, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9585>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9585>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9585>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9585>>(v5, 0x2::tx_context::sender(arg1));
    }
