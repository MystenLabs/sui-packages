module 0x200cd3833dd0aec6a91d61e5aec6895531d800aab0de6d46d4b7f583395e09b::reward3647 {
    struct REWARD3647 has drop {
        dummy_field: bool,
    }

    struct TICKET_3647 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3647(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3647>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3647>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3647, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3647>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3647>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3647>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3647>>(v5, 0x2::tx_context::sender(arg1));
    }
