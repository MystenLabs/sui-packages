module 0x888f919f64154138f6e21a2341515f68d472be54c45eb9c70e628cfb5458958a::suirobo_factory {
    ...
    entry fun pay_execution_fee(arg0: &mut Marketplace, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<address>, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg1) == 10000000, 2);
        if (0x1::vector::is_empty<address>(&arg2)) {
            ...
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.treasury, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg1, 5000000, arg4)));
            let v1 = *0x1::vector::borrow<address>(&arg2, 0);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(arg1, v1);
            let v2 = ExecutionFeePaid{
                payer            : 0x2::tx_context::sender(arg4),
                total_fee        : 10000000,
                platform_share   : 5000000,
                creator_reward   : 5000000,
                rewarded_creator : v1,
                num_creators     : 0x1::vector::length<address>(&arg2),
            };
            0x2::event::emit<ExecutionFeePaid>(v2);
        };
    }
