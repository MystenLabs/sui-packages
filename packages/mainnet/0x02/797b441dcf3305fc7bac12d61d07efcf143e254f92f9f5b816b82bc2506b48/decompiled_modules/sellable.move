module 0x2797b441dcf3305fc7bac12d61d07efcf143e254f92f9f5b816b82bc2506b48::sellable {
    ...
    public fun create_config<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : (T0, CredenzaSellableConfig<T0>) {
        ...
        let v1 = CredenzaSellableConfig<T0>{
            id                      : v0,
            ownership               : 0x2797b441dcf3305fc7bac12d61d07efcf143e254f92f9f5b816b82bc2506b48::ownership::create_ownership(0x2::object::uid_to_inner(&v0), arg1),
        ...
        0x2797b441dcf3305fc7bac12d61d07efcf143e254f92f9f5b816b82bc2506b48::ownership::add_owner(&mut v1.ownership, 0x2::tx_context::sender(arg1));
