module 0x27b9e7d348e7e5b0f6ecaf8868bca955076b01d09bfda71a2d338aeba088f70::cnsnft4722 {
    struct CNSNFT4722 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4722, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4722>(arg0, arg1);
