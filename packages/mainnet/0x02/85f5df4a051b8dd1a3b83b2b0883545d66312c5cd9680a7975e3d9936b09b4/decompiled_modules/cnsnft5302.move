module 0x285f5df4a051b8dd1a3b83b2b0883545d66312c5cd9680a7975e3d9936b09b4::cnsnft5302 {
    struct CNSNFT5302 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5302, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3167"));
        let v4 = 0x2::package::claim<CNSNFT5302>(arg0, arg1);
