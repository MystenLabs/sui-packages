module 0x2fe4933f4521250e55a15441096d1d4a38a7311195b0bca126fc0138c1f5a97::claim {
    ...
    public entry fun join<T0>(arg0: &mut Claim<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        if (0x2::bag::contains<address>(&arg0.unclaim_members, v0)) {
            abort 1006
        };
        0x2::bag::add<address, u64>(&mut arg0.unclaim_members, v0, 0);
        let v1 = JoinEvent{address: v0};
        0x2::event::emit<JoinEvent>(v1);
    }
    ...
    public entry fun add_wait_claim_list<T0>(arg0: &mut Claim<T0>, arg1: &ManageCap<T0>, arg2: vector<address>, arg3: vector<u64>) {
        ...
        while (v1 < v0) {
            ...
            if (0x2::bag::contains<address>(&arg0.unclaim_members, v2)) {
                let v3 = 0x2::bag::borrow_mut<address, u64>(&mut arg0.unclaim_members, v2);
                *v3 = *v3 + 0x1::vector::pop_back<u64>(&mut arg3);
            } else {
    ...
    public entry fun check_claim_info<T0>(arg0: &mut Claim<T0>, arg1: address) {
        ...
        let v3 = CheckClaimInfoEvent{
            address        : arg1,
            amount         : v0,
            claimed_amount : v1,
            is_join        : v2,
        };
        0x2::event::emit<CheckClaimInfoEvent>(v3);
    }
