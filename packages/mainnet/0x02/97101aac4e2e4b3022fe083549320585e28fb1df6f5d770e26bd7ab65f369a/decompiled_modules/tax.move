module 0x297101aac4e2e4b3022fe083549320585e28fb1df6f5d770e26bd7ab65f369a::tax {
    ...
    fun collect_batch_impl(arg0: &mut 0x2::object::UID, arg1: u64, arg2: &0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::index::Index, arg3: 0x2::object::ID, arg4: &0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::index::Index, arg5: vector<ChildRef>, arg6: &0x2::tx_context::TxContext) : (u64, 0x2::balance::Balance<0x2::sui::SUI>) {
        ...
        while (v3 < 0x1::vector::length<ChildRef>(&arg5)) {
            ...
            if (!0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::index::outer_contains_inner(arg2, arg3, arg4, v4.child_id)) {
                v3 = v3 + 1;
                continue
            };
            let v10 = 0;
            while (v10 < 0x1::vector::length<TaxBucketKey>(&v5)) {
                ...
                if (0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::polygon::created_epoch(0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::index::get(arg2, arg3)) > v11.accrual_epoch) {
                    v10 = v10 + 1;
                    continue
                };
    ...
    public fun collect_tax(arg0: &mut 0x2::object::UID, arg1: bool, arg2: u64, arg3: &0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::index::Index, arg4: 0x2::object::ID, arg5: &0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::index::Index, arg6: vector<0x2::object::ID>, arg7: vector<u64>, arg8: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        assert!(!arg1, 3115);
        ...
        let v6 = 0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::polygon::owner(0xb73acbeb7ba64de058d7035f2db26452158f8af6b9296d1caae0d5ee89f3d23b::index::get(arg3, arg4));
        if (v4 > 0) {
