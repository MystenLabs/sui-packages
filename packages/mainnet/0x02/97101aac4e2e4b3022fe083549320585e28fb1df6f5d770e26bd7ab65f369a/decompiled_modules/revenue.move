module 0x297101aac4e2e4b3022fe083549320585e28fb1df6f5d770e26bd7ab65f369a::revenue {
    ...
    public(friend) fun deposit_revenue(arg0: &mut 0x2::object::UID, arg1: 0x2::balance::Balance<0x2::sui::SUI>, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::tx_context::TxContext) : (0x2::balance::Balance<0x2::sui::SUI>, 0x2::balance::Balance<0x2::sui::SUI>) {
        ...
        let v1 = 0x297101aac4e2e4b3022fe083549320585e28fb1df6f5d770e26bd7ab65f369a::pricing::treasury_fee_for_price(v0);
        let v2 = 0x297101aac4e2e4b3022fe083549320585e28fb1df6f5d770e26bd7ab65f369a::pricing::hierarchy_pool_for_price(v0);
    ...
    public(friend) fun route_hierarchy_pool(arg0: &mut 0x2::object::UID, arg1: 0x2::object::ID, arg2: 0x2::balance::Balance<0x2::sui::SUI>, arg3: u64, arg4: &0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        ...
        if (arg3 >= 5 || !0x297101aac4e2e4b3022fe083549320585e28fb1df6f5d770e26bd7ab65f369a::tax::tax_is_initialized(arg0)) {
            return arg2
        };
        0x297101aac4e2e4b3022fe083549320585e28fb1df6f5d770e26bd7ab65f369a::tax::tax_accrue(arg0, arg1, arg2, arg3, (arg3 as u8), arg4)
    }
