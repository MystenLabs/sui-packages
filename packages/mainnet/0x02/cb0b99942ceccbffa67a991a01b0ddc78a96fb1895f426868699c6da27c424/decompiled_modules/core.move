module 0x2cb0b99942ceccbffa67a991a01b0ddc78a96fb1895f426868699c6da27c424::core {
    ...
    public(friend) fun after_set_boost<T0>(arg0: &Setting, arg1: &mut Pool<T0>, arg2: &mut Deposit<T0>, arg3: &0x2::clock::Clock) {
        ...
        arg2.debts = debts<T0>(arg1, arg2.amount, get_boost(arg0, &arg2.owner), arg3);
    }
    ...
    fun cal_share<T0>(arg0: &Deposit<T0>, arg1: &Setting) : (u64, u64) {
        (arg0.amount * (1000 as u64), arg0.amount * get_boost(arg1, &arg0.owner))
    }

    public(friend) fun calculate_per_share_of_reward_config(arg0: u64, arg1: u64, arg2: u64, arg3: u128, arg4: u64, arg5: u64, arg6: u64) : u128 {
        let v0 = if (arg6 < arg1) {
            arg6
        } else {
            arg1
    ...
    fun create_deposit<T0>(arg0: &Setting, arg1: &mut Pool<T0>, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : Deposit<T0> {
        ...
        Deposit<T0>{
            ...
            share       : 0,
            boost_share : 0,
            debts       : debts<T0>(arg1, arg2, get_boost(arg0, &arg3), arg4),
    ...
    fun debt(arg0: &mut RewardConfig, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        update_per_share(arg0, arg2, arg3);
        ((arg0.per_share * (arg1 as u128) / 10000000000) as u64)
    }
    ...
    public(friend) fun deposit<T0>(arg0: &Setting, arg1: 0x2::coin::Coin<T0>, arg2: &mut Pool<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = create_deposit<T0>(arg0, arg2, v0, v1, arg3, arg4);
        let v3 = create_deposit_info<T0>(0x2::object::uid_to_address(&arg2.id), 0x2::object::uid_to_address(&v2.id), arg4);
        let v4 = &mut v2;
        update_share<T0>(v4, arg0, arg2, true);
        0x2::table::add<address, address>(&mut arg2.users, 0x2::tx_context::sender(arg4), 0x2::object::uid_to_address(&v2.id));
        let v5 = DepositEvent<T0>{
            deposit : 0x2::object::uid_to_address(&v2.id),
        ...
        0x2::balance::join<T0>(&mut arg2.balance, 0x2::coin::into_balance<T0>(arg1));
        0x2::transfer::share_object<Deposit<T0>>(v2);
        0x2::transfer::transfer<DepositInfo<T0>>(v3, 0x2::tx_context::sender(arg4));
    }
    ...
    public(friend) fun flip_boost<T0, T1>(arg0: &mut Pool<T0>, arg1: &0x2::clock::Clock) {
        ...
        let v2 = get_total_share(v1, arg0.total_share, arg0.total_boost_share);
    ...
    fun get_boost(arg0: &Setting, arg1: &address) : u64 {
    ...
    fun get_reward<T0>(arg0: &Deposit<T0>, arg1: &RewardConfig, arg2: &0x1::type_name::TypeName) : u64 {
        (((get_share_in_reward_config<T0>(arg0, arg1) as u128) * arg1.per_share / 10000000000) as u64) - get_debt<T0>(arg0, arg2)
    }

    fun get_reward_config_info_by_idx_mut<T0>(arg0: &mut Pool<T0>, arg1: u64) : (&0x1::type_name::TypeName, &mut RewardConfig, u64) {
        let (v0, v1) = 0x2::vec_map::get_entry_by_idx_mut<0x1::type_name::TypeName, RewardConfig>(&mut arg0.reward_configs, arg1);
        (v0, v1, get_total_share(v1, arg0.total_share, arg0.total_boost_share))
    }

    fun get_share_in_reward_config<T0>(arg0: &Deposit<T0>, arg1: &RewardConfig) : u64 {
    ...
    fun get_total_share(arg0: &RewardConfig, arg1: u64, arg2: u64) : u64 {
    ...
    public(friend) fun harvest<T0, T1>(arg0: &mut Pool<T0>, arg1: &mut Deposit<T0>, arg2: &mut Bank<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = get_share_in_reward_config<T0>(arg1, v1);
        set_debt<T0>(arg1, &v0, debt(v1, v3, v2, arg3));
    ...
    public(friend) fun per_share_of_period(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u128 {
        if (arg1 <= arg0 || arg3 == 0) {
            ...
            ((arg1 - arg0) as u128) * (arg2 as u128) * 10000000000 / (arg3 as u128)
        }
    }
    ...
    public(friend) fun remaining<T0>(arg0: &Pool<T0>, arg1: &Deposit<T0>, arg2: &0x2::clock::Clock) : 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64> {
        ...
        while (v1 < 0x2::vec_map::size<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            ...
            0x2::vec_map::insert<0x1::type_name::TypeName, u64>(&mut v0, *v2, ((calculate_per_share_of_reward_config(v3.reward_rate_before, v3.rate_change_at, v3.reward_rate_after, v3.per_share, v3.last_update_time, get_total_share(v3, arg0.total_share, arg0.total_boost_share), now(arg2)) * (get_share_in_reward_config<T0>(arg1, v3) as u128) / 10000000000) as u64) + get_credit<T0>(arg1, v2) - get_debt<T0>(arg1, v2));
            v1 = v1 + 1;
        };
        v0
    }

    fun reward_to_credit<T0>(arg0: &mut Deposit<T0>, arg1: &0x1::type_name::TypeName, arg2: &mut RewardConfig, arg3: u64, arg4: &0x2::clock::Clock) {
    ...
    fun set_debt<T0>(arg0: &mut Deposit<T0>, arg1: &0x1::type_name::TypeName, arg2: u64) {
        if (0x2::vec_map::contains<0x1::type_name::TypeName, u64>(&arg0.debts, arg1)) {
    ...
    public(friend) fun set_reward_config<T0, T1>(arg0: &mut Pool<T0>, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        let v1 = 0x2::vec_map::get_mut<0x1::type_name::TypeName, RewardConfig>(&mut arg0.reward_configs, &v0);
        let v2 = get_total_share(v1, arg0.total_share, arg0.total_boost_share);
        update_reward_config(v1, arg1, arg2, v2, arg3);
    ...
    public fun update_boost(arg0: &mut Setting, arg1: address, arg2: u64) {
        if (0x2::vec_map::contains<address, u64>(&arg0.boosts, &arg1)) {
    ...
    fun update_per_share(arg0: &mut RewardConfig, arg1: u64, arg2: &0x2::clock::Clock) {
