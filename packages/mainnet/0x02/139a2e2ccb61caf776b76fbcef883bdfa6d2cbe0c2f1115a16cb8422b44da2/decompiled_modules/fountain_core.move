module 0x8f16cb934fa0c4ad403ac3fddaab8585a642f2073a47a32215a77448c3e353c6::fountain_core {
    ...
    fun borrow_mut_penalty_vault<T0, T1>(arg0: &mut Fountain<T0, T1>) : &mut PenaltyVault<T0> {
        ...
        assert!(0x2::dynamic_field::exists_with_type<PenaltyKey, PenaltyVault<T0>>(&arg0.id, v0), 5);
    ...
    fun check_admin_cap<T0, T1>(arg0: &AdminCap, arg1: &Fountain<T0, T1>) {
        assert!(arg0.fountain_id == 0x2::object::id<Fountain<T0, T1>>(arg1), 3);
    }
    ...
    public fun claim_penalty<T0, T1>(arg0: &AdminCap, arg1: &mut Fountain<T0, T1>) : 0x2::balance::Balance<T0> {
        ...
        let v0 = PenaltyKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists_with_type<PenaltyKey, PenaltyVault<T0>>(&arg1.id, v0), 5);
        let v1 = 0x2::dynamic_field::borrow_mut<PenaltyKey, PenaltyVault<T0>>(&mut arg1.id, v0);
        0x2::balance::split<T0>(&mut v1.vault, 0x2::balance::value<T0>(&v1.vault))
    }
