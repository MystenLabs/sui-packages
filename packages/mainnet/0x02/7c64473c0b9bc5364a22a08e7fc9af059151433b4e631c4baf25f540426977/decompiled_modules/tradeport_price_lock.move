module 0x91e660159efb988d6a71abd46d056fc1c8c5904be06334c92b70ec5a0746a286::tradeport_price_lock {
    ...
    public fun cancel_any_lock<T0: store + key>(arg0: &0x2::package::Publisher, arg1: &mut Store, arg2: 0x2::object::ID, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Lock<T0>>(&arg1.id, arg2)) {
            let v0 = 0x2::dynamic_object_field::remove<0x2::object::ID, Lock<T0>>(&mut arg1.id, arg2);
    ...
    public fun end_confirm_short_lock<T0: store + key>(arg0: &mut Store, arg1: &mut 0x47c8d4e4f92f877521a1b9dd553554dfec0f449277a9611aed4349c1c40a96ba::kiosk_transfers::Store, arg2: ConfirmLockRequest<T0>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        let ConfirmLockRequest { lock_id: v0 } = arg2;
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Lock<T0>>(&arg0.id, v0), 4);
        let v1 = 0x2::dynamic_object_field::remove<0x2::object::ID, Lock<T0>>(&mut arg0.id, v0);
        assert!(v1.lock_type == 0, 9);
        assert!(v1.state == 1, 2);
        assert!(0x1::option::is_some<address>(&v1.taker) && *0x1::option::borrow<address>(&v1.taker) == 0x2::tx_context::sender(arg5), 1);
        let v2 = *0x1::option::borrow<0x2::object::ID>(&v1.nft_id);
        ...
        0x2::event::emit<LockConfirmedEvent<T0>>(v3);
        delete_lock<T0>(v1);
        0x47c8d4e4f92f877521a1b9dd553554dfec0f449277a9611aed4349c1c40a96ba::kiosk_transfers::transfer_with_purchase_capability<T0>(arg1, arg3, arg4, v2, v1.maker, arg5);
    }
    ...
    public fun start_confirm_short_lock<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &mut 0x2::kiosk::Kiosk, arg5: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, ConfirmLockRequest<T0>) {
        ...
        v0.nft_id = 0x1::option::some<0x2::object::ID>(arg3);
    ...
    public fun start_confirm_short_lock_with_buy_listing<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: &0x2::transfer_policy::TransferRequest<T0>, arg6: &mut 0x2::tx_context::TxContext) : ConfirmLockRequest<T0> {
        ...
        v0.nft_id = 0x1::option::some<0x2::object::ID>(0x2::transfer_policy::item<T0>(arg5));
