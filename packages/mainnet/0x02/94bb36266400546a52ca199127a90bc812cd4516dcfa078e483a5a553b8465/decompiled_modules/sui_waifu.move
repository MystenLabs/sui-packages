module 0x294bb36266400546a52ca199127a90bc812cd4516dcfa078e483a5a553b8465::sui_waifu {
    ...
    public fun balance<T0>(arg0: &Sui_Test<T0>) : &0x2::balance::Balance<T0> {
        &arg0.balance
    }

    public fun destroy_zero<T0>(arg0: Sui_Test<T0>) {
        let Sui_Test {
            id      : v0,
            balance : v1,
        } = arg0;
    ...
    public entry fun join<T0>(arg0: &mut Sui_Test<T0>, arg1: Sui_Test<T0>) {
        let Sui_Test {
            id      : v0,
            balance : v1,
        } = arg1;
    ...
    public fun split<T0>(arg0: &mut Sui_Test<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Sui_Test<T0> {
        let v0 = &mut arg0.balance;
        take<T0>(v0, arg1, arg2)
    }

    public fun value<T0>(arg0: &Sui_Test<T0>) : u64 {
        0x2::balance::value<T0>(&arg0.balance)
    }

    public fun zero<T0>(arg0: &mut 0x2::tx_context::TxContext) : Sui_Test<T0> {
        Sui_Test<T0>{
    ...
    public fun balance_mut<T0>(arg0: &mut Sui_Test<T0>) : &mut 0x2::balance::Balance<T0> {
        &mut arg0.balance
    }

    public entry fun burn<T0>(arg0: &mut TreasuryCap<T0>, arg1: Sui_Test<T0>) : u64 {
        let Sui_Test {
            id      : v0,
            balance : v1,
        } = arg1;
    ...
    public fun divide_into_n<T0>(arg0: &mut Sui_Test<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : vector<Sui_Test<T0>> {
        assert!(arg1 > 0, 1);
        assert!(arg1 <= value<T0>(arg0), 2);
        let v0 = 0x1::vector::empty<Sui_Test<T0>>();
        let v1 = 0;
        let v2 = value<T0>(arg0) / arg1;
        while (v1 < arg1 - 1) {
            0x1::vector::push_back<Sui_Test<T0>>(&mut v0, split<T0>(arg0, v2, arg2));
            v1 = v1 + 1;
        };
        v0
    }

    public fun from_balance<T0>(arg0: 0x2::balance::Balance<T0>, arg1: &mut 0x2::tx_context::TxContext) : Sui_Test<T0> {
        Sui_Test<T0>{
    ...
    public fun into_balance<T0>(arg0: Sui_Test<T0>) : 0x2::balance::Balance<T0> {
        let Sui_Test {
            id      : v0,
            balance : v1,
        } = arg0;
    ...
    public fun put<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: Sui_Test<T0>) {
    ...
    public fun take<T0>(arg0: &mut 0x2::balance::Balance<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Sui_Test<T0> {
        Sui_Test<T0>{
            id      : 0x2::object::new(arg2),
