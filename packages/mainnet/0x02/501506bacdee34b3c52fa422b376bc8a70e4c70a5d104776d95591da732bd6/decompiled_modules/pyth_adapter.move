module 0x2501506bacdee34b3c52fa422b376bc8a70e4c70a5d104776d95591da732bd6::pyth_adapter {
    fun assert_price_conf_within_range(arg0: u64, arg1: u64, arg2: u64) {
        assert!(((((arg1 * 10000 * 100) as u128) / (arg0 as u128)) as u64) <= 2 * arg2, 0);
    }

    public fun get_pyth_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: u64, arg3: &0x2::clock::Clock) : (u64, u8, u64) {
        ...
        assert!(v4 <= 255, 0);
        assert!(v2 > 0, 1);
        assert_price_conf_within_range(v2, 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price::get_conf(&v0), arg2);
