module 0x281a4d9a9b28fae7aee198f330fe3ee508a46151d13f6486869ba05ef333d99::cnsnft8812 {
    struct CNSNFT8812 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8812, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8812>(arg0, arg1);
