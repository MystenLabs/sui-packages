module 0xaa2a2cfcbf56c651088854c00b1bebac7ce8d6c81367569fe77a9513a021f9eb::minter {
    ...
    public fun a(arg0: &Config) : address {
        arg0.a
    }
    ...
    fun init(arg0: MINTER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MINTER>(arg0, arg1);
        ...
        let v6 = Config{
            ...
            a       : @0xde747ac256499aecd23774b8ee7ce7c6e7ec0202aa04ea4fc2d8e4d0d8f7e877,
            b       : 500000000,
            version : 1,
        };
        let v7 = Admin{id: 0x2::object::new(arg1)};
        0x2::transfer::transfer<Admin>(v7, 0x2::tx_context::sender(arg1));
        0x2::transfer::share_object<Config>(v6);
    }

    public entry fun mint(arg0: &mut Minter, arg1: u64, arg2: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg3: &Config, arg4: &0x2::clock::Clock, arg5: vector<u8>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = b"Minting";
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(arg2) >= (v5.price + arg3.b) * v11, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg2, v5.price * v11, arg6), arg0.owner);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg2, arg3.b * v11, arg6), arg3.a);
        let v13 = 0;
        while (v13 < v11) {
    ...
    public entry fun update_config(arg0: &Admin, arg1: &mut Config, arg2: address, arg3: u64, arg4: u64) {
        arg1.a = arg2;
        arg1.b = arg3;
        arg1.version = arg4;
    }
