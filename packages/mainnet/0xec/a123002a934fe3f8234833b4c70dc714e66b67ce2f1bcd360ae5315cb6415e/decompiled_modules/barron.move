module 0xeca123002a934fe3f8234833b4c70dc714e66b67ce2f1bcd360ae5315cb6415e::barron {
    ...
    fun init(arg0: BARRON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/8ByDmBFetL7kNzdWh9NPGY1Xmqpqyv1btfe3mwvFdRrw.png?size=lg&key=98295a                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BARRON>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Barron  ")))), trim_right(b"Barron Trump Meme               "), trim_right(b"Barron Trump Meme. Send this Time Traveler to Space.                                                                                                                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
