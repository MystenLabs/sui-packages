module 0xec99674bde6ea6f1133dc59ae9f98d1363d07f7a36bcb6e89745e7f0b0a972c7::game6196 {
    struct GAME6196 has drop {
        dummy_field: bool,
    }

    struct TICKET_6196 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6196(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6196>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6196>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME6196, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6196>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6196>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6196>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6196>>(v5, 0x2::tx_context::sender(arg1));
    }
