module 0xecdf555a02543cb727f27feb6a917821efb3b4ca7267d34c6eaffbb7d5b4f561::main {
    ...
    public fun initialize(arg0: &AdminCapability, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = MainConfig{
            id                      : 0x2::object::new(arg1),
            fee_recipient           : 0x2::tx_context::sender(arg1),
            open_market_fee         : 0,
            finalize_market_fee_bps : 10000,
        };
    ...
    fun validate_params(arg0: u64, arg1: u64) {
        assert!(arg0 <= arg1, 1);
    }
