module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::settlement {
    ...
    public fun settle_trade_v3<T0>(arg0: &EngineCapability, arg1: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::RiskParams, arg2: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::circuit_breaker::BreakerRegistry, arg3: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::mark_price::MarkPriceRegistry, arg4: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::funding_index::FundingRegistry, arg5: &mut SettlementLog, arg6: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::perp_controller::ControllerRegistry, arg7: &mut 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::position_store::PositionStore, arg8: &mut 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_bank::MarginBank<T0>, arg9: &mut 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::fee_manager::FeeCollector, arg10: &mut 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::MarketRegistry, arg11: vector<u8>, arg12: u64, arg13: address, arg14: address, arg15: u64, arg16: u64, arg17: u8, arg18: u64, arg19: u64, arg20: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::GlobalParams, arg21: &0x2::clock::Clock, arg22: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::borrow_market(arg10, arg11);
        let v10 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_initial_margin_ratio_bps(v9);
        let v11 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_maintenance_margin_ratio_bps(v9);
        let (v12, v13, v14) = plan_fill(arg7, arg14, v2, v1, arg16, arg15, arg18);
        let v15 = v12;
        let (v16, v17, v18) = plan_fill(arg7, arg13, v2, arg17, arg16, arg15, arg19);
        let v19 = v16;
        let v20 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_max_leverage(v9);
        let v21 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_total_oi_cap(v9);
        assert_outcome_risk(arg1, v13, v14, arg15, v20, v21);
        assert_outcome_risk(arg1, v17, v18, arg15, v20, v21);
        apply_close_outcome<T0>(arg7, arg8, v15, v2, arg15, v0);
        apply_close_outcome<T0>(arg7, arg8, v19, v2, arg15, v0);
        apply_open_outcome<T0>(arg7, arg8, v15, v2, arg15, v10, v11, v3, v4, v5, v0);
        apply_open_outcome<T0>(arg7, arg8, v19, v2, arg15, v10, v11, v3, v4, v5, v0);
        apply_positive_pnl<T0>(arg8, v15);
        apply_positive_pnl<T0>(arg8, v19);
        0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_bank::ensure_balance_exists<T0>(arg8, arg14, arg22);
        let (v22, v23) = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::fee_manager::split_fee(arg9, v8);
        0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_bank::collect_insurance<T0>(arg8, arg14, v23);
        0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::margin_bank::collect_fee<T0>(arg8, arg14, v22);
        0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::set_long_oi(arg10, arg11, add_u64_saturating(sub_oi_saturating(0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_long_oi(v9), add_u64_saturating(v15.long_oi_sub, v19.long_oi_sub)), add_u64_saturating(v15.long_oi_add, v19.long_oi_add)));
        0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::set_short_oi(arg10, arg11, add_u64_saturating(sub_oi_saturating(0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::market_short_oi(v9), add_u64_saturating(v15.short_oi_sub, v19.short_oi_sub)), add_u64_saturating(v15.short_oi_add, v19.short_oi_add)));
        0x2::table::add<u64, bool>(&mut arg5.settled_trades, arg12, true);
        arg5.trade_count = arg5.trade_count + 1;
        let v24 = TradeSettled{
            trade_id     : arg12,
            market_id    : v2,
            symbol       : arg11,
            maker        : arg13,
            ...
            maker_side   : arg17,
            taker_fee    : v8,
            maker_rebate : 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::fee_manager::pay_maker_rebate(arg9, arg13, v2, arg11, v7),
            timestamp_ms : v0,
        };
        0x2::event::emit<TradeSettled>(v24);
    }
