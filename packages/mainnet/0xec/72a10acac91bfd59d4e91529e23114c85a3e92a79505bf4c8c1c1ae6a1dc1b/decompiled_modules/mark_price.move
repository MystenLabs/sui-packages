module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::mark_price {
    ...
    struct MarkPriceWriterCap has store, key {
        id: 0x2::object::UID,
    }
    ...
    struct MarkPriceWriterCapCreated has copy, drop {
    ...
    public fun create_mark_price_writer_cap(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = MarkPriceWriterCap{id: 0x2::object::new(arg2)};
        0x2::transfer::public_transfer<MarkPriceWriterCap>(v0, arg1);
        let v1 = MarkPriceWriterCapCreated{writer_address: arg1};
        0x2::event::emit<MarkPriceWriterCapCreated>(v1);
    }
    ...
    public fun register_market(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut MarkPriceRegistry, arg2: 0x2::object::ID, arg3: u64, arg4: &0x2::clock::Clock) {
        ...
        let v0 = MarkPriceState{
            ...
            last_session_flag      : 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::session_open(),
        };
    ...
    public fun set_last_close_oracle(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut MarkPriceRegistry, arg2: 0x2::object::ID, arg3: u64) {
    ...
    public fun update_mark_price(arg0: &MarkPriceWriterCap, arg1: &mut MarkPriceRegistry, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8, arg9: &0x2::clock::Clock) {
        update_mark_price_core(arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, true);
    }

    fun update_mark_price_core(arg0: &mut MarkPriceRegistry, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u8, arg8: &0x2::clock::Clock, arg9: bool) {
        assert!(0x2::table::contains<0x2::object::ID, MarkPriceState>(&arg0.states, arg1), 0);
        assert!(arg2 > 0, 2);
        assert!(arg6 > 0, 2);
        ...
        let v3 = 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::market_factory::session_open();
        if (v0.last_session_flag == v3 && arg7 != v3) {
            v0.last_close_oracle = v0.oracle_price;
        };
        let v4 = if (arg7 == v3) {
            if (arg9 && v0.last_session_flag == v3) {
                clamp_to_bps_bound(arg6, v0.oracle_price, v0.max_per_update_bps)
            } else if (arg9) {
                clamp_to_bps_bound(arg6, v0.oracle_price, 2000)
            } else {
                arg6
            }
        } else {
    ...
    public fun update_params(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut MarkPriceRegistry, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: u64, arg6: u64) {
        assert!(0x2::table::contains<0x2::object::ID, MarkPriceState>(&arg1.states, arg2), 0);
