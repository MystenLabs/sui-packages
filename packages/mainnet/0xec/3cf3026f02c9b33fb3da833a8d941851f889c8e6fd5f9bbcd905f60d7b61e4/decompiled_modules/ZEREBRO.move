module 0xec3cf3026f02c9b33fb3da833a8d941851f889c8e6fd5f9bbcd905f60d7b61e4::ZEREBRO {
    struct ZEREBRO has drop {
        dummy_field: bool,
    }

    fun init(arg0: ZEREBRO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<ZEREBRO>(arg0, 2, b"ZEREBRO", b"ZEREBRO", b"ZEREBRO", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/6XXPLJL-xaUr9R5IbXAzpnUpDr4V71XKDAeqA_qoiYE?ext=png")), arg1);
