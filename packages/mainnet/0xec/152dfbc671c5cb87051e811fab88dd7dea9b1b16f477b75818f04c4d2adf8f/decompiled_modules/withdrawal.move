module 0xec152dfbc671c5cb87051e811fab88dd7dea9b1b16f477b75818f04c4d2adf8f::withdrawal {
    ...
    entry fun create_pool<T0>(arg0: vector<u8>, arg1: vector<vector<u8>>, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: address, arg7: address, arg8: address, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = WithdrawalOwnerCap<T0>{
            id      : 0x2::object::new(arg10),
            pool_id : v4,
        };
        let v6 = GovernanceCap<T0>{
            id      : 0x2::object::new(arg10),
            pool_id : v4,
        };
        let v7 = GuardianCap<T0>{
            id      : 0x2::object::new(arg10),
            pool_id : v4,
        };
        let v8 = TreasuryCap<T0>{
            id      : 0x2::object::new(arg10),
            pool_id : v4,
        };
        let v9 = PoolCreated{
        ...
        0x2::transfer::transfer<WithdrawalOwnerCap<T0>>(v5, 0x2::tx_context::sender(arg10));
        0x2::transfer::transfer<GovernanceCap<T0>>(v6, arg6);
        0x2::transfer::transfer<GuardianCap<T0>>(v7, arg7);
        0x2::transfer::transfer<TreasuryCap<T0>>(v8, arg8);
    }
