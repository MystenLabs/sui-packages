module 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_pool {
    ...
    public(friend) fun accrue_fees<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u128, arg2: u64) : u128 {
        ...
        if (arg0.management_fee_bps > 0) {
            ...
            if (v6) {
                v1 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_math::mul_div(v5, v0, arg1);
            };
        };
        if (arg0.performance_fee_bps > 0 && arg1 > arg0.last_total_assets) {
            let v7 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_math::mul_div(arg1 - arg0.last_total_assets, (arg0.performance_fee_bps as u128), (10000 as u128));
            v4 = v7;
            let v8 = if (v7 > 0) {
                if (v0 > 0) {
                    arg1 > 0
            ...
            if (v8) {
                v2 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_math::mul_div(v7, v0, arg1);
            };
        };
        let v9 = v1 + v2;
        arg0.last_fee_collection_ms = arg2;
        ...
        if (v9 > 0) {
            0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_fees_accrued(0x2::object::id<LLVPool<T0, T1>>(arg0), v1, v2, v9, arg0.fee_recipient, arg0.last_total_assets, v3, v4, arg1, v0 + v9, arg2);
        };
        v9
    }
    ...
    public(friend) fun add_keeper<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: address, arg3: &0x2::clock::Clock) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        ...
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_keeper_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, true, 0x2::clock::timestamp_ms(arg3));
    }

    public(friend) fun add_protocol<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: &0x2::clock::Clock) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(!0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 2);
        assert!(!0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::is_idle_protocol(arg2), 2);
        ...
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_update_protocol(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, 0, false, false, 0, 0, 0, 0, 0, 0x2::clock::timestamp_ms(arg3));
    }
    ...
    public(friend) fun claim_fee_shares<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: address, arg2: &mut 0x2::tx_context::TxContext, arg3: &0x2::clock::Clock) : (0x2::coin::Coin<T1>, u128) {
        ...
        (0x2::coin::mint<T1>(&mut arg0.share_treasury, (v0 as u64), arg2), 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_math::calculate_assets_for_shares(total_shares<T0, T1>(arg0), get_total_assets<T0, T1>(arg0), v0))
    }
    ...
    public(friend) fun create_pool<T0, T1>(arg0: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVGlobalAdminCap, arg1: 0x1::string::String, arg2: 0x2::coin::TreasuryCap<T1>, arg3: u8, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (LLVPool<T0, T1>, 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap) {
        ...
        let v1 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::PROTOCOL_IDLE();
        ...
        let v4 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::create_pool_admin_cap(v3, arg5);
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_pool_created(v3, 0x2::object::id<0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap>(&v4), 0x1::type_name::with_defining_ids<T0>(), 0x2::tx_context::sender(arg5), v0.paused, v0.min_deposit, v0.deposit_cap, v0.performance_fee_bps, v0.management_fee_bps, v0.fee_recipient, v0.min_rebalance_interval_ms, v0.min_rebalance_deviation_bps, 0x2::clock::timestamp_ms(arg4));
        (v0, v4)
    }
    ...
    public(friend) fun deposit_idle_balance_internal<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        ...
        record_deposit<T0, T1>(arg0, 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::PROTOCOL_IDLE(), (v0 as u128));
    ...
    public(friend) fun extract_balance<T0, T1, T2>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u64) : 0x2::balance::Balance<T2> {
        ...
        if (!0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::exists_<0x2::balance::Balance<T2>>(v0, arg1)) {
            return 0x2::balance::zero<T2>()
        };
        let v1 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::borrow_mut<0x2::balance::Balance<T2>>(v0, arg1);
        if (0x2::balance::value<T2>(v1) <= arg2) {
            0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::remove<0x2::balance::Balance<T2>>(v0, arg1)
        } else {
    ...
    public(friend) fun extract_idle_balance<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = borrow_uid_mut<T0, T1>(arg0);
        let v1 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::PROTOCOL_IDLE();
        if (!0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::exists_<0x2::balance::Balance<T0>>(v0, v1)) {
            return 0x2::balance::zero<T0>()
        };
        let v2 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::borrow_mut<0x2::balance::Balance<T0>>(v0, v1);
    ...
    public fun extract_protocol_cap<T0, T1, T2: copy + drop + store, T3: store>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: T2) : T3 {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
    ...
    public fun get_protocol_deposit_cap<T0, T1>(arg0: &LLVPool<T0, T1>, arg1: u8) : u128 {
        if (0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::is_idle_protocol(arg1)) {
            return 0
        };
        if (!0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg1)) {
            return 0
    ...
    public(friend) fun inject_reward_to_idle<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: 0x2::coin::Coin<T0>) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
    ...
    public(friend) fun pause<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        arg0.paused = true;
    }
    ...
    public fun query_holding_balance<T0, T1, T2>(arg0: &LLVPool<T0, T1>, arg1: u8) : u64 {
        ...
        if (0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::exists_<0x2::balance::Balance<T2>>(v0, arg1)) {
            0x2::balance::value<T2>(0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::borrow<0x2::balance::Balance<T2>>(v0, arg1))
        } else {
            0
        }
    }
    ...
    public fun query_idle_holding_balance<T0, T1>(arg0: &LLVPool<T0, T1>) : u64 {
        ...
        let v1 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::PROTOCOL_IDLE();
        if (0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::exists_<0x2::balance::Balance<T0>>(v0, v1)) {
            0x2::balance::value<T0>(0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::borrow<0x2::balance::Balance<T0>>(v0, v1))
        } else {
            0
        }
    }
    ...
    public(friend) fun record_withdraw<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: u128) {
        if (0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg1)) {
            ...
            let v2 = if (v1.deposited_amount >= arg2) {
                ...
                0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_withdraw_saturation(v0, arg1, 0, v1.deposited_amount, arg2);
                0
            };
            ...
            let v3 = if (v1.current_balance >= arg2) {
                ...
                0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_withdraw_saturation(v0, arg1, 1, v1.current_balance, arg2);
                0
            };
    ...
    public(friend) fun refresh_idle_balance<T0, T1>(arg0: &mut LLVPool<T0, T1>) {
        let v0 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::PROTOCOL_IDLE();
    ...
    public fun register_protocol_leg_auth<T0, T1, T2>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u8) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
    ...
    public(friend) fun remove_keeper<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: address, arg3: &0x2::clock::Clock) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        let (v0, v1) = 0x1::vector::index_of<address>(&arg0.keepers, &arg2);
        assert!(v0, 107);
        0x1::vector::remove<address>(&mut arg0.keepers, v1);
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_keeper_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, false, 0x2::clock::timestamp_ms(arg3));
    }

    public fun return_protocol_cap<T0, T1, T2: copy + drop + store, T3: store>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: T2, arg3: T3) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
    ...
    public fun rotate_protocol_cap<T0, T1, T2: copy + drop + store, T3: store>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: T2) : T3 {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        0x2::dynamic_field::remove<T2, T3>(&mut arg0.id, arg2)
    }
    ...
    public(friend) fun set_deposit_cap<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u128) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        arg0.deposit_cap = arg2;
    }

    public(friend) fun set_fee_recipient<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: address) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        arg0.fee_recipient = arg2;
    }

    public(friend) fun set_management_fee<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(arg2 <= 500, 104);
        arg0.management_fee_bps = arg2;
    }

    public(friend) fun set_min_deposit<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        arg0.min_deposit = arg2;
    }

    public(friend) fun set_min_rebalance_deviation<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(arg2 >= 10, 121);
        arg0.min_rebalance_deviation_bps = arg2;
    }

    public(friend) fun set_min_rebalance_interval<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(arg2 >= 60000, 120);
        arg0.min_rebalance_interval_ms = arg2;
    }

    public(friend) fun set_name<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: 0x1::string::String) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        arg0.name = arg2;
    }

    public(friend) fun set_performance_fee<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u64) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(arg2 <= 5000, 104);
        arg0.performance_fee_bps = arg2;
    }

    public(friend) fun set_protocol_config<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: ProtocolConfig, arg4: &0x2::clock::Clock) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        ...
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_update_protocol_config(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, v0, arg3.ids, arg3.values, v1, 0x2::clock::timestamp_ms(arg4));
    }

    public(friend) fun set_protocol_deposit_cap<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: u128) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(!0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::is_idle_protocol(arg2), 130);
        assert!(0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 3);
        0x2::vec_map::get_mut<u8, ProtocolAllocation>(&mut arg0.allocations, &arg2).deposit_cap = arg3;
    }

    public(friend) fun set_protocol_status<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: bool, arg4: bool, arg5: &0x2::clock::Clock) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(!0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::is_idle_protocol(arg2), 130);
        assert!(0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 3);
        ...
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_update_protocol(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, 1, arg3, arg4, v0.target_ratio_bps, v0.deposited_amount, v0.current_balance, v0.last_sync_ms, v0.apr_bps, 0x2::clock::timestamp_ms(arg5));
    }

    public(friend) fun set_protocol_targets<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: vector<u8>, arg3: vector<u64>, arg4: vector<u128>, arg5: vector<bool>, arg6: vector<bool>, arg7: &0x2::clock::Clock) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        ...
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_protocol_targets_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, arg3, arg4, arg5, arg6, 0x2::clock::timestamp_ms(arg7));
    }

    public(friend) fun set_supply_queue<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: vector<u8>) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        validate_queue<T0, T1>(arg0, &arg2);
        arg0.supply_queue = arg2;
    }

    public(friend) fun set_withdraw_queue<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: vector<u8>) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        validate_queue<T0, T1>(arg0, &arg2);
    ...
    public(friend) fun store_or_join_balance<T0, T1, T2>(arg0: &mut LLVPool<T0, T1>, arg1: u8, arg2: 0x2::balance::Balance<T2>) {
        let v0 = borrow_uid_mut<T0, T1>(arg0);
        if (0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::exists_<0x2::balance::Balance<T2>>(v0, arg1)) {
            0x2::balance::join<T2>(0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::borrow_mut<0x2::balance::Balance<T2>>(v0, arg1), arg2);
        } else {
            0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::store<0x2::balance::Balance<T2>>(v0, arg1, arg2);
        };
    }
    ...
    public(friend) fun store_or_join_idle_balance<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: 0x2::balance::Balance<T0>) {
        ...
        let v1 = 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::PROTOCOL_IDLE();
        if (0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::exists_<0x2::balance::Balance<T0>>(v0, v1)) {
            0x2::balance::join<T0>(0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::borrow_mut<0x2::balance::Balance<T0>>(v0, v1), arg1);
        } else {
            0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::protocol_holdings::store<0x2::balance::Balance<T0>>(v0, v1, arg1);
        };
    }

    public fun store_protocol_cap<T0, T1, T2: copy + drop + store, T3: store>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: T2, arg3: T3) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        0x2::dynamic_field::add<T2, T3>(&mut arg0.id, arg2, arg3);
    }
    ...
    public(friend) fun unpause<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        arg0.paused = false;
    }

    public(friend) fun update_apr<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: &0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::LLVPoolAdminCap, arg2: u8, arg3: u64, arg4: &0x2::clock::Clock) {
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_admin::verify_pool_admin(arg1, 0x2::object::id<LLVPool<T0, T1>>(arg0));
        assert!(0x2::vec_map::contains<u8, ProtocolAllocation>(&arg0.allocations, &arg2), 3);
        let v0 = 0x2::vec_map::get_mut<u8, ProtocolAllocation>(&mut arg0.allocations, &arg2);
        v0.apr_bps = arg3;
        0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_events::emit_apr_updated(0x2::object::id<LLVPool<T0, T1>>(arg0), arg2, v0.apr_bps, arg3, 0x2::clock::timestamp_ms(arg4));
    }
    ...
    public(friend) fun withdraw_idle_balance_internal<T0, T1>(arg0: &mut LLVPool<T0, T1>, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        record_withdraw<T0, T1>(arg0, 0xecfc0a19eec03f6347dd0f5d5cede2552b0a0e7a7a5742a9294159e868a486ca::llv_allocation_plan::PROTOCOL_IDLE(), (arg1 as u128));
        refresh_idle_balance<T0, T1>(arg0);
        v0
    }
