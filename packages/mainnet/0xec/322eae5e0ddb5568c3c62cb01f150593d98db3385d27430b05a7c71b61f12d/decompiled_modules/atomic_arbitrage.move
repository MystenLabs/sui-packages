module 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::atomic_arbitrage {
    ...
    public entry fun arb_cross_dex_simple(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_invalid_amount_error());
        ...
        assert!(v5 >= arg1, 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_insufficient_profit_error());
    ...
    public entry fun arb_sui_usdc_sui(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::clock::timestamp_ms(arg2);
        assert!(v0 > 0, 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_invalid_amount_error());
        assert!(v0 >= 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_min_sui_amount(), 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_invalid_amount_error());
        let v3 = v0 * 30 / 10000;
        let v4 = v0 - v3;
        let v5 = v4 * 25 / 10000;
        let v6 = v4 - v5;
        ...
        assert!(v7 >= arg1, 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_insufficient_profit_error());
