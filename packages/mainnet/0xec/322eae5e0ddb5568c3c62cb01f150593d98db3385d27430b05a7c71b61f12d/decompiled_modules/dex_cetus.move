module 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::dex_cetus {
    ...
    public fun get_dex_info() : 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::dex_trait::DexInfo {
        0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::dex_trait::create_dex_info(b"Cetus", 30, @0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb)
    }
    ...
    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_cetus_sui_usdc_pool(),
        };
