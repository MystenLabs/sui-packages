module 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::dex_turbos {
    ...
    public fun get_dex_info() : 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::dex_trait::DexInfo {
        0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::dex_trait::create_dex_info(b"Turbos", 25, @0x91bfbc386a41afcfd9b2533058d7e915a1d3829089cc268ff4333d54d6339ca1)
    }

    public fun swap_cross<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: address, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let v0 = 0x2::coin::value<T0>(&arg0);
        assert!(v0 > 0, 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_zero_amount_error());
        ...
        let v1 = SwapExecuted{
            ...
            trader       : arg1,
            pool_address : 0xec322eae5e0ddb5568c3c62cb01f150593d98db3385d27430b05a7c71b61f12d::constants::get_turbos_sui_usdc_pool(),
        };
