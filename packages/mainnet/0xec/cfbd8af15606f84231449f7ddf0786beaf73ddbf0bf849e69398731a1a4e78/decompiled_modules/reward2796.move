module 0xeccfbd8af15606f84231449f7ddf0786beaf73ddbf0bf849e69398731a1a4e78::reward2796 {
    struct REWARD2796 has drop {
        dummy_field: bool,
    }

    struct TICKET_2796 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2796(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2796>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2796>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2796, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2796>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2796>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2796>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2796>>(v5, 0x2::tx_context::sender(arg1));
    }
