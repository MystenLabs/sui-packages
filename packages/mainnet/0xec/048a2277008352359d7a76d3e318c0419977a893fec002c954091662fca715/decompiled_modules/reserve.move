module 0xec048a2277008352359d7a76d3e318c0419977a893fec002c954091662fca715::reserve {
    ...
    public(friend) fun repay_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>, arg2: FlashLoan<T0>) {
        ...
        assert!(0x2::balance::value<T0>(&arg1) >= v0, 0xec048a2277008352359d7a76d3e318c0419977a893fec002c954091662fca715::error::flash_loan_repay_not_enough_error());
        0x350fe3231df82efee1a1d15af4e132a92ba2b445cbdd92208ba5270132f68a79::balance_bag::join<T0>(&mut arg0.underlying_balances, arg1);
    }
