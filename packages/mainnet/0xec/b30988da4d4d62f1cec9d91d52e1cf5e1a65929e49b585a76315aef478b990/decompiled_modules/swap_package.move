module 0xecb30988da4d4d62f1cec9d91d52e1cf5e1a65929e49b585a76315aef478b990::swap_package {
    ...
    public fun swap_bac_by_ab_ac<T0, T1, T2>(arg0: &WhiteList, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T2>, arg4: &mut CoinWallet<T1>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 4295048016;
        let v4 = 79226673515401279992447579055;
        white_list_check(arg0, &v2);
        let v5 = 0;
        let v6 = 0x2::coin::take<T1>(&mut arg4.token, arg5, arg9);
        let v7 = 0x2::coin::zero<T0>(arg9);
        let v8 = 0x2::coin::zero<T2>(arg9);
        let (v9, v10, v11) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg2, false, v0, arg5, v4, arg7);
        let v12 = v11;
        let v13 = v9;
        ...
        0x2::event::emit<FlashSwapRespEvent>(v16);
        0x2::coin::join<T1>(&mut v6, 0x2::coin::from_balance<T1>(v10, arg9));
        0x2::coin::join<T0>(&mut v7, 0x2::coin::from_balance<T0>(v13, arg9));
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v6, v14, arg9)), v12);
        let (v17, v18, v19) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T2>(arg1, arg3, true, v0, v15, v3, arg7);
        let v20 = v19;
        let v21 = v18;
        let v22 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T2>(&v20);
        let v23 = 0x2::balance::value<T2>(&v21);
        let v24 = FlashSwapRespEvent{
            a2b              : v1,
            by_amount_in     : v0,
            amount           : arg5,
            min_out_amount   : arg6,
        ...
        0x2::event::emit<FlashSwapRespEvent>(v24);
        assert!(v23 > arg6, 502);
        0x2::coin::join<T0>(&mut v7, 0x2::coin::from_balance<T0>(v17, arg9));
        0x2::coin::join<T2>(&mut v8, 0x2::coin::from_balance<T2>(v21, arg9));
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T2>(arg1, arg3, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v7, v22, arg9)), 0x2::balance::zero<T2>(), v20);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v7, arg8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v6, arg8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v8, arg8);
    }
    ...
    public fun swap_bac_by_ab_ca<T0, T1, T2>(arg0: &WhiteList, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T2, T0>, arg4: &mut CoinWallet<T1>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: address, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        let v4 = 0x2::coin::take<T1>(&mut arg4.token, arg5, arg9);
        let v5 = 0x2::coin::zero<T0>(arg9);
        let v6 = 0x2::coin::zero<T2>(arg9);
        let (v7, v8, v9) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg2, false, v0, arg5, v2, arg7);
        let v10 = v9;
        let v11 = v7;
        ...
        0x2::event::emit<FlashSwapRespEvent>(v14);
        0x2::coin::join<T1>(&mut v4, 0x2::coin::from_balance<T1>(v8, arg9));
        0x2::coin::join<T0>(&mut v5, 0x2::coin::from_balance<T0>(v11, arg9));
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v4, v12, arg9)), v10);
        let (v15, v16, v17) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T2, T0>(arg1, arg3, false, v0, v13, v2, arg7);
        let v18 = v17;
        let v19 = v15;
        let v20 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T2, T0>(&v18);
        let v21 = 0x2::balance::value<T2>(&v19);
        let v22 = FlashSwapRespEvent{
            a2b              : false,
            by_amount_in     : v0,
            amount           : arg5,
            min_out_amount   : arg6,
        ...
        0x2::event::emit<FlashSwapRespEvent>(v22);
        assert!(v21 > arg6, 502);
        0x2::coin::join<T2>(&mut v6, 0x2::coin::from_balance<T2>(v19, arg9));
        0x2::coin::join<T0>(&mut v5, 0x2::coin::from_balance<T0>(v16, arg9));
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T2, T0>(arg1, arg3, 0x2::balance::zero<T2>(), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v5, v20, arg9)), v18);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v5, arg8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v4, arg8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v6, arg8);
    }
