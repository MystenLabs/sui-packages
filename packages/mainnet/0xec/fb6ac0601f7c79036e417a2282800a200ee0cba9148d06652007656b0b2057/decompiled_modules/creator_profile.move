module 0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile {
    ...
    public entry fun create_profile(arg0: &0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::user_profile::UserProfile, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        assert!(0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::user_profile::get_user(arg0) == v0, 1);
        assert!(0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::user_profile::is_creator(arg0), 4);
        let v2 = CreatorProfile{
            id                : 0x2::object::new(arg4),
            creator           : v0,
            user_profile_id   : 0x2::object::id<0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::user_profile::UserProfile>(arg0),
            handle            : arg1,
            banner_url        : arg2,
        ...
        0x2::transfer::share_object<CreatorProfile>(v2);
        let v4 = CreatorCap{
            id      : 0x2::object::new(arg4),
            creator : v0,
        };
