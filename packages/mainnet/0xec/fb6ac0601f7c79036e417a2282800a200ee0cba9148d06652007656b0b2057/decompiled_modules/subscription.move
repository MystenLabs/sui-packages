module 0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::subscription {
    ...
    public entry fun renew(arg0: &mut SubscriptionToken, arg1: &Tier, arg2: &mut 0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile::CreatorProfile, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(arg0.subscriber == v0, 1);
        assert!(arg1.active, 2);
        assert!(0x2::object::id<Tier>(arg1) == arg0.tier_id, 1);
        assert!(0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile::get_creator(arg2) == arg1.creator, 1);
        ...
        0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile::add_earnings(arg2, arg1.price);
    ...
    public entry fun subscribe(arg0: &Tier, arg1: &mut 0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile::CreatorProfile, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.active, 2);
        assert!(0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile::get_creator(arg1) == arg0.creator, 1);
        ...
        0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile::increment_subscriber_count(arg1);
        0xecfb6ac0601f7c79036e417a2282800a200ee0cba9148d06652007656b0b2057::creator_profile::add_earnings(arg1, arg0.price);
