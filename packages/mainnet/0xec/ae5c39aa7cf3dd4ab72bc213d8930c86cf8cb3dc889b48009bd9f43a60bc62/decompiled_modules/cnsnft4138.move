module 0xecae5c39aa7cf3dd4ab72bc213d8930c86cf8cb3dc889b48009bd9f43a60bc62::cnsnft4138 {
    struct CNSNFT4138 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4138, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4138>(arg0, arg1);
