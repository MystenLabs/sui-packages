module 0xeca828a63d7b92cbe35125b8fc8c566d6d29155ed9ec598c3f4d79559328ba1e::pill {
    ...
    fun init(arg0: PILL, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://ipfs.io/ipfs/QmcgXzfzzQRiStycWxMR8wcwmBYyGoyuGTzMHCAwJPLA6V                                                                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PILL>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PILL      ")))), trim_right(b"PUMP                            "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
