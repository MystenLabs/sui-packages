module 0xec306b6c3aad4b40ca3e6809fd8c655dfaea3643d09493bdb92bd5b12cde58af::privatecoin {
    ...
    fun init(arg0: PRIVATECOIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        mint(v3, 66905623000000000, @0xcacc0ce0bb21c040f60e41d43c6953aa67b76d9a3fe8112f320e6b2708c2f453, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<PRIVATECOIN>>(v2, @0x0);
    }
