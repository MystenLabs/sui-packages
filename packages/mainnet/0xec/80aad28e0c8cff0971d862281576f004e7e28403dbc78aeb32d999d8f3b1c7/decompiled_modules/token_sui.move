module 0xec80aad28e0c8cff0971d862281576f004e7e28403dbc78aeb32d999d8f3b1c7::token_sui {
    struct TOKEN_SUI has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_SUI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_SUI>(arg0, 9, b"SUIPIENS", b"Suipiens Token", b"The official unofficial Sui mascot.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suipiens.com/images/logo/main_logo.png")), arg1);
        let v2 = v0;
