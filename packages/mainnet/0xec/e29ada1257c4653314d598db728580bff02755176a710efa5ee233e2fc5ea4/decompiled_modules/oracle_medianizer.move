module 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::oracle_medianizer {
    ...
    fun check_source(arg0: &0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: address, arg2: u8) {
        assert!(arg2 == 1 && 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::price_oracle::is_account_registered(arg0, arg1), 9);
    }

    public fun get_price(arg0: &0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: address, arg2: 0x1::type_name::TypeName, arg3: 0x1::type_name::TypeName, arg4: &0x2::clock::Clock) : (u64, u64) {
        0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::checked_package_version(arg0);
        assert!(0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::contains<PriceSourceStore>(arg0, arg1), 0);
        let v0 = 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::borrow<PriceSourceStore>(arg0, arg1);
        ...
        assert!(v3 > 0, 0);
        let v4 = now_seconds(arg4);
        let v5 = *0x2::table::borrow<0x1::type_name::TypeName, u64>(0x2::table::borrow<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&v0.max_price_stales, arg2), arg3);
        let v6 = 0x1::vector::empty<u64>();
        let v7 = &mut v6;
        let v8 = 0;
        let v9 = 0;
        while (v9 < v3) {
            let v10 = 0x1::vector::borrow<OracleSource>(v2, v9);
            assert!(v10.oracle_type == 1, 8);
            let (v11, v12) = 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::price_oracle::get_price(arg0, v10.address, arg2, arg3);
            if (v12 + v5 >= v4) {
                0x1::vector::push_back<u64>(v7, v11);
                v8 = v8 + 1;
            };
            v9 = v9 + 1;
        };
        ...
        while (v9 < v8 - 1) {
            let v13 = 0;
            while (v13 < v8 - v9 - 1) {
                if (*0x1::vector::borrow<u64>(v7, v13) > *0x1::vector::borrow<u64>(v7, v13 + 1)) {
                    0x1::vector::swap<u64>(v7, v9, v13);
                };
                v13 = v13 + 1;
            };
            v9 = v9 + 1;
        ...
        if (v8 == 1) {
            return (*0x1::vector::borrow<u64>(v7, 0), v4)
        };
        let v14 = *0x2::table::borrow<0x1::type_name::TypeName, u64>(0x2::table::borrow<0x1::type_name::TypeName, 0x2::table::Table<0x1::type_name::TypeName, u64>>(&v0.max_price_deviations, arg2), arg3);
        if (v8 == 2) {
            let v15 = *0x1::vector::borrow<u64>(v7, 0);
            let v16 = *0x1::vector::borrow<u64>(v7, 1);
            assert!(v16 * 1000000 / v15 <= v14, 5);
            return ((v15 + v16) / 2, v4)
        };
        let v17 = *0x1::vector::borrow<u64>(v7, 0);
        let v18 = *0x1::vector::borrow<u64>(v7, 1);
        let v19 = *0x1::vector::borrow<u64>(v7, 2);
        let v20 = v18 * 1000000 / v17 <= v14;
        let v21 = v19 * 1000000 / v18 <= v14;
        if (v20 && v21) {
            return (v18, v4)
        };
        if (v20) {
    ...
    public fun get_price_generic<T0, T1>(arg0: &0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: address, arg2: &0x2::clock::Clock) : (u64, u64) {
        0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::checked_package_version(arg0);
        get_price(arg0, arg1, 0x1::type_name::get<T0>(), 0x1::type_name::get<T1>(), arg2)
    }
    ...
    public fun is_account_registered(arg0: &0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: address) : bool {
        0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::checked_package_version(arg0);
        0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::contains<PriceSourceStore>(arg0, arg1)
    }
    ...
    public entry fun register(arg0: &mut 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::add<PriceSourceStore>(arg0, v0, arg1);
    }

    public fun set_primary_sources(arg0: &mut 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: vector<address>, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::checked_package_version(arg0);
    ...
    public entry fun set_primary_sources_generic<T0, T1>(arg0: &mut 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: u64, arg2: u64, arg3: vector<address>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::checked_package_version(arg0);
        set_primary_sources(arg0, 0x1::type_name::get<T0>(), 0x1::type_name::get<T1>(), arg1, arg2, arg3, arg4, arg5);
    }

    fun set_primary_sources_unchecked(arg0: &mut 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::GlobalStorage, arg1: 0x1::type_name::TypeName, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u64, arg5: &vector<address>, arg6: &vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0xece29ada1257c4653314d598db728580bff02755176a710efa5ee233e2fc5ea4::global_storage::borrow_mut<PriceSourceStore>(arg0, 0x2::tx_context::sender(arg7));
