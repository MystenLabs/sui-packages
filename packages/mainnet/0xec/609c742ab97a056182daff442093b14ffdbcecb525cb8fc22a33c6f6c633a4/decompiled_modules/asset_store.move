module 0xec609c742ab97a056182daff442093b14ffdbcecb525cb8fc22a33c6f6c633a4::asset_store {
    ...
    public(friend) fun deposit_object<T0: store + key>(arg0: &mut AssetStore, arg1: T0) {
        let v0 = create_asset_key<T0>();
        assert!(!0x2::dynamic_field::exists_<AssetKey>(&arg0.id, v0), 0xec609c742ab97a056182daff442093b14ffdbcecb525cb8fc22a33c6f6c633a4::errors::asset_already_exists());
    ...
    public(friend) fun destroy(arg0: AssetStore) {
        assert!(0x1::vector::is_empty<AssetKey>(&arg0.active_asset_keys), 0xec609c742ab97a056182daff442093b14ffdbcecb525cb8fc22a33c6f6c633a4::errors::asset_store_not_empty());
        assert!(0x1::vector::is_empty<RewardKey>(&arg0.active_reward_keys), 0xec609c742ab97a056182daff442093b14ffdbcecb525cb8fc22a33c6f6c633a4::errors::asset_store_not_empty());
        let AssetStore {
            id                 : v0,
    ...
    public(friend) fun extract_reward_balance<T0>(arg0: &mut AssetStore, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = create_reward_key<T0>();
        assert!(0x2::dynamic_field::exists_<RewardKey>(&arg0.id, v0), 0xec609c742ab97a056182daff442093b14ffdbcecb525cb8fc22a33c6f6c633a4::errors::asset_not_found());
    ...
    public(friend) fun withdraw<T0>(arg0: &mut AssetStore, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = create_asset_key<T0>();
        assert!(0x2::dynamic_field::exists_<AssetKey>(&arg0.id, v0), 0xec609c742ab97a056182daff442093b14ffdbcecb525cb8fc22a33c6f6c633a4::errors::asset_not_found());
