module 0xec5097a6dfcd59fb4e65090646f9fa6a0df6ccb5471c642e25fdd03380f01ee5::reward5361 {
    struct REWARD5361 has drop {
        dummy_field: bool,
    }

    struct TICKET_5361 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5361(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5361>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5361>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5361, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5361>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5361>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5361>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5361>>(v5, 0x2::tx_context::sender(arg1));
    }
