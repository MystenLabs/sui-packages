module 0xf16656c7d417654680c9e6a67f626c2c99a7a91011c88bc50d9ccaffdc53081b::oshi {
    ...
    public fun mint(arg0: &ControlledTreasuryCap, arg1: &mut ControlledTreasury, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0, 13906834569480437762);
        assert!(0x2::coin::total_supply<OSHI>(borrow_treasury_cap(arg1)) + arg2 <= arg1.limit, 13906834586660438020);
    ...
    public fun metadata_to_oshicoinmetadata(arg0: &ControlledTreasuryCap, arg1: 0x2::coin::CoinMetadata<OSHI>, arg2: &mut OshiCoinMetadata) {
        let v0 = CoinMetadataKey{dummy_field: false};
        0x2::dynamic_object_field::add<CoinMetadataKey, 0x2::coin::CoinMetadata<OSHI>>(&mut arg2.id, v0, arg1);
    }
    ...
    public fun treasury_cap_to_controlled(arg0: &ControlledTreasuryCap, arg1: &mut ControlledTreasury, arg2: 0x2::coin::TreasuryCap<OSHI>) {
        let v0 = TreasuryCapKey{dummy_field: false};
        0x2::dynamic_object_field::add<TreasuryCapKey, 0x2::coin::TreasuryCap<OSHI>>(&mut arg1.id, v0, arg2);
    }

    public fun treasury_cap_to_owned(arg0: &ControlledTreasuryCap, arg1: &mut ControlledTreasury, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = TreasuryCapKey{dummy_field: false};
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<OSHI>>(0x2::dynamic_object_field::remove<TreasuryCapKey, 0x2::coin::TreasuryCap<OSHI>>(&mut arg1.id, v0), 0x2::tx_context::sender(arg2));
    }
