module 0xa76499eda1d37751473de5f30e106f35943ada2f6ea764861243e7f5aa5bcc97::typus_dov_single {
    ...
    public(friend) entry fun new_bid<T0, T1, T2>(arg0: &mut Registry, arg1: &mut AdditionalConfigRegistry, arg2: u64, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x2::clock::Clock, arg5: vector<0x2::coin::Coin<T1>>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x1::option::is_some<bool>(&v64) && *0x1::option::borrow<bool>(&v64)) {
            if (v26 > 0) {
                let v65 = AdditionalConfigKey{
                    index : arg2,
                    tag   : b"bidder_incentive_record",
                };
                let v66 = get_additional_config<0x2::vec_map::VecMap<u64, u64>>(arg1, v65);
                let v67 = 0x2::vec_map::empty<u64, u64>();
                let v68 = *0x1::option::borrow_with_default<0x2::vec_map::VecMap<u64, u64>>(&v66, &v67);
                0x2::vec_map::insert<u64, u64>(&mut v68, v57, v26);
                let v69 = AdditionalConfigKey{
                    index : arg2,
                    tag   : b"bidder_incentive_record",
                };
                update_additional_config<0x2::vec_map::VecMap<u64, u64>>(arg1, v69, v68);
            };
            let v70 = IncentiveNewBid<T1>{
                signer          : 0x2::tx_context::sender(arg7),
                index           : arg2,
                bid_index       : v57,
                incentive_value : v26,
            };
            0x2::event::emit<IncentiveNewBid<T1>>(v70);
        };
        let v71 = NewBid<T0, T1, T2>{
            signer     : 0x2::tx_context::sender(arg7),
            index      : arg2,
            bid_index  : v57,
            price      : v58,
        ...
        0x2::event::emit<NewBid<T0, T1, T2>>(v71);
    }
    ...
    public(friend) entry fun upgrade_registry(arg0: &ManagerCap, arg1: &mut Registry) {
        assert!(21 > arg1.version, 1000);
        arg1.version = 21;
    }

    fun version_check(arg0: &Registry) {
        assert!(21 == arg0.version, 1000);
    }
