module 0xecc84d6943c146f5fac6ca131ac86d8d1678032050d19207f1954aa5b4cbe7d4::cnsnft2800 {
    struct CNSNFT2800 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2800, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2800>(arg0, arg1);
