module 0xec6e43078dc933911b14834e3e97a0f0e5c6dffb0fc084e32303a2ffbdd08ffe::gift5995 {
    struct GIFT5995 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift5995(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT5995, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5995>(arg0, arg1);
