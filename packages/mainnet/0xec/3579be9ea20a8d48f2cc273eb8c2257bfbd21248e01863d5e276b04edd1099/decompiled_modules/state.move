module 0xec3579be9ea20a8d48f2cc273eb8c2257bfbd21248e01863d5e276b04edd1099::state {
    struct State has key {
        ...
        paused: bool,
        roles: 0xec3579be9ea20a8d48f2cc273eb8c2257bfbd21248e01863d5e276b04edd1099::roles::Roles,
    ...
    public(friend) fun new(arg0: u32, arg1: u32, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) : State {
        State{
            ...
            paused                : false,
            roles                 : 0xec3579be9ea20a8d48f2cc273eb8c2257bfbd21248e01863d5e276b04edd1099::roles::new(arg3, arg3, arg3, arg4),
            compatible_versions   : 0x2::vec_set::singleton<u64>(0xec3579be9ea20a8d48f2cc273eb8c2257bfbd21248e01863d5e276b04edd1099::version_control::current_version()),
        }
    }

    public fun roles(arg0: &State) : &0xec3579be9ea20a8d48f2cc273eb8c2257bfbd21248e01863d5e276b04edd1099::roles::Roles {
        &arg0.roles
    }
    ...
    public(friend) fun roles_mut(arg0: &mut State) : &mut 0xec3579be9ea20a8d48f2cc273eb8c2257bfbd21248e01863d5e276b04edd1099::roles::Roles {
        &mut arg0.roles
    }
