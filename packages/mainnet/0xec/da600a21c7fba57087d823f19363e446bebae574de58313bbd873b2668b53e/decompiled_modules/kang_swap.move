module 0xecda600a21c7fba57087d823f19363e446bebae574de58313bbd873b2668b53e::kang_swap {
    ...
    public entry fun create<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Pool<T0, T1>{
            ...
            supply_lt : 0x2::balance::create_supply<LiquidityToken<T0, T1>>(v1),
        };
        0x2::transfer::share_object<Pool<T0, T1>>(v2);
        0x2::transfer::public_transfer<0x2::coin::Coin<LiquidityToken<T0, T1>>>(0x2::coin::from_balance<LiquidityToken<T0, T1>>(0x2::balance::increase_supply<LiquidityToken<T0, T1>>(&mut v2.supply_lt, v0), arg2), 0x2::tx_context::sender(arg2));
    }
