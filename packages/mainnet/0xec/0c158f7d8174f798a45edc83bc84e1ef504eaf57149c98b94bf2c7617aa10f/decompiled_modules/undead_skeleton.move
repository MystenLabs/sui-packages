module 0xec0c158f7d8174f798a45edc83bc84e1ef504eaf57149c98b94bf2c7617aa10f::undead_skeleton {
    struct UNDEAD_SKELETON has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: UNDEAD_SKELETON, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<UNDEAD_SKELETON>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Undead Skeleton"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Undead Dimensions is a digital graveyard of style, rebellion, and post-human artistry. Each skeleton is forged in surreal landscapes, powered by the essence of eternity. This genesis piece features a punk-boned soul with a green mohawk, glowing eyes, and a cyber-dimensional backdrop. Only a few will own the afterlife."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://AzQHeFCMCTU7aZe6CRZEE4W92JTc7tGfgzVuJ28QzPc"));
