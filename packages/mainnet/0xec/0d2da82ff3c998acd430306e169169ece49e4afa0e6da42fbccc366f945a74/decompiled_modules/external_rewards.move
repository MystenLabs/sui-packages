module 0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::external_rewards {
    ...
    public fun add_token_support<T0>(arg0: &0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public fun distribute_rewards_collateral_vault<T0>(arg0: &0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::admin::AdminCap, arg1: &mut TokenVault<T0>, arg2: u64, arg3: &mut 0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::collateral_vault_rewards::RewardPool<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg2 > 0) {
            let v0 = DistributeCollateralVaultEvent{
                vault_id           : 0x2::object::id<TokenVault<T0>>(arg1),
                coin_type          : 0x1::type_name::with_defining_ids<T0>(),
                amount             : arg2,
                collateral_pool_id : 0x2::object::id<0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::collateral_vault_rewards::RewardPool<T0>>(arg3),
                setter             : 0x2::tx_context::sender(arg4),
            };
            0x2::event::emit<DistributeCollateralVaultEvent>(v0);
            0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::collateral_vault_rewards::deposit_reward_funds<T0>(arg3, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.balance, arg2), arg4), arg4);
        };
    }
    ...
    public fun distribute_rewards_staking_pool<T0>(arg0: &0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::admin::AdminCap, arg1: &mut TokenVault<T0>, arg2: u64, arg3: &mut 0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::staking_pool_rewards::RewardPool<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        if (arg2 > 0) {
            let v0 = DistributeStakingPoolEvent{
                ...
                coin_type       : 0x1::type_name::with_defining_ids<T0>(),
                amount          : arg2,
                staking_pool_id : 0x2::object::id<0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::staking_pool_rewards::RewardPool<T0>>(arg3),
                setter          : 0x2::tx_context::sender(arg4),
            };
            0x2::event::emit<DistributeStakingPoolEvent>(v0);
            0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::staking_pool_rewards::deposit_reward_funds<T0>(arg3, 0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.balance, arg2), arg4), arg4);
        };
    }

    public fun emergency_withdraw<T0>(arg0: &0xec0d2da82ff3c998acd430306e169169ece49e4afa0e6da42fbccc366f945a74::admin::AdminCap, arg1: &mut TokenVault<T0>, arg2: &mut 0x2::tx_context::TxContext) {
