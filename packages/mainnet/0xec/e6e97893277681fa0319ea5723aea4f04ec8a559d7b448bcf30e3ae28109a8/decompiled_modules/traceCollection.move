module 0xece6e97893277681fa0319ea5723aea4f04ec8a559d7b448bcf30e3ae28109a8::traceCollection {
    ...
    public entry fun burn_nft<T0>(arg0: TraceNFT, arg1: &mut Collection<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: TRACECOLLECTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = 0x2::display::new_with_fields<Collection<ATP_COLLECT>>(&v0, v6, v8, arg1);
        0x2::display::update_version<Collection<ATP_COLLECT>>(&mut v10);
        let v11 = 0x2::display::new_with_fields<Collection<MOMENTUM>>(&v0, v6, v8, arg1);
        0x2::display::update_version<Collection<MOMENTUM>>(&mut v11);
        let v12 = 0x2::display::new_with_fields<Collection<F1_2025>>(&v0, v6, v8, arg1);
        0x2::display::update_version<Collection<F1_2025>>(&mut v12);
        let v13 = 0x2::display::new_with_fields<Collection<F1_2023>>(&v0, v6, v8, arg1);
        0x2::display::update_version<Collection<F1_2023>>(&mut v13);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v0, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TraceNFT>>(v5, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Collection<ATP_COLLECT>>>(v10, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Collection<MOMENTUM>>>(v11, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Collection<F1_2025>>>(v12, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<Collection<F1_2023>>>(v13, 0x2::tx_context::sender(arg1));
    }
    ...
    public entry fun set_transfer_policy<T0>(arg0: &mut Collection<T0>, arg1: &0x2::transfer_policy::TransferPolicy<TraceNFT>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(is_admin<T0>(arg0, 0x2::tx_context::sender(arg3)), 0);
