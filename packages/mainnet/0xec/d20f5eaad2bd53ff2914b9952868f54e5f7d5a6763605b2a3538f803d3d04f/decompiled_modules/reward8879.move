module 0xecd20f5eaad2bd53ff2914b9952868f54e5f7d5a6763605b2a3538f803d3d04f::reward8879 {
    struct REWARD8879 has drop {
        dummy_field: bool,
    }

    struct TICKET_8879 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8879(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8879>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8879>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8879, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8879>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8879>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8879>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8879>>(v5, 0x2::tx_context::sender(arg1));
    }
