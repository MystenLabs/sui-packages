module 0xd2197b1ce2096e96e726c29fa2c138c5c6748da169b81d34927c522b7499f1d7::ika_chan_updater {
    ...
    public fun get_random_reserved_one_of_one(arg0: &mut Updater, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : 0x3533437eabe66f05207aec78857efad86f42c2be84e2bbd63692c7c37fd349fb::mf_squid_maiden::UMetadata {
        0x2::table_vec::swap_remove<0x3533437eabe66f05207aec78857efad86f42c2be84e2bbd63692c7c37fd349fb::mf_squid_maiden::UMetadata>(&mut arg0.reserved_one_of_ones, get_random_number_by_length(arg1, 0x2::table_vec::length<0x3533437eabe66f05207aec78857efad86f42c2be84e2bbd63692c7c37fd349fb::mf_squid_maiden::UMetadata>(&arg0.reserved_one_of_ones), arg2))
    }

    public fun length_of_nfts(arg0: &Updater) : u64 {
    ...
    public fun update_the_nft(arg0: &mut Updater, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: &0x2::transfer_policy::TransferPolicy<0x3533437eabe66f05207aec78857efad86f42c2be84e2bbd63692c7c37fd349fb::mf_squid_maiden::MfSquidMaiden>, arg4: 0x2::object::ID, arg5: &0x2::random::Random, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!0x2::table::contains<0x2::object::ID, bool>(&arg0.already_updated_ones, arg4), 13906834333257170943);
        ...
        assert!(v5 > 0, 13906834423451484159);
        let v6 = if (v4) {
