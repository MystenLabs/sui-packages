module 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault {
    ...
    public(friend) fun redeem_token_internal<T0, T1, T2>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: vector<u64>, arg6: u64, arg7: vector<vector<u8>>, arg8: vector<vector<u8>>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T2> {
        ...
        let v4 = 0x1::type_name::get_address(&v3);
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<0x2::object::ID>(&v2));
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<address>(&arg2));
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<0x1::ascii::String>(&v4));
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<vector<u64>>(&arg3));
        0x1::vector::append<u8>(&mut v1, 0x2::bcs::to_bytes<vector<u64>>(&arg4));
        ...
        assert!(0x2::table::contains<address, vector<PendingRedeem>>(&arg1.pending_redeems, arg2), 7);
        let v5 = 0x2::table::remove<address, vector<PendingRedeem>>(&mut arg1.pending_redeems, arg2);
        let v6 = 0x1::vector::empty<PendingRedeem>();
        let v7 = 0x1::vector::empty<PendingRedeem>();
        let v8 = 0;
        while (v8 < 0x1::vector::length<PendingRedeem>(&v5)) {
            let v9 = 0x1::vector::borrow<PendingRedeem>(&v5, v8);
            let (v10, _) = 0x1::vector::index_of<u64>(&arg3, &v9.withdraw_time);
            if (v9.withdraw_time <= v0 - arg1.lock_duration_ms && v10) {
                0x1::vector::push_back<PendingRedeem>(&mut v6, *v9);
            } else {
                0x1::vector::push_back<PendingRedeem>(&mut v7, *v9);
            };
            v8 = v8 + 1;
        };
        if (0x1::vector::length<PendingRedeem>(&v7) > 0) {
            0x2::table::add<address, vector<PendingRedeem>>(&mut arg1.pending_redeems, arg2, v7);
        };
        let v12 = 0x1::vector::length<PendingRedeem>(&v6);
        assert!(v12 > 0, 7);
        let v13 = 0;
        let v14 = 0;
        let v15 = 0;
        let v16 = 0;
        while (v16 < v12) {
            let v17 = 0x1::vector::borrow<PendingRedeem>(&v6, v16);
            let (_, v19) = 0x1::vector::index_of<u64>(&arg3, &v17.withdraw_time);
            let v20 = 0x1::vector::borrow<u64>(&arg4, v19);
            let v21 = 0x1::vector::borrow<u64>(&arg5, v19);
            assert!(v17.amount >= *v20, 21);
            v13 = v13 + *v20;
            v14 = v14 + v17.amount;
            v15 = v15 + *v21;
            v16 = v16 + 1;
        };
        let v22 = get_dynamic_field_or_default<T0, T1, u64>(arg1, b"hwm", (arg1.liquidity as u64));
        let v23 = if (v22 >= v15) {
            v22 - v15
        } else {
            0
        };
        set_dynamic_field<T0, T1, u64>(arg1, b"hwm", v23);
        arg1.pending_redemptions = arg1.pending_redemptions - (v14 as u128);
        let v24 = spend_withdraw_asset<T0, T1, T2>(arg1, v13, arg10);
        let v25 = calculate_fee(v13, arg1.withdraw.fee_bps);
        arg1.withdraw.total_fee = arg1.withdraw.total_fee + calculate_fee(v15, arg1.withdraw.fee_bps);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::split<T2>(&mut v24, v25, arg10), arg1.fee_receiver);
        let v26 = get_dynamic_field_or_default<T0, T1, u128>(arg1, b"total_withdraw", 0) + (v15 as u128);
        set_dynamic_field<T0, T1, u128>(arg1, b"total_withdraw", v26);
        let v27 = RedeemWithSigTokenEvent{
            receiver                            : arg2,
            item_amount                         : v14,
            amount                              : v13,
        ...
        0x2::event::emit<RedeemWithSigTokenEvent>(v27);
        v24
    }
