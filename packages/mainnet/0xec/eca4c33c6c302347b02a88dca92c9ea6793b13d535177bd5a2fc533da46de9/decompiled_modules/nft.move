module 0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::nft {
    ...
    public entry fun accumulate_sity_updated(arg0: &mut City, arg1: &mut GameData, arg2: &Wallet, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = *0x1::vector::borrow<u64>(&arg1.accumulation_speeds, *0x1::vector::borrow<u64>(&arg0.buildings, 0));
        let v5 = get_halving_nonce(arg1);
        let v6 = if (v0 < get_withdraw_date(arg1)) {
            0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg1.pool, v2 * v4 / v5 * arg1.speed / 3600000, arg4)
        } else {
            0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg1.secure_pool, v2 * v4 / v5 * arg1.speed / 3600000, arg4)
        };
        0x2::balance::join<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg0.balance, 0x2::coin::into_balance<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(v6));
        arg0.last_accumulated = v0;
    ...
    public fun boost_sivilian(arg0: &mut GameData, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::KioskOwnerCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut 0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen, arg5: &0x2::transfer_policy::TransferPolicy<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>, arg6: &mut City, arg7: &mut CityBooster, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let (v0, v1) = 0x2::kiosk::purchase_with_cap<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg1, 0x2::kiosk::list_with_purchase_cap<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg1, arg2, 0x2::object::id<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg4), 0, arg8), 0x2::coin::zero<0x2::sui::SUI>(arg8));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg5, v1);
        0x2::kiosk::lock<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg3, &arg7.kiosk_owner_cap, arg5, v0);
        arg7.population_boost = arg7.population_boost + 1;
    }
    ...
    public fun boost_sivilian_v4(arg0: &mut GameData, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg3: &mut 0x2::kiosk::Kiosk, arg4: 0x2::object::ID, arg5: &mut 0x2::transfer_policy::TransferPolicy<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>, arg6: &mut City, arg7: &mut CityBooster, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        let (v3, v4) = 0x2::kiosk::purchase_with_cap<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg1, 0x2::kiosk::list_with_purchase_cap<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg1, &v2, arg4, 0, arg8), 0x2::coin::zero<0x2::sui::SUI>(arg8));
        let v5 = v4;
        ...
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sitizens::Sitizen>(arg5, &mut v5, 0x2::coin::zero<0x2::sui::SUI>(arg8));
    ...
    fun calculate_halving_nonce(arg0: &mut GameData) : u64 {
        let v0 = *0x1::vector::borrow<u64>(&arg0.extra_data, 3);
        let v1 = 0x2::balance::value<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&arg0.secure_pool);
        let v2 = get_tge_supply(arg0);
        if (v2 == 0) {
            return v0
        };
        let v3 = 1;
    ...
    public fun calculate_population(arg0: &City) : u64 {
        ...
        v0 + v3 + v6 + v9 + v12 + 0x2::balance::value<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&arg0.balance)
    }
    ...
    public fun get_city_population(arg0: &mut City, arg1: &Wallet) : u64 {
        arg0.population = calculate_population_updated(arg0, arg1);
        arg0.population
    }
    ...
    entry fun simulate_singleplayer_war(arg0: &0x2::random::Random, arg1: &mut City, arg2: &0x2::clock::Clock, arg3: &mut GameData, arg4: &mut Wallet, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::random::generate_u64_in_range(&mut v2, 0, v1 + arg5) <= v1) {
            ...
            let v6 = get_halving_nonce(arg3);
            let v7 = v5 / v6;
            let v8 = if (v0 < get_withdraw_date(arg3)) {
                0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg3.pool, v7, arg6)
            } else {
                0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg3.secure_pool, v7, arg6)
            };
            0x2::balance::join<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg4.balance, 0x2::coin::into_balance<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(v8));
            let v9 = SingleplayerWarResult{
                nft_id : 0x2::object::uid_to_inner(&arg1.id),
                user   : 0x2::tx_context::sender(arg6),
                result : 0x1::string::utf8(b"Win"),
                reward : v7,
            };
            0x2::event::emit<SingleplayerWarResult>(v9);
        } else {
            let v10 = SingleplayerWarResult{
                nft_id : 0x2::object::uid_to_inner(&arg1.id),
                user   : 0x2::tx_context::sender(arg6),
                result : 0x1::string::utf8(b"Lose"),
                reward : 0,
            };
            0x2::event::emit<SingleplayerWarResult>(v10);
        };
    }
    ...
    entry fun simulate_singleplayer_war_with_sui(arg0: &0x2::random::Random, arg1: &mut City, arg2: &0x2::clock::Clock, arg3: &mut GameData, arg4: &mut Wallet, arg5: u64, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::random::generate_u64_in_range(&mut v2, 0, v1 + arg5) <= v1) {
            ...
            let v7 = get_halving_nonce(arg3);
            let v8 = v6 / v7;
            let v9 = if (v0 < get_withdraw_date(arg3)) {
                0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg3.pool, v8, arg7)
            } else {
                0x2::coin::take<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg3.secure_pool, v8, arg7)
            };
            0x2::balance::join<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(&mut arg4.balance, 0x2::coin::into_balance<0x5b9b4cd82aee3d5a942eebe9c2da38f411d82bfdfea1204f2486e45b5868b44f::sity::SITY>(v9));
            let v10 = SingleplayerWarResult{
                nft_id : 0x2::object::uid_to_inner(&arg1.id),
            ...
            let v11 = SingleplayerWarResult{
                nft_id : 0x2::object::uid_to_inner(&arg1.id),
                user   : 0x2::tx_context::sender(arg7),
                result : 0x1::string::utf8(b"Lose"),
                reward : 0,
            };
            0x2::event::emit<SingleplayerWarResult>(v11);
        };
    }
