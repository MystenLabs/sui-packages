module 0x50a0583be0008d76f2d94988b1d81960b61e18a647deb3004052f0ce038341bb::treasury {
    ...
    entry fun claim_provision<T0>(arg0: &mut Treasury<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<T0>(&arg0.wal) >= 850000000, 3);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.wal, 850000000), arg1), v0);
        let v1 = TreasuryDraw{
            recipient : v0,
            sui_out   : 11000000,
            wal_out   : 850000000,
