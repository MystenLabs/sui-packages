module 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::price_feed {
    ...
    public(friend) fun ensure_timestamp_not_stale(arg0: &PriceFeedComponent, arg1: u64, arg2: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg2) - update_time(arg0) * 1000 <= arg1, 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::oracle_stale_price_error());
    }
    ...
    public(friend) fun safe_cast_to_u64(arg0: u128) : u64 {
        assert!(arg0 < 18446744073709551615, 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::value_overflow());
        (arg0 as u64)
    }
