module 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::reference {
    ...
    public(friend) fun new(arg0: u64, arg1: u64, arg2: u64) : AdminReference {
        assert!(arg0 > 0 && arg1 > 0, 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::oracle_zero_price_error());
        AdminReference{
            spot       : arg0,
            ema        : arg1,
            updated_at : arg2,
    ...
    public(friend) fun update(arg0: &mut AdminReference, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg1 > 0 && arg2 > 0, 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::oracle_zero_price_error());
        arg0.spot = arg1;
        arg0.ema = arg2;
