module 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::asset_registry {
    ...
    public(friend) fun borrow<T0: store>(arg0: &XOracleAssetRegistry<T0>, arg1: 0x1::type_name::TypeName) : &T0 {
        assert!(0x2::table::contains<0x1::type_name::TypeName, T0>(&arg0.assets, arg1), 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::asset_not_registered());
    ...
    public(friend) fun set<T0: store>(arg0: &mut XOracleAssetRegistry<T0>, arg1: 0x1::type_name::TypeName, arg2: T0) {
        assert!(!0x2::table::contains<0x1::type_name::TypeName, T0>(&arg0.assets, arg1), 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::asset_already_registered());
