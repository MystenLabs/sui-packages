module 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::stork_feed {
    ...
    fun assert_price_newer(arg0: u64, arg1: u64, arg2: &0x2::clock::Clock) {
        assert!(arg0 >= arg1, 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::stork_price_too_old());
        assert!(arg0 <= 0x2::clock::timestamp_ms(arg2) * 1000000, 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::oracle_error::future_stork_price());
    }
    ...
    public(friend) fun refresh_stork_price(arg0: &mut StorkFeedInfo, arg1: &0xbc96aa8e79e0831131f00e7d9568fb40f283e6b96c2516dd99aa26b67459b60a::state::StorkState, arg2: &0x2::clock::Clock) : (0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::price_feed::PriceFeedComponent, 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::price_feed::PriceFeedComponent) {
        ...
        (0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::price_feed::new_component(v0, v1 / 1000000000), 0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::price_feed::new_component(v2, v3 / 1000000000))
    }

    public(friend) fun to_normalized_u64(arg0: u128) : u64 {
        0x144c57d6014488bc71c0902bddff482af090d13e2c61333ed903fe088220a92c::price_feed::safe_cast_to_u64(arg0 / 1000000000)
    }
