module 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::order {
    ...
    entry fun cancel_order(arg0: &0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::roles::SubAccounts, arg1: &mut 0x2::table::Table<vector<u8>, OrderStatus>, arg2: address, arg3: u8, arg4: u128, arg5: u128, arg6: u128, arg7: u64, arg8: u128, arg9: address, arg10: vector<u8>, arg11: vector<u8>, arg12: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg12);
        assert!(v0 == arg9 || 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::roles::is_sub_account(arg0, arg9, v0), 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::sender_does_not_have_permission_for_account(2));
        let v1 = get_serialized_order(pack_order(arg2, arg3, arg4, arg5, arg6, arg9, arg7, arg8));
        let v2 = 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::get_hash(v1);
        create_order(arg1, v2);
        let v3 = 0x2::table::borrow_mut<vector<u8>, OrderStatus>(arg1, v2);
        assert!(v3.status, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::order_is_canceled(0));
        v3.status = false;
        let v4 = OrderCancel{
            caller    : v0,
    ...
    public(friend) fun verify_and_fill_order_qty(arg0: &mut 0x2::table::Table<vector<u8>, OrderStatus>, arg1: Order, arg2: vector<u8>, arg3: u128, arg4: u128, arg5: bool, arg6: u128, arg7: address, arg8: u64) {
        assert!(arg1.isBuy && arg3 <= arg1.price || arg3 >= arg1.price, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::fill_price_invalid(arg8));
        if (arg1.reduceOnly) {
            assert!(arg1.isBuy != arg5 && arg4 <= arg6, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::fill_does_not_decrease_size(arg8));
        };
        let v0 = 0x2::table::borrow_mut<vector<u8>, OrderStatus>(arg0, arg2);
        v0.filledQty = v0.filledQty + arg4;
        assert!(v0.filledQty <= arg1.quantity, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::cannot_overfill_order(arg8));
        let v1 = OrderFill{
            orderHash         : arg2,
            order             : arg1,
            sigMaker          : arg7,
    ...
    public(friend) fun verify_order_expiry(arg0: u64, arg1: u64, arg2: u64) {
        assert!(arg0 == 0 || arg0 > arg1, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::order_expired(arg2));
    }

    public(friend) fun verify_order_leverage(arg0: u128, arg1: u128, arg2: u64) {
        assert!(arg1 > 0, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::leverage_must_be_greater_than_zero(arg2));
        assert!(arg0 == 0 || 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::compute_mro(arg1) == arg0, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::invalid_leverage(arg2));
    }

    public(friend) fun verify_order_signature(arg0: &0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::roles::SubAccounts, arg1: address, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64) : address {
        let v0 = 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::verify_signature(arg3, arg4, 0x2::hex::encode(arg2));
        assert!(0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::get_result_status(v0), 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::order_has_invalid_signature(arg5));
        let v1 = 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::get_public_address(0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::get_result_public_key(v0));
        assert!(arg1 == v1 || 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::roles::is_sub_account(arg0, arg1, v1), 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::order_has_invalid_signature(arg5));
        v1
    }

    public(friend) fun verify_order_state(arg0: &mut 0x2::table::Table<vector<u8>, OrderStatus>, arg1: vector<u8>, arg2: u64) {
        assert!(0x2::table::borrow<vector<u8>, OrderStatus>(arg0, arg1).status, 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::error::order_is_canceled(arg2));
    }
