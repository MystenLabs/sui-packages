module 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::base_div(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun mul_uint(arg0: Number, arg1: u128) : Number {
        Number{
            value : 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::base_mul(arg0.value, arg1),
            sign  : arg0.sign,
        }
    }
    ...
    public fun one() : Number {
        Number{
            value : 0xecb757733603257390ccc1730738d96d80fdcd681f5bc735c01d9ba5e64418de::library::base_uint(),
            sign  : true,
        }
    }
