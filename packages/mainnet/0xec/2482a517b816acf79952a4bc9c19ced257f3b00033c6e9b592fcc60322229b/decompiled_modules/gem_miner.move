module 0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::gem_miner {
    ...
    public entry fun buy_gems(arg0: &mut GameState, arg1: &mut 0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::Registry, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::coin::value<0x2::sui::SUI>(&arg2);
        0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::register_player(arg1, v0, arg3, arg4);
        0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::update_deposit(arg1, v0, v1);
        let v2 = if (0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::is_valid_referrer(arg1, arg3)) {
            let v3 = 0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::get_player_address(arg1, arg3);
            if (v3 == v0) {
                arg0.ceo_address
            } else {
                v3
        ...
        if (v2 == arg0.ceo_address) {
            ...
            0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::add_referral_reward(arg1, v2, arg2, arg4);
        };
    ...
    public entry fun hire_miners(arg0: &mut GameState, arg1: &mut 0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::Registry, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::get_player_id(arg1, v0);
        let v4 = if (v3 != 0) {
            0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::get_player_address(arg1, v3)
        } else {
            arg0.ceo_address
        };
        let v5 = calculate_egg_sell(v1, 0x2::balance::value<0x2::sui::SUI>(&arg0.balance), arg0.market_eggs) * 1 / 100;
        if (v5 > 0) {
            0xec2482a517b816acf79952a4bc9c19ced257f3b00033c6e9b592fcc60322229b::player_registry::add_referral_reward(arg1, v4, 0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, v5, arg3), arg2);
        };
