module 0xec2b9a12a2028c094cbc028e1023f9ca565b4794b37f120c8ca44084380cb9b7::_vram_genesis_core {
    struct _VRAM_GENESIS_CORE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _VRAM_GENESIS_CORE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_VRAM_GENESIS_CORE>(arg0, arg1);
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeibeoby4f7z4y5c2w3r3e2zaagajxuqgy5nc5c3k66gizgfylifm3y"));
