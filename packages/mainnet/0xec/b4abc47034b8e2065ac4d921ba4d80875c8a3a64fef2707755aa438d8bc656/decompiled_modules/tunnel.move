module 0xecb4abc47034b8e2065ac4d921ba4d80875c8a3a64fef2707755aa438d8bc656::tunnel {
    ...
    public fun creator_config_public_key(arg0: &CreatorConfig) : vector<u8> {
        arg0.public_key
    }
    ...
    public fun open_tunnel<T0>(arg0: &CreatorConfig, arg1: vector<u8>, arg2: vector<u8>, arg3: address, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = Tunnel<T0>{
            ...
            creator_public_key : arg0.public_key,
            credential         : arg2,
