module 0xec99b3d848d0eb8376f1283b89bac5d1c7d14daea93c25f1a11cd40f007f9277::events {
    ...
    struct FilledMakerOrders has copy, drop {
        ...
        book_price: 0x1::option::Option<u64>,
    }
    ...
    public(friend) fun e17(arg0: 0x2::object::ID, arg1: u64, arg2: u128, arg3: 0x1::option::Option<u64>, arg4: u64, arg5: bool, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u32>, arg8: u32, arg9: u256, arg10: 0x1::option::Option<u64>) {
        let v0 = PostedOrder{
            ch_id                   : arg0,
            account_id              : arg1,
            order_id                : arg2,
    ...
    public(friend) fun e18(arg0: vector<FilledMakerOrder>, arg1: 0x1::option::Option<u64>) {
        let v0 = FilledMakerOrders{
            events     : arg0,
            book_price : arg1,
        };
    ...
    public(friend) fun e22(arg0: 0x2::object::ID, arg1: u64, arg2: u128, arg3: 0x1::option::Option<u64>, arg4: u64, arg5: u8, arg6: 0x1::option::Option<u64>) {
