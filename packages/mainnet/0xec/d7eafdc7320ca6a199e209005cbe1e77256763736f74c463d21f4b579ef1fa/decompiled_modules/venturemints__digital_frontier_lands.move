module 0xecd7eafdc7320ca6a199e209005cbe1e77256763736f74c463d21f4b579ef1fa::venturemints__digital_frontier_lands {
    struct VENTUREMINTS__DIGITAL_FRONTIER_LANDS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: VENTUREMINTS__DIGITAL_FRONTIER_LANDS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VENTUREMINTS__DIGITAL_FRONTIER_LANDS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"VentureMints: Digital Frontier Lands"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
