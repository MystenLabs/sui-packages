module 0xec439e29e6cfd342d89eec7041c25044b61b57a83ea1ec73801fec83b382a763::ldo {
    struct LDO has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LDO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<LDO>(arg0, 6, b"okxu", b"okxu", b"okxu Token on Sui Network", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://icon.suntool.cc/file/cosmos.png")), arg1);
        let v2 = v0;
