module 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::sunset {
    struct SecurityMigrationV2 has copy, drop {
        old_version: u64,
        new_version: u64,
        frozen_address: address,
        removed_sui_unit: u64,
        removed_invested_amount: u64,
        removed_static_power: u64,
        removed_dynamic_power_distributed: u64,
        removed_dynamic_power_outstanding: u64,
        restored_legitimate_dynamic_power: u64,
    }
    ...
    public(friend) fun add_repurchase_points<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: address, arg2: u64) {
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::app_version::check_version(arg0.version);
        assert!(arg2 > 0, 202);
        assert!(0x2::table::contains<address, User>(&arg0.users, arg1), 1);
        let v0 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, arg1);
        v0.repurchase_points = v0.repurchase_points + arg2;
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_repurchase_points(&mut arg0.global_network_data, arg2);
    }
    ...
    public fun admin_add_repurchase_points<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public(friend) fun assert_native_sui<T0>() {
        assert!(0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>(), 305);
    }

    public(friend) fun batch_appoint_user_level<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: vector<address>, arg2: vector<u8>) {
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::app_version::check_version(arg0.version);
        let v0 = 0x1::vector::length<address>(&arg1);
        assert!(v0 == 0x1::vector::length<u8>(&arg2), 406);
        let v1 = 0;
        while (v1 < v0) {
            ...
            0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::updateLevel(&mut arg0.global_network_data, get_user_level(v3), v2);
            v3.appoint_level = v2;
            v1 = v1 + 1;
        };
    }
    ...
    fun close_v1_exploit_order(arg0: &mut Order, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg0.status == 0, 307);
        assert!(arg0.pay_type == 1, 307);
        assert!(arg0.amount == arg1, 307);
        assert!(arg0.sui_amount == arg2, 307);
        assert!(arg0.static_power == arg3, 307);
        arg0.status = 1;
    }
    ...
    public fun exchange_pre_to_pst_balance<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: &0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::app_version::check_version(arg0.version);
        let v0 = 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::price_oracle::get_pst_from_pre(arg1, arg2) / 4;
        assert!(arg2 > 0 && v0 > 0, 202);
        assert!(0x2::balance::value<T1>(&arg0.pst_balance) >= v0, 205);
        let v1 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, 0x2::tx_context::sender(arg3));
        assert!(v1.state == 0, 303);
        assert!(v1.pre_balance >= arg2, 203);
        v1.pre_balance = v1.pre_balance - arg2;
        v1.pst_balance = v1.pst_balance + v0;
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::sub_total_pre_balance(&mut arg0.global_network_data, arg2);
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_pst_balance(&mut arg0.global_network_data, v0);
    }
    ...
    public fun investment_v1<T0, T1, T2>(arg0: &mut Contract<T1, T2>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: &0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::price_oracle::PriceOracle, arg5: u64, arg6: u8, arg7: &0x2::clock::Clock, arg8: &mut 0x2441fbeefd1cb2e892b6c27cdc5eec6fda9dd1cebf6c1fea46304ec4d208d644::implements::Global, arg9: &Router, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg6 == 1) {
            ...
            let v19 = 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::price_oracle::get_pre_amount(arg4, arg5);
            v6 = v19;
            let v20 = 0x2::table::borrow_mut<address, User>(v1, v0);
            assert!(v20.pre_balance >= v19, 203);
            v20.pre_balance = v20.pre_balance - v19;
            0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::sub_total_pre_balance(v2, v19);
            0x2::coin::send_funds<T0>(arg1, v0);
            0x2::coin::send_funds<T1>(arg2, v0);
            0x2::coin::send_funds<T2>(arg3, v0);
            0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_pre_invested(v2, v19, arg5);
        };
        let v21 = calc_static_power(arg5);
        let v22 = 0x2::table::borrow_mut<address, User>(v1, v0);
        v22.static_power = v22.static_power + v21;
        v22.underway_power = v22.underway_power + v21;
        v22.join_amount = v22.join_amount + arg5;
        v22.invest_amount = v22.invest_amount + arg5;
        let v23 = v22.static_power;
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_asset_invested(v2, arg5);
        if (v22.invest_amount == 0) {
            0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_effective_user(v2, 1);
        };
        let v24 = 0x2::table::borrow_mut<address, User>(v1, v0);
        let v25 = Order{
            id                 : (0x1::vector::length<Order>(&v24.orders) as u64) + 1,
            ...
            pre_amount         : v6,
            static_power       : v21,
            total_static_power : v23,
            status             : 0,
        };
        0x1::vector::push_back<Order>(&mut v24.orders, v25);
    ...
    public(friend) fun migrate_security_v2<T0, T1>(arg0: &mut Contract<T0, T1>) {
        assert!(arg0.version == 1, 306);
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::repair_v1_fake_sui_totals(&mut arg0.global_network_data, 1427292436233910375, 1110000000000000);
        let v0 = &mut arg0.users;
        let v1 = &mut arg0.global_network_data;
        repair_v1_exploiter_user(v0, v1);
        let v2 = &mut arg0.users;
        rollback_v1_exploit_performance(v2, @0x4b06bdc537e3cb83349951f806556f074b8ff3861d025f155cb6c3e60170a232, 1110000000000000);
        let v3 = &mut arg0.users;
        let v4 = &mut arg0.global_network_data;
        repair_v1_exploit_dynamic_power(v3, v4);
        arg0.version = 2;
        let v5 = SecurityMigrationV2{
            old_version                       : 1,
            new_version                       : 2,
            frozen_address                    : @0x4b06bdc537e3cb83349951f806556f074b8ff3861d025f155cb6c3e60170a232,
            removed_sui_unit                  : 1427292436233910375,
            removed_invested_amount           : 1110000000000000,
            removed_static_power              : 2775000000000000,
            removed_dynamic_power_distributed : 377400000000000,
            removed_dynamic_power_outstanding : 44400000000000,
            restored_legitimate_dynamic_power : 29940000,
        };
        0x2::event::emit<SecurityMigrationV2>(v5);
    }

    public fun recharge_repurchase_points_by_pre<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: u64, arg2: &0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::price_oracle::PriceOracle, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::app_version::check_version(arg0.version);
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(0x2::table::contains<address, User>(&arg0.users, v0), 1);
        let v1 = 0x2::coin::value<T0>(&arg3);
        let v2 = 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::price_oracle::get_pre_amount(arg2, arg1);
        assert!(v1 > 0, 202);
        assert!(arg1 > 0, 202);
        assert!(v2 > 0, 202);
        assert!(v1 >= v2, 203);
        let v3 = 0x2::table::borrow_mut<address, User>(&mut arg0.users, v0);
        assert!(v3.state == 0, 303);
        v3.repurchase_points = v3.repurchase_points + arg1;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg3, arg0.burn_address);
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_repurchase_points(&mut arg0.global_network_data, arg1);
    }
    ...
    fun repair_v1_exploit_dynamic_power(arg0: &mut 0x2::table::Table<address, User>, arg1: &mut 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::GlobalNetworkData) {
        assert!(0x2::table::contains<address, User>(arg0, @0x3a560b5830090bb03874d04313aae5a85ef7f254009aa749a5982b7819207b7), 307);
        let v0 = 0x2::table::borrow_mut<address, User>(arg0, @0x3a560b5830090bb03874d04313aae5a85ef7f254009aa749a5982b7819207b7);
        assert!(v0.dynamic_power == 0, 307);
        v0.dynamic_power = v0.dynamic_power + 29940000;
        assert!(0x2::table::contains<address, User>(arg0, @0x6cdbf5d30bac8dde491ec63e66ecf9820bcebf6c282668e627f18ac889e139e9), 307);
        let v1 = 0x2::table::borrow_mut<address, User>(arg0, @0x6cdbf5d30bac8dde491ec63e66ecf9820bcebf6c282668e627f18ac889e139e9);
        assert!(v1.dynamic_power >= 11100000000000, 307);
        v1.dynamic_power = v1.dynamic_power - 11100000000000;
        assert!(0x2::table::contains<address, User>(arg0, @0x6d59831e1e71c666e0e4055e6f008d656f32d455b18530b39f7c4af9d276bb9f), 307);
        let v2 = 0x2::table::borrow_mut<address, User>(arg0, @0x6d59831e1e71c666e0e4055e6f008d656f32d455b18530b39f7c4af9d276bb9f);
        assert!(v2.dynamic_power >= 33300000000000, 307);
        v2.dynamic_power = v2.dynamic_power - 33300000000000;
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::repair_v1_fake_sui_dynamic_totals(arg1, 377400000000000, 44400000000000, 29940000, 79829748932);
    }

    fun repair_v1_exploiter_user(arg0: &mut 0x2::table::Table<address, User>, arg1: &mut 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::GlobalNetworkData) {
        assert!(0x2::table::contains<address, User>(arg0, @0x4b06bdc537e3cb83349951f806556f074b8ff3861d025f155cb6c3e60170a232), 307);
        let v0 = 0x2::table::borrow_mut<address, User>(arg0, @0x4b06bdc537e3cb83349951f806556f074b8ff3861d025f155cb6c3e60170a232);
        assert!(0x1::vector::length<Order>(&v0.orders) >= 4, 307);
        let v1 = 0x1::vector::borrow_mut<Order>(&mut v0.orders, 1);
        close_v1_exploit_order(v1, 10000000000000, 12813941568426447, 25000000000000);
        let v2 = 0x1::vector::borrow_mut<Order>(&mut v0.orders, 2);
        close_v1_exploit_order(v2, 100000000000000, 128139415684264479, 250000000000000);
        let v3 = 0x1::vector::borrow_mut<Order>(&mut v0.orders, 3);
        close_v1_exploit_order(v3, 1000000000000000, 1286339078981219449, 2500000000000000);
        assert!(v0.join_amount >= 1110000000000000, 307);
        assert!(v0.invest_amount >= 1110000000000000, 307);
        assert!(v0.static_power >= 2775000000000000, 307);
        assert!(v0.underway_power >= 2775000000000000, 307);
        v0.join_amount = v0.join_amount - 1110000000000000;
        v0.invest_amount = v0.invest_amount - 1110000000000000;
        v0.static_power = v0.static_power - 2775000000000000;
        v0.underway_power = v0.underway_power - 2775000000000000;
        if (v0.state != 1) {
            v0.state = 1;
            0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_freeze_user(arg1, 1);
        };
    }
    ...
    fun rollback_v1_exploit_performance(arg0: &mut 0x2::table::Table<address, User>, arg1: address, arg2: u64) {
        let v0 = 0x2::table::borrow<address, User>(arg0, arg1).inviter;
        let v1 = 1;
        while (0x1::option::is_some<address>(&v0) && v1 <= 100) {
            let v2 = 0x2::table::borrow_mut<address, User>(arg0, 0x1::option::extract<address>(&mut v0));
            assert!(v2.performance >= arg2, 307);
            assert!(v2.team_invest_amount >= arg2, 307);
    ...
    public fun transfer_pre_balance<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: address, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::app_version::check_version(arg0.version);
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(arg2 > 0, 202);
        assert!(v0 != arg1, 400);
        let v1 = &mut arg0.users;
        assert!(0x2::table::contains<address, User>(v1, v0), 1);
        assert!(0x2::table::contains<address, User>(v1, arg1), 1);
        let v2 = 0x2::table::borrow_mut<address, User>(v1, v0);
        assert!(v2.state == 0, 303);
        assert!(v2.pre_balance >= arg2, 203);
        v2.pre_balance = v2.pre_balance - arg2;
        let v3 = 0x2::table::borrow_mut<address, User>(v1, arg1);
        assert!(v3.state == 0, 303);
        v3.pre_balance = v3.pre_balance + arg2;
    }
        ...
        while (0x1::option::is_some<address>(&v0) && v1 <= 30) {
            ...
            while (v5 < 0x1::vector::length<address>(v4)) {
                ...
                if (0x2::table::contains<address, User>(arg1, v6)) {
                    ...
                    if (v7.invest_amount > 0 || v7.appoint_level == 1) {
                        v3 = v3 + 1;
                    };
                };
                v5 = v5 + 1;
            ...
            if (v9.invest_amount > 0 && v8 > 0) {
                ...
                0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::admin::add_total_dynamic_power_distributed(arg0, v10);
            };
            v0 = v9.inviter;
            v1 = v1 + 1;
        };
    ...
    public fun withdraw_fixed_pst<T0, T1>(arg0: &mut Contract<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::app_version::check_version(arg0.version);
        assert!(arg1 > 0, 202);
        assert!(arg0.admin == 0x2::tx_context::sender(arg2), 208);
        assert!(arg1 <= 5000000, 206);
        withdraw_pst<T0, T1>(arg0, @0x11a49c9e97d49a4015ba95ffbb4ffbffef1d9da394d4b1321ffe6424441ac124, arg1, arg2);
    }
