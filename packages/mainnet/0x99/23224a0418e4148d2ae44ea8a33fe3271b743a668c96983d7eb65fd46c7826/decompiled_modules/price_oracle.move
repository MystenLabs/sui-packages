module 0xdc09f42fad92009378d897ba6bb35cd94b51d5268fc36a84b43a79453487229e::price_oracle {
    ...
    public fun get_pst_from_pre(arg0: &PriceOracle, arg1: u64) : u64 {
        let v0 = if (arg1 == 0) {
            true
        } else if (arg0.pre_price == 0) {
            true
        } else {
            arg0.pst_price == 0
        };
        ...
        (((arg1 as u128) * (arg0.pre_price as u128) / (arg0.pst_price as u128)) as u64)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = PriceOracle{
            ...
            rebot     : @0xbb71d71f63a4731ba044b7e1eddd409913883399c9ba6445422cc63b78d94796,
            version   : 1,
    ...
    public(friend) fun update_rebot(arg0: &mut PriceOracle, arg1: address) {
        assert!(1 == arg0.version, 100);
        arg0.rebot = arg1;
    }
