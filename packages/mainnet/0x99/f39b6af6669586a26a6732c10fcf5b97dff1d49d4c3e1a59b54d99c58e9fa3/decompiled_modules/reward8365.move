module 0x99f39b6af6669586a26a6732c10fcf5b97dff1d49d4c3e1a59b54d99c58e9fa3::reward8365 {
    struct REWARD8365 has drop {
        dummy_field: bool,
    }

    struct TICKET_8365 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8365(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8365>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8365>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8365, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8365>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8365>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8365>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8365>>(v5, 0x2::tx_context::sender(arg1));
    }
