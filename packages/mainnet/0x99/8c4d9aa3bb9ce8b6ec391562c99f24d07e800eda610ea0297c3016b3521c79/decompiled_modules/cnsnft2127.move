module 0x998c4d9aa3bb9ce8b6ec391562c99f24d07e800eda610ea0297c3016b3521c79::cnsnft2127 {
    struct CNSNFT2127 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2127, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2127>(arg0, arg1);
