module 0x995a8e717f132bc85f0ece3c3d49ceb256e5cb01e98b68dc8590883da4282b07::cnsnft1315 {
    struct CNSNFT1315 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1315, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1315>(arg0, arg1);
