module 0x99f6d1586582e9da2aa7ba44d154eef27dd6272d7edff1febe088637e4a9a078::cnsnft4883 {
    struct CNSNFT4883 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4883, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4883>(arg0, arg1);
