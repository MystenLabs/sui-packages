module 0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::pool_rewards {
    ...
    struct StakedNFT has store, key {
        id: 0x2::object::UID,
        nft: 0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::CreatureNFT,
        owner: address,
        pool_id: 0x2::object::ID,
        stake_time: u64,
        weight: u64,
    ...
    fun check_nft_has_required_elements(arg0: &0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::CreatureNFT, arg1: &vector<u64>) : bool {
    ...
    fun extract_nft_element_ids(arg0: &0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::CreatureNFT) : vector<u64> {
        0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::get_all_item_ids(arg0)
    }
    ...
    public entry fun stake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        assert!(v0.is_active, 2);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        ...
        let v3 = 0x2::object::id<0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::CreatureNFT>(&arg2);
        let v4 = 1;
        let v5 = StakedNFT{
    ...
    public entry fun unstake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::CreatureNFT>(v7, v1);
        let v14 = NFTUnstaked{
            pool_id           : arg1,
            nft_id            : arg2,
            owner             : v1,
    ...
    fun validate_nft_requirements(arg0: &Pool, arg1: &0x99adf37b1f96eaa0a5ad65d265f11d84b9d139053bc95e53f5273f64ff9c865a::creature_nft::CreatureNFT) {
