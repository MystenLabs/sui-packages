module 0x99dd772b52dc44601dab3f2eb23bff7603750e141b188c04b5af5cd7bef57a02::ferret {
    ...
    public fun kriyaswap_0<T0, T1>(arg0: &mut AccessList, arg1: &mut 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg2: vector<0x2::coin::Coin<T0>>, arg3: &mut 0x2::tx_context::TxContext) : vector<0x2::coin::Coin<T1>> {
        assert!(is_valid(arg0, arg3), 10000002);
        let v0 = 0x1::vector::pop_back<0x2::coin::Coin<T0>>(&mut arg2);
        0x1::vector::destroy_empty<0x2::coin::Coin<T0>>(arg2);
        0x1::vector::singleton<0x2::coin::Coin<T1>>(0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::swap_token_x<T0, T1>(arg1, v0, 0x2::coin::value<T0>(&v0), 0, arg3))
    }

    public fun kriyaswap_1<T0, T1>(arg0: &mut AccessList, arg1: &mut 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg2: vector<0x2::coin::Coin<T1>>, arg3: &mut 0x2::tx_context::TxContext) : vector<0x2::coin::Coin<T0>> {
        assert!(is_valid(arg0, arg3), 10000002);
        let v0 = 0x1::vector::pop_back<0x2::coin::Coin<T1>>(&mut arg2);
        0x1::vector::destroy_empty<0x2::coin::Coin<T1>>(arg2);
        0x1::vector::singleton<0x2::coin::Coin<T0>>(0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::swap_token_y<T0, T1>(arg1, v0, 0x2::coin::value<T1>(&v0), 0, arg3))
    }

    public fun new_access_list(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0xaecdaa08f1b9f4469aa3abe357a0ec105152a9b72129245a2e3277c98e4f3914 || 0x2::tx_context::sender(arg0) == @0x8feaaf3e14db29d341d5b03012f51e91855fd465b137203f36802951fe38f069 || 0x2::tx_context::sender(arg0) == @0x6a2fdf6ed9df04787cab1478d57c97755764da30afd41b0aeea9141fafa984ac || 0x2::tx_context::sender(arg0) == @0xd9456a92f160eafbfca830fa2520a22bd7fbb4bbf6207eea2d69f26414e72ef4, 10000001);
