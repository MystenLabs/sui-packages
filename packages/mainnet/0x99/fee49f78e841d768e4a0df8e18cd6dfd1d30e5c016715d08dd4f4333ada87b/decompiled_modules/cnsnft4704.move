module 0x99fee49f78e841d768e4a0df8e18cd6dfd1d30e5c016715d08dd4f4333ada87b::cnsnft4704 {
    struct CNSNFT4704 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4704, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4704>(arg0, arg1);
