module 0x995c1bbc48ac25a6057191576093d051cfae7bf69acc4826ebab56ea43b1a3f2::chillfam {
    ...
    fun init(arg0: CHILLFAM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<CHILLFAM>(&mut v3, 1000000000000000000, 0x2::tx_context::sender(arg1), arg1);
