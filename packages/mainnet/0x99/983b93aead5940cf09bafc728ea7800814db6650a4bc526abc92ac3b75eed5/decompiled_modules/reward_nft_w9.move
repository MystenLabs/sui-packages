module 0x99983b93aead5940cf09bafc728ea7800814db6650a4bc526abc92ac3b75eed5::reward_nft_w9 {
    struct REWARD_NFT_W9 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmZZZ7KHbsbtXeT2bZNtihsmRzDwDng8aAjvUtatBYqa2u"),
            };
            let v1 = MintEvent{
    ...
    fun init(arg0: REWARD_NFT_W9, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmZZZ7KHbsbtXeT2bZNtihsmRzDwDng8aAjvUtatBYqa2u"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui Foundation"));
        let v4 = 0x2::package::claim<REWARD_NFT_W9>(arg0, arg1);
