module 0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::turbospump_router {
    ...
    public entry fun buy_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::turbospump::Configuration, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3;
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<T0>(v4, 0x2::tx_context::sender(arg7));
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<0x2::sui::SUI>(v2, 0x2::tx_context::sender(arg7));
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut arg2, v0, arg7), arg0.admin);
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg7));
        let v5 = BuyEvent<T0>{
    ...
    public entry fun sell_exact_in<T0>(arg0: &FeeObject, arg1: &mut 0x96e1396c8a771c8ae404b86328dc27e7b66af39847a31926980c96dbc1096a15::turbospump::Configuration, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 - v4 >= arg4, 1);
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<T0>(v1, 0x2::tx_context::sender(arg7));
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<T0>(arg2, 0x2::tx_context::sender(arg7));
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<0x2::sui::SUI>(v2, 0x2::tx_context::sender(arg7));
        0x9983294216210986bfb0b93c783bc6c024b8850c18cd4c606c576967baafb012::utils::send_coin<0x2::sui::SUI>(0x2::coin::split<0x2::sui::SUI>(&mut v2, v4, arg7), arg0.admin);
        let v5 = SellEvent<T0>{
            recipient  : 0x2::tx_context::sender(arg7),
            amount_in  : arg3,
            amount_out : v3 - v4,
