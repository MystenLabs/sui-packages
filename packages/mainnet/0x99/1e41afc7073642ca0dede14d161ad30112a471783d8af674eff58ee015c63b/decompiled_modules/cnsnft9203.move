module 0x991e41afc7073642ca0dede14d161ad30112a471783d8af674eff58ee015c63b::cnsnft9203 {
    struct CNSNFT9203 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9203, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9203>(arg0, arg1);
