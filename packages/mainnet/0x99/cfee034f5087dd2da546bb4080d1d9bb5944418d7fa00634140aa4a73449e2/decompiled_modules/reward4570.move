module 0x99cfee034f5087dd2da546bb4080d1d9bb5944418d7fa00634140aa4a73449e2::reward4570 {
    struct REWARD4570 has drop {
        dummy_field: bool,
    }

    struct TICKET_4570 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4570(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4570>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4570>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4570, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4570>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4570>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4570>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4570>>(v5, 0x2::tx_context::sender(arg1));
    }
