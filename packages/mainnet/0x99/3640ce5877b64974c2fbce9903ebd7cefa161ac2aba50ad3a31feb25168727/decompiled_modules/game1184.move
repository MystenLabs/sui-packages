module 0x993640ce5877b64974c2fbce9903ebd7cefa161ac2aba50ad3a31feb25168727::game1184 {
    struct GAME1184 has drop {
        dummy_field: bool,
    }

    struct TICKET_1184 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1184(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1184>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1184>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME1184, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME1184>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1184>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1184>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1184>>(v5, 0x2::tx_context::sender(arg1));
    }
