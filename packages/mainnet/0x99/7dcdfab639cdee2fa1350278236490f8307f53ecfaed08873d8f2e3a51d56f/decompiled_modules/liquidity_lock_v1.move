module 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::liquidity_lock_v1 {
    ...
    fun calculate_liquidity_split(arg0: u128, arg1: u64) : (u128, u128) {
        assert!(arg1 <= 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::consts::lock_liquidity_share_denom(), 902354235823942382);
        let v0 = 0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_div_floor(arg0, (arg1 as u128), (0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::consts::lock_liquidity_share_denom() as u128));
        (v0, arg0 - v0)
    }

    fun calculate_remainder_coin_split(arg0: u64, arg1: u64) : u64 {
        assert!(arg1 <= 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::consts::lock_liquidity_share_denom(), 902354235823942382);
        0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u64::mul_div_floor(arg0, ((0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::consts::lock_liquidity_share_denom() - arg1) as u64), (0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::consts::lock_liquidity_share_denom() as u64))
    }
    ...
    public fun lock_position<T0, T1>(arg0: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::config::GlobalConfig, arg1: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::PoolTrancheManager, arg4: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg5: 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::position::Position, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : vector<LockedPosition<T0, T1>> {
        ...
        let v2 = 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::time_manager::epoch_next(v1 + 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::time_manager::epoch_to_seconds(*0x1::vector::borrow<u64>(&arg2.periods_blocking, arg6)));
        let v3 = 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::get_tranches(arg3, 0x2::object::id<0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>>(arg4));
        assert!(0x1::vector::length<0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::PoolTranche>(v3) > 0, 9823742374723842);
        let v4 = 0x1::vector::empty<LockedPosition<T0, T1>>();
        let v5 = v0;
        let v6 = 0;
        while (v6 < 0x1::vector::length<0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::PoolTranche>(v3)) {
            let v7 = 0x1::vector::borrow_mut<0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::PoolTranche>(v3, v6);
            if (0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::is_filled(v7)) {
                v6 = v6 + 1;
                continue
            };
            let v8 = 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::get_duration_profitabilities(v7);
            assert!(0x1::vector::length<u64>(&v8) == 0x1::vector::length<u64>(&arg2.periods_blocking), 93877534345684724);
            let (v9, v10) = 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::get_free_volume(v7);
            let v11 = if (v10) {
                0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::locker_utils::calculate_position_liquidity_in_token_a<T0, T1>(arg4, v5)
            } else {
                0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::locker_utils::calculate_position_liquidity_in_token_b<T0, T1>(arg4, v5)
            };
            let (v12, v13, v14, v15, v16) = if (v11 > v9) {
                let v17 = &mut arg5;
                let (v18, v19, v20, v21, v22) = split_position_internal<T0, T1>(arg0, arg1, arg4, v17, (0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_div_floor(v9, (0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::consts::lock_liquidity_share_denom() as u128), v11) as u64), arg7, arg8);
                let v23 = v19;
                let v24 = v18;
                v5 = v23.position_id;
                ...
                0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::fill_tranches(v7, v9);
                (v24.position_id, v24.liquidity, v20, v21, true)
            } else {
                0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::fill_tranches(v7, v11);
            ...
            let v26 = LockedPosition<T0, T1>{
                ...
                position_id               : v12,
                tranche_id                : 0x2::object::id<0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::PoolTranche>(v7),
                start_lock_time           : v1,
                expiration_time           : v2,
                full_unlocking_time       : v2 + 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::time_manager::epoch_to_seconds(*0x1::vector::borrow<u64>(&arg2.periods_post_lockdown, arg6)),
            ...
            let v28 = v6 + 1;
            v6 = v28;
            assert!(v28 < 0x1::vector::length<0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::pool_tranche::PoolTranche>(v3) || v5 == v12, 92035925692467234);
        };
    ...
    public fun remove_lock_liquidity<T0, T1>(arg0: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::config::GlobalConfig, arg1: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg4: LockedPosition<T0, T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let v2 = if (v1) {
            ...
            let v3 = 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::time_manager::number_epochs_in_timestamp(v0 - arg4.lock_liquidity_info.last_remove_liquidity_time);
            assert!(v3 > 0, 91877547573637423);
            0x6b904ae739b2baad330aae14991abcd3b7354d3dc3db72507ed8dabeeb7a36de::full_math_u128::mul_div_floor(arg4.lock_liquidity_info.total_lock_liquidity, (v3 as u128), (0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::time_manager::number_epochs_in_timestamp(arg4.full_unlocking_time - arg4.expiration_time) as u128))
        };
        let v4 = v2;
        ...
        if (v1) {
            ...
            arg4.lock_liquidity_info.last_remove_liquidity_time = 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::time_manager::epoch_start(v0);
    ...
    public fun split_position<T0, T1>(arg0: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::config::GlobalConfig, arg1: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::rewarder::RewarderGlobalVault, arg2: &mut Locker, arg3: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg4: LockedPosition<T0, T1>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (LockedPosition<T0, T1>, LockedPosition<T0, T1>) {
        ...
        assert!(arg5 <= 0x997dcdfab639cdee2fa1350278236490f8307f53ecfaed08873d8f2e3a51d56f::consts::lock_liquidity_share_denom() && arg5 > 0, 902354235823942382);
