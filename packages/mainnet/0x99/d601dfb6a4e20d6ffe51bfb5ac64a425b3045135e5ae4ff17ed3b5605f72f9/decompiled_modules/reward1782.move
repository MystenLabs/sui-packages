module 0x99d601dfb6a4e20d6ffe51bfb5ac64a425b3045135e5ae4ff17ed3b5605f72f9::reward1782 {
    struct REWARD1782 has drop {
        dummy_field: bool,
    }

    struct TICKET_1782 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1782(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1782>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1782>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1782, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1782>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1782>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1782>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1782>>(v5, 0x2::tx_context::sender(arg1));
    }
