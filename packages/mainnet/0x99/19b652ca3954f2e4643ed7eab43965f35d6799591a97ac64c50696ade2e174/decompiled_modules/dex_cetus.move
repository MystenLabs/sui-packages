module 0x9919b652ca3954f2e4643ed7eab43965f35d6799591a97ac64c50696ade2e174::dex_cetus {
    ...
    fun call_cetus_pool_script_swap_a2b(arg0: &0x2::clock::Clock, arg1: address, arg2: address, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: bool, arg5: u64, arg6: u64, arg7: u128, arg8: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_supported_methods() : vector<vector<u8>> {
        vector[b"pool_script_swap_a2b", b"verified_swap"]
    }
    ...
    public entry fun swap_sui_to_usdc_cetus(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        call_cetus_pool_script_swap_a2b(arg0, @0xdaa46292632c3c4d8f31f23ea0f9b36a28ff3677e9684980e4438403a67a3d8f, @0x6d8af9e6afd27262db436f0d37b304a041f710c3ea1fa4c3a9bab36b3569ad3, arg1, true, v0, arg2, 4295048016, arg3);
    }
