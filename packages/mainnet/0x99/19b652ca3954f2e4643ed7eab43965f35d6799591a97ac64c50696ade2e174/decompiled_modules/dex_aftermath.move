module 0x9919b652ca3954f2e4643ed7eab43965f35d6799591a97ac64c50696ade2e174::dex_aftermath {
    ...
    fun call_aftermath_swap_exact_in(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: address, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun get_supported_methods() : vector<vector<u8>> {
        vector[b"swap_exact_in", b"router_swap_exact_coin_for_coin"]
    }
    ...
    public entry fun swap_sui_to_usdc_simple(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 3401);
        assert!(calculate_aftermath_output(v0) >= arg1, 3402);
        call_aftermath_swap_exact_in(arg2, arg0, get_aftermath_pool(), v0, arg1, arg3);
    }
