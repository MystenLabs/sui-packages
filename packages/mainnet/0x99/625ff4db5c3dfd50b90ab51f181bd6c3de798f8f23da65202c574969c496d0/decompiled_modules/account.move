module 0x51e18f149666eff167d6bcaf59d0b9edcf6affe7650bb2bc3d5167a8c9f6f6d0::account {
    ...
    public(friend) fun create_child_account_cap(arg0: &AccountCap, arg1: &mut 0x2::tx_context::TxContext) : AccountCap {
        let v0 = arg0.owner;
        assert!(0x2::object::uid_to_address(&arg0.id) == v0, 0x51e18f149666eff167d6bcaf59d0b9edcf6affe7650bb2bc3d5167a8c9f6f6d0::error::required_parent_account_cap());
        AccountCap{
    ...
    fun get_or_create_account_field(arg0: &mut AccountCap) : &mut AccountField {
        let v0 = AccountFieldKey{dummy_field: false};
