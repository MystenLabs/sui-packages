module 0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config {
    ...
    public(friend) fun initialize(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0x98aeaac9956b31410eb27c0205799e9b0a7f8929391d8fa5903406984382739c, 303);
        let v0 = Config{
            id                      : 0x2::object::new(arg0),
            dao_admin_address       : @0x98aeaac9956b31410eb27c0205799e9b0a7f8929391d8fa5903406984382739c,
            emergency_admin_address : @0x98aeaac9956b31410eb27c0205799e9b0a7f8929391d8fa5903406984382739c,
            fee_admin_address       : @0x98aeaac9956b31410eb27c0205799e9b0a7f8929391d8fa5903406984382739c,
            default_swap_fee        : 30,
            default_dao_fee         : 33,
        };
    ...
    public entry fun set_dao_admin(arg0: &mut Config, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x98aeaac9956b31410eb27c0205799e9b0a7f8929391d8fa5903406984382739c, 301);
