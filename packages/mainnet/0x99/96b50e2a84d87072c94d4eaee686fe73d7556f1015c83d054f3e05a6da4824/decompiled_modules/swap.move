module 0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::swap {
    ...
    public fun swap<T0, T1>(arg0: &mut RyuSwap, arg1: &mut 0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::dao_fee::DaoFeeInfo, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::coin_helper::is_sorted<T0, T1>(), 1000);
    ...
    public entry fun initialize(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0x98aeaac9956b31410eb27c0205799e9b0a7f8929391d8fa5903406984382739c, 1009);
        let v0 = RyuSwap{id: 0x2::object::new(arg0)};
        0x2::transfer::share_object<RyuSwap>(v0);
        0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::dao_fee::initialize(arg0);
        0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config::initialize(arg0);
    }

    public fun register<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &0x2::clock::Clock, arg3: &mut RyuSwap, arg4: &mut 0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::dao_fee::DaoFeeInfo, arg5: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1>> {
        ...
        0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::dao_fee::register<T0, T1>(arg4);
        let v6 = PoolCreatedEvent<T0, T1>{creator: 0x2::tx_context::sender(arg5)};
        0x2::event::emit<PoolCreatedEvent<T0, T1>>(v6);
        0x2::coin::from_balance<LPCoin<T0, T1>>(0x2::balance::increase_supply<LPCoin<T0, T1>>(&mut v3, 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::sqrt(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_to_u128(v0, v1))), arg5)
    }

    fun assert_lp_value_is_increased(arg0: u128, arg1: u128, arg2: u128, arg3: u128) {
        let v0 = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::u256::mul(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::u256::from_u128(arg0 * arg1), 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::u256::from_u64(10000 * 10000));
        let v1 = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::u256::mul(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::u256::from_u128(arg2), 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::u256::from_u128(arg3));
        assert!(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::u256::compare(&v1, &v0) == 2, 1005);
    }
    ...
    public fun burn<T0, T1>(arg0: &mut RyuSwap, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<LPCoin<T0, T1>>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v3 = 0x2::balance::value<T0>(&v0.coin_x_reserve);
        let v4 = 0x2::balance::value<T1>(&v0.coin_y_reserve);
        let v5 = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_div_u128((v1 as u128), (v3 as u128), (v2 as u128));
        let v6 = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_div_u128((v1 as u128), (v4 as u128), (v2 as u128));
    ...
    public fun mint<T0, T1>(arg0: &mut RyuSwap, arg1: &0x2::clock::Clock, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LPCoin<T0, T1>> {
        ...
        let v8 = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_div_u128((v6 as u128), (v1 as u128), (v2 as u128));
        let v9 = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_div_u128((v7 as u128), (v1 as u128), (v3 as u128));
        let v10 = if (v8 < v9) {
            v8
        } else {
            v9
    ...
    fun new_reserves_after_fees_scaled(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u128, u128) {
        (0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_to_u128(arg0, 10000) - 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_to_u128(arg2, arg4), 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_to_u128(arg1, 10000) - 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_to_u128(arg3, arg4))
    }

    public entry fun set_dao_fee<T0, T1>(arg0: &mut RyuSwap, arg1: &mut LiquidityPool<T0, T1>, arg2: &0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config::Config, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::coin_helper::is_sorted<T0, T1>(), 1000);
        ...
        assert!(0x2::tx_context::sender(arg4) == 0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config::get_fee_admin(arg2), 1012);
        0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config::assert_valid_dao_fee(arg3);
        arg1.dao_fee = arg3;
        let v0 = UpdateDAOFeeEvent<T0, T1>{new_fee: arg3};
        0x2::event::emit<UpdateDAOFeeEvent<T0, T1>>(v0);
    }

    public entry fun set_fee<T0, T1>(arg0: &mut RyuSwap, arg1: &mut LiquidityPool<T0, T1>, arg2: &0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config::Config, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::coin_helper::is_sorted<T0, T1>(), 1000);
        assert!(0x2::dynamic_field::exists_<0x1::ascii::String>(&mut arg0.id, 0x1::type_name::into_string(0x1::type_name::get<LPCoin<T0, T1>>())), 1007);
        assert!(!arg1.locked, 1011);
        assert!(0x2::tx_context::sender(arg4) == 0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config::get_fee_admin(arg2), 1012);
        0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::config::assert_valid_fee(arg3);
        arg1.fee = arg3;
        let v0 = UpdateFeeEvent<T0, T1>{new_fee: arg3};
        0x2::event::emit<UpdateFeeEvent<T0, T1>>(v0);
    }

    fun split_fee_to_dao<T0, T1>(arg0: &mut LiquidityPool<T0, T1>, arg1: &mut 0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::dao_fee::DaoFeeInfo, arg2: u64, arg3: u64) {
        let v0 = arg0.fee;
        let v1 = arg0.dao_fee;
        ...
        0x9996b50e2a84d87072c94d4eaee686fe73d7556f1015c83d054f3e05a6da4824::dao_fee::deposit<T0, T1>(arg1, 0x2::balance::split<T0>(&mut arg0.coin_x_reserve, 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_div(arg2, v2, 10000)), 0x2::balance::split<T1>(&mut arg0.coin_y_reserve, 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::mul_div(arg3, v2, 10000)));
    }
    ...
    fun update_oracle<T0, T1>(arg0: &mut LiquidityPool<T0, T1>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64) {
        ...
        if (v1 > 0 && arg2 != 0 && arg3 != 0) {
            arg0.last_price_x_cumulative = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::overflow_add(arg0.last_price_x_cumulative, 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::uq64x64::to_u128(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::uq64x64::fraction(arg3, arg2)) * v1);
            arg0.last_price_y_cumulative = 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::math::overflow_add(arg0.last_price_y_cumulative, 0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::uq64x64::to_u128(0xb2c5dee1361f9c6aa230bf73897d5a8a33702036315bbe7b9694341f6398f85c::uq64x64::fraction(arg2, arg3)) * v1);
