module 0x912e777a94bdfd9befda19c3999eb409d4f53041be8d7a30e668bdfe9bc80370::inscription {
    ...
    public entry fun deploy_sui20(arg0: &mut InscriptionData, arg1: address, arg2: 0x1::string::String, arg3: u64, arg4: u64, arg5: u64, arg6: 0x1::string::String, arg7: 0x2::object::ID, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = InscriptionSui20{
            ...
            current_mint : 0,
            uri          : arg6,
            deployer     : 0x2::tx_context::sender(arg9),
        };
    ...
    fun init(arg0: INSCRIPTION, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Fee{
            id                 : 0x2::object::new(arg1),
            inscribe_sui20_fee : 100000000,
            inscribe_fee       : 100000000,
    ...
    public entry fun inscribe(arg0: &mut InscriptionData, arg1: &mut Fee, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::object::ID, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = InscriptionItem{current_id: arg0.total_inscription + 1};
        ...
        let v1 = InscribeEvent{
            current_id : arg0.total_inscription,
            object_id  : arg3,
        };
    ...
    public entry fun inscribe_sui20(arg0: &mut InscriptionData, arg1: &mut Fee, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0.current_mint <= v0.max / v0.amt, 0);
        ...
        let v3 = InscriptionItem{current_id: arg0.total_inscription};
