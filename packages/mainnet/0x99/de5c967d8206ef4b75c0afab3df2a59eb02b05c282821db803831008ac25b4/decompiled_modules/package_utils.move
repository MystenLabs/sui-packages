module 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::package_utils {
    ...
    public fun authorize_upgrade(arg0: &mut 0x2::object::UID, arg1: &mut 0x2::package::UpgradeCap, arg2: 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::bytes32::Bytes32) : 0x2::package::UpgradeTicket {
        set_authorized_digest(arg0, arg2);
        0x2::package::authorize_upgrade(arg1, 0x2::package::upgrade_policy(arg1), 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::bytes32::to_bytes(arg2))
    }
    ...
    public fun authorized_digest(arg0: &0x2::object::UID) : 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::bytes32::Bytes32 {
    ...
    public fun current_digest(arg0: &0x2::object::UID) : 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::bytes32::Bytes32 {
    ...
    public fun init_package_info<T0: store>(arg0: &mut 0x2::object::UID, arg1: T0, arg2: &0x2::package::UpgradeCap) {
        ...
        let v2 = PackageInfo{
            package : v0,
            digest  : 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::bytes32::default(),
        };
    ...
    fun set_authorized_digest(arg0: &mut 0x2::object::UID, arg1: 0x99de5c967d8206ef4b75c0afab3df2a59eb02b05c282821db803831008ac25b4::bytes32::Bytes32) {
        let v0 = PendingPackage{dummy_field: false};
