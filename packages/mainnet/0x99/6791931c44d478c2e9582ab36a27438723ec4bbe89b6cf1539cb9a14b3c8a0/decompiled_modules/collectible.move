module 0x996791931c44d478c2e9582ab36a27438723ec4bbe89b6cf1539cb9a14b3c8a0::collectible {
    ...
    fun init(arg0: COLLECTIBLE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"name"), 0x1::string::utf8(b"FlowX Testnet Pass I"));
        0x2::display::add<Token>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"ipfs://bafybeielxyqakkiphfc2vngu7r6hsas6wea2y3gd2hgwr3wkvxfjtfqlea"));
    ...
    public entry fun mint(arg0: &mut State, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg0.total_supply < 5000, 0);
