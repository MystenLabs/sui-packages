module 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::cope_game_vault {
    ...
    public fun admin_deposit<T0>(arg0: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::app::AdminCap, arg1: &mut Vault<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::Config, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::assert_version(arg3);
        assert!(!arg1.is_paused, 2);
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 7);
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(arg2));
        arg1.house_deposited_lifetime = arg1.house_deposited_lifetime + v0;
    ...
    public fun create_vault<T0>(arg0: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::app::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::assert_version(arg2);
        assert!(!arg0.is_paused, 2);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 >= 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::get_min_deposit(arg2), 3);
        assert!(v0 <= 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::get_max_deposit(arg2), 5);
    ...
    public fun end_game<T0>(arg0: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::Config, arg3: &0x2::clock::Clock) {
        0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::assert_version(arg2);
        assert!(!arg1.is_paused, 2);
        assert!(arg1.active_game, 9);
        arg1.active_game = false;
        let v0 = GameEndedEvent{timestamp: 0x2::clock::timestamp_ms(arg3)};
    ...
    public fun get_vault_stats<T0>(arg0: &Vault<T0>) : (u64, u64, u64, u64, u64, u64, u64, bool, bool) {
        (0x2::balance::value<T0>(&arg0.balance), arg0.total_deposited, arg0.total_withdrawn, arg0.house_profit_lifetime, arg0.house_loss_lifetime, arg0.house_deposited_lifetime, arg0.house_withdrawn_lifetime, arg0.is_paused, arg0.active_game)
    }
    ...
    public fun set_pause<T0>(arg0: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::app::AdminCap, arg1: &mut Vault<T0>, arg2: bool, arg3: &0x2::clock::Clock) {
        arg1.is_paused = arg2;
    ...
    public fun settle_game<T0>(arg0: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::app::AdminCap, arg1: &mut Vault<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::Config, arg5: &0x2::clock::Clock) {
        0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::assert_version(arg4);
        assert!(!arg1.is_paused, 2);
        assert!(arg1.active_game, 9);
    ...
    public fun start_game<T0>(arg0: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::Config, arg3: &0x2::clock::Clock) {
        0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::assert_version(arg2);
        assert!(!arg1.is_paused, 2);
        assert!(!arg1.active_game, 8);
        arg1.active_game = true;
        let v0 = GameStartedEvent{timestamp: 0x2::clock::timestamp_ms(arg3)};
        0x2::event::emit<GameStartedEvent>(v0);
    }

    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::assert_version(arg2);
        assert!(!arg0.is_paused, 2);
        assert!(!arg0.active_game, 8);
        assert!(arg1 >= 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::get_min_withdraw(arg2), 4);
        assert!(arg1 <= 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::get_max_withdraw(arg2), 6);
        assert!(arg1 > 0, 7);
        ...
        if (!0x2::table::contains<address, DailyWithdrawal>(&arg0.user_daily_withdrawals, v0)) {
            ...
            assert!(arg1 <= 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::get_max_withdraw_per_day(arg2), 13);
        } else {
            let v4 = 0x2::table::borrow_mut<address, DailyWithdrawal>(&mut arg0.user_daily_withdrawals, v0);
            if (v4.day == v2) {
                let v5 = v4.amount + arg1;
                assert!(v5 <= 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::get_max_withdraw_per_day(arg2), 13);
                v4.amount = v5;
            } else {
                v4.amount = arg1;
                v4.day = v2;
    ...
    public fun withdraw_house_profits<T0>(arg0: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::app::AdminCap, arg1: &0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::Config, arg2: &mut Vault<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::assert_version(arg1);
        assert!(!arg2.is_paused, 2);
        assert!(arg3 > 0, 7);
        let v0 = if (arg2.house_withdrawn_lifetime <= arg2.house_profit_lifetime + arg2.house_deposited_lifetime) {
            arg2.house_profit_lifetime + arg2.house_deposited_lifetime - arg2.house_withdrawn_lifetime
        } else {
            0
        };
        let v1 = if (v0 >= arg2.house_loss_lifetime) {
            v0 - arg2.house_loss_lifetime
        } else {
            0
        };
        assert!(arg3 <= v1, 11);
        ...
        let v2 = 0x993d8b3c5c00c114dd8060ffc135dc06a7deab069f772cb8427ebfd7ec861684::config::get_admin_address(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg2.balance, arg3), arg5), v2);
        let v3 = HouseProfitWithdrawalEvent{
            recipient : v2,
            amount    : arg3,
            timestamp : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<HouseProfitWithdrawalEvent>(v3);
    }
