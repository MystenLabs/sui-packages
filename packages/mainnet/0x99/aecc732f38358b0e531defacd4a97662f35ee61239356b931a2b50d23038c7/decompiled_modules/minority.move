module 0x99aecc732f38358b0e531defacd4a97662f35ee61239356b931a2b50d23038c7::minority {
    ...
    public fun admin_withdraw_and_delete(arg0: Game, arg1: &AdminCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (!0x2::linked_table::is_empty<address, vector<Vote>>(&v17)) {
            let (_, v19) = 0x2::linked_table::pop_front<address, vector<Vote>>(&mut v17);
            let v20 = v19;
            let v21 = 0x1::vector::length<Vote>(&v20);
            while (v21 > 0) {
                let Vote {
                    voter            : _,
                    encrypted_vote   : _,
                    ...
                    decrypted_choice : _,
                    is_disturbance   : _,
                } = 0x1::vector::pop_back<Vote>(&mut v20);
                v21 = v21 - 1;
            };
            0x1::vector::destroy_empty<Vote>(v20);
        };
        0x2::linked_table::destroy_empty<address, vector<Vote>>(v17);
    ...
    entry fun settle(arg0: &mut Game, arg1: vector<vector<u8>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x9636e0c761e7476b8579cb13d543838e3732ca482dc0a64f086f57b60c024e23::bf_hmac_encryption::verify_derived_keys(&v0, @0x0, 0x2::object::id_bytes<Game>(arg0), &v3);
        let v5 = arg0.count_a;
        let v6 = arg0.count_b;
        ...
        if (0x1::option::is_none<address>(&v13)) {
            if (v5 < 5 || v6 < 5) {
                ...
                0x2::event::emit<GameSettled>(v25);
                return
            };
            let v26 = if (v5 > v6) {
                v5 - v6
            ...
            let v27 = 0x2::math::sqrt(v6 + v5) * 46 / 100;
            let v28 = v27;
            if (v27 < 2) {
                v28 = 2;
            };
            let v29 = 0x2::balance::value<0x2::sui::SUI>(&arg0.total_pool);
            let (v30, v31) = if (v26 < v28 && v9 > 0) {
                (2, v9)
            } else if (v5 < v6) {
                (0, v7)
            } else {
            ...
            arg0.winner_pool = v30;
            if (v31 > 0) {
                arg0.winning_share = v29 / v31;
            } else {
            ...
            0x2::event::emit<GameSettled>(v32);
        };
    }
    ...
    entry fun vote(arg0: &mut Game, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
