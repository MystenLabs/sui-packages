module 0x99d363210a9937d0ab337d91b6e2df2126d83fda1c27e3d99c0473e42ea62bcd::mint_proof {
    ...
    public(friend) fun new(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) : MintProof {
        MintProof{
    ...
    public(friend) fun decode_msg(arg0: &0x1::option::Option<vector<u8>>) : 0x1::option::Option<MintArg> {
    ...
    public(friend) fun is_nonce_used(arg0: &MintProof, arg1: u64) : bool {
        let v0 = arg1 / 64;
    ...
    public(friend) fun set_nonce_used(arg0: &mut MintProof, arg1: u64) {
        let v0 = arg1 / 64;
        let v1 = 0x1::u64::try_as_u8(arg1 % 64);
        if (0x2::vec_map::contains<u64, u64>(&arg0.used_bit_map, &v0)) {
    ...
    public(friend) fun set_public_key(arg0: &mut MintProof, arg1: vector<u8>) {
        arg0.minter_public_key = arg1;
    }

    public(friend) fun verify_msg(arg0: &MintProof, arg1: &vector<u8>) : (bool, 0x1::option::Option<vector<u8>>) {
