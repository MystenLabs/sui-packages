module 0x99e67db02ea33c0eb50bdd90f4f9a425c5bc00706743bedb4d25d79360098101::cnsnft6489 {
    struct CNSNFT6489 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6489, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6489>(arg0, arg1);
