module 0x99d49e443aae28cc21d8855bbf0704e9910c8369663a05ce708a83ef92edc03d::cnsnft2054 {
    struct CNSNFT2054 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2054, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2054>(arg0, arg1);
