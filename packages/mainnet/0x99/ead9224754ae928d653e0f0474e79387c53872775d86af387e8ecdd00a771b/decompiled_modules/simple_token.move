module 0x99ead9224754ae928d653e0f0474e79387c53872775d86af387e8ecdd00a771b::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"KMPG", b"Kapogian86 Token", b"Ang Token mga Pogi", 0x1::option::none<0x2::url::Url>(), arg1);
