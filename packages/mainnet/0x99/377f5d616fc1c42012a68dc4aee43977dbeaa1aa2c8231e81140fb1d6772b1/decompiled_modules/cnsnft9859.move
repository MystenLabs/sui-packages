module 0x99377f5d616fc1c42012a68dc4aee43977dbeaa1aa2c8231e81140fb1d6772b1::cnsnft9859 {
    struct CNSNFT9859 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9859, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9859>(arg0, arg1);
