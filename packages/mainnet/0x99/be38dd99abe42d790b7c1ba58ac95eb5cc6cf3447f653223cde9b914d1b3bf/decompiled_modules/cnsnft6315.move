module 0x99be38dd99abe42d790b7c1ba58ac95eb5cc6cf3447f653223cde9b914d1b3bf::cnsnft6315 {
    struct CNSNFT6315 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6315, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6315>(arg0, arg1);
