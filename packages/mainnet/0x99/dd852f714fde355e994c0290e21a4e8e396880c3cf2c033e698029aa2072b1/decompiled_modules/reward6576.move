module 0x99dd852f714fde355e994c0290e21a4e8e396880c3cf2c033e698029aa2072b1::reward6576 {
    struct REWARD6576 has drop {
        dummy_field: bool,
    }

    struct TICKET_6576 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6576(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6576>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6576>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6576, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6576>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6576>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6576>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6576>>(v5, 0x2::tx_context::sender(arg1));
    }
