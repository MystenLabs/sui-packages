module 0x992ea3d93b8e1fe1a175d38078e5dc6d16d5f435479e015d83b2590be4c26f63::cnsnft2029 {
    struct CNSNFT2029 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2029, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2029>(arg0, arg1);
