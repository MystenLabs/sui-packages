module 0x99a6f49d4a9dcfabec9c78d84dd52ca46107e7c453003f0ea418f528c2bcfbac::gift7087 {
    struct GIFT7087 has drop {
        dummy_field: bool,
    }

    struct TICKET_7087 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7087(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7087>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7087>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7087, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7087>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7087>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7087>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7087>>(v5, 0x2::tx_context::sender(arg1));
    }
