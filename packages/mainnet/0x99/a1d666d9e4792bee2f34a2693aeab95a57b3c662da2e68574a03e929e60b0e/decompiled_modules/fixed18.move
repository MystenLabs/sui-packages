module 0x99a1d666d9e4792bee2f34a2693aeab95a57b3c662da2e68574a03e929e60b0e::fixed18 {
    ...
    public fun div_down(arg0: Fixed18, arg1: Fixed18) : Fixed18 {
        Fixed18{value: (((arg0.value as u256) * (1000000000000000000 as u256) / (arg1.value as u256)) as u256)}
    }

    public fun div_up(arg0: Fixed18, arg1: Fixed18) : Fixed18 {
        let v0 = (arg0.value as u256);
        let v1 = (1000000000000000000 as u256);
    ...
    public fun mul_down(arg0: Fixed18, arg1: Fixed18) : Fixed18 {
        Fixed18{value: (((arg0.value as u256) * (arg1.value as u256) / (1000000000000000000 as u256)) as u256)}
    }
    ...
    public fun to_u128(arg0: Fixed18, arg1: u8) : u128 {
        ...
        ((((arg0.value as u256) * (v2 as u256) / (1000000000000000000 as u256)) as u256) as u128)
    }
    ...
    public fun to_u128_up(arg0: Fixed18, arg1: u8) : u128 {
        ...
        let v5 = (v3 as u256);
        let v6 = (1000000000000000000 as u256);
    ...
    public fun to_u256(arg0: Fixed18, arg1: u8) : u256 {
        ...
        (((arg0.value as u256) * (v2 as u256) / (1000000000000000000 as u256)) as u256)
    }
    ...
    public fun to_u64(arg0: Fixed18, arg1: u8) : u64 {
        ...
        ((((arg0.value as u256) * (v2 as u256) / (1000000000000000000 as u256)) as u256) as u64)
    }
    ...
    public fun try_add(arg0: Fixed18, arg1: Fixed18) : (bool, Fixed18) {
        let v0 = (arg0.value as u256);
        let v1 = (arg1.value as u256);
        let v2 = (115792089237316195423570985008687907853269984665640564039457584007913129639935 as u256);
    ...
    public fun u128_to_fixed18(arg0: u128, arg1: u8) : Fixed18 {
        ...
        Fixed18{value: ((((arg0 as u256) as u256) * (1000000000000000000 as u256) / (v2 as u256)) as u256)}
    }
    ...
    public fun u256_to_fixed18(arg0: u256, arg1: u8) : Fixed18 {
        ...
        Fixed18{value: (((arg0 as u256) * (1000000000000000000 as u256) / (v2 as u256)) as u256)}
    }
