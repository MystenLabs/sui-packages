module 0x996f3afafbd1dad037b35389b9d8eb8ee1ead9319b96294f006ca4ac174ac675::asset_store {
    ...
    public(friend) fun deposit_object<T0: store + key>(arg0: &mut AssetStore, arg1: T0) {
        let v0 = create_asset_key<T0>();
        assert!(!0x2::dynamic_field::exists_<AssetKey>(&arg0.id, v0), 0x996f3afafbd1dad037b35389b9d8eb8ee1ead9319b96294f006ca4ac174ac675::errors::asset_already_exists());
    ...
    public(friend) fun extract_reward_balance<T0>(arg0: &mut AssetStore, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = create_reward_key<T0>();
        assert!(0x2::dynamic_field::exists_<RewardKey>(&arg0.id, v0), 0x996f3afafbd1dad037b35389b9d8eb8ee1ead9319b96294f006ca4ac174ac675::errors::asset_not_found());
    ...
    public(friend) fun withdraw<T0>(arg0: &mut AssetStore, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = create_asset_key<T0>();
        assert!(0x2::dynamic_field::exists_<AssetKey>(&arg0.id, v0), 0x996f3afafbd1dad037b35389b9d8eb8ee1ead9319b96294f006ca4ac174ac675::errors::asset_not_found());
