module 0x994c990e2143890c48f47cbb179a005e7a876470f6021e2387e51bbfcc5bcd8d::kriya_vampire_attack {
    ...
    public entry fun add_incentives_for_pool<T0, T1>(arg0: &0x2::clock::Clock, arg1: &mut KriyaLockdropForPool<T0, T1>, arg2: &KriyaAttackConfig, arg3: 0x2::coin::Coin<0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive::HIVE>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) : (u64, 0x1::string::String) {
    ...
    public fun destroy_user_position<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xaaec747bf644ac7fe8fc8c4ab24daf25abb11e1947f535015328b302ddc2a3a1::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &KriyaLockdropForPool<T0, T1>, arg4: &mut 0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::HiveProfile, arg5: &mut 0x2::tx_context::TxContext) : (vector<u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u64>, 0x2::table::Table<u64, u128>, u128, u128) {
        ...
        } = 0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::entry_remove_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg5);
        0x2::object::delete(v1);
        0x2::table::drop<u64, bool>(v6);
        (v2, v3, v4, v5, v7, v8)
    }

    public fun does_user_have_position<T0, T1>(arg0: &0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : bool {
        let v0 = 0x1::string::utf8(b"kriya_vampire_attack");
    ...
    public fun extract_liquidity_from_kriya<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xaaec747bf644ac7fe8fc8c4ab24daf25abb11e1947f535015328b302ddc2a3a1::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::Pool<T0, T1>, arg5: &mut 0x2::tx_context::TxContext) : (u128, u128, u64, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive::HIVE>) {
        assert!(0x2::clock::timestamp_ms(arg0) > arg2.init_timestamp + arg2.deposit_window + arg2.withdrawal_window, 9813);
        ...
        (arg3.total_lp_locked, arg3.total_weighted_units, arg3.total_hive_incentives, v3, v4, 0x2::balance::withdraw_all<0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive::HIVE>(&mut arg3.available_hive_tokens))
    }

    public fun get_user_position<T0, T1>(arg0: &0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::HiveProfile, arg1: &KriyaLockdropForPool<T0, T1>) : (vector<u64>, vector<u64>, vector<u64>, vector<u128>, vector<bool>, vector<u64>, u128, u64) {
        let v0 = 0x1::string::utf8(b"kriya_vampire_attack");
        0x1::string::append(&mut v0, arg1.identifer);
        let v1 = 0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::borrow_from_profile<UserKriyaHivePosition>(arg0, 0x1::string::to_ascii(v0));
    ...
    public entry fun initialize_kriya_attack_config(arg0: &0x2::clock::Clock, arg1: &0xaaec747bf644ac7fe8fc8c4ab24daf25abb11e1947f535015328b302ddc2a3a1::config::HiveEntryCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u8, arg10: &mut 0x2::tx_context::TxContext) : address {
    ...
    public entry fun lock_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xaaec747bf644ac7fe8fc8c4ab24daf25abb11e1947f535015328b302ddc2a3a1::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::HiveProfile, arg5: 0xa0eba10b173538c8fecca1dff298e488402cc9ff374f8a12ca7758eebe830b66::spot_dex::KriyaLPToken<T0, T1>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let v6 = if (0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::exists_for_profile(arg4, 0x1::string::to_ascii(v5))) {
            0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::entry_remove_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg8)
        } else {
        ...
        0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::entry_add_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v6, arg8);
    ...
    public entry fun withdraw_lp_tokens<T0, T1>(arg0: &0x2::clock::Clock, arg1: &0xaaec747bf644ac7fe8fc8c4ab24daf25abb11e1947f535015328b302ddc2a3a1::config::HiveEntryCap, arg2: &KriyaAttackConfig, arg3: &mut KriyaLockdropForPool<T0, T1>, arg4: &mut 0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::HiveProfile, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        let v0 = 0x2::clock::timestamp_ms(arg0);
        let (v1, v2, _, v4) = 0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::get_profile_meta_info(arg4);
        assert!(v0 >= arg2.init_timestamp, 9804);
        ...
        let v6 = 0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::entry_remove_from_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, arg7);
        ...
        0x51c960a89932d74a57def175755914192ee95c37d2076c23f29bcdcf6338f562::hive_profile::entry_add_to_profile<UserKriyaHivePosition>(&arg3.user_profile_access_cap, arg4, v6, arg7);
