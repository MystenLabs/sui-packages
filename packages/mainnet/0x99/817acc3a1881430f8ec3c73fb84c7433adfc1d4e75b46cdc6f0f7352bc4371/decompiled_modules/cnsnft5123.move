module 0x99817acc3a1881430f8ec3c73fb84c7433adfc1d4e75b46cdc6f0f7352bc4371::cnsnft5123 {
    struct CNSNFT5123 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5123, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5123>(arg0, arg1);
