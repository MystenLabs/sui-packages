module 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::user_manager {
    ...
    public fun accept_friend_request(arg0: &mut 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::GilderApp, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<address, FriendInfo>(&mut 0x2::table::borrow_mut<address, UserRelation>(&mut 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::app_object_mut<0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::version::UserManagerV1, UserManager>(arg0).relations, arg1).friends, v0, v4);
    ...
    public fun create_friend_request(arg0: &mut 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<address, FriendRequestInfo>(&mut 0x2::table::borrow_mut<address, UserRelation>(&mut 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::app_object_mut<0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::version::UserManagerV1, UserManager>(arg0).relations, arg1).friend_requests_received, v0, v1);
    ...
    public fun create_relation(arg0: &mut 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::GilderApp, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::app_object_mut<0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::version::UserManagerV1, UserManager>(arg0);
    ...
    public fun remove_friend(arg0: &mut 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::GilderApp, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::remove<address, FriendInfo>(&mut 0x2::table::borrow_mut<address, UserRelation>(&mut 0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::app::app_object_mut<0x997a2db9d4e6352f3776011dc010c5858e28f2741cf1c8fe11e301482d6106f9::version::UserManagerV1, UserManager>(arg0).relations, arg1).friends, v0);
        let v2 = FriendRequestEvent{
            from   : v0,
            to     : arg1,
