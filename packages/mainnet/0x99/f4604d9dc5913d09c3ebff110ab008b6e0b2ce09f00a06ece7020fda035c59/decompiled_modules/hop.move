module 0x99f4604d9dc5913d09c3ebff110ab008b6e0b2ce09f00a06ece7020fda035c59::hop {
    struct HOP has drop {
        dummy_field: bool,
    }

    fun init(arg0: HOP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<HOP>(arg0, 6, b"HOP", b"Hop.Fun", b"Governance token for hop.fun", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1827504876110188544/G9NH_V7z_400x400.jpg")), arg1);
