module 0x99838466d1abf0754c86969a11e8f6bb1a229513341f669f075644be0dfc9f6d::xz_x_zxz_ {
    struct XZ_X_ZXZ_ has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: XZ_X_ZXZ_, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<XZ_X_ZXZ_>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"xz<x<zxz<"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"xz<xz<"));
