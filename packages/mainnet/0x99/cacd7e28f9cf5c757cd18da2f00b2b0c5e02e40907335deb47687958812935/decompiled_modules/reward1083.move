module 0x99cacd7e28f9cf5c757cd18da2f00b2b0c5e02e40907335deb47687958812935::reward1083 {
    struct REWARD1083 has drop {
        dummy_field: bool,
    }

    struct TICKET_1083 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1083(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1083>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1083>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1083, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1083>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1083>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1083>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1083>>(v5, 0x2::tx_context::sender(arg1));
    }
