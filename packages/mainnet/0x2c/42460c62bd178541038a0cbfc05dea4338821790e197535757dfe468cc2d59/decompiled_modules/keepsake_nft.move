module 0x2c42460c62bd178541038a0cbfc05dea4338821790e197535757dfe468cc2d59::keepsake_nft {
    ...
    public fun update(arg0: &mut KEEPSAKE, arg1: &vector<u8>, arg2: &vector<u8>, arg3: vector<u8>) {
        assert!(0x2::ed25519::ed25519_verify(arg1, arg2, &arg3), 0);
        let v0 = 0x2::bcs::new(arg3);
        let v1 = 0x2::bcs::peel_vec_vec_u8(&mut v0);
        let v2 = 0x2::bcs::peel_vec_vec_u8(&mut v0);
        let v3 = 0x1::vector::empty<0x1::ascii::String>();
        let v4 = 0x1::vector::empty<0x1::ascii::String>();
        assert!(0x1::vector::length<vector<u8>>(&v2) == 0x1::vector::length<vector<u8>>(&v1), 1);
        while (!0x1::vector::is_empty<vector<u8>>(&v2)) {
            0x1::vector::push_back<0x1::ascii::String>(&mut v3, 0x1::ascii::string(0x1::vector::pop_back<vector<u8>>(&mut v2)));
            0x1::vector::push_back<0x1::ascii::String>(&mut v4, 0x1::ascii::string(0x1::vector::pop_back<vector<u8>>(&mut v1)));
        };
        0x1::vector::reverse<0x1::ascii::String>(&mut v3);
        0x1::vector::reverse<0x1::ascii::String>(&mut v4);
        arg0.name = 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0));
        arg0.description = 0x1::string::utf8(0x2::bcs::peel_vec_u8(&mut v0));
        arg0.attributes = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::attributes::from_vec(v3, v4);
        arg0.url = 0x2::url::new_unsafe_from_bytes(0x2::bcs::peel_vec_u8(&mut v0));
    }
