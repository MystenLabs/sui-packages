module 0x9bd711b9067f57b07743de2d1f67fd2be75a2e03370ea256f07b5c0ed88016cc::academy {
    ...
    entry fun finish_training(arg0: TrainingDiver, arg1: &0x9bd711b9067f57b07743de2d1f67fd2be75a2e03370ea256f07b5c0ed88016cc::global::GlobalState, arg2: &0x2::clock::Clock, arg3: &0x9bd711b9067f57b07743de2d1f67fd2be75a2e03370ea256f07b5c0ed88016cc::user::User, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let TrainingDiver {
            ...
            diver                : v1,
            start_time           : v2,
            training_duration_ms : v3,
            training_type        : v4,
            r_value              : v5,
        } = arg0;
        let v6 = v1;
        assert!(0x2::clock::timestamp_ms(arg2) >= v2 + v3, 3);
        let v7 = if (v4 == 0) {
            true
        } else if (v4 == 1) {
            true
        ...
        if (v4 == 0) {
            ...
            if (v5 > 80) {
                0x9bd711b9067f57b07743de2d1f67fd2be75a2e03370ea256f07b5c0ed88016cc::diver::mint_diving_tank_for_reef_plant_diver(2, arg4);
                v8 = 2;
            } else {
                0x9bd711b9067f57b07743de2d1f67fd2be75a2e03370ea256f07b5c0ed88016cc::diver::mint_diving_tank_for_reef_plant_diver(1, arg4);
                v8 = 1;
            };
        };
        0x2::object::delete(v0);
        0x2::transfer::public_transfer<0x9bd711b9067f57b07743de2d1f67fd2be75a2e03370ea256f07b5c0ed88016cc::diver::Diver>(v6, 0x2::tx_context::sender(arg4));
