module 0x9bd711b9067f57b07743de2d1f67fd2be75a2e03370ea256f07b5c0ed88016cc::marketplace_base {
    ...
    struct SellerListingListEvent has copy, drop {
        id: 0x2::object::ID,
    }
    ...
    public fun fetch_seller_listing_list(arg0: &Marketplace, arg1: address) {
        let v0 = SellerListingListEvent{id: 0x2::object::id<0x2::table::Table<0x2::object::ID, ListingDetail>>(&0x2::table::borrow<address, UserListingInfo>(&arg0.user_listing_table, arg1).listing_list)};
        0x2::event::emit<SellerListingListEvent>(v0);
    }
