module 0x2c2869282816e63112d65447418dd6830742809ee6d644a9ef7da5564d813061::island {
    struct ISLAND has drop {
        dummy_field: bool,
    }

    struct IslandInventory has store, key {
        id: 0x2::object::UID,
        count: u64,
    }

    struct IslandOwnership has store, key {
        id: 0x2::object::UID,
        ownership: 0x2::table::Table<address, u64>,
    }

    struct IslandLand has store, key {
        id: 0x2::object::UID,
    ...
    public fun url(arg0: &IslandLand) : &0x2::url::Url {
        &arg0.url
    }

    public fun burn_land(arg0: IslandLand, arg1: &mut 0x2::tx_context::TxContext) {
        let IslandLand {
            id                         : v0,
            name                       : _,
            url                        : _,
        ...
        let v11 = LandBurned{
            object_id : 0x2::object::id<IslandLand>(&arg0),
    ...
    public fun create_ownership_manually(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = IslandOwnership{
            id        : 0x2::object::new(arg0),
            ownership : 0x2::table::new<address, u64>(arg0),
        };
        0x2::transfer::public_transfer<IslandOwnership>(v1, v0);
    }
    ...
    fun init(arg0: ISLAND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Island Kingdom NFT - Property in Drariux Network ecosystem."));
        ...
        let v4 = 0x2::package::claim<ISLAND>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<IslandLand>(&v4, v0, v2, arg1);
        0x2::display::update_version<IslandLand>(&mut v5);
        let v6 = IslandInventory{
            id    : 0x2::object::new(arg1),
            count : 0,
        };
        let v7 = IslandOwnership{
            id        : 0x2::object::new(arg1),
        ...
        0x2::transfer::public_transfer<0x2::display::Display<IslandLand>>(v5, @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce);
        0x2::transfer::public_transfer<IslandInventory>(v6, @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce);
        0x2::transfer::public_transfer<IslandOwnership>(v7, @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce);
    }
    ...
    public fun mint_island_land(arg0: u8, arg1: u8, arg2: &mut IslandInventory, arg3: &mut IslandOwnership, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == @0x554a2392980b0c3e4111c9a0e8897e632d41847d04cbd41f9e081e49ba2eb04a || v0 == @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce, 6);
        assert!(arg0 >= 1 && arg0 <= 31, 1);
        assert!(arg1 <= 5, 1);
        assert!(arg2.count < 100, 2);
        ...
        *v1 = *v1 + 1;
        let v2 = if (arg1 == 1) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmTWZuc651dwUHp4A7bXrW8wryr1g8TsA4LQFMiGEqPvLT")
        } else if (arg1 == 4) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmQa4T3LomcpHsRczTwzqW72tdJMSor9277n2nnsAc8scB")
        } else if (arg1 == 5) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/Qmduj9PP85B6wn9PmGhVmGDB9cen1JbLQuV7221bxTZeC4")
        } else if (arg1 == 2) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmNzinffbaB6hPBheep1PXtykR4pUrNcmnjSArYs3oDngM")
        } else if (arg1 == 3) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmdLozsDds7nHkNuNMzRz5vVzH19AeAfSwU1esibRKfmKX")
        } else {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmQ6yGSonjTf1ySU3rirFmL3L5bKBm8UTdDAPsvuRBaEse")
        };
        let v3 = 0x1::string::utf8(b"Island Kingdom #");
        ...
        let v5 = LandMinted{
            object_id      : 0x2::object::id<IslandLand>(&v4),
            owner          : v0,
            type_id        : arg0,
            name           : v4.name,
        ...
        0x2::transfer::public_transfer<IslandLand>(v4, v0);
    }

    public fun mint_sub_land(arg0: &mut IslandLand, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = *v1 + 1;
        ...
        let v6 = SubLand{
            ...
            parent_land_id : 0x2::object::id<IslandLand>(arg0),
            size_km2       : v2,
            sub_type       : arg1,
    ...
    public fun name(arg0: &IslandLand) : &0x1::string::String {
        &arg0.name
    }
    ...
    public fun update_url(arg0: &mut IslandLand, arg1: 0x1::ascii::String, arg2: &mut 0x2::tx_context::TxContext) {
