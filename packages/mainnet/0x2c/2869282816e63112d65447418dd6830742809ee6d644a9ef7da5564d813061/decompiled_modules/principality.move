module 0x2c2869282816e63112d65447418dd6830742809ee6d644a9ef7da5564d813061::principality {
    struct PRINCIPALITY has drop {
        dummy_field: bool,
    }

    struct PrincipalityInventory has store, key {
        id: 0x2::object::UID,
        count: u64,
    }

    struct PrincipalityOwnership has store, key {
        id: 0x2::object::UID,
        ownership: 0x2::table::Table<address, u64>,
    }

    struct PrincipalityLand has store, key {
        id: 0x2::object::UID,
    ...
    struct FeudalLand has store, key {
        id: 0x2::object::UID,
        name: 0x1::string::String,
        url: 0x2::url::Url,
    ...
    struct ProtectedTP has store, key {
        id: 0x2::object::UID,
        transfer_policy: 0x2::transfer_policy::TransferPolicy<FeudalLand>,
        policy_cap: 0x2::transfer_policy::TransferPolicyCap<FeudalLand>,
    }
    ...
    public fun list(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &ProtectedTP, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::kiosk::list<FeudalLand>(arg0, arg1, arg3, 0);
        let (v0, v1) = 0x2::kiosk::purchase<FeudalLand>(arg0, arg3, 0x2::coin::zero<0x2::sui::SUI>(arg6));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<FeudalLand>(&arg2.transfer_policy, v1);
        let v5 = Rentable{
            object        : v0,
            duration      : arg4,
    ...
    public fun url(arg0: &PrincipalityLand) : &0x2::url::Url {
        &arg0.url
    }

    public fun burn_land(arg0: PrincipalityLand, arg1: &mut 0x2::tx_context::TxContext) {
        let PrincipalityLand {
            id                         : v0,
            name                       : _,
            url                        : _,
            size_km2                   : _,
        ...
        let v11 = LandBurned{
            object_id : 0x2::object::id<PrincipalityLand>(&arg0),
            owner     : 0x2::tx_context::sender(arg1),
        };
        0x2::event::emit<LandBurned>(v11);
    }

    public fun create_ownership_manually(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = PrincipalityOwnership{
            id        : 0x2::object::new(arg0),
            ownership : 0x2::table::new<address, u64>(arg0),
        };
        0x2::transfer::public_transfer<PrincipalityOwnership>(v1, v0);
    }
    ...
    public fun delist(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::kiosk::place<FeudalLand>(arg0, arg1, v2);
    }
    ...
    public fun end_rental(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::clock::Clock, arg3: 0x2::object::ID, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::kiosk::place<FeudalLand>(arg0, arg4, v2);
    }

    fun init(arg0: PRINCIPALITY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Principality Land NFT - Property in Drariux Network ecosystem."));
        ...
        let v4 = 0x2::package::claim<PRINCIPALITY>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<PrincipalityLand>(&v4, v0, v2, arg1);
        0x2::display::update_version<PrincipalityLand>(&mut v5);
        let v6 = PrincipalityInventory{
            id    : 0x2::object::new(arg1),
            count : 0,
        };
        let v7 = PrincipalityOwnership{
            id        : 0x2::object::new(arg1),
            ownership : 0x2::table::new<address, u64>(arg1),
        };
        let (v8, v9) = 0x2::transfer_policy::new<FeudalLand>(&v4, arg1);
        let v10 = ProtectedTP{
            id              : 0x2::object::new(arg1),
            transfer_policy : v8,
            policy_cap      : v9,
        ...
        0x2::transfer::public_transfer<0x2::display::Display<PrincipalityLand>>(v5, @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce);
        0x2::transfer::public_transfer<PrincipalityInventory>(v6, @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce);
        0x2::transfer::public_transfer<PrincipalityOwnership>(v7, @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce);
    }
    ...
    public fun mint_feudal_land(arg0: &mut PrincipalityLand, arg1: u8, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = *v1 + 1;
        ...
        let v6 = FeudalLand{
            ...
            parent_land_id : 0x2::object::id<PrincipalityLand>(arg0),
            size_km2       : v2,
            sub_type       : arg1,
            terrain_type   : arg0.terrain_type,
        };
        0x2::dynamic_object_field::add<0x2::object::ID, FeudalLand>(&mut arg0.id, 0x2::object::id<FeudalLand>(&v6), v6);
    }

    public fun mint_principality_land(arg0: u8, arg1: u8, arg2: &mut PrincipalityInventory, arg3: &mut PrincipalityOwnership, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == @0x554a2392980b0c3e4111c9a0e8897e632d41847d04cbd41f9e081e49ba2eb04a || v0 == @0x9e7aaf5f56ae094eadf9ca7f2856f533bcbf12fcc9bb9578e43ca770599a5dce, 6);
        assert!(arg0 >= 1 && arg0 <= 31, 1);
        assert!(arg1 <= 5, 1);
        assert!(arg2.count < 500, 2);
        ...
        *v1 = *v1 + 1;
        let v2 = if (arg1 == 4) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmUnBF841o6KHML9ywUsuKosDud62n6W2zwCp2L9aUkSm2")
        } else if (arg1 == 3) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmV9CMYfUngcp7UrhxTKd7xRd88LoQkaXMHHy9Q5PRucch")
        } else if (arg1 == 0) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmVGLBKEH82jrCGzqBuz5QvJxY98PEwDugnzVroNVWu19p")
        } else if (arg1 == 2) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmT3wgK9fELuNFtR5XYsNidf4VyorZzBmx4CeACkk5zdFE")
        } else if (arg1 == 1) {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmRkUR7esoYyZvxUUxwjZNJH89dGuqb3mLufnusBoKrHD3")
        } else {
            0x1::ascii::string(b"https://ipfs.io/ipfs/QmaMB7XCkWLFeE2FciJdYNrtPti4qzKRG2mUd4Fk6ogWY2")
        };
        let v3 = 0x1::string::utf8(b"Principality Land #");
        0x1::string::append(&mut v3, u64_to_string(arg2.count));
        let v4 = PrincipalityLand{
        ...
        let v5 = LandMinted{
            object_id      : 0x2::object::id<PrincipalityLand>(&v4),
            owner          : v0,
            type_id        : arg0,
            name           : v4.name,
        ...
        0x2::transfer::public_transfer<PrincipalityLand>(v4, v0);
    }

    public fun name(arg0: &PrincipalityLand) : &0x1::string::String {
        &arg0.name
    }
    ...
    public fun update_url(arg0: &mut PrincipalityLand, arg1: 0x1::ascii::String, arg2: &mut 0x2::tx_context::TxContext) {
