module 0x2c49e5d9f0db8b33a296e628336290ead3614fe77f2ab0cae9c8f406af358a49::reward2248 {
    struct REWARD2248 has drop {
        dummy_field: bool,
    }

    struct TICKET_2248 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2248(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2248>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2248>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2248, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2248>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2248>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2248>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2248>>(v5, 0x2::tx_context::sender(arg1));
    }
