module 0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::cross_chain_limit_orders {
    ...
    public fun cancel_order<T0, T1, T2>(arg0: Order<T0, T1, T2>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let Order {
            id                     : v0,
            guard_id               : _,
            locked_collateral      : v2,
            locked_coins_in        : v3,
            locked_stablecoins     : v4,
            user                   : v5,
            min_stablecoins_amount : _,
            active_solver          : _,
            execution_deadline     : v8,
            deadline               : v9,
            execution_details_hash : _,
        } = arg0;
        let v11 = v0;
        if (0x2::tx_context::sender(arg2) != v5) {
            abort 0
        };
        ...
        let v13 = OrderCancelled{order_id: 0x2::object::uid_to_inner(&v11)};
        0x2::event::emit<OrderCancelled>(v13);
        0x2::object::delete(v11);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::send_coins_and_destroy_balance<T1>(v3, v5, arg2);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::send_coins_and_destroy_balance<T2>(v4, v5, arg2);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::send_coins_and_destroy_balance<T0>(v2, v5, arg2);
    }
    ...
    public fun claim_tokens<T0, T1, T2>(arg0: &0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T2>, arg1: Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_version<T0, T2>(arg0);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_id<T0, T2>(arg0, arg1.guard_id);
        let v0 = 0x2::address::to_bytes(0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::get_actioneer<T0, T2>(arg0));
        ...
        let Order {
            id                     : v2,
            guard_id               : _,
            locked_collateral      : v4,
            locked_coins_in        : v5,
            locked_stablecoins     : v6,
            user                   : _,
            min_stablecoins_amount : _,
            active_solver          : v9,
        ...
        let v13 = v9;
        let v14 = v2;
        let v15 = decode_signed_success_confirmation_data(arg2);
        if (&v15.order_id != 0x2::object::uid_as_inner(&v14)) {
            abort 108
        };
        let v16 = if (0x1::option::is_none<address>(&v13)) {
            true
        } else if (0x1::option::borrow<address>(&v13) != &v1) {
            true
        } else {
            v1 != v15.solver_address
        };
        if (v16) {
            abort 2
        };
        let v17 = OrderFulfilled{order_id: 0x2::object::uid_to_inner(&v14)};
        0x2::event::emit<OrderFulfilled>(v17);
        0x2::object::delete(v14);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::send_coins_and_destroy_balance<T1>(v5, v1, arg4);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::send_coins_and_destroy_balance<T2>(v6, v1, arg4);
        0x2::coin::from_balance<T0>(v4, arg4)
    }

    public fun create_order<T0, T1, T2>(arg0: &0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T2>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_version<T0, T2>(arg0);
    ...
    public fun pre_start_order_execution<T0, T1, T2>(arg0: &0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, SwapReceipt) {
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_version<T0, T2>(arg0);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_id<T0, T2>(arg0, arg1.guard_id);
    ...
    public fun start_order_execution<T0, T1, T2>(arg0: &mut 0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_version<T0, T2>(arg0);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_id<T0, T2>(arg0, arg1.guard_id);
        let v0 = decode_start_permission_and_check_signature<T0, T2>(arg0, arg2, arg3);
    ...
    public fun start_order_execution_after_swap<T0, T1, T2>(arg0: &mut 0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: 0x2::coin::Coin<T0>, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: 0x2::coin::Coin<T2>, arg8: SwapReceipt, arg9: &mut 0x2::tx_context::TxContext) {
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_version<T0, T2>(arg0);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_id<T0, T2>(arg0, arg1.guard_id);
        if (0x2::balance::value<T1>(&arg1.locked_coins_in) != 0) {
            abort 5
    ...
    fun start_order_execution_internal<T0, T1, T2>(arg0: &mut 0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T2>, arg1: &mut Order<T0, T1, T2>, arg2: SignedPermissionData, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::increase_collected_fees<T0, T2>(arg0, 0x2::coin::into_balance<T0>(arg4));
