module 0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::single_chain_dca_orders {
    ...
    public fun cancel_dca_order<T0>(arg0: DcaOrder<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = DcaOrderCancelled{order_id: 0x2::object::uid_to_inner(&v14)};
        0x2::event::emit<DcaOrderCancelled>(v15);
    ...
    public fun create_dca_order<T0, T1, T2>(arg0: &0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T2>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u32, arg7: u64, arg8: vector<u8>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
    ...
    public fun fulfill_dca_order_interval<T0, T1, T2, T3, T4>(arg0: &mut 0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T1>, arg1: DcaOrder<T2>, arg2: FulfillmentReceipt<T3, T4>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T3>, arg5: 0x1::option::Option<0x2::coin::Coin<T4>>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.total_intervals == arg1.total_executed_intervals) {
            ...
            let v25 = DcaOrderFulfilled{order_id: 0x2::object::uid_to_inner(&v24)};
            0x2::event::emit<DcaOrderFulfilled>(v25);
    ...
    public fun start_dca_order_execution<T0, T1, T2, T3, T4>(arg0: &mut 0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::Guard<T0, T1>, arg1: &mut DcaOrder<T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, FulfillmentReceipt<T3, T4>) {
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_version<T0, T1>(arg0);
        0x2c9b6a7a018f2f02663a1b2247e7e53d0bf832b30ab9534c49699a78a2f659f2::guard::ensure_guard_id<T0, T1>(arg0, arg1.guard_id);
