module 0x2c4cccdca8dfe827fe770e8d2376f74b2f86d050311ea28257f993a65cd73e0f::swap_context {
    struct SwapContext {
    ...
    public fun confirm_swap<T0>(arg0: SwapContext, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v2 = v1;
        assert!(0x2::bag::is_empty(&v2), 0x2c4cccdca8dfe827fe770e8d2376f74b2f86d050311ea28257f993a65cd73e0f::errors::err_remains_balance());
    ...
    public fun new_swap_context<T0>(arg0: 0x2::coin::Coin<T0>, arg1: &mut 0x2::tx_context::TxContext) : SwapContext {
        assert!(0x2::coin::value<T0>(&arg0) > 0, 0x2c4cccdca8dfe827fe770e8d2376f74b2f86d050311ea28257f993a65cd73e0f::errors::err_amount_in_is_zero());
