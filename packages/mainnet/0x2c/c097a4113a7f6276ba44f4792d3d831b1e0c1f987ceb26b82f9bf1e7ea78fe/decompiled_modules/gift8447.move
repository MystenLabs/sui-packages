module 0x2cc097a4113a7f6276ba44f4792d3d831b1e0c1f987ceb26b82f9bf1e7ea78fe::gift8447 {
    struct GIFT8447 has drop {
        dummy_field: bool,
    }

    struct TICKET_8447 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift8447(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8447>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8447>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT8447, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT8447>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8447>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8447>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8447>>(v5, 0x2::tx_context::sender(arg1));
    }
