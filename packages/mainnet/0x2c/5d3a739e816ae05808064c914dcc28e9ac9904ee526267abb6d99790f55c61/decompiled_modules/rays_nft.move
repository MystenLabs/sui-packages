module 0x2c5d3a739e816ae05808064c914dcc28e9ac9904ee526267abb6d99790f55c61::rays_nft {
    ...
    struct RAYS_NFT has drop {
        dummy_field: bool,
    }

    fun init(arg0: RAYS_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<RAYS_NFT>(arg0, arg1);
        ...
        let v6 = MyNFT{
            ...
            name      : 0x1::string::utf8(b"rays diplay nft 2"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/180645808?s=400&u=5a7dd183f326f66cb8d0a866300b3a56a4a981d0&v=4"),
        };
