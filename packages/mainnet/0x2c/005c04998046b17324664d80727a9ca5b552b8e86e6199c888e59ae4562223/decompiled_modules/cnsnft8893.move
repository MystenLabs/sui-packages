module 0x2c005c04998046b17324664d80727a9ca5b552b8e86e6199c888e59ae4562223::cnsnft8893 {
    struct CNSNFT8893 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8893, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1790"));
        let v4 = 0x2::package::claim<CNSNFT8893>(arg0, arg1);
