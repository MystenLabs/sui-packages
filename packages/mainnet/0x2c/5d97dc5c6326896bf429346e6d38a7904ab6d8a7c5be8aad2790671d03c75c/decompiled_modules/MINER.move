module 0x2c5d97dc5c6326896bf429346e6d38a7904ab6d8a7c5be8aad2790671d03c75c::MINER {
    ...
    fun init(arg0: MINER, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SUIVE"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"http://suive.com"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://i.ibb.co/Hq8tMH0/photo-2024-11-13-14-23-20.jpg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SuiVE-8$ all"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"http://suive.com"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SUIVE"));
