module 0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::config {
    ...
    public fun cancel_funding(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::cancel(&mut arg0.id);
    }

    public fun cancel_hibernation(arg0: &mut Config, arg1: &AdminCap) {
        authorize(arg0, arg1);
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::cancel(&mut arg0.id);
    }
    ...
    public fun execute_funding(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::execute(&mut arg0.id, arg1);
    }

    public fun execute_hibernation(arg0: &mut Config, arg1: &0x2::clock::Clock) {
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::execute(&mut arg0.id, arg1);
    }
    ...
    public fun funding(arg0: &Config) : 0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::Rules {
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::get(&arg0.id)
    }

    public fun funding_proposal(arg0: &Config) : (bool, 0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::Rules, u64) {
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::pending(&arg0.id)
    }

    public fun hibernation(arg0: &Config) : 0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::Rules {
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::get(&arg0.id)
    }

    public fun hibernation_proposal(arg0: &Config) : (bool, 0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::Rules, u64) {
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::pending(&arg0.id)
    }
    ...
    public fun propose_funding(arg0: &mut Config, arg1: &AdminCap, arg2: 0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::funding_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }

    public fun propose_hibernation(arg0: &mut Config, arg1: &AdminCap, arg2: 0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::Rules, arg3: &0x2::clock::Clock) {
        authorize(arg0, arg1);
        0x2c4e75d6f73a65f435d1a99636c4483536becd51e0fecd76e2b447104948b30f::hibernation_rules::propose(&mut arg0.id, arg2, arg0.params.timelock_ms, arg3);
    }
