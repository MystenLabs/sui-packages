module 0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::craps {
        ...
        loop {
            ...
            if (v2 == arg1 && v4 == arg2) {
                let v6 = if (v2 == 0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::come_bet()) {
                    ...
                    v2 == 0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::dont_come_odds_bet()
                };
                if (v6) {
                    abort 13
                };
    ...
    fun handle_bets<T0>(arg0: &0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: u64, arg2: &mut 0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>, arg3: &mut 0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>, arg4: &mut CrapsTable<T0>, arg5: address, arg6: &mut bool, arg7: &mut u64, arg8: &mut u64, arg9: &mut vector<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::BetResult<T0, Craps>>, arg10: &mut vector<PlayerWin<T0>>, arg11: &mut 0x2::balance::Balance<T0>, arg12: &mut u64, arg13: u64) : bool {
        ...
        while (*arg8 < arg13 && 0x1::vector::length<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>(&v2) != 0) {
            ...
            if (v11) {
                ...
                arg4.current_risk = arg4.current_risk - 0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::get_bet_max_payout(v6, v5, v9);
    ...
    public fun settle_or_continue<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut CrapsConfig, arg2: address, arg3: 0x1::option::Option<u64>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x1::option::extract<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&mut v1.bets);
        let v4 = 0x1::option::extract<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&mut v1.settled_bets);
        assert!(0x2::linked_table::length<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>(&v3) != 0, 10);
        ...
        let v14 = 0;
        let v15 = 0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::dice_interpreter::get_dice_sum(v5);
        ...
        while (v10 < v8 && 0x2::linked_table::length<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>(&v3) > 0) {
            let v16 = &mut v3;
            let v17 = &mut v4;
            let v18 = &mut v11;
            let v19 = &mut v7;
        ...
        if (0x2::linked_table::length<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>(&v3) == 0) {
            v1.status = 0;
            v1.round_number = v1.round_number + 1;
            0x1::option::fill<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&mut v1.settled_bets, 0x2::linked_table::new<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>(arg5));
            0x1::option::fill<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&mut v1.bets, v4);
            0x2::linked_table::destroy_empty<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>(v3);
            let v32 = 0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::dice_interpreter::get_dice_sum(v5);
            if (0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::dice_interpreter::get_dice_sum(v5) == 7) {
                let v33 = 0x1::option::borrow<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&v1.settled_bets);
                assert!(0x2::linked_table::length<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>(0x1::option::borrow<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&v1.bets)) == 0, 11);
                assert!(0x2::linked_table::length<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>(v33) == 0, 12);
                assert!(0x2::balance::value<T0>(&v1.balance) == 0, 14);
            ...
            0x1::option::fill<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&mut v1.bets, v3);
            0x1::option::fill<0x2::linked_table::LinkedTable<address, vector<0x2c6b186d1bb437e09132af796714340d431c7dfaa83cddfd4b9bd785204be743::bet_manager::Bet>>>(&mut v1.settled_bets, v4);
        };
    }
