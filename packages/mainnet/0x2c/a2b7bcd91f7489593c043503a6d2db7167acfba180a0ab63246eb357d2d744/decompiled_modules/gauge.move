module 0xb8a376d33c5f113fdf9faf988c4d16d88a02ff9fec62481fa2b450ee8119316c::gauge {
    ...
    struct EventUpdateRewardPositionV2 has copy, drop, store {
        gauger_id: 0x2::object::ID,
        pool_id: 0x2::object::ID,
        position_id: 0x2::object::ID,
        growth_inside: u128,
    ...
    public fun get_pool_reward<T0, T1, T2>(arg0: &0x8c9b843944257991e5f813039d9fb70e0358ae2ff28b2bfdf2624dd6d8251bb3::config::GlobalConfig, arg1: &mut 0x8c9b843944257991e5f813039d9fb70e0358ae2ff28b2bfdf2624dd6d8251bb3::rewarder::RewarderGlobalVault, arg2: &mut Gauge<T0, T1>, arg3: &mut 0x8c9b843944257991e5f813039d9fb70e0358ae2ff28b2bfdf2624dd6d8251bb3::pool::Pool<T0, T1>, arg4: &StakedPosition, arg5: &0x2::clock::Clock) : 0x2::balance::Balance<T2> {
        assert!(check_gauger_pool<T0, T1>(arg2, arg3), 73727195005154130);
    ...
    public(friend) fun update_reward_internal<T0, T1>(arg0: &mut Gauge<T0, T1>, arg1: &mut 0x8c9b843944257991e5f813039d9fb70e0358ae2ff28b2bfdf2624dd6d8251bb3::pool::Pool<T0, T1>, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : u64 {
        ...
        let v4 = v3.amount;
        v3.growth_inside = v2;
        let v5 = EventUpdateRewardPositionV2{
            gauger_id     : 0x2::object::id<Gauge<T0, T1>>(arg0),
            pool_id       : 0x2::object::id<0x8c9b843944257991e5f813039d9fb70e0358ae2ff28b2bfdf2624dd6d8251bb3::pool::Pool<T0, T1>>(arg1),
            position_id   : arg2,
        ...
        0x2::event::emit<EventUpdateRewardPositionV2>(v5);
        v3.amount = 0;
        v4
    }
