module 0x2c375c9ef8a3caec9b0a61a02f9ef28cdc6990bb1b188c03a7246a0098c7ddf4::pool {
    ...
    struct Vault<phantom T0> has store, key {
        ...
        coin_type_a: 0x1::type_name::TypeName,
        coin_type_b: 0x1::type_name::TypeName,
        buffer_assets: 0x2c375c9ef8a3caec9b0a61a02f9ef28cdc6990bb1b188c03a7246a0098c7ddf4::balance_bag::BalanceBag,
        markets: 0x2::object_bag::ObjectBag,
    }

    public fun add_coin<T0: drop, T1>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T1>) {
        0x2c375c9ef8a3caec9b0a61a02f9ef28cdc6990bb1b188c03a7246a0098c7ddf4::balance_bag::join<T1>(&mut arg0.buffer_assets, 0x2::coin::into_balance<T1>(arg1));
    }
    ...
    public fun new_vault<T0, T1>(arg0: 0x1::type_name::TypeName, arg1: 0x1::type_name::TypeName, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
            id            : 0x2::object::new(arg2),
            coin_type_a   : arg0,
            coin_type_b   : arg1,
            buffer_assets : 0x2c375c9ef8a3caec9b0a61a02f9ef28cdc6990bb1b188c03a7246a0098c7ddf4::balance_bag::new_balance_bag(arg2),
            markets       : 0x2::object_bag::new(arg2),
        };
