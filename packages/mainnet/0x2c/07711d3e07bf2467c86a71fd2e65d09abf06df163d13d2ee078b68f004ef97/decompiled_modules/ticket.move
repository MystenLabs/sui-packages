module 0x2c07711d3e07bf2467c86a71fd2e65d09abf06df163d13d2ee078b68f004ef97::ticket {
    ...
    public fun create_ticket(arg0: &mut Stats, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg8) >= 10000000, 13);
    ...
    public fun migrate_stats(arg0: &AdminCap, arg1: &mut Stats, arg2: u64, arg3: u64) {
        arg1.total_files = arg1.total_files + arg2;
        arg1.total_bytes = arg1.total_bytes + arg3;
    }
