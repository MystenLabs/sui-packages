module 0x2cd126cf634a70459eeebde9d550d11210e56a33a1b2cc5569ffaa6153a47f4d::suiwin {
    ...
    entry fun game_stake_21_stand(arg0: &0x2::random::Random, arg1: &mut GameData, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v8 = &mut v5;
        let v9 = compared(arg0, v8, v6, arg2);
        if (v9 == 1) {
            let v10 = v1 * 2;
            if (v7) {
                v10 = v1 * 3;
            };
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.balance, v10, arg2), 0x2::tx_context::sender(arg2));
        } else if (v9 == 2) {
    ...
    entry fun game_stake_21_surrender(arg0: &mut GameData, arg1: &mut 0x2::tx_context::TxContext) {
        let Game21 {
            id  : v0,
            bet : v1,
            d   : v2,
            p   : v3,
        } = 0x2::dynamic_object_field::remove<address, Game21>(&mut arg0.id, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg0.balance, v1 / 2, arg1), 0x2::tx_context::sender(arg1));
        0x2::object::delete(v0);
        let v4 = Outcome21{
            bet     : v1,
            d       : v2,
