module 0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::vault {
    ...
    struct Treasury has key {
        id: 0x2::object::UID,
        rewardsTreasury: 0x2::balance::Balance<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>,
    ...
    public entry fun getReward(arg0: &mut UserState, arg1: &mut RewardState, arg2: &mut Treasury, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        *v1 = 0;
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>>(0x2::coin::take<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>(&mut arg2.rewardsTreasury, *v1, arg4), 0x2::tx_context::sender(arg4));
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Treasury{
            id                  : 0x2::object::new(arg0),
            rewardsTreasury     : 0x2::balance::zero<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>(),
    ...
    public entry fun setRewardAmount(arg0: &AdminCap, arg1: 0x2::coin::Coin<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>, arg2: &mut UserState, arg3: &mut RewardState, arg4: &mut Treasury, arg5: &0x2::clock::Clock) {
        let v0 = 0x2::coin::value<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>(&arg1);
        updateReward(0x2::balance::value<0x2::sui::SUI>(&arg4.stakedCoinsTreasury), @0x0, arg2, arg3, arg5);
        0x2::balance::join<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>(&mut arg4.rewardsTreasury, 0x2::coin::into_balance<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>(arg1));
        ...
        assert!(arg3.rewardRate * arg3.duration <= 0x2::balance::value<0x2ccb94fc874ae5372392f4754203818942d62916126f5d66a5a052906741b74e::farm::FARM>(&arg4.rewardsTreasury), 103);
