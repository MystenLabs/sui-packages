module 0x2cb47c6d99d7207dcb7d89e3f622e9abdc4d2b668067d1909e480ff1202f9ab4::sui_mm_honey {
    struct SUI_MM_HONEY has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUI_MM_HONEY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<SUI_MM_HONEY>(arg0, 6, b"SUI_MM_HONEY", b"", b"", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
