module 0x2c26c0ffe82e5711142cac219f9a3c4afdbd8774b753d9b7c66a3e2708e031db::reward7694 {
    struct REWARD7694 has drop {
        dummy_field: bool,
    }

    struct TICKET_7694 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7694(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7694>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7694>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7694, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7694>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7694>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7694>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7694>>(v5, 0x2::tx_context::sender(arg1));
    }
