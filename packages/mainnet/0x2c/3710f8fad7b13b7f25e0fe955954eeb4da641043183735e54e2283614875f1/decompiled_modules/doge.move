module 0x2c3710f8fad7b13b7f25e0fe955954eeb4da641043183735e54e2283614875f1::doge {
    ...
    fun init(arg0: DOGE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<DOGE>(arg0, 9, b"DOGE", b"@DOGE", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://ipfs.io/ipfs/QmcCuZGaew3xYSATg5jqhH7s3MrUjhUfquSjPK86F5oR8e"))), false, arg1);
        let v3 = v0;
