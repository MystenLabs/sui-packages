module 0x2c4fe69fd7f894133499ea35b9c7e12bf4b84edfe4dd169ccc7fa4a2f591fa93::game6072 {
    struct GAME6072 has drop {
        dummy_field: bool,
    }

    struct TICKET_6072 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6072(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6072>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6072>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME6072, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6072>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6072>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6072>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6072>>(v5, 0x2::tx_context::sender(arg1));
    }
