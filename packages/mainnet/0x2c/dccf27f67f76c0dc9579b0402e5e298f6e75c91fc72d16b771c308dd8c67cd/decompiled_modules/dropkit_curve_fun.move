module 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::dropkit_curve_fun {
    ...
    struct Curve<phantom T0> has key {
        ...
        signature_config: 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::SignatureConfig,
    }

    public entry fun buy<T0>(arg0: &mut Curve<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::fee_collector::FeeCollector, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        if (0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::requires_signature(&arg0.signature_config)) {
            0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::verify_signature(&mut arg0.signature_config, 0x2::tx_context::sender(arg8), arg3, arg4, arg2, arg5, arg7, 0x2::object::uid_to_address(&arg0.id));
        };
        buy_internal<T0>(arg0, arg1, arg2, arg6, arg8);
    }

    fun buy_internal<T0>(arg0: &mut Curve<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: &mut 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::fee_collector::FeeCollector, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::fee_collector::collect_and_distribute_fees(arg3, arg1, arg0.creator_address, arg4);
    ...
    public entry fun buy_with_sui_amount<T0>(arg0: &mut Curve<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::fee_collector::FeeCollector, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg1);
        assert!(v0 > 0, 4);
        let v1 = calculate_tokens_for_payment<T0>(arg0, v0);
        assert!(v1 > 0, 4);
        if (0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::requires_signature(&arg0.signature_config)) {
            0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::verify_signature(&mut arg0.signature_config, 0x2::tx_context::sender(arg7), arg2, arg3, v0, arg4, arg6, 0x2::object::uid_to_address(&arg0.id));
        };
    ...
    public fun get_backend_public_key<T0>(arg0: &Curve<T0>) : vector<u8> {
        0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::get_backend_public_key(&arg0.signature_config)
    }
    ...
    public fun get_used_nonces_count<T0>(arg0: &Curve<T0>) : u64 {
        0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::get_used_nonces_count(&arg0.signature_config)
    }

    public fun is_nonce_used<T0>(arg0: &Curve<T0>, arg1: u64) : bool {
        0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::is_nonce_used(&arg0.signature_config, arg1)
    }
    ...
    public entry fun new_curve<T0>(arg0: u64, arg1: u64, arg2: 0x2::coin::TreasuryCap<T0>, arg3: address, arg4: address, arg5: bool, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Curve<T0>{
            ...
            signature_config      : 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::new_signature_config(arg5, arg6, arg7),
        };
    ...
    public fun requires_signature<T0>(arg0: &Curve<T0>) : bool {
        0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::requires_signature(&arg0.signature_config)
    }

    public entry fun sell<T0>(arg0: &mut Curve<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: vector<u8>, arg5: &mut 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::fee_collector::FeeCollector, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        if (0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::requires_signature(&arg0.signature_config)) {
            0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::verify_signature(&mut arg0.signature_config, 0x2::tx_context::sender(arg7), arg2, arg3, 0x2::coin::value<T0>(&arg1) / 1000000000, arg4, arg6, 0x2::object::uid_to_address(&arg0.id));
        };
        sell_internal<T0>(arg0, arg1, arg5, arg7);
    }

    fun sell_internal<T0>(arg0: &mut Curve<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::fee_collector::FeeCollector, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v5 > 0) {
            0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::fee_collector::collect_and_distribute_fees(arg2, 0x2::coin::from_balance<0x2::sui::SUI>(v6, arg3), arg0.creator_address, arg3);
        } else {
    ...
    public entry fun set_signature_requirement<T0>(arg0: &mut Curve<T0>, arg1: bool, arg2: vector<u8>, arg3: &0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::admin::DropkitAdminCap, arg4: &mut 0x2::tx_context::TxContext) {
        0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::set_signature_requirement(&mut arg0.signature_config, arg1, arg2, arg3);
    }
    ...
    public entry fun update_backend_public_key<T0>(arg0: &mut Curve<T0>, arg1: vector<u8>, arg2: &0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::admin::DropkitAdminCap) {
        0x2cdccf27f67f76c0dc9579b0402e5e298f6e75c91fc72d16b771c308dd8c67cd::signature_verifier::update_backend_public_key(&mut arg0.signature_config, arg1, arg2);
    }
