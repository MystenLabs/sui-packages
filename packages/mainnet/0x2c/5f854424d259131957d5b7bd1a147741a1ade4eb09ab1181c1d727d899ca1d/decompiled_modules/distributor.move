module 0xa609c916c2c64226ee928aa55449575daf21caa95afd9a1ed10f4e237d6faaf9::distributor {
    ...
    public(friend) fun deposit<T0>(arg0: &mut Distributor, arg1: 0x2::balance::Balance<T0>) {
        ...
        assert!(0x2::vec_map::length<0x1::type_name::TypeName, u64>(&v0.entries) > 0, 13906834917372723201);
    ...
    public(friend) fun merge_to_target_balances<T0>(arg0: &mut Distributor, arg1: 0x2::balance::Balance<T0>, arg2: u8) {
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.target_balances, 0x1::type_name::with_defining_ids<T0>())) {
            0x2::balance::join<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.target_balances, 0x1::type_name::with_defining_ids<T0>()), arg1);
        } else {
            0x2::bag::add<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.target_balances, 0x1::type_name::with_defining_ids<T0>(), arg1);
        };
    ...
    public(friend) fun take_source_for_swap<T0, T1>(arg0: &mut Distributor, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.source_balances, 0x1::type_name::with_defining_ids<T0>()), 13906835080581611523);
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        ...
        let v5 = v4;
        assert!(0x2::balance::value<T0>(&v5) >= arg1, 13906835097761611781);
    ...
    public(friend) fun withdraw_source<T0>(arg0: &mut Distributor, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.source_balances, 0x1::type_name::with_defining_ids<T0>()), 13906835248085336067);
    ...
    public(friend) fun withdraw_target<T0>(arg0: &mut Distributor, arg1: u64) : 0x2::balance::Balance<T0> {
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.target_balances, 0x1::type_name::with_defining_ids<T0>()), 13906835179365859331);
