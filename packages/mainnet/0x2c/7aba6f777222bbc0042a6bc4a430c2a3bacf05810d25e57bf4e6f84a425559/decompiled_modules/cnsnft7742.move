module 0x2c7aba6f777222bbc0042a6bc4a430c2a3bacf05810d25e57bf4e6f84a425559::cnsnft7742 {
    struct CNSNFT7742 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7742, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4225"));
        let v4 = 0x2::package::claim<CNSNFT7742>(arg0, arg1);
