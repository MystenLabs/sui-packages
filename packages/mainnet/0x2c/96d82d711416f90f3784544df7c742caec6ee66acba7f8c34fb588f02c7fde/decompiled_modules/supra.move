module 0x2c96d82d711416f90f3784544df7c742caec6ee66acba7f8c34fb588f02c7fde::supra {
    ...
    fun init(arg0: SUPRA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUPRA>(arg0, 9, b"li.fi", b"li.fi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
