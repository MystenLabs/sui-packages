module 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::book {
    ...
    public(friend) fun get_level2_range_and_ticks(arg0: &Book, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64) : (vector<u64>, vector<u64>) {
        ...
        let v9 = v8;
        let v10 = 0;
        while (!0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::slice_is_null(&v7) && arg3 > 0) {
            ...
            if (arg5 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::expire_timestamp(v11)) {
                let (_, v13, _) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::utils::decode_order_id(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::order_id(v11));
                ...
                if (v9 != 0) {
                    let v15 = v10 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::quantity(v11);
                    v10 = v15 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::filled_quantity(v11);
                };
            };
            let (v16, v17) = if (arg4) {
    ...
    public(friend) fun get_quantity_out(arg0: &Book, arg1: u64, arg2: u64, arg3: u64, arg4: 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::deep_price::OrderDeepPrice, arg5: u64, arg6: u64) : (u64, u64, u64) {
        ...
        let v9 = v8;
        let v10 = v7;
        while (!0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::slice_is_null(&v10) && v5 > 0) {
            let v11 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::slice_borrow<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::borrow_slice<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v6, v10), v9);
            let v12 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::price(v11);
            if (arg6 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::expire_timestamp(v11)) {
                let v13 = if (v2) {
                    let v14 = 0x1::u64::min(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::div(v5, v12), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::quantity(v11) - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::filled_quantity(v11));
                    let v15 = v14 - v14 % arg5;
                    v3 = v3 + v15;
                    v5 = v5 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v15, v12);
                    v15
                } else {
                    let v16 = 0x1::u64::min(v5, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::quantity(v11) - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::filled_quantity(v11));
                    let v17 = v16 - v16 % arg5;
                    v3 = v3 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v17, v12);
                    v5 = v5 - v17;
                    v17
                };
                if (v13 == 0) {
            ...
            let (v18, v19) = if (v2) {
                let (v20, v21) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::next_slice<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v6, v10, v9);
                (v21, v20)
            } else {
                let (v22, v23) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::prev_slice<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v6, v10, v9);
                (v23, v22)
            };
            v9 = v18;
            v10 = v19;
        ...
        let v24 = if (v2) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::deep_price::deep_quantity(&arg4, v3, arg2 - v5)
        } else {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::deep_price::deep_quantity(&arg4, arg1 - v5, v3)
        };
        let (v25, v26) = if (v2) {
            (v3, v5)
        } else {
        ...
        (v25, v26, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(arg3, v24))
    }
    ...
    fun match_against_book(arg0: &mut Book, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::OrderInfo, arg2: u64) {
        ...
        let v4 = v3;
        let v5 = v2;
        while (!0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::slice_is_null(&v5) && 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::Fill>(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::fills_ref(arg1)) < 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_fills()) {
        ...
        let v8 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::fills_ref(arg1);
        let v9 = 0;
        while (v9 < 0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::Fill>(v8)) {
            let v10 = 0x1::vector::borrow<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::Fill>(v8, v9);
            if (0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::expired(v10) || 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::completed(v10)) {
                0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::remove<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v1, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::maker_order_id(v10));
            };
            v9 = v9 + 1;
        };
        if (0x1::vector::length<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::fill::Fill>(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::fills_ref(arg1)) == 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_fills()) {
