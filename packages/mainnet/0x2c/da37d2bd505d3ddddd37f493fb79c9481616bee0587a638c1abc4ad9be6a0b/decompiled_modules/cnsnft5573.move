module 0x2cda37d2bd505d3ddddd37f493fb79c9481616bee0587a638c1abc4ad9be6a0b::cnsnft5573 {
    struct CNSNFT5573 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5573, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7195"));
        let v4 = 0x2::package::claim<CNSNFT5573>(arg0, arg1);
