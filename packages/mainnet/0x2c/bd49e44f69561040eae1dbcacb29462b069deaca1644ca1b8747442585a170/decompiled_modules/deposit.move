module 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::deposit {
    ...
    public fun deposit<T0, T1, T2>(arg0: &mut 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, 0x1::option::Option<0x2::coin::Coin<T0>>, 0x1::option::Option<0x2::coin::Coin<T1>>) {
        0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::check_pool_compatibility<T0, T1, T2>(arg0, arg1);
        assert!(0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::seed_balance<T0, T1, T2>(arg0) > 0, 4);
        assert!(0x2::coin::value<T0>(&arg3) > 0, 2);
        assert!(0x2::coin::value<T1>(&arg4) > 0, 3);
        let (v0, v1) = 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::get_amount_by_liquidity<T0, T1, T2>(arg0, arg1, true);
        let v2 = !0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::compare_amounts(0x2::coin::value<T0>(&arg3), 0x2::coin::value<T1>(&arg4), v0, v1);
        let v3 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::position_borrow<T0, T1, T2>(arg0));
        let v4 = if (v2) {
            0x2::coin::value<T0>(&arg3)
        } else {
            0x2::coin::value<T1>(&arg4)
        };
        let v5 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::add_liquidity_fix_coin<T0, T1>(arg2, arg1, 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::position_borrow_mut<T0, T1, T2>(arg0), v4, v2, arg5);
        let (v6, v7, v8, v9) = take_lp_coins<T0, T1>(&v5, arg3, arg4, arg6);
        let v10 = v7;
        let v11 = v6;
        ...
        let v12 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::liquidity(0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::position_borrow<T0, T1, T2>(arg0));
        let v13 = 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::mint_vault_coin<T0, T1, T2>(arg0, v12 - v3, v3, arg6);
        emit_event(0x2::object::id<0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::Vault<T0, T1, T2>>(arg0), v3, v12, 0x2::coin::value<T2>(&v13), 0x2::coin::value<T0>(&v11), 0x2::coin::value<T1>(&v10));
        (v13, v8, v9)
    }

    public entry fun deposit_entry<T0, T1, T2>(arg0: &mut 0x2cbd49e44f69561040eae1dbcacb29462b069deaca1644ca1b8747442585a170::vault::Vault<T0, T1, T2>, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
