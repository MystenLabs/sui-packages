module 0x2c41c92170a2290e49acb54980e1a55fb0d3adddffbe06a1c856cdb9eed6d1f8::funding_vault {
    ...
    public fun borrow_deepbook_balance_manager_mut(arg0: &0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::Version, arg1: &mut Registry, arg2: u64, arg3: &0x2::tx_context::TxContext) : (&mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof) {
        ...
        let v2 = 0x2::dynamic_object_field::remove<0x1::string::String, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeCap>(&mut v1.id, 0x1::string::utf8(b"deepbook_trade_cap"));
        let v3 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager>(&mut v1.id, 0x1::string::utf8(b"deepbook_balance_manager"));
        assert!(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::owner(v3) != 0x2::tx_context::sender(arg3), invalid_trader());
        0x2::dynamic_object_field::add<0x1::string::String, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeCap>(&mut v1.id, 0x1::string::utf8(b"deepbook_trade_cap"), v2);
        (0x2::dynamic_object_field::borrow_mut<0x1::string::String, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager>(&mut v1.id, 0x1::string::utf8(b"deepbook_balance_manager")), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_trader(v3, &v2, arg3))
    }
    ...
    entry fun delegate_raise_fund<T0>(arg0: &0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::Version, arg1: &mut Registry, arg2: u64, arg3: address, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::verify_witness<VERSION>(arg0, v0);
        0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::verify_version(arg0, 1);
        raise_fund_<T0>(arg0, arg1, arg2, arg3, arg4, arg5);
    }
    ...
    public fun raise_fund<T0>(arg0: &0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::Version, arg1: &mut Registry, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::verify_witness<VERSION>(arg0, v0);
        0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::verify_version(arg0, 1);
        raise_fund_<T0>(arg0, arg1, arg2, 0x2::tx_context::sender(arg5), arg3, arg4);
    }

    fun raise_fund_<T0>(arg0: &0x59f5b7dc478e27bef51537c436bec95003db5c1a909f36c5e4b2df1c2eae5b91::version::Version, arg1: &mut Registry, arg2: u64, arg3: address, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock) {
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::dynamic_object_field::borrow_mut<u64, Vault>(&mut arg1.vault_registry, arg2);
        ...
        assert!(0x2::clock::timestamp_ms(arg5) >= *0x1::vector::borrow<u64>(&v1.config, 0), not_yet_activated());
        assert!(0x2::clock::timestamp_ms(arg5) < *0x1::vector::borrow<u64>(&v1.config, 1), expired());
        ...
        if (!0x2::table::contains<address, vector<Fund>>(&v1.fund, arg3)) {
            0x2::table::add<address, vector<Fund>>(&mut v1.fund, arg3, 0x1::vector::empty<Fund>());
        };
        let v6 = Fund{
            balance : v2,
            ts_ms   : 0x2::clock::timestamp_ms(arg5),
        };
        0x1::vector::push_back<Fund>(0x2::table::borrow_mut<address, vector<Fund>>(&mut v1.fund, arg3), v6);
        *0x1::vector::borrow_mut<u64>(&mut v1.info, 1) = *0x1::vector::borrow<u64>(&v1.info, 1) + v2;
        0x2::balance::join<T0>(0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, v0), 0x2::coin::into_balance<T0>(arg4));
    }
