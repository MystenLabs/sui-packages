module 0x2ce32b43190988f4b2d0129aa748c2ab86405a390fb37ac366ff41a6b19ad43a::tvp {
    struct TVP has drop {
        dummy_field: bool,
    }

    fun init(arg0: TVP, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/ynP_mUFiw1iuWVkN2SCP-0fgfArToW4WGiXvmpEYqFU";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/ynP_mUFiw1iuWVkN2SCP-0fgfArToW4WGiXvmpEYqFU"))
        };
