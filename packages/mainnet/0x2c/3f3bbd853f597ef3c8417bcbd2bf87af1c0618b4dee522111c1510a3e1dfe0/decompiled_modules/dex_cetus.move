module 0x2c3f3bbd853f597ef3c8417bcbd2bf87af1c0618b4dee522111c1510a3e1dfe0::dex_cetus {
    ...
    public fun create_pool<T0, T1>(arg0: u128, arg1: u32, arg2: u32, arg3: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        Pool<T0, T1>{
            id                 : 0x2::object::new(arg3),
            sqrt_price_current : arg0,
            liquidity          : 0,
            tick_current       : 0,
            fee_rate           : arg1,
            protocol_fee_rate  : 0,
