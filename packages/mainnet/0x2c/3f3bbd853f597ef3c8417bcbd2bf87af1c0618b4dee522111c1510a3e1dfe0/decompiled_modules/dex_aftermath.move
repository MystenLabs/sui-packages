module 0x2c3f3bbd853f597ef3c8417bcbd2bf87af1c0618b4dee522111c1510a3e1dfe0::dex_aftermath {
    ...
    public fun create_pool<T0, T1>(arg0: u64, arg1: u64, arg2: u64, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : Pool<T0, T1> {
        Pool<T0, T1>{
            id                   : 0x2::object::new(arg4),
            balance_a            : 0x2::balance::zero<T0>(),
            balance_b            : 0x2::balance::zero<T1>(),
            amplification_factor : arg0,
            swap_fee             : arg1,
            admin_fee            : arg2,
