module 0x2c0861b8743721dda155d2eb45242f1b8011c283b92609c1855f27c30aeb1871::vault {
    ...
    public fun add_objects<T0: store + key>(arg0: &mut Vault, arg1: u64, arg2: vector<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 < arg1 * arg0.max_receivers, 9223372990337908743);
    ...
    fun assert_sender_is_vault_creator(arg0: &0x2::tx_context::TxContext, arg1: &Vault) {
        assert!(sender_is_vault_creator(arg0, arg1), 9223372517891244035);
    }

    fun assert_sender_is_vault_manager(arg0: &0x2::tx_context::TxContext, arg1: &Vault) {
        assert!(sender_is_vault_manager(arg0, arg1), 9223372565136015365);
    }

    fun assert_vault_manager_is_the_same(arg0: &VaultManager, arg1: &Vault) {
        assert!(arg0.manager == arg1.manager, 9223372608085688325);
    }
    ...
    public fun destroy_empty_vault(arg0: Vault, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v3;
        let v7 = v0;
        assert!(0x2::object_bag::length(&v6) == 0, 9223373677532282881);
        assert!(v1 == v2, 9223373694712152065);
