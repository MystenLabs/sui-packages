module 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::position {
    ...
    public(friend) fun order_filled<T0>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: TradingOrder, arg2: 0x1::option::Option<Position>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: bool, arg10: u64, arg11: u64, arg12: &0x2::clock::Clock, arg13: &mut 0x2::tx_context::TxContext) : (Position, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64, bool, u64, u64) {
        ...
        let (v22, v23, v24, v25) = if (0x1::option::is_some<Position>(&arg2)) {
            ...
            let v36 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v31, v26.size_decimal, arg6, arg7), v26.collateral_token_decimal, arg4, arg5);
            let v37 = if (v35 >= v36) {
                0
            } else {
                v36 - v35
            ...
            let v38 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v12, v13, arg6, arg7), v6, arg4, arg5);
            let v39 = if (v21 >= v38) {
                0
            } else {
                v38 - v21
        ...
        let v42 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(v25, v41.collateral_token_decimal, arg4, arg5);
        ...
        let v48 = OrderFilledEvent{
            ...
            realized_fee_in_usd    : 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v19 + v46, v41.collateral_token_decimal, arg4, arg5),
            realized_amount        : v42,
    ...
    public(friend) fun order_filled_with_bid_receipts_collateral<T0, T1>(arg0: &0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::admin::Version, arg1: &mut 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool::LiquidityPool, arg2: &0x321848bf1ae327a9e022ccb3701940191e02fa193ab160d9c0e49cd3c003de3a::typus_dov_single::Registry, arg3: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg4: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg5: TradingOrder, arg6: 0x1::option::Option<Position>, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: bool, arg14: u64, arg15: u64, arg16: u64, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) : (Position, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64) {
        ...
        let (v25, v26, v27, v28) = if (0x1::option::is_some<Position>(&arg6)) {
            ...
            assert!(0x2::dynamic_field::remove<0x1::string::String, 0x1::type_name::TypeName>(&mut v17, 0x1::string::utf8(b"deposit_token")) == v29.collateral_token, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::deposit_token_mismatched());
            assert!(0x2::dynamic_field::remove<0x1::string::String, u64>(&mut v17, 0x1::string::utf8(b"portfolio_index")) == 0x1::option::borrow<OptionCollateralInfo>(&v29.option_collateral_info).index, 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::error::portfolio_index_mismatched());
            ...
            let v38 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v34, v29.size_decimal, arg10, arg11), v29.collateral_token_decimal, arg8, arg9);
            let v39 = if (v36 >= v38) {
                0
            } else {
                v38 - v36
            ...
            let v40 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v12, v13, arg10, arg11), v6, arg8, arg9);
            let v41 = if (v22 >= v40) {
                0
            } else {
                v40 - v22
        ...
        let v47 = v25;
        let v48 = 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::usd_to_amount(v28, v47.collateral_token_decimal, arg8, arg9);
        if (v26 && !v27) {
            v47.unrealized_loss = v47.unrealized_loss + v48;
        };
        let v49 = if (v26 && v27) {
            0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::lp_pool::request_collateral<T0>(arg1, v48, arg8, arg9)
        } else {
            0x2::balance::zero<T0>()
        };
        let v50 = v49;
        ...
        let v65 = OrderFilledEvent{
            ...
            realized_fee_in_usd    : 0xe27969a70f93034de9ce16e6ad661b480324574e68d15a64b513fd90eb2423e5::math::amount_to_usd(v57 + v60, v47.collateral_token_decimal, arg8, arg9),
            realized_amount        : v48,
