module 0xe44758ba7c6a260c8fa9e2aad4a6ec4a01dfae7378543aef651efc412b752853::blackcoin {
    ...
    fun init(arg0: BLACKCOIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BLACKCOIN>(arg0, 9, b"BlackCoin", b"Black", b"A Sui Network Special Test Coin", 0x1::option::some<0x2::url::Url>(0xe44758ba7c6a260c8fa9e2aad4a6ec4a01dfae7378543aef651efc412b752853::icon::get_icon_url()), arg1);
