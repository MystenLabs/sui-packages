module 0xe446f91b4975ed2ebba0a8bbc5bd796fb07e084b50e3ae2ba73dcc673038a1bd::reward1564 {
    struct REWARD1564 has drop {
        dummy_field: bool,
    }

    struct TICKET_1564 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1564(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1564>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1564>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1564, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1564>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1564>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1564>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1564>>(v5, 0x2::tx_context::sender(arg1));
    }
