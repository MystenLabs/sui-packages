module 0xe4340b90442b0719959d4ce998748ac61256c8228d7245c75550a50e90ce756c::reward3125 {
    struct REWARD3125 has drop {
        dummy_field: bool,
    }

    struct TICKET_3125 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3125(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3125>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3125>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3125, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3125>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3125>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3125>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3125>>(v5, 0x2::tx_context::sender(arg1));
    }
