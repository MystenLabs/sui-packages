module 0xe4793f38788baadbab12591cc0d1c6ac00fa517eb38dd4e76d064fc7953c4a44::grid_on_chain {
    ...
    fun init(arg0: GRID_ON_CHAIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<GridOnChain>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"GRIDY GRID"));
    ...
    public fun mint(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<GridOnChain>(v0, 0x2::tx_context::sender(arg2));
    }
