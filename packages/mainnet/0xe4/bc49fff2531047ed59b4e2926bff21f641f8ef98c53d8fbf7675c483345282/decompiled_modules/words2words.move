module 0xe4bc49fff2531047ed59b4e2926bff21f641f8ef98c53d8fbf7675c483345282::words2words {
            ...
            if (v1 < 0x1::vector::length<vector<u8>>(&v2)) {
                ...
                if (0x2::dynamic_field::exists_<0x1::string::String>(&arg2.id, 0x1::string::utf8(v4))) {
                    ...
                    while (v9 < *v7) {
                        ...
                        internal_mint_and_transfer_word(arg0, *0x1::vector::borrow<0x1::string::String>(&v8, v10), 0x1::string::utf8(*0x1::vector::borrow<vector<u8>>(&v5, v1)), v0.background, 0x1::string::utf8(b"Basic"), arg4);
    ...
    fun random_index(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0xe4bc49fff2531047ed59b4e2926bff21f641f8ef98c53d8fbf7675c483345282::pseudorandom::rand_with_ctx(arg1);
        0xe4bc49fff2531047ed59b4e2926bff21f641f8ef98c53d8fbf7675c483345282::pseudorandom::select_u64(arg0, &v0)
    }
