module 0xe46922d69b4bc54279265a47957fa200ee14dcb9461f04a3b58ad2f963c0d8c7::cnsnft5590 {
    struct CNSNFT5590 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5590, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5590>(arg0, arg1);
