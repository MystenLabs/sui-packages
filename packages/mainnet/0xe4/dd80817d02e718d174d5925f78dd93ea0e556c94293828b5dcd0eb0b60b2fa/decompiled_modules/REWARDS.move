module 0xe4dd80817d02e718d174d5925f78dd93ea0e556c94293828b5dcd0eb0b60b2fa::REWARDS {
    ...
    public entry fun pool_reward<T0>(arg0: &mut Pool<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 > 0, 0);
        assert!(0x2::balance::value<T0>(&arg0.coin_c_reserve) >= arg1, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.coin_c_reserve, arg1), arg2), 0x2::tx_context::sender(arg2));
    }
