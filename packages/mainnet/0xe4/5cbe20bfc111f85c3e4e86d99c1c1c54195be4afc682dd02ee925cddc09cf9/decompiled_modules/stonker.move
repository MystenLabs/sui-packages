module 0xe45cbe20bfc111f85c3e4e86d99c1c1c54195be4afc682dd02ee925cddc09cf9::stonker {
    ...
    struct DummyTradeEvent has copy, drop {
        is_buy: bool,
        price: u64,
        quantity: u64,
    }
    ...
    fun input_signal_internal(arg0: &mut Stonker, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::BalanceManager, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<0x2::sui::SUI, 0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg3: &0x2::clock::Clock, arg4: u64, arg5: bool, arg6: bool, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 && v7 + v8 < arg4) {
            ...
            if (convert_to_quote_at_price(arg0, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<0x2::sui::SUI>(arg1) + v10, v7) > 10000000) {
            ...
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            let v16 = DummyTradeEvent{
                is_buy   : true,
                price    : v7,
                quantity : arg0.parameters.order_size_base,
            };
            0x2::event::emit<DummyTradeEvent>(v16);
            return
        };
        if (!arg5 && arg4 + v8 < v6) {
            ...
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::generate_proof_as_owner(arg1, arg7);
            let v21 = DummyTradeEvent{
                is_buy   : false,
                price    : v6,
                quantity : arg0.parameters.order_size_base,
            };
            0x2::event::emit<DummyTradeEvent>(v21);
            return
        };
    }
