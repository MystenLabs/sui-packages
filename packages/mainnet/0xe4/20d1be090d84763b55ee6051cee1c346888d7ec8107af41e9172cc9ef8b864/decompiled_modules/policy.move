module 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::policy {
    ...
    fun assert_agent_gates(arg0: &Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault, arg2: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == arg0.agent, 13906836248812584961);
        assert!(!arg0.suspended, 13906836253107683331);
        assert!(0x2::object::id<0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault>(arg1) == arg0.vault_id, 13906836257402781701);
    }
    ...
    fun assert_binding(arg0: &Policy, arg1: &0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::OwnerCap) {
        assert!(0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::owner_cap_vault_id(arg1) == arg0.vault_id, 13906836472151277575);
    }
    ...
    fun assert_within_bps(arg0: u128, arg1: u128, arg2: u64) {
        ...
        assert!(v2 * 10000 <= v0 * (arg2 as u256), 13906836420611932171);
    }
    ...
    public fun spend_balance_from_vault<T0>(arg0: &Policy, arg1: &mut 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert_agent_gates(arg0, arg1, arg4);
        let v0 = CapKey{dummy_field: false};
        0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::spend<T0>(arg1, 0x2::dynamic_object_field::borrow<CapKey, 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::SpenderCap>(&arg0.id, v0), arg2, arg3, arg4)
    }
    ...
    public fun swap_and_route<T0, T1>(arg0: &mut Policy, arg1: &mut 0x2441fb74d7684f43019fdabf27d6de24dc8e42826ddd86ba07bc21aded80c014::spend_vault::Vault, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: bool, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::contains<0x2::object::ID>(&arg0.allowed_pools, &v0), 13906835557323374601);
