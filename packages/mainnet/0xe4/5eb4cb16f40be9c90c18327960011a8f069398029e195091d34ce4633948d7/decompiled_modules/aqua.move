module 0xe45eb4cb16f40be9c90c18327960011a8f069398029e195091d34ce4633948d7::aqua {
    ...
    public fun borrow_treasury_cap<T0>(arg0: &AdminCap, arg1: &Vault<T0>) : &0x2::coin::TreasuryCap<AQUA> {
        &arg1.treasury_cap
    }
    ...
    public fun request_withdrawal<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<AQUA>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (arg0.total_shares == 0) {
            ...
            (((v1 as u128) * ((0x2::balance::value<T0>(&arg0.idle_balance) + arg0.total_invested) as u128) / (arg0.total_shares as u128)) as u64)
        };
        assert!(v2 >= arg2, 5);
        ...
        let v5 = WithdrawalRequestedEvent{
            request_id : 0x2::object::id<WithdrawalRequest>(&v4),
            user       : v0,
            shares     : v1,
            usdc_owed  : v2,
            min_usdc   : arg2,
        };
        0x2::event::emit<WithdrawalRequestedEvent>(v5);
        0x2::transfer::share_object<WithdrawalRequest>(v4);
    }
