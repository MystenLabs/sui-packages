module 0xe430d737ab29e6e449d4dd675c9d2dd561d85f950062d491aa4acfa7c8192069::prediction {
    ...
    struct Round has store {
        ...
        upAmount: u256,
        downAmount: u256,
        upaddress: 0x2::table::Table<address, u256>,
        downaddress: 0x2::table::Table<address, u256>,
        upamount: u256,
        downamount: u256,
        oracleCalled: bool,
        upordown: bool,
    ...
    public entry fun betDown(arg0: &mut Rounds, arg1: &mut Epoch, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        v2.downAmount = v2.downAmount + (v1 as u256);
        v2.downamount = v2.downamount + 1;
        0x2::table::add<address, u256>(&mut v2.downaddress, 0x2::tx_context::sender(arg4), (v1 as u256));
    }
    ...
    public entry fun betUp(arg0: &mut Rounds, arg1: &mut Epoch, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::vector::borrow_mut<Round>(&mut arg0.rounds, arg3);
        0x2::balance::join<0x2::sui::SUI>(&mut v2.totalAmount, 0x2::coin::into_balance<0x2::sui::SUI>(arg2));
        v2.upAmount = v2.upAmount + (v1 as u256);
        v2.upamount = v2.upamount + 1;
        0x2::table::add<address, u256>(&mut v2.upaddress, 0x2::tx_context::sender(arg4), (v1 as u256));
    }
    ...
    public entry fun claim(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.upordown) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v1, ((*0x2::table::borrow<address, u256>(&v0.upaddress, 0x2::tx_context::sender(arg3)) * 10000000000 * (0x2::balance::value<0x2::sui::SUI>(v1) as u256) / v0.upamount / 10000000000) as u64), arg3), 0x2::tx_context::sender(arg3));
            if (0x2::table::contains<address, u256>(&v0.upaddress, 0x2::tx_context::sender(arg3))) {
                0x2::table::remove<address, u256>(&mut v0.upaddress, 0x2::tx_context::sender(arg3));
            };
        } else {
            let v2 = &mut v0.totalAmount;
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(v2, ((*0x2::table::borrow<address, u256>(&v0.downaddress, 0x2::tx_context::sender(arg3)) * 10000000000 * (0x2::balance::value<0x2::sui::SUI>(v2) as u256) / v0.downamount / 10000000000) as u64), arg3), 0x2::tx_context::sender(arg3));
            if (0x2::table::contains<address, u256>(&v0.downaddress, 0x2::tx_context::sender(arg3))) {
                0x2::table::remove<address, u256>(&mut v0.downaddress, 0x2::tx_context::sender(arg3));
            };
        };
    }
    ...
    public entry fun executeRound(arg0: &mut Rounds, arg1: u64, arg2: &mut Epoch, arg3: &0x5d8fbbf6f908a4af8c6d072669a462d53e03eb3c1d863bd0359dc818c69ea706::SupraSValueFeed::OracleHolder, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = Round{
            ...
            upAmount       : 0,
            downAmount     : 0,
            upaddress      : 0x2::table::new<address, u256>(arg5),
            downaddress    : 0x2::table::new<address, u256>(arg5),
            upamount       : 0,
            downamount     : 0,
            oracleCalled   : false,
            upordown       : false,
    ...
    public entry fun startplay(arg0: &mut Rounds, arg1: &mut Epoch, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = Round{
            ...
            upAmount       : 0,
            downAmount     : 0,
            upaddress      : 0x2::table::new<address, u256>(arg3),
            downaddress    : 0x2::table::new<address, u256>(arg3),
            upamount       : 0,
            downamount     : 0,
            oracleCalled   : false,
            upordown       : false,
