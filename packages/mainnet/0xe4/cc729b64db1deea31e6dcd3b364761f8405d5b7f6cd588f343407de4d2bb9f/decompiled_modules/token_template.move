module 0xe4cc729b64db1deea31e6dcd3b364761f8405d5b7f6cd588f343407de4d2bb9f::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"T928692", b"Test 928692", b"Integration test token 2025-10-28T01:28:48.692Z", 0x1::option::none<0x2::url::Url>(), arg1);
