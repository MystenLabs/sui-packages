module 0xe42f9188504db74ddfe83f5dd855bf6e13ba6c4a5bf77441dc6006ee5bf83a6a::reward8193 {
    struct REWARD8193 has drop {
        dummy_field: bool,
    }

    struct TICKET_8193 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8193(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_8193>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8193, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8193>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8193>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8193>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8193>>(v5, 0x2::tx_context::sender(arg1));
    }
