module 0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::hybrid_auctionhouse {
    struct MixedOfferStore has key {
        id: 0x2::object::UID,
    ...
    public fun accept_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: &mut 0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &0x2::transfer_policy::TransferPolicy<T1>, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T1>) {
        ...
        assert!(0x2::kiosk::has_access(arg6, arg7), 12);
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg9) >= v6, 9);
        0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg9));
        let NftEscrow {
            id  : v8,
            nft : v9,
        ...
        let (v10, v11) = 0x2::kiosk::purchase_with_cap<T1>(arg2, 0x2::kiosk::list_with_purchase_cap<T1>(arg2, arg3, arg4, 0, arg10), 0x2::coin::zero<0x2::sui::SUI>(arg10));
        0x2::kiosk::lock<T1>(arg6, arg7, arg8, v10);
    ...
    public entry fun accept_direct_for_kiosk_offer_create_kiosk<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: &mut 0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: 0x2::object::ID, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: &mut 0x2::transfer_policy::TransferPolicy<T1>, arg9: 0x2::coin::Coin<0x2::sui::SUI>, arg10: 0x2::coin::Coin<0x2::sui::SUI>, arg11: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = accept_direct_for_kiosk_offer<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg11);
        let v2 = v1;
        if (0x2::coin::value<0x2::sui::SUI>(&arg10) > 0) {
            0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::pay<T1>(arg8, &mut v2, arg10);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg10);
        };
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T1>(&mut v2, arg6);
        let (_, _, _) = 0x2::transfer_policy::confirm_request<T1>(arg8, v2);
        let (v6, v7) = 0x2::kiosk::new(arg11);
        let v8 = v6;
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v8);
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::transfer_to_sender(0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::new(&mut v8, v7, arg11), arg11);
        0x2::transfer::public_transfer<T0>(v0, 0x2::tx_context::sender(arg11));
    }
    ...
    public fun accept_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: &mut 0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: 0x2::object::ID, arg6: T1, arg7: &0x2::transfer_policy::TransferPolicy<T0>, arg8: 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg8));
    ...
    public fun cancel_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: 0x2::object::ID, arg2: &mut 0x2::tx_context::TxContext) : T0 {
    ...
    public fun cancel_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun create_and_share_mixed_offer_store(arg0: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<MixedOfferStore>(create_mixed_offer_store(arg0, arg1));
    }

    public fun create_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: T0, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_mixed_offer_store(arg0: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : MixedOfferStore {
        MixedOfferStore{
            id            : 0x2::object::new(arg1),
            marketplace   : 0x2::object::id<0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse>(arg0),
            orphaned_caps : 0x2::object::new(arg1),
        }
    }

    public fun direct_for_kiosk_offer_exists<T0: store + key, T1: store + key>(arg0: &MixedOfferStore, arg1: 0x2::object::ID) : bool {
        0x2::dynamic_object_field::exists_with_type<0x2::object::ID, DirectForKioskOffer<T0, T1>>(&arg0.id, arg1)
    }

    public entry fun emergency_reset_direct_for_kiosk_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 11);
    ...
    public entry fun emergency_reset_kiosk_for_direct_offer<T0: store + key, T1: store + key>(arg0: &mut MixedOfferStore, arg1: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 11);
    ...
    public fun get_direct_for_kiosk_offer_fee<T0: store + key, T1: store + key>(arg0: &MixedOfferStore, arg1: 0x2::object::ID) : u64 {
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, DirectForKioskOffer<T0, T1>>(&arg0.id, arg1), 6);
        0x2::dynamic_object_field::borrow<0x2::object::ID, DirectForKioskOffer<T0, T1>>(&arg0.id, arg1).fee
    }

    public fun get_kiosk_for_direct_offer_fee<T0: store + key, T1: store + key>(arg0: &MixedOfferStore, arg1: 0x2::object::ID) : u64 {
    ...
    public fun kiosk_for_direct_offer_exists<T0: store + key, T1: store + key>(arg0: &MixedOfferStore, arg1: 0x2::object::ID) : bool {
        0x2::dynamic_object_field::exists_with_type<0x2::object::ID, KioskForDirectOffer<T0, T1>>(&arg0.id, arg1)
    }

    public entry fun recover_orphaned_cap<T0: store + key>(arg0: &mut MixedOfferStore, arg1: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::is_admin(arg1, v0) || 0x2::kiosk::owner(arg2) == v0, 1);
    ...
    public fun store_orphaned_cap<T0: store + key>(arg0: &mut MixedOfferStore, arg1: 0x2::kiosk::PurchaseCap<T0>, arg2: 0x2::object::ID, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
