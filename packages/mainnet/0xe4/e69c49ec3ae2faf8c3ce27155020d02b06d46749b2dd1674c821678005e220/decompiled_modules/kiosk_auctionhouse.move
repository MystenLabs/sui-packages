module 0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::kiosk_auctionhouse {
    struct KioskOfferStore has key {
        id: 0x2::object::UID,
    ...
    public fun accept_offer<T0: store + key, T1: store + key>(arg0: &mut KioskOfferStore, arg1: &mut 0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::kiosk::Kiosk, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: 0x2::object::ID, arg9: &0x2::transfer_policy::TransferPolicy<T0>, arg10: 0x2::coin::Coin<0x2::sui::SUI>, arg11: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        ...
        0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg10));
    ...
    public fun accept_offer_exists<T0: store + key>(arg0: &KioskOfferStore, arg1: 0x2::object::ID) : bool {
        0x2::dynamic_object_field::exists_with_type<0x2::object::ID, AcceptOffer<T0>>(&arg0.id, arg1)
    }

    public fun cancel_offer<T0: store + key, T1: store + key>(arg0: &mut KioskOfferStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun claim_swap_creator_nft<T0: store + key>(arg0: &mut KioskOfferStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
    ...
    public entry fun claim_swap_creator_nft_create_kiosk<T0: store + key>(arg0: &mut KioskOfferStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun complete_atomic_swap<T0: store + key, T1: store + key>(arg0: &mut KioskOfferStore, arg1: &mut 0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::kiosk::Kiosk, arg6: 0x2::object::ID, arg7: &mut 0x2::kiosk::Kiosk, arg8: &0x2::kiosk::KioskOwnerCap, arg9: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg10: &mut 0x2::transfer_policy::TransferPolicy<T1>, arg11: 0x2::coin::Coin<0x2::sui::SUI>, arg12: 0x2::coin::Coin<0x2::sui::SUI>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::add_fee(arg1, 0x2::coin::into_balance<0x2::sui::SUI>(arg11));
        0x2::object::delete(v0);
    ...
    public entry fun create_and_share_kiosk_offer_store(arg0: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<KioskOfferStore>(create_kiosk_offer_store(arg0, arg1));
    }

    public fun create_kiosk_offer_store(arg0: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg1: &mut 0x2::tx_context::TxContext) : KioskOfferStore {
        KioskOfferStore{
            id            : 0x2::object::new(arg1),
            auction_house : 0x2::object::id<0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse>(arg0),
            orphaned_caps : 0x2::object::new(arg1),
        }
    }

    public fun create_offer<T0: store + key, T1: store + key>(arg0: &mut KioskOfferStore, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: 0x2::object::ID, arg4: 0x2::object::ID, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun emergency_reset_accept_offer<T0: store + key>(arg0: &mut KioskOfferStore, arg1: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 8);
    ...
    public entry fun emergency_reset_offer<T0: store + key, T1: store + key>(arg0: &mut KioskOfferStore, arg1: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: 0x2::object::ID, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::is_admin(arg1, 0x2::tx_context::sender(arg3)), 8);
    ...
    public fun get_offer_fee<T0: store + key, T1: store + key>(arg0: &KioskOfferStore, arg1: 0x2::object::ID) : u64 {
    ...
    public fun offer_exists<T0: store + key, T1: store + key>(arg0: &KioskOfferStore, arg1: 0x2::object::ID) : bool {
        0x2::dynamic_object_field::exists_with_type<0x2::object::ID, SwapOffer<T0, T1>>(&arg0.id, arg1)
    }

    public entry fun recover_orphaned_cap<T0: store + key>(arg0: &mut KioskOfferStore, arg1: &0xe4e69c49ec3ae2faf8c3ce27155020d02b06d46749b2dd1674c821678005e220::auctionhouse::AuctionHouse, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun store_orphaned_cap<T0: store + key>(arg0: &mut KioskOfferStore, arg1: 0x2::kiosk::PurchaseCap<T0>, arg2: 0x2::object::ID, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) {
