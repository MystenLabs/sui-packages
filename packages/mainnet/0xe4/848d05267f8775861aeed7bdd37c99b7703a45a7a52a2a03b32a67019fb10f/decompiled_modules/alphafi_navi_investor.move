module 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::alphafi_navi_investor {
    ...
    public(friend) fun autocompound<T0>(arg0: &mut Investor<T0>, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::Distributor, arg2: &0x2::clock::Clock, arg3: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg6: u8, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = (((v1 as u128) * (arg0.performance_fee as u128) / 10000) as u64);
        let v3 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::unnormal_amount<T0>(arg5, (v1 as u64) - v2);
        let v4 = v3;
        let v5 = if (0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::unnormal_amount<T0>(arg5, v2) > 0) {
            withdraw_from_navi<T0>(arg0, arg2, arg3, arg4, arg5, arg6, v2, arg7, arg8, arg9, arg10)
        } else {
            0x2::balance::zero<T0>()
        };
        let v6 = v5;
        let v7 = 0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"is_autocompounding_on") && *0x2::dynamic_field::borrow<vector<u8>, bool>(&arg0.id, b"is_autocompounding_on") == false;
        if (!v7 && 0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::get<T0>())) {
            let v8 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.free_rewards, 0x1::type_name::get<T0>());
            if (0x2::balance::value<T0>(v8) > 0) {
                let v9 = 0x2::balance::withdraw_all<T0>(v8);
                0x2::balance::join<T0>(&mut v6, 0x2::balance::split<T0>(&mut v9, (((0x2::balance::value<T0>(&v9) as u128) * (arg0.performance_fee as u128) / 10000) as u64)));
                v4 = v3 + 0x2::balance::value<T0>(&v9);
                if (0x2::balance::value<T0>(&v9) > 0) {
                    deposit<T0>(arg0, arg2, arg4, arg5, arg6, 0x2::coin::from_balance<T0>(v9, arg10), arg7, arg8);
                } else {
        ...
        let v10 = AutoCompoundingEvent{
            ...
            compound_amount : v4,
            total_amount    : get_total_invested<T0>(arg0, arg4, arg6, arg2),
            fee_collected   : 0x2::balance::value<T0>(&v6),
            location        : 20,
        };
        0x2::event::emit<AutoCompoundingEvent>(v10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v6, arg10), 0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::get_fee_wallet_address(arg1));
    }
    ...
    public fun set_autocompounding_on<T0>(arg0: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::distributor::AdminCap, arg1: &0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::version::Version, arg2: &mut Investor<T0>, arg3: bool) {
        0x9bbd650b8442abb082c20f3bc95a9434a8d47b4bef98b0832dab57c1a8ba7123::version::assert_current_version(arg1);
        if (0x2::dynamic_field::exists_<vector<u8>>(&arg2.id, b"is_autocompounding_on")) {
            *0x2::dynamic_field::borrow_mut<vector<u8>, bool>(&mut arg2.id, b"is_autocompounding_on") = arg3;
        } else {
            0x2::dynamic_field::add<vector<u8>, bool>(&mut arg2.id, b"is_autocompounding_on", arg3);
        };
    }
    ...
    public(friend) fun withdraw_from_navi<T0>(arg0: &mut Investor<T0>, arg1: &0x2::clock::Clock, arg2: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: u8, arg6: u64, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        let v0 = 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::withdraw_with_account_cap_v2<T0>(arg1, arg2, arg3, arg4, arg5, 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::unnormal_amount<T0>(arg4, arg6), arg8, arg7, &arg0.navi_acc_cap, arg9, arg10);
