module 0xe44bfa8b8942a47ad9f40a3ec0cd1a34df11f8d1f4e71e882f75c6ba326c5ef3::vault {
    ...
    public fun withdraw(arg0: &mut DepositContract, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun withdraw_all(arg0: &AdminCap, arg1: &mut DepositContract, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg1.creator, 1);
        let v1 = 0x2::balance::value<0x2::sui::SUI>(&arg1.balance);
        assert!(v1 > 0, 4);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg1.balance, v1), arg2), v0);
    }
