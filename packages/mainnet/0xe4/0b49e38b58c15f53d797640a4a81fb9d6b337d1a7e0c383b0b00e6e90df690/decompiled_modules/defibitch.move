module 0xe40b49e38b58c15f53d797640a4a81fb9d6b337d1a7e0c383b0b00e6e90df690::defibitch {
    ...
    fun init(arg0: DEFIBITCH, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DEFIBITCH>(arg0, 9, b"defibitch", b"DEFIBITCH", b"defibitch testing bundler", 0x1::option::none<0x2::url::Url>(), arg1);
