module 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market {
    ...
    public(friend) fun remove_liquidity<T0>(arg0: &mut Market, arg1: 0x2::balance::Balance<XToken<T0>>, arg2: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::oracle::Oracle, arg3: bool, arg4: &0x2::clock::Clock) : LiquidityPromise<T0> {
        if (arg3) {
            refresh_with_price(arg0, arg2, arg4);
        } else {
            refresh(arg0, arg4);
    ...
    public(friend) fun set_sui_staking_enabled(arg0: &mut Market, arg1: address, arg2: bool, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2) {
            ...
            if (0x2::dynamic_field::exists_<SuiStakingEnabledKey>(&arg0.id, v2)) {
                ...
                0x2::balance::join<0x2::sui::SUI>(&mut 0x2::dynamic_field::borrow_mut<TreasuryKey, Treasury<0x2::sui::SUI>>(&mut arg0.id, v4).balance, 0x2::coin::into_balance<0x2::sui::SUI>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::delete_sui_staker(0x2::dynamic_field::remove<SuiStakingEnabledKey, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::SuiStaker>(&mut arg0.id, v3), arg3, arg4)));
            };
            let v5 = SuiStakingEnabledKey{dummy_field: false};
            0x2::dynamic_field::add<SuiStakingEnabledKey, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::SuiStaker>(&mut arg0.id, v5, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::init_staker(arg1, 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v1.balance, 0x2::balance::value<0x2::sui::SUI>(&v1.balance)), arg4), arg3, arg4));
        } else {
            assert!(arg0.config.staking_enabled == true, 35);
            arg0.config.staking_enabled = false;
            let v6 = SuiStakingEnabledKey{dummy_field: false};
            if (0x2::dynamic_field::exists_<SuiStakingEnabledKey>(&arg0.id, v6)) {
                let v7 = SuiStakingEnabledKey{dummy_field: false};
                let v8 = 0x2::dynamic_field::borrow_mut<SuiStakingEnabledKey, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::SuiStaker>(&mut arg0.id, v7);
                let v9 = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::remove_stake(v8, arg0.balance_holding, arg3, false, arg4);
                let v10 = 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::drain_sui_pool(v8, arg4);
                let v11 = TreasuryKey{dummy_field: false};
                let v12 = 0x2::dynamic_field::borrow_mut<TreasuryKey, Treasury<0x2::sui::SUI>>(&mut arg0.id, v11);
                0x2::balance::join<0x2::sui::SUI>(&mut v12.balance, 0x2::coin::into_balance<0x2::sui::SUI>(v9));
                0x2::balance::join<0x2::sui::SUI>(&mut v12.balance, 0x2::coin::into_balance<0x2::sui::SUI>(v10));
            };
        };
    }
