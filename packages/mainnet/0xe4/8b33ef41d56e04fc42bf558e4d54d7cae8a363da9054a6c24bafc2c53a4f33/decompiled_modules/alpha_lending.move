module 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending {
    ...
    struct PauseStateKey has copy, drop, store {
        dummy_field: bool,
    }

    struct PauseCapRegistryKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct PauseCapRegistry has store {
        caps: 0x2::vec_map::VecMap<0x2::object::ID, bool>,
    }
    ...
    struct ProtocolPausedEvent has copy, drop {
        pause_liquidations: bool,
        pause_cap_id: 0x2::object::ID,
    }

    struct ProtocolUnpausedEvent has copy, drop {
        pause_cap_id: 0x2::object::ID,
    }

    struct PauseCapDisabledEvent has copy, drop {
        cap_id: 0x2::object::ID,
        admin_cap_id: 0x2::object::ID,
    }

    struct PauseCapEnabledEvent has copy, drop {
        cap_id: 0x2::object::ID,
        admin_cap_id: 0x2::object::ID,
    }

    struct LiquidationProtectionUpdatedEvent has copy, drop {
        position_id: 0x2::object::ID,
        protected: bool,
        admin_cap_id: 0x2::object::ID,
    }

    struct PositionPausedUpdatedEvent has copy, drop {
        position_id: 0x2::object::ID,
        paused: bool,
        admin_cap_id: 0x2::object::ID,
    }
    ...
    public fun admin_liquidate<T0, T1>(arg0: &mut LendingProtocol, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: 0x2::coin::Coin<T0>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::LiquidityPromise<T1>, 0x2::coin::Coin<T0>) {
        verify_version(arg0);
        verify_admin_cap(arg0, arg1);
        ...
        liquidate_internal<T0, T1>(arg0, arg2, arg3, arg4, arg5, arg6, arg7)
    }

    public fun admin_liquidate_lp_position<T0, T1, T2>(arg0: &mut LendingProtocol, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: 0x2::coin::Coin<T2>, arg6: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        verify_version(arg0);
        verify_admin_cap(arg0, arg1);
        liquidate_lp_internal<T0, T1, T2>(arg0, arg2, arg3, arg4, arg5, arg6, arg7, arg8)
    }
    ...
    public fun collect_reward<T0>(arg0: &mut LendingProtocol, arg1: u64, arg2: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::PositionCap, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::LiquidityPromise<T0>) {
        verify_version(arg0);
        verify_not_paused(arg0);
        assert!(0x2::table::contains<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&arg0.positions, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::get_position_id(arg2)), 44);
    ...
    public fun create_new_pause_admin_cap(arg0: &mut LendingProtocol, arg1: &LendingProtocolCap, arg2: &mut 0x2::tx_context::TxContext) : PauseAdminCap {
        verify_version(arg0);
        let v0 = PauseAdminCap{id: 0x2::object::new(arg2)};
        let v1 = PauseCapRegistryKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PauseCapRegistryKey>(&arg0.id, v1)) {
            let v2 = PauseCapRegistryKey{dummy_field: false};
            0x2::vec_map::insert<0x2::object::ID, bool>(&mut 0x2::dynamic_field::borrow_mut<PauseCapRegistryKey, PauseCapRegistry>(&mut arg0.id, v2).caps, 0x2::object::id<PauseAdminCap>(&v0), true);
        } else {
            let v3 = 0x2::vec_map::empty<0x2::object::ID, bool>();
            0x2::vec_map::insert<0x2::object::ID, bool>(&mut v3, 0x2::object::id<PauseAdminCap>(&v0), true);
            let v4 = PauseCapRegistryKey{dummy_field: false};
            let v5 = PauseCapRegistry{caps: v3};
            0x2::dynamic_field::add<PauseCapRegistryKey, PauseCapRegistry>(&mut arg0.id, v4, v5);
        };
        v0
    }
    ...
    public fun disable_pause_cap(arg0: &mut LendingProtocol, arg1: &AdminCap, arg2: 0x2::object::ID) {
        verify_version(arg0);
        verify_admin_cap(arg0, arg1);
        let v0 = PauseCapRegistryKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<PauseCapRegistryKey>(&arg0.id, v0), 51);
        let v1 = PauseCapRegistryKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow_mut<PauseCapRegistryKey, PauseCapRegistry>(&mut arg0.id, v1);
        assert!(0x2::vec_map::contains<0x2::object::ID, bool>(&v2.caps, &arg2), 51);
        *0x2::vec_map::get_mut<0x2::object::ID, bool>(&mut v2.caps, &arg2) = false;
        let v3 = PauseCapDisabledEvent{
            cap_id       : arg2,
            admin_cap_id : 0x2::object::id<AdminCap>(arg1),
        };
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::events::emit_event<PauseCapDisabledEvent>(v3);
    }

    public fun enable_pause_cap(arg0: &mut LendingProtocol, arg1: &AdminCap, arg2: 0x2::object::ID) {
        verify_version(arg0);
        verify_admin_cap(arg0, arg1);
        let v0 = PauseCapRegistryKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<PauseCapRegistryKey>(&arg0.id, v0), 51);
        ...
        let v2 = 0x2::dynamic_field::borrow_mut<PauseCapRegistryKey, PauseCapRegistry>(&mut arg0.id, v1);
        assert!(0x2::vec_map::contains<0x2::object::ID, bool>(&v2.caps, &arg2), 51);
        *0x2::vec_map::get_mut<0x2::object::ID, bool>(&mut v2.caps, &arg2) = true;
        let v3 = PauseCapEnabledEvent{
            cap_id       : arg2,
            admin_cap_id : 0x2::object::id<AdminCap>(arg1),
        };
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::events::emit_event<PauseCapEnabledEvent>(v3);
    }
    ...
    public fun get_collateral_amount(arg0: &mut LendingProtocol, arg1: u64, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock) : u64 {
        ...
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::get_collateral_amount(0x2::table::borrow<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&arg0.positions, arg2), &mut arg0.markets, arg3, arg1)
    }
    ...
    public fun liquidate<T0, T1>(arg0: &mut LendingProtocol, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::LiquidityPromise<T1>, 0x2::coin::Coin<T0>) {
        verify_version(arg0);
        verify_liquidations_not_paused(arg0);
        ...
        assert!(!0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::is_liquidation_protected(0x2::table::borrow_mut<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&mut arg0.positions, arg1)), 52);
        liquidate_internal<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6)
    }

    fun liquidate_internal<T0, T1>(arg0: &mut LendingProtocol, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::LiquidityPromise<T1>, 0x2::coin::Coin<T0>) {
    ...
    fun liquidate_lp_internal<T0, T1, T2>(arg0: &mut LendingProtocol, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: 0x2::coin::Coin<T2>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        let v0 = 0x2::table::borrow_mut<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&mut arg0.positions, arg1);
    ...
    public fun liquidate_lp_position<T0, T1, T2>(arg0: &mut LendingProtocol, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg4: 0x2::coin::Coin<T2>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x2::coin::Coin<T2>) {
        ...
        verify_liquidations_not_paused(arg0);
        assert!(!0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::is_liquidation_protected(0x2::table::borrow_mut<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&mut arg0.positions, arg1)), 52);
        liquidate_lp_internal<T0, T1, T2>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7)
    }
    ...
    public fun pause_protocol(arg0: &mut LendingProtocol, arg1: &PauseAdminCap, arg2: bool) {
        verify_version(arg0);
        verify_pause_cap(arg0, arg1);
        let v0 = PauseStateKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PauseStateKey>(&arg0.id, v0)) {
            let v1 = PauseStateKey{dummy_field: false};
            let v2 = 0x2::dynamic_field::borrow_mut<PauseStateKey, PauseState>(&mut arg0.id, v1);
            v2.paused = true;
            v2.liquidations_paused = arg2;
        } else {
            let v3 = PauseStateKey{dummy_field: false};
            let v4 = PauseState{
                paused              : true,
                liquidations_paused : arg2,
            };
            0x2::dynamic_field::add<PauseStateKey, PauseState>(&mut arg0.id, v3, v4);
        };
        let v5 = ProtocolPausedEvent{
            pause_liquidations : arg2,
            pause_cap_id       : 0x2::object::id<PauseAdminCap>(arg1),
        };
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::events::emit_event<ProtocolPausedEvent>(v5);
    }
    ...
    public fun set_position_liquidation_protected(arg0: &mut LendingProtocol, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: bool) {
        verify_version(arg0);
        verify_admin_cap(arg0, arg1);
        assert!(0x2::table::contains<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&arg0.positions, arg2), 44);
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::set_liquidation_protected(0x2::table::borrow_mut<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&mut arg0.positions, arg2), arg3);
        let v0 = LiquidationProtectionUpdatedEvent{
            position_id  : arg2,
            protected    : arg3,
            admin_cap_id : 0x2::object::id<AdminCap>(arg1),
        };
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::events::emit_event<LiquidationProtectionUpdatedEvent>(v0);
    }

    public fun set_position_paused(arg0: &mut LendingProtocol, arg1: &AdminCap, arg2: 0x2::object::ID, arg3: bool) {
        verify_version(arg0);
        verify_admin_cap(arg0, arg1);
        assert!(0x2::table::contains<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&arg0.positions, arg2), 44);
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::set_position_paused_flag(0x2::table::borrow_mut<0x2::object::ID, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::Position>(&mut arg0.positions, arg2), arg3);
        let v0 = PositionPausedUpdatedEvent{
            position_id  : arg2,
            paused       : arg3,
            admin_cap_id : 0x2::object::id<AdminCap>(arg1),
        };
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::events::emit_event<PositionPausedUpdatedEvent>(v0);
    }
    ...
    public fun unpause_protocol(arg0: &mut LendingProtocol, arg1: &PauseAdminCap) {
        verify_version(arg0);
        verify_pause_cap(arg0, arg1);
        verify_is_paused(arg0);
        let v0 = PauseStateKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PauseStateKey>(&arg0.id, v0)) {
            let v1 = PauseStateKey{dummy_field: false};
            let v2 = 0x2::dynamic_field::borrow_mut<PauseStateKey, PauseState>(&mut arg0.id, v1);
            v2.paused = false;
            v2.liquidations_paused = false;
        };
        let v3 = ProtocolUnpausedEvent{pause_cap_id: 0x2::object::id<PauseAdminCap>(arg1)};
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::events::emit_event<ProtocolUnpausedEvent>(v3);
    }
    ...
    public fun update_protocol_fee_v2(arg0: &mut LendingProtocol, arg1: &AdminCap, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock) {
        verify_version(arg0);
        verify_admin_cap(arg0, arg1);
        assert!(arg3 <= 10000 && arg4 <= 10000, 20);
        let v0 = 0x2::table::borrow_mut<u64, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market>(&mut arg0.markets, arg2);
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::refresh(v0, arg5);
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::update_protocol_fee_share(v0, arg3, arg4);
    }
    ...
    fun verify_is_paused(arg0: &LendingProtocol) {
        let v0 = PauseStateKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<PauseStateKey>(&arg0.id, v0), 55);
        let v1 = PauseStateKey{dummy_field: false};
        assert!(0x2::dynamic_field::borrow<PauseStateKey, PauseState>(&arg0.id, v1).paused, 55);
    }

    fun verify_liquidations_not_paused(arg0: &LendingProtocol) {
        let v0 = PauseStateKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PauseStateKey>(&arg0.id, v0)) {
            let v1 = PauseStateKey{dummy_field: false};
            assert!(!0x2::dynamic_field::borrow<PauseStateKey, PauseState>(&arg0.id, v1).liquidations_paused, 50);
        };
    }

    fun verify_not_paused(arg0: &LendingProtocol) {
        let v0 = PauseStateKey{dummy_field: false};
        if (0x2::dynamic_field::exists<PauseStateKey>(&arg0.id, v0)) {
            let v1 = PauseStateKey{dummy_field: false};
            assert!(!0x2::dynamic_field::borrow<PauseStateKey, PauseState>(&arg0.id, v1).paused, 49);
        };
    }

    fun verify_pause_cap(arg0: &LendingProtocol, arg1: &PauseAdminCap) {
        let v0 = PauseCapRegistryKey{dummy_field: false};
        assert!(0x2::dynamic_field::exists<PauseCapRegistryKey>(&arg0.id, v0), 51);
        let v1 = PauseCapRegistryKey{dummy_field: false};
        let v2 = 0x2::dynamic_field::borrow<PauseCapRegistryKey, PauseCapRegistry>(&arg0.id, v1);
        let v3 = 0x2::object::id<PauseAdminCap>(arg1);
        assert!(0x2::vec_map::contains<0x2::object::ID, bool>(&v2.caps, &v3), 51);
        assert!(*0x2::vec_map::get<0x2::object::ID, bool>(&v2.caps, &v3), 53);
    }
