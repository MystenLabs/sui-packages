module 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker {
    ...
    public(friend) fun collect_fees(arg0: &mut SuiStaker, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        assert!(v1 <= v0, 0);
        remove_stake(arg0, v0 - v1, arg1, true, arg2)
    }

    public(friend) fun delete_sui_staker(arg0: SuiStaker, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        let v8 = v2;
        let v9 = v1;
        if (0x1::option::is_some<0x3::staking_pool::FungibleStakedSui>(&v8)) {
            0x2::balance::join<0x2::sui::SUI>(&mut v9, 0x3::sui_system::redeem_fungible_staked_sui(arg1, 0x1::option::extract<0x3::staking_pool::FungibleStakedSui>(&mut v8), arg2));
        };
        0x1::option::destroy_none<0x3::staking_pool::FungibleStakedSui>(v8);
        0x1::option::destroy_none<0x3::staking_pool::StakedSui>(v3);
        0x2::coin::from_balance<0x2::sui::SUI>(v9, arg2)
    }

    public(friend) fun drain_sui_pool(arg0: &mut SuiStaker, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::withdraw_all<0x2::sui::SUI>(&mut arg0.sui_pool), arg1)
    }

    fun get_fungible_amount(arg0: &0x3::staking_pool::PoolTokenExchangeRate, arg1: u64) : u64 {
    ...
    public(friend) fun init_staker(arg0: address, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) : SuiStaker {
        ...
        let v2 = update_and_get_latest_exchange_rate(&v1, 0, arg2, arg3);
        let v3 = SuiStaker{
            staked_sui_count   : 0,
    ...
    fun refresh_epoch(arg0: &mut SuiStaker, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) {
        if (0x2::tx_context::epoch(arg2) > arg0.last_refresh_epoch) {
            let v0 = update_and_get_latest_exchange_rate(&arg0.pool_id, arg0.last_refresh_epoch, arg1, arg2);
    ...
    public(friend) fun remove_stake(arg0: &mut SuiStaker, arg1: u64, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: bool, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        if (arg3 == false) {
            arg0.staked_sui_count = arg0.staked_sui_count - arg1;
        };
        if (0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool) >= arg1) {
            return 0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_pool, arg1), arg4)
        };
        let v0 = arg1 - 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool);
        refresh_epoch(arg0, arg2, arg4);
        if (0x1::option::is_some<0x3::staking_pool::StakedSui>(&arg0.pending_stake)) {
            ...
            let v2 = if (0x3::staking_pool::staked_sui_amount(0x1::option::borrow<0x3::staking_pool::StakedSui>(&arg0.pending_stake)) < v1 + 1000000000) {
                ...
                0x3::staking_pool::split(0x1::option::borrow_mut<0x3::staking_pool::StakedSui>(&mut arg0.pending_stake), v1, arg4)
            };
            0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_pool, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::from_balance<0x2::sui::SUI>(0x3::sui_system::request_withdraw_stake_non_entry(arg2, v2, arg4), arg4)));
        };
        if (arg1 > 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool)) {
            if (0x1::option::is_some<0x3::staking_pool::FungibleStakedSui>(&arg0.active_stake)) {
                0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_pool, 0x2::coin::into_balance<0x2::sui::SUI>(0x2::coin::from_balance<0x2::sui::SUI>(0x3::sui_system::redeem_fungible_staked_sui(arg2, 0x3::staking_pool::split_fungible_staked_sui(0x1::option::borrow_mut<0x3::staking_pool::FungibleStakedSui>(&mut arg0.active_stake), 0x1::u64::min(get_fungible_amount(&arg0.exchange_rate, arg1 - 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool)) + 100, 0x3::staking_pool::fungible_staked_sui_value(0x1::option::borrow<0x3::staking_pool::FungibleStakedSui>(&arg0.active_stake))), arg4), arg4), arg4)));
                if (0x3::staking_pool::fungible_staked_sui_value(0x1::option::borrow<0x3::staking_pool::FungibleStakedSui>(&arg0.active_stake)) == 0) {
                    0x2::balance::destroy_zero<0x2::sui::SUI>(0x3::sui_system::redeem_fungible_staked_sui(arg2, 0x1::option::extract<0x3::staking_pool::FungibleStakedSui>(&mut arg0.active_stake), arg4));
                };
            };
        };
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.sui_pool) >= arg1, 0);
        0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_pool, arg1), arg4)
    }

    fun update_and_get_latest_exchange_rate(arg0: &0x2::object::ID, arg1: u64, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &0x2::tx_context::TxContext) : 0x1::option::Option<0x3::staking_pool::PoolTokenExchangeRate> {
