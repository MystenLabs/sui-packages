        ...
        while (v0 < 0x1::vector::length<0x1::option::Option<Reward>>(&arg1.rewards)) {
            ...
            if (0x1::vector::length<0x1::option::Option<UserReward>>(&arg0.rewards) <= v0) {
                ...
                let v4 = UserReward{
                    ...
                    earned_rewards                : 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(v2.cummulative_rewards_per_share, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(arg0.share)),
                ...
                0x1::option::fill<UserReward>(&mut v3, v4);
                0x1::vector::push_back<0x1::option::Option<UserReward>>(&mut arg0.rewards, v3);
            } else {
                let v5 = 0x1::option::borrow_mut<UserReward>(0x1::vector::borrow_mut<0x1::option::Option<UserReward>>(&mut arg0.rewards, v0));
                v5.earned_rewards = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::add(v5.earned_rewards, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::sub(v2.cummulative_rewards_per_share, v5.cummulative_rewards_per_share), 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(arg0.share)));
                v5.cummulative_rewards_per_share = v2.cummulative_rewards_per_share;
            };
            v0 = v0 + 1;
        };
