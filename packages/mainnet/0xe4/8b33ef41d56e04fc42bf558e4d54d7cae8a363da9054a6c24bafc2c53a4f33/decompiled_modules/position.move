module 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position {
    ...
    struct LiquidationProtectedKey has copy, drop, store {
        dummy_field: bool,
    }

    struct PositionPausedKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public(friend) fun refresh(arg0: &mut Position, arg1: &mut 0x2::table::Table<u64, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market>, arg2: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::oracle::Oracle, arg3: &0x2::clock::Clock) {
        ...
        let v13 = 0;
        while (v13 < 0x2::vec_map::length<u64, u64>(&arg0.collaterals)) {
    ...
    public(friend) fun add_bluefin_lp_collateral(arg0: &mut Position, arg1: 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::position::Position, arg2: u8, arg3: u8, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock) {
        assert!(!is_position_paused(arg0), 16);
    ...
    public(friend) fun get_collateral_amount(arg0: &Position, arg1: &mut 0x2::table::Table<u64, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market>, arg2: &0x2::clock::Clock, arg3: u64) : u64 {
        if (!0x2::vec_map::contains<u64, u64>(&arg0.collaterals, &arg3)) {
            return 0
        };
        let v0 = 0x2::table::borrow_mut<u64, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market>(arg1, arg3);
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::refresh(v0, arg2);
        0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::to_u64(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::mul(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(*0x2::vec_map::get<u64, u64>(&arg0.collaterals, &arg3)), 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::get_xtoken_ratio(v0)))
    }
    ...
    public(friend) fun is_liquidation_protected(arg0: &Position) : bool {
        let v0 = LiquidationProtectedKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<LiquidationProtectedKey>(&arg0.id, v0)) {
            let v2 = LiquidationProtectedKey{dummy_field: false};
            *0x2::dynamic_field::borrow<LiquidationProtectedKey, bool>(&arg0.id, v2)
        } else {
            false
        }
    }

    public(friend) fun is_position_paused(arg0: &Position) : bool {
        let v0 = PositionPausedKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<PositionPausedKey>(&arg0.id, v0)) {
            let v2 = PositionPausedKey{dummy_field: false};
            *0x2::dynamic_field::borrow<PositionPausedKey, bool>(&arg0.id, v2)
        } else {
            false
        }
    }
    ...
    public(friend) fun liquidate<T0, T1>(arg0: &mut Position, arg1: &mut 0x2::table::Table<u64, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market>, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<T0>, arg5: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::oracle::Oracle, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::XToken<T1>>, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::Number, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::Number, 0x2::balance::Balance<0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::XToken<T1>>, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T0>) {
        ...
        let v21 = remove_token_collateral_internal<T1>(arg0, arg2, v16, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::to_u64(v19), arg6);
        ...
        assert!(repay(arg0, 0x1::type_name::get<T0>(), arg3, v23, 0x2::coin::value<T0>(&v22), arg6) == 0x2::coin::value<T0>(&v22), 13906839117850738687);
    ...
    public(friend) fun liquidate_bluefin_lp_position<T0, T1, T2>(arg0: &mut Position, arg1: &mut 0x2::table::Table<u64, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market>, arg2: u64, arg3: 0x2::coin::Coin<T2>, arg4: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg5: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg6: &0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::oracle::Oracle, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::Number, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::Number, 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::Number, 0x2::coin::Coin<T2>, 0x2::coin::Coin<T2>, 0x2::object::ID, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        assert!(v15 == 0x2::coin::value<T2>(&v13), 13906840251722104831);
    ...
    public(friend) fun remove_token_collateral<T0>(arg0: &mut Position, arg1: u64, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market, arg3: u64, arg4: &0x2::clock::Clock) : 0x2::balance::Balance<0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::XToken<T0>> {
        assert!(!is_position_paused(arg0), 16);
        remove_token_collateral_internal<T0>(arg0, arg1, arg2, arg3, arg4)
    }

    fun remove_token_collateral_internal<T0>(arg0: &mut Position, arg1: u64, arg2: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market, arg3: u64, arg4: &0x2::clock::Clock) : 0x2::balance::Balance<0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::XToken<T0>> {
    ...
    public(friend) fun repay(arg0: &mut Position, arg1: 0x1::type_name::TypeName, arg2: u64, arg3: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market::Market, arg4: u64, arg5: &0x2::clock::Clock) : u64 {
        ...
        while (v0 < 0x1::vector::length<Borrow>(&arg0.loans)) {
            ...
            assert!(v1.coin_type == arg1, 13906838533735186431);
    ...
    public(friend) fun set_liquidation_protected(arg0: &mut Position, arg1: bool) {
        let v0 = LiquidationProtectedKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<LiquidationProtectedKey>(&arg0.id, v0)) {
            let v1 = LiquidationProtectedKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<LiquidationProtectedKey, bool>(&mut arg0.id, v1) = arg1;
        } else {
            let v2 = LiquidationProtectedKey{dummy_field: false};
            0x2::dynamic_field::add<LiquidationProtectedKey, bool>(&mut arg0.id, v2, arg1);
        };
    }

    public(friend) fun set_position_paused_flag(arg0: &mut Position, arg1: bool) {
        let v0 = PositionPausedKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<PositionPausedKey>(&arg0.id, v0)) {
            let v1 = PositionPausedKey{dummy_field: false};
            *0x2::dynamic_field::borrow_mut<PositionPausedKey, bool>(&mut arg0.id, v1) = arg1;
        } else {
            let v2 = PositionPausedKey{dummy_field: false};
            0x2::dynamic_field::add<PositionPausedKey, bool>(&mut arg0.id, v2, arg1);
        };
    }
