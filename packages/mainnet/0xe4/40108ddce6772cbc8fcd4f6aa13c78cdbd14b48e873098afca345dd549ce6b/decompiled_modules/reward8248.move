module 0xe440108ddce6772cbc8fcd4f6aa13c78cdbd14b48e873098afca345dd549ce6b::reward8248 {
    struct REWARD8248 has drop {
        dummy_field: bool,
    }

    struct TICKET_8248 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8248(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8248>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8248>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8248, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8248>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8248>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8248>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8248>>(v5, 0x2::tx_context::sender(arg1));
    }
