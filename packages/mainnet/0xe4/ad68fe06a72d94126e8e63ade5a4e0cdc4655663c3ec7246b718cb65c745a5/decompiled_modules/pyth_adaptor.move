module 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::pyth_adaptor {
    ...
    public(friend) fun assert_channel_matches(arg0: &PythProFeedInfo, arg1: &0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::channel_v2::Channel) {
        ...
        assert!(v3, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_unexpected_channel());
    }

    fun ensure_feed_timestamp_ok(arg0: u64, arg1: &PythProFeedInfo, arg2: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg2) * 1000;
        assert!(arg0 <= v0, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::future_pyth_price());
        assert!(arg0 + 30000000 >= v0, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_price_too_old());
        assert!(arg0 >= arg1.last_updated_timestamp_us, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_price_too_old());
    }

    fun ensure_price_conf_within_range(arg0: u64, arg1: u64, arg2: u64) {
        assert!(arg0 > 0, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::oracle_zero_price_error());
        assert!((((arg1 as u128) * (10000 as u128) * 100 / (arg0 as u128)) as u64) <= arg2 * 100, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_price_conf_too_large());
    }
    ...
    fun extract_from_nested_optional<T0: drop>(arg0: 0x1::option::Option<0x1::option::Option<T0>>, arg1: u64) : T0 {
        assert!(0x1::option::is_some<0x1::option::Option<T0>>(&arg0), 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_missing_item() + arg1);
        let v0 = 0x1::option::extract<0x1::option::Option<T0>>(&mut arg0);
        assert!(0x1::option::is_some<T0>(&v0), 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_no_value() + arg1);
    ...
    fun normalize_decimals(arg0: u64, arg1: u8) : u64 {
        let v0 = 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed::decimals();
        let v1 = if (arg1 < v0) {
            arg0 * pow10_u64(v0 - arg1)
        } else {
            arg0 / pow10_u64(arg1 - v0)
        };
        assert!(v1 > 0, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_price_decimals_too_large());
        v1
    }
    ...
    public(friend) fun refresh_pyth_price(arg0: &mut PythProFeedInfo, arg1: &0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::feed::Feed, arg2: &0x2::clock::Clock) : (0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed::PriceFeedComponent, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed::PriceFeedComponent) {
        assert!(0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::feed::feed_id(arg1) == arg0.feed_id, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_feed_id_not_matching());
    ...
    fun refresh_pyth_price_inner(arg0: &mut PythProFeedInfo, arg1: 0x1::option::Option<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::i16::I16>, arg2: 0x1::option::Option<u16>, arg3: 0x1::option::Option<0x1::option::Option<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::i64::I64>>, arg4: 0x1::option::Option<0x1::option::Option<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::i64::I64>>, arg5: 0x1::option::Option<0x1::option::Option<0x7b502c8a7bcb3915892347f11086745570e759fe9708d03c03accf4c90bbf580::i64::I64>>, arg6: 0x1::option::Option<0x1::option::Option<u64>>, arg7: 0x1::option::Option<0x1::option::Option<u64>>, arg8: &0x2::clock::Clock) : (0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed::PriceFeedComponent, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed::PriceFeedComponent) {
        ...
        assert!(v1 <= 255, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_price_decimals_too_large());
        let v2 = (v1 as u8);
        assert!(0x1::option::is_some<u16>(&arg2), 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_missing_item() + 1);
        assert!(0x1::option::extract<u16>(&mut arg2) >= arg0.min_publisher_count, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_publisher_count_too_small());
        ...
        let v9 = v8 / 1000000;
        (0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed::new_component(normalize_decimals(v7, v2), v9), 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed::new_component(normalize_decimals(v4, v2), v9))
    }

    public(friend) fun register_pyth_feed<T0>(arg0: &mut 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::asset_registry::XOracleAssetRegistry<PythProFeedInfo>, arg1: u32, arg2: u8, arg3: u16, arg4: u64, arg5: u64) {
        assert!(arg3 != 0, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_invalid_min_publisher_count());
        assert!(arg4 <= 10000, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::invalid_conf_range());
        assert!(arg5 <= 10000, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::invalid_conf_range());
        assert!(is_known_channel_id(arg2), 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::pyth_pro_unexpected_channel());
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        if (!0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::asset_registry::has_asset<PythProFeedInfo>(arg0, v0)) {
            ...
            0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::asset_registry::set<PythProFeedInfo>(arg0, v0, v1);
        } else {
            let v2 = 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::asset_registry::borrow_mut<PythProFeedInfo>(arg0, v0);
            v2.feed_id = arg1;
