module 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::price_feed {
    ...
    public(friend) fun ensure_timestamp_not_stale(arg0: &PriceFeedComponent, arg1: u64, arg2: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg2) - update_time(arg0) * 1000 <= arg1, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::oracle_stale_price_error());
    }
    ...
    public(friend) fun safe_cast_to_u64(arg0: u128) : u64 {
        assert!(arg0 < 18446744073709551615, 0x6d801b4d9099b78a67477cdc0ddd6018113b280226a0b1708169a605453ec4cb::oracle_error::value_overflow());
        (arg0 as u64)
    }
