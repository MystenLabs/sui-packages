module 0xe4ec4b394fddd2e8f0983bb6bac2b39394a88cf3371ef2073d50efac47952331::cnsnft6911 {
    struct CNSNFT6911 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6911, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3932"));
        let v4 = 0x2::package::claim<CNSNFT6911>(arg0, arg1);
