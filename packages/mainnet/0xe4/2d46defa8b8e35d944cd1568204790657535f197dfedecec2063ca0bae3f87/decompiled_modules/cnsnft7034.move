module 0xe42d46defa8b8e35d944cd1568204790657535f197dfedecec2063ca0bae3f87::cnsnft7034 {
    struct CNSNFT7034 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7034, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7034>(arg0, arg1);
