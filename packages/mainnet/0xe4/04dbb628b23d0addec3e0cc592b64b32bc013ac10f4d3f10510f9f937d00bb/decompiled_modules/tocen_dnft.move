module 0xe404dbb628b23d0addec3e0cc592b64b32bc013ac10f4d3f10510f9f937d00bb::tocen_dnft {
    ...
    fun checkOwnerSign(arg0: vector<u8>, arg1: &mut 0x2::tx_context::TxContext) : bool {
        ...
        0x1::string::sub_string(&v1, 0, 66) == v0 && 0x1::string::sub_string(&v1, 67, 0x1::string::length(&v1)) == 0x1::string::utf8(0xe404dbb628b23d0addec3e0cc592b64b32bc013ac10f4d3f10510f9f937d00bb::config::get_project())
    }
    ...
    fun init(arg0: TOCEN_DNFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(0xe404dbb628b23d0addec3e0cc592b64b32bc013ac10f4d3f10510f9f937d00bb::config::get_link_project()));
    ...
    fun init_infocollection(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = InfoCollection{
            ...
            name_nft        : 0x1::string::utf8(0xe404dbb628b23d0addec3e0cc592b64b32bc013ac10f4d3f10510f9f937d00bb::config::get_name_dnft()),
            description_nft : 0x1::string::utf8(0xe404dbb628b23d0addec3e0cc592b64b32bc013ac10f4d3f10510f9f937d00bb::config::get_description_dnft()),
            ourl            : 0x1::string::utf8(0xe404dbb628b23d0addec3e0cc592b64b32bc013ac10f4d3f10510f9f937d00bb::config::get_url()),
            sum_nft         : 0,
            timestamp_mint  : 0,
        };
    ...
    public entry fun mintNFT(arg0: &mut InfoCollection, arg1: vector<u8>, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xe404dbb628b23d0addec3e0cc592b64b32bc013ac10f4d3f10510f9f937d00bb::config::get_key();
