module 0xe468111b005737fe72a7fd66bbea52980159d02a7d8e4494e9a7b105f24fd925::cnsnft1402 {
    struct CNSNFT1402 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1402, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1402>(arg0, arg1);
