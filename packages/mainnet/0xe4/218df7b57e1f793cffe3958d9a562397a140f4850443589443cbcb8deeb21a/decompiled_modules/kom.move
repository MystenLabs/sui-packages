module 0xe4218df7b57e1f793cffe3958d9a562397a140f4850443589443cbcb8deeb21a::kom {
    struct KOM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: KOM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<KOM>(&mut v2, 1000000000, 0x2::tx_context::sender(arg1), arg1);
