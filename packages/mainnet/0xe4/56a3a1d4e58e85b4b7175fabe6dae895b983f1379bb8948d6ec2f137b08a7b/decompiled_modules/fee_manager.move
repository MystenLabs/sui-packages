module 0xa283fd6b45f1103176e7ae27e870c89df7c8783b15345e2b13faa81ec25c4fa6::fee_manager {
    ...
    public entry fun fees_remove_as_manager(arg0: &0xa283fd6b45f1103176e7ae27e870c89df7c8783b15345e2b13faa81ec25c4fa6::admin::Config, arg1: &mut FeeTable, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == 0xa283fd6b45f1103176e7ae27e870c89df7c8783b15345e2b13faa81ec25c4fa6::admin::get_fee_manager(arg0), 2);
        remove_from_fee_table(arg1, arg2);
    }
    ...
    public entry fun fees_write_as_manager(arg0: &0xa283fd6b45f1103176e7ae27e870c89df7c8783b15345e2b13faa81ec25c4fa6::admin::Config, arg1: &mut FeeTable, arg2: address, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg5) == 0xa283fd6b45f1103176e7ae27e870c89df7c8783b15345e2b13faa81ec25c4fa6::admin::get_fee_manager(arg0), 2);
        write_to_fee_table(arg1, arg2, arg3, arg4);
    }
    ...
    fun write_to_fee_table(arg0: &mut FeeTable, arg1: address, arg2: u64, arg3: u64) {
        ...
        0x2::table::add<address, FeeValue>(&mut arg0.values, arg1, v1);
    }
