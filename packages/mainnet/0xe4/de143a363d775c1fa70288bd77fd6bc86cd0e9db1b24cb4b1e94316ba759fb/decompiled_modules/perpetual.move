module 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::perpetual {
    struct FundingRate has copy, drop, store {
        timestamp: u64,
        rate: 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::signed_number::Number,
    }
    ...
    public fun create_funding_rate(arg0: u64, arg1: u64, arg2: bool) : FundingRate {
        FundingRate{
            timestamp : arg0,
            rate      : 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::signed_number::from(arg1, arg2),
        }
    }
    ...
    public(friend) fun create_perpetual(arg0: address, arg1: 0x1::string::String, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: vector<u64>, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: address, arg19: address, arg20: bool, arg21: 0x1::string::String, arg22: 0x1::string::String, arg23: u64, arg24: u64, arg25: u64, arg26: u64) : Perpetual {
        assert!(arg17 > 1735714800000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_trade_start_time());
        let v0 = Perpetual{
            id                        : arg0,
            symbol                    : arg1,
            imr                       : arg2,
        ...
        let v2 = &mut v0;
        set_mmr(v2, arg3);
        assert!(arg4 == arg6, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        let v3 = &mut v0;
        ...
        assert!(v17 >= 3 && v17 <= 12, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        v0
    }

    public(friend) fun delist(arg0: &mut Perpetual, arg1: u64) {
        assert!(!arg0.delist, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::already_delisted());
        ...
        assert!(v0, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_oracle_price());
        arg0.delist = true;
    ...
    public fun get_funding_rate(arg0: &FundingRate) : 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::signed_number::Number {
        arg0.rate
    }
    ...
    public(friend) fun set_fee(arg0: &mut Perpetual, arg1: u64, arg2: bool) {
        assert!(arg1 >= 0 && arg1 <= 30000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        if (arg2) {
            arg0.maker_fee = arg1;
        } else {
            arg0.taker_fee = arg1;
    ...
    public(friend) fun set_fee_pool_address(arg0: &mut Perpetual, arg1: address) {
        assert!(arg1 != @0x0, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::can_not_be_zero_address());
        arg0.fee_pool = arg1;
    }

    public(friend) fun set_imr(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 20000000 && arg1 <= 500000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        assert!(arg1 >= arg0.mmr, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        arg0.imr = arg1;
    }
    ...
    public(friend) fun set_insurance_pool_liquidation_premium_percentage(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 10000000 && arg1 <= 500000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
    ...
    public(friend) fun set_max_allowed_oi_open(arg0: &mut Perpetual, arg1: vector<u64>) {
        ...
        while (0x1::vector::length<u64>(&arg1) > 0) {
            ...
            assert!(v0 >= 1000000000000 && v0 <= 10000000000000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        };
    }

    public(friend) fun set_max_funding_rate(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 1000000 && arg1 <= 50000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        arg0.max_funding_rate = arg1;
    }

    public(friend) fun set_max_trade_price(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 10000 && arg1 <= 100000000000000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        assert!(arg1 >= arg0.min_trade_price && arg1 % arg0.tick_size == 0, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        arg0.max_trade_price = arg1;
    }

    public(friend) fun set_max_trade_qty(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 1000 && arg1 <= 100000000000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        assert!(arg1 > arg0.min_trade_qty && arg1 % arg0.step_size == 0, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        arg0.max_trade_qty = arg1;
    }

    public(friend) fun set_min_trade_price(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 10000 && arg1 <= 100000000000000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        assert!(arg1 <= arg0.max_trade_price && arg1 % arg0.tick_size == 0, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        arg0.min_trade_price = arg1;
    }

    public(friend) fun set_mmr(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 10000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        assert!(arg1 <= arg0.imr, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        arg0.mmr = arg1;
    }

    public(friend) fun set_mtb(arg0: &mut Perpetual, arg1: u64, arg2: bool) {
        assert!(arg1 >= 1000000 && arg1 <= 200000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        if (arg2) {
            arg0.mtb_long = arg1;
        } else {
            arg0.mtb_short = arg1;
    ...
    public(friend) fun set_step_size_and_min_trade_qty(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 1000 && arg1 <= 1000000000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        assert!(arg1 < arg0.max_trade_qty, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        arg0.step_size = arg1;
    ...
    public(friend) fun set_tick_size(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 >= 1000 && arg1 <= 1000000000000, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::out_of_config_value_bounds());
        assert!(arg0.min_trade_price % arg1 == 0 && arg0.max_trade_price % arg1 == 0, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_quantity());
        arg0.tick_size = arg1;
    }
    ...
    public(friend) fun update_funding_rate(arg0: &mut Perpetual, arg1: u64, arg2: bool, arg3: u64) {
        assert!(arg0.funding.timestamp < arg3, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_funding_time());
        assert!(arg1 <= arg0.max_funding_rate, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::funding_rate_exceeds_max_allowed_limit());
        arg0.funding = create_funding_rate(arg3, arg1, arg2);
    }

    public(friend) fun update_oracle_price(arg0: &mut Perpetual, arg1: u64) {
        assert!(arg1 % arg0.tick_size == 0, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::invalid_oracle_price());
        assert!(!arg0.delist, 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::errors::already_delisted());
