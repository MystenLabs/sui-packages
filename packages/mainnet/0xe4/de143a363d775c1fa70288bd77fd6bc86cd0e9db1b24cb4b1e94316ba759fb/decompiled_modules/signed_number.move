module 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::utils::base_div(arg0.value, arg1);
    ...
    public fun mul_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::utils::base_mul(arg0.value, arg1);
        let v1 = v0 == 0 || arg0.sign;
        Number{
            value : v0,
            sign  : v1,
    ...
    public fun one() : Number {
        Number{
            value : 0xe4de143a363d775c1fa70288bd77fd6bc86cd0e9db1b24cb4b1e94316ba759fb::constants::base_uint(),
            sign  : true,
        }
    }
