module 0xe44ec0f3d8abd4f438a893aa929b44a489a05faa8a6d13130f4dc4de0b6370b9::cnsnft1194 {
    struct CNSNFT1194 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1194, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1194>(arg0, arg1);
