module 0xe4cf5184c80b0315f037d46e826512fdf9fe48f3a72fd0e10a79b547d124596f::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"BA", b"Machiii", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-31T09-47-02.407Z-images (7).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"Machiii"),
            symbol     : 0x1::string::utf8(b"BA"),
            decimals   : 9,
