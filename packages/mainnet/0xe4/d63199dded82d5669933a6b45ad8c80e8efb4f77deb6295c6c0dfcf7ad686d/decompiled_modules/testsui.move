module 0xe4d63199dded82d5669933a6b45ad8c80e8efb4f77deb6295c6c0dfcf7ad686d::testsui {
    ...
    fun init(arg0: TESTSUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TESTSUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"testsui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is just a test dont buy"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreidyhamet2f6sfy2jkm3skbe6ouf7ejv4sdlpitivldp5r5knrseau"));
