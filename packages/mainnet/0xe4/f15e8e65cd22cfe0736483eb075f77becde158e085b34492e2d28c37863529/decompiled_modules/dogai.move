module 0xe4f15e8e65cd22cfe0736483eb075f77becde158e085b34492e2d28c37863529::dogai {
    ...
    fun init(arg0: DOGAI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/DhASyXH2drjZ2w5GVXe6MWmtchAYnjECzRfcZNfopump.png?size=lg&key=d270d3                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<DOGAI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"DOGAI     ")))), trim_right(b"Doggo Ai                        "), trim_right(b"Doggo Ai is the first-ever AI Pet Agent, designed to understand your pets emotions, plan special moments, and bring innovation to pet care. Fueled by a strong community, $DOGAI combines fun, utility, and the charm of dog-themed AI technology.                                                                              "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
