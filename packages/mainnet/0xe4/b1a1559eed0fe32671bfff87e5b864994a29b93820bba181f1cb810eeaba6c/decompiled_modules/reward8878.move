module 0xe4b1a1559eed0fe32671bfff87e5b864994a29b93820bba181f1cb810eeaba6c::reward8878 {
    struct REWARD8878 has drop {
        dummy_field: bool,
    }

    struct TICKET_8878 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8878(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8878>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8878>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8878, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8878>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8878>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8878>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8878>>(v5, 0x2::tx_context::sender(arg1));
    }
