module 0xe442288c372eeb20339b3efa84e026a25bb98287b81a9923d772dd2af4c723ef::character {
    ...
    public fun create_character(arg0: &mut CharacterNameRegistry, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) : Character {
        let v0 = 0x1::string::from_ascii(0x2085d89f5df00bf6d628748b02a0f23f5d512dc4a23e22d74efeb2c8c86005e0::ascii_utils::to_lower_case(0x1::string::to_ascii(arg1)));
    ...
    public fun is_name_taken(arg0: &CharacterNameRegistry, arg1: 0x1::string::String) {
        assert!(!0x2::table::contains<0x1::string::String, address>(&arg0.registry, 0x1::string::from_ascii(0x2085d89f5df00bf6d628748b02a0f23f5d512dc4a23e22d74efeb2c8c86005e0::ascii_utils::to_lower_case(0x1::string::to_ascii(arg1)))), 1);
    }
