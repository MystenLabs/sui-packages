module 0x8d80e13e5419a30add9a0f8f2ecc3ad70dab33a0806fb2d7ec5ce9b87d946e7::reward9792 {
    struct REWARD9792 has drop {
        dummy_field: bool,
    }

    struct TICKET_9792 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9792(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9792>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9792>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9792, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9792>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9792>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9792>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9792>>(v5, 0x2::tx_context::sender(arg1));
    }
