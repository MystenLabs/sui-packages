module 0x8914d18c34dfbdb7b3b0f06e28dd4f1a95bac27c865f1499ab764e2d9e7ba5d::csc {
    struct CSC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CSC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<CSC>(arg0, 9, b"CSC", b"CaSuino Coin", b"The governance token of CaSuino", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://api.cscancer.cscance/icons/cscancer.svg")), arg1);
