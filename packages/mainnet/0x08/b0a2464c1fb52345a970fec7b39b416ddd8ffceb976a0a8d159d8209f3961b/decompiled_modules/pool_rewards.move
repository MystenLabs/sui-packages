module 0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::pool_rewards {
    ...
    struct StakedNFT has store, key {
        id: 0x2::object::UID,
        nft: 0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT,
        owner: address,
        pool_id: 0x2::object::ID,
        stake_time: u64,
        weight: u64,
    ...
    fun check_nft_has_all_required_elements(arg0: &0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT, arg1: &vector<u64>) : bool {
    ...
    public fun claim_rewards_dynamic(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = v0.end_time - v0.start_time;
        let v7 = if (v2 > v0.end_time) {
            v0.end_time - v0.start_time
        } else {
            v2 - v0.start_time
        };
        let v8 = if (v5 == 0) {
        ...
        let v9 = if (v8) {
            ...
            let v10 = (v7 as u128) * (v4 as u128) * (0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) as u128) / (v5 as u128) / (v6 as u128);
        ...
        if (v9 > 0 && 0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) >= v9) {
            0x2::table::borrow_mut<address, UserStakeInfo>(&mut v0.user_stakes, v1).last_reward_claim = v2;
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut v0.sui_reward_pool, v9), arg3), v1);
            let v11 = RewardsClaimed{
                pool_id    : arg1,
                user       : v1,
                sui_amount : v9,
            };
            0x2::event::emit<RewardsClaimed>(v11);
        };
    }
    ...
    public fun delete_pool(arg0: &PoolAdminCap, arg1: &mut PoolSystem, arg2: 0x2::object::ID, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<0x2::object::ID>(&v0.staked_nft_ids)) {
            ...
            if (0x2::object_table::contains<0x2::object::ID, StakedNFT>(&v0.staked_nfts, v3)) {
                ...
                0x2::transfer::public_transfer<0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT>(v6, v4.owner);
            };
            v2 = v2 + 1;
        };
        let Pool {
            ...
            total_weight        : _,
            staked_nft_ids      : _,
            unique_participants : v28,
            participant_count   : _,
        } = v0;
        0x2::balance::destroy_zero<0x2::sui::SUI>(v21);
        0x2::object_table::destroy_empty<0x2::object::ID, StakedNFT>(v23);
        0x2::table::drop<address, UserStakeInfo>(v24);
        0x2::table::drop<address, bool>(v28);
        ...
        0x2::event::emit<PoolDeleted>(v30);
    }
    ...
    fun extract_nft_element_ids(arg0: &0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT) : vector<u64> {
        0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::get_all_item_ids(arg0)
    }
    ...
    public fun get_user_reward_details_dynamic(arg0: &PoolSystem, arg1: 0x2::object::ID, arg2: address, arg3: &0x2::clock::Clock) : (u64, u64, u64, u64, u64, u64) {
        ...
        let v5 = v0.end_time - v0.start_time;
        let v6 = if (v1 > v0.end_time) {
            v0.end_time - v0.start_time
        } else {
            v1 - v0.start_time
        };
        ...
        let v8 = if (v7) {
            let v9 = (v6 as u128) * (v3 as u128) * (0x2::balance::value<0x2::sui::SUI>(&v0.sui_reward_pool) as u128) / (v4 as u128) / (v5 as u128);
        ...
        (v2.nft_count, v3, v4, v8, v1 - v2.stake_start_time, v2.last_reward_claim)
    }
    ...
    public fun stake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::object_table::borrow_mut<0x2::object::ID, Pool>(&mut arg0.pools, arg1);
        assert!(v0.is_active, 2);
        let v1 = 0x2::clock::timestamp_ms(arg3);
        ...
        let v3 = 0x2::object::id<0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT>(&arg2);
        let v4 = 1;
        let v5 = StakedNFT{
    ...
    public fun unstake_nft(arg0: &mut PoolSystem, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT>(v5, v1);
        let v12 = NFTUnstaked{
            pool_id        : arg1,
            nft_id         : arg2,
            owner          : v1,
    ...
    fun update_all_nft_weights(arg0: &mut Pool, arg1: u64) {
        ...
        while (v2 < 0x1::vector::length<0x2::object::ID>(&arg0.staked_nft_ids)) {
            let v3 = *0x1::vector::borrow<0x2::object::ID>(&arg0.staked_nft_ids, v2);
            if (0x2::object_table::contains<0x2::object::ID, StakedNFT>(&arg0.staked_nfts, v3)) {
                let v4 = 0x2::object_table::borrow_mut<0x2::object::ID, StakedNFT>(&mut arg0.staked_nfts, v3);
                let v5 = (v0 - v4.stake_time) / 3600000;
                let v6 = if (v5 == 0) {
                    1
                } else {
                    v5
    ...
    fun validate_nft_requirements(arg0: &Pool, arg1: &0x17aa7d1e8f59d5a869847b308837e7bdee73ee19b11b970dba0f2a8435bec549::creature_nft::CreatureNFT) {
