module 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::roulette {
    ...
    struct RouletteTable<phantom T0> has store, key {
        id: 0x2::object::UID,
        host: address,
        risk_manager: 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::risk_manager::RiskManager,
    ...
    public fun add_bet<T0>(arg0: &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::Unihouse, arg1: &mut RouletteConfig, arg2: address, arg3: 0x2::coin::Coin<T0>, arg4: u8, arg5: 0x1::option::Option<u64>, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let (_, _) = 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::risk_manager::add_risk(&mut v0.risk_manager, arg4, arg5, 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::bet_manager::get_bet_payout(v1, arg4));
        let v4 = Roulette{dummy_field: false};
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::assert_within_risk<T0, Roulette>(arg0, v4, 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::risk_manager::total_risk(&v0.risk_manager), arg7);
    ...
    public fun assert_within_risk<T0>(arg0: &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::Unihouse, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        let v0 = Roulette{dummy_field: false};
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::assert_within_risk<T0, Roulette>(arg0, v0, arg1, arg2);
    }
    ...
    public fun create_roulette_table<T0>(arg0: &mut RouletteConfig, arg1: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v1 = RouletteTable<T0>{
            ...
            risk_manager   : 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::risk_manager::new_manager(),
    ...
    public fun settle_or_continue<T0>(arg0: &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::Unihouse, arg1: &mut RouletteConfig, arg2: address, arg3: 0x1::option::Option<u64>, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        assert_valid_version(arg1);
        assert!(table_exists<T0>(arg1, arg2), 3);
        ...
        let v6 = 0x1::vector::empty<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::BetResult<T0, Roulette>>();
        let v7 = 0;
        let v8 = 10000;
        ...
        while (v9 < v8 && 0x2::linked_table::length<address, vector<Bet>>(&v1.current_bets) > 0) {
            ...
            while (v9 < v8 && 0x1::vector::length<Bet>(&v13) != 0) {
                ...
                let v21 = 0;
                let v22 = v21;
                if (0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::bet_manager::won_bet(v16, *v2, v17)) {
                    let v23 = 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::bet_manager::get_bet_payout(v18, v16);
                    v4 = v4 + v23;
                ...
                0x1::vector::push_back<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::BetResult<T0, Roulette>>(&mut v6, 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::bet_result<T0, Roulette>(0x1::option::some<0x2::object::ID>(0x2::object::id<Bet>(&v14)), v19, (v16 as u64), v17, v18, v22, *v2));
                v9 = v9 + 1;
            };
        ...
        if (!0x1::vector::is_empty<PlayerWin<T0>>(&v3)) {
            ...
            let v26 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::split_with_reimbursement<T0, Roulette>(arg0, v25, v4);
        ...
        if (0x2::balance::value<T0>(&v5) != 0) {
            ...
            0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::put_with_fee<T0, Roulette>(arg0, v31, 0x2::coin::from_balance<T0>(v5, arg5));
        } else {
            0x2::balance::destroy_zero<T0>(v5);
        };
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::emit_bet_results<T0, Roulette>(arg0, 0x1::option::some<0x2::object::ID>(0x2::object::id<RouletteTable<T0>>(v1)), 0x1::option::some<u64>(v1.round_number), 0x1::option::some<0x1::string::String>(arg4), v6);
        if (v10) {
            let v32 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::math::mul_rate(v7, v0);
            let v33 = Roulette{dummy_field: false};
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::take<T0, Roulette>(arg0, v33, v32, arg5), arg2);
        ...
        if (0x2::linked_table::length<address, vector<Bet>>(&v1.current_bets) == 0) {
            v1.risk_manager = 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::risk_manager::new_manager();
            v1.status = 0;
            v1.round_number = v1.round_number + 1;
        };
    }

    public fun settle_or_continue_0<T0>(arg0: &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::Unihouse, arg1: &mut RouletteConfig, arg2: address, arg3: 0x1::option::Option<u64>, arg4: 0x1::string::String, arg5: &0xee0150555a187970285efd82153b0fc87ed0fb53844a3001f4dff3a5e73d70af::pond::SuilendPond<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0>, arg6: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL>, arg7: &0x2::clock::Clock, arg8: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x1::vector::empty<0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::BetResult<T0, Roulette>>();
        let v8 = 0;
        let v9 = 10000;
        if (0x1::option::is_some<u64>(&arg3)) {
        ...
        while (v10 < v9 && 0x2::linked_table::length<address, vector<Bet>>(&v1.current_bets) > 0) {
            ...
            while (v10 < v9 && 0x1::vector::length<Bet>(&v14) != 0) {
                ...
                let v22 = 0;
                let v23 = v22;
                if (0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::bet_manager::won_bet(v17, *v2, v18)) {
                    let v24 = 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::bet_manager::get_bet_payout(v19, v17);
                    v5 = v5 + v24;
        ...
        if (!0x1::vector::is_empty<PlayerWin<T0>>(&v4)) {
            let (v26, v27) = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::pool_changes(v5);
            let v28 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::pool_balance<T0>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::borrow_house<T0>(arg0));
            if (v26 > v28) {
                0xee0150555a187970285efd82153b0fc87ed0fb53844a3001f4dff3a5e73d70af::pond::withdraw<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, Roulette>(arg5, arg0, v26 - v28, false, v3, arg6, arg7, arg9, arg10);
            };
            let v29 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::house_balance<T0>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::borrow_house<T0>(arg0));
            if (v27 > v29) {
                0xee0150555a187970285efd82153b0fc87ed0fb53844a3001f4dff3a5e73d70af::pond::withdraw<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, Roulette>(arg5, arg0, v27 - v29, true, v3, arg6, arg7, arg9, arg10);
            };
            let v30 = Roulette{dummy_field: false};
            let v31 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::split_with_reimbursement<T0, Roulette>(arg0, v30, v5);
        ...
        if (0x2::balance::value<T0>(&v6) != 0) {
            ...
            let (v37, v38) = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::pool_changes(0x2::coin::value<T0>(&v36));
            0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::put_with_fee<T0, Roulette>(arg0, v3, v36);
            0xee0150555a187970285efd82153b0fc87ed0fb53844a3001f4dff3a5e73d70af::pond::deposit<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, Roulette>(arg5, arg0, v37, false, v3, arg6, arg7, arg9, arg10);
            0xee0150555a187970285efd82153b0fc87ed0fb53844a3001f4dff3a5e73d70af::pond::deposit<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, Roulette>(arg5, arg0, v38, true, v3, arg6, arg7, arg9, arg10);
        } else {
            0x2::balance::destroy_zero<T0>(v6);
        };
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::emit_bet_results<T0, Roulette>(arg0, 0x1::option::some<0x2::object::ID>(0x2::object::id<RouletteTable<T0>>(v1)), 0x1::option::some<u64>(v1.round_number), 0x1::option::some<0x1::string::String>(arg4), v7);
        if (v11) {
            let v39 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::math::mul_rate(v8, v0);
            let v40 = 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::house::pool_balance<T0>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::borrow_house<T0>(arg0));
            if (v39 > v40) {
                0xee0150555a187970285efd82153b0fc87ed0fb53844a3001f4dff3a5e73d70af::pond::withdraw<0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::suilend::MAIN_POOL, T0, Roulette>(arg5, arg0, v39 - v40, false, v3, arg6, arg7, arg9, arg10);
            };
            let v41 = Roulette{dummy_field: false};
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::take<T0, Roulette>(arg0, v41, v39, arg10), arg2);
    ...
    entry fun start_roll<T0>(arg0: &mut 0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::Unihouse, arg1: &0x2::random::Random, arg2: &mut RouletteConfig, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = Roulette{dummy_field: false};
        0x90ebe312f8cdfc6eb719513b19e200fd68b06e340487c2a7a69be6554979e7e2::unihouse::assert_within_risk<T0, Roulette>(arg0, v3, 0x832ca4c8b6416f6b000a08ac36bd79df1917cc3470009caa71612974fb457e7::risk_manager::total_risk(&v2.risk_manager), arg3);
        v2.status = 1;
