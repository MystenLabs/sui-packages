module 0x85acb98013373d2bdb8e11071afac072f27333889de33d3472a937555418e1b::fairmile_navi {
    ...
    public fun depositSUI<T0>(arg0: &mut SuiTreasury<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(0x2::tx_context::sender(arg2) == @0xb6b8d57026badb25d4b6d434c2bb26fa2eaaa7da8c4e35a2b67b26767acf9c65, 100);
    ...
    public fun initializeSuiObject<T0>(arg0: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0xb6b8d57026badb25d4b6d434c2bb26fa2eaaa7da8c4e35a2b67b26767acf9c65, 100);
    ...
    public fun withdrawSUI<T0>(arg0: &mut SuiTreasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0xb6b8d57026badb25d4b6d434c2bb26fa2eaaa7da8c4e35a2b67b26767acf9c65, 100);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.sui_amount, arg1), arg2), @0xb6b8d57026badb25d4b6d434c2bb26fa2eaaa7da8c4e35a2b67b26767acf9c65);
    }
