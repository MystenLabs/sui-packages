module 0x89f0567cd6d2e1cadc7ef35c09119bb92f02fd53f477929ba1a1d08cfec4175::gift7736 {
    struct GIFT7736 has drop {
        dummy_field: bool,
    }

    struct TICKET_7736 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift7736(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7736>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7736>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT7736, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT7736>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7736>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7736>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7736>>(v5, 0x2::tx_context::sender(arg1));
    }
