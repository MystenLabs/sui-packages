module 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::pair_parameter_helper {
    ...
    public fun get_base_fee(arg0: &PairParameters, arg1: u64) : u64 {
        ...
        let v1 = 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::mul_u64((arg0.fee_scheduler_reduction_factor as u64), v0);
        if (v1 >= arg0.cliff_fee_numerator) {
            return 0
        };
        0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::sub_u64(arg0.cliff_fee_numerator, v1)
    }
    ...
    public fun get_current_number_period(arg0: &PairParameters, arg1: u64) : u64 {
        ...
        0x1::u64::min(0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::sub_u64(arg1, arg0.activation_timestamp) / arg0.period_frequency, (arg0.number_of_period as u64))
    }
    ...
    public fun get_total_fee_rate(arg0: &PairParameters, arg1: u16, arg2: u64) : u64 {
        0x1::u64::min(0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::add_u64(get_base_fee(arg0, arg2), get_variable_fee(arg0, arg1)), 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::constants::max_fee_rate())
    }

    public fun get_total_fee_rate_legacy(arg0: &PairParameters, arg1: u16) : u64 {
        0x1::u64::min(0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::add_u64(0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::mul_u64((arg0.base_factor as u64), (arg1 as u64)), get_variable_fee(arg0, arg1)), 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::constants::max_fee_rate())
    }
    ...
    public fun get_variable_fee(arg0: &PairParameters, arg1: u16) : u64 {
        ...
        if (v0 != 0) {
            let v2 = 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::mul_u64((arg0.volatility_accumulator as u64), (arg1 as u64));
            (0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::mul_u64(0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::mul_u64(v2, v2), v0) + 99) / 100
        } else {
            0
        }
    }
    ...
    public(friend) fun new(arg0: u32, arg1: bool, arg2: bool) : PairParameters {
        PairParameters{
            base_factor                    : 0,
            protocol_share                 : 0,
            active_id                      : arg0,
            activation_timestamp           : 0,
            enabled_fee_scheduler          : arg1,
            cliff_fee_numerator            : 0,
            number_of_period               : 0,
            period_frequency               : 0,
            fee_scheduler_reduction_factor : 0,
            enabled_dynamic_fee            : arg2,
            filter_period                  : 0,
            decay_period                   : 0,
            reduction_factor               : 0,
    ...
    public(friend) fun update_volatility_accumulator(arg0: &mut PairParameters, arg1: u32) {
        arg0.volatility_accumulator = 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::u64_to_u32(0x1::u64::min(0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::add_u64((arg0.volatility_reference as u64), 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::mul_u64((0x1::u32::diff(arg1, arg0.id_reference) as u64), 10)), (arg0.max_volatility_accumulator as u64)));
    }
    ...
    public(friend) fun update_volatility_reference(arg0: &mut PairParameters) {
        arg0.volatility_reference = 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::u64_to_u32(0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::safe_math::mul_div_u64((arg0.volatility_accumulator as u64), (arg0.reduction_factor as u64), 0x809df5840765842809af5fdca85db642e0de615de8899884a022b2f8608f84d5::constants::basis_point_max()));
    }
