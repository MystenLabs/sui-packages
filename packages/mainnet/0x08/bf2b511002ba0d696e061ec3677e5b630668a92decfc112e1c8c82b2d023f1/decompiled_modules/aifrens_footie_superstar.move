module 0x414abb429e44ddff03fe84d407ea3985c93fe55bd3ed79a8e2e57f50daf2e21c::aifrens_footie_superstar {
    ...
    public fun burn_token(arg0: AifrensFootieSuperstar) {
        ...
        let v12 = v0;
        let v13 = BurnEvent{id: 0x2::object::uid_to_inner(&v12)};
    ...
    public fun awaken<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: vector<AifrensFootieSuperstar>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 > arg0.start_time_ms, 1);
        assert!(v0 < arg0.expired_time_ms, 2);
        assert!(arg5 == 1 || arg5 == 2, 11);
        let v1 = 0x1::vector::length<AifrensFootieSuperstar>(&arg6);
        assert!(v1 > 2, 12);
        let v2 = get_rarity_str(arg5);
        let v3 = 0;
        while (v3 < v1) {
            let v4 = 0x414abb429e44ddff03fe84d407ea3985c93fe55bd3ed79a8e2e57f50daf2e21c::comparator::compare<0x1::string::String>(&0x1::vector::borrow<AifrensFootieSuperstar>(&arg6, v3).rarity, &v2);
            assert!(0x414abb429e44ddff03fe84d407ea3985c93fe55bd3ed79a8e2e57f50daf2e21c::comparator::is_equal(&v4), 11);
            v3 = v3 + 1;
        };
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg4, get_final_price<T0>(arg1.fusion_price, arg1), arg7)));
        let v5 = 0x1::vector::pop_back<AifrensFootieSuperstar>(&mut arg6);
        burn_token(v5);
        let v6 = 1;
        while (v6 < v1) {
            burn_token(0x1::vector::pop_back<AifrensFootieSuperstar>(&mut arg6));
            v6 = v6 + 1;
        };
        0x1::vector::destroy_empty<AifrensFootieSuperstar>(arg6);
        let v7 = mint_token_with_rarity(arg2, arg3, v0, v5.genes, v5.birth_location, arg5 + 1, arg7);
        0x2::transfer::public_transfer<AifrensFootieSuperstar>(v7, 0x2::tx_context::sender(arg7));
    }
    ...
    public fun fusion_ref<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis, arg7: 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::AifrensGenesis, arg8: vector<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>, arg9: address, arg10: &mut ReferralSystem, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = take_referral_fee<T0>(arg4, v1, arg9, arg10, arg11);
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg4, v1 - v2, arg11)));
        let v3 = 0x1::vector::length<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&arg8);
        let v4 = 0;
        while (v4 < v3) {
            0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::burn_token(0x1::vector::pop_back<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&mut arg8));
            v4 = v4 + 1;
        ...
        0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::burn_token(arg6);
        0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::burn_token(arg7);
        let v5 = mint_token(arg2, arg3, 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::birthdate(&arg6), 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::genes(&arg6), 0x17c1d7520b731e59c665962aba86f84827f8d6812f839d126d3426caa29777cc::aifrens_footie_legends::birth_location(&arg6), get_rate(arg0, arg5, v3), arg11);
        0x2::transfer::public_transfer<AifrensFootieSuperstar>(v5, 0x2::tx_context::sender(arg11));
    }
    ...
    fun get_rarity_index(arg0: 0x1::string::String) : u64 {
        ...
        let (v2, v3) = 0x1::vector::index_of<0x1::string::String>(&v0, &arg0);
        assert!(v2, 14);
        v3
    }
    ...
    fun get_ref_share(arg0: &ReferralSystem, arg1: address) : u64 {
        let v0 = 0x2::table::borrow<address, u64>(&arg0.invitees, arg1);
        let v1 = 0;
        let v2 = 0;
        let v3 = 0;
        while (v1 < 0x1::vector::length<u64>(&arg0.tier_thres) && *v0 >= v2) {
            v2 = *0x1::vector::borrow<u64>(&arg0.tier_thres, v1);
            v3 = *0x1::vector::borrow<u64>(&arg0.shares, v1);
            v1 = v1 + 1;
        };
        v3
    }

    fun get_upgrade_success_rate(arg0: u64, arg1: vector<u64>, arg2: u64) : u64 {
        let v0 = 0;
        let v1 = 0;
        while (v0 < 0x1::vector::length<u64>(&arg1)) {
            v1 = v1 + 100000 * 0x2::math::pow(2, (0x1::vector::pop_back<u64>(&mut arg1) as u8)) / 0x2::math::pow(2, (arg0 as u8)) / 0x2::math::pow(2, ((arg2 - 1) as u8));
            v0 = v0 + 1;
        };
        v1
    }
    ...
    fun is_lucky_upgrade_success(arg0: &0x2::clock::Clock, arg1: address, arg2: vector<u8>, arg3: u64, arg4: vector<u64>, arg5: u64) : bool {
        get_random(arg0, arg1, arg2, 100000) <= get_upgrade_success_rate(arg3, arg4, arg5)
    }
    ...
    fun mint_token_with_rarity(arg0: &AifrensSeason, arg1: &0x2::clock::Clock, arg2: u64, arg3: vector<u8>, arg4: 0x1::string::String, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : AifrensFootieSuperstar {
        let v0 = 0x2::tx_context::sender(arg6);
        let v1 = 0x1::vector::borrow<0x2::table::Table<u64, TokenMetadata>>(&arg0.tier_list, arg5);
        let v2 = 0x2::table::borrow<u64, TokenMetadata>(v1, get_random(arg1, v0, arg3, 0x2::table::length<u64, TokenMetadata>(v1)));
        let v3 = &v2.id;
        let v4 = &v2.name;
        let v5 = &v2.rating;
        let v6 = &v2.position;
        let v7 = &v2.nation;
        let v8 = get_rarity_str(arg5);
        let v9 = AifrensFootieSuperstar{
            id             : 0x2::object::new(arg6),
            generation     : 1,
            birthdate      : arg2,
            genes          : arg3,
    ...
    public fun package_mint_ref<T0>(arg0: &AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &mut PackageMinted<T0>, arg4: &mut 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: vector<u8>, arg7: address, arg8: &mut ReferralSystem, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = take_referral_fee<T0>(arg4, v1, arg7, arg8, arg9);
        ...
        if (!0x2::table::contains<address, u64>(&arg3.minted, v3)) {
            0x2::table::add<address, u64>(&mut arg3.minted, v3, 1);
        } else {
            let v4 = 0x2::table::borrow_mut<address, u64>(&mut arg3.minted, v3);
            *v4 = *v4 + 1;
        };
        let v5 = 0;
        while (v5 < 0x1::vector::length<vector<u64>>(&arg3.rates)) {
            let v6 = mint_token(arg2, arg5, v0, get_random_vector(arg5, v3, 0x1::bcs::to_bytes<u64>(&v5)), 0x1::string::utf8(arg6), *0x1::vector::borrow<vector<u64>>(&arg3.rates, v5), arg9);
            0x2::transfer::public_transfer<AifrensFootieSuperstar>(v6, 0x2::tx_context::sender(arg9));
            v5 = v5 + 1;
        };
    }
    ...
    public fun recruit_ref<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &0x2::clock::Clock, arg4: vector<u8>, arg5: vector<u8>, arg6: &mut 0x2::coin::Coin<T0>, arg7: u64, arg8: vector<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>, arg9: address, arg10: &mut ReferralSystem, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = take_referral_fee<T0>(arg6, v1, arg9, arg10, arg11);
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg6, v1 - v2, arg11)));
        let v3 = get_random_vector(arg3, 0x2::tx_context::sender(arg11), arg4);
        let v4 = 0x1::vector::length<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&arg8);
        let v5 = 0;
        while (v5 < v4) {
            0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::burn_token(0x1::vector::pop_back<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(&mut arg8));
            v5 = v5 + 1;
        ...
        0x1::vector::destroy_empty<0xcf82c1ad5faa30acb2f18394f7cfaf5e5c0c2416d68ebcf01a78c83c385a682c::aifrens_lol::AifrensLol>(arg8);
        let v6 = mint_token(arg2, arg3, v0, v3, 0x1::string::utf8(arg5), get_rate(arg0, arg7, v4), arg11);
        0x2::transfer::public_transfer<AifrensFootieSuperstar>(v6, 0x2::tx_context::sender(arg11));
    }

    public fun recycle<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: vector<AifrensFootieSuperstar>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 > arg0.start_time_ms, 1);
        assert!(v0 < arg0.expired_time_ms, 2);
        ...
        assert!(v1 > 2, 12);
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg4, get_final_price<T0>(arg1.fusion_price, arg1), arg7)));
        let v2 = 0x1::vector::pop_back<AifrensFootieSuperstar>(&mut arg6);
        burn_token(v2);
        let v3 = 1;
        while (v3 < v1) {
            burn_token(0x1::vector::pop_back<AifrensFootieSuperstar>(&mut arg6));
        ...
        0x1::vector::destroy_empty<AifrensFootieSuperstar>(arg6);
        let v4 = mint_token(arg2, arg3, v0, v2.genes, v2.birth_location, get_rate(arg0, arg5, 0), arg7);
        0x2::transfer::public_transfer<AifrensFootieSuperstar>(v4, 0x2::tx_context::sender(arg7));
    }

    public fun recycle_rarity<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &AifrensSeason, arg3: &0x2::clock::Clock, arg4: &mut 0x2::coin::Coin<T0>, arg5: u64, arg6: vector<AifrensFootieSuperstar>, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        assert!(v0 > arg0.start_time_ms, 1);
        assert!(v0 < arg0.expired_time_ms, 2);
        ...
        0x1::vector::destroy_empty<AifrensFootieSuperstar>(arg6);
        let v7 = mint_token_with_rarity(arg2, arg3, v0, v5.genes, v5.birth_location, arg5, arg7);
        0x2::transfer::public_transfer<AifrensFootieSuperstar>(v7, 0x2::tx_context::sender(arg7));
    }

    fun take_referral_fee<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: u64, arg2: address, arg3: &mut ReferralSystem, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        if (!0x2::table::contains<address, u64>(&arg3.invitees, arg2)) {
            0x2::table::add<address, u64>(&mut arg3.invitees, arg2, 1);
        } else {
            let v0 = 0x2::table::borrow_mut<address, u64>(&mut arg3.invitees, arg2);
            *v0 = *v0 + 1;
        };
        let v1 = arg1 * get_ref_share(arg3, arg2) / 100;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(arg0, v1, arg4), arg2);
        let v2 = ReferralEvent{
            amount   : v1,
            referrer : arg2,
        };
        0x2::event::emit<ReferralEvent>(v2);
        v1
    }
    ...
    public fun upgrade<T0>(arg0: &mut AifrensSuperstarGlobal, arg1: &mut PriceGlobal<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::coin::Coin<T0>, arg4: &mut AifrensFootieSuperstar, arg5: vector<AifrensFootieSuperstar>, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 3);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        assert!(v0 > arg0.start_time_ms, 1);
        assert!(v0 < arg0.expired_time_ms, 2);
        let v1 = 0x1::vector::length<AifrensFootieSuperstar>(&arg5);
        assert!(v1 > 0, 12);
        assert!(arg4.level < 10, 13);
        0x2::balance::join<T0>(&mut arg1.balance, 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(arg3, get_final_price<T0>(arg1.fusion_price, arg1), arg6)));
        let v2 = 0;
        let v3 = 0x1::vector::empty<u64>();
        while (v2 < v1) {
            let v4 = 0x1::vector::pop_back<AifrensFootieSuperstar>(&mut arg5);
            0x1::vector::push_back<u64>(&mut v3, get_rarity_index(v4.rarity));
            burn_token(v4);
            v2 = v2 + 1;
        };
        0x1::vector::destroy_empty<AifrensFootieSuperstar>(arg5);
        let v5 = is_lucky_upgrade_success(arg2, 0x2::tx_context::sender(arg6), arg4.genes, get_rarity_index(arg4.rarity), v3, arg4.level);
        let v6 = if (v5) {
            arg4.level + 1
        } else {
            1
        ...
        arg4.level = v6;
        let v7 = UpgradeEvent{
            id         : 0x2::object::id<AifrensFootieSuperstar>(arg4),
            is_success : v5,
            level      : arg4.level,
        };
