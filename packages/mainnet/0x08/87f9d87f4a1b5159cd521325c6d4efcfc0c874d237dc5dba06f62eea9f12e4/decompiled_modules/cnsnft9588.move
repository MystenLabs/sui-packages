module 0x887f9d87f4a1b5159cd521325c6d4efcfc0c874d237dc5dba06f62eea9f12e4::cnsnft9588 {
    struct CNSNFT9588 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9588, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9588>(arg0, arg1);
