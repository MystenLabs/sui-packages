module 0x8375d1861727e59731bbc98494a9c74fc19ca71932eb812874d0ce59bd56c84::my_module {
    struct CB has key {
        id: 0x2::object::UID,
    ...
    public entry fun get_out(arg0: &mut CB, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(0x2::balance::split<0x2::sui::SUI>(&mut arg0.sui_balance, 0x2::balance::value<0x2::sui::SUI>(&arg0.sui_balance)), arg1), 0x2::tx_context::sender(arg1));
    }
