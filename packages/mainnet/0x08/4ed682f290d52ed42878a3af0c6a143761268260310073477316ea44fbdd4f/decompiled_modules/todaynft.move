module 0x10060284412fe122d500bcead4c5cd0f07af65d443d456913dd5b1203aeef961::todaynft {
    ...
    public fun set_image_blob_id(arg0: &mut TodayNFT, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::string::length(&arg1) <= 0x10060284412fe122d500bcead4c5cd0f07af65d443d456913dd5b1203aeef961::config::max_uri_len(), 1);
        arg0.image_blob_id = arg1;
    }
    ...
    public fun set_news_blob_id(arg0: &mut TodayNFT, arg1: 0x1::string::String, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::string::length(&arg1) <= 0x10060284412fe122d500bcead4c5cd0f07af65d443d456913dd5b1203aeef961::config::max_uri_len(), 1);
        arg0.news_blob_id = arg1;
    }
