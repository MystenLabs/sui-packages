module 0x895a5f05fdafdaf39ef33e5330ff7de551945db745b22819c367cba281b1e60::cnsnft2596 {
    struct CNSNFT2596 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2596, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2596>(arg0, arg1);
