module 0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::config {
    ...
    struct GlobalConfig has store, key {
        ...
        acl: 0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::ACL,
        package_version: u64,
    }
    ...
    public fun acl(arg0: &GlobalConfig) : &0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::ACL {
        &arg0.acl
    }
    ...
    public fun cancel(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::cancel(&mut arg0.acl, arg1, arg2, arg3);
    }

    public fun execute(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::execute(&mut arg0.acl, arg1, arg2, arg3);
    }

    public fun get_fund_receiver(arg0: &GlobalConfig) : address {
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::get_fund_receiver(&arg0.acl)
    }

    public fun get_reward_receiver(arg0: &GlobalConfig) : address {
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::get_reward_receiver(&arg0.acl)
    }
    ...
    public fun propose(arg0: &mut GlobalConfig, arg1: u8, arg2: u8, arg3: address, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : u64 {
        checked_package_version(arg0);
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::propose(&mut arg0.acl, arg1, arg2, arg3, arg4, arg5)
    }
    ...
    public fun set_publisher(arg0: &mut GlobalConfig, arg1: 0x2::package::Publisher, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::set_publisher(&mut arg0.acl, arg1, arg2, arg3);
    }
    ...
    public fun set_upgrade_cap(arg0: &mut GlobalConfig, arg1: 0x2::package::UpgradeCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::set_upgrade_cap(&mut arg0.acl, arg1, arg2, arg3);
    }

    public fun vote(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::vote(&mut arg0.acl, arg1, arg2, arg3);
    }
    ...
    public fun add_update_bin_step(arg0: &mut GlobalConfig, arg1: u16, arg2: u32, arg3: u16, arg4: u16, arg5: u16, arg6: u32, arg7: u16, arg8: u32, arg9: &0x2::tx_context::TxContext) {
        ...
        0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::fee_helper::verify_protocol_share(arg7);
    ...
    public fun check_config_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::has_role(&arg0.acl, arg1, 0), 5003);
    }

    public fun check_pool_manager_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::has_role(&arg0.acl, arg1, 1), 5003);
    }

    public fun check_reward_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::has_role(&arg0.acl, arg1, 2), 5003);
    }

    public fun check_upgrade_role(arg0: &GlobalConfig, arg1: address) {
        assert!(0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::has_role(&arg0.acl, arg1, 3), 5003);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0x808f9627fe1e4e839875c91b2c484e12f5d674281d25c94546a79480255106c::acl::new(arg0),
            package_version       : 1,
        };
