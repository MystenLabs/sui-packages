module 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap {
    ...
    fun add_liquidity_direct<T0, T1>(arg0: 0x2::coin::Coin<T0>, arg1: 0x2::coin::Coin<T1>, arg2: &mut Pool<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : (u64, u64, 0x2::coin::Coin<LSP<T0, T1>>, u64, 0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v8 = EscownCoins<T0, T1>{
            id      : 0x2::object::new(arg3),
            token_x : 0x2::balance::zero<T0>(),
            token_y : 0x2::balance::zero<T1>(),
        };
        0x2::balance::join<T0>(&mut v8.token_x, 0x2::coin::into_balance<T0>(arg0));
        0x2::balance::join<T1>(&mut v8.token_y, 0x2::coin::into_balance<T1>(arg1));
        0x2::dynamic_object_field::add<0x2::object::ID, EscownCoins<T0, T1>>(&mut arg2.id, 0x2::object::uid_to_inner(&arg2.id), v8);
        let (v9, v10) = mint<T0, T1>(arg2, 0x2::balance::value<T0>(&v8.token_x), 0x2::balance::value<T1>(&v8.token_y), arg3);
        (v2, v3, v9, v10, v6, v7)
    }
    ...
    public entry fun migrate_pool<T0, T1>(arg0: &mut Dex_Info, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        if (0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::utils::sort_token_type<T0, T1>()) {
            ...
            if (!0x2::dynamic_object_field::exists_<0x2::object::ID>(&v3.id, v4)) {
                let v5 = EscownCoins<T1, T0>{
                    id      : 0x2::object::new(arg1),
                    token_x : 0x2::balance::split<T1>(&mut v3.token_x, 0x2::balance::value<T1>(&v3.token_x)),
                    token_y : 0x2::balance::split<T0>(&mut v3.token_y, 0x2::balance::value<T0>(&v3.token_y)),
                };
                0x2::dynamic_object_field::add<0x2::object::ID, EscownCoins<T1, T0>>(&mut v3.id, v4, v5);
            };
        };
    }
