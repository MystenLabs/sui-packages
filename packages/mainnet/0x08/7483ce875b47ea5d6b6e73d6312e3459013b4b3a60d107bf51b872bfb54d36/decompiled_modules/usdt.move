module 0x87483ce875b47ea5d6b6e73d6312e3459013b4b3a60d107bf51b872bfb54d36::usdt {
    struct USDT has drop {
        dummy_field: bool,
    }

    fun init(arg0: USDT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gateway.irys.xyz/CldRBFuTxa5ltzlSX4-DdVa-mSWjBDCLG88t_eGrnTs";
        let v1 = if (0x1::vector::length<u8>(&v0) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gateway.irys.xyz/CldRBFuTxa5ltzlSX4-DdVa-mSWjBDCLG88t_eGrnTs"))
        };
