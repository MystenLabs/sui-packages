module 0x8e175f5559cd5d6598f235c91c0353e60c89f4b9b640f25b14f7dc04028abc0::cnsnft7971 {
    struct CNSNFT7971 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7971, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3649"));
        let v4 = 0x2::package::claim<CNSNFT7971>(arg0, arg1);
