module 0x8a672d970eec15ce4b2bdf83f9cce761cf9a21e3d246a17d3161c737cb70784::peanut {
    ...
    fun init(arg0: PEANUT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/CzFesN18ZPErgtLoV8CRRDfN7NJW9F7gJxkwXkf68jpA.png?size=lg&key=e38202                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<PEANUT>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PEANUT  ")))), trim_right(b"FREE THE PEANUT                 "), trim_right(b"Lets free the peanut!                                                                                                                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
