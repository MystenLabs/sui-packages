module 0x89d55f3cb372bf50cc6e09bc78c304f102aaa259b4763b0e1979005031bc0b5::cnsnft2316 {
    struct CNSNFT2316 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2316, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2316>(arg0, arg1);
