module 0x88f5f9cd326663e5930858029e3bf898bc0a6e383201ec3536fc850cfc02b17::cnsnft9940 {
    struct CNSNFT9940 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9940, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9940>(arg0, arg1);
