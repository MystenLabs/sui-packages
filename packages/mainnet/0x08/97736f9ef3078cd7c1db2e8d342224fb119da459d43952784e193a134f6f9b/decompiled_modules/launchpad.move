module 0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::launchpad {
    ...
    struct Raise<phantom T0, phantom T1> has store, key {
        ...
        success_specs: vector<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>,
        failure_specs: vector<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>,
    ...
    public entry fun accept_reservation<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &mut 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::fee::FeeManager, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::fee::deposit_launchpad_bid_fee(arg1, arg3, arg0.bid_fee, arg4, arg5);
    ...
    public fun add_deposit_raise_funds_spec<T0, T1>(arg0: &mut 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::Builder, arg1: 0x2::object::ID) {
        let v0 = 0x1::vector::empty<u8>();
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<0x2::object::ID>(&arg1));
        0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::add(arg0, 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::new_action_spec_with_typename(0x1::type_name::with_original_ids<DepositRaiseFunds<T0, T1>>(), v0, 1));
        let v1 = 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::new_builder();
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::add_id(&mut v1, b"raise_id", arg1);
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::emit_action_params(v1, 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::source_type(arg0), 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::source_id(arg0), 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::outcome_index(arg0), 0x1::string::from_ascii(0x1::type_name::into_string(0x1::type_name::with_original_ids<DepositRaiseFunds<T0, T1>>())), 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::next_action_index(arg0));
    }
    ...
    public fun add_reservation<T0, T1>(arg0: &mut UnsharedRaise<T0, T1>, arg1: address, arg2: u64) {
        ...
        assert!(v0.reservation_count < 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_reservations(), 185);
    ...
    fun assert_emergency_delay_reached<T0, T1>(arg0: &Raise<T0, T1>, arg1: &0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::emergency_cap::EmergencyCap, arg2: &0x2::clock::Clock) {
        assert!(0x2::clock::timestamp_ms(arg2) >= arg0.deadline_ms, 2);
        0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::emergency_cap::assert_ready(arg1, arg2);
    }
    ...
    public entry fun batch_claim_refund_for<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: vector<address>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 > 0, 136);
        assert!(v2 <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_batch_size(), 135);
        let v3 = 0;
        while (v3 < v2) {
    ...
    public entry fun batch_claim_tokens_for<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: vector<address>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 136);
        assert!(v0 <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_batch_size(), 135);
        ...
        while (v2 < v0) {
            ...
            let v5 = 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::math::mul_div_to_64(0x2::dynamic_field::borrow<ContributorKey, Contribution>(&arg0.id, v4).amount, arg0.tokens_for_sale_amount, v1);
    ...
    public entry fun claim_tokens<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v3 > 0, 161);
        let v4 = 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::math::mul_div_to_64(v2.amount, arg0.tokens_for_sale_amount, v3);
        if (v4 > 0) {
    ...
    public entry fun cleanup_failed_raise<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &CreatorCap, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.success_specs = 0x1::vector::empty<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>();
    ...
    fun completion_intent_already_executed(arg0: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account) : bool {
        let v0 = 0x1::string::utf8(0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::dao_init_intent_key());
        ...
        let v2 = 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::execution_times<0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_outcome::DaoInitOutcome>(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::get<0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_outcome::DaoInitOutcome>(v1, v0));
    ...
    public entry fun contribute<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &mut 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::fee::FeeManager, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.state == 0, 1);
        assert!(arg0.intents_locked, 123);
        assert!(0x2::clock::timestamp_ms(arg4) >= arg0.start_time_ms, 1);
        assert!(0x2::clock::timestamp_ms(arg4) < arg0.deadline_ms, 1);
    ...
    public fun create_completion_intents<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &mut 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg2: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::object::id<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account>(arg1) == arg0.account_id, 141);
        if (arg0.state != 2 && arg0.final_raise_amount >= arg0.min_raise_amount) {
            assert!(0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&arg0.success_specs) > 0, 179);
            arg0.state = 3;
            arg0.completion_started_ms = 0x1::option::some<u64>(0x2::clock::timestamp_ms(arg3));
            0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::create_intents_from_specs_for_launchpad(arg1, arg2, &arg0.success_specs, 0x2::object::id<Raise<T0, T1>>(arg0), arg3, arg4);
        } else {
            arg0.state = 2;
            ...
            if (!0x1::vector::is_empty<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&arg0.failure_specs)) {
                let v1 = 0x2::object::id<Raise<T0, T1>>(arg0);
                if (!failure_intent_active(v1, arg1, arg3)) {
                    0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::cancel_launchpad_intent_if_present(arg1, arg2, v1, arg4);
                    0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::create_intents_from_specs_for_launchpad(arg1, arg2, &arg0.failure_specs, v1, arg3, arg4);
                };
            };
        };
    }

    public fun create_raise<T0, T1>(arg0: &0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::Factory, arg1: &mut 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::fee::FeeManager, arg2: 0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::LaunchpadAccountReceipt<T0>, arg3: &0x2::coin_registry::Currency<T0>, arg4: &0x2::coin_registry::Currency<T1>, arg5: address, arg6: 0x1::string::String, arg7: u64, arg8: u64, arg9: 0x1::option::Option<u64>, arg10: u64, arg11: bool, arg12: 0x1::string::String, arg13: vector<0x1::string::String>, arg14: vector<0x1::string::String>, arg15: u64, arg16: u64, arg17: 0x2::coin::Coin<0x2::sui::SUI>, arg18: &0x2::clock::Clock, arg19: &mut 0x2::tx_context::TxContext) : UnsharedRaise<T0, T1> {
        assert!(!0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::is_paused(arg0), 15);
        0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::fee::deposit_launchpad_creation_payment(arg1, arg17, arg18, arg19);
        let (v0, v1) = 0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::consume_launchpad_receipt<T0>(arg2);
        let v2 = v1;
        assert!(arg7 > 0, 150);
        assert!(arg8 >= arg7, 163);
        assert!(0x2::coin::value<T0>(&v2) > 0, 150);
        assert!(arg10 >= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_min_duration_ms(), 151);
        assert!(arg10 <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_duration_ms(), 151);
        if (0x1::option::is_some<u64>(&arg9)) {
            assert!(*0x1::option::borrow<u64>(&arg9) <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_start_delay_ms(), 151);
        };
        assert!(0x1::string::length(&arg6) <= 64, 152);
        assert!(0x1::string::length(&arg12) <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_description_length(), 152);
        assert!(!0x2::coin_registry::is_regulated<T0>(arg3), 168);
        assert!(0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::is_stable_type_allowed<T1>(arg0), 14);
        ...
        assert!(0x1::vector::length<0x1::string::String>(&arg13) <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_metadata_pairs(), 154);
        init_raise<T0, T1>(v0, v2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, 0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::launchpad_bid_fee(arg0), arg18, arg19)
    }

    public fun create_raise_with_account_setup<T0, T1>(arg0: &mut 0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::Factory, arg1: &mut 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::fee::FeeManager, arg2: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg3: 0x2::coin::TreasuryCap<T0>, arg4: 0x1::option::Option<0x2::coin_registry::MetadataCap<T0>>, arg5: &0x2::coin_registry::Currency<T0>, arg6: &0x2::coin_registry::Currency<T1>, arg7: u64, arg8: 0x1::ascii::String, arg9: address, arg10: 0x1::string::String, arg11: u64, arg12: u64, arg13: 0x1::option::Option<u64>, arg14: u64, arg15: bool, arg16: 0x1::string::String, arg17: vector<0x1::string::String>, arg18: vector<0x1::string::String>, arg19: u64, arg20: u64, arg21: 0x2::coin::Coin<0x2::sui::SUI>, arg22: &0x2::clock::Clock, arg23: &mut 0x2::tx_context::TxContext) : UnsharedRaise<T0, T1> {
        let v0 = 0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::setup_dao_account_for_launchpad<T0, T1>(arg0, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg22, arg23);
    ...
    public fun do_init_deposit_raise_funds<T0: store, T1, T2, T3: copy + drop>(arg0: &mut 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::executable::Executable<T0>, arg1: &mut 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg2: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg3: &mut Raise<T1, T2>, arg4: T3, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = ExecutionProgressWitness{dummy_field: false};
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::assert_execution_authorized<T0, ExecutionProgressWitness>(arg1, arg2, arg0, v0);
        ...
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_validation::assert_action_type<DepositRaiseFunds<T1, T2>>(v1);
        assert!(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::action_spec_version(v1) == 1, 171);
        ...
        assert!(arg3.account_id == 0x2::object::id<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account>(arg1), 141);
        ...
        assert!(v4 >= v3, 150);
        let v5 = 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::math::mul_div_mixed((v3 as u128), 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::price_precision_scale(), (arg3.tokens_for_sale_amount as u128));
        assert!(v5 > 0, 169);
        let v6 = ExecutionProgressWitness{dummy_field: false};
        0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::futarchy_config::set_launchpad_initial_price_from_execution<T0, ExecutionProgressWitness>(arg1, arg2, arg0, v6, v5);
        ...
        let v11 = v3 - v9 - v10;
        if (v11 > 0) {
            0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::vault::deposit_approved<0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::futarchy_config::FutarchyConfig, T2>(arg1, arg2, 0x1::string::utf8(b"treasury"), 0x2::coin::from_balance<T2>(0x2::balance::split<T2>(&mut arg3.stable_coin_vault, v11), arg5));
        };
        if (v9 > 0) {
        ...
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::executable::increment_action_idx<T0, DepositRaiseFunds<T1, T2>, ExecutionProgressWitness>(arg0, arg2, v12);
    }

    public entry fun emergency_sweep_raise_token_vault_to_sender<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::emergency_cap::EmergencyCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun emergency_sweep_stable_coin_vault_to_sender<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &0x5733b07a4ec3f22fa7e0e1420d9493766307009dadbe2265324d3b79a5880758::emergency_cap::EmergencyCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert_emergency_delay_reached<T0, T1>(arg0, arg1, arg3);
        let v0 = 0x2::balance::value<T1>(&arg0.stable_coin_vault);
        let v1 = if (arg2 == 0 || arg2 > v0) {
            v0
    ...
    fun failure_intent_active(arg0: 0x2::object::ID, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg2: &0x2::clock::Clock) : bool {
        let v0 = 0x1::string::utf8(0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::dao_init_intent_key());
        let v1 = 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::intents(arg1);
        if (!0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::contains(v1, v0)) {
            return false
        };
        let v2 = 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::get<0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_outcome::DaoInitOutcome>(v1, v0);
        if (!0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_outcome::is_for_raise(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::outcome<0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_outcome::DaoInitOutcome>(v2), arg0)) {
            return false
        };
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::expiration_time<0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_outcome::DaoInitOutcome>(v2) > 0x2::clock::timestamp_ms(arg2)
    }
    ...
    public fun finalize_completion_execution<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &mut 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg2: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg3: 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::executable::Executable<0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_outcome::DaoInitOutcome>, arg4: 0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::DaoInitExecutionTicket, arg5: &0x2::clock::Clock) {
        assert!(0x2::object::id<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account>(arg1) == arg0.account_id, 141);
        0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::finalize_execution(arg1, arg2, arg3, arg4, arg5);
        if (arg0.state == 3) {
            mark_completion_success<T0, T1>(arg0, arg1);
        };
    }

    public entry fun force_fail_raise<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::Factory, arg2: &0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::FactoryOwnerCap, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::factory::assert_valid_owner_cap(arg1, arg2);
        assert!(arg0.state == 0, 155);
    ...
    fun init_raise<T0, T1>(arg0: 0x2::object::ID, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::coin_registry::Currency<T0>, arg3: &0x2::coin_registry::Currency<T1>, arg4: address, arg5: 0x1::string::String, arg6: u64, arg7: u64, arg8: 0x1::option::Option<u64>, arg9: u64, arg10: bool, arg11: 0x1::string::String, arg12: vector<0x1::string::String>, arg13: vector<0x1::string::String>, arg14: u64, arg15: u64, arg16: u64, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) : UnsharedRaise<T0, T1> {
        ...
        assert!(0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::math::mul_div_mixed((arg6 as u128), 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::price_precision_scale(), (v0 as u128)) > 0, 169);
        ...
        let v4 = Raise<T0, T1>{
            ...
            success_specs                  : 0x1::vector::empty<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(),
            failure_specs                  : 0x1::vector::empty<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(),
    ...
    public fun lock_and_share_raise<T0, T1>(arg0: UnsharedRaise<T0, T1>) {
        ...
        let v4 = 0;
        let v5 = 0;
        while (v5 < 0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(v3)) {
            let v6 = 0x1::vector::borrow<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(v3, v5);
            if (0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::action_spec_type(v6) == 0x1::type_name::with_original_ids<DepositRaiseFunds<T0, T1>>()) {
                v4 = v4 + 1;
                let v7 = 0x2::bcs::new(*0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::action_spec_data(v6));
                0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::bcs_validation::validate_all_bytes_consumed(v7);
        ...
        assert!(v4 >= 1, 181);
        assert!(v4 == 1, 182);
        assert!(0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v2.failure_specs) > 0, 190);
        v2.intents_locked = true;
        0x2::transfer::transfer<CreatorCap>(v1, v2.creator);
        0x2::transfer::public_share_object<Raise<T0, T1>>(v2);
    }

    fun mark_completion_success<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account) {
        assert!(0x2::object::id<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account>(arg1) == arg0.account_id, 141);
    ...
    public fun new_failure_builder<T0, T1>(arg0: &UnsharedRaise<T0, T1>) : 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::Builder {
        0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::new(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::source_launchpad_failure(), 0x2::object::id<Raise<T0, T1>>(&arg0.raise), 1)
    }

    public fun new_success_builder<T0, T1>(arg0: &UnsharedRaise<T0, T1>) : 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::Builder {
        0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::new(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::source_launchpad_success(), 0x2::object::id<Raise<T0, T1>>(&arg0.raise), 0)
    }
    ...
    public entry fun reconcile_completion_state<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun rollback_completion_after_timeout<T0, T1>(arg0: &mut Raise<T0, T1>, arg1: &mut 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg2: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.state == 3, 174);
        assert!(0x2::object::id<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account>(arg1) == arg0.account_id, 141);
        ...
        0x897736f9ef3078cd7c1db2e8d342224fb119da459d43952784e193a134f6f9b::dao_init_executor::cancel_launchpad_intent_if_present(arg1, arg2, 0x2::object::id<Raise<T0, T1>>(arg0), arg4);
        arg0.state = 2;
        arg0.completion_started_ms = 0x1::option::none<u64>();
    ...
    public fun stage_failure_intent<T0, T1>(arg0: &mut UnsharedRaise<T0, T1>, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg2: 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::Builder, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0.raise;
        assert!(v0.state == 0, 155);
        assert!(!v0.intents_locked, 113);
        let v1 = 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::into_vector(arg2);
        let v2 = 0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v1);
        assert!(v2 > 0, 16);
        assert!(0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v0.failure_specs) + v2 <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_init_actions(), 110);
        let v3 = 0x1::vector::empty<0x1::string::String>();
        let v4 = 0;
        while (v4 < 0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v1)) {
            0x1::vector::push_back<0x1::string::String>(&mut v3, 0x1::string::from_ascii(0x1::type_name::into_string(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::action_spec_type(0x1::vector::borrow<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v1, v4)))));
            v4 = v4 + 1;
        };
        0x1::vector::append<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&mut v0.failure_specs, v1);
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::emit_intent_actions(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::source_launchpad_failure(), 0x2::object::id<Raise<T0, T1>>(v0), 1, v3);
    }

    public fun stage_success_intent<T0, T1>(arg0: &mut UnsharedRaise<T0, T1>, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg2: 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::Builder, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0.raise;
        assert!(v0.state == 0, 155);
        assert!(!v0.intents_locked, 113);
        let v1 = 0xbe96f5469a522974f1226110b2753076587eeed890c01700a3bb14e528c956ee::action_spec_builder::into_vector(arg2);
        let v2 = 0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v1);
        assert!(v2 > 0, 16);
        assert!(0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v0.success_specs) + v2 <= 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::launchpad_max_init_actions(), 110);
        let v3 = 0x1::vector::empty<0x1::string::String>();
        let v4 = 0;
        while (v4 < 0x1::vector::length<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v1)) {
            0x1::vector::push_back<0x1::string::String>(&mut v3, 0x1::string::from_ascii(0x1::type_name::into_string(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::action_spec_type(0x1::vector::borrow<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&v1, v4)))));
        ...
        0x1::vector::append<0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::intents::ActionSpec>(&mut v0.success_specs, v1);
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::emit_intent_actions(0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::action_events::source_launchpad_success(), 0x2::object::id<Raise<T0, T1>>(v0), 0, v3);
    }
