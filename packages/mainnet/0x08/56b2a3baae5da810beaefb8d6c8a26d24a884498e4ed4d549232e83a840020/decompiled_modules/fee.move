module 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::fee {
    struct FEE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: FEE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = FeeManager{
            ...
            dao_creation_fee                      : 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::default_dao_creation_fee(),
            proposal_creation_fee_per_outcome     : 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::default_proposal_fee_per_outcome(),
            launchpad_creation_fee                : 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::default_launchpad_creation_fee(),
            ...
            dao_fee_baseline                      : 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::default_dao_creation_fee(),
            proposal_fee_baseline                 : 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::default_proposal_fee_per_outcome(),
            launchpad_fee_baseline                : 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::default_launchpad_creation_fee(),
    ...
    fun max_allowed_from_baseline(arg0: u64) : u64 {
        if (arg0 > 18446744073709551615 / 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::max_fee_multiplier()) {
            18446744073709551615
        } else {
            arg0 * 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::max_fee_multiplier()
        }
    }
    ...
    public fun update_coin_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 >= v0.creation_baseline_reset_timestamp + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms()) {
        ...
        if (arg3 <= v0.dao_creation_fee) {
            ...
            v0.pending_creation_fee_effective_timestamp = 0x1::option::some<u64>(v1 + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms());
        };
    }
    ...
    public fun update_coin_proposal_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, CoinFeeConfig>(&mut arg0.id, arg2);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        if (v1 >= v0.proposal_baseline_reset_timestamp + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms()) {
        ...
        if (arg3 <= v0.proposal_creation_fee_per_outcome) {
            ...
            v0.pending_proposal_fee_effective_timestamp = 0x1::option::some<u64>(v1 + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms());
        };
    }
    ...
    public entry fun update_dao_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 >= arg0.dao_baseline_reset_ts + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms()) {
        ...
        if (arg2 <= v1) {
            ...
            let v3 = v0 + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms();
    ...
    public entry fun update_launchpad_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        apply_pending_global_fees(arg0, arg3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        if (v0 >= arg0.launchpad_baseline_reset_ts + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms()) {
    ...
    public entry fun update_proposal_creation_fee(arg0: &mut FeeManager, arg1: &FeeAdminCap, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        apply_pending_global_fees(arg0, arg3);
        let v0 = 0x2::clock::timestamp_ms(arg3);
        if (v0 >= arg0.proposal_baseline_reset_ts + 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::six_months_ms()) {
