module 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::protective_ask_registry {
    ...
    public fun ask_count(arg0: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry) : u64 {
        if (!has_registry(arg0)) {
            return 0
        };
        let v0 = ProtectiveAskKey{dummy_field: false};
        0x1::vector::length<ProtectiveAskRecord>(&0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::borrow_managed_data_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v0, 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::markets_core_version::current()).records)
    }

    public fun ask_ids(arg0: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry) : vector<0x2::object::ID> {
        if (!has_registry(arg0)) {
            return 0x1::vector::empty<0x2::object::ID>()
        };
        let v0 = ProtectiveAskKey{dummy_field: false};
        let v1 = 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::borrow_managed_data_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v0, 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::markets_core_version::current());
    ...
    fun clear_internal(arg0: &mut 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg2: 0x2::object::ID) {
        ...
        let v0 = ProtectiveAskKey{dummy_field: false};
        let v1 = 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::borrow_managed_data_mut_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v0, 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::markets_core_version::current());
        let v2 = 0;
    ...
    public fun has_registry(arg0: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account) : bool {
        let v0 = ProtectiveAskKey{dummy_field: false};
        0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::has_managed_data<ProtectiveAskKey>(arg0, v0)
    }
    ...
    fun set_internal(arg0: &mut 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::Account, arg1: &0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::package_registry::PackageRegistry, arg2: 0x2::object::ID, arg3: 0x2::object::ID) {
        if (!has_registry(arg0)) {
            ...
            0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::add_managed_data_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v3, v2, 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::markets_core_version::current());
        } else {
            let v4 = ProtectiveAskKey{dummy_field: false};
            let v5 = 0x8a0ce6b60836f32d52c7aed958f9f319cf3cb654c227cbb1806fdcaa0ad737e1::account::borrow_managed_data_mut_with_package_witness<ProtectiveAskKey, ProtectiveAskRegistry>(arg0, arg1, v4, 0x856b2a3baae5da810beaefb8d6c8a26d24a884498e4ed4d549232e83a840020::markets_core_version::current());
            assert!(0x1::vector::length<ProtectiveAskRecord>(&v5.records) < 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants::max_protective_asks_per_dao(), 1);
