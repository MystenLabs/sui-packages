module 0x87e538c508fccdd5f65fa8022c9abdd141b85b57bd90ddb710674a9822b9b1e::seed_mon_box {
    ...
    fun init(arg0: SEED_MON_BOX, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreibrfnnttkx6re5ttnnim4q4erbylsxlbw3krodmiju2y7c5cimhiq"));
