module 0x820f7097c86c5f96bec9295d6845fe2ceeba46a68ea0fe6bb56f579e497fc12::cnsnft6913 {
    struct CNSNFT6913 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6913, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7860"));
        let v4 = 0x2::package::claim<CNSNFT6913>(arg0, arg1);
