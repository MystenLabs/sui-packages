module 0x80bc0ee32af483ba8d152fdaad48b8fc2865f85ee635521f24ce2a763017c41::reward6598 {
    struct REWARD6598 has drop {
        dummy_field: bool,
    }

    struct TICKET_6598 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6598(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6598>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6598>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6598, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6598>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6598>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6598>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6598>>(v5, 0x2::tx_context::sender(arg1));
    }
