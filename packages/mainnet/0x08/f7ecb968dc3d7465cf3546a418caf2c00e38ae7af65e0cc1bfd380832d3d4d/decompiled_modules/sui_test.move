module 0x8f7ecb968dc3d7465cf3546a418caf2c00e38ae7af65e0cc1bfd380832d3d4d::sui_test {
    ...
    public fun initialize(arg0: &mut TreasuryCap<Sui_Test<MyToken>>, arg1: &mut CoinMetadata<Sui_Test<MyToken>>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        mint_and_transfer<Sui_Test<MyToken>>(arg0, arg1, 1000000000, arg2, arg3);
        freeze_metadata<Sui_Test<MyToken>>(arg0, arg1);
    }
