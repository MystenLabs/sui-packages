module 0x8f3bbefc43550d4a6016437c844922f1ad5627941c839d661a38743e70e5890::reward_nft_w4 {
    struct REWARD_NFT_W4 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmNviBz8PS5jtdfoP6E8C7S7kR1m9Z6jotXBvyqECqLxdV"),
    ...
    fun init(arg0: REWARD_NFT_W4, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmNviBz8PS5jtdfoP6E8C7S7kR1m9Z6jotXBvyqECqLxdV"));
        ...
        let v4 = 0x2::package::claim<REWARD_NFT_W4>(arg0, arg1);
