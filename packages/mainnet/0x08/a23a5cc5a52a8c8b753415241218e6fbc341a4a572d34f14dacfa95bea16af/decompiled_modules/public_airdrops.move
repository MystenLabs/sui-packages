module 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::public_airdrops {
    ...
    entry fun claim_airdrop<T0>(arg0: &mut 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::DropletRegistry, arg1: &mut Droplet<T0>, arg2: 0x1::option::Option<0x1::string::String>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    entry fun create_droplet<T0>(arg0: &mut 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::DropletRegistry, arg1: u64, arg2: u64, arg3: 0x1::option::Option<u64>, arg4: 0x1::string::String, arg5: u8, arg6: u8, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0 && arg2 <= 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::max_receiver_limit(), 1);
        assert!(arg1 > 0, 2);
        assert!(arg5 <= 1, 14);
        assert!(arg6 <= 1, 17);
        ...
        let v3 = v1 + v2 * 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::ms_per_hour();
        let v4 = arg1 * 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::fee_percentage(arg0) / 10000;
        let v5 = arg1 + v4;
        assert!(0x2::coin::value<T0>(&arg7) >= v5, 2);
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg7, v4, arg9), 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::contract_owner());
        };
        ...
        assert!(v7 == arg1, 2);
        let v8 = 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::admin::generate_droplet_id(v0, v1, arg9);
        let v9 = 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::coin_type_name<T0>();
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::accumulate_fee(arg0, v9, v4);
        let v10 = Droplet<T0>{
        ...
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::register_droplet(arg0, v8, v12);
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::update_user_history(arg0, v0, v8, true);
        ...
        let v14 = if (arg5 == 0) {
            0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::calculate_claim_amount(v7, arg2)
        } else {
            0
        };
