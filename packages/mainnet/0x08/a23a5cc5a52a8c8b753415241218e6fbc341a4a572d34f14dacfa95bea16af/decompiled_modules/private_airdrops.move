module 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::private_airdrops {
    ...
    entry fun batch_direct_send<T0>(arg0: &mut 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::DropletRegistry, arg1: u8, arg2: vector<address>, arg3: 0x1::option::Option<vector<u64>>, arg4: 0x2::coin::Coin<T0>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v3 * 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::fee_percentage(arg0) / (10000 + 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::fee_percentage(arg0));
        let v5 = v3 - v4;
        assert!(v5 > 0, 2);
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg4, v4, arg6), 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::contract_owner());
        };
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::accumulate_fee(arg0, 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::coin_type_name<T0>(), v4);
        if (arg1 == 0) {
            let v6 = v5 / v0;
            assert!(v6 > 0, 2);
            let v7 = 0;
            ...
            let v11 = 0;
            while (v11 < v0) {
                let v12 = 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::generate_random_weight(v1, v11, v2, 0x1::string::utf8(b"BATCH"));
    ...
    entry fun claim_private_airdrop<T0>(arg0: &mut 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::DropletRegistry, arg1: &mut Droplet<T0>, arg2: 0x1::option::Option<0x1::string::String>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (arg1.distribution_type == 2) {
            ...
            *0x2::table::borrow<u64, u64>(&arg1.random_shares, *0x2::table::borrow<address, u64>(&arg1.address_to_index, v0))
            ...
            0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::calculate_claim_amount(v2, arg1.receiver_limit - arg1.num_claimed)
        };
        assert!(v3 > 0, 8);
        let v4 = if (v3 > v2) {
            v2
        ...
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::update_user_history(arg0, v0, arg1.droplet_id, false);
        let v5 = DropletClaimed{
            droplet_id         : arg1.droplet_id,
            claimer            : v0,
            token_type         : 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::coin_type_name<T0>(),
            claim_amount       : v4,
    ...
    entry fun create_private_airdrop<T0>(arg0: &mut 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::DropletRegistry, arg1: u64, arg2: 0x1::option::Option<u64>, arg3: 0x1::string::String, arg4: u8, arg5: u8, arg6: vector<address>, arg7: 0x1::option::Option<vector<u64>>, arg8: 0x2::coin::Coin<T0>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = if (0x1::option::is_some<u64>(&arg2)) {
            ...
            0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::default_expiry_hours()
        };
        let v4 = v2 + v3 * 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::ms_per_hour();
        let v5 = arg1 * 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::fee_percentage(arg0) / 10000;
        let v6 = arg1 + v5;
        assert!(0x2::coin::value<T0>(&arg8) >= v6, 2);
        if (v5 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg8, v5, arg10), 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::contract_owner());
        };
        ...
        assert!(v8 == arg1, 2);
        let v9 = 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::admin::generate_droplet_id(v1, v2, arg10);
        let v10 = 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::coin_type_name<T0>();
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::accumulate_fee(arg0, v10, v5);
        ...
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::register_droplet(arg0, v9, v19);
        0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::update_user_history(arg0, v1, v9, true);
        let v20 = FeeCollected{
            droplet_id : v9,
            token_type : v10,
            fee_amount : v5,
            recipient  : 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::contract_owner(),
            timestamp  : v2,
        };
        0x2::event::emit<FeeCollected>(v20);
        let v21 = if (arg4 == 0) {
            0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::calculate_claim_amount(v8, v0)
        } else {
            0
        };
    ...
    fun precalculate_random_distribution<T0>(arg0: &mut Droplet<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        v3 = 0;
        while (v3 < v1) {
            let v7 = 0x8a23a5cc5a52a8c8b753415241218e6fbc341a4a572d34f14dacfa95bea16af::types::generate_random_weight(arg0.sender, v3, arg0.created_at, arg0.droplet_id);
