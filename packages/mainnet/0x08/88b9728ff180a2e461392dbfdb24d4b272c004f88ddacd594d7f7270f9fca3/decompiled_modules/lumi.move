module 0xabb438fbd62e6b2df5954fdf251027c9f939a694c1baa4ffc38cbc3eddabfeb7::lumi {
    ...
    public(friend) fun return_lumi_from_liquidity(arg0: &mut Vault, arg1: 0x2::coin::Coin<LUMI>) {
        assert!(!arg0.paused, 1);
        0x2::balance::join<LUMI>(&mut arg0.lumi_reserve, 0x2::coin::into_balance<LUMI>(arg1));
    }
    ...
    public(friend) fun withdraw_lumi_for_settlement(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LUMI> {
        assert!(!arg0.paused, 1);
        assert!(arg1 > 0 && arg1 <= 0x2::balance::value<LUMI>(&arg0.lumi_reserve), 2);
        0x2::coin::from_balance<LUMI>(0x2::balance::split<LUMI>(&mut arg0.lumi_reserve, arg1), arg2)
    }
