module 0x8166749ab55457addb5ff841482b2c74e0d5f586b8756631945b2c2968be340::cnsnft5019 {
    struct CNSNFT5019 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5019, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3840"));
        let v4 = 0x2::package::claim<CNSNFT5019>(arg0, arg1);
