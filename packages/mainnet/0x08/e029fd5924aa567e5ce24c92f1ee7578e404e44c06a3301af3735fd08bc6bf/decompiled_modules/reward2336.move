module 0x8e029fd5924aa567e5ce24c92f1ee7578e404e44c06a3301af3735fd08bc6bf::reward2336 {
    struct REWARD2336 has drop {
        dummy_field: bool,
    }

    struct TICKET_2336 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2336(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2336>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2336>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2336, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2336>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2336>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2336>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2336>>(v5, 0x2::tx_context::sender(arg1));
    }
