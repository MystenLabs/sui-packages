module 0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::config {
    ...
    public fun unverify_extension<T0>(arg0: &mut Config, arg1: &0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::authority::AuthorityCap<0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::authority::PACKAGE, T0>, arg2: 0x1::type_name::TypeName) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(v0)) {
            if (0x1::vector::borrow<0x1::type_name::TypeName>(v0, v1) == &arg2) {
                ...
                0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::events::emit_unverified_extension_event(arg2);
                return
            };
            v1 = v1 + 1;
        };
    ...
    public fun upgrade_version<T0>(arg0: &mut Config, arg1: &0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::authority::AuthorityCap<0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::authority::PACKAGE, T0>) {
        assert!(arg0.version == 1 - 1, 0);
        arg0.version = 1;
    }

    public fun verify_extension<T0, T1: copy + drop + store>(arg0: &mut Config, arg1: &0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::authority::AuthorityCap<0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::authority::PACKAGE, T0>, arg2: &T1) {
        assert_package_version(arg0);
        ...
        0x85891c96d7802ac09421dc2064002234b2dfcd238adaa9b20b781be1953cd50::events::emit_verified_extension_event(v0);
    }
