module 0x855b6d7d8a712a5ab48bb7a2d1c20c85cefdd51af68dc3691c59bfccb372e49::authority {
    struct PACKAGE {
        dummy_field: bool,
    }
    ...
    public fun add_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0x855b6d7d8a712a5ab48bb7a2d1c20c85cefdd51af68dc3691c59bfccb372e49::events::emit_added_authorization(0x2::object::uid_to_inner(arg0));
    }
    ...
    public fun remove_authorization(arg0: &mut 0x2::object::UID, arg1: &AuthorityCap<PACKAGE, ADMIN>) {
        ...
        0x855b6d7d8a712a5ab48bb7a2d1c20c85cefdd51af68dc3691c59bfccb372e49::events::emit_removed_authorization(0x2::object::uid_to_inner(arg0));
    }
