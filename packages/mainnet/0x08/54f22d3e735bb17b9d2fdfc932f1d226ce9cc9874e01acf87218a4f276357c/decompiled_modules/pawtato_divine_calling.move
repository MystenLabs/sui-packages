module 0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_divine_calling {
    ...
    public entry fun claim_rewards_coin<T0>(arg0: &mut DivineCallingRegistry, arg1: &mut 0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests::QuestSystem, arg2: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::StakingPool, arg3: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg4: 0x2::object::ID, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests::validate_user_representing_land(arg2, v0);
        ...
        assert!(v2.status == 4, 1705);
        assert!(0x2::table::contains<address, UserContribution>(&v2.contributors, v0), 1704);
        let v3 = 0x2::table::borrow_mut<address, UserContribution>(&mut v2.contributors, v0);
        assert!(!v3.rewards_claimed, 1706);
        let v4 = 0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::quest_helpers::calculate_boosted_influence_reward(0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests::get_package_cap(arg1), arg2, v0, 0x1::vector::borrow<ContributionTier>(&v2.contribution_tiers, (v3.tier_selected as u64)).influence_reward, arg5);
        v2.total_influence_distributed = v2.total_influence_distributed + v4;
        arg0.total_influence_distributed = arg0.total_influence_distributed + v4;
        0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests::add_land_influence(0x916f631158cdbfdc24e19cefb496c729ba8522fa8aab35c4b4875bef9544d2e5::pawtato_quests::get_package_cap(arg1), arg2, v0, v1, v4);
        let v5 = 0;
        while (v5 < 0x1::vector::length<DivineReward>(&v2.fixed_rewards)) {
            let v6 = 0x1::vector::borrow<DivineReward>(&v2.fixed_rewards, v5);
            if (v6.reward_type == 0) {
        ...
        v3.rewards_claimed = true;
        let v7 = DivineRewardsClaimed{
            calling_id          : arg4,
            user                : v0,
            land_id             : v1,
            influence_reward    : v4,
            fixed_rewards_count : 0x1::vector::length<DivineReward>(&v2.fixed_rewards),
        };
