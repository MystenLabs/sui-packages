module 0x8b5a1888c28f14685956dc7ee9d29c6929a5f8c735d088530698ffca1669122::cnsnft2957 {
    struct CNSNFT2957 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2957, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6565"));
        let v4 = 0x2::package::claim<CNSNFT2957>(arg0, arg1);
