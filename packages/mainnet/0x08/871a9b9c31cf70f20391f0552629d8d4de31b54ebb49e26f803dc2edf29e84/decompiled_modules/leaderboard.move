module 0x894f312a7256b2aad5aa7c810ef0ffca7d0db6573590b56d1ccdc208d6e78656::leaderboard {
    ...
    public entry fun submit_score(arg0: &mut EveryAddressTopScoreLeaderboard, arg1: u64, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::append<u8>(&mut v0, address_to_bytes(v1));
        ...
        if (0x2::table::contains<address, u64>(&arg0.scores, v1)) {
            let v2 = 0x2::table::borrow_mut<address, u64>(&mut arg0.scores, v1);
            if (arg1 > *v2) {
                *v2 = arg1;
            };
        } else {
