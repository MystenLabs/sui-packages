module 0x827751b9568a438a217b22c0b9edabf6cbc393ed30891c860408a295756d72a::cnsnft8606 {
    struct CNSNFT8606 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8606, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8606>(arg0, arg1);
