module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_tools {
    ...
    public fun get_idol_raffle_multiplier(arg0: &TOOL) : u64 {
        ...
        calculate_tier_based_mul(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v0, &v1), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::string_to_u64(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v0, &v2)), v3)
    }
    ...
    public(friend) fun get_processing_resource_mul(arg0: &TOOL) : u64 {
        ...
        calculate_tier_based_mul(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v1, &v2), 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::string_to_u64(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v1, &v3)), v4)
    }
    ...
    public(friend) fun set_durability_value(arg0: &mut TOOL, arg1: u64) {
        ...
        let v1 = if (arg1 == 999999) {
            ...
            0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::helpers::u64_to_string(arg1)
        };
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(&arg0.attributes, &v0)) {
