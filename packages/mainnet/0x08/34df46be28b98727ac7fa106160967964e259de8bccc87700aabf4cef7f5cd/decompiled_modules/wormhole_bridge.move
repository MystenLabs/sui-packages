module 0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::wormhole_bridge {
    ...
    public fun get_user_registry(arg0: &mut 0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::nft_market::UserRegistry) : u8 {
        12
    }

    public fun get_vaa_emitter_chain(arg0: &0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::VAA) : u16 {
        0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::emitter_chain(arg0)
    }

    public fun get_vaa_sequence(arg0: &0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::VAA) : u64 {
        0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::sequence(arg0)
    }

    public fun get_wormhole_state(arg0: &0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::state::State) : u8 {
        11
    }
    ...
    public fun register_nft_from_vaa(arg0: &0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::state::State, arg1: &mut 0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::nft_market::UserRegistry, arg2: vector<u8>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::VAA {
        let v0 = verify_and_parse_vaa(arg0, arg2, arg3);
        let v1 = 0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::payload(&v0);
        0x1::debug::print<vector<u8>>(&v1);
        assert!(0x1::vector::length<u8>(&v1) >= 74, 1);
        let (v2, v3, v4, v5, v6) = parse_nft_data(v1);
        0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::nft_market::register_wormhole_nft(arg1, v2, v3, v4, v5, v6, arg4);
        let v7 = NFTRegistered{
            origin_chain       : 0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::emitter_chain(&v0),
            token_id           : v4,
    ...
    public fun verify_and_parse_vaa(arg0: &0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::state::State, arg1: vector<u8>, arg2: &0x2::clock::Clock) : 0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::VAA {
        0x1::debug::print<vector<u8>>(&arg1);
        0x834df46be28b98727ac7fa106160967964e259de8bccc87700aabf4cef7f5cd::vaa::parse_and_verify(arg0, arg1, arg2)
    }
