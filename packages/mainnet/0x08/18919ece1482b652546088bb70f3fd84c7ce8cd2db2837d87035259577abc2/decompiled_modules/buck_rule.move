module 0x818919ece1482b652546088bb70f3fd84c7ce8cd2db2837d87035259577abc2::buck_rule {
    ...
    public fun add_stable_type<T0>(arg0: &0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::listing::ListingCap, arg1: &mut StableTypes) {
    ...
    public fun remove_stable_type<T0>(arg0: &0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::listing::ListingCap, arg1: &mut StableTypes) {
        let v0 = 0x1::type_name::get<T0>();
        0x2::vec_set::remove<0x1::type_name::TypeName>(&mut arg1.types, &v0);
    }

    public fun update_blast_off_oracle<T0>(arg0: &mut 0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::oracle::Oracle, arg1: &0x2::clock::Clock, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::state::State, arg3: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg4: &StableTypes) {
        ...
        0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::oracle::update_price<T0, Rule>(v2, arg0, arg1, 0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::config::precision() * (0x2::math::pow(10, (v1 as u8)) as u128) / (v0 as u128) * 10 / 9);
    }
