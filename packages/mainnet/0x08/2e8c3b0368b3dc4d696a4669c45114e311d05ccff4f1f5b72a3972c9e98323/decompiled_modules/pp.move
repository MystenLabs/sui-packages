module 0x82e8c3b0368b3dc4d696a4669c45114e311d05ccff4f1f5b72a3972c9e98323::pp {
    struct PP has drop {
        dummy_field: bool,
    }
    ...
    public entry fun transfer(arg0: 0x2::coin::Coin<PP>, arg1: address) {
        0x2::transfer::public_transfer<0x2::coin::Coin<PP>>(arg0, arg1);
    }

    fun init(arg0: PP, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<PP>(arg0, 9, b"PP", b"PPEDRO", b"PPPP", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"PPPP")), arg1);
        let v2 = v0;
        let v3 = 0x2::tx_context::sender(arg1);
        0x2::coin::mint_and_transfer<PP>(&mut v2, 35000000000000000, v3, arg1);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<PP>>(v2, v3);
