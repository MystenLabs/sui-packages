module 0x8f8c79c48b3cc6e6e22382cd604ffb12d8ca4c231cdd9814c95604d1c8aa7ae::reward3967 {
    struct REWARD3967 has drop {
        dummy_field: bool,
    }

    struct TICKET_3967 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3967(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3967>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3967>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3967, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3967>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3967>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3967>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3967>>(v5, 0x2::tx_context::sender(arg1));
    }
