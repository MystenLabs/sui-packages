module 0x8401888c3a5bff5363bea1cf023ea8ac1a943ee0f82ed799027d9e80b227759::cnsnft3494 {
    struct CNSNFT3494 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3494, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3494>(arg0, arg1);
