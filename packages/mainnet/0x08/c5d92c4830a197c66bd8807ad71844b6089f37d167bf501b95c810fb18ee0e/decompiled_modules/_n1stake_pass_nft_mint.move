module 0x8c5d92c4830a197c66bd8807ad71844b6089f37d167bf501b95c810fb18ee0e::_n1stake_pass_nft_mint {
    struct _N1STAKE_PASS_NFT_MINT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: _N1STAKE_PASS_NFT_MINT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<_N1STAKE_PASS_NFT_MINT>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" n1stake Pass NFT Mint"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"This is n1stake Pass NFT #68, part of an n1stake collection."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreia2vme2v4wxib4wutparkukhkpj3wasqak7agspv3ajvfiel47kam"));
