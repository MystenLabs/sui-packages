module 0x8221a583d020c3d96ed17e15a0a9e602a0ffb6dabe897ec05e116fc85f10b6e::bera {
    ...
    fun init(arg0: BERA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/FKFKP5URLE8E2PK8j7RRSjxCtMbasd6zw8eCkXTwpump.png?size=lg&key=00303e                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<BERA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Bera      ")))), trim_right(b"Berachain                       "), trim_right(b"Berachain                                                                                                                                                                                                                                                                                                                       "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
