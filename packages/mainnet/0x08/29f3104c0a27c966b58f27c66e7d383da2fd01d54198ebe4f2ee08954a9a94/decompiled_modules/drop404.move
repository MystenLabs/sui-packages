module 0x829f3104c0a27c966b58f27c66e7d383da2fd01d54198ebe4f2ee08954a9a94::drop404 {
    struct DROP404 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: DROP404, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<DROP404>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"drop404"));
