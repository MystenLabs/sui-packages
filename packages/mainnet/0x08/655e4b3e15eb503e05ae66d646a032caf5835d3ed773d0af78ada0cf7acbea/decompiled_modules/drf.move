module 0x8655e4b3e15eb503e05ae66d646a032caf5835d3ed773d0af78ada0cf7acbea::drf {
    ...
    fun init(arg0: DRF, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<DRF>(arg0, 6, b"DRF", b"$DRF", b"$DRF is Drife's token", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://static.wixstatic.com/media/3af3d0_ddce8ac5003346b498d4f3bb449d53a0~mv2.png/v1/fill/w_1474,h_722,al_c,q_90,usm_0.66_1.00_0.01,enc_auto/drf%20coin%20web1.png")), true, arg1);
        let v3 = v0;
