module 0x8292b4c06ed6b2f72463c41fab735870f13b89592e0196e0a3fc0c60564d1e1::reward2794 {
    struct REWARD2794 has drop {
        dummy_field: bool,
    }

    struct TICKET_2794 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket2794(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2794>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2794>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2794, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2794>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2794>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2794>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2794>>(v5, 0x2::tx_context::sender(arg1));
    }
