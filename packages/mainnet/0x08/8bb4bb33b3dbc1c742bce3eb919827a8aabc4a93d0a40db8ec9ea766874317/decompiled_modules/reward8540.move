module 0x88bb4bb33b3dbc1c742bce3eb919827a8aabc4a93d0a40db8ec9ea766874317::reward8540 {
    struct REWARD8540 has drop {
        dummy_field: bool,
    }

    struct TICKET_8540 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8540(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8540>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8540>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8540, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8540>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8540>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8540>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8540>>(v5, 0x2::tx_context::sender(arg1));
    }
