module 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_exposure {
    ...
    public(friend) fun live_close_inventory_impact(arg0: &StrikeExposure, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        inventory_impact_potential_for_liability(arg0, live_payout_liability_from_terms(arg0, v0, v1)) - inventory_impact_potential_for_liability(arg0, live_payout_liability_from_terms(arg0, 0x1::u64::max(0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_payout_tree::range_max_payout(&arg0.payout, arg1, arg2) - arg3, 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_payout_tree::complement_max_payout(&arg0.payout, arg1, arg2)), v1 - arg3))
    }
    ...
    public(friend) fun max_quantity_for_premium(arg0: &MintRange, arg1: u64) : u64 {
        let v0 = 10000;
        let v1 = 0;
        let v2 = 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::order::max_quantity_lots();
        while (v1 < v2) {
            let v3 = (v1 + v2 + 1) / 2;
            if (mint_range_premium(arg0, v3 * v0) <= arg1) {
                v1 = v3;
                continue
            };
            v2 = v3 - 1;
    ...
    public(friend) fun mint_range_inventory_impact(arg0: &StrikeExposure, arg1: &MintRange, arg2: u64) : u64 {
        if (0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_exposure_config::inventory_impact_max_rate(&arg0.config) == 0 || arg2 == 0) {
            return 0
        };
        inventory_impact_potential_for_liability(arg0, live_payout_liability_from_terms(arg0, 0x1::u64::max(arg1.max_payout, arg1.range_max_payout + arg2), arg1.total_payout + arg2)) - inventory_impact_potential_for_liability(arg0, live_payout_liability_from_terms(arg0, arg1.max_payout, arg1.total_payout))
    }

    public(friend) fun mint_range_premium(arg0: &MintRange, arg1: u64) : u64 {
        0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::math::mul_down(0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::pricing::probability(&arg0.price), arg1)
    }

    public(friend) fun mint_range_price(arg0: &MintRange) : &0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::pricing::RangePrice {
        &arg0.price
    }

    public(friend) fun mint_terms(arg0: &StrikeExposure, arg1: MintRange, arg2: u64, arg3: u64) : MintTerms {
        assert!(arg1.expiry_market_id == arg0.expiry_market_id, 4);
        assert!(arg2 >= arg3, 5);
        0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::order::assert_valid_quantity(arg2);
        let MintRange {
            expiry_market_id : v0,
            lower_tick       : v1,
            higher_tick      : v2,
        ...
        MintTerms{
            ...
            quantity                : arg2,
            price                   : v3,
            premium                 : 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_exposure_config::assert_mint_admission(&arg0.config, 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::pricing::probability(&arg1.price), arg2),
            inventory_impact_charge : mint_range_inventory_impact(arg0, &arg1, arg2),
        }
    }
    ...
    public(friend) fun quote_live_close(arg0: &StrikeExposure, arg1: &0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::pricing::Pricer, arg2: &0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::order::Order, arg3: u64) : LiveCloseTerms {
        ...
        LiveCloseTerms{
            ...
            price                   : v0,
            inventory_impact_rebate : live_close_inventory_impact(arg0, 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::order::lower_tick(arg2), 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::order::higher_tick(arg2), arg3),
        }
    }

    public(friend) fun quote_mint_range(arg0: &StrikeExposure, arg1: &0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::pricing::Pricer, arg2: u64, arg3: u64) : MintRange {
        ...
        let (v1, v2, v3) = if (0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_exposure_config::inventory_impact_max_rate(&arg0.config) == 0) {
            (0, 0, 0)
        } else {
            let (v4, v5) = 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_payout_tree::payout_reserve_terms(&arg0.payout);
            (v4, v5, 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::strike_payout_tree::range_max_payout(&arg0.payout, arg2, arg3))
        };
        MintRange{
            expiry_market_id : arg0.expiry_market_id,
            lower_tick       : arg2,
    ...
    public(friend) fun quote_mint_terms(arg0: &StrikeExposure, arg1: &0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::pricing::Pricer, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: bool) : MintTerms {
        let v0 = quote_mint_range(arg0, arg1, arg2, arg3);
        let v1 = if (arg6) {
            arg5
        } else {
            max_quantity_for_premium(&v0, arg4)
        };
        mint_terms(arg0, v0, v1, arg5)
    }
