module 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::vault_events {
    ...
    struct UsdcAddedToPlp has copy, drop, store {
        pool_vault_id: 0x2::object::ID,
        contributor: address,
        amount: u64,
    }
    ...
    public(friend) fun emit_usdc_added_to_plp(arg0: 0x2::object::ID, arg1: address, arg2: u64) {
        let v0 = UsdcAddedToPlp{
            pool_vault_id : arg0,
            contributor   : arg1,
            amount        : arg2,
        };
        0x2::event::emit<UsdcAddedToPlp>(v0);
    }
