module 0x89aea622e7bb3bdd598bde87dde40ee31c9eed4971b9546e23ec83de3c48bbba::pool_accounting {
    ...
    public(friend) fun deployed_expiry_cash(arg0: &Ledger) : u64 {
        let v0 = 0;
        let v1 = &arg0.active_expiry_markets;
        let v2 = 0;
        while (v2 < 0x1::vector::length<ActiveExpiry>(v1)) {
            v0 = v0 + flow_net_funding(0x2::table::borrow<0x2::object::ID, RegisteredExpiry>(&arg0.registered_expiries, 0x1::vector::borrow<ActiveExpiry>(v1, v2).expiry_market_id));
            v2 = v2 + 1;
        };
        v0
    }
    ...
    public(friend) fun register_expiry(arg0: &mut Ledger, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) {
        ...
        let v1 = RegisteredExpiry{
            ...
            fee_incentive_lifetime_cap  : 0x52ec2d263bb9ad545d1be1c00f6779cc577ed7c0408cdea8d589c2664adc22db::math::mul_down(arg3, 100000000),
