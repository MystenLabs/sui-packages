module 0x844a1ee8c6d3702beb488b342b97c26047270237f36e7244f2172490b4937c0::capybara_money_bag_mystery {
    struct CAPYBARA_MONEY_BAG_MYSTERY has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CAPYBARA_MONEY_BAG_MYSTERY, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CAPYBARA_MONEY_BAG_MYSTERY>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Capybara Money Bag Mystery"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://Vf1AVG1e8LBqoVtEsFsrJt7WTwPkkq84t_2T2qgaa5I"));
