module 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::policy {
    ...
    public(friend) fun assert_action(arg0: &Policy, arg1: u64, arg2: u64, arg3: bool) {
        assert!(!arg3 && arg0.phase != 2, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::paused());
        assert!(arg0.phase == 0 || arg0.phase == 1, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::bad_phase());
        if (arg0.phase == 0) {
            assert!(arg1 <= arg0.pilot_deadline_ms, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::pilot_limit());
            assert!(arg0.pilot_actions_used < arg0.pilot_action_limit, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::pilot_limit());
        };
        if (arg2 > 0) {
            assert!(arg1 >= arg2 && arg1 - arg2 >= arg0.min_action_interval_ms, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::cooldown());
        };
    }

    public(friend) fun assert_creation(arg0: &Policy, arg1: u64) {
        assert!(arg0.phase == 0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::bad_phase());
        assert!(arg0.pilot_deadline_ms > arg1, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::pilot_limit());
    }
    ...
    public(friend) fun assert_swap_input(arg0: &Policy, arg1: u8, arg2: u64) {
        ...
        assert!(arg2 <= v0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::swap_input_limit());
    }
    ...
    public fun new_pilot(arg0: u64, arg1: u64, arg2: u16, arg3: u32, arg4: u32, arg5: u32, arg6: u32, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u8) : Policy {
        assert!(arg1 > 0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::pilot_limit());
        assert!(arg2 >= 2 && arg2 <= 70, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::vector_length());
        assert!(arg7 > 0 && arg7 <= 120000, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::deadline());
        assert!(arg6 <= arg5, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::active_drift());
        assert!(signed_gte(arg4, arg3), 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::bin_range());
        assert!(arg9 > 0 && arg10 > 0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::amount_limit());
        let v0 = if (arg13 > 0) {
            if (arg14 > 0) {
                arg15 > 0
            } else {
        ...
        assert!(v0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::exposure_limit());
        assert!(arg16 > 0 && arg17 > 0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::swap_input_limit());
        Policy{
            phase                    : 0,
            version                  : 1,
    ...
    public(friend) fun replace(arg0: &mut Policy, arg1: Policy) {
        ...
        assert!(v0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::exposure_limit());
        assert!(arg1.max_swap_input_a > 0 && arg1.max_swap_input_b > 0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::swap_input_limit());
        assert!(arg1.max_swap_input_a <= arg0.max_swap_input_a && arg1.max_swap_input_b <= arg0.max_swap_input_b, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::swap_input_limit());
        assert!(arg1.pilot_deadline_ms <= arg0.pilot_deadline_ms && arg1.pilot_action_limit <= arg0.pilot_action_limit, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::pilot_limit());
        *arg0 = arg1;
    ...
    public(friend) fun set_phase(arg0: &mut Policy, arg1: u8) {
        ...
        assert!(v0, 0x85928dcbc80c3245fa2146004d538f7fa5033bdecb180d3820b3118e4709bb2::errors::bad_phase());
        arg0.phase = arg1;
        arg0.version = arg0.version + 1;
    }
