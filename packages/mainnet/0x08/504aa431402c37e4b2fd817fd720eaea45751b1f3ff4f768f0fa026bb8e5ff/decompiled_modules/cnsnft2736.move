module 0x8504aa431402c37e4b2fd817fd720eaea45751b1f3ff4f768f0fa026bb8e5ff::cnsnft2736 {
    struct CNSNFT2736 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2736, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2736>(arg0, arg1);
