module 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::query {
    ...
    public fun create_with_schema<T0, T1: drop>(arg0: T1, arg1: &mut 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::protocol::Protocol, arg2: &0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::resolver::Resolver, arg3: 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::query_inner::Schema, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x1::option::Option<u64>, arg7: 0x1::option::Option<u64>, arg8: vector<0x2::object::ID>, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) : Query<T0> {
        ...
        0x1::vector::push_back<u64>(&mut v2, 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::protocol::num_queries(arg1));
        let v3 = 0x2::derived_object::claim<vector<u64>>(0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::protocol::extend(arg1), v2);
        let v4 = 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::query_inner::create<T0>(&mut v3, 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::resolver::id(arg2), arg3, arg4, arg5, 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::protocol::default_liveness_ms(arg1), arg6, arg8, 0x1::type_name::with_defining_ids<T1>(), v1, arg9);
        let v5 = Query<T0>{
            id    : v3,
            inner : 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::versioned_object::create<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::query_inner::QueryInner<T0>>(0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::query_inner::current_query_version(), v4, arg10),
        };
        let v6 = QueryCreated<T0>{
            query_id       : 0x2::object::uid_to_inner(&v5.id),
            creator        : 0x2::tx_context::sender(arg10),
            topic          : arg4,
            bond_amount    : v1,
            timestamp_ms   : arg6,
            schema_version : 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::query_inner::schema_version<T0>(&v4),
        };
        0x2::event::emit<QueryCreated<T0>>(v6);
