module 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::protocol {
    ...
    struct ProtocolInner has store, key {
        ...
        topic_schemas: 0x2::table::Table<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>,
    ...
    struct SchemaEntry has copy, drop, store {
        active: bool,
        schema: 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::Schema,
    }
    ...
    public fun deactivate_topic_schema(arg0: &mut Protocol, arg1: &ProtocolCap, arg2: vector<u8>, arg3: u64) {
        ...
        let v1 = 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::new_schema_ref(arg2, arg3);
        assert!(0x2::table::contains<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&v0.topic_schemas, v1), 7);
        0x2::table::borrow_mut<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&mut v0.topic_schemas, v1).active = false;
    ...
    public fun default_liveness_ms(arg0: &Protocol) : u64 {
    ...
    public fun fee_factor_bps(arg0: &Protocol) : u64 {
        load_inner(arg0).fee_factor_bps
    }

    public fun has_topic_schema(arg0: &Protocol, arg1: vector<u8>, arg2: u64) : bool {
        0x2::table::contains<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&load_inner(arg0).topic_schemas, 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::new_schema_ref(arg1, arg2))
    }
    ...
    public fun initialize(arg0: 0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) : (Protocol, ProtocolCap) {
        ...
        let v1 = ProtocolInner{
            ...
            topic_schemas        : 0x2::table::new<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(arg1),
        ...
        let v3 = Protocol{
            id    : v0,
            inner : 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::versioned_object::create<ProtocolInner>(1, v1, arg1),
        };
        0x2::package::burn_publisher(arg0);
        (v3, v2)
    }

    public fun is_coin_type_supported<T0>(arg0: &Protocol) : bool {
        0x2::table::contains<0x1::type_name::TypeName, bool>(&load_inner(arg0).supported_coin_types, 0x1::type_name::with_defining_ids<T0>())
    }

    fun load_inner(arg0: &Protocol) : &ProtocolInner {
        assert!(0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::versioned_object::version(&arg0.inner) == 1, 6);
        0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::versioned_object::load_value<ProtocolInner>(&arg0.inner)
    }

    fun load_inner_mut(arg0: &mut Protocol) : &mut ProtocolInner {
        assert!(0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::versioned_object::version(&arg0.inner) == 1, 6);
        0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::versioned_object::load_value_mut<ProtocolInner>(&mut arg0.inner)
    }

    public fun minimum_bond_amount<T0>(arg0: &Protocol) : u64 {
    ...
    public fun num_queries(arg0: &Protocol) : u64 {
    ...
    public fun resolver_fee<T0>(arg0: &Protocol) : u64 {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
    ...
    public fun set_topic_schema(arg0: &mut Protocol, arg1: &ProtocolCap, arg2: vector<u8>, arg3: 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::Schema) {
        ...
        let v2 = v1 + 1;
        if (v2 > 1) {
            let v3 = 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::new_schema_ref(arg2, v1);
            if (0x2::table::contains<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&v0.topic_schemas, v3)) {
                0x2::table::borrow_mut<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&mut v0.topic_schemas, v3).active = false;
            };
        };
        let v4 = SchemaEntry{
            active : true,
        ...
        0x2::table::add<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&mut v0.topic_schemas, 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::new_schema_ref(arg2, v2), v4);
    ...
    public fun topic_schema(arg0: &Protocol, arg1: vector<u8>, arg2: u64) : &0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::Schema {
        let v0 = load_inner(arg0);
        let v1 = 0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::new_schema_ref(arg1, arg2);
        assert!(0x2::table::contains<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&v0.topic_schemas, v1), 7);
        &0x2::table::borrow<0x74355104dc60857523e4367650df08c7fef8cfb08629f84ab3385d34fa063041::schema::SchemaRef, SchemaEntry>(&v0.topic_schemas, v1).schema
    }
