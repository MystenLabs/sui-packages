module 0x8050705084804deae040ab13f6770d37d78d534b51eb3d808f786b92bc999b5::parameterized {
    ...
    struct TransferDetails has copy, drop, store {
        recipient: address,
        coin_amounts: 0x2::vec_map::VecMap<0x1::ascii::String, u64>,
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v26 = *0x2::dynamic_field::borrow<vector<u8>, TransferDetails>(&arg0.id, b"details");
        v26.coin_amounts = v5;
        if (0x2::vec_map::is_empty<0x1::ascii::String, u64>(&v26.coin_amounts) && 0x1::vector::is_empty<0x1::ascii::String>(&v26.nft_types)) {
            0x2::dynamic_field::remove<vector<u8>, TransferDetails>(&mut arg0.id, b"details");
        } else {
            *0x2::dynamic_field::borrow_mut<vector<u8>, TransferDetails>(&mut arg0.id, b"details") = v26;
        };
        let v27 = DebugEvent{
    ...
    public entry fun update_transfer_details(arg0: &mut TransferParams, arg1: address, arg2: vector<0x1::ascii::String>, arg3: vector<u64>, arg4: vector<0x1::ascii::String>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = TransferDetails{
            recipient    : arg1,
            coin_amounts : 0x2::vec_map::empty<0x1::ascii::String, u64>(),
            nft_types    : arg4,
        };
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::ascii::String>(&arg2)) {
            let v2 = *0x1::vector::borrow<0x1::ascii::String>(&arg2, v1);
            0x2::vec_map::insert<0x1::ascii::String, u64>(&mut v0.coin_amounts, trim_address_zeros(&v2), *0x1::vector::borrow<u64>(&arg3, v1));
            v1 = v1 + 1;
        };
