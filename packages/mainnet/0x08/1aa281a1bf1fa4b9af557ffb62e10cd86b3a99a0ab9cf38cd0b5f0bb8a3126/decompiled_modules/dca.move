module 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::dca {
    ...
    public(friend) fun apply_fee<T0>(arg0: &mut DCAReg, arg1: &mut 0x2::coin::Coin<T0>) {
        ...
        0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::event::charge_fee<T0>(v0);
    }

    public fun assert_not_expired<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg1) <= arg0.end_time + 10 * 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::minute(), 111);
    }

    public fun assert_time_window<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) {
        assert!(0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg1) <= get_current_epoch<T0, T1>(arg0, arg1) * arg0.frequency + arg0.deposit_time + 10 * 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::minute(), 114);
    }
    ...
    public entry fun claim_fee<T0>(arg0: &mut DCAReg, arg1: &DCACap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::event::claim_fee<T0>(0x2::tx_context::sender(arg3), arg2);
    }

    public fun clear_escrow_with_cap<T0, T1>(arg0: &mut DCAReg, arg1: &DCACap, arg2: Escrow<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg3) > arg2.end_time + 10 * 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::minute() || balance_x_value<T0, T1>(&arg2) == 0 || get_current_epoch<T0, T1>(&arg2, arg3) == arg2.orders, 116);
        let v0 = arg2.owner;
        let (v1, v2) = close_escrow_<T0, T1>(arg0, arg2, arg4);
    ...
    public fun close_escrow<T0, T1>(arg0: &mut DCAReg, arg1: Escrow<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        close_escrow_<T0, T1>(arg0, arg1, arg2)
    }

    fun close_escrow_<T0, T1>(arg0: &mut DCAReg, arg1: Escrow<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        assert!(extensions_length<T0, T1>(&arg1) == 0, 107);
        ...
        0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::event::order_closed<T0, T1>(0x2::object::uid_to_inner(&v21), v1, 0x2::coin::value<T0>(&v22), 0x2::coin::value<T1>(&v23));
        (v22, v23)
    }
    ...
    public fun execute_order<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &DCACap, arg2: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, SwapReceipt<T0, T1>) {
        assert!(get_last_claimed_epoch<T0, T1>(arg0) <= get_current_epoch<T0, T1>(arg0, arg3), 104);
        assert!(arg0.filled_orders < arg0.orders, 110);
        assert!(balance_x_value<T0, T1>(arg0) > 0, 112);
        assert_time_window<T0, T1>(arg0, arg3);
        assert_not_expired<T0, T1>(arg0, arg3);
        roll_epoch<T0, T1>(arg0, arg3);
        let (v0, v1) = get_escrow_required_amount<T0, T1>(arg0, arg2, arg3);
        let v2 = SwapReceipt<T0, T1>{
            escrow_id : 0x2::object::id<Escrow<T0, T1>>(arg0),
            ts        : 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg3),
            spent     : v0,
            amount    : v1,
        };
        (0x2::coin::take<T0>(&mut arg0.balance_x, v0, arg4), v2)
    }
    ...
    public fun get_current_epoch<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        get_epoch<T0, T1>(arg0, 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg1))
    }
    ...
    public fun get_escrow_required_amount<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : (u64, u64) {
        let v0 = if (arg0.price_enabled) {
            ...
            0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::mul_div(get_output_y<T0, T1>(arg0, arg1, arg0.divided_amount, arg2), 10000 - 50, 10000)
        };
    ...
    public fun place_order<T0, T1>(arg0: &mut DCAReg, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: u64, arg6: u64, arg7: bool, arg8: u128, arg9: u128, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v6 = Escrow<T0, T1>{
            ...
            frequency              : arg5,
            divided_amount         : v1,
            last_claimed           : 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg10),
            filled_orders          : 0,
            balance_x              : v2,
            ...
            min_price              : v4,
            max_price              : v5,
            deposit_time           : 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg10),
            end_time               : 0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::utils::get_sec(arg10) + arg6 * arg5,
            total_spent            : 0,
            total_withdrawn_amount : 0,
        };
        0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::event::order_created<T0, T1>(0x2::object::id<Escrow<T0, T1>>(&v6), arg1, 0x2::coin::value<T0>(&arg2), arg6, arg5, v4, v5);
    ...
    public fun repay_order<T0, T1>(arg0: &mut DCAReg, arg1: &DCACap, arg2: &mut Escrow<T0, T1>, arg3: SwapReceipt<T0, T1>, arg4: 0x2::coin::Coin<T1>) {
        assert!(0x2::object::id<Escrow<T0, T1>>(arg2) == arg3.escrow_id, 108);
        assert!(0x2::coin::value<T1>(&arg4) >= arg3.amount, 101);
        if (arg2.price_enabled) {
            assert!(0x2::coin::value<T1>(&arg4) <= (((arg2.divided_amount as u128) * arg2.max_price / (1000000000 as u128) * (0x2::math::pow(10, arg2.decimals_y) as u128) / (0x2::math::pow(10, arg2.decimals_x) as u128)) as u64), 109);
        };
        let SwapReceipt {
            escrow_id : _,
            ts        : v1,
        ...
        fill_order<T0, T1>(arg2, &arg4, v2);
        let v4 = &mut arg4;
        apply_fee<T1>(arg0, v4);
        0x2::coin::put<T1>(&mut arg2.balance_y, arg4);
        0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::event::order_executed<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg2), arg2.owner, v1, v2, v3, balance_x_value<T0, T1>(arg2), balance_y_value<T0, T1>(arg2), arg2.filled_orders);
    }
    ...
    public entry fun update_price<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: &0x2::tx_context::TxContext) {
        ...
        arg0.min_price = arg2;
        arg0.max_price = arg3;
        0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::event::price_updated<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg0), arg0.owner, arg0.price_enabled, arg0.min_price, arg0.max_price);
    }
    ...
    public fun withdraw<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x81aa281a1bf1fa4b9af557ffb62e10cd86b3a99a0ab9cf38cd0b5f0bb8a3126::event::order_withdrew<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg0), arg0.owner, 0x2::coin::value<T1>(&v0));
        v0
    }
