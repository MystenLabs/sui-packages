module 0x81af3b1cfce0aa66fdcb287c1ccec5d3138036218e3bc6e268d395099de16db::OccultPass {
    ...
    fun init(arg0: OCCULTPASS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<OccultPass>(&mut v5, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"{url}"));
