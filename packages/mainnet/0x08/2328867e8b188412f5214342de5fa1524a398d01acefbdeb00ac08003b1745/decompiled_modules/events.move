module 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::events {
    ...
    struct MarketSettlementSnapshot has copy, drop {
        market_registry_id: address,
        market_key: u64,
        market_id: vector<u8>,
        outcome: 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::Outcome,
        ...
        no_cost: u64,
        cost_basis: u128,
        payout_liability: u128,
        settlement_pnl: u128,
        settlement_pnl_is_profit: bool,
        pool_balance: u64,
        event_ts: u64,
    ...
    struct MarketRegistryDeposited has copy, drop {
        market_registry_id: address,
        amount: u64,
        new_balance: u64,
        from_account_id: 0x1::option::Option<0x2::object::ID>,
    }
    ...
    public(friend) fun emit_market_registry_deposited(arg0: address, arg1: u64, arg2: u64, arg3: 0x1::option::Option<0x2::object::ID>) {
        let v0 = MarketRegistryDeposited{
            market_registry_id : arg0,
            amount             : arg1,
            new_balance        : arg2,
            from_account_id    : arg3,
        };
        0x2::event::emit<MarketRegistryDeposited>(v0);
    }
    ...
    public(friend) fun emit_market_settlement_snapshot<T0>(arg0: address, arg1: u64, arg2: vector<u8>, arg3: 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::Outcome, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u128, arg10: u128, arg11: u128, arg12: bool, arg13: u64, arg14: u64) {
        let v0 = MarketSettlementSnapshot{
            market_registry_id       : arg0,
            market_key               : arg1,
            market_id                : arg2,
            outcome                  : arg3,
            ...
            no_cost                  : arg8,
            cost_basis               : arg9,
            payout_liability         : arg10,
            settlement_pnl           : arg11,
            settlement_pnl_is_profit : arg12,
            pool_balance             : arg13,
            event_ts                 : arg14,
            settlement_coin_type     : 0x1::type_name::with_defining_ids<T0>(),
        };
        0x2::event::emit<MarketSettlementSnapshot>(v0);
    }
