module 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::waterx_prediction {
    ...
    public fun deposit_settlement<T0>(arg0: &0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::admin::AdminCap, arg1: &mut MarketRegistry<T0>, arg2: 0x2::coin::Coin<T0>) {
        ...
        0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::events::emit_market_registry_deposited(0x2::object::uid_to_address(&arg1.id), 0x2::coin::value<T0>(&arg2), 0x2::balance::value<T0>(&arg1.balance), 0x1::option::none<0x2::object::ID>());
    }

    public fun deposit_settlement_from_account<T0>(arg0: &0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::global_config::GlobalConfig, arg1: &mut MarketRegistry<T0>, arg2: &mut 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::AccountRegistry, arg3: &0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::AccountRequest, arg4: 0x2::object::ID, arg5: u64, arg6: &0x2::clock::Clock) {
        0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::global_config::assert_version(arg0);
        assert!(0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::is_account_owner(arg2, arg4, 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::account::request_address(arg3)), 14);
        0x2::balance::join<T0>(&mut arg1.balance, 0xe308bd40bd81aa42b9245e4b51b3fe63801c77c78a76be4ce5902aae549f7221::account::take<T0, 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::account_data::WaterXPrediction>(arg2, arg3, arg4, arg5, 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::account_data::witness(), arg6));
        0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::events::emit_market_registry_deposited(0x2::object::uid_to_address(&arg1.id), arg5, 0x2::balance::value<T0>(&arg1.balance), 0x1::option::some<0x2::object::ID>(arg4));
    }

    fun derive_settlement(arg0: 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::Outcome, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : (u128, u128, u128, bool) {
        let v0 = (arg2 as u128) + (arg4 as u128);
        let v1 = if (0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::is_invalid(arg0)) {
            v0
        } else if (0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::is_yes(arg0)) {
            (arg1 as u128)
        } else {
            (arg3 as u128)
        };
    ...
    fun resolve_market_internal<T0>(arg0: &mut MarketRegistry<T0>, arg1: vector<u8>, arg2: 0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::Outcome, arg3: bool, arg4: u64) : (u64, u64) {
        let (v0, v1, v2, v3, v4, v5) = if (contains_market<T0>(arg0, arg1)) {
            let v6 = market_pointer_internal<T0>(arg0, arg1);
            assert!(!v6.resolved, 4);
            let v7 = 0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::linked_table::remove<u64, Market>(&mut arg0.unresolved_markets, v6.key);
            v7.outcome = 0x1::option::some<0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::Outcome>(arg2);
            0x665188033384920a5bb5dcfb2ef21f54b4568d08b431718b97e02e5c184b92cc::linked_table::push_back<u64, Market>(&mut arg0.resolved_markets, v6.key, v7);
            0x2::table::borrow_mut<vector<u8>, MarketPointer>(&mut arg0.market_id_map, arg1).resolved = true;
            (v6.key, v7.unclaimed_count, v7.yes_shares, v7.yes_cost, v7.no_shares, v7.no_cost)
        } else {
            let v8 = create_market<T0>(arg0, arg1, 0x1::option::some<0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::outcome::Outcome>(arg2), 0, true, arg3, arg4);
            (v8, 0, 0, 0, 0, 0)
        };
        let (v9, v10, v11, v12) = derive_settlement(arg2, v2, v3, v4, v5);
        0xa5cfafe6660a8bf37eedf1a09dba633048da374c30b835668473689668f9ef57::events::emit_market_settlement_snapshot<T0>(0x2::object::uid_to_address(&arg0.id), v0, arg1, arg2, v1, v2, v3, v4, v5, v9, v10, v11, v12, 0x2::balance::value<T0>(&arg0.balance), arg4);
        (v0, v1)
    }
