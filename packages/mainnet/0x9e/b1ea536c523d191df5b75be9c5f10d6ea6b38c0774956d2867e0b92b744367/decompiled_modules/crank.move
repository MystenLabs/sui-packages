module 0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::crank {
    ...
    public fun admin_lock_config(arg0: &0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::vault::AdminCap, arg1: &mut CrankConfig) {
    ...
    public fun admin_set_cooldown_ms(arg0: &0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::vault::AdminCap, arg1: &mut CrankConfig, arg2: u64) {
        *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg1.id, 0x1::string::utf8(b"cooldown_ms")) = arg2;
    }

    public fun admin_set_min_apy_bps(arg0: &0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::vault::AdminCap, arg1: &mut CrankConfig, arg2: u64) {
        *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg1.id, 0x1::string::utf8(b"min_apy_bps")) = arg2;
    }

    public fun admin_set_min_protocols(arg0: &0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::vault::AdminCap, arg1: &mut CrankConfig, arg2: u64) {
        *0x2::dynamic_field::borrow_mut<0x1::string::String, u64>(&mut arg1.id, 0x1::string::utf8(b"min_protocols")) = arg2;
    }

    public fun admin_set_min_spread_bps(arg0: &0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::vault::AdminCap, arg1: &mut CrankConfig, arg2: u64) {
    ...
    public fun validate_reroute(arg0: &mut CrankConfig, arg1: &0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::strategy::StrategyRegistry, arg2: u8, arg3: u8, arg4: &0x2::clock::Clock) {
        let v0 = 0x2::clock::timestamp_ms(arg4);
        assert!(v0 - get_last_reroute_ms(arg0) >= get_cooldown_ms(arg0), 400);
        assert!(0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::strategy::count_available(arg1) >= get_min_protocols(arg0), 402);
        let (v1, v2) = 0xa1d6283cf5b81ba4a029ec4dab79df4b5eb904c2da95cb2cd917cc2fe0b2c2ac::strategy::should_reroute(arg1, arg2, get_min_spread_bps(arg0));
