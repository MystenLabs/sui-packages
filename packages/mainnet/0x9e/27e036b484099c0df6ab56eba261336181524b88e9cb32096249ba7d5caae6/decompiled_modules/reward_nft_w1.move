module 0x9e27e036b484099c0df6ab56eba261336181524b88e9cb32096249ba7d5caae6::reward_nft_w1 {
    struct REWARD_NFT_W1 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun MultiMint(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = REWARD_NFT{
                ...
                image_url   : 0x1::string::utf8(b"ipfs://QmU14eV2NUqEdkf6SryY3pCuzAcgxuUHGVq89LFSmnQAyC"),
    ...
    fun init(arg0: REWARD_NFT_W1, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmU14eV2NUqEdkf6SryY3pCuzAcgxuUHGVq89LFSmnQAyC"));
        ...
        let v4 = 0x2::package::claim<REWARD_NFT_W1>(arg0, arg1);
