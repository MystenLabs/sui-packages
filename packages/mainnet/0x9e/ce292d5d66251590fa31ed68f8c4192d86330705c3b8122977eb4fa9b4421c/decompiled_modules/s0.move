module 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::s0 {
    fun calc_sx<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::I128 {
        ...
        0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::sub(0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::from((0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::calculated_swap_result_amount_out(&v0) as u128)), 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::from((arg4 as u128)))
    }

    fun calc_sxr<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::I128 {
    ...
    fun sxp_internal<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0x361dd589b98e8fcda9a7ee53b85efabef3569d00416640d2faa516e3801d7ffc::pool::Pool<0x2::sui::SUI, T0>, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::new_f_max(arg4, arg5, 1000000000, arg6);
        let v5 = calc_sx<T0>(arg1, v0, v1, v3, arg4);
        if (0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::gt(v5, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::zero())) {
            0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_init(&mut v4, arg4, v5);
            let v6 = 0;
            while (v6 < 10 && !0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_has_converged(&v4)) {
                0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_complete(&mut v4, calc_sx<T0>(arg1, v0, v1, v3, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_prep_u(&mut v4)));
                v6 = v6 + 1;
            };
            let (v7, _) = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_result(&v4);
            sx_internal<T0>(arg0, arg1, arg2, arg3, v7, arg10);
            return
        };
        let v9 = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::new_f_max(arg7, arg8, 1000000, arg9);
        let v10 = calc_sxr<T0>(arg1, v0, v1, v3, arg7);
        assert!(0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::gt(v10, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::zero()), 25);
        0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_init(&mut v9, arg7, v10);
        let v11 = 0;
        while (v11 < 10 && !0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_has_converged(&v9)) {
            0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_complete(&mut v9, calc_sxr<T0>(arg1, v0, v1, v3, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_prep_u(&mut v9)));
            v11 = v11 + 1;
        };
        let (v12, _) = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_result(&v9);
