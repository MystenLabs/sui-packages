module 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i0 {
    fun calc_ix<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::I128 {
    ...
    fun calc_ixr<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::I128 {
    ...
    fun ixp_internal<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0x5c45d10c26c5fb53bfaff819666da6bc7053d2190dfa29fec311cc666ff1f4b0::core::DEXStorage, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::new_f_max(arg4, arg5, 1000000000, arg6);
        let v4 = calc_ix<T0>(arg1, v0, v1, arg4);
        if (0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::gt(v4, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::zero())) {
            0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_init(&mut v3, arg4, v4);
            let v5 = 0;
            while (v5 < 10 && !0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_has_converged(&v3)) {
                0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_complete(&mut v3, calc_ix<T0>(arg1, v0, v1, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_prep_u(&mut v3)));
                v5 = v5 + 1;
            };
            let (v6, _) = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_result(&v3);
            ix_internal<T0>(arg0, arg1, arg2, arg3, v6, arg10);
            return
        };
        let v8 = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::new_f_max(arg7, arg8, 1000000, arg9);
        let v9 = calc_ixr<T0>(arg1, v0, v1, arg7);
        assert!(0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::gt(v9, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::i128::zero()), 25);
        0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_init(&mut v8, arg7, v9);
        let v10 = 0;
        while (v10 < 10 && !0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_has_converged(&v8)) {
            0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_complete(&mut v8, calc_ixr<T0>(arg1, v0, v1, 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_next_step_prep_u(&mut v8)));
            v10 = v10 + 1;
        };
        let (v11, _) = 0x9ece292d5d66251590fa31ed68f8c4192d86330705c3b8122977eb4fa9b4421c::f_max::f_max_result(&v8);
