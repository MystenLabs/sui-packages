module 0x9e7eaf468e906ee2b570094eb240c601f8935add2a2012682f69d9ad4033f39b::reward6998 {
    struct REWARD6998 has drop {
        dummy_field: bool,
    }

    struct TICKET_6998 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6998(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6998>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6998>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6998, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6998>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6998>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6998>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6998>>(v5, 0x2::tx_context::sender(arg1));
    }
