module 0x9e30efa44fc125b7b704dab2ca3536a7d83228f00b0d1415569eed60455b9c06::reserve {
    ...
    public(friend) fun handle_borrow<T0>(arg0: &mut Reserve, arg1: u64) : 0x2::balance::Balance<T0> {
        ...
        assert!(v1.cash >= v1.revenue, 0x9e30efa44fc125b7b704dab2ca3536a7d83228f00b0d1415569eed60455b9c06::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun mint_market_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<T0>) : 0x2::balance::Balance<MarketCoin<T0>> {
        ...
        assert!(v3 > 0, 0x9e30efa44fc125b7b704dab2ca3536a7d83228f00b0d1415569eed60455b9c06::error::mint_market_coin_too_small_error());
        v2.cash = v2.cash + v0;
    ...
    public(friend) fun redeem_underlying_coin<T0>(arg0: &mut Reserve, arg1: 0x2::balance::Balance<MarketCoin<T0>>) : 0x2::balance::Balance<T0> {
        ...
        assert!(v2.cash >= v2.revenue, 0x9e30efa44fc125b7b704dab2ca3536a7d83228f00b0d1415569eed60455b9c06::error::pool_liquidity_not_enough_error());
    ...
    public(friend) fun repay_flash_loan<T0>(arg0: &mut Reserve, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoan<T0>) {
        ...
        assert!(v2 >= v0 + v1, 0x9e30efa44fc125b7b704dab2ca3536a7d83228f00b0d1415569eed60455b9c06::error::flash_loan_repay_not_enough_error());
        let v3 = v2 - v0;
