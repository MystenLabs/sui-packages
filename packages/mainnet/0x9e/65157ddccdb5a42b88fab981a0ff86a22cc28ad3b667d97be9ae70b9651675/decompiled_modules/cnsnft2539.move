module 0x9e65157ddccdb5a42b88fab981a0ff86a22cc28ad3b667d97be9ae70b9651675::cnsnft2539 {
    struct CNSNFT2539 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2539, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2539>(arg0, arg1);
