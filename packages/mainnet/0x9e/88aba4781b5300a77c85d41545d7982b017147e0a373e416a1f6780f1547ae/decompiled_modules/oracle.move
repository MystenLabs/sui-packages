module 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::oracle {
    ...
    public fun add_price_feed<T0, T1: drop>(arg0: &0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::listing::ListingCap, arg1: &mut Oracle, arg2: u8, arg3: u64) {
    ...
    public fun change_rule<T0, T1: drop>(arg0: &0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::listing::ListingCap, arg1: &mut Oracle) {
        if (!price_feed_exists<T0>(arg1)) {
            err_price_feed_not_exist();
        };
    ...
    fun handle_decimal_diff(arg0: u64, arg1: u8) : u64 {
        let v0 = 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::config::sui_decimals();
        if (v0 > arg1) {
            0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::math::mul_and_div(arg0, 1, 0x2::math::pow(10, v0 - arg1))
        } else if (v0 < arg1) {
            0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::math::mul_and_div(arg0, 0x2::math::pow(10, v0 - arg1), 1)
        } else {
            arg0
        }
    }
    ...
    public fun remove_price_feed<T0>(arg0: &0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::listing::ListingCap, arg1: &mut Oracle) {
        if (!price_feed_exists<T0>(arg1)) {
            err_price_feed_not_exist();
        };
        let PriceFeed {
    ...
    public fun ticket_price<T0>(arg0: &Oracle, arg1: &0x2::clock::Clock, arg2: u64) : u64 {
        ...
        let v1 = if (v0 > arg2) {
            (v0 - arg2) / 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::config::price_period() * 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::config::price_increment()
        } else {
            0
        };
        let v2 = 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::config::initial_price_in_sui() + v1;
        let v3 = v2;
        if (v2 > 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::config::max_price_in_sui()) {
            v3 = 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::config::max_price_in_sui();
        };
        if (0x1::type_name::get<T0>() == 0x1::type_name::get<0x2::sui::SUI>()) {
            ...
            handle_decimal_diff(0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::math::mul_and_div_u128(v3, 0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::config::precision(), v5.price_against_sui), v5.decimals)
        }
    }
    ...
    public fun update_tolerance_ms<T0>(arg0: &0x9e88aba4781b5300a77c85d41545d7982b017147e0a373e416a1f6780f1547ae::listing::ListingCap, arg1: &mut Oracle, arg2: u64) {
        if (!price_feed_exists<T0>(arg1)) {
            err_price_feed_not_exist();
        };
