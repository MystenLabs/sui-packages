module 0x9e0429f9baa3303ba57418e2bee556bca1e22bc7a250a54a56a9ca5da3c33b7a::reward4438 {
    struct REWARD4438 has drop {
        dummy_field: bool,
    }

    struct TICKET_4438 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4438(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4438>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4438>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4438, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4438>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4438>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4438>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4438>>(v5, 0x2::tx_context::sender(arg1));
    }
