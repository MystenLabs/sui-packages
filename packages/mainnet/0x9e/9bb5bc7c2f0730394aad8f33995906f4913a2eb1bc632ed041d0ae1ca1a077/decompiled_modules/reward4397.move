module 0x9e9bb5bc7c2f0730394aad8f33995906f4913a2eb1bc632ed041d0ae1ca1a077::reward4397 {
    struct REWARD4397 has drop {
        dummy_field: bool,
    }

    struct TICKET_4397 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4397(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4397>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4397>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4397, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4397>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4397>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4397>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4397>>(v5, 0x2::tx_context::sender(arg1));
    }
