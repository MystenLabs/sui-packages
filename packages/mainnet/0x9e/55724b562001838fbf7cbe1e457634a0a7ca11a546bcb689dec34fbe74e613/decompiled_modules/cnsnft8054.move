module 0x9e55724b562001838fbf7cbe1e457634a0a7ca11a546bcb689dec34fbe74e613::cnsnft8054 {
    struct CNSNFT8054 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8054, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8054>(arg0, arg1);
