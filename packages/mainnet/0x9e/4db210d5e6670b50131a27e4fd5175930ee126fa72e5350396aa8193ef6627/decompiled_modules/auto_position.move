module 0x9e4db210d5e6670b50131a27e4fd5175930ee126fa72e5350396aa8193ef6627::auto_position {
    ...
    public fun new<T0: store + key>(arg0: T0, arg1: 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, arg2: address, arg3: u64, arg4: &0x9e4db210d5e6670b50131a27e4fd5175930ee126fa72e5350396aa8193ef6627::registry::ProxyCap) : AutoPosition<T0> {
        assert!(arg3 < 0x9e4db210d5e6670b50131a27e4fd5175930ee126fa72e5350396aa8193ef6627::constants::scaling_pips(), 2);
        AutoPosition<T0>{
            owner         : arg2,
    ...
    public fun unwrap<T0: store + key>(arg0: AutoPosition<T0>, arg1: &0x9e4db210d5e6670b50131a27e4fd5175930ee126fa72e5350396aa8193ef6627::registry::ProxyCap) : (address, T0, 0x2::vec_map::VecMap<0x1::type_name::TypeName, u64>, u64) {
        let AutoPosition {
            owner         : v0,
            inner         : v1,
            vault         : v2,
