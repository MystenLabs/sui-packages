module 0x9e0f8e8292c458eafe6aca2054f9b22f98f7b3293373062ccabd1863a75351a3::gork {
    ...
    fun init(arg0: GORK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/38PgzpJYu2HkiYvV8qePFakB8tuobPdGm2FFEn7Dpump.png?claimId=uUm7gNngA2cm5Qsi                                                                                                                                                                                                      ");
