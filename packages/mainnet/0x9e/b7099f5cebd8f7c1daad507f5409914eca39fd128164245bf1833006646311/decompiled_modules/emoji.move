module 0x9eb7099f5cebd8f7c1daad507f5409914eca39fd128164245bf1833006646311::emoji {
    ...
    fun init(arg0: EMOJI, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<EMOJI>(arg0, 2, b"AISUI", b"", b"", 0x1::option::none<0x2::url::Url>(), arg1);
        let v2 = v0;
