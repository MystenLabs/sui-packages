module 0xa031c162f9982ee32b199b98fbfbb6561051f2c4d2e17d358b09beafc20ce45::delayed_transfer {
    ...
    public fun cancel_schedule<T0: store + key>(arg0: &mut DelayedTransferWrapper<T0>) {
        ...
        assert!(0x1::option::is_some<PendingTransfer>(v0), 13835341020612657155);
        let PendingTransfer {
            recipient        : _,
            execute_after_ms : _,
    ...
    public fun execute_transfer<T0: store + key>(arg0: DelayedTransferWrapper<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg0.pending;
        assert!(0x1::option::is_some<PendingTransfer>(v0), 13835340750029717507);
        let PendingTransfer {
            recipient        : v1,
            execute_after_ms : v2,
        } = 0x1::option::extract<PendingTransfer>(v0);
        let v3 = v1;
        let v4 = &mut v3;
        assert!(0x1::option::is_some<address>(v4), 13835903708573335559);
        let v5 = 0x1::option::extract<address>(v4);
        assert!(0x2::clock::timestamp_ms(arg1) >= v2, 13835622246481395717);
    ...
    public fun return_val<T0: store + key>(arg0: &mut DelayedTransferWrapper<T0>, arg1: T0, arg2: Borrow) {
        ...
        assert!(0x2::object::id<DelayedTransferWrapper<T0>>(arg0) == v0, 13836184788413186057);
        assert!(0x2::object::id<T0>(&arg1) == v1, 13836466267684995083);
    ...
    public fun schedule_transfer<T0: store + key>(arg0: &mut DelayedTransferWrapper<T0>, arg1: address, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::option::is_none<PendingTransfer>(&arg0.pending), 13835058995880001537);
    ...
    public fun schedule_unwrap<T0: store + key>(arg0: &mut DelayedTransferWrapper<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x1::option::is_none<PendingTransfer>(&arg0.pending), 13835059129023987713);
    ...
    public fun unwrap<T0: store + key>(arg0: DelayedTransferWrapper<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) : T0 {
        let v0 = &mut arg0.pending;
        assert!(0x1::option::is_some<PendingTransfer>(v0), 13835340896058605571);
        let PendingTransfer {
            recipient        : v1,
            execute_after_ms : v2,
        } = 0x1::option::extract<PendingTransfer>(v0);
        let v3 = v1;
        assert!(0x1::option::is_none<address>(&v3), 13835903858897190919);
        assert!(0x2::clock::timestamp_ms(arg1) >= v2, 13835622396805251077);
