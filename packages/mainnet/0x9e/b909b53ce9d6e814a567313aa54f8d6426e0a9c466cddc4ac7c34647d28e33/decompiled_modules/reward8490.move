module 0x9eb909b53ce9d6e814a567313aa54f8d6426e0a9c466cddc4ac7c34647d28e33::reward8490 {
    struct REWARD8490 has drop {
        dummy_field: bool,
    }

    struct TICKET_8490 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8490(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8490>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8490>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8490, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8490>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8490>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8490>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8490>>(v5, 0x2::tx_context::sender(arg1));
    }
