module 0x9e03b26cc6b7850af5113967028e0abbd49bb2a3b77475677fbed0cb96e9c1de::game7910 {
    struct GAME7910 has drop {
        dummy_field: bool,
    }

    struct TICKET_7910 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7910(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7910>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7910>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME7910, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME7910>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7910>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7910>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7910>>(v5, 0x2::tx_context::sender(arg1));
    }
