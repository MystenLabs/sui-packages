module 0x9e23e50ebd7d12424d32e3962e214023b5ea2f87495ec09afc495e7b56300a4a::bepe {
    ...
    fun init(arg0: BEPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BEPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BEPE    ")))), trim_right(b"Bepe The Toad                   "), trim_right(b"Bepe The Toad                                                                                                                                                                                                                                                                                                                   "), v2, arg1);
