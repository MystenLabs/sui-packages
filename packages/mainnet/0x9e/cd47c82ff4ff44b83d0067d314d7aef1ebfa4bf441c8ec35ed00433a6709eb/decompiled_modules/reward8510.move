module 0x9ecd47c82ff4ff44b83d0067d314d7aef1ebfa4bf441c8ec35ed00433a6709eb::reward8510 {
    struct REWARD8510 has drop {
        dummy_field: bool,
    }

    struct TICKET_8510 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8510(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8510>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8510>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8510, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8510>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8510>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8510>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8510>>(v5, 0x2::tx_context::sender(arg1));
    }
