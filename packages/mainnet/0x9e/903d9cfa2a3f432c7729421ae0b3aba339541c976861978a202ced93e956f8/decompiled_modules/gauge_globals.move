module 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge_globals {
    struct GaugeGlobals has store, key {
        ...
        gauges: 0x2::vec_map::VecMap<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>,
    ...
    public(friend) fun add_gauge(arg0: &mut GaugeGlobals, arg1: 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge) {
        let v0 = 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::gauge_id(&arg1);
        assert!(!0x2::vec_map::contains<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(&arg0.gauges, &v0), 0);
        let v1 = 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::pool_id(&arg1);
        assert!(!0x2::vec_map::contains<address, address>(&arg0.pool_id_to_gauge, &v1), 0);
        0x2::vec_map::insert<address, address>(&mut arg0.pool_id_to_gauge, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::pool_id(&arg1), 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::gauge_id(&arg1));
        0x2::vec_map::insert<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(&mut arg0.gauges, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::gauge_id(&arg1), arg1);
    }
    ...
    public(friend) fun all_gauge_ids(arg0: &GaugeGlobals) : vector<address> {
        0x2::vec_map::keys<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(&arg0.gauges)
    }
    ...
    public(friend) fun create(arg0: &mut 0x2::tx_context::TxContext) : GaugeGlobals {
        GaugeGlobals{
            ...
            gauges              : 0x2::vec_map::empty<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(),
            pool_id_to_gauge    : 0x2::vec_map::empty<address, address>(),
        }
    }

    public(friend) fun get_gauge(arg0: &GaugeGlobals, arg1: &address) : &0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge {
        assert!(0x2::vec_map::contains<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(&arg0.gauges, arg1), 1);
        0x2::vec_map::get<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(&arg0.gauges, arg1)
    }

    public(friend) fun get_gauge_by_pool_id(arg0: &GaugeGlobals, arg1: &address) : &0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge {
    ...
    public(friend) fun get_gauge_not_paused(arg0: &mut GaugeGlobals, arg1: &address) : &mut 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge {
        assert!(0x2::vec_map::contains<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(&arg0.gauges, arg1), 1);
        let v0 = 0x2::vec_map::get_mut<address, 0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::Gauge>(&mut arg0.gauges, arg1);
        0x9e903d9cfa2a3f432c7729421ae0b3aba339541c976861978a202ced93e956f8::gauge::assert_not_paused(v0);
        v0
    }
