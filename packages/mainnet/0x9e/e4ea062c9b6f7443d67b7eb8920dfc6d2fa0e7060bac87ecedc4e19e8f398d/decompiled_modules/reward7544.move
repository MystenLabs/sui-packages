module 0x9ee4ea062c9b6f7443d67b7eb8920dfc6d2fa0e7060bac87ecedc4e19e8f398d::reward7544 {
    struct REWARD7544 has drop {
        dummy_field: bool,
    }

    struct TICKET_7544 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7544(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7544>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7544>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7544, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7544>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7544>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7544>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7544>>(v5, 0x2::tx_context::sender(arg1));
    }
