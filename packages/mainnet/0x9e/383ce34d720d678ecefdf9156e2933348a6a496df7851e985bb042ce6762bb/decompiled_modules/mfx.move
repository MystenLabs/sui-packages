module 0x9f31d118ad07fb1f8951a1f31ae544459aa6f0b8b39f5ae49473dd6da688b39a::mfx {
    ...
    fun op<T0, T1>(arg0: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg1: bool, arg2: u128, arg3: u128, arg4: u64, arg5: u64, arg6: u8, arg7: u8, arg8: u64) : (u64, u64) {
        assert!(arg4 > 0, 1);
        assert!(arg4 <= arg5, 2);
        assert!(arg8 < arg4, 3);
        let v0 = 0;
        ...
        while (v4 < arg6) {
            ...
            let (v5, v6, v7, v8) = st<T0, T1>(arg0, v3, arg1, arg2);
            if (v7) {
                break
            };
            if (!pk(v6, arg3, arg1)) {
        ...
        while (v4 < arg7) {
            ...
            let v9 = (v2 + v3) / 2;
            let (v10, v11, v12, v13) = st<T0, T1>(arg0, v9, arg1, arg2);
    ...
    fun st<T0, T1>(arg0: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg1: u64, arg2: bool, arg3: u128) : (u64, u128, bool, u64) {
        if (arg1 == 0) {
            return (0, 0, true, 0)
        };
    ...
    fun sw<T0, T1>(arg0: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg1: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::partner::Partner, arg2: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T0>, arg3: &mut 0x78633b3c519af1f210a3c02533c5a6595c20d39e2a0ad6b2a5652e029a737a88::treasury::Vault<T1>, arg4: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg5: &0x2::clock::Clock, arg6: u128, arg7: bool, arg8: u64, arg9: u64, arg10: u8, arg11: u8, arg12: u64, arg13: &mut 0x2::tx_context::TxContext) : (u64, u64, u64) {
        ...
        let (v5, v6, v7) = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::flash_swap_with_partner<T0, T1>(arg4, arg0, arg1, arg7, true, v3, isp(arg6), arg5);
        let v8 = v7;
        let v9 = v6;
        let v10 = v5;
        let v11 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::swap_pay_amount<T0, T1>(&v8);
        assert!(v11 <= arg9, 5);
        let v12 = if (arg7) {
        ...
        let v13 = v11 - (((v4 as u128) * (0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::protocol_fee_rate(arg4) as u128) * (0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::partner::current_ref_fee_rate(arg1, 0x2::clock::timestamp_ms(arg5) / 1000) as u128) / 10000 * 10000) as u64);
        let v14 = if (arg7) {
        ...
        let v18 = v15;
        let (v19, v20) = if (arg7) {
            (0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut v18, v11, arg13)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v17, v11, arg13)))
        };
        0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::repay_flash_swap_with_partner<T0, T1>(arg4, arg0, arg1, v19, v20, v8);
        0x2::coin::join<T0>(&mut v18, 0x2::coin::from_balance<T0>(v10, arg13));
        0x2::coin::join<T1>(&mut v17, 0x2::coin::from_balance<T1>(v9, arg13));
        dep_or_destroy<T0>(arg2, v18);
        dep_or_destroy<T1>(arg3, v17);
        (v13, v12, v14)
    }
