module 0x9e9cb285ec4968b594426482284342c471f3bd679387e86aa3bebca17a871a03::master_node_treasury_and_multisend {
    ...
    struct MasterNode has store, key {
        id: 0x2::object::UID,
        has_distributor_role: 0x2::vec_set::VecSet<address>,
    }

    struct MasterNodeBalance<phantom T0> has copy, drop, store {
        dummy_field: bool,
    }
    ...
    struct MASTER_NODE_TREASURY_AND_MULTISEND has drop {
        dummy_field: bool,
    }

    public entry fun change_owner(arg0: &mut MasterNode, arg1: Owner, arg2: address, arg3: &UpgradeVersion, arg4: 0x2::package::UpgradeCap, arg5: &0x2::tx_context::TxContext) {
    ...
    entry fun collect_reward<T0>(arg0: 0x2::transfer::Receiving<0x2::coin::Coin<T0>>, arg1: &mut MasterNode, arg2: &UpgradeVersion, arg3: &0x2::tx_context::TxContext) {
        ...
        let v2 = MasterNodeBalance<T0>{dummy_field: false};
        let v3 = &mut arg1.id;
        if (0x2::dynamic_field::exists_<MasterNodeBalance<T0>>(v3, v2)) {
            0x2::coin::join<T0>(0x2::dynamic_field::borrow_mut<MasterNodeBalance<T0>, 0x2::coin::Coin<T0>>(v3, v2), v1);
        } else {
            0x2::dynamic_field::add<MasterNodeBalance<T0>, 0x2::coin::Coin<T0>>(v3, v2, v1);
        };
        let v4 = RewardCollected{reward_amount: 0x2::coin::value<T0>(&v1)};
        0x2::event::emit<RewardCollected>(v4);
    }

    public entry fun grant_distributor_role(arg0: &Owner, arg1: &mut MasterNode, arg2: &UpgradeVersion, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 0, 2);
    ...
    fun init(arg0: MASTER_NODE_TREASURY_AND_MULTISEND, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::share_object<MasterNode>(v1);
        let v2 = Owner{
            id            : 0x2::object::new(arg1),
            owner_address : v0,
        };
    ...
    public entry fun revoke_distributor_role(arg0: &Owner, arg1: &mut MasterNode, arg2: address, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 0, 2);
    ...
    public entry fun send_reward<T0>(arg0: vector<address>, arg1: vector<u64>, arg2: &mut MasterNode, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = @0x0;
        ...
        let v3 = MasterNodeBalance<T0>{dummy_field: false};
        let v4 = &mut arg2.id;
        assert!(0x2::dynamic_field::exists_<MasterNodeBalance<T0>>(v4, v3), 7);
        let v5 = 0x2::dynamic_field::borrow_mut<MasterNodeBalance<T0>, 0x2::coin::Coin<T0>>(v4, v3);
