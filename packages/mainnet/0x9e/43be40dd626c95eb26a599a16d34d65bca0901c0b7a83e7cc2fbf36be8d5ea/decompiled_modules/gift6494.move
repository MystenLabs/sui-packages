module 0x9e43be40dd626c95eb26a599a16d34d65bca0901c0b7a83e7cc2fbf36be8d5ea::gift6494 {
    struct GIFT6494 has drop {
        dummy_field: bool,
    }

    struct TICKET_6494 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6494(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6494>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6494>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6494, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6494>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6494>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6494>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6494>>(v5, 0x2::tx_context::sender(arg1));
    }
