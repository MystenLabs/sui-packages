module 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::bound_curve_amm {
    ...
    struct PoolState<phantom T0, phantom T1, phantom T2> has store {
        ...
        fees: 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::fees::Fees,
        config: Config,
        locked: bool,
    }
    ...
    public fun new<T0, T1, T2>(arg0: &mut 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::index::Registry, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::TreasuryCap<T2>, arg3: &mut 0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T2>, arg5: u256, arg6: u256, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: &mut 0x2::tx_context::TxContext) {
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::utils::assert_ticket_coin_integrity<T0, T1, T2>(arg3);
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::utils::assert_coin_integrity<T0, T1, T2>(&arg1, arg3, &arg2, arg4);
        0x2::coin::update_name<T0>(&arg1, arg3, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::utils::get_ticket_coin_name<T2>(arg4));
        0x2::coin::update_symbol<T0>(&arg1, arg3, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::utils::get_ticket_coin_symbol<T2>(arg4));
        ...
        let (v4, v5) = 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::token_ir::init_token<T0>(&mut v3.id, &arg1, arg11);
        0x2::table::add<0x1::type_name::TypeName, address>(0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::index::policies_mut(arg0), 0x1::type_name::get<T0>(), v5);
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::events::new_pool<T0, T1, T2>(0x2::object::uid_to_address(&v3.id), 0x2::balance::value<T0>(&v1), 0, v5);
    ...
    public fun transfer<T0, T1, T2>(arg0: &mut SeedPool, arg1: &0x2::token::TokenPolicy<T0>, arg2: 0x2::token::Token<T0>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::token_ir::transfer<T0>(arg1, arg2, arg3, arg4);
    }
    ...
    public fun buy_meme<T0, T1, T2>(arg0: &mut SeedPool, arg1: &mut 0x2::coin::Coin<T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::staked_lp::StakedLP<T0> {
        assert!(0x2::coin::value<T1>(arg1) != 0, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::no_zero_coin());
        let v0 = 0x2::object::uid_to_address(&arg0.id);
        let v1 = pool_state_mut<T0, T1, T2>(arg0);
        assert!(!v1.locked, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::pool_is_locked());
        ...
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::events::swap<T1, T0, SwapAmount>(v0, v2, v3);
        let v4 = v3.amount_out;
        if (0x2::balance::value<T0>(&v1.balance_m) == 0) {
            v1.locked = true;
        };
        add_from_token_acc(arg0, v4, 0x2::tx_context::sender(arg4));
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::staked_lp::new<T0>(0x2::balance::split<T0>(&mut v1.balance_m, v4), arg3, arg4)
    }
    ...
    fun buy_meme_swap_amounts<T0, T1, T2>(arg0: &PoolState<T0, T1, T2>, arg1: u64, arg2: u64) : SwapAmount {
        ...
        let v3 = 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::fees::get_fee_in_amount(&arg0.fees, arg1);
        ...
        let v6 = 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::fees::get_fee_out_amount(&arg0.fees, v5);
        let v7 = v5 - v6;
        assert!(v7 >= arg2, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::slippage());
        SwapAmount{
            amount_in     : v4,
            amount_out    : v7,
            admin_fee_in  : v3,
    ...
    public fun compute_alpha_abs(arg0: u256, arg1: u256, arg2: u256, arg3: u64) : u256 {
        ...
        assert!(v0 < arg1, 1);
        2 * (arg1 - v0) * 1000000 / 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2((arg0 as u256))
    }
    ...
    public fun compute_delta_m<T0, T1, T2>(arg0: &PoolState<T0, T1, T2>, arg1: u64, arg2: u64) : u64 {
        let v0 = (arg1 as u256);
        let v1 = (arg2 as u256);
        ((arg0.config.beta * (v1 - v0) / 1000000 * 1000000000 - arg0.config.alpha_abs * (0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2(v1) / 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2(1000000000) - 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2(v0) / 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2(1000000000)) / 2 * 1000000) as u64)
    }
    ...
    public fun compute_delta_s<T0, T1, T2>(arg0: &PoolState<T0, T1, T2>, arg1: u64, arg2: u64) : u64 {
        ...
        let v4 = 0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math256::sqrt_down(1000000 * 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2(v3));
        let v5 = 1000000 * 1000000 * 1000000000;
        (((0xf7334947a5037552a94cee15fc471dbda71bf24d46c97ee24e1fdac38e26644c::math256::sqrt_down(0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2(2 * v2 * 1000000 * 1000000000 - 2 * v1 * v0 * 1000000) * 1000000 + 8 * (arg2 as u256) * v1 * 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::math256::pow_2(v3)) * v5 - (2 * v2 * 1000000 * 1000000000 - 2 * v1 * v0 * 1000000) * v4) * 1000000000 * 1000000 / 2 * v1 * v4 * v5) as u64)
    }
    ...
    public(friend) fun destroy_pool<T0, T1, T2>(arg0: SeedPool) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>, 0x2::balance::Balance<T2>, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::fees::Fees, Config, bool, 0x2::object::UID) {
        let v0 = &mut arg0;
    ...
    public fun fees<T0, T1, T2>(arg0: &SeedPool) : 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::fees::Fees {
    ...
    fun gamma_s_mist<T0, T1, T2>(arg0: &PoolState<T0, T1, T2>) : u64 {
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::utils::mist(arg0.config.gamma_s)
    }
    ...
    public fun new_default<T0, T1, T2>(arg0: &mut 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::index::Registry, arg1: 0x2::coin::TreasuryCap<T0>, arg2: 0x2::coin::TreasuryCap<T2>, arg3: &mut 0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T2>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    fun new_fees(arg0: u256, arg1: u256) : 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::fees::Fees {
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::fees::new(arg0, arg1)
    }

    fun new_pool_internal<T0, T1, T2>(arg0: &mut 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::index::Registry, arg1: 0x2::balance::Balance<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::coin::Coin<T2>, arg4: u256, arg5: u256, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) : SeedPool {
        assert!(0x2::balance::value<T0>(&arg1) == (arg8 as u64), 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::provide_both_coins());
        assert!(0x2::coin::value<T1>(&arg2) == 0, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::provide_both_coins());
        assert!(0x2::coin::value<T2>(&arg3) == ((arg8 + arg9) as u64), 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::provide_both_coins());
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::index::assert_new_pool<T0, T1, T2>(arg0);
        let v0 = Config{
        ...
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::index::add_seed_pool<T0, T1, T2>(arg0, 0x2::object::uid_to_address(&v2.id));
        v2
    }
    ...
    public fun sell_meme<T0, T1, T2>(arg0: &mut SeedPool, arg1: 0x2::token::Token<T0>, arg2: u64, arg3: &0x2::token::TokenPolicy<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(0x2::token::value<T0>(&arg1) != 0, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::no_zero_coin());
        let v0 = 0x2::object::uid_to_address(&arg0.id);
        let v1 = pool_state_mut<T0, T1, T2>(arg0);
        assert!(!v1.locked, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::pool_is_locked());
        ...
        if (v3.admin_fee_in != 0) {
            0x2::balance::join<T0>(&mut v1.admin_balance_m, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::token_ir::into_balance<T0>(arg3, 0x2::token::split<T0>(&mut arg1, v3.admin_fee_in, arg4), arg4));
        };
        if (v3.admin_fee_out != 0) {
            0x2::balance::join<T1>(&mut v1.admin_balance_s, 0x2::balance::split<T1>(&mut v1.balance_s, v3.admin_fee_out));
        };
        0x2::balance::join<T0>(&mut v1.balance_m, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::token_ir::into_balance<T0>(arg3, arg1, arg4));
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::events::swap<T0, T1, SwapAmount>(v0, v2, v3);
    ...
    public fun take_fees<T0, T1, T2>(arg0: &0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::admin::Admin, arg1: &mut SeedPool, arg2: &0x2::token::TokenPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::token::Token<T0>, 0x2::coin::Coin<T1>) {
        ...
        (0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::token_ir::take<T0>(arg2, &mut v3.admin_balance_m, v1, arg3), 0x2::coin::take<T1>(&mut v3.admin_balance_s, v2, arg3))
    }
