module 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::staked_lp {
    ...
    public fun into_token<T0>(arg0: StakedLP<T0>, arg1: &0x2::clock::Clock, arg2: &0x2::token::TokenPolicy<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::token::Token<T0> {
        ...
        assert!(0x2::clock::timestamp_ms(arg1) >= v2, 0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::errors::lp_stake_time_not_passed());
        0x2::object::delete(v0);
        0x9e1701ec8d7942a79874a40d4d5c9d94c45ffd141c9cd2cff4f4fc3820329b61::token_ir::from_balance<T0>(arg2, v1, arg3)
    }
