module 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::dapp {
    ...
    fun apply_reward(arg0: &mut User, arg1: &mut GlobalNetworkData, arg2: u64, arg3: bool) {
        ...
        arg1.total_user_balance = arg1.total_user_balance + v1;
    ...
    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 13906838031224012799);
        let v1 = 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::get_sui_amount(arg1, v0);
    ...
    public entry fun claimBalance<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg9: &mut 0x2::tx_context::TxContext) {
        abort 0
    }

    public entry fun claimBalanceV1<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0.total_user_balance >= arg2) {
            v0.total_user_balance = v0.total_user_balance - arg2;
        };
        let v2 = withdrawSui<T0>(&arg0.vault, 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::get_sui_amount(arg1, arg2 - arg2 / 10), arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v2, 0x2::tx_context::sender(arg10));
    }

    public entry fun claimInterest<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::PriceOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        withdraw_pre<T0>(arg0, v0, 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::get_usdt_amount(arg2, v5), arg4);
    }
    ...
    public entry fun investment<T0, T1, T2>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::PriceOracle, arg4: u64, arg5: u8, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg10: &mut 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::rank_list::TodayRank, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg5 > 0) {
            ...
            v5 = v6;
            assert!(v6 >= 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::get_sui_amount(arg3, arg4 * (arg5 as u64) / 100), 2);
            depositSui<T0>(v2, arg1, arg6, arg7, arg8, arg9, arg11);
            v3.total_sui_invested_amount = v3.total_sui_invested_amount + v6;
        } else {
        ...
        if (v7 > 0) {
            ...
            v8 = v9;
            assert!(v9 >= 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::get_pre_amount(arg3, arg4 * (v7 as u64) / 100), 2);
        ...
        let v10 = calc_static_power(arg4);
        let v11 = Order{
        ...
        0x1::vector::push_back<Order>(&mut v4.orders, v11);
        v4.static_power = v4.static_power + v10;
        v4.underway_power = v4.underway_power + v10;
    ...
    public entry fun stake<T0>(arg0: &mut Contract<T0>, arg1: &0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 3);
        let v1 = if (arg3 == 7) {
            true
        ...
        let v4 = StakeOrder{
            ...
            cycle      : arg3,
            pre_amount : v0,
            amount     : 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::price_oracle::get_pre_amount(arg1, v0),
            interest   : 0,
        };
    ...
    fun update_dynamic_power(arg0: &mut GlobalNetworkData, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: bool) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        let v1 = 1;
        while (0x1::option::is_some<address>(&v0) && v1 <= 20) {
            ...
            if (v3 > 0) {
                ...
                if (v1 == 1 && arg4) {
                    let v5 = v4 / 10;
                    arg0.total_user_balance = arg0.total_user_balance + v5;
                ...
                if (v1 == 1) {
                    ...
                    arg0.total_buy_amount = arg0.total_buy_amount + v4;
                };
            };
            v0 = v2.inviter;
            v1 = v1 + 1;
    ...
    fun update_share_performance(arg0: &mut 0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::rank_list::TodayRank, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        if (0x1::option::is_some<address>(&v0)) {
            ...
            0xcb22c8a3069ac0dee2961233044244d8aef0f2cbe6b180f97ec7254a2c8ef376::rank_list::add_performance(arg0, arg2, arg3, arg4);
        };
    }
