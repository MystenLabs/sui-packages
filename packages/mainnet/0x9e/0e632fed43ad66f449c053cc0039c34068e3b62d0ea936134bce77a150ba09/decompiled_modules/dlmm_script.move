module 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_script {
    ...
    public entry fun deposit_reward<T0>(arg0: &0xbb1e485664a4d5099154f9c8f10a54d49e2e7dc02c8e358253f0cd5c14eaa1bd::config::GlobalConfig, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::RewarderGlobalVault, arg2: 0x2::coin::Coin<T0>) {
        0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::deposit_reward<T0>(arg0, arg1, 0x2::coin::into_balance<T0>(arg2));
    }
    ...
    fun extra_amount_x(arg0: u64, arg1: u8, arg2: u32, arg3: u32, arg4: u32, arg5: u16, arg6: &vector<u32>, arg7: &vector<u64>) : vector<u64> {
        ...
        let v2 = v0;
        let (v3, _) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(arg2, arg5, arg0, 0, 0, 0, v2, v1);
        let v5 = v3;
        let v6 = 0;
    ...
    fun extra_amount_y(arg0: u64, arg1: u8, arg2: u32, arg3: u32, arg4: u32, arg5: u16, arg6: &vector<u32>, arg7: &vector<u64>) : vector<u64> {
        let (v0, v1) = get_distribution_by_strategy(arg1, arg3, arg4, arg2);
        let (_, v3) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(arg2, arg5, 0, arg0, 0, 0, v0, v1);
        let v4 = v3;
        let v5 = 0;
    ...
    fun get_distribution_by_strategy(arg0: u8, arg1: u32, arg2: u32, arg3: u32) : (vector<u32>, vector<u256>) {
        let v0 = &arg0;
        if (*v0 == 1) {
            0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_spot_balanced(arg1, arg2)
        } else if (*v0 == 2) {
            if (arg3 > arg2) {
                0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(arg1, arg2)
            } else if (arg3 < arg1) {
                0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(arg1, arg2)
            } else {
                0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_curve(arg1, arg2, arg3)
            }
        } else {
            assert!(*v0 == 3, 4);
            let (v3, v4) = if (arg3 > arg2) {
                let (v5, v6) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(arg1, arg2);
                (v6, v5)
            } else {
                let (v7, v8) = if (arg3 < arg1) {
                    0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(arg1, arg2)
                } else {
                    0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_bid_ask(arg1, arg2, arg3)
                };
                (v8, v7)
            };
            (v4, v3)
    ...
    public entry fun mint_by_strategy<T0, T1>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_factory::Factory, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: bool, arg5: u64, arg6: bool, arg7: u64, arg8: u8, arg9: u32, arg10: u32, arg11: u32, arg12: u32, arg13: u64, arg14: u64, arg15: &0x2::clock::Clock, arg16: &mut 0x2::tx_context::TxContext) {
        assert!(arg5 > 0 || arg7 > 0, 9223373716186988543);
        assert!(arg4 || arg6, 9223373720481955839);
        if (arg4 && arg6) {
        ...
        let (v8, v9) = if (arg4 && arg6) {
            ...
            let (v11, v12) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, v1, arg5, arg7, v2, v3, v7, v6);
            let v13 = v12;
            let v14 = v11;
            ...
            if (v0 < arg9) {
                ...
                (0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v0, v1, arg5, v7, v6), v19)
            } else {
                assert!(v0 >= arg9 && v0 <= arg10, 3);
                let v21 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::auto_fill_y_by_weight(v0, v1, arg5, v2, v3, v7, v6);
                assert!(v21 >= arg13 && v21 <= arg14, 2);
                0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, v1, arg5, v21, v2, v3, v7, v6)
            }
        } else if (v0 > arg10) {
            let v22 = vector[];
            let v23 = 0;
            ...
            (v22, 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v0, arg7, v7, v6))
        } else {
            assert!(v0 >= arg9 && v0 <= arg10, 3);
            let v24 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::auto_fill_x_by_weight(v0, v1, arg7, v2, v3, v7, v6);
            assert!(v24 >= arg13 && v24 <= arg14, 2);
            0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, v1, v24, arg7, v2, v3, v7, v6)
        };
    ...
    public entry fun mint_by_strategy_single<T0, T1>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_factory::Factory, arg2: 0x2::coin::Coin<T0>, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: u8, arg7: u32, arg8: u32, arg9: u32, arg10: u32, arg11: u64, arg12: u64, arg13: &0x2::clock::Clock, arg14: &mut 0x2::tx_context::TxContext) {
        ...
        if (*v7 == 1) {
            if (v0 < arg7 || v0 > arg8) {
                let (v8, v9) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_spot_balanced(arg7, arg8);
                let (v10, v11) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, arg5, v1, v2, v8, v9);
                v6 = v8;
                v4 = v10;
                v5 = v11;
            } else if (!(arg5 == 0)) {
                if (arg7 <= v0) {
                    let (v12, v13) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_spot_balanced(arg7, v0);
                    let v14 = v12;
                    let v15 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v0, arg5, v14, v13);
                    let v16 = 0;
                ...
                if (v0 < arg8) {
                    let (v17, v18) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_spot_balanced(v0 + 1, arg8);
                    let v19 = v17;
                    let v20 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, v19, v18);
                    let v21 = 0;
                ...
                if (arg7 < v0) {
                    let (v22, v23) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_spot_balanced(arg7, v0 - 1);
                    let v24 = v22;
                    let v25 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v0, arg5, v24, v23);
                    let v26 = 0;
                ...
                if (v0 <= arg8) {
                    let (v27, v28) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_spot_balanced(v0, arg8);
                    let v29 = v27;
                    let v30 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, v29, v28);
                    let v31 = 0;
            ...
            if (v0 < arg7) {
                let (v32, v33) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(arg7, arg8);
                let (v34, v35) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, arg5, v1, v2, v32, v33);
                v6 = v32;
                v4 = v34;
                v5 = v35;
            } else if (v0 > arg8) {
                let (v36, v37) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(arg7, arg8);
                let (v38, v39) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, arg5, v1, v2, v36, v37);
                v6 = v36;
                v4 = v38;
                v5 = v39;
            } else if (!(arg5 == 0)) {
                if (arg7 <= v0) {
                    let (v40, v41) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(arg7, v0);
                    let v42 = v40;
                    let v43 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v0, arg5, v42, v41);
                    let v44 = 0;
                ...
                if (v0 < arg8) {
                    let (v45, v46) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(v0 + 1, arg8);
                    let v47 = v45;
                    let v48 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, v47, v46);
                    let v49 = 0;
                ...
                if (arg7 < v0) {
                    let (v50, v51) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(arg7, v0 - 1);
                    let v52 = v50;
                    let v53 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v0, arg5, v52, v51);
                    let v54 = 0;
                ...
                if (v0 <= arg8) {
                    let (v55, v56) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(v0, arg8);
                    let v57 = v55;
                    let v58 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, v57, v56);
                    let v59 = 0;
            ...
            assert!(*v7 == 3, 4);
            if (v0 < arg7) {
                let (v60, v61) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(arg7, arg8);
                let (v62, v63) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, arg5, v1, v2, v60, v61);
                v6 = v60;
                v4 = v62;
                v5 = v63;
            } else if (v0 > arg8) {
                let (v64, v65) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(arg7, arg8);
                let (v66, v67) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, arg5, v1, v2, v64, v65);
                v6 = v64;
                v4 = v66;
                v5 = v67;
            } else if (!(arg5 == 0)) {
                if (arg7 <= v0) {
                    let (v68, v69) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(arg7, v0);
                    let v70 = v68;
                    let v71 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v0, arg5, v70, v69);
                    let v72 = 0;
                ...
                if (v0 < arg8) {
                    let (v73, v74) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(v0 + 1, arg8);
                    let v75 = v73;
                    let v76 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, v75, v74);
                    let v77 = 0;
                ...
                if (arg7 < v0) {
                    let (v78, v79) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_descending_order(arg7, v0 - 1);
                    let v80 = v78;
                    let v81 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v0, arg5, v80, v79);
                    let v82 = 0;
                ...
                if (v0 <= arg8) {
                    let (v83, v84) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_weight_ascending_order(v0, arg8);
                    let v85 = v83;
                    let v86 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v0, 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::get_bin_step<T0, T1>(arg0), arg4, v85, v84);
                    let v87 = 0;
    ...
    public entry fun raise_by_strategy<T0, T1>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_factory::Factory, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: bool, arg6: u64, arg7: bool, arg8: u64, arg9: u8, arg10: u32, arg11: u32, arg12: u64, arg13: u64, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg6 > 0 || arg8 > 0, 9223375425583972351);
        assert!(arg5 || arg7, 9223375429878939647);
        if (arg5 && arg7) {
        ...
        let (v10, v11) = if (arg5 && arg7) {
            ...
            let (v13, v14) = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v2, v3, arg6, arg8, v4, v5, v9, v8);
            let v15 = v14;
            let v16 = v13;
            ...
            if (v2 < v0) {
                ...
                (0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_ask_side(v2, v3, arg6, v9, v8), v21)
            } else {
                assert!(v2 >= v0 && v2 <= v1, 3);
                let v23 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::auto_fill_y_by_weight(v2, v3, arg6, v4, v5, v9, v8);
                assert!(v23 >= arg12 && v23 <= arg13, 2);
                0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v2, v3, arg6, v23, v4, v5, v9, v8)
            }
        } else if (v2 > v1) {
            let v24 = vector[];
            let v25 = 0;
            ...
            (v24, 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_bid_side(v2, arg8, v9, v8))
        } else {
            assert!(v2 >= v0 && v2 <= v1, 3);
            let v26 = 0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::auto_fill_x_by_weight(v2, v3, arg8, v4, v5, v9, v8);
            assert!(v26 >= arg12 && v26 <= arg13, 2);
            0x9e0e632fed43ad66f449c053cc0039c34068e3b62d0ea936134bce77a150ba09::dlmm_pair_utils::to_amount_both_side(v2, v3, v26, arg8, v4, v5, v9, v8)
        };
    ...
    public entry fun shrink_position<T0, T1>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg2 > 0 && arg2 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223376679714422783);
    ...
    public entry fun shrink_position_reward1<T0, T1, T2>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::RewarderGlobalVault, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0 && arg3 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223376761318801407);
    ...
    public entry fun shrink_position_reward2<T0, T1, T2, T3>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::RewarderGlobalVault, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0 && arg3 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223376868692983807);
        let v0 = 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::collect_reward<T0, T1, T2>(arg0, arg1, arg2, arg4, arg5);
        if (0x2::balance::value<T2>(&v0) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(v0, arg5), 0x2::tx_context::sender(arg5));
        } else {
    ...
    public entry fun shrink_position_reward3<T0, T1, T2, T3, T4>(arg0: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::DlmmPair<T0, T1>, arg1: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_rewarder::RewarderGlobalVault, arg2: &mut 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_position::Position, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg3 > 0 && arg3 < (0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_constants::basis_point_max() as u64), 9223377001836969983);
        let v0 = 0xf676f63a36cd3e721ed3863798b0199433ddbf3192c762f6a555b06ba3f62ae9::dlmm_pair::collect_reward<T0, T1, T2>(arg0, arg1, arg2, arg4, arg5);
        if (0x2::balance::value<T2>(&v0) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(0x2::coin::from_balance<T2>(v0, arg5), 0x2::tx_context::sender(arg5));
        } else {
