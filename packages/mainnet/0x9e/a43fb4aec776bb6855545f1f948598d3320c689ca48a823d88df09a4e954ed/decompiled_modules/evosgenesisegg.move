module 0x9ea43fb4aec776bb6855545f1f948598d3320c689ca48a823d88df09a4e954ed::evosgenesisegg {
    ...
    fun create_nft(arg0: &mut 0x2::tx_context::TxContext) : EvosGenesisEgg {
        EvosGenesisEgg{
            ...
            url  : 0x2::url::new_unsafe_from_bytes(b"https://knw-gp.s3.eu-north-1.amazonaws.com/test.jpg"),
        }
    }
