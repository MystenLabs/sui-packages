module 0x9e8dd0a200db8fb836770cf493904d57e0c21526fa81984c5f21ef6baec2b606::hydro_token {
    ...
    fun init(arg0: HYDRO_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<HYDRO_TOKEN>(arg0, 9, b"HYO", b"HYDRO", b"Utility Coin for HYDRO", 0x1::option::none<0x2::url::Url>(), arg1);
    ...
    public entry fun mint(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut TreasuryLock, arg2: &mut MinterRole, arg3: u64, arg4: address, arg5: &UpgradeVersion, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_set::contains<address>(&arg2.has_unlimited_mint_access, &v0)) {
            0x2::coin::mint_and_transfer<HYDRO_TOKEN>(&mut arg1.treasury_cap, arg3, arg4, arg6);
        } else {
    ...
    public entry fun remove_addr_from_blacklist(arg0: &mut 0x2::deny_list::DenyList, arg1: &mut 0x2::coin::DenyCap<HYDRO_TOKEN>, arg2: vector<address>, arg3: &UpgradeVersion, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg3.version == 0, 9);
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
            0x2::coin::deny_list_remove<HYDRO_TOKEN>(arg0, arg1, 0x1::vector::pop_back<address>(&mut arg2), arg4);
            v0 = v0 + 1;
        };
