module 0x6912f65729914f9dbb55da0bfa6c4f36f10f5e7912c5baf5938d95828f52b840::vault {
    ...
    public(friend) fun redeem_internal<T0, T1>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: address, arg3: vector<u64>, arg4: vector<u64>, arg5: u64, arg6: vector<vector<u8>>, arg7: vector<vector<u8>>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v18 = 0x1::option::borrow_mut<0x2::coin::Coin<T0>>(&mut arg1.coin_store.coin);
        assert!(0x2::coin::value<T0>(v18) >= v11, 2);
        let v19 = 0x2::coin::split<T0>(v18, v11, arg9);
        let v20 = calculate_fee(v11, arg1.withdraw.fee_bps);
        arg1.withdraw.total_fee = arg1.withdraw.total_fee + v20;
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v19, v20, arg9), arg1.fee_receiver);
        let v21 = RedeemWithSigEvent{
            receiver                 : arg2,
            item_amount              : v12,
            amount                   : v11,
            vault_id                 : 0x2::object::id<Vault<T0, T1>>(arg1),
        ...
        0x2::event::emit<RedeemWithSigEvent>(v21);
        v19
    }
