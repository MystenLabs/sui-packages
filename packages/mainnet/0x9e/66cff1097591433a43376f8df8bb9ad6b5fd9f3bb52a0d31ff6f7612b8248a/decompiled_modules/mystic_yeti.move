module 0x9e66cff1097591433a43376f8df8bb9ad6b5fd9f3bb52a0d31ff6f7612b8248a::mystic_yeti {
    ...
    fun init(arg0: MYSTIC_YETI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Lofi the Yeti"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeich63yyvdyh27efmj2maksaf2mxeyv2r5ix6xnua6xcyjssb2mgni"));
