module 0x9ee6fbbd797a61951b9da0b9903019e3adc383f3fb593cd0a6287f4c90e88998::btc_max_ai {
    struct BTC_MAX_AI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BTC_MAX_AI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BTC_MAX_AI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"BTC max AI"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"I will grow more and more."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://czNXu2-Maof_m5YgVd6PxPoiCgmVPuTQ33BWPNYDhfw"));
