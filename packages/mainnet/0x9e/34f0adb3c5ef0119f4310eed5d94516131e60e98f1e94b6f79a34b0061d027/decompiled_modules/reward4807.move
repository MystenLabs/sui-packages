module 0x9e34f0adb3c5ef0119f4310eed5d94516131e60e98f1e94b6f79a34b0061d027::reward4807 {
    struct REWARD4807 has drop {
        dummy_field: bool,
    }

    struct TICKET_4807 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4807(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4807>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4807>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4807, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4807>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4807>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4807>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4807>>(v5, 0x2::tx_context::sender(arg1));
    }
