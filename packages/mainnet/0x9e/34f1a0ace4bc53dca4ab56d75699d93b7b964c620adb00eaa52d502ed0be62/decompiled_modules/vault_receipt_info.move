module 0x9e34f1a0ace4bc53dca4ab56d75699d93b7b964c620adb00eaa52d502ed0be62::vault_receipt_info {
    ...
    public(friend) fun update_reward(arg0: &mut VaultReceiptInfo, arg1: 0x1::type_name::TypeName, arg2: u256) : u256 {
        ...
        if (arg2 > *v1) {
            let v3 = 0x9e34f1a0ace4bc53dca4ab56d75699d93b7b964c620adb00eaa52d502ed0be62::vault_utils::mul_with_oracle_price(arg2 - *v1, arg0.shares);
            *v1 = arg2;
            *v2 = *v2 + v3;
