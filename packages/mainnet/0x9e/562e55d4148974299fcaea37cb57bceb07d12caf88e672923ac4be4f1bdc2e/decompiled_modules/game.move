module 0x9e562e55d4148974299fcaea37cb57bceb07d12caf88e672923ac4be4f1bdc2e::game {
    ...
    public fun create_game_witness() : 0x9e562e55d4148974299fcaea37cb57bceb07d12caf88e672923ac4be4f1bdc2e::leaderboard::GameWitness {
        0x9e562e55d4148974299fcaea37cb57bceb07d12caf88e672923ac4be4f1bdc2e::leaderboard::new_game_witness()
    }
    ...
    public entry fun mint_nft(arg0: &mut Session, arg1: AllowlistCap, arg2: &GameConfig, arg3: vector<u8>, arg4: &mut 0x9e562e55d4148974299fcaea37cb57bceb07d12caf88e672923ac4be4f1bdc2e::leaderboard::Leaderboard, arg5: 0x9e562e55d4148974299fcaea37cb57bceb07d12caf88e672923ac4be4f1bdc2e::leaderboard::GameWitness, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        0x9e562e55d4148974299fcaea37cb57bceb07d12caf88e672923ac4be4f1bdc2e::leaderboard::add_score(arg4, arg5, v1, v2, arg6, arg7);
        let AllowlistCap {
            id          : v7,
            session_id  : _,
            session_obj : _,
    ...
    public fun seal_approve(arg0: vector<u8>, arg1: &GameConfig, arg2: &0x2::clock::Clock) {
        assert!(0x1::vector::length<u8>(&arg0) == 40, 9);
        let v0 = 0x2::object::id_bytes<GameConfig>(arg1);
        let v1 = 0;
        while ((v1 as u64) < 32) {
        ...
        let v3 = 0;
        while ((v3 as u64) < 8) {
            v2 = v2 | (*0x1::vector::borrow<u8>(&arg0, 32 + (v3 as u64)) as u64) << v3 * 8;
            v3 = v3 + 1;
        };
        assert!(v2 == arg1.session_counter, 9);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg1.current_session), 3);
