module 0x9e509e260a912b98e301a863e796ea50d807d572063136e9674ce8449dc2a287::cnsnft3608 {
    struct CNSNFT3608 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3608, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3608>(arg0, arg1);
