module 0x9edcd51ada37ff33cad9dab5e92b901f3263b12edd4276713e31b7611a295bad::jorgie {
    ...
    fun init(arg0: JORGIE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = v0;
        0x2::coin::mint_and_transfer<JORGIE>(&mut v3, 100000000000000000, 0x2::tx_context::sender(arg1), arg1);
