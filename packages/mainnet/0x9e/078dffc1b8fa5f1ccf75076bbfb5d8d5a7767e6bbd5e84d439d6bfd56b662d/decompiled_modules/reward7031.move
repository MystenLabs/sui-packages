module 0x9e078dffc1b8fa5f1ccf75076bbfb5d8d5a7767e6bbd5e84d439d6bfd56b662d::reward7031 {
    struct REWARD7031 has drop {
        dummy_field: bool,
    }

    struct TICKET_7031 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7031(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7031>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7031>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7031, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7031>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7031>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7031>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7031>>(v5, 0x2::tx_context::sender(arg1));
    }
