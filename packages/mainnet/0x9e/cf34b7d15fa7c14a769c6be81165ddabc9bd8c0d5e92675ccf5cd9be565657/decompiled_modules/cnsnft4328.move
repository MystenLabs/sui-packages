module 0x9ecf34b7d15fa7c14a769c6be81165ddabc9bd8c0d5e92675ccf5cd9be565657::cnsnft4328 {
    struct CNSNFT4328 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4328, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4328>(arg0, arg1);
