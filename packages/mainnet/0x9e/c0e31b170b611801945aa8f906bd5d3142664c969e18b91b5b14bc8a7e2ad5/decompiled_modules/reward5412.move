module 0x9ec0e31b170b611801945aa8f906bd5d3142664c969e18b91b5b14bc8a7e2ad5::reward5412 {
    struct REWARD5412 has drop {
        dummy_field: bool,
    }

    struct TICKET_5412 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5412(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5412>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5412>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5412, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5412>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5412>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5412>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5412>>(v5, 0x2::tx_context::sender(arg1));
    }
