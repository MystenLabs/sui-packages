module 0x9e51f16ace50a21fe3668de8d0c0e7450170e589c93272c4af2b5b18562fdc54::cnsnft1533 {
    struct CNSNFT1533 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1533, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=5701"));
        let v4 = 0x2::package::claim<CNSNFT1533>(arg0, arg1);
