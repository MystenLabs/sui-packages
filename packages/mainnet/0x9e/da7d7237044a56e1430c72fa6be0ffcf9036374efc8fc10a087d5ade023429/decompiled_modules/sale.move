module 0x9eda7d7237044a56e1430c72fa6be0ffcf9036374efc8fc10a087d5ade023429::sale {
    ...
    public entry fun buy_land<T0>(arg0: &SaleConfig<T0>, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun buy_miner<T0>(arg0: &SaleConfig<T0>, arg1: &mut GlobalConfig<T0>, arg2: u64, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.is_enabled, 3);
