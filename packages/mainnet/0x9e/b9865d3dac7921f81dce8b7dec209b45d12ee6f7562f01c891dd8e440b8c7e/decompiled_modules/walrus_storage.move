module 0x9eb9865d3dac7921f81dce8b7dec209b45d12ee6f7562f01c891dd8e440b8c7e::walrus_storage {
    struct WALRUS_STORAGE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: WALRUS_STORAGE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<WALRUS_STORAGE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"walrus storage"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Here I want to put a collection related to storage, entertainment and anything else free."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://gh2QvzwLKZJW2JPlr59A6OJXZaeQHttmQEqEAEUKbH4"));
