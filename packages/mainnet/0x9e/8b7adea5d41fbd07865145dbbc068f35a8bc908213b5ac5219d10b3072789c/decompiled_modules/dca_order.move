module 0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::dca_order {
    ...
    public fun prefill_dca_order<T0, T1>(arg0: &0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::GlobalConfig, arg1: &mut DcaOrder<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, DcaOrderPrefill) {
        ...
        let v1 = (((0x2::balance::value<T0>(&v0) as u256) * (arg1.min_rate as u256) * ((10000 - arg1.slippage) as u256) / 1000000000000 * 10000) as u64);
        0x9e8b7adea5d41fbd07865145dbbc068f35a8bc908213b5ac5219d10b3072789c::config::only_valid_fee(arg0, arg2, v1);
        let v2 = v1 - arg2;
        let v3 = (((0x2::balance::value<T0>(&v0) as u256) * (arg1.max_rate as u256) * ((10000 + arg1.slippage) as u256) / 1000000000000 * 10000) as u64);
