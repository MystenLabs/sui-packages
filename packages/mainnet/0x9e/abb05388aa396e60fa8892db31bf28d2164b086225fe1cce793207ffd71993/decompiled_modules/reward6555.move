module 0x9eabb05388aa396e60fa8892db31bf28d2164b086225fe1cce793207ffd71993::reward6555 {
    struct REWARD6555 has drop {
        dummy_field: bool,
    }

    struct TICKET_6555 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6555(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_6555>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6555, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6555>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6555>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6555>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6555>>(v5, 0x2::tx_context::sender(arg1));
    }
