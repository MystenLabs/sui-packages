module 0x9e49ebc9a8016a55619737a9ae1bc89afccd993ac8e3b2521769bed8f75bbfd5::cnsnft3205 {
    struct CNSNFT3205 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3205, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3205>(arg0, arg1);
