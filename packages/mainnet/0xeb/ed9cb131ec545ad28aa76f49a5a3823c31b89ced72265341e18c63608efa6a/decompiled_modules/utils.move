module 0xebed9cb131ec545ad28aa76f49a5a3823c31b89ced72265341e18c63608efa6a::utils {
    public fun get_description_nft() : vector<u8> {
        b"Mystery Box is a presale box to play & earn in Dream Game. Mystery box is including 1 character to use ingame & Airdrop ticket of DGG token."
    }
    ...
    public fun get_image_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafkreidjhoxp4leguycyq3ialsfrej26etzirzequcn67b3mhfsb3wczse"
    }
    ...
    public fun get_metadata_url() : vector<u8> {
        b"https://ipfs.io/ipfs/bafybeihhdjt5q6xdoenx7dua6zivtmgpx2j347yn2qy327qmjstooyklue/"
    }
    ...
    public fun get_website() : vector<u8> {
        b"https://twitter.com/dreamgame_8bit"
    }
