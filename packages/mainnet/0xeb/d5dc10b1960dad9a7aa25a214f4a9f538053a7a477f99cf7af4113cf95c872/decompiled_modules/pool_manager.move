module 0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::pool_manager {
    ...
    public(friend) fun disable_manage(arg0: &mut SuiPoolManager, arg1: u64) {
        assert!(arg0.enabled_manage == true, 0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::error::paused());
        assert!(arg1 >= arg0.original_sui_amount, 0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::error::insufficient_balance());
        arg0.enabled_manage = false;
    }

    public(friend) fun enable_manage(arg0: &mut SuiPoolManager) {
        assert!(arg0.enabled_manage == false, 0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::error::paused());
    ...
    public(friend) fun prepare_before_withdraw<T0>(arg0: &mut SuiPoolManager, arg1: u64, arg2: u64, arg3: &mut 0x3::sui_system::SuiSystemState, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::event::emit_fund_updated(arg0.original_sui_amount, arg2, 0x2::balance::value<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT>(&arg0.vsui_balance), arg0.target_sui_amount, 0x2::object::uid_to_address(&arg0.id));
    ...
    public(friend) fun take_vsui_from_treasury(arg0: &mut SuiPoolManager, arg1: u64, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT> {
        ...
        0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::event::emit_staking_treasury_withdrawn(0x2::balance::value<0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert::CERT>(&v3), v0, 0x2::object::uid_to_address(&arg0.id));
        v3
    }
