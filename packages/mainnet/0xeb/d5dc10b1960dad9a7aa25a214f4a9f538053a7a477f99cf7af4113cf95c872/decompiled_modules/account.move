module 0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::account {
    ...
    public(friend) fun create_child_account_cap(arg0: &AccountCap, arg1: &mut 0x2::tx_context::TxContext) : AccountCap {
        let v0 = arg0.owner;
        assert!(0x2::object::uid_to_address(&arg0.id) == v0, 0xebd5dc10b1960dad9a7aa25a214f4a9f538053a7a477f99cf7af4113cf95c872::error::required_parent_account_cap());
        AccountCap{
