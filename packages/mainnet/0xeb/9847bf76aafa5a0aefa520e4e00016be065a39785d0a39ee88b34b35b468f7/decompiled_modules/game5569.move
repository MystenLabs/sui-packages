module 0xeb9847bf76aafa5a0aefa520e4e00016be065a39785d0a39ee88b34b35b468f7::game5569 {
    struct GAME5569 has drop {
        dummy_field: bool,
    }

    struct TICKET_5569 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5569(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5569>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5569>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME5569, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME5569>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5569>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5569>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5569>>(v5, 0x2::tx_context::sender(arg1));
    }
