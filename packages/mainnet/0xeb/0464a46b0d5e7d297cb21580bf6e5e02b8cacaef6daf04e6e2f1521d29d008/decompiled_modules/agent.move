module 0x5613a7e1f4f8fc7b896781aaba9b52944763e14421458d14c829223541d77c1c::agent {
    ...
    public fun admin_mint_badge(arg0: &AgentRegistry, arg1: &AdminCap, arg2: address, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<address, u64>(&arg0.agents, arg2), 1);
        let v0 = 0x2::clock::timestamp_ms(arg4);
        let v1 = AgentBadge{
            id          : 0x2::object::new(arg5),
            owner       : arg2,
            agent_id    : *0x2::table::borrow<address, u64>(&arg0.agents, arg2),
            skill_hash  : arg3,
            issued_at   : v0,
        ...
        0x2::transfer::public_transfer<AgentBadge>(v1, arg2);
    }
    ...
    public fun badge_owner(arg0: &AgentBadge) : address {
        arg0.owner
    }

    public entry fun freeze_treasury(arg0: TreasuryStore, arg1: &AdminCap) {
        let TreasuryStore {
            id       : v0,
            treasury : v1,
        } = arg0;
        0x2::object::delete(v0);
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<AGENT>>(v1);
    }

    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AGENT>(arg0, 6, b"AGENT", b"SUI AGENT", b"The first token built for AI agents to trade autonomously on Sui.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://teal-bizarre-leopard-828.mypinata.cloud/ipfs/bafkreie2hhcbgowj57myo4kcu7wi3apkg2uzsxwdz3qssxqonht32bmgqu")), arg1);
        let v2 = v0;
