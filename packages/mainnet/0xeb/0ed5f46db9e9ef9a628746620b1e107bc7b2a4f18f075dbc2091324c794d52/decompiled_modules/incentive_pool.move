module 0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::incentive_pool {
    ...
    struct IncentivePools<phantom T0> has store, key {
        ...
        reward_pool: 0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::reward_pool::RewardPool<T0>,
    }
    ...
    public(friend) fun add_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: 0x2::balance::Balance<T0>) {
        0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::reward_pool::add_reward<T0>(&mut arg0.reward_pool, arg1);
    }
    ...
    public(friend) fun claim_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : (u64, 0x2::balance::Balance<T0>) {
        0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::reward_pool::claim_reward<T0>(&mut arg0.reward_pool, arg1)
    }
    ...
    public(friend) fun create_incentive_pools<T0>(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : IncentivePools<T0> {
        IncentivePools<T0>{
            ...
            reward_pool : 0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::reward_pool::new<T0>(arg0, arg1),
        }
    }
    ...
    public fun reward_fee_recipient<T0>(arg0: &IncentivePools<T0>) : address {
        let v0 = IncentivePoolRewardFeeKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<IncentivePoolRewardFeeKey>(&arg0.id, v0)) {
            let v2 = IncentivePoolRewardFeeKey{dummy_field: false};
            0x2::dynamic_field::borrow<IncentivePoolRewardFeeKey, IncentivePoolRewardFee>(&arg0.id, v2).recipient
        } else {
            @0x0
        }
    }

    public fun reward_pool<T0>(arg0: &IncentivePools<T0>) : &0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::reward_pool::RewardPool<T0> {
        &arg0.reward_pool
    }
    ...
    public(friend) fun take_rewards<T0>(arg0: &mut IncentivePools<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::reward_pool::take_reward<T0>(&mut arg0.reward_pool, arg1)
    }
    ...
    public(friend) fun update_reward_pool<T0>(arg0: &mut IncentivePools<T0>, arg1: u64, arg2: u64) {
        0xeb0ed5f46db9e9ef9a628746620b1e107bc7b2a4f18f075dbc2091324c794d52::reward_pool::update_reward_pool<T0>(&mut arg0.reward_pool, arg1, arg2);
    }
