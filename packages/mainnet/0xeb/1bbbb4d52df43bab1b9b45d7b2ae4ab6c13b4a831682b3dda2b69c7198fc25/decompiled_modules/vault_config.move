module 0xeb1bbbb4d52df43bab1b9b45d7b2ae4ab6c13b4a831682b3dda2b69c7198fc25::vault_config {
    ...
    public(friend) fun borrow_withdraw_cap(arg0: &VaultTokenHolder) : &0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::QuickWithdrawCap {
        0x2::dynamic_field::borrow<0x1::ascii::String, 0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::QuickWithdrawCap>(&arg0.id, 0x1::ascii::string(b"quick_withdraw_cap"))
    }
    ...
    public(friend) fun get_cloud_wallet_addr(arg0: &VaultConfig) : address {
        *0x2::dynamic_field::borrow<0x1::ascii::String, address>(&arg0.id, 0x1::ascii::string(b"cloud_wallet_addr"))
    }
    ...
    public fun remove_withdraw_cap(arg0: &mut 0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::CloudWalletConfig, arg1: &VaultConfig, arg2: &mut VaultTokenHolder, arg3: &mut 0x2::tx_context::TxContext) {
        only_admin(arg1, arg3);
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::delete_quick_withdraw_cap(arg0, 0x2::dynamic_field::remove<0x1::ascii::String, 0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
    }
    ...
    public fun set_cloud_wallet_addr(arg0: &mut VaultConfig, arg1: address) {
        0x2::dynamic_field::remove_if_exists<0x1::ascii::String, address>(&mut arg0.id, 0x1::ascii::string(b"cloud_wallet_addr"));
        0x2::dynamic_field::add<0x1::ascii::String, address>(&mut arg0.id, 0x1::ascii::string(b"cloud_wallet_addr"), arg1);
    }

    public fun set_cloud_wallet_withdraw_cap(arg0: &mut 0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::CloudWalletConfig, arg1: &VaultConfig, arg2: &mut VaultTokenHolder, arg3: 0x2::transfer::Receiving<0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::QuickWithdrawCap>, arg4: &mut 0x2::tx_context::TxContext) {
        only_admin(arg1, arg4);
        if (0x2::dynamic_field::exists_<0x1::ascii::String>(&arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"))) {
            0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::delete_quick_withdraw_cap(arg0, 0x2::dynamic_field::remove<0x1::ascii::String, 0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap")));
        };
        0x2::dynamic_field::add<0x1::ascii::String, 0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, 0x1::ascii::string(b"quick_withdraw_cap"), 0x2::transfer::public_receive<0x71af7b4723fbfb28204a871225a594a2f150145ae12b2d97848ff9b54beb856a::cloud_wallet_config::QuickWithdrawCap>(&mut arg2.id, arg3));
    }
