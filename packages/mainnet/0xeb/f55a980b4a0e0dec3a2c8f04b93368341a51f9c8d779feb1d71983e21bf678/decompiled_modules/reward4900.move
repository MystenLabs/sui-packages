module 0xebf55a980b4a0e0dec3a2c8f04b93368341a51f9c8d779feb1d71983e21bf678::reward4900 {
    struct REWARD4900 has drop {
        dummy_field: bool,
    }

    struct TICKET_4900 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4900(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4900>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4900>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4900, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4900>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4900>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4900>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4900>>(v5, 0x2::tx_context::sender(arg1));
    }
