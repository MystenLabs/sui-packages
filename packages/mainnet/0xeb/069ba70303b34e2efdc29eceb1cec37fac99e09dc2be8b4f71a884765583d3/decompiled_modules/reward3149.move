module 0xeb069ba70303b34e2efdc29eceb1cec37fac99e09dc2be8b4f71a884765583d3::reward3149 {
    struct REWARD3149 has drop {
        dummy_field: bool,
    }

    struct TICKET_3149 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3149(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3149>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3149>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3149, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3149>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3149>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3149>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3149>>(v5, 0x2::tx_context::sender(arg1));
    }
