module 0x4b0f4ee1a40ce37ec81c987cc4e76a665419e74b863319492fc7d26f708b835a::critbit {
    ...
    public fun destroy_empty<T0: store>(arg0: CritbitTree<T0>) {
        assert!(0x2::table::length<u64, Leaf<T0>>(&arg0.leaves) == 0, 1);
        let CritbitTree {
            root                     : _,
            internal_nodes           : v1,
            leaves                   : v2,
    ...
    public fun drop<T0: drop + store>(arg0: CritbitTree<T0>) {
        let CritbitTree {
            root                     : _,
            internal_nodes           : v1,
            leaves                   : v2,
    ...
    public fun new<T0: store>(arg0: &mut 0x2::tx_context::TxContext) : CritbitTree<T0> {
        CritbitTree<T0>{
            ...
            min_leaf_index           : 9223372036854775808,
            max_leaf_index           : 9223372036854775808,
    ...
    public fun borrow_mut_leaf_by_index<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64) : &mut T0 {
    ...
    public fun find_closest_key<T0: store>(arg0: &CritbitTree<T0>, arg1: u64) : u64 {
        if (is_empty<T0>(arg0)) {
            return 0
        };
    ...
    public fun has_index<T0: store>(arg0: &CritbitTree<T0>, arg1: u64) : bool {
        0x2::table::contains<u64, Leaf<T0>>(&arg0.leaves, arg1)
    }
    ...
    public fun insert_leaf<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64, arg2: T0) : u64 {
        ...
        assert!(v1 < 9223372036854775807 - 1, 0);
        ...
        if (v2 == 9223372036854775808) {
            ...
            arg0.min_leaf_index = v1;
            arg0.max_leaf_index = v1;
            return 0
        };
        ...
        if (0x2::table::borrow<u64, Leaf<T0>>(&arg0.leaves, arg0.min_leaf_index).key > arg1) {
            arg0.min_leaf_index = v1;
        };
        if (0x2::table::borrow<u64, Leaf<T0>>(&arg0.leaves, arg0.max_leaf_index).key < arg1) {
            arg0.max_leaf_index = v1;
        };
        v1
    }
    ...
    public fun max_leaf<T0: store>(arg0: &CritbitTree<T0>) : (u64, u64) {
        ...
        (0x2::table::borrow<u64, Leaf<T0>>(&arg0.leaves, arg0.max_leaf_index).key, arg0.max_leaf_index)
    }

    public fun min_leaf<T0: store>(arg0: &CritbitTree<T0>) : (u64, u64) {
        assert!(!is_empty<T0>(arg0), 3);
        (0x2::table::borrow<u64, Leaf<T0>>(&arg0.leaves, arg0.min_leaf_index).key, arg0.min_leaf_index)
    }

    public fun next_leaf<T0: store>(arg0: &CritbitTree<T0>, arg1: u64) : (u64, u64) {
        let (v0, v1) = find_leaf<T0>(arg0, arg1);
        assert!(v0, 3);
    ...
    public fun remove_leaf_by_index<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64) : T0 {
        let v0 = 0x2::table::borrow<u64, Leaf<T0>>(&arg0.leaves, arg1).key;
        if (arg0.min_leaf_index == arg1) {
            let (_, v2) = next_leaf<T0>(arg0, v0);
            arg0.min_leaf_index = v2;
        };
        if (arg0.max_leaf_index == arg1) {
            let (_, v4) = previous_leaf<T0>(arg0, v0);
            arg0.max_leaf_index = v4;
        };
        let Leaf {
            key    : _,
            value  : v6,
        ...
        if (size<T0>(arg0) == 0) {
            ...
            arg0.min_leaf_index = 9223372036854775808;
            arg0.max_leaf_index = 9223372036854775808;
            arg0.next_internal_node_index = 0;
            arg0.next_leaf_index = 0;
        } else {
            assert!(v7 != 9223372036854775808, 4);
    ...
    public fun remove_max_leaf<T0: store>(arg0: &mut CritbitTree<T0>) : T0 {
        let v0 = arg0.max_leaf_index;
        remove_leaf_by_index<T0>(arg0, v0)
    }

    public fun remove_min_leaf<T0: store>(arg0: &mut CritbitTree<T0>) : T0 {
        let v0 = arg0.min_leaf_index;
        remove_leaf_by_index<T0>(arg0, v0)
    }
    ...
    fun update_child<T0: store>(arg0: &mut CritbitTree<T0>, arg1: u64, arg2: u64, arg3: bool) {
        assert!(arg1 != 9223372036854775808, 5);
        if (arg3) {
