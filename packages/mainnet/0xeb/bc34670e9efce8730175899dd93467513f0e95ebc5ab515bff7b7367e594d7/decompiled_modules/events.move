module 0xebbc34670e9efce8730175899dd93467513f0e95ebc5ab515bff7b7367e594d7::events {
    ...
    struct ForeignRewardDistributed has copy, drop {
        vault_id: 0x2::object::ID,
        profit_recipient: address,
        reward_type: 0x1::type_name::TypeName,
        amount: u64,
        cumulative_collected_amount: u128,
        cumulative_distributed_amount: u128,
        sequence: u64,
        generation: u64,
        policy_version: u64,
    }

    struct IncomePolicyApplied has copy, drop {
        vault_id: 0x2::object::ID,
        profit_recipient: address,
        mode: u8,
        sequence: u64,
        generation: u64,
        policy_version: u64,
        compounded_fee_a: u64,
        compounded_fee_b: u64,
        compounded_reward_a: u64,
        compounded_reward_b: u64,
        distributed_fee_a: u64,
        distributed_fee_b: u64,
        distributed_reward_a: u64,
        distributed_reward_b: u64,
        principal_idle_a: u64,
        principal_idle_b: u64,
        pending_fee_a: u64,
        pending_fee_b: u64,
        pending_reward_a: u64,
        pending_reward_b: u64,
    ...
    struct OwnerIncomeCollectionApplied has copy, drop {
        vault_id: 0x2::object::ID,
        pool_id: 0x2::object::ID,
    ...
    public(friend) fun emit_foreign_reward_distributed(arg0: 0x2::object::ID, arg1: address, arg2: 0x1::type_name::TypeName, arg3: u64, arg4: u128, arg5: u128, arg6: u64, arg7: u64, arg8: u64) {
        let v0 = ForeignRewardDistributed{
            vault_id                      : arg0,
            profit_recipient              : arg1,
            reward_type                   : arg2,
            amount                        : arg3,
            cumulative_collected_amount   : arg4,
            cumulative_distributed_amount : arg5,
            sequence                      : arg6,
            generation                    : arg7,
            policy_version                : arg8,
        };
        0x2::event::emit<ForeignRewardDistributed>(v0);
    }
    ...
    public(friend) fun emit_income_policy_applied(arg0: 0x2::object::ID, arg1: address, arg2: u8, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: u64, arg16: u64, arg17: u64, arg18: u64, arg19: u64, arg20: u128, arg21: u128, arg22: u128, arg23: u128, arg24: u128, arg25: u128, arg26: u128, arg27: u128) {
        let v0 = IncomePolicyApplied{
            vault_id                        : arg0,
            profit_recipient                : arg1,
            mode                            : arg2,
            sequence                        : arg3,
            generation                      : arg4,
            policy_version                  : arg5,
            compounded_fee_a                : arg6,
            compounded_fee_b                : arg7,
            compounded_reward_a             : arg8,
            compounded_reward_b             : arg9,
            distributed_fee_a               : arg10,
            distributed_fee_b               : arg11,
            distributed_reward_a            : arg12,
            distributed_reward_b            : arg13,
            principal_idle_a                : arg14,
            principal_idle_b                : arg15,
            pending_fee_a                   : arg16,
            pending_fee_b                   : arg17,
            pending_reward_a                : arg18,
            pending_reward_b                : arg19,
            cumulative_fee_compounded_a     : arg20,
            cumulative_fee_compounded_b     : arg21,
            cumulative_fee_distributed_a    : arg22,
            cumulative_fee_distributed_b    : arg23,
            cumulative_reward_compounded_a  : arg24,
            cumulative_reward_compounded_b  : arg25,
            cumulative_reward_distributed_a : arg26,
            cumulative_reward_distributed_b : arg27,
        };
        0x2::event::emit<IncomePolicyApplied>(v0);
    }
    ...
    public(friend) fun emit_owner_income_collection_applied(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: vector<0x1::type_name::TypeName>, arg15: vector<u64>, arg16: vector<u64>, arg17: u64, arg18: u64, arg19: u64, arg20: u64, arg21: u64, arg22: u64, arg23: u64, arg24: u64) {
        let v0 = OwnerIncomeCollectionApplied{
            vault_id             : arg0,
            pool_id              : arg1,
            below_position_id    : arg2,
            above_position_id    : arg3,
            position_generation  : arg4,
            sequence             : arg5,
            generation           : arg6,
            policy_version       : arg7,
            timestamp_ms         : arg8,
            income_action_ms     : arg9,
            below_fee_a          : arg10,
            below_fee_b          : arg11,
            above_fee_a          : arg12,
            above_fee_b          : arg13,
            reward_types         : arg14,
            below_reward_amounts : arg15,
            above_reward_amounts : arg16,
            principal_idle_a     : arg17,
            principal_idle_b     : arg18,
            current_deployed_a   : arg19,
            current_deployed_b   : arg20,
            pending_fee_a        : arg21,
            pending_fee_b        : arg22,
            pending_reward_a     : arg23,
            pending_reward_b     : arg24,
        };
        0x2::event::emit<OwnerIncomeCollectionApplied>(v0);
    }
    ...
    public(friend) fun emit_vault_created(arg0: 0x2::object::ID, arg1: 0x2::object::ID, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: address, arg5: address, arg6: address, arg7: address, arg8: 0x2::object::ID, arg9: u64, arg10: u16, arg11: u64, arg12: u64, arg13: u64) {
        let v0 = VaultCreated{
            vault_id         : arg0,
            pool_id          : arg1,
            config_id        : arg2,
            ...
            agent            : arg5,
            funding          : arg6,
            profit_recipient : arg7,
            cap_id           : arg8,
            protocol_version : arg9,
            bin_step         : arg10,
            sequence         : arg11,
            generation       : arg12,
            policy_version   : arg13,
        };
