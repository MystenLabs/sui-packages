module 0xeb1a526057ace9f0ff6e65106f9411c5d0b275b1236ff338e591a4f9947625f4::reward4653 {
    struct REWARD4653 has drop {
        dummy_field: bool,
    }

    struct TICKET_4653 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4653(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4653>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4653>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4653, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4653>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4653>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4653>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4653>>(v5, 0x2::tx_context::sender(arg1));
    }
