module 0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::duck_nft {
    ...
    public entry fun hatch_basic_egg(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SharedTreasury, arg9: &mut 0x2::kiosk::Kiosk, arg10: &0x2::kiosk::KioskOwnerCap, arg11: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg12: 0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>, arg13: 0x2::coin::Coin<0x2::sui::SUI>, arg14: u64, arg15: &0x2::random::Random, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg14;
        let v6 = v4 * arg14;
        assert!(0x2::coin::value<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&arg12) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut arg12, v5, arg17);
        0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::burn(arg8, 0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut v9, v7, arg17));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut v9, v8, arg17), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut v9, v8, arg17), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&arg12) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(arg12, 0x2::tx_context::sender(arg17));
        } else {
            0x2::coin::destroy_zero<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(arg12);
        };
    ...
    entry fun hatch_basic_egg_v2(arg0: &HatchCap, arg1: &mut PackSupply, arg2: &mut PerTypeSupply, arg3: &Whitelist, arg4: &TreasuryConfig, arg5: &ReferralRegistry, arg6: &mut GlobalStats, arg7: &mut UserStatsRegistry, arg8: &mut 0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SharedTreasury, arg9: &PackPricesV2, arg10: &mut 0x2::kiosk::Kiosk, arg11: &0x2::kiosk::KioskOwnerCap, arg12: &0x2::transfer_policy::TransferPolicy<DuckNFT>, arg13: 0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>, arg14: 0x2::coin::Coin<0x2::sui::SUI>, arg15: u64, arg16: &0x2::random::Random, arg17: &0x2::clock::Clock, arg18: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = v3 * arg15;
        let v6 = v4 * arg15;
        assert!(0x2::coin::value<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&arg13) >= v5, 1);
        ...
        let v7 = v5 * 80 / 100;
        let v8 = v5 * 10 / 100;
        let v9 = 0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut arg13, v5, arg18);
        0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::burn(arg8, 0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut v9, v7, arg18));
        ...
        if (0x1::option::is_some<address>(&v2)) {
            ...
            0x2::event::emit<ReferralReward>(v11);
            0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut v9, v8, arg18), v10);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(0x2::coin::split<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&mut v9, v8, arg18), arg4.treasury_wallet);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(v9, arg4.treasury_wallet);
        if (0x2::coin::value<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(&arg13) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>>(arg13, 0x2::tx_context::sender(arg18));
        } else {
            0x2::coin::destroy_zero<0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken::SHTTOKEN>(arg13);
        };
