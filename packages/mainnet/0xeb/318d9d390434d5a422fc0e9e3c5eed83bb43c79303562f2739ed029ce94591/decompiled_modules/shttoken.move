module 0xeb318d9d390434d5a422fc0e9e3c5eed83bb43c79303562f2739ed029ce94591::shttoken {
    ...
    public entry fun create_nest_mint_cap_v2(arg0: &0x2::package::Publisher, arg1: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::package::from_package<NestMintCap>(arg0), 2);
        let v0 = NestMintCapV2{id: 0x2::object::new(arg1)};
        0x2::transfer::share_object<NestMintCapV2>(v0);
    }
    ...
    public entry fun delete_nest_mint_cap_v1(arg0: &0x2::package::Publisher, arg1: NestMintCap) {
        assert!(0x2::package::from_package<NestMintCap>(arg0), 2);
        let NestMintCap { id: v0 } = arg1;
    ...
    public(friend) fun mint_for_nest_v2(arg0: &NestMintCapV2, arg1: &mut SharedTreasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<SHTTOKEN> {
        0x2::coin::mint<SHTTOKEN>(&mut arg1.treasury_cap, arg2, arg3)
    }
