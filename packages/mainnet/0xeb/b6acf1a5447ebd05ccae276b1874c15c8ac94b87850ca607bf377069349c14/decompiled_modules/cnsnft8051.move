module 0xebb6acf1a5447ebd05ccae276b1874c15c8ac94b87850ca607bf377069349c14::cnsnft8051 {
    struct CNSNFT8051 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8051, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8051>(arg0, arg1);
