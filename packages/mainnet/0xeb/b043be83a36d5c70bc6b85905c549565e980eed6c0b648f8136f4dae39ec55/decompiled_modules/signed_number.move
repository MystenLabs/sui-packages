module 0xebb043be83a36d5c70bc6b85905c549565e980eed6c0b648f8136f4dae39ec55::signed_number {
    ...
    public fun div_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0xebb043be83a36d5c70bc6b85905c549565e980eed6c0b648f8136f4dae39ec55::utils::base_div(arg0.value, arg1);
    ...
    public fun from_bytes(arg0: vector<u8>) : Number {
        ...
        Number{
            value : 0x2::bcs::peel_u64(&mut v0),
            sign  : 0x2::bcs::peel_bool(&mut v0),
        }
    }
    ...
    public fun mul_uint(arg0: Number, arg1: u64) : Number {
        let v0 = 0xebb043be83a36d5c70bc6b85905c549565e980eed6c0b648f8136f4dae39ec55::utils::base_mul(arg0.value, arg1);
        let v1 = v0 == 0 || arg0.sign;
        Number{
            value : v0,
            sign  : v1,
    ...
    public fun one() : Number {
        Number{
            value : 0xebb043be83a36d5c70bc6b85905c549565e980eed6c0b648f8136f4dae39ec55::constants::base_uint(),
            sign  : true,
        }
    }
