module 0xeb70d6f78750a292ab4f785ea9c738dfbe6a125d8c089212657662ddb57487e7::cnsnft1108 {
    struct CNSNFT1108 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1108, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1108>(arg0, arg1);
