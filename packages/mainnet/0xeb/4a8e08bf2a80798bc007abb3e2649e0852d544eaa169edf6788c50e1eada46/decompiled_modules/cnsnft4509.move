module 0xeb4a8e08bf2a80798bc007abb3e2649e0852d544eaa169edf6788c50e1eada46::cnsnft4509 {
    struct CNSNFT4509 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4509, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4509>(arg0, arg1);
