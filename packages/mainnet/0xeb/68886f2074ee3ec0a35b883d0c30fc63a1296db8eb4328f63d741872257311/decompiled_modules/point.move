module 0xeb68886f2074ee3ec0a35b883d0c30fc63a1296db8eb4328f63d741872257311::point {
    ...
    public fun send_add_point_req<T0: drop>(arg0: u256, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        send_add_point_req_<T0>(0xeb68886f2074ee3ec0a35b883d0c30fc63a1296db8eb4328f63d741872257311::constant::point_updater(), v0, arg0, arg2);
    }
    ...
    public fun send_add_point_req_with_owner<T0>(arg0: address, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        send_add_point_req_<T0>(0xeb68886f2074ee3ec0a35b883d0c30fc63a1296db8eb4328f63d741872257311::constant::point_updater(), arg0, arg1, arg2);
    }

    public fun send_sub_point_req<T0>(arg0: u256, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        send_sub_point_req_<T0>(0xeb68886f2074ee3ec0a35b883d0c30fc63a1296db8eb4328f63d741872257311::constant::point_updater(), v0, arg0, arg1);
    }
    ...
    public fun send_sub_point_req_with_owner<T0>(arg0: address, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        send_sub_point_req_<T0>(0xeb68886f2074ee3ec0a35b883d0c30fc63a1296db8eb4328f63d741872257311::constant::point_updater(), arg0, arg1, arg2);
    }
