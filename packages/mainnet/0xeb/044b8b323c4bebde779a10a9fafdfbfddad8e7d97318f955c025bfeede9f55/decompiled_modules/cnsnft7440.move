module 0xeb044b8b323c4bebde779a10a9fafdfbfddad8e7d97318f955c025bfeede9f55::cnsnft7440 {
    struct CNSNFT7440 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7440, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3155"));
        let v4 = 0x2::package::claim<CNSNFT7440>(arg0, arg1);
