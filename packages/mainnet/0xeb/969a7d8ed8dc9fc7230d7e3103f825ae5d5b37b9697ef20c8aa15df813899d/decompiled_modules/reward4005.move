module 0xeb969a7d8ed8dc9fc7230d7e3103f825ae5d5b37b9697ef20c8aa15df813899d::reward4005 {
    struct REWARD4005 has drop {
        dummy_field: bool,
    }

    struct TICKET_4005 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket4005(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_4005>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4005, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4005>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4005>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4005>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4005>>(v5, 0x2::tx_context::sender(arg1));
    }
