module 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::router {
    ...
    public fun calculate_router_swap_result<T0, T1, T2, T3>(arg0: &mut 0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::pool::Pool<T0, T1>, arg1: &mut 0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::pool::Pool<T2, T3>, arg2: bool, arg3: bool, arg4: bool, arg5: u64) {
        if (arg4) {
            let v0 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap<T0, T1>(arg0, arg2, arg4, arg5);
            let v1 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_amount_out(&v0);
            if (0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_is_exceed(&v0) || v1 > 18446744073709551615) {
                ...
                let v4 = (v1 as u64);
                let v5 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap<T2, T3>(arg1, arg3, arg4, v4);
                let v6 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_amount_out(&v5);
                if (v6 > 18446744073709551615) {
                    ...
                    let v9 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_is_exceed(&v0) || 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_is_exceed(&v5);
                    let v10 = CalculatedRouterSwapResult{
                        ...
                        target_sqrt_price_ab  : 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_after_sqrt_price(&v0),
                        target_sqrt_price_cd  : 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_after_sqrt_price(&v5),
                    };
            ...
            let v12 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap<T2, T3>(arg1, arg3, arg4, arg5);
            let v13 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_is_exceed(&v12);
            let v14 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_amount_in(&v12);
            if (v13 || v14 > 18446744073709551615) {
                ...
                let v17 = (v14 as u64);
                let v18 = (0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_fee_amount(&v12) as u64);
                let v19 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap<T0, T1>(arg0, arg2, arg4, v17 + v18);
                let v20 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_amount_in(&v19);
                if (v20 > 18446744073709551615) {
                    ...
                    let v23 = 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_is_exceed(&v19) || v13;
                    let v24 = CalculatedRouterSwapResult{
                        amount_in             : (v20 as u64) + (0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_fee_amount(&v19) as u64),
                        amount_medium         : v17 + v18,
                        amount_out            : arg5,
                        is_exceed             : v23,
                        current_sqrt_price_ab : 0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::pool::current_sqrt_price<T0, T1>(arg0),
                        current_sqrt_price_cd : 0x91657507890f065ad5ac9ad5f585ad54cce127f51d893ada7a18fa331a88af3c::pool::current_sqrt_price<T2, T3>(arg1),
                        target_sqrt_price_ab  : 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_after_sqrt_price(&v19),
                        target_sqrt_price_cd  : 0xeb26658e6eaacea1b65346b5e81a3e0cf4f5f20a999b1ae5a7cdd9657305b697::expect_swap::expect_swap_result_after_sqrt_price(&v12),
                    };
