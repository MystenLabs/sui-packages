module 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_machine {
    ...
    struct Store has store, key {
        ...
        vaults: 0x2::table::Table<0x1::string::String, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::GachaVault<Card>>,
        pack_index: u128,
    ...
    entry fun burn_card_in_vault(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: 0x2::object::ID, arg4: u64, arg5: vector<u8>, arg6: &0x2::tx_context::TxContext) {
        ...
        let Card {
            ...
            media_url   : _,
            attributes  : _,
        } = 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::remove_by_id<Card>(0x2::table::borrow_mut<0x1::string::String, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg2), arg3);
        0x2::object::delete(v2);
        let v7 = CardBurnedEvent{
            card_id    : arg3,
            vault_name : arg2,
        };
        0x2::event::emit<CardBurnedEvent>(v7);
    }
    ...
    fun buy_packs(arg0: &0x2::random::Random, arg1: &mut Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: 0x1::string::String, arg5: u64, arg6: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::table::borrow_mut<0x1::string::String, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg4);
        while (arg5 > 0) {
            let v6 = 0;
            let v7 = arg1.pack_index + 1;
            let v8 = 0x1::vector::empty<0x2::object::ID>();
            while (v6 < v3.pack_size) {
                let v9 = 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::remove_by_index<Card>(v5, 0x2::random::generate_u64_in_range(v1, 0, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::length<Card>(v5) - 1));
    ...
    fun init(arg0: GACHA_MACHINE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Card>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Fantasy TCG"));
        0x2::display::add<Card>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"The world's most generic TCG"));
        ...
        let v5 = Store{
            ...
            vaults              : 0x2::table::new<0x1::string::String, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::GachaVault<Card>>(arg1),
            pack_index          : 0,
            transfer_policy     : v2,
    ...
    entry fun mint_card(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: 0x1::string::String, arg7: vector<0x1::string::String>, arg8: vector<0x1::string::String>, arg9: u64, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        verify_version(arg1);
        verify_mint_admin(arg1, arg11);
        let v0 = 0x1::vector::empty<u8>();
        ...
        0x1::vector::append<u8>(&mut v0, 0x1::bcs::to_bytes<vector<0x1::string::String>>(&arg8));
        ...
        if (!0x2::table::contains<0x1::string::String, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::GachaVault<Card>>(&arg1.vaults, arg3)) {
            0x2::table::add<0x1::string::String, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg3, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::new<Card>(arg11));
        };
        0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::add<Card>(0x2::table::borrow_mut<0x1::string::String, 0xeb7cf804855a1c33e7391734d9fe6d98e8279fd54ae4b9cc045da771097427b2::gacha_vault::GachaVault<Card>>(&mut arg1.vaults, arg3), v2);
    }

    entry fun redeem_card(arg0: &0x2::clock::Clock, arg1: &Store, arg2: 0x2::object::ID, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg6: vector<u8>, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<u8>();
        ...
        assert!(0x2::clock::timestamp_ms(arg0) < arg3, 6);
        let (v2, v3) = 0x2::kiosk::purchase_with_cap<Card>(arg4, 0x2::kiosk::list_with_purchase_cap<Card>(arg4, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg5), arg2, 0, arg7), 0x2::coin::zero<0x2::sui::SUI>(arg7));
        let (_, _, _) = 0x2::transfer_policy::confirm_request<Card>(&arg1.transfer_policy, v3);
        let Card {
            id          : v7,
            name        : _,
            description : _,
        ...
        let v12 = CardRedeemedEvent{card_id: arg2};
        0x2::event::emit<CardRedeemedEvent>(v12);
    }
    ...
    entry fun sell_card(arg0: &0x2::clock::Clock, arg1: &mut Store, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg4: u128, arg5: 0x1::string::String, arg6: 0x2::object::ID, arg7: u64, arg8: u64, arg9: u64, arg10: vector<u8>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<CardSoldEvent>(v14);
    }
