module 0xeba6e429eda29082faa5d8874b404de615feab94ac027c30f6a0474c0cf2ebcd::RevealAurahmaNFT {
    struct REVEALAURAHMANFT has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: REVEALAURAHMANFT, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        let (v1, v2) = 0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::collection::create_with_mint_cap<REVEALAURAHMANFT, SimpleNft>(&arg0, 0x1::option::none<u64>(), arg1);
        let v3 = v1;
        let v4 = 0x2::package::claim<REVEALAURAHMANFT>(arg0, arg1);
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: vector<u8>, arg3: &0xbc3df36be17f27ac98e3c839b2589db8475fa07b20657b08e8891e3aaf5ee5f9::mint_cap::MintCap<SimpleNft>, arg4: address, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = SimpleNft{
        ...
        0x2::transfer::public_transfer<SimpleNft>(v0, arg4);
    }
