module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land {
    ...
    public fun rebuild_stakers_vector(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: vector<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        while (v2 < 0x1::vector::length<address>(&arg2)) {
            let v4 = 0x2::object::id_from_address(*0x1::vector::borrow<address>(&arg2, v2));
            v1 = v1 + 1;
            if (0x2::dynamic_field::exists_<0x2::object::ID>(&arg1.id, v4)) {
                0x2::dynamic_field::remove<0x2::object::ID, vector<u8>>(&mut arg1.id, v4);
                v0 = v0 + 1;
            };
            v2 = v2 + 1;
        };
        0x1::vector::push_back<0x1::string::String>(&mut v3, 0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"Checked NFTs: "));
        0x1::vector::push_back<0x1::string::String>(&mut v3, 0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::u128_to_string((v1 as u128)));
        0x1::vector::push_back<0x1::string::String>(&mut v3, 0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::utf8(b"Removed caches: "));
        0x1::vector::push_back<0x1::string::String>(&mut v3, 0xa9d503feaf655e76df1de94b034bcdd9c4caa7cba5311269506b07100d03ee72::pawtato_helpers::u128_to_string((v0 as u128)));
        let v5 = DebugEvent{messages: v3};
    ...
    public entry fun upgrade_version(arg0: &LandAdminCap, arg1: &mut StakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.version;
        assert!(v0 < 9, 13906836820043235327);
        arg1.version = 9;
