module 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::errors {
    ...
    public fun error_code_crafting_category_slot_full() : u64 {
        37
    }
    ...
    public fun error_code_item_invalid_tool() : u64 {
        34
    }

    public fun error_code_item_missing_required_tool() : u64 {
        32
    }
    ...
    public fun error_code_miscellaneous_slots_full() : u64 {
        36
    }
    ...
    public fun error_code_production_slots_full() : u64 {
        35
    }

    public fun error_code_quality_not_initialized() : u64 {
        30
    }

    public fun error_code_quality_out_of_range() : u64 {
        31
    }
    ...
    public fun error_code_tool_in_use() : u64 {
        33
    }
    ...
    public fun error_code_upgrade_already_purchased() : u64 {
        38
    }

    public fun error_code_upgrade_prerequisite_not_met() : u64 {
        39
    }
