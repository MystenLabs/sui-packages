module 0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::egg {
    ...
    public fun add_kiosk_lock_rule_official(arg0: &EggCollectionInfo, arg1: &mut 0x2::transfer_policy::TransferPolicy<AfEgg>) {
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::add<AfEgg>(arg1, &arg0.policy_cap);
    }

    public fun add_royalty_rule_official(arg0: &EggCollectionInfo, arg1: &mut 0x2::transfer_policy::TransferPolicy<AfEgg>) {
        0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::royalty_rule::add<AfEgg>(arg1, &arg0.policy_cap, 0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::constants::amount_bps(), 0);
    }
    ...
    public fun remove_kiosk_lock_rule(arg0: &EggCollectionInfo, arg1: &mut 0x2::transfer_policy::TransferPolicy<AfEgg>) {
        0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::kiosk_lock_rule::remove<AfEgg>(arg1, &arg0.policy_cap);
    }

    public fun remove_royalty_rule(arg0: &EggCollectionInfo, arg1: &mut 0x2::transfer_policy::TransferPolicy<AfEgg>) {
        0x484932c474bf09f002b82e4a57206a6658a0ca6dbdb15896808dcd1929c77820::royalty_rule::remove<AfEgg>(arg1, &arg0.policy_cap);
    }
    ...
    public fun update_display(arg0: &mut EggCollectionInfo, arg1: 0x1::string::String, arg2: 0x1::string::String) {
        let v0 = 0x2::display::fields<AfEgg>(&arg0.display);
        if (0x2::vec_map::contains<0x1::string::String, 0x1::string::String>(v0, &arg1)) {
            assert!(0x2::vec_map::get<0x1::string::String, 0x1::string::String>(v0, &arg1) != &arg2, 9223372921618497544);
            0x2::display::edit<AfEgg>(&mut arg0.display, arg1, arg2);
        } else {
            0x2::display::add<AfEgg>(&mut arg0.display, arg1, arg2);
        };
        0x2::display::update_version<AfEgg>(&mut arg0.display);
    }

    public fun withdraw_royalties(arg0: &EggCollectionInfo, arg1: &mut 0x2::transfer_policy::TransferPolicy<AfEgg>, arg2: 0x1::option::Option<u64>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        0x2::transfer_policy::withdraw<AfEgg>(arg1, &arg0.policy_cap, arg2, arg3)
    }
