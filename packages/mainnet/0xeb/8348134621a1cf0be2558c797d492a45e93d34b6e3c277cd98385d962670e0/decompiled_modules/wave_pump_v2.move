module 0x1ec60b387a1d0437107d80109b9e0667c93ffe3cb6ca893daafa11d3aacb5290::wave_pump_v2 {
    struct App has key {
        id: 0x2::object::UID,
    ...
    public fun buy<T0>(arg0: &mut App, arg1: 0x2::coin::Coin<0x82616322719cb327186d5b83a6d7783ce5cef4c5dbd4c6d1b5f3d6e5d288e2be::wav::WAV>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v8 = v5 + v2 - v3;
        let v9 = v6 - v7;
        if (v1.listing_dex_threshold > 0 && v8 >= v1.listing_dex_threshold) {
            v1.is_completed = true;
            let v10 = CompletedEvent{
                token_type   : v0,
                pool_id      : 0x2::object::id<Pool<T0>>(v1),
                wav_amount   : v8,
                token_amount : v9,
            };
            0x2::event::emit<CompletedEvent>(v10);
        };
        let v11 = SwapEvent{
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = App{
            ...
            fee_receiver          : @0x5c71df0f165474a7998c4e6d6787995b37afa0e4f80a744846cb87dd8d5c4e2b,
            operator              : @0x8a51e48948443293c0e652be069d3f6845d7748b26801c53614730696b53c323,
            version               : 1,
    ...
    public entry fun init_module(arg0: &0x1ec60b387a1d0437107d80109b9e0667c93ffe3cb6ca893daafa11d3aacb5290::wave_pump::OwnerCap, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = App{
    ...
    entry fun migrate(arg0: &0x1ec60b387a1d0437107d80109b9e0667c93ffe3cb6ca893daafa11d3aacb5290::wave_pump::OwnerCap, arg1: &mut App) {
    ...
    entry fun update_config(arg0: &0x1ec60b387a1d0437107d80109b9e0667c93ffe3cb6ca893daafa11d3aacb5290::wave_pump::OwnerCap, arg1: &mut App, arg2: address, arg3: address, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64) {
