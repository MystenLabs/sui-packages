module 0xe15294a337e2c136e81f7408b494cd63d2c957bdaf85d38200c69f90e0ba9242::consts {
    public(friend) fun CONFIG_KEY_AUTH_PUBLIC() : u8 {
        0
    }

    public(friend) fun F0Auth() : u8 {
        0
    }

    public(friend) fun F0PlayBox() : u8 {
        40
    }
    ...
    public(friend) fun USER_BAG_SOTRE_HOUSE_KEY() : u64 {
        1
    }

    public(friend) fun USER_BAG_SUBSCRIPTIONS_KEY() : u64 {
        0
    }
