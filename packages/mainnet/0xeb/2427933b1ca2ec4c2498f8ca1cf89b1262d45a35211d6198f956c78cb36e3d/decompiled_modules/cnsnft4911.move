module 0xeb2427933b1ca2ec4c2498f8ca1cf89b1262d45a35211d6198f956c78cb36e3d::cnsnft4911 {
    struct CNSNFT4911 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4911, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4911>(arg0, arg1);
