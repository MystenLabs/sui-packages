module 0xeb947c2573b92006e2d9121c9e0a8647b86b486f180a90a5a9a8a9e4bc01127a::cnsnft6719 {
    struct CNSNFT6719 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6719, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6719>(arg0, arg1);
