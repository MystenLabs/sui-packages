module 0xeb5d9d6d758d2aaa44782876a79cfd1553b8bf1a072b6cccdf2939f7dd69925f::cnsnft1998 {
    struct CNSNFT1998 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1998, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1998>(arg0, arg1);
