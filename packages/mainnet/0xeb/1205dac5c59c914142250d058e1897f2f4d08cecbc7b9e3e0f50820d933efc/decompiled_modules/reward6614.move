module 0xeb1205dac5c59c914142250d058e1897f2f4d08cecbc7b9e3e0f50820d933efc::reward6614 {
    struct REWARD6614 has drop {
        dummy_field: bool,
    }

    struct TICKET_6614 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6614(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6614>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6614>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6614, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6614>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6614>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6614>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6614>>(v5, 0x2::tx_context::sender(arg1));
    }
