module 0xebdfc614336a3b372e6bf2cb101afdb2621373a684b0f35165136e928616d256::cnsnft8834 {
    struct CNSNFT8834 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8834, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8834>(arg0, arg1);
