module 0xeba1eaf627e2e59ab9e5c98ee490c7eb20758f99b9e6075b78889be2dfb56c50::cnsnft3877 {
    struct CNSNFT3877 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3877, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3877>(arg0, arg1);
