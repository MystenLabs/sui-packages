module 0x47c8d4e4f92f877521a1b9dd553554dfec0f449277a9611aed4349c1c40a96ba::kiosk_transfers {
    ...
    public fun admin_upgrade_escrow(arg0: &mut Store, arg1: 0x2::object::ID, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg3) == @0x1565313b747dbdaf2d9d82709461018c43dafa495543d9923e710b1c6535d253, 0);
        let Escrow {
            id       : v0,
            receiver : v1,
    ...
    public fun claim_with_purchase_cap<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x2::tx_context::TxContext) : 0x2::transfer_policy::TransferRequest<T0> {
        if (0x2::dynamic_object_field::exists_with_type<0x2::object::ID, EscrowWithPurchaseCap<T0>>(&arg0.id, arg4)) {
            let v1 = 0x2::dynamic_object_field::remove<0x2::object::ID, EscrowWithPurchaseCap<T0>>(&mut arg0.id, arg4);
            assert!(0x2::tx_context::sender(arg6) == v1.receiver, 0);
            let EscrowWithPurchaseCap {
                id           : v2,
                receiver     : v3,
                sender       : v4,
            ...
            let (v6, v7) = 0x2::kiosk::purchase_with_cap<T0>(arg1, v5, 0x2::coin::zero<0x2::sui::SUI>(arg6));
            0x2::kiosk::lock<T0>(arg2, arg3, arg5, v6);
            let v8 = ClaimWithPurchaseCapEvent{
                receiver          : v3,
            ...
            0x2::event::emit<ClaimWithPurchaseCapEvent>(v8);
            v7
        } else {
            let v9 = 0x2::dynamic_object_field::remove<0x2::object::ID, RevertableEscrowWithPurchaseCap<T0>>(&mut arg0.id, arg4);
            assert!(0x2::tx_context::sender(arg6) == v9.receiver, 0);
            let RevertableEscrowWithPurchaseCap {
                id            : v10,
                receiver      : v11,
                sender        : v12,
            ...
            let (v15, v16) = 0x2::kiosk::purchase_with_cap<T0>(arg1, v13, 0x2::coin::zero<0x2::sui::SUI>(arg6));
            0x2::kiosk::lock<T0>(arg2, arg3, arg5, v15);
            let v17 = ClaimWithPurchaseCapEvent{
                receiver          : v11,
                receiver_kiosk_id : 0x2::object::id<0x2::kiosk::Kiosk>(arg2),
                sender            : v12,
                sender_kiosk_id   : 0x2::object::id<0x2::kiosk::Kiosk>(arg1),
            ...
            0x2::event::emit<ClaimWithPurchaseCapEvent>(v17);
            v16
        }
    }

    public fun direct_transfer<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: &0x2::kiosk::KioskOwnerCap, arg4: 0x2::object::ID, arg5: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg6: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v1;
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(arg5) || 0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk_rule::Rule>(arg5)) {
            ...
            if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk_rule::Rule>(arg5)) {
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk_rule::prove<T0>(arg2, &mut v2);
            };
        } else {
    ...
    public fun direct_transfer_to_receiver<T0: store + key>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: address, arg3: 0x2::object::ID, arg4: &mut 0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg6: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::kiosk::purchase_with_cap<T0>(arg0, 0x2::kiosk::list_with_purchase_cap<T0>(arg0, arg1, arg3, 0, arg6), 0x2::coin::zero<0x2::sui::SUI>(arg6));
        let v2 = v1;
        if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(arg4) || 0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk_rule::Rule>(arg4)) {
            ...
            if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::Rule>(arg4)) {
                0x2::kiosk::lock<T0>(&mut v6, &v5, arg4, v0);
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::kiosk_lock_rule::prove<T0>(&mut v2, &v6);
            } else {
                0x2::kiosk::place<T0>(&mut v6, &v5, v0);
            };
            if (0x2::transfer_policy::has_rule<T0, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk_rule::Rule>(arg4)) {
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::create_for(&mut v6, v5, arg2, arg6);
                0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk_rule::prove<T0>(&v6, &mut v2);
            } else {
                0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v5, arg2);
            };
