module 0xeb11f0acdec663880f4e9c147749849fd7adf48d3b6cca6c7984a5314f69eb8d::orderbook_raw {
    ...
    public(friend) fun buy<T0: store + key>(arg0: &mut OrderbookRaw<T0>, arg1: 0x2::object::ID, arg2: &mut 0x2::balance::Balance<0x2::sui::SUI>) : (T0, 0x2::balance::Balance<0x2::sui::SUI>, address, u64) {
        ...
        if (0x1::option::is_some<Commission>(&v5)) {
            ...
            if (0x2::dynamic_field::exists_<BalanceKey>(&arg0.id, v11)) {
    ...
    public(friend) fun claim_commission<T0: store + key>(arg0: &mut OrderbookRaw<T0>, arg1: &0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
    ...
    public(friend) fun delist<T0: store + key>(arg0: &mut OrderbookRaw<T0>, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) : T0 {
        assert_listed<T0>(arg0, arg1);
        let v0 = ListingKey{object_id: arg1};
        let Listing {
            object     : v1,
    ...
    public(friend) fun destroy<T0: store + key>(arg0: OrderbookRaw<T0>) {
        let OrderbookRaw { id: v0 } = arg0;
    ...
    public(friend) fun list<T0: store + key>(arg0: &mut OrderbookRaw<T0>, arg1: 0x2::object::ID, arg2: T0, arg3: u64, arg4: 0x1::option::Option<Commission>, arg5: &0x2::tx_context::TxContext) {
        let v0 = ListingKey{object_id: arg1};
        let v1 = Listing<T0>{
            object     : arg2,
            price      : arg3,
    ...
    public(friend) fun modify<T0: store + key>(arg0: &mut OrderbookRaw<T0>, arg1: 0x2::object::ID, arg2: u64, arg3: 0x1::option::Option<Commission>, arg4: &0x2::tx_context::TxContext) {
        assert_listed<T0>(arg0, arg1);
        let v0 = ListingKey{object_id: arg1};
