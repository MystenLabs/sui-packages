module 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::dapp {
    ...
    public fun buyToken<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 13906838001159241727);
        let v1 = 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::get_sui_amount(arg1, v0);
    ...
    public entry fun claimBalance<T0, T1>(arg0: &mut Contract<T1>, arg1: &0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::PriceOracle, arg2: u64, arg3: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg7: &0x2::clock::Clock, arg8: &mut 0x3::sui_system::SuiSystemState, arg9: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = withdrawSui<T0>(&arg0.vault, 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::get_sui_amount(arg1, arg2 - arg2 / 10), arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v2, 0x2::tx_context::sender(arg10));
    }

    public entry fun claimInterest<T0>(arg0: &mut Contract<T0>, arg1: u64, arg2: &0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::PriceOracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        withdraw_pre<T0>(arg0, v0, 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::get_usdt_amount(arg2, v5), arg4);
    }
    ...
    public fun freezeUser<T0>(arg0: &mut Contract<T0>, arg1: address, arg2: u8, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg2 == 1) {
            arg0.global_network_data.total_freeze_user = arg0.global_network_data.total_freeze_user + 1;
        } else if (arg0.global_network_data.total_freeze_user > 0) {
            arg0.global_network_data.total_freeze_user = arg0.global_network_data.total_freeze_user - 1;
        };
    }
    ...
    fun handler_out(arg0: &mut GlobalNetworkData, arg1: &mut User) {
        ...
        while (0x1::vector::length<Order>(&arg1.orders) > v0) {
            ...
            if (v2.status == 0 && arg1.total_earning >= v3) {
                ...
                if (arg0.total_asset_invested >= v2.amount) {
    ...
    public entry fun investment<T0, T1, T2>(arg0: &mut Contract<T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::PriceOracle, arg4: u64, arg5: u8, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T0>, arg8: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg9: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg10: &mut 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::rank_list::TodayRank, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        if (v7 > 0) {
            ...
            v8 = v9;
            assert!(v9 >= 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::get_pre_amount(arg3, arg4 * (v7 as u64) / 100), 2);
            0x2::balance::join<T1>(&mut arg0.pre_balance, 0x2::coin::into_balance<T1>(arg2));
            v3.total_pre_invested_amount = v3.total_pre_invested_amount + v9;
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(arg2, v0);
        };
        let v10 = v4.invest_amount == 0;
        ...
        v3.total_asset_invested = v3.total_asset_invested + arg4;
        v3.total_static_power = v3.total_static_power + v11;
        if (v10) {
            v3.total_effective_user = v3.total_effective_user + 1;
        };
        let v12 = Order{
        ...
        if (v10 && arg0.up_time < 0x2::clock::timestamp_ms(arg11)) {
        ...
        update_dynamic_power(v3, v1, v0, arg4, v10);
    ...
    public entry fun stake<T0>(arg0: &mut Contract<T0>, arg1: &0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::PriceOracle, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg2);
        assert!(v0 > 0, 3);
        let v1 = if (arg3 == 7) {
            true
        ...
        let v4 = StakeOrder{
            ...
            cycle              : arg3,
            pre_amount         : v0,
            amount             : 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::price_oracle::get_pre_amount(arg1, v0),
            interest           : 0,
    ...
    fun update_share_performance(arg0: &mut 0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::rank_list::TodayRank, arg1: &mut 0x2::table::Table<address, User>, arg2: address, arg3: u64, arg4: &0x2::clock::Clock) {
        let v0 = 0x2::table::borrow_mut<address, User>(arg1, arg2).inviter;
        if (0x1::option::is_some<address>(&v0)) {
            ...
            0xebeaa163a98b6358f4d886a6eb757d512860666f6de29c4d938cb6d78ee91098::rank_list::add_performance(arg0, arg2, arg3, arg4);
        };
    }
