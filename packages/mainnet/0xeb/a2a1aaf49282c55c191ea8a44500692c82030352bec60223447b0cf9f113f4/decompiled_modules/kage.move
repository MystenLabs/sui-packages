module 0xeba2a1aaf49282c55c191ea8a44500692c82030352bec60223447b0cf9f113f4::kage {
    ...
    struct MemoryQueried has copy, drop {
        memory_id: u64,
        queried_by: address,
        owner_namespace: 0x1::string::String,
    ...
    fun check_conflict(arg0: &mut KageProtocol, arg1: u64, arg2: &0x1::string::String, arg3: &0x1::string::String, arg4: &0x1::string::String, arg5: address, arg6: u64) : (bool, 0x1::option::Option<u64>) {
        ...
        let v5 = v4;
        while (v5 < v0) {
            if (0x2::table::contains<u64, MemoryEntry>(&arg0.memory_index, v5)) {
                let v6 = 0x2::table::borrow<u64, MemoryEntry>(&arg0.memory_index, v5);
                let v7 = if (v6.asset == *arg2) {
                    if (v6.namespace == *arg4) {
                        if (v6.action == v3) {
                            if (v6.agent != arg5) {
                                !v6.conflict_flag
                            } else {
                ...
                if (v7) {
                    ...
                    0x2::event::emit<ConflictDetected>(v8);
                    let v9 = 0x2::table::borrow_mut<u64, MemoryEntry>(&mut arg0.memory_index, v5);
                    v9.conflict_flag = true;
                    v9.conflict_with = 0x1::option::some<u64>(arg1);
                    return (true, 0x1::option::some<u64>(v5))
                };
            };
            v5 = v5 + 1;
        };
    ...
    public entry fun create_bridge(arg0: &mut KageProtocol, arg1: &mut KageProtocol, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<BridgeCreated>(v6);
        let v7 = CrossGraphBridge{
            id               : v2,
            protocol_a       : v4,
            protocol_b       : v5,
            shared_namespace : v1,
        ...
        0x2::transfer::share_object<CrossGraphBridge>(v7);
    }

    public entry fun deregister_agent(arg0: &mut KageProtocol, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x2::table::contains<address, AgentRecord>(&arg0.agent_registry, v0), 2);
        0x2::table::borrow_mut<address, AgentRecord>(&mut arg0.agent_registry, v0).active = false;
    }
            ...
            if (0x2::table::contains<u64, Subscription>(&arg0.subscriptions, v0)) {
                ...
                if (!v1.active) {
                    ...
                    if (v6) {
                        ...
                        0x2::table::borrow_mut<u64, Subscription>(&mut arg0.subscriptions, v0).trigger_count = 0x2::table::borrow<u64, Subscription>(&arg0.subscriptions, v0).trigger_count + 1;
                    };
                };
            };
            v0 = v0 + 1;
    ...
    public fun get_agent_namespace(arg0: &KageProtocol, arg1: address) : 0x1::string::String {
        if (!0x2::table::contains<address, AgentRecord>(&arg0.agent_registry, arg1)) {
            return 0x1::string::utf8(b"")
        };
        0x2::table::borrow<address, AgentRecord>(&arg0.agent_registry, arg1).namespace
    }
    ...
    public fun get_memory_namespace(arg0: &KageProtocol, arg1: u64) : 0x1::string::String {
        assert!(0x2::table::contains<u64, MemoryEntry>(&arg0.memory_index, arg1), 6);
        0x2::table::borrow<u64, MemoryEntry>(&arg0.memory_index, arg1).namespace
    }
    ...
    fun index_push(arg0: &mut 0x2::vec_map::VecMap<0x1::string::String, vector<u64>>, arg1: &0x1::string::String, arg2: u64) {
        if (0x2::vec_map::contains<0x1::string::String, vector<u64>>(arg0, arg1)) {
            ...
            0x2::vec_map::insert<0x1::string::String, vector<u64>>(arg0, *arg1, v0);
        };
    }
    ...
    public entry fun inherit_memory(arg0: &mut KageProtocol, arg1: u64, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<vector<u8>>, arg5: vector<u8>, arg6: u64, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::table::contains<address, AgentRecord>(&arg0.agent_registry, v0), 2);
        assert!(0x2::table::borrow<address, AgentRecord>(&arg0.agent_registry, v0).active, 11);
        assert!(0x2::table::contains<u64, MemoryEntry>(&arg0.memory_index, arg1), 6);
        ...
        let v3 = 0x2::table::borrow<u64, MemoryEntry>(&arg0.memory_index, arg1).asset;
        let v4 = 0x2::table::borrow<u64, MemoryEntry>(&arg0.memory_index, arg1).namespace;
        let v5 = 0x1::vector::empty<0x1::string::String>();
        let v6 = 0;
        while (v6 < 0x1::vector::length<vector<u8>>(&arg4)) {
            0x1::vector::push_back<0x1::string::String>(&mut v5, 0x1::string::utf8(*0x1::vector::borrow<vector<u8>>(&arg4, v6)));
            v6 = v6 + 1;
        };
        let v7 = 0x2::table::borrow_mut<address, AgentRecord>(&mut arg0.agent_registry, v0);
        v7.total_writes = v7.total_writes + 1;
        let v8 = 0x1::string::utf8(arg5);
        let v9 = 0x1::string::utf8(arg2);
        let v10 = MemoryEntry{
            id                : v2,
            agent             : v0,
            blob_id           : v9,
            ...
            weight            : v7.reputation,
            namespace         : v4,
            inherited_from    : 0x1::option::some<u64>(arg1),
            shared_from_graph : 0x1::option::none<0x2::object::ID>(),
        };
        let v11 = &mut arg0.namespace_index;
        index_push(v11, &v4, v2);
        let v12 = &mut arg0.asset_index;
        index_push(v12, &v3, v2);
        0x2::table::add<u64, MemoryEntry>(&mut arg0.memory_index, v2, v10);
        arg0.total_memories = arg0.total_memories + 1;
        let v13 = MemoryInherited{
            child_memory_id  : v2,
            parent_memory_id : arg1,
            child_agent      : v0,
            parent_agent     : 0x2::table::borrow<u64, MemoryEntry>(&arg0.memory_index, arg1).agent,
            namespace        : v4,
            timestamp_ms     : v1,
        };
        0x2::event::emit<MemoryInherited>(v13);
        fire_triggers(arg0, v2, &v9, &v5, &v3, &v8, &v4, v1);
    }
    ...
    public fun is_agent_registered(arg0: &KageProtocol, arg1: address) : bool {
        0x2::table::contains<address, AgentRecord>(&arg0.agent_registry, arg1) && 0x2::table::borrow<address, AgentRecord>(&arg0.agent_registry, arg1).active
    }
    ...
    public fun query_memory_internal(arg0: &mut KageProtocol, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) : (0x1::string::String, bool) {
        assert!(0x2::table::contains<u64, MemoryEntry>(&arg0.memory_index, arg1), 6);
        assert!(0x2::table::contains<address, AgentRecord>(&arg0.agent_registry, arg2), 2);
        let v0 = 0x2::table::borrow<u64, MemoryEntry>(&arg0.memory_index, arg1).namespace;
        let v1 = 0x2::table::borrow<address, AgentRecord>(&arg0.agent_registry, arg2).namespace != v0;
        let v2 = MemoryQueried{
            memory_id          : arg1,
            queried_by         : arg2,
            owner_namespace    : v0,
            is_cross_namespace : v1,
            timestamp_ms       : 0x2::tx_context::epoch_timestamp_ms(arg3),
        };
        0x2::event::emit<MemoryQueried>(v2);
        (0x2::table::borrow<u64, MemoryEntry>(&arg0.memory_index, arg1).blob_id, v1)
    }
    ...
    public entry fun share_memory_across(arg0: &mut CrossGraphBridge, arg1: &KageProtocol, arg2: &mut KageProtocol, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_map::contains<0x2::object::ID, bool>(&arg1.active_bridges, &v0), 7);
        let v1 = 0x2::object::uid_to_inner(&arg1.id);
        let v2 = 0x2::tx_context::epoch_timestamp_ms(arg4);
        let v3 = arg2.total_memories;
        let v4 = 0x2::table::borrow<u64, MemoryEntry>(&arg1.memory_index, arg3);
        let v5 = MemoryEntry{
            id                : v3,
            agent             : v4.agent,
            blob_id           : v4.blob_id,
            blob_hash         : v4.blob_hash,
            tags              : v4.tags,
            asset             : v4.asset,
            action            : v4.action,
            outcome           : v4.outcome,
            confidence        : v4.confidence,
            ttl_epochs        : v4.ttl_epochs,
            ...
            shared_from_graph : 0x1::option::some<0x2::object::ID>(v1),
        };
        let v6 = &mut arg2.namespace_index;
        index_push(v6, &arg0.shared_namespace, v3);
        let v7 = &mut arg2.asset_index;
        index_push(v7, &v4.asset, v3);
        0x2::table::add<u64, MemoryEntry>(&mut arg2.memory_index, v3, v5);
        arg2.total_memories = arg2.total_memories + 1;
        arg0.total_shared = arg0.total_shared + 1;
        let v8 = CrossGraphMemoryShared{
        ...
        0x2::event::emit<CrossGraphMemoryShared>(v8);
    }
