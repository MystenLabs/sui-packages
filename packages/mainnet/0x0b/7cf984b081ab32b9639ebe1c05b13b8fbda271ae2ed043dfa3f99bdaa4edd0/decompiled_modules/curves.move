module 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves {
    ...
    public fun buy<T0>(arg0: &mut BondingCurve<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v8 = 5000000000000 - v5;
        0x1::debug::print<u64>(&v8);
        let v9 = v8 / 100;
        let v10 = if (0x2::balance::value<0x2::sui::SUI>(&v1) > v8 + v9) {
            take_fee<T0>(arg0, 0x2::balance::split<0x2::sui::SUI>(&mut v1, v9), v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::from_balance<0x2::sui::SUI>(v1, arg2), v0);
            0x2::balance::split<0x2::sui::SUI>(&mut v1, v8)
        } else {
        ...
        let v15 = get_output_amount(v12, v5 + arg0.virtual_sui_amt, v4);
        0x2::balance::join<0x2::sui::SUI>(&mut arg0.sui_balance, v11);
        let (v16, v17) = get_reserves<T0>(arg0);
        let v18 = v17;
        let v19 = v16;
        let v20 = b"+++++++";
        ...
        assert!(v19 > 0 && v18 > 0, 5);
        if (v19 >= 5000000000000) {
            arg0.is_active = false;
            let v22 = MigrationPendingEvent{
                bc_id            : 0x2::object::id<BondingCurve<T0>>(arg0),
                meme_type        : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
                sui_reserve_val  : 3000000000000 + 500000000,
                meme_reserve_val : v18 - v15,
            };
            0x1::debug::print<MigrationPendingEvent>(&v22);
            0x2::event::emit<MigrationPendingEvent>(v22);
        };
        let v23 = SwapEvent{
            bc_id            : 0x2::object::id<BondingCurve<T0>>(arg0),
            meme_type        : 0x1::type_name::into_string(0x1::type_name::get<T0>()),
        ...
        0x1::debug::print<SwapEvent>(&v23);
        0x2::event::emit<SwapEvent>(v23);
        0x2::coin::take<T0>(&mut arg0.meme_balance, v15, arg2)
    }
    ...
    public fun list<T0>(arg0: &mut Configurator, arg1: 0x2::coin::TreasuryCap<T0>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminAccess, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u8, arg6: 0x1::option::Option<0x2::url::Url>, arg7: 0x1::option::Option<0x2::url::Url>, arg8: 0x1::option::Option<0x2::url::Url>, arg9: &mut 0x2::tx_context::TxContext) : BondingCurve<T0> {
        ...
        0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::freezer::freeze_object<0x2::coin::TreasuryCap<T0>>(arg1, arg9);
        let (_, _, v3) = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::get_addresses(arg3);
        let v4 = v3;
        let v5 = b"+++++++++++++++++++++++++++++";
    ...
    public fun migrating<T0>(arg0: &mut BondingCurve<T0>, arg1: &mut Configurator, arg2: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminAccess, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_active, 6);
        let (v0, v1) = get_reserves<T0>(arg0);
        let v2 = v1;
        0x1::debug::print<u64>(&v2);
        let v3 = 306571483142857143;
        0x1::debug::print<u64>(&v3);
        assert!(v0 >= 3000000000000, 3);
        assert!(v2 >= 306571483142857143, 7);
        ...
        let (v10, v11, v12) = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::get_addresses(arg2);
        let v13 = v11;
        let v14 = b"====================";
        0x1::debug::print<vector<u8>>(&v14);
    ...
    public fun update_listing_fee(arg0: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.listing_fee = arg2;
    }

    public fun update_migration_fee(arg0: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.migration_fee = arg2;
    }

    public fun update_target_supply_threshold(arg0: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.target_supply_threshold = arg2;
    }

    public fun update_virtual_sui_liq(arg0: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminCap, arg1: &mut Configurator, arg2: u64) {
        arg1.virtual_sui_amt = arg2;
    }

    public fun withdraw_fee(arg0: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminCap, arg1: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminAccess, arg2: &mut Configurator, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let (_, _, v2) = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::get_addresses(arg1);
