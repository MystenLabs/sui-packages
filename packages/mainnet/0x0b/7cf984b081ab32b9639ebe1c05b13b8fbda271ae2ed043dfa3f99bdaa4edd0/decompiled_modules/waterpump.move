module 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::waterpump {
    ...
    public entry fun buy<T0>(arg0: &mut 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::BondingCurve<T0>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::buy<T0>(arg0, arg1, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v0, 0x2::tx_context::sender(arg2));
        0x2::coin::value<T0>(&v0)
    }

    public entry fun sell<T0>(arg0: &mut 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::BondingCurve<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) : u64 {
        let v0 = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::sell<T0>(arg0, arg1, 0, arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(v0, 0x2::tx_context::sender(arg2));
        0x2::coin::value<0x2::sui::SUI>(&v0)
    }

    public entry fun bonding_curve_state<T0>(arg0: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::BondingCurve<T0>) : BondingCurveState {
        let (v0, v1, _, _, v4) = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::get_curve_state<T0>(arg0);
        BondingCurveState{
            sui_balance  : v0,
            meme_balance : v1,
            is_active    : v4,
    ...
    public entry fun create_and_first_buy_1<T0>(arg0: &mut BondingCurveRegistry, arg1: &mut 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::Configurator, arg2: 0x2::coin::TreasuryCap<T0>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::admin::AdminAccess, arg5: 0x2::coin::Coin<0x2::sui::SUI>, arg6: u8, arg7: 0x1::ascii::String, arg8: 0x1::ascii::String, arg9: 0x1::ascii::String, arg10: &mut 0x2::tx_context::TxContext) : u64 {
        let (_, _, v2, _) = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::get_config_info(arg1);
        assert!(v2 <= 0x2::coin::value<0x2::sui::SUI>(&arg5), 3);
        let v4 = 0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::list<T0>(arg1, arg2, arg3, arg4, 0x2::coin::split<0x2::sui::SUI>(&mut arg5, v2, arg10), arg6, string_into_Url(arg8), string_into_Url(arg9), string_into_Url(arg7), arg10);
        registry_bonding(arg0, 0x2::object::id<0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::BondingCurve<T0>>(&v4), 0x2::coin::get_symbol<T0>(arg3), 0x2::tx_context::sender(arg10), 0x2::tx_context::epoch_timestamp_ms(arg10));
        let v5 = 0;
        if (!0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::is_empty<0x2::sui::SUI>(&arg5)) {
            let v6 = &mut v4;
            v5 = buy<T0>(v6, arg5, arg10);
        } else {
            0x2::coin::destroy_zero<0x2::sui::SUI>(arg5);
        };
        0xb7cf984b081ab32b9639ebe1c05b13b8fbda271ae2ed043dfa3f99bdaa4edd0::curves::transfer<T0>(v4);
        v5
    }
