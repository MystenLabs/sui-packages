module 0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::metadata {
    ...
    public(friend) fun new<T0>(arg0: &mut 0x2::object::UID, arg1: 0x1::ascii::String, arg2: 0x1::ascii::String, arg3: 0x1::option::Option<0x1::ascii::String>, arg4: 0x1::option::Option<0x1::ascii::String>, arg5: 0x1::option::Option<0x1::ascii::String>, arg6: 0x1::option::Option<vector<0x1::ascii::String>>, arg7: 0x1::option::Option<vector<0x1::ascii::String>>) : VaultMetadata<T0> {
        let v0 = 0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::keys::vault_metadata_key();
        assert!(!0x2::derived_object::exists<0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::keys::VaultMetadataKey>(arg0, v0), 13835058373109743617);
        let v1 = &mut arg6;
        ...
        VaultMetadata<T0>{
            id               : 0x2::derived_object::claim<0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::keys::VaultMetadataKey>(arg0, v0),
    ...
    public(friend) fun set_curator_logo_url<T0>(arg0: &mut VaultMetadata<T0>, arg1: 0x1::ascii::String) {
        ...
        0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::events::emit_update_vault_metadata(arg0.vault_id, 0x1::string::utf8(b"curator_logo_url"), 0x1::string::from_ascii(arg1));
    }
    ...
    public(friend) fun set_curator_name<T0>(arg0: &mut VaultMetadata<T0>, arg1: 0x1::ascii::String) {
        ...
        0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::events::emit_update_vault_metadata(arg0.vault_id, 0x1::string::utf8(b"curator_name"), 0x1::string::from_ascii(arg1));
    }
    ...
    public(friend) fun set_curator_url<T0>(arg0: &mut VaultMetadata<T0>, arg1: 0x1::ascii::String) {
        ...
        0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::events::emit_update_vault_metadata(arg0.vault_id, 0x1::string::utf8(b"curator_url"), 0x1::string::from_ascii(arg1));
    }

    public(friend) fun set_description<T0>(arg0: &mut VaultMetadata<T0>, arg1: 0x1::ascii::String) {
        arg0.description = arg1;
        0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::events::emit_update_vault_metadata(arg0.vault_id, 0x1::string::utf8(b"description"), 0x1::string::from_ascii(arg1));
    }
    ...
    public(friend) fun set_extra_field<T0>(arg0: &mut VaultMetadata<T0>, arg1: 0x1::ascii::String, arg2: 0x1::ascii::String) {
        ...
        0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::events::emit_update_vault_metadata(arg0.vault_id, 0x1::string::from_ascii(arg1), 0x1::string::from_ascii(arg2));
    }

    public(friend) fun set_name<T0>(arg0: &mut VaultMetadata<T0>, arg1: 0x1::ascii::String) {
        arg0.name = arg1;
        0xbb235679284cf43fdf33953418c18e99c6297f774399f7774616b07e915d81b::events::emit_update_vault_metadata(arg0.vault_id, 0x1::string::utf8(b"name"), 0x1::string::from_ascii(arg1));
    }
