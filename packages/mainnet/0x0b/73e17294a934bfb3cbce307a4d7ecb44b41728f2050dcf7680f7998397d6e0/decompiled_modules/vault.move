module 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault {
    ...
    public(friend) fun cancel_deposit<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: address, arg4: address) : 0x2::coin::Coin<T0> {
        ...
        assert!(0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_receipt_info::status(v0) == 1, 5017);
        let v1 = 0x2::table::borrow_mut<u64, 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::deposit_request::DepositRequest>(&mut arg0.request_buffer.deposit_requests, arg2);
        assert!(arg3 == 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::deposit_request::receipt_id(v1), 5003);
        assert!(0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::deposit_request::request_time(v1) + arg0.locking_time_for_cancel_request <= 0x2::clock::timestamp_ms(arg1), 5018);
        let v2 = if (arg4 == 0x2::address::from_u256(0)) {
            0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::deposit_request::recipient(v1)
        } else {
            arg4
        };
        0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_receipt_info::update_after_cancel_deposit(v0, 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::deposit_request::amount(v1));
        let v3 = 0x2::table::remove<u64, 0x2::coin::Coin<T0>>(&mut arg0.request_buffer.deposit_coin_buffer, arg2);
        let v4 = DepositCancelled{
            request_id : arg2,
            receipt_id : 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::deposit_request::receipt_id(v1),
            recipient  : v2,
            vault_id   : 0x2::object::uid_to_address(&arg0.id),
            amount     : 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::deposit_request::amount(v1),
        };
    ...
    public(friend) fun cancel_withdraw<T0>(arg0: &mut Vault<T0>, arg1: &0x2::clock::Clock, arg2: u64, arg3: address, arg4: address) : u256 {
        ...
        let v0 = 0x2::table::borrow_mut<address, 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_receipt_info::VaultReceiptInfo>(&mut arg0.receipts, arg3);
        let v1 = 0x2::table::borrow_mut<u64, 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::WithdrawRequest>(&mut arg0.request_buffer.withdraw_requests, arg2);
        assert!(arg3 == 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::receipt_id(v1), 5003);
        assert!(0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::request_time(v1) + arg0.locking_time_for_cancel_request <= 0x2::clock::timestamp_ms(arg1), 5018);
        assert!(0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::recipient(v1) == arg4 || 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::recipient(v1) == 0x2::address::from_u256(0), 5023);
        0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_receipt_info::update_after_cancel_withdraw(v0, 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::shares(v1));
        let v2 = WithdrawCancelled{
            request_id : arg2,
            receipt_id : 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::receipt_id(v1),
            recipient  : arg4,
            vault_id   : 0x2::object::uid_to_address(&arg0.id),
            shares     : 0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::shares(v1),
        };
        0x2::event::emit<WithdrawCancelled>(v2);
        delete_withdraw_request<T0>(arg0, arg2);
        0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::withdraw_request::shares(v1)
    }
    ...
    public(friend) fun request_deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u256, arg4: address, arg5: address) : u64 {
        ...
        0x1cd46539840a60ea47f12b6b3b20c4afa2ebbba5eb6efdd077bb03cfef11ca8::vault_receipt_info::update_after_request_deposit(v0, v2);
        v1
    }
