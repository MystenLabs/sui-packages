module 0xb76b7aed57e2a4388d875d2da06c5f83a5e801a65aa4fbca502c0806861dc77::perf_fee_helper {
    ...
    fun current_state<T0>(arg0: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault::Vault<T0>, arg1: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_oracle::OracleConfig, arg2: &0x2::clock::Clock) : (u256, u256, u256, u256, u256) {
        0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault::validate_total_usd_value_updated<T0>(arg0, arg2);
        let v0 = 0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault::get_total_usd_value_without_update<T0>(arg0);
        let v1 = 0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_oracle::get_normalized_asset_price(arg1, arg2, 0x1::type_name::into_string(0x1::type_name::get<T0>()));
        let v2 = 0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_utils::div_with_oracle_price(v0, v1);
        let v3 = 0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault::total_shares<T0>(arg0);
        let v4 = if (v3 == 0) {
            0
        } else {
            0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_utils::div_d(v2, v3)
        };
        (v4, v2, v0, v1, v3)
    }
    ...
    public fun record_execution_no_fee<T0>(arg0: &mut VaultHelper<T0>, arg1: &HelperOperatorCap, arg2: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault::Vault<T0>, arg3: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_oracle::OracleConfig, arg4: &0x2::clock::Clock) {
        ...
        0x2::event::emit<ExecutionRecorded>(v6);
    }
    ...
    public fun verify_and_record_performance_fee<T0>(arg0: &mut VaultHelper<T0>, arg1: &HelperOperatorCap, arg2: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault::Vault<T0>, arg3: &0xcd86f77503a755c48fe6c87e1b8e9a137ec0c1bf37aac8878b6083262b27fefa::vault_oracle::OracleConfig, arg4: &0x2::balance::Balance<T0>, arg5: address, arg6: &0x2::clock::Clock) {
        ...
        let v11 = PerformanceFeeVerified{
            helper_id           : v0,
            vault_id            : arg0.vault_id,
        ...
        0x2::event::emit<PerformanceFeeVerified>(v11);
    }
