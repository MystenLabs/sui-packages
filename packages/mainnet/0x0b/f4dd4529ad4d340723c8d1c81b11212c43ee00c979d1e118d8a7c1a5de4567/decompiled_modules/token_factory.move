module 0xbf4dd4529ad4d340723c8d1c81b11212c43ee00c979d1e118d8a7c1a5de4567::token_factory {
    ...
    fun init(arg0: TOKEN_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_FACTORY>(arg0, 6, b"WAS", b"Wasabi", b"", 0x1::option::none<0x2::url::Url>(), arg1);
