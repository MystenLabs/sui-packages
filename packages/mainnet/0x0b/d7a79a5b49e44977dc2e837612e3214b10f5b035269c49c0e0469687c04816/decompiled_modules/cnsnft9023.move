module 0xbd7a79a5b49e44977dc2e837612e3214b10f5b035269c49c0e0469687c04816::cnsnft9023 {
    struct CNSNFT9023 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9023, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9023>(arg0, arg1);
