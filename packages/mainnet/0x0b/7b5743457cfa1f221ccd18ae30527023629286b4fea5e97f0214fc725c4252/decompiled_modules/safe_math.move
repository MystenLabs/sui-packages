module 0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::safe_math {
    ...
    public fun mul_div_round_up_u128(arg0: u128, arg1: u128, arg2: u128) : u128 {
        ...
        u256_to_u128(((arg0 as u256) * (arg1 as u256) - 1) / (arg2 as u256) + 1)
    }
    ...
    public fun mul_shift_round_up(arg0: u64, arg1: u128, arg2: u8) : u64 {
        ...
        u256_to_u64(((arg0 as u256) * (arg1 as u256) - 1) / (1 << arg2) + 1)
    }
    ...
    public fun shift_div_round_up(arg0: u64, arg1: u8, arg2: u128) : u64 {
        ...
        u128_to_u64((((arg0 as u128) << arg1) - 1) / arg2 + 1)
    }
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
