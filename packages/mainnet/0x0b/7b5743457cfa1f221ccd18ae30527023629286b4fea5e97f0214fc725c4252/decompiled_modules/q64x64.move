module 0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::q64x64 {
    ...
    fun from_parts(arg0: u64, arg1: u64) : u128 {
        (arg0 as u128) << 64 | (arg1 as u128)
    }

    fun get_fraction(arg0: u128) : u128 {
        arg0 & (1 << 64) - 1
    }
    ...
    public fun liquidity_from_amounts(arg0: u64, arg1: u64, arg2: u128) : u128 {
        0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::safe_math::u256_to_u128(((arg0 as u256) * (arg2 as u256) >> 64) + (arg1 as u256))
    }
    ...
    public fun log2(arg0: u128) : u128 {
        ...
        let v2 = if (v0 >= 9223372036854775808) {
            ...
            v1 = 0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::safe_math::div_u128(85070591730234615865843651857942052864, v0);
            340282366920938463463374607431768211455
        };
        let v3 = 0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::bit_math::most_significant_bit(v1 >> 63);
    ...
    public fun max_input_for_exact_output(arg0: u64, arg1: u128, arg2: bool) : u64 {
        ...
        if (arg2) {
            0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::safe_math::shift_div_round_up(arg0, scale_offset(), arg1)
        } else {
            0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::safe_math::mul_shift_round_up(arg0, arg1, scale_offset())
        }
    }
    ...
    public fun sqrt(arg0: u128) : u128 {
        ...
        let v0 = 0xb7b5743457cfa1f221ccd18ae30527023629286b4fea5e97f0214fc725c4252::bit_math::most_significant_bit(arg0);
        let v1 = if (v0 >= 64) {
            1 << (v0 + 64) / 2
        } else {
            1 << (v0 + 64) / 2
