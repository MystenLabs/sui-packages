module 0xb942a983b140803236424e695a57748d0e8817b3c3baa9ef71f6f228cb0ca4a::auction {
    ...
    struct Auction has store, key {
        ...
        deliver_balance: 0x2::balance::Balance<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>,
    ...
    entry fun new(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: 0x2::coin::Coin<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 >= arg2, 1);
        assert!(arg4 > 0 && arg4 == 0x2::coin::value<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>(&arg10), 2);
        ...
        let v1 = Auction{
            ...
            deliver_balance : 0x2::coin::into_balance<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>(arg10),
    ...
    entry fun claim(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>>(0x2::coin::from_balance<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>(0x2::balance::split<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>(&mut arg1.deliver_balance, v2.total_bid_size), arg3), v1);
        let v6 = ClaimEvent{
            price   : v3,
    ...
    entry fun withdraw(arg0: &0xb44f547f5f9e35513a35139a8f2381923ea3f861e6d8debcd5aaf077f2d3a39d::version::Version, arg1: &mut Auction, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg1.max_size > arg1.total_bid_size) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>>(0x2::coin::from_balance<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>(0x2::balance::split<0xf2a72651127568ee87caf3d7a508c53c54051bcbd920e5a0979d76d9e49dc85e::typus::TYPUS>(&mut arg1.deliver_balance, arg1.max_size - arg1.total_bid_size), arg4), arg2);
        };
    }
