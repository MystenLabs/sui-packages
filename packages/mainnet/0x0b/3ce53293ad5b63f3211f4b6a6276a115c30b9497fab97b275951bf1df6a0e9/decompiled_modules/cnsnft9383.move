module 0xb3ce53293ad5b63f3211f4b6a6276a115c30b9497fab97b275951bf1df6a0e9::cnsnft9383 {
    struct CNSNFT9383 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9383, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9383>(arg0, arg1);
