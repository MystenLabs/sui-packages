module 0xb7c6ed5a78a91feae32c8985985487cf2b8f658117bc3bbf14190c9b7c04e3d::reward6685 {
    struct REWARD6685 has drop {
        dummy_field: bool,
    }

    struct TICKET_6685 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6685(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6685>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6685>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6685, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6685>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6685>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6685>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6685>>(v5, 0x2::tx_context::sender(arg1));
    }
