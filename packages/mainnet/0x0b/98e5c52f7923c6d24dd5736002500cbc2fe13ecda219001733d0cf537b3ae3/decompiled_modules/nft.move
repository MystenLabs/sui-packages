module 0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::nft {
    ...
    public entry fun burn(arg0: ArtfiNFT, arg1: &mut NFTInfo, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_burn_nft<ArtfiNFT>(v0);
    }
    ...
    public entry fun mint_nft(arg0: &MinterCap, arg1: &mut NFTInfo, arg2: vector<u8>, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_mint_nft(v0, 0x2::tx_context::sender(arg5), arg1.name);
    }
    ...
    public fun mint_nft_batch(arg0: &MinterCap, arg1: &mut NFTInfo, arg2: &vector<vector<u8>>, arg3: &vector<address>, arg4: &vector<u64>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_batch_mint_nft(v1, v0, 0x2::tx_context::sender(arg5), arg1.name);
    }
    ...
    public entry fun transfer_minter_cap(arg0: &AdminCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_transfer_object<MinterCap>(0x2::object::id<MinterCap>(&v0), arg1);
    }
    ...
    public entry fun transfer_nft(arg0: ArtfiNFT, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_transfer_object<ArtfiNFT>(0x2::object::id<ArtfiNFT>(&arg0), arg1);
    }
    ...
    public entry fun update_nft_royalty(arg0: &MinterCap, arg1: &mut NFTInfo, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::update_attribute<0x2::object::ID, Royalty>(&mut arg1.royalty_nft, arg2, v0);
    }
