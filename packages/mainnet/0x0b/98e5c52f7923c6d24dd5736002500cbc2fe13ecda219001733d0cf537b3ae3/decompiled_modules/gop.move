module 0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::gop {
    ...
    public entry fun update_attribute(arg0: &AdminCap, arg1: &mut NFTInfo, arg2: 0x2::object::ID, arg3: bool, arg4: bool, arg5: bool) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::update_attribute<0x2::object::ID, Attributes>(&mut arg1.user_detials, arg2, v0);
    }
    ...
    public entry fun burn(arg0: GOPNFT, arg1: &mut NFTInfo, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_burn_nft<GOPNFT>(v0);
    }
    ...
    fun mint_nft(arg0: &mut NFTInfo, arg1: address, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_mint_nft(v0, 0x2::tx_context::sender(arg3), arg0.name);
    }
    ...
    public entry fun transfer_nft(arg0: GOPNFT, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_transfer_object<GOPNFT>(0x2::object::id<GOPNFT>(&arg0), arg1);
    }
