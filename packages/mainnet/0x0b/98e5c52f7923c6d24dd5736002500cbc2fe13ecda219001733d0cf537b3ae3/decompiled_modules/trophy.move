module 0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::trophy {
    ...
    public entry fun burn(arg0: TrophyNFT, arg1: &mut NFTInfo, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_burn_nft<TrophyNFT>(v0);
    }
    ...
    public entry fun mint_nft(arg0: &mut NFTInfo, arg1: &0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::nft::ArtfiNFT, arg2: vector<u8>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::nft::fraction_id(arg1);
        assert!(check_fraction_exist(arg0, v0) == false, 1);
        let v1 = mint_func(arg0, arg2, v0, arg3);
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_mint_nft(0x2::object::id<TrophyNFT>(&v1), 0x2::tx_context::sender(arg3), arg0.name);
    ...
    public entry fun transfer_nft(arg0: TrophyNFT, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_transfer_object<TrophyNFT>(0x2::object::id<TrophyNFT>(&arg0), arg1);
    }
    ...
    public entry fun update_attribute(arg0: &AdminCap, arg1: &mut NFTInfo, arg2: 0x2::object::ID, arg3: 0x1::string::String) {
        ...
        0xb98e5c52f7923c6d24dd5736002500cbc2fe13ecda219001733d0cf537b3ae3::base_nft::emit_update_attributes<0x2::object::ID, Attributes>(arg2, *v0);
    }
