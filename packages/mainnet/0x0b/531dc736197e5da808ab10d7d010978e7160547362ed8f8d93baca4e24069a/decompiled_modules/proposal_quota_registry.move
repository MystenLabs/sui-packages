module 0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::proposal_quota_registry {
    ...
    struct QuotaInfo has copy, drop, store {
        ...
        sponsor_refunded_proposals: vector<0x2::object::ID>,
    }
        ...
        while (v2 < 0x1::vector::length<address>(&arg2)) {
            ...
            if (v0) {
                ...
                let v6 = QuotaInfo{
                    ...
                    sponsor_refunded_proposals       : 0x1::vector::empty<0x2::object::ID>(),
                };
                ...
                if (v7) {
                    ...
                    if (v10.period_ms == arg3) {
                        ...
                        let (v17, v18) = if (v12 > 0) {
                            (0x1::vector::empty<0x2::object::ID>(), 0x1::vector::empty<0x2::object::ID>())
                        } else {
                            (v10.sponsor_consumed_proposals, v10.sponsor_refunded_proposals)
                        };
                        let v19 = QuotaInfo{
                            period_ms                        : arg3,
                            feeless_proposal_amount          : arg4,
                            ...
                            sponsor_refunded_proposals       : v18,
                        };
                        v9.info = v19;
                    } else {
                        v9.info = v6;
                    ...
                    assert!(0x1::vector::length<QuotaEntry>(&arg0.quotas) < 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_quota_entries(), 1);
                    let v20 = QuotaEntry{
                        user : v3,
                        info : v6,
                    };
                    0x1::vector::push_back<QuotaEntry>(&mut arg0.quotas, v20);
                };
            };
            v2 = v2 + 1;
        };
        if (v0) {
            let v21 = QuotasRemoved{
                dao_id    : arg1,
                users     : arg2,
                timestamp : v1,
            };
            0x2::event::emit<QuotasRemoved>(v21);
        } else {
            let v22 = QuotasSet{
                dao_id                  : arg1,
                users                   : arg2,
    ...
    public fun sponsor_refunded_proposals(arg0: &QuotaInfo) : &vector<0x2::object::ID> {
        &arg0.sponsor_refunded_proposals
    }
    ...
    public fun use_sponsor_quota(arg0: &mut ProposalQuotaRegistry, arg1: 0x2::object::ID, arg2: address, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock) {
        ...
        if (v4 > 0) {
            ...
            v2.sponsor_refunded_proposals = 0x1::vector::empty<0x2::object::ID>();
        };
