module 0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::dao_config {
    ...
    public fun default_governance_config() : GovernanceConfig {
        GovernanceConfig{
            max_outcomes              : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_max_outcomes(),
            max_actions_per_outcome   : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_max_actions_per_outcome(),
            proposal_creation_fee     : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_proposal_creation_fee(),
            proposal_fee_per_outcome  : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_proposal_fee_per_outcome(),
            fee_in_asset_token        : false,
            proposal_intent_expiry_ms : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_proposal_intent_expiry_ms(),
        }
    }
    ...
    public fun default_trading_params() : TradingParams {
        TradingParams{
            ...
            review_period_ms                    : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_day_ms(),
            trading_period_ms                   : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_week_ms(),
            conditional_amm_fee_bps             : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_conditional_amm_fee_bps(),
            conditional_liquidity_ratio_percent : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_conditional_liquidity_percent(),
        }
    }
    ...
    public fun default_twap_config() : TwapConfig {
        TwapConfig{
            start_delay         : 0,
            step_max            : 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_twap_max_movement_ppm(),
            initial_observation : 0x1::option::none<u128>(),
            threshold           : (0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::default_twap_threshold() as u128),
    ...
    public fun derive_conditional_metadata_from_currency<T0>(arg0: &0x2::coin_registry::Currency<T0>) : (u8, 0x1::ascii::String, 0x2::url::Url) {
        ...
        assert!(!0x1::string::is_empty(&v0), 20);
        ...
        let v4 = 0x1::ascii::try_string(0x1::string::into_bytes(v0));
        let v5 = if (0x1::option::is_some<0x1::ascii::String>(&v4)) {
            0x1::option::destroy_some<0x1::ascii::String>(v4)
        } else {
            0x1::option::destroy_none<0x1::ascii::String>(v4);
            0x1::ascii::string(b"https://govex.ai/default-conditional-icon.png")
        };
        (0x2::coin_registry::decimals<T0>(arg0), v3, 0x2::url::new_unsafe(v5))
    }
    ...
    public fun new_governance_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: bool, arg5: u64) : GovernanceConfig {
        assert!(arg0 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_outcomes(), 3);
        assert!(arg0 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::protocol_max_outcomes(), 10);
        assert!(arg1 > 0 && arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::protocol_max_actions_per_outcome(), 11);
        assert!(arg2 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_proposal_creation_fee(), 19);
        assert!(arg3 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_proposal_fee_per_outcome(), 19);
        assert!(arg5 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_proposal_intent_expiry_ms(), 8);
    ...
    public fun new_trading_params(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : TradingParams {
        assert!(arg0 > 0, 0);
        assert!(arg1 > 0, 0);
        assert!(arg0 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::protocol_min_liquidity_amount(), 16);
        assert!(arg1 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::protocol_min_liquidity_amount(), 16);
        assert!(arg2 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_review_period_ms(), 1);
        assert!(arg2 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_trading_duration_ms(), 1);
        assert!(arg3 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_trading_period_ms(), 1);
        assert!(arg3 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_trading_duration_ms(), 1);
        assert!(arg4 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_amm_fee_bps(), 2);
        assert!(arg5 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_conditional_liquidity_percent() && arg5 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_conditional_liquidity_percent(), 2);
        TradingParams{
    ...
    public fun new_twap_config(arg0: u64, arg1: u64, arg2: 0x1::option::Option<u128>, arg3: u128) : TwapConfig {
        assert!(arg0 < 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_week_ms(), 7);
        assert!(arg0 % 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::twap_price_cap_window() == 0, 7);
        assert!(arg1 > 0, 7);
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::ppm_denominator(), 7);
        if (0x1::option::is_some<u128>(&arg2)) {
            assert!(*0x1::option::borrow<u128>(&arg2) > 0, 7);
        };
        assert!(arg3 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::twap_threshold_base(), 7);
        TwapConfig{
            start_delay         : arg0,
            step_max            : arg1,
    ...
    public fun new_twap_config_with_sponsored_threshold(arg0: u64, arg1: u64, arg2: 0x1::option::Option<u128>, arg3: u128, arg4: u128) : TwapConfig {
        ...
        assert!(arg3 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::twap_threshold_base(), 7);
        assert!(arg4 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_sponsored_threshold(), 7);
        TwapConfig{
            start_delay         : arg0,
            step_max            : arg1,
            initial_observation : arg2,
    ...
    public(friend) fun set_conditional_amm_fee_bps(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_amm_fee_bps(), 2);
    ...
    public(friend) fun set_conditional_liquidity_ratio_percent(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_conditional_liquidity_percent() && arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_conditional_liquidity_percent(), 2);
    ...
    public(friend) fun set_max_outcomes(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_outcomes(), 3);
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::protocol_max_outcomes(), 10);
    ...
    public(friend) fun set_proposal_creation_fee(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_proposal_creation_fee(), 19);
        arg0.proposal_creation_fee = arg1;
    }

    public(friend) fun set_proposal_fee_per_outcome(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_proposal_fee_per_outcome(), 19);
        arg0.proposal_fee_per_outcome = arg1;
    }

    public(friend) fun set_proposal_intent_expiry_ms(arg0: &mut GovernanceConfig, arg1: u64) {
        assert!(arg1 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_proposal_intent_expiry_ms(), 8);
    ...
    public(friend) fun set_review_period_ms(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_review_period_ms(), 1);
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_trading_duration_ms(), 1);
        arg0.review_period_ms = arg1;
    }

    public(friend) fun set_sponsored_threshold(arg0: &mut TwapConfig, arg1: u128) {
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_sponsored_threshold(), 7);
    ...
    public(friend) fun set_start_delay(arg0: &mut TwapConfig, arg1: u64) {
        assert!(arg1 < 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_week_ms(), 7);
        assert!(arg1 % 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::twap_price_cap_window() == 0, 7);
        arg0.start_delay = arg1;
    }

    public(friend) fun set_step_max(arg0: &mut TwapConfig, arg1: u64) {
        assert!(arg1 > 0, 7);
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::ppm_denominator(), 7);
        arg0.step_max = arg1;
    }
    ...
    public(friend) fun set_threshold(arg0: &mut TwapConfig, arg1: u128) {
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::twap_threshold_base(), 7);
        arg0.threshold = arg1;
    }

    public(friend) fun set_trading_period_ms(arg0: &mut TradingParams, arg1: u64) {
        assert!(arg1 >= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::min_trading_period_ms(), 1);
        assert!(arg1 <= 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::max_trading_duration_ms(), 1);
    ...
    public fun step_max(arg0: &TwapConfig) : u64 {
        arg0.step_max
    }
