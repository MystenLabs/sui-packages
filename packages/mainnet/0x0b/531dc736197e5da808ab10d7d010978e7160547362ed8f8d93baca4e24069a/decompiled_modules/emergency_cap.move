module 0xb531dc736197e5da808ab10d7d010978e7160547362ed8f8d93baca4e24069a::emergency_cap {
    ...
    public fun assert_ready(arg0: &EmergencyCap, arg1: &0x2::clock::Clock) {
        ...
        let v2 = if (arg0.created_at > 0 && v1 - arg0.created_at < 60 * 0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_day_ms()) {
            0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_day_ms()
        } else {
            0xcf1218ee7d7e2610b8bc7da9c1d513c230b94e470e57cf4e9260b6da64318f12::constants::one_week_ms()
        };
