module 0xb6c2cab16b4ab2a5e633eba596fe404d1521eeab4892a9d414071d48256e974::reward3682 {
    struct REWARD3682 has drop {
        dummy_field: bool,
    }

    struct TICKET_3682 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3682(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3682>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3682>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3682, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3682>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3682>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3682>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3682>>(v5, 0x2::tx_context::sender(arg1));
    }
