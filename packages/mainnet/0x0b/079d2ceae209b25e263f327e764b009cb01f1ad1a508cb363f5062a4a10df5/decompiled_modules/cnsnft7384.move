module 0xb079d2ceae209b25e263f327e764b009cb01f1ad1a508cb363f5062a4a10df5::cnsnft7384 {
    struct CNSNFT7384 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7384, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7384>(arg0, arg1);
