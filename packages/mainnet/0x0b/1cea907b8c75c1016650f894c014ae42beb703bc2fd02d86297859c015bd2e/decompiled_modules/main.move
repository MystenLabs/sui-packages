module 0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::main {
    ...
    public fun finalize_market<T0, T1>(arg0: &MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::vault::LpVault<T0, T1> {
        ...
        let v2 = @0x0;
        let v3 = 0;
        let v4 = 0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, arg0.admin_key_id, arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v12) {
                ...
                let v24 = 0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::vault::id<T0, T1>(&v4);
                let v25 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::vault::id_to_address(&v24),
                ...
                0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::vault::add_position<T0, T1>(&mut v4, v32);
                let v35 = 0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::vault::id<T0, T1>(&v4);
                let v36 = LpVaultCreated<T0, T1>{
                    market_address   : 0x2::object::id_address<Market<T0, T1>>(arg1),
                    lp_vault_address : 0xb1cea907b8c75c1016650f894c014ae42beb703bc2fd02d86297859c015bd2e::vault::id_to_address(&v35),
                    curator          : arg1.curator,
                    pool_address     : v34,
