module 0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::trade {
    ...
    public fun cancel_order_by_keeper<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: &mut LimitOrder<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_package_version(arg0);
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_keeper(arg0, 0x2::tx_context::sender(arg3));
        let v0 = 0;
    ...
    public fun cancel_order_by_owner<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: &mut LimitOrder<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_package_version(arg0);
        assert!(arg1.owner == 0x2::tx_context::sender(arg3), 13);
        cancel_order<T0, T1>(arg1, 2, arg2, arg3);
    }

    public fun claim_target_coin<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: &mut LimitOrder<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_package_version(arg0);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(arg1.owner == v0, 13);
        assert!(arg1.canceled_ts == 18446744073709551615, 8);
        let v1 = 0x2::balance::value<T1>(&arg1.target_balance);
        assert!(v1 > 0, 20);
        ...
        let v2 = ClaimTargetCoinEvent{
            order_id       : 0x2::object::id<LimitOrder<T0, T1>>(arg1),
            claimed_amount : v1,
        };
        0x2::event::emit<ClaimTargetCoinEvent>(v2);
    }

    fun delete_limit_order<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: LimitOrder<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert!(arg1.canceled_ts != 18446744073709551615, 8);
        assert!(0x2::clock::timestamp_ms(arg2) > arg1.canceled_ts + 0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::get_config_deletion_grace_period(arg0), 12);
        destroy_limit_order<T0, T1>(arg1);
    }

    public fun delete_order<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: LimitOrder<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_package_version(arg0);
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_keeper(arg0, 0x2::tx_context::sender(arg3));
    ...
    public fun flash_loan<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: &mut LimitOrder<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoanReceipt<T1>) {
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_package_version(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        if (0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::get_config_require_flash_loan_auth(arg0)) {
            0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_keeper(arg0, v0);
        };
        assert!(arg1.canceled_ts == 18446744073709551615, 8);
        assert!(arg2 > 0, 5);
        assert!(0x2::clock::timestamp_ms(arg3) < arg1.expire_ts, 6);
        assert!(0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::check_token_and_min_trade_amount<T0>(arg0, arg2), 14);
    ...
    fun init(arg0: TRADE, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::package::Publisher>(0x2::package::claim<TRADE>(arg0, arg1), 0x2::tx_context::sender(arg1));
    }
    ...
    public fun place_limit_order<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: 0x2::coin::Coin<T0>, arg2: u128, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_package_version(arg0);
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_pool_token_types<T0, T1>(arg0);
        assert!(arg2 > 0, 15);
    ...
    public fun repay_flash_loan<T0, T1>(arg0: &0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::GlobalConfig, arg1: &mut 0x2::coin::Coin<T1>, arg2: &mut LimitOrder<T0, T1>, arg3: FlashLoanReceipt<T1>, arg4: &mut 0x2::tx_context::TxContext) {
        0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_package_version(arg0);
        let v0 = 0x2::tx_context::sender(arg4);
        if (0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::get_config_require_flash_loan_auth(arg0)) {
            0xbe0847f8a87305cc7da5b4446e7a05b8357d85b99d2a61d7e5fcb8f5e52245e::config::checked_keeper(arg0, v0);
        ...
        if (0x2::balance::value<T0>(&arg2.pay_balance) == 0) {
            arg2.claimed_amount = arg2.claimed_amount + 0x2::balance::value<T1>(&arg2.target_balance);
