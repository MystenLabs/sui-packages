module 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::core {
    ...
    struct StakeTicket<phantom T0, phantom T1: drop> {
        ...
        single_game_stake_usd_values: vector<0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float>,
        unsafe_oracle_usd_coin_price: 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float,
        adjusted_oracle_usd_coin_price: 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float,
    ...
    public fun admin_set_manager<T0: drop>(arg0: &mut ManagerRegistry, arg1: &AdminCap, arg2: address) {
        ...
        assert!(!0x1::vector::contains<address>(v1, &arg2), 13837593468967321617);
        0x1::vector::push_back<address>(v1, arg2);
    }

    public fun assert_is_manager<T0: drop>(arg0: &ManagerRegistry, arg1: address) {
        assert!(is_manager<T0>(arg0, arg1), 13835341531713634305);
    }
    ...
    public(friend) fun create_stake_ticket<T0, T1: drop>(arg0: u64, arg1: address, arg2: u64) : StakeTicket<T0, T1> {
        assert!(arg2 > 0, 13837310452097220623);
        let v0 = arg0 / arg2;
        let v1 = 0x1::vector::empty<u64>();
        let v2 = 0;
        while (v2 < arg2) {
            let v3 = if (v2 < arg0 - v0 * arg2) {
                v0 + 1
            } else {
                v0
            };
        ...
        StakeTicket<T0, T1>{
            ...
            single_game_stake_amounts      : v1,
            single_game_stake_usd_values   : 0x1::vector::empty<0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float>(),
            unsafe_oracle_usd_coin_price   : 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::zero(),
            adjusted_oracle_usd_coin_price : 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::zero(),
    ...
    public(friend) fun destroy_stake_ticket<T0, T1: drop>(arg0: StakeTicket<T0, T1>, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        let StakeTicket {
            ...
            player                         : v1,
            number_of_games                : v2,
            single_game_stake_amounts      : v3,
            single_game_stake_usd_values   : v4,
            unsafe_oracle_usd_coin_price   : v5,
            adjusted_oracle_usd_coin_price : v6,
            outcome_amounts                : v7,
            game_details                   : v8,
            metadata                       : v9,
        ...
        let v16 = v4;
        let v17 = v3;
        assert!(v2 > 0, 13836747798496280587);
        assert!(0x1::vector::length<u64>(&v15) == 0 || 0x1::vector::length<u64>(&v15) == v2, 13836747802791247883);
        assert!(0x1::vector::length<0x2::vec_map::VecMap<0x1::string::String, vector<u8>>>(&v14) == v2, 13836747807086215179);
        assert!(0x1::vector::length<u64>(&v17) == v2, 13836747811381182475);
        assert!(0x1::vector::length<0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float>(&v16) == v2, 13836747815676149771);
        let v18 = 0x1::vector::length<u64>(&v15) == 0;
        if (!v18) {
            if (0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::utils::sum(&v15) > v0) {
                randomize_create_and_transfer_gas_object_high_cost(arg1, arg2);
                burn_happy_resources(arg1, arg2);
                let v19 = DummyEvent{dummy_field: false};
                0x2::event::emit<DummyEvent>(v19);
                0x2::event::emit<DummyEvent>(v19);
            } else {
        ...
        while (v20 < v2) {
            let v21 = if (v18) {
                ...
                *0x1::vector::borrow<u64>(&v15, v20)
            };
            let v22 = BetResultEvent<T1>{
                player                         : v1,
                coin_type                      : 0x1::type_name::with_defining_ids<T0>(),
                stake_amount                   : *0x1::vector::borrow<u64>(&v17, v20),
                unsafe_oracle_usd_coin_price   : v5,
                adjusted_oracle_usd_coin_price : v6,
                outcome_amount                 : v21,
                game_details                   : *0x1::vector::borrow<0x2::vec_map::VecMap<0x1::string::String, vector<u8>>>(&v14, v20),
                metadata                       : v9,
            };
            0x2::event::emit<BetResultEvent<T1>>(v22);
            v20 = v20 + 1;
        };
    }
    ...
    public fun get_adjusted_oracle_usd_coin_price<T0, T1: drop>(arg0: &StakeTicket<T0, T1>) : 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float {
        arg0.adjusted_oracle_usd_coin_price
    }

    fun get_gas_obj_address() : address {
        @0xd970d02546ea6b3da208a01d931e21d084dd0b7800ccd8a4dd83338821789596
    }
    ...
    public fun get_total_stake_usd_value_if_exists<T0, T1: drop>(arg0: &StakeTicket<T0, T1>) : 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float {
        let v0 = 0x1::vector::length<0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float>(&arg0.single_game_stake_usd_values);
        assert!(v0 > 0, 13836466847505448969);
        let v1 = 0;
        let v2 = 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::zero();
        while (v1 < v0) {
            v2 = 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::add(v2, *0x1::vector::borrow<0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float>(&arg0.single_game_stake_usd_values, v1));
            v1 = v1 + 1;
        };
        v2
    }

    public fun get_unsafe_oracle_usd_coin_price<T0, T1: drop>(arg0: &StakeTicket<T0, T1>) : 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float {
    ...
    public fun randomize_gas_cost(arg0: u64, arg1: u64, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = vector[];
        let v2 = 0;
        assert!(arg1 > arg0, 13837030776711675917);
    ...
    fun remove_manager_internal<T0: drop>(arg0: &mut ManagerRegistry, arg1: address) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        if (!0x2::vec_map::contains<0x1::type_name::TypeName, vector<address>>(&arg0.manager_map, &v0)) {
            abort 13836185982413963271
        };
        let v1 = 0x2::vec_map::get_mut<0x1::type_name::TypeName, vector<address>>(&mut arg0.manager_map, &v0);
        let (v2, v3) = 0x1::vector::index_of<address>(v1, &arg1);
        assert!(v2, 13836186012478734343);
    ...
    public fun update_stake_ticket_oracle_prices<T0, T1: drop>(arg0: &mut StakeTicket<T0, T1>, arg1: 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float, arg2: 0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float) {
        arg0.unsafe_oracle_usd_coin_price = arg1;
        arg0.adjusted_oracle_usd_coin_price = arg2;
    }

    public fun update_stake_ticket_usd_values<T0, T1: drop>(arg0: &mut StakeTicket<T0, T1>, arg1: vector<0xbde37abf904292a57b279a9299ff508b7b55620db1f193771498c6c3d0ea2a6::float::Float>) {
