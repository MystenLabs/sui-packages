module 0xafa3e6b3070c5c5683ea78ca5529758dbf46ddeaca8d4045c6185c48577361ab::accessControlLib {
    ...
    public fun checkHasRole(arg0: &UserRolesCollection, arg1: 0x2::object::ID, arg2: u8, arg3: 0x2::object::ID) {
        checkUserNotBanned(arg0, arg1, arg3);
        checkUserVerified(arg0, arg1);
    ...
    fun checkUserNotBanned(arg0: &UserRolesCollection, arg1: 0x2::object::ID, arg2: 0x2::object::ID) {
        assert!(!hasRole(arg0, getCommunityRole(x"06", arg2), arg1) || !hasRole(arg0, x"06", arg1), 312);
    }

    fun checkUserVerified(arg0: &UserRolesCollection, arg1: 0x2::object::ID) {
        assert!(hasRole(arg0, x"09", arg1), 313);
    }
    ...
    public(friend) fun setCommunityPermission(arg0: &mut UserRolesCollection, arg1: 0x2::object::ID, arg2: 0x2::object::ID) {
        ...
        setRoleAdmin(arg0, getCommunityRole(x"06", arg1), v1);
    ...
    public(friend) fun setRoleAdminPublic(arg0: &mut UserRolesCollection, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: vector<u8>) {
        assert!(hasRole(arg0, x"02", arg1), 302);
        setRoleAdmin(arg0, arg2, arg3);
    }
