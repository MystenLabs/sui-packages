module 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::go_live {
    struct AddLiquidityHook has drop {
        dummy_field: bool,
    }

    public fun go_live<T0, T1>(arg0: &0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::admin::Admin, arg1: 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::seed_pool::SeedPool<0x2::sui::SUI, T0>, arg2: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: 0x2::coin::TreasuryCap<T1>, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg8);
        go_live_<0x2::sui::SUI, T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::vesting::new_config(v0, v0 + arg6, v0 + arg7), arg8, arg9);
    }

    public fun go_live_<T0, T1, T2>(arg0: &0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::admin::Admin, arg1: 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::seed_pool::SeedPool<T0, T1>, arg2: &0x2::coin::CoinMetadata<T0>, arg3: &0x2::coin::CoinMetadata<T1>, arg4: &0x2::coin::CoinMetadata<T2>, arg5: 0x2::coin::TreasuryCap<T2>, arg6: 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::vesting::VestingConfig, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, v5, v6, v7, _, v9, v10) = 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::seed_pool::destroy_pool<T0, T1>(arg1);
        let v11 = v9;
        let v12 = v4;
        let v13 = v1;
        let v14 = v0;
        ...
        assert!(v15 == 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::utils::mist(0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::seed_pool::gamma_s(&v11)), 2);
        ...
        let v29 = v26;
        let v30 = 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::staking_pool::new<T0, T1, T2>(0x2::object::id<0x9641311c4442a1464941ed2898b8466820a6313082f271906fb1d0cb3be18c65::interest_pool::InterestPool<0x9641311c4442a1464941ed2898b8466820a6313082f271906fb1d0cb3be18c65::curves::Volatile>>(&v29), (0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::seed_pool::gamma_m(&v11) as u64), 0x2::coin::into_balance<T2>(v28), arg6, v27, v6, v7, v5, arg8);
        ...
        let v32 = 0x2::object::id<0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::staking_pool::StakingPool<T0, T1, T2>>(&v30);
        0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::events::go_live<T0, T1, T2>(0x2::object::id_to_address(&v31), 0x2::object::id_to_address(&v32));
        ...
        0x2::transfer::public_share_object<0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::staking_pool::StakingPool<T0, T1, T2>>(v30);
    ...
    public fun go_live_default<T0, T1>(arg0: &0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::admin::Admin, arg1: 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::seed_pool::SeedPool<0x2::sui::SUI, T0>, arg2: &0x2::coin::CoinMetadata<0x2::sui::SUI>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: 0x2::coin::TreasuryCap<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        go_live_<0x2::sui::SUI, T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, 0xb531bba8d504febba31a7dd448bd51b5588faf72bfd6594b0046cd5584c65e3::vesting::default_config(arg6), arg6, arg7);
    }
