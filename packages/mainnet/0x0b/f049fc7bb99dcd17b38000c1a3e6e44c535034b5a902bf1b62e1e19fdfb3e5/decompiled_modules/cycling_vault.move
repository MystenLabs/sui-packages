module 0xbf049fc7bb99dcd17b38000c1a3e6e44c535034b5a902bf1b62e1e19fdfb3e5::cycling_vault {
    ...
    public fun create_vault<T0, T1>(arg0: &mut VaultConfig, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: 0x2::object::ID, arg4: u64, arg5: u64, arg6: u64, arg7: bool, arg8: bool, arg9: bool, arg10: u64, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) : Vault<T0, T1> {
        ...
        let v1 = if (arg5 > 0) {
            0x2::clock::timestamp_ms(arg11) + arg5
        } else {
            0
        };
        let v2 = Vault<T0, T1>{
    ...
    public fun record_rebalance<T0, T1>(arg0: &VaultConfig, arg1: &mut Vault<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == arg0.executor || v0 == arg0.admin, 1);
        arg1.rebalance_pending = false;
        arg1.out_of_range_since = 0;
    ...
    public fun withdraw<T0, T1>(arg0: &mut VaultConfig, arg1: Vault<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v24 = v3;
        let v25 = v4;
        0x2::balance::join<T0>(&mut v24, v5);
        0x2::balance::join<T1>(&mut v25, v6);
        let v26 = VaultWithdrawn{
            vault_id : 0x2::object::uid_to_address(&v23),
            owner    : v1,
            total_x  : 0x2::balance::value<T0>(&v24),
            total_y  : 0x2::balance::value<T1>(&v25),
        };
        0x2::event::emit<VaultWithdrawn>(v26);
        0x2::object::delete(v23);
        (0x2::coin::from_balance<T0>(v24, arg2), 0x2::coin::from_balance<T1>(v25, arg2))
    }
