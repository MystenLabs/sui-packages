module 0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::gusd_usdc_vault {
    ...
    public fun mint_gusd(arg0: &0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::version::Version, arg1: &mut USDCVault, arg2: &mut 0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::market::Market, arg3: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::version::assert_current_version(arg0);
        assert!(!0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::market::is_paused(arg2), 9);
        ...
        let v1 = v0 * 1000;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xfed4826846f281385e9b6eac8c116b6302105dbd30eebc5509b634e64b1bb818::coin_gusd::COIN_GUSD>>(0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::market::mint_gusd(arg2, v1, 0x2::clock::timestamp_ms(arg4) / 1000, arg5), 0x2::tx_context::sender(arg5));
        let v2 = MintEvent{
    ...
    public fun redeem_gusd(arg0: &0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::version::Version, arg1: &mut USDCVault, arg2: &mut 0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::market::Market, arg3: 0x2::coin::Coin<0xfed4826846f281385e9b6eac8c116b6302105dbd30eebc5509b634e64b1bb818::coin_gusd::COIN_GUSD>, arg4: &mut 0x2::tx_context::TxContext) {
        0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::version::assert_current_version(arg0);
        assert!(!0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::market::is_paused(arg2), 9);
        let v0 = 0x2::coin::value<0xfed4826846f281385e9b6eac8c116b6302105dbd30eebc5509b634e64b1bb818::coin_gusd::COIN_GUSD>(&arg3);
        assert!(v0 > 0, 2);
        let v1 = v0 / 1000;
        assert!(v1 > 0, 2);
        ...
        assert!(v3 < v1, 6);
        let v4 = v1 - v3;
        0xb8adce96346c5c9c7c3a3ac02ca35712d36a58952d4a727a225c6ef5cc159f2::market::burn_gusd(arg2, arg3, arg4);
