module 0xb884dbc39d915f32a82cc62dabad75ca3efd3c568c329eba270b03c6f58cbd8::guardian_queue_init_action {
    ...
    fun actuate(arg0: vector<u8>, arg1: address, arg2: 0x1::string::String, arg3: u64, arg4: address, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = GuardianQueueCreated{
            queue_id  : 0xb884dbc39d915f32a82cc62dabad75ca3efd3c568c329eba270b03c6f58cbd8::queue::new(arg0, arg1, arg2, arg3, arg4, arg5, arg6, 0x2::object::id_from_address(@0x0), true, arg7),
            queue_key : arg0,
        };
