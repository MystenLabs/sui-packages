module 0xba158475e21b2b39573fc3332396c3b2b01ccb63d65ae9bc483502d7875b292::cnsnft9304 {
    struct CNSNFT9304 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9304, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2418"));
        let v4 = 0x2::package::claim<CNSNFT9304>(arg0, arg1);
