module 0xbe82bae533288a5cddd63e6eb714286146a2327aa58debe6e3103a7d2216764::agent {
    ...
    fun init(arg0: AGENT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x2::package::claim<AGENT>(arg0, arg1);
        let v6 = 0x2::display::new_with_fields<AGENT_NFT>(&v5, v1, v3, arg1);
