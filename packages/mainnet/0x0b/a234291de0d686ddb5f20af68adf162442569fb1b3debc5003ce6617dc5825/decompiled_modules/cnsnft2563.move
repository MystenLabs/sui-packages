module 0xba234291de0d686ddb5f20af68adf162442569fb1b3debc5003ce6617dc5825::cnsnft2563 {
    struct CNSNFT2563 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2563, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4634"));
        let v4 = 0x2::package::claim<CNSNFT2563>(arg0, arg1);
