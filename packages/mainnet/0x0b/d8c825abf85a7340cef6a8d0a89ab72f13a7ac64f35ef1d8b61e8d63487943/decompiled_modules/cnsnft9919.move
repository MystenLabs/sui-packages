module 0xbd8c825abf85a7340cef6a8d0a89ab72f13a7ac64f35ef1d8b61e8d63487943::cnsnft9919 {
    struct CNSNFT9919 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9919, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9919>(arg0, arg1);
