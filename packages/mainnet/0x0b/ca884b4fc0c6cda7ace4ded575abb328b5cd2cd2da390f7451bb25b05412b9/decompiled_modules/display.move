module 0xbca884b4fc0c6cda7ace4ded575abb328b5cd2cd2da390f7451bb25b05412b9::display {
    ...
    public fun batch_mint(arg0: &Minter, arg1: vector<0x1::string::String>, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>, arg4: vector<address>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < v0) {
            let v2 = NFT{
                ...
                image_url   : *0x1::vector::borrow<0x1::string::String>(&arg2, v1),
    ...
    fun init(arg0: DISPLAY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://coleccionsui.xyz"));
