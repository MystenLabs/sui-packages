module 0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::final {
    ...
    public fun deposit<T0>(arg0: &0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::listing::CoinTypeWhitelist, arg1: &mut FinalPool, arg2: &0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::game_status::GameStatus, arg3: &0x2::clock::Clock, arg4: 0x2::coin::Coin<T0>, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public fun split_final_pool_after_game_ended<T0>(arg0: &mut FinalPool, arg1: &0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::game_status::GameStatus, arg2: &0x2::clock::Clock, arg3: &0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::profile_manager::ProfileManager, arg4: &mut 0x2::tx_context::TxContext) {
        0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::game_status::assert_valid_package_version(arg1);
        0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::game_status::assert_game_is_ended(arg1, arg2);
        let v0 = arg0.dev;
        let v1 = borrow_single_pool_mut<T0>(arg0);
        if (v1.is_splitted) {
            err_pool_already_splitted();
        };
        let (v2, v3, v4, v5) = 0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::splitter::split_final_pool<T0>(&mut v1.main_pool, arg4);
        let v6 = v3;
        let v7 = v2;
        let v8 = 0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::config::final_winner_count();
        ...
        while (v12 < v8) {
            ...
            let (v15, v16) = 0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::profile_manager::get_seniors(arg3, v14);
        ...
        if (0x1::vector::is_empty<address>(&v10)) {
            ...
            0xb1bd3db2664e3d980fa8e6f2a5391cad98bc082f8fec3ed62459b3731983e5e::splitter::divide_coin_to<T0>(v5, v10, arg4);
        };
