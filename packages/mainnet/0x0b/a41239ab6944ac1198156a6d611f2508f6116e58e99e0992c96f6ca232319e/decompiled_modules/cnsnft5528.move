module 0xba41239ab6944ac1198156a6d611f2508f6116e58e99e0992c96f6ca232319e::cnsnft5528 {
    struct CNSNFT5528 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5528, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4885"));
        let v4 = 0x2::package::claim<CNSNFT5528>(arg0, arg1);
