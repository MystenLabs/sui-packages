module 0xb18b157ee05cff5488e25731e953c47e470918cc1feaf855f49e7a7e0af5d6f::cnsnft6097 {
    struct CNSNFT6097 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6097, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6097>(arg0, arg1);
