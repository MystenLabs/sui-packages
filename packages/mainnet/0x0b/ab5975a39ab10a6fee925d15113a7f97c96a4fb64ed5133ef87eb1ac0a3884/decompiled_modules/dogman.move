module 0xbab5975a39ab10a6fee925d15113a7f97c96a4fb64ed5133ef87eb1ac0a3884::dogman {
    ...
    fun init(arg0: DOGMAN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<DOGMAN>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<DOGMAN>>(v4);
    }
