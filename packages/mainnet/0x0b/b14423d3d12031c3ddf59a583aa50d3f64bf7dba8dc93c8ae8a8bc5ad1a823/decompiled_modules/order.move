module 0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::order {
    ...
    struct OrderAdminCapV2<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        schema_version: u64,
        pool_id: 0x2::object::ID,
        swap_pool_id: 0x2::object::ID,
    ...
    struct OrderProbabilityAdminCapV2<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        schema_version: u64,
        pool_id: 0x2::object::ID,
        swap_pool_id: 0x2::object::ID,
    ...
    struct OrderPauseAdminCapV2<phantom T0, phantom T1> has store, key {
        id: 0x2::object::UID,
        schema_version: u64,
        pool_id: 0x2::object::ID,
        swap_pool_id: 0x2::object::ID,
    ...
    struct OrderPoolV2<phantom T0, phantom T1> has key {
        id: 0x2::object::UID,
        schema_version: u64,
        source_pool_id: 0x2::object::ID,
        migrated_at_ms: u64,
        probability_updated_at_ms: u64,
        swap_pool_id: 0x2::object::ID,
        admin: address,
        admin_version: u64,
        probability_admin: address,
    ...
    struct OrderPoolMigratedV2 has copy, drop {
        old_pool_id: 0x2::object::ID,
        new_pool_id: 0x2::object::ID,
        swap_pool_id: 0x2::object::ID,
        ast_receiver: address,
        old_probability_version: u64,
        new_probability_version: u64,
    ...
    fun assert_pause_admin_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>, arg1: &OrderPauseAdminCapV2<T0, T1>) {
        assert!(arg0.schema_version == 7, 22);
        assert!(arg1.schema_version == 7, 7);
        assert!(arg1.pool_id == 0x2::object::id<OrderPoolV2<T0, T1>>(arg0), 7);
        assert!(arg1.swap_pool_id == arg0.swap_pool_id, 7);
        assert!(arg1.role_version == arg0.pause_admin_version, 7);
    }
    ...
    fun assert_probability_admin_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>, arg1: &OrderProbabilityAdminCapV2<T0, T1>) {
        assert!(arg0.schema_version == 7, 22);
        assert!(arg1.schema_version == 7, 7);
        assert!(arg1.pool_id == 0x2::object::id<OrderPoolV2<T0, T1>>(arg0), 7);
        assert!(arg1.swap_pool_id == arg0.swap_pool_id, 7);
    ...
    fun assert_probability_version_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>, arg1: u64) {
        assert!(arg0.schema_version == 7, 22);
        assert!(arg0.probability_version == arg1, 23);
    }
    ...
    fun assert_valid_daily_rate_v2(arg0: u64) {
        let v0 = if (arg0 > 0) {
            if (arg0 <= 100000000) {
                arg0 % 100 == 0
            } else {
    ...
    fun create_order_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: 0x2::balance::Balance<T0>, arg2: u64, arg3: address, arg4: u64, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = daily_rate_for_period_v2(&arg0.daily_rates_e6, arg5);
        let v1 = arg0.next_order_no;
        let v2 = arg0.ast_receiver;
        arg0.next_order_no = v1 + 1;
        arg0.total_orders = arg0.total_orders + 1;
        ...
        let v3 = OrderCreated{
            order_no             : v1,
            pool_id              : 0x2::object::id<OrderPoolV2<T0, T1>>(arg0),
            swap_pool_id         : arg0.swap_pool_id,
            owner                : arg3,
            ast_receiver         : v2,
            payment_usdc         : arg4,
            ...
            period_days          : arg5,
            daily_rate_e6        : v0,
            total_profit_cap_ast : total_profit_cap_ast_v2(arg2, arg5, v0),
            purchase_price_e8    : arg6,
            price_version        : arg7,
            probability_version  : arg0.probability_version,
            created_at_ms        : arg8,
    ...
    fun daily_rate_for_period_v2(arg0: &vector<u64>, arg1: u8) : u64 {
        assert!(arg1 >= 9 && arg1 <= 199, 4);
        assert!(0x1::vector::length<u64>(arg0) == 191, 21);
        let v0 = *0x1::vector::borrow<u64>(arg0, ((arg1 - 9) as u64));
        assert_valid_daily_rate_v2(v0);
        v0
    }

    public fun default_daily_rates_e6_v2() : vector<u64> {
        let v0 = vector[];
        let v1 = 0;
        while (v1 < 191) {
            0x1::vector::push_back<u64>(&mut v0, 500000 + (v1 * 10000 + 95) / 190 * 100);
            v1 = v1 + 1;
        };
        v0
    }
    ...
    fun emit_admin_updated_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>, arg1: u8, arg2: address, arg3: address, arg4: u64, arg5: &0x2::clock::Clock) {
        let v0 = OrderAdminUpdated{
            pool_id      : 0x2::object::id<OrderPoolV2<T0, T1>>(arg0),
            role         : arg1,
            old_admin    : arg2,
    ...
    public fun get_admin_pool_id_v2<T0, T1>(arg0: &OrderAdminCapV2<T0, T1>) : (0x2::object::ID, 0x2::object::ID) {
        (arg0.pool_id, arg0.swap_pool_id)
    }
    ...
    public fun get_daily_rate_e6_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>, arg1: u8) : u64 {
        daily_rate_for_period_v2(&arg0.daily_rates_e6, arg1)
    }

    public fun get_migration_info_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>) : (0x2::object::ID, u64, u64) {
        (arg0.source_pool_id, arg0.migrated_at_ms, arg0.probability_updated_at_ms)
    }
    ...
    public fun get_pool_id_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>) : 0x2::object::ID {
        0x2::object::id<OrderPoolV2<T0, T1>>(arg0)
    }
    ...
    public fun get_pool_info_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>) : (u64, 0x2::object::ID, address, bool, u64, u64, u128, u128, u128) {
        (arg0.schema_version, arg0.swap_pool_id, arg0.ast_receiver, arg0.paused, arg0.next_order_no, arg0.total_orders, arg0.total_usdc_paid, arg0.total_ast_principal, arg0.total_ast_transferred)
    }
    ...
    public fun get_probability_info_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>) : (u64, u64, vector<u64>, vector<u64>) {
        (arg0.probability_version, arg0.total_probability_weight, arg0.probability_weights, arg0.daily_rates_e6)
    }
    ...
    public fun get_role_info_v2<T0, T1>(arg0: &OrderPoolV2<T0, T1>) : (address, u64, address, u64, address, u64) {
        (arg0.admin, arg0.admin_version, arg0.probability_admin, arg0.probability_admin_version, arg0.pause_admin, arg0.pause_admin_version)
    }
    ...
    public fun get_total_profit_cap_ast_v2(arg0: u64, arg1: u8, arg2: u64) : u64 {
        total_profit_cap_ast_v2(arg0, arg1, arg2)
    }

    public fun owner_migrate_pool_v2<T0, T1>(arg0: &0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::ProtocolOwnerCap, arg1: OrderPool<T0, T1>, arg2: &0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::swap::SwapPool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::assert_owner(arg0);
        assert!(arg1.schema_version == 6, 22);
        assert!(arg1.paused, 24);
        assert!(arg1.probability_version == arg3, 23);
        assert!(arg1.swap_pool_id == 0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::swap::get_pool_id<T0, T1>(arg2), 2);
        assert!(validate_probability_weights(&arg1.probability_weights) == arg1.total_probability_weight, 18);
        validate_daily_rates(&arg1.daily_rates_e6);
        assert!(arg1.ast_receiver != @0x0, 14);
        let v0 = if (arg1.admin != @0x0) {
            if (arg1.probability_admin != @0x0) {
                arg1.pause_admin != @0x0
            } else {
                false
            }
        } else {
        ...
        assert!(v0, 20);
        let v1 = 0x2::object::id<OrderPool<T0, T1>>(&arg1);
        let OrderPool {
            id                        : v2,
            schema_version            : _,
            swap_pool_id              : v4,
            admin                     : v5,
            admin_version             : v6,
            probability_admin         : v7,
            probability_admin_version : v8,
            pause_admin               : v9,
            pause_admin_version       : v10,
            ast_receiver              : v11,
            paused                    : _,
            probability_weights       : v13,
            daily_rates_e6            : v14,
            total_probability_weight  : v15,
            probability_version       : v16,
            next_order_no             : v17,
            total_orders              : v18,
            total_usdc_paid           : v19,
            total_ast_principal       : v20,
            total_ast_transferred     : v21,
        } = arg1;
        let v22 = v13;
        while (0x1::vector::length<u64>(&v22) < 191) {
            0x1::vector::push_back<u64>(&mut v22, 0);
        };
        let v23 = v16 + 1;
        let v24 = OrderPoolV2<T0, T1>{
            id                        : 0x2::object::new(arg5),
            schema_version            : 7,
            source_pool_id            : v1,
            migrated_at_ms            : 0x2::clock::timestamp_ms(arg4),
            probability_updated_at_ms : 0x2::clock::timestamp_ms(arg4),
            swap_pool_id              : v4,
            admin                     : v5,
            admin_version             : v6,
            probability_admin         : v7,
            ...
            ast_receiver              : v11,
            paused                    : true,
            probability_weights       : v22,
            daily_rates_e6            : default_daily_rates_e6_v2(),
            total_probability_weight  : v15,
            probability_version       : v23,
            next_order_no             : v17,
            total_orders              : v18,
            total_usdc_paid           : v19,
            total_ast_principal       : v20,
        ...
        let v25 = 0x2::object::id<OrderPoolV2<T0, T1>>(&v24);
        let v26 = OrderAdminCapV2<T0, T1>{
            id             : 0x2::object::new(arg5),
            schema_version : 7,
            pool_id        : v25,
            swap_pool_id   : v4,
        ...
        let v27 = OrderProbabilityAdminCapV2<T0, T1>{
            id             : 0x2::object::new(arg5),
            schema_version : 7,
            pool_id        : v25,
            swap_pool_id   : v4,
        ...
        let v28 = OrderPauseAdminCapV2<T0, T1>{
            id             : 0x2::object::new(arg5),
            schema_version : 7,
            pool_id        : v25,
            swap_pool_id   : v4,
        ...
        let v29 = OrderPoolMigratedV2{
            old_pool_id              : v1,
            new_pool_id              : v25,
            swap_pool_id             : v4,
            ast_receiver             : v11,
            old_probability_version  : v16,
            new_probability_version  : v23,
            total_probability_weight : v15,
            next_order_no            : v17,
            total_orders             : v18,
            old_daily_rates_e6       : v14,
            probability_weights      : v24.probability_weights,
            daily_rates_e6           : v24.daily_rates_e6,
            timestamp_ms             : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<OrderPoolMigratedV2>(v29);
        0x2::object::delete(v2);
        0x2::transfer::share_object<OrderPoolV2<T0, T1>>(v24);
        0x2::transfer::transfer<OrderAdminCapV2<T0, T1>>(v26, v5);
        0x2::transfer::transfer<OrderProbabilityAdminCapV2<T0, T1>>(v27, v7);
        0x2::transfer::transfer<OrderPauseAdminCapV2<T0, T1>>(v28, v9);
    }
    ...
    public fun owner_replace_admin_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::ProtocolOwnerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::assert_owner(arg1);
        assert!(arg2 != @0x0, 20);
        arg0.admin = arg2;
        arg0.admin_version = arg0.admin_version + 1;
        let v0 = arg0.admin_version;
        let v1 = OrderAdminCapV2<T0, T1>{
            id             : 0x2::object::new(arg4),
            schema_version : 7,
            pool_id        : 0x2::object::id<OrderPoolV2<T0, T1>>(arg0),
            swap_pool_id   : arg0.swap_pool_id,
        ...
        emit_admin_updated_v2<T0, T1>(arg0, 1, arg0.admin, arg2, v0, arg3);
        0x2::transfer::transfer<OrderAdminCapV2<T0, T1>>(v1, arg2);
    }
    ...
    public fun owner_replace_pause_admin_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::ProtocolOwnerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::assert_owner(arg1);
        assert!(arg2 != @0x0, 20);
        arg0.pause_admin = arg2;
        arg0.pause_admin_version = arg0.pause_admin_version + 1;
        let v0 = arg0.pause_admin_version;
        let v1 = OrderPauseAdminCapV2<T0, T1>{
            id             : 0x2::object::new(arg4),
            schema_version : 7,
            pool_id        : 0x2::object::id<OrderPoolV2<T0, T1>>(arg0),
            swap_pool_id   : arg0.swap_pool_id,
        ...
        emit_admin_updated_v2<T0, T1>(arg0, 3, arg0.pause_admin, arg2, v0, arg3);
        0x2::transfer::transfer<OrderPauseAdminCapV2<T0, T1>>(v1, arg2);
    }
    ...
    public fun owner_replace_probability_admin_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::ProtocolOwnerCap, arg2: address, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::assert_owner(arg1);
        assert!(arg2 != @0x0, 20);
        arg0.probability_admin = arg2;
        arg0.probability_admin_version = arg0.probability_admin_version + 1;
        let v0 = arg0.probability_admin_version;
        let v1 = OrderProbabilityAdminCapV2<T0, T1>{
            id             : 0x2::object::new(arg4),
            schema_version : 7,
            pool_id        : 0x2::object::id<OrderPoolV2<T0, T1>>(arg0),
            swap_pool_id   : arg0.swap_pool_id,
        ...
        emit_admin_updated_v2<T0, T1>(arg0, 2, arg0.probability_admin, arg2, v0, arg3);
        0x2::transfer::transfer<OrderProbabilityAdminCapV2<T0, T1>>(v1, arg2);
    }
    ...
    public fun owner_set_paused_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::ProtocolOwnerCap, arg2: bool, arg3: &0x2::clock::Clock) {
        0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::assert_owner(arg1);
        set_paused_internal_v2<T0, T1>(arg0, arg2, arg3);
    }
    ...
    public fun owner_set_probability_weights_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::ProtocolOwnerCap, arg2: u64, arg3: vector<u64>, arg4: vector<u64>, arg5: &0x2::clock::Clock) {
        0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::governance::assert_owner(arg1);
        set_probability_weights_internal_v2<T0, T1>(arg0, arg2, arg3, arg4, arg5);
    }
    ...
    fun period_day_for_ticket_v2(arg0: &vector<u64>, arg1: u64) : u8 {
        assert!(arg1 < validate_probability_weights_v2(arg0), 13);
        let v0 = 0;
        let v1 = 0;
        let v2 = false;
        let v3 = 199;
    ...
    fun set_paused_internal_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: bool, arg2: &0x2::clock::Clock) {
        assert!(arg0.schema_version == 7, 22);
        arg0.paused = arg1;
        let v0 = OrderPauseUpdated{
            pool_id      : 0x2::object::id<OrderPoolV2<T0, T1>>(arg0),
    ...
    public fun set_paused_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &OrderPauseAdminCapV2<T0, T1>, arg2: bool, arg3: &0x2::clock::Clock) {
        assert_pause_admin_v2<T0, T1>(arg0, arg1);
        set_paused_internal_v2<T0, T1>(arg0, arg2, arg3);
    }
    ...
    fun set_probability_weights_internal_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: u64, arg2: vector<u64>, arg3: vector<u64>, arg4: &0x2::clock::Clock) {
        assert_probability_version_v2<T0, T1>(arg0, arg1);
        let v0 = validate_probability_weights_v2(&arg2);
        validate_daily_rates_v2(&arg3);
        let v1 = arg0.probability_version;
        arg0.probability_weights = arg2;
        arg0.daily_rates_e6 = arg3;
        arg0.total_probability_weight = v0;
        arg0.probability_version = v1 + 1;
        arg0.probability_updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        let v2 = OrderProbabilityUpdated{
            pool_id                  : 0x2::object::id<OrderPoolV2<T0, T1>>(arg0),
            old_probability_version  : v1,
            new_probability_version  : arg0.probability_version,
    ...
    public fun set_probability_weights_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &OrderProbabilityAdminCapV2<T0, T1>, arg2: u64, arg3: vector<u64>, arg4: vector<u64>, arg5: &0x2::clock::Clock) {
        assert_probability_admin_v2<T0, T1>(arg0, arg1);
        set_probability_weights_internal_v2<T0, T1>(arg0, arg2, arg3, arg4, arg5);
    }
    ...
    entry fun subscribe_and_draw_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &mut 0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::swap::SwapPool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::random::Random, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert_probability_version_v2<T0, T1>(arg0, arg5);
        assert!(!arg0.paused, 1);
        let v0 = 0x2::random::new_generator(arg8, arg10);
        let v1 = period_day_for_ticket_v2(&arg0.probability_weights, 0x2::random::generate_u64_in_range(&mut v0, 0, arg0.total_probability_weight - 1));
        subscribe_with_period_v2<T0, T1>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, v1, arg9, arg10);
    }
    ...
    fun subscribe_with_period_v2<T0, T1>(arg0: &mut OrderPoolV2<T0, T1>, arg1: &mut 0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::swap::SwapPool<T0, T1>, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u8, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        assert_probability_version_v2<T0, T1>(arg0, arg5);
        assert!(!arg0.paused, 1);
        assert!(arg0.swap_pool_id == 0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::swap::get_pool_id<T0, T1>(arg1), 2);
        assert!(arg8 >= 9 && arg8 <= 199, 4);
        let v0 = 0x2::coin::value<T1>(&arg2);
        let v1 = 0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::swap::get_usdc_unit<T0, T1>(arg1);
        assert!(v0 >= 100 * v1 && v0 <= 10000 * v1, 3);
        let (v2, v3) = 0xde0c7967a1290bb17686f2f1c12602ded7c6b121383e3aca424f80f049967bc0::swap::buy_for_order<T0, T1>(arg1, arg2, arg3, arg4, arg6, arg7, arg9, arg10);
        let v4 = 0x2::tx_context::sender(arg10);
        create_order_v2<T0, T1>(arg0, v2, v3, v4, v0, arg8, arg3, arg4, 0x2::clock::timestamp_ms(arg9), arg10);
    }
    ...
    fun total_profit_cap_ast_v2(arg0: u64, arg1: u8, arg2: u64) : u64 {
        assert!(arg1 >= 9 && arg1 <= 199, 4);
        assert_valid_daily_rate_v2(arg2);
        let v0 = (arg0 as u128) * (arg2 as u128) * (arg1 as u128) / 100000000;
        assert!(v0 <= 18446744073709551615, 17);
        (v0 as u64)
    }
    ...
    fun validate_daily_rates_v2(arg0: &vector<u64>) {
        assert!(0x1::vector::length<u64>(arg0) == 191, 21);
        let v0 = 0;
        while (v0 < 191) {
            assert_valid_daily_rate_v2(*0x1::vector::borrow<u64>(arg0, v0));
            v0 = v0 + 1;
        };
    }
    ...
    fun validate_probability_weights_v2(arg0: &vector<u64>) : u64 {
        assert!(0x1::vector::length<u64>(arg0) == 191, 18);
        let v0 = 0;
        let v1 = 0;
        while (v1 < 191) {
            v0 = v0 + (*0x1::vector::borrow<u64>(arg0, v1) as u128);
