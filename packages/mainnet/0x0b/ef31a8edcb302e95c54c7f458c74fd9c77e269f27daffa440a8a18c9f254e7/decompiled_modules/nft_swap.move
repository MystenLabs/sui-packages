module 0xbef31a8edcb302e95c54c7f458c74fd9c77e269f27daffa440a8a18c9f254e7::nft_swap {
            ...
            if (*0x1::vector::borrow<0x1::string::String>(&v9, v32) == v7 && 0x2::kiosk::has_item(arg1, v33)) {
                ...
                if (0x2::dynamic_object_field::exists_<vector<u8>>(&v31.id, v34)) {
                    if (0x2::kiosk::is_listed(arg1, v33)) {
                        0x2::kiosk::delist<T0>(arg1, arg3, v33);
                    };
                    0x2::kiosk::return_purchase_cap<T0>(arg1, 0x2::dynamic_object_field::remove<vector<u8>, 0x2::kiosk::PurchaseCap<T0>>(&mut v31.id, v34));
            ...
            if (0x2::kiosk::has_item(arg1, v39)) {
                ...
                if (0x2::dynamic_object_field::exists_<vector<u8>>(&v40.id, v41)) {
                    if (0x2::kiosk::is_listed(arg1, v39)) {
                        0x2::kiosk::delist<T0>(arg1, arg2, v39);
                    };
                    0x2::kiosk::return_purchase_cap<T0>(arg1, 0x2::dynamic_object_field::remove<vector<u8>, 0x2::kiosk::PurchaseCap<T0>>(&mut v40.id, v41));
                ...
                if (0x2::dynamic_object_field::exists_<vector<u8>>(&v47.id, v48)) {
                    if (0x2::kiosk::is_listed(arg3, v39)) {
                        0x2::kiosk::delist<T0>(arg3, arg4, v39);
                    };
                    0x2::kiosk::return_purchase_cap<T0>(arg3, 0x2::dynamic_object_field::remove<vector<u8>, 0x2::kiosk::PurchaseCap<T0>>(&mut v47.id, v48));
    ...
    public fun create_trade<T0: store + key>(arg0: &mut Store, arg1: &mut 0x2::kiosk::Kiosk, arg2: &0x2::kiosk::KioskOwnerCap, arg3: vector<TradeItem>, arg4: vector<TradeItem>, arg5: u64, arg6: u64, arg7: u64, arg8: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(is_compatible_version(arg0), 13);
        assert!(0x2::kiosk::has_access(arg1, arg2), 1);
        ...
        assert!(0x2::dynamic_object_field::exists_with_type<0x2::object::ID, Trade>(&arg0.id, v17), 3);
    }
