module 0xb1930aaadbdc5c72ab974ac66989cbf3bbef231737405f18c584680e8d1fb06f::futr_toys {
    struct FUTR_TOYS has drop {
        dummy_field: bool,
    }

    struct DabbingAstro has store, key {
        id: 0x2::object::UID,
        token_id: u64,
    ...
    public fun add_new_toy(arg0: &0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::registry::RegistryCap, arg1: &mut 0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::registry::Registry, arg2: vector<0x1::string::String>, arg3: vector<0x1::string::String>) {
        0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::registry::add_new_toy<DabbingAstro>(arg1, arg0, 0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::toy::create(0x1::string::utf8(b"Dabbing Astro"), 0x1::string::utf8(b"Being an Astronaut is cool in crypto"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/M8u3sIS9YNZzOTNEDSJbN01CFVymBUpao1S0ICFLlBkBAQALAA"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/M8u3sIS9YNZzOTNEDSJbN01CFVymBUpao1S0ICFLlBkBXQCQAg"), 0x2::url::new_unsafe_from_bytes(b"https://aggregator.walrus-mainnet.walrus.space/v1/blobs/by-quilt-patch-id/M8u3sIS9YNZzOTNEDSJbN01CFVymBUpao1S0ICFLlBkBCwBdAA"), 0x2::vec_map::from_keys_values<0x1::string::String, 0x1::string::String>(arg2, arg3), 500000, 20));
    }

    public fun burn(arg0: DabbingAstro, arg1: &mut 0x2::tx_context::TxContext) {
        let DabbingAstro {
            id          : v0,
            token_id    : _,
            name        : _,
    ...
    public fun init_display(arg0: &mut 0x2::display_registry::DisplayRegistry, arg1: 0x2::package::Publisher, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x1::string::utf8(b"Dabbing Astro");
        ...
        let (v5, v6) = 0x2::display_registry::new_with_publisher<DabbingAstro>(arg0, &mut arg1, arg2);
        let v7 = v6;
        let v8 = v5;
        let v9 = 0;
        while (v9 < 4) {
            0x2::display_registry::set<DabbingAstro>(&mut v8, &v7, *0x1::vector::borrow<0x1::string::String>(&v0, v9), *0x1::vector::borrow<0x1::string::String>(&v3, v9));
            v9 = v9 + 1;
        };
        0x2::display_registry::share<DabbingAstro>(v8);
        0x2::transfer::public_transfer<0x2::display_registry::DisplayCap<DabbingAstro>>(v7, 0x2::tx_context::sender(arg2));
    ...
    public fun premint_toys(arg0: &0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::store::StoreCap, arg1: &mut 0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::store::Store, arg2: &mut 0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::registry::Registry, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::vector::empty<DabbingAstro>();
        let v1 = 0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::registry::borrow_toy<DabbingAstro>(arg2);
        let v2 = 1;
        while (v2 <= arg3) {
            let v3 = DabbingAstro{
            ...
            0x1::vector::push_back<DabbingAstro>(&mut v0, v3);
            v2 = v2 + 1;
        };
        0x70243ba0c5b73ebb20ed89bad5f93a51fc070dfd7092e1cf174c5a5efea03c15::store::add_preminted<DabbingAstro>(arg1, arg0, arg2, v0);
