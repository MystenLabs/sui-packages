module 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::combo_dice {
    ...
    fun draw_<T0>(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>) {
        ...
        let v34 = 0x2::balance::zero<T0>();
        let v35 = 0x2::balance::value<T0>(&v20);
        if (v33 > v35) {
            let v36 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut v1.id, 0x1::type_name::get<T0>());
            if (v33 - v35 > 0x2::balance::value<T0>(v36)) {
                abort 19
            };
            0x2::balance::join<T0>(&mut v34, 0x2::balance::split<T0>(v36, v33 - v35));
            0x2::balance::join<T0>(&mut v34, 0x2::balance::split<T0>(&mut v20, v35));
        } else if (v33 > 0) {
            0x2::balance::join<T0>(&mut v34, 0x2::balance::split<T0>(&mut v20, v33));
        };
        if (v33 >= 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::get_u64_padding_value(&v1.game_config.u64_padding, 0)) {
            v1.is_active = false;
        };
        ...
        0x2::event::emit<Draw>(v37);
        (0x2::coin::from_balance<T0>(v34, arg5), v21)
    }
    ...
    public entry fun new_game<T0>(arg0: &mut Registry, arg1: &mut 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::Registry, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<vector<u8>, 0x2::coin::Coin<0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::TAILS_EXP>>(&mut v4.id, b"tails_exp_coin", 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp::friend_mint_exp_token(arg1, arg4 / v2.exp_config.base_exp_divisor, arg5));
    ...
    public(friend) entry fun set_max_single_game_loss(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: &0x2::tx_context::TxContext) {
        ...
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::set_u64_padding_value(&mut v1.game_config.u64_padding, 0, arg2);
        let v2 = SetMaxSingleGameLoss{
            signer      : 0x2::tx_context::sender(arg3),
            index       : arg1,
            prev_amount : 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::utils::get_u64_padding_value(&v1.game_config.u64_padding, 0),
            amount      : arg2,
        };
