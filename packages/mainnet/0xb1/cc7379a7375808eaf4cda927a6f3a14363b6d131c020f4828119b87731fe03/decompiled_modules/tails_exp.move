module 0x37816d28c34cc0df82655ca97b3f066112a5f3c202cbb4aaa76c8af54e779750::tails_exp {
    ...
    fun draw_(arg0: &mut Registry, arg1: u64, arg2: address, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<TAILS_EXP> {
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        let (_, v3) = 0x2::vec_map::remove<address, Game>(&mut v1.opened_games, &arg2);
    ...
    entry fun play_guess(arg0: &mut Registry, arg1: u64, arg2: u64, arg3: bool, arg4: u64, arg5: bool, arg6: &0x2::random::Random, arg7: &mut 0x2::tx_context::TxContext) {
        version_check(arg0);
        let v0 = &mut arg0.id;
        let v1 = get_mut_playground(v0, arg1);
        assert!(v1.is_active, 19);
        ...
        let v9 = draw_(arg0, arg1, v6, arg6, arg7);
