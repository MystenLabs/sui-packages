module 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::battle {
    ...
    fun charge_reroll<T0>(arg0: &0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::config::TreeConfig, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::config::reroll_cost(arg0);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg1, v0, arg2), @0x0);
    ...
    fun gen_moves_for_entitlement(arg0: bool, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) : vector<u8> {
        ...
        let v1 = attack_hand_candidate_moves();
        let v2 = candidates_excluding(&v1, &v0);
        let v3 = growth_hand_candidate_moves();
        let v4 = candidates_excluding(&v3, &v0);
        let v5 = hybrid_hand_candidate_moves();
        let v6 = candidates_excluding(&v5, &v0);
        let v7 = 0x2::random::new_generator(arg1, arg2);
        0x1::vector::push_back<u8>(&mut v0, *0x1::vector::borrow<u8>(&v2, 0x2::random::generate_u64(&mut v7) % 0x1::vector::length<u8>(&v2)));
        0x1::vector::push_back<u8>(&mut v0, *0x1::vector::borrow<u8>(&v4, 0x2::random::generate_u64(&mut v7) % 0x1::vector::length<u8>(&v4)));
        0x1::vector::push_back<u8>(&mut v0, *0x1::vector::borrow<u8>(&v6, 0x2::random::generate_u64(&mut v7) % 0x1::vector::length<u8>(&v6)));
        v0
    }
    ...
    fun gen_reroll_moves(arg0: &vector<u8>, arg1: bool, arg2: &0x2::random::Random, arg3: &mut 0x2::tx_context::TxContext) : vector<u8> {
        ...
        let v11 = attack_hand_candidate_moves();
        let v12 = candidates_excluding(&v11, arg0);
        let v13 = growth_hand_candidate_moves();
        let v14 = candidates_excluding(&v13, arg0);
        let v15 = hybrid_hand_candidate_moves();
    ...
    fun map_ability_name(arg0: vector<u8>) : u8 {
        if (0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::eq_str(arg0, b"ThornSpikeBomb")) {
            ...
            13
        } else if (0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::eq_str(arg0, b"CompostTea")) {
            14
        } else if (0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::eq_str(arg0, b"MycorrhizalNetwork")) {
            15
        } else if (0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::eq_str(arg0, b"PruningShears")) {
            16
        } else if (0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::eq_str(arg0, b"MulchBarrier")) {
            17
        } else if (0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::eq_str(arg0, b"RootGraft")) {
            18
        } else if (0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::utils::eq_str(arg0, b"OvergrowthGamble")) {
            19
    ...
    public entry fun reroll_pvp_v3_moves<T0>(arg0: &mut PvpBattleV3, arg1: &0x656ac984c39b952b40ccaaad4c26a3e074c4c99f56e2bac0862b811557de448b::config::TreeConfig, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == arg0.player1) {
            ...
            charge_reroll<T0>(arg1, arg2, arg4);
