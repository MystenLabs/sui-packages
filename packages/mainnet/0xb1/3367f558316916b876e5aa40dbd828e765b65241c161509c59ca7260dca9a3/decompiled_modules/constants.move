module 0xb13367f558316916b876e5aa40dbd828e765b65241c161509c59ca7260dca9a3::constants {
    ...
    public fun default_dao_creation_fee() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::default_dao_creation_fee()
    }

    public fun default_launchpad_creation_fee() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::default_launchpad_creation_fee()
    }
    ...
    public fun default_proposal_creation_fee() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::default_proposal_creation_fee()
    }

    public fun default_proposal_fee_per_outcome() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::default_proposal_fee_per_outcome()
    }
    ...
    public fun execution_window_ms() : u64 {
        let v0 = 1800000;
        let v1 = 0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::min_execution_window_ms();
        if (v0 > v1) {
            v0
        } else {
            v1
    ...
    public fun launchpad_bid_fee_per_contribution() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::launchpad_bid_fee_per_contribution()
    }
    ...
    public fun launchpad_min_duration_ms() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::launchpad_min_duration_ms()
    }
    ...
    public fun min_execution_window_ms() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::min_execution_window_ms()
    }
    ...
    public fun min_proposal_intent_expiry_ms() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::min_proposal_intent_expiry_ms()
    }

    public fun min_review_period_ms() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::min_review_period_ms()
    }

    public fun min_trading_period_ms() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::min_trading_period_ms()
    }
    ...
    public fun protocol_min_liquidity_amount() : u64 {
        0xd1da5bd491feb0dc7caa4954bc040c3218700a34cfd553208d50dab90c10f6b0::constants::protocol_min_liquidity_amount()
    }
