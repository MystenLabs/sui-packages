module 0xb1b3b2d19de60ee7895b7182eb48ebc9c42c7e5bad96198a6061b49d6b4aa040::cnsnft3484 {
    struct CNSNFT3484 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3484, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3484>(arg0, arg1);
