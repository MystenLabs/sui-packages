module 0xb193a27fed03429eb50180e906abd34f0b55dad015ca1fa199683b04975e0450::cnsnft9127 {
    struct CNSNFT9127 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9127, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9127>(arg0, arg1);
