module 0xb1fe8a5c45498e4b04a5afe01db4900773fd78aee50af9ff8bc0a8314b6453d6::reward7048 {
    struct REWARD7048 has drop {
        dummy_field: bool,
    }

    struct TICKET_7048 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7048(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7048>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7048>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7048, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7048>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7048>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7048>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7048>>(v5, 0x2::tx_context::sender(arg1));
    }
