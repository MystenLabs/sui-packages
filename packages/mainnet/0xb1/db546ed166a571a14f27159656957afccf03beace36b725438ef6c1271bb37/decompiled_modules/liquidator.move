module 0xb1db546ed166a571a14f27159656957afccf03beace36b725438ef6c1271bb37::liquidator {
    ...
    public(friend) fun ensure_caller_whitelisted(arg0: &Liquidator, arg1: address) {
        assert!(0x2::vec_set::contains<address>(&arg0.whitelist, &arg1), 0xb1db546ed166a571a14f27159656957afccf03beace36b725438ef6c1271bb37::error::not_whitelisted());
    }
    ...
    public fun update_slippage_tolerance(arg0: &LiquidatorAdminCap, arg1: &mut Liquidator, arg2: u32) {
        assert!(arg2 <= 10000, 0xb1db546ed166a571a14f27159656957afccf03beace36b725438ef6c1271bb37::error::invalid_slippage());
