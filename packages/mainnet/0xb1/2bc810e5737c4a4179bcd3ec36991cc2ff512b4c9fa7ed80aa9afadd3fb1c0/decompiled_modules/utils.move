module 0xb12bc810e5737c4a4179bcd3ec36991cc2ff512b4c9fa7ed80aa9afadd3fb1c0::utils {
    ...
    public fun split_coin_by_weights<T0>(arg0: 0x2::coin::Coin<T0>, arg1: vector<u64>, arg2: &mut 0x2::tx_context::TxContext) : vector<0x2::coin::Coin<T0>> {
        ...
        while (v3 < 0x1::vector::length<u64>(&arg1)) {
            0x1::vector::push_back<0x2::coin::Coin<T0>>(&mut v0, 0x2::coin::split<T0>(&mut arg0, 0xb12bc810e5737c4a4179bcd3ec36991cc2ff512b4c9fa7ed80aa9afadd3fb1c0::math::divide_and_round_up(v4 * *0x1::vector::borrow<u64>(&arg1, v3), 10000), arg2));
            v3 = v3 + 1;
        };
