module 0xb12bc810e5737c4a4179bcd3ec36991cc2ff512b4c9fa7ed80aa9afadd3fb1c0::fee {
    ...
    public fun accrue_fixed_native_fees(arg0: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg1: address, arg2: &FeesStorage, arg3: 0x1::string::String, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            0xb12bc810e5737c4a4179bcd3ec36991cc2ff512b4c9fa7ed80aa9afadd3fb1c0::asset::transfer_sui_coin(arg0, v1 - v2, arg1, arg4);
        };
        if (v2 > 0) {
            0xb12bc810e5737c4a4179bcd3ec36991cc2ff512b4c9fa7ed80aa9afadd3fb1c0::asset::transfer_sui_coin(arg0, v2, arg2.protocol_fee_vault, arg4);
        };
    }
    ...
    public fun accrue_token_fees<T0>(arg0: &mut 0x2::coin::Coin<T0>, arg1: address, arg2: u64, arg3: &FeesStorage, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        if (v1 > 0) {
            0xb12bc810e5737c4a4179bcd3ec36991cc2ff512b4c9fa7ed80aa9afadd3fb1c0::asset::transfer_coin<T0>(arg0, v1 - v2, arg1, arg5);
        };
        if (v2 > 0) {
            0xb12bc810e5737c4a4179bcd3ec36991cc2ff512b4c9fa7ed80aa9afadd3fb1c0::asset::transfer_coin<T0>(arg0, v2, arg3.protocol_fee_vault, arg5);
        };
    }
