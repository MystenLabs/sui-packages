module 0xb1be6adec1c15140ec349c8a12818b32dd8e1a82e7904de29dc849c0692b3445::file {
    struct File has key {
        id: 0x2::object::UID,
    ...
    public fun create_file(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: u8, arg5: u16, arg6: 0x1::option::Option<0x1::string::String>, arg7: 0x1::option::Option<u8>, arg8: vector<0x1::string::String>, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = FileConfig{
            chunk_size            : arg4,
            sublist_size          : arg5,
        ...
        0x2::transfer::transfer<File>(v1, 0x2::tx_context::sender(arg9));
    }
