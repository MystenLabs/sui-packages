module 0xb1cbac5258871ee5b2eeae690e27c524a8172821597bab733738fc7adaf9c2ca::klaus {
    ...
    fun init(arg0: KLAUS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<KLAUS>(&mut v2, 4000000000000000000, 0x2::tx_context::sender(arg1), arg1);
