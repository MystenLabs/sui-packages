module 0xb1861cbedbd0e4cd3f78cd947e305e046402de52098ad9fe611d6474bdba104f::cnsnft4391 {
    struct CNSNFT4391 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4391, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4391>(arg0, arg1);
