module 0xb186fac1377c6b8fb2c9da8fd3b1c25aa0a036149ff133430c31fc6f735f2cf2::Sui_Reward_W3 {
    struct SUI_REWARD_W3 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun GiveReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = SUI_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://QmRwJd18QijGBcvMSdS8iDNVXYuWrVtMpZam9ewcP5ETHq"),
            };
    ...
    fun init(arg0: SUI_REWARD_W3, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmRwJd18QijGBcvMSdS8iDNVXYuWrVtMpZam9ewcP5ETHq"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Sui"));
        let v4 = 0x2::package::claim<SUI_REWARD_W3>(arg0, arg1);
