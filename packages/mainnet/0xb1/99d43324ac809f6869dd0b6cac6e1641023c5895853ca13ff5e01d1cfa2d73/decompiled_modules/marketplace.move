module 0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::marketplace {
    ...
    public fun accept_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Marketplace>, RoyaltiesInfo<T0>, FloorInfo<T0>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223374227288227843);
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg1), 9223374231583195139);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v0), 9223374235878293509);
        let v1 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg1), v1), 9223374240173654027);
        ...
        let Listing {
            ...
            purchase_cap : v5,
            timestamp    : v6,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v2);
        ...
        let Bidding {
            ...
            funds     : v11,
            timestamp : v12,
        } = 0x2::bag::remove<BidItem, Bidding<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg1), v7);
        ...
        0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::witness_rule_marketplace::confirm<T0, Purchase>(v19, arg3, &mut v18);
        0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::lock<T0>(arg1, v16, arg3);
        ...
        (v18, 0x2::transfer_policy::new_request<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Marketplace>(arg2, v10, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v20, v21, v22, 0x2::coin::split<T1>(&mut v13, arg6, arg7))
    }

    public fun accept_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &mut 0x2::kiosk::Kiosk, arg2: 0x2::object::ID, arg3: &mut Collection, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: u64, arg8: &mut 0x2::tx_context::TxContext) : (0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Marketplace>, RoyaltiesInfo<T0>, FloorInfo<T0>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223374442036592643);
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg1), 9223374446331559939);
        let v0 = ListItem{id: arg2};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v0), 9223374450626658309);
        let v1 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg3.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg1), v1), 9223374454922018827);
        let v2 = ListItem{id: arg2};
        let Listing {
            seller       : v3,
            price        : _,
        ...
        let CollectionBid {
            ...
            funds     : v9,
            timestamp : v10,
        } = 0x2::bag::remove<CollectionBidItem, CollectionBid<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg1), v7);
        let v11 = v9;
        ...
        let v18 = v17;
        let v19 = Purchase{dummy_field: false};
        0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::witness_rule_marketplace::confirm<T0, Purchase>(v19, arg4, &mut v18);
        0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::lock<T0>(arg1, v16, arg4);
        let v20 = RoyaltiesInfo<T0>{
            coin_type : v14,
            price     : v12,
        };
        ...
        (v18, 0x2::transfer_policy::new_request<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Marketplace>(arg2, v12, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v20, v21, v22, 0x2::coin::split<T1>(&mut v13, arg7, arg8))
    }
    ...
    public fun cancel_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223373948115353603);
        let v0 = BidItem{id: arg2};
        assert!(0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v0), 9223373952410845195);
        ...
        let Bidding {
            ...
            funds     : v9,
            timestamp : _,
        } = 0x2::bag::remove<BidItem, Bidding<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v5);
    ...
    public fun cancel_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: vector<u8>, arg4: &mut MarketplaceConfig, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223374085554307075);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v0), 9223374089849798667);
        let v1 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v2 = 0x1::bcs::to_bytes<0x2::object::ID>(&v1);
        let v3 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v2, 0x1::bcs::to_bytes<address>(&v3));
        ...
        let CollectionBid {
            ...
            funds     : v8,
            timestamp : _,
        } = 0x2::bag::remove<CollectionBidItem, CollectionBid<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v6);
    ...
    public fun delist<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: &mut MarketplaceConfig, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223373226560847875);
        ...
        let Listing {
            ...
            purchase_cap : v7,
            timestamp    : _,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v4);
    ...
    public fun list<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &mut MarketplaceConfig, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223373050467188739);
        let v0 = 0x2::object::uid_to_inner(0x2::kiosk::uid(arg0));
        let v1 = 0x1::bcs::to_bytes<0x2::object::ID>(&v0);
        let v2 = 0x2::kiosk::owner(arg0);
        0x1::vector::append<u8>(&mut v1, 0x1::bcs::to_bytes<address>(&v2));
        ...
        assert!(0x4029616b7d1496bf853e8024cb23a0f0ca10fe58aafefbec674119c312bcca22::build_slot::is_active(0x2::kiosk::borrow<0x4029616b7d1496bf853e8024cb23a0f0ca10fe58aafefbec674119c312bcca22::build_slot::BuildSlot>(arg0, arg1, arg2)), 9223373106302418957);
        ...
        0x2::bag::add<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v4, v5);
        let v6 = ListingEvent{
            item_id   : arg2,
    ...
    public fun place_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: u64, arg5: 0x2::coin::Coin<T1>, arg6: u64, arg7: &0x2::clock::Clock, arg8: vector<u8>, arg9: &mut MarketplaceConfig, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223373591633068035);
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg2), 9223373595928035331);
        let v0 = ListItem{id: arg3};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg2), v0), 9223373600223133701);
        let v1 = BidItem{id: arg3};
        assert!(!0x2::bag::contains_with_type<BidItem, Bidding<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v1), 9223373604518363145);
        ...
        let v7 = 0x2::bag::borrow<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg2), v6);
        let v8 = &v7.seller;
        ...
        0x2::bag::add<BidItem, Bidding<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v9, v10);
    ...
    public fun place_collection_bid<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: &mut Collection, arg3: 0x2::coin::Coin<T1>, arg4: u64, arg5: vector<u8>, arg6: &mut MarketplaceConfig, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223373797791498243);
        let v0 = CollectionBidItem{id: 0x2::object::uid_to_inner(&arg2.id)};
        assert!(!0x2::bag::contains_with_type<CollectionBidItem, CollectionBid<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v0), 9223373802086858761);
        ...
        0x2::bag::add<CollectionBidItem, CollectionBid<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v6, v7);
    ...
    public fun purchase<T0: store + key, T1>(arg0: &mut 0x2::kiosk::Kiosk, arg1: 0x2::object::ID, arg2: 0x2::coin::Coin<T1>, arg3: &0x2::transfer_policy::TransferPolicy<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (T0, 0x2::transfer_policy::TransferRequest<T0>, 0x2::transfer_policy::TransferRequest<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Marketplace>, RoyaltiesInfo<T0>, FloorInfo<T0>, TradeInfo<T0>, 0x2::coin::Coin<T1>) {
        assert!(0x2::kiosk_extension::is_installed<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Extension>(arg0), 9223373385474637827);
        let v0 = ListItem{id: arg1};
        assert!(0x2::bag::contains_with_type<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v0), 9223373389769736197);
        ...
        let Listing {
            ...
            purchase_cap : v4,
            timestamp    : v5,
        } = 0x2::bag::remove<ListItem, Listing<T0, T1>>(0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::bag_mut(arg0), v1);
        ...
        0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::witness_rule_marketplace::confirm<T0, Purchase>(v12, arg3, &mut v11);
        ...
        (v9, v11, 0x2::transfer_policy::new_request<0xb199d43324ac809f6869dd0b6cac6e1641023c5895853ca13ff5e01d1cfa2d73::extension::Marketplace>(arg1, v3, 0x2::object::id<0x2::kiosk::Kiosk>(arg0)), v13, v14, v15, 0x2::coin::split<T1>(&mut arg2, arg6, arg7))
    }
