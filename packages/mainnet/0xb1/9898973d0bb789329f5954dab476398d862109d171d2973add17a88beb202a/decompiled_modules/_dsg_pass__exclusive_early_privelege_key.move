module 0xb19898973d0bb789329f5954dab476398d862109d171d2973add17a88beb202a::_dsg_pass__exclusive_early_privelege_key {
    ...
    fun init(arg0: _DSG_PASS__EXCLUSIVE_EARLY_PRIVELEGE_KEY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreieicad4dcm23kg4mloilieoyd7myfxqrvaz5bdb4fwnpznrmnylmm"));
