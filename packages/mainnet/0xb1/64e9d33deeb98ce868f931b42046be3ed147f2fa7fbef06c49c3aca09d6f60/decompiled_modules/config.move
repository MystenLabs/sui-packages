module 0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::config {
    ...
    struct GlobalConfig has store, key {
        id: 0x2::object::UID,
        acl: 0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::ACL,
        package_version: u64,
    ...
    public fun get_members(arg0: &GlobalConfig) : vector<0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::Member> {
        0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::get_members(&arg0.acl)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        checked_package_version(arg0);
        0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        checked_package_version(arg0);
        0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::set_roles(&mut arg0.acl, arg2, arg3);
    ...
    public fun add_in_coin_type<T0>(arg0: &mut GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        assert!(0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 1), 2);
    ...
    public fun checked_keeper(arg0: &GlobalConfig, arg1: address) {
        assert!(0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::has_role(&arg0.acl, arg1, 0), 1);
    }

    public fun checked_oracle(arg0: &GlobalConfig, arg1: address) {
        assert!(0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::has_role(&arg0.acl, arg1, 2), 3);
    }
    ...
    public fun claim_fee<T0>(arg0: &GlobalConfig, arg1: &mut ProtocolFeeVault, arg2: &mut 0x2::tx_context::TxContext) {
        checked_package_version(arg0);
        assert!(0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg2), 1), 2);
        let v0 = 0x1::type_name::get<T0>();
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = GlobalConfig{
            ...
            acl                   : 0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::new(arg0),
            package_version       : 1,
        ...
        0xb164e9d33deeb98ce868f931b42046be3ed147f2fa7fbef06c49c3aca09d6f60::acl::set_roles(&mut v0.acl, v3, 0 | 1 << 1);
