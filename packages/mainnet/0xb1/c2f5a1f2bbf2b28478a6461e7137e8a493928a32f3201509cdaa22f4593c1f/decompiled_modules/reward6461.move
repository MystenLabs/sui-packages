module 0xb1c2f5a1f2bbf2b28478a6461e7137e8a493928a32f3201509cdaa22f4593c1f::reward6461 {
    struct REWARD6461 has drop {
        dummy_field: bool,
    }

    struct TICKET_6461 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6461(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6461>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6461>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6461, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6461>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6461>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6461>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6461>>(v5, 0x2::tx_context::sender(arg1));
    }
