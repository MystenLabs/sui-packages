module 0xb1c576d10e217a38726286ffae86b6fb0ed9f9cb0d613edf98d61654b6301216::attestor {
    struct Order has key {
        ...
        deadline_epoch: u32,
        state: u8,
        ticket: 0x1::option::Option<0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::ObligationTicket>,
    }
    ...
    public fun accept_delivery(arg0: &mut Order, arg1: &mut 0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::EternityVault, arg2: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.state == 0, 7);
        assert!(0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::vault_id(arg1) == arg0.vault_id, 1);
        assert!(0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::is_certified_live(arg1, arg2), 2);
        assert!(0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::committed_blob_id(arg1) == arg0.committed_blob_id, 3);
        assert!(0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::live_through_epoch(arg1) >= arg0.required_horizon, 4);
        ...
        arg0.state = 1;
        0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::unlock_obligation(arg1, 0x1::option::extract<0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::ObligationTicket>(&mut arg0.ticket));
        let v1 = Delivered{
            order_id : 0x2::object::uid_to_inner(&arg0.id),
            worker   : arg0.worker,
            amount   : v0,
            vault_id : arg0.vault_id,
            version  : 0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::receipt_version(arg1),
        };
        0x2::event::emit<Delivered>(v1);
    }

    public fun create_order(arg0: &mut 0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::EternityVault, arg1: address, arg2: 0x2::coin::Coin<0x356a26eb9e012a68958082340d4c4116e7f55615cf27affcff209cf0ae544f59::wal::WAL>, arg3: u256, arg4: u32, arg5: u32, arg6: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = 0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::lock_obligation(arg0);
        let v1 = 0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::ticket_vault_id(&v0);
        ...
        let v5 = Order{
            ...
            deadline_epoch    : arg5,
            state             : 0,
            ticket            : 0x1::option::some<0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::ObligationTicket>(v0),
        };
        let v6 = OrderCreated{
            order_id          : v4,
            payer             : v2,
    ...
    public fun refund_on_timeout(arg0: &mut Order, arg1: &mut 0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::EternityVault, arg2: &0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::system::System, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.state == 0, 7);
        assert!(0x7a81a9cbc45f3512f314250b138cd86fc588906828e6090173306e0777c1215a::eternity_vault::vault_id(arg1) == arg0.vault_id, 1);
