module 0xb1a18970ffff58f27a0f2a7faa98bca465ddc7caec8ba3a63effccd107726d13::cnsnft4758 {
    struct CNSNFT4758 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4758, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4758>(arg0, arg1);
