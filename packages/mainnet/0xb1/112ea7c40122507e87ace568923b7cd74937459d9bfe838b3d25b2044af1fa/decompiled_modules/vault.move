module 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::vault {
    ...
    entry fun burn_sgc<T0>(arg0: &mut 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::Minter, arg1: &mut Burn_sgc_fee, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 9);
        let v0 = withdraw_burning_sgc<T0>(arg1, arg3);
        assert!(0x2::coin::value<T0>(&v0) > 0, 5);
        0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::burn(arg0, 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::mini_swap::swap<0x2::sui::SUI, 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::SGC>(arg2, 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::mini_swap::swap<T0, 0x2::sui::SUI>(arg2, v0, arg3), arg3));
    }

    entry fun burn_sgc_sui(arg0: &mut 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::Minter, arg1: &mut Burn_sgc_fee, arg2: &mut 0xba153169476e8c3114962261d1edc70de5ad9781b83cc617ecc8c1923191cae0::factory::Container, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version == 1, 9);
        let v0 = withdraw_burning_sgc<0x2::sui::SUI>(arg1, arg3);
        assert!(0x2::coin::value<0x2::sui::SUI>(&v0) > 0, 5);
        0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::burn(arg0, 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::mini_swap::swap<0x2::sui::SUI, 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::SGC>(arg2, v0, arg3));
    }
    ...
    public entry fun entry_get_sgc_coin<T0>(arg0: &mut 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::Minter, arg1: &mut 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg2.version == 1, 9);
        let v0 = 0x2::clock::timestamp_ms(arg4) / 1000;
        0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg5)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg5))) / arg3.sgc_weight, arg5);
    ...
    fun get_sgc_coin<T0>(arg0: &mut 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::Minter, arg1: &mut 0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::Halving_cycle, arg2: &SavingsData<T0>, arg3: &mut Get_sgc<T0>, arg4: bool, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::clock::timestamp_ms(arg5) / 1000;
        if (arg4) {
            0xb1112ea7c40122507e87ace568923b7cd74937459d9bfe838b3d25b2044af1fa::sgc::mint(arg0, arg1, *0x2::table::borrow<address, u64>(&arg2.savings, 0x2::tx_context::sender(arg6)) * (v0 - *0x2::table::borrow<address, u64>(&arg3.change_time, 0x2::tx_context::sender(arg6))) / arg3.sgc_weight, arg6);
    ...
    entry fun lottery<T0, T1, T2>(arg0: &mut Burn_sgc_fee, arg1: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T0>, arg2: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::RewardFund<T1>, arg3: &0xca441b44943c16be0e6e23c5a955bb971537ea3289ae8016fbf33fffe1fd210f::oracle::PriceOracle, arg4: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v3::Incentive, arg5: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::incentive_v2::Incentive, arg6: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::storage::Storage, arg7: &mut 0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::pool::Pool<T2>, arg8: &mut SavingsData<T2>, arg9: &0x2::random::Random, arg10: &0x2::clock::Clock, arg11: &mut 0x3::sui_system::SuiSystemState, arg12: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = v6 / (arg0.fee as u64);
        let v8 = (v6 - v7) / 100;
        let v9 = 0x2::coin::split<T2>(&mut v5, v7, arg12);
        0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v5, v2);
        let v10 = &mut arg8.prize_pool_weekly;
        add_coin_to_bag<T2>(v10, 0x2::coin::split<T2>(&mut v5, v8 * arg8.weighting_weekly, arg12));
        let v11 = &mut arg8.prize_pool_monthly;
        add_coin_to_bag<T2>(v11, 0x2::coin::split<T2>(&mut v5, v8 * arg8.weighting_monthly, arg12));
        deposit_fee<T2>(arg0, v9, arg12);
        claim_reward_all<T0, T1, T2>(arg0, arg1, arg2, arg4, arg6, arg8, arg10, v2, arg12);
        if (arg8.number_of_draws % arg8.round_weekly == 0) {
            if (!arg8.lottery_draw_weekly) {
                arg8.lottery_draw_weekly = true;
            };
        };
        if (arg8.number_of_draws % arg8.round_monthly == 0) {
            if (!arg8.lottery_draw_monthly) {
                arg8.lottery_draw_monthly = true;
            };
        };
        arg8.start_time_day = 0x2::clock::timestamp_ms(arg10);
        let v12 = Outcome<T2>{
            win       : v4,
            game_type : 1,
            adder     : v2,
    ...
    entry fun lottery_monthly<T0, T1, T2>(arg0: &mut SavingsData<T2>, arg1: &0x2::random::Random, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 9);
        assert!(arg0.lottery_draw_monthly, 6);
        let v0 = 0x2::random::new_generator(arg1, arg3);
        gas_consume(0x2::random::generate_u64_in_range(&mut v0, 1, 20));
        let v1 = 0x2::random::generate_u128_in_range(&mut v0, 1, calculate_node_weight(0x2::table::borrow<u64, Node_Data>(&arg0.internal_node_data, 1), 0x2::clock::timestamp_ms(arg2) / 1000, arg0.start_time));
        let v2 = *0x2::table::borrow<u64, address>(&arg0.node_adder, lottery_num<T2>(v1, arg0, arg2));
        let v3 = 0x2::bag::length(&arg0.prize_pool_monthly);
        let v4 = &mut arg0.prize_pool_monthly;
        let v5 = take_all_from_bag<T2>(v4, arg3);
        ...
        if (v3 > 1) {
            let v6 = &mut arg0.prize_pool_monthly;
            let v7 = take_all_from_bag<T0>(v6, arg3);
            ...
            if (v3 > 2) {
                let v8 = &mut arg0.prize_pool_monthly;
                let v9 = take_all_from_bag<T1>(v8, arg3);
        ...
        assert!(0x2::bag::length(&arg0.prize_pool_monthly) == 0, 13);
        arg0.lottery_draw_monthly = false;
    ...
    entry fun lottery_weekly<T0, T1, T2>(arg0: &mut SavingsData<T2>, arg1: &0x2::random::Random, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.version == 1, 9);
        assert!(arg0.lottery_draw_weekly, 6);
        let v0 = 0x2::random::new_generator(arg1, arg3);
        gas_consume(0x2::random::generate_u64_in_range(&mut v0, 1, 20));
        let v1 = 0x2::random::generate_u128_in_range(&mut v0, 1, calculate_node_weight(0x2::table::borrow<u64, Node_Data>(&arg0.internal_node_data, 1), 0x2::clock::timestamp_ms(arg2) / 1000, arg0.start_time));
        let v2 = *0x2::table::borrow<u64, address>(&arg0.node_adder, lottery_num<T2>(v1, arg0, arg2));
        let v3 = 0x2::bag::length(&arg0.prize_pool_weekly);
        let v4 = &mut arg0.prize_pool_weekly;
        let v5 = take_all_from_bag<T2>(v4, arg3);
        if (0x2::coin::value<T2>(&v5) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T2>>(v5, v2);
        } else {
        ...
        if (v3 > 1) {
            let v6 = &mut arg0.prize_pool_weekly;
            let v7 = take_all_from_bag<T0>(v6, arg3);
            if (0x2::coin::value<T0>(&v7) > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v7, v2);
            } else {
            ...
            if (v3 > 2) {
                let v8 = &mut arg0.prize_pool_weekly;
                let v9 = take_all_from_bag<T1>(v8, arg3);
                if (0x2::coin::value<T1>(&v9) > 0) {
                    0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v9, v2);
                } else {
        ...
        assert!(0x2::bag::length(&arg0.prize_pool_weekly) == 0, 12);
        arg0.lottery_draw_weekly = false;
        let v10 = Outcome<T2>{
            win       : 0,
            game_type : 7,
            adder     : v2,
    ...
    fun use_null_nodes<T0>(arg0: &mut SavingsData<T0>, arg1: u64, arg2: &0x2::clock::Clock, arg3: address) {
        ...
        *v1 = arg3;
        ...
        modify_parent_node<T0>(v3, v5, arg0, v2, true, 0);
    }
