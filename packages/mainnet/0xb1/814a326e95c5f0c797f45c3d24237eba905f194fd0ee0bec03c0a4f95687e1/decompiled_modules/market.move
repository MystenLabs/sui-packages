module 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::market {
    ...
    public(friend) fun add_fee<T0>(arg0: &mut Market, arg1: 0x2::balance::Balance<XToken<T0>>) {
        ...
        let v2 = 0x2::balance::value<XToken<T0>>(&arg1);
        let v3 = 0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::to_u64(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::bps_round_up(0x4b591bbc246c9fadd28e7ac895e0778fb0e102f1b0d9f441e78d35f0d1ea1fcc::math::from(v2), arg0.config.protocol_fee_share_bps));
        let v4 = FeeEarnedEvent{
            coin_type    : 0x1::type_name::get<T0>(),
            market_fee   : v2 - v3,
            protocol_fee : v3,
        };
        0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::events::emit_event<FeeEarnedEvent>(v4);
        0x2::balance::join<XToken<T0>>(&mut v1.protocol_fee, 0x2::balance::split<XToken<T0>>(&mut arg1, v3));
        0x2::balance::join<XToken<T0>>(&mut v1.market_fee, arg1);
    ...
    public(friend) fun collect_staking_rewards(arg0: &mut Market, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        if (0x2::dynamic_field::exists_<SuiStakingEnabledKey>(&arg0.id, v0)) {
            let v2 = SuiStakingEnabledKey{dummy_field: false};
            0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::collect_fees(0x2::dynamic_field::borrow_mut<SuiStakingEnabledKey, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::sui_staker::SuiStaker>(&mut arg0.id, v2), arg1, arg2)
        } else {
    ...
    public(friend) fun update_fee_config(arg0: &mut Market, arg1: &MarketCap, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: &0x2::clock::Clock) {
        ...
        let v1 = &mut arg0.config;
        update_config_timestamp(v1, arg7);
        generate_market_config_update_event(arg0.market_id, &arg0.config);
    }
