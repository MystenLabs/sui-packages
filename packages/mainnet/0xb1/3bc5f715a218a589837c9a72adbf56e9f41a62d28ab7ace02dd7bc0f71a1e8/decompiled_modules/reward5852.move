module 0xb13bc5f715a218a589837c9a72adbf56e9f41a62d28ab7ace02dd7bc0f71a1e8::reward5852 {
    struct REWARD5852 has drop {
        dummy_field: bool,
    }

    struct TICKET_5852 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5852(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5852>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5852>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5852, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5852>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5852>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5852>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5852>>(v5, 0x2::tx_context::sender(arg1));
    }
