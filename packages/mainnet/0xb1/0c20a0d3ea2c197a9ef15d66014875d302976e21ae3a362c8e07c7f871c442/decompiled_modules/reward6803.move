module 0xb10c20a0d3ea2c197a9ef15d66014875d302976e21ae3a362c8e07c7f871c442::reward6803 {
    struct REWARD6803 has drop {
        dummy_field: bool,
    }

    struct TICKET_6803 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6803(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6803>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6803>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6803, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6803>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6803>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6803>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6803>>(v5, 0x2::tx_context::sender(arg1));
    }
