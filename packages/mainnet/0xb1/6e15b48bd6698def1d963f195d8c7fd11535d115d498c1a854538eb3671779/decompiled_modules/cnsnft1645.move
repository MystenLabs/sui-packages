module 0xb16e15b48bd6698def1d963f195d8c7fd11535d115d498c1a854538eb3671779::cnsnft1645 {
    struct CNSNFT1645 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1645, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=3534"));
        let v4 = 0x2::package::claim<CNSNFT1645>(arg0, arg1);
