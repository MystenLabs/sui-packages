module 0xb18430838f0bf528618d464b18a84489e4e9bb9057cca71cd5d74151cc24eb9d::cnsnft5108 {
    struct CNSNFT5108 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5108, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2134"));
        let v4 = 0x2::package::claim<CNSNFT5108>(arg0, arg1);
