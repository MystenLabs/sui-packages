module 0xb1155c57684cd3bc06feb1f5a7a14138c863ab2add185d1c8e607e33f77d865c::whitelist {
    ...
    fun init(arg0: WHITELIST, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v10, create_image_url(b"QmZTwMPgfiwrwSn42YcAdhk4ubrmV2jzZVRLY2hR6GdQbq"));
    ...
    public entry fun mint_ancient(arg0: &mut WhitelistRegistry, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = AncientWisp{
            id        : v1,
            image_url : create_image_url(b"QmZTwMPgfiwrwSn42YcAdhk4ubrmV2jzZVRLY2hR6GdQbq"),
            creator   : v0,
        };
