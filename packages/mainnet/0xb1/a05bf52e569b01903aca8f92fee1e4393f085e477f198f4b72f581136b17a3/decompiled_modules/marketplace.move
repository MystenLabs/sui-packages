module 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::marketplace {
    ...
    struct QualityMarketplace has key {
        id: 0x2::object::UID,
        treasury_cap: 0x2::coin::TreasuryCap<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>,
        reward_pool: 0x2::balance::Balance<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>,
        reward_pool_initial: u64,
        reward_pool_allocated: u64,
        liquidity_vault: 0x2::balance::Balance<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>,
        total_submissions: u64,
        total_purchases: u64,
        total_burned: u64,
        treasury_address: address,
        admin_cap_id: 0x2::object::ID,
        economic_config: 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::EconomicConfig,
    ...
    public entry fun claim_vested_tokens(arg0: &mut QualityMarketplace, arg1: &mut AudioSubmission, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg0.reward_pool, v0, arg2), arg1.uploader);
    }
    ...
    public entry fun finalize_submission(arg0: &ValidatorCap, arg1: &mut QualityMarketplace, arg2: &mut AudioSubmission, arg3: u8, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::calculate_reward(get_circulating_supply(arg1), arg3);
        let v1 = if (arg3 >= 30) {
            1
        } else {
            2
        ...
        if (v1 == 1) {
            assert!(0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg1.reward_pool) - arg1.reward_pool_allocated >= v0, 2005);
    ...
    public fun finalize_submission_from_session(arg0: &mut QualityMarketplace, arg1: &mut 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::VerificationSession, arg2: &mut 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::SessionRegistry, arg3: &mut 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::storage_lease::LeaseRegistry, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!is_circuit_breaker_active(&arg0.circuit_breaker, arg7), 5002);
        assert!(0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::is_encrypted(arg1), 3002);
        assert!(0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::is_approved(arg1), 3002);
        let v0 = 0x2::tx_context::sender(arg7);
        assert!(0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::owner(arg1) == v0, 5001);
        let v1 = 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::encrypted_cid(arg1);
        let v2 = *0x1::option::borrow<0x1::string::String>(&v1);
        let v3 = 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::preview_cid(arg1);
        let v4 = 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::seal_policy_id(arg1);
        let v5 = 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::quality_score(arg1);
        ...
        let v7 = 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::calculate_reward(get_circulating_supply(arg0), v5);
        assert!(0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg0.reward_pool) >= v7, 2002);
        ...
        let v12 = AudioSubmission{
            ...
            duration_seconds   : 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::duration_seconds(arg1),
            quality_score      : v5,
            status             : 1,
            vested_balance     : v11,
            unlocked_balance   : 0,
        ...
        0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::link_submission(arg1, v9, arg2, arg7);
        0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::storage_lease::create_lease(arg3, v9, v2, 0x1::string::utf8(b""), 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::verification_session::plaintext_size_bytes(arg1), arg5, arg7);
    ...
    public entry fun finalize_submission_with_blob(arg0: &mut QualityMarketplace, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: BlobRegistration, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: 0x1::option::Option<vector<u8>>, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg0.reward_pool) >= 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::calculate_reward(get_circulating_supply(arg0), 30), 2002);
    ...
    public fun get_circulating_supply(arg0: &QualityMarketplace) : u64 {
        let v0 = 0x2::coin::total_supply<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg0.treasury_cap);
        let v1 = 0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg0.reward_pool) + 0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg0.liquidity_vault);
        if (v0 > v1) {
            v0 - v1
        } else {
            0
    ...
    public fun get_current_burn_rate(arg0: &QualityMarketplace) : u64 {
        0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::burn_bps(get_circulating_supply(arg0), &arg0.economic_config)
    }

    public fun get_current_tier(arg0: &QualityMarketplace) : u8 {
        0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::get_tier(get_circulating_supply(arg0), &arg0.economic_config)
    }

    public fun get_marketplace_stats(arg0: &QualityMarketplace) : (u64, u64, u64, u64, u64) {
        (arg0.total_submissions, arg0.total_purchases, arg0.total_burned, 0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg0.reward_pool), 0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg0.liquidity_vault))
    }
    ...
    public fun initialize_marketplace(arg0: 0x2::coin::TreasuryCap<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>, arg1: address, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 100000000000000000;
        let v1 = 0x2::coin::mint<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg0, v0, arg3);
        let v2 = 70000000000000000;
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>>(v1, arg1);
        ...
        let v7 = QualityMarketplace{
            ...
            treasury_cap          : arg0,
            reward_pool           : 0x2::coin::into_balance<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut v1, v2, arg3)),
            reward_pool_initial   : v2,
            reward_pool_allocated : 0,
            liquidity_vault       : 0x2::balance::zero<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(),
            total_submissions     : 0,
            total_purchases       : 0,
            total_burned          : 0,
            treasury_address      : arg2,
            admin_cap_id          : 0x2::object::id<AdminCap>(&v3),
            economic_config       : 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::default_config(),
            circuit_breaker       : v5,
    ...
    public entry fun purchase_dataset(arg0: &mut QualityMarketplace, arg1: &mut AudioSubmission, arg2: 0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg2) >= v0, 3003);
        let v1 = get_circulating_supply(arg0);
        let (v2, v3, v4, v5) = 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::calculate_purchase_splits(v0, v1, &arg0.economic_config);
        if (v2 > 0) {
            0x2::balance::decrease_supply<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(0x2::coin::supply_mut<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg0.treasury_cap), 0x2::coin::into_balance<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg2, v2, arg3)));
            arg0.total_burned = arg0.total_burned + v2;
        };
        if (v3 > 0) {
            0x2::balance::join<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg0.liquidity_vault, 0x2::coin::into_balance<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(0x2::coin::split<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg2, v3, arg3)));
        };
        if (v5 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>>(0x2::coin::split<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg2, v5, arg3), arg0.treasury_address);
        };
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>>(0x2::coin::split<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg2, v4, arg3), arg1.uploader);
        };
        if (0x2::coin::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg2) > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>>(arg2, 0x2::tx_context::sender(arg3));
        } else {
            0x2::coin::destroy_zero<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(arg2);
        };
        ...
        if (v6 > 0) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg0.reward_pool, v6, arg3), arg1.uploader);
        };
        arg1.purchase_count = arg1.purchase_count + 1;
        arg0.total_purchases = arg0.total_purchases + 1;
        let v7 = 0x2::tx_context::sender(arg3);
        0x2::transfer::public_transfer<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::purchase_policy::PurchaseReceipt>(0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::purchase_policy::mint_receipt(arg1.seal_policy_id, 0x2::object::uid_to_inner(&arg1.id), v7, arg3), v7);
        let v8 = DatasetPurchased{
            submission_id       : 0x2::object::uid_to_inner(&arg1.id),
            buyer               : v7,
            price               : v0,
            burned              : v2,
            burn_rate_bps       : 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::burn_bps(v1, &arg0.economic_config),
            liquidity_allocated : v3,
            liquidity_rate_bps  : 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::liquidity_bps(v1, &arg0.economic_config),
            uploader_paid       : v4,
            uploader_rate_bps   : 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::uploader_bps(v1, &arg0.economic_config),
            treasury_paid       : v5,
            circulating_supply  : v1,
            economic_tier       : 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::get_tier(v1, &arg0.economic_config),
    ...
    public fun purchase_dataset_with_sui(arg0: &mut QualityMarketplace, arg1: &mut AudioSubmission, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::purchase_policy::PurchaseReceipt>(0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::purchase_policy::mint_receipt(arg1.seal_policy_id, 0x2::object::uid_to_inner(&arg1.id), v3, arg3), v3);
    ...
    public fun update_economic_config(arg0: &AdminCap, arg1: &mut QualityMarketplace, arg2: 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::EconomicConfig) {
        assert!(0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::validate_config(&arg2), 5001);
    ...
    public fun update_economic_config_entry(arg0: &AdminCap, arg1: &mut QualityMarketplace, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64) {
        update_economic_config(arg0, arg1, 0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::economics::create_config(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13));
    }
    ...
    public fun withdraw_liquidity_vault(arg0: &AdminCap, arg1: &mut QualityMarketplace, arg2: u64, arg3: address, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v1.total_withdrawn_this_epoch + arg2 <= 0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg1.liquidity_vault) * v1.max_per_epoch_bps / 10000, 5005);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>>(0x2::coin::take<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&mut arg1.liquidity_vault, arg2, arg5), arg3);
        ...
        let v2 = LiquidityVaultWithdrawal{
            ...
            recipient         : arg3,
            reason            : arg4,
            remaining_balance : 0x2::balance::value<0xb1a05bf52e569b01903aca8f92fee1e4393f085e477f198f4b72f581136b17a3::sonar_token::SONAR_TOKEN>(&arg1.liquidity_vault),
