module 0xb15d37fda94fd0f7bd9113ed5ad86c6ba7ddf0777abb6e0870cff8105b3bd9df::stonk {
    ...
    fun init(arg0: STONK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<STONK>(&mut v2, 999999999000000000, 0x2::tx_context::sender(arg1), arg1);
