module 0xb117bf587c9155cc7df3e19e66a7bdf436826ad84c2b6ae56a24f3194970b6c2::reward8093 {
    struct REWARD8093 has drop {
        dummy_field: bool,
    }

    struct TICKET_8093 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8093(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8093>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8093>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8093, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8093>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8093>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8093>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8093>>(v5, 0x2::tx_context::sender(arg1));
    }
