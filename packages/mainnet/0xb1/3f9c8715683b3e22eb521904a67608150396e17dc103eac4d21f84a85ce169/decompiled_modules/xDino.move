module 0xb13f9c8715683b3e22eb521904a67608150396e17dc103eac4d21f84a85ce169::xDino {
    ...
    fun init(arg0: XDINO, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<XDINO>(arg0, 6, b"SUI Poseidon", b"SUIPO", b"https://pbs.twimg.com/profile_images/1341414337634811905/-iqeQbOa_400x400.jpg", 0x1::option::none<0x2::url::Url>(), arg1);
