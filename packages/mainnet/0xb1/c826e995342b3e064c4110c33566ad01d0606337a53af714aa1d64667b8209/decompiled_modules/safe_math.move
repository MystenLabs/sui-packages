module 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
