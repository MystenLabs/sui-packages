module 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::lb_position {
    ...
    struct LBPositionInfo has store {
        ...
        reward_debt: 0x2::table::Table<u64, u64>,
    }
    ...
    public(friend) fun add_reward_debt(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u64, arg3: u64) {
        let v0 = borrow_mut_position_info(arg0, arg1);
        if (0x2::table::contains<u64, u64>(&v0.reward_debt, arg2)) {
            let v1 = 0x2::table::borrow_mut<u64, u64>(&mut v0.reward_debt, arg2);
            *v1 = 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::add_u64(*v1, arg3);
        } else {
            0x2::table::add<u64, u64>(&mut v0.reward_debt, arg2, arg3);
        };
    }
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (((0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::mul_u128(v2, 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::sub_u128(arg3, v1.fee_growth_inside_last_x)) >> 64) as u64), ((0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::mul_u128(v2, 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::sub_u128(arg4, v1.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public fun get_reward_debt(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u64) : u64 {
        let v0 = borrow_position_info(arg0, arg1);
        if (0x2::table::contains<u64, u64>(&v0.reward_debt, arg2)) {
            *0x2::table::borrow<u64, u64>(&v0.reward_debt, arg2)
        } else {
            0
        }
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 6) {
            ...
            v3 = 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::add_u64(v0, v3);
            v1 = 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }

    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: u128, arg6: u128) {
        let v0 = borrow_mut_position_info(arg0, arg2);
        if (contains_bin(v0, arg3)) {
            let v1 = borrow_bin_mut(v0, arg3);
            v1.amount = 0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::safe_math::add_u128(v1.amount, arg4);
        ...
        0xb1c826e995342b3e064c4110c33566ad01d0606337a53af714aa1d64667b8209::bin_manager::increment_total_supply(arg1, arg3, arg4);
    }
    ...
    public fun is_position_empty(arg0: &LBPositionInfo, arg1: u64) : bool {
        ...
        let v0 = 0;
        while (v0 < arg1) {
            if (0x2::table::contains<u64, u64>(&arg0.reward_debt, v0)) {
                if (*0x2::table::borrow<u64, u64>(&arg0.reward_debt, v0) > 0) {
                    return false
                };
            };
            v0 = v0 + 1;
    ...
    public(friend) fun open_position<T0, T1>(arg0: &mut LBPositionManager, arg1: 0x2::object::ID, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : LBPosition {
        ...
        let v2 = LBPositionInfo{
            ...
            reward_debt : 0x2::table::new<u64, u64>(arg3),
        };
    ...
    public(friend) fun subtract_reward_debt(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u64, arg3: u64) : u64 {
        let v0 = borrow_mut_position_info(arg0, arg1);
        if (!0x2::table::contains<u64, u64>(&v0.reward_debt, arg2)) {
            return 0
        };
