module 0x3f2d9168a6077a6de1bff9c3934941d71cb67b45a313f7ce146bd430d755b7d0::reward2558 {
    struct REWARD2558 has drop {
        dummy_field: bool,
    }

    struct TICKET_2558 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2558(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2558>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2558>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2558, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2558>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2558>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2558>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2558>>(v5, 0x2::tx_context::sender(arg1));
    }
