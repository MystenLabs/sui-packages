module 0x3f1633cd78e97d1bb44a40c487bf59cf95c480354c78700db87bea001af632c9::cnsnft4600 {
    struct CNSNFT4600 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4600>(arg0, arg1);
