module 0x3f47480993b9a65108298be85a4f55e14be75b87a91006e59016ab4b390d00f9::cnsnft9261 {
    struct CNSNFT9261 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9261, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9261>(arg0, arg1);
