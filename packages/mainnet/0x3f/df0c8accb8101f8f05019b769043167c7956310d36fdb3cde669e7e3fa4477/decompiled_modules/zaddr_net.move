module 0x3fdf0c8accb8101f8f05019b769043167c7956310d36fdb3cde669e7e3fa4477::zaddr_net {
    struct ZADDR_NET has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: ZADDR_NET, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<ZADDR_NET>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"ZADDR NET"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"2,800 faces you can see. 2,800 owners you can't. Shielded on Robinhood . Nice to not meet you"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiftamfq5adyd2eh3ig5l57m3x7626kx6rlh2ymgrxy4recx33n5da"));
