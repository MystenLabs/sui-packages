module 0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::position_store {
    ...
    struct BackstopKey has copy, drop, store {
        market_id: 0x2::object::ID,
        direction: u8,
    }

    struct BackstopInventoryChanged has copy, drop {
        market_id: 0x2::object::ID,
        direction: u8,
        delta: u64,
        new_total: u64,
    ...
    public(friend) fun add_backstop_inventory(arg0: &mut PositionStore, arg1: 0x2::object::ID, arg2: u8, arg3: u64, arg4: vector<u8>) {
        ...
        let v1 = if (0x2::dynamic_field::exists_<BackstopKey>(&arg0.id, v0)) {
            let v2 = 0x2::dynamic_field::borrow_mut<BackstopKey, u64>(&mut arg0.id, v0);
            *v2 = *v2 + arg3;
            *v2
        } else {
            0x2::dynamic_field::add<BackstopKey, u64>(&mut arg0.id, v0, arg3);
            arg3
        };
        let v3 = BackstopInventoryChanged{
            market_id : arg1,
            direction : arg2,
            delta     : arg3,
            new_total : v1,
        ...
        0x2::event::emit<BackstopInventoryChanged>(v3);
    }
    ...
    public fun admin_seed_backstop_inventory(arg0: &0xec72a10acac91bfd59d4e91529e23114c85a3e92a79505bf4c8c1c1ae6a1dc1b::admin_config::AdminCap, arg1: &mut PositionStore, arg2: 0x2::object::ID, arg3: u8, arg4: u64) {
        add_backstop_inventory(arg1, arg2, arg3, arg4, b"admin_seed");
    }
    ...
    public fun backstop_inventory(arg0: &PositionStore, arg1: 0x2::object::ID, arg2: u8) : u64 {
        let v0 = BackstopKey{
            market_id : arg1,
            direction : arg2,
        };
        if (0x2::dynamic_field::exists_<BackstopKey>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow<BackstopKey, u64>(&arg0.id, v0)
        } else {
            0
        }
    }
