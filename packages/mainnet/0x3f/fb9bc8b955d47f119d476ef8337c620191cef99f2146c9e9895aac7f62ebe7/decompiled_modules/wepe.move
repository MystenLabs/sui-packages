module 0x3ffb9bc8b955d47f119d476ef8337c620191cef99f2146c9e9895aac7f62ebe7::wepe {
    ...
    fun init(arg0: WEPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/HCUBYFfqashXe0FJ?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<WEPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"WEPE    ")))), trim_right(b"Wall Street Pepe                "), trim_right(b"Pepe of Wall Street hates that whales are hiding in insider groups. So he decided to make his own. Join the Wepe Token army - frogs strong together!                                                                                                                                                                            "), v2, arg1);
        let v5 = v3;
