module 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::vault {
    ...
    fun convert<T0>(arg0: u64, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg2: u64) : u64 {
        ...
        if (arg0 == 0) {
            0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::math::mul_div(arg2, v3, v0 + v1 - v2)
        } else {
            0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::math::mul_div(arg2, v0 + v1 - v2, v3)
        }
    }
    ...
    public entry fun deposit<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &mut 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUICONTROLLER<0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUI>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg7: 0x2::coin::Coin<T0>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::total_supply(arg3);
        let v8 = if (v7 == 0) {
            v6
        } else {
            0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::math::mul_div(v6, v7, v4)
        };
        0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::mint(arg3, v8, v1, arg9);
    ...
    fun get_price_per_full_share<T0>(arg0: &PoolInfo<T0>, arg1: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg2: &0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUICONTROLLER<0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUI>) : u64 {
        if (0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::total_supply(arg2) == 0) {
            return 1000000000
        };
        0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::math::mul_div(balance<T0>(arg0, arg1), 1000000000, 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::total_supply(arg2))
    }

    public entry fun harvest<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUICONTROLLER<0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUI>, arg3: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg4: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg5: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg6: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 1);
        ...
        if (v2 + v1 > 1000000) {
            ...
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut v3, 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::math::mul_div(v4, arg0.performance_fee, 1000), arg8), arg0.admin);
            let v5 = &mut arg1.pool_account;
    ...
    public entry fun withdraw<T0>(arg0: &GlobalConfig, arg1: &mut PoolInfo<T0>, arg2: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool::Spool, arg3: &mut 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUICONTROLLER<0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUI>, arg4: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg5: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg6: &mut 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::rewards_pool::RewardsPool<T0>, arg7: 0x2::coin::Coin<0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUI>, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg9);
        assert!(0x2::object_table::contains<address, UserRegistry<T0>>(&arg1.users, v0), 3);
        let v1 = 0x2::coin::value<0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::PSUI>(&arg7);
        assert!(v1 > 0, 5);
        harvest<T0>(arg0, arg1, arg3, arg2, arg6, arg4, arg5, arg8, arg9);
        let v2 = balance<T0>(arg1, arg5);
        let v3 = 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::total_supply(arg3);
        let v4 = 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::math::mul_div(v2, v1, v3);
        let v5 = v4;
        assert!(v4 > 0, 6);
        0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::psui::burn(arg3, arg7);
        let v6 = available<T0>(arg1);
        if (v6 < v4) {
            let v7 = v4 - v6;
            let v8 = 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::spool_account::stake_amount<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(&arg1.pool_account);
            let v9 = if (v8 >= v7) {
                v7
            } else {
                v8
            };
            0x2::balance::join<T0>(&mut arg1.total_reward_token, 0x2::coin::into_balance<T0>(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg4, arg5, 0xe87f1b2d498106a2c61421cec75b7b5c5e348512b0dc263949a0e7a3c256571a::user::unstake<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(arg2, &mut arg1.pool_account, v9, arg8, arg9), arg8, arg9)));
            let v10 = available<T0>(arg1) - v6;
            if (v10 < v9) {
                v5 = v6 + v10;
            };
        };
        let v11 = 0x2::coin::take<T0>(&mut arg1.total_reward_token, v5 - 0x3f833eb06da56f8c25233a9233a310a8b189af38be74212639e25aedcd774eaf::math::mul_div(v5, arg0.performance_fee, 1000), arg9);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v11, v0);
        let v12 = available<T0>(arg1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.total_reward_token, v12, arg9), arg0.admin);
        let v13 = WithdrawEvent{
            user                         : v0,
            psui_supply_before_withdraw  : v3,
            pool_balance_before_withdraw : v2,
            fee_amount                   : v12,
            withdraw_amount              : 0x2::coin::value<T0>(&v11),
            shares_burned                : v1,
            timestamp                    : 0x2::clock::timestamp_ms(arg8),
        };
