module 0x3f348d7ff0678dbf1daaae714308dcc8a56345a25dd68cc0351a1eab9a8a76cd::gift6642 {
    struct GIFT6642 has drop {
        dummy_field: bool,
    }

    struct TICKET_6642 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift6642(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6642>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6642>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT6642, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT6642>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6642>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6642>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6642>>(v5, 0x2::tx_context::sender(arg1));
    }
