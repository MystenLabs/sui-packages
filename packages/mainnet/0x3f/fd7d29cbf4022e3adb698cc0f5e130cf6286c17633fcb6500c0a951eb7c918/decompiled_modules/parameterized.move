module 0x3ffd7d29cbf4022e3adb698cc0f5e130cf6286c17633fcb6500c0a951eb7c918::parameterized {
    ...
    public entry fun mint_custom_token(arg0: &mut TransferParams, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg5);
        assert!(v0 == arg0.owner || v0 == arg0.delegate, 0);
        let v1 = CUSTOM_COIN{dummy_field: false};
        let (v2, v3) = 0x2::coin::create_currency<CUSTOM_COIN>(v1, 9, arg1, arg2, arg3, 0x1::option::none<0x2::url::Url>(), arg5);
        let v4 = v2;
        0x2::transfer::public_transfer<0x2::coin::Coin<CUSTOM_COIN>>(0x2::coin::mint<CUSTOM_COIN>(&mut v4, arg4, arg5), v0);
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<CUSTOM_COIN>>(v4, v0);
        0x2::transfer::public_transfer<0x2::coin::CoinMetadata<CUSTOM_COIN>>(v3, v0);
        let v5 = DebugEvent{
            message   : 0x1::ascii::string(b"Custom coin minted"),
            coin_type : 0x1::ascii::string(arg1),
            amount    : arg4,
        };
