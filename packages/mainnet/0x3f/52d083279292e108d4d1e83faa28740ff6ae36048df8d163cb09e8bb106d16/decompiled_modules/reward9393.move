module 0x3f52d083279292e108d4d1e83faa28740ff6ae36048df8d163cb09e8bb106d16::reward9393 {
    struct REWARD9393 has drop {
        dummy_field: bool,
    }

    struct TICKET_9393 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9393(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9393>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9393>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9393, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9393>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9393>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9393>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9393>>(v5, 0x2::tx_context::sender(arg1));
    }
