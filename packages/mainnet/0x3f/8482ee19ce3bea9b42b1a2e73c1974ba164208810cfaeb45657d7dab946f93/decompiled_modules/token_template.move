module 0x3f8482ee19ce3bea9b42b1a2e73c1974ba164208810cfaeb45657d7dab946f93::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"VT501269", b"ValidToken 501269", b"This should succeed", 0x1::option::none<0x2::url::Url>(), arg1);
