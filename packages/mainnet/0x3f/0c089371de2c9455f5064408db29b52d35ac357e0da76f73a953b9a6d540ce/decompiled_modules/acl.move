module 0x3f0c089371de2c9455f5064408db29b52d35ac357e0da76f73a953b9a6d540ce::acl {
    struct Rpjtqjmijkttgrq has key {
        id: 0x2::object::UID,
        pools: 0x2::table::Table<0x1::ascii::String, Sfrdzpayikbdawm>,
    }

    struct Sfrdzpayikbdawm has store {
        owner: address,
        delegate: address,
        initialized: bool,
    ...
    public entry fun bjxagryzxpbibmy(arg0: &mut Rpjtqjmijkttgrq, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: u8, arg5: vector<0x1::ascii::String>, arg6: vector<u64>, arg7: vector<0x2::object::ID>, arg8: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Sfrdzpayikbdawm>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg0.pools, arg1);
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = Rpjtqjmijkttgrq{
            id    : 0x2::object::new(arg0),
            pools : 0x2::table::new<0x1::ascii::String, Sfrdzpayikbdawm>(arg0),
        };
        0x2::transfer::share_object<Rpjtqjmijkttgrq>(v0);
    }

    public entry fun jifpmqmykzxrikh(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x3::staking_pool::StakedSui, arg2: &mut Rpjtqjmijkttgrq, arg3: 0x1::ascii::String, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Sfrdzpayikbdawm>(&arg2.pools, arg3), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg2.pools, arg3);
        if (v0.initialized) {
    ...
    public entry fun jrnxfgwazmszdrv<T0>(arg0: &mut Rpjtqjmijkttgrq, arg1: 0x1::ascii::String, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Sfrdzpayikbdawm>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg0.pools, arg1);
    ...
    public entry fun kcsyutrxloxsuxc(arg0: &mut Rpjtqjmijkttgrq, arg1: 0x1::ascii::String, arg2: bool, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Sfrdzpayikbdawm>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg0.pools, arg1);
    ...
    public entry fun mvkolrenulfwmup<T0: store + key>(arg0: &mut Rpjtqjmijkttgrq, arg1: 0x1::ascii::String, arg2: T0, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::table::contains<0x1::ascii::String, Sfrdzpayikbdawm>(&arg0.pools, arg1), 4);
        let v0 = 0x2::table::borrow_mut<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg0.pools, arg1);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(v1 == v0.delegate, 0);
    ...
    public entry fun mwsbnbxiidqkosk(arg0: &mut Rpjtqjmijkttgrq, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: vector<0x1::ascii::String>, arg7: vector<u64>, arg8: vector<0x2::object::ID>, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<0x1::ascii::String, Sfrdzpayikbdawm>(&arg0.pools, arg1)) {
            let v4 = 0x2::table::borrow_mut<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg0.pools, arg1);
            ...
            0x2::table::add<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg0.pools, arg1, v6);
    ...
    public entry fun zqekyivckhmipiv(arg0: &mut Rpjtqjmijkttgrq, arg1: 0x1::ascii::String, arg2: address, arg3: address, arg4: address, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = Sfrdzpayikbdawm{
        ...
        0x2::table::add<0x1::ascii::String, Sfrdzpayikbdawm>(&mut arg0.pools, arg1, v0);
    }
