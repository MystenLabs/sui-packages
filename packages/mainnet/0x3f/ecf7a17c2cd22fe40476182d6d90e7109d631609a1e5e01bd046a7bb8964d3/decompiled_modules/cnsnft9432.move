module 0x3fecf7a17c2cd22fe40476182d6d90e7109d631609a1e5e01bd046a7bb8964d3::cnsnft9432 {
    struct CNSNFT9432 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9432, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9432>(arg0, arg1);
