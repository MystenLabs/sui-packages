module 0x3f12f0cd4a50c6a984d19225221089d8f940ce0d0c564d69248a5aced18e88aa::faucet_coin {
    ...
    fun init(arg0: FAUCET_COIN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<FAUCET_COIN>(arg0, 2, b"$$", b"digot-dream_faucet", b"power by digot-dream", 0x1::option::none<0x2::url::Url>(), arg1);
