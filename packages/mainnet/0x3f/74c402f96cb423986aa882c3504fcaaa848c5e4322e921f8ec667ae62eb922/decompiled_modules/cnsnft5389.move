module 0x3f74c402f96cb423986aa882c3504fcaaa848c5e4322e921f8ec667ae62eb922::cnsnft5389 {
    struct CNSNFT5389 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5389, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5389>(arg0, arg1);
