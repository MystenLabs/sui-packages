module 0x3f1d4b045f016f2494d2e86e16f8e4bcba64d60189a1246acb404b584d0be8f9::voxx_whitelist_pass {
    ...
    fun init(arg0: VOXX_WHITELIST_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VOXX_WHITELIST_PASS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"VOXX Whitelist PASS"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigciu443zgmdj2qiiabey3fuva76sxxwasjxyc6ljiudn2zlt3tea"));
