module 0x3f6b3369bb7bd20a6b8c0a70c04e26646f620f99939ab7e36bbcb7bd7983d71e::game3454 {
    struct GAME3454 has drop {
        dummy_field: bool,
    }

    struct TICKET_3454 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket3454(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3454>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3454>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME3454, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME3454>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3454>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3454>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3454>>(v5, 0x2::tx_context::sender(arg1));
    }
