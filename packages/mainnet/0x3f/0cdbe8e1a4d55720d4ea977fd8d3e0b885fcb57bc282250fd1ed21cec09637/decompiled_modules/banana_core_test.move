module 0x3f0cdbe8e1a4d55720d4ea977fd8d3e0b885fcb57bc282250fd1ed21cec09637::banana_core_test {
    struct BANANA_CORE_TEST has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: BANANA_CORE_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<BANANA_CORE_TEST>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"banana core test"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"banana core test "));
