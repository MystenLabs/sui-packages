module 0x3f347f1b741427c8472a790af9773e86fc831bc031d99ffd8f2d6dffe9719fba::nft {
    ...
    public entry fun mint(arg0: &mut Global, arg1: &AdminCap, arg2: vector<u8>, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = SuihubNFT{
            ...
            thumbnail_url : 0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmQtswV3RoMJ7GQsaUxruLwGnzD1sn58gwQ2suNs2n3bYN"),
            image_url     : 0x2::url::new_unsafe_from_bytes(b"https://gateway.pinata.cloud/ipfs/QmQtswV3RoMJ7GQsaUxruLwGnzD1sn58gwQ2suNs2n3bYN"),
        };
