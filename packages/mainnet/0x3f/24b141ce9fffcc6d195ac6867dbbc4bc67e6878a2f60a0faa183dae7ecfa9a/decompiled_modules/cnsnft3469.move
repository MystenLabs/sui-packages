module 0x3f24b141ce9fffcc6d195ac6867dbbc4bc67e6878a2f60a0faa183dae7ecfa9a::cnsnft3469 {
    struct CNSNFT3469 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3469, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3469>(arg0, arg1);
