module 0x3f62d186b2946e83cfc1cc3256c5f108610d83188def4138c2c78307659ba1d2::culture {
    ...
    fun init(arg0: CULTURE, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<CULTURE>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"CULTURE"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Culture is not something you consume. It is something you create, repeat, remix, and make impossible to ignore. $CULTURE is built around one simple idea: Catch the signal early. Make it louder. Become part of the culture. Pure meme culture on Sui. "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreid3fhhjlfrrbjt5p3ablp5x6eapsfuttvfk4fkyfl5llouj2gqxxu"));
