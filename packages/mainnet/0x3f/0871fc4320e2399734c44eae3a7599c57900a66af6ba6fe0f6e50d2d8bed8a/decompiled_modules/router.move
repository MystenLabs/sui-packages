module 0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::router {
    ...
    public fun end_router_tx_r1_w1<T0, T1>(arg0: RouterSwapCapExtended<RouterDataV1, WrapperDataV1<T0>>, arg1: &mut 0x2::balance::Balance<T1>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        assert_correct_amount_out(arg0.wrapper_data.final_swap.amount, v0);
        ...
        let v8 = v4;
        let RouterDataV1 {
            expected_amount_out    : v9,
            slippage               : v10,
            protocol_fee_recipient : v11,
            integrator_fee_config  : v12,
            take_fees_on_coin_in   : v13,
        } = v1;
        let v14 = v12;
        0x2::balance::destroy_zero<T0>(v3);
        if (v0 > v9) {
            let v15 = v0 - v9;
            let v16 = 0x2::coin::take<T1>(arg1, v15, arg2);
            if (v14.recipient == @0x0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v16, v11);
            } else {
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::split<T1>(&mut v16, v15 / 2, arg2), v14.recipient);
                0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(v16, v11);
            };
        } else {
            assert!(v0 >= v9 - (((v9 as u128) * (v10 as u128) / 1000000000000000000) as u64), 5);
        };
        let v17 = if (v13) {
            v8.type
        } else {
        ...
        0xe5099fcd45747074d0ef5eabce07a9bd1c3b0c1862435bf2a09c3a81e0604373::events::emit_swap_completed_event(v8.type, v8.amount, v7.type, v7.amount, v14.recipient, v17, v14.fee_percent_base_18, 0x1::option::none<address>(), arg2);
    }
