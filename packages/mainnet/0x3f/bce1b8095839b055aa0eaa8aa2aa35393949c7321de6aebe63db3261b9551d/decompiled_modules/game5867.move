module 0x3fbce1b8095839b055aa0eaa8aa2aa35393949c7321de6aebe63db3261b9551d::game5867 {
    struct GAME5867 has drop {
        dummy_field: bool,
    }

    struct TICKET_5867 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5867(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5867>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5867>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME5867, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME5867>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5867>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5867>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5867>>(v5, 0x2::tx_context::sender(arg1));
    }
