module 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_core {
    ...
    public(friend) fun add_banker(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_role_update(3, arg1, true, arg2);
    }
    ...
    public(friend) fun add_minor(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_role_update(2, arg1, true, arg2);
    }
    ...
    public(friend) fun add_operator(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_role_update(1, arg1, true, arg2);
    }
    ...
    public(friend) fun add_reward_config<T0, T1>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : address {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_reward_config_add(pool_id<T0>(arg1), v4, 0x1::type_name::with_defining_ids<T1>(), arg3, arg2, arg4, arg6);
        v4
    }
    ...
    fun assert_borrow_market_match<T0>(arg0: &Pool<T0>, arg1: &0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::Hearn, arg2: u64) {
        assert!(arg0.hearn_addr == 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::hearn_address(arg1), 17);
    ...
    fun calc_pool_acc_reward_per_share(arg0: &RewardConfig, arg1: u128, arg2: u64) : u128 {
        ...
        arg0.acc_reward_per_share + 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::mul_div_down(checked_mul_u128(((v2 - v1) as u128), (arg0.reward_per_second as u128)), 1000000000000, arg1)
    }
    ...
    public(friend) fun claim<T0, T1>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: &mut RewardBank<T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x1::option::Option<0x2::coin::Coin<T1>> {
        ...
        store_or_delete_position_if_empty<T0>(arg0, arg1, v0, v1);
        let v7 = 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::to_u64(v5);
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_claim(pool_id<T0>(arg1), v4, v0, v7, arg4);
    ...
    public(friend) fun create_borrow_pool<T0>(arg0: &mut Farming, arg1: &0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::Hearn, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : address {
        assert_version(arg0);
        assert_minor(arg0, 0x2::tx_context::sender(arg3));
        let v0 = 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::hearn_address(arg1);
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_pool_create(v3, 0x1::type_name::with_defining_ids<T0>(), 2, arg2, v0, @0x0, arg3);
        0x2::table::add<BorrowPoolKey, address>(&mut arg0.borrow_pools, v1, v3);
        v3
    }

    public(friend) fun create_lend_pool<T0, T1>(arg0: &mut Farming, arg1: &0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::Hearn, arg2: &0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::meta_vault_core::Vault<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : address {
        assert_version(arg0);
        assert_minor(arg0, 0x2::tx_context::sender(arg3));
        let v0 = 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::hearn_address(arg1);
        let v1 = 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::meta_vault_core::vault_id<T0, T1>(arg2);
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_pool_create(v4, v2, 1, 0, v0, v1, arg3);
    ...
    public(friend) fun del_banker(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_role_update(3, arg1, false, arg2);
    }
    ...
    public(friend) fun del_minor(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_role_update(2, arg1, false, arg2);
    }
    ...
    public(friend) fun del_operator(arg0: &mut Farming, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_role_update(1, arg1, false, arg2);
    }
    ...
    public(friend) fun extract_reward_bank<T0, T1>(arg0: &Farming, arg1: &Pool<T0>, arg2: &mut RewardBank<T1>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_reward_bank_extract(pool_id<T0>(arg1), reward_bank_id<T1>(arg2), 0x1::type_name::with_defining_ids<T1>(), v0, arg4);
        0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg2.reward_reserve, v0), arg4)
    }

    public fun farming_borrow_pool_id(arg0: &Farming, arg1: &0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::Hearn, arg2: u64) : (0x1::option::Option<address>, bool) {
        let v0 = BorrowPoolKey{
            hearn_addr : 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::hearn_address(arg1),
            market_id  : arg2,
        };
    ...
    public(friend) fun fund_reward_bank<T0, T1>(arg0: &Farming, arg1: &Pool<T0>, arg2: &mut RewardBank<T1>, arg3: 0x2::coin::Coin<T1>, arg4: &0x2::tx_context::TxContext) : u64 {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_reward_bank_fund(pool_id<T0>(arg1), reward_bank_id<T1>(arg2), 0x1::type_name::with_defining_ids<T1>(), v0, arg4);
        v0
    }
    ...
    public fun get_claimable_rewards<T0>(arg0: &Pool<T0>, arg1: address, arg2: &0x2::clock::Clock) : vector<ClaimableReward> {
        ...
        while (v2 < 0x2::vec_map::length<0x1::type_name::TypeName, RewardConfig>(&arg0.reward_configs)) {
            ...
            let v5 = 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::mul_div_down(v0.boost_shares, calc_pool_acc_reward_per_share(v4, arg0.total_boost_shares, 0x2::clock::timestamp_ms(arg2) / 1000), 1000000000000);
            ...
            if (v8 > 0) {
                let v9 = ClaimableReward{
                    ...
                    amount            : 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::to_u64_saturating(v8),
                };
    ...
    public(friend) fun migrate(arg0: &mut Farming, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(arg0.version < 1, 20);
        arg0.version = 1;
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_migrate(arg0.version, arg1);
    }
    ...
    public(friend) fun pause<T0>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        arg1.is_paused = true;
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_pool_pause(pool_id<T0>(arg1), arg3);
    }
    ...
    public(friend) fun resume<T0>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_pool_resume(pool_id<T0>(arg1), arg3);
    }
    ...
    public(friend) fun set_reward_config<T0, T1>(arg0: &Farming, arg1: &mut Pool<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_reward_config_update(pool_id<T0>(arg1), v1.reward_bank_id, v0, v1.start_time, v1.reward_per_second, v1.end_time, arg6);
    }
    ...
    public(friend) fun stake<T0>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_stake(pool_id<T0>(arg1), v1, v0, arg1.total_shares, arg4);
    }
    ...
    public(friend) fun stake_adjust<T0>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: &0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::market::Hearn, arg3: u64, arg4: address, arg5: u128, arg6: bool, arg7: &0x2::clock::Clock, arg8: &0x2::tx_context::TxContext) {
        assert_version(arg0);
        if (arg5 == 0) {
            return
        };
        ...
        if (arg6) {
            0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_stake(pool_id<T0>(arg1), arg4, arg5, arg1.total_shares, arg8);
        } else {
            0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_unstake(pool_id<T0>(arg1), arg4, arg5, arg1.total_shares, arg8);
        };
    }
    ...
    public(friend) fun unstake<T0>(arg0: &mut Farming, arg1: &mut Pool<T0>, arg2: u128, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::farming_events::emit_unstake(pool_id<T0>(arg1), v0, arg2, arg1.total_shares, arg4);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg1.staked_balance, 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::to_u64(arg2)), arg4)
    }
    ...
    fun update_user_postion_debts(arg0: &mut Position, arg1: &0x2::vec_map::VecMap<0x1::type_name::TypeName, RewardConfig>) {
        ...
        while (v0 < 0x2::vec_map::length<0x1::type_name::TypeName, RewardConfig>(arg1)) {
            ...
            map_set_u128(v3, *v1, 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::mul_div_down(arg0.boost_shares, v2.acc_reward_per_share, 1000000000000));
            v0 = v0 + 1;
        };
    }
    ...
    fun update_user_postion_pending(arg0: &mut Position, arg1: &0x2::vec_map::VecMap<0x1::type_name::TypeName, RewardConfig>) {
        ...
        while (v0 < 0x2::vec_map::length<0x1::type_name::TypeName, RewardConfig>(arg1)) {
            let (v1, v2) = 0x2::vec_map::get_entry_by_idx<0x1::type_name::TypeName, RewardConfig>(arg1, v0);
            let v3 = 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::mul_div_down(arg0.boost_shares, v2.acc_reward_per_share, 1000000000000);
