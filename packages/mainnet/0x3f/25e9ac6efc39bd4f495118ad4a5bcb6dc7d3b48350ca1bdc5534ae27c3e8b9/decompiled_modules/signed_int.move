module 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::signed_int {
    ...
    public fun signed_w_div_to_zero(arg0: SignedInt, arg1: SignedInt) : SignedInt {
        SignedInt{
            value       : 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::mul_div_down(arg0.value, 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::wad(), arg1.value),
    ...
    public fun signed_w_mul_to_zero(arg0: SignedInt, arg1: SignedInt) : SignedInt {
        SignedInt{
            value       : 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::mul_div_down(arg0.value, arg1.value, 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::wad()),
            is_negative : arg0.is_negative != arg1.is_negative,
        }
    }
    ...
    public fun w_exp(arg0: SignedInt) : SignedInt {
        if (arg0.is_negative && arg0.value > 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::ln_wei()) {
            return signed_zero()
        };
        if (!arg0.is_negative && arg0.value >= 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::wexp_upper_bound()) {
            return signed_from_u128(0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::wexp_upper_value())
        };
        let v0 = if (arg0.is_negative) {
            QValue{q: (arg0.value + 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::ln_2() / 2) / 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::ln_2(), is_negative: true}
        } else {
            QValue{q: (arg0.value + 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::ln_2() / 2) / 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::ln_2(), is_negative: false}
        };
        let v1 = v0;
        let v2 = v1.q * 0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::ln_2();
        ...
        let v6 = signed_add(signed_from_u128(0x3f25e9ac6efc39bd4f495118ad4a5bcb6dc7d3b48350ca1bdc5534ae27c3e8b9::math::wad()), signed_add(v3, v5));
        if (v1.is_negative) {
            let v8 = if (v1.q > 127) {
                127
            } else {
