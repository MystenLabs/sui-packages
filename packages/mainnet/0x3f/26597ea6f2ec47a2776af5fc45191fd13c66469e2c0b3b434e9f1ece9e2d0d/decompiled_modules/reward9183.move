module 0x3f26597ea6f2ec47a2776af5fc45191fd13c66469e2c0b3b434e9f1ece9e2d0d::reward9183 {
    struct REWARD9183 has drop {
        dummy_field: bool,
    }

    struct TICKET_9183 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9183(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9183>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9183>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9183, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9183>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9183>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9183>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9183>>(v5, 0x2::tx_context::sender(arg1));
    }
