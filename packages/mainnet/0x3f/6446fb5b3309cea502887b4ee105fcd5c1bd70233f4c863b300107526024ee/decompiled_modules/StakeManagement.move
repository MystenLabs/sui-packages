module 0x3f6446fb5b3309cea502887b4ee105fcd5c1bd70233f4c863b300107526024ee::StakeManagement {
    ...
    public fun Reward<T0>(arg0: address, arg1: address, arg2: address, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<T0>(&arg3) * 5 / 1000;
        let v1 = StakeReward{
            stake_id      : arg0,
            treasury_addr : 0x2::tx_context::sender(arg4),
            lender_addr   : arg1,
            reward_amount : 0x2::coin::value<T0>(&arg3),
        };
        0x2::event::emit<StakeReward>(v1);
        let v2 = PlatformCommission{
            stake_id          : arg0,
            commission_addr   : arg2,
