module 0x3fffded4de39ac532d253ead42b37576b137ae64ff7bd18ef58f16c6cd49ea23::cnsnft8560 {
    struct CNSNFT8560 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8560, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8560>(arg0, arg1);
