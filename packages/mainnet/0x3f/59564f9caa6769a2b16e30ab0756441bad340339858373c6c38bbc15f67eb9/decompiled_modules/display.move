module 0x3f59564f9caa6769a2b16e30ab0756441bad340339858373c6c38bbc15f67eb9::display {
    ...
    public(friend) fun encode_label(arg0: &mut PackageDisplay, arg1: 0x1::string::String) {
        ...
        while (v1 < 0x1::string::length(&v0)) {
            ...
            0x1::string::append(&mut v3, new_text(0x1::string::substring(&v0, v4, v1), 38, 70 + v2 * 46, 41, arg0.text_color));
            v2 = v2 + 1;
        };
        ...
        0x1::string::append(&mut v3, new_text(v6, 38, 70 + v2 * 46, 18, arg0.text_color));
    ...
    public fun new(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String) : PackageDisplay {
        assert!(0x1::string::length(&arg0) <= 68, 1);
        PackageDisplay{
            gradient_from    : arg1,
            gradient_to      : arg2,
            text_color       : arg3,
    ...
    fun new_text(arg0: 0x1::string::String, arg1: u64, arg2: u64, arg3: u64, arg4: 0x1::string::String) : 0x1::string::String {
