module 0x3f6e8e9ef12c6b0cb396a3390a50000e75904be474be4245055a372b28f8e44b::reward8019 {
    struct REWARD8019 has drop {
        dummy_field: bool,
    }

    struct TICKET_8019 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8019(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8019>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8019>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8019, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8019>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8019>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8019>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8019>>(v5, 0x2::tx_context::sender(arg1));
    }
