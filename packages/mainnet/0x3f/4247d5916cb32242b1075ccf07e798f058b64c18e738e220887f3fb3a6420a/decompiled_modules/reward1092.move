module 0x3f4247d5916cb32242b1075ccf07e798f058b64c18e738e220887f3fb3a6420a::reward1092 {
    struct REWARD1092 has drop {
        dummy_field: bool,
    }

    struct TICKET_1092 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket1092(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_1092>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1092, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1092>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1092>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1092>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1092>>(v5, 0x2::tx_context::sender(arg1));
    }
