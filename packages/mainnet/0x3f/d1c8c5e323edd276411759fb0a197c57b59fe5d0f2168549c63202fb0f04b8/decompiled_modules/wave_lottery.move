module 0x3fd1c8c5e323edd276411759fb0a197c57b59fe5d0f2168549c63202fb0f04b8::wave_lottery {
    ...
    fun can_participate(arg0: &App, arg1: &Game, arg2: u64, arg3: &0x2::clock::Clock, arg4: u8, arg5: address) {
        ...
        if (0x2::table::contains<address, vector<Ticket>>(&arg1.participants, arg5)) {
            assert!(0x1::vector::length<Ticket>(0x2::table::borrow<address, vector<Ticket>>(&arg1.participants, arg5)) < arg0.max_buy_times, 12);
        };
    }

    entry fun change_max_buy_times(arg0: &LotteryOwnerCap, arg1: &mut App, arg2: u64) {
        arg1.max_buy_times = arg2;
    }
    ...
    entry fun complete(arg0: &App, arg1: &mut Game, arg2: &0x2::clock::Clock, arg3: vector<u8>, arg4: vector<u8>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        0x3fd1c8c5e323edd276411759fb0a197c57b59fe5d0f2168549c63202fb0f04b8::drand_lib::verify_drand_signature(arg3, arg4, arg1.round);
        ...
        arg1.status = 1;
        let v2 = 0x3fd1c8c5e323edd276411759fb0a197c57b59fe5d0f2168549c63202fb0f04b8::drand_lib::derive_randomness(arg3);
        let v3 = 0;
        while (v3 < arg1.n_winner) {
            0x1::vector::push_back<u64>(&mut arg1.lucky_numbers, 0x3fd1c8c5e323edd276411759fb0a197c57b59fe5d0f2168549c63202fb0f04b8::drand_lib::safe_selection(arg1.ticket_sold, &v2) + 1);
            v2 = 0x3fd1c8c5e323edd276411759fb0a197c57b59fe5d0f2168549c63202fb0f04b8::drand_lib::derive_randomness(v2);
            v3 = v3 + 1;
        };
        if (arg1.game_type == 0) {
    ...
    entry fun create(arg0: &LotteryOwnerCap, arg1: &mut App, arg2: u64, arg3: u64, arg4: u8, arg5: u64, arg6: u8, arg7: u64, arg8: u64, arg9: u16, arg10: u16, arg11: &0x2::clock::Clock, arg12: &mut 0x2::tx_context::TxContext) {
        assert!(arg6 < 3, 6);
        assert!(arg9 <= 1000, 14);
        assert!(arg6 != 0 || arg6 == 0 && arg10 <= arg9, 14);
        valid_round_timestamp(arg11, arg2, arg7, arg8);
        if (arg6 == 1) {
            assert!(arg5 > 0, 8);
        };
        if (arg6 == 0 || arg6 == 2) {
        ...
        let v0 = Game{
            ...
            start_at           : arg7,
            end_at             : arg8,
            participants       : 0x2::table::new<address, vector<Ticket>>(arg12),
    ...
    entry fun operator_update_game(arg0: &LotteryOwnerCap, arg1: &mut Game, arg2: u64, arg3: u8, arg4: u16, arg5: u16) {
        assert!(arg1.ticket_sold == 0, 1);
        assert!(arg4 <= 1000, 14);
        assert!(arg1.game_type != 0 || arg1.game_type == 0 && arg5 <= arg4, 14);
    ...
    entry fun operator_update_ocean_prize(arg0: &LotteryOwnerCap, arg1: &mut Game, arg2: u64, arg3: &0x2::clock::Clock) {
        ...
        assert!(0x2::clock::timestamp_ms(arg3) < arg1.end_at, 15);
        arg1.prize = arg2;
        let v0 = GameUpdated{
            id                : 0x2::object::id<Game>(arg1),
            status            : arg1.status,
    ...
    entry fun participate_nft(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg4, 2, 0x2::tx_context::sender(arg5));
        let v0 = arg1.ticket_price * arg3;
        let v1 = take_exact_amount<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>(arg2, v0, arg5);
    ...
    entry fun participate_ocean(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg4, 1, 0x2::tx_context::sender(arg5));
        let v0 = arg1.ticket_price * arg3;
        let v1 = take_exact_amount<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>(arg2, v0, arg5);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>>(v1, arg0.ocean_receiver);
        add_ticket(arg1, arg3, v0, arg5);
    ...
    entry fun participate_ocean_discount(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>, arg3: u64, arg4: &0xbe9d578ed9e0b7dbd79555fe02b8058be262f4c534adbf816cd6c4606df9ead9::ocean_nft::NFT, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg5, 1, 0x2::tx_context::sender(arg6));
        let v0 = required_amount_nft(arg1, arg3);
        let v1 = take_exact_amount<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>(arg2, v0, arg6);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xa8816d3a6e3136e86bc2873b1f94a15cadc8af2703c075f2d546c2ae367f4df9::ocean::OCEAN>>(v1, arg0.ocean_receiver);
        add_ticket(arg1, arg3, v0, arg6);
    ...
    entry fun participate_sui(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg4, 0, 0x2::tx_context::sender(arg5));
        let v0 = arg1.ticket_price * arg3;
        let v1 = take_exact_amount<0x2::sui::SUI>(arg2, v0, arg5);
    ...
    entry fun participate_sui_discount(arg0: &App, arg1: &mut Game, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &0xbe9d578ed9e0b7dbd79555fe02b8058be262f4c534adbf816cd6c4606df9ead9::ocean_nft::NFT, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        can_participate(arg0, arg1, arg3, arg5, 0, 0x2::tx_context::sender(arg6));
        let v0 = required_amount_nft(arg1, arg3);
    ...
    fun redeem_ocean(arg0: &mut App, arg1: &mut Game, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<0x2::sui::SUI>(&arg0.sui_reward) >= v1, 13);
