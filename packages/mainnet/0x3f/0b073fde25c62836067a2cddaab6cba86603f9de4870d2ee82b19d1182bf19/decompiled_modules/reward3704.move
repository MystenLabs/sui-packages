module 0x3f0b073fde25c62836067a2cddaab6cba86603f9de4870d2ee82b19d1182bf19::reward3704 {
    struct REWARD3704 has drop {
        dummy_field: bool,
    }

    struct TICKET_3704 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3704(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3704>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3704>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3704, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3704>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3704>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3704>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3704>>(v5, 0x2::tx_context::sender(arg1));
    }
