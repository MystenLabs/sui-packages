module 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::sui_swapper {
    ...
    public entry fun bluefin_flash_swap_a2b<T0, T1>(arg0: &SwapperConfig, arg1: &mut 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::VirtualPool<T0, T1>, arg2: &mut CoinVault<T0>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        assert!(0x2::tx_context::sender(arg6) == arg0.swap_op, 5);
        let (v0, v1, v2) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::flash_swap<T0, T1>(arg5, arg1, true, false, arg3, arg4, arg6);
        let v3 = v2;
        let v4 = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::get_flash_swap_pay_amount<T0, T1>(&v3);
        ...
        0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::repay_flash_swap<T0, T1>(arg1, 0x2::balance::split<T0>(&mut arg2.balance, v4), 0x2::balance::zero<T1>(), v3, arg6);
        0x2::balance::destroy_zero<T0>(v0);
        let v6 = BluefinSwapEvent{
            pool_id           : 0x2::object::id<0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::VirtualPool<T0, T1>>(arg1),
            dex_type          : 0x1::string::utf8(b"Bluefin Flash"),
            a2b               : true,
            amount_in         : v4,
            amount_out        : arg3,
            fee_amount        : 0,
            sqrt_price_before : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::get_current_sqrt_price<T0, T1>(arg1),
            sqrt_price_after  : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::get_current_sqrt_price<T0, T1>(arg1),
            operator          : 0x2::tx_context::sender(arg6),
        };
        0x2::event::emit<BluefinSwapEvent>(v6);
    }

    public entry fun bluefin_flash_swap_b2a<T0, T1>(arg0: &SwapperConfig, arg1: &mut 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::VirtualPool<T0, T1>, arg2: &mut CoinVault<T1>, arg3: u64, arg4: u128, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        assert!(0x2::tx_context::sender(arg6) == arg0.swap_op, 5);
        let (v0, v1, v2) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::flash_swap<T0, T1>(arg5, arg1, false, false, arg3, arg4, arg6);
        let v3 = v2;
        let v4 = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::get_flash_swap_pay_amount<T0, T1>(&v3);
        ...
        0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::repay_flash_swap<T0, T1>(arg1, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut arg2.balance, v4), v3, arg6);
    ...
    public entry fun bluefin_swap_exact_input<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::VirtualPool<T0, T1>, arg2: &mut CoinVault<T0>, arg3: u64, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        ...
        let v0 = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::calculate_swap_results<T0, T1>(arg1, true, true, arg3, arg5);
        assert!(0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::swap_result_amount_calculated(&v0) >= arg4, 4);
        let (v1, v2) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::swap<T0, T1>(arg6, arg1, 0x2::balance::split<T0>(&mut arg2.balance, arg3), 0x2::balance::zero<T1>(), true, true, arg3, arg4, arg5, arg7);
        let v3 = v2;
        ...
        let v5 = BluefinSwapEvent{
            ...
            fee_amount        : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::swap_result_fee_amount(&v0),
            sqrt_price_before : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::get_current_sqrt_price<T0, T1>(arg1),
            sqrt_price_after  : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::get_current_sqrt_price<T0, T1>(arg1),
    ...
    public entry fun bluefin_swap_exact_input_reverse<T0, T1>(arg0: &SwapperConfig, arg1: &mut 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::VirtualPool<T0, T1>, arg2: &mut CoinVault<T1>, arg3: u64, arg4: u64, arg5: u128, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 6);
        assert!(0x2::tx_context::sender(arg7) == arg0.swap_op, 5);
        assert!(arg3 > 0, 3);
        assert!(0x2::balance::value<T1>(&arg2.balance) >= arg3, 2);
        let v0 = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::calculate_swap_results<T0, T1>(arg1, false, true, arg3, arg5);
        assert!(0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::swap_result_amount_calculated(&v0) >= arg4, 4);
        let (v1, v2) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::swap<T0, T1>(arg6, arg1, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut arg2.balance, arg3), false, true, arg3, arg4, arg5, arg7);
        let v3 = v1;
    ...
    public fun calculate_bluefin_swap_result<T0, T1>(arg0: &0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::VirtualPool<T0, T1>, arg1: bool, arg2: bool, arg3: u64, arg4: u128) : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::VirtualSwapResult {
        0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::bluefin_virtual_dex::calculate_swap_results<T0, T1>(arg0, arg1, arg2, arg3, arg4)
    }
    ...
    public entry fun magma_swap_a_to_b<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T0>, arg2: address, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.total_volume = arg0.total_volume + arg3;
        let (v0, v1) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::magma_clmm_integration::swap_a_to_b<T0, T1>(arg2, 0x2::coin::take<T0>(&mut arg1.balance, arg3, arg5), arg3, arg4, arg5);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::magma_clmm_integration::get_magma_pool_id(arg2),
            a2b        : true,
            amount_in  : arg3,
            amount_out : 0x2::coin::value<T1>(&v3),
            fee_amount : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::magma_clmm_integration::get_fee_amount(&v2),
    ...
    public entry fun magma_swap_b_to_a<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T1>, arg2: address, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        arg0.total_volume = arg0.total_volume + arg3;
        let (v0, v1) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::magma_clmm_integration::swap_b_to_a<T0, T1>(arg2, 0x2::coin::take<T1>(&mut arg1.balance, arg3, arg5), arg3, arg4, arg5);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::magma_clmm_integration::get_magma_pool_id(arg2),
    ...
    public entry fun momentum_swap_a_to_b<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T0>, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<T0>(&arg1.balance) >= arg3, 2);
        arg0.total_volume = arg0.total_volume + arg3;
        let (v0, v1) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::momentum_v3_integration::swap_a_to_b<T0, T1>(arg2, 0x2::coin::take<T0>(&mut arg1.balance, arg3, arg6), arg3, arg4, arg5, arg6);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::momentum_v3_integration::get_momentum_pool_id(arg2),
            a2b        : true,
            amount_in  : arg3,
            amount_out : 0x2::coin::value<T1>(&v3),
            fee_amount : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::momentum_v3_integration::get_fee_amount(&v2),
            operator   : 0x2::tx_context::sender(arg6),
        };
        0x2::event::emit<SwapEvent>(v4);
    ...
    public entry fun momentum_swap_b_to_a<T0, T1>(arg0: &mut SwapperConfig, arg1: &mut CoinVault<T1>, arg2: address, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::balance::value<T1>(&arg1.balance) >= arg3, 2);
        arg0.total_volume = arg0.total_volume + arg3;
        let (v0, v1) = 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::momentum_v3_integration::swap_b_to_a<T0, T1>(arg2, 0x2::coin::take<T1>(&mut arg1.balance, arg3, arg6), arg3, arg4, arg5, arg6);
        let v2 = v1;
        let v3 = v0;
        let v4 = SwapEvent{
            pool_id    : 0x3f3ec7daae9b78a6faaadeeeb337647f9cc669a64da226aac93dadb231e18aac::momentum_v3_integration::get_momentum_pool_id(arg2),
