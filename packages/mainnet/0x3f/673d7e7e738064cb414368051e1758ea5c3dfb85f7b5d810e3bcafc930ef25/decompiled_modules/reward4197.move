module 0x3f673d7e7e738064cb414368051e1758ea5c3dfb85f7b5d810e3bcafc930ef25::reward4197 {
    struct REWARD4197 has drop {
        dummy_field: bool,
    }

    struct TICKET_4197 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4197(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4197>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4197>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4197, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4197>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4197>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4197>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4197>>(v5, 0x2::tx_context::sender(arg1));
    }
