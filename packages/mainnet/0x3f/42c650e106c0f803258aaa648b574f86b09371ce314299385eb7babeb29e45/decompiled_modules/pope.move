module 0x3f42c650e106c0f803258aaa648b574f86b09371ce314299385eb7babeb29e45::pope {
    ...
    fun init(arg0: POPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/8bylxf-cH8el4-Pn?width=150&height=150&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<POPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POPE    ")))), trim_right(b"Poker Pepe                      "), trim_right(b"Feeling lucky, punk? Meet PokerPepe, the crypto kingpin who shuffles memes and deals fortunes like its Vegas every day! With those iconic red shades and stacks of chips, PokerPepe isnt just playing the gameit is the game.                                                                                                   "), v2, arg1);
        let v5 = v3;
