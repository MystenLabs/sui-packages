module 0x123c415fc9e6e25e831c8882d1440419667f4c46b28208b33d8096eef1cff04b::yufin {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<T0>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        if (0x2::balance::supply_value<LpCoin<T0, T1>>(&arg0.lp) != 0) {
            assert!(0x2::balance::value<T0>(&arg0.coin_a) * 0x2::coin::value<T1>(&arg2) == 0x2::balance::value<T1>(&arg0.coin_b) * 0x2::coin::value<T0>(&arg1), 144);
        };
        0x2::transfer::public_transfer<0x2::coin::Coin<LpCoin<T0, T1>>>(0x2::coin::from_balance<LpCoin<T0, T1>>(0x2::balance::increase_supply<LpCoin<T0, T1>>(&mut arg0.lp, 0x1::u64::sqrt(0x2::coin::value<T0>(&arg1) * 0x2::coin::value<T1>(&arg2))), arg3), 0x2::tx_context::sender(arg3));
    ...
    public fun remove_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<LpCoin<T0, T1>>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.coin_a, 0x2::balance::value<T0>(&arg0.coin_a) * v0 / v1), arg2), 0x2::tx_context::sender(arg2));
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg0.coin_b, 0x2::balance::value<T1>(&arg0.coin_b) * v0 / v1), arg2), 0x2::tx_context::sender(arg2));
    }
