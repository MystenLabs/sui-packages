module 0x128dc0d4c52da1b944c4a35405723a8a23c308ac7b3032dbbfc4788adbf579e4::cnsnft5092 {
    struct CNSNFT5092 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5092, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5092>(arg0, arg1);
