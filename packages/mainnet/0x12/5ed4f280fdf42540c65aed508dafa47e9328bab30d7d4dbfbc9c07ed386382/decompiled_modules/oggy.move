module 0x125ed4f280fdf42540c65aed508dafa47e9328bab30d7d4dbfbc9c07ed386382::oggy {
    ...
    fun init(arg0: OGGY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<OGGY>(&mut v2, 1000000000000000, 0x2::tx_context::sender(arg1), arg1);
