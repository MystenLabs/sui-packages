module 0x12afeb0379423aacf690677dc5894aa78909d537aae6c2b0b3bacc10c648934f::reward6988 {
    struct REWARD6988 has drop {
        dummy_field: bool,
    }

    struct TICKET_6988 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6988(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6988>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6988>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6988, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6988>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6988>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6988>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6988>>(v5, 0x2::tx_context::sender(arg1));
    }
