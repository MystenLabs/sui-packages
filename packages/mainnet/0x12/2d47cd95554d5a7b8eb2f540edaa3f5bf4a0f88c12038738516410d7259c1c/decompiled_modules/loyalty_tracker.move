module 0x330aa337772418f68117556dce74034063f11a8de68f60a99acc9a5ee62f5fb3::loyalty_tracker {
    ...
    entry fun create_record(arg0: &0x2::clock::Clock, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = new_record(arg0, arg1);
        0x2::transfer::transfer<LoyaltyRecord>(v0, 0x2::tx_context::sender(arg1));
    }
