module 0x12b1abb535a8fded21c21ff33316c6ef182181727c94106f27b2fbb8896a6791::peppa {
    ...
    fun init(arg0: PEPPA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PEPPA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Peppa   ")))), trim_right(b"Peppa                           "), trim_right(b"Peppa Pigs Mummy Pig gives birth to third baby as GMB reveals first pic and piglets sweet name.                                                                                                                                                                                                                                 "), v2, arg1);
        let v5 = v3;
