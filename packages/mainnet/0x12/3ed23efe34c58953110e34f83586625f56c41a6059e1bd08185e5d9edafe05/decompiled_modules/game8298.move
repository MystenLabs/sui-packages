module 0x123ed23efe34c58953110e34f83586625f56c41a6059e1bd08185e5d9edafe05::game8298 {
    struct GAME8298 has drop {
        dummy_field: bool,
    }

    struct TICKET_8298 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket8298(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8298>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8298>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME8298, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME8298>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8298>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8298>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8298>>(v5, 0x2::tx_context::sender(arg1));
    }
