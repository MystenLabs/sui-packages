module 0x12881b4fe64849dc9fef4ac471c1305fbefc0581746b327b536f0f937ebf88ba::v {
    ...
    public fun a_add(arg0: &mut A, arg1: vector<address>, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg2) == @0x64a3f649ee39d67918271193e96d75b6b35d1094daecf4fe3ca7cc4706fab7bb, 1);
    ...
    public fun a_new(arg0: &mut 0x2::tx_context::TxContext) {
        let v0 = A{
            ...
            a  : 0x1::vector::singleton<address>(@0x64a3f649ee39d67918271193e96d75b6b35d1094daecf4fe3ca7cc4706fab7bb),
        };
