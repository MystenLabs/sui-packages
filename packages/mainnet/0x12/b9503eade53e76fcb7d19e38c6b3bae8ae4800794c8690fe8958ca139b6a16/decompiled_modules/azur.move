module 0x12b9503eade53e76fcb7d19e38c6b3bae8ae4800794c8690fe8958ca139b6a16::azur {
    ...
    fun init(arg0: AZUR, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = vector[9, 9000000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v9, 1) > 0) {
            let v10 = vector[9, 9000000000000000000, 0];
        ...
        let v13 = v12;
        let v14 = v11;
        let v15 = vector[9, 9000000000000000000, 0];
        if (*0x1::vector::borrow<u64>(&v15, 2) > 0) {
            let v16 = vector[9, 9000000000000000000, 0];
