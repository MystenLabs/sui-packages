module 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::dutch {
    ...
    struct Auction has store, key {
        ...
        bids: 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::BigVector<Bid>,
        bid_index: u64,
    }
    ...
    public fun new<T0>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: &mut 0x2::tx_context::TxContext) : Auction {
        ...
        Auction{
            ...
            bids               : 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::new<Bid>(1000, arg12),
            bid_index          : 0,
        }
    }
    ...
    public fun bids(arg0: &Auction) : &0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::BigVector<Bid> {
        &arg0.bids
    }

    public fun calculate_bid_size(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        let v0 = 10000;
        (((arg3 as u128) * (0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg1) as u128) / (((((arg2 as u128) * (((((arg0 as u128) * ((v0 - arg4) as u128) / (v0 as u128)) as u64) + v0) as u128) / (v0 as u128)) as u64) + 1) as u128)) as u64)
    }

    public fun calculate_bid_value(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64) : (u64, u64) {
        let v0 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg1);
        let v1 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::multiplier(arg2);
        let v2 = 10000;
    ...
    public fun delivery<T0>(arg0: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::BalancePool, arg1: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault, arg2: Auction, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64, u64, u64, u64, u64, u64) {
        ...
        let v22 = if (v13 < v5) {
            ...
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::borrow<Bid>(&v17, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::length<Bid>(&v17) - 1).price
        };
        let v23 = 0x2::dynamic_field::remove<vector<u8>, 0x2::balance::Balance<T0>>(&mut v18, b"bidder_balance");
        let v24 = vector[];
        let v25 = vector[];
        let v26 = 0x2::balance::zero<T0>();
        while (!0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::is_empty<Bid>(&v17)) {
            let Bid {
                index             : _,
                bidder            : _,
                price             : _,
                ...
                fee_discount      : v33,
                ts_ms             : v34,
            } = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::pop_back<Bid>(&mut v17);
        ...
        if (!0x1::vector::is_empty<u64>(&v24) || !0x1::vector::is_empty<u64>(&v25) || 0x2::balance::value<T0>(&v26) != 0) {
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::put_refunds<T0>(arg1, v26, v24, v25);
        } else {
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::put<T0>(arg0, v47);
        0x2::balance::join<T0>(&mut v23, 0x2::balance::split<T0>(&mut v46, v19));
        0x2::object::delete(v18);
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::destroy_empty<Bid>(v17);
        let v49 = Delivery{
    ...
    public fun get_user_bid_info(arg0: &Auction, arg1: u64) : (u64, address, u64, u64, u64, u64, u64, u64) {
        let v0 = 0;
        while (v0 < 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::length<Bid>(&arg0.bids)) {
            let v1 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::borrow<Bid>(&arg0.bids, v0);
            if (v1.index == arg1) {
    ...
    public fun new_bid_v2<T0>(arg0: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault, arg1: &mut Auction, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: 0x2::balance::Balance<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address) {
        abort 999
    }
    ...
    public fun old_delivery<T0>(arg0: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::BalancePool, arg1: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault, arg2: Auction, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64, u64, u64, u64, u64, u64) {
        ...
        while (!0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::is_empty<Bid>(&v17)) {
            ...
            let v42 = v28 - v40;
            if (v41 < v42) {
                0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::put_refund<T0>(arg1, 0x2::balance::split<T0>(&mut v23, v42 - v41), v25);
            };
        };
        ...
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::balance_pool::put<T0>(arg0, v44);
    ...
    public fun public_new_bid_v2<T0>(arg0: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault, arg1: &mut Auction, arg2: address, arg3: u64, arg4: vector<0x2::coin::Coin<T0>>, arg5: 0x2::balance::Balance<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address, 0x2::coin::Coin<T0>) {
        ...
        let v9 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::utils::merge_coins<T0>(arg4);
        let v10 = Bid{
            index             : v0,
            bidder            : arg2,
            price             : v1,
            ...
            fee_discount      : arg6,
            ts_ms             : 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::register_refund<T0>(arg0, arg2),
        };
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::push_back<Bid>(&mut arg1.bids, v10);
    ...
    public fun remove_bid<T0>(arg0: &mut Auction, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v2 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::length<Bid>(&arg0.bids);
        let v3 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::slice_size<Bid>(&arg0.bids);
        let v4 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::borrow_slice<Bid>(&arg0.bids, 1);
        let v5 = 0;
        while (v5 < v2) {
            ...
            if (v5 + 1 < v2 && (v5 + 1) % v3 == 0) {
                v4 = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::borrow_slice<Bid>(&arg0.bids, 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::slice_id<Bid>(&arg0.bids, v5 + 1));
            };
            v5 = v5 + 1;
        };
        if (v5 == v2) {
        ...
        let Bid {
            ...
            fee_discount      : v13,
            ts_ms             : v14,
        } = 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::remove<Bid>(&mut arg0.bids, v5);
    ...
    public fun terminate<T0>(arg0: Auction, arg1: &mut 0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::RefundVault, arg2: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.token == 0x1::type_name::get<T0>(), 4);
        let Auction {
            id                 : v0,
            index              : v1,
        ...
        while (!0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::is_empty<Bid>(&v17)) {
            ...
            0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::vault::put_refund<T0>(arg1, 0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut v18, b"bidder_balance"), v23), v20);
        };
        0x8b3ec6814a0613c96fd35931dad7f6bc380e5de89e7a66691852fe8f10b9387::big_vector::destroy_empty<Bid>(v17);
