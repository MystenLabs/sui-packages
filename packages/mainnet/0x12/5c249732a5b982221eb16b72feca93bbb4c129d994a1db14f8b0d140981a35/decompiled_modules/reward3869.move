module 0x125c249732a5b982221eb16b72feca93bbb4c129d994a1db14f8b0d140981a35::reward3869 {
    struct REWARD3869 has drop {
        dummy_field: bool,
    }

    struct TICKET_3869 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3869(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3869>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3869>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3869, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3869>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3869>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3869>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3869>>(v5, 0x2::tx_context::sender(arg1));
    }
