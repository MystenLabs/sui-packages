module 0x1239890f95391456d4cea13ee1fa7a9807b7f8d4323b9a4741a9a89223076d45::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"Suitizen", b"STZ", b"", 0x1::option::none<0x2::url::Url>(), arg1);
