module 0x27590d1d4eb13c545258a8a767ac94bf88455c0319ef944dee236cd5e00870c1::vault {
    ...
    struct ChecksumEvent has copy, drop {
        checksum: vector<u8>,
    }
    ...
    public fun test_234() : u64 {
        234
    }

    public fun test_234_2() : u64 {
        234
    }

    public fun test_check_sum<T0>(arg0: u64, arg1: u64) {
        let v0 = ChecksumEvent{checksum: get_checksum<T0>(arg0, arg1)};
        0x2::event::emit<ChecksumEvent>(v0);
    }
