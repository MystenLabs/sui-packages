module 0x12fb2f7d2e38b93412786150d7babc661ce607c35cf8d3a71b2228957b94886f::suiba_nft {
    ...
    public entry fun mint_admin(arg0: &AdminCap, arg1: &mut SuibaCollection, arg2: &0x2::transfer_policy::TransferPolicy<SuibaNFT>, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = remove_specific_id(arg1, 1);
        let v1 = create_nft(arg1, v0, arg7);
        arg1.minted = arg1.minted + 1;
        0x2::kiosk::lock<SuibaNFT>(arg3, arg4, arg2, v1);
        let v2 = NFTMinted{
            nft_id   : 0x2::object::id<SuibaNFT>(&v1),
            suiba_id : v0,
            minter   : 0x2::tx_context::sender(arg7),
        };
        0x2::event::emit<NFTMinted>(v2);
        let v3 = remove_specific_id(arg1, 2);
        let v4 = create_nft(arg1, v3, arg7);
        arg1.minted = arg1.minted + 1;
    ...
    fun remove_specific_id(arg0: &mut SuibaCollection, arg1: u64) : u64 {
