module 0x647c0752408b6adc991ee6d47ffcfaf08009e3622686c1a44ba023180e704b34::signature_withdraw {
    ...
    struct WithdrawBurnEventV1 has copy, drop {
        coin_type: vector<u8>,
        amount: u64,
        record_type: u8,
        burn_amount: u64,
    ...
    public fun withdraw_with_burn<T0>(arg0: &mut WithdrawState<T0>, arg1: u64, arg2: u64, arg3: vector<u8>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::event::emit<WithdrawBurnEventV1>(v7);
    }
