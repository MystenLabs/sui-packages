module 0x1246d8b622be4eaf746c02d9ff2b773e54e420cc127366c0559e14c944b9f0f5::spark {
    ...
    fun init(arg0: SPARK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/9U8RALvbD4WUaxmJt7Gvznofnb9XNhLp46zWMFMCpump.png?size=lg&key=b34454                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<SPARK>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Spark   ")))), trim_right(b"Spark                           "), trim_right(b"USA Pavilion mascot, Spark                                                                                                                                                                                                                                                                                                      "), v2, arg1);
        let v5 = v3;
