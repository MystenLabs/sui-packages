module 0x121bec7b98d1b6b5150d3d98a3240393e86d6391343b0f29b7a0ea98fc7c2067::reward6190 {
    struct REWARD6190 has drop {
        dummy_field: bool,
    }

    struct TICKET_6190 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6190(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6190>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6190>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6190, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6190>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6190>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6190>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6190>>(v5, 0x2::tx_context::sender(arg1));
    }
