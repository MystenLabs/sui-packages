module 0x129a2c475870717c1922d8c3942aa771b8be5bae4b7d85d1e8498f2c91e4da99::ferret {
    ...
    public fun suiswap_0<T0, T1>(arg0: &mut AccessList, arg1: &mut 0x8e2add966102a8e07c037e4943741d71048d86ce170937b95918774c74fa861e::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T0>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        assert!(is_valid(arg0, arg4), 10000000002);
        let (v0, v1) = 0x8e2add966102a8e07c037e4943741d71048d86ce170937b95918774c74fa861e::pool::do_swap_x_to_y_direct<T0, T1>(arg1, 0x1::vector::singleton<0x2::coin::Coin<T0>>(arg3), 0x2::coin::value<T0>(&arg3), arg2, arg4);
        transfer_or_destroy_zero<T0>(v0, 0x2::tx_context::sender(arg4));
        v1
    }

    public fun suiswap_1<T0, T1>(arg0: &mut AccessList, arg1: &mut 0x8e2add966102a8e07c037e4943741d71048d86ce170937b95918774c74fa861e::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: 0x2::coin::Coin<T1>, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(is_valid(arg0, arg4), 10000000002);
        let (v0, v1) = 0x8e2add966102a8e07c037e4943741d71048d86ce170937b95918774c74fa861e::pool::do_swap_y_to_x_direct<T0, T1>(arg1, 0x1::vector::singleton<0x2::coin::Coin<T1>>(arg3), 0x2::coin::value<T1>(&arg3), arg2, arg4);
