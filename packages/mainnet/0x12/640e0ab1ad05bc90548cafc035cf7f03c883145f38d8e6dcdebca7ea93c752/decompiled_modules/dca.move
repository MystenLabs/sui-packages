module 0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::dca {
    ...
    public(friend) fun apply_fee<T0>(arg0: &mut DCAReg, arg1: &mut 0x2::coin::Coin<T0>) {
        ...
        0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::event::charge_fee<T0>(v0);
    }
    ...
    public entry fun claim_fee<T0>(arg0: &mut DCAReg, arg1: &DCACap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::event::claim_fee<T0>(0x2::tx_context::sender(arg3), arg2);
    }
    ...
    public fun close_escrow<T0, T1>(arg0: &mut DCAReg, arg1: Escrow<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::event::order_closed<T0, T1>(0x2::object::uid_to_inner(&v20), v1, 0x2::coin::value<T0>(&v21), 0x2::coin::value<T1>(&v22));
        (v21, v22)
    }
    ...
    public fun execute_order<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, SwapReceipt<T0, T1>) {
        ...
        assert!(get_last_claimed_epoch<T0, T1>(arg0) <= v0, 104);
        assert!(arg0.filled_orders < total_orders<T0, T1>(arg0), 110);
        assert!(balance_x_value<T0, T1>(arg0) > 0, 112);
        assert!(0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::utils::get_sec(arg2) <= v0 * arg0.frequency + arg0.deposit_time + 30, 114);
        ...
        let v3 = SwapReceipt<T0, T1>{
            ...
            ts        : 0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::utils::get_sec(arg2),
            spent     : v1,
            amount    : v2,
        };
    ...
    public fun get_current_epoch<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0x2::clock::Clock) : u64 {
        get_epoch<T0, T1>(arg0, 0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::utils::get_sec(arg1))
    }
    ...
    public fun get_escrow_required_amount<T0, T1>(arg0: &Escrow<T0, T1>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : (u64, u64) {
        let v0 = if (arg0.price_enabled) {
            ...
            0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::utils::mul_div(get_output_y<T0, T1>(arg0, arg1, arg0.divided_amount, arg2), 10000 - 50, 10000)
        };
    ...
    public fun new_escrow<T0, T1>(arg0: Escrow<T0, T1>) {
        arg0.last_claimed = arg0.last_claimed + arg0.frequency;
        arg0.end_time = arg0.end_time + arg0.frequency;
        0x2::transfer::share_object<Escrow<T0, T1>>(arg0);
    }
    ...
    public fun place_order<T0, T1>(arg0: &mut DCAReg, arg1: address, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::coin::CoinMetadata<T0>, arg4: &0x2::coin::CoinMetadata<T1>, arg5: u64, arg6: u64, arg7: bool, arg8: u128, arg9: u128, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : Escrow<T0, T1> {
        ...
        let v6 = Escrow<T0, T1>{
            ...
            frequency              : arg5,
            divided_amount         : v1,
            last_claimed           : 0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::utils::get_sec(arg10),
            filled_orders          : 0,
            balance_x              : v2,
            ...
            min_price              : v4,
            max_price              : v5,
            deposit_time           : 0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::utils::get_sec(arg10),
            end_time               : 0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::utils::get_sec(arg10) + (arg6 - 1) * arg5,
            total_spent            : 0,
            total_withdrawn_amount : 0,
        };
        0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::event::order_created<T0, T1>(0x2::object::id<Escrow<T0, T1>>(&v6), arg1, 0x2::coin::value<T0>(&arg2), arg6, arg5, v4, v5);
        v6
    }
    ...
    public fun repay_order<T0, T1>(arg0: &mut DCAReg, arg1: &mut Escrow<T0, T1>, arg2: SwapReceipt<T0, T1>, arg3: 0x2::coin::Coin<T1>) {
        ...
        0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::event::order_executed<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg1), arg1.owner, v1, v2, v3);
    }
    ...
    public fun withdraw<T0, T1>(arg0: &mut Escrow<T0, T1>, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        0x12640e0ab1ad05bc90548cafc035cf7f03c883145f38d8e6dcdebca7ea93c752::event::order_withdrew<T0, T1>(0x2::object::id<Escrow<T0, T1>>(arg0), arg0.owner, 0x2::coin::value<T1>(&v0));
        v0
    }
