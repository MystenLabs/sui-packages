module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bucket {
    ...
    public(friend) fun update_snapshot<T0>(arg0: &mut Bucket<T0>) {
        0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::update_snapshot(&mut arg0.bottle_table, get_total_collateral_balance<T0>(arg0));
    }
    ...
    fun compute_collateral_value_to_buck(arg0: u64, arg1: u8, arg2: u64, arg3: u64) : u64 {
        if (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::buck_decimal() >= arg1) {
            0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg0, arg2, arg3) * 0x1::u64::pow(10, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::buck_decimal() - arg1)
        } else {
            0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg0, arg2, arg3) / 0x1::u64::pow(10, arg1 - 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::buck_decimal())
        }
    }
    ...
    public fun get_bottle_icr<T0>(arg0: &Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock, arg3: address) : u64 {
        ...
        if (v3 > 0) {
            0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(compute_collateral_value_to_buck(v2, arg0.collateral_decimal, v0, v1), 10000, v3)
        } else {
    ...
    public fun get_bucket_tcr<T0>(arg0: &Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : u64 {
        ...
        0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(compute_collateral_value_to_buck(get_total_collateral_balance<T0>(arg0) + arg0.total_flash_loan_amount, arg0.collateral_decimal, v1, v2), 10000, v0)
    }
    ...
    public(friend) fun handle_deposit_surplus<T0>(arg0: &mut Bucket<T0>, arg1: address, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::contains<address, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::Bottle>(v0, arg1)) {
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::record_top_up(0x2::table::borrow_mut<address, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::Bottle>(v0, arg1), 0x2::balance::value<T0>(&arg2));
        } else {
            0x2::table::add<address, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::Bottle>(v0, arg1, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::new_surplus_bottle(0x2::balance::value<T0>(&arg2), arg3));
        };
    ...
    public(friend) fun handle_transfer<T0>(arg0: &mut Bucket<T0>, arg1: address, arg2: address, arg3: &0x2::clock::Clock) {
        ...
        if (is_interest_table_exists<T0>(arg0)) {
            let v2 = 0x2::dynamic_object_field::remove<vector<u8>, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable>(&mut arg0.id, b"interest_table");
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::insert_bottle(&mut arg0.bottle_table, &v2, arg2, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::remove_bottle(&mut arg0.bottle_table, arg1), *prev_debtor<T0>(arg0, arg1), arg3);
            0x2::dynamic_object_field::add<vector<u8>, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable>(&mut arg0.id, b"interest_table", v2);
        } else {
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::insert(&mut arg0.bottle_table, arg2, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle::remove_bottle(&mut arg0.bottle_table, arg1), *prev_debtor<T0>(arg0, arg1));
        };
    }
    ...
    public fun is_in_recovery_mode<T0>(arg0: &Bucket<T0>, arg1: &0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::BucketOracle, arg2: &0x2::clock::Clock) : bool {
        let (v0, v1) = 0xf145ee6d09aae034924f80672bc76db2415dfd1b1bed863ac289af9d94e2c4fc::bucket_oracle::get_price<T0>(arg1, arg2);
        compute_collateral_value_to_buck(get_total_collateral_balance<T0>(arg0) + arg0.total_flash_loan_amount, arg0.collateral_decimal, v0, v1) <= 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(get_bucket_debt<T0>(arg0, arg2), arg0.recovery_mode_threshold, 100)
    }
