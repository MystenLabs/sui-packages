module 0x1274defcfc2c69bd998a411ab9b9b221bd7d014104865ea89443d34337e2c1dd::kiosk_swap {
    ...
    public fun execute_swap(arg0: &mut SwapProposal, arg1: &mut SwapEscrow, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &mut ProtocolConfig, arg5: &mut ProtocolTreasury, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = KioskOwnershipUpdated{
            proposal_id  : 0x2::object::id<SwapProposal>(arg0),
            kiosk_id     : 0x2::object::id<0x2::kiosk::Kiosk>(arg2),
            old_owner    : arg0.proposer,
            new_owner    : v1,
            update_order : 1,
        };
        0x2::event::emit<KioskOwnershipUpdated>(v5);
        0x2::kiosk::set_owner_custom(arg3, &v4, arg0.proposer);
        let v6 = KioskOwnershipUpdated{
            proposal_id  : 0x2::object::id<SwapProposal>(arg0),
            kiosk_id     : 0x2::object::id<0x2::kiosk::Kiosk>(arg3),
            old_owner    : v1,
            new_owner    : arg0.proposer,
            update_order : 2,
        };
        0x2::event::emit<KioskOwnershipUpdated>(v6);
        ...
        let v7 = 0x2::balance::value<0x2::sui::SUI>(&arg1.proposer_sui_balance);
        let v8 = 0x2::balance::value<0x2::sui::SUI>(&arg1.counterparty_sui_balance);
        if (v7 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.proposer_sui_balance, v7, arg7), v1);
        };
        if (v8 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::take<0x2::sui::SUI>(&mut arg1.counterparty_sui_balance, v8, arg7), arg0.proposer);
        };
        arg0.state = 3;
        let v9 = SwapExecuted{
            proposal_id             : 0x2::object::id<SwapProposal>(arg0),
            ...
            proposer_sui_amount     : v7,
            counterparty_sui_amount : v8,
