module 0x12b856cf8ca88d042fb7114ab156886bb9e75522391afbafdacf6312ce40822f::game4142 {
    struct GAME4142 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeTicket4142(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GAME4142, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME4142>(arg0, arg1);
