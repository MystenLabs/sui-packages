module 0x12e0fa1e136b87341ef984f35b72aecc31861da6dcf7fb0260fd48c27a4d6ca6::reward2018 {
    struct REWARD2018 has drop {
        dummy_field: bool,
    }

    struct TICKET_2018 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2018(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2018>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2018>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2018, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2018>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2018>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2018>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2018>>(v5, 0x2::tx_context::sender(arg1));
    }
