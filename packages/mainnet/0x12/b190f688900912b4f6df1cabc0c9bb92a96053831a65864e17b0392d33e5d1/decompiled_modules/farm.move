module 0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::farm {
    ...
    public(friend) fun add_reward<T0, T1>(arg0: &mut Farm<T0>, arg1: 0x2::balance::Balance<T1>, arg2: u64, arg3: bool, arg4: &0x2::clock::Clock) {
        ...
        assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg0.reward_types, &v0), 0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::error::invalid_reward_type());
    ...
    fun assert_farm_id<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) {
        assert!(arg1.farm_id == 0x2::object::id<Farm<T0>>(arg0), 0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::error::invalid_stake_receipt_for_farm());
    }
    ...
    public(friend) fun claim_reward<T0, T1>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        assert!(v1.is_claimable, 0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::error::reward_not_claimable());
    ...
    public(friend) fun harvest<T0>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) {
        ...
        if (0x2::balance::value<T0>(&arg0.staked_balance) == 0) {
            return
        };
        let v2 = v0 - *v1;
        ...
        while (v4 < 0x1::vector::length<0x1::type_name::TypeName>(v3)) {
            ...
            v5.cumulative_index = v5.cumulative_index + 0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::utils::mul_factor_u128((v6 as u128), 18446744073709551616, (0x2::balance::value<T0>(&arg0.staked_balance) as u128));
            v4 = v4 + 1;
        };
        *v1 = v0;
    }
    ...
    public(friend) fun harvest_for_user<T0>(arg0: &Farm<T0>, arg1: &mut StakeReceipt) {
        ...
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(v0)) {
            ...
            if (0x2::table::contains<0x1::type_name::TypeName, UserRewardInfo>(&arg1.reward_infos, v2)) {
                ...
                v4.harvested_rewards = v4.harvested_rewards + (0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::utils::mul_factor_u128((arg1.shares as u128), v3.cumulative_index - v4.cumulative_index, 18446744073709551616) as u64);
                v4.cumulative_index = v3.cumulative_index;
            } else {
                let v5 = UserRewardInfo{
                    cumulative_index  : v3.cumulative_index,
                    harvested_rewards : (0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::utils::mul_factor_u128((arg1.shares as u128), v3.cumulative_index, 18446744073709551616) as u64),
                };
    ...
    public fun simulate_current_rewards<T0>(arg0: &Farm<T0>, arg1: &StakeReceipt) : (vector<0x1::ascii::String>, vector<u64>) {
        ...
        while (v3 < 0x1::vector::length<0x1::type_name::TypeName>(v0)) {
            ...
            if (0x2::table::contains<0x1::type_name::TypeName, UserRewardInfo>(&arg1.reward_infos, v4)) {
                ...
                0x1::vector::push_back<u64>(&mut v2, v6.harvested_rewards + (0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::utils::mul_factor_u128((arg1.shares as u128), v5.cumulative_index - v6.cumulative_index, 18446744073709551616) as u64));
            } else {
                0x1::vector::push_back<u64>(&mut v2, (0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::utils::mul_factor_u128((arg1.shares as u128), v5.cumulative_index, 18446744073709551616) as u64));
            };
            v3 = v3 + 1;
        };
        (v1, v2)
    ...
    public(friend) fun unstake<T0>(arg0: &mut Farm<T0>, arg1: &mut StakeReceipt, arg2: u64, arg3: &0x2::clock::Clock) : 0x2::balance::Balance<T0> {
        ...
        harvest<T0>(arg0, arg3);
        harvest_for_user<T0>(arg0, arg1);
        assert!(arg2 <= arg1.shares, 0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::error::unstake_amount_too_much());
    ...
    public(friend) fun withdraw_unharvested<T0, T1>(arg0: &mut Farm<T0>, arg1: &0x2::clock::Clock) : 0x2::balance::Balance<T1> {
        ...
        assert!(v1.harvested_rewards < v3, 0x12b190f688900912b4f6df1cabc0c9bb92a96053831a65864e17b0392d33e5d1::error::no_unharvested_rewards());
