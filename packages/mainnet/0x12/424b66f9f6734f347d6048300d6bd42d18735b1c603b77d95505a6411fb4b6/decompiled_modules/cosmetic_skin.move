module 0x12424b66f9f6734f347d6048300d6bd42d18735b1c603b77d95505a6411fb4b6::cosmetic_skin {
    ...
    fun init(arg0: COSMETIC_SKIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v12 = &mut v11;
        0x1::vector::push_back<address>(v12, @0x1);
        0x1::vector::push_back<address>(v12, @0x2);
