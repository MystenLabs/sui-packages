module 0x12bc564f55674f8b150058397b9ad40a8954b90ef5ccf509c8577404f925ae57::miracle {
    ...
    public fun create(arg0: u64, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : Miracle {
        assert!(arg0 > 0, 0x12bc564f55674f8b150058397b9ad40a8954b90ef5ccf509c8577404f925ae57::errors::E_BAD_SPLIT());
        Miracle{
    ...
    public fun get_drought_tests(arg0: &Miracle) : u64 {
        arg0.drought_tests
    }

    public fun maybe_trigger(arg0: &mut Miracle, arg1: u64) : (bool, u64) {
        let v0 = arg0.current_odds;
        assert!(v0 > 0, 0x12bc564f55674f8b150058397b9ad40a8954b90ef5ccf509c8577404f925ae57::errors::E_BAD_SPLIT());
        if (arg1 % v0 == 0) {
    ...
    public fun set_params(arg0: &mut Miracle, arg1: u64, arg2: u64) {
        assert!(arg1 > 0, 0x12bc564f55674f8b150058397b9ad40a8954b90ef5ccf509c8577404f925ae57::errors::E_BAD_SPLIT());
        arg0.base_odds = arg1;
