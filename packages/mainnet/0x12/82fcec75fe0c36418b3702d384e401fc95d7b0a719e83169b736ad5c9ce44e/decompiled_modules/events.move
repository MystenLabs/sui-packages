module 0x1282fcec75fe0c36418b3702d384e401fc95d7b0a719e83169b736ad5c9ce44e::events {
    ...
    public(friend) fun emit_decrement_balance(arg0: 0x1::type_name::TypeName, arg1: u64, arg2: address, arg3: u8, arg4: vector<u8>, arg5: u256, arg6: u256, arg7: vector<u8>, arg8: vector<u8>, arg9: 0x2::object::ID, arg10: address, arg11: address) {
    ...
    public(friend) fun emit_increment_balance(arg0: 0x1::type_name::TypeName, arg1: vector<u8>, arg2: u64, arg3: address, arg4: u8, arg5: vector<u8>, arg6: u256, arg7: u256, arg8: address, arg9: address) {
    ...
    public(friend) fun emit_presign_added(arg0: 0x1::type_name::TypeName, arg1: address, arg2: address, arg3: u64) {
        let v0 = PresignAdded{
            app                    : arg0,
            dwallet                : arg1,
            dwallet_cap            : arg2,
            current_presign_length : arg3,
        };
