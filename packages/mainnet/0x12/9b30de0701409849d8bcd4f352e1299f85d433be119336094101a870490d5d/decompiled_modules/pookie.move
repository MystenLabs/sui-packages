module 0x129b30de0701409849d8bcd4f352e1299f85d433be119336094101a870490d5d::pookie {
    ...
    fun init(arg0: POOKIE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"EcH6l86j28V9hHTV                                                                                                                                                                                                                                                                                                                ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<POOKIE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"POOKIE      ")))), trim_right(b"POOKIE                          "), trim_right(b"Pookie is more than just a coinit's a community, a vision, and the key to financial freedom for those who truly believe.                                                                                                                                                                                                        "), v2, arg1);
