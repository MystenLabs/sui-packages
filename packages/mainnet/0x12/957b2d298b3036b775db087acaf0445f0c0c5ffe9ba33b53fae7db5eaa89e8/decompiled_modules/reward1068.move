module 0x12957b2d298b3036b775db087acaf0445f0c0c5ffe9ba33b53fae7db5eaa89e8::reward1068 {
    struct REWARD1068 has drop {
        dummy_field: bool,
    }

    struct TICKET_1068 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1068(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1068>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1068>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1068, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1068>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1068>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1068>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1068>>(v5, 0x2::tx_context::sender(arg1));
    }
