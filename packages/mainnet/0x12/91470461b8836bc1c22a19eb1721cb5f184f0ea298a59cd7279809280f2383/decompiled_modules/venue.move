module 0x1291470461b8836bc1c22a19eb1721cb5f184f0ea298a59cd7279809280f2383::venue {
    struct Venue<phantom T0> has store, key {
        ...
        whitelist: 0x1291470461b8836bc1c22a19eb1721cb5f184f0ea298a59cd7279809280f2383::market_whitelist::Whitelist,
    }
    ...
    public(friend) fun new<T0>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : Venue<T0> {
        ...
        Venue<T0>{
            ...
            whitelist           : 0x1291470461b8836bc1c22a19eb1721cb5f184f0ea298a59cd7279809280f2383::market_whitelist::new(arg6),
        }
    }
    ...
    public(friend) fun borrow_whitelist_mut<T0>(arg0: &mut Venue<T0>) : &mut 0x1291470461b8836bc1c22a19eb1721cb5f184f0ea298a59cd7279809280f2383::market_whitelist::Whitelist {
        &mut arg0.whitelist
    }
    ...
    public fun is_allowed<T0>(arg0: &Venue<T0>, arg1: address) : bool {
        0x1291470461b8836bc1c22a19eb1721cb5f184f0ea298a59cd7279809280f2383::market_whitelist::is_empty(&arg0.whitelist) || 0x1291470461b8836bc1c22a19eb1721cb5f184f0ea298a59cd7279809280f2383::market_whitelist::is_whitelisted(&arg0.whitelist, arg1)
    }
