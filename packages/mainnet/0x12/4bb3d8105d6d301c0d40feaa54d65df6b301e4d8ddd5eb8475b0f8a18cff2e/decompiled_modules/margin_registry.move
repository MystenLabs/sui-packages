module 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_registry {
    ...
    struct CurrentPriceKey has copy, drop, store {
        pool_id: 0x2::object::ID,
    }

    struct CurrentPriceData has store {
        price: u64,
    ...
    struct MaxOrderTtlKey has copy, drop, store {
        pos0: 0x2::object::ID,
    }
    ...
    struct CurrentPriceUpdated has copy, drop {
        pool_id: 0x2::object::ID,
        price: u64,
        timestamp: u64,
    }

    struct PriceToleranceUpdated has copy, drop {
        pool_id: 0x2::object::ID,
        tolerance: u64,
        timestamp: u64,
    }

    struct MaxPriceAgeUpdated has copy, drop {
        pool_id: 0x2::object::ID,
        max_age_ms: u64,
        timestamp: u64,
    }

    struct MaxOrderTtlUpdated has copy, drop {
        pool_id: 0x2::object::ID,
    ...
    public(friend) fun add_margin_manager(arg0: &mut MarginRegistry, arg1: 0x2::object::ID, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(0x2::vec_set::length<0x2::object::ID>(v2) <= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::max_margin_managers(), 13);
    }
    ...
    public(friend) fun assert_price(arg0: &MarginRegistry, arg1: 0x2::object::ID, arg2: u64, arg3: bool, arg4: &0x2::clock::Clock) {
        let (v0, v1) = get_price_bounds(arg0, arg1, arg4);
        if (arg3) {
            assert!(arg2 <= v1, 16);
        } else {
            assert!(arg2 >= v0, 16);
    ...
    fun calculate_risk_ratios(arg0: u64) : RiskRatios {
        RiskRatios{
            min_withdraw_risk_ratio       : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + 4 * arg0,
            min_borrow_risk_ratio         : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + arg0,
            liquidation_risk_ratio        : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + arg0 / 2,
            target_liquidation_risk_ratio : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + arg0,
        }
    }
    ...
    public(friend) fun clamp_expire_timestamp(arg0: &MarginRegistry, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        let v0 = 0x2::clock::timestamp_ms(arg3) + max_order_ttl_ms(arg0, arg1);
        if (arg2 > v0) {
            v0
        } else {
            arg2
    ...
    public fun disable_deepbook_pool<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
    ...
    public fun enable_deepbook_pool<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
        assert!(0x2::table::contains<0x2::object::ID, PoolConfig>(&v0.pool_registry, v1), 3);
        let v2 = 0x2::table::borrow_mut<0x2::object::ID, PoolConfig>(&mut v0.pool_registry, v1);
    ...
    public(friend) fun get_price_bounds(arg0: &MarginRegistry, arg1: 0x2::object::ID, arg2: &0x2::clock::Clock) : (u64, u64) {
        load_inner(arg0);
        let v0 = CurrentPriceKey{pool_id: arg1};
        assert!(0x2::dynamic_field::exists_with_type<CurrentPriceKey, CurrentPriceData>(&arg0.id, v0), 18);
        let v1 = 0x2::dynamic_field::borrow<CurrentPriceKey, CurrentPriceData>(&arg0.id, v0);
        let v2 = v1.price;
        assert!(0x2::clock::timestamp_ms(arg2) - v1.last_price_update_ms <= v1.max_price_age_ms, 17);
        let v3 = v1.tolerance;
        (0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v2, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() - v3), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v2, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + v3))
    }
    ...
    fun init(arg0: MARGIN_REGISTRY, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = MarginRegistryInner{
            ...
            allowed_versions    : 0x2::vec_set::singleton<u64>(0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::margin_version()),
        ...
        let v2 = MarginRegistry{
            id    : v0,
            inner : 0x2::versioned::create<MarginRegistryInner>(0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::margin_version(), v1, arg1),
        };
    ...
    public(friend) fun load_inner(arg0: &MarginRegistry) : &MarginRegistryInner {
        ...
        let v1 = 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::margin_version();
    ...
    public(friend) fun max_order_ttl_ms(arg0: &MarginRegistry, arg1: 0x2::object::ID) : u64 {
        let v0 = MaxOrderTtlKey{pos0: arg1};
        if (0x2::dynamic_field::exists_with_type<MaxOrderTtlKey, u64>(&arg0.id, v0)) {
            *0x2::dynamic_field::borrow<MaxOrderTtlKey, u64>(&arg0.id, v0)
        } else {
            0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_max_order_ttl_ms()
        }
    }
    ...
    public fun new_pool_config<T0, T1>(arg0: &MarginRegistry, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64) : PoolConfig {
        ...
        assert!(arg3 < arg2, 1);
        assert!(arg3 < arg4, 1);
        assert!(arg3 >= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 1);
        assert!(arg5 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 1);
        assert!(arg6 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 1);
        assert!(arg5 + arg6 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 1);
        assert!(arg4 > 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + arg5 + arg6, 1);
        let v0 = RiskRatios{
    ...
    public fun new_pool_config_with_leverage<T0, T1>(arg0: &MarginRegistry, arg1: u64) : PoolConfig {
        load_inner(arg0);
        assert!(arg1 > 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::min_leverage(), 1);
        assert!(arg1 <= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::max_leverage(), 1);
        let v0 = calculate_risk_ratios(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::div(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), arg1 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling()));
        new_pool_config<T0, T1>(arg0, v0.min_withdraw_risk_ratio, v0.min_borrow_risk_ratio, v0.liquidation_risk_ratio, v0.target_liquidation_risk_ratio, 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_user_liquidation_reward(), 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_pool_liquidation_reward())
    }
    ...
    public fun pool_enabled<T0, T1>(arg0: &MarginRegistry, arg1: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>) : bool {
        let v0 = load_inner(arg0);
        let v1 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg1);
    ...
    public fun register_deepbook_pool<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: PoolConfig, arg4: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
    ...
    public fun set_max_order_ttl<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock) {
        load_inner(arg0);
        assert!(arg3 >= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::min_max_order_ttl_ms(), 23);
        assert!(arg3 <= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::max_max_order_ttl_ms(), 23);
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
        let v1 = MaxOrderTtlKey{pos0: v0};
        if (0x2::dynamic_field::exists_with_type<MaxOrderTtlKey, u64>(&arg0.id, v1)) {
            *0x2::dynamic_field::borrow_mut<MaxOrderTtlKey, u64>(&mut arg0.id, v1) = arg3;
        } else {
            0x2::dynamic_field::add<MaxOrderTtlKey, u64>(&mut arg0.id, v1, arg3);
        };
        let v2 = MaxOrderTtlUpdated{
            pool_id          : v0,
            max_order_ttl_ms : arg3,
            timestamp        : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<MaxOrderTtlUpdated>(v2);
    }

    public fun set_max_price_age<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg3 >= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::min_price_age_ms(), 21);
        assert!(arg3 <= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::max_price_age_ms(), 22);
        load_inner(arg0);
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
        let v1 = CurrentPriceKey{pool_id: v0};
        assert!(0x2::dynamic_field::exists_with_type<CurrentPriceKey, CurrentPriceData>(&arg0.id, v1), 18);
        0x2::dynamic_field::borrow_mut<CurrentPriceKey, CurrentPriceData>(&mut arg0.id, v1).max_price_age_ms = arg3;
        let v2 = MaxPriceAgeUpdated{
            pool_id    : v0,
            max_age_ms : arg3,
            timestamp  : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<MaxPriceAgeUpdated>(v2);
    }

    public fun set_price_tolerance<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg3 >= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::min_price_tolerance(), 19);
        assert!(arg3 <= 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::max_price_tolerance(), 20);
        load_inner(arg0);
        let v0 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
        let v1 = CurrentPriceKey{pool_id: v0};
        assert!(0x2::dynamic_field::exists_with_type<CurrentPriceKey, CurrentPriceData>(&arg0.id, v1), 18);
        0x2::dynamic_field::borrow_mut<CurrentPriceKey, CurrentPriceData>(&mut arg0.id, v1).tolerance = arg3;
        let v2 = PriceToleranceUpdated{
            pool_id   : v0,
            tolerance : arg3,
            timestamp : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<PriceToleranceUpdated>(v2);
    }
    ...
    public(friend) fun update_current_price(arg0: &mut MarginRegistry, arg1: 0x2::object::ID, arg2: u64, arg3: &0x2::clock::Clock) {
        load_inner(arg0);
        let v0 = CurrentPriceKey{pool_id: arg1};
        let v1 = 0x2::clock::timestamp_ms(arg3);
        if (!0x2::dynamic_field::exists_with_type<CurrentPriceKey, CurrentPriceData>(&arg0.id, v0)) {
            let v2 = CurrentPriceData{
                price                : arg2,
                last_price_update_ms : v1,
                tolerance            : 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_price_tolerance(),
                max_price_age_ms     : 0x97d9473771b01f77b0940c589484184b49f6444627ec121314fae6a6d36fb86b::margin_constants::default_max_price_age_ms(),
            };
            0x2::dynamic_field::add<CurrentPriceKey, CurrentPriceData>(&mut arg0.id, v0, v2);
        };
        let v3 = 0x2::dynamic_field::borrow_mut<CurrentPriceKey, CurrentPriceData>(&mut arg0.id, v0);
        v3.price = arg2;
        v3.last_price_update_ms = v1;
        let v4 = CurrentPriceUpdated{
            pool_id   : arg1,
            price     : arg2,
            timestamp : v1,
        };
        0x2::event::emit<CurrentPriceUpdated>(v4);
    }

    public fun update_risk_params<T0, T1>(arg0: &mut MarginRegistry, arg1: &MarginAdminCap, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: PoolConfig, arg4: &0x2::clock::Clock) {
        let v0 = load_inner_mut(arg0);
        let v1 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::id<T0, T1>(arg2);
        assert!(0x2::table::contains<0x2::object::ID, PoolConfig>(&v0.pool_registry, v1), 3);
        ...
        assert!(arg3.risk_ratios.liquidation_risk_ratio >= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling(), 1);
        0x2::table::add<0x2::object::ID, PoolConfig>(&mut v0.pool_registry, v1, arg3);
