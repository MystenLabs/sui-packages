module 0x12c83c6c655fab0547a09cbe51351dc7115a621b321cca2a72d1a70854938e00::global_config {
    ...
    struct SponsorFeeRecord has store, key {
        id: 0x2::object::UID,
        sponsor_fee_records: 0x2::table::Table<0x1::string::String, u64>,
    ...
    public(friend) fun add_sponsor_record(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) {
        let v0 = user_sponsor_key(arg2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, SponsorFeeRecord>(&mut arg0.id, 0x1::string::utf8(b"sponsor_fee_record"));
        if (!0x2::table::contains<address, bool>(&v1.whitelist, 0x2::tx_context::sender(arg2))) {
            assert!(arg1 <= v1.epoch_sponsor_fee_limit, 3);
        };
        if (!0x2::table::contains<0x1::string::String, u64>(&v1.sponsor_fee_records, v0)) {
            0x2::table::add<0x1::string::String, u64>(&mut v1.sponsor_fee_records, v0, arg1);
        } else {
            let v2 = 0x2::table::borrow_mut<0x1::string::String, u64>(&mut v1.sponsor_fee_records, v0);
            if (!0x2::table::contains<address, bool>(&v1.whitelist, 0x2::tx_context::sender(arg2))) {
                assert!(*v2 + arg1 <= v1.epoch_sponsor_fee_limit, 3);
            };
            *v2 = *v2 + arg1;
        };
    }

    public(friend) fun add_sponsor_record_v2(arg0: &mut GlobalConfig, arg1: u64, arg2: &0x2::tx_context::TxContext) : bool {
        let v0 = user_sponsor_key(arg2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x1::string::String, SponsorFeeRecord>(&mut arg0.id, 0x1::string::utf8(b"sponsor_fee_record"));
        if (!0x2::table::contains<address, bool>(&v1.whitelist, 0x2::tx_context::sender(arg2))) {
            if (arg1 > v1.epoch_sponsor_fee_limit) {
                return false
            };
        };
        if (!0x2::table::contains<0x1::string::String, u64>(&v1.sponsor_fee_records, v0)) {
            ...
            let v2 = 0x2::table::borrow_mut<0x1::string::String, u64>(&mut v1.sponsor_fee_records, v0);
            if (!0x2::table::contains<address, bool>(&v1.whitelist, 0x2::tx_context::sender(arg2))) {
                if (*v2 + arg1 > v1.epoch_sponsor_fee_limit) {
                    return false
                };
            };
            *v2 = *v2 + arg1;
    ...
    public(friend) fun alternative_payment_deep(arg0: &mut GlobalConfig, arg1: 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP> {
        ...
        let v0 = add_sponsor_record_v2(arg0, arg2, arg3);
        if (!v0 || 0x2::balance::value<0xdeeb7a4662eec9f2f3def03fb937a663dddaa2e215b8078a284d026b7946c270::deep::DEEP>(&arg0.deep_fee_vault) < arg2) {
            return arg1
        };
    ...
    public entry fun init_sponsor_fee_record(arg0: &mut GlobalConfig, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = SponsorFeeRecord{
            id                      : 0x2::object::new(arg1),
            sponsor_fee_records     : 0x2::table::new<0x1::string::String, u64>(arg1),
    ...
    fun user_sponsor_key(arg0: &0x2::tx_context::TxContext) : 0x1::string::String {
        let v0 = 0x2::address::to_string(0x2::tx_context::sender(arg0));
        0x1::string::append_utf8(&mut v0, b"-");
        0x1::string::append(&mut v0, u64_to_str(0x2::tx_context::epoch(arg0)));
        v0
    }
