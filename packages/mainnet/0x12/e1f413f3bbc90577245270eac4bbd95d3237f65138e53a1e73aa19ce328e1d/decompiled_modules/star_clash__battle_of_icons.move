module 0x12e1f413f3bbc90577245270eac4bbd95d3237f65138e53a1e73aa19ce328e1d::star_clash__battle_of_icons {
    struct STAR_CLASH__BATTLE_OF_ICONS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: STAR_CLASH__BATTLE_OF_ICONS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<STAR_CLASH__BATTLE_OF_ICONS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Star Clash: Battle of Icons"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Star Clash: Battle of Icons is an epic NFT game where the greatest personalities of humanity transform into legendary fighters! Collect exclusive digital collections featuring three iconic types of characters: artists, singers, and politicians. Each hero boasts unique abilities and a distinct fighting style, making every battle a true test of strategy and skill. Your collection is your path to glory!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiay2nvmqu24kytqb7zwt6npinose6mlf2fxo7ufcavqxkzqqgxmkq"));
