module 0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::tvl {
    ...
    public fun guard_reroute_trustless(arg0: &TvlRegistry, arg1: u8, arg2: u64, arg3: address, arg4: &0x2::clock::Clock) {
        ...
        0xb15e15f9541a3eb12989d950a319e037c71e3d422065221687372e7c36c70897::floors::assert_min_tvl(arg2);
    ...
    public fun push_capacity_from_enclave(arg0: &mut TvlRegistry, arg1: &0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::crank::CrankConfig, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock) {
        assert!(0x2::ed25519::ed25519_verify(&arg3, 0x1222e054f9dff4d12dabbfd3b61103e5439ea56d390f49d813b163c20ebddd9a::crank::tee_public_key(arg1), &arg2), 805);
