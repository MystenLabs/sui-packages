module 0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::wait {
    ...
    public fun borrow_contribution(arg0: &WaitCard) : &0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::WarlotData {
        0x2::dynamic_field::borrow<vector<u8>, 0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::WarlotData>(&arg0.id, b"WARLOT CONTRIBUTIONS")
    }

    public fun borrow_contribution_mut(arg0: &mut AdminCap, arg1: &mut WaitCard) : &mut 0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::WarlotData {
        0x2::dynamic_field::borrow_mut<vector<u8>, 0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::WarlotData>(&mut arg1.id, b"WARLOT CONTRIBUTIONS")
    }
    ...
    fun destroy_dfield(arg0: &mut 0x2::object::UID) {
        ...
        if (v0 == true) {
            0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::destroy(0x2::dynamic_field::remove<vector<u8>, 0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::WarlotData>(arg0, b"WARLOT CONTRIBUTIONS"));
        };
    }
    ...
    fun mint(arg0: &CloneWaitCard<WAIT>, arg1: &mut 0x2::tx_context::TxContext) : WaitCard {
        ...
        0x2::dynamic_field::add<vector<u8>, 0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::WarlotData>(&mut v1.id, b"WARLOT CONTRIBUTIONS", 0x12a335d4e49693f86ae95a24ea4273538514b0ca5caf597a98cc0aa689d81b98::contribution::create());
        v1
    }
