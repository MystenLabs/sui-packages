module 0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::fee_dispatcher {
    ...
    struct FeeDispatcher<phantom T0> has store, key {
        id: 0x2::object::UID,
        queue: 0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::queue::FifoQueue<DispatcherRecord<T0>>,
    }
    ...
    public fun new<T0>(arg0: &0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::admin::AdminCap, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = FeeDispatcher<T0>{
            id    : v0,
            queue : 0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::queue::new<DispatcherRecord<T0>>(100, arg1),
        };
    ...
    public(friend) fun add_record<T0>(arg0: &mut FeeDispatcher<T0>, arg1: address, arg2: u64, arg3: address, arg4: 0x2::balance::Balance<T0>) {
        ...
        0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::queue::insert<DispatcherRecord<T0>>(&mut arg0.queue, v0);
    }
    ...
    public entry fun dispatch<T0>(arg0: &mut FeeDispatcher<T0>, arg1: &0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::asset_registry::AssetRegistry, arg2: &mut 0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::balances_registry::BalancesRegistry, arg3: &mut 0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::vault::Vault<T0>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1269ebf4edc63a9d4df8469bfd386938f4d71543734ae0cf0398630461085f02::queue::consume<DispatcherRecord<T0>>(&mut arg0.queue);
