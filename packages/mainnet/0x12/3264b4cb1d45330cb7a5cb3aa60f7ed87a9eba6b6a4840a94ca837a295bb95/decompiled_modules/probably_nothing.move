module 0x123264b4cb1d45330cb7a5cb3aa60f7ed87a9eba6b6a4840a94ca837a295bb95::probably_nothing {
    ...
    fun init(arg0: PROBABLY_NOTHING, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreig63ta7bg3lepxa726m3thnglz3r5wzrssfs7cibdqo7f3frbpo7q"));
