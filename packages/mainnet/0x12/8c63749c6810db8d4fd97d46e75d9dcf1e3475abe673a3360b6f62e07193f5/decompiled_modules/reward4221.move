module 0x128c63749c6810db8d4fd97d46e75d9dcf1e3475abe673a3360b6f62e07193f5::reward4221 {
    struct REWARD4221 has drop {
        dummy_field: bool,
    }

    struct TICKET_4221 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4221(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4221>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4221>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4221, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4221>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4221>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4221>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4221>>(v5, 0x2::tx_context::sender(arg1));
    }
