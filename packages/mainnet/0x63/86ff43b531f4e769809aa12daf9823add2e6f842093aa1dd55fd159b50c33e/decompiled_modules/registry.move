module 0x6386ff43b531f4e769809aa12daf9823add2e6f842093aa1dd55fd159b50c33e::registry {
    ...
    public entry fun new_name1_asset<T0: key>(arg0: &mut 0x2::coin_registry::CoinRegistry, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun new_name2_asset<T0: key>(arg0: &mut 0x2::coin_registry::CoinRegistry, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun new_name3_asset<T0: key>(arg0: &mut 0x2::coin_registry::CoinRegistry, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun new_name4_asset<T0: key>(arg0: &mut 0x2::coin_registry::CoinRegistry, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun regiater<T0: drop>(arg0: &mut 0x2::coin_registry::CoinRegistry, arg1: 0x2::transfer::Receiving<0x2::coin_registry::Currency<T0>>, arg2: &mut 0x2::tx_context::TxContext) {
