module 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::staking {
    ...
    public fun claim_coin_v2(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Staking, arg2: UnstakeTicket, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<0x2::sui::SUI> {
        ...
        update_total_rewards_onchain(arg1, arg0, arg3);
        ...
        let v9 = v7;
        let v10 = withdraw(arg0, arg1, v8, arg3);
    ...
    public(friend) fun collect_rewards_fee_v2(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Staking, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        let v3 = withdraw(arg0, arg1, v1, arg3);
    ...
    fun do_validator_unstake(arg0: &mut Staking, arg1: &mut 0x3::sui_system::SuiSystemState, arg2: &mut 0x2::balance::Balance<0x2::sui::SUI>, arg3: address, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        while (arg4 > 0 && 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::length<0x3::staking_pool::StakedSui>(&v1.staked_suis) > 0) {
            ...
            let v4 = if (v2 > 0) {
                let v5 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::borrow_front_mut<0x3::staking_pool::StakedSui>(&mut v1.staked_suis);
                calculate_staked_sui_rewards(arg1, v5, arg5);
                0x3::staking_pool::split(v5, v3, arg6)
            } else {
            ...
            let (v6, v7) = withdraw_staked_sui(arg1, v4, arg2, arg6);
            let v8 = v0 + v6;
            v0 = v8 + v7;
            if (v6 + v7 <= arg4) {
                let v9 = arg4 - v6;
            ...
            v1.rewards = v1.rewards - v7;
        };
        let v10 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::is_empty<0x3::staking_pool::StakedSui>(&v1.staked_suis);
        if (v10) {
            let PoolInfo {
                staked_suis  : v11,
                total_staked : _,
            ...
            0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::table_queue::destroy_empty<0x3::staking_pool::StakedSui>(v11);
            let (v14, v15) = 0x1::vector::index_of<address>(&arg0.validators, &arg3);
            if (v14) {
                0x1::vector::remove<address>(&mut arg0.validators, v15);
            };
        };
        if (arg4 != arg4) {
    ...
    public fun request_unstake_instant_v2(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Staking, arg2: 0x2::coin::Coin<0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::hasui::HASUI>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = withdraw(arg0, arg1, v1, arg3);
        let v4 = 0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::config::get_service_fee(&arg1.config);
        let v5 = (((v1 as u128) * (v4 as u128) / (1000 as u128)) as u64);
        assert!(v4 == 0 || v5 > 0, 9);
        0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::vault::deposit<0x2::sui::SUI>(&mut arg1.service_sui_vault, 0x2::balance::split<0x2::sui::SUI>(&mut v3, v5));
    ...
    fun withdraw(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: &mut Staking, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<0x2::sui::SUI> {
        update_total_rewards_onchain(arg1, arg0, arg3);
        ...
        if (v1 > 0) {
            ...
            let v5 = arg1.validators;
            let v6 = 0;
            while (v6 < 0x1::vector::length<address>(&v5) && arg2 > 0) {
                let v7 = &mut v3;
                arg2 = do_validator_unstake(arg1, arg0, v7, *0x1::vector::borrow<address>(&v5, v6), arg2, v4, arg3);
                v6 = v6 + 1;
            };
            assert!(arg2 == 0, 16);
            0x2::balance::join<0x2::sui::SUI>(&mut v2, 0x2::balance::split<0x2::sui::SUI>(&mut v3, v1));
            0xbde4ba4c2e274a60ce15c1cfff9e5c42e41654ac8b6d906a57efa4bd3c29f47d::vault::deposit<0x2::sui::SUI>(&mut arg1.sui_vault, v3);
        };
        v2
    }
