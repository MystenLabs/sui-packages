module 0x634511c660964940915acb37dde75963e35f2d1b0a034b41e2da8f3e9d1491ae::cert {
    ...
    public fun get_total_supply_value(arg0: &Metadata<CERT>) : u64 {
        0x2::balance::supply_value<CERT>(&arg0.total_supply) - 0
    }
    ...
    fun init(arg0: CERT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<Metadata<CERT>>(v2, 0x2::tx_context::sender(arg1));
    }

    public(friend) fun migrate(arg0: &mut Metadata<CERT>) {
        assert!(arg0.version < 1, 1);
