module 0x63a217178e1189dd64b85d9719eb5e8e63afae1a8628f23b88fd61c034dc2a4d::gift2504 {
    struct GIFT2504 has drop {
        dummy_field: bool,
    }

    struct TICKET_2504 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift2504(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2504>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2504>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT2504, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT2504>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2504>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2504>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2504>>(v5, 0x2::tx_context::sender(arg1));
    }
