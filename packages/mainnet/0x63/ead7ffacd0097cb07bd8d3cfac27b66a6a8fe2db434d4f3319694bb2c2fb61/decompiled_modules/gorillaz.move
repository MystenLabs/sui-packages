module 0x63ead7ffacd0097cb07bd8d3cfac27b66a6a8fe2db434d4f3319694bb2c2fb61::gorillaz {
    ...
    fun init(arg0: GORILLAZ, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::TreasuryCap<GORILLAZ>>(v3, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_share_object<0x2::coin::CoinMetadata<GORILLAZ>>(v4);
    }
