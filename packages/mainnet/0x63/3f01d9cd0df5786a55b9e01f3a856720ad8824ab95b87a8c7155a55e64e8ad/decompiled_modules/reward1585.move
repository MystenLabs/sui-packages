module 0x633f01d9cd0df5786a55b9e01f3a856720ad8824ab95b87a8c7155a55e64e8ad::reward1585 {
    struct REWARD1585 has drop {
        dummy_field: bool,
    }

    struct TICKET_1585 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1585(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1585>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1585>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1585, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1585>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1585>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1585>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1585>>(v5, 0x2::tx_context::sender(arg1));
    }
