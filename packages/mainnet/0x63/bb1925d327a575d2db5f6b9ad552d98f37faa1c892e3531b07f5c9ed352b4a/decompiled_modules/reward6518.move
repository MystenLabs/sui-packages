module 0x63bb1925d327a575d2db5f6b9ad552d98f37faa1c892e3531b07f5c9ed352b4a::reward6518 {
    struct REWARD6518 has drop {
        dummy_field: bool,
    }

    struct TICKET_6518 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6518(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6518>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6518>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6518, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6518>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6518>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6518>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6518>>(v5, 0x2::tx_context::sender(arg1));
    }
