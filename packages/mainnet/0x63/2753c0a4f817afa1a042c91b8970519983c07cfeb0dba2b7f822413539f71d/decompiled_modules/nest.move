module 0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::nest {
    ...
    struct StakedDuck has store {
        duck: 0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::DuckNFT,
        stake_time: u64,
    ...
    public fun get_duck_harvest_stats(arg0: &Nest) : (u8, u8, u8) {
        ...
        let v0 = 0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::get_rarity_level(&0x1::option::borrow<StakedDuck>(&arg0.staked_duck).duck);
    ...
    public entry fun harvest_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::NestMintCap, arg3: &mut 0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = 0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::get_rarity_level(&v2.duck);
        let v6 = 0x2::object::id<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::DuckNFT>(&v2.duck);
        ...
        if (v11 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SHTTOKEN>>(0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::mint_for_nest(arg2, arg3, v11, arg6), v0);
        };
    ...
    public entry fun stake_duck(arg0: &mut 0x2::kiosk::Kiosk, arg1: &0x2::kiosk::KioskOwnerCap, arg2: 0x2::object::ID, arg3: &mut Nest, arg4: &mut HarvestStats, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = 0x2::kiosk::take<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::DuckNFT>(arg0, arg1, arg2);
        ...
        let v4 = DuckStaked{
            ...
            duck_id    : 0x2::object::id<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::DuckNFT>(&v1),
            owner      : v0,
    ...
    public entry fun unstake_duck(arg0: &mut Nest, arg1: &mut HarvestStats, arg2: &0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::NestMintCap, arg3: &mut 0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SharedTreasury, arg4: &0x2::random::Random, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg8);
        assert!(arg0.owner == v0, 6);
        assert!(0x1::option::is_some<StakedDuck>(&arg0.staked_duck), 2);
        let v1 = 0x2::object::id<Nest>(arg0);
        let v2 = 0x1::option::borrow<StakedDuck>(&arg0.staked_duck);
        let v3 = (0x2::clock::timestamp_ms(arg7) - v2.last_harvest_time) / 14400000;
        if (v3 > 0) {
            let v4 = if (v3 > 30) {
                30
            } else {
            ...
            if (v11 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SHTTOKEN>>(0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::mint_for_nest(arg2, arg3, v11, arg8), v0);
            };
        ...
        let v20 = DuckUnstaked{
            nest_id    : v1,
            duck_id    : 0x2::object::id<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::DuckNFT>(&v19.duck),
            owner      : v0,
        ...
        0x2::kiosk::place<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::duck_nft::DuckNFT>(arg5, arg6, v21);
    }
    ...
    public entry fun upgrade_nest(arg0: &mut Nest, arg1: &mut 0x2::coin::Coin<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SHTTOKEN>, arg2: &mut 0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SharedTreasury, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::coin::value<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SHTTOKEN>(arg1) >= v3, 5);
        0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::burn(arg2, 0x2::coin::split<0x632753c0a4f817afa1a042c91b8970519983c07cfeb0dba2b7f822413539f71d::shttoken::SHTTOKEN>(arg1, v3, arg3));
        arg0.level = v2;
        let v4 = SlotUpgraded{
            nest_id    : 0x2::object::id<Nest>(arg0),
            owner      : v0,
