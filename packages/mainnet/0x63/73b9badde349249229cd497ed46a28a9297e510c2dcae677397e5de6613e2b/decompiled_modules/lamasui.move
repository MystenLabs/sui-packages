module 0x6373b9badde349249229cd497ed46a28a9297e510c2dcae677397e5de6613e2b::lamasui {
    struct LAMASUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: LAMASUI, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<LAMASUI>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"LamaSui"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"LamaSui is the fusion between Lama memecoin and the cosmonaut of Sui Network. It represents the icon of the DeFI ecosystem that the new generation ! "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeiduimvgjnvgesv46pecd5mtpby75ijqfhzbrxhezrdprnfv5jlzqe"));
