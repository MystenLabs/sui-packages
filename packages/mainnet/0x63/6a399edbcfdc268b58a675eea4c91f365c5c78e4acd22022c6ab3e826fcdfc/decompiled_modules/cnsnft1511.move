module 0x636a399edbcfdc268b58a675eea4c91f365c5c78e4acd22022c6ab3e826fcdfc::cnsnft1511 {
    struct CNSNFT1511 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1511, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1511>(arg0, arg1);
