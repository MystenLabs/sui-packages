module 0x630ca339869353383fd39cbb22b99901f9e50f67aad3844dbda71119c7102661::barron {
    ...
    fun init(arg0: BARRON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BARRON>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BARRON  ")))), trim_right(b"Official Barron Meme On Sui     "), trim_right(b"Rumor has it this was launched by Barron himself. Most likely the future President of America and Time Traveler.                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
