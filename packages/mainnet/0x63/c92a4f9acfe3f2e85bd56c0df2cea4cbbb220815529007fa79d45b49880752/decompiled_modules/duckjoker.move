module 0x63c92a4f9acfe3f2e85bd56c0df2cea4cbbb220815529007fa79d45b49880752::duckjoker {
    ...
    fun init(arg0: DUCKJOKER, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<DUCKJOKER>(arg0, 6, b"DUJO", x"f09f838f4475636b204a6f6b6572", b"Duck Joker Coin is a whimsical and engaging memecoin that merges the playful nature of ducks with the iconic, mischievous character of the Joker.      https://www.dujo.pro/   https://x.com/dujosui   https://t.me/duckjokerportal", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://belaunchio.infura-ipfs.io/ipfs/QmayiyyoX6Ma66Tk6xRAaZfFsm3K6vEbdk6g57papUxBdz")), arg1);
