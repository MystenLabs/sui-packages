module 0x639386e63bccd376927b03605100eb314a5be5102d846d6ee6bb0f27e79df8b9::subscription {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x639386e63bccd376927b03605100eb314a5be5102d846d6ee6bb0f27e79df8b9::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun finalize_market<T0, T1>(arg0: &0x639386e63bccd376927b03605100eb314a5be5102d846d6ee6bb0f27e79df8b9::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v31 = arg1.soft_cap - arg1.soft_cap * 0x639386e63bccd376927b03605100eb314a5be5102d846d6ee6bb0f27e79df8b9::main::finalize_market_fee_bps(arg0) / 10000;
        let v32 = v31;
        if (arg1.is_auto_add_liquidity) {
    ...
    fun validate_params(arg0: &0x639386e63bccd376927b03605100eb314a5be5102d846d6ee6bb0f27e79df8b9::main::MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + 0x639386e63bccd376927b03605100eb314a5be5102d846d6ee6bb0f27e79df8b9::main::finalize_market_fee_bps(arg0) <= 10000, 1);
        let v0 = 0;
        if (arg5) {
