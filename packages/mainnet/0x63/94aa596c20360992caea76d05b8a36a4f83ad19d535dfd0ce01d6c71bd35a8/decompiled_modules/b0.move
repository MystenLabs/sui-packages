module 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::b0 {
    ...
    fun bxp_internal<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: &mut 0xb24b6789e088b876afabca733bed2299fbc9e2d6369be4d1acfa17d8145454d9::swap::Dex_Info, arg3: &0x2::clock::Clock, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::new_f_max(arg4, arg5, 1000000000, arg6);
        let v3 = calc_bx<T0>(arg1, v0, v1, arg4);
        if (0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::gt(v3, 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::zero())) {
            0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_init(&mut v2, arg4, v3);
            let v4 = 0;
            while (v4 < 10 && !0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_has_converged(&v2)) {
                0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_complete(&mut v2, calc_bx<T0>(arg1, v0, v1, 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_prep_u(&mut v2)));
                v4 = v4 + 1;
            };
            let (v5, _) = 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_result(&v2);
            bx_internal<T0>(arg0, arg1, arg2, arg3, v5, arg10);
            return
        };
        let v7 = 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::new_f_max(arg7, arg8, 1000000, arg9);
        let v8 = calc_bxr<T0>(arg1, v0, v1, arg7);
        assert!(0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::gt(v8, 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::zero()), 25);
        0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_init(&mut v7, arg7, v8);
        let v9 = 0;
        while (v9 < 10 && !0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_has_converged(&v7)) {
            0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_complete(&mut v7, calc_bxr<T0>(arg1, v0, v1, 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_next_step_prep_u(&mut v7)));
            v9 = v9 + 1;
        };
        let (v10, _) = 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::f_max::f_max_result(&v7);
    ...
    fun calc_bx<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::I128 {
    ...
    fun calc_bxr<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg1: u64, arg2: u64, arg3: u64) : 0x895a25cea1fc62b359d3b2f1db130c2425914cd912d33bd630413fc45efbee02::i128::I128 {
