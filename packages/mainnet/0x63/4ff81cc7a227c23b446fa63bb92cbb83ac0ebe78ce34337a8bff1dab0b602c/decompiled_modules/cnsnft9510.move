module 0x634ff81cc7a227c23b446fa63bb92cbb83ac0ebe78ce34337a8bff1dab0b602c::cnsnft9510 {
    struct CNSNFT9510 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9510, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9510>(arg0, arg1);
