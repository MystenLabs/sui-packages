module 0x63537f14127a77554cf107593d6c61dbc09a5cd6f4febec5c7428ed409572571::main {
    ...
    public entry fun new(arg0: u64, arg1: &mut WalletArtRegistry, arg2: &0x2::random::Random, arg3: &mut 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) {
        let (_, _, v2) = estimate_total_cost(arg1, arg0);
        assert!(0x2::coin::value<0x2::sui::SUI>(arg3) >= v2, 2);
        assert!(arg1.count < 18446744073709551615, 7);
        if (v2 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<0x2::sui::SUI>>(0x2::coin::split<0x2::sui::SUI>(arg3, v2, arg4), arg1.fee_config.fee_recipient);
        };
        let v3 = 0x2::random::new_generator(arg2, arg4);
        let v4 = 0x2::tx_context::sender(arg4);
        let v5 = generate_colors_from_address(v4);
        let v6 = 0x1::string::utf8(b"data:image/svg+xml;base64,");
        if (arg0 <= 512) {
            let v7 = &mut v3;
            0x1::string::append(&mut v6, encode_8(generate_svg_8(&v5, v7, arg0)));
        } else {
            let v8 = &mut v3;
            0x1::string::append(&mut v6, encode_16(generate_svg_16(&v5, v8, arg0)));
        };
        let v9 = WalletArt{
        ...
        0x2::transfer::transfer<WalletArt>(v9, v4);
    }
    ...
    public fun estimate_total_cost(arg0: &WalletArtRegistry, arg1: u64) : (u64, u64, u64) {
        ...
        let v2 = if (arg1 == 64) {
            arg0.fee_config.fee_8x8
        } else if (arg1 == 256) {
            arg0.fee_config.fee_16x16
        } else if (arg1 == 1024) {
            arg0.fee_config.fee_32x32
        } else {
            arg0.fee_config.fee_64x64
        };
    ...
    fun init(arg0: MAIN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = FeeConfig{
            fee_8x8           : 4000000000,
            fee_16x16         : 8000000000,
            fee_32x32         : 16000000000,
            fee_64x64         : 32000000000,
    ...
    public entry fun regenerate_art(arg0: &mut WalletArt, arg1: &0x2::random::Random, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.owner == 0x2::tx_context::sender(arg2), 3);
        let v0 = 0x2::random::new_generator(arg1, arg2);
        let v1 = generate_colors_from_address(arg0.owner);
        let v2 = 0x1::string::utf8(b"data:image/svg+xml;base64,");
        if (arg0.size <= 512) {
            let v3 = &mut v0;
            0x1::string::append(&mut v2, encode_8(generate_svg_8(&v1, v3, arg0.size)));
        } else {
            let v4 = &mut v0;
            0x1::string::append(&mut v2, encode_16(generate_svg_16(&v1, v4, arg0.size)));
        };
        arg0.data_url = v2;
    }
