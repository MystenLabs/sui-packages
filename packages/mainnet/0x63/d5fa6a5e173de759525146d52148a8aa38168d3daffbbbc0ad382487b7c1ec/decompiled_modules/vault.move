module 0x63d5fa6a5e173de759525146d52148a8aa38168d3daffbbbc0ad382487b7c1ec::vault {
    ...
    public fun begin_rebalance<T0, T1>(arg0: &Registry, arg1: &mut Vault<T0, T1>, arg2: &KeeperCap, arg3: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg4: &0x2::clock::Clock) : (0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, RebalanceTicket) {
        ...
        begin_rebalance_inner<T0, T1>(arg0, arg1, arg3, arg4)
    }
    ...
    fun begin_rebalance_inner<T0, T1>(arg0: &Registry, arg1: &mut Vault<T0, T1>, arg2: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : (0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, RebalanceTicket) {
        assert_version(arg0);
        ...
        let v0 = 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::sqrt_price<T0, T1>(arg2);
        let v1 = 0x1::option::extract<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&mut arg1.position);
        let v2 = RebalanceTicket{
            vault_id            : 0x2::object::id<Vault<T0, T1>>(arg1),
            pool_id             : arg1.pool_id,
            old_position_id     : 0x2::object::id<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&v1),
            value_before        : total_value_in_y<T0, T1>(arg1, v0),
            ...
            old_tick_lower      : 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::tick_lower_index(&v1),
            old_tick_upper      : 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::tick_upper_index(&v1),
        };
        (v1, v2)
    }
    ...
    public fun end_rebalance<T0, T1>(arg0: &Registry, arg1: &mut Vault<T0, T1>, arg2: RebalanceTicket, arg3: 0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position, arg4: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg5: &0x2::clock::Clock) {
        ...
        let v15 = if (is_in_range<T0, T1>(arg4, 0x1::option::borrow<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&arg1.position))) {
            0
        } else {
            v14
        };
        arg1.out_of_range_since_ms = v15;
        let v16 = Rebalanced{
            vault_id        : v0,
            pool_id         : v1,
            old_position_id : v2,
    ...
    public fun sync_range_status<T0, T1>(arg0: &mut Vault<T0, T1>, arg1: &0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock) {
        ...
        if (is_in_range<T0, T1>(arg1, 0x1::option::borrow<0xb5f529c1dcda6580a61bf7ee9fbd524b50be62f11044d137c8202c8cbace9e56::position::Position>(&arg0.position))) {
            if (arg0.out_of_range_since_ms != 0 && 0x2::clock::timestamp_ms(arg2) >= arg0.out_of_range_since_ms + 300000) {
