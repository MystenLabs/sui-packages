module 0x63d328a1faeab6c839037c1eedd453b622e5de81f179eecfc6ba434fac3ff9af::cnsnft3600 {
    struct CNSNFT3600 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3600, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8648"));
        let v4 = 0x2::package::claim<CNSNFT3600>(arg0, arg1);
