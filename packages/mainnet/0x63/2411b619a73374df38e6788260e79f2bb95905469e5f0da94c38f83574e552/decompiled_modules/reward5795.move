module 0x632411b619a73374df38e6788260e79f2bb95905469e5f0da94c38f83574e552::reward5795 {
    struct REWARD5795 has drop {
        dummy_field: bool,
    }

    struct TICKET_5795 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5795(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5795>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5795>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5795, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5795>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5795>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5795>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5795>>(v5, 0x2::tx_context::sender(arg1));
    }
