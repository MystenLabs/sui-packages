module 0xf31db015430ecfb43022476929ce760a9e962ce762fb95b918c75a2f334481b9::clmm_liquidity_script {
    ...
    fun calc_swap_amount_in_one_pool_internal<T0, T1>(arg0: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg1: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg2: 0x659c0e9c4c8a416f040fa758d4fc4073a5fdd1fed97edadcd5cba5180fb36246::i32::I32, arg3: 0x659c0e9c4c8a416f040fa758d4fc4073a5fdd1fed97edadcd5cba5180fb36246::i32::I32, arg4: u64, arg5: u64) : (u64, u64, bool) {
        ...
        let (v10, v11, v12, v13) = if (v3 >= v6) {
            ...
            while (v19 < 20 && v15 < v14) {
                ...
                v17 = v21;
                if (((arg5 as u128) + (v21 as u128)) * 18446744073709551616 / ((arg4 - v14) as u128) >= (v2 - 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::tick_math::get_sqrt_price_at_tick(arg2)) * 18446744073709551616 / (v9 - v2) * v2 * v9 / 18446744073709551616) {
                } else {
                    v15 = v14;
                };
            ...
            while (v27 < 20 && v23 < v22) {
                ...
                v25 = v29;
                if (((arg5 as u128) - (v22 as u128)) * 18446744073709551616 / ((arg4 + v29) as u128) >= (v2 - 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::tick_math::get_sqrt_price_at_tick(arg2)) * 18446744073709551616 / (v9 - v2) * v2 * v9 / 18446744073709551616) {
                    v23 = v22;
                };
        ...
        let (v30, v31) = if (after_tick_in_range(v0, v1, 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::tick_math::get_tick_at_sqrt_price(v13))) {
            (v10, v11)
        } else if (v12) {
            let v32 = 0;
            let v33 = v10;
            let v34 = v10 / 2;
            let v35 = 0;
            while (v35 < 10 && v34 < v33) {
                v34 = (v33 + v34) / 2;
                let v36 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculate_swap_result<T0, T1>(arg0, arg1, true, true, v34);
                if (after_tick_in_range(v0, v1, 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::tick_math::get_tick_at_sqrt_price(0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculated_swap_result_after_sqrt_price(&v36)))) {
                    v33 = v34;
                } else {
                    v32 = v34;
                };
            ...
            if (v32 != 0) {
                let v37 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculate_swap_result<T0, T1>(arg0, arg1, v12, true, v32);
                (v32, 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculated_swap_result_amount_out(&v37))
            } else {
                (v10, v11)
            }
        } else {
            ...
            let v40 = v11 / 2;
            let v41 = 0;
            while (v41 < 10 && v40 < v39) {
                v40 = (v39 + v40) / 2;
                let v42 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculate_swap_result<T0, T1>(arg0, arg1, false, true, v40);
                if (after_tick_in_range(v0, v1, 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::tick_math::get_tick_at_sqrt_price(0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculated_swap_result_after_sqrt_price(&v42)))) {
                } else {
                    v38 = v40;
                    v39 = v40;
                };
            ...
            if (v38 != 0) {
                let v43 = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculate_swap_result<T0, T1>(arg0, arg1, v12, true, v38);
                (0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::calculated_swap_result_amount_out(&v43), v38)
            } else {
                (v10, v11)
            }
        };
    ...
    public entry fun extract_balance_from_botcap<T0>(arg0: &mut BotCap, arg1: address, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1 != @0x0, 9223372221538369535);
    ...
    fun remove_swap_add_in_one_pool<T0, T1>(arg0: &0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::config::GlobalConfig, arg1: 0x1::option::Option<0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::Position>, arg2: &mut 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::Pool<T0, T1>, arg3: 0x2::balance::Balance<T0>, arg4: 0x2::balance::Balance<T1>, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : (0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::position::Position, 0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        ...
        let (v8, v9, v10) = calc_swap_amount_in_one_pool_internal<T0, T1>(arg0, arg2, v2, v3, 0x2::balance::value<T0>(&arg3), 0x2::balance::value<T1>(&arg4));
        let v11 = if (v10) {
            v8
        } else {
            v9
        ...
        let (v13, v14, v15) = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::flash_swap<T0, T1>(arg0, arg2, v10, true, v11, v12, arg5);
        let v16 = v15;
        if (v10) {
            0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::repay_flash_swap<T0, T1>(arg0, arg2, 0x2::balance::split<T0>(&mut arg3, 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::swap_pay_amount<T0, T1>(&v16)), 0x2::balance::zero<T1>(), v16);
            0x2::balance::join<T1>(&mut arg4, v14);
            0x2::balance::destroy_zero<T0>(v13);
        } else {
            0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::repay_flash_swap<T0, T1>(arg0, arg2, 0x2::balance::zero<T0>(), 0x2::balance::split<T1>(&mut arg4, 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::swap_pay_amount<T0, T1>(&v16)), v16);
            0x2::balance::join<T0>(&mut arg3, v13);
            0x2::balance::destroy_zero<T1>(v14);
        };
        let (_, _, v19) = 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::clmm_math::get_liquidity_by_amount(v2, v3, v0, 0x4a35d3dfef55ed3631b7158544c6322a23bc434fe4fca1234cb680ce0505f82d::pool::current_sqrt_price<T0, T1>(arg2), 0x2::balance::value<T0>(&arg3), true);
        let v20 = if (v19 <= 0x2::balance::value<T1>(&arg4)) {
