module 0xdaebb123115985f817053cae3eb18b5da08b6dee8978236de2ee9d3face7059::account {
    ...
    struct AccountAdminCapBootstrapMarker has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun bootstrap_admin_cap(arg0: &mut AccountRoot, arg1: &0x2::package::UpgradeCap, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0x1::type_name::with_defining_ids<AccountAdminCapBootstrapMarker>();
        assert!(0x2::address::to_ascii_string(0x2::object::id_to_address(&v0)) == 0x1::type_name::address_string(&v1), 3);
        let v2 = AccountAdminCapKey{dummy_field: false};
        let v3 = 0x2::derived_object::claim<AccountAdminCapKey>(&mut arg0.id, v2);
        let v4 = AccountAdminCapCreated{
            cap_id    : 0x2::object::uid_to_inner(&v3),
            recipient : arg2,
            admin     : 0x2::tx_context::sender(arg3),
        };
        0x2::event::emit<AccountAdminCapCreated>(v4);
        let v5 = AccountAdminCap{id: v3};
        0x2::transfer::transfer<AccountAdminCap>(v5, arg2);
    }
    ...
    public fun redeem_address_coin<T0>(arg0: &mut Account, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert_owner(arg0, arg2);
        0x2::coin::redeem_funds<T0>(0x2::balance::withdraw_funds_from_object<T0>(&mut arg0.id, arg1), arg2)
    }
