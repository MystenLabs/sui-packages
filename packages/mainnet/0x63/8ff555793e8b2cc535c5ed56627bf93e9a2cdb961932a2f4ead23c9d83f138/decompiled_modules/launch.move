module 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::launch {
    ...
    public entry fun activate_pool(arg0: &LaunchCreatorCap, arg1: &mut VaultLaunch, arg2: 0x2::object::ID, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.status == 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::status_awakened(), 105);
        ...
        arg1.status = 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::status_vesting();
        0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::events::emit_pool_activated(0x2::object::uid_to_inner(&arg1.id), arg2, arg3, v0);
    }
    ...
    public entry fun create_launch(arg0: &mut 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::GlobalConfig, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u8, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: bool, arg11: &mut 0x2::tx_context::TxContext) {
        assert!(arg6 >= 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::min_mint_price_mist(), 100);
        assert!(arg7 <= 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::max_supply(), 101);
        if (arg5 == 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::quote_coin_sui()) {
            assert!(arg8 >= 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::min_goal_sui(), 102);
        } else {
            assert!(arg8 >= 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::min_goal_usdc(), 102);
        };
        ...
        let v3 = VaultLaunch{
            ...
            status                 : 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::status_genesis(),
            total_raised           : 0,
            nft_count              : 0,
            last_mint_time_ms      : 0,
        ...
        0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::events::emit_launch_created(v1, v2, arg1, arg6, arg7, arg8, arg5);
        0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::increment_launches(arg0);
    ...
    public entry fun receive_swap_fees(arg0: &mut VaultLaunch, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = v0 * 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::creator_swap_bps() / 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::bps_denominator();
    ...
    public fun record_mint(arg0: &mut VaultLaunch, arg1: address, arg2: u64, arg3: u64, arg4: 0x2::coin::Coin<0x2::sui::SUI>, arg5: &0x2::clock::Clock) {
        ...
        if (0x2::table::contains<address, u64>(&arg0.wallet_mints, arg1)) {
            let v1 = 0x2::table::borrow_mut<address, u64>(&mut arg0.wallet_mints, arg1);
            *v1 = *v1 + 1;
        } else {
        ...
        if (arg0.total_raised >= arg0.goal && arg0.status == 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::status_genesis()) {
            arg0.status = 0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::config::status_awakened();
            0x638ff555793e8b2cc535c5ed56627bf93e9a2cdb961932a2f4ead23c9d83f138::events::emit_goal_reached(0x2::object::uid_to_inner(&arg0.id), arg0.total_raised, arg0.nft_count, v0);
        };
    }
