module 0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::rootlet {
    ...
    public fun admin_mint(arg0: &mut Sale, arg1: &0x2::transfer_policy::TransferPolicy<Rootlet>, arg2: &mut 0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::CollectionData, arg3: &AdminCap, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.active, 9223373011812351999);
        let (v0, v1, v2, v3) = 0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::get_nft(arg2, 0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::nfts_left(arg2) - 1);
        let v4 = if (0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::is_robot(v0)) {
    ...
    entry fun mint(arg0: &mut Sale, arg1: &0x2::transfer_policy::TransferPolicy<Rootlet>, arg2: &mut 0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::CollectionData, arg3: vector<Pass>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg7 > 0) {
            let v0 = if (0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::nfts_left(arg2) == 1) {
                0
            } else {
                0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::pseuso_random::rng(0, 0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::nfts_left(arg2) - 1, arg9)
            };
            let (v1, v2, v3, v4) = 0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::get_nft(arg2, v0);
            let v5 = if (0x63af2ea5268bb000bcf8136cac759180099df9ba3c00440690b337a9f8d713c2::attributes::is_robot(v1)) {
                0x1::string::utf8(b"Robot")
            } else {
                0x1::string::utf8(b"Rootlets")
            };
