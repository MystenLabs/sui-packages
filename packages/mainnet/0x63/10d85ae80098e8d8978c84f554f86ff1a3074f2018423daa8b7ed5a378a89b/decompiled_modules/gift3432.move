module 0x6310d85ae80098e8d8978c84f554f86ff1a3074f2018423daa8b7ed5a378a89b::gift3432 {
    struct GIFT3432 has drop {
        dummy_field: bool,
    }

    struct TICKET_3432 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3432(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3432>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3432>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3432, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3432>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3432>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3432>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3432>>(v5, 0x2::tx_context::sender(arg1));
    }
