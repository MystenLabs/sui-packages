module 0x63a1e8717e833252525214fe453c83e52dc5619781d3a8bd98b992d06705f6e5::navxgift1209 {
    struct NAVXGIFT1209 has drop {
        dummy_field: bool,
    }

    struct NAVX_GIFTBOX_1209 has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun NaviGiftBox1209(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVX_GIFTBOX_1209{
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<NAVX_GIFTBOX_1209>(&v0),
            ...
            0x2::transfer::public_transfer<NAVX_GIFTBOX_1209>(v0, 0x1::vector::pop_back<address>(&mut arg0));
        };
    }

    public entry fun burn_nft(arg0: NAVX_GIFTBOX_1209, arg1: &mut 0x2::tx_context::TxContext) {
        let NAVX_GIFTBOX_1209 {
            id          : v0,
            name        : v1,
            image_url   : v2,
            description : v3,
    ...
    fun init(arg0: NAVXGIFT1209, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<NAVXGIFT1209>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<NAVX_GIFTBOX_1209>(&v4, v0, v2, arg1);
        0x2::display::update_version<NAVX_GIFTBOX_1209>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<NAVX_GIFTBOX_1209>>(v5, 0x2::tx_context::sender(arg1));
    }
