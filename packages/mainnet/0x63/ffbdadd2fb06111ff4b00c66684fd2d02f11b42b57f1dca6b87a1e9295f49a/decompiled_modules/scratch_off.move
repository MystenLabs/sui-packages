module 0x63ffbdadd2fb06111ff4b00c66684fd2d02f11b42b57f1dca6b87a1e9295f49a::scratch_off {
    ...
    public fun finish_evaluation<T0>(arg0: &mut 0x90a88c7fe8931d467f6364839b9db3b0a7744084664817de5ed709885e086ff0::unihouse::UniHouse, arg1: 0x2::object::ID, arg2: vector<u8>, arg3: &mut ConvenienceStore<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = 0x63ffbdadd2fb06111ff4b00c66684fd2d02f11b42b57f1dca6b87a1e9295f49a::math::get_random_u64_in_range(&v5, tickets_left<T0>(arg3));
        let v7 = 0;
        let v8 = 0;
        while (v7 < v6) {
    ...
    public fun open_store<T0>(arg0: vector<u64>, arg1: vector<u64>, arg2: vector<u8>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0;
        while (v2 < v0) {
            let v4 = 0x1::vector::pop_back<u64>(&mut arg0);
            let v5 = PrizeStruct{
                ticket_amount : v4,
                prize_value   : 0x1::vector::pop_back<u64>(&mut arg1),
            };
