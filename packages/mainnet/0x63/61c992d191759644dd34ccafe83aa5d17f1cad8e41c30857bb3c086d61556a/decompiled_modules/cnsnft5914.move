module 0x6361c992d191759644dd34ccafe83aa5d17f1cad8e41c30857bb3c086d61556a::cnsnft5914 {
    struct CNSNFT5914 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5914, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5914>(arg0, arg1);
