module 0x6317477eb9e5e775038f69e818fa89b552f79d487c7f5f583f02991a30c8f511::reward5664 {
    struct REWARD5664 has drop {
        dummy_field: bool,
    }

    struct TICKET_5664 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket5664(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5664>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5664>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5664, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5664>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5664>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5664>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5664>>(v5, 0x2::tx_context::sender(arg1));
    }
