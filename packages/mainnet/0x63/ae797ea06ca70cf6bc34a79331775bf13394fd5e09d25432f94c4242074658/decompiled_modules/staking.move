module 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::staking {
    ...
    fun claim_tokens(arg0: address, arg1: &0x2::clock::Clock, arg2: &mut StakingVault, arg3: &mut 0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::ProtocolTreasury, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            ...
            assert!(0x2::table::contains<0x2::object::ID, u64>(&mut arg2.token_timestamps, v2), 3);
            assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&mut arg2.id, v2), 3);
            let v3 = 0x2::dynamic_object_field::borrow<0x2::object::ID, 0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::Stork>(&mut arg2.id, v2);
            let (v4, v5) = calculate_stake_with_remainder(v3, *0x2::table::borrow<0x2::object::ID, u64>(&mut arg2.token_timestamps, v2), arg1);
            if (v4 > 0) {
                assert!(0x2::table::contains<0x2::object::ID, address>(&arg2.owners, 0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::id(v3)), 3);
                0x2::table::remove<0x2::object::ID, u64>(&mut arg2.token_timestamps, v2);
                0x2::table::add<0x2::object::ID, u64>(&mut arg2.token_timestamps, v2, 0x2::clock::timestamp_ms(arg1) - v5);
                0x2::transfer::public_transfer<0x2::coin::Coin<0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::STORKTOKEN>>(0x3cf6e24398c526fd1e0c46e22d4c1f88e3f3c14ba3df6fdaa6dd6d4aab202736::storktoken::withdraw_staking(arg3, v4, arg4), *0x2::table::borrow<0x2::object::ID, address>(&arg2.owners, 0x5f1fa51a6d5c52df7dfe0ff7efaab7cc769d81e51cf208a424e455575aa1ed7a::stork::id(v3)));
            };
            v1 = v1 + 1;
        };
    }
