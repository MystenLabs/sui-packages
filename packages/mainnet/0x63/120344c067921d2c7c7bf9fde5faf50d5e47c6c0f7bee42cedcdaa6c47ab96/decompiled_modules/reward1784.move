module 0x63120344c067921d2c7c7bf9fde5faf50d5e47c6c0f7bee42cedcdaa6c47ab96::reward1784 {
    struct REWARD1784 has drop {
        dummy_field: bool,
    }

    struct TICKET_1784 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1784(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1784>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1784>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1784, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1784>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1784>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1784>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1784>>(v5, 0x2::tx_context::sender(arg1));
    }
