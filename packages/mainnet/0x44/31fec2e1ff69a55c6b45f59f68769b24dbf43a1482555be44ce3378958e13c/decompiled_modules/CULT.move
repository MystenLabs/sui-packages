module 0x4431fec2e1ff69a55c6b45f59f68769b24dbf43a1482555be44ce3378958e13c::CULT {
    struct CULT has drop {
        dummy_field: bool,
    }

    fun init(arg0: CULT, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency<CULT>(arg0, 2, b"CULT", b"CULT", b"CULT", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://arweave.net/kRQ-lb3cxMWzoyATgySAxrGohZs7vDUJRXWtYC_-whQ?ext=png")), arg1);
