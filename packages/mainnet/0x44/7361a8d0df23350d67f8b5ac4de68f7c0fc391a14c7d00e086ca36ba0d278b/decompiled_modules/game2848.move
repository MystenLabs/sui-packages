module 0x447361a8d0df23350d67f8b5ac4de68f7c0fc391a14c7d00e086ca36ba0d278b::game2848 {
    struct GAME2848 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeTicket2848(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GAME2848, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME2848>(arg0, arg1);
