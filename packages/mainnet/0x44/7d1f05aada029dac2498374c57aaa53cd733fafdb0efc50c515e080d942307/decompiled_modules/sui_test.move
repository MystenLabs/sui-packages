module 0x447d1f05aada029dac2498374c57aaa53cd733fafdb0efc50c515e080d942307::sui_test {
    ...
    public fun mint_and_transfer<T0>(arg0: &mut TreasuryCap<T0>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun update_description<T0>(arg0: &TreasuryCap<T0>, arg1: &mut CoinMetadata<T0>, arg2: 0x1::string::String) {
        arg1.description = arg2;
    }

    public fun update_icon_url<T0>(arg0: &TreasuryCap<T0>, arg1: &mut CoinMetadata<T0>, arg2: 0x1::ascii::String) {
        arg1.icon_url = 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(arg2));
    }

    public fun update_name<T0>(arg0: &TreasuryCap<T0>, arg1: &mut CoinMetadata<T0>, arg2: 0x1::string::String) {
        arg1.name = arg2;
    }

    public fun update_symbol<T0>(arg0: &TreasuryCap<T0>, arg1: &mut CoinMetadata<T0>, arg2: 0x1::ascii::String) {
        arg1.symbol = arg2;
    }
