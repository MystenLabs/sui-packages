module 0x444651a5c140c41afd9ff72792e164df8690bb713126eab59d7cffe416da37e3::LLV1 {
    ...
    public entry fun new_lotus_pool<T0, T1>(arg0: &CreatePoolLock, arg1: &mut Factory, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: address, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: u64, arg12: u64, arg13: u64, arg14: u64, arg15: address, arg16: &0x2::clock::Clock, arg17: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0x2::coin::value<T1>(&v1) / 10;
        assert!(v2 > 0, 21);
        let v3 = 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg2, arg3, arg17));
        let v4 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v1, v2, arg17));
        let v5 = 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut v1, v2, arg17));
        create_lotus_pool<T0, T1>(arg1, v3, v4, v5, 0x2::coin::into_balance<T1>(v1), arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17);
