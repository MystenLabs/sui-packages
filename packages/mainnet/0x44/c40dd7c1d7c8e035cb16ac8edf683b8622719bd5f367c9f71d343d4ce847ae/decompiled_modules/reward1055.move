module 0x44c40dd7c1d7c8e035cb16ac8edf683b8622719bd5f367c9f71d343d4ce847ae::reward1055 {
    struct REWARD1055 has drop {
        dummy_field: bool,
    }

    struct TICKET_1055 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1055(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1055>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1055>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1055, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1055>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1055>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1055>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1055>>(v5, 0x2::tx_context::sender(arg1));
    }
