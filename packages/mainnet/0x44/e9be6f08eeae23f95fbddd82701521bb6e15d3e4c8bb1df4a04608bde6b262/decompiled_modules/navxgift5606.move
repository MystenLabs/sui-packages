module 0x44e9be6f08eeae23f95fbddd82701521bb6e15d3e4c8bb1df4a04608bde6b262::navxgift5606 {
    struct NAVXGIFT5606 has drop {
        dummy_field: bool,
    }

    struct NAVX_GIFTBOX_5606 has store, key {
        id: 0x2::object::UID,
    ...
    public entry fun NaviGiftBox5606(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = NAVX_GIFTBOX_5606{
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<NAVX_GIFTBOX_5606>(&v0),
            ...
            0x2::transfer::public_transfer<NAVX_GIFTBOX_5606>(v0, 0x1::vector::pop_back<address>(&mut arg0));
        };
    }

    public entry fun burn_nft(arg0: NAVX_GIFTBOX_5606, arg1: &mut 0x2::tx_context::TxContext) {
        let NAVX_GIFTBOX_5606 {
            id          : v0,
            name        : v1,
            image_url   : v2,
            description : v3,
    ...
    fun init(arg0: NAVXGIFT5606, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<NAVXGIFT5606>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<NAVX_GIFTBOX_5606>(&v4, v0, v2, arg1);
        0x2::display::update_version<NAVX_GIFTBOX_5606>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<NAVX_GIFTBOX_5606>>(v5, 0x2::tx_context::sender(arg1));
    }
