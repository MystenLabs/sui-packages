module 0x4485e3a49008a7e0116e7787d9d5c4ca2cebc7beb5a59cb73d352ab9abdcd0bf::cnsnft2433 {
    struct CNSNFT2433 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2433, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2433>(arg0, arg1);
