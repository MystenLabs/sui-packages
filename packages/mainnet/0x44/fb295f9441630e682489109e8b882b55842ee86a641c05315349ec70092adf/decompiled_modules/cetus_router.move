module 0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::cetus_router {
    ...
    public entry fun buy_exact_in<T0, T1>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: bool, arg9: 0x1::string::String, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = v0 * arg0.buy_fee / 10000;
        let v2 = v0 - v1;
        if (arg8) {
            0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T0>(0x2::coin::split<T0>(&mut arg3, v1, arg10), arg0.admin);
        } else {
            0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T1>(0x2::coin::split<T1>(&mut arg4, v1, arg10), arg0.admin);
        };
        let (v3, v4, v5) = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::flash_swap<T0, T1>(arg1, arg2, arg8, true, v2, arg6, arg7);
        let v6 = v5;
        let v7 = v4;
        let v8 = v3;
        let v9 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::swap_pay_amount<T0, T1>(&v6);
        assert!(v9 == v2, 3);
        let (v10, v11, v12) = if (arg8) {
            (0x2::balance::value<T1>(&v7), 0x2::coin::into_balance<T0>(0x2::coin::split<T0>(&mut arg3, v9, arg10)), 0x2::balance::zero<T1>())
        } else {
            (0x2::balance::value<T0>(&v8), 0x2::balance::zero<T0>(), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg4, v9, arg10)))
        };
        assert!(v10 >= arg5, 1);
        0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::repay_flash_swap<T0, T1>(arg1, arg2, v11, v12, v6);
        0x2::coin::join<T0>(&mut arg3, 0x2::coin::from_balance<T0>(v8, arg10));
        0x2::coin::join<T1>(&mut arg4, 0x2::coin::from_balance<T1>(v7, arg10));
        0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg10));
        0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T1>(arg4, 0x2::tx_context::sender(arg10));
        if (arg8) {
            let v13 = BuyEvent<T1>{
            ...
            0x2::event::emit<BuyEvent<T1>>(v13);
        } else {
            let v14 = BuyEvent<T0>{
                recipient  : 0x2::tx_context::sender(arg10),
                amount_in  : v2,
            ...
            0x2::event::emit<BuyEvent<T0>>(v14);
        };
    ...
    public fun buy_exact_in_first_return<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<0x2::sui::SUI, T0>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = v2;
        let v4 = v1;
        0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_balance<0x2::sui::SUI>(v0, 0x2::tx_context::sender(arg7), arg7);
        ...
        0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<0x2::sui::SUI>(arg2, 0x2::tx_context::sender(arg7));
        let v6 = BuyEvent<T0>{
    ...
    public fun buy_exact_in_second_return<T0>(arg0: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg1: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, 0x2::sui::SUI>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: 0x1::string::String, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v3 = v2;
        let v4 = v0;
        0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_balance<0x2::sui::SUI>(v1, 0x2::tx_context::sender(arg7), arg7);
        let v5 = 0x2::balance::value<T0>(&v4);
        assert!(v5 >= arg4, 1);
    ...
    public entry fun sell_exact_in<T0, T1>(arg0: &FeeObject, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T1>, arg5: u64, arg6: u64, arg7: u128, arg8: &0x2::clock::Clock, arg9: bool, arg10: 0x1::string::String, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        if (arg9) {
            0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T1>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut v4, v10), arg11), arg0.admin);
        } else {
            0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T0>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut v5, v10), arg11), arg0.admin);
        };
        ...
        0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T0>(arg3, 0x2::tx_context::sender(arg11));
        0x44fb295f9441630e682489109e8b882b55842ee86a641c05315349ec70092adf::utils::send_coin<T1>(arg4, 0x2::tx_context::sender(arg11));
        if (arg9) {
