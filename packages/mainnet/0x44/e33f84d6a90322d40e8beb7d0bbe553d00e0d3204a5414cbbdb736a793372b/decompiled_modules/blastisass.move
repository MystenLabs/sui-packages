module 0x44e33f84d6a90322d40e8beb7d0bbe553d00e0d3204a5414cbbdb736a793372b::blastisass {
    struct BLASTISASS has drop {
        dummy_field: bool,
    }

    fun init(arg0: BLASTISASS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BLASTISASS>(arg0, 9, b"BLASTISASS", b"_S_", b"BLAST IS ASS smells like it too", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"")), arg1);
        let v2 = v0;
