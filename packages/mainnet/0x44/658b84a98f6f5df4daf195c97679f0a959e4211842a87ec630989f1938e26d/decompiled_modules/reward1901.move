module 0x44658b84a98f6f5df4daf195c97679f0a959e4211842a87ec630989f1938e26d::reward1901 {
    struct REWARD1901 has drop {
        dummy_field: bool,
    }

    struct TICKET_1901 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1901(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1901>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1901>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1901, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1901>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1901>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1901>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1901>>(v5, 0x2::tx_context::sender(arg1));
    }
