module 0x447f71b5558548c7101c092071a88fcf5d47e0b5d3e77dd657c1bd5c0fb627a8::usdc_vault {
    ...
    public entry fun set_receiver(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
    ...
    public entry fun withdraw_with_super(arg0: &mut USDCVault, arg1: &SuperAdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        verify_super_admin_cap(arg0, arg1);
        let v0 = withdraw(arg0, arg2, arg3);
        assert!(0x1::option::is_some<address>(&arg0.receiver), 7);
        0x2::transfer::public_transfer<0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>>(v0, *0x1::option::borrow<address>(&arg0.receiver));
    }
