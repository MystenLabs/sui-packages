module 0x443ab6e1662cc575e99f368dc661dbc94ee12fbf43dd4c09538ae465b7a7acac::swap_pool {
    ...
    public fun swap<T0, T1, T2>(arg0: &mut State, arg1: &SwapCap, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T1, T2>, arg5: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        let (v0, v1) = get_swap_price<T1, T2>(arg0, arg5, arg4, arg6);
    ...
    public fun get_amount_out<T0, T1>(arg0: &State, arg1: u64, arg2: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg3: &0x2::clock::Clock) : u64 {
        ...
        let v4 = (arg1 as u128) * (0x1::u64::pow(10, 9 + v3 - v1) as u128) / (v2 as u128);
        assert!(v4 < 18446744073709551615, 122);
        let v5 = (v4 as u64);
        assert!(v5 <= get_balance_amount<T1>(arg0), 108);
        v5
    }
    ...
    public fun get_price_from_oracle(arg0: &State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x2::clock::Clock) : (u64, u8) {
        let v0 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::pyth::get_price_no_older_than(arg1, arg2, 90);
        ...
        assert!(v6 == (8 as u64), 119);
        let v7 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v5);
        assert!(v7 < 184467440737095, 117);
        (v7, (v6 as u8))
    }

    fun get_swap_price<T0, T1>(arg0: &State, arg1: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg2: &0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : (u64, u8) {
        let (v0, v1) = get_price_from_oracle(arg0, arg1, arg3);
        if (arg0.price_check) {
            let v2 = 0x2::object::id<0x70285592c97965e811e0c6f98dccc3a9c2b4ad854b3594faab9597ada267b860::pool::Pool<T0, T1>>(arg2);
            assert!(0x1::option::contains<0x2::object::ID>(&arg0.dex_pool, &v2), 114);
            let v3 = get_twap_price_from_dex<T0, T1>(arg2, v1, arg3);
            assert!(v3 * ((10000 - arg0.price_deviation_ratio) as u256) / (10000 as u256) <= (v0 as u256), 106);
            assert!(v3 * ((10000 + arg0.price_deviation_ratio) as u256) / (10000 as u256) >= (v0 as u256), 107);
        };
    ...
    fun swap_at_price<T0, T1>(arg0: &mut State, arg1: &SwapCap, arg2: &mut 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u8, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        let v3 = (arg3 as u128) * (0x1::u64::pow(10, 9 + arg5 - v2) as u128) / (arg4 as u128);
        assert!(v3 < 18446744073709551615, 122);
        let v4 = (v3 as u64);
        ...
        0x2::coin::take<T1>(get_balance_mut<T1>(v5), v4, arg6)
    }
