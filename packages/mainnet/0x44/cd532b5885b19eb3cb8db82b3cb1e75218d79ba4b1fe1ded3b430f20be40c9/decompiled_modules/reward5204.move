module 0x44cd532b5885b19eb3cb8db82b3cb1e75218d79ba4b1fe1ded3b430f20be40c9::reward5204 {
    struct REWARD5204 has drop {
        dummy_field: bool,
    }

    struct TICKET_5204 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5204(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5204>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5204>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5204, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5204>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5204>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5204>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5204>>(v5, 0x2::tx_context::sender(arg1));
    }
