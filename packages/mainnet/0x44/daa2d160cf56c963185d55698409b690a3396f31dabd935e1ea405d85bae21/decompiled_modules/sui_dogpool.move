module 0x44daa2d160cf56c963185d55698409b690a3396f31dabd935e1ea405d85bae21::sui_dogpool {
    ...
    fun init(arg0: SUI_DOGPOOL, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SUI_DOGPOOL>(arg0, 9, b"DOGPOOL", b"Sui DogPool", b"The SUI top meme dog is here! The badass hero/villain that combines crypto and memes together!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://pbs.twimg.com/profile_images/1839075561508892672/QxWo-trT_400x400.jpg")), arg1);
