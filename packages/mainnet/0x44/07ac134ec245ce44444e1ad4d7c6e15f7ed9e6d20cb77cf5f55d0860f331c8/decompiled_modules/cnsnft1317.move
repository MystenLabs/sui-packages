module 0x4407ac134ec245ce44444e1ad4d7c6e15f7ed9e6d20cb77cf5f55d0860f331c8::cnsnft1317 {
    struct CNSNFT1317 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1317, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTHHbY5SiMQA1nsLh5fvk9ifWsX9QGoSyrVnBBoBZEw1C?ref=6679"));
        let v4 = 0x2::package::claim<CNSNFT1317>(arg0, arg1);
