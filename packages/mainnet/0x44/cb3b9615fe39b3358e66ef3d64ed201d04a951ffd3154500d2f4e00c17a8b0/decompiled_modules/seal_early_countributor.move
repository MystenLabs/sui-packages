module 0x44cb3b9615fe39b3358e66ef3d64ed201d04a951ffd3154500d2f4e00c17a8b0::seal_early_countributor {
    struct SEAL_EARLY_COUNTRIBUTOR has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SEAL_EARLY_COUNTRIBUTOR, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SEAL_EARLY_COUNTRIBUTOR>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Seal early countributor"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Seal Early Contributor"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreigyvyjm7si7uzsqbtgg4d26bwwue5jccgnh7zyjqjwafvxitzqbgu"));
