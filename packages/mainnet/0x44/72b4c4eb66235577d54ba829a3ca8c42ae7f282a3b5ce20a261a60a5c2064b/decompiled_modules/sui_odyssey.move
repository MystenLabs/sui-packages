module 0x4472b4c4eb66235577d54ba829a3ca8c42ae7f282a3b5ce20a261a60a5c2064b::sui_odyssey {
    ...
    public entry fun whitelist_mint(arg0: &mut SuiOdysseyMintGlobal, arg1: vector<vector<u8>>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(0x4472b4c4eb66235577d54ba829a3ca8c42ae7f282a3b5ce20a261a60a5c2064b::utils::verify_calldata(arg1, arg0.whitelist_hash, 0x1::bcs::to_bytes<address>(&v0)), 4);
