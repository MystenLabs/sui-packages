module 0x44a8dbf51c7cc0cc9049ec9e400fd9cfe3ef8ce7693d28115cf6bc0754e453f1::jellyfish {
    ...
    fun init(arg0: JELLYFISH, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = &mut v3;
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"TEst Steampunk Jellyfish #{nr}"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Test Tier {tier}"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"https://axelra.net/nft/jelly{index}.png"));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Test These Steampunk Jellyfish are small, adaptable, smart and creative creatures that use their superpowers to defy the dangers in the depths of the ocean and have a lot of fun doing it."));
        0x1::vector::push_back<0x1::string::String>(v4, 0x1::string::utf8(b"Test Axelra Early Stage AG"));
        ...
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Blue Ocean"));
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Mystic Orange"));
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Green Depth"));
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Pink Glow"));
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Turquoise Light"));
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Dark Red Ocean"));
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Dark Ocean"));
        0x1::vector::push_back<0x1::string::String>(&mut v15, 0x1::string::utf8(b"Yellow Glow"));
        let v16 = 0x1::vector::empty<0x1::string::String>();
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"Team"));
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"Green Laser"));
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"Orange Laser"));
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"Pink Laser"));
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"Turquoise Laser"));
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"Mechanical Glasses"));
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"Binoculars"));
        0x1::vector::push_back<0x1::string::String>(&mut v16, 0x1::string::utf8(b"One-eyed"));
        ...
        let v21 = Features{
            name   : 0x1::string::utf8(b"Glasses"),
            traits : v16,
        };
    ...
    fun mintInternal(arg0: &mut ContractInfo, arg1: u8, arg2: u16, arg3: 0x1::string::String, arg4: address, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x2::kiosk::KioskOwnerCap, arg7: bool, arg8: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        if (arg2 == 0) {
            arg2 = ((0x44a8dbf51c7cc0cc9049ec9e400fd9cfe3ef8ce7693d28115cf6bc0754e453f1::pseudorandom::rand_u32(arg8) % 65535) as u16);
        };
