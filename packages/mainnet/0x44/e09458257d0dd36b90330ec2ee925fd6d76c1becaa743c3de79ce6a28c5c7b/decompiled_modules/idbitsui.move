module 0x44e09458257d0dd36b90330ec2ee925fd6d76c1becaa743c3de79ce6a28c5c7b::idbitsui {
    ...
    public entry fun admin_burn(arg0: &mut 0x2::coin::TreasuryCap<IDBITSUI>, arg1: 0x2::coin::Coin<IDBITSUI>, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun bridge_burn(arg0: &mut 0x2::coin::TreasuryCap<IDBITSUI>, arg1: &BridgeCap, arg2: &Config, arg3: 0x2::coin::Coin<IDBITSUI>, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun bridge_mint_to(arg0: &AdminCap, arg1: &mut 0x2::coin::TreasuryCap<IDBITSUI>, arg2: &BridgeCap, arg3: &Config, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun grant_bridge(arg0: &AdminCap, arg1: BridgeCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<BridgeCap>(arg1, arg2);
    }

    public entry fun grant_minter(arg0: &AdminCap, arg1: MinterCap, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun mint_to(arg0: &AdminCap, arg1: &mut 0x2::coin::TreasuryCap<IDBITSUI>, arg2: &MinterCap, arg3: address, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun register_for(arg0: address, arg1: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<IDBITSUI>>(0x2::coin::zero<IDBITSUI>(arg1), arg0);
    }

    public entry fun set_bridge_operator(arg0: &AdminCap, arg1: &mut Config, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        arg1.bridge_operator = arg2;
    }

    public entry fun set_pause_mint(arg0: &mut AdminCap, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        arg0.paused_mint = arg1;
        let v0 = PausedMint{paused: arg1};
        0x2::event::emit<PausedMint>(v0);
    }

    public entry fun set_version(arg0: &AdminCap, arg1: &mut Version, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        arg1.major = arg2;
        arg1.minor = arg3;
        arg1.patch = arg4;
        let v0 = Upgraded{
