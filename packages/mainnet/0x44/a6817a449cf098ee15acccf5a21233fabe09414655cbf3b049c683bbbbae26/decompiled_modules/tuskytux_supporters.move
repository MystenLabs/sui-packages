module 0x44a6817a449cf098ee15acccf5a21233fabe09414655cbf3b049c683bbbbae26::tuskytux_supporters {
    struct TUSKYTUX_SUPPORTERS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: TUSKYTUX_SUPPORTERS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<TUSKYTUX_SUPPORTERS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"TuskyTux Supporters"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Show your support for TuskyTux, the innovative project bringing decentralized storage vaults to your Linux servers and desktops! This limited collection of three unique NFTs celebrates the fusion of the sturdy walrus and the dependable Tux penguin, representing the secure and user-friendly integration of decentralized storage into the Linux ecosystem. By acquiring a TuskyTux NFT, you're not just owning a unique digital collectible; you're directly contributing to the ongoing development and maintenance of a tool that empowers Linux users with seamless access to their decentralized vaults. Thank you for being a vital part of the TuskyTux community!"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeierbjwskz67w7nl225fr2u4jygewn5txbvgfsbhqygufrro66cczi"));
