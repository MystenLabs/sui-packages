module 0x448c8845fa6f162602ce61b4466b1be0309d61d11e043b4f363624c4ce3283f7::simple_token {
    struct SIMPLE_TOKEN has drop {
        dummy_field: bool,
    }

    fun create_currency<T0: drop>(arg0: T0, arg1: &mut 0x2::tx_context::TxContext) : 0x2::coin::TreasuryCap<T0> {
        let (v0, v1) = 0x2::coin::create_currency<T0>(arg0, 9, b"GPT4", b"GPT4", b"Official token. Banner on Dexscreener paid and Boost!", 0x1::option::none<0x2::url::Url>(), arg1);
