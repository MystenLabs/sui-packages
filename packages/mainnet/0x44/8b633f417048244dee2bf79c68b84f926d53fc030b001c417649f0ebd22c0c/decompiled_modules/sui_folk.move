module 0x448b633f417048244dee2bf79c68b84f926d53fc030b001c417649f0ebd22c0c::sui_folk {
    struct SUI_FOLK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI_FOLK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<SUI_FOLK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"SUI Folk"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"SUI Folk: 20 pixel art NFTs inspired by Viking folklore, forged for the Sui blockchain. Collect your legacy, block by block."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiaxhcl3on6dkhi6wyjrrjtsbv6ca4ysiljn7aasrywlxz3jdxzy7y"));
