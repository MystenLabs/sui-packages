module 0x4478cd3df4493b17f7681d97dbdc37b5ce16683f5bd75fdaeb4e7fc5f37be83f::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"TMT", b"Timur token", b"my super token", 0x1::option::none<0x2::url::Url>(), arg1);
