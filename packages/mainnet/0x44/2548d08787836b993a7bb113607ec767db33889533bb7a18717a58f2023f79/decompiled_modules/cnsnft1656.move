module 0x442548d08787836b993a7bb113607ec767db33889533bb7a18717a58f2023f79::cnsnft1656 {
    struct CNSNFT1656 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1656, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1656>(arg0, arg1);
