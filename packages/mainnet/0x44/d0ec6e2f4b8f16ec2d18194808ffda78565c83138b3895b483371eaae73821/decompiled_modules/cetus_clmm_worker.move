module 0xf74d70ad742dcbb0f75dc75312b3e7f2a5dd0b9f01634565289cbb6a6eb812c0::cetus_clmm_worker {
    ...
    public fun collect_reward_one_other<T0, T1, T2, T3>(arg0: &mut WorkerInfo<T0, T1, T2>, arg1: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg2: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::rewarder::RewarderGlobalVault, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg4: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T3>, arg5: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T1, T3>, arg6: bool, arg7: bool, arg8: bool, arg9: bool, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        checked_package_version<T0, T1, T2>(arg0);
        if (arg6) {
            let v0 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_reward<T0, T1, T0>(arg1, arg3, 0x1::option::borrow<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg0.position_nft), arg2, true, arg10);
            let v1 = 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T0>(&v0), arg0.reinvest_bounty_bps, 10000);
            if (0x2::balance::value<T0>(&v0) >= v1) {
                0x2::balance::join<T0>(&mut arg0.tiny_coin_base_bounty, 0x2::balance::split<T0>(&mut v0, v1));
            };
            0x2::balance::join<T0>(&mut arg0.tiny_coin_base, v0);
        };
        if (arg7) {
            let v2 = 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::collect_reward<T0, T1, T1>(arg1, arg3, 0x1::option::borrow<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&arg0.position_nft), arg2, true, arg10);
            let v3 = 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T1>(&v2), arg0.reinvest_bounty_bps, 10000);
            if (0x2::balance::value<T1>(&v2) >= v3) {
                0x2::balance::join<T1>(&mut arg0.tiny_coin_farming_bounty, 0x2::balance::split<T1>(&mut v2, v3));
            };
            0x2::balance::join<T1>(&mut arg0.tiny_coin_farming, v2);
        };
        if (arg8) {
            ...
            if (v5 > 0) {
                if (arg9) {
                    ...
                    let (v10, v11) = 0xb40b95dfee63de4d308b5b3118d1f127950d15184cad3ee762bba7594f26dd40::cetus_clmm_utils::swap_exact<T1, T3>(arg1, arg5, 0x2::coin::zero<T1>(arg11), 0x2::coin::from_balance<T3>(v4, arg11), false, true, v5, arg10, arg11);
                    0x2::coin::destroy_zero<T3>(v11);
                    let v12 = 0x2::coin::into_balance<T1>(v10);
                    let v13 = 0x9ec6f17e19c5e64c8872779a635235497fd6c71f7b5c23b07f652b02a240c84a::mole_math::mul_div(0x2::balance::value<T1>(&v12), arg0.reinvest_bounty_bps, 10000);
                    if (0x2::balance::value<T1>(&v12) >= v13) {
                        0x2::balance::join<T1>(&mut arg0.tiny_coin_farming_bounty, 0x2::balance::split<T1>(&mut v12, v13));
                    };
                    0x2::balance::join<T1>(&mut arg0.tiny_coin_farming, v12);
                };
            } else {
