module 0x63081c5dd824a49289b6557d9f9bcf8613fe801e89dbad728616348a58b4b40a::iplayer {
    ...
    public(friend) fun add_reg_df(arg0: &mut PlayersRegistry, arg1: 0x1::string::String, arg2: u128, arg3: 0x1::string::String, arg4: bool) {
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, arg1)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, u128>(&mut arg0.id, arg1) = arg2;
        } else {
            0x2::dynamic_field::add<0x1::string::String, u128>(&mut arg0.id, arg1, arg2);
        };
        if (0x2::dynamic_field::exists_<0x1::string::String>(&arg0.id, arg3)) {
            *0x2::dynamic_field::borrow_mut<0x1::string::String, bool>(&mut arg0.id, arg3) = arg4;
        } else {
            0x2::dynamic_field::add<0x1::string::String, bool>(&mut arg0.id, arg3, arg4);
        };
    }

    public(friend) fun borrow_df_value(arg0: &PlayersRegistry, arg1: 0x1::string::String, arg2: 0x1::string::String) : (u128, bool) {
        (*0x2::dynamic_field::borrow<0x1::string::String, u128>(&arg0.id, arg1), *0x2::dynamic_field::borrow<0x1::string::String, bool>(&arg0.id, arg2))
    }
    ...
    public(friend) fun set_player_address(arg0: &mut Player, arg1: address) {
        arg0.player_address = arg1;
    }
