module 0x44448dbb2b9e685ef070125725ab5263c3fc6a6acc11820550187e7759101d6d::retrosui {
    ...
    fun init(arg0: RETROSUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreiai3lvtdfju2kutzzttuwiuskmjyd5i5r7rr2miaockdgvcdlgnqq"));
