module 0x44a5d89f8b22fe477cfb66f1957347c861c075680d3dfffcef9e95ff742b4678::launchpad {
    ...
    fun do_sell<T0>(arg0: &mut LaunchpadManager<T0>, arg1: MemeBalance, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public entry fun sell_meme_partial<T0>(arg0: &mut LaunchpadManager<T0>, arg1: MemeBalance, arg2: u64, arg3: address, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = arg1.amount;
        ...
        if (arg2 == v0) {
            ...
            0x2::transfer::public_transfer<MemeBalance>(v9, v1);
            let v10 = MemeBalance{
                id         : 0x2::object::new(arg4),
                token_id   : v4,
                manager_id : v5,
