module 0x444ff4ebca7260deb1e5e855a9c332c0a5ef176be13d13e96244c5688340409a::events {
    ...
    public(friend) fun emit_add_registry_event<T0>(arg0: vector<u8>, arg1: &0x2::tx_context::TxContext) {
        let v0 = AddRegistryEvent{
            ...
            xasset_type : 0x1::ascii::string(0x444ff4ebca7260deb1e5e855a9c332c0a5ef176be13d13e96244c5688340409a::utils::type_to_bytes<T0>()),
            price_id    : arg0,
        };
