module 0x444ff4ebca7260deb1e5e855a9c332c0a5ef176be13d13e96244c5688340409a::treasury {
    ...
    fun check_version(arg0: &Treasury) {
        0x444ff4ebca7260deb1e5e855a9c332c0a5ef176be13d13e96244c5688340409a::version::check_version(arg0.version);
    }

    public(friend) fun create_treasury(arg0: &mut 0x2::tx_context::TxContext) : Treasury {
        Treasury{
            id      : 0x2::object::new(arg0),
            version : 0x444ff4ebca7260deb1e5e855a9c332c0a5ef176be13d13e96244c5688340409a::version::current_version(),
    ...
    public fun withdraw<T0>(arg0: &0x444ff4ebca7260deb1e5e855a9c332c0a5ef176be13d13e96244c5688340409a::admin::AdminCap, arg1: &mut Treasury, arg2: &mut 0x2::tx_context::TxContext) {
        check_version(arg1);
    ...
    public fun withdraw_some<T0>(arg0: &0x444ff4ebca7260deb1e5e855a9c332c0a5ef176be13d13e96244c5688340409a::admin::AdminCap, arg1: &mut Treasury, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        check_version(arg1);
