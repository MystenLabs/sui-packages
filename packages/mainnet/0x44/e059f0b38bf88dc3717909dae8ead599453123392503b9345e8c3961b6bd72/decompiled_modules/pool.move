module 0x44e059f0b38bf88dc3717909dae8ead599453123392503b9345e8c3961b6bd72::pool {
    ...
    public fun add_liquidity<T0, T1>(arg0: &mut Pool<T0, T1>, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::increase_supply<LSP<T0, T1>>(&mut arg0.lsp_supply, 0x1::u64::min(0x2::balance::value<0x2::sui::SUI>(&v0) * v4 / v2, 0x2::balance::value<T1>(&v1) * v4 / v3)), arg3)
    }
    ...
    public fun create_pool<T0: drop, T1>(arg0: T0, arg1: 0x2::coin::Coin<T1>, arg2: 0x2::coin::Coin<0x2::sui::SUI>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<LSP<T0, T1>> {
        ...
        0x2::coin::from_balance<LSP<T0, T1>>(0x2::balance::increase_supply<LSP<T0, T1>>(&mut v3, 0x1::u64::sqrt(v0) * 0x1::u64::sqrt(v1)), arg4)
    }
