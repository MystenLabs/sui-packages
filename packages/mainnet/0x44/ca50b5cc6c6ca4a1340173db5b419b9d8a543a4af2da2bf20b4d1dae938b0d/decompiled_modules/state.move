module 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::state {
    ...
    fun cal_sqrt_price(arg0: u256, arg1: 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::I128, arg2: u256) : u256 {
        ...
        let v1 = if (0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::is_neg(arg1)) {
            0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::sqrt(v0 * v0 + 4 * arg0 * arg2) - v0
        } else {
            0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::sqrt(v0 * v0 + 4 * arg0 * arg2) + v0
        };
        (v1 << 64) / 2 * arg0
    ...
    public fun solve_one_for_zero(arg0: &SwapState) : u256 {
        ...
        let v3 = 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_price * 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::constants::max_fee_pips_u256() / v0);
        let v4 = arg0.amount_y_desired + v3 - 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(arg0.liquidity, arg0.sqrt_ratio_lower);
        assert!(v4 > arg0.amount_y_desired, 0);
        0x1::u256::max(cal_sqrt_price(v2 - v1 * 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::constants::max_fee_pips_u256() / v0 * arg0.sqrt_ratio_upper, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(v2, arg0.sqrt_ratio_lower) as u128)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from(((arg0.fee_pips * arg0.liquidity / v0) as u128))), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((((arg0.amount_y_desired + v3 << 64) / arg0.sqrt_ratio_upper) as u128))), v4), arg0.sqrt_price)
    }
    ...
    public fun solve_zero_for_one(arg0: &SwapState) : u256 {
        ...
        0x1::u256::min(cal_sqrt_price(v3, 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::sub(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::add(0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(arg0.amount_x_desired + v2, arg0.sqrt_ratio_lower) as u128)), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from(((arg0.fee_pips * arg0.liquidity / v0) as u128))), 0x3637b7b60978ef4389124f7683456f0050ab015a0590d52b6e6cadb342af34a::i128::from((((v4 << 64) / arg0.sqrt_ratio_upper) as u128))), v4 - 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::safe_math::mul_div_Q64(arg0.liquidity, 0x61ad0632db24fe95f8a3e9dfa51eb7e74678a6acbbe54b03cc78ad2834109e19::constants::max_fee_pips_u256() * arg0.sqrt_ratio_lower / v0)), arg0.sqrt_price)
    }
