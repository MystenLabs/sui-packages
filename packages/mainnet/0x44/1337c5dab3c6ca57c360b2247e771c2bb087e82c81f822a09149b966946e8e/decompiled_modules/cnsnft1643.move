module 0x441337c5dab3c6ca57c360b2247e771c2bb087e82c81f822a09149b966946e8e::cnsnft1643 {
    struct CNSNFT1643 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1643, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=7217"));
        let v4 = 0x2::package::claim<CNSNFT1643>(arg0, arg1);
