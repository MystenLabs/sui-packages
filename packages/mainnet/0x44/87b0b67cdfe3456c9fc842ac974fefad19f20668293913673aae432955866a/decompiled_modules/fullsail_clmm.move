module 0x4487b0b67cdfe3456c9fc842ac974fefad19f20668293913673aae432955866a::fullsail_clmm {
    public fun fullsail_clmm_add_liquidity<T0, T1>(arg0: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::Pool<T0, T1>, arg1: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::rewarder::RewarderGlobalVault, arg2: &0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::config::GlobalConfig, arg3: &0x2::clock::Clock, arg4: &mut 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::position::Position, arg5: 0x2::coin::Coin<T0>, arg6: 0x2::coin::Coin<T1>, arg7: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, 0x2::coin::Coin<T1>) {
        ...
        let v4 = 0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::pool::current_sqrt_price<T0, T1>(arg0);
        let v5 = 0;
        let v6 = 0;
        if (v4 < v3) {
            let v7 = if (v4 <= v2) {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_a(v2, v3, 0x2::coin::value<T0>(&arg5), false)
            } else {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_a(v4, v3, 0x2::coin::value<T0>(&arg5), false)
            };
            v5 = v7;
        };
        if (v4 > v2) {
            let v8 = if (v4 >= v3) {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_b(v2, v3, 0x2::coin::value<T1>(&arg6), false)
            } else {
                0xe74104c66dd9f16b3096db2cc00300e556aa92edc871be4bc052b5dfb80db239::clmm_math::get_liquidity_from_b(v2, v4, 0x2::coin::value<T1>(&arg6), false)
            };
            v6 = v8;
        };
        let v9 = if (v4 <= v2) {
