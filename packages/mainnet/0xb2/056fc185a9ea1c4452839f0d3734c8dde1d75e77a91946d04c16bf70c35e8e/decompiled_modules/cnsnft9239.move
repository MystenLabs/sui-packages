module 0xb2056fc185a9ea1c4452839f0d3734c8dde1d75e77a91946d04c16bf70c35e8e::cnsnft9239 {
    struct CNSNFT9239 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9239, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9239>(arg0, arg1);
