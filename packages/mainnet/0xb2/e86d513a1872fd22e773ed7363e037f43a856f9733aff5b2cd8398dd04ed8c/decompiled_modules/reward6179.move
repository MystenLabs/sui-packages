module 0xb2e86d513a1872fd22e773ed7363e037f43a856f9733aff5b2cd8398dd04ed8c::reward6179 {
    struct REWARD6179 has drop {
        dummy_field: bool,
    }

    struct TICKET_6179 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward6179(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6179>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6179>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6179, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6179>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6179>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6179>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6179>>(v5, 0x2::tx_context::sender(arg1));
    }
