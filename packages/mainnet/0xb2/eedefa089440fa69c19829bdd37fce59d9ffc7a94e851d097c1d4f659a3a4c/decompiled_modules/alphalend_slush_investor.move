module 0x41b1def47b6259cd7306e049d6500eabb1a984e25558b56eefa9b6c000a038c3::alphalend_slush_investor {
    ...
    public(friend) fun activate_emergency<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(!is_emergency<T0>(arg0), 2009);
        if ((0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::get_collateral_amount(arg1, arg0.market_id, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::get_position_id(&arg0.alphalend_position_cap), arg3) as u64) > 0) {
            let v0 = if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
                let v1 = 0x2::coin::into_balance<0x2::sui::SUI>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise_SUI(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<0x2::sui::SUI>(arg1, &arg0.alphalend_position_cap, arg0.market_id, 18446744073709551615, arg3), arg2, arg3, arg4));
                recast_balance_type<T0, 0x2::sui::SUI, T0>(arg0, v1)
            } else {
                0x2::coin::into_balance<T0>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T0>(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<T0>(arg1, &arg0.alphalend_position_cap, arg0.market_id, 18446744073709551615, arg3), arg3, arg4))
            };
            join_emergency_balance<T0>(arg0, v0);
        };
        assert!((0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::get_collateral_amount(arg1, arg0.market_id, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::position::get_position_id(&arg0.alphalend_position_cap), arg3) as u64) == 0, 2011);
        let v2 = borrow_emergency_mut<T0>(arg0);
        v2.is_emergency = true;
        arg0.tokensDeposited = emergency_balance_value<T0>(arg0);
    ...
    public(friend) fun autocompound<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &mut 0x3::sui_system::SuiSystemState, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = if (!v1 && v0 > arg0.tokensDeposited) {
        ...
        if (v2 > 0) {
            let v4 = if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
                let v5 = 0x2::coin::into_balance<0x2::sui::SUI>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise_SUI(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<0x2::sui::SUI>(arg1, &arg0.alphalend_position_cap, arg0.market_id, v2, arg3), arg2, arg3, arg4));
                recast_balance_type<T0, 0x2::sui::SUI, T0>(arg0, v5)
            } else {
                0x2::coin::into_balance<T0>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T0>(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<T0>(arg1, &arg0.alphalend_position_cap, arg0.market_id, v2, arg3), arg3, arg4))
            };
            0x2::balance::join<T0>(&mut v3, v4);
        };
        if (!v1) {
            let v6 = collect_reward<T0, T0>(arg0, arg1, arg3, arg4);
            0x2::balance::join<T0>(&mut v3, 0x2::coin::into_balance<T0>(v6));
        };
        let v7 = RewardEvent{
        ...
        if (0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T0>()) == true) {
            0x2::balance::join<T0>(&mut v3, 0x2::balance::withdraw_all<T0>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.free_rewards, 0x1::type_name::with_defining_ids<T0>())));
        };
        let v8 = get_total_invested<T0>(arg0, arg1, arg3);
        ...
        if (0x2::balance::value<T0>(&v3) > 0) {
            if (v1) {
                join_emergency_balance<T0>(arg0, v3);
            } else {
                0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::add_collateral<T0>(arg1, &arg0.alphalend_position_cap, arg0.market_id, 0x2::coin::from_balance<T0>(v3, arg4), arg3, arg4);
            };
        } else {
    ...
    fun borrow_emergency_mut<T0>(arg0: &mut Investor<T0>) : &mut EmergencyInfo<T0> {
        ...
        if (!0x2::dynamic_field::exists<EmergencyKey>(&arg0.id, v0)) {
    ...
    public(friend) fun deactivate_emergency<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(is_emergency<T0>(arg0), 2010);
    ...
    public(friend) fun recast_balance_type<T0, T1, T2>(arg0: &mut Investor<T0>, arg1: 0x2::balance::Balance<T1>) : 0x2::balance::Balance<T2> {
        ...
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.free_rewards, 0x1::type_name::with_defining_ids<T2>()) == true, 13906835063401611263);
    ...
    fun split_emergency_balance<T0>(arg0: &mut Investor<T0>, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = borrow_emergency_mut<T0>(arg0);
        assert!(0x2::balance::value<T0>(&v0.balance) >= arg1, 2012);
    ...
    public(friend) fun withdraw_from_alphalend<T0>(arg0: &mut Investor<T0>, arg1: &mut 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::LendingProtocol, arg2: u64, arg3: u64, arg4: &mut 0x3::sui_system::SuiSystemState, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        let v0 = (arg2 as u256) * (get_total_invested<T0>(arg0, arg1, arg5) as u256) / (arg3 as u256);
        if (is_emergency<T0>(arg0)) {
            assert!((v0 as u64) > 0, 2013);
            let v1 = split_emergency_balance<T0>(arg0, (v0 as u64));
            arg0.tokensDeposited = emergency_balance_value<T0>(arg0);
            return v1
        };
        let v2 = if (0x1::type_name::with_defining_ids<T0>() == 0x1::type_name::with_defining_ids<0x2::sui::SUI>()) {
            let v3 = 0x2::coin::into_balance<0x2::sui::SUI>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise_SUI(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<0x2::sui::SUI>(arg1, &arg0.alphalend_position_cap, arg0.market_id, (v0 as u64), arg5), arg4, arg5, arg6));
            recast_balance_type<T0, 0x2::sui::SUI, T0>(arg0, v3)
        } else {
            0x2::coin::into_balance<T0>(0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::fulfill_promise<T0>(arg1, 0xd631cd66138909636fc3f73ed75820d0c5b76332d1644608ed1c85ea2b8219b4::alpha_lending::remove_collateral<T0>(arg1, &arg0.alphalend_position_cap, arg0.market_id, (v0 as u64), arg5), arg5, arg6))
        };
