module 0x8513d4a794b76bbb2af9e0181df2794ffbcac7b507764fd8dfe8585b3a2ed157::universal_router {
    ...
    public fun settle<T0, T1>(arg0: &mut Treasury, arg1: Route, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        check_amount_threshold<T1>(&v1, 0x8513d4a794b76bbb2af9e0181df2794ffbcac7b507764fd8dfe8585b3a2ed157::math::mul_div(1000000 - v5, v4, 1000000));
        let v10 = &mut v1;
