module 0xb22f32cc1bfa81a3b02c749d6d279dc8874cd5cd040ff7f65496ad555f6ac506::token_factory {
    ...
    fun init(arg0: TOKEN_FACTORY, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_FACTORY>(arg0, 6, b"PNMA", b"PNEUMA Token", b"Test Token for Pool Creation", 0x1::option::none<0x2::url::Url>(), arg1);
