module 0xb286fe8e3313200e909df6d0f6846438f2fe3f13b8b01b72e8ec0d484cb591a9::tradeport_listings {
    ...
    struct AddFeaturedListingEvent has copy, drop {
        nft_id: 0x2::object::ID,
    ...
    entry fun add_featured_listing<T0: store + key>(arg0: &mut Store, arg1: &0x2::clock::Clock, arg2: 0x2::object::ID, arg3: u64, arg4: 0x2::coin::Coin<0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb846e2f900e7::usdc::USDC>, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v9 = AddFeaturedListingEvent{
            nft_id    : arg2,
            nft_type  : v1,
            period    : arg3,
        ...
        0x2::event::emit<AddFeaturedListingEvent>(v9);
    }
