module 0xb272c7861ddb13e3517775b7d0336684e869f47fb48c0906d9d0cb00ed173278::toilet_club_alpha_pass {
    ...
    fun init(arg0: TOILET_CLUB_ALPHA_PASS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Early access to the alpha ecosystem. A prestigious pass for committed pioneers."));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafkreifwsjl5vy42yykpabf4znzdcpw62cgwn2pnroocv73rfsjyovs2we"));
