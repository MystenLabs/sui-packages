module 0xb2b63887a9f17dfca7b026561ed35a8b1080731823020c5abfcbd180190d4681::token_template {
    struct TOKEN_TEMPLATE has drop {
        dummy_field: bool,
    }

    fun init(arg0: TOKEN_TEMPLATE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<TOKEN_TEMPLATE>(arg0, 9, b"BT2121542", b"BatchToken2 121542", b"Second parallel deployment", 0x1::option::none<0x2::url::Url>(), arg1);
