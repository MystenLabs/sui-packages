module 0xb28903114a1416d1a43ee6076de07d29705a4dc41a1fca914e3c3ae05e46716c::pastel_logic {
    struct PASTEL_LOGIC has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: PASTEL_LOGIC, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<PASTEL_LOGIC>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Pastel Logic"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeia3yiqxb3u5reedradqqrys5my73m7kxiubkedsvh6isqtfnsf6ye"));
