module 0xb2814fd84ab77a32b4a23e5fffd25adb3dfbe5f1f8a210d67f08f5c05f36c277::cetus_reward_w6 {
    struct CETUS_REWARD_W6 has drop {
        dummy_field: bool,
    }
    ...
    public entry fun DisperseNFT(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_REWARD{
                ...
                image_url : 0x1::string::utf8(b"ipfs://Qmb3tThT8RyA18ZFJ2fbLAfBv1WJSqERyXr2KEGfXMtCTz"),
            };
    ...
    fun init(arg0: CETUS_REWARD_W6, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://Qmb3tThT8RyA18ZFJ2fbLAfBv1WJSqERyXr2KEGfXMtCTz"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"TBA"));
        let v4 = 0x2::package::claim<CETUS_REWARD_W6>(arg0, arg1);
