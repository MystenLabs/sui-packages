module 0xb2019cc2e46dc22eb80a5189cc4ac3a34450da0ec227a1af1d7fb96fc390db5d::squidsquids {
    ...
    fun init(arg0: SQUIDSQUIDS, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<SQUIDSQUIDS>(arg0, 6, b"SQSQ", b"SQUIDSQUIDS", b"A Rogue Squid accidently Inked the prestine SUI code", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://collection.cloudinary.com/dyjnxznh8/5d1620c3c766577db6114cacb218eef5.png")), arg1);
        let v2 = v0;
    ...
    public entry fun transfer_with_tax(arg0: &mut 0x2::coin::Coin<SQUIDSQUIDS>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = arg1 * 3 / 100;
        let v1 = arg1 - v0;
        0xb2019cc2e46dc22eb80a5189cc4ac3a34450da0ec227a1af1d7fb96fc390db5d::events::emit_transfer_event(0x2::tx_context::sender(arg3), arg2, v1, v0, 0x2::tx_context::epoch(arg3));
