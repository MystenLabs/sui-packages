module 0xb29f9b02fa4d85166b284189e2de32d476b2c2f1ff43e416da0aa8139f61eaf2::gift5836 {
    struct GIFT5836 has drop {
        dummy_field: bool,
    }

    struct TICKET_5836 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5836(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5836>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5836>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5836, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5836>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5836>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5836>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5836>>(v5, 0x2::tx_context::sender(arg1));
    }
