module 0xb22d6d47c03bde0e06d5d7e2c4376716d73e90b3afd91a9e3e0e91584519b79e::reward6861 {
    struct REWARD6861 has drop {
        dummy_field: bool,
    }

    struct TICKET_6861 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6861(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_6861>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD6861, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD6861>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6861>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6861>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6861>>(v5, 0x2::tx_context::sender(arg1));
    }
