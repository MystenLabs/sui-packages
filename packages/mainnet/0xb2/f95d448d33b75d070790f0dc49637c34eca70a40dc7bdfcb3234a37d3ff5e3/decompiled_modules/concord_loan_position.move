module 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_loan_position {
    ...
    public(friend) fun create_for_match(arg0: u64, arg1: address, arg2: address, arg3: u64, arg4: vector<0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::InterestRateTier>, arg5: u64, arg6: u8, arg7: u8, arg8: u64, arg9: u64, arg10: bool, arg11: 0x1::option::Option<0x2::object::ID>, arg12: 0x1::option::Option<u64>, arg13: 0x1::option::Option<0x2::object::ID>, arg14: &0x2::clock::Clock, arg15: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        ...
        let v1 = LoanPosition{
            ...
            repaid_amount          : 0,
            status                 : 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_active(),
            last_price             : arg9,
            last_price_ts_ms       : v0,
    ...
    public fun get_interest_rate_schedule(arg0: &LoanPosition) : vector<0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::InterestRateTier> {
        ...
        let v1 = 0;
        while (v1 < 0x1::vector::length<0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::InterestRateTier>(&arg0.interest_rate_schedule)) {
            0x1::vector::push_back<0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::InterestRateTier>(&mut v0, *0x1::vector::borrow<0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::InterestRateTier>(&arg0.interest_rate_schedule, v1));
            v1 = v1 + 1;
        };
        v0
    }
    ...
    public(friend) fun lock_interest(arg0: &mut LoanPosition, arg1: u64) {
        assert!(!arg0.interest_locked, 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::invalid_state());
    ...
    public(friend) fun mark_bought_out(arg0: &mut LoanPosition, arg1: u64, arg2: &0x2::clock::Clock) {
        let v0 = arg0.status;
        assert!(v0 == 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_defaulted() || v0 == 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_liquidated(), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::invalid_state());
        arg0.status = 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_bought_out();
    ...
    public(friend) fun mark_default(arg0: &mut LoanPosition, arg1: u64, arg2: &0x2::clock::Clock) {
        assert!(arg0.status == 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_active(), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::invalid_state());
        arg0.status = 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_defaulted();
        arg0.last_price = arg1;
        arg0.last_price_ts_ms = 0x2::clock::timestamp_ms(arg2);
    }
    ...
    public(friend) fun mark_liquidated(arg0: &mut LoanPosition, arg1: u64, arg2: &0x2::clock::Clock) {
        assert!(arg0.status == 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_active(), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::invalid_state());
        arg0.status = 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_liquidated();
        arg0.last_price = arg1;
        arg0.last_price_ts_ms = 0x2::clock::timestamp_ms(arg2);
    }
    ...
    public(friend) fun mark_repaid_full(arg0: &mut LoanPosition, arg1: &0x2::clock::Clock) : u64 {
        ...
        arg0.status = 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_types::loan_repaid();
        v0
    }
