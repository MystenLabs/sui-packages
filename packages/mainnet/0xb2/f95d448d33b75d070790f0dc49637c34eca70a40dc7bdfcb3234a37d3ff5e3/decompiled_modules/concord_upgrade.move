module 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_upgrade {
    ...
    public fun authorize_upgrade(arg0: &mut UpgradeGovernance, arg1: &UpgradeGovernanceAdminCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) : 0x2::package::UpgradeTicket {
        ...
        assert!(0x1::option::is_some<PendingUpgrade>(&arg0.pending), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::no_pending_upgrade());
        let v0 = 0x1::option::extract<PendingUpgrade>(&mut arg0.pending);
        let v1 = 0x2::clock::timestamp_ms(arg2);
        assert!(v1 >= v0.proposed_at_ms + arg0.timelock_ms, 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::upgrade_timelock_active());
        let PendingUpgrade {
            digest         : v2,
            policy         : v3,
            proposed_at_ms : _,
        ...
        let v5 = v2;
        0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_events::emit_upgrade_authorized(0x2::object::id<UpgradeGovernance>(arg0), v3, 0x1::vector::length<u8>(&v5), v1);
    ...
    public fun commit_upgrade(arg0: &mut UpgradeGovernance, arg1: &UpgradeGovernanceAdminCap, arg2: 0x2::package::UpgradeReceipt, arg3: &0x2::clock::Clock, arg4: &0x2::tx_context::TxContext) {
        ...
        0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_events::emit_upgrade_committed(0x2::object::id<UpgradeGovernance>(arg0), arg0.nonce, 0x2::package::receipt_package(&arg2), 0x2::clock::timestamp_ms(arg3));
    }
    ...
    fun assert_admin(arg0: &UpgradeGovernance, arg1: &UpgradeGovernanceAdminCap, arg2: &0x2::tx_context::TxContext) {
        assert!(arg1.governance_id == 0x2::object::id<UpgradeGovernance>(arg0), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::wrong_governance());
    ...
    fun assert_version(arg0: &UpgradeGovernance) {
        assert!(arg0.version == 1, 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::wrong_version());
    }
    ...
    public fun cancel_upgrade(arg0: &mut UpgradeGovernance, arg1: &UpgradeGovernanceAdminCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_events::emit_upgrade_cancelled(0x2::object::id<UpgradeGovernance>(arg0), 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun migrate(arg0: &mut UpgradeGovernance, arg1: &UpgradeGovernanceAdminCap, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        assert_admin(arg0, arg1, arg3);
        let v0 = arg0.version;
        assert!(v0 < 1, 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::invalid_state());
        arg0.version = 1;
        0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_events::emit_object_migrated(0x2::object::id<UpgradeGovernance>(arg0), v0, 1, 0x2::clock::timestamp_ms(arg2));
    }
    ...
    public fun propose_upgrade(arg0: &mut UpgradeGovernance, arg1: &UpgradeGovernanceAdminCap, arg2: u8, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<u8>(&arg3) > 0, 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::invalid_argument());
        assert!(0x1::option::is_none<PendingUpgrade>(&arg0.pending), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::upgrade_already_pending());
        assert!(arg2 >= 0x2::package::upgrade_policy(&arg0.cap), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::upgrade_policy_too_permissive());
        ...
        0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_events::emit_upgrade_proposed(0x2::object::id<UpgradeGovernance>(arg0), arg2, pending_digest_length(arg0), v0);
    }
    ...
    public fun restrict_policy(arg0: &mut UpgradeGovernance, arg1: &UpgradeGovernanceAdminCap, arg2: u8, arg3: &0x2::tx_context::TxContext) {
        ...
        if (arg2 == 0x2::package::additive_policy()) {
            ...
            assert!(arg2 == 0x2::package::dep_only_policy(), 0xb2f95d448d33b75d070790f0dc49637c34eca70a40dc7bdfcb3234a37d3ff5e3::concord_errors::invalid_argument());
