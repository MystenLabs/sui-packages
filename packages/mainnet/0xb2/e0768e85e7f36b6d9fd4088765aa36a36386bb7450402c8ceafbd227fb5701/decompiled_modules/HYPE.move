module 0xb2e0768e85e7f36b6d9fd4088765aa36a36386bb7450402c8ceafbd227fb5701::HYPE {
    ...
    fun init(arg0: HYPE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<HYPE>(arg0, 9, b"HYPER", b"Hyper Cat", b"Hyper Cat millions $$$", 0x1::option::none<0x2::url::Url>(), false, arg1);
        let v3 = v0;
