module 0xb27fface42561a5494dce084bfcbca3e6d9880e8b3a168d0813c7fd139872d01::reward7751 {
    struct REWARD7751 has drop {
        dummy_field: bool,
    }

    struct TICKET_7751 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7751(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7751>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7751>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7751, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7751>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7751>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7751>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7751>>(v5, 0x2::tx_context::sender(arg1));
    }
