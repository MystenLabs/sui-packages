module 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::bottle {
    ...
    public(friend) fun add_interest_index_to_bottle(arg0: &mut Bottle, arg1: u256, arg2: &mut 0x2::tx_context::TxContext) {
        if (!is_interest_index_exists(arg0)) {
            0x2::dynamic_object_field::add<vector<u8>, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::BottleInterestIndex>(&mut arg0.id, b"interest_index", 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::new_bottle_interest_index(arg1, arg2));
        };
    }
    ...
    public fun borrow_interest_index(arg0: &Bottle) : &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::BottleInterestIndex {
        assert!(is_interest_index_exists(arg0), 8);
        0x2::dynamic_object_field::borrow<vector<u8>, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::BottleInterestIndex>(&arg0.id, b"interest_index")
    }

    public(friend) fun borrow_interest_index_mut(arg0: &mut Bottle) : &mut 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::BottleInterestIndex {
        assert!(is_interest_index_exists(arg0), 8);
        0x2::dynamic_object_field::borrow_mut<vector<u8>, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::BottleInterestIndex>(&mut arg0.id, b"interest_index")
    }
    ...
    fun compute_buck_value_to_collateral(arg0: u64, arg1: u8, arg2: u64, arg3: u64) : u64 {
        if (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::buck_decimal() >= arg1) {
            0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg0, arg3, arg2) / 0x1::u64::pow(10, 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::buck_decimal() - arg1)
        } else {
            0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::math::mul_factor(arg0, arg3, arg2) * 0x1::u64::pow(10, arg1 - 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::buck_decimal())
        }
    }

    fun compute_new_stake(arg0: &BottleTable, arg1: u64) : u64 {
    ...
    public fun cr_greater_with_interest(arg0: &BottleTable, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: &Bottle, arg3: &Bottle, arg4: &0x2::clock::Clock) : bool {
        let (v0, v1) = if (is_interest_index_exists(arg2)) {
            get_bottle_info_with_interest(arg0, arg2, arg1, arg4)
        } else {
            get_bottle_info(arg0, arg2)
        };
        let (v2, v3) = if (is_interest_index_exists(arg3)) {
            get_bottle_info_with_interest(arg0, arg3, arg1, arg4)
        } else {
            get_bottle_info(arg0, arg3)
        };
        (v0 as u128) * (v3 as u128) > (v2 as u128) * (v1 as u128)
    }
    ...
    public fun cr_less_or_equal_with_interest(arg0: &BottleTable, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: &Bottle, arg3: &Bottle, arg4: &0x2::clock::Clock) : bool {
        let (v0, v1) = if (is_interest_index_exists(arg2)) {
            get_bottle_info_with_interest(arg0, arg2, arg1, arg4)
        } else {
            get_bottle_info(arg0, arg2)
    ...
    fun find_downward_and_insert_with_interest(arg0: &mut BottleTable, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: address, arg3: Bottle, arg4: 0x1::option::Option<address>, arg5: &0x2::clock::Clock) {
        while (0x1::option::is_some<address>(&arg4)) {
            let v0 = *0x1::option::borrow<address>(&arg4);
            if (cr_greater_with_interest(arg0, arg1, &arg3, 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::borrow<address, Bottle>(&arg0.table, v0), arg5)) {
                0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::insert_back<address, Bottle>(&mut arg0.table, arg4, arg2, arg3);
                return
            };
            arg4 = *0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::prev<address, Bottle>(&arg0.table, v0);
        };
        0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::insert_back<address, Bottle>(&mut arg0.table, arg4, arg2, arg3);
    }
    ...
    fun find_upward_and_insert_with_interest(arg0: &mut BottleTable, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: address, arg3: Bottle, arg4: 0x1::option::Option<address>, arg5: &0x2::clock::Clock) {
        while (0x1::option::is_some<address>(&arg4)) {
            let v0 = *0x1::option::borrow<address>(&arg4);
            if (cr_less_or_equal_with_interest(arg0, arg1, &arg3, 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::borrow<address, Bottle>(&arg0.table, v0), arg5)) {
                0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::insert_front<address, Bottle>(&mut arg0.table, arg4, arg2, arg3);
                return
            };
            arg4 = *0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::next<address, Bottle>(&arg0.table, v0);
        };
        0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::insert_front<address, Bottle>(&mut arg0.table, arg4, arg2, arg3);
    }
    ...
    public fun get_bottle_info_with_interest(arg0: &BottleTable, arg1: &Bottle, arg2: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg3: &0x2::clock::Clock) : (u64, u64) {
        (arg1.collateral_amount + get_pending_coll(arg1, arg0), get_debt_amount_with_interest(arg1, arg2, arg1.buck_amount, arg3) + get_pending_debt(arg1, arg0))
    }

    public fun get_bottle_info_with_interest_by_debtor(arg0: &BottleTable, arg1: address, arg2: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg3: &0x2::clock::Clock) : (u64, u64) {
        let v0 = borrow_bottle(arg0, arg1);
        (v0.collateral_amount + get_pending_coll(v0, arg0), get_debt_amount_with_interest(v0, arg2, v0.buck_amount, arg3) + get_pending_debt(v0, arg0))
    }
    ...
    fun get_debt_amount_with_interest(arg0: &Bottle, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: u64, arg3: &0x2::clock::Clock) : u64 {
        if (is_interest_index_exists(arg0)) {
            let v1 = (arg2 as u256);
            let v2 = v1;
            let v3 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::get_bottle_interest_index(borrow_interest_index(arg0));
            if (v3 > 0) {
                let (v4, _) = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::calculate_interest_index(arg1, arg3);
                v2 = 0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::math::mul_factor_u256((v1 as u256), v4, v3);
            };
            assert!(v2 <= (0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::constants::max_u64() as u256), 7);
            (v2 as u64)
        } else {
            arg2
        }
    ...
    public(friend) fun insert_bottle(arg0: &mut BottleTable, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: address, arg3: Bottle, arg4: 0x1::option::Option<address>, arg5: &0x2::clock::Clock) {
        if (0x1::option::is_none<address>(&arg4)) {
            let v0 = *0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::front<address, Bottle>(&arg0.table);
            find_upward_and_insert_with_interest(arg0, arg1, arg2, arg3, v0, arg5);
            return
        };
        let v1 = 0x1::option::destroy_some<address>(arg4);
        assert!(!0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::contains<address, Bottle>(&arg0.table, arg2), 5);
        if (cr_greater_with_interest(arg0, arg1, &arg3, 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::borrow<address, Bottle>(&arg0.table, v1), arg5)) {
            let v2 = *0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::next<address, Bottle>(&arg0.table, v1);
            find_upward_and_insert_with_interest(arg0, arg1, arg2, arg3, v2, arg5);
        } else {
            let v3 = *0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::prev<address, Bottle>(&arg0.table, v1);
            find_downward_and_insert_with_interest(arg0, arg1, arg2, arg3, v3, arg5);
        };
    }

    public fun is_interest_index_exists(arg0: &Bottle) : bool {
        0x2::dynamic_object_field::exists<vector<u8>>(&arg0.id, b"interest_index")
    }

    public(friend) fun new_surplus_bottle(arg0: u64, arg1: &mut 0x2::tx_context::TxContext) : Bottle {
        Bottle{
            id                   : 0x2::object::new(arg1),
    ...
    public fun re_insert_bottle(arg0: &mut BottleTable, arg1: &0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::InterestTable, arg2: address, arg3: &0x2::clock::Clock) {
        let v0 = *0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::prev<address, Bottle>(&arg0.table, arg2);
        let v1 = 0xdb9a10bb9536ab367b7d1ffa404c1d6c55f009076df1139dc108dd86608bbe::linked_table::remove<address, Bottle>(&mut arg0.table, arg2);
        insert_bottle(arg0, arg1, arg2, v1, v0, arg3);
    }
    ...
    public(friend) fun update_bottle_debt_and_interest_index(arg0: &mut Bottle, arg1: u64, arg2: u256) {
        assert!(arg0.buck_amount <= arg1, 6);
        if (is_interest_index_exists(arg0)) {
            arg0.buck_amount = arg1;
            0xce7ff77a83ea0cb6fd39bd8748e2ec89a3f41e8efdc3f4eb123e0ca37b184db2::interest::update_bottle_interest_index(borrow_interest_index_mut(arg0), arg2);
        };
    }
    ...
    public(friend) fun update_stake_and_total_stake(arg0: &mut BottleTable, arg1: &mut Bottle) {
        ...
        let v3 = if (arg0.total_stake >= arg1.stake_amount) {
            arg0.total_stake - arg1.stake_amount
        } else {
            0
        };
        arg0.total_stake = v3 + v2;
    ...
    public(friend) fun update_stake_and_total_stake_by_debtor(arg0: &mut BottleTable, arg1: address) {
        ...
        v3.stake_amount = v2;
        let v5 = if (arg0.total_stake >= v4) {
            arg0.total_stake - v4
        } else {
            0
        };
        arg0.total_stake = v5 + v2;
    }
