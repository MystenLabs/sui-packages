module 0xb247e50badafc4506d552e134729ca3776cdb273b339be9243d085a71bf3f9d9::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0x752f2abf4d843584d0ddb7032eb2f3d543694ff5f340ff99a89519380fff4203::mode::Mode,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0x540185394f156cc2739c0f34b45dd5763762cbf97a4df9bfa27cb0ab5f6e10d2::bytes4::to_bytes(0x540185394f156cc2739c0f34b45dd5763762cbf97a4df9bfa27cb0ab5f6e10d2::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0x752f2abf4d843584d0ddb7032eb2f3d543694ff5f340ff99a89519380fff4203::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x752f2abf4d843584d0ddb7032eb2f3d543694ff5f340ff99a89519380fff4203::mode::serialize(arg0.manager_mode));
