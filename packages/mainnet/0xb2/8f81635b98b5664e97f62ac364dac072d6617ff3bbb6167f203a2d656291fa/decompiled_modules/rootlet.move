module 0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::rootlet {
    ...
    public fun admin_mint(arg0: &mut Sale, arg1: &0x2::transfer_policy::TransferPolicy<Rootlet>, arg2: &mut 0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::CollectionData, arg3: &AdminCap, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.active, 9223373011812351999);
        let (v0, v1, v2, v3) = 0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::get_nft(arg2, 0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::nfts_left(arg2) - 1);
        let v4 = if (0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::is_robot(v0)) {
    ...
    entry fun mint(arg0: &mut Sale, arg1: &0x2::transfer_policy::TransferPolicy<Rootlet>, arg2: &mut 0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::CollectionData, arg3: vector<Pass>, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        while (arg7 > 0) {
            let v0 = if (0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::nfts_left(arg2) == 1) {
                0
            } else {
                0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::pseuso_random::rng(0, 0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::nfts_left(arg2) - 1, arg9)
            };
            let (v1, v2, v3, v4) = 0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::get_nft(arg2, v0);
            let v5 = if (0xb28f81635b98b5664e97f62ac364dac072d6617ff3bbb6167f203a2d656291fa::attributes::is_robot(v1)) {
                0x1::string::utf8(b"Robot")
            } else {
                0x1::string::utf8(b"Rootlets")
            };
        ...
        arg0.total_quantity = arg0.total_quantity - arg7;
    }
    ...
    public fun set_total_quantity(arg0: &mut Sale, arg1: &AdminCap, arg2: u64) {
        assert!(5555 >= arg2, 9223372951682809855);
