module 0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::ions {
    ...
    public fun claim_rewards<T0>(arg0: &0x2::clock::Clock, arg1: &mut AnimaChef, arg2: &mut AnimaIONs, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&arg1.id, b"ANIMA_REWARDS_HOLDER"), 13906836875878662158);
    ...
    fun increment_global_claim_index(arg0: &0x2::clock::Clock, arg1: &mut SeasonRewards) {
        ...
        if (arg1.total_points > 0) {
            arg1.global_claim_index = arg1.global_claim_index + 0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256(((v0 - arg1.last_time) as u256), (arg1.rewards_distribution_rate as u256) * (1000000000 as u256), (arg1.total_points as u256));
        };
        arg1.last_time = v0;
    }

    fun increment_user_claim_index(arg0: &SeasonRewards, arg1: &mut UserSeasonInfo) : u64 {
        let v0 = (0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256(arg0.global_claim_index - arg1.claim_index, (arg1.points_earned as u256), (1000000000 as u256)) as u64);
    ...
    public fun init_new_season<T0>(arg0: &AdminCap, arg1: &mut AnimaChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: u64, arg7: u64) {
        ...
        assert!(0x2::linked_table::borrow<u64, SeasonRewards>(&arg1.season_alloc, arg1.ongoing_season).end_time < v0, 13906835699057098758);
        assert!(arg3 > v0, 13906835711942262794);
        assert!(arg4 > v0 && arg4 > arg3, 13906835716237361164);
        ...
        assert!(v2.total_deposited - v2.allocated_amount >= v4, 13906835827905986564);
    ...
    public fun mint_anima_ions(arg0: &0x2::clock::Clock, arg1: &mut AnimaChef, arg2: 0x1::option::Option<address>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = arg1.ongoing_season;
        assert!(!0x2::linked_table::contains<address, address>(&arg1.anima_ions, v0), 13906836377662849044);
        let v2 = if (0x1::option::is_some<address>(&arg2)) {
            assert!(*0x1::option::borrow<address>(&arg2) != v0, 13906836416317423634);
            arg2
        } else {
            0x1::option::none<address>()
        };
        ...
        if (v0 > 0 && v0 > v1) {
            ...
            let v4 = if (!v2.is_time_based_distribution) {
                if (v2.total_points > 0) {
                    (0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256((v3.points_earned as u256), (v2.rewards_allocated as u256), (v2.total_points as u256)) as u64)
                } else {
                    0
                }
            } else {
                v3.claim_index = v2.global_claim_index;
                (0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256(v2.global_claim_index - v3.claim_index, (v3.points_earned as u256), (1000000000 as u256)) as u64)
            };
            ...
            if (0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v2)) {
                ...
                if (!v5.is_time_based_distribution) {
                    if (v5.total_points > 0) {
                        v4 = v3 + (0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256((v6.points_earned as u256), (v5.rewards_allocated as u256), (v5.total_points as u256)) as u64) - v6.claimed_amount;
                    };
                } else {
                    v4 = v3 + (0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256(v5.global_claim_index - v6.claim_index, (v6.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        if (0x2::linked_table::contains<u64, SeasonRewards>(&arg1.season_alloc, v1) && 0x2::linked_table::contains<u64, UserSeasonInfo>(&arg2.season_info, v1)) {
            ...
            if (!v9 && !(v7.start_time > v0)) {
                if (v7.is_time_based_distribution && v7.total_points > 0) {
                    v4 = v4 + (0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256(v7.global_claim_index + 0xb2f3f2134577e6cd3ef312b099f05e48964301262a1158416143e57358d2e455::math::mul_div_u256(((v0 - v7.last_time) as u256), (((v7.rewards_distribution_rate as u256) * 1000000000) as u256), (v7.total_points as u256)) - v8.claim_index, (v8.points_earned as u256), (1000000000 as u256)) as u64);
                };
            };
        };
        v4
    ...
    public fun update_ongoing_season_rewards<T0>(arg0: &AdminCap, arg1: &mut AnimaChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        ...
        assert!(v1.end_time > v0, 13906836085604286472);
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&arg1.id, b"ANIMA_REWARDS_HOLDER"), 13906836098489581582);
        let v2 = 0x2::dynamic_object_field::borrow_mut<vector<u8>, RewardsHolder<T0>>(&mut arg1.id, b"ANIMA_REWARDS_HOLDER");
        let v3 = 0;
        let v4 = false;
        ...
        if (v4) {
            assert!(v2.total_deposited - v2.allocated_amount >= v3, 13906836270287618052);
    ...
    public fun update_ongoing_season_time(arg0: &AdminCap, arg1: &mut AnimaChef, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64) {
        ...
        let v1 = 0x2::linked_table::borrow_mut<u64, SeasonRewards>(&mut arg1.season_alloc, arg1.ongoing_season);
        if (arg3 > 0) {
            assert!(v1.start_time > v0 && arg3 > v0, 13906835948165464074);
            v1.start_time = arg3;
        };
        if (arg4 > 0) {
            if (v1.end_time == 0) {
                assert!(arg4 > v0, 13906835986820300812);
            } else {
                assert!(v1.end_time > v0 && arg4 > v0, 13906835999705202700);
            };
            v1.end_time = arg4;
        };
    ...
    public fun validation_check(arg0: &mut AnimaChef) {
        assert!(arg0.version == 0, 13906837485764149264);
    }
