module 0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::vault_receipt_info {
    ...
    public(friend) fun update_reward(arg0: &mut VaultReceiptInfo, arg1: 0x1::type_name::TypeName, arg2: u256) : u64 {
        ...
        let v3 = (0xdaeecd2df440aea862e502734be69e9fd9a75aa18b4982a5110792882ad88319::vault_utils::mul_d(arg2 - *v1, arg0.shares) as u64);
        *v1 = arg2;
        *v2 = *v2 + v3;
