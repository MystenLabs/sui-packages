module 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::unlock_schedule {
    ...
    public(friend) fun add_future_unlock_amount(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock) {
        assert!(arg0.refreshed_at == 0x2::clock::timestamp_ms(arg3) / 1000, 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::error_code::should_refresh_first());
    ...
    fun calculate_lock_history_snapshots(arg0: &VeScaUnlockSchedule, arg1: &0x2::clock::Clock) : vector<LockHistorySnapshot> {
        ...
        while (v2 != v1) {
            v2 = 0x2::math::min(v2 + 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::unlock_round_duration() - v2 % 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::unlock_round_duration(), v1);
    ...
    public(friend) fun extend_lock_period(arg0: &mut VeScaUnlockSchedule, arg1: u64, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock) {
        assert!(arg0.refreshed_at == 0x2::clock::timestamp_ms(arg4) / 1000, 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::error_code::should_refresh_first());
        let v0 = nearest_unlock_amount_mut(arg0, arg2);
        *v0 = *v0 - arg1;
    ...
    fun nearest_unlock_amount(arg0: &VeScaUnlockSchedule, arg1: u64) : u64 {
        ...
        if (v0 < 0x1::vector::length<u64>(&arg0.schedule)) {
            *0x1::vector::borrow<u64>(&arg0.schedule, (arg0.schedule_pointer + v0) % 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::max_lock_rounds())
        } else {
            0
        }
    }
    ...
    fun nearest_unlock_amount_mut(arg0: &mut VeScaUnlockSchedule, arg1: u64) : &mut u64 {
        0x1::vector::borrow_mut<u64>(&mut arg0.schedule, (arg0.schedule_pointer + rounds_passed_since_last_refresh(arg0, arg1) - 1) % 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::max_lock_rounds())
    }

    public(friend) fun new() : VeScaUnlockSchedule {
        let v0 = 0x1::vector::empty<u64>();
        let v1 = 0;
        while (v1 < 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::max_lock_rounds()) {
    ...
    fun refresh_unlock_schedule(arg0: &mut VeScaUnlockSchedule, arg1: &0x2::clock::Clock) {
        ...
        while (v1 < rounds_passed_since_last_refresh(arg0, v0)) {
            ...
            arg0.schedule_pointer = (arg0.schedule_pointer + 1) % 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::max_lock_rounds();
    ...
    fun rounds_passed_since_last_refresh(arg0: &VeScaUnlockSchedule, arg1: u64) : u64 {
        arg1 / 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::unlock_round_duration() - arg0.refreshed_at / 0xb220d034bdf335d77ae5bfbf6daf059c2cc7a1f719b12bfed75d1736fac038c8::constants::unlock_round_duration()
    }
