module 0xb2da03d74fbae2e1401b05fe09c2e55579f05033ccc91a4bdc8e5e6893b0084b::cnsnft2264 {
    struct CNSNFT2264 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2264, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2264>(arg0, arg1);
