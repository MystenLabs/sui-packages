module 0xb2bba99ba65bd7b98971621b51ef3d20b4785d173f5c956ed26fcd3264042cc8::reward4493 {
    struct REWARD4493 has drop {
        dummy_field: bool,
    }

    struct TICKET_4493 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4493(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4493>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4493>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4493, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4493>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4493>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4493>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4493>>(v5, 0x2::tx_context::sender(arg1));
    }
