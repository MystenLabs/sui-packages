module 0xb268172d0cd9f637de5dbee79ed473654df31d47f9acf93b7d5ce129101a7e63::luigi {
    ...
    fun init(arg0: LUIGI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/5XyKkFaJpAmsH4Tf2EFj3S61W3hC5cJhxNZQQ5h1pump.png?size=lg&key=7f6a71                                                                                                                                                                                                            ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<LUIGI>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"Luigi   ")))), trim_right(b"Luigi Mangione                  "), trim_right(b"Luigi Mangione (Luigi)                                                                                                                                                                                                                                                                                                          "), v2, arg1);
        let v5 = v3;
