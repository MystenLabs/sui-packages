module 0xb21d7616c12a71a0b5be31e831e3b8c3b16e0a3c898a46fc8cd3e1835cc41804::cnsnft6721 {
    struct CNSNFT6721 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6721, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6721>(arg0, arg1);
