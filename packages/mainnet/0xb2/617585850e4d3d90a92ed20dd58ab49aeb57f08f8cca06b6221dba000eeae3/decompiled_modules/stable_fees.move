module 0xb2617585850e4d3d90a92ed20dd58ab49aeb57f08f8cca06b6221dba000eeae3::stable_fees {
    ...
    public fun update_admin_fee_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        assert!(200000000000000000 >= v0, 0xb2617585850e4d3d90a92ed20dd58ab49aeb57f08f8cca06b6221dba000eeae3::errors::invalid_fee());
    ...
    public fun update_fee_in_percent(arg0: &mut StableFees, arg1: 0x1::option::Option<u256>) {
        ...
        let v0 = 0x1::option::extract<u256>(&mut arg1);
        assert!(20000000000000000 >= v0, 0xb2617585850e4d3d90a92ed20dd58ab49aeb57f08f8cca06b6221dba000eeae3::errors::invalid_fee());
