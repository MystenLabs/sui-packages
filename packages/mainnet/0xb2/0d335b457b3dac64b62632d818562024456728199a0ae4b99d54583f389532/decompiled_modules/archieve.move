module 0xb20d335b457b3dac64b62632d818562024456728199a0ae4b99d54583f389532::archieve {
    ...
    public(friend) fun decreaseBalance(arg0: u64, arg1: &mut UserArchieve) : u64 {
        assert!(arg1.balance >= arg0, 8004);
        arg1.balance = arg1.balance - arg0;
        arg1.balance
    }

    public(friend) fun increaseBalance(arg0: u64, arg1: &mut UserArchieve) : u64 {
        arg1.balance = arg1.balance + arg0;
        arg1.balance
    }
