module 0xb2314cce06fa04c1d7221e51772748df51d160aa8a05cb818d1c8a2dfcbfc585::wormhole_transceiver_info {
    struct WormholeTransceiverInfo has drop {
        ...
        manager_mode: 0xd0ee9e76633b890f04d9a159c58b3e68fbe1af4d1a19e5c3bae0a47cd31a6711::mode::Mode,
    ...
    public fun take_bytes(arg0: &mut 0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::cursor::Cursor<u8>) : WormholeTransceiverInfo {
        assert!(0x6fe3a623aa78c4e7659ee8bac759d0ab949305e0ec6858e2a99670a3e87b249d::bytes4::to_bytes(0x6fe3a623aa78c4e7659ee8bac759d0ab949305e0ec6858e2a99670a3e87b249d::bytes4::take(arg0)) == x"9c23bd3b", 13906834367616974850);
        WormholeTransceiverInfo{
            ...
            manager_mode    : 0xd0ee9e76633b890f04d9a159c58b3e68fbe1af4d1a19e5c3bae0a47cd31a6711::mode::parse(0x5306f64e312b581766351c07af79c72fcb1cd25147157fdc2f8ad76de9a3fb6a::bytes::take_bytes(arg0, 1)),
    ...
    public fun to_bytes(arg0: &WormholeTransceiverInfo) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0xd0ee9e76633b890f04d9a159c58b3e68fbe1af4d1a19e5c3bae0a47cd31a6711::mode::serialize(arg0.manager_mode));
