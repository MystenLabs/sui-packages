module 0xb2093243e2166481bfd37bd53c258d167862faa71315350daa706a9aff28ecd5::verify_ir {
    public(friend) fun verify_and_extract_payload(arg0: vector<u8>, arg1: vector<u8>, arg2: u8) : vector<u8> {
        ...
        let v6 = x"0000000000000000000000003e5ea25e23cd4a10c1202765556fde70937e4a61";
        let v7 = 12;
        while (v7 < 32) {
