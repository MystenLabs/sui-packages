module 0xb25ed638b2e66a5fdcbbdd9c4dd24fbe17316e70c2062c05b304fa87909f6174::inscriptions_collection {
    ...
    public fun mint_inscriptions_nft_v2<T0>(arg0: &mut CollectionConfig, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: u64, arg6: 0x2::coin::Coin<0x2::sui::SUI>, arg7: 0x1::string::String, arg8: &mut 0x2::tx_context::TxContext) : Inscriptions<T0> {
        ...
        if (v0 <= 1000) {
            assert_type_name<T0, 0xb25ed638b2e66a5fdcbbdd9c4dd24fbe17316e70c2062c05b304fa87909f6174::collection::SUB_TEXT_1K>();
        } else if (v0 > 1000 && v0 <= 10000) {
            assert_type_name<T0, 0xb25ed638b2e66a5fdcbbdd9c4dd24fbe17316e70c2062c05b304fa87909f6174::collection::SUB_TEXT_10K>();
        } else if (v0 > 10000 && v0 <= 50000) {
            assert_type_name<T0, 0xb25ed638b2e66a5fdcbbdd9c4dd24fbe17316e70c2062c05b304fa87909f6174::collection::SUB_TEXT_50K>();
        } else if (v0 > 50000 && v0 <= 100000) {
            assert_type_name<T0, 0xb25ed638b2e66a5fdcbbdd9c4dd24fbe17316e70c2062c05b304fa87909f6174::collection::SUB_TEXT_100K>();
        } else if (v0 > 100000 && v0 <= 200000) {
            assert_type_name<T0, 0xb25ed638b2e66a5fdcbbdd9c4dd24fbe17316e70c2062c05b304fa87909f6174::collection::SUB_TEXT_200K>();
        } else if (v0 > 200000 && v0 <= 500000) {
            assert_type_name<T0, 0xb25ed638b2e66a5fdcbbdd9c4dd24fbe17316e70c2062c05b304fa87909f6174::collection::SUB_TEXT_500K>();
        };
        arg0.current_id = v0;
