module 0xb21111cf93708badaccf813aebabd381f7f716daafe6a3e018a2b933c769911e::cnsnft9696 {
    struct CNSNFT9696 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9696, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9696>(arg0, arg1);
