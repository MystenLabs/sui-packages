module 0x7b9640dc7446fdc540a17ce6a0673be6f95447862ea63685daa7594f57f32601::sentra {
    ...
    public entry fun add_to_yield_lock<T0, T1>(arg0: &mut YieldLock<T1>, arg1: &mut Platform, arg2: 0x2::coin::Coin<T1>, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        assert!(v0 == arg0.owner, 1);
        assert!(arg0.strategy == 1, 3);
        let v1 = 0x1::type_name::with_original_ids<T0>();
        ...
        let v3 = calculate_deposit_fee(v2, 0x2::vec_map::get<0x1::type_name::TypeName, TokenFeeConfig>(&arg1.token_fee_configs, &v1));
        assert!(v2 > v3, 8);
        0x2::balance::join<T1>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&mut arg1.deposit_fees, 0x1::type_name::with_original_ids<T1>()), 0x2::coin::into_balance<T1>(0x2::coin::split<T1>(&mut arg2, v3, arg3)));
        let v4 = 0x2::coin::into_balance<T1>(arg2);
        let v5 = 0x2::balance::value<T1>(&v4);
        0x2::balance::join<T1>(&mut arg0.s_coin_balance, v4);
        arg0.principal_amount = arg0.principal_amount + v5;
        update_yield_tvl<T0>(arg1, v5, true);
        let v6 = YieldLockExtended{
            owner                : v0,
            added_amount         : v5,
            deposit_fee_paid     : v3,
            new_s_coin_balance   : 0x2::balance::value<T1>(&arg0.s_coin_balance),
            new_principal_amount : arg0.principal_amount,
            coin_type            : v1,
        };
        0x2::event::emit<YieldLockExtended>(v6);
    }
    ...
    public fun unlock_yield_lock_s_coin<T0>(arg0: &mut YieldLock<T0>, arg1: &Platform, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::coin::take<T0>(&mut arg0.s_coin_balance, 0x2::balance::value<T0>(&arg0.s_coin_balance), arg2)
    }
