module 0xb26d9a0d5b2529ede4e8154d5cc507aa9946c1f2d71bc22a186a3aae5e32a7b1::suigpt_test {
    ...
    struct SUIGPT_TEST has drop {
        dummy_field: bool,
    }

    fun init(arg0: SUIGPT_TEST, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"SuiGPT test"));
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"1736250115707"));
        ...
        let v4 = 0x2::package::claim<SUIGPT_TEST>(arg0, arg1);
