module 0xb2108eef38a3652f219afca106a2ba9195f4d6403e701315a32c2b11c7144f7f::dynamic {
    ...
    public fun coinTypes(arg0: &Vault) : vector<0x1::string::String> {
        let v0 = 0x1::vector::empty<0x1::string::String>();
        let v1 = 0;
        while (v1 < 0x1::vector::length<0x1::type_name::TypeName>(&arg0.coinTypes)) {
            0x1::vector::push_back<0x1::string::String>(&mut v0, 0x1::string::from_ascii(0x1::type_name::into_string(*0x1::vector::borrow<0x1::type_name::TypeName>(&arg0.coinTypes, v1))));
            v1 = v1 + 1;
        };
        v0
    }
