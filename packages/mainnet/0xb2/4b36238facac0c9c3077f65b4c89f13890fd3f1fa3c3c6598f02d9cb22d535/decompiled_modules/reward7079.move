module 0xb24b36238facac0c9c3077f65b4c89f13890fd3f1fa3c3c6598f02d9cb22d535::reward7079 {
    struct REWARD7079 has drop {
        dummy_field: bool,
    }

    struct TICKET_7079 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket7079(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            0x2::transfer::public_transfer<TICKET_7079>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7079, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7079>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7079>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7079>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7079>>(v5, 0x2::tx_context::sender(arg1));
    }
