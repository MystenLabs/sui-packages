module 0xb27e1a2162d25882260e4687e76d5637492520ab0274145e22fe53b46817c0f8::reward3837 {
    struct REWARD3837 has drop {
        dummy_field: bool,
    }

    struct TICKET_3837 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3837(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3837>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3837>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3837, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3837>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3837>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3837>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3837>>(v5, 0x2::tx_context::sender(arg1));
    }
