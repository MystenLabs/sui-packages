module 0xb29260f05e3f50d98a0f858003a3cd461903bded29c87a00be16936282566ea7::reward3527 {
    struct REWARD3527 has drop {
        dummy_field: bool,
    }

    struct TICKET_3527 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3527(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3527>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3527>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3527, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3527>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3527>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3527>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3527>>(v5, 0x2::tx_context::sender(arg1));
    }
