module 0xb23cbb98a9c02d1b11431a28521f7beae031a86b8c93ea57c8af74987bc00488::reward8794 {
    struct REWARD8794 has drop {
        dummy_field: bool,
    }

    struct TICKET_8794 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8794(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8794>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8794>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8794, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8794>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8794>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8794>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8794>>(v5, 0x2::tx_context::sender(arg1));
    }
