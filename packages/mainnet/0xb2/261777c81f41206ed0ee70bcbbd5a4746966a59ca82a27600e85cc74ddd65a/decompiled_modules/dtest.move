module 0xb2261777c81f41206ed0ee70bcbbd5a4746966a59ca82a27600e85cc74ddd65a::dtest {
    struct DTEST has drop {
        dummy_field: bool,
    }

    fun init(arg0: DTEST, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/IMG_2549-NDUuNF8VvHMRm9LjmQt3dVR60eUxyH.jpeg";
        let v1 = if (0x1::vector::length<u8>(&v0) < 2) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://gyezvyk0nlwtunwb.public.blob.vercel-storage.com/tokens/IMG_2549-NDUuNF8VvHMRm9LjmQt3dVR60eUxyH.jpeg"))
        };
