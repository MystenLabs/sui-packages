module 0xb26eb9a32f6a89ab1b8a3f08cae907babd3518c95352fc069de0df9c907631e2::reward4247 {
    struct REWARD4247 has drop {
        dummy_field: bool,
    }

    struct TICKET_4247 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward4247(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_4247>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_4247>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD4247, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD4247>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_4247>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_4247>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_4247>>(v5, 0x2::tx_context::sender(arg1));
    }
