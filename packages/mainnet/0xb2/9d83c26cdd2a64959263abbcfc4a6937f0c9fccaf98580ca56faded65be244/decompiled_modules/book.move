module 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::book {
    ...
    public(friend) fun get_quantity_out(arg0: &Book, arg1: u64, arg2: u64, arg3: u64, arg4: 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::deep_price::OrderDeepPrice, arg5: u64, arg6: bool, arg7: u64) : (u64, u64, u64) {
        ...
        let v3 = v2;
        let v4 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::fee_penalty_multiplier(), arg3);
        let v5 = if (v0) {
            &arg0.asks
        } else {
            &arg0.bids
        ...
        let (v6, v7) = if (v0) {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::min_slice<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v5)
        } else {
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::max_slice<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v5)
        };
        let v8 = v7;
        let v9 = v6;
        let v10 = 0;
        loop {
            let v11 = if (!0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::slice_is_null(&v9)) {
                if (v3 > 0) {
                    v10 < 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_fills()
                } else {
                    false
                }
            } else {
            ...
            if (v11) {
                ...
                if (arg7 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::expire_timestamp(v12)) {
                    let v14 = if (arg6) {
                        v3
                    } else {
                        0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::div(v3, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::float_scaling() + v4)
                    };
                    let v15 = if (v0) {
                        let v16 = 0x1::u64::min(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::div(v14, v13), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::quantity(v12) - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::filled_quantity(v12));
                        let v17 = v16 - v16 % arg5;
                        v1 = v1 + v17;
                        let v18 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v17, v13);
                        let v19 = v3 - v18;
                        v3 = v19;
                        if (!arg6) {
                            v3 = v19 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v18, v4);
                        };
                        v17
                    } else {
                        let v20 = 0x1::u64::min(v14, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::quantity(v12) - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::filled_quantity(v12));
                        let v21 = v20 - v20 % arg5;
                        v1 = v1 + 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v21, v13);
                        let v22 = v3 - v21;
                        v3 = v22;
                        if (!arg6) {
                            v3 = v22 - 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(v21, v4);
                        };
                        v21
                    };
                    if (v15 == 0) {
                ...
                let (v23, v24) = if (v0) {
                    0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::next_slice<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v5, v9, v8)
                } else {
                    0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::big_vector::prev_slice<0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order::Order>(v5, v9, v8)
                };
                v8 = v24;
                v9 = v23;
                v10 = v10 + 1;
        ...
        let v25 = if (!arg6) {
            ...
            let v26 = if (v0) {
                0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::deep_price::fee_quantity(&arg4, v1, arg2 - v3, v0)
            } else {
                0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::deep_price::fee_quantity(&arg4, arg1 - v3, v1, v0)
            };
            let v27 = v26;
            0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::math::mul(arg3, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balances::deep(&v27))
        };
        let (v28, v29) = if (v0) {
            (v1, v3)
        } else {
