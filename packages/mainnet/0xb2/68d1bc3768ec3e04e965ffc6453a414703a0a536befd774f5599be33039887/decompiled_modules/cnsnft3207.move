module 0xb268d1bc3768ec3e04e965ffc6453a414703a0a536befd774f5599be33039887::cnsnft3207 {
    struct CNSNFT3207 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3207, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3207>(arg0, arg1);
