module 0xf6d956b4b3a18ddfe03b1b0086548e41791f3912105ed919104ea0de20cb8d19::Ticket {
    ...
    entry fun buyTicket(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: &TicketPrice, arg2: &mut 0xf6d956b4b3a18ddfe03b1b0086548e41791f3912105ed919104ea0de20cb8d19::prizePool::PrizePool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::value<0x2::sui::SUI>(&arg0) > 0, 1);
        let v0 = 0xf6d956b4b3a18ddfe03b1b0086548e41791f3912105ed919104ea0de20cb8d19::prizePool::getPoolLevel(arg2);
        ...
        0xf6d956b4b3a18ddfe03b1b0086548e41791f3912105ed919104ea0de20cb8d19::prizePool::updateBalance(arg2, arg0);
        let v4 = BuyTicket{
