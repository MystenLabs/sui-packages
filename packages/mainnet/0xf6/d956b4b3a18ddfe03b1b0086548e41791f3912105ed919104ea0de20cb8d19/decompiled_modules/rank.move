module 0xf6d956b4b3a18ddfe03b1b0086548e41791f3912105ed919104ea0de20cb8d19::rank {
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::dynamic_object_field::add<0x1::string::String, RankTable>(&mut v1.id, 0x1::string::utf8(b"2025-03-25"), v0);
