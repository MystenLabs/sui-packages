module 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::dutch {
    ...
    public fun new<T0>(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: u64, arg11: bool, arg12: &mut 0x2::tx_context::TxContext) : Auction {
        assert!(arg2 > arg1, 13906834767048867841);
        assert!(arg3 > 0, 13906834771343966211);
        assert!(arg4 > 0, 13906834775639064581);
        assert!(arg5 >= arg6 && arg6 > 0, 13906834779934162951);
    ...
    public fun calculate_bid_size(arg0: u64, arg1: u64, arg2: u64, arg3: u64, arg4: u64) : u64 {
        let v0 = 10000;
        (((arg3 as u128) * (0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::multiplier(arg1) as u128) / (((((arg2 as u128) * (((((arg0 as u128) * ((v0 - arg4) as u128) / (v0 as u128)) as u64) + v0) as u128) / (v0 as u128)) as u64) + 1) as u128)) as u64)
    }
    ...
    public fun delivery<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault, arg2: Auction, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64, u64, u64, u64, u64, u64) {
        assert!(0x2::clock::timestamp_ms(arg4) >= arg2.start_ts_ms, 13906835668993048593);
        assert!(arg3 || 0x2::clock::timestamp_ms(arg4) >= arg2.end_ts_ms, 13906835673288278037);
        assert!(arg2.token == 0x1::type_name::with_defining_ids<T0>(), 13906835677582458889);
        let Auction {
            id                 : v0,
            index              : v1,
            token              : _,
        ...
        if (0x2::balance::value<T0>(&v26) != 0) {
            0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::put_refunds<T0>(arg1, v26, v24, v25);
        } else {
        ...
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::put<T0>(arg0, v47);
    ...
    public fun new_bid<T0>(arg0: &mut Auction, arg1: u64, arg2: vector<0x2::coin::Coin<T0>>, arg3: 0x2::balance::Balance<T0>, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address) {
        abort 13906838151484932125
    }

    public fun new_bid_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault, arg1: &mut Auction, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: 0x2::balance::Balance<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address) {
        abort 13906838099945324573
    }

    public fun old_delivery<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::balance_pool::BalancePool, arg1: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault, arg2: Auction, arg3: bool, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T0>, u64, u64, u64, u64, u64, u64) {
        abort 13906838198729572381
    }
    ...
    public fun public_new_bid<T0>(arg0: address, arg1: &mut Auction, arg2: u64, arg3: vector<0x2::coin::Coin<T0>>, arg4: 0x2::balance::Balance<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address, 0x2::coin::Coin<T0>) {
        abort 13906838044110749725
    }

    public fun public_new_bid_v2<T0>(arg0: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault, arg1: &mut Auction, arg2: address, arg3: u64, arg4: vector<0x2::coin::Coin<T0>>, arg5: 0x2::balance::Balance<T0>, arg6: u64, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, address, 0x2::coin::Coin<T0>) {
        let v0 = 0x2::clock::timestamp_ms(arg7);
        assert!(v0 >= arg1.start_ts_ms, 13906834960323444753);
        assert!(v0 <= arg1.end_ts_ms, 13906834964618805271);
        assert!(arg3 > 0, 13906834968913117197);
        assert!(arg1.total_bid_size + arg3 <= arg1.size, 13906834973207953419);
        assert!(arg1.token == 0x1::type_name::with_defining_ids<T0>(), 13906834977502789641);
        let (v1, v2, v3, v4) = get_bid_info(arg1, arg3, arg6, v0);
        let v5 = v3 + v4;
        assert!(v5 > 0, 13906835003273642009);
        ...
        let v9 = 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::utils::merge_coins<T0>(arg4);
        let v10 = Bid{
            index             : v0,
            bidder            : arg2,
            price             : v1,
            ...
            fee_discount      : arg6,
            ts_ms             : 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::register_refund<T0>(arg0, arg2),
        };
        0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::big_vector::push_back<Bid>(&mut arg1.bids, v10);
    ...
    public fun remove_bid<T0>(arg0: &mut Auction, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.able_to_remove_bid, 13906835316806385691);
        let v0 = 0x2::clock::timestamp_ms(arg2);
        assert!(v0 >= arg0.start_ts_ms, 13906835325395664913);
        assert!(v0 <= arg0.end_ts_ms, 13906835329691025431);
        assert!(arg0.token == 0x1::type_name::with_defining_ids<T0>(), 13906835333985075209);
        ...
        arg0.total_bid_size = arg0.total_bid_size - v10;
        ...
        0x2::balance::split<T0>(0x2::dynamic_field::borrow_mut<vector<u8>, 0x2::balance::Balance<T0>>(&mut arg0.id, b"incentive_balance"), v12)
    }
    ...
    public fun terminate<T0>(arg0: Auction, arg1: &mut 0xb4f25230ba74837d8299e92951306100c4a532e8c48cc3d8828abe9b91c8b274::vault::RefundVault, arg2: &0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        assert!(arg0.token == 0x1::type_name::with_defining_ids<T0>(), 13906836575230623753);
        let Auction {
            id                 : v0,
            index              : v1,
            token              : v2,
    ...
    public fun update_auction_config(arg0: &mut Auction, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: bool, arg11: &0x2::clock::Clock, arg12: &0x2::tx_context::TxContext) {
        assert!(0x2::clock::timestamp_ms(arg11) < arg0.start_ts_ms, 13906836317533241363);
        assert!(arg2 > arg1, 13906836321827028993);
        assert!(arg3 > 0, 13906836326122258437);
        assert!(arg4 >= arg5 && arg5 > 0, 13906836330417356807);
