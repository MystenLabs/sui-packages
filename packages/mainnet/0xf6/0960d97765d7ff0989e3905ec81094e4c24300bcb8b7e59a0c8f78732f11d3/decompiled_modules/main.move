module 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::main {
    ...
    public fun cancel_order<T0, T1>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
    ...
    public fun claim_order<T0, T1>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T0>, 0x2::balance::Balance<T1>) {
        validate_global_config(arg0);
        let Receipt {
            id       : v0,
            order_id : v1,
    ...
    public fun create_batch_orders<T0>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: vector<BatchOrderParams<T0>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, vector<Receipt>) {
        validate_global_config(arg0);
    ...
    public fun create_order<T0, T1>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: 0x2::balance::Balance<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u64, arg9: u64, arg10: &0x2::clock::Clock, arg11: &mut 0x2::tx_context::TxContext) : Receipt {
        validate_global_config(arg0);
        assert!(arg4 > 0, 10);
        assert!(arg3 > 0, 11);
    ...
    public fun end_execute_order<T0, T1>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg1: &mut 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::ProtocolFeeVault, arg2: &mut OrderRegistry, arg3: 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::LoanTicket<T0>, arg4: 0x2::balance::Balance<T0>, arg5: 0x2::balance::Balance<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        validate_global_config(arg0);
        let (v0, v1) = 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::destroy_loan_ticket<T0>(arg3);
        let v2 = v1;
        let v3 = v0;
        let v4 = 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_order_id(&v3);
        ...
        let v6 = 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_cycle_number(&v3);
        ...
        let v8 = 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_amount_in_max(&v3);
        ...
        let v13 = 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_execution_time(&v3);
        ...
        let v14 = OrderFilled{
            recipe_id            : v4,
            cycle_number         : 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_cycle_number(&v3),
            fulfilled_time       : v13,
            from_coin_type       : 0x1::type_name::with_defining_ids<T0>(),
            to_coin_type         : 0x1::type_name::with_defining_ids<T1>(),
            amount_in_borrowed   : 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_amount_borrowed(&v3),
            amount_in_spent      : v8 - v9,
            amount_out           : v7,
            protocol_fee_charged : 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_fee_collected(&v3),
        };
        0x2::event::emit<OrderFilled>(v14);
        let (_, _, _, _, _, _, _, _, _) = 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::destroy_exec_ticket(v3);
    }
    ...
    public fun preview_next_execution<T0>(arg0: &OrderRegistry, arg1: address, arg2: &0x2::clock::Clock) : (u64, u64, u64, bool, u64, u64, u64, u64, u64) {
        ...
        let (v9, v10) = calc_window_for_cycle(v0, v7);
        let v11 = v10;
        let v12 = v9;
        while (v1 > v11 && v8 < v0.order_num) {
            let v13 = v8 + 1;
            v8 = v13;
            let (v14, v15) = calc_window_for_cycle(v0, v13);
            v12 = v14;
            v11 = v15;
        };
        let v16 = v1 >= v12 && v1 <= v11;
        let v17 = v0.original_amount_per_cycle;
        let v18 = v17 * v0.fee_rate / 1000000;
        (v8, v12, v11, v16, v17, v18, v17 - v18, v0.min_amount_out, v0.max_amount_out)
    }

    public fun put_back_input<T0>(arg0: &mut 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::LoanTicket<T0>, arg1: 0x2::balance::Balance<T0>) {
        0x2::balance::join<T0>(0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_in_balance_mut<T0>(arg0), arg1);
    }

    public fun put_back_input_entry<T0>(arg0: &mut 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::LoanTicket<T0>, arg1: 0x2::balance::Balance<T0>) {
        put_back_input<T0>(arg0, arg1);
    }

    public fun start_execute_order<T0>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::OperatorCap, arg1: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg2: &mut 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::ProtocolFeeVault, arg3: &mut OrderRegistry, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::LoanTicket<T0> {
        ...
        0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::collect_protocol_fee<T0>(arg2, 0x2::balance::split<T0>(&mut v8, v7), arg5);
        v0.paid_fee = v0.paid_fee + v7;
        v0.executing_flag = true;
        0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::new_loan_ticket<T0>(0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::new_exec_ticket(arg4, v5, 0x2::balance::value<T0>(&v8), v1, v2, v7, v3, v4, v1), v8)
    }
    ...
    public fun take_input<T0>(arg0: &mut 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::LoanTicket<T0>) : 0x2::balance::Balance<T0> {
        let v0 = 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::get_in_balance_mut<T0>(arg0);
        0x2::balance::split<T0>(v0, 0x2::balance::value<T0>(v0))
    }

    public fun take_input_entry<T0>(arg0: &mut 0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::types::LoanTicket<T0>) : 0x2::balance::Balance<T0> {
        take_input<T0>(arg0)
    }
    ...
    fun validate_global_config(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig) {
        assert!(!0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::is_paused(arg0), 1);
        assert!(0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::get_version(arg0) == 1, 2);
    }
    ...
    public fun withdraw_output<T0>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
    ...
    public fun withdraw_output_amount<T0>(arg0: &0xf60960d97765d7ff0989e3905ec81094e4c24300bcb8b7e59a0c8f78732f11d3::config::GlobalConfig, arg1: &mut OrderRegistry, arg2: &Receipt, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        validate_global_config(arg0);
        assert!(0x2::table::contains<address, Order>(&arg1.orders, arg2.order_id), 37);
        let v0 = 0x2::table::borrow_mut<address, Order>(&mut arg1.orders, arg2.order_id);
