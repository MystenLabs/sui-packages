module 0xf6c5579be3446db67b38c738055804aa979e0f165f495bc054e6a0023e0f27e6::cnsnft8343 {
    struct CNSNFT8343 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8343, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT8343>(arg0, arg1);
