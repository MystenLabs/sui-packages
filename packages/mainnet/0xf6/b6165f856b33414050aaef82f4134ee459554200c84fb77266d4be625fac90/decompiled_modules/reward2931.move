module 0xf6b6165f856b33414050aaef82f4134ee459554200c84fb77266d4be625fac90::reward2931 {
    struct REWARD2931 has drop {
        dummy_field: bool,
    }

    struct TICKET_2931 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2931(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2931>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2931>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2931, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2931>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2931>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2931>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2931>>(v5, 0x2::tx_context::sender(arg1));
    }
