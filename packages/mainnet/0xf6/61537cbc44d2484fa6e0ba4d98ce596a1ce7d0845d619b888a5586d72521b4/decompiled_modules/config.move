module 0xf661537cbc44d2484fa6e0ba4d98ce596a1ce7d0845d619b888a5586d72521b4::config {
    ...
    public fun add_whitelisted_deployer(arg0: &AdminCap, arg1: &mut Config, arg2: address) {
        assert!(!0x2::vec_set::contains<address>(&arg1.whitelisted_deployers, &arg2), 5);
    ...
    public fun add_whitelisted_quote_token<T0>(arg0: &AdminCap, arg1: &mut Config) {
        ...
        assert!(!0x2::vec_set::contains<0x1::type_name::TypeName>(&arg1.whitelisted_quote_tokens, &v0), 6);
    ...
    public fun assert_deployer_whitelisted(arg0: &Config, arg1: address) {
        ...
        assert!(is_deployer_whitelisted(arg0, arg1), 3);
    }
    ...
    public fun assert_quote_token_whitelisted<T0>(arg0: &Config) {
        assert!(is_quote_token_whitelisted<T0>(arg0), 4);
    }
    ...
    public fun calculate_protocol_fee(arg0: &Config, arg1: u64) : u64 {
        (((arg1 as u128) * (arg0.protocol_fee_bps as u128) / (10000 as u128)) as u64)
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = Config{
            ...
            total_token_supply       : 1000000000000000000,
            is_fixed_x               : true,
            collect_fee_mode         : 1,
            is_quote_y               : true,
    ...
    public fun remove_whitelisted_deployer(arg0: &AdminCap, arg1: &mut Config, arg2: address) {
        assert!(0x2::vec_set::contains<address>(&arg1.whitelisted_deployers, &arg2), 3);
    ...
    public fun remove_whitelisted_quote_token<T0>(arg0: &AdminCap, arg1: &mut Config) {
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x2::vec_set::contains<0x1::type_name::TypeName>(&arg1.whitelisted_quote_tokens, &v0), 4);
