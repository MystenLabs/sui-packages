module 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::lb_position {
    ...
    public(friend) fun add_total_fees_gen(arg0: &mut LBPositionInfo, arg1: u128) {
        arg0.total_fees_gen = 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::add_u128(arg0.total_fees_gen, arg1);
    }
    ...
    public(friend) fun collect_fees(arg0: &mut LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u128, arg4: u128) : (u64, u64) {
        ...
        (((0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::mul_u128(v3, 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::sub_u128(arg3, v2.fee_growth_inside_last_x)) >> 64) as u64), ((0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::mul_u128(v3, 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::sub_u128(arg4, v2.fee_growth_inside_last_y)) >> 64) as u64))
    }
    ...
    public(friend) fun decrease_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128, arg5: &0x2::clock::Clock) : u128 {
        ...
        0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::bin_manager::decrement_total_supply(arg1, arg3, arg4)
    }
    ...
    public fun get_tokens_in_position(arg0: &LBPositionManager, arg1: &LBPosition, arg2: u32, arg3: u32) : (vector<u32>, vector<u128>) {
        ...
        while (v3 <= arg3 >> 6) {
            ...
            v3 = 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::add_u32(v3, 1);
        };
        (v0, v1)
    }
    ...
    public fun get_total_pending_fees_with_growth(arg0: &LBPositionManager, arg1: &LBPosition, arg2: &vector<u32>, arg3: &vector<u128>, arg4: &vector<u128>) : (u64, u64) {
        ...
        while (v2 < 0x1::vector::length<u32>(arg2)) {
            ...
            v0 = 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::add_u64(v0, v3);
            v1 = 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::add_u64(v1, v4);
            v2 = v2 + 1;
        };
        (v0, v1)
    }
    ...
    public(friend) fun increase_liquidity(arg0: &mut LBPositionManager, arg1: &mut 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::bin_manager::BinManager, arg2: &LBPosition, arg3: u32, arg4: u128) : u128 {
        let v0 = borrow_mut_position_info(arg0, 0x2::object::id<LBPosition>(arg2));
        let v1 = get_bin(v0, arg3);
        if (0x1::option::is_some<LBBinPosition>(&v1)) {
            let v2 = 0x1::option::extract<LBBinPosition>(&mut v1);
            let v3 = LBBinPosition{
                bin_id                   : arg3,
                amount                   : 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math::add_u128(v2.amount, arg4),
                fee_growth_inside_last_x : v2.fee_growth_inside_last_x,
                fee_growth_inside_last_y : v2.fee_growth_inside_last_y,
            };
        ...
        0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::bin_manager::increment_total_supply(arg1, arg3, arg4)
    }
