module 0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::safe_math {
    ...
    public fun sqrt_u128(arg0: u128) : u128 {
        ...
        let v0 = 1 << (0xf6567f2eccde24b83d08e6f0076ef17edeb93c140c8b891838c1e8eb7e417a40::bit_math::most_significant_bit(arg0) + 1) / 2;
        let v1 = (arg0 / v0 + v0) / 2;
        while (v1 < v0) {
            let v2 = arg0 / v1 + v1;
            v1 = v2 / 2;
