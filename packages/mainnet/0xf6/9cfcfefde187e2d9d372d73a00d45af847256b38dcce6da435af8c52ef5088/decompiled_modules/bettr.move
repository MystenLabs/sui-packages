module 0xf69cfcfefde187e2d9d372d73a00d45af847256b38dcce6da435af8c52ef5088::bettr {
    ...
    public fun cleanup_expired<T0>(arg0: &mut Bet<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (v4 > 0) {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.total_pool, v4), arg2), 0x2::tx_context::sender(arg2));
        };
    ...
    fun resolve_and_distribute<T0>(arg0: &mut Bet<T0>, arg1: bool, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = if (arg1) {
            ...
            (v1, arg0.total_bets_on_a)
        } else {
            let v1 = &arg0.bets_on_b;
            (v1, arg0.total_bets_on_b)
        };
        if (v2 == 0) {
            return
        };
        let v3 = 0x2::vec_map::length<address, u64>(v1);
        let v4 = 0;
        while (v4 < v3) {
            let (v5, v6) = 0x2::vec_map::get_entry_by_idx<address, u64>(v1, v4);
            let v7 = *v6 * v0 / v2;
            if (v7 > 0) {
                0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.total_pool, v7), arg2), *v5);
            };
            v4 = v4 + 1;
        };
        let v8 = 0x2::balance::value<T0>(&arg0.total_pool);
        if (v8 > 0 && v3 > 0) {
            let (v9, _) = 0x2::vec_map::get_entry_by_idx<address, u64>(v1, v3 - 1);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.total_pool, v8), arg2), *v9);
        };
    }
