module 0xf684ea9df41f376bb30536fe99dec240165920b88c7578a55dcadc6a01144247::gift5949 {
    struct GIFT5949 has drop {
        dummy_field: bool,
    }

    struct TICKET_5949 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5949(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5949>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5949>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5949, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5949>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5949>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5949>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5949>>(v5, 0x2::tx_context::sender(arg1));
    }
