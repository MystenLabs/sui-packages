module 0xf6378fabc07e63f17212507929dd3544783d693b27071a6bcafaf6e93f3aa32f::catgf {
    ...
    fun init(arg0: CATGF, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<CATGF>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CATGF   ")))), trim_right(b"CATGF                           "), trim_right(b"Daram is a social experiment meme coin that combines the advantages of BRC20 tokens with those of traditional meme tokens, aiming to ensure this fair launch method is sufficiently fluid on Ethereum                                                                                                                           "), v2, arg1);
