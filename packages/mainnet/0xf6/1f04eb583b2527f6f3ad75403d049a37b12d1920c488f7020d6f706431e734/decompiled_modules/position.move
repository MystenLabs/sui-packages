module 0xf61f04eb583b2527f6f3ad75403d049a37b12d1920c488f7020d6f706431e734::position {
    ...
    public(friend) fun new<T0, T1, T2>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u128, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) : Position<T0, T1, T2> {
        Position<T0, T1, T2>{
    ...
    public(friend) fun decrease_position_scoin_share_in_pool<T0, T1, T2>(arg0: &mut Position<T0, T1, T2>, arg1: u128) {
    ...
    public fun get_position_scoin_share_in_pool<T0, T1, T2>(arg0: &Position<T0, T1, T2>) : u128 {
    ...
    public(friend) fun increase_position_scoin_share_in_pool<T0, T1, T2>(arg0: &mut Position<T0, T1, T2>, arg1: u128) {
        arg0.position_scoin_share_in_pool = arg0.position_scoin_share_in_pool + arg1;
    }
