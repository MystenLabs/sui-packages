module 0xf68489865068f6b92322f564e240dae7f96b4995a68381ef46995b6be1c057c0::gift3430 {
    struct GIFT3430 has drop {
        dummy_field: bool,
    }

    struct TICKET_3430 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3430(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3430>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3430>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3430, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3430>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3430>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3430>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3430>>(v5, 0x2::tx_context::sender(arg1));
    }
