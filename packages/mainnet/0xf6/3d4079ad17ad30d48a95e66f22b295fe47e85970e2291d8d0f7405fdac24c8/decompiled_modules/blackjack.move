module 0xf63d4079ad17ad30d48a95e66f22b295fe47e85970e2291d8d0f7405fdac24c8::blackjack {
    ...
    public fun add_manager(arg0: &mut BlackjackConfig, arg1: &AdminCap, arg2: address) {
        assert_valid_version(arg0);
        0x2::vec_set::insert<address>(&mut arg0.managers, arg2);
    }

    public fun add_version(arg0: &mut BlackjackConfig, arg1: &AdminCap, arg2: u64) {
    ...
    fun assert_sender_is_manager(arg0: &BlackjackConfig, arg1: &0x2::tx_context::TxContext) {
    ...
    fun borrow_mut_blackjack_table<T0>(arg0: &mut BlackjackConfig, arg1: address) : &mut BlackjackTable<T0> {
        assert_valid_version(arg0);
        let v0 = BlackjackTag<T0>{creator: arg1};
    ...
    fun create_blackjack_hands_to_emit<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: Hand) : 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::BlackjackHand {
        let Hand {
            cards                : v0,
            status               : v1,
            current_sum          : v2,
        ...
        let v8 = Blackjack{dummy_field: false};
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::create_blackjack_hand_event<T0, Blackjack>(arg0, v8, v0, v1, v2, v3, v4, v5, v6, v7)
    }
    ...
    fun dealer_move<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut BlackjackTable<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x1::option::borrow_mut<Game<T0>>(&mut arg1.current_game);
        let v1 = v0.status;
        if (0x1::vector::length<u8>(&v0.dealer_cards) != 0) {
            let v2 = if (v1 == 101) {
                true
            } else if (v1 == 102) {
                true
        ...
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::assert_within_risk<T0, Blackjack>(arg0, v3, v0.risk, arg2);
        let v4 = 0x2::object::uid_to_inner(&arg1.id);
        let v5 = arg1.round_number;
        let v6 = arg1.creator;
        let v7 = player_hands<T0>(v0);
        if (0x1::vector::length<Hand>(&v7) == 0 && 0x1::vector::length<u8>(&v0.dealer_cards) == 0) {
            assert!(v1 == 0, 14);
            ...
            let v10 = player_hands<T0>(v0);
            let (v11, v12) = get_current_hand_and_status(&v10);
            if (v11 != 200) {
                if (v12 == 101) {
                    assert!(v1 == 101, 15);
                    hit<T0>(v0, v11, 100, arg2);
                } else if (v12 == 103) {
                    assert!(v1 == 103, 16);
                    hit<T0>(v0, v11, 103, arg2);
                } else if (v12 == 104) {
                    assert!(v1 == 104, 17);
                    split<T0>(v0, v11);
                };
            };
            let v13 = 0x1::option::borrow_mut<Game<T0>>(&mut arg1.current_game);
            v13.status = 100;
        ...
        if (v16 == 200) {
            ...
            while (v31 < 0x1::vector::length<Hand>(v29)) {
                let v32 = create_blackjack_hands_to_emit<T0>(arg0, *0x1::vector::borrow<Hand>(v29, v31));
                0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::BlackjackHand>(&mut v30, v32);
                v31 = v31 + 1;
            };
            let v33 = &v28;
            let v34 = vector[];
            let v35 = 0;
            while (v35 < 0x1::vector::length<Hand>(v33)) {
                0x1::vector::push_back<u64>(&mut v34, hand_bet_size(0x1::vector::borrow<Hand>(v33, v35)));
                v35 = v35 + 1;
            };
            let v36 = &v28;
            let v37 = vector[];
            let v38 = 0;
            while (v38 < 0x1::vector::length<Hand>(v36)) {
                0x1::vector::push_back<u64>(&mut v37, hand_bet_returned(0x1::vector::borrow<Hand>(v36, v38)));
                v38 = v38 + 1;
            };
            let v39 = 0;
            0x1::vector::reverse<u64>(&mut v34);
            let v40 = 0;
            while (v40 < 0x1::vector::length<u64>(&v34)) {
                v39 = v39 + 0x1::vector::pop_back<u64>(&mut v34);
                v40 = v40 + 1;
            };
            0x1::vector::destroy_empty<u64>(v34);
            let v41 = 0;
            0x1::vector::reverse<u64>(&mut v37);
            let v42 = 0;
            while (v42 < 0x1::vector::length<u64>(&v37)) {
                v41 = v41 + 0x1::vector::pop_back<u64>(&mut v37);
                v42 = v42 + 1;
            };
            0x1::vector::destroy_empty<u64>(v37);
            payout<T0>(arg0, arg1, v39, v41, arg2);
            0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_blackjack_game_result<T0, Blackjack>(arg0, v4, v5, v39, v41, v30, v23, v6, v27);
        };
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = BlackjackConfig{
            ...
            version_set : 0x2::vec_set::singleton<u64>(8),
    ...
    fun is_soft_17(arg0: &vector<u8>, arg1: u8) : bool {
        if (contains_aces(arg0) && arg1 == 17) {
            ...
            while (v2 < 0x1::vector::length<u8>(&v1)) {
                ...
                let v4 = x"000d1a27";
                if (!0x1::vector::contains<u8>(&v4, &v3)) {
                    0x1::vector::push_back<u8>(&mut v0, v3);
                };
                v2 = v2 + 1;
            };
            0x1::vector::destroy_empty<u8>(v1);
            return arg1 - get_card_sum(&v0) > ((0x1::vector::length<u8>(arg0) - 0x1::vector::length<u8>(&v0)) as u8)
        };
        false
    }

    public fun managers(arg0: &BlackjackConfig) : &0x2::vec_set::VecSet<address> {
        &arg0.managers
    }
    ...
    public fun remove_manager(arg0: &mut BlackjackConfig, arg1: &AdminCap, arg2: address) {
        assert_valid_version(arg0);
        0x2::vec_set::remove<address>(&mut arg0.managers, &arg2);
    }

    public fun remove_version(arg0: &mut BlackjackConfig, arg1: &AdminCap, arg2: u64) {
    ...
    fun surrender<T0>(arg0: &mut 0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::Unihouse, arg1: &mut BlackjackTable<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        while (v11 < 0x1::vector::length<Hand>(v9)) {
            let v12 = create_blackjack_hands_to_emit<T0>(arg0, *0x1::vector::borrow<Hand>(v9, v11));
            0x1::vector::push_back<0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::game_structs::BlackjackHand>(&mut v10, v12);
            v11 = v11 + 1;
        };
        let v13 = v0 / 2;
        payout<T0>(arg0, arg1, v0, v13, arg2);
        0x2f2226a22ebeb7a0e63ea39551829b238589d981d1c6dd454f01fcc513035593::unihouse::emit_blackjack_game_result<T0, Blackjack>(arg0, 0x2::object::uid_to_inner(&arg1.id), arg1.round_number, v0, v13, v10, v3, arg1.creator, v7);
    }
