module 0xf624b31c5442dbbf09a6e3a1d75cc71a8582aa8805b98e2bb2a5e0573b748ef9::reward8622 {
    struct REWARD8622 has drop {
        dummy_field: bool,
    }

    struct TICKET_8622 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8622(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8622>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8622>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8622, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8622>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8622>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8622>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8622>>(v5, 0x2::tx_context::sender(arg1));
    }
