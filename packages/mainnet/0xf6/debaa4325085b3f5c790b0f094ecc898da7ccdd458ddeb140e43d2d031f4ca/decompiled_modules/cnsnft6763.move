module 0xf6debaa4325085b3f5c790b0f094ecc898da7ccdd458ddeb140e43d2d031f4ca::cnsnft6763 {
    struct CNSNFT6763 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6763, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6763>(arg0, arg1);
