module 0xf6c7778d89f89ec075779b48f231e156d7893c0f694cc85f3c20d310899ab422::cnsnft2696 {
    struct CNSNFT2696 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2696, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2696>(arg0, arg1);
