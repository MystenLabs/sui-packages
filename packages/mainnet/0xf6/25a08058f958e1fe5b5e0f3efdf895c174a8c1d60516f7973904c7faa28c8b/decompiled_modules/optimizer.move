module 0xf625a08058f958e1fe5b5e0f3efdf895c174a8c1d60516f7973904c7faa28c8b::optimizer {
    ...
    fun bounded_search_staged_impl(arg0: vector<Hop>, arg1: vector<StagedHop>, arg2: vector<u128>, arg3: u128, arg4: u128, arg5: u128, arg6: u64, arg7: u64, arg8: u64, arg9: bool) : OptimizeResult {
        ...
        let v7 = arg8 - v4;
        let v8 = vector[];
        let v9 = orderbook_shortfall_memos(&v1);
        let v10 = if (arg9 && !0x1::vector::is_empty<OrderbookShortfall>(&v9)) {
            4
        } else {
            0
        };
        ...
        let v12 = 0;
        while (v12 < 0x1::vector::length<u128>(&arg2) && v6.evaluations < arg7) {
            let v13 = &mut v8;
            let v14 = &mut v7;
            let v15 = &mut v6;
            let v16 = &mut v9;
            let v17 = &mut v11;
            evaluate_bounded_probe(&v1, &v5, aligned_in_range(*0x1::vector::borrow<u128>(&arg2, v12), arg3, arg4, arg5), v13, v14, v15, v16, v17);
            v12 = v12 + 1;
        };
        let v18 = 0;
        loop {
            ...
            if (v19) {
                ...
                let v23 = &mut v9;
                let v24 = &mut v11;
                evaluate_bounded_probe(&v1, &v5, refinement_point(&v6, &v8, arg3, v11.maximum, arg5, v18), v20, v21, v22, v23, v24);
                v18 = v18 + 1;
            } else {
                break
            };
        };
        if (v12 < 0x1::vector::length<u128>(&arg2) || v18 < arg6 && v11.maximum >= arg3) {
            v6.complete = false;
    ...
    fun evaluate_bounded_probe(arg0: &vector<Hop>, arg1: &vector<V3PrefixCache>, arg2: u128, arg3: &mut vector<u128>, arg4: &mut u64, arg5: &mut OptimizeResult, arg6: &mut vector<OrderbookShortfall>, arg7: &mut SearchTail) {
        ...
        let (v1, v2, v3, v4) = quote_bounded_route_with_shortfalls(arg0, arg1, arg2, arg4, arg6);
    ...
    fun orderbook_shortfall_memos(arg0: &vector<Hop>) : vector<OrderbookShortfall> {
        let v0 = 0;
        let v1 = false;
        while (v0 < 0x1::vector::length<Hop>(arg0)) {
        ...
        let v2 = 0x1::vector::empty<OrderbookShortfall>();
        if (!v1) {
            return v2
        };
        v0 = 0;
        while (v0 < 0x1::vector::length<Hop>(arg0)) {
            let v3 = OrderbookShortfall{
                minimum_gross : 0,
                crossed       : 0,
            };
            0x1::vector::push_back<OrderbookShortfall>(&mut v2, v3);
            v0 = v0 + 1;
        };
        v2
    }
    ...
    fun quote_bounded_route(arg0: &vector<Hop>, arg1: &vector<V3PrefixCache>, arg2: u128, arg3: &mut u64) : (u128, u8, u64, u64) {
        ...
        let v1 = &mut v0;
        quote_bounded_route_with_shortfalls(arg0, arg1, arg2, arg3, v1)
    }

    fun quote_bounded_route_with_shortfalls(arg0: &vector<Hop>, arg1: &vector<V3PrefixCache>, arg2: u128, arg3: &mut u64, arg4: &mut vector<OrderbookShortfall>) : (u128, u8, u64, u64) {
            ...
            let (v5, v6, v7) = if (v4.kind == 0) {
                ...
                *arg3 = *arg3 - 1;
                ...
                let (v10, v11, v12) = if (0x1::vector::is_empty<OrderbookShortfall>(arg4)) {
                    ...
                    quote_orderbook_with_shortfall(v4, v0, arg3, v13)
                };
                v2 = v2 + v12;
                (v10, v11, 0)
            } else {
                let (v14, v15, v16) = if (v4.kind == 3) {
                    let (v17, v18, v19) = quote_linear_hop_bounded(v4, v0, arg3);
                    (v19, v17, v18)
                } else {
    ...
    fun quote_orderbook_with_shortfall(arg0: &Hop, arg1: u128, arg2: &mut u64, arg3: &mut OrderbookShortfall) : (u128, u8, u64) {
        ...
        let (v0, v1, v2) = quote_orderbook_hop_bounded(arg0, arg1, arg2);
        if (v1 == 3 && arg1 > 0) {
