module 0xf6cff19d320c04530fbeed2c9f2ddbaea5d75e89b33fcc4e52141152cca571c3::helper {
    public fun calculate_rewards(arg0: &mut 0x3::sui_system::SuiSystemState, arg1: 0x2::object::ID, arg2: u64, arg3: u64, arg4: u64) : u64 {
        ...
        let v4 = if (v2 == 0) {
            (0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::math::mul_div_u256((arg2 as u256), (0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::math::mul_to_u128(get_sui_amount(&v3), 1) as u256), (0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::math::mul_to_u128(1, get_token_amount(&v3)) as u256)) as u64)
        } else {
            (0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::math::mul_div_u256((arg2 as u256), (0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::math::mul_to_u128(get_sui_amount(&v3), get_token_amount(&v1)) as u256), (0x76edbed77a22cdae87fe5a92a8d9fec34f1ea4c9005976ffce5ca89f43297bac::math::mul_to_u128(v2, get_token_amount(&v3)) as u256)) as u64)
        };
        v4 - arg2
    }
