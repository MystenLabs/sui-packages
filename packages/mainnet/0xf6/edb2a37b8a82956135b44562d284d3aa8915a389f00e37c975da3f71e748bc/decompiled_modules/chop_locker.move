module 0xf6edb2a37b8a82956135b44562d284d3aa8915a389f00e37c975da3f71e748bc::chop_locker {
    ...
    public entry fun lock_tokens<T0>(arg0: &mut PoolConfig<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: 0x1::string::String, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v5 = Lock<T0>{
            ...
            start_time     : v1,
            end_time       : v1 + arg3,
            locked_in_apy  : calculate_apy<T0>(0x2::coin::balance<T0>(&arg1), arg0.total_staked, &arg0.reward_balance, arg3 / 86400000 + 1),
            token_type     : arg4,
            rewards_locked : v4,
        };
