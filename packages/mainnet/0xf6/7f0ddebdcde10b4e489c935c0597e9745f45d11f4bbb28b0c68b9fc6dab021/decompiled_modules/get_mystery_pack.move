module 0xf67f0ddebdcde10b4e489c935c0597e9745f45d11f4bbb28b0c68b9fc6dab021::get_mystery_pack {
    struct GET_MYSTERY_PACK has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: GET_MYSTERY_PACK, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<GET_MYSTERY_PACK>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"Get Mystery Pack"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Get Mystery Pack "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://jylFaNcuStGRR7KjQdcUk00b_LNsC57BvJ5ckL8tMq0"));
