module 0xf6ca3a23bc48f31ea3c4344fb0255e81264d4aaf83a25a2e471a0326d33c0f66::cnsnft6828 {
    struct CNSNFT6828 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6828, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6828>(arg0, arg1);
