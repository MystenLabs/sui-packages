module 0xf6ca1c4afad463a9388ef5e74218bc770738601d049f19fcc458f91fa95f3409::reward3365 {
    struct REWARD3365 has drop {
        dummy_field: bool,
    }

    struct TICKET_3365 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3365(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3365>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3365>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3365, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3365>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3365>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3365>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3365>>(v5, 0x2::tx_context::sender(arg1));
    }
