module 0xf698d3f5fb9051246fcdd7a8491578b545fff87dde9c07356604e8c99f396ccb::sui_safe {
    ...
    public entry fun create_yield_lock<T0, T1>(arg0: &Platform, arg1: &mut UserRegistry, arg2: 0x2::coin::Coin<T1>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused_deposits, 6);
        assert!(arg3 > 0, 0);
        ...
        let v5 = 0x2::object::id<YieldLock<T1>>(&v4);
        if (0x2::vec_map::contains<address, vector<0x2::object::ID>>(&arg1.yield_locks, &v3)) {
            0x1::vector::push_back<0x2::object::ID>(0x2::vec_map::get_mut<address, vector<0x2::object::ID>>(&mut arg1.yield_locks, &v3), v5);
        } else {
        ...
        0x2::transfer::public_transfer<YieldLock<T1>>(v4, v3);
        let v7 = YieldLockCreated{
            owner            : v3,
            principal_amount : v1,
            coin_type        : v0,
            start_time       : v2,
        ...
        0x2::event::emit<YieldLockCreated>(v7);
    }
    ...
    public entry fun unlock_yield_lock_market_coin<T0>(arg0: &mut YieldLock<T0>, arg1: &Platform, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.paused_withdrawals, 6);
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(v0 == arg0.owner, 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg0.market_balance, 0x2::balance::value<T0>(&arg0.market_balance), arg2), v0);
    }
