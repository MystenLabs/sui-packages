module 0x19501965fad56c075d017e6c2a8846a81919926a4b9df45183f0b4a754679bc2::guild {
    ...
    public(friend) fun set_checkin(arg0: &Config, arg1: &mut UserArchive, arg2: &0x2::clock::Clock) : (u64, u64) {
        ...
        start_of_day(v0);
        let v1 = get_max_check_in_days(arg0);
        let v2 = 0x2::dynamic_field::borrow_mut<vector<u8>, Checkin>(&mut arg1.id, b"CHECKIN_KEY");
        assert!(v2.last_checkin_time < v0 - 3600000, 6024);
        let v3 = if (v1 > 0) {
            if (v0 - v2.last_checkin_time > 3600000 || v2.checkin_days + 1 > v1 * 3600000) {
                1
            } else {
                v2.checkin_days + 1
            }
        ...
        v2.checkin_days = v3;
        v2.last_checkin_time = v0;
        (v2.checkin_days, v2.last_checkin_time)
    }
