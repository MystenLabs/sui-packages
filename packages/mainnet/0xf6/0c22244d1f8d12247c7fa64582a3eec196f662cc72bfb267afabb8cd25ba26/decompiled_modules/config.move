module 0xf60c22244d1f8d12247c7fa64582a3eec196f662cc72bfb267afabb8cd25ba26::config {
    ...
    public fun update_mist_required_per_order(arg0: &0xf60c22244d1f8d12247c7fa64582a3eec196f662cc72bfb267afabb8cd25ba26::admin::AdminCap, arg1: &mut Config, arg2: u64) {
        assert_interacting_with_most_up_to_date_package(arg1);
        arg1.mist_required_per_order = arg2;
    }

    public fun update_total_protocol_fee_bps(arg0: &0xf60c22244d1f8d12247c7fa64582a3eec196f662cc72bfb267afabb8cd25ba26::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
        assert!(arg2 <= 1000, 9223372784179478535);
        arg1.total_protocol_fee_bps = arg2;
    }

    public fun update_treasury_fee_bps(arg0: &0xf60c22244d1f8d12247c7fa64582a3eec196f662cc72bfb267afabb8cd25ba26::admin::AdminCap, arg1: &mut Config, arg2: u128) {
        assert_interacting_with_most_up_to_date_package(arg1);
        assert!(arg2 <= 10000, 9223372852899086345);
        arg1.treasury_fee_bps = arg2;
    }

    public fun upgrade_version(arg0: &0xf60c22244d1f8d12247c7fa64582a3eec196f662cc72bfb267afabb8cd25ba26::admin::AdminCap, arg1: &mut Config) {
        assert!(arg1.version == 1 - 1, 9223372917323071489);
        arg1.version = 1;
    }
