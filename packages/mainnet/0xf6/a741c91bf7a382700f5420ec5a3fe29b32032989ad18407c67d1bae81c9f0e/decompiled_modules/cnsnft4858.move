module 0xf6a741c91bf7a382700f5420ec5a3fe29b32032989ad18407c67d1bae81c9f0e::cnsnft4858 {
    struct CNSNFT4858 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4858, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4858>(arg0, arg1);
