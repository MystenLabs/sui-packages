module 0xf699f56a59d8e1204a45a5d784d03ed1cea9dd793a4bb6ac63e12e31a0eeb65a::cnsnft1815 {
    struct CNSNFT1815 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1815, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1815>(arg0, arg1);
