module 0xf674d82107aa2e4b20f93a90dd6a925fbfa1d068d3d1100d0cec7bb2007b65ef::dragon_food {
    ...
    public entry fun migrate_dragon_food_to_v2(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: 0x6a7ea1255160d2d3c77aa80440f17d4ae9092ef547141a34185e5b41c1c31c66::dragon_food::DragonFood, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) = 0x6a7ea1255160d2d3c77aa80440f17d4ae9092ef547141a34185e5b41c1c31c66::dragon_food::delete_dragon_food(arg0, arg1);
        let v12 = v5;
        ...
        let v15 = DragonFood{
            ...
            max_dragonbees_per_psn : (arg2 as u64),
            ...
            pool_hives             : 0x2::linked_table::new<0x1::ascii::String, address>(arg3),
            module_version         : 1,
        };
        0x2::transfer::share_object<DragonFood>(v15);
    }

    public entry fun migrate_pool_hive_to_v2<T0, T1, T2, T3, T4>(arg0: &0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::yield_flow::DragonDaoCapability, arg1: bool, arg2: 0x6a7ea1255160d2d3c77aa80440f17d4ae9092ef547141a34185e5b41c1c31c66::dragon_food::PoolHive<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) = 0x6a7ea1255160d2d3c77aa80440f17d4ae9092ef547141a34185e5b41c1c31c66::dragon_food::delete_pool_hive<T0, T1, T2, T3>(arg0, arg2, arg3);
        let v10 = v9;
        let v11 = v8;
        let v12 = v7;
        let v13 = v6;
        ...
        let v16 = Bribes{
            ...
            hive_bribe              : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::hive::HIVE>(),
            honey_bribe             : 0x2::balance::zero<0x50c2216a078d3bdf5081fe436df9f42dfdbe538ebd9c935913ce2436362cff90::honey::HONEY>(),
            hive_fee_claim_indexes  : 0x2::linked_table::new<u64, u256>(arg3),
            honey_fee_claim_indexes : 0x2::linked_table::new<u64, u256>(arg3),
        };
        let v17 = PoolHive<T0>{
            id                       : 0x2::object::new(arg3),
            pool_addr                : @0x0,
            ...
            resting_dragons          : 0x2::linked_table::new<address, DragonsDen<T0>>(arg3),
            additional_rewards       : 0x1::vector::empty<0x1::ascii::String>(),
            proposal_list            : 0x2::linked_table::new<u64, Proposal>(arg3),
            next_proposal_id         : 1,
            module_version           : 1,
        };
        let v18 = VotingBribes<T1>{
            ...
            bribe                     : 0x2::balance::zero<T1>(),
            is_meme_token             : false,
            cycle_to_hive_bribes_map  : 0x2::linked_table::new<u64, u64>(arg3),
            cycle_to_honey_bribes_map : 0x2::linked_table::new<u64, u64>(arg3),
        };
        ...
        while (0x1::option::is_some<address>(&v21)) {
            ...
            let v23 = 0x2::linked_table::new<u64, LockedDragonBee>(arg3);
            ...
            let v44 = DragonsDen<T0>{
                ...
                hive_fee_claim_indexes  : 0x2::linked_table::new<u64, u256>(arg3),
                honey_fee_claim_indexes : 0x2::linked_table::new<u64, u256>(arg3),
                rewards_indexes         : 0x2::linked_table::new<0x1::ascii::String, u256>(arg3),
                is_locked               : false,
            };
