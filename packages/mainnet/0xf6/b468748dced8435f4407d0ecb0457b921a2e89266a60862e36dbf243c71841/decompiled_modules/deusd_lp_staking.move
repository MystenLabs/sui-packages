module 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::deusd_lp_staking {
    ...
    public fun set_epoch(arg0: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::admin_cap::AdminCap, arg1: &mut DeUSDLPStakingManagement, arg2: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg3: u8) {
    ...
    public fun stake<T0>(arg0: &mut DeUSDLPStakingManagement, arg1: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
    ...
    public fun unstake<T0>(arg0: &mut DeUSDLPStakingManagement, arg1: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::check_package_version(arg1);
        assert!(arg2 > 0, 1);
        let v0 = 0x1::type_name::get<T0>();
        ...
        v3.cooldown_start_timestamp = 0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::clock_utils::timestamp_seconds(arg3);
    ...
    public fun update_stake_parameters<T0>(arg0: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::admin_cap::AdminCap, arg1: &mut DeUSDLPStakingManagement, arg2: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg3: u8, arg4: u64, arg5: u64) {
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::check_package_version(arg2);
    ...
    public fun withdraw<T0>(arg0: &mut DeUSDLPStakingManagement, arg1: &0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::GlobalConfig, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::config::check_package_version(arg1);
        assert!(arg2 > 0, 1);
        let v0 = 0x1::type_name::get<T0>();
        let v1 = 0x2::tx_context::sender(arg4);
        ...
        assert!(0xf6b468748dced8435f4407d0ecb0457b921a2e89266a60862e36dbf243c71841::clock_utils::timestamp_seconds(arg3) >= v3.cooldown_start_timestamp + 0x2::table::borrow<0x1::type_name::TypeName, StakeParameters>(&arg0.stake_parameters_by_token, v0).cooldown, 7);
        v3.cooling_down_amount = v3.cooling_down_amount - arg2;
        let v4 = 0x2::table::borrow_mut<0x1::type_name::TypeName, StakeParameters>(&mut arg0.stake_parameters_by_token, v0);
        v4.total_cooling_down = v4.total_cooling_down - arg2;
