module 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::pool {
    ...
    public fun add_quote_asset<T0, T1>(arg0: &GlobalConfig, arg1: &mut LiquidityPool<T0>, arg2: &mut 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: 0x1::option::Option<u64>, arg8: 0x1::option::Option<u64>, arg9: u64, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::dynamic_field::exists_<0x1::ascii::String>(&arg1.id, v0), 4023);
    ...
    fun assert_valid_quote_asset_config(arg0: u64, arg1: u64, arg2: u64, arg3: u64) {
        assert!(arg0 <= 10000, 4010);
        assert!(arg1 <= 10000, 4010);
        assert!(arg2 <= 10000, 4010);
    ...
    fun calc_dynamic_fee<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u64, arg2: u128, arg3: bool) : (u64, u128, u64, u64) {
        ...
        let v2 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v0 as u128), arg2, 1000000000000000000);
    ...
    fun default_flash_swap_protocol_fee<T0>(arg0: &LiquidityPool<T0>) : u64 {
        (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg0.swap_fee_pct as u128), ((10000 - arg0.lp_fee_pct) as u128), 10000) as u64)
    }
    ...
    public fun deposit_base<T0>(arg0: &mut LiquidityPool<T0>, arg1: &mut LPPosition<T0>, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg1.pool_id == 0x2::object::uid_to_inner(&arg0.id), 4012);
        update_claimable_rewards_inner<T0>(arg0, arg1);
        0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::helper::transfer_or_destroy_zero<T0>(arg2, 0x2::tx_context::sender(arg4));
        arg1.shares = arg1.shares + internal_deposit_base<T0>(arg0, 0x2::coin::split<T0>(&mut arg2, arg3, arg4), false, arg4);
    }

    public fun flash_borrow<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, FlashSwapPromise<T0, T1>) {
        validate_pool_version<T0>(arg0);
        assert!(!arg0.is_paused, 4005);
        ...
        let v2 = (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0) as u64);
        assert!(v2 > 0, 4016);
        let v3 = v2 + (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v2 as u128), (flash_swap_protocol_fee<T0>(arg0) as u128), 10000) as u64);
    ...
    public fun flash_repay<T0, T1>(arg0: &mut LiquidityPool<T0>, arg1: FlashSwapPromise<T0, T1>, arg2: 0x2::balance::Balance<T0>, arg3: &mut 0x2::tx_context::TxContext) : 0x2::balance::Balance<T0> {
        ...
        let v4 = (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v1 as u128), 1000000000000000000, v3) as u64);
        let v5 = v2 - v4;
    ...
    public fun initial_deposit_base<T0>(arg0: &mut LiquidityPool<T0>, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::helper::transfer_or_destroy_zero<T0>(arg1, 0x2::tx_context::sender(arg3));
    ...
    entry fun migrate_module_version(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::admin::ProtocolAdminCap, arg1: &mut GlobalConfig) {
        assert!(arg1.version < 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version(), 4011);
        arg1.version = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version();
    }

    entry fun migrate_pool_version<T0>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>) {
        assert!(arg1.version < 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version(), 4011);
        arg1.version = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::constants::get_version();
        let v0 = FlashSwapEnabledKey{dummy_field: false};
        if (!0x2::dynamic_field::exists_<FlashSwapEnabledKey>(&arg1.id, v0)) {
        ...
        if (!0x2::dynamic_field::exists_<FlashSwapProtocolFeeKey>(&arg1.id, v2)) {
    ...
    fun quote_limit<T0, T1>(arg0: &LiquidityPool<T0>, arg1: u128, arg2: &QuoteAssetReserve<T1>) : u64 {
        0x1::u64::min((0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((get_pool_ideal_base_anchor<T0>(arg0) as u128), arg1, 1000000000000000000) as u128), (0x1::option::get_with_default<u64>(&arg2.limit_ratio, arg0.limit_ratio) as u128), 10000) as u64), 0x1::option::get_with_default<u64>(&arg2.limit_fixed, 18446744073709551615))
    }
    ...
    public fun simulate_buy_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        assert_quote_is_supported<T0, T1>(arg0);
        let (v0, _) = get_price<T0, T1>(arg1, arg2);
        let v2 = 0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0);
        assert!(v2 != 0, 4016);
        ...
        SwapSimulationResult{
            base_out        : (v7 as u64),
            quote_out       : (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((v7 as u128), v0, 1000000000000000000) as u64),
    ...
    public fun simulate_sell_swap<T0, T1>(arg0: &LiquidityPool<T0>, arg1: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::price_oracle::Oracle, arg2: &0x2::clock::Clock, arg3: u64) : SwapSimulationResult {
        ...
        let (v2, v3, v4, _) = calc_dynamic_fee<T0, T1>(arg0, (0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::math::mul_div_u128((arg3 as u128), 1000000000000000000, v0) as u64), 1000000000000000000 * 1000000000000000000 / v0, true);
    ...
    public fun update_ideal_base_anchor<T0>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        validate_pool_version<T0>(arg1);
        let v0 = IdealBaseAnchorKey{dummy_field: false};
        if (0x2::dynamic_field::exists_<IdealBaseAnchorKey>(&arg1.id, v0)) {
    ...
    public fun update_net_base_fee_multiplier<T0>(arg0: &0xc8724de692400a2a08585f6f7c8617acfb783abe2c66ae6a4680a21b36a504c5::admin::ProtocolAdminCap, arg1: &mut LiquidityPool<T0>, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        abort 4022
    }
