module 0xf67cb3d34867eb0f720ab2b9729954746a01d1708250a2f5c3d81aada0548873::x {
    struct X has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: X, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<X>(arg0, 2, b"X", b"X", b"VIP", v1, arg1);
        let v4 = v2;
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<X>>(v3);
        0x2::coin::mint_and_transfer<X>(&mut v4, 100000, v0, arg1);
