module 0xf693e57bf045fdacb52edb6999ec0a24fdab74cae3ba2f2e6f0eb7acac172bcf::managed {
    ...
    fun init(arg0: MANAGED, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MANAGED>(arg0, 2, b"NEMO", b"Where is NEMO?", b"holders get rewards!", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://iili.io/2bYAz1s.jpg")), arg1);
