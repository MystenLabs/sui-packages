module 0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::bclmm {
    ...
    public fun elf<T0, T1>(arg0: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: &mut 0xa3e3162fb175b3068eee9c18a91c72aba52d1a2b69b68fcda1d34c629da6376a::bm::CBM, arg2: &0x2::clock::Clock, arg3: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg4: u64, arg5: u64, arg6: u64, arg7: vector<bool>, arg8: vector<bool>, arg9: vector<u64>, arg10: vector<u64>, arg11: &mut 0x2::tx_context::TxContext) {
        ...
        while (v8 < 0x1::vector::length<bool>(&arg7)) {
            ...
            if (v13 != 0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_no_error()) {
                let v15 = EE{
                    e : v13,
                    l : 268,
                };
            ...
            if (v16 != 0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_no_error()) {
                let v21 = EE{
                    e : v16,
                    l : 306,
                };
    ...
    fun sei<T0, T1>(arg0: &mut 0xa3e3162fb175b3068eee9c18a91c72aba52d1a2b69b68fcda1d34c629da6376a::bm::CBM, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        (0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_no_error(), v10, v11, v6, v7)
    }
    ...
    fun seo<T0, T1>(arg0: &mut 0xa3e3162fb175b3068eee9c18a91c72aba52d1a2b69b68fcda1d34c629da6376a::bm::CBM, arg1: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::config::GlobalConfig, arg2: &mut 0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg3: bool, arg4: u64, arg5: u64, arg6: u128, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64) {
        ...
        assert!(v6 <= arg5, 0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_amount_in_too_high());
        let (v7, v8) = if (arg3) {
            (v6, 0)
        } else {
            (0, v6)
        ...
        (0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_no_error(), v7, v8, 0x2::balance::value<T0>(&v5), 0x2::balance::value<T1>(&v4))
    }
    ...
    fun vbac<T0, T1>(arg0: &0x3492c874c1e3b3e2984e8c41b589e642d4d0a5d6459e5a9cfc2d52fd7c89c267::pool::Pool<T0, T1>, arg1: u64, arg2: u64, arg3: bool, arg4: bool, arg5: u64, arg6: u64, arg7: u128) : (u64, u64) {
        ...
        if (arg3) {
            if (v3 < arg6) {
                return (0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_amount_out_too_low(), 0)
            };
        } else if (v2 > arg6) {
            return (0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_amount_in_too_high(), 0)
        };
        if (arg4) {
            if (v2 > arg1) {
                return (0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_insufficient_input_balance(), 0)
            };
        } else if (v2 > arg2) {
            return (0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_insufficient_input_balance(), 0)
        };
        (0xf6cc231ead142d35c37494a4c36d9e78c97503c0be9f9a0652f6e1127304096a::ct::e_no_error(), v1)
    }
