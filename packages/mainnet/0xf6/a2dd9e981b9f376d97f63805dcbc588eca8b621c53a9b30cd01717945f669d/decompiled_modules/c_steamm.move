module 0xf6a2dd9e981b9f376d97f63805dcbc588eca8b621c53a9b30cd01717945f669d::c_steamm {
    struct C_STEAMM has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: C_STEAMM, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<C_STEAMM>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b" STEAMM"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(b"Superfluid AMM by suilend Live NFT 1000 With STEAMM Points "));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"walrus://TFOdUuYRkx2Dm2k675F35s4hromHfNiFY5iCo56dNbI"));
