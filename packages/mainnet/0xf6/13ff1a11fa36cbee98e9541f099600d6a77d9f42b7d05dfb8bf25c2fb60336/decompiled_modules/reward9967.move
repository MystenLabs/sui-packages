module 0xf613ff1a11fa36cbee98e9541f099600d6a77d9f42b7d05dfb8bf25c2fb60336::reward9967 {
    struct REWARD9967 has drop {
        dummy_field: bool,
    }

    struct TICKET_9967 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9967(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9967>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9967>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9967, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9967>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9967>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9967>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9967>>(v5, 0x2::tx_context::sender(arg1));
    }
