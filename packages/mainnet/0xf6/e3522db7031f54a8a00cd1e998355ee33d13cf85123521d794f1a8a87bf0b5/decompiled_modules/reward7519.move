module 0xf6e3522db7031f54a8a00cd1e998355ee33d13cf85123521d794f1a8a87bf0b5::reward7519 {
    struct REWARD7519 has drop {
        dummy_field: bool,
    }

    struct TICKET_7519 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7519(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7519>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7519>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7519, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7519>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7519>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7519>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7519>>(v5, 0x2::tx_context::sender(arg1));
    }
