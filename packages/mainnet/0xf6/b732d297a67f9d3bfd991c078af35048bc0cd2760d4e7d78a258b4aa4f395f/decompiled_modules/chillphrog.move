module 0xf6b732d297a67f9d3bfd991c078af35048bc0cd2760d4e7d78a258b4aa4f395f::chillphrog {
    ...
    fun init(arg0: CHILLPHROG, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v1, v2) = 0x2::coin::create_currency<CHILLPHROG>(arg0, 9, b"CHILLPHROG", b"Chill Phrog", b"The chillest frog meme coin on Sui. Join our vibrant community of chill frogs. Ribbit responsibly.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://i.ibb.co/QfDdxT1/CHILLPHROG.png")), arg1);
        let v3 = TokenConfig{
