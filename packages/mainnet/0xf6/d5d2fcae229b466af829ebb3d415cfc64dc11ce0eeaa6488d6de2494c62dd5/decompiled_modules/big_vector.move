module 0xf6d5d2fcae229b466af829ebb3d415cfc64dc11ce0eeaa6488d6de2494c62dd5::big_vector {
    ...
    public fun push_back<T0: store>(arg0: &mut BigVector, arg1: T0) {
        if (is_empty(arg0) || length(arg0) % (arg0.slice_size as u64) == 0) {
            ...
            let v0 = Slice<T0>{
                idx    : arg0.slice_idx,
                vector : 0x1::vector::singleton<T0>(arg1),
            };
            0x2::dynamic_field::add<u64, Slice<T0>>(&mut arg0.id, arg0.slice_idx, v0);
        } else {
            let v1 = &mut arg0.id;
            0x1::vector::push_back<T0>(&mut borrow_slice_mut_<T0>(v1, arg0.slice_idx).vector, arg1);
        };
