module 0xf64f0f024ac7de5b8b0218627f5b45a5b337ccde0fc4da0c82a2b645d90b6a7f::lorem {
    ...
    fun init(arg0: LOREM, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v2, v3) = 0x2::coin::create_currency<LOREM>(arg0, 2, b"Lorem", b"Lorem", b"Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor.", v1, arg1);
        let v4 = v2;
