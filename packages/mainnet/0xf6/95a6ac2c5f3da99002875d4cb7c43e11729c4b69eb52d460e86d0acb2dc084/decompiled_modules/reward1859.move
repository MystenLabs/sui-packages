module 0xf695a6ac2c5f3da99002875d4cb7c43e11729c4b69eb52d460e86d0acb2dc084::reward1859 {
    struct REWARD1859 has drop {
        dummy_field: bool,
    }

    struct TICKET_1859 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1859(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1859>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1859>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1859, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1859>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1859>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1859>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1859>>(v5, 0x2::tx_context::sender(arg1));
    }
