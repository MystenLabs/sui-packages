module 0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::treasury {
    ...
    struct CreditRefunded has copy, drop {
        endowment_id: 0x2::object::ID,
        character_id: 0x2::object::ID,
        owner: address,
        fan_recipient: address,
        amount_mist: u64,
        remaining_liability_mist: u64,
        nonce: u64,
        timestamp_ms: u64,
    }

    struct WindDownExecuted has copy, drop {
        endowment_id: 0x2::object::ID,
        character_id: 0x2::object::ID,
        owner: address,
        refunded_liability_mist: u64,
        released_principal_mist: u64,
        remaining_principal_mist: u64,
        keep_alive_reserve_mist: u64,
        nonce: u64,
        timestamp_ms: u64,
    ...
    struct JitUnstakeExecuted has copy, drop {
        endowment_id: 0x2::object::ID,
        character_id: 0x2::object::ID,
        owner: address,
        requested_mist: u64,
        moved_mist: u64,
        to_allocation_kind: u8,
        remaining_principal_mist: u64,
        keep_alive_reserve_mist: u64,
        nonce: u64,
        timestamp_ms: u64,
    ...
    struct RatchetStateCreated has copy, drop {
        ratchet_id: 0x2::object::ID,
        endowment_id: 0x2::object::ID,
        character_id: 0x2::object::ID,
        owner: address,
        required_reserve_mist: u64,
        up_step_bps: u64,
        down_step_bps: u64,
        min_reserve_mist: u64,
        max_reserve_mist: u64,
        timestamp_ms: u64,
    }

    struct ReserveRatcheted has copy, drop {
        ratchet_id: 0x2::object::ID,
        endowment_id: 0x2::object::ID,
        character_id: 0x2::object::ID,
        direction: u8,
        old_reserve_mist: u64,
        new_reserve_mist: u64,
        observed_cost_mist: u64,
        nonce: u64,
        timestamp_ms: u64,
    }

    struct RatchetState has store, key {
        id: 0x2::object::UID,
        character_id: 0x2::object::ID,
        endowment_id: 0x2::object::ID,
        observed_cost_mist: u64,
    ...
    fun allocation_bucket_code(arg0: u8) : u8 {
        if (arg0 == 1) {
            1
        } else if (arg0 == 2) {
            3
    ...
    fun assert_reserve_floor(arg0: u64) {
        assert!(arg0 >= 100000, 226);
    }
    ...
    public(friend) fun build_endowment<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) : Endowment<T0> {
    ...
    fun clamp_u64(arg0: u64, arg1: u64, arg2: u64) : u64 {
        min_u64(max_u64(arg0, arg1), arg2)
    }
    ...
    entry fun create_endowment<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::share_object<Endowment<T0>>(build_endowment<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9));
    }
    ...
    entry fun execute_wind_down<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: u64, arg3: address, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg6));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        let v0 = 0x2::balance::value<T0>(&arg1.unspent_credit_liability);
        assert!(0x2::balance::value<T0>(&arg1.unspent_credit_liability) == 0, 229);
        let v1 = if (arg2 == 0) {
            0
        } else {
            assert_withdrawable_principal<T0>(arg1, arg2);
            arg2
        };
        let v2 = if (v1 > 0) {
            0x2::coin::take<T0>(&mut arg1.principal, v1, arg6)
        } else {
            0x2::coin::zero<T0>(arg6)
        };
        arg1.nonce = arg1.nonce + 1;
        arg1.updated_at_ms = 0x2::clock::timestamp_ms(arg5);
        let v3 = WindDownExecuted{
            endowment_id             : 0x2::object::uid_to_inner(&arg1.id),
            character_id             : 0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0),
            owner                    : 0x2::tx_context::sender(arg6),
            refunded_liability_mist  : v0,
            released_principal_mist  : v1,
            remaining_principal_mist : 0x2::balance::value<T0>(&arg1.principal),
            keep_alive_reserve_mist  : arg1.keep_alive_reserve_mist,
            nonce                    : arg1.nonce,
            timestamp_ms             : arg1.updated_at_ms,
        };
        0x2::event::emit<WindDownExecuted>(v3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.unspent_credit_liability, v0, arg6), arg3);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v2, arg4);
    }
    ...
    fun jit_unstake_internal<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: u8, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg5));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        assert!(arg3 > 0, 207);
        assert_allocation_kind(arg2);
        let v0 = min_u64(arg3, releasable_above_floor<T0>(arg1));
        if (v0 > 0) {
            if (arg2 == 1) {
                0x2::balance::join<T0>(&mut arg1.keep_alive_allocation, 0x2::balance::split<T0>(&mut arg1.principal, v0));
            } else if (arg2 == 2) {
                0x2::balance::join<T0>(&mut arg1.storage_allocation, 0x2::balance::split<T0>(&mut arg1.principal, v0));
            } else {
                0x2::balance::join<T0>(&mut arg1.interaction_allocation, 0x2::balance::split<T0>(&mut arg1.principal, v0));
            };
            arg1.nonce = arg1.nonce + 1;
            arg1.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
            let v1 = AllocationFlow{
                anft_id     : arg1.character_id,
                from_bucket : 0,
                to_bucket   : allocation_bucket_code(arg2),
                amount      : v0,
                reason      : 4,
                at_ms       : arg1.updated_at_ms,
            };
            0x2::event::emit<AllocationFlow>(v1);
        } else {
            arg1.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        };
        let v2 = JitUnstakeExecuted{
            endowment_id             : 0x2::object::uid_to_inner(&arg1.id),
            character_id             : 0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0),
            owner                    : 0x2::tx_context::sender(arg5),
            requested_mist           : arg3,
            moved_mist               : v0,
            to_allocation_kind       : arg2,
            remaining_principal_mist : 0x2::balance::value<T0>(&arg1.principal),
            keep_alive_reserve_mist  : arg1.keep_alive_reserve_mist,
            nonce                    : arg1.nonce,
            timestamp_ms             : arg1.updated_at_ms,
        };
        0x2::event::emit<JitUnstakeExecuted>(v2);
        v0
    }

    entry fun jit_unstake_to_buffer<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        jit_unstake_internal<T0>(arg0, arg1, 1, arg2, arg3, arg4);
    }

    entry fun jit_unstake_to_lane<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: u8, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        jit_unstake_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5);
    }
    ...
    entry fun new_ratchet_state<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &Endowment<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg7));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        assert!(arg2 <= 10000 && arg3 <= 10000, 215);
        assert!(arg2 >= arg3, 230);
        assert!(arg4 <= arg5, 232);
        let v0 = clamp_u64(arg1.keep_alive_reserve_mist, arg4, arg5);
        let v1 = 0x2::clock::timestamp_ms(arg6);
        let v2 = RatchetState{
            id                    : 0x2::object::new(arg7),
            character_id          : 0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0),
            endowment_id          : 0x2::object::uid_to_inner(&arg1.id),
            observed_cost_mist    : 0,
            required_reserve_mist : v0,
            up_step_bps           : arg2,
            down_step_bps         : arg3,
            min_reserve_mist      : arg4,
            max_reserve_mist      : arg5,
            nonce                 : 0,
            created_at_ms         : v1,
            updated_at_ms         : v1,
        };
        let v3 = RatchetStateCreated{
            ratchet_id            : 0x2::object::uid_to_inner(&v2.id),
            endowment_id          : v2.endowment_id,
        ...
        0x2::event::emit<RatchetStateCreated>(v3);
        0x2::transfer::share_object<RatchetState>(v2);
    }
    ...
    public fun preview_wind_down<T0>(arg0: &Endowment<T0>) : (u64, u64, u64) {
        (0x2::balance::value<T0>(&arg0.unspent_credit_liability), 0x2::balance::value<T0>(&arg0.principal), arg0.keep_alive_reserve_mist)
    }
    ...
    entry fun recompute_reserve<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: &mut RatchetState, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg5));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        assert!(arg2.endowment_id == 0x2::object::uid_to_inner(&arg1.id), 231);
        assert!(arg2.character_id == 0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0), 231);
        let v0 = arg2.required_reserve_mist;
        let (v1, v2) = if (arg3 > v0) {
            (max_u64(min_u64(arg3, arg2.max_reserve_mist), v0), 1)
        } else if (arg3 < v0) {
            let v3 = v0 - arg3;
            let v4 = mul_bps(v3, arg2.down_step_bps);
            let v5 = if (v4 >= v3) {
                arg3
            } else {
                v0 - v4
            };
            (max_u64(v5, arg2.min_reserve_mist), 2)
        } else {
            (v0, 0)
        };
        let v6 = clamp_u64(v1, arg2.min_reserve_mist, arg2.max_reserve_mist);
        arg2.observed_cost_mist = arg3;
        arg2.required_reserve_mist = v6;
        arg2.nonce = arg2.nonce + 1;
        arg2.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        arg1.keep_alive_reserve_mist = v6;
        arg1.updated_at_ms = arg2.updated_at_ms;
        let v7 = ReserveRatcheted{
            ratchet_id         : 0x2::object::uid_to_inner(&arg2.id),
            endowment_id       : arg2.endowment_id,
            character_id       : arg2.character_id,
            direction          : v2,
            old_reserve_mist   : v0,
            new_reserve_mist   : v6,
            observed_cost_mist : arg3,
            nonce              : arg2.nonce,
            timestamp_ms       : arg2.updated_at_ms,
        };
        0x2::event::emit<ReserveRatcheted>(v7);
    }
    ...
    entry fun refund_credits<T0>(arg0: &0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter, arg1: &mut Endowment<T0>, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert_endowment_owner<T0>(arg0, arg1, 0x2::tx_context::sender(arg5));
        0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::assert_not_paused(arg0);
        assert!(arg2 > 0, 207);
        assert!(0x2::balance::value<T0>(&arg1.unspent_credit_liability) >= arg2, 228);
        arg1.nonce = arg1.nonce + 1;
        arg1.updated_at_ms = 0x2::clock::timestamp_ms(arg4);
        let v0 = CreditRefunded{
            endowment_id             : 0x2::object::uid_to_inner(&arg1.id),
            character_id             : 0x2::object::id<0x55d6fe64890a3feaeafc825c28032a9ff81a4891b35208333ded8abadea17d63::identity::LivingCharacter>(arg0),
            owner                    : 0x2::tx_context::sender(arg5),
            fan_recipient            : arg3,
            amount_mist              : arg2,
            remaining_liability_mist : 0x2::balance::value<T0>(&arg1.unspent_credit_liability),
            nonce                    : arg1.nonce,
            timestamp_ms             : arg1.updated_at_ms,
        };
        0x2::event::emit<CreditRefunded>(v0);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut arg1.unspent_credit_liability, arg2, arg5), arg3);
    }

    fun releasable_above_floor<T0>(arg0: &Endowment<T0>) : u64 {
        let v0 = 0x2::balance::value<T0>(&arg0.principal);
        if (v0 <= arg0.keep_alive_reserve_mist) {
            0
        } else {
            v0 - arg0.keep_alive_reserve_mist
        }
    }
    ...
    fun run_heartbeat<T0>(arg0: &mut Endowment<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, bool, u64, u64, u64, u64, u64) {
        ...
        let v2 = (((0x2::balance::value<T0>(&arg0.principal) as u128) * (2000 as u128) / (10000 as u128)) as u64);
        ...
        assert!(v1 <= v3, 227);
        let v4 = arg0.character_id;
        let v5 = 0x2::coin::into_balance<T0>(arg1);
        let v6 = &mut v5;
        let v7 = &mut arg0.keep_alive_allocation;
        let v8 = fund_until_target<T0>(v6, v7, arg0.keep_alive_target_mist);
        if (v8 > 0) {
            let v9 = AllocationFlow{
                anft_id     : v4,
                from_bucket : 6,
                to_bucket   : 1,
                amount      : v8,
            ...
            0x2::event::emit<AllocationFlow>(v9);
        };
        let v10 = &mut v5;
        let v11 = &mut arg0.storage_allocation;
        let v12 = fund_until_target<T0>(v10, v11, arg0.storage_target_mist);
        if (v12 > 0) {
            let v13 = AllocationFlow{
                anft_id     : v4,
                from_bucket : 6,
                to_bucket   : 3,
                amount      : v12,
            ...
            0x2::event::emit<AllocationFlow>(v13);
        };
        let v14 = &mut v5;
        let v15 = &mut arg0.interaction_allocation;
        let v16 = fund_until_target<T0>(v14, v15, arg0.interaction_target_mist);
        if (v16 > 0) {
        ...
        let v18 = 0x2::balance::value<T0>(&v5);
        0x2::balance::join<T0>(&mut arg0.principal, v5);
        if (v18 > 0) {
        ...
        let v20 = arg0.heartbeat_bounty_mist;
        if (v20 > 0) {
            let v21 = AllocationFlow{
                anft_id     : v4,
                from_bucket : 1,
                to_bucket   : 6,
                amount      : v20,
            ...
            0x2::event::emit<AllocationFlow>(v21);
        };
        arg0.last_epoch_ms = v0;
        arg0.nonce = arg0.nonce + 1;
        arg0.updated_at_ms = v0;
        (0x2::coin::take<T0>(&mut arg0.keep_alive_allocation, v20, arg3), true, v8, v12, v16, v18, v20)
    }
