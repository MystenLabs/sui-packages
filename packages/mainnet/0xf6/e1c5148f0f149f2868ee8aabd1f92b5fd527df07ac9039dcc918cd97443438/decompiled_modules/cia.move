module 0xf6e1c5148f0f149f2868ee8aabd1f92b5fd527df07ac9039dcc918cd97443438::cia {
    struct CIA has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CIA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://ipfs.io/ipfs/QmYarEKSsj4q8tWgMiSzTyZizBWFxQY7eVTMpDHZpAFvZ5                                                                                                                                                                                                                                                             ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<CIA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"CIA       ")))), trim_right(b"JFK Inside Job                  "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
