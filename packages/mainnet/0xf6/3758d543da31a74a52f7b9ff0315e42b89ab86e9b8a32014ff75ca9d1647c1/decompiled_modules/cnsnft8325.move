module 0xf63758d543da31a74a52f7b9ff0315e42b89ab86e9b8a32014ff75ca9d1647c1::cnsnft8325 {
    struct CNSNFT8325 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT8325, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=2890"));
        let v4 = 0x2::package::claim<CNSNFT8325>(arg0, arg1);
