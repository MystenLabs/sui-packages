module 0xf6fa41451db98960c7b36d397e4b9da3e29b76db9174e1237a2467ab52a2bd3d::movexnft2821 {
    struct MOVEXNFT2821 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2821, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2821>(arg0, arg1);
