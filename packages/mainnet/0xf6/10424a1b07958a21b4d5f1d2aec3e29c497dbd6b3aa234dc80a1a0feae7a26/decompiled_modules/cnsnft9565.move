module 0xf610424a1b07958a21b4d5f1d2aec3e29c497dbd6b3aa234dc80a1a0feae7a26::cnsnft9565 {
    struct CNSNFT9565 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9565, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=6254"));
        let v4 = 0x2::package::claim<CNSNFT9565>(arg0, arg1);
