module 0xf66174b425d4fd44b70adc6d5eb3d916245b8ba555aeaae29f8e06146c3aef77::meme_token {
    ...
    public fun init_internal(arg0: MEME_TOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<MEME_TOKEN>(arg0, 9, b"STR", b"SUI LAZY STR", b"", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://summon.lon1.cdn.digitaloceanspaces.com/2025-10-16T10-13-57.508Z-images (4).jpg")), arg1);
        ...
        let v2 = TokenCreatedEvent{
            name       : 0x1::string::utf8(b"SUI LAZY STR"),
            symbol     : 0x1::string::utf8(b"STR"),
            decimals   : 9,
