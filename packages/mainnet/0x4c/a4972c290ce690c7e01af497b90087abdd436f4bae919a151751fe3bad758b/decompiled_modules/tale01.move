module 0x4ca4972c290ce690c7e01af497b90087abdd436f4bae919a151751fe3bad758b::tale01 {
    ...
    fun init(arg0: TALE01, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"description"), 0x1::string::utf8(b"01"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"image_url"), 0x1::string::utf8(b"https://picsum.photos/600/600"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(b"[{ \"trait_type\": \"Edition\", \"value\": \"{index}\" }]"));
        ...
        0x2::transfer::public_share_object<MintConfig>(v4);
        ...
        0x2::transfer::public_transfer<0x2::transfer_policy::TransferPolicyCap<Nft>>(v6, v3);
    }
    ...
    public entry fun update_config(arg0: &AdminCap, arg1: &mut MintConfig, arg2: &mut 0x2::transfer_policy::TransferPolicy<Nft>, arg3: &0x2::transfer_policy::TransferPolicyCap<Nft>, arg4: u64, arg5: u64, arg6: u64, arg7: u64, arg8: u16, arg9: address, arg10: u64) {
        ...
        let v0 = if (arg1.royalty_bps != arg8) {
            ...
            0x4ca4972c290ce690c7e01af497b90087abdd436f4bae919a151751fe3bad758b::tale01_royalty::min_amount(0x4ca4972c290ce690c7e01af497b90087abdd436f4bae919a151751fe3bad758b::tale01_royalty::get_config<Nft>(arg2)) != arg10
        };
        if (v0) {
            0x4ca4972c290ce690c7e01af497b90087abdd436f4bae919a151751fe3bad758b::tale01_royalty::update<Nft>(arg2, arg3, arg8, arg9, arg10);
            arg1.royalty_bps = arg8;
            arg1.recipient = arg9;
        };
    }

    public entry fun update_display(arg0: &mut 0x2::display::Display<Nft>, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>) {
        ...
        0x2::display::edit<Nft>(arg0, 0x1::string::utf8(b"attributes"), 0x1::string::utf8(arg4));
