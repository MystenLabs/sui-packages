module 0x4c9ab46c7496b14f65911a6155abfbe174c29960331078ebee6452f4d4eb2a03::vault {
    ...
    struct Vault has key {
        id: 0x2::object::UID,
        borrow_members: 0x2::vec_set::VecSet<address>,
        withdraw_members: 0x2::vec_set::VecSet<address>,
    }
    ...
    public fun borrow<T0>(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T0>, FlashLoan) {
        ...
        assert!(0x2::vec_set::contains<address>(&arg0.borrow_members, &v0), 700);
        let v1 = withdraw_balance<T0>(arg0, arg1);
        let v2 = FlashLoan{
    ...
    public fun add_borrow_member(arg0: &AdminCap, arg1: &mut Vault, arg2: address) {
        0x2::vec_set::insert<address>(&mut arg1.borrow_members, arg2);
    }

    public fun add_withdraw_member(arg0: &AdminCap, arg1: &mut Vault, arg2: address) {
        0x2::vec_set::insert<address>(&mut arg1.withdraw_members, arg2);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Vault{
            ...
            borrow_members   : 0x2::vec_set::empty<address>(),
            withdraw_members : 0x2::vec_set::empty<address>(),
        };
        0x2::transfer::share_object<Vault>(v1);
    }

    public fun is_borrow_member(arg0: &Vault, arg1: address) : bool {
        0x2::vec_set::contains<address>(&arg0.borrow_members, &arg1)
    }

    public fun is_withdraw_member(arg0: &Vault, arg1: address) : bool {
        0x2::vec_set::contains<address>(&arg0.withdraw_members, &arg1)
    }
    ...
    public fun repay<T0>(arg0: &mut Vault, arg1: 0x2::coin::Coin<T0>, arg2: FlashLoan, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v2 == 0x1::type_name::with_defining_ids<T0>(), 704);
        let v4 = if (0x2::vec_set::contains<address>(&arg0.borrow_members, &v0)) {
            v3
        } else {
            v3 + (v3 + 99) / 100
        };
        assert!(0x2::coin::value<T0>(&arg1) >= v4, 702);
    ...
    public fun revoke_borrow_member(arg0: &AdminCap, arg1: &mut Vault, arg2: address) {
        0x2::vec_set::remove<address>(&mut arg1.borrow_members, &arg2);
    }

    public fun revoke_withdraw_member(arg0: &AdminCap, arg1: &mut Vault, arg2: address) {
        0x2::vec_set::remove<address>(&mut arg1.withdraw_members, &arg2);
    }

    public fun transfer_admin(arg0: AdminCap, arg1: &mut Vault, arg2: address, arg3: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg3);
        if (0x2::vec_set::contains<address>(&arg1.borrow_members, &v0)) {
            0x2::vec_set::remove<address>(&mut arg1.borrow_members, &v0);
        };
        if (0x2::vec_set::contains<address>(&arg1.withdraw_members, &v0)) {
            0x2::vec_set::remove<address>(&mut arg1.withdraw_members, &v0);
        };
    ...
    public fun withdraw<T0>(arg0: &mut Vault, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::tx_context::sender(arg2);
        assert!(0x2::vec_set::contains<address>(&arg0.withdraw_members, &v0), 701);
    ...
    fun withdraw_balance<T0>(arg0: &mut Vault, arg1: u64) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::dynamic_field::exists_<0x1::type_name::TypeName>(&arg0.id, v0), 703);
        let v1 = 0x2::dynamic_field::borrow_mut<0x1::type_name::TypeName, 0x2::balance::Balance<T0>>(&mut arg0.id, v0);
        assert!(0x2::balance::value<T0>(v1) >= arg1, 702);
