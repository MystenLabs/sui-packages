module 0xe2838c056bbd1df206bc45a4291e79f73386d1e7bfb83bc485116fec3ddb250b::sdstaging {
    ...
    public fun check_allowed(arg0: &0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg0) == @0x1e07453a476033dba61689c3aa77e5ad0bf542432004a3e56dddc0e8c1ab3eaa, 100);
    }
    ...
    public fun get_account_cap(arg0: &MyStruct) : &0xd899cf7d2b5db716bd2cf55599fb0d5ee38a3061e7b6bb6eebf73fa5bc4c81ca::account::AccountCap {
        &arg0.navi_account
    }

    public fun get_balance<T0>(arg0: &mut Treasury<T0>) : &mut 0x2::balance::Balance<T0> {
        &mut arg0.balance
    }

    public fun get_fee_balance<T0>(arg0: &mut Treasury<T0>) : &mut 0x2::balance::Balance<T0> {
        &mut arg0.fee_balance
    }
    ...
    public fun withdraw<T0>(arg0: &mut Treasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        check_allowed(arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.balance, arg1), arg2), @0x1e07453a476033dba61689c3aa77e5ad0bf542432004a3e56dddc0e8c1ab3eaa);
    }

    public fun withdrawFees<T0>(arg0: &mut Treasury<T0>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) {
        check_allowed(arg2);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.fee_balance, arg1), arg2), @0x1e07453a476033dba61689c3aa77e5ad0bf542432004a3e56dddc0e8c1ab3eaa);
    }
