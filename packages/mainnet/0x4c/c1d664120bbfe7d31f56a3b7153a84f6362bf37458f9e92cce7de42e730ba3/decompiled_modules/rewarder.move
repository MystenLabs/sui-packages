module 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::rewarder {
    ...
    public fun deposit_reward<T0>(arg0: &0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: 0x2::balance::Balance<T0>) {
    ...
    public fun emergent_withdraw<T0>(arg0: &0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::config::GlobalConfig, arg1: &mut RewarderGlobalVault, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) {
        0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::config::checked_package_version(arg0);
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v0, arg3), 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::config::get_reward_receiver(arg0));
    ...
    public fun get_reward_emission<T0>(arg0: &RewarderManager, arg1: &0x2::clock::Clock) : u128 {
        ...
        if (v1 > 0 && v2 > v3) {
            return 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::safe_math::mul_div_u128(v1, ((v2 - v3) as u128), 1000)
        };
        0
    }
    ...
    public(friend) fun simulate_update_rewarder(arg0: &Rewarder, arg1: u128, arg2: &0x2::clock::Clock) : u128 {
        ...
        if (arg0.emission_per_second > 0 && v0 > arg0.last_update_timestamp) {
            return 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::safe_math::add_u128(arg0.reward_per_fee_accumulated, 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::safe_math::mul_div_u128(0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::safe_math::mul_div_u128(arg0.emission_per_second, ((v0 - arg0.last_update_timestamp) as u128), 1000), 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::q64x64::scale_64x64(), arg1))
        };
        arg0.reward_per_fee_accumulated
    }
    ...
    public(friend) fun update_reward_emission<T0>(arg0: &RewarderGlobalVault, arg1: &mut RewarderManager, arg2: 0x2::object::ID, arg3: u128) {
        ...
        let v2 = RewardEmissionUpdateEvent{
            pair         : arg2,
            reward_type  : v0,
            old_emission : v1.emission_per_second,
            new_emission : arg3,
        };
    ...
    public(friend) fun update_rewarder(arg0: &mut Rewarder, arg1: u128, arg2: &0x2::clock::Clock) : u128 {
        ...
        if (arg0.emission_per_second > 0 && v0 > arg0.last_update_timestamp) {
            arg0.reward_per_fee_accumulated = 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::safe_math::add_u128(arg0.reward_per_fee_accumulated, 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::safe_math::mul_div_u128(0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::safe_math::mul_div_u128(arg0.emission_per_second, ((v0 - arg0.last_update_timestamp) as u128), 1000), 0x4cc1d664120bbfe7d31f56a3b7153a84f6362bf37458f9e92cce7de42e730ba3::q64x64::scale_64x64(), arg1));
