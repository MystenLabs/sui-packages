module 0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::outbox_bridge {
    ...
    fun create_merkle_update_message_hash(arg0: u64, arg1: vector<u8>) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v0, 0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::utils::u64_to_be_bytes(arg0));
    ...
    fun create_outbox_proof_hash(arg0: vector<u8>, arg1: vector<u8>, arg2: u64) : vector<u8> {
        ...
        0x1::vector::append<u8>(&mut v1, 0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::utils::u64_to_be_bytes(arg2));
    ...
    public fun hash_to_g1_bump(arg0: vector<u8>) {
        let (_, v1) = 0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::alt_bn128::hash_to_g1(arg0);
        let v2 = InitialMerkleRootSetEvent{
            epoch : (v1 as u64),
            root  : arg0,
        };
        0x2::event::emit<InitialMerkleRootSetEvent>(v2);
    }
    ...
    fun verify_receive_signature(arg0: vector<u8>, arg1: vector<u8>, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: vector<u8>) {
        assert!(0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::merkle::verify_merkle_aggregation(arg2, arg4, arg3, arg1), 7);
        let (v0, _) = 0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::alt_bn128::hash_to_g1(arg0);
        assert!(0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::alt_bn128::verify(arg5, arg4, v0), 8);
    }
    ...
    fun verify_update_signature(arg0: u64, arg1: vector<u8>, arg2: u64, arg3: vector<vector<u8>>, arg4: vector<u8>, arg5: vector<u8>, arg6: vector<u8>) {
        assert!(0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::merkle::verify_merkle_aggregation(arg2, arg4, arg3, arg6), 7);
        let (v0, _) = 0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::alt_bn128::hash_to_g1(create_merkle_update_message_hash(arg0, arg1));
        assert!(0x4c5bb62df78bb552f6a49aa42bd202fdedd7cfd08d4acb093e7e4b021f84668b::alt_bn128::verify(arg5, arg4, v0), 8);
    }
