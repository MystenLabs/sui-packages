module 0x4ce803b91381f8d06f4b18afabf0f2518f194224535029f0c6134329a5643fd8::venturemints__digital_frontier_common_lands {
    struct VENTUREMINTS__DIGITAL_FRONTIER_COMMON_LANDS has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: VENTUREMINTS__DIGITAL_FRONTIER_COMMON_LANDS, arg1: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::package::claim<VENTUREMINTS__DIGITAL_FRONTIER_COMMON_LANDS>(arg0, arg1);
        let v1 = 0x2::display::new<Nft>(&v0, arg1);
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_name"), 0x1::string::utf8(b"VentureMints: Digital Frontier Common Lands"));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_description"), 0x1::string::utf8(x""));
        0x2::display::add<Nft>(&mut v1, 0x1::string::utf8(b"collection_media_url"), 0x1::string::utf8(b"ipfs://bafybeib22iqo4ovv2owetlkbhded67ycyv5rs5lcmsn6gdtxwy4hu55kb4"));
