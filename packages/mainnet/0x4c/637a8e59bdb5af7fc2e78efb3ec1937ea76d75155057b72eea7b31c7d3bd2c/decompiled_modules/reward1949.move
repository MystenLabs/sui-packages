module 0x4c637a8e59bdb5af7fc2e78efb3ec1937ea76d75155057b72eea7b31c7d3bd2c::reward1949 {
    struct REWARD1949 has drop {
        dummy_field: bool,
    }

    struct TICKET_1949 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1949(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1949>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1949>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1949, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1949>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1949>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1949>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1949>>(v5, 0x2::tx_context::sender(arg1));
    }
