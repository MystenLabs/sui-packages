module 0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::sui_safe {
    ...
    struct YieldLock<phantom T0> has store, key {
        ...
        strategy: u8,
        market_coin: 0x2::coin::Coin<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::reserve::MarketCoin<T0>>,
    }
    ...
    public entry fun configure_scallop(arg0: &AdminCap, arg1: &mut Platform, arg2: &0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::market::Market, arg3: &0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::version::Version, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg4);
        assert!(v0 == arg1.admin, 1);
        assert!(0x2::object::id<AdminCap>(arg0) == arg1.admin_cap_id, 7);
        arg1.scallop_market_id = 0x1::option::some<0x2::object::ID>(0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::market::Market>(arg2));
        arg1.scallop_version_id = 0x1::option::some<0x2::object::ID>(0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::version::Version>(arg3));
        let v1 = ScallopConfigured{
            admin      : v0,
            market_id  : 0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::market::Market>(arg2),
            version_id : 0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::version::Version>(arg3),
        };
    ...
    public entry fun create_yield_lock<T0>(arg0: &Platform, arg1: &mut UserRegistry, arg2: &0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::version::Version, arg3: &mut 0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::market::Market, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused_deposits, 6);
        assert!(arg5 > 0, 0);
        ...
        assert!(0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::market::Market>(arg3) == *0x1::option::borrow<0x2::object::ID>(&arg0.scallop_market_id), 4);
        assert!(0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::version::Version>(arg2) == *0x1::option::borrow<0x2::object::ID>(&arg0.scallop_version_id), 4);
        let v0 = 0x1::type_name::get<T0>();
        assert!(0x1::vector::contains<0x1::type_name::TypeName>(&arg0.supported_tokens, &v0), 2);
        ...
        let v4 = 0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::mint::mint<T0>(arg2, arg3, arg4, arg6, arg7);
        let v5 = YieldLock<T0>{
        ...
        let v7 = YieldLockCreated<T0>{
            ...
            start_time         : v2,
            duration_ms        : arg5,
            market_coin_amount : 0x2::coin::value<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::reserve::MarketCoin<T0>>(&v4),
        };
    ...
    public entry fun withdraw_yield_lock<T0>(arg0: YieldLock<T0>, arg1: &mut Platform, arg2: &mut UserRegistry, arg3: &0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::version::Version, arg4: &mut 0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::market::Market, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.paused_withdrawals, 6);
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(v0 == arg0.owner, 1);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg1.scallop_market_id), 4);
        assert!(0x1::option::is_some<0x2::object::ID>(&arg1.scallop_version_id), 4);
        assert!(0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::market::Market>(arg4) == *0x1::option::borrow<0x2::object::ID>(&arg1.scallop_market_id), 4);
        assert!(0x2::object::id<0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::version::Version>(arg3) == *0x1::option::borrow<0x2::object::ID>(&arg1.scallop_version_id), 4);
        let v1 = 0x1::type_name::get<T0>();
        assert!(0x1::vector::contains<0x1::type_name::TypeName>(&arg1.supported_tokens, &v1), 2);
        let YieldLock {
            id               : v2,
        ...
        let v11 = 0x4c3dfe7f92ec3f9e9b0c35244a19a13b6a9038ea8ff2dd28cfbd2592274e856d::redeem::redeem<T0>(arg3, arg4, v8, arg5, arg6);
