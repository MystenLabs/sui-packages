module 0x4c8369eabae2e6535658ccb543a8d16447d685c2dfa2da72eb32d22b7e76a157::cnsnft6420 {
    struct CNSNFT6420 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6420, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6420>(arg0, arg1);
