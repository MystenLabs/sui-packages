module 0x4c594901145a277f8443a731514bcf0870ea946a413dd682c5df4e424a5769fc::risk_manager {
    ...
    public(friend) fun add_risk(arg0: &mut RiskManager, arg1: 0x1::type_name::TypeName, arg2: vector<0x4c594901145a277f8443a731514bcf0870ea946a413dd682c5df4e424a5769fc::bet_manager::Placement>, arg3: u64) {
        ...
        let v3 = 0;
        while (v3 < 0x1::vector::length<0x4c594901145a277f8443a731514bcf0870ea946a413dd682c5df4e424a5769fc::bet_manager::Placement>(&arg2)) {
            let (v4, v5) = 0x4c594901145a277f8443a731514bcf0870ea946a413dd682c5df4e424a5769fc::bet_manager::get_placement_data(0x1::vector::borrow<0x4c594901145a277f8443a731514bcf0870ea946a413dd682c5df4e424a5769fc::bet_manager::Placement>(&arg2, v3));
