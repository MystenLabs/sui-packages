module 0x4ca03304910c0623a86cfb5d2ac9b81a120ab79f2b8ee16f041a8c5d9a3b0305::cnsnft1217 {
    struct CNSNFT1217 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1217, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT1217>(arg0, arg1);
