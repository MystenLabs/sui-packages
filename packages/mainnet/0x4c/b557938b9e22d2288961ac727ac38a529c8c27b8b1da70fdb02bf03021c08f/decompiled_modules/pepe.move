module 0x4cb557938b9e22d2288961ac727ac38a529c8c27b8b1da70fdb02bf03021c08f::pepe {
    ...
    fun init(arg0: PEPE, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<PEPE>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"PEPE    ")))), trim_right(b"SUI PEPE                        "), trim_right(b"The Boys Club have already run on Ethereum, but our friends at Based Brett have shown that the memecoin season on SUI has just begun                                                                                                                                                                                            "), v2, arg1);
