module 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::executor {
    ...
    struct Executor has store, key {
        ...
        market: 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::Market,
        config: 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::AMMConfig,
        info: 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::Info,
    }
    ...
    public fun config(arg0: &Executor) : &0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::AMMConfig {
        &arg0.config
    }
    ...
    fun cancel_orders<T0, T1>(arg0: &mut Executor, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) : 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof {
        ...
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::update(&mut arg0.info, volume_base<T0, T1>(arg0, arg1), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T1>(&arg0.balance_manager), 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::balance<T0>(&arg0.balance_manager));
        v0
    }
    ...
    public fun cancel_orders_after_update<T0, T1>(arg0: &mut Executor, arg1: RefreshTicket, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::has_valid_pool<T0, T1>(&arg0.market, arg2), 13835341415749648387);
        ...
        if (0x1::option::is_some<u64>(&v0)) {
            ...
            let v3 = if (v2 == 0) {
                ...
                if (0x1::option::is_some<u64>(&v4)) {
                    ...
                    abort 13837312831509233681
                }
            };
            assert!(v3 <= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::max_price(), 13837312840099168273);
            return v3
        } else {
            0x1::option::destroy_none<u64>(v0);
            abort 13837312801444462609
        };
    }
    ...
    fun compute_bid_price(arg0: u64, arg1: u64, arg2: u64) : u64 {
        ...
        if (0x1::option::is_some<u64>(&v0)) {
            let v1 = 0x1::option::destroy_some<u64>(v0);
            let v2 = v1 - v1 % arg2;
            assert!(v2 >= 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::min_price(), 13837031279222980623);
            return v2
        } else {
            0x1::option::destroy_none<u64>(v0);
            abort 13837031262043111439
        };
    }

    public fun create(arg0: 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::Market, arg1: 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::AMMConfig, arg2: &mut 0x2::tx_context::TxContext) : (Executor, AdminCap) {
        ...
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::emit_executor_created(0x2::object::uid_to_inner(&v1), 0x2::object::uid_to_inner(&v2));
        let v3 = AdminCap{
            id          : v2,
        ...
        let v5 = Executor{
            ...
            market          : arg0,
            config          : arg1,
            info            : 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::empty(),
        };
        (v5, v3)
    }

    public fun market(arg0: &Executor) : &0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::Market {
        &arg0.market
    }
    ...
    public fun deposit<T0>(arg0: &mut Executor, arg1: &AdminCap, arg2: 0x2::coin::Coin<T0>, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        if (v0 == 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::base_type(&arg0.market)) {
            0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::record_base_deposit(&mut arg0.info, v1);
        } else {
            assert!(v0 == 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::quote_type(&arg0.market), 13837592253491707923);
            0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::record_quote_deposit(&mut arg0.info, v1);
        };
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::emit_deposited(id(arg0), v0, v1);
    ...
    public fun info(arg0: &Executor) : &0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::Info {
        &arg0.info
    }
    ...
    public fun pause<T0, T1>(arg0: &mut Executor, arg1: &AdminCap, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::has_valid_pool<T0, T1>(&arg0.market, arg2), 13835340303353118723);
        cancel_orders<T0, T1>(arg0, arg2, arg3, arg4);
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::emit_executor_paused(id(arg0));
        arg0.active = false;
    }
    ...
    public fun refresh_quotes<T0, T1>(arg0: &mut Executor, arg1: &AdminCap, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::has_valid_pool<T0, T1>(&arg0.market, arg2), 13835341123691872259);
        assert!(arg0.active, 13835904082235490311);
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::set_latest_publish_times(&mut arg0.market, arg5);
    ...
    public fun refresh_quotes_after_update<T0, T1>(arg0: &mut Executor, arg1: RefreshTicket, arg2: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::has_valid_pool<T0, T1>(&arg0.market, arg2), 13835341235361021955);
    ...
    fun refresh_quotes_inner<T0, T1>(arg0: &mut Executor, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: u64, arg3: u64, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) {
        ...
        let v1 = 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::base_spread(&arg0.config, arg2);
        let v2 = 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::outer_spread(&arg0.config, arg2, arg3);
        ...
        let v5 = 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::reservation_mid(&arg0.config, arg2, v3, v4);
        ...
        let v13 = if (v9 == v10) {
            ...
            0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::outer_balance(&arg0.config, v4)
        };
        let v14 = if (v12 == v11) {
            0
        } else {
            0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::outer_balance(&arg0.config, v3)
        };
        let v15 = LimitOrderParams{
            price    : v9,
            quantity : round_down_quantity(quote_to_base_quantity(v13, v9), v7),
            is_bid   : true,
        };
        let v16 = LimitOrderParams{
            price    : v10,
            quantity : round_down_quantity(quote_to_base_quantity(v4 - v13, v10), v7),
            is_bid   : true,
        };
        let v17 = LimitOrderParams{
            price    : v11,
            quantity : round_down_quantity(v3 - v14, v7),
            is_bid   : false,
        };
        let v18 = LimitOrderParams{
            price    : v12,
            quantity : round_down_quantity(v14, v7),
            is_bid   : false,
        };
        let v19 = 0x1::vector::empty<LimitOrderParams>();
        let v20 = &mut v19;
        0x1::vector::push_back<LimitOrderParams>(v20, v15);
        0x1::vector::push_back<LimitOrderParams>(v20, v16);
        0x1::vector::push_back<LimitOrderParams>(v20, v17);
        0x1::vector::push_back<LimitOrderParams>(v20, v18);
        let v21 = try_place_limit_orders<T0, T1>(arg0, arg1, &v0, v19, arg4, arg5);
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::set_price_and_conf(&mut arg0.market, arg2, arg3);
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::emit_quote_updated(id(arg0), arg2, v21);
    }
    ...
    public fun refresh_quotes_permissionless<T0, T1>(arg0: &mut Executor, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg3: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::has_valid_pool<T0, T1>(&arg0.market, arg1), 13835340737144815619);
        assert!(arg0.active, 13835903695688433671);
        assert!(0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::has_valid_base_pyth_feed_id(&arg0.market, arg2), 13835059287937777665);
        assert!(0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::has_valid_quote_pyth_feed_id(&arg0.market, arg3), 13835059305117646849);
        let v0 = 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::max_price_age_secs(&arg0.config);
        ...
        if (v3 && !0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::try_update_publish_times(&mut arg0.market, v1, v2)) {
            return
        };
        let (v4, v5) = 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::deepbook_price(&arg0.market, v1, v2, 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::max_conf_ratio_bps(&arg0.config));
        let v6 = 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::mid_price(&arg0.market);
        let v7 = 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::conf_ratio_bps(&arg0.market);
        let v8 = if (v3) {
        ...
        if (v8) {
            if (0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::is_stale_tolerant(&arg0.config, v4, v5, 0x1::option::destroy_some<u64>(v6), 0x1::option::destroy_some<u64>(v7))) {
                return
            };
        };
    ...
    fun try_place_limit_orders<T0, T1>(arg0: &mut Executor, arg1: &mut 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::Pool<T0, T1>, arg2: &0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::balance_manager::TradeProof, arg3: vector<LimitOrderParams>, arg4: &0x2::clock::Clock, arg5: &0x2::tx_context::TxContext) : vector<0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::LimitOrder> {
        let (_, _, v2) = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::pool_book_params<T0, T1>(arg1);
        let v3 = if (0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::post_only(&arg0.config)) {
        ...
        let v4 = 0x1::vector::empty<0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::LimitOrder>();
        let v5 = 0;
        while (v5 < 0x1::vector::length<LimitOrderParams>(&arg3)) {
            ...
            let v10 = 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::pool::place_limit_order<T0, T1>(arg1, &mut arg0.balance_manager, arg2, v9, v3, 0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::constants::cancel_taker(), v6, v7, v8, false, 0x2::clock::timestamp_ms(arg4) + 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::order_expiration_time_ms(&arg0.config), arg4, arg5);
            0x1::vector::push_back<0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::LimitOrder>(&mut v4, 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::new_order(0x2c8d603bc51326b8c13cef9dd07031a408a48dddb541963357661df5d3204809::order_info::order_id(&v10), v6, v7, v8));
        };
        v4
    }
    ...
    public fun unpause(arg0: &mut Executor, arg1: &AdminCap) {
        ...
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::emit_executor_unpaused(id(arg0));
        arg0.active = true;
    }

    public fun update_config(arg0: &mut Executor, arg1: &AdminCap, arg2: 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::config::AMMConfig) : RefreshTicket {
        assert!(id(arg0) == arg1.executor_id, 13835621688135647237);
        assert!(&arg0.config != &arg2, 13836747592337981453);
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::emit_executor_config_updated(id(arg0));
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::reset_freshness_state(&mut arg0.market);
        arg0.config = arg2;
    ...
    public fun withdraw<T0>(arg0: &mut Executor, arg1: &AdminCap, arg2: u64, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        if (v0 == 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::base_type(&arg0.market)) {
            0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::record_base_withdraw(&mut arg0.info, arg2);
        } else {
            assert!(v0 == 0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::market::quote_type(&arg0.market), 13837592382340726803);
            0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::info::record_quote_withdraw(&mut arg0.info, arg2);
        };
        0x634fd7331a366f1eebc09d6d7a0ef2dd13aaf72ea2f8e4714936dad7a6d873a2::events::emit_withdrawn(id(arg0), v0, arg2);
