module 0x4ceb15a0384439a0ed4d30148dae612a991ac2707b89f7c151ec986d0645b1ce::reward2087 {
    struct REWARD2087 has drop {
        dummy_field: bool,
    }

    struct TICKET_2087 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2087(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2087>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2087>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2087, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2087>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2087>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2087>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2087>>(v5, 0x2::tx_context::sender(arg1));
    }
