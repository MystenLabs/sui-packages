module 0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_hero_staking {
    ...
    fun attempt_fragment_finding<T0, T1, T2, T3, T4, T5, T6, T7, T8>(arg0: &mut HeroStakingPool, arg1: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_land::StakingPool, arg2: &mut 0x9afb9a1c63a9bbaba650ef0a6b473b9874882cd63aab9570b99274e8f796f00::pawtato_resources::PawtatoResources, arg3: &0x2::clock::Clock, arg4: &0x2::random::Random, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = 100 * v15 * (v13 as u128) / 10000;
        let v17 = 0x2::random::new_generator(arg4, arg5);
        let v18 = 0x2::random::generate_u128(&mut v17) % 1000000;
        let v19 = 0x1::vector::empty<u128>();
        0x1::vector::push_back<u128>(&mut v19, v16);
        let v20 = FragmentRolled{
            user    : v0,
            roll    : v18,
            chances : v19,
        };
        0x2::event::emit<FragmentRolled>(v20);
        if (v18 < v16) {
            let v21 = 1000000000;
            let v22 = 0x2::random::generate_u64(&mut v17) % v13;
            if (v22 == 0) {
                mint_and_transfer_coin<T0>(arg0, arg2, v21, v0, arg5);
                ...
                mint_and_transfer_coin<T1>(arg0, arg2, v21, v0, arg5);
                ...
                mint_and_transfer_coin<T2>(arg0, arg2, v21, v0, arg5);
                ...
                mint_and_transfer_coin<T3>(arg0, arg2, v21, v0, arg5);
                ...
                mint_and_transfer_coin<T4>(arg0, arg2, v21, v0, arg5);
                ...
                mint_and_transfer_coin<T5>(arg0, arg2, v21, v0, arg5);
                ...
                mint_and_transfer_coin<T6>(arg0, arg2, v21, v0, arg5);
                let v29 = FragmentFound{
                    user          : v0,
                    fragment_type : v7,
                    amount        : v21,
                    roll          : v18,
                };
                0x2::event::emit<FragmentFound>(v29);
            } else if (v22 == 7) {
                mint_and_transfer_coin<T7>(arg0, arg2, v21, v0, arg5);
                let v30 = FragmentFound{
                    user          : v0,
                    fragment_type : v8,
                    amount        : v21,
                    roll          : v18,
                };
                0x2::event::emit<FragmentFound>(v30);
            } else if (v22 == 8) {
                mint_and_transfer_coin<T8>(arg0, arg2, v21, v0, arg5);
                let v31 = FragmentFound{
                    user          : v0,
                    fragment_type : v9,
                    amount        : v21,
                    roll          : v18,
                };
                0x2::event::emit<FragmentFound>(v31);
            };
        };
    }
    ...
    public entry fun upgrade_version(arg0: &0xe0fa7b75a3dc8137b38bceb0c0c21c10e0f57c408fe9068694f58fd21e071925::pawtato_heroes::HeroAdminCap, arg1: &mut HeroStakingPool, arg2: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.version < 1, 13906840754233278463);
        arg1.version = 1;
    }
