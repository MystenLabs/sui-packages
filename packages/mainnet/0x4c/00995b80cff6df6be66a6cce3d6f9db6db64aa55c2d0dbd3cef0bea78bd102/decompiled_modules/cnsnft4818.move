module 0x4c00995b80cff6df6be66a6cce3d6f9db6db64aa55c2d0dbd3cef0bea78bd102::cnsnft4818 {
    struct CNSNFT4818 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4818, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4818>(arg0, arg1);
