module 0x4c9bf061d3fb029d673b6f71e5993027a61cfe963ab0abe2cb97f8595093497d::farm {
    ...
    fun calculate_accrued_rewards_per_share(arg0: u64, arg1: u256, arg2: u64, arg3: u64, arg4: u64) : u256 {
        arg1 + 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::math256::min((arg3 as u256), (arg0 as u256) * (arg4 as u256)) / (arg2 as u256)
    }
    ...
    public fun new_farm<T0, T1>(arg0: &mut 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::owner::OwnerCap<FarmWitness>, arg1: &0x2::clock::Clock, arg2: u64, arg3: u64, arg4: &0x2::transfer_policy::TransferPolicy<T0>, arg5: &mut 0x2::tx_context::TxContext) : Farm<T0, T1> {
        assert!(arg3 > clock_timestamp_s(arg1), 3);
        let (v0, v1) = 0x2::kiosk::new(arg5);
        let v2 = v0;
        let v3 = 0x2::object::id<0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::owner::OwnerCap<FarmWitness>>(arg0);
        let v4 = Farm<T0, T1>{
        ...
        let v5 = 0x2::object::id<Farm<T0, T1>>(&v4);
        let v6 = FarmWitness{dummy_field: false};
        0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::owner::add<FarmWitness>(arg0, v6, v5);
        let v7 = NewFarm<T0, T1>{
            farm : v5,
            cap  : v3,
        };
        0x2::event::emit<NewFarm<T0, T1>>(v7);
    ...
    public fun remove_rewards<T0, T1>(arg0: &0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::owner::OwnerCap<FarmWitness>, arg1: &mut Farm<T0, T1>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        update<T0, T1>(arg1, clock_timestamp_s(arg3));
        0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::owner::assert_ownership<FarmWitness>(arg0, 0x2::object::id<Farm<T0, T1>>(arg1));
        0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_reward_coin, arg2), arg4)
    }
    ...
    public fun stake<T0: store + key, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: &0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::kiosk::Kiosk, arg4: T0, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (0x2::table_vec::length<0x2::object::ID>(&arg1.nft_ids) != 0) {
            let v1 = 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::math64::min(calculate_pending_rewards<T0, T1>(arg1, arg0.accrued_rewards_per_share), 0x2::balance::value<T1>(&arg0.balance_reward_coin));
            if (v1 != 0) {
    ...
    public fun stake_personal_kiosk<T0: store + key, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: &0x2::transfer_policy::TransferPolicy<T0>, arg3: &mut 0x2::kiosk::Kiosk, arg4: 0x2::object::ID, arg5: &mut 0x2::kiosk::Kiosk, arg6: &0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::PersonalKioskCap, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, 0x2::transfer_policy::TransferRequest<T0>) {
        0x2::kiosk::list<T0>(arg5, 0x434b5bd8f6a7b05fede0ff46c6e511d71ea326ed38056e3bcd681d2d7c2a7879::personal_kiosk::borrow(arg6), arg4, 0);
        let (v0, v1) = 0x2::kiosk::purchase<T0>(arg5, arg4, 0x2::coin::zero<0x2::sui::SUI>(arg8));
        (stake<T0, T1>(arg0, arg1, arg2, arg3, v0, arg7, arg8), v1)
    }
    ...
    public fun unstake<T0: store + key, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: &mut 0x2::kiosk::Kiosk, arg3: 0x2::object::ID, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T1>, T0, 0x2::transfer_policy::TransferRequest<T0>) {
        ...
        if (v1 != 0) {
            0x2::balance::join<T1>(0x2::coin::balance_mut<T1>(&mut v2), 0x2::balance::split<T1>(&mut arg0.balance_reward_coin, 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::math64::min(v1, 0x2::balance::value<T1>(&arg0.balance_reward_coin))));
        };
        arg1.reward_debt = calculate_reward_debt(0x2::table_vec::length<0x2::object::ID>(&arg1.nft_ids), arg0.accrued_rewards_per_share);
    ...
    public fun withdraw_rewards<T0, T1>(arg0: &mut Farm<T0, T1>, arg1: &mut Account<T0, T1>, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        if (v0 != 0) {
            0x2::balance::join<T1>(0x2::coin::balance_mut<T1>(&mut v1), 0x2::balance::split<T1>(&mut arg0.balance_reward_coin, 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::math64::min(v0, 0x2::balance::value<T1>(&arg0.balance_reward_coin))));
        };
        arg1.reward_debt = calculate_reward_debt(0x2::table_vec::length<0x2::object::ID>(&arg1.nft_ids), arg0.accrued_rewards_per_share);
