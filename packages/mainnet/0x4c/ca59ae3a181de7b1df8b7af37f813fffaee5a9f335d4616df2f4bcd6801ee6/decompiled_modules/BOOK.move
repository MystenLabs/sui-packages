module 0x4cca59ae3a181de7b1df8b7af37f813fffaee5a9f335d4616df2f4bcd6801ee6::BOOK {
    ...
    public entry fun mint(arg0: &mut 0x2::coin::TreasuryCap<BOOK>, arg1: u64, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::coin::total_supply<BOOK>(arg0) + arg1 <= 10000000000000000000, 1);
    ...
    fun init(arg0: BOOK, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<BOOK>(arg0, 9, b"BOOK", b"TBook Token", b"BOOK: The TBook Token.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://walrus-main-aggregator.4everland.org/v1/blobs/nfEkXADqqsRfQPYnnn8nP4qNpppKulUGdgDYqL6EaCA")), arg1);
