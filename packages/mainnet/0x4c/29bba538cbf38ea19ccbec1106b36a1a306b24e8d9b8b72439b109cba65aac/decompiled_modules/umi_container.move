module 0x6514bb6123f8b566396c377f6bc0252c60c50b1236f6cf9092dd8d9b1054f6dc::umi_container {
    ...
    fun contains_subslice(arg0: &vector<u8>, arg1: &vector<u8>) : bool {
    ...
    public fun deposit_cap<T0: store + key>(arg0: &mut UmiContainer, arg1: T0, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = b"dd24c62739923fbf582f49ef190b4a007f981ca6eb209ca94f3a8eaf7c611317";
        assert!(0x1::ascii::as_bytes(&v2) == &v3, 5);
        let v4 = 0x1::type_name::get_module(&v1);
        let v5 = b"coordinator_inner";
        assert!(0x1::ascii::as_bytes(&v4) == &v5, 5);
        let v6 = *0x1::type_name::borrow_string(&v1);
        let v7 = 0x1::ascii::string(b"::coordinator_inner::DWalletCap");
        assert!(contains_subslice(0x1::ascii::as_bytes(&v6), 0x1::ascii::as_bytes(&v7)), 5);
        let v8 = 0x2::object::id<T0>(&arg1);
        assert!(!contains_id(&arg0.cap_ids, v8), 2);
        0x2::dynamic_object_field::add<0x2::object::ID, T0>(&mut arg0.id, v8, arg1);
        0x1::vector::push_back<0x2::object::ID>(&mut arg0.cap_ids, v8);
        let v9 = CapDeposited{
            container_id : 0x2::object::id<UmiContainer>(arg0),
            owner        : v0,
            cap_id       : v8,
        };
        0x2::event::emit<CapDeposited>(v9);
    }
