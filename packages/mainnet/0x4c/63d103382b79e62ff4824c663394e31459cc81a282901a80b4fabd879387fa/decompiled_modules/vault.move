module 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::vault {
    ...
    struct ObligationKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public fun accrue_performance_fee_with_adapter<T0>(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: &mut 0x2::tx_context::TxContext) {
        0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::get_suilend_reserve<T0, 0x2::sui::SUI>(arg3);
        let v0 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::get_suilend_fee_receiver<T0>(arg3);
    ...
    public entry fun admin_claim_and_compound_reward<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::get_suilend_fee_receiver<T0>(arg1);
        ensure_obligation_cap<T0>(arg0, arg1, arg6);
        let v0 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::claim_rewards_from_suilend<T0, 0x2::sui::SUI>(arg1, borrow_obligation_cap<T0>(arg0), arg2, arg3, arg4, arg5, arg6);
    ...
    public entry fun admin_claim_reward<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg6) == arg0.admin, 1001);
        let v0 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::get_suilend_fee_receiver<T0>(arg1);
        ensure_obligation_cap<T0>(arg0, arg1, arg6);
        let v1 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::claim_rewards_from_suilend<T0, T1>(arg1, borrow_obligation_cap<T0>(arg0), arg2, arg3, arg4, arg5, arg6);
    ...
    public entry fun borrow_from_vault<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: u64, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        ensure_obligation_cap<T0>(arg0, arg1, arg5);
        ensure_borrow_position(arg0, arg2);
        let v0 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::borrow_from_suilend<T0, T1>(arg1, arg2, borrow_obligation_cap<T0>(arg0), arg3, arg4, arg5);
        let v1 = borrow_position_mut(arg0, arg2);
        v1.total_borrowed = v1.total_borrowed + arg4;
    ...
    fun borrow_obligation_cap<T0>(arg0: &Vault) : &0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0> {
        0x2::dynamic_field::borrow<ObligationKey, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(&arg0.id, obligation_key())
    }

    fun borrow_position(arg0: &Vault, arg1: u64) : &BorrowPosition {
        0x2::dynamic_field::borrow<ReserveKey, BorrowPosition>(&arg0.id, reserve_key(arg1))
    }

    fun borrow_position_mut(arg0: &mut Vault, arg1: u64) : &mut BorrowPosition {
        0x2::dynamic_field::borrow_mut<ReserveKey, BorrowPosition>(&mut arg0.id, reserve_key(arg1))
    }
    ...
    fun calculate_target_borrow(arg0: u64, arg1: u64) : u64 {
        if (arg1 <= 10000) {
            ...
            (((arg0 as u128) * ((arg1 - 10000) as u128) / 10000) as u64)
        }
    }

    public entry fun deposit<T0, T1: drop>(arg0: &mut Vault, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg3: u64, arg4: u64, arg5: &0x2::clock::Clock, arg6: &0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::strategy::Strategies, arg7: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg8: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg9: &mut 0x3::sui_system::SuiSystemState, arg10: &mut 0x2::tx_context::TxContext) {
        0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::refresh_reserve_price<T0>(arg2, arg4, arg5, arg7);
        0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::refresh_reserve_price<T0>(arg2, arg3, arg5, arg7);
        ...
        0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::strategy::allocate_and_execute(arg6, v0, arg10);
        ensure_obligation_cap<T0>(arg0, arg2, arg10);
        ensure_borrow_position(arg0, arg4);
        0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::deposit_to_suilend<T0, T1>(arg2, arg3, arg5, 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::staker::mint_lst_internal<T1>(arg8, arg9, arg1, arg10), borrow_obligation_cap<T0>(arg0), arg10);
        execute_leverage_loop<T0, T1>(arg0, arg2, arg3, arg4, v0, arg8, arg9, arg5, arg10);
        let v2 = VaultEvent{
            kind      : 0,
    ...
    public entry fun emergency_liquidate<T0, T1, T2>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: 0x2::object::ID, arg3: &mut 0x2::coin::Coin<T1>, arg4: u64, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        let (v0, _) = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::liquidate_obligation<T0, T1, T2>(arg1, arg2, arg3, arg4, arg5, arg6, arg7);
        let v2 = v0;
    ...
    fun ensure_borrow_position(arg0: &mut Vault, arg1: u64) {
        let v0 = reserve_key(arg1);
        if (!0x2::dynamic_field::exists_<ReserveKey>(&arg0.id, v0)) {
            let v1 = BorrowPosition{total_borrowed: 0};
            0x2::dynamic_field::add<ReserveKey, BorrowPosition>(&mut arg0.id, v0, v1);
        };
    }

    fun ensure_obligation_cap<T0>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        if (!0x2::dynamic_field::exists_<ObligationKey>(&arg0.id, obligation_key())) {
            0x2::dynamic_field::add<ObligationKey, 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::ObligationOwnerCap<T0>>(&mut arg0.id, obligation_key(), 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::create_obligation_cap<T0>(arg1, arg2));
        };
    }

    fun execute_leverage_loop<T0, T1: drop>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: u64, arg3: u64, arg4: u64, arg5: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg6: &mut 0x3::sui_system::SuiSystemState, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        if (arg4 == 0) {
            return
        };
        let v0 = calculate_target_borrow(arg4, 12000);
        if (v0 == 0) {
            return
        };
        let v1 = 0;
        while (v0 > 0 && v1 < 6) {
            ...
            let v4 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::borrow_from_suilend<T0, 0x2::sui::SUI>(arg1, arg3, borrow_obligation_cap<T0>(arg0), arg7, v3, arg8);
            let v5 = borrow_position_mut(arg0, arg3);
            v5.total_borrowed = v5.total_borrowed + v3;
            0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::deposit_to_suilend<T0, T1>(arg1, arg2, arg7, 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::mint<T1>(arg5, arg6, v4, arg8), borrow_obligation_cap<T0>(arg0), arg8);
            v0 = v0 - v3;
            v1 = v1 + 1;
        };
    }
    ...
    public entry fun harvest_rewards<T0, T1>(arg0: &mut Vault, arg1: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg2: &0x2::clock::Clock, arg3: u64, arg4: u64, arg5: bool, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(0x2::tx_context::sender(arg6) == arg0.admin, 1001);
        ensure_obligation_cap<T0>(arg0, arg1, arg6);
        let v0 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::claim_rewards_from_suilend<T0, T1>(arg1, borrow_obligation_cap<T0>(arg0), arg2, arg3, arg4, arg5, arg6);
    ...
    fun obligation_key() : ObligationKey {
        ObligationKey{dummy_field: false}
    }
    ...
    fun repay_borrow_share(arg0: &mut Vault, arg1: u64, arg2: u64, arg3: u64) : u64 {
        if (arg2 == 0 || arg3 == 0) {
            return 0
        };
        let v0 = borrow_position_mut(arg0, arg1);
    ...
    public entry fun withdraw<T0, T1: drop>(arg0: &mut Vault, arg1: &mut 0x2::coin::Coin<VAULT>, arg2: u64, arg3: &mut 0xf95b06141ed4a174f239417323bde3f209b972f5930d8521ea38a52aff3a6ddf::lending_market::LendingMarket<T0>, arg4: u64, arg5: u64, arg6: &mut 0xb0575765166030556a6eafd3b1b970eba8183ff748860680245b9edd41c716e7::liquid_staking::LiquidStakingInfo<T1>, arg7: &mut 0x3::sui_system::SuiSystemState, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.paused, 0);
        assert!(arg2 > 0 && arg2 <= arg0.total_shares, 1);
        let v0 = (((arg2 as u128) * get_pps(arg0) / 1000000000000) as u64);
        assert!(v0 <= arg0.sui_balance, 2);
        ensure_borrow_position(arg0, arg5);
        let v1 = arg0.total_shares;
        let v2 = repay_borrow_share(arg0, arg5, v1, arg2);
        arg0.sui_balance = arg0.sui_balance - v0;
        arg0.total_shares = arg0.total_shares - arg2;
        0x2::coin::burn<VAULT>(&mut arg0.share_treasury, 0x2::coin::split<VAULT>(arg1, arg2, arg9));
        ensure_obligation_cap<T0>(arg0, arg3, arg9);
        let v3 = 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::staker::redeem_lst_internal<T1>(arg6, arg7, 0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::withdraw_liquidity_from_suilend<T0, T1>(arg3, arg4, arg8, borrow_obligation_cap<T0>(arg0), v0 + v2, arg9), arg9);
        if (v2 > 0) {
            let v4 = 0x2::coin::split<0x2::sui::SUI>(&mut v3, v2, arg9);
            0x4c63d103382b79e62ff4824c663394e31459cc81a282901a80b4fabd879387fa::suilend_adapter::repay_borrow<T0, 0x2::sui::SUI>(arg3, arg5, borrow_obligation_cap<T0>(arg0), arg8, &mut v4, arg9);
