module 0x9eea9fa6f1730073268edb3b6b8d5b4795026721d7015e306fde47a610b59d66::rand {
    ...
    public fun rng_with_clock_and_counter<T0>(arg0: &T0, arg1: u64, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x9eea9fa6f1730073268edb3b6b8d5b4795026721d7015e306fde47a610b59d66::counter::Counter<T0>, arg5: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg2 > arg1, 0);
        from_seed(seed_with_clock_and_counter<T0>(arg0, arg3, arg4, arg5)) % (arg2 - arg1) + arg1
    }

    public fun rng_with_counter<T0>(arg0: &T0, arg1: u64, arg2: u64, arg3: &mut 0x9eea9fa6f1730073268edb3b6b8d5b4795026721d7015e306fde47a610b59d66::counter::Counter<T0>, arg4: &mut 0x2::tx_context::TxContext) : u64 {
        assert!(arg2 > arg1, 0);
    ...
    public fun seed_with_clock_and_counter<T0>(arg0: &T0, arg1: &0x2::clock::Clock, arg2: &mut 0x9eea9fa6f1730073268edb3b6b8d5b4795026721d7015e306fde47a610b59d66::counter::Counter<T0>, arg3: &mut 0x2::tx_context::TxContext) : vector<u8> {
        let v0 = raw_seed(arg3);
        let v1 = 0x2::clock::timestamp_ms(arg1);
        let v2 = 0x9eea9fa6f1730073268edb3b6b8d5b4795026721d7015e306fde47a610b59d66::counter::increment<T0>(arg2, arg0);
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u64>(&v1));
        0x1::vector::append<u8>(&mut v0, 0x2::bcs::to_bytes<u256>(&v2));
        0x1::hash::sha3_256(v0)
    }

    public fun seed_with_counter<T0>(arg0: &T0, arg1: &mut 0x9eea9fa6f1730073268edb3b6b8d5b4795026721d7015e306fde47a610b59d66::counter::Counter<T0>, arg2: &mut 0x2::tx_context::TxContext) : vector<u8> {
        let v0 = raw_seed(arg2);
        let v1 = 0x9eea9fa6f1730073268edb3b6b8d5b4795026721d7015e306fde47a610b59d66::counter::increment<T0>(arg1, arg0);
