module 0x4c5bc72c4385d6d7cdf896aab0b55e80e7c3cb7d0010af0dcb4f35a1bd3b773f::stonker {
    ...
    fun default_stonker_parameters() : StonkerParameters {
        ...
        StonkerParameters{
            ...
            maker_max_shallow_quantity_base  : 1 * v0 / 10,
            maker_max_deep_quantity_base     : 2 * v0 / 10,
            maker_trades_enabled             : true,
            maker_deep_trades_enabled        : false,
            single_base                      : v0,
            position_limit_quote             : 15000 * 1000000,
            minimum_order_size_base          : v0 / 10,
            order_size_step_base             : v0 / 10,
            allowed_to_buy                   : true,
