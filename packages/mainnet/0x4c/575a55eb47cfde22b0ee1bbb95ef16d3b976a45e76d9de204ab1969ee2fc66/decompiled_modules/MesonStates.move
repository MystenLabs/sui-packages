module 0x371a30d40fcc357a37d412c4750a57303d58c9482e5f51886e46f7bf774028f3::MesonStates {
    ...
    public fun addSupportToken<T0>(arg0: &AdminCap, arg1: u8, arg2: &mut GeneralStore, arg3: &mut 0x2::tx_context::TxContext) {
        match_package_version(arg2);
        ...
        0x2::table::add<u8, 0x1::type_name::TypeName>(v0, arg1, 0x1::type_name::with_defining_ids<T0>());
    ...
    public(friend) fun coins_from_pending<T0>(arg0: vector<u8>, arg1: &mut GeneralStore) : 0x2::coin::Coin<T0> {
        0x2::table::remove<vector<u8>, 0x2::coin::Coin<T0>>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<vector<u8>, 0x2::coin::Coin<T0>>>(&mut arg1.pending_coins, 0x1::type_name::with_defining_ids<T0>()), arg0)
    }
    ...
    public(friend) fun coins_from_pool<T0>(arg0: u64, arg1: u64, arg2: &mut GeneralStore, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2::coin::split<T0>(0x2::table::borrow_mut<u64, 0x2::coin::Coin<T0>>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<u64, 0x2::coin::Coin<T0>>>(&mut arg2.in_pool_coins, 0x1::type_name::with_defining_ids<T0>()), arg0), arg1 * 0x371a30d40fcc357a37d412c4750a57303d58c9482e5f51886e46f7bf774028f3::MesonHelpers::amount_factor(index_of_coin<T0>(arg2)), arg3)
    }

    public(friend) fun coins_to_pending<T0>(arg0: vector<u8>, arg1: 0x2::coin::Coin<T0>, arg2: &mut GeneralStore) {
        0x2::table::add<vector<u8>, 0x2::coin::Coin<T0>>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<vector<u8>, 0x2::coin::Coin<T0>>>(&mut arg2.pending_coins, 0x1::type_name::with_defining_ids<T0>()), arg0, arg1);
    }

    public(friend) fun coins_to_pool<T0>(arg0: u64, arg1: 0x2::coin::Coin<T0>, arg2: &mut GeneralStore) {
        let v0 = 0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<u64, 0x2::coin::Coin<T0>>>(&mut arg2.in_pool_coins, 0x1::type_name::with_defining_ids<T0>());
    ...
    public(friend) fun index_of_coin<T0>(arg0: &GeneralStore) : u8 {
        let v0 = 0;
        let v1 = false;
        while (v0 < 255) {
            let v2 = v0 + 1;
            v0 = v2;
            if (0x2::table::contains<u8, 0x1::type_name::TypeName>(&arg0.supported_coins, v2)) {
                if (0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()) == 0x1::type_name::into_string(*0x2::table::borrow<u8, 0x1::type_name::TypeName>(&arg0.supported_coins, v2))) {
                    v1 = true;
                    break
                };
            };
    ...
    public(friend) fun match_coin_type<T0>(arg0: u8, arg1: &GeneralStore) {
        assert!(0x1::type_name::into_string(0x1::type_name::with_defining_ids<T0>()) == 0x1::type_name::into_string(coin_type_for_index(arg0, arg1)), 38);
    }

    public(friend) fun match_package_version(arg0: &GeneralStore) {
        assert!(arg0.package_version == 5, 2);
    }

    public(friend) fun merge_coins_and_split<T0>(arg0: vector<0x2::coin::Coin<T0>>, arg1: u64, arg2: &GeneralStore, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(0x1::vector::length<0x2::coin::Coin<T0>>(&arg0) > 0, 24);
        ...
        0x2::coin::split<T0>(&mut v0, arg1 * 0x371a30d40fcc357a37d412c4750a57303d58c9482e5f51886e46f7bf774028f3::MesonHelpers::amount_factor(index_of_coin<T0>(arg2)), arg3)
    }

    public fun migrate(arg0: &AdminCap, arg1: &mut GeneralStore) {
        assert!(arg1.package_version < 5, 1);
        arg1.package_version = 5;
    }
    ...
    public(friend) fun release_locked_swap(arg0: vector<u8>, arg1: &mut GeneralStore) : address {
        let v0 = 0x2::table::borrow_mut<vector<u8>, LockedSwap>(&mut arg1.locked_swaps, arg0);
        assert!(v0.until != 0, 36);
        v0.until = 0;
        v0.recipient
    }
    ...
    public(friend) fun remove_locked_swap(arg0: vector<u8>, arg1: &mut GeneralStore) : (u64, u64) {
        let LockedSwap {
            pool_index : v0,
            until      : v1,
            recipient  : _,
        } = 0x2::table::remove<vector<u8>, LockedSwap>(&mut arg1.locked_swaps, arg0);
        assert!(v1 != 0, 36);
        (v0, v1)
    }
    ...
    public(friend) fun remove_posted_swap(arg0: vector<u8>, arg1: &0x2::clock::Clock, arg2: &mut GeneralStore) : (u64, vector<u8>, address) {
        ...
        if (0x371a30d40fcc357a37d412c4750a57303d58c9482e5f51886e46f7bf774028f3::MesonHelpers::expire_ts_from(arg0) < 0x2::clock::timestamp_ms(arg1) / 1000 + 0x371a30d40fcc357a37d412c4750a57303d58c9482e5f51886e46f7bf774028f3::MesonHelpers::get_MIN_BOND_TIME_PERIOD()) {
            let PostedSwap {
                pool_index   : v4,
                initiator    : v5,
                from_address : v6,
    ...
    public fun transferPremiumManager(arg0: address, arg1: &mut GeneralStore, arg2: &mut 0x2::tx_context::TxContext) {
        match_package_version(arg1);
