module 0x4cb43a298a78ab64a3181305e45cef6b4ecadf35e85c92496aa1590c11af5c70::nft {
    ...
    public entry fun mint_and_distribute_multiple(arg0: &mut AdminCap, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: 0x1::string::String, arg4: 0x1::string::String, arg5: vector<address>, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(arg0.creator == v0 || 0x2::vec_set::contains<address>(&arg0.admins, &v0), 403);
