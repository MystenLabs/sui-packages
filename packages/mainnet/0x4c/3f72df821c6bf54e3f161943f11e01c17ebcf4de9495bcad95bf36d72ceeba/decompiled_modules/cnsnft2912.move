module 0x4c3f72df821c6bf54e3f161943f11e01c17ebcf4de9495bcad95bf36d72ceeba::cnsnft2912 {
    struct CNSNFT2912 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT2912, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT2912>(arg0, arg1);
