module 0x4c60fb6555b0cc31a70827524f286b2b545d8bdafb1b05f4aa510d52602773ee::cnsnft1905 {
    struct CNSNFT1905 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1905, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=1502"));
        let v4 = 0x2::package::claim<CNSNFT1905>(arg0, arg1);
