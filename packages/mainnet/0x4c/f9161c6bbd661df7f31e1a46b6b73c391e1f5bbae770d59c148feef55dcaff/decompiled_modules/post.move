module 0xf45f752bc45dadff2ebc867c69af682c7192686d2455f655e2c54c9c75e95cff::post {
    ...
    public(friend) fun like_post(arg0: &mut Post, arg1: 0x2::object::ID) {
        0x2::vec_set::insert<0x2::object::ID>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, liked_set_key()), arg1);
    ...
    public(friend) fun unlike_post(arg0: &mut Post, arg1: 0x2::object::ID) {
        0x2::vec_set::remove<0x2::object::ID>(0x2::dynamic_field::borrow_mut<0x1::string::String, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.id, liked_set_key()), &arg1);
        arg0.like_count = arg0.like_count - 1;
    }
