module 0x4c81f32e70633a7e4c485892022ea9b403791fab5a1310411b60e2afb685b64f::REWARDS {
    struct UserClaimInfoKey has copy, drop, store {
        address: address,
    }
    ...
    struct UserClaimInfo has store, key {
        id: 0x2::object::UID,
        pool_id: 0x2::object::ID,
        user: address,
        last_claim: u64,
    ...
    struct ClaimInfoCreated has copy, drop {
    ...
    public entry fun burn_and_claim<T0>(arg0: &mut BurnPool<T0>, arg1: 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::NFT, arg2: &mut 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::CollectionCap, arg3: 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance, arg4: &mut 0x2::tx_context::TxContext) {
        ...
        let v0 = NFTBurned{
            ...
            nft_id        : 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::get_nft_id(&arg1),
            collection_id : 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::get_nft_collection_id(&arg1),
        };
        ...
        let v2 = 0x1::vector::empty<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>();
        0x1::vector::push_back<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>(&mut v2, arg3);
        0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::burn_art20(arg1, arg2, v2, arg4);
    }
    ...
    public fun get_time_to_next_claim(arg0: &UserClaimInfo, arg1: &0x2::clock::Clock) : u64 {
        let v0 = 0x2::clock::timestamp_ms(arg1);
        if (v0 >= arg0.next_claim) {
            0
        } else {
            arg0.next_claim - v0
        }
    ...
    public entry fun timed_burn_and_claim<T0>(arg0: &mut TimedBurnPool<T0>, arg1: 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::NFT, arg2: &mut 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::CollectionCap, arg3: 0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.is_active, 4);
        let v0 = 0x2::tx_context::sender(arg5);
        let v1 = 0x2::clock::timestamp_ms(arg4);
        let v2 = 0x2::object::uid_to_inner(&arg0.id);
        let v3 = UserClaimInfoKey{address: v0};
        if (!0x2::dynamic_field::exists_<UserClaimInfoKey>(&arg0.id, v3)) {
            let v4 = UserClaimInfo{
                id         : 0x2::object::new(arg5),
                pool_id    : v2,
                user       : v0,
                last_claim : v1,
                next_claim : v1 + arg0.claim_delay,
            };
            let v5 = ClaimInfoCreated{
                info_id    : 0x2::object::uid_to_inner(&v4.id),
                pool_id    : v2,
                user       : v0,
                next_claim : v1 + arg0.claim_delay,
            };
            0x2::event::emit<ClaimInfoCreated>(v5);
            0x2::dynamic_field::add<UserClaimInfoKey, UserClaimInfo>(&mut arg0.id, v3, v4);
        } else {
            let v6 = 0x2::dynamic_field::borrow_mut<UserClaimInfoKey, UserClaimInfo>(&mut arg0.id, v3);
            assert!(v6.user == v0, 1);
            assert!(v1 >= v6.next_claim, 11);
            v6.last_claim = v1;
            v6.next_claim = v1 + arg0.claim_delay;
        };
        assert!(0x2::balance::value<T0>(&arg0.reward_balance) >= arg0.reward_per_burn, 5);
        arg0.total_burns = safe_add(arg0.total_burns, 1);
        arg0.total_rewards_distributed = safe_add(arg0.total_rewards_distributed, arg0.reward_per_burn);
        ...
        let v8 = RewardClaimed<T0>{
            burner  : v0,
            amount  : arg0.reward_per_burn,
            pool_id : v2,
        };
        0x2::event::emit<RewardClaimed<T0>>(v8);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(0x2::balance::split<T0>(&mut arg0.reward_balance, arg0.reward_per_burn), arg5), v0);
        let v9 = 0x1::vector::empty<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>();
        0x1::vector::push_back<0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::UserBalance>(&mut v9, arg3);
        0xffec77bdbb001fb7d9770bfdee1d3d1e5f48598d77c6ba793d8452e166ccb0d4::ART20::burn_art20(arg1, arg2, v9, arg5);
    }
