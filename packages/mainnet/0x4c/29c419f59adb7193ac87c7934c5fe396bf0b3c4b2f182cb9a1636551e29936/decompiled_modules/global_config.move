module 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::global_config {
    ...
    struct GlobalConfig has key {
        id: 0x2::object::UID,
        acl: 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::ACL,
        paused: bool,
    }
    ...
    public fun get_permission(arg0: &GlobalConfig, arg1: address) : u128 {
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::get_permission(&arg0.acl, arg1)
    }

    public fun has_role(arg0: &GlobalConfig, arg1: address, arg2: u8) : bool {
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::has_role(&arg0.acl, arg1, arg2)
    }

    public fun remove_member(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::remove_member(&mut arg0.acl, arg2);
    ...
    public fun set_roles(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address, arg3: u128) {
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::set_roles(&mut arg0.acl, arg2, arg3);
        let v0 = MemberRolesUpdatedEvent{
            member    : arg2,
            old_roles : 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::get_permission(&arg0.acl, arg2),
            new_roles : arg3,
        };
    ...
    public fun add_keeper(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::add_role(&mut arg0.acl, arg2, 0);
        let v0 = MemberRolesUpdatedEvent{
            member    : arg2,
            old_roles : 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::get_permission(&arg0.acl, arg2),
            new_roles : 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::get_permission(&arg0.acl, arg2),
        };
        0x2::event::emit<MemberRolesUpdatedEvent>(v0);
    }

    public fun assert_keeper(arg0: &GlobalConfig, arg1: &0x2::tx_context::TxContext) {
        assert!(0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::has_role(&arg0.acl, 0x2::tx_context::sender(arg1), 0), 13906834891602919425);
    }
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = GlobalConfig{
            ...
            acl    : 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::new(arg0),
            paused : false,
        };
        let v2 = InitEvent{
    ...
    public fun is_keeper(arg0: &GlobalConfig, arg1: address) : bool {
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::has_role(&arg0.acl, arg1, 0)
    }
    ...
    public fun remove_keeper(arg0: &mut GlobalConfig, arg1: &AdminCap, arg2: address) {
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::remove_role(&mut arg0.acl, arg2, 0);
        let v0 = MemberRolesUpdatedEvent{
            member    : arg2,
            old_roles : 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::get_permission(&arg0.acl, arg2),
            new_roles : 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::acl::get_permission(&arg0.acl, arg2),
