module 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::order {
    ...
    struct FeeParamsUpdatedEvent has copy, drop {
        ...
        old_fee_cap_usd_1e6: u64,
        new_fee_cap_usd_1e6: u64,
        updater: address,
    }
    ...
    public(friend) fun add_tpsl_level(arg0: &mut Order, arg1: u8, arg2: u128, arg3: u64, arg4: u64, arg5: bool) : u64 {
        let v0 = arg0.next_level_id;
        assert!(v0 < 18446744073709551615, 13906838529441660951);
        let v1 = (v0 as u64);
    ...
    public fun assert_initialized<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>) {
        assert!(arg0.base_decimals != 0 && arg0.quote_decimals != 0, 13906836613886902305);
    }

    public(friend) fun assert_market_matches(arg0: &Order, arg1: 0x2::object::ID) {
        assert!(arg0.market_id == arg1, 13906839070606491655);
    }
    ...
    fun assert_metadata_type_matches<T0, T1, T2>(arg0: bool) {
        ...
        assert!(0x1::type_name::with_defining_ids<T2>() == v0, 13906836433498800169);
    }

    public(friend) fun assert_order_book_matches<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>, arg1: &Order) {
        assert!(arg1.order_book_id == 0x2::object::id<OrderBook<T0, T1, T2>>(arg0), 13906839049131524101);
        assert!(arg1.market_id == arg0.market_id, 13906839053426491397);
    }

    public(friend) fun assert_order_cap_matches(arg0: &Order, arg1: &OrderCap) {
        assert!(arg1.order_id == 0x2::object::uid_to_inner(&arg0.id), 13906839027656556547);
        assert!(arg1.position_id == arg0.position_id, 13906839031951523843);
    }

    public(friend) fun assert_receipt_matches_order(arg0: &Order, arg1: &ExecuteReceipt) {
        assert!(arg1.order_id == 0x2::object::uid_to_inner(&arg0.id), 13906839087786491913);
        assert!(arg1.position_id == arg0.position_id, 13906839092081459209);
    }
    ...
    public(friend) fun borrow_position_cap(arg0: &Order) : &0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        assert!(0x1::option::is_some<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&arg0.position_cap), 13906837399865786399);
    ...
    public(friend) fun cancel<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(arg1.status == 0, 13906837885196042255);
        let (v3, v4, v5, _) = destroy_order(arg1);
        assert!(v1 == v3, 13906837893785190403);
    ...
    public(friend) fun claim_orphan<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(0x2::dynamic_field::exists_<OrphanDfKey>(&arg0.id, v3), 13906838220203360269);
    ...
    public(friend) fun cleanup_and_claim_orphan<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        ...
        assert!(v1 == v4, 13906838168663097347);
        v3
    }
    ...
    public(friend) fun close<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order, arg2: OrderCap) {
        ...
        0x2::object::delete(v0);
        assert!(arg1.status == 2, 13906837979685453841);
        let (v3, v4, v5, _) = destroy_order(arg1);
        assert!(v1 == v3, 13906837988274470915);
    ...
    public fun create_order_book<T0, T1, T2>(arg0: &0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::global_config::AdminCap, arg1: &mut 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::order_book_registry::OrderBookRegistry, arg2: &0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::market::Market, arg3: u64, arg4: u64, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::market::market_id(arg2);
        let v1 = new_order_book<T0, T1, T2>(v0, arg3, arg4, arg5, arg6);
        let v2 = 0x2::object::id<OrderBook<T0, T1, T2>>(&v1);
        0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::order_book_registry::register(arg1, v0, v2);
        let v3 = OrderBookCreatedEvent{
            order_book_id : v2,
            market_id     : v0,
        };
        0x2::event::emit<OrderBookCreatedEvent>(v3);
        0x2::transfer::share_object<OrderBook<T0, T1, T2>>(v1);
    }
    ...
    fun destroy_order(arg0: Order) : (0x2::object::ID, 0x2::object::ID, 0x1::option::Option<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>, u8) {
        ...
        let v15 = v9;
        let v16 = v0;
        assert!(0x2::bag::is_empty(&v15), 13906837051972648979);
    ...
    public(friend) fun emit_tpsl_level_added(arg0: 0x2::object::ID, arg1: u64, arg2: u8, arg3: u128, arg4: u64, arg5: u64, arg6: bool) {
    ...
    public(friend) fun emit_tpsl_level_updated(arg0: 0x2::object::ID, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool) {
    ...
    public fun fee_cap_usd_1e6<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>) : u64 {
        arg0.fee_cap_usd_1e6
    }
    ...
    public fun harvest_fees<T0, T1, T2, T3>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::global_config::AdminCap, arg2: &mut 0x2::tx_context::TxContext) {
    ...
    public fun init_decimals_via_coin_metadata<T0, T1, T2, T3>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0x2::coin::CoinMetadata<T3>, arg2: bool) {
        assert_metadata_type_matches<T1, T2, T3>(arg2);
        if (arg2) {
            set_base_decimals<T0, T1, T2>(arg0, 0x2::coin::get_decimals<T3>(arg1), b"coin_metadata");
        } else {
            set_quote_decimals<T0, T1, T2>(arg0, 0x2::coin::get_decimals<T3>(arg1), b"coin_metadata");
        };
    }

    public fun init_decimals_via_currency<T0, T1, T2, T3>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0x2::coin_registry::Currency<T3>, arg2: bool) {
        assert_metadata_type_matches<T1, T2, T3>(arg2);
        if (arg2) {
            set_base_decimals<T0, T1, T2>(arg0, 0x2::coin_registry::decimals<T3>(arg1), b"currency");
        } else {
            set_quote_decimals<T0, T1, T2>(arg0, 0x2::coin_registry::decimals<T3>(arg1), b"currency");
        };
    }
    ...
    public fun level_slippage_bps(arg0: &TpslLevel) : u64 {
        arg0.slippage_bps
    }

    public(friend) fun make_tpsl_level(arg0: u64, arg1: u128, arg2: u64, arg3: u64, arg4: bool) : TpslLevel {
        TpslLevel{
            id              : arg0,
            trigger_price   : arg1,
            slippage_bps    : arg2,
    ...
    public(friend) fun new_order<T0, T1, T2>(arg0: &OrderBook<T0, T1, T2>, arg1: 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap, arg2: 0x2::object::ID, arg3: bool, arg4: u128, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : (Order, OrderCap) {
        ...
        assert!(!0x2::table::contains<0x2::object::ID, 0x2::object::ID>(&arg0.order_index, v0), 13906837163640619009);
        let v1 = Order{
    ...
    fun new_order_book<T0, T1, T2>(arg0: 0x2::object::ID, arg1: u64, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : OrderBook<T0, T1, T2> {
        assert!(arg1 <= 10000, 13906835982524612607);
        OrderBook<T0, T1, T2>{
    ...
    public(friend) fun park_cap_post_completion(arg0: &mut Order, arg1: 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap) {
        assert!(arg0.status == 2, 13906837610318266385);
        assert!(0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::position_cap_position_id(&arg1) == arg0.position_id, 13906837623203692569);
        assert!(0x1::option::is_none<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&arg0.position_cap), 13906837631793758235);
    ...
    public fun pause<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::global_config::AdminCap) {
    ...
    public(friend) fun remove_settlement<T0>(arg0: &mut Order) : 0x2::balance::Balance<T0> {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        assert!(0x2::bag::contains<0x1::type_name::TypeName>(&arg0.settlements, v0), 13906837820771270667);
    ...
    public(friend) fun remove_triggered_level(arg0: &mut Order, arg1: u8, arg2: u64) {
        ...
        abort 13906838881628848149
    }

    public fun resume<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::global_config::AdminCap) {
        arg0.is_active = true;
        let v0 = OrderBookPausedEvent{
            order_book_id : 0x2::object::id<OrderBook<T0, T1, T2>>(arg0),
            is_active     : true,
    ...
    public(friend) fun return_position_cap(arg0: &mut Order, arg1: 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap, arg2: u64) {
        assert!(0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::position_cap_position_id(&arg1) == arg0.position_id, 13906837498649640985);
        0x1::option::fill<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&mut arg0.position_cap, arg1);
        arg0.status = 0;
    ...
    fun set_base_decimals<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: u8, arg2: vector<u8>) {
        assert!(arg0.base_decimals == 0, 13906836467858145315);
        assert!(arg1 != 0, 13906836472153374759);
    ...
    fun set_quote_decimals<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: u8, arg2: vector<u8>) {
        assert!(arg0.quote_decimals == 0, 13906836536577753125);
        assert!(arg1 != 0, 13906836540872851495);
    ...
    public(friend) fun share_order<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: Order) {
        assert!(arg1.order_book_id == 0x2::object::id<OrderBook<T0, T1, T2>>(arg0), 13906837348324474885);
    ...
    public(friend) fun take_parked_cap(arg0: &mut Order) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        assert!(arg0.status == 2, 13906837683332710417);
        assert!(0x1::option::is_some<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&arg0.position_cap), 13906837687628464157);
    ...
    public(friend) fun take_position_cap(arg0: &mut Order) : 0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap {
        assert!(arg0.status == 0, 13906837425634541583);
        arg0.status = 1;
        0x1::option::extract<0x51bfedf86b5e18076f844bf0e1f82b14667bce59e2c38a8b5c8752ba3314bbd3::position::PositionCap>(&mut arg0.position_cap)
    }
    ...
    public fun update_fee_params<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::global_config::AdminCap, arg2: u64, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        assert!(arg2 <= 10000, 13906836777093562367);
        arg0.fee_rate_bps = arg2;
        arg0.fee_cap_usd_1e6 = arg3;
        let v0 = FeeParamsUpdatedEvent{
            order_book_id       : 0x2::object::id<OrderBook<T0, T1, T2>>(arg0),
            old_fee_rate_bps    : arg0.fee_rate_bps,
            new_fee_rate_bps    : arg2,
            old_fee_cap_usd_1e6 : arg0.fee_cap_usd_1e6,
            new_fee_cap_usd_1e6 : arg3,
            updater             : 0x2::tx_context::sender(arg4),
        };
        0x2::event::emit<FeeParamsUpdatedEvent>(v0);
    }

    public fun update_params<T0, T1, T2>(arg0: &mut OrderBook<T0, T1, T2>, arg1: &0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::global_config::AdminCap, arg2: u64) {
        arg0.max_price_age_seconds = arg2;
    }

    public(friend) fun update_tpsl_level_by_id(arg0: &mut Order, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<TpslLevel>(&arg0.tp_levels)) {
            if (0x1::vector::borrow<TpslLevel>(&arg0.tp_levels, v0).id == arg1) {
                0x1::vector::borrow_mut<TpslLevel>(&mut arg0.tp_levels, v0).trigger_price = arg2;
                0x1::vector::borrow_mut<TpslLevel>(&mut arg0.tp_levels, v0).slippage_bps = arg3;
        ...
        while (v0 < 0x1::vector::length<TpslLevel>(&arg0.sl_levels)) {
            if (0x1::vector::borrow<TpslLevel>(&arg0.sl_levels, v0).id == arg1) {
                ...
                0x1::vector::borrow_mut<TpslLevel>(&mut arg0.sl_levels, v0).slippage_bps = arg3;
