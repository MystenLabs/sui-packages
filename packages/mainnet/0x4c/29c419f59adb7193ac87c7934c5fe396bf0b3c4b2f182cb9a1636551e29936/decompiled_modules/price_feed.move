module 0x4c29c419f59adb7193ac87c7934c5fe396bf0b3c4b2f182cb9a1636551e29936::price_feed {
    ...
    public fun extract_single_usd_price_1e18(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x2::clock::Clock, arg2: u64) : u128 {
        let (v0, v1, v2) = get_feed_price(arg0, arg1, arg2);
        let (v3, v4) = signed_add(v1, v2, false, 18);
        if (!v3) {
            v0 * pow10(v4)
        } else {
            v0 / pow10(v4)
    ...
    public fun get_feed_price(arg0: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg1: &0x2::clock::Clock, arg2: u64) : (u128, bool, u64) {
        ...
        assert!(!0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_is_negative(&v1), 13906834414861549569);
        let v2 = 0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::i64::get_magnitude_if_positive(&v1);
        assert!(v2 > 0, 13906834423451615235);
    ...
    fun pow10(arg0: u64) : u128 {
        assert!(arg0 <= 38, 13906835020452200453);
        let v0 = 1;
        let v1 = 0;
        while (v1 < arg0) {
            v0 = v0 * 10;
