module 0x4c74a5004e11670829c660ebb3a9b51ed9d1ba5d87225e069458003a836e4159::gift9865 {
    struct GIFT9865 has drop {
        dummy_field: bool,
    }

    struct TICKET_9865 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift9865(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9865>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9865>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT9865, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT9865>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9865>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9865>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9865>>(v5, 0x2::tx_context::sender(arg1));
    }
