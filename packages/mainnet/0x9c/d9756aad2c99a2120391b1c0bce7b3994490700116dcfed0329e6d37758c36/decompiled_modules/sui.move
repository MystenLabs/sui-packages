module 0x9cd9756aad2c99a2120391b1c0bce7b3994490700116dcfed0329e6d37758c36::sui {
    struct SUI has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: SUI, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = v0;
        0x2::coin::mint_and_transfer<SUI>(&mut v2, 3000000 * 0x1::u64::pow(10, 9), 0x2::tx_context::sender(arg1), arg1);
