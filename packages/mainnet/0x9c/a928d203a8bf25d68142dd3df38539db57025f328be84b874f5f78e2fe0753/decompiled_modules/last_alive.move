module 0x9ca928d203a8bf25d68142dd3df38539db57025f328be84b874f5f78e2fe0753::last_alive {
    ...
    public entry fun add_token_reward_v2<T0: store + key>(arg0: &GameState, arg1: &mut RewardsPool, arg2: 0x2::coin::Coin<T0>, arg3: vector<u8>, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::tx_context::sender(arg4) == arg0.owner, 4);
        let v0 = arg0.current_round;
        let v1 = TokenStoreId{
        ...
        let v3 = RewardAddedEvent{
            round       : v0,
            reward_type : 0x1::string::utf8(arg3),
