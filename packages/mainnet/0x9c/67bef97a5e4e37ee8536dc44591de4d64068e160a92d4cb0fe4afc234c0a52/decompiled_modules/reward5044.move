module 0x9c67bef97a5e4e37ee8536dc44591de4d64068e160a92d4cb0fe4afc234c0a52::reward5044 {
    struct REWARD5044 has drop {
        dummy_field: bool,
    }

    struct TICKET_5044 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5044(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5044>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5044>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5044, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5044>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5044>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5044>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5044>>(v5, 0x2::tx_context::sender(arg1));
    }
