module 0x9c7ffbdc9d16e263db342a8c5c02d9347aa7fadcae3ed7eb38e1d61099447f79::reward2190 {
    struct REWARD2190 has drop {
        dummy_field: bool,
    }

    struct TICKET_2190 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward2190(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_2190>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_2190>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD2190, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD2190>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_2190>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_2190>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_2190>>(v5, 0x2::tx_context::sender(arg1));
    }
