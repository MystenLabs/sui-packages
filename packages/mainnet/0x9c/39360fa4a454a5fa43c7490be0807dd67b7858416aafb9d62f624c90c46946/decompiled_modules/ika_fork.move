module 0x9c39360fa4a454a5fa43c7490be0807dd67b7858416aafb9d62f624c90c46946::ika_fork {
    ...
    fun init(arg0: IKA_FORK, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<IKA_FORK>>(0x2::coin::mint<IKA_FORK>(&mut v2, 1000000000, arg1), 0x2::tx_context::sender(arg1));
