module 0x9cea3799fdcadb8d96559d218a58b481f2cf42eae10acbb5e11f871744b8f16a::cnsnft5431 {
    struct CNSNFT5431 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT5431, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT5431>(arg0, arg1);
