module 0x9ce6834f83a0a37a7376c0da9c2e7ac6f27ab77ea47f47cb9eaa26492f067e11::retard {
    ...
    fun init(arg0: RETARD, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<RETARD>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"retard    ")))), trim_right(b"retardcoin                      "), trim_right(b"                                                                                                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
        let v6 = &mut v5;
