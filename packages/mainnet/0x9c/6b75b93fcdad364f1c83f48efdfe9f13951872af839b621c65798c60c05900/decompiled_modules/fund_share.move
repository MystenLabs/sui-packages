module 0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::fund_share {
    ...
    public(friend) fun burn<T0>(arg0: &0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::config::GlobalConfig, arg1: BurnRequest<T0>, arg2: FundShare) {
    ...
    public(friend) fun create_burn_request<T0>(arg0: &0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::config::GlobalConfig, arg1: 0x2::object::ID) : BurnRequest<T0> {
        0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::config::assert_if_version_not_matched(arg0, 1);
        BurnRequest<T0>{fund_id: arg1}
    }

    public(friend) fun create_mint_request<T0>(arg0: &0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::config::GlobalConfig, arg1: 0x2::object::ID, arg2: bool, arg3: address, arg4: 0x1::string::String, arg5: u64, arg6: address, arg7: address) : MintRequest<T0> {
        0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::config::assert_if_version_not_matched(arg0, 1);
        MintRequest<T0>{
            fund_id         : arg1,
            is_init         : arg2,
    ...
    public fun mint<T0>(arg0: &mut 0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::config::GlobalConfig, arg1: MintRequest<T0>, arg2: &mut 0x2::tx_context::TxContext) : FundShare {
        0xcd6a6152b61f25e24d97d6b77d2eeab7b1850c4a7e9a588064888c7a7bed2ed::config::assert_if_version_not_matched(arg0, 1);
        let MintRequest {
            fund_id         : v0,
            is_init         : v1,
