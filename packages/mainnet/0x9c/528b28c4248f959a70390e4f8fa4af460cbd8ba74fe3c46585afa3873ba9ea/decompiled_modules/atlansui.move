module 0x1f087b0343dccd6f8353cf448ae9b7885e54ee34e2d0cf398b386b9cfa808a97::atlansui {
    ...
    struct CreateOfferWithScallopEvent<phantom T0: store + key> has copy, drop {
        id: 0x2::object::ID,
        key: u64,
        collection: 0x1::ascii::String,
        creator: address,
    ...
    struct ScallopDepositEvent<phantom T0: store + key> has copy, drop {
        id: 0x2::object::ID,
        key: u64,
        collection: 0x1::ascii::String,
        creator: address,
    ...
    public fun accept_offer_with_kiosk<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: &0x2::kiosk::KioskOwnerCap, arg6: 0x2::object::ID, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(!0x2::dynamic_object_field::exists_with_type<ScallopKey<T0>, Scallop<T0>>(&v9.id, v10), 7);
    ...
    public fun accept_offer_with_kiosk_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: address, arg5: u64, arg6: &mut 0x2::kiosk::Kiosk, arg7: &0x2::kiosk::KioskOwnerCap, arg8: 0x2::object::ID, arg9: &0x2::clock::Clock, arg10: &mut 0x2::tx_context::TxContext) {
        ...
        let v15 = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg2, arg3, 0x2::coin::from_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v14, arg10), arg9, arg10);
        if (0x2::coin::value<T0>(&v15) > v9.value) {
            let v16 = 0x2::coin::into_balance<T0>(v15);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v16, v9.value, arg10), v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v16, arg10), v9.creator);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v15, v0);
        };
        0x2::object::delete(v12);
        let v17 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : arg8,
            creator            : v9.creator,
            borrower           : v0,
        ...
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v17);
    }
    ...
    public fun accept_offer_with_nft<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: T1, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        let v14 = v11;
        let v15 = &mut v14;
        install(v15, &v13, arg6);
        let v16 = 0x2::object::id<T1>(&arg4);
        let v17 = Rentable<T1>{
            object     : arg4,
        ...
        let v18 = &mut v14;
        let v19 = Rented{id: v16};
        place_in_bag<T1, Rented>(v18, v19, v17);
        0x2::transfer::public_transfer<0x2::kiosk::KioskOwnerCap>(v13, v0);
        0x2::transfer::public_share_object<0x2::kiosk::Kiosk>(v14);
        v9.start_time = v1;
        v9.is_started = true;
        0x1::option::fill<address>(&mut v9.borrower, v0);
        0x1::option::fill<0x2::object::ID>(&mut v9.item_id, v16);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v2.balance, v9.value, arg6), v0);
        let v20 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : v16,
            creator            : v9.creator,
            borrower           : v0,
            borrower_kiosk     : 0x2::object::id<0x2::kiosk::Kiosk>(&v14),
            borrower_kiosk_cap : 0x2::object::id<0x2::kiosk::KioskOwnerCap>(&v13),
            value              : v9.value,
            time               : v1,
        };
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v20);
    }
    ...
    public fun accept_offer_with_nft_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: address, arg5: u64, arg6: T1, arg7: &0x2::clock::Clock, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        let v24 = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg2, arg3, 0x2::coin::from_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v23, arg8), arg7, arg8);
        if (0x2::coin::value<T0>(&v24) > v9.value) {
            let v25 = 0x2::coin::into_balance<T0>(v24);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v25, v9.value, arg8), v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v25, arg8), v9.creator);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v24, v0);
        };
        0x2::object::delete(v21);
        let v26 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : v15,
            creator            : v9.creator,
            borrower           : v0,
        ...
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v26);
    }
    ...
    public fun accept_offer_with_originbyte_kiosk<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: address, arg3: u64, arg4: &mut 0x2::kiosk::Kiosk, arg5: 0x2::object::ID, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v10 = ScallopKey<T0>{dummy_field: false};
        assert!(!0x2::dynamic_object_field::exists_with_type<ScallopKey<T0>, Scallop<T0>>(&v9.id, v10), 7);
        let v11 = 0x2::object::id<0x2::kiosk::Kiosk>(arg4);
        ...
        let v12 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : arg5,
            creator            : v9.creator,
            borrower           : v0,
            borrower_kiosk     : v11,
            borrower_kiosk_cap : v11,
            value              : v9.value,
            time               : v1,
        };
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v12);
    }
    ...
    public fun accept_offer_with_originbyte_kiosk_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: address, arg5: u64, arg6: &mut 0x2::kiosk::Kiosk, arg7: 0x2::object::ID, arg8: &0x2::clock::Clock, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        let v16 = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg2, arg3, 0x2::coin::from_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v15, arg9), arg8, arg9);
        if (0x2::coin::value<T0>(&v16) > v9.value) {
            let v17 = 0x2::coin::into_balance<T0>(v16);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::take<T0>(&mut v17, v9.value, arg9), v0);
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::from_balance<T0>(v17, arg9), v9.creator);
        } else {
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(v16, v0);
        };
        0x2::object::delete(v13);
        let v18 = AcceptOfferEvent<Collection<T0, T1>>{
            offer_id           : 0x2::object::id<Offer>(v9),
            nft_id             : arg7,
            creator            : v9.creator,
            borrower           : v0,
        ...
        0x2::event::emit<AcceptOfferEvent<Collection<T0, T1>>>(v18);
    }
    ...
    public fun cancel_offer_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::redeem::redeem<T0>(arg2, arg3, 0x2::coin::from_balance<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(v19, arg6), arg5, arg6), v0);
        0x2::object::delete(v14);
        0x2::object::delete(v17);
        if (0x1::option::contains<address>(&v1.best_offer_user, &v0) && v1.best_idx == arg4) {
            v1.best_offer_value = 0;
            let v20 = 0x2::vec_map::keys<address, Offers>(&v1.offers);
            while (0x1::vector::length<address>(&v20) > 0) {
                let v21 = 0x1::vector::pop_back<address>(&mut v20);
                let v22 = 0x2::vec_map::get<address, Offers>(&v1.offers, &v21);
                let v23 = 0;
                while (v23 < v22.counter) {
                    if (0x2::object_table::contains<u64, Offer>(&v22.offers, v23)) {
                        let v24 = 0x2::object_table::borrow<u64, Offer>(&v22.offers, v23);
                        if (!v24.is_started && v24.value > v1.best_offer_value) {
                            v1.best_offer_value = v24.value;
                            0x1::option::swap_or_fill<address>(&mut v1.best_offer_user, v24.creator);
                            v1.best_idx = v23;
                        };
                    };
                    v23 = v23 + 1;
        ...
        let v25 = CancelOfferEvent{
            id         : 0x2::object::id<Offer>(&v3),
            collection : v5,
            creator    : v8,
            time       : 0x2::clock::timestamp_ms(arg5),
        };
        0x2::event::emit<CancelOfferEvent>(v25);
    }
    ...
    public fun create_offer_with_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: 0x2::coin::Coin<T0>, arg5: u64, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
        ...
        let v6 = ScallopKey<T0>{dummy_field: false};
        let v7 = Scallop<T0>{
            id      : 0x2::object::new(arg7),
            lender  : v0,
        ...
        0x2::dynamic_object_field::add<ScallopKey<T0>, Scallop<T0>>(&mut v4.id, v6, v7);
        ...
        let v8 = CreateOfferWithScallopEvent<Collection<T0, T1>>{
            id           : 0x2::object::id<Offer>(&v4),
            key          : v3.counter - 1,
            collection   : v1.name,
            creator      : v0,
            value        : arg5,
            s_coin_value : 0x2::coin::value<0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::reserve::MarketCoin<T0>>(&v5),
            time         : 0x2::clock::timestamp_ms(arg6),
        };
        0x2::event::emit<CreateOfferWithScallopEvent<Collection<T0, T1>>>(v8);
    }

    public fun deposit_into_scallop<T0, T1: store + key>(arg0: &mut Platform, arg1: 0x2::object::ID, arg2: &0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::version::Version, arg3: &mut 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::market::Market, arg4: u64, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg6);
        assert!(0x2::dynamic_object_field::exists_<0x2::object::ID>(&arg0.id, arg1), 2);
        let v1 = 0x2::dynamic_object_field::borrow_mut<0x2::object::ID, Collection<T0, T1>>(&mut arg0.id, arg1);
        let v2 = 0x2::vec_map::get_mut<address, Offers>(&mut v1.offers, &v0);
        assert!(v2.counter > arg4, 104);
        let v3 = 0x2::object_table::borrow_mut<u64, Offer>(&mut v2.offers, arg4);
        assert!(v3.creator == v0, 401);
        assert!(!v3.is_started, 103);
        let v4 = ScallopKey<T0>{dummy_field: false};
        assert!(!0x2::dynamic_object_field::exists_with_type<ScallopKey<T0>, Scallop<T0>>(&v3.id, v4), 7);
        let v5 = 0xefe8b36d5b2e43728cc323298626b83177803521d195cfb11e15b910e892fddf::mint::mint<T0>(arg2, arg3, 0x2::coin::take<T0>(&mut v1.balance, v3.value, arg6), arg5, arg6);
        let v6 = ScallopKey<T0>{dummy_field: false};
        let v7 = Scallop<T0>{
        ...
        0x2::dynamic_object_field::add<ScallopKey<T0>, Scallop<T0>>(&mut v3.id, v6, v7);
        let v8 = ScallopDepositEvent<Collection<T0, T1>>{
            id           : 0x2::object::id<Offer>(v3),
            key          : arg4,
            collection   : v1.name,
            creator      : v0,
        ...
        0x2::event::emit<ScallopDepositEvent<Collection<T0, T1>>>(v8);
    }
