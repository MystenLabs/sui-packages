module 0x9c55192a4b048b1c914cbfea4e1fc1780110719f5e3d335d9ac83f9fa909ea96::staked_share {
    ...
    public entry fun new_and_share_number_pool_and_share_supply<T0: store, T1: store + key>(arg0: &0x9c55192a4b048b1c914cbfea4e1fc1780110719f5e3d335d9ac83f9fa909ea96::pool::AdminCap, arg1: &mut 0x9c55192a4b048b1c914cbfea4e1fc1780110719f5e3d335d9ac83f9fa909ea96::pool::Pool<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = NumberPool<T0, T1>{
            id               : 0x2::object::new(arg2),
            available_shares : 0x1::vector::empty<StakedPoolShare<T0, T1>>(),
        };
        0x9c55192a4b048b1c914cbfea4e1fc1780110719f5e3d335d9ac83f9fa909ea96::pool::fill_number_pool<T0, T1>(arg1, 0x2::object::uid_to_inner(&v0.id));
