module 0x9c5205365e646940f83286105efeb23a7a5cd911fb5fb4551397874945f2adbd::cnsnft7360 {
    struct CNSNFT7360 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT7360, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT7360>(arg0, arg1);
