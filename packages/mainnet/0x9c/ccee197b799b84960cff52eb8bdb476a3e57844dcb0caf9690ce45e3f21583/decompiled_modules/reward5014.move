module 0x9cccee197b799b84960cff52eb8bdb476a3e57844dcb0caf9690ce45e3f21583::reward5014 {
    struct REWARD5014 has drop {
        dummy_field: bool,
    }

    struct TICKET_5014 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward5014(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5014>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5014>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD5014, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD5014>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5014>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5014>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5014>>(v5, 0x2::tx_context::sender(arg1));
    }
