module 0x9c3b5327345c790154e74016b6bad799f5fe566baf0fce404edcd9b7773ebb96::gorklon {
    ...
    fun init(arg0: GORKLON, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://dd.dexscreener.com/ds-data/tokens/solana/2ivzYvjnKqA4X3dVvPKr7bctGpbxwrXbbxm44TJCpump.png                                                                                                                                                                                                                               ");
