module 0x9cfdda8a77fc6624f7fd76c9133df9e2bea7e1e74f4e0cc7eea48e0e3ee01fd4::game6569 {
    struct GAME6569 has drop {
        dummy_field: bool,
    }

    struct TICKET_6569 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeTicket6569(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_6569>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_6569>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GAME6569, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GAME6569>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_6569>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_6569>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_6569>>(v5, 0x2::tx_context::sender(arg1));
    }
