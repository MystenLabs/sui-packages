module 0x9c688ea952547e8d3ebfe13e97668659dd3aebd6c5a854048655ba8f253e7a26::locked {
    ...
    public(friend) fun set_lock_end_timestamp_ms<T0: store>(arg0: &mut Locked<T0>, arg1: u64) {
        assert!(arg0.lock_end_timestamp_ms <= arg1, 1);
    ...
    public(friend) fun unlock_<T0: store>(arg0: Locked<T0>, arg1: u64) : T0 {
        assert!(arg0.lock_end_timestamp_ms <= arg1, 0);
        let Locked {
            id                    : v0,
            inner                 : v1,
            lock_end_timestamp_ms : _,
