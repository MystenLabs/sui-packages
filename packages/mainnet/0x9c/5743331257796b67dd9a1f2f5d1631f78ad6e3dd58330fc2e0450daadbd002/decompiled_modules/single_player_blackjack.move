module 0x9c5743331257796b67dd9a1f2f5d1631f78ad6e3dd58330fc2e0450daadbd002::single_player_blackjack {
    ...
    entry fun hit<T0>(arg0: &mut Game<T0>, arg1: &mut HouseData<T0>, arg2: HitRequest, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 13);
        let HitRequest {
            id                 : v0,
            game_id            : v1,
            current_player_sum : v2,
        } = arg2;
        assert!(v1 == 0x2::object::id<Game<T0>>(arg0), 16);
        assert!(v2 == arg0.player_sum, 18);
        0x2::object::delete(v0);
        let v3 = 0x2::random::new_generator(arg3, arg4);
        let v4 = &mut v3;
        let v5 = get_next_random_card<T0>(v4, arg0);
        0x1::vector::push_back<u8>(&mut arg0.player_cards, v5);
        arg0.player_sum = get_card_sum(&arg0.player_cards);
        let v6 = HitDoneEvent{
        ...
        0x2::event::emit<HitDoneEvent>(v6);
        if (arg0.player_sum > 21) {
            house_won_post_handling<T0>(arg0, arg1, arg4);
        } else {
            arg0.counter = arg0.counter + 1;
        };
    }
    ...
    entry fun stand<T0>(arg0: &mut Game<T0>, arg1: &mut HouseData<T0>, arg2: StandRequest, arg3: &0x2::random::Random, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.status == 0, 13);
        let StandRequest {
            id                 : v0,
            game_id            : v1,
        ...
        assert!(v1 == 0x2::object::id<Game<T0>>(arg0), 17);
        assert!(v2 == arg0.player_sum, 19);
        0x2::object::delete(v0);
        let v3 = 0x2::random::new_generator(arg3, arg4);
        while (arg0.dealer_sum < 17) {
            let v4 = &mut v3;
            let v5 = get_next_random_card<T0>(v4, arg0);
            0x1::vector::push_back<u8>(&mut arg0.dealer_cards, v5);
            arg0.dealer_sum = get_card_sum(&arg0.dealer_cards);
        };
        if (arg0.dealer_sum > 21) {
            player_won_post_handling<T0>(arg0, b"Dealer Busted!", arg4);
        } else {
            let v6 = if (arg0.dealer_sum == 21) {
                if (arg0.player_sum == 21) {
            ...
            if (v6) {
                ...
                player_won_post_handling<T0>(arg0, b"Player won!", arg4);
            } else {
                tie_post_handling<T0>(arg0, arg1, arg4);
            };
        };
    }
