module 0x9cc854d89b2986f9a26bb230ee8c511e6bb2c4e0d1482c6477c35a9a85b8b67d::registry {
    ...
    public fun approve<T0: drop>(arg0: &0x9cc854d89b2986f9a26bb230ee8c511e6bb2c4e0d1482c6477c35a9a85b8b67d::admin::AdminCap, arg1: &mut AdapterRegistry, arg2: u64) {
    ...
    public fun revoke<T0: drop>(arg0: &0x9cc854d89b2986f9a26bb230ee8c511e6bb2c4e0d1482c6477c35a9a85b8b67d::admin::AdminCap, arg1: &mut AdapterRegistry) {
        let v0 = 0x1::type_name::with_defining_ids<T0>();
        if (0x2::vec_map::contains<0x1::type_name::TypeName, AdapterInfo>(&arg1.approved, &v0)) {
