module 0x9c4569b97c1e3d86b3482ad129136931a31ecae4ae084a5d6222a10e11c2d3a3::reward3734 {
    struct REWARD3734 has drop {
        dummy_field: bool,
    }

    struct TICKET_3734 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3734(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3734>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3734>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3734, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3734>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3734>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3734>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3734>>(v5, 0x2::tx_context::sender(arg1));
    }
