module 0x9c396c5463c713c34a8cc0a941a94220599abf45860d1ea5c2817353c1a5f7a0::nft {
    ...
    public fun create_spec(arg0: &0x9c396c5463c713c34a8cc0a941a94220599abf45860d1ea5c2817353c1a5f7a0::house::AdminCap, arg1: &mut Factory, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: u64, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        let v0 = Spec{
    ...
    public fun mint_to_sender(arg0: &mut Factory, arg1: &mut 0x9c396c5463c713c34a8cc0a941a94220599abf45860d1ea5c2817353c1a5f7a0::house::House<0x2::sui::SUI>, arg2: 0x2::object::ID, arg3: 0x2::coin::Coin<0x2::sui::SUI>, arg4: &mut 0x2::tx_context::TxContext) : Nft {
        ...
        0x9c396c5463c713c34a8cc0a941a94220599abf45860d1ea5c2817353c1a5f7a0::house::deposit<0x2::sui::SUI>(arg1, arg3);
        let v1 = Nft{
        ...
        0x9c396c5463c713c34a8cc0a941a94220599abf45860d1ea5c2817353c1a5f7a0::events::emit_nft_minted_event(0x2::object::id<Nft>(&v1), 0x2::tx_context::sender(arg4), v1.name);
        v1
    }
