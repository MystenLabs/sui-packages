module 0x9cef21034715f62a5052e8f8286869e8d6d2ff686643b1b65f2e1361c6a27710::cnsnft4074 {
    struct CNSNFT4074 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4074, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4074>(arg0, arg1);
