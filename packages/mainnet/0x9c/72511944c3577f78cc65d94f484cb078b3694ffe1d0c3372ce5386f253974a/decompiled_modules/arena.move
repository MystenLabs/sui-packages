module 0x9c72511944c3577f78cc65d94f484cb078b3694ffe1d0c3372ce5386f253974a::arena {
    ...
    fun init(arg0: ARENA, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = trim_right(b"https://cdn.dexscreener.com/cms/images/tbDqd4FjGyFMHFcm?width=128&height=128&fit=crop&quality=95&format=auto                                                                                                                                                                                                                    ");
        let v2 = if (0x1::vector::length<u8>(&v1) == 0) {
            0x1::option::none<0x2::url::Url>()
        } else {
            0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(v1))
        };
        let (v3, v4) = 0x2::coin::create_currency<ARENA>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"ARENA   ")))), trim_right(b"Arena of Memes                  "), trim_right(b"Launch. Battle. KO. Migrate. The $ARENA where memecoins fight 1v1 for migration.                                                                                                                                                                                                                                                "), v2, arg1);
        let v5 = v3;
