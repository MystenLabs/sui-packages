module 0x9c0d95617cb8c3fa1ddcaf98540e995d42e3a7e30a2e9a05a0305cb27aa24cdc::cnsnft6656 {
    struct CNSNFT6656 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6656, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6656>(arg0, arg1);
