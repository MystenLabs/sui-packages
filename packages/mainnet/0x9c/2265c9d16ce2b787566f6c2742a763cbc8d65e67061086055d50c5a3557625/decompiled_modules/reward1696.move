module 0x9c2265c9d16ce2b787566f6c2742a763cbc8d65e67061086055d50c5a3557625::reward1696 {
    struct REWARD1696 has drop {
        dummy_field: bool,
    }

    struct TICKET_1696 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward1696(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_1696>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_1696>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD1696, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD1696>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_1696>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_1696>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_1696>>(v5, 0x2::tx_context::sender(arg1));
    }
