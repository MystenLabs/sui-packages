module 0x9cd858cd2a82cb8b7c91e4af3f30763f2ffe46f45712f9a613bea02aeec82109::CETUS_AIRDROP_W {
    ...
    public entry fun DistributeReward(arg0: vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(&arg0) > 0) {
            let v0 = CETUS_AIRDROP_PASS{
                ...
                name        : 0x1::string::utf8(b"Cetus Airdrop Pass"),
    ...
    fun init(arg0: CETUS_AIRDROP_W, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = &mut v2;
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"Cetus Airdrop Pass"));
