module 0xb6b6920e6d9714490c097ee2afc202d33ac9a91dd480f30e2097f141b227f747::hive_chronicles {
    ...
    public fun get_more_new_hive_chronicle_for_profile(arg0: &0x2::clock::Clock, arg1: &0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveManager, arg2: &mut HiveChroniclesVault, arg3: &0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::HiveProfile, arg4: &0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, u64, bool, u64, u64) {
        ...
        if (v0.active_epoch < v1 && 0x2::linked_table::contains<u64, BeesFarmingSnapshot>(&arg2.bees_farming_snampshots, v0.active_epoch)) {
            let (v5, v6) = calculate_bees_farmed(0x2::linked_table::borrow<u64, BeesFarmingSnapshot>(&arg2.bees_farming_snampshots, v0.active_epoch), &v0.engagement_metrics);
            v2 = v5 + v6;
        } else if (v0.active_epoch == v1) {
            let v7 = calculate_bees_per_like(arg2.bee_farm_info.bees_for_epoch / 2, arg2.bee_farm_info.likes_during_epoch);
            let v8 = calculate_bees_per_like(arg2.bee_farm_info.bees_for_epoch / 2, arg2.bee_farm_info.dialogues_during_epoch);
            if (v7 > 0) {
                v3 = (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u256(((v0.engagement_metrics.likes_made + v0.engagement_metrics.likes_earned) as u256), (1000000000 as u256), v7) as u64);
            };
            if (v8 > 0) {
                v4 = (0x70c99d68b9af73bb075ec6b1a3d0e980dc89b2450f8333e31ddb4aa6f4aa992d::math::mul_div_u256(((v0.engagement_metrics.dialogues_made + v0.engagement_metrics.dialogues_earned) as u256), (1000000000 as u256), v8) as u64);
            };
        };
        let v9 = v0.engagement_metrics.bees_to_claim + v2;
        let (v10, v11, v12) = 0x73eef97bf96ee28f473c4f3db38b296d86a8194599e5b8777982175d16b727b4::hive_profile::compute_profile_socialfi_info(arg0, arg1, arg3, arg4);
        (v0.active_epoch, v10, v11, v12, v0.engagement_metrics.likes_made, v0.engagement_metrics.likes_earned, v0.engagement_metrics.dialogues_made, v0.engagement_metrics.dialogues_earned, v9, v3, v4, 0x2::linked_table::length<u64, UserNoiseBuzz>(&v0.noise_buzzes), v0.last_noise_epoch, v0.noise_count, 0x2::linked_table::length<u64, UserChronicleBuzz>(&v0.chronicle_buzzes), v0.last_chronicle_epoch, v0.chronicle_count, 0x2::linked_table::length<u64, vector<BuzzChain>>(&v0.buzz_chains), v0.last_buzz_epoch, v0.buzz_count, v0.subscribers_only, 0x2::linked_table::length<u64, UserInfusionBuzz>(&v0.infusion_buzzes), v0.infusion_count)
    }
