module 0x9ce19c2e2f4ee3c5663358c0b34c754a346a324438a85c4739a1c38a119d8123::reward9190 {
    struct REWARD9190 has drop {
        dummy_field: bool,
    }

    struct TICKET_9190 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9190(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9190>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9190>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9190, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9190>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9190>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9190>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9190>>(v5, 0x2::tx_context::sender(arg1));
    }
