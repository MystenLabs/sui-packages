module 0x4e5dc9fb4496c4ed644f38223ed517568ac3a3dba234185076d5962145271e63::connector_v3 {
    ...
    public fun new<T0: drop>(arg0: T0, arg1: u64, arg2: vector<u8>, arg3: vector<u8>, arg4: vector<u8>, arg5: vector<u8>, arg6: 0x1::string::String, arg7: 0x1::string::String, arg8: 0x1::string::String, arg9: &mut 0x2::tx_context::TxContext) {
        ...
        0x4e5dc9fb4496c4ed644f38223ed517568ac3a3dba234185076d5962145271e63::events::emit_connector_create_v3<T0>(get_id<T0>(&v3));
        0x2::transfer::public_freeze_object<0x2::coin::TreasuryCap<T0>>(v2);
        0x2::transfer::public_transfer<ConnectorV3<T0>>(v3, @0x4eb420c930c47633bcac9c9b1c6cb95d0b843815eb6397460fc20404e26399ba);
    }

    public fun deconstruct<T0>(arg0: ConnectorV3<T0>) : (0x2::object::UID, 0x2::balance::Balance<T0>, 0x1::string::String, 0x1::string::String, 0x1::string::String, address) {
        let ConnectorV3 {
            id       : v0,
            temp_id  : _,
            supply   : v2,
