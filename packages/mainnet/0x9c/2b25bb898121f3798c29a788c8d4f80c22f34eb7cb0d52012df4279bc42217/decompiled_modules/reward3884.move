module 0x9c2b25bb898121f3798c29a788c8d4f80c22f34eb7cb0d52012df4279bc42217::reward3884 {
    struct REWARD3884 has drop {
        dummy_field: bool,
    }

    struct TICKET_3884 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3884(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3884>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3884>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3884, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3884>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3884>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3884>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3884>>(v5, 0x2::tx_context::sender(arg1));
    }
