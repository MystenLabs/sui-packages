module 0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::single_chain_limit_orders {
    ...
    public fun cancel_order<T0>(arg0: LimitOrder<T0>, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::guard::send_coins_and_destroy_balance<T0>(v2, v1, arg1);
    }
    ...
    fun check_signed_permission_data<T0, T1, T2>(arg0: &LimitOrder<T0>, arg1: &SignedPermissionData, arg2: &0x2::clock::Clock, arg3: &0x2::tx_context::TxContext) {
        ...
        if (0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::single_chain_helpers::get_secret_hash<T1, T2>(arg1.coin_out_receiver, arg1.extra_transfer_receiver, arg1.secret_number) != arg0.secret_hash) {
            abort 109
        };
    }

    public fun create_limit_order<T0, T1, T2>(arg0: &0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::guard::Guard<T0, T2>, arg1: 0x2::coin::Coin<T1>, arg2: u64, arg3: u64, arg4: u64, arg5: vector<u8>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) {
    ...
    fun decode_start_permission_and_check_signature<T0, T1>(arg0: &0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::guard::Guard<T0, T1>, arg1: vector<u8>, arg2: vector<u8>) : SignedPermissionData {
    ...
    public fun fulfill_order<T0, T1, T2, T3, T4>(arg0: &mut 0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::guard::Guard<T0, T1>, arg1: LimitOrder<T2>, arg2: FulfillmentReceipt<T3, T4>, arg3: 0x2::coin::Coin<T0>, arg4: 0x2::coin::Coin<T3>, arg5: 0x1::option::Option<0x2::coin::Coin<T4>>, arg6: &mut 0x2::tx_context::TxContext) {
        let LimitOrder {
            id                            : v0,
            user                          : _,
            locked_coins_in               : v2,
        ...
        0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::guard::increase_collected_fees<T0, T1>(arg0, 0x2::coin::into_balance<T0>(arg3));
    ...
    public fun start_order_execution<T0, T1, T2, T3, T4>(arg0: &mut 0x9c993b10b072ff07f93437bdda25f0736195fa8d19a8af40d71408eb5b267730::guard::Guard<T0, T1>, arg1: &mut LimitOrder<T2>, arg2: vector<u8>, arg3: vector<u8>, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) : (0x2::coin::Coin<T2>, FulfillmentReceipt<T3, T4>) {
