module 0x9ca977ab03e0fef310278d7c3a40449477ac5948d2b7e2f3346486ef211016b8::sustatetoken {
    ...
    fun calculate_vesting_amount(arg0: &mut Distribution, arg1: u64) : u64 {
        ...
        if (v0 > 0 && arg0.vesting.tge_status) {
            let v2 = 0x9ca977ab03e0fef310278d7c3a40449477ac5948d2b7e2f3346486ef211016b8::math::mul_div(arg0.vesting.total_amount, v0, 100);
    ...
    fun init(arg0: SUSTATETOKEN, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = v2;
        0x2::coin::mint_and_transfer<SUSTATETOKEN>(&mut v4, 10000000000000000, v0, arg1);
        let v5 = OwnerCap{
        ...
        let v6 = VestingMap{
            ...
            tge_status            : true,
            tge_percent           : 0,
            cycle_amount          : 0x9ca977ab03e0fef310278d7c3a40449477ac5948d2b7e2f3346486ef211016b8::math::mul_div(8000000000000000, 20, 1000),
        };
        let v7 = Distribution{
            id      : 0x2::object::new(arg1),
        ...
        let v8 = VestingMap{
            ...
            tge_status            : true,
            tge_percent           : 7,
            cycle_amount          : 0x9ca977ab03e0fef310278d7c3a40449477ac5948d2b7e2f3346486ef211016b8::math::mul_div(62000000000000000, 30, 1000),
        };
        let v9 = Distribution{
            id      : 0x2::object::new(arg1),
        ...
        let v10 = VestingMap{
            ...
            tge_status            : true,
            tge_percent           : 2,
            cycle_amount          : 0x9ca977ab03e0fef310278d7c3a40449477ac5948d2b7e2f3346486ef211016b8::math::mul_div(20000000000000000, 35, 1000),
        };
