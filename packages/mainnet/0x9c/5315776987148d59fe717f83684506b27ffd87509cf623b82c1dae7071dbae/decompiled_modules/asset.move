module 0x9c5315776987148d59fe717f83684506b27ffd87509cf623b82c1dae7071dbae::asset {
    ...
    public(friend) fun new<T0>(arg0: 0x9c5315776987148d59fe717f83684506b27ffd87509cf623b82c1dae7071dbae::interest::InterestModel, arg1: AssetConfig, arg2: &mut 0x2::tx_context::TxContext) : Asset<T0> {
        let v0 = Asset<T0>{
    ...
    fun assert_not_equal_and_set<T0: copy + drop + store>(arg0: &mut 0x2::object::UID, arg1: T0, arg2: bool) {
        ...
        assert!(*v0 != arg2, 0x9c5315776987148d59fe717f83684506b27ffd87509cf623b82c1dae7071dbae::error::updating_with_same_value());
        *v0 = arg2;
    }
    ...
    public(friend) fun change_operation_status<T0>(arg0: &mut Asset<T0>, arg1: u8, arg2: bool) {
        ...
        if (*v0 == 0) {
            ...
            assert!(*v0 == 4, 0x9c5315776987148d59fe717f83684506b27ffd87509cf623b82c1dae7071dbae::error::invalid_operation_status());
            let v9 = &mut arg0.id;
    ...
    public(friend) fun interest_model<T0>(arg0: &Asset<T0>) : &0x9c5315776987148d59fe717f83684506b27ffd87509cf623b82c1dae7071dbae::interest::InterestModel {
        &arg0.interest_model
    }
    ...
    public(friend) fun update_interest_model<T0>(arg0: &mut Asset<T0>, arg1: 0x9c5315776987148d59fe717f83684506b27ffd87509cf623b82c1dae7071dbae::interest::InterestModel) {
