module 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::subscription {
    ...
    fun collect_finalize_market_fee<T0, T1>(arg0: &0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &mut 0x2::tx_context::TxContext) {
        0x2::transfer::public_transfer<0x2::coin::Coin<T1>>(0x2::coin::from_balance<T1>(0x2::balance::split<T1>(&mut arg1.balance_y, arg1.contributed * 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::finalize_market_fee_bps(arg0) / 10000), arg2), 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::fee_recipient(arg0));
    }

    fun collect_open_market_fee<T0>(arg0: &0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::MainConfig, arg1: 0x2::coin::Coin<T0>) {
        assert!(0x2::coin::value<T0>(&arg1) == 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::open_market_fee(arg0), 1);
        0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(arg1, 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::fee_recipient(arg0));
    }
    ...
    public fun finalize_market<T0, T1>(arg0: &0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::MainConfig, arg1: &mut Market<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::config::GlobalConfig, arg3: &mut 0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::factory::Pools, arg4: &0x2::coin::CoinMetadata<T0>, arg5: &0x2::coin::CoinMetadata<T1>, arg6: &0x2::clock::Clock, arg7: &mut 0x2::tx_context::TxContext) : 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::vault::LpVault<T0, T1> {
        let v0 = 0x2::clock::timestamp_ms(arg6);
        assert!(0x2::balance::value<T1>(&arg1.balance_y) >= arg1.soft_cap && v0 > arg1.market_close, 9);
        if (v0 < arg1.market_close + 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::curator_finalizing_cooldown(arg0)) {
        ...
        let v1 = @0x0;
        let v2 = 0;
        let v3 = 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::vault::new_lp_vault<T0, T1>(0x2::bag::new(arg7), arg1.curator, arg1.admin_public_key, 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::admin_key_id(arg0), arg7);
        if (arg1.is_auto_add_liquidity) {
            ...
            if (v11) {
                ...
                0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::vault::add_position<T0, T1>(&mut v3, v20);
                0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::events::emit_lp_vault_created<T0, T1>(0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::events::get_id(&arg1.id), 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::vault::id<T0, T1>(&v3), arg1.curator, v22, v14, v4, v5, 0x2::object::id<0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::position::Position>(&v20));
            } else {
                ...
                0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::vault::add_position<T0, T1>(&mut v3, v29);
        ...
        let v32 = arg1.soft_cap - arg1.soft_cap * 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::finalize_market_fee_bps(arg0) / 10000;
        let v33 = v32;
        if (arg1.is_auto_add_liquidity) {
    ...
    fun validate_params(arg0: &0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::MainConfig, arg1: u64, arg2: u128, arg3: u64, arg4: u64, arg5: bool, arg6: u64) {
        assert!(arg3 + 0x9c1678e2514446cdd1d10becae20ce430b98017ebe0f21578c0287697587c72e::main::finalize_market_fee_bps(arg0) <= 10000, 1);
        let v0 = 0;
        if (arg5) {
