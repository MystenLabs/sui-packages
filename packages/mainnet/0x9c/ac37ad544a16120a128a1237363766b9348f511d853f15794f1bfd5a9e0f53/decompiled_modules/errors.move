module 0x9cac37ad544a16120a128a1237363766b9348f511d853f15794f1bfd5a9e0f53::errors {
    ...
    public fun maker_bad_offset() : u64 {
        433
    }

    public fun maker_bad_param() : u64 {
        431
    }

    public fun maker_bad_side() : u64 {
        432
    }

    public fun maker_binding_mismatch() : u64 {
        439
    }

    public fun maker_commitment_cap() : u64 {
        438
    }

    public fun maker_kernel_mismatch() : u64 {
        430
    }

    public fun maker_no_book() : u64 {
        434
    }

    public fun maker_paused() : u64 {
        437
    }

    public fun maker_post_only_crossed() : u64 {
        440
    }

    public fun maker_price_underflow() : u64 {
        435
    }

    public fun maker_replay() : u64 {
        436
    }
