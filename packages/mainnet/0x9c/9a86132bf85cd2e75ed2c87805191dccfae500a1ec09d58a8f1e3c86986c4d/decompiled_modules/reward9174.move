module 0x9c9a86132bf85cd2e75ed2c87805191dccfae500a1ec09d58a8f1e3c86986c4d::reward9174 {
    struct REWARD9174 has drop {
        dummy_field: bool,
    }

    struct TICKET_9174 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9174(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9174>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9174>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9174, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9174>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9174>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9174>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9174>>(v5, 0x2::tx_context::sender(arg1));
    }
