module 0x75b7f5d2926f333d8849726655904111420d4f86acb2578274b31338bcf8142c::agent_policy {
    ...
    public fun assert_active(arg0: &AgentPolicy, arg1: &0x2::clock::Clock, arg2: 0x1::string::String, arg3: u64, arg4: &0x2::tx_context::TxContext) {
        ...
        assert!(arg3 <= arg0.per_tx_cap, 3);
        assert!(0x2::vec_set::contains<0x1::string::String>(&arg0.allowed_protocols, &arg2), 5);
    }
    ...
    public fun owner_cap_policy_id(arg0: &OwnerCap) : 0x2::object::ID {
        arg0.policy_id
    }
