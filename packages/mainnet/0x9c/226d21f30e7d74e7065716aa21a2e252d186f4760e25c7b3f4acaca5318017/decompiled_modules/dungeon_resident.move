module 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_resident {
    ...
    public fun equip_gem<T0>(arg0: &mut Resident<T0>, arg1: 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::Gem, arg2: &mut DungeonState, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.level >= 30, 9);
        assert!(!0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"Gem"), 13);
        let v0 = 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::gem_rarity(&arg1);
        0x2::dynamic_field::add<vector<u8>, u64>(&mut arg0.id, b"origin_rating", arg0.rating);
        0x2::dynamic_field::add<vector<u8>, u64>(&mut arg0.id, b"origin_level", arg0.level);
        let v1 = arg0.level + 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::calculate_upgrade_level(v0);
        let v2 = arg0.rating * 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_utils::calc_gem_upgrade_rating(get_rarity_multiplier(&arg0.rarity), v0) / 1000000;
        update_leaderboard<T0>(arg0, arg2, v2, v1, arg3);
        arg0.rating = v2;
        arg0.level = v1;
        0x2::dynamic_object_field::add<vector<u8>, 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::Gem>(&mut arg0.id, b"Gem", arg1);
    }
    ...
    fun get_rarity_multiplier(arg0: &0x1::string::String) : u64 {
        let v0 = 0x1::string::utf8(b"UR");
        if (arg0 == &v0) {
            1140000
        } else {
            let v2 = 0x1::string::utf8(b"SSR");
            if (arg0 == &v2) {
                1100000
            } else {
                let v3 = 0x1::string::utf8(b"SR");
                if (arg0 == &v3) {
                    1080000
                } else {
                    let v4 = 0x1::string::utf8(b"R");
                    if (arg0 == &v4) {
                        1060000
                    } else {
                        let v5 = 0x1::string::utf8(b"N");
                        assert!(arg0 == &v5, 14);
                        1040000
                    }
                }
    ...
    public fun resident_identity<T0>(arg0: &Resident<T0>) : 0x1::string::String {
        arg0.identity
    }

    public fun resident_level<T0>(arg0: &Resident<T0>) : u64 {
        arg0.level
    }

    public fun resident_rarity<T0>(arg0: &Resident<T0>) : 0x1::string::String {
        arg0.rarity
    }
    ...
    public fun unequip_gem<T0>(arg0: &mut Resident<T0>, arg1: &mut DungeonState, arg2: 0x2::coin::Coin<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>, arg3: &mut 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DungeonVault, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"origin_rating"), 11);
        assert!(0x2::dynamic_field::exists_<vector<u8>>(&arg0.id, b"origin_level"), 11);
        assert!(0x2::dynamic_object_field::exists_<vector<u8>>(&arg0.id, b"Gem"), 12);
        let v0 = 0x2::dynamic_object_field::remove<vector<u8>, 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::Gem>(&mut arg0.id, b"Gem");
        assert!(0x2::coin::value<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::DGG_TOKEN>(&arg2) == 0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::get_unequip_fee(0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::gem_rarity(&v0)), 10);
        let v1 = 0x2::dynamic_field::remove<vector<u8>, u64>(&mut arg0.id, b"origin_rating");
        let v2 = 0x2::dynamic_field::remove<vector<u8>, u64>(&mut arg0.id, b"origin_level");
        update_leaderboard<T0>(arg0, arg1, v1, v2, arg4);
        arg0.level = v2;
        arg0.rating = v1;
        0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dgg_token::internal_burn(arg3, arg2);
        0x2::transfer::public_transfer<0x625d518a3cc78899742d76cf785609cd707e15228d4284aa4fee5ca53caa9849::dungeon_gem::Gem>(v0, 0x2::tx_context::sender(arg4));
    }

    fun update_leaderboard<T0>(arg0: &Resident<T0>, arg1: &mut DungeonState, arg2: u64, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) {
        let v0 = &mut arg1.rating_leaderboard;
        let LeaderboardRecordItem {
            ...
            level       : _,
            identity    : v6,
        } = remove_leaderboard(v0, arg0.rating, 0x2::object::uid_to_inner(&arg0.id));
        0x2::object::delete(v1);
        let v7 = LeaderboardRecordItem{
        ...
        let v8 = &mut arg1.rating_leaderboard;
        add_leaderboard(v8, arg2, v7);
    }
