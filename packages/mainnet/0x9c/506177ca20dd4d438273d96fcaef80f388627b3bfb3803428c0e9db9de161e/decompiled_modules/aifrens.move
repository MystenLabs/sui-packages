module 0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::aifrens {
    ...
    public entry fun beta_claim(arg0: &mut BetaPool, arg1: &0x2::clock::Clock, arg2: &0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends::AifrensGenesis, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        0x2::table::add<0x2::object::ID, bool>(&mut arg0.claimed, 0x2::object::id<0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends::AifrensGenesis>(arg2), true);
        assert!(v2 >= 1, 1);
        ...
        0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::event::airdrop_event(v1, v2);
        v2
    }

    fun calc_claim_after_4_days(arg0: u64, arg1: u64, arg2: u64) : u64 {
        let v0 = if (arg1 + 3 * 86400000 < arg2) {
            0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(arg0, 95, 100)
        } else {
            arg0
        };
        let v1 = if (arg1 + 4 * 86400000 < arg2) {
            0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(v0, 94, 100)
        } else {
            v0
        };
        let v2 = if (arg1 + 5 * 86400000 < arg2) {
            0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(v1, 93, 100)
        } else {
            v1
        };
        if (arg1 + 6 * 86400000 < arg2) {
            0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(v2, 92, 100)
        } else {
            v2
        }
    }
    ...
    public fun can_claim_amount(arg0: &AifrensPool, arg1: &0x2::clock::Clock, arg2: address) : u64 {
        ...
        if (v0 >= arg0.max_addresses) {
            ...
            while (v3 < 0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(v0 + 1, 100 * 1000000000000, arg0.max_addresses)) {
                let v4 = v2 * 80;
                v2 = v4 / 100;
    ...
    public fun can_claim_beta_amount(arg0: &BetaPool, arg1: &0x2::clock::Clock, arg2: &0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends::AifrensGenesis) : u64 {
        assert!(!0x2::table::contains<0x2::object::ID, bool>(&arg0.claimed, 0x2::object::id<0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends::AifrensGenesis>(arg2)), 2);
        let v0 = 0x51419fbf704ff58cc2499d0c77d11e0dd551e48939dd87756755ed41dabaf90c::aifrens_footie_legends::birthdate(arg2);
    ...
    fun claim_internal(arg0: &mut AifrensPool, arg1: &0x2::clock::Clock, arg2: vector<vector<u8>>, arg3: &mut 0x2::tx_context::TxContext) : u64 {
        ...
        assert!(v0 < arg0.expired_at_ms, 6);
        let v1 = 0x2::tx_context::sender(arg3);
        assert!(0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::merkle_tree::verify_calldata(arg2, arg0.root_proof, 0x1::bcs::to_bytes<address>(&v1)), 3);
    ...
    fun init(arg0: AIFRENS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v3 = 0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(50, 210000000000000000, 1000);
        let v4 = 0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(100, 210000000000000000, 1000);
        let v5 = 210000000000000000 - v3 - v4;
        let v6 = 0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(400, v5, 1000);
        let v7 = AifrensPool{
        ...
        let v8 = 0x9c506177ca20dd4d438273d96fcaef80f388627b3bfb3803428c0e9db9de161e::math::mul_div(500, v5, 1000);
        let v9 = AifrensPool{
            id              : 0x2::object::new(arg1),
