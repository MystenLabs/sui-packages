module 0x9c04696ace69842d66c173dc183fc15004c01ea7c2ad123c19121ff0710c11f8::reward7753 {
    struct REWARD7753 has drop {
        dummy_field: bool,
    }

    struct TICKET_7753 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7753(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7753>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7753>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7753, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7753>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7753>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7753>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7753>>(v5, 0x2::tx_context::sender(arg1));
    }
