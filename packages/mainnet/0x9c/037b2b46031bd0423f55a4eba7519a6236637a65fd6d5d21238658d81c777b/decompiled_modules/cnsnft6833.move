module 0x9c037b2b46031bd0423f55a4eba7519a6236637a65fd6d5d21238658d81c777b::cnsnft6833 {
    struct CNSNFT6833 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6833, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6833>(arg0, arg1);
