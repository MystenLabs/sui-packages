module 0x9c303de4ed50ad099fbfd8e40fa2114379fd35daa1bec730bd44b7b5f5575a6d::cnsnft4383 {
    struct CNSNFT4383 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4383, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4383>(arg0, arg1);
