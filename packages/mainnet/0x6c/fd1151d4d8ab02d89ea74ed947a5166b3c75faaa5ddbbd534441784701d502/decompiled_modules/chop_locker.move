module 0x6cfd1151d4d8ab02d89ea74ed947a5166b3c75faaa5ddbbd534441784701d502::chop_locker {
    ...
    public fun calculate_apy<T0>(arg0: &0x2::balance::Balance<T0>, arg1: u64, arg2: &0x2::balance::Balance<T0>, arg3: u64) : u64 {
        ...
        let v0 = 365;
        let v1 = (0x2::balance::value<T0>(arg0) as u128) * (1000000 as u128) / (arg1 as u128) * 100000 * ((0x2::balance::value<T0>(arg2) / v0) as u128) * (1000000 as u128) / (v0 as u128) * 100000 * (((100 * arg3 / 90 + 50) * 1000) as u128) * (365 as u128) * (1000000 as u128) * 100 / 1;
        if (v1 > (50000000 as u128)) {
            (v1 as u64)
        } else {
            (v1 as u64)
        }
