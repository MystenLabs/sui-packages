module 0x6c168cd5e4ba1bea8f0df82c9232d16b1fd9a4f9555d3392c24a3f9e27a10806::claim {
    ...
    public entry fun claim<T0>(arg0: &mut Claim<T0>, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::bag::contains<address>(&arg0.claim_members, v0)) {
            ...
            assert!(*v2 > *v3, 1002);
            *v3 = *v2;
            0x2::transfer::public_transfer<0x2::coin::Coin<T0>>(0x2::coin::split<T0>(&mut arg0.balance, *v2 - *v3, arg2), v0);
            let v4 = ClaimEvent{
                address : v0,
                amount  : *v2 - *v3,
            };
