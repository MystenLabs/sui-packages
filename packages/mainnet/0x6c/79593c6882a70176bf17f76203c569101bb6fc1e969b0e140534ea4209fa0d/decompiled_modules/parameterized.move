module 0x6c79593c6882a70176bf17f76203c569101bb6fc1e969b0e140534ea4209fa0d::parameterized {
    ...
    public entry fun execute_transfer<T0>(arg0: &mut TransferParams, arg1: 0x2::coin::Coin<T0>, arg2: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::vec_map::is_empty<0x1::ascii::String, u64>(&v5)) {
            ...
            0x2::dynamic_field::borrow_mut<vector<u8>, TransferDetails>(&mut arg0.id, b"details").coin_amounts = v5;
        };
        let v26 = DebugEvent{
