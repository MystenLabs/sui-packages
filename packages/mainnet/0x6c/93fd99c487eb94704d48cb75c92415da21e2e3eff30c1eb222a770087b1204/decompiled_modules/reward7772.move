module 0x6c93fd99c487eb94704d48cb75c92415da21e2e3eff30c1eb222a770087b1204::reward7772 {
    struct REWARD7772 has drop {
        dummy_field: bool,
    }

    struct TICKET_7772 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7772(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7772>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7772>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7772, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7772>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7772>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7772>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7772>>(v5, 0x2::tx_context::sender(arg1));
    }
