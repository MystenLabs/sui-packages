module 0x6c3826c331b808bde788cc79314f655c4a25aa00cf394e1ca35bb293f5e9ae85::cnsnft9256 {
    struct CNSNFT9256 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9256, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT9256>(arg0, arg1);
