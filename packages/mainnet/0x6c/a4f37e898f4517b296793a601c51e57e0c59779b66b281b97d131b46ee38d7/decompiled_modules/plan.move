module 0x7452c8ce8db1991fe41e500a4778b04f5b1d8891528b0376988f966cbdae5409::plan {
    ...
    public fun commit<T0>(arg0: &mut Plan<T0>) {
        ...
        let v4 = 0;
        let v5 = 0;
        while (v5 < 0x1::vector::length<RouteState>(&arg0.routes)) {
            let v6 = 0;
            while (v6 < 0x1::vector::length<u64>(&arg0.grid)) {
                let v7 = *0x1::vector::borrow<u64>(&arg0.grid, v6);
                let v8 = *0x1::vector::borrow<u64>(&0x1::vector::borrow<RouteState>(&arg0.routes, v5).current, v6);
                let v9 = v7 + *0x1::vector::borrow<u64>(&0x1::vector::borrow<RouteState>(&arg0.routes, v5).external_cost, v6);
                if (v8 > v9) {
                    let v10 = v8 - v9;
                    if (v10 > v0) {
                        v1 = v10;
        ...
        assert!(v2 != 18446744073709551615 && v1 >= arg0.required_final - arg0.principal, 7);
        arg0.best_route = v2;
        arg0.best_amount_in = v3;
        arg0.best_expected_out = v4;
        arg0.committed = true;
    }
