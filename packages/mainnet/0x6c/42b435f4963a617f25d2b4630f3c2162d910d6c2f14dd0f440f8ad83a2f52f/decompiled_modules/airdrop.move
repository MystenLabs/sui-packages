module 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::airdrop {
    ...
    public fun destroy_zero<T0>(arg0: Airdrop<T0>) {
        ...
        0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::bitmap::destroy(v4);
    }
    ...
    public fun new<T0>(arg0: 0x2::coin::Coin<T0>, arg1: vector<u8>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : Airdrop<T0> {
        ...
        Airdrop<T0>{
            ...
            root    : arg1,
            start   : arg2,
            map     : 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::bitmap::new(arg4),
        }
    }
    ...
    public fun get_airdrop<T0>(arg0: &mut Airdrop<T0>, arg1: vector<vector<u8>>, arg2: &0x2::clock::Clock, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::coin::take<T0>(&mut arg0.balance, 0x6c42b435f4963a617f25d2b4630f3c2162d910d6c2f14dd0f440f8ad83a2f52f::math64::min(arg3, 0x2::balance::value<T0>(&arg0.balance)), arg4)
    }
