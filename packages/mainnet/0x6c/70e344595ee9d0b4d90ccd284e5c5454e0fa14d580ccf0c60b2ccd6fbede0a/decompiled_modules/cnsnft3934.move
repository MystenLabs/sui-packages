module 0x6c70e344595ee9d0b4d90ccd284e5c5454e0fa14d580ccf0c60b2ccd6fbede0a::cnsnft3934 {
    struct CNSNFT3934 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3934, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3934>(arg0, arg1);
