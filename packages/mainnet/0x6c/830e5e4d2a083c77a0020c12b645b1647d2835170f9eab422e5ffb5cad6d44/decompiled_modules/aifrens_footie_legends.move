module 0x6c830e5e4d2a083c77a0020c12b645b1647d2835170f9eab422e5ffb5cad6d44::aifrens_footie_legends {
    ...
    public fun burn_token(arg0: AifrensGenesis) {
        let AifrensGenesis {
            id             : v0,
            generation     : _,
            birthdate      : _,
    ...
    fun init(arg0: AIFRENS_FOOTIE_LEGENDS, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v7 = AifrensGenesisGlobal{
            ...
            cap             : 50000,
            count           : 0,
            beneficary      : @0xd25d89953a68686909b4918dac07c3f072013fb47a5fc22727de20421c3c14b2,
            start_time_ms   : 1,
            expired_time_ms : 168398280000000,
            paused          : false,
        };
