module 0x6c369dd94d52b125e43c24fe55ab2d56766220226a5ba687ebf420e43d68b12e::factory {
    ...
    public fun launch<T0>(arg0: 0x2::coin::TreasuryCap<T0>, arg1: 0x2::coin::CoinMetadata<T0>, arg2: 0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::blob::Blob, arg3: &mut 0x2::tx_context::TxContext) : Pool<T0> {
        ...
        0xfdc88f7d7cf30afab2f82e8380d11ee8f70efb90e863d1de8616fae1bb09ea77::shared_blob::new(arg2, arg3);
        let v0 = 0x2::object::id_from_address(@0x0);
        let v1 = 1000000000000000000 / 100;
        let v2 = 0x1::vector::empty<Bin>();
        let v3 = 1000;
        let v4 = 0;
        while (v4 < 100) {
            let v5 = if (v4 == 0) {
                v1 + 1000000000000000000 - v1 * 100
            } else {
                v1
            };
            let v6 = Bin{
        ...
        let v8 = Pool<T0>{
            ...
            token_vault      : 0x2::coin::into_balance<T0>(0x2::coin::mint<T0>(&mut arg0, 1000000000000000000, arg3)),
