module 0x6cb6ec869a6c7a477cfe59dccbf68a9b8805e62c9753cfb6e664956f07573ec6::reward9373 {
    struct REWARD9373 has drop {
        dummy_field: bool,
    }

    struct TICKET_9373 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward9373(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_9373>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_9373>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD9373, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD9373>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_9373>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_9373>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_9373>>(v5, 0x2::tx_context::sender(arg1));
    }
