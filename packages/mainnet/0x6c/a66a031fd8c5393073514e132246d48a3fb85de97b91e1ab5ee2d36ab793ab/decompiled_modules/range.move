module 0xd19e32b0f2a5e541fbd345b4602f8a93a2eee25c16029595b6fef0b1e0461a54::range {
    ...
    fun borrow_mut_parameters<T0>(arg0: &mut RangeSettings) : &mut Parameters<T0> {
        assert!(parameters_exist<T0>(arg0), 13835621675250745349);
    ...
    public fun borrow_range_settings(arg0: &0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &RangeSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<Range, RangeSettingsKey, RangeSettings>(arg0, v1, v0), 13835340062834950147);
    ...
    fun borrow_range_settings_mut(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse) : &mut RangeSettings {
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::dof_exists_with_type<Range, RangeSettingsKey, RangeSettings>(arg0, v0, v1), 13835340122964492291);
    ...
    entry fun play<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: vector<0x1::string::String>, arg8: vector<vector<u8>>, arg9: &0x8d97f1cd6ac663735be08d1d2b6d02a159e711586461306ce60a2b7a6a565a9e::price_info::PriceInfoObject, arg10: &0x2::clock::Clock, arg11: &0x2::random::Random, arg12: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        play_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::read_price_quote(arg9), arg10, arg11, arg12)
    }

    fun play_internal<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: vector<0x1::string::String>, arg8: vector<vector<u8>>, arg9: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::PriceQuote, arg10: &0x2::clock::Clock, arg11: &0x2::random::Random, arg12: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v5 = v2.max_rtp;
        let v6 = v2.min_rtp;
        assert!(arg3 > 0 && arg3 <= v2.max_number_of_games, 13836748404086800397);
        assert!(arg3 <= 100, 13836748408381767693);
        assert!(arg4 <= 100000000, 13837874312584101909);
        assert!(arg5 <= 100000000, 13838155791855910935);
        assert!(arg4 < arg5, 13838437271127719961);
        let v7 = arg5 - arg4;
        let v8 = if (arg6) {
            100000000 - v7
        } else {
        ...
        let v9 = v8;
        assert!(v9 >= v2.min_zone_size, 13838718758989463579);
        assert!(v9 <= v2.max_zone_size, 13839000238261272605);
        ...
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(&v11), 13837592889146867731);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&v11, &v5), 13837592893441835027);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::lt(&v11, &v6), 13837592897736802323);
        ...
        assert!(0x2::balance::value<T0>(&v14) == arg1, 13837030050862333967);
        ...
        0x13a877d974d59f54d8affa4d345bf794cf8e9e936d9d22100c801c95b415930f::loyalty::process_stake_ticket_with_quote<T0, Range>(&mut v17, arg0, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::utils::build_metadata<0x1::string::String, vector<u8>>(arg7, arg8), arg9, arg10, arg11, arg12);
        ...
        while (v20 < arg3) {
            ...
            assert!(v21 >= v3, 13836185832090238985);
            assert!(v21 <= v4, 13836467311362048011);
    ...
    entry fun play_v2<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: 0x2::coin::Coin<T0>, arg3: u64, arg4: u64, arg5: u64, arg6: bool, arg7: vector<0x1::string::String>, arg8: vector<vector<u8>>, arg9: &0x55300367a2d40813727ccac4ecee977a39fb9cdb46f2e6b2c354b9798f5de2c0::price_info::PriceInfoObject, arg10: &0x2::clock::Clock, arg11: &0x2::random::Random, arg12: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        play_internal<T0>(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::oracle::read_price_quote_v2(arg9), arg10, arg11, arg12)
    }
    ...
    fun set_parameters<T0>(arg0: &mut 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::sweethouse::SweetHouse, arg1: u64, arg2: u64, arg3: u64, arg4: u64, arg5: u64, arg6: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg7: 0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::Float, arg8: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(arg3 > 0 && arg3 <= 100000000, 13835903347796082695);
        assert!(arg3 <= arg4, 13835903352091049991);
        assert!(arg4 <= 100000000, 13835903356386017287);
        assert!(arg5 > 0 && arg5 <= 100, 13835903360680984583);
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(&arg6), 13835903369270919175);
        assert!(0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::is_positive_or_zero(&arg7), 13835903373565886471);
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&arg6, &arg7), 13835903377860853767);
        let v0 = max_allowed_rtp();
        assert!(!0xcbb0929f21450013ebe5e86e7139f2409da2e3ed212c51126a7e6448b795a43f::float::gt(&arg7, &v0), 13835903386450788359);
