module 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager {
    ...
    struct ProjectConfig has drop, store {
        level: u8,
    ...
    public fun add_whitelist<T0>(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchAdmin, arg1: &mut ProjectManager<T0>, arg2: address, arg3: u64) {
    ...
    public fun batch_add_whitelist<T0>(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchAdmin, arg1: &mut ProjectManager<T0>, arg2: vector<address>, arg3: vector<u64>) {
        let v0 = 0;
    ...
    public fun batch_remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchAdmin, arg2: vector<address>) {
        let v0 = 0;
        while (v0 < 0x1::vector::length<address>(&arg2)) {
    ...
    public entry fun initialize_project_manager<T0>(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchAdmin, arg1: PayNft, arg2: address, arg3: u64, arg4: u64, arg5: u64, arg6: u8, arg7: &ProjectManagerConfig, arg8: &mut 0x2::tx_context::TxContext) {
        assert_version(arg7);
        let v0 = if (arg6 == 0) {
            true
        } else if (arg6 == 1) {
        ...
        assert!(v3 == arg2, 0);
        assert!(v4 == arg3, 5);
        let (v6, _, v8) = get_project_fund_config_by_level(arg6, arg7);
        let v9 = 0x1::type_name::get<T0>();
        let v10 = 0x2::object::new(arg8);
        let v11 = 0x2::object::uid_to_address(&v10);
        let v12 = ProjectAdmin{
            id                       : 0x2::object::new(arg8),
            project_manager          : v11,
            claimed_incentive_amount : 0,
        };
        0x2::transfer::transfer<ProjectAdmin>(v12, v3);
        let v13 = ProjectInitializedEvent{
            project_manager     : v11,
            target_funds        : v8,
            total_supply_amount : v6,
            start_times         : arg4,
            end_times           : arg5,
            level               : arg6,
            count               : v4,
        ...
        0x2::event::emit<ProjectInitializedEvent>(v13);
        let v14 = ProjectManager<T0>{
            id             : v10,
            target_funds   : v8,
            start_times    : arg4,
            fund_coin_type : v9,
        ...
        0x2::transfer::share_object<ProjectManager<T0>>(v14);
    }
    ...
    public fun project_falied<T0>(arg0: &mut ProjectManager<T0>, arg1: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchAdmin, arg2: &0x2::clock::Clock) {
    ...
    public fun remove_whitelist<T0>(arg0: &mut ProjectManager<T0>, arg1: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchAdmin, arg2: address) {
    ...
    public fun set_project_config_hard(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u64, arg3: u64, arg4: u64) {
    ...
    public fun set_project_config_simple(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = ProjectConfig{
            level              : 0,
            max_funding_amount : arg2,
            token_price        : arg3,
    ...
    public fun set_project_config_standard(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut ProjectManagerConfig, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = ProjectConfig{
            level              : 1,
            max_funding_amount : arg2,
            token_price        : arg3,
