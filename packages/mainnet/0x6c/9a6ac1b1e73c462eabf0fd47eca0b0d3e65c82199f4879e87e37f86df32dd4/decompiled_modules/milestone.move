module 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::milestone {
    ...
    public fun check_if_update_milestone<T0, T1>(arg0: &mut LockedPool<T0, T1>, arg1: &VestingConfig, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x2::clock::Clock) : (bool, bool, bool) {
        ...
        ((0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::cetus::get_sui_token_price<T0, T1>(arg2) as u64) >= get_milestone_target_price(arg0.milestone_round, arg0.level, arg1), arg0.current_milestone_start, v1)
    }

    public fun claim<T0, T1>(arg0: &mut LockedPool<T0, T1>, arg1: &mut 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::FundingProof, arg2: &VestingConfig, arg3: &mut 0x2::tx_context::TxContext) {
        assert_version(arg2);
        let v0 = claimable<T0, T1>(arg0, arg1, arg2);
        assert!(v0 > 0, 0);
        assert!(0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::get_proof_project_id(arg1) == arg0.project_id, 1);
        0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::update_proof_claimed(arg1, v0);
    ...
    public(friend) fun claimable<T0, T1>(arg0: &LockedPool<T0, T1>, arg1: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::FundingProof, arg2: &VestingConfig) : u64 {
        let v0 = 0x2::table::borrow<u8, ProjectMilestoneConfig>(&arg2.configs, arg0.level);
        assert!(0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::get_proof_project_id(arg1) == arg0.project_id, 1);
        let v1 = (0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::get_proof_token(arg1) as u128) * (get_milestone_target_unlocked(arg0.milestone_round, arg0.level, arg2) as u128) / (v0.locked_supply as u128);
        let v2 = 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::get_proof_claimed(arg1);
        if ((v1 as u64) > v2) {
            (v1 as u64) - v2
        } else {
            0
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        0x2::table::add<u8, ProjectMilestoneConfig>(&mut v0, 2, v1);
        ...
        0x2::table::add<u8, ProjectMilestoneConfig>(&mut v0, 3, v3);
    ...
    public(friend) entry fun new_wallet<T0, T1>(arg0: 0x2::coin::Coin<T1>, arg1: 0x2::coin::Coin<T0>, arg2: u8, arg3: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::ProjectManager<T0>, arg4: 0x2::object::ID, arg5: &mut 0x2::tx_context::TxContext) : 0x2::object::ID {
        let v0 = LockedPool<T0, T1>{
            ...
            start_times             : 0,
            position_id             : arg4,
            project_id              : 0x2::object::id<0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::ProjectManager<T0>>(arg3),
            level                   : 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::get_project_manager_level<T0>(arg3),
        };
        0x2::transfer::share_object<LockedPool<T0, T1>>(v0);
        0x2::object::id<LockedPool<T0, T1>>(&v0)
    }

    public fun set_milestone_round<T0, T1>(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchManagerAdmin, arg1: &mut LockedPool<T0, T1>, arg2: u8) {
        arg1.milestone_round = arg2;
    }

    public fun set_vesting_config_count(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchManagerAdmin, arg1: u8, arg2: u8, arg3: &mut VestingConfig) {
        0x2::table::borrow_mut<u8, ProjectMilestoneConfig>(&mut arg3.configs, arg1).milestone_count = arg2;
    }

    public fun set_vesting_config_price(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchManagerAdmin, arg1: u8, arg2: vector<u64>, arg3: &mut VestingConfig) {
        0x2::table::borrow_mut<u8, ProjectMilestoneConfig>(&mut arg3.configs, arg1).milestone_prices = arg2;
    }

    public fun set_vesting_config_total_unlocked(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchManagerAdmin, arg1: u8, arg2: vector<u64>, arg3: &mut VestingConfig) {
        0x2::table::borrow_mut<u8, ProjectMilestoneConfig>(&mut arg3.configs, arg1).milestone_total_unlocked = arg2;
    }

    public fun update_milestone<T0, T1>(arg0: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config::LaunchAdmin, arg1: &mut LockedPool<T0, T1>, arg2: &0x1eabed72c53feb3805120a081dc15963c204dc8d091542592abaf7a35689b2fb::pool::Pool<T0, T1>, arg3: &0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::ProjectManager<T0>, arg4: &0x2::clock::Clock, arg5: &VestingConfig) {
        let v0 = 0x2::table::borrow<u8, ProjectMilestoneConfig>(&arg5.configs, arg1.level);
        assert_version(arg5);
        let v1 = 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::cetus::get_sui_token_price<T0, T1>(arg2);
        ...
        if (arg1.current_milestone_start == false) {
            ...
            let v2 = MilestoneUpdatedEvent{
                ...
                count                 : 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::project_manager::get_project_count<T0>(arg3),
