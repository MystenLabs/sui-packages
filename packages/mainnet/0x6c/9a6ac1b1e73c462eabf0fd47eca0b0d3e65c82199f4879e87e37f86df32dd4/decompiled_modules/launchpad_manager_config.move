module 0x6c9a6ac1b1e73c462eabf0fd47eca0b0d3e65c82199f4879e87e37f86df32dd4::launchpad_manager_config {
    ...
    public fun get_hard_add_liquidity_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 2).add_liquidity_fee_rate
    }

    public fun get_hard_transaction_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 2).transaction_fee_rate
    }
    ...
    public fun get_simple_add_liquidity_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 0).add_liquidity_fee_rate
    }

    public fun get_simple_fudraising_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 0).fudraising_fee_rate
    }

    public fun get_simple_transaction_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 0).transaction_fee_rate
    }

    public fun get_standard_add_liquidity_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 1).add_liquidity_fee_rate
    }

    public fun get_standard_fudraising_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 1).fudraising_fee_rate
    }

    public fun get_standard_transaction_fee_rate(arg0: &LaunchpadManagerConfig) : u64 {
        0x2::table::borrow<u8, LaunchConfig>(&arg0.configs, 1).transaction_fee_rate
    }
