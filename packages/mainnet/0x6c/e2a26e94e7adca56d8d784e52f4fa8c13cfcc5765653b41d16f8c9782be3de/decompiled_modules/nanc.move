module 0x6ce2a26e94e7adca56d8d784e52f4fa8c13cfcc5765653b41d16f8c9782be3de::nanc {
    ...
    fun init(arg0: NANC, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<NANC>(arg0, 9, b"NANC", b"NANC", b"NO AIRDROP NO COMMUNITY", 0x1::option::none<0x2::url::Url>(), arg1);
