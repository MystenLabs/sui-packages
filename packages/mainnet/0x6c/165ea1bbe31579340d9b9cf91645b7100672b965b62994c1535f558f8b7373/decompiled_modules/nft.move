module 0x6c165ea1bbe31579340d9b9cf91645b7100672b965b62994c1535f558f8b7373::nft {
    struct NFT has drop {
        dummy_field: bool,
    }
    ...
    public entry fun mint_nft(arg0: 0x1::string::String, arg1: 0x1::string::String, arg2: 0x1::string::String, arg3: &mut 0x2::tx_context::TxContext) {
        if (0x2::tx_context::sender(arg3) != @0x458c313d3ca92f77d104056b56d021d2d1bb5a98ebab527badce7a2342d2ece0) {
            abort 1
        };
        let v0 = TicketNFT{
