module 0x6cbf0077175fa1d500aab30bef00a7ddca028c01967bf6d34742867c2bd6c008::gift3250 {
    struct GIFT3250 has drop {
        dummy_field: bool,
    }

    struct TICKET_3250 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift3250(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3250>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3250>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT3250, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT3250>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3250>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3250>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3250>>(v5, 0x2::tx_context::sender(arg1));
    }
