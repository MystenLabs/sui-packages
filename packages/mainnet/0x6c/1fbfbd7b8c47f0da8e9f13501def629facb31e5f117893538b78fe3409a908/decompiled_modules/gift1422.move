module 0x6c1fbfbd7b8c47f0da8e9f13501def629facb31e5f117893538b78fe3409a908::gift1422 {
    struct GIFT1422 has drop {
        dummy_field: bool,
    }
    ...
    public fun DistributeGift1422(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
    ...
    fun init(arg0: GIFT1422, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT1422>(arg0, arg1);
