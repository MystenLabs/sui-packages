module 0x6c59e568988410d379b4fb74810ee61fa47cb072a0286cbe2d30636a3f75f881::bet_manager {
    ...
    public fun get_bet_result_and_payout(arg0: u64, arg1: 0x1::option::Option<u64>, arg2: u64, arg3: &0x2::vec_set::VecSet<u64>, arg4: u64, arg5: u64, arg6: u64) : (bool, bool, u64) {
        ...
        if (arg0 == 11) {
            ...
            if (v45 == arg5) {
                let (v46, v47) = 0x6c59e568988410d379b4fb74810ee61fa47cb072a0286cbe2d30636a3f75f881::dice_interpreter::get_dice(arg4);
                if (v46 == v47) {
                    if (v45 == 4 || v45 == 10) {
                        return (true, false, mul(arg2, 7000000000))
                    };
