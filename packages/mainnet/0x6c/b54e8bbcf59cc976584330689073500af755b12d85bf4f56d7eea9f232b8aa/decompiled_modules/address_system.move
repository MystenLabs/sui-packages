module 0x6cb54e8bbcf59cc976584330689073500af755b12d85bf4f56d7eea9f232b8aa::address_system {
    fun base58_decode(arg0: 0x1::ascii::String) : vector<u8> {
        ...
        while (v4 < 0x1::vector::length<u8>(v1)) {
            ...
            0x6cb54e8bbcf59cc976584330689073500af755b12d85bf4f56d7eea9f232b8aa::error::invalid_solana_address(v6);
            let v8 = v5;
            let v9 = 32 - 1;
            while (v9 < 32) {
    ...
    public fun ensure_origin(arg0: &0x2::tx_context::TxContext) : 0x1::ascii::String {
        let v0 = 0x2::address::to_bytes(0x2::tx_context::sender(arg0));
        let v1 = detect_chain_type_from_tx_hash(0x2::tx_context::digest(arg0));
        if (v1 == 1) {
            let v3 = b"";
            let v4 = 12;
            while (v4 < 32) {
            ...
            0x1::ascii::string(0x2::hex::encode(v3))
        } else if (v1 == 2) {
            base58_encode(v0)
        } else {
            0x1::ascii::string(0x2::hex::encode(v0))
        }
    }

    public fun evm_to_sui(arg0: 0x1::ascii::String) : address {
        let v0 = hex_string_to_bytes(arg0);
        0x6cb54e8bbcf59cc976584330689073500af755b12d85bf4f56d7eea9f232b8aa::error::invalid_evm_address(0x1::vector::length<u8>(&v0) == 20);
        let v1 = b"";
        let v2 = 0;
        while (v2 < 12) {
    ...
    public fun solana_to_sui(arg0: 0x1::ascii::String) : address {
        ...
        0x6cb54e8bbcf59cc976584330689073500af755b12d85bf4f56d7eea9f232b8aa::error::invalid_solana_address(0x1::vector::length<u8>(&v0) == 32);
