module 0x6ca75b24ce1bf45af6d4448587ec4a839484b06c8ec60d4c067c017ed48f6f4f::my_nft {
    ...
    fun init(arg0: MY_NFT, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://github.com/xiaxianlin"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"{image_url}"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"A true Hero of the Sui ecosystem!"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"https://github.com/xiaxianlin"));
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"xiaxianlin"));
        ...
        let v6 = MyNFT{
            ...
            name      : 0x1::string::utf8(b"XXL-NFT"),
            image_url : 0x1::string::utf8(b"https://avatars.githubusercontent.com/u/2775378?v=4"),
        };
