module 0xb466ddecf4d57e72409f4d367f436d5fa88bb13d6cff25865b0cc26066d19b60::prize_vault {
    ...
    struct PurchaseCapKey has copy, drop, store {
        dummy_field: bool,
    }
    ...
    public entry fun claim_purchase_cap_kiosk_nft_prize<T0: store + key>(arg0: &mut PrizeVault, arg1: ClaimTicket, arg2: &mut 0x2::kiosk::Kiosk, arg3: &mut 0x2::kiosk::Kiosk, arg4: &0x2::kiosk::KioskOwnerCap, arg5: &0x2::transfer_policy::TransferPolicy<T0>, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) {
        assert!(arg0.vault_id == arg1.vault_id, 4);
        assert!(0x2::tx_context::sender(arg7) == arg1.recipient, 4);
        assert!(arg0.prize_type == 0x1::string::utf8(b"PURCHASE_CAP_KIOSK_NFT"), 1);
        assert!(arg0.has_prize, 2);
        assert!(0x2::object::id<0x2::kiosk::Kiosk>(arg2) == *0x2::dynamic_field::borrow<0x1::string::String, 0x2::object::ID>(&arg0.id, 0x1::string::utf8(b"creator_kiosk_id")), 4);
        let v0 = PurchaseCapKey{dummy_field: false};
        let (v1, v2) = 0x2::kiosk::purchase_with_cap<T0>(arg2, 0x2::dynamic_object_field::remove<PurchaseCapKey, 0x2::kiosk::PurchaseCap<T0>>(&mut arg0.id, v0), 0x2::coin::zero<0x2::sui::SUI>(arg7));
        0x2::kiosk::lock<T0>(arg3, arg4, arg5, v1);
    ...
    public fun create_purchase_cap_kiosk_nft_vault<T0: store + key>(arg0: 0x2::kiosk::PurchaseCap<T0>, arg1: 0x2::object::ID, arg2: 0x1::string::String, arg3: 0x2::object::ID, arg4: 0x1::string::String, arg5: 0x1::string::String, arg6: u64, arg7: &mut 0x2::tx_context::TxContext) : (PrizeVault, DepositReceipt) {
        let v0 = 0x2::object::new(arg7);
        let v1 = 0x2::object::uid_to_inner(&v0);
        let v2 = PrizeVault{
            id                : v0,
            vault_id          : v1,
            prize_type        : 0x1::string::utf8(b"PURCHASE_CAP_KIOSK_NFT"),
            prize_name        : arg4,
            prize_description : arg5,
            prize_value       : 0,
            creator           : 0x2::tx_context::sender(arg7),
        ...
        let v3 = PurchaseCapKey{dummy_field: false};
        0x2::dynamic_object_field::add<PurchaseCapKey, 0x2::kiosk::PurchaseCap<T0>>(&mut v2.id, v3, arg0);
        0x2::dynamic_field::add<0x1::string::String, 0x2::object::ID>(&mut v2.id, 0x1::string::utf8(b"nft_id"), arg1);
        0x2::dynamic_field::add<0x1::string::String, 0x2::object::ID>(&mut v2.id, 0x1::string::utf8(b"creator_kiosk_id"), arg3);
        let v4 = PrizeTypeKey{dummy_field: false};
        0x2::dynamic_field::add<PrizeTypeKey, 0x1::string::String>(&mut v2.id, v4, arg2);
        let v5 = DepositReceipt{
            id           : 0x2::object::new(arg7),
            vault_id     : v1,
            prize_type   : 0x1::string::utf8(b"PURCHASE_CAP_KIOSK_NFT"),
