module 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::registry {
    ...
    public fun assert_output(arg0: &Registry, arg1: u64, arg2: u64) {
        ...
        assert!(0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::safe_math::mul_div_u64(v0, 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips(), arg1) <= arg0.max_output_delta_pips, 4);
    }
    ...
    public fun assert_price(arg0: &Registry, arg1: u128, arg2: u128) {
        ...
        assert!((0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::safe_math::mul_div_u128(v0, 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips_u128(), arg1) as u64) <= arg0.max_price_delta_pips, 3);
    }

    public(friend) fun assert_witness<T0>(arg0: &Registry) {
        assert!(arg0.version <= 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::current_version(), 0);
        let v0 = type_name<T0>();
    ...
    public fun collect_fees<T0>(arg0: &mut Registry, arg1: 0x2::object::ID, arg2: &mut 0x2::balance::Balance<T0>, arg3: u64, arg4: u64) {
        let v0 = 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::safe_math::mul_div_u64(0x2::balance::value<T0>(arg2), arg4, 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips());
        let v1 = type_name<T0>();
    ...
    fun init(arg0: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = Registry{
            ...
            version               : 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::current_version(),
    ...
    public fun update_fee_configs(arg0: &mut Registry, arg1: vector<u64>, arg2: vector<u64>, arg3: vector<u64>, arg4: vector<u64>, arg5: &AdminCap) {
        ...
        while (v1 < 0x1::vector::length<u64>(&arg1)) {
            let v2 = if (*0x1::vector::borrow<u64>(&arg1, v1) < 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips()) {
                if (*0x1::vector::borrow<u64>(&arg2, v1) < 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips()) {
                    *0x1::vector::borrow<u64>(&arg3, v1) < 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips()
                } else {
                    false
                }
            } else {
            ...
            assert!(v2, 2);
            assert!(v0 < *0x1::vector::borrow<u64>(&arg4, v1) && *0x1::vector::borrow<u64>(&arg4, v1) < 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips(), 2);
    ...
    public fun update_max_output_delta_pips(arg0: &mut Registry, arg1: u64, arg2: &AdminCap) {
        assert!(arg1 < 0x6c286cdd52c7ca07ab29a70d1afab565c5899adbdc1acf2ab4554456faa25d68::constants::scaling_pips(), 2);
