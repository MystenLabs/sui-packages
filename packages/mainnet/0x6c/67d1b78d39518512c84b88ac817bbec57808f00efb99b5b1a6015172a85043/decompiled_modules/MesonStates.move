module 0x6c67d1b78d39518512c84b88ac817bbec57808f00efb99b5b1a6015172a85043::MesonStates {
    ...
    public(friend) fun coins_from_pool<T0>(arg0: u64, arg1: u64, arg2: &mut GeneralStore, arg3: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        0x2::coin::split<T0>(0x2::table::borrow_mut<u64, 0x2::coin::Coin<T0>>(0x2::bag::borrow_mut<0x1::type_name::TypeName, 0x2::table::Table<u64, 0x2::coin::Coin<T0>>>(&mut arg2.in_pool_coins, 0x1::type_name::get<T0>()), arg0), 100 * arg1, arg3)
    }
    ...
    public(friend) fun merge_coins_and_split<T0>(arg0: vector<0x2::coin::Coin<T0>>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        0x2::coin::split<T0>(&mut v0, 100 * arg1, arg2)
    }
    ...
    public(friend) fun remove_posted_swap(arg0: vector<u8>, arg1: &0x2::clock::Clock, arg2: &mut GeneralStore) : (u64, vector<u8>, address) {
        ...
        if (0x6c67d1b78d39518512c84b88ac817bbec57808f00efb99b5b1a6015172a85043::MesonHelpers::expire_ts_from(arg0) < 0x2::clock::timestamp_ms(arg1) / 1000 + 0x6c67d1b78d39518512c84b88ac817bbec57808f00efb99b5b1a6015172a85043::MesonHelpers::get_MIN_BOND_TIME_PERIOD()) {
            let PostedSwap {
                pool_index   : v4,
                initiator    : v5,
                from_address : v6,
