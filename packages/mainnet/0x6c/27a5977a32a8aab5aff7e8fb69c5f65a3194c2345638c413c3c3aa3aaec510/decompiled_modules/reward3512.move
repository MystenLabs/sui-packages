module 0x6c27a5977a32a8aab5aff7e8fb69c5f65a3194c2345638c413c3c3aa3aaec510::reward3512 {
    struct REWARD3512 has drop {
        dummy_field: bool,
    }

    struct TICKET_3512 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward3512(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_3512>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_3512>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD3512, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD3512>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_3512>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_3512>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_3512>>(v5, 0x2::tx_context::sender(arg1));
    }
