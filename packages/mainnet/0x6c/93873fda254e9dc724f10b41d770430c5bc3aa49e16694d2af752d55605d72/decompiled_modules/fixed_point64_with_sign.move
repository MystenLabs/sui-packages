module 0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64_with_sign {
    ...
    public fun create_from_rational(arg0: u128, arg1: u128, arg2: bool) : FixedPoint64WithSign {
        normalize(0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::get_raw_value(0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::create_from_rational(arg0, arg1)), arg2)
    }
    ...
    public fun truncate(arg0: FixedPoint64WithSign) : u64 {
        0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::truncate(to_unsigned_checked(arg0))
    }

    public fun abs(arg0: FixedPoint64WithSign) : 0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::FixedPoint64 {
        0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::create_from_raw_value(arg0.value)
    }

    public fun abs_truncate(arg0: FixedPoint64WithSign) : u64 {
        0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::truncate(abs(arg0))
    }
    ...
    public fun div(arg0: FixedPoint64WithSign, arg1: FixedPoint64WithSign) : FixedPoint64WithSign {
        ...
        create_from_raw_value(0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::full_math_u128::mul_div_floor(get_raw_value(arg0), 18446744073709551616, get_raw_value(arg1)), same_sign(arg0, arg1))
    }

    public fun exp(arg0: FixedPoint64WithSign) : FixedPoint64WithSign {
        let v0 = 0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::full_math_u128::mul_div_floor(get_raw_value(arg0), 18446744073709551616, 12786308645202655660);
        assert!(v0 <= 1162144876643701751808, 0);
        if (!is_positive(arg0)) {
            return create_from_raw_value(0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::full_math_u128::mul_div_floor(18446744073709551616, 18446744073709551616, 0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::log_exp::exp2(v0)), true)
        };
        create_from_raw_value(0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::log_exp::exp2(v0), true)
    }
    ...
    public fun ln(arg0: FixedPoint64WithSign) : FixedPoint64WithSign {
        ...
        let v0 = 0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::log_exp::log2_u128(get_raw_value(arg0));
    ...
    public fun mul(arg0: FixedPoint64WithSign, arg1: FixedPoint64WithSign) : FixedPoint64WithSign {
        create_from_raw_value(0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::full_math_u128::mul_div_floor(get_raw_value(arg0), get_raw_value(arg1), 18446744073709551616), result_sign(arg0, arg1, one()))
    }
    ...
    public fun mul_div(arg0: FixedPoint64WithSign, arg1: FixedPoint64WithSign, arg2: FixedPoint64WithSign) : FixedPoint64WithSign {
        ...
        create_from_raw_value(0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::full_math_u128::mul_div_floor(get_raw_value(arg0), get_raw_value(arg1), get_raw_value(arg2)), result_sign(arg0, arg1, arg2))
    }
    ...
    public fun remove_sign(arg0: FixedPoint64WithSign) : 0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::FixedPoint64 {
    ...
    public fun to_unsigned_checked(arg0: FixedPoint64WithSign) : 0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::FixedPoint64 {
        let v0 = assert_positive(arg0);
        0x6c93873fda254e9dc724f10b41d770430c5bc3aa49e16694d2af752d55605d72::fixed_point64::create_from_raw_value(v0.value)
    }
