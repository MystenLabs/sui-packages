module 0x6cc2ca7162e5af8ac2888e0a0488f3a78ca3c0adbb17d6f6ace399f428d82f35::interfaces {
    ...
    public entry fun get_treasury_lending_info(arg0: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::Storage, arg1: &mut 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::oracle::PriceOracle) {
        let v0 = 0;
        let v1 = 0x1::vector::empty<UserLiquidAssetInfo>();
        let v2 = 0x1::vector::empty<UserDebtInfo>();
        let v3 = 0;
        let v4 = 0;
        let v5 = 0;
        let v6 = 0;
        let v7 = 0;
        while (v7 < 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_reserve_length(arg0)) {
            let v8 = (v7 as u16);
            let v9 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::scaled_balance::balance_of(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_user_scaled_otoken_v2(arg0, v0, v8), 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_liquidity_index_v2(arg0, v8));
            if (v9 > 0) {
                let v10 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg1, v8, v9);
                let v11 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_liquidity_rate(arg0, v8);
                v5 = v5 + 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_mul(v10, v11);
                v3 = v3 + v10;
                let v12 = UserLiquidAssetInfo{
                    dola_pool_id  : v8,
                    borrow_apy    : 0,
                    supply_apy    : v11 * 10000 / 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray(),
                    liquid_amount : v9,
                    liquid_value  : v10,
                };
                0x1::vector::push_back<UserLiquidAssetInfo>(&mut v1, v12);
            };
            let v13 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::scaled_balance::balance_of(0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_user_scaled_dtoken_v2(arg0, v0, v8), 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_borrow_index_v2(arg0, v8));
            if (v13 > 0) {
                let v14 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_logic::calculate_value(arg1, v8, v13);
                let v15 = 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::lending_core_storage::get_borrow_rate(arg0, v8);
                v6 = v6 + 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray_mul(v14, v15);
                v4 = v4 + v14;
                let v16 = UserDebtInfo{
                    dola_pool_id : v8,
                    borrow_apy   : v15 * 10000 / 0x826915f8ca6d11597dfe6599b8aa02a4c08bd8d39674855254a06ee83fe7220e::ray_math::ray(),
                    supply_apy   : 0,
                    debt_amount  : v13,
                    debt_value   : v14,
                };
                0x1::vector::push_back<UserDebtInfo>(&mut v2, v16);
            };
            v7 = v7 + 1;
        };
        let v17 = UserLendingInfo{
            health_factor          : 0,
            profit_state           : true,
            net_apy                : 0,
            total_supply_apy       : 0,
            total_borrow_apy       : 0,
            liquid_asset_infos     : v1,
            total_liquid_value     : v3,
            collateral_infos       : 0x1::vector::empty<UserCollateralInfo>(),
            total_collateral_value : 0,
            debt_infos             : v2,
            total_debt_value       : v4,
            isolation_mode         : false,
        };
        0x2::event::emit<UserLendingInfo>(v17);
    }
