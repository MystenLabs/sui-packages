module 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::redeem {
    ...
    public fun redeem<T0>(arg0: &0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::version::Version, arg1: &mut 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::market::Market, arg2: 0x2::coin::Coin<0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::reserve::MarketCoin<T0>>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        ...
        let v1 = 0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::market::handle_redeem<T0>(arg1, 0x2::coin::into_balance<0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::reserve::MarketCoin<T0>>(arg2), v0);
        let v2 = RedeemEvent{
            redeemer        : 0x2::tx_context::sender(arg4),
            withdraw_asset  : 0x1::type_name::get<T0>(),
            withdraw_amount : 0x2::balance::value<T0>(&v1),
            burn_asset      : 0x1::type_name::get<0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::reserve::MarketCoin<T0>>(),
            burn_amount     : 0x2::coin::value<0x6c23585e940a989588432509107e98bae06dbca4e333f26d0635d401b3c7c76d::reserve::MarketCoin<T0>>(&arg2),
            time            : v0,
        };
