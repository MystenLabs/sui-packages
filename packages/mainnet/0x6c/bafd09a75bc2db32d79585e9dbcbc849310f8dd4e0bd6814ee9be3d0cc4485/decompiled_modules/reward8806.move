module 0x6cbafd09a75bc2db32d79585e9dbcbc849310f8dd4e0bd6814ee9be3d0cc4485::reward8806 {
    struct REWARD8806 has drop {
        dummy_field: bool,
    }

    struct TICKET_8806 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8806(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8806>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8806>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8806, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8806>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8806>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8806>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8806>>(v5, 0x2::tx_context::sender(arg1));
    }
