module 0x6c6c8a2a9b65aa83b2d1a99056081316342a1a7e22152bb5011e912cff73981d::nft {
    ...
    public entry fun mint(arg0: &mut MintRegistry, arg1: vector<u8>, arg2: vector<u8>, arg3: vector<u8>, arg4: address, arg5: &0x2::clock::Clock, arg6: &mut 0x2::tx_context::TxContext) {
        ...
        if (0x2::table::is_empty<address, bool>(&arg0.minters)) {
            arg0.mint_end_time = v0 + 93600000;
        };
        if (v0 > arg0.mint_end_time) {
            abort 2
        };
        if (has_minted(arg0, arg4)) {
            abort 1
        };
        ...
        0x2::transfer::public_transfer<PoorlaxNFT>(v1, arg4);
    }
    ...
    public entry fun update_mint_end_time(arg0: &mut MintRegistry, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        arg0.mint_end_time = 0x2::clock::timestamp_ms(arg1) + 93600000;
    }
