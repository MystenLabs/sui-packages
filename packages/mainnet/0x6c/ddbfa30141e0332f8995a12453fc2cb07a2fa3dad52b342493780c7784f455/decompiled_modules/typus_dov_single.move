module 0x6cddbfa30141e0332f8995a12453fc2cb07a2fa3dad52b342493780c7784f455::typus_dov_single {
    ...
    public(friend) fun activate_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: &0x855eb2d260ee42b898266e6df90bfd3c4ed821ccb253a352c159c223244a4b8a::oracle::Oracle, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64) {
        ...
        let (v16, v17, v18) = 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_date_from_ts(v1.info.expiration_ts_ms / 1000);
        0x1::string::append_utf8(&mut v15, b"-");
        0x1::string::append_utf8(&mut v15, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v18));
        0x1::string::append_utf8(&mut v15, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_month_short_string(v17));
        0x1::string::append_utf8(&mut v15, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v16));
        if (v1.info.period == 3) {
            0x1::string::append_utf8(&mut v15, b"-");
            0x1::string::append_utf8(&mut v15, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 86400000 / 3600000));
            0x1::string::append_utf8(&mut v15, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::get_pad_2_number_string(v1.info.expiration_ts_ms % 3600000 / 60000));
        };
        0x1::vector::reverse<u64>(&mut v7);
        while (!0x1::vector::is_empty<u64>(&v7)) {
            0x1::string::append_utf8(&mut v15, b"-");
            0x1::string::append_utf8(&mut v15, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::u64_to_bytes(0x1::vector::pop_back<u64>(&mut v7), v5));
        };
        ...
        0x2::dynamic_object_field::add<u64, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::BidVault>(&mut arg0.bid_vault_registry, arg1, 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::new_bid_vault<T0, T1>(v1.info.index, v15, arg4));
    ...
    public(friend) fun delivery_<T0, T1>(arg0: &mut Registry, arg1: u64, arg2: bool, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : (u64, u64, u64, u64, u64, u64, u64) {
        ...
        let v20 = if (v1.config.deposit_incentive_bp > 0 && 0x2::dynamic_field::exists_with_type<0x1::type_name::TypeName, 0x2::balance::Balance<T1>>(&arg0.id, 0x1::type_name::get<T1>())) {
            ...
            let v24 = if (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::match_types<T0, T1>()) {
                ((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_balance<T0>(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_balance<T0>(v3)) as u128) * (v13 as u128) / (v1.info.delivery_infos.max_size as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64)
            } else if (v1.info.option_type % 2 == 0) {
                (((((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_balance<T0>(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_balance<T0>(v3)) as u128) * (v13 as u128) / (v1.info.delivery_infos.max_size as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64) as u128) * (v1.info.oracle_info.price as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.oracle_info.decimal) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            } else {
                (((((((0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::active_balance<T0>(v3) + 0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::deactivating_balance<T0>(v3)) as u128) * (v13 as u128) / (v1.info.delivery_infos.max_size as u128) * (v1.config.deposit_incentive_bp as u128) / 10000) as u64) as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.oracle_info.decimal) as u128) / (v1.info.oracle_info.price as u128) * (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.b_token_decimal) as u128) / (0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::multiplier(v1.info.d_token_decimal) as u128)) as u64)
            };
            let v25 = if (v24 > v22) {
                if (v22 > v23) {
            ...
            let v26 = v25;
            0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::utils::set_u64_padding_value(&mut v1.config.u64_padding, 0, v23 - 0x2::balance::value<T1>(&v26));
            v26
        } else {
            0x2::balance::zero<T1>()
        };
        let v27 = v20;
        0xa2de2f04907b77ef03800a8969bb4f88c821737ee133aba4bc0485b267ad2118::vault::delivery_b<T0, T1>(v3, v5, v10, v27, arg4);
