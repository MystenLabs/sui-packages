module 0x6c861e0a849129c30c53aea18d16d9dbb31b6eecbe57d6a4fb25a0531980bb01::AftermathReward {
    ...
    fun init(arg0: AFTERMATHREWARD, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<AFTERMATHREWARD>(arg0, 9, b"$ afrwd.cc - Aftermath Reward Token", b"afrwd.cc", b"You're rewarded $10,000 Sui for empowering Aftermath Finance and Sui Network.", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe_from_bytes(b"https://suicamp.b-cdn.net/bucket/bucket_token_icon.jpg")), arg1);
