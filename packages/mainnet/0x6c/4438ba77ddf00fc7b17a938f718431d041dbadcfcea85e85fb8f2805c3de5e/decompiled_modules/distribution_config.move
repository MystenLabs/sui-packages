module 0x3fcdcee11f485731170944af3acd26b17d1b96121ce6b756fe8517a95192b3a::distribution_config {
    ...
    public fun checked_package_version(arg0: &DistributionConfig) {
        assert!(arg0.version == 6, 458466182903521300);
    }
    ...
    public fun is_gauge_paused(arg0: &DistributionConfig, arg1: 0x2::object::ID) : bool {
        if (!0x2::bag::contains<u8>(&arg0.bag, 3)) {
            return false
        };
        0x2::vec_set::contains<0x2::object::ID>(0x2::bag::borrow<u8, 0x2::vec_set::VecSet<0x2::object::ID>>(&arg0.bag, 3), &arg1)
    }
    ...
    public(friend) fun pause_gauge(arg0: &mut DistributionConfig, arg1: 0x2::object::ID) {
        if (!0x2::bag::contains<u8>(&arg0.bag, 3)) {
            0x2::bag::add<u8, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.bag, 3, 0x2::vec_set::empty<0x2::object::ID>());
        };
        let v0 = 0x2::bag::borrow_mut<u8, 0x2::vec_set::VecSet<0x2::object::ID>>(&mut arg0.bag, 3);
    ...
    public fun set_package_version(arg0: &mut DistributionConfig, arg1: &0x2::package::Publisher, arg2: u64) {
        assert!(0x2::package::from_module<DISTRIBUTION_CONFIG>(arg1), 24442067766657028);
        assert!(arg2 <= 6, 326963916733903800);
        arg0.version = arg2;
    }
