module 0x6cf10730412f503c6c60675081906a0a7efa1eb0ed35c1b60a7e33c602c76b5a::cnsnft3287 {
    struct CNSNFT3287 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3287, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3287>(arg0, arg1);
