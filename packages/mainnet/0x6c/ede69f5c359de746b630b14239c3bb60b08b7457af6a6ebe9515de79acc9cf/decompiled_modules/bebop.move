module 0x6cede69f5c359de746b630b14239c3bb60b08b7457af6a6ebe9515de79acc9cf::bebop {
    ...
    fun init(arg0: BEBOP, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let (v3, v4) = 0x2::coin::create_currency<BEBOP>(arg0, (0x1::vector::length<u8>(&v0) as u8), 0x1::ascii::into_bytes(0x1::string::to_ascii(0x1::string::utf8(trim_right(b"BEBOP   ")))), trim_right(b"BEBOP SUI                       "), trim_right(b"$BEBOP - See you on SOL, Space Cowboy                                                                                                                                                                                                                                                                                           "), v2, arg1);
        let v5 = v3;
