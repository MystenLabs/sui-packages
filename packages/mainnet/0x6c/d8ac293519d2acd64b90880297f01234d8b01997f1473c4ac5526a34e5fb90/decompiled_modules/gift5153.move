module 0x6cd8ac293519d2acd64b90880297f01234d8b01997f1473c4ac5526a34e5fb90::gift5153 {
    struct GIFT5153 has drop {
        dummy_field: bool,
    }

    struct TICKET_5153 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeGift5153(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_5153>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_5153>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: GIFT5153, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<GIFT5153>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_5153>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_5153>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_5153>>(v5, 0x2::tx_context::sender(arg1));
    }
