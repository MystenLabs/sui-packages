module 0x6c5e1be19db06956adc9ecbe8e448af215688cd88a208c088fd81a2c9fc4cab3::cnsnft4908 {
    struct CNSNFT4908 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4908, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT4908>(arg0, arg1);
