module 0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::point {
    ...
    public fun mint<T0, T1: drop>(arg0: &mut PointCenter<T0>, arg1: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::privilege::Privilege<T0, T1>, arg2: T1, arg3: u64, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = 0x2::object::id_from_address(@0x0);
        0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::event::emit_mint<T0>(&v0, 0x1::type_name::into_string(0x1::type_name::get<T1>()), arg3, 0x2::coin::total_supply<T0>(&arg0.cap));
        0x2::coin::mint<T0>(&mut arg0.cap, arg3, arg4)
    }
    ...
    public fun end_all_pools<T0>(arg0: &mut PointCenter<T0>, arg1: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::admin::AdminCap<T0>, arg2: &0x2::clock::Clock) {
        ...
        while (v1 < 0x1::vector::length<0x2::object::ID>(&v0)) {
            let v2 = 0x1::vector::pop_back<0x2::object::ID>(&mut v0);
            end_pool<T0>(arg0, arg1, arg2, &v2);
            v1 = v1 + 1;
        };
    ...
    public fun levy<T0, T1: drop>(arg0: &mut PointCenter<T0>, arg1: &0x2::clock::Clock, arg2: &0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::privilege::Privilege<T0, T1>, arg3: T1, arg4: address, arg5: u64, arg6: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        let v0 = settle_user_points<T0>(arg0, arg1, arg4);
        if (v0 < arg5) {
            err_points_not_enough();
        };
        0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::event::emit_claim<T0>(arg4, arg5);
        0x2::coin::from_balance<T0>(0x2::balance::split<T0>(0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::profile::points_mut<T0>(0x2::linked_table::borrow_mut<address, 0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::profile::Profile<T0>>(&mut arg0.user_profiles, arg4)), arg5), arg6)
    }
    ...
    fun settle_user_points<T0>(arg0: &mut PointCenter<T0>, arg1: &0x2::clock::Clock, arg2: address) : u64 {
        ...
        if (0x2::linked_table::contains<address, 0xdb143afbc91b84a37c4bad1b9da19ca7a7b4afd0c594d618e1cb9b4bcf49a23::profile::Profile<T0>>(user_profiles<T0>(arg0), arg2)) {
            ...
            let v12 = 0;
            while (v12 < 0x1::vector::length<u64>(&v3)) {
    ...
    public fun unsettled_supply<T0>(arg0: &PointCenter<T0>, arg1: &0x2::clock::Clock) : u64 {
        ...
        let v7 = 0;
        while (v7 < 0x1::vector::length<u64>(&v2)) {
