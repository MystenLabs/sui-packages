module 0x6c3e22c60b401c2d491865af8ece2e358b01f5df028fcede69ff10beb01cc37f::cnsnft9105 {
    struct CNSNFT9105 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT9105, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=9390"));
        let v4 = 0x2::package::claim<CNSNFT9105>(arg0, arg1);
