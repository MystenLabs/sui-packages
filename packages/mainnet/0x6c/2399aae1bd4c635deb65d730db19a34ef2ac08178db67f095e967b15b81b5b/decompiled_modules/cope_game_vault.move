module 0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::cope_game_vault {
    ...
    public fun create_vault<T0>(arg0: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::app::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 >= 0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::config::get_min_deposit(arg2), 3);
        assert!(v0 <= 0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::config::get_max_deposit(arg2), 5);
    ...
    public fun emergency_withdraw_all<T0>(arg0: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::app::AdminCap, arg1: &mut Vault<T0>, arg2: address, arg3: &mut 0x2::tx_context::TxContext) {
        assert!(arg1.is_paused, 2);
        arg1.total_withdrawn = arg1.total_withdrawn + 0x2::balance::value<T0>(&arg1.balance);
    ...
    public fun end_game<T0>(arg0: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
    ...
    public fun set_pause<T0>(arg0: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::app::AdminCap, arg1: &mut Vault<T0>, arg2: bool, arg3: &0x2::clock::Clock) {
        arg1.is_paused = arg2;
    ...
    public fun settle_game<T0>(arg0: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::app::AdminCap, arg1: &mut Vault<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock) {
        assert!(!arg1.is_paused, 2);
    ...
    public fun start_game<T0>(arg0: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
        assert!(!arg1.is_paused, 2);
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
        assert!(!arg0.active_game, 8);
        assert!(arg1 >= 0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::config::get_min_withdraw(arg2), 4);
        assert!(arg1 <= 0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::config::get_max_withdraw(arg2), 6);
        assert!(arg1 > 0, 7);
    ...
    public fun withdraw_house_profits<T0>(arg0: &0x6c2399aae1bd4c635deb65d730db19a34ef2ac08178db67f095e967b15b81b5b::app::AdminCap, arg1: &mut Vault<T0>, arg2: u64, arg3: address, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        assert!(!arg1.is_paused, 2);
        assert!(arg2 > 0, 7);
        let v0 = if (arg1.house_profit_lifetime >= arg1.house_loss_lifetime) {
            arg1.house_profit_lifetime - arg1.house_loss_lifetime
        } else {
            0
        };
        assert!(arg2 <= v0, 11);
        assert!(0x2::balance::value<T0>(&arg1.balance) >= arg2, 1);
        arg1.house_profit_lifetime = arg1.house_profit_lifetime - arg2;
        ...
        let v1 = HouseProfitWithdrawalEvent{
            recipient              : arg3,
            amount                 : arg2,
            remaining_house_profit : arg1.house_profit_lifetime - arg1.house_loss_lifetime,
            timestamp              : 0x2::clock::timestamp_ms(arg4),
        };
        0x2::event::emit<HouseProfitWithdrawalEvent>(v1);
    }
