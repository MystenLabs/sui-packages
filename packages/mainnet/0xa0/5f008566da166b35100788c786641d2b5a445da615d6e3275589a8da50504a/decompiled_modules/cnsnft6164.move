module 0xa05f008566da166b35100788c786641d2b5a445da615d6e3275589a8da50504a::cnsnft6164 {
    struct CNSNFT6164 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT6164, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT6164>(arg0, arg1);
