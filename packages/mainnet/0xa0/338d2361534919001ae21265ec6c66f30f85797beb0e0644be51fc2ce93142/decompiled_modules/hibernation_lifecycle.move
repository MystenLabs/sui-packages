module 0x97fea95545c04dc73f8174c6195013b100a26e3fa978e7cf8b100a51dfaf8354::hibernation_lifecycle {
    ...
    public(friend) fun bond_wake(arg0: &mut 0x2::object::UID, arg1: u8, arg2: u64) {
        assert!(arg1 == 6, 1);
        let v0 = status(arg0);
        v0.waking_ms = arg2;
        v0.unlock_remaining = 0;
        save(arg0, v0);
    }
    ...
    public(friend) fun finish_wake_capped(arg0: &mut 0x2::object::UID, arg1: u8, arg2: u64, arg3: u64, arg4: u64) {
        let v0 = if (arg1 == 5) {
            let v1 = Key{dummy_field: false};
            0x2::dynamic_field::exists<Key>(arg0, v1)
        } else {
        ...
        assert!(arg2 >= v4.waking_ms && v4.unlock_remaining == 0, 1);
        v4.has_woken = true;
        v4.last_wake_ms = arg2;
    }
