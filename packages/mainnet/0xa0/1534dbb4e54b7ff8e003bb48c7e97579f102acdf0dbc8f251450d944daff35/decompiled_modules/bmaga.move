module 0xa01534dbb4e54b7ff8e003bb48c7e97579f102acdf0dbc8f251450d944daff35::bmaga {
    ...
    fun init(arg0: BMAGA, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1, v2) = 0x2::coin::create_regulated_currency_v2<BMAGA>(arg0, 9, b"Black MAGA", b"BMAGA", b"Black MAGA", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://orange-upper-booby-780.mypinata.cloud/ipfs/QmTv7wkK2ummNDaHunqCmUtqgqmWWpc3pQ6sdiY2ZtDsvx"))), false, arg1);
        let v3 = v0;
