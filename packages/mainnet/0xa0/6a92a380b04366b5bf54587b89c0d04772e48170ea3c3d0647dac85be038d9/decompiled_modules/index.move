module 0xa06a92a380b04366b5bf54587b89c0d04772e48170ea3c3d0647dac85be038d9::index {
    ...
    public fun assert_new_pool<T0, T1>(arg0: &Registry) {
        assert!(!0x2::table::contains<0x1::type_name::TypeName, address>(&arg0.seed_pools, 0x1::type_name::get<RegistryKey<T0, T1>>()), 0xa06a92a380b04366b5bf54587b89c0d04772e48170ea3c3d0647dac85be038d9::errors::pool_already_deployed());
    }
