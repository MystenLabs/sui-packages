module 0xa06a92a380b04366b5bf54587b89c0d04772e48170ea3c3d0647dac85be038d9::utils {
    public fun are_coins_suitable<T0, T1>() : bool {
        assert!(0x1::type_name::get<T0>() != 0x1::type_name::get<T1>(), 0xa06a92a380b04366b5bf54587b89c0d04772e48170ea3c3d0647dac85be038d9::errors::select_different_coins());
        true
    }
