module 0xa06a92a380b04366b5bf54587b89c0d04772e48170ea3c3d0647dac85be038d9::fee_distribution {
    ...
    fun get_max_withdraw(arg0: u64, arg1: u64, arg2: u64, arg3: u64) : u64 {
        ...
        assert!(v1 <= v0 * 1000000000000000, 0xa06a92a380b04366b5bf54587b89c0d04772e48170ea3c3d0647dac85be038d9::errors::no_funds_to_withdraw());
    ...
    public(friend) fun update_stake<T0, T1>(arg0: u64, arg1: u64, arg2: &mut FeeState<T0, T1>, arg3: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>) {
    ...
    public fun withdraw<T0, T1>(arg0: &mut FeeState<T0, T1>, arg1: u64, arg2: &mut 0x2::tx_context::TxContext) : (0x2::balance::Balance<T1>, 0x2::balance::Balance<T0>) {
