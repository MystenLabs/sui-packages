module 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::dapp_score {
    ...
    public fun check_is_dapp_admin(arg0: &Dapp, arg1: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::contains<address>(&arg0.admins, &v0) || 0x1::vector::length<address>(&arg0.admins) == 0, 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::error::not_authorized_error());
    }

    fun check_is_super_admin(arg0: &DappScoreManager, arg1: &0x2::tx_context::TxContext) {
        let v0 = 0x2::tx_context::sender(arg1);
        assert!(0x1::vector::contains<address>(&arg0.admins, &v0) || arg0.creator == 0x2::tx_context::sender(arg1), 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::error::not_authorized_error());
    }

    public fun check_is_updater(arg0: &DappScoreManager, arg1: &0x2::tx_context::TxContext) {
        assert!(arg0.updater == 0x2::tx_context::sender(arg1), 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::error::not_authorized_error());
    }
    ...
    fun internal_add_dapp_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(!0x1::vector::contains<address>(&v0.admins, &arg2), 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::error::duplicated_error());
    ...
    fun internal_remove_dapp_admin(arg0: &mut DappScoreManager, arg1: u64, arg2: address, arg3: &0x2::tx_context::TxContext) {
        ...
        assert!(v2 && v4, 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::error::not_authorized_error());
        0x1::vector::remove<address>(&mut v0.admins, v3);
        assert!(0x1::vector::length<address>(&v0.admins) > 0, 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::error::not_authorized_error());
    ...
    fun internal_remove_super_admin(arg0: &mut DappScoreManager, arg1: address, arg2: &0x2::tx_context::TxContext) {
        ...
        assert!(0x1::vector::length<address>(&arg0.admins) > 0, 0xa06f4b5d3da4aec4a6d3a1dd066d248c2b74120863f2d281089c7074ac0ed62c::error::not_authorized_error());
