module 0xa05156599533b0b39978494f8754c050eaa40a7f1eb7596fd6298bdebe10b8b5::cnsnft1370 {
    struct CNSNFT1370 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT1370, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=4278"));
        let v4 = 0x2::package::claim<CNSNFT1370>(arg0, arg1);
