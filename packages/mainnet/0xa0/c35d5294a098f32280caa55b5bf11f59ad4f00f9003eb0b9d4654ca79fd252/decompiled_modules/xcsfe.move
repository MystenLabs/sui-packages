module 0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::xcsfe {
    struct XCSFE has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: XCSFE, arg1: &mut 0x2::tx_context::TxContext) {
        let (v0, v1) = 0x2::coin::create_currency<XCSFE>(arg0, 0, b"XCSFE", b"Xociety company stock - Fusion Edge Finance", b"Stock for the Xociety in-game company named Fusion Edge Finance", 0x1::option::some<0x2::url::Url>(0x2::url::new_unsafe(0x1::ascii::string(b"https://app.xociety.io/assets/xcs/xcsfe.png"))), arg1);
        let v2 = v0;
        let (v3, v4) = 0x2::token::new_policy<XCSFE>(&v2, arg1);
        let v5 = v4;
        let v6 = v3;
        let v7 = 0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::new<XCSFE>(v2, 0x2::tx_context::sender(arg1), arg1);
        0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::add_capability<XCSFE, 0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::MintCap>(&mut v7, @0x3142efe76da5935d46bcbde9351398e6b70fa8423a86c98e39ad71c24bdb95c7, 0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::new_mint_cap(5000000, arg1), arg1);
        0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::add_capability<XCSFE, 0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::WhitelistCap>(&mut v7, @0x3142efe76da5935d46bcbde9351398e6b70fa8423a86c98e39ad71c24bdb95c7, 0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::new_whitelist_cap(), arg1);
        let v8 = &mut v6;
        set_rules<XCSFE>(v8, &v5, arg1);
        0x2::transfer::public_freeze_object<0x2::coin::CoinMetadata<XCSFE>>(v1);
        0x2::transfer::public_transfer<0x2::token::TokenPolicyCap<XCSFE>>(v5, 0x2::tx_context::sender(arg1));
        0x2::token::share_policy<XCSFE>(v6);
        0xa0c35d5294a098f32280caa55b5bf11f59ad4f00f9003eb0b9d4654ca79fd252::treasury::share<XCSFE>(v7);
    }
