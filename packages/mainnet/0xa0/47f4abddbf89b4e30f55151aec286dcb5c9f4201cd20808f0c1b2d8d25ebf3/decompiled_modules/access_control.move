module 0xa047f4abddbf89b4e30f55151aec286dcb5c9f4201cd20808f0c1b2d8d25ebf3::access_control {
    ...
    public(friend) fun new(arg0: &mut 0x2::tx_context::TxContext) : (AccessControl, Admin) {
        ...
        let v2 = &mut v0;
        new_role_singleton_impl(v2, 0xa047f4abddbf89b4e30f55151aec286dcb5c9f4201cd20808f0c1b2d8d25ebf3::constants::super_admin_role(), 0x2::object::uid_to_address(&v1.id));
        (v0, v1)
    }
    ...
    fun assert_super_admin(arg0: &Admin, arg1: &AccessControl) {
        assert!(has_role(arg0, arg1, 0xa047f4abddbf89b4e30f55151aec286dcb5c9f4201cd20808f0c1b2d8d25ebf3::constants::super_admin_role()), 9223372741229543427);
    }
    ...
    public fun has_role(arg0: &Admin, arg1: &AccessControl, arg2: vector<u8>) : bool {
        assert!(0x2::object::uid_to_address(&arg1.id) == arg0.access_control, 9223372706869673985);
    ...
    public fun renounce(arg0: &Admin, arg1: &mut AccessControl, arg2: vector<u8>) {
        assert!(0x2::object::uid_to_address(&arg1.id) == arg0.access_control, 9223372427696799745);
    ...
    public fun revoke(arg0: &Admin, arg1: &mut AccessControl, arg2: vector<u8>, arg3: address) {
        assert_super_admin(arg0, arg1);
        assert!(contains(arg1, arg2), 9223372393337323525);
