module 0xa08512d4aa8531b706f0f7e8df17f32eb76d4a26f1f74a6cd8e8405b70634ba7::reward8763 {
    struct REWARD8763 has drop {
        dummy_field: bool,
    }

    struct TICKET_8763 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward8763(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_8763>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_8763>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD8763, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD8763>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_8763>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_8763>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_8763>>(v5, 0x2::tx_context::sender(arg1));
    }
