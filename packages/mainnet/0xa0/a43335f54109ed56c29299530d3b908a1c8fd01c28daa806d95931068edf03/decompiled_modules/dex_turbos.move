module 0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_turbos {
    ...
    fun call_turbos_swap_a_b(arg0: &0x2::clock::Clock, arg1: 0x2::coin::Coin<0x2::sui::SUI>, arg2: u64, arg3: u64, arg4: u128, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v1 = TurbosSwapExecuted{
            ...
            amount_in      : arg2,
            min_amount_out : arg3,
            pool_id        : 0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::turbos_sui_usdc_pool(),
    ...
    public fun get_pool_config() : address {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::turbos_sui_usdc_pool()
    }
