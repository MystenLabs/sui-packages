module 0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::atomic_arbitrage_simple {
    ...
    public fun calculate_cetus_output(arg0: u64) : u64 {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_cetus::calculate_cetus_output(arg0)
    }

    public fun calculate_turbos_output(arg0: u64) : u64 {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_turbos::calculate_turbos_output(arg0)
    }

    public fun get_cetus_config() : (address, address, u128) {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_cetus::get_pool_config()
    }

    public fun get_cetus_packages() : (address, address) {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_cetus::get_cetus_packages()
    }
    ...
    public fun get_turbos_config() : address {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_turbos::get_pool_config()
    }

    public fun get_turbos_packages() : (address, address) {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_turbos::get_turbos_packages()
    }
    ...
    public entry fun swap_sui_to_usdc_aftermath_simple(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_aftermath::swap_sui_to_usdc_simple(arg0, arg1, arg2, arg3);
    ...
    public entry fun swap_sui_to_usdc_bluefin_simple(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_bluefin::swap_sui_to_usdc_gateway(arg2, arg0, arg1, arg3);
    ...
    public entry fun swap_sui_to_usdc_cetus(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_cetus::swap_sui_to_usdc_cetus(arg2, arg0, arg1, arg3);
    ...
    public entry fun swap_sui_to_usdc_cetus_verified(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_cetus::swap_sui_to_usdc_verified(arg0, arg1, arg2, arg3);
        let v1 = CetusSwapCompleted{
            sender         : 0x2::tx_context::sender(arg3),
            amount_in      : v0,
            min_amount_out : arg1,
    ...
    public entry fun swap_sui_to_usdc_flowx_simple(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_flowx::swap_sui_to_usdc_factory(arg0, arg1, arg2, arg3);
    ...
    public entry fun swap_sui_to_usdc_kriya_simple(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0x2::transfer::public_transfer<0x2::coin::Coin<USDC>>(0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_kriya::swap_sui_to_usdc<0x2::sui::SUI, USDC>(0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::kriya_sui_usdc_pool(), arg0, arg1, arg2, arg3), 0x2::tx_context::sender(arg3));
    ...
    public entry fun swap_sui_to_usdc_suiswap_exact_input(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_suiswap::swap_sui_to_usdc_simple(arg0, arg1, arg2, arg3);
    ...
    public entry fun swap_sui_to_usdc_suiswap_router(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_suiswap::swap_sui_to_usdc_router(arg0, arg1, arg2, arg3);
        let v1 = SuiSwapSwapCompleted{
            sender         : 0x2::tx_context::sender(arg3),
            amount_in      : v0,
            min_amount_out : arg1,
    ...
    public entry fun swap_sui_to_usdc_turbos_simple(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        let v0 = 0x2::coin::value<0x2::sui::SUI>(&arg0);
        assert!(v0 > 0, 2001);
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_turbos::swap_sui_to_usdc_simple(arg0, arg1, arg2, arg3);
        let v1 = CetusSwapCompleted{
            sender         : 0x2::tx_context::sender(arg3),
            amount_in      : v0,
            min_amount_out : arg1,
    ...
    public fun validate_swap_params(arg0: u64, arg1: u64) : bool {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_cetus::validate_swap_params(arg0, arg1)
    }

    public fun validate_turbos_params(arg0: u64, arg1: u64) : bool {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_turbos::validate_swap_params(arg0, arg1)
    }
