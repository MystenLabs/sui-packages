module 0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::dex_deepbook {
    ...
    public fun get_deep_token_package() : address {
        0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::deep_token_package()
    }

    public fun get_deepbook_config() : (address, address, address) {
        (0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::deepbook_package(), 0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::deepbook_registry(), 0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::deepbook_treasury())
    }
    ...
    public entry fun real_external_deepbook_swap(arg0: 0x2::coin::Coin<0x2::sui::SUI>, arg1: u64, arg2: &0x2::clock::Clock, arg3: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = DeepBookSwapExecuted{
            ...
            min_amount_out : arg1,
            pool_id        : get_deepbook_pool(),
            method         : b"real_external_deepbook_swap_worker3_corrected_package",
        };
    ...
    public fun swap_sui_to_usdc<T0, T1>(arg0: address, arg1: 0x2::coin::Coin<T0>, arg2: u64, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T1> {
        ...
        assert!(v0 > 0, 3401);
        assert!(arg0 == 0xa0a43335f54109ed56c29299530d3b908a1c8fd01c28daa806d95931068edf03::constants::deepbook_sui_usdc_pool(), 3403);
