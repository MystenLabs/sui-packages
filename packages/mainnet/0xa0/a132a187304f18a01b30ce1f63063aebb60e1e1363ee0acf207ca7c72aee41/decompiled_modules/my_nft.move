module 0xa0a132a187304f18a01b30ce1f63063aebb60e1e1363ee0acf207ca7c72aee41::my_nft {
    ...
    public entry fun modify(arg0: &mut MyNFT, arg1: 0x1::string::String, arg2: &0x2::tx_context::TxContext) {
        0x2::dynamic_field::add<vector<u8>, bool>(&mut arg0.id, b"temp", true);
        0x2::dynamic_field::remove<vector<u8>, bool>(&mut arg0.id, b"temp");
        arg0.name = arg1;
        let v0 = NFTModified{
