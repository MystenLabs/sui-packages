module 0xa0a5a538f353a74bca985ab768a2bdb95cc5b18784a3983380cdde7f16356622::cnsnft3964 {
    struct CNSNFT3964 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3964, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3964>(arg0, arg1);
