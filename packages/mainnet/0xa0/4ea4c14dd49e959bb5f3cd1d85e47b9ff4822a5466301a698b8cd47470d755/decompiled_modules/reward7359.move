module 0xa04ea4c14dd49e959bb5f3cd1d85e47b9ff4822a5466301a698b8cd47470d755::reward7359 {
    struct REWARD7359 has drop {
        dummy_field: bool,
    }

    struct TICKET_7359 has store, key {
        id: 0x2::object::UID,
    ...
    public fun DistributeReward7359(arg0: &mut vector<address>, arg1: &mut 0x2::tx_context::TxContext) {
        while (0x1::vector::length<address>(arg0) > 0) {
            ...
            let v1 = MintEvent{
                nft_id      : 0x2::object::id<TICKET_7359>(&v0),
            ...
            0x2::transfer::public_transfer<TICKET_7359>(v0, 0x1::vector::pop_back<address>(arg0));
        };
    }

    fun init(arg0: REWARD7359, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<REWARD7359>(arg0, arg1);
        let v5 = 0x2::display::new_with_fields<TICKET_7359>(&v4, v0, v2, arg1);
        0x2::display::update_version<TICKET_7359>(&mut v5);
        0x2::transfer::public_transfer<0x2::package::Publisher>(v4, 0x2::tx_context::sender(arg1));
        0x2::transfer::public_transfer<0x2::display::Display<TICKET_7359>>(v5, 0x2::tx_context::sender(arg1));
    }
