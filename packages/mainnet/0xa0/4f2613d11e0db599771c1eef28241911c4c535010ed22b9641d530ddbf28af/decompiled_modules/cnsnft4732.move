module 0xa04f2613d11e0db599771c1eef28241911c4c535010ed22b9641d530ddbf28af::cnsnft4732 {
    struct CNSNFT4732 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT4732, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        0x1::vector::push_back<0x1::string::String>(v3, 0x1::string::utf8(b"ipfs://QmTatKT7BRygc9CmvGsrNqSQkoXQvJKKaoyuHtaRrq5mY5?ref=8814"));
        let v4 = 0x2::package::claim<CNSNFT4732>(arg0, arg1);
