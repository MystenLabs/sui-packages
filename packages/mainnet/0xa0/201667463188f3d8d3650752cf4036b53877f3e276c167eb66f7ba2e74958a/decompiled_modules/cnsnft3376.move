module 0xa0201667463188f3d8d3650752cf4036b53877f3e276c167eb66f7ba2e74958a::cnsnft3376 {
    struct CNSNFT3376 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3376, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3376>(arg0, arg1);
