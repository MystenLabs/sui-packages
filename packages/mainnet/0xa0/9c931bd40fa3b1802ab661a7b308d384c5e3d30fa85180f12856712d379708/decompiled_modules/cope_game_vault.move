module 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::cope_game_vault {
    ...
    public fun admin_deposit<T0>(arg0: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::app::AdminCap, arg1: &mut Vault<T0>, arg2: 0x2::coin::Coin<T0>, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
    ...
    public fun create_vault<T0>(arg0: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::app::AdminCap, arg1: &0x2::clock::Clock, arg2: &mut 0x2::tx_context::TxContext) {
        let v0 = Vault<T0>{
    ...
    public fun deposit<T0>(arg0: &mut Vault<T0>, arg1: 0x2::coin::Coin<T0>, arg2: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) {
        assert!(!arg0.is_paused, 2);
        let v0 = 0x2::coin::value<T0>(&arg1);
        assert!(v0 >= 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::get_min_deposit(arg2), 3);
        assert!(v0 <= 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::get_max_deposit(arg2), 5);
    ...
    public fun end_game<T0>(arg0: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
        assert!(!arg1.is_paused, 2);
    ...
    public fun set_pause<T0>(arg0: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::app::AdminCap, arg1: &mut Vault<T0>, arg2: bool, arg3: &0x2::clock::Clock) {
        arg1.is_paused = arg2;
    ...
    public fun settle_game<T0>(arg0: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::app::AdminCap, arg1: &mut Vault<T0>, arg2: vector<address>, arg3: vector<u64>, arg4: &0x2::clock::Clock) {
        assert!(!arg1.is_paused, 2);
        assert!(arg1.active_game, 9);
    ...
    public fun start_game<T0>(arg0: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::app::AdminCap, arg1: &mut Vault<T0>, arg2: &0x2::clock::Clock) {
        assert!(!arg1.is_paused, 2);
    ...
    public fun withdraw<T0>(arg0: &mut Vault<T0>, arg1: u64, arg2: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::Config, arg3: &0x2::clock::Clock, arg4: &mut 0x2::tx_context::TxContext) : 0x2::coin::Coin<T0> {
        assert!(!arg0.is_paused, 2);
        assert!(!arg0.active_game, 8);
        assert!(arg1 >= 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::get_min_withdraw(arg2), 4);
        assert!(arg1 <= 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::get_max_withdraw(arg2), 6);
        assert!(arg1 > 0, 7);
        ...
        if (!0x2::table::contains<address, DailyWithdrawal>(&arg0.user_daily_withdrawals, v0)) {
            ...
            assert!(arg1 <= 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::get_max_withdraw_per_day(arg2), 13);
        } else {
            let v4 = 0x2::table::borrow_mut<address, DailyWithdrawal>(&mut arg0.user_daily_withdrawals, v0);
            if (v4.day == v2) {
                let v5 = v4.amount + arg1;
                assert!(v5 <= 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::get_max_withdraw_per_day(arg2), 13);
                v4.amount = v5;
            } else {
                v4.amount = arg1;
                v4.day = v2;
    ...
    public fun withdraw_house_profits<T0>(arg0: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::app::AdminCap, arg1: &0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::Config, arg2: &mut Vault<T0>, arg3: u64, arg4: &0x2::clock::Clock, arg5: &mut 0x2::tx_context::TxContext) {
        ...
        let v2 = 0xa09c931bd40fa3b1802ab661a7b308d384c5e3d30fa85180f12856712d379708::config::get_admin_address(arg1);
