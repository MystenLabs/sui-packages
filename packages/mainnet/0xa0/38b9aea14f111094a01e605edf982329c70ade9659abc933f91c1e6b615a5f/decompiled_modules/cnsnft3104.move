module 0xa038b9aea14f111094a01e605edf982329c70ade9659abc933f91c1e6b615a5f::cnsnft3104 {
    struct CNSNFT3104 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: CNSNFT3104, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<CNSNFT3104>(arg0, arg1);
