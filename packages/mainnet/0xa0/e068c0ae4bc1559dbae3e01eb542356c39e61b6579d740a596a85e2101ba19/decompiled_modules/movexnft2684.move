module 0xa0e068c0ae4bc1559dbae3e01eb542356c39e61b6579d740a596a85e2101ba19::movexnft2684 {
    struct MOVEXNFT2684 has drop {
        dummy_field: bool,
    }
    ...
    fun init(arg0: MOVEXNFT2684, arg1: &mut 0x2::tx_context::TxContext) {
        ...
        let v4 = 0x2::package::claim<MOVEXNFT2684>(arg0, arg1);
